/*
    Compile unit: C:\TestBuild\in\GAME\zInteraction.cpp
...
static class xBase * sTurnList; // size: 0x4, address: 0x0
static class pointer_asset sGotoPointer; // size: 0x28, address: 0x6BA0A0
static float sAlphaUpRate; // size: 0x4, address: 0x6083D8
static float sAlphaDownRate; // size: 0x4, address: 0x6083DC
static float sMinDrawDist2; // size: 0x4, address: 0x0
static float sMaxDrawDist2; // size: 0x4, address: 0x6083E0
static float sMinDrawAlpha; // size: 0x4, address: 0x6083E4
static float sMaxDrawAlpha; // size: 0x4, address: 0x6083E8
static float sLogoAngle; // size: 0x4, address: 0x609464
static float sTurnStandDist; // size: 0x4, address: 0x6083EC
static float sTurnMinDot; // size: 0x4, address: 0x6083F0
static float sLaunchMaxDist2; // size: 0x4, address: 0x6083F4
static float sLaunchHalfYawRange; // size: 0x4, address: 0x6083F8
static float sLaunchFlipLength; // size: 0x4, address: 0x6083FC
static float sLaunchThresholdY; // size: 0x4, address: 0x0
static float sLaunchReelInBegin; // size: 0x4, address: 0x608400
static float sLaunchFlingBegin; // size: 0x4, address: 0x0
static signed int sLiftBoneIndex; // size: 0x4, address: 0x608404
static class xVec3 sLiftBoneOffset; // size: 0xC, address: 0x6BA0C8
static float sLiftMoveBack; // size: 0x4, address: 0x0
static class TurnSmokeParticleSystem turn_smoke_particle; // size: 0xC, address: 0x6BA0D8
static class LeavesSystem leaves_particle_system; // size: 0x8, address: 0x609468
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
class zGlobals globals; // size: 0x640, address: 0x61C210
void zLift_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x423640
void zEntSimpleObj_CustomMove(class xEnt *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x12F920
unsigned int zLaunch_StopCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4247D0
unsigned int zLaunch_AbortLaunch(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x424810
unsigned int zLaunch_PlayLaunch(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4249D0
unsigned int zLaunch_StartCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4247F0
unsigned int zLaunch_PlayGrab(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4249F0
void zLaunch_LaunchStateCB(class xAnimState *, class xAnimSingle *, void *); // size: 0x0, address: 0x424850
void zLaunch_MatchGrabIdleCB(class xAnimState *, class xAnimSingle *, void *); // size: 0x0, address: 0x4248D0
void zLaunch_MatchGrabCB(class xAnimState *, class xAnimSingle *, void *); // size: 0x0, address: 0x424950
void zLaunch_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x424A70
signed int Update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x425B40
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
void zTurn_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x427230
signed int Update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4274A0
unsigned char HDR_brightening; // size: 0x1, address: 0x609450
unsigned char HDR_brightening; // size: 0x1, address: 0x609450
// total size: 0x30
class TurnSmokeParticle {
    // Members
public:
    class xVec3 position; // offset 0x0, size 0xC
    float radius; // offset 0xC, size 0x4
    class xVec3 start; // offset 0x10, size 0xC
    float time_elapsed; // offset 0x1C, size 0x4
    class xVec3 horz_dir; // offset 0x20, size 0xC
    float rotation_mult; // offset 0x2C, size 0x4
};
// total size: 0x14
class xCylinder {
    // Members
...
// total size: 0x90
class zTurn : public zInteraction {
    // Members
public:
    class zTurnAsset * turnAsset; // offset 0x70, size 0x4
    enum zTurnState turnState; // offset 0x74, size 0x4
    class zProgressScript * forward; // offset 0x78, size 0x4
    class zProgressScript * backward; // offset 0x7C, size 0x4
    float currIncrement; // offset 0x80, size 0x4
    float initObjYaw; // offset 0x84, size 0x4
    float playerYaw; // offset 0x88, size 0x4
    unsigned int runFlags; // offset 0x8C, size 0x4
};
// total size: 0x68
class xScene {
    // Members
...
class xFFX {};
// total size: 0x110
class zLift : public zInteraction {
    // Members
public:
    class zLiftAsset * liftAsset; // offset 0x70, size 0x4
    enum zLiftState liftState; // offset 0x74, size 0x4
    class zProgressScript * forward; // offset 0x78, size 0x4
    class zProgressScript * backward; // offset 0x7C, size 0x4
    class pointer_asset * stand; // offset 0x80, size 0x4
    float buttonTimer; // offset 0x84, size 0x4
    float speed; // offset 0x88, size 0x4
    class xVec3 contactOffset; // offset 0x8C, size 0xC
    class xVec3 contactPoint; // offset 0x98, size 0xC
    class zLiftInfo info; // offset 0xB0, size 0x50
    unsigned int runFlags; // offset 0x100, size 0x4
};
// total size: 0x8
class xJSPNodeInfo {
    // Members
...
public:
    ...
    class xMat3x3 origMat; // offset 0x10, size 0x30
    float currAngle; // offset 0x40, size 0x4
};
enum AutoMoveMode {
    eAutoMoveOff = 0,
    eAutoMoveMoving = 1,
...
public:
    union { // inferred
        class zLiftTranslate lift; // offset 0x0, size 0x4
        class zLiftRotate tilt; // offset 0x0, size 0x50
    };
};
// total size: 0x30
class RxPacket {
...
public:
    union { // inferred
        class LaunchLeavesParticle p; // offset 0x0, size 0x40
...
// total size: 0x8
class LeavesSystem : public zParticleSystemHelper {
    // Members
public:
    class RwTexture * leaf_texture; // offset 0x4, size 0x4
};
// total size: 0x38
class zTurnAsset : public xDynAsset {
    // Members
public:
    unsigned int forwardScript; // offset 0x10, size 0x4
    unsigned int backwardScript; // offset 0x14, size 0x4
    unsigned int turnObject; // offset 0x18, size 0x4
    float increment; // offset 0x1C, size 0x4
    float turnRate; // offset 0x20, size 0x4
    float restoreRate; // offset 0x24, size 0x4
    signed int goalIncrement; // offset 0x28, size 0x4
    signed int minIncrement; // offset 0x2C, size 0x4
    signed int maxIncrement; // offset 0x30, size 0x4
    unsigned int turnFlags; // offset 0x34, size 0x4
};
// total size: 0x14
...
class effect {};
enum zTurnState {
    eTurnStateReleased = 0,
    eTurnStateIdle = 1,
    eTurnStateTurnLeft = 2,
    eTurnStateTurnRight = 3,
    eTurnStateCount = 4,
    eTurnStateForceSize = 2147483647,
};
// total size: 0x70
...
public:
    union { // inferred
        class TurnSmokeParticle p; // offset 0x0, size 0x30
        char padding[48]; // offset 0x0, size 0x30
    };
};
// total size: 0x8
class RwV2d {
...
// total size: 0x3C
class zLiftAsset : public xDynAsset {
    // Members
public:
    unsigned int forwardScript; // offset 0x10, size 0x4
    unsigned int backwardScript; // offset 0x14, size 0x4
    unsigned int liftObject; // offset 0x18, size 0x4
    unsigned int standPointer; // offset 0x1C, size 0x4
    float buttonFreq; // offset 0x20, size 0x4
    float progressSpeed; // offset 0x24, size 0x4
    float slipSpeed; // offset 0x28, size 0x4
    float finalPos; // offset 0x2C, size 0x4
    float tossSpeed; // offset 0x30, size 0x4
    float dropGravity; // offset 0x34, size 0x4
    unsigned int liftFlags; // offset 0x38, size 0x4
};
// total size: 0x8
...
// total size: 0xC
class TurnSmokeParticleSystem : public zParticleSystemHelper {
    // Members
public:
    float num_particles; // offset 0x4, size 0x4
    class RwTexture * texture; // offset 0x8, size 0x4
};
...
// total size: 0x40
class LaunchLeavesParticle {
    // Members
public:
    class xVec3 position; // offset 0x0, size 0xC
    float radius; // offset 0xC, size 0x4
    class xVec3 base_pos; // offset 0x10, size 0xC
    float floor_height; // offset 0x1C, size 0x4
    class xVec3 path; // offset 0x20, size 0xC
    class xVec3 sway_dir; // offset 0x2C, size 0xC
    float sway_time; // offset 0x38, size 0x4
...
enum zLiftState {
    eLiftStateIdle = 0,
    eLiftStateStruggle = 1,
    eLiftStateDrop = 2,
    eLiftStateToss = 3,
    eLiftStateCount = 4,
    eLiftStateForceSize = 2147483647,
};
// total size: 0x14
...
// total size: 0x4
class zLiftTranslate {
    // Members
public:
    float origHeight; // offset 0x0, size 0x4
};
// total size: 0x8
class RwLinkList {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00423640 -> 0x004236AC
*/
// Range: 0x423640 -> 0x4236AC
void zLift_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x423640 -> 0x4236AC
        class zLift * lift; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004236B0 -> 0x004238C0
*/
// Range: 0x4236B0 -> 0x4238C0
void zLift_CalcTilt(class zLift * lift /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4236B0 -> 0x4238C0
        class zLiftRotate * rot; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004238C0 -> 0x00424064
*/
// Range: 0x4238C0 -> 0x424064
unsigned char zLift_Update(class zLift * lift /* r19 */, float dt /* r29+0x190 */) {
    /* anonymous block */ {
        // Range: 0x4238C0 -> 0x424064
        class zLiftAsset * asset; // r18
        unsigned char bAOIC_is_on; // r17
        float * time; // r3
        float dur; // r4
        float percent; // r20
        float percent; // r20
        class xMat4x3 tmpMat; // r29+0x150
        class zLiftRotate * rot; // r2
        float rFinal; // r29+0x190
        class zLiftRotate * rot; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424070 -> 0x0042428C
*/
// Range: 0x424070 -> 0x42428C
void zLift_Ready(class zLift * lift /* r17 */) {
    /* anonymous block */ {
        // Range: 0x424070 -> 0x42428C
        class zLiftAsset * asset; // r16
        class xVec3 hand; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424290 -> 0x00424408
*/
// Range: 0x424290 -> 0x424408
void zLift_ResetTilt(class zLift * lift /* r17 */) {
    /* anonymous block */ {
        // Range: 0x424290 -> 0x424408
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424410 -> 0x00424510
*/
// Range: 0x424410 -> 0x424510
void zLift_Init(class zLift * lift /* r16 */, class zLiftAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x424410 -> 0x424510
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424510 -> 0x00424518
*/
// Range: 0x424510 -> 0x424518
void zLift_Init(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x424510 -> 0x424518
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424520 -> 0x004247CC
*/
// Range: 0x424520 -> 0x4247CC
class xAnimTable * zLaunch_CreateAnimTable() {
    /* anonymous block */ {
        // Range: 0x424520 -> 0x4247CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004247D0 -> 0x004247E4
*/
// Range: 0x4247D0 -> 0x4247E4
static unsigned int zLaunch_StopCB(void * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4247D0 -> 0x4247E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004247F0 -> 0x00424804
*/
// Range: 0x4247F0 -> 0x424804
static unsigned int zLaunch_StartCB(void * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4247F0 -> 0x424804
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424810 -> 0x00424844
*/
// Range: 0x424810 -> 0x424844
static unsigned int zLaunch_AbortLaunch(void * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x424810 -> 0x424844
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424850 -> 0x004248C4
*/
// Range: 0x424850 -> 0x4248C4
static void zLaunch_LaunchStateCB(class xAnimSingle * anim /* r16 */) {
    /* anonymous block */ {
        // Range: 0x424850 -> 0x4248C4
        class xAnimSingle * playerSingle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004248D0 -> 0x00424944
*/
// Range: 0x4248D0 -> 0x424944
static void zLaunch_MatchGrabIdleCB(class xAnimSingle * anim /* r16 */) {
    /* anonymous block */ {
        // Range: 0x4248D0 -> 0x424944
        class xAnimSingle * playerSingle; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424950 -> 0x004249C4
*/
// Range: 0x424950 -> 0x4249C4
static void zLaunch_MatchGrabCB(class xAnimSingle * anim /* r16 */) {
    /* anonymous block */ {
        // Range: 0x424950 -> 0x4249C4
        class xAnimSingle * playerSingle; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004249D0 -> 0x004249F0
*/
// Range: 0x4249D0 -> 0x4249F0
static unsigned int zLaunch_PlayLaunch() {
    /* anonymous block */ {
        // Range: 0x4249D0 -> 0x4249F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004249F0 -> 0x00424A6C
*/
// Range: 0x4249F0 -> 0x424A6C
static unsigned int zLaunch_PlayGrab(void * object /* r16 */) {
    /* anonymous block */ {
        // Range: 0x4249F0 -> 0x424A6C
        class zCommonPlayer * commonPlayer; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424A70 -> 0x00424B38
*/
// Range: 0x424A70 -> 0x424B38
void zLaunch_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x424A70 -> 0x424B38
        class zLaunch * launch; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424B40 -> 0x00424CA8
*/
// Range: 0x424B40 -> 0x424CA8
void zLaunch_GotoLiftState(class zLaunch * launch /* r2 */) {
    /* anonymous block */ {
        // Range: 0x424B40 -> 0x424CA8
        class zLaunchAsset * asset; // r6
        float peak; // r7
        float airTime; // r29
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00424CB0 -> 0x00425910
*/
// Range: 0x424CB0 -> 0x425910
unsigned char zLaunch_Update(class zLaunch * launch /* r16 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x424CB0 -> 0x425910
        class zLaunchAsset * asset; // r2
        class xAnimSingle * playerSingle; // r2
        class zCommonPlayer * commonPlayer; // r2
        float newAlpha; // r22
        class xVec3 disp; // r29+0x110
        float len2; // r29+0x120
        float yaw; // r29+0x120
        float yawDiff; // r21
        unsigned char inRange; // r2
        float factor; // r29+0x120
        float currYaw; // r29+0x120
        float alphaDiff; // r2
        float maxUp; // r29+0x120
        float maxDown; // r29+0x120
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00425910 -> 0x00425A0C
*/
// Range: 0x425910 -> 0x425A0C
void zLaunch_Init(class zLaunch * launch /* r18 */, class zLaunchAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x425910 -> 0x425A0C
        unsigned int size; // r29+0x5C
        void * obj; // r2
        class PKRAssetTOCInfo assetInfo; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00425A10 -> 0x00425A18
*/
// Range: 0x425A10 -> 0x425A18
void zLaunch_Init(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x425A10 -> 0x425A18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00425A20 -> 0x00425B40
*/
// Range: 0x425A20 -> 0x425B40
void zLaunch_SceneInit(class zScene * zsc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x425A20 -> 0x425B40
        signed int count; // r2
        class zLaunch * launchList; // r2
        signed int i; // r18
        class xEnt * ent; // r4
        class zEntSimpleObj * simp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00425FB0 -> 0x00426074
*/
// Range: 0x425FB0 -> 0x426074
static unsigned char GetEmitBone(class zLaunch * ent /* r16 */, class xVec3 & cur_pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x425FB0 -> 0x426074
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00426080 -> 0x00427224
*/
// Range: 0x426080 -> 0x427224
unsigned char zTurn_Update(class zTurn * turn /* r20 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x426080 -> 0x427224
        unsigned char bPlayerTurning; // r16
        class zTurnAsset * asset; // r19
        float deltaYaw; // r20
        signed int result; // r18
        float incrRate; // r29+0xB0
        float percent; // r21
        float percent; // r21
        float percent; // r21
        float percent; // r21
        float turnRate; // r29+0xB0
        float angle; // r3
        unsigned char singularity; // r17
        float percent; // r21
        float percent; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00427230 -> 0x004273CC
*/
// Range: 0x427230 -> 0x4273CC
void zTurn_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x427230 -> 0x4273CC
        class zTurn * turn; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004273D0 -> 0x00427490
*/
// Range: 0x4273D0 -> 0x427490
void zTurn_Init(class zTurn * turn /* r16 */, class zTurnAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x4273D0 -> 0x427490
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00427490 -> 0x00427498
*/
// Range: 0x427490 -> 0x427498
void zTurn_Init(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x427490 -> 0x427498
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004279D0 -> 0x00427B54
*/
// Range: 0x4279D0 -> 0x427B54
void zInteraction_Ready(class zInteraction * action /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4279D0 -> 0x427B54
        class zTurn * turn; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00427B60 -> 0x00427D88
*/
// Range: 0x427B60 -> 0x427D88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00427D90 -> 0x00427F2C
*/
// Range: 0x427D90 -> 0x427F2C
void zInteraction_Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x427D90 -> 0x427F2C
        unsigned char bInteractionOnScreen; // r20
        unsigned char bPlayerIsTurning; // r19
        signed int count; // r2
        class zScene * zsc; // r2
        class zTurn * turnList; // r2
        signed int i; // r18
        class zLaunch * launchList; // r2
        signed int i; // r18
        class zLift * liftList; // r2
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00427F30 -> 0x00428270
*/
// Range: 0x427F30 -> 0x428270
void zInteraction_SceneReset(class zScene * zsc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x427F30 -> 0x428270
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00428270 -> 0x0042840C
*/
// Range: 0x428270 -> 0x42840C
void zInteraction_SceneInit(class zScene * zsc /* r19 */) {
    /* anonymous block */ {
        // Range: 0x428270 -> 0x42840C
    }
}
