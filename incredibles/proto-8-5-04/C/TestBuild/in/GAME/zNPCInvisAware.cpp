/*
    Compile unit: C:\TestBuild\in\GAME\zNPCInvisAware.cpp
...
static class RwRaster * exclamation; // size: 0x4, address: 0x609200
static class RwRaster * question; // size: 0x4, address: 0x609204
static class xBase * alert_counter; // size: 0x4, address: 0x609208
enum iSndGroupHandle hAlarmGroup; // size: 0x4, address: 0x607CC0
// total size: 0xB4
struct /* @anon0 */ {} zNPC::security_bird::__vtable; // size: 0xB4, address: 0x6043C0
// total size: 0x7C
struct /* @anon15 */ {} zNPC::alarm::__vtable; // size: 0x7C, address: 0x604520
// total size: 0x7C
struct /* @anon8 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon4 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon16 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon10 */ {} zNPC::activating::__vtable; // size: 0x7C, address: 0x6048A0
// total size: 0x7C
struct /* @anon7 */ {} zNPC::idle::__vtable; // size: 0x7C, address: 0x601770
// total size: 0x7C
struct /* @anon11 */ {} zNPC::take_damage::__vtable; // size: 0x7C, address: 0x5FD8A0
// total size: 0x80
struct /* @anon6 */ {} zNPC::search::__vtable; // size: 0x80, address: 0x604760
// total size: 0x7C
struct /* @anon19 */ {} zNPC::violet_attack::__vtable; // size: 0x7C, address: 0x604660
// total size: 0x7C
struct /* @anon12 */ {} zNPC::run_attack::__vtable; // size: 0x7C, address: 0x5FE000
// total size: 0x7C
struct /* @anon5 */ {} zNPC::bone_container<zNPC::laser_bone>::__vtable; // size: 0x7C, address: 0x5FE4E0
// total size: 0x7C
struct /* @anon9 */ {} zNPC::violet_shoot::__vtable; // size: 0x7C, address: 0x6046E0
// total size: 0x98
struct /* @anon3 */ {} zNPC::violet_patrol::__vtable; // size: 0x98, address: 0x604480
// total size: 0x98
struct /* @anon2 */ {} zNPC::patrol_movepoints::__vtable; // size: 0x98, address: 0x5FE240
// total size: 0x98
struct /* @anon18 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x98
struct /* @anon20 */ {} zNPC::defend::__vtable; // size: 0x98, address: 0x5FE380
// total size: 0xB4
struct /* @anon17 */ {} zNPC::violet_gun::__vtable; // size: 0xB4, address: 0x6045A0
// total size: 0xB4
struct /* @anon13 */ {} zNPC::violet_enemy::__vtable; // size: 0xB4, address: 0x6047E0
...
unsigned int anfire(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36EDE0
unsigned int anis_timer_up(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36EBD0
unsigned int anwait(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36EC80
unsigned int anis_invisible(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36EC10
unsigned int anis_visible(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36ECD0
unsigned int anconfuse(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36ED30
unsigned int anis_facing_player(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36EDC0
unsigned int anshould_fire(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x36F010
...
// total size: 0x7C
struct /* @anon1 */ {} zNPC::firing_bone::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon14 */ {} zNPC::bone_behavior::__vtable; // size: 0x7C, address: 0x0
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x6C
class violet_shoot : public move {
    // Members
public:
    class search & search_state; // offset 0x24, size 0x4
    unsigned char facing_player; // offset 0x28, size 0x1
    unsigned char shooting; // offset 0x29, size 0x1
    class xVec3 old_violet_pos; // offset 0x2C, size 0xC
    float max_angle_diff_seen; // offset 0x38, size 0x4
    float max_angle_diff_unseen; // offset 0x3C, size 0x4
    float shoot_first_radius; // offset 0x40, size 0x4
    float shot_timer; // offset 0x44, size 0x4
    float shot_delay; // offset 0x48, size 0x4
    float angle_diff_coeff; // offset 0x4C, size 0x4
    float accuracy_adjuster; // offset 0x50, size 0x4
    class bone_container laser_bones; // offset 0x54, size 0x18
};
// total size: 0x18
class xAnimTable {
    // Members
...
class zGrapplePoint {};
// total size: 0x44
class violet_attack : public run_attack {
    // Members
public:
    class search & search_state; // offset 0x40, size 0x4
};
// total size: 0x18
class xBox {
    // Members
...
// total size: 0x330
class security_bird : public common {
    // Members
public:
    enum iSndHandle hAlarm; // offset 0x2C0, size 0x4
    class idle idle_state; // offset 0x2C4, size 0x10
    class activating reaction_state; // offset 0x2D4, size 0x30
    class alarm alarm_state; // offset 0x304, size 0x24
    float behaviorTimer; // offset 0x328, size 0x4
    float reactionTime; // offset 0x32C, size 0x4
};
// total size: 0x14
...
// total size: 0x2C4
class violet_enemy : public common {
    // Members
public:
    enum eVioletEnemyState state; // offset 0x2C0, size 0x4
};
// total size: 0xC
...
// total size: 0x18
class search : public behavior_implementation {
    // Members
public:
    float alert_timer; // offset 0x10, size 0x4
    float max_alert_time; // offset 0x14, size 0x4
};
// total size: 0x30
class RxPacket {
    // Members
...
// total size: 0x30
class activating : public move {
    // Members
public:
    float activationTimer; // offset 0x24, size 0x4
    unsigned char prevCanSeeTarget; // offset 0x28, size 0x1
    float activationDelay; // offset 0x2C, size 0x4
};
...
// total size: 0x444
class violet_gun : public violet_enemy {
    // Members
public:
    class defend defend_state; // offset 0x2C4, size 0x48
    class violet_patrol patrol_state; // offset 0x30C, size 0x44
    class violet_shoot shoot_state; // offset 0x350, size 0x6C
    class violet_attack attack_state; // offset 0x3BC, size 0x44
    class search search_state; // offset 0x400, size 0x18
    class take_damage damage_state; // offset 0x418, size 0x2C
};
// total size: 0x10
class /* @class */ {
    // Members
...
enum eVioletEnemyState {
    eVioletEnemyState_NONE = 0,
    eVioletEnemyState_SURPRISED = 1,
    eVioletEnemyState_PUZZLED = 2,
};
// total size: 0x8
class RwTexCoords {
    // Members
...
// total size: 0x44
class violet_patrol : public patrol_movepoints {};
// total size: 0x4
...
// total size: 0x10
class idle : public behavior_implementation {};
// total size: 0x8
class xModelPipe {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036DDC0 -> 0x0036DEBC
*/
// Range: 0x36DDC0 -> 0x36DEBC
// this: r17
void security_bird::BehaviorUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x36DDC0 -> 0x36DEBC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036DEC0 -> 0x0036DEC8
*/
// Range: 0x36DEC0 -> 0x36DEC8
// this: r2
void security_bird::update_npc(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x36DEC0 -> 0x36DEC8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036DED0 -> 0x0036DED8
*/
// Range: 0x36DED0 -> 0x36DED8
// this: r2
unsigned char security_bird::system_event(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int to_event /* r2 */, float * to_param /* r2 */, class xBase * to_param_widget /* r2 */, unsigned int to_param_widget_id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x36DED0 -> 0x36DED8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036DEE0 -> 0x0036DF24
*/
// Range: 0x36DEE0 -> 0x36DF24
// this: r16
void security_bird::setup() {
    /* anonymous block */ {
        // Range: 0x36DEE0 -> 0x36DF24
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036DF30 -> 0x0036E01C
*/
// Range: 0x36DF30 -> 0x36E01C
// this: r16
security_bird::security_bird() {
    /* anonymous block */ {
        // Range: 0x36DF30 -> 0x36E01C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E020 -> 0x0036E034
*/
// Range: 0x36E020 -> 0x36E034
// this: r2
void alarm::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x36E020 -> 0x36E034
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E040 -> 0x0036E0D0
*/
// Range: 0x36E040 -> 0x36E0D0
// this: r16
void alarm::enter_state() {
    /* anonymous block */ {
        // Range: 0x36E040 -> 0x36E0D0
        class security_bird * pBird; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E0D0 -> 0x0036E124
*/
// Range: 0x36E0D0 -> 0x36E124
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E130 -> 0x0036E19C
*/
// Range: 0x36E130 -> 0x36E19C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E1A0 -> 0x0036E1D4
*/
// Range: 0x36E1A0 -> 0x36E1D4
// this: r2
void violet_gun::setup() {
    /* anonymous block */ {
        // Range: 0x36E1A0 -> 0x36E1D4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E1E0 -> 0x0036E354
*/
// Range: 0x36E1E0 -> 0x36E354
// this: r16
violet_gun::violet_gun() {
    /* anonymous block */ {
        // Range: 0x36E1E0 -> 0x36E354
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E3C0 -> 0x0036E434
*/
// Range: 0x36E3C0 -> 0x36E434
// this: r17
void violet_attack::exit_state() {
    /* anonymous block */ {
        // Range: 0x36E3C0 -> 0x36E434
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E450 -> 0x0036E4F4
*/
// Range: 0x36E450 -> 0x36E4F4
// this: r18
void violet_attack::enter_state(class behavior_implementation * prev_behavior /* r17 */) {
    /* anonymous block */ {
        // Range: 0x36E450 -> 0x36E4F4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E500 -> 0x0036E508
*/
// Range: 0x36E500 -> 0x36E508
// this: r2
void violet_shoot::reset() {
    /* anonymous block */ {
        // Range: 0x36E500 -> 0x36E508
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E510 -> 0x0036E568
*/
// Range: 0x36E510 -> 0x36E568
// this: r2
void violet_shoot::exit_state() {
    /* anonymous block */ {
        // Range: 0x36E510 -> 0x36E568
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E570 -> 0x0036E5D0
*/
// Range: 0x36E570 -> 0x36E5D0
// this: r17
void violet_shoot::init() {
    /* anonymous block */ {
        // Range: 0x36E570 -> 0x36E5D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E5D0 -> 0x0036E6AC
*/
// Range: 0x36E5D0 -> 0x36E6AC
// this: r16
void violet_shoot::setup() {
    /* anonymous block */ {
        // Range: 0x36E5D0 -> 0x36E6AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E6B0 -> 0x0036E6F0
*/
// Range: 0x36E6B0 -> 0x36E6F0
// this: r16
unsigned char violet_shoot::runnable() {
    /* anonymous block */ {
        // Range: 0x36E6B0 -> 0x36E6F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E6F0 -> 0x0036E7F4
*/
// Range: 0x36E6F0 -> 0x36E7F4
// this: r16
void violet_shoot::enter_state() {
    /* anonymous block */ {
        // Range: 0x36E6F0 -> 0x36E7F4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E800 -> 0x0036E938
*/
// Range: 0x36E800 -> 0x36E938
// this: r16
void violet_shoot::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x36E800 -> 0x36E938
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036E940 -> 0x0036EBC4
*/
// Range: 0x36E940 -> 0x36EBC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F0C0 -> 0x0036F260
*/
// Range: 0x36F0C0 -> 0x36F260
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F260 -> 0x0036F2B8
*/
// Range: 0x36F260 -> 0x36F2B8
// this: r2
void search::exit_state() {
    /* anonymous block */ {
        // Range: 0x36F260 -> 0x36F2B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F2C0 -> 0x0036F2C8
*/
// Range: 0x36F2C0 -> 0x36F2C8
// this: r2
void search::reset() {
    /* anonymous block */ {
        // Range: 0x36F2C0 -> 0x36F2C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F2D0 -> 0x0036F2FC
*/
// Range: 0x36F2D0 -> 0x36F2FC
// this: r2
unsigned char search::runnable(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x36F2D0 -> 0x36F2FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F300 -> 0x0036F340
*/
// Range: 0x36F300 -> 0x36F340
// this: r16
void search::setup() {
    /* anonymous block */ {
        // Range: 0x36F300 -> 0x36F340
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F340 -> 0x0036F3E4
*/
// Range: 0x36F340 -> 0x36F3E4
// this: r16
void search::enter_state() {
    /* anonymous block */ {
        // Range: 0x36F340 -> 0x36F3E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F3F0 -> 0x0036F444
*/
// Range: 0x36F3F0 -> 0x36F444
void add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x36F3F0 -> 0x36F444
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036F450 -> 0x0036FAA8
*/
// Range: 0x36F450 -> 0x36FAA8
// this: r20
void violet_enemy::render_extra() {
    /* anonymous block */ {
        // Range: 0x36F450 -> 0x36FAA8
        class xVec3 width; // r29+0x298
        class xVec3 pos; // r29+0x288
        class RxObjSpace3DVertex vert[4]; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FAB0 -> 0x0036FAC8
*/
// Range: 0x36FAB0 -> 0x36FAC8
// this: r2
void activating::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x36FAB0 -> 0x36FAC8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FAD0 -> 0x0036FAF8
*/
// Range: 0x36FAD0 -> 0x36FAF8
// this: r2
void activating::enter_state() {
    /* anonymous block */ {
        // Range: 0x36FAD0 -> 0x36FAF8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FB00 -> 0x0036FB44
*/
// Range: 0x36FB00 -> 0x36FB44
// this: r2
unsigned char activating::runnable() {
    /* anonymous block */ {
        // Range: 0x36FB00 -> 0x36FB44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FB50 -> 0x0036FBA4
*/
// Range: 0x36FB50 -> 0x36FBA4
void add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x36FB50 -> 0x36FBA4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FBB0 -> 0x0036FBBC
*/
// Range: 0x36FBB0 -> 0x36FBBC
// this: r2
void activating::reset() {
    /* anonymous block */ {
        // Range: 0x36FBB0 -> 0x36FBBC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FBC0 -> 0x0036FC10
*/
// Range: 0x36FBC0 -> 0x36FC10
// this: r16
void activating::setup() {
    /* anonymous block */ {
        // Range: 0x36FBC0 -> 0x36FC10
    }
}
