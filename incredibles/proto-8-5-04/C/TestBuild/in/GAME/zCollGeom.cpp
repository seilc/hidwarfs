/*
    Compile unit: C:\TestBuild\in\GAME\zCollGeom.cpp
...
static class zCollisionGeomTableEntry sCollisionGeomTable[20]; // size: 0xA0, address: 0x66BB40
static unsigned int sCollisionGeomTableCount; // size: 0x4, address: 0x608BFC
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1120 -> 0x001D1128
*/
// Range: 0x1D1120 -> 0x1D1128
void zCollGeom_CamDisable(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D1120 -> 0x1D1128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1130 -> 0x001D1158
*/
// Range: 0x1D1130 -> 0x1D1158
void zCollGeom_CamEnable(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D1130 -> 0x1D1158
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1160 -> 0x001D1348
*/
// Range: 0x1D1160 -> 0x1D1348
void zCollGeom_Init() {
    /* anonymous block */ {
        // Range: 0x1D1160 -> 0x1D1348
        unsigned int sCollisionGeomTableCount'94; // r3
        unsigned int tmpsize; // r29+0x6C
        unsigned int i; // r20
        unsigned int k; // r19
        void * data; // r2
        unsigned int hash; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1350 -> 0x001D15A0
*/
// Range: 0x1D1350 -> 0x1D15A0
unsigned int zCollGeom_EntSetup(class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D1350 -> 0x1D15A0
        unsigned int i; // r21
        unsigned int j; // r22
        unsigned char auto_cam_coll; // r23
        class zCollGeomTable * tableList; // r2
        class RpAtomic * imodel; // r2
        class xModelInstance * model; // r20
        class xModelInstance * model; // r20
    }
}
