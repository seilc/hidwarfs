/*
    Compile unit: C:\TestBuild\in\GAME\zFlameThrower.cpp
...
class lightweight_system * system; // size: 0x4, address: 0x609494
static class config flamethrower_config; // size: 0x44, address: 0x6BA230
static float length_modifier; // size: 0x4, address: 0x608440
static float radius_modifier; // size: 0x4, address: 0x608444
unsigned char draw_damage; // size: 0x1, address: 0x0
class zFlameThrowerCfg FTCfgDefault; // size: 0x80, address: 0x5F9940
static class zFlameThrowerCfg FTCfgDefault2; // size: 0x80, address: 0x0
class FlameThrowerCollisionInfo flameThrowerCollisionInfo; // size: 0x14, address: 0x6BA280
class RwTexture * particleTex; // size: 0x4, address: 0x609498
class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4, address: 0x6094A0
// total size: 0x20
struct /* @anon1 */ {} flamethrower::__vtable; // size: 0x20, address: 0x604CE0
...
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<flamethrower, 10>::__vtable; // size: 0x20, address: 0x604D30
// total size: 0x24
struct /* @anon2 */ {} z::lightweight_system<flamethrower, 10>::__vtable; // size: 0x24, address: 0x604D00
// total size: 0x24
struct /* @anon3 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
void EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x430280
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x188
class flamethrower : public lightweight {
    // Members
public:
    ...
    class collision_particle coll_particle[10]; // offset 0x48, size 0x140
};
// total size: 0x8
class xCamScreen {
    // Members
...
public:
    ...
    class lightweight_system * * system; // offset 0xF54, size 0x4
...
// total size: 0x44
class zFlameThrowerAsset : public xDynAsset {
    // Members
public:
    class xVec3 position; // offset 0x10, size 0xC
    union { // inferred
        class xVec3 rotation; // offset 0x1C, size 0xC
        class xVec3 direction; // offset 0x1C, size 0xC
    };
    ...
    signed int damage; // offset 0x38, size 0x4
...
public:
    ...
    class zFlameThrowerAsset * asset; // offset 0x18, size 0x4
};
// total size: 0x14
class FlameThrowerCollisionInfo {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042D0A0 -> 0x0042D280
*/
// Range: 0x42D0A0 -> 0x42D280
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042D280 -> 0x0042D37C
*/
// Range: 0x42D280 -> 0x42D37C
// this: r16
class zFlameThrower * zFlameThrowerMgr::GetMem(unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42D280 -> 0x42D37C
        class zFlameThrower * mem; // r2
        class zFlameThrower * prev; // r2
        unsigned int i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042D380 -> 0x0042D418
*/
// Range: 0x42D380 -> 0x42D418
void Reset() {
    /* anonymous block */ {
        // Range: 0x42D380 -> 0x42D418
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042D420 -> 0x0042D440
*/
// Range: 0x42D420 -> 0x42D440
void Remove() {
    /* anonymous block */ {
        // Range: 0x42D420 -> 0x42D440
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042D440 -> 0x0042D9FC
*/
// Range: 0x42D440 -> 0x42D9FC
// this: r29+0xBC
void zFlameThrower::UpdateCollision() {
    /* anonymous block */ {
        // Range: 0x42D440 -> 0x42D9FC
        class xBound bound; // r29+0x140
        class xMat4x3 mat; // r29+0x100
        signed int p; // r20
        class FTParticle & particle; // r3
        float width; // r29+0x1D0
        float height; // r29+0x1D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042DA00 -> 0x0042EB80
*/
// Range: 0x42DA00 -> 0x42EB80
// this: r17
void zFlameThrower::UpdateParticles(float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x42DA00 -> 0x42EB80
        class xMat4x3 & mat; // r16
        float collide_distance; // r29+0x2F0
        unsigned char isActive; // r22
        signed int p; // r21
        class FTParticle & particle; // r20
        float size; // r24
        unsigned char alpha; // r19
        float life; // r29+0x2F0
        signed int count; // r2
        float diffTime; // r29+0x2F0
        class FTParticle * particle; // r13
        class FTParticle * end; // r2
        float t; // r29+0x2F0
        class xVec3 pos; // r29+0x2E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042EB80 -> 0x0042EFB8
*/
// Range: 0x42EB80 -> 0x42EFB8
// this: r29+0xBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042EFC0 -> 0x0042F3A0
*/
// Range: 0x42EFC0 -> 0x42F3A0
void AddTweaks() {
    /* anonymous block */ {
        // Range: 0x42EFC0 -> 0x42F3A0
        char name[64]; // r29+0x50
        char name1[64]; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F3A0 -> 0x0042F504
*/
// Range: 0x42F3A0 -> 0x42F504
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F510 -> 0x0042F95C
*/
// Range: 0x42F510 -> 0x42F95C
// this: r21
void zFlameThrower::Update(float dt /* r20 */, class xMat4x3 & mat /* r20 */) {
    /* anonymous block */ {
        // Range: 0x42F510 -> 0x42F95C
        class xQuat quat; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F960 -> 0x0042F974
*/
// Range: 0x42F960 -> 0x42F974
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F980 -> 0x0042F990
*/
// Range: 0x42F980 -> 0x42F990
// this: r2
void zFlameThrower::DoMgrRender(unsigned char _doMgrRender /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42F980 -> 0x42F990
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F990 -> 0x0042F9A0
*/
// Range: 0x42F990 -> 0x42F9A0
// this: r2
void zFlameThrower::DoMgrUpdate(unsigned char _doMgrUpdate /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42F990 -> 0x42F9A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042F9A0 -> 0x0042FB00
*/
// Range: 0x42F9A0 -> 0x42FB00
// this: r16
void zFlameThrower::Init() {
    /* anonymous block */ {
        // Range: 0x42F9A0 -> 0x42FB00
        unsigned int counter; // @ 0x0060949C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042FB00 -> 0x0042FB44
*/
// Range: 0x42FB00 -> 0x42FB44
// this: r16
zFlameThrower::zFlameThrower(unsigned char _doMgrUpdate /* r2 */, unsigned char _doMgrRender /* r2 */, class zFlameThrowerCfg & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42FB00 -> 0x42FB44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042FB50 -> 0x0042FBC8
*/
// Range: 0x42FB50 -> 0x42FBC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042FBD0 -> 0x0042FE74
*/
// Range: 0x42FBD0 -> 0x42FE74
// this: r2
void flamethrower::collision_emit(class xVec3 & position /* r2 */, class xVec3 & direction /* r2 */, class xVec3 & velocity /* r2 */, float dt /* r29+0x60 */) {
    /* anonymous block */ {
        // Range: 0x42FBD0 -> 0x42FE74
        float time_passed; // r5
        class collision_particle * p; // r17
        class collision_particle * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042FE80 -> 0x00430174
*/
// Range: 0x42FE80 -> 0x430174
// this: r16
void flamethrower::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x42FE80 -> 0x430174
        float length_mod; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00430180 -> 0x00430274
*/
// Range: 0x430180 -> 0x430274
void setup() {
    /* anonymous block */ {
        // Range: 0x430180 -> 0x430274
        char * prefix; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00430280 -> 0x004310B0
*/
// Range: 0x430280 -> 0x4310B0
void EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r19 */) {
    /* anonymous block */ {
        // Range: 0x430280 -> 0x4310B0
        class zFlameThrowerWidget & flameThrowerWidget; // r16
        class flamethrower ft; // r29+0x370
        class flamethrower ft; // r29+0x1E0
        class flamethrower ft; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004310B0 -> 0x00431408
*/
// Range: 0x4310B0 -> 0x431408
void Init(class xBase & data /* r16 */, class xDynAsset & asset /* r19 */) {
    /* anonymous block */ {
        // Range: 0x4310B0 -> 0x431408
    }
}
