/*
    Compile unit: C:\TestBuild\in\GAME\zFire.cpp
...
unsigned char _enabled; // size: 0x1, address: 0x608F3C
unsigned char frame_changed; // size: 0x1, address: 0x608F40
class zFlame * flames; // size: 0x4, address: 0x608F44
unsigned int flames_size; // size: 0x4, address: 0x608F48
unsigned int flames_used; // size: 0x4, address: 0x608F4C
static class card_info short_card_info; // size: 0x1C, address: 0x5EEAC0
static class card_info tall_card_info; // size: 0x1C, address: 0x5EEAE0
static class RwTexture * face_texture; // size: 0x4, address: 0x608F50
static class RwTexture * floor_texture; // size: 0x4, address: 0x608F54
static float anim_frame_time; // size: 0x4, address: 0x608F58
static signed int anim_frame; // size: 0x4, address: 0x608F5C
static class zFlame * im_flames[48]; // size: 0xC0, address: 0x686AD0
static signed int im_flames_size; // size: 0x4, address: 0x608F60
static signed int last_brightness; // size: 0x4, address: 0x608F64
static signed int last_background_glow; // size: 0x4, address: 0x608F68
static class zSmokeEmitter * smoke_emitter; // size: 0x4, address: 0x608F6C
static class RwTexture * wisp_texture; // size: 0x4, address: 0x608F70
static signed int wisp_system_id; // size: 0x4, address: 0x608F74
static signed int spawn_explosion_type; // size: 0x4, address: 0x608F78
...
signed int update_wisp_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x2B4610
// total size: 0x70
class RpAtomic {
    // Members
public:
...
public:
    ...
    unsigned int pad2; // offset 0x98, size 0x4
    unsigned int pad3; // offset 0x9C, size 0x4
};
// total size: 0x10
...
public:
    ...
    class xVec3 vel_dir; // offset 0x2C, size 0xC
    float vel_dir_vary; // offset 0x38, size 0x4
    float wind; // offset 0x3C, size 0x4
    class xColor_tag color_birth; // offset 0x40, size 0x4
    class xColor_tag color_death; // offset 0x44, size 0x4
    signed int texture_columns; // offset 0x48, size 0x4
    signed int texture_rows; // offset 0x4C, size 0x4
};
// total size: 0x68
class xScene {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1330 -> 0x002B1538
*/
// Range: 0x2B1330 -> 0x2B1538
// this: r16
void zFlame::refresh_nearby() {
    /* anonymous block */ {
        // Range: 0x2B1330 -> 0x2B1538
        class zFlame * found[16]; // r29+0xC0
        signed int found_size; // r2
        class zFlame * * n; // r7
        class zFlame * * endn; // r2
        class flame_distance_pair pairs[16]; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1540 -> 0x002B15B8
*/
// Range: 0x2B1540 -> 0x2B15B8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B15C0 -> 0x002B16FC
*/
// Range: 0x2B15C0 -> 0x2B16FC
// this: r16
void zFlame::emit_smoke(float dheat /* r29+0x80 */, float dt /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x2B15C0 -> 0x2B16FC
        float rate; // r2
        signed int emit; // r17
        class zSmokeSphereVolume volume; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1700 -> 0x002B18BC
*/
// Range: 0x2B1700 -> 0x2B18BC
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B18C0 -> 0x002B1A68
*/
// Range: 0x2B18C0 -> 0x2B1A68
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1A70 -> 0x002B1C14
*/
// Range: 0x2B1A70 -> 0x2B1C14
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1C20 -> 0x002B1E24
*/
// Range: 0x2B1C20 -> 0x2B1E24
void destroy(class handle h /* r29+0x3C */) {
    /* anonymous block */ {
        // Range: 0x2B1C20 -> 0x2B1E24
        class handle h'93; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1E30 -> 0x002B2448
*/
// Range: 0x2B1E30 -> 0x2B2448
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B2450 -> 0x002B2A90
*/
// Range: 0x2B2450 -> 0x2B2A90
class handle emit(class spawn_data & params /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B2450 -> 0x2B2A90
        class handle h; // r29+0x20C
        class spawn_data d; // r29+0x1A0
        class xVec3 start; // r29+0x1F0
        class xVec3 end; // r29+0x1E0
        class xSweptSphere sws; // r29+0xD0
        float overlap_radius; // r29+0x210
        class zFlame * nearbies[6]; // r29+0xB0
        signed int nearbies_size; // r2
        class zFlame * * nearby; // r20
        class zFlame * * end_nearby; // r2
        class zFlame * nearby; // r29+0x208
        class zFlame * flame; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B2A90 -> 0x002B3300
*/
// Range: 0x2B2A90 -> 0x2B3300
void render() {
    /* anonymous block */ {
        // Range: 0x2B2A90 -> 0x2B3300
        signed int min_alpha; // r2
        class xMat4x3 & cam_mat; // r2
        class RxObjSpace3DVertex * begin_face_vert; // r20
        class RxObjSpace3DVertex * face_vert; // r13
        class RxObjSpace3DVertex * begin_floor_vert; // r19
        class RxObjSpace3DVertex * floor_vert; // r12
        class zFlame * * it; // r11
        class zFlame * * end; // r2
        class zFlame * flame; // r10
        ...
        float py; // r28
        float pz; // r27
        class xVec3 at; // r29+0xC0
        class xVec3 up; // r29+0xB0
        unsigned short * face_index; // r9
        unsigned short * floor_index; // r8
        unsigned short * end_face_index; // r2
        signed int face_verts_used; // r7
        signed int floor_verts_used; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B3300 -> 0x002B42A4
*/
// Range: 0x2B3300 -> 0x2B42A4
void pre_render() {
    /* anonymous block */ {
        // Range: 0x2B3300 -> 0x2B42A4
        signed int rs_flags; // r16
        unsigned char min_glow; // r2
        class ptank_pool__color_mat_uv2 face_pool; // r29+0x110
        class ptank_pool__color_mat_uv2 floor_pool; // r29+0xE0
        class xMat4x3 & cam_mat; // r2
        class zFlame * flame; // r20
        class zFlame * end_flame; // r2
        float effect_radius; // r7
        class xVec3 effect_center; // r29+0x1B0
        float cx; // r29+0x1C0
        float cz; // r29+0x1C0
        signed int uvindex; // r2
        float u; // r4
        float v; // r29+0x1C0
        class xColor_tag color; // r29+0x1BC
        class xMat4x3 & face_mat; // r2
        float floor_width; // r25
        float floor_height; // r24
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B42B0 -> 0x002B446C
*/
// Range: 0x2B42B0 -> 0x2B446C
void update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B42B0 -> 0x2B446C
        class spawn_data sd; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B4470 -> 0x002B4488
*/
// Range: 0x2B4470 -> 0x2B4488
void reset() {
    /* anonymous block */ {
        // Range: 0x2B4470 -> 0x2B4488
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B4490 -> 0x002B44D0
*/
// Range: 0x2B4490 -> 0x2B44D0
void setup() {
    /* anonymous block */ {
        // Range: 0x2B4490 -> 0x2B44D0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B44D0 -> 0x002B44DC
*/
// Range: 0x2B44D0 -> 0x2B44DC
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x2B44D0 -> 0x2B44DC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B44E0 -> 0x002B4608
*/
// Range: 0x2B44E0 -> 0x2B4608
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x2B44E0 -> 0x2B4608
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B4610 -> 0x002B4A74
*/
// Range: 0x2B4610 -> 0x2B4A74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B4A80 -> 0x002B4D78
*/
// Range: 0x2B4A80 -> 0x2B4D78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B4D80 -> 0x002B4E30
*/
// Range: 0x2B4D80 -> 0x2B4E30
