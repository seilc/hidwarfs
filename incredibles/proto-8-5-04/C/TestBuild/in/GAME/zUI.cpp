/*
    Compile unit: C:\TestBuild\in\GAME\zUI.cpp
...
unsigned char bAllowInput; // size: 0x1, address: 0x607720
static void * (* staticAllocator)(unsigned int, void *); // size: 0x4, address: 0x60883C
static void * staticUser; // size: 0x4, address: 0x608840
static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, class xBase *, unsigned int, void *); // size: 0x4, address: 0x608844
static void * signalUser; // size: 0x4, address: 0x608848
// total size: 0x50
struct /* @anon0 */ {} zUI::__vtable; // size: 0x50, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
unsigned char gDontAutoMenu; // size: 0x1, address: 0x6096F0
class zUICustom * pSysMessageManager_Custom; // size: 0x4, address: 0x6096FC
unsigned char gSysMessageManager_active; // size: 0x1, address: 0x6096F4
class _tagTRCPadInfo gTrcPad[4]; // size: 0x30, address: 0x66B400
class zGlobals globals; // size: 0x640, address: 0x61C210
class zUI * pSysMessageManager; // size: 0x4, address: 0x6096F8
void UIEventHandler(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1576F0
enum _tagPadInit {
    ePadInit_Open1 = 0,
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001551F0 -> 0x001551FC
*/
// Range: 0x1551F0 -> 0x1551FC
void zUISetCustomSignalHandler(void (* handler)(class zUI *, unsigned int, unsigned int, float *, class xBase *, unsigned int, void *) /* r2 */, void * user /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1551F0 -> 0x1551FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155200 -> 0x0015520C
*/
// Range: 0x155200 -> 0x15520C
void zUISetCustomStaticAllocator(void * (* allocator)(unsigned int, void *) /* r2 */, void * user /* r2 */) {
    /* anonymous block */ {
        // Range: 0x155200 -> 0x15520C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155210 -> 0x0015524C
*/
// Range: 0x155210 -> 0x15524C
void * zUIAllocStaticMemory(unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x155210 -> 0x15524C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155250 -> 0x001553A0
*/
// Range: 0x155250 -> 0x1553A0
// this: r17
void zUI::Unselect() {
    /* anonymous block */ {
        // Range: 0x155250 -> 0x1553A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001553A0 -> 0x001554F4
*/
// Range: 0x1553A0 -> 0x1554F4
// this: r17
void zUI::Select() {
    /* anonymous block */ {
        // Range: 0x1553A0 -> 0x1554F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155500 -> 0x00155530
*/
// Range: 0x155500 -> 0x155530
// this: r2
void zUI::Invisible() {
    /* anonymous block */ {
        // Range: 0x155500 -> 0x155530
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155530 -> 0x0015557C
*/
// Range: 0x155530 -> 0x15557C
// this: r16
void zUI::Visible() {
    /* anonymous block */ {
        // Range: 0x155530 -> 0x15557C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155580 -> 0x001555E0
*/
// Range: 0x155580 -> 0x1555E0
// this: r16
void zUI::FocusOff() {
    /* anonymous block */ {
        // Range: 0x155580 -> 0x1555E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001555E0 -> 0x00155644
*/
// Range: 0x1555E0 -> 0x155644
// this: r16
void zUI::FocusOn() {
    /* anonymous block */ {
        // Range: 0x1555E0 -> 0x155644
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155650 -> 0x00155930
*/
// Range: 0x155650 -> 0x155930
// this: r20
void zUI::AutoMenu(void item /* r19 */, unsigned int event /* r18 */) {
    /* anonymous block */ {
        // Range: 0x155650 -> 0x155930
        class zUI * ui; // r17
        unsigned int id; // r2
        unsigned char bAllowAutoMenu; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155940 -> 0x00155A14
*/
// Range: 0x155940 -> 0x155A14
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155A20 -> 0x00155A84
*/
// Range: 0x155A20 -> 0x155A84
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00155A90 -> 0x001567F0
*/
// Range: 0x155A90 -> 0x1567F0
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001567F0 -> 0x001568A8
*/
// Range: 0x1567F0 -> 0x1568A8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001568B0 -> 0x001568B8
*/
// Range: 0x1568B0 -> 0x1568B8
void DoExit() {
    /* anonymous block */ {
        // Range: 0x1568B0 -> 0x1568B8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001568C0 -> 0x00156CE0
*/
// Range: 0x1568C0 -> 0x156CE0
// this: r18
void zUI::DoUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1568C0 -> 0x156CE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00156CE0 -> 0x0015721C
*/
// Range: 0x156CE0 -> 0x15721C
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157220 -> 0x00157290
*/
// Range: 0x157220 -> 0x157290
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157290 -> 0x00157334
*/
// Range: 0x157290 -> 0x157334
// this: r16
void zUI::DoReset() {
    /* anonymous block */ {
        // Range: 0x157290 -> 0x157334
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157340 -> 0x00157348
*/
// Range: 0x157340 -> 0x157348
void DoSetup() {
    /* anonymous block */ {
        // Range: 0x157340 -> 0x157348
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157350 -> 0x001573C8
*/
// Range: 0x157350 -> 0x1573C8
// this: r16
void zUI::DoInit() {
    /* anonymous block */ {
        // Range: 0x157350 -> 0x1573C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001573D0 -> 0x0015760C
*/
// Range: 0x1573D0 -> 0x15760C
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157620 -> 0x00157628
*/
// Range: 0x157620 -> 0x157628
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00157630 -> 0x001576F0
*/
// Range: 0x157630 -> 0x1576F0
void zUI_Init(class zUI * text /* r17 */, class zUIAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x157630 -> 0x1576F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001576F0 -> 0x00157790
*/
// Range: 0x1576F0 -> 0x157790
