/*
    Compile unit: C:\TestBuild\in\GAME\zTransient.cpp
...
unsigned char cb_check_damage(class entry_data *, void *); // size: 0x0, address: 0x2D4090
...
public:
    ...
    class property_set props; // offset 0x68, size 0x8
    unsigned int flames_size; // offset 0x70, size 0x4
    float oscil; // offset 0x74, size 0x4
};
enum iSndHandle {
};
// total size: 0x1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3CE0 -> 0x002D3DE0
*/
// Range: 0x2D3CE0 -> 0x2D3DE0
signed int check_damage(class damage_result * results /* r2 */, class xBox & box /* r17 */, signed int max_results /* r2 */, signed int type_filter /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D3CE0 -> 0x2D3DE0
        class check_damage_data data; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3DE0 -> 0x002D3E04
*/
// Range: 0x2D3DE0 -> 0x2D3E04
void render() {
    /* anonymous block */ {
        // Range: 0x2D3DE0 -> 0x2D3E04
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3E10 -> 0x002D3E3C
*/
// Range: 0x2D3E10 -> 0x2D3E3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3E40 -> 0x002D3E6C
*/
// Range: 0x2D3E40 -> 0x2D3E6C
void reset() {
    /* anonymous block */ {
        // Range: 0x2D3E40 -> 0x2D3E6C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3E70 -> 0x002D3E78
*/
// Range: 0x2D3E70 -> 0x2D3E78
void setup() {
    /* anonymous block */ {
        // Range: 0x2D3E70 -> 0x2D3E78
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3E80 -> 0x002D3EAC
*/
// Range: 0x2D3E80 -> 0x2D3EAC
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x2D3E80 -> 0x2D3EAC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D3EB0 -> 0x002D4090
*/
// Range: 0x2D3EB0 -> 0x2D4090
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x2D3EB0 -> 0x2D4090
        class xBox world_box; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4090 -> 0x002D42B4
*/
// Range: 0x2D4090 -> 0x2D42B4
static unsigned char cb_check_damage(class entry_data * e /* r19 */, void * context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D4090 -> 0x2D42B4
        class check_damage_data * data; // r18
        class damage_result & result; // r17
        class zFlame * flame; // r2
        class presence_volume * plode; // r16
    }
}
