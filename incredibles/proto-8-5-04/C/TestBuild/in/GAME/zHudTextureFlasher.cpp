/*
    Compile unit: C:\TestBuild\in\GAME\zHudTextureFlasher.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7DC0 -> 0x002A7E10
*/
// Range: 0x2A7DC0 -> 0x2A7E10
// this: r2
void TextureFlasher::setFlashingParams(float offTime /* r29 */, float onTime /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2A7DC0 -> 0x2A7E10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7E10 -> 0x002A7F40
*/
// Range: 0x2A7E10 -> 0x2A7F40
// this: r16
void TextureFlasher::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2A7E10 -> 0x2A7F40
        float timeoff; // r29+0x30
        float fPercentDecay; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7F40 -> 0x002A7F4C
*/
// Range: 0x2A7F40 -> 0x2A7F4C
// this: r2
void TextureFlasher::setCallback(unsigned char (* callback)(void *, class TextureFlasher *) /* r2 */, void * context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A7F40 -> 0x2A7F4C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7F50 -> 0x002A7F70
*/
// Range: 0x2A7F50 -> 0x2A7F70
// this: r2
void TextureFlasher::setup(class image_widget * pImageWidget /* r2 */, unsigned int uLayer /* r2 */, float onTime /* r29 */, float offTime /* r29 */, float decayTime /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2A7F50 -> 0x2A7F70
    }
}
