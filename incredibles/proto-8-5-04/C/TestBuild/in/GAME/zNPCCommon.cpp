/*
    Compile unit: C:\TestBuild\in\GAME\zNPCCommon.cpp
...
// total size: 0xB4
struct /* @anon2 */ {} zNPC::common::__vtable; // size: 0xB4, address: 0x604280
void xSkyDome_EmptyRender(class xEnt *); // size: 0x0, address: 0x1D0B50
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
unsigned int xUpdateCull_AlwaysTrueCB(void *, void *); // size: 0x0, address: 0x1F1530
...
void BeforeAnimMatrices(class xAnimPlay *, class xQuat *, class xVec3 *, signed int); // size: 0x0, address: 0x342180
class xVec3 g_O3; // size: 0xC, address: 0x5E77C0
void render_wrapper(class xEnt *); // size: 0x0, address: 0x342AB0
void bupdate_wrapper(class xEnt *, class xVec3 *); // size: 0x0, address: 0x342B40
void move_wrapper(class xEnt *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x342B90
void update_wrapper(class xEnt *, class xScene *, float); // size: 0x0, address: 0x342BE0
void event_wrapper(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x342B00
...
// total size: 0x38
struct /* @anon1 */ {} zNPC::base::__vtable; // size: 0x38, address: 0x5FD7D0
// total size: 0x4C
struct /* @anon0 */ {} behavior_manager::__vtable; // size: 0x4C, address: 0x604200
class xBase * update_cull_cb(class xBase *, class zScene *, void *); // size: 0x0, address: 0x342E40
// total size: 0x2C0
...
// total size: 0x100
class zDuplicator : public xEnt {
    // Members
public:
    class common * avatar; // offset 0xDC, size 0x4
    unsigned char need_reset; // offset 0xE0, size 0x1
    unsigned char active; // offset 0xE1, size 0x1
    signed int npcs_alive; // offset 0xE4, size 0x4
    signed int npcs_healthy; // offset 0xE8, size 0x4
    signed int npcs_spawned; // offset 0xEC, size 0x4
    unsigned int spawn_event; // offset 0xF0, size 0x4
    float time_till_next_spawn; // offset 0xF4, size 0x4
    class common * * npc_pool; // offset 0xF8, size 0x4
    class zDuplicatorAsset * duplicator_asset; // offset 0xFC, size 0x4
};
// total size: 0x0
class xOneLiner {};
// total size: 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340DD0 -> 0x00340DD8
*/
// Range: 0x340DD0 -> 0x340DD8
void init_system() {
    /* anonymous block */ {
        // Range: 0x340DD0 -> 0x340DD8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340DE0 -> 0x00340E44
*/
// Range: 0x340DE0 -> 0x340E44
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340E50 -> 0x003410D0
*/
// Range: 0x340E50 -> 0x3410D0
// this: r16
void common::reset() {
    /* anonymous block */ {
        // Range: 0x340E50 -> 0x3410D0
        float scale; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003410D0 -> 0x0034159C
*/
// Range: 0x3410D0 -> 0x34159C
// this: r16
void common::setup() {
    /* anonymous block */ {
        // Range: 0x3410D0 -> 0x34159C
        signed int hit_points; // r29+0xCC
        char * table; // r29+0xC8
        float scale; // r29+0xC4
        class xSphere s; // r29+0xA0
        char * group_name; // r29+0xC0
        char prefix[128]; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003415A0 -> 0x00341620
*/
// Range: 0x3415A0 -> 0x341620
// this: r2
void common::set_shadow_strength(float percent /* r29 */) {
    /* anonymous block */ {
        // Range: 0x3415A0 -> 0x341620
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341620 -> 0x003419F4
*/
// Range: 0x341620 -> 0x3419F4
// this: r20
unsigned char common::system_event(class xBase * from /* r19 */, class xBase * to /* r21 */, unsigned int to_event /* r18 */, float * to_param /* r17 */, class xBase * to_param_widget /* r16 */, unsigned int to_param_widget_id /* r22 */) {
    /* anonymous block */ {
        // Range: 0x341620 -> 0x3419F4
        class FloatAndVoid dist; // r29+0xBC
        class zCombatDamageInfo info; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341A00 -> 0x00341A08
*/
// Range: 0x341A00 -> 0x341A08
void debug_render() {
    /* anonymous block */ {
        // Range: 0x341A00 -> 0x341A08
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341A10 -> 0x00341A60
*/
// Range: 0x341A10 -> 0x341A60
// this: r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341A60 -> 0x00341A90
*/
// Range: 0x341A60 -> 0x341A90
// this: r2
unsigned char common::punchable() {
    /* anonymous block */ {
        // Range: 0x341A60 -> 0x341A90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341A90 -> 0x00341AB8
*/
// Range: 0x341A90 -> 0x341AB8
// this: r2
signed int common::grabOffset(class xVec3 * offset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x341A90 -> 0x341AB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341AC0 -> 0x00341AF0
*/
// Range: 0x341AC0 -> 0x341AF0
// this: r2
unsigned char common::grabbable(enum GrabType grabType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x341AC0 -> 0x341AF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341AF0 -> 0x00341B00
*/
// Range: 0x341AF0 -> 0x341B00
// this: r2
unsigned char common::alive() {
    /* anonymous block */ {
        // Range: 0x341AF0 -> 0x341B00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341B00 -> 0x00341C88
*/
// Range: 0x341B00 -> 0x341C88
// this: r17
void common::kill(unsigned char still_collide /* r16 */) {
    /* anonymous block */ {
        // Range: 0x341B00 -> 0x341C88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341C90 -> 0x00341D24
*/
// Range: 0x341C90 -> 0x341D24
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341D30 -> 0x00341DCC
*/
// Range: 0x341D30 -> 0x341DCC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341DD0 -> 0x00341E40
*/
// Range: 0x341DD0 -> 0x341E40
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341E40 -> 0x00341E50
*/
// Range: 0x341E40 -> 0x341E50
// this: r2
void common::revive() {
    /* anonymous block */ {
        // Range: 0x341E40 -> 0x341E50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341E50 -> 0x00342154
*/
// Range: 0x341E50 -> 0x342154
// this: r17
void common::init_npc(class xEntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x341E50 -> 0x342154
        unsigned int bufsize; // r29+0x38
        void * info; // r2
        unsigned char tempBool; // r29+0x3F
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342160 -> 0x00342178
*/
// Range: 0x342160 -> 0x342178
// this: r2
void common::before_anim_matrices(class xAnimPlay * play /* r2 */, class xQuat * quat /* r2 */, class xVec3 * tran /* r2 */, signed int boneCount /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342160 -> 0x342178
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342180 -> 0x003421AC
*/
// Range: 0x342180 -> 0x3421AC
void BeforeAnimMatrices(class xAnimPlay * play /* r4 */, class xQuat * quat /* r3 */, class xVec3 * tran /* r2 */, signed int boneCount /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342180 -> 0x3421AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003421B0 -> 0x003421C8
*/
// Range: 0x3421B0 -> 0x3421C8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003421D0 -> 0x003422A8
*/
// Range: 0x3421D0 -> 0x3422A8
// this: r17
void common::damage(class zCombatDamageInfo & damageInfo /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3421D0 -> 0x3422A8
        class zCombatDamageInfo newInfo; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003422B0 -> 0x00342344
*/
// Range: 0x3422B0 -> 0x342344
// this: r2
unsigned char common::valid_damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3422B0 -> 0x342344
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342350 -> 0x00342490
*/
// Range: 0x342350 -> 0x342490
// this: r2
void common::deliver_damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342350 -> 0x342490
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342490 -> 0x003424B8
*/
// Range: 0x342490 -> 0x3424B8
// this: r2
class zCombat * common::get_combat() {
    /* anonymous block */ {
        // Range: 0x342490 -> 0x3424B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003424C0 -> 0x003424D8
*/
// Range: 0x3424C0 -> 0x3424D8
// this: r2
void common::add_transitions(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3424C0 -> 0x3424D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003424E0 -> 0x003424F8
*/
// Range: 0x3424E0 -> 0x3424F8
// this: r2
void common::add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3424E0 -> 0x3424F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342500 -> 0x00342734
*/
// Range: 0x342500 -> 0x342734
// this: r16
void common::update_npc(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x342500 -> 0x342734
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342740 -> 0x003429AC
*/
// Range: 0x342740 -> 0x3429AC
// this: r21
void common::check_transient_damage() {
    /* anonymous block */ {
        // Range: 0x342740 -> 0x3429AC
        class damage_result hits[8]; // r29+0x110
        class xBox box; // r29+0xF0
        signed int hits_found; // r2
        class damage_result * hit; // r20
        class damage_result * end_hit; // r2
        class xVec3 hitdir; // r29+0x410
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003429B0 -> 0x003429F0
*/
// Range: 0x3429B0 -> 0x3429F0
// this: r2
unsigned char common::can_attack() {
    /* anonymous block */ {
        // Range: 0x3429B0 -> 0x3429F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003429F0 -> 0x00342A6C
*/
// Range: 0x3429F0 -> 0x342A6C
// this: r17
common::~common() {
    /* anonymous block */ {
        // Range: 0x3429F0 -> 0x342A6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342A70 -> 0x00342AA8
*/
// Range: 0x342A70 -> 0x342AA8
// this: r2
common::common() {
    /* anonymous block */ {
        // Range: 0x342A70 -> 0x342AA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342AB0 -> 0x00342B00
*/
// Range: 0x342AB0 -> 0x342B00
static void render_wrapper(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342AB0 -> 0x342B00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342B00 -> 0x00342B38
*/
// Range: 0x342B00 -> 0x342B38
static void event_wrapper(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r6 */, float * toParam /* r3 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342B00 -> 0x342B38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342B40 -> 0x00342B84
*/
// Range: 0x342B40 -> 0x342B84
static void bupdate_wrapper(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342B40 -> 0x342B84
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342B90 -> 0x00342BD4
*/
// Range: 0x342B90 -> 0x342BD4
static void move_wrapper(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x342B90 -> 0x342BD4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342BE0 -> 0x00342E1C
*/
// Range: 0x342BE0 -> 0x342E1C
static void update_wrapper(class xEnt * ent /* r17 */, class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x342BE0 -> 0x342E1C
        class common * npc; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342E20 -> 0x00342E34
*/
// Range: 0x342E20 -> 0x342E34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342E40 -> 0x00342EEC
*/
// Range: 0x342E40 -> 0x342EEC
static class xBase * update_cull_cb(class xBase * b /* r17 */) {
    /* anonymous block */ {
        // Range: 0x342E40 -> 0x342EEC
    }
}
