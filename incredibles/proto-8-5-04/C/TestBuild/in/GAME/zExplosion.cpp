/*
    Compile unit: C:\TestBuild\in\GAME\zExplosion.cpp
...
static char ini_filename[12]; // size: 0xC, address: 0x5EF950
static char * decal_type_labels[4]; // size: 0x10, address: 0x0
static unsigned int decal_type_ids[4]; // size: 0x10, address: 0x5EF960
static signed int decal_blend_mode[3]; // size: 0xC, address: 0x5EF970
static signed int decal_flags[3]; // size: 0xC, address: 0x5EF980
static class curve_node decal_anim_impact[3]; // size: 0x54, address: 0x5EF990
static class curve_node decal_anim_burn[7]; // size: 0xC4, address: 0x5EF9F0
static class curve_node decal_anim_plasma[3]; // size: 0x54, address: 0x5EFAC0
static class xResponseCurve decal_curve[3]; // size: 0x30, address: 0x6889D0
static class mote * motes; // size: 0x4, address: 0x608FC4
static signed int motes_used; // size: 0x4, address: 0x608FC8
static class streak_particle * streaks; // size: 0x4, address: 0x608FCC
static signed int streaks_used; // size: 0x4, address: 0x608FD0
static class streak_emitter * streak_emitters; // size: 0x4, address: 0x608FD4
static signed int streak_emitters_used; // size: 0x4, address: 0x608FD8
static class streak_group * streak_groups; // size: 0x4, address: 0x608FDC
static signed int streak_groups_used; // size: 0x4, address: 0x608FE0
static class spark_particle * sparks; // size: 0x4, address: 0x608FE4
static signed int sparks_used; // size: 0x4, address: 0x608FE8
static class spark_emitter * spark_emitters; // size: 0x4, address: 0x608FEC
static signed int spark_emitters_used; // size: 0x4, address: 0x608FF0
static class spark_group * spark_groups; // size: 0x4, address: 0x608FF4
static signed int spark_groups_used; // size: 0x4, address: 0x608FF8
static class xVec3 current_cam_at; // size: 0xC, address: 0x0
static float current_cam_depth; // size: 0x4, address: 0x0
static class ini_config * ini_configs; // size: 0x4, address: 0x608FFC
static class runtime_config * runtime_configs; // size: 0x4, address: 0x609000
static class material_group * materials; // size: 0x4, address: 0x609004
static unsigned int configs_size; // size: 0x4, address: 0x609008
static signed int materials_used; // size: 0x4, address: 0x60900C
static class presence_node presi[32]; // size: 0x780, address: 0x688A00
static signed int presi_size; // size: 0x4, address: 0x609010
static class curve_node fire_curve_nodes[4]; // size: 0x60, address: 0x0
static class curve_node plasma_curve_nodes[4]; // size: 0x60, address: 0x0
static class default_type_loader default_types[5]; // size: 0x28, address: 0x5EFB20
...
signed int compare_ini_sections(void *, void *); // size: 0x0, address: 0x2D9200
signed int compare_ini_values(void *, void *); // size: 0x0, address: 0x2D91F0
...
class /* @class */ {
    // Members
public:
    class RwTexture * fire; // offset 0x0, size 0x4
    class RwTexture * smoke; // offset 0x4, size 0x4
    class RwTexture * streak; // offset 0x8, size 0x4
    class RwTexture * spark; // offset 0xC, size 0x4
    class RwTexture * glare; // offset 0x10, size 0x4
    class RwTexture * decal; // offset 0x14, size 0x4
};
// total size: 0x8
class spark_group {
    // Members
...
public:
    ...
    class anim_data anim; // offset 0x2C, size 0x14
};
// total size: 0x8
class xCamScreen {
    // Members
...
// total size: 0x3C
class presence_node : public presence_volume {
    // Members
public:
    ...
    class entry_data * space_entry; // offset 0x34, size 0x4
    class trail_emitter * trail; // offset 0x38, size 0x4
};
// total size: 0x8
...
public:
    float t; // offset 0x0, size 0x4
    class anim_data anim; // offset 0x4, size 0x14
};
// total size: 0xC
class xIniSection {
    // Members
...
public:
    ...
    class curve_node * anim; // offset 0x74, size 0x4
    unsigned int anim_size; // offset 0x78, size 0x4
    class glare_config glare; // offset 0x7C, size 0xC
    // total size: 0x14
    class /* @class */ {
        // Members
    public:
    ...
    class streak_config streak; // offset 0x9C, size 0x28
    class spark_config spark; // offset 0xC4, size 0x28
    class shake_config shake; // offset 0xEC, size 0x14
    class presence_config presence; // offset 0x100, size 0x24
    class decal_config decal; // offset 0x124, size 0x14
    // total size: 0x18
    class /* @class */ {
        // Members
    public:
...
public:
    ...
    signed int material_index; // offset 0x38, size 0x4
    signed int streak_group_index; // offset 0x3C, size 0x4
    signed int spark_group_index; // offset 0x40, size 0x4
    class xResponseCurve anim; // offset 0x44, size 0x10
    class glare_config glare; // offset 0x54, size 0xC
    // total size: 0x14
    class /* @class */ {
        // Members
    public:
    ...
    class streak_config streak; // offset 0x74, size 0x28
    class spark_config spark; // offset 0x9C, size 0x28
    class shake_config shake; // offset 0xC4, size 0x14
    class presence_config presence; // offset 0xD8, size 0x24
    class decal_config decal; // offset 0xFC, size 0x14
    // total size: 0x18
    class /* @class */ {
        // Members
    public:
...
class material_group {
    // Members
public:
    class RwTexture * texture_fire; // offset 0x0, size 0x4
    class RwTexture * texture_smoke; // offset 0x4, size 0x4
};
// total size: 0x14
...
// total size: 0x8
class default_type_loader {
    // Members
public:
    char * name; // offset 0x0, size 0x4
    void (* load)(class ini_config &); // offset 0x4, size 0x4
};
// total size: 0xC
class RxClusterRef {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D42C0 -> 0x002D4624
*/
// Range: 0x2D42C0 -> 0x2D4624
// this: r18
void trail_emitter::update(class xVec3 & loc /* r17 */, float dt /* r21 */, float intensity /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D42C0 -> 0x2D4624
        class runtime_config & cfg; // r16
        signed int emit_rand; // r4
        signed int emit_total; // r2
        signed int motes_available; // r2
        class xVec3 & loc0; // r2
        class xVec3 offset; // r29+0x70
        signed int streak_amount; // r2
        signed int spark_amount; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4630 -> 0x002D47A0
*/
// Range: 0x2D4630 -> 0x2D47A0
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D47A0 -> 0x002D49E4
*/
// Range: 0x2D47A0 -> 0x2D49E4
// this: r18
void trail_emitter::start(signed int type /* r2 */, class xVec3 & loc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2D47A0 -> 0x2D49E4
        class runtime_config & cfg; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D49F0 -> 0x002D4E2C
*/
// Range: 0x2D49F0 -> 0x2D4E2C
void emit(signed int type /* r20 */, class xVec3 & loc /* r19 */) {
    /* anonymous block */ {
        // Range: 0x2D49F0 -> 0x2D4E2C
        class runtime_config & cfg; // r18
        unsigned int motes_available; // r17
        unsigned int motes_required; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4E30 -> 0x002D4E74
*/
// Range: 0x2D4E30 -> 0x2D4E74
signed int find_type(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D4E30 -> 0x2D4E74
        signed int i; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4E80 -> 0x002D4E88
*/
// Range: 0x2D4E80 -> 0x2D4E88
void render() {
    /* anonymous block */ {
        // Range: 0x2D4E80 -> 0x2D4E88
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4E90 -> 0x002D4E98
*/
// Range: 0x2D4E90 -> 0x2D4E98
void pre_render() {
    /* anonymous block */ {
        // Range: 0x2D4E90 -> 0x2D4E98
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4EA0 -> 0x002D4F48
*/
// Range: 0x2D4EA0 -> 0x2D4F48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4F50 -> 0x002D4F58
*/
// Range: 0x2D4F50 -> 0x2D4F58
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x2D4F50 -> 0x2D4F58
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D4F60 -> 0x002D504C
*/
// Range: 0x2D4F60 -> 0x2D504C
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x2D4F60 -> 0x2D504C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5050 -> 0x002D5058
*/
// Range: 0x2D5050 -> 0x2D5058
void startup() {
    /* anonymous block */ {
        // Range: 0x2D5050 -> 0x2D5058
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5060 -> 0x002D5154
*/
// Range: 0x2D5060 -> 0x2D5154
static void paint_decals(class xVec3 & loc /* r17 */, class runtime_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D5060 -> 0x2D5154
        class emit_context ec; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5160 -> 0x002D55A8
*/
// Range: 0x2D5160 -> 0x2D55A8
static void load_runtime_configs() {
    /* anonymous block */ {
        // Range: 0x2D5160 -> 0x2D55A8
        class ini_config * icfg; // r18
        class ini_config * end_icfg; // r2
        class runtime_config * ocfg; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D55B0 -> 0x002D5820
*/
// Range: 0x2D55B0 -> 0x2D5820
static void update_sparks(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D55B0 -> 0x2D5820
        class spark_particle * spark; // r7
        class spark_particle * end_spark; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5820 -> 0x002D599C
*/
// Range: 0x2D5820 -> 0x2D599C
static void update_spark_emitters(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D5820 -> 0x2D599C
        class spark_emitter * emitter; // r17
        class spark_emitter * end_emitter; // r16
        float time; // r2
        class runtime_config & cfg; // r2
        signed int emit; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D59A0 -> 0x002D5C60
*/
// Range: 0x2D59A0 -> 0x2D5C60
static void update_streaks(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D59A0 -> 0x2D5C60
        class streak_particle * streak; // r6
        class streak_particle * end_streak; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5C60 -> 0x002D5DDC
*/
// Range: 0x2D5C60 -> 0x2D5DDC
static void update_streak_emitters(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D5C60 -> 0x2D5DDC
        class streak_emitter * emitter; // r17
        class streak_emitter * end_emitter; // r16
        float time; // r2
        class runtime_config & cfg; // r2
        signed int emit; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5DE0 -> 0x002D5F1C
*/
// Range: 0x2D5DE0 -> 0x2D5F1C
static void update_motes(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D5DE0 -> 0x2D5F1C
        class mote * m; // r17
        class mote * endm; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D5F20 -> 0x002D6180
*/
// Range: 0x2D5F20 -> 0x2D6180
static void update_presence(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D5F20 -> 0x2D6180
        class presence_node * presence; // r20
        class presence_node * end; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6180 -> 0x002D6370
*/
// Range: 0x2D6180 -> 0x2D6370
static class presence_node * create_presence(class xVec3 & center /* r2 */, float delay /* r29+0x30 */, float life /* r29+0x30 */, float knockback /* r29+0x30 */, float radius_begin /* r29+0x30 */, float radius_end /* r29+0x30 */, float damage_player /* r29+0x30 */, float damage_npc /* r29+0x30 */, float damage_other /* r29+0x30 */, unsigned char infinite /* r2 */, class trail_emitter * trail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D6180 -> 0x2D6370
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6370 -> 0x002D6478
*/
// Range: 0x2D6370 -> 0x2D6478
static void refresh_spark_groups() {
    /* anonymous block */ {
        // Range: 0x2D6370 -> 0x2D6478
        class runtime_config * cfg; // r3
        class runtime_config * end_cfg; // r2
        signed int i; // r10
        class spark_group * sg; // r4
        class spark_group * endsg; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6480 -> 0x002D6588
*/
// Range: 0x2D6480 -> 0x2D6588
static void refresh_streak_groups() {
    /* anonymous block */ {
        ...
        class runtime_config * end_cfg; // r2
        signed int i; // r10
        class streak_group * sg; // r4
        class streak_group * endsg; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6590 -> 0x002D6690
*/
// Range: 0x2D6590 -> 0x2D6690
static void refresh_materials() {
    /* anonymous block */ {
        // Range: 0x2D6590 -> 0x2D6690
        class runtime_config * cfg; // r3
        class runtime_config * end_cfg; // r2
        signed int mat_index; // r10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6690 -> 0x002D69F0
*/
// Range: 0x2D6690 -> 0x2D69F0
static void load_ini_configs() {
    /* anonymous block */ {
        // Range: 0x2D6690 -> 0x2D69F0
        class xIniFile * ini; // r20
        class xIniSection * sections; // r22
        unsigned int memsize; // r29+0xAC
        void * mem; // r23
        class xIniSection * isec; // r19
        class xIniSection * end_isec; // r2
        class xIniSection * osec; // r18
        unsigned char is_default; // r17
        class default_type_loader * dtl; // r16
        class default_type_loader * end_dtl; // r2
        class ini_config * cfg; // r16
        class ini_config * end_cfg; // r2
        signed int i; // r18
        class ini_config * cfg; // r17
        class ini_config * end_cfg; // r2
        class xIniSection * sec; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D69F0 -> 0x002D6B54
*/
// Range: 0x2D69F0 -> 0x2D6B54
static void load_default_config_just_sparks(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D69F0 -> 0x2D6B54
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6B60 -> 0x002D6C3C
*/
// Range: 0x2D6B60 -> 0x2D6C3C
static void load_default_config_gauntlet_boom(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D6B60 -> 0x2D6C3C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6C40 -> 0x002D6E4C
*/
// Range: 0x2D6C40 -> 0x2D6E4C
static void load_default_config_fire_trail(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D6C40 -> 0x2D6E4C
        class curve_node anim[5]; // @ 0x0050E370
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D6E50 -> 0x002D7054
*/
// Range: 0x2D6E50 -> 0x2D7054
static void load_default_config_plasma(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D6E50 -> 0x2D7054
        class curve_node anim[4]; // @ 0x0050E310
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D7060 -> 0x002D72A0
*/
// Range: 0x2D7060 -> 0x2D72A0
static void load_default_config_fire(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D7060 -> 0x2D72A0
        class curve_node anim[4]; // @ 0x0050E2B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D72A0 -> 0x002D90A4
*/
// Range: 0x2D72A0 -> 0x2D90A4
static void load_config(class ini_config & cfg /* r23 */, class xIniSection & sec /* r17 */, class xIniFile & ini /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D72A0 -> 0x2D90A4
        class xIniValue * values; // r22
        unsigned int decal_type_hash; // r18
        char buffer[32]; // r29+0x90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D90B0 -> 0x002D91EC
*/
// Range: 0x2D90B0 -> 0x2D91EC
static void reset_config(class ini_config & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D90B0 -> 0x2D91EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D91F0 -> 0x002D91FC
*/
// Range: 0x2D91F0 -> 0x2D91FC
static signed int compare_ini_values(void * e1 /* r2 */, void * e2 /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D91F0 -> 0x2D91FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D9200 -> 0x002D920C
*/
// Range: 0x2D9200 -> 0x2D920C
static signed int compare_ini_sections(void * e1 /* r2 */, void * e2 /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D9200 -> 0x2D920C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D9210 -> 0x002D9C58
*/
// Range: 0x2D9210 -> 0x2D9C58
static void ptank_render() {
    /* anonymous block */ {
        // Range: 0x2D9210 -> 0x2D9C58
        class ordered_mote * om_buffer; // r29+0xBC
        class ordered_mote * end_om; // r2
        class ptank_pool__pos_color_size pool; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D9C60 -> 0x002DA07C
*/
// Range: 0x2D9C60 -> 0x2DA07C
static void ptank_render_sparks() {
    /* anonymous block */ {
        // Range: 0x2D9C60 -> 0x2DA07C
        class RwFrame * cam_frame; // r2
        class xMat4x3 & cam_mat; // r2
        class ptank_pool__pos_color_size pool; // r29+0xB0
        unsigned char min_alpha; // r21
        class spark_group * group; // r20
        class spark_group * end_group; // r2
        class spark_particle * spark; // r19
        class spark_particle * end_spark; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DA080 -> 0x002DA6A4
*/
// Range: 0x2DA080 -> 0x2DA6A4
static void ptank_render_streaks() {
    /* anonymous block */ {
        // Range: 0x2DA080 -> 0x2DA6A4
        class RwFrame * cam_frame; // r2
        class xMat4x3 & cam_mat; // r2
        class ptank_pool__color_mat pool; // r29+0xC0
        unsigned char min_alpha; // r23
        class streak_group * group; // r20
        class streak_group * end_group; // r2
        class streak_particle * streak; // r19
        class streak_particle * end_streak; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DA6B0 -> 0x002DAC0C
*/
// Range: 0x2DA6B0 -> 0x2DAC0C
static class ordered_mote * transform_motes(class ordered_mote * om /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2DA6B0 -> 0x2DAC0C
        class RwFrame * cam_frame; // r2
        class xMat4x3 & cam_mat; // r2
        ...
        class runtime_config & cfg; // r2
        float scale; // r10
        float dirdot; // r29+0xC
        float zdepth; // r29+0x8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DAC10 -> 0x002DB084
*/
// Range: 0x2DAC10 -> 0x2DB084
static void emit_sparks(class runtime_config & cfg /* r20 */, class xVec3 & loc /* r19 */, signed int amount /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2DAC10 -> 0x2DB084
        signed int remaining; // r2
        signed int group; // r2
        float alpha_vel; // r22
        float velrange; // r21
        signed int i; // r18
        float r; // r29+0xA0
        float velmag; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DB090 -> 0x002DB4C0
*/
// Range: 0x2DB090 -> 0x2DB4C0
static void emit_streaks(class runtime_config & cfg /* r20 */, class xVec3 & loc /* r19 */, signed int amount /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2DB090 -> 0x2DB4C0
        signed int remaining; // r2
        signed int group; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DB4C0 -> 0x002DB8D0
*/
// Range: 0x2DB4C0 -> 0x2DB8D0
static void launch_line(signed int type /* r20 */, signed int size /* r16 */, class xVec3 & loc0 /* r19 */, class xVec3 & offset /* r18 */, float age_delta /* r25 */) {
    /* anonymous block */ {
        // Range: 0x2DB4C0 -> 0x2DB8D0
        class runtime_config & cfg; // r17
        class xMat3x3 lookmat; // r29+0xF0
        class mote * m; // r16
        class mote * endm; // r2
        float s; // r24
        class xMat3x3 rotmat; // r29+0xC0
        float r; // r29+0x120
        float dloc; // r29+0x120
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002DB8D0 -> 0x002DBBDC
*/
// Range: 0x2DB8D0 -> 0x2DBBDC
static void launch_sphere(signed int type /* r20 */, signed int size /* r2 */, class xVec3 & loc /* r19 */) {
    /* anonymous block */ {
        // Range: 0x2DB8D0 -> 0x2DBBDC
        class runtime_config & cfg; // r18
        class mote * m; // r17
