/*
    Compile unit: C:\TestBuild\in\GAME\zSplash.cpp
...
static char ini_filename[11]; // size: 0xB, address: 0x5F23D0
static char * texture_key_names[8]; // size: 0x20, address: 0x50EB00
static class RwTexture * cone_texture; // size: 0x4, address: 0x60912C
static class splash_emitter * splash_emitters; // size: 0x4, address: 0x609130
static signed int splash_emitters_size; // size: 0x4, address: 0x609134
static class plume_emitter * plume_emitters; // size: 0x4, address: 0x609138
static signed int plume_emitters_size; // size: 0x4, address: 0x60913C
static class bubble_emitter * bubble_emitters; // size: 0x4, address: 0x609140
static signed int bubble_emitters_size; // size: 0x4, address: 0x609144
static class chain_emitter * chain_emitters; // size: 0x4, address: 0x609148
static signed int chain_emitters_size; // size: 0x4, address: 0x60914C
static signed int mist_system_id; // size: 0x4, address: 0x609150
static signed int ring_system_id; // size: 0x4, address: 0x609154
static signed int streak_system_id; // size: 0x4, address: 0x609158
static signed int plume_system_id; // size: 0x4, address: 0x60915C
static signed int trail_system_id; // size: 0x4, address: 0x609160
static signed int drips_system_id; // size: 0x4, address: 0x609164
static class splash_planner * planners; // size: 0x4, address: 0x609168
static class type_mapping * type_mappings; // size: 0x4, address: 0x60916C
static signed int types_size; // size: 0x4, address: 0x609170
static unsigned int texture_ids[8]; // size: 0x20, address: 0x6A2470
static signed int cone_texture_repeats; // size: 0x4, address: 0x607CA0
static float old_zbias; // size: 0x4, address: 0x609174
static class xColor_tag emitterColor; // size: 0x4, address: 0x5F23E0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
signed int update_plume_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x328E50
signed int update_ring_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x32A4A0
signed int update_streak_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x329FB0
signed int update_mist_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x32A8B0
...
// total size: 0x188
class splash_planner {
    // Members
public:
    char name[64]; // offset 0x0, size 0x40
    enum type_enum type; // offset 0x40, size 0x4
    union { // inferred
        class splash_config splash; // offset 0x44, size 0x144
        class plume_config plume; // offset 0x44, size 0x7C
        class bubble_config bubble; // offset 0x44, size 0x1C
        class chain_config chain; // offset 0x44, size 0x84
    };
};
// total size: 0x28
class mblur_data {
...
class chain_emitter {
    // Members
public:
    class chain_config * chain; // offset 0x0, size 0x4
    class xVec3 loc; // offset 0x4, size 0xC
    float time; // offset 0x10, size 0x4
    signed int next_link; // offset 0x14, size 0x4
};
// total size: 0x70
class RpWorld {
    // Members
...
public:
    ...
    class xColor_tag color; // offset 0x34, size 0x4
...
public:
    ...
    class plume_emitter initial; // offset 0x34, size 0x48
};
...
class chain_config {
    // Members
public:
    class chain_link links[8]; // offset 0x0, size 0x40
    class chain_link ordered_links[8]; // offset 0x40, size 0x40
    signed int links_size; // offset 0x80, size 0x4
};
// total size: 0x0
...
public:
    ...
    public:
        ...
        class xColor_tag color; // offset 0x1C, size 0x4
...
public:
    ...
    class xColor_tag color; // offset 0x44, size 0x4
};
...
public:
    ...
    public:
        ...
        signed int alpha_birth; // offset 0x20, size 0x4
        signed int alpha_death; // offset 0x24, size 0x4
    } cone; // offset 0x0, size 0x28
    // total size: 0x20
    class /* @class */ {
        // Members
    public:
    ...
    public:
        ...
        float y_accel; // offset 0x20, size 0x4
        class xColor_tag color; // offset 0x24, size 0x4
    } streak; // offset 0x68, size 0x28
    class splash_emitter initial; // offset 0x90, size 0xB4
};
enum iSndHandle {
};
// total size: 0x34
...
public:
    ...
    class bubble_emitter initial; // offset 0x8, size 0x14
};
// total size: 0x10
class xQuat {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326C30 -> 0x00326CA8
*/
// Range: 0x326C30 -> 0x326CA8
void zSplashEmit(signed int type /* r2 */, class xVec3 & loc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326C30 -> 0x326CA8
        class xVec3 bias_loc; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326CB0 -> 0x00326D0C
*/
// Range: 0x326CB0 -> 0x326D0C
signed int zSplashFindType(char * name /* r29+0x28 */) {
    /* anonymous block */ {
        // Range: 0x326CB0 -> 0x326D0C
        class type_mapping * end; // r2
        class type_mapping * found; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326D10 -> 0x00326D38
*/
// Range: 0x326D10 -> 0x326D38
void zSplashRender() {
    /* anonymous block */ {
        // Range: 0x326D10 -> 0x326D38
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326D40 -> 0x00326E30
*/
// Range: 0x326D40 -> 0x326E30
void zSplashUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x326D40 -> 0x326E30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326E30 -> 0x00326E38
*/
// Range: 0x326E30 -> 0x326E38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326E40 -> 0x003272E8
*/
// Range: 0x326E40 -> 0x3272E8
void zSplashSceneEnter() {
    /* anonymous block */ {
        // Range: 0x326E40 -> 0x3272E8
        class splash_planner * plan; // r18
        class splash_planner * end_plan; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003272F0 -> 0x00327328
*/
// Range: 0x3272F0 -> 0x327328
void zSplashStartup() {
    /* anonymous block */ {
        // Range: 0x3272F0 -> 0x327328
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327330 -> 0x0032779C
*/
// Range: 0x327330 -> 0x32779C
void zEmitSwimDrips(class SwimEmitter & emitter /* r20 */, float & emitted /* r2 */, class xVec3 & pos /* r2 */, float dt /* r29+0x90 */) {
    /* anonymous block */ {
        // Range: 0x327330 -> 0x32779C
        signed int emit; // r19
        float cx; // r24
        float cy; // r23
        float cz; // r22
        unsigned char * mem; // r29+0x8C
        signed int have; // r2
        class plume_particle * p; // r18
        class plume_particle * endp; // r2
        float ang; // r20
        float rr; // r29+0x90
        float vel_mag; // r21
        float vel_pitch; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003277A0 -> 0x00327BFC
*/
// Range: 0x3277A0 -> 0x327BFC
void zEmitSwimSplashes(class SwimEmitter & emitter /* r20 */, float & emitted /* r2 */, class xVec3 & pos /* r2 */, float dt /* r29+0x90 */) {
    /* anonymous block */ {
        // Range: 0x3277A0 -> 0x327BFC
        signed int emit; // r19
        float cx; // r24
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327C00 -> 0x00328058
*/
// Range: 0x327C00 -> 0x328058
void zEmitSwimRings(float & emitted /* r2 */, class xVec3 & pos /* r2 */, class xVec3 & velocity /* r20 */, float dt /* r29+0x170 */, float rate /* r29+0x170 */) {
    /* anonymous block */ {
        // Range: 0x327C00 -> 0x328058
        float speed; // r28
        float emit_rate; // r27
        signed int emit; // r19
        float time_passed; // r26
        class xVec3 last_position; // r29+0x158
        unsigned char * mem; // r29+0x16C
        signed int have; // r2
        class ring_particle * p; // r18
        class ring_particle * endp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328060 -> 0x00328434
*/
// Range: 0x328060 -> 0x328434
void zEmitSwimRings(float & emitted /* r2 */, class xVec3 & pos /* r20 */, float speed /* r21 */, float dt /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x328060 -> 0x328434
        signed int emit; // r19
        unsigned char * mem; // r29+0x7C
        signed int have; // r18
        class ring_particle * p; // r17
        class ring_particle * endp; // r2
        float rot; // r22
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328440 -> 0x0032874C
*/
// Range: 0x328440 -> 0x32874C
static void render_cones() {
    /* anonymous block */ {
        // Range: 0x328440 -> 0x32874C
        class HIFastIMLockStruct lock; // r29+0x20
        class xVec3 * pos; // r5
        class xVec2 * uv; // r4
        unsigned int * color; // r3
        float du; // r19
        class splash_emitter * splash; // r2
        class splash_emitter * end_splash; // r2
        float cx; // r18
        float cy; // r17
        float cz; // r16
        float radius; // r15
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328750 -> 0x003288CC
*/
// Range: 0x328750 -> 0x3288CC
static void update_chain_emitters(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x328750 -> 0x3288CC
        class chain_emitter * e; // r18
        class chain_link * links; // r2
        signed int links_size; // r2
        class chain_link * link; // r20
        class chain_link * end_link; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003288D0 -> 0x00328E48
*/
// Range: 0x3288D0 -> 0x328E48
static void update_plume_emitters(float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x3288D0 -> 0x328E48
        class plume_emitter * e; // r20
        class plume_emitter * ende; // r21
        signed int emit; // r19
        float cx; // r24
        float cy; // r23
        float cz; // r22
        unsigned char * mem; // r29+0xAC
        signed int have; // r2
        class plume_particle * p; // r18
        class plume_particle * endp; // r2
        float ang; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328E50 -> 0x0032928C
*/
// Range: 0x328E50 -> 0x32928C
static signed int update_plume_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x328E50 -> 0x32928C
        class ptank_pool__pos_color_size & pool; // r18
        class plume_particle * p; // r17
        class plume_particle * end; // r16
        float t1; // r20
        float t2; // r29+0x80
        float alpha; // r4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00329290 -> 0x00329FA4
*/
// Range: 0x329290 -> 0x329FA4
static void update_splash_emitters(float dt /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x329290 -> 0x329FA4
        class splash_emitter * e; // r16
        class splash_emitter * ende; // r21
        float r0; // r20
        float y0; // r29+0xC0
        float dyv; // r29+0xC0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00329FB0 -> 0x0032A49C
*/
// Range: 0x329FB0 -> 0x32A49C
static signed int update_streak_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r24 */) {
    /* anonymous block */ {
        // Range: 0x329FB0 -> 0x32A49C
        class ptank_pool__color_mat & pool; // r18
        class xMat4x3 & cam_mat; // r2
        float ax; // r23
        float ay; // r22
        float az; // r21
        class streak_particle * p; // r17
        class streak_particle * end; // r16
        float t; // r20
        float mag; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032A4A0 -> 0x0032A8AC
*/
// Range: 0x32A4A0 -> 0x32A8AC
static signed int update_ring_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x32A4A0 -> 0x32A8AC
        class ptank_pool__color_mat & pool; // r18
        class ring_particle * p; // r17
        class ring_particle * end; // r16
        float t; // r21
        float rx; // r29+0x70
        float rz; // r29+0x70
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032A8B0 -> 0x0032AC5C
*/
// Range: 0x32A8B0 -> 0x32AC5C
static signed int update_mist_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x32A8B0 -> 0x32AC5C
        class ptank_pool__pos_color_size & pool; // r18
        class mist_particle * p; // r17
        class mist_particle * end; // r16
        float t; // r20
        float dv; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032AC60 -> 0x0032B098
*/
// Range: 0x32AC60 -> 0x32B098
static void emit_splash_internal(signed int type /* r2 */, class xVec3 & loc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32AC60 -> 0x32B098
        class splash_planner & plan; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032B0A0 -> 0x0032B45C
*/
// Range: 0x32B0A0 -> 0x32B45C
static void load_ini_configs() {
    /* anonymous block */ {
        // Range: 0x32B0A0 -> 0x32B45C
        void * mem; // r22
        class xIniFile * ini; // r20
        class xIniSection * sections; // r21
        unsigned int memsize; // r29+0xDC
        class xIniSection * isec; // r18
        class xIniSection * end_isec; // r2
        class xIniSection * osec; // r17
        class splash_planner * plan; // r19
        class splash_planner * end_plan; // r2
        class xIniSection * sec; // r18
        class type_mapping * m; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032B460 -> 0x0032BAE0
*/
// Range: 0x32B460 -> 0x32BAE0
static void load_planner(class splash_planner & plan /* r21 */, class xIniSection & sec /* r22 */, class xIniFile & ini /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32B460 -> 0x32BAE0
        class xIniValue * values; // r20
        signed int values_size; // r19
        class xIniValue * iv; // r18
        class xIniValue * end_iv; // r2
        char * type; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032BAE0 -> 0x0032BD90
*/
// Range: 0x32BAE0 -> 0x32BD90
static void load_chain(class chain_config & chain /* r19 */, class xIniValue * values /* r2 */, signed int values_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32BAE0 -> 0x32BD90
        class chain_link * link; // r18
        class xIniValue * iv; // r17
        class xIniValue * end_iv; // r2
        char * nextoken; // r29+0x6C
        char * s; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032BD90 -> 0x0032C9E0
*/
// Range: 0x32BD90 -> 0x32C9E0
static void load_splash(class splash_config & cfg /* r18 */, class xIniValue * values /* r17 */, signed int values_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32BD90 -> 0x32C9E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C9E0 -> 0x0032CAA4
*/
// Range: 0x32C9E0 -> 0x32CAA4
static void refresh_plume(class plume_config & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32C9E0 -> 0x32CAA4
        class plume_emitter & initial; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032CAB0 -> 0x0032CD20
*/
// Range: 0x32CAB0 -> 0x32CD20
static void refresh_splash(class splash_config & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32CAB0 -> 0x32CD20
        class splash_emitter & initial; // r2
        float ilife; // r29
        float Y0; // r29
        float Ym; // r29
        float iT1; // r29
