/*
    Compile unit: C:\TestBuild\in\GAME\zNPCPlayers.cpp
...
static class incrediball * the_ball; // size: 0x4, address: 0x6096C8
// total size: 0xB8
struct /* @anon7 */ {} zNPC::incrediball::__vtable; // size: 0xB8, address: 0x606F50
// total size: 0x7C
struct /* @anon2 */ {} zNPC::health_hud::__vtable; // size: 0x7C, address: 0x607250
// total size: 0x7C
struct /* @anon4 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon5 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon1 */ {} zNPC::follow_spline_path::__vtable; // size: 0x7C, address: 0x602CD0
// total size: 0x7C
struct /* @anon6 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon9 */ {} zNPC::idle::__vtable; // size: 0x7C, address: 0x601770
// total size: 0xB8
struct /* @anon3 */ {} zNPC::frozone::__vtable; // size: 0xB8, address: 0x6070D0
// total size: 0xB8
struct /* @anon8 */ {} zNPC::player::__vtable; // size: 0xB8, address: 0x607190
// total size: 0xB8
struct /* @anon0 */ {} zNPC::elastigirl::__vtable; // size: 0xB8, address: 0x607010
...
void delayed_render_npc(); // size: 0x0, address: 0x48CA90
void render_inards_callback(void *); // size: 0x0, address: 0x48CAA0
...
// total size: 0x3D0
class incrediball : public player {
    // Members
public:
    class idle idle_state; // offset 0x2C0, size 0x10
    class follow_spline_path follow_state; // offset 0x2D0, size 0xB0
    class health_hud hud_state; // offset 0x380, size 0x10
    class xMat4x3 effect_mat; // offset 0x390, size 0x40
};
// total size: 0x5FC
class xEntCollis {
    // Members
...
// total size: 0x390
class elastigirl : public player {
    // Members
public:
    class idle idle_state; // offset 0x2C0, size 0x10
    class follow_spline_path follow_state; // offset 0x2D0, size 0xB0
...
// total size: 0x10
class health_hud : public behavior_implementation {};
// total size: 0x18
class RwResEntry {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048C560 -> 0x0048C624
*/
// Range: 0x48C560 -> 0x48C624
// this: r16
frozone::frozone() {
    /* anonymous block */ {
        // Range: 0x48C560 -> 0x48C624
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048C690 -> 0x0048C754
*/
// Range: 0x48C690 -> 0x48C754
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048C760 -> 0x0048CA78
*/
// Range: 0x48C760 -> 0x48CA78
// this: r16
void incrediball::update_npc(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x48C760 -> 0x48CA78
        class xVec3 dpos; // r29+0xB0
        float angle_change; // r29+0xC0
        class xVec3 right; // r29+0xA0
        class xMat3x3 temp; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CA80 -> 0x0048CA90
*/
// Range: 0x48CA80 -> 0x48CA90
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CA90 -> 0x0048CAA0
*/
// Range: 0x48CA90 -> 0x48CAA0
static void delayed_render_npc() {
    /* anonymous block */ {
        // Range: 0x48CA90 -> 0x48CAA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CAA0 -> 0x0048CADC
*/
// Range: 0x48CAA0 -> 0x48CADC
void render_inards_callback(void * context /* r16 */) {
    /* anonymous block */ {
        // Range: 0x48CAA0 -> 0x48CADC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CAE0 -> 0x0048CBCC
*/
// Range: 0x48CAE0 -> 0x48CBCC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CBD0 -> 0x0048CC94
*/
// Range: 0x48CBD0 -> 0x48CC94
// this: r16
incrediball::incrediball() {
    /* anonymous block */ {
        // Range: 0x48CBD0 -> 0x48CC94
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CCA0 -> 0x0048CCA8
*/
// Range: 0x48CCA0 -> 0x48CCA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CCB0 -> 0x0048CCB8
*/
// Range: 0x48CCB0 -> 0x48CCB8
void setup() {
    /* anonymous block */ {
        // Range: 0x48CCB0 -> 0x48CCB8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048CCC0 -> 0x0048CCC8
*/
// Range: 0x48CCC0 -> 0x48CCC8
void reset() {
    /* anonymous block */ {
        // Range: 0x48CCC0 -> 0x48CCC8
    }
