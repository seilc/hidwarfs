/*
    Compile unit: C:\TestBuild\in\GAME\zSparkEmitter.cpp
...
void Event(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x498B00
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x48
class zSparkEmitterAsset : public xDynAsset {
    // Members
public:
    unsigned char initially_on : 1; // offset 0x10, size 0x1
    unsigned int attach_obj_id; // offset 0x14, size 0x4
    class xVec3 position; // offset 0x18, size 0xC
    float yaw; // offset 0x24, size 0x4
    float pitch; // offset 0x28, size 0x4
    float dir_vary; // offset 0x2C, size 0x4
    float period; // offset 0x30, size 0x4
    float lifetime_min; // offset 0x34, size 0x4
    float lifetime_rand; // offset 0x38, size 0x4
    float velocity_min; // offset 0x3C, size 0x4
    float velocity_rand; // offset 0x40, size 0x4
    signed int num_sparks; // offset 0x44, size 0x4
};
// total size: 0x168
class xJSPNodeLight {
    // Members
...
class zSparkEmitter : public xBase {
    // Members
public:
    class zSparkEmitterAsset * asset; // offset 0x10, size 0x4
    class xEnt * track_entity; // offset 0x14, size 0x4
    class xVec3 emit_dir; // offset 0x18, size 0xC
    float time_until_emit; // offset 0x24, size 0x4
    unsigned char is_on : 1; // offset 0x28, size 0x1
    unsigned char should_look_for_track : 1; // offset 0x28, size 0x1
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498B00 -> 0x00498BF4
*/
// Range: 0x498B00 -> 0x498BF4
void Event(class xBase * to /* r16 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x498B00 -> 0x498BF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498C00 -> 0x00498E7C
*/
// Range: 0x498C00 -> 0x498E7C
// this: r16
void zSparkEmitter::Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x498C00 -> 0x498E7C
        float num_sparks; // r29+0x50
        class xVec3 cur_pos; // r29+0x40
        class xVec3 cur_dir; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498E80 -> 0x004990BC
*/
// Range: 0x498E80 -> 0x4990BC
void Load(class xBase & data /* r18 */, class xDynAsset & asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x498E80 -> 0x4990BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004990C0 -> 0x00499144
*/
// Range: 0x4990C0 -> 0x499144
void zSparkUpdate(class zScene * scene /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4990C0 -> 0x499144
        signed int num_emitters; // r2
        signed int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499150 -> 0x00499158
*/
// Range: 0x499150 -> 0x499158
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499160 -> 0x00499168
*/
// Range: 0x499160 -> 0x499168
