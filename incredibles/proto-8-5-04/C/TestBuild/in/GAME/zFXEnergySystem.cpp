/*
    Compile unit: C:\TestBuild\in\GAME\zFXEnergySystem.cpp
...
signed int streak_system_id; // size: 0x4, address: 0x608504
signed int point_system_id; // size: 0x4, address: 0x608508
unsigned char need_setup; // size: 0x1, address: 0x6096DC
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
signed int streak_update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x491E10
signed int point_update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x492570
// total size: 0x2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491D40 -> 0x00491D50
*/
// Range: 0x491D40 -> 0x491D50
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491D50 -> 0x00491D58
*/
// Range: 0x491D50 -> 0x491D58
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491D60 -> 0x00491E0C
*/
// Range: 0x491D60 -> 0x491E0C
// this: r16
void energy_system::start() {
    /* anonymous block */ {
        // Range: 0x491D60 -> 0x491E0C
        class particle * p; // r29+0x2C
        signed int count; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491E10 -> 0x0049256C
*/
// Range: 0x491E10 -> 0x49256C
signed int streak_update(unsigned char * mem /* r21 */, signed int count /* r2 */, class ptank_pool & pool_ /* r2 */, float dt /* r28 */) {
    /* anonymous block */ {
        // Range: 0x491E10 -> 0x49256C
        class ptank_pool__pos_color_size_rot & pool; // r20
        class particle * p; // r19
        class particle * end; // r18
        class energy_system * system; // r2
        class xVec3 & system_position; // r2
        class config * use_config; // r17
        class xVec3 particle_to_position; // r29+0x240
        float length; // r27
        class xVec3 screen_space_position; // r29+0x230
        class xVec3 screen_space_system_position; // r29+0x220
        class xVec3 screen_space_direction; // r29+0x210
        float rot; // r26
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00492570 -> 0x00493068
*/
// Range: 0x492570 -> 0x493068
signed int point_update(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & pool_ /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x492570 -> 0x493068
        class ptank_pool__pos_color_size & pool; // r19
        class particle * p; // r18
        class particle * end; // r17
        class energy_system * system; // r3
        class xVec3 & system_target; // r2
        class config * use_config; // r16
        class xVec3 particle_to_position; // r29+0x1C0
        class xVec3 rotation; // r29+0x1B0
        float u; // r1
        float g; // r6
        float b; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493070 -> 0x00493540
*/
// Range: 0x493070 -> 0x493540
// this: r20
void energy_system::emit_streaks(class xMat3x3 & mat /* r19 */, float dt /* r29+0x150 */) {
    /* anonymous block */ {
        // Range: 0x493070 -> 0x493540
        float time_passed; // r25
        signed int emit; // r18
        class particle * p; // r29+0x14C
        signed int count; // r2
        class particle * end; // r2
        float angle; // r24
        class xVec3 direction; // r29+0x140
        float start_distance; // r24
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493540 -> 0x00493B14
*/
// Range: 0x493540 -> 0x493B14
// this: r20
void energy_system::emit_points(class xMat3x3 & mat /* r19 */, float dt /* r29+0x150 */) {
    /* anonymous block */ {
        // Range: 0x493540 -> 0x493B14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493B20 -> 0x00493BE4
*/
// Range: 0x493B20 -> 0x493BE4
// this: r17
void energy_system::emit(class xVec3 & pos /* r2 */, class xMat3x3 & mat /* r16 */, float dt /* r20 */, class xVec3 * new_target /* r2 */) {
    /* anonymous block */ {
        // Range: 0x493B20 -> 0x493BE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493BF0 -> 0x00493BF8
*/
// Range: 0x493BF0 -> 0x493BF8
void add_tweaks() {
    /* anonymous block */ {
        // Range: 0x493BF0 -> 0x493BF8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493C00 -> 0x00493C10
*/
// Range: 0x493C00 -> 0x493C10
// this: r2
void energy_system::add_tweaks(char * prefix /* r2 */) {
    /* anonymous block */ {
        // Range: 0x493C00 -> 0x493C10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493C10 -> 0x00493EB4
*/
// Range: 0x493C10 -> 0x493EB4
// this: r19
void energy_system::setup(class config * new_config /* r2 */, unsigned char additive /* r18 */) {
    /* anonymous block */ {
        // Range: 0x493C10 -> 0x493EB4
        class RwTexture * texture; // r2
        class xParticleBatchSystem batch_system; // r29+0x60
        class config default_config; // @ 0x006C5430
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00493EC0 -> 0x00493ECC
*/
// Range: 0x493EC0 -> 0x493ECC
void scene_setup() {
    /* anonymous block */ {
        // Range: 0x493EC0 -> 0x493ECC
    }
