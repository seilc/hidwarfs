/*
    Compile unit: C:\TestBuild\in\GAME\zNPCCombat.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class xHierarchyBoundInitData zNPC_BadGuyMedium_Bounds[9]; // size: 0x6C, address: 0x508BF0
static class xHierarchyBoundInitData zNPC_Hench_Bounds[9]; // size: 0x6C, address: 0x508C60
static class xHierarchyBoundInitData zNPC_BadGuyShield_Bounds[7]; // size: 0x54, address: 0x508CD0
static class xHierarchyBoundInitData zNPC_Turret_Top_Bounds[2]; // size: 0x18, address: 0x508D30
static class xHierarchyBoundInitData zNPC_Turret_Bunker_Bounds[2]; // size: 0x18, address: 0x508D50
static class xHierarchyBoundInitData zNPC_Turret_Building_Bounds[2]; // size: 0x18, address: 0x508D70
static class xHierarchyBoundInitData zNPC_Turret_Hoverpod_Bounds[2]; // size: 0x18, address: 0x508D90
static class xHierarchyBoundInitData zNPC_Turret_Tower_Bounds[2]; // size: 0x18, address: 0x508DB0
static class xHierarchyBoundInitData zNPC_Turret_Beach_Bounds[2]; // size: 0x18, address: 0x508DD0
static class xHierarchyBoundInitData zNPC_Velocipod_Bounds[2]; // size: 0x18, address: 0x508DF0
static class xHierarchyBoundInitData zNPC_Omnidroid08_Bounds[7]; // size: 0x54, address: 0x508E10
static class xHierarchyBoundInitData zNPC_BombVoyage_Bounds[2]; // size: 0x18, address: 0x508E70
static class xHierarchyBoundInitData zNPC_BombVoyageHeli_Bounds[2]; // size: 0x18, address: 0x508E90
static class zNPCCombatInitData ZNPC_Default; // size: 0x8, address: 0x608D18
static class zNPCCombatInitData ZNPC_BadGuyMedium; // size: 0x8, address: 0x607868
static class zNPCCombatInitData ZNPC_BadGuyShield; // size: 0x8, address: 0x607870
static class zNPCCombatInitData ZNPC_BadGuyFat; // size: 0x8, address: 0x607878
static class zNPCCombatInitData ZNPC_Mine; // size: 0x8, address: 0x607880
static class zNPCCombatInitData ZNPC_Oracle; // size: 0x8, address: 0x607888
static class zNPCCombatInitData ZNPC_Turret_Top; // size: 0x8, address: 0x607890
static class zNPCCombatInitData ZNPC_Turret_Bunker; // size: 0x8, address: 0x607898
static class zNPCCombatInitData ZNPC_Turret_Building; // size: 0x8, address: 0x6078A0
static class zNPCCombatInitData ZNPC_Turret_Hoverpod; // size: 0x8, address: 0x6078A8
static class zNPCCombatInitData ZNPC_Turret_Tower; // size: 0x8, address: 0x6078B0
static class zNPCCombatInitData ZNPC_Turret_Beach; // size: 0x8, address: 0x6078B8
static class zNPCCombatInitData ZNPC_Car; // size: 0x8, address: 0x6078C0
static class zNPCCombatInitData ZNPC_Lobber; // size: 0x8, address: 0x6078C8
static class zNPCCombatInitData ZNPC_Velocipod; // size: 0x8, address: 0x6078D0
static class zNPCCombatInitData ZNPC_Omnidroid08; // size: 0x8, address: 0x6078D8
static class zNPCCombatInitData ZNPC_BombVoyage; // size: 0x8, address: 0x6078E0
static class zNPCCombatInitData ZNPC_BombVoyageHeli; // size: 0x8, address: 0x6078E8
static class zNPCCombatInitDataIndex initData[18]; // size: 0xD8, address: 0x508EB0
...
// total size: 0x8
class zNPCCombatInitData {
    // Members
public:
    class xHierarchyBoundInitData * hierarchy; // offset 0x0, size 0x4
    float masterRadius; // offset 0x4, size 0x4
};
// total size: 0x4
...
// total size: 0xC
class zNPCCombatInitDataIndex {
    // Members
public:
    char * name; // offset 0x0, size 0x4
    class zNPCCombatInitData * initData; // offset 0x4, size 0x4
    unsigned int id; // offset 0x8, size 0x4
};
// total size: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F49F0 -> 0x001F4B98
*/
// Range: 0x1F49F0 -> 0x1F4B98
void zNPCCombatSetCombat(class xEnt * ent /* r18 */, unsigned int id /* r17 */, char * root /* r22 */, unsigned int atkTblID /* r16 */, unsigned short hitPoints /* r23 */, float scale /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1F49F0 -> 0x1F4B98
        unsigned int size; // r29+0xAC
        class zAttackTableState * pAttackTableStates; // r21
        unsigned int stateCount; // r20
        class zAttackTableAsset * pAsset; // r2
        unsigned int i; // r5
        class zNPCCombatInitData * init; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4BA0 -> 0x001F4BA8
*/
// Range: 0x1F4BA0 -> 0x1F4BA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4BB0 -> 0x001F4BFC
*/
// Range: 0x1F4BB0 -> 0x1F4BFC
void zNPCCombatInit() {
    /* anonymous block */ {
        // Range: 0x1F4BB0 -> 0x1F4BFC
        signed int i; // r17
