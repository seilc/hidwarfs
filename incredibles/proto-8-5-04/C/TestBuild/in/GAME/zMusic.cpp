/*
    Compile unit: C:\TestBuild\in\GAME\zMusic.cpp
...
static class zMusicTrackInfo sMusicTrack[2]; // size: 0x48, address: 0x61C860
static class xSndGroup * spMusicGroup; // size: 0x4, address: 0x608780
static class zMusicState sMusic; // size: 0x8, address: 0x608788
float gDialogueMusicLevel; // size: 0x4, address: 0x6076E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140740 -> 0x00140790
*/
// Range: 0x140740 -> 0x140790
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140790 -> 0x001408F8
*/
// Range: 0x140790 -> 0x1408F8
void zMusicTempSongEvent(float * toParam /* r16 */, unsigned int toParamWidgetID /* r18 */) {
    /* anonymous block */ {
        // Range: 0x140790 -> 0x1408F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140900 -> 0x00140A90
*/
// Range: 0x140900 -> 0x140A90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140A90 -> 0x00140DF8
*/
// Range: 0x140A90 -> 0x140DF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140E00 -> 0x00140E40
*/
// Range: 0x140E00 -> 0x140E40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140E40 -> 0x00140EBC
*/
// Range: 0x140E40 -> 0x140EBC
void zMusicUnpause() {
    /* anonymous block */ {
        // Range: 0x140E40 -> 0x140EBC
        unsigned int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140EC0 -> 0x00140F44
*/
// Range: 0x140EC0 -> 0x140F44
void zMusicPause() {
    /* anonymous block */ {
        // Range: 0x140EC0 -> 0x140F44
        unsigned int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140F50 -> 0x00140FC4
*/
// Range: 0x140F50 -> 0x140FC4
void zMusicKill() {
    /* anonymous block */ {
        // Range: 0x140F50 -> 0x140FC4
        unsigned int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140FD0 -> 0x00141400
*/
// Range: 0x140FD0 -> 0x141400
void zMusicUpdate() {
    /* anonymous block */ {
        // Range: 0x140FD0 -> 0x141400
        float fNowTime; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00141400 -> 0x001414D0
*/
// Range: 0x141400 -> 0x1414D0
void zMusicInit() {
    /* anonymous block */ {
        // Range: 0x141400 -> 0x1414D0
