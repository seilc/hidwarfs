/*
    Compile unit: C:\TestBuild\in\GAME\zIncrediBallCam.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x24
struct /* @anon0 */ {} zIncrediBall::camera::__vtable; // size: 0x24, address: 0x604250
...
class camera : public xCam {
    // Members
public:
    float VELOCITY_BLEND_K; // offset 0xD0, size 0x4
    float CAMERA_POSITION_BLEND_K; // offset 0xD4, size 0x4
    float PLAYER_POSITION_BLEND_K; // offset 0xD8, size 0x4
    float MOUNT_CEILING; // offset 0xDC, size 0x4
    float MOUNT_FLOOR; // offset 0xE0, size 0x4
    float MAX_ANGLE_DIFF; // offset 0xE4, size 0x4
    float MOUNT_GROUND_BLEND_K; // offset 0xE8, size 0x4
    float MOUNT_AIR_MIN_BLEND_K; // offset 0xEC, size 0x4
    float MOUNT_AIR_MAX_BLEND_K; // offset 0xF0, size 0x4
    float COLLIDE_SPHERE_RADIUS; // offset 0xF4, size 0x4
    float COLLIDE_VELOCITY_BLEND_K; // offset 0xF8, size 0x4
    float REST_HEIGHT; // offset 0xFC, size 0x4
    float REST_DISTANCE; // offset 0x100, size 0x4
    float REST_TARGET_OFFSET; // offset 0x104, size 0x4
    float UP_HEIGHT; // offset 0x108, size 0x4
    float UP_DISTANCE; // offset 0x10C, size 0x4
    float UP_TARGET_OFFSET; // offset 0x110, size 0x4
    float DOWN_HEIGHT; // offset 0x114, size 0x4
    float DOWN_DISTANCE; // offset 0x118, size 0x4
    float DOWN_TARGET_OFFSET; // offset 0x11C, size 0x4
    float TILT_MOUNT_MULTIPLIER; // offset 0x120, size 0x4
    float TILT_BLEND_K; // offset 0x124, size 0x4
    float TILT_VELOCITY_MULTIPLIER; // offset 0x128, size 0x4
    float INPUT_X_BLEND_K; // offset 0x12C, size 0x4
    float INPUT_Y_BLEND_K; // offset 0x130, size 0x4
    float USER_CONTROL_BLEND_K; // offset 0x134, size 0x4
    float MAX_ROTATION_SPEED; // offset 0x138, size 0x4
    float PATH_COLLIDE_BLEND_K; // offset 0x13C, size 0x4
    class player * owner; // offset 0x140, size 0x4
    class xVec3 last_camera_position; // offset 0x144, size 0xC
    class xVec3 camera_position; // offset 0x150, size 0xC
    float camera_position_v; // offset 0x15C, size 0x4
    class xVec3 player_position; // offset 0x160, size 0xC
    class xVec3 target_position; // offset 0x16C, size 0xC
    float player_position_v; // offset 0x178, size 0x4
    class xVec3 velocity; // offset 0x17C, size 0xC
    float velocity_v; // offset 0x188, size 0x4
    float mount_y; // offset 0x18C, size 0x4
    float mount_y_v; // offset 0x190, size 0x4
    float input_x; // offset 0x194, size 0x4
    float input_x_v; // offset 0x198, size 0x4
    float input_y; // offset 0x19C, size 0x4
    float input_y_v; // offset 0x1A0, size 0x4
    float user_control_angle; // offset 0x1A4, size 0x4
    float user_control_angle_v; // offset 0x1A8, size 0x4
    float leftover_control_angle; // offset 0x1AC, size 0x4
    float height; // offset 0x1B0, size 0x4
    float distance; // offset 0x1B4, size 0x4
    float target_offset; // offset 0x1B8, size 0x4
    float tilt; // offset 0x1BC, size 0x4
    float tilt_v; // offset 0x1C0, size 0x4
    float path_v; // offset 0x1C4, size 0x4
    class xCamSupportLOSBar losbar; // offset 0x1C8, size 0x50
    class xCamSupportPath path; // offset 0x218, size 0xA8
};
// total size: 0x70
class jump {
    // Members
...
class player : public zPlayer {
    // Members
public:
    class config_data blur_config; // offset 0x4E0, size 0x24
    class xModelBlur blur; // offset 0x504, size 0x4
    float blur_lifetime; // offset 0x508, size 0x4
    float blur_alpha; // offset 0x50C, size 0x4
    class behavior_manager manager; // offset 0x510, size 0x14
    class xVec3 velocity; // offset 0x524, size 0xC
    class xVec3 desired_direction; // offset 0x530, size 0xC
    class camera cam; // offset 0x540, size 0x2C0
    float float_health; // offset 0x800, size 0x4
    float difference_angle; // offset 0x804, size 0x4
    float speed; // offset 0x808, size 0x4
    class xModelInstance * da_ball_model; // offset 0x80C, size 0x4
    unsigned char on_floor; // offset 0x810, size 0x1
    enum strength last_strength_level; // offset 0x814, size 0x4
    class StepFX stepfx; // offset 0x818, size 0x30
};
// total size: 0xC
...
public:
    ...
    class zFootstepDetect footsteps[1]; // offset 0xC, size 0xC
    class zDecalEmitterList * decals; // offset 0x18, size 0x4
    class zParticleSystemProperties particleProperties; // offset 0x1C, size 0x14
};
...
// total size: 0x14
class zParticleSystemProperties {
    // Members
public:
    float time; // offset 0x0, size 0x4
    class xVec3 pos; // offset 0x4, size 0xC
    class zParEmitter * emitter; // offset 0x10, size 0x4
};
// total size: 0x8
class RwTexCoords {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033BEE0 -> 0x0033BEE8
*/
// Range: 0x33BEE0 -> 0x33BEE8
// this: r2
void camera::attach(class player * p /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33BEE0 -> 0x33BEE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033BEF0 -> 0x0033C248
*/
// Range: 0x33BEF0 -> 0x33C248
// this: r16
void camera::update_path(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x33BEF0 -> 0x33C248
        class xCamCoordPolar start; // r29+0x70
        class xCamCoordPolar end; // r29+0x50
        float end_dist; // r29+0x90
        float velmag; // r29+0x8C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033C250 -> 0x0033CFC0
*/
// Range: 0x33C250 -> 0x33CFC0
// this: r18
void camera::update(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x33C250 -> 0x33CFC0
        class xVec3 desired_user_direction; // r29+0x2F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033CFC0 -> 0x0033D378
*/
// Range: 0x33CFC0 -> 0x33D378
// this: r16
void camera::update_user_control(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x33CFC0 -> 0x33D378
        class xVec3 player_xz; // r29+0x60
        class xVec3 xz_direction; // r29+0x50
        float desired_control_angle; // r29+0x6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D380 -> 0x0033D604
*/
// Range: 0x33D380 -> 0x33D604
// this: r16
void camera::start() {
    /* anonymous block */ {
        // Range: 0x33D380 -> 0x33D604
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D610 -> 0x0033D7A8
*/
// Range: 0x33D610 -> 0x33D7A8
// this: r16
void camera::create() {
    /* anonymous block */ {
        // Range: 0x33D610 -> 0x33D7A8
