/*
    Compile unit: C:\TestBuild\in\GAME\zShrapnel.cpp
...
static class xMat4x3 tmpMat; // size: 0x40, address: 0x66C370
static signed int sNumActiveFrags; // size: 0x4, address: 0x608C90
static class zFrag sFragPool[150]; // size: 0x5208, address: 0x66C3B0
static class zFrag sFirstFreeFrag; // size: 0x8C, address: 0x6715C0
static class zFrag sFirstActiveFrag; // size: 0x8C, address: 0x671650
static class zFrag sProjectileList; // size: 0x8C, address: 0x6716E0
static class zFrag sLightningList; // size: 0x8C, address: 0x671770
static class zFrag sParticleList; // size: 0x8C, address: 0x671800
static class zFrag sSoundList; // size: 0x8C, address: 0x671890
static class zFrag sExplosionList; // size: 0x8C, address: 0x671920
static class zFrag sDistortionList; // size: 0x8C, address: 0x6719B0
static class zFrag sFireList; // size: 0x8C, address: 0x671A40
static class _tagLightningAdd sLightningAddInfo; // size: 0x68, address: 0x671AD0
static class zShrapnelInitTable sShrapnelTable[1]; // size: 0xC, address: 0x671B38
static class smoke_config smoke_config; // size: 0x38, address: 0x671B50
static void (* sCinCB)(class zFrag *, class zFragAsset *); // size: 0x4, address: 0x608C94
static class zFrag * sCinFrag; // size: 0x4, address: 0x608C98
static class zFragProjectileAsset sCinProj; // size: 0x110, address: 0x671B90
static class RpAtomic * sCinModel; // size: 0x4, address: 0x608C9C
void exampleFragCB(class zFrag *, class zFragAsset *); // size: 0x0, address: 0x0
class zGlobals globals; // size: 0x640, address: 0x61C210
void zFrag_DefaultShrapnelUpdate(class zFrag *, float); // size: 0x0, address: 0x1E1CA0
void zFrag_DefaultFireUpdate(class zFrag *, float); // size: 0x0, address: 0x1E1E40
void zFrag_DefaultDistortionUpdate(class zFrag *, float); // size: 0x0, address: 0x1E1F30
void zFrag_DefaultExplosionUpdate(class zFrag *, float); // size: 0x0, address: 0x1E2150
void zFrag_DefaultSoundUpdate(class zFrag *, float); // size: 0x0, address: 0x1E22B0
void zFrag_DefaultParticleUpdate(class zFrag *, float); // size: 0x0, address: 0x1E3C70
void zFrag_DefaultLightningUpdate(class zFrag *, float); // size: 0x0, address: 0x1E2520
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
void zFrag_DefaultProjectileUpdate(class zFrag *, float); // size: 0x0, address: 0x1E2E50
...
void CinFragCB(class zFrag *, class zFragAsset *); // size: 0x0, address: 0x1E5740
...
class xColor_tag g_YELLOW; // size: 0x4, address: 0x5E7200
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E1CA0 -> 0x001E1CF4
*/
// Range: 0x1E1CA0 -> 0x1E1CF4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E1D00 -> 0x001E1E38
*/
// Range: 0x1E1D00 -> 0x1E1E38
static void zFrag_DistortionManager(float dt /* r20 */) {
    /* anonymous block */ {
        ...
        class zFragDistortionAsset * a; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E1E40 -> 0x001E1F2C
*/
// Range: 0x1E1E40 -> 0x1E1F2C
static void zFrag_DefaultFireUpdate(class zFrag * frag /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1E1E40 -> 0x1E1F2C
        class zFragFireAsset * a; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E1F30 -> 0x001E2080
*/
// Range: 0x1E1F30 -> 0x1E2080
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2080 -> 0x001E214C
*/
// Range: 0x1E2080 -> 0x1E214C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2150 -> 0x001E22AC
*/
// Range: 0x1E2150 -> 0x1E22AC
static void zFrag_DefaultExplosionUpdate(class zFrag * frag /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1E2150 -> 0x1E22AC
        class zFragExplosion * f; // r2
        class zFragExplosionAsset * a; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E22B0 -> 0x001E2384
*/
// Range: 0x1E22B0 -> 0x1E2384
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2390 -> 0x001E2520
*/
// Range: 0x1E2390 -> 0x1E2520
void zFrag_LightningManager(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1E2390 -> 0x1E2520
        class zFrag * frag; // r21
        class zFragLightning * ligh; // r2
        class zFragLightningAsset * lasset; // r20
        class zLightning * inst; // r19
        class zFrag * next; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2520 -> 0x001E2600
*/
// Range: 0x1E2520 -> 0x1E2600
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2600 -> 0x001E2E48
*/
// Range: 0x1E2600 -> 0x1E2E48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E2E50 -> 0x001E3A08
*/
// Range: 0x1E2E50 -> 0x1E3A08
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E3A10 -> 0x001E3C64
*/
// Range: 0x1E3A10 -> 0x1E3C64
void zFrag_ParticleManager(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1E3A10 -> 0x1E3C64
        class zFrag * frag; // r21
        class zFragParticle * part; // r2
        class zFrag * next; // r20
        class zFragParticleAsset * passet; // r2
        class xVec3 pos; // r29+0x110
        class xVec3 dir; // r29+0x100
        class xVec3 velocity; // r29+0xF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E3C70 -> 0x001E3CD8
*/
// Range: 0x1E3C70 -> 0x1E3CD8
void zFrag_DefaultParticleUpdate(class zFrag * frag /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E3C70 -> 0x1E3CD8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E3CE0 -> 0x001E4AD4
*/
// Range: 0x1E3CE0 -> 0x1E4AD4
unsigned char zFrag_DefaultInit(class zFrag * frag /* r18 */, class zFragAsset * fasset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E3CE0 -> 0x1E4AD4
        class zFragProjectileAsset * passet; // r17
        class RpAtomic * m; // r2
        class zFragProjectile * proj; // r16
        class zFragLightningAsset * lasset; // r16
        class zFragParticleAsset * prasset; // r16
        class zFragSoundAsset * sasset; // r6
        class zFragExplosionAsset * easset; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E4AE0 -> 0x001E4CB8
*/
// Range: 0x1E4AE0 -> 0x1E4CB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E4CC0 -> 0x001E50AC
*/
// Range: 0x1E4CC0 -> 0x1E50AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E50B0 -> 0x001E54A0
*/
// Range: 0x1E50B0 -> 0x1E54A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E54A0 -> 0x001E5734
*/
// Range: 0x1E54A0 -> 0x1E5734
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E5740 -> 0x001E57A4
*/
// Range: 0x1E5740 -> 0x1E57A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E57B0 -> 0x001E5A18
*/
// Range: 0x1E57B0 -> 0x1E5A18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E5A20 -> 0x001E5AF8
*/
// Range: 0x1E5A20 -> 0x1E5AF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E5B00 -> 0x001E5B64
*/
// Range: 0x1E5B00 -> 0x1E5B64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E5B70 -> 0x001E5D30
*/
// Range: 0x1E5B70 -> 0x1E5D30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E5D30 -> 0x001E6250
*/
// Range: 0x1E5D30 -> 0x1E6250
void zShrapnel_SceneInit() {
    /* anonymous block */ {
        ...
        signed int j; // r20
        class zShrapnelAsset * sa; // r19
        class zFragAsset * fa; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E6250 -> 0x001E6440
*/
// Range: 0x1E6250 -> 0x1E6440
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E6440 -> 0x001E64E0
*/
// Range: 0x1E6440 -> 0x1E64E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001E64E0 -> 0x001E6570
*/
// Range: 0x1E64E0 -> 0x1E6570
