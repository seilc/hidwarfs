/*
    Compile unit: C:\TestBuild\in\GAME\zVolume.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class zVolume * vols; // size: 0x4, address: 0x608868
static unsigned short nvols; // size: 0x2, address: 0x60886C
signed int gOccludeCount; // size: 0x4, address: 0x608870
class zVolume * gOccludeList[10]; // size: 0x28, address: 0x61D1A0
signed int gOccludeCalcCount; // size: 0x4, address: 0x608874
class PreCalcOcclude gOccludeCalc[10]; // size: 0x320, address: 0x61D1D0
signed int occludeAlwaysFalse; // size: 0x4, address: 0x0
class zGlobals globals; // size: 0x640, address: 0x61C210
void zVolumeEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x158A40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00158A40 -> 0x00158B64
*/
// Range: 0x158A40 -> 0x158B64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00158B70 -> 0x00159144
*/
// Range: 0x158B70 -> 0x159144
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00159150 -> 0x0015916C
*/
// Range: 0x159150 -> 0x15916C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00159170 -> 0x001591DC
*/
// Range: 0x159170 -> 0x1591DC
void zVolumeSetup() {
    /* anonymous block */ {
        // Range: 0x159170 -> 0x1591DC
        unsigned int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001591E0 -> 0x001592BC
*/
// Range: 0x1591E0 -> 0x1592BC
void zVolumeInit() {
    /* anonymous block */ {
        // Range: 0x1591E0 -> 0x1592BC
