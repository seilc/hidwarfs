/*
    Compile unit: C:\TestBuild\in\GAME\zTransientModel.cpp
...
static class module_type * module; // size: 0x4, address: 0x60973C
...
public:
    ...
    class RpAtomic * models[8]; // offset 0x6C, size 0x20
    signed int models_size; // offset 0x8C, size 0x4
    class node_type * head; // offset 0x90, size 0x4
    class node_type * tail; // offset 0x94, size 0x4
    signed int active; // offset 0x98, size 0x4
    float intensity_range; // offset 0x9C, size 0x4
    float scale_range; // offset 0xA0, size 0x4
    float fade_in_alpha_scale; // offset 0xA4, size 0x4
    float fade_out_alpha_scale; // offset 0xA8, size 0x4
};
// total size: 0x8
class node_base {
    // Members
...
public:
    ...
    class entry_data * space_entry; // offset 0x10, size 0x4
};
// total size: 0x14
...
public:
    ...
    class transient_instance value; // offset 0x8, size 0x14
};
// total size: 0x10
class xJSPNodeTree {
    // Members
...
public:
    ...
    class node_type * fade_head; // offset 0x30, size 0x4
    signed int fade_active; // offset 0x34, size 0x4
};
// total size: 0x14
...
public:
    ...
    signed int hits; // offset 0x14, size 0x4
};
// total size: 0xC
...
public:
    ...
    class activity_data * _buffer; // offset 0x8, size 0x4
};
// total size: 0x10
...
public:
    ...
    signed int overlap_max; // offset 0x4, size 0x4
    ...
    class _xFColor color; // offset 0x2C, size 0x10
    unsigned int * models; // offset 0x3C, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DF20 -> 0x0049E1A4
*/
// Range: 0x49DF20 -> 0x49E1A4
// this: r21
void zTransientModelEmitter::render() {
    /* anonymous block */ {
        ...
        float cy; // r22
        float cz; // r21
        float max_dist; // r29+0x80
        float max_dist2; // r20
        class node_type * it; // r16
        signed int i; // r20
        signed int end; // r2
        class transient_instance & inst; // r2
        class xVec3 & loc; // r2
        float dx; // r29+0x80
        float dy; // r29+0x80
        float dz; // r29+0x80
        float alpha; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E1B0 -> 0x0049E4AC
*/
// Range: 0x49E1B0 -> 0x49E4AC
// this: r21
void zTransientModelEmitter::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x49E1B0 -> 0x49E4AC
        float max_life; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E4B0 -> 0x0049E4D8
*/
// Range: 0x49E4B0 -> 0x49E4D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E4E0 -> 0x0049E508
*/
// Range: 0x49E4E0 -> 0x49E508
void zTransientModelUpdate(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x49E4E0 -> 0x49E508
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E510 -> 0x0049E60C
*/
// Range: 0x49E510 -> 0x49E60C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E610 -> 0x0049E61C
*/
// Range: 0x49E610 -> 0x49E61C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E620 -> 0x0049E800
*/
// Range: 0x49E620 -> 0x49E800
void zTransientModelSceneEnter() {
    /* anonymous block */ {
        // Range: 0x49E620 -> 0x49E800
        class module_type * module'96; // r2
        signed int emitters_max; // r17
        signed int instances_max; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E800 -> 0x0049E8BC
*/
// Range: 0x49E800 -> 0x49E8BC
// this: r17
static void module_type::render() {
    /* anonymous block */ {
        // Range: 0x49E800 -> 0x49E8BC
        class activity_data * act; // r16
        class activity_data * end_act; // r2
        class node_type * it; // r18
        signed int i; // r17
        signed int end; // r2
        class transient_instance & inst; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049E8C0 -> 0x0049EA20
*/
// Range: 0x49E8C0 -> 0x49EA20
// this: r16
static void module_type::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x49E8C0 -> 0x49EA20
        class activity_data * act; // r17
        class activity_data * end_act; // r2
        class node_type * it; // r21
        signed int i; // r20
        signed int end; // r2
        class transient_instance & inst; // r2
    }
