/*
    Compile unit: C:\TestBuild\in\GAME\zNPCTurret.cpp
...
enum iSndGroupHandle glow_sound_group; // size: 0x4, address: 0x608E28
class smoke_config config; // size: 0x38, address: 0x67F500
// total size: 0xB4
struct /* @anon5 */ {} zNPC::turret::__vtable; // size: 0xB4, address: 0x5FE790
// total size: 0x88
struct /* @anon12 */ {} zNPC::turret_follow_movepoints::__vtable; // size: 0x88, address: 0x5FEA90
// total size: 0x88
struct /* @anon8 */ {} zNPC::follow_movepoints::__vtable; // size: 0x88, address: 0x5FD810
// total size: 0x7C
struct /* @anon14 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon9 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon13 */ {} zNPC::bone_container<zNPC::smoke_bone>::__vtable; // size: 0x7C, address: 0x5FE850
// total size: 0x7C
struct /* @anon0 */ {} zNPC::bone_container<zNPC::glow_bone>::__vtable; // size: 0x7C, address: 0x5FE8D0
// total size: 0x7C
struct /* @anon10 */ {} zNPC::bone_container<zNPC::laser_bone>::__vtable; // size: 0x7C, address: 0x5FE4E0
// total size: 0x7C
struct /* @anon7 */ {} zNPC::bone_container<zNPC::aim_bone>::__vtable; // size: 0x7C, address: 0x5FE950
// total size: 0x7C
struct /* @anon15 */ {} zNPC::shrapnel_death::__vtable; // size: 0x7C, address: 0x600F30
// total size: 0x7C
struct /* @anon1 */ {} zNPC::take_damage::__vtable; // size: 0x7C, address: 0x5FD8A0
// total size: 0x7C
struct /* @anon19 */ {} zNPC::turret_alert::__vtable; // size: 0x7C, address: 0x5FECA0
// total size: 0x7C
struct /* @anon11 */ {} zNPC::up_down_spin::__vtable; // size: 0x7C, address: 0x5FED20
// total size: 0xB4
struct /* @anon2 */ {} zNPC::spin_turret::__vtable; // size: 0xB4, address: 0x5FE9D0
// total size: 0x7C
struct /* @anon18 */ {} zNPC::shoot_along_movepoints::__vtable; // size: 0x7C, address: 0x5FEC20
// total size: 0x7C
struct /* @anon3 */ {} zNPC::up_down::__vtable; // size: 0x7C, address: 0x5FEDA0
...
unsigned int anoverheated(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x223590
unsigned int annoticed(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x223D80
unsigned int annot_in_range(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x223DA0
unsigned int anin_range(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x224290
unsigned int annot_in_range(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x2242B0
// total size: 0x7C
struct /* @anon6 */ {} zNPC::smoke_bone::__vtable; // size: 0x7C, address: 0x5FEB20
// total size: 0x7C
struct /* @anon17 */ {} zNPC::glow_bone::__vtable; // size: 0x7C, address: 0x5FEBA0
void * __ct(class aim_bone *); // size: 0x0, address: 0x224750
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void * __ct(class laser_bone *); // size: 0x0, address: 0x221A70
void * __ct(class glow_bone *); // size: 0x0, address: 0x224900
void * __ct(class smoke_bone *); // size: 0x0, address: 0x224AB0
// total size: 0x7C
struct /* @anon4 */ {} zNPC::firing_bone::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon16 */ {} zNPC::bone_behavior::__vtable; // size: 0x7C, address: 0x0
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x8C
class glow_bone : public bone_behavior {
    // Members
public:
    unsigned char enabled; // offset 0x14, size 0x1
    signed int direction_bone; // offset 0x18, size 0x4
    signed int position_bone; // offset 0x1C, size 0x4
    signed int glare_id; // offset 0x20, size 0x4
    class xVec3 offset; // offset 0x24, size 0xC
    class xModelTag tag; // offset 0x30, size 0x20
    class energy_system energy; // offset 0x50, size 0x3C
};
// total size: 0x40
class RpLight {
    // Members
...
// total size: 0x5C
class smoke_bone : public firing_bone {
    // Members
public:
    float time; // offset 0x4C, size 0x4
    float total_time; // offset 0x50, size 0x4
    float emit_remaining; // offset 0x54, size 0x4
    float offset; // offset 0x58, size 0x4
};
// total size: 0x18
class xAnimTable {
    // Members
...
// total size: 0x38
class shoot_along_movepoints : public behavior_implementation {
    // Members
public:
    float shot_delay; // offset 0x10, size 0x4
    float time; // offset 0x14, size 0x4
    float shot_speed; // offset 0x18, size 0x4
    class xVec3 target; // offset 0x1C, size 0xC
    class xMovePoint * start_movepoint; // offset 0x28, size 0x4
    class xMovePoint * movepoint; // offset 0x2C, size 0x4
    class bone_container & laser_bones; // offset 0x30, size 0x4
    class bone_container & aim_bones; // offset 0x34, size 0x4
};
// total size: 0x20
class up_down : public behavior_implementation {
    // Members
public:
    unsigned char target_visible; // offset 0x10, size 0x1
    char * last_state; // offset 0x14, size 0x4
    float default_alert_radius; // offset 0x18, size 0x4
    float alert_radius; // offset 0x1C, size 0x4
};
// total size: 0x8C
...
class bone_container : public behavior_implementation {
    // Members
public:
    class smoke_bone * array; // offset 0x10, size 0x4
...
// total size: 0x38
class up_down_spin : public behavior_implementation {
    // Members
public:
    unsigned char seen_player; // offset 0x10, size 0x1
    float spin_speed; // offset 0x14, size 0x4
    float spin_max; // offset 0x18, size 0x4
    float spin_min; // offset 0x1C, size 0x4
    float alert_radius; // offset 0x20, size 0x4
    float default_alert_radius; // offset 0x24, size 0x4
    float current_rotation; // offset 0x28, size 0x4
    class bone_container & aim_bones; // offset 0x2C, size 0x4
    char * last_state; // offset 0x30, size 0x4
    unsigned char rotate_right; // offset 0x34, size 0x1
};
// total size: 0xC0
class xEntDrive {
    // Members
...
struct /* @anon3 */ {};
// total size: 0xC0
class turret_follow_movepoints : public follow_movepoints {
    // Members
public:
    class xMovePoint * turret_movepoint; // offset 0xB0, size 0x4
};
// total size: 0xD8
...
// total size: 0x50
class turret_alert : public behavior_implementation {
    // Members
public:
    float shot_delay; // offset 0x10, size 0x4
    float time; // offset 0x14, size 0x4
    float aim_time; // offset 0x18, size 0x4
    float pause_time; // offset 0x1C, size 0x4
    float glow_start_time; // offset 0x20, size 0x4
    float glow_end_time; // offset 0x24, size 0x4
    float cooldown_time; // offset 0x28, size 0x4
    signed int shots_left; // offset 0x2C, size 0x4
    signed int shots_in_group; // offset 0x30, size 0x4
    class group_attack attacker; // offset 0x34, size 0x1
    class bone_container & laser_bones; // offset 0x38, size 0x4
    class bone_container & aim_bones; // offset 0x3C, size 0x4
    class bone_container & glow_bones; // offset 0x40, size 0x4
    class bone_container & smoke_bones; // offset 0x44, size 0x4
    enum iSndHandle glow_sound; // offset 0x48, size 0x4
    enum /* @enum */ {
        SHOOTING = 0,
        OVERHEAT = 1,
        AIM = 2,
        START_ATTACK = 3,
    } state; // offset 0x4C, size 0x4
};
// total size: 0xC
...
class bone_container : public behavior_implementation {
    // Members
public:
    class laser_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x4
class xModelBlur {
...
class zDuplicator {};
// total size: 0x4E0
class spin_turret : public common {
    // Members
public:
    class up_down_spin turret_idle_state; // offset 0x2C0, size 0x38
    class turret_alert turret_alert_state; // offset 0x2F8, size 0x50
    class take_damage take_damage_state; // offset 0x348, size 0x2C
    class shrapnel_death shrapnel_death_state; // offset 0x374, size 0x40
    class bone_container aim_bones; // offset 0x3B4, size 0x18
    class bone_container laser_bones; // offset 0x3CC, size 0x18
    class bone_container glow_bones; // offset 0x3E4, size 0x18
    class bone_container smoke_bones; // offset 0x3FC, size 0x18
    class turret_follow_movepoints follow_movepoints_state; // offset 0x420, size 0xC0
};
// total size: 0x0
...
class bone_container : public behavior_implementation {
    // Members
public:
    class glow_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x500
class turret : public common {
    // Members
public:
    class up_down turret_idle_state; // offset 0x2C0, size 0x20
    class shoot_along_movepoints shoot_along_movepoints_state; // offset 0x2E0, size 0x38
    class turret_alert turret_alert_state; // offset 0x318, size 0x50
    class take_damage take_damage_state; // offset 0x368, size 0x2C
    class shrapnel_death shrapnel_death_state; // offset 0x394, size 0x40
    class bone_container aim_bones; // offset 0x3D4, size 0x18
    class bone_container laser_bones; // offset 0x3EC, size 0x18
    class bone_container glow_bones; // offset 0x404, size 0x18
    class bone_container smoke_bones; // offset 0x41C, size 0x18
    class turret_follow_movepoints follow_movepoints_state; // offset 0x440, size 0xC0
};
// total size: 0x18
class RwResEntry {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00221B10 -> 0x00221B34
*/
// Range: 0x221B10 -> 0x221B34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00221B40 -> 0x00221D70
*/
// Range: 0x221B40 -> 0x221D70
// this: r16
spin_turret::spin_turret() {
    /* anonymous block */ {
        // Range: 0x221B40 -> 0x221D70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00221D70 -> 0x00221D78
*/
// Range: 0x221D70 -> 0x221D78
// this: r2
void turret::setup() {
    /* anonymous block */ {
        // Range: 0x221D70 -> 0x221D78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00221D80 -> 0x00221DA4
*/
// Range: 0x221D80 -> 0x221DA4
void static_scene_setup() {
    /* anonymous block */ {
        // Range: 0x221D80 -> 0x221DA4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00221DB0 -> 0x00222014
*/
// Range: 0x221DB0 -> 0x222014
// this: r16
turret::turret() {
    /* anonymous block */ {
        // Range: 0x221DB0 -> 0x222014
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222020 -> 0x0022202C
*/
// Range: 0x222020 -> 0x22202C
// this: r2
void turret_follow_movepoints::set_start_movepoint() {
    /* anonymous block */ {
        // Range: 0x222020 -> 0x22202C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222030 -> 0x0022209C
*/
// Range: 0x222030 -> 0x22209C
// this: r16
void turret_follow_movepoints::setup() {
    /* anonymous block */ {
        // Range: 0x222030 -> 0x22209C
        char * movepoint_name; // r29+0x2C
        unsigned int movepoint_id; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002220A0 -> 0x00222208
*/
// Range: 0x2220A0 -> 0x222208
// this: r16
void smoke_bone::setup() {
    /* anonymous block */ {
        // Range: 0x2220A0 -> 0x222208
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222210 -> 0x00222218
*/
// Range: 0x222210 -> 0x222218
// this: r2
void smoke_bone::reset() {
    /* anonymous block */ {
        // Range: 0x222210 -> 0x222218
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222220 -> 0x0022234C
*/
// Range: 0x222220 -> 0x22234C
// this: r16
void smoke_bone::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x222220 -> 0x22234C
        class xVec3 pos; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222350 -> 0x00222360
*/
// Range: 0x222350 -> 0x222360
// this: r2
void smoke_bone::enter_state() {
    /* anonymous block */ {
        // Range: 0x222350 -> 0x222360
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222360 -> 0x00222530
*/
// Range: 0x222360 -> 0x222530
// this: r17
void glow_bone::setup() {
    /* anonymous block */ {
        // Range: 0x222360 -> 0x222530
        class xVec3 pos; // r29+0x270
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222530 -> 0x00222538
*/
// Range: 0x222530 -> 0x222538
// this: r2
void glow_bone::reset() {
    /* anonymous block */ {
        // Range: 0x222530 -> 0x222538
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222540 -> 0x00222784
*/
// Range: 0x222540 -> 0x222784
// this: r16
void glow_bone::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x222540 -> 0x222784
        class xMat3x3 mat; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222790 -> 0x00222798
*/
// Range: 0x222790 -> 0x222798
// this: r2
void glow_bone::exit_state() {
    /* anonymous block */ {
        // Range: 0x222790 -> 0x222798
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002227A0 -> 0x00222C30
*/
// Range: 0x2227A0 -> 0x222C30
// this: r21
void shoot_along_movepoints::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2227A0 -> 0x222C30
        class xVec3 direction; // r29+0x110
        float move_dt; // r20
        float direction_length; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222C30 -> 0x00222C3C
*/
// Range: 0x222C30 -> 0x222C3C
// this: r2
void shoot_along_movepoints::reset() {
    /* anonymous block */ {
        // Range: 0x222C30 -> 0x222C3C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222C40 -> 0x00222CB8
*/
// Range: 0x222C40 -> 0x222CB8
// this: r16
void shoot_along_movepoints::setup() {
    /* anonymous block */ {
        // Range: 0x222C40 -> 0x222CB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222CC0 -> 0x00222D60
*/
// Range: 0x222CC0 -> 0x222D60
// this: r16
void shoot_along_movepoints::enter_state() {
    /* anonymous block */ {
        // Range: 0x222CC0 -> 0x222D60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222D60 -> 0x00222DBC
*/
// Range: 0x222D60 -> 0x222DBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222DC0 -> 0x00222E60
*/
// Range: 0x222DC0 -> 0x222E60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222E60 -> 0x00222FB8
*/
// Range: 0x222E60 -> 0x222FB8
// this: r16
void turret_alert::setup() {
    /* anonymous block */ {
        // Range: 0x222E60 -> 0x222FB8
        class xAnimState * state; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222FC0 -> 0x00222FF0
*/
// Range: 0x222FC0 -> 0x222FF0
// this: r2
void turret_alert::exit_state() {
    /* anonymous block */ {
        // Range: 0x222FC0 -> 0x222FF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00222FF0 -> 0x0022304C
*/
// Range: 0x222FF0 -> 0x22304C
// this: r16
void turret_alert::enter_state() {
    /* anonymous block */ {
        // Range: 0x222FF0 -> 0x22304C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223050 -> 0x002234C8
*/
// Range: 0x223050 -> 0x2234C8
// this: r16
void turret_alert::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x223050 -> 0x2234C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002234D0 -> 0x00223584
*/
// Range: 0x2234D0 -> 0x223584
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002235C0 -> 0x002236A0
*/
// Range: 0x2235C0 -> 0x2236A0
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2235C0 -> 0x2236A0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002236A0 -> 0x00223954
*/
// Range: 0x2236A0 -> 0x223954
// this: r17
void up_down_spin::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2236A0 -> 0x223954
        class xVec3 aim_direction; // r29+0x60
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223960 -> 0x00223988
*/
// Range: 0x223960 -> 0x223988
// this: r2
void up_down_spin::reset() {
    /* anonymous block */ {
        // Range: 0x223960 -> 0x223988
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223990 -> 0x00223A6C
*/
// Range: 0x223990 -> 0x223A6C
// this: r16
void up_down_spin::setup() {
    /* anonymous block */ {
        // Range: 0x223990 -> 0x223A6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223A70 -> 0x00223A90
*/
// Range: 0x223A70 -> 0x223A90
// this: r2
void up_down_spin::exit_state() {
    /* anonymous block */ {
        // Range: 0x223A70 -> 0x223A90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223A90 -> 0x00223AD4
*/
// Range: 0x223A90 -> 0x223AD4
// this: r16
void up_down_spin::enter_state() {
    /* anonymous block */ {
        // Range: 0x223A90 -> 0x223AD4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223AE0 -> 0x00223BFC
*/
// Range: 0x223AE0 -> 0x223BFC
// this: r18
unsigned char up_down_spin::runnable() {
    /* anonymous block */ {
        // Range: 0x223AE0 -> 0x223BFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223C00 -> 0x00223C28
*/
// Range: 0x223C00 -> 0x223C28
// this: r2
unsigned char up_down_spin::system_event(unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x223C00 -> 0x223C28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223C30 -> 0x00223D78
*/
// Range: 0x223C30 -> 0x223D78
void add_transitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x223C30 -> 0x223D78
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223E00 -> 0x00223F20
*/
// Range: 0x223E00 -> 0x223F20
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x223E00 -> 0x223F20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223F20 -> 0x00223F2C
*/
// Range: 0x223F20 -> 0x223F2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223F30 -> 0x00223F58
*/
// Range: 0x223F30 -> 0x223F58
// this: r2
unsigned char up_down::system_event(unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x223F30 -> 0x223F58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223F60 -> 0x00223F78
*/
// Range: 0x223F60 -> 0x223F78
// this: r2
void up_down::reset() {
    /* anonymous block */ {
        // Range: 0x223F60 -> 0x223F78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00223F80 -> 0x00224008
*/
// Range: 0x223F80 -> 0x224008
// this: r16
void up_down::setup() {
    /* anonymous block */ {
        // Range: 0x223F80 -> 0x224008
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224010 -> 0x00224030
*/
// Range: 0x224010 -> 0x224030
// this: r2
void up_down::exit_state() {
    /* anonymous block */ {
        // Range: 0x224010 -> 0x224030
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224030 -> 0x00224054
*/
// Range: 0x224030 -> 0x224054
// this: r2
void up_down::enter_state() {
    /* anonymous block */ {
        // Range: 0x224030 -> 0x224054
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224060 -> 0x00224140
*/
// Range: 0x224060 -> 0x224140
// this: r16
unsigned char up_down::runnable() {
    /* anonymous block */ {
        // Range: 0x224060 -> 0x224140
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224140 -> 0x00224288
*/
// Range: 0x224140 -> 0x224288
void add_transitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x224140 -> 0x224288
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002242E0 -> 0x00224400
*/
// Range: 0x2242E0 -> 0x224400
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2242E0 -> 0x224400
    }
