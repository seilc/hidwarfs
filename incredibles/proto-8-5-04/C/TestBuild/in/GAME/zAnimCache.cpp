/*
    Compile unit: C:\TestBuild\in\GAME\zAnimCache.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int cachedAnimations; // size: 0x4, address: 0x6090A0
static class zAnimCacheEntry cachedEntry[32]; // size: 0x180, address: 0x68AD60
static unsigned int currentCacheIndex; // size: 0x4, address: 0x6090A4
static class xVec3 cache[5120]; // size: 0xF000, address: 0x68AEE0
// total size: 0x14
class xAnimEffect {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F79B0 -> 0x002F7B84
*/
// Range: 0x2F79B0 -> 0x2F7B84
void zAnimCacheCreateData(class zAttackTableState * attackTableStates /* r2 */, unsigned int attackTableCount /* r23 */, class xAnimPlay * animPlay /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2F79B0 -> 0x2F7B84
        unsigned int i; // r21
        unsigned int j; // r20
        class zAnimCacheEntry newCacheEntry; // r29+0x90
        class xAnimState * state; // r2
        unsigned int entryIndex; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7B90 -> 0x002F7B9C
*/
// Range: 0x2F7B90 -> 0x2F7B9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7BA0 -> 0x002F7D08
*/
// Range: 0x2F7BA0 -> 0x2F7D08
static void fillInCache(class zAnimCacheEntry * cacheEntry /* r18 */, class RpAtomic * model /* r17 */, float startTime /* r21 */, float endTime /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2F7BA0 -> 0x2F7D08
        class xVec3 tempPositions[64]; // r29+0x1450
        class xQuat tempQuats[64]; // r29+0x1050
        class xMat4x3 tempMats[64]; // r29+0x50
        class xVec3 * currentCachePos; // r16
        float time; // r29+0x1750
    }
}
