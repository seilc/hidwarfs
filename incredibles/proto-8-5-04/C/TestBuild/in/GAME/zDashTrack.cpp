/*
    Compile unit: C:\TestBuild\in\GAME\zDashTrack.cpp
...
class track * head; // size: 0x4, address: 0x609214
class track * current_track; // size: 0x4, address: 0x609218
class xVec3 last_impulse; // size: 0xC, address: 0x6A89E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371AE0 -> 0x00371DC8
*/
// Range: 0x371AE0 -> 0x371DC8
unsigned char swept_point_to_circle(class xVec2 & position /* r2 */, class xVec2 & dpos /* r2 */, class xVec2 & center /* r2 */, float radius /* r29+0x20 */, class xVec2 & normal /* r2 */, float & min_t /* r2 */) {
    /* anonymous block */ {
        // Range: 0x371AE0 -> 0x371DC8
        class xVec2 P; // r29+0x18
        float radius_2; // r29+0x20
        float b; // r29+0x20
        float c; // r29+0x20
        float t; // r29+0x20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371DD0 -> 0x003723DC
*/
// Range: 0x371DD0 -> 0x3723DC
// this: r23
unsigned char track::get_static_mesh_collision(class xVec3 & position /* r18 */, float radius /* r20 */, class static_collision_record * record /* r22 */, signed int & collision_count /* r17 */, signed int triangle /* r19 */, unsigned int check_number /* r16 */) {
    /* anonymous block */ {
        // Range: 0x371DD0 -> 0x3723DC
        signed int i; // r21
        unsigned int vertex_a_index; // r2
        unsigned int vertex_b_index; // r2
        class xVec3 vertex_a_3d; // r29+0x130
        class xVec3 vertex_b_3d; // r29+0x120
        class xVec2 vertex_a; // r29+0x118
        class xVec2 vertex_b; // r29+0x110
        class xVec2 position_2d; // r29+0x108
        class xVec2 contact; // r29+0x100
        float d; // r29+0x140
        unsigned short portal_triangle; // r2
        unsigned char found_edge; // r9
        signed int j; // r8
        class xVec2 edge_to_position; // r29+0xF8
        class xVec2 edge_direction; // r29+0xF0
        class xVec2 edge_normal; // r29+0xE8
        unsigned int _check_number; // @ 0x00607CD0
        unsigned int visited[5000]; // @ 0x006AD8A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003723E0 -> 0x00372B60
*/
// Range: 0x3723E0 -> 0x372B60
// this: r19
unsigned char track::swept_circle_collide_mesh(signed int triangle /* r30 */, class xVec2 & position /* r18 */, class xVec2 & dpos /* r17 */, float radius /* r23 */, class xVec2 & normal /* r23 */, float & min_t /* r16 */, class xVec2 & contact /* r29+0xE4 */, unsigned int check_number /* r22 */) {
    /* anonymous block */ {
        // Range: 0x3723E0 -> 0x372B60
        unsigned char collision; // r21
        float check_radius; // r22
        signed int i; // r20
        signed int next_triangle; // r30
        class xVec3 vertex_a_3d; // r29+0x168
        class xVec3 vertex_b_3d; // r29+0x158
        class xVec2 vertex_a; // r29+0x150
        class xVec2 vertex_b; // r29+0x148
        class xVec2 c; // r29+0x140
        float d; // r21
        float r; // r29+0x17C
        float s; // r29+0x178
        class xVec2 edge_direction; // r29+0x138
        class xVec2 edge_normal; // r29+0x130
        class xVec2 position_to_vertex_a; // r29+0x128
        class xVec2 position_to_vertex_b; // r29+0x120
        float t; // r29+0x180
        class xVec2 edge_normal; // r29+0x118
        unsigned int _check_number; // @ 0x00607CCC
        unsigned int visited[5000]; // @ 0x006A8A80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00372B60 -> 0x00372CD4
*/
// Range: 0x372B60 -> 0x372CD4
// this: r2
unsigned char track::in_triangle(signed int triangle_index /* r2 */, class xVec2 & point /* r2 */) {
    /* anonymous block */ {
        // Range: 0x372B60 -> 0x372CD4
        class xVec3 v[3]; // r29
        unsigned char c; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00372CE0 -> 0x00372F90
*/
// Range: 0x372CE0 -> 0x372F90
// this: r21
signed int track::get_triangle(class xVec2 & position /* r20 */, signed int current_triangle /* r19 */, signed int depth /* r18 */) {
    /* anonymous block */ {
        // Range: 0x372CE0 -> 0x372F90
        class xVec2 v[3]; // r29+0x90
        signed int i; // r11
        class xVec3 temp; // r29+0xD0
        float distance[3]; // r29+0xC0
        signed int i; // r17
        signed int order[3]; // r29+0xB0
        signed int i; // r8
        signed int j; // r7
        signed int temp_int; // r2
        signed int i; // r16
        signed int test_triangle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00372F90 -> 0x00373734
*/
// Range: 0x372F90 -> 0x373734
// this: r2
void track::interpolate_impulse(signed int triangle /* r2 */, class xVec3 & point /* r2 */, class xVec3 & return_impulse /* r2 */) {
    /* anonymous block */ {
        // Range: 0x372F90 -> 0x373734
        class xVec3 vp1; // r29+0x190
        class xVec3 vp2; // r29+0x180
        class xVec3 vp3; // r29+0x170
        class xVec2 tp1; // r29+0x168
        class xVec2 tp2; // r29+0x160
        class xVec2 tp3; // r29+0x158
        class xVec3 v1; // r29+0x148
        class xVec3 v2; // r29+0x138
        class xVec3 normal; // r29+0x128
        class xVec2 t1; // r29+0x120
        class xVec2 t2; // r29+0x118
        float det; // r8
        class xVec2 pre_mult; // r29+0x110
        class xVec2 impulse; // r29+0x108
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00373740 -> 0x003740E8
*/
// Range: 0x373740 -> 0x3740E8
// this: r21
void track::cast_through_track(class xVec3 & direction /* r20 */, signed int triangle /* r19 */, class xVec3 & point /* r18 */, float & distance /* r17 */, unsigned char debug_draw /* r30 */) {
    /* anonymous block */ {
        // Range: 0x373740 -> 0x3740E8
        class xVec3 v[3]; // r29+0xC0
        float r; // r29+0x2BC
        float s; // r29+0x2B8
        signed int i; // r22
        class xVec3 edge_direction; // r29+0x2A8
        class xVec3 normal; // r29+0x298
        class xVec3 end; // r29+0x288
        signed int next_triangle; // r2
        class xVec3 intersection; // r29+0x278
        class xVec3 new_direction; // r29+0x268
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003740F0 -> 0x003740FC
*/
// Range: 0x3740F0 -> 0x3740FC
// this: r2
track::track(class track_asset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3740F0 -> 0x3740FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374100 -> 0x0037445C
*/
// Range: 0x374100 -> 0x37445C
void static_sphere_track(class xSphere & sphere /* r17 */, class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x374100 -> 0x37445C
        class xVec2 triangle_position; // r29+0x48
        signed int triangle; // r2
        signed int i; // r5
        signed int collision_count; // @ 0x0060921C
        class static_collision_record record[10]; // @ 0x006A8A00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374460 -> 0x003746E8
*/
// Range: 0x374460 -> 0x3746E8
unsigned char swept_sphere_to_track(class xSweptSphere & sws /* r17 */) {
    /* anonymous block */ {
        // Range: 0x374460 -> 0x3746E8
        class xVec2 triangle_position; // r29+0x80
        signed int triangle; // r2
        class xVec3 dir; // r29+0x70
        class xVec2 dpos; // r29+0x68
        class xVec2 normal; // r29+0x60
        float t; // r29+0x8C
        class xVec2 position; // r29+0x58
        class xVec2 contact; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003746F0 -> 0x003749D4
*/
// Range: 0x3746F0 -> 0x3749D4
unsigned char verify_track(class xVec3 & point /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3746F0 -> 0x3749D4
        signed int last_triangle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003749E0 -> 0x003749F4
*/
// Range: 0x3749E0 -> 0x3749F4
void exit() {
    /* anonymous block */ {
        // Range: 0x3749E0 -> 0x3749F4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374A00 -> 0x00374A38
*/
// Range: 0x374A00 -> 0x374A38
void get_cast_direction(class xVec3 & direction /* r5 */, class xVec3 & point /* r2 */, float distance /* r29+0x1C */) {
    /* anonymous block */ {
        // Range: 0x374A00 -> 0x374A38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374A40 -> 0x00374AF4
*/
// Range: 0x374A40 -> 0x374AF4
unsigned char get_impulse(class xVec3 & point /* r2 */, class xVec3 & impulse /* r16 */) {
    /* anonymous block */ {
        // Range: 0x374A40 -> 0x374AF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374B00 -> 0x00374B2C
*/
// Range: 0x374B00 -> 0x374B2C
void reset() {
    /* anonymous block */ {
        // Range: 0x374B00 -> 0x374B2C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374B30 -> 0x00374B84
*/
// Range: 0x374B30 -> 0x374B84
void add_track(class track * new_track /* r2 */) {
    /* anonymous block */ {
        // Range: 0x374B30 -> 0x374B84
        unsigned char no_tracks; // @ 0x00607CC8
    }
}
