/*
    Compile unit: C:\TestBuild\in\GAME\zEntSimpleObj.cpp
...
static unsigned int sMgrCount; // size: 0x4, address: 0x6085CC
static class zSimpleMgr * sMgrList; // size: 0x4, address: 0x6085D0
static unsigned int sSimpleCustomCount; // size: 0x4, address: 0x6085D4
static class xEnt * * sSimpleCustomList; // size: 0x4, address: 0x6085D8
class lightweight_system * system; // size: 0x4, address: 0x6085DC
// total size: 0x20
struct /* @anon2 */ {} z::toss::__vtable; // size: 0x20, address: 0x607430
// total size: 0x20
struct /* @anon3 */ {} z::lightweight<z::toss, 10>::__vtable; // size: 0x20, address: 0x5FD040
// total size: 0x24
struct /* @anon1 */ {} z::lightweight_system<z::toss, 10>::__vtable; // size: 0x24, address: 0x5FD060
// total size: 0x24
...
void zEntSimpleObj_Move(class xEnt *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x12F950
void zEntSimpleObj_Render(class xEnt *); // size: 0x0, address: 0x12FD00
void zEntSimpleObjEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x12E8B0
void zEntSimpleObj_Update(class zEntSimpleObj *, class xScene *, float); // size: 0x0, address: 0x12F490
...
void VisUpdateSimpleMgr(class xEnt *); // size: 0x0, address: 0x130FF0
signed int CmpSimpleMgr(void *, void *); // size: 0x0, address: 0x131050
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E880 -> 0x0012E8B0
*/
// Range: 0x12E880 -> 0x12E8B0
void zEntSimpleObj_MoveUpdate(class zEntSimpleObj * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12E880 -> 0x12E8B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E8B0 -> 0x0012F048
*/
// Range: 0x12E8B0 -> 0x12F048
void zEntSimpleObjEventCB(class xBase * from /* r20 */, class xBase * to /* r2 */, unsigned int toEvent /* r19 */, float * toParam /* r18 */, class xBase * toParamWidget /* r17 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12E8B0 -> 0x12F048
        class zEntSimpleObj * s; // r16
        class zShrapnelAsset * shrap; // r2
        class FloatAndVoid dist; // r29+0xDC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F050 -> 0x0012F3FC
*/
// Range: 0x12F050 -> 0x12F3FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F400 -> 0x0012F408
*/
// Range: 0x12F400 -> 0x12F408
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F410 -> 0x0012F418
*/
// Range: 0x12F410 -> 0x12F418
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F420 -> 0x0012F48C
*/
// Range: 0x12F420 -> 0x12F48C
void zEntSimpleObj_Setup(class zEntSimpleObj * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12F420 -> 0x12F48C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F490 -> 0x0012F630
*/
// Range: 0x12F490 -> 0x12F630
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F630 -> 0x0012F914
*/
// Range: 0x12F630 -> 0x12F914
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F920 -> 0x0012F950
*/
// Range: 0x12F920 -> 0x12F950
void zEntSimpleObj_CustomMove(class xEnt * ent /* r2 */, class xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12F920 -> 0x12F950
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F950 -> 0x0012F958
*/
// Range: 0x12F950 -> 0x12F958
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F960 -> 0x0012FCD4
*/
// Range: 0x12F960 -> 0x12FCD4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FCE0 -> 0x0012FCEC
*/
// Range: 0x12FCE0 -> 0x12FCEC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FCF0 -> 0x0012FCFC
*/
// Range: 0x12FCF0 -> 0x12FCFC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FD00 -> 0x0012FD40
*/
// Range: 0x12FD00 -> 0x12FD40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FD40 -> 0x0012FDB0
*/
// Range: 0x12FD40 -> 0x12FDB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FDB0 -> 0x0012FE54
*/
// Range: 0x12FDB0 -> 0x12FE54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FE60 -> 0x001304E0
*/
// Range: 0x12FE60 -> 0x1304E0
void zEntSimpleObj_MgrUpdateRender() {
    /* anonymous block */ {
        // Range: 0x12FE60 -> 0x1304E0
        unsigned int i; // r22
        unsigned int currPipeFlags; // r29+0xCC
        unsigned int pipeMask; // r29+0xB0
        enum RwFogType oldfogtype; // r2
        class CloneContainer ccont[2]; // r29+0xD0
        class RpAtomic * cloneAtomic; // r20
        class xLightKit * cloneLightKit; // r19
        float camX; // r22
        float camY; // r21
        float camZ; // r20
        class zSimpleMgr * smgr; // r18
        ...
        class CloneContainer * thisCont; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001304E0 -> 0x00130FE8
*/
// Range: 0x1304E0 -> 0x130FE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130FF0 -> 0x00131050
*/
// Range: 0x130FF0 -> 0x131050
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131050 -> 0x001310AC
*/
// Range: 0x131050 -> 0x1310AC
