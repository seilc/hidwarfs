/*
    Compile unit: C:\TestBuild\in\GAME\zRubbleGenerator.cpp
...
static class config landDustConfig; // size: 0x4C, address: 0x6BEDF0
static signed int numActiveGenerators; // size: 0x4, address: 0x609674
static signed int numActiveRubble; // size: 0x4, address: 0x609678
static class zRubble * rubble; // size: 0x4, address: 0x60967C
static unsigned int rubbleCount; // size: 0x4, address: 0x609680
class config default_config; // size: 0x4C, address: 0x6BA620
void * __ct(class zRubble *); // size: 0x0, address: 0x47D1E0
...
void * __ct(class zRubbleMarker *); // size: 0x0, address: 0x47D590
void RubbleEventWrapper(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x47EBC0
...
void StaticBoundsUpdate(class xEnt *, class xVec3 *); // size: 0x0, address: 0x47EB50
// total size: 0x38
class xGrid {
    // Members
public:
...
class zRubbleGenerator : public xBase {
    // Members
public:
    class zRubbleGeneratorAsset * asset; // offset 0x10, size 0x4
    class ModelData * models; // offset 0x14, size 0x4
    unsigned int spawnFromCount; // offset 0x18, size 0x4
    class zRubbleMarker * spawnFrom; // offset 0x1C, size 0x4
    unsigned int spawnToCount; // offset 0x20, size 0x4
    class zRubbleMarker * spawnTo; // offset 0x24, size 0x4
    void * * spawnToOccupied; // offset 0x28, size 0x4
    float nextSpawnTime; // offset 0x2C, size 0x4
    signed int spawnCount; // offset 0x30, size 0x4
    unsigned char on; // offset 0x34, size 0x1
    unsigned char initialGeneration; // offset 0x35, size 0x1
    unsigned char modelUsedSetBits; // offset 0x36, size 0x1
    unsigned int modelUsedMask; // offset 0x38, size 0x4
};
// total size: 0x60
...
class zRubble : public zEntSimpleObj {
    // Members
public:
    unsigned char active; // offset 0x100, size 0x1
    enum MotionState motionState; // offset 0x104, size 0x4
    class xVec3 source; // offset 0x108, size 0xC
    class xVec3 target; // offset 0x114, size 0xC
    class xVec3 velocity; // offset 0x120, size 0xC
    float velocityY; // offset 0x12C, size 0x4
    float velocityXZ; // offset 0x130, size 0x4
    float rotationalVelocity; // offset 0x134, size 0x4
    float time; // offset 0x138, size 0x4
    float maxTime; // offset 0x13C, size 0x4
    unsigned char linearSolution; // offset 0x140, size 0x1
    class zRubbleGenerator * parent; // offset 0x144, size 0x4
    enum zRubbleLandType landEffectType; // offset 0x148, size 0x4
    // total size: 0x4
    class /* @class */ {
        // Members
    public:
        float emitRemaining; // offset 0x0, size 0x4
    } dustEffect; // offset 0x14C, size 0x4
    enum iSndGroupHandle landSoundGroup; // offset 0x150, size 0x4
    // total size: 0x10C
    class /* @class */ {
        // Members
    public:
        class zDestructible destructible; // offset 0x0, size 0x58
        class zDestructibleState states[3]; // offset 0x58, size 0xB4
    } destructData; // offset 0x154, size 0x10C
};
// total size: 0x2C
...
class ModelData {
    // Members
public:
    class RpAtomic * file; // offset 0x0, size 0x4
    class xModelBucket * * bucket; // offset 0x4, size 0x4
    class xDestructibleAsset * destructibleAsset; // offset 0x8, size 0x4
};
// total size: 0x2C
class xJSPHeader {
    // Members
...
class xSurface {};
// total size: 0x5C
class FakeSimpleObjectAsset : public xEntAsset {
    // Members
public:
    class xSimpleObjAsset simp; // offset 0x50, size 0xC
};
...
// total size: 0x4C
class zRubbleGeneratorAsset : public xDynAsset {
    // Members
public:
    unsigned int flags; // offset 0x10, size 0x4
    ...
    float minVelocity; // offset 0x2C, size 0x4
    float maxVelocity; // offset 0x30, size 0x4
    unsigned int minRotations; // offset 0x34, size 0x4
    unsigned int maxRotations; // offset 0x38, size 0x4
    enum zRubbleLandType landEffectType; // offset 0x3C, size 0x4
    unsigned int repeatType; // offset 0x40, size 0x4
    union { // inferred
        unsigned int launchSoundGroupId; // offset 0x44, size 0x4
        enum iSndGroupHandle launchSoundGroup; // offset 0x44, size 0x4
    };
    union { // inferred
        unsigned int landSoundGroupId; // offset 0x48, size 0x4
        enum iSndGroupHandle landSoundGroup; // offset 0x48, size 0x4
    };
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047CC40 -> 0x0047CDCC
*/
// Range: 0x47CC40 -> 0x47CDCC
void zRubbleGeneratorReset(class zScene * scene /* r19 */) {
    /* anonymous block */ {
        // Range: 0x47CC40 -> 0x47CDCC
        unsigned int i; // r18
        class zRubbleGenerator * current; // r5
        class zRubbleGenerator * last; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047CDD0 -> 0x0047CE5C
*/
// Range: 0x47CDD0 -> 0x47CE5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047CE60 -> 0x0047CF58
*/
// Range: 0x47CE60 -> 0x47CF58
void zRubbleGeneratorUpdate(class zScene * scene /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x47CE60 -> 0x47CF58
        class zRubbleGenerator * current; // r16
        class zRubbleGenerator * last; // r2
        unsigned int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047CF60 -> 0x0047D1E0
*/
// Range: 0x47CF60 -> 0x47D1E0
void zRubbleGeneratorSceneSetup(class zScene * scene /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47CF60 -> 0x47D1E0
        signed int numActiveGenerators'122; // r3
        unsigned int rubbleCount'121; // r5
        unsigned int randomModelID; // r18
        class zRubbleGenerator * current; // r7
        class zRubbleGenerator * last; // r2
        unsigned int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047D1E0 -> 0x0047D1E8
*/
// Range: 0x47D1E0 -> 0x47D1E8
// this: r2
static zRubble::zRubble() {
    /* anonymous block */ {
        // Range: 0x47D1E0 -> 0x47D1E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047D1F0 -> 0x0047D314
*/
// Range: 0x47D1F0 -> 0x47D314
// this: r2
unsigned char zRubbleGenerator::CheckSpawnStatus(class RpAtomic * file /* r2 */, unsigned int which /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47D1F0 -> 0x47D314
        class xSphere sphere; // r29+0x60
        class xBound bound; // r29+0x10
        unsigned char hit; // r29+0x7F
        class HitCallback cb; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047D320 -> 0x0047D58C
*/
// Range: 0x47D320 -> 0x47D58C
void SetupMarkers(unsigned int baseID /* r16 */, class zRubbleMarker * & marker /* r18 */, unsigned int & count /* r17 */) {
    /* anonymous block */ {
        // Range: 0x47D320 -> 0x47D58C
        class xBase * b; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047D5A0 -> 0x0047D924
*/
// Range: 0x47D5A0 -> 0x47D924
// this: r17
void zRubbleGenerator::Spawn(class zRubbleMarker & from /* r30 */) {
    /* anonymous block */ {
        // Range: 0x47D5A0 -> 0x47D924
        unsigned int spawnStatus[32]; // r29+0xC0
        unsigned int spawnStatusCount; // r20
        unsigned int i; // r7
        unsigned int modelIndex; // r2
        class ModelData & data; // r16
        unsigned int spawnToIndex; // r19
        unsigned int i; // r2
        class zRubbleMarker & to; // r20
        signed int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047D930 -> 0x0047DA54
*/
// Range: 0x47D930 -> 0x47DA54
// this: r16
void zRubbleGenerator::HandleEvent(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47D930 -> 0x47DA54
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DA60 -> 0x0047DC28
*/
// Range: 0x47DA60 -> 0x47DC28
// this: r17
void zRubbleGenerator::Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x47DA60 -> 0x47DC28
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DC30 -> 0x0047DE3C
*/
// Range: 0x47DC30 -> 0x47DE3C
// this: r20
zRubbleGenerator::zRubbleGenerator(class zRubbleGeneratorAsset * asset /* r19 */) {
    /* anonymous block */ {
        // Range: 0x47DC30 -> 0x47DE3C
        unsigned int * modelIDs; // r2
        unsigned int i; // r18
        unsigned int i; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DE40 -> 0x0047DE60
*/
// Range: 0x47DE40 -> 0x47DE60
void InitDynamic(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */, unsigned int asset_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47DE40 -> 0x47DE60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DE60 -> 0x0047E3E0
*/
// Range: 0x47DE60 -> 0x47E3E0
// this: r16
static void zRubble::Update(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x47DE60 -> 0x47E3E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E3E0 -> 0x0047E894
*/
// Range: 0x47E3E0 -> 0x47E894
// this: r20
static void zRubble::Activate(class xVec3 & source /* r19 */, class xVec3 & target /* r18 */, float velocity /* r20 */, unsigned int rotations /* r17 */, class ModelData & data /* r16 */, unsigned int modelID /* r21 */, class zRubbleGenerator * par /* r2 */, enum zRubbleLandType landEffect /* r2 */, enum iSndGroupHandle theLandSoundGroup /* r29+0x90 */) {
    /* anonymous block */ {
        // Range: 0x47E3E0 -> 0x47E894
        class xLightKit * objLightKit; // r2
        float angle; // r29+0x8C
        float vxz; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E8A0 -> 0x0047EA1C
*/
// Range: 0x47E8A0 -> 0x47EA1C
// this: r17
static void zRubble::DestructibleInit(class xDestructibleAsset * d_asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47E8A0 -> 0x47EA1C
        class xDestructibleAssetState * d_states; // r21
        unsigned int i; // r20
        class xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047EA20 -> 0x0047EB4C
*/
// Range: 0x47EA20 -> 0x47EB4C
// this: r16
static void zRubble::Init(unsigned int index /* r2 */, unsigned int randomModelID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47EA20 -> 0x47EB4C
        class FakeSimpleObjectAsset fakeAsset; // @ 0x006BEE40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047EB50 -> 0x0047EBBC
*/
// Range: 0x47EB50 -> 0x47EBBC
static void StaticBoundsUpdate(class xEnt * ent /* r2 */, class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47EB50 -> 0x47EBBC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047EBC0 -> 0x0047EBD0
*/
// Range: 0x47EBC0 -> 0x47EBD0
static void RubbleEventWrapper(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47EBC0 -> 0x47EBD0
    }
}
