/*
    Compile unit: C:\TestBuild\in\GAME\zVioletPlayer.cpp
...
static signed int render_order[3]; // size: 0xC, address: 0x5EEBA8
static float INVIS_POWER_REQUIRED; // size: 0x4, address: 0x607BC4
static float INVIS_POWER_INITIAL; // size: 0x4, address: 0x607BC8
static float INVIS_POWER_ONGOING; // size: 0x4, address: 0x607BCC
static float INCREDIPOWER_RECOVERY; // size: 0x4, address: 0x607BD0
static float DEFAULT_INVISIBILITY_POWER; // size: 0x4, address: 0x607BD4
static signed int headBones[28]; // size: 0x70, address: 0x5EEBC0
static class xBox vis_box[3]; // size: 0x48, address: 0x5EEC30
// total size: 0x10C
struct /* @anon0 */ {} zVioletPlayer::__vtable; // size: 0x10C, address: 0x601520
...
// total size: 0xA30
class zVioletPlayer : public zCommonPlayer {
    // Members
public:
    enum /* @enum */ {
        eVisible = 0,
        eTurningInvisible = 1,
        eInvisible = 2,
    } invisState; // offset 0xA10, size 0x4
    float invisPower; // offset 0xA14, size 0x4
    float invisTimer; // offset 0xA18, size 0x4
    float alpha; // offset 0xA1C, size 0x4
    float destAlpha; // offset 0xA20, size 0x4
    float turnInvisTime; // offset 0xA24, size 0x4
    unsigned char isDead; // offset 0xA28, size 0x1
    class xModelInstance * invisimodel; // offset 0xA2C, size 0x4
};
// total size: 0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C1D20 -> 0x002C1E74
*/
// Range: 0x2C1D20 -> 0x2C1E74
// this: r2
void zVioletPlayer::RenderInvisibility() {
    /* anonymous block */ {
        // Range: 0x2C1D20 -> 0x2C1E74
        class xModelInstance * from; // r5
        class xModelInstance * to; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C1E80 -> 0x002C1FC8
*/
// Range: 0x2C1E80 -> 0x2C1FC8
// this: r16
void zVioletPlayer::SetupInvisibility() {
    /* anonymous block */ {
        // Range: 0x2C1E80 -> 0x2C1FC8
        class RpAtomic * atomic; // r2
        class xModelInstance * from; // r21
        class xModelInstance * to; // r20
        class RpAtomic * subatomic; // r2
        class _xFColor color; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C1FD0 -> 0x002C20B8
*/
// Range: 0x2C1FD0 -> 0x2C20B8
void ReactiveAnimationCollided() {
    /* anonymous block */ {
        // Range: 0x2C1FD0 -> 0x2C20B8
        class zScene & s; // r18
        signed int i; // r17
        class zDuplicator * dupeArray; // r2
        signed int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C20C0 -> 0x002C24B4
*/
// Range: 0x2C20C0 -> 0x2C24B4
// this: r2
void zVioletPlayer::AddTransitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2C20C0 -> 0x2C24B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C24C0 -> 0x002C25FC
*/
// Range: 0x2C24C0 -> 0x2C25FC
// this: r2
void zVioletPlayer::AddStates(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2C24C0 -> 0x2C25FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2600 -> 0x002C2694
*/
// Range: 0x2C2600 -> 0x2C2694
// this: r18
void zVioletPlayer::Move(class xScene * s /* r17 */, float dt /* r20 */, class xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2C2600 -> 0x2C2694
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C26A0 -> 0x002C26DC
*/
// Range: 0x2C26A0 -> 0x2C26DC
// this: r16
unsigned char zVioletPlayer::Damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C26A0 -> 0x2C26DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C26E0 -> 0x002C2868
*/
// Range: 0x2C26E0 -> 0x2C2868
// this: r16
void zVioletPlayer::Render() {
    /* anonymous block */ {
        // Range: 0x2C26E0 -> 0x2C2868
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2870 -> 0x002C2BD0
*/
// Range: 0x2C2870 -> 0x2C2BD0
// this: r16
void zVioletPlayer::Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2C2870 -> 0x2C2BD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2BD0 -> 0x002C2CAC
*/
// Range: 0x2C2BD0 -> 0x2C2CAC
// this: r16
void zVioletPlayer::BoundUpdate(class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C2BD0 -> 0x2C2CAC
        class xSphere * midSphere; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2CB0 -> 0x002C2CEC
*/
// Range: 0x2C2CB0 -> 0x2C2CEC
// this: r16
void zVioletPlayer::Reset() {
    /* anonymous block */ {
        // Range: 0x2C2CB0 -> 0x2C2CEC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2CF0 -> 0x002C2D00
*/
// Range: 0x2C2CF0 -> 0x2C2D00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2D00 -> 0x002C2D0C
*/
// Range: 0x2C2D00 -> 0x2C2D0C
class xHierarchyBoundInitData * GetHierarchyBoundInitData() {
    /* anonymous block */ {
        // Range: 0x2C2D00 -> 0x2C2D0C
        class xHierarchyBoundInitData bounds[6]; // @ 0x0050E070
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2D10 -> 0x002C2D40
*/
// Range: 0x2C2D10 -> 0x2C2D40
// this: r2
void zVioletPlayer::Exit() {
    /* anonymous block */ {
        // Range: 0x2C2D10 -> 0x2C2D40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2D40 -> 0x002C2DC4
*/
// Range: 0x2C2D40 -> 0x2C2DC4
// this: r16
void zVioletPlayer::ParseIni() {
    /* anonymous block */ {
        // Range: 0x2C2D40 -> 0x2C2DC4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2DD0 -> 0x002C2DFC
*/
// Range: 0x2C2DD0 -> 0x2C2DFC
// this: r16
void zVioletPlayer::SceneSetup() {
    /* anonymous block */ {
        // Range: 0x2C2DD0 -> 0x2C2DFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2E00 -> 0x002C2E30
*/
// Range: 0x2C2E00 -> 0x2C2E30
// this: r16
void zVioletPlayer::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C2E00 -> 0x2C2E30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2E30 -> 0x002C2E3C
*/
// Range: 0x2C2E30 -> 0x2C2E3C
