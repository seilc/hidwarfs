/*
    Compile unit: C:\TestBuild\in\GAME\zIncrediSlam.cpp
...
signed int isStartOnKey; // size: 0x4, address: 0x609184
unsigned int tweakSlamWaveTextureID; // size: 0x4, address: 0x609188
unsigned int tweakSlamParticleTextureID; // size: 0x4, address: 0x60918C
...
} old_rsB; // size: 0x28, address: 0x6A2550
class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4, address: 0x609190
...
public:
    ...
    class effect * rumble; // offset 0xC, size 0x4
};
// total size: 0x18
class xBox {
    // Members
...
public:
    union { // inferred
        struct { // inferred
            ...
            signed int gen; // offset 0x2C, size 0x4
...
public:
    ...
    class WaveLayer layer[9]; // offset 0xC, size 0x10E0
...
public:
    ...
    class config * cfg; // offset 0x8, size 0x4
    class xEnt * owner; // offset 0xC, size 0x4
    class Wave wave[3]; // offset 0x10, size 0x32DC
    class xMat4x3 startMat; // offset 0x32F0, size 0x40
    ...
    class WaveParticle * particles; // offset 0x3338, size 0x4
    unsigned char particleMem[11215]; // offset 0x333C, size 0x2BCF
    float waveTimer; // offset 0x5F0C, size 0x4
    signed int nextWave; // offset 0x5F10, size 0x4
    float texScroll; // offset 0x5F14, size 0x4
    signed int nextParticle; // offset 0x5F18, size 0x4
    class xColor_tag color; // offset 0x5F1C, size 0x4
    float friction; // offset 0x5F20, size 0x4
    float cullFade; // offset 0x5F24, size 0x4
    class RwTexture * decalDefault; // offset 0x5F28, size 0x4
    class RwTexture * decalConcrete; // offset 0x5F2C, size 0x4
    class RwTexture * decalDirt; // offset 0x5F30, size 0x4
    class xResponseCurve curve; // offset 0x5F34, size 0x10
    class emit_context ec; // offset 0x5F44, size 0x54
    enum iSndGroupHandle sound; // offset 0x5F98, size 0x4
    signed int hitPoints; // offset 0x5F9C, size 0x4
...
class WaveLayer {
    // Members
public:
    class Point point[20]; // offset 0x0, size 0x1E0
};
// total size: 0x30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DF90 -> 0x0032E074
*/
// Range: 0x32DF90 -> 0x32E074
unsigned char StartSlam(class xMat4x3 & startMat /* r19 */, float hitRadius /* r20 */, signed short hitPoints /* r18 */, class config * cfg /* r17 */, class xEnt * owner /* r16 */, unsigned char drawDecal /* r22 */) {
    /* anonymous block */ {
        // Range: 0x32DF90 -> 0x32E074
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E080 -> 0x0032E0E8
*/
// Range: 0x32E080 -> 0x32E0E8
void Render() {
    /* anonymous block */ {
        // Range: 0x32E080 -> 0x32E0E8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E0F0 -> 0x0032E2B8
*/
// Range: 0x32E0F0 -> 0x32E2B8
void Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x32E0F0 -> 0x32E2B8
        class _tagxPad * pad; // r2
        class _tagxPad * pad1; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E2C0 -> 0x0032E384
*/
// Range: 0x32E2C0 -> 0x32E384
// this: r16
class zIncrediSlam * zIncrediSlamMgr::GetMem(unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E2C0 -> 0x32E384
        class zIncrediSlam * mem; // r2
        class zIncrediSlam * prev; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E390 -> 0x0032E428
*/
// Range: 0x32E390 -> 0x32E428
void Reset() {
    /* anonymous block */ {
        // Range: 0x32E390 -> 0x32E428
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E430 -> 0x0032E450
*/
// Range: 0x32E430 -> 0x32E450
void Remove() {
    /* anonymous block */ {
        // Range: 0x32E430 -> 0x32E450
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E450 -> 0x0032E5C0
*/
// Range: 0x32E450 -> 0x32E5C0
void BeginRender() {
    /* anonymous block */ {
        // Range: 0x32E450 -> 0x32E5C0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E5C0 -> 0x0032EA00
*/
// Range: 0x32E5C0 -> 0x32EA00
// this: r16
void zIncrediSlam::RenderWave() {
    /* anonymous block */ {
        // Range: 0x32E5C0 -> 0x32EA00
        class RxObjSpace3DVertex vert[40]; // r29+0x110
        float alphaTable[9]; // r29+0xE0
        signed int w; // r21
        float t; // r20
        signed int strip; // r20
        float s; // r7
        signed int p; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EA00 -> 0x0032F454
*/
// Range: 0x32EA00 -> 0x32F454
// this: r21
void zIncrediSlam::UpdateWaves(float dt /* r31 */) {
    /* anonymous block */ {
        // Range: 0x32EA00 -> 0x32F454
        float lengthA; // r30
        float lengthB; // r29
        float dLength; // r28
        float angleA; // r29+0xFC
        float velY; // r27
        float velDY; // r29+0xF8
        signed int i; // r17
        signed int j; // r16
        float angleB; // r26
        float cosA; // r25
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F460 -> 0x0032FB84
*/
// Range: 0x32F460 -> 0x32FB84
// this: r18
void zIncrediSlam::Start(class xMat4x3 & _startMat /* r2 */, float _hitRadius /* r29+0x1B0 */, signed short _hitPoints /* r2 */, class config * new_cfg /* r2 */, class xEnt * _owner /* r2 */, unsigned char drawDecal /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32F460 -> 0x32FB84
        class xScene & scene; // r11
        class zCommonPlayer * player; // r2
        class xRay3 ray; // r29+0x120
        class xCollis coll; // r29+0xC0
        class xMat4x3 mat; // r29+0x80
        class xMat4x3 matB; // r29+0x40
        class zSurfaceProps * sp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032FB90 -> 0x0032FD88
*/
// Range: 0x32FB90 -> 0x32FD88
// this: r2
void zIncrediSlam::UpdateParticles(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x32FB90 -> 0x32FD88
        signed int p; // r12
        class WaveParticle & particle; // r6
        float fadeTime; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032FD90 -> 0x0032FF94
*/
// Range: 0x32FD90 -> 0x32FF94
// this: r17
void zIncrediSlam::GenerateParticle(class xVec3 & pos /* r2 */, class xVec3 & vel /* r2 */, float size /* r29+0x40 */, float deltaSize /* r21 */, float life /* r20 */, float fadeTime /* r29+0x40 */, float alpha /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x32FD90 -> 0x32FF94
        class WaveParticle & particle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032FFA0 -> 0x00330338
*/
// Range: 0x32FFA0 -> 0x330338
// this: r29+0xBC
void zIncrediSlam::UpdatePTankPool() {
    /* anonymous block */ {
        // Range: 0x32FFA0 -> 0x330338
        class ptank_pool__pos_color_size_rot pool; // r29+0xC0
        signed int p; // r20
        class WaveParticle & particle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330340 -> 0x00330348
*/
// Range: 0x330340 -> 0x330348
void AddTweaks() {
    /* anonymous block */ {
        // Range: 0x330340 -> 0x330348
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330350 -> 0x00330444
*/
// Range: 0x330350 -> 0x330444
// this: r16
void zIncrediSlam::Init() {
    /* anonymous block */ {
        // Range: 0x330350 -> 0x330444
        class curve_node footstep_curve[3]; // @ 0x005F26D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330450 -> 0x00330608
*/
// Range: 0x330450 -> 0x330608
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330610 -> 0x0033094C
*/
// Range: 0x330610 -> 0x33094C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330950 -> 0x003309CC
*/
// Range: 0x330950 -> 0x3309CC
void * operator new(unsigned int size /* r17 */) {
    /* anonymous block */ {
        // Range: 0x330950 -> 0x3309CC
    }
}
