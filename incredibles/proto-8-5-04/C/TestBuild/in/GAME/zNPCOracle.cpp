/*
    Compile unit: C:\TestBuild\in\GAME\zNPCOracle.cpp
...
// total size: 0x98
struct /* @anon3 */ {} zNPC::oracle_charge::__vtable; // size: 0x98, address: 0x6007C0
// total size: 0x98
struct /* @anon2 */ {} zNPC::static_jump::__vtable; // size: 0x98, address: 0x604130
// total size: 0x98
struct /* @anon8 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x7C
struct /* @anon4 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon1 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon13 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon12 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x7C
struct /* @anon11 */ {} zNPC::shrapnel_death::__vtable; // size: 0x7C, address: 0x600F30
// total size: 0x98
struct /* @anon5 */ {} zNPC::charge_attack::__vtable; // size: 0x98, address: 0x0
// total size: 0x7C
struct /* @anon0 */ {} zNPC::oracle_idle::__vtable; // size: 0x7C, address: 0x6009A0
// total size: 0x80
struct /* @anon10 */ {} zNPC::engine_exhaust::__vtable; // size: 0x80, address: 0x603D00
// total size: 0x7C
struct /* @anon6 */ {} zNPC::oracle_hover_effect::__vtable; // size: 0x7C, address: 0x600860
// total size: 0x7C
struct /* @anon9 */ {} zNPC::hover_effect::__vtable; // size: 0x7C, address: 0x602FD0
// total size: 0xB4
struct /* @anon7 */ {} zNPC::oracle::__vtable; // size: 0xB4, address: 0x6008E0
unsigned int anopened(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x2850B0
unsigned int anfacing_player(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x285120
// total size: 0x74
class oracle_charge : public charge_attack {
    // Members
public:
    class engine_exhaust * engine; // offset 0x64, size 0x4
    float detonateRadius; // offset 0x68, size 0x4
    float chargeTime; // offset 0x6C, size 0x4
...
// total size: 0x28
class oracle_hover_effect : public hover_effect {};
// total size: 0x70
class RpWorld {
    // Members
public:
...
// total size: 0x43C
class oracle : public common {
    // Members
public:
    class oracle_hover_effect oracle_hover_effect_state; // offset 0x2C0, size 0x28
    class engine_exhaust engine_exhaust_state; // offset 0x2E8, size 0x44
    class oracle_idle oracle_idle_state; // offset 0x32C, size 0x10
    class oracle_charge oracle_charge_state; // offset 0x33C, size 0x74
    class explode oracle_explode_state; // offset 0x3B0, size 0x54
    class static_jump jump_state; // offset 0x404, size 0x38
};
// total size: 0x4C
class xAnimState {
    // Members
...
// total size: 0x10
class oracle_idle : public behavior_implementation {};
// total size: 0x8
class xModelPipe {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284B20 -> 0x00284C80
*/
// Range: 0x284B20 -> 0x284C80
// this: r16
oracle::oracle() {
    /* anonymous block */ {
        // Range: 0x284B20 -> 0x284C80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284C80 -> 0x00284CF8
*/
// Range: 0x284C80 -> 0x284CF8
// this: r17
void oracle_charge::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x284C80 -> 0x284CF8
        unsigned char prev_state; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284D00 -> 0x00284E08
*/
// Range: 0x284D00 -> 0x284E08
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284E10 -> 0x00284EB8
*/
// Range: 0x284E10 -> 0x284EB8
// this: r17
void oracle_charge::enter_state(class behavior_implementation * prev_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x284E10 -> 0x284EB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284EC0 -> 0x00284EFC
*/
// Range: 0x284EC0 -> 0x284EFC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284F10 -> 0x00284FF0
*/
// Range: 0x284F10 -> 0x284FF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00284FF0 -> 0x002850A8
*/
// Range: 0x284FF0 -> 0x2850A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00285160 -> 0x00285168
*/
// Range: 0x285160 -> 0x285168
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00285170 -> 0x00285198
*/
// Range: 0x285170 -> 0x285198
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002851A0 -> 0x002851F4
*/
// Range: 0x2851A0 -> 0x2851F4
