/*
    Compile unit: C:\TestBuild\in\GAME\zBehavior.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float scale; // size: 0x4, address: 0x0
// total size: 0x78
struct /* @anon0 */ {} behavior::__vtable; // size: 0x78, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
// total size: 0x4C
struct /* @anon1 */ {} behavior_manager::__vtable; // size: 0x4C, address: 0x604200
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00338EA0 -> 0x00338F4C
*/
// Range: 0x338EA0 -> 0x338F4C
// this: r2
void behavior::set_state(char * new_state /* r16 */, float blend /* r21 */, float dest_time /* r20 */, class xModelInstance * model /* r17 */) {
    /* anonymous block */ {
        // Range: 0x338EA0 -> 0x338F4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00338F50 -> 0x00338FEC
*/
// Range: 0x338F50 -> 0x338FEC
// this: r2
void behavior::set_state(char * new_state /* r16 */, float blend /* r20 */, class xModelInstance * model /* r17 */) {
    /* anonymous block */ {
        // Range: 0x338F50 -> 0x338FEC
        class xAnimTransition * transition; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00338FF0 -> 0x0033910C
*/
// Range: 0x338FF0 -> 0x33910C
// this: r2
unsigned char behavior::in_state(char * state /* r2 */, float look_ahead /* r20 */, class xModelInstance * model /* r17 */) {
    /* anonymous block */ {
        // Range: 0x338FF0 -> 0x33910C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339110 -> 0x00339190
*/
// Range: 0x339110 -> 0x339190
// this: r2
void behavior_manager::kill() {
    /* anonymous block */ {
        // Range: 0x339110 -> 0x339190
        class behavior_node * i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339190 -> 0x00339268
*/
// Range: 0x339190 -> 0x339268
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339270 -> 0x00339310
*/
// Range: 0x339270 -> 0x339310
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339310 -> 0x00339388
*/
// Range: 0x339310 -> 0x339388
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339390 -> 0x00339408
*/
// Range: 0x339390 -> 0x339408
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339410 -> 0x00339488
*/
// Range: 0x339410 -> 0x339488
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339490 -> 0x003395D4
*/
// Range: 0x339490 -> 0x3395D4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003395E0 -> 0x00339680
*/
// Range: 0x3395E0 -> 0x339680
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339680 -> 0x003396F8
*/
// Range: 0x339680 -> 0x3396F8
// this: r2
void behavior_manager::remove_behavior(class behavior * which /* r2 */) {
    /* anonymous block */ {
        // Range: 0x339680 -> 0x3396F8
        class behavior_node * last_node; // r7
        class behavior_node * i; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339700 -> 0x00339760
*/
// Range: 0x339700 -> 0x339760
// this: r17
void behavior_manager::reset_behavior(class behavior * new_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x339700 -> 0x339760
        class behavior * prev_behavior; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339760 -> 0x003397A4
*/
// Range: 0x339760 -> 0x3397A4
// this: r2
class behavior * behavior_manager::get_behavior(unsigned int type /* r2 */) {
    /* anonymous block */ {
        // Range: 0x339760 -> 0x3397A4
        class behavior_node * i; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003397B0 -> 0x0033981C
*/
// Range: 0x3397B0 -> 0x33981C
// this: r17
void behavior_manager::set_behavior(class behavior * new_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3397B0 -> 0x33981C
        class behavior * prev_behavior; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339820 -> 0x003399B8
*/
// Range: 0x339820 -> 0x3399B8
// this: r18
void behavior_manager::add_behavior(class behavior * new_behavior /* r17 */, signed char priority /* r16 */) {
    /* anonymous block */ {
        // Range: 0x339820 -> 0x3399B8
        class behavior_node * node; // r3
        class behavior_node * last_node; // r6
        class behavior_node * i; // r5
        class behavior_node * i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003399C0 -> 0x00339B58
*/
// Range: 0x3399C0 -> 0x339B58
// this: r17
void behavior_manager::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3399C0 -> 0x339B58
        class behavior_node * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339B60 -> 0x00339D28
*/
// Range: 0x339B60 -> 0x339D28
// this: r18
void behavior_manager::select_current(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x339B60 -> 0x339D28
        class behavior * new_behavior; // r17
        class behavior_node * i; // r16
        unsigned char runnable; // r2
        float state_delay; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339D30 -> 0x00339DF8
*/
// Range: 0x339D30 -> 0x339DF8
// this: r17
void behavior_manager::damage(class zCombatDamageInfo & damageInfo /* r16 */) {
    /* anonymous block */ {
        // Range: 0x339D30 -> 0x339DF8
        class behavior_node * i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339E00 -> 0x00339E98
*/
// Range: 0x339E00 -> 0x339E98
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339EA0 -> 0x00339F24
*/
// Range: 0x339EA0 -> 0x339F24
// this: r2
void behavior_manager::add_transitions(class xAnimTable * table /* r17 */) {
    /* anonymous block */ {
        // Range: 0x339EA0 -> 0x339F24
        class behavior_node * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339F30 -> 0x00339FB4
*/
// Range: 0x339F30 -> 0x339FB4
// this: r2
void behavior_manager::add_states(class xAnimTable * table /* r17 */) {
    /* anonymous block */ {
        // Range: 0x339F30 -> 0x339FB4
        class behavior_node * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00339FC0 -> 0x0033A044
*/
// Range: 0x339FC0 -> 0x33A044
// this: r2
void behavior_manager::register_collision(class SphereCollisionResults & scene_collide /* r17 */) {
    /* anonymous block */ {
        // Range: 0x339FC0 -> 0x33A044
        class behavior_node * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A050 -> 0x0033A10C
*/
// Range: 0x33A050 -> 0x33A10C
// this: r2
unsigned char behavior_manager::collision_response(class xVec3 & current_dir /* r20 */, class SphereCollisionResults & scene_collide /* r19 */, class xVec3 & response_dpos /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33A050 -> 0x33A10C
        unsigned char collide_on; // r17
        class behavior_node * i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A110 -> 0x0033A1E0
*/
// Range: 0x33A110 -> 0x33A1E0
// this: r2
void behavior_manager::before_anim_matrices(class xAnimPlay * play /* r19 */, class xQuat * quat /* r18 */, class xVec3 * tran /* r17 */, signed int boneCount /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33A110 -> 0x33A1E0
        class behavior_node * i; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A1E0 -> 0x0033A308
*/
// Range: 0x33A1E0 -> 0x33A308
// this: r21
unsigned char behavior_manager::system_event(class xBase * from /* r20 */, class xBase * to /* r19 */, unsigned int to_event /* r18 */, float * to_param /* r17 */, class xBase * to_param_widget /* r22 */, unsigned int to_param_widget_id /* r23 */) {
    /* anonymous block */ {
        // Range: 0x33A1E0 -> 0x33A308
        class behavior_node * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A310 -> 0x0033A318
*/
// Range: 0x33A310 -> 0x33A318
