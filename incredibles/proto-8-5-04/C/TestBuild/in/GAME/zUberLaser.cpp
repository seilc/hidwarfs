/*
    Compile unit: C:\TestBuild\in\GAME\zUberLaser.cpp
...
class config default_config; // size: 0x17C, address: 0x5FBA00
signed int ring_explosion; // size: 0x4, address: 0x609608
enum iSndGroupHandle shoot_charge; // size: 0x4, address: 0x60960C
enum iSndGroupHandle shoot; // size: 0x4, address: 0x609610
enum iSndGroupHandle shoot_end; // size: 0x4, address: 0x609614
enum iSndGroupHandle explode; // size: 0x4, address: 0x609618
class RwRaster * beam_raster; // size: 0x4, address: 0x60961C
class RxObjSpace3DVertex * vert; // size: 0x4, address: 0x609620
static signed int laser_count; // size: 0x4, address: 0x60962C
static unsigned int oldsrcblend; // size: 0x4, address: 0x609630
static unsigned int olddestblend; // size: 0x4, address: 0x609634
static unsigned int oldcullmode; // size: 0x4, address: 0x609638
// total size: 0x20
struct /* @anon1 */ {} z::uber_laser::__vtable; // size: 0x20, address: 0x6067A0
...
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<z::uber_laser, 5>::__vtable; // size: 0x20, address: 0x6067C0
class tagiRenderInput gRenderBuffer; // size: 0x80, address: 0x6C5360
// total size: 0x24
struct /* @anon2 */ {} z::lightweight_system<z::uber_laser, 5>::__vtable; // size: 0x24, address: 0x600AD0
// total size: 0x24
struct /* @anon3 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void handle_event(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x471640
// total size: 0x24
class xAnimFile {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E940 -> 0x0046E9FC
*/
// Range: 0x46E940 -> 0x46E9FC
void post_render_end() {
    /* anonymous block */ {
        // Range: 0x46E940 -> 0x46E9FC
        class RwError error; // r29+0x28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046EA00 -> 0x0046F044
*/
// Range: 0x46EA00 -> 0x46F044
// this: r2
void uber_laser::post_render_2d() {
    /* anonymous block */ {
        // Range: 0x46EA00 -> 0x46F044
        class xVec3 end_loc; // r29+0x120
        class xMat4x3 & cam_mat; // r2
        class xVec3 & dir; // r12
        class xVec3 right; // r29+0x110
        class xVec3 half_right; // r29+0x100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F050 -> 0x0046F11C
*/
// Range: 0x46F050 -> 0x46F11C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F120 -> 0x0046F6AC
*/
// Range: 0x46F120 -> 0x46F6AC
// this: r17
void uber_laser::render() {
    /* anonymous block */ {
        ...
        class xVec3 s; // r29+0x140
        class xMat3x3 scale_mat; // r29+0x60
        class xMat4x3 & mat; // r16
        float orb_scale; // r29+0x150
        class xVec3 size; // r29+0x130
        class xMat3x3 scale; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F6B0 -> 0x0046F7A4
*/
// Range: 0x46F6B0 -> 0x46F7A4
// this: r17
class uber_laser & uber_laser::operator=(class uber_laser & ulaser /* r16 */) {
    /* anonymous block */ {
        // Range: 0x46F6B0 -> 0x46F7A4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F7B0 -> 0x004709C0
*/
// Range: 0x46F7B0 -> 0x4709C0
// this: r20
void uber_laser::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x46F7B0 -> 0x4709C0
        class xMat3x3 mat; // r29+0x1F0
        float falpha; // r29+0x3E0
        class xRay3 ray; // r29+0x1C0
        class xCollis collision_record; // r29+0x160
        class xSphere * player_spheres[5]; // r29+0x140
        signed int num_spheres; // r2
        signed int i; // r19
        class xBound bound; // r29+0xF0
        class zCombatDamageInfo info; // r29+0xB0
        class xVec3 knockback; // r29+0x3D0
        signed char @10299; // @ 0x00609628
        signed int trail_type; // @ 0x00609624
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004709C0 -> 0x00470D08
*/
// Range: 0x4709C0 -> 0x470D08
// this: r21
void uber_laser::update_ring(float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x4709C0 -> 0x470D08
        class xVec3 ring_start; // r29+0x120
        float angle_delta; // r24
        float intensity; // r23
        float angle; // r22
        signed int i; // r20
        class xVec3 direction; // r29+0x110
        class xVec3 trail_position; // r29+0x100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470D10 -> 0x00471288
*/
// Range: 0x470D10 -> 0x471288
// this: r17
uber_laser::uber_laser(class xEnt * owner /* r2 */, class xVec3 & start /* r2 */, class xVec3 & end /* r2 */, class config * cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x470D10 -> 0x471288
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471290 -> 0x004713B8
*/
// Range: 0x471290 -> 0x4713B8
// this: r2
void uber_laser::orient(class xVec3 & start_pos /* r2 */, class xVec3 & end_pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x471290 -> 0x4713B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004713C0 -> 0x004714C0
*/
// Range: 0x4713C0 -> 0x4714C0
// this: r16
uber_laser::uber_laser() {
    /* anonymous block */ {
        // Range: 0x4713C0 -> 0x4714C0
        unsigned int ball_model_id; // r2
        unsigned int size; // r29+0x2C
        class RpAtomic * imodel; // r2
        unsigned int beam_model_id; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004714C0 -> 0x00471570
*/
// Range: 0x4714C0 -> 0x471570
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471570 -> 0x00471640
*/
// Range: 0x471570 -> 0x471640
void setup() {
    /* anonymous block */ {
        // Range: 0x471570 -> 0x471640
        unsigned int LASER_TEXTURE_ID; // r2
        class RwTexture * beam_texture; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471640 -> 0x004718C8
*/
// Range: 0x471640 -> 0x4718C8
void handle_event(class xBase * to /* r18 */, unsigned int event /* r2 */, class xBase * widget_param /* r2 */) {
    /* anonymous block */ {
        // Range: 0x471640 -> 0x4718C8
        class zUberLaser * ulaser; // r2
        class uber_laser new_ulaser; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004718D0 -> 0x00471944
*/
// Range: 0x4718D0 -> 0x471944
void load(class xBase & data /* r2 */, class xDynAsset & asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x4718D0 -> 0x471944
        class zUberLaser & ulaser; // r16
        class zUberLaserAsset & uasset; // r2
        unsigned int size; // r29+0x3C
    }
}
