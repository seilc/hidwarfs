/*
    Compile unit: C:\TestBuild\in\GAME\zNPC.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x38
struct /* @anon0 */ {} zNPC::base::__vtable; // size: 0x38, address: 0x5FD7D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002102C0 -> 0x002102F4
*/
// Range: 0x2102C0 -> 0x2102F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210300 -> 0x002103A0
*/
// Range: 0x210300 -> 0x2103A0
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002103A0 -> 0x0021049C
*/
// Range: 0x2103A0 -> 0x21049C
// this: r19
unsigned char base::get_parameter(char * name /* r18 */, class xVec3 * value /* r17 */, class xVec3 & default_value /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2103A0 -> 0x21049C
        char * text; // r2
        signed int size; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002104A0 -> 0x0021055C
*/
// Range: 0x2104A0 -> 0x21055C
// this: r18
unsigned char base::get_parameter(char * name /* r17 */, float * value /* r16 */, float default_value /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2104A0 -> 0x21055C
        char * text; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210560 -> 0x00210640
*/
// Range: 0x210560 -> 0x210640
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210640 -> 0x002106FC
*/
// Range: 0x210640 -> 0x2106FC
// this: r19
unsigned char base::get_parameter(char * name /* r18 */, signed short * value /* r17 */, signed short default_value /* r16 */) {
    /* anonymous block */ {
        // Range: 0x210640 -> 0x2106FC
        char * text; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210700 -> 0x002107BC
*/
// Range: 0x210700 -> 0x2107BC
// this: r19
unsigned char base::get_parameter(char * name /* r18 */, signed int * value /* r17 */, signed int default_value /* r16 */) {
    /* anonymous block */ {
        // Range: 0x210700 -> 0x2107BC
        char * text; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002107C0 -> 0x0021087C
*/
// Range: 0x2107C0 -> 0x21087C
// this: r19
unsigned char base::get_parameter(char * name /* r18 */, unsigned char * value /* r17 */, unsigned char default_value /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2107C0 -> 0x21087C
        char * text; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210880 -> 0x00210964
*/
// Range: 0x210880 -> 0x210964
// this: r2
class xVec3 base::get_bone_world_position_offset(signed int bone /* r2 */, class xVec3 & bone_local_offset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x210880 -> 0x210964
        class xVec3 position; // r29
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210970 -> 0x00210A30
*/
// Range: 0x210970 -> 0x210A30
// this: r2
class xVec3 base::get_bone_world_position(signed int bone /* r2 */) {
    /* anonymous block */ {
        // Range: 0x210970 -> 0x210A30
        class xVec3 position; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210A30 -> 0x00210AAC
*/
// Range: 0x210A30 -> 0x210AAC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210AB0 -> 0x00210EBC
*/
// Range: 0x210AB0 -> 0x210EBC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00210EC0 -> 0x00211220
*/
// Range: 0x210EC0 -> 0x211220
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00211220 -> 0x002116B0
*/
// Range: 0x211220 -> 0x2116B0
// this: r17
void base::initialize_bounds(float modelScale /* r20 */) {
    /* anonymous block */ {
        // Range: 0x211220 -> 0x2116B0
        unsigned char use_bounding_box; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002116B0 -> 0x00211754
*/
// Range: 0x2116B0 -> 0x211754
// this: r17
