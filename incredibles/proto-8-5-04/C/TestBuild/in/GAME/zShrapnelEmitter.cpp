/*
    Compile unit: C:\TestBuild\in\GAME\zShrapnelEmitter.cpp
...
static class module_type * module; // size: 0x4, address: 0x609724
void cb_destroy_projectile(class zFrag *); // size: 0x0, address: 0x49A160
void cb_init_projectile(class zFrag *, class zFragAsset *); // size: 0x0, address: 0x49A1A0
void zShrapnel_DefaultInit(class zShrapnelAsset *, class xModelInstance *, class xVec3 *, void (*)(class zFrag *, class zFragAsset *)); // size: 0x0, address: 0x1E57B0
...
public:
    ...
    class activity_data * sphere_emitters; // offset 0x4, size 0x4
    signed int sphere_emitters_max; // offset 0x8, size 0x4
    signed int sphere_emitters_used; // offset 0xC, size 0x4
    class shared_frag_asset * frag_asset_buffer; // offset 0x10, size 0x4
    class shared_frag_asset * frag_asset_head; // offset 0x14, size 0x4
    signed int frag_asset_max; // offset 0x18, size 0x4
};
// total size: 0x110
...
// total size: 0x124
class shared_frag_asset {
    // Members
public:
    union { // inferred
        signed int refcount; // offset 0x0, size 0x4
        class shared_frag_asset * next; // offset 0x0, size 0x4
    };
    class zShrapnelEmitterSphere * owner; // offset 0x4, size 0x4
    class zShrapnelAsset shrap; // offset 0x8, size 0xC
    class zFragProjectileAsset proj; // offset 0x14, size 0x110
};
// total size: 0x20
class xLinkAsset {
    // Members
...
public:
    ...
    class config_type * cfg; // offset 0x48, size 0x4
    class shared_frag_asset * asset; // offset 0x4C, size 0x4
    class xModelInstance parent_model; // offset 0x50, size 0xA4
    unsigned int model_ids[12]; // offset 0xF4, size 0x30
    class RpAtomic * models[12]; // offset 0x124, size 0x30
    signed int models_size; // offset 0x154, size 0x4
    class xVec3 * dir; // offset 0x158, size 0x4
    float zmin; // offset 0x15C, size 0x4
    float zmax; // offset 0x160, size 0x4
    float radius_range; // offset 0x164, size 0x4
    float vel_range; // offset 0x168, size 0x4
    float intensity_range; // offset 0x16C, size 0x4
    float rot_vel_range; // offset 0x170, size 0x4
    float scale_range; // offset 0x174, size 0x4
};
// total size: 0x1C
class RxCluster {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049A160 -> 0x0049A1A0
*/
// Range: 0x49A160 -> 0x49A1A0
void cb_destroy_projectile(class zFrag * frag /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49A160 -> 0x49A1A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049A1A0 -> 0x0049A1B0
*/
// Range: 0x49A1A0 -> 0x49A1B0
void cb_init_projectile(class zFrag * frag /* r2 */, class zFragAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49A1A0 -> 0x49A1B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049A1B0 -> 0x0049A594
*/
// Range: 0x49A1B0 -> 0x49A594
// this: r20
void zShrapnelEmitterSphere::init_projectile(class zFrag * frag /* r19 */) {
    /* anonymous block */ {
        // Range: 0x49A1B0 -> 0x49A594
        class zFragProjectile & proj; // r18
        class xVec3 dir; // r29+0x60
        float radius; // r29+0x70
        float velmag; // r29+0x70
        float intensity; // r29+0x70
        float scale; // r29+0x70
        class xMat4x3 & proj_mat; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049A5A0 -> 0x0049A77C
*/
// Range: 0x49A5A0 -> 0x49A77C
// this: r16
void zShrapnelEmitterSphere::spawn(class xMat4x3 & mat /* r17 */, signed int amount /* r21 */) {
    /* anonymous block */ {
        // Range: 0x49A5A0 -> 0x49A77C
        signed int spawn_range; // r2
        class xVec3 * dir_buffer; // r20
        class zShrapnelAsset & shrap; // r19
        class zFragProjectileAsset & proj; // r2
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049A780 -> 0x0049AA28
*/
// Range: 0x49A780 -> 0x49AA28
// this: r20
void zShrapnelEmitterSphere::set_config(class config_type & cfg /* r19 */) {
    /* anonymous block */ {
        // Range: 0x49A780 -> 0x49AA28
        class zFragProjectileAsset & proj; // r2
        signed int i; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AA30 -> 0x0049AB88
*/
// Range: 0x49AA30 -> 0x49AB88
// this: r17
void zShrapnelEmitterSphere::activate(class config_type & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49AA30 -> 0x49AB88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AB90 -> 0x0049AB98
*/
// Range: 0x49AB90 -> 0x49AB98
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049ABA0 -> 0x0049ABA8
*/
// Range: 0x49ABA0 -> 0x49ABA8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049ABB0 -> 0x0049ABBC
*/
// Range: 0x49ABB0 -> 0x49ABBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049ABC0 -> 0x0049AC10
*/
// Range: 0x49ABC0 -> 0x49AC10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AC10 -> 0x0049AC7C
*/
// Range: 0x49AC10 -> 0x49AC7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AC80 -> 0x0049AC8C
*/
// Range: 0x49AC80 -> 0x49AC8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AC90 -> 0x0049AE40
*/
// Range: 0x49AC90 -> 0x49AE40
void zShrapnelEmitterSceneEnter() {
    /* anonymous block */ {
        // Range: 0x49AC90 -> 0x49AE40
        class module_type * module'88; // r2
        signed int sphere_emitters_max; // r18
        signed int frag_asset_max; // r17
    }
}
