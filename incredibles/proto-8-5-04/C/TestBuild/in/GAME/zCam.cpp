/*
    Compile unit: C:\TestBuild\in\GAME\zCam.cpp
...
static unsigned int input_disabled; // size: 0x4, address: 0x608ECC
static enum zcam_mode_enum current_mode; // size: 0x4, address: 0x607B64
static class xCam * mode_cams[1]; // size: 0x4, address: 0x608ED0
static unsigned char have_default_orientation; // size: 0x1, address: 0x608ED4
static class xVec3 default_orientation; // size: 0xC, address: 0x685928
static class zCamPlayer * follow_cam; // size: 0x4, address: 0x608ED8
static class xCamGroup global_cam; // size: 0x120, address: 0x685940
static class xCamScreen global_screen; // size: 0x8, address: 0x608EE0
class zGlobals globals; // size: 0x640, address: 0x61C210
// total size: 0x24
struct /* @anon1 */ {} zCamPlayer::__vtable; // size: 0x24, address: 0x601440
// total size: 0x24
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A13A0 -> 0x002A13A8
*/
// Range: 0x2A13A0 -> 0x2A13A8
class zCamPlayer * zCamGetDefault() {
    /* anonymous block */ {
        // Range: 0x2A13A0 -> 0x2A13A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A13B0 -> 0x002A13BC
*/
// Range: 0x2A13B0 -> 0x2A13BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A13C0 -> 0x002A142C
*/
// Range: 0x2A13C0 -> 0x2A142C
void zCamSetStartOrientation(unsigned int pointer_id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A13C0 -> 0x2A142C
        unsigned int size; // r29+0x1C
        void * a; // r2
        class pointer_asset & pa; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1430 -> 0x002A1448
*/
// Range: 0x2A1430 -> 0x2A1448
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1450 -> 0x002A1468
*/
// Range: 0x2A1450 -> 0x2A1468
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1470 -> 0x002A147C
*/
// Range: 0x2A1470 -> 0x2A147C
void zCamEndRender() {
    /* anonymous block */ {
        // Range: 0x2A1470 -> 0x2A147C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1480 -> 0x002A1490
*/
// Range: 0x2A1480 -> 0x2A1490
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1490 -> 0x002A149C
*/
// Range: 0x2A1490 -> 0x2A149C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A14A0 -> 0x002A16F0
*/
// Range: 0x2A14A0 -> 0x2A16F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A16F0 -> 0x002A18C4
*/
// Range: 0x2A16F0 -> 0x2A18C4
void zCamUpdate(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x2A16F0 -> 0x2A18C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A18D0 -> 0x002A19E4
*/
// Range: 0x2A18D0 -> 0x2A19E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A19F0 -> 0x002A1A24
*/
// Range: 0x2A19F0 -> 0x2A1A24
void zCamSceneExit() {
    /* anonymous block */ {
        // Range: 0x2A19F0 -> 0x2A1A24
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1A30 -> 0x002A1C1C
*/
// Range: 0x2A1A30 -> 0x2A1C1C
