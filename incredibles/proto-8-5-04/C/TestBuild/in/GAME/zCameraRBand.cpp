/*
    Compile unit: C:\TestBuild\in\GAME\zCameraRBand.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
class zSlideCam * rbCam; // size: 0x4, address: 0x609668
unsigned char zRBAND_CAMERA_ACTIVE; // size: 0x1, address: 0x60966C
...
void zCameraRBandAsset_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x47C880
// total size: 0x10
class xBase {
    // Members
public:
...
// total size: 0x20
class zCameraRBandAsset : public xDynAsset {
    // Members
public:
...
// total size: 0x14
class zCameraRBandObject : public xBase {
    // Members
public:
    class zCameraRBandAsset * asset; // offset 0x10, size 0x4
};
// total size: 0x1C
class iFogParams {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C880 -> 0x0047C940
*/
// Range: 0x47C880 -> 0x47C940
void zCameraRBandAsset_EventCB(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47C880 -> 0x47C940
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C940 -> 0x0047C9E4
*/
// Range: 0x47C940 -> 0x47C9E4
void zCameraRBandAsset_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47C940 -> 0x47C9E4
    }
}
