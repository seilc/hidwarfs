/*
    Compile unit: C:\TestBuild\in\GAME\zDestructible.cpp
...
static float DEG_TO_RAD; // size: 0x4, address: 0x607B70
static float LAUNCH_ANGLE; // size: 0x4, address: 0x607B74
static float LAUNCH_VEL; // size: 0x4, address: 0x607B78
static float DAMAGE_RADIUS; // size: 0x4, address: 0x607B7C
static float MAX_TIME_NO_COLLISIONS; // size: 0x4, address: 0x607B80
static float HIT_TO_DESTROY_TIME; // size: 0x4, address: 0x607B84
static float Y_VELOCITY; // size: 0x4, address: 0x607B88
static float RESPAWN_THRESHOLD; // size: 0x4, address: 0x607B8C
static float DOBJ_STD_BOUND_VAR; // size: 0x4, address: 0x607B90
...
void DOBJ_alwaysUseSphere(class xEnt *, class xVec3 *); // size: 0x0, address: 0x2AE8C0
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AC870 -> 0x002AC8A4
*/
// Range: 0x2AC870 -> 0x2AC8A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AC8B0 -> 0x002ACA7C
*/
// Range: 0x2AC8B0 -> 0x2ACA7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ACA80 -> 0x002AD41C
*/
// Range: 0x2ACA80 -> 0x2AD41C
void zDestructibleAsset_EventCB(class xBase * from /* r18 */, class xBase * root_base /* r2 */, class zDestructible * to /* r17 */, unsigned int toEvent /* r2 */, float * toParam /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2ACA80 -> 0x2AD41C
        class xEnt * ent; // r2
        ...
        class zDestructibleState * cstate; // r2
        signed int up; // r2
        signed int idx; // r2
        signed int idx; // r2
        class xVec3 dir; // r29+0xE0
        class xSurface * surf; // r2
        unsigned int hit_source_flag; // r2
        unsigned int damage; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AD420 -> 0x002ADB2C
*/
// Range: 0x2AD420 -> 0x2ADB2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ADB30 -> 0x002ADD18
*/
// Range: 0x2ADB30 -> 0x2ADD18
void zDestructibleAsset_Init(unsigned int assetID /* r16 */, class zDestructible * & dest /* r20 */, class xEnt * ent /* r22 */) {
    /* anonymous block */ {
        ...
        unsigned int i; // r21
        class xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ADD20 -> 0x002ADE20
*/
// Range: 0x2ADD20 -> 0x2ADE20
void zDestructibleAsset_ReReset(class zDestructible * & dest /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2ADD20 -> 0x2ADE20
        class xDestructibleAssetState * d_states; // r19
        unsigned int i; // r18
        class xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r17
        void * tmp_ptr; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ADE20 -> 0x002AE370
*/
// Range: 0x2ADE20 -> 0x2AE370
void zDestructibleAsset_Reset(class zDestructible * & dest /* r21 */, class xEnt * ent /* r23 */) {
    /* anonymous block */ {
        ...
        unsigned int i; // r30
        class RpAtomic * imodel; // r2
        class xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AE370 -> 0x002AE8B4
*/
// Range: 0x2AE370 -> 0x2AE8B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AE8C0 -> 0x002AE980
*/
// Range: 0x2AE8C0 -> 0x2AE980
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AE980 -> 0x002AF050
*/
// Range: 0x2AE980 -> 0x2AF050
