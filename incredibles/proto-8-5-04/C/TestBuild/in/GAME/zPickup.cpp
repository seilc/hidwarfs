/*
    Compile unit: C:\TestBuild\in\GAME\zPickup.cpp
...
static class xMat3x3 sPickupOrientation; // size: 0x30, address: 0x5DB270
float PICKUP_FADE_DIST_SQR; // size: 0x4, address: 0x609544
float PICKUP_CULL_DIST_SQR; // size: 0x4, address: 0x609548
class Table * table; // size: 0x4, address: 0x60954C
class zPickup * extras; // size: 0x4, address: 0x609550
class InstanceAsset * extra_assets; // size: 0x4, address: 0x609554
signed int extras_used; // size: 0x4, address: 0x609558
signed int extras_max; // size: 0x4, address: 0x60955C
...
void zPickupEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x446800
// total size: 0x8
...
// total size: 0x20
class InstanceAsset : public xDynAsset {
    // Members
public:
...
class zPickup : public xBase {
    // Members
public:
    class TableEntry * tableEntry; // offset 0x10, size 0x4
    class InstanceAsset * asset; // offset 0x14, size 0x4
    float glow_time; // offset 0x18, size 0x4
    enum eState state; // offset 0x1C, size 0x4
    class xModelInstance * model; // offset 0x20, size 0x4
    class xModelInstance * effect_model; // offset 0x24, size 0x4
    void * fx; // offset 0x28, size 0x4
    class xVec3 grabPos; // offset 0x2C, size 0xC
    float timer; // offset 0x38, size 0x4
    class xShadowSimpleCache * simpShadow; // offset 0x3C, size 0x4
};
// total size: 0x18
class RwBBox {
    // Members
...
// total size: 0x10
class Table : public xTableAsset {
    // Members
public:
    class TableEntry entries[]; // offset 0x10, size 0x0
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004450A0 -> 0x00445198
*/
// Range: 0x4450A0 -> 0x445198
unsigned char SpawnExtra(unsigned int type /* r19 */, class xVec3 & loc /* r18 */) {
    /* anonymous block */ {
        // Range: 0x4450A0 -> 0x445198
        class zPickup & pickup; // r17
        class InstanceAsset & asset; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004451A0 -> 0x00445420
*/
// Range: 0x4451A0 -> 0x445420
void UpdateAll(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4451A0 -> 0x445420
        class zPickup * it; // r17
        class zPickup * end; // r18
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00445420 -> 0x00445938
*/
// Range: 0x445420 -> 0x445938
void UpdateFlyToInterfaceAll(float dt /* r24 */) {
    /* anonymous block */ {
        // Range: 0x445420 -> 0x445938
        class zPickup * it; // r20
        class zPickup * end; // r19
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00445940 -> 0x00446138
*/
// Range: 0x445940 -> 0x446138
// this: r16
void zPickup::Render() {
    /* anonymous block */ {
        // Range: 0x445940 -> 0x446138
        float distanceFadeAlpha; // r20
        float u; // r29+0x180
        class xVec3 delta; // r29+0x170
        class xVec3 scale; // r29+0x160
        class xMat3x3 scale_mat; // r29+0xB0
        float u; // r29+0x180
        class xVec3 delta; // r29+0x150
        class xVec3 scale; // r29+0x140
        class xMat3x3 scale_mat; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004461F0 -> 0x0044654C
*/
// Range: 0x4461F0 -> 0x44654C
// this: r16
void zPickup::Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4461F0 -> 0x44654C
        float grabDist; // r29+0xB0
        class xVec3 playerPos; // r29+0xA0
        class xVec3 toPlayer; // r29+0x90
        float timeToPlayer; // r29+0xB0
        float speed; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446550 -> 0x004467F8
*/
// Range: 0x446550 -> 0x4467F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446800 -> 0x00446A34
*/
// Range: 0x446800 -> 0x446A34
void zPickupEventCB(class xBase * to /* r18 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x446800 -> 0x446A34
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446A40 -> 0x00446C60
*/
// Range: 0x446A40 -> 0x446C60
// this: r17
void zPickup::Init(class InstanceAsset & asset_ /* r2 */) {
    /* anonymous block */ {
        // Range: 0x446A40 -> 0x446C60
        unsigned int tmpSize; // r29+0x3C
        class RpAtomic * modelData; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446C60 -> 0x00446C68
*/
// Range: 0x446C60 -> 0x446C68
void InitDynamic(class xBase & obj /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x446C60 -> 0x446C68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446C70 -> 0x00446CD0
*/
// Range: 0x446C70 -> 0x446CD0
void ResetAll() {
    /* anonymous block */ {
        // Range: 0x446C70 -> 0x446CD0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00446CD0 -> 0x00446DE8
*/
// Range: 0x446CD0 -> 0x446DE8
void SceneSetup() {
    /* anonymous block */ {
        // Range: 0x446CD0 -> 0x446DE8
        signed int extras_max'68; // r3
