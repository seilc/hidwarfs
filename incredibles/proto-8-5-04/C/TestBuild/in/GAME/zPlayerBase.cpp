/*
    Compile unit: C:\TestBuild\in\GAME\zPlayerBase.cpp
...
static signed int sMemDepthJustHIPStartPlayer; // size: 0x4, address: 0x607A60
static class basic_rect screen_bounds; // size: 0x10, address: 0x0
static class basic_rect default_adjust; // size: 0x10, address: 0x0
static signed int eEA_Head; // size: 0x4, address: 0x0
static signed int eEA_Torso; // size: 0x4, address: 0x0
static signed int eEA_LeftArm; // size: 0x4, address: 0x0
static signed int eEA_LeftHand; // size: 0x4, address: 0x0
static signed int eEA_RightArm; // size: 0x4, address: 0x0
static signed int eEA_RightHand; // size: 0x4, address: 0x0
static signed int eEA_Hair; // size: 0x4, address: 0x0
static signed int eEA_Count; // size: 0x4, address: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026BEB0 -> 0x0026C03C
*/
// Range: 0x26BEB0 -> 0x26C03C
void zPlayer_LoadCheckPoint() {
    /* anonymous block */ {
        ...
        class zCheckPoint & checkpoint; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C040 -> 0x0026C0EC
*/
// Range: 0x26C040 -> 0x26C0EC
void zPlayer_StoreCheckPoint(class xVec3 & pos /* r2 */, float rot /* r29+0x10 */, unsigned int initialCameraID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x26C040 -> 0x26C0EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C0F0 -> 0x0026C15C
*/
// Range: 0x26C0F0 -> 0x26C15C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C160 -> 0x0026C258
*/
// Range: 0x26C160 -> 0x26C258
void zPlayerLoadHIP(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x26C160 -> 0x26C258
        unsigned int tagPlayer; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C260 -> 0x0026C270
*/
// Range: 0x26C260 -> 0x26C270
void zPlayerMove(class xEnt * ent /* r2 */, class xScene * s /* r2 */, float dt /* r29 */, class xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x26C260 -> 0x26C270
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C270 -> 0x0026C280
*/
// Range: 0x26C270 -> 0x26C280
void zPlayerReset(class zEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x26C270 -> 0x26C280
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C280 -> 0x0026C290
*/
// Range: 0x26C280 -> 0x26C290
void zPlayerRender(class zEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x26C280 -> 0x26C290
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C290 -> 0x0026C30C
*/
// Range: 0x26C290 -> 0x26C30C
void zPlayerUpdate(class xEnt * ent /* r2 */, class xScene * sc /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x26C290 -> 0x26C30C
        class zPlayer * player; // r16
    }
}
