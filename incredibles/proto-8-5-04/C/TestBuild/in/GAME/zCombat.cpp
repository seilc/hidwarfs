/*
    Compile unit: C:\TestBuild\in\GAME\zCombat.cpp
...
static class zCombatDamageInfo * damage_info_stack[2]; // size: 0x8, address: 0x608D28
static signed int damage_info_stack_count; // size: 0x4, address: 0x608D30
...
class CheckForCollisionWrapper {
    // Members
public:
    class xEnt * attacker; // offset 0x0, size 0x4
    class xSweptSphere * sphere; // offset 0x4, size 0x4
    class zCombat * combat; // offset 0x8, size 0x4
    class xVec3 * move_dir; // offset 0xC, size 0x4
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4C60 -> 0x001F4E08
*/
// Range: 0x1F4C60 -> 0x1F4E08
// this: r17
void zCombat::UpdateEffect(class xEnt * attacker /* r16 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1F4C60 -> 0x1F4E08
        float startDiff; // r29+0x50
        float radius; // r29+0x50
        class xFXRing sBodySlamRing[3]; // @ 0x00508F90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4E10 -> 0x001F4E18
*/
// Range: 0x1F4E10 -> 0x1F4E18
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4E20 -> 0x001F4ED0
*/
// Range: 0x1F4E20 -> 0x1F4ED0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4ED0 -> 0x001F5190
*/
// Range: 0x1F4ED0 -> 0x1F5190
// this: r18
void zCombat::SweepSphere(class xEnt * attacker /* r17 */, class xVec3 * pos1 /* r2 */, class xVec3 * pos2 /* r2 */, float radius /* r29+0x1B0 */) {
    /* anonymous block */ {
        // Range: 0x1F4ED0 -> 0x1F5190
        class xVec3 moveDirection; // r29+0x1A0
        float moveMagnitude2; // r29+0x1B0
        class xVec3 * moveDirectionPtr; // r16
        class xSweptSphere swept; // r29+0xB0
        class xBound tempBound; // r29+0x60
        class CheckForCollisionWrapper callback; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F5190 -> 0x001F5368
*/
// Range: 0x1F5190 -> 0x1F5368
// this: r20
void zCombat::CheckForCollisionEnv(class xEnt * attacker /* r19 */, class xEnv * env /* r18 */, class xSweptSphere * sphere /* r17 */, class xVec3 * hitDirection /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1F5190 -> 0x1F5368
        class xVec3 hdng; // r29+0x80
        unsigned char oldHitEnv; // r2
        class xSurface * pXSurface; // r16
        class zSurfaceProps * prop; // r2
        enum iSndGroupHandle pSmackSound; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F5380 -> 0x001F58C0
*/
// Range: 0x1F5380 -> 0x1F58C0
// this: r20
void zCombat::CheckForCollision(class xEnt * attacker /* r21 */, class xEnt * target /* r19 */, class xSweptSphere * sphere /* r18 */, class xVec3 * hitDirection /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1F5380 -> 0x1F58C0
        unsigned char isPlayer; // r2
        unsigned char hitIt; // r17
        enum zHitTarget hitTarget; // r16
        signed char subsphere; // r29+0xCF
        unsigned short hitTargetU16; // r29+0xCC
        class xVec3 direction; // r29+0xC0
        class xVec3 hitLoc; // r29+0xB0
        class xVec3 hitNorm; // r29+0xA0
        unsigned char hitEffect; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F58C0 -> 0x001F5DAC
*/
// Range: 0x1F58C0 -> 0x1F5DAC
// this: r20
void zCombat::SendObjectHit(class xEnt * attacker /* r19 */, class xEnt * target /* r18 */, class xSurface * surface /* r17 */, enum zHitTarget hitTarget /* r2 */, class xVec3 * direction /* r2 */, class xVec3 * hit_loc /* r16 */, class xVec3 * hit_norm /* r21 */, class xVec3 * move_dir /* r29+0x100 */, unsigned char hitEffect /* r29+0x108 */) {
    /* anonymous block */ {
        // Range: 0x1F58C0 -> 0x1F5DAC
        signed int i; // r6
        class xVec3 dir; // r29+0xF0
        class zCombatDamageInfo params; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F5DD0 -> 0x001F6004
*/
// Range: 0x1F5DD0 -> 0x1F6004
void zCombatDamage(class xEnt * ent /* r17 */, class zCombatDamageInfo & damageInfo /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1F5DD0 -> 0x1F6004
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6010 -> 0x001F603C
*/
// Range: 0x1F6010 -> 0x1F603C
class zCombatDamageInfo * zCombatGetActiveDamageInfo() {
    /* anonymous block */ {
        // Range: 0x1F6010 -> 0x1F603C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6040 -> 0x001F6D98
*/
// Range: 0x1F6040 -> 0x1F6D98
// this: r20
void zCombat::PostUpdate(class xEnt * ent /* r19 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1F6040 -> 0x1F6D98
        signed int i; // r9
        class xHierarchyNode & node; // r2
        class effect * rumble; // r16
        unsigned char needToContinue; // r22
        unsigned char resetSphere; // r5
        class xAnimState * curState; // r2
        class zAttackTableState * temp; // r2
        float newTime; // r29+0xD0
        float moveTime; // r29+0xD0
        float velocityZ; // r3
        float velocityY; // r2
        float timeLeft; // r29+0xD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6DA0 -> 0x001F6E30
*/
// Range: 0x1F6DA0 -> 0x1F6E30
// this: r2
class zAttackTableState * zCombat::FindAttackState(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1F6DA0 -> 0x1F6E30
        class zAttackTableState * result; // r2
        signed int low; // r9
        signed int high; // r8
        signed int mid; // r7
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6E30 -> 0x001F6F20
*/
// Range: 0x1F6E30 -> 0x1F6F20
// this: r17
void zCombat::PreUpdate(class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1F6E30 -> 0x1F6F20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6F20 -> 0x001F6FA4
*/
// Range: 0x1F6F20 -> 0x1F6FA4
// this: r19
void zCombat::Init(class xHierarchyBoundInitData * initHierarchy /* r2 */, float masterRadius /* r29+0x50 */, class zAttackTableState * stateTable /* r18 */, unsigned short stateTableSize /* r17 */, signed int hitPoints /* r16 */, float scale /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x1F6F20 -> 0x1F6FA4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F6FB0 -> 0x001F6FE4
*/
// Range: 0x1F6FB0 -> 0x1F6FE4
void zCombatInit() {
    /* anonymous block */ {
        // Range: 0x1F6FB0 -> 0x1F6FE4
    }
