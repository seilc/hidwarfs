/*
    Compile unit: C:\TestBuild\in\GAME\zNPCStreamer.cpp
...
static float COS_MIN_ANGLE; // size: 0x4, address: 0x5FBD48
enum iSndGroupHandle hChargeAttackGroup; // size: 0x4, address: 0x6084E4
// total size: 0xA0
struct /* @anon0 */ {} zNPC::run_stream::__vtable; // size: 0xA0, address: 0x606910
unsigned int anattack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x477F90
unsigned int ancan_attack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x478260
unsigned int anmove_attack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x478000
unsigned int ancan_move_attack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x478070
unsigned int anattack_finished(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4781B0
unsigned int anattack_timer_done(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x478220
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477630 -> 0x0047771C
*/
// Range: 0x477630 -> 0x47771C
// this: r16
void run_stream::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x477630 -> 0x47771C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477720 -> 0x00477758
*/
// Range: 0x477720 -> 0x477758
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477760 -> 0x0047798C
*/
// Range: 0x477760 -> 0x47798C
// this: r16
unsigned char run_stream::runnable() {
    /* anonymous block */ {
        // Range: 0x477760 -> 0x47798C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477990 -> 0x00477D68
*/
// Range: 0x477990 -> 0x477D68
// this: r17
void run_stream::enter_state() {
    /* anonymous block */ {
        // Range: 0x477990 -> 0x477D68
        class xVec3 cross; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477D70 -> 0x00477E30
*/
// Range: 0x477D70 -> 0x477E30
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477E30 -> 0x00477F8C
*/
// Range: 0x477E30 -> 0x477F8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478340 -> 0x00478420
*/
// Range: 0x478340 -> 0x478420
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478420 -> 0x0047842C
*/
// Range: 0x478420 -> 0x47842C
