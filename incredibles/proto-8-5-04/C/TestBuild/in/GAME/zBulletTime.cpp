/*
    Compile unit: C:\TestBuild\in\GAME\zBulletTime.cpp
...
static float zBULLET_TIME_CAMERA_TIMER; // size: 0x4, address: 0x607C3C
static float zBULLET_TIME_DEFAULT_ANGLE; // size: 0x4, address: 0x6090A8
static float zBULLET_TIME_ACTIVE_ANGLE; // size: 0x4, address: 0x6090AC
static float zBULLET_TIME_CAMERA_ORIGIN_OFFSET; // size: 0x4, address: 0x607C40
static float CONST_DEG_TO_RAD; // size: 0x4, address: 0x607C44
static enum zCameraType zCAMERA_TYPE; // size: 0x4, address: 0x6090B0
static float zSNAPSHOT_TIMER; // size: 0x4, address: 0x607C48
static unsigned char bt_was_active; // size: 0x1, address: 0x607C4C
static unsigned char force_mode; // size: 0x1, address: 0x0
unsigned char zBULLET_TIME_CAMERA; // size: 0x1, address: 0x607C50
unsigned char zBULLET_TIME; // size: 0x1, address: 0x607C54
unsigned char zSTATIC_CAMERA_ACTIVE; // size: 0x1, address: 0x0
class zBulletTimeObject btObj; // size: 0x14, address: 0x699EE0
class zBulletTimeCamera * btCam; // size: 0x4, address: 0x6090B4
class zSnapshots snapshotObj; // size: 0xF4, address: 0x699F00
static float filter_angle[3]; // size: 0xC, address: 0x699FF8
static unsigned int filters_count; // size: 0x4, address: 0x6090B8
static unsigned int temp_count; // size: 0x4, address: 0x6090BC
// total size: 0x24
struct /* @anon4 */ {} zBulletTimeCamera::__vtable; // size: 0x24, address: 0x603130
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
// total size: 0xC
struct /* @anon1 */ {} zLinearFilter::__vtable; // size: 0xC, address: 0x603158
// total size: 0xC
struct /* @anon5 */ {} zFilterAbstract<xVec3>::__vtable; // size: 0xC, address: 0x0
// total size: 0xC
struct /* @anon3 */ {} zQuaternionFilter::__vtable; // size: 0xC, address: 0x603168
// total size: 0xC
struct /* @anon0 */ {} zFilterAbstract<zQuat>::__vtable; // size: 0xC, address: 0x0
// total size: 0x24
struct /* @anon2 */ {} xCam::__vtable; // size: 0x24, address: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7D10 -> 0x002F7FDC
*/
// Range: 0x2F7D10 -> 0x2F7FDC
// this: r16
void zBulletTimeCamera::activate(enum zFilterType value /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F7D10 -> 0x2F7FDC
        class xMat4x3 * c_mat; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7FE0 -> 0x002F8304
*/
// Range: 0x2F7FE0 -> 0x2F8304
// this: r16
void zBulletTimeCamera::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2F7FE0 -> 0x2F8304
        class xVec3 * p_pos; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8310 -> 0x002F8318
*/
// Range: 0x2F8310 -> 0x2F8318
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8320 -> 0x002F8368
*/
// Range: 0x2F8320 -> 0x2F8368
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8370 -> 0x002F852C
*/
// Range: 0x2F8370 -> 0x2F852C
// this: r2
void zBulletTimeObject::update(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x2F8370 -> 0x2F852C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8530 -> 0x002F855C
*/
// Range: 0x2F8530 -> 0x2F855C
void zBulletTimeAsset_Init(class xBase & data /* r2 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2F8530 -> 0x2F855C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8560 -> 0x002F8568
*/
// Range: 0x2F8560 -> 0x2F8568
void interpolate() {
    /* anonymous block */ {
        // Range: 0x2F8560 -> 0x2F8568
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8570 -> 0x002F8590
*/
// Range: 0x2F8570 -> 0x2F8590
// this: r2
void zQuaternionFilter::interpolate(class zQuat * q /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F8570 -> 0x2F8590
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8590 -> 0x002F867C
*/
// Range: 0x2F8590 -> 0x2F867C
float zBulletTime_Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2F8590 -> 0x2F867C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8680 -> 0x002F86D8
*/
// Range: 0x2F8680 -> 0x2F86D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F86E0 -> 0x002F86EC
*/
// Range: 0x2F86E0 -> 0x2F86EC
unsigned char zBulletTime_IsActive() {
    /* anonymous block */ {
        // Range: 0x2F86E0 -> 0x2F86EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F86F0 -> 0x002F86FC
*/
// Range: 0x2F86F0 -> 0x2F86FC
float zBulletTime_GetScale() {
    /* anonymous block */ {
        // Range: 0x2F86F0 -> 0x2F86FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8700 -> 0x002F880C
*/
// Range: 0x2F8700 -> 0x2F880C
void zBulletTime_Activate(unsigned char use_camera /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2F8700 -> 0x2F880C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8810 -> 0x002F881C
*/
// Range: 0x2F8810 -> 0x2F881C
void zBulletTime_SetTimer(float value /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2F8810 -> 0x2F881C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8820 -> 0x002F8830
*/
// Range: 0x2F8820 -> 0x2F8830
float zBulletTime_GetOriginalTimer() {
    /* anonymous block */ {
        // Range: 0x2F8820 -> 0x2F8830
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8830 -> 0x002F88EC
*/
// Range: 0x2F8830 -> 0x2F88EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F88F0 -> 0x002F89BC
*/
// Range: 0x2F88F0 -> 0x2F89BC
static void zFilterAnglesSet(float start_angle /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2F88F0 -> 0x2F89BC
    }
}
