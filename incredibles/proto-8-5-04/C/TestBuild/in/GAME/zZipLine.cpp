/*
    Compile unit: C:\TestBuild\in\GAME\zZipLine.cpp
...
// total size: 0x24
struct /* @anon0 */ {} zZipLineCam::__vtable; // size: 0x24, address: 0x5FD740
void zZipLineEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x207840
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206EE0 -> 0x002073A8
*/
// Range: 0x206EE0 -> 0x2073A8
// this: r16
void zZipLineCam::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x206EE0 -> 0x2073A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002073B0 -> 0x0020777C
*/
// Range: 0x2073B0 -> 0x20777C
// this: r16
void zZipLineCam::start() {
    /* anonymous block */ {
        // Range: 0x2073B0 -> 0x20777C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00207780 -> 0x00207840
*/
// Range: 0x207780 -> 0x207840
// this: r16
void zZipLineCam::create() {
    /* anonymous block */ {
        // Range: 0x207780 -> 0x207840
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00207840 -> 0x00207888
*/
// Range: 0x207840 -> 0x207888
void zZipLineEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x207840 -> 0x207888
        class zZipLine * zipline; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00207890 -> 0x002078F0
*/
// Range: 0x207890 -> 0x2078F0
void zZipLineSetup(class zZipLine * zipline /* r16 */) {
    /* anonymous block */ {
        // Range: 0x207890 -> 0x2078F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002078F0 -> 0x00207944
*/
// Range: 0x2078F0 -> 0x207944
void zZipLineInit(void * plat /* r17 */, void * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2078F0 -> 0x207944
    }
}
