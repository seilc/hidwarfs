/*
    Compile unit: C:\TestBuild\in\GAME\zEGenerator.cpp
...
void zEGenerator_Render(class zEGenerator *); // size: 0x0, address: 0x12B040
void zEGeneratorEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x12A6A0
void zEGenerator_Move(class zEGenerator *, class xScene *, float); // size: 0x0, address: 0x12B270
void zEGenerator_Update(class zEGenerator *, class xScene *, float); // size: 0x0, address: 0x12B050
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A6A0 -> 0x0012AAF0
*/
// Range: 0x12A6A0 -> 0x12AAF0
void zEGeneratorEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, class xBase * toParamWidget /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12A6A0 -> 0x12AAF0
        class zEGenerator * egen; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012AAF0 -> 0x0012B034
*/
// Range: 0x12AAF0 -> 0x12B034
void zEGenerator_TurnOn(class zEGenerator * egen /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12AAF0 -> 0x12B034
        ...
        unsigned short imp; // r19
        signed int i; // r18
        class xLinkAsset * link; // r17
        unsigned int dstAssetID; // r2
        class xBase * b; // r16
        class xVec3 destOffset; // r29+0x110
        class xEnt * ent; // r2
        signed int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B040 -> 0x0012B048
*/
// Range: 0x12B040 -> 0x12B048
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B050 -> 0x0012B268
*/
// Range: 0x12B050 -> 0x12B268
void zEGenerator_Update(class zEGenerator * egen /* r16 */, class xScene * sc /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12B050 -> 0x12B268
        class xBase * b; // r2
        class zEnt * ent; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B270 -> 0x0012B278
*/
// Range: 0x12B270 -> 0x12B278
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B280 -> 0x0012B380
*/
// Range: 0x12B280 -> 0x12B380
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B380 -> 0x0012B388
*/
// Range: 0x12B380 -> 0x12B388
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B390 -> 0x0012B398
*/
// Range: 0x12B390 -> 0x12B398
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B3A0 -> 0x0012B47C
*/
// Range: 0x12B3A0 -> 0x12B47C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B480 -> 0x0012B5E4
*/
// Range: 0x12B480 -> 0x12B5E4
void zEGenerator_Init(class zEGenerator * egen /* r17 */, class xEntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12B480 -> 0x12B5E4
        class zEGenAsset * zasset; // r2
        void * buf; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B5F0 -> 0x0012B5F8
*/
// Range: 0x12B5F0 -> 0x12B5F8
