/*
    Compile unit: C:\TestBuild\in\GAME\zAssetTypes.cpp
...
static class PKRAssetType assetTypeHandlers[102]; // size: 0xFF0, address: 0x503BF0
class BrainTableEntry g_brainTable[47]; // size: 0x234, address: 0x504BE0
static class xJSPHeader sDummyEmptyJSP; // size: 0x2C, address: 0x613190
static class xJSPHeader * sTempJSP; // size: 0x4, address: 0x608594
class AnimTableList animTable[2]; // size: 0x18, address: 0x504E20
static class xAnimTable * (* tableFuncList[1])(); // size: 0x4, address: 0x608598
static unsigned int (* effectFuncList[3])(unsigned int, class xAnimActiveEffect *, class xAnimSingle *, void *); // size: 0xC, address: 0x504E38
...
// total size: 0x10C
struct /* @anon6 */ {} zVioletPlayer::__vtable; // size: 0x10C, address: 0x601520
// total size: 0x18
struct /* @anon4 */ {} jump::__vtable; // size: 0x18, address: 0x5FFE70
// total size: 0x10C
struct /* @anon7 */ {} zCommonPlayer::__vtable; // size: 0x10C, address: 0x5FF1C0
// total size: 0x24
struct /* @anon5 */ {} zCamSwing::__vtable; // size: 0x24, address: 0x6014A0
// total size: 0x24
struct /* @anon1 */ {} xCam::__vtable; // size: 0x24, address: 0x0
// total size: 0x24
struct /* @anon3 */ {} zCamFP::__vtable; // size: 0x24, address: 0x601470
// total size: 0x10C
struct /* @anon0 */ {} zElastiGirlPlayer::__vtable; // size: 0x10C, address: 0x5FFF70
// total size: 0x10C
struct /* @anon2 */ {} zMrIncrediblePlayer::__vtable; // size: 0x10C, address: 0x5FFD60
void * FindAssetCB(unsigned int, char *); // size: 0x0, address: 0x126E60
unsigned int gxAnimUseGrowAlloc; // size: 0x4, address: 0x608BAC
class RwTexture * TexCB(class RwTexture *, void *); // size: 0x0, address: 0x127120
class zGlobals globals; // size: 0x640, address: 0x61C210
unsigned int ErrorCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x33A310
// total size: 0xC
class xVec3 {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126270 -> 0x00126278
*/
// Range: 0x126270 -> 0x126278
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126280 -> 0x00126288
*/
// Range: 0x126280 -> 0x126288
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126290 -> 0x00126298
*/
// Range: 0x126290 -> 0x126298
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001262A0 -> 0x00126E58
*/
// Range: 0x1262A0 -> 0x126E58
static void * ATBL_Read(void * indata /* r20 */, unsigned int * outsize /* r30 */) {
    /* anonymous block */ {
        ...
        unsigned char initialized; // @ 0x00608590
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126E60 -> 0x00126E7C
*/
// Range: 0x126E60 -> 0x126E7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126E80 -> 0x00126F88
*/
// Range: 0x126E80 -> 0x126F88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126F90 -> 0x00126F98
*/
// Range: 0x126F90 -> 0x126F98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126FA0 -> 0x00126FC4
*/
// Range: 0x126FA0 -> 0x126FC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126FD0 -> 0x00127120
*/
// Range: 0x126FD0 -> 0x127120
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127120 -> 0x00127144
*/
// Range: 0x127120 -> 0x127144
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127150 -> 0x00127178
*/
// Range: 0x127150 -> 0x127178
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127180 -> 0x001271F4
*/
// Range: 0x127180 -> 0x1271F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127200 -> 0x00127210
*/
// Range: 0x127200 -> 0x127210
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127210 -> 0x0012730C
*/
// Range: 0x127210 -> 0x12730C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127310 -> 0x00127330
*/
// Range: 0x127310 -> 0x127330
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127330 -> 0x00127450
*/
// Range: 0x127330 -> 0x127450
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127450 -> 0x00127540
*/
// Range: 0x127450 -> 0x127540
static void * Dash_Track_Read(void * indata /* r2 */, unsigned int insize /* r2 */, unsigned int * outsize /* r17 */) {
    /* anonymous block */ {
        // Range: 0x127450 -> 0x127540
        class track_asset * asset; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127540 -> 0x0012775C
*/
// Range: 0x127540 -> 0x12775C
static void * Navigation_Mesh_Read(void * indata /* r2 */, unsigned int * outsize /* r17 */) {
    /* anonymous block */ {
        // Range: 0x127540 -> 0x12775C
        class navigation_mesh * mesh_asset; // r16
        signed int m; // r6
        class sub_mesh * sub_mesh; // r2
        signed int portal_lookup_size; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127760 -> 0x00127794
*/
// Range: 0x127760 -> 0x127794
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001277A0 -> 0x001277B4
*/
// Range: 0x1277A0 -> 0x1277B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001277C0 -> 0x0012781C
*/
// Range: 0x1277C0 -> 0x12781C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127820 -> 0x00127828
*/
// Range: 0x127820 -> 0x127828
void zAssetShutdown() {
    /* anonymous block */ {
        // Range: 0x127820 -> 0x127828
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127830 -> 0x00127888
*/
// Range: 0x127830 -> 0x127888
void zAssetStartup() {
    /* anonymous block */ {
        // Range: 0x127830 -> 0x127888
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127890 -> 0x00127950
*/
// Range: 0x127890 -> 0x127950
enum en_npctyp GetBrainID(unsigned int brainNameHash /* r16 */) {
    /* anonymous block */ {
        // Range: 0x127890 -> 0x127950
        signed int i; // r18
        signed int i; // r4
