/*
    Compile unit: C:\TestBuild\in\GAME\zCameraFly.cpp
...
unsigned int zcam_flyasset_current; // size: 0x4, address: 0x0
class zGlobals globals; // size: 0x640, address: 0x61C210
void zCameraFlyEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1F8BD0
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8BD0 -> 0x001F8C30
*/
// Range: 0x1F8BD0 -> 0x1F8C30
void zCameraFlyEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1F8BD0 -> 0x1F8C30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8C30 -> 0x001F8C38
*/
// Range: 0x1F8C30 -> 0x1F8C38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8C40 -> 0x001F8C48
*/
// Range: 0x1F8C40 -> 0x1F8C48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8C50 -> 0x001F8C58
*/
// Range: 0x1F8C50 -> 0x1F8C58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8C60 -> 0x001F8C70
*/
// Range: 0x1F8C60 -> 0x1F8C70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F8C70 -> 0x001F8CCC
*/
// Range: 0x1F8C70 -> 0x1F8CCC
