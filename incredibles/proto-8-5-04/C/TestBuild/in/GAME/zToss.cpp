/*
    Compile unit: C:\TestBuild\in\GAME\zToss.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
class lightweight_system * system; // size: 0x4, address: 0x6085DC
// total size: 0x20
struct /* @anon1 */ {} z::toss::__vtable; // size: 0x20, address: 0x607430
// total size: 0x20
struct /* @anon3 */ {} z::lightweight<z::toss, 10>::__vtable; // size: 0x20, address: 0x5FD040
// total size: 0x24
struct /* @anon2 */ {} z::lightweight_system<z::toss, 10>::__vtable; // size: 0x24, address: 0x5FD060
// total size: 0x24
struct /* @anon0 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
...
// total size: 0x70
class toss : public lightweight {
    // Members
public:
    class xEnt * ent; // offset 0xC, size 0x4
    class pointer_asset * dest_pointer; // offset 0x10, size 0x4
    float arc_height; // offset 0x14, size 0x4
    float speed; // offset 0x18, size 0x4
    class xBase * toss_event_sender; // offset 0x1C, size 0x4
    float peakDist; // offset 0x20, size 0x4
    float totalDist; // offset 0x24, size 0x4
    float parabola_scale; // offset 0x28, size 0x4
    class xVec3 toDest; // offset 0x2C, size 0xC
    class xQuat startQuat; // offset 0x40, size 0x10
    class xQuat destQuat; // offset 0x50, size 0x10
    float dist; // offset 0x60, size 0x4
};
// total size: 0xB0
class RwFrame {
    // Members
...
class lightweight_system : public lightweight_system_base {
    // Members
public:
    class toss object[10]; // offset 0x10, size 0x460
    class lightweight_system * * system; // offset 0x470, size 0x4
    unsigned int current_id; // offset 0x474, size 0x4
};
// total size: 0x30
class RxPacket {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499170 -> 0x004992F4
*/
// Range: 0x499170 -> 0x4992F4
// this: r16
void toss::update(float dt /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x499170 -> 0x4992F4
        float pct; // r29+0x80
        class xVec3 newLoc; // r29+0x70
        float ox; // r29+0x80
        class xQuat curOrient; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499300 -> 0x00499538
*/
// Range: 0x499300 -> 0x499538
// this: r18
toss::toss(class xEnt * ent /* r17 */, class pointer_asset * dest_pointer /* r16 */, float arc_height /* r20 */, float speed /* r29+0xB0 */, class xBase * toss_event_sender /* r2 */) {
    /* anonymous block */ {
        // Range: 0x499300 -> 0x499538
        class xVec2 toDest2d; // r29+0xA0
        float m0; // r29+0xAC
        float m1; // r29+0xA8
        class xMat3x3 finalMat; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499540 -> 0x00499658
*/
// Range: 0x499540 -> 0x499658
class toss * find(class xEnt * ent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x499540 -> 0x499658
        unsigned int i; // r18
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499660 -> 0x00499668
*/
// Range: 0x499660 -> 0x499668
void setup() {
    /* anonymous block */ {
        // Range: 0x499660 -> 0x499668
    }
