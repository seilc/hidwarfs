/*
    Compile unit: C:\TestBuild\in\GAME\zNPCWeapon.cpp
...
signed int system_id; // size: 0x4, address: 0x6091BC
signed int glow_system_id; // size: 0x4, address: 0x6091C0
class RwTexture * glow_texture; // size: 0x4, address: 0x6091C4
class RwTexture * texture; // size: 0x4, address: 0x6091C8
class config default_config; // size: 0x48, address: 0x6A6A80
class xAnimTable * animTable; // size: 0x4, address: 0x0
class xAnimFile * animExpanding; // size: 0x4, address: 0x6091CC
class xAnimFile * animContracting; // size: 0x4, address: 0x6091D0
// total size: 0x80
struct /* @anon2 */ {} zNPC::Weapon::__vtable; // size: 0x80, address: 0x604340
...
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x343C20
// total size: 0x0
class xFFX {};
// total size: 0x14
class xCylinder {
...
class Particle {
    // Members
public:
    class xVec3 * start; // offset 0x0, size 0x4
    class xVec3 * end; // offset 0x4, size 0x4
    ...
    float width_delta; // offset 0x18, size 0x4
    float height_delta; // offset 0x1C, size 0x4
    float u; // offset 0x20, size 0x4
    float v; // offset 0x24, size 0x4
    float offset; // offset 0x28, size 0x4
    class config * cfg; // offset 0x2C, size 0x4
    class xVec3 * right; // offset 0x30, size 0x4
    float shift; // offset 0x34, size 0x4
    unsigned char r; // offset 0x38, size 0x1
    unsigned char g; // offset 0x39, size 0x1
    unsigned char b; // offset 0x3A, size 0x1
    unsigned char pad1; // offset 0x3B, size 0x1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003431A0 -> 0x003431A8
*/
// Range: 0x3431A0 -> 0x3431A8
// this: r2
unsigned char Weapon::runnable() {
    /* anonymous block */ {
        // Range: 0x3431A0 -> 0x3431A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003431B0 -> 0x003431B8
*/
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003431C0 -> 0x00343308
*/
// Range: 0x3431C0 -> 0x343308
// this: r18
void Weapon::render() {
    /* anonymous block */ {
        // Range: 0x3431C0 -> 0x343308
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343310 -> 0x003436E4
*/
// Range: 0x343310 -> 0x3436E4
// this: r20
void Weapon::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x343310 -> 0x3436E4
        signed int i; // r19
        float percent; // r29+0x130
        class xModelInstance * it; // r6
        signed int counter; // @ 0x006091D4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003436F0 -> 0x003436F8
*/
// Range: 0x3436F0 -> 0x3436F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343700 -> 0x003437A8
*/
// Range: 0x343700 -> 0x3437A8
// this: r18
void Weapon::exit_state() {
    /* anonymous block */ {
        // Range: 0x343700 -> 0x3437A8
        signed int i; // r17
        class zShrapnelAsset * shrapnelAsset; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003437B0 -> 0x00343808
*/
// Range: 0x3437B0 -> 0x343808
// this: r2
void Weapon::reset() {
    /* anonymous block */ {
        // Range: 0x3437B0 -> 0x343808
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343810 -> 0x00343818
*/
// Range: 0x343810 -> 0x343818
// this: r2
void Weapon::init() {
    /* anonymous block */ {
        // Range: 0x343810 -> 0x343818
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343820 -> 0x0034388C
*/
// Range: 0x343820 -> 0x34388C
// this: r16
void Weapon::exit() {
    /* anonymous block */ {
        // Range: 0x343820 -> 0x34388C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343890 -> 0x00343898
*/
// Range: 0x343890 -> 0x343898
// this: r2
void Weapon::setup() {
    /* anonymous block */ {
        // Range: 0x343890 -> 0x343898
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003438A0 -> 0x003438A8
*/
// Range: 0x3438A0 -> 0x3438A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003438B0 -> 0x003438B8
*/
// Range: 0x3438B0 -> 0x3438B8
void add_states() {
    /* anonymous block */ {
        // Range: 0x3438B0 -> 0x3438B8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003438C0 -> 0x00343C04
*/
// Range: 0x3438C0 -> 0x343C04
class Weapon * AddWeapon(class common * owner /* r20 */, class projectile & projectile_state /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3438C0 -> 0x343C04
        signed int weaponBone; // r29+0x13C
        char * modelName; // r29+0x138
        char modelBaseName[100]; // r29+0xD0
        char parameterName[100]; // r29+0x60
        class Weapon * newWeapon; // r2
        signed int bone; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343C10 -> 0x00343C18
*/
// Range: 0x343C10 -> 0x343C18
void initial_scene_setup() {
    /* anonymous block */ {
        // Range: 0x343C10 -> 0x343C18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343C20 -> 0x003442F4
*/
// Range: 0x343C20 -> 0x3442F4
signed int update(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & pool_ /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        ...
        class xVec3 start_diff; // r29+0x180
        // total size: 0x10
        class /* @class */ {
            // Members
        public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00344300 -> 0x003447F0
*/
// Range: 0x344300 -> 0x3447F0
void emit(class xVec3 * start_pos /* r21 */, class xVec3 * end_pos /* r22 */, float & emit_remaining /* r20 */, float dt /* r29+0xC0 */, unsigned char r /* r23 */, unsigned char g /* r30 */, unsigned char b /* r29+0xBB */, class config * cfg /* r19 */, class xVec3 * right /* r29+0xB4 */) {
    /* anonymous block */ {
        // Range: 0x344300 -> 0x3447F0
        float time_passed; // r20
        signed int emit; // r18
        class Particle * p; // r29+0xBC
        signed int count; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003447F0 -> 0x003447F8
*/
// Range: 0x3447F0 -> 0x3447F8
void add_tweaks() {
    /* anonymous block */ {
        // Range: 0x3447F0 -> 0x3447F8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00344800 -> 0x00344A30
*/
// Range: 0x344800 -> 0x344A30
void scene_setup() {
    /* anonymous block */ {
        // Range: 0x344800 -> 0x344A30
        class xParticleBatchSystem batch_system; // r29+0xA0
    }
}
