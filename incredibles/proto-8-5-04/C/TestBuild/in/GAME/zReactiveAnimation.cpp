/*
    Compile unit: C:\TestBuild\in\GAME\zReactiveAnimation.cpp
...
static signed int total_reactives; // size: 0x4, address: 0x6094E0
static class zReactiveGenre * genres; // size: 0x4, address: 0x6094E4
static signed int genres_size; // size: 0x4, address: 0x6094E8
static class zReactiveAnimationData * activities; // size: 0x4, address: 0x6094EC
static signed int activities_size; // size: 0x4, address: 0x6094F0
static signed int activities_used; // size: 0x4, address: 0x6094F4
...
unsigned int AlwaysConditional(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x43D3D0
...
class zReactiveGenre {
    // Members
public:
    class RpAtomic * model_static; // offset 0x0, size 0x4
    class RpAtomic * model_bound; // offset 0x4, size 0x4
    class RpAtomic * model_burnt; // offset 0x8, size 0x4
    ...
    class xAnimTable * table; // offset 0x18, size 0x4
    class xAnimState * anim_idle; // offset 0x1C, size 0x4
    class xAnimState * anim_move_through; // offset 0x20, size 0x4
    class xAnimState * anim_hit; // offset 0x24, size 0x4
    class xAnimState * anim_burn; // offset 0x28, size 0x4
...
class zReactiveAnimationData {
    // Members
public:
    signed int kill_flags; // offset 0x0, size 0x4
    class zEntSimpleObj * owner; // offset 0x4, size 0x4
    class zReactiveGenre * genre; // offset 0x8, size 0x4
    enum iSndHandle sound_idle_handle; // offset 0xC, size 0x4
};
// total size: 0x0
...
// total size: 0x10
class asset_type : public xTableAsset {
    // Members
public:
    class asset_entry entries[]; // offset 0x10, size 0x0
};
// total size: 0xC
class check_bound {
    // Members
public:
    class zEntSimpleObj * * hit; // offset 0x0, size 0x4
    class zEntSimpleObj * * end_hit; // offset 0x4, size 0x4
    class xBound & bound; // offset 0x8, size 0x4
};
// total size: 0x0
class activity_data {};
// total size: 0x68
...
public:
    class zEntSimpleObj * * hit; // offset 0x0, size 0x4
    class zEntSimpleObj * * end_hit; // offset 0x4, size 0x4
    class xRay3 & ray; // offset 0x8, size 0x4
};
// total size: 0x1C
class RxNodeMethods {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B4A0 -> 0x0043B53C
*/
// Range: 0x43B4A0 -> 0x43B53C
void zReactiveAddExtraSimpleMgr(class zEntSimpleObj & ent /* r2 */, class zSimpleMgr * smgr /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B4A0 -> 0x43B53C
        class zSimpleMgr * smgr_static; // r7
        class zSimpleMgr * smgr_burnt; // r2
        unsigned int visible; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B540 -> 0x0043B6B4
*/
// Range: 0x43B540 -> 0x43B6B4
void zReactivePreBucket(class zEntSimpleObj & ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B540 -> 0x43B6B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B6C0 -> 0x0043B6D0
*/
// Range: 0x43B6C0 -> 0x43B6D0
unsigned char zReactiveNeedExtraModel(class zEntSimpleObj & ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B6C0 -> 0x43B6D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B6D0 -> 0x0043B720
*/
// Range: 0x43B6D0 -> 0x43B720
signed int zReactiveCountExtraModels(class zEntSimpleObj * * ents /* r2 */, unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B6D0 -> 0x43B720
        signed int total; // r2
        class zEntSimpleObj * * it; // r2
        class zEntSimpleObj * * end; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B720 -> 0x0043B828
*/
// Range: 0x43B720 -> 0x43B828
unsigned char zReactiveSelectLOD(class zEntSimpleObj & ent /* r16 */, float dist2 /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x43B720 -> 0x43B828
        unsigned char was_active; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B830 -> 0x0043BA48
*/
// Range: 0x43B830 -> 0x43BA48
void zReactiveDeactivate(class zEntSimpleObj & ent /* r18 */, unsigned char immediate /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B830 -> 0x43BA48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043BA50 -> 0x0043BC14
*/
// Range: 0x43BA50 -> 0x43BC14
void zReactiveAffectArea(class xSphere & sphere /* r17 */, float max_dist /* r21 */) {
    /* anonymous block */ {
        // Range: 0x43BA50 -> 0x43BC14
        class zEntSimpleObj * hits[16]; // r29+0xB0
        signed int hits_size; // r2
        float cx; // r24
        float cy; // r23
        float cz; // r22
        float max_dist2; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043BC20 -> 0x0043BD7C
*/
// Range: 0x43BC20 -> 0x43BD7C
void zReactiveDamage(class zEntSimpleObj & ent /* r17 */, enum zHitSource hs /* r2 */, float damage /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x43BC20 -> 0x43BD7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043BD80 -> 0x0043BFA0
*/
// Range: 0x43BD80 -> 0x43BFA0
unsigned char zReactiveMoveThrough(class zEntSimpleObj & ent /* r18 */, float speed /* r20 */) {
    /* anonymous block */ {
        // Range: 0x43BD80 -> 0x43BFA0
        class xVec3 diff; // r29+0x70
        class zReactiveAnimationData & react; // r17
        class xAnimSingle * single; // r4
        class xAnimState * state; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043BFA0 -> 0x0043C1A8
*/
// Range: 0x43BFA0 -> 0x43C1A8
signed int zReactiveHitTestRay(class zEntSimpleObj * * hits /* r16 */, signed int max_hits /* r2 */, class xRay3 & ray /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43BFA0 -> 0x43C1A8
        class check_ray cb; // r29+0x70
        class xBound bound; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C1B0 -> 0x0043C274
*/
// Range: 0x43C1B0 -> 0x43C274
signed int zReactiveHitTestSphere(class zEntSimpleObj * * hits /* r17 */, signed int max_hits /* r16 */, class xSphere & sphere /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43C1B0 -> 0x43C274
        class xBound bound; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C280 -> 0x0043C2DC
*/
// Range: 0x43C280 -> 0x43C2DC
void zReactiveRender() {
    /* anonymous block */ {
        // Range: 0x43C280 -> 0x43C2DC
        class zReactiveAnimationData * act; // r17
        class zReactiveAnimationData * end_act; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C2E0 -> 0x0043C358
*/
// Range: 0x43C2E0 -> 0x43C358
void zReactiveUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x43C2E0 -> 0x43C358
        class zReactiveAnimationData * act; // r17
        class zReactiveAnimationData * end_act; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C360 -> 0x0043C73C
*/
// Range: 0x43C360 -> 0x43C73C
void zReactiveReset() {
    /* anonymous block */ {
        // Range: 0x43C360 -> 0x43C73C
        class zReactiveAnimationData * act; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C740 -> 0x0043C778
*/
// Range: 0x43C740 -> 0x43C778
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C780 -> 0x0043C8F0
*/
// Range: 0x43C780 -> 0x43C8F0
static void apply_fire_damage(class zEntSimpleObj & ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x43C780 -> 0x43C8F0
        class spawn_data fire_spawn; // r29+0x30
        class property_set fire_props; // @ 0x006094F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043C8F0 -> 0x0043C9FC
*/
// Range: 0x43C8F0 -> 0x43C9FC
static void play_anim(class zEntSimpleObj & ent /* r16 */, class xAnimState * state /* r19 */, float speed /* r20 */, unsigned char force_restart /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43C8F0 -> 0x43C9FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043CA00 -> 0x0043CCD4
*/
// Range: 0x43CA00 -> 0x43CCD4
static unsigned char update_activity(class zReactiveAnimationData & react /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x43CA00 -> 0x43CCD4
        class zReactiveGenre & genre; // r2
        class zEntSimpleObj & ent; // r18
        class xAnimSingle * single; // r2
        class xAnimState * state; // r2
        float time; // r2
        float duration; // r1
        float time_left; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043CCE0 -> 0x0043CE50
*/
// Range: 0x43CCE0 -> 0x43CE50
static unsigned char activate_entity(class zEntSimpleObj & ent /* r17 */, class zReactiveGenre & genre /* r16 */) {
    /* anonymous block */ {
        // Range: 0x43CCE0 -> 0x43CE50
        class xModelInstance * model; // r2
        class xAnimPlay * play; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043CE50 -> 0x0043CF90
*/
// Range: 0x43CE50 -> 0x43CF90
static void setup_entities() {
    /* anonymous block */ {
        // Range: 0x43CE50 -> 0x43CF90
        signed int activities_size'71; // r2
        signed int total; // r3
        class zScene & scene; // r2
        class zEntSimpleObj * it; // r12
        class zEntSimpleObj * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043CF90 -> 0x0043D0EC
*/
// Range: 0x43CF90 -> 0x43D0EC
static void load_genres() {
    /* anonymous block */ {
        // Range: 0x43CF90 -> 0x43D0EC
        signed int genres_size'75; // r3
        signed int tables; // r2
        signed int i; // r16
        unsigned int asset_size; // r29+0x7C
        class asset_type * asset; // r2
        class zReactiveGenre * genre; // r17
        signed int i; // r16
        unsigned int asset_size; // r29+0x78
        class asset_type * asset; // r21
        signed int j; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043D0F0 -> 0x0043D254
*/
// Range: 0x43D0F0 -> 0x43D254
static void load_genre(class zReactiveGenre & genre /* r17 */, class asset_entry & entry /* r16 */) {
    /* anonymous block */ {
        // Range: 0x43D0F0 -> 0x43D254
        unsigned int model_static_id; // r29+0x3C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043D260 -> 0x0043D3C4
*/
// Range: 0x43D260 -> 0x43D3C4
static class xAnimState * add_anim_state(class xAnimTable * table /* r19 */, unsigned int id /* r2 */, char * name /* r18 */, class xAnimState * transitionTo /* r17 */, unsigned char loop /* r20 */) {
    /* anonymous block */ {
        // Range: 0x43D260 -> 0x43D3C4
        void * anim_data; // r2
        class xAnimFile * afile; // r16
        unsigned int end; // r2
        class xAnimState * state; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043D3D0 -> 0x0043D3D8
*/
// Range: 0x43D3D0 -> 0x43D3D8
