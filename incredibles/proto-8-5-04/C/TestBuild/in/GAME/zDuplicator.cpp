/*
    Compile unit: C:\TestBuild\in\GAME\zDuplicator.cpp
...
// total size: 0x14
struct /* @anon0 */ {} zDuplicator::__vtable; // size: 0x14, address: 0x5FD720
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void event_wrapper(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x206CC0
void update_wrapper(class xEnt *, class xScene *, float); // size: 0x0, address: 0x206E60
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206300 -> 0x00206318
*/
// Range: 0x206300 -> 0x206318
unsigned int zDuplicatorQuerySubObjects(void * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x206300 -> 0x206318
        unsigned int spawn_count; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206320 -> 0x00206544
*/
// Range: 0x206320 -> 0x206544
// this: r18
void zDuplicator::spawn() {
    /* anonymous block */ {
        // Range: 0x206320 -> 0x206544
        signed int i; // r17
        class xMovePoint * movepoint; // r17
        signed int index; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206550 -> 0x00206938
*/
// Range: 0x206550 -> 0x206938
// this: r16
void zDuplicator::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x206550 -> 0x206938
        signed int i; // r17
        signed int old_npcs_alive; // r2
        signed int i; // r18
        signed int old_npcs_healthy; // r2
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206940 -> 0x002069A8
*/
// Range: 0x206940 -> 0x2069A8
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002069B0 -> 0x002069E4
*/
// Range: 0x2069B0 -> 0x2069E4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002069F0 -> 0x00206C9C
*/
// Range: 0x2069F0 -> 0x206C9C
// this: r20
unsigned int zDuplicator::init(class zScene * scene /* r30 */, class zDuplicatorAsset * asset /* r22 */, unsigned int common_idx /* r19 */) {
    /* anonymous block */ {
        // Range: 0x2069F0 -> 0x206C9C
        class xEntNPCAssetIN * duplicator_npc; // r17
        class xEntAsset * entass; // r23
        unsigned int new_id; // r2
        class xEntAsset * avatar_asset; // r16
        signed int i; // r18
        char additional_identifier[10]; // r29+0xA0
        unsigned int new_id; // r2
        class xEntAsset * unique_asset; // r17
        class common * npc; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206CA0 -> 0x00206CB4
*/
// Range: 0x206CA0 -> 0x206CB4
// this: r2
zDuplicator::zDuplicator() {
    /* anonymous block */ {
        // Range: 0x206CA0 -> 0x206CB4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206CC0 -> 0x00206E58
*/
// Range: 0x206CC0 -> 0x206E58
void event_wrapper(class xBase * from /* r23 */, class xBase * to /* r2 */, unsigned int toEvent /* r21 */, float * toParam /* r20 */, class xBase * toParamWidget /* r19 */, unsigned int toParamWidgetID /* r22 */) {
    /* anonymous block */ {
        // Range: 0x206CC0 -> 0x206E58
        class zDuplicator * duplicator; // r18
        signed int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00206E60 -> 0x00206EC4
*/
// Range: 0x206E60 -> 0x206EC4
void update_wrapper(class xEnt * ent /* r2 */, class xScene * xscn /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x206E60 -> 0x206EC4
        class zDuplicator * duplicator; // r16
    }
}
