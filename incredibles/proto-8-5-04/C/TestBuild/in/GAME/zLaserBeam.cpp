/*
    Compile unit: C:\TestBuild\in\GAME\zLaserBeam.cpp
...
static char * bm_labels[4]; // size: 0x10, address: 0x0
static char * mt_labels[3]; // size: 0xC, address: 0x0
static char * bv_labels[2]; // size: 0x8, address: 0x0
static char * ro_labels[2]; // size: 0x8, address: 0x0
static char * rc_labels[2]; // size: 0x8, address: 0x0
static char * ca_labels[3]; // size: 0xC, address: 0x0
static char * fi_labels[3]; // size: 0xC, address: 0x0
static char * fo_labels[3]; // size: 0xC, address: 0x0
static unsigned int blend_modes[4][2]; // size: 0x20, address: 0x5E9150
static class curve_node burn_ribbon_curve[7]; // size: 0x54, address: 0x5E9170
static class curve_node fade_ribbon_curve[2]; // size: 0x18, address: 0x5E91D0
static // total size: 0x8
class /* @class */ {
    // Members
public:
    class curve_node * curve; // offset 0x0, size 0x4
    signed int size; // offset 0x4, size 0x4
} ribbon_curves[2]; // size: 0x10, address: 0x509340
static char * fade_value_labels[2]; // size: 0x8, address: 0x0
static class fade_curve_node fade_in_curve_immediate[2]; // size: 0x18, address: 0x5E91F0
static class fade_curve_node fade_in_curve_linear[2]; // size: 0x18, address: 0x5E9210
static class fade_curve_node fade_in_curve_overshoot[3]; // size: 0x24, address: 0x5E9230
static class xResponseCurve fade_in_curve[3]; // size: 0x30, address: 0x67F320
static class RxObjSpace3DVertex * vert_buffer; // size: 0x4, address: 0x608DDC
static class RxObjSpace3DVertex * end_vert_buffer; // size: 0x4, address: 0x608DE0
static signed int vert_indices_set; // size: 0x4, address: 0x608DE4
static unsigned char brightening; // size: 0x1, address: 0x608DE8
static class RwRaster * current_raster; // size: 0x4, address: 0x608DEC
...
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x209E60
unsigned char HDR_brightening; // size: 0x1, address: 0x609450
...
// total size: 0xC
class fade_curve_node {
    // Members
public:
    float t; // offset 0x0, size 0x4
    class fade_value value; // offset 0x4, size 0x8
};
// total size: 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00209E60 -> 0x00209F00
*/
// Range: 0x209E60 -> 0x209F00
void cb_dispatch(class xBase * to /* r2 */, unsigned int event /* r2 */, float * argf /* r2 */) {
    /* anonymous block */ {
        // Range: 0x209E60 -> 0x209F00
        class zLaserBeam & e; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00209F00 -> 0x0020A224
*/
// Range: 0x209F00 -> 0x20A224
// this: r17
void zLaserBeam::render() {
    /* anonymous block */ {
        // Range: 0x209F00 -> 0x20A224
        unsigned char bright; // r2
        float isubdiv; // r4
        class xColor_tag color; // r29+0x4C
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020A230 -> 0x0020A614
*/
// Range: 0x20A230 -> 0x20A614
// this: r2
void zLaserBeam::render_beam_card(class motion_data & beam /* r19 */, class xColor_tag color /* r29+0x5C */) {
    /* anonymous block */ {
        // Range: 0x20A230 -> 0x20A614
        class xVec3 right; // r29+0x130
        class xVec3 half_right; // r29+0x120
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020A620 -> 0x0020AAB8
*/
// Range: 0x20A620 -> 0x20AAB8
// this: r2
void zLaserBeam::apply_damage(class motion_data & m /* r2 */, class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x20A620 -> 0x20AAB8
        class xVec3 knockback_vel; // r29+0x110
        class xVec3 knockback_perp; // r29+0x100
        class zCombatDamageInfo params; // r29+0x90
        class zCombatDamageInfo params; // r29+0x50
        class zCombatDamageInfo params; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020AAC0 -> 0x0020B248
*/
// Range: 0x20AAC0 -> 0x20B248
// this: r17
void zLaserBeam::collide(class motion_data & m /* r16 */) {
    /* anonymous block */ {
        // Range: 0x20AAC0 -> 0x20B248
        class xRay3 ray; // r29+0x240
        class xCollis coll; // r29+0x1E0
        class xBound bound; // r29+0x190
        class xCollis temp_coll; // r29+0x130
        class xBound secondBound; // r29+0xE0
        unsigned char chkby; // r7
        class cb_beam_hits_ent cb; // r29+0xD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020B250 -> 0x0020B79C
*/
// Range: 0x20B250 -> 0x20B79C
// this: r21
void zLaserBeam::update_ribbon() {
    /* anonymous block */ {
        // Range: 0x20B250 -> 0x20B79C
        class xVec3 norm; // r29+0x160
        class xVec3 safety; // r29+0x150
        class xVec3 tan; // r29+0x140
        unsigned int i; // r20
        class xVec3 tan; // r29+0x130
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020B7A0 -> 0x0020B8CC
*/
// Range: 0x20B7A0 -> 0x20B8CC
// this: r2
void zLaserBeam::update_fade(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x20B7A0 -> 0x20B8CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020B8D0 -> 0x0020BC50
*/
// Range: 0x20B8D0 -> 0x20BC50
// this: r16
void zLaserBeam::update_target(float dt /* r29+0x60 */) {
    /* anonymous block */ {
        // Range: 0x20B8D0 -> 0x20BC50
        class xModelInstance * model; // r2
        signed int bone; // r6
        class xVec3 & bone_dir; // r2
        class xVec3 dir; // r29+0x50
        class xVec3 start_loc; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020BC50 -> 0x0020C338
*/
// Range: 0x20BC50 -> 0x20C338
// this: r21
void zLaserBeam::apply_motion_direct(float start_subdist /* r29+0x190 */, float subdist /* r21 */, signed int motion_flags /* r20 */) {
    /* anonymous block */ {
        // Range: 0x20BC50 -> 0x20C338
        unsigned int i; // r19
        float ddist; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020C340 -> 0x0020C774
*/
// Range: 0x20C340 -> 0x20C774
// this: r16
void zLaserBeam::next_point(float ddist /* r29+0xE0 */) {
    /* anonymous block */ {
        // Range: 0x20C340 -> 0x20C774
        class xVec3 direction; // r29+0xD0
        class xMovePoint * next_mp; // r29+0xDC
        class xMovePoint * prev_mp; // r2
        float u; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020C780 -> 0x0020C834
*/
// Range: 0x20C780 -> 0x20C834
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020C840 -> 0x0020C92C
*/
// Range: 0x20C840 -> 0x20C92C
// this: r18
void zLaserBeam::load_attach_to(unsigned int id /* r17 */) {
    /* anonymous block */ {
        // Range: 0x20C840 -> 0x20C92C
        unsigned int size; // r29+0x4C
        class location_asset * location; // r16
        class xBase * ent; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020C930 -> 0x0020CA40
*/
// Range: 0x20C930 -> 0x20CA40
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020CA40 -> 0x0020CE44
*/
// Range: 0x20CA40 -> 0x20CE44
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020CE50 -> 0x0020CF4C
*/
// Range: 0x20CE50 -> 0x20CF4C
// this: r16
void zLaserBeam::deactivate(float time /* r20 */) {
    /* anonymous block */ {
        // Range: 0x20CE50 -> 0x20CF4C
        class fade_value value; // r29+0x38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020CF50 -> 0x0020D3D4
*/
// Range: 0x20CF50 -> 0x20D3D4
// this: r16
void zLaserBeam::activate(float time /* r20 */) {
    /* anonymous block */ {
        // Range: 0x20CF50 -> 0x20D3D4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020D3E0 -> 0x0020DBDC
*/
// Range: 0x20D3E0 -> 0x20DBDC
// this: r21
void zLaserBeam::update_motion(float dt /* r29+0x140 */) {
    /* anonymous block */ {
        // Range: 0x20D3E0 -> 0x20DBDC
        signed int motion_flags; // r20
        float old_segment_dist; // r2
        float ddist; // r29+0x140
        float start_subdist; // r29+0x140
        float subdist; // r21
        class xMat4x3 & model_mat; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020DBE0 -> 0x0020DD24
*/
// Range: 0x20DBE0 -> 0x20DD24
void render_all() {
    /* anonymous block */ {
        // Range: 0x20DBE0 -> 0x20DD24
        class zScene & s; // r2
        class zLaserBeam * it; // r16
        class zLaserBeam * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020DD30 -> 0x0020DE34
*/
// Range: 0x20DD30 -> 0x20DE34
void reset_all() {
    /* anonymous block */ {
        // Range: 0x20DD30 -> 0x20DE34
        class zScene & s; // r2
        class zLaserBeam * it; // r17
        class zLaserBeam * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020DE40 -> 0x0020E810
*/
// Range: 0x20DE40 -> 0x20E810
void update_all(float dt /* r24 */) {
    /* anonymous block */ {
        // Range: 0x20DE40 -> 0x20E810
        class zScene & s; // r2
        class zLaserBeam * it; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020E810 -> 0x0020E87C
*/
// Range: 0x20E810 -> 0x20E87C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020E880 -> 0x0020E924
*/
// Range: 0x20E880 -> 0x20E924
void setup_all() {
    /* anonymous block */ {
        // Range: 0x20E880 -> 0x20E924
        class zScene & s; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020E930 -> 0x0020E938
*/
// Range: 0x20E930 -> 0x20E938
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x20E930 -> 0x20E938
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020E940 -> 0x0020E9A8
*/
// Range: 0x20E940 -> 0x20E9A8
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x20E940 -> 0x20E9A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0020E9B0 -> 0x0020EAB0
*/
// Range: 0x20E9B0 -> 0x20EAB0
static void flush_vert_buffer() {
    /* anonymous block */ {
        // Range: 0x20E9B0 -> 0x20EAB0
        signed int vert_size; // r2
        unsigned short * index_buffer; // r17
        signed int index_size; // r16
        unsigned short * index; // r8
        unsigned short * end_index; // r2
        signed int vi; // r7
    }
}
