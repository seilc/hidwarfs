/*
    Compile unit: C:\TestBuild\in\GAME\zFXFireTrail.cpp
...
unsigned char need_setup; // size: 0x1, address: 0x608500
class config default_config; // size: 0x44, address: 0x6C53E0
signed int system_id; // size: 0x4, address: 0x6096D8
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x490DC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00490DC0 -> 0x00491464
*/
// Range: 0x490DC0 -> 0x491464
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491470 -> 0x00491C40
*/
// Range: 0x491470 -> 0x491C40
void emit(class xVec3 & position /* r21 */, class xVec3 & normal /* r20 */, float & emit_remaining /* r19 */, class xVec3 & velocity /* r22 */, float dt /* r23 */, class config * cfg /* r18 */) {
    /* anonymous block */ {
        // Range: 0x491470 -> 0x491C40
        float time_passed; // r22
        signed int emit; // r17
        class particle * p; // r29+0x15C
        signed int count; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491C40 -> 0x00491C48
*/
// Range: 0x491C40 -> 0x491C48
void add_tweaks() {
    /* anonymous block */ {
        // Range: 0x491C40 -> 0x491C48
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00491C50 -> 0x00491D3C
*/
// Range: 0x491C50 -> 0x491D3C
void setup() {
    /* anonymous block */ {
        // Range: 0x491C50 -> 0x491D3C
    }
