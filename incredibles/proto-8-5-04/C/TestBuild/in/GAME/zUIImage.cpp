/*
    Compile unit: C:\TestBuild\in\GAME\zUIImage.cpp
...
// total size: 0x50
struct /* @anon1 */ {} zUIImage::__vtable; // size: 0x50, address: 0x601350
// total size: 0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9410 -> 0x002A9460
*/
// Range: 0x2A9410 -> 0x2A9460
void zUIImage_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A9410 -> 0x2A9460
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9460 -> 0x002A9474
*/
// Range: 0x2A9460 -> 0x2A9474
// this: r2
unsigned char zUIImage::Blends() {
    /* anonymous block */ {
        // Range: 0x2A9460 -> 0x2A9474
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9480 -> 0x002A94C8
*/
// Range: 0x2A9480 -> 0x2A94C8
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A94D0 -> 0x002A94D8
*/
// Range: 0x2A94D0 -> 0x2A94D8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A94E0 -> 0x002A963C
*/
// Range: 0x2A94E0 -> 0x2A963C
// this: r17
void zUIImage::DoApplyMotionFrame(class zUIMotionFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A94E0 -> 0x2A963C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9640 -> 0x002A967C
*/
// Range: 0x2A9640 -> 0x2A967C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9680 -> 0x002AA5D0
*/
// Range: 0x2A9680 -> 0x2AA5D0
// this: r17
void zUIImage::DoRender() {
    /* anonymous block */ {
        ...
        class RwSky2DVertex vertex[4]; // r29+0x70
        float x1; // r22
        float y1; // r26
        float x2; // r21
        float y2; // r20
        ...
        float cz; // r9
        float cooz; // r8
        void * modeTranslate[3]; // @ 0x0050DEA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA5D0 -> 0x002AA5D8
*/
// Range: 0x2AA5D0 -> 0x2AA5D8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA5E0 -> 0x002AA86C
*/
// Range: 0x2AA5E0 -> 0x2AA86C
// this: r18
void zUIImage::DoHandleEvent(class xBase * from /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2AA5E0 -> 0x2AA86C
        class RwTexture * pTexture; // r2
        float u0; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA870 -> 0x002AA8A8
*/
// Range: 0x2AA870 -> 0x2AA8A8
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA8B0 -> 0x002AA9A0
*/
// Range: 0x2AA8B0 -> 0x2AA9A0
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA9A0 -> 0x002AA9D0
*/
// Range: 0x2AA9A0 -> 0x2AA9D0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AA9D0 -> 0x002AAABC
*/
// Range: 0x2AA9D0 -> 0x2AAABC
// this: r18
void zUIImage::SetTexture(unsigned int id /* r17 */, unsigned char clearPrev /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2AA9D0 -> 0x2AAABC
