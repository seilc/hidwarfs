/*
    Compile unit: C:\TestBuild\in\GAME\zBomb.cpp
...
class config dust_config; // size: 0x4C, address: 0x6BA120
class config_data blur_config; // size: 0x24, address: 0x6BA170
class smoke_config smoke_config; // size: 0x38, address: 0x6BA1A0
class xEntAsset ent_asset; // size: 0x50, address: 0x6BA1E0
class zShrapnelAsset * shrapnel; // size: 0x4, address: 0x609478
enum iSndGroupHandle bounce_group; // size: 0x4, address: 0x60947C
enum iSndGroupHandle tick_group; // size: 0x4, address: 0x609480
enum iSndGroupHandle warning_group; // size: 0x4, address: 0x609484
float speed; // size: 0x4, address: 0x608434
unsigned char weak_bombs; // size: 0x1, address: 0x609488
char * bomb_model_name; // size: 0x4, address: 0x608438
char * bomb_glow_name; // size: 0x4, address: 0x60843C
// total size: 0x4C
struct /* @anon2 */ {} z::bomb::__vtable; // size: 0x4C, address: 0x604C30
...
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<z::bomb, 20>::__vtable; // size: 0x20, address: 0x604C80
// total size: 0xC
struct /* @anon1 */ {} xBallPhysics::__vtable; // size: 0xC, address: 0x604CA0
void bomb_event_handler_func(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x42B7E0
void update_bomb_bounds(class xEnt *, class xVec3 *); // size: 0x0, address: 0x42B310
...
unsigned int DestroyCB(class xEnt *, void *, unsigned char); // size: 0x0, address: 0x42B850
unsigned int CollideCB(class xEnt *, class xEnt *, class xVec3 *, class xVec3 *, void *); // size: 0x0, address: 0x42B820
// total size: 0x0
class xFFX {};
// total size: 0xD8
...
// total size: 0x14
class damage_callback {
    // Members
public:
    class xEnt * from; // offset 0x0, size 0x4
    class xBound * bound; // offset 0x4, size 0x4
    signed int damage; // offset 0x8, size 0x4
    float & away_speed; // offset 0xC, size 0x4
    float & up_speed; // offset 0x10, size 0x4
};
// total size: 0xC
class tri_data {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00429BA0 -> 0x00429BF0
*/
// Range: 0x429BA0 -> 0x429BF0
void sphere_damage(class xEnt * fromEnt /* r3 */, class xVec3 & epicenter /* r2 */, float blastRadius /* r29+0x60 */, signed int player_damage /* r2 */, signed int npc_damage /* r2 */, float awayKnockback /* r29+0x60 */, float upKnockback /* r29+0x60 */) {
    /* anonymous block */ {
        // Range: 0x429BA0 -> 0x429BF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00429BF0 -> 0x00429C44
*/
// Range: 0x429BF0 -> 0x429C44
void cylinder_damage(class xEnt * fromEnt /* r3 */, class xVec3 & epicenter /* r2 */, float blastRadius /* r29+0x60 */, float blastHeight_2 /* r29+0x60 */, signed int player_damage /* r2 */, signed int npc_damage /* r2 */, float awayKnockback /* r29+0x60 */, float upKnockback /* r29+0x60 */) {
    /* anonymous block */ {
        // Range: 0x429BF0 -> 0x429C44
        class xBound bound; // r29+0x10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00429C50 -> 0x0042A3E8
*/
// Range: 0x429C50 -> 0x42A3E8
void bound_damage(class xBound & bound /* r20 */, class xEnt * fromEnt /* r29+0xD4 */, signed int player_damage /* r29+0xD0 */, signed int npc_damage /* r16 */, float awayKnockback /* r29+0xD8 */, float upKnockback /* r29+0xDC */) {
    /* anonymous block */ {
        // Range: 0x429C50 -> 0x42A3E8
        class damage_callback cb; // r29+0x290
        class xVec3 hit_pos; // r29+0x350
        class xVec3 hit; // r29+0x340
        class xSphere * player_spheres[5]; // r29+0x270
        signed int num_spheres; // r2
        signed int i; // r19
        class xBound test_bound; // r29+0x220
        class xVec3 hit_pos; // r29+0x330
        class xVec3 hit; // r29+0x320
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042A3F0 -> 0x0042A6D8
*/
// Range: 0x42A3F0 -> 0x42A6D8
// this: r16
bomb::bomb() {
    /* anonymous block */ {
        // Range: 0x42A3F0 -> 0x42A6D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042A6E0 -> 0x0042A968
*/
// Range: 0x42A6E0 -> 0x42A968
// this: r17
class bomb & bomb::operator=(class bomb & b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x42A6E0 -> 0x42A968
        unsigned char activated; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042A970 -> 0x0042AAE4
*/
// Range: 0x42A970 -> 0x42AAE4
// this: r2
bomb::bomb(class xVec3 & position /* r2 */, class xVec3 & velocity /* r2 */, float time /* r29+0x10 */, class xBallPhysicsProperties & physics_properties /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42A970 -> 0x42AAE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042AAF0 -> 0x0042AB20
*/
// Range: 0x42AAF0 -> 0x42AB20
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042AB20 -> 0x0042AB98
*/
// Range: 0x42AB20 -> 0x42AB98
// this: r2
void bomb::render() {
    /* anonymous block */ {
        // Range: 0x42AB20 -> 0x42AB98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042ABA0 -> 0x0042ABB0
*/
// Range: 0x42ABA0 -> 0x42ABB0
// this: r2
void bomb::defuse() {
    /* anonymous block */ {
        // Range: 0x42ABA0 -> 0x42ABB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042ABB0 -> 0x0042AE4C
*/
// Range: 0x42ABB0 -> 0x42AE4C
// this: r16
void bomb::detonate() {
    /* anonymous block */ {
        // Range: 0x42ABB0 -> 0x42AE4C
        signed int playerDamage; // r2
        class xVec3 knockback; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042AE50 -> 0x0042B1C8
*/
// Range: 0x42AE50 -> 0x42B1C8
// this: r16
void bomb::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x42AE50 -> 0x42B1C8
        class xVec3 old_pos; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B1D0 -> 0x0042B308
*/
// Range: 0x42B1D0 -> 0x42B308
// this: r17
unsigned char bomb::collided(class xSweptSphere & sws /* r16 */) {
    /* anonymous block */ {
        // Range: 0x42B1D0 -> 0x42B308
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B310 -> 0x0042B37C
*/
// Range: 0x42B310 -> 0x42B37C
static void update_bomb_bounds(class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x42B310 -> 0x42B37C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B380 -> 0x0042B3C8
*/
// Range: 0x42B380 -> 0x42B3C8
// this: r16
void bomb::destroy() {
    /* anonymous block */ {
        // Range: 0x42B380 -> 0x42B3C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B3D0 -> 0x0042B6CC
*/
// Range: 0x42B3D0 -> 0x42B6CC
void setup() {
    /* anonymous block */ {
        // Range: 0x42B3D0 -> 0x42B6CC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B6D0 -> 0x0042B7A0
*/
// Range: 0x42B6D0 -> 0x42B7A0
void scene_setup() {
    /* anonymous block */ {
        // Range: 0x42B6D0 -> 0x42B7A0
        unsigned int nameHash; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B7A0 -> 0x0042B7D4
*/
// Range: 0x42B7A0 -> 0x42B7D4
// this: r2
void bomb::reset() {
    /* anonymous block */ {
        // Range: 0x42B7A0 -> 0x42B7D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B7E0 -> 0x0042B818
*/
// Range: 0x42B7E0 -> 0x42B818
static void bomb_event_handler_func(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42B7E0 -> 0x42B818
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B820 -> 0x0042B844
*/
// Range: 0x42B820 -> 0x42B844
static unsigned int CollideCB(class xEnt * thrown /* r2 */, class xVec3 * point /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42B820 -> 0x42B844
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0042B850 -> 0x0042B870
*/
// Range: 0x42B850 -> 0x42B870
static unsigned int DestroyCB(class xEnt * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x42B850 -> 0x42B870
    }
}
