/*
    Compile unit: C:\TestBuild\in\GAME\zRocket.cpp
...
static class config rocket_jet_config; // size: 0x4C, address: 0x6BA2A0
float ROCKET_BOUND_RADIUS; // size: 0x4, address: 0x608448
static float MAX_ROCKET_LIFETIME; // size: 0x4, address: 0x5F9D80
float ROCKET_ACCELERATION; // size: 0x4, address: 0x60844C
class zShrapnelAsset * shrapnel; // size: 0x4, address: 0x6094A4
enum iSndGroupHandle flying_noise_group; // size: 0x4, address: 0x608450
unsigned char need_setup; // size: 0x1, address: 0x608454
class config default_config; // size: 0x4C, address: 0x6BA2F0
signed int system_id; // size: 0x4, address: 0x6094A8
class smoke_config default_config; // size: 0x38, address: 0x6BA340
signed int system_id; // size: 0x4, address: 0x608458
static unsigned char need_setup; // size: 0x1, address: 0x60845C
// total size: 0x20
struct /* @anon1 */ {} z::rocket::__vtable; // size: 0x20, address: 0x6051D0
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x432DD0
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x433420
class zGlobals globals; // size: 0x640, address: 0x61C210
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<z::rocket, 20>::__vtable; // size: 0x20, address: 0x6051F0
...
public:
    ...
    float system_emit_time; // offset 0x28, size 0x4
    ...
    float normal_emit_speed; // offset 0x3C, size 0x4
...
public:
    ...
    class smoke_config * cfg; // offset 0x2C, size 0x4
};
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004328D0 -> 0x00432DD0
*/
// Range: 0x4328D0 -> 0x432DD0
void emit(float & emit_remaining /* r20 */, class xVec3 & velocity /* r19 */, float dt /* r25 */, class smoke_config * cfg /* r18 */) {
    /* anonymous block */ {
        // Range: 0x4328D0 -> 0x432DD0
        class xVec3 position; // r29+0xC0
        float emit_rate; // r24
        float time_passed; // r23
        signed int emit; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432DD0 -> 0x00433370
*/
// Range: 0x432DD0 -> 0x433370
signed int update(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & pool_ /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x432DD0 -> 0x433370
        class ptank_pool__pos_color_size_rot & pool; // r18
        class particle * p; // r17
        class particle * end; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00433370 -> 0x00433414
*/
// Range: 0x433370 -> 0x433414
void setup() {
    /* anonymous block */ {
        // Range: 0x433370 -> 0x433414
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00433420 -> 0x00433A18
*/
// Range: 0x433420 -> 0x433A18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00433A20 -> 0x004342CC
*/
// Range: 0x433A20 -> 0x4342CC
void emit(float & emit_remaining /* r20 */, float dt /* r21 */, class xMat4x3 * mat /* r19 */, class config * cfg /* r18 */) {
    /* anonymous block */ {
        // Range: 0x433A20 -> 0x4342CC
        class xVec3 position; // r29+0x180
        class xVec3 normal; // r29+0x170
        class xVec3 velocity; // r29+0x160
        float time_passed; // r20
        signed int emit; // r17
        class particle * p; // r29+0x18C
        signed int count; // r2
        class particle * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004342D0 -> 0x004343B4
*/
// Range: 0x4342D0 -> 0x4343B4
void setup() {
    /* anonymous block */ {
        // Range: 0x4342D0 -> 0x4343B4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004343C0 -> 0x00434440
*/
// Range: 0x4343C0 -> 0x434440
// this: r16
rocket::rocket() {
    /* anonymous block */ {
        // Range: 0x4343C0 -> 0x434440
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00434440 -> 0x004344A8
*/
// Range: 0x434440 -> 0x4344A8
// this: r2
class rocket & rocket::operator=(class rocket & r /* r2 */) {
    /* anonymous block */ {
        // Range: 0x434440 -> 0x4344A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004344B0 -> 0x0043459C
*/
// Range: 0x4344B0 -> 0x43459C
// this: r2
rocket::rocket(class xVec3 * target_pos /* r2 */, float above_target_pos /* r29+0x20 */, class xEnt * source /* r2 */, class xVec3 & position /* r2 */, class xVec3 & direction /* r2 */, float turn_speed /* r29+0x20 */, float rocket_speed /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x4344B0 -> 0x43459C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004345A0 -> 0x004345A8
*/
// Range: 0x4345A0 -> 0x4345A8
void post_render_3d() {
    /* anonymous block */ {
        // Range: 0x4345A0 -> 0x4345A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004345B0 -> 0x004345B8
*/
// Range: 0x4345B0 -> 0x4345B8
void post_render_2d() {
    /* anonymous block */ {
        // Range: 0x4345B0 -> 0x4345B8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004345C0 -> 0x00434A18
*/
// Range: 0x4345C0 -> 0x434A18
// this: r2
void rocket::render() {
    /* anonymous block */ {
        // Range: 0x4345C0 -> 0x434A18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00434A20 -> 0x00435158
*/
// Range: 0x434A20 -> 0x435158
// this: r16
void rocket::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x434A20 -> 0x435158
        class xVec3 cur_target_pos; // r29+0x170
        class xVec3 direction_to_player; // r29+0x160
        class xVec3 perpendicular_direction; // r29+0x150
        class xVec3 smoke_pos; // r29+0x140
        class xVec3 jet_pos; // r29+0x130
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00435160 -> 0x00435C60
*/
// Range: 0x435160 -> 0x435C60
// this: r16
void rocket::collide(class xVec3 & dpos /* r17 */) {
    /* anonymous block */ {
        // Range: 0x435160 -> 0x435C60
        class xSweptSphere sws; // r29+0x70
        class xVec3 start; // r29+0x310
        class xVec3 end; // r29+0x300
        class xSphere * extra_spheres[5]; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00435C60 -> 0x00435C68
*/
// Range: 0x435C60 -> 0x435C68
// this: r2
void rocket::destroy() {
    /* anonymous block */ {
        // Range: 0x435C60 -> 0x435C68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00435C70 -> 0x00435D40
*/
// Range: 0x435C70 -> 0x435D40
void setup() {
    /* anonymous block */ {
        // Range: 0x435C70 -> 0x435D40
    }
