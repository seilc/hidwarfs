/*
    Compile unit: C:\TestBuild\in\GAME\zDust.cpp
...
static char * ring_chain_labels[3]; // size: 0xC, address: 0x0
static class ring_chain_data chain[2]; // size: 0x38, address: 0x5FA050
static signed int texture_rows; // size: 0x4, address: 0x608460
static signed int texture_columns; // size: 0x4, address: 0x608464
static signed int dirt_system_id; // size: 0x4, address: 0x6094C0
static float ring_vel_decay; // size: 0x4, address: 0x6094C4
static class xVec2 * dirt_uvs; // size: 0x4, address: 0x6094C8
static unsigned char refreshed_ring_chains; // size: 0x1, address: 0x6094CC
static float ring_chain_ang[2]; // size: 0x8, address: 0x6094D0
static class xVec2 ring_chain[2][8]; // size: 0x80, address: 0x6BA3A0
signed int activities_used; // size: 0x4, address: 0x6094D8
class activity_data * activities; // size: 0x4, address: 0x6094DC
...
signed int update_dust_particles_uv2(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x43A830
signed int update_dust_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x43ADE0
// total size: 0x18
class analog_data {
    // Members
public:
...
public:
    ...
    class xVec2 * uv; // offset 0x34, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439A40 -> 0x0043A0B0
*/
// Range: 0x439A40 -> 0x43A0B0
// this: r29+0x108
void zDustRingEmitter::kickup(class xVec3 & center /* r16 */, float force /* r29+0xDC */, float dt /* r29+0xD8 */) {
    /* anonymous block */ {
        // Range: 0x439A40 -> 0x43A0B0
        float cx; // r31
        float cy; // r30
        float cz; // r29
        float radius_min; // r28
        float radius_delta; // r27
        float size_min; // r26
        float size_delta; // r25
        float vmag_min; // r24
        float vmag_delta; // r23
        float intensity_min; // r22
        float intensity_delta; // r29+0xD4
        unsigned char alpha; // r2
        signed int dirt_frames; // r2
        signed int i; // r29+0xF0
        signed int emit; // r20
        unsigned char * mem; // r29+0x10C
        signed int have; // r2
        class dust_particle * p; // r19
        class dust_particle * endp; // r2
        float dx; // r21
        float dz; // r20
        float rr; // r29+0x110
        float rand_radius; // r29+0x110
        float vmag; // r29+0x110
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A0B0 -> 0x0043A13C
*/
// Range: 0x43A0B0 -> 0x43A13C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A140 -> 0x0043A284
*/
// Range: 0x43A140 -> 0x43A284
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A290 -> 0x0043A388
*/
// Range: 0x43A290 -> 0x43A388
// this: r2
void zDustRingEmitter::set_config(class config_type * cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43A290 -> 0x43A388
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A390 -> 0x0043A3AC
*/
// Range: 0x43A390 -> 0x43A3AC
void load_default_config(class config_type & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43A390 -> 0x43A3AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A3B0 -> 0x0043A450
*/
// Range: 0x43A3B0 -> 0x43A450
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A450 -> 0x0043A458
*/
// Range: 0x43A450 -> 0x43A458
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A460 -> 0x0043A468
*/
// Range: 0x43A460 -> 0x43A468
void zDustRender() {
    /* anonymous block */ {
        // Range: 0x43A460 -> 0x43A468
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A470 -> 0x0043A498
*/
// Range: 0x43A470 -> 0x43A498
void zDustUpdate(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x43A470 -> 0x43A498
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A4A0 -> 0x0043A554
*/
// Range: 0x43A4A0 -> 0x43A554
void zDustReset() {
    /* anonymous block */ {
        // Range: 0x43A4A0 -> 0x43A554
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A560 -> 0x0043A634
*/
// Range: 0x43A560 -> 0x43A634
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A640 -> 0x0043A82C
*/
// Range: 0x43A640 -> 0x43A82C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043A830 -> 0x0043ADDC
*/
// Range: 0x43A830 -> 0x43ADDC
static signed int update_dust_particles_uv2(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x43A830 -> 0x43ADDC
        class ptank_pool__pos_color_size_rot_uv2 & pool; // r18
        float vel_decay; // r21
        class dust_particle * p; // r17
        class dust_particle * end; // r16
        float hsize; // r20
        float t1; // r29+0x90
        float t2; // r29+0x90
        float alpha; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043ADE0 -> 0x0043B334
*/
// Range: 0x43ADE0 -> 0x43B334
static signed int update_dust_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x43ADE0 -> 0x43B334
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B340 -> 0x0043B408
*/
// Range: 0x43B340 -> 0x43B408
static void create_dirt_system() {
    /* anonymous block */ {
        // Range: 0x43B340 -> 0x43B408
        signed int uvpairs; // r2
        class RwTexture * dirt_texture; // r2
        class xParticleBatchSystem system; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0043B410 -> 0x0043B4A0
*/
// Range: 0x43B410 -> 0x43B4A0
static void set_uv_frames(class xVec2 * uv /* r2 */, signed int rows /* r2 */, signed int columns /* r2 */) {
    /* anonymous block */ {
        // Range: 0x43B410 -> 0x43B4A0
        float du; // r5
        float dv; // r4
