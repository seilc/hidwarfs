/*
    Compile unit: C:\TestBuild\in\GAME\zNPCMeleeBot.cpp
...
static class xColor_tag light_color; // size: 0x4, address: 0x5F9E08
static class xColor_tag laser_color; // size: 0x4, address: 0x5F9E10
static class config_type dust_config; // size: 0x14, address: 0x5DB240
static class scan_curve_node scan_show_nodes[3]; // size: 0x54, address: 0x5F9E20
static class scan_curve_node scan_hide_nodes[3]; // size: 0x54, address: 0x5F9E80
static signed int model_atomics; // size: 0x4, address: 0x6094AC
static class xQuat spin_quat; // size: 0x10, address: 0x0
static class RpAtomic * flat_laser_atomic; // size: 0x4, address: 0x6094B0
static class xResponseCurve scan_show_curve; // size: 0x10, address: 0x6BA380
static class xResponseCurve scan_hide_curve; // size: 0x10, address: 0x6BA390
enum iSndGroupHandle scan_noise_group; // size: 0x4, address: 0x6094B4
class xBallPhysicsProperties physics_properties; // size: 0x1C, address: 0x5F9EE0
class fx_context * fx_buffer; // size: 0x4, address: 0x6094B8
class fx_context * fx_stack; // size: 0x4, address: 0x6094BC
// total size: 0xB4
struct /* @anon19 */ {} zNPC::melee_bot::__vtable; // size: 0xB4, address: 0x605210
...
void * __ct(class fx_context *); // size: 0x0, address: 0x4376F0
...
// total size: 0x7C
struct /* @anon6 */ {} zNPC::NPCSmokeBehavior::__vtable; // size: 0x7C, address: 0x606850
// total size: 0x7C
struct /* @anon22 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon23 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x98
struct /* @anon4 */ {} zNPC::pickup_react::__vtable; // size: 0x98, address: 0x6052D0
// total size: 0x98
struct /* @anon21 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x7C
struct /* @anon3 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon0 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x7C
struct /* @anon1 */ {} zNPC::shrapnel_death::__vtable; // size: 0x7C, address: 0x600F30
// total size: 0x7C
struct /* @anon13 */ {} zNPC::timebomb_death::__vtable; // size: 0x7C, address: 0x6040B0
// total size: 0x7C
struct /* @anon20 */ {} zNPC::launch_death::__vtable; // size: 0x7C, address: 0x603FB0
// total size: 0x7C
struct /* @anon24 */ {} zNPC::physics_death::__vtable; // size: 0x7C, address: 0x604030
// total size: 0x8C
struct /* @anon10 */ {} zNPC::auto_orient_physics::__vtable; // size: 0x8C, address: 0x603E00
// total size: 0x8C
struct /* @anon7 */ {} zNPC::ball_physics::__vtable; // size: 0x8C, address: 0x603E90
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
// total size: 0xC
struct /* @anon2 */ {} xBallPhysics::__vtable; // size: 0xC, address: 0x604CA0
// total size: 0x98
struct /* @anon16 */ {} zNPC::on_edge::__vtable; // size: 0x98, address: 0x5FDEC0
// total size: 0x98
struct /* @anon8 */ {} zNPC::stuck::__vtable; // size: 0x98, address: 0x5FDF60
// total size: 0x98
struct /* @anon14 */ {} zNPC::static_jump::__vtable; // size: 0x98, address: 0x604130
// total size: 0x7C
struct /* @anon17 */ {} zNPC::bot_sleep::__vtable; // size: 0x7C, address: 0x603C80
// total size: 0x98
struct /* @anon5 */ {} zNPC::patrol_return::__vtable; // size: 0x98, address: 0x603BE0
// total size: 0x98
struct /* @anon25 */ {} zNPC::random_patrol::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon9 */ {} zNPC::player_hit_react::__vtable; // size: 0x98, address: 0x603B40
// total size: 0x98
struct /* @anon26 */ {} zNPC::react::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon12 */ {} zNPC::melee_charge::__vtable; // size: 0x98, address: 0x605370
// total size: 0x98
struct /* @anon18 */ {} zNPC::charge_attack::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon15 */ {} zNPC::home::__vtable; // size: 0x98, address: 0x5FE2E0
unsigned int anfacing_player(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x439760
unsigned int anend_scan_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x439720
unsigned int anstart_scan_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x4397A0
unsigned int anattack_finished(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x439810
unsigned int anattack_start(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x439850
// total size: 0x10
struct /* @anon11 */ {} xLightVolume::__vtable; // size: 0x10, address: 0x0
// total size: 0xC
...
// total size: 0x69C
class melee_bot : public common {
    // Members
public:
    class home home_state; // offset 0x2C0, size 0x40
    class melee_charge charge_attack_state; // offset 0x300, size 0x6C
    class player_hit_react player_hit_state; // offset 0x36C, size 0x58
    class patrol_return patrol_return_state; // offset 0x3C4, size 0x54
    class bot_sleep bot_sleep_state; // offset 0x418, size 0x28
    class static_jump bot_jump_state; // offset 0x440, size 0x38
    class stuck stuck_state; // offset 0x478, size 0x34
    class on_edge on_edge_state; // offset 0x4AC, size 0x34
    class auto_orient_physics ball_physics_state; // offset 0x4E0, size 0x74
    class launch_death launch_death_state; // offset 0x554, size 0x2C
    class timebomb_death timebomb_death_state; // offset 0x580, size 0x38
    class explode explode_state; // offset 0x5B8, size 0x54
    class pickup_react pickup_state; // offset 0x60C, size 0x54
    class NPCSmokeBehavior NPCSmokeBehaviorState; // offset 0x660, size 0x2C
    float away_speed; // offset 0x68C, size 0x4
    signed int carry_damage; // offset 0x690, size 0x4
    float damage_timer; // offset 0x694, size 0x4
    class fx_context * fx; // offset 0x698, size 0x4
};
// total size: 0x8
...
// total size: 0x6C
class melee_charge : public charge_attack {
    // Members
public:
    float attack_timer; // offset 0x64, size 0x4
    enum iSndHandle scan_noise; // offset 0x68, size 0x4
};
// total size: 0x64
...
class fx_context {
    // Members
public:
    class fx_context * next; // offset 0x0, size 0x4
    class xQuat last_blade_quat; // offset 0x10, size 0x10
    class xModelInstance * blur_model; // offset 0x20, size 0x4
    class xModelInstance * blur_model2; // offset 0x24, size 0x4
    class xModelInstance * blade_model; // offset 0x28, size 0x4
    class xModelInstance * laser_model; // offset 0x2C, size 0x4
    class xModelInstance * volume_model; // offset 0x30, size 0x4
    class zDustRingEmitter dust_ring; // offset 0x34, size 0x8
    float blur_blade_ang; // offset 0x3C, size 0x4
    float blur_blade2_ang; // offset 0x40, size 0x4
    class RwMatrixTag * old_volume_mat; // offset 0x44, size 0x4
    class RwMatrixTag laser_uvmat; // offset 0x50, size 0x40
    float laser_v; // offset 0x90, size 0x4
    enum scan_state_enum scan_state; // offset 0x94, size 0x4
    class scan_curve_node scan_values; // offset 0x98, size 0x1C
    float scan_age_rate; // offset 0xB4, size 0x4
    class xLightVolumeModel laser_light_volume; // offset 0xB8, size 0x14
};
// total size: 0x138
class _tagxPad {
    // Members
...
class zCutsceneMgr {};
// total size: 0x54
class pickup_react : public npc_move {
    // Members
public:
    float spin_timer; // offset 0x34, size 0x4
    float max_timer; // offset 0x38, size 0x4
    float knockback; // offset 0x3C, size 0x4
    float old_speed; // offset 0x40, size 0x4
    float backup_distance; // offset 0x44, size 0x4
    class xVec3 target_pos; // offset 0x48, size 0xC
};
// total size: 0x18
class xAnimTable {
    // Members
...
// total size: 0x1C
class scan_curve_node {
    // Members
public:
    float t; // offset 0x0, size 0x4
    float scalex; // offset 0x4, size 0x4
    float scaley; // offset 0x8, size 0x4
    float scalez; // offset 0xC, size 0x4
    float intensity; // offset 0x10, size 0x4
    float glow; // offset 0x14, size 0x4
    float uvvel; // offset 0x18, size 0x4
};
// total size: 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00436170 -> 0x004365E0
*/
// Range: 0x436170 -> 0x4365E0
// this: r17
void melee_bot::prepare_render_scan() {
    /* anonymous block */ {
        // Range: 0x436170 -> 0x4365E0
        class xMat4x3 & mat; // r2
        class xVec3 offset; // r29+0x30
        class xVec3 & scale; // r2
        class RpAtomic * laser_atomic; // r2
        class xSphere & laser_sphere; // r9
        class xSphere & laser_wsphere; // r2
        class RpAtomic * volume_atomic; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004365E0 -> 0x00436C84
*/
// Range: 0x4365E0 -> 0x436C84
// this: r16
void melee_bot::update_scan(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4365E0 -> 0x436C84
        float intensity; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00436C90 -> 0x00436E70
*/
// Range: 0x436C90 -> 0x436E70
// this: r16
void melee_bot::activate_scan() {
    /* anonymous block */ {
        // Range: 0x436C90 -> 0x436E70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00436E70 -> 0x004371B8
*/
// Range: 0x436E70 -> 0x4371B8
// this: r17
void melee_bot::anim_blades(class xQuat & quat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x436E70 -> 0x4371B8
        float spin_vel; // r8
        float t; // r29+0x30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004371C0 -> 0x004372F8
*/
// Range: 0x4371C0 -> 0x4372F8
// this: r17
void melee_bot::emit_dust(float force /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4371C0 -> 0x4372F8
        class xVec3 & center; // r16
        class xVec3 cam_offset; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437300 -> 0x004373B8
*/
// Range: 0x437300 -> 0x4373B8
// this: r2
void melee_bot::refresh_models() {
    /* anonymous block */ {
        // Range: 0x437300 -> 0x4373B8
        class xModelInstance * m; // r10
        signed int i; // r9
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004373C0 -> 0x0043753C
*/
// Range: 0x4373C0 -> 0x43753C
void create_flat_laser_atomic(class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4373C0 -> 0x43753C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437540 -> 0x004375CC
*/
// Range: 0x437540 -> 0x4375CC
void reset_fx() {
    /* anonymous block */ {
        // Range: 0x437540 -> 0x4375CC
        class fx_context * fx; // r5
        class fx_context * endfx; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004375D0 -> 0x004376E4
*/
// Range: 0x4375D0 -> 0x4376E4
void create_fx(class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4375D0 -> 0x4376E4
        class fx_context * fx; // r17
        class fx_context * endfx; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437710 -> 0x00437820
*/
// Range: 0x437710 -> 0x437820
// this: r16
void melee_bot::render_with_simple_shadow() {
    /* anonymous block */ {
        // Range: 0x437710 -> 0x437820
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437820 -> 0x00437A68
*/
// Range: 0x437820 -> 0x437A68
// this: r16
void melee_bot::deactivate() {
    /* anonymous block */ {
        // Range: 0x437820 -> 0x437A68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437A70 -> 0x00437CB8
*/
// Range: 0x437A70 -> 0x437CB8
// this: r16
void melee_bot::activate() {
    /* anonymous block */ {
        // Range: 0x437A70 -> 0x437CB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437CC0 -> 0x00437EFC
*/
// Range: 0x437CC0 -> 0x437EFC
// this: r16
void melee_bot::culling_changed() {
    /* anonymous block */ {
        // Range: 0x437CC0 -> 0x437EFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00437F00 -> 0x00438020
*/
// Range: 0x437F00 -> 0x438020
// this: r16
void melee_bot::render_extra() {
    /* anonymous block */ {
        // Range: 0x437F00 -> 0x438020
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438020 -> 0x0043822C
*/
// Range: 0x438020 -> 0x43822C
// this: r18
void melee_bot::render_npc() {
    /* anonymous block */ {
        // Range: 0x438020 -> 0x43822C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438230 -> 0x0043826C
*/
// Range: 0x438230 -> 0x43826C
// this: r17
void melee_bot::before_anim_matrices(class xAnimPlay * play /* r2 */, class xQuat * quat /* r16 */, class xVec3 * tran /* r2 */, signed int bone_count /* r2 */) {
    /* anonymous block */ {
        // Range: 0x438230 -> 0x43826C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438270 -> 0x0043831C
*/
// Range: 0x438270 -> 0x43831C
// this: r16
void melee_bot::scene_setup() {
    /* anonymous block */ {
        // Range: 0x438270 -> 0x43831C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438320 -> 0x004387F8
*/
// Range: 0x438320 -> 0x4387F8
// this: r16
void melee_bot::update_npc(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x438320 -> 0x4387F8
        class xVec3 knockback; // r29+0xE0
        class xSphere sphere; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438800 -> 0x00438868
*/
// Range: 0x438800 -> 0x438868
void destroy() {
    /* anonymous block */ {
        // Range: 0x438800 -> 0x438868
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438870 -> 0x00438910
*/
// Range: 0x438870 -> 0x438910
// this: r16
void melee_bot::setup() {
    /* anonymous block */ {
        // Range: 0x438870 -> 0x438910
        signed int i; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438910 -> 0x00438938
*/
// Range: 0x438910 -> 0x438938
// this: r16
void melee_bot::reset() {
    /* anonymous block */ {
        // Range: 0x438910 -> 0x438938
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438940 -> 0x00438CF8
*/
// Range: 0x438940 -> 0x438CF8
// this: r16
melee_bot::melee_bot() {
    /* anonymous block */ {
        // Range: 0x438940 -> 0x438CF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438D00 -> 0x00438EBC
*/
// Range: 0x438D00 -> 0x438EBC
// this: r18
unsigned char melee_bot::grabbable(enum GrabType grabType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x438D00 -> 0x438EBC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438EC0 -> 0x00438EC8
*/
// Range: 0x438EC0 -> 0x438EC8
void type_reset() {
    /* anonymous block */ {
        // Range: 0x438EC0 -> 0x438EC8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438ED0 -> 0x00438ED8
*/
// Range: 0x438ED0 -> 0x438ED8
void type_setup() {
    /* anonymous block */ {
        // Range: 0x438ED0 -> 0x438ED8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438EE0 -> 0x00438EF0
*/
// Range: 0x438EE0 -> 0x438EF0
void type_scene_enter() {
    /* anonymous block */ {
        // Range: 0x438EE0 -> 0x438EF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438EF0 -> 0x00438F70
*/
// Range: 0x438EF0 -> 0x438F70
// this: r16
void pickup_react::setup() {
    /* anonymous block */ {
        // Range: 0x438EF0 -> 0x438F70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438F70 -> 0x00438F78
*/
// Range: 0x438F70 -> 0x438F78
// this: r2
void pickup_react::reset() {
    /* anonymous block */ {
        // Range: 0x438F70 -> 0x438F78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438F80 -> 0x00438FEC
*/
// Range: 0x438F80 -> 0x438FEC
// this: r2
void pickup_react::update(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x438F80 -> 0x438FEC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00438FF0 -> 0x00439014
*/
// Range: 0x438FF0 -> 0x439014
// this: r2
unsigned char pickup_react::runnable() {
    /* anonymous block */ {
        // Range: 0x438FF0 -> 0x439014
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439020 -> 0x00439030
*/
// Range: 0x439020 -> 0x439030
// this: r2
void pickup_react::exit_state() {
    /* anonymous block */ {
        // Range: 0x439020 -> 0x439030
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439030 -> 0x0043920C
*/
// Range: 0x439030 -> 0x43920C
// this: r17
void pickup_react::enter_state() {
    /* anonymous block */ {
        // Range: 0x439030 -> 0x43920C
        class xVec3 & owner_pos; // r16
        float time; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439210 -> 0x0043926C
*/
// Range: 0x439210 -> 0x43926C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439270 -> 0x00439314
*/
// Range: 0x439270 -> 0x439314
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439320 -> 0x00439390
*/
// Range: 0x439320 -> 0x439390
// this: r16
void melee_charge::setup() {
    /* anonymous block */ {
        // Range: 0x439320 -> 0x439390
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439390 -> 0x00439414
*/
// Range: 0x439390 -> 0x439414
// this: r16
void melee_charge::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x439390 -> 0x439414
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439420 -> 0x0043945C
*/
// Range: 0x439420 -> 0x43945C
// this: r16
void melee_charge::exit_state() {
    /* anonymous block */ {
        // Range: 0x439420 -> 0x43945C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439460 -> 0x0043954C
*/
// Range: 0x439460 -> 0x43954C
// this: r17
void melee_charge::enter_state(class behavior_implementation * prev_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x439460 -> 0x43954C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439550 -> 0x00439714
*/
// Range: 0x439550 -> 0x439714
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00439890 -> 0x004399F0
*/
// Range: 0x439890 -> 0x4399F0
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x439890 -> 0x4399F0
    }
