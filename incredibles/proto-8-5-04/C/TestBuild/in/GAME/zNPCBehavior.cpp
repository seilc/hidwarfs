/*
    Compile unit: C:\TestBuild\in\GAME\zNPCBehavior.cpp
...
signed int system_id; // size: 0x4, address: 0x60791C
float rot_delta; // size: 0x4, address: 0x607920
float life; // size: 0x4, address: 0x607924
float fade_start; // size: 0x4, address: 0x607928
float size; // size: 0x4, address: 0x60792C
float speed; // size: 0x4, address: 0x607930
signed int number; // size: 0x4, address: 0x607934
float gravity; // size: 0x4, address: 0x607938
unsigned char need_setup; // size: 0x1, address: 0x60793C
class xColor_tag color; // size: 0x4, address: 0x607940
// total size: 0x7C
struct /* @anon0 */ {} zNPC::approach::__vtable; // size: 0x7C, address: 0x0
...
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x213AA0
...
// total size: 0x88
struct /* @anon1 */ {} zNPC::follow_movepoints::__vtable; // size: 0x88, address: 0x5FD810
// total size: 0x7C
struct /* @anon3 */ {} zNPC::take_damage::__vtable; // size: 0x7C, address: 0x5FD8A0
// total size: 0x7C
struct /* @anon2 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x38
class approach : public behavior_implementation {
    // Members
public:
    class xVec3 * target; // offset 0x10, size 0x4
    class xVec3 heading; // offset 0x14, size 0xC
    class xMovePoint * movepoint; // offset 0x20, size 0x4
    class xMovePoint * next_movepoint; // offset 0x24, size 0x4
    class xSpline3 * spline; // offset 0x28, size 0x4
    enum /* @enum */ {
        FORWARD = 0,
        BACKWARD = 1,
    } direction; // offset 0x2C, size 0x4
    float u; // offset 0x30, size 0x4
    float speed; // offset 0x34, size 0x4
};
// total size: 0x34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00211760 -> 0x002117CC
*/
// Range: 0x211760 -> 0x2117CC
// this: r2
unsigned char follow_movepoints::system_event(unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x211760 -> 0x2117CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002117D0 -> 0x00211824
*/
// Range: 0x2117D0 -> 0x211824
// this: r16
unsigned char follow_movepoints::runnable() {
    /* anonymous block */ {
        // Range: 0x2117D0 -> 0x211824
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00211830 -> 0x00211FCC
*/
// Range: 0x211830 -> 0x211FCC
// this: r16
void follow_movepoints::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x211830 -> 0x211FCC
        class xVec3 direction; // r29+0x1B0
        class xMat3x3 target_orientation_mat; // r29+0x80
        class xQuat target_orientation; // r29+0x70
        class xQuat orientation; // r29+0x60
        class xVec3 diff; // r29+0x1A0
        float target_bank; // r29+0x1BC
        class xMat3x3 bank_mat; // r29+0x30
        float use_speed; // r29+0x1C0
        class xVec3 target_velocity; // r29+0x190
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00211FD0 -> 0x002121E4
*/
// Range: 0x211FD0 -> 0x2121E4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002121F0 -> 0x00212200
*/
// Range: 0x2121F0 -> 0x212200
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00212200 -> 0x0021224C
*/
// Range: 0x212200 -> 0x21224C
// this: r2
void follow_movepoints::set_speed(float new_speed /* r29 */) {
    /* anonymous block */ {
        // Range: 0x212200 -> 0x21224C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00212250 -> 0x00212864
*/
// Range: 0x212250 -> 0x212864
// this: r17
void follow_movepoints::get_orientation(class xMat3x3 * mat /* r16 */, float distance /* r20 */) {
    /* anonymous block */ {
        // Range: 0x212250 -> 0x212864
        class xQuat orient; // r29+0xA0
        class xQuat orient1; // r29+0x90
        class xQuat orient2; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00212870 -> 0x00213094
*/
// Range: 0x212870 -> 0x213094
// this: r17
class xQuat follow_movepoints::calc_orientation(class xVec3 & direction /* r16 */, float force /* r20 */) {
    /* anonymous block */ {
        // Range: 0x212870 -> 0x213094
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002130A0 -> 0x002131C0
*/
// Range: 0x2130A0 -> 0x2131C0
// this: r2
class xQuat follow_movepoints::calc_orientation(class xVec3 & current /* r2 */, class xVec3 & next /* r2 */, float force /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x2130A0 -> 0x2131C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002131C0 -> 0x00213354
*/
// Range: 0x2131C0 -> 0x213354
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213360 -> 0x00213484
*/
// Range: 0x213360 -> 0x213484
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213490 -> 0x0021349C
*/
// Range: 0x213490 -> 0x21349C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002134A0 -> 0x002135C4
*/
// Range: 0x2134A0 -> 0x2135C4
// this: r2
unsigned char take_damage::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2134A0 -> 0x2135C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002135D0 -> 0x00213620
*/
// Range: 0x2135D0 -> 0x213620
// this: r16
unsigned char take_damage::runnable(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x2135D0 -> 0x213620
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213620 -> 0x00213628
*/
// Range: 0x213620 -> 0x213628
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213630 -> 0x0021365C
*/
// Range: 0x213630 -> 0x21365C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213660 -> 0x00213AA0
*/
// Range: 0x213660 -> 0x213AA0
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213AA0 -> 0x00213EF8
*/
// Range: 0x213AA0 -> 0x213EF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213F00 -> 0x00213F5C
*/
// Range: 0x213F00 -> 0x213F5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213F60 -> 0x00213FD4
*/
// Range: 0x213F60 -> 0x213FD4
void setup_teeth() {
    /* anonymous block */ {
        // Range: 0x213F60 -> 0x213FD4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213FE0 -> 0x00213FE8
*/
// Range: 0x213FE0 -> 0x213FE8
// this: r2
void move::reset() {
    /* anonymous block */ {
        // Range: 0x213FE0 -> 0x213FE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00213FF0 -> 0x00214084
*/
// Range: 0x213FF0 -> 0x214084
// this: r16
void move::setup() {
    /* anonymous block */ {
        // Range: 0x213FF0 -> 0x214084
        float turn_speed_degrees; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00214090 -> 0x002140AC
*/
// Range: 0x214090 -> 0x2140AC
// this: r2
void move::stop() {
    /* anonymous block */ {
        // Range: 0x214090 -> 0x2140AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002140B0 -> 0x00214300
*/
// Range: 0x2140B0 -> 0x214300
// this: r2
void move::accelerate(float dt /* r29+0x40 */, class xVec3 & direction /* r2 */, unsigned char change_anim_speed /* r2 */, float move_speed /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x2140B0 -> 0x214300
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00214300 -> 0x00214420
*/
// Range: 0x214300 -> 0x214420
// this: r16
float move::turn_to_face(class xVec3 * direction /* r2 */, float dt /* r22 */, float turning_speed /* r21 */) {
    /* anonymous block */ {
        // Range: 0x214300 -> 0x214420
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00214420 -> 0x00214478
*/
// Range: 0x214420 -> 0x214478
// this: r16
void move::turn(float angle_difference /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x214420 -> 0x214478
        class xMat3x3 drot; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00214480 -> 0x002144E8
*/
// Range: 0x214480 -> 0x2144E8
// this: r16
float move::get_angle_difference(class xVec3 * direction /* r2 */) {
    /* anonymous block */ {
        // Range: 0x214480 -> 0x2144E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002144F0 -> 0x00214638
*/
// Range: 0x2144F0 -> 0x214638
// this: r16
float move::face_player(float dt /* r22 */, float turning_speed /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2144F0 -> 0x214638
        class xVec3 direction_to_player; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00214640 -> 0x002146FC
*/
// Range: 0x214640 -> 0x2146FC
// this: r2
unsigned char move::is_facing_player(float min_facing_cos /* r20 */) {
    /* anonymous block */ {
        // Range: 0x214640 -> 0x2146FC
        class xVec2 at; // r29+0x38
    }
}
