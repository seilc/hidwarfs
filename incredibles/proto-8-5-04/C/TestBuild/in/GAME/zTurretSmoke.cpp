/*
    Compile unit: C:\TestBuild\in\GAME\zTurretSmoke.cpp
...
class RwTexture * texture; // size: 0x4, address: 0x60963C
static class xColor_tag turretSmokeColor; // size: 0x4, address: 0x5FBC18
// total size: 0x20
struct /* @anon0 */ {} zTurretSmokeSystem::__vtable; // size: 0x20, address: 0x6067E0
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
// total size: 0x20
struct /* @anon1 */ {} z::lightweight<zTurretSmokeSystem, 10>::__vtable; // size: 0x20, address: 0x606800
signed int Update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x471990
// total size: 0x14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471E20 -> 0x004722E0
*/
// Range: 0x471E20 -> 0x4722E0
// this: r16
void zTurretSmokeSystem::update(float dt /* r29+0xD0 */) {
    /* anonymous block */ {
        // Range: 0x471E20 -> 0x4722E0
        float timePassed; // r20
        signed int emit; // r21
        class TurretSmokeParticle * p; // r29+0xCC
        signed int count; // r2
        class TurretSmokeParticle * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004722E0 -> 0x00472304
*/
// Range: 0x4722E0 -> 0x472304
// this: r2
zTurretSmokeSystem::zTurretSmokeSystem() {
    /* anonymous block */ {
        // Range: 0x4722E0 -> 0x472304
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00472310 -> 0x00472430
*/
// Range: 0x472310 -> 0x472430
// this: r18
zTurretSmokeSystem::zTurretSmokeSystem(class xVec3 & pos /* r17 */, class xVec3 & dir /* r16 */) {
    /* anonymous block */ {
        // Range: 0x472310 -> 0x472430
        class xParticleBatchSystem system; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00472430 -> 0x00472438
*/
// Range: 0x472430 -> 0x472438
void setup() {
    /* anonymous block */ {
        // Range: 0x472430 -> 0x472438
    }
