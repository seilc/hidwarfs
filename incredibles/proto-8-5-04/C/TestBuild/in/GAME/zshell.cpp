/*
    Compile unit: C:\TestBuild\in\GAME\zshell.cpp
...
// total size: 0x20
struct /* @anon1 */ {} z::shell::__vtable; // size: 0x20, address: 0x602350
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<z::shell, 15>::__vtable; // size: 0x20, address: 0x602370
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CFC60 -> 0x002CFDC8
*/
// Range: 0x2CFC60 -> 0x2CFDC8
// this: r18
shell::shell(class xVec3 & position /* r2 */, class xVec3 & velocity /* r2 */, class xEnt * owner /* r2 */, float gravity_speed /* r29+0x40 */, class shell_type * type /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CFC60 -> 0x2CFDC8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CFDD0 -> 0x002CFFE8
*/
// Range: 0x2CFDD0 -> 0x2CFFE8
// this: r2
void shell::render() {
    /* anonymous block */ {
        // Range: 0x2CFDD0 -> 0x2CFFE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CFFF0 -> 0x002D0560
*/
// Range: 0x2CFFF0 -> 0x2D0560
// this: r16
void shell::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2CFFF0 -> 0x2D0560
        class xSweptSphere sws; // r29+0x50
        class xVec3 end; // r29+0x230
        signed int rc; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D0560 -> 0x002D0588
*/
// Range: 0x2D0560 -> 0x2D0588
// this: r2
void shell::destroy() {
    /* anonymous block */ {
        // Range: 0x2D0560 -> 0x2D0588
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D0590 -> 0x002D0598
*/
// Range: 0x2D0590 -> 0x2D0598
void setup() {
    /* anonymous block */ {
        // Range: 0x2D0590 -> 0x2D0598
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D05A0 -> 0x002D0810
*/
// Range: 0x2D05A0 -> 0x2D0810
class shell_type * create(char * model_name /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D05A0 -> 0x2D0810
        class shell_type * type; // r16
        unsigned int modelID; // r18
        unsigned short parameters_size; // r29+0x5E
        class xModelAssetParam * parameters; // r17
        char * shrapnel_name; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D0810 -> 0x002D0830
*/
// Range: 0x2D0810 -> 0x2D0830
void free_model(class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0810 -> 0x2D0830
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002D0830 -> 0x002D091C
*/
// Range: 0x2D0830 -> 0x2D091C
class xModelInstance * get_model(char * model_name /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2D0830 -> 0x2D091C
        unsigned int modelID; // r16
    }
}
