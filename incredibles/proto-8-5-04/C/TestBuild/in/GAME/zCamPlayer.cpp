/*
    Compile unit: C:\TestBuild\in\GAME\zCamPlayer.cpp
...
// total size: 0x24
struct /* @anon0 */ {} zCamPlayer::__vtable; // size: 0x24, address: 0x601440
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B5560 -> 0x002B5744
*/
// Range: 0x2B5560 -> 0x2B5744
// this: r16
void zCamPlayer::collide_compress() {
    /* anonymous block */ {
        // Range: 0x2B5560 -> 0x2B5744
        class xVec3 mount_origin; // r29+0x30
        float ddist; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B5750 -> 0x002B59AC
*/
// Range: 0x2B5750 -> 0x2B59AC
// this: r16
void zCamPlayer::collide_pivot() {
    /* anonymous block */ {
        // Range: 0x2B5750 -> 0x2B59AC
        float old_phi; // r20
        class xVec3 mount_origin; // r29+0x38
        float dphi; // r29+0x4C
        float rest_to_input_phi; // r29+0x48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B59B0 -> 0x002B5E00
*/
// Range: 0x2B59B0 -> 0x2B5E00
// this: r16
void zCamPlayer::update_pitch(float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x2B59B0 -> 0x2B5E00
        float goal_pitch_rest; // r24
        float goal_pitch_clamp0; // r23
        float dx; // r29+0x70
        float dz; // r29+0x70
        float target_height; // r29+0x70
        float look_diff; // r29+0x70
        float goal_pitch_clamp1; // r2
        float pitch_clamp_center; // r29+0x70
        float pitch_min; // r22
        float pitch_max; // r21
        class xVec3 mount_origin; // r29+0x58
        class xVec3 offset; // r29+0x48
        float pitch; // r29+0x70
        float goal_pitch_clamp; // r29+0x6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B5E00 -> 0x002B6038
*/
// Range: 0x2B5E00 -> 0x2B6038
// this: r16
void zCamPlayer::update_restoration(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B5E00 -> 0x2B6038
        float drest_phi; // r29+0x6C
        float max_dphi; // r29+0x68
        float dphi; // r29+0x64
        class xVec3 mount_origin; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B6040 -> 0x002B6404
*/
// Range: 0x2B6040 -> 0x2B6404
// this: r16
void zCamPlayer::update_aggression(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B6040 -> 0x2B6404
        float opt_dtheta; // r29+0x6C
        float min_dtheta; // r29+0x68
        float dtheta; // r29+0x64
        class xVec3 mount_origin; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B6410 -> 0x002B69A8
*/
// Range: 0x2B6410 -> 0x2B69A8
// this: r16
void zCamPlayer::update_secondary_clamping(float dt /* r29+0x58 */) {
    /* anonymous block */ {
        // Range: 0x2B6410 -> 0x2B69A8
        unsigned char have_secondary; // r2
        class xEnt * ent; // r2
        class xVec3 * center; // r6
        float radius; // r26
        float margin_angle; // r29+0x54
        float Ax; // r29+0x60
        float Az; // r29+0x60
        float Bx; // r25
        float Bz; // r24
        ...
        float CAx; // r29+0x60
        float CAz; // r29+0x60
        float Vscale; // r29+0x60
        float Vx; // r29+0x60
        float Vz; // r29+0x60
        float yaw_start; // r21
        float yaw_end; // r29+0x60
        float dyaw1; // r27
        float dyaw2; // r20
        float max_dyaw; // r29+0x60
        float dtheta; // r2
        float CBx; // r29+0x60
        float CBz; // r29+0x60
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B69B0 -> 0x002B6CEC
*/
// Range: 0x2B69B0 -> 0x2B6CEC
// this: r16
void zCamPlayer::update_input_theta(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B69B0 -> 0x2B6CEC
        class xVec3 & dir; // r2
        float stickx; // r29+0x70
        float max_vel_theta; // r29+0x6C
        class xVec3 mount_origin; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B6CF0 -> 0x002B6E74
*/
// Range: 0x2B6CF0 -> 0x2B6E74
// this: r2
void zCamPlayer::update_zone_dist(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x2B6CF0 -> 0x2B6E74
        float dist_away; // r29+0xC
        float ddist; // r29+0x8
        float rest_to_goal; // r29+0x4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B6E80 -> 0x002B6FA0
*/
// Range: 0x2B6E80 -> 0x2B6FA0
// this: r16
void zCamPlayer::update_zone(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B6E80 -> 0x2B6FA0
        float goal_yaw_offset; // r29+0x3C
        float goal_pitch_offset; // r29+0x38
        float t; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B6FA0 -> 0x002B7440
*/
// Range: 0x2B6FA0 -> 0x2B7440
// this: r16
void zCamPlayer::update_drift() {
    /* anonymous block */ {
        // Range: 0x2B6FA0 -> 0x2B7440
        class xVec3 origin; // r29+0x70
        class xVec3 drift_loc; // r29+0x60
        float dist; // r25
        float phi; // r24
        float ddist; // r29+0x8C
        float max_ddist; // r29+0x88
        float max_dphi; // r29+0x84
        float dphi; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B7440 -> 0x002B760C
*/
// Range: 0x2B7440 -> 0x2B760C
// this: r16
void zCamPlayer::update_mount(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2B7440 -> 0x2B760C
        float prev_mount_height; // r20
        float dmount; // r29+0x3C
        float dfloor; // r29+0x38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B7610 -> 0x002B7BC0
*/
// Range: 0x2B7610 -> 0x2B7BC0
// this: r16
void zCamPlayer::update_target(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2B7610 -> 0x2B7BC0
        class xVec3 & player_loc; // r2
        float xzvel2; // r29+0x40
        float xzscale; // r29+0x40
        class xVec3 old_target_loc; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B7BC0 -> 0x002B7E0C
*/
// Range: 0x2B7BC0 -> 0x2B7E0C
// this: r16
void zCamPlayer::reset_basis() {
    /* anonymous block */ {
        // Range: 0x2B7BC0 -> 0x2B7E0C
        class xVec3 mount_origin; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B7E10 -> 0x002B8604
*/
// Range: 0x2B7E10 -> 0x2B8604
// this: r17
void zCamPlayer::snap_reset(class xMat4x3 & mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2B7E10 -> 0x2B8604
        class rest_config restore_cfg; // r29+0x40
        class xVec3 mount_origin; // r29+0x70
        float start_phi; // r22
        class xVec3 start_euler; // r29+0x60
        float start_pitch_offset; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8610 -> 0x002B8648
*/
// Range: 0x2B8610 -> 0x2B8648
// this: r2
void zCamPlayer::set_secondary_target(class xVec3 & center /* r2 */, float radius /* r29 */, float margin_angle /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2B8610 -> 0x2B8648
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8650 -> 0x002B8670
*/
// Range: 0x2B8650 -> 0x2B8670
// this: r2
void zCamPlayer::set_secondary_target(class xEnt & ent /* r2 */, float radius /* r29 */, float margin_angle /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2B8650 -> 0x2B8670
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8670 -> 0x002B8738
*/
// Range: 0x2B8670 -> 0x2B8738
// this: r2
void zCamPlayer::snap_to(class xMat4x3 & mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B8670 -> 0x2B8738
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8740 -> 0x002B874C
*/
// Range: 0x2B8740 -> 0x2B874C
// this: r2
void zCamPlayer::set_pitch_offset(float pitch_offset /* r29 */, float blend_speed /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2B8740 -> 0x2B874C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8750 -> 0x002B87C0
*/
// Range: 0x2B8750 -> 0x2B87C0
// this: r2
void zCamPlayer::set_rest_dist(float dist /* r29 */, unsigned char lazy /* r2 */, float blend_time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2B8750 -> 0x2B87C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B87C0 -> 0x002B8880
*/
// Range: 0x2B87C0 -> 0x2B8880
// this: r2
void zCamPlayer::set_rest(class rest_config & cfg /* r2 */, unsigned char lazy /* r2 */, float blend_time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2B87C0 -> 0x2B8880
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8880 -> 0x002B8890
*/
// Range: 0x2B8880 -> 0x2B8890
float get_rest_dist_default() {
    /* anonymous block */ {
        // Range: 0x2B8880 -> 0x2B8890
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B8890 -> 0x002B9134
*/
// Range: 0x2B8890 -> 0x2B9134
// this: r16
void zCamPlayer::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2B8890 -> 0x2B9134
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B9140 -> 0x002B94A4
*/
// Range: 0x2B9140 -> 0x2B94A4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B94B0 -> 0x002B9570
*/
// Range: 0x2B94B0 -> 0x2B9570
// this: r16
