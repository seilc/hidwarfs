/*
    Compile unit: C:\TestBuild\in\GAME\zMovePoint.cpp
...
static class zMovePoint * g_mvpt_list; // size: 0x4, address: 0x608778
static signed int g_mvpt_cnt; // size: 0x4, address: 0x60877C
...
void zMovePointEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1405C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001405B0 -> 0x001405B8
*/
// Range: 0x1405B0 -> 0x1405B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001405C0 -> 0x00140620
*/
// Range: 0x1405C0 -> 0x140620
void zMovePointEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1405C0 -> 0x140620
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140620 -> 0x00140628
*/
// Range: 0x140620 -> 0x140628
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140630 -> 0x00140638
*/
// Range: 0x140630 -> 0x140638
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140640 -> 0x00140648
*/
// Range: 0x140640 -> 0x140648
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140650 -> 0x00140668
*/
// Range: 0x140650 -> 0x140668
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140670 -> 0x001406D4
*/
// Range: 0x140670 -> 0x1406D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001406E0 -> 0x00140740
*/
// Range: 0x1406E0 -> 0x140740
class zMovePoint * zMovePoint_GetMemPool(signed int cnt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1406E0 -> 0x140740
        class zMovePoint * g_mvpt_list'39; // r2
    }
}
