/*
    Compile unit: C:\TestBuild\in\GAME\zGrapple.cpp
...
static class zGrapplePoint * sGrapplePoints; // size: 0x4, address: 0x608F18
static signed int sNumGrapplePoints; // size: 0x4, address: 0x608F1C
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void zGrapple_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2A9030
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A8EE0 -> 0x002A8FF4
*/
// Range: 0x2A8EE0 -> 0x2A8FF4
void zGrapple_GetPosition(class zGrapplePoint * point /* r2 */, class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A8EE0 -> 0x2A8FF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9000 -> 0x002A9018
*/
// Range: 0x2A9000 -> 0x2A9018
class zGrapplePoint * zGrapple_GetGrapplePoint(signed int i /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A9000 -> 0x2A9018
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9020 -> 0x002A9028
*/
// Range: 0x2A9020 -> 0x2A9028
signed int zGrapple_NumGrapplePoints() {
    /* anonymous block */ {
        // Range: 0x2A9020 -> 0x2A9028
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9030 -> 0x002A9074
*/
// Range: 0x2A9030 -> 0x2A9074
void zGrapple_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A9030 -> 0x2A9074
        class zGrapple * grap; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9080 -> 0x002A90C8
*/
// Range: 0x2A9080 -> 0x2A90C8
void zGrapple_Reset() {
    /* anonymous block */ {
        // Range: 0x2A9080 -> 0x2A90C8
        signed int i; // r6
        class zGrapple * grapple; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A90D0 -> 0x002A9218
*/
// Range: 0x2A90D0 -> 0x2A9218
void zGrapple_SceneInit(class zScene * zsc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A90D0 -> 0x2A9218
        signed int i; // r20
        signed int count; // r2
        signed int numGrapples; // r19
        class zGrapple * grapple; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A9220 -> 0x002A939C
*/
// Range: 0x2A9220 -> 0x2A939C
signed int zGrapple_Recurse(unsigned int id /* r16 */, class zGrapplePoint * gpList /* r21 */, class zGrapple * grapple /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2A9220 -> 0x2A939C
        unsigned int i; // r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A93A0 -> 0x002A93F8
*/
// Range: 0x2A93A0 -> 0x2A93F8
void zGrapple_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A93A0 -> 0x2A93F8
    }
}
