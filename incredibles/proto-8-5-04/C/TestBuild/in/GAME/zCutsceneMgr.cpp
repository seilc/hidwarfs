/*
    Compile unit: C:\TestBuild\in\GAME\zCutsceneMgr.cpp
...
unsigned int demoDisableHackTable[6]; // size: 0x18, address: 0x504E50
class zCutsceneHack cutsceneHackTable[5]; // size: 0x30C, address: 0x504E70
static signed int gCutsceneSkipOK; // size: 0x4, address: 0x60859C
static unsigned char ents_hidden; // size: 0x1, address: 0x6085A0
...
class RpAtomic * AtomicDefaultRenderCallBack(class RpAtomic *); // size: 0x0, address: 0x3F69E8
class RpAtomic * NextAtomicCallback(class RpAtomic *, void *); // size: 0x0, address: 0x128AF0
void zCutsceneMgrEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x128640
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128040 -> 0x0012819C
*/
// Range: 0x128040 -> 0x12819C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001281A0 -> 0x001284FC
*/
// Range: 0x1281A0 -> 0x1284FC
void zCutsceneMgrUpdate(class xBase * to /* r17 */, class xScene * sc /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        ...
        signed int doCineFX; // @ 0x006085A4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128500 -> 0x00128634
*/
// Range: 0x128500 -> 0x128634
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128640 -> 0x0012888C
*/
// Range: 0x128640 -> 0x12888C
void zCutsceneMgrEventCB(class xBase * to /* r17 */, unsigned int toEvent /* r2 */, float * toParam /* r16 */) {
    /* anonymous block */ {
        // Range: 0x128640 -> 0x12888C
        class zCutsceneMgr * t; // r2
        unsigned char disableCutscene; // r8
        unsigned int i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128890 -> 0x00128AE8
*/
// Range: 0x128890 -> 0x128AE8
static void zCutsceneMgrPlayStart(class zCutsceneMgr * t /* r16 */) {
    /* anonymous block */ {
        ...
        unsigned char hacked; // r3
        unsigned int counter; // r22
        class RpAtomic * tmpModel; // r3
        class RpClump * clump; // r2
        class RpAtomic * nextModel; // r29+0xAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128AF0 -> 0x00128B20
*/
// Range: 0x128AF0 -> 0x128B20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128B20 -> 0x00128B28
*/
// Range: 0x128B20 -> 0x128B28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128B30 -> 0x00128B38
*/
// Range: 0x128B30 -> 0x128B38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128B40 -> 0x00128BB0
*/
// Range: 0x128B40 -> 0x128BB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128BB0 -> 0x00128BD4
*/
// Range: 0x128BB0 -> 0x128BD4
class zCutsceneHack & zCutsceneMgrGetHackTableDataByIdx(signed int idx /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128BB0 -> 0x128BD4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128BE0 -> 0x00128BE8
*/
// Range: 0x128BE0 -> 0x128BE8
signed int zCutsceneMgrGetHackTableSize() {
    /* anonymous block */ {
        // Range: 0x128BE0 -> 0x128BE8
    }
}
