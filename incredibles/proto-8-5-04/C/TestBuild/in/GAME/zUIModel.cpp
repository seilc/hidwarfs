/*
    Compile unit: C:\TestBuild\in\GAME\zUIModel.cpp
...
// total size: 0x50
struct /* @anon1 */ {} zUIModel::__vtable; // size: 0x50, address: 0x6013A0
// total size: 0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AB990 -> 0x002AB9A8
*/
// Range: 0x2AB990 -> 0x2AB9A8
void zUIModel_Init(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2AB990 -> 0x2AB9A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AB9B0 -> 0x002ABA8C
*/
// Range: 0x2AB9B0 -> 0x2ABA8C
// this: r16
void zUIModel::DoHandleEvent(class xBase * from /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2AB9B0 -> 0x2ABA8C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABA90 -> 0x002ABAD0
*/
// Range: 0x2ABA90 -> 0x2ABAD0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABAD0 -> 0x002ABB1C
*/
// Range: 0x2ABAD0 -> 0x2ABB1C
// this: r16
void zUIModel::DoUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2ABAD0 -> 0x2ABB1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABB20 -> 0x002ABD3C
*/
// Range: 0x2ABB20 -> 0x2ABD3C
// this: r17
void zUIModel::DoRender() {
    /* anonymous block */ {
        ...
        unsigned int destblend; // r18
        class xVec3 to; // @ 0x00686AC0
        class xVec3 from; // @ 0x0050DEB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABD40 -> 0x002ABD48
*/
// Range: 0x2ABD40 -> 0x2ABD48
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABD50 -> 0x002ABF00
*/
// Range: 0x2ABD50 -> 0x2ABF00
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ABF00 -> 0x002ABF44
*/
// Range: 0x2ABF00 -> 0x2ABF44
// this: r16
