/*
    Compile unit: C:\TestBuild\in\GAME\zWater.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static char ini_filename[10]; // size: 0xA, address: 0x5F2E60
static class motion_config * motions; // size: 0x4, address: 0x609194
static signed int motions_size; // size: 0x4, address: 0x609198
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void stay_hidden_dammit(class xEnt *); // size: 0x0, address: 0x33BDB0
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x33A470
...
public:
    ...
    unsigned int hash_id; // offset 0x40, size 0x4
    signed int motion_type; // offset 0x44, size 0x4
    float lod_dist_min; // offset 0x48, size 0x4
    float lod_dist_interval; // offset 0x4C, size 0x4
    signed int shimmer; // offset 0x50, size 0x4
    signed int refract_glow; // offset 0x54, size 0x4
    unsigned int random_seed; // offset 0x58, size 0x4
    float amplitude_min; // offset 0x5C, size 0x4
    float gravity; // offset 0x60, size 0x4
    float wind_speed; // offset 0x64, size 0x4
    float wind_dir; // offset 0x68, size 0x4
    float scale_amplitude; // offset 0x6C, size 0x4
    float scale_speed; // offset 0x70, size 0x4
    float scale_wave_length; // offset 0x74, size 0x4
    // total size: 0x38
    class /* @class */ {
        // Members
    public:
        float color_mul_red; // offset 0x0, size 0x4
        float color_mul_green; // offset 0x4, size 0x4
        float color_mul_blue; // offset 0x8, size 0x4
        float light_ambient; // offset 0xC, size 0x4
        float light_diffuse; // offset 0x10, size 0x4
        float light_transmissive; // offset 0x14, size 0x4
        float reflectance_min; // offset 0x18, size 0x4
        float reflect_intensity; // offset 0x1C, size 0x4
        float reflect_magnitude; // offset 0x20, size 0x4
        float refract_min; // offset 0x24, size 0x4
        float refract_max; // offset 0x28, size 0x4
        float refract_dist_min; // offset 0x2C, size 0x4
        float refract_dist_max; // offset 0x30, size 0x4
        float refract_ymax; // offset 0x34, size 0x4
    } shading; // offset 0x78, size 0x38
};
// total size: 0x0
class xFFX {};
// total size: 0x18
...
class zWaterBody : private xBase {
    // Members
public:
    signed int motion_type; // offset 0x10, size 0x4
    class asset_type * asset; // offset 0x14, size 0x4
    class xEnt * body_ent; // offset 0x18, size 0x4
    class xEnt * * refract_ents; // offset 0x1C, size 0x4
    signed int refract_ents_size; // offset 0x20, size 0x4
    class xEnt * * reflect_ents; // offset 0x24, size 0x4
    signed int reflect_ents_size; // offset 0x28, size 0x4
    signed int body_id; // offset 0x2C, size 0x4
...
public:
    unsigned int flags; // offset 0x10, size 0x4
    unsigned int motion_type; // offset 0x14, size 0x4
    unsigned int body; // offset 0x18, size 0x4
    unsigned int facade_refract; // offset 0x1C, size 0x4
    unsigned int facade_reflect; // offset 0x20, size 0x4
    unsigned int light_dir; // offset 0x24, size 0x4
};
enum iSndHandle {
};
...
public:
    float phase; // offset 0x0, size 0x4
    float amplitude; // offset 0x4, size 0x4
    float wave_length; // offset 0x8, size 0x4
    float speed; // offset 0xC, size 0x4
    float dir; // offset 0x10, size 0x4
};
// total size: 0x640
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A320 -> 0x0033A328
*/
// Range: 0x33A320 -> 0x33A328
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A330 -> 0x0033A460
*/
// Range: 0x33A330 -> 0x33A460
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A460 -> 0x0033A468
*/
// Range: 0x33A460 -> 0x33A468
void zWaterStartup() {
    /* anonymous block */ {
        // Range: 0x33A460 -> 0x33A468
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A470 -> 0x0033A4E0
*/
// Range: 0x33A470 -> 0x33A4E0
void cb_dispatch(class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33A470 -> 0x33A4E0
        class zWaterBody & e; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A4E0 -> 0x0033A68C
*/
// Range: 0x33A4E0 -> 0x33A68C
// this: r2
void zWaterBody::get_shading(class xWaterShading & shading /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33A4E0 -> 0x33A68C
        class motion_config & cfg; // r2
        float light_yaw; // r21
        float light_pitch; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A690 -> 0x0033A720
*/
// Range: 0x33A690 -> 0x33A720
// this: r16
class xEnt * * zWaterBody::load_ents(signed int & size /* r19 */, unsigned int id /* r2 */, char * type /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33A690 -> 0x33A720
        class xBase * base; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A720 -> 0x0033AB08
*/
// Range: 0x33A720 -> 0x33AB08
// this: r29+0x13C
class xEnt * * zWaterBody::load_ents(class xEnt * * ents /* r2 */, class xBase * base /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33A720 -> 0x33AB08
        class xGroup * group; // r2
        class xBase * * child; // r29+0x120
        class xBase * * end_child; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AB10 -> 0x0033ABD4
*/
// Range: 0x33AB10 -> 0x33ABD4
// this: r20
signed int zWaterBody::count_ents(class xBase * base /* r2 */, char * type /* r19 */, signed int depth /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33AB10 -> 0x33ABD4
        class xGroup * group; // r2
        signed int total; // r17
        class xBase * * child; // r16
        class xBase * * end_child; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033ABE0 -> 0x0033AE6C
*/
// Range: 0x33ABE0 -> 0x33AE6C
// this: r16
void zWaterBody::setup() {
    /* anonymous block */ {
        // Range: 0x33ABE0 -> 0x33AE6C
        class xWaterSettings settings; // r29+0x9C
        class xWaterShading shading; // r29+0x40
        class xWaterEnvironment env; // r29+0x30
        class xWaterTileSet * tileset; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AE70 -> 0x0033AF0C
*/
// Range: 0x33AE70 -> 0x33AF0C
void update_all() {
    /* anonymous block */ {
        // Range: 0x33AE70 -> 0x33AF0C
        class zScene & scene; // r2
        class zWaterBody * it; // r17
        class zWaterBody * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AF10 -> 0x0033B154
*/
// Range: 0x33AF10 -> 0x33B154
void reset_all() {
    /* anonymous block */ {
        // Range: 0x33AF10 -> 0x33B154
        class zScene & scene; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B160 -> 0x0033B1D4
*/
// Range: 0x33B160 -> 0x33B1D4
void setup_all() {
    /* anonymous block */ {
        // Range: 0x33B160 -> 0x33B1D4
        class zScene & scene; // r2
        class zWaterBody * it; // r16
        class zWaterBody * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B1E0 -> 0x0033B2D8
*/
// Range: 0x33B1E0 -> 0x33B2D8
void load(class xBase & data /* r17 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33B1E0 -> 0x33B2D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B2E0 -> 0x0033B534
*/
// Range: 0x33B2E0 -> 0x33B534
static void load_motion_configs() {
    /* anonymous block */ {
        // Range: 0x33B2E0 -> 0x33B534
        void * mem; // r18
        class xIniFile * ini; // r17
        class xIniSection * sections; // r23
        unsigned int memsize; // r29+0x9C
        class xIniSection * isec; // r20
        class xIniSection * end_isec; // r2
        class xIniSection * osec; // r19
        class motion_config * cfg; // r16
        class motion_config * end_cfg; // r2
        class xIniSection * sec; // r21
        class xIniValue * values; // r20
        signed int values_size; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B540 -> 0x0033BDA4
*/
// Range: 0x33B540 -> 0x33BDA4
static void load_motion_config(class motion_config & cfg /* r18 */, class xIniValue * values /* r17 */, signed int values_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33B540 -> 0x33BDA4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033BDB0 -> 0x0033BE0C
*/
// Range: 0x33BDB0 -> 0x33BE0C
static void stay_hidden_dammit(class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33BDB0 -> 0x33BE0C
    }
}
