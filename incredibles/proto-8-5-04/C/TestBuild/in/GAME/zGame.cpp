/*
    Compile unit: C:\TestBuild\in\GAME\zGame.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class basic_rect screen_bounds; // size: 0x10, address: 0x5E4750
...
static unsigned int sPlayerMarkerStartID; // size: 0x4, address: 0x6085E4
static float sGameOverTimer; // size: 0x4, address: 0x6085E8
...
static signed int g_hiphopReloadHIP; // size: 0x4, address: 0x60860C
static signed int g_hiphopForcePortal; // size: 0x4, address: 0x608610
...
static unsigned int gzAsyncSceneID; // size: 0x4, address: 0x608614
unsigned int startPressed; // size: 0x4, address: 0x607618
class xColor_tag black; // size: 0x4, address: 0x0
class xColor_tag clear; // size: 0x4, address: 0x0
unsigned int gSoak; // size: 0x4, address: 0x608618
float s_dbloop_elapsec; // size: 0x4, address: 0x60861C
static unsigned int s_dbloop_elaptick; // size: 0x4, address: 0x608620
static float s_dbloop_fps; // size: 0x4, address: 0x608624
static signed int currentLevel; // size: 0x4, address: 0x0
static char switchSceneDest[4]; // size: 0x4, address: 0x608628
static unsigned char switchScene; // size: 0x1, address: 0x60862C
char * * soaklevels; // size: 0x4, address: 0x608630
static float SOAK_DELAY; // size: 0x4, address: 0x60761C
static float SOAK_DELAYRAND; // size: 0x4, address: 0x607620
static float soaktime; // size: 0x4, address: 0x607624
static signed int enableSuperSoaker; // size: 0x4, address: 0x0
...
class xPortalAsset dummyPortalAsset; // size: 0x18, address: 0x6136C0
class _zPortal dummyPortal; // size: 0x14, address: 0x6136E0
static unsigned int loadMeter; // size: 0x4, address: 0x608634
static unsigned int loadCDMeter; // size: 0x4, address: 0x0
static signed long t0; // size: 0x4, address: 0x608650
static signed long t1; // size: 0x4, address: 0x608658
static signed long w0; // size: 0x4, address: 0x608660
static signed long w1; // size: 0x4, address: 0x608668
static signed long gloop_time; // size: 0x4, address: 0x608670
static signed long gwait_time; // size: 0x4, address: 0x608678
static signed int gloop_ct; // size: 0x4, address: 0x608680
static float gloop_time_secs; // size: 0x4, address: 0x608684
static float gwait_time_secs; // size: 0x4, address: 0x608688
static float gloop_net_time_secs; // size: 0x4, address: 0x60868C
float snd_radius; // size: 0x4, address: 0x0
unsigned int gLastProfileDump; // size: 0x4, address: 0x0
class RwCamera * sGameScreenTransCam; // size: 0x4, address: 0x6086A0
static class RpWorld * gWorld; // size: 0x4, address: 0x6086A4
static class RpLight * DirectionalLight; // size: 0x4, address: 0x6086A8
unsigned int bgID; // size: 0x4, address: 0x60762C
float bgu1; // size: 0x4, address: 0x6086AC
float bgv1; // size: 0x4, address: 0x6086B0
float bgu2; // size: 0x4, address: 0x607630
float bgv2; // size: 0x4, address: 0x607634
unsigned char bgr; // size: 0x1, address: 0x607638
unsigned char bgg; // size: 0x1, address: 0x60763C
unsigned char bgb; // size: 0x1, address: 0x607640
unsigned char bga; // size: 0x1, address: 0x607644
...
float VBLANKS_PER_SEC; // size: 0x4, address: 0x6076B8
...
unsigned int gSceneFrameCount; // size: 0x4, address: 0x6089B4
...
void RenderThread(void *); // size: 0x0, address: 0x324A70
// total size: 0x18
struct /* @anon1 */ {} zLoadingScreen::__vtable; // size: 0x18, address: 0x606820
// total size: 0x18
struct /* @anon0 */ {} zAsync::Screen::__vtable; // size: 0x18, address: 0x0
unsigned int loadSceneID; // size: 0x4, address: 0x6095E0
// total size: 0x4
class iSndVol {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132580 -> 0x00132700
*/
// Range: 0x132580 -> 0x132700
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132700 -> 0x00132708
*/
// Range: 0x132700 -> 0x132708
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132710 -> 0x001327AC
*/
// Range: 0x132710 -> 0x1327AC
void zGameInitPlayer() {
    /* anonymous block */ {
        // Range: 0x132710 -> 0x1327AC
        class xEntAsset * asset; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001327B0 -> 0x0013282C
*/
// Range: 0x1327B0 -> 0x13282C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132830 -> 0x00132F9C
*/
// Range: 0x132830 -> 0x132F9C
void zGameScreenTransitionUpdate(float percentComplete /* r21 */, char * msg /* r17 */, unsigned char * rgba /* r16 */) {
    /* anonymous block */ {
        // Range: 0x132830 -> 0x132F9C
        class RwRGBA back_col; // r29+0x25C
        class RwTexture * tex; // r2
        class RwRaster * ras; // r2
        float recipCamZ; // r20
        class RwSky2DVertex vx[4]; // r29+0x150
        float z; // r2
        char meter[256]; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132FA0 -> 0x00132FF4
*/
// Range: 0x132FA0 -> 0x132FF4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133000 -> 0x001330D0
*/
// Range: 0x133000 -> 0x1330D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001330D0 -> 0x00133624
*/
// Range: 0x1330D0 -> 0x133624
static void zGameUpdateMode() {
    /* anonymous block */ {
        // Range: 0x1330D0 -> 0x133624
        class xPortalAsset * passet; // r2
        unsigned int nextSceneID; // r17
        unsigned int sPlayerMarkerStartCamID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133630 -> 0x00133638
*/
// Range: 0x133630 -> 0x133638
void zGameStall() {
    /* anonymous block */ {
        // Range: 0x133630 -> 0x133638
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133640 -> 0x00133708
*/
// Range: 0x133640 -> 0x133708
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133710 -> 0x00133778
*/
// Range: 0x133710 -> 0x133778
void zGamePause() {
    /* anonymous block */ {
        // Range: 0x133710 -> 0x133778
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133780 -> 0x00133838
*/
// Range: 0x133780 -> 0x133838
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133840 -> 0x00133898
*/
// Range: 0x133840 -> 0x133898
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001338A0 -> 0x00134BF8
*/
// Range: 0x1338A0 -> 0x134BF8
void zGameLoop() {
    /* anonymous block */ {
        // Range: 0x1338A0 -> 0x134BF8
        signed int ostrich_delay; // r20
        class xMat4x3 playerMat; // r29+0x3B0
        unsigned int i; // r19
        char tmpStr[384]; // r29+0x230
        char * nextToken; // r29+0x42C
        char * foo; // r16
        float y; // r28
        unsigned char moviePadInsertion; // r2
        class _zPortal portal; // @ 0x00613730
        class xPortalAsset portalAsset; // @ 0x00613750
        class xfont debugStr; // @ 0x00613700
        signed char @8590; // @ 0x00608698
        signed int displayToggle; // @ 0x00608690
        float sAttractMode_timer; // @ 0x00607628
        signed char @8579; // @ 0x00608694
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134C00 -> 0x00134E44
*/
// Range: 0x134C00 -> 0x134E44
void zGameSetup() {
    /* anonymous block */ {
        // Range: 0x134C00 -> 0x134E44
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134E50 -> 0x00134ED4
*/
// Range: 0x134E50 -> 0x134ED4
void zGameExit() {
    /* anonymous block */ {
        // Range: 0x134E50 -> 0x134ED4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134EE0 -> 0x00135190
*/
// Range: 0x134EE0 -> 0x135190
void zGameInit(unsigned int theSceneID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x134EE0 -> 0x135190
        class zLoadingScreen screen; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135190 -> 0x00135470
*/
// Range: 0x135190 -> 0x135470
static unsigned int PickNextSoak() {
    /* anonymous block */ {
        // Range: 0x135190 -> 0x135470
        signed int soakidx'138; // r2
        unsigned int nextsoak; // r2
        char * name; // r2
        unsigned int tag; // r4
        signed int num_search; // r18
        char useme[5]; // r29+0x48
        enum en_SOAK_DIR soakdir; // @ 0x00608640
        signed int soakidx; // @ 0x00608638
        signed int justwrap; // @ 0x00608644
        signed int soakcnt; // @ 0x0060863C
        unsigned int sumtotal; // @ 0x00608648
    }
}
