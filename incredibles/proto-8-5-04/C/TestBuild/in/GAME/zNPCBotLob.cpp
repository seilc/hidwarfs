/*
    Compile unit: C:\TestBuild\in\GAME\zNPCBotLob.cpp
...
class shell_type * proj_type; // size: 0x4, address: 0x60920C
class lightweight_system * system; // size: 0x4, address: 0x609210
// total size: 0xB4
struct /* @anon8 */ {} zNPC::bot_lob_water::__vtable; // size: 0xB4, address: 0x604920
// total size: 0x7C
struct /* @anon10 */ {} zNPC::water_death::__vtable; // size: 0x7C, address: 0x604A10
// total size: 0x7C
struct /* @anon0 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon11 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon7 */ {} zNPC::water_idle::__vtable; // size: 0x7C, address: 0x604B20
// total size: 0x84
struct /* @anon5 */ {} zNPC::water_lob::__vtable; // size: 0x84, address: 0x604A90
// total size: 0x84
struct /* @anon2 */ {} zNPC::bot_lob::__vtable; // size: 0x84, address: 0x604BA0
// total size: 0x7C
struct /* @anon3 */ {} zNPC::lob_generic<zNPC::move>::__vtable; // size: 0x7C, address: 0x602450
// total size: 0x7C
struct /* @anon9 */ {} zNPC::firing_attack_generic<zNPC::move>::__vtable; // size: 0x7C, address: 0x6024D0
// total size: 0x7C
struct /* @anon4 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
...
unsigned int anfire(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x370770
// total size: 0x20
struct /* @anon12 */ {} z::shell::__vtable; // size: 0x20, address: 0x602350
// total size: 0x20
struct /* @anon1 */ {} z::lightweight<z::shell, 15>::__vtable; // size: 0x20, address: 0x602370
// total size: 0x24
struct /* @anon6 */ {} z::lightweight_system<z::shell, 15>::__vtable; // size: 0x24, address: 0x6049E0
// total size: 0x24
struct /* @anon13 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
unsigned int anlob_bomb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x371030
unsigned int anstart_attack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x3710E0
unsigned int ancan_shoot_player(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x371120
// total size: 0x18
class xAnimTable {
    // Members
public:
...
// total size: 0xA4
class water_lob : public bot_lob {};
// total size: 0xD8
...
class lightweight_system : public lightweight_system_base {
    // Members
public:
    class shell object[15]; // offset 0x4, size 0x348
    class lightweight_system * * system; // offset 0x34C, size 0x4
    unsigned int current_id; // offset 0x350, size 0x4
};
// total size: 0x28
...
// total size: 0xA4
class bot_lob : public lob_generic {
    // Members
public:
    signed int max_lob_count; // offset 0x8C, size 0x4
    signed int lob_count; // offset 0x90, size 0x4
    float lob_speed; // offset 0x94, size 0x4
    float aim_radius; // offset 0x98, size 0x4
    class bot_sleep * sleep_state; // offset 0x9C, size 0x4
    unsigned char running; // offset 0xA0, size 0x1
};
// total size: 0x7C
struct /* @anon0 */ {};
// total size: 0x14
...
class shell_type {
    // Members
public:
    char * shell_model_name; // offset 0x0, size 0x4
    class zShrapnelAsset * shrapnel; // offset 0x4, size 0x4
    class xVec3 gravity_direction; // offset 0x8, size 0xC
    float blast_radius; // offset 0x14, size 0x4
    signed int damage; // offset 0x18, size 0x4
    float away_knockback; // offset 0x1C, size 0x4
    float up_knockback; // offset 0x20, size 0x4
    float max_dist; // offset 0x24, size 0x4
};
// total size: 0x2C
class water_death : public behavior_implementation {
    // Members
public:
    class zShrapnelAsset * shrapnel; // offset 0x10, size 0x4
    float timer; // offset 0x14, size 0x4
    float explode_delay; // offset 0x18, size 0x4
    float gravity; // offset 0x1C, size 0x4
    float velocity; // offset 0x20, size 0x4
    float y_surface; // offset 0x24, size 0x4
    signed int explode_splash; // offset 0x28, size 0x4
};
// total size: 0x44
...
// total size: 0x3A8
class bot_lob_water : public common {
    // Members
public:
    class water_lob lob_state; // offset 0x2C0, size 0xA4
    class water_idle idle_state; // offset 0x364, size 0x10
    class water_death death_state; // offset 0x374, size 0x2C
    class array flash_bones; // offset 0x3A0, size 0x8
};
// total size: 0x10
...
// total size: 0x10
class water_idle : public behavior_implementation {};
// total size: 0xC0
class xEntDrive {
    // Members
public:
...
// total size: 0x38
class shell : public lightweight {
    // Members
public:
    class xEnt * owner; // offset 0xC, size 0x4
    float distance; // offset 0x10, size 0x4
    float gravity_speed; // offset 0x14, size 0x4
    ...
    class shell_type * type; // offset 0x34, size 0x4
};
// total size: 0x1C
class RxCluster {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FD80 -> 0x0036FDB0
*/
// Range: 0x36FD80 -> 0x36FDB0
// this: r16
void bot_lob_water::setup() {
    /* anonymous block */ {
        // Range: 0x36FD80 -> 0x36FDB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FDB0 -> 0x0036FEB0
*/
// Range: 0x36FDB0 -> 0x36FEB0
// this: r16
bot_lob_water::bot_lob_water() {
    /* anonymous block */ {
        // Range: 0x36FDB0 -> 0x36FEB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FEB0 -> 0x0036FF7C
*/
// Range: 0x36FEB0 -> 0x36FF7C
// this: r16
void water_death::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x36FEB0 -> 0x36FF7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036FF80 -> 0x00370020
*/
// Range: 0x36FF80 -> 0x370020
// this: r16
void water_death::setup() {
    /* anonymous block */ {
        // Range: 0x36FF80 -> 0x370020
        char * shrapnel_name; // r29+0x2C
        char * splash; // r29+0x28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370020 -> 0x003700EC
*/
// Range: 0x370020 -> 0x3700EC
// this: r16
void water_death::enter_state() {
    /* anonymous block */ {
        // Range: 0x370020 -> 0x3700EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003700F0 -> 0x00370190
*/
// Range: 0x3700F0 -> 0x370190
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370190 -> 0x00370268
*/
// Range: 0x370190 -> 0x370268
// this: r17
unsigned char water_lob::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x370190 -> 0x370268
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370270 -> 0x00370364
*/
// Range: 0x370270 -> 0x370364
// this: r16
void water_lob::update(float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x370270 -> 0x370364
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370370 -> 0x0037064C
*/
// Range: 0x370370 -> 0x37064C
// this: r16
void water_lob::setup() {
    /* anonymous block */ {
        // Range: 0x370370 -> 0x37064C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370650 -> 0x00370678
*/
// Range: 0x370650 -> 0x370678
// this: r2
void water_lob::enter_state() {
    /* anonymous block */ {
        // Range: 0x370650 -> 0x370678
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370680 -> 0x0037076C
*/
// Range: 0x370680 -> 0x37076C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003707D0 -> 0x00370874
*/
// Range: 0x3707D0 -> 0x370874
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3707D0 -> 0x370874
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370880 -> 0x00370908
*/
// Range: 0x370880 -> 0x370908
// this: r2
void water_idle::enter_state() {
    /* anonymous block */ {
        // Range: 0x370880 -> 0x370908
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370910 -> 0x00370964
*/
// Range: 0x370910 -> 0x370964
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370970 -> 0x00370A10
*/
// Range: 0x370970 -> 0x370A10
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x370970 -> 0x370A10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370A10 -> 0x00370E68
*/
// Range: 0x370A10 -> 0x370E68
// this: r17
void bot_lob::launch(class xVec3 & bomb_pos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x370A10 -> 0x370E68
        float rand_radius; // r20
        class xVec3 random_offset; // r29+0x140
        class xVec3 target_pos; // r29+0x130
        class xVec3 target_vel; // r29+0x120
        class xVec3 bomb_vel; // r29+0x110
        class shell newShell; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370E70 -> 0x00370F18
*/
// Range: 0x370E70 -> 0x370F18
// this: r16
void bot_lob::launch() {
    /* anonymous block */ {
        // Range: 0x370E70 -> 0x370F18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00370F20 -> 0x00371028
*/
// Range: 0x370F20 -> 0x371028
void add_transitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x370F20 -> 0x371028
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371180 -> 0x00371224
*/
// Range: 0x371180 -> 0x371224
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x371180 -> 0x371224
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371230 -> 0x00371318
*/
// Range: 0x371230 -> 0x371318
// this: r16
void bot_lob::enter_state() {
    /* anonymous block */ {
        // Range: 0x371230 -> 0x371318
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371320 -> 0x00371344
*/
// Range: 0x371320 -> 0x371344
// this: r4
void bot_lob::reset() {
    /* anonymous block */ {
        // Range: 0x371320 -> 0x371344
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371350 -> 0x00371358
*/
// Range: 0x371350 -> 0x371358
void exit() {
    /* anonymous block */ {
        // Range: 0x371350 -> 0x371358
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371360 -> 0x0037163C
*/
// Range: 0x371360 -> 0x37163C
// this: r16
void bot_lob::setup() {
    /* anonymous block */ {
        // Range: 0x371360 -> 0x37163C
        float default_outer_radius; // r29+0x4C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00371640 -> 0x003716CC
*/
// Range: 0x371640 -> 0x3716CC
// this: r16
unsigned char bot_lob::runnable(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x371640 -> 0x3716CC
    }
}
