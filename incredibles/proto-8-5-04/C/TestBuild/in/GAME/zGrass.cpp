/*
    Compile unit: C:\TestBuild\in\GAME\zGrass.cpp
...
class zGrass * grass; // size: 0x4, address: 0x609440
...
void event_handler(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x41ACF0
// total size: 0xD0
class clone_node {
    // Members
public:
    class clone_node * next; // offset 0x0, size 0x4
    ...
    unsigned int pad2; // offset 0x8, size 0x4
    unsigned int pad3; // offset 0xC, size 0x4
    class xSphere sphere; // offset 0x10, size 0x10
    class xMat4x3 mat; // offset 0x20, size 0x40
    class rwPDS_HICloneFlatArray clone; // offset 0x60, size 0x50
    class xVec2 wave_offset[4]; // offset 0xB0, size 0x20
};
// total size: 0xC
class view_cell {
    // Members
public:
    ...
    class clone_node * clones; // offset 0x4, size 0x4
    class clone_node * last_clone; // offset 0x8, size 0x4
};
// total size: 0x10
class xLightKit {
    // Members
...
class knoll_type {
    // Members
public:
    class asset_type * asset; // offset 0x0, size 0x4
    class zGrassMeshAsset * mesh; // offset 0x4, size 0x4
    class RpAtomic * atomic; // offset 0x8, size 0x4
    signed int cache_index; // offset 0xC, size 0x4
    class zGrassMeshVertex * vert; // offset 0x10, size 0x4
    signed int vert_size; // offset 0x14, size 0x4
    class zGrassMeshFace * tri; // offset 0x18, size 0x4
    signed int tri_size; // offset 0x1C, size 0x4
...
public:
    union { // inferred
        ...
        struct { // inferred
            ...
            signed int source_index; // offset 0x4, size 0x4
        };
    };
};
// total size: 0x70
...
class zGrass {
    // Members
public:
    class grass_cache * caches; // offset 0x0, size 0x4
    signed int caches_size; // offset 0x4, size 0x4
    class knoll_type * knolls; // offset 0x8, size 0x4
    signed int knolls_size; // offset 0xC, size 0x4
    class clone_node clone_buffer[512]; // offset 0x10, size 0x1A000
    class clone_node * head_free_clone; // offset 0x1A010, size 0x4
    // total size: 0x20
    class /* @class */ {
        // Members
    public:
        class grid_cell * cells; // offset 0x0, size 0x4
        class xBox * * boxes; // offset 0x4, size 0x4
        signed int originx; // offset 0x8, size 0x4
        signed int originz; // offset 0xC, size 0x4
        signed int sizex; // offset 0x10, size 0x4
        signed int sizez; // offset 0x14, size 0x4
        float ylower; // offset 0x18, size 0x4
        float yupper; // offset 0x1C, size 0x4
    } grid; // offset 0x1A014, size 0x20
    // total size: 0x8
    class /* @class */ {
        // Members
    public:
        class grass_mesh_tri * tri; // offset 0x0, size 0x4
        signed int tri_size; // offset 0x4, size 0x4
    } world_mesh; // offset 0x1A034, size 0x8
    // total size: 0x25A0
    class /* @class */ {
        // Members
    public:
        class xVec3 center; // offset 0x0, size 0xC
        signed int originx; // offset 0xC, size 0x4
        signed int originz; // offset 0x10, size 0x4
        signed int sizex; // offset 0x14, size 0x4
        signed int sizez; // offset 0x18, size 0x4
        class view_cell cells[2][20][20]; // offset 0x1C, size 0x2580
        signed int current_cells; // offset 0x259C, size 0x4
    } view_area; // offset 0x1A03C, size 0x25A0
    // total size: 0x70
    class /* @class */ {
        // Members
    public:
    ...
    } white_light; // offset 0x1C5DC, size 0x70
    class wave_params anim_wave[4]; // offset 0x1C64C, size 0xA0
    signed int old_alpha_test; // offset 0x1C6EC, size 0x4
    class xLightKit * old_light_kit; // offset 0x1C6F0, size 0x4
};
// total size: 0x28
class mblur_data {
    // Members
...
// total size: 0x14
class base_widget : public xBase {
    // Members
public:
    class knoll_type * knoll; // offset 0x10, size 0x4
};
// total size: 0x20
...
public:
    ...
    class xVec3 normal; // offset 0x10, size 0xC
...
public:
    signed int flags; // offset 0x0, size 0x4
    class RpAtomic * atomic; // offset 0x4, size 0x4
    signed int first; // offset 0x8, size 0x4
...
class zGrassMeshAsset : public xBaseAsset {
    // Members
public:
    signed int numVertices; // offset 0x8, size 0x4
    signed int numFaces; // offset 0xC, size 0x4
    class xVec3 min; // offset 0x10, size 0xC
    class xVec3 max; // offset 0x1C, size 0xC
};
// total size: 0x138
class _tagxPad {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00417A50 -> 0x00417CF0
*/
// Range: 0x417A50 -> 0x417CF0
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00417CF0 -> 0x004181D0
*/
// Range: 0x417CF0 -> 0x4181D0
// this: r21
void zGrass::render_view_area() {
    /* anonymous block */ {
        // Range: 0x417CF0 -> 0x4181D0
        class view_cell (& vcells)[20][20]; // r2
        signed int sizex; // r2
        signed int sizez; // r2
        class rwPDS_HICloneFlatArray * * output_buffer; // r20
        signed int output_size[8]; // r29+0x200
        signed int i; // r5
        signed int viz; // r29+0x1B0
        signed int vix; // r19
        class view_cell & vcell; // r2
        class clone_node * clone; // r18
        signed int cache_index; // r2
        signed int & size; // r17
        class rwPDS_HICloneFlatArray * & output; // r2
        signed int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004181D0 -> 0x0041838C
*/
// Range: 0x4181D0 -> 0x41838C
// this: r19
void zGrass::refresh_view_area() {
    /* anonymous block */ {
        // Range: 0x4181D0 -> 0x41838C
        signed int new_xlower; // r18
        signed int new_xupper; // r17
        signed int new_zlower; // r16
        signed int new_zupper; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00418390 -> 0x00418884
*/
// Range: 0x418390 -> 0x418884
// this: r21
void zGrass::process_view_area() {
    /* anonymous block */ {
        // Range: 0x418390 -> 0x418884
        class view_cell (& vcells)[20][20]; // r2
        signed int originx; // r2
        signed int sizex; // r2
        signed int originz; // r2
        signed int sizez; // r2
        float xstart; // r23
        float z; // r22
        signed int viz; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00418890 -> 0x00418960
*/
// Range: 0x418890 -> 0x418960
// this: r2
void zGrass::fade_cell_alpha(class view_cell & vcell /* r2 */) {
    /* anonymous block */ {
        // Range: 0x418890 -> 0x418960
        float xcenter; // r8
        float zcenter; // r7
        class clone_node * clone; // r6
        float dx; // r29
        float dz; // r29
        float dist2; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00418960 -> 0x00418DF0
*/
// Range: 0x418960 -> 0x418DF0
// this: r2
void zGrass::displace_view_area(signed int new_xlower /* r2 */, signed int new_xupper /* r2 */, signed int new_zlower /* r2 */, signed int new_zupper /* r2 */) {
    /* anonymous block */ {
        // Range: 0x418960 -> 0x418DF0
        signed int old_xlower; // r22
        signed int old_xupper; // r21
        signed int old_zlower; // r29+0xC0
        signed int old_zupper; // r20
        signed int begin_ix; // r29+0xB0
        signed int end_ix; // r19
        signed int begin_iz; // r18
        signed int end_iz; // r23
        signed int next_cells; // r2
        signed int iz; // r2
        signed int ix; // r17
        class view_cell & vcell; // r2
        class view_cell & vcell; // r2
        class view_cell & icell; // r2
        class view_cell & ocell; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00418DF0 -> 0x00418EFC
*/
// Range: 0x418DF0 -> 0x418EFC
// this: r19
void zGrass::populate_cell(class view_cell & vcell /* r18 */, signed int grid_index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x418DF0 -> 0x418EFC
        class grid_cell & gcell; // r2
        class grass_mesh_tri * tri; // r17
        class grass_mesh_tri * end_tri; // r2
        class clone_node * clones; // r29+0x5C
        class clone_node * last_clone; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00418F00 -> 0x00419BC4
*/
// Range: 0x418F00 -> 0x419BC4
// this: r29+0x16C
void zGrass::emit_clones(class clone_node * & clones /* r29+0x168 */, class clone_node * & last_clone /* r29+0x164 */, class grass_mesh_tri & tri /* r2 */) {
    /* anonymous block */ {
        // Range: 0x418F00 -> 0x419BC4
        class knoll_type & knoll; // r2
        signed int emit; // r21
        unsigned char cache_index; // r2
        class RpAtomic * atomic; // r29+0x150
        class xSphere & atomic_sphere; // r2
        class xVec3 atomic_center; // r29+0x230
        float atomic_radius; // r31
        class zGrassMeshVertex & v0; // r22
        class zGrassMeshVertex & v1; // r23
        class zGrassMeshVertex & v2; // r30
        float rand_width_min; // r29+0xFC
        float rand_width_scale; // r29+0xF8
        float rand_height_min; // r29+0xF4
        float rand_height_scale; // r29+0xF0
        float width_min; // r29+0xEC
        float height_min; // r29+0xE8
        signed int orient; // r2
        float animate; // r30
        float s; // r29
        float t; // r28
        float v; // r27
        float height; // r26
        float rand_width; // r25
        float width; // r29+0x240
        float orient; // r24
        class clone_node * clone; // r20
        float intensity; // r1
        float g; // r29+0x240
        float b; // r5
        class xMat4x3 & mat; // r16
        class xMat3x3 rot_mat; // r29+0x200
        class xMat3x3 norm_mat; // r29+0x1D0
        class xMat3x3 rot_mat; // r29+0x1A0
        class xMat3x3 norm_mat; // r29+0x170
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00419BD0 -> 0x0041A2DC
*/
// Range: 0x419BD0 -> 0x41A2DC
// this: r20
void zGrass::partition_meshes() {
    /* anonymous block */ {
        // Range: 0x419BD0 -> 0x41A2DC
        class knoll_type * knoll; // r7
        class knoll_type * end_knoll; // r2
        float xlower; // r3
        float xupper; // r21
        float ylower; // r2
        float yupper; // r1
        ...
        class grass_mesh_tri * otri; // r19
        class grass_mesh_tri * end_otri; // r2
        signed int i; // r18
        class knoll_type & knoll; // r17
        class zGrassMeshFace * itri; // r16
        class zGrassMeshFace * end_itri; // r2
        class xVec3 & p0; // r2
        class xVec3 & p1; // r2
        class xVec3 & p2; // r2
        signed int tri_index; // r6
        signed int i; // r5
        signed int knoll_index; // r2
        class zGrassMeshFace & itri; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041A2E0 -> 0x0041A5E8
*/
// Range: 0x41A2E0 -> 0x41A5E8
// this: r2
void zGrass::refresh_grid_cell_boxes() {
    /* anonymous block */ {
        // Range: 0x41A2E0 -> 0x41A5E8
        signed int grid_size; // r2
        signed int box_index; // r14
        signed int i; // r13
        class grid_cell & gcell; // r12
        float xlower; // r18
        float xupper; // r17
        float ylower; // r16
        float yupper; // r15
        float zlower; // r14
        float zupper; // r13
        class grass_mesh_tri * tri; // r11
        class grass_mesh_tri * end_tri; // r2
        class knoll_type & knoll; // r10
        float atomic_radius; // r12
        class zGrassMeshVertex & v0; // r2
        float xtrilower; // r11
        float xtriupper; // r10
        float ytrilower; // r9
        float ytriupper; // r8
        ...
        float maxheight; // r5
        signed int vi; // r9
        class zGrassMeshVertex & v; // r2
        float height; // r29+0x20
        float width; // r29+0x20
        float radius; // r29+0x20
        class xBox & box; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041A5F0 -> 0x0041A7BC
*/
// Range: 0x41A5F0 -> 0x41A7BC
// this: r2
void zGrass::refresh_density(class grass_mesh_tri & tri /* r17 */) {
    /* anonymous block */ {
        // Range: 0x41A5F0 -> 0x41A7BC
        class knoll_type & knoll; // r2
        class zGrassMeshVertex & A; // r2
        class zGrassMeshVertex & B; // r2
        class zGrassMeshVertex & C; // r2
        float ABx; // r29+0x50
        float ABy; // r29+0x50
        float ABz; // r29+0x50
        float ACx; // r29+0x50
        float ACy; // r29+0x50
        float ACz; // r29+0x50
        float ABXACx; // r29+0x50
        float ABXACy; // r29+0x50
        float ABXACz; // r29+0x50
        float density; // r20
        signed int emit; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041A7C0 -> 0x0041A948
*/
// Range: 0x41A7C0 -> 0x41A948
// this: r16
void zGrass::create_caches() {
    /* anonymous block */ {
        // Range: 0x41A7C0 -> 0x41A948
        class RpAtomic * atomics_found[8]; // r29+0x40
        class knoll_type * knoll; // r3
        class knoll_type * end_knoll; // r2
        class RpAtomic * * t; // r10
        class RpAtomic * * endt; // r2
        class grass_cache * cache; // r18
        class grass_cache * end_cache; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041A950 -> 0x0041AA40
*/
// Range: 0x41A950 -> 0x41AA40
// this: r2
void zGrass::apply_visibility(class knoll_type & knoll /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41A950 -> 0x41AA40
        unsigned char knoll_index; // r2
        class grass_mesh_tri * tri; // r3
        class grass_mesh_tri * end_tri; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041AA40 -> 0x0041ACE8
*/
// Range: 0x41AA40 -> 0x41ACE8
void create_knolls(class knoll_type * & knolls /* r21 */, signed int & knolls_size /* r19 */) {
    /* anonymous block */ {
        // Range: 0x41AA40 -> 0x41ACE8
        ...
        class asset_type * asset; // r2
        class zGrassMeshAsset * mesh; // r2
        unsigned int model_id; // r29+0xA8
        class RpAtomic * atomic; // r2
        class xModelPipe pipe; // r29+0x98
        class knoll_type * knoll; // r21
        signed int i; // r20
        unsigned int asset_size; // r29+0xA4
        class asset_type * asset; // r19
        class zGrassMeshAsset * mesh; // r2
        unsigned int model_id; // r29+0xA0
        class RpAtomic * atomic; // r18
        class xModelPipe pipe; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041ACF0 -> 0x0041AD44
*/
// Range: 0x41ACF0 -> 0x41AD44
void event_handler(class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41ACF0 -> 0x41AD44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041AD50 -> 0x0041ADFC
*/
// Range: 0x41AD50 -> 0x41ADFC
void load(class xBase & data /* r2 */, class xDynAsset & asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x41AD50 -> 0x41ADFC
        class asset_type & a; // r2
        class base_widget * w; // r16
        class knoll_type * knoll; // r5
        class knoll_type * end_knoll; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041AE00 -> 0x0041AF38
*/
// Range: 0x41AE00 -> 0x41AF38
void render() {
    /* anonymous block */ {
        // Range: 0x41AE00 -> 0x41AF38
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041AF40 -> 0x0041AF4C
*/
// Range: 0x41AF40 -> 0x41AF4C
void pre_render() {
    /* anonymous block */ {
        // Range: 0x41AF40 -> 0x41AF4C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041AF50 -> 0x0041B0AC
*/
// Range: 0x41AF50 -> 0x41B0AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B0B0 -> 0x0041B210
*/
// Range: 0x41B0B0 -> 0x41B210
void reset() {
    /* anonymous block */ {
        // Range: 0x41B0B0 -> 0x41B210
        class knoll_type * knoll; // r4
        class knoll_type * end_knoll; // r2
        class clone_node * clone; // r5
        class clone_node * end_clone; // r2
        class grass_cache * cache; // r4
        class grass_cache * end_cache; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B210 -> 0x0041B21C
*/
// Range: 0x41B210 -> 0x41B21C
void setup() {
    /* anonymous block */ {
        // Range: 0x41B210 -> 0x41B21C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B220 -> 0x0041B2EC
*/
// Range: 0x41B220 -> 0x41B2EC
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x41B220 -> 0x41B2EC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B2F0 -> 0x0041B420
*/
// Range: 0x41B2F0 -> 0x41B420
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x41B2F0 -> 0x41B420
        class knoll_type * knolls; // r29+0x2C
        signed int knolls_size; // r29+0x28
    }
}
