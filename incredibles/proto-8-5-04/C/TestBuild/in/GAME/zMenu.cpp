/*
    Compile unit: C:\TestBuild\in\GAME\zMenu.cpp
...
static signed int sFirstBoot; // size: 0x4, address: 0x6076DC
static signed int logoTmr; // size: 0x4, address: 0x0
static float time_elapsed; // size: 0x4, address: 0x6076E0
static float time_last; // size: 0x4, address: 0x60875C
static float time_current; // size: 0x4, address: 0x608760
static float sAttractMode_timer; // size: 0x4, address: 0x608764
static float sOneLiner_timer; // size: 0x4, address: 0x608768
static signed int promptSel; // size: 0x4, address: 0x0
static signed int card; // size: 0x4, address: 0x60876C
static signed int var; // size: 0x4, address: 0x0
static signed int fullCard; // size: 0x4, address: 0x0
static signed int sInMenu; // size: 0x4, address: 0x608770
static float ONELINER_WAITTIME; // size: 0x4, address: 0x0
static float holdTmr; // size: 0x4, address: 0x6076E4
static unsigned char sAllowAttract; // size: 0x1, address: 0x608774
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F500 -> 0x0013F508
*/
// Range: 0x13F500 -> 0x13F508
void zMenuAllowAtract(unsigned char allowAttract /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13F500 -> 0x13F508
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F510 -> 0x0013F564
*/
// Range: 0x13F510 -> 0x13F564
void zMenuPause(unsigned char bPause /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13F510 -> 0x13F564
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F570 -> 0x0013F578
*/
// Range: 0x13F570 -> 0x13F578
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F580 -> 0x0013F58C
*/
// Range: 0x13F580 -> 0x13F58C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F590 -> 0x0013F8A8
*/
// Range: 0x13F590 -> 0x13F8A8
signed int zMenuCardCheckStartup(signed int * bytesNeeded /* r20 */, signed int * availOnDisk /* r19 */, signed int * neededFiles /* r18 */) {
    /* anonymous block */ {
        ...
        signed int tgtmax; // r29+0x8C
        signed int rc; // r2
        signed int tgtslot; // r22
        unsigned char cardWithSpace; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F8B0 -> 0x0013F9E8
*/
// Range: 0x13F8B0 -> 0x13F9E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013F9F0 -> 0x00140318
*/
// Range: 0x13F9F0 -> 0x140318
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140320 -> 0x0014048C
*/
// Range: 0x140320 -> 0x14048C
void zMenuSetup() {
    /* anonymous block */ {
        // Range: 0x140320 -> 0x14048C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140490 -> 0x00140504
*/
// Range: 0x140490 -> 0x140504
void zMenuExit() {
    /* anonymous block */ {
        // Range: 0x140490 -> 0x140504
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00140510 -> 0x001405A0
*/
// Range: 0x140510 -> 0x1405A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001405A0 -> 0x001405A8
*/
// Range: 0x1405A0 -> 0x1405A8
