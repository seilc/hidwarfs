/*
    Compile unit: C:\TestBuild\in\GAME\zHudBossMeter.cpp
...
// total size: 0x28
struct /* @anon1 */ {} zHud::BossMeter::__vtable; // size: 0x28, address: 0x606EE0
...
enum eBossHealthMeterLayer {
    HEALTH_BASE = 0,
    HEALTH_DAMAGEHEALTH = 1,
    HEALTH_HEALTH = 2,
    HEALTH_OUTLINE = 3,
    HEALTH_STATIC_DEST = 4,
    HEALTH_STATIC = 5,
    HEALTH_NUM_LAYERS = 6,
};
// total size: 0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00481DD0 -> 0x00481EB4
*/
// Range: 0x481DD0 -> 0x481EB4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00481EC0 -> 0x00481FBC
*/
// Range: 0x481EC0 -> 0x481FBC
// this: r17
void BossMeter::appear_off() {
    /* anonymous block */ {
        // Range: 0x481EC0 -> 0x481FBC
        enum eBossHealthMeterLayer eLayer; // r16
        enum eBossStageMeterLayer eLayer; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00481FC0 -> 0x00482120
*/
// Range: 0x481FC0 -> 0x482120
// this: r16
void BossMeter::appear_update() {
    /* anonymous block */ {
        ...
        float fStopTime; // r21
        float fAlpha; // r20
        enum eBossHealthMeterLayer eLayer; // r17
        enum eBossStageMeterLayer eLayer; // r17
        float fStatic; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482120 -> 0x004821A0
*/
// Range: 0x482120 -> 0x4821A0
// this: r16
void BossMeter::set_health(float HealthPercent /* r20 */) {
    /* anonymous block */ {
        // Range: 0x482120 -> 0x4821A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004821A0 -> 0x00482274
*/
// Range: 0x4821A0 -> 0x482274
// this: r16
void BossMeter::set_stage_completed(unsigned char LastCompletedStage /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4821A0 -> 0x482274
        enum eBossStageMeterLayer eLayer; // r18
        float fOffsetX; // r29+0x4C
        float fOffsetY; // r29+0x48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482280 -> 0x0048277C
*/
// Range: 0x482280 -> 0x48277C
// this: r17
void BossMeter::set_stage_count(unsigned char StageCount /* r16 */) {
    /* anonymous block */ {
        // Range: 0x482280 -> 0x48277C
        enum eBossStageMeterLayer eLayer; // r16
        class RwTexCoords zero; // r29+0x48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482780 -> 0x004827D0
*/
// Range: 0x482780 -> 0x4827D0
// this: r16
void BossMeter::hide() {
    /* anonymous block */ {
        // Range: 0x482780 -> 0x4827D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004827D0 -> 0x00482864
*/
// Range: 0x4827D0 -> 0x482864
// this: r16
void BossMeter::show() {
    /* anonymous block */ {
        // Range: 0x4827D0 -> 0x482864
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482870 -> 0x004829F0
*/
// Range: 0x482870 -> 0x4829F0
// this: r16
void BossMeter::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x482870 -> 0x4829F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004829F0 -> 0x004829F8
*/
// Range: 0x4829F0 -> 0x4829F8
void destroy() {
    /* anonymous block */ {
        // Range: 0x4829F0 -> 0x4829F8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482A00 -> 0x0048346C
*/
// Range: 0x482A00 -> 0x48346C
// this: r19
void BossMeter::setup() {
    /* anonymous block */ {
        // Range: 0x482A00 -> 0x48346C
        unsigned int hitMeterID; // r16
        unsigned int stageMeterID; // r16
        float numberX; // r4
        float numberY; // r1
        class RwTexCoords upperleft; // r29+0x70
        class RwTexCoords lowerright; // r29+0x68
        unsigned char bOmnidroidLevel; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00483470 -> 0x004834A0
*/
// Range: 0x483470 -> 0x4834A0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004834A0 -> 0x00483528
*/
// Range: 0x4834A0 -> 0x483528
// this: r2
BossMeter::BossMeter() {
    /* anonymous block */ {
        // Range: 0x4834A0 -> 0x483528
