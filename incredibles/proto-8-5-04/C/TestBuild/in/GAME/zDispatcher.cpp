/*
    Compile unit: C:\TestBuild\in\GAME\zDispatcher.cpp
...
static signed int g_zdsp_init; // size: 0x4, address: 0x6085A8
static signed int g_zdsp_dblog_init; // size: 0x4, address: 0x0
static class st_ZDISPATCH_DEPOT g_zdsp_depot; // size: 0x8, address: 0x6085B0
static class World worlds[20]; // size: 0x4D8, address: 0x6131C0
static signed short currentWorld; // size: 0x2, address: 0x6085B8
static signed short currentTask; // size: 0x2, address: 0x6085BC
static signed short currentPointer; // size: 0x2, address: 0x6085C0
...
void ZDSP_elcb_event(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x128C80
...
enum eFMVFile {
    ...
    eFMVFile_FMVOM03a = 8,
    eFMVFile_FMVOM04 = 9,
    eFMVFile_FMVLD01a = 10,
    eFMVFile_FMVNJO2 = 11,
    eFMVFile_FMVNJ03 = 12,
    eFMVFile_FMVNI01 = 13,
    eFMVFile_FMVNI01a = 14,
    eFMVFile_FMVCI03 = 15,
    eFMVFile_FMVCI01a = 16,
    eFMVFile_FMVFT01 = 17,
    eFMVFile_FMVFT01a = 18,
    eFMVFile_FMVFT02 = 19,
    eFMVFile_FMVFT02a = 20,
    eFMVFile_FMVFT03a = 21,
    eFMVFile_FMVFT04 = 22,
    eFMVFile_FMVFT04a = 23,
    eFMVFile_FMVRS01 = 24,
    eFMVFile_FMVRS01a = 25,
    eFMVFile_FMVRS02a = 26,
    eFMVFile_FMVHS01a = 27,
    eFMVFile_FMVHS01b = 28,
    eFMVFile_FMVNI01b = 29,
    eFMVFile_FMVNI03a = 30,
    eFMVFile_FMVHS01 = 31,
    eFMVFile_CARS = 32,
    eFMVFile_D3 = 33,
    eFMVFile_PROMO1 = 35,
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128BF0 -> 0x00128C7C
*/
// Range: 0x128BF0 -> 0x128C7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128C80 -> 0x00129CD4
*/
// Range: 0x128C80 -> 0x129CD4
void ZDSP_elcb_event(class xBase * from /* r19 */, class xBase * xb /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r18 */, class xBase * toParamWidget /* r17 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128C80 -> 0x129CD4
        signed short currentTask'530; // r3
        signed short currentWorld'529; // r3
        class st_ZDISPATCH_DATA * dspdata; // r16
        signed int old_vibration; // r2
        class pointer_asset * pointerAsset; // r2
        enum eFMVFile fmv; // r2
        class zFMVFile * file; // r2
        float pointer; // r29+0x190
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129CE0 -> 0x0012A2AC
*/
// Range: 0x129CE0 -> 0x12A2AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A2B0 -> 0x0012A2B8
*/
// Range: 0x12A2B0 -> 0x12A2B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A2C0 -> 0x0012A2C8
*/
// Range: 0x12A2C0 -> 0x12A2C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A2D0 -> 0x0012A2D8
*/
// Range: 0x12A2D0 -> 0x12A2D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A2E0 -> 0x0012A344
*/
// Range: 0x12A2E0 -> 0x12A344
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A350 -> 0x0012A364
*/
// Range: 0x12A350 -> 0x12A364
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A370 -> 0x0012A3F0
*/
// Range: 0x12A370 -> 0x12A3F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A3F0 -> 0x0012A424
*/
// Range: 0x12A3F0 -> 0x12A424
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A430 -> 0x0012A464
*/
// Range: 0x12A430 -> 0x12A464
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A470 -> 0x0012A478
*/
// Range: 0x12A470 -> 0x12A478
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A480 -> 0x0012A488
*/
// Range: 0x12A480 -> 0x12A488
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A490 -> 0x0012A6A0
*/
// Range: 0x12A490 -> 0x12A6A0
