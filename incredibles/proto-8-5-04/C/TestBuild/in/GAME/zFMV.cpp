/*
    Compile unit: C:\TestBuild\in\GAME\zFMV.cpp
...
static class zFMVFile zFMVFileTable[37]; // size: 0x1BC, address: 0x505190
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132390 -> 0x0013246C
*/
// Range: 0x132390 -> 0x13246C
unsigned int zFMVPlay(char * name /* r21 */, unsigned int buttons /* r20 */, float time /* r20 */, unsigned int uSubtitlesAID /* r19 */, unsigned char skippable /* r18 */, unsigned char lockController /* r17 */) {
    /* anonymous block */ {
        // Range: 0x132390 -> 0x13246C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132470 -> 0x001324D4
*/
// Range: 0x132470 -> 0x1324D4
char * zFMVFileGetName(enum eFMVFile fmvId /* r2 */) {
    /* anonymous block */ {
        // Range: 0x132470 -> 0x1324D4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001324E0 -> 0x00132530
*/
// Range: 0x1324E0 -> 0x132530
class zFMVFile * zFMVFileGetFile(enum eFMVFile fmvId /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1324E0 -> 0x132530
        signed int i; // r5
    }
