/*
    Compile unit: C:\TestBuild\in\GAME\zAsync.cpp
...
class RwCamera * cam; // size: 0x4, address: 0x609100
class RpLight * light; // size: 0x4, address: 0x609104
class RwFrame * frame; // size: 0x4, address: 0x609110
class RpWorld * world; // size: 0x4, address: 0x609114
class Screen * screen; // size: 0x4, address: 0x609118
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324A70 -> 0x00324C20
*/
// Range: 0x324A70 -> 0x324C20
void RenderThread() {
    /* anonymous block */ {
        // Range: 0x324A70 -> 0x324C20
        signed long lastTime; // r16
        signed long curTime; // r17
        float dt; // r20
        class RwRGBA bg; // r29+0x4C
        class RwCamera * currentCamera; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324C20 -> 0x00324CA0
*/
// Range: 0x324C20 -> 0x324CA0
void Free() {
    /* anonymous block */ {
        // Range: 0x324C20 -> 0x324CA0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324CA0 -> 0x00324D80
*/
// Range: 0x324CA0 -> 0x324D80
void Allocate() {
    /* anonymous block */ {
        // Range: 0x324CA0 -> 0x324D80
        class RwBBox tmpbbox; // r29+0x20
        class RwV3d lightpos; // r29+0x40
        class RwRGBAReal color; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324D80 -> 0x00324D88
*/
// Range: 0x324D80 -> 0x324D88
void Init(class Screen * scr /* r2 */) {
    /* anonymous block */ {
        // Range: 0x324D80 -> 0x324D88
    }
}
