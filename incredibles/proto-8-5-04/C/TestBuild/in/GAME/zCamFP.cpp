/*
    Compile unit: C:\TestBuild\in\GAME\zCamFP.cpp
...
// total size: 0x24
struct /* @anon0 */ {} zCamFP::__vtable; // size: 0x24, address: 0x601470
...
// total size: 0x100
class zCamFP : public xCam {
    // Members
public:
    unsigned int fpFlags; // offset 0xD0, size 0x4
    float yawSpeed; // offset 0xD4, size 0x4
    float pitchSpeed; // offset 0xD8, size 0x4
    float minPitch; // offset 0xDC, size 0x4
    float maxPitch; // offset 0xE0, size 0x4
    signed int boneIndex; // offset 0xE4, size 0x4
    class xVec3 boneOffset; // offset 0xE8, size 0xC
};
// total size: 0x30
class RxPacket {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B9AB0 -> 0x002B9C9C
*/
// Range: 0x2B9AB0 -> 0x2B9C9C
// this: r16
void zCamFP::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B9AB0 -> 0x2B9C9C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B9CA0 -> 0x002B9D78
*/
// Range: 0x2B9CA0 -> 0x2B9D78
// this: r16
void zCamFP::stop() {
    /* anonymous block */ {
        // Range: 0x2B9CA0 -> 0x2B9D78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B9D80 -> 0x002B9E78
*/
// Range: 0x2B9D80 -> 0x2B9E78
// this: r16
void zCamFP::start() {
    /* anonymous block */ {
        // Range: 0x2B9D80 -> 0x2B9E78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B9E80 -> 0x002B9EB8
*/
// Range: 0x2B9E80 -> 0x2B9EB8
// this: r16
void zCamFP::create() {
    /* anonymous block */ {
        // Range: 0x2B9E80 -> 0x2B9EB8
