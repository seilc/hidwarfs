/*
    Compile unit: C:\TestBuild\in\GAME\zCheat.cpp
...
static float cheatTimer; // size: 0x4, address: 0x608FB4
static float headScale; // size: 0x4, address: 0x607BD8
static float targetHead; // size: 0x4, address: 0x607BDC
static float discoTimer; // size: 0x4, address: 0x608FB8
static class xFXHighDynamicRangeConfiguration defaultConfig; // size: 0x18, address: 0x688670
static class Cheat cheats[35]; // size: 0x118, address: 0x50E0D0
class lightweight_system * system; // size: 0x4, address: 0x608DD8
// total size: 0x24
struct /* @anon0 */ {} z::lightweight_system<z::laser, 40>::__vtable; // size: 0x24, address: 0x5FD7A0
// total size: 0x24
struct /* @anon1 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
...
unsigned char weak_bombs; // size: 0x1, address: 0x609488
// total size: 0x10
class iEnvMatOrder {
    // Members
public:
...
public:
    char * name; // offset 0x0, size 0x4
    unsigned char (* callback)(); // offset 0x4, size 0x4
};
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C63E0 -> 0x002C64B0
*/
// Range: 0x2C63E0 -> 0x2C64B0
unsigned char zCheatProcess(char * name /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2C63E0 -> 0x2C64B0
        signed int low; // r19
        signed int high; // r18
        signed int mid; // r2
        signed int compare; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C64B0 -> 0x002C64B8
*/
// Range: 0x2C64B0 -> 0x2C64B8
float zCheatGetHeadScale() {
    /* anonymous block */ {
        // Range: 0x2C64B0 -> 0x2C64B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C64C0 -> 0x002C6B40
*/
// Range: 0x2C64C0 -> 0x2C6B40
void zCheatUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2C64C0 -> 0x2C6B40
        class xColor_tag color; // r29+0x12C
        class xVec3 pos; // r29+0x120
        class zCommonPlayer * player; // r2
        class laser gazerLaser; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6B40 -> 0x002C6BD8
*/
// Range: 0x2C6B40 -> 0x2C6BD8
void zCheatReset() {
    /* anonymous block */ {
        // Range: 0x2C6B40 -> 0x2C6BD8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6BE0 -> 0x002C6C60
*/
// Range: 0x2C6BE0 -> 0x2C6C60
void zCheatInit() {
    /* anonymous block */ {
        // Range: 0x2C6BE0 -> 0x2C6C60
        char * uncrypt; // r6
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6C60 -> 0x002C6D48
*/
// Range: 0x2C6C60 -> 0x2C6D48
static unsigned char Cheat_IncrediPower() {
    /* anonymous block */ {
        // Range: 0x2C6C60 -> 0x2C6D48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6D50 -> 0x002C6D84
*/
// Range: 0x2C6D50 -> 0x2C6D84
static unsigned char Cheat_GlowingSwimmer() {
    /* anonymous block */ {
        // Range: 0x2C6D50 -> 0x2C6D84
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6D90 -> 0x002C6E98
*/
// Range: 0x2C6D90 -> 0x2C6E98
static unsigned char Cheat_Ethereal() {
    /* anonymous block */ {
        // Range: 0x2C6D90 -> 0x2C6E98
        class xFXHighDynamicRangeConfiguration config; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6EA0 -> 0x002C6FA8
*/
// Range: 0x2C6EA0 -> 0x2C6FA8
static unsigned char Cheat_Blurry() {
    /* anonymous block */ {
        // Range: 0x2C6EA0 -> 0x2C6FA8
        class xFXHighDynamicRangeConfiguration config; // r29+0x10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6FB0 -> 0x002C6FE4
*/
// Range: 0x2C6FB0 -> 0x2C6FE4
static unsigned char Cheat_FlamingFeet() {
    /* anonymous block */ {
        // Range: 0x2C6FB0 -> 0x2C6FE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C6FF0 -> 0x002C715C
*/
// Range: 0x2C6FF0 -> 0x2C715C
static unsigned char Cheat_DiscoMode() {
    /* anonymous block */ {
        // Range: 0x2C6FF0 -> 0x2C715C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7160 -> 0x002C7194
*/
// Range: 0x2C7160 -> 0x2C7194
static unsigned char Cheat_FlamingPlants() {
    /* anonymous block */ {
        // Range: 0x2C7160 -> 0x2C7194
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C71A0 -> 0x002C7210
*/
// Range: 0x2C71A0 -> 0x2C7210
static unsigned char Cheat_SmallHeadMode() {
    /* anonymous block */ {
        // Range: 0x2C71A0 -> 0x2C7210
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7210 -> 0x002C7280
*/
// Range: 0x2C7210 -> 0x2C7280
static unsigned char Cheat_BigHeadMode() {
    /* anonymous block */ {
        // Range: 0x2C7210 -> 0x2C7280
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7280 -> 0x002C7348
*/
// Range: 0x2C7280 -> 0x2C7348
static unsigned char Cheat_Gazerbeam() {
    /* anonymous block */ {
        // Range: 0x2C7280 -> 0x2C7348
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7350 -> 0x002C7390
*/
// Range: 0x2C7350 -> 0x2C7390
static unsigned char Cheat_SlowMo() {
    /* anonymous block */ {
        // Range: 0x2C7350 -> 0x2C7390
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7390 -> 0x002C73D0
*/
// Range: 0x2C7390 -> 0x2C73D0
static unsigned char Cheat_FastMo() {
    /* anonymous block */ {
        // Range: 0x2C7390 -> 0x2C73D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C73D0 -> 0x002C73E8
*/
// Range: 0x2C73D0 -> 0x2C73E8
static unsigned char Cheat_ExtraShrapnel() {
    /* anonymous block */ {
        // Range: 0x2C73D0 -> 0x2C73E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C73F0 -> 0x002C7408
*/
// Range: 0x2C73F0 -> 0x2C7408
static unsigned char Cheat_BouncyHenchmen() {
    /* anonymous block */ {
        // Range: 0x2C73F0 -> 0x2C7408
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7410 -> 0x002C74EC
*/
// Range: 0x2C7410 -> 0x2C74EC
static unsigned char Cheat_NoDashDamage() {
    /* anonymous block */ {
        // Range: 0x2C7410 -> 0x2C74EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C74F0 -> 0x002C75CC
*/
// Range: 0x2C74F0 -> 0x2C75CC
static unsigned char Cheat_KonamiCode() {
    /* anonymous block */ {
        // Range: 0x2C74F0 -> 0x2C75CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C75D0 -> 0x002C75F0
*/
// Range: 0x2C75D0 -> 0x2C75F0
static unsigned char Cheat_InvertCameraX() {
    /* anonymous block */ {
        // Range: 0x2C75D0 -> 0x2C75F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C75F0 -> 0x002C7610
*/
// Range: 0x2C75F0 -> 0x2C7610
static unsigned char Cheat_InvertCameraY() {
    /* anonymous block */ {
        // Range: 0x2C75F0 -> 0x2C7610
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7610 -> 0x002C7630
*/
// Range: 0x2C7610 -> 0x2C7630
static unsigned char Cheat_InvertTurret() {
    /* anonymous block */ {
        // Range: 0x2C7610 -> 0x2C7630
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7630 -> 0x002C7638
*/
// Range: 0x2C7630 -> 0x2C7638
static unsigned char Cheat_BoaPlace() {
    /* anonymous block */ {
        // Range: 0x2C7630 -> 0x2C7638
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7640 -> 0x002C7660
*/
// Range: 0x2C7640 -> 0x2C7660
static unsigned char Cheat_CarsTrailer() {
    /* anonymous block */ {
        // Range: 0x2C7640 -> 0x2C7660
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7660 -> 0x002C775C
*/
// Range: 0x2C7660 -> 0x2C775C
static unsigned char Cheat_TonyLoaf() {
    /* anonymous block */ {
        // Range: 0x2C7660 -> 0x2C775C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7760 -> 0x002C7874
*/
// Range: 0x2C7760 -> 0x2C7874
static unsigned char Cheat_Flexible() {
    /* anonymous block */ {
        // Range: 0x2C7760 -> 0x2C7874
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7880 -> 0x002C7980
*/
// Range: 0x2C7880 -> 0x2C7980
static unsigned char Cheat_Showtime() {
    /* anonymous block */ {
        // Range: 0x2C7880 -> 0x2C7980
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7980 -> 0x002C7990
*/
// Range: 0x2C7980 -> 0x2C7990
static unsigned char Cheat_NoFly() {
    /* anonymous block */ {
        // Range: 0x2C7980 -> 0x2C7990
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7990 -> 0x002C79A8
*/
// Range: 0x2C7990 -> 0x2C79A8
static unsigned char Cheat_HUD() {
    /* anonymous block */ {
        // Range: 0x2C7990 -> 0x2C79A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C79B0 -> 0x002C79C0
*/
// Range: 0x2C79B0 -> 0x2C79C0
static unsigned char Cheat_Fly() {
    /* anonymous block */ {
        // Range: 0x2C79B0 -> 0x2C79C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C79C0 -> 0x002C79E0
*/
// Range: 0x2C79C0 -> 0x2C79E0
static unsigned char Cheat_UnlockScenes() {
    /* anonymous block */ {
        // Range: 0x2C79C0 -> 0x2C79E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C79E0 -> 0x002C7ABC
*/
// Range: 0x2C79E0 -> 0x2C7ABC
static unsigned char Cheat_DashLikes() {
    /* anonymous block */ {
        // Range: 0x2C79E0 -> 0x2C7ABC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7AC0 -> 0x002C7ACC
*/
// Range: 0x2C7AC0 -> 0x2C7ACC
static unsigned char Cheat_Labombe() {
    /* anonymous block */ {
        // Range: 0x2C7AC0 -> 0x2C7ACC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7AD0 -> 0x002C7B58
*/
// Range: 0x2C7AD0 -> 0x2C7B58
static unsigned char Cheat_Smartbomb() {
    /* anonymous block */ {
        // Range: 0x2C7AD0 -> 0x2C7B58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7B60 -> 0x002C7C44
*/
// Range: 0x2C7B60 -> 0x2C7C44
static unsigned char Cheat_Kronos() {
    /* anonymous block */ {
        // Range: 0x2C7B60 -> 0x2C7C44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7C50 -> 0x002C7C58
*/
// Range: 0x2C7C50 -> 0x2C7C58
static unsigned char Cheat_JustinBailey() {
    /* anonymous block */ {
        // Range: 0x2C7C50 -> 0x2C7C58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7C60 -> 0x002C7D54
*/
// Range: 0x2C7C60 -> 0x2C7D54
static unsigned char Cheat_HalfDamage() {
    /* anonymous block */ {
        // Range: 0x2C7C60 -> 0x2C7D54
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C7D60 -> 0x002C7E48
*/
// Range: 0x2C7D60 -> 0x2C7E48
static unsigned char Cheat_DanielTheFlash() {
    /* anonymous block */ {
        // Range: 0x2C7D60 -> 0x2C7E48
    }
}
