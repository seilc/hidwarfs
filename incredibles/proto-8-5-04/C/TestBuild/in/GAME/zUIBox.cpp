/*
    Compile unit: C:\TestBuild\in\GAME\zUIBox.cpp
...
// total size: 0x50
struct /* @anon0 */ {} zUIBox::__vtable; // size: 0x50, address: 0x6014D0
void * __dt(class xTextureHandle *, signed short); // size: 0x0, address: 0x2C5530
void * __ct(class xTextureHandle *); // size: 0x0, address: 0x2C6020
// total size: 0x50
struct /* @anon1 */ {} zUI::__vtable; // size: 0x50, address: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BAA30 -> 0x002BAA98
*/
// Range: 0x2BAA30 -> 0x2BAA98
void zUIBox_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2BAA30 -> 0x2BAA98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BAAA0 -> 0x002BB71C
*/
// Range: 0x2BAAA0 -> 0x2BB71C
// this: r16
void zUIBox::RenderPart(signed int p /* r17 */, float x1 /* r28 */, float y1 /* r20 */, float x2 /* r27 */, float y2 /* r26 */, float uScale /* r25 */, float vScale /* r24 */, float rotation /* r21 */, float xPivot /* r22 */, float yPivot /* r29+0x80 */) {
    /* anonymous block */ {
        ...
        class RwSky2DVertex vertex[4]; // @ 0x00686B90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BB720 -> 0x002BBB7C
*/
// Range: 0x2BB720 -> 0x2BBB7C
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBB80 -> 0x002BBBB8
*/
// Range: 0x2BBB80 -> 0x2BBBB8
// this: r17
void zUIBox::DoApplyMotionFrame(class zUIMotionFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2BBB80 -> 0x2BBBB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBBC0 -> 0x002BBCFC
*/
// Range: 0x2BBBC0 -> 0x2BBCFC
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBD00 -> 0x002BBD28
*/
// Range: 0x2BBD00 -> 0x2BBD28
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBD30 -> 0x002BBDA4
*/
// Range: 0x2BBD30 -> 0x2BBDA4
// this: r19
void zUIBox::DoReset() {
    /* anonymous block */ {
        // Range: 0x2BBD30 -> 0x2BBDA4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBDB0 -> 0x002BBDF0
*/
// Range: 0x2BBDB0 -> 0x2BBDF0
// this: r16
void zUIBox::DoInit() {
    /* anonymous block */ {
        // Range: 0x2BBDB0 -> 0x2BBDF0
