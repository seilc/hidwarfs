/*
    Compile unit: C:\TestBuild\in\GAME\zSmashRing.cpp
...
static class module_type * module; // size: 0x4, address: 0x609728
...
public:
    ...
    class ring_type * rings; // offset 0x4, size 0x4
    signed int rings_max; // offset 0x8, size 0x4
    signed int rings_used; // offset 0xC, size 0x4
    class RwRaster * rasters[32]; // offset 0x10, size 0x80
    signed int rasters_used; // offset 0x90, size 0x4
    class activity_data * ring_emitters; // offset 0x94, size 0x4
    signed int ring_emitters_max; // offset 0x98, size 0x4
    signed int ring_emitters_used; // offset 0x9C, size 0x4
    class emitter_id_node * emitter_id_buffer; // offset 0xA0, size 0x4
    class emitter_id_node * emitter_id_head; // offset 0xA4, size 0x4
    signed int emitter_ids_max; // offset 0xA8, size 0x4
};
// total size: 0x0
class xGrid {};
// total size: 0x2C
...
// total size: 0x4
class emitter_id_node {
    // Members
public:
    class emitter_id_node * next; // offset 0x0, size 0x4
};
// total size: 0x0
...
public:
    ...
    signed int segments; // offset 0x4, size 0x4
    ...
    class xColor_tag color0; // offset 0x4C, size 0x4
    class xColor_tag color1; // offset 0x50, size 0x4
};
// total size: 0x8
class xBaseAsset {
    // Members
...
public:
    ...
    class config_type * cfg; // offset 0x4, size 0x4
    signed int raster_id; // offset 0x8, size 0x4
    signed int emitter_id; // offset 0xC, size 0x4
    signed int ring_index; // offset 0x10, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049AE40 -> 0x0049B2F4
*/
// Range: 0x49AE40 -> 0x49B2F4
// this: r17
void zSmashRingEmitter::update(float dt /* r29+0x60 */) {
    /* anonymous block */ {
        // Range: 0x49AE40 -> 0x49B2F4
        float s0; // r28
        float s1; // r29+0x60
        ...
        float dr; // r25
        float ds; // r24
        float force_scale; // r23
        float force_damp; // r22
        float r; // r21
        float s; // r20
        float force; // r29+0x60
        float tpeak; // r29+0x60
        float ypeak; // r29+0x60
        float tfall; // r29+0x60
        float alpha1; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B300 -> 0x0049B620
*/
// Range: 0x49B300 -> 0x49B620
// this: r18
void zSmashRingEmitter::start(class config_type & cfg /* r17 */, class xVec3 & center /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49B300 -> 0x49B620
        float dang; // r20
        float ilife; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B620 -> 0x0049B628
*/
// Range: 0x49B620 -> 0x49B628
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B630 -> 0x0049B674
*/
// Range: 0x49B630 -> 0x49B674
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B680 -> 0x0049B724
*/
// Range: 0x49B680 -> 0x49B724
void zSmashRingUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x49B680 -> 0x49B724
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B730 -> 0x0049B794
*/
// Range: 0x49B730 -> 0x49B794
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B7A0 -> 0x0049B7AC
*/
// Range: 0x49B7A0 -> 0x49B7AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B7B0 -> 0x0049B928
*/
// Range: 0x49B7B0 -> 0x49B928
void zSmashRingSceneEnter() {
    /* anonymous block */ {
        // Range: 0x49B7B0 -> 0x49B928
        class module_type * module'79; // r2
        signed int max_rings; // r18
        signed int ring_emitters_max; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049B930 -> 0x0049BC70
*/
// Range: 0x49B930 -> 0x49BC70
// this: r21
static void module_type::render_rings() {
    /* anonymous block */ {
        // Range: 0x49B930 -> 0x49BC70
        class HIFastIMLockStruct lock; // r29+0xA0
        class xVec3 * pos; // r2
        class xVec2 * uv; // r20
        unsigned int * color; // r19
        signed int verts_size; // r18
        signed int last_raster_id; // r30
        class ring_type * ring; // r17
        class ring_type * end_ring; // r2
        signed int raster_id; // r16
        class ring_type * batch_ring; // r4
        float Cx; // r14
        float Cz; // r13
        float Ay; // r12
        float By; // r11
        float r0; // r10
        float r1; // r9
        unsigned int color0; // r7
        unsigned int color1; // r6
        float du; // r8
        float dsin; // r7
        float dcos; // r6
        float u; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049BC70 -> 0x0049BE50
*/
// Range: 0x49BC70 -> 0x49BE50
// this: r2
static void module_type::update_rings(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x49BC70 -> 0x49BE50
        class ring_type * ring; // r5
        class ring_type * end_ring; // r3
        float t; // r29
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049BE50 -> 0x0049BF04
*/
// Range: 0x49BE50 -> 0x49BF04
// this: r16
static signed int module_type::find_unused_raster() {
    /* anonymous block */ {
        // Range: 0x49BE50 -> 0x49BF04
        unsigned char used[32]; // r29+0x20
        class ring_type * ring; // r5
        class ring_type * end_ring; // r2
        signed int i; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049BF10 -> 0x0049BFB4
*/
// Range: 0x49BF10 -> 0x49BFB4
// this: r17
static signed int module_type::get_raster_id(class RwRaster * raster /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49BF10 -> 0x49BFB4
        signed int i; // r2
        signed int unused; // r2
    }
}
