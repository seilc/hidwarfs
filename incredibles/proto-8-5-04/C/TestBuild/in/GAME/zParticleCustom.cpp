/*
    Compile unit: C:\TestBuild\in\GAME\zParticleCustom.cpp
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x609730
static // total size: 0x14
class /* @class */ {
    // Members
public:
    signed int spark; // offset 0x0, size 0x4
    signed int glint; // offset 0x4, size 0x4
    signed int pebble; // offset 0x8, size 0x4
    signed int dust; // offset 0xC, size 0x4
    signed int dust_puff; // offset 0x10, size 0x4
} system_id; // size: 0x14, address: 0x6C5950
static float dust_vel_decay; // size: 0x4, address: 0x609738
signed int update_dust_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x49C550
signed int update_pebble_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x49CD30
signed int update_glint_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x49D430
signed int update_spark_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x49DB30
...
public:
    ...
    class xVec3 vel; // offset 0x1C, size 0xC
...
public:
    ...
    class xVec3 vel; // offset 0x24, size 0xC
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049BFC0 -> 0x0049BFE8
*/
// Range: 0x49BFC0 -> 0x49BFE8
void zParticleCustomUpdate(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x49BFC0 -> 0x49BFE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049BFF0 -> 0x0049C1C4
*/
// Range: 0x49BFF0 -> 0x49C1C4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C1D0 -> 0x0049C54C
*/
// Range: 0x49C1D0 -> 0x49C54C
void zParticleCustomEmitDust(class xVec3 * loc /* r21 */, class xVec3 * vel /* r20 */, signed int amount /* r19 */, float alpha /* r29+0xC0 */, float life_min /* r26 */, float life_range /* r25 */, float size_min /* r24 */, float size_range /* r23 */, float scale_yoffset /* r22 */, float dt /* r29+0xC0 */) {
    /* anonymous block */ {
        // Range: 0x49C1D0 -> 0x49C54C
        unsigned int ualpha; // r2
        float age; // r21
        float dage; // r20
        unsigned char * mem; // r29+0xBC
        signed int have; // r2
        class dust_particle * p; // r18
        class dust_particle * endp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C550 -> 0x0049CADC
*/
// Range: 0x49C550 -> 0x49CADC
static signed int update_dust_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x49C550 -> 0x49CADC
        class ptank_pool__pos_color_size_uv2 & _fptank_pool; // r19
        signed int _fptank_used; // r9
        class xVec3 * pool_pos; // r7
        class xColor_tag * pool_color; // r4
        class xVec2 * pool_size; // r3
        class xVec2 * pool_uv; // r2
        float vel_decay; // r22
        class dust_particle * p; // r18
        class dust_particle * end; // r17
        float t1; // r21
        float size; // r20
        class xVec4 loc; // r29+0x90
        float t2; // r5
        float max_alpha; // r29+0xC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CAE0 -> 0x0049CD24
*/
// Range: 0x49CAE0 -> 0x49CD24
void zParticleCustomEmitPebble(class xVec3 * loc /* r21 */, class xVec3 * vel /* r20 */, signed int amount /* r19 */, float plane_y /* r25 */, float size_min /* r24 */, float size_range /* r23 */, float dt /* r29+0xA0 */) {
    /* anonymous block */ {
        // Range: 0x49CAE0 -> 0x49CD24
        float age; // r22
        float dage; // r21
        ...
        signed int have; // r2
        class pebble_particle * p; // r18
        class pebble_particle * endp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CD30 -> 0x0049D174
*/
// Range: 0x49CD30 -> 0x49D174
static signed int update_pebble_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x49CD30 -> 0x49D174
        class ptank_pool__pos_color_size & _fptank_pool; // r19
        signed int _fptank_used; // r2
        class xVec3 * pool_pos; // r5
        class xColor_tag * pool_color; // r4
        class xVec2 * pool_size; // r3
        class pebble_particle * p; // r18
        class pebble_particle * end; // r17
        float oldy; // r29+0xC0
        float plane_y; // r29+0xC0
        float under; // r29+0xC0
        class xVec4 loc; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D180 -> 0x0049D430
*/
// Range: 0x49D180 -> 0x49D430
void zParticleCustomEmitGlint(class xVec3 * loc /* r21 */, class xVec3 * vel /* r20 */, float * length_vel /* r19 */, signed int amount /* r18 */, float life_min /* r29 */, float life_range /* r28 */, float width_min /* r27 */, float width_range /* r26 */, float length_min /* r25 */, float length_range /* r24 */, float length_clamp_min /* r23 */, float length_clamp_range /* r22 */, float dt /* r29+0xD0 */) {
    /* anonymous block */ {
        // Range: 0x49D180 -> 0x49D430
        float age; // r21
        float dage; // r20
        ...
        signed int have; // r2
        class glint_particle * p; // r17
        class glint_particle * endp; // r2
        float rlen; // r29+0xD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D430 -> 0x0049D914
*/
// Range: 0x49D430 -> 0x49D914
static signed int update_glint_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x49D430 -> 0x49D914
        class ptank_pool__color_mat & _fptank_pool; // r19
        signed int _fptank_used; // r4
        class xColor_tag * pool_color; // r3
        class xMat4x3 * pool_mat; // r2
        class xMat4x3 & cam_mat; // r2
        float Ax; // r22
        float Ay; // r21
        float Az; // r20
        class glint_particle * p; // r18
        class glint_particle * end; // r17
        float age1; // r29+0xD0
        float t1; // r31
        float length; // r7
        float Vx; // r30
        float Vy; // r29
        float Vz; // r28
        float Uscale; // r29+0xD0
        float Ux; // r27
        float Uy; // r26
        float Uz; // r25
        class xVec4 loc; // r29+0xB0
        float Rx; // r29+0xD0
        float Ry; // r29+0xD0
        float Rz; // r29+0xD0
        float Rscale; // r29+0xD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D920 -> 0x0049DB2C
*/
// Range: 0x49D920 -> 0x49DB2C
void zParticleCustomEmitSpark(class xVec3 * loc /* r21 */, class xVec3 * vel /* r20 */, signed int amount /* r19 */, float life_min /* r25 */, float life_range /* r24 */, float size_min /* r23 */, float size_range /* r22 */, float dt /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x49D920 -> 0x49DB2C
        float age; // r21
        float dage; // r20
        ...
        signed int have; // r2
        class spark_particle * p; // r18
        class spark_particle * endp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DB30 -> 0x0049DF18
*/
// Range: 0x49DB30 -> 0x49DF18
static signed int update_spark_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x49DB30 -> 0x49DF18
        class ptank_pool__pos_color_size & _fptank_pool; // r19
        signed int _fptank_used; // r7
        class xVec3 * pool_pos; // r4
        class xColor_tag * pool_color; // r3
        class xVec2 * pool_size; // r2
        class spark_particle * p; // r18
        class spark_particle * end; // r17
        float age1; // r29+0xC0
        float t1; // r20
        class xVec4 loc; // r29+0x90
    }
