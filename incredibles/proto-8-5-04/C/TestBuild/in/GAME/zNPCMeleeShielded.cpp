/*
    Compile unit: C:\TestBuild\in\GAME\zNPCMeleeShielded.cpp
...
static class config electricity_config; // size: 0x48, address: 0x688830
// total size: 0xB4
struct /* @anon1 */ {} zNPC::melee_shielded::__vtable; // size: 0xB4, address: 0x602140
// total size: 0xA4
struct /* @anon6 */ {} zNPC::shield::__vtable; // size: 0xA4, address: 0x6022A0
// total size: 0x7C
struct /* @anon5 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon2 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x98
struct /* @anon4 */ {} zNPC::shield_protect::__vtable; // size: 0x98, address: 0x602200
// total size: 0x98
struct /* @anon3 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x7C
struct /* @anon0 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
unsigned int andont_high_block(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x2CECC0
unsigned int anhigh_block(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x2CEDD0
unsigned int anarrived(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x2CEEE0
...
void shield_event_wrapper(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2CF8E0
// total size: 0x170
class shield : public xEnt, public behavior_implementation {
    // Members
public:
    class xMat4x3 mat; // offset 0xF0, size 0x40
    unsigned char shielded; // offset 0x130, size 0x1
    class zShrapnelAsset * shrapnel; // offset 0x134, size 0x4
    signed int shield_damage; // offset 0x138, size 0x4
    float emit_remaining; // offset 0x13C, size 0x4
    float offset; // offset 0x140, size 0x4
    float shift; // offset 0x144, size 0x4
    class xVec3 start; // offset 0x148, size 0xC
    class xVec3 end; // offset 0x154, size 0xC
    class xVec3 right; // offset 0x160, size 0xC
};
// total size: 0x20
class xQCData {
    // Members
...
// total size: 0x40
class shield_protect : public npc_move {
    // Members
public:
    class shield & owners_shield; // offset 0x34, size 0x4
    float high_block_radius; // offset 0x38, size 0x4
    float high_block_height; // offset 0x3C, size 0x4
};
// total size: 0x38
class circle {
    // Members
...
// total size: 0x8B0
class melee_shielded : public melee {
    // Members
public:
    class shield_protect protect_state; // offset 0x700, size 0x40
    class shield shield_state; // offset 0x740, size 0x170
};
// total size: 0x30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CE8A0 -> 0x002CE8E0
*/
// Range: 0x2CE8A0 -> 0x2CE8E0
// this: r16
void melee_shielded::setup() {
    /* anonymous block */ {
        // Range: 0x2CE8A0 -> 0x2CE8E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CE8F0 -> 0x002CE930
*/
// Range: 0x2CE8F0 -> 0x2CE930
// this: r16
void melee_shielded::reset() {
    /* anonymous block */ {
        // Range: 0x2CE8F0 -> 0x2CE930
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CE930 -> 0x002CE9E4
*/
// Range: 0x2CE930 -> 0x2CE9E4
// this: r16
melee_shielded::melee_shielded() {
    /* anonymous block */ {
        // Range: 0x2CE930 -> 0x2CE9E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CE9F0 -> 0x002CEA50
*/
// Range: 0x2CE9F0 -> 0x2CEA50
// this: r16
void shield_protect::setup() {
    /* anonymous block */ {
        // Range: 0x2CE9F0 -> 0x2CEA50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CEA50 -> 0x002CEAE8
*/
// Range: 0x2CEA50 -> 0x2CEAE8
// this: r16
void shield_protect::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2CEA50 -> 0x2CEAE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CEAF0 -> 0x002CEB18
*/
// Range: 0x2CEAF0 -> 0x2CEB18
// this: r2
void shield_protect::enter_state() {
    /* anonymous block */ {
        // Range: 0x2CEAF0 -> 0x2CEB18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CEB20 -> 0x002CECB4
*/
// Range: 0x2CEB20 -> 0x2CECB4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CEF20 -> 0x002CF048
*/
// Range: 0x2CEF20 -> 0x2CF048
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF050 -> 0x002CF2AC
*/
// Range: 0x2CF050 -> 0x2CF2AC
// this: r16
void shield::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2CF050 -> 0x2CF2AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF2B0 -> 0x002CF494
*/
// Range: 0x2CF2B0 -> 0x2CF494
// this: r16
void shield::player_collide() {
    /* anonymous block */ {
        // Range: 0x2CF2B0 -> 0x2CF494
        class xVec3 damage_pos; // r29+0x80
        class xVec3 damage_dir; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF4A0 -> 0x002CF4A8
*/
// Range: 0x2CF4A0 -> 0x2CF4A8
// this: r2
void shield::kill() {
    /* anonymous block */ {
        // Range: 0x2CF4A0 -> 0x2CF4A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF4B0 -> 0x002CF4FC
*/
// Range: 0x2CF4B0 -> 0x2CF4FC
// this: r16
void shield::reset() {
    /* anonymous block */ {
        // Range: 0x2CF4B0 -> 0x2CF4FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF500 -> 0x002CF788
*/
// Range: 0x2CF500 -> 0x2CF788
// this: r16
void shield::setup() {
    /* anonymous block */ {
        // Range: 0x2CF500 -> 0x2CF788
        class xVec3 default_lower; // r29+0x60
        class xVec3 default_upper; // r29+0x50
        char * name; // r29+0x6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF790 -> 0x002CF850
*/
// Range: 0x2CF790 -> 0x2CF850
// this: r16
unsigned char shield::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CF790 -> 0x2CF850
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF850 -> 0x002CF8D8
*/
// Range: 0x2CF850 -> 0x2CF8D8
static void set_model_flags(class xModelInstance * m /* r2 */, signed int which_piece_min /* r2 */, signed int which_piece_max /* r2 */, unsigned short flags /* r2 */, unsigned char and_flags /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CF850 -> 0x2CF8D8
        signed int i; // r9
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CF8E0 -> 0x002CFB7C
*/
// Range: 0x2CF8E0 -> 0x2CFB7C
static void shield_event_wrapper(class xBase * from /* r2 */, class xBase * to /* r16 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CF8E0 -> 0x2CFB7C
    }
}
