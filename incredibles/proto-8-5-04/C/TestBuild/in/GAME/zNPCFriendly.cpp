/*
    Compile unit: C:\TestBuild\in\GAME\zNPCFriendly.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x7C
struct /* @anon5 */ {} zNPC::buddy_anim::__vtable; // size: 0x7C, address: 0x601630
// total size: 0x7C
...
// total size: 0xB4
struct /* @anon2 */ {} zNPC::friendly::__vtable; // size: 0xB4, address: 0x6016B0
class zGlobals globals; // size: 0x640, address: 0x61C210
// total size: 0x98
struct /* @anon3 */ {} zNPC::speak::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon7 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x7C
...
// total size: 0x5C
class speak : public npc_move {
    // Members
public:
    unsigned char draw_talk_symbol; // offset 0x34, size 0x1
    unsigned char speaking; // offset 0x35, size 0x1
    unsigned char talkative; // offset 0x36, size 0x1
    float tmr_cycleAnim; // offset 0x38, size 0x4
    float tmr_minTalk; // offset 0x3C, size 0x4
    enum iSndGroupHandle soundgroup; // offset 0x40, size 0x4
    enum iSndHandle soundhandle; // offset 0x44, size 0x4
    void * jawdata; // offset 0x48, size 0x4
    float jawtime; // offset 0x4C, size 0x4
    class ztaskbox * task; // offset 0x50, size 0x4
    float max_talk_distance_2; // offset 0x54, size 0x4
    float speak_distance_2; // offset 0x58, size 0x4
};
// total size: 0x4
class triangle {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2E60 -> 0x002C2EC4
*/
// Range: 0x2C2E60 -> 0x2C2EC4
// this: r16
friendly::friendly() {
    /* anonymous block */ {
        // Range: 0x2C2E60 -> 0x2C2EC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2ED0 -> 0x002C2F18
*/
// Range: 0x2C2ED0 -> 0x2C2F18
// this: r2
unsigned char buddy_anim::system_event(unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C2ED0 -> 0x2C2F18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2F20 -> 0x002C2F48
*/
// Range: 0x2C2F20 -> 0x2C2F48
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2F50 -> 0x002C2FAC
*/
// Range: 0x2C2F50 -> 0x2C2FAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C2FB0 -> 0x002C3050
*/
// Range: 0x2C2FB0 -> 0x2C3050
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3050 -> 0x002C3078
*/
// Range: 0x2C3050 -> 0x2C3078
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3080 -> 0x002C30D4
*/
// Range: 0x2C3080 -> 0x2C30D4
