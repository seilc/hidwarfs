/*
    Compile unit: C:\TestBuild\in\GAME\zEntButton.cpp
...
static float sRedMultiplier; // size: 0x4, address: 0x60760C
static float sGreenMultiplier; // size: 0x4, address: 0x607610
static float sBlueMultiplier; // size: 0x4, address: 0x607614
static float sColorMultiplier; // size: 0x4, address: 0x0
static signed int sColorMultiplierSign; // size: 0x4, address: 0x0
...
void zEntButtonEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x12D4C0
void zEntButton_Render(class _zEntButton *); // size: 0x0, address: 0x12DB70
void zEntButton_Move(class _zEntButton *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x12E130
void zEntButton_Update(class _zEntButton *, class xScene *, float); // size: 0x0, address: 0x12DC20
// total size: 0x50
class xEntMPData {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D4C0 -> 0x0012D958
*/
// Range: 0x12D4C0 -> 0x12D958
void zEntButtonEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12D4C0 -> 0x12D958
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D960 -> 0x0012DAC4
*/
// Range: 0x12D960 -> 0x12DAC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DAD0 -> 0x0012DB68
*/
// Range: 0x12DAD0 -> 0x12DB68
void zEntButton_Press(class _zEntButton * ent /* r16 */, unsigned int mask /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12DAD0 -> 0x12DB68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DB70 -> 0x0012DC1C
*/
// Range: 0x12DB70 -> 0x12DC1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DC20 -> 0x0012DF00
*/
// Range: 0x12DC20 -> 0x12DF00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DF00 -> 0x0012DFE0
*/
// Range: 0x12DF00 -> 0x12DFE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DFE0 -> 0x0012E05C
*/
// Range: 0x12DFE0 -> 0x12E05C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E060 -> 0x0012E0E4
*/
// Range: 0x12E060 -> 0x12E0E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E0F0 -> 0x0012E12C
*/
// Range: 0x12E0F0 -> 0x12E12C
void zEntButton_Setup(class _zEntButton * ent /* r17 */, class xScene * sc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12E0F0 -> 0x12E12C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E130 -> 0x0012E1C0
*/
// Range: 0x12E130 -> 0x12E1C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E1C0 -> 0x0012E358
*/
// Range: 0x12E1C0 -> 0x12E358
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E360 -> 0x0012E368
*/
// Range: 0x12E360 -> 0x12E368
