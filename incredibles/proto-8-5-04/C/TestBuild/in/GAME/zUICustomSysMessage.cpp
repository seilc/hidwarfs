/*
    Compile unit: C:\TestBuild\in\GAME\zUICustomSysMessage.cpp
...
enum enVERIFY_CONTENT g_current_content_verify; // size: 0x4, address: 0x0
enum enREMOVE_CONTENT g_current_content_remove; // size: 0x4, address: 0x0
enum enLOCAL_CONTENT g_current_content_local; // size: 0x4, address: 0x0
char buff_final[256]; // size: 0x100, address: 0x0
// total size: 0x4C
struct /* @anon1 */ {} zUICustomSysMessageManager::__vtable; // size: 0x4C, address: 0x607380
class zGlobals globals; // size: 0x640, address: 0x61C210
// total size: 0x4C
struct /* @anon0 */ {} zUICustom::__vtable; // size: 0x4C, address: 0x606100
// total size: 0x8
class zUICustom {
    // Members
public:
...
class zUICustomSysMessageManager : public zUICustom {
    // Members
public:
    void (* cb_function)(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // offset 0x8, size 0x4
    unsigned int toCBEvent; // offset 0xC, size 0x4
    float toCBParams[4]; // offset 0x10, size 0x10
    class xBase * toCBto; // offset 0x20, size 0x4
    class xBase * toCBParamWidget; // offset 0x24, size 0x4
    unsigned int toCBParamWidgetID; // offset 0x28, size 0x4
    class zUI * fromUI; // offset 0x2C, size 0x4
    class zUIText * itemOk; // offset 0x30, size 0x4
    class zUIText * itemYes; // offset 0x34, size 0x4
    class zUIText * itemNo; // offset 0x38, size 0x4
    class zUIText * itemMsg; // offset 0x3C, size 0x4
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495830 -> 0x00495874
*/
// Range: 0x495830 -> 0x495874
// this: r2
void zUICustomSysMessageManager::ShowSystemMessage(void (* cb)(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int) /* r2 */, unsigned int _toCBEvent /* r2 */, float * _toCBParams /* r2 */, class xBase * _toCBto /* r2 */, class xBase * _toCBParamWidget /* r2 */, unsigned int _toCBParamWidgetID /* r2 */, char * sys_message /* r29 */) {
    /* anonymous block */ {
        // Range: 0x495830 -> 0x495874
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495880 -> 0x004959F0
*/
// Range: 0x495880 -> 0x4959F0
// this: r19
unsigned char zUICustomSysMessageManager::HandleEvent(class xBase * from /* r18 */, unsigned int toEvent /* r17 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x495880 -> 0x4959F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004959F0 -> 0x00495A28
*/
// Range: 0x4959F0 -> 0x495A28
// this: r2
unsigned char zUICustomSysMessageManager::IsSignalAllowed(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4959F0 -> 0x495A28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495A30 -> 0x00495AC0
*/
// Range: 0x495A30 -> 0x495AC0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495AC0 -> 0x00495B0C
*/
// Range: 0x495AC0 -> 0x495B0C
// this: r2
zUICustomSysMessageManager::zUICustomSysMessageManager(class zUI * ui /* r2 */) {
    /* anonymous block */ {
        // Range: 0x495AC0 -> 0x495B0C
    }
}
