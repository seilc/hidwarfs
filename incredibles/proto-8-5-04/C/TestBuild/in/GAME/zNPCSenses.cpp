/*
    Compile unit: C:\TestBuild\in\GAME\zNPCSenses.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00421E00 -> 0x00421F64
*/
// Range: 0x421E00 -> 0x421F64
// this: r17
unsigned char Senses::WorldRayLOS(class xVec3 & start /* r2 */, class xVec3 & dir /* r2 */, float dist /* r29+0xC0 */) {
    /* anonymous block */ {
        // Range: 0x421E00 -> 0x421F64
        class xRay3 ray; // r29+0x90
        class xCollis collisionRecord; // r29+0x30
        class xEnt * grabbed; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00421F70 -> 0x00422514
*/
// Range: 0x421F70 -> 0x422514
// this: r18
unsigned char Senses::CheckLOS(class common * owner /* r17 */) {
    /* anonymous block */ {
        // Range: 0x421F70 -> 0x422514
        float time; // r26
        unsigned char lastCanSee; // r2
        class xVec3 newTargetPos; // r29+0xF0
        class xVec3 newTargetDir; // r29+0xE0
        class xVec3 newAimPos; // r29+0xD0
        class xVec3 newAimDir; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00422520 -> 0x004227E4
*/
// Range: 0x422520 -> 0x4227E4
// this: r17
void Senses::Update(class common * owner /* r16 */, float dt /* r29+0x90 */) {
    /* anonymous block */ {
        // Range: 0x422520 -> 0x4227E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004227F0 -> 0x00422B68
*/
// Range: 0x4227F0 -> 0x422B68
// this: r18
void Senses::AlertTargetPos(class common * owner /* r17 */, class xVec3 & newTargetPos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4227F0 -> 0x422B68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00422B70 -> 0x00422B78
*/
// Range: 0x422B70 -> 0x422B78
// this: r2
unsigned char Senses::CanSeeTarget() {
    /* anonymous block */ {
        // Range: 0x422B70 -> 0x422B78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00422B80 -> 0x00422BA0
*/
// Range: 0x422B80 -> 0x422BA0
// this: r2
unsigned char Senses::HasTarget() {
    /* anonymous block */ {
        // Range: 0x422B80 -> 0x422BA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00422BA0 -> 0x00422F78
*/
// Range: 0x422BA0 -> 0x422F78
// this: r17
void Senses::Reset(class common * owner /* r16 */) {
    /* anonymous block */ {
        // Range: 0x422BA0 -> 0x422F78
        class xVec2 safety; // r29+0x98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00422F80 -> 0x004230D4
*/
// Range: 0x422F80 -> 0x4230D4
// this: r17
void Senses::Setup(class common * owner /* r16 */) {
    /* anonymous block */ {
        // Range: 0x422F80 -> 0x4230D4
    }
}
