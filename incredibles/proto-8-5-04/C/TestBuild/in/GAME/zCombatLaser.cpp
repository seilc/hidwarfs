/*
    Compile unit: C:\TestBuild\in\GAME\zCombatLaser.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float RAY_CHECK_FREQUENCY; // size: 0x4, address: 0x5E8E80
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
float scale; // size: 0x4, address: 0x0
static class RwRaster * laser_raster; // size: 0x4, address: 0x0
static enum iSndGroupHandle laser_soundgroup; // size: 0x4, address: 0x6078F8
static enum iSndGroupHandle laser_splash_soundgroup; // size: 0x4, address: 0x6078FC
static enum iSndGroupHandle impact_laser_soundgroup; // size: 0x4, address: 0x607900
signed int splash; // size: 0x4, address: 0x608D5C
signed int laser_count; // size: 0x4, address: 0x608D60
class RwRaster * laser_raster; // size: 0x4, address: 0x608D64
class RxObjSpace3DVertex * vert; // size: 0x4, address: 0x608D68
class emit_context context; // size: 0x54, address: 0x67F120
static unsigned int oldsrcblend; // size: 0x4, address: 0x608D6C
static unsigned int olddestblend; // size: 0x4, address: 0x608D70
static unsigned int oldcullmode; // size: 0x4, address: 0x608D74
static unsigned int oldvertexalphaenable; // size: 0x4, address: 0x608D78
// total size: 0x20
struct /* @anon0 */ {} z::laser::__vtable; // size: 0x20, address: 0x5FD6E0
...
void zLaserLavaEmit(float, class zTimeHandlerStruct *); // size: 0x0, address: 0x1FD4E0
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
// total size: 0x20
struct /* @anon1 */ {} z::lightweight<z::laser, 40>::__vtable; // size: 0x20, address: 0x5FD700
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FB2E0 -> 0x001FB3AC
*/
// Range: 0x1FB2E0 -> 0x1FB3AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FB3B0 -> 0x001FB994
*/
// Range: 0x1FB3B0 -> 0x1FB994
// this: r2
void laser::post_render_2d() {
    /* anonymous block */ {
        // Range: 0x1FB3B0 -> 0x1FB994
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FB9A0 -> 0x001FBA8C
*/
// Range: 0x1FB9A0 -> 0x1FBA8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FBA90 -> 0x001FCA68
*/
// Range: 0x1FBA90 -> 0x1FCA68
// this: r20
void laser::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1FBA90 -> 0x1FCA68
        class xSurface * impact_surface; // r2
        class zSurfAssetIN * asset; // r2
        class xVec3 glare_position; // r29+0x470
        class xRay3 ray; // r29+0x220
        class xCollis coll; // r29+0x1C0
        class xIsect isect; // r29+0x190
        unsigned short userData; // r29+0x47E
        class xMat4x3 mat; // r29+0x150
        class xVec3 glare_position; // r29+0x460
        class xVec3 knockback; // r29+0x450
        class zEntSimpleObj * reactive_hits[8]; // r29+0x130
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FCA70 -> 0x001FCFDC
*/
// Range: 0x1FCA70 -> 0x1FCFDC
// this: r18
void laser::ground_effects() {
    /* anonymous block */ {
        // Range: 0x1FCA70 -> 0x1FCFDC
        class xVec3 info_pos; // r29+0x120
        class xSurface * impact_surface; // r2
        class xVec3 dir; // r29+0x110
        class xVec3 pos; // r29+0x100
        signed int glareIdx; // r17
        class zBulletMarkAsset * mark; // r2
        class xVec3 normal; // r29+0xF0
        class zTimeHandlerStruct hit; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FCFE0 -> 0x001FD0E0
*/
// Range: 0x1FCFE0 -> 0x1FD0E0
// this: r16
void laser::calc_predicted_lifetime(float max_laser_distance /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1FCFE0 -> 0x1FD0E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FD0E0 -> 0x001FD2F8
*/
// Range: 0x1FD0E0 -> 0x1FD2F8
// this: r16
laser::laser(class xBase * firing_entity /* r2 */, class xVec3 & start /* r2 */, class xVec3 & direction /* r2 */, float speed /* r29+0x50 */, float length /* r29+0x50 */, float thickness /* r29+0x50 */, signed int damage /* r2 */, float shake /* r29+0x50 */, float max_laser_distance /* r20 */, float knockback_speed /* r29+0x50 */, unsigned int markID /* r2 */, unsigned char use_glare /* r2 */, class xColor_tag & color /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1FD0E0 -> 0x1FD2F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FD300 -> 0x001FD328
*/
// Range: 0x1FD300 -> 0x1FD328
// this: r2
laser::laser() {
    /* anonymous block */ {
        // Range: 0x1FD300 -> 0x1FD328
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FD330 -> 0x001FD4E0
*/
// Range: 0x1FD330 -> 0x1FD4E0
void setup() {
    /* anonymous block */ {
        // Range: 0x1FD330 -> 0x1FD4E0
        class RwTexture * laser_texture; // r2
        unsigned int laser_soundgroup_id; // r2
        class RwTexture * burn_mark_texture; // r2
        class xResponseCurve curve; // @ 0x0067F180
        class curve_node burn_curve[3]; // @ 0x005E8E90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FD4E0 -> 0x001FD518
*/
// Range: 0x1FD4E0 -> 0x1FD518
static void zLaserLavaEmit(float dt /* r29 */, class zTimeHandlerStruct * handler /* r4 */) {
    /* anonymous block */ {
        // Range: 0x1FD4E0 -> 0x1FD518
    }
}
