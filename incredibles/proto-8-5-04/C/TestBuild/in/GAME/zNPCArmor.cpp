/*
    Compile unit: C:\TestBuild\in\GAME\zNPCArmor.cpp
...
signed int numArmorNPC; // size: 0x4, address: 0x6090E0
// total size: 0x7C
struct /* @anon0 */ {} zNPC::Armor::__vtable; // size: 0x7C, address: 0x603A00
unsigned int ErrorCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x0
...
// total size: 0xC60
class Armor : public behavior_implementation {
    // Members
public:
    unsigned char isEnabled; // offset 0x10, size 0x1
    unsigned char isFinished; // offset 0x11, size 0x1
    unsigned char isExclusive; // offset 0x12, size 0x1
    unsigned char startFallBack; // offset 0x13, size 0x1
    signed int armorHitPointsInitial; // offset 0x14, size 0x4
    signed int armorHitPoints; // offset 0x18, size 0x4
    signed int numArmor; // offset 0x1C, size 0x4
    signed int numArmorRemaining; // offset 0x20, size 0x4
    signed int finishCount; // offset 0x24, size 0x4
    enum iSndGroupHandle breakingArmorSound; // offset 0x28, size 0x4
    // total size: 0x60
    class /* @class */ {
        // Members
    public:
        ...
        class zShrapnelAsset * shrapnelAsset; // offset 0x50, size 0x4
        unsigned char isActive; // offset 0x54, size 0x1
    } armorInstance[32]; // offset 0x30, size 0xC00
    float length; // offset 0xC30, size 0x4
    class xModelTag tag; // offset 0xC34, size 0x20
};
// total size: 0x14
class RxIoSpec {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AAE0 -> 0x0031AAE8
*/
// Range: 0x31AAE0 -> 0x31AAE8
// this: r2
unsigned char Armor::runnable() {
    /* anonymous block */ {
        // Range: 0x31AAE0 -> 0x31AAE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AAF0 -> 0x0031AAF8
*/
// Range: 0x31AAF0 -> 0x31AAF8
void render_extra() {
    /* anonymous block */ {
        // Range: 0x31AAF0 -> 0x31AAF8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AB00 -> 0x0031AC38
*/
// Range: 0x31AB00 -> 0x31AC38
// this: r18
void Armor::render() {
    /* anonymous block */ {
        // Range: 0x31AB00 -> 0x31AC38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AC40 -> 0x0031ACB4
*/
// Range: 0x31AC40 -> 0x31ACB4
// this: r16
void Armor::update() {
    /* anonymous block */ {
        // Range: 0x31AC40 -> 0x31ACB4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031ACC0 -> 0x0031AED4
*/
// Range: 0x31ACC0 -> 0x31AED4
// this: r20
unsigned char Armor::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x31ACC0 -> 0x31AED4
        signed int numNow; // r2
        signed int numToRemove; // r19
        signed int i; // r18
        signed int iStart; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AEE0 -> 0x0031AF18
*/
// Range: 0x31AEE0 -> 0x31AF18
// this: r2
unsigned char Armor::system_event(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x31AEE0 -> 0x31AF18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AF20 -> 0x0031AF84
*/
// Range: 0x31AF20 -> 0x31AF84
// this: r2
void Armor::reset() {
    /* anonymous block */ {
        // Range: 0x31AF20 -> 0x31AF84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AF90 -> 0x0031AFA4
*/
// Range: 0x31AF90 -> 0x31AFA4
// this: r2
void Armor::init() {
    /* anonymous block */ {
        // Range: 0x31AF90 -> 0x31AFA4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AFB0 -> 0x0031AFB8
*/
// Range: 0x31AFB0 -> 0x31AFB8
void setup() {
    /* anonymous block */ {
        // Range: 0x31AFB0 -> 0x31AFB8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AFC0 -> 0x0031AFC8
*/
// Range: 0x31AFC0 -> 0x31AFC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AFD0 -> 0x0031AFD8
*/
// Range: 0x31AFD0 -> 0x31AFD8
void add_states() {
    /* anonymous block */ {
        // Range: 0x31AFD0 -> 0x31AFD8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0031AFE0 -> 0x0031B290
*/
// Range: 0x31AFE0 -> 0x31B290
void AddArmor(class common * owner /* r20 */) {
    /* anonymous block */ {
        // Range: 0x31AFE0 -> 0x31B290
        signed int armorBone; // r29+0x13C
        char * shrapnelName; // r29+0x138
        class zShrapnelAsset * shrapnelAsset; // r19
        char * modelName; // r29+0x134
