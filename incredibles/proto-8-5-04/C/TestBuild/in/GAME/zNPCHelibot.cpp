/*
    Compile unit: C:\TestBuild\in\GAME\zNPCHelibot.cpp
...
signed int system_id; // size: 0x4, address: 0x60958C
float rot_delta; // size: 0x4, address: 0x60846C
float life; // size: 0x4, address: 0x608470
float start_alpha; // size: 0x4, address: 0x608474
float fade_start; // size: 0x4, address: 0x608478
float size; // size: 0x4, address: 0x60847C
float emit_rate; // size: 0x4, address: 0x608480
float slow; // size: 0x4, address: 0x608484
float horizontal_speed; // size: 0x4, address: 0x608488
float max_y; // size: 0x4, address: 0x60848C
float min_y; // size: 0x4, address: 0x608490
class xColor_tag color; // size: 0x4, address: 0x608494
static class xVec3 AIM_TARGET; // size: 0xC, address: 0x5FA268
class xBallPhysicsProperties physics_properties; // size: 0x1C, address: 0x5FA280
// total size: 0xB4
struct /* @anon17 */ {} zNPC::helibot::__vtable; // size: 0xB4, address: 0x605480
signed int update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x44B200
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
class xVec3 g_O3; // size: 0xC, address: 0x5E77C0
unsigned int RobotDestroyCB(class xEnt *, void *, unsigned char); // size: 0x0, address: 0x3343B0
unsigned int zThrowableSystemSmallCollideCB(class xEnt *, class xEnt *, class xVec3 *, class xVec3 *, void *); // size: 0x0, address: 0x4479D0
// total size: 0x7C
struct /* @anon16 */ {} zNPC::bone_container<zNPC::blade_bone>::__vtable; // size: 0x7C, address: 0x602710
// total size: 0x7C
struct /* @anon21 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon20 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon26 */ {} zNPC::bone_container<zNPC::energy_glow_bone>::__vtable; // size: 0x7C, address: 0x605540
// total size: 0x7C
struct /* @anon8 */ {} zNPC::bone_container<zNPC::energy_bone>::__vtable; // size: 0x7C, address: 0x6055C0
// total size: 0x7C
struct /* @anon24 */ {} zNPC::bone_container<zNPC::aim_bone>::__vtable; // size: 0x7C, address: 0x5FE950
// total size: 0x7C
struct /* @anon22 */ {} zNPC::NPCSmokeBehavior::__vtable; // size: 0x7C, address: 0x606850
// total size: 0x7C
struct /* @anon19 */ {} zNPC::hover_effect::__vtable; // size: 0x7C, address: 0x602FD0
// total size: 0x7C
struct /* @anon11 */ {} zNPC::heli_attack::__vtable; // size: 0x7C, address: 0x6056D0
// total size: 0x8C
struct /* @anon3 */ {} zNPC::ball_physics::__vtable; // size: 0x8C, address: 0x603E90
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
class xVec3 m_Null; // size: 0xC, address: 0x5E7C40
// total size: 0xC
struct /* @anon27 */ {} xBallPhysics::__vtable; // size: 0xC, address: 0x604CA0
// total size: 0x7C
struct /* @anon6 */ {} zNPC::timebomb_death::__vtable; // size: 0x7C, address: 0x6040B0
// total size: 0x84
struct /* @anon14 */ {} zNPC::fall_turn_death::__vtable; // size: 0x84, address: 0x605640
// total size: 0x84
struct /* @anon2 */ {} zNPC::fall_swap_death::__vtable; // size: 0x84, address: 0x0
// total size: 0x84
struct /* @anon10 */ {} zNPC::fall_death::__vtable; // size: 0x84, address: 0x603F20
// total size: 0x7C
struct /* @anon18 */ {} zNPC::physics_death::__vtable; // size: 0x7C, address: 0x604030
// total size: 0x7C
struct /* @anon25 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x7C
struct /* @anon4 */ {} zNPC::shrapnel_death::__vtable; // size: 0x7C, address: 0x600F30
// total size: 0x7C
struct /* @anon0 */ {} zNPC::bone_spin::__vtable; // size: 0x7C, address: 0x603AC0
// total size: 0x7C
struct /* @anon9 */ {} zNPC::exclusive_spline_path::__vtable; // size: 0x7C, address: 0x602DD0
// total size: 0x7C
struct /* @anon12 */ {} zNPC::follow_spline_path::__vtable; // size: 0x7C, address: 0x602CD0
// total size: 0x7C
struct /* @anon1 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon7 */ {} zNPC::collide_detect::__vtable; // size: 0x7C, address: 0x602ED0
// total size: 0xB4
struct /* @anon23 */ {} zNPC::flying_npc_generic<zNPC::common>::__vtable; // size: 0xB4, address: 0x602790
...
unsigned int anattack_finished_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x44CC50
unsigned int anis_done_attacking(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x44CCD0
unsigned int anattack_started_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x44CDA0
unsigned int ancan_attack(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x44CE10
// total size: 0x7C
struct /* @anon13 */ {} zNPC::energy_glow_bone::__vtable; // size: 0x7C, address: 0x605750
...
void * __ct(class energy_bone *); // size: 0x0, address: 0x44DA00
void * __ct(class energy_glow_bone *); // size: 0x0, address: 0x44DBB0
// total size: 0x7C
struct /* @anon15 */ {} zNPC::firing_bone::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon5 */ {} zNPC::bone_behavior::__vtable; // size: 0x7C, address: 0x0
// total size: 0xA4
...
// total size: 0x2C
class NPCSmokeBehavior : public behavior_implementation {
    // Members
public:
    unsigned char hasStarted; // offset 0x10, size 0x1
    signed int smokePoints; // offset 0x14, size 0x4
    class zNPCSmokeSystem * NPCSmoke; // offset 0x18, size 0x4
    signed int bone; // offset 0x1C, size 0x4
    float scale; // offset 0x20, size 0x4
...
public:
    ...
    float rot; // offset 0x18, size 0x4
    float rot_delta; // offset 0x1C, size 0x4
...
// total size: 0x670
class helibot : public flying_npc_generic {
    // Members
public:
    class collide_detect collide_detect_state; // offset 0x2D0, size 0x24
    class exclusive_spline_path spline_path_state; // offset 0x300, size 0xB0
    class bone_spin bone_spin_state; // offset 0x3B0, size 0x40
    class explode explode_state; // offset 0x3F0, size 0x54
    class fall_turn_death fall_state; // offset 0x450, size 0x80
    class timebomb_death timebomb_state; // offset 0x4D0, size 0x38
    class ball_physics physics_state; // offset 0x508, size 0x60
    class heli_attack attack_state; // offset 0x568, size 0x4C
    class hover_effect hover; // offset 0x5B4, size 0x28
    class NPCSmokeBehavior NPCSmokeBehaviorState; // offset 0x5DC, size 0x2C
    class bone_container aim_bones; // offset 0x608, size 0x18
    class bone_container energy_bones; // offset 0x620, size 0x18
    class bone_container energy_glow_bones; // offset 0x638, size 0x18
    class bone_container blade_bones; // offset 0x650, size 0x18
};
// total size: 0x5FC
class xEntCollis {
    // Members
...
// total size: 0x4C
class heli_attack : public behavior_implementation {
    // Members
public:
    unsigned char detected; // offset 0x10, size 0x1
    unsigned char can_see; // offset 0x11, size 0x1
    float wait_timer; // offset 0x14, size 0x4
    float wait_time; // offset 0x18, size 0x4
    float speed_limit_2; // offset 0x1C, size 0x4
    float detect_radius; // offset 0x20, size 0x4
    float orient_blend_v; // offset 0x24, size 0x4
    float orient_blend_speed; // offset 0x28, size 0x4
    float pause_time; // offset 0x2C, size 0x4
    float timer; // offset 0x30, size 0x4
    class group_attack attacker; // offset 0x34, size 0x1
    class bone_container & aim_bones; // offset 0x38, size 0x4
    class bone_container & energy_bones; // offset 0x3C, size 0x4
    class xVec3 target_dir; // offset 0x40, size 0xC
};
// total size: 0x560
class xGlobals {
    // Members
...
class bone_container : public behavior_implementation {
    // Members
public:
    class energy_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x70
class jump {
...
// total size: 0x64
class energy_glow_bone : public firing_bone {
    // Members
public:
    float emit_remaining; // offset 0x4C, size 0x4
    float offset; // offset 0x50, size 0x4
    float min_velocity; // offset 0x54, size 0x4
...
class bone_container : public behavior_implementation {
    // Members
public:
    class energy_glow_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0xC
...
// total size: 0x80
class fall_turn_death : public fall_swap_death {
    // Members
public:
    class xQuat target_orient; // offset 0x50, size 0x10
    class xQuat start_orient; // offset 0x60, size 0x10
    float timer; // offset 0x70, size 0x4
    float slerp_time; // offset 0x74, size 0x4
};
// total size: 0x40
class RpLight {
    // Members
...
// total size: 0x34
class zNPCSmokeSystem {
    // Members
public:
    float time; // offset 0x0, size 0x4
    class xVec3 pos; // offset 0x8, size 0xC
    class xVec3 dir; // offset 0x14, size 0xC
    signed int systemID; // offset 0x20, size 0x4
    float emitRemaining; // offset 0x24, size 0x4
...
// total size: 0x24
class collide_detect : public behavior_implementation {
    // Members
public:
    class xVec3 last_position; // offset 0x10, size 0xC
    class zShrapnelAsset * death_shrapnel; // offset 0x1C, size 0x4
    signed int player_damage; // offset 0x20, size 0x4
};
// total size: 0x44
...
// total size: 0x28
class hover_effect : public behavior_implementation {
    // Members
public:
    unsigned char was_last_over_ground; // offset 0x10, size 0x1
    float hover_effect_height; // offset 0x14, size 0x4
    float emit_remaining; // offset 0x18, size 0x4
    class xVec3 last_ground_pos; // offset 0x1C, size 0xC
};
// total size: 0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B170 -> 0x0044B1F8
*/
// Range: 0x44B170 -> 0x44B1F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B200 -> 0x0044B6EC
*/
// Range: 0x44B200 -> 0x44B6EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B6F0 -> 0x0044B7E4
*/
// Range: 0x44B6F0 -> 0x44B7E4
// this: r16
void helibot::update_npc(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x44B6F0 -> 0x44B7E4
        signed int i; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B7F0 -> 0x0044B804
*/
// Range: 0x44B7F0 -> 0x44B804
// this: r2
unsigned char helibot::grabbable() {
    /* anonymous block */ {
        // Range: 0x44B7F0 -> 0x44B804
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B810 -> 0x0044B8BC
*/
// Range: 0x44B810 -> 0x44B8BC
// this: r16
void helibot::scene_setup() {
    /* anonymous block */ {
        // Range: 0x44B810 -> 0x44B8BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044B8C0 -> 0x0044BC84
*/
// Range: 0x44B8C0 -> 0x44BC84
// this: r16
helibot::helibot() {
    /* anonymous block */ {
        // Range: 0x44B8C0 -> 0x44BC84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044BC90 -> 0x0044BE18
*/
// Range: 0x44BC90 -> 0x44BE18
// this: r17
void fall_turn_death::enter_state(class behavior_implementation * prev_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x44BC90 -> 0x44BE18
        class xMat3x3 target_mat; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044BE20 -> 0x0044BE68
*/
// Range: 0x44BE20 -> 0x44BE68
// this: r16
void fall_turn_death::setup() {
    /* anonymous block */ {
        // Range: 0x44BE20 -> 0x44BE68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044BE70 -> 0x0044BE78
*/
// Range: 0x44BE70 -> 0x44BE78
// this: r2
void fall_turn_death::reset() {
    /* anonymous block */ {
        // Range: 0x44BE70 -> 0x44BE78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044BE80 -> 0x0044BF44
*/
// Range: 0x44BE80 -> 0x44BF44
// this: r16
void fall_turn_death::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x44BE80 -> 0x44BF44
        class xQuat current_orient; // r29+0x30
        float old_timer; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044BF50 -> 0x0044C0E4
*/
// Range: 0x44BF50 -> 0x44C0E4
// this: r17
unsigned char heli_attack::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x44BF50 -> 0x44C0E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044C0F0 -> 0x0044C100
*/
// Range: 0x44C0F0 -> 0x44C100
// this: r2
void heli_attack::reset() {
    /* anonymous block */ {
        // Range: 0x44C0F0 -> 0x44C100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044C100 -> 0x0044C1CC
*/
// Range: 0x44C100 -> 0x44C1CC
// this: r16
void heli_attack::setup() {
    /* anonymous block */ {
        // Range: 0x44C100 -> 0x44C1CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044C1D0 -> 0x0044C918
*/
// Range: 0x44C1D0 -> 0x44C918
// this: r18
void heli_attack::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x44C1D0 -> 0x44C918
        class xVec3 aim_dir; // r29+0x240
        class xVec3 remain; // r29+0x230
        class xVec3 non_y_component; // r29+0x220
        class xQuat target_orient; // r29+0xA0
        class xQuat current_orient; // r29+0x90
        class xMat3x3 target_orient_mat; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044C920 -> 0x0044C9D0
*/
// Range: 0x44C920 -> 0x44C9D0
// this: r2
void heli_attack::exit_state() {
    /* anonymous block */ {
        // Range: 0x44C920 -> 0x44C9D0
        signed int i; // r8
        signed int i; // r7
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044C9D0 -> 0x0044CA04
*/
// Range: 0x44C9D0 -> 0x44CA04
// this: r2
void heli_attack::enter_state() {
    /* anonymous block */ {
        // Range: 0x44C9D0 -> 0x44CA04
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044CA10 -> 0x0044CAF0
*/
// Range: 0x44CA10 -> 0x44CAF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044CAF0 -> 0x0044CC48
*/
// Range: 0x44CAF0 -> 0x44CC48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044CFE0 -> 0x0044D6F8
*/
// Range: 0x44CFE0 -> 0x44D6F8
// this: r20
void energy_glow_bone::update(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x44CFE0 -> 0x44D6F8
        class xVec3 position; // r29+0x1D0
        class xVec3 v; // r29+0x1C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044D700 -> 0x0044D748
*/
// Range: 0x44D700 -> 0x44D748
// this: r16
void energy_glow_bone::reset() {
    /* anonymous block */ {
        // Range: 0x44D700 -> 0x44D748
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044D750 -> 0x0044D804
*/
// Range: 0x44D750 -> 0x44D804
// this: r17
void energy_glow_bone::setup() {
    /* anonymous block */ {
        // Range: 0x44D750 -> 0x44D804
    }
}
