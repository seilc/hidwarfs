/*
    Compile unit: C:\TestBuild\in\GAME\zSpotlight.cpp
...
static class flare_element * flares; // size: 0x4, address: 0x609524
static signed int flares_used; // size: 0x4, address: 0x609528
static class cone_element * cones; // size: 0x4, address: 0x60952C
static signed int cones_used; // size: 0x4, address: 0x609530
static class RpAtomic * * light_cone_atomics; // size: 0x4, address: 0x609534
static class RpAtomic * * aura_cone_atomics; // size: 0x4, address: 0x609538
static signed int light_cone_atomics_size; // size: 0x4, address: 0x60953C
static signed int aura_cone_atomics_size; // size: 0x4, address: 0x609540
...
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x442B10
unsigned char HDR_brightening; // size: 0x1, address: 0x609450
class xVec3 g_O3; // size: 0xC, address: 0x5E77C0
class RpMeshHeader * cone_stripper(class RpBuildMesh *, void *); // size: 0x0, address: 0x444820
class xColor_tag g_WHITE; // size: 0x4, address: 0x5E7210
// total size: 0x10
struct /* @anon1 */ {} zSpotlight::light_volume_type::__vtable; // size: 0x10, address: 0x605440
// total size: 0x10
struct /* @anon0 */ {} xLightVolume::__vtable; // size: 0x10, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
signed int compare_cones(void *, void *); // size: 0x0, address: 0x444F50
// total size: 0x4
class xColor_tag {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00442490 -> 0x00442B04
*/
// Range: 0x442490 -> 0x442B04
void render_flares() {
    /* anonymous block */ {
        // Range: 0x442490 -> 0x442B04
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00442B10 -> 0x00442D88
*/
// Range: 0x442B10 -> 0x442D88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00442D90 -> 0x00442F44
*/
// Range: 0x442D90 -> 0x442F44
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00442F50 -> 0x004430E0
*/
// Range: 0x442F50 -> 0x4430E0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004430E0 -> 0x00443268
*/
// Range: 0x4430E0 -> 0x443268
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443270 -> 0x004432D4
*/
// Range: 0x443270 -> 0x4432D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004432E0 -> 0x0044373C
*/
// Range: 0x4432E0 -> 0x44373C
void render_all() {
    /* anonymous block */ {
        // Range: 0x4432E0 -> 0x44373C
        class zScene & s; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443740 -> 0x00443D6C
*/
// Range: 0x443740 -> 0x443D6C
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443D70 -> 0x00443DDC
*/
// Range: 0x443D70 -> 0x443DDC
void early_render() {
    /* anonymous block */ {
        // Range: 0x443D70 -> 0x443DDC
        class zScene & s; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443DE0 -> 0x00443F2C
*/
// Range: 0x443DE0 -> 0x443F2C
void reset_all() {
    /* anonymous block */ {
        // Range: 0x443DE0 -> 0x443F2C
        class zScene & s; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443F30 -> 0x00443FC0
*/
// Range: 0x443F30 -> 0x443FC0
void update_all(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x443F30 -> 0x443FC0
        class zScene & s; // r2
        class zSpotlight * it; // r16
        class zSpotlight * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00443FC0 -> 0x00444720
*/
// Range: 0x443FC0 -> 0x444720
void setup_all() {
    /* anonymous block */ {
        // Range: 0x443FC0 -> 0x444720
        class zScene & s; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444720 -> 0x00444804
*/
// Range: 0x444720 -> 0x444804
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x444720 -> 0x444804
        class RpAtomic * * light; // r16
        class RpAtomic * * end_light; // r2
        class RpAtomic * * aura; // r16
        class RpAtomic * * end_aura; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444810 -> 0x00444818
*/
// Range: 0x444810 -> 0x444818
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x444810 -> 0x444818
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444820 -> 0x004448E0
*/
// Range: 0x444820 -> 0x4448E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004448E0 -> 0x00444B10
*/
// Range: 0x4448E0 -> 0x444B10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444B10 -> 0x00444D30
*/
// Range: 0x444B10 -> 0x444D30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444D30 -> 0x00444EE4
*/
// Range: 0x444D30 -> 0x444EE4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444EF0 -> 0x00444F50
*/
// Range: 0x444EF0 -> 0x444F50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00444F50 -> 0x00445010
*/
// Range: 0x444F50 -> 0x445010
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00445010 -> 0x0044509C
*/
// Range: 0x445010 -> 0x44509C
// this: r18
