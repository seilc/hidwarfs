/*
    Compile unit: C:\TestBuild\in\GAME\zHangable.cpp
...
static class zHangableObject * sPlayerHangObj; // size: 0x4, address: 0x609094
static class xVec3 playerDPos; // size: 0xC, address: 0x68AD48
static class zHangableObject * sHangableObjects; // size: 0x4, address: 0x609098
static signed int sNumHangableObjects; // size: 0x4, address: 0x60909C
...
void zHangable_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2F6180
// total size: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F6150 -> 0x002F6168
*/
// Range: 0x2F6150 -> 0x2F6168
class zHangableObject * zHangable_GetHangableObject(signed int i /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F6150 -> 0x2F6168
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F6170 -> 0x002F6178
*/
// Range: 0x2F6170 -> 0x2F6178
signed int zHangable_NumHangableObjects() {
    /* anonymous block */ {
        // Range: 0x2F6170 -> 0x2F6178
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F6180 -> 0x002F6450
*/
// Range: 0x2F6180 -> 0x2F6450
void zHangable_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F6180 -> 0x2F6450
        class zHangable * hang; // r2
        signed int i; // r11
        class zHangableObject * hangObj; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F6450 -> 0x002F7308
*/
// Range: 0x2F6450 -> 0x2F7308
void zHangable_Update(float dt /* r30 */) {
    /* anonymous block */ {
        // Range: 0x2F6450 -> 0x2F7308
        signed int i; // r20
        class zHangableObject * hangObj; // r19
        class zHangableAsset * asset; // r18
        class xVec3 oldHandle; // r29+0x230
        class xVec3 hangDisp; // r29+0x220
        class xVec3 playerCenter; // r29+0x210
        class xVec3 localCenter; // r29+0x200
        class xVec3 centerDisp; // r29+0x1F0
        class xVec3 disp; // r29+0x1E0
        float dist; // r31
        class xVec3 pivot; // r29+0x1D0
        class xMat3x3 newMat; // r29+0x130
        class xMat3x3 rotMat; // r29+0x100
        float maxAng; // r31
        class xVec3 cross; // r29+0x1C0
        float len; // r29+0x240
        class xMat3x3 rotMat; // r29+0xD0
        class xVec3 actualDisp; // r29+0x1B0
        class xVec3 actualPivot; // r29+0x1A0
        class xVec3 cross; // r29+0x190
        float len; // r29+0x240
        float ang; // r31
        float minArcRadians; // r29+0x240
        class xVec3 relVel; // r29+0x180
        float total; // r29+0x240
        class xVec3 velAddDir; // r29+0x170
        class xVec3 newPlayerCenter; // r29+0x160
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7310 -> 0x002F7358
*/
// Range: 0x2F7310 -> 0x2F7358
void zHangable_Reset() {
    /* anonymous block */ {
        // Range: 0x2F7310 -> 0x2F7358
        signed int i; // r6
        class zHangable * hangable; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7360 -> 0x002F7794
*/
// Range: 0x2F7360 -> 0x2F7794
void zHangable_SceneInit(class zScene * zsc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2F7360 -> 0x2F7794
        signed int i; // r20
        signed int count; // r2
        signed int numHangables; // r19
        class zHangable * hangable; // r2
        class zHangableObject * hangObj; // r21
        class zHangableAsset * asset; // r2
        class xMat3x3 rotMat; // r29+0xA0
        class xVec3 pivot; // r29+0xF0
        class xVec3 disp; // r29+0xE0
        class xVec3 cross; // r29+0xD0
        float len; // r29+0x100
        float ang; // r29+0x100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F77A0 -> 0x002F78B4
*/
// Range: 0x2F77A0 -> 0x2F78B4
signed int zHangable_Recurse(unsigned int id /* r2 */, class zHangableObject * gpList /* r21 */, class zHangable * hangable /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2F77A0 -> 0x2F78B4
        unsigned int i; // r19
        signed int result; // r18
        class xBase * base; // r2
        class xGroup * group; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F78C0 -> 0x002F78E8
*/
// Range: 0x2F78C0 -> 0x2F78E8
void zHangable_PlayerDPos(class xVec3 * dpos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F78C0 -> 0x2F78E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F78F0 -> 0x002F78F8
*/
// Range: 0x2F78F0 -> 0x2F78F8
void zHangable_AttachPlayer(class zHangableObject * hangObj /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F78F0 -> 0x2F78F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F7900 -> 0x002F79A8
*/
// Range: 0x2F7900 -> 0x2F79A8
void zHangable_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2F7900 -> 0x2F79A8
    }
}
