/*
    Compile unit: C:\TestBuild\in\GAME\zCamPreset.cpp
...
void event_handler_callback(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x4962B0
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004962B0 -> 0x004963E4
*/
// Range: 0x4962B0 -> 0x4963E4
void event_handler_callback(class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4962B0 -> 0x4963E4
        class zCamPreset * w; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004963F0 -> 0x004964E4
*/
// Range: 0x4963F0 -> 0x4964E4
// this: r2
unsigned char zCamPreset::get_checkpoint(class xVec3 & loc /* r18 */, float & yaw /* r17 */) {
    /* anonymous block */ {
        // Range: 0x4963F0 -> 0x4964E4
        class PKRAssetTOCInfo ainfo; // r29+0x50
        class xBaseAsset * checkpoint; // r2
        unsigned int type; // r2
        class xEntAsset * player; // r2
        class pointer_asset * pointer; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004964F0 -> 0x00496770
*/
// Range: 0x4964F0 -> 0x496770
class zCamPreset * find_preset(unsigned char scene_prepare /* r21 */) {
    /* anonymous block */ {
        // Range: 0x4964F0 -> 0x496770
        class zCamPreset * best_preset; // r20
        float best_dist2; // r20
        unsigned char best_has_checkpoint; // r22
        class xVec3 & to; // r19
        class zScene & s; // r2
        class zCamPreset * preset; // r18
        class zCamPreset * end_preset; // r2
        unsigned char has_checkpoint; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00496770 -> 0x00496874
*/
// Range: 0x496770 -> 0x496874
void apply_on_reset() {
    /* anonymous block */ {
        // Range: 0x496770 -> 0x496874
        class zCamPreset * preset; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00496880 -> 0x00496984
*/
// Range: 0x496880 -> 0x496984
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00496990 -> 0x00496998
*/
// Range: 0x496990 -> 0x496998
void update_all() {
    /* anonymous block */ {
        // Range: 0x496990 -> 0x496998
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004969A0 -> 0x00496A10
*/
// Range: 0x4969A0 -> 0x496A10
