/*
    Compile unit: C:\TestBuild\in\GAME\zUICustom.cpp
...
signed int brain_id; // size: 0x4, address: 0x6095B8
signed int stat_strings_count; // size: 0x4, address: 0x6095BC
char stat_strings[100][128]; // size: 0x3200, address: 0x6BA670
signed int line_size[100]; // size: 0x190, address: 0x6BD870
signed int last_stat; // size: 0x4, address: 0x6084CC
// total size: 0x4C
struct /* @anon4 */ {} zUICustomConditionallyDisabled::__vtable; // size: 0x4C, address: 0x605FC0
// total size: 0x4C
struct /* @anon2 */ {} zUICustom::__vtable; // size: 0x4C, address: 0x606100
// total size: 0x4C
struct /* @anon0 */ {} zUICustomImageSlideshow::__vtable; // size: 0x4C, address: 0x606010
// total size: 0x4C
struct /* @anon1 */ {} zUICustomStatImage::__vtable; // size: 0x4C, address: 0x6060B0
// total size: 0x4C
struct /* @anon3 */ {} zUICustomStatBox::__vtable; // size: 0x4C, address: 0x606060
...
// total size: 0x1C
class zUICustomStatBox : public zUICustom {
    // Members
public:
    char * buffer; // offset 0x8, size 0x4
    float time; // offset 0xC, size 0x4
    float current; // offset 0x10, size 0x4
    unsigned char cont; // offset 0x14, size 0x1
...
// total size: 0xC
class zUICustomStatImage : public zUICustom {
    // Members
public:
    unsigned int brain_id; // offset 0x8, size 0x4
};
// total size: 0x18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F2C0 -> 0x0045F2C8
*/
// Range: 0x45F2C0 -> 0x45F2C8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F2D0 -> 0x0045F2D8
*/
// Range: 0x45F2D0 -> 0x45F2D8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F2E0 -> 0x0045F328
*/
// Range: 0x45F2E0 -> 0x45F328
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F330 -> 0x0045F3E4
*/
// Range: 0x45F330 -> 0x45F3E4
// this: r16
unsigned char zUICustomImageSlideshow::HandleEvent(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x45F330 -> 0x45F3E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F3F0 -> 0x0045F438
*/
// Range: 0x45F3F0 -> 0x45F438
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F440 -> 0x0045FA44
*/
// Range: 0x45F440 -> 0x45FA44
class zUICustom * zUICustomAllocate(unsigned int hashID /* r2 */, class zUI * ui /* r17 */) {
    /* anonymous block */ {
        // Range: 0x45F440 -> 0x45FA44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045FA50 -> 0x00460018
*/
// Range: 0x45FA50 -> 0x460018
// this: r17
void zUICustomStatBox::create_incrediball_stat(signed int index /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x45FA50 -> 0x460018
        char temp[128]; // r29+0xD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00460020 -> 0x00460410
*/
// Range: 0x460020 -> 0x460410
// this: r17
void zUICustomStatBox::create_violet_stat(signed int index /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x460020 -> 0x460410
        char temp[128]; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00460410 -> 0x00460944
*/
// Range: 0x460410 -> 0x460944
// this: r17
void zUICustomStatBox::create_dash_stat(signed int index /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x460410 -> 0x460944
        char temp[128]; // r29+0xC0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00460950 -> 0x00460E68
*/
// Range: 0x460950 -> 0x460E68
// this: r17
void zUICustomStatBox::create_mr_i_stat(signed int index /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x460950 -> 0x460E68
        char temp[128]; // r29+0xD0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00460E70 -> 0x00460FF0
*/
// Range: 0x460E70 -> 0x460FF0
// this: r17
void zUICustomStatBox::create_time(char * stat_string /* r2 */, char * temp /* r16 */, signed int index /* r18 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x460E70 -> 0x460FF0
        signed int seconds; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00460FF0 -> 0x00461140
*/
// Range: 0x460FF0 -> 0x461140
// this: r17
void zUICustomStatBox::create_stats_buffer(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x460FF0 -> 0x461140
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461140 -> 0x00461168
*/
// Range: 0x461140 -> 0x461168
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461170 -> 0x004611E4
*/
// Range: 0x461170 -> 0x4611E4
// this: r16
unsigned char zUICustomStatBox::HandleEvent(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x461170 -> 0x4611E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004611F0 -> 0x004612E0
*/
// Range: 0x4611F0 -> 0x4612E0
// this: r20
void zUICustomStatBox::create_text_buffer() {
    /* anonymous block */ {
        // Range: 0x4611F0 -> 0x4612E0
        unsigned int length; // r19
        signed int i; // r18
        char temp[128]; // r29+0xE0
        class xtextbox tb; // r29+0x60
        class layout & temp_layout; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004612E0 -> 0x00461384
*/
// Range: 0x4612E0 -> 0x461384
void collect_data() {
    /* anonymous block */ {
        // Range: 0x4612E0 -> 0x461384
        signed int stat_strings_count'54; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461390 -> 0x004613F0
*/
// Range: 0x461390 -> 0x4613F0
// this: r17
void zUICustomStatBox::PreUpdate(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x461390 -> 0x4613F0
        class zUIText * ui_text; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004613F0 -> 0x00461408
*/
// Range: 0x4613F0 -> 0x461408
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461410 -> 0x00461420
*/
// Range: 0x461410 -> 0x461420
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461420 -> 0x00461608
*/
// Range: 0x461420 -> 0x461608
// this: r2
unsigned char zUICustomStatImage::HandleEvent(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x461420 -> 0x461608
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461610 -> 0x00461618
*/
// Range: 0x461610 -> 0x461618
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461620 -> 0x00461628
*/
// Range: 0x461620 -> 0x461628
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461630 -> 0x00461638
*/
// Range: 0x461630 -> 0x461638
void PostInitMotion() {
    /* anonymous block */ {
        // Range: 0x461630 -> 0x461638
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461640 -> 0x00461648
*/
// Range: 0x461640 -> 0x461648
void PreInitMotion() {
    /* anonymous block */ {
        // Range: 0x461640 -> 0x461648
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461650 -> 0x00461658
*/
// Range: 0x461650 -> 0x461658
void Exit() {
    /* anonymous block */ {
        // Range: 0x461650 -> 0x461658
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461660 -> 0x00461668
*/
// Range: 0x461660 -> 0x461668
void PostRender() {
    /* anonymous block */ {
        // Range: 0x461660 -> 0x461668
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461670 -> 0x00461678
*/
// Range: 0x461670 -> 0x461678
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461680 -> 0x00461688
*/
// Range: 0x461680 -> 0x461688
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00461690 -> 0x00461698
*/
// Range: 0x461690 -> 0x461698
void PostUpdate() {
    /* anonymous block */ {
        // Range: 0x461690 -> 0x461698
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616A0 -> 0x004616A8
*/
// Range: 0x4616A0 -> 0x4616A8
void PreUpdate() {
    /* anonymous block */ {
        // Range: 0x4616A0 -> 0x4616A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616B0 -> 0x004616B8
*/
// Range: 0x4616B0 -> 0x4616B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616C0 -> 0x004616C8
*/
// Range: 0x4616C0 -> 0x4616C8
void ResetMotion() {
    /* anonymous block */ {
        // Range: 0x4616C0 -> 0x4616C8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616D0 -> 0x004616D8
*/
// Range: 0x4616D0 -> 0x4616D8
void Reset() {
    /* anonymous block */ {
        // Range: 0x4616D0 -> 0x4616D8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616E0 -> 0x004616E8
*/
// Range: 0x4616E0 -> 0x4616E8
void Setup() {
    /* anonymous block */ {
        // Range: 0x4616E0 -> 0x4616E8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004616F0 -> 0x004616F8
*/
// Range: 0x4616F0 -> 0x4616F8
void Init() {
    /* anonymous block */ {
        // Range: 0x4616F0 -> 0x4616F8
    }
