/*
    Compile unit: C:\TestBuild\in\GAME\zWaterhose.cpp
...
class RwRaster * textureRaster; // size: 0x4, address: 0x609020
class RwTexture * particleTex; // size: 0x4, address: 0x609024
class WaterhoseCollisionInfo waterhoseCollisionInfo; // size: 0x14, address: 0x50E470
unsigned int tweakWHcardTextureID; // size: 0x4, address: 0x60902C
unsigned int tweakWHParticleTextureID; // size: 0x4, address: 0x609030
// total size: 0x28
class /* @class */ {
    // Members
public:
    class RwRaster * raster; // offset 0x0, size 0x4
    signed int zwriteenable; // offset 0x4, size 0x4
    signed int ztestenable; // offset 0x8, size 0x4
    signed int fogenable; // offset 0xC, size 0x4
    signed int vertexalphaenable; // offset 0x10, size 0x4
    enum RwShadeMode shademode; // offset 0x14, size 0x4
    enum RwCullMode cullmode; // offset 0x18, size 0x4
    enum RwBlendFunction srcblend; // offset 0x1C, size 0x4
    enum RwBlendFunction destblend; // offset 0x20, size 0x4
    enum RwTextureAddressMode textureaddress; // offset 0x24, size 0x4
} old_rs; // size: 0x28, address: 0x6891D0
class zWaterhoseMgr * waterhoseMgr; // size: 0x4, address: 0x609050
...
void TweakChangeWHparticleTextureCB(class tweak_info &); // size: 0x0, address: 0x2E7BF0
void TweakChangeWHwaveTextureCB(class tweak_info &); // size: 0x0, address: 0x2E7C20
void EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2E8860
// total size: 0x14
class xCylinder {
    // Members
public:
...
class zWaterhoseAsset : public xDynAsset {
    // Members
public:
    class xVec3 startPos; // offset 0x10, size 0xC
    class xVec3 endPos; // offset 0x1C, size 0xC
...
public:
    ...
    class zWaterhoseAsset * asset; // offset 0x14, size 0x4
};
// total size: 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E44E0 -> 0x002E4660
*/
// Range: 0x2E44E0 -> 0x2E4660
void Render() {
    /* anonymous block */ {
        // Range: 0x2E44E0 -> 0x2E4660
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E4660 -> 0x002E47B0
*/
// Range: 0x2E4660 -> 0x2E47B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E47B0 -> 0x002E48AC
*/
// Range: 0x2E47B0 -> 0x2E48AC
// this: r16
class zWaterhose * zWaterhoseMgr::GetMem(unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E47B0 -> 0x2E48AC
        class zWaterhose * mem; // r2
        class zWaterhose * prev; // r2
        unsigned int i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E48B0 -> 0x002E4948
*/
// Range: 0x2E48B0 -> 0x2E4948
void Reset() {
    /* anonymous block */ {
        // Range: 0x2E48B0 -> 0x2E4948
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E4950 -> 0x002E4970
*/
// Range: 0x2E4950 -> 0x2E4970
void Remove() {
    /* anonymous block */ {
        // Range: 0x2E4950 -> 0x2E4970
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E4970 -> 0x002E4AE0
*/
// Range: 0x2E4970 -> 0x2E4AE0
void BeginRender() {
    /* anonymous block */ {
        // Range: 0x2E4970 -> 0x2E4AE0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E4AE0 -> 0x002E51EC
*/
// Range: 0x2E4AE0 -> 0x2E51EC
// this: r2
void zWaterhose::UpdateCollision() {
    /* anonymous block */ {
        // Range: 0x2E4AE0 -> 0x2E51EC
        class xBound bound; // r29+0x130
        class xMat4x3 mat; // r29+0xF0
        signed int i; // r20
        float width; // r29+0x200
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E51F0 -> 0x002E548C
*/
// Range: 0x2E51F0 -> 0x2E548C
// this: r16
void zWaterhose::RenderCrossCardSection(signed int i /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2E51F0 -> 0x2E548C
        class RxObjSpace3DVertex vert[14]; // r29+0x70
        float t; // r9
        signed int p; // r15
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E5490 -> 0x002E59C8
*/
// Range: 0x2E5490 -> 0x2E59C8
// this: r20
void zWaterhose::GetSecondEmitterPoint() {
    /* anonymous block */ {
        // Range: 0x2E5490 -> 0x2E59C8
        class xVec3 dir; // r29+0x1C0
        class xMat4x3 matC; // r29+0xB0
        class xVec3 pos; // r29+0x1B0
        class xMat4x3 & mat; // r16
        signed int i; // r19
        class xVec3 move; // r29+0x1A0
        class xVec3 acc; // r29+0x190
        float speed; // @ 0x00607C20
        float start; // @ 0x00607C18
        float spread; // @ 0x00607C1C
        float yOffset; // @ 0x0060904C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E59D0 -> 0x002E6098
*/
// Range: 0x2E59D0 -> 0x2E6098
// this: r20
void zWaterhose::CreateCardEdge(signed int l /* r2 */, float dirX /* r29+0x230 */, float dirY /* r29+0x230 */) {
    /* anonymous block */ {
        // Range: 0x2E59D0 -> 0x2E6098
        class xVec3 dir; // r29+0x220
        class xMat3x3 matC; // r29+0xB0
        class xVec3 * pos; // r19
        class xMat4x3 & mat; // r18
        signed int i; // r18
        class xVec3 move; // r29+0x210
        class xVec3 acc; // r29+0x200
        float speed; // @ 0x00607C14
        float start; // @ 0x00607C0C
        float spread; // @ 0x00607C10
        float yOffset; // @ 0x00609048
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E60A0 -> 0x002E6510
*/
// Range: 0x2E60A0 -> 0x2E6510
// this: r16
void zWaterhose::UpdateCrossCards(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2E60A0 -> 0x2E6510
        class RwTexture * tex; // r2
        float angle; // r29+0x30
        float angleDiff; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E6510 -> 0x002E7538
*/
// Range: 0x2E6510 -> 0x2E7538
// this: r20
void zWaterhose::UpdateParticles(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2E6510 -> 0x2E7538
        signed int numSteps; // r21
        float angle; // r31
        class xMat3x3 matEmitter; // r29+0xE0
        float emitterLen; // r29+0x250
        class xVec3 emitterUp; // r29+0x240
        class xVec3 emitterRight; // r29+0x230
        signed int p; // r19
        class Particle & particle; // r18
        float time; // r2
        float size; // r29+0x250
        unsigned char alpha; // r3
        signed int gen; // r19
        class xMat4x3 & mat; // r18
        signed int j; // r17
        class Particle & particle; // r16
        float life; // @ 0x00609044
        float speed; // @ 0x00607C04
        float start; // @ 0x00607C08
        float spread; // @ 0x00609040
        float yOffset; // @ 0x0060903C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E7540 -> 0x002E78E0
*/
// Range: 0x2E7540 -> 0x2E78E0
// this: r29+0xBC
void zWaterhose::UpdatePTankPool() {
    /* anonymous block */ {
        // Range: 0x2E7540 -> 0x2E78E0
        class ptank_pool__pos_color_size_uv2 pool; // r29+0xC0
        signed int p; // r20
        class Particle & particle; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E78E0 -> 0x002E7BEC
*/
// Range: 0x2E78E0 -> 0x2E7BEC
void AddTweaks(unsigned int number /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E78E0 -> 0x2E7BEC
        char name[64]; // r29+0x110
        char name1[64]; // r29+0xD0
        char prefix[1]; // r29+0x15C
        signed char @7969; // @ 0x00609038
        class tweak_callback cb_change_textureB; // @ 0x005F0400
        signed char @7966; // @ 0x00609034
        class tweak_callback cb_change_texture; // @ 0x005F03D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E7BF0 -> 0x002E7C14
*/
// Range: 0x2E7BF0 -> 0x2E7C14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E7C20 -> 0x002E7C48
*/
// Range: 0x2E7C20 -> 0x2E7C48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E7C50 -> 0x002E7D90
*/
// Range: 0x2E7C50 -> 0x2E7D90
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E7D90 -> 0x002E83AC
*/
// Range: 0x2E7D90 -> 0x2E83AC
// this: r16
unsigned char zWaterhose::Cull() {
    /* anonymous block */ {
        // Range: 0x2E7D90 -> 0x2E83AC
        class xMat4x3 mat; // r29+0xA0
        class xVec3 pos; // r29+0x210
        float dist2; // r29+0x220
        class xVec3 start; // r29+0x200
        class xVec3 end; // r29+0x1F0
        class xVec3 step; // r29+0x1E0
        signed int i; // r5
        unsigned char doDraw; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E83B0 -> 0x002E8508
*/
// Range: 0x2E83B0 -> 0x2E8508
// this: r16
void zWaterhose::Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2E83B0 -> 0x2E8508
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8510 -> 0x002E85E4
*/
// Range: 0x2E8510 -> 0x2E85E4
// this: r17
void zWaterhose::Update(float dt /* r20 */, class xMat4x3 & mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2E8510 -> 0x2E85E4
        class xMat3x3 matB; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E85F0 -> 0x002E8600
*/
// Range: 0x2E85F0 -> 0x2E8600
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8600 -> 0x002E8610
*/
// Range: 0x2E8600 -> 0x2E8610
// this: r2
void zWaterhose::DoMgrRender(unsigned char _doMgrRender /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E8600 -> 0x2E8610
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8610 -> 0x002E8620
*/
// Range: 0x2E8610 -> 0x2E8620
// this: r2
void zWaterhose::DoMgrUpdate(unsigned char _doMgrUpdate /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E8610 -> 0x2E8620
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8620 -> 0x002E87BC
*/
// Range: 0x2E8620 -> 0x2E87BC
// this: r16
void zWaterhose::Init() {
    /* anonymous block */ {
        // Range: 0x2E8620 -> 0x2E87BC
        signed int i; // r7
        unsigned int counter; // @ 0x00609028
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E87C0 -> 0x002E8800
*/
// Range: 0x2E87C0 -> 0x2E8800
// this: r16
zWaterhose::zWaterhose(unsigned char _doMgrUpdate /* r2 */, unsigned char _doMgrRender /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E87C0 -> 0x2E8800
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8800 -> 0x002E885C
*/
// Range: 0x2E8800 -> 0x2E885C
void * operator new(unsigned int size /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2E8800 -> 0x2E885C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8860 -> 0x002E8F88
*/
// Range: 0x2E8860 -> 0x2E8F88
void EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2E8860 -> 0x2E8F88
        class zWaterhoseWidget & waterhoseWidget; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002E8F90 -> 0x002E8FE4
*/
// Range: 0x2E8F90 -> 0x2E8FE4
