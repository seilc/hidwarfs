/*
    Compile unit: C:\TestBuild\in\GAME\zEnv.cpp
...
void zEnvEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x131F60
// total size: 0x70
class RpAtomic {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131F60 -> 0x00132050
*/
// Range: 0x131F60 -> 0x132050
void zEnvEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, class xBase * toParamWidget /* r2 */) {
    /* anonymous block */ {
        // Range: 0x131F60 -> 0x132050
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132050 -> 0x00132058
*/
// Range: 0x132050 -> 0x132058
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132060 -> 0x00132068
*/
// Range: 0x132060 -> 0x132068
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132070 -> 0x00132168
*/
// Range: 0x132070 -> 0x132168
void zEnvRender(class xEnv * env /* r20 */) {
    /* anonymous block */ {
        // Range: 0x132070 -> 0x132168
        class RpWorld * world; // r19
        signed int num; // r2
        signed int i; // r18
        class xSurface * sp; // r2
        class zSurfaceProps * pp; // r2
        class RpMaterial * mp; // r2
        class xGroup * g; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132170 -> 0x00132178
*/
// Range: 0x132170 -> 0x132178
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132180 -> 0x001321BC
*/
// Range: 0x132180 -> 0x1321BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001321C0 -> 0x00132378
*/
// Range: 0x1321C0 -> 0x132378
void zEnvInit(class _zEnv * env /* r17 */, class xEnvAsset * easset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1321C0 -> 0x132378
        signed int mapper_count; // r2
        signed int i; // r18
        unsigned int size; // r29+0x4C
        class xBase * material_map; // r2
        signed int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132380 -> 0x00132388
*/
// Range: 0x132380 -> 0x132388
