/*
    Compile unit: C:\TestBuild\in\GAME\zGameState.cpp
...
enum _GameOstrich gGameOstrich; // size: 0x4, address: 0x6086D4
static unsigned int sGameMode_DispatchTable[12]; // size: 0x30, address: 0x6137C0
static unsigned int sGameState_DispatchTable[8]; // size: 0x20, address: 0x505590
static unsigned int sPauseState_DispatchTable[2]; // size: 0x8, address: 0x607650
static unsigned int sSaveState_DispatchTable[3]; // size: 0xC, address: 0x5055B0
static unsigned int sOptionsState_DispatchTable[1]; // size: 0x4, address: 0x607658
static unsigned int sLoadState_DispatchTable[3]; // size: 0xC, address: 0x5055C0
static unsigned int sTitleState_DispatchTable[2]; // size: 0x8, address: 0x607660
static unsigned int sIntroState_DispatchTable[4]; // size: 0x10, address: 0x5055D0
static unsigned int sGameState_DoDispatchTable[8]; // size: 0x20, address: 0x5055E0
static unsigned int sPauseState_DoDispatchTable[2]; // size: 0x8, address: 0x607668
static unsigned int sSaveState_DoDispatchTable[3]; // size: 0xC, address: 0x505600
static unsigned int sOptionsState_DoDispatchTable[1]; // size: 0x4, address: 0x607670
static unsigned int sLoadState_DoDispatchTable[3]; // size: 0xC, address: 0x505610
static unsigned int sTitleState_DoDispatchTable[2]; // size: 0x8, address: 0x607678
static unsigned int sIntroState_DoDispatchTable[4]; // size: 0x10, address: 0x505620
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135D20 -> 0x00135E78
*/
// Range: 0x135D20 -> 0x135E78
void zGameModeSwitch(enum eGameMode modeNew /* r16 */) {
    /* anonymous block */ {
        // Range: 0x135D20 -> 0x135E78
        enum eGameMode modeOld; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135E80 -> 0x00135FB8
*/
// Range: 0x135E80 -> 0x135FB8
void zGameStateSwitch(signed int theNewState /* r17 */) {
    /* anonymous block */ {
        // Range: 0x135E80 -> 0x135FB8
        signed int stateOld; // r2
        unsigned int theEvent; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135FC0 -> 0x00136220
*/
// Range: 0x135FC0 -> 0x136220
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136220 -> 0x00136228
*/
// Range: 0x136220 -> 0x136228
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136230 -> 0x00136238
*/
// Range: 0x136230 -> 0x136238
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136240 -> 0x00136248
*/
// Range: 0x136240 -> 0x136248
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136250 -> 0x00136258
*/
// Range: 0x136250 -> 0x136258
