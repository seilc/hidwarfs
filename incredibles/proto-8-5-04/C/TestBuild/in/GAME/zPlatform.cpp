/*
    Compile unit: C:\TestBuild\in\GAME\zPlatform.cpp
...
static class effect * sRumbleBreakaway; // size: 0x4, address: 0x608790
...
void xFFXShakeUpdateEnt(class xEnt *, class xScene *, float, void *); // size: 0x0, address: 0x189920
...
void genericPlatRender(class xEnt *); // size: 0x0, address: 0x146030
void zPlatformTranslate(class xEnt *, class xVec3 *, class xMat4x3 *); // size: 0x0, address: 0x142DB0
void zPlatformEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x141B80
void zPlatform_Move(class xEnt *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x143110
void zPlatform_Update(class xEnt *, class xScene *, float); // size: 0x0, address: 0x143170
// total size: 0x24
class xAnimFile {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00141B80 -> 0x00142CD8
*/
// Range: 0x141B80 -> 0x142CD8
void zPlatformEventCB(class xBase * from /* r3 */, class xBase * to /* r2 */, unsigned int toEvent /* r19 */, float * toParam /* r18 */, class xBase * toParamWidget /* r17 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x141B80 -> 0x142CD8
        ...
        float tp[4]; // r29+0xB0
        float tp[4]; // r29+0xA0
        float desired_angle; // r29+0x140
        float delta_angle; // r29+0x140
        float tp[4]; // r29+0x90
        float desired_angle; // r29+0x140
        float delta_angle; // r29+0x140
        float tp[4]; // r29+0x80
        ...
        float mt; // r29+0x140
        float mt; // r29+0x140
        class FloatAndVoid dist; // r29+0x13C
        class zShrapnelAsset * shrap; // r2
        class xVec3 currVel; // r29+0x130
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00142CE0 -> 0x00142DA8
*/
// Range: 0x142CE0 -> 0x142DA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00142DB0 -> 0x00142DFC
*/
// Range: 0x142DB0 -> 0x142DFC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00142E00 -> 0x00142ED4
*/
// Range: 0x142E00 -> 0x142ED4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00142EE0 -> 0x00143034
*/
// Range: 0x142EE0 -> 0x143034
void zPlatform_Mount(class zPlatform * plat /* r17 */) {
    /* anonymous block */ {
        // Range: 0x142EE0 -> 0x143034
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00143040 -> 0x00143104
*/
// Range: 0x143040 -> 0x143104
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00143110 -> 0x00143164
*/
// Range: 0x143110 -> 0x143164
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00143170 -> 0x00143A58
*/
// Range: 0x143170 -> 0x143A58
void zPlatform_Update(class xEnt * entplat /* r2 */, class xScene * sc /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        ...
        class xEnt * p; // r2
        float ctilt; // r29+0xC0
        float itilt; // r29+0xC0
        float dtilt; // r1
        class xVec3 * scale; // r2
        class xVec3 lpos; // r29+0xB0
        float dangle; // r2
        float tangle; // r29+0xC0
        class xVec3 * scale; // r2
        float time[3]; // r29+0xA0
        float orient; // r29+0xC0
        class xMat3x3 orientrot; // r29+0x70
        class xMat3x3 origrot; // r29+0x40
        class xVec3 * scale; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00143A60 -> 0x00144040
*/
// Range: 0x143A60 -> 0x144040
void zPlatformBreakaway_Update(class zPlatform * plat /* r17 */, class xScene * sc /* r2 */, float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x143A60 -> 0x144040
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00144040 -> 0x00145210
*/
// Range: 0x144040 -> 0x145210
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145210 -> 0x001452F4
*/
// Range: 0x145210 -> 0x1452F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145300 -> 0x00145758
*/
// Range: 0x145300 -> 0x145758
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145760 -> 0x00145AC4
*/
// Range: 0x145760 -> 0x145AC4
void zPlatform_Reset(class zPlatform * plat /* r17 */, class xScene * sc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x145760 -> 0x145AC4
        class RpAtomic * imodel; // r18
        signed int i; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145AD0 -> 0x00145AF8
*/
// Range: 0x145AD0 -> 0x145AF8
void zPlatform_ReReset(class zPlatform * plat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x145AD0 -> 0x145AF8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145B00 -> 0x00145B08
*/
// Range: 0x145B00 -> 0x145B08
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145B10 -> 0x00145B18
*/
// Range: 0x145B10 -> 0x145B18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145B20 -> 0x00145BF4
*/
// Range: 0x145B20 -> 0x145BF4
void zPlatform_Setup(class zPlatform * plat /* r16 */, class xScene * sc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x145B20 -> 0x145BF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00145C00 -> 0x00146008
*/
// Range: 0x145C00 -> 0x146008
void zPlatform_Init(class zPlatform * plat /* r16 */, class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x145C00 -> 0x146008
        class xPlatformAsset * plat_asset; // r17
        class xEntMotionAsset * ent_motion_asset; // r20
        class xAnimFile * spring_file; // r19
        class xAnimFile * idle_file; // r2
        unsigned int size; // r29+0x8C
        unsigned int newid; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00146010 -> 0x00146018
*/
// Range: 0x146010 -> 0x146018
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00146020 -> 0x00146028
*/
// Range: 0x146020 -> 0x146028
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00146030 -> 0x00146070
*/
// Range: 0x146030 -> 0x146070
