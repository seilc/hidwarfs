/*
    Compile unit: C:\TestBuild\in\GAME\zScript.cpp
...
void zScriptEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x153AD0
// total size: 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001538C0 -> 0x00153960
*/
// Range: 0x1538C0 -> 0x153960
void zScriptUpdate(class xBase * to /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1538C0 -> 0x153960
        class _zScript * t; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00153960 -> 0x00153AD0
*/
// Range: 0x153960 -> 0x153AD0
static unsigned char zScriptExecuteEvents(class _zScript * t /* r19 */, float start /* r21 */, float end /* r20 */) {
    /* anonymous block */ {
        // Range: 0x153960 -> 0x153AD0
        signed int i; // r18
        signed int eventCount; // r2
        class xScriptEventAsset * currentScript; // r17
        class xBase * b; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00153AD0 -> 0x00153C8C
*/
// Range: 0x153AD0 -> 0x153C8C
void zScriptEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x153AD0 -> 0x153C8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00153C90 -> 0x00153C98
*/
// Range: 0x153C90 -> 0x153C98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00153CA0 -> 0x00153CA8
*/
// Range: 0x153CA0 -> 0x153CA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00153CB0 -> 0x00153D50
*/
// Range: 0x153CB0 -> 0x153D50
