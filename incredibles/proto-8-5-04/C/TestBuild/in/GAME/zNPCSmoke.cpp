/*
    Compile unit: C:\TestBuild\in\GAME\zNPCSmoke.cpp
...
class RwTexture * texture; // size: 0x4, address: 0x609660
static class xColor_tag NPCSmokeColor; // size: 0x4, address: 0x5FBC68
// total size: 0xC
struct /* @anon0 */ {} zNPCSmokeSystem::__vtable; // size: 0xC, address: 0x606838
signed int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x608208
signed int Update(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4748A0
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
// total size: 0x7C
struct /* @anon1 */ {} zNPC::NPCSmokeBehavior::__vtable; // size: 0x7C, address: 0x606850
// total size: 0x14
class xCylinder {
    // Members
public:
...
public:
    ...
    float pad; // offset 0x28, size 0x4
};
// total size: 0xC
class tri_data {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004748A0 -> 0x00474D40
*/
// Range: 0x4748A0 -> 0x474D40
signed int Update(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & pool_ /* r2 */, float dt /* r21 */, void * context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4748A0 -> 0x474D40
        class zNPCSmokeSystem * system; // r19
        class ptank_pool__pos_color_size_rot & pool; // r18
        class NPCSmokeParticle * p; // r17
        class NPCSmokeParticle * end; // r16
        float fadeTime; // r29+0xF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474D40 -> 0x00475224
*/
// Range: 0x474D40 -> 0x475224
// this: r18
void zNPCSmokeSystem::update(class xVec3 & pos /* r17 */, class xVec3 & dir /* r16 */, float currentHitPoints /* r29+0xE0 */, float smokePoints /* r29+0xE0 */, float dt /* r29+0xE0 */) {
    /* anonymous block */ {
        // Range: 0x474D40 -> 0x475224
        float smokeEmitRate; // r21
        float timePassed; // r20
        signed int emit; // r21
        class NPCSmokeParticle * p; // r29+0xDC
        signed int count; // r2
        class NPCSmokeParticle * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475230 -> 0x00475330
*/
// Range: 0x475230 -> 0x475330
// this: r16
zNPCSmokeSystem::zNPCSmokeSystem(float _scale /* r29+0x50 */, float _lifetime /* r29+0x50 */, float _gravity /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x475230 -> 0x475330
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475330 -> 0x0047544C
*/
// Range: 0x475330 -> 0x47544C
// this: r16
void NPCSmokeBehavior::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x475330 -> 0x47544C
        class xVec3 dir; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475450 -> 0x00475484
*/
// Range: 0x475450 -> 0x475484
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475490 -> 0x00475500
*/
// Range: 0x475490 -> 0x475500
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475500 -> 0x00475508
*/
// Range: 0x475500 -> 0x475508
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475510 -> 0x00475548
*/
// Range: 0x475510 -> 0x475548
// this: r16
unsigned char NPCSmokeBehavior::runnable() {
    /* anonymous block */ {
        // Range: 0x475510 -> 0x475548
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475550 -> 0x00475558
*/
// Range: 0x475550 -> 0x475558
void reset() {
    /* anonymous block */ {
        // Range: 0x475550 -> 0x475558
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475560 -> 0x00475668
*/
// Range: 0x475560 -> 0x475668
// this: r16
