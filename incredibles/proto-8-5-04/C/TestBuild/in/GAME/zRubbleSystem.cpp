/*
    Compile unit: C:\TestBuild\in\GAME\zRubbleSystem.cpp
...
static class config_data cfg; // size: 0x24, address: 0x5DBAC0
static class xVec3 force_offset; // size: 0xC, address: 0x0
static class xVec3 prefer_up; // size: 0xC, address: 0x0
// total size: 0xC
struct /* @anon0 */ {} z::rubble_chunk::ball_physics::__vtable; // size: 0xC, address: 0x606F08
signed int extras_used; // size: 0x4, address: 0x609558
...
void event_handler_callback(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x4889A0
void bound_update_callback(class xEnt *, class xVec3 *); // size: 0x0, address: 0x488C20
// total size: 0xC
struct /* @anon1 */ {} xBallPhysics::__vtable; // size: 0xC, address: 0x604CA0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
void collide_swept_sphere_statics_callback(class xScene *, class xRay3 *, class xQCData *, class xEnt *, void *); // size: 0x0, address: 0x48BF20
class xGrid colls_oso_grid; // size: 0x38, address: 0x66BC20
unsigned int throw_destroy_callback(class xEnt *, void *, unsigned char); // size: 0x0, address: 0x488BB0
unsigned int zThrowableSystemLongmediumCollideCB(class xEnt *, class xEnt *, class xVec3 *, class xVec3 *, void *); // size: 0x0, address: 0x447350
// total size: 0x2C
struct /* @anon2 */ {} z::rubble_system::__vtable; // size: 0x2C, address: 0x606F20
// total size: 0x14
class xCylinder {
    // Members
public:
...
public:
    ...
    class xEnt ent; // offset 0x40, size 0xD8
    class rubble_chunk_config * cfg; // offset 0x118, size 0x4
    class ball_physics * physics; // offset 0x11C, size 0x4
    signed int flags; // offset 0x120, size 0x4
    class xVec3 settle_loc; // offset 0x124, size 0xC
    float settle_time; // offset 0x130, size 0x4
    signed int spawn_index; // offset 0x134, size 0x4
    class rubble_system * rubsys; // offset 0x138, size 0x4
};
// total size: 0x30
class xMat3x3 {
    // Members
...
// total size: 0xC4
class rubble_system : public lightweight_system_base {
    // Members
public:
    class rubble_system_config config; // offset 0x4, size 0x60
    class pool_list rubble_bombs; // offset 0x64, size 0x20
    class pool_list rubble_chunks; // offset 0x84, size 0x20
    class xEntAsset * rubble_chunk_assets; // offset 0xA4, size 0x4
    unsigned char need_post_reset; // offset 0xA8, size 0x1
    class zShrapnelEmitterSphere bomb_shrap_emitter; // offset 0xAC, size 0x4
    class zShrapnelEmitterSphere chunk_shrap_emitter; // offset 0xB0, size 0x4
    class config_type * bomb_shrap_cfg; // offset 0xB4, size 0x4
    class config_type * chunk_shrap_cfg; // offset 0xB8, size 0x4
    signed int spawn_index; // offset 0xBC, size 0x4
    float pickup_time; // offset 0xC0, size 0x4
};
// total size: 0x18
class xBox {
    // Members
...
public:
    class xMat4x3 mat; // offset 0x0, size 0x40
    class xMat4x3 prev_mat; // offset 0x40, size 0x40
    class xMat4x3 shadow_mat; // offset 0x80, size 0x40
    float scale; // offset 0xC0, size 0x4
    signed int flags; // offset 0xC4, size 0x4
    enum motion_state_enum motion_state; // offset 0xC8, size 0x4
    class xModelInstance * model; // offset 0xCC, size 0x4
    float prev_dt; // offset 0xD0, size 0x4
    // total size: 0x70
    class /* @class */ {
        // Members
    public:
        union { // inferred
            ...
            class /* @class */ {
                // Members
            public:
                signed int bone; // offset 0x0, size 0x4
                class xVec3 offset; // offset 0x4, size 0xC
            } bind; // offset 0x0, size 0x10
            // total size: 0x70
            class /* @class */ {
                // Members
            public:
                float age; // offset 0x0, size 0x4
                class xMat4x3 start_mat; // offset 0x10, size 0x40
                class xVec3 start_vel; // offset 0x50, size 0xC
                class xVec3 rot_axis; // offset 0x5C, size 0xC
                float rot_vel; // offset 0x68, size 0x4
            } parabola; // offset 0x0, size 0x70
        };
    } motion; // offset 0xE0, size 0x70
    signed int _track_bone; // offset 0x150, size 0x4
    class xVec3 track_offset; // offset 0x154, size 0xC
    class xModelBlur blur; // offset 0x160, size 0x4
    class config_type cfg; // offset 0x164, size 0x34
    class config_type * smash_ring_cfg; // offset 0x198, size 0x4
    class emit_context * explode_decal; // offset 0x19C, size 0x4
    float ground_y; // offset 0x1A0, size 0x4
    float smash_ring_yoffset; // offset 0x1A4, size 0x4
    float splode_time; // offset 0x1A8, size 0x4
    class zSmashRingEmitter smash_ring; // offset 0x1AC, size 0x4
    class xShadowSimpleCache shadow_cache; // offset 0x1B0, size 0xA4
    class rubble_system * rubsys; // offset 0x254, size 0x4
};
// total size: 0xD0
class xCam {
    // Members
...
public:
    ...
    class rubble_bomb value; // offset 0x10, size 0x260
};
// total size: 0x2C
...
// total size: 0x74
class rubble_chunk_config {
    // Members
public:
    unsigned int model; // offset 0x0, size 0x4
    unsigned int collModel; // offset 0x4, size 0x4
    float scale; // offset 0x8, size 0x4
    float radius; // offset 0xC, size 0x4
    unsigned int throwFlags; // offset 0x10, size 0x4
    class xVec3 prefer_offset; // offset 0x14, size 0xC
    class xVec3 prefer_up; // offset 0x20, size 0xC
    class rubble_dust_config dust; // offset 0x2C, size 0x2C
    class xBallPhysicsProperties physics; // offset 0x58, size 0x1C
};
// total size: 0x10
class iEnvMatOrder {
    // Members
...
// total size: 0x4C
class ball_physics : public xBallPhysics {};
// total size: 0x168
class xJSPNodeLight {
    // Members
public:
...
// total size: 0x18
class cb_motivate_above {
    // Members
public:
    class xVec3 center; // offset 0x0, size 0xC
    float radius; // offset 0xC, size 0x4
    class xEnt * owner_ent; // offset 0x10, size 0x4
    class rubble_system * rubsys; // offset 0x14, size 0x4
};
// total size: 0xB0
class RwFrame {
    // Members
...
public:
    class node_type * prev; // offset 0x0, size 0x4
    class node_type * next; // offset 0x4, size 0x4
    class rubble_chunk value; // offset 0x10, size 0x140
};
// total size: 0x60
class rubble_system_config {
    // Members
public:
    unsigned int bomb_model_id; // offset 0x0, size 0x4
    float bomb_scale; // offset 0x4, size 0x4
    class rubble_chunk_config * chunk_types; // offset 0x8, size 0x4
    signed int chunk_type_count; // offset 0xC, size 0x4
    signed int emit_min; // offset 0x10, size 0x4
    signed int emit_max; // offset 0x14, size 0x4
    float yaw_variance; // offset 0x18, size 0x4
    float pitch_min; // offset 0x1C, size 0x4
    float pitch_max; // offset 0x20, size 0x4
    float radius_min; // offset 0x24, size 0x4
    float radius_max; // offset 0x28, size 0x4
    float vel_min; // offset 0x2C, size 0x4
    float vel_max; // offset 0x30, size 0x4
    float rot_vel_min; // offset 0x34, size 0x4
    float rot_vel_max; // offset 0x38, size 0x4
    class xEnt * owner; // offset 0x3C, size 0x4
    float ymin; // offset 0x40, size 0x4
    // total size: 0x1C
    class /* @class */ {
        // Members
    public:
        signed int max_active; // offset 0x0, size 0x4
        float ground_y; // offset 0x4, size 0x4
        float spawn_delay; // offset 0x8, size 0x4
        float probability; // offset 0xC, size 0x4
        unsigned int * types; // offset 0x10, size 0x4
        signed int types_size; // offset 0x14, size 0x4
        unsigned char (* allow_spawn)(class xVec3 &); // offset 0x18, size 0x4
    } pickup; // offset 0x44, size 0x1C
};
// total size: 0x0
class zSlideCam {};
// total size: 0x8
...
class zSmashRingEmitter {
    // Members
public:
    class activity_data * act; // offset 0x0, size 0x4
};
enum RxClusterValid {
...
// total size: 0xC
class cb_gather_sphere_hits {
    // Members
public:
    class xEnt * * hits; // offset 0x0, size 0x4
    class xEnt * * end_hits; // offset 0x4, size 0x4
    class xSphere & sphere; // offset 0x8, size 0x4
};
// total size: 0x34
class config_type {
    // Members
public:
    ...
    signed int texture_repeats; // offset 0x4, size 0x4
    ...
    signed int ring_segments; // offset 0x28, size 0x4
    class xColor_tag color_lower; // offset 0x2C, size 0x4
    class xColor_tag color_upper; // offset 0x30, size 0x4
};
// total size: 0x18
class analog_data {
    // Members
...
class config_type {
    // Members
public:
    float explode_radius; // offset 0x0, size 0x4
    float explode_time; // offset 0x4, size 0x4
    class rubble_dust_config dust; // offset 0x8, size 0x2C
};
// total size: 0x24
class xAnimFile {
    // Members
...
// total size: 0x2C
class rubble_dust_config {
    // Members
public:
    signed int spawn_min; // offset 0x0, size 0x4
    signed int spawn_max; // offset 0x4, size 0x4
    float vel_min; // offset 0x8, size 0x4
    float vel_max; // offset 0xC, size 0x4
    ...
    float time_span; // offset 0x28, size 0x4
};
// total size: 0x10
class cb_collide_sphere_statics {
    // Members
public:
    class rubble_system * rubsys; // offset 0x0, size 0x4
    class xSphere * sphere; // offset 0x4, size 0x4
    class xCollis * coll; // offset 0x8, size 0x4
...
public:
    signed int spawn_min; // offset 0x0, size 0x4
    signed int spawn_max; // offset 0x4, size 0x4
    float radius_min; // offset 0x8, size 0x4
    float radius_max; // offset 0xC, size 0x4
    float pitch_min; // offset 0x10, size 0x4
    float pitch_max; // offset 0x14, size 0x4
    float vel_min; // offset 0x18, size 0x4
    float vel_max; // offset 0x1C, size 0x4
    float scale_min; // offset 0x20, size 0x4
    float scale_max; // offset 0x24, size 0x4
    float rot_vel_min; // offset 0x28, size 0x4
    float rot_vel_max; // offset 0x2C, size 0x4
    float intensity_min; // offset 0x30, size 0x4
    float intensity_max; // offset 0x34, size 0x4
    class _xFColor color; // offset 0x38, size 0x10
    float lifetime; // offset 0x48, size 0x4
    float gravity; // offset 0x4C, size 0x4
    float bounce; // offset 0x50, size 0x4
    float friction; // offset 0x54, size 0x4
    signed int max_bounces; // offset 0x58, size 0x4
    signed int proj_flags; // offset 0x5C, size 0x4
    unsigned int child; // offset 0x60, size 0x4
    unsigned int * models; // offset 0x64, size 0x4
    signed int models_size; // offset 0x68, size 0x4
};
// total size: 0x14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004885F0 -> 0x004887A4
*/
// Range: 0x4885F0 -> 0x4887A4
// this: r17
void rubble_system::try_spawn_pickup(class xVec3 & center /* r16 */, float radius /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x4885F0 -> 0x4887A4
        float y; // r20
        float yupper; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004887B0 -> 0x004887F8
*/
// Range: 0x4887B0 -> 0x4887F8
// this: r2
class xLightKit * rubble_system::get_light_kit() {
    /* anonymous block */ {
        // Range: 0x4887B0 -> 0x4887F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488800 -> 0x00488994
*/
// Range: 0x488800 -> 0x488994
// this: r2
class node_type * rubble_system::find_stale_chunk() {
    /* anonymous block */ {
        // Range: 0x488800 -> 0x488994
        ...
        float cy; // r5
        float cz; // r4
        class node_type * farthest; // r3
        float farthest_dist2; // r3
        class node_type * it; // r2
        class node_type * end; // r2
        class rubble_chunk & chunk; // r2
        float dx; // r29
        float dy; // r29
        float dz; // r29
        float dist2; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004889A0 -> 0x00488BB0
*/
// Range: 0x4889A0 -> 0x488BB0
void event_handler_callback(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4889A0 -> 0x488BB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488BB0 -> 0x00488C18
*/
// Range: 0x488BB0 -> 0x488C18
unsigned int throw_destroy_callback(class xEnt * ent /* r2 */, unsigned char impact /* r2 */) {
    /* anonymous block */ {
        // Range: 0x488BB0 -> 0x488C18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488C20 -> 0x00488C50
*/
// Range: 0x488C20 -> 0x488C50
void bound_update_callback(class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x488C20 -> 0x488C50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488C50 -> 0x00488D40
*/
// Range: 0x488C50 -> 0x488D40
// this: r18
void rubble_chunk::smash(unsigned char reward /* r17 */) {
    /* anonymous block */ {
        // Range: 0x488C50 -> 0x488D40
        class xMat4x3 shrap_mat; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488D40 -> 0x00489074
*/
// Range: 0x488D40 -> 0x489074
// this: r16
void rubble_chunk::launch(class xVec3 & loc /* r2 */, class xVec3 & vel /* r2 */, class xVec3 & rot_axis /* r2 */, float rot_vel /* r29+0x70 */) {
    /* anonymous block */ {
        // Range: 0x488D40 -> 0x489074
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00489080 -> 0x00489300
*/
// Range: 0x489080 -> 0x489300
// this: r18
void rubble_chunk::activate(class xLightKit * kit /* r17 */, class rubble_chunk_config & cfg /* r16 */, class xEntAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x489080 -> 0x489300
        class xMat4x3 & model_mat; // r2
        class xVec3 corner_dist; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00489300 -> 0x004896C8
*/
// Range: 0x489300 -> 0x4896C8
// this: r16
void rubble_chunk::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x489300 -> 0x4896C8
        class xMat4x3 & model_mat; // r2
        float dx; // r29+0xD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004896D0 -> 0x004897E4
*/
// Range: 0x4896D0 -> 0x4897E4
// this: r17
void rubble_chunk::setup(class rubble_system * rubsys /* r16 */) {
    /* anonymous block */ {
        // Range: 0x4896D0 -> 0x4897E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004897F0 -> 0x004897F8
*/
// Range: 0x4897F0 -> 0x4897F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00489800 -> 0x00489F30
*/
// Range: 0x489800 -> 0x489F30
// this: r30
void rubble_bomb::spawn_chunks() {
    /* anonymous block */ {
        // Range: 0x489800 -> 0x489F30
        class rubble_system_config & cfg; // r2
        float pitch_min; // r25
        float rot_vel_min; // r24
        float rscale_pitch; // r23
        float rscale_radius; // r22
        float rscale_vel; // r29+0xDC
        float rscale_rot_vel; // r29+0xD8
        signed int emit_max; // r2
        signed int emit_min; // r2
        signed int emit; // r18
        float dyaw; // r21
        float rscale_yaw; // r29+0xD4
        float yaw_min; // r20
        ...
        class xVec3 loc; // r29+0x100
        class xVec3 vel; // r29+0xF0
        class xVec3 rot_axis; // r29+0xE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00489F30 -> 0x0048A2C8
*/
// Range: 0x489F30 -> 0x48A2C8
// this: r17
void rubble_bomb::update_motion_parabola(float dt /* r29+0x190 */) {
    /* anonymous block */ {
        // Range: 0x489F30 -> 0x48A2C8
        class xVec3 last_loc; // r29+0x180
        float t; // r6
        class xVec3 & p; // r2
        class xVec3 & v; // r2
        float rot; // r29+0x190
        class xMat3x3 rot_mat; // r29+0x150
        class xSweptSphere sws; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A2D0 -> 0x0048A518
*/
// Range: 0x48A2D0 -> 0x48A518
// this: r17
void rubble_bomb::explode(float ground_y /* r20 */) {
    /* anonymous block */ {
        // Range: 0x48A2D0 -> 0x48A518
        class xVec3 center; // r29+0xC0
        float rot; // r20
        class xMat4x3 decal_mat; // r29+0x80
        class xMat4x3 shrap_mat; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A520 -> 0x0048A778
*/
// Range: 0x48A520 -> 0x48A778
// this: r16
void rubble_bomb::launch_at(class xVec3 & target /* r17 */, float xzvel /* r20 */) {
    /* anonymous block */ {
        // Range: 0x48A520 -> 0x48A778
        class xQuat q0; // r29+0x60
        class xQuat q1; // r29+0x50
        class xQuat dq; // r29+0x40
        class xVec3 rot_axis; // r29+0x88
        float rot_vel; // r29+0x9C
        class xVec3 vel; // r29+0x78
        float dx; // r29+0xA0
        float dy; // r29+0x98
        float dz; // r29+0xA0
        float det; // r29+0xA0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A780 -> 0x0048A7D0
*/
// Range: 0x48A780 -> 0x48A7D0
// this: r2
void rubble_bomb::blur_end() {
    /* anonymous block */ {
        // Range: 0x48A780 -> 0x48A7D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A7D0 -> 0x0048A838
*/
// Range: 0x48A7D0 -> 0x48A838
// this: r7
void rubble_bomb::blur_begin() {
    /* anonymous block */ {
        // Range: 0x48A7D0 -> 0x48A838
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A840 -> 0x0048A870
*/
// Range: 0x48A840 -> 0x48A870
// this: r2
void rubble_bomb::damage_enable(unsigned char knockback_from_boss /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48A840 -> 0x48A870
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A870 -> 0x0048A8A8
*/
// Range: 0x48A870 -> 0x48A8A8
// this: r2
void rubble_bomb::show() {
    /* anonymous block */ {
        // Range: 0x48A870 -> 0x48A8A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A8B0 -> 0x0048A8D8
*/
// Range: 0x48A8B0 -> 0x48A8D8
// this: r2
void rubble_bomb::track_bone(signed int bone /* r2 */, class xVec3 & offset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48A8B0 -> 0x48A8D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048A8E0 -> 0x0048B11C
*/
// Range: 0x48A8E0 -> 0x48B11C
// this: r16
void rubble_bomb::update(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x48A8E0 -> 0x48B11C
        class xSphere sphere; // r29+0x200
        float t; // r29+0x250
        class xMat4x3 & model_mat; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B120 -> 0x0048B154
*/
// Range: 0x48B120 -> 0x48B154
// this: r16
void rubble_bomb::deactivate() {
    /* anonymous block */ {
        // Range: 0x48B120 -> 0x48B154
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B160 -> 0x0048B228
*/
// Range: 0x48B160 -> 0x48B228
// this: r2
void rubble_bomb::activate(class config_type * cfg /* r2 */, class config_type * smash_ring_cfg /* r2 */, class emit_context * explode_decal /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48B160 -> 0x48B228
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B230 -> 0x0048B810
*/
// Range: 0x48B230 -> 0x48B810
// this: r20
void rubble_system::setup(class rubble_system_config & config /* r19 */, class config_type * bomb_shrap_cfg /* r18 */, class config_type * chunk_shrap_cfg /* r21 */) {
    /* anonymous block */ {
        // Range: 0x48B230 -> 0x48B810
        class node_type * rb; // r17
        class node_type * end_rb; // r2
        signed int types; // r2
        signed int i; // r7
        class node_type * rc; // r16
        class node_type * end_rc; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B810 -> 0x0048B95C
*/
// Range: 0x48B810 -> 0x48B95C
// this: r20
void rubble_system::scene_setup() {
    /* anonymous block */ {
        // Range: 0x48B810 -> 0x48B95C
        signed int i; // r19
        class rubble_chunk_config & cfg; // r2
        class xVec3 prefer_offset; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B960 -> 0x0048B998
*/
// Range: 0x48B960 -> 0x48B998
// this: r2
void rubble_system::post_render_3d() {
    /* anonymous block */ {
        // Range: 0x48B960 -> 0x48B998
        class node_type * rc; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048B9A0 -> 0x0048BAA0
*/
// Range: 0x48B9A0 -> 0x48BAA0
// this: r18
void rubble_system::render() {
    /* anonymous block */ {
        // Range: 0x48B9A0 -> 0x48BAA0
        class node_type * rb; // r17
        class node_type * end_rb; // r2
        class node_type * rc; // r17
        class node_type * end_rc; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048BAA0 -> 0x0048BBA0
*/
// Range: 0x48BAA0 -> 0x48BBA0
// this: r16
void rubble_system::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x48BAA0 -> 0x48BBA0
        class node_type * rb; // r3
        class node_type * end_rb; // r2
        class node_type * next_rb; // r2
        class node_type * rc; // r3
        class node_type * end_rc; // r2
        class node_type * next_rc; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048BBA0 -> 0x0048BC94
*/
// Range: 0x48BBA0 -> 0x48BC94
// this: r18
void rubble_system::reset() {
    /* anonymous block */ {
        // Range: 0x48BBA0 -> 0x48BC94
        class node_type * rb; // r3
        class node_type * rc; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048BCA0 -> 0x0048BCB0
*/
// Range: 0x48BCA0 -> 0x48BCB0
// this: r2
unsigned char rubble_system::collide_with(class xEnt & ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48BCA0 -> 0x48BCB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048BCB0 -> 0x0048BF1C
*/
// Range: 0x48BCB0 -> 0x48BF1C
static void emit_dust(class rubble_dust_config & dust /* r21 */, class xVec3 & center /* r16 */) {
    /* anonymous block */ {
        // Range: 0x48BCB0 -> 0x48BF1C
        signed int amount; // r20
        class xVec3 * loc; // r19
        class xVec3 * vel; // r22
        float cx; // r25
        float cy; // r24
        ...
        float vel_min; // r22
        float vel_range; // r21
        float radius_range; // r20
        signed int i; // r18
        float velmag; // r29+0xA0
        float radius; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048BF20 -> 0x0048BFB0
*/
// Range: 0x48BF20 -> 0x48BFB0
static void collide_swept_sphere_statics_callback(class xRay3 * ray /* r18 */, class xQCData * qcd /* r2 */, class xEnt * ent /* r17 */, void * context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48BF20 -> 0x48BFB0
