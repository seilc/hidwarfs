/*
    Compile unit: C:\TestBuild\in\GAME\zNPCFlyShooter.cpp
...
// total size: 0xB4
struct /* @anon24 */ {} zNPC::flying_lobber::__vtable; // size: 0xB4, address: 0x604D50
// total size: 0x7C
struct /* @anon10 */ {} zNPC::bone_container<zNPC::blade_bone>::__vtable; // size: 0x7C, address: 0x602710
// total size: 0x7C
...
// total size: 0x7C
struct /* @anon16 */ {} zNPC::hover_bob::__vtable; // size: 0x7C, address: 0x603050
// total size: 0x7C
struct /* @anon2 */ {} zNPC::flying_idle::__vtable; // size: 0x7C, address: 0x604E10
// total size: 0x7C
struct /* @anon0 */ {} zNPC::idle::__vtable; // size: 0x7C, address: 0x601770
// total size: 0x80
struct /* @anon19 */ {} zNPC::human_lob::__vtable; // size: 0x80, address: 0x602550
// total size: 0x7C
struct /* @anon4 */ {} zNPC::lob_generic<zNPC::move>::__vtable; // size: 0x7C, address: 0x602450
// total size: 0x7C
struct /* @anon9 */ {} zNPC::firing_attack_generic<zNPC::move>::__vtable; // size: 0x7C, address: 0x6024D0
// total size: 0x7C
struct /* @anon3 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon23 */ {} zNPC::projectile::__vtable; // size: 0x7C, address: 0x5FDB20
// total size: 0x88
struct /* @anon17 */ {} zNPC::follow_movepoints::__vtable; // size: 0x88, address: 0x5FD810
// total size: 0x7C
struct /* @anon25 */ {} zNPC::fly_forward::__vtable; // size: 0x7C, address: 0x605150
// total size: 0xB4
struct /* @anon12 */ {} zNPC::flying_npc_generic<zNPC::human_throwable>::__vtable; // size: 0xB4, address: 0x604E90
// total size: 0xB4
struct /* @anon6 */ {} zNPC::human_throwable::__vtable; // size: 0xB4, address: 0x5FD920
// total size: 0x80
struct /* @anon18 */ {} zNPC::rocket_lob::__vtable; // size: 0x80, address: 0x6050D0
// total size: 0xB4
struct /* @anon1 */ {} zNPC::flying_rocket::__vtable; // size: 0xB4, address: 0x604F50
// total size: 0x7C
struct /* @anon20 */ {} zNPC::bone_container<zNPC::laser_bone>::__vtable; // size: 0x7C, address: 0x5FE4E0
// total size: 0x80
struct /* @anon15 */ {} zNPC::wait_shoot::__vtable; // size: 0x80, address: 0x5FE690
// total size: 0x80
struct /* @anon13 */ {} zNPC::shoot::__vtable; // size: 0x80, address: 0x5FE710
// total size: 0xB4
struct /* @anon5 */ {} zNPC::flying_shooter::__vtable; // size: 0xB4, address: 0x605010
// total size: 0x24
struct /* @anon8 */ {} z::lightweight_system<z::rocket, 20>::__vtable; // size: 0x24, address: 0x5FF3B0
// total size: 0x24
struct /* @anon11 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
...
// total size: 0x7C
struct /* @anon7 */ {} zNPC::firing_bone::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon22 */ {} zNPC::bone_behavior::__vtable; // size: 0x7C, address: 0x0
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x2D0
class flying_npc_generic : public human_throwable {
    // Members
public:
...
// total size: 0x620
class flying_rocket : public flying_npc_generic {
    // Members
public:
    class fly_forward fly_foward_state; // offset 0x2D0, size 0x14
    class follow_movepoints follow_movepoints_state; // offset 0x2F0, size 0xB0
    class projectile projectile_state; // offset 0x3A0, size 0x120
    class rocket_lob rocket_lob_state; // offset 0x4C0, size 0xD0
    class flying_idle idle_state; // offset 0x590, size 0x10
    class hover_bob bob_state; // offset 0x5A0, size 0x60
    class bone_container blade_bones; // offset 0x600, size 0x18
    float old_speed; // offset 0x618, size 0x4
};
// total size: 0xB4
struct /* @anon6 */ {};
// total size: 0x20
...
// total size: 0xD0
class rocket_lob : public human_lob {
    // Members
public:
    float rocket_turn_speed; // offset 0xC8, size 0x4
    float rocket_speed; // offset 0xCC, size 0x4
};
// total size: 0x14
...
// total size: 0x5E0
class flying_shooter : public flying_npc_generic {
    // Members
public:
    class fly_forward fly_foward_state; // offset 0x2D0, size 0x14
    class follow_movepoints follow_movepoints_state; // offset 0x2F0, size 0xB0
    class projectile projectile_state; // offset 0x3A0, size 0x120
    class wait_shoot shoot_state; // offset 0x4C0, size 0x78
    class bone_container laser_bones; // offset 0x538, size 0x18
    class hover_bob bob_state; // offset 0x550, size 0x60
    class flying_idle idle_state; // offset 0x5B0, size 0x10
    class bone_container blade_bones; // offset 0x5C0, size 0x18
    float old_speed; // offset 0x5D8, size 0x4
};
// total size: 0x0
class zFrag {};
// total size: 0x14
...
struct /* @anon8 */ {};
// total size: 0x620
class flying_lobber : public flying_npc_generic {
    // Members
public:
    class fly_forward fly_foward_state; // offset 0x2D0, size 0x14
    class follow_movepoints follow_movepoints_state; // offset 0x2F0, size 0xB0
    class projectile projectile_state; // offset 0x3A0, size 0x120
    class human_lob lob_state; // offset 0x4C0, size 0xC8
    class flying_idle idle_state; // offset 0x588, size 0x10
    class hover_bob bob_state; // offset 0x598, size 0x60
    class bone_container blade_bones; // offset 0x5F8, size 0x18
    float old_speed; // offset 0x610, size 0x4
};
// total size: 0x8
...
// total size: 0x14
class fly_forward : public behavior_implementation {
    // Members
public:
    class follow_movepoints & follow_movepoints_state; // offset 0x10, size 0x4
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431880 -> 0x00431988
*/
// Range: 0x431880 -> 0x431988
// this: r16
void flying_lobber::update_npc(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x431880 -> 0x431988
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431990 -> 0x004319BC
*/
// Range: 0x431990 -> 0x4319BC
// this: r16
void flying_lobber::reset() {
    /* anonymous block */ {
        // Range: 0x431990 -> 0x4319BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004319C0 -> 0x00431A24
*/
// Range: 0x4319C0 -> 0x431A24
// this: r16
void flying_lobber::setup() {
    /* anonymous block */ {
        // Range: 0x4319C0 -> 0x431A24
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431A30 -> 0x00431BCC
*/
// Range: 0x431A30 -> 0x431BCC
// this: r16
flying_lobber::flying_lobber() {
    /* anonymous block */ {
        // Range: 0x431A30 -> 0x431BCC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431C40 -> 0x00431D48
*/
// Range: 0x431C40 -> 0x431D48
// this: r16
void flying_rocket::update_npc(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x431C40 -> 0x431D48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431D50 -> 0x00431D7C
*/
// Range: 0x431D50 -> 0x431D7C
// this: r16
void flying_rocket::reset() {
    /* anonymous block */ {
        // Range: 0x431D50 -> 0x431D7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431D80 -> 0x00431DE4
*/
// Range: 0x431D80 -> 0x431DE4
// this: r16
void flying_rocket::setup() {
    /* anonymous block */ {
        // Range: 0x431D80 -> 0x431DE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431DF0 -> 0x00431F8C
*/
// Range: 0x431DF0 -> 0x431F8C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00431F90 -> 0x00432098
*/
// Range: 0x431F90 -> 0x432098
// this: r16
void flying_shooter::update_npc(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x431F90 -> 0x432098
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004320A0 -> 0x004320CC
*/
// Range: 0x4320A0 -> 0x4320CC
// this: r16
void flying_shooter::reset() {
    /* anonymous block */ {
        // Range: 0x4320A0 -> 0x4320CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004320D0 -> 0x00432134
*/
// Range: 0x4320D0 -> 0x432134
// this: r16
void flying_shooter::setup() {
    /* anonymous block */ {
        // Range: 0x4320D0 -> 0x432134
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432140 -> 0x0043230C
*/
// Range: 0x432140 -> 0x43230C
// this: r16
flying_shooter::flying_shooter() {
    /* anonymous block */ {
        // Range: 0x432140 -> 0x43230C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432310 -> 0x0043231C
*/
// Range: 0x432310 -> 0x43231C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432320 -> 0x00432380
*/
// Range: 0x432320 -> 0x432380
// this: r16
void rocket_lob::setup() {
    /* anonymous block */ {
        // Range: 0x432320 -> 0x432380
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432380 -> 0x0043255C
*/
// Range: 0x432380 -> 0x43255C
// this: r16
void rocket_lob::launch() {
    /* anonymous block */ {
        // Range: 0x432380 -> 0x43255C
        class xVec3 rocket_pos; // r29+0xA0
        class rocket new_rocket; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432560 -> 0x0043256C
*/
// Range: 0x432560 -> 0x43256C
unsigned char grabbable(enum GrabType grabType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x432560 -> 0x43256C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432570 -> 0x00432578
*/
// Range: 0x432570 -> 0x432578
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00432580 -> 0x004325D4
*/
// Range: 0x432580 -> 0x4325D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004325E0 -> 0x00432608
*/
// Range: 0x4325E0 -> 0x432608
// this: r2
void fly_forward::enter_state() {
    /* anonymous block */ {
        // Range: 0x4325E0 -> 0x432608
    }
}
