/*
    Compile unit: C:\TestBuild\in\GAME\zNPCMine.cpp
...
// total size: 0xB4
struct /* @anon7 */ {} zNPC::mine::__vtable; // size: 0xB4, address: 0x5FEE20
// total size: 0x7C
struct /* @anon2 */ {} zNPC::mine_explode::__vtable; // size: 0x7C, address: 0x5FEEE0
// total size: 0x7C
struct /* @anon3 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x7C
...
// total size: 0x7C
struct /* @anon9 */ {} zNPC::initial_anim::__vtable; // size: 0x7C, address: 0x5FF0A0
// total size: 0x98
struct /* @anon5 */ {} zNPC::mine_charge::__vtable; // size: 0x98, address: 0x5FF000
// total size: 0x98
struct /* @anon6 */ {} zNPC::npc_move::__vtable; // size: 0x98, address: 0x5FF120
// total size: 0x7C
struct /* @anon4 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x98
struct /* @anon0 */ {} zNPC::mine_home::__vtable; // size: 0x98, address: 0x5FEF60
// total size: 0x7C
struct /* @anon10 */ {} zNPC::idle::__vtable; // size: 0x7C, address: 0x601770
...
// total size: 0x14
class initial_anim : public behavior_implementation {
    // Members
public:
...
// total size: 0x3B8
class mine : public common {
    // Members
public:
    class idle idle_state; // offset 0x2C0, size 0x10
    class mine_home mine_home_state; // offset 0x2D0, size 0x38
    class mine_charge mine_charge_state; // offset 0x308, size 0x40
    class initial_anim rising_state; // offset 0x348, size 0x14
    class mine_explode mine_explode_state; // offset 0x35C, size 0x58
    float rings_emitted; // offset 0x3B4, size 0x4
};
// total size: 0x38
class mine_home : public npc_move {
    // Members
public:
...
// total size: 0x40
class mine_charge : public npc_move {
    // Members
public:
    float radius; // offset 0x34, size 0x4
    float timer; // offset 0x38, size 0x4
    float wait_time; // offset 0x3C, size 0x4
};
// total size: 0x50
...
// total size: 0x58
class mine_explode : public explode {
    // Members
public:
    float radius; // offset 0x54, size 0x4
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224B40 -> 0x00224B68
*/
// Range: 0x224B40 -> 0x224B68
// this: r16
void mine::reset() {
    /* anonymous block */ {
        // Range: 0x224B40 -> 0x224B68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224B70 -> 0x00224CB8
*/
// Range: 0x224B70 -> 0x224CB8
// this: r16
void mine::update_npc(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x224B70 -> 0x224CB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224CC0 -> 0x00224D1C
*/
// Range: 0x224CC0 -> 0x224D1C
// this: r16
void mine::setup() {
    /* anonymous block */ {
        // Range: 0x224CC0 -> 0x224D1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224D20 -> 0x00224E44
*/
// Range: 0x224D20 -> 0x224E44
// this: r16
mine::mine() {
    /* anonymous block */ {
        // Range: 0x224D20 -> 0x224E44
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224E50 -> 0x00224E98
*/
// Range: 0x224E50 -> 0x224E98
// this: r16
unsigned char mine_explode::runnable() {
    /* anonymous block */ {
        // Range: 0x224E50 -> 0x224E98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224EA0 -> 0x00224EE4
*/
// Range: 0x224EA0 -> 0x224EE4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224EF0 -> 0x00224F48
*/
// Range: 0x224EF0 -> 0x224F48
// this: r2
unsigned char mine_home::runnable() {
    /* anonymous block */ {
        // Range: 0x224EF0 -> 0x224F48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224F50 -> 0x00224F9C
*/
// Range: 0x224F50 -> 0x224F9C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224FA0 -> 0x00224FC8
*/
// Range: 0x224FA0 -> 0x224FC8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00224FD0 -> 0x00224FF8
*/
// Range: 0x224FD0 -> 0x224FF8
// this: r2
void mine_home::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x224FD0 -> 0x224FF8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225000 -> 0x00225054
*/
// Range: 0x225000 -> 0x225054
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225060 -> 0x002250C0
*/
// Range: 0x225060 -> 0x2250C0
// this: r16
void mine_charge::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x225060 -> 0x2250C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002250C0 -> 0x0022510C
*/
// Range: 0x2250C0 -> 0x22510C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225110 -> 0x002251AC
*/
// Range: 0x225110 -> 0x2251AC
// this: r16
unsigned char mine_charge::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x225110 -> 0x2251AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002251C0 -> 0x00225220
*/
// Range: 0x2251C0 -> 0x225220
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225220 -> 0x0022527C
*/
// Range: 0x225220 -> 0x22527C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225280 -> 0x00225320
*/
// Range: 0x225280 -> 0x225320
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225320 -> 0x00225370
*/
// Range: 0x225320 -> 0x225370
// this: r2
unsigned char initial_anim::runnable(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x225320 -> 0x225370
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225370 -> 0x00225398
*/
// Range: 0x225370 -> 0x225398
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002253A0 -> 0x0022541C
*/
// Range: 0x2253A0 -> 0x22541C
// this: r16
void initial_anim::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2253A0 -> 0x22541C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225420 -> 0x00225474
*/
// Range: 0x225420 -> 0x225474
void add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x225420 -> 0x225474
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225480 -> 0x00225488
*/
// Range: 0x225480 -> 0x225488
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00225490 -> 0x00225498
*/
// Range: 0x225490 -> 0x225498
// this: r2
