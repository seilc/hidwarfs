/*
    Compile unit: C:\TestBuild\in\GAME\zHudDashMeter.cpp
...
// total size: 0x28
struct /* @anon1 */ {} zHud::DashMeter::__vtable; // size: 0x28, address: 0x6057D0
unsigned char blink_text_motive_reset(class widget &, class motive &); // size: 0x0, address: 0x42C1C0
unsigned char blink_text_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x42BDF0
class zGlobals globals; // size: 0x640, address: 0x61C210
unsigned char scale_text_motive_reset(class widget &, class motive &); // size: 0x0, address: 0x42C370
unsigned char scale_text_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x42C1F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DBD0 -> 0x0044DC60
*/
// Range: 0x44DBD0 -> 0x44DC60
// this: r16
void DashMeter::setTimeRemaining(unsigned int uHour /* r2 */, unsigned int uMin /* r2 */, unsigned int uSec /* r2 */) {
    /* anonymous block */ {
        // Range: 0x44DBD0 -> 0x44DC60
        char buffer[16]; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DC60 -> 0x0044DCB8
*/
// Range: 0x44DC60 -> 0x44DCB8
// this: r16
void DashMeter::setPercentText(unsigned int uPercent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x44DC60 -> 0x44DCB8
        char buffer[12]; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DCC0 -> 0x0044DD18
*/
// Range: 0x44DCC0 -> 0x44DD18
// this: r16
void DashMeter::setSpeed(unsigned int uSpeed /* r2 */) {
    /* anonymous block */ {
        // Range: 0x44DCC0 -> 0x44DD18
        char buffer0[12]; // r29+0x30
        char buffer1[12]; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DD20 -> 0x0044DDF4
*/
// Range: 0x44DD20 -> 0x44DDF4
// this: r2
void DashMeter::setOffset(enum eDashMeterLayer eIcon /* r2 */, float fOffset /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x44DD20 -> 0x44DDF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DE00 -> 0x0044DE6C
*/
// Range: 0x44DE00 -> 0x44DE6C
// this: r16
void DashMeter::hide() {
    /* anonymous block */ {
        // Range: 0x44DE00 -> 0x44DE6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DE70 -> 0x0044DEC8
*/
// Range: 0x44DE70 -> 0x44DEC8
// this: r16
void DashMeter::show() {
    /* anonymous block */ {
        // Range: 0x44DE70 -> 0x44DEC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044DED0 -> 0x0044E134
*/
// Range: 0x44DED0 -> 0x44E134
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E140 -> 0x0044E148
*/
// Range: 0x44E140 -> 0x44E148
void destroy() {
    /* anonymous block */ {
        // Range: 0x44E140 -> 0x44E148
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E150 -> 0x0044E2B4
*/
// Range: 0x44E150 -> 0x44E2B4
// this: r17
void DashMeter::setCountdownFlashingRed(unsigned char bOn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x44E150 -> 0x44E2B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E2C0 -> 0x0044E358
*/
// Range: 0x44E2C0 -> 0x44E358
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E360 -> 0x0044E87C
*/
// Range: 0x44E360 -> 0x44E87C
// this: r16
void DashMeter::setup() {
    /* anonymous block */ {
        // Range: 0x44E360 -> 0x44E87C
        unsigned int meterID; // r20
        unsigned int countdownTimerID; // r17
        unsigned int levelpercentID; // r19
        unsigned int speedmeterID; // r21
        unsigned int checkpointID; // r18
        unsigned int missionTextID; // r17
        class RwTexCoords upperleft; // r29+0x78
        class RwTexCoords lowerright; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E880 -> 0x0044E888
*/
// Range: 0x44E880 -> 0x44E888
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0044E890 -> 0x0044EA1C
*/
// Range: 0x44E890 -> 0x44EA1C
// this: r2
DashMeter::DashMeter() {
    /* anonymous block */ {
        // Range: 0x44E890 -> 0x44EA1C
