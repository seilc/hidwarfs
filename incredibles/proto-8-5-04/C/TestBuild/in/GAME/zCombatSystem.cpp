/*
    Compile unit: C:\TestBuild\in\GAME\zCombatSystem.cpp
...
static class xEnt * combatList[96]; // size: 0x180, address: 0x67EFA0
static unsigned int currentCombat; // size: 0x4, address: 0x608D34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7190 -> 0x001F7344
*/
// Range: 0x1F7190 -> 0x1F7344
void zCombatHitChooser(class xAnimState * state /* r17 */, void * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1F7190 -> 0x1F7344
        class xEnt * ent; // r2
        enum zHitSource source; // r24
        enum zHitTarget target; // r15
        class xAnimFile * files[16]; // r29+0x70
        signed int currentFile; // r16
        enum zHitSource bestSource; // r14
        enum zHitTarget bestTarget; // r13
        unsigned int i; // r12
        unsigned int id; // r2
        class xAnimFile * file; // r2
        unsigned int idSource; // r2
        enum zHitSource testSource; // r21
        unsigned int idTarget; // r2
        enum zHitTarget testTarget; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7350 -> 0x001F73E8
*/
// Range: 0x1F7350 -> 0x1F73E8
void zCombatSystemUpdateEntity(class xEnt * ent /* r16 */, float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x1F7350 -> 0x1F73E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F73F0 -> 0x001F7470
*/
// Range: 0x1F73F0 -> 0x1F7470
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7470 -> 0x001F7514
*/
// Range: 0x1F7470 -> 0x1F7514
void zCombatSystemUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1F7470 -> 0x1F7514
        unsigned int i; // r17
        class xEnt * ent; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7520 -> 0x001F7528
*/
// Range: 0x1F7520 -> 0x1F7528
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7530 -> 0x001F7540
*/
// Range: 0x1F7530 -> 0x1F7540
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F7540 -> 0x001F7550
*/
// Range: 0x1F7540 -> 0x1F7550
