/*
    Compile unit: C:\TestBuild\in\GAME\zNPCCar.cpp
...
static char * brakeTextureName; // size: 0x4, address: 0x607B68
static char * swerveTypeStrings[4]; // size: 0x10, address: 0x0
class xIm3DHelperQuadBuffer quadBuffer; // size: 0xC, address: 0x685A60
class xResponseCurve curve; // size: 0x10, address: 0x685A70
static class xColor_tag brake_color; // size: 0x4, address: 0x5EE810
static class smoke_config smoke_config; // size: 0x38, address: 0x685A80
// total size: 0xB4
struct /* @anon0 */ {} zNPC::car::__vtable; // size: 0xB4, address: 0x6010D0
...
// total size: 0x8C
struct /* @anon3 */ {} zNPC::CarDrive::__vtable; // size: 0x8C, address: 0x601190
// total size: 0x88
struct /* @anon2 */ {} zNPC::follow_movepoints::__vtable; // size: 0x88, address: 0x5FD810
// total size: 0x7C
struct /* @anon5 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon4 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon6 */ {} zNPC::exclusive_spline_path::__vtable; // size: 0x7C, address: 0x602DD0
// total size: 0x7C
struct /* @anon8 */ {} zNPC::follow_spline_path::__vtable; // size: 0x7C, address: 0x602CD0
// total size: 0x7C
struct /* @anon9 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon7 */ {} zNPC::BrakeLights::__vtable; // size: 0x7C, address: 0x6012A0
// total size: 0x7C
struct /* @anon1 */ {} zNPC::CarStop::__vtable; // size: 0x7C, address: 0x601220
...
class Incredimeter {};
// total size: 0x4
class car_collide_callback {
    // Members
public:
    class car * pCar; // offset 0x0, size 0x4
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2CE0 -> 0x002A2D40
*/
// Range: 0x2A2CE0 -> 0x2A2D40
// this: r2
void car::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A2CE0 -> 0x2A2D40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2D40 -> 0x002A2EA0
*/
// Range: 0x2A2D40 -> 0x2A2EA0
// this: r21
unsigned char car::system_event(class xBase * pFrom /* r20 */, class xBase * pTo /* r19 */, unsigned int toEvent /* r18 */, float * toParam /* r17 */, class xBase * to_parawidget /* r16 */, unsigned int to_parawidget_id /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2A2D40 -> 0x2A2EA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2EB0 -> 0x002A3480
*/
// Range: 0x2A2EB0 -> 0x2A3480
// this: r17
void car::update_npc(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2A2EB0 -> 0x2A3480
        float delta; // r29+0xA0
        float u; // r5
        float speed; // r22
        float newPitchModifier; // r20
        class car_collide_callback cb; // r29+0x9C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3480 -> 0x002A391C
*/
// Range: 0x2A3480 -> 0x2A391C
// this: r16
void car::move() {
    /* anonymous block */ {
        // Range: 0x2A3480 -> 0x2A391C
        class xVec3 pos; // r29+0x220
        class xSphere * playerSpheres[6]; // r29+0x170
        signed int sphereCount; // r2
        unsigned char collision; // r19
        signed int i; // r10
        class xSweptSphere sws; // r29+0xA0
        class xVec3 end; // r29+0x210
        signed int i; // r20
        class zCombatDamageInfo damageInfo; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3920 -> 0x002A3964
*/
// Range: 0x2A3920 -> 0x2A3964
// this: r16
void car::reset() {
    /* anonymous block */ {
        // Range: 0x2A3920 -> 0x2A3964
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3970 -> 0x002A39E8
*/
// Range: 0x2A3970 -> 0x2A39E8
// this: r17
void car::add_states(class xAnimTable * pTable /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A3970 -> 0x2A39E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A39F0 -> 0x002A3C44
*/
// Range: 0x2A39F0 -> 0x2A3C44
// this: r16
void car::setup() {
    /* anonymous block */ {
        // Range: 0x2A39F0 -> 0x2A3C44
        char * soundGroupName; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3C50 -> 0x002A3C58
*/
// Range: 0x2A3C50 -> 0x2A3C58
// this: r2
void car::scene_setup() {
    /* anonymous block */ {
        // Range: 0x2A3C50 -> 0x2A3C58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3C60 -> 0x002A3D68
*/
// Range: 0x2A3C60 -> 0x2A3D68
// this: r16
car::car() {
    /* anonymous block */ {
        // Range: 0x2A3C60 -> 0x2A3D68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3D70 -> 0x002A3D98
*/
// Range: 0x2A3D70 -> 0x2A3D98
// this: r2
void CarDrive::enter_state() {
    /* anonymous block */ {
        // Range: 0x2A3D70 -> 0x2A3D98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3DA0 -> 0x002A3DEC
*/
// Range: 0x2A3DA0 -> 0x2A3DEC
// this: r16
void CarDrive::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2A3DA0 -> 0x2A3DEC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3DF0 -> 0x002A3E74
*/
// Range: 0x2A3DF0 -> 0x2A3E74
// this: r2
unsigned char CarDrive::system_event(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A3DF0 -> 0x2A3E74
        float params[4]; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3E80 -> 0x002A3EC8
*/
// Range: 0x2A3E80 -> 0x2A3EC8
// this: r16
void CarDrive::reset() {
    /* anonymous block */ {
        // Range: 0x2A3E80 -> 0x2A3EC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3ED0 -> 0x002A3ED8
*/
// Range: 0x2A3ED0 -> 0x2A3ED8
// this: r2
void CarDrive::setup() {
    /* anonymous block */ {
        // Range: 0x2A3ED0 -> 0x2A3ED8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A3EE0 -> 0x002A4190
*/
// Range: 0x2A3EE0 -> 0x2A4190
// this: r16
void CarStop::emitSurfaceDecal(class xVec3 & loc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A3EE0 -> 0x2A4190
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A4190 -> 0x002A4298
*/
// Range: 0x2A4190 -> 0x2A4298
// this: r16
void CarStop::setup() {
    /* anonymous block */ {
        // Range: 0x2A4190 -> 0x2A4298
        char * tireTextureName; // r29+0x2C
        char * soundGroupName; // r29+0x28
        class curve_node decalCurve[3]; // @ 0x005EE820
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A42A0 -> 0x002A4428
*/
// Range: 0x2A42A0 -> 0x2A4428
// this: r18
void CarStop::enter_state() {
    /* anonymous block */ {
        // Range: 0x2A42A0 -> 0x2A4428
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A4430 -> 0x002A44A0
*/
// Range: 0x2A4430 -> 0x2A44A0
// this: r2
void CarStop::exit_state() {
    /* anonymous block */ {
        // Range: 0x2A4430 -> 0x2A44A0
        float params[4]; // r29+0x10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A44A0 -> 0x002A4598
*/
// Range: 0x2A44A0 -> 0x2A4598
// this: r17
unsigned char CarStop::damage(class zCombatDamageInfo & damageInfo /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2A44A0 -> 0x2A4598
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A45A0 -> 0x002A45A8
*/
// Range: 0x2A45A0 -> 0x2A45A8
void update() {
    /* anonymous block */ {
        // Range: 0x2A45A0 -> 0x2A45A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A45B0 -> 0x002A45F0
*/
// Range: 0x2A45B0 -> 0x2A45F0
// this: r2
unsigned char CarStop::runnable(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2A45B0 -> 0x2A45F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A45F0 -> 0x002A45FC
*/
// Range: 0x2A45F0 -> 0x2A45FC
// this: r2
void CarStop::reset() {
    /* anonymous block */ {
        // Range: 0x2A45F0 -> 0x2A45FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A4600 -> 0x002A481C
*/
// Range: 0x2A4600 -> 0x2A481C
void render_extra() {
    /* anonymous block */ {
        // Range: 0x2A4600 -> 0x2A481C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A4820 -> 0x002A48B0
*/
// Range: 0x2A4820 -> 0x2A48B0
// this: r2
unsigned char BrakeLights::runnable() {
    /* anonymous block */ {
        // Range: 0x2A4820 -> 0x2A48B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A48B0 -> 0x002A48E4
*/
// Range: 0x2A48B0 -> 0x2A48E4
void exit() {
    /* anonymous block */ {
        // Range: 0x2A48B0 -> 0x2A48E4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A48F0 -> 0x002A4A88
*/
// Range: 0x2A48F0 -> 0x2A4A88
// this: r17
void BrakeLights::setup() {
    /* anonymous block */ {
        // Range: 0x2A48F0 -> 0x2A4A88
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A4A90 -> 0x002A58F0
*/
// Range: 0x2A4A90 -> 0x2A58F0
// this: r16
void BrakeLights::update() {
    /* anonymous block */ {
        // Range: 0x2A4A90 -> 0x2A58F0
        class xVec2 view_dir; // r29+0x4B0
        signed int i; // r22
        class xVec3 halfWidthVec; // r29+0x4A0
        class xVec3 halfHeightVec; // r29+0x490
        class xVec3 pos; // r29+0x480
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A58F0 -> 0x002A5AA0
*/
// Range: 0x2A58F0 -> 0x2A5AA0
// this: r18
unsigned char car_collide_callback::operator()(class xEnt & ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2A58F0 -> 0x2A5AA0
        class xCollis coll; // r29+0x80
        class zCombatDamageInfo damageInfo; // r29+0x40
    }
}
