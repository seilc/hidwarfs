/*
    Compile unit: C:\TestBuild\in\GAME\zNPCNavigationMeshDriven.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class navigation_mesh_driven * driven_meshes[2]; // size: 0x8, address: 0x609178
static signed int num_driven_meshes; // size: 0x4, address: 0x609180
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
// total size: 0x50
class vertex_group {
    // Members
public:
    signed int num_vertices; // offset 0x0, size 0x4
    class xVec3 * local_space_verts; // offset 0x4, size 0x4
    class xVec3 * * world_space_verts; // offset 0x8, size 0x4
    class xMat4x3 to_world; // offset 0x10, size 0x40
};
// total size: 0x10
class xRot {
    // Members
...
class navigation_mesh_driven {
    // Members
public:
    class navigation_mesh * full_mesh; // offset 0x0, size 0x4
    signed int sub_mesh_index; // offset 0x4, size 0x4
    unsigned char vert_to_group_map[254]; // offset 0x8, size 0xFE
    signed int num_groups; // offset 0x108, size 0x4
    class vertex_group * groups; // offset 0x10C, size 0x4
};
// total size: 0x8
...
class circle_location {
    // Members
public:
    class circle * npc_circle; // offset 0x0, size 0x4
    signed int index; // offset 0x4, size 0x4
    float circle_u; // offset 0x8, size 0x4
    float circle_v; // offset 0xC, size 0x4
    float entity_u; // offset 0x10, size 0x4
    float entity_v; // offset 0x14, size 0x4
};
// total size: 0x18
class xGridBound {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032CEC0 -> 0x0032D64C
*/
// Range: 0x32CEC0 -> 0x32D64C
// this: r21
void navigation_mesh_driven::UpdateGroup(signed int group_num /* r20 */, class xMat4x3 * to_world /* r19 */) {
    /* anonymous block */ {
        // Range: 0x32CEC0 -> 0x32D64C
        class circle_location deformed_tri_circles[10]; // r29+0xB0
        signed int num_deformed_tri_circles; // r18
        class sub_mesh * sub_mesh; // r17
        class circle * npc_circle; // r16
        signed int tri_index; // r2
        class xVec3 * v0; // r23
        class xVec3 * v1; // r30
        class xVec3 * v2; // r29+0xA0
        signed int i; // r3
        signed int i; // r14
        class xVec3 * v0; // r2
        class xVec3 * v1; // r2
        class xVec3 * v2; // r2
        class xVec3 circle_pos; // r29+0x230
        class xVec3 entity_pos; // r29+0x220
        class circle * npc_circle; // r18
        class xVec3 circle_local_space_pos; // r29+0x210
        class xVec3 entity_local_space_pos; // r29+0x200
        class xVec3 circle_world_pos; // r29+0x1F0
        class xVec3 entity_world_pos; // r29+0x1E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032D650 -> 0x0032DA34
*/
// Range: 0x32D650 -> 0x32DA34
void get_triangle_uv_pos(float & u /* r2 */, float & v /* r2 */, class xVec3 * v0 /* r2 */, class xVec3 * v1 /* r2 */, class xVec3 * v2 /* r2 */, class xVec3 & pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32D650 -> 0x32DA34
        float inner; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DA40 -> 0x0032DBD0
*/
// Range: 0x32DA40 -> 0x32DBD0
// this: r21
void navigation_mesh_driven::Init(signed int group_index /* r2 */, class xMat4x3 & local_space_origin /* r20 */) {
    /* anonymous block */ {
        // Range: 0x32DA40 -> 0x32DBD0
        signed int i; // r19
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DBD0 -> 0x0032DC9C
*/
// Range: 0x32DBD0 -> 0x32DC9C
class navigation_mesh_driven * Get(class navigation_mesh * full_mesh /* r18 */, signed int sub_mesh_index /* r17 */) {
    /* anonymous block */ {
        // Range: 0x32DBD0 -> 0x32DC9C
        signed int i; // r6
        class navigation_mesh_driven * driven; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DCA0 -> 0x0032DCA8
*/
// Range: 0x32DCA0 -> 0x32DCA8
void reset() {
    /* anonymous block */ {
        // Range: 0x32DCA0 -> 0x32DCA8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DCB0 -> 0x0032DF84
*/
// Range: 0x32DCB0 -> 0x32DF84
// this: r19
void navigation_mesh_driven::Init(class navigation_mesh * full_mesh /* r2 */, signed int sub_mesh_index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32DCB0 -> 0x32DF84
        class sub_mesh * sub_mesh; // r18
        signed int max_group; // r6
        signed int i; // r5
        signed int group_index; // r2
        signed int i; // r3
        signed int group_index; // r2
        signed int i; // r6
        signed int i; // r17
