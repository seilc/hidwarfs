/*
    Compile unit: C:\TestBuild\in\GAME\zMain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class basic_rect screen_bounds; // size: 0x10, address: 0x5E4850
...
unsigned int FB_DEPTH; // size: 0x4, address: 0x6076C4
unsigned int SCENE_ID_MNU_INGAME; // size: 0x4, address: 0x608728
...
float ShortbreadCookieJar; // size: 0x4, address: 0x608734
signed int gBuildNumber; // size: 0x4, address: 0x0
unsigned int gEE2BuildNumber; // size: 0x4, address: 0x0
static signed int sShowMenuOnBoot; // size: 0x4, address: 0x6076CC
static class st_SERIAL_PERCID_SIZE g_xser_sizeinfo[2]; // size: 0x10, address: 0x5057A0
static signed int gCountryCodeCount; // size: 0x4, address: 0x608738
static char gCountryCodes[4][3]; // size: 0xC, address: 0x61C850
...
char * allsoaklevels[]; // size: 0x0, address: 0x6BE9A0
...
signed int displayPadDebugInfo; // size: 0x4, address: 0x6089AC
void zMainMemLvlChkCB(); // size: 0x0, address: 0x13DBC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C110 -> 0x0013C300
*/
// Range: 0x13C110 -> 0x13C300
void zOPM_HandleInactivityTimeout(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x13C110 -> 0x13C300
        class _tagxPad * p; // r2
        signed int ax; // r2
        ...
        signed int bx; // r2
        signed int by; // r2
        signed int lby; // @ 0x00608758
        signed int lbx; // @ 0x00608754
        signed int lay; // @ 0x00608750
        signed int lax; // @ 0x0060874C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C300 -> 0x0013C354
*/
// Range: 0x13C300 -> 0x13C354
void zMainExitScreen() {
    /* anonymous block */ {
        // Range: 0x13C300 -> 0x13C354
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C360 -> 0x0013C5FC
*/
// Range: 0x13C360 -> 0x13C5FC
static void DisplayExitCard(unsigned int assetID /* r16 */, float min_time /* r23 */, float max_time /* r22 */) {
    /* anonymous block */ {
        // Range: 0x13C360 -> 0x13C5FC
        class RwTexture * tex; // r2
        class RwCamera * cam; // r16
        class RwRGBA bg; // r29+0x7C
        float recipCamZ; // r20
        float uvOffset; // r21
        signed int MIN_VBLANKS; // r2
        signed int MAX_VBLANKS; // r2
        signed int i; // r20
        float DXRES; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C600 -> 0x0013CD48
*/
// Range: 0x13C600 -> 0x13CD48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013CD50 -> 0x0013D3A0
*/
// Range: 0x13CD50 -> 0x13D3A0
void zMainFirstScreen(signed int mode /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13CD50 -> 0x13D3A0
        class RwCamera * cam; // r19
        class RwRGBA bg; // r29+0x25C
        signed int i; // r18
        char * str; // r2
        class xtextbox tb; // r29+0x1E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013D3A0 -> 0x0013D8D0
*/
// Range: 0x13D3A0 -> 0x13D8D0
static void zMainReadINI(char * iniName /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13D3A0 -> 0x13D8D0
        char * str; // r2
        void * buf; // r22
        ...
        unsigned int num_levels; // r2
        char * tok; // r19
        signed int level_count; // r18
        char * watermark; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013D8D0 -> 0x0013DBB8
*/
// Range: 0x13D8D0 -> 0x13DBB8
static void zMainLoop() {
    /* anonymous block */ {
        // Range: 0x13D8D0 -> 0x13DBB8
        unsigned int newGameSceneID; // r16
        unsigned int iconDataSize; // r29+0x2C
        void * iconData; // r2
        unsigned int gameSceneID; // @ 0x00608744
        unsigned int menuModeID; // @ 0x0060873C
        signed char @6918; // @ 0x00608748
        signed char @6915; // @ 0x00608740
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013DBC0 -> 0x0013DBC8
*/
// Range: 0x13DBC0 -> 0x13DBC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013DBD0 -> 0x0013E250
*/
// Range: 0x13DBD0 -> 0x13E250
static void zMainParseINIGlobals(class xIniFile * ini /* r19 */) {
    /* anonymous block */ {
        // Range: 0x13DBD0 -> 0x13E250
        signed int timeout; // r2
        char * SCENE_ID_MNU_START_TEXT; // r2
        char * videosys; // r16
        char DEFAULT_REGION_NTSC[3]; // r29+0x6C
        char DEFAULT_REGION_PAL[3]; // r29+0x68
        char * defaultregion; // r17
        char * iniString; // r18
        signed int idx; // r29+0x64
        signed int playerCount; // r17
        unsigned int sceneTag; // r16
        unsigned int playerTag; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013E250 -> 0x0013E27C
*/
// Range: 0x13E250 -> 0x13E27C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013E280 -> 0x0013E854
*/
// Range: 0x13E280 -> 0x13E854
void main(signed int argc /* r20 */, char * * argv /* r21 */) {
    /* anonymous block */ {
        // Range: 0x13E280 -> 0x13E854
        unsigned int options; // r19
        signed int i; // r17
        char * ini; // r18
        signed int i; // r17
        class xCamScreen local_screen; // r29+0x78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013E860 -> 0x0013F500
*/
// Range: 0x13E860 -> 0x13F500
static void zMainLanguageSelection() {
    /* anonymous block */ {
        // Range: 0x13E860 -> 0x13F500
        float flagXRES; // r29
        float flagWidth; // r28
        float flagHeight; // r27
        float flagStartX; // r26
        float flagStartY; // r25
        class RwTexture * textures[4][2]; // r29+0x3E0
        signed int highlighted; // r20
        char * defaultRegion; // r21
        signed int i; // r19
        unsigned int countryHash; // r18
        class RwTexture * texture; // r2
        class RwRaster * background; // r19
        class RwRaster * noController; // r30
        signed long prevTime; // r29+0xD8
        float dt; // r23
        float flashTimer; // r24
        class RwCamera * cam; // r18
        class RwRGBA bg; // r29+0x40C
        signed int i; // r17
