/*
    Compile unit: C:\TestBuild\in\GAME\zEnergyStream.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class curve_node ribbon_curve[2]; // size: 0x18, address: 0x5FBD10
class config default_config; // size: 0x4C, address: 0x6BEC70
// total size: 0x20
struct /* @anon1 */ {} EnergyStream::__vtable; // size: 0x20, address: 0x6068D0
...
// total size: 0x20
struct /* @anon0 */ {} z::lightweight<EnergyStream, 12>::__vtable; // size: 0x20, address: 0x6068F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475680 -> 0x004756AC
*/
// Range: 0x475680 -> 0x4756AC
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004756B0 -> 0x00475B30
*/
// Range: 0x4756B0 -> 0x475B30
// this: r20
void EnergyStream::update_ribbon(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4756B0 -> 0x475B30
        signed int count; // r19
        class iterator i; // r29+0xA8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475B30 -> 0x00475C30
*/
// Range: 0x475B30 -> 0x475C30
// this: r2
void EnergyStream::add_dpos(class xVec3 & dpos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x475B30 -> 0x475C30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00475C30 -> 0x00476174
*/
// Range: 0x475C30 -> 0x476174
// this: r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00476180 -> 0x00476188
*/
// Range: 0x476180 -> 0x476188
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00476190 -> 0x00476934
*/
// Range: 0x476190 -> 0x476934
// this: r21
void EnergyStream::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x476190 -> 0x476934
        signed int i; // r20
        class xVec3 direction; // r29+0x1F0
        class xVec3 target_velocity; // r29+0x1E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00476940 -> 0x00476948
*/
// Range: 0x476940 -> 0x476948
void add_tweaks() {
    /* anonymous block */ {
        // Range: 0x476940 -> 0x476948
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00476950 -> 0x00476A20
*/
// Range: 0x476950 -> 0x476A20
void setup() {
    /* anonymous block */ {
        // Range: 0x476950 -> 0x476A20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00476A20 -> 0x00477344
*/
// Range: 0x476A20 -> 0x477344
// this: r21
class EnergyStream & EnergyStream::operator=(class EnergyStream & new_stream /* r2 */) {
    /* anonymous block */ {
        // Range: 0x476A20 -> 0x477344
        signed int i; // r17
        class xVec3 position; // r29+0x1F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477350 -> 0x00477420
*/
// Range: 0x477350 -> 0x477420
// this: r2
EnergyStream::EnergyStream(class xVec3 * start /* r2 */, class xVec3 * end /* r2 */, class config * use_config /* r2 */) {
    /* anonymous block */ {
        // Range: 0x477350 -> 0x477420
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00477420 -> 0x00477604
*/
// Range: 0x477420 -> 0x477604
// this: r17
EnergyStream::EnergyStream() {
    /* anonymous block */ {
        // Range: 0x477420 -> 0x477604
        class config_type cfg; // @ 0x006BEC50
    }
}
