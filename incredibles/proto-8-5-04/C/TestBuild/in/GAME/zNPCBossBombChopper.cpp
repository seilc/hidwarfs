/*
    Compile unit: C:\TestBuild\in\GAME\zNPCBossBombChopper.cpp
...
static class smoke_config smoke_settings; // size: 0x38, address: 0x6BECC0
static class config flash_config; // size: 0x48, address: 0x6BED00
class lightweight_system * system; // size: 0x4, address: 0x608FBC
class lightweight_system * system; // size: 0x4, address: 0x608E58
class boss_bomb_chopper * chopper; // size: 0x4, address: 0x609664
// total size: 0xB4
struct /* @anon5 */ {} zNPC::boss_bomb_chopper::__vtable; // size: 0xB4, address: 0x6069B0
// total size: 0x24
struct /* @anon13 */ {} z::lightweight_system<z::bomb, 20>::__vtable; // size: 0x24, address: 0x601940
// total size: 0x24
struct /* @anon15 */ {} z::lightweight_system_base::__vtable; // size: 0x24, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
// total size: 0x14
struct /* @anon23 */ {} zNPC::rocket_attack::__vtable; // size: 0x14, address: 0x606B30
// total size: 0x14
struct /* @anon7 */ {} zNPC::chopper_attack::__vtable; // size: 0x14, address: 0x606B50
class xVec3 m_Null; // size: 0xC, address: 0x5E7C40
// total size: 0x14
struct /* @anon0 */ {} zNPC::lob_attack::__vtable; // size: 0x14, address: 0x606AF0
// total size: 0x14
struct /* @anon14 */ {} zNPC::laser_attack::__vtable; // size: 0x14, address: 0x606B10
...
// total size: 0x7C
struct /* @anon27 */ {} zNPC::hover_bob::__vtable; // size: 0x7C, address: 0x603050
// total size: 0x7C
struct /* @anon11 */ {} behavior_implementation<zNPC::common>::__vtable; // size: 0x7C, address: 0x5FD5A0
// total size: 0x78
struct /* @anon6 */ {} behavior::__vtable; // size: 0x78, address: 0x0
// total size: 0x7C
struct /* @anon21 */ {} zNPC::bone_container<zNPC::flashing_light_bone>::__vtable; // size: 0x7C, address: 0x606A70
// total size: 0x7C
struct /* @anon22 */ {} zNPC::bone_container<zNPC::blade_bone>::__vtable; // size: 0x7C, address: 0x602710
// total size: 0x7C
struct /* @anon19 */ {} zNPC::manual_explode::__vtable; // size: 0x7C, address: 0x606BF0
// total size: 0x7C
struct /* @anon4 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x7C
struct /* @anon28 */ {} zNPC::shrapnel_death::__vtable; // size: 0x7C, address: 0x600F30
// total size: 0x7C
struct /* @anon26 */ {} zNPC::bone_container<zNPC::aim_bone>::__vtable; // size: 0x7C, address: 0x5FE950
// total size: 0x7C
struct /* @anon8 */ {} zNPC::bone_container<zNPC::auto_laser_bone>::__vtable; // size: 0x7C, address: 0x601B40
// total size: 0x7C
struct /* @anon17 */ {} zNPC::chopper_laser::__vtable; // size: 0x7C, address: 0x606C70
// total size: 0x7C
struct /* @anon16 */ {} zNPC::move::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon10 */ {} zNPC::chopper_damage::__vtable; // size: 0x7C, address: 0x606B70
// total size: 0x7C
struct /* @anon24 */ {} zNPC::chopper_rocket::__vtable; // size: 0x7C, address: 0x606CF0
// total size: 0x7C
struct /* @anon1 */ {} zNPC::chopper_lob::__vtable; // size: 0x7C, address: 0x606D70
// total size: 0x8C
struct /* @anon9 */ {} zNPC::chopper_follow_movepoints::__vtable; // size: 0x8C, address: 0x606DF0
// total size: 0x88
struct /* @anon2 */ {} zNPC::follow_movepoints::__vtable; // size: 0x88, address: 0x5FD810
// total size: 0xB4
struct /* @anon25 */ {} zNPC::flying_npc_generic<zNPC::common>::__vtable; // size: 0xB4, address: 0x602790
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
class xVec3 m_UnitAxisZ; // size: 0xC, address: 0x5E7C70
void * __ct(class aim_bone *); // size: 0x0, address: 0x224750
void * __ct(class auto_laser_bone *); // size: 0x0, address: 0x2C9FA0
unsigned int anclosed_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47A620
// total size: 0x24
struct /* @anon18 */ {} z::lightweight_system<z::rocket, 20>::__vtable; // size: 0x24, address: 0x5FF3B0
unsigned int anfire_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47AAC0
unsigned int anfire(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47ACD0
unsigned int anoriented(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47AD20
...
unsigned int anfire_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47B620
unsigned int anfire(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47B570
unsigned int andone_cb(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47B5C0
unsigned int andone(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47B5F0
unsigned int anoriented(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x47BAB0
// total size: 0x7C
struct /* @anon20 */ {} zNPC::firing_bone::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon12 */ {} zNPC::bone_behavior::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon3 */ {} zNPC::blurred_blade_bone::__vtable; // size: 0x7C, address: 0x0
void * __ct(class blade_bone *); // size: 0x0, address: 0x2E3FA0
void * __ct(class flashing_light_bone *); // size: 0x0, address: 0x47C860
// total size: 0x2C
...
class bone_container : public behavior_implementation {
    // Members
public:
    class auto_laser_bone * array; // offset 0x10, size 0x4
...
// total size: 0x60
class hover_bob : public behavior_implementation {
    // Members
public:
    float max_offset; // offset 0x10, size 0x4
    float max_speed; // offset 0x14, size 0x4
    float max_angle; // offset 0x18, size 0x4
    float max_angle_speed; // offset 0x1C, size 0x4
    float target_offset; // offset 0x20, size 0x4
    float offset; // offset 0x24, size 0x4
    float velocity; // offset 0x28, size 0x4
    float velocity_v; // offset 0x2C, size 0x4
    float velocity_blend_k; // offset 0x30, size 0x4
    class xVec3 angle_velocity; // offset 0x34, size 0xC
    float angle_velocity_v; // offset 0x40, size 0x4
    float angle_velocity_blend_k; // offset 0x44, size 0x4
    class xVec3 target_up; // offset 0x48, size 0xC
    class xVec3 up; // offset 0x54, size 0xC
};
// total size: 0xC
class RwV3d {
    // Members
...
// total size: 0x80
class chopper_rocket : public move {
    // Members
public:
    float wait_time; // offset 0x24, size 0x4
    float rocket_speed; // offset 0x28, size 0x4
    float rocket_turn_speed; // offset 0x2C, size 0x4
    float timer; // offset 0x30, size 0x4
    signed int rocket_count; // offset 0x34, size 0x4
    signed int max_rocket_count; // offset 0x38, size 0x4
    class xModelTag tag[2]; // offset 0x3C, size 0x40
    unsigned char second_rocket_enabled; // offset 0x7C, size 0x1
};
// total size: 0x18
class xModelBucket {
    // Members
...
class xGrid {};
// total size: 0x98
class chopper_laser : public move {
    // Members
public:
    enum laser_state state; // offset 0x24, size 0x4
    class bone_container laser_bones; // offset 0x28, size 0x18
    class bone_container aim_bones; // offset 0x40, size 0x18
    float angle; // offset 0x58, size 0x4
    float timer; // offset 0x5C, size 0x4
    float spin_time; // offset 0x60, size 0x4
    float fire_time; // offset 0x64, size 0x4
    float max_rot_speed; // offset 0x68, size 0x4
    float rot_speed; // offset 0x6C, size 0x4
    float attack_time; // offset 0x70, size 0x4
    float period; // offset 0x74, size 0x4
    float floor_offset; // offset 0x78, size 0x4
    class xRot rot; // offset 0x7C, size 0x10
    class xVec3 target_dir; // offset 0x8C, size 0xC
};
// total size: 0x1E5C
...
struct /* @anon2 */ {};
// total size: 0xC0
class chopper_follow_movepoints : public follow_movepoints {
    // Members
public:
    unsigned char move; // offset 0xB0, size 0x1
    unsigned char run; // offset 0xB1, size 0x1
    unsigned char sideways_orient; // offset 0xB2, size 0x1
};
// total size: 0x18
...
// total size: 0x7D0
class boss_bomb_chopper : public flying_npc_generic {
    // Members
public:
    unsigned char is_invincible; // offset 0x2D0, size 0x1
    class chopper_stage stages[6]; // offset 0x2D4, size 0x60
    signed int current_stage; // offset 0x334, size 0x4
    signed int current_attack; // offset 0x338, size 0x4
    class xModelInstance * bomb_voyage_model; // offset 0x33C, size 0x4
    class xModelTag weakpoints[6]; // offset 0x340, size 0xC0
    float smoke_emit_remaining[5]; // offset 0x400, size 0x14
    class xVec3 prev_weakpoint_pos[5]; // offset 0x414, size 0x3C
    class xVec3 target_pos; // offset 0x450, size 0xC
    class chopper_follow_movepoints follow_movepoints_state; // offset 0x460, size 0xC0
    class chopper_lob lob_state; // offset 0x520, size 0x9C
    class chopper_rocket rocket_state; // offset 0x5BC, size 0x80
    class chopper_damage damage_state; // offset 0x63C, size 0x18
    class chopper_laser laser_state; // offset 0x654, size 0x98
    class manual_explode explode_state; // offset 0x6EC, size 0x54
    class bone_container blade_bones; // offset 0x740, size 0x18
    class bone_container light_bones; // offset 0x758, size 0x18
    class hover_bob bob_state; // offset 0x770, size 0x60
};
// total size: 0xC
...
public:
    ...
    float time_left; // offset 0x4, size 0x4
...
// total size: 0x14
class laser_attack : public chopper_attack {
    // Members
public:
    float period; // offset 0x8, size 0x4
    float attack_time; // offset 0xC, size 0x4
    class chopper_laser & attack_state; // offset 0x10, size 0x4
};
// total size: 0x9C
class chopper_lob : public move {
    // Members
public:
    float in_front_distance; // offset 0x24, size 0x4
    float wait_time; // offset 0x28, size 0x4
    float fuse_time; // offset 0x2C, size 0x4
    float timer; // offset 0x30, size 0x4
    float flash_emit_remaining; // offset 0x34, size 0x4
    float total_flash_time; // offset 0x38, size 0x4
    float flash_time; // offset 0x3C, size 0x4
    signed int lob_count; // offset 0x40, size 0x4
    class xModelTag tag; // offset 0x44, size 0x20
    class xModelInstance * & bomb_voyage_model; // offset 0x64, size 0x4
    class xVec3 bomb_pos_start; // offset 0x68, size 0xC
    class xVec3 bomb_pos_end; // offset 0x74, size 0xC
    unsigned char firing; // offset 0x80, size 0x1
    class xVec3 target_dir; // offset 0x84, size 0xC
    unsigned int bomb_ids[3]; // offset 0x90, size 0xC
};
// total size: 0xC
...
// total size: 0x60
class blurred_blade_bone : public bone_behavior {
    // Members
public:
    unsigned char use_tag; // offset 0x14, size 0x1
    signed char bone; // offset 0x15, size 0x1
    signed char num_blades; // offset 0x16, size 0x1
    signed char current_blade; // offset 0x17, size 0x1
    float speed; // offset 0x18, size 0x4
    float rotation; // offset 0x1C, size 0x4
    float delta_rot; // offset 0x20, size 0x4
    float blades_per_sec; // offset 0x24, size 0x4
    float life_time; // offset 0x28, size 0x4
    float blade_alpha; // offset 0x2C, size 0x4
    class blade * blades; // offset 0x30, size 0x4
    class xVec3 axis; // offset 0x34, size 0xC
    class xModelTag tag; // offset 0x40, size 0x20
};
// total size: 0x14
...
// total size: 0x18
class chopper_damage : public behavior_implementation {
    // Members
public:
    unsigned char run; // offset 0x10, size 0x1
    class xModelInstance * & bomb_voyage_model; // offset 0x14, size 0x4
};
// total size: 0x7C
...
// total size: 0x54
class explode : public shrapnel_death {
    // Members
public:
    float damage_radius; // offset 0x40, size 0x4
    float damage_radius_2; // offset 0x44, size 0x4
    float velocity_up; // offset 0x48, size 0x4
    float velocity_away; // offset 0x4C, size 0x4
    signed short damage; // offset 0x50, size 0x2
    unsigned char hurt_things; // offset 0x52, size 0x1
};
// total size: 0x4C
class xBallPhysics {
    // Members
...
class bone_container : public behavior_implementation {
    // Members
public:
    class flashing_light_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x10
class xQuat {
...
// total size: 0x64
class blade_bone : public bone_behavior {
    // Members
public:
    unsigned char enabled; // offset 0x14, size 0x1
    signed int bone; // offset 0x18, size 0x4
    signed int blade_orientation_bone; // offset 0x1C, size 0x4
    signed int position_bone; // offset 0x20, size 0x4
    signed int orientation_bone; // offset 0x24, size 0x4
    float speed; // offset 0x28, size 0x4
    float rotation1; // offset 0x2C, size 0x4
    float rotation2; // offset 0x30, size 0x4
    class xVec3 axis; // offset 0x34, size 0xC
    union { // inferred
        class xVec3 offset; // offset 0x40, size 0xC
        class xModelTag tag; // offset 0x40, size 0x20
    };
    class xModelInstance * rotor; // offset 0x60, size 0x4
};
// total size: 0x18
class bone_container : public behavior_implementation {
    // Members
public:
    class blade_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x0
class xSpline3 {};
...
// total size: 0x54
class manual_explode : public explode {};
// total size: 0x7C
struct /* @anon10 */ {};
// total size: 0xDC
...
class bone_container : public behavior_implementation {
    // Members
public:
    class aim_bone * array; // offset 0x10, size 0x4
    signed int size_; // offset 0x14, size 0x4
};
// total size: 0x14
struct /* @anon14 */ {};
...
// total size: 0x18
class rocket_attack : public chopper_attack {
    // Members
public:
    float rocket_speed; // offset 0x8, size 0x4
    float rocket_turn_speed; // offset 0xC, size 0x4
    float wait_time; // offset 0x10, size 0x4
    class chopper_rocket & attack_state; // offset 0x14, size 0x4
};
// total size: 0x2C
...
// total size: 0x8
class chopper_attack {
    // Members
public:
    unsigned char move; // offset 0x0, size 0x1
};
// total size: 0x8
...
// total size: 0x14
class lob_attack : public chopper_attack {
    // Members
public:
    float bomb_fuse_time; // offset 0x8, size 0x4
    float wait_time; // offset 0xC, size 0x4
    class chopper_lob & attack_state; // offset 0x10, size 0x4
};
// total size: 0x0
class xFFX {};
// total size: 0x24
...
// total size: 0x2D0
class flying_npc_generic : public common {
    // Members
public:
    class behavior_implementation & death_state; // offset 0x2C0, size 0x4
    enum iSndGroupHandle flying_noise_group; // offset 0x2C4, size 0x4
    enum iSndHandle flying_noise; // offset 0x2C8, size 0x4
    unsigned char started; // offset 0x2CC, size 0x1
};
// total size: 0x8
...
class chopper_stage {
    // Members
public:
    signed int attack_count; // offset 0x0, size 0x4
    class chopper_attack * attacks[3]; // offset 0x4, size 0xC
};
// total size: 0x14
struct /* @anon23 */ {};
// total size: 0x44
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004784B0 -> 0x004784DC
*/
// Range: 0x4784B0 -> 0x4784DC
// this: r16
void boss_bomb_chopper::render_npc() {
    /* anonymous block */ {
        // Range: 0x4784B0 -> 0x4784DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004784E0 -> 0x00478740
*/
// Range: 0x4784E0 -> 0x478740
// this: r21
void boss_bomb_chopper::update_npc(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x4784E0 -> 0x478740
        signed int i; // r20
        class xVec3 smoke_pos; // r29+0xC0
        class xVec3 vel; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478740 -> 0x00478AD0
*/
// Range: 0x478740 -> 0x478AD0
// this: r20
void boss_bomb_chopper::damage(class zCombatDamageInfo & damageInfo /* r19 */) {
    /* anonymous block */ {
        // Range: 0x478740 -> 0x478AD0
        class zCombatDamageInfo newInfo; // r29+0x80
        signed int hide; // r7
        signed int display; // r6
        class xModelInstance * atomic; // r4
        signed int i; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478AE0 -> 0x00478C9C
*/
// Range: 0x478AE0 -> 0x478C9C
// this: r17
void boss_bomb_chopper::BehaviorUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x478AE0 -> 0x478C9C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478CD0 -> 0x00478D18
*/
// Range: 0x478CD0 -> 0x478D18
// this: r16
void boss_bomb_chopper::deactivate() {
    /* anonymous block */ {
        // Range: 0x478CD0 -> 0x478D18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478D20 -> 0x00478D5C
*/
// Range: 0x478D20 -> 0x478D5C
// this: r16
void boss_bomb_chopper::activate() {
    /* anonymous block */ {
        // Range: 0x478D20 -> 0x478D5C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478D60 -> 0x00478D90
*/
// Range: 0x478D60 -> 0x478D90
// this: r16
void boss_bomb_chopper::reset() {
    /* anonymous block */ {
        // Range: 0x478D60 -> 0x478D90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478D90 -> 0x00478F34
*/
// Range: 0x478D90 -> 0x478F34
// this: r16
void boss_bomb_chopper::set_init_state() {
    /* anonymous block */ {
        // Range: 0x478D90 -> 0x478F34
        class zCamPlayer * player_cam; // r17
        float radius; // r29+0x4C
        signed int initially_on_atomics[6]; // r29+0x30
        signed int on_atomic_index; // r7
        class xModelInstance * atomic; // r6
        signed int i; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00478F40 -> 0x004793F8
*/
// Range: 0x478F40 -> 0x4793F8
// this: r18
void boss_bomb_chopper::setup() {
    /* anonymous block */ {
        // Range: 0x478F40 -> 0x4793F8
        char buffer[256]; // r29+0x3A0
        signed int i; // r22
        signed int stage_num; // r17
        signed int j; // r16
        char * attack; // r29+0x4BC
        class xVec3 pos; // r29+0x4A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479400 -> 0x0047944C
*/
// Range: 0x479400 -> 0x47944C
// this: r17
void boss_bomb_chopper::init_npc(class xEntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x479400 -> 0x47944C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479450 -> 0x004794AC
*/
// Range: 0x479450 -> 0x4794AC
class xFactoryInst * create(signed int who /* r4 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x479450 -> 0x4794AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004794B0 -> 0x00479638
*/
// Range: 0x4794B0 -> 0x479638
void static_scene_init() {
    /* anonymous block */ {
        // Range: 0x4794B0 -> 0x479638
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479640 -> 0x00479864
*/
// Range: 0x479640 -> 0x479864
// this: r16
boss_bomb_chopper::boss_bomb_chopper() {
    /* anonymous block */ {
        // Range: 0x479640 -> 0x479864
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479870 -> 0x0047992C
*/
// Range: 0x479870 -> 0x47992C
// this: r16
unsigned char chopper_damage::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x479870 -> 0x47992C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479930 -> 0x004799BC
*/
// Range: 0x479930 -> 0x4799BC
// this: r2
void chopper_damage::enter_state() {
    /* anonymous block */ {
        // Range: 0x479930 -> 0x4799BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479A20 -> 0x00479A88
*/
// Range: 0x479A20 -> 0x479A88
// this: r17
unsigned char chopper_damage::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x479A20 -> 0x479A88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479A90 -> 0x00479B70
*/
// Range: 0x479A90 -> 0x479B70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479B70 -> 0x00479CD0
*/
// Range: 0x479B70 -> 0x479CD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479CD0 -> 0x00479D30
*/
// Range: 0x479CD0 -> 0x479D30
// this: r17
unsigned char manual_explode::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x479CD0 -> 0x479D30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479D30 -> 0x00479DD0
*/
// Range: 0x479D30 -> 0x479DD0
// this: r19
void chopper_laser::before_anim_matrices(class xQuat * quat /* r18 */) {
    /* anonymous block */ {
        // Range: 0x479D30 -> 0x479DD0
        class xQuat q; // r29+0x50
        signed int i; // r17
        class xQuat * curr; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479DD0 -> 0x00479DE0
*/
// Range: 0x479DD0 -> 0x479DE0
// this: r2
unsigned char chopper_laser::runnable() {
    /* anonymous block */ {
        // Range: 0x479DD0 -> 0x479DE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479DE0 -> 0x00479E94
*/
// Range: 0x479DE0 -> 0x479E94
// this: r16
void chopper_laser::setup() {
    /* anonymous block */ {
        // Range: 0x479DE0 -> 0x479E94
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479EA0 -> 0x00479F1C
*/
// Range: 0x479EA0 -> 0x479F1C
// this: r2
void chopper_laser::enter_state() {
    /* anonymous block */ {
        // Range: 0x479EA0 -> 0x479F1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479F80 -> 0x00479FC8
*/
// Range: 0x479F80 -> 0x479FC8
// this: r2
void chopper_laser::exit_state() {
    /* anonymous block */ {
        // Range: 0x479F80 -> 0x479FC8
        signed int i; // r6
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479FD0 -> 0x0047A51C
*/
// Range: 0x479FD0 -> 0x47A51C
// this: r16
void chopper_laser::update(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x479FD0 -> 0x47A51C
        signed int i; // r5
        signed int i; // r4
        signed int i; // r17
        unsigned char is_reset; // r19
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A520 -> 0x0047A5B8
*/
// Range: 0x47A520 -> 0x47A5B8
// this: r17
void chopper_laser::init() {
    /* anonymous block */ {
        // Range: 0x47A520 -> 0x47A5B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A5C0 -> 0x0047A620
*/
// Range: 0x47A5C0 -> 0x47A620
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A660 -> 0x0047A700
*/
// Range: 0x47A660 -> 0x47A700
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47A660 -> 0x47A700
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A700 -> 0x0047A738
*/
// Range: 0x47A700 -> 0x47A738
// this: r2
unsigned char chopper_rocket::runnable() {
    /* anonymous block */ {
        // Range: 0x47A700 -> 0x47A738
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A740 -> 0x0047A75C
*/
// Range: 0x47A740 -> 0x47A75C
// this: r2
void chopper_rocket::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x47A740 -> 0x47A75C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A760 -> 0x0047A76C
*/
// Range: 0x47A760 -> 0x47A76C
// this: r2
void chopper_rocket::exit_state() {
    /* anonymous block */ {
        // Range: 0x47A760 -> 0x47A76C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A770 -> 0x0047A7FC
*/
// Range: 0x47A770 -> 0x47A7FC
// this: r2
void chopper_rocket::enter_state() {
    /* anonymous block */ {
        // Range: 0x47A770 -> 0x47A7FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A860 -> 0x0047A878
*/
// Range: 0x47A860 -> 0x47A878
// this: r2
void chopper_rocket::reset() {
    /* anonymous block */ {
        // Range: 0x47A860 -> 0x47A878
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A880 -> 0x0047A964
*/
// Range: 0x47A880 -> 0x47A964
// this: r16
void chopper_rocket::setup() {
    /* anonymous block */ {
        // Range: 0x47A880 -> 0x47A964
        class xVec3 position; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A970 -> 0x0047AABC
*/
// Range: 0x47A970 -> 0x47AABC
void add_transitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47A970 -> 0x47AABC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047ADF0 -> 0x0047AF10
*/
// Range: 0x47ADF0 -> 0x47AF10
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47ADF0 -> 0x47AF10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047AF10 -> 0x0047AF44
*/
// Range: 0x47AF10 -> 0x47AF44
// this: r2
unsigned char chopper_lob::runnable() {
    /* anonymous block */ {
        // Range: 0x47AF10 -> 0x47AF44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047AF50 -> 0x0047B114
*/
// Range: 0x47AF50 -> 0x47B114
// this: r16
void chopper_lob::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x47AF50 -> 0x47B114
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047B120 -> 0x0047B12C
*/
// Range: 0x47B120 -> 0x47B12C
// this: r2
void chopper_lob::exit_state() {
    /* anonymous block */ {
        // Range: 0x47B120 -> 0x47B12C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047B130 -> 0x0047B1C0
*/
// Range: 0x47B130 -> 0x47B1C0
// this: r2
void chopper_lob::enter_state() {
    /* anonymous block */ {
        // Range: 0x47B130 -> 0x47B1C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047B220 -> 0x0047B234
*/
// Range: 0x47B220 -> 0x47B234
// this: r2
void chopper_lob::reset() {
    /* anonymous block */ {
        // Range: 0x47B220 -> 0x47B234
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047B240 -> 0x0047B2EC
*/
// Range: 0x47B240 -> 0x47B2EC
// this: r16
void chopper_lob::setup() {
    /* anonymous block */ {
        // Range: 0x47B240 -> 0x47B2EC
        class xVec3 position; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047B2F0 -> 0x0047B56C
*/
// Range: 0x47B2F0 -> 0x47B56C
void add_transitions(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47B2F0 -> 0x47B56C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047BB10 -> 0x0047BD30
*/
// Range: 0x47BB10 -> 0x47BD30
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47BB10 -> 0x47BD30
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047BD30 -> 0x0047BDC8
*/
// Range: 0x47BD30 -> 0x47BDC8
// this: r16
void chopper_follow_movepoints::update(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x47BD30 -> 0x47BDC8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047BDD0 -> 0x0047C09C
*/
// Range: 0x47BDD0 -> 0x47C09C
// this: r18
void chopper_follow_movepoints::get_orientation(class xMat3x3 * mat /* r17 */, float distance /* r20 */) {
    /* anonymous block */ {
        // Range: 0x47BDD0 -> 0x47C09C
        class xVec3 dir; // r29+0xE0
        class xQuat orient; // r29+0xB0
        class xQuat orient1; // r29+0xA0
        class xQuat orient2; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C0A0 -> 0x0047C0D8
*/
// Range: 0x47C0A0 -> 0x47C0D8
// this: r16
void chopper_follow_movepoints::get_next_movepoint() {
    /* anonymous block */ {
        // Range: 0x47C0A0 -> 0x47C0D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C0E0 -> 0x0047C168
*/
// Range: 0x47C0E0 -> 0x47C168
// this: r2
void chopper_follow_movepoints::enter_state() {
    /* anonymous block */ {
        // Range: 0x47C0E0 -> 0x47C168
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C1D0 -> 0x0047C22C
*/
// Range: 0x47C1D0 -> 0x47C22C
void add_transitions(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47C1D0 -> 0x47C22C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C230 -> 0x0047C2D0
*/
// Range: 0x47C230 -> 0x47C2D0
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47C230 -> 0x47C2D0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C2D0 -> 0x0047C2F8
*/
// Range: 0x47C2D0 -> 0x47C2F8
// this: r2
void lob_attack::start() {
    /* anonymous block */ {
        // Range: 0x47C2D0 -> 0x47C2F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C300 -> 0x0047C308
*/
// Range: 0x47C300 -> 0x47C308
unsigned char face_sideways() {
    /* anonymous block */ {
        // Range: 0x47C300 -> 0x47C308
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C310 -> 0x0047C360
*/
// Range: 0x47C310 -> 0x47C360
// this: r2
void laser_attack::start() {
    /* anonymous block */ {
        // Range: 0x47C310 -> 0x47C360
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047C360 -> 0x0047C38C
*/
// Range: 0x47C360 -> 0x47C38C
// this: r2
void rocket_attack::start() {
    /* anonymous block */ {
        // Range: 0x47C360 -> 0x47C38C
    }
}
