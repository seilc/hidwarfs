/*
    Compile unit: C:\TestBuild\in\GAME\zSmoke.cpp
...
static class smoke_type types[32]; // size: 0x100, address: 0x6A2360
static signed int types_size; // size: 0x4, address: 0x60911C
static float wind_magnitude_time; // size: 0x4, address: 0x609120
static float wind_yaw_time; // size: 0x4, address: 0x609124
static float wind_pitch_time; // size: 0x4, address: 0x609128
static class xVec3 wind_delta; // size: 0xC, address: 0x6A2460
class zGlobals globals; // size: 0x640, address: 0x61C210
signed int update_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x326520
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x324D90
...
public:
    ...
    signed int system_id; // offset 0x4, size 0x4
};
// total size: 0x20
class xAnimPlay {
    // Members
...
public:
    ...
    class xVec2 uv[2]; // offset 0x20, size 0x10
...
public:
    ...
    public:
        ...
        class xVec3 scale; // offset 0x1C, size 0xC
    ...
    class xVec3 vel_dir; // offset 0x64, size 0xC
    float vel_dir_vary; // offset 0x70, size 0x4
    float wind; // offset 0x74, size 0x4
    class xColor_tag color_birth; // offset 0x78, size 0x4
    class xColor_tag color_death; // offset 0x7C, size 0x4
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324D90 -> 0x00324DD8
*/
// Range: 0x324D90 -> 0x324DD8
void cb_dispatch(class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x324D90 -> 0x324DD8
        class zSmokeEmitter & e; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324DE0 -> 0x00324E98
*/
// Range: 0x324DE0 -> 0x324E98
// this: r2
void zSmokeEmitter::prepare_volume(class zSmokeSphereVolume & volume /* r2 */) {
    /* anonymous block */ {
        // Range: 0x324DE0 -> 0x324E98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324EA0 -> 0x00325414
*/
// Range: 0x324EA0 -> 0x325414
// this: r21
void zSmokeEmitter::update(float dt /* r29+0x100 */) {
    /* anonymous block */ {
        // Range: 0x324EA0 -> 0x325414
        float rate; // r29+0x100
        signed int emit; // r20
        unsigned char * mem; // r29+0xFC
        signed int have; // r2
        class smoke_particle * p; // r19
        class smoke_particle * endp; // r2
        signed int frame; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325420 -> 0x0032595C
*/
// Range: 0x325420 -> 0x32595C
// this: r17
void zSmokeEmitter::load(class asset_type & a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x325420 -> 0x32595C
        class xMat3x3 dir_mat; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325960 -> 0x00325968
*/
// Range: 0x325960 -> 0x325968
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325970 -> 0x0032614C
*/
// Range: 0x325970 -> 0x32614C
void zSmokeEmitSphere(signed int system_id /* r30 */, class zSmokeSphereVolume & volume /* r2 */, signed int amount /* r21 */) {
    /* anonymous block */ {
        // Range: 0x325970 -> 0x32614C
        float size_min; // r26
        float size_rand_scale; // r25
        float age_rate_min; // r24
        float age_rate_rand_scale; // r29+0xFC
        class xColor_tag color_birth; // r29+0x15C
        float dr; // r29+0xF8
        float dg; // r29+0xF4
        float db; // r29+0xF0
        float da; // r29+0xEC
        ...
        float cz; // r29+0xE0
        float radius; // r23
        class xVec3 vel_dir; // r29+0x148
        float vel_dir_vary; // r29+0x160
        float vel_min; // r22
        float vel_rand_scale; // r29+0xDC
        float growth; // r29+0xD8
        float wind; // r29+0xD4
        signed int texture_rows; // r2
        signed int max_frame; // r2
        float du; // r21
        float dv; // r20
        unsigned char * mem; // r29+0x158
        signed int have; // r2
        class smoke_particle * p; // r20
        class smoke_particle * endp; // r2
        signed int frame; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326150 -> 0x003261E8
*/
// Range: 0x326150 -> 0x3261E8
void zSmokeUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x326150 -> 0x3261E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003261F0 -> 0x003261F8
*/
// Range: 0x3261F0 -> 0x3261F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326200 -> 0x0032622C
*/
// Range: 0x326200 -> 0x32622C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326230 -> 0x00326518
*/
// Range: 0x326230 -> 0x326518
static void update_wind(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x326230 -> 0x326518
        float magnitude; // r22
        float yaw; // r21
        float pitch; // r29+0x30
        float t; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326520 -> 0x00326B74
*/
// Range: 0x326520 -> 0x326B74
static signed int update_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x326520 -> 0x326B74
        class ptank_pool__pos_color_size_uv2 & pool; // r18
        class smoke_particle * p; // r17
        class smoke_particle * end; // r16
        float oldsize; // r20
        float t1; // r29+0x80
        float t2; // r29+0x80
        float alpha; // r5
