/*
    Compile unit: C:\TestBuild\in\GAME\zNPCRobotBehavior.cpp
...
class emit_context context; // size: 0x54, address: 0x6A2580
static class config dust_config; // size: 0x4C, address: 0x6A25F0
// total size: 0x98
struct /* @anon13 */ {} zNPC::charge_attack::__vtable; // size: 0x98, address: 0x0
class xVec3 m_UnitAxisY; // size: 0xC, address: 0x5E7C60
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
unsigned int anlook_doneCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x0
unsigned int anlook_check(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x0
// total size: 0x80
struct /* @anon21 */ {} zNPC::engine_exhaust::__vtable; // size: 0x80, address: 0x603D00
class xVec3 m_Null; // size: 0xC, address: 0x5E7C40
unsigned int anlandedCB(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x3334E0
unsigned int anlanded_check(class xAnimTransition *, class xAnimSingle *, void *); // size: 0x0, address: 0x333510
class config default_config; // size: 0x4C, address: 0x6BA620
class xVec3 g_O3; // size: 0xC, address: 0x5E77C0
// total size: 0x98
struct /* @anon18 */ {} zNPC::hit_react_armor::__vtable; // size: 0x98, address: 0x0
// total size: 0x7C
struct /* @anon3 */ {} zNPC::bone_spin::__vtable; // size: 0x7C, address: 0x603AC0
// total size: 0x98
struct /* @anon8 */ {} zNPC::player_hit_react::__vtable; // size: 0x98, address: 0x603B40
// total size: 0x98
struct /* @anon7 */ {} zNPC::hit_react_die::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon1 */ {} zNPC::hit_react_sleep::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon22 */ {} zNPC::react::__vtable; // size: 0x98, address: 0x0
// total size: 0x98
struct /* @anon16 */ {} zNPC::random_leap::__vtable; // size: 0x98, address: 0x0
// total size: 0xA0
struct /* @anon6 */ {} zNPC::patrol_look::__vtable; // size: 0xA0, address: 0x0
// total size: 0x98
struct /* @anon2 */ {} zNPC::patrol_return::__vtable; // size: 0x98, address: 0x603BE0
// total size: 0x98
struct /* @anon20 */ {} zNPC::random_patrol::__vtable; // size: 0x98, address: 0x0
// total size: 0x7C
struct /* @anon12 */ {} zNPC::bot_sleep::__vtable; // size: 0x7C, address: 0x603C80
// total size: 0x7C
struct /* @anon0 */ {} zNPC::explode::__vtable; // size: 0x7C, address: 0x603D80
// total size: 0x8C
struct /* @anon9 */ {} zNPC::auto_orient_physics::__vtable; // size: 0x8C, address: 0x603E00
// total size: 0x8C
struct /* @anon5 */ {} zNPC::ball_physics::__vtable; // size: 0x8C, address: 0x603E90
// total size: 0x84
struct /* @anon4 */ {} zNPC::fall_swap_death::__vtable; // size: 0x84, address: 0x0
// total size: 0x84
struct /* @anon14 */ {} zNPC::fall_death::__vtable; // size: 0x84, address: 0x603F20
// total size: 0x7C
struct /* @anon15 */ {} zNPC::launch_death::__vtable; // size: 0x7C, address: 0x603FB0
// total size: 0x7C
struct /* @anon19 */ {} zNPC::physics_death::__vtable; // size: 0x7C, address: 0x604030
// total size: 0x7C
struct /* @anon23 */ {} zNPC::animbomb_death::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon17 */ {} zNPC::gunfire_death::__vtable; // size: 0x7C, address: 0x0
// total size: 0x7C
struct /* @anon10 */ {} zNPC::timebomb_death::__vtable; // size: 0x7C, address: 0x6040B0
// total size: 0x98
struct /* @anon11 */ {} zNPC::static_jump::__vtable; // size: 0x98, address: 0x604130
// total size: 0x50
...
// total size: 0x44
class patrol_look : public random_patrol {};
// total size: 0x14
class xCylinder {
    // Members
public:
...
// total size: 0x2C
class launch_death : public physics_death {};
// total size: 0x14
...
// total size: 0x38
class timebomb_death : public behavior_implementation {
    // Members
public:
    signed char which_bone; // offset 0x10, size 0x1
    float explode_timer; // offset 0x14, size 0x4
    float max_timer; // offset 0x18, size 0x4
    float flash_timer; // offset 0x1C, size 0x4
    class explode * explode_state; // offset 0x20, size 0x4
    enum iSndGroupHandle beep_group; // offset 0x24, size 0x4
    class xModelInstance * eye_model; // offset 0x28, size 0x4
    class xVec3 bone_offset; // offset 0x2C, size 0xC
};
// total size: 0x4C
class xBound {
    // Members
...
// total size: 0x44
class fall_death : public physics_death {
    // Members
public:
    class xVec3 par_offset; // offset 0x2C, size 0xC
    signed int num_pieces; // offset 0x38, size 0x4
    class zShrapnelAsset * hit_shrapnel; // offset 0x3C, size 0x4
    class zShrapnelAsset * land_shrapnel; // offset 0x40, size 0x4
};
...
// total size: 0x64
class charge_attack : public npc_move {
    // Members
public:
    float attack_radius; // offset 0x34, size 0x4
    class xVec3 desired_dpos; // offset 0x38, size 0xC
    class xVec3 old_pos; // offset 0x44, size 0xC
    unsigned char attacking; // offset 0x50, size 0x1
    unsigned char entered; // offset 0x51, size 0x1
    float charge_distance; // offset 0x54, size 0x4
    float charge_past; // offset 0x58, size 0x4
    float charge_turn_speed; // offset 0x5C, size 0x4
    enum iSndGroupHandle charge_noise_group; // offset 0x60, size 0x4
};
// total size: 0xC8
class xSweptSphere {
    // Members
...
// total size: 0x38
class static_jump : public npc_move {
    // Members
public:
    unsigned int anim_flags; // offset 0x34, size 0x4
};
// total size: 0x30
class xMat3x3 {
    // Members
...
// total size: 0x48
class random_leap : public random_patrol {
    // Members
public:
    unsigned char there_yet; // offset 0x44, size 0x1
};
// total size: 0x10
class iEnvMatOrder {
    // Members
...
// total size: 0x54
class patrol_return : public random_patrol {
    // Members
public:
    class bot_sleep * sleep_state; // offset 0x44, size 0x4
    float defend_timer; // offset 0x48, size 0x4
    float max_defend; // offset 0x4C, size 0x4
    float sleep_after_defend_time; // offset 0x50, size 0x4
};
// total size: 0x18
class xGridBound {
    // Members
...
class RyzMemData {};
// total size: 0x60
class ball_physics : public behavior_implementation, public xBallPhysics {
    // Members
public:
    unsigned char run; // offset 0x5C, size 0x1
    unsigned char bounce; // offset 0x5D, size 0x1
};
// total size: 0x10
class xPlane {
    // Members
...
// total size: 0x74
class auto_orient_physics : public ball_physics {
    // Members
public:
    float spring_speed; // offset 0x60, size 0x4
    float spring_vel; // offset 0x64, size 0x4
    float final_spin_speed; // offset 0x68, size 0x4
    float timer; // offset 0x6C, size 0x4
    signed int settle_bounce_count; // offset 0x70, size 0x4
};
// total size: 0x14
class xAnimEffect {
    // Members
...
// total size: 0x58
class player_hit_react : public react {
    // Members
public:
    unsigned int anim_flag; // offset 0x50, size 0x4
    class behavior_implementation & attack; // offset 0x54, size 0x4
};
// total size: 0x70
class RpWorld {
    // Members
...
// total size: 0x14
class fire : public behavior_implementation {
    // Members
public:
...
// total size: 0x5C
class hit_react_sleep : public react {
    // Members
public:
    float sleep_time; // offset 0x50, size 0x4
    unsigned int anim_flag; // offset 0x54, size 0x4
    class bot_sleep * sleep_state; // offset 0x58, size 0x4
};
// total size: 0x8
class xJSPNodeInfo {
    // Members
...
// total size: 0x28
class bot_sleep : public behavior_implementation {
    // Members
public:
    unsigned int anim_flag; // offset 0x10, size 0x4
    float notice_radius; // offset 0x14, size 0x4
    float run_timer; // offset 0x18, size 0x4
    float outside_timer; // offset 0x1C, size 0x4
    float max_outside_timer; // offset 0x20, size 0x4
    enum iSndGroupHandle sleep_noise_group; // offset 0x24, size 0x4
};
// total size: 0x20
...
// total size: 0x5C
class hit_react_armor : public react {
    // Members
public:
    float timer; // offset 0x50, size 0x4
    unsigned int anim_flag; // offset 0x54, size 0x4
    unsigned char hasRun; // offset 0x58, size 0x1
};
// total size: 0x8
class xBaseAsset {
    // Members
...
// total size: 0x44
class engine_exhaust : public behavior_implementation {
    // Members
public:
    class xModelInstance * model[2]; // offset 0x10, size 0x8
    unsigned char engine_on; // offset 0x18, size 0x1
    signed char bones[2]; // offset 0x19, size 0x2
    class xVec3 effect_offset; // offset 0x1C, size 0xC
    class xVec3 effect_pos[2]; // offset 0x28, size 0x18
...
// total size: 0x2C
class physics_death : public behavior_implementation {
    // Members
public:
    unsigned char landed; // offset 0x10, size 0x1
    unsigned char run; // offset 0x11, size 0x1
    unsigned char bounce; // offset 0x12, size 0x1
    float dust_emit_time; // offset 0x14, size 0x4
    float dust_emit_remaining; // offset 0x18, size 0x4
    class xVec3 hit_velocity; // offset 0x1C, size 0xC
    class ball_physics * physics; // offset 0x28, size 0x4
};
// total size: 0x18
class analog_data {
    // Members
...
// total size: 0x50
class react : public npc_move {
    // Members
public:
    unsigned char run; // offset 0x34, size 0x1
    unsigned char entered; // offset 0x35, size 0x1
    class xVec3 target_pos; // offset 0x38, size 0xC
    char * anim_name; // offset 0x44, size 0x4
    union { // inferred
        char * dist_param_name; // offset 0x48, size 0x4
        float dist; // offset 0x48, size 0x4
    };
    float old_speed; // offset 0x4C, size 0x4
};
// total size: 0x30
...
// total size: 0x44
class random_patrol : public npc_move {
    // Members
public:
    float patrol_radius; // offset 0x34, size 0x4
    class xVec3 current_point; // offset 0x38, size 0xC
};
// total size: 0x560
class xGlobals {
    // Members
...
// total size: 0x38
class animbomb_death : public timebomb_death {};
// total size: 0xC
...
// total size: 0x50
class hit_react_die : public react {};
// total size: 0x40
...
// total size: 0x40
class bone_spin : public behavior_implementation {
    // Members
public:
    class xQuat quat; // offset 0x10, size 0x10
    class xRot rot; // offset 0x20, size 0x10
    signed char bone; // offset 0x30, size 0x1
};
// total size: 0x1C
class RpMaterial {
    // Members
...
// total size: 0x3C
class gunfire_death : public timebomb_death {
    // Members
public:
    class fire * fire_state; // offset 0x38, size 0x4
};
// total size: 0x18
...
// total size: 0x44
class fall_swap_death : public fall_death {};
// total size: 0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003309D0 -> 0x00330A18
*/
// Range: 0x3309D0 -> 0x330A18
// this: r16
void charge_attack::exit_state() {
    /* anonymous block */ {
        // Range: 0x3309D0 -> 0x330A18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330A20 -> 0x00330A50
*/
// Range: 0x330A20 -> 0x330A50
// this: r2
void charge_attack::enter_state() {
    /* anonymous block */ {
        // Range: 0x330A20 -> 0x330A50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330A50 -> 0x00330AE8
*/
// Range: 0x330A50 -> 0x330AE8
// this: r2
unsigned int charge_attack::facing_player() {
    /* anonymous block */ {
        // Range: 0x330A50 -> 0x330AE8
        class xVec2 facing; // r29+0x18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330AF0 -> 0x00330B88
*/
// Range: 0x330AF0 -> 0x330B88
// this: r16
unsigned int charge_attack::attack_start() {
    /* anonymous block */ {
        // Range: 0x330AF0 -> 0x330B88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330B90 -> 0x00330BA4
*/
// Range: 0x330B90 -> 0x330BA4
// this: r2
unsigned int charge_attack::attack_finished() {
    /* anonymous block */ {
        // Range: 0x330B90 -> 0x330BA4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330BB0 -> 0x00330C2C
*/
// Range: 0x330BB0 -> 0x330C2C
// this: r16
unsigned char charge_attack::runnable() {
    /* anonymous block */ {
        // Range: 0x330BB0 -> 0x330C2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330C30 -> 0x00330DE8
*/
// Range: 0x330C30 -> 0x330DE8
// this: r16
void charge_attack::update(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x330C30 -> 0x330DE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330DF0 -> 0x0033104C
*/
// Range: 0x330DF0 -> 0x33104C
// this: r2
unsigned char charge_attack::prev_step_success() {
    /* anonymous block */ {
        // Range: 0x330DF0 -> 0x33104C
        class xVec3 prev_dpos; // r29+0x30
        class xVec2 diff_2d; // r29+0x28
        class xVec2 at_2d; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331050 -> 0x00331110
*/
// Range: 0x331050 -> 0x331110
// this: r16
void charge_attack::setup() {
    /* anonymous block */ {
        // Range: 0x331050 -> 0x331110
        char * noise_name; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331110 -> 0x00331128
*/
// Range: 0x331110 -> 0x331128
// this: r4
void bone_spin::before_anim_matrices(class xQuat * pQuat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x331110 -> 0x331128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331130 -> 0x003311D4
*/
// Range: 0x331130 -> 0x3311D4
// this: r16
void bone_spin::setup() {
    /* anonymous block */ {
        // Range: 0x331130 -> 0x3311D4
        signed int bone_num; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003311E0 -> 0x00331224
*/
// Range: 0x3311E0 -> 0x331224
// this: r16
void bone_spin::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x3311E0 -> 0x331224
        class xQuat q; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331230 -> 0x00331304
*/
// Range: 0x331230 -> 0x331304
// this: r16
unsigned char player_hit_react::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x331230 -> 0x331304
        class zCombat * combat; // r2
        signed int hit_count; // r2
        signed int i; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331310 -> 0x00331364
*/
// Range: 0x331310 -> 0x331364
// this: r3
void player_hit_react::add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x331310 -> 0x331364
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331370 -> 0x00331390
*/
// Range: 0x331370 -> 0x331390
// this: r2
void react::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x331370 -> 0x331390
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331390 -> 0x0033139C
*/
// Range: 0x331390 -> 0x33139C
// this: r2
void react::reset() {
    /* anonymous block */ {
        // Range: 0x331390 -> 0x33139C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003313A0 -> 0x003313F0
*/
// Range: 0x3313A0 -> 0x3313F0
// this: r16
void react::setup() {
    /* anonymous block */ {
        // Range: 0x3313A0 -> 0x3313F0
        float the_dist; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003313F0 -> 0x00331404
*/
// Range: 0x3313F0 -> 0x331404
// this: r2
void react::exit_state() {
    /* anonymous block */ {
        // Range: 0x3313F0 -> 0x331404
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331410 -> 0x003314C8
*/
// Range: 0x331410 -> 0x3314C8
// this: r16
void react::enter_state() {
    /* anonymous block */ {
        // Range: 0x331410 -> 0x3314C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003314D0 -> 0x00331770
*/
// Range: 0x3314D0 -> 0x331770
// this: r17
void react::move_away(class xVec3 & away_dir /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3314D0 -> 0x331770
        float time; // r20
        signed int sub_mesh_index; // r29+0xBC
        signed int tri_index; // r29+0xB8
        class xVec2 pos; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331770 -> 0x00331814
*/
// Range: 0x331770 -> 0x331814
// this: r16
void patrol_return::enter_state(class behavior_implementation * prev_behavior /* r2 */) {
    /* anonymous block */ {
        // Range: 0x331770 -> 0x331814
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331820 -> 0x0033189C
*/
// Range: 0x331820 -> 0x33189C
// this: r16
void patrol_return::setup() {
    /* anonymous block */ {
        // Range: 0x331820 -> 0x33189C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003318A0 -> 0x003319AC
*/
// Range: 0x3318A0 -> 0x3319AC
// this: r16
void patrol_return::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x3318A0 -> 0x3319AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003319B0 -> 0x00331A0C
*/
// Range: 0x3319B0 -> 0x331A0C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331A10 -> 0x00331AB0
*/
// Range: 0x331A10 -> 0x331AB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331AB0 -> 0x00331AB8
*/
// Range: 0x331AB0 -> 0x331AB8
// this: r2
void bot_sleep::exit_state() {
    /* anonymous block */ {
        // Range: 0x331AB0 -> 0x331AB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331AC0 -> 0x00331B24
*/
// Range: 0x331AC0 -> 0x331B24
// this: r16
void bot_sleep::enter_state() {
    /* anonymous block */ {
        // Range: 0x331AC0 -> 0x331B24
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331B30 -> 0x00331BC8
*/
// Range: 0x331B30 -> 0x331BC8
// this: r16
void bot_sleep::setup() {
    /* anonymous block */ {
        // Range: 0x331B30 -> 0x331BC8
        char * noise_name; // r29+0x2C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331BD0 -> 0x00331BE0
*/
// Range: 0x331BD0 -> 0x331BE0
// this: r2
void bot_sleep::reset() {
    /* anonymous block */ {
        // Range: 0x331BD0 -> 0x331BE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331BE0 -> 0x00331C7C
*/
// Range: 0x331BE0 -> 0x331C7C
// this: r16
unsigned char bot_sleep::runnable(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x331BE0 -> 0x331C7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331C80 -> 0x00331CB0
*/
// Range: 0x331C80 -> 0x331CB0
// this: r2
void bot_sleep::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x331C80 -> 0x331CB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331CB0 -> 0x00331D04
*/
// Range: 0x331CB0 -> 0x331D04
// this: r4
void bot_sleep::add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x331CB0 -> 0x331D04
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331D10 -> 0x00331D6C
*/
// Range: 0x331D10 -> 0x331D6C
// this: r2
void engine_exhaust::render() {
    /* anonymous block */ {
        // Range: 0x331D10 -> 0x331D6C
        signed int i; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331D70 -> 0x00331E78
*/
// Range: 0x331D70 -> 0x331E78
// this: r17
void engine_exhaust::update() {
    /* anonymous block */ {
        // Range: 0x331D70 -> 0x331E78
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331E80 -> 0x00331F18
*/
// Range: 0x331E80 -> 0x331F18
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00331F20 -> 0x003320B0
*/
// Range: 0x331F20 -> 0x3320B0
// this: r20
void engine_exhaust::setup() {
    /* anonymous block */ {
        // Range: 0x331F20 -> 0x3320B0
        class RpAtomic * imodel; // r19
        char * name; // r29+0x7C
        class xSurface * surface; // r18
        signed int i; // r17
        char buffer[16]; // r29+0x60
        signed int bone_id; // r29+0x78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003320B0 -> 0x0033215C
*/
// Range: 0x3320B0 -> 0x33215C
// this: r17
void explode::enter_state(class behavior_implementation * prev_behavior /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3320B0 -> 0x33215C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332160 -> 0x00332208
*/
// Range: 0x332160 -> 0x332208
// this: r16
void explode::setup() {
    /* anonymous block */ {
        // Range: 0x332160 -> 0x332208
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332210 -> 0x00332370
*/
// Range: 0x332210 -> 0x332370
// this: r18
unsigned char explode::system_event(class xBase * from /* r17 */, unsigned int toEvent /* r2 */, float * toParam /* r16 */) {
    /* anonymous block */ {
        // Range: 0x332210 -> 0x332370
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332370 -> 0x0033242C
*/
// Range: 0x332370 -> 0x33242C
// this: r16
void auto_orient_physics::setup() {
    /* anonymous block */ {
        // Range: 0x332370 -> 0x33242C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332430 -> 0x00332BC4
*/
// Range: 0x332430 -> 0x332BC4
// this: r21
void auto_orient_physics::update(float dt /* r24 */) {
    /* anonymous block */ {
        // Range: 0x332430 -> 0x332BC4
        class xMat4x3 & mat; // r20
        float params[4]; // r29+0xC0
        class xQuat current; // r29+0xB0
        class xQuat next; // r29+0xA0
        class xVec3 rotation_direction; // r29+0x190
        class xVec3 normal; // r29+0x180
        class xVec3 proj; // r29+0x170
        float angle; // r29+0x1A0
        class xQuat target; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332BD0 -> 0x00332CCC
*/
// Range: 0x332BD0 -> 0x332CCC
// this: r18
unsigned char auto_orient_physics::collided(class xSweptSphere & sws /* r17 */) {
    /* anonymous block */ {
        // Range: 0x332BD0 -> 0x332CCC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332CD0 -> 0x00332CE4
*/
// Range: 0x332CD0 -> 0x332CE4
// this: r2
void auto_orient_physics::enter_state() {
    /* anonymous block */ {
        // Range: 0x332CD0 -> 0x332CE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332CF0 -> 0x00332CFC
*/
// Range: 0x332CF0 -> 0x332CFC
// this: r2
void ball_physics::reset() {
    /* anonymous block */ {
        // Range: 0x332CF0 -> 0x332CFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332D00 -> 0x00332D10
*/
// Range: 0x332D00 -> 0x332D10
// this: r2
void ball_physics::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x332D00 -> 0x332D10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332D10 -> 0x00332D94
*/
// Range: 0x332D10 -> 0x332D94
// this: r16
void ball_physics::setup() {
    /* anonymous block */ {
        // Range: 0x332D10 -> 0x332D94
        class xSphere s; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332DA0 -> 0x00332F3C
*/
// Range: 0x332DA0 -> 0x332F3C
// this: r16
unsigned char ball_physics::collided(class xSweptSphere & sws /* r2 */) {
    /* anonymous block */ {
        // Range: 0x332DA0 -> 0x332F3C
        class xEnt * ent; // r2
        float params[4]; // r29+0x30
        float params[4]; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332F40 -> 0x00332F74
*/
// Range: 0x332F40 -> 0x332F74
// this: r2
void fall_swap_death::reset_effects() {
    /* anonymous block */ {
        // Range: 0x332F40 -> 0x332F74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00332F80 -> 0x00333088
*/
// Range: 0x332F80 -> 0x333088
// this: r16
void fall_swap_death::enter_effects() {
    /* anonymous block */ {
        // Range: 0x332F80 -> 0x333088
        class xModelInstance * model; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333090 -> 0x00333140
*/
// Range: 0x333090 -> 0x333140
// this: r16
void fall_death::enter_state() {
    /* anonymous block */ {
        // Range: 0x333090 -> 0x333140
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333140 -> 0x0033331C
*/
// Range: 0x333140 -> 0x33331C
// this: r18
void fall_death::enter_effects() {
    /* anonymous block */ {
        // Range: 0x333140 -> 0x33331C
        char buffer[32]; // r29+0x40
        signed int which_piece; // r17
        signed int file_number; // r16
        class xModelInstance * model; // r7
        signed int i; // r3
        char * shrapnelName; // r29+0x6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333320 -> 0x0033338C
*/
// Range: 0x333320 -> 0x33338C
// this: r17
void fall_death::update(float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x333320 -> 0x33338C
        unsigned char prev_landed; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333390 -> 0x003334DC
*/
// Range: 0x333390 -> 0x3334DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333530 -> 0x0033366C
*/
// Range: 0x333530 -> 0x33366C
// this: r17
void fall_death::add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x333530 -> 0x33366C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333670 -> 0x003336A8
*/
// Range: 0x333670 -> 0x3336A8
// this: r2
void fall_death::reset_effects() {
    /* anonymous block */ {
        // Range: 0x333670 -> 0x3336A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003336B0 -> 0x003336C8
*/
// Range: 0x3336B0 -> 0x3336C8
// this: r2
void fall_death::reset() {
    /* anonymous block */ {
        // Range: 0x3336B0 -> 0x3336C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003336D0 -> 0x003337E0
*/
// Range: 0x3336D0 -> 0x3337E0
// this: r2
void fall_death::setup() {
    /* anonymous block */ {
        // Range: 0x3336D0 -> 0x3337E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003337E0 -> 0x00333880
*/
// Range: 0x3337E0 -> 0x333880
// this: r16
void launch_death::enter_state() {
    /* anonymous block */ {
        // Range: 0x3337E0 -> 0x333880
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333880 -> 0x003338DC
*/
// Range: 0x333880 -> 0x3338DC
void add_transitions(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x333880 -> 0x3338DC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003338E0 -> 0x00333980
*/
// Range: 0x3338E0 -> 0x333980
void add_states(class xAnimTable * table /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3338E0 -> 0x333980
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333980 -> 0x003339BC
*/
// Range: 0x333980 -> 0x3339BC
// this: r16
void launch_death::update(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x333980 -> 0x3339BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003339C0 -> 0x00333A3C
*/
// Range: 0x3339C0 -> 0x333A3C
// this: r16
void physics_death::enter_state() {
    /* anonymous block */ {
        // Range: 0x3339C0 -> 0x333A3C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333A40 -> 0x00333A64
*/
// Range: 0x333A40 -> 0x333A64
// this: r2
unsigned char physics_death::system_event(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x333A40 -> 0x333A64
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333A70 -> 0x00333AF0
*/
// Range: 0x333A70 -> 0x333AF0
// this: r2
unsigned char physics_death::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x333A70 -> 0x333AF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333AF0 -> 0x00333D1C
*/
// Range: 0x333AF0 -> 0x333D1C
// this: r16
void physics_death::update(float dt /* r29+0xD0 */) {
    /* anonymous block */ {
        // Range: 0x333AF0 -> 0x333D1C
        class xVec3 normal; // r29+0xC0
        class xVec3 position; // r29+0xB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333D20 -> 0x00333D64
*/
// Range: 0x333D20 -> 0x333D64
// this: r16
unsigned char physics_death::runnable() {
    /* anonymous block */ {
        // Range: 0x333D20 -> 0x333D64
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333D70 -> 0x00333D7C
*/
// Range: 0x333D70 -> 0x333D7C
// this: r2
void physics_death::reset() {
    /* anonymous block */ {
        // Range: 0x333D70 -> 0x333D7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333D80 -> 0x00333E88
*/
// Range: 0x333D80 -> 0x333E88
// this: r2
void physics_death::setup() {
    /* anonymous block */ {
        // Range: 0x333D80 -> 0x333E88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333E90 -> 0x00333F50
*/
// Range: 0x333E90 -> 0x333F50
void static_setup() {
    /* anonymous block */ {
        // Range: 0x333E90 -> 0x333F50
        class RwTexture * burn_mark_texture; // r2
        class xResponseCurve curve; // @ 0x006A25E0
        class curve_node burn_curve[3]; // @ 0x005F2790
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333F50 -> 0x00333F60
*/
// Range: 0x333F50 -> 0x333F60
// this: r2
void timebomb_death::reset() {
    /* anonymous block */ {
        // Range: 0x333F50 -> 0x333F60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00333F60 -> 0x00334044
*/
// Range: 0x333F60 -> 0x334044
// this: r16
void timebomb_death::setup() {
    /* anonymous block */ {
        // Range: 0x333F60 -> 0x334044
        signed int bone; // r29+0x2C
        char * name; // r29+0x28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334050 -> 0x00334098
*/
// Range: 0x334050 -> 0x334098
// this: r2
unsigned char timebomb_death::system_event(unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x334050 -> 0x334098
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003340A0 -> 0x003340EC
*/
// Range: 0x3340A0 -> 0x3340EC
// this: r2
unsigned char timebomb_death::damage(class zCombatDamageInfo & damageInfo /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3340A0 -> 0x3340EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003340F0 -> 0x003340F8
*/
// Range: 0x3340F0 -> 0x3340F8
// this: r2
void timebomb_death::exit() {
    /* anonymous block */ {
        // Range: 0x3340F0 -> 0x3340F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334100 -> 0x003341A0
*/
// Range: 0x334100 -> 0x3341A0
// this: r16
void timebomb_death::render() {
    /* anonymous block */ {
        // Range: 0x334100 -> 0x3341A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003341A0 -> 0x003341C8
*/
// Range: 0x3341A0 -> 0x3341C8
// this: r2
void timebomb_death::enter_state() {
    /* anonymous block */ {
        // Range: 0x3341A0 -> 0x3341C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003341D0 -> 0x00334224
*/
// Range: 0x3341D0 -> 0x334224
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334230 -> 0x003342E0
*/
// Range: 0x334230 -> 0x3342E0
// this: r5
void timebomb_death::update(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x334230 -> 0x3342E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003342E0 -> 0x00334308
*/
// Range: 0x3342E0 -> 0x334308
// this: r2
void static_jump::enter_state() {
    /* anonymous block */ {
        // Range: 0x3342E0 -> 0x334308
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334310 -> 0x00334324
*/
// Range: 0x334310 -> 0x334324
// this: r2
void static_jump::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x334310 -> 0x334324
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334330 -> 0x00334350
*/
// Range: 0x334330 -> 0x334350
// this: r2
unsigned char static_jump::runnable() {
    /* anonymous block */ {
        // Range: 0x334330 -> 0x334350
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334350 -> 0x003343A4
*/
// Range: 0x334350 -> 0x3343A4
// this: r4
void static_jump::add_states(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x334350 -> 0x3343A4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003343B0 -> 0x003343EC
*/
// Range: 0x3343B0 -> 0x3343EC
unsigned int RobotDestroyCB(class xEnt * object /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3343B0 -> 0x3343EC
    }
}
