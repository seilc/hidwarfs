/*
    Compile unit: C:\TestBuild\in\GAME\zFrozoneIce.cpp
...
static class xColor_tag lower_color; // size: 0x4, address: 0x5FC3C8
static class frozone_data * frodata; // size: 0x4, address: 0x6096D4
static class frobridge_spike_curve_node spike_appear_curve[4]; // size: 0x60, address: 0x5FC3D0
static class frobridge_spike_curve_node spike_disappear_curve[3]; // size: 0x48, address: 0x5FC430
signed int update_decay_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x48E960
signed int update_spawn_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x48F3D0
...
// total size: 0x80
class frobridge_spike {
    // Members
public:
    class xMat4x3 mat; // offset 0x0, size 0x40
    float lower_scale; // offset 0x40, size 0x4
    class xColor_tag upper_color; // offset 0x44, size 0x4
    class xColor_tag lower_color; // offset 0x48, size 0x4
    float path_dist; // offset 0x4C, size 0x4
    signed int animating; // offset 0x50, size 0x4
    ...
    class xColor_tag upper_glow_color; // offset 0x70, size 0x4
    class xColor_tag lower_glow_color; // offset 0x74, size 0x4
};
// total size: 0x70
class jump {
    // Members
...
class NCINEntry {
    // Members
public:
    class TypeInfo info; // offset 0x0, size 0x10
    class Callbacks cb; // offset 0x10, size 0x10
    class IndexInput index; // offset 0x20, size 0x10
    class PosInput basic; // offset 0x30, size 0x30
    class NCINInput input; // offset 0x60, size 0x4
    void * userFXData; // offset 0x64, size 0x4
    class NCINData fxdata; // offset 0x68, size 0x28
    signed int flg_stat; // offset 0x90, size 0x4
};
// total size: 0x40
...
// total size: 0x20
class NCINRibbonInput {
    // Members
public:
    class config_type ribcfg; // offset 0x0, size 0x20
};
// total size: 0xC
...
// total size: 0x8
class frobridge_spike_ref {
    // Members
public:
    signed int sort_value; // offset 0x0, size 0x4
    class frobridge_spike * spike; // offset 0x4, size 0x4
};
// total size: 0x1C
class iFogParams {
    // Members
...
class Callbacks {
    // Members
public:
    void (* fxupd)(class zCutsceneMgr *, class NCINEntry *, signed int); // offset 0x0, size 0x4
    void (* fxanim)(class zCutsceneMgr *, class NCINEntry *, class RpAtomic *, class RwMatrixTag *, unsigned int, unsigned int); // offset 0x4, size 0x4
    void (* fxrend)(class zCutsceneMgr *, class NCINEntry *); // offset 0x8, size 0x4
    void (* tweaks)(char *, class NCINEntry *); // offset 0xC, size 0x4
};
...
class frozone_data {
    // Members
public:
    unsigned char was_active; // offset 0x0, size 0x1
    unsigned char active; // offset 0x1, size 0x1
    unsigned char gap; // offset 0x2, size 0x1
    class xVec3 lead_loc; // offset 0x4, size 0xC
    class xVec3 foot_loc; // offset 0x10, size 0xC
    class xVec3 last_lead_loc; // offset 0x1C, size 0xC
    class xVec3 last_foot_loc; // offset 0x28, size 0xC
    class frobridge_spike spikes[64]; // offset 0x40, size 0x2000
    signed int spikes_size; // offset 0x2040, size 0x4
    float spikes_emitted; // offset 0x2044, size 0x4
    class xResponseCurve spike_curve[2]; // offset 0x2048, size 0x20
    // total size: 0x1C
    class /* @class */ {
        // Members
    public:
    ...
    } parabola; // offset 0x2068, size 0x1C
    class RwRaster * spike_raster; // offset 0x2084, size 0x4
    signed int spawn_system_id; // offset 0x2088, size 0x4
    signed int decay_system_id; // offset 0x208C, size 0x4
    class HIFastIMLockStruct lock; // offset 0x2090, size 0x1C
    class HIFastIMLockStruct glow_lock; // offset 0x20AC, size 0x1C
};
// total size: 0x28
class NCINData {
    // Members
public:
    union { // inferred
        ...
        class NCINStreak streakdata; // offset 0x0, size 0x4
        ...
        class NCINCustom customdata; // offset 0x0, size 0x28
        class NCINMat matdata; // offset 0x0, size 0x4
        class NCINRibbon ribbondata; // offset 0x0, size 0x4
    };
};
// total size: 0x10
class xBase {
...
class IndexInput {
    // Members
public:
    signed int idx_anim; // offset 0x0, size 0x4
    signed int idx_bone; // offset 0x4, size 0x4
    signed int idx_boneA; // offset 0x8, size 0x4
    signed int idx_boneB; // offset 0xC, size 0x4
};
// total size: 0xDC
...
class zParEmitter {
    // Members
public:
    char dummy[144]; // offset 0x0, size 0x90
};
// total size: 0x4
class RxColorUnion {
    // Members
...
class PosInput {
    // Members
public:
    class xVec3 pos_A[2]; // offset 0x0, size 0x18
    class xVec3 pos_B[2]; // offset 0x18, size 0x18
};
// total size: 0x0
class Incredimeter {};
// total size: 0x14
...
public:
    union { // inferred
        ...
        signed int int_val; // offset 0x0, size 0x4
        float flt_val; // offset 0x0, size 0x4
        class NCINRibbonInput * ribbon; // offset 0x0, size 0x4
    };
};
enum _tagPadState {
    ePad_Disabled = 0,
...
public:
    ...
    signed int n[3]; // offset 0x1C, size 0xC
};
// total size: 0x2C
...
// total size: 0x18
class frobridge_spike_curve_node {
    // Members
public:
    float t; // offset 0x0, size 0x4
    class frobridge_spike_anim anim; // offset 0x4, size 0x14
};
// total size: 0x10
...
public:
    union { // inferred
        signed int fxTypeID; // offset 0x0, size 0x4
        signed int usrTypeID; // offset 0x0, size 0x4
    };
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D520 -> 0x0048D528
*/
// Range: 0x48D520 -> 0x48D528
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D530 -> 0x0048D538
*/
// Range: 0x48D530 -> 0x48D538
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D540 -> 0x0048D83C
*/
// Range: 0x48D540 -> 0x48D83C
void cinfx_frobridge_animate(class NCINEntry * fxrec /* r18 */, class RwMatrixTag * animMat /* r2 */, unsigned int animIndex /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48D540 -> 0x48D83C
        class xMat4x3 & root_mat; // r17
        class xMat4x3 & lead_bone_mat; // r2
        class xMat4x3 & foot_bone_mat; // r16
        class xMat4x3 lead_mat; // r29+0x80
        class xMat4x3 foot_mat; // r29+0x40
        class xVec3 foot_loc; // r29+0xD0
        class xVec3 lead_loc; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D840 -> 0x0048D948
*/
// Range: 0x48D840 -> 0x48D948
void cinfx_frobridge_update(class NCINEntry * fxrec /* r2 */, signed int killit /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48D840 -> 0x48D948
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D950 -> 0x0048D98C
*/
// Range: 0x48D950 -> 0x48D98C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048D990 -> 0x0048E01C
*/
// Range: 0x48D990 -> 0x48E01C
void zFrozoneIceUpdate(float dt /* r24 */) {
    /* anonymous block */ {
        // Range: 0x48D990 -> 0x48E01C
        float cx; // r23
        float cy; // r22
        float cz; // r21
        class frobridge_spike * spike; // r20
        class frobridge_spike * end_spike; // r19
        float dx; // r29+0xC0
        float dy; // r29+0xC0
        float dz; // r29+0xC0
        float dist2; // r29+0xC0
        signed int was_animating; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048E020 -> 0x0048E028
*/
// Range: 0x48E020 -> 0x48E028
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048E030 -> 0x0048E188
*/
// Range: 0x48E030 -> 0x48E188
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048E190 -> 0x0048E960
*/
// Range: 0x48E190 -> 0x48E960
static void emit_decay_particles(class frobridge_spike & spike /* r17 */, float dt /* r29+0x110 */) {
    /* anonymous block */ {
        // Range: 0x48E190 -> 0x48E960
        float rate; // r29+0x110
        signed int emit; // r16
        float xzscale_max; // r29+0x110
        float xzscale_range; // r31
        float y_min; // r30
        float y_range; // r29+0xFC
        float xz_min; // r29
        float xz_max; // r29+0x110
        float xz_range; // r28
        float red_upper; // r3
        float red_lower; // r27
        float red_range; // r29+0xF8
        float green_upper; // r3
        float green_lower; // r26
        float green_range; // r29+0xF4
        float blue_upper; // r1
        float blue_lower; // r25
        float blue_range; // r29+0xF0
        signed int system_id; // r30
        unsigned char * mem; // r29+0x10C
        signed int have; // r2
        class decay_particle * p; // r21
        class decay_particle * endp; // r2
        float yrand; // r24
        float xzscale; // r23
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048E960 -> 0x0048EDB8
*/
// Range: 0x48E960 -> 0x48EDB8
static signed int update_decay_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x48E960 -> 0x48EDB8
        class ptank_pool__pos_color_size & pool; // r19
        class decay_particle * p; // r18
        class decay_particle * end; // r17
        float t1; // r21
        float age2; // r29+0xC0
        float y0; // r4
        float y1; // r1
        float height; // r20
        class xVec4 loc; // r29+0x90
        float alpha; // r1
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048EDC0 -> 0x0048F3C8
*/
// Range: 0x48EDC0 -> 0x48F3C8
static void emit_spawn_particles(class frobridge_spike & spike /* r17 */, float dt /* r29+0xE0 */) {
    /* anonymous block */ {
        // Range: 0x48EDC0 -> 0x48F3C8
        float rate; // r29+0xE0
        signed int emit; // r16
        float xzscale_max; // r29+0xE0
        float xzscale_range; // r27
        float y_min; // r26
        float y_range; // r25
        float xz_min; // r24
        float xz_max; // r29+0xE0
        float xz_range; // r23
        float red_upper; // r29+0xE0
        float red_lower; // r22
        float red_range; // r21
        float green_upper; // r29+0xE0
        float green_lower; // r29+0xE0
        float green_range; // r29+0xE0
        float blue_upper; // r1
        float blue_lower; // r20
        float blue_range; // r29+0xD8
        signed int system_id; // r22
        unsigned char * mem; // r29+0xDC
        signed int have; // r2
        class spawn_particle * p; // r21
        class spawn_particle * endp; // r2
        float size; // r30
        float yrand; // r31
        float xzscale; // r30
        float intensity; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048F3D0 -> 0x0048F794
*/
// Range: 0x48F3D0 -> 0x48F794
static signed int update_spawn_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x48F3D0 -> 0x48F794
        class ptank_pool__pos_color_size & pool; // r18
        class spawn_particle * p; // r17
        class spawn_particle * end; // r16
        float t1; // r22
        float width; // r20
        float alpha; // r1
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048F7A0 -> 0x0048F9E8
*/
// Range: 0x48F7A0 -> 0x48F9E8
static void render_spikes() {
    /* anonymous block */ {
        // Range: 0x48F7A0 -> 0x48F9E8
        signed int spikes_size; // r2
        class frobridge_spike * unsorted_spikes; // r17
        class frobridge_spike_ref * sspikes; // r18
        class frobridge_spike_ref * sspike; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048F9F0 -> 0x0048FCC0
*/
// Range: 0x48F9F0 -> 0x48FCC0
static void transform_spikes(class xVec3 * pos /* r2 */, class xVec2 * uv /* r2 */, unsigned int * color /* r2 */, unsigned int * glow_color /* r2 */, class frobridge_spike_ref * sspikes /* r2 */, signed int spikes_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x48F9F0 -> 0x48FCC0
        class frobridge_spike_ref * sspike; // r12
        class frobridge_spike_ref * end_sspike; // r2
        class frobridge_spike & spike; // r2
        float tx; // r29
        float ty; // r29
        float tz; // r29
        float bscale; // r29
        ...
        float boy; // r29
        float boz; // r29
        unsigned int lower_color; // r2
        unsigned int lower_glow_value; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0048FCC0 -> 0x00490AB0
*/
// Range: 0x48FCC0 -> 0x490AB0
static void emit_spikes(class xVec3 & A /* r16 */, class xVec3 & B /* r2 */, float dt /* r26 */) {
    /* anonymous block */ {
        // Range: 0x48FCC0 -> 0x490AB0
        float ABx; // r24
        float ABy; // r23
        float ABz; // r22
        float ABmag; // r29+0x2A0
        float old_emitted; // r21
        signed int emit; // r2
        float ABrmag; // r29+0x2A0
        float xdir; // r20
        float ydir; // r29
        float zdir; // r28
        class xMat3x3 path_mat; // r29+0x230
        class xMat3x3 path_imat; // r29+0x200
        class xVec3 path_at; // r29+0x290
        float iemit; // r29+0x2A0
        float dage; // r24
        float age; // r23
        float start_dist; // r29+0x2A0
        float x; // r22
        float y; // r21
        float z; // r20
        float dx; // r29+0x11C
        ...
        float xscale; // r31
        float zscale; // r30
        class xMat3x3 pre_scale_mat; // r29+0x1D0
        class xMat3x3 rot_mat; // r29+0x1A0
        class xMat3x3 post_scale_mat; // r29+0x170
        class xMat3x3 temp_mat; // r29+0x140
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00490AB0 -> 0x00490C84
*/
// Range: 0x490AB0 -> 0x490C84
static signed int reserve_spikes(signed int amount /* r2 */) {
    /* anonymous block */ {
        // Range: 0x490AB0 -> 0x490C84
        signed int spikes_left; // r8
        class frobridge_spike * spikes; // r2
        signed int eldest; // r12
        float eldest_age; // r1
        signed int i; // r11
        signed int endi; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00490C90 -> 0x00490D58
*/
// Range: 0x490C90 -> 0x490D58
static signed int create_particle_system(signed int old_system_id /* r20 */, unsigned int texture /* r2 */, unsigned int src_blend /* r19 */, unsigned int dst_blend /* r18 */, signed int stride /* r17 */, signed int (* update)(unsigned char *, signed int, class ptank_pool &, float, void *) /* r16 */) {
    /* anonymous block */ {
        // Range: 0x490C90 -> 0x490D58
        class xParticleBatchSystem system; // r29+0x60
    }
}
