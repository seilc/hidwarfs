/*
    Compile unit: C:\TestBuild\in\GAME\zUICustomBattleModeSelectPlayer.cpp
...
unsigned int curr_content_playerID; // size: 0x4, address: 0x0
static class battle_player_details battle_player_default[2]; // size: 0x20, address: 0x5FC640
static unsigned char texture_scene_loaded; // size: 0x1, address: 0x0
// total size: 0x4C
struct /* @anon0 */ {} zUICustomBattleModeSelectPlayerManager::__vtable; // size: 0x4C, address: 0x6073D0
...
public:
    ...
    char imagename[128]; // offset 0x80, size 0x80
    char description[128]; // offset 0x100, size 0x80
    enum enCONTENT_TYPE contentType; // offset 0x180, size 0x4
    enum enCONTENT_TYPE_ACCESS contentAccess; // offset 0x184, size 0x4
    enum enCONTENT_STATE contentState; // offset 0x188, size 0x4
    signed int contentListIdx; // offset 0x18C, size 0x4
};
// total size: 0x0
class zCutsceneMgr {};
// total size: 0x50
...
// total size: 0xC830
class zUICustomBattleModeSelectPlayerManager : public zUICustom {
    // Members
public:
    class zUIText * removeButton; // offset 0x8, size 0x4
    class xBase * dispatcher; // offset 0xC, size 0x4
    class zUIImage * imagePlayer; // offset 0x10, size 0x4
    class zUIImage * imageArrowLeft; // offset 0x14, size 0x4
    class zUIImage * imageArrowRight; // offset 0x18, size 0x4
    class contentDetails battle_players[128]; // offset 0x1C, size 0xC800
    signed int maxContents; // offset 0xC81C, size 0x4
    signed int defaultContents; // offset 0xC820, size 0x4
    signed int displayIndex; // offset 0xC824, size 0x4
    signed int olddisplayIndex; // offset 0xC828, size 0x4
    unsigned char downloadable_content_available; // offset 0xC82C, size 0x1
    unsigned char local_content_available; // offset 0xC82D, size 0x1
};
// total size: 0x14
...
// total size: 0x10
class battle_player_details {
    // Members
public:
    unsigned int tag; // offset 0x0, size 0x4
    char filename[5]; // offset 0x4, size 0x5
    char imagename[5]; // offset 0x9, size 0x5
};
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495B10 -> 0x00495B18
*/
// Range: 0x495B10 -> 0x495B18
// this: r2
void zUICustomBattleModeSelectPlayerManager::PreUpdate(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x495B10 -> 0x495B18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00495B20 -> 0x00496164
*/
// Range: 0x495B20 -> 0x496164
// this: r18
unsigned char zUICustomBattleModeSelectPlayerManager::HandleEvent(class xBase * from /* r2 */, unsigned int toEvent /* r16 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, unsigned int toParamWidgetID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x495B20 -> 0x496164
        class contentDetails & content; // r2
        float toParams[4]; // r29+0x50
        char * filename; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00496170 -> 0x00496274
*/
// Range: 0x496170 -> 0x496274
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00496280 -> 0x004962A4
*/
// Range: 0x496280 -> 0x4962A4
// this: r2
zUICustomBattleModeSelectPlayerManager::zUICustomBattleModeSelectPlayerManager(class zUI * ui /* r2 */) {
    /* anonymous block */ {
        // Range: 0x496280 -> 0x4962A4
    }
}
