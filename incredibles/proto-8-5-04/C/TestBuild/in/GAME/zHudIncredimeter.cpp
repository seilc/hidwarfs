/*
    Compile unit: C:\TestBuild\in\GAME\zHudIncredimeter.cpp
...
static class RwTexCoords blueMeterUpLeft; // size: 0x8, address: 0x608EF8
static class RwTexCoords blueMeterDownRight; // size: 0x8, address: 0x608F00
static class RwTexCoords purpleMeterUpLeft; // size: 0x8, address: 0x608F08
static class RwTexCoords purpleMeterDownRight; // size: 0x8, address: 0x608F10
// total size: 0x28
struct /* @anon1 */ {} zHud::Incredimeter::__vtable; // size: 0x28, address: 0x601320
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
// total size: 0x24
struct /* @anon0 */ {} zHud::hud_element::__vtable; // size: 0x24, address: 0x0
// total size: 0x70
class RpAtomic {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A5CB0 -> 0x002A5EA4
*/
// Range: 0x2A5CB0 -> 0x2A5EA4
// this: r16
void Incredimeter::meter_full_update() {
    /* anonymous block */ {
        // Range: 0x2A5CB0 -> 0x2A5EA4
        float persistpercent; // r20
        float fScale; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A5EB0 -> 0x002A6044
*/
// Range: 0x2A5EB0 -> 0x2A6044
// this: r18
void Incredimeter::incredipoint_update() {
    /* anonymous block */ {
        ...
        unsigned int i; // r17
        float fControl; // r20
        float fScale; // r29+0x50
        float fControl; // r29+0x50
        float fScale; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6050 -> 0x002A60F8
*/
// Range: 0x2A6050 -> 0x2A60F8
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6100 -> 0x002A613C
*/
// Range: 0x2A6100 -> 0x2A613C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6140 -> 0x002A6558
*/
// Range: 0x2A6140 -> 0x2A6558
// this: r16
void Incredimeter::twist_update() {
    /* anonymous block */ {
        // Range: 0x2A6140 -> 0x2A6558
        float fTwistPercent; // r20
        float fSparklePercent; // r20
        float fScale; // r29+0x30
        float fGleamPercent; // r20
        float fScale; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6560 -> 0x002A6858
*/
// Range: 0x2A6560 -> 0x2A6858
// this: r16
void Incredimeter::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2A6560 -> 0x2A6858
        float fStrobe; // r29+0x30
        float fAlpha; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6860 -> 0x002A6AC4
*/
// Range: 0x2A6860 -> 0x2A6AC4
// this: r16
void Incredimeter::power_update() {
    /* anonymous block */ {
        // Range: 0x2A6860 -> 0x2A6AC4
        float fPowerPercent; // r21
        float fUsedPowerPercent; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6AD0 -> 0x002A6C34
*/
// Range: 0x2A6AD0 -> 0x2A6C34
// this: r16
void Incredimeter::health_update() {
    /* anonymous block */ {
        // Range: 0x2A6AD0 -> 0x2A6C34
        float fHealthPercent; // r20
        float fDamagePercent; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6C40 -> 0x002A6E70
*/
// Range: 0x2A6C40 -> 0x2A6E70
// this: r16
void Incredimeter::twist_off() {
    /* anonymous block */ {
        // Range: 0x2A6C40 -> 0x2A6E70
        float fMaxHealth; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A6E70 -> 0x002A7098
*/
// Range: 0x2A6E70 -> 0x2A7098
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A70A0 -> 0x002A70E8
*/
// Range: 0x2A70A0 -> 0x2A70E8
// this: r2
void Incredimeter::blueIncredipower(unsigned char bBlue /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A70A0 -> 0x2A70E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A70F0 -> 0x002A7518
*/
// Range: 0x2A70F0 -> 0x2A7518
// this: r16
void Incredimeter::set(float outerScroller /* r22 */, float bgScroller /* r21 */, float iScroller /* r20 */, unsigned char effects_off /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A70F0 -> 0x2A7518
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7520 -> 0x002A7528
*/
// Range: 0x2A7520 -> 0x2A7528
void destroy() {
    /* anonymous block */ {
        // Range: 0x2A7520 -> 0x2A7528
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7530 -> 0x002A7BD4
*/
// Range: 0x2A7530 -> 0x2A7BD4
// this: r18
void Incredimeter::setup() {
    /* anonymous block */ {
        // Range: 0x2A7530 -> 0x2A7BD4
        unsigned int meterID; // r2
        class RwTexCoords upperleft; // r29+0x58
        class RwTexCoords lowerright; // r29+0x50
        unsigned int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7BE0 -> 0x002A7BE8
*/
// Range: 0x2A7BE0 -> 0x2A7BE8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A7BF0 -> 0x002A7DB4
*/
// Range: 0x2A7BF0 -> 0x2A7DB4
// this: r2
Incredimeter::Incredimeter() {
    /* anonymous block */ {
        // Range: 0x2A7BF0 -> 0x2A7DB4
    }
}
