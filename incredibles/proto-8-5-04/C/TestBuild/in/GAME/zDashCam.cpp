/*
    Compile unit: C:\TestBuild\in\GAME\zDashCam.cpp
...
// total size: 0x24
struct /* @anon0 */ {} zDash::camera::__vtable; // size: 0x24, address: 0x6041D0
...
// total size: 0x14
class camera_spline_asset : public xDynAsset {
    // Members
public:
    unsigned int spline_id; // offset 0x10, size 0x4
};
// total size: 0x0
class xFFX {};
// total size: 0x70
...
class BossMeter {};
// total size: 0x14
class camera_spline : public xBase {
    // Members
public:
    class NURBS * nurbs; // offset 0x10, size 0x4
};
// total size: 0x18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003345D0 -> 0x00334928
*/
// Range: 0x3345D0 -> 0x334928
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00334930 -> 0x00336370
*/
// Range: 0x334930 -> 0x336370
// this: r16
void camera::update(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x334930 -> 0x336370
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336370 -> 0x00336378
*/
// Range: 0x336370 -> 0x336378
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336380 -> 0x00336390
*/
// Range: 0x336380 -> 0x336390
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336390 -> 0x003367B0
*/
// Range: 0x336390 -> 0x3367B0
// this: r20
void camera::update_spline_direction() {
    /* anonymous block */ {
        // Range: 0x336390 -> 0x3367B0
        float closest_distance; // r29+0xDC
        float closest_u; // r29+0xD8
        class NURBS * closest_spline; // r19
        signed int i; // r18
        class camera_spline * current_spline; // r2
        float distance; // r29+0xD4
        float u; // r29+0xD0
        unsigned char reverse; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003367B0 -> 0x00336AF8
*/
// Range: 0x3367B0 -> 0x336AF8
// this: r16
void camera::update_direction(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x3367B0 -> 0x336AF8
        float u; // r29+0xA0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336B00 -> 0x00336B0C
*/
// Range: 0x336B00 -> 0x336B0C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336B10 -> 0x00336B20
*/
// Range: 0x336B10 -> 0x336B20
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336B20 -> 0x00336EE8
*/
// Range: 0x336B20 -> 0x336EE8
// this: r16
void camera::attach(class player * new_owner /* r2 */) {
    /* anonymous block */ {
        // Range: 0x336B20 -> 0x336EE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00336EF0 -> 0x00337D14
*/
// Range: 0x336EF0 -> 0x337D14
// this: r16
void camera::start() {
    /* anonymous block */ {
        // Range: 0x336EF0 -> 0x337D14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00337D20 -> 0x00337DC4
*/
// Range: 0x337D20 -> 0x337DC4
// this: r16
void camera::create() {
    /* anonymous block */ {
        // Range: 0x337D20 -> 0x337DC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00337DD0 -> 0x00337E10
*/
// Range: 0x337DD0 -> 0x337E10
void init(class xBase & data /* r17 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x337DD0 -> 0x337E10
        class camera_spline_asset * spline_asset; // r16
    }
}
