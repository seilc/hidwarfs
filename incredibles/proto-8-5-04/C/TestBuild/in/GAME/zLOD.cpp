/*
    Compile unit: C:\TestBuild\in\GAME\zLOD.cpp
...
static unsigned int sLODTableCount; // size: 0x4, address: 0x608714
static class zLODTable * sLODTableList; // size: 0x4, address: 0x608718
static unsigned int sManagerIndex; // size: 0x4, address: 0x60871C
static unsigned int sManagerCount; // size: 0x4, address: 0x608720
static float sLODFadeDistance; // size: 0x4, address: 0x6076B4
static class zLODManager sManagerList[2048]; // size: 0x8000, address: 0x614210
class zGlobals globals; // size: 0x640, address: 0x61C210
class xEnt * AddToLODList(class xEnt *, class xScene *, void *); // size: 0x0, address: 0x13BF60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B980 -> 0x0013B9FC
*/
// Range: 0x13B980 -> 0x13B9FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BA00 -> 0x0013BCE8
*/
// Range: 0x13BA00 -> 0x13BCE8
void zLOD_Update(unsigned int percent_update /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13BA00 -> 0x13BCE8
        unsigned int sManagerIndex'118; // r2
        class xVec3 * campos; // r7
        unsigned int numUpdates; // r6
        class zLODTable * lod; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BCF0 -> 0x0013BF58
*/
// Range: 0x13BCF0 -> 0x13BF58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BF60 -> 0x0013BF98
*/
// Range: 0x13BF60 -> 0x13BF98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BFA0 -> 0x0013C110
*/
// Range: 0x13BFA0 -> 0x13C110
static void AddToLODList(class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13BFA0 -> 0x13C110
        unsigned int i; // r5
        class xModelInstance * minst; // r6
        unsigned int numextra; // r10
        float distscale; // r5
    }
}
