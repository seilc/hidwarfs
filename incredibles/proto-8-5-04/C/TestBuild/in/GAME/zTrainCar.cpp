/*
    Compile unit: C:\TestBuild\in\GAME\zTrainCar.cpp
...
class zPathWalker * walker; // size: 0x4, address: 0x608F34
class zTrainCar * first_train_car; // size: 0x4, address: 0x608F38
signed int spark_particle_batch_id; // size: 0x4, address: 0x607B94
...
void Event(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2B05C0
void Move(class xEnt *, class xScene *, float, class xEntFrame *); // size: 0x0, address: 0x2AFE30
void Update(class xEnt *, class xScene *, float); // size: 0x0, address: 0x2B0320
// total size: 0x14
class xCylinder {
    // Members
public:
...
public:
    ...
    class xVec3 front_axle_pos; // offset 0xE8, size 0xC
    class xVec3 rear_axle_pos; // offset 0xF4, size 0xC
    unsigned char have_positions; // offset 0x100, size 0x1
    class zTrainCar * global_car_list_next; // offset 0x104, size 0x4
    class zDestructible * destructible; // offset 0x108, size 0x4
...
public:
    ...
    class NURBS * curve; // offset 0x18, size 0x4
...
class front_car_data {
    // Members
public:
    class NURBS * current_path; // offset 0x0, size 0x4
    float front_u; // offset 0x4, size 0x4
    class xVec3 spline_dir; // offset 0x8, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF050 -> 0x002AF064
*/
// Range: 0x2AF050 -> 0x2AF064
void Reset() {
    /* anonymous block */ {
        // Range: 0x2AF050 -> 0x2AF064
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF070 -> 0x002AF11C
*/
// Range: 0x2AF070 -> 0x2AF11C
// this: r16
void zTrainCar::Explode() {
    /* anonymous block */ {
        // Range: 0x2AF070 -> 0x2AF11C
        float uber_damage; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF120 -> 0x002AF574
*/
// Range: 0x2AF120 -> 0x2AF574
// this: r20
void zTrainCar::Detach() {
    /* anonymous block */ {
        // Range: 0x2AF120 -> 0x2AF574
        class zPathWalker walker; // r29+0xA8
        class xVec3 front_axle_pos; // r29+0x98
        class xVec3 rear_axle_pos; // r29+0x88
        class zTrainCar * ahead_car; // r19
        class zTrainCar * this_car; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF580 -> 0x002AF63C
*/
// Range: 0x2AF580 -> 0x2AF63C
// this: r2
void zTrainCar::ChangeSpeed(float new_speed /* r29 */, float speedup_time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2AF580 -> 0x2AF63C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF640 -> 0x002AF9EC
*/
// Range: 0x2AF640 -> 0x2AF9EC
// this: r17
void zTrainCar::FrontCarUpdateFrontAxle(float dt /* r29+0x60 */, class xVec3 & front_axle_pos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2AF640 -> 0x2AF9EC
        float distance; // r20
        float new_u; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AF9F0 -> 0x002AFE28
*/
// Range: 0x2AF9F0 -> 0x2AFE28
// this: r17
void zTrainCar::MoveAsFront(float dt /* r20 */, class xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2AF9F0 -> 0x2AFE28
        class xVec3 center_track_loc; // r29+0x50
        class xVec3 old_pos; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002AFE30 -> 0x002B0268
*/
// Range: 0x2AFE30 -> 0x2B0268
void Move(class xEnt * _this /* r17 */, class xScene * scene /* r2 */, float dt /* r20 */, class xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2AFE30 -> 0x2B0268
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0270 -> 0x002B0278
*/
// Range: 0x2B0270 -> 0x2B0278
// this: r2
void zTrainCar::Save(class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B0270 -> 0x2B0278
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0280 -> 0x002B0320
*/
// Range: 0x2B0280 -> 0x2B0320
// this: r17
void zTrainCar::Update(class xScene * scene /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B0280 -> 0x2B0320
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0320 -> 0x002B03F4
*/
// Range: 0x2B0320 -> 0x2B03F4
void Update(class xEnt * ent /* r2 */, class xScene * scene /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2B0320 -> 0x2B03F4
        class zTrainCar * _this; // r16
        class zPathWalker walker; // r29+0x48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0400 -> 0x002B04A8
*/
// Range: 0x2B0400 -> 0x2B04A8
void MapCarPointers() {
    /* anonymous block */ {
        // Range: 0x2B0400 -> 0x2B04A8
        class zTrainCar * current_car; // r16
        class zTrainCarAsset * search_for_asset; // r2
        class zTrainCar * found_car; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B04B0 -> 0x002B05B8
*/
// Range: 0x2B04B0 -> 0x2B05B8
// this: r21
void zTrainCar::Event(class xBase * from /* r20 */, unsigned int toEvent /* r19 */, float * toParam /* r18 */, class xBase * toParamWidget /* r17 */, unsigned int toParamWidgetID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2B04B0 -> 0x2B05B8
        unsigned char send_event_to_destructible; // r22
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B05C0 -> 0x002B05D0
*/
// Range: 0x2B05C0 -> 0x2B05D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B05D0 -> 0x002B06A4
*/
// Range: 0x2B05D0 -> 0x2B06A4
// this: r16
void zTrainCar::Setup() {
    /* anonymous block */ {
        // Range: 0x2B05D0 -> 0x2B06A4
        unsigned int asset_size; // r29+0x6C
        void * navmesh_asset_ptr; // r2
        class xMat4x3 mesh_local_origin; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B06B0 -> 0x002B09E4
*/
// Range: 0x2B06B0 -> 0x2B09E4
// this: r16
void zTrainCar::Init(class zTrainCarAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B06B0 -> 0x2B09E4
        unsigned int assetID; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B09F0 -> 0x002B09F8
*/
// Range: 0x2B09F0 -> 0x2B09F8
void Init(class xBase & data /* r2 */, class xDynAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B09F0 -> 0x2B09F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0A00 -> 0x002B0DF4
*/
// Range: 0x2B0A00 -> 0x2B0DF4
// this: r16
void zPathWalker::FindPoint(class xVec3 & from_point /* r2 */, float distance /* r29+0x30 */, class xVec3 & found_pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2B0A00 -> 0x2B0DF4
        float dist_squ; // r7
        float intersect_u; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B0E00 -> 0x002B1044
*/
// Range: 0x2B0E00 -> 0x2B1044
// this: r19
void zFollowPath::ExtendSameCurve(float front_u /* r20 */, class xVec3 & pos /* r18 */, class xVec3 & dir /* r17 */, float & dir_mag /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2B0E00 -> 0x2B1044
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002B1050 -> 0x002B132C
*/
// Range: 0x2B1050 -> 0x2B132C
// this: r20
void zFollowPath::JumpToCurve(class NURBS * curve /* r19 */, float u /* r20 */, unsigned char traveling_positive_u /* r21 */, class xVec3 & dir /* r18 */, float & dir_mag /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2B1050 -> 0x2B132C
    }
}
