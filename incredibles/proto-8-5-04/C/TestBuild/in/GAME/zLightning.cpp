/*
    Compile unit: C:\TestBuild\in\GAME\zLightning.cpp
...
static class zLightning * sLightning[80]; // size: 0x140, address: 0x613930
static class zParEmitter * sSparkEmitter; // size: 0x4, address: 0x0
static class RwRaster * sLightningRaster; // size: 0x4, address: 0x6086F4
static class RwRaster * sLightningRasterBranch; // size: 0x4, address: 0x6086F8
static class RwTexture * sLightningParticleRaster; // size: 0x4, address: 0x6086FC
float LIGHTNING_FADE_DIST_SQR; // size: 0x4, address: 0x608700
float LIGHTNING_CULL_DIST_SQR; // size: 0x4, address: 0x608704
static class xFuncPiece sLFuncX[10]; // size: 0x140, address: 0x613A70
static class xFuncPiece sLFuncY[10]; // size: 0x140, address: 0x613BB0
static class xFuncPiece sLFuncZ[10]; // size: 0x140, address: 0x613CF0
static class xVec3 sLFuncVal[10]; // size: 0x78, address: 0x613E30
static class xVec3 sLFuncSlope[10][2]; // size: 0xF0, address: 0x613EB0
static float sLFuncEnd[10]; // size: 0x28, address: 0x613FA0
static float sLFuncJerkFreq; // size: 0x4, address: 0x607680
static float sLFuncJerkTime; // size: 0x4, address: 0x608708
static float sLFuncShift; // size: 0x4, address: 0x607684
static float sLFuncMaxPStep; // size: 0x4, address: 0x0
static float sLFuncMinPStep; // size: 0x4, address: 0x0
static float sLFuncMinScale; // size: 0x4, address: 0x607688
static float sLFuncMaxScale; // size: 0x4, address: 0x60768C
static float sLFuncScalePerLength; // size: 0x4, address: 0x607690
static float sLFuncMinSpan; // size: 0x4, address: 0x607694
static float sLFuncSpanPerLength; // size: 0x4, address: 0x607698
static float sLFuncSlopeRange; // size: 0x4, address: 0x60769C
static float sLFuncUVSpeed; // size: 0x4, address: 0x6076A0
static float sLFuncUVOffset; // size: 0x4, address: 0x60870C
class zLightningFuncPiece sLFuncNew[11]; // size: 0x160, address: 0x613FD0
class _tagLightningAdd gLightningTweakAddInfo; // size: 0x68, address: 0x614130
static class xVec3 sTweakStart; // size: 0xC, address: 0x614198
static class xVec3 sTweakEnd; // size: 0xC, address: 0x6141A8
static class tweak_callback sLightningStartCB; // size: 0x28, address: 0x6141C0
static class tweak_callback sLightningChangeCB; // size: 0x28, address: 0x0
class CollisionInfo collisionInfo; // size: 0x20, address: 0x6141F0
class xVec3 * posArray; // size: 0x4, address: 0x608710
...
class tagiRenderArrays gRenderArr; // size: 0x5280, address: 0x6C00E0
...
void lightningTweakStart(class tweak_info &); // size: 0x0, address: 0x13B740
void EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x13B820
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00137530 -> 0x00137AFC
*/
// Range: 0x137530 -> 0x137AFC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00137B00 -> 0x00137EB8
*/
// Range: 0x137B00 -> 0x137EB8
void zLightningUpdatePTankPool(class zLightning * l /* r20 */) {
    /* anonymous block */ {
        // Range: 0x137B00 -> 0x137EB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00137EC0 -> 0x001382CC
*/
// Range: 0x137EC0 -> 0x1382CC
void zLightningUpdateParticles(class zLightning * l /* r16 */, float dt /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x137EC0 -> 0x1382CC
        signed int p; // r7
        signed int next; // r2
        float life; // @ 0x006076A8
        float speed; // @ 0x006076A4
        float genTime; // @ 0x006076AC
        float gravity; // @ 0x006076B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001382D0 -> 0x0013844C
*/
// Range: 0x1382D0 -> 0x13844C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138450 -> 0x00138458
*/
// Range: 0x138450 -> 0x138458
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138460 -> 0x001384B8
*/
// Range: 0x138460 -> 0x1384B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001384C0 -> 0x00138A10
*/
// Range: 0x1384C0 -> 0x138A10
void zLightningRender() {
    /* anonymous block */ {
        // Range: 0x1384C0 -> 0x138A10
        signed int i; // r20
        class zLightning * l; // r19
        signed int start; // r2
        float frac; // r29+0x140
        class xVec3 oldEndPoint; // r29+0x130
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138A10 -> 0x00138E1C
*/
// Range: 0x138A10 -> 0x138E1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138E20 -> 0x00139FC4
*/
// Range: 0x138E20 -> 0x139FC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139FD0 -> 0x0013A510
*/
// Range: 0x139FD0 -> 0x13A510
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A510 -> 0x0013A7F8
*/
// Range: 0x13A510 -> 0x13A7F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A800 -> 0x0013AB18
*/
// Range: 0x13A800 -> 0x13AB18
class zLightning * _zLightningAdd(class _tagLightningAdd * add /* r17 */) {
    /* anonymous block */ {
        // Range: 0x13A800 -> 0x13AB18
        class zLightning * l; // r16
        class RwTexture * tex; // r2
        float defaultWeightParam[4][12]; // @ 0x005056E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013AB20 -> 0x0013AB2C
*/
// Range: 0x13AB20 -> 0x13AB2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013AB30 -> 0x0013AC10
*/
// Range: 0x13AB30 -> 0x13AC10
static class zLightning * FindFreeLightning(unsigned int flags /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13AB30 -> 0x13AC10
        signed int start; // r5
        signed int end; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013AC10 -> 0x0013AC84
*/
// Range: 0x13AC10 -> 0x13AC84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013AC90 -> 0x0013B430
*/
// Range: 0x13AC90 -> 0x13B430
void zLightningInit() {
    /* anonymous block */ {
        // Range: 0x13AC90 -> 0x13B430
        signed int i; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B430 -> 0x0013B438
*/
// Range: 0x13B430 -> 0x13B438
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B440 -> 0x0013B738
*/
// Range: 0x13B440 -> 0x13B738
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B740 -> 0x0013B818
*/
// Range: 0x13B740 -> 0x13B818
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B820 -> 0x0013B918
*/
// Range: 0x13B820 -> 0x13B918
void EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13B820 -> 0x13B918
        class zLightningWidget & lightningWidget; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B920 -> 0x0013B978
*/
// Range: 0x13B920 -> 0x13B978
