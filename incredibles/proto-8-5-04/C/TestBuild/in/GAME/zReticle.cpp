/*
    Compile unit: C:\TestBuild\in\GAME\zReticle.cpp
...
static class xFuncPiece sFadeSize[2]; // size: 0x40, address: 0x6B26C0
static class xFuncPiece sDistSize; // size: 0x20, address: 0x6B2700
static float sAlpha; // size: 0x4, address: 0x607CE0
static float sFadeInSpeed; // size: 0x4, address: 0x607CE4
static float sFadeOutSpeed; // size: 0x4, address: 0x607CE8
static float sMinDist; // size: 0x4, address: 0x607CEC
static float sPulseAmp; // size: 0x4, address: 0x607CF0
static float sPulseSpeed; // size: 0x4, address: 0x607CF4
static float sRotSpeed; // size: 0x4, address: 0x607CF8
static float sSwirlMaxU; // size: 0x4, address: 0x607CFC
static float sSwirlMinU; // size: 0x4, address: 0x609220
static float sSwirlMaxV; // size: 0x4, address: 0x607D00
static float sSwirlMinV; // size: 0x4, address: 0x609224
static float sLetterMaxU; // size: 0x4, address: 0x607D04
static float sLetterMinU; // size: 0x4, address: 0x607D08
static float sLetterMaxV; // size: 0x4, address: 0x607D0C
static float sLetterMinV; // size: 0x4, address: 0x607D10
static float sXMult; // size: 0x4, address: 0x607D14
static class zReticle reticle[4]; // size: 0x80, address: 0x6B2720
static signed int activeReticle; // size: 0x4, address: 0x607D18
static signed int nextReticle; // size: 0x4, address: 0x609228
static class RwRaster * reticleRast; // size: 0x4, address: 0x60922C
static float sAlphaUpRate; // size: 0x4, address: 0x607D1C
static float sAlphaDownRate; // size: 0x4, address: 0x607D20
static float sMinDrawDist2; // size: 0x4, address: 0x607D24
static float sMaxDrawAlpha; // size: 0x4, address: 0x607D28
static float sIconAngle; // size: 0x4, address: 0x609230
class zGlobals globals; // size: 0x640, address: 0x61C210
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
void zIcon_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x374B90
...
// total size: 0x30
class zIconAsset : public xDynAsset {
    // Members
public:
...
// total size: 0x70
class zIcon : public xBase {
    // Members
public:
    class zIconAsset * iconAsset; // offset 0x10, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374B90 -> 0x00374BD4
*/
// Range: 0x374B90 -> 0x374BD4
void zIcon_EventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x374B90 -> 0x374BD4
        class zIcon * icon; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374BE0 -> 0x00374DB8
*/
// Range: 0x374BE0 -> 0x374DB8
void zIcon_Update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x374BE0 -> 0x374DB8
        class zScene * zsc; // r2
        signed int count; // r2
        class zIcon * iconList; // r2
        signed int i; // r7
        class zIconAsset * asset; // r2
        float newAlpha; // r4
        float radius2; // r29
        float alphaDiff; // r2
        float maxUp; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374DC0 -> 0x00374EC8
*/
// Range: 0x374DC0 -> 0x374EC8
void zIcon_Reset() {
    /* anonymous block */ {
        // Range: 0x374DC0 -> 0x374EC8
        class zScene * zsc; // r2
        signed int count; // r2
        class zIcon * iconList; // r5
        signed int i; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374ED0 -> 0x00374F74
*/
// Range: 0x374ED0 -> 0x374F74
void zIcon_Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x374ED0 -> 0x374F74
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00374F80 -> 0x003750AC
*/
// Range: 0x374F80 -> 0x3750AC
void zReticle_MoveActive(class xVec3 * pos /* r2 */, float radius /* r29 */) {
    /* anonymous block */ {
        // Range: 0x374F80 -> 0x3750AC
        signed int activeReticle'80; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003750B0 -> 0x003751D0
*/
// Range: 0x3750B0 -> 0x3751D0
void zReticle_MoveActive(class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3750B0 -> 0x3751D0
        signed int activeReticle'77; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003751D0 -> 0x00375214
*/
// Range: 0x3751D0 -> 0x375214
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375220 -> 0x00375304
*/
// Range: 0x375220 -> 0x375304
void zReticle_NewActive(class xVec3 * pos /* r2 */, float radius /* r29 */) {
    /* anonymous block */ {
        // Range: 0x375220 -> 0x375304
        signed int activeReticle'71; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375310 -> 0x003754F8
*/
// Range: 0x375310 -> 0x3754F8
void zReticle_Render() {
    /* anonymous block */ {
        // Range: 0x375310 -> 0x3754F8
        signed int i; // r17
        unsigned char wasBright; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375500 -> 0x0037587C
*/
// Range: 0x375500 -> 0x37587C
static void RenderReticle(class zReticle * ret /* r17 */) {
    /* anonymous block */ {
        // Range: 0x375500 -> 0x37587C
        float atDist; // r24
        class xMat4x3 objToWorld; // r29+0x70
        float scale; // r23
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375880 -> 0x00375B0C
*/
// Range: 0x375880 -> 0x375B0C
void zReticle_RenderLetter(class xMat4x3 * mat /* r18 */, float alpha /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x375880 -> 0x375B0C
        class RxObjSpace3DVertex * vert; // r17
        unsigned char alpha8bit; // r2
        float x; // r22
        float ang; // r21
        float aspect; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375B10 -> 0x00375D9C
*/
// Range: 0x375B10 -> 0x375D9C
void zReticle_RenderSwirl(class xMat4x3 * mat /* r18 */, float angle /* r20 */, float alpha /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x375B10 -> 0x375D9C
        class RxObjSpace3DVertex * vert; // r17
        unsigned char alpha8bit; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375DA0 -> 0x00375E18
*/
// Range: 0x375DA0 -> 0x375E18
void zReticle_Update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x375DA0 -> 0x375E18
        signed int i; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375E20 -> 0x00375F6C
*/
// Range: 0x375E20 -> 0x375F6C
static void UpdateReticle(class zReticle * ret /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x375E20 -> 0x375F6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375F70 -> 0x00375FE4
*/
// Range: 0x375F70 -> 0x375FE4
float zReticle_RotateSwirl(float angle /* r29 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x375F70 -> 0x375FE4
        float result; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00375FF0 -> 0x00376130
*/
// Range: 0x375FF0 -> 0x376130
void zReticle_Init() {
    /* anonymous block */ {
        // Range: 0x375FF0 -> 0x376130
