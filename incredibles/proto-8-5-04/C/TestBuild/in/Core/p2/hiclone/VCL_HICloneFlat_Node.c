/*
    Compile unit: C:\TestBuild\in\Core\p2\hiclone\VCL_HICloneFlat_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HICloneFlat_VU1Transforms[2]; // size: 0x8, address: 0x608498
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneFlat_VU1Code; // size: 0x8, address: 0x6084A0
class RpPDSSkyMatTemplate rwPDS_VCL_HICloneFlat_MatPipe; // size: 0x84, address: 0x5DB3B0
