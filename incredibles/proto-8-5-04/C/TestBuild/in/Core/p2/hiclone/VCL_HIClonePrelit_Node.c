/*
    Compile unit: C:\TestBuild\in\Core\p2\hiclone\VCL_HIClonePrelit_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HIClonePrelit_VU1Transforms[2]; // size: 0x8, address: 0x6084D0
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HIClonePrelit_VU1Code; // size: 0x8, address: 0x6084D8
class RpPDSSkyMatTemplate rwPDS_VCL_HIClonePrelit_MatPipe; // size: 0x84, address: 0x5DB9E0
class rwPDS_HICloneDownloadInfo rwPDS_VCL_HIClonePrelitDownload; // size: 0x10, address: 0x0
