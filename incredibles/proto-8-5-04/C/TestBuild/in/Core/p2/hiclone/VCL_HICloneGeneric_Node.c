/*
    Compile unit: C:\TestBuild\in\Core\p2\hiclone\VCL_HICloneGeneric_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HICloneGeneric_VU1Transforms[2]; // size: 0x8, address: 0x607BA0
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneGeneric_VU1Code; // size: 0x8, address: 0x607BA8
class RpPDSSkyMatTemplate rwPDS_VCL_HICloneGeneric_MatPipe; // size: 0x84, address: 0x50DF30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BEF90 -> 0x002BF45C
*/
// Range: 0x2BEF90 -> 0x2BF45C
signed int CloneBridgeCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r19 */) {
    /* anonymous block */ {
        // Range: 0x2BEF90 -> 0x2BF45C
        signed int skyAlphaTex'278; // r2
        __int128 * _rwDMAPktPtr'277; // r6
        unsigned int skyUserSwitch1'276; // r7
        signed long old_sky_test; // r2
        class RwTexture * _nwtx; // r18
        class RwRaster * _nwrs; // r17
        unsigned int cFormat; // r2
        __int128 ltmp; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BF460 -> 0x002BF49C
*/
// Range: 0x2BF460 -> 0x2BF49C
static signed int InterleaveNormalInstanceCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r17 */, void * * clusterData /* r2 */, unsigned int numClusters /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2BF460 -> 0x2BF49C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BF4A0 -> 0x002BF904
*/
// Range: 0x2BF4A0 -> 0x2BF904
static void InterleaveNormalReprocessData(class RxPS2AllPipeData * ps2AllPipeData /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2BF4A0 -> 0x2BF904
        signed int i; // r14
        signed int j; // r13
        signed int totwtct[4]; // r29+0x70
        class RpMesh * mesh; // r2
        class rwPS2AllResEntryHeader * hdr; // r20
