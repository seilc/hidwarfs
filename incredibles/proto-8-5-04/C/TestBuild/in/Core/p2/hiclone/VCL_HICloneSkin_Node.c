/*
    Compile unit: C:\TestBuild\in\Core\p2\hiclone\VCL_HICloneSkin_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HICloneSkin_VU1Transforms[2]; // size: 0x8, address: 0x607BB0
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneSkin_VU1Code; // size: 0x8, address: 0x607BB8
class RpPDSSkyMatTemplate rwPDS_VCL_HICloneSkin_MatPipe; // size: 0x84, address: 0x50DFD0
