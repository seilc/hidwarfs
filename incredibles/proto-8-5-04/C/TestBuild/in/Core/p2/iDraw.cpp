/*
    Compile unit: C:\TestBuild\in\Core\p2\iDraw.cpp
...
class rwDMA_flipData _rwDMAFlipData; // size: 0x3D0, address: 0x6B7180
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015B410 -> 0x0015B628
*/
// Range: 0x15B410 -> 0x15B628
void iDrawSetDisplayOffset(float x /* r29 */, float y /* r29 */) {
    /* anonymous block */ {
        // Range: 0x15B410 -> 0x15B628
        signed int dx; // r6
        signed int dy; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015B630 -> 0x0015B69C
*/
// Range: 0x15B630 -> 0x15B69C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015B6A0 -> 0x0015B718
*/
// Range: 0x15B6A0 -> 0x15B718
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015B720 -> 0x0015B804
*/
// Range: 0x15B720 -> 0x15B804
void iDrawSetFBMSK(unsigned int abgr /* r2 */, unsigned int setMask /* r2 */, unsigned char plusFrame2 /* r16 */) {
    /* anonymous block */ {
        // Range: 0x15B720 -> 0x15B804
        signed int size; // r2
        __int128 * _rwDMA_local_rwDMAPktPtr; // r8
        unsigned long tmp; // r2
    }
}
