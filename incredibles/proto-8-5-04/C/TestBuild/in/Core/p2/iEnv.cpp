/*
    Compile unit: C:\TestBuild\in\Core\p2\iEnv.cpp
...
static signed int sBeginDrawFX; // size: 0x4, address: 0x608880
static class RpWorld * sPipeWorld; // size: 0x4, address: 0x608884
static class RwCamera * sPipeCamera; // size: 0x4, address: 0x608890
static class iEnv * lastEnv; // size: 0x4, address: 0x608894
static class iEnv * sCmpEnv; // size: 0x4, address: 0x608898
static signed int sColorCompare; // size: 0x4, address: 0x60889C
class zGlobals globals; // size: 0x640, address: 0x61C210
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
signed int CmpMatOrder(void *, void *); // size: 0x0, address: 0x15BD70
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
class RwCamera * globalCamera; // size: 0x4, address: 0x608D40
class RpAtomic * SetPipelineCB(class RpAtomic *, void *); // size: 0x0, address: 0x15C6A0
// total size: 0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015B810 -> 0x0015BB0C
*/
// Range: 0x15B810 -> 0x15BB0C
static void iEnvMatOrderRenderPS2(class iEnv * env /* r30 */, unsigned char alpha /* r16 */) {
    /* anonymous block */ {
        ...
        unsigned int oldState; // r29+0xBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015BB10 -> 0x0015BD64
*/
// Range: 0x15BB10 -> 0x15BD64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015BD70 -> 0x0015BF9C
*/
// Range: 0x15BD70 -> 0x15BF9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015BFA0 -> 0x0015C004
*/
// Range: 0x15BFA0 -> 0x15C004
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C010 -> 0x0015C070
*/
// Range: 0x15C010 -> 0x15C070
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C070 -> 0x0015C078
*/
// Range: 0x15C070 -> 0x15C078
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C080 -> 0x0015C088
*/
// Range: 0x15C080 -> 0x15C088
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C090 -> 0x0015C098
*/
// Range: 0x15C090 -> 0x15C098
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C0A0 -> 0x0015C100
*/
// Range: 0x15C0A0 -> 0x15C100
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C100 -> 0x0015C158
*/
// Range: 0x15C100 -> 0x15C158
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C160 -> 0x0015C208
*/
// Range: 0x15C160 -> 0x15C208
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C210 -> 0x0015C2B8
*/
// Range: 0x15C210 -> 0x15C2B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C2C0 -> 0x0015C370
*/
// Range: 0x15C2C0 -> 0x15C370
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C370 -> 0x0015C420
*/
// Range: 0x15C370 -> 0x15C420
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C420 -> 0x0015C598
*/
// Range: 0x15C420 -> 0x15C598
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C5A0 -> 0x0015C68C
*/
// Range: 0x15C5A0 -> 0x15C68C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C690 -> 0x0015C698
*/
// Range: 0x15C690 -> 0x15C698
void iEnvStartup() {
    /* anonymous block */ {
        // Range: 0x15C690 -> 0x15C698
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0015C6A0 -> 0x0015C768
*/
// Range: 0x15C6A0 -> 0x15C768
