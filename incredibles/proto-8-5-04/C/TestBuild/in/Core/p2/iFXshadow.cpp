/*
    Compile unit: C:\TestBuild\in\Core\p2\iFXshadow.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class RxPipeline * ShadowMapMaterialPipeline; // size: 0x4, address: 0x608D08
class RxPipeline * ShadowMapAtomicPipeline; // size: 0x4, address: 0x608D0C
...
static void * VUCodeArray[32]; // size: 0x80, address: 0x508B70
unsigned int ShadowMapLightOffset; // size: 0x4, address: 0x608D10
...
class RwCamera * ShadowCamera; // size: 0x4, address: 0x608B40
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
class RpLight * ShadowLight; // size: 0x4, address: 0x608B2C
class RwCamera * ShadowCamera; // size: 0x4, address: 0x608B40
signed int ShadowMapObjectSetupCallBack(class RxPS2AllPipeData *, class RwMatrixTag * *); // size: 0x0, address: 0x1F31C0
signed int ShadowMapBridgeCallBack(class RxPS2AllPipeData *); // size: 0x0, address: 0x1F2830
signed int RpMeshPS2AllInstanceCallBack(class RxPS2AllPipeData *, void * *, unsigned int); // size: 0x0, address: 0x4116A0
class RwResEntry * RpMeshPS2AllResEntryAllocCallBack(class RxPS2AllPipeData *, class RwResEntry * *, unsigned int, void (*)(class RwResEntry *)); // size: 0x0, address: 0x40FE50
signed int RpMeshPS2AllMeshInstanceTestCallBack(class RxPS2AllPipeData *); // size: 0x0, address: 0x411610
class RxClusterDefinition RxClPS2normal; // size: 0x10, address: 0x5DB1D0
class RxClusterDefinition RxClPS2rgba; // size: 0x10, address: 0x5DB1C0
class RxClusterDefinition RxClPS2uv; // size: 0x10, address: 0x5DB1A0
class RxClusterDefinition RxClPS2xyz; // size: 0x10, address: 0x5DB180
...
class RwMatrixTag sm_matrix; // size: 0x40, address: 0x657EE0
class RwCamera * ShadowCamera; // size: 0x4, address: 0x608B40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2570 -> 0x001F2678
*/
// Range: 0x1F2570 -> 0x1F2678
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2680 -> 0x001F2830
*/
// Range: 0x1F2680 -> 0x1F2830
static class RxPipeline * ShadowMapCreateMaterialPipeline() {
    /* anonymous block */ {
        // Range: 0x1F2680 -> 0x1F2830
        class RxPipeline * pipe; // r16
        class RxPipeline * lpipe; // r17
        class RxNodeDefinition * ps2allmat; // r19
        class RxPipelineNode * plnode; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2830 -> 0x001F2ECC
*/
// Range: 0x1F2830 -> 0x1F2ECC
static signed int ShadowMapBridgeCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1F2830 -> 0x1F2ECC
        signed int skyAlphaTex'345; // r2
        __int128 * _rwDMAPktPtr'344; // r3
        unsigned int skyUserSwitch1'343; // r4
        unsigned int numInitialQW; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F3070 -> 0x001F31B4
*/
// Range: 0x1F3070 -> 0x1F31B4
...
static signed int ShadowMapObjectSetupCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r18 */, class RwMatrixTag * * transform /* r17 */) {
    /* anonymous block */ {
        ...
        class rwPS2AllResEntryHeader * ps2AllResHeader; // r2
        class RpInterpolator * interpolator; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F3610 -> 0x001F3714
*/
// Range: 0x1F3610 -> 0x1F3714
