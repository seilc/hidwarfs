/*
    Compile unit: C:\TestBuild\in\Core\p2\iPad.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class basic_rect screen_bounds; // size: 0x10, address: 0x5E66F0
static class basic_rect default_adjust; // size: 0x10, address: 0x0
static unsigned char mReadData[32]; // size: 0x20, address: 0x61E0C0
static __int128 mPadDmaBuffer[4][16]; // size: 0x400, address: 0x61E100
static unsigned char mActDirect[6]; // size: 0x6, address: 0x6088F0
static unsigned char mActAlign[6]; // size: 0x6, address: 0x6088F8
static float mLargeMotor[4]; // size: 0x10, address: 0x61E500
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166260 -> 0x00166900
*/
// Range: 0x166260 -> 0x166900
void iPadDebugRender() {
    /* anonymous block */ {
        ...
        class xtextbox tb; // @ 0x0061E510
        signed char @4117; // @ 0x00608900
        char trc_state_strings[11][33]; // @ 0x005063D0
        char state_strings[4][16]; // @ 0x00506390
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166900 -> 0x00166928
*/
// Range: 0x166900 -> 0x166928
void iPadKill() {
    /* anonymous block */ {
        // Range: 0x166900 -> 0x166928
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166930 -> 0x00166AB0
*/
// Range: 0x166930 -> 0x166AB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166AB0 -> 0x00166ACC
*/
// Range: 0x166AB0 -> 0x166ACC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166AD0 -> 0x00166F08
*/
// Range: 0x166AD0 -> 0x166F08
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00166F10 -> 0x00167034
*/
// Range: 0x166F10 -> 0x167034
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00167040 -> 0x001670A4
*/
// Range: 0x167040 -> 0x1670A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001670B0 -> 0x00167438
*/
// Range: 0x1670B0 -> 0x167438
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00167440 -> 0x00167484
*/
// Range: 0x167440 -> 0x167484
signed int iPadInit() {
    /* anonymous block */ {
        // Range: 0x167440 -> 0x167484
    }
