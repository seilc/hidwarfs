/*
    Compile unit: C:\TestBuild\in\Core\x\xFXCameraTexture.cpp
...
enum blend_mode {
    BLEND_INVALID = -1,
    BLEND_AVERAGE = 0,
    BLEND_AVERAGE_FIXED = 1,
    BLEND_RAVERAGE = 2,
    BLEND_RAVERAGE_FIXED = 3,
    BLEND_ADDITIVE = 4,
    BLEND_ADDITIVE_FIXED = 5,
    BLEND_ADDITIVE_SCALE_FIXED = 6,
    BLEND_COPY = 7,
    BLEND_COPY_FIXED = 8,
    BLEND_SUBTRACT = 9,
    BLEND_SUBTRACT_FIXED = 10,
    BLEND_SUBTRACT_SCALE_FIXED = 11,
    MAX_BLEND = 12,
};
// total size: 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B420 -> 0x0041B998
*/
// Range: 0x41B420 -> 0x41B998
// this: r20
void xFXFastRaster::blit_scaled(float u /* r21 */, float v /* r20 */, class _xFColor & color /* r21 */) {
    /* anonymous block */ {
        // Range: 0x41B420 -> 0x41B998
        float one'270; // r6
        signed int min_dst_strips; // r2
        signed int min_src_strips; // r2
        unsigned int msb; // r29+0xCC
        unsigned int lsb; // r29+0xC8
        unsigned long stex0; // r2
        signed int swidthpow; // r2
        signed int sheightpow; // r2
        signed int qwords_used; // r22
        signed int actual_endx; // r2
        signed int dx; // r2
        signed int endx; // r2
        __int128 * pkt; // r8
        float one; // r29+0xC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041B9A0 -> 0x0041BAF8
*/
// Range: 0x41B9A0 -> 0x41BAF8
// this: r2
void xFXFastRaster::blit_scaled(float u /* r29+0x30 */, float v /* r29+0x30 */, class xColor_tag color /* r29+0x1C */) {
    /* anonymous block */ {
        // Range: 0x41B9A0 -> 0x41BAF8
        class _xFColor fcolor; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041BB00 -> 0x0041C260
*/
// Range: 0x41BB00 -> 0x41C260
// this: r2
void xFXFastRaster::blit(class xFRect & dst_rect /* r29+0x104 */, class xFRect & src_rect /* r20 */, class _xFColor & color /* r21 */, float z /* r20 */) {
    /* anonymous block */ {
        // Range: 0x41BB00 -> 0x41C260
        float one'352; // r8
        signed int dst_x; // r19
        signed int dst_w; // r2
        signed int dst_y; // r2
        signed int dst_h; // r2
        signed int strip_shift; // r3
        signed int strip_width; // r18
        signed int strip_mask; // r2
        signed int src_width; // r2
        signed int shrinkify; // r8
        signed int sw; // r5
        signed int maxsw; // r2
        signed int left_width; // r2
        signed int right_width; // r30
        signed int center_width; // r2
        signed int center_strips; // r17
        signed int left_strips; // r29+0xF0
        signed int right_strips; // r16
        unsigned int msb; // r29+0x11C
        unsigned int lsb; // r29+0x118
        unsigned long stex0; // r2
        signed int swidthpow; // r2
        signed int sheightpow; // r2
        signed int qwords_used; // r2
        __int128 * pkt; // r12
        float one; // r29+0x114
        signed int r; // r7
        signed int g; // r6
        ...
        signed int a; // r4
        signed int y1; // r2
        float uscale; // r29+0x120
        float vscale; // r29+0x120
        float s0; // r29+0x120
        float s1; // r6
        float t0; // r29+0x110
        float t1; // r29+0x10C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041C260 -> 0x0041C5BC
*/
// Range: 0x41C260 -> 0x41C5BC
void clear_z(class RwRaster * dst /* r20 */, unsigned int value /* r19 */) {
    /* anonymous block */ {
        // Range: 0x41C260 -> 0x41C5BC
        class sceGsZbuf & zbuf; // r2
        signed int byte_depth; // r18
        signed int buffer_size; // r2
        signed int pages; // r2
        signed int total_ysize; // r2
        signed int strips; // r4
        signed int ysize; // r2
        signed int total_xsize; // r2
        unsigned char dithering; // r2
        signed int qwords_used; // r17
        __int128 * pkt; // r4
        signed int y1; // r2
        signed int x; // r10
        signed int endx; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041C5C0 -> 0x0041C880
*/
// Range: 0x41C5C0 -> 0x41C880
void fill(class RwRect & rect /* r20 */, class xColor_tag color /* r29+0xAC */, float z /* r20 */) {
    /* anonymous block */ {
        // Range: 0x41C5C0 -> 0x41C880
        signed int strips; // r2
        signed int qwords_used; // r19
        signed int actual_endx; // r18
        signed int dx; // r17
        signed int endx; // r2
        __int128 * pkt; // r8
        signed int y0; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041C880 -> 0x0041C89C
*/
// Range: 0x41C880 -> 0x41C89C
// this: r2
void xFXFastRaster::fill(class xColor_tag color /* r29+0x1C */, unsigned char alpha_blend /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41C880 -> 0x41C89C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041C8A0 -> 0x0041CABC
*/
// Range: 0x41C8A0 -> 0x41CABC
void fill(class RwRaster * dst /* r20 */, class xColor_tag color /* r29+0xAC */, unsigned char alpha_blend /* r21 */) {
    /* anonymous block */ {
        // Range: 0x41C8A0 -> 0x41CABC
        signed int strips; // r2
        signed int qwords_used; // r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CAC0 -> 0x0041CB7C
*/
// Range: 0x41CAC0 -> 0x41CB7C
void set_scissor(signed int scax0 /* r19 */, signed int scax1 /* r18 */, signed int scay0 /* r17 */, signed int scay1 /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41CAC0 -> 0x41CB7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CB80 -> 0x0041CC34
*/
// Range: 0x41CB80 -> 0x41CC34
void set_clamp(signed int wms /* r2 */, signed int wmt /* r2 */, signed int minu /* r2 */, signed int maxu /* r2 */, signed int minv /* r2 */, signed int maxv /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41CB80 -> 0x41CC34
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CC40 -> 0x0041CCC4
*/
// Range: 0x41CC40 -> 0x41CCC4
void set_prmode(unsigned char prmodecont /* r17 */, unsigned int prmode /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41CC40 -> 0x41CCC4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CCD0 -> 0x0041CD70
*/
// Range: 0x41CCD0 -> 0x41CD70
void set_texa(signed int ta0 /* r18 */, signed int aem /* r17 */, signed int ta1 /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41CCD0 -> 0x41CD70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CD70 -> 0x0041CDF8
*/
// Range: 0x41CD70 -> 0x41CDF8
void set_blend_mode(enum blend_mode mode /* r2 */, float fixed_alpha /* r29 */) {
    /* anonymous block */ {
        // Range: 0x41CD70 -> 0x41CDF8
        signed int func[12]; // @ 0x005F9660
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CE00 -> 0x0041CE68
*/
// Range: 0x41CE00 -> 0x41CE68
void set_test(unsigned int test /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41CE00 -> 0x41CE68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CE70 -> 0x0041CE94
*/
// Range: 0x41CE70 -> 0x41CE94
unsigned int get_full_blend_mode() {
    /* anonymous block */ {
        // Range: 0x41CE70 -> 0x41CE94
        unsigned int full_mode; // r29+0x1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CEA0 -> 0x0041CEAC
*/
// Range: 0x41CEA0 -> 0x41CEAC
void set_full_blend_mode(unsigned int full_mode /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41CEA0 -> 0x41CEAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CEB0 -> 0x0041CF08
*/
// Range: 0x41CEB0 -> 0x41CF08
void texflush() {
    /* anonymous block */ {
        // Range: 0x41CEB0 -> 0x41CF08
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CF10 -> 0x0041CFDC
*/
// Range: 0x41CF10 -> 0x41CFDC
void set_blend_mode_cached(enum blend_mode mode /* r2 */, float fixed_alpha /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x41CF10 -> 0x41CFDC
        unsigned int old_reg; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041CFE0 -> 0x0041D04C
*/
// Range: 0x41CFE0 -> 0x41D04C
// this: r2
void xFXFastRaster::set_test_cached(unsigned int test /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41CFE0 -> 0x41D04C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D050 -> 0x0041D178
*/
// Range: 0x41D050 -> 0x41D178
// this: r2
void xFXFastRaster::set_destination(class RwRaster * dst /* r20 */, unsigned int fbmsk /* r19 */) {
    /* anonymous block */ {
        // Range: 0x41D050 -> 0x41D178
        unsigned int msb; // r29+0x6C
        unsigned int lsb; // r29+0x68
        unsigned int daddr; // r2
        unsigned int dwidth; // r2
        unsigned int dformat; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D180 -> 0x0041D304
*/
// Range: 0x41D180 -> 0x41D304
// this: r2
void xFXFastRaster::set_source(class RwRaster * src /* r16 */, enum tcc_type tcc /* r20 */, enum tfx_type tfx /* r19 */, enum filter_type filter /* r18 */) {
    /* anonymous block */ {
        // Range: 0x41D180 -> 0x41D304
        unsigned int msb; // r29+0x6C
        unsigned int lsb; // r29+0x68
        unsigned long stex0; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D310 -> 0x0041D494
*/
// Range: 0x41D310 -> 0x41D494
// this: r20
void xFXFastRaster::end_render() {
    /* anonymous block */ {
        // Range: 0x41D310 -> 0x41D494
        unsigned int oldtest; // r2
        class RwCamera * cam; // r3
        signed int qwords_used; // r19
        __int128 * pkt; // r9
        unsigned int alpha_1; // r29+0x6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D4A0 -> 0x0041D534
*/
// Range: 0x41D4A0 -> 0x41D534
// this: r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D540 -> 0x0041D67C
*/
// Range: 0x41D540 -> 0x41D67C
unsigned char clip_rect(class xFRect & dst_rect /* r17 */, class RwRaster * dst_raster /* r2 */, class xFRect & src_rect /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41D540 -> 0x41D67C
        float oldx; // r29+0x40
        float oldw; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D680 -> 0x0041D83C
*/
// Range: 0x41D680 -> 0x41D83C
unsigned char clip_rect(class xFRect & dst_rect /* r2 */, class RwRaster * dst_raster /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41D680 -> 0x41D83C
        signed int width; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D840 -> 0x0041D8AC
*/
// Range: 0x41D840 -> 0x41D8AC
void zbuffer_unmap() {
    /* anonymous block */ {
        // Range: 0x41D840 -> 0x41D8AC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041D8B0 -> 0x0041DC10
*/
// Range: 0x41D8B0 -> 0x41DC10
// this: r20
void xFXCameraTexture::zbuffer_map_and_clear(class RwRaster * fraster /* r19 */, class RwRaster * zraster /* r18 */, unsigned int fbmsk /* r21 */, signed int clear_flags /* r22 */) {
    /* anonymous block */ {
        // Range: 0x41D8B0 -> 0x41DC10
        signed int width; // r2
        signed int height; // r2
        unsigned int fmsb; // r29+0xDC
        unsigned int flsb; // r29+0xD8
        unsigned int faddr; // r2
        unsigned int fwidth; // r2
        unsigned int fformat; // r17
        unsigned int zmsb; // r29+0xD4
        unsigned int zlsb; // r29+0xD0
        unsigned int zaddr; // r2
        unsigned int zformat; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041DC10 -> 0x0041DDF8
*/
// Range: 0x41DC10 -> 0x41DDF8
// this: r18
void xFXCameraTexture::shrink_to_fit(signed int w /* r2 */, signed int h /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41DC10 -> 0x41DDF8
        unsigned int msb; // r29+0x4C
        unsigned int lsb; // r29+0x48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041DE00 -> 0x0041DF94
*/
// Range: 0x41DE00 -> 0x41DF94
void get_subview(class xMat4x3 & view_mat /* r2 */, class RwCamera * src_cam /* r2 */, class xFRect & src_rect /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41DE00 -> 0x41DF94
        class xMat4x3 ltm; // r29+0x10
        class xVec2 view_window; // r29+0x58
        class xVec2 view_offset; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041DFA0 -> 0x0041E150
*/
// Range: 0x41DFA0 -> 0x41E150
// this: r2
void xFXCameraTexture::get_subview(class xMat4x3 & ltm /* r2 */, class xVec2 & view_window /* r2 */, class xVec2 & view_offset /* r2 */, class RwCamera * src_cam /* r2 */, class xFRect & src_rect /* r2 */, class xFRect & dst_rect /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41DFA0 -> 0x41E150
        class RwRaster * src_raster; // r2
        class xMat4x3 & src_ltm; // r2
        class xVec2 & src_view_window; // r2
        class xVec2 & src_view_offset; // r2
        float src_iwidth; // r29
        float src_iheight; // r29
        float dst_iwidth; // r29
        float dst_iheight; // r29
        float rw; // r29
        float rh; // r29
        float mx; // r29
        float my; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E150 -> 0x0041E264
*/
// Range: 0x41E150 -> 0x41E264
void create_view_matrix(class xMat4x3 & view_mat /* r2 */, class xMat4x3 & ltm /* r2 */, class xVec2 & view_window /* r2 */, class xVec2 & view_offset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41E150 -> 0x41E264
        float ascale; // r29
        float bscale; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E270 -> 0x0041E330
*/
// Range: 0x41E270 -> 0x41E330
// this: r19
void xFXCameraTexture::setup_subview(class RwCamera * src_cam /* r18 */, class xFRect & src_rect /* r17 */, class xFRect & dst_rect /* r16 */) {
    /* anonymous block */ {
        // Range: 0x41E270 -> 0x41E330
        class xMat4x3 ltm; // r29+0x50
        class xVec2 view_window; // r29+0x98
        class xVec2 view_offset; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E330 -> 0x0041E400
*/
// Range: 0x41E330 -> 0x41E400
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E400 -> 0x0041E7A0
*/
// Range: 0x41E400 -> 0x41E7A0
// this: r19
void xFXCameraTexture::begin_render(signed int clear_flags /* r18 */, unsigned int fbmsk_write /* r17 */, unsigned int fbmsk_finish /* r16 */, float near_plane /* r21 */, float far_plane /* r20 */) {
    /* anonymous block */ {
        // Range: 0x41E400 -> 0x41E7A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E7A0 -> 0x0041E86C
*/
// Range: 0x41E7A0 -> 0x41E86C
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041E870 -> 0x0041EB88
*/
// Range: 0x41E870 -> 0x41EB88
// this: r20
unsigned char xFXCameraTexture::create(signed int w /* r19 */, signed int h /* r18 */, unsigned char need_zwrite /* r17 */, signed int bpp /* r21 */, signed int zbpp /* r22 */) {
    /* anonymous block */ {
        // Range: 0x41E870 -> 0x41EB88
        class RwBBox bbox; // r29+0x80
        class RwV2d vw; // r29+0x98
    }
}
