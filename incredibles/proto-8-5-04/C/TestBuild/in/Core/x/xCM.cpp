/*
    Compile unit: C:\TestBuild\in\Core\x\xCM.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class basic_rect screen_bounds; // size: 0x10, address: 0x5EC4A0
static class basic_rect default_adjust; // size: 0x10, address: 0x0
static char * KEY; // size: 0x4, address: 0x607A64
static float destX; // size: 0x4, address: 0x608E70
static float destY; // size: 0x4, address: 0x608E74
static float destWidth; // size: 0x4, address: 0x607A68
static float destHeight; // size: 0x4, address: 0x607A6C
static char * preset_names[5]; // size: 0x14, address: 0x0
float dtscale; // size: 0x4, address: 0x607A70
static float credits_time; // size: 0x4, address: 0x607A74
static class xCreditsData * credits_data; // size: 0x4, address: 0x608E78
static unsigned int credits_parentID; // size: 0x4, address: 0x608E7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C310 -> 0x0026C324
*/
// Range: 0x26C310 -> 0x26C324
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C330 -> 0x0026C370
*/
// Range: 0x26C330 -> 0x26C370
void xCMstop() {
    /* anonymous block */ {
        // Range: 0x26C330 -> 0x26C370
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C370 -> 0x0026C408
*/
// Range: 0x26C370 -> 0x26C408
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C410 -> 0x0026C41C
*/
// Range: 0x26C410 -> 0x26C41C
void xCMrender() {
    /* anonymous block */ {
        // Range: 0x26C410 -> 0x26C41C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C420 -> 0x0026C514
*/
// Range: 0x26C420 -> 0x26C514
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026C520 -> 0x0026E728
*/
// Range: 0x26C520 -> 0x26E728
static unsigned int xCMrender(float time /* r27 */, class xCreditsData * data /* r30 */) {
    /* anonymous block */ {
        // Range: 0x26C520 -> 0x26E728
        class xCMheader * hdr; // r2
        char * dp; // r18
        ...
        float y1; // r29+0x830
        float ca; // r24
        class xCMtexture * tex; // r20
        class xColor_tag color; // r29+0x82C
        class basic_rect bounds; // r29+0x7D0
        class xtextbox tb; // r29+0x750
        class xColor_tag color; // r29+0x828
        class basic_rect bounds; // r29+0x740
        class xtextbox tb; // r29+0x6C0
        unsigned int alignL; // r2
        unsigned int alignR; // r20
        class xColor_tag colorL; // r29+0x824
        class basic_rect bounds; // r29+0x6B0
        class xtextbox tb; // r29+0x630
        class xColor_tag colorR; // r29+0x820
        class basic_rect bounds; // r29+0x620
        class xtextbox tb; // r29+0x5A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026E730 -> 0x0026E91C
*/
// Range: 0x26E730 -> 0x26E91C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0026E920 -> 0x0026EB30
*/
// Range: 0x26E920 -> 0x26EB30
