/*
    Compile unit: C:\TestBuild\in\Core\x\xEnt.cpp
...
static float nsn_angle; // size: 0x4, address: 0x607760
static class xBox all_ents_box; // size: 0x18, address: 0x627B30
static signed int all_ents_box_init; // size: 0x4, address: 0x6089B8
static signed int setMaterialTextureRestore; // size: 0x4, address: 0x6089BC
...
signed int xent_entent; // size: 0x4, address: 0x6089C4
...
class xEnt * xEntCollCheckOneEntNoDepen(class xEnt *, class xScene *, void *); // size: 0x0, address: 0x180230
class zGlobals globals; // size: 0x640, address: 0x61C210
class xMat4x3 g_I3; // size: 0x40, address: 0x643E60
void stacked_owner_destroyed(class zDestructible *, void *); // size: 0x0, address: 0x1833D0
...
void xEntRender(class xEnt *); // size: 0x0, address: 0x1822B0
void xEntUpdate(class xEnt *, class xScene *, float); // size: 0x0, address: 0x181FD0
void xEntDefaultTranslate(class xEnt *, class xVec3 *, class xMat4x3 *); // size: 0x0, address: 0x1818E0
void xEntDefaultBoundUpdate(class xEnt *, class xVec3 *); // size: 0x0, address: 0x181A50
// total size: 0xF0
class xEntFrame {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F2F0 -> 0x0017F2F8
*/
// Range: 0x17F2F0 -> 0x17F2F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F300 -> 0x0017F308
*/
// Range: 0x17F300 -> 0x17F308
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F310 -> 0x0017F420
*/
// Range: 0x17F310 -> 0x17F420
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F420 -> 0x0017F42C
*/
// Range: 0x17F420 -> 0x17F42C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F430 -> 0x0017F5F4
*/
// Range: 0x17F430 -> 0x17F5F4
unsigned char xEntTurnToFace(class xEnt * ent /* r16 */, class xVec3 * target /* r17 */, float speedLimit /* r22 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x17F430 -> 0x17F5F4
        class xVec3 currentFacing; // r29+0x50
        class xVec3 axis; // r29+0x40
        float angle; // r29+0x60
        float maxAngle; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F600 -> 0x0017F66C
*/
// Range: 0x17F600 -> 0x17F66C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F670 -> 0x0017F71C
*/
// Range: 0x17F670 -> 0x17F71C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F720 -> 0x0017F72C
*/
// Range: 0x17F720 -> 0x17F72C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017F730 -> 0x0017FB68
*/
// Range: 0x17F730 -> 0x17FB68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017FB70 -> 0x0017FDEC
*/
// Range: 0x17FB70 -> 0x17FDEC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017FDF0 -> 0x00180230
*/
// Range: 0x17FDF0 -> 0x180230
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00180230 -> 0x00180754
*/
// Range: 0x180230 -> 0x180754
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00180760 -> 0x00180B18
*/
// Range: 0x180760 -> 0x180B18
static void xEntCollCheckOneGrid(class xEnt * p /* r20 */, class xScene * sc /* r19 */, class xEnt * (* hitIt)(class xEnt *, class xScene *, void *) /* r21 */, class xGrid * grid /* r23 */) {
    /* anonymous block */ {
        // Range: 0x180760 -> 0x180B18
        ...
        float clcenterx; // r29+0xC0
        float clcenterz; // r2
        signed int i; // r18
        signed int offs[4][3][2]; // @ 0x00506750
        signed int k; // @ 0x006089C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00180B20 -> 0x00180C58
*/
// Range: 0x180B20 -> 0x180C58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00180C60 -> 0x00180FF4
*/
// Range: 0x180C60 -> 0x180FF4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181000 -> 0x001812BC
*/
// Range: 0x181000 -> 0x1812BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001812C0 -> 0x00181618
*/
// Range: 0x1812C0 -> 0x181618
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181620 -> 0x001818D8
*/
// Range: 0x181620 -> 0x1818D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001818E0 -> 0x00181A4C
*/
// Range: 0x1818E0 -> 0x181A4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181A50 -> 0x00181AD0
*/
// Range: 0x181A50 -> 0x181AD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181AD0 -> 0x00181E90
*/
// Range: 0x181AD0 -> 0x181E90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181E90 -> 0x00181FC4
*/
// Range: 0x181E90 -> 0x181FC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00181FD0 -> 0x001822A4
*/
// Range: 0x181FD0 -> 0x1822A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001822B0 -> 0x00182418
*/
// Range: 0x1822B0 -> 0x182418
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182420 -> 0x00182454
*/
// Range: 0x182420 -> 0x182454
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182460 -> 0x00182494
*/
// Range: 0x182460 -> 0x182494
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001824A0 -> 0x0018262C
*/
// Range: 0x1824A0 -> 0x18262C
void xEntSetupPipeline(class xSurface * surf /* r2 */, class RpAtomic * model /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1824A0 -> 0x18262C
        signed int setPipeline; // r18
        class zSurfaceProps * pp; // r17
        class RwTexture * texptr; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182630 -> 0x0018263C
*/
// Range: 0x182630 -> 0x18263C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182640 -> 0x001826EC
*/
// Range: 0x182640 -> 0x1826EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001826F0 -> 0x00182C68
*/
// Range: 0x1826F0 -> 0x182C68
void xEntReset(class xEnt * ent /* r16 */) {
    /* anonymous block */ {
        ...
        unsigned int receive_models[15]; // @ 0x00506710
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182C70 -> 0x00182D04
*/
// Range: 0x182C70 -> 0x182D04
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182D10 -> 0x00182D6C
*/
// Range: 0x182D10 -> 0x182D6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00182D70 -> 0x0018306C
*/
// Range: 0x182D70 -> 0x18306C
void xEntSetup(class xEnt * ent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x182D70 -> 0x18306C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183070 -> 0x0018307C
*/
// Range: 0x183070 -> 0x18307C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183080 -> 0x001830F8
*/
// Range: 0x183080 -> 0x1830F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183100 -> 0x001833C8
*/
// Range: 0x183100 -> 0x1833C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001833D0 -> 0x001833D8
*/
// Range: 0x1833D0 -> 0x1833D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001833E0 -> 0x00183728
*/
// Range: 0x1833E0 -> 0x183728
static unsigned char collide_downward(class xVec3 & loc /* r20 */, class xEnt * & hit /* r30 */, class xScene & s /* r16 */, class xEnt & ent /* r19 */, float max_dist /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1833E0 -> 0x183728
        class xRay3 ray; // r29+0x1B0
        unsigned char old_bound_type; // r2
        float old_bound_radius; // r29+0x1E0
        class xCollis coll; // r29+0x150
        class xSphere * spheres[5]; // r29+0x130
        signed int count; // r2
        signed int i; // r18
        class xBound b; // r29+0xE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183730 -> 0x00183938
*/
// Range: 0x183730 -> 0x183938
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183940 -> 0x0018398C
*/
// Range: 0x183940 -> 0x18398C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183990 -> 0x00183A9C
*/
// Range: 0x183990 -> 0x183A9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183AA0 -> 0x00183BF0
*/
// Range: 0x183AA0 -> 0x183BF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183BF0 -> 0x00183BF8
*/
// Range: 0x183BF0 -> 0x183BF8
void xEntSceneExit() {
    /* anonymous block */ {
        // Range: 0x183BF0 -> 0x183BF8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183C00 -> 0x00183C0C
*/
// Range: 0x183C00 -> 0x183C0C
void xEntSceneInit() {
    /* anonymous block */ {
        // Range: 0x183C00 -> 0x183C0C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00183C10 -> 0x0018407C
*/
// Range: 0x183C10 -> 0x18407C
