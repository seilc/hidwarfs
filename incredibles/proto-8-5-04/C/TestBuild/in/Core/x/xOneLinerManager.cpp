/*
    Compile unit: C:\TestBuild\in\Core\x\xOneLinerManager.cpp
...
signed int compare(void *, void *); // size: 0x0, address: 0x2970C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00296730 -> 0x00296B70
*/
// Range: 0x296730 -> 0x296B70
// this: r20
void xOneLinerManager::PlayAudio() {
    /* anonymous block */ {
        // Range: 0x296730 -> 0x296B70
        float currentTime; // r21
        float fTimeSinceLastUpdate; // r20
        signed int i; // r19
        unsigned char bPlay; // r2
        float currentTime; // r29+0x80
        signed int playEventType; // r2
        signed int typeIndex; // r8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00296B70 -> 0x00296EA8
*/
// Range: 0x296B70 -> 0x296EA8
// this: r21
void xOneLinerManager::Inform(signed int event /* r20 */, void * pEventSpecific /* r22 */, float fOverrideDuration /* r20 */) {
    /* anonymous block */ {
        // Range: 0x296B70 -> 0x296EA8
        signed int lowerIndex; // r8
        signed int upperIndex; // r7
        signed int thisIndex; // r19
        signed int i; // r2
        float fDuration; // r21
        float currentTime; // r21
        unsigned char bPlay; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00296EB0 -> 0x002970BC
*/
// Range: 0x296EB0 -> 0x2970BC
// this: r16
void xOneLinerManager::Init(unsigned short eventCount /* r2 */) {
    /* anonymous block */ {
        // Range: 0x296EB0 -> 0x2970BC
        signed int count; // r2
        signed int i; // r18
        ...
        signed int i; // r21
        char * buffer; // r20
        class xOneLinerAsset * pAsset; // r2
        class xOneLiner * pLiner; // r19
        unsigned int j; // r18
        unsigned int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002970C0 -> 0x002970E4
*/
// Range: 0x2970C0 -> 0x2970E4
static signed int compare(void * p1 /* r2 */, void * p2 /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2970C0 -> 0x2970E4
    }
}
