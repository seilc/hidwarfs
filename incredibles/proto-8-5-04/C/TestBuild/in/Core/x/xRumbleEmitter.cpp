/*
    Compile unit: C:\TestBuild\in\Core\x\xRumbleEmitter.cpp
...
// total size: 0x14
struct /* @anon0 */ {} xRumble::sphericalEmitter::__vtable; // size: 0x14, address: 0x601840
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
void emitter_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2C4420
// total size: 0x10
struct /* @anon3 */ {} xRumble::emitterBase::__vtable; // size: 0x10, address: 0x0
// total size: 0x10
struct /* @anon2 */ {} xRumble::boxEmitter::__vtable; // size: 0x10, address: 0x601870
// total size: 0x10
struct /* @anon1 */ {} xRumble::effect::__vtable; // size: 0x10, address: 0x601860
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3EA0 -> 0x002C3EC0
*/
// Range: 0x2C3EA0 -> 0x2C3EC0
// this: r2
void sphericalEmitter::UpdatePosition(class xVec3 & playerPos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C3EA0 -> 0x2C3EC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3EC0 -> 0x002C4000
*/
// Range: 0x2C3EC0 -> 0x2C4000
// this: r2
unsigned char sphericalEmitter::GetIntensity(class xVec3 & playerPos /* r2 */, float & intensity /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C3EC0 -> 0x2C4000
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C4000 -> 0x002C406C
*/
// Range: 0x2C4000 -> 0x2C406C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C4070 -> 0x002C4198
*/
// Range: 0x2C4070 -> 0x2C4198
// this: r2
unsigned char boxEmitter::GetIntensity(class xVec3 & playerPos /* r2 */, float & intensity /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C4070 -> 0x2C4198
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C41A0 -> 0x002C4200
*/
// Range: 0x2C41A0 -> 0x2C4200
void Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2C41A0 -> 0x2C4200
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C4200 -> 0x002C4250
*/
// Range: 0x2C4200 -> 0x2C4250
void Init(class xBase & data /* r17 */, class xDynAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2C4200 -> 0x2C4250
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C4250 -> 0x002C441C
*/
// Range: 0x2C4250 -> 0x2C441C
// this: r2
float effectAsset::GetIntensity(float currentTime /* r29+0x10 */, float totalTime /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x2C4250 -> 0x2C441C
        float pulsePeriod; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C4420 -> 0x002C4538
*/
// Range: 0x2C4420 -> 0x2C4538
static void emitter_EventCB(class xBase * to /* r16 */, unsigned int toEvent /* r2 */, float * toParam /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2C4420 -> 0x2C4538
    }
}
