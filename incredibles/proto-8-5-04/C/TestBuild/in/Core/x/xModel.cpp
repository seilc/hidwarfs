/*
    Compile unit: C:\TestBuild\in\Core\x\xModel.cpp
...
static class xModelPool * sxModelPoolList; // size: 0x4, address: 0x608A6C
static class RwCamera * subcamera; // size: 0x4, address: 0x608A70
signed int xModelPipeNumTables; // size: 0x4, address: 0x608A74
signed int xModelPipeCount[16]; // size: 0x40, address: 0x648290
class xModelPipeTable * xModelPipeData[16]; // size: 0x40, address: 0x6482D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A27E0 -> 0x001A28BC
*/
// Range: 0x1A27E0 -> 0x1A28BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A28C0 -> 0x001A296C
*/
// Range: 0x1A28C0 -> 0x1A296C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2970 -> 0x001A2A84
*/
// Range: 0x1A2970 -> 0x1A2A84
void xModelCloneAtomic(class RpAtomic * * out /* r16 */, signed int out_size /* r19 */, class RpAtomic * in /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1A2970 -> 0x1A2A84
        class RwMemory rwmem; // r29+0x58
        class RwStream * ostream; // r17
        class RpAtomic * * end_out; // r2
        class RwStream * istream; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2A90 -> 0x001A2AD0
*/
// Range: 0x1A2A90 -> 0x1A2AD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2AD0 -> 0x001A2B58
*/
// Range: 0x1A2AD0 -> 0x1A2B58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2B60 -> 0x001A2C4C
*/
// Range: 0x1A2B60 -> 0x1A2C4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2C50 -> 0x001A2CA8
*/
// Range: 0x1A2C50 -> 0x1A2CA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2CB0 -> 0x001A2E80
*/
// Range: 0x1A2CB0 -> 0x1A2E80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2E80 -> 0x001A2F84
*/
// Range: 0x1A2E80 -> 0x1A2F84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2F90 -> 0x001A30C0
*/
// Range: 0x1A2F90 -> 0x1A30C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A30C0 -> 0x001A30EC
*/
// Range: 0x1A30C0 -> 0x1A30EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A30F0 -> 0x001A3254
*/
// Range: 0x1A30F0 -> 0x1A3254
void xModelGetBoneMatScaled(class xMat4x3 & mat /* r2 */, class xModelInstance & model /* r2 */, unsigned int index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A30F0 -> 0x1A3254
        class xMat4x3 temp_mat; // r29+0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3260 -> 0x001A3398
*/
// Range: 0x1A3260 -> 0x1A3398
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A33A0 -> 0x001A3458
*/
// Range: 0x1A33A0 -> 0x1A3458
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3460 -> 0x001A34F8
*/
// Range: 0x1A3460 -> 0x1A34F8
void xModelGetBoneMat(class xMat3x3 & mat /* r2 */, class xModelInstance & model /* r2 */, unsigned int index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3460 -> 0x1A34F8
        class xMat3x3 & root_mat; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3500 -> 0x001A3588
*/
// Range: 0x1A3500 -> 0x1A3588
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3590 -> 0x001A3764
*/
// Range: 0x1A3590 -> 0x1A3764
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3770 -> 0x001A37E4
*/
// Range: 0x1A3770 -> 0x1A37E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A37F0 -> 0x001A37F8
*/
// Range: 0x1A37F0 -> 0x1A37F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3800 -> 0x001A3808
*/
// Range: 0x1A3800 -> 0x1A3808
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3810 -> 0x001A3898
*/
// Range: 0x1A3810 -> 0x1A3898
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A38A0 -> 0x001A3CCC
*/
// Range: 0x1A38A0 -> 0x1A3CCC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3CD0 -> 0x001A3D30
*/
// Range: 0x1A3CD0 -> 0x1A3D30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D30 -> 0x001A4074
*/
// Range: 0x1A3D30 -> 0x1A4074
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4080 -> 0x001A40DC
*/
// Range: 0x1A4080 -> 0x1A40DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4460 -> 0x001A44E4
*/
// Range: 0x1A4460 -> 0x1A44E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A44F0 -> 0x001A454C
*/
// Range: 0x1A44F0 -> 0x1A454C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4550 -> 0x001A463C
*/
// Range: 0x1A4550 -> 0x1A463C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4640 -> 0x001A4A14
*/
// Range: 0x1A4640 -> 0x1A4A14
class xModelInstance * xModelInstanceAllocReuse(class RpAtomic * data /* r20 */, void * object /* r22 */, unsigned short flags /* r19 */, unsigned char boneIndex /* r23 */, unsigned char * boneRemap /* r30 */, class xModelInstance * reuse_instance /* r18 */) {
    /* anonymous block */ {
        ...
        class xModelPipe zeroPipe; // @ 0x00608A88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4A20 -> 0x001A4A8C
*/
// Range: 0x1A4A20 -> 0x1A4A8C
unsigned char xModelInstanceAvailable(signed int bones /* r2 */, signed int need /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A4A20 -> 0x1A4A8C
        signed int mats; // r2
        class xModelPool * pool; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4A90 -> 0x001A4CCC
*/
// Range: 0x1A4A90 -> 0x1A4CCC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4CD0 -> 0x001A4DA8
*/
// Range: 0x1A4CD0 -> 0x1A4DA8
void xModelInitOnce() {
    /* anonymous block */ {
        // Range: 0x1A4CD0 -> 0x1A4DA8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4DB0 -> 0x001A4DD4
*/
// Range: 0x1A4DB0 -> 0x1A4DD4
void xModelInit() {
    /* anonymous block */ {
        // Range: 0x1A4DB0 -> 0x1A4DD4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A4DE0 -> 0x001A4E50
*/
// Range: 0x1A4DE0 -> 0x1A4E50
