/*
    Compile unit: C:\TestBuild\in\Core\x\xSndMgr.cpp
...
enum xSndEffect m_eCurrentEffect; // size: 0x4, address: 0x608EC8
static float s_fCategoryVolume[6]; // size: 0x18, address: 0x6858F0
static float s_fCategoryVolumeFade[6]; // size: 0x18, address: 0x685910
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297840 -> 0x00297920
*/
// Range: 0x297840 -> 0x297920
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297920 -> 0x00297928
*/
// Range: 0x297920 -> 0x297928
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297930 -> 0x002979E4
*/
// Range: 0x297930 -> 0x2979E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002979F0 -> 0x00297AA4
*/
// Range: 0x2979F0 -> 0x297AA4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297AB0 -> 0x00297BDC
*/
// Range: 0x297AB0 -> 0x297BDC
void xSndMgrStop(enum iSndHandle & hSound /* r2 */) {
    /* anonymous block */ {
        // Range: 0x297AB0 -> 0x297BDC
        enum iSndHandle hInHandle; // r2
        signed int i; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297BE0 -> 0x00297CA8
*/
// Range: 0x297BE0 -> 0x297CA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297CB0 -> 0x00297CE0
*/
// Range: 0x297CB0 -> 0x297CE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297CE0 -> 0x00297D38
*/
// Range: 0x297CE0 -> 0x297D38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297D40 -> 0x00297DB8
*/
// Range: 0x297D40 -> 0x297DB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00297DC0 -> 0x00298590
*/
// Range: 0x297DC0 -> 0x298590
enum iSndHandle xSndMgrPlay(enum iSndGroupHandle hSoundToPlay /* r16 */, unsigned int uFlags /* r17 */, class xVec3 * pPos_WS /* r20 */, class xVec3 * pVel /* r21 */, class xEnt * pParentEnt /* r19 */, float * pfOverrideVolume /* r30 */, float * pfOverridePitch /* r29+0xBC */) {
    /* anonymous block */ {
        // Range: 0x297DC0 -> 0x298590
        unsigned int uInfoIndex; // r2
        class xSndGroupInfo * pSndInfo; // r23
        unsigned int iFlags; // r18
        class iSndFileInfo * ip; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298590 -> 0x002985D4
*/
// Range: 0x298590 -> 0x2985D4
unsigned char xSndMgrGetPriority(enum iSndGroupHandle hSound /* r2 */, unsigned char bStreaming /* r2 */, unsigned char bLooping /* r2 */) {
    /* anonymous block */ {
        // Range: 0x298590 -> 0x2985D4
        unsigned int uPriority; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002985E0 -> 0x00298638
*/
// Range: 0x2985E0 -> 0x298638
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298640 -> 0x002986BC
*/
// Range: 0x298640 -> 0x2986BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002986C0 -> 0x002986F0
*/
// Range: 0x2986C0 -> 0x2986F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002986F0 -> 0x00298710
*/
// Range: 0x2986F0 -> 0x298710
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298710 -> 0x0029880C
*/
// Range: 0x298710 -> 0x29880C
void xSndMgrStopSounds(enum iSndGroupHandle hActiveSound /* r19 */) {
    /* anonymous block */ {
        // Range: 0x298710 -> 0x29880C
        signed int i; // r18
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298810 -> 0x002988A4
*/
// Range: 0x298810 -> 0x2988A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002988B0 -> 0x002988F4
*/
// Range: 0x2988B0 -> 0x2988F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298900 -> 0x00298970
*/
// Range: 0x298900 -> 0x298970
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298970 -> 0x00298DA4
*/
// Range: 0x298970 -> 0x298DA4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00298DB0 -> 0x00299058
*/
// Range: 0x298DB0 -> 0x299058
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00299060 -> 0x002990A8
*/
// Range: 0x299060 -> 0x2990A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002990B0 -> 0x002994A4
*/
// Range: 0x2990B0 -> 0x2994A4
void xSndMgrUpdate() {
    /* anonymous block */ {
        // Range: 0x2990B0 -> 0x2994A4
        unsigned int i; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002994B0 -> 0x00299598
*/
// Range: 0x2994B0 -> 0x299598
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002995A0 -> 0x002997A4
*/
// Range: 0x2995A0 -> 0x2997A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002997B0 -> 0x00299F44
*/
// Range: 0x2997B0 -> 0x299F44
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00299F50 -> 0x0029A120
*/
// Range: 0x299F50 -> 0x29A120
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A120 -> 0x0029A314
*/
// Range: 0x29A120 -> 0x29A314
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A320 -> 0x0029A328
*/
// Range: 0x29A320 -> 0x29A328
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A330 -> 0x0029A338
*/
// Range: 0x29A330 -> 0x29A338
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A340 -> 0x0029A4CC
*/
// Range: 0x29A340 -> 0x29A4CC
void xSndMgrInit() {
    /* anonymous block */ {
        // Range: 0x29A340 -> 0x29A4CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A4D0 -> 0x0029A644
*/
// Range: 0x29A4D0 -> 0x29A644
