/*
    Compile unit: C:\TestBuild\in\Core\x\xTimer.cpp
...
static unsigned int sPauseTimerHash[20]; // size: 0x50, address: 0x5086B0
class zGlobals globals; // size: 0x640, address: 0x61C210
void xTimerEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1CF920
// total size: 0x34
class RwRaster {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CF870 -> 0x001CF914
*/
// Range: 0x1CF870 -> 0x1CF914
void xTimerUpdate(class xBase * to /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CF870 -> 0x1CF914
        class xTimer * t; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CF920 -> 0x001CFAA8
*/
// Range: 0x1CF920 -> 0x1CFAA8
void xTimerEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1CF920 -> 0x1CFAA8
        class xTimer * t; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFAB0 -> 0x001CFAF8
*/
// Range: 0x1CFAB0 -> 0x1CFAF8
void xTimerLoad(class xTimer * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CFAB0 -> 0x1CFAF8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFB00 -> 0x001CFB48
*/
// Range: 0x1CFB00 -> 0x1CFB48
void xTimerSave(class xTimer * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CFB00 -> 0x1CFB48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFB50 -> 0x001CFC04
*/
// Range: 0x1CFB50 -> 0x1CFC04
static signed int xTimer_ObjIDIsPauseTimer(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1CFB50 -> 0x1CFC04
        signed int bar; // r2
        signed int i; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFC10 -> 0x001CFD34
*/
// Range: 0x1CFC10 -> 0x1CFD34
void xTimerInit(void * b /* r18 */, void * tasset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1CFC10 -> 0x1CFD34
    }
}
