/*
    Compile unit: C:\TestBuild\in\Core\x\xHudUnitMeter.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static float tweak_anim_time_delta; // size: 0x4, address: 0x607834
// total size: 0x28
struct /* @anon2 */ {} xhud::unit_meter_widget::__vtable; // size: 0x28, address: 0x5FD1A0
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC1A0 -> 0x001CC3F0
*/
// Range: 0x1CC1A0 -> 0x1CC3F0
// this: r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC3F0 -> 0x001CC5D4
*/
// Range: 0x1CC3F0 -> 0x1CC5D4
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC5E0 -> 0x001CC694
*/
// Range: 0x1CC5E0 -> 0x1CC694
// this: r2
void unit_meter_widget::setup() {
    /* anonymous block */ {
        // Range: 0x1CC5E0 -> 0x1CC694
        char tempString[128]; // r29+0x30
        signed int i; // r17
        char * modelName[2]; // r29+0xB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC6A0 -> 0x001CC718
*/
// Range: 0x1CC6A0 -> 0x1CC718
// this: r17
unsigned char unit_meter_widget::is(unsigned int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CC6A0 -> 0x1CC718
        signed char @4979; // @ 0x00608BE8
        unsigned int myid; // @ 0x00608BE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC720 -> 0x001CC760
*/
// Range: 0x1CC720 -> 0x1CC760
unsigned int type() {
    /* anonymous block */ {
        // Range: 0x1CC720 -> 0x1CC760
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC760 -> 0x001CC768
*/
// Range: 0x1CC760 -> 0x1CC768
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC770 -> 0x001CC8FC
*/
// Range: 0x1CC770 -> 0x1CC8FC
// this: r20
unit_meter_widget::unit_meter_widget(class unit_meter_asset & a /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1CC770 -> 0x1CC8FC
        signed int i; // r21
        signed int j; // r19
        unsigned char registered; // @ 0x00608BE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC900 -> 0x001CC948
*/
// Range: 0x1CC900 -> 0x1CC948
