/*
    Compile unit: C:\TestBuild\in\Core\x\xTRC.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class basic_rect screen_bounds; // size: 0x10, address: 0x5E7B10
...
class _tagTRCDiskInfo gTrcDisk; // size: 0x8, address: 0x608B88
unsigned int gInTRC; // size: 0x4, address: 0x0
static char * k_CONTROLLER_MISSING_MESSAGE; // size: 0x4, address: 0x608B90
static char * k_CONTROLLER_INVALID_MESSAGE; // size: 0x4, address: 0x608B94
static class xColor_tag yellow; // size: 0x4, address: 0x5E7B20
static char composed_message_text[256]; // size: 0x100, address: 0x66B4B0
static char * message_text; // size: 0x4, address: 0x608B9C
static unsigned int standalone; // size: 0x4, address: 0x608BA0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C0380 -> 0x001C0820
*/
// Range: 0x1C0380 -> 0x1C0820
void RenderText(char * text /* r2 */, unsigned char enabled /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1C0380 -> 0x1C0820
        class xColor_tag c2; // r29+0x15C
        class xtextbox tb; // @ 0x0066B5B0
        signed char @5618; // @ 0x00608BA4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C0820 -> 0x001C0CF4
*/
// Range: 0x1C0820 -> 0x1C0CF4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C0D00 -> 0x001C0DC0
*/
// Range: 0x1C0D00 -> 0x1C0DC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C0DC0 -> 0x001C14C0
*/
// Range: 0x1C0DC0 -> 0x1C14C0
static signed int DisplayMessage(enum _tagTRCState state /* r2 */) {
    /* anonymous block */ {
        ...
        signed char @5468; // @ 0x00608B98
        class xtextbox tb; // @ 0x0066B430
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C14C0 -> 0x001C14D8
*/
// Range: 0x1C14C0 -> 0x1C14D8
void xTRCReset() {
    /* anonymous block */ {
        // Range: 0x1C14C0 -> 0x1C14D8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C14E0 -> 0x001C1DF0
*/
// Range: 0x1C14E0 -> 0x1C1DF0
void xTRCRender() {
    /* anonymous block */ {
        // Range: 0x1C14E0 -> 0x1C1DF0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C1DF0 -> 0x001C1E00
*/
// Range: 0x1C1DF0 -> 0x1C1E00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C1E00 -> 0x001C1E3C
*/
// Range: 0x1C1E00 -> 0x1C1E3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C1E40 -> 0x001C1EC4
*/
// Range: 0x1C1E40 -> 0x1C1EC4
void xTRCInit() {
    /* anonymous block */ {
        // Range: 0x1C1E40 -> 0x1C1EC4
    }
