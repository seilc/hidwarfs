/*
    Compile unit: C:\TestBuild\in\Core\x\xCutscene.cpp
...
static unsigned int sCutTocCount; // size: 0x4, address: 0x60899C
static class xCutsceneInfo * sCutTocInfo; // size: 0x4, address: 0x6089A0
static class xModelInstance sCutsceneFakeModel[8]; // size: 0x520, address: 0x627610
static class xCutsceneModelHack * sCutsceneModelHackBuf; // size: 0x4, address: 0x6089A4
static class xCamCutscene * cutscene_cam; // size: 0x4, address: 0x6089A8
// total size: 0x24
struct /* @anon0 */ {} @unnamed@xCutscene_cpp@::xCamCutscene::__vtable; // size: 0x24, address: 0x5FD0B0
// total size: 0x24
struct /* @anon1 */ {} xCam::__vtable; // size: 0x24, address: 0x0
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
class xLightKit * gLastLightKit; // size: 0x4, address: 0x608C44
class tagiRenderArrays gRenderArr; // size: 0x5280, address: 0x6C00E0
void CutsceneShadowRender(class CutsceneShadowModel *); // size: 0x0, address: 0x17D190
class RwRaster * ShadowCameraRaster; // size: 0x4, address: 0x608B44
...
// total size: 0x120
class xCamCutscene : public xCam {
    // Members
public:
    class xCutscene * csn; // offset 0xD0, size 0x4
    class xMat4x3 original_mat; // offset 0xE0, size 0x40
};
// total size: 0x8
class xModelPipe {
    // Members
...
public:
    ...
    void * dataPtr; // offset 0x54, size 0x4
    unsigned int numAtomics; // offset 0x58, size 0x4
    void * atomic_dataPtr[8]; // offset 0x5C, size 0x20
    unsigned int atomic_Idx[8]; // offset 0x7C, size 0x20
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017C1F0 -> 0x0017C228
*/
// Range: 0x17C1F0 -> 0x17C228
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017C230 -> 0x0017D18C
*/
// Range: 0x17C230 -> 0x17D18C
void xCutscene_Render(class xCutscene * csn /* r23 */) {
    /* anonymous block */ {
        // Range: 0x17C230 -> 0x17D18C
        unsigned int i; // r9
        unsigned int dataIndex; // r29+0x190
        unsigned int animIndex; // r29+0x180
        unsigned int mphIndex; // r2
        unsigned int visFlags; // r29+0x170
        unsigned int visIdx; // r22
        unsigned int fakeCount; // r21
        unsigned int tworoot; // r16
        unsigned int noshadow; // r29+0x160
        class xCutsceneData * data; // r29+0x150
        class xCutsceneData * mphdata; // r4
        class RpAtomic * model; // r20
        class RpAtomic * shadowModel; // r29+0x14C
        class RwMatrixTag animMat[65]; // r29+0x3290
        class xVec3 * camVec; // r29+0x130
        class xModelPipe * pipeCurr; // r19
        unsigned int idx; // r29+0x120
        unsigned int hacked_model; // r29+0x110
        signed int tableIdx; // r29+0x100
        class XCSNNosey * nosey; // r29+0xF0
        unsigned int tempSize; // r29+0x42FC
        signed int table_size; // r2
        signed int h; // r17
        class zCutsceneHack & cutsceneHackTableData; // r2
        ...
        class xBox combinedAnimBound; // r29+0x3270
        ...
        class xMorphTargetFile * mphFile; // r7
        signed short * v_array[4]; // r29+0x3260
        signed short weight[4]; // r29+0x42F0
        unsigned int skipsize; // r5
        ...
        class xBox worldbox; // r29+0x3240
        signed int culled; // r16
        class xBox worldbox; // r29+0x3220
        class zCutsceneHack & cutsceneHackTableData2; // r2
        class CutsceneShadowModel smod; // r29+0x42E0
        class xShadowCache scache; // r29+0x1A0
        class xVec3 center; // r29+0x42D0
        class xVec3 shadVec; // @ 0x00506700
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017D190 -> 0x0017D200
*/
// Range: 0x17D190 -> 0x17D200
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017D200 -> 0x0017E250
*/
// Range: 0x17D200 -> 0x17E250
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017E250 -> 0x0017E504
*/
// Range: 0x17E250 -> 0x17E504
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017E510 -> 0x0017E878
*/
// Range: 0x17E510 -> 0x17E878
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017E880 -> 0x0017E8BC
*/
// Range: 0x17E880 -> 0x17E8BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017E8C0 -> 0x0017EA6C
*/
// Range: 0x17E8C0 -> 0x17EA6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017EA70 -> 0x0017EC0C
*/
// Range: 0x17EA70 -> 0x17EC0C
class xCutscene * xCutscene_Create(unsigned int csnID /* r19 */, unsigned int subtitlesID /* r18 */) {
    /* anonymous block */ {
        // Range: 0x17EA70 -> 0x17EC0C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017EC10 -> 0x0017ED7C
*/
// Range: 0x17EC10 -> 0x17ED7C
void xCutscene_Init(void * toc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x17EC10 -> 0x17ED7C
        signed int i; // r17
        signed int maxModels; // r7
        class xCutsceneInfo * cnfo; // r6
        unsigned int cnum; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017ED80 -> 0x0017EE48
*/
// Range: 0x17ED80 -> 0x17EE48
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017EE50 -> 0x0017EEF4
*/
// Range: 0x17EE50 -> 0x17EEF4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0017EF00 -> 0x0017F210
*/
// Range: 0x17EF00 -> 0x17F210
// this: r21
