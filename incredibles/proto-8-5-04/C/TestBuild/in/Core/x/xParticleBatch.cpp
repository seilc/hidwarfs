/*
    Compile unit: C:\TestBuild\in\Core\x\xParticleBatch.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class internal_system systems[128]; // size: 0x2000, address: 0x69C5C0
static class system_bucket buckets[6][128]; // size: 0x3C00, address: 0x69E5C0
static class block_info * head_free_block; // size: 0x4, address: 0x6090EC
static unsigned char * block_buffer; // size: 0x4, address: 0x6090F0
static class block_info block_info_buffer[32]; // size: 0x180, address: 0x6A21C0
static signed int systems_size; // size: 0x4, address: 0x6090F4
static signed int buckets_size[6]; // size: 0x18, address: 0x6A2340
signed int compare_group_systems_function(void *, void *); // size: 0x0, address: 0x322890
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322730 -> 0x0032288C
*/
// Range: 0x322730 -> 0x32288C
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322890 -> 0x00322A40
*/
// Range: 0x322890 -> 0x322A40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322A40 -> 0x00322A78
*/
// Range: 0x322A40 -> 0x322A78
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322A80 -> 0x00322BB0
*/
// Range: 0x322A80 -> 0x322BB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322BB0 -> 0x00322CA0
*/
// Range: 0x322BB0 -> 0x322CA0
void xParticleBatchReplaceSystem(signed int system_id /* r2 */, class xParticleBatchSystem & system /* r17 */) {
    /* anonymous block */ {
        // Range: 0x322BB0 -> 0x322CA0
        class internal_system & isys; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322CA0 -> 0x00322D78
*/
// Range: 0x322CA0 -> 0x322D78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322D80 -> 0x00322ED0
*/
// Range: 0x322D80 -> 0x322ED0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322ED0 -> 0x00322F4C
*/
// Range: 0x322ED0 -> 0x322F4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322F50 -> 0x00322F58
*/
// Range: 0x322F50 -> 0x322F58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322F60 -> 0x00322FAC
*/
// Range: 0x322F60 -> 0x322FAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00322FB0 -> 0x003230E4
*/
// Range: 0x322FB0 -> 0x3230E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003230F0 -> 0x0032322C
*/
// Range: 0x3230F0 -> 0x32322C
static void remove_from_bucket(class internal_system & isys /* r18 */) {
    /* anonymous block */ {
        // Range: 0x3230F0 -> 0x32322C
        signed int & bsize; // r2
        class system_bucket * begin_bucket; // r2
        class system_bucket * end_bucket; // r2
        class system_bucket key; // r29+0x40
        class system_bucket * bucket; // r6
        class internal_system * it; // r3
        class internal_system * * itp; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00323230 -> 0x00323364
*/
// Range: 0x323230 -> 0x323364
static void add_to_bucket(class internal_system & isys /* r19 */) {
    /* anonymous block */ {
        // Range: 0x323230 -> 0x323364
        signed int & bsize; // r18
        class system_bucket * begin_bucket; // r17
        class system_bucket * end_bucket; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00323B70 -> 0x00323DEC
*/
// Range: 0x323B70 -> 0x323DEC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00323DF0 -> 0x0032406C
*/
// Range: 0x323DF0 -> 0x32406C
static void pre_render_buckets(class system_bucket * first /* r2 */, class system_bucket * last /* r29+0xCC */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x323DF0 -> 0x32406C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324070 -> 0x003242EC
*/
// Range: 0x324070 -> 0x3242EC
static void pre_render_buckets(class system_bucket * first /* r2 */, class system_bucket * last /* r29+0xCC */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x324070 -> 0x3242EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003242F0 -> 0x0032456C
*/
// Range: 0x3242F0 -> 0x32456C
static void pre_render_buckets(class system_bucket * first /* r2 */, class system_bucket * last /* r29+0xCC */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3242F0 -> 0x32456C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324570 -> 0x003247EC
*/
// Range: 0x324570 -> 0x3247EC
static void pre_render_buckets(class system_bucket * first /* r2 */, class system_bucket * last /* r29+0xCC */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x324570 -> 0x3247EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003247F0 -> 0x00324A6C
*/
// Range: 0x3247F0 -> 0x324A6C
static void pre_render_buckets(class system_bucket * first /* r2 */, class system_bucket * last /* r29+0xCC */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3247F0 -> 0x324A6C
