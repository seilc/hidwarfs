/*
    Compile unit: C:\TestBuild\in\Core\x\xGroup.cpp
...
void xEntVisibilityCullOff(class xEnt *); // size: 0x0, address: 0x1D0260
void xEntVisibilityCullOn(class xEnt *); // size: 0x0, address: 0x1D02A0
void xEntHide(class xEnt *); // size: 0x0, address: 0x1D02E0
void xEntShow(class xEnt *); // size: 0x0, address: 0x1D0320
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void xGroupEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1CFFC0
// total size: 0x2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFEE0 -> 0x001CFF18
*/
// Range: 0x1CFEE0 -> 0x1CFF18
// this: r2
unsigned int xGroup::get_any() {
    /* anonymous block */ {
        // Range: 0x1CFEE0 -> 0x1CFF18
        unsigned int id; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFF20 -> 0x001CFF34
*/
// Range: 0x1CFF20 -> 0x1CFF34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFF40 -> 0x001CFFA4
*/
// Range: 0x1CFF40 -> 0x1CFFA4
class xBase * xGroupGetItemPtr(class xGroup * g /* r17 */, unsigned int index /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CFF40 -> 0x1CFFA4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFFB0 -> 0x001CFFBC
*/
// Range: 0x1CFFB0 -> 0x1CFFBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CFFC0 -> 0x001D0260
*/
// Range: 0x1CFFC0 -> 0x1D0260
void xGroupEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r19 */, float * toParam /* r18 */, class xBase * toParamWidget /* r22 */, unsigned int toParamWidgetID /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1CFFC0 -> 0x1D0260
        class xGroup * g; // r17
        signed int rand; // r16
        void (* entVisEventHandler)(class xEnt *); // r30
        signed int i; // r21
        class xBase * b; // r2
        signed int i; // r21
        class xBase * b; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0360 -> 0x001D0368
*/
// Range: 0x1D0360 -> 0x1D0368
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0370 -> 0x001D0378
*/
// Range: 0x1D0370 -> 0x1D0378
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0380 -> 0x001D0490
*/
// Range: 0x1D0380 -> 0x1D0490
void xGroupSetup(class xGroup * g /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D0380 -> 0x1D0490
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0490 -> 0x001D0534
*/
// Range: 0x1D0490 -> 0x1D0534
