/*
    Compile unit: C:\TestBuild\in\Core\x\xScreenFade.cpp
...
static signed int cnt_fadesInProgress; // size: 0x4, address: 0x60919C
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
class xColor_tag g_CLEAR; // size: 0x4, address: 0x5E7218
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x33D7B0
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D7B0 -> 0x0033D80C
*/
// Range: 0x33D7B0 -> 0x33D80C
void cb_dispatch(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33D7B0 -> 0x33D80C
        class xScreenFade & e; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D810 -> 0x0033D818
*/
// Range: 0x33D810 -> 0x33D818
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D820 -> 0x0033D938
*/
// Range: 0x33D820 -> 0x33D938
// this: r16
void xScreenFade::load(class asset_type & a /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33D820 -> 0x33D938
    }
}
