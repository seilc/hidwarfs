/*
    Compile unit: C:\TestBuild\in\Core\x\xModelBlur.cpp
...
static unsigned char sModelBlurEnabled; // size: 0x1, address: 0x6084E0
static class xFXCameraTexture camtex; // size: 0x48, address: 0x6BEBE0
class activity_data * activity_buffer; // size: 0x4, address: 0x609658
class activity_data * activities[6]; // size: 0x18, address: 0x6BEC30
signed int activities_used; // size: 0x4, address: 0x60965C
...
public:
    ...
    class config_data * cfg; // offset 0x8, size 0x4
    class xModelInstance * model; // offset 0xC, size 0x4
    class xVec3 center; // offset 0x10, size 0xC
    class path_node path[32]; // offset 0x1C, size 0x280
    class card_data cards[32]; // offset 0x29C, size 0x200
    signed int path_start; // offset 0x49C, size 0x4
    signed int path_size; // offset 0x4A0, size 0x4
    signed int cards_size; // offset 0x4A4, size 0x4
    class interpolator lifetime; // offset 0x4A8, size 0x14
    class interpolator alpha; // offset 0x4BC, size 0x14
};
// total size: 0x2C
class RpClump {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473290 -> 0x004736B0
*/
// Range: 0x473290 -> 0x4736B0
// this: r20
void xModelBlur::render_cards(class xFRect & src_rect /* r19 */, float xoff0 /* r29 */, float yoff0 /* r28 */, float xoff1 /* r27 */, float yoff1 /* r26 */) {
    /* anonymous block */ {
        // Range: 0x473290 -> 0x4736B0
        class RwRaster * draw_raster; // r16
        class xFXFastRaster fr; // r29+0x100
        signed int maxu; // r2
        signed int maxv; // r2
        ...
        class xVec2 & vw; // r2
        class _xFColor color; // r29+0xF0
        float zscale; // r25
        float zbias; // r24
        signed int i; // r18
        class card_data & card; // r2
        class xVec3 sp; // r29+0x120
        float rz; // r29+0x130
        float blitz; // r23
        float cx; // r8
        float cy; // r7
        float x0; // r6
        float y0; // r5
        class xFRect clip_src_rect; // r29+0xE0
        class xFRect clip_dst_rect; // r29+0xD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004736B0 -> 0x00473C58
*/
// Range: 0x4736B0 -> 0x473C58
// this: r20
void xModelBlur::render() {
    /* anonymous block */ {
        // Range: 0x4736B0 -> 0x473C58
        unsigned int oldFBMSK; // r19
        class RwRaster * draw_raster; // r18
        class xVec3 & center; // r2
        class xVec3 view_center; // r29+0x100
        class RwCamera * world_cam; // r17
        class xMat4x3 & view_mat; // r2
        float rz; // r29+0x110
        float screen_x; // r20
        float screen_y; // r23
        float screen_radius; // r2
        class xVec2 & world_view_window; // r6
        class xFRect scr_rect; // r29+0xF0
        class xFRect tex_rect; // r29+0xE0
        class xFXFastRaster fr; // r29+0xC0
        class _xFColor color; // r29+0xB0
        class xModelInstance * m; // r17
        float oldalpha; // r29+0x110
        class xModelInstance * m; // r17
        float oldalpha; // r29+0x110
        float xoff0; // r22
        float xoff1; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473C60 -> 0x004740B8
*/
// Range: 0x473C60 -> 0x4740B8
// this: r2
unsigned char xModelBlur::update(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x473C60 -> 0x4740B8
        signed int i; // r2
        float lifetime; // r3
        class path_node & p; // r2
        float card_dist; // r2
        signed int max_card_renders; // r2
        float alpha_scale; // r1
        class card_data * cards; // r2
        signed int cards_size; // r7
        float path_dist; // r29+0x10
        class path_node & p0; // r2
        class path_node & p1; // r2
        class xVec3 & A; // r11
        class xVec3 & B; // r2
        float ABx; // r17
        float ABy; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004740C0 -> 0x004740CC
*/
// Range: 0x4740C0 -> 0x4740CC
// this: r2
float xModelBlur::get_alpha_goal() {
    /* anonymous block */ {
        // Range: 0x4740C0 -> 0x4740CC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004740D0 -> 0x0047413C
*/
// Range: 0x4740D0 -> 0x47413C
// this: r2
void xModelBlur::set_alpha(float value /* r29 */, float time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x4740D0 -> 0x47413C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474140 -> 0x0047414C
*/
// Range: 0x474140 -> 0x47414C
// this: r2
float xModelBlur::get_lifetime_goal() {
    /* anonymous block */ {
        // Range: 0x474140 -> 0x47414C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474150 -> 0x004741BC
*/
// Range: 0x474150 -> 0x4741BC
// this: r2
void xModelBlur::set_lifetime(float value /* r29 */, float time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x474150 -> 0x4741BC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004741C0 -> 0x00474278
*/
// Range: 0x4741C0 -> 0x474278
// this: r2
unsigned char xModelBlur::visible() {
    /* anonymous block */ {
        // Range: 0x4741C0 -> 0x474278
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474280 -> 0x0047428C
*/
// Range: 0x474280 -> 0x47428C
// this: r2
void xModelBlur::set_config(class config_data & cfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x474280 -> 0x47428C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474290 -> 0x004743C0
*/
// Range: 0x474290 -> 0x4743C0
// this: r2
void xModelBlur::move(class xVec3 & center /* r2 */) {
    /* anonymous block */ {
        // Range: 0x474290 -> 0x4743C0
        signed int second_index; // r2
        class xVec3 & A; // r2
        class xVec3 & B; // r2
        float ABx; // r29
        float ABy; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004743C0 -> 0x00474434
*/
// Range: 0x4743C0 -> 0x474434
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474440 -> 0x00474518
*/
// Range: 0x474440 -> 0x474518
// this: r2
unsigned char xModelBlur::activate(float lifetime /* r29 */, float alpha /* r29 */, class config_data & cfg /* r2 */, class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x474440 -> 0x474518
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474520 -> 0x00474528
*/
// Range: 0x474520 -> 0x474528
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474530 -> 0x0047453C
*/
// Range: 0x474530 -> 0x47453C
class config_data & get_default_config() {
    /* anonymous block */ {
        // Range: 0x474530 -> 0x47453C
        class config_data cfg; // @ 0x005FBC40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474540 -> 0x004745CC
*/
// Range: 0x474540 -> 0x4745CC
void render_all() {
    /* anonymous block */ {
        // Range: 0x474540 -> 0x4745CC
        class activity_data * * activity; // r16
        class activity_data * * end_activity; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004745D0 -> 0x00474670
*/
// Range: 0x4745D0 -> 0x474670
void update_all(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x4745D0 -> 0x474670
        class activity_data * * activity; // r16
        class activity_data * * end_activity; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474670 -> 0x00474760
*/
// Range: 0x474670 -> 0x474760
void reset_all() {
    /* anonymous block */ {
        // Range: 0x474670 -> 0x474760
        signed int i; // r5
        class activity_data * activity; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474760 -> 0x0047476C
*/
// Range: 0x474760 -> 0x47476C
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x474760 -> 0x47476C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474770 -> 0x004748A0
*/
// Range: 0x474770 -> 0x4748A0
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x474770 -> 0x4748A0
        class activity_data * activity; // r2
