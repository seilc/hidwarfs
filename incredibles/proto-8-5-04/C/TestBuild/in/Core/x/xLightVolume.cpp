/*
    Compile unit: C:\TestBuild\in\Core\x\xLightVolume.cpp
...
class activity_type * activities; // size: 0x4, address: 0x6095AC
signed int activities_used; // size: 0x4, address: 0x6095B0
// total size: 0x10
struct /* @anon0 */ {} xLightVolumeModel::__vtable; // size: 0x10, address: 0x605FB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045E2B0 -> 0x0045EC28
*/
// Range: 0x45E2B0 -> 0x45EC28
void render_atomic(class RpAtomic * atomic /* r17 */, class xColor_tag color /* r29+0x4C */, unsigned char inside /* r18 */) {
    /* anonymous block */ {
        // Range: 0x45E2B0 -> 0x45EC28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045EC30 -> 0x0045EDA4
*/
// Range: 0x45EC30 -> 0x45EDA4
void render_all() {
    /* anonymous block */ {
        // Range: 0x45EC30 -> 0x45EDA4
        unsigned int oldATEST; // r29+0x5C
        class xFXFastRaster fr; // r29+0x40
        class activity_type * act; // r18
        class activity_type * end_act; // r2
        unsigned int newATEST; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045EDB0 -> 0x0045F0A8
*/
// Range: 0x45EDB0 -> 0x45F0A8
// this: r21
void xLightVolumeModel::render_single(class xModelInstance * model /* r20 */, unsigned int stencil_pass /* r29+0xBC */) {
    /* anonymous block */ {
        // Range: 0x45EDB0 -> 0x45F0A8
        class RpAtomic * atomic; // r19
        class RpHAnimHierarchy * hierarchy; // r2
        class RwMatrixTag * old_anim_mat; // r29+0xA0
        class xMat4x3 & mat; // r2
        class xMat4x3 old_mat; // r29+0xC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F0B0 -> 0x0045F144
*/
// Range: 0x45F0B0 -> 0x45F144
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F150 -> 0x0045F194
*/
// Range: 0x45F150 -> 0x45F194
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F1A0 -> 0x0045F1E0
*/
// Range: 0x45F1A0 -> 0x45F1E0
// this: r2
void xLightVolume::deactivate() {
    /* anonymous block */ {
        // Range: 0x45F1A0 -> 0x45F1E0
        class activity_type * tail_activity; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F1E0 -> 0x0045F224
*/
// Range: 0x45F1E0 -> 0x45F224
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F230 -> 0x0045F238
*/
// Range: 0x45F230 -> 0x45F238
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F240 -> 0x0045F280
*/
// Range: 0x45F240 -> 0x45F280
void reset_all() {
    /* anonymous block */ {
        // Range: 0x45F240 -> 0x45F280
        class activity_type * act; // r5
        class activity_type * end_act; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F280 -> 0x0045F288
*/
// Range: 0x45F280 -> 0x45F288
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x45F280 -> 0x45F288
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0045F290 -> 0x0045F2BC
*/
// Range: 0x45F290 -> 0x45F2BC
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x45F290 -> 0x45F2BC
    }
