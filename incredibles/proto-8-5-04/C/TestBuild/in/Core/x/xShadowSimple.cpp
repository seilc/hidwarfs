/*
    Compile unit: C:\TestBuild\in\Core\x\xShadowSimple.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class xShadowSimpleQueue sCollQueue[2]; // size: 0x30, address: 0x67A410
static class RxRenderStateVector xrsv; // size: 0x2C, address: 0x67A440
static class RxObjSpace3DVertex sShadVert[384]; // size: 0x3600, address: 0x67A470
static class RwRaster * sShadRasters[64]; // size: 0x100, address: 0x67DA70
static class RwRaster * sShadRaster; // size: 0x4, address: 0x608CE8
static unsigned int sShadVertCount; // size: 0x4, address: 0x608CEC
static class RwMatrixTag * sModelMat; // size: 0x4, address: 0x608CF0
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
signed int shadowRayEntCB(class xEnt *, void *); // size: 0x0, address: 0x1F06C0
...
class RpCollisionTriangle * shadowRayCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x1F07C0
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
class RpCollisionTriangle * shadowRayModelCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x1F07A0
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EEB60 -> 0x001EF948
*/
// Range: 0x1EEB60 -> 0x1EF948
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EF950 -> 0x001EF9E0
*/
// Range: 0x1EF950 -> 0x1EF9E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EF9E0 -> 0x001EFD18
*/
// Range: 0x1EF9E0 -> 0x1EFD18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EFD20 -> 0x001EFD3C
*/
// Range: 0x1EFD20 -> 0x1EFD3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EFD40 -> 0x001EFF20
*/
// Range: 0x1EFD40 -> 0x1EFF20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EFF20 -> 0x001EFF34
*/
// Range: 0x1EFF20 -> 0x1EFF34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001EFF40 -> 0x001F0028
*/
// Range: 0x1EFF40 -> 0x1F0028
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F0030 -> 0x001F0220
*/
// Range: 0x1F0030 -> 0x1F0220
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F0220 -> 0x001F0418
*/
// Range: 0x1F0220 -> 0x1F0418
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F0420 -> 0x001F06B4
*/
// Range: 0x1F0420 -> 0x1F06B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F06C0 -> 0x001F07A0
*/
// Range: 0x1F06C0 -> 0x1F07A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F07A0 -> 0x001F07B4
*/
// Range: 0x1F07A0 -> 0x1F07B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F07C0 -> 0x001F091C
*/
// Range: 0x1F07C0 -> 0x1F091C
