/*
    Compile unit: C:\TestBuild\in\Core\x\xLightKit.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xLightKit * gLastLightKit; // size: 0x4, address: 0x608C44
class xLightKit * gCloneLightKit; // size: 0x4, address: 0x608C48
unsigned int _rwSkyLightQWordsWritten; // size: 0x4, address: 0x60942C
float * _rwSkyLightFillPos; // size: 0x4, address: 0x609428
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D94E0 -> 0x001D94E8
*/
// Range: 0x1D94E0 -> 0x1D94E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D94F0 -> 0x001D95D0
*/
// Range: 0x1D94F0 -> 0x1D95D0
void xLightKit_Enable(class xLightKit * lkit /* r17 */, class RpWorld * world /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D94F0 -> 0x1D95D0
        unsigned int i; // r19
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D95D0 -> 0x001D96EC
*/
// Range: 0x1D95D0 -> 0x1D96EC
void xLightKit_ClonePS2AllDoApply() {
    /* anonymous block */ {
        // Range: 0x1D95D0 -> 0x1D96EC
        float * _rwSkyLightFillPos'79; // r5
        unsigned int i; // r4
        class RpLight * light; // r2
        enum RpLightType type; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D96F0 -> 0x001D9A64
*/
// Range: 0x1D96F0 -> 0x1D9A64
