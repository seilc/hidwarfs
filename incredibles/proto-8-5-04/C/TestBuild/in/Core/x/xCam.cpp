/*
    Compile unit: C:\TestBuild\in\Core\x\xCam.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float scale; // size: 0x4, address: 0x0
// total size: 0x24
struct /* @anon1 */ {} xCamDebug::__vtable; // size: 0x24, address: 0x0
// total size: 0x24
struct /* @anon2 */ {} xCamBlend::__vtable; // size: 0x24, address: 0x601070
// total size: 0x24
struct /* @anon0 */ {} xCam::__vtable; // size: 0x24, address: 0x0
...
// total size: 0x160
class xCamDebug : public xCam {
    // Members
public:
    class config cfg; // offset 0xD0, size 0x70
    class analog_data * analog_move; // offset 0x140, size 0x4
    class analog_data * analog_turn; // offset 0x144, size 0x4
    class xVec2 dpad; // offset 0x148, size 0x8
    float slow_input; // offset 0x150, size 0x4
};
// total size: 0x18
...
class config : public xCamConfigFollow {
    // Members
public:
    class xVec2 stick_vel; // offset 0x54, size 0x8
    class xVec3 move_vel; // offset 0x5C, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029E4A0 -> 0x0029E4C0
*/
// Range: 0x29E4A0 -> 0x29E4C0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029E4C0 -> 0x0029F50C
*/
// Range: 0x29E4C0 -> 0x29F50C
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029F510 -> 0x0029F5A4
*/
// Range: 0x29F510 -> 0x29F5A4
// this: r16
void xCamBlend::stop() {
    /* anonymous block */ {
        // Range: 0x29F510 -> 0x29F5A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029F5B0 -> 0x0029F7D4
*/
// Range: 0x29F5B0 -> 0x29F7D4
// this: r16
void xCamBlend::start() {
    /* anonymous block */ {
        // Range: 0x29F5B0 -> 0x29F7D4
        enum xCamOrientType orient_table[2][2]; // @ 0x005EE800
        enum xCamCoordType coord_table[3][3]; // @ 0x005EE7D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029F7E0 -> 0x0029F7E8
*/
// Range: 0x29F7E0 -> 0x29F7E8
void destroy() {
    /* anonymous block */ {
        // Range: 0x29F7E0 -> 0x29F7E8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029F7F0 -> 0x0029F81C
*/
// Range: 0x29F7F0 -> 0x29F81C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029F820 -> 0x002A0528
*/
// Range: 0x29F820 -> 0x2A0528
void create_frustum_planes(class xVec4 * frust_planes /* r2 */, class xMat4x3 & ltm /* r2 */, class xVec2 & view_offset /* r2 */, class xVec2 & view_window /* r2 */, float near_plane /* r29+0x360 */, float far_plane /* r29+0x360 */) {
    /* anonymous block */ {
        // Range: 0x29F820 -> 0x2A0528
        class plane_type * planes; // r2
        class xVec3 temp; // r29+0x350
        class xVec3 cop; // r29+0x340
        float scale; // r29+0x360
        class xVec3 corners[8]; // r29+0xC0
        signed int i; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0530 -> 0x002A054C
*/
// Range: 0x2A0530 -> 0x2A054C
// this: r2
void xCamScreen::set_fov(float fov /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2A0530 -> 0x2A054C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0550 -> 0x002A0558
*/
// Range: 0x2A0550 -> 0x2A0558
// this: r2
void xCamScreen::set_world_matrix(class xMat4x3 & mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A0550 -> 0x2A0558
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0560 -> 0x002A0568
*/
// Range: 0x2A0560 -> 0x2A0568
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0570 -> 0x002A05A8
*/
// Range: 0x2A0570 -> 0x2A05A8
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A05B0 -> 0x002A05B8
*/
// Range: 0x2A05B0 -> 0x2A05B8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A05C0 -> 0x002A05D0
*/
// Range: 0x2A05C0 -> 0x2A05D0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A05D0 -> 0x002A05D8
*/
// Range: 0x2A05D0 -> 0x2A05D8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A05E0 -> 0x002A0614
*/
// Range: 0x2A05E0 -> 0x2A0614
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0620 -> 0x002A07EC
*/
// Range: 0x2A0620 -> 0x2A07EC
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A07F0 -> 0x002A09B4
*/
// Range: 0x2A07F0 -> 0x2A09B4
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A09C0 -> 0x002A0A54
*/
// Range: 0x2A09C0 -> 0x2A0A54
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0A60 -> 0x002A0B0C
*/
// Range: 0x2A0A60 -> 0x2A0B0C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0B10 -> 0x002A0BB4
*/
// Range: 0x2A0B10 -> 0x2A0BB4
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0BC0 -> 0x002A0FC4
*/
// Range: 0x2A0BC0 -> 0x2A0FC4
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A0FD0 -> 0x002A1080
*/
// Range: 0x2A0FD0 -> 0x2A1080
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1080 -> 0x002A10D4
*/
// Range: 0x2A1080 -> 0x2A10D4
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A10E0 -> 0x002A1190
*/
// Range: 0x2A10E0 -> 0x2A1190
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1190 -> 0x002A11A8
*/
// Range: 0x2A1190 -> 0x2A11A8
// this: r2
void xCam::create() {
    /* anonymous block */ {
        // Range: 0x2A1190 -> 0x2A11A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A11B0 -> 0x002A1348
*/
// Range: 0x2A11B0 -> 0x2A1348
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1350 -> 0x002A1358
*/
// Range: 0x2A1350 -> 0x2A1358
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x2A1350 -> 0x2A1358
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1360 -> 0x002A1368
*/
// Range: 0x2A1360 -> 0x2A1368
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x2A1360 -> 0x2A1368
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1370 -> 0x002A1384
*/
// Range: 0x2A1370 -> 0x2A1384
// this: r2
void xCam::stop() {
    /* anonymous block */ {
        // Range: 0x2A1370 -> 0x2A1384
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A1390 -> 0x002A13A0
*/
// Range: 0x2A1390 -> 0x2A13A0
// this: r2
void xCam::start() {
    /* anonymous block */ {
        // Range: 0x2A1390 -> 0x2A13A0
