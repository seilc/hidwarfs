/*
    Compile unit: C:\TestBuild\in\Core\x\xEntBoulder.cpp
...
static class xEntCollis sBoulderCollis; // size: 0x5FC, address: 0x66BCE0
void xEntBoulder_Update(class xEntBoulder *, class xScene *, float); // size: 0x0, address: 0x1DC920
...
void xBoulderGenerator_EventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1DB080
...
void xEntBoulder_Render(class xEnt *); // size: 0x0, address: 0x1DE2D0
void xEntBoulder_BUpdate(class xEnt *, class xVec3 *); // size: 0x0, address: 0x1DDD30
void xEntBoulderEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1DC250
// total size: 0x14
class xCylinder {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB080 -> 0x001DB7CC
*/
// Range: 0x1DB080 -> 0x1DB7CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB7D0 -> 0x001DBB84
*/
// Range: 0x1DB7D0 -> 0x1DBB84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DBB90 -> 0x001DBD68
*/
// Range: 0x1DBB90 -> 0x1DBD68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DBD70 -> 0x001DC110
*/
// Range: 0x1DBD70 -> 0x1DC110
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC110 -> 0x001DC118
*/
// Range: 0x1DC110 -> 0x1DC118
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC120 -> 0x001DC24C
*/
// Range: 0x1DC120 -> 0x1DC24C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC250 -> 0x001DC628
*/
// Range: 0x1DC250 -> 0x1DC628
void xEntBoulderEventCB(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1DC250 -> 0x1DC628
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC630 -> 0x001DC6DC
*/
// Range: 0x1DC630 -> 0x1DC6DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC6E0 -> 0x001DC744
*/
// Range: 0x1DC6E0 -> 0x1DC744
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC750 -> 0x001DC920
*/
// Range: 0x1DC750 -> 0x1DC920
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DC920 -> 0x001DDD2C
*/
// Range: 0x1DC920 -> 0x1DDD2C
void xEntBoulder_Update(class xEntBoulder * ent /* r21 */, class xScene * sc /* r29+0xBC */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1DC920 -> 0x1DDD2C
        signed int i; // r5
        class xVec3 rotatedLC; // r29+0x200
        class xVec3 oldPos; // r29+0x1F0
        signed int numDepens; // r20
        class xVec3 depen; // r29+0x1E0
        class xEnt * optr; // r2
        class xEnt * xb; // r19
        class xEntBoulder * boul; // r2
        class xVec3 force; // r29+0x1D0
        class xVec3 toAdd; // r29+0x1C0
        float forceMag; // r29+0x210
        class xEnt * optr; // r2
        class xEnt * xb; // r2
        float hitParams[6]; // r29+0x150
        class base * npc; // r2
        float hitParams[6]; // r29+0x130
        class xVec3 newVel; // r29+0x1B0
        float newMag; // r29+0x210
        float oldMag; // r22
        class xVec3 depenNorm; // r29+0x1A0
        float depenComp; // r21
        float afterBounce; // r29+0x210
        class xVec3 fricComp; // r29+0x190
        class xMat4x3 baseMatrix; // r29+0xF0
        class xVec3 vForcedRotationAxis; // r29+0x180
        float fMagnitudeAgainstAxis; // r29+0x210
        class xVec3 newRotVec; // r29+0x170
        float newAngVel; // r29+0x210
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DDD30 -> 0x001DDD38
*/
// Range: 0x1DDD30 -> 0x1DDD38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DDD40 -> 0x001DDD90
*/
// Range: 0x1DDD40 -> 0x1DDD90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DDD90 -> 0x001DE038
*/
// Range: 0x1DDD90 -> 0x1DE038
void xEntBoulder_ApplyForces(class xEntCollis * collis /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1DDD90 -> 0x1DE038
        signed int i; // r20
        class xVec3 f; // r29+0x100
        class xEntBoulder * boul; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DE040 -> 0x001DE2B4
*/
// Range: 0x1DE040 -> 0x1DE2B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DE2C0 -> 0x001DE2C8
*/
// Range: 0x1DE2C0 -> 0x1DE2C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DE2D0 -> 0x001DE434
*/
// Range: 0x1DE2D0 -> 0x1DE434
