/*
    Compile unit: C:\TestBuild\in\Core\x\xMovePoint.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A52D0 -> 0x001A53C8
*/
// Range: 0x1A52D0 -> 0x1A53C8
signed int xMovePointGetAllLinked(class xMovePoint * * mps /* r21 */, signed int mps_max /* r20 */, class xMovePoint * mp /* r19 */, signed int mps_used /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A52D0 -> 0x1A53C8
        signed int i; // r4
        signed int size; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A53D0 -> 0x001A53D8
*/
// Range: 0x1A53D0 -> 0x1A53D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A53E0 -> 0x001A55DC
*/
// Range: 0x1A53E0 -> 0x1A55DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A55E0 -> 0x001A5604
*/
// Range: 0x1A55E0 -> 0x1A5604
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5610 -> 0x001A57F4
*/
// Range: 0x1A5610 -> 0x1A57F4
void xMovePointSplineSetup(class xMovePoint * m /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A5610 -> 0x1A57F4
        class xMovePoint * w0; // r2
        class xMovePoint * w2; // r2
        class xMovePoint * w3; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5800 -> 0x001A58D8
*/
// Range: 0x1A5800 -> 0x1A58D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A58E0 -> 0x001A5920
*/
// Range: 0x1A58E0 -> 0x1A5920
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5920 -> 0x001A5928
*/
// Range: 0x1A5920 -> 0x1A5928
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5930 -> 0x001A5938
*/
// Range: 0x1A5930 -> 0x1A5938
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5940 -> 0x001A59C0
*/
// Range: 0x1A5940 -> 0x1A59C0
void xMovePointInit(class xMovePoint * m /* r16 */, class xMovePointAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A5940 -> 0x1A59C0
    }
}
