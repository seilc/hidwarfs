/*
    Compile unit: C:\TestBuild\in\Core\x\xCollideSphereBox.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class xBoxFace box_faces[6]; // size: 0x480, address: 0x50EBA0
static class xEdge * box_edges[6][6]; // size: 0x90, address: 0x50F020
// total size: 0x8
...
class xEdge {
    // Members
public:
    class xCollideLineSegment segment; // offset 0x0, size 0x1C
    class xPlane edge; // offset 0x1C, size 0x10
};
// total size: 0x0
class xLightKit {};
// total size: 0x1C
class xCollideLineSegment {
    // Members
public:
...
public:
    ...
    class xEdge edges[4]; // offset 0x10, size 0xB0
};
// total size: 0x8
class RpTriangle {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034B780 -> 0x0034BB10
*/
// Range: 0x34B780 -> 0x34BB10
signed int xSweptSphereToOBB(class xSweptSphere * sws /* r17 */, class xBox * box /* r18 */, class xMat4x3 * mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x34B780 -> 0x34BB10
        class xVec3 old_start; // r29+0x90
        class xVec3 old_end; // r29+0x80
        class xVec3 old_dir; // r29+0x70
        float old_dist; // r24
        float box_scale; // r23
        float old_radius; // r22
        float old_curdist; // r21
        float initial_scaled_curdist; // r20
        signed int got_collision; // r2
        class xVec3 collide_point; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034BB10 -> 0x00352408
*/
// Range: 0x34BB10 -> 0x352408
signed int xSweptSphereToBox(class xSweptSphere & sws /* r2 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x34BB10 -> 0x352408
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00352410 -> 0x00352554
*/
// Range: 0x352410 -> 0x352554
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x352410 -> 0x352554
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00352560 -> 0x003526A0
*/
// Range: 0x352560 -> 0x3526A0
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x352560 -> 0x3526A0
        class xCollideSphereToPolygonResults results; // r29+0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003526A0 -> 0x003527E4
*/
// Range: 0x3526A0 -> 0x3527E4
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3526A0 -> 0x3527E4
        class xCollideSphereToPolygonResults results; // r29+0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003527F0 -> 0x00352930
*/
// Range: 0x3527F0 -> 0x352930
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3527F0 -> 0x352930
        class xCollideSphereToPolygonResults results; // r29+0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00352930 -> 0x00352A6C
*/
// Range: 0x352930 -> 0x352A6C
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x352930 -> 0x352A6C
        class xCollideSphereToPolygonResults results; // r29+0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00352A70 -> 0x00352BB4
*/
// Range: 0x352A70 -> 0x352BB4
static signed int xSweptSphereToBoxFaces(class xSweptSphere & sphere /* r16 */, class xBox & box /* r2 */) {
    /* anonymous block */ {
        // Range: 0x352A70 -> 0x352BB4
        class xCollideSphereToPolygonResults results; // r29+0x20
