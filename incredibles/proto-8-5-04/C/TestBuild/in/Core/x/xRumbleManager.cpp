/*
    Compile unit: C:\TestBuild\in\Core\x\xRumbleManager.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3530 -> 0x002C353C
*/
// Range: 0x2C3530 -> 0x2C353C
void StopRumbling() {
    /* anonymous block */ {
        // Range: 0x2C3530 -> 0x2C353C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3540 -> 0x002C357C
*/
// Range: 0x2C3540 -> 0x2C357C
// this: r16
void Manager::Reset() {
    /* anonymous block */ {
        // Range: 0x2C3540 -> 0x2C357C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3580 -> 0x002C35C8
*/
// Range: 0x2C3580 -> 0x2C35C8
class Manager & Get() {
    /* anonymous block */ {
        // Range: 0x2C3580 -> 0x2C35C8
        signed char @4582; // @ 0x00608FA0
        class Manager rumbleManager; // @ 0x00686C90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C35D0 -> 0x002C3888
*/
// Range: 0x2C35D0 -> 0x2C3888
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3890 -> 0x002C3908
*/
// Range: 0x2C3890 -> 0x2C3908
// this: r2
unsigned char Manager::Stop(class _tagxPad * pad /* r2 */, class emitterBase * pEmitter /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2C3890 -> 0x2C3908
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3910 -> 0x002C3BB0
*/
// Range: 0x2C3910 -> 0x2C3BB0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3BB0 -> 0x002C3D44
*/
// Range: 0x2C3BB0 -> 0x2C3D44
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002C3D50 -> 0x002C3E88
*/
// Range: 0x2C3D50 -> 0x2C3E88
// this: r2
