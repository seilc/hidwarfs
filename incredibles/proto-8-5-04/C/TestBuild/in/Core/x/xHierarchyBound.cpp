/*
    Compile unit: C:\TestBuild\in\Core\x\xHierarchyBound.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F45D0 -> 0x001F46E0
*/
// Range: 0x1F45D0 -> 0x1F46E0
unsigned char xHierarchyBoundTest(class xHierarchyBound * bound /* r21 */, class xSweptSphere * sphere /* r20 */, unsigned short * boundUserData /* r19 */, signed char * subsphere /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1F45D0 -> 0x1F46E0
        unsigned int i; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F46E0 -> 0x001F4880
*/
// Range: 0x1F46E0 -> 0x1F4880
unsigned char xHierarchyBoundTest(class xHierarchyBound * bound /* r21 */, class xRay3 * testRay /* r20 */, unsigned short * boundUserData /* r22 */, class xIsect * isect /* r19 */, signed char * subsphere /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1F46E0 -> 0x1F4880
        class xIsect localIsect; // r29+0x90
        unsigned int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F4880 -> 0x001F49F0
*/
// Range: 0x1F4880 -> 0x1F49F0
void xHierarchyBoundInit(class xHierarchyBound * bound /* r18 */, class xHierarchyBoundInitData * init /* r17 */, float masterRadius /* r21 */, unsigned int extraBounds /* r23 */, float scale /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1F4880 -> 0x1F49F0
