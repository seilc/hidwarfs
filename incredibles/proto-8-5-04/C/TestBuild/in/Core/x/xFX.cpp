/*
    Compile unit: C:\TestBuild\in\Core\x\xFX.cpp
...
class RpAtomic * (* gAtomicRenderCallBack)(class RpAtomic *); // size: 0x4, address: 0x608A18
float EnvMapShininess; // size: 0x4, address: 0x0
float BumpMapBumpiness; // size: 0x4, address: 0x0
class RpLight * MainLight; // size: 0x4, address: 0x608A1C
static class RwFrame * g_matfx_frame; // size: 0x4, address: 0x608A20
unsigned int xfx_initted; // size: 0x4, address: 0x608A24
class xFXRing ringlist[8]; // size: 0x1E0, address: 0x642DE0
static class RxObjSpace3DVertex * Im3DBuffer; // size: 0x4, address: 0x0
static unsigned int Im3DBufferPos; // size: 0x4, address: 0x0
static class xFXBubbleParams defaultBFX[1]; // size: 0x18, address: 0x0
static class xFXBubbleParams BubbleBowl2FX; // size: 0x18, address: 0x0
static unsigned int bfx_curr; // size: 0x4, address: 0x0
static unsigned int bfx_max; // size: 0x4, address: 0x0
static class xFXBubbleParams * BFX; // size: 0x4, address: 0x0
static class RxPipeline * xFXanimUVPipeline; // size: 0x4, address: 0x608A28
float xFXanimUVRotMat0[2]; // size: 0x8, address: 0x6077A0
float xFXanimUVRotMat1[2]; // size: 0x8, address: 0x6077A8
float xFXanimUVTrans[2]; // size: 0x8, address: 0x608A30
float xFXanimUVScale[2]; // size: 0x8, address: 0x6077B0
float xFXanimUV2PRotMat0[2]; // size: 0x8, address: 0x6077B8
float xFXanimUV2PRotMat1[2]; // size: 0x8, address: 0x6077C0
float xFXanimUV2PTrans[2]; // size: 0x8, address: 0x608A38
float xFXanimUV2PScale[2]; // size: 0x8, address: 0x6077C8
class RwTexture * xFXanimUV2PTexture; // size: 0x4, address: 0x608A40
static class RwMatrixTag gFXUVs[2]; // size: 0x80, address: 0x642FC0
class RxPipeline * xFXgooPipeline; // size: 0x4, address: 0x608A44
class tier_queue_allocator joint_alloc; // size: 0x1C, address: 0x643040
class activity_data * activities[32]; // size: 0x80, address: 0x643060
signed int activities_used; // size: 0x4, address: 0x608A48
unsigned char need_sort; // size: 0x1, address: 0x608A4C
unsigned char HDR_brightening; // size: 0x1, address: 0x609450
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
signed int compare_ribbons(void *, void *); // size: 0x0, address: 0x196BB0
...
unsigned int gFXSurfaceFlags; // size: 0x4, address: 0x6085E0
...
class RpMaterial * MaterialSetShininess(class RpMaterial *, void *); // size: 0x0, address: 0x0
class RpMaterial * MaterialSetEnvMap2(class RpMaterial *, void *); // size: 0x0, address: 0x0
class RpMaterial * MatUpdateFrame(class RpMaterial *, void *); // size: 0x0, address: 0x0
class RpMaterial * MaterialDisableMatFX(class RpMaterial *, void *); // size: 0x0, address: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196010 -> 0x00196224
*/
// Range: 0x196010 -> 0x196224
void render_all() {
    /* anonymous block */ {
        // Range: 0x196010 -> 0x196224
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196230 -> 0x00196BB0
*/
// Range: 0x196230 -> 0x196BB0
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x196230 -> 0x196BB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196BB0 -> 0x00196C74
*/
// Range: 0x196BB0 -> 0x196C74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196C80 -> 0x0019718C
*/
// Range: 0x196C80 -> 0x19718C
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197190 -> 0x00197678
*/
// Range: 0x197190 -> 0x197678
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197680 -> 0x00197984
*/
// Range: 0x197680 -> 0x197984
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197990 -> 0x00197B9C
*/
// Range: 0x197990 -> 0x197B9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197BA0 -> 0x00197BDC
*/
// Range: 0x197BA0 -> 0x197BDC
class RwRaster * get_raster(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x197BA0 -> 0x197BDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197BE0 -> 0x00197C30
*/
// Range: 0x197BE0 -> 0x197C30
class RwRaster * get_raster(char * name /* r2 */) {
    /* anonymous block */ {
        // Range: 0x197BE0 -> 0x197C30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197C30 -> 0x00197E30
*/
// Range: 0x197C30 -> 0x197E30
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197E30 -> 0x001982F0
*/
// Range: 0x197E30 -> 0x1982F0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001982F0 -> 0x001987C8
*/
// Range: 0x1982F0 -> 0x1987C8
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001987D0 -> 0x00198854
*/
// Range: 0x1987D0 -> 0x198854
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198860 -> 0x00198900
*/
// Range: 0x198860 -> 0x198900
void load_default_config(class config_type & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x198860 -> 0x198900
        class curve_node default_curve[2]; // @ 0x005E7740
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198900 -> 0x00198A28
*/
// Range: 0x198900 -> 0x198A28
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198A30 -> 0x00198A48
*/
// Range: 0x198A30 -> 0x198A48
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198A50 -> 0x00198CD4
*/
// Range: 0x198A50 -> 0x198CD4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198CE0 -> 0x00198CE8
*/
// Range: 0x198CE0 -> 0x198CE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198CF0 -> 0x00198D34
*/
// Range: 0x198CF0 -> 0x198D34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198D40 -> 0x00198D54
*/
// Range: 0x198D40 -> 0x198D54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198D60 -> 0x00198D74
*/
// Range: 0x198D60 -> 0x198D74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198D80 -> 0x00198DC4
*/
// Range: 0x198D80 -> 0x198DC4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198DD0 -> 0x00198DE4
*/
// Range: 0x198DD0 -> 0x198DE4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198DF0 -> 0x00198E04
*/
// Range: 0x198DF0 -> 0x198E04
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198E10 -> 0x00198EE0
*/
// Range: 0x198E10 -> 0x198EE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198EE0 -> 0x00198F50
*/
// Range: 0x198EE0 -> 0x198F50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198F50 -> 0x00198F58
*/
// Range: 0x198F50 -> 0x198F58
void xFX_SceneExit() {
    /* anonymous block */ {
        // Range: 0x198F50 -> 0x198F58
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00198F60 -> 0x001992B4
*/
// Range: 0x198F60 -> 0x1992B4
void xFX_SceneEnter(class RpWorld * world /* r23 */) {
    /* anonymous block */ {
        ...
        class zSurfMatFX * fxp; // r19
        class RpMaterial * mp; // r18
        class RwTexture * env; // r2
        class RwTexture * bump; // r16
        class RwTexture * env; // r17
        class RwTexture * bump; // r16
        class xScene * sc; // r5
        class xEnt * ent; // r10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001992C0 -> 0x00199368
*/
// Range: 0x1992C0 -> 0x199368
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00199370 -> 0x00199478
*/
// Range: 0x199370 -> 0x199478
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00199480 -> 0x001995A4
*/
// Range: 0x199480 -> 0x1995A4
void xFXInit() {
    /* anonymous block */ {
        // Range: 0x199480 -> 0x1995A4
