/*
    Compile unit: C:\TestBuild\in\Core\x\xDecal.cpp
...
static class decal_instance * decals; // size: 0x4, address: 0x608D98
static class decal_instance * * render_list; // size: 0x4, address: 0x608D9C
static class immediate_mode_data * immediate_buffer; // size: 0x4, address: 0x608DA0
static class immediate_mode_data * immediate_free; // size: 0x4, address: 0x608DA4
static signed int decals_used; // size: 0x4, address: 0x608DA8
static unsigned char decals_sorted; // size: 0x1, address: 0x608DAC
static signed int immediate_indices_used; // size: 0x4, address: 0x608DB0
static signed int immediate_verts_used; // size: 0x4, address: 0x608DB4
static class pool_list owner_groups; // size: 0x20, address: 0x67F190
static float old_zbias; // size: 0x4, address: 0x608DB8
char * animix_labels[6]; // size: 0x18, address: 0x0
static class xDecalEmitter * active_emitters[32]; // size: 0x80, address: 0x67F1B0
static unsigned int active_emitters_size; // size: 0x4, address: 0x608DBC
...
signed int compare_decals(void *, void *); // size: 0x0, address: 0x202B70
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
__int128 vu1DataXYZShift; // size: 0x10, address: 0x5150D0
__int128 vu1DataXYZShift; // size: 0x10, address: 0x5150D0
signed int intersect_env_callback(class xClumpCollBSPTriangle *, void *); // size: 0x0, address: 0x2026D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FDD60 -> 0x001FE468
*/
// Range: 0x1FDD60 -> 0x1FE468
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FE470 -> 0x001FE9C8
*/
// Range: 0x1FE470 -> 0x1FE9C8
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FE9D0 -> 0x001FED20
*/
// Range: 0x1FE9D0 -> 0x1FED20
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FED20 -> 0x001FEFC0
*/
// Range: 0x1FED20 -> 0x1FEFC0
// this: r17
void xDecalEmitter::emit(class xMat4x3 & mat /* r2 */, signed int texture_index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1FED20 -> 0x1FEFC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FEFC0 -> 0x001FEFCC
*/
// Range: 0x1FEFC0 -> 0x1FEFCC
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FEFD0 -> 0x001FF1B0
*/
// Range: 0x1FEFD0 -> 0x1FF1B0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF1B0 -> 0x001FF200
*/
// Range: 0x1FF1B0 -> 0x1FF200
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF200 -> 0x001FF240
*/
// Range: 0x1FF200 -> 0x1FF240
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF240 -> 0x001FF300
*/
// Range: 0x1FF240 -> 0x1FF300
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF300 -> 0x001FF398
*/
// Range: 0x1FF300 -> 0x1FF398
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF3A0 -> 0x001FF3A8
*/
// Range: 0x1FF3A0 -> 0x1FF3A8
void xDecalInit() {
    /* anonymous block */ {
        // Range: 0x1FF3A0 -> 0x1FF3A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF3B0 -> 0x001FF9F0
*/
// Range: 0x1FF3B0 -> 0x1FF9F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001FF9F0 -> 0x00201134
*/
// Range: 0x1FF9F0 -> 0x201134
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201140 -> 0x00201438
*/
// Range: 0x201140 -> 0x201438
void sphere_emit(class emit_context & ec /* r18 */, class xVec3 & center /* r17 */, float radius /* r20 */, signed int check_flags /* r16 */) {
    /* anonymous block */ {
        // Range: 0x201140 -> 0x201438
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201440 -> 0x002016E4
*/
// Range: 0x201440 -> 0x2016E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002016F0 -> 0x002016FC
*/
// Range: 0x2016F0 -> 0x2016FC
void set_default_emit_context(class emit_context & context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2016F0 -> 0x2016FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201700 -> 0x00201EF0
*/
// Range: 0x201700 -> 0x201EF0
void render_all() {
    /* anonymous block */ {
        // Range: 0x201700 -> 0x201EF0
        signed int immediate_verts_used'364; // r3
        signed int i; // r7
        class decal_instance * decal; // r20
        class decal_instance * * it; // r17
        class decal_instance * * end; // r2
        unsigned int blend_mode; // r16
        class RwTexture * texture; // r29+0xCC
        class xMat4x3 * driver; // r22
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201EF0 -> 0x00202238
*/
// Range: 0x201EF0 -> 0x202238
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202240 -> 0x00202394
*/
// Range: 0x202240 -> 0x202394
void reset() {
    /* anonymous block */ {
        // Range: 0x202240 -> 0x202394
        class decal_instance * decal; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002023A0 -> 0x0020249C
*/
// Range: 0x2023A0 -> 0x20249C
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x2023A0 -> 0x20249C
        class decal_instance * decal; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002024A0 -> 0x00202510
*/
// Range: 0x2024A0 -> 0x202510
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x2024A0 -> 0x202510
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202510 -> 0x002026CC
*/
// Range: 0x202510 -> 0x2026CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002026D0 -> 0x00202B64
*/
// Range: 0x2026D0 -> 0x202B64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202B70 -> 0x00202C00
*/
// Range: 0x202B70 -> 0x202C00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202C00 -> 0x00202E78
*/
// Range: 0x202C00 -> 0x202E78
static class decal_instance * create_decal(class emit_context & ec /* r17 */, class xMat4x3 * driver /* r2 */, class owner_group_type * owner_group /* r2 */) {
    /* anonymous block */ {
        // Range: 0x202C00 -> 0x202E78
        unsigned short rwmodes[3][2]; // @ 0x005E90D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202E80 -> 0x00203340
*/
// Range: 0x202E80 -> 0x203340
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203340 -> 0x00203470
*/
// Range: 0x203340 -> 0x203470
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203470 -> 0x0020350C
*/
// Range: 0x203470 -> 0x20350C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203510 -> 0x0020375C
*/
// Range: 0x203510 -> 0x20375C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203760 -> 0x00203864
*/
// Range: 0x203760 -> 0x203864
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203870 -> 0x00203BE8
*/
// Range: 0x203870 -> 0x203BE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00203BF0 -> 0x00204FEC
*/
// Range: 0x203BF0 -> 0x204FEC
static void clip_decal_indexed(class clip_decal_indexed_params & arg /* r21 */) {
    /* anonymous block */ {
        ...
        signed int * poly_vert_index; // r15
        signed int * pvi; // r14
        signed int vi; // r2
        unsigned short & stored; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00204FF0 -> 0x00205C0C
*/
// Range: 0x204FF0 -> 0x205C0C
static void clip_decal(class clip_decal_params & arg /* r2 */) {
    /* anonymous block */ {
        ...
        class xVec2 * poly_uv; // r17
        class xVec3 * pv; // r18
        class xVec2 * puv; // r16
        class xVec2 * end_puv; // r2
        class xVec3 * tri_vert1; // r16
        class xVec3 * tri_vert2; // r15
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00205C10 -> 0x00205D88
*/
// Range: 0x205C10 -> 0x205D88
