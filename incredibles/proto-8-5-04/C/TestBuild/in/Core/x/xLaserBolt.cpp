/*
    Compile unit: C:\TestBuild\in\Core\x\xLaserBolt.cpp
...
class xLaserBoltEmitter {
    // Members
public:
    class config cfg; // offset 0x0, size 0x50
    class static_queue bolts; // offset 0x50, size 0x14
    class xBase * owner; // offset 0x64, size 0x4
    float ialpha; // offset 0x68, size 0x4
    class RwRaster * bolt_raster; // offset 0x6C, size 0x4
    signed int start_collide; // offset 0x70, size 0x4
    class effect_data * fx[7]; // offset 0x74, size 0x1C
    unsigned int fxsize[7]; // offset 0x90, size 0x1C
};
// total size: 0x10
class iEnvMatOrder {
    // Members
...
public:
    ...
    float fade_dist; // offset 0x10, size 0x4
    float kill_dist; // offset 0x14, size 0x4
    float safe_dist; // offset 0x18, size 0x4
    float hit_radius; // offset 0x1C, size 0x4
    float rand_ang; // offset 0x20, size 0x4
    float scar_life; // offset 0x24, size 0x4
    class xVec2 bolt_uv[2]; // offset 0x28, size 0x10
    signed int hit_interval; // offset 0x38, size 0x4
    float damage; // offset 0x3C, size 0x4
    float knockback; // offset 0x40, size 0x4
    float knockback_pitch; // offset 0x44, size 0x4
    unsigned int blend_src; // offset 0x48, size 0x4
    unsigned int blend_dst; // offset 0x4C, size 0x4
};
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EAF40 -> 0x002EB73C
*/
// Range: 0x2EAF40 -> 0x2EB73C
void emit_decal_dist(class effect_data & effect /* r21 */, class bolt & b /* r2 */, float from_dist /* r29+0x170 */, float to_dist /* r29+0x170 */) {
    /* anonymous block */ {
        // Range: 0x2EAF40 -> 0x2EB73C
        float start_dist; // r1
        signed int total; // r2
        class xMat4x3 mat; // r29+0x80
        class xVec3 dloc; // r29+0x160
        signed int i; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EB740 -> 0x002ED7B4
*/
// Range: 0x2EB740 -> 0x2ED7B4
// this: r30
void xLaserBoltEmitter::update_fx(class bolt & b /* r21 */, float prev_dist /* r26 */, float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x2EB740 -> 0x2ED7B4
        float tail_dist; // r24
        class effect_data * itfx; // r20
        class effect_data * endfx; // r2
        class effect_data * itfx; // r20
        class effect_data * endfx; // r2
        float from_dist; // r23
        float to_dist; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ED7C0 -> 0x002ED92C
*/
// Range: 0x2ED7C0 -> 0x2ED92C
// this: r17
void xLaserBoltEmitter::apply_damage(class bolt & b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2ED7C0 -> 0x2ED92C
        class zCombatDamageInfo com; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002ED930 -> 0x002EDB10
*/
// Range: 0x2ED930 -> 0x2EDB10
// this: r17
void xLaserBoltEmitter::collide_update(class bolt & b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2ED930 -> 0x2EDB10
        class xScene & scene; // r20
        class xRay3 ray; // r29+0xE0
        class xVec3 player_hit_norm; // r29+0x110
        unsigned char player_hit; // r2
        class xCollis scene_coll; // r29+0x80
        class zEntSimpleObj * reactive_hits[8]; // r29+0x60
        signed int reactive_hits_size; // r2
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EDB10 -> 0x002EDD28
*/
// Range: 0x2EDB10 -> 0x2EDD28
static unsigned char ray_hits_player(class xRay3 & ray /* r19 */, float & dist /* r18 */, class xVec3 & norm /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2EDB10 -> 0x2EDD28
        class xSphere * hit; // r16
        class xSphere * player_spheres[5]; // r29+0x50
        signed int player_spheres_size; // r2
        class xSphere * * o; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EDD30 -> 0x002EDE54
*/
// Range: 0x2EDD30 -> 0x2EDE54
// this: r17
void xLaserBoltEmitter::pre_collide(class bolt & b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2EDD30 -> 0x2EDE54
        class xScene & scene; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EDE60 -> 0x002EDEE0
*/
// Range: 0x2EDE60 -> 0x2EDEE0
// this: r2
void xLaserBoltEmitter::attach_effects(enum fx_when_enum when /* r2 */, class effect_data * fx /* r2 */, unsigned int fxsize /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EDE60 -> 0x2EDEE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EDEE0 -> 0x002EE500
*/
// Range: 0x2EDEE0 -> 0x2EE500
// this: r16
void xLaserBoltEmitter::render() {
    /* anonymous block */ {
        // Range: 0x2EDEE0 -> 0x2EE500
        signed int bolts_size; // r2
        class HIFastIMLockStruct lock; // r29+0xB0
        class xVec3 * pos; // r7
        class xVec2 * uv; // r6
        unsigned int * color; // r5
        class xMat4x3 & view_mat; // r4
        float ialpha; // r11
        float thickness; // r10
        signed int i; // r3
        class bolt & b; // r2
        ...
        float By; // r5
        float Bz; // r4
        class xVec3 loc0; // r29+0x100
        class xVec3 loc1; // r29+0xF0
        class xVec3 screen_loc0; // r29+0xE0
        class xVec3 screen_loc1; // r29+0xD0
        float rz0; // r29+0x110
        float rz1; // r29+0x110
        float sRx; // r29+0x110
        float sRy; // r29+0x110
        ...
        float Ry; // r17
        float Rz; // r16
        float Rmag2; // r29+0x110
        float Rscale; // r29+0x110
        unsigned int ucolor; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EE500 -> 0x002EF87C
*/
// Range: 0x2EE500 -> 0x2EF87C
// this: r21
void xLaserBoltEmitter::update(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2EE500 -> 0x2EF87C
        signed int ci; // r29+0xD0
        class iterator it; // r29+0x2A8
        unsigned char collided; // r2
        float prev_dist; // r21
        class effect_data * itfx; // r20
        class effect_data * endfx; // r2
        class effect_data * itfx; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002EF880 -> 0x002F02D4
*/
// Range: 0x2EF880 -> 0x2F02D4
// this: r30
void xLaserBoltEmitter::emit(class xVec3 & loc /* r2 */, class xVec3 & dir /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EF880 -> 0x2F02D4
        class effect_data * itfx; // r20
        class effect_data * endfx; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F02E0 -> 0x002F0320
*/
// Range: 0x2F02E0 -> 0x2F0320
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F0320 -> 0x002F0C3C
*/
// Range: 0x2F0320 -> 0x2F0C3C
// this: r21
void xLaserBoltEmitter::reset() {
    /* anonymous block */ {
        // Range: 0x2F0320 -> 0x2F0C3C
        class iterator it; // r29+0x188
        class effect_data * itfx; // r20
        class effect_data * endfx; // r2
        signed int i; // r6
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F0C40 -> 0x002F0C88
*/
// Range: 0x2F0C40 -> 0x2F0C88
// this: r16
void xLaserBoltEmitter::set_texture(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F0C40 -> 0x2F0C88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F0C90 -> 0x002F0D4C
*/
// Range: 0x2F0C90 -> 0x2F0D4C
// this: r16
void xLaserBoltEmitter::init(unsigned int max_bolts /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2F0C90 -> 0x2F0D4C
    }
}
