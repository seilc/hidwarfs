/*
    Compile unit: C:\TestBuild\in\Core\x\xBallPhysics.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBDF0 -> 0x002BBFE0
*/
// Range: 0x2BBDF0 -> 0x2BBFE0
// this: r17
unsigned char xBallPhysics::on_ground(class xEnt * ent /* r16 */, class xVec3 & position /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2BBDF0 -> 0x2BBFE0
        class xVec3 start; // r29+0x130
        class xVec3 end; // r29+0x120
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BBFE0 -> 0x002BCA58
*/
// Range: 0x2BBFE0 -> 0x2BCA58
// this: r20
unsigned char xBallPhysics::collide(class xEnt * ent /* r29+0xCC */, class xVec3 & position /* r19 */, class xVec3 & collide_pos /* r23 */, class xVec3 & dpos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2BBFE0 -> 0x2BCA58
        class xSweptSphere sws; // r29+0xF0
        signed int rc; // r22
        class xVec3 start; // r29+0x300
        class xVec3 end; // r29+0x2F0
        signed int depth; // r21
        signed int stat; // r2
        signed int env; // r2
        class xSphere * extra_spheres[6]; // r29+0xD0
        signed int num_spheres; // r2
        signed int i; // r30
        class xSurface * surf; // r2
        class xVec3 new_direction; // r29+0x2E0
        float result; // r29+0x310
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BCA70 -> 0x002BCEE0
*/
// Range: 0x2BCA70 -> 0x2BCEE0
// this: r18
void xBallPhysics::update_position(class xEnt * ent /* r17 */, class xVec3 & position /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2BCA70 -> 0x2BCEE0
        class xVec3 direction; // r29+0xB0
        class xVec3 collide_pos; // r29+0xA0
        class xVec2 velXZ; // r29+0x98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BCEE0 -> 0x002BCFC0
*/
// Range: 0x2BCEE0 -> 0x2BCFC0
// this: r17
void xBallPhysics::update_ent(class xEnt * ent /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2BCEE0 -> 0x2BCFC0
        class xVec3 bound_pos; // r29+0x70
        class xVec3 new_pos; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BCFC0 -> 0x002BD384
*/
// Range: 0x2BCFC0 -> 0x2BD384
// this: r17
void xBallPhysics::update_rotation(class xMat4x3 & mat /* r16 */, class xVec3 & rot_center /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2BCFC0 -> 0x2BD384
        class xVec3 & position; // r2
        class xVec3 prev_bound_trans; // r29+0x120
        class xVec3 new_bound_trans; // r29+0x110
        class xVec3 dpos; // r29+0x100
        float angle_change; // r20
        class xVec3 direction; // r29+0xF0
        class xVec3 right; // r29+0xE0
        class xQuat q; // r29+0x50
        class xQuat original_rotation; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002BD390 -> 0x002BD40C
*/
// Range: 0x2BD390 -> 0x2BD40C
// this: r2
