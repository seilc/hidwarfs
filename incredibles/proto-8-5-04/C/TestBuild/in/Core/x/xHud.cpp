/*
    Compile unit: C:\TestBuild\in\Core\x\xHud.cpp
...
} known_types[5]; // size: 0x28, address: 0x5E7CD0
class block_allocator motive_allocator; // size: 0x10, address: 0x66BAB0
static unsigned char inited; // size: 0x1, address: 0x608BB8
// total size: 0x28
...
void fp_render(class widget &); // size: 0x0, address: 0x1CA480
void fp_setup(class widget &); // size: 0x0, address: 0x0
unsigned char delay_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x0
void right_hide_widget(class widget &, class motive &); // size: 0x0, address: 0x0
void left_hide_widget(class widget &, class motive &); // size: 0x0, address: 0x0
void bottom_hide_widget(class widget &, class motive &); // size: 0x0, address: 0x0
void top_hide_widget(class widget &, class motive &); // size: 0x0, address: 0x0
unsigned char linear_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x1C9C90
unsigned char accelerate_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x1C9B80
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x1CA1B0
// total size: 0x34
class RwRaster {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9B80 -> 0x001C9C90
*/
// Range: 0x1C9B80 -> 0x1C9C90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9C90 -> 0x001C9D7C
*/
// Range: 0x1C9C90 -> 0x1C9D7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9D80 -> 0x001CA0FC
*/
// Range: 0x1C9D80 -> 0x1CA0FC
void render_model(class xModelInstance & m /* r18 */, class render_context & rc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1C9D80 -> 0x1CA0FC
        class basic_rect r; // r29+0x90
        class xVec3 from; // r29+0xB0
        class xVec3 to; // r29+0xA0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA100 -> 0x001CA1B0
*/
// Range: 0x1CA100 -> 0x1CA1B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA1B0 -> 0x001CA1CC
*/
// Range: 0x1CA1B0 -> 0x1CA1CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA1D0 -> 0x001CA234
*/
// Range: 0x1CA1D0 -> 0x1CA234
// this: r2
unsigned char widget::active() {
    /* anonymous block */ {
        // Range: 0x1CA1D0 -> 0x1CA234
        class motive_node * * itp; // r5
        class motive_node * it; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA240 -> 0x001CA2C8
*/
// Range: 0x1CA240 -> 0x1CA2C8
// this: r2
void widget::clear_motives(unsigned char (* fp_update)(class widget &, class motive &, float) /* r2 */, void * context /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1CA240 -> 0x1CA2C8
        class motive_node * * itp; // r11
        class motive_node * it; // r10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA2D0 -> 0x001CA3A8
*/
// Range: 0x1CA2D0 -> 0x1CA3A8
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA3B0 -> 0x001CA480
*/
// Range: 0x1CA3B0 -> 0x1CA480
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA480 -> 0x001CA4D0
*/
// Range: 0x1CA480 -> 0x1CA4D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA4D0 -> 0x001CA960
*/
// Range: 0x1CA4D0 -> 0x1CA960
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA960 -> 0x001CAD44
*/
// Range: 0x1CA960 -> 0x1CAD44
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAD50 -> 0x001CADA4
*/
// Range: 0x1CAD50 -> 0x1CADA4
unsigned char is(unsigned int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CAD50 -> 0x1CADA4
        signed char @5807; // @ 0x00608BC0
        unsigned int myid; // @ 0x00608BBC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CADB0 -> 0x001CADF0
*/
// Range: 0x1CADB0 -> 0x1CADF0
unsigned int type() {
    /* anonymous block */ {
        // Range: 0x1CADB0 -> 0x1CADF0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CADF0 -> 0x001CAE90
*/
// Range: 0x1CADF0 -> 0x1CAE90
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x1CADF0 -> 0x1CAE90
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAE90 -> 0x001CAFB8
*/
// Range: 0x1CAE90 -> 0x1CAFB8
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAFC0 -> 0x001CAFC8
*/
// Range: 0x1CAFC0 -> 0x1CAFC8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAFD0 -> 0x001CAFD8
*/
// Range: 0x1CAFD0 -> 0x1CAFD8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAFE0 -> 0x001CB038
*/
// Range: 0x1CAFE0 -> 0x1CB038
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB040 -> 0x001CB13C
*/
// Range: 0x1CB040 -> 0x1CB13C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB140 -> 0x001CB1D4
*/
// Range: 0x1CB140 -> 0x1CB1D4
void render() {
    /* anonymous block */ {
        // Range: 0x1CB140 -> 0x1CB1D4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB1E0 -> 0x001CB234
*/
// Range: 0x1CB1E0 -> 0x1CB234
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB240 -> 0x001CB2A0
*/
// Range: 0x1CB240 -> 0x1CB2A0
void destroy() {
    /* anonymous block */ {
        // Range: 0x1CB240 -> 0x1CB2A0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB2A0 -> 0x001CB31C
*/
// Range: 0x1CB2A0 -> 0x1CB31C
void init() {
    /* anonymous block */ {
        // Range: 0x1CB2A0 -> 0x1CB31C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB320 -> 0x001CB3D4
*/
// Range: 0x1CB320 -> 0x1CB3D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB3E0 -> 0x001CB464
*/
// Range: 0x1CB3E0 -> 0x1CB464
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB470 -> 0x001CB514
*/
// Range: 0x1CB470 -> 0x1CB514
