/*
    Compile unit: C:\TestBuild\in\Core\x\xFXHighDynamicRange.cpp
...
static float overbrighten; // size: 0x4, address: 0x6083B0
static float overbrighten_decay; // size: 0x4, address: 0x6083B4
static signed int downsamples; // size: 0x4, address: 0x6083B8
static unsigned char blur_faster; // size: 0x1, address: 0x6083BC
static float colorize_red; // size: 0x4, address: 0x6083C0
static float colorize_green; // size: 0x4, address: 0x6083C4
static float colorize_blue; // size: 0x4, address: 0x6083C8
static float colorize_alpha; // size: 0x4, address: 0x6083CC
static unsigned char enabled; // size: 0x1, address: 0x6083D0
static signed int background_glow_normal; // size: 0x4, address: 0x609454
static signed int background_darken_normal; // size: 0x4, address: 0x609458
static class interpolator background_glow; // size: 0x18, address: 0x6B9D80
static class interpolator background_darken; // size: 0x18, address: 0x6B9DA0
static signed int saved_alpha_test; // size: 0x4, address: 0x60945C
static __int128 * blur_packet[5]; // size: 0x14, address: 0x0
static class xVec2 diagonal_00_11_offsets[2]; // size: 0x10, address: 0x5F9690
static class xVec2 diagonal_01_10_offsets[2]; // size: 0x10, address: 0x5F96A0
static class xVec2 square_offsets[4]; // size: 0x20, address: 0x5F96B0
static class downsample_pass_info downsample_passes_fast[5]; // size: 0x28, address: 0x5F96D0
static class downsample_pass_info downsample_passes_slow[5]; // size: 0x28, address: 0x5F9700
static class xFXCameraTexture blurbuffer[5]; // size: 0x168, address: 0x6B9DC0
static class RwRaster * backbuffer_raster; // size: 0x4, address: 0x0
static class xFXCameraTexture downbuffer[5]; // size: 0x168, address: 0x6B9F30
static signed int old_alpha_test; // size: 0x4, address: 0x6083D4
static signed int our_alpha_test; // size: 0x4, address: 0x609460
...
class xColor_tag g_MAGENTA; // size: 0x4, address: 0x5E71F8
unsigned int FB_YRES; // size: 0x4, address: 0x6076C0
unsigned int FB_XRES; // size: 0x4, address: 0x6076BC
// total size: 0xA0
class _rpPTankSkyTransformInfo {
    // Members
public:
    unsigned long prim; // offset 0x0, size 0x4
    unsigned long regs; // offset 0x8, size 0x4
    unsigned int batchSize; // offset 0x10, size 0x4
    unsigned int offset; // offset 0x14, size 0x4
    unsigned int numClusters; // offset 0x18, size 0x4
    void * vuCode[2]; // offset 0x1C, size 0x8
    class _rpPTankSkyClusterInfo clusters[5]; // offset 0x24, size 0x78
    unsigned int pad; // offset 0x9C, size 0x4
};
// total size: 0x28
class mblur_data {
    // Members
...
// total size: 0x20
class _rpPTankSkyBufferInfo {
    // Members
public:
    class RwSkySplitBits128 callTag; // offset 0x0, size 0x10
    unsigned int refCnt; // offset 0x10, size 0x4
    unsigned int clrCnt; // offset 0x14, size 0x4
    unsigned int limit; // offset 0x18, size 0x4
    unsigned int start; // offset 0x1C, size 0x4
};
// total size: 0x4
class xColor_tag {
    // Members
...
// total size: 0x8
class downsample_pass_info {
    // Members
public:
    class xVec2 * offset; // offset 0x0, size 0x4
    signed int resamples; // offset 0x4, size 0x4
};
// total size: 0x4
class RpSector {
    // Members
...
// total size: 0x18
class _rpPTankSkyClusterInfo {
    // Members
public:
    unsigned int cluster; // offset 0x0, size 0x4
    unsigned int batchSize; // offset 0x4, size 0x4
    unsigned int constSize; // offset 0x8, size 0x4
    unsigned int batchUnpack; // offset 0xC, size 0x4
    unsigned int constUnpack; // offset 0x10, size 0x4
    unsigned int cmd; // offset 0x14, size 0x4
};
// total size: 0x4E8
...
// total size: 0x10
class RwSkySplitBits128 {
    // Members
public:
    union { // inferred
        __int128 field128; // offset 0x0, size 0x10
        unsigned long field_64[2]; // offset 0x0, size 0x8
        class RwSplitBits field_32[4]; // offset 0x0, size 0x10
    };
};
// total size: 0x18
class xGridBound {
...
// total size: 0x190
class RpPTankSkyData {
    // Members
public:
    class _rpPTankSkyBufferInfo buffers[2]; // offset 0x0, size 0x40
    class RwSkySplitBits128 clusterTags[5]; // offset 0x40, size 0x50
    unsigned long clusterStrides[5]; // offset 0x90, size 0x14
    unsigned long alpha; // offset 0xB8, size 0x4
    unsigned long clamp; // offset 0xC0, size 0x4
    unsigned long test; // offset 0xC8, size 0x4
    unsigned long tex1; // offset 0xD0, size 0x4
    signed int fastPipe; // offset 0xD8, size 0x4
    signed int refillDMApacket; // offset 0xDC, size 0x4
    signed int frameBuffering; // offset 0xE0, size 0x4
    signed int frameIdx; // offset 0xE4, size 0x4
    signed int bufferedFrame; // offset 0xE8, size 0x4
    unsigned int instFlag[2]; // offset 0xEC, size 0x8
    unsigned char vuStride[4]; // offset 0xF4, size 0x4
    void * vuCode; // offset 0xF8, size 0x4
    class _rpPTankSkyTransformInfo * transformInfo; // offset 0xFC, size 0x4
    signed int clusterConst[9]; // offset 0x100, size 0x24
    unsigned int maxBatches; // offset 0x124, size 0x4
    unsigned int tagBatchSize; // offset 0x128, size 0x4
    unsigned int dataBatchSize; // offset 0x12C, size 0x4
    unsigned int tagConstSize; // offset 0x130, size 0x4
    unsigned int dataConstSize; // offset 0x134, size 0x4
    class RwResEntry * resEntry[2]; // offset 0x138, size 0x8
    void * clusters[2][9]; // offset 0x140, size 0x48
};
// total size: 0xC
...
class interpolator {
    // Members
public:
    signed int value; // offset 0x0, size 0x4
    float start; // offset 0x4, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EB90 -> 0x0041EC94
*/
// Range: 0x41EB90 -> 0x41EC94
void xFXHighDynamicRangeSetBackgroundDefault(signed int glow /* r2 */, signed int darken /* r2 */, unsigned char apply /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41EB90 -> 0x41EC94
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041ECA0 -> 0x0041EE20
*/
// Range: 0x41ECA0 -> 0x41EE20
void xFXHighDynamicRangeSetBackground(signed int glow /* r2 */, signed int darken /* r2 */, float time /* r29 */) {
    /* anonymous block */ {
        // Range: 0x41ECA0 -> 0x41EE20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EE20 -> 0x0041EE50
*/
// Range: 0x41EE20 -> 0x41EE50
void xFXHighDynamicRangeResetGlowClamp() {
    /* anonymous block */ {
        // Range: 0x41EE20 -> 0x41EE50
        signed int alpha_test; // r29+0x1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EE50 -> 0x0041EEE4
*/
// Range: 0x41EE50 -> 0x41EEE4
void xFXHighDynamicRangeSetGlowClamp(signed int glow_min /* r2 */, unsigned char dest_test /* r17 */) {
    /* anonymous block */ {
        // Range: 0x41EE50 -> 0x41EEE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EEF0 -> 0x0041EF2C
*/
// Range: 0x41EEF0 -> 0x41EF2C
void xFXHighDynamicRangeGetConfiguration(class xFXHighDynamicRangeConfiguration & configuration /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41EEF0 -> 0x41EF2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EF30 -> 0x0041EF6C
*/
// Range: 0x41EF30 -> 0x41EF6C
void xFXHighDynamicRangeSetConfiguration(class xFXHighDynamicRangeConfiguration & configuration /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41EF30 -> 0x41EF6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EF70 -> 0x0041EF7C
*/
// Range: 0x41EF70 -> 0x41EF7C
signed int xFXHighDynamicRangeGetBackgroundGlow() {
    /* anonymous block */ {
        // Range: 0x41EF70 -> 0x41EF7C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041EF80 -> 0x0041F124
*/
// Range: 0x41EF80 -> 0x41F124
void xFXHighDynamicRangeUpdate(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x41EF80 -> 0x41F124
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041F130 -> 0x0041F36C
*/
// Range: 0x41F130 -> 0x41F36C
void xFXHighDynamicRangeTunePalette(class RwRaster * raster /* r18 */, float base_alpha /* r20 */, unsigned char additive /* r17 */) {
    /* anonymous block */ {
        // Range: 0x41F130 -> 0x41F36C
        signed int format; // r2
        signed int palette_size; // r16
        float min_alpha; // r22
        class xColor_tag * start_color; // r2
        class xColor_tag * color; // r6
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041F370 -> 0x0041F390
*/
// Range: 0x41F370 -> 0x41F390
void xFXHighDynamicRangeRestorePtank(class RpAtomic * ptank /* r2 */, unsigned int oldtest /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41F370 -> 0x41F390
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041F390 -> 0x0041F424
*/
// Range: 0x41F390 -> 0x41F424
unsigned int xFXHighDynamicRangeBrightenPtank(class RpAtomic * ptank /* r2 */, unsigned char bright /* r2 */) {
    /* anonymous block */ {
        // Range: 0x41F390 -> 0x41F424
        class RpPTankSkyData * sky_ptank_data; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041F430 -> 0x0041FBDC
*/
// Range: 0x41F430 -> 0x41FBDC
void xFXHighDynamicRangeRender() {
    /* anonymous block */ {
        // Range: 0x41F430 -> 0x41FBDC
        class xFXFastRaster fr; // r29+0xC0
        signed int i; // r30
        signed int j; // r19
        class RwRaster * backbuffer_raster; // r20
        unsigned int msb; // r29+0x12C
        unsigned int lsb; // r29+0x128
        float u; // r4
        float v; // r3
        class _xFColor colorize; // r29+0xB0
        float overbrighten; // r20
        float alpha; // r21
        float resample_alpha; // r29+0x130
        signed int resamples; // r2
        class RwRaster * final_raster; // r2
        float darken_alpha; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041FBE0 -> 0x0041FD4C
*/
// Range: 0x41FBE0 -> 0x41FD4C
void xFXHighDynamicRangeStartRender() {
    /* anonymous block */ {
        // Range: 0x41FBE0 -> 0x41FD4C
        class xColor_tag color; // r29+0x2C
        class xFXFastRaster fr; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041FD50 -> 0x0041FDD8
*/
// Range: 0x41FD50 -> 0x41FDD8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041FDE0 -> 0x0041FDE8
*/
// Range: 0x41FDE0 -> 0x41FDE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041FDF0 -> 0x0041FDF8
*/
// Range: 0x41FDF0 -> 0x41FDF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0041FE00 -> 0x00420040
*/
// Range: 0x41FE00 -> 0x420040
void xFXHighDynamicRangeInit() {
    /* anonymous block */ {
        // Range: 0x41FE00 -> 0x420040
        signed int width; // r20
        signed int height; // r19
        signed int i; // r21
        signed int awidth; // r22
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00420040 -> 0x00420054
*/
// Range: 0x420040 -> 0x420054
void xFXHighDynamicRangeSetColorize(float r /* r29 */, float g /* r29 */, float b /* r29 */, float alpha /* r29 */) {
    /* anonymous block */ {
        // Range: 0x420040 -> 0x420054
    }
}
