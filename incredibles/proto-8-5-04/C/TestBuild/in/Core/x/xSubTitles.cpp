/*
    Compile unit: C:\TestBuild\in\Core\x\xSubTitles.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class basic_rect screen_bounds; // size: 0x10, address: 0x5F06B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F8E80 -> 0x002F93E8
*/
// Range: 0x2F8E80 -> 0x2F93E8
unsigned char xSubTitlesRender(unsigned int aid /* r16 */, float fTime /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2F8E80 -> 0x2F93E8
        unsigned int uSearchIndex; // r7
        char * pszDisplay; // r2
        class xtextbox tbSubtitles; // r29+0x170
        class xSubtitlesAsset * m_pCurrentAsset; // @ 0x006090C0
        unsigned int m_uLastTimeKey; // @ 0x006090C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F93F0 -> 0x002F93F8
*/
// Range: 0x2F93F0 -> 0x2F93F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002F9400 -> 0x002F946C
*/
// Range: 0x2F9400 -> 0x2F946C
void * xSubTitlesRead(void * indata /* r19 */, unsigned int insize /* r18 */, unsigned int * outsize /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2F9400 -> 0x2F946C
        class xSubtitlesAsset * pSubTitleAsset; // r16
    }
}
