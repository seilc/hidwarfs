/*
    Compile unit: C:\TestBuild\in\Core\x\xScrFx.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
unsigned char g_debugRenderSafeArea; // size: 0x1, address: 0x608AE8
static class _xFadeData mFade; // size: 0x18, address: 0x655EB0
static float mLetterboxO; // size: 0x4, address: 0x608AEC
static float mLetterboxTO; // size: 0x4, address: 0x608AF0
static float sLetterBoxSize; // size: 0x4, address: 0x608AF4
static unsigned char sLetterBoxAlpha; // size: 0x1, address: 0x6077DC
class xGlare sGlare[10]; // size: 0x208, address: 0x655ED0
class xVec3 sFullScreenGlareDir; // size: 0xC, address: 0x5084B8
float sFullScreenGlareIntensity; // size: 0x4, address: 0x6077E0
class RwRGBA sFullScreenGlareColor; // size: 0x4, address: 0x6077E4
signed int sFullScreenGlareEnabled; // size: 0x4, address: 0x608AF8
unsigned int sFullScreenGlareTextureID; // size: 0x4, address: 0x6077E8
class RwTexture * sFullScreenGlareTexturePtr; // size: 0x4, address: 0x608AFC
static class xMat4x3 sCameraFXMatOld; // size: 0x40, address: 0x656270
static unsigned char anycameraFXActive; // size: 0x1, address: 0x608B00
class cameraFXTableEntry sCameraFXTable[3]; // size: 0x24, address: 0x5084D0
class cameraFX sCameraFX[10]; // size: 0x2F8, address: 0x6562B0
static class xScrFxLensFlareSource * sFlareSource; // size: 0x4, address: 0x608B04
static signed int sNumFlareSources; // size: 0x4, address: 0x608B08
static class xScrFxLensFlareParams sDefaultLensFlareParams; // size: 0x10, address: 0x508500
static class xScrFxLensFlareParams * sLensFlareParams; // size: 0x4, address: 0x6077F8
static class iScrFxLensFlare sFlare[128]; // size: 0x1800, address: 0x6565B0
static signed int sNumFlares; // size: 0x4, address: 0x608B0C
class RwTexture * gxFlareTexture; // size: 0x4, address: 0x608B10
class RwFrame * gxFlareFrame; // size: 0x4, address: 0x608B20
signed int sort_flares; // size: 0x4, address: 0x608B24
signed int dumpFlares; // size: 0x4, address: 0x0
signed int lfcmp(void *, void *); // size: 0x0, address: 0x1B12B0
void xScrFxLensFlare_RenderElements(class RwRaster *, class RwFrame *, unsigned char, void *); // size: 0x0, address: 0x1B12D0
class RwCamera * globalCamera; // size: 0x4, address: 0x608D40
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x6B2890
void LensFlareSourceCB(void *, unsigned int, void *); // size: 0x0, address: 0x1B1E40
unsigned int gActiveHeap; // size: 0x4, address: 0x608A5C
void LensFlareElementCB(void *, unsigned int, void *); // size: 0x0, address: 0x1B2140
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0E00 -> 0x001B12A8
*/
// Range: 0x1B0E00 -> 0x1B12A8
void xScrFxLensFlare_Render(class RwCamera * cam /* r22 */) {
    /* anonymous block */ {
        ...
        signed int i; // r3
        signed int i; // r19
        class xScrFxLensFlareSource * source; // r18
        float intensity; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B12B0 -> 0x001B12D0
*/
// Range: 0x1B12B0 -> 0x1B12D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B12D0 -> 0x001B1B34
*/
// Range: 0x1B12D0 -> 0x1B1B34
static void xScrFxLensFlare_RenderElements(class RwFrame * frame /* r17 */, unsigned char vCol /* r18 */, void * flr /* r19 */) {
    /* anonymous block */ {
        ...
        class xScrFxLensFlareElement * ep; // r7
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1B40 -> 0x001B1B6C
*/
// Range: 0x1B1B40 -> 0x1B1B6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1B70 -> 0x001B1E34
*/
// Range: 0x1B1B70 -> 0x1B1E34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1E40 -> 0x001B2134
*/
// Range: 0x1B1E40 -> 0x1B2134
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2140 -> 0x001B2168
*/
// Range: 0x1B2140 -> 0x1B2168
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2170 -> 0x001B2344
*/
// Range: 0x1B2170 -> 0x1B2344
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2350 -> 0x001B2384
*/
// Range: 0x1B2350 -> 0x1B2384
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2390 -> 0x001B24F0
*/
// Range: 0x1B2390 -> 0x1B24F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B24F0 -> 0x001B2880
*/
// Range: 0x1B24F0 -> 0x1B2880
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2880 -> 0x001B29D8
*/
// Range: 0x1B2880 -> 0x1B29D8
class cameraFX * xCameraFXShake(float maxTime /* r24 */, float magnitude /* r23 */, float cycleMax /* r22 */, float rotate_magnitude /* r21 */, float radius /* r20 */, class xVec3 * epicenter /* r18 */, class xVec3 * player /* r17 */, unsigned char shakeY /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B2880 -> 0x1B29D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B29E0 -> 0x001B2A00
*/
// Range: 0x1B29E0 -> 0x1B2A00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2A00 -> 0x001B2A28
*/
// Range: 0x1B2A00 -> 0x1B2A28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2A30 -> 0x001B2B74
*/
// Range: 0x1B2A30 -> 0x1B2B74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2B80 -> 0x001B2BC8
*/
// Range: 0x1B2B80 -> 0x1B2BC8
void xCameraFXKill() {
    /* anonymous block */ {
        // Range: 0x1B2B80 -> 0x1B2BC8
        signed int i; // r6
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2BD0 -> 0x001B2BD8
*/
// Range: 0x1B2BD0 -> 0x1B2BD8
unsigned char xCameraFXAnyActive() {
    /* anonymous block */ {
        // Range: 0x1B2BD0 -> 0x1B2BD8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2BE0 -> 0x001B2C38
*/
// Range: 0x1B2BE0 -> 0x1B2C38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2C40 -> 0x001B307C
*/
// Range: 0x1B2C40 -> 0x1B307C
void xScrFxDrawBox(float x1 /* r29+0x10 */, float y1 /* r29+0x10 */, float x2 /* r29+0x10 */, float y2 /* r29+0x10 */, unsigned char red /* r2 */, unsigned char green /* r2 */, unsigned char blue /* r2 */, unsigned char alpha /* r2 */, float ushift /* r29+0x10 */, float vshift /* r29+0x10 */) {
    /* anonymous block */ {
        ...
        unsigned short indices[4]; // @ 0x006077F0
        class RwSky2DVertex v[4]; // @ 0x00656170
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3080 -> 0x001B3A44
*/
// Range: 0x1B3080 -> 0x1B3A44
void xScrFXGlareRender(class xMat4x3 & mat /* r20 */) {
    /* anonymous block */ {
        ...
        class xVec3 v; // r29+0x120
        class xVec3 glareDir; // r29+0x110
        float val; // r1
        class xVec3 toCam; // r29+0x100
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        class RxObjSpace3DVertex sStripVert[4]; // @ 0x006560E0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3A50 -> 0x001B3CF0
*/
// Range: 0x1B3A50 -> 0x1B3CF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3CF0 -> 0x001B3D7C
*/
// Range: 0x1B3CF0 -> 0x1B3D7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3D80 -> 0x001B3F14
*/
// Range: 0x1B3D80 -> 0x1B3F14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3F20 -> 0x001B3F48
*/
// Range: 0x1B3F20 -> 0x1B3F48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3F50 -> 0x001B41C4
*/
// Range: 0x1B3F50 -> 0x1B41C4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B41D0 -> 0x001B4314
*/
// Range: 0x1B41D0 -> 0x1B4314
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4320 -> 0x001B4368
*/
// Range: 0x1B4320 -> 0x1B4368
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4370 -> 0x001B4378
*/
// Range: 0x1B4370 -> 0x1B4378
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4380 -> 0x001B43CC
*/
// Range: 0x1B4380 -> 0x1B43CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B43D0 -> 0x001B4428
*/
// Range: 0x1B43D0 -> 0x1B4428
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4430 -> 0x001B443C
*/
// Range: 0x1B4430 -> 0x1B443C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4440 -> 0x001B477C
*/
// Range: 0x1B4440 -> 0x1B477C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4780 -> 0x001B4824
*/
// Range: 0x1B4780 -> 0x1B4824
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4830 -> 0x001B4888
*/
// Range: 0x1B4830 -> 0x1B4888
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4890 -> 0x001B4938
*/
// Range: 0x1B4890 -> 0x1B4938
void xScrFxRender() {
    /* anonymous block */ {
        // Range: 0x1B4890 -> 0x1B4938
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4940 -> 0x001B49E8
*/
// Range: 0x1B4940 -> 0x1B49E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B49F0 -> 0x001B4A28
*/
// Range: 0x1B49F0 -> 0x1B4A28
void xScrFxReset() {
    /* anonymous block */ {
        // Range: 0x1B49F0 -> 0x1B4A28
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4A30 -> 0x001B4AD4
*/
// Range: 0x1B4A30 -> 0x1B4AD4
void xScrFxInit() {
    /* anonymous block */ {
        // Range: 0x1B4A30 -> 0x1B4AD4
    }
