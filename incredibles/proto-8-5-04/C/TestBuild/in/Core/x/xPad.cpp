/*
    Compile unit: C:\TestBuild\in\Core\x\xPad.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5E20 -> 0x001A615C
*/
// Range: 0x1A5E20 -> 0x1A615C
void xPadNormalizeAnalog(class _tagxPad & pad /* r2 */, signed int inner_zone /* r21 */, signed int outer_zone /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A5E20 -> 0x1A615C
        class _tagPadAnalog * src; // r2
        signed int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A6160 -> 0x001A6720
*/
// Range: 0x1A6160 -> 0x1A6720
signed int xPadUpdate(signed int idx /* r16 */, float time_passed /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A6160 -> 0x1A6720
        unsigned int new_on; // r29+0x3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A6720 -> 0x001A6790
*/
// Range: 0x1A6720 -> 0x1A6790
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A6790 -> 0x001A6844
*/
// Range: 0x1A6790 -> 0x1A6844
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A6850 -> 0x001A6884
*/
// Range: 0x1A6850 -> 0x1A6884
signed int xPadInit() {
    /* anonymous block */ {
        // Range: 0x1A6850 -> 0x1A6884
    }
