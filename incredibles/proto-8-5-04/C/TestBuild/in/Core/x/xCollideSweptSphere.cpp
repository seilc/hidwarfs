/*
    Compile unit: C:\TestBuild\in\Core\x\xCollideSweptSphere.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class zSweptSphereGlobals sSwsGlobal; // size: 0x8, address: 0x6091A0
static signed int sSweptSphereEntFound; // size: 0x4, address: 0x6091A8
static class xEnt * sSweptSphereMover; // size: 0x4, address: 0x6091AC
static unsigned char sSweptSphereCollType; // size: 0x1, address: 0x6091B0
static signed int sSweptSpherePenby; // size: 0x4, address: 0x6091B4
static unsigned int sSweptSphereIgnoreMovers; // size: 0x4, address: 0x6091B8
void SweptSphereHitsEntCB(class xScene *, class xRay3 *, class xQCData *, class xEnt *, void *); // size: 0x0, address: 0x33E4B0
...
signed int SweptSphereModelCB(signed int, signed int, void *); // size: 0x0, address: 0x33F950
signed int _rpCollisionGeometryDataOffset; // size: 0x4, address: 0x607F60
signed int SweptSphereLeafNodeCB(class xClumpCollBSPTriangle *, void *); // size: 0x0, address: 0x3405A0
...
// total size: 0x8
class zSweptSphereGlobals {
    // Members
public:
    signed int hitFound; // offset 0x0, size 0x4
    class xMat4x3 * modelMat; // offset 0x4, size 0x4
};
// total size: 0x2C
class xJSPHeader {
    // Members
...
// total size: 0xC
class RpCollSectorLineItNodeInfo {
    // Members
public:
    class RpCollSector * sector; // offset 0x0, size 0x4
...
// total size: 0x1C4
class RpCollSectorCapsuleIt {
    // Members
public:
    class RpCollTree * tree; // offset 0x0, size 0x4
    class RwV3d start; // offset 0x4, size 0xC
    class RwV3d delta; // offset 0x10, size 0xC
    class RwV3d recip; // offset 0x1C, size 0xC
    float radius; // offset 0x28, size 0x4
    class RpCollSector dummy; // offset 0x2C, size 0x8
    class RpCollSectorLineItNodeInfo stack[33]; // offset 0x34, size 0x18C
    class RpCollSectorLineItNodeInfo * curr; // offset 0x1C0, size 0x4
};
enum RxClusterValid {
...
// total size: 0x14
class xCollideSphereToPolygonResults {
    // Members
public:
    float dist; // offset 0x0, size 0x4
    class xVec3 contact; // offset 0x4, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D940 -> 0x0033DA9C
*/
// Range: 0x33D940 -> 0x33DA9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033DAA0 -> 0x0033DC3C
*/
// Range: 0x33DAA0 -> 0x33DC3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033DC40 -> 0x0033DE50
*/
// Range: 0x33DC40 -> 0x33DE50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033DE50 -> 0x0033DFE0
*/
// Range: 0x33DE50 -> 0x33DFE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033DFE0 -> 0x0033E3E0
*/
// Range: 0x33DFE0 -> 0x33E3E0
signed int xSweptSphereToEnt(class xSweptSphere * sws /* r19 */, class xEnt * ent /* r18 */, class xRay3 * ray /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33DFE0 -> 0x33E3E0
        unsigned int result; // r2
        float oldrad; // r29+0x100
        class xBox tmpbox; // r29+0xE0
        class xBox tmpbox; // r29+0xC0
        class xRay3 lr; // r29+0x90
        class xMat3x3 mn; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033E3E0 -> 0x0033E4A8
*/
// Range: 0x33E3E0 -> 0x33E4A8
signed int xSweptSphereToEnt(class xSweptSphere * sws /* r2 */, class xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33E3E0 -> 0x33E4A8
        class xRay3 ray; // r29+0x10
        float one_len; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033E4B0 -> 0x0033E66C
*/
// Range: 0x33E4B0 -> 0x33E66C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033E670 -> 0x0033E6E4
*/
// Range: 0x33E670 -> 0x33E6E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033E6F0 -> 0x0033E934
*/
// Range: 0x33E6F0 -> 0x33E934
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033E940 -> 0x0033F118
*/
// Range: 0x33E940 -> 0x33F118
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F120 -> 0x0033F94C
*/
// Range: 0x33F120 -> 0x33F94C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F950 -> 0x0033FC04
*/
// Range: 0x33F950 -> 0x33FC04
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033FC10 -> 0x003405A0
*/
// Range: 0x33FC10 -> 0x3405A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003405A0 -> 0x0034083C
*/
// Range: 0x3405A0 -> 0x34083C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340840 -> 0x00340ACC
*/
// Range: 0x340840 -> 0x340ACC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340AD0 -> 0x00340AF0
*/
// Range: 0x340AD0 -> 0x340AF0
void xSweptSphereResetCollision(class xSweptSphere * sws /* r2 */) {
    /* anonymous block */ {
        // Range: 0x340AD0 -> 0x340AF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340AF0 -> 0x00340C88
*/
// Range: 0x340AF0 -> 0x340C88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340C90 -> 0x00340DB8
*/
// Range: 0x340C90 -> 0x340DB8
void xSweptSpherePrepare(class xSweptSphere & sws /* r16 */, class xVec3 & start /* r2 */, class xVec3 & dir /* r2 */, float dist /* r29+0x40 */, float radius /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x340C90 -> 0x340DB8
        class xCapsule tmpC; // r29+0x20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340DC0 -> 0x00340DCC
*/
// Range: 0x340DC0 -> 0x340DCC
void xSweptSphereDetectInitialPenetration(class xSweptSphere & sws /* r2 */) {
    /* anonymous block */ {
        // Range: 0x340DC0 -> 0x340DCC
    }
}
