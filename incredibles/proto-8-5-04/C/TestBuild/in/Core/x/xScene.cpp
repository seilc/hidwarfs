/*
    Compile unit: C:\TestBuild\in\Core\x\xScene.cpp
...
static class xMat4x3 * sBoxTestMat; // size: 0x4, address: 0x608AD0
static unsigned char sUseJSP; // size: 0x1, address: 0x608AD4
static void * sTestOPtr; // size: 0x4, address: 0x608AD8
static class xModelInstance * sTestMPtr; // size: 0x4, address: 0x608ADC
static class xBound sNearestBound; // size: 0x4C, address: 0x655E40
static unsigned char sNearestChk; // size: 0x1, address: 0x608AE0
static unsigned char sNearestCollType; // size: 0x1, address: 0x608AE4
static class RpIntersection sSphereIsx; // size: 0x1C, address: 0x655E90
class RpCollisionTriangle * sectorNearestFloorCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x1AE9D0
signed int gridNearestFloorCB(class xEnt *, void *); // size: 0x0, address: 0x1AE880
...
class RpCollisionTriangle * boxNearestFloorCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x1AE9E0
...
void xRayHitsTikiLandableEnt(class xScene *, class xRay3 *, class xQCData *, class xEnt *, void *); // size: 0x0, address: 0x0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AE4A0 -> 0x001AE878
*/
// Range: 0x1AE4A0 -> 0x1AE878
unsigned int xSceneNearestFloorPoly(class xScene * sc /* r17 */, class xNearFloorPoly * nfpoly /* r16 */, unsigned char collType /* r20 */, unsigned char chk /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1AE4A0 -> 0x1AE878
        class RpIntersection isx; // r29+0x70
        signed int i; // r19
        float test_dist; // r29+0x90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AE880 -> 0x001AE9CC
*/
// Range: 0x1AE880 -> 0x1AE9CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AE9D0 -> 0x001AE9DC
*/
// Range: 0x1AE9D0 -> 0x1AE9DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AE9E0 -> 0x001AEBC8
*/
// Range: 0x1AE9E0 -> 0x1AEBC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AEBD0 -> 0x001AF288
*/
// Range: 0x1AEBD0 -> 0x1AF288
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AF290 -> 0x001AF664
*/
// Range: 0x1AF290 -> 0x1AF664
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AF670 -> 0x001AF994
*/
// Range: 0x1AF670 -> 0x1AF994
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AF9A0 -> 0x001AFB18
*/
// Range: 0x1AF9A0 -> 0x1AFB18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AFB20 -> 0x001AFBDC
*/
// Range: 0x1AFB20 -> 0x1AFBDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AFBE0 -> 0x001B0760
*/
// Range: 0x1AFBE0 -> 0x1B0760
void xRayHitsGrid(class xGrid * grid /* r19 */, class xScene * sc /* r29+0x10C */, class xRay3 * r /* r30 */, void (* rentcb)(class xScene *, class xRay3 *, class xQCData *, class xEnt *, void *) /* r29+0x108 */, class xQCData * qcr /* r18 */, void * data /* r29+0x104 */) {
    /* anonymous block */ {
        // Range: 0x1AFBE0 -> 0x1B0760
        class xGridIterator it; // r29+0x110
        float len; // r29+0x150
        signed int sclgx; // r29+0x14C
        signed int sclgz; // r29+0x148
        signed int eclgx; // r29+0x144
        signed int eclgz; // r29+0x140
        float sclcz; // r25
        float eclcz; // r24
        float halfclx; // r23
        float halfclz; // r22
        ...
        float quatrclz; // r30
        signed int sz; // r23
        signed int ez; // r29+0xF0
        signed int x; // r17
        signed int z; // r29+0xE0
        float dxdz; // r20
        float cz; // r29+0x150
        float lz; // r29+0x150
        float rz; // r31
        ...
        float aclcx; // r29+0x150
        float bclcx; // r2
        signed int ax; // r2
        signed int bx; // r16
        class xGridBound * cell; // r21
        class xGridBound * cell; // r21
        float cz; // r29+0x150
        float lz; // r29+0x150
        float rz; // r31
        float lx; // r30
        float rx; // r25
        signed int aclgx; // r29+0x12C
        signed int aclgz; // r29+0x128
        signed int bclgx; // r29+0x124
        signed int bclgz; // r29+0x120
        float aclcx; // r29+0x150
        float bclcx; // r2
        signed int ax; // r17
        signed int bx; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0760 -> 0x001B0804
*/
// Range: 0x1B0760 -> 0x1B0804
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0810 -> 0x001B0844
*/
// Range: 0x1B0810 -> 0x1B0844
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0850 -> 0x001B0920
*/
// Range: 0x1B0850 -> 0x1B0920
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0920 -> 0x001B0928
*/
// Range: 0x1B0920 -> 0x1B0928
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0930 -> 0x001B0938
*/
// Range: 0x1B0930 -> 0x1B0938
void xSceneLoad() {
    /* anonymous block */ {
        // Range: 0x1B0930 -> 0x1B0938
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0940 -> 0x001B0948
*/
// Range: 0x1B0940 -> 0x1B0948
void xSceneSave() {
    /* anonymous block */ {
        // Range: 0x1B0940 -> 0x1B0948
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0950 -> 0x001B0958
*/
// Range: 0x1B0950 -> 0x1B0958
void xSceneExit() {
    /* anonymous block */ {
        // Range: 0x1B0950 -> 0x1B0958
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0960 -> 0x001B0ABC
*/
// Range: 0x1B0960 -> 0x1B0ABC
