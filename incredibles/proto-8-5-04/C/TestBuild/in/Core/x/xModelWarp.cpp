/*
    Compile unit: C:\TestBuild\in\Core\x\xModelWarp.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _xFColor default_color; // size: 0x10, address: 0x5FC2F0
static class xFXCameraTexture camtex; // size: 0x48, address: 0x6BEF00
static class render_context render_contexts[8]; // size: 0x400, address: 0x6BEF50
static signed int render_contexts_size; // size: 0x4, address: 0x609684
...
class RpAtomic * render_callback(class RpAtomic *); // size: 0x0, address: 0x484CC0
...
class render_context {
    // Members
public:
    class xMat4x3 uvmat; // offset 0x0, size 0x40
    signed int flags; // offset 0x40, size 0x4
    class xBox box; // offset 0x44, size 0x18
    class _xFColor color; // offset 0x5C, size 0x10
    class RpAtomic * atomic; // offset 0x6C, size 0x4
    class RpAtomic * original_atomic; // offset 0x70, size 0x4
    class RpAtomic * (* original_render_callback)(class RpAtomic *); // offset 0x74, size 0x4
};
// total size: 0x18
class xBox {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484240 -> 0x00484458
*/
// Range: 0x484240 -> 0x484458
class xFXCameraTexture * xModelWarpGrabScreen(class xSphere & sphere /* r2 */, class _xFColor & color /* r2 */, class xMat4x3 * subview_mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x484240 -> 0x484458
        class xFRect scr_rect; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484460 -> 0x004847C0
*/
// Range: 0x484460 -> 0x4847C0
void xModelWarpSphereMapUVs(class RpAtomic * atomic /* r18 */, unsigned char use_normals /* r22 */) {
    /* anonymous block */ {
        // Range: 0x484460 -> 0x4847C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004847C0 -> 0x004848E8
*/
// Range: 0x4847C0 -> 0x4848E8
void xModelWarpSphereMapUVsByNormals(class xVec2 * uv /* r18 */, signed int verts_size /* r2 */, class xVec3 * norm /* r17 */) {
    /* anonymous block */ {
        // Range: 0x4847C0 -> 0x4848E8
        class xVec2 * end_uv; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004848F0 -> 0x00484BAC
*/
// Range: 0x4848F0 -> 0x484BAC
void xModelWarpSetEffect(class RpAtomic * atomic /* r20 */, class xBox * box /* r19 */, class _xFColor * color /* r18 */) {
    /* anonymous block */ {
        // Range: 0x4848F0 -> 0x484BAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484BB0 -> 0x00484C34
*/
// Range: 0x484BB0 -> 0x484C34
void xModelWarpSceneExit() {
    /* anonymous block */ {
        // Range: 0x484BB0 -> 0x484C34
        class render_context * context; // r6
        class render_context * end_context; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484C40 -> 0x00484CC0
*/
// Range: 0x484C40 -> 0x484CC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484CC0 -> 0x0048537C
*/
// Range: 0x484CC0 -> 0x48537C
static class RpAtomic * render_callback(class RpAtomic * atomic /* r20 */) {
    /* anonymous block */ {
        // Range: 0x484CC0 -> 0x48537C
        class render_context * context; // r2
        class xSphere & sphere; // r19
        class xMat4x3 ltm; // r29+0x100
        ...
        class xMat4x3 offset_mat; // r29+0x80
        class xVec3 look; // r29+0x150
        float alpha; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485380 -> 0x004854F4
*/
// Range: 0x485380 -> 0x4854F4
static unsigned char write_screen(class xFRect & scr_rect /* r18 */, class _xFColor & color /* r17 */) {
    /* anonymous block */ {
        // Range: 0x485380 -> 0x4854F4
        class RwRaster * draw_raster; // r16
        signed int width; // r2
        signed int height; // r2
        class xFRect tex_rect; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485500 -> 0x004857A8
*/
// Range: 0x485500 -> 0x4857A8
static void get_screen_rect(class xFRect & rect /* r17 */, class xMat4x3 & mat /* r2 */, class xBox & box /* r16 */) {
    /* anonymous block */ {
        // Range: 0x485500 -> 0x4857A8
        class RwCamera * world_cam; // r2
        class xMat4x3 & view_mat; // r2
        class xMat4x3 cat_mat; // r29+0x30
        float left; // r11
        float right; // r10
        float top; // r9
        float bottom; // r8
