/*
    Compile unit: C:\TestBuild\in\Core\x\xWater.cpp
...
static class water_motion_group motion_groups[16]; // size: 0x13C0, address: 0x6A6AD0
static signed int motion_groups_size; // size: 0x4, address: 0x6091D8
static class xMat4x3 current_cam_mat; // size: 0x40, address: 0x6A7E90
static unsigned char allocation_ship_sailed; // size: 0x1, address: 0x6091DC
static float tile_width; // size: 0x4, address: 0x6091E0
static class xVec4 current_frustum_planes[6]; // size: 0x60, address: 0x6A7ED0
static class xVec2 blur_offsets[4]; // size: 0x20, address: 0x0
static class xFXCameraTexture refract_tv; // size: 0x48, address: 0x6A7F30
static class xFXCameraTexture reflect_tv; // size: 0x48, address: 0x6A7F80
static class xMat4x3 uvscale_mat; // size: 0x40, address: 0x6A7FD0
static unsigned char downloaded_frustum_planes; // size: 0x1, address: 0x6091E4
static unsigned int skydome_old_test; // size: 0x4, address: 0x6091E8
static unsigned int skydome_old_blend_mode; // size: 0x4, address: 0x6091EC
static signed int skydome_model_alpha; // size: 0x4, address: 0x6091F0
...
unsigned int lastSetFBMSK; // size: 0x4, address: 0x60887C
...
class vidmode_data {
    // Members
public:
    signed int refract_width; // offset 0x0, size 0x4
    signed int refract_height; // offset 0x4, size 0x4
    signed int reflect_width; // offset 0x8, size 0x4
    signed int reflect_height; // offset 0xC, size 0x4
...
class zCutsceneMgr {};
// total size: 0x13C
class water_motion_group {
    // Members
public:
    signed int flags; // offset 0x0, size 0x4
    float * mesh[6]; // offset 0x4, size 0x18
    class tile_batch * batches; // offset 0x1C, size 0x4
    signed int batches_size; // offset 0x20, size 0x4
    float update_dt; // offset 0x24, size 0x4
    class iWaterWave waves[12]; // offset 0x28, size 0xC0
    float wave_speeds[12]; // offset 0xE8, size 0x30
    float max_height; // offset 0x118, size 0x4
    float lod_dist_min; // offset 0x11C, size 0x4
    float lod_dist_interval; // offset 0x120, size 0x4
    float lod_scale; // offset 0x124, size 0x4
    signed int shimmer; // offset 0x128, size 0x4
    signed int refract_glow; // offset 0x12C, size 0x4
    signed int tiles_used; // offset 0x130, size 0x4
    signed int min_lod; // offset 0x134, size 0x4
    signed int max_lod; // offset 0x138, size 0x4
};
// total size: 0x4E0
...
public:
    signed int flags; // offset 0x0, size 0x4
    class xWaterTileSet * tileset; // offset 0x4, size 0x4
    class tile_quadtree qtree; // offset 0x8, size 0x3C
    signed int tiles_size; // offset 0x44, size 0x4
    class xSphere bound; // offset 0x48, size 0x10
    float plane_y; // offset 0x58, size 0x4
    class xWaterShading shading; // offset 0x5C, size 0x50
    class facade_entity * refract_ents; // offset 0xAC, size 0x4
    signed int refract_ents_size; // offset 0xB0, size 0x4
    class facade_entity * reflect_ents; // offset 0xB4, size 0x4
    signed int reflect_ents_size; // offset 0xB8, size 0x4
    class iWaterTile itiles[6][128]; // offset 0xC0, size 0x3000
    signed int itiles_used[6]; // offset 0x30C0, size 0x18
    signed int min_lod; // offset 0x30D8, size 0x4
    signed int max_lod; // offset 0x30DC, size 0x4
    signed int itiles_used_total; // offset 0x30E0, size 0x4
};
// total size: 0x8
...
class xWaterMotion {
    // Members
public:
    float lod_dist_min; // offset 0x0, size 0x4
    float lod_dist_interval; // offset 0x4, size 0x4
    signed int shimmer; // offset 0x8, size 0x4
    signed int refract_glow; // offset 0xC, size 0x4
    unsigned int random_seed; // offset 0x10, size 0x4
    float amplitude_min; // offset 0x14, size 0x4
    float gravity; // offset 0x18, size 0x4
    float wind_speed; // offset 0x1C, size 0x4
    float wind_dir; // offset 0x20, size 0x4
    float scale_amplitude; // offset 0x24, size 0x4
    float scale_speed; // offset 0x28, size 0x4
    float scale_wave_length; // offset 0x2C, size 0x4
};
// total size: 0x0
...
class xWaterTileSet {
    // Members
public:
    float y; // offset 0x0, size 0x4
    signed int gridx; // offset 0x4, size 0x4
    signed int gridz; // offset 0x8, size 0x4
    signed int sizex; // offset 0xC, size 0x4
    signed int sizez; // offset 0x10, size 0x4
    unsigned int bitfield[1]; // offset 0x14, size 0x4
};
// total size: 0x48
...
class xWaterShading {
    // Members
public:
    class xVec3 light_dir; // offset 0x0, size 0xC
    float color_mul_red; // offset 0xC, size 0x4
    float color_mul_green; // offset 0x10, size 0x4
    float color_mul_blue; // offset 0x14, size 0x4
    float light_ambient; // offset 0x18, size 0x4
    float light_diffuse; // offset 0x1C, size 0x4
    float light_transmissive; // offset 0x20, size 0x4
    float refraction_index; // offset 0x24, size 0x4
    float reflectance_min; // offset 0x28, size 0x4
    float reflect_intensity; // offset 0x2C, size 0x4
    float reflect_magnitude; // offset 0x30, size 0x4
    float refract_min; // offset 0x34, size 0x4
    float refract_max; // offset 0x38, size 0x4
    float refract_dist_min; // offset 0x3C, size 0x4
    float refract_dist_max; // offset 0x40, size 0x4
    float refract_ymax; // offset 0x44, size 0x4
    enum RwBlendFunction blend_src; // offset 0x48, size 0x4
    enum RwBlendFunction blend_dst; // offset 0x4C, size 0x4
};
// total size: 0x70
class RpWorld {
    // Members
...
// total size: 0x1
class xWaterSettings {
    // Members
public:
    unsigned char allow_overfill; // offset 0x0, size 0x1
};
// total size: 0x18
...
// total size: 0x10
class xWaterEnvironment {
    // Members
public:
    class xEnt * * refract_ents; // offset 0x0, size 0x4
    signed int refract_ents_size; // offset 0x4, size 0x4
    class xEnt * * reflect_ents; // offset 0x8, size 0x4
    signed int reflect_ents_size; // offset 0xC, size 0x4
};
// total size: 0x50
class iEnv {
    // Members
...
class tile_region {
    // Members
public:
    unsigned char lod; // offset 0x0, size 0x1
    unsigned char repeat_power; // offset 0x1, size 0x1
    unsigned char flags; // offset 0x2, size 0x1
    unsigned char pad1; // offset 0x3, size 0x1
    unsigned short gridx; // offset 0x4, size 0x2
    unsigned short gridz; // offset 0x6, size 0x2
};
...
class tile_quadtree {
    // Members
public:
    float plane_y; // offset 0x0, size 0x4
    float scale; // offset 0x4, size 0x4
    signed int rootx; // offset 0x8, size 0x4
    signed int rootz; // offset 0xC, size 0x4
    signed int tree_depth; // offset 0x10, size 0x4
    unsigned char * * levels; // offset 0x14, size 0x4
    class tile_region * region; // offset 0x18, size 0x4
    class tile_region * end_region; // offset 0x1C, size 0x4
    class xVec4 * frust_planes; // offset 0x20, size 0x4
    float lod_dist_min; // offset 0x24, size 0x4
    float lod_dist_scale; // offset 0x28, size 0x4
    signed int min_tess_level_sum; // offset 0x2C, size 0x4
    class xVec3 cam_loc; // offset 0x30, size 0xC
};
enum iSndHandle {
};
// total size: 0x40
...
class gather_args {
    // Members
public:
    class point_data point[4]; // offset 0x0, size 0x8
    signed int lod_min; // offset 0x8, size 0x4
    signed int lod_max; // offset 0xC, size 0x4
};
// total size: 0x28
class mblur_data {
    // Members
...
class point_data {
    // Members
public:
    unsigned char clip_flags; // offset 0x0, size 0x1
...
public:
    ...
    float phase; // offset 0x4, size 0x4
    float frequency; // offset 0x8, size 0x4
    float dir; // offset 0xC, size 0x4
};
// total size: 0x10
class xRot {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00344A30 -> 0x00345FE8
*/
// Range: 0x344A30 -> 0x345FE8
// this: r21
static void tile_quadtree::gather_regions_recur(signed int depth /* r2 */, signed int ix /* r29+0x1DC */, signed int iz /* r29+0x1D8 */, class gather_args & args /* r20 */) {
    /* anonymous block */ {
        // Range: 0x344A30 -> 0x345FE8
        signed int level; // r2
        signed int clip_union; // r2
        signed int width; // r2
        signed int tesselevel; // r2
        signed int cdepth; // r2
        signed int clevel; // r2
        signed int cwidth; // r29+0x1C0
        signed int cix; // r2
        signed int ciz; // r2
        signed int center_ix; // r29+0x1B0
        signed int center_iz; // r29+0x1A0
        signed int left_clip_flags; // r30
        signed int right_clip_flags; // r29+0x190
        signed int top_clip_flags; // r29+0x180
        signed int bottom_clip_flags; // r29+0x17C
        signed int left_lod; // r19
        signed int right_lod; // r18
        signed int top_lod; // r17
        signed int bottom_lod; // r16
        float x; // r30
        float z; // r29
        float dxz; // r28
        float half_dxz; // r29+0x1F0
        class gather_args cargs; // r29+0x1E0
        signed int cclip_inter; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00345FF0 -> 0x00346134
*/
// Range: 0x345FF0 -> 0x346134
static void downsample_level(unsigned char * out_nodes /* r2 */, unsigned char * in_nodes /* r2 */, signed int in_depth /* r2 */) {
    /* anonymous block */ {
        // Range: 0x345FF0 -> 0x346134
        signed int out_depth; // r2
        signed int out_width; // r2
        signed int iz; // r16
        signed int ix; // r25
        unsigned char in_node; // r2
        signed int union_flag; // r2
        signed int out_sum; // r24
        signed int out_union; // r15
        signed int out_inter; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346140 -> 0x00346238
*/
// Range: 0x346140 -> 0x346238
static void load_tileset(unsigned char * nodes /* r18 */, signed int depth /* r17 */, class xWaterTileSet & tileset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x346140 -> 0x346238
        signed int stride; // r2
        unsigned char * bits; // r15
        signed int endix; // r2
        signed int endiz; // r2
        signed int iz; // r14
        signed int ix; // r13
        unsigned int ixmod32; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346240 -> 0x00346C68
*/
// Range: 0x346240 -> 0x346C68
// this: r17
static signed int tile_quadtree::gather_regions(class tile_region * regions /* r16 */, signed int max_regions /* r2 */, float lod_dist_min /* r29+0x40 */, float lod_dist_scale /* r29+0x40 */, signed int min_tess_level_sum /* r2 */, class xVec3 & cam_loc /* r2 */, class xVec4 * frust_planes /* r2 */) {
    /* anonymous block */ {
        // Range: 0x346240 -> 0x346C68
        signed int width; // r2
        float x; // r4
        float z; // r3
        float dxz; // r2
        class gather_args args; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346C70 -> 0x00346F50
*/
// Range: 0x346C70 -> 0x346F50
// this: r17
static void tile_quadtree::create(class xWaterTileSet & tileset /* r16 */, float scale /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x346C70 -> 0x346F50
        signed int total_nodes; // r2
        signed int depth; // r6
        unsigned char * nodes; // r18
        signed int depth; // r8
        signed int depth; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346F50 -> 0x00346FB4
*/
// Range: 0x346F50 -> 0x346FB4
void xWaterSetBodyVisibility(signed int body_id /* r2 */, unsigned char visible /* r2 */) {
    /* anonymous block */ {
        // Range: 0x346F50 -> 0x346FB4
        class tile_batch & batch; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346FC0 -> 0x00347334
*/
// Range: 0x346FC0 -> 0x347334
signed int xWaterAddBody(signed int motion_type /* r20 */, class xWaterSettings & settings /* r18 */, class xWaterShading & shading /* r30 */, class xWaterEnvironment & env /* r19 */, class xWaterTileSet * tileset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x346FC0 -> 0x347334
        class water_motion_group & motion_group; // r16
        signed int batch_index; // r2
        class tile_batch & batch; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347340 -> 0x003474D4
*/
// Range: 0x347340 -> 0x3474D4
signed int xWaterAddMotion(class xWaterMotion & motion /* r17 */) {
    /* anonymous block */ {
        // Range: 0x347340 -> 0x3474D4
        signed int motion_type; // r16
        class water_motion_group & motion_group; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003474E0 -> 0x003474F0
*/
// Range: 0x3474E0 -> 0x3474F0
void xWaterDestroyTileSet(class xWaterTileSet * tileset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3474E0 -> 0x3474F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003474F0 -> 0x00347980
*/
// Range: 0x3474F0 -> 0x347980
class xWaterTileSet * xWaterCreateTileSet(class RpAtomic * atomic /* r2 */, class xMat4x3 & mat /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3474F0 -> 0x347980
        ...
        class xMat4x3 & ltm; // r2
        class xVec3 wv; // r29+0xF0
        float y; // r21
        float xmin; // r2
        float xmax; // r24
        float zmin; // r23
        ...
        class xVec3 * v; // r7
        class xVec3 * endv; // r2
        float scale; // r29+0x100
        float iscale; // r20
        signed int gridx; // r2
        signed int gridz; // r2
        signed int sizex; // r21
        signed int sizez; // r22
        signed int stride; // r29+0xE0
        class xWaterTileSet * tileset; // r20
        class RpTriangle * t; // r2
        class RpTriangle * endt; // r2
        float tx0; // r29+0x100
        float tz0; // r29+0x100
        float tx1; // r29+0x100
        float tz1; // r29+0x100
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347980 -> 0x00347C10
*/
// Range: 0x347980 -> 0x347C10
void xWaterRender() {
    /* anonymous block */ {
        // Range: 0x347980 -> 0x347C10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347C10 -> 0x00347D80
*/
// Range: 0x347C10 -> 0x347D80
void xWaterUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x347C10 -> 0x347D80
        class water_motion_group * mg; // r20
        class water_motion_group * endmg; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347D80 -> 0x00347DAC
*/
// Range: 0x347D80 -> 0x347DAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347DB0 -> 0x00347DBC
*/
// Range: 0x347DB0 -> 0x347DBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347DC0 -> 0x00347EF8
*/
// Range: 0x347DC0 -> 0x347EF8
void xWaterSceneEnter() {
    /* anonymous block */ {
        // Range: 0x347DC0 -> 0x347EF8
        class vidmode_data & vd; // r16
        class vidmode_data viddata[2]; // @ 0x005F3240
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00347F00 -> 0x003481CC
*/
// Range: 0x347F00 -> 0x3481CC
static void setup_water_entity(class tile_batch & batch /* r17 */, class facade_entity & ent /* r18 */, unsigned char refract /* r16 */) {
    /* anonymous block */ {
        // Range: 0x347F00 -> 0x3481CC
        signed int sortorder; // r29+0xCC
        signed int lockY; // r29+0xC8
        signed int lockXZ; // r29+0xC4
        class xMat4x3 & model_mat; // r2
        class xMat4x3 flip_mat; // r29+0x80
        class xMat4x3 result_mat; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003481D0 -> 0x003483D0
*/
// Range: 0x3481D0 -> 0x3483D0
static void setup_water_atomic(class RpAtomic * atomic /* r18 */, class xMat4x3 & mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3481D0 -> 0x3483D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003483D0 -> 0x003484A4
*/
// Range: 0x3483D0 -> 0x3484A4
static void transform_atomic_vertices(class RpAtomic * atomic /* r2 */, class xMat4x3 & mat /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3483D0 -> 0x3484A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003484B0 -> 0x0034879C
*/
// Range: 0x3484B0 -> 0x34879C
static void render_batch_pipeline(class water_motion_group & motion_group /* r17 */, class tile_batch & batch /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3484B0 -> 0x34879C
        class xMat4x3 shade_view_mat; // r29+0xD0
        class xVec2 shade_view_window; // r29+0x118
        signed int lod; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003487A0 -> 0x00348C60
*/
// Range: 0x3487A0 -> 0x348C60
static void render_tile_lod(class water_motion_group & motion_group /* r18 */, class tile_batch & batch /* r29+0x184 */, signed int lod /* r17 */, class xMat4x3 & shade_view_mat /* r29+0x180 */) {
    /* anonymous block */ {
        // Range: 0x3487A0 -> 0x348C60
        signed int width; // r2
        float dxz; // r27
        signed int width_in_meshes; // r2
        float mesh_world_width; // r26
        signed int field_stride; // r2
        float lod_blend_dist_min; // r29+0x18C
        float lod_blend_dist_max; // r29+0x188
        class iWaterTile * itiles; // r29+0x170
        class iWaterTile * tiles; // r22
        float * mesh; // r2
        signed int i; // r29+0x160
        signed int j; // r29+0x150
        signed int tiles_used; // r21
        signed int k; // r20
        signed int endk; // r2
        class iWaterTile & itile; // r2
        float x; // r25
        float z; // r24
        signed int repeat_unit_width; // r23
        signed int repeats; // r2
        float repeat_width; // r23
        signed int m; // r19
        signed int n; // r18
        class iWaterTile & tile; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348C60 -> 0x00348D00
*/
// Range: 0x348C60 -> 0x348D00
static void get_lod_blend_range(float & dist_min /* r2 */, float & dist_max /* r2 */, signed int lod /* r2 */, float lod_dist_min /* r29 */, float lod_dist_interval /* r29 */) {
    /* anonymous block */ {
        // Range: 0x348C60 -> 0x348D00
        float lod_range; // r4
        float dist_center; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348D00 -> 0x00348E64
*/
// Range: 0x348D00 -> 0x348E64
static void refresh_motion_group(class water_motion_group & motion_group /* r18 */) {
    /* anonymous block */ {
        // Range: 0x348D00 -> 0x348E64
        class tile_batch * batch; // r17
        class tile_batch * end_batch; // r2
        signed int lod; // r17
        signed int width_in_meshes; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348E70 -> 0x00349048
*/
// Range: 0x348E70 -> 0x349048
static void gather_batch_tiles(class water_motion_group & motion_group /* r18 */, class tile_batch & batch /* r17 */) {
    /* anonymous block */ {
        // Range: 0x348E70 -> 0x349048
        class tile_region * regions; // r16
        signed int regions_used; // r2
        class tile_region * region; // r5
        class tile_region * end_region; // r2
        signed int lod; // r7
        signed int max_lod; // r2
        class iWaterTile & itile; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349050 -> 0x003492C0
*/
// Range: 0x349050 -> 0x3492C0
static void refresh_heightmaps(class water_motion_group & motion_group /* r21 */, signed int min_lod /* r19 */, signed int max_lod /* r30 */) {
    /* anonymous block */ {
        // Range: 0x349050 -> 0x3492C0
        signed int lod; // r2
        signed int subdiv_level; // r18
        signed int width; // r17
        float * Ay[2]; // r29+0xC8
        float * Nx[2]; // r29+0xC0
        float * Ny[2]; // r29+0xB8
        float * Nz[2]; // r29+0xB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003492C0 -> 0x00349464
*/
// Range: 0x3492C0 -> 0x349464
static void downsample_mesh(float * By /* r2 */, float * Ay /* r2 */, signed int subdiv_level /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3492C0 -> 0x349464
        signed int width; // r2
        signed int mask; // r2
        signed int i; // r14
        signed int row_mid; // r2
        signed int mid; // r2
        signed int row_up; // r2
        signed int row_down; // r2
        signed int j; // r13
        signed int diag0; // r2
        signed int diag1; // r2
        signed int j; // r10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349470 -> 0x00349668
*/
// Range: 0x349470 -> 0x349668
static float * create_mesh(float * out /* r16 */, float * in /* r2 */, signed int in_subdiv /* r2 */) {
    /* anonymous block */ {
        // Range: 0x349470 -> 0x349668
        signed int width; // r2
        signed int width_in_meshes; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349670 -> 0x00349784
*/
// Range: 0x349670 -> 0x349784
static void wrap_mesh(float * out /* r2 */, float * in /* r2 */, signed int in_subdiv /* r2 */) {
    /* anonymous block */ {
        // Range: 0x349670 -> 0x349784
        signed int in_mask; // r2
        float * out_endcol; // r10
        signed int i; // r9
        float * row_in; // r8
        signed int j; // r7
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349790 -> 0x00349810
*/
// Range: 0x349790 -> 0x349810
static void prune_odds(float * out /* r2 */, float * in /* r2 */, signed int in_subdiv /* r2 */) {
    /* anonymous block */ {
        // Range: 0x349790 -> 0x349810
        signed int in_width; // r2
        signed int in_stride; // r2
        signed int in_padding; // r2
        signed int out_width; // r2
        signed int out_padding; // r2
        float * end_row; // r9
        float * end; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349810 -> 0x00349F10
*/
// Range: 0x349810 -> 0x349F10
static void triangle_render_1bit(unsigned char * bits /* r2 */, signed int stride /* r2 */, float Ax /* r29 */, float Ay /* r29 */, float Bx /* r29 */, float By /* r29 */, float Cx /* r29 */, float Cy /* r29 */) {
    /* anonymous block */ {
        // Range: 0x349810 -> 0x349F10
        signed int y; // r15
        signed int ymid; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349F10 -> 0x0034A5F8
*/
// Range: 0x349F10 -> 0x34A5F8
static unsigned char render_facades(class water_motion_group & motion_group /* r21 */, class xMat4x3 & shade_view_mat /* r29+0x100 */, class xMat4x3 & cam_mat /* r22 */, class xVec2 & view_window /* r23 */, float plane_y /* r20 */, class xSphere & bound_sphere /* r20 */, class facade_entity * refract_ents /* r19 */, signed int refract_ents_size /* r30 */, class facade_entity * reflect_ents /* r18 */, signed int reflect_ents_size /* r29+0x160 */) {
    /* anonymous block */ {
        // Range: 0x349F10 -> 0x34A5F8
        class xColor_tag fill_color; // r29+0x15C
        signed int reflect_alpha; // r17
        class RwCamera * world_cam; // r16
        class xMat4x3 flip_mat; // r29+0x110
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034A600 -> 0x0034A9F8
*/
// Range: 0x34A600 -> 0x34A9F8
static signed int render_reflect_skydomes(class water_motion_group & motion_group /* r29+0xEC */, class facade_entity * ents /* r23 */, signed int ents_size /* r2 */, class xMat4x3 & mat /* r29+0xE0 */) {
    /* anonymous block */ {
        // Range: 0x34A600 -> 0x34A9F8
        signed int domes; // r29+0xD0
        class facade_entity * end_ents; // r2
        class xEnt * ent; // r20
        class xModelInstance * model; // r2
        class RpAtomic * atomic; // r2
        class xMat4x3 & entmat; // r2
        class xMat4x3 oldentmat; // r29+0xF0
        class xVec3 & local_center; // r2
        class xVec3 & center; // r19
        class xVec3 oldcenter; // r29+0x130
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034AA00 -> 0x0034ABD4
*/
// Range: 0x34AA00 -> 0x34ABD4
static signed int render_refract_skydomes(class facade_entity * ents /* r19 */, signed int ents_size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x34AA00 -> 0x34ABD4
        signed int domes; // r18
        class facade_entity * end_ents; // r2
        class xEnt * ent; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034ABE0 -> 0x0034AF2C
*/
// Range: 0x34ABE0 -> 0x34AF2C
static void render_model_now(class xModelInstance & model /* r20 */, signed int flags /* r2 */, class xMat4x3 * transform_mat /* r19 */) {
    /* anonymous block */ {
        // Range: 0x34ABE0 -> 0x34AF2C
        class xMat4x3 oldmat; // r29+0xA0
        class xVec3 oldcenter; // r29+0xE0
        class xModelInstance * submodel; // r18
        class RpAtomic * atomic; // r2
        class xMat4x3 & mat; // r2
        class xVec3 & center; // r17
        class xVec3 & local_center; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034AF30 -> 0x0034B0F4
*/
// Range: 0x34AF30 -> 0x34B0F4
static void heightmap_animate_waves(float * Ay_out /* r21 */, float * Nx_out /* r20 */, float * Ny_out /* r22 */, float * Nz_out /* r23 */, signed int subdiv_level /* r2 */, float scale /* r29+0xE0 */, class iWaterWave * waves /* r29+0xDC */) {
    /* anonymous block */ {
        // Range: 0x34AF30 -> 0x34B0F4
        signed int width; // r19
        signed int stride; // r29+0xC0
        signed int drow; // r2
        float dxz; // r22
        float passz; // r21
        float z; // r20
        class iWaterInstancedWaves * iwaves; // r18
        float * Ay; // r2
        float * Nx; // r2
        float * Ny; // r2
        float * Nz; // r2
        signed int row_value_step; // r2
        signed int start_row; // r30
        signed int end_row; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034B100 -> 0x0034B268
*/
// Range: 0x34B100 -> 0x34B268
static void convert_wave(class iWaterWave & wave /* r16 */, float wave_length /* r23 */, float dir /* r22 */) {
    /* anonymous block */ {
        // Range: 0x34B100 -> 0x34B268
        float freq_scale; // r20
        float xlen; // r29+0x3C
        float zlen; // r29+0x38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034B270 -> 0x0034B774
*/
// Range: 0x34B270 -> 0x34B774
static void generate_random_ocean_wave(class ocean_wave & w /* r18 */, class xWaterMotion & motion /* r17 */) {
    /* anonymous block */ {
        // Range: 0x34B270 -> 0x34B774
        float g; // r26
        float freq_peak; // r25
        float wind_dir; // r29+0x9C
        float maxf; // r2
        signed int i; // r16
        float f; // r20
        float phi; // r24
