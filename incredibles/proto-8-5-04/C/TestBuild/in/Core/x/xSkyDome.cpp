/*
    Compile unit: C:\TestBuild\in\Core\x\xSkyDome.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class SkyDomeInfo sSkyList[8]; // size: 0x80, address: 0x66BAC0
static signed int sSkyCount; // size: 0x4, address: 0x608BEC
static float old_far_clip; // size: 0x4, address: 0x608BF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0540 -> 0x001D0624
*/
// Range: 0x1D0540 -> 0x1D0624
void xSkyDome_RenderSingle(class xEnt * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1D0540 -> 0x1D0624
        class RwMatrixTag * cammat; // r2
        class xMat4x3 & mat; // r2
        class xVec3 oldpos; // r29+0x30
        class SkyDomeInfo & info; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0630 -> 0x001D069C
*/
// Range: 0x1D0630 -> 0x1D069C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D06A0 -> 0x001D071C
*/
// Range: 0x1D06A0 -> 0x1D071C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0720 -> 0x001D0750
*/
// Range: 0x1D0720 -> 0x1D0750
void xSkyDome_GetSettings(class xEnt * ent /* r2 */, signed int & sortorder /* r2 */, signed int & lockY /* r2 */, signed int & lockXZ /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D0720 -> 0x1D0750
        class SkyDomeInfo & info; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0750 -> 0x001D0980
*/
// Range: 0x1D0750 -> 0x1D0980
void xSkyDome_Render() {
    /* anonymous block */ {
        // Range: 0x1D0750 -> 0x1D0980
        class RwCamera * cam; // r20
        class RwMatrixTag * cammat; // r2
        float far_clip; // r23
        class RwRGBA color; // r29+0x7C
        signed int i; // r19
        class xEnt * ent; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0980 -> 0x001D0B40
*/
// Range: 0x1D0980 -> 0x1D0B40
void xSkyDome_AddEntity(class xEnt * ent /* r16 */, signed int sortorder /* r2 */, signed int lockY /* r2 */, signed int lockXZ /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D0980 -> 0x1D0B40
        signed int i; // r9
        signed int j; // r9
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0B40 -> 0x001D0B48
*/
// Range: 0x1D0B40 -> 0x1D0B48
void xSkyDome_Setup() {
    /* anonymous block */ {
        // Range: 0x1D0B40 -> 0x1D0B48
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D0B50 -> 0x001D0B58
*/
// Range: 0x1D0B50 -> 0x1D0B58
