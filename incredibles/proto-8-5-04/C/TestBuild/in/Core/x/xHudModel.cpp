/*
    Compile unit: C:\TestBuild\in\Core\x\xHudModel.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x2C
struct /* @anon1 */ {} xhud::model_widget::__vtable; // size: 0x2C, address: 0x5FD170
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CBF10 -> 0x001CBF8C
*/
// Range: 0x1CBF10 -> 0x1CBF8C
// this: r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CBF90 -> 0x001CBFB4
*/
// Range: 0x1CBF90 -> 0x1CBFB4
// this: r2
void model_widget::set_params(class xModelInstance * & model /* r2 */, class render_context & rc /* r2 */, float xs /* r29 */, float ys /* r29 */, float lx /* r29 */, float ly /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1CBF90 -> 0x1CBFB4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CBFC0 -> 0x001CC044
*/
// Range: 0x1CBFC0 -> 0x1CC044
// this: r16
void model_widget::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CBFC0 -> 0x1CC044
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC050 -> 0x001CC0C8
*/
// Range: 0x1CC050 -> 0x1CC0C8
// this: r17
unsigned char model_widget::is(unsigned int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CC050 -> 0x1CC0C8
        signed char @4819; // @ 0x00608BDC
        unsigned int myid; // @ 0x00608BD8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC0D0 -> 0x001CC110
*/
// Range: 0x1CC0D0 -> 0x1CC110
unsigned int type() {
    /* anonymous block */ {
        // Range: 0x1CC0D0 -> 0x1CC110
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC110 -> 0x001CC118
*/
// Range: 0x1CC110 -> 0x1CC118
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC120 -> 0x001CC198
*/
// Range: 0x1CC120 -> 0x1CC198
