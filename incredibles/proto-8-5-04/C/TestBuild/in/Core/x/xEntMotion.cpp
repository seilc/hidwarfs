/*
    Compile unit: C:\TestBuild\in\Core\x\xEntMotion.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00185250 -> 0x00185700
*/
// Range: 0x185250 -> 0x185700
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00185700 -> 0x0018588C
*/
// Range: 0x185700 -> 0x18588C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00185890 -> 0x0018599C
*/
// Range: 0x185890 -> 0x18599C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001859A0 -> 0x00185C98
*/
// Range: 0x1859A0 -> 0x185C98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00185CA0 -> 0x001860F0
*/
// Range: 0x185CA0 -> 0x1860F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001860F0 -> 0x00186590
*/
// Range: 0x1860F0 -> 0x186590
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00186590 -> 0x001869AC
*/
// Range: 0x186590 -> 0x1869AC
static void xEntMechMove(class xEntMotion * motion /* r19 */, class xScene * sc /* r10 */, float dt /* r20 */, class xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x186590 -> 0x1869AC
        class xEntMechData * mech; // r2
        class xEntMotionMechData * mkasst; // r18
        unsigned int last; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001869B0 -> 0x00186AF0
*/
// Range: 0x1869B0 -> 0x186AF0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00186AF0 -> 0x00187338
*/
// Range: 0x186AF0 -> 0x187338
static void xEntSplineMove(class xEntMotion * motion /* r16 */, float dt /* r25 */, class xEntFrame * frame /* r18 */) {
    /* anonymous block */ {
        // Range: 0x186AF0 -> 0x187338
        class xEntSplineData * spline_data; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00187340 -> 0x00187F24
*/
// Range: 0x187340 -> 0x187F24
static void xEntMPMove(class xEntMotion * motion /* r21 */, class xScene * sc /* r20 */, float dt /* r24 */, class xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x187340 -> 0x187F24
        class xEntMPData * mp; // r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00187F30 -> 0x00188090
*/
// Range: 0x187F30 -> 0x188090
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188090 -> 0x001881D8
*/
// Range: 0x188090 -> 0x1881D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001881E0 -> 0x00188494
*/
// Range: 0x1881E0 -> 0x188494
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001884A0 -> 0x001885A0
*/
// Range: 0x1884A0 -> 0x1885A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001885A0 -> 0x00188CAC
*/
// Range: 0x1885A0 -> 0x188CAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188CB0 -> 0x00188E74
*/
// Range: 0x188CB0 -> 0x188E74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188E80 -> 0x00189168
*/
// Range: 0x188E80 -> 0x189168
