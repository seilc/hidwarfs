/*
    Compile unit: C:\TestBuild\in\Core\x\xSoundFX.cpp
...
static class xSoundFX * s_managedEnvSoundFX[1]; // size: 0x4, address: 0x608EE8
class xGlobals * xglobals; // size: 0x4, address: 0x6076C8
void xSoundFXEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x2A22E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2290 -> 0x002A22D8
*/
// Range: 0x2A2290 -> 0x2A22D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A22E0 -> 0x002A2608
*/
// Range: 0x2A22E0 -> 0x2A2608
void xSoundFXEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2A22E0 -> 0x2A2608
        class xSoundFX * t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2610 -> 0x002A2780
*/
// Range: 0x2A2610 -> 0x2A2780
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2780 -> 0x002A2788
*/
// Range: 0x2A2780 -> 0x2A2788
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2790 -> 0x002A2C60
*/
// Range: 0x2A2790 -> 0x2A2C60
void xSoundFXUpdateEnvironmentalStreamSounds(class xSoundFX * pSoundFXList /* r20 */, unsigned int numSounds /* r21 */) {
    /* anonymous block */ {
        // Range: 0x2A2790 -> 0x2A2C60
        unsigned int i; // r17
        class xVec3 playPos; // r29+0xE0
        ...
        signed int j; // r6
        signed int j; // r6
        float bestDist2[1]; // @ 0x00608EF0
        class xSoundFX * bestSoundFX[1]; // @ 0x00608EEC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002A2C60 -> 0x002A2C70
*/
// Range: 0x2A2C60 -> 0x2A2C70
