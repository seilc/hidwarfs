/*
    ...
    Language: C++
    Code range: 0x800EF97C -> 0x800F2D9C
*/
static unsigned char render_intersect; // size: 0x1, address: 0x80D69918
static unsigned char render_empty; // size: 0x1, address: 0x80D69919
static int cast_player_point; // size: 0x4, address: 0x80D6991C
static int cast_player_sphere; // size: 0x4, address: 0x80D69920
static int cast_player_line; // size: 0x4, address: 0x80D69924
static float cast_line_length; // size: 0x4, address: 0x80D61008
static unsigned char validate; // size: 0x1, address: 0x80D69928
static unsigned char added; // size: 0x1, address: 0x80D69929
static signed char init; // size: 0x1, address: 0x80D6992A
// Range: 0x800EF97C -> 0x800EFB40
static void add_tweaks() {
    ...
    // -> static float cast_line_length;
    // -> static int cast_player_line;
    // -> static int cast_player_sphere;
    // -> static int cast_player_point;
    // -> static unsigned char render_empty;
    // -> static unsigned char render_intersect;
    // -> static unsigned char added;
...
// total size: 0xC
struct /* @class$842xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845xSpacePartitionTree_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846xSpacePartitionTree_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847xSpacePartitionTree_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848xSpacePartitionTree_cpp */ {
    // Members
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D6100C
union entry_data {
...
class xSpacePartitionTree2D {
    ...
    int get_cell_bound(const union cell * c, float & x, float & y, float & r) const;

    unsigned char clip_line(float & x0, float & y0, float & x1, float & y1) const;

    unsigned char intersect_line_setup(float x0, float y0, float x1, float y1, int & ix, int & iy, int & dix, int & diy, int & end_ix, int & end_iy, int & a, float & tx0, float & ty0, float & tx1, float & ty1, float & dtx, float & dty);

    void debug_update();

    void debug_validate() const;

    unsigned char any_layer_empty(const union cell * c) const;

    void debug_validate_cell(const union cell * c) const;

    void debug_intersect_cell(const union cell * c) const;
...
// Range: 0x800EFB40 -> 0x800EFF58
// this: r31
void xSpacePartitionTree2D::create(float minx /* f26 */, float miny /* f27 */, float maxx /* r1+0x8 */, float maxy /* r1+0xC */, float min_width /* f30 */, float max_width /* f28 */, int max_entries /* r27 */) {
    // Local variables
    struct xVec2 gsize; // r1+0x10
    float * cs; // r30
    float * end_cs; // r26
    float * ics; // r29
    float * cf; // r28
...
// Range: 0x800EFF58 -> 0x800F013C
// this: r31
void xSpacePartitionTree2D::clear() {
    // Local variables
    union cell * gc; // r27
    union cell * end_gc; // r21
    union entry_data * fe; // r30
    union entry_data * end_fe; // r26
    int i; // r25
    union entry_node * fn; // r28
    union entry_node * end_fn; // r24
    int grid_size; // r23
    union cell * fc; // r29
    union cell * end_fc; // r22
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61013
// Range: 0x800F013C -> 0x800F0270
// this: r29
void xSpacePartitionTree2D::create_cell(union cell & c /* r31 */, unsigned short parent /* r27 */, int cid /* r28 */) {
    // Local variables
    union cell * const pc; // r30
    int xbit; // r26
    int ybit; // r25
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6101F
// Range: 0x800F0270 -> 0x800F0394
// this: r28
void xSpacePartitionTree2D::create_children(union cell & c /* r30 */) {
    // Local variables
    union cell * const cell_list; // r29
    union cell * cc; // r31
    union cell * end_cc; // r27
...
// Range: 0x800F0394 -> 0x800F03E0
// this: r3
void xSpacePartitionTree2D::reset_searchid() {
    // Local variables
    union entry_data * e; // r31
    union entry_data * end; // r30
}

static unsigned char done; // size: 0x1, address: 0x80D6992B
static signed char init; // size: 0x1, address: 0x80D6992C
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6102F
// total size: 0x8
...
// Range: 0x800F03E0 -> 0x800F03EC
// this: r3
static cb_fp_wrapper::cb_fp_wrapper(unsigned char (* cb)(union entry_data *, void *) /* r4 */, void * context /* r5 */) {}
...
struct cb_accum_wrapper {
    ...
    int maxResults; // offset 0x8, size 0x4
};
// Range: 0x800F03EC -> 0x800F0404
// this: r3
static cb_accum_wrapper::cb_accum_wrapper(union entry_data * * results /* r4 */, int max_results /* r5 */) {}

// Range: 0x800F0404 -> 0x800F0468
// this: r1+0x8
void xSpacePartitionTree2D::intersect_rect(float x0 /* r1+0xC */, float y0 /* r1+0x10 */, float x1 /* r1+0x14 */, float y1 /* r1+0x18 */, unsigned char (* cb)(union entry_data *, void *) /* r1+0x1C */, void * context /* r1+0x20 */) {
    // Local variables
    struct cb_fp_wrapper fp_wrapper; // r1+0x24
}

// Range: 0x800F0468 -> 0x800F04E0
// this: r1+0x8
int xSpacePartitionTree2D::intersect_rect(union entry_data * * results /* r31 */, int max_results /* r1+0xC */, float x0 /* r1+0x10 */, float y0 /* r1+0x14 */, float x1 /* r1+0x18 */, float y1 /* r1+0x1C */) {
    // Local variables
    struct cb_accum_wrapper accum_wrapper; // r1+0x20
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D61034
// Range: 0x800F04E0 -> 0x800F0B44
// this: r31
void xSpacePartitionTree2D::insert_internal(union entry_data * e /* r27 */, float x0 /* f28 */, float y0 /* f29 */, float x1 /* f30 */, float y1 /* f31 */, float width /* f26 */) {
    // Local variables
    float scale; // f27
    int gx0; // r26
    int gy0; // r25
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D61044
// total size: 0x10
struct /* @class$2254xSpacePartitionTree_cpp */ {
    // Members
...
// Range: 0x800F0B44 -> 0x800F0F8C
// this: r29
void xSpacePartitionTree2D::insert_internal(union entry_data * e /* r27 */, union cell * c /* r31 */, int end_depth /* r1+0x8 */, float x0 /* r1+0xC */, float y0 /* r1+0x10 */, float x1 /* r1+0x14 */, float y1 /* r1+0x18 */) {
    // Local variables
    int index; // r28
    float dxy; // f31
    float cx0; // f30
    ...
    struct /* @class$2254xSpacePartitionTree_cpp */ {
        ...
        float cx1; // offset 0x8, size 0x4
        float cy1; // offset 0xC, size 0x4
    } bound_stack[8]; // r1+0x1C
    union cell * const cell_list; // r25
    union entry_node * const node_list; // r24
    union entry_data * const entry_list; // r23
    union entry_node * n; // r26
    int ix; // r22
    int iy; // r21
    float ccx0; // f26
    float ccy0; // f25
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D61054
// Range: 0x800F0F8C -> 0x800F140C
// this: r27
void xSpacePartitionTree2D::erase_internal(union entry_data * e /* r31 */) {
    // Local variables
    int i; // r26
    int i; // r25
    union cell * const cell_list; // r21
    union entry_node * const node_list; // r22
    union entry_data * const entry_list; // r20
    unsigned short * owner; // r29
    unsigned short * end_owner; // r19
    union cell * c; // r28
    union entry_node * prev; // r24
    union entry_node * n; // r30
    unsigned short key; // r18
    int i; // r23
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D61063
// Range: 0x800F140C -> 0x800F1520
// this: r27
void xSpacePartitionTree2D::remove_empty(union cell * c /* r25 */) {
    // Local variables
    union cell * const cell_list; // r29
    unsigned short parent; // r28
    union cell * pc; // r31
    union cell * bro; // r30
    union cell * end_bro; // r26

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x800F1520 -> 0x800F16C8
// this: r3
int xSpacePartitionTree2D::get_cell_bound(const union cell * c /* r4 */, float & x /* r5 */, float & y /* r6 */, float & r /* r7 */) const {
    // Local variables
    union cell * const cell_list; // r29
    int depth; // r31
    int ix; // r28
...
// Range: 0x800F16C8 -> 0x800F1A68
// this: r3
unsigned char xSpacePartitionTree2D::clip_line(float & x0 /* r4 */, float & y0 /* r5 */, float & x1 /* r6 */, float & y1 /* r7 */) const {
    // Local variables
    float s; // f29
    float s; // f28
    float _c; // f31
...
// Range: 0x800F1A68 -> 0x800F1EE8
// this: r31
unsigned char xSpacePartitionTree2D::intersect_line_setup(float x0 /* r1+0x8 */, float y0 /* r1+0xC */, float x1 /* r1+0x10 */, float y1 /* r1+0x14 */, int & ix /* r24 */, int & iy /* r25 */, int & dix /* r22 */, int & diy /* r23 */, int & end_ix /* r1+0x18 */, int & end_iy /* r17 */, int & a /* r26 */, float & tx0 /* r27 */, float & ty0 /* r28 */, float & tx1 /* r29 */, float & ty1 /* r30 */, float & dtx /* r18 */, float & dty /* r19 */) {
    // Local variables
    float dx; // f29
    float dy; // f28
    float idx; // f31
...
// total size: 0x4
struct /* @class$901xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039xSpacePartitionTree_cpp */ {
    // Members
...
union /* @class$1040xSpacePartitionTree_cpp */ {
...
// total size: 0x10
struct /* @class$1453xSpacePartitionTree_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x4
struct cb_test_intersect {
    // Functions
    cb_test_intersect(int & count);
...
// Range: 0x800F1EE8 -> 0x800F20B4
// this: r26
void xSpacePartitionTree2D::debug_update() {
    // Local variables
    int count; // r1+0x10
    struct cb_test_intersect cb; // r1+0xC
    int i; // r29
    const struct xVec3 & player_loc; // r30
    int i; // r28
    const struct xSphere & player_bound; // r31
    int i; // r27
    const struct xVec3 & player_loc; // r25
    const struct xVec3 & player_dir; // r24
    struct xVec3 v0; // r1+0x20
...
// total size: 0x890
struct /* @class$1931xSpacePartitionTree_cpp */ {
    // Static members
...
// Range: 0x800F20B4 -> 0x800F20BC
// this: r3
cb_test_intersect::cb_test_intersect(int & count /* r4 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D61070
// Range: 0x800F20BC -> 0x800F257C
// this: r30
void xSpacePartitionTree2D::debug_validate() const {
    // Local variables
    int gy; // r29
    int gx; // r28
    const union cell * c; // r23
    union entry_data * e; // r31
    int i; // r27
    union entry_data * ende; // r22
    int i; // r26
    int i; // r25
    int i; // r24
...
// Range: 0x800F257C -> 0x800F2628
// this: r28
unsigned char xSpacePartitionTree2D::any_layer_empty(const union cell * c /* r29 */) const {
    // Local variables
    int total; // r30
    const union cell * cc; // r31
    const union cell * end_cc; // r27
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6107F
// Range: 0x800F2628 -> 0x800F2B18
// this: r30
void xSpacePartitionTree2D::debug_validate_cell(const union cell * c /* r28 */) const {
    // Local variables
    union cell * const cell_list; // r24
    union entry_node * const node_list; // r21
    union entry_data * const entry_list; // r20
    unsigned short key; // r19
    unsigned short i; // r23
    union entry_node * const n; // r27
    union entry_data * const e; // r31
    int j; // r26
    int j; // r25
    unsigned short * owner; // r29
    unsigned short * end_owner; // r22

    // References
    // -> static char __FUNCTION__[20];
}

static struct xColor_tag box_colors[8]; // size: 0x20, address: 0x8048D020
// Range: 0x800F2B18 -> 0x800F2C34
// this: r1+0x8
void xSpacePartitionTree2D::debug_intersect_cell(const union cell * c /* r31 */) const {
    // Local variables
    float x; // r1+0x18
    float z; // r1+0x14
    float r; // r1+0x10
    ...
    // References
    // -> static struct xColor_tag box_colors[8];
    // -> struct xGlobals * xglobals;
    // -> static unsigned char render_empty;
    // -> static unsigned char render_intersect;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D61093
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D610A2
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D610B1
// Range: 0x800F2C34 -> 0x800F2C74
// this: r31
static unsigned char cb_fp_wrapper::operator()(union entry_data * e /* r1+0x8 */) const {}

// Range: 0x800F2C74 -> 0x800F2D80
// this: r31
static unsigned char cb_accum_wrapper::operator()(union entry_data * e /* r1+0x8 */) {
    // Local variables
    char tempString[128]; // r1+0xC
...
// Range: 0x800F2D80 -> 0x800F2D9C
// this: r3
unsigned char cb_test_intersect::operator()() const {}
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D610C0
