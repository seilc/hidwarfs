/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\gc\iPad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8011A458 -> 0x8011B0C8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float g_rumblingThreshold; // size: 0x4, address: 0x80D69B48
// total size: 0xC
struct PADStatus {
    // Members
...
static struct PADStatus sPadData[4]; // size: 0x30, address: 0x80516C30
static unsigned long sPadMotor[4]; // size: 0x10, address: 0x80D69B4C
static int sPadCurrLevel[4]; // size: 0x10, address: 0x80D69B5C
static int sPadDeltaLevel[4]; // size: 0x10, address: 0x80D69B6C
// Range: 0x8011A458 -> 0x8011A4EC
int iPadInit() {
    // Local variables
    int i; // r31
...
// Range: 0x8011A4EC -> 0x8011A564
struct _tagxPad * iPadEnable(struct _tagxPad * pad /* r31 */, signed short port /* r1+0x8 */) {
    // Local variables
    unsigned int new_on; // r1+0xC
}

// Range: 0x8011A564 -> 0x8011A5DC
static signed char iPadConvStick(float in /* f1 */) {
    // Local variables
    float fin; // f31
}

// Range: 0x8011A5DC -> 0x8011A5E0
void iPadWaitForRevolution() {}

// Range: 0x8011A5E0 -> 0x8011A614
void iPadUpdateDataAll() {
    // References
    // -> static struct PADStatus sPadData[4];
}

static long long held_start[4]; // size: 0x20, address: 0x80516C60
static unsigned char held_through_reset[4]; // size: 0x4, address: 0x80D619F8
// Range: 0x8011A614 -> 0x8011A6FC
void iPadInHandReset(int port /* r31 */, unsigned int * on /* r29 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D619FC
...
// Range: 0x8011A6FC -> 0x8011AD7C
int iPadUpdate(struct _tagxPad * pad /* r31 */, unsigned int * on /* r29 */) {
    // Local variables
    unsigned int read_on; // r30
...
// Range: 0x8011AD7C -> 0x8011AD94
static unsigned int iPadConvFromGCN(unsigned int buttons /* r3 */, unsigned int gcn_flag /* r4 */, unsigned int x_flag /* r5 */) {}

// Range: 0x8011AD94 -> 0x8011AE04
void iPadStopRumble(struct _tagxPad * pad /* r31 */) {
    // References
    // -> static unsigned long sPadMotor[4];
    // -> static int sPadDeltaLevel[4];
    // -> static int sPadCurrLevel[4];
...
// Range: 0x8011AEB0 -> 0x8011AFB0
void iPadStartRumble(struct _tagxPad * pad /* r31 */, float intensity /* f31 */) {
    // References
    // -> static unsigned long sPadMotor[4];
    // -> static int sPadDeltaLevel[4];
    // -> static int sPadCurrLevel[4];
...
// Range: 0x8011AFB0 -> 0x8011B0C4
void iPadUpdateRumble(struct _tagxPad * pad /* r31 */) {
    // References
    // -> static unsigned long sPadMotor[4];
    // -> static int sPadCurrLevel[4];
    // -> static int sPadDeltaLevel[4];
