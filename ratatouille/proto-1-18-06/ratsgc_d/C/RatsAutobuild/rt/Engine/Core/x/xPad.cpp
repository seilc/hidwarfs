/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xPad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800A9A88 -> 0x800AA4BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800A9B20 -> 0x800A9B6C
struct _tagxPad * xPadEnable(int idx /* r30 */) {
    // Local variables
...
// Range: 0x800A9B6C -> 0x800A9BDC
void xPadRumbleEnable(int idx /* r3 */, int enable /* r4 */) {
    // Local variables
    struct _tagxPad * p; // r31
...
// Range: 0x800A9BDC -> 0x800A9C1C
void xPadClear() {
    // Local variables
    int i; // r31
}

// Range: 0x800A9C1C -> 0x800A9C50
void xPadClear(int idx /* r3 */) {
    // Local variables
    struct _tagxPad * p; // r31
...
static int submap; // size: 0x4, address: 0x80D693B8
static signed char init; // size: 0x1, address: 0x80D693BC
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D601A0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x800A9C50 -> 0x800AA044
int xPadUpdate(int idx /* r28 */, float time_passed /* f31 */) {
    // Local variables
    unsigned int new_on; // r1+0x8
    struct _tagxPad * p; // r31
    unsigned int fake_dpad; // r30
    int i; // r29
...
// Range: 0x800AA044 -> 0x800AA090
void xPadUpdateAllPads(float time_passed /* r1+0x8 */) {
    // Local variables
    int j; // r31
}

// Range: 0x800AA090 -> 0x800AA1C4
void SubMapAll(int * neuon /* r3 */, struct _tagxPad * xp /* r4 */) {
    // Local variables
    int old; // r30
    int keys; // r31
}

// Range: 0x800AA1C4 -> 0x800AA400
void xPadNormalizeAnalog(struct _tagxPad & pad /* r31 */, int inner_zone /* r27 */, int outer_zone /* r28 */) {
    // Local variables
    const struct _tagPadAnalog * src; // r29
    int i; // r30
}
...
// Range: 0x800AA400 -> 0x800AA420
void xPadKill() {}

// Range: 0x800AA420 -> 0x800AA4BC
void xPadAnalogIsDigital(int idx /* r3 */, int enable /* r4 */) {
    // Local variables
