/*
    ...
    Language: C++
    Code range: 0x800AA6F0 -> 0x800AA9B0
*/
// total size: 0xC
struct RwV3d {
    // Members
...
struct xPar gParPool[500]; // size: 0xDAC0, address: 0x80B871D8
struct xPar * gParDead; // size: 0x4, address: 0x80D693C0
// Range: 0x800AA6F0 -> 0x800AA760
void xParMemInit() {
    // Local variables
    int i; // r30
    struct xPar * p; // r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D601B0
// Range: 0x800AA7C4 -> 0x800AA89C
...
// Range: 0x800AA89C -> 0x800AA9B0
void xParInit(struct xPar * p /* r3 */) {
    // Local variables
    int i; // r31
}
