/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xEntDrive.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800632B0 -> 0x8006498C
*/
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5F440
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1030xEntDrive_cpp */ {
    // Members
...
// Range: 0x800632B0 -> 0x80063384
void xEntDriveInit(struct xEntDrive * drv /* r31 */, struct xEnt * driven /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D5F44E
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80063384 -> 0x80063B9C
void xEntDriveMount(struct xEntDrive * drv /* r31 */, struct xEnt * driver /* r30 */, float mt /* f30 */, const struct xCollis * coll /* r29 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D5F45D
// Range: 0x80063B9C -> 0x80063CD0
void xEntDriveDismount(struct xEntDrive * drv /* r31 */, float dmt /* f31 */) {
    // Local variables
    struct xEnt * pDriver; // r30

    // References
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5F46F
// total size: 0x40
...
// Range: 0x80063CD0 -> 0x800647D0
void xEntDriveUpdate(struct xEntDrive * drv /* r31 */, float dt /* f24 */) {
    // Local variables
...
// Range: 0x800647D0 -> 0x80064830
void xEntDriveSimpleInit(struct xEntDriveSimple * drv /* r31 */, struct xMat4x3 * mat /* r1+0x8 */) {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x804F2FE0
// Range: 0x80064830 -> 0x800648EC
void xEntDriveSimpleMount(struct xEntDriveSimple * drv /* r31 */, struct xEnt * driver /* r30 */) {
    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x800648EC -> 0x8006493C
void xEntDriveSimpleUpdate(struct xEntDriveSimple * drv /* r31 */) {
    // Local variables
    struct xVec3 newq; // r1+0x8
}

// Range: 0x8006493C -> 0x8006498C
