/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xstransvc.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800F8344 -> 0x800FAE08
*/
static int g_straninit; // size: 0x4, address: 0x80D69938
// total size: 0x28
struct PKRAssetType {
    // Members
...
struct st_STRAN_SCENE {
    ...
    struct st_PACKER_READ_DATA * spkg; // offset 0x8, size 0x4
    int flgHipHop; // offset 0xC, size 0x4
...
struct st_STRAN_DATA {
    // Members
    struct st_STRAN_SCENE hipscn[32]; // offset 0x0, size 0x2280
    unsigned int loadlock; // offset 0x2280, size 0x4
};
static struct st_STRAN_DATA g_xstdata; // size: 0x2284, address: 0x80514080
enum en_LAYER_TYPE {
    PKR_LTYPE_ALL = -1,
    PKR_LTYPE_DEFAULT = 0,
    PKR_LTYPE_TEXTURE = 1,
...
static struct PKRReadFuncs * g_pkrf; // size: 0x4, address: 0x80D6993C
static struct PKRAssetType * g_typeHandlers; // size: 0x4, address: 0x80D69940
static char g_localCode[4]; // size: 0x4, address: 0x80D61130
enum xRegion {
    eRegionUnknown = -1,
    eRegionUS = 0,
    eRegionBE = 1,
...
static enum xRegion g_localEnum; // size: 0x4, address: 0x80D61134
static unsigned int g_localDiscLanguageConfig; // size: 0x4, address: 0x80D69944
// Range: 0x800F8344 -> 0x800F8358
unsigned char xSTIsLoaded() {
    // References
    // -> static int g_straninit;
}

static int been_here; // size: 0x4, address: 0x80D69948
static int been_here; // size: 0x4, address: 0x80D6994C
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61138
// Range: 0x800F8358 -> 0x800F8484
int xSTStartup(struct PKRAssetType * handlers /* r31 */) {
    // References
    // -> static int g_straninit;
    // -> static int been_here;
    // -> static char __FUNCTION__[11];
    // -> static struct PKRReadFuncs * g_pkrf;
    // -> static struct PKRAssetType * g_typeHandlers;
    // -> static int been_here;
}

static int been_here; // size: 0x4, address: 0x80D69950
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61143
// Range: 0x800F8484 -> 0x800F852C
int xSTShutdown() {
    // References
    // -> static int g_straninit;
    // -> static int been_here;
...
static int been_here; // size: 0x4, address: 0x80D69954
static int been_here; // size: 0x4, address: 0x80D69958
static int been_here; // size: 0x4, address: 0x80D6995C
static int been_here; // size: 0x4, address: 0x80D69960
static int been_here; // size: 0x4, address: 0x80D69964
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6114F
// Range: 0x800F852C -> 0x800F8C38
int xSTPreLoadScene(unsigned int sid /* r1+0x8 */, void * userdata /* r23 */, int flg_hiphop /* r26 */, int fileflags /* r27 */, const char * filename /* r1+0xC */) {
    // Local variables
    int result; // r25
    struct st_STRAN_SCENE * sdata; // r31
    const char * sfile; // r30
    int cltver; // r29
    int cnt_retry; // r24
    char * cp; // r28
...
static int been_here; // size: 0x4, address: 0x80D69968
static int been_here; // size: 0x4, address: 0x80D6996C
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6115F
// Range: 0x800F8C38 -> 0x800F8DDC
int xSTQueueSceneAssets(unsigned int sid /* r29 */, int flg_hiphop /* r1+0x8 */) {
    // Local variables
    int result; // r30
    struct st_STRAN_SCENE * sdata; // r31
    int doTheHOP; // r1+0xC
...
// Range: 0x800F8DDC -> 0x800F8EEC
void xSTUnLoadSceneMany(unsigned int sceneID /* r27 */, int type /* r28 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r31
    struct st_STRAN_SCENE * sdata; // r30
    struct st_STRAN_SCENE * sdata; // r29

    // References
    // -> static struct PKRReadFuncs * g_pkrf;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61173
// Range: 0x800F8EEC -> 0x800F8F8C
float xSTLoadStep() {
    // Local variables
    float pct; // f31
    int rc; // r31
...
static int been_here; // size: 0x4, address: 0x80D69970
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6117F
// Range: 0x800F8F8C -> 0x800F9048
void xSTDisconnect(unsigned int sid /* r1+0x8 */, int flg_hiphop /* r1+0xC */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r31
    int doTheHOP; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6118D
// Range: 0x800F9048 -> 0x800F91D4
int xSTSwitchScene(unsigned int sid /* r24 */, void * userdata /* r25 */, int (* progmon)(void *, float) /* r28 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r30
    int rc; // r29
    int i; // r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6119C
// Range: 0x800F91D4 -> 0x800F92D8
char * xSTAssetName(unsigned int aid /* r1+0x8 */) {
    // Local variables
    const char * aname; // r29
    int scncnt; // r28
    int i; // r30
    struct st_STRAN_SCENE * sdata; // r31
...
static int been_here; // size: 0x4, address: 0x80D69974
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D611A9
// Range: 0x800F92D8 -> 0x800F9408
char * xSTAssetName(void * raw_HIP_asset /* r1+0x8 */) {
    // Local variables
    const char * aname; // r29
    int scncnt; // r28
    int i; // r30
    struct st_STRAN_SCENE * sdata; // r31
    unsigned int aid; // r27
...
// Range: 0x800F9408 -> 0x800F944C
char * xSTAssetNameFromPointer(void * model /* r1+0x8 */) {
    // Local variables
    struct PKRAssetTOCInfo ainfo; // r1+0xC
}

static int been_here; // size: 0x4, address: 0x80D69978
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D611B6
...
// Range: 0x800F944C -> 0x800F9588
enum en_pkrfindmyass xSTRandMemToAsset(struct PKRAssetTOCInfo * ainfo /* r1+0x8 */, void * addr /* r1+0xC */) {
    // Local variables
    int scncnt; // r28
    int i; // r30
    struct st_STRAN_SCENE * sdata; // r31
    enum en_pkrfindmyass rc_cur; // r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D611C8
// Range: 0x800F9588 -> 0x800F96FC
void * xSTFindAsset(unsigned int aid /* r27 */, unsigned int * size /* r28 */) {
    // Local variables
    void * memloc; // r29
    int scncnt; // r26
    int i; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D611D5
// Range: 0x800F96FC -> 0x800F985C
struct st_PACKER_ATOC_NODE * xSTFindAssetNode(unsigned int aid /* r27 */, unsigned int * size /* r28 */) {
    // Local variables
    struct st_PACKER_ATOC_NODE * memloc; // r29
    int scncnt; // r26
    int i; // r30
    struct st_STRAN_SCENE * sdata; // r31
    int asssize; // r1+0x8
...
static int been_here; // size: 0x4, address: 0x80D6997C
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D611E6
// Range: 0x800F985C -> 0x800F9990
int xSTAssetCountByType(unsigned int type /* r1+0x8 */) {
    // Local variables
    int sum; // r29
    int cnt; // r28
    struct st_STRAN_SCENE * sdata; // r31
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D611FA
// Range: 0x800F9990 -> 0x800F9B20
void * xSTFindAssetByType(unsigned int type /* r24 */, int idx /* r25 */, unsigned int * size /* r1+0x8 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r31
    void * memptr; // r27
    int scncnt; // r26
...
static int been_here; // size: 0x4, address: 0x80D69980
static int been_here; // size: 0x4, address: 0x80D69984
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6120D
// Range: 0x800F9B20 -> 0x800F9C40
int xSTGetAssetInfo(unsigned int aid /* r1+0x8 */, struct PKRAssetTOCInfo * tocainfo /* r1+0xC */) {
    // Local variables
    int found; // r29
    int scncnt; // r28
    int i; // r30
...
static int been_here; // size: 0x4, address: 0x80D69988
static int been_here; // size: 0x4, address: 0x80D6998C
static char __FUNCTION__[22]; // size: 0x16, address: 0x80516304
// Range: 0x800F9C40 -> 0x800F9DAC
int xSTGetAssetInfoByType(unsigned int type /* r23 */, int idx /* r26 */, struct PKRAssetTOCInfo * tocainfo /* r1+0x8 */) {
    // Local variables
    int found; // r27
    int sum; // r30
    int cnt; // r28
...
// Range: 0x800F9DAC -> 0x800F9DD8
char * xST_xAssetID_HIPFullPath(unsigned int aid /* r1+0x8 */) {}

static int been_here; // size: 0x4, address: 0x80D69990
static int been_here; // size: 0x4, address: 0x80D69994
static char __FUNCTION__[25]; // size: 0x19, address: 0x8051631A
// Range: 0x800F9DD8 -> 0x800F9F1C
char * xST_xAssetID_HIPFullPath(unsigned int aid /* r1+0x8 */, unsigned int * sceneID /* r26 */) {
    // Local variables
    const char * da_hipname; // r29
    struct st_STRAN_SCENE * sdata; // r31
    int rc; // r28
    int scncnt; // r27
    int i; // r30
...
static int been_here; // size: 0x4, address: 0x80D69998
static int been_here; // size: 0x4, address: 0x80D6999C
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6121D
// Range: 0x800F9F1C -> 0x800FA084
void xSTReportLoadTimes(unsigned int sceneID /* r28 */, int toScreen /* r26 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r31
    int scncnt; // r27
    int i; // r30
...
static int been_here; // size: 0x4, address: 0x80D699A0
static int been_here; // size: 0x4, address: 0x80D699A4
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D61230
// Range: 0x800FA084 -> 0x800FA268
static int XST_PreLoadScene(struct st_STRAN_SCENE * sdata /* r31 */, const char * sfile /* r30 */, int fileflags /* r1+0x8 */) {
    // Local variables
    int cltver; // r1+0xC
...
static char fname[64]; // size: 0x40, address: 0x80BA6940
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D61241
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0xC
struct /* @class$1080xstransvc_cpp */ {
    // Members
...
// Range: 0x800FA268 -> 0x800FA3A0
static char * XST_translate_sid(unsigned int sid /* r1+0x8 */, char * exten /* r31 */, unsigned char local /* r1+0xC */) {
    // References
    // -> static char fname[64];
    // -> static char g_localCode[4];
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[18];
}

static char fname[64]; // size: 0x40, address: 0x80BA6980
// Range: 0x800FA3A0 -> 0x800FA4EC
static char * XST_translate_sid_path(unsigned int sid /* r30 */, char * exten /* r1+0x8 */, unsigned char local /* r1+0xC */) {
    // Local variables
    char path_delimiter[2]; // r1+0xD
    char subdir[4]; // r1+0xF
...
// Range: 0x800FA4EC -> 0x800FA51C
static void XST_reset_raw() {
    // References
    // -> static struct st_STRAN_DATA g_xstdata;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D61253
// Range: 0x800FA51C -> 0x800FA640
static struct st_STRAN_SCENE * XST_lock_next() {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r30
    int i; // r31
    int uselock; // r29
...
static int been_here; // size: 0x4, address: 0x80D699A8
static int been_here; // size: 0x4, address: 0x80D699AC
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61261
// Range: 0x800FA640 -> 0x800FA758
static void XST_unlock(struct st_STRAN_SCENE * sdata /* r31 */) {
    // References
    // -> static struct st_STRAN_DATA g_xstdata;
    // -> static int been_here;
    // -> static char __FUNCTION__[11];
...
static int been_here; // size: 0x4, address: 0x80D699B0
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6126C
// Range: 0x800FA758 -> 0x800FA834
...
// Range: 0x800FA834 -> 0x800FA848
static struct st_STRAN_SCENE * XST_get_rawinst(int idx /* r3 */) {
    // References
    // -> static struct st_STRAN_DATA g_xstdata;
}

// Range: 0x800FA848 -> 0x800FA8A4
...
static int been_here; // size: 0x4, address: 0x80D699B4
static int been_here; // size: 0x4, address: 0x80D699B8
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6127B
// Range: 0x800FA8A4 -> 0x800FA9D8
static struct st_STRAN_SCENE * XST_nth_locked(int nth /* r28 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r29
    int cnt; // r30
    int i; // r31
...
static int been_here; // size: 0x4, address: 0x80D699BC
static int been_here; // size: 0x4, address: 0x80D699C0
static int been_here; // size: 0x4, address: 0x80D699C4
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6128A
// Range: 0x800FA9D8 -> 0x800FAB7C
static struct st_STRAN_SCENE * XST_find_bySID(unsigned int sid /* r28 */, int flagHipHop /* r1+0x8 */) {
    // Local variables
    struct st_STRAN_SCENE * da_sdata; // r29
    int i; // r30
    struct st_STRAN_SCENE * tmp_sdata; // r31
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80516333
// Range: 0x800FAB7C -> 0x800FAC30
void xSTSetLocalizationCode(const char * code /* r31 */) {
    // References
    // -> static char __FUNCTION__[23];
    // -> static enum xRegion g_localEnum;
    // -> static char g_localCode[4];
}

char * region_array[21]; // size: 0x54, address: 0x80511598
// Range: 0x800FAC30 -> 0x800FAC38
char * xSTGetLocalizationCode() {
    // References
    // -> static char g_localCode[4];
}

// Range: 0x800FAC38 -> 0x800FAC40
enum xRegion xSTGetLocalizationEnum() {
    // References
    // -> static enum xRegion g_localEnum;
}

// Range: 0x800FAC40 -> 0x800FAC68
void xSTAddToDiscLanguageConfig(enum xRegion region /* r3 */) {
    // References
    // -> static unsigned int g_localDiscLanguageConfig;
}

// Range: 0x800FAC68 -> 0x800FAC70
unsigned int xSTGetDiscLanguageConfig() {
    // References
    // -> static unsigned int g_localDiscLanguageConfig;
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D61299
// Range: 0x800FAC70 -> 0x800FAE08
int xSTGetAssetTypes(unsigned int * types /* r1+0x8 */, int max_types /* r1+0xC */) {
    // Local variables
    unsigned int * type_buffer; // r27
    unsigned int * type; // r30
    unsigned int * end_type; // r21
    int scenes; // r20
    int i; // r26
    struct st_STRAN_SCENE * sdata; // r25
    struct st_PACKER_READ_DATA * pr; // r24
    const struct PKRAssetType * atype; // r28
    int itotal; // r23
    unsigned int last_type_value; // r22
    unsigned int * otype; // r29
    unsigned int * end_otype; // r19
    const unsigned int * itype; // r31
    const unsigned int * end_itype; // r18
