/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xLight.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008C200 -> 0x8008F4A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xLight * sLight[128]; // size: 0x200, address: 0x80B7C588
static int sLightTotal; // size: 0x4, address: 0x80D69278
static struct xLight sTempLights[16]; // size: 0x2580, address: 0x80B7C788
static struct xLightAsset sTempLightAssets[16]; // size: 0x4C0, address: 0x80B7ED08
static struct xModelInstance * sTempLightCards[16]; // size: 0x40, address: 0x80B7F1C8
// total size: 0xC
struct lightFlash {
    // Members
    struct xLight * light; // offset 0x0, size 0x4
    float lifetime; // offset 0x4, size 0x4
    float downTime; // offset 0x8, size 0x4
};
static struct lightFlash sLightFlashes[4]; // size: 0x30, address: 0x80B7F208
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D5FC60
// Range: 0x8008C200 -> 0x8008C304
void xLightResetAll() {
    // Local variables
    unsigned long il; // r30
    unsigned long ir; // r29
    int i; // r31

    // References
    // -> static int sLightTotal;
    // -> static struct xLight sTempLights[16];
    // -> static struct xLight * sLight[128];
    // -> static char __FUNCTION__[15];
}

// Range: 0x8008C304 -> 0x8008C32C
void xLightSceneInit() {}

// Range: 0x8008C32C -> 0x8008C350
void xLightSceneExit() {}

// Range: 0x8008C350 -> 0x8008C390
void xLightSceneReset() {
    // Local variables
    int i; // r31

    // References
    // -> static struct lightFlash sLightFlashes[4];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5FC6F
// Range: 0x8008C390 -> 0x8008C53C
void xLightInit(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// total size: 0x1
struct /* @class$869xLight_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$870xLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$871xLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$872xLight_cpp */ {
    // Members
...
// Range: 0x8008C53C -> 0x8008C58C
void DetachLightCB(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct xLight * light; // r31
}
...
static struct tweak_callback detachLight; // size: 0x28, address: 0x8047EFD0
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5FC7A
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8008C58C -> 0x8008CBE4
void xLightInit(struct xBase * b /* r28 */, struct xLightAsset * tasset /* r30 */) {
    // Local variables
    struct xLight * light; // r31
    unsigned int itype; // r29
    struct RpAtomic * imodel; // r27
    char name[128]; // r1+0x88
    char buffer[128]; // r1+0x8

    // References
    // -> static struct tweak_callback detachLight;
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x804F5640
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8008CBE4 -> 0x8008CF18
void xLightInitTempLights() {
    // Local variables
    struct RpAtomic * lightCardModel; // r30
    int i; // r31

    // References
    // -> static struct lightFlash sLightFlashes[4];
    // -> static struct xModelInstance * sTempLightCards[16];
    // -> static char __FUNCTION__[21];
    // -> static struct xLight sTempLights[16];
    // -> static struct xLightAsset sTempLightAssets[16];
    // -> struct xColor_tag g_WHITE;
    // -> struct xVec3 m_Null;
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x804F5655
// total size: 0x10
struct _xFColor {
    // Members
...
// Range: 0x8008CF18 -> 0x8008D174
struct xLight * xLightCreateTempInternal(unsigned char useLightCard /* r1+0x8 */, const char * fileName /* r1+0xC */, unsigned int lineNumber /* r1+0x10 */) {
    // Local variables
    int i; // r31
    struct _xFColor color; // r1+0x14
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x804F566E
// Range: 0x8008D174 -> 0x8008D290
void xLightDestroyTempInternal(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[26];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D5FC85
// Range: 0x8008D290 -> 0x8008D3AC
void xLightResolveLinks() {
    // Local variables
    int i; // r30
    struct xLight * xl; // r31
...
// Range: 0x8008D3AC -> 0x8008D41C
void xLightDestroyAll() {
    // Local variables
    int total; // r30
    int i; // r31
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5FC98
// Range: 0x8008D41C -> 0x8008D4D4
void xLightDestroy(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5FCA6
// Range: 0x8008D4D4 -> 0x8008D67C
void xLightReset(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5FCB2
// Range: 0x8008D67C -> 0x8008DA8C
void xLightEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r25 */) {
    // Local variables
    struct xLight * xl; // r31
    unsigned char resetEffect; // r28
    unsigned char resetColor; // r24
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x804F5688
// total size: 0x1C
...
// Range: 0x8008DA8C -> 0x8008DECC
static void xLightUpdateLightCard(struct xLight * xl /* r30 */) {
    // Local variables
    struct xVec3 pos; // r1+0x48
    struct xMat4x3 cameraMat; // r1+0x60
    struct RwMatrixTag * modelMat; // r31
    float right_len; // f31
    float up_len; // f30
    float at_len; // f29
    struct xVec3 _up_; // r1+0x3C
    struct xVec3 _at_; // r1+0x30
    struct xVec3 _right_; // r1+0x24
    struct RpAtomic * lightCardAtomic; // r28
    struct RpGeometry * geometery; // r29
    struct RpMaterial * material; // r27
    struct _xFColor lightColor; // r1+0x14
    float maxColor; // f28
    float colorMultiplier; // f27
...
// Range: 0x8008DECC -> 0x8008E1FC
void xLightUpdateAll(float dt /* f30 */) {
    // Local variables
    int i; // r29
    struct lightFlash & flash; // r30
    struct xLight * xl; // r31
    float percentage; // f31
    struct _xFColor tempColor; // r1+0x1C
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5FCC0
// total size: 0x40
struct RwMatrixTag {
    // Members
...
// Range: 0x8008E1FC -> 0x8008E384
void xLightRenderAll() {
    // Local variables
    int i; // r30
    struct xLight * xlight; // r31
    struct RwMatrixTag modelMat; // r1+0x8
...
// Range: 0x8008E384 -> 0x8008E42C
void xLightAddLocalEnv(struct xEnv * env /* r1+0x8 */) {
    // Local variables
    int i; // r30
    struct xLight * xlight; // r31
    struct iLight * light; // r29
...
// Range: 0x8008E42C -> 0x8008E454
void xLightRemoveLocalEnv(struct xEnv * env /* r1+0x8 */) {}
...
// total size: 0x8
class xLightCollisionCallback {
    // Functions
    static unsigned char operator()(struct xEnt & ent);

    static xLightCollisionCallback(const struct xSphere & sphere, struct xLight * light);
...
// Range: 0x8008E454 -> 0x8008E624
void xLightPrepLocal() {
    // Local variables
    int i; // r29
    struct xLight * xlight; // r31
    const struct xSphere * lightSphere; // r28
    struct xBound tempBound; // r1+0x8C
    class xLightCollisionCallback static_callback; // r1+0x8
    int i; // r30
...
// Range: 0x8008E624 -> 0x8008E7BC
// this: r30
static unsigned char xLightCollisionCallback::operator()(struct xEnt & ent /* r26 */) {
    // Local variables
    struct xCollis coll; // r1+0x8
    struct xModelInstance * model; // r31
    int furthestLight; // r27
    int i; // r29
    int freeLight; // r28
}

// Range: 0x8008E7BC -> 0x8008E7C8
// this: r3
static xLightCollisionCallback::xLightCollisionCallback(const struct xSphere & sphere /* r4 */, struct xLight * light /* r5 */) {}
...
// Range: 0x8008E7C8 -> 0x8008E85C
void xLightAddLocal(struct xModelInstance * minst /* r29 */) {
    // Local variables
    struct xLight * * xlights; // r30
    struct iLight * ilights[4]; // r1+0x8
    int i; // r31
}

// Range: 0x8008E85C -> 0x8008E900
void xLightRemoveLocal(struct xModelInstance * minst /* r29 */) {
    // Local variables
    struct xLight * * xlights; // r31
    struct iLight * ilights[4]; // r1+0x8
    int i; // r30
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5FCD0
// Range: 0x8008E900 -> 0x8008E9D8
void xLightSetEffect(struct xLight * xl /* r31 */, unsigned int effectID /* r30 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D5FCE0
// Range: 0x8008E9D8 -> 0x8008EAE0
void xLightResetEffect(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

static int been_here; // size: 0x4, address: 0x80D6927C
static int been_here; // size: 0x4, address: 0x80D69280
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D5FCF2
// Range: 0x8008EAE0 -> 0x8008EC58
void xLightOn(struct xLight * xl /* r31 */, unsigned char on /* r1+0x8 */, float transitionTime /* f31 */) {
    // References
...
// Range: 0x8008EC58 -> 0x8008ECBC
void xLightToggle(struct xLight * xl /* r31 */, float transitionTime /* f31 */) {}

// Range: 0x8008ECBC -> 0x8008ED44
void xLightSetColor(struct xLight * xl /* r1+0x8 */, float r /* r1+0xC */, float g /* r1+0x10 */, float b /* r1+0x14 */, float transitionTime /* r1+0x18 */) {
    // Local variables
    struct _xFColor col; // r1+0x1C
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D5FCFB
// Range: 0x8008ED44 -> 0x8008EF6C
void xLightSetColor(struct xLight * xl /* r31 */, const struct _xFColor & col /* r30 */, float transitionTime /* f31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8008EF90 -> 0x8008EFC4
void xLightGetColor(struct xLight * xl /* r1+0x8 */, struct _xFColor & col /* r1+0xC */) {}

// Range: 0x8008EFC4 -> 0x8008EFF8
void xLightSetPos(struct xLight * xl /* r1+0x8 */, const struct xVec3 & pos /* r1+0xC */) {}

// Range: 0x8008EFF8 -> 0x8008F02C
void xLightSetRadius(struct xLight * xl /* r1+0x8 */, float radius /* r1+0xC */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5FD0A
// Range: 0x8008F02C -> 0x8008F288
void xLightFlash(const struct xVec3 & pos /* r1+0x8 */, const struct _xFColor & color /* r1+0xC */, float radius /* r1+0x10 */, float upTime /* f30 */, float maxTime /* f29 */, float downTime /* f31 */) {
    // Local variables
    struct lightFlash * flash; // r31
    int i; // r30
...
// Range: 0x8008F288 -> 0x8008F340
void xLightDebugRender() {
    // Local variables
    int i; // r30
    struct xLight * xlight; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D5FD16
// Range: 0x8008F340 -> 0x8008F4A8
void xLightDebugReset(struct xLight * light /* r31 */) {
    // Local variables
    const struct xLightAsset * tasset; // r1+0x8
