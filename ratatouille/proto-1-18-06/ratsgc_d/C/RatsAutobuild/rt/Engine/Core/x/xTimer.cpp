/*
    ...
    Language: C++
    Code range: 0x800FE48C -> 0x800FED68
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800FE48C -> 0x800FE53C
static float GetRandomizedTime(struct xTimerAsset * tasset /* r31 */) {
    // Local variables
    unsigned int halfRangeMilli; // r30
    int offset; // r29
    float time; // f31
}

// Range: 0x800FE53C -> 0x800FE56C
void xTimerInit(void * b /* r1+0x8 */, void * tasset /* r1+0xC */) {}

static unsigned int sPauseTimerHash[20]; // size: 0x50, address: 0x80516380
// Range: 0x800FE56C -> 0x800FE670
static int xTimer_ObjIDIsPauseTimer(unsigned int id /* r3 */) {
    // Local variables
    int foo; // r30
    int bar; // r29
    int i; // r31
...
// Range: 0x800FE670 -> 0x800FE710
void xTimerInit(struct xBase * b /* r30 */, struct xTimerAsset * tasset /* r29 */) {
    // Local variables
    struct xTimer * t; // r31
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61378
// Range: 0x800FE710 -> 0x800FE818
void xTimerReset(struct xTimer * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61384
// total size: 0x0
...
// Range: 0x800FE818 -> 0x800FE920
void xTimerSave(struct xTimer * ent /* r31 */, struct xSerial * s /* r30 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6138F
// Range: 0x800FE920 -> 0x800FEA28
void xTimerLoad(struct xTimer * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6139A
// Range: 0x800FEA28 -> 0x800FEBD4
void xTimerEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */) {
    // Local variables
    struct xTimer * t; // r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D613A8
// total size: 0x50
...
// Range: 0x800FEBD4 -> 0x800FED68
void xTimerUpdate(struct xBase * to /* r30 */, struct xScene * sc /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    struct xTimer * t; // r31
