/*
    ...
    Language: C++
    Code range: 0x8006BD8C -> 0x8006C458
*/
// Range: 0x8006BD8C -> 0x8006BDB4
void xFogClearFog() {}

// Range: 0x8006BDB4 -> 0x8006BDE4
void xFogInit(void * b /* r1+0x8 */, void * tasset /* r1+0xC */) {}
...
// Range: 0x8006BDE4 -> 0x8006BE5C
void xFogInit(struct xBase * b /* r29 */, struct xFogAsset * tasset /* r30 */) {
    // Local variables
    struct _xFog * t; // r31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D5F628
// Range: 0x8006BE5C -> 0x8006BF48
void xFogReset(struct _xFog * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D5F632
// total size: 0x0
struct xSerial {};
// Range: 0x8006BF48 -> 0x8006C038
void xFogSave(struct _xFog * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D5F63B
// Range: 0x8006C038 -> 0x8006C128
void xFogLoad(struct _xFog * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5F644
enum RwFogType {
...
// Range: 0x8006C128 -> 0x8006C30C
void xFogEventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    struct _xFog * t; // r31
    struct iFogParams fog; // r1+0xC

    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5F650
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8006C30C -> 0x8006C458
void xFogUpdate(struct xBase * to /* r30 */, struct xScene * sc /* r1+0x8 */) {
    // Local variables
    struct _xFog * t; // r31
