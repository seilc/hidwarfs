/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xLightEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802632A4 -> 0x8026406C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x802632A4 -> 0x802632DC
unsigned char xLightEffectIsValid(struct xBase * base /* r3 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65650
// total size: 0x30
struct xLightEffectFlickerAsset : public xDynAsset {
    // Members
    struct _xFColor maxColorVariation; // offset 0x10, size 0x10
    float flickerRate; // offset 0x20, size 0x4
    float randomFlickerRate; // offset 0x24, size 0x4
    float blendTime; // offset 0x28, size 0x4
    unsigned int flags; // offset 0x2C, size 0x4
};
// total size: 0x58
class xLightEffectFlicker : private xLightEffectBase {
    // Functions
    void InitDebugTweak();

    void UpdateEffect(struct xLight & light, float dt);

    // Members
public:
    char effectName[64]; // offset 0x14, size 0x40
private:
    struct xLightEffectFlickerAsset * tasset; // offset 0x54, size 0x4
};
// Range: 0x802632DC -> 0x802634A4
void xLightEffectFlicker::Init(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r28
    class xLightEffectFlicker * flickerEffect; // r30
...
union /* @class$760xLightEffect_cpp */ {
...
// total size: 0xC
struct /* @class$1081xLightEffect_cpp */ {
    // Members
...
// Range: 0x80263724 -> 0x80263778
void xLightEffectFlicker::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r1+0x8 */) {}

// Range: 0x80263778 -> 0x802637C8
void xLightEffectFlicker::StopEffect(struct xLight & light /* r31 */, unsigned char resetColor /* r1+0x8 */) {}
...
// Range: 0x802637C8 -> 0x8026398C
// this: r30
void xLightEffectFlicker::UpdateEffect(struct xLight & light /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    struct xLightEffectFlickerData & flickerData; // r31
    struct _xFColor newColor; // r1+0xC
    float randomNum; // f31
    float blendtime; // f29
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65655
// total size: 0x38
struct xLightEffectStrobeAsset : public xDynAsset {
    // Members
    struct _xFColor minColor; // offset 0x10, size 0x10
    float fadeUpTime; // offset 0x20, size 0x4
    float fadeDownTime; // offset 0x24, size 0x4
    float timeMax; // offset 0x28, size 0x4
    float timeMin; // offset 0x2C, size 0x4
    float randomTimeMax; // offset 0x30, size 0x4
    float randomTimeMin; // offset 0x34, size 0x4
};
// total size: 0x58
class xLightEffectStrobe : private xLightEffectBase {
    // Functions
    void InitDebugTweak();
...
public:
    char effectName[64]; // offset 0x14, size 0x40
private:
    struct xLightEffectStrobeAsset * tasset; // offset 0x54, size 0x4
};
// Range: 0x8026398C -> 0x80263B60
void xLightEffectStrobe::Init(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r28
    class xLightEffectStrobe * strobeEffect; // r30

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x80263B9C -> 0x80263E54
// this: r31
...
// Range: 0x80263E54 -> 0x80263EB0
void xLightEffectStrobe::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r1+0x8 */) {}

// Range: 0x80263EB0 -> 0x80263F00
void xLightEffectStrobe::StopEffect(struct xLight & light /* r31 */, unsigned char resetColor /* r1+0x8 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6565A
// Range: 0x80263F00 -> 0x8026406C
// this: r31
void xLightEffectStrobe::UpdateEffect(struct xLight & light /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    struct xLightEffectStrobeData & strobeData; // r30
...
// total size: 0x18
struct {} xLightEffectStrobe::__vtable; // size: 0x18, address: 0x80524320
// total size: 0x18
struct {} xLightEffectFlicker::__vtable; // size: 0x18, address: 0x80524338
// total size: 0x18
struct {} xLightEffectBase::__vtable; // size: 0x18, address: 0x80524350
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$925xLightEffect_cpp */ {
    // Members
