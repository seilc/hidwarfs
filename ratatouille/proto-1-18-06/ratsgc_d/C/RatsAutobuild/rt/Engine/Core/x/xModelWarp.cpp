/*
    ...
    Language: C++
    Code range: 0x80241978 -> 0x802422F4
*/
// total size: 0x10
struct _xFColor {
    // Members
...
static struct _xFColor default_color; // size: 0x10, address: 0x80D65040
static int render_texture; // size: 0x4, address: 0x80D65050
static int render_bound; // size: 0x4, address: 0x80D65054
static int render_rect; // size: 0x4, address: 0x80D65058
static unsigned char force_default_color; // size: 0x1, address: 0x80D6B108
// Range: 0x80241978 -> 0x80241B40
...
// total size: 0xC
struct /* @class$848xModelWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$849xModelWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$850xModelWarp_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$851xModelWarp_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$852xModelWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$853xModelWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$854xModelWarp_cpp */ {
    // Members
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x80D18900
// total size: 0x18
struct xBox {
    // Members
...
static struct render_context render_contexts[8]; // size: 0x400, address: 0x80D18950
static int render_contexts_size; // size: 0x4, address: 0x80D6B10C
// Range: 0x80241B40 -> 0x80241B98
static struct render_context * get_render_context(struct RpAtomic * atomic /* r3 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6505C
// Range: 0x80241B98 -> 0x80241D14
static void set_texture(struct RpAtomic * atomic /* r1+0x8 */, struct RwTexture * texture /* r1+0xC */) {
    // Local variables
...
// Range: 0x80241D14 -> 0x80241D48
static void destroy_render_context(struct render_context & context /* r31 */) {}

// Range: 0x80241D48 -> 0x80241D50
static struct RpAtomic * render_callback() {}
...
// Range: 0x80241D50 -> 0x80241E24
void xModelWarpSceneEnter() {
    // Local variables
    unsigned int test_atomic_id; // r30
    struct RpAtomic * test_atomic; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D65068
struct xMat4x3 g_I3; // size: 0x40, address: 0x80B7FA80
// Range: 0x80241E90 -> 0x802420D4
void xModelWarpSetEffect(struct RpAtomic * atomic /* r30 */, const struct xBox * box /* r26 */, const struct _xFColor * color /* r27 */) {
    // Local variables
    struct render_context * old_context; // r29
    struct render_context & context; // r31
    struct RpGeometry * geom; // r28
    struct RpMaterial * material; // r1+0x8
...
// Range: 0x802420D4 -> 0x8024216C
void xModelWarpSphereMapUVsByNormals(struct xVec2 * uv /* r31 */, int verts_size /* r1+0x8 */, const struct xVec3 * norm /* r30 */) {
    // Local variables
    struct xVec2 * end_uv; // r29
}

// Range: 0x8024216C -> 0x80242234
void xModelWarpSphereMapUVsByOffsets(struct xVec2 * uv /* r31 */, int verts_size /* r1+0x8 */, const struct xVec3 * vert /* r30 */, const struct xVec3 & center /* r1+0xC */) {
    // Local variables
    struct xVec2 * end_uv; // r29
    struct xVec3 offset; // r1+0x10
}

// Range: 0x80242234 -> 0x802422F4
void xModelWarpSphereMapUVs(struct RpAtomic * atomic /* r24 */, unsigned char use_normals /* r1+0x8 */) {
    // Local variables
    struct RpGeometry * geom; // r31
    int verts_size; // r30
    struct RpMorphTarget * mt; // r29
    const struct xVec3 * vert; // r27
    const struct xVec3 * norm; // r26
    struct xVec2 * uv; // r28
    const struct xVec3 & center; // r25
}
