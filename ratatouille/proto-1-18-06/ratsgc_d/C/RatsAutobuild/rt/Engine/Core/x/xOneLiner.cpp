/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xOneLiner.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80286CF0 -> 0x802872A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class xOneLiner * sDelayedSound; // size: 0x4, address: 0x80D6B358
unsigned char sDebugIgnoreTime; // size: 0x1, address: 0x80D6B35C
unsigned char sDebugIgnoreProb; // size: 0x1, address: 0x80D6B35D
// total size: 0x44
struct xSoundHistory {
    ...
    // Members
    int mNumSounds; // offset 0x0, size 0x4
    int mTotalRequests; // offset 0x4, size 0x4
    struct xRequestedSound mHistory[5]; // offset 0x8, size 0x3C
};
static struct xSoundHistory sSndHistory; // size: 0x44, address: 0x80D26CE8
// Range: 0x80286CF0 -> 0x80286D18
static void OneLinerDebugModeCB() {
    // References
    // -> static struct xSoundHistory sSndHistory;
}

// Range: 0x80286D18 -> 0x80286D74
// this: r30
void xSoundHistory::Display() {
    // Local variables
    int i; // r31
}
...
struct xRequestedSound {
    // Functions
    void Display(unsigned char wasPlayed);

    // Members
    class xOneLiner * mSound; // offset 0x0, size 0x4
    float mRequestTime; // offset 0x4, size 0x4
    int mRequestID; // offset 0x8, size 0x4
};
// Range: 0x80286D74 -> 0x80286DF0
// this: r31
void xRequestedSound::Display(unsigned char wasPlayed /* r1+0x8 */) {}

// Range: 0x80286DF0 -> 0x80286E30
static void OneLinerDebugInit() {
    // References
    // -> static struct xSoundHistory sSndHistory;
}

// Range: 0x80286E30 -> 0x80286E44
// this: r3
void xSoundHistory::Init() {}
...
class xOneLiner {
    // Functions
    unsigned char PlaySoundCore();

    unsigned char IsProbable() const;

    unsigned char NoInhibitions() const;

    float CalcTimeToWait() const;

    // Static members
    static unsigned char sDebugIgnoreProb; // size: 0x1
    static unsigned char sDebugIgnoreTime; // size: 0x1
    static unsigned int sLastLevelAdjustGGTokenCount; // size: 0x4
    static float sLevelProbabilityAdjust; // size: 0x4
    static float sLevelCycleTimeAdjust; // size: 0x4
    static class xOneLiner * sDelayedSound; // size: 0x4
...
// Range: 0x80286E44 -> 0x80286E6C
void xOneLiner::SceneInit() {}

// Range: 0x80286E6C -> 0x80286E78
void xOneLiner::SceneReset() {
    // References
    // -> class xOneLiner * sDelayedSound;
}

// Range: 0x80286E78 -> 0x80286EDC
void xOneLiner::UpdateSounds() {
    // Local variables
    class xOneLiner * sound; // r31
...
// Range: 0x80286EDC -> 0x80286F48
// this: r31
void xSoundHistory::Age() {
    // Local variables
    float now; // f31
}

// Range: 0x80286F48 -> 0x80286FC8
// this: r31
void xSoundHistory::ScrollSounds() {
    // Local variables
    int i; // r30
}

// Range: 0x80286FE4 -> 0x80287040
void xOneLiner::TweaksInit() {
    // References
    // -> unsigned char sDebugIgnoreProb;
    // -> unsigned char sDebugIgnoreTime;
}

// Range: 0x80287040 -> 0x80287168
// this: r31
unsigned char xOneLiner::PlaySoundCore() {
    // Local variables
    float timeNow; // f31
    float timeToPlay; // f30
...
// Range: 0x80287168 -> 0x80287204
// this: r30
unsigned char xOneLiner::IsProbable() const {
    // Local variables
    unsigned int probBits; // r31
    float prob; // f31
...
// Range: 0x80287204 -> 0x802872A0
// this: r28
unsigned char xOneLiner::NoInhibitions() const {}
...
// total size: 0x4
struct /* @class$1048xOneLiner_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1186xOneLiner_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737xOneLiner_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738xOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739xOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740xOneLiner_cpp */ {
    // Members
...
// Range: 0x802872A0 -> 0x802872A8
// this: r3
float xOneLiner::CalcTimeToWait() const {}

// total size: 0x8
class xOneLinerList {
    // Members
    unsigned int mNumSounds; // offset 0x0, size 0x4
    class xOneLiner * mSounds; // offset 0x4, size 0x4
};
