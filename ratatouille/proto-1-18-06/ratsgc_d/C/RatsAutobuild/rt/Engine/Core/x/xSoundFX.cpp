/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xSoundFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800EEC08 -> 0x800EF7EC
*/
static char __FUNCTION__[21]; // size: 0x15, address: 0x80513F90
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800EEC08 -> 0x800EECEC
static unsigned char xSoundFXWillSendDone(struct xSoundFX * pSoundFX /* r30 */) {
    // Local variables
...
// Range: 0x800EECEC -> 0x800EED1C
void xSoundFXInit(void * t /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D60FD0
// Range: 0x800EED1C -> 0x800EEF24
void xSoundFXInit(struct xSoundFX * t /* r31 */, struct xSoundFXAsset * asset /* r30 */) {
    // References
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D60FDD
// Range: 0x800EEF24 -> 0x800EF010
void xSoundFXReset(struct xSoundFX * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D60FEB
// Range: 0x800EF010 -> 0x800EF3D8
void xSoundFXEventCB(struct xBase * to /* r1+0x8 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r30 */) {
    // Local variables
    struct xSoundFX * t; // r31
    float destVolume; // f31
    float startVolume; // f30
    float destVolume; // f29

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x80513FA5
// Range: 0x800EF3D8 -> 0x800EF518
static unsigned char xSoundFXEnsureFreeAudioStream(unsigned char willingToStopMainGameMusic /* r1+0x8 */) {
    // Local variables
    unsigned char haveFreeStreamedVoice; // r31

    // References
    // -> static char __FUNCTION__[30];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D60FFB
// total size: 0x50
...
// Range: 0x800EF518 -> 0x800EF754
static void xSoundFXPlay(struct xSoundFX * t /* r31 */) {
    // Local variables
    int sndFlags; // r30
    struct xEnt * ent; // r29
...
// total size: 0x1
struct /* @class$845xSoundFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848xSoundFX_cpp */ {
    // Members
...
// Range: 0x800EF754 -> 0x800EF780
static void xSoundFXStop(struct xSoundFX * t /* r1+0x8 */) {}
...
// Range: 0x800EF780 -> 0x800EF7EC
struct xSoundFX * xSoundFXGet(unsigned int soundfxID /* r3 */) {
    // Local variables
    struct zScene * s; // r31
    int count; // r28
    struct xSoundFX * sfx; // r30
    int i; // r29
