/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCollideSphereBox.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F0F68 -> 0x801F3AA4
*/
// total size: 0x24
struct xRay3 {
    // Members
...
struct xBoxFace {
    ...
    struct xEdge edges[4]; // offset 0x10, size 0xB0
};
static struct xBoxFace box_faces[6]; // size: 0x480, address: 0x80522998
static struct xEdge * box_edges[6][6]; // size: 0x90, address: 0x80522E18
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522EA8
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522EC1
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522EDA
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522EF3
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F0C
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F25
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F3E
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F57
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F70
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522F89
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522FA2
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522FBB
// total size: 0x18
struct xBox {
    // Members
...
// total size: 0x4
struct /* @class$892xCollideSphereBox_cpp */ {
    // Members
...
union /* @class$1040xCollideSphereBox_cpp */ {
...
// Range: 0x801F0F68 -> 0x801F14F8
int xSweptSphereToBox(struct xSweptSphere & sws /* r31 */, const struct xBox & box /* r30 */) {}
...
// Range: 0x801F14F8 -> 0x801F15E0
static int xSweptSphereToBoxInside(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {
    // Local variables
    struct xVec3 box_center; // r1+0x8
    float box_radius; // f31
}

// Range: 0x801F15E0 -> 0x801F15FC
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F15FC -> 0x801F1618
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F1618 -> 0x801F1634
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F1634 -> 0x801F16E4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F16E4 -> 0x801F17D8
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
    struct xVec3 path_perp; // r1+0xC

    // References
    // -> static char __FUNCTION__[25];
    // -> static struct xEdge * box_edges[6][6];
    // -> static struct xBoxFace box_faces[6];
}

// Range: 0x801F17D8 -> 0x801F18B8
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x801F18B8 -> 0x801F1968
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F1968 -> 0x801F1A5C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F1A5C -> 0x801F1A78
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F1A78 -> 0x801F1B28
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F1B28 -> 0x801F1C1C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F1C1C -> 0x801F1CF8
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x801F1CF8 -> 0x801F1DA8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F1DA8 -> 0x801F1E9C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F1E9C -> 0x801F1EB8
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F1EB8 -> 0x801F1F68
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F1F68 -> 0x801F205C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F205C -> 0x801F213C
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x801F213C -> 0x801F21EC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F21EC -> 0x801F22E0
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F22E0 -> 0x801F2390
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2390 -> 0x801F2484
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F2484 -> 0x801F2534
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2534 -> 0x801F25E4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F25E4 -> 0x801F2694
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2694 -> 0x801F2788
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F2788 -> 0x801F2838
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2838 -> 0x801F28E8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F28E8 -> 0x801F2904
static unsigned char check_moving_away(const struct xVec3 & dir /* r3 */) {}

// Range: 0x801F2904 -> 0x801F29B4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F29B4 -> 0x801F2AA8
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F2AA8 -> 0x801F2B84
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x801F2B84 -> 0x801F2C34
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2C34 -> 0x801F2D28
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F2D28 -> 0x801F2DD8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2DD8 -> 0x801F2ECC
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F2ECC -> 0x801F2F7C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F2F7C -> 0x801F302C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F302C -> 0x801F30DC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F30DC -> 0x801F31D0
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x18
...
// Range: 0x801F31D0 -> 0x801F3280
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}

// Range: 0x801F3280 -> 0x801F3330
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r30 */) {}
...
// Range: 0x801F3330 -> 0x801F3574
int xSweptSphereToOBB(struct xSweptSphere * sws /* r31 */, const struct xBox * box /* r1+0x8 */, const struct xMat4x3 * mat /* r30 */) {
    // Local variables
    struct xVec3 old_start; // r1+0x30
    struct xVec3 old_end; // r1+0x24
    struct xVec3 old_dir; // r1+0x18
    float old_dist; // f30
    float box_scale; // f31
    float old_radius; // f29
    float old_curdist; // f28
    float initial_scaled_curdist; // f27
    int got_collision; // r29
    struct xVec3 collide_point; // r1+0xC
}
...
// Range: 0x801F3574 -> 0x801F3608
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0xC

    // References
    // -> static struct xBoxFace box_faces[6];
}

// Range: 0x801F3608 -> 0x801F369C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0xC
...
// Range: 0x801F3854 -> 0x801F3930
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x801F3930 -> 0x801F39C4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r1+0x8 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0xC
