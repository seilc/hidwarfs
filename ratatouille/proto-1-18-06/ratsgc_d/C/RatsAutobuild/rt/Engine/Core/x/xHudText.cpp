/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xHudText.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80206674 -> 0x80207078
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D645F8
// total size: 0x17C
class text_widget : public widget {
    // Functions
    text_widget(const struct text_asset & a);
...
// Range: 0x80206674 -> 0x80206830
void text_widget::load(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
...
// total size: 0x34
struct {} xhud::text_widget::__vtable; // size: 0x34, address: 0x80523100
// Range: 0x80206830 -> 0x8020687C
// this: r31
text_widget::text_widget(const struct text_asset & a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] xhud::text_widget::__vtable;
}

// total size: 0x8
struct /* @class$1114xHudText_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833xHudText_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834xHudText_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835xHudText_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836xHudText_cpp */ {
    // Members
...
// Range: 0x8020687C -> 0x802068A4
// this: r1+0x8
void text_widget::destruct() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D645FD
// total size: 0x1
struct /* @class$1128xHudText_cpp */ {
    // Members
...
enum /* @enum$1133xHudText_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1134xHudText_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1135xHudText_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// Range: 0x802068A4 -> 0x80206B98
// this: r31
void text_widget::setup() {
    // Local variables
    const struct text_asset & ta; // r30
    struct ztextbox * ztb; // r29
...
// Range: 0x80206B98 -> 0x80206BC0
// this: r1+0x8
void text_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80D6ADC8
static signed char init; // size: 0x1, address: 0x80D6ADCC
// Range: 0x80206BC0 -> 0x80206C00
unsigned int text_widget::type() {
    // References
    // -> static unsigned int myid;
    // -> static signed char init;
}

// Range: 0x80206C00 -> 0x80206C68
// this: r29
unsigned char text_widget::is(unsigned int id /* r30 */) const {}

unsigned int FB_XRES; // size: 0x4, address: 0x80D63014
unsigned int FB_YRES; // size: 0x4, address: 0x80D63018
// Range: 0x80206C68 -> 0x80206D54
// this: r31
void text_widget::update(float dt /* r1+0x8 */) {
    // References
    // -> unsigned int FB_YRES;
    // -> unsigned int FB_XRES;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64603
// Range: 0x80206D54 -> 0x80206FC0
// this: r31
void text_widget::render() {
    // Local variables
    unsigned char bDebug; // r30
    float rc_x0; // f30
    float rc_y0; // f31
    float rc_x2; // f28
    float rc_y2; // f29
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D6460A
// Range: 0x80206FC0 -> 0x80207078
// this: r27
void text_widget::set_text(const char * intext /* r28 */) {
    // Local variables
    unsigned long textchars; // r30
    unsigned long copychars; // r31
