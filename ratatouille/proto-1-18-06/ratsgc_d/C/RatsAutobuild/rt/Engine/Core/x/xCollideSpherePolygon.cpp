/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCollideSpherePolygon.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D5A90 -> 0x801D73C0
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x801D5A90 -> 0x801D5BD8
unsigned char xSweptSphereToPoint(const struct xSweptSphere & sphere /* r31 */, const struct xVec3 & pt /* r1+0x8 */, struct xCollideSphereToPointResults & results /* r30 */) {
    // Local variables
    struct xVec3 to_pt; // r1+0x18
    float along_d0; // f31
    struct xVec3 proj_vec; // r1+0xC
    float dist_from_line_squ; // f30
    float sphere_radius_squ; // f29
    float forward_distance; // f28
    float along_d_impact; // f27
}
...
// Range: 0x801D5BD8 -> 0x801D6124
unsigned char xSweptSphereToLineSement(const struct xSweptSphere & sphere /* r31 */, const struct xVec3 & segment_start /* r28 */, const struct xVec3 & segment_dir /* r29 */, float segment_length /* f23 */, struct xCollideSphereToLineSegmentResults & results /* r30 */) {
    // Local variables
    class xPlane shear; // r1+0x34
    float shear_normal_len2; // f20
    float sphere_height; // f25
    struct xVec3 shear_sphere_center; // r1+0x28
    struct xVec3 segment_start_to_sphere; // r1+0x1C
    float proj_center_along_seg_d0; // f30
    float proj_center_along_seg_de; // f27
    float proj_center_along_seg_vel; // f24
    struct xVec3 segment_out_normal; // r1+0x10
    float proj_center_above_seg_d0; // f31
    float proj_center_above_seg_de; // f26
    float proj_center_above_seg_vel; // f28
    float sphere_intersect_radius; // f29
    float travel_total; // f19
    float travel_percent; // f18
    float impact_along_dist; // f22
    float travel_total; // r1+0xC
    float travel_percent; // r1+0x8
    float impact_along_dist; // f21
}
...
// total size: 0x4
struct /* @class$892xCollideSpherePolygon_cpp */ {
    // Members
...
union /* @class$1040xCollideSpherePolygon_cpp */ {
...
// Range: 0x801D6124 -> 0x801D62D4
unsigned char xSweptSphereToPolygon(const struct xSweptSphere & sphere /* r31 */, const class xPlane & surface /* r29 */, const struct xEdge * edges /* r27 */, int num_edges /* r28 */, struct xCollideSphereToPolygonResults & results /* r30 */) {
    // Local variables
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80522550
// total size: 0x10
...
// Range: 0x801D62D4 -> 0x801D6C58
static unsigned char PolygonTestSphereOnPlane(const class xPlane & surface /* r25 */, const struct xEdge * edges /* r29 */, int num_edges /* r26 */, const struct xSweptSphere & sphere /* r30 */, struct xCollideSphereToPolygonResults & results /* r31 */, float vertical_d0 /* r1+0x8 */) {
    // Local variables
    float above_edge_d0; // f31
    float above_edge_vel; // f30
    float above_edge_de; // f29
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x64
    struct xCollideSphereToPointResults vertex_collide; // r1+0xC
    struct xVec3 sphere_to_vertex; // r1+0x58
    float closest_dist_squ; // f28
    int i; // r28
    struct xVec3 sphere_to_vertex; // r1+0x4C
    float closest_dist_squ; // f27
    struct xVec3 sphere_to_vertex; // r1+0x40
    float closest_dist_squ; // f26
    struct xVec3 sphere_to_vertex; // r1+0x34
    float closest_dist_squ; // f25
    struct xVec3 sphere_to_vertex; // r1+0x28
    float closest_dist_squ; // f24
    int i; // r27
    struct xVec3 sphere_to_vertex; // r1+0x1C
    float closest_dist_squ; // f23
    struct xVec3 sphere_to_vertex; // r1+0x10
    float closest_dist_squ; // f22

    // References
    // -> static char __FUNCTION__[25];
}

// Range: 0x801D6C58 -> 0x801D6EB0
static unsigned char PolygonTestAH0a(int i /* r30 */, float closest_dist_squ /* f30 */, const struct xEdge * edges /* r29 */, int num_edges /* r1+0x8 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r31 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x28
    struct xCollideSphereToPointResults vertex_collide; // r1+0xC
    float above_edge_d0; // f29
    struct xVec3 sphere_to_vert; // r1+0x1C
    float new_dist_squ; // f28
    struct xVec3 sphere_to_vert; // r1+0x10
    float new_dist_squ; // f31
}

// Range: 0x801D6EB0 -> 0x801D6FF0
static unsigned char PolygonTestAH0b(int i /* r30 */, float closest_dist_squ /* f30 */, const struct xEdge * edges /* r29 */, int num_edges /* r1+0x8 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r31 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x1C
    struct xCollideSphereToPointResults vertex_collide; // r1+0xC
    struct xVec3 sphere_to_vert; // r1+0x10
    float new_dist_squ; // f31
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63E78
// Range: 0x801D6FF0 -> 0x801D723C
static unsigned char PolygonTestAH0c(int i /* r30 */, float closest_dist_squ /* f31 */, const class xPlane & surface /* r1+0x8 */, const struct xEdge * edges /* r29 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r31 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x28
    struct xCollideSphereToPointResults vertex_collide; // r1+0xC
    float above_edge_d0; // f28
    struct xVec3 sphere_to_vert; // r1+0x1C
    float new_dist_squ; // f30
    struct xVec3 sphere_to_vert; // r1+0x10
    float new_dist_squ; // f29

    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x801D723C -> 0x801D73C0
static unsigned char PolygonTestBH0a(int i /* r30 */, float closest_dist_squ /* f30 */, const class xPlane & surface /* r1+0x8 */, const struct xEdge * edges /* r29 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r31 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x1C
    struct xCollideSphereToPointResults vertex_collide; // r1+0xC
    float above_edge_d0; // f29
