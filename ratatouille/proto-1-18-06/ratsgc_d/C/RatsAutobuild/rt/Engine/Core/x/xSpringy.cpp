/*
    ...
    Language: C++
    Code range: 0x802872C4 -> 0x80287384
*/
// total size: 0x8
struct substr {
    // Members
...
// total size: 0x1
struct /* @class$788xSpringy_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$789xSpringy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$790xSpringy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$791xSpringy_cpp */ {
    // Members
