/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xNavigationMeshAsset.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800A76EC -> 0x800A876C
*/
char __FUNCTION__$localstatic1$vertex__Q227xNavigationMeshAssetSubMesh8TriangleFi[7]; // size: 0x7, address: 0x80D600C8
char __FUNCTION__$localstatic1$getHeight__20xNavigationMeshAssetCFiiRC5xVec3[10]; // size: 0xA, address: 0x80D600CF
char __FUNCTION__$localstatic1$getHeight__27xNavigationMeshAssetSubMeshCFiff[10]; // size: 0xA, address: 0x80D600D9
char __FUNCTION__$localstatic1$GetNeighbor__27xNavigationMeshAssetSubMeshCFii[12]; // size: 0xC, address: 0x80D600E3
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zMeshCircle * sFreeCirclePool; // size: 0x4, address: 0x80D693A8
// total size: 0x14
class xNavigationMeshAsset : public xBaseAsset {
    ...
    class zMeshCircle * GetNearbyCircles(const struct xVec3 & position, float radius, float speed, struct xEnt * skipEntity, struct xEnt * ourEntity, unsigned int flags);

    class zMeshCircle * FindMeshCircleForEnt(const struct xEnt * ent);

    void AddCircle(class zMeshCircle * circle);

    unsigned char RemoveCircle(class zMeshCircle * circle);

    unsigned char GetTriangle(const struct xVec3 & position, int subMeshGuess, int triGuess, int & subMeshIndex, int & triIndex);

    void CheckSubMeshExits(int & subMeshIndex, int & triangleIndex);
...
// Range: 0x800A76EC -> 0x800A76F8
// this: r3
void xNavigationMeshAsset::Init() {}

// Range: 0x800A76F8 -> 0x800A778C
// this: r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D600EF
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1734xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1969xNavigationMeshAsset_cpp */ {
    // Static members
...
// Range: 0x800A778C -> 0x800A79AC
// this: r28
void xNavigationMeshAsset::RegisterEntity(unsigned int id /* r26 */) {
    // Local variables
    class zMeshCircle * circle; // r29
    struct xEnt * entity; // r31
    struct xCylinder cylinder; // r1+0x8
    class zMeshCircle * newCircle; // r30
...
// total size: 0x4
struct /* @class$965xNavigationMeshAsset_cpp */ {
    // Members
...
union /* @class$711xNavigationMeshAsset_cpp */ {
...
// total size: 0xC
struct /* @class$1121xNavigationMeshAsset_cpp */ {
    // Members
...
// Range: 0x800A79AC -> 0x800A7B70
// this: r25
class zMeshCircle * xNavigationMeshAsset::GetNearbyCircles(const struct xVec3 & position /* r1+0x8 */, float radius /* r1+0xC */, float speed /* r1+0x10 */, struct xEnt * skipEntity /* r1+0x14 */, struct xEnt * ourEntity /* r30 */, unsigned int flags /* r28 */) {
    // Local variables
    class zMeshCircle * nearbyCircles; // r29
    float distanceTolerance; // f31
...
// total size: 0x4
struct /* @class$2158xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2117xNavigationMeshAsset_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2118xNavigationMeshAsset_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2119xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2116xNavigationMeshAsset_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2121xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$906xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$907xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$908xNavigationMeshAsset_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$909xNavigationMeshAsset_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$910xNavigationMeshAsset_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$911xNavigationMeshAsset_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$912xNavigationMeshAsset_cpp */ {
    // Members
...
// Range: 0x800A7B70 -> 0x800A7BB0
// this: r3
class zMeshCircle * xNavigationMeshAsset::FindMeshCircleForEnt(const struct xEnt * ent /* r4 */) {
    // Local variables
    class zMeshCircle * circle; // r31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D600FE
// Range: 0x800A7BB0 -> 0x800A7C5C
// this: r30
void xNavigationMeshAsset::AddCircle(class zMeshCircle * circle /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D60108
// Range: 0x800A7C5C -> 0x800A7DC4
// this: r28
unsigned char xNavigationMeshAsset::RemoveCircle(class zMeshCircle * circle /* r31 */) {
    // Local variables
    class zMeshCircle * currentCircle; // r30
    class zMeshCircle * prevCircle; // r29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D60115
// Range: 0x800A7DC4 -> 0x800A7ECC
void xNavigationMeshAsset::SceneInit() {
    // Local variables
    unsigned int i; // r31

    // References
    // -> static class zMeshCircle * sFreeCirclePool;
    // -> static char __FUNCTION__[10];
    // -> unsigned int gActiveHeap;
}

// Range: 0x800A7ECC -> 0x800A7ED8
void xNavigationMeshAsset::SceneExit() {
    // References
    // -> static class zMeshCircle * sFreeCirclePool;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6011F
// Range: 0x800A7ED8 -> 0x800A7F88
class zMeshCircle * xNavigationMeshAsset::GetFreeCircle() {
    // Local variables
    class zMeshCircle * circle; // r31
...
// Range: 0x800A7F88 -> 0x800A7F98
void xNavigationMeshAsset::ReleaseCircle(class zMeshCircle * circle /* r3 */) {
    // References
    // -> static class zMeshCircle * sFreeCirclePool;
}
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6012D
// total size: 0xC
struct Exit {
    // Members
...
class xNavigationMeshAssetSubMesh {
    // Functions
    int getTriangle(const struct xVec3 & point, int current_triangle) const;

    unsigned char inTriangle(int triangle_index, const struct xVec3 & point) const;

    int lookup_next(int source, int destination) const;
...
// Range: 0x800A7F98 -> 0x800A8244
// this: r30
int xNavigationMeshAssetSubMesh::getTriangle(const struct xVec3 & point /* r31 */, int current_triangle /* r29 */) const {
    // Local variables
    float triangleHeight; // f31
    int i; // r28
    int triangle; // r26
    float triangleHeight; // f30
    int i; // r27
    float triangleHeight; // f29

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x800A8244 -> 0x800A83DC
// this: r3
unsigned char xNavigationMeshAssetSubMesh::inTriangle(int triangle_index /* r4 */, const struct xVec3 & point /* r5 */) const {
    // Local variables
    struct xVec3 * v[3]; // r1+0x8
}

// Range: 0x800A83DC -> 0x800A842C
// this: r3
int xNavigationMeshAssetSubMesh::lookup_next(int source /* r4 */, int destination /* r5 */) const {
    // Local variables
    unsigned int bitIndex; // r31
    unsigned int byteIndex; // r30
    unsigned int bitShift; // r29
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D60139
// Range: 0x800A842C -> 0x800A85E8
// this: r30
unsigned char xNavigationMeshAsset::GetTriangle(const struct xVec3 & position /* r1+0x8 */, int subMeshGuess /* r27 */, int triGuess /* r28 */, int & subMeshIndex /* r31 */, int & triIndex /* r29 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh * sub_mesh; // r25
    int useGuessTriangle; // r24

    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D60145
// Range: 0x800A85E8 -> 0x800A876C
// this: r27
void xNavigationMeshAsset::CheckSubMeshExits(int & subMeshIndex /* r29 */, int & triangleIndex /* r30 */) {
    // Local variables
