/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\gc\iLight.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8010FEE8 -> 0x80110C30
*/
// Range: 0x8010FEE8 -> 0x8010FEEC
void iLightInit() {}

// Range: 0x8010FEEC -> 0x8010FEF0
void iLightDeinit() {}
...
// Range: 0x8010FEF0 -> 0x8011008C
struct iLight * iLightCreate(struct iLight * light /* r31 */, unsigned int type /* r29 */) {
    // Local variables
...
// Range: 0x8011008C -> 0x801100D4
void iLightSetColor(struct iLight * light /* r31 */, const struct _xFColor & col /* r30 */) {}

// Range: 0x801100D4 -> 0x80110108
void iLightGetColor(struct iLight * light /* r1+0x8 */, struct _xFColor & col /* r1+0xC */) {}

// Range: 0x80110108 -> 0x80110194
void iLightSetPos(struct iLight * light /* r28 */, const struct xVec3 & pos /* r30 */) {
    // Local variables
    struct RwFrame * f; // r29
    struct RwMatrixTag * m; // r31
}

// Range: 0x80110194 -> 0x801101C8
void iLightGetPos(struct iLight * light /* r1+0x8 */, struct xVec3 & pos /* r1+0xC */) {}

// Range: 0x801101C8 -> 0x8011021C
void iLightSetRadius(struct iLight * light /* r31 */, float radius /* f31 */) {}

// Range: 0x8011021C -> 0x80110224
struct xSphere * iLightGetBoundingSphere(struct iLight * light /* r3 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D617A8
// Range: 0x80110224 -> 0x80110348
...
static struct RpTie dummyTie; // size: 0x18, address: 0x80C6FBD0
// total size: 0x8
struct RpTriangle {
    // Members
...
static struct RpWorldSector dummyWorldSector; // size: 0x88, address: 0x80C6FBE8
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D617B6
// total size: 0xC
struct xModelPool {
    // Members
...
// Range: 0x80110348 -> 0x80110600
void iLightAddForModel(struct xModelInstance * minst /* r28 */, struct iLight * * lights /* r31 */, int numLights /* r24 */) {
    // Local variables
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80516B60
// Range: 0x80110600 -> 0x80110850
void iLightRemoveFromModel(struct xModelInstance * minst /* r29 */, struct iLight * * lights /* r31 */, int numLights /* r26 */) {
    // Local variables
    int i; // r30
    struct RpAtomic * atomic; // r1+0x8
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D617C8
// Range: 0x80110850 -> 0x80110938
void iLightEnv(struct iLight * light /* r30 */, int env /* r1+0x8 */) {
    // Local variables
...
// Range: 0x80110938 -> 0x80110974
void iLightJSPPreRender(struct xEnv * env /* r1+0x8 */, struct iLight * light /* r31 */) {}

// Range: 0x80110974 -> 0x801109A0
void iLightJSPPostRender(struct xEnv * env /* r1+0x8 */) {}
...
// total size: 0x1
struct /* @class$833iLight_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834iLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835iLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836iLight_cpp */ {
    // Members
...
static struct tweak_callback colorUpdateCallback; // size: 0x28, address: 0x80C6FC70
static struct tweak_callback radiusUpdateCallback; // size: 0x28, address: 0x80C6FC98
static struct tweak_callback positionUpdateCallback; // size: 0x28, address: 0x80C6FCC0
// Range: 0x801109A0 -> 0x801109E0
void OnUpdateColorTweak(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct iLight * light; // r31
}

// Range: 0x801109E0 -> 0x80110A20
void OnUpdateRadiusTweak(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct iLight * light; // r31
}

// Range: 0x80110A20 -> 0x80110A60
void OnUpdatePositionTweak(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct iLight * light; // r31
}

// Range: 0x80110A60 -> 0x80110C30
void iLightAddTweak(struct iLight * light /* r31 */, const char * name /* r30 */) {
    // Local variables
