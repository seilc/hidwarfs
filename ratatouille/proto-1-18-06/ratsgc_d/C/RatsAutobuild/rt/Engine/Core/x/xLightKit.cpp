/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xLightKit.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008F764 -> 0x8009028C
*/
// total size: 0x8
struct RwObject {
    // Members
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D5FD28
// total size: 0x1
...
// Range: 0x8008F764 -> 0x8008FD08
struct xLightKit * xLightKit_Prepare(void * data /* r1+0x8 */) {
    // Local variables
    struct iAsyncLockRWSentry rw_sentry; // r1+0xC
    struct xLightKit * lkit; // r30
    struct xLightKitLight * currlight; // r31
    unsigned int i; // r27
    unsigned int numdir; // r29
    unsigned int numamb; // r28
    float s; // f31
    struct RwFrame * frame; // r26
    struct RwMatrixTag tmpmat; // r1+0x10
...
// Range: 0x8008FD08 -> 0x8008FD2C
void xLightKit_GetBlendInfo(struct xLightKitBlendInfo & lkitInfo /* r3 */, struct xModelInstance * model /* r4 */) {}

// Range: 0x8008FD2C -> 0x8008FDC4
int xLightKit_Compare(struct xLightKitBlendInfo & lkitInfo1 /* r3 */, struct xLightKitBlendInfo & lkitInfo2 /* r4 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D5FD3A
...
// Range: 0x8008FDC4 -> 0x8008FEA0
void xLightKit_Enable(const struct xModelInstance & model /* r31 */, struct RpWorld * world /* r30 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D5FD4B
// total size: 0x10
struct RwRGBAReal {
    // Members
...
// Range: 0x8008FEA0 -> 0x800901DC
void xLightKit_Enable(struct xLightKit * lkit /* r31 */, struct RpWorld * world /* r28 */, struct xLightKit * lkit_blend /* r29 */, float blendPercentage /* f31 */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x800901E4 -> 0x8009028C
void xLightKit_Destroy(struct xLightKit * lkit /* r30 */) {
    // Local variables
    unsigned int i; // r29
    struct xLightKitLight * currLight; // r31
