/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCollideSweptSphere.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801EC050 -> 0x801F0464
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zSweptSphereGlobals {
    // Members
    int hitFound; // offset 0x0, size 0x4
    struct xMat4x3 * modelMat; // offset 0x4, size 0x4
};
static struct zSweptSphereGlobals sSwsGlobal; // size: 0x8, address: 0x80D6AD10
// Range: 0x801EC050 -> 0x801EC0B8
...
// Range: 0x801EC0B8 -> 0x801EC0C4
void xSweptSphereDetectInitialPenetration(struct xSweptSphere & sws /* r3 */) {}
...
// Range: 0x801EC0C4 -> 0x801EC20C
void xSweptSpherePrepare(struct xSweptSphere & sws /* r31 */, const struct xVec3 & start /* r30 */, const struct xVec3 & dir /* r29 */, float dist /* f30 */, float radius /* f31 */, unsigned int filterFlags /* r1+0x8 */) {
    // Local variables
    struct xCapsule tmpC; // r1+0xC
}
...
// Range: 0x801EC20C -> 0x801EC33C
void xSweptSpherePrepare(struct xSweptSphere * sws /* r31 */, const struct xVec3 * start /* r29 */, const struct xVec3 * end /* r30 */, float radius /* f31 */, unsigned int filterFlags /* r1+0x8 */) {
    // Local variables
    struct xCapsule tmpC; // r1+0xC
}

// Range: 0x801EC33C -> 0x801EC370
void xSweptSphereResetCollision(struct xSweptSphere * sws /* r3 */) {}

// Range: 0x801EC370 -> 0x801EC4D8
void xSweptSphereGetResults(struct xSweptSphere * sws /* r31 */) {
    // Local variables
    float tandot; // f31
    struct xVec3 tanplane; // r1+0x14
    struct xVec3 in_plane; // r1+0x8
}
...
// Range: 0x801EC4D8 -> 0x801EC594
static int SweptSphereLeafNodeCB(struct xClumpCollBSPTriangle * triangles /* r30 */, void * data /* r1+0x8 */) {
    // Local variables
    struct xSweptSphere * sws; // r31
    struct xCollideSphereToPolygonResults tri_collide; // r1+0x1C
    class xPlane surface; // r1+0xC

    // References
    // -> static struct zSweptSphereGlobals sSwsGlobal;
}
...
// Range: 0x801EC594 -> 0x801EC664
unsigned char TestSingleEnvTri(struct xSweptSphere * sws /* r27 */, struct xClumpCollBSPTriangle * triangle /* r31 */, struct xCollideSphereToPolygonResults & tri_collide /* r1+0x8 */, class xPlane & surface /* r1+0xC */) {
    // Local variables
    struct xVec3 * p0; // r30
    struct xVec3 * p1; // r29
    struct xVec3 * p2; // r28
    struct xBox tri_box; // r1+0x10
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D64248
...
// total size: 0xC
struct /* @class$1039xCollideSweptSphere_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$892xCollideSweptSphere_cpp */ {
    // Members
...
union /* @class$1040xCollideSweptSphere_cpp */ {
...
// Range: 0x801EC664 -> 0x801ECB24
int xSweptSphereToEnv(struct xSweptSphere * sws /* r31 */, struct xEnv * env /* r30 */) {
    // Local variables
    struct xCollis coll; // r1+0x54
    struct xSphere s; // r1+0x14
    struct RwLine line; // r1+0x3C
    struct RwV3d delta; // r1+0x8
    struct xClumpCollV3dGradient grad; // r1+0x24
    float recip; // f31
    int i; // r29
    float testdist; // f27
    struct xSweptSphere newsws; // r1+0xA8
    float testdist; // f26
...
// Range: 0x801ECE6C -> 0x801ECEE8
static void xSweptSphereFillFromCollision(struct xSweptSphere * sws /* r31 */, const struct xCollis * coll /* r30 */) {}
...
struct xEdge {
    // Members
    struct xCollideLineSegment segment; // offset 0x0, size 0x1C
    class xPlane edge; // offset 0x1C, size 0x10
};
// total size: 0x94
struct xCollideProcessedTri {
    // Members
    class xPlane surface; // offset 0x0, size 0x10
    struct xEdge edges[3]; // offset 0x10, size 0x84
};
int _rpCollisionGeometryDataOffset; // size: 0x4, address: 0x80D6C1CC
// Range: 0x801ECEE8 -> 0x801ED06C
static int SweptSphereModelCB(int numTriangles /* r1+0x8 */, int triOffset /* r17 */, void * data /* r1+0xC */) {
    // Local variables
    struct SweptSphereCollParam * isData; // r30
    struct RpGeometry * geometry; // r27
    struct xSweptSphere * sws; // r31
    struct RwV3d * vertices; // r25
    struct RpTriangle * triangles; // r21
    int triSlot; // r26
    unsigned short * triIndex; // r29
    ...
    struct RwV3d * v1; // r23
    struct RwV3d * v2; // r22
    struct xBox tri_box; // r1+0x24
    struct xCollideSphereToPolygonResults tri_collide; // r1+0x10
...
struct RpCollSectorCapsuleIt {
    ...
    struct RpCollSector dummy; // offset 0x2C, size 0x8
    struct RpCollSectorLineItNodeInfo stack[33]; // offset 0x34, size 0x18C
    struct RpCollSectorLineItNodeInfo * curr; // offset 0x1C0, size 0x4
};
// Range: 0x801ED06C -> 0x801ED0EC
void RpCollTreeForAllCapsuleIntsec(struct RpCollTree * tree /* r1+0x8 */, struct RwLine * line /* r1+0xC */, float radius /* r1+0x10 */, int (* callBack)(int, int, void *) /* r1+0x14 */, void * data /* r1+0x18 */) {
    // Local variables
    struct RpCollSectorCapsuleIt it; // r1+0x20
    unsigned short start; // r1+0x1E
    unsigned short count; // r1+0x1C
}

// Range: 0x801ED0EC -> 0x801ED1A0
void _rpCollSectorCapsuleItFindNextEntriesMacro(struct RpCollSectorCapsuleIt * _it /* r31 */, unsigned short * _start /* r27 */, unsigned short * _count /* r28 */) {
    // Local variables
    struct RpCollSplit * split; // r30
    unsigned int axis; // r29
}

// Range: 0x801ED1A0 -> 0x801ED3B0
void _rpCollCapsuleItStepMacro(struct RpCollSectorCapsuleIt * _it /* r3 */, unsigned int _axis /* r4 */, struct RpCollSector * _left /* r5 */, struct RpCollSector * _right /* r6 */, float _leftHi /* f1 */, float _rightLo /* f2 */) {
    // Local variables
    float del; // f27
    float sta; // f31
    float end; // f30
...
// Range: 0x801ED3B0 -> 0x801ED968
void _rpCollSectorCapsuleItInitMacro(struct RpCollSectorCapsuleIt * _it /* r30 */, struct RpCollTree * _tree /* r29 */, struct RwLine * _line /* r31 */, float _radius /* f31 */) {
    // Local variables
    float pa; // f30
    float pb; // f29
    int result; // r28
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6425A
// total size: 0x4
...
struct SweptSphereCollParam {
    // Members
    struct RpGeometry * geometry; // offset 0x0, size 0x4
    struct xSweptSphere * sws; // offset 0x4, size 0x4
    unsigned char singleSided; // offset 0x8, size 0x1
};
// Range: 0x801ED968 -> 0x801EDEB0
int xSweptSphereToModel(struct xSweptSphere * sws /* r31 */, struct RpAtomic * model /* r20 */, const struct RwMatrixTag * mat /* r30 */, unsigned char singleSided /* r21 */) {
    // Local variables
    struct xVec3 old_start; // r1+0x40
    struct xVec3 old_end; // r1+0x34
    struct xVec3 old_dir; // r1+0x28
    float old_radius; // f29
    struct xBox old_box; // r1+0x78
    float old_dist; // f30
    float model_scale; // f31
    float old_curdist; // f28
    float start_curdist; // f27
    struct RpGeometry * geom; // r29
    struct RpCollisionData * colldata; // r27
    struct RwLine line; // r1+0x60
    float scale; // r1+0x8
    struct SweptSphereCollParam isData; // r1+0x1C
    struct RpTriangle * tri; // r28
    struct RwV3d * vert; // r26
    int i; // r25
    struct xVec3 * p0; // r24
    struct xVec3 * p1; // r23
    struct xVec3 * p2; // r22
    struct xCollideSphereToPolygonResults tri_collide; // r1+0x4C
    class xPlane surface; // r1+0xC
...
// Range: 0x801EDEB0 -> 0x801EE1A4
static unsigned char GrossCullTri(struct xSweptSphere * sws /* r3 */, struct xVec3 * v0 /* r4 */, struct xVec3 * v1 /* r5 */, struct xVec3 * v2 /* r6 */) {
    // Local variables
    float minX; // f31
    float maxX; // f30
    float minY; // f29
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80522940
// Range: 0x801EE1A4 -> 0x801EE714
int xSweptSphereToSphere(struct xSweptSphere & sws /* r31 */, const struct xVec3 & center /* r30 */, float radius /* f23 */) {
    // Local variables
    struct xVec3 center_to_center; // r1+0x20
    float dist_along; // f30
    struct xVec3 along; // r1+0x14
    struct xVec3 out; // r1+0x8
    float out_dist_squ; // f28
    float combined_raidus; // f31
    float combined_radius_squ; // f27
    float stop_dist; // f26
    float dist_to_collide; // f29
    float dist_between; // f24
    float ratio; // f25
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6426E
// total size: 0x24
struct xBBox {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
...
// Range: 0x801EE714 -> 0x801EE800
int xSweptSphereToBound(struct xSweptSphere * sws /* r30 */, const struct xBound * bound /* r31 */) {
    // References
    // -> static char __FUNCTION__[20];
}

static int sSweptSphereEntFound; // size: 0x4, address: 0x80D6AD18
// total size: 0x20
struct xLinkAsset {
    // Members
...
static const struct xEnt * sSweptSphereMover; // size: 0x4, address: 0x80D6AD1C
static unsigned char sSweptSphereCollType; // size: 0x1, address: 0x80D6AD20
static int sSweptSpherePenby; // size: 0x4, address: 0x80D6AD24
static unsigned int sSweptSphereIgnoreMovers; // size: 0x4, address: 0x80D6AD28
static unsigned char sSweptSphereNPCIgnoreGoo; // size: 0x1, address: 0x80D6AD2C
// Range: 0x801EE800 -> 0x801EE99C
static void SweptSphereHitsEntCB(struct xRay3 * ray /* r1+0x8 */, struct xQCData * qcd /* r1+0xC */, struct xEnt * ent /* r31 */, void * data /* r1+0x10 */) {
    // Local variables
    struct xSweptSphere * sws; // r28
    struct xModelInstance * collmod; // r27
    struct xMat4x3 * m1; // r30
    struct xMat4x3 * m2; // r29

    // References
    // -> static int sSweptSphereEntFound;
    // -> static unsigned int sSweptSphereIgnoreMovers;
    // -> static int sSweptSpherePenby;
    // -> static unsigned char sSweptSphereCollType;
    // -> static const struct xEnt * sSweptSphereMover;
}

// Range: 0x801EE99C -> 0x801EEB5C
static void NPCSweptSphereHitsEntCB(struct xRay3 * ray /* r1+0x8 */, struct xQCData * qcd /* r1+0xC */, struct xEnt * ent /* r31 */, void * data /* r1+0x10 */) {
    // Local variables
    struct xSweptSphere * sws; // r28
    int goo; // r27
    ...
    // -> static unsigned char sSweptSphereCollType;
    // -> static const struct xEnt * sSweptSphereMover;
    // -> static unsigned char sSweptSphereNPCIgnoreGoo;
}
...
static int been_here; // size: 0x4, address: 0x80D6AD30
static int been_here; // size: 0x4, address: 0x80D6AD34
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AD38
static signed char init; // size: 0x1, address: 0x80D6AD39
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D64282
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801EEB5C -> 0x801EF190
int xSweptSphereToEnt(struct xSweptSphere * sws /* r30 */, struct xEnt * ent /* r31 */, struct xRay3 * ray /* r28 */) {
    // Local variables
    float testdist; // r1+0x10
    unsigned char react; // r26
    struct xSweptSphere sweptSphere; // r1+0xA4
    unsigned int result; // r27
    float oldrad; // f30
    struct xBox tmpbox; // r1+0x2C
    struct xBox tmpbox; // r1+0x14
    struct xRay3 lr; // r1+0x80
    struct xMat3x3 mn; // r1+0x50
    float ms; // f31
...
// Range: 0x801EF190 -> 0x801EF204
static unsigned char sphereToEntResults(struct xSweptSphere * sws /* r30 */, struct xEnt * ent /* r31 */, unsigned char react /* r1+0x8 */) {}
...
static int been_here; // size: 0x4, address: 0x80D6AD3C
static int been_here; // size: 0x4, address: 0x80D6AD40
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AD44
static signed char init; // size: 0x1, address: 0x80D6AD45
static char __FUNCTION__[21]; // size: 0x15, address: 0x80522955
// Range: 0x801EF204 -> 0x801EF87C
int xNPCSweptSphereToEnt(struct xSweptSphere * sws /* r30 */, struct xEnt * ent /* r31 */, struct xRay3 * ray /* r28 */) {
    // Local variables
    float testdist; // r1+0x10
    int goo; // r25
    unsigned char react; // r26
...
// Range: 0x801EF87C -> 0x801EFA44
int xSweptSphereToScene(struct xSweptSphere * sws /* r31 */, struct xScene * sc /* r30 */, const struct xEnt * mover /* r1+0x8 */, unsigned char collType /* r1+0xC */, int penby /* r1+0x10 */) {
    // Local variables
    int envcollfound; // r28
    struct xRay3 ray; // r1+0x14
    float one_len; // f30
...
// Range: 0x801EFA44 -> 0x801EFC58
int xSweptSphereToNonMoving(struct xSweptSphere * sws /* r31 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r1+0x8 */, unsigned char collType /* r1+0xC */, int penby /* r1+0x10 */) {
    // Local variables
    int envcollfound; // r29
...
// Range: 0x801EFC58 -> 0x801EFDF8
int xSweptSphereToStatDyn(struct xSweptSphere * sws /* r31 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r1+0x8 */, unsigned char collType /* r1+0xC */, int penby /* r1+0x10 */) {
    // Local variables
    struct xRay3 ray; // r1+0x14
    float one_len; // f30
...
// Range: 0x801EFDF8 -> 0x801EFFA4
int xNPCSweptSphereToStatDyn(struct xSweptSphere * sws /* r31 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r1+0x8 */, unsigned char collType /* r1+0xC */, int penby /* r1+0x10 */, unsigned char ignoreGoo /* r1+0x14 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052296A
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1288xCollideSweptSphere_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801EFFA4 -> 0x801F0140
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r30 */, struct xEnt * mover /* r27 */, unsigned char collType /* r1+0x8 */, int penby /* r1+0xC */) {
    // Local variables
    int i; // r31
    struct xSphere * extra_spheres[10]; // r1+0x10
    int numSpheres; // r28
    int j; // r29
...
// total size: 0x890
struct /* @class$1785xCollideSweptSphere_cpp */ {
    // Static members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052297F
// Range: 0x801F0140 -> 0x801F02F0
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r30 */, struct xEnt * mover /* r26 */, struct zPlayer * * player /* r27 */, unsigned char collType /* r1+0x8 */, int penby /* r1+0xC */) {
    // Local variables
    int i; // r31
    struct xSphere * extra_spheres[10]; // r1+0x10
    int numSpheres; // r28
...
// Range: 0x801F02F0 -> 0x801F0464
int xSweptSphereToNPC(struct xSweptSphere * sws /* r31 */, struct xScene * sc /* r1+0x8 */, struct xEnt * mover /* r1+0xC */, unsigned char collType /* r1+0x10 */, int penby /* r1+0x14 */) {
    // Local variables
    struct xRay3 ray; // r1+0x18
    float one_len; // f30
