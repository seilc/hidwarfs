/*
    ...
    Language: C++
    Code range: 0x800D5F00 -> 0x800D92CC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float radius_cull; // size: 0x4, address: 0x80D60C50
static float radius_fade; // size: 0x4, address: 0x80D60C54
static float mag; // size: 0x4, address: 0x80D60C58
static float mag; // size: 0x4, address: 0x80D60C5C
static float freq; // size: 0x4, address: 0x80D60C60
static float mag; // size: 0x4, address: 0x80D60C64
static float freq; // size: 0x4, address: 0x80D60C68
static float freq2; // size: 0x4, address: 0x80D60C6C
static float mag; // size: 0x4, address: 0x80D60C70
static float freq; // size: 0x4, address: 0x80D60C74
static float dthetax; // size: 0x4, address: 0x80D60C78
static float dthetay; // size: 0x4, address: 0x80D60C7C
static float dxcos0; // size: 0x4, address: 0x80D696E0
static float dxsin0; // size: 0x4, address: 0x80D60C80
static float dycos0; // size: 0x4, address: 0x80D60C84
static float dysin0; // size: 0x4, address: 0x80D60C88
static int type; // size: 0x4, address: 0x80D60C8C
static float repeat_every; // size: 0x4, address: 0x80D696E4
static float radius; // size: 0x4, address: 0x80D60C90
static float duration; // size: 0x4, address: 0x80D60C94
static float intensity; // size: 0x4, address: 0x80D60C98
static float freq; // size: 0x4, address: 0x80D60C9C
static float emit_height; // size: 0x4, address: 0x80D60CA0
static float emit_random_offset; // size: 0x4, address: 0x80D696E8
static unsigned char on; // size: 0x1, address: 0x80D696EC
static int type; // size: 0x4, address: 0x80D60CA4
static float radius; // size: 0x4, address: 0x80D60CA8
static float duration; // size: 0x4, address: 0x80D60CAC
static float intensity; // size: 0x4, address: 0x80D60CB0
static float freq; // size: 0x4, address: 0x80D60CB4
static float emit_height; // size: 0x4, address: 0x80D60CB8
static unsigned char enable; // size: 0x1, address: 0x80D60CBC
static unsigned char render_bounds; // size: 0x1, address: 0x80D696ED
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$769xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$771xScreenWarp_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$772xScreenWarp_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$773xScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$774xScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$775xScreenWarp_cpp */ {
    // Members
...
static struct tweak_callback cb_debug_emit; // size: 0x28, address: 0x8048A230
static struct tweak_callback cb_debug_print_warps; // size: 0x28, address: 0x8048A258
static struct tweak_callback cb_heat_dtheta; // size: 0x28, address: 0x8048A280
...
char * common_warp_names[7]; // size: 0x1C, address: 0x80513A60
// Range: 0x800D5F00 -> 0x800D6534
static void add_tweaks(const char * prefix /* r31 */) {
    // References
    // -> static struct tweak_callback cb_debug_print_warps;
    ...
    // -> static int type;
    // -> static struct tweak_callback cb_heat_dtheta;
    // -> static float dthetay;
    // -> static float dthetax;
    // -> static float freq;
    // -> static float mag;
    // -> static float freq2;
    // -> static float freq;
    ...
    // -> static float mag;
    // -> static float mag;
    // -> static float radius_cull;
    // -> struct tweak_callback cb_tweak_force_gt;
    // -> static float radius_fade;
...
static struct xVec2 * uvmap_buffer; // size: 0x4, address: 0x80D696F0
static float uvmap_uoffset; // size: 0x4, address: 0x80D696F4
static float uvmap_voffset; // size: 0x4, address: 0x80D696F8
static float uvmap_uscale; // size: 0x4, address: 0x80D696FC
static float uvmap_vscale; // size: 0x4, address: 0x80D69700
static float uvmap_udelta; // size: 0x4, address: 0x80D69704
static float uvmap_vdelta; // size: 0x4, address: 0x80D69708
static float uvmap_xscale; // size: 0x4, address: 0x80D6970C
static float uvmap_yscale; // size: 0x4, address: 0x80D69710
static float uvmap_xdelta; // size: 0x4, address: 0x80D69714
static float uvmap_ydelta; // size: 0x4, address: 0x80D69718
static unsigned int common_warp_ids[6]; // size: 0x18, address: 0x80B96370
// total size: 0x30
struct warper {
    // Members
...
static struct warper warp_buffer[128]; // size: 0x1800, address: 0x80B96388
static struct warper warp_lists[6]; // size: 0x120, address: 0x80B97B88
static struct warper * warp_stack; // size: 0x4, address: 0x80D6971C
static unsigned char render_this_frame; // size: 0x1, address: 0x80D69720
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D60CBD
// Range: 0x800D6534 -> 0x800D667C
static struct warper * alloc_warp(enum type_enum type /* r29 */) {
    // Local variables
    struct warper * warp; // r31
    struct warper & head; // r30
...
// Range: 0x800D667C -> 0x800D66B0
static void free_warp(struct warper * warp /* r3 */) {
    // References
    // -> static struct warper * warp_stack;
}

// Range: 0x800D66B0 -> 0x800D672C
static void change_warp_type(struct warper * warp /* r3 */, enum type_enum type /* r4 */) {
    // Local variables
    struct warper & head; // r31

    // References
    // -> static struct warper warp_lists[6];
}

// Range: 0x800D672C -> 0x800D679C
static unsigned char warp_exists(struct warper * warp /* r3 */) {
    // Local variables
    struct warper * w; // r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D60CC8
// Range: 0x800D679C -> 0x800D6884
static void set_warp(struct warper & warp /* r31 */, float radius /* r1+0x8 */, float duration /* f31 */, enum type_enum type /* r1+0xC */, float intensity /* r1+0x10 */, float freq /* r1+0x14 */, int flags /* r1+0x18 */) {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x800D6884 -> 0x800D6904
static struct warper * create_warp(float radius /* r1+0x8 */, float duration /* f31 */, enum type_enum type /* r30 */, float intensity /* r1+0xC */, float freq /* r1+0x10 */, int flags /* r1+0x14 */) {
    // Local variables
    struct warper * warp; // r31
}

// Range: 0x800D6904 -> 0x800D69EC
static void reset_uvmap(struct xVec2 * uvmap /* r1+0x8 */) {
    // Local variables
    struct xVec2 * uv; // r31
    float du; // f29
    float dv; // f28
...
void (* common_warp_animate[6])(struct xVec2 *, struct warper &, struct xVec2 &, float, float, float, float); // size: 0x18, address: 0x80513A7C
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x800D69EC -> 0x800D6C7C
static unsigned char animate_uvmap(struct xVec2 * uvmap /* r25 */, struct RwCamera * cam /* r1+0x8 */) {
    // Local variables
    const struct xMat4x3 & view_mat; // r28
    unsigned char need_render; // r29
    int type; // r30
    void (* const animate_cb)(struct xVec2 *, struct warper &, struct xVec2 &, float, float, float, float); // r26
    struct warper * warp; // r31
    struct xVec2 loc; // r1+0xC
    float radius; // f31
    float iz; // f30
    struct xVec3 loc3; // r1+0x14
    float intensity; // f29
    float s; // f28
...
// Range: 0x800D6C7C -> 0x800D6E04
static void debug_print_warps() {
    // Local variables
    int type; // r29
    const char * type_name; // r25
    struct warper * warp; // r31
    const struct xVec2 * loc; // r28
    const struct xVec3 * loc; // r30
...
// Range: 0x800D6E04 -> 0x800D6E24
static void debug_emit() {}

// Range: 0x800D6E24 -> 0x800D6EB4
static void on_change_heat_dtheta() {
    // Local variables
    float dthetax; // f31
    float dthetay; // f30
...
static float debug_emit_time; // size: 0x4, address: 0x80D69724
static struct warper * debug_warp; // size: 0x4, address: 0x80D69728
// Range: 0x800D6EB4 -> 0x800D6FA4
...
// total size: 0x4
struct /* @class$1058xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1196xScreenWarp_cpp */ {
    // Members
...
union /* @class$829xScreenWarp_cpp */ {
...
// total size: 0x10
struct /* @class$842xScreenWarp_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2012xScreenWarp_cpp */ {
    // Static members
...
// Range: 0x800D705C -> 0x800D7098
static void debug_init() {
    // References
    // -> static struct warper * debug_warp;
    // -> static float debug_emit_time;
}

// Range: 0x800D7098 -> 0x800D71B0
...
// Range: 0x800D72B8 -> 0x800D72D8
void scene_exit() {}

// Range: 0x800D72D8 -> 0x800D72F8
void reset() {}
...
// Range: 0x800D74E4 -> 0x800D74E8
void pre_render() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D60CD1
// Range: 0x800D74E8 -> 0x800D7578
...
// Range: 0x800D7578 -> 0x800D75F0
void clear() {
    // Local variables
    struct warper * warp; // r31
    struct warper * end_warp; // r30
...
// Range: 0x800D75F0 -> 0x800D7640
enum type_enum find_type(unsigned int id /* r3 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D60CD8
// Range: 0x800D7640 -> 0x800D7778
struct warper * emit(const struct xVec3 & loc /* r29 */, float radius /* r1+0x8 */, float duration /* r1+0xC */, enum type_enum type /* r30 */, float intensity /* r1+0x10 */, float freq /* r1+0x14 */, int flags /* r1+0x18 */) {
    // Local variables
    struct warper * warp; // r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D60CDD
// Range: 0x800D7778 -> 0x800D79D4
void modify(struct warper * warp /* r31 */, const struct xVec3 & loc /* r29 */, float radius /* r1+0x8 */, float duration /* f31 */, enum type_enum type /* r30 */, float intensity /* r1+0xC */, float freq /* r1+0x10 */, int flags /* r1+0x14 */) {
    // References
    // -> static char __FUNCTION__[7];
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D60CE4
// Range: 0x800D79D4 -> 0x800D7AD0
void remove(struct warper * warp /* r31 */) {
    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x800D7AD0 -> 0x800D7BA4
static void get_uvmap_range(int & istart /* r3 */, int & iend /* r4 */, int & jstart /* r5 */, int & jend /* r6 */, float x /* f1 */, float y /* f2 */, float r /* f3 */) {}

// Range: 0x800D7BA4 -> 0x800D7E90
static void warp_animate_warble(struct xVec2 * uvmap /* r23 */, struct warper & warp /* r24 */, const struct xVec2 & loc /* r30 */, float radius /* r1+0x8 */, float base_intensity /* r1+0xC */, float s /* f27 */) {
    // Local variables
    float randumag; // f26
    float randvmag; // f25
    float random_u; // f31
...
// Range: 0x800D7E90 -> 0x800D8144
static void warp_animate_lens(struct xVec2 * uvmap /* r24 */, const struct xVec2 & loc /* r30 */, float radius /* f21 */, float base_intensity /* r1+0x8 */, float s /* r1+0xC */) {
    // Local variables
    float freq; // f20
    float mag; // f27
    float r2; // f26
...
// Range: 0x800D8144 -> 0x800D8454
static void warp_animate_ripple(struct xVec2 * uvmap /* r23 */, struct warper & warp /* r27 */, const struct xVec2 & loc /* r30 */, float radius /* f19 */, float base_intensity /* r1+0x8 */, float s /* f20 */) {
    // Local variables
    float mag; // f31
    float m; // f18
    float umag; // r1+0x28
...
// Range: 0x800D8454 -> 0x800D87C0
static void warp_animate_shockwave(struct xVec2 * uvmap /* r24 */, const struct xVec2 & loc /* r30 */, float radius /* f25 */, float base_intensity /* r1+0x8 */, float s /* r1+0xC */) {
    // Local variables
    float freq; // r1+0x40
    float freq2; // r1+0x3C
    float mag; // f24
...
// Range: 0x800D87C0 -> 0x800D8B7C
static void warp_animate_heat_shimmer(struct xVec2 * uvmap /* r1+0x8 */, struct warper & warp /* r29 */, const struct xVec2 & loc /* r30 */, float radius /* r1+0xC */, float base_intensity /* r1+0x10 */, float s /* r1+0x14 */) {
    // Local variables
    float mag; // f31
    float start_theta; // r1+0x48
    int istart; // r1+0x44
    int iend; // r1+0x40
    int jstart; // r1+0x3C
    int jend; // r1+0x38
    float dthetax; // r1+0x34
    float dthetay; // r1+0x30
    float dxcos0; // f22
    float dxsin0; // f21
    float dycos0; // f20
    float dysin0; // f19
    ...
    float dx; // r1+0x2C
    float dy; // r1+0x28
    float xstart; // r1+0x24
    float ystart; // r1+0x20
    int xsize; // r27
    int ysize; // r28
    struct xVec2 * uv; // r31
    struct xVec2 * uv_xend; // r26
    int uvstride; // r25
    float x; // f27
    float tempcos; // f24
    float cos0; // f23
...
// Range: 0x800D8B7C -> 0x800D8E08
static void warp_animate_static_lens(struct xVec2 * uvmap /* r24 */, const struct xVec2 & loc /* r30 */, float radius /* f21 */, float base_intensity /* r1+0x8 */) {
    // Local variables
    float freq; // r1+0x1C
    float mag; // f27
    float r2; // f26
...
// Range: 0x800D8E18 -> 0x800D8E1C
static void render_scene_exit() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D60CEB
// total size: 0x20
struct _GXTexObj {
    // Members
...
// Range: 0x800D8E1C -> 0x800D9230
static void render_uvmap() {
    // Local variables
    void * junk_buffer; // r22
    void * frame_buffer_raw; // r27
    void * frame_buffer; // r24
    ...
    int dy; // r21
    int x; // r29
    struct xVec2 * uv0; // r31
    struct xVec2 * uv1; // r30
    int i; // r26
    int y; // r28
    int j; // r25
