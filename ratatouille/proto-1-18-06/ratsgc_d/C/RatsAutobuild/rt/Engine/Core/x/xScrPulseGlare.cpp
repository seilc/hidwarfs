/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xScrPulseGlare.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E6588 -> 0x801E7050
*/
// total size: 0xC
struct config {
    // Members
...
static struct xPulseGlareMgr glare_mgr; // size: 0x3600, address: 0x80D13F28
// Range: 0x801E6588 -> 0x801E65B4
static void init_pulse(struct xPulse & p /* r3 */) {}

// Range: 0x801E65B4 -> 0x801E6628
static void xPulseFn(struct xPulse & p /* r31 */) {}

// Range: 0x801E6628 -> 0x801E66E0
static void init_pulse_glare(struct xPulseGlare & glare /* r31 */) {}

// Range: 0x801E66E0 -> 0x801E67E8
static void update_pulse_glare(struct xPulseGlare & g /* r31 */, float dt /* f31 */) {}
...
static struct RxObjSpace3DVertex sStripVert[4]; // size: 0x90, address: 0x80D17528
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D64100
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x801E67E8 -> 0x801E6EA4
static void render_pulse_glare(const struct xMat4x3 & mat /* r29 */, struct xPulseGlare * g /* r30 */) {
    // Local variables
    struct xVec3 w; // r1+0x74
    struct xVec3 h; // r1+0x68
    struct xVec3 g_pos; // r1+0x5C
    struct xVec3 cam_dir; // r1+0x50
    float dot; // f31
    float noise; // f30
    struct xMat3x3 m; // r1+0x80
...
// Range: 0x801E6EF0 -> 0x801E6F5C
// this: r30
void xPulseGlareMgr::update(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
}
...
// Range: 0x801E6F5C -> 0x801E6FC8
// this: r30
void xPulseGlareMgr::render(const struct xMat4x3 & mat /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

// Range: 0x801E6FC8 -> 0x801E6FF8
void xScrFX_PulseGlaresRender(const struct xMat4x3 & mat /* r1+0x8 */) {
    // References
    // -> static struct xPulseGlareMgr glare_mgr;
}

// Range: 0x801E6FF8 -> 0x801E7028
void xScrFX_PulseGlaresUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static struct xPulseGlareMgr glare_mgr;
}

// Range: 0x801E7028 -> 0x801E7050
