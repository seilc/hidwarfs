/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xEntBoulder.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8005F4CC -> 0x800630E0
*/
char __FUNCTION__$localstatic1$xMovePointGetPoint__FPC10xMovePointUs[19]; // size: 0x13, address: 0x80D5F3C0
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$update__Q24xhud6motiveFRQ24xhud6widgetf[7]; // size: 0x7, address: 0x80D5F3D3
char __FUNCTION__$localstatic1$category__Q24xhud6widgetFv[9]; // size: 0x9, address: 0x80D5F3DA
char __FUNCTION__$localstatic1$reset__Q24zNPC11zNPCBaseIN2Fv[6]; // size: 0x6, address: 0x80D5F3E3
char __FUNCTION__$localstatic1$ShouldEscapeGrab__Q24zNPC10zNPCCommonFv[17]; // size: 0x11, address: 0x80D5F3E9
// total size: 0xC
struct xModelPool {
    // Members
...
union /* @class$1040xEntBoulder_cpp */ {
...
// total size: 0x4
struct /* @class$901xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039xEntBoulder_cpp */ {
    // Members
...
static struct xEntCollis sBoulderCollis; // size: 0x5FC, address: 0x80B5FD18
static char __FUNCTION__[23]; // size: 0x17, address: 0x804F2E88
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8005F4CC -> 0x8005F60C
void xEntBoulder_FitToModel(struct xEntBoulder * ent /* r31 */) {
    // References
    // -> struct xVec3 m_Null;
    // -> static char __FUNCTION__[23];
}

// Range: 0x8005F60C -> 0x8005F740
void xEntBoulder_Render(struct xEnt * ent /* r31 */) {
    // Local variables
    struct xModelInstance * model; // r30
    int shadowResult; // r1+0x8
    struct xVec3 shadVec; // r1+0xC
    float radius; // f31
}

// Range: 0x8005F740 -> 0x8005F770
void xEntBoulder_Init(void * ent /* r1+0x8 */, void * asset /* r1+0xC */) {}

// Range: 0x8005F770 -> 0x8005F7B4
void xEntBoulder_Init(struct xEntBoulder * ent /* r30 */, struct xEntAsset * asset /* r31 */) {}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x804F2E9F
...
// total size: 0x10
struct /* @class$1288xEntBoulder_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8005F7B4 -> 0x8005FA0C
void xEntBoulder_InitNoEntInit(struct xEntBoulder * ent /* r31 */, struct xEntAsset * asset /* r29 */) {
    // Local variables
    struct xEntBoulderAsset * basset; // r30
...
// Range: 0x8005FA0C -> 0x8005FB54
void xEntBoulder_ApplyForces(struct zPlayer * player /* r27 */, struct xEntCollis * collis /* r31 */) {
    // Local variables
    int i; // r30
    struct xVec3 f; // r1+0x10
    struct xEntBoulder * boul; // r29
    struct xEntDrive * drv; // r28
...
// total size: 0x4
struct /* @class$2098xEntBoulder_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2057xEntBoulder_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2058xEntBoulder_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2059xEntBoulder_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2056xEntBoulder_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2061xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844xEntBoulder_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845xEntBoulder_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846xEntBoulder_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847xEntBoulder_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848xEntBoulder_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785xEntBoulder_cpp */ {
    // Static members
...
// Range: 0x8005FB54 -> 0x8005FB98
void xEntBoulder_AddInstantForce(struct xEntBoulder * ent /* r31 */, struct xVec3 * force /* r1+0x8 */) {}

// Range: 0x8005FB98 -> 0x8005FBDC
void xEntBoulder_AddForce(struct xEntBoulder * ent /* r31 */, struct xVec3 * force /* r1+0x8 */) {}

// Range: 0x8005FBDC -> 0x8005FBE0
void xEntBoulder_BUpdate() {}

// Range: 0x8005FBE0 -> 0x8005FC40
void xEntBoulder_RealBUpdate(struct xEnt * ent /* r1+0x8 */, struct xVec3 * pos /* r1+0xC */) {
    // Local variables
    struct xEntBoulder * boul; // r31
    struct xVec3 rotatedLC; // r1+0x10
}
...
// Range: 0x8005FC40 -> 0x80060C7C
void xEntBoulder_Update(struct xEntBoulder * ent /* r31 */, struct xScene * sc /* r22 */, float dt /* f31 */) {
    // Local variables
    int i; // r30
    struct xVec3 rotatedLC; // r1+0xB0
    struct xVec3 oldPos; // r1+0xA4
    struct xVec3 sweptDisp; // r1+0x98
    unsigned char definitelyBounce; // r21
    float sweptDistSqr; // f25
    float penAllowed; // f28
    struct xSweptSphere sws; // r1+0x1D0
    float pen; // f24
    float scaleBack; // f26
    struct xEntBoulder * boulder; // r28
    int numDepens; // r29
    struct xVec3 depen; // r1+0x8C
    float penComp; // f23
    struct xEnt * optr; // r25
    float penComp; // f22
    struct xEnt * xb; // r24
    struct xEntBoulder * boul; // r27
    struct xVec3 force; // r1+0x80
    struct xVec3 toAdd; // r1+0x74
    float v1; // f21
    float v2; // f20
    float forceMag; // f19
    struct xEnt * optr; // r23
    float penComp; // f18
    struct xEnt * xb; // r26
    float hitParams[6]; // r1+0xD4
    class zNPCBaseIN2 * npc; // r18
    float penComp; // r1+0x28
    float hitParams[6]; // r1+0xBC
    struct zPlayer * player; // r1+0x24
    struct xVec3 playerDepen; // r1+0x68
    float penComp; // r1+0x20
    struct xVec3 newVel; // r1+0x5C
    float newMag; // f27
    float oldMag; // f29
    struct xVec3 depenNorm; // r1+0x50
    float depenComp; // f30
    float afterBounce; // r1+0x1C
    struct xVec3 fricComp; // r1+0x44
    struct xMat4x3 baseMatrix; // r1+0x190
    struct xVec3 vForcedRotationAxis; // r1+0x38
    float fMagnitudeAgainstAxis; // r1+0x18
    struct xVec3 newRotVec; // r1+0x2C
    float newAngVel; // r1+0x14
    struct xMat3x3 rotM; // r1+0x160
    float vol; // r1+0x10

    // References
    // -> static struct xEntCollis sBoulderCollis;
    // -> struct xVec3 m_Null;
    // -> struct zGlobals globals;
}
...
// Range: 0x80060C7C -> 0x80060DD8
int xEntBoulder_KilledBySurface(struct xEntBoulder * ent /* r31 */) {
    // Local variables
    struct xCollis * coll; // r30
    struct xCollis * cend; // r27
    struct xSurface * surf; // r28
    struct zSurfaceProps * prop; // r29
}

// Range: 0x80060DD8 -> 0x80060E48
void xEntBoulder_Kill(struct xEntBoulder * ent /* r31 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D5F3FA
// Range: 0x80060E48 -> 0x80060F20
void xEntBoulder_Setup(struct xEntBoulder * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x80060F20 -> 0x80061024
void xEntBoulder_Reset(struct xEntBoulder * ent /* r31 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D5F40C
union FloatAndVoid {
    float f; // offset 0x0, size 0x4
    void * v; // offset 0x0, size 0x4
};
// Range: 0x80061024 -> 0x80061418
void xEntBoulderEventCB(struct xBase * from /* r28 */, struct xBase * to /* r25 */, unsigned int toEvent /* r26 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r27 */) {
    // Local variables
    struct xEntBoulder * s; // r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5F41F
// Range: 0x80061418 -> 0x80061568
static int RecurseLinks(const struct xLinkAsset * link /* r1+0x8 */, int count /* r1+0xC */, struct xEntBoulder * * boulList /* r1+0x10 */) {
    // Local variables
    int i; // r30
    int numInList; // r1+0x14
    const struct xLinkAsset * currLink; // r31
    struct xBase * mychild; // r29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5F42C
// Range: 0x80061568 -> 0x800616B8
static void RecurseChild(struct xBase * child /* r27 */, struct xEntBoulder * * boulList /* r29 */, int & currBoul /* r30 */) {
    // Local variables
    unsigned int i; // r28
    unsigned int cnt; // r25
    struct xGroup * grp; // r26
    struct xBase * grpitem; // r31

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x804F2EB9
// Range: 0x800616B8 -> 0x80061870
void xBoulderGenerator_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x804F2ED0
// total size: 0x48
struct xBoulderGeneratorAsset : public xDynAsset {
    // Members
    unsigned int object; // offset 0x10, size 0x4
    struct xVec3 offset; // offset 0x14, size 0xC
    float offsetRand; // offset 0x20, size 0x4
    struct xVec3 initvel; // offset 0x24, size 0xC
    float velAngleRand; // offset 0x30, size 0x4
    float velMagRand; // offset 0x34, size 0x4
    struct xVec3 rotation; // offset 0x38, size 0xC
    unsigned int flags; // offset 0x44, size 0x4
};
// total size: 0x58
struct xBoulderGenerator : public xBase {
    // Members
    struct xBoulderGeneratorAsset * bgasset; // offset 0x10, size 0x4
    int numBoulders; // offset 0x14, size 0x4
    int nextBoulder; // offset 0x18, size 0x4
    struct xEntBoulder * * boulderList; // offset 0x1C, size 0x4
    int * boulderAges; // offset 0x20, size 0x4
    ...
    struct xVec3 initaxis; // offset 0x34, size 0xC
    struct xVec3 perp1; // offset 0x40, size 0xC
    struct xVec3 perp2; // offset 0x4C, size 0xC
};
// Range: 0x80061870 -> 0x80061AE8
void xBoulderGenerator_Init(struct xBoulderGenerator * bg /* r31 */, struct xBoulderGeneratorAsset * asset /* r30 */) {
    // Local variables
...
// Range: 0x80061AE8 -> 0x80061B50
void xBoulderGenerator_Reset(struct xBoulderGenerator * bg /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80061B50 -> 0x80061BA0
static void BoulderGen_GiveBirth(struct xBoulderGenerator * bg /* r3 */, int indx /* r4 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80061BA0 -> 0x80061D4C
static int GetBoulderForGenerating(struct xBoulderGenerator * bg /* r31 */) {
    // Local variables
    int i; // r30
    int j; // r27
    int oldestCulled; // r29
    int minAge; // r26
    int numList; // r28
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x804F2EE7
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x80061D4C -> 0x80062000
void xBoulderGenerator_Launch(struct xBoulderGenerator * bg /* r30 */, struct xVec3 * pnt /* r28 */, float t /* f31 */) {
    // Local variables
    int i; // r27
    struct xEntBoulder * b; // r31
    struct xEnt * genEnt; // r29
    struct xVec3 worldOffset; // r1+0x8
    float invTime; // f30
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x804F2F00
// Range: 0x80062000 -> 0x800623D4
void xBoulderGenerator_EventCB(struct xBase * to /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r31 */, struct xBase * toParamWidget /* r29 */) {
    // Local variables
    struct xBoulderGenerator * bg; // r30
    struct xVec3 pnt; // r1+0x8
...
// Range: 0x800623D4 -> 0x80062860
void xBoulderGenerator_GenBoulder(struct xBoulderGenerator * bg /* r31 */) {
    // Local variables
    int i; // r28
    struct xEntBoulder * b; // r30
    struct xEnt * genEnt; // r29
    struct xVec3 worldOffset; // r1+0x14
    float p1c; // f31
    float p2c; // f30
    float nf; // f28
    struct xVec3 perpRand; // r1+0x8
    float randAng; // f29
    float sclMag; // f27
...
static int myDebugID; // size: 0x4, address: 0x80D68FE8
static unsigned char showUsage; // size: 0x1, address: 0x80D68FEC
static unsigned char drawWire; // size: 0x1, address: 0x80D5F439
static unsigned char cameraSnap; // size: 0x1, address: 0x80D68FED
static struct xEntBoulder * lastBoulder; // size: 0x4, address: 0x80D68FF0
static struct xEntBoulder * selectedBoulder; // size: 0x4, address: 0x80D68FF4
static struct xVec3 snapPos; // size: 0xC, address: 0x80D68FF8
static struct xVec3 snapRot; // size: 0xC, address: 0x80D69004
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x80062860 -> 0x80063050
void xEntBoulderDebugModeCB() {
    // Local variables
    int i; // r27
    unsigned char selectNext; // r29
    unsigned char selectPrev; // r28
    struct xEntBoulder * boul; // r31
    struct xEntBoulder * prevBoulder; // r26
    struct zScene * zsc; // r30
    struct xVec3 tmp; // r1+0x34
    struct xMat4x3 baseMatrix; // r1+0x40
    struct xVec3 vForcedRotationAxis; // r1+0x28
    struct xVec2 s1; // r1+0x20
    struct xVec2 s2; // r1+0x18

    // References
    // -> struct zGlobals globals;
    // -> static struct xEntBoulder * selectedBoulder;
    // -> static struct xVec3 snapRot;
    // -> static struct xVec3 snapPos;
    // -> static unsigned char cameraSnap;
    // -> static struct xEntBoulder * lastBoulder;
    // -> struct xColor_tag g_WHITE;
    // -> struct xColor_tag g_RED;
    // -> static unsigned char drawWire;
    // -> static unsigned char showUsage;
}
...
// Range: 0x80063050 -> 0x80063058
void xEntBoulder_DebugID(int id /* r3 */) {
    // References
    // -> static int myDebugID;
}

static unsigned char was_tracking; // size: 0x1, address: 0x80D69010
static unsigned char first_time; // size: 0x1, address: 0x80D5F43A
// Range: 0x80063058 -> 0x800630E0
void xEntBoulder_SetSnapCamera() {
    // References
    // -> static unsigned char was_tracking;
