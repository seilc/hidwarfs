/*
    ...
    Language: C++
    Code range: 0x80109E58 -> 0x8010A798
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80109E58 -> 0x80109F04
void iDrawSetFBMSK(unsigned int abgr /* r31 */, unsigned int setMask /* r30 */) {
    // Local variables
...
float PAL_OFFX; // size: 0x4, address: 0x80D61648
float PAL_OFFY; // size: 0x4, address: 0x80D6164C
...
// Range: 0x80109F04 -> 0x8010A0CC
void iDrawSetDisplayOffset(float x /* r1+0x8 */, float y /* r1+0xC */) {
    // Local variables
    float nPosX; // f31
    float nPosY; // f30
...
static struct RxObjSpace3DVertex gLineVerts[10000]; // size: 0x57E40, address: 0x80BAB540
static unsigned short gLineIndicies[40000]; // size: 0x13880, address: 0x80C03380
static struct RxObjSpace3DVertex gShadedVerts[10000]; // size: 0x57E40, address: 0x80C16C00
static unsigned int gNumLineVerts; // size: 0x4, address: 0x80D69A54
static unsigned int gNumLineIndices; // size: 0x4, address: 0x80D69A58
static unsigned int gNumShadedVerts; // size: 0x4, address: 0x80D69A5C
// Range: 0x8010A0CC -> 0x8010A0E8
void iDrawBegin() {
    // References
    // -> static unsigned int gNumShadedVerts;
    // -> static unsigned int gNumLineIndices;
    // -> static unsigned int gNumLineVerts;
}
...
// Range: 0x8010A0E8 -> 0x8010A278
void iQueueLineList(struct xColor_tag & color /* r20 */, struct RwV3d * verts /* r21 */, unsigned int * indices /* r22 */, struct RwMatrixTag * mat /* r23 */, unsigned int numVerts /* r1+0x8 */, unsigned int numIndices /* r1+0xC */) {
    // Local variables
    unsigned int maxi; // r30
    unsigned int i; // r31
    unsigned int qi; // r29

    // References
    // -> static unsigned int gNumLineVerts;
    // -> static struct RxObjSpace3DVertex gLineVerts[10000];
    // -> static unsigned int gNumLineIndices;
    // -> static unsigned short gLineIndicies[40000];
}
...
// Range: 0x8010A278 -> 0x8010A380
void iDrawEnd() {
    // Local variables
    int cullstate; // r1+0xC
    int ztest; // r1+0x8

    // References
    // -> static unsigned int gNumShadedVerts;
    // -> static struct RxObjSpace3DVertex gShadedVerts[10000];
    // -> static unsigned int gNumLineIndices;
    // -> static unsigned short gLineIndicies[40000];
    // -> struct xMat4x3 g_I3;
    // -> static unsigned int gNumLineVerts;
...
// Range: 0x8010A380 -> 0x8010A6AC
void iDrawShadedQuad(struct xColor_tag & color /* r25 */, struct RwMatrixTag * mat /* r23 */, struct xVec3 * v1 /* r29 */, struct xVec3 * v2 /* r30 */, struct xVec3 * v3 /* r26 */, struct xVec3 * v4 /* r28 */, int cullmode /* r22 */) {
    // Local variables
    struct RwCamera * camera; // r21
    struct RxObjSpace3DVertex * v3d; // r31
    unsigned int maxi; // r20
    float eyedot; // f31
    struct xVec3 normal; // r1+0x38
    struct xVec3 eyedelta; // r1+0x2C
    struct xVec3 edge1; // r1+0x20
    struct xVec3 edge2; // r1+0x14
    struct RwFrame * frame; // r19
    struct RwMatrixTag * cammat; // r24
...
static struct GCmemXFB xfb; // size: 0xC, address: 0x80D69A60
static void * xfbDisp; // size: 0x4, address: 0x80D69A6C
static void * xfbCopy; // size: 0x4, address: 0x80D69A70
// Range: 0x8010A6AC -> 0x8010A6D4
void iXFBinit() {
    // References
    // -> static void * xfbCopy;
    // -> static void * xfbDisp;
...
// Range: 0x8010A738 -> 0x8010A798
void * iXFBalloc(unsigned int size /* r3 */) {
    // Local variables
