/*
    ...
    Language: C++
    Code range: 0x8002B2AC -> 0x8002BC58
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char buffer[16]; // size: 0x10, address: 0x80D68C78
// total size: 0x8
struct xBaseAsset {
    // Members
...
// Range: 0x8002B2AC -> 0x8002B318
static char * get_asset_name(struct xCounterAsset * asset /* r30 */) {
    // Local variables
    const char * name; // r31
...
// total size: 0x1
struct /* @class$841xCounter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$842xCounter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$843xCounter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$844xCounter_cpp */ {
    // Members
...
// Range: 0x8002B318 -> 0x8002B3FC
static void on_update_counter_tweak(const struct tweak_info & info /* r28 */) {
    // Local variables
    struct _xCounter & c; // r31
    const char * msg_st; // r30
}
...
static struct tweak_callback cb_update; // size: 0x28, address: 0x804F10D0
static signed char init; // size: 0x1, address: 0x80D68C88
// Range: 0x8002B3FC -> 0x8002B4F0
static void add_tweaks(struct _xCounter & counter /* r31 */) {
    // Local variables
    char prefix[128]; // r1+0x30

    // References
    // -> static struct tweak_callback cb_update;
    // -> static signed char init;
}

// Range: 0x8002B4F0 -> 0x8002B51C
void xCounterInit() {}
...
// Range: 0x8002B51C -> 0x8002B54C
void xCounterInit(void * b /* r1+0x8 */, void * asset /* r1+0xC */) {}

// Range: 0x8002B54C -> 0x8002B5DC
void xCounterInit(struct xBase * b /* r29 */, struct xCounterAsset * asset /* r30 */) {
    // Local variables
    struct _xCounter * t; // r31
}

static int been_here; // size: 0x4, address: 0x80D68C8C
static int been_here; // size: 0x4, address: 0x80D68C90
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5EA40
// Range: 0x8002B5DC -> 0x8002B6E8
void xCounterReset(struct xBase * b /* r1+0x8 */) {
    // Local variables
    struct _xCounter * t; // r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5EA4E
// total size: 0x0
...
// Range: 0x8002B6E8 -> 0x8002B7F8
void xCounterSave(struct _xCounter * ent /* r31 */, struct xSerial * s /* r30 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5EA5B
// Range: 0x8002B7F8 -> 0x8002B908
void xCounterLoad(struct _xCounter * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5EA68
// Range: 0x8002B908 -> 0x8002BC58
void xCounterEventCB(struct xBase * to /* r28 */, unsigned int toEvent /* r29 */, const float * toParam /* r25 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    struct _xCounter * t; // r31
    struct _xCounter * paramCounter; // r27
    unsigned int level; // r26
