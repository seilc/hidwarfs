/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xEnv.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80069E44 -> 0x8006A538
*/
// total size: 0x8
struct RwObject {
    // Members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5F548
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x80069E44 -> 0x8006A008
void xEnvLoadJSPList(struct xEnv * env /* r31 */, int dataType /* r27 */) {
    // Local variables
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D5F558
// Range: 0x8006A008 -> 0x8006A0B0
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D5F562
// Range: 0x8006A0B0 -> 0x8006A1B8
void xEnvFree(struct xEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static unsigned char done; // size: 0x1, address: 0x80D6902D
static signed char init; // size: 0x1, address: 0x80D6902E
static unsigned char done; // size: 0x1, address: 0x80D6902F
static signed char init; // size: 0x1, address: 0x80D69030
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5F56B
// Range: 0x8006A1B8 -> 0x8006A464
void xEnvRender(struct xEnv * env /* r31 */, unsigned char alpha /* r1+0x8 */) {
    // Local variables
    unsigned int jspRenderCount; // r29
    int i; // r30
    char text[128]; // r1+0x9
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804F3040
// Range: 0x8006A464 -> 0x8006A538
