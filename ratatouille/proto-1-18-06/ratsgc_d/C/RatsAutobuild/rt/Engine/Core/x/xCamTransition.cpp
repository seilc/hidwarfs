/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCamTransition.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802722A4 -> 0x80273BD8
*/
char __FUNCTION__$localstatic1$Validate__19xCamTransitionAssetCFv[9]; // size: 0x9, address: 0x80D658C0
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$anHitReactToRunCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[21]; // size: 0x15, address: 0x80524B70
char __FUNCTION__$localstatic1$anHitReactToWalkCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[22]; // size: 0x16, address: 0x80524B85
char __FUNCTION__$localstatic1$anLgHitReactStartCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[23]; // size: 0x17, address: 0x80524B9B
char __FUNCTION__$localstatic1$anSmHitReactStartCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[23]; // size: 0x17, address: 0x80524BB2
char __FUNCTION__$localstatic1$anRunStopCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[15]; // size: 0xF, address: 0x80D658C9
char __FUNCTION__$localstatic1$anRunStartCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[16]; // size: 0x10, address: 0x80D658D8
char __FUNCTION__$localstatic1$anMoveStopCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[16]; // size: 0x10, address: 0x80D658E8
char __FUNCTION__$localstatic1$anMoveStartCheck__24zHumanVehiclePlayerDriveFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80D658F8
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65909
// total size: 0x20
struct xLinkAsset {
    // Members
...
class xCamTransition : public xBase {
    // Functions
    void Init(const struct xCamTransitionAsset & asset);

    void Init(struct zEntTrigger & theVolume);
    ...
    void GetParams(struct xCamTransitionParams & params);

    void Start();

    void Completed(unsigned char sendCompletionEvents);
...
// Range: 0x802722A4 -> 0x80272388
// this: r31
void xCamTransition::Init(const struct xCamTransitionAsset & asset /* r30 */) {
    // References
...
// total size: 0x2C
struct xCamTransitionAsset : public xDynAsset {
    // Members
    unsigned int mVersion; // offset 0x10, size 0x4
    int mType; // offset 0x14, size 0x4
    unsigned int mFlags; // offset 0x18, size 0x4
    unsigned int mDestCameraID; // offset 0x1C, size 0x4
    union { // inferred
        struct { // inferred
            float mTime; // offset 0x20, size 0x4
            float mAccel; // offset 0x24, size 0x4
            float mDecel; // offset 0x28, size 0x4
        };
        struct { // inferred
            unsigned int mSrcCameraID; // offset 0x20, size 0x4
            unsigned int mCurveID; // offset 0x24, size 0x4
            unsigned int mTriggerID; // offset 0x28, size 0x4
        };
    };
};
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6590E
// Range: 0x80272388 -> 0x802724AC
// this: r31
void xCamTransition::Init(struct zEntTrigger & theVolume /* r29 */) {
    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x802724AC -> 0x802724F4
// this: r31
void xCamTransition::Reset() {}

// Range: 0x802724F4 -> 0x80272524
void xCamTransition::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80524BC9
// Range: 0x80272524 -> 0x802725E0
void xCamTransition::AddTriggerTransition(struct zEntTrigger & theVolume /* r30 */) {
    // Local variables
    class xCamTransition * trans; // r31

    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x802725E0 -> 0x802725EC
// this: r3
float xCamTransition::BlendTime() const {}

// Range: 0x802725EC -> 0x80272650
// this: r30
unsigned char xCamTransition::IsCut() {}

// Range: 0x80272650 -> 0x80272694
// this: r3
void xCamTransition::GetParams(struct xCamTransitionParams & params /* r4 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6B260
static signed char init; // size: 0x1, address: 0x80D6B261
static unsigned char already_asserted; // size: 0x1, address: 0x80D6B262
static signed char init; // size: 0x1, address: 0x80D6B263
static unsigned char done; // size: 0x1, address: 0x80D6B264
static signed char init; // size: 0x1, address: 0x80D6B265
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65913
// total size: 0xE0
struct xCamGroup {
    // Members
...
// Range: 0x80272694 -> 0x80272C68
// this: r31
void xCamTransition::Start() {
    // Local variables
    struct xBase * destCamera; // r30
    struct xBase * cameraA; // r29
    struct xBase * cameraB; // r28
    unsigned char forward; // r27
    struct xBase * srcCamera; // r25
    struct xCamTransitionParams params; // r1+0x10
    struct zCamPlayer * followCam; // r26
...
// total size: 0x14
struct /* @class$1942xCamTransition_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$1943xCamTransition_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1944xCamTransition_cpp */ {
    // Members
...
// total size: 0x6C
struct /* @class$1945xCamTransition_cpp */ {
    // Members
    float dist; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1946xCamTransition_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1947xCamTransition_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1949xCamTransition_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1950xCamTransition_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$795xCamTransition_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$796xCamTransition_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$797xCamTransition_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$798xCamTransition_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$799xCamTransition_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$800xCamTransition_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$801xCamTransition_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2076xCamTransition_cpp */ {
    // Static members
...
// total size: 0x10
struct /* @class$859xCamTransition_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1114xCamTransition_cpp */ {
    // Members
...
union /* @class$846xCamTransition_cpp */ {
...
// total size: 0xC
struct /* @class$1270xCamTransition_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1784xCamTransition_cpp */ {
    // Members
...
// Range: 0x80272C68 -> 0x80272D1C
// this: r31
void xCamTransition::Completed(unsigned char sendCompletionEvents /* r1+0x8 */) {
    // Local variables
    float bias; // f31
}
...
class xCamPathBias : public xCamBias {
    ...
    xCamPathBias(struct zEntTrigger * triggerEnt);
    ...
    float GetInitialRawBias();

    void SetDirection(unsigned char forward);
    ...
    float CurveIntersectPlane(const struct xVec3 & planePoint, float & u, float guess);

    void DebugRender();

    // Members
protected:
    class xSpringyF32 mBias; // offset 0x8, size 0x18
    float mLastU; // offset 0x20, size 0x4
    const class xNurbs * mCurve; // offset 0x24, size 0x4
    struct zEntTrigger * mTrigger; // offset 0x28, size 0x4
    struct xVec3 mMappingPlaneNormal; // offset 0x2C, size 0xC
    float mGuessSpanU; // offset 0x38, size 0x4
    struct xVec3 mCurveEnd0; // offset 0x3C, size 0xC
    struct xVec3 mCurveEnd1; // offset 0x48, size 0xC
    int mReversed; // offset 0x54, size 0x4
    int mDirection; // offset 0x58, size 0x4
    unsigned char mIsActive; // offset 0x5C, size 0x1
    float mRenderIncU; // offset 0x60, size 0x4
};
// Range: 0x80272D1C -> 0x80272D48
// this: r1+0x8
float xCamPathBias::RawBias() {}
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80524BDE
// Range: 0x80272D48 -> 0x80272DF8
void zCamTransition_EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[23];
}

unsigned char debugRenderTransitionCurve; // size: 0x1, address: 0x80D6B266
float debugCurveVelocityScale; // size: 0x4, address: 0x80D6591C
unsigned char tweakUsePlaneMapping; // size: 0x1, address: 0x80D65920
float cBiasSpringTension; // size: 0x4, address: 0x80D65924
static unsigned char tweakAdded; // size: 0x1, address: 0x80D6B267
static signed char init; // size: 0x1, address: 0x80D6B268
// total size: 0x20
struct {} xCamPathBias::__vtable; // size: 0x20, address: 0x80524BF8
// Range: 0x80272DF8 -> 0x80272F34
// this: r31
xCamPathBias::xCamPathBias(struct zEntTrigger * triggerEnt /* r1+0x8 */) {
    // References
    // -> float cBiasSpringTension;
    // -> unsigned char tweakUsePlaneMapping;
    // -> float debugCurveVelocityScale;
    // -> unsigned char debugRenderTransitionCurve;
    // -> static unsigned char tweakAdded;
    // -> static signed char init;
    // -> struct [anonymous] xCamPathBias::__vtable;
}
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65928
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8027323C -> 0x802732A0
// this: r31
void xCamPathBias::Start() {}

static int i; // size: 0x4, address: 0x80D6B26C
static signed char init; // size: 0x1, address: 0x80D6B270
// Range: 0x802732A0 -> 0x802733D0
// this: r31
void xCamPathBias::Update(float dt /* r1+0x8 */) {
    // Local variables
    const struct xVec3 & testPt; // r30
...
// Range: 0x802733D0 -> 0x802733E0
// this: r3
void xCamPathBias::Reverse() {}

// Range: 0x802733E0 -> 0x8027341C
// this: r1+0x8
float xCamPathBias::GetInitialRawBias() {
    // Local variables
    float rawBias; // r1+0xC
}

// Range: 0x8027341C -> 0x80273448
// this: r3
void xCamPathBias::SetDirection(unsigned char forward /* r4 */) {}

// Range: 0x80273448 -> 0x802734B4
// this: r31
float xCamPathBias::GetBias() {}

// Range: 0x802734B4 -> 0x802734BC
// this: r3
unsigned char xCamPathBias::IsActive() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65933
// Range: 0x802734BC -> 0x80273578
// this: r31
unsigned char xCamPathBias::DidComplete() {
    // References
...
// Range: 0x80273578 -> 0x802738D8
// this: r31
float xCamPathBias::CurveIntersectPlane(const struct xVec3 & planePoint /* r1+0x8 */, float & u /* r30 */, float guess /* f30 */) {
    // Local variables
    class xPlane plane; // r1+0x3C
    float distLo; // f28
    float distHi; // f27
    struct xVec3 loPt; // r1+0x30
    struct xVec3 hiPt; // r1+0x24
    float loU; // f31
    float hiU; // f29
    struct xVec3 segmentV; // r1+0x18
    float segmentLen2; // f26
    struct xVec3 guessPt; // r1+0xC
    float guessDist; // f25
    float t; // f24
}

struct xVec3 g_Y3; // size: 0xC, address: 0x80D6D1B0
// Range: 0x802738D8 -> 0x80273BD8
// this: r31
void xCamPathBias::DebugRender() {
    ...
    float end; // f30
    float u; // f31
    struct xVec3 p0; // r1+0x50
    struct xVec3 p1; // r1+0x44
    struct xVec3 end0; // r1+0x38
    unsigned char p0OutOfBounds; // r29
    unsigned char p1OutOfBounds; // r28
    struct xVec3 end1; // r1+0x2C
    struct xVec3 toEnd1; // r1+0x20
    struct xVec3 perp; // r1+0x14
    struct xVec3 bead; // r1+0x8
