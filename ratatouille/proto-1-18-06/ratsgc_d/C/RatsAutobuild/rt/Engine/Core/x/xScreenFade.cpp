/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xScreenFade.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F0568 -> 0x801F0F50
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cnt_fadesInProgress; // size: 0x4, address: 0x80D6AD48
// total size: 0x4
struct RwRGBA {
    // Members
...
// total size: 0x28
struct xScreenFade : public xBase {
    // Functions
    void load(struct asset_type & a);
    ...
    struct xColor_tag src; // offset 0x18, size 0x4
    struct xColor_tag current_color; // offset 0x1C, size 0x4
    float time_passed; // offset 0x20, size 0x4
    struct xBase * owner; // offset 0x24, size 0x4
};
// Range: 0x801F0568 -> 0x801F065C
// this: r31
void xScreenFade::load(struct asset_type & a /* r30 */) {
    // References
    // -> struct xColor_tag g_CLEAR;
}

// Range: 0x801F065C -> 0x801F06D8
unsigned char xScreenFade::InterpCol(float t /* f1 */, unsigned char s /* r4 */, unsigned char d /* r5 */) {
    // Local variables
    unsigned char uval; // r31
    float val; // f31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D64298
// Range: 0x801F06D8 -> 0x801F077C
// this: r31
void xScreenFade::StartFade() {
    // References
    // -> static int cnt_fadesInProgress;
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D642A2
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$931xScreenFade_cpp */ {
    // Members
...
union /* @class$1070xScreenFade_cpp */ {
...
// total size: 0xC
struct /* @class$1069xScreenFade_cpp */ {
    // Members
...
// Range: 0x801F077C -> 0x801F0AD0
// this: r31
void xScreenFade::update(float seconds /* r1+0x8 */) {
    // Local variables
    float percent; // f31
    float percent; // f30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D642A9
// Range: 0x801F0B90 -> 0x801F0D3C
void xScreenFade::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
struct asset_type : public xDynAsset {
    // Members
    struct xColor_tag dest; // offset 0x10, size 0x4
    float fadeDownTime; // offset 0x14, size 0x4
    float waitTime; // offset 0x18, size 0x4
    float fadeUpTime; // offset 0x1C, size 0x4
};
// Range: 0x801F0D3C -> 0x801F0DA8
void xScreenFade::update_all(float dt /* r1+0x8 */) {
    // Local variables
    struct zScene & scene; // r30
    struct xScreenFade * it; // r31
    struct xScreenFade * end; // r29

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x801F0DA8 -> 0x801F0E0C
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D642AE
// Range: 0x801F0E0C -> 0x801F0F50
void xScreenFade::cb_dispatch(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int event /* r1+0xC */) {
    // Local variables
    struct xScreenFade & e; // r31
