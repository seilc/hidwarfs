/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xTRC.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800FEE40 -> 0x8010121C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80D6D8D8
static struct _tagTRCPadInfo gTrcPad[4]; // size: 0x40, address: 0x80BA90E8
// total size: 0x8
...
static struct _tagTRCDiskInfo gTrcDisk; // size: 0x8, address: 0x80D699F0
static const char * k_CONTROLLER_MISSING_MESSAGE; // size: 0x4, address: 0x80D699F8
static const char * k_CONTROLLER_INVALID_MESSAGE; // size: 0x4, address: 0x80D699FC
enum _tagTRCState {
    TRC_Unknown = 0,
    TRC_PadMissing = 1,
    TRC_PadInserted = 2,
...
// Range: 0x800FEE40 -> 0x800FEE48
unsigned char xTRCMemCardCheck() {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80516450
// Range: 0x800FEE48 -> 0x800FEF34
struct _tagTRCPadInfo & xTRCPadGetNextAvailablePad() {
    // Local variables
    int i; // r31

    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[27];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D613B8
// Range: 0x800FEF34 -> 0x800FEFE4
int xTRCPadGetArrayIdx(int port /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// Range: 0x800FEFE4 -> 0x800FF16C
void xTRCPadRemove(int port /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// total size: 0x10
struct _tagTRCPadInfo : public _tagiTRCPadInfo {
    // Members
    int id; // offset 0x4, size 0x4
    enum _tagTRCState state; // offset 0x8, size 0x4
    enum _tagTRCPadState padstate; // offset 0xC, size 0x4
};
// Range: 0x800FF16C -> 0x800FF1C0
static void xTRCSwapPads(struct _tagTRCPadInfo & pad0 /* r3 */, struct _tagTRCPadInfo & pad1 /* r4 */) {
    // Local variables
    struct _tagTRCPadInfo temppad; // r1+0x8
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D613CB
// total size: 0x2
...
// Range: 0x800FF1C0 -> 0x800FF2BC
void xTRCPadRestoreAll() {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D613DD
// Range: 0x800FF2BC -> 0x800FF360
void xTRCPadSetState(int idx /* r31 */, enum _tagTRCState state /* r1+0x8 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[16];
}

// Range: 0x800FF360 -> 0x800FF3C0
int xTRCPadCount(enum _tagTRCState state /* r1+0x8 */) {
    // Local variables
    int counter; // r31
    int startidx; // r1+0xC
}

enum _tagTRCPadState {
    TRC_PadStateUnknown = 0,
    TRC_PadStatePresent = 1,
    TRC_PadStateMissingDuringGameplay = 2,
    TRC_PadStateMissingDuringCutscene = 3,
    TRC_PadStateMissingDuringMainMenu = 4,
    TRC_PadStateMissingDuringMovie = 5,
    TRC_PadStateMissingDuringLoadSave = 6,
};
// Range: 0x800FF3C0 -> 0x800FF420
int xTRCPadCount(enum _tagTRCPadState padstate /* r1+0x8 */) {
    // Local variables
    int counter; // r31
    int startidx; // r1+0xC
}

// Range: 0x800FF420 -> 0x800FF4D0
int xTRCPadCountWereActiveTotal() {
    // Local variables
    int activecount; // r31
    int missingcount; // r30
    int padstatecount; // r29
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x8051646B
// Range: 0x800FF4D0 -> 0x800FF5B0
void xTRCPadSetStatePadPort(int port /* r30 */, enum _tagTRCState state /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80516482
// Range: 0x800FF5B0 -> 0x800FF690
void xTRCPadSetPadStatePort(int port /* r30 */, enum _tagTRCPadState state /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D613ED
// Range: 0x800FF690 -> 0x800FF7F4
unsigned char xTRCPadFindFirst(int & idx /* r31 */, enum _tagTRCState state /* r1+0x8 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80516499
// Range: 0x800FF7F4 -> 0x800FF960
unsigned char xTRCPadFindFirstPadState(int & idx /* r31 */, enum _tagTRCPadState state /* r1+0x8 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D613FE
// Range: 0x800FF960 -> 0x800FFA24
unsigned char xTRCPadIsIdx(int idx /* r30 */, enum _tagTRCState state /* r1+0x8 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D6140B
// Range: 0x800FFA24 -> 0x800FFAC0
int xTRCPadGetPadPort(int idx /* r31 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6141D
// Range: 0x800FFAC0 -> 0x800FFB5C
enum _tagTRCState xTRCPadGetStateIdx(int idx /* r31 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D61430
// Range: 0x800FFB5C -> 0x800FFC38
enum _tagTRCState xTRCPadGetStatePort(int port /* r30 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x805164B2
// Range: 0x800FFC38 -> 0x800FFD18
enum _tagTRCPadState xTRCPadGetPadStatePort(int port /* r30 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x805164C9
// Range: 0x800FFD18 -> 0x800FFDB8
enum _tagTRCPadState xTRCPadGetPadStateIdx(int idx /* r31 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[22];
}

// Range: 0x800FFDB8 -> 0x800FFE3C
unsigned char xTRCPadIsPort(int port /* r3 */, enum _tagTRCState state /* r4 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D61444
// Range: 0x800FFE3C -> 0x800FFF54
unsigned char xTRCPadGetPadPort(int & idx /* r31 */, enum _tagTRCState state /* r1+0x8 */) {
    // Local variables
    int i; // r30
...
// Range: 0x800FFF54 -> 0x800FFFDC
unsigned char xTRCPadPortWasActive(int port /* r29 */) {}

// Range: 0x800FFFDC -> 0x80100038
static unsigned char xTRCIsNextState(int i /* r3 */, unsigned int state /* r4 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80100038 -> 0x80100094
static unsigned char xTRCIsNextPadState(int i /* r3 */, unsigned int state /* r4 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80100094 -> 0x80100150
static unsigned char xTRCBabbleSort(unsigned char (* funcShake)(int, unsigned int) /* r1+0x8 */, unsigned int state /* r1+0xC */) {
    // Local variables
    unsigned char babble; // r30
    int counter; // r29
    int i; // r31
...
// Range: 0x801001B4 -> 0x80100218
int xTRCPadGetPort_Player1() {
    // Local variables
    class zPad * pad; // r31
...
// Range: 0x80100218 -> 0x8010027C
int xTRCPadGetPort_Player2() {
    // Local variables
    class zPad * pad; // r31
...
// Range: 0x8010027C -> 0x8010064C
void xTRCUpdate(int i /* r31 */) {
    // Local variables
    int padPortP1; // r29
    int padPortP2; // r28
    int startidx; // r1+0x8
...
// Range: 0x8010064C -> 0x801006D4
void xTRCPadInsert(int i /* r31 */) {
    // Local variables
    struct _tagTRCPadInfo & trcpad; // r30
}

// Range: 0x801006D4 -> 0x80100778
void xTRCInit() {
    // Local variables
    int i; // r31

    // References
    // -> static struct _tagTRCDiskInfo gTrcDisk;
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80100778 -> 0x801007C4
void xTRCInitMessages() {
    // References
    // -> static const char * k_CONTROLLER_INVALID_MESSAGE;
    // -> static const char * k_CONTROLLER_MISSING_MESSAGE;
}
...
// Range: 0x80100838 -> 0x80100A48
static void render_message(const char * s /* r1+0x8 */) {
    // Local variables
    struct xColor_tag yellow; // r1+0x1C
    class xtextbox tb; // r1+0xC4
    struct xColor_tag c; // r1+0x18
...
unsigned int lastSetFBMSK; // size: 0x4, address: 0x80D69A50
// total size: 0x388
struct jot_block {
    // Members
...
static char composed_message_text[256]; // size: 0x100, address: 0x80BA9128
static const char * message_text; // size: 0x4, address: 0x80D69A00
// Range: 0x80100A48 -> 0x80100A60
void xTRCClearPadMsg() {
    // References
    // -> static char composed_message_text[256];
    // -> static const char * message_text;
}

// Range: 0x80100A60 -> 0x80100AC4
void xTRCRender() {
    // References
    // -> static const char * message_text;
    // -> static char composed_message_text[256];
...
// Range: 0x80100AC4 -> 0x80100AE4
void xTRCReset() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D61456
// Range: 0x80100AE4 -> 0x80100C1C
void xTRCPadSetPressed(int port /* r30 */, int value /* r31 */, unsigned char reverse /* r1+0x8 */) {
    // References
    // -> struct _tagxPad mPad[4];
    // -> static char __FUNCTION__[18];
}

// Range: 0x80100C1C -> 0x80100DD4
static int DisplayMessage(int port /* r1+0x8 */, enum _tagTRCState state /* r1+0xC */) {
    // Local variables
    int display; // r29
    unsigned int len_message_text; // r30
    const char * msg; // r28
    char c; // r27
    unsigned int sub_len; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051651C
// Range: 0x80100DD4 -> 0x80100ED8
void xTRCPadDisplayMessage(int pad_id /* r31 */) {
    // Local variables
    int display_message; // r30
...
// Range: 0x80100ED8 -> 0x80100F04
void xTRCDisk(enum _tagTRCState state /* r3 */) {
    // References
    // -> static struct _tagTRCDiskInfo gTrcDisk;
}
...
// Range: 0x80100F04 -> 0x80100FCC
void render_mem_card_no_space(int needed /* r28 */, int available /* r31 */, int neededFiles /* r29 */, unsigned char enabled /* r1+0x8 */) {
    // Local variables
    const char * error_text; // r30
...
static class xtextbox tb; // size: 0x74, address: 0x80516534
static signed char init; // size: 0x1, address: 0x80D69A04
// Range: 0x80100FCC -> 0x8010121C
void RenderText(const char * text /* r1+0x8 */, unsigned char enabled /* r27 */) {
    // Local variables
    struct xColor_tag c1; // r1+0x1C
    struct xColor_tag c2; // r1+0x18
