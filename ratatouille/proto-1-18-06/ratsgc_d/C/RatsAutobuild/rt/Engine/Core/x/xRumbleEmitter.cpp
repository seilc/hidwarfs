/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xRumbleEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800C9CD8 -> 0x800CAF80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D608A8
// total size: 0x2
...
// Range: 0x800C9CD8 -> 0x800C9F0C
static void emitter_EventCB(struct xBase * to /* r26 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r31 */) {
    // Local variables
    struct emitterBase * pEffect; // r28
    int startidx; // r1+0x10
    int padPort; // r30
    struct emitterBase * pEffect; // r27
    int startidx; // r1+0xC
    int padPort; // r29
...
struct effectAsset : public xDynAsset {
    ...
    float GetIntensity(float currentTime, float totalTime) const;
...
// Range: 0x800C9F0C -> 0x800CA0E0
// this: r30
void effectAsset::AddTweaks(const char * prefix /* r31 */) {}
...
// total size: 0xC
struct /* @class$842xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845xRumbleEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846xRumbleEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847xRumbleEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848xRumbleEmitter_cpp */ {
    // Members
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D608B8
// Range: 0x800CA0E0 -> 0x800CA334
// this: r31
float effectAsset::GetIntensity(float currentTime /* f31 */, float totalTime /* f30 */) const {
    // Local variables
    float pulsePeriod; // f29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D608C5
// total size: 0x18
struct effect : public emitterBase {
    // Functions
    effect(struct effectAsset * pAsset);

    void AddTweaks();
};
// Range: 0x800CA334 -> 0x800CA4FC
void effect::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// total size: 0x10
struct {} xRumble::effect::__vtable; // size: 0x10, address: 0x80D6091C
// Range: 0x800CA4FC -> 0x800CA578
// this: r31
effect::effect(struct effectAsset * pAsset /* r30 */) {
    // References
    // -> struct [anonymous] xRumble::effect::__vtable;
}
...
// total size: 0x4
struct /* @class$901xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039xRumbleEmitter_cpp */ {
    // Members
...
union /* @class$1040xRumbleEmitter_cpp */ {
...
// total size: 0x10
struct /* @class$1640xRumbleEmitter_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D608CA
// total size: 0x30
struct boxEmitterAsset : public xDynAsset {
    // Members
    unsigned int effectID; // offset 0x10, size 0x4
    struct xVec3 minCorner; // offset 0x14, size 0xC
    struct xVec3 maxCorner; // offset 0x20, size 0xC
    unsigned char onlyOnFloor; // offset 0x2C, size 0x1
};
// total size: 0x1C
struct boxEmitter : public emitterBase {
    // Functions
    boxEmitter(struct boxEmitterAsset * pAsset);

    unsigned char GetIntensity(const struct xVec3 & playerPos, float & intensity) const;

    // Members
    struct boxEmitterAsset * pAsset; // offset 0x18, size 0x4
};
// Range: 0x800CA5E4 -> 0x800CA7AC
void boxEmitter::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
// total size: 0x10
struct {} xRumble::boxEmitter::__vtable; // size: 0x10, address: 0x80D608FC
// Range: 0x800CA7AC -> 0x800CA830
// this: r31
boxEmitter::boxEmitter(struct boxEmitterAsset * pAsset /* r30 */) {
    // Local variables
    unsigned int size; // r1+0x8

    // References
    // -> struct [anonymous] xRumble::boxEmitter::__vtable;
}

// Range: 0x800CA830 -> 0x800CA934
// this: r31
unsigned char boxEmitter::GetIntensity(const struct xVec3 & playerPos /* r1+0x8 */, float & intensity /* r30 */) const {
    // Local variables
    int charIndex; // r29
...
// Range: 0x800CA934 -> 0x800CAA0C
unsigned char inBox(const struct xVec3 & v /* r3 */, const struct xVec3 & min /* r4 */, const struct xVec3 & max /* r5 */) {}
...
// total size: 0x890
struct /* @class$1883xRumbleEmitter_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D608CF
// total size: 0x28
...
struct sphericalEmitter : public emitterBase {
    // Functions
    sphericalEmitter(struct sphericalEmitterAsset * pAsset);

    unsigned char GetIntensity(const struct xVec3 & playerPos, float & intensity) const;

    void UpdatePosition(const struct xVec3 & playerPos) const;

    // Members
    struct sphericalEmitterAsset * pAsset; // offset 0x18, size 0x4
    float radiusSqrd; // offset 0x1C, size 0x4
};
// Range: 0x800CAA0C -> 0x800CABD4
void sphericalEmitter::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D608D4
// total size: 0x14
struct {} xRumble::sphericalEmitter::__vtable; // size: 0x14, address: 0x80D608E8
// Range: 0x800CABD4 -> 0x800CACC0
// this: r31
sphericalEmitter::sphericalEmitter(struct sphericalEmitterAsset * pAsset /* r30 */) {
    // Local variables
    unsigned int size; // r1+0x8

    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] xRumble::sphericalEmitter::__vtable;
}

// Range: 0x800CACC0 -> 0x800CAE6C
// this: r31
unsigned char sphericalEmitter::GetIntensity(const struct xVec3 & playerPos /* r28 */, float & intensity /* r30 */) const {
    // Local variables
    float distSqrd; // f31
    int charIndex; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D608D9
// Range: 0x800CAE6C -> 0x800CAF08
// this: r31
void sphericalEmitter::UpdatePosition(const struct xVec3 & playerPos /* r1+0x8 */) const {
    // References
    // -> static char __FUNCTION__[15];
}

// total size: 0x48
struct FreezableObjectEffect : public emitterBase {
    // Members
    struct sphericalEmitterAsset mModifiableAsset; // offset 0x18, size 0x28
    struct sphericalEmitterAsset * mDefaultSphericalEmitterAsset; // offset 0x40, size 0x4
    float mRadiusSqrd; // offset 0x44, size 0x4
};
// total size: 0x18
...
// total size: 0x10
struct {} xRumble::emitterBase::__vtable; // size: 0x10, address: 0x80D6090C
