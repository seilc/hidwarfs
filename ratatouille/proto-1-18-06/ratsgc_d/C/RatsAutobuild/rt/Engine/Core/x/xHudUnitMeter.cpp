/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xHudUnitMeter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008848C -> 0x80089218
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float tweak_anim_time_delta; // size: 0x4, address: 0x80D5FC00
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D5FC04
// total size: 0x18C
class unit_meter_widget : public meter_widget {
    // Functions
    unit_meter_widget(const struct unit_meter_asset & a);
    ...
    // Members
public:
    struct unit_meter_asset res; // offset 0xC4, size 0x94
    struct xModelInstance * model[6][2]; // offset 0x158, size 0x30
    float anim_time; // offset 0x188, size 0x4
};
// total size: 0x19C
struct widget_chunk : public xBase {
    // Members
    class unit_meter_widget w; // offset 0x10, size 0x18C
};
// Range: 0x8008848C -> 0x80088648
void unit_meter_widget::load(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
...
struct model_info {
    ...
    struct xVec3 size; // offset 0x10, size 0xC
};
// total size: 0x94
struct unit_meter_asset : public meter_asset {
    // Members
    struct model_info model[2]; // offset 0x4C, size 0x38
    struct xVec3 offset; // offset 0x84, size 0xC
    unsigned int fill_forward; // offset 0x90, size 0x4
};
static unsigned char registered; // size: 0x1, address: 0x80D69250
static signed char init; // size: 0x1, address: 0x80D69251
// total size: 0x30
struct {} xhud::unit_meter_widget::__vtable; // size: 0x30, address: 0x804F55D0
// Range: 0x80088648 -> 0x80088800
// this: r31
unit_meter_widget::unit_meter_widget(const struct unit_meter_asset & a /* r30 */) {
    // Local variables
    int i; // r29
    int j; // r28

    // References
    // -> static float tweak_anim_time_delta;
    // -> static unsigned char registered;
    // -> static signed char init;
    // -> struct [anonymous] xhud::unit_meter_widget::__vtable;
}

// total size: 0x10
struct /* @class$1074xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$889xHudUnitMeter_cpp */ {
    // Members
...
union /* @class$601xHudUnitMeter_cpp */ {
...
// total size: 0xC
struct /* @class$1151xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1114xHudUnitMeter_cpp */ {
    // Members
...
enum /* @enum$1115xHudUnitMeter_cpp */ {
    ACT_NONE = 0,
    ACT_SHOW = 1,
    ACT_HIDE = 2,
    MAX_ACT = 3,
...
// total size: 0xC
struct /* @class$830xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833xHudUnitMeter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834xHudUnitMeter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835xHudUnitMeter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836xHudUnitMeter_cpp */ {
    // Members
...
// Range: 0x80088800 -> 0x80088828
// this: r1+0x8
void unit_meter_widget::destruct() {}

// Range: 0x80088828 -> 0x80088850
// this: r1+0x8
void unit_meter_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80D69254
static signed char init; // size: 0x1, address: 0x80D69258
// Range: 0x80088850 -> 0x80088890
unsigned int unit_meter_widget::type() {
    // References
    // -> static unsigned int myid;
    // -> static signed char init;
}

// Range: 0x80088890 -> 0x800888F8
// this: r29
unsigned char unit_meter_widget::is(unsigned int id /* r30 */) const {}
...
static struct tweak_callback tweakOffsetX; // size: 0x28, address: 0x8047E9E8
static struct tweak_callback tweakOffsetY; // size: 0x28, address: 0x8047EA10
unsigned int FB_XRES; // size: 0x4, address: 0x80D63014
unsigned int FB_YRES; // size: 0x4, address: 0x80D63018
// Range: 0x800888F8 -> 0x80088CA8
// this: r30
void unit_meter_widget::setup() {
    // Local variables
    char name[128]; // r1+0x410
    char * prefix; // r29
    char _buffer[128]; // r1+0x390
    char _buffer[128]; // r1+0x310
    char tempString[128]; // r1+0x290
    int i; // r31
    char * modelName[2]; // r1+0x8
    ...
    // References
    // -> static struct tweak_callback tweakOffsetY;
    // -> unsigned int FB_YRES;
    // -> static struct tweak_callback tweakOffsetX;
    // -> unsigned int FB_XRES;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D5FC09
// Range: 0x80088CA8 -> 0x80088F00
// this: r31
void unit_meter_widget::update(float dt /* f28 */) {
    // Local variables
    int units; // r28
    float mod_duration; // f29
    int i; // r29
    int which; // r27
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D5FC10
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80088F00 -> 0x80089218
// this: r31
void unit_meter_widget::render() {
    // Local variables
    struct render_context unitrc; // r1+0x8
    int units; // r28
    int i; // r30
    int which; // r29
