/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\gc\iSnd.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80126B0C -> 0x8012AFD0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static void * sSndStaticBuffer; // size: 0x4, address: 0x80D69D48
// total size: 0x0
struct FSOUND_STREAM {};
// total size: 0x10
struct ExternalStreamInfo {
    // Members
    struct FSOUND_STREAM * stream; // offset 0x0, size 0x4
    int bytesToConsume; // offset 0x4, size 0x4
    int frontBuffer; // offset 0x8, size 0x4
    void * pData; // offset 0xC, size 0x4
};
struct ExternalStreamInfo externStreamInfo[2]; // size: 0x20, address: 0x80CBD540
// total size: 0x0
...
struct FSOUND_GCADPCM_HDR {
    ...
    unsigned short pred_scale; // offset 0x3E, size 0x2
    unsigned short yn1; // offset 0x40, size 0x2
    unsigned short yn2; // offset 0x42, size 0x2
    unsigned short loop_pred_scale; // offset 0x44, size 0x2
    unsigned short loop_yn1; // offset 0x46, size 0x2
    unsigned short loop_yn2; // offset 0x48, size 0x2
    unsigned short pad[11]; // offset 0x4A, size 0x16
};
// total size: 0x64
struct sDSPADPCM : public FSOUND_GCADPCM_HDR {
    // Members
    unsigned int uAssetID; // offset 0x60, size 0x4
};
// total size: 0x20
struct gcSoundInfoAsset {
    // Members
    unsigned int uSoundInfoID; // offset 0x0, size 0x4
    union { // inferred
        unsigned int uSumFSBSize; // offset 0x4, size 0x4
        int nOffsetFinalFSBEnd; // offset 0x4, size 0x4
    };
    struct FMUSIC_MODULE * pFMusicMod; // offset 0x8, size 0x4
    int * pFSBFileArray; // offset 0xC, size 0x4
    struct gcWavInfo * pWavInfoArray; // offset 0x10, size 0x4
    struct sDSPADPCM * pCutsceneAudioHeaders; // offset 0x14, size 0x4
    unsigned short nWavFiles; // offset 0x18, size 0x2
    unsigned short nSounds; // offset 0x1A, size 0x2
    unsigned short nStreams; // offset 0x1C, size 0x2
    unsigned char nFSBFiles; // offset 0x1E, size 0x1
    unsigned char nCutsceneAudioHeaders; // offset 0x1F, size 0x1
};
struct gcSoundInfoAsset sinfoArray[12]; // size: 0x180, address: 0x80CBD560
unsigned int sinfoArrayLoaded; // size: 0x4, address: 0x80D69D4C
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct xSndVoiceInfo * pTempStreams[4]; // size: 0x10, address: 0x80D69D50
static unsigned char sOldPauseState[7]; // size: 0x7, address: 0x80D69D60
static unsigned char sReverbSetup; // size: 0x1, address: 0x80D69D67
unsigned int gChkStreams[10]; // size: 0x28, address: 0x80517398
unsigned int * pChk; // size: 0x4, address: 0x80D61CF8
unsigned int gNumStreamsOpened; // size: 0x4, address: 0x80D69910
// Range: 0x80126B0C -> 0x80126BA8
static void DetectLeakStreamOpen(unsigned int sndID /* r31 */, const char * name /* r1+0x8 */) {
    // References
    // -> unsigned int * pChk;
    // -> unsigned int gChkStreams[10];
    // -> unsigned int gNumStreamsOpened;
}

unsigned int gNumStreamsClosed; // size: 0x4, address: 0x80D69914
// Range: 0x80126BA8 -> 0x80126CB0
static void DetectLeakStreamClose(unsigned int sndID /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
    unsigned int i; // r30
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D61CFC
// total size: 0x4
...
// total size: 0x1
struct /* @class$828iSnd_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$829iSnd_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$830iSnd_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$831iSnd_cpp */ {
    // Members
...
void iSndInit() {
    ...
    // References
    // -> static unsigned char sReverbSetup;
    // -> static void * sSndStaticBuffer;
    // -> static char __FUNCTION__[9];
    // -> void * RwEngineInstance;
    // -> unsigned int _rwMemoryLastAllocLine;
    // -> const char * _rwMemoryLastAllocFile;
    // -> static struct xSndVoiceInfo * pTempStreams[4];
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D61D05
// total size: 0x28
struct PKRAssetType {
    // Members
...
void iSndInitSceneLoaded() {
    ...
    int i; // r30
    unsigned char bOk; // r28

    // References
    // -> unsigned int sinfoArrayLoaded;
    // -> struct gcSoundInfoAsset sinfoArray[12];
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D61D19
...
// Range: 0x801270AC -> 0x801275B0
static unsigned char loadSoundInfoAsset(unsigned int uInfoArrayIndex /* r21 */, struct PKRAssetTOCInfo & rAssetInfo /* r27 */) {
    // Local variables
    unsigned char retval; // r28
    struct gcSoundInfoAsset & rSoundAsset; // r31
    unsigned int uFileSize; // r1+0x10
    const char * hipname; // r29
    struct tag_xFile hopFile; // r1+0x14
    unsigned int open; // r1+0xC
    int uSoundInfoOffsetBytes; // r23
    unsigned int dataBufferSize; // r30
    unsigned char * dataBuffer; // r22
    int i; // r26
    int i; // r25
    int uStaticBufferLength; // r24
    int nOpenState; // r1+0x8
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x805173C0
// Range: 0x801275B0 -> 0x801276B0
static unsigned char unloadSoundInfoAsset(unsigned int uInfoArrayIndex /* r29 */) {
    // Local variables
    struct gcSoundInfoAsset & rSoundAsset; // r31
    signed char bOK; // r30
...
// Range: 0x801276B0 -> 0x80127718
void iSndSceneExit() {
    // Local variables
    unsigned int i; // r31
    unsigned char bOk; // r1+0x8
...
// Range: 0x80127718 -> 0x80127738
void iSndExit() {}

// Range: 0x80127738 -> 0x801277E4
struct iSndFileInfo * iSndLookup(unsigned int id /* r3 */) {
    // Local variables
    struct gcSoundInfoAsset * pSoundBankInfo; // r31
    int i; // r29
    int lowerIndex; // r28
    int upperIndex; // r27
    int thisIndex; // r30
...
// Range: 0x801277E4 -> 0x80127878
static struct sDSPADPCM * iSndFindCutsceneHeader(unsigned int id /* r3 */) {
    // Local variables
    struct gcSoundInfoAsset * pSoundBankInfo; // r31
    int i; // r30
    struct sDSPADPCM * pHeader; // r29
    int j; // r28
...
// Range: 0x80127878 -> 0x80127924
unsigned char initBytesToConsume(struct FSOUND_STREAM * stream /* r3 */) {
    // Local variables
    int i; // r31

    // References
    // -> struct ExternalStreamInfo externStreamInfo[2];
}

// Range: 0x80127924 -> 0x801279D4
unsigned char releaseBytesToConsume(struct FSOUND_STREAM * stream /* r3 */) {
    // Local variables
    int i; // r31
...
// Range: 0x801279D4 -> 0x80127A34
int getBytesToConsume(struct FSOUND_STREAM * stream /* r3 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80127A34 -> 0x80127A94
int getFrontBuffer(struct FSOUND_STREAM * stream /* r3 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80127A94 -> 0x80127AF4
void * getDataPtr(struct FSOUND_STREAM * stream /* r3 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80127AF4 -> 0x80127B58
unsigned char setBytesToConsume(struct FSOUND_STREAM * stream /* r3 */, int bytesToConsume /* r4 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80127B58 -> 0x80127BBC
unsigned char setFrontBuffer(struct FSOUND_STREAM * stream /* r3 */, int frontBuffer /* r4 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80127BBC -> 0x80127C20
unsigned char setDataPtr(struct FSOUND_STREAM * stream /* r3 */, void * pData /* r4 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D61D2C
// Range: 0x80127C20 -> 0x80127FE8
signed char iSndExternalCB(struct FSOUND_STREAM * stream /* r29 */, void * buff /* r25 */, int len /* r26 */, void * userdata /* r22 */) {
    // Local variables
    int bytesToConsume; // r31
    int frontbuffer; // r27
    void * pData; // r30
    unsigned int datasize; // r1+0x8
    unsigned int assetID; // r24
    unsigned char * pEndOfCpy; // r23
    unsigned char retval; // r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D61D3B
// Range: 0x80127FE8 -> 0x80128374
static void iSndCloseStream(int idx /* r31 */, unsigned char bFreeRef /* r1+0x8 */) {
    // Local variables
    unsigned char retval; // r28
    int nOpenState; // r29
    signed char closed; // r27
    int nIndex; // r30
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D61D4B
int enableAudioAnnihilator; // size: 0x4, address: 0x80D6A214
// total size: 0x0
struct FSOUND_SAMPLE {};
// total size: 0x2E
struct FSOUND_GCADPCMINFO {
    // Members
    signed short coef[16]; // offset 0x0, size 0x20
    unsigned short gain; // offset 0x20, size 0x2
    unsigned short pred_scale; // offset 0x22, size 0x2
    signed short yn1; // offset 0x24, size 0x2
    signed short yn2; // offset 0x26, size 0x2
    unsigned short loop_pred_scale; // offset 0x28, size 0x2
    signed short loop_yn1; // offset 0x2A, size 0x2
    signed short loop_yn2; // offset 0x2C, size 0x2
};
// Range: 0x80128374 -> 0x80128FC0
unsigned char iSndPlay(struct xSndVoiceInfo * vp /* r31 */) {
    // Local variables
    struct gcSoundInfoAsset * pSoundBankInfo; // r30
    struct iSndFileInfo * pSndInfo; // r29
    struct FSOUND_SAMPLE * pSample; // r26
    unsigned int uOpenMode; // r27
    struct sDSPADPCM * pHeader; // r23
    unsigned char retval; // r17
    struct FSOUND_GCADPCMINFO * info; // r1+0x10
    int nChannel; // r19
    struct xSndVoiceInfo * pVoice; // r25
    int nOffsetToStartStream; // r1+0xC
    int nStreamSize; // r21
    const char * hipname; // r18
    unsigned int nIndex; // r24
    unsigned int samplemode; // r22
    int nChannel; // r20
    int nRawChanZero; // r28
    int savePriority; // r1+0x8
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D61D54
enum xSndEffect {
    xSndEffect_NONE = 0,
    xSndEffect_CAVE = 1,
...
// Range: 0x80128FC0 -> 0x80129510
static unsigned char iSndPlayDone(struct xSndVoiceInfo * vp /* r30 */) {
    // Local variables
    int nRawChanZero; // r31
    int nChannelCount; // r29
    float fMinDist; // f31
    float fMaxDist; // f30
    struct xVec3 vPosInvX; // r1+0x8
    signed char bOK; // r27
    signed char ret; // r28
...
// Range: 0x80129510 -> 0x80129514
void iSndStartStereo() {}

// Range: 0x80129514 -> 0x80129580
void iSndSetMode() {
    // References
    // -> struct xSndGlobals gSnd;
}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x805173D5
// Range: 0x80129580 -> 0x80129638
void iSndSetEnvironmentalEffect(int effectType /* r31 */) {
    // References
    // -> static char __FUNCTION__[27];
    // -> enum xSndEffect m_eCurrentEffect;
}

// Range: 0x80129638 -> 0x80129744
unsigned char iSndGetFreeStreamInfo(unsigned int priority /* r1+0x8 */) {
    // Local variables
    int numStreams; // r29
    int i; // r30
    unsigned int lo_priority; // r28
    unsigned int lo_voice; // r27
    unsigned int i; // r31
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x805173F0
// Range: 0x80129744 -> 0x80129A30
struct xSndVoiceInfo * iSndGetFreeVoiceInfo(unsigned int priority /* r24 */, int flags /* r1+0x8 */) {
    // Local variables
    unsigned int lo_priority; // r29
    unsigned int lo_voice; // r31
    int voiceIsUnused; // r28
    unsigned int i; // r30
    unsigned int loopMode; // r27
    unsigned char islooped; // r23
    unsigned char isstreaming; // r22
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61D61
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x80129A30 -> 0x8012A6F8
void iSndUpdate() {
    // Local variables
    int i; // r30
    int nOpenState; // r28
    unsigned char bCloseStream; // r27
    int nChannel; // r26
    int nRawChanZero; // r29
    signed char closed; // r20
    unsigned char bDialogActive; // r25
    int i; // r31
    signed char playing; // r19
    signed char paused; // r18
    unsigned char is3d; // r17
    unsigned int loopMode; // r24
    unsigned char islooped; // r1+0xA
    unsigned char bGoneForever; // r1+0x9
    struct xVec3 vPosInvX; // r1+0x20
    signed char bOK; // r1+0x8
    int nSampleFreq; // r1+0x10
    struct FSOUND_SAMPLE * pSample; // r23
    float iShiftedFreq; // f31
    int iDoppleredFreq; // r1+0xC
    struct xVec3 vListenerPosInvX; // r1+0x14

    // References
    // -> static char __FUNCTION__[11];
    // -> unsigned int gHighwaterSoundMemoryUsed;
    // -> unsigned int gCurrSoundMemoryUsed;
    // -> struct xSndGlobals gSnd;
    // -> struct xGlobals * xglobals;
    // -> static struct xSndVoiceInfo * pTempStreams[4];
}

// Range: 0x8012A6F8 -> 0x8012A700
unsigned char iSndIsReady() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D61D6C
// Range: 0x8012A700 -> 0x8012AB64
void iSndStop(struct xSndVoiceInfo * vp /* r31 */, unsigned char bFreeRef /* r26 */) {
    // Local variables
    int nRawChanZeroCheck; // r1+0xC
    signed char paused; // r1+0x9
    unsigned int loopMode; // r29
    unsigned char islooped; // r1+0x8
    int nCountChannels; // r25
    int nRawChanZero; // r28
    int i; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D61D75
// Range: 0x8012AB64 -> 0x8012AC08
void iSndPause(struct xSndVoiceInfo * vp /* r31 */, unsigned int paused /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61D7F
// Range: 0x8012AC08 -> 0x8012AD04
void iSndSetVol(struct xSndVoiceInfo * vp /* r31 */, float xVolume /* r1+0x8 */) {
    // Local variables
    float fVolume; // f31
    unsigned char iVolume; // r30

    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D61D8A
// Range: 0x8012AD04 -> 0x8012AE58
void iSndSetPitch(struct xSndVoiceInfo * pVoice /* r31 */, float xpitch /* r1+0x8 */) {
    // Local variables
    int nSampleFreq; // r1+0xC
    struct FSOUND_SAMPLE * pSample; // r30
    float fShiftedFreq; // f31
    int iDoppleredFreq; // r29

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x8012AE58 -> 0x8012AF00
void iSndKill() {
    // Local variables
    unsigned char oneOpen; // r30
    unsigned int i; // r31
...
// Range: 0x8012AF00 -> 0x8012AF04
void iSndSetExternalCallback() {}

// Range: 0x8012AF04 -> 0x8012AF08
void iSndSuspendCD() {}

// Range: 0x8012AF08 -> 0x8012AF70
void iSndSuspend() {
    // Local variables
    signed short i; // r31

    // References
    // -> static unsigned char sOldPauseState[7];
}

// Range: 0x8012AF70 -> 0x8012AFD0
void iSndResume() {
    // Local variables
    signed short i; // r31
