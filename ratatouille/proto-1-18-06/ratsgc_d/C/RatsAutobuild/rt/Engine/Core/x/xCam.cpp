/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCam.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80011344 -> 0x80014D48
*/
char __FUNCTION__$localstatic1$normalize_analog__Fiiiiii[17]; // size: 0x11, address: 0x80D5E620
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR5xVec3[8]; // size: 0x8, address: 0x80D5E631
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR17xCamCoordCylinder[8]; // size: 0x8, address: 0x80D5E639
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR15xCamCoordSphere[8]; // size: 0x8, address: 0x80D5E641
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR5xQuat[8]; // size: 0x8, address: 0x80D5E649
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR15xCamOrientEuler[8]; // size: 0x8, address: 0x80D5E651
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR5xVec3[13]; // size: 0xD, address: 0x80D5E659
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR17xCamCoordCylinder[13]; // size: 0xD, address: 0x80D5E666
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR15xCamCoordSphere[13]; // size: 0xD, address: 0x80D5E673
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR5xQuat[13]; // size: 0xD, address: 0x80D5E680
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR15xCamOrientEuler[13]; // size: 0xD, address: 0x80D5E68D
char __FUNCTION__$localstatic1$xEntGetPos__FPC4xEnt[11]; // size: 0xB, address: 0x80D5E69A
char __FUNCTION__$localstatic1$xEntGetFacingDirection__FPC4xEnt[23]; // size: 0x17, address: 0x804F0DA0
char __FUNCTION__$localstatic1$xEntGetUpDirection__FPC4xEnt[19]; // size: 0x13, address: 0x80D5E6A5
char __FUNCTION__$localstatic1$xEntGetFrame__FPC4xEnt[13]; // size: 0xD, address: 0x80D5E6B8
char __FUNCTION__$localstatic1$xEntGetAnimFlags__FPC4xEnt[17]; // size: 0x11, address: 0x80D5E6C5
char __FUNCTION__$localstatic1$PushBack__16zPlayerContainerFP7zPlayer[9]; // size: 0x9, address: 0x80D5E6D6
char __FUNCTION__$localstatic1$__vc__16zPlayerContainerFi[5]; // size: 0x5, address: 0x80D5E6DF
char xSTAssetNameOrID(unsigned int)::buffer[16]; // size: 0x10, address: 0x80D68BD8
char xSTAssetNameOrID(void*)::buffer[16]; // size: 0x10, address: 0x80D68BE8
char __FUNCTION__$localstatic1$unlink__14pool_list_baseFPQ214pool_list_base9node_base[7]; // size: 0x7, address: 0x80D5E6E4
char __FUNCTION__$localstatic1$free__14pool_list_baseFPQ214pool_list_base9node_base[5]; // size: 0x5, address: 0x80D5E6EB
char __FUNCTION__$localstatic1$alloc__14pool_list_baseFv[6]; // size: 0x6, address: 0x80D5E6F0
char __FUNCTION__$localstatic1$alloc_block_data__20tier_queue_allocatorCFUi[17]; // size: 0x11, address: 0x80D5E6F6
char __FUNCTION__$localstatic1$get_block__20tier_queue_allocatorCFUl[10]; // size: 0xA, address: 0x80D5E707
char __FUNCTION__$localstatic1$free_block__20tier_queue_allocatorFUc[11]; // size: 0xB, address: 0x80D5E711
char __FUNCTION__$localstatic1$alloc_block__20tier_queue_allocatorFUi[12]; // size: 0xC, address: 0x80D5E71C
char __FUNCTION__$localstatic1$clear__20tier_queue_allocatorFv[6]; // size: 0x6, address: 0x80D5E728
char __FUNCTION__$localstatic1$full__20tier_queue_allocatorCFv[5]; // size: 0x5, address: 0x80D5E72E
char __FUNCTION__$localstatic1$init__20tier_queue_allocatorFUlUlUlUi[5]; // size: 0x5, address: 0x80D5E733
// total size: 0x10
struct basic_rect {
    // Static members
...
static int blendDepth; // size: 0x4, address: 0x80D68BFC
static int super_sample_updates; // size: 0x4, address: 0x80D68C00
// Range: 0x80011344 -> 0x80011394
static void add_tweaks(const char * prefix /* r1+0x10 */) {
    // References
    // -> static int super_sample_updates;
}
...
struct xCam {
    ...
    void refresh_mat(struct xMat4x3 & mat, const struct xCamSpatialInfo & spatial);
...
// Range: 0x80011394 -> 0x800113A4
// this: r3
void xCam::start() {}

// Range: 0x800113A4 -> 0x800113B4
// this: r3
void xCam::stop() {}

// Range: 0x800113B4 -> 0x800113E0
void xCam::scene_enter() {}

// Range: 0x800113E0 -> 0x8001140C
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5E738
// Range: 0x8001140C -> 0x80011590
// this: r29
void xCam::refresh_mat(struct xMat4x3 & mat /* r30 */, const struct xCamSpatialInfo & spatial /* r31 */) {
    // References
...
// Range: 0x80011590 -> 0x800115FC
// this: r31
void xCam::refresh_mat() {}

// Range: 0x80011720 -> 0x80011770
// this: r31
void xCam::create() {}

// Range: 0x80011770 -> 0x8001177C
// this: r3
unsigned char xCam::active() {}

static struct xColor_tag colors[22]; // size: 0x58, address: 0x804F0DB7
static signed char init; // size: 0x1, address: 0x80D68C04
static int last_color; // size: 0x4, address: 0x80D68C08
static signed char init; // size: 0x1, address: 0x80D68C0C
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x80011E20 -> 0x80011F94
// this: r31
void xCam::debug_render() {
    // Local variables
    float cone_radius; // f31
    struct xVec3 coneTip; // r1+0x14
}

// total size: 0xC
struct /* @class$768xCam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771xCam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772xCam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773xCam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774xCam_cpp */ {
    // Members
...
// Range: 0x80011F94 -> 0x80012444
// this: r31
void xCam::add_tweaks_common(const char * prefix /* r30 */) {
    // Local variables
    char _buffer[128]; // r1+0x808
    char _buffer[128]; // r1+0x788
    char _buffer[128]; // r1+0x708
    char _buffer[128]; // r1+0x688
...
// Range: 0x80012444 -> 0x800126D4
// this: r1+0x8
void xCam::add_tweaks_config_follow(const char * prefix /* r30 */) {
    // Local variables
    struct xCamConfigFollow * fcfg; // r31
    char _buffer[128]; // r1+0x40C
    char _buffer[128]; // r1+0x38C
    char _buffer[128]; // r1+0x30C
    char _buffer[128]; // r1+0x28C
    char _buffer[128]; // r1+0x20C
    char _buffer[128]; // r1+0x18C
    char _buffer[128]; // r1+0x10C
...
struct xCamGroup {
    ...
    void update(struct xScene & scene, float dt);

    void transition_to(struct xCam & cam, const struct xCamTransitionParams * params, unsigned char force_cut, unsigned char force_restart);

    void add(struct xCam & cam, unsigned char force_cut);

    void remove(struct xCam & cam);

    struct xCamBlend * grab_blend_cam();

    void set_primary(struct xCam * toCamera, unsigned char force_restart);

    struct xCam * get_blend(class xCamTransition * transition, struct xCam & to);

    void set_child_flags(int add, int remove);

    void debug_render(unsigned char force, unsigned char sparse);

    void PrintCamMsg(const char * msg, unsigned int ownerID) const;
...
// Range: 0x800126D4 -> 0x80012730
// this: r29
void xCamGroup::create() {
    // Local variables
    struct xCamBlend * * it; // r31
    struct xCamBlend * * end; // r30
}

// Range: 0x80012730 -> 0x8001279C
// this: r30
void xCamGroup::destroy() {
    // Local variables
    struct xCamBlend * * it; // r31
    struct xCamBlend * * end; // r29
}
...
// Range: 0x80012838 -> 0x80012A08
// this: r31
void xCamGroup::update(struct xScene & scene /* r1+0x8 */, float dt /* f29 */) {
    // Local variables
    struct xVec3 prev_pos; // r1+0xC
    float len; // f31
    float len2; // f30
    float len_inv; // f28
...
// Range: 0x80012A08 -> 0x80012AE4
// this: r31
void xCamGroup::transition_to(struct xCam & cam /* r30 */, const struct xCamTransitionParams * params /* r29 */, unsigned char force_cut /* r1+0x8 */, unsigned char force_restart /* r25 */) {
    // Local variables
    class xCamTransition * transition; // r27
    struct xCam * next; // r26
}

// Range: 0x80012AE4 -> 0x80012B48
// this: r30
void xCamGroup::add(struct xCam & cam /* r31 */, unsigned char force_cut /* r1+0x8 */) {}

// Range: 0x80012B48 -> 0x80012BCC
// this: r30
void xCamGroup::remove(struct xCam & cam /* r31 */) {
    // References
    // -> unsigned char gxCamShowDebugMessages;
}

// Range: 0x80012BCC -> 0x80012C1C
// this: r3
struct xCamBlend * xCamGroup::grab_blend_cam() {
    // Local variables
    struct xCamBlend * * it; // r31
    struct xCamBlend * * end; // r30
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5E744
// Range: 0x80012C1C -> 0x80012EB8
// this: r31
void xCamGroup::set_primary(struct xCam * toCamera /* r30 */, unsigned char force_restart /* r1+0x8 */) {
    // Local variables
    float len; // f31
    float len2; // f30
    float len_inv; // f29
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D5E750
// Range: 0x80012EB8 -> 0x80013128
// this: r29
struct xCam * xCamGroup::get_blend(class xCamTransition * transition /* r27 */, struct xCam & to /* r30 */) {
    // Local variables
    float blend_time; // f31
    struct xCamBlend * parent; // r28
    struct xCam * pTo; // r26
    struct xCamBlend * blend; // r31

    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x80013128 -> 0x80013140
void xCamGroup::notify_released(struct xCam & cam /* r4 */) {}

// Range: 0x80013140 -> 0x80013158
// this: r3
void xCamGroup::set_child_flags(int add /* r4 */, int remove /* r5 */) {}

// Range: 0x80013158 -> 0x80013200
static void do_transient_replacement(struct xCam * & curCam /* r31 */) {
    // Local variables
    struct xCam * next; // r30
}

// Range: 0x80013200 -> 0x800132C0
// this: r31
void xCamGroup::debug_render(unsigned char force /* r1+0x8 */, unsigned char sparse /* r1+0x9 */) {}

// Range: 0x800132C0 -> 0x80013350
struct xCamBlend * xCamGroup::create_blend() {
    // Local variables
    struct xCamBlend * cam; // r31
}

// total size: 0x20
struct {} xCamBias::__vtable; // size: 0x20, address: 0x804F0EC8
// total size: 0x8
class xCamBias {
    // Members
public:
...
// Range: 0x800133D0 -> 0x80013470
// this: r1+0x8
void xCamGroup::PrintCamMsg(const char * msg /* r1+0xC */, unsigned int ownerID /* r30 */) const {
    // References
    // -> struct zGlobals globals;
    // -> unsigned char gxCamShowDebugMessages;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D5E75A
...
struct xCamScreen {
    ...
    void set_scene(struct xScene & scene);

    void prepare_render();

    void begin_render(unsigned char clear);

    void end_render();

    void set_world_matrix(const struct xMat4x3 & mat);

    void get_world_matrix(struct xMat4x3 & mat);

    void set_fov(float fov);

    float world_to_screen(struct xVec3 & screen_loc, const struct xVec3 & world_loc) const;

    // Members
    struct RwCamera * icam; // offset 0x0, size 0x4
    float fov; // offset 0x4, size 0x4
};
// Range: 0x80013470 -> 0x80013518
// this: r31
void xCamScreen::create(int w /* r1+0x8 */, int h /* r1+0xC */) {
    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x80013518 -> 0x80013548
// this: r31
void xCamScreen::destroy() {}

// Range: 0x80013548 -> 0x8001358C
// this: r30
void xCamScreen::set_scene(struct xScene & scene /* r31 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D5E761
// Range: 0x8001358C -> 0x80013620
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5E770
// Range: 0x80013620 -> 0x800136CC
// this: r31
void xCamScreen::begin_render(unsigned char clear /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x800136CC -> 0x800136FC
// this: r31
void xCamScreen::end_render() {}

// Range: 0x800136FC -> 0x80013734
// this: r31
void xCamScreen::set_world_matrix(const struct xMat4x3 & mat /* r1+0x8 */) {}

// Range: 0x80013734 -> 0x80013780
// this: r30
void xCamScreen::get_world_matrix(struct xMat4x3 & mat /* r1+0x8 */) {
    // Local variables
    struct RwFrame * frame; // r31
}

// Range: 0x80013780 -> 0x800137CC
// this: r31
void xCamScreen::set_fov(float fov /* f31 */) {}

// Range: 0x800137CC -> 0x80013858
// this: r30
float xCamScreen::world_to_screen(struct xVec3 & screen_loc /* r1+0x8 */, const struct xVec3 & world_loc /* r1+0xC */) const {
    // Local variables
    const struct xMat4x3 & view_mat; // r31
    struct xVec3 view_loc; // r1+0x10
    float rz; // f31
}
...
// Range: 0x80013858 -> 0x80013860
// this: r3
void xCamTimeBias::Init(float blendTime /* f1 */) {}

// Range: 0x80013860 -> 0x80013874
// this: r3
void xCamTimeBias::Start() {}

// Range: 0x80013874 -> 0x800138B4
// this: r31
void xCamTimeBias::Update(float dt /* r1+0x8 */) {}

// Range: 0x800138B4 -> 0x8001390C
// this: r31
void xCamTimeBias::Reverse() {}

// Range: 0x8001390C -> 0x80013914
// this: r3
float xCamTimeBias::GetBias() {}

// Range: 0x80013914 -> 0x8001392C
// this: r3
unsigned char xCamTimeBias::IsActive() {}

// Range: 0x8001392C -> 0x80013948
// this: r3
unsigned char xCamTimeBias::DidComplete() {}

// Range: 0x80013948 -> 0x800139A8
// this: r31
...
// Range: 0x800139A8 -> 0x80013A08
class xCamBias * xCamBias::GetBiasObject(class xCamTransition * transition /* r31 */, class xCamTimeBias & timeBias /* r30 */) {}
...
struct xCamBlend : public xCam {
    ...
    void pre_update(struct xScene & scene);

    void post_update(struct xScene & scene);

    void update(struct xScene & scene, float dt);

    struct xCam * get_next();

    float getCameraPlayerAudioBias() const;

    struct xCam * find_camera(unsigned int ownerID);

    void attach(struct xCam & src, struct xCam & dst);
...
// Range: 0x80013A08 -> 0x80013A50
// this: r31
void xCamBlend::create() {}

// Range: 0x80013A50 -> 0x80013A54
void xCamBlend::destroy() {}

static enum xCamCoordType coord_table[3][3]; // size: 0x24, address: 0x80474648
static enum xCamOrientType orient_table[2][2]; // size: 0x10, address: 0x80D6C518
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D5E77D
// Range: 0x80013A54 -> 0x80013ED4
// this: r31
void xCamBlend::start() {
    // Local variables
    char levelMsg[128]; // r1+0x8
    int combined_sprung_flags; // r29

    // References
    // -> static enum xCamOrientType orient_table[2][2];
    // -> static enum xCamCoordType coord_table[3][3];
    // -> static char __FUNCTION__[6];
    // -> static int blendDepth;
    // -> unsigned char gxCamShowDebugMessages;
}

// Range: 0x80013ED4 -> 0x80014004
// this: r31
void xCamBlend::stop() {
    // Local variables
    char levelMsg[128]; // r1+0x8
...
// Range: 0x80014004 -> 0x80014064
// this: r31
void xCamBlend::pre_update(struct xScene & scene /* r30 */) {}
...
// Range: 0x80014064 -> 0x800140C4
// this: r31
void xCamBlend::post_update(struct xScene & scene /* r30 */) {}

// Range: 0x800140C4 -> 0x800141EC
// this: r31
void xCamBlend::update(struct xScene & scene /* r30 */, float dt /* f30 */) {
    // Local variables
    float s; // f31
}

// Range: 0x800141EC -> 0x8001427C
// this: r31
struct xCam * xCamBlend::get_next() {}

// Range: 0x8001427C -> 0x80014310
// this: r31
float xCamBlend::getCameraPlayerAudioBias() const {
    // Local variables
    float srcBias; // f31
    float dstBias; // f30
}

// Range: 0x80014310 -> 0x80014398
// this: r31
struct xCam * xCamBlend::find_camera(unsigned int ownerID /* r28 */) {
    // Local variables
    struct xCam * found; // r30
}

// Range: 0x80014398 -> 0x800143CC
// this: r3
void xCamBlend::attach(struct xCam & src /* r4 */, struct xCam & dst /* r5 */) {}

// Range: 0x800143CC -> 0x80014420
// this: r31
void xCamBlend::reverse() {
    // Local variables
    struct xCam * temp; // r30
}
...
// Range: 0x80014420 -> 0x800145DC
// this: r31
void xCamBlend::blend_coord(float s /* f31 */) {
    // Local variables
    struct xVec3 c1; // r1+0x14
    struct xVec3 c2; // r1+0x8
    struct xCamCoordCylinder c1; // r1+0x78
    struct xCamCoordCylinder c2; // r1+0x60
    struct xCamCoordSphere c1; // r1+0x40
    struct xCamCoordSphere c2; // r1+0x20
}
...
// Range: 0x800145DC -> 0x80014718
// this: r31
void xCamBlend::blend_orient(float s /* f31 */) {
    // Local variables
    struct xQuat c1; // r1+0x30
    struct xQuat c2; // r1+0x20
    struct xCamOrientEuler c1; // r1+0x14
    struct xCamOrientEuler c2; // r1+0x8
}

// Range: 0x80014718 -> 0x80014794
// this: r31
void xCamBlend::debug_render() {}

// Range: 0x80014794 -> 0x800147C4
// this: r1+0x8
void xCamBlend::add_tweaks(const char * prefix /* r1+0xC */) {}

// total size: 0x70
struct config : public xCamConfigFollow {
    // Members
    struct xVec2 stick_vel; // offset 0x54, size 0x8
    struct xVec3 move_vel; // offset 0x5C, size 0xC
    float slow_turn; // offset 0x68, size 0x4
    float slow_move; // offset 0x6C, size 0x4
};
// total size: 0x1C0
struct xCamDebug : public xCam {
    // Functions
    void create();
    ...
    // Members
    struct config cfg; // offset 0x140, size 0x70
    struct xVec2 dpad; // offset 0x1B0, size 0x8
    float slow_input; // offset 0x1B8, size 0x4
};
// Range: 0x800147C4 -> 0x80014800
// this: r31
void xCamDebug::create() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D5E783
// Range: 0x80014800 -> 0x800148C4
// this: r31
void xCamDebug::start() {
    // References
    // -> static char __FUNCTION__[6];
}
...
// Range: 0x800148C4 -> 0x80014ABC
// this: r31
void xCamDebug::update(float dt /* f31 */) {
    // Local variables
    float turn_mult; // f29
    float move_mult; // f30
    float dyaw; // f28
    float dpitch; // f27
    struct xVec3 dright; // r1+0x14
    float dy; // f26
    struct xVec3 dat; // r1+0x8
}
...
// Range: 0x80014ABC -> 0x80014BA8
// this: r31
void xCamDebug::refresh_input() {}

// Range: 0x80014BA8 -> 0x80014BD0
// this: r1+0x8
void xCamDebug::debug_render() {}

// Range: 0x80014BD0 -> 0x80014D48
// this: r30
void xCamDebug::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char _buffer[128]; // r1+0x208
    char _buffer[128]; // r1+0x188
    char _buffer[128]; // r1+0x108
...
// total size: 0x4C
struct {} xCamDebug::__vtable; // size: 0x4C, address: 0x804F0E10
// total size: 0x0
class zCamSplineCommonMix {};
// total size: 0x4C
struct {} xCamBlend::__vtable; // size: 0x4C, address: 0x804F0E5C
// total size: 0x0
class zCam2Player {};
// total size: 0x20
struct {} xCamTimeBias::__vtable; // size: 0x20, address: 0x804F0EA8
// total size: 0x4C
struct {} xCam::__vtable; // size: 0x4C, address: 0x804F0EE8
