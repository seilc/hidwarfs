/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xMovePoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800A6A1C -> 0x800A76E4
*/
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D60058
...
// Range: 0x800A6A1C -> 0x800A6B2C
void xMovePointInit(struct xMovePoint * m /* r31 */, struct xMovePointAsset * asset /* r30 */) {
    // References
    // -> static char __FUNCTION__[15];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D60067
// total size: 0x0
struct xSerial {};
// Range: 0x800A6B2C -> 0x800A6C1C
void xMovePointSave(struct xMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D60076
// Range: 0x800A6C1C -> 0x800A6D0C
void xMovePointLoad(struct xMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D60085
// Range: 0x800A6D0C -> 0x800A6E18
void xMovePointReset(struct xMovePoint * m /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D60095
// total size: 0x0
struct xEnt {};
// total size: 0x8
struct RwObject {
...
// Range: 0x800A6E18 -> 0x800A70B0
void xMovePointSetup(struct xMovePoint * m /* r31 */, struct xScene * sc /* r28 */) {
    // Local variables
    unsigned int * id; // r29
    unsigned short idx; // r30

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x804F61A8
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x800A70B0 -> 0x800A74B8
void xMovePointSplineSetup(struct xMovePoint * m /* r31 */) {
    // Local variables
    struct xMovePoint * w0; // r28
    struct xMovePoint * w1; // r29
    struct xMovePoint * w2; // r30
    struct xMovePoint * w3; // r27
    struct xVec3 points[2]; // r1+0x20
    struct xVec3 p1; // r1+0x14
    struct xVec3 p2; // r1+0x8

    // References
    // -> static char __FUNCTION__[22];
}

// Range: 0x800A74B8 -> 0x800A74D0
void xMovePointSplineDestroy(struct xMovePoint * m /* r3 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D600A5
// Range: 0x800A74D0 -> 0x800A7660
float xMovePointGetNext(const struct xMovePoint * m /* r30 */, const struct xMovePoint * prev /* r1+0x8 */, struct xMovePoint * * next /* r31 */, struct xVec3 * hdng /* r26 */) {
    // Local variables
    int rnd; // r28
    unsigned short idx; // r29
    struct xMovePoint * previousOption; // r27

    // References
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D600B7
// Range: 0x800A7660 -> 0x800A76E4
struct xVec3 * xMovePointGetPos(const struct xMovePoint * m /* r31 */) {
    // References
