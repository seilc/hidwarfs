/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xClimate.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8001B918 -> 0x8001B918
*/
// total size: 0x8
struct _tagRain {
    // Members
