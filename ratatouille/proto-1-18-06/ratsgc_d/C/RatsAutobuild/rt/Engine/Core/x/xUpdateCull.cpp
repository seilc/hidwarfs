/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xUpdateCull.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8010123C -> 0x80102018
*/
// total size: 0x10
...
// Range: 0x8010123C -> 0x80101300
static void xUpdateCull_Swap(struct xUpdateCullMgr * m /* r3 */, unsigned int a /* r4 */, unsigned int b /* r5 */) {
    // Local variables
    struct xUpdateCullEnt * cullA; // r30
    struct xUpdateCullEnt * cullB; // r29
    struct xUpdateCullEnt * curr; // r31
    void * tmpent; // r28
    struct xUpdateCullEnt * tmpmgr; // r27
}

// Range: 0x80101300 -> 0x80101398
static void xUpdateCull_MakeActive(struct xUpdateCullMgr * m /* r31 */, struct xUpdateCullEnt * cent /* r30 */) {}

// Range: 0x80101398 -> 0x80101438
static void xUpdateCull_MakeInactive(struct xUpdateCullMgr * m /* r31 */, struct xUpdateCullEnt * cent /* r30 */) {}

// Range: 0x80101438 -> 0x80101440
...
// total size: 0x4
struct /* @class$901xUpdateCull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039xUpdateCull_cpp */ {
    // Members
...
union /* @class$1040xUpdateCull_cpp */ {
...
// total size: 0x10
struct /* @class$1304xUpdateCull_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80101440 -> 0x80101540
unsigned int xUpdateCull_DistanceSquaredCB(void * ent /* r3 */, void * cbdata /* r4 */) {
    // Local variables
    union FloatAndVoid fandv; // r1+0x8
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D61468
...
// Range: 0x80101540 -> 0x80101C2C
struct xUpdateCullMgr * xUpdateCull_Init(void * ent /* r24 */, unsigned int entCount /* r28 */, struct xGroup * * group /* r25 */, unsigned int groupCount /* r1+0x8 */) {
    // Local variables
    void * tempEnt; // r20
    unsigned int tempCount; // r1+0x38
    unsigned int idx; // r18
    unsigned int i; // r30
    unsigned int j; // r26
    unsigned int k; // r27
    unsigned int gcnt; // r1+0x34
    unsigned int entsInThisGroup; // r21
    unsigned int entsInGroups; // r1+0x30
    unsigned int nonEmptyGroups; // r17
    unsigned int x; // r19
    unsigned char * inGroupArray; // r23
    struct xBase * base; // r1+0x2C
    unsigned int mgrCount; // r1+0x28
    unsigned int memsize; // r1+0x24
    struct xUpdateCullMgr * m; // r31
    unsigned int grpIndex; // r22
    unsigned int mgrIndex; // r29
    unsigned int startIndex; // r1+0x20
    struct xBase * base; // r1+0x1C
    struct xUpdateCullEnt * * prevPtr; // r1+0x18
...
// Range: 0x80101C2C -> 0x80101E64
void xUpdateCull_Update(struct xUpdateCullMgr * m /* r31 */, unsigned int percent_update /* r1+0x8 */) {
    // Local variables
    int numiters; // r28
    unsigned int i; // r27
    struct xUpdateCullEnt * cent; // r29
    unsigned int result; // r25
    struct xUpdateCullGroup * grp; // r30
    struct xUpdateCullEnt * curr; // r26
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D61479
// Range: 0x80101E64 -> 0x80101FBC
void xUpdateCull_SetCB(struct xUpdateCullMgr * m /* r31 */, void * entity /* r29 */, unsigned int (* cb)(void *, void *) /* r1+0x8 */, void * cbdata /* r1+0xC */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x80101FBC -> 0x80102018
void xUpdateCull_Reset(struct xUpdateCullMgr * m /* r31 */) {
    // Local variables
    unsigned int i; // r30
}
