/*
    ...
    Language: C++
    Code range: 0x800873B8 -> 0x800879D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80D6CFE8
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D5FBD8
// total size: 0x24
struct font_context {
    // Members
...
struct widget_chunk : public xBase {
    // Members
    class font_meter_widget w; // offset 0x10, size 0x150
};
// Range: 0x800873B8 -> 0x80087574
void font_meter_widget::load(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
...
// total size: 0x30
struct {} xhud::font_meter_widget::__vtable; // size: 0x30, address: 0x804F5538
// Range: 0x80087574 -> 0x8008769C
// this: r31
...
// total size: 0x10
struct /* @class$1074xHudFontMeter_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1114xHudFontMeter_cpp */ {
    // Members
...
enum /* @enum$1115xHudFontMeter_cpp */ {
    ACT_NONE = 0,
    ACT_SHOW = 1,
    ACT_HIDE = 2,
    MAX_ACT = 3,
...
// total size: 0xC
struct /* @class$830xHudFontMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831xHudFontMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832xHudFontMeter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833xHudFontMeter_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$835xHudFontMeter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836xHudFontMeter_cpp */ {
    // Members
...
// Range: 0x8008769C -> 0x800876C4
// this: r1+0x8
void font_meter_widget::destruct() {}

// Range: 0x800876C4 -> 0x800876EC
// this: r1+0x8
void font_meter_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80D69230
static signed char init; // size: 0x1, address: 0x80D69234
// Range: 0x800876EC -> 0x8008772C
...
// Range: 0x8008772C -> 0x80087794
// this: r29
unsigned char font_meter_widget::is(unsigned int id /* r30 */) const {}

// Range: 0x80087794 -> 0x80087924
// this: r31
void font_meter_widget::update(float dt /* r1+0x8 */) {
    // Local variables
    float a; // f31
    int new_value; // r30
}
