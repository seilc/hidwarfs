/*
    ...
    Language: C++
    Code range: 0x8002AF3C -> 0x8002B2A4
*/
static int been_here; // size: 0x4, address: 0x80D68C70
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D5EA08
// total size: 0x10
struct xSphere {
    // Members
...
// Range: 0x8002AF3C -> 0x8002B170
unsigned int xRayHitsSphereFast(const struct xRay3 * r /* r31 */, const struct xSphere * s /* r30 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D5EA1B
// total size: 0x18
struct xBox {
    // Members
...
// Range: 0x8002B170 -> 0x8002B2A4
unsigned int xRayHitsBoxFast(const struct xRay3 * r /* r29 */, const struct xBox * b /* r30 */) {
    // Local variables
