/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xLightVolume.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80221058 -> 0x802214AC
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct activity_type * activities; // size: 0x4, address: 0x80D6AF08
int activities_used; // size: 0x4, address: 0x80D6AF0C
// total size: 0x8
class xLightVolume {
    // Functions
    void create();
...
// Range: 0x80221098 -> 0x8022109C
void xLightVolume::scene_exit() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D64AD0
// Range: 0x8022109C -> 0x80221160
...
// Range: 0x80221160 -> 0x8022116C
// this: r3
void xLightVolume::create() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D64ADA
// Range: 0x8022116C -> 0x802212CC
// this: r31
unsigned char xLightVolume::activate() {
    // Local variables
    struct activity_type * act; // r30
    struct activity_type * end_act; // r29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D64AE3
// Range: 0x802212CC -> 0x80221498
// this: r31
void xLightVolume::deactivate() {
    // Local variables
    struct activity_type * tail_activity; // r30
...
// total size: 0x4
struct /* @class$920xLightVolume_cpp */ {
    // Members
...
// Range: 0x802214A4 -> 0x802214A8
void xLightVolume::render_all() {}

// Range: 0x802214A8 -> 0x802214AC
