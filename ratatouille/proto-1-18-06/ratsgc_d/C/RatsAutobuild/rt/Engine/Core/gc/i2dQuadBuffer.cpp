/*
    ...
    Language: C++
    Code range: 0x8025D5D4 -> 0x8025D7DC
*/
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D655B8
// total size: 0x18
...
unsigned char i2dQuadBuffer::Flush() {
    ...
    struct rwGameCube2DVertex * end_marker; // r27
