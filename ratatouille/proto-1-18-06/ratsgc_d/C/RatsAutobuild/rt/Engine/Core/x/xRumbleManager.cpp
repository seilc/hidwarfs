/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xRumbleManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800CB1AC -> 0x800CBFA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800CB1AC -> 0x800CB2D0
// this: r3
void effectInternal::updateCameraShake(float intensity /* f1 */) {
    // Local variables
    const struct effectAsset * pAsset; // r31
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D60930
// Range: 0x800CB2D0 -> 0x800CB374
// this: r31
...
// Range: 0x800CB374 -> 0x800CB50C
// this: r30
float effectInternal::GetIntensity(const struct xVec3 & playerPos /* r1+0x8 */) {
    // Local variables
    float intensity; // r1+0xC
    const struct effectAsset * pAsset; // r31
...
// Range: 0x800CB50C -> 0x800CB5B4
// this: r3
void padInfo::FindNewExclusive() {
    // Local variables
    unsigned int maxPriority; // r30
    unsigned int i; // r31
    unsigned int currentPriority; // r29
}
...
// Range: 0x800CB5B4 -> 0x800CB5E8
void Manager::store(struct padInfo * pInfo /* r4 */, const struct emitterBase * pEmitter /* r5 */, struct effectInternal * pEffectInternal /* r6 */, float timeToLive /* f1 */, unsigned char rumbleForever /* r7 */) {}

static unsigned char done; // size: 0x1, address: 0x80D69698
static signed char init; // size: 0x1, address: 0x80D69699
static char __FUNCTION__[4]; // size: 0x4, address: 0x80D6093F
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$901xRumbleManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039xRumbleManager_cpp */ {
    // Members
...
union /* @class$1040xRumbleManager_cpp */ {
...
// total size: 0x10
struct /* @class$1640xRumbleManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x800CB5E8 -> 0x800CBAD4
// this: r20
unsigned char Manager::Add(struct _tagxPad * pad /* r29 */, struct emitterBase * pEmitter /* r30 */) {
    // Local variables
    int counter; // r22
    int i; // r25
    struct padInfo * pInfo; // r31
    float timeToLive; // f31
    unsigned char rumbleForever; // r24
    struct effectInternal * currentExclusive; // r27
    const struct emitterBase * pCurrentEmitter; // r23
    unsigned int effectPriority; // r21
    struct effectInternal * freeEffect; // r26
    unsigned int i; // r28
...
// total size: 0x890
struct /* @class$1883xRumbleManager_cpp */ {
    // Static members
...
// Range: 0x800CBAD4 -> 0x800CBB64
// this: r3
unsigned char Manager::Stop(struct _tagxPad * pad /* r4 */, struct emitterBase * pEmitter /* r5 */) {
    // Local variables
    struct padInfo * pInfo; // r31
    unsigned int i; // r30
}

// Range: 0x800CBB64 -> 0x800CBDDC
// this: r1+0x8
void Manager::Update(struct _tagxPad * pad /* r28 */, const struct xVec3 & playerPos /* r26 */, float timeElapsed /* r1+0xC */, unsigned char bPauseState /* r27 */) {
    // Local variables
    struct padInfo * pInfo; // r31
    unsigned int i; // r29
    float intensity; // f31
    float timeToLive; // r1+0x10
    unsigned int i; // r30
}
...
static signed char init; // size: 0x1, address: 0x80D6969A
static class Manager rumbleManager; // size: 0x510, address: 0x80B95DF8
// Range: 0x800CBDDC -> 0x800CBE20
...
// Range: 0x800CBE20 -> 0x800CBE64
// this: r31
void Manager::Reset() {}

// Range: 0x800CBE64 -> 0x800CBE9C
// this: r31
Manager::Manager() {}

struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80B86CF8
// Range: 0x800CBE9C -> 0x800CBEE8
...
// Range: 0x800CBEE8 -> 0x800CBF60
// this: r1+0x8
void Manager::StopCameraShake(int padNum /* r1+0xC */) {
    // Local variables
    struct padInfo * pInfo; // r30
    unsigned int j; // r31
}

// Range: 0x800CBF60 -> 0x800CBFA8
// this: r1+0x8
