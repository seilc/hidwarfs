/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xHierarchyBound.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80081FC4 -> 0x80082B48
*/
// Range: 0x80081FC4 -> 0x80081FFC
static unsigned int CountElements(const char * * list /* r3 */) {
    // Local variables
    const char * * it; // r31
}

// Range: 0x80081FFC -> 0x80082088
static int GetNumberFromString(const char * string /* r1+0x8 */, unsigned long size /* r1+0xC */) {
    // Local variables
    const char * end; // r30
    const char * start; // r31
    char buffer[32]; // r1+0x10
}

// total size: 0xC
struct /* @class$734xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736xHierarchyBound_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737xHierarchyBound_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738xHierarchyBound_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739xHierarchyBound_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740xHierarchyBound_cpp */ {
    // Members
...
// Range: 0x80082088 -> 0x800820A8
static void OnHierarchyRootSelect(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct xHierarchyBound * bound; // r31
}

// Range: 0x800820A8 -> 0x800820C8
static void OnHierarchyRootUnselect(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct xHierarchyBound * bound; // r31
}

// Range: 0x800820C8 -> 0x8008210C
static void OnHierarchySelect(const struct tweak_info & info /* r31 */) {
    // Local variables
    struct xHierarchyBound * bound; // r30
}

// Range: 0x8008210C -> 0x8008212C
static void OnHierarchyUnselect(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct xHierarchyBound * bound; // r31
}
...
static struct tweak_callback tweak_param_cb; // size: 0x28, address: 0x8047DD48
// Range: 0x8008212C -> 0x800822DC
static void AddHierarchyTweak(const char * base /* r29 */, struct xHierarchyBound * bound /* r31 */, unsigned int which /* r30 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    unsigned int boneNameCount; // r28

    // References
    // -> static struct tweak_callback tweak_param_cb;
}
...
struct xSphereList {
    // Members
    struct xSphereListElement * elements; // offset 0x0, size 0x4
    ...
    struct xHierarchTweakInfo tweakInfo; // offset 0x8, size 0x8
};
// Range: 0x800822DC -> 0x800823D4
static void OnHierachyChangeCount(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct xHierarchyBound * bound; // r31
    char baseName[128]; // r1+0x88
    const char * nameEnd; // r29
    unsigned int i; // r28
    char buffer[128]; // r1+0x8
    unsigned int i; // r27
}
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x804F4EF0
...
// Range: 0x800823D4 -> 0x800824DC
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r30 */, const struct xHierarchyBoundInitData * init /* r29 */, unsigned int extraBounds /* r1+0x8 */) {
    // Local variables
    unsigned int nodesSize; // r31
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x804F4F05
// Range: 0x800824DC -> 0x800825B4
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r30 */, unsigned int nodesNumber /* r1+0x8 */) {
    // Local variables
    unsigned int nodesSize; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D5FAB8
// Range: 0x800825B4 -> 0x8008277C
void xHierarchyBoundInit(struct xHierarchyBound * bound /* r31 */, const struct xHierarchyBoundInitData * init /* r27 */, float masterRadius /* r1+0x8 */, float scale /* f31 */) {
    // Local variables
    unsigned int count; // r30
    unsigned int i; // r29
    struct xHierarchyNode & node; // r28
    unsigned int extraBounds; // r26

    // References
    // -> static char __FUNCTION__[20];
}

// Range: 0x8008277C -> 0x80082870
void xHierarchyBoundDraw(const struct xHierarchyBound * bound /* r30 */, unsigned char mR /* r1+0x8 */, unsigned char mG /* r1+0x9 */, unsigned char mB /* r1+0xA */, unsigned char mA /* r1+0xB */, unsigned char sR /* r25 */, unsigned char sG /* r26 */, unsigned char sB /* r27 */, unsigned char sA /* r28 */, signed char hilight /* r29 */, unsigned char hR /* r1+0x43 */, unsigned char hG /* r1+0x47 */, unsigned char hB /* r1+0x4B */, unsigned char hA /* r1+0x4F */) {
    // Local variables
    unsigned int i; // r31
}
...
// total size: 0x4
struct /* @class$894xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1032xHierarchyBound_cpp */ {
    // Members
...
union /* @class$1041xHierarchyBound_cpp */ {
...
// Range: 0x80082870 -> 0x80082940
unsigned char xHierarchyBoundTest(const struct xHierarchyBound * bound /* r30 */, struct xSweptSphere * sphere /* r27 */, unsigned short * boundUserData /* r28 */, signed char * subsphere /* r29 */, unsigned char skipMasterCheck /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
}

static struct tweak_callback master_tweaks; // size: 0x28, address: 0x8047DD70
static struct tweak_callback entry_tweaks; // size: 0x28, address: 0x8047DD98
static char __FUNCTION__[30]; // size: 0x1E, address: 0x804F4F1A
// Range: 0x80082940 -> 0x80082B48
void xHierarchyBoundAddDebugTweaks(struct xHierarchyBound * bound /* r31 */, const char * base /* r29 */, const char * * boneNames /* r27 */, int boneCount /* r28 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    unsigned int i; // r30

    // References
    // -> static struct tweak_callback master_tweaks;
    // -> static struct tweak_callback entry_tweaks;
