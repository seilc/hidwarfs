/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xGroup.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80081114 -> 0x80081F1C
*/
// Range: 0x80081114 -> 0x80081144
void xGroupInit(void * b /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5FA30
...
// Range: 0x80081144 -> 0x80081218
void xGroupInit(struct xBase * b /* r27 */, struct xGroupAsset * asset /* r30 */) {
    // Local variables
    struct xGroup * t; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5FA3B
// Range: 0x80081218 -> 0x800813CC
void xGroupSetup(struct xGroup * g /* r31 */) {
    // Local variables
    unsigned int count; // r28
    unsigned int i; // r30
    unsigned int itemID; // r29

    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5FA47
// total size: 0x0
struct xSerial {};
// Range: 0x800813CC -> 0x800814BC
void xGroupSave(struct xGroup * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D5FA52
// Range: 0x800814BC -> 0x800815AC
void xGroupLoad(struct xGroup * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D5FA5D
// Range: 0x800815AC -> 0x80081698
void xGroupReset(struct xGroup * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5FA69
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80081698 -> 0x800819D4
void xGroupEventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r30 */, const float * toParam /* r20 */, struct xBase * toParamWidget /* r21 */, unsigned int toParamWidgetID /* r22 */) {
    // Local variables
    struct xGroup * g; // r31
    int rand; // r27
    unsigned int * idx; // r24
    void (* entVisEventHandler)(struct xEnt *); // r25
    int i; // r26
    struct xBase * b; // r29
    int i; // r28
    struct xBase * b; // r23
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D5FA77
// Range: 0x800819D4 -> 0x80081ABC
unsigned int xGroupGetCount(struct xGroup * g /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D5FA86
// Range: 0x80081ABC -> 0x80081BA4
struct xBase * xGroupGetItemPtr(struct xGroup * g /* r31 */, unsigned int index /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D5FA97
// Range: 0x80081BA4 -> 0x80081D0C
unsigned int xGroupGetItem(struct xGroup * g /* r31 */, unsigned int index /* r29 */) {
    // Local variables
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D5FAA5
// Range: 0x80081D0C -> 0x80081E58
unsigned int xGroupGetAny(struct xGroup * g /* r31 */) {
    // Local variables
    unsigned int * ids; // r30
    unsigned int id; // r29
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x804F4ED8
// Range: 0x80081E58 -> 0x80081F1C
struct xBase * xGroupGetAnyRandomPtr(struct xGroup * g /* r31 */) {
    // Local variables
    unsigned int idx; // r30
