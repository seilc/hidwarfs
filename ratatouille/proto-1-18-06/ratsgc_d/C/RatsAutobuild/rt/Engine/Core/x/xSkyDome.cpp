/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xSkyDome.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800E8694 -> 0x800E8DBC
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct SkyDomeInfo {
    ...
    int sortorder; // offset 0x4, size 0x4
    int lockXZ; // offset 0x8, size 0x4
    int lockY; // offset 0xC, size 0x4
    int zReadWrite; // offset 0x10, size 0x4
};
static struct SkyDomeInfo sSkyList[16]; // size: 0x140, address: 0x80B9D2F0
static int sSkyCount; // size: 0x4, address: 0x80D698E8
// Range: 0x800E8694 -> 0x800E8698
void xSkyDome_EmptyRender() {}

// Range: 0x800E8698 -> 0x800E86A4
void xSkyDome_Setup() {
    // References
    // -> static int sSkyCount;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D60E90
// Range: 0x800E86A4 -> 0x800E8A3C
void xSkyDome_AddEntity(struct xEnt * ent /* r31 */, int sortorder /* r24 */, int lockY /* r1+0x8 */, int lockXZ /* r1+0xC */, int ZReadWrite /* r1+0x10 */) {
    // Local variables
    int index; // r28
    struct SkyDomeInfo & info; // r27
    unsigned char inList; // r26
    int i; // r30
    int j; // r29
    int index; // r25
    ...
    // References
    // -> static int sSkyCount;
    // -> static struct SkyDomeInfo sSkyList[16];
    // -> static char __FUNCTION__[19];
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D698EC
static signed char init; // size: 0x1, address: 0x80D698ED
static unsigned char already_asserted; // size: 0x1, address: 0x80D698EE
static signed char init; // size: 0x1, address: 0x80D698EF
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D60EA3
...
// Range: 0x800E8A3C -> 0x800E8DBC
void xSkyDome_Render() {
    // Local variables
    struct RwCamera * cam; // r29
    struct RwFrame * camframe; // r26
    struct RwMatrixTag * cammat; // r28
    float far_clip; // f31
    int useZBuf; // r27
    int i; // r30
    struct xEnt * ent; // r31
    struct RwV3d oldpos; // r1+0xC
