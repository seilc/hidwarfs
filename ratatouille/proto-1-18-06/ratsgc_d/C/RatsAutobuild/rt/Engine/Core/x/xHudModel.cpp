/*
    ...
    Language: C++
    Code range: 0x80087FAC -> 0x80088464
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D5FBF0
// total size: 0x98
...
struct widget_chunk : public xBase {
    // Members
    class model_widget w; // offset 0x10, size 0x98
};
// Range: 0x80087FAC -> 0x80088174
void model_widget::load(struct xBase & data /* r26 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D5FBF5
// total size: 0x34
struct {} xhud::model_widget::__vtable; // size: 0x34, address: 0x804F5598
// Range: 0x80088174 -> 0x8008824C
// this: r31
model_widget::model_widget(const struct model_asset & a /* r30 */) {
    // References
    // -> static char __FUNCTION__[5];
...
// total size: 0x8
struct /* @class$1114xHudModel_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833xHudModel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834xHudModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835xHudModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836xHudModel_cpp */ {
    // Members
...
// Range: 0x8008824C -> 0x80088274
// this: r1+0x8
void model_widget::destruct() {}

// Range: 0x80088274 -> 0x8008829C
// this: r1+0x8
void model_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80D69248
static signed char init; // size: 0x1, address: 0x80D6924C
// Range: 0x8008829C -> 0x800882DC
...
// Range: 0x800882DC -> 0x80088344
// this: r29
unsigned char model_widget::is(unsigned int id /* r30 */) const {}

// Range: 0x80088344 -> 0x800883C0
// this: r31
void model_widget::update(float dt /* f31 */) {}

// Range: 0x800883C0 -> 0x800883E4
// this: r3
void model_widget::set_params(struct xModelInstance * & model /* r4 */, struct render_context & rc /* r5 */, float xs /* f1 */, float ys /* f2 */, float lx /* f3 */, float ly /* f4 */) {}

// Range: 0x800883E4 -> 0x80088464
// this: r31
