/*
    ...
    Language: C++
    Code range: 0x80240B7C -> 0x80241928
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80240B7C -> 0x80240BCC
static void FunctionGeneratorEventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}
...
// total size: 0x4
struct /* @class$927xFunctionGenerator_cpp */ {
    // Members
...
union /* @class$1066xFunctionGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1065xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$734xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737xFunctionGenerator_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738xFunctionGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739xFunctionGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740xFunctionGenerator_cpp */ {
    // Members
...
// Range: 0x80240BCC -> 0x80240C3C
static void FunctionGeneratorExpandTweaks(const struct tweak_info & info /* r30 */) {
    // Local variables
    class xFunctionGenerator * fg; // r31
...
// Range: 0x80240C3C -> 0x80240C90
static void FunctionGeneratorStartTweak(const struct tweak_info & info /* r30 */) {
    // Local variables
    class xFunctionGenerator * fg; // r31
}

// Range: 0x80240C90 -> 0x80240CC8
static void FunctionGeneratorStopTweak(const struct tweak_info & info /* r30 */) {
    // Local variables
    class xFunctionGenerator * fg; // r31
}
...
static struct tweak_callback cb; // size: 0x28, address: 0x80523E88
static signed char init; // size: 0x1, address: 0x80D6B100
// Range: 0x80240CC8 -> 0x80240E08
// this: r31
xFunctionGenerator::xFunctionGenerator(const struct xFunctionGeneratorAsset * asset /* r30 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65038
// Range: 0x80240E08 -> 0x80241224
// this: r31
void xFunctionGenerator::Update(float dt /* r1+0x8 */) {
    // Local variables
    float t; // f30
    float t; // f29
    float t; // f28
...
// Range: 0x80241224 -> 0x80241320
// this: r31
void xFunctionGenerator::HandleEvent(unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */) {}

// Range: 0x80241320 -> 0x8024136C
// this: r3
void xFunctionGenerator::Start() {}

// Range: 0x8024136C -> 0x80241378
// this: r3
void xFunctionGenerator::Stop() {}

// Range: 0x80241378 -> 0x80241384
// this: r3
void xFunctionGenerator::Reset() {}

static struct tweak_callback cb1; // size: 0x28, address: 0x80523EB0
static signed char init; // size: 0x1, address: 0x80D6B101
static struct tweak_callback cb2; // size: 0x28, address: 0x80523ED8
static signed char init; // size: 0x1, address: 0x80D6B102
// Range: 0x80241384 -> 0x802418DC
// this: r29
void xFunctionGenerator::AddTweaks(const char * base /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x58
    struct xFunctionGeneratorAsset * ncasset; // r30

    // References
    // -> static struct tweak_callback cb2;
    // -> static signed char init;
    // -> static struct tweak_callback cb1;
    // -> static signed char init;
}

// Range: 0x802418DC -> 0x80241928
void xFunctionGenerator_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}
