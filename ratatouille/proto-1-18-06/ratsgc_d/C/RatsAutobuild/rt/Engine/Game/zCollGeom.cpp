/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCollGeom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80133180 -> 0x80133860
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zCollGeomTable {
    // Members
    struct RpAtomic * baseModel; // offset 0x0, size 0x4
    struct RpAtomic * colModel[1]; // offset 0x4, size 0x4
    struct RpAtomic * camcolModel; // offset 0x8, size 0x4
};
// total size: 0x8
struct zCollisionGeomTableEntry {
    // Members
    unsigned int sTableCount; // offset 0x0, size 0x4
    struct zCollGeomTable * sTableList; // offset 0x4, size 0x4
};
static struct zCollisionGeomTableEntry sCollisionGeomTable[20]; // size: 0xA0, address: 0x80CF0AC0
static unsigned int sCollisionGeomTableCount; // size: 0x4, address: 0x80D69E98
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D61F08
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1053zCollGeom_cpp */ {
    // Members
...
// Range: 0x80133180 -> 0x80133414
unsigned int zCollGeom_EntSetup(struct xEnt * ent /* r31 */) {
    // Local variables
    unsigned int i; // r29
    unsigned int j; // r27
    unsigned char auto_cam_coll; // r26
    struct zCollGeomTable * tableList; // r28
    struct RpAtomic * imodel; // r30
    struct xModelInstance * model; // r25
    struct xModelInstance * model; // r24

    // References
    // -> static unsigned int sCollisionGeomTableCount;
    // -> static struct zCollisionGeomTableEntry sCollisionGeomTable[20];
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D61F1B
// Range: 0x80133414 -> 0x8013383C
void zCollGeom_Init() {
    // Local variables
    ...
    unsigned int k; // r31
    void * data; // r27
    unsigned int hash; // r28
    unsigned int aid; // r26
...
// Range: 0x8013383C -> 0x80133854
void zCollGeom_CamEnable(struct xEnt * ent /* r3 */) {}

// Range: 0x80133854 -> 0x80133860
void zCollGeom_CamDisable(struct xEnt * ent /* r3 */) {}
