/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFlameEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80167CE0 -> 0x801698C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float rand_offset; // size: 0x4, address: 0x80D6A170
static float oscil_rate; // size: 0x4, address: 0x80D62B68
// Range: 0x80167CE0 -> 0x80167D60
...
struct zFlameEmitter * hilighted; // size: 0x4, address: 0x80D6A174
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80167D60 -> 0x80167E18
// this: r31
void zFlameEmitter::load(const struct asset_type & a /* r30 */) {}

// Range: 0x80167E18 -> 0x80167E68
// this: r31
void zFlameEmitter::debug_reset() {}

// Range: 0x80167E68 -> 0x80167EB4
// this: r31
void zFlameEmitter::reset() {}

// Range: 0x80167EB4 -> 0x80167EFC
// this: r31
void zFlameEmitter::hide() {}

// Range: 0x80167EFC -> 0x80167F48
// this: r31
void zFlameEmitter::show() {}

// Range: 0x80167F48 -> 0x80167F94
// this: r31
void zFlameEmitter::spawn() {}

// Range: 0x80167F94 -> 0x80167FDC
// this: r31
void zFlameEmitter::kill() {}

// Range: 0x80167FDC -> 0x8016804C
// this: r31
void zFlameEmitter::update(float dt /* r1+0x8 */) {
    // References
    // -> static float oscil_rate;
}

// Range: 0x8016804C -> 0x80168074
// this: r1+0x8
void zFlameEmitter::render() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D62B6C
// Range: 0x80168074 -> 0x8016822C
void zFlameEmitter::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x8016823C -> 0x801682AC
// this: r31
void zFlameEmitter::get_bounding_box(struct xBox & box /* r1+0x8 */) const {
    // Local variables
    struct xBox obb; // r1+0xC
}
...
// Range: 0x801683C0 -> 0x80168430
void zFlameEmitter::update_all(float dt /* r1+0x8 */) {
    // Local variables
    struct zScene & scene; // r30
    struct zFlameEmitter * it; // r31
    struct zFlameEmitter * end; // r29
...
// Range: 0x80168500 -> 0x80168564
// this: r31
void zFlameEmitter::refresh_mat() {}

// Range: 0x80168564 -> 0x80168620
// this: r31
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D62B71
...
// Range: 0x801686A4 -> 0x80168CCC
// this: r31
void zFlameEmitter::create_flames(int flags /* r1+0x8 */) {
    // Local variables
    float radius; // f28
    float width; // f31
    int ux; // r30
    int uz; // r29
    struct spawn_data sd; // r1+0x40
    const struct xVec3 & center; // r28
    struct xVec3 dx; // r1+0x34
    struct xVec3 dz; // r1+0x28
    float hx; // f30
    float hz; // f29
    float rr; // f27
    struct xVec3 corner; // r1+0x1C
    struct handle * flame; // r27
    struct handle * const end_flame; // r24
    unsigned int ix; // r26
    struct xVec3 v; // r1+0x10
    unsigned int iz; // r25
...
// Range: 0x80168CCC -> 0x80168D74
// this: r31
void zFlameEmitter::destroy_flames() {
    // Local variables
    struct handle * flame; // r30
    struct handle * end_flame; // r29

    // References
    // -> class xSpacePartitionTree2D space_tree;
}

// Range: 0x80168D74 -> 0x80168DC4
// this: r31
void zFlameEmitter::dump_flames() {}

// Range: 0x80168DC4 -> 0x80168E28
// this: r31
void zFlameEmitter::start_flames_sound() {}

// Range: 0x80168E28 -> 0x80168E80
// this: r31
void zFlameEmitter::end_flames_sound() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D62B7F
// Range: 0x80168E80 -> 0x80169054
void zFlameEmitter::cb_dispatch(struct xBase * to /* r30 */, unsigned int event /* r1+0x8 */, const float * argf /* r29 */) {
    // Local variables
...
// Range: 0x80169054 -> 0x801690A0
// this: r31
void zFlameEmitter::debug_init() {}

// Range: 0x801690A0 -> 0x80169148
// this: r31
...
// total size: 0xC
struct /* @class$734zFlameEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zFlameEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zFlameEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zFlameEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zFlameEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zFlameEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zFlameEmitter_cpp */ {
    // Members
...
static struct tweak_callback cb_hilight; // size: 0x28, address: 0x804A88A8
static struct tweak_callback cb_visible; // size: 0x28, address: 0x804A88D0
static struct tweak_callback cb_move; // size: 0x28, address: 0x804A88F8
static struct tweak_callback cb_move_dir; // size: 0x28, address: 0x804A8920
static struct tweak_callback cb_refresh_props; // size: 0x28, address: 0x804A8948
static struct tweak_callback cb_update_flame_heat; // size: 0x28, address: 0x8051EC70
static signed char init; // size: 0x1, address: 0x80D6A178
// Range: 0x80169148 -> 0x801694FC
// this: r31
...
enum /* @enum$1802zFlameEmitter_cpp */ {
    FLAG_GROUND = 1,
    FLAG_VISIBLE = 2,
    FLAG_DRAW_GROUND = 4,
    FLAG_DRAW_SHORT = 8,
};
// Range: 0x801694FC -> 0x80169508
void zFlameEmitter::enable_hilight(const struct tweak_info & info /* r3 */) {
    // References
    // -> struct zFlameEmitter * hilighted;
}

// Range: 0x80169508 -> 0x80169514
void zFlameEmitter::disable_hilight() {
    // References
    // -> struct zFlameEmitter * hilighted;
}

// Range: 0x80169514 -> 0x8016956C
void zFlameEmitter::on_change_visible(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct zFlameEmitter * f; // r31
}

// Range: 0x8016956C -> 0x801695FC
void zFlameEmitter::on_move(const struct tweak_info & info /* r29 */) {
    // Local variables
    struct zFlameEmitter * f; // r30
    struct asset_type & a; // r31
}

// Range: 0x801695FC -> 0x80169624
void zFlameEmitter::tweak_rtod(void * value /* r4 */) {
    // Local variables
    float & f; // r31
}

// Range: 0x80169624 -> 0x8016964C
void zFlameEmitter::tweak_dtor(void * value /* r4 */) {
    // Local variables
    float & f; // r31
}

// Range: 0x8016964C -> 0x80169850
// this: r31
...
// total size: 0x4
struct /* @class$1110zFlameEmitter_cpp */ {
    // Members
...
union /* @class$1018zFlameEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1257zFlameEmitter_cpp */ {
    // Members
...
// Range: 0x80169850 -> 0x80169888
void zFlameEmitter::on_update_flame_heat(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct zFlameEmitter * f; // r31
}

// Range: 0x80169888 -> 0x801698C0
void zFlameEmitter::on_refresh_props(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct zFlameEmitter * f; // r31
}
