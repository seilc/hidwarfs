/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zTransientModel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80255880 -> 0x80257B20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float repeat_every; // size: 0x4, address: 0x80D65458
// Range: 0x80255880 -> 0x802558DC
...
static class module_type * module; // size: 0x4, address: 0x80D6B1A8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
union /* @class$1059zTransientModel_cpp */ {
...
// total size: 0x10
struct /* @class$1072zTransientModel_cpp */ {
    // Members
...
// Range: 0x802558DC -> 0x802558F0
static void get_scene_parameters(int & emitters_max /* r3 */, int & instances_max /* r4 */) {
    // References
    // -> struct zGlobals globals;
}

// total size: 0x1
struct /* @class$2087zTransientModel_cpp */ {
    // Members
    unsigned char foo; // offset 0x0, size 0x1
};
// total size: 0x4C
struct /* @class$2088zTransientModel_cpp */ {
    // Members
    class zTransientModelEmitter emitter; // offset 0x0, size 0x4
    struct config_type cfg; // offset 0x4, size 0x44
    float repeat_time; // offset 0x48, size 0x4
};
// total size: 0x4C
struct debug_info {
    // Members
    ...
    struct /* @class$2088zTransientModel_cpp */ {
        ...
        struct config_type cfg; // offset 0x4, size 0x44
        float repeat_time; // offset 0x48, size 0x4
    } test; // offset 0x0, size 0x4C
};
// total size: 0x3C
class module_type {
    // Functions
    static module_type(int emitters_max, int instances_max, unsigned char tweak_alloc);
    ...
    static struct node_type * destroy_instance(struct node_type * it);

    static void fade_away(struct node_type * it, float time, float alpha_scale);
    ...
    class linear_pool activities; // offset 0x4, size 0xC
    class pool_list instances; // offset 0x10, size 0x20
    struct node_type * fade_head; // offset 0x30, size 0x4
    int fade_active; // offset 0x34, size 0x4
    struct debug_info * debug; // offset 0x38, size 0x4
};
// Range: 0x802558F0 -> 0x802559D0
// this: r31
static module_type::module_type(int emitters_max /* r28 */, int instances_max /* r29 */, unsigned char tweak_alloc /* r1+0x8 */) {}

// total size: 0x1
struct /* @class$2086zTransientModel_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$894zTransientModel_cpp */ {
    // Members
...
struct transient_instance {
    ...
    float alpha_scale; // offset 0x4, size 0x4
    struct xModelInstance * model; // offset 0x8, size 0x4
    class zTransientModelEmitter * owner; // offset 0xC, size 0x4
    union entry_data * space_entry; // offset 0x10, size 0x4
};
// total size: 0x1C
struct node_type {
    // Members
    ...
    struct transient_instance value; // offset 0x8, size 0x14
};
// total size: 0x170
struct activity_data {
    ...
    class zTransientModelEmitter * owner; // offset 0x44, size 0x4
    const struct config_type * cfg; // offset 0x48, size 0x4
    unsigned int model_ids[8]; // offset 0x4C, size 0x20
    struct RpAtomic * models[8]; // offset 0x6C, size 0x20
    struct xBox model_bounds[8]; // offset 0x8C, size 0xC0
    int models_size; // offset 0x14C, size 0x4
    struct node_type * head; // offset 0x150, size 0x4
    struct node_type * tail; // offset 0x154, size 0x4
    int active; // offset 0x158, size 0x4
    float intensity_range; // offset 0x15C, size 0x4
    float scale_range; // offset 0x160, size 0x4
    float fade_in_alpha_scale; // offset 0x164, size 0x4
    float fade_out_alpha_scale; // offset 0x168, size 0x4
};
// total size: 0xC
class linear_pool {
    // Members
    ...
    struct activity_data * _buffer; // offset 0x8, size 0x4
};
// total size: 0x20
class pool_list : public pool_list_base {};
// Range: 0x802559D0 -> 0x80255A7C
// this: r31
...
// Range: 0x80255A7C -> 0x80255B78
// this: r31
static void module_type::update(float dt /* f31 */) {
    // Local variables
    struct activity_data * act; // r28
    struct activity_data * end_act; // r26
    struct node_type * it; // r30
    int i; // r27
    int end; // r25
    struct transient_instance & inst; // r29
    float alpha; // r1+0x8
}

// Range: 0x80255B78 -> 0x80255C08
// this: r29
static void module_type::render() {
    // Local variables
    struct activity_data * act; // r30
    struct activity_data * end_act; // r26
    struct node_type * it; // r28
    int i; // r27
    int end; // r25
    struct transient_instance & inst; // r31
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6545C
union entry_node {
...
// Range: 0x80255C08 -> 0x80255C8C
// this: r1+0x8
static struct node_type * module_type::destroy_instance(struct node_type * it /* r30 */) {
    // Local variables
    struct transient_instance & inst; // r31
...
char __FUNCTION__$localstatic1$move__64pool_list<Q229@unnamed@zTransientModel_cpp@18transient_instance>FPQ264pool_list<Q229@unnamed@zTransientModel_cpp@18transient_instance>9node_typePQ264pool_list<Q229@unnamed@zTransientModel_cpp@18transient_instance>9node_type[5]; // size: 0x5, address: 0x80D6546D
// Range: 0x80255C8C -> 0x80255D50
// this: r30
static void module_type::fade_away(struct node_type * it /* r29 */, float time /* r1+0x8 */, float alpha_scale /* r1+0xC */) {
    // Local variables
    struct transient_instance & inst; // r31
...
// Range: 0x80255D50 -> 0x80255DE4
static struct node_type * module_type::fade_away(struct activity_data & act /* r31 */, struct node_type * it /* r30 */) {
    // Local variables
    struct node_type * dead; // r29
...
// total size: 0xC
struct /* @class$778zTransientModel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$779zTransientModel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$780zTransientModel_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$781zTransientModel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$782zTransientModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$783zTransientModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$784zTransientModel_cpp */ {
    // Members
...
static struct tweak_callback cb_test_spawn; // size: 0x28, address: 0x804C4C28
// Range: 0x80255DE4 -> 0x80255E44
static void module_type::add_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static struct tweak_callback cb_test_spawn;
}

static unsigned int test_models[2]; // size: 0x8, address: 0x80D65474
// Range: 0x80255E44 -> 0x80255F04
// this: r31
static void module_type::debug_init() {
    // References
    // -> static unsigned int test_models[2];
}
...
class zTransientModelEmitter {
    ...
    void spawn(const struct xMat4x3 & mat, float fade_in_time, unsigned int flags);
...
// total size: 0x890
struct /* @class$2019zTransientModel_cpp */ {
    // Static members
...
// Range: 0x80256078 -> 0x8025613C
static void module_type::on_test_spawn() {
    // Local variables
...
// Range: 0x8025613C -> 0x80256220
void zTransientModelSceneEnter() {
    // Local variables
    int emitters_max; // r1+0xC
    int instances_max; // r1+0x8

    // References
    // -> static class module_type * module;
}

// Range: 0x80256220 -> 0x8025622C
void zTransientModelSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025622C -> 0x8025625C
void zTransientModelReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025625C -> 0x80256294
void zTransientModelUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x80256294 -> 0x802562C4
void zTransientModelRender() {
    // References
    // -> static class module_type * module;
}

// Range: 0x802562C4 -> 0x80256350
void zTransientModelEmitter::set_default_config(struct config_type & cfg /* r3 */) {}

// Range: 0x80256350 -> 0x8025635C
// this: r3
void zTransientModelEmitter::create() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6547C
// Range: 0x8025635C -> 0x80256458
// this: r31
int zTransientModelEmitter::size() const {
    // References
    // -> static char __FUNCTION__[5];
    // -> static class module_type * module;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65481
// Range: 0x80256458 -> 0x802565A0
// this: r31
void zTransientModelEmitter::activate(const struct config_type & cfg /* r30 */) {
    // References
    // -> static class module_type * module;
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6548A
// Range: 0x802565A0 -> 0x802566A8
// this: r31
void zTransientModelEmitter::deactivate() {
    // References
    // -> static char __FUNCTION__[11];
    // -> static class module_type * module;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65495
// Range: 0x802566A8 -> 0x80256ABC
// this: r31
void zTransientModelEmitter::set_config(const struct config_type & cfg /* r30 */) {
    // Local variables
    int i; // r29
    struct xBox & box; // r28
...
// total size: 0xC
struct /* @class$1579zTransientModel_cpp */ {
    // Members
...
// Range: 0x80256ABC -> 0x80256BB8
static unsigned char HitsScene(const struct xVec3 & corner /* r1+0x8 */, const struct xMat4x3 & mat /* r30 */) {
    // Local variables
    struct xVec3 pos; // r1+0xC
    struct xCollis coll; // r1+0x3C
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D654A0
// total size: 0x18
struct cb_check_overlap {
    // Functions
    static cb_check_overlap(class zTransientModelEmitter * owner, const struct xVec3 & center, float radius, int hits);

    static unsigned char operator()(union entry_data * e);

    // Members
    class zTransientModelEmitter * owner; // offset 0x0, size 0x4
    struct xVec3 center; // offset 0x4, size 0xC
    float radius2; // offset 0x10, size 0x4
    int hits; // offset 0x14, size 0x4
};
// Range: 0x80256BB8 -> 0x80257210
// this: r31
void zTransientModelEmitter::spawn(const struct xMat4x3 & mat /* r27 */, float fade_in_time /* f29 */, unsigned int flags /* r1+0x8 */) {
    // Local variables
    struct cb_check_overlap cb; // r1+0x18
    int model_index; // r26
    int start_model_index; // r20
    unsigned char found; // r22
    struct xBox & box; // r30
    struct xVec3 corner; // r1+0xC
    struct xModelInstance * model; // r29
    struct transient_instance & inst; // r28
    float scale; // f31
    struct xMat4x3 & model_mat; // r23
    float & radius; // r24
    struct xVec3 & center; // r25
    float intensity; // f30
...
// Range: 0x80257210 -> 0x8025723C
// this: r3
static cb_check_overlap::cb_check_overlap(class zTransientModelEmitter * owner /* r4 */, const struct xVec3 & center /* r5 */, float radius /* f1 */, int hits /* r6 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D654A6
// Range: 0x8025723C -> 0x80257380
// this: r30
void zTransientModelEmitter::update(float dt /* f30 */) {
    // Local variables
    float max_life; // f31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D654AD
// Range: 0x80257380 -> 0x80257588
// this: r30
...
char __FUNCTION__$localstatic1$push_back__54linear_pool<Q222zTransientModelEmitter13activity_data>Fv[10]; // size: 0xA, address: 0x80D654B4
char __FUNCTION__$localstatic1$back__54linear_pool<Q222zTransientModelEmitter13activity_data>Fv[5]; // size: 0x5, address: 0x80D654BE
// Range: 0x80257588 -> 0x802575BC
struct activity_data * zTransientModelEmitter::alloc_activity() {
    // References
    // -> static class module_type * module;
}

char __FUNCTION__$localstatic1$erase__54linear_pool<Q222zTransientModelEmitter13activity_data>FPQ222zTransientModelEmitter13activity_data[6]; // size: 0x6, address: 0x80D654C3
// Range: 0x802575BC -> 0x8025760C
void zTransientModelEmitter::free_activity(struct activity_data * v /* r31 */) {
    // References
    // -> static class module_type * module;
}
...
struct config_type {
    // Members
    int max_active; // offset 0x0, size 0x4
    int overlap_max; // offset 0x4, size 0x4
    float overlap_radius; // offset 0x8, size 0x4
    float kill_dist; // offset 0xC, size 0x4
    float fade_in_time; // offset 0x10, size 0x4
    float fade_out_time; // offset 0x14, size 0x4
    float max_life; // offset 0x18, size 0x4
    ...
    struct _xFColor color; // offset 0x2C, size 0x10
    const unsigned int * models; // offset 0x3C, size 0x4
    int models_size; // offset 0x40, size 0x4
};
// Range: 0x8025760C -> 0x80257A2C
void zTransientModelEmitter::add_config_tweaks(const char * prefix /* r28 */, struct config_type & cfg /* r31 */, const struct tweak_callback * cb /* r30 */, void * context /* r29 */) {
    // Local variables
    const struct tweak_callback * cb_convert_degrees; // r25
    const char * * model_labels; // r1+0x18
    const unsigned int * model_ids; // r1+0x14
    unsigned int models; // r26
    int i; // r27
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D654C9
// Range: 0x80257A2C -> 0x80257B20
// this: r3
static unsigned char cb_check_overlap::operator()(union entry_data * e /* r4 */) {
    // Local variables
    struct node_type * it; // r30
    const struct xVec3 & loc; // r31
    float dx; // f31
    float dy; // f30
    float dz; // f29
    float dist2; // f28
