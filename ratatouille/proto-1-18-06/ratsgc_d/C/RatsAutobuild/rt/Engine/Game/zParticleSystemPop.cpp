/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemPop.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028584C -> 0x80286A60
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zParticleLocator * sLocatorPool; // size: 0x4, address: 0x80D6B350
static int sLocatorsUsed; // size: 0x4, address: 0x80D6B354
// total size: 0x8
...
// total size: 0x24
class zParticleSystemPop : public zParticleSystem {
    // Functions
...
// Range: 0x8028584C -> 0x802858C0
// this: r1+0x8
struct zParticleGenerator * zParticleSystemPop::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorPop * gen; // r30
}

// Range: 0x802858FC -> 0x80285948
// this: r1+0x8
void zParticleSystemPop::scene_enter() {
    // References
    // -> static int sLocatorsUsed;
    // -> static class zParticleLocator * sLocatorPool;
}

// Range: 0x80285948 -> 0x8028595C
void zParticleSystemPop::scene_exit() {
    // References
    // -> static int sLocatorsUsed;
    // -> static class zParticleLocator * sLocatorPool;
}

// Range: 0x8028595C -> 0x8028598C
// this: r1+0x8
void zParticleSystemPop::update(float dt /* r1+0xC */) {}
...
// Range: 0x8028598C -> 0x80285994
int zParticleSystemPop::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65C40
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$840zParticleSystemPop_cpp */ {
    // Members
...
struct particle_instance {
    ...
    float age; // offset 0xC, size 0x4
    struct xVec3 vel; // offset 0x10, size 0xC
    unsigned int flags; // offset 0x1C, size 0x4
    float rotation; // offset 0x20, size 0x4
    float rotSpeed; // offset 0x24, size 0x4
    float pad[2]; // offset 0x28, size 0x8
};
// total size: 0x1C
struct asset_data {
    // Members
    float gravity; // offset 0x0, size 0x4
    float drift; // offset 0x4, size 0x4
    float outVel; // offset 0x8, size 0x4
    float size; // offset 0xC, size 0x4
    float rotSpeed; // offset 0x10, size 0x4
    float lifetime; // offset 0x14, size 0x4
    float maxAlpha; // offset 0x18, size 0x4
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x80285994 -> 0x80285D9C
int zParticleSystemPop::update_particles(unsigned char * mem /* r19 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f22 */, void * context /* r20 */) {
    // Local variables
    ...
    struct particle_instance * end; // r22
    struct zParticleGeneratorPop & g; // r21
    struct asset_data & a; // r25
    float size; // f31
    float lifetime; // f21
    float maxAlpha; // f20
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65C51
...
// total size: 0x160
struct zParticleGeneratorPop : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemPop & system, struct zParticleAsset & asset);

    void reset();

    void activate(struct xEnt * ent);

    void activateEnt(struct xEnt * ent);

    void deactivate(struct xEnt * ent);

    void deactivateEnt(struct xEnt * ent);
    ...
    // Static members
    static int MAX_LOCATORS; // size: 0x4

    // Members
protected:
    class zParticleSystemPop * system; // offset 0xA4, size 0x4
    struct xEnt * attach_to; // offset 0xA8, size 0x4
    float emitted; // offset 0xAC, size 0x4
    class zParticleLocator * locators[40]; // offset 0xB0, size 0xA0
    int numLocators; // offset 0x150, size 0x4
    int batch_id; // offset 0x154, size 0x4
    struct debug debugInfo; // offset 0x158, size 0x8
};
// Range: 0x80285D9C -> 0x8028605C
// this: r31
void zParticleGeneratorPop::update(float dt /* f27 */) {
    // Local variables
    int i; // r26
    class zParticleLocator * locator; // r24
...
// Range: 0x8028605C -> 0x8028618C
// this: r31
void zParticleGeneratorPop::create(class zParticleSystemPop & system /* r27 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    int i; // r29
    struct xParticleBatchSystem batch; // r1+0xC
    const struct asset_data & a; // r1+0x8
}

// Range: 0x8028618C -> 0x80286214
// this: r31
void zParticleGeneratorPop::reset() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D65C58
// Range: 0x80286214 -> 0x80286320
class zParticleLocator * allocLocator() {
    // Local variables
    class zParticleLocator * locator; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65C65
// Range: 0x80286320 -> 0x802863FC
void freeLocator(class zParticleLocator * locator /* r31 */) {
    // Local variables
    class zParticleLocator * tailLocator; // r30
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65C71
// Range: 0x80286418 -> 0x80286504
// this: r31
void zParticleGeneratorPop::activate(struct xEnt * ent /* r30 */) {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x80286504 -> 0x8028658C
// this: r31
void zParticleGeneratorPop::activateEnt(struct xEnt * ent /* r29 */) {
    // Local variables
    class zParticleLocator * locator; // r30
}

// Range: 0x8028658C -> 0x80286644
// this: r31
void zParticleGeneratorPop::deactivate(struct xEnt * ent /* r28 */) {
    // Local variables
    int i; // r30
    class zParticleLocator * locator; // r29
}

// Range: 0x80286644 -> 0x80286758
// this: r31
void zParticleGeneratorPop::deactivateEnt(struct xEnt * ent /* r1+0x8 */) {
    // Local variables
    int i; // r30
    class zParticleLocator * locator; // r29
    class zParticleLocator * tailLocator; // r28
...
// Range: 0x80286758 -> 0x802869D4
// this: r31
void zParticleGeneratorPop::add_tweaks(const char * prefix /* r30 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    struct asset_data & a; // r29
}

// Range: 0x802869D4 -> 0x80286A60
// this: r30
void zParticleGeneratorPop::debug_render(unsigned char all /* r28 */) {
    // Local variables
    int i; // r31
    class zParticleLocator * locator; // r29
}
...
// total size: 0x4
struct /* @class$1158zParticleSystemPop_cpp */ {
    // Members
...
union /* @class$827zParticleSystemPop_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$776zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemPop_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemPop_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemPop_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemPop_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0x2C
struct {} zParticleGeneratorPop::__vtable; // size: 0x2C, address: 0x805251B8
// total size: 0x0
struct debug_info {};
// total size: 0xA4
...
// total size: 0x3C
struct {} zParticleSystemPop::__vtable; // size: 0x3C, address: 0x805251E4
// total size: 0x8
