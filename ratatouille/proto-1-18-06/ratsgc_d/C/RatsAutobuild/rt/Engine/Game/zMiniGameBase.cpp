/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80303150 -> 0x80303B94
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zMiniGameBase * currentMiniGame; // size: 0x4, address: 0x80D6B818
// total size: 0x7C
struct {} zMiniGameBase::__vtable; // size: 0x7C, address: 0x8052A5F4
// total size: 0x20
struct xLinkAsset {
    // Members
...
class zMiniGameBase : public xBase {
    // Functions
    zMiniGameBase(struct zMiniGameAsset * a);

    void SceneSetup();

    void SwitchGameState(enum eMiniGameState newState);
...
// Range: 0x80303150 -> 0x803031A0
// this: r31
zMiniGameBase::zMiniGameBase(struct zMiniGameAsset * a /* r30 */) {
    // References
    // -> class zMiniGameBase * currentMiniGame;
    // -> struct [anonymous] zMiniGameBase::__vtable;
}
...
// total size: 0x4
struct /* @class$932zMiniGameBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1093zMiniGameBase_cpp */ {
    // Members
...
union /* @class$1069zMiniGameBase_cpp */ {
...
// total size: 0x10
struct /* @class$1629zMiniGameBase_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1872zMiniGameBase_cpp */ {
    // Static members
...
// Range: 0x803031A0 -> 0x80303204
// this: r31
void zMiniGameBase::SceneSetup() {
    // Local variables
    struct zScene * s; // r30
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D672C0
// Range: 0x80303204 -> 0x80303284
class zMiniGameBase * zMiniGameBase::GetGame() {
    // References
    // -> class zMiniGameBase * currentMiniGame;
...
// Range: 0x80303284 -> 0x80303400
// this: r31
void zMiniGameBase::SwitchGameState(enum eMiniGameState newState /* r1+0x8 */) {}

// Range: 0x80303400 -> 0x803034EC
// this: r31
void zMiniGameBase::Update(float dt /* f31 */) {}

// total size: 0x7C
struct {} zMiniGameType1::__vtable; // size: 0x7C, address: 0x8052A578
// total size: 0x30
class zMiniGameType1 : public zMiniGameBase {
    // Functions
    zMiniGameType1(struct zMiniGameAsset * a);
    ...
    // Members
    int yourWorth; // offset 0x2C, size 0x4
};
// Range: 0x803034EC -> 0x80303538
// this: r31
zMiniGameType1::zMiniGameType1(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGameType1::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D672C8
// Range: 0x80303538 -> 0x803037B8
void zMiniGameType1::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zMiniGameType1 * instance; // r28
...
// Range: 0x803037B8 -> 0x803037EC
// this: r31
void zMiniGameType1::SceneSetup() {}

// total size: 0x18
struct zMiniGameAssetType1 : public zMiniGameAsset {
    // Members
    int num; // offset 0x14, size 0x4
};
// total size: 0x4
struct xColor_tag {
    // Members
...
// Range: 0x803037EC -> 0x80303914
// this: r29
void zMiniGameType1::Update() {
    // Local variables
    struct xTimer * timer; // r31
    const struct xMat4x3 & cammat; // r30
    float sec; // f31
    struct xVec3 txtPos; // r1+0xC
    char messageTxt[128]; // r1+0x18

    // References
    // -> struct xColor_tag g_GREEN;
}

// Range: 0x80303914 -> 0x80303918
void zMiniGameType1::Render() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D672CD
// Range: 0x80303918 -> 0x80303A48
float GetAngleDiff(const struct xVec3 * startDir /* r30 */, const struct xVec3 * endDir /* r31 */) {
    // Local variables
    float angle_caller; // f31
    float angle_true; // f30
...
// Range: 0x80303A48 -> 0x80303B94
float ApplyAngleDiff(struct xMat3x3 * mat /* r31 */, float angle_difference /* f29 */, float dt /* f30 */, float turning_speed /* f31 */) {
    // Local variables
    float delta_angle; // f28
    struct xMat3x3 drot; // r1+0x10
