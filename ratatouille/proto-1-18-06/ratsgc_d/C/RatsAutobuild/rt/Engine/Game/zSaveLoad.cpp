/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSaveLoad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801A0690 -> 0x801A7738
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int saveSuccess; // size: 0x4, address: 0x80D6A740
static float saveload_time_elapsed; // size: 0x4, address: 0x80D63588
static float saveload_time_last; // size: 0x4, address: 0x80D6A744
static float saveload_time_current; // size: 0x4, address: 0x80D6A748
static int currentCard; // size: 0x4, address: 0x80D6358C
static int currentGame; // size: 0x4, address: 0x80D63590
static int saveLoadPromptSel; // size: 0x4, address: 0x80D6A74C
static int badCard; // size: 0x4, address: 0x80D6A750
static unsigned int startSceneID; // size: 0x4, address: 0x80D6A754
static int sAvailable; // size: 0x4, address: 0x80D6A758
static int sNeeded; // size: 0x4, address: 0x80D6A75C
static int sAccessType; // size: 0x4, address: 0x80D6A760
static float dontPoll; // size: 0x4, address: 0x80D63594
int autoSaveCard; // size: 0x4, address: 0x80D63598
int prevSelectCard; // size: 0x4, address: 0x80D6359C
int prevSelectGame; // size: 0x4, address: 0x80D635A0
static unsigned char sIsLoading; // size: 0x1, address: 0x80D635A4
static int loadState; // size: 0x4, address: 0x80D6A764
static int saveState; // size: 0x4, address: 0x80D6A768
static char currSceneStr[32]; // size: 0x20, address: 0x8051FCF8
static char sceneRead[32]; // size: 0x20, address: 0x8051FD18
int g_promptUserSelection; // size: 0x4, address: 0x80D635A8
// total size: 0xC
struct zSaveLoadUI {
    // Members
...
struct zSaveLoadUI zSaveLoadUITable[73]; // size: 0x36C, address: 0x8051FD38
// total size: 0x6C
struct zSaveLoadGame {
    // Members
    char label[64]; // offset 0x0, size 0x40
    char date[32]; // offset 0x40, size 0x20
    int progress; // offset 0x60, size 0x4
    unsigned int size; // offset 0x64, size 0x4
    char thumbIconIndex; // offset 0x68, size 0x1
};
struct zSaveLoadGame zSaveLoadGameTable[3]; // size: 0x144, address: 0x80D01530
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1054zSaveLoad_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1638zSaveLoad_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801A0690 -> 0x801A0728
static void WaitAndSpin(float sec /* r1+0x8 */) {
    // Local variables
    long long startTime; // r30
    long long now; // r28
    struct XSGAutoData * autodata; // r27
...
// total size: 0x10
class zUICustomSaveLoadManager : public zUICustom {
    // Members
public:
    class zUIText * backText; // offset 0x8, size 0x4
    class zUIText * selectText; // offset 0xC, size 0x4
};
class zUICustomSaveLoadManager * pUICustomSaveLoadManager; // size: 0x4, address: 0x80D6B710
// Range: 0x801A0728 -> 0x801A07F8
static void zUI_SysMessage(int msgType /* r1+0x8 */, unsigned int event /* r1+0xC */, unsigned char delay /* r1+0x10 */) {
    // Local variables
    float toParams[4]; // r1+0x14

    // References
    // -> class zUICustomSaveLoadManager * pUICustomSaveLoadManager;
    // -> struct zSaveLoadUI zSaveLoadUITable[73];
}

// Range: 0x801A07F8 -> 0x801A08B4
static void zUI_SysMessageID(int msgType /* r1+0x8 */, unsigned int msgID /* r1+0xC */, unsigned char delay /* r1+0x10 */) {
    // Local variables
    float toParams[4]; // r1+0x14
...
// Range: 0x801A08B4 -> 0x801A09C4
static void UnselectGameSlot(unsigned char resetMotion /* r28 */) {
    // Local variables
    class zUI * gc0; // r31
    class zUI * gc1; // r30
    class zUI * gc2; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D635AC
...
// Range: 0x801A09C4 -> 0x801A0D28
void zSaveLoad_Tick() {
    // Local variables
    unsigned char showTRCMessage; // r31
    int startidx; // r28
    int trccount; // r30
    struct xMat4x3 playerMat; // r1+0x20
    struct xVec3 playerVel; // r1+0x10
    ...
    // -> static float saveload_time_elapsed;
    // -> float sTimeElapsed;
    ...
    // -> long long sTimeLast;
    // -> static float saveload_time_current;
    // -> static float saveload_time_last;
    // -> static float dontPoll;
...
// total size: 0x1
struct /* @class$834zSaveLoad_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$835zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$836zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$837zSaveLoad_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1881zSaveLoad_cpp */ {
    // Static members
...
// Range: 0x801A0D28 -> 0x801A0DB0
unsigned int zSaveLoad_poll(int retValue /* r1+0x8 */) {
    // Local variables
    int val; // r30
    struct XSGAutoData * autodata; // r31

    // References
    // -> static int currentGame;
    // -> static int saveLoadPromptSel;
    // -> static int currentCard;
    // -> static float dontPoll;
}

// Range: 0x801A0DB0 -> 0x801A0DE4
void zSaveLoadInit() {
    // References
    // -> struct zSaveLoadGame zSaveLoadGameTable[3];
    // -> struct zSaveLoadUI zSaveLoadUITable[73];
}

// Range: 0x801A0DE4 -> 0x801A0E58
void zSaveLoadGameTableInit(struct zSaveLoadGame * table /* r3 */) {
    // Local variables
    int i; // r31
}

// Range: 0x801A0E58 -> 0x801A0EB8
void zSaveLoadUITableInit(struct zSaveLoadUI * table /* r30 */) {
    // Local variables
    int i; // r31
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D635BB
// Range: 0x801A0EB8 -> 0x801A0F74
void zSaveLoad_UIEvent(int ui /* r1+0x8 */, unsigned int event /* r1+0xC */) {
    // Local variables
    unsigned int id; // r30
...
// Range: 0x801A0F74 -> 0x801A0FD8
struct st_XSAVEGAME_DATA * zSaveLoadSGInit(enum en_SAVEGAME_MODE mode /* r31 */) {}

// Range: 0x801A0FD8 -> 0x801A1000
int zSaveLoadSGDone(struct st_XSAVEGAME_DATA * xsgdata /* r1+0x8 */) {}

// Range: 0x801A1000 -> 0x801A1008
int zSaveLoad_getgame() {
    // References
    // -> static int currentGame;
}

// Range: 0x801A1008 -> 0x801A1010
int zSaveLoad_getcard() {
    // References
    // -> static int currentCard;
}

// Range: 0x801A1010 -> 0x801A1018
int zSaveLoad_getMCavailable() {
    // References
    // -> static int sAvailable;
}

// Range: 0x801A1018 -> 0x801A1020
int zSaveLoad_getMCneeded() {
    // References
    // -> static int sNeeded;
}

// Range: 0x801A1020 -> 0x801A1028
int zSaveLoad_getMCAccessType() {
    // References
    // -> static int sAccessType;
}

// Range: 0x801A1028 -> 0x801A1030
int zSaveLoadGetAutoSaveCard() {
    // References
    // -> int autoSaveCard;
}

static int been_here; // size: 0x4, address: 0x80D6A76C
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D635CD
// Range: 0x801A1030 -> 0x801A127C
int format(int num /* r28 */, int mode /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r30
    int tgtcnt; // r23
    int tgtmax; // r1+0x8
    int rc; // r31
    int tgtslot; // r27
...
static int been_here; // size: 0x4, address: 0x80D6A770
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D635D4
// Range: 0x801A127C -> 0x801A1368
int CardtoTgt(int card /* r1+0x8 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r30
    int tgtmax; // r1+0xC
...
static int been_here; // size: 0x4, address: 0x80D6A774
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D635DE
// Range: 0x801A1368 -> 0x801A1418
int zSaveLoad_CardCount() {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r30
    int tgtmax; // r1+0x8
...
// Range: 0x801A1418 -> 0x801A14A8
int zSaveLoad_Loop(unsigned char freeInv /* r1+0x8 */, int returnEvent /* r30 */, int pollEvent /* r31 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x801A14A8 -> 0x801A1508
int zSaveLoad_CardPrompt(int mode /* r1+0x8 */) {}

// Range: 0x801A1508 -> 0x801A1578
int zSaveLoad_CardPromptFormat(int mode /* r1+0x8 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x801A1578 -> 0x801A15D8
int zSaveLoad_CardPromptSpace(int mode /* r1+0x8 */) {}

// Range: 0x801A15D8 -> 0x801A1638
int zSaveLoad_CardPromptGames(int mode /* r1+0x8 */) {}

// Range: 0x801A1638 -> 0x801A1698
int zSaveLoad_CardPromptGameSlotEmpty(int mode /* r1+0x8 */) {}

// Range: 0x801A1698 -> 0x801A16D4
int zSaveLoad_CardPromptOverwrite() {}

// Range: 0x801A16D4 -> 0x801A1778
int zSaveLoad_ErrorPrompt(int mode /* r29 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x801A1778 -> 0x801A17B4
int zSaveLoad_DamagedSaveGameErrorPrompt() {}

// Range: 0x801A17B4 -> 0x801A1834
int zSaveLoad_CardWrongDeviceErrorPrompt(int mode /* r29 */) {}

// Range: 0x801A1834 -> 0x801A18B4
int zSaveLoad_CardDamagedErrorPrompt(int mode /* r29 */) {}

// Range: 0x801A18B4 -> 0x801A1914
int zSaveLoad_SaveDamagedErrorPrompt(int mode /* r1+0x8 */) {}

// Range: 0x801A1914 -> 0x801A1974
int zSaveLoad_CardYankedErrorPrompt(int mode /* r1+0x8 */) {}

// Range: 0x801A1974 -> 0x801A19F4
int zSaveLoad_ErrorFormatPrompt(int mode /* r29 */) {}

// Range: 0x801A19F4 -> 0x801A1A74
int zSaveLoad_ErrorFormatCardYankedPrompt(int mode /* r29 */) {}

static int been_here; // size: 0x4, address: 0x80D6A778
static char __FUNCTION__[26]; // size: 0x1A, address: 0x805200A4
// Range: 0x801A1A74 -> 0x801A1BC8
int zSaveLoad_CardCheckSingle(int num /* r28 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r27
    int tgtmax; // r1+0x8
...
static int been_here; // size: 0x4, address: 0x80D6A77C
static char __FUNCTION__[35]; // size: 0x23, address: 0x805200BE
// Range: 0x801A1BC8 -> 0x801A1DDC
int zSaveLoad_CardCheckFormattedSingle(int num /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r30
    int tgtcnt; // r25
    int tgtmax; // r1+0x8
    ...
    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[35];
}

static int been_here; // size: 0x4, address: 0x80D6A780
static int been_here; // size: 0x4, address: 0x80D6A784
static char __FUNCTION__[39]; // size: 0x27, address: 0x805200E1
// Range: 0x801A1DDC -> 0x801A1FA4
int zSaveLoad_CardCheckSpaceSingle_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, int num /* r30 */) {
    // Local variables
    int rc; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A788
static char __FUNCTION__[31]; // size: 0x1F, address: 0x80520108
// Range: 0x801A1FA4 -> 0x801A20C4
int zSaveLoad_CardCheckSpaceSingle(int num /* r28 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r27
    int tgtmax; // r1+0x8
...
static int been_here; // size: 0x4, address: 0x80D6A78C
static int been_here; // size: 0x4, address: 0x80D6A790
static int been_here; // size: 0x4, address: 0x80D6A794
static char __FUNCTION__[39]; // size: 0x27, address: 0x80520127
// Range: 0x801A20C4 -> 0x801A2268
int zSaveLoad_CardCheckGamesSingle_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, int num /* r30 */) {
    // Local variables
    int rc; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A798
static char __FUNCTION__[31]; // size: 0x1F, address: 0x8052014E
// Range: 0x801A2268 -> 0x801A2388
int zSaveLoad_CardCheckGamesSingle(int num /* r28 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r27
    int tgtmax; // r1+0x8
...
static int been_here; // size: 0x4, address: 0x80D6A79C
static int been_here; // size: 0x4, address: 0x80D6A7A0
static int been_here; // size: 0x4, address: 0x80D6A7A4
static char __FUNCTION__[45]; // size: 0x2D, address: 0x8052016D
// Range: 0x801A2388 -> 0x801A250C
int zSaveLoad_CardCheckSlotEmpty_hasGame_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r30 */, int num /* r29 */, int game /* r1+0x8 */) {
    // Local variables
    int rc; // r31

    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[45];
    // -> static int been_here;
    // -> static int been_here;
}

static int been_here; // size: 0x4, address: 0x80D6A7A8
static char __FUNCTION__[37]; // size: 0x25, address: 0x8052019A
// Range: 0x801A250C -> 0x801A2644
int zSaveLoad_CardCheckSlotEmpty_hasGame(int num /* r28 */, int game /* r26 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r30
    int tgtcnt; // r27
    int tgtmax; // r1+0x8
    ...
    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[37];
}

static char __FUNCTION__[38]; // size: 0x26, address: 0x805201BF
// Range: 0x801A2644 -> 0x801A2728
int zSaveLoad_CardCheckSlotOverwrite_Free(int num /* r1+0x8 */, int game /* r1+0xC */) {
    // Local variables
    int result; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D635F2
// Range: 0x801A2728 -> 0x801A2964
int zSaveLoad_CardCheck(int cardNumber /* r30 */, int mode /* r1+0x8 */) {
    // Local variables
    int result; // r31
    int cardResult; // r29
...
// Range: 0x801A2964 -> 0x801A2A40
int zSaveLoad_CardCheckFormatted(int cardNumber /* r29 */, int mode /* r30 */) {
    // Local variables
    int result; // r31
...
// Range: 0x801A2A40 -> 0x801A2A98
int zSaveLoad_CardCheckValid(int cardNumber /* r30 */, int mode /* r31 */) {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x805201E5
// Range: 0x801A2A98 -> 0x801A2BCC
int zSaveLoad_CardCheckSpace(int cardNumber /* r29 */, int mode /* r1+0x8 */) {
    // Local variables
    int result; // r31
    int tmp; // r30
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x805201FE
// Range: 0x801A2BCC -> 0x801A2D00
int zSaveLoad_CardCheckGames(int cardNumber /* r29 */, int mode /* r1+0x8 */) {
    // Local variables
    int result; // r31
    int tmp; // r30
...
// Range: 0x801A2D00 -> 0x801A2D68
int zSaveLoad_CardCheckGameSlot(int cardNumber /* r29 */, int gameNumber /* r30 */, int mode /* r31 */) {}

// Range: 0x801A2D68 -> 0x801A2E1C
int zSaveLoad_CardCheckSlotEmpty(int cardNumber /* r29 */, int gameNumber /* r30 */, int mode /* r1+0x8 */) {
    // Local variables
    int result; // r31
}

// Range: 0x801A2E1C -> 0x801A2EC0
int zSaveLoad_CardCheckSlotOverwrite(int cardNumber /* r29 */, int gameNumber /* r30 */) {
    // Local variables
    int result; // r31
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D63606
unsigned char gSysMessageManager_active; // size: 0x1, address: 0x80D6B159
// Range: 0x801A2EC0 -> 0x801A37B4
int zSaveLoad_CardPick(int mode /* r30 */) {
    // Local variables
    int result; // r1+0x8
    int done; // r31
    unsigned char formatDone; // r27
    int oldCurrentCard; // r26
    class zUI * mc1; // r29
    class zUI * mc2; // r28
    ...
    // -> static int currentCard;
    // -> static int currentGame;
    // -> unsigned char gSysMessageManager_active;
    // -> int prevSelectCard;
}

// Range: 0x801A37B4 -> 0x801A3834
static unsigned char IsValidName(char * name /* r31 */) {}

// Range: 0x801A3834 -> 0x801A3BF8
static void BuildIt(char * build_txt /* r27 */, int i /* r31 */) {
    // Local variables
    char date1[32]; // r1+0x4C
    char date2[32]; // r1+0x2C
    char biggerbuf[256]; // r1+0x6C
    char displaySizeUnit[32]; // r1+0xC
    const char * damaged_save_name; // r28
    const char * empty_save_name; // r1+0x8
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D63619
// Range: 0x801A3BF8 -> 0x801A3DC4
void zSaveLoad_BuildName(char * name_txt /* r28 */, unsigned long max_len /* r27 */, int idx /* r29 */) {
    // Local variables
    char desired[128]; // r1+0x88
    char current_name[128]; // r1+0x8
    const char * damaged_save_name; // r26
    int counter; // r30
    int i; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A7AC
static int been_here; // size: 0x4, address: 0x80D6A7B0
static int been_here; // size: 0x4, address: 0x80D6A7B4
static char __FUNCTION__[21]; // size: 0x15, address: 0x80520298
unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x80D6A5B0
// Range: 0x801A3DC4 -> 0x801A4770
int zSaveLoad_GameSelect(int mode /* r28 */, unsigned char waitInput /* r1+0x8 */) {
    // Local variables
    int done; // r30
    class zUIText * uiTxtSavedGame1; // r26
    class zUIText * uiTxtSavedGame2; // r25
    class zUIText * uiTxtSavedGame3; // r24
    int rc; // r27
    struct st_XSAVEGAME_DATA * svinst; // r29
    int use_tgt; // r23
    int emptyCount; // r22
    int i; // r31
    const char * empty_string; // r21
    const char * damaged_string; // r20
...
// total size: 0x2
struct /* @class$1615zSaveLoad_cpp */ {
    // Members
...
static unsigned char preAutoSaving; // size: 0x1, address: 0x80D6A7B8
// Range: 0x801A4770 -> 0x801A4778
unsigned char zSaveLoadGetPreAutoSave() {
    // References
    // -> static unsigned char preAutoSaving;
}

unsigned char autosaveErrorHack; // size: 0x1, address: 0x80D6A7B9
// Range: 0x801A4778 -> 0x801A47D4
void zSaveLoadPreAutoSave(unsigned char onOff /* r31 */) {
    // References
    // -> static unsigned char preAutoSaving;
    // -> unsigned char autosaveErrorHack;
}

// Range: 0x801A47D4 -> 0x801A4938
void zSaveLoadAutoSaveUpdate() {
    // Local variables
    struct xBase * sendTo; // r1+0x10
    char * list[3]; // r1+0x14
    int i; // r30
    struct zUITextAsset * asset; // r31
    struct XSGAutoData * autodata; // r27
    int lastCard; // r29
    long memSize; // r1+0xC
...
static int been_here; // size: 0x4, address: 0x80D6A7BC
static int been_here; // size: 0x4, address: 0x80D6A7C0
static int been_here; // size: 0x4, address: 0x80D6A7C4
static int been_here; // size: 0x4, address: 0x80D6A7C8
static int been_here; // size: 0x4, address: 0x80D6A7CC
static int been_here; // size: 0x4, address: 0x80D6A7D0
static int been_here; // size: 0x4, address: 0x80D6A7D4
static char __FUNCTION__[21]; // size: 0x15, address: 0x805202F0
...
// Range: 0x801A4938 -> 0x801A4FF8
int zSaveLoad_DoAutoSave() {
    // Local variables
    int success; // r25
    int teststat; // r28
    int rc; // r31
    enum en_XSGASYNC_STATUS asstat; // r24
    struct st_XSAVEGAME_DATA * svinst; // r30
    struct XSGAutoData * autodata; // r29
    int use_tgt; // r27
    int use_game; // r26
    int lastPhysicalSlot; // r23
    int physicalSlot; // r22
    unsigned int progress; // r20
    char label[64]; // r1+0xC
    const char * area; // r21
    int testing; // r1+0x8
    int physicalSlot; // r19
    ...
    // -> static int been_here;
    // -> static int been_here;
    // -> static unsigned int startSceneID;
    // -> static int been_here;
    // -> static int been_here;
    // -> static int been_here;
    // -> static int been_here;
...
static int been_here; // size: 0x4, address: 0x80D6A7D8
static int been_here; // size: 0x4, address: 0x80D6A7DC
static int been_here; // size: 0x4, address: 0x80D6A7E0
static int been_here; // size: 0x4, address: 0x80D6A7E4
static int been_here; // size: 0x4, address: 0x80D6A7E8
static int been_here; // size: 0x4, address: 0x80D6A7EC
static int been_here; // size: 0x4, address: 0x80D6A7F0
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6362D
enum en_XSG_WHYFAIL {
    XSG_WHYERR_NONE = 0,
    XSG_WHYERR_NOCARD = 1,
    XSG_WHYERR_NOROOM = 2,
...
// Range: 0x801A4FF8 -> 0x801A5620
int zSaveLoad_SaveGame() {
    // Local variables
    int success; // r26
    int teststat; // r29
    int rc; // r31
    enum en_XSGASYNC_STATUS asstat; // r25
    struct st_XSAVEGAME_DATA * svinst; // r30
    int use_tgt; // r28
    int use_game; // r27
    unsigned int progress; // r22
    char label[256]; // r1+0x10
    const char * area; // r24
    enum en_XSG_WHYFAIL whyFail; // r1+0xC
    int testing; // r1+0x8
    struct XSGAutoData * asg; // r23
    int physicalSlot; // r21
...
static int been_here; // size: 0x4, address: 0x80D6A7F4
static int been_here; // size: 0x4, address: 0x80D6A7F8
static int been_here; // size: 0x4, address: 0x80D6A7FC
static int been_here; // size: 0x4, address: 0x80D6A800
static int been_here; // size: 0x4, address: 0x80D6A804
static int been_here; // size: 0x4, address: 0x80D6A808
static int been_here; // size: 0x4, address: 0x80D6A80C
static int been_here; // size: 0x4, address: 0x80D6A810
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D63640
// Range: 0x801A5620 -> 0x801A5B64
int zSaveLoad_LoadGame() {
    // Local variables
    const char * damaged_save_name; // r1+0xC
    int success; // r28
    int teststat; // r29
    int rc; // r31
    enum en_XSGASYNC_STATUS asstat; // r27
    struct st_XSAVEGAME_DATA * ldinst; // r30
    int use_tgt; // r26
    enum en_XSG_WHYFAIL whyFail; // r1+0x8
    struct XSGAutoData * asg; // r25
    int use_game; // r24
    int physicalSlot; // r23
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D63653
// Range: 0x801A5B64 -> 0x801A6058
unsigned int zSaveLoad_LoadLoop() {
    // Local variables
    int result; // r31
    unsigned char hasCard; // r29
    int wrongDeviceSlot; // r28
    int tmp; // r26
    int tmp; // r30
    int result; // r25
    struct XSGAutoData * autodata; // r27
    ...
    // -> static int currentCard;
    // -> static char __FUNCTION__[19];
    // -> int g_promptUserSelection;
    // -> static unsigned char sIsLoading;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D63666
enum eGameMode {
    eGameMode_Boot = 0,
    eGameMode_Intro = 1,
    eGameMode_Title = 2,
...
// Range: 0x801A6058 -> 0x801A686C
unsigned int zSaveLoad_SaveLoop() {
    // Local variables
    int result; // r31
    unsigned char hasCard; // r30
    int wrongDeviceSlot; // r28
    int tmp; // r23
    int tmp; // r29
    struct xBase * sendTo; // r1+0x8
    int oldGame; // r22
    class zUIText * uiTxtSavedGame1; // r27
    class zUIText * uiTxtSavedGame2; // r26
    class zUIText * uiTxtSavedGame3; // r25
    struct xBase * sendTo; // r21
    struct XSGAutoData * autodata; // r24

    // References
    // -> static unsigned int saveSuccess;
    // -> struct zGlobals globals;
    // -> static int sAccessType;
    // -> static int saveState;
    // -> static int currentCard;
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052046C
// Range: 0x801A686C -> 0x801A6A38
void zSaveLoad_DispatchCB(unsigned int dispatchEvent /* r1+0x8 */, const float * toParam /* r30 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * inst; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A814
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63679
// Range: 0x801A6A38 -> 0x801A6B1C
int xSGT_SaveInfoCB(int * need /* r31 */, int * most /* r30 */) {
    // Local variables
    int slen; // r29

    // References
    // -> static char currSceneStr[32];
    // -> static int been_here;
    // -> static char __FUNCTION__[16];
}

static int been_here; // size: 0x4, address: 0x80D6A818
static int been_here; // size: 0x4, address: 0x80D6A81C
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63689
// Range: 0x801A6B1C -> 0x801A6C74
int xSGT_SaveProcCB(struct st_XSAVEGAME_DATA * xsgdata /* r1+0x8 */, struct st_XSAVEGAME_WRITECONTEXT * wctxt /* r1+0xC */) {
    // Local variables
    int amy; // r31
    int sum; // r30
...
static int been_here; // size: 0x4, address: 0x80D6A820
static char __FUNCTION__[21]; // size: 0x15, address: 0x80520481
// Range: 0x801A6C74 -> 0x801A6D38
int xSGT_SaveInfoPrefsCB(int * need /* r30 */, int * most /* r29 */) {
    // Local variables
    int slen; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A824
static int been_here; // size: 0x4, address: 0x80D6A828
static int been_here; // size: 0x4, address: 0x80D6A82C
static int been_here; // size: 0x4, address: 0x80D6A830
static int been_here; // size: 0x4, address: 0x80D6A834
static int been_here; // size: 0x4, address: 0x80D6A838
static char __FUNCTION__[21]; // size: 0x15, address: 0x80520496
// Range: 0x801A6D38 -> 0x801A7060
int xSGT_SaveProcPrefsCB(struct st_XSAVEGAME_DATA * xsgdata /* r28 */, struct st_XSAVEGAME_WRITECONTEXT * wctxt /* r29 */) {
    // Local variables
    int amy; // r31
    int sum; // r30
    float fMusicVolume; // r1+0xC
    float f3DVolume; // r1+0x8
...
static int been_here; // size: 0x4, address: 0x80D6A83C
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63699
// Range: 0x801A7060 -> 0x801A7308
int xSGT_LoadLoadCB(struct st_XSAVEGAME_DATA * xsgdata /* r1+0x8 */, struct st_XSAVEGAME_READCONTEXT * rctxt /* r1+0xC */) {
    // Local variables
    char bigbuf[32]; // r1+0x10
    int amy; // r30
    int sum; // r29
    int compdiff; // r31
...
static int been_here; // size: 0x4, address: 0x80D6A840
static int been_here; // size: 0x4, address: 0x80D6A844
static int been_here; // size: 0x4, address: 0x80D6A848
static int been_here; // size: 0x4, address: 0x80D6A84C
static int been_here; // size: 0x4, address: 0x80D6A850
static int been_here; // size: 0x4, address: 0x80D6A854
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D636A9
enum xSndMode {
    xSndMode_Mono = 0,
    xSndMode_Stereo = 1,
    xSndMode_Dolby = 2,
...
// Range: 0x801A7308 -> 0x801A76D4
int xSGT_LoadPrefsCB(struct st_XSAVEGAME_DATA * xsgdata /* r28 */, struct st_XSAVEGAME_READCONTEXT * rctxt /* r29 */) {
    // Local variables
    int amy; // r31
    int sum; // r30
    int compdiff; // r24
    enum xSndMode tempSndMode; // r1+0x10
    float fMusicVol; // r1+0xC
    float f3DVol; // r1+0x8
    int i; // r27
    int padPort; // r26
    int padPort; // r25
