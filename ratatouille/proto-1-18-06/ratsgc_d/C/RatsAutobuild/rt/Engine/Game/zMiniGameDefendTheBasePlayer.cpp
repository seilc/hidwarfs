/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameDefendTheBasePlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8031EFD4 -> 0x8031FA18
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float SHOT_SPEED; // size: 0x4, address: 0x80D67830
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80D67834
static unsigned int SHOT_MODEL_ID; // size: 0x4, address: 0x80D6B990
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67838
// total size: 0x60
...
// Range: 0x8031EFD4 -> 0x8031F11C
// this: r31
void zMiniGameDefendTheBasePlayerShot::Init(void * data /* r1+0x8 */) {
    // Local variables
    struct RpAtomic * file; // r30
...
// total size: 0x10
struct /* @class$1328zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
// Range: 0x8031F11C -> 0x8031F2C0
// this: r31
void zMiniGameDefendTheBasePlayerShot::Update(float dt /* r1+0x8 */) {
    // Local variables
    struct xSweptSphere sws; // r1+0x24
    struct xVec3 start; // r1+0x18
    struct xVec3 end; // r1+0xC
    class zMiniGameDefendTheBaseEnemy * enemy; // r30
    int result; // r29

    // References
    // -> struct xGlobals * xglobals;
    // -> struct zGlobals globals;
    // -> static float SHOT_SPEED;
}
...
// total size: 0x4
struct /* @class$932zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1856zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1858zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1859zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1860zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
enum /* @enum$1861zMiniGameDefendTheBasePlayer_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1862zMiniGameDefendTheBasePlayer_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1863zMiniGameDefendTheBasePlayer_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1865zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1853zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
// Range: 0x8031F2C0 -> 0x8031F360
// this: r31
void zMiniGameDefendTheBasePlayerShot::Render() {
    // References
    // -> struct xColor_tag g_RED;
}

// Range: 0x8031F360 -> 0x8031F3A0
// this: r31
void zMiniGameDefendTheBasePlayerShot::Emit() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6783D
// Range: 0x8031F3A0 -> 0x8031F3EC
// this: r31
void zMiniGameDefendTheBasePlayerShot::Exit() {
    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x8031F3EC -> 0x8031F434
// this: r31
float zMiniGameDefendTheBasePlayerShot::GetRadius() {}

// Range: 0x8031F434 -> 0x8031F4BC
// this: r30
void zMiniGameDefendTheBasePlayer::Init(struct xEntAsset * asset /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// Range: 0x8031F4BC -> 0x8031F568
// this: r31
void zMiniGameDefendTheBasePlayer::BeginUpdate(float dt /* f31 */) {
    // Local variables
    struct zEnt * ent; // r30
...
union /* @class$1080zMiniGameDefendTheBasePlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1079zMiniGameDefendTheBasePlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1825zMiniGameDefendTheBasePlayer_cpp */ {
    // Static members
...
// Range: 0x8031F568 -> 0x8031F650
// this: r31
void zMiniGameDefendTheBasePlayer::UpdateOrientation(float dt /* r1+0x8 */) {
    // Local variables
...
// Range: 0x8031F650 -> 0x8031F77C
// this: r31
void zMiniGameDefendTheBasePlayer::Update(float dt /* f31 */) {
    // Local variables
    int j; // r30
    int i; // r29
}

// Range: 0x8031F77C -> 0x8031F7AC
// this: r1+0x8
void zMiniGameDefendTheBasePlayer::EndUpdate(float dt /* r1+0xC */) {}

// Range: 0x8031F7AC -> 0x8031F8A4
// this: r31
void zMiniGameDefendTheBasePlayer::Render() {
    // Local variables
    int i; // r30
...
// Range: 0x8031F8A4 -> 0x8031F8E4
// this: r31
void zMiniGameDefendTheBasePlayer::SceneSetup() {}

// Range: 0x8031F8E4 -> 0x8031F918
// this: r31
void zMiniGameDefendTheBasePlayer::Reset() {}

// Range: 0x8031F918 -> 0x8031F970
// this: r30
void zMiniGameDefendTheBasePlayer::Exit() {
    // Local variables
    int i; // r31
}

// Range: 0x8031F970 -> 0x8031FA18
void zMiniGameDefendTheBasePlayer::SetupTweaks() {
    // Local variables
    char * prefix; // r31
    char buf[128]; // r1+0x8
...
// total size: 0x12C
struct {} zMiniGameDefendTheBasePlayer::__vtable; // size: 0x12C, address: 0x8052D4E0
// total size: 0x13B0
...
// total size: 0x1C
struct {} zMiniGameDefendTheBasePlayerShot::__vtable; // size: 0x1C, address: 0x8052D60C
