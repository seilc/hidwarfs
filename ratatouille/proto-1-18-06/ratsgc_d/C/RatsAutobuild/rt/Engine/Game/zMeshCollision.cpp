/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMeshCollision.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025F5C4 -> 0x80261534
*/
static unsigned int gTriangleFlags[3][256]; // size: 0xC00, address: 0x80D24B70
static unsigned int gCurrentFlagValue; // size: 0x4, address: 0x80D6B1E8
static int gRecursiveCallCount; // size: 0x4, address: 0x80D6B1EC
// Range: 0x8025F5C4 -> 0x8025F61C
static void zMeshCollisionClearFlags() {
    // References
    // -> static unsigned int gCurrentFlagValue;
    // -> static unsigned int gTriangleFlags[3][256];
}

// Range: 0x8025F61C -> 0x8025F7F0
static unsigned char zMeshCollisionSweptCircleToPoint(class zSweptCircle & sweptCircle /* r31 */, const struct xVec3 & point /* r30 */, const struct xVec2 & toStart /* r29 */, const struct xVec2 & fallbackHitNormal /* r1+0x8 */) {
    // Local variables
    float startAlong; // f30
    float distAway; // f31
    float distToStart2; // f29
    float backDist; // f28
}
...
static char __FUNCTION__[39]; // size: 0x27, address: 0x80524258
// Range: 0x8025F7F0 -> 0x8025FF28
static unsigned char zMeshCollisionSweptCircleToMeshRecurse(class zSweptCircle & sweptCircle /* r31 */, class xNavigationMeshAsset * mesh /* r24 */, int subMeshIndex /* r26 */, int triangleIndex /* r25 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh & subMesh; // r27
    struct Triangle & tri; // r30
    struct xVec3 * vertices[3]; // r1+0x38
    int v0; // r29
    int v1; // r28
    int neighborTriangle; // r1+0xC
    float edgeLength; // f29
    struct xVec2 edgeDir; // r1+0x30
    struct xVec2 edgeNorm; // r1+0x28
    struct xVec2 v0ToStart; // r1+0x20
    struct xVec2 v0ToEnd; // r1+0x18
    float startAbove; // f30
    float endAbove; // f28
    int neighborSubMesh; // r1+0x8
    float startAlong; // f31
    float endAlong; // f26
    struct xVec2 v1ToStart; // r1+0x10
    float percentDistTillTouchEdge; // f25
    float touchAlong; // f27

    // References
    // -> static int gRecursiveCallCount;
    // -> static unsigned int gTriangleFlags[3][256];
    // -> static unsigned int gCurrentFlagValue;
...
static char __FUNCTION__[32]; // size: 0x20, address: 0x8052427F
// Range: 0x8025FF28 -> 0x80260090
unsigned char zMeshCollisionSweptCircleToMesh(class zSweptCircle & sweptCircle /* r1+0x8 */, class zMeshPosition & meshPosition /* r31 */) {
    // References
    // -> static int gRecursiveCallCount;
...
// Range: 0x80260090 -> 0x80260294
unsigned char zMeshCollisionSweptCircleToCircles(class zSweptCircle & sweptCircle /* r31 */, class zMeshCircle * nearbyCircles /* r1+0x8 */) {
    // Local variables
    struct xVec2 movementNormal; // r1+0x1C
    unsigned char hitSomething; // r29
    class zMeshCircle * circle; // r30
    struct xVec2 startToCenter; // r1+0x14
    float distAway; // f29
    float combinedRadius; // f31
    float distAlong; // f30
    float firstContactDist; // f28
    struct xVec2 end; // r1+0xC
}
...
// total size: 0x4
struct /* @class$967zMeshCollision_cpp */ {
    // Members
...
union /* @class$1115zMeshCollision_cpp */ {
...
// total size: 0xC
struct /* @class$1105zMeshCollision_cpp */ {
    // Members
...
// total size: 0x1C
struct CircleCollisionResults {
    // Members
    struct xVec2 testedDir; // offset 0x0, size 0x8
    float dist; // offset 0x8, size 0x4
    struct xVec2 contact; // offset 0xC, size 0x8
    struct xVec2 normal; // offset 0x14, size 0x8
};
// Range: 0x80260294 -> 0x80260318
static unsigned char zMeshCollisionCheckNaiveResponseWorks(int stuckCollisions /* r1+0x8 */, struct CircleCollisionResults * sceneCollide /* r1+0xC */, int depth /* r1+0x10 */, const struct xVec2 & naiveResponse /* r1+0x14 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80260318 -> 0x802603EC
static void zMeshCollisionComputeResponse(int stuckCollisions /* r28 */, struct CircleCollisionResults * sceneCollide /* r29 */, int depth /* r30 */, struct xVec2 & remainingDpos /* r31 */) {
    // Local variables
    struct xVec2 naiveResponse; // r1+0x8
}

// total size: 0x50
class zSweptCircle {
    // Functions
    void Prepare(const struct xVec2 & start, float radius, const struct xVec2 & dir, float dist);
...
public:
    ...
    unsigned char hitSomething; // offset 0x2C, size 0x1
    unsigned int hitEdge; // offset 0x30, size 0x4
    class zMeshCircle * hitCircle; // offset 0x34, size 0x4
    struct xVec2 contactPoint; // offset 0x38, size 0x8
    struct xVec2 finalPosition; // offset 0x40, size 0x8
    struct xVec2 hitNormal; // offset 0x48, size 0x8
};
// Range: 0x802603EC -> 0x802604FC
static unsigned char zMeshCollisionFindShortestCollision(const struct xVec2 & center /* r1+0x8 */, float radius /* r1+0xC */, const struct xVec2 & validDpos /* r1+0x10 */, const struct xVec2 & dir /* r30 */, float dist /* f31 */, struct CircleCollisionResults & results /* r31 */, class zMeshPosition & meshPosition /* r1+0x14 */, class zMeshCircle * nearbyCircles /* r1+0x18 */) {
    // Local variables
    struct xVec2 start; // r1+0x1C
    class zSweptCircle sweptCircle; // r1+0x24
}

static char __FUNCTION__[33]; // size: 0x21, address: 0x8052429F
// Range: 0x802604FC -> 0x80260864
unsigned char zMeshCollisionSweptCircleEnemies(class zMeshPosition & meshPosition /* r30 */, float radius /* r1+0x8 */, const struct xVec2 & desiredDpos /* r28 */, class zMeshCircle * nearbyCircles /* r1+0xC */) {
    // Local variables
    struct xVec2 validDpos; // r1+0x30
    struct xVec2 originalDesiredDir; // r1+0x28
    float remainingDist; // f30
    struct xVec2 currentDir; // r1+0x20
    float currentDist; // f31
    struct xVec2 circleStart; // r1+0x18
    struct CircleCollisionResults sceneCollide[8]; // r1+0x44
    int stuckCollisions; // r29
    int depth; // r31
    struct xVec2 remainingDpos; // r1+0x10
    struct xVec3 newPos; // r1+0x38
...
// total size: 0x14
struct zMeshCollisionRecord {
    // Members
    struct xVec2 depenDir; // offset 0x0, size 0x8
    float depenDist; // offset 0x8, size 0x4
    class zMeshCircle * penetratedCircle; // offset 0xC, size 0x4
    unsigned int penetratedEdgeID; // offset 0x10, size 0x4
};
// Range: 0x80260864 -> 0x802608EC
static unsigned char zMeshCollisionSeenBefore(int subMeshIndex /* r3 */, int vert0Index /* r4 */, int vert1Index /* r5 */, struct zMeshCollisionRecord * previousCollisions /* r6 */, int numCollisions /* r7 */) {
    // Local variables
    unsigned int edgeID; // r29
    int i; // r31
}

// Range: 0x802608EC -> 0x80260974
static void zMeshCollisionFillRecord(int subMeshIndex /* r27 */, int vert0Index /* r28 */, int vert1Index /* r29 */, const struct xVec2 & depenDir /* r1+0x8 */, float depenDist /* r1+0xC */, struct zMeshCollisionRecord & collision /* r31 */) {}

// Range: 0x80260974 -> 0x80260E8C
static unsigned char zMeshCollisionFindMeshPenetrationRecurse(const struct xVec3 & center /* r22 */, float radius /* f31 */, class xNavigationMeshAsset * mesh /* r23 */, int subMeshIndex /* r26 */, int triangleIndex /* r24 */, struct zMeshCollisionRecord * allCollisions /* r25 */, int & collisionCount /* r30 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh & subMesh; // r28
    struct Triangle & tri; // r31
    struct xVec3 * vertices[3]; // r1+0x30
    int v0; // r27
    int v1; // r29
    int neighborTriangle; // r1+0xC
    float edgeLength; // f29
    struct xVec2 edgeDir; // r1+0x28
    struct xVec2 edgeNorm; // r1+0x20
    struct xVec2 v0ToCenter; // r1+0x18
    float distAwayEdge; // f28
    int neighborSubMesh; // r1+0x8
    float distAlongEdge; // f30
    float dist2; // f27
    float dist; // f26
    struct xVec2 v1ToCenter; // r1+0x10
    float dist2; // f25
    float dist; // f24
...
static char __FUNCTION__[34]; // size: 0x22, address: 0x805242C0
// Range: 0x80260E8C -> 0x8026100C
static unsigned char zMeshCollisionFindMeshPenetration(const class zMeshPosition & meshPosition /* r31 */, float radius /* r1+0x8 */, struct zMeshCollisionRecord * allCollisions /* r1+0xC */, int & collisionCount /* r1+0x10 */) {
    // References
    // -> static char __FUNCTION__[34];
}

// Range: 0x8026100C -> 0x8026108C
static unsigned char zMeshCollisionCirclesIntersecting(const struct xVec3 & center1 /* r1+0x8 */, float radius1 /* r1+0xC */, const struct xVec3 & center2 /* r1+0x10 */, float radius2 /* r1+0x14 */) {
    // Local variables
    float distBetween2; // f30
    float combinedRadius2; // f31
}

// Range: 0x8026108C -> 0x802610D4
static unsigned char zMeshCollisionSeenBefore(class zMeshCircle * circle /* r3 */, struct zMeshCollisionRecord * previousCollisions /* r4 */, int numCollisions /* r5 */) {
    // Local variables
    int i; // r31
}

// Range: 0x802610D4 -> 0x802611A0
static void zMeshCollisionFillRecord(const struct xVec3 & center /* r1+0x8 */, float radius /* r1+0xC */, class zMeshCircle * hitCircle /* r30 */, struct zMeshCollisionRecord & record /* r31 */) {
    // Local variables
    struct xVec3 toCircle; // r1+0x10
    float currentSeparation; // f31
}

// Range: 0x802611A0 -> 0x802612AC
static unsigned char zMeshCollisionFindCirclePenetration(const struct xVec3 & center /* r28 */, float radius /* f31 */, class zMeshCircle * nearbyCircles /* r1+0x8 */, struct zMeshCollisionRecord * previousCollisions /* r29 */, int & collisionCount /* r30 */, unsigned int filterBaseType /* r1+0xC */) {
    // Local variables
    class zMeshCircle * circle; // r31
}

static char __FUNCTION__[33]; // size: 0x21, address: 0x805242E2
// Range: 0x802612AC -> 0x8026141C
unsigned char zMeshCollisionDepenetrateEnemies(class zMeshPosition & meshPosition /* r31 */, float radius /* f31 */, class zMeshCircle * nearbyCircles /* r30 */, unsigned int filterBaseType /* r1+0x8 */) {
    // Local variables
    struct zMeshCollisionRecord allCollisions[5]; // r1+0x18
    int collisionCount; // r1+0xC
    struct xVec2 depenetration; // r1+0x10

    // References
    // -> static char __FUNCTION__[33];
}

// Range: 0x8026141C -> 0x802614D4
// this: r31
void zSweptCircle::Prepare(const struct xVec2 & start /* r29 */, float radius /* r1+0x8 */, const struct xVec2 & dir /* r30 */, float dist /* f31 */) {}

// Range: 0x802614D4 -> 0x80261534
// this: r31
void zSweptCircle::GetResults() {}
