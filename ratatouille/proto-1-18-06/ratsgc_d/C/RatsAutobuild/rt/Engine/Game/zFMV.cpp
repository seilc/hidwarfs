/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFMV.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801699FC -> 0x80169CB8
*/
// total size: 0xC
struct zFMVFile {
    // Members
...
static struct zFMVFile zFMVFileTable[53]; // size: 0x27C, address: 0x804A8C58
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D62B90
enum eFMVFile {
    eFMVFile_NoMovie = 0,
...
// Range: 0x801699FC -> 0x80169AC4
struct zFMVFile * zFMVFileGetFile(enum eFMVFile fmvId /* r30 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80169AC4 -> 0x80169B14
char * zFMVFileGetName(enum eFMVFile fmvId /* r1+0x8 */) {
    // Local variables
    const struct zFMVFile * file; // r31
}
...
// Range: 0x80169B14 -> 0x80169CB8
unsigned int zFMVPlay(const char * name /* r29 */, unsigned int buttons /* r23 */, float time /* f30 */, unsigned int uSubtitlesAID /* r24 */, unsigned char skippable /* r25 */, unsigned char lockController /* r26 */, unsigned char displayDemoBlink /* r27 */) {
    // Local variables
    unsigned int retval; // r30
    float oldSize; // f31
    enum xSndEffect currentEffect; // r28
