/*
    ...
    Language: C++
    Code range: 0x802532F8 -> 0x8025567C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char loop; // size: 0x1, address: 0x80D6B198
static unsigned char stoppit; // size: 0x1, address: 0x80D6B199
static unsigned char track_player; // size: 0x1, address: 0x80D653C0
static float repeat_delay; // size: 0x4, address: 0x80D6B19C
static float yoffset; // size: 0x4, address: 0x80D6B1A0
// Range: 0x802532F8 -> 0x80253420
...
// total size: 0xC
struct /* @class$734zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zSmashRing_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zSmashRing_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zSmashRing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zSmashRing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zSmashRing_cpp */ {
    // Members
...
static class module_type * module; // size: 0x4, address: 0x80D6B1A4
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$894zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1058zSmashRing_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1634zSmashRing_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// ERROR: Failed to emit tag 1999A2D (Subroutine)
// total size: 0x1
struct /* @class$1914zSmashRing_cpp */ {
    // Members
...
struct debug_info {
    // Members
    class zSmashRingEmitter test_ring_emitter; // offset 0x0, size 0x4
    struct config_type test_ring_emitter_cfg; // offset 0x4, size 0x34
    struct xVec3 test_ring_center; // offset 0x38, size 0xC
    float repeat_time; // offset 0x44, size 0x4
};
// total size: 0xB0
class module_type {
    // Functions
    static module_type(int rings_max, int ring_emitters_max, unsigned char tweak_alloc);
    ...
    static int get_raster_id(unsigned int texture);

    static int get_raster_id(struct RwTexture * texture);

    static int get_raster_id(struct RwRaster * raster);

    static int alloc_emitter_id();

    static void free_emitter_id(int id);

    static int find_unused_raster() const;
    ...
    struct debug_info * debug; // offset 0xAC, size 0x4
};
// Range: 0x80253434 -> 0x80253558
// this: r31
static module_type::module_type(int rings_max /* r1+0x8 */, int ring_emitters_max /* r30 */, unsigned char tweak_alloc /* r1+0xC */) {}

// Range: 0x80253558 -> 0x80253610
// this: r3
static void module_type::reset() {
    // Local variables
    int i; // r30
    struct emitter_id_node * it; // r31
    struct emitter_id_node * end; // r29
}

// Range: 0x80253610 -> 0x802536A4
// this: r31
static void module_type::update(float dt /* f31 */) {
    // Local variables
    struct activity_data * ring_emitter; // r30
    struct activity_data * end_ring_emitter; // r29
}

// Range: 0x802536A4 -> 0x802536E0
// this: r31
static void module_type::render() {}

// Range: 0x802536E0 -> 0x8025373C
// this: r1+0x8
static int module_type::get_raster_id(unsigned int texture /* r30 */) {}
...
// Range: 0x8025373C -> 0x80253794
// this: r1+0x8
static int module_type::get_raster_id(struct RwTexture * texture /* r30 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D653C1
// Range: 0x80253794 -> 0x802538B8
// this: r31
static int module_type::get_raster_id(struct RwRaster * raster /* r28 */) {
    // Local variables
    int i; // r30
    int unused; // r29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D653CF
// Range: 0x802538B8 -> 0x80253970
// this: r31
static int module_type::alloc_emitter_id() {
    // Local variables
    int id; // r30
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D653E0
// Range: 0x80253970 -> 0x80253AA0
// this: r31
static void module_type::free_emitter_id(int id /* r28 */) {
    // Local variables
    struct emitter_id_node * it; // r30
    int check_id; // r27
    struct emitter_id_node * node; // r29

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D653F0
// Range: 0x80253AA0 -> 0x80253BA8
// this: r31
static int module_type::find_unused_raster() const {
    // Local variables
    unsigned char used[32]; // r1+0x8
    struct ring_type * ring; // r30
    struct ring_type * end_ring; // r27
    int raster_id; // r28
    int i; // r29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65403
// Range: 0x80253BA8 -> 0x80253C60
// this: r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D6540E
// Range: 0x80253C60 -> 0x80253D50
// this: r31
static void module_type::free_ring(struct ring_type * ring /* r30 */) {
    // Local variables
    struct ring_type * tail; // r29

    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x80253E2C -> 0x80253F24
// this: r30
static void module_type::update_rings(float dt /* r1+0x8 */) {
    // Local variables
    struct ring_type * ring; // r31
    struct ring_type * end_ring; // r29
    float t; // f31
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D65418
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
static void module_type::render_rings() {
    ...
    int verts_size; // r25
    int last_raster_id; // r23
    struct ring_type * ring; // r31
    struct ring_type * end_ring; // r22
    int raster_id; // r24
    struct ring_type * batch_ring; // r26
    struct RwRaster * raster; // r19
    float Cx; // f31
    float Cz; // f30
    float Ay; // f24
    float By; // f23
    float r0; // f26
    float r1; // f25
    unsigned int color0; // r21
    unsigned int color1; // r20
    float du; // f20
    float dsin; // f22
    float dcos; // f21
    float u; // f29
    float s; // f28
    float c; // f27
    struct xVec3 * const end_pos; // r18
    float tempc; // f19
...
// total size: 0x890
struct /* @class$1877zSmashRing_cpp */ {
    // Static members
...
class zSmashRingEmitter {
    ...
    void start(const struct config_type & cfg, const struct xVec3 & center);
...
// Range: 0x80254798 -> 0x802547A4
void zSmashRingSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x802547A4 -> 0x802547D4
void zSmashRingReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x802547D4 -> 0x8025480C
void zSmashRingUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025480C -> 0x8025483C
void zSmashRingRender() {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025483C -> 0x802548AC
void zSmashRingEmitter::load_default_config(struct config_type & cfg /* r3 */) {}

// Range: 0x802548AC -> 0x802548B8
// this: r3
void zSmashRingEmitter::create() {}

// Range: 0x802548B8 -> 0x80254B50
// this: r31
void zSmashRingEmitter::start(const struct config_type & cfg /* r30 */, const struct xVec3 & center /* r1+0x8 */) {
    // Local variables
    float dang; // f31
    float life; // f29
    float ilife; // f30
...
// Range: 0x80254B50 -> 0x80254B8C
// this: r31
void zSmashRingEmitter::stop() {}

// Range: 0x80254B8C -> 0x80254F1C
// this: r31
void zSmashRingEmitter::update(float dt /* r1+0x8 */) {
    // Local variables
    float s0; // f25
    float s1; // f24
    float rmin; // f27
    ...
    float dr; // f26
    float ds; // f18
    float force_scale; // r1+0x24
    float force_damp; // r1+0x20
    float r; // f31
    float s; // f30
    float force; // r1+0x1C
    float yvel; // f22
    ...
    float ypeak; // f19
    float tfall; // r1+0x18
    float alpha0; // r1+0x14
    float alpha1; // r1+0x10
...
// Range: 0x80254F1C -> 0x80254F34
// this: r3
static void ring_type::set_sort_key(int raster_id /* r4 */, int emitter_id /* r5 */, int ring_id /* r6 */) {}

// Range: 0x80254F34 -> 0x80254F50
// this: r3
static unsigned char module_type::rings_full() const {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65425
// Range: 0x80254F50 -> 0x80255008
struct activity_data * zSmashRingEmitter::alloc_activity() {
    // References
    // -> static class module_type * module;
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D65434
// Range: 0x80255008 -> 0x80255104
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65442
// Range: 0x802551C8 -> 0x8025529C
// this: r31
void zSmashRingEmitter::activate() {
    // References
    // -> static class module_type * module;
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6544B
// Range: 0x8025529C -> 0x802553AC
// this: r31
...
// Range: 0x802553AC -> 0x8025567C
void zSmashRingEmitter::add_config_tweaks(const char * prefix /* r28 */, struct config_type & cfg /* r29 */, const struct tweak_callback * cb /* r30 */, void * context /* r31 */) {
    // Local variables
    const char * * texture_labels; // r1+0x14
    const unsigned int * texture_ids; // r1+0x10
    unsigned int textures; // r27
}
