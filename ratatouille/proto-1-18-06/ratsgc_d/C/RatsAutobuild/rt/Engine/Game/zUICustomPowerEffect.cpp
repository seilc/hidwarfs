/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomPowerEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802943E0 -> 0x802947A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float POWER_EFFECT_MIN_WAIT; // size: 0x4, address: 0x80D65EE8
float POWER_EFFECT_MAX_WAIT; // size: 0x4, address: 0x80D65EEC
float POWER_EFFECT_MIN_SCROLL; // size: 0x4, address: 0x80D65EF0
float POWER_EFFECT_MAX_SCROLL; // size: 0x4, address: 0x80D65EF4
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65EF8
// total size: 0x54
struct {} zUICustomPowerEffect::__vtable; // size: 0x54, address: 0x80525660
// total size: 0x14
...
// Range: 0x802943E0 -> 0x8029449C
// this: r31
zUICustomPowerEffect::zUICustomPowerEffect(class zUI * ui /* r30 */) {
    // References
...
// Range: 0x802944EC -> 0x802945A8
// this: r31
void zUICustomPowerEffect::PreUpdate(float dt /* f31 */) {
    // References
    // -> float POWER_EFFECT_MAX_SCROLL;
    // -> float POWER_EFFECT_MIN_SCROLL;
    // -> float POWER_EFFECT_MAX_WAIT;
...
// Range: 0x802945A8 -> 0x802945D4
unsigned char zUICustomPowerEffect::PreRender() {}

// Range: 0x802945D4 -> 0x802945D8
void zUICustomPowerEffect::PostRender() {}

// Range: 0x802945D8 -> 0x802946F0
...
// Range: 0x802946F0 -> 0x802947A8
// this: r31
void zUICustomPowerEffect::PreApplyMotionFrame(struct zUIMotionFrame * frame /* r29 */) {
    // Local variables
    const struct zUIImageAsset * asset; // r30
    float span; // f31
}
