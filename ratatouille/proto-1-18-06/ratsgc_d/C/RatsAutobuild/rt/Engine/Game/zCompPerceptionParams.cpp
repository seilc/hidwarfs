/*
    ...
    Language: C++
    Code range: 0x80346F68 -> 0x803470FC
*/
// total size: 0x8
struct xBaseAsset {
    // Members
...
class zCompPerceptionParams sNPCGenericDefault; // size: 0x78, address: 0x80D36218
class zCompPerceptionParams sNPCInstaKillDefault; // size: 0x78, address: 0x80D36290
const class zCompPerceptionParams * spNPCGenericDefault; // size: 0x4, address: 0x80D67EC0
// Range: 0x80346F68 -> 0x80346F8C
void zCompPerceptionParams::InitializeDefaults() {
    // References
    // -> class zCompPerceptionParams sNPCInstaKillDefault;
}

// Range: 0x80346F8C -> 0x80347060
// this: r3
zCompPerceptionParams::zCompPerceptionParams() {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D67EC4
// Range: 0x80347060 -> 0x803470FC
class zCompPerceptionParams * zCompPerceptionParams::GetParamsFromAsset(unsigned int aid /* r1+0x8 */) {
    // Local variables
    unsigned int assetSize; // r1+0xC
