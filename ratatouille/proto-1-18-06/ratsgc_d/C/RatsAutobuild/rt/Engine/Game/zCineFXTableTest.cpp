/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCineFXTableTest.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D3D40 -> 0x802D40B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[36]; // size: 0x24, address: 0x80528DE0
// total size: 0x10
struct TypeInfo {
    // Members
    union { // inferred
...
// total size: 0x54
struct /* @class$1677zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$897zCineFXTableTest_cpp */ {
    // Members
...
union /* @class$609zCineFXTableTest_cpp */ {
...
// total size: 0xC
struct /* @class$1101zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$838zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$839zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$840zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$841zCineFXTableTest_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$842zCineFXTableTest_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$843zCineFXTableTest_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$844zCineFXTableTest_cpp */ {
    // Members
...
// Range: 0x802D3D40 -> 0x802D3E94
static void zCinFX_Par_CINFX_TEST_PAR_SMOKE_Upd(struct NCINEntry * fxrec /* r31 */, int killit /* r1+0x8 */) {
    // Local variables
    struct zParEmitter * & emitter; // r30
    struct xParEmitterAsset * a; // r29
...
// Range: 0x802D3E94 -> 0x802D3F84
static void NCIN_upd_test(const struct zCutsceneMgr * csnmgr /* r29 */, struct NCINEntry * fxrec /* r30 */, int killit /* r28 */) {
    // Local variables
    struct PosInput * pi; // r31
}

// Range: 0x802D3F84 -> 0x802D4004
static void NCIN_anim_test(const struct zCutsceneMgr * csnmgr /* r31 */, struct NCINEntry * fxrec /* r1+0x8 */, struct RpAtomic * model /* r1+0xC */, struct RwMatrixTag * animMat /* r1+0x10 */, unsigned int animIndex /* r1+0x14 */, unsigned int dataIndex /* r1+0x18 */, unsigned int & visflags /* r30 */) {}

// Range: 0x802D4004 -> 0x802D4054
static void NCIN_rend_test(const struct zCutsceneMgr * csnmgr /* r31 */, struct NCINEntry * fxrec /* r1+0x8 */) {}

// Range: 0x802D4054 -> 0x802D4090
static void NCIN_tweak_test(const char * prefix /* r1+0x8 */) {}

static struct NCINEntry g_TR02_cin_test[4]; // size: 0x250, address: 0x80528E04
// total size: 0xC
struct NCINMap {
    // Members
...
static struct NCINMap cutmap[2]; // size: 0x18, address: 0x80529054
// Range: 0x802D4090 -> 0x802D40B8
void zCineFX_Register_TestTable() {
    // References
    // -> static struct NCINMap cutmap[2];
}
