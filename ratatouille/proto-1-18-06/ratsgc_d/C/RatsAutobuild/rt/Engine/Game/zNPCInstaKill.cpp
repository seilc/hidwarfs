/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCInstaKill.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8034546C -> 0x80345A90
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gInstaKillEntParams; // size: 0x30, address: 0x80D361B0
enum eSteeringType {
...
static class zCompSteeringGenericParams gInstaKillPatrolSteeringParams; // size: 0x38, address: 0x80D361E0
// total size: 0x68
class zNPCInstaKill : public zNPCBase {
    // Functions
...
// Range: 0x8034546C -> 0x803454A0
void zNPCInstaKill::CompParametersInit() {
    // References
    // -> static class zCompSteeringGenericParams gInstaKillPatrolSteeringParams;
    // -> static class zICompNPCEntityParams gInstaKillEntParams;
}

// Range: 0x803454A0 -> 0x803454A4
void zNPCInstaKill::AddTweaks() {}

char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<19zCompLogicInstaKill,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67E58
// total size: 0xC
...
char __FUNCTION__$localstatic1$AttachComponent__65zComponentPool<20zCompSteeringGeneric,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67E68
// total size: 0x0
class zNPCWalls {};
// total size: 0x4
struct xColor_tag {
...
char __FUNCTION__$localstatic1$AttachComponent__62zComponentPool<15zCompPerception,16zICompPerception,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67E78
// total size: 0x0
class zCompPerceptionParams {};
...
// Range: 0x803454A4 -> 0x80345564
// this: r31
unsigned char zNPCInstaKill::Activate() {
    // References
    // -> static class zICompNPCEntityParams gInstaKillEntParams;
}
...
// total size: 0x4
struct /* @class$984zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1122zNPCInstaKill_cpp */ {
    // Members
...
union /* @class$1124zNPCInstaKill_cpp */ {
...
// Range: 0x80345564 -> 0x8034558C
// this: r1+0x8
void zNPCInstaKill::Deactivate() {}

// Range: 0x8034558C -> 0x80345614
// this: r29
void zNPCInstaKill::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x80345614 -> 0x80345660
// this: r30
void zNPCInstaKill::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

static struct zCompStateMachineTable gInstaKillStateMachineTable[2]; // size: 0x10, address: 0x80D67E88
// total size: 0x40
...
// Range: 0x80345660 -> 0x80345664
void zCompLogicInstaKill::SetupStateTranstitionTests() {}

// Range: 0x80345664 -> 0x8034566C
int zCompLogicInstaKill::GetInitialStateEnum() {}

// Range: 0x8034566C -> 0x80345674
struct zCompStateMachineTable * zCompLogicInstaKill::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gInstaKillStateMachineTable[2];
}

// Range: 0x80345674 -> 0x803456C4
// this: r31
void zCompLogicInstaKill::AllAttached() {
    // Local variables
...
// total size: 0xC
struct /* @class$858zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$861zNPCInstaKill_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$862zNPCInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$863zNPCInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$864zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0x2C
struct {} zInstaKillPatrol::__vtable; // size: 0x2C, address: 0x8052F0D0
// total size: 0x28
...
// total size: 0x18
class zInstaKillPatrol : public zCompState {
    // Functions
    zInstaKillPatrol();
...
// Range: 0x803456C4 -> 0x80345708
// this: r31
zInstaKillPatrol::zInstaKillPatrol() {
    // References
    // -> struct [anonymous] zInstaKillPatrol::__vtable;
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D67E98
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x78
struct zNPCAssetInstaKill : public zNPCAssetRATS {
    // Members
    unsigned int firstMovePoint; // offset 0x74, size 0x4
};
// Range: 0x80345708 -> 0x803457F8
// this: r30
void zInstaKillPatrol::Enter(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zNPCInstaKill * npcInstaKill; // r29
    struct zNPCAssetInstaKill * npcassInstaKill; // r31
...
// Range: 0x803457F8 -> 0x803458BC
// this: r30
void zInstaKillPatrol::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
...
static unsigned char already_asserted; // size: 0x1, address: 0x80D6BBC0
static signed char init; // size: 0x1, address: 0x80D6BBC1
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67E9E
// Range: 0x803458BC -> 0x80345A88
// this: r31
void zInstaKillPatrol::Update(class zNPCBase * owner /* r28 */, float dt /* r1+0x8 */) {
    // Local variables
...
// Range: 0x80345A88 -> 0x80345A8C
void zInstaKillPatrol::CheckTranstitions() {}

// Range: 0x80345A8C -> 0x80345A90
void zInstaKillPatrol::DebugRender() {}
...
// total size: 0x50
struct {} zCompLogicInstaKill::__vtable; // size: 0x50, address: 0x8052F0FC
// total size: 0x8
...
// total size: 0x3C
struct {} zNPCInstaKill::__vtable; // size: 0x3C, address: 0x8052F14C
