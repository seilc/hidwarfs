/*
    ...
    Language: C++
    Code range: 0x801C9FAC -> 0x801CBAD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x1
struct /* @class$833zUIImage_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zUIImage_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zUIImage_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zUIImage_cpp */ {
    // Members
...
// Range: 0x801C9FAC -> 0x801C9FFC
static void OnUIImageUpdateTexture(const struct tweak_info & info /* r30 */) {
    // Local variables
...
// Range: 0x801C9FFC -> 0x801CA0EC
// this: r31
void zUIImage::SetTexture(unsigned int id /* r30 */, unsigned char clearPrev /* r1+0x8 */) {
    // Local variables
    struct PKRAssetTOCInfo info; // r1+0x1C
    unsigned char isMovie; // r28
}

// Range: 0x801CA0EC -> 0x801CA128
// this: r31
void zUIImage::DoInit() {}

// Range: 0x801CA128 -> 0x801CA178
// this: r31
void zUIImage::DoReset() {}

// Range: 0x801CA178 -> 0x801CA1C4
// this: r31
void zUIImage::DoResetMotion() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63CB8
// Range: 0x801CA1C4 -> 0x801CA40C
// this: r29
void zUIImage::DoHandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r25 */, const float * toParam /* r31 */, struct xBase * toParamWidget /* r26 */, unsigned int toParamWidgetID /* r27 */) {
    // Local variables
    struct RwTexture * pTexture; // r28
    float u0; // f31
    float v0; // f30
    float u1; // f29
    float v1; // f28
    struct zUIImageAsset * pAsset; // r30

    // References
    // -> static char __FUNCTION__[14];
}

// Range: 0x801CA40C -> 0x801CA47C
// this: r31
void zUIImage::PlayMovie(unsigned int id /* r30 */, unsigned char loop /* r1+0x8 */, unsigned char stopFrame /* r1+0x9 */, unsigned int startFrame /* r1+0xC */, unsigned int endFrame /* r1+0x10 */) {}

// Range: 0x801CA47C -> 0x801CA4B4
// this: r31
void zUIImage::StopMovie() {}

static void * modeTranslate[3]; // size: 0xC, address: 0x80D63CC8
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D63CD4
...
// Range: 0x801CA4B4 -> 0x801CB33C
// this: r30
void zUIImage::DoRender() const {
    // Local variables
    struct RwTexture * pTexture; // r27
    struct RwRaster * raster; // r28
    unsigned char bBlendROP; // r26
    void * oldAlphaFunction; // r1+0x94
    enum RwBlendFunction srcBlend; // r1+0x90
    enum RwBlendFunction destBlend; // r1+0x8C
    struct rwGameCube2DVertex vertex[4]; // r1+0x98
    const struct zUIImageAsset * asset; // r31
    float x1; // f30
    float y1; // f31
    float x2; // f29
    float y2; // f28
    ...
    float lrx; // r1+0x7C
    float lry; // r1+0x78
    float rotation; // r1+0x74
    float offx; // f22
    float offy; // f21
    float sinA; // f27
    float cosA; // f26
    const struct xColor_tag * color; // r29
    float z; // f25
    float u1; // r1+0x70
    float v1; // r1+0x6C
    float u2; // r1+0x68
    ...
    float u4; // r1+0x58
    float v4; // r1+0x54
    float texwidth; // r1+0x50
    float texheight; // r1+0x4C
    struct RwCamera * camera; // r25
    float cz; // r1+0x48
    float cooz; // r1+0x44
    float offset_x; // r1+0x40
    float offset_y; // r1+0x3C
    float offset_cx; // r1+0x38
    float offset_cy; // r1+0x34
    float x_sign; // f24
    float y_sign; // f23
    float g_center_x; // r1+0x30
    float g_center_y; // r1+0x2C
    float colorAlphaMulti; // r1+0x28
...
static struct tweak_callback textureCB; // size: 0x28, address: 0x80521DE0
static signed char init; // size: 0x1, address: 0x80D6AA58
...
// Range: 0x801CB33C -> 0x801CB73C
// this: r29
void zUIImage::DoAddTweaks(const char * baseName /* r31 */) {
    // Local variables
    struct zUIImageAsset * asset; // r30
...
// Range: 0x801CB73C -> 0x801CB774
// this: r31
void zUIImage::DoInitMotion() {}

// Range: 0x801CB790 -> 0x801CB958
// this: r31
void zUIImage::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r30 */) {}

// Range: 0x801CB958 -> 0x801CB980
// this: r1+0x8
void zUIImage::Visible() {}

// Range: 0x801CB980 -> 0x801CB9D4
// this: r31
void zUIImage::Invisible() {}

// Range: 0x801CB9D4 -> 0x801CBA04
// this: r1+0x8
unsigned char zUIImage::Blends() const {}

// Range: 0x801CBA04 -> 0x801CBA34
void zUIImage_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x801CBA34 -> 0x801CBA90
void zUIImage_Init(class zUIImage * image /* r30 */, struct zUIImageAsset * asset /* r1+0x8 */) {}

// total size: 0x64
struct {} zUIImage::__vtable; // size: 0x64, address: 0x80521E08
