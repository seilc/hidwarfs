/*
    ...
    Language: C++
    Code range: 0x80339A90 -> 0x8033B29C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80D6BB28
unsigned int numTextureSystems; // size: 0x4, address: 0x80D6BB2C
// total size: 0x58
struct config {
    // Members
...
struct config default_config; // size: 0x58, address: 0x80D35F70
// total size: 0x8
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D67BE0
struct TextureSystem textureSystems[8]; // size: 0x40, address: 0x80D35FC8
// Range: 0x80339C58 -> 0x80339DD8
unsigned int zPourStreamParticleSystem::register_texture(unsigned int texId /* r30 */) {
    // Local variables
    unsigned int i; // r31
...
char * zPourStreamParticleSystemNames[8]; // size: 0x20, address: 0x8052E8F8
// total size: 0x28
...
void zPourStreamParticleSystem::scene_setup() {
    ...
    // References
    // -> unsigned int numTextureSystems;
    // -> char * zPourStreamParticleSystemNames[8];
    // -> struct TextureSystem textureSystems[8];
}

// Range: 0x80339EB0 -> 0x8033A2B4
void zPourStreamParticleSystem::add_tweaks(const char * prefix /* r30 */, struct config * dust /* r31 */) {}
...
// total size: 0xC
struct /* @class$768zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zPourStream_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zPourStream_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zPourStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zPourStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zPourStream_cpp */ {
    // Members
...
// Range: 0x8033A2B4 -> 0x8033A714
void zPourStreamParticleSystem::emit(const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & normal /* r25 */, float & emit_remaining /* r30 */, const struct xVec3 & velocity /* r1+0xC */, float dt /* f31 */, struct config * cfg /* r31 */, float velocity_scale /* r1+0x10 */, float emit_scale /* f29 */, unsigned int systemIdx /* r26 */) {
    // Local variables
    float denom; // f25
    float time_passed; // f30
    int emit; // r29
    struct particle * p; // r1+0x14
    int count; // r28
    struct particle * end; // r27
    float dir_dot; // f27
    float vel_length; // f28
...
// total size: 0x4
struct /* @class$1150zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zPourStream_cpp */ {
    // Members
...
union /* @class$819zPourStream_cpp */ {
...
// total size: 0x10
struct /* @class$832zPourStream_cpp */ {
    // Members
...
// Range: 0x8033A714 -> 0x8033AA68
int zPourStreamParticleSystem::update(unsigned char * mem /* r26 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r30
    int cinematic_not_running; // r27
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67BF1
// total size: 0x18
...
// Range: 0x8033AA68 -> 0x8033AC1C
// this: r31
zPourStreamWidget::zPourStreamWidget(struct zPourStreamWidgetAsset * theAsset /* r30 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67BF6
// Range: 0x8033AC1C -> 0x8033ADE4
void zPourStreamWidget::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8033ADE4 -> 0x8033AE80
// this: r31
void zPourStreamWidget::EventCB(unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */) {
    // References
    // -> char * zPourStreamParticleSystemNames[8];
    // -> struct config default_config;
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67BFB
// Range: 0x8033AF4C -> 0x8033B068
void zPourStreamWidget::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zPourStreamWidget * pourStream; // r31
...
// Range: 0x8033B068 -> 0x8033B0E8
// this: r31
void zPourStreamWidget::Update(float dt /* r1+0x8 */) {
    // Local variables
    float t; // f31
...
struct PourStreamList * headList; // size: 0x4, address: 0x80D6BB30
// total size: 0x1
class zPourStreamManager {
    // Static members
    static struct PourStreamList * headList; // size: 0x4
};
// Range: 0x8033B0E8 -> 0x8033B110
void zPourStreamManager::Init() {
    // References
    // -> struct PourStreamList * headList;
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67C03
// Range: 0x8033B110 -> 0x8033B1C0
void zPourStreamManager::UpdateAll(float dt /* r1+0x8 */) {
    // Local variables
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67C0D
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8033B1C0 -> 0x8033B290
