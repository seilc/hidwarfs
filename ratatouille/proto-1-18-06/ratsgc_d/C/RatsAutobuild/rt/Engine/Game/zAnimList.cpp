/*
    ...
    Language: C++
    Code range: 0x8012F600 -> 0x8012FF20
*/
static int nals; // size: 0x4, address: 0x80D69E50
static unsigned int * aids; // size: 0x4, address: 0x80D69E54
// total size: 0xC
struct RwV3d {
    // Members
...
static struct xAnimTable * * atbls; // size: 0x4, address: 0x80D69E58
static int * anused; // size: 0x4, address: 0x80D69E5C
static char * astnames[20]; // size: 0x50, address: 0x80517718
// Range: 0x8012F600 -> 0x8012F608
...
// Range: 0x8012F608 -> 0x8012F6E0
static void AddAnimCustom(struct zAnimListAsset * a /* r31 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D61E28
...
// Range: 0x8012F6E0 -> 0x8012FE54
void zAnimListInit() {
    // Local variables
    int i; // r29
    unsigned int size; // r1+0x18
    struct zAnimListAsset * zala; // r31
    struct PKRAssetTOCInfo ainfo; // r1+0x1C
    struct xAnimTable * atbl; // r28
    void * buf; // r27
    struct xAnimFile * afile; // r25
    int idle_exists; // r23
    int j; // r30
    struct xAnimFile * afile; // r26
    struct xAnimTable * table; // r22
...
// Range: 0x8012FE78 -> 0x8012FECC
struct xAnimTable * zAnimListGetTable(unsigned int id /* r3 */) {
    // Local variables
    int i; // r31
...
// Range: 0x8012FECC -> 0x8012FF20
int zAnimListGetNumUsed(unsigned int id /* r3 */) {
    // Local variables
    int i; // r31
