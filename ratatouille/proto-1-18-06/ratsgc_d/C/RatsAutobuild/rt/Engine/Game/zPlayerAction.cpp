/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerAction.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80270804 -> 0x80271A1C
*/
// total size: 0xC
class zPlayerAction {
    // Functions
    struct xAnimState * NewState(struct xAnimTable * table, const char * name, unsigned int flags, unsigned int userFlags, float speed, float * boneBlend, float * timeSnap, float fadeRecip, unsigned short * fadeOffset, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *), void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *), void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int));

    void NewStateMany(struct xAnimTable * table, const char * name, int howMany, unsigned int flags, unsigned int userFlags, float speed, float * boneBlend, float * timeSnap, float fadeRecip, unsigned short * fadeOffset, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *), void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *), void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int));
...
// Range: 0x80270804 -> 0x8027088C
// this: r1+0x18
struct xAnimState * zPlayerAction::NewState(struct xAnimTable * table /* r1+0x1C */, const char * name /* r1+0x20 */, unsigned int flags /* r1+0x24 */, unsigned int userFlags /* r1+0x28 */, float speed /* r1+0x2C */, float * boneBlend /* r1+0x30 */, float * timeSnap /* r1+0x34 */, float fadeRecip /* r1+0x38 */, unsigned short * fadeOffset /* r1+0x3C */, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *) /* r1+0x48 */, void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *) /* r1+0x4C */, void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int) /* r1+0x50 */) {}

// Range: 0x8027088C -> 0x8027091C
// this: r1+0x18
void zPlayerAction::NewStateMany(struct xAnimTable * table /* r1+0x1C */, const char * name /* r1+0x20 */, int howMany /* r1+0x24 */, unsigned int flags /* r1+0x28 */, unsigned int userFlags /* r1+0x2C */, float speed /* r1+0x30 */, float * boneBlend /* r1+0x34 */, float * timeSnap /* r1+0x38 */, float fadeRecip /* r1+0x3C */, unsigned short * fadeOffset /* r1+0x48 */, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *) /* r1+0x4C */, void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *) /* r1+0x50 */, void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int) /* r1+0x54 */) {}

// Range: 0x8027091C -> 0x802709A0
void zPlayerAction::AddActionTransition(struct xAnimTable * table /* r1+0x10 */, const char * source /* r1+0x14 */, const char * dest /* r1+0x18 */, unsigned int (* condition)(struct xAnimTransition *, struct xAnimSingle *, void *) /* r1+0x1C */, unsigned short priority /* r1+0x20 */, float blend /* r1+0x24 */, unsigned int flags /* r1+0x28 */, unsigned int userFlags /* r1+0x2C */) {}

// Range: 0x802709A0 -> 0x802709E8
unsigned int zPlayerAction::ActionChange(struct xAnimTransition * tran /* r30 */) {
    // Local variables
    class zPlayerAction * nextAction; // r31
}

// Range: 0x802709E8 -> 0x80270A3C
// this: r31
void zPlayerAction::Move(struct xScene * s /* r1+0x8 */, float dt /* r1+0xC */, struct xEntFrame * frame /* r1+0x10 */) {}
...
// total size: 0x4
struct /* @class$901zPlayerAction_cpp */ {
    // Members
...
union /* @class$1040zPlayerAction_cpp */ {
...
// total size: 0xC
struct /* @class$1039zPlayerAction_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zPlayerAction_cpp */ {
    // Static members
...
// Range: 0x80270A3C -> 0x80270A80
// this: r31
void zPlayerAction::BeginUpdate(float dt /* r1+0x8 */) {}

// Range: 0x80270A80 -> 0x80270AC4
// this: r31
void zPlayerAction::Update(float dt /* r1+0x8 */) {}

// Range: 0x80270AC4 -> 0x80270B08
// this: r31
void zPlayerAction::EndUpdate(float dt /* r1+0x8 */) {}

// Range: 0x80270B08 -> 0x80270B5C
// this: r31
unsigned char zPlayerAction::CollisionResponse(const struct xVec3 & currentDir /* r1+0x8 */, const struct SphereCollisionResults & sceneCollide /* r1+0xC */, struct xVec3 & responseDpos /* r1+0x10 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D657E8
// total size: 0xC
class zPlayerActionManager {
    // Functions
    void SetCurrentAction(class zPlayerAction * newCurrentAction);

    unsigned int GetCurrentActionID() const;

    void Init(unsigned int actionCount);

    void Add(struct zPlayer * player, class zPlayerAction * action);
    ...
    void AddTransitions(struct xAnimTable * table);

    void AddTweaks();

    void AddStandardTransitionsTo(unsigned int actionID, struct xAnimTable * table, const char * fromStates);

    void AddTransitionsTo(unsigned int actionID, struct xAnimTable * table, const char * fromStates, unsigned short priority, float blend, unsigned int flags, unsigned int userFlags);

    class zPlayerAction * GetAction(unsigned int actionID);

    class zPlayerAction * GetAction(unsigned int actionID) const;
...
// Range: 0x80270B5C -> 0x80270C1C
// this: r31
void zPlayerActionManager::SetCurrentAction(class zPlayerAction * newCurrentAction /* r30 */) {
    // Local variables
    class zPlayerAction * prevAction; // r1+0x8

    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x80270C1C -> 0x80270C6C
// this: r31
unsigned int zPlayerActionManager::GetCurrentActionID() const {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D657F9
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80270C6C -> 0x80270CF4
// this: r31
void zPlayerActionManager::Init(unsigned int actionCount /* r1+0x8 */) {
    // Local variables
    unsigned int listMemSize; // r30
...
static char __FUNCTION__[4]; // size: 0x4, address: 0x80D657FE
// Range: 0x80270CF4 -> 0x80270E48
// this: r30
void zPlayerActionManager::Add(struct zPlayer * player /* r1+0x8 */, class zPlayerAction * action /* r31 */) {
    // References
    // -> static char __FUNCTION__[4];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65802
// Range: 0x80270E48 -> 0x80270F14
// this: r31
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65808
// Range: 0x80270F14 -> 0x80271054
// this: r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6580E
// Range: 0x80271054 -> 0x80271140
// this: r31
void zPlayerActionManager::BeginUpdate(float dt /* f31 */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x80271140 -> 0x80271184
// this: r31
void zPlayerActionManager::Update(float dt /* r1+0x8 */) {}

// Range: 0x80271184 -> 0x802711C8
// this: r31
void zPlayerActionManager::EndUpdate(float dt /* r1+0x8 */) {}

// Range: 0x802711C8 -> 0x8027121C
// this: r31
void zPlayerActionManager::Move(struct xScene * s /* r1+0x8 */, float dt /* r1+0xC */, struct xEntFrame * frame /* r1+0x10 */) {}

// Range: 0x8027121C -> 0x80271258
// this: r31
void zPlayerActionManager::Render() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D6581A
// Range: 0x80271258 -> 0x80271360
// this: r31
unsigned char zPlayerActionManager::CollisionResponse(const struct xVec3 & currentDir /* r28 */, const struct SphereCollisionResults & sceneCollide /* r29 */, struct xVec3 & responseDpos /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D6582C
// Range: 0x80271360 -> 0x8027142C
// this: r30
void zPlayerActionManager::AddStates(struct xAnimTable * table /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65836
// Range: 0x8027142C -> 0x80271520
// this: r30
void zPlayerActionManager::AddTransitions(struct xAnimTable * table /* r29 */) {
    // Local variables
    unsigned int i; // r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65845
// Range: 0x80271520 -> 0x802715E4
// this: r30
void zPlayerActionManager::AddTweaks() {
    // Local variables
    unsigned int i; // r31
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80524AE8
// Range: 0x802715E4 -> 0x80271700
// this: r31
void zPlayerActionManager::AddStandardTransitionsTo(unsigned int actionID /* r30 */, struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {
    // References
    // -> static char __FUNCTION__[25];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6584F
// Range: 0x80271700 -> 0x80271834
// this: r31
void zPlayerActionManager::AddTransitionsTo(unsigned int actionID /* r30 */, struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65860
// Range: 0x80271834 -> 0x80271928
// this: r31
class zPlayerAction * zPlayerActionManager::GetAction(unsigned int actionID /* r30 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D6586A
// Range: 0x80271928 -> 0x80271A1C
// this: r31
class zPlayerAction * zPlayerActionManager::GetAction(unsigned int actionID /* r30 */) const {
    // References
    // -> static char __FUNCTION__[10];
}

// total size: 0x54
struct {} zPlayerAction::__vtable; // size: 0x54, address: 0x80524B04
