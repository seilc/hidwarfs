/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomStatsScreen.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028CA68 -> 0x8028DA50
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cheapCreditsCheat; // size: 0x4, address: 0x80D6B390
static enum en_zStatistics PlayerStats[8]; // size: 0x20, address: 0x804CB4B8
// total size: 0x54
struct {} zUICustomStatsScreen::__vtable; // size: 0x54, address: 0x805253F0
enum xSndHandle {
};
// total size: 0x114
class zUICustomStatsScreen : public zUICustom {
    // Functions
    zUICustomStatsScreen(class zUI * ui);
    ...
    void FormatPrevNumberLines(class zUIText * * lines, char (* buffers)[10], int playerIndex, int curLine);

    unsigned char FormatLastNumberLine(class zUIText * * lines, char (* buffers)[10], int playerIndex, int curLine, float fraction);
    ...
    // Members
    class zUIText * stats1[7]; // offset 0x8, size 0x1C
    class zUIText * stats2[7]; // offset 0x24, size 0x1C
    class zUIText * numbers1[7]; // offset 0x40, size 0x1C
    class zUIText * numbers2[7]; // offset 0x5C, size 0x1C
    char numBuff1[7][10]; // offset 0x78, size 0x46
    char numBuff2[7][10]; // offset 0xBE, size 0x46
    enum xSndHandle statCycleSound; // offset 0x104, size 0x4
    float totalTime; // offset 0x108, size 0x4
    int lastLine; // offset 0x10C, size 0x4
    unsigned char doneUpdating; // offset 0x110, size 0x1
};
// Range: 0x8028CA68 -> 0x8028CAB4
// this: r31
zUICustomStatsScreen::zUICustomStatsScreen(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomStatsScreen::__vtable;
}
...
// Range: 0x8028CAB4 -> 0x8028CAF8
// this: r31
void zUICustomStatsScreen::Init() {}

// Range: 0x8028CAF8 -> 0x8028CC24
// this: r31
void zUICustomStatsScreen::Setup() {
    // Local variables
    char temp[128]; // r1+0x8
    int i; // r30
}

// Range: 0x8028CC24 -> 0x8028CC68
// this: r31
void zUICustomStatsScreen::Reset() {}

// Range: 0x8028CC68 -> 0x8028CC9C
// this: r31
void zUICustomStatsScreen::Exit() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65D30
// Range: 0x8028CC9C -> 0x8028CF34
// this: r31
void zUICustomStatsScreen::PreUpdate(float dt /* f30 */) {
    // Local variables
    int CurLine; // r30
    float fraction; // f31
    unsigned char MRICounting; // r29
    unsigned char FROCounting; // r28
    class zUIText * acceptText; // r27

    // References
    // -> static char __FUNCTION__[10];
    // -> static enum en_zStatistics PlayerStats[8];
}

enum iSndGroupHandle {
};
// Range: 0x8028CF34 -> 0x8028D02C
void zUICustomStatsScreen::FormatTextLines(class zUIText * * lines /* r30 */, int playerIndex /* r1+0x8 */, int curLine /* r1+0xC */) {
    // Local variables
    char temp[128]; // r1+0x10
    int i; // r31
    const char * playerString; // r29
    const char * line; // r28
}
...
// total size: 0x2
struct /* @class$1614zUICustomStatsScreen_cpp */ {
    // Members
...
// Range: 0x8028D02C -> 0x8028D118
// this: r1+0x8
void zUICustomStatsScreen::FormatPrevNumberLines(class zUIText * * lines /* r30 */, char (* buffers)[10] /* r28 */, int playerIndex /* r1+0xC */, int curLine /* r1+0x10 */) {
    // Local variables
    int i; // r31
    int stat; // r29
...
// Range: 0x8028D118 -> 0x8028D2A8
// this: r1+0x8
unsigned char zUICustomStatsScreen::FormatLastNumberLine(class zUIText * * lines /* r28 */, char (* buffers)[10] /* r26 */, int playerIndex /* r1+0xC */, int curLine /* r29 */, float fraction /* f31 */) {
    // Local variables
    int realStat; // r30
    int dispStat; // r31
    unsigned char stillCounting; // r27

    // References
    // -> static enum en_zStatistics PlayerStats[8];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D65D3A
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$889zUICustomStatsScreen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1053zUICustomStatsScreen_cpp */ {
    // Members
...
union /* @class$601zUICustomStatsScreen_cpp */ {
...
// total size: 0x10
struct /* @class$1695zUICustomStatsScreen_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
enum en_zStatistics {
    ...
    eStatJumps = 17,
    eStatDistance = 18,
    eStatObjectsDestroyed = 19,
    eStatCreated = 20,
    eStatRotations = 21,
    eStatMaxDamage = 22,
    eStatThrowsHit = 23,
    eStatThrows = 24,
    eStatIncrediPoints = 25,
    eStatMrIKilled = 26,
    eStatMrIPunchDamage = 27,
    eStatISlamDamage = 28,
    eStatThrowDamage = 29,
    eStatMrIDodgeDamage = 30,
    eStatMrIFinMoves = 31,
    eStatMrIDamageTaken = 32,
    eStatFrozoneKilled = 33,
    eStatFrozonePunchDamage = 34,
    eStatFrozoneNukeDamage = 35,
    eStatFrozoneThrowDamage = 36,
    eStatFrozoneDodgeDamage = 37,
    eStatFrozoneFinMoves = 38,
    eStatFrozoneDamageTaken = 39,
    eStatBounces = 40,
    eStatMaxBounceHeight = 41,
    eStatMaxSpeed = 42,
    eStatTotalSpeed = 43,
    eStatTotalSpeedTime = 44,
    eStatAverageSpeed = 45,
    eStatTimeBoosting = 46,
    eStatTrips = 47,
    eStatWaterTime = 48,
    eStatWaterLostFriction = 49,
    eStatTotalFriction = 50,
    eStatCount = 51,
};
// Range: 0x8028D2A8 -> 0x8028D414
int zUICustomStatsScreen::GetStat(enum en_zStatistics statIndex /* r1+0x8 */, int playerIndex /* r31 */) {
    // References
...
// total size: 0x890
struct /* @class$1938zUICustomStatsScreen_cpp */ {
    // Static members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65D42
// Range: 0x8028D414 -> 0x8028D568
// this: r31
unsigned char zUICustomStatsScreen::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r29 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // Local variables
    class zUIText * acceptText; // r30

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x8028D568 -> 0x8028D56C
void zUICustomStatsScreen::AllocateBuffers() {}

// Range: 0x8028D56C -> 0x8028D570
void zUICustomStatsScreen::DeAllocateBuffers() {}

class zUICustomParrBestScreen * pUICustomParrBestScreen; // size: 0x4, address: 0x80D6B394
// total size: 0x54
struct {} zUICustomParrBestScreen::__vtable; // size: 0x54, address: 0x8052539C
// total size: 0xB0
class zUICustomParrBestScreen : public zUICustom {
    // Functions
    zUICustomParrBestScreen(class zUI * ui);
    ...
    unsigned char IsSignalAllowed(unsigned int toEvent);

    void SetCompletedGoalsFlags();

    void SetupText();

    // Members
    class zUIText * scoreText[4]; // offset 0x8, size 0x10
    class zUIText * scoreNum[4]; // offset 0x18, size 0x10
    class zUIText * goalText[4]; // offset 0x28, size 0x10
    class zUIText * goalNum[4]; // offset 0x38, size 0x10
    class zUIText * statusText[4]; // offset 0x48, size 0x10
    char numBuff1[4][10]; // offset 0x58, size 0x28
    char numBuff2[4][10]; // offset 0x80, size 0x28
    float totalTime; // offset 0xA8, size 0x4
    unsigned char doneUpdating; // offset 0xAC, size 0x1
};
// Range: 0x8028D570 -> 0x8028D5B4
// this: r31
zUICustomParrBestScreen::zUICustomParrBestScreen(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomParrBestScreen::__vtable;
}

// Range: 0x8028D5B4 -> 0x8028D5F0
// this: r31
void zUICustomParrBestScreen::Init() {}

// Range: 0x8028D5F0 -> 0x8028D624
// this: r31
void zUICustomParrBestScreen::Exit() {}

// Range: 0x8028D624 -> 0x8028D780
// this: r31
void zUICustomParrBestScreen::Setup() {
    // Local variables
    char temp[128]; // r1+0x8
    int i; // r30
}

// Range: 0x8028D780 -> 0x8028D7BC
// this: r31
void zUICustomParrBestScreen::Reset() {}

// Range: 0x8028D7BC -> 0x8028D7EC
// this: r1+0x8
void zUICustomParrBestScreen::PreUpdate(float dt /* r1+0xC */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65D4E
// total size: 0x1C
...
// Range: 0x8028D7EC -> 0x8028D9F0
// this: r31
unsigned char zUICustomParrBestScreen::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r28 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // Local variables
    class zUIController * ref; // r30
    unsigned char cheapCredits; // r29

    // References
    // -> static int cheapCreditsCheat;
    // -> static char __FUNCTION__[12];
    // -> struct zGlobals globals;
}

// Range: 0x8028D9F0 -> 0x8028DA18
// this: r3
unsigned char zUICustomParrBestScreen::IsSignalAllowed(unsigned int toEvent /* r4 */) {}
...
// Range: 0x8028DA18 -> 0x8028DA2C
// this: r3
void zUICustomParrBestScreen::SetCompletedGoalsFlags() {
    // Local variables
    int points; // r27
    int goal; // r26
    unsigned char passed; // r30
    unsigned int targetFlag; // r25
    struct Scene * sceneCur; // r28
    int sceneFlags; // r29
    int i; // r31
}

// Range: 0x8028DA2C -> 0x8028DA48
// this: r3
void zUICustomParrBestScreen::SetupText() {
    // Local variables
    int points; // r28
    int goal; // r27
    unsigned char passed; // r30
    struct Scene * sceneCur; // r26
    int sceneFlags; // r29
    int i; // r31
}

// Range: 0x8028DA48 -> 0x8028DA4C
void zUICustomParrBestScreen::AllocateBuffers() {}

// Range: 0x8028DA4C -> 0x8028DA50
void zUICustomParrBestScreen::DeAllocateBuffers() {}
