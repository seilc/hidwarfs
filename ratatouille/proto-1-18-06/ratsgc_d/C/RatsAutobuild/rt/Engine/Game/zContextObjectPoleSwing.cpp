/*
    ...
    Language: C++
    Code range: 0x802D6C84 -> 0x802D7490
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float REMY_MOUNT_HEIGHT; // size: 0x4, address: 0x80D66AE8
static float DIR_COS; // size: 0x4, address: 0x80D66AEC
static float END_POINT_DIST; // size: 0x4, address: 0x80D66AF0
static float POLE_DIST; // size: 0x4, address: 0x80D66AF4
static float HAND_WIDTH; // size: 0x4, address: 0x80D66AF8
static unsigned char debugDraw; // size: 0x1, address: 0x80D6B6F0
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$833zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zContextObjectPoleSwing_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zContextObjectPoleSwing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zContextObjectPoleSwing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zContextObjectPoleSwing_cpp */ {
    // Members
...
// Range: 0x802D6C84 -> 0x802D6DDC
void zContextObjectPoleSwing::AddStaticTweaks() {
    // Local variables
    ...
    // -> static float POLE_DIST;
    // -> static float END_POINT_DIST;
    // -> struct tweak_callback cb_tweak_convert_cos;
    // -> static float DIR_COS;
    // -> static float REMY_MOUNT_HEIGHT;
}

// total size: 0x14
struct {} zContextObjectPoleSwing::__vtable; // size: 0x14, address: 0x80D66B08
// Range: 0x802D6DDC -> 0x802D6E2C
// this: r31
zContextObjectPoleSwing::zContextObjectPoleSwing(struct zContextObjectPoleSwingAsset * theAsset /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zContextObjectPoleSwing::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66AFC
// Range: 0x802D6E2C -> 0x802D7000
void zContextObjectPoleSwing::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D66B01
...
// Range: 0x802D7158 -> 0x802D7418
// this: r30
unsigned char zContextObjectPoleSwing::CanMount(struct zCommonPlayer * player /* r22 */, union MountData & mountData /* r29 */, float & priority /* r26 */) const {
    // Local variables
    const struct xMat4x3 & poleMat; // r31
    const struct xMat4x3 & playerMat; // r28
    struct xVec3 handPos; // r1+0x34
    float dirDot; // f27
    unsigned char forward; // r25
    struct xVec3 dir; // r1+0x28
    float projection; // f31
    float distance2; // f30
    unsigned char valid; // r27
    struct xVec3 grabPoint; // r1+0x1C
    float dist; // f29
    float currPriority; // f28
...
// total size: 0x4
struct /* @class$892zContextObjectPoleSwing_cpp */ {
    // Members
...
union /* @class$1031zContextObjectPoleSwing_cpp */ {
...
// total size: 0xC
struct /* @class$1030zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1832zContextObjectPoleSwing_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$1547zContextObjectPoleSwing_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1548zContextObjectPoleSwing_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2025zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2024zContextObjectPoleSwing_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2027zContextObjectPoleSwing_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1574zContextObjectPoleSwing_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802D7418 -> 0x802D7490
// this: r27
unsigned char zContextObjectPoleSwing::Mount(struct zCommonPlayer * player /* r31 */, union MountData & mountData /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    unsigned char match; // r28
}
