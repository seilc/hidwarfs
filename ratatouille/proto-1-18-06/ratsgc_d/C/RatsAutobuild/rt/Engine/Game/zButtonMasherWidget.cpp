/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zButtonMasherWidget.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803352EC -> 0x80335D7C
*/
class zButtonMasherMashChecker * * objectArray; // size: 0x4, address: 0x80D6BB00
int objectCount; // size: 0x4, address: 0x80D6BB04
// total size: 0x1
class zButtonMasherController {
    // Static members
    static class zButtonMasherMashChecker * * objectArray; // size: 0x4
    static int objectCount; // size: 0x4
};
// Range: 0x803352EC -> 0x80335300
void zButtonMasherController::Init() {
    // References
    // -> class zButtonMasherMashChecker * * objectArray;
    // -> int objectCount;
}

// Range: 0x80335300 -> 0x80335360
void zButtonMasherController::UpdateAll(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80335360 -> 0x80335388
int zButtonMasherController::AddToObjectCount() {
    // Local variables
    int t; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67AD8
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80335388 -> 0x80335460
void zButtonMasherController::InsertInObjectArray(class zButtonMasherMashChecker * inObj /* r1+0x8 */, int idx /* r31 */) {
    // References
    // -> class zButtonMasherMashChecker * * objectArray;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67AEC
// total size: 0x14
struct {} zButtonMasherMashChecker::__vtable; // size: 0x14, address: 0x80D67B00
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$957zButtonMasherWidget_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1095zButtonMasherWidget_cpp */ {
    // Members
...
union /* @class$1096zButtonMasherWidget_cpp */ {
...
// total size: 0x10
struct /* @class$1316zButtonMasherWidget_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
struct PrivateFlags {
    ...
    unsigned char doCalcRate : 1; // offset 0x0, size 0x1
    unsigned int pad : 31; // offset 0x4, size 0x4
};
// total size: 0x8
struct xBaseAsset {
    // Members
...
// total size: 0x2C
struct zButtonMasherWidgetAsset : public xDynAsset {
    // Members
    unsigned int playerId; // offset 0x10, size 0x4
    unsigned int buttonId; // offset 0x14, size 0x4
    float lowRateThreshold; // offset 0x18, size 0x4
    float medRateThreshold; // offset 0x1C, size 0x4
    float highRateThreshold; // offset 0x20, size 0x4
    float decayTime; // offset 0x24, size 0x4
    float decayRate; // offset 0x28, size 0x4
};
// total size: 0x8
struct AnalogStick {
    // Members
...
// total size: 0x3C
class zButtonMasherMashChecker : public xBase {
    // Functions
    zButtonMasherMashChecker(struct zButtonMasherWidgetAsset * theAsset);
    ...
    // Members
protected:
    struct PrivateFlags privateFlags; // offset 0x10, size 0x8
    struct zButtonMasherWidgetAsset * asset; // offset 0x18, size 0x4
    class zPlayerInput * playerInput; // offset 0x1C, size 0x4
    unsigned char cycleDone; // offset 0x20, size 0x1
    unsigned char pressed; // offset 0x21, size 0x1
    unsigned int button; // offset 0x24, size 0x4
    float timer; // offset 0x28, size 0x4
    float curRate; // offset 0x2C, size 0x4
    float curVelocity; // offset 0x30, size 0x4
    int objectArrayIdx; // offset 0x34, size 0x4
public:
    void * __vptr$; // offset 0x38, size 0x4
};
// Range: 0x80335460 -> 0x80335628
// this: r31
zButtonMasherMashChecker::zButtonMasherMashChecker(struct zButtonMasherWidgetAsset * theAsset /* r30 */) {
    // Local variables
    struct zPlayer * player; // r29

    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zButtonMasherMashChecker::__vtable;
}
...
// total size: 0x890
struct /* @class$1813zButtonMasherWidget_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67AF1
// Range: 0x80335628 -> 0x803357F0
void zButtonMasherMashChecker::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x803357F0 -> 0x8033588C
// this: r31
void zButtonMasherMashChecker::EventCB(unsigned int toEvent /* r1+0x8 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67AF6
// Range: 0x8033588C -> 0x803359A8
void zButtonMasherMashChecker::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zButtonMasherMashChecker * obj; // r31

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x803359A8 -> 0x803359B0
// this: r3
unsigned char zButtonMasherMashChecker::CycleDone() {}

// Range: 0x803359B0 -> 0x80335D68
// this: r31
void zButtonMasherMashChecker::Update(float dt /* f30 */) {
    // Local variables
    float retRate; // f31
}

// Range: 0x80335D68 -> 0x80335D7C
// this: r3
void zButtonMasherMashChecker::ResetButton() {}
