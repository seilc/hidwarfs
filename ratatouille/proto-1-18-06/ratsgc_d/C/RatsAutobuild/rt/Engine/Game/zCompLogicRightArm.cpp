/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicRightArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80321CD4 -> 0x803230B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float anim_speed; // size: 0x4, address: 0x80D67870
static unsigned char freeze; // size: 0x1, address: 0x80D6B9C0
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$986zCompLogicRightArm_cpp */ {
    // Members
...
union /* @class$1134zCompLogicRightArm_cpp */ {
...
// total size: 0xC
struct /* @class$1124zCompLogicRightArm_cpp */ {
    // Members
...
static struct AttachInfo Attachments[2]; // size: 0x118, address: 0x8052D8F0
// total size: 0x8
...
static struct zCompStateMachineTable gRightArmStateMachineTable[4]; // size: 0x20, address: 0x8052DA08
// Range: 0x80321CD4 -> 0x80322130
...
// total size: 0x2C
struct {} zRightArmIdle::__vtable; // size: 0x2C, address: 0x8052DAD4
// total size: 0x14
class zRightArmIdle : public zCompState {
    // Functions
    zRightArmIdle();

    void Enter(class zNPCBase * owner);
};
// Range: 0x803223A8 -> 0x803223E4
// this: r31
zRightArmIdle::zRightArmIdle() {
    // References
    // -> struct [anonymous] zRightArmIdle::__vtable;
}

// Range: 0x803223E4 -> 0x80322458
void zRightArmIdle::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$734zCompLogicRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zCompLogicRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zCompLogicRightArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zCompLogicRightArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zCompLogicRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zCompLogicRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zCompLogicRightArm_cpp */ {
    // Members
...
// Range: 0x80322458 -> 0x80322494
// this: r1+0x8
void zRightArmIdle::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80322494 -> 0x803224E8
void zRightArmIdle::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zRightArmLR::__vtable; // size: 0x2C, address: 0x8052DAA8
// total size: 0x18
class zRightArmLR : public zCompState {
    // Functions
    zRightArmLR();
...
// Range: 0x803224E8 -> 0x80322524
// this: r31
zRightArmLR::zRightArmLR() {
    // References
    // -> struct [anonymous] zRightArmLR::__vtable;
}

// Range: 0x80322524 -> 0x80322598
void zRightArmLR::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r31
...
// Range: 0x80322598 -> 0x803225EC
// this: r31
void zRightArmLR::Enter(class zNPCBase * owner /* r1+0x8 */) {}

// Range: 0x803225EC -> 0x80322640
void zRightArmLR::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zRightArmUR::__vtable; // size: 0x2C, address: 0x8052DA7C
// total size: 0x18
class zRightArmUR : public zCompState {
    // Functions
    zRightArmUR();
...
// Range: 0x80322640 -> 0x8032267C
// this: r31
zRightArmUR::zRightArmUR() {
    // References
    // -> struct [anonymous] zRightArmUR::__vtable;
}

// Range: 0x8032267C -> 0x803226F0
void zRightArmUR::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r31
...
// Range: 0x803226F0 -> 0x80322744
// this: r31
void zRightArmUR::Enter(class zNPCBase * owner /* r1+0x8 */) {}

// Range: 0x80322744 -> 0x80322798
void zRightArmUR::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}
...
// Range: 0x80322798 -> 0x803227D8
unsigned char zCompLogicRightArm::LRTriggered() {
    // Local variables
...
// Range: 0x803227D8 -> 0x8032283C
unsigned char zCompLogicRightArm::URTriggered() {
    // Local variables
    struct _tagxPad * pad; // r31
...
// Range: 0x8032283C -> 0x803228B0
unsigned char zCompLogicRightArm::IsAnimationStopped(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// Range: 0x803228B0 -> 0x80322944
void zCompLogicRightArm::AddStaticTweaks() {
    // Local variables
    char * prefix; // r31
...
// Range: 0x80322944 -> 0x803229CC
void zCompLogicRightArm::BeforeAnimMatrices(struct xAnimPlay * play /* r28 */, struct xQuat * quat /* r1+0x8 */, struct xVec3 * tran /* r1+0xC */, int boneCount /* r1+0x10 */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r27
    class zCompLogicRightArm * arm; // r29
}

// total size: 0x1
class zINPC {};
// Range: 0x803229CC -> 0x80322ACC
void zCompLogicRightArm::before_anim_matrices(struct xAnimPlay * play /* r23 */, struct xQuat * quat /* r24 */, struct xVec3 * tran /* r25 */, int boneCount /* r26 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    struct xModelInstance * model; // r31
...
// Range: 0x80322ACC -> 0x80322BE8
void zCompLogicRightArm::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x80322BE8 -> 0x80322CB4
// this: r31
void zCompLogicRightArm::SetupStateTranstitionTests() {}

// Range: 0x80322CB4 -> 0x80322CBC
int zCompLogicRightArm::GetInitialStateEnum() {}

// Range: 0x80322CBC -> 0x80322CC8
struct zCompStateMachineTable * zCompLogicRightArm::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gRightArmStateMachineTable[4];
}

// Range: 0x80322CC8 -> 0x80322CF0
// this: r1+0x8
void zCompLogicRightArm::Attached() {}

// Range: 0x80322CF0 -> 0x803230B8
// this: r22
void zCompLogicRightArm::AllAttached() {
    // Local variables
