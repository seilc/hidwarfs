/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGameState.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801732B4 -> 0x80173A84
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
enum _GameOstrich gGameOstrich; // size: 0x4, address: 0x80D6A4FC
static unsigned int sGameMode_DispatchTable[12]; // size: 0x30, address: 0x8051F0F8
static unsigned int sGameState_DispatchTable[8]; // size: 0x20, address: 0x8051F128
static unsigned int sPauseState_DispatchTable[2]; // size: 0x8, address: 0x80D62D34
static unsigned int sSaveState_DispatchTable[3]; // size: 0xC, address: 0x80D62D3C
static unsigned int sOptionsState_DispatchTable[1]; // size: 0x4, address: 0x80D62D48
static unsigned int sLoadState_DispatchTable[3]; // size: 0xC, address: 0x80D62D4C
static unsigned int sTitleState_DispatchTable[2]; // size: 0x8, address: 0x80D62D58
static unsigned int sIntroState_DispatchTable[4]; // size: 0x10, address: 0x80D62D60
static unsigned int sGameState_DoDispatchTable[8]; // size: 0x20, address: 0x8051F148
static unsigned int sPauseState_DoDispatchTable[2]; // size: 0x8, address: 0x80D62D70
static unsigned int sSaveState_DoDispatchTable[3]; // size: 0xC, address: 0x80D62D78
static unsigned int sOptionsState_DoDispatchTable[1]; // size: 0x4, address: 0x80D62D84
static unsigned int sLoadState_DoDispatchTable[3]; // size: 0xC, address: 0x80D62D88
static unsigned int sTitleState_DoDispatchTable[2]; // size: 0x8, address: 0x80D62D94
static unsigned int sIntroState_DoDispatchTable[4]; // size: 0x10, address: 0x80D62D9C
// Range: 0x801732B4 -> 0x801732BC
int zGameStateGet() {
    // References
    // -> int gGameState;
}

// Range: 0x801732BC -> 0x801732C4
int zGameModeGet() {
    // References
    // -> enum eGameMode gGameMode;
}

// Range: 0x801732C4 -> 0x801732CC
enum _GameOstrich zGameGetOstrich() {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

// Range: 0x801732CC -> 0x801732D4
void zGameSetOstrich(enum _GameOstrich o /* r3 */) {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62DAC
// Range: 0x801732D4 -> 0x801734BC
int zGameStateFindEvent(unsigned int * array /* r28 */, int size /* r27 */, int mode /* r1+0x8 */, int event /* r1+0xC */, int * ret_mode /* r29 */, int * ret_state /* r30 */) {
    // Local variables
    int i; // r31
...
// total size: 0x4
struct /* @class$952zGameState_cpp */ {
    // Members
...
union /* @class$1091zGameState_cpp */ {
...
// total size: 0xC
struct /* @class$1090zGameState_cpp */ {
    // Members
...
// Range: 0x801734BC -> 0x801736BC
void zGameStateSwitchEvent(int event /* r31 */) {
    // Local variables
    int cur_mode; // r30
    int cur_state; // r28
    int new_mode; // r1+0x14
    int new_state; // r1+0x10
    int startidx; // r1+0xC
    struct _tagxPad * pad; // r29
    int port; // r27
    enum _tagTRCState state; // r1+0x8

    // References
    // -> struct _tagxPad mPad[4];
    // -> struct xGlobals * xglobals;
    // -> static unsigned int sIntroState_DoDispatchTable[4];
    // -> static unsigned int sTitleState_DoDispatchTable[2];
    // -> static unsigned int sLoadState_DoDispatchTable[3];
    // -> static unsigned int sOptionsState_DoDispatchTable[1];
    // -> static unsigned int sSaveState_DoDispatchTable[3];
    // -> static unsigned int sPauseState_DoDispatchTable[2];
    // -> static unsigned int sGameState_DoDispatchTable[8];
}

// Range: 0x801736BC -> 0x801737D0
void zGameStateSwitch(int theNewState /* r30 */) {
    // Local variables
    int stateOld; // r29
    unsigned int theEvent; // r31

    // References
    // -> static unsigned int sGameState_DispatchTable[8];
    // -> static unsigned int sPauseState_DispatchTable[2];
    // -> static unsigned int sSaveState_DispatchTable[3];
    // -> static unsigned int sOptionsState_DispatchTable[1];
    // -> static unsigned int sLoadState_DispatchTable[3];
    // -> static unsigned int sTitleState_DispatchTable[2];
    // -> static unsigned int sIntroState_DispatchTable[4];
    // -> enum eGameMode gGameMode;
    // -> int gGameState;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D62DC0
// total size: 0x1C
...
// Range: 0x801737D0 -> 0x80173A84
void zGameModeSwitch(enum eGameMode modeNew /* r31 */) {
    // Local variables
    enum eGameMode modeOld; // r30

    // References
    // -> static unsigned int sGameMode_DispatchTable[12];
    // -> enum eGameMode gGameMode;
