/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUI.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C493C -> 0x801C7FFC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char bAllowInput; // size: 0x1, address: 0x80D63C98
unsigned char bAllowSelectInput; // size: 0x1, address: 0x80D63C99
// Range: 0x801C493C -> 0x801C498C
static void UIEventHandler(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}
...
class zUI : public xBase {
    // Functions
    void Signal(struct xBase * from, unsigned int event);
    ...
    void DoHandleEvent(unsigned int toEvent, const float * toParam, struct xBase * toParamWidget);
    ...
    void RunMotion(struct zUIMotionAsset * asset, unsigned char loop, unsigned char reset);

    float CalcAcceleratedDistance(float totalDistance, float startTime, float endTime, float accelTime, float decelTime);
    ...
    void AutoMenu(unsigned int (zUIAsset::* item), unsigned int event);
...
// Range: 0x801C498C -> 0x801C49AC
static void OnChangeZ() {}
...
// total size: 0x1
struct /* @class$833zUI_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zUI_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zUI_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zUI_cpp */ {
    // Members
...
// Range: 0x801C49AC -> 0x801C4A28
static void OnCurrentMotion(const struct tweak_info & info /* r27 */, void * value /* r1+0x8 */) {
    // Local variables
    const char * * str; // r31
    class zUI * ui; // r28
    struct zUIMotionAsset * motion; // r30

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x801C4A28 -> 0x801C4A60
static void OnStopMotion(const struct tweak_info & info /* r30 */) {
    // Local variables
    class zUI * ui; // r31
}

static void * (* staticAllocator)(unsigned int, void *); // size: 0x4, address: 0x80D6AA38
static void * staticUser; // size: 0x4, address: 0x80D6AA3C
static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *); // size: 0x4, address: 0x80D6AA40
static void * signalUser; // size: 0x4, address: 0x80D6AA44
static int padPortInitiatedPause; // size: 0x4, address: 0x80D63C9C
static int playersActiveAtInitiatedPause; // size: 0x4, address: 0x80D6AA48
// Range: 0x801C4A60 -> 0x801C4A68
void zUISetActivePlayersAtInitiatedPause(int value /* r3 */) {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x801C4A68 -> 0x801C4A70
int zUIGetActivePlayersAtInitiatedPause() {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x801C4A70 -> 0x801C4A78
void zUISetPadPortInitiatedPause(int port /* r3 */) {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x801C4A78 -> 0x801C4A80
int zUIGetPadPortInitiatedPause() {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x801C4A80 -> 0x801C4AF4
void zUI_Init(class zUI * text /* r31 */, struct zUIAsset * asset /* r30 */) {}

// Range: 0x801C4AF4 -> 0x801C4AFC
unsigned char zUI::Blends() {}

unsigned char gSysMessageManager_active; // size: 0x1, address: 0x80D6B159
class zUI * pSysMessageManager; // size: 0x4, address: 0x80D6B15C
class zUICustom * pSysMessageManager_Custom; // size: 0x4, address: 0x80D6B160
// Range: 0x801C4AFC -> 0x801C4DA4
// this: r31
void zUI::Signal(struct xBase * from /* r24 */, unsigned int event /* r27 */) {
    // Local variables
    int i; // r30
    struct xBase * dest; // r26
    struct xBase * base; // r28
    int i; // r29
    struct xBase * base; // r25
    class zUI * uiFrom; // r23

    // References
    // -> static void * signalUser;
    // -> static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *);
...
// Range: 0x801C4DA4 -> 0x801C4E70
// this: r31
void zUI::DoInit() {}

// Range: 0x801C4E70 -> 0x801C4E74
void zUI::DoSetup() {}

// Range: 0x801C4E74 -> 0x801C4F08
// this: r31
void zUI::DoReset() {}

// Range: 0x801C4F08 -> 0x801C4F94
// this: r31
void zUI::DoResetMotion() {}

// Range: 0x801C4F94 -> 0x801C5380
// this: r31
void zUI::DoHandleEvent(unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r27 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D63CA0
...
unsigned char gPassAnyActveController; // size: 0x1, address: 0x80D6B15A
// total size: 0x30
class xfont {
    // Members
public:
...
class zUICustomControllerManager * pUICustomControllerManager; // size: 0x4, address: 0x80D6B708
enum _tagTRCState {
    TRC_Unknown = 0,
    TRC_PadMissing = 1,
    TRC_PadInserted = 2,
...
// Range: 0x801C5380 -> 0x801C5A88
// this: r30
void zUI::DoUpdate(float dt /* r1+0x8 */) {
    // Local variables
    struct _tagxPad * pad; // r31
    int startidx; // r1+0x14
    int port; // r28
    enum _tagTRCState state; // r27
    enum ePauseType pausetype; // r29
    int oldstartidx; // r1+0x10
    enum xRegion region; // r1+0xC
    int portInitiatedSysMsg; // r25
    unsigned char pressedDirection; // r26

    // References
    // -> unsigned char bAllowSelectInput;
    // -> class zUICustom * pSysMessageManager_Custom;
    // -> class zUICustomControllerManager * pUICustomControllerManager;
    // -> struct zGlobals globals;
    // -> unsigned char gSysMessageManager_active;
    // -> unsigned char gPassAnyActveController;
    // -> static int padPortInitiatedPause;
    // -> struct _tagxPad mPad[4];
    // -> static char __FUNCTION__[9];
    // -> unsigned char bAllowInput;
}
...
static struct tweak_callback cbChangeZ; // size: 0x28, address: 0x80521BC8
static signed char init; // size: 0x1, address: 0x80D6AA4C
static struct tweak_callback cbCurrentMotion; // size: 0x28, address: 0x80521BF0
static signed char init; // size: 0x1, address: 0x80D6AA4D
static struct tweak_callback cbStopMotion; // size: 0x28, address: 0x80521C18
static signed char init; // size: 0x1, address: 0x80D6AA4E
// Range: 0x801C5A8C -> 0x801C5F28
// this: r30
void zUI::DoAddTweaks(const char * baseName /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x80

    // References
    // -> static struct tweak_callback cbStopMotion;
    // -> static signed char init;
    // -> static struct tweak_callback cbCurrentMotion;
    // -> static signed char init;
    // -> static struct tweak_callback cbChangeZ;
    // -> static signed char init;
}

// Range: 0x801C5F28 -> 0x801C5F80
// this: r31
void zUI::StopMotion() {}

// Range: 0x801C5F80 -> 0x801C6024
// this: r31
void zUI::RunMotion(struct zUIMotionAsset * asset /* r1+0x8 */, unsigned char loop /* r1+0xC */, unsigned char reset /* r1+0xD */) {}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80521C40
// Range: 0x801C6024 -> 0x801C62D4
// this: r31
float zUI::CalcAcceleratedDistance(float totalDistance /* f22 */, float startTime /* f24 */, float endTime /* f25 */, float accelTime /* f29 */, float decelTime /* f26 */) {
    // Local variables
    float timePassed; // f31
    float timeLength; // f30
    float topVelocity; // f28
    float curDistance; // f27
    float timeToEnd; // f23
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63CA9
// total size: 0x34
...
// total size: 0x20
struct zUIMotionCmdMove : public zUIMotionCmdAsset {
    // Members
    float distX; // offset 0x18, size 0x4
    float distY; // offset 0x1C, size 0x4
};
// total size: 0x2C
struct zUIMotionCmdScale : public zUIMotionCmdAsset {
    // Members
...
// total size: 0x24
struct zUIMotionCmdRotate : public zUIMotionCmdAsset {
    // Members
...
// total size: 0x1C
struct zUIMotionCmdOpacity : public zUIMotionCmdAsset {
    // Members
    unsigned char startOpacity; // offset 0x18, size 0x1
    unsigned char endOpacity; // offset 0x19, size 0x1
};
// total size: 0x2C
struct zUIMotionCmdAbsoluteScale : public zUIMotionCmdAsset {
    // Members
...
// total size: 0x1C
struct zUIMotionCmdBrightness : public zUIMotionCmdAsset {
    // Members
...
// total size: 0x20
struct zUIMotionCmdUVScroll : public zUIMotionCmdAsset {
    // Members
...
// Range: 0x801C62D4 -> 0x801C6F34
// this: r31
void zUI::ApplyMotion() {
    // Local variables
    struct zUIMotionFrame frame; // r1+0x24
    float timeCompensation; // f30
    unsigned char fireEndEvent; // r19
    const char * entity; // r22
    int i; // r20
    int size; // r21
    const struct zUIMotionCmdMove * cmd; // r26
    const struct zUIMotionCmdScale * cmd; // r29
    float scaleX; // f29
    float scaleY; // f28
    const struct zUIMotionCmdRotate * cmd; // r28
    float rotation; // f31
    float sinA; // f25
    float cosA; // f24
    const struct zUIMotionCmdOpacity * cmd; // r24
    float opacityChange; // f22
    const struct zUIMotionCmdAbsoluteScale * cmd; // r27
    float scaleX; // f27
    float scaleY; // f26
    float timePassed; // f21
    float timeLength; // f20
    float percent; // f23
    const struct zUIMotionCmdBrightness * cmd; // r23
    float brightnessChange; // f19
    const struct zUIMotionCmdColor * cmd; // r30
    float redChange; // f18
    float greenChange; // r1+0x10
    float blueChange; // r1+0xC
    const struct zUIMotionCmdUVScroll * cmd; // r25
    unsigned char in; // r17
    struct xBase uiMotionBase; // r1+0x14
    struct zUIMotionAsset * oldMotion; // r1+0x8

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x801C6F34 -> 0x801C6F68
// this: r31
void zUI::DoInitMotion() {}

// Range: 0x801C6FF8 -> 0x801C70E8
// this: r31
void zUI::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r30 */) {}

static char * TYPES[8]; // size: 0x20, address: 0x80521C78
static char __FUNCTION__[23]; // size: 0x17, address: 0x80521C98
// Range: 0x801C70E8 -> 0x801C7ABC
void zUI_ExpandMotionTweaks(const struct tweak_info & info /* r19 */) {
    // Local variables
    char base[128]; // r1+0x88
    struct zUIMotionAsset * asset; // r28
    char buffer[128]; // r1+0x8
    char * start; // r30
    int i; // r31
    struct zUIMotionCmdAsset * cmd; // r29
    struct zUIMotionCmdMove * derived; // r23
    struct zUIMotionCmdScale * derived; // r25
    struct zUIMotionCmdRotate * derived; // r24
    struct zUIMotionCmdOpacity * derived; // r22
    struct zUIMotionCmdAbsoluteScale * derived; // r26
    struct zUIMotionCmdBrightness * derived; // r21
    struct zUIMotionCmdColor * derived; // r27
    struct zUIMotionCmdUVScroll * derived; // r20
...
unsigned char gDontAutoMenu; // size: 0x1, address: 0x80D6B158
// Range: 0x801C7ABC -> 0x801C7CAC
// this: r30
void zUI::AutoMenu(unsigned int (zUIAsset::* item) /* r27 */, unsigned int event /* r24 */) {
    // Local variables
    class zUI * ui; // r31
    const struct zUIAsset * asset; // r26
    unsigned int id; // r29
    unsigned int autoMenuLimit; // r25
    unsigned char bAllowAutoMenu; // r28

    // References
    // -> unsigned char gDontAutoMenu;
    // -> class zUICustom * pSysMessageManager_Custom;
    // -> unsigned char gSysMessageManager_active;
}

// Range: 0x801C7CAC -> 0x801C7D0C
// this: r31
void zUI::FocusOn() {}

// Range: 0x801C7D0C -> 0x801C7D6C
// this: r31
void zUI::FocusOff() {}

// Range: 0x801C7D6C -> 0x801C7DBC
// this: r31
void zUI::Visible() {}

// Range: 0x801C7DBC -> 0x801C7E04
// this: r31
void zUI::Invisible() {}

// Range: 0x801C7E04 -> 0x801C7EAC
// this: r31
void zUI::Select() {}

// Range: 0x801C7EAC -> 0x801C7F54
// this: r31
void zUI::Unselect() {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80521CD0
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x801C7F54 -> 0x801C7FE4
void * zUIAllocStaticMemory(unsigned int size /* r30 */) {
    // References
    // -> static char __FUNCTION__[21];
    // -> unsigned int gActiveHeap;
    // -> static void * staticUser;
    // -> static void * (* staticAllocator)(unsigned int, void *);
}

// Range: 0x801C7FE4 -> 0x801C7FF0
void zUISetCustomStaticAllocator(void * (* allocator)(unsigned int, void *) /* r3 */, void * user /* r4 */) {
    // References
    // -> static void * staticUser;
    // -> static void * (* staticAllocator)(unsigned int, void *);
}

// Range: 0x801C7FF0 -> 0x801C7FFC
void zUISetCustomSignalHandler(void (* handler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *) /* r3 */, void * user /* r4 */) {
    // References
    // -> static void * signalUser;
    // -> static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *);
}
...
// total size: 0x64
struct {} zUI::__vtable; // size: 0x64, address: 0x80521CE8
