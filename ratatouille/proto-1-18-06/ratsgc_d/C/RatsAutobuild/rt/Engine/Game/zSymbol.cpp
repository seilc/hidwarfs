/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSymbol.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801BBEB4 -> 0x801BBEC0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct symbol_map * map; // size: 0x4, address: 0x80D6A9D0
// total size: 0x1
class symbol {
    // Static members
    static struct symbol_map * map; // size: 0x4
};
// Range: 0x801BBEB4 -> 0x801BBEC0
void symbol::init() {
    // References
