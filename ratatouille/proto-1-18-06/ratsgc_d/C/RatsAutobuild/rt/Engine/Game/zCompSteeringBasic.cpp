/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompSteeringBasic.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802FC958 -> 0x802FE68C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xVec3 LocalFeeler[3]; // size: 0x24, address: 0x80529BA0
// total size: 0x1
...
static class zCompSteeringBasicParams gDefaultSteeringBasicParams; // size: 0x70, address: 0x80D2DB20
// Range: 0x802FC958 -> 0x802FCE30
// this: r31
void zCompSteeringBasicParams::AddTweaks(const char * name /* r30 */) {}
...
// Range: 0x802FCE30 -> 0x802FCEB8
// this: r31
void zSteeringBasicDynamics::Initialize(class zICompNPCEntity * npcEnt /* r30 */) {}
...
// total size: 0xC
struct /* @class$842zCompSteeringBasic_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zCompSteeringBasic_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zCompSteeringBasic_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zCompSteeringBasic_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zCompSteeringBasic_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zCompSteeringBasic_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zCompSteeringBasic_cpp */ {
    // Members
...
// total size: 0x60
struct {} zCompSteeringBasic::__vtable; // size: 0x60, address: 0x80529BC4
// total size: 0x18
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D671F0
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x802FD08C -> 0x802FD090
void zCompSteeringBasic::Detached() {}

// Range: 0x802FD090 -> 0x802FD094
void zCompSteeringBasic::Update() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D671F9
// Range: 0x802FD094 -> 0x802FD160
// this: r30
unsigned char zCompSteeringBasic::SystemEvent(unsigned int to_event /* r1+0x8 */, struct xBase * to_param_widget /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static unsigned char renderWallAvoidenceForce; // size: 0x1, address: 0x80D6B7B8
static unsigned char renderSphereAvoidenceForce; // size: 0x1, address: 0x80D6B7B9
static unsigned char renderWanderForce; // size: 0x1, address: 0x80D6B7BA
static unsigned char renderSeekForce; // size: 0x1, address: 0x80D6B7BB
static unsigned char renderFleeForce; // size: 0x1, address: 0x80D6B7BC
static unsigned char renderArriveForce; // size: 0x1, address: 0x80D6B7BD
// Range: 0x802FD160 -> 0x802FD2C8
...
static struct xVec3 ArrowDrawOffset; // size: 0xC, address: 0x80D67208
// Range: 0x802FD2C8 -> 0x802FD374
void zCompSteeringBasic::DebugRenderForce(const struct xVec3 * entPos /* r1+0x8 */, struct xVec3 * Force /* r1+0xC */, unsigned char render /* r1+0x10 */, float multiplier /* r1+0x14 */, struct xColor_tag & color /* r30 */) {
    // Local variables
    struct xVec3 HeadingArrowStart; // r1+0x28
    struct xVec3 ForceMult; // r1+0x1C

    // References
    // -> static struct xVec3 ArrowDrawOffset;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D67214
// Range: 0x802FD374 -> 0x802FD5C0
// this: r31
...
// Range: 0x802FD5C0 -> 0x802FD930
// this: r30
void zCompSteeringBasic::CalculateForce(struct xVec3 & force /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x802FD930 -> 0x802FDAAC
// this: r1+0x8
void zCompSteeringBasic::CalculateVelConstraints(struct xVec3 & dVel /* r31 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */, float dt /* f28 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r30
    struct xVec3 oldVelXZ; // r1+0xC
    float oldSpeed2; // f31
    float accMag; // f30
    float oldSpeed; // f29
...
// Range: 0x802FDAAC -> 0x802FDB00
// this: r1+0x8
void zCompSteeringBasic::CalculatePosConstraints(struct xVec3 & dPos /* r31 */, class zSteeringBasicDynamics & steeringDynamics /* r1+0xC */, float dt /* r1+0x10 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x802FDB00 -> 0x802FDBDC
// this: r1+0x8
unsigned char zCompSteeringBasic::AccumulateForce(struct xVec3 & CurTotal /* r31 */, struct xVec3 & ForceToAdd /* r30 */, float Scale /* r1+0xC */, unsigned char truncateIfTooBig /* r1+0x10 */) {
    // Local variables
    float ForceLength2; // f30
    float maxForce; // f31
    float ForceLength; // f29
}

// Range: 0x802FDBDC -> 0x802FDC20
void ConvertLocalVectorToWorldVector(struct xVec3 & oWorld /* r3 */, const struct xVec3 & iLocal /* r4 */, const struct xVec3 & iEntityHeading /* r5 */) {}

// Range: 0x802FDC20 -> 0x802FDC64
void ConvertWorldVectorToLocalVector(struct xVec3 & oLocal /* r3 */, const struct xVec3 & iWorld /* r4 */, const struct xVec3 & iEntityHeading /* r5 */) {}

// Range: 0x802FDC64 -> 0x802FDD74
// this: r30
void zCompSteeringBasic::GetWanderForce(struct xVec3 & wanderForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r31
...
// Range: 0x802FDD74 -> 0x802FDEE0
// this: r27
void zCompSteeringBasic::GetWallAvoidenceForce(struct xVec3 & avoidenceForce /* r26 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */) {
    // Local variables
...
void zCompSteeringBasic::GetSphereAvoidenceForce(struct xVec3 & avoidenceForce /* r29 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */) {
    ...
    class zSphereAvoidenceSearchCB cb; // r1+0xC
...
// Range: 0x802FDF9C -> 0x802FDFAC
// this: r3
zSphereAvoidenceSearchCB::zSphereAvoidenceSearchCB(class zSteeringBasicDynamics * steeringDynamics /* r4 */, const class zCompSteeringBasicParams * params /* r5 */, struct xVec3 * totalForce /* r6 */) {}
...
// Range: 0x802FDFAC -> 0x802FE0C0
// this: r31
void zCompSteeringBasic::GetSeekForce(struct xVec3 & seekForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r30
...
// Range: 0x802FE0C0 -> 0x802FE1D4
// this: r31
void zCompSteeringBasic::GetFleeForce(struct xVec3 & fleeForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r30
    struct xVec3 desiredVelocity; // r1+0x8
...
// Range: 0x802FE1D4 -> 0x802FE304
// this: r31
void zCompSteeringBasic::GetArriveForce(struct xVec3 & arriveForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r29
    struct xVec3 desiredVelocity; // r1+0x8
...
// Range: 0x802FE304 -> 0x802FE42C
// this: r30
void zCompSteeringBasic::GetSweptSphereCollDPos(struct xVec3 & collDPos /* r29 */, class zSteeringBasicDynamics & steeringDynamics /* r31 */) {
    // Local variables
    const class zCompSteeringBasicParams * params; // r1+0xC
    float boundR; // f31
    float ratioToThisWall; // r1+0x8
    struct xVec3 collPoint; // r1+0x28
    struct xVec3 collNormal; // r1+0x1C
...
// total size: 0x4
struct /* @class$901zCompSteeringBasic_cpp */ {
    // Members
...
union /* @class$1040zCompSteeringBasic_cpp */ {
...
// total size: 0x30
struct {} zIComponent<zNPCBase>::__vtable; // size: 0x30, address: 0x80529C24
// total size: 0x54
struct {} zICompSteering::__vtable; // size: 0x54, address: 0x80529C54
enum eCompType {
    eCompType_Unknown = -1,
...
// Range: 0x802FE42C -> 0x802FE68C
// this: r31
unsigned char zSphereAvoidenceSearchCB::operator()(const struct xEnt & ent /* r30 */) {
    // Local variables
    ...
    float PosRange; // f28
    float NegRange; // f27
    float expandedRadius; // f30
    float absY; // f29
    float absX; // f31
    struct xVec3 curForce; // r1+0x14
    float ForceMultiplier; // f26
    struct xVec3 curWorldForce; // r1+0x8
}

// total size: 0xC
struct {} zCompSteeringBasicParams::__vtable; // size: 0xC, address: 0x80D67224
