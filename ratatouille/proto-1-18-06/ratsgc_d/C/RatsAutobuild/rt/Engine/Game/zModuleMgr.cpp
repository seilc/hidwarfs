/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zModuleMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80325298 -> 0x803260C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct st_XORDEREDARRAY g_modlist; // size: 0x10, address: 0x80D6B9F8
static struct st_XORDEREDARRAY g_modlistUpdateSort; // size: 0x10, address: 0x80D6BA08
static struct st_XORDEREDARRAY g_modlistRenderSort; // size: 0x10, address: 0x80D6BA18
// total size: 0x1C
struct zModule {
    // Functions
    zModule();
...
// Range: 0x80325298 -> 0x803252F4
void zModule::Mgr_Startup() {
    // References
    // -> static struct st_XORDEREDARRAY g_modlistRenderSort;
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
    // -> static struct st_XORDEREDARRAY g_modlist;
}

// Range: 0x803252F4 -> 0x80325338
void zModule::Mgr_Shutdown() {
    // References
    // -> static struct st_XORDEREDARRAY g_modlist;
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
    // -> static struct st_XORDEREDARRAY g_modlistRenderSort;
...
// Range: 0x80325338 -> 0x80325390
int OrdComp_updatePriority(void * vkey /* r3 */, void * vitem /* r4 */) {
    // Local variables
    struct zModule * key; // r31
    struct zModule * item; // r30
}

// Range: 0x80325390 -> 0x803253E8
int OrdComp_renderPriority(void * vkey /* r3 */, void * vitem /* r4 */) {
    // Local variables
    struct zModule * key; // r31
    struct zModule * item; // r30
}
...
// Range: 0x803253E8 -> 0x80325488
void zModuleMgr_RegisterModule(struct zModule * mod /* r31 */, int moduleID /* r1+0x8 */, const char * moduleName /* r1+0xC */, enum enModulePriority updPriority /* r1+0x10 */, enum enModulePriority rendPriority /* r1+0x14 */) {
    // References
    // -> static struct st_XORDEREDARRAY g_modlistRenderSort;
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
    // -> static struct st_XORDEREDARRAY g_modlist;
...
// ERROR: Failed to emit tag 2FFF738 (GlobalSubroutine)
// Range: 0x80325538 -> 0x803255A8
void zModule::Mgr_ScenePrepare() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29

    // References
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
}

// Range: 0x803255A8 -> 0x80325618
void zModule::Mgr_SceneFinish() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// Range: 0x80325618 -> 0x8032569C
void zModule::Mgr_SceneInit() {
    // Local variables
    int num_mod; // r29
    int i; // r31
    struct zModule * mod; // r30

    // References
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
}

// Range: 0x8032569C -> 0x8032570C
void zModule::Mgr_ScenePostInit() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// Range: 0x8032570C -> 0x8032577C
void zModule::Mgr_SceneSetup() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// Range: 0x8032577C -> 0x803257EC
void zModule::Mgr_ScenePostSetup() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// Range: 0x803257EC -> 0x8032585C
void zModule::Mgr_SceneExit() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// Range: 0x8032585C -> 0x803258CC
void zModule::Mgr_SceneReset() {
    // Local variables
    int num_mod; // r30
    int i; // r31
    struct zModule * mod; // r29
...
// total size: 0x4
struct /* @class$884zModuleMgr_cpp */ {
    // Members
...
union /* @class$1031zModuleMgr_cpp */ {
...
// total size: 0xC
struct /* @class$1103zModuleMgr_cpp */ {
    // Members
...
// Range: 0x803258CC -> 0x803259EC
void zModule::Mgr_Timestep(float dt /* r1+0x8 */) {
    // Local variables
    int isPaused; // r27
    int isCinematic; // r26
    int num_mod; // r25
...
// Range: 0x803259EC -> 0x80325B0C
void zModule::Mgr_PostTimestep(float dt /* r1+0x8 */) {
    // Local variables
    int isPaused; // r27
    int isCinematic; // r26
    int num_mod; // r25
...
// Range: 0x80325B0C -> 0x80325C2C
void zModule::Mgr_RenderPrep() {
    // Local variables
    int isPaused; // r27
    int isCinematic; // r26
    int num_mod; // r25
    int i; // r30
    struct zModule * mod; // r31
...
// Range: 0x80325C2C -> 0x80325D58
void zModule::Mgr_RenderToBuckets() {
    // Local variables
    int isPaused; // r27
    int isCinematic; // r26
    int num_mod; // r25
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D678B0
enum zLayerType {
    eLAYER_FIRST = 0,
    eLAYER_PREPICKUP = 1,
    eLAYER_POSTPICKUP = 2,
...
// Range: 0x80325D58 -> 0x80325F78
void zModule::Mgr_RenderLayer(enum zLayerType endLayer /* r24 */) {
    // Local variables
    int isPaused; // r23
    int isCinematic; // r22
    int num_mod; // r21
    ...
    int start; // r30
    int j; // r28
    enum zLayerType layer_curr; // r27
...
// Range: 0x80325F78 -> 0x803260C0
void zModule::Mgr_RenderDone() {
    // Local variables
    int isPaused; // r24
    int isCinematic; // r23
    int num_mod; // r28
