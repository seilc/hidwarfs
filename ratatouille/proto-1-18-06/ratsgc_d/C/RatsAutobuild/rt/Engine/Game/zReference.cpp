/*
    ...
    Language: C++
    Code range: 0x8019F790 -> 0x8019FB54
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$925zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1081zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$866zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$867zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$868zReference_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$869zReference_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$870zReference_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$871zReference_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$872zReference_cpp */ {
    // Members
...
// Range: 0x8019F790 -> 0x8019F808
static void ReferenceMemToTweak(const struct tweak_info & info /* r29 */, void * value /* r1+0x8 */) {
    // Local variables
    const char * * valueStr; // r31
    struct zReference * context; // r30

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8019F808 -> 0x8019F838
void zReferenceInit(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}
...
static struct tweak_callback cb; // size: 0x28, address: 0x8051FBF8
static signed char init; // size: 0x1, address: 0x80D6A728
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D63538
// total size: 0x14
struct zReferenceAsset : public xDynAsset {
    // Members
    unsigned int initial; // offset 0x10, size 0x4
};
// Range: 0x8019F838 -> 0x8019F9D8
void zReferenceInit(struct zReference * t /* r31 */, struct zReferenceAsset * a /* r30 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D63547
// Range: 0x8019F9D8 -> 0x8019FB54
void zReferenceEventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r28 */, unsigned int toEvent /* r29 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r1+0x10 */) {
    // Local variables
    struct zReference * ref; // r31
