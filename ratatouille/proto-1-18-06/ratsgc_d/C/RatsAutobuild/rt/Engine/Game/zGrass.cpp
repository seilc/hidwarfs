/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGrass.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F5830 -> 0x801FB4E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x1
struct /* @class$863zGrass_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$864zGrass_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$865zGrass_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$866zGrass_cpp */ {
    // Members
...
static struct tweak_callback cb_reset; // size: 0x28, address: 0x804B9258
static struct tweak_callback cb_refresh_density; // size: 0x28, address: 0x804B9280
static float default_dist_fade; // size: 0x4, address: 0x80D64340
static float default_dist_cull; // size: 0x4, address: 0x80D64344
static float density_scale; // size: 0x4, address: 0x80D64348
static float rand_width; // size: 0x4, address: 0x80D6434C
static float rand_height; // size: 0x4, address: 0x80D64350
static float rand_intensity; // size: 0x4, address: 0x80D64354
static int alpha_compare; // size: 0x4, address: 0x80D64358
static float clip_expand; // size: 0x4, address: 0x80D6435C
static unsigned char disable_render; // size: 0x1, address: 0x80D6AD60
static unsigned char use_game_camera; // size: 0x1, address: 0x80D6AD61
static unsigned char render_mesh_wireframe; // size: 0x1, address: 0x80D6AD62
static unsigned char render_mesh_bounds; // size: 0x1, address: 0x80D6AD63
static unsigned char render_mesh_color; // size: 0x1, address: 0x80D6AD64
static unsigned char render_mesh_density; // size: 0x1, address: 0x80D6AD65
static unsigned char render_mesh_height; // size: 0x1, address: 0x80D6AD66
static int render_cell; // size: 0x4, address: 0x80D64360
static int render_clone_bounds; // size: 0x4, address: 0x80D64364
static int render_only_clone; // size: 0x4, address: 0x80D64368
static int clones_rendered; // size: 0x4, address: 0x80D6AD68
static unsigned char stats_update; // size: 0x1, address: 0x80D6AD6C
static unsigned char force_dist_default; // size: 0x1, address: 0x80D6AD6D
// Range: 0x801F5830 -> 0x801F5CBC
static void add_tweaks() {
    ...
    // -> static unsigned char stats_update;
    // -> static unsigned char force_dist_default;
    // -> static int clones_rendered;
    // -> static int render_only_clone;
    // -> static int render_clone_bounds;
    // -> static int render_cell;
    // -> static unsigned char render_mesh_height;
    // -> static unsigned char render_mesh_density;
    // -> static unsigned char render_mesh_color;
    // -> static unsigned char render_mesh_bounds;
    // -> static unsigned char render_mesh_wireframe;
    // -> static unsigned char use_game_camera;
    // -> static unsigned char disable_render;
    // -> static float clip_expand;
    // -> static int alpha_compare;
    // -> static float rand_intensity;
    // -> static float rand_height;
    // -> static float rand_width;
    // -> static struct tweak_callback cb_refresh_density;
    // -> static float density_scale;
    // -> static float default_dist_cull;
    // -> static float default_dist_fade;
}

class zGrass * grass; // size: 0x4, address: 0x80D6AD70
// total size: 0x18
struct analog_data {
    // Members
...
struct grass_cache {
    ...
    int first; // offset 0x8, size 0x4
    int size; // offset 0xC, size 0x4
};
// total size: 0x28
struct zGrassMeshAsset : public xBaseAsset {
    // Members
    int numVertices; // offset 0x8, size 0x4
    int numFaces; // offset 0xC, size 0x4
    struct xVec3 min; // offset 0x10, size 0xC
    struct xVec3 max; // offset 0x1C, size 0xC
};
// total size: 0x20
struct zGrassMeshVertex {
    ...
    struct xVec3 normal; // offset 0x10, size 0xC
    unsigned char r; // offset 0x1C, size 0x1
    unsigned char g; // offset 0x1D, size 0x1
    unsigned char b; // offset 0x1E, size 0x1
    unsigned char a; // offset 0x1F, size 0x1
};
// total size: 0x6
...
struct debug_info {
    // Members
    char mesh_name[128]; // offset 0x0, size 0x80
    char model_name[128]; // offset 0x80, size 0x80
    int verts_wasted; // offset 0x100, size 0x4
};
// total size: 0x28
struct knoll_type {
    // Members
    const struct asset_type * asset; // offset 0x0, size 0x4
    struct zGrassMeshAsset * mesh; // offset 0x4, size 0x4
    struct RpAtomic * atomic; // offset 0x8, size 0x4
    int cache_index; // offset 0xC, size 0x4
    struct zGrassMeshVertex * vert; // offset 0x10, size 0x4
    int vert_size; // offset 0x14, size 0x4
    struct zGrassMeshFace * tri; // offset 0x18, size 0x4
    int tri_size; // offset 0x1C, size 0x4
    unsigned char visible; // offset 0x20, size 0x1
    unsigned char was_visible; // offset 0x21, size 0x1
    struct debug_info * debug; // offset 0x24, size 0x4
};
// total size: 0x80
struct clone_node {
    // Members
    struct clone_node * next; // offset 0x0, size 0x4
    unsigned char culling; // offset 0x4, size 0x1
    unsigned char cache_index; // offset 0x5, size 0x1
    unsigned char animate; // offset 0x6, size 0x1
    unsigned char pad1; // offset 0x7, size 0x1
    struct xColor_tag color; // offset 0x8, size 0x4
    unsigned int pad3; // offset 0xC, size 0x4
    struct xSphere sphere; // offset 0x10, size 0x10
    struct xMat4x3 mat; // offset 0x20, size 0x40
    struct xVec2 wave_offset[4]; // offset 0x60, size 0x20
};
// total size: 0x4
struct grid_cell {
    // Members
    unsigned short first_tri; // offset 0x0, size 0x2
    unsigned char tri_size; // offset 0x2, size 0x1
    unsigned char box_index; // offset 0x3, size 0x1
};
// total size: 0x18
struct xBox {
    // Members
...
// total size: 0x20
struct /* @class$1064zGrass_cpp */ {
    // Members
    struct grid_cell * cells; // offset 0x0, size 0x4
    struct xBox * * boxes; // offset 0x4, size 0x4
    int originx; // offset 0x8, size 0x4
    int originz; // offset 0xC, size 0x4
    int sizex; // offset 0x10, size 0x4
    int sizez; // offset 0x14, size 0x4
    float ylower; // offset 0x18, size 0x4
    float yupper; // offset 0x1C, size 0x4
};
union grass_mesh_tri {
    unsigned char knoll_index; // offset 0x0, size 0x1
    unsigned char cache_index; // offset 0x1, size 0x1
    unsigned short vert_index[3]; // offset 0x2, size 0x6
    unsigned short emit; // offset 0x8, size 0x2
    unsigned short base_emit; // offset 0xA, size 0x2
    int sort_key; // offset 0x0, size 0x4
    int source_index; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1065zGrass_cpp */ {
    // Members
    union grass_mesh_tri * tri; // offset 0x0, size 0x4
...
struct view_cell {
    // Members
    unsigned short flags; // offset 0x0, size 0x2
    unsigned char culling; // offset 0x2, size 0x1
    unsigned char pad; // offset 0x3, size 0x1
    struct clone_node * clones; // offset 0x4, size 0x4
    struct clone_node * last_clone; // offset 0x8, size 0x4
};
// total size: 0x3620
struct /* @class$1066zGrass_cpp */ {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
    int originx; // offset 0xC, size 0x4
    int originz; // offset 0x10, size 0x4
    int sizex; // offset 0x14, size 0x4
    int sizez; // offset 0x18, size 0x4
    struct view_cell cells[2][24][24]; // offset 0x1C, size 0x3600
    int current_cells; // offset 0x361C, size 0x4
};
// total size: 0x10
struct RwRGBAReal {
    // Members
...
// total size: 0x74
struct /* @class$1067zGrass_cpp */ {
    // Members
    struct xLightKit kit; // offset 0x0, size 0x14
    struct xLightKitLight light[1]; // offset 0x14, size 0x60
};
// total size: 0x28
struct wave_params {
    // Members
    ...
    float wavelength; // offset 0x8, size 0x4
    float angle; // offset 0xC, size 0x4
    float phase; // offset 0x10, size 0x4
    float xdir; // offset 0x14, size 0x4
    float zdir; // offset 0x18, size 0x4
    float iwavelength; // offset 0x1C, size 0x4
    float phase_cos; // offset 0x20, size 0x4
    float phase_sin; // offset 0x24, size 0x4
};
// total size: 0xC
struct xLightKitBlendInfo {
    // Members
    struct xLightKit * lightKit; // offset 0x0, size 0x4
    struct xLightKit * lightKitBlend; // offset 0x4, size 0x4
    float blendPercentage; // offset 0x8, size 0x4
};
// total size: 0x20
struct xLinkAsset {
    // Members
...
class zGrass {
    // Functions
    void apply_visibility(struct knoll_type & knoll);
    ...
    void reset_view_area();

    struct clone_node * alloc_clone();

    void refresh_density(union grass_mesh_tri & tri);

    void refresh_density();

    void allocate_grid_cell_boxes();

    void refresh_grid_cell_boxes();

    void partition_meshes();

    void emit_clones(struct clone_node * & clones, struct clone_node * & last_clone, const union grass_mesh_tri & tri);

    void populate_cell(struct view_cell & vcell, int grid_index);

    void wipe_cell(struct view_cell & vcell);

    void displace_view_area(int new_xlower, int new_xupper, int new_zlower, int new_zupper);

    void fade_cell_alpha(struct view_cell & vcell);

    void unfade_cell_alpha(struct view_cell & vcell);
    ...
    void render_clones(struct RpAtomic * atomic, struct clone_node * * output, int size);

    void render_view_area();

    void create_white_light();

    void destroy_white_light();

    void refresh_animation_waves();

    void create_animation_waves();

    void update_animation_waves(float dt);

    void debug_render();

    void add_wave_tweaks();

    // Members
    struct grass_cache * caches; // offset 0x0, size 0x4
    int caches_size; // offset 0x4, size 0x4
    struct knoll_type * knolls; // offset 0x8, size 0x4
    int knolls_size; // offset 0xC, size 0x4
    struct clone_node clone_buffer[512]; // offset 0x10, size 0x10000
    struct clone_node * head_free_clone; // offset 0x10010, size 0x4
    float dist_fade; // offset 0x10014, size 0x4
    float dist_cull; // offset 0x10018, size 0x4
    // total size: 0x20
    struct /* @class$1064zGrass_cpp */ {
        // Members
        struct grid_cell * cells; // offset 0x0, size 0x4
        ...
        float ylower; // offset 0x18, size 0x4
        float yupper; // offset 0x1C, size 0x4
    } grid; // offset 0x1001C, size 0x20
    // total size: 0x8
    struct /* @class$1065zGrass_cpp */ {
        // Members
        union grass_mesh_tri * tri; // offset 0x0, size 0x4
        int tri_size; // offset 0x4, size 0x4
    } world_mesh; // offset 0x1003C, size 0x8
    // total size: 0x3620
    struct /* @class$1066zGrass_cpp */ {
        // Members
        struct xVec3 center; // offset 0x0, size 0xC
        ...
        struct view_cell cells[2][24][24]; // offset 0x1C, size 0x3600
        int current_cells; // offset 0x361C, size 0x4
    } view_area; // offset 0x10044, size 0x3620
    // total size: 0x74
    struct /* @class$1067zGrass_cpp */ {
        // Members
        struct xLightKit kit; // offset 0x0, size 0x14
        struct xLightKitLight light[1]; // offset 0x14, size 0x60
    } white_light; // offset 0x13664, size 0x74
    struct wave_params anim_wave[4]; // offset 0x136D8, size 0xA0
    struct xLightKitBlendInfo old_light_kit; // offset 0x13778, size 0xC
};
// Range: 0x801F5CBC -> 0x801F5E4C
void zGrass::scene_enter() {
    // Local variables
    struct knoll_type * knolls; // r1+0xC
    int knolls_size; // r1+0x8
...
// Range: 0x801F5E4C -> 0x801F5E84
void zGrass::scene_exit() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x801F5E84 -> 0x801F5E90
void zGrass::setup() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x801F5E90 -> 0x801F5F78
void zGrass::reset() {
    // Local variables
    struct knoll_type * knoll; // r30
    struct knoll_type * const end_knoll; // r28
    struct clone_node * clone; // r31
    struct clone_node * end_clone; // r27
    struct grass_cache * cache; // r29
    struct grass_cache * end_cache; // r26

    // References
    // -> class zGrass * grass;
}

// Range: 0x801F5F78 -> 0x801F5FB0
void zGrass::update(float dt /* r1+0x8 */) {
    // References
    // -> class zGrass * grass;
}

// Range: 0x801F5FB0 -> 0x801F5FBC
void zGrass::pre_render() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x801F5FBC -> 0x801F604C
void zGrass::render() {
    // References
    // -> class zGrass * grass;
    // -> static float default_dist_cull;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6436C
// total size: 0x14
struct base_widget : public xBase {
    // Members
    struct knoll_type * knoll; // offset 0x10, size 0x4
};
// Range: 0x801F604C -> 0x801F626C
void zGrass::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */, unsigned long asset_size /* r26 */) {
    // Local variables
    struct asset_type & a; // r31
    unsigned long expected_asset_size; // r28
    struct base_widget * w; // r30
    struct knoll_type * knoll; // r29
    struct knoll_type * end_knoll; // r27
...
struct asset_type : public xDynAsset {
    ...
    unsigned char pad1; // offset 0x11, size 0x1
    unsigned short flags; // offset 0x12, size 0x2
    unsigned int mesh; // offset 0x14, size 0x4
    unsigned int model; // offset 0x18, size 0x4
    float width_scale; // offset 0x1C, size 0x4
    float height_scale; // offset 0x20, size 0x4
    float density_scale; // offset 0x24, size 0x4
    float width_min; // offset 0x28, size 0x4
    float height_min; // offset 0x2C, size 0x4
    float animate; // offset 0x30, size 0x4
};
// Range: 0x801F626C -> 0x801F62F8
void zGrass::event_handler(struct xBase * to /* r1+0x8 */, unsigned int event /* r1+0xC */) {
    // Local variables
    struct base_widget * w; // r31

    // References
    // -> class zGrass * grass;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D64371
// total size: 0x8
struct xModelPipe {
    // Members
    unsigned int Flags; // offset 0x0, size 0x4
...
// Range: 0x801F62F8 -> 0x801F6860
void zGrass::create_knolls(struct knoll_type * & knolls /* r22 */, int & knolls_size /* r27 */) {
    // Local variables
    unsigned int type; // r21
    int asses; // r20
    int i; // r26
    unsigned int asset_size; // r1+0x18
    struct asset_type * asset; // r30
    unsigned long expected_asset_size; // r19
    struct zGrassMeshAsset * mesh; // r18
    unsigned int model_id; // r1+0x14
    struct RpAtomic * atomic; // r24
    struct xModelPipe pipe; // r1+0x24
    unsigned char prelight_only; // r17
    struct knoll_type * knoll; // r31
    int i; // r25
    unsigned int asset_size; // r1+0x10
    struct asset_type * asset; // r29
    struct zGrassMeshAsset * mesh; // r28
    unsigned int model_id; // r1+0xC
    struct RpAtomic * atomic; // r23
    struct xModelPipe pipe; // r1+0x1C
    unsigned char prelight_only; // r1+0x8

    // References
    // -> static char __FUNCTION__[14];
}

// Range: 0x801F6860 -> 0x801F6924
// this: r3
void zGrass::apply_visibility(struct knoll_type & knoll /* r4 */) {
    // Local variables
    unsigned char knoll_index; // r30
    union grass_mesh_tri * tri; // r31
    union grass_mesh_tri * const end_tri; // r29
}

// Range: 0x801F6924 -> 0x801F69A0
// this: r30
void zGrass::refresh_visibility() {
    // Local variables
    struct knoll_type * knoll; // r31
    struct knoll_type * const end_knoll; // r29
}

// Range: 0x801F69A0 -> 0x801F69A8
struct RpAtomic * zGrass::setup_atomic(struct RpAtomic * atomic /* r4 */) {}

// Range: 0x801F69A8 -> 0x801F6A0C
void zGrass::destroy_atomic(struct RpAtomic * atomic /* r30 */) {
    // Local variables
    struct RwFrame * frame; // r31
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6437F
// Range: 0x801F6A0C -> 0x801F6BE0
// this: r31
void zGrass::create_caches() {
    // Local variables
    struct RpAtomic * atomics_found[8]; // r1+0x8
    struct knoll_type * knoll; // r29
    struct knoll_type * end_knoll; // r25
    struct RpAtomic * * t; // r28
    struct RpAtomic * * endt; // r26
    struct grass_cache * cache; // r30
    struct grass_cache * end_cache; // r24
...
// Range: 0x801F6BE0 -> 0x801F6C50
// this: r30
void zGrass::destroy_caches() {
    // Local variables
    struct grass_cache * cache; // r31
    struct grass_cache * end_cache; // r29
}

// Range: 0x801F6C50 -> 0x801F6C64
void zGrass::reset_cache(struct grass_cache & cache /* r4 */) {}

// Range: 0x801F6C64 -> 0x801F6CE0
// this: r31
void zGrass::reset_view_area() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6438D
// Range: 0x801F6CE0 -> 0x801F6D88
// this: r30
struct clone_node * zGrass::alloc_clone() {
    // Local variables
    struct clone_node * clone; // r31
...
// Range: 0x801F6D88 -> 0x801F7000
// this: r24
void zGrass::refresh_density(union grass_mesh_tri & tri /* r30 */) {
    // Local variables
    struct knoll_type & knoll; // r29
    const struct zGrassMeshVertex & A; // r31
    const struct zGrassMeshVertex & B; // r28
    const struct zGrassMeshVertex & C; // r27
    float ABx; // f30
    float ABy; // f29
    float ABz; // f28
    float ACx; // f27
...
// Range: 0x801F7000 -> 0x801F706C
// this: r30
void zGrass::refresh_density() {
    // Local variables
    union grass_mesh_tri * tri; // r31
    union grass_mesh_tri * end_tri; // r29
}

// Range: 0x801F706C -> 0x801F7138
// this: r30
void zGrass::allocate_grid_cell_boxes() {
    // Local variables
    int grid_size; // r28
    int nonempty_cells; // r29
    int i; // r31
    struct grid_cell & gcell; // r27
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80522FD8
// Range: 0x801F7138 -> 0x801F7648
// this: r30
void zGrass::refresh_grid_cell_boxes() {
    ...
    float zlower; // f20
    float zupper; // f19
    const union grass_mesh_tri * tri; // r29
    const union grass_mesh_tri * const end_tri; // r19
    const struct knoll_type & knoll; // r26
    const struct grass_cache & cache; // r22
    float atomic_radius; // r1+0x18
    const struct zGrassMeshVertex & v0; // r28
    float xtrilower; // f31
    float xtriupper; // f30
    float ytrilower; // f29
    float ytriupper; // f28
    ...
    float maxheight; // f18
    int vi; // r23
    const struct zGrassMeshVertex & v; // r31
    float height; // r1+0x14
    float width; // r1+0x10
    float radius_scale; // r1+0xC
    float radius; // f25
    struct xBox & box; // r21
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D64399
// Range: 0x801F7648 -> 0x801F7E50
// this: r31
void zGrass::partition_meshes() {
    // Local variables
    struct knoll_type * knoll; // r29
    struct knoll_type * const end_knoll; // r18
    float xlower; // f31
    float xupper; // f30
    float ylower; // f29
    float yupper; // f28
    ...
    float zupper; // f26
    int grid_size; // r22
    union grass_mesh_tri * otri; // r30
    union grass_mesh_tri * const end_otri; // r17
    int i; // r23
    struct knoll_type & knoll; // r28
    struct zGrassMeshFace * itri; // r27
    struct zGrassMeshFace * end_itri; // r1+0x2C
    const struct xVec3 & p0; // r1+0x28
    const struct xVec3 & p1; // r1+0x24
    const struct xVec3 & p2; // r1+0x20
    int grid_index; // r1+0x1C
    int tri_index; // r25
    int tri_total; // r1+0x18
    int i; // r26
    int grid_index; // r1+0x14
    int tri_size; // r21
    int cache_index; // r1+0x10
    int knoll_index; // r20
    int source_index; // r1+0xC
    const struct knoll_type & knoll; // r19
    const struct zGrassMeshFace & itri; // r24

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D643AA
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801F7E50 -> 0x801F8698
// this: r24
void zGrass::emit_clones(struct clone_node * & clones /* r23 */, struct clone_node * & last_clone /* r20 */, const union grass_mesh_tri & tri /* r25 */) {
    // Local variables
    struct knoll_type & knoll; // r28
    int emit; // r22
    unsigned char cache_index; // r19
    struct RpAtomic * atomic; // r18
    const struct xSphere & atomic_sphere; // r21
    struct xVec3 atomic_center; // r1+0x38
    float atomic_radius; // f25
    const struct zGrassMeshVertex & v0; // r31
    const struct zGrassMeshVertex & v1; // r30
    const struct zGrassMeshVertex & v2; // r29
    float rand_width_min; // f24
    float rand_width_scale; // f23
    float rand_height_min; // f22
    float rand_height_scale; // f21
    float rand_intensity_min; // f20
    float rand_intensity_scale; // f19
    float width_min; // f18
    float height_min; // r1+0x34
    int orient; // r1+0x30
    float animate; // r1+0x2C
    float s; // r1+0x28
    float t; // r1+0x24
    float v; // f31
    float rand_height; // r1+0x20
    float height; // f29
    float rand_width; // r1+0x1C
    float width; // f30
    float orient; // f28
    struct clone_node * clone; // r26
    float intensity; // f27
    float r; // r1+0x18
    float g; // r1+0x14
    float b; // r1+0x10
    struct xMat4x3 & mat; // r27
    struct xMat3x3 rot_mat; // r1+0xE0
    struct xMat3x3 norm_mat; // r1+0xB0
    struct xMat3x3 rot_mat; // r1+0x80
    struct xMat3x3 norm_mat; // r1+0x50
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D643B6
// Range: 0x801F8698 -> 0x801F889C
// this: r28
void zGrass::populate_cell(struct view_cell & vcell /* r31 */, int grid_index /* r1+0x8 */) {
    // Local variables
    struct grid_cell & gcell; // r29
    const union grass_mesh_tri * tri; // r30
    const union grass_mesh_tri * const end_tri; // r27
    struct clone_node * clones; // r1+0x10
    struct clone_node * last_clone; // r1+0xC

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D643C4
// Range: 0x801F889C -> 0x801F896C
// this: r30
void zGrass::wipe_cell(struct view_cell & vcell /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D643CE
// Range: 0x801F896C -> 0x801F9090
// this: r31
void zGrass::displace_view_area(int new_xlower /* r25 */, int new_xupper /* r21 */, int new_zlower /* r26 */, int new_zupper /* r22 */) {
    // Local variables
    int old_xlower; // r28
    int old_xupper; // r24
    int old_zlower; // r27
    ...
    int begin_iz; // r17
    int end_iz; // r1+0x30
    int next_cells; // r1+0x2C
    int iz; // r30
    int ix; // r29
    unsigned char out_new; // r1+0xF
    unsigned char out_old; // r1+0xE
    struct view_cell & vcell; // r20
    struct view_cell & vcell; // r1+0x28
    struct view_cell & icell; // r1+0x24
    struct view_cell & ocell; // r1+0x20
...
// Range: 0x801F90BC -> 0x801F919C
int zGrass::frustum_test_box(const struct xBox & box /* r31 */) {
    // Local variables
...
// Range: 0x801F919C -> 0x801F9220
unsigned char zGrass::cull_clones(struct clone_node * clones /* r1+0x8 */) {
    // Local variables
    int total; // r30
...
// Range: 0x801F9220 -> 0x801F93B8
// this: r30
void zGrass::fade_cell_alpha(struct view_cell & vcell /* r29 */) {
    // Local variables
    float dist_fade; // f29
    float dist_fade2; // f31
    float dist_cull; // f28
    float dist_cull2; // f27
    float tscale; // f24
    float xcenter; // f23
    float zcenter; // f22
    struct clone_node * clone; // r31
...
// Range: 0x801F93B8 -> 0x801F9428
// this: r1+0x8
void zGrass::unfade_cell_alpha(struct view_cell & vcell /* r30 */) {
    // Local variables
    struct clone_node * clone; // r31
}

// Range: 0x801F9428 -> 0x801F97EC
// this: r31
void zGrass::process_view_area() {
    // Local variables
    struct view_cell (& vcells)[24][24]; // r21
    int originx; // r24
    int sizex; // r20
    int originz; // r23
    int sizez; // r19
    ...
    int ix; // r17
    int grid_index; // r26
    struct grid_cell & gcell; // r22
    const struct xBox & box; // r25
    struct view_cell & vcell; // r30
    float xnear; // f28
    float xzdist2; // f25
    struct clone_node * clone; // r29
}

// Range: 0x801F97EC -> 0x801F9A0C
// this: r31
...
// Range: 0x801F9A0C -> 0x801F9A84
// this: r31
void zGrass::begin_render() {
    // References
    // -> static int alpha_compare;
    // -> struct zGlobals globals;
}

// Range: 0x801F9A84 -> 0x801F9AC4
// this: r1+0x8
void zGrass::end_render() {
    // References
    // -> struct zGlobals globals;
}
...
// Range: 0x801F9AC4 -> 0x801F9BD0
// this: r1+0x10
void zGrass::render_clones(struct RpAtomic * atomic /* r28 */, struct clone_node * * output /* r30 */, int size /* r1+0x14 */) {
    // Local variables
    struct RwFrame * frame; // r27
    struct RpGeometry * geom; // r29
    struct RpMaterial * material; // r26
    int i; // r31
    struct xMat4x3 temp_mat; // r1+0x20

    // References
    // -> static int alpha_compare;
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D643E1
// Range: 0x801F9BD0 -> 0x801F9E1C
// this: r31
void zGrass::render_view_area() {
    // Local variables
    struct view_cell (& vcells)[24][24]; // r20
    int sizex; // r19
    int sizez; // r18
    struct clone_node * * output_buffer; // r23
    int output_size[8]; // r1+0x8
    int i; // r27
    int viz; // r26
    int vix; // r25
    struct view_cell & vcell; // r24
    struct clone_node * clone; // r30
    int cache_index; // r22
    int & size; // r28
    struct clone_node * & output; // r21
    int i; // r29
...
// Range: 0x801F9E1C -> 0x801F9ED4
// this: r31
void zGrass::create_white_light() {
    // Local variables
    unsigned int & total; // r30
}

// Range: 0x801F9ED4 -> 0x801F9F04
// this: r1+0x8
void zGrass::destroy_white_light() {}

// Range: 0x801F9F04 -> 0x801FA03C
// this: r31
void zGrass::refresh_animation_waves() {
    // Local variables
    int i; // r30
    float angle; // f31
}

// Range: 0x801FA03C -> 0x801FA16C
// this: r31
...
// Range: 0x801FA16C -> 0x801FA260
// this: r31
void zGrass::update_animation_waves(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r30
}

static char * orient_labels[3]; // size: 0xC, address: 0x80D643F4
// Range: 0x801FA260 -> 0x801FA570
void zGrass::add_knoll_tweaks(struct knoll_type & knoll /* r31 */) {
    // Local variables
    const char * name; // r29
    char prefix[256]; // r1+0x10
    struct asset_type & a; // r30

    // References
    // -> static struct tweak_callback cb_reset;
    // -> static char * orient_labels[3];
    // -> static struct tweak_callback cb_refresh_density;
}

enum /* @enum$1058zGrass_cpp */ {
    ORIENT_UP = 0,
    ORIENT_ROTATE = 1,
    ORIENT_SKEW = 2,
    MAX_ORIENT = 3,
};
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D64400
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x801FA570 -> 0x801FB1D4
// this: r31
void zGrass::debug_render() {
    // Local variables
    int begin_ix; // r1+0xFC
    int end_ix; // r1+0xF8
    int begin_iz; // r1+0xF4
    int end_iz; // r1+0xF0
    int iz; // r22
    int ix; // r21
    int vix; // r1+0xEC
    int viz; // r1+0xE8
    struct view_cell & vcell; // r1+0xE4
    int grid_index; // r1+0xE0
    struct grid_cell & gcell; // r19
    float x; // f31
    float y; // f30
    float z; // f29
    const union grass_mesh_tri * tri; // r26
    const union grass_mesh_tri * const end_tri; // r1+0xDC
    struct knoll_type & knoll; // r18
    const struct zGrassMeshVertex & v0; // r1+0xD8
    const struct zGrassMeshVertex & v1; // r1+0xD4
    const struct zGrassMeshVertex & v2; // r1+0xD0
    const struct xBox & box; // r1+0xCC
    int tri_passes; // r23
    int total_tris; // r1+0xC8
    int begin_ix; // r1+0xC4
    int end_ix; // r1+0xC0
    int begin_iz; // r1+0xBC
    int end_iz; // r1+0xB8
    int iz; // r17
    int ix; // r1+0xB4
    int vix; // r1+0xB0
    int viz; // r1+0xAC
    struct view_cell & vcell; // r1+0xA8
    int grid_index; // r1+0xA4
    struct grid_cell & gcell; // r1+0xA0
    struct RxObjSpace3DVertex * vert_buffer; // r1+0x9C
    struct RxObjSpace3DVertex * vert; // r27
    int iz; // r1+0x98
    int ix; // r1+0x94
    int vix; // r1+0x90
    int viz; // r1+0x8C
    struct view_cell & vcell; // r1+0x88
    int grid_index; // r1+0x84
    struct grid_cell & gcell; // r1+0x80
    const union grass_mesh_tri * tri; // r25
    const union grass_mesh_tri * const end_tri; // r1+0x7C
    struct knoll_type & knoll; // r1+0x78
    const struct zGrassMeshVertex & v0; // r30
    const struct zGrassMeshVertex & v1; // r29
    const struct zGrassMeshVertex & v2; // r28
    int grid_size; // r1+0x74
    int ix; // r1+0x70
    int iz; // r1+0x6C
    struct grid_cell & cell; // r1+0x68
    float x; // f28
    float y; // f27
    float z; // f26
    const union grass_mesh_tri * tri; // r24
    const union grass_mesh_tri * const end_tri; // r1+0x64
    struct knoll_type & knoll; // r1+0x60
    const struct zGrassMeshVertex & v0; // r1+0x5C
    const struct zGrassMeshVertex & v1; // r1+0x58
    const struct zGrassMeshVertex & v2; // r1+0x54
    struct view_cell (& vcells)[24][24]; // r1+0x50
    int sizex; // r1+0x4C
    int sizez; // r1+0x48
    int clone_count; // r1+0x44
    int viz; // r1+0x40
    int vix; // r1+0x3C
    struct view_cell & vcell; // r1+0x38
    struct clone_node * clone; // r20

    // References
    // -> struct xColor_tag g_MAGENTA;
    // -> static int render_clone_bounds;
    // -> struct xGlobals * xglobals;
    // -> struct xColor_tag g_ORANGE;
    // -> static int render_cell;
    // -> static unsigned char render_mesh_height;
    // -> static unsigned char render_mesh_density;
    // -> static unsigned char render_mesh_color;
...
// Range: 0x801FB1D4 -> 0x801FB234
static void set_vert(struct RxObjSpace3DVertex & vert /* r3 */, float x /* f1 */, float y /* f2 */, float z /* f3 */, unsigned char r /* r4 */, unsigned char g /* r5 */, unsigned char b /* r6 */, unsigned char a /* r7 */) {
    // Local variables
    struct RwV3d tmp; // r1+0xC
    struct RwRGBA col; // r1+0x8
}

// Range: 0x801FB234 -> 0x801FB2A0
static void set_vert(struct RxObjSpace3DVertex & vert /* r3 */, const struct xVec3 & loc /* r4 */, unsigned char r /* r5 */, unsigned char g /* r6 */, unsigned char b /* r7 */, unsigned char a /* r8 */) {
    // Local variables
    struct RwV3d tmp; // r1+0xC
    struct RwRGBA col; // r1+0x8
}
...
// Range: 0x801FB2A0 -> 0x801FB2C0
void zGrass::on_reset() {}

// Range: 0x801FB2C0 -> 0x801FB2E8
void zGrass::on_refresh_density() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x801FB2E8 -> 0x801FB364
void zGrass::on_refresh_wave_dir(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct wave_params & wave; // r31
    float angle; // f31
}

static struct tweak_callback cb_refresh_wave_dir; // size: 0x28, address: 0x804B92A8
// Range: 0x801FB364 -> 0x801FB4E0
// this: r30
void zGrass::add_wave_tweaks() {
    // Local variables
    const char * root_prefix; // r29
    int i; // r31
    char prefix[128]; // r1+0x8

    // References
    // -> static struct tweak_callback cb_refresh_wave_dir;
    // -> static struct tweak_callback cb_reset;
}
