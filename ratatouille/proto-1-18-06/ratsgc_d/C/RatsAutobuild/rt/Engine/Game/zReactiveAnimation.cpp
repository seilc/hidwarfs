/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zReactiveAnimation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80210B44 -> 0x80213AD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float anim_blend_time; // size: 0x4, address: 0x80D64728
static float heat; // size: 0x4, address: 0x80D6AE08
static float damage; // size: 0x4, address: 0x80D6AE0C
static float knockback; // size: 0x4, address: 0x80D6AE10
static float burnt_color; // size: 0x4, address: 0x80D6472C
// Range: 0x80210B44 -> 0x80210C60
static void add_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float burnt_color;
...
static int total_reactives; // size: 0x4, address: 0x80D6AE14
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$901zReactiveAnimation_cpp */ {
    // Members
...
struct zReactiveGenre {
    // Members
    struct RpAtomic * model_static; // offset 0x0, size 0x4
    struct RpAtomic * model_bound; // offset 0x4, size 0x4
    struct RpAtomic * model_burnt; // offset 0x8, size 0x4
    enum iSndGroupHandle sound_idle; // offset 0xC, size 0x4
    enum iSndGroupHandle sound_move_through; // offset 0x10, size 0x4
    enum iSndGroupHandle sound_hit; // offset 0x14, size 0x4
    struct xAnimTable * table; // offset 0x18, size 0x4
    struct xAnimState * anim_idle; // offset 0x1C, size 0x4
    struct xAnimState * anim_move_through; // offset 0x20, size 0x4
    struct xAnimState * anim_hit; // offset 0x24, size 0x4
    struct xAnimState * anim_burn; // offset 0x28, size 0x4
    float lod_dist2; // offset 0x2C, size 0x4
    float burn_fuel; // offset 0x30, size 0x4
    float burn_flame_size; // offset 0x34, size 0x4
    float burn_emit_scale; // offset 0x38, size 0x4
    float move_through_radius2; // offset 0x3C, size 0x4
    char * name; // offset 0x40, size 0x4
};
static struct zReactiveGenre * genres; // size: 0x4, address: 0x80D6AE18
static int genres_size; // size: 0x4, address: 0x80D6AE1C
// total size: 0x20
struct xLinkAsset {
    // Members
...
union /* @class$1040zReactiveAnimation_cpp */ {
...
// total size: 0xC
struct /* @class$1039zReactiveAnimation_cpp */ {
    // Members
...
struct zReactiveAnimationData {
    // Members
    int kill_flags; // offset 0x0, size 0x4
    struct zEntSimpleObj * owner; // offset 0x4, size 0x4
    struct zReactiveGenre * genre; // offset 0x8, size 0x4
    enum xSndHandle sound_idle_handle; // offset 0xC, size 0x4
};
static struct zReactiveAnimationData * activities; // size: 0x4, address: 0x80D6AE20
static int activities_size; // size: 0x4, address: 0x80D6AE24
static int activities_used; // size: 0x4, address: 0x80D6AE28
// total size: 0x60
struct property_set {
    // Members
...
static struct property_set fire_props; // size: 0x60, address: 0x80D181D0
// Range: 0x80210C60 -> 0x80210C68
static unsigned int AlwaysConditional() {}

// Range: 0x80210C68 -> 0x80210C88
static void on_respawn_all() {}

// Range: 0x80210C88 -> 0x80210CC8
static void on_change_burn_fuel(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
}
...
// total size: 0xC
struct /* @class$842zReactiveAnimation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zReactiveAnimation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zReactiveAnimation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zReactiveAnimation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zReactiveAnimation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zReactiveAnimation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zReactiveAnimation_cpp */ {
    // Members
...
static struct tweak_callback cb_respawn_all; // size: 0x28, address: 0x804BBCC8
// Range: 0x80210CC8 -> 0x80210D28
static void add_global_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static struct tweak_callback cb_respawn_all;
}

static struct tweak_callback cb_burn_fuel; // size: 0x28, address: 0x804BBCF0
// Range: 0x80210D28 -> 0x80210E34
static void add_tweaks(const char * name /* r1+0x8 */, struct zReactiveGenre & genre /* r31 */) {
    // Local variables
    char prefix[128]; // r1+0xC

    // References
    // -> static struct tweak_callback cb_burn_fuel;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64730
// Range: 0x80210E34 -> 0x80211048
static struct xAnimState * add_anim_state(struct xAnimTable * table /* r25 */, unsigned int id /* r31 */, const char * name /* r26 */, struct xAnimState * transitionTo /* r29 */, unsigned char loop /* r1+0x18 */) {
    // Local variables
    void * anim_data; // r28
    struct xAnimFile * afile; // r27
    unsigned int end; // r30
    struct xAnimState * state; // r24

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6473F
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6474F
// total size: 0x3C
struct asset_entry {
    // Members
    unsigned int model_static; // offset 0x0, size 0x4
    unsigned int model_bound; // offset 0x4, size 0x4
    float lod_dist; // offset 0x8, size 0x4
    unsigned int anim_idle; // offset 0xC, size 0x4
    unsigned int anim_move_through; // offset 0x10, size 0x4
    unsigned int anim_hit; // offset 0x14, size 0x4
    unsigned int sound_idle; // offset 0x18, size 0x4
    unsigned int sound_move_through; // offset 0x1C, size 0x4
    unsigned int sound_hit; // offset 0x20, size 0x4
    unsigned int model_burnt; // offset 0x24, size 0x4
    unsigned int anim_burn; // offset 0x28, size 0x4
    float burn_fuel; // offset 0x2C, size 0x4
    float burn_flame_size; // offset 0x30, size 0x4
    float burn_emit_scale; // offset 0x34, size 0x4
    float move_through_radius; // offset 0x38, size 0x4
};
// Range: 0x80211048 -> 0x80211368
static void load_genre(struct zReactiveGenre & genre /* r31 */, const struct asset_entry & entry /* r30 */) {
    // Local variables
    unsigned int model_static_id; // r1+0x8
    char debug_name[256]; // r1+0xC

    // References
    // -> static struct zReactiveGenre * genres;
...
// total size: 0x10
struct /* @class$1824zReactiveAnimation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80211368 -> 0x80211490
static unsigned char check_flammable(struct zReactiveGenre & genre /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
    // -> struct xGlobals * xglobals;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6475A
// total size: 0x10
...
// total size: 0x10
struct asset_type : public xTableAsset {
    // Members
    struct asset_entry entries[]; // offset 0x10, size 0x0
};
// Range: 0x80211490 -> 0x8021171C
static void load_genres() {
    // Local variables
    int tables; // r25
    int i; // r28
    unsigned int asset_size; // r1+0xC
    const struct asset_type * asset; // r31
    unsigned long expected_asset_size; // r24
    struct zReactiveGenre * genre; // r30
    int i; // r27
    unsigned int asset_size; // r1+0x8
    const struct asset_type * asset; // r26
    int j; // r29

    // References
    // -> static char __FUNCTION__[12];
    // -> static struct zReactiveGenre * genres;
    // -> static int genres_size;
}

// Range: 0x8021171C -> 0x80211794
static struct zReactiveGenre * find_genre(struct zEntSimpleObj & ent /* r3 */) {
    // Local variables
    struct RpAtomic * model; // r30
    struct zReactiveGenre * genre; // r31
    struct zReactiveGenre * end_genre; // r29
...
// Range: 0x80211794 -> 0x80211800
static void setup_entity(struct zEntSimpleObj & ent /* r3 */, struct zReactiveGenre * genre /* r4 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6AE2C
static signed char init; // size: 0x1, address: 0x80D6AE2D
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64766
// total size: 0x1C
...
// Range: 0x80211800 -> 0x80211950
static void setup_entities() {
    // Local variables
    int total; // r29
    struct zScene & scene; // r28
    struct zEntSimpleObj * it; // r30
    struct zEntSimpleObj * end; // r26
    struct zEntSimpleObj & ent; // r31
    struct zReactiveGenre * genre; // r27

    // References
    // -> static int activities_size;
    // -> static struct zReactiveAnimationData * activities;
    // -> static int total_reactives;
    // -> static char __FUNCTION__[15];
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64775
// Range: 0x80211950 -> 0x802119FC
static struct zReactiveAnimationData * alloc_activity() {
    // Local variables
    struct zReactiveAnimationData * act; // r31
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D64784
// Range: 0x802119FC -> 0x80211AE0
static void free_activity(struct zReactiveAnimationData * act /* r31 */) {
    // Local variables
    struct zReactiveAnimationData * tail_act; // r30
...
// Range: 0x80211B04 -> 0x80211BC8
static void swap_model(struct zEntSimpleObj & ent /* r29 */, struct RpAtomic * atomic /* r30 */) {
    // Local variables
    struct xModelInstance * model; // r31
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64792
// Range: 0x80211BC8 -> 0x80211EAC
static unsigned char activate_entity(struct zEntSimpleObj & ent /* r31 */, struct zReactiveGenre & genre /* r28 */) {
    // Local variables
    struct xModelInstance * model; // r29
    struct xAnimPlay * play; // r27
    struct zReactiveAnimationData & react; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D647A2
// Range: 0x80211EAC -> 0x802120C0
static void set_static_model(struct zEntSimpleObj & ent /* r31 */, struct zReactiveGenre & genre /* r30 */) {
    // Local variables
    struct zSimpleMgr * temp; // r29
    unsigned int visible; // r28

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D647B3
// Range: 0x802120C0 -> 0x802121F4
static void set_burnt_model(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    struct zSimpleMgr * temp; // r29
    unsigned int visible; // r28
...
// Range: 0x802121F4 -> 0x802121FC
static struct zReactiveGenre * get_genre(struct zEntSimpleObj & ent /* r3 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D647C3
// Range: 0x802121FC -> 0x80212344
static void deactivate_entity(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r29
    struct zReactiveAnimationData & react; // r30
    unsigned char burning; // r28

    // References
    // -> static char __FUNCTION__[18];
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6AE2E
static signed char init; // size: 0x1, address: 0x80D6AE2F
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AE30
static signed char init; // size: 0x1, address: 0x80D6AE31
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AE32
static signed char init; // size: 0x1, address: 0x80D6AE33
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D647D5
// Range: 0x80212344 -> 0x802126E0
static unsigned char update_activity(struct zReactiveAnimationData & react /* r29 */, float dt /* f26 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    struct zEntSimpleObj & ent; // r31
    struct xModelInstance * model; // r28
    struct xAnimSingle * single; // r27
    struct xAnimState * state; // r26
    float time; // f31
    float duration; // f30
    float time_left; // f29
    float t; // f28
...
// Range: 0x802126E0 -> 0x80212720
static void grid_check_bound(struct xGrid & grid /* r1+0x8 */, const struct xBound & bound /* r1+0xC */, const struct xQCData & qcd /* r1+0x10 */, struct check_bound & cb /* r1+0x14 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D647E5
// Range: 0x80212720 -> 0x8021290C
static void play_anim(struct zEntSimpleObj & ent /* r25 */, struct xAnimState * state /* r26 */, float speed /* r1+0x8 */, unsigned char force_restart /* r1+0xC */) {
    // Local variables
    struct xModelInstance * model; // r29
    struct xAnimPlay * play; // r28
    struct xAnimSingle * single; // r30
    struct xAnimState * from; // r24
    struct xAnimTransition * tran; // r31
    float params[4]; // r1+0x10
...
// Range: 0x8021290C -> 0x802129AC
static unsigned char activate_if_possible(struct zEntSimpleObj & ent /* r31 */, struct zReactiveGenre & genre /* r30 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D647EF
// total size: 0x30
struct spawn_data {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x802129AC -> 0x80212B8C
static void apply_fire_damage(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    struct zReactiveAnimationData & react; // r29
    struct spawn_data fire_spawn; // r1+0x8
    float emit_radius; // f30

    // References
    // -> static struct property_set fire_props;
    // -> static float heat;
    // -> static float knockback;
    // -> static float damage;
    // -> static char __FUNCTION__[18];
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D64801
// Range: 0x80212B8C -> 0x80212C98
static void animate_hit(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
    struct zReactiveAnimationData & react; // r1+0xC
    struct xAnimSingle * single; // r29
    struct xAnimState * state; // r1+0x8

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x80212C98 -> 0x80212D04
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6480D
// Range: 0x80212D04 -> 0x80212E14
void zReactiveReset() {
    // Local variables
    struct zReactiveAnimationData * act; // r31
    struct zReactiveAnimationData * end_act; // r26
    struct zScene & scene; // r29
    struct zEntSimpleObj * it; // r30
    struct zEntSimpleObj * end; // r25
    struct zEntSimpleObj & ent; // r28
    struct zReactiveGenre * genre; // r27
...
// Range: 0x80212E14 -> 0x80212E80
void zReactiveUpdate(float dt /* r1+0x8 */) {
    // Local variables
    struct zReactiveAnimationData * act; // r31
    struct zReactiveAnimationData * end_act; // r30
...
struct check_bound {
    // Functions
    static check_bound(struct zEntSimpleObj * * hits, int max_hits, const struct xBound & bound);

    static unsigned char operator()(struct xEnt & ent);

    // Members
    struct zEntSimpleObj * * hit; // offset 0x0, size 0x4
    struct zEntSimpleObj * * end_hit; // offset 0x4, size 0x4
    const struct xBound & bound; // offset 0x8, size 0x4
};
// Range: 0x80212ED8 -> 0x80212F64
int zReactiveHitTestBound(struct zEntSimpleObj * * hits /* r30 */, int max_hits /* r1+0x8 */, const struct xBound & bound /* r31 */) {
    // Local variables
    struct check_bound cb; // r1+0xC
...
// Range: 0x80212F64 -> 0x80212F7C
// this: r3
static check_bound::check_bound(struct zEntSimpleObj * * hits /* r4 */, int max_hits /* r5 */, const struct xBound & bound /* r6 */) {}
...
// Range: 0x80212F7C -> 0x80212FC0
int zReactiveHitTestSphere(struct zEntSimpleObj * * hits /* r1+0x8 */, int max_hits /* r1+0xC */, const struct xSphere & sphere /* r1+0x10 */) {
    // Local variables
    struct xBound bound; // r1+0x14
}
...
struct check_ray {
    ...
    struct zEntSimpleObj * * hit; // offset 0x0, size 0x4
    struct zEntSimpleObj * * end_hit; // offset 0x4, size 0x4
    const struct xRay3 & ray; // offset 0x8, size 0x4
};
// total size: 0x18
struct xBox {
    // Members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x805232F0
// Range: 0x80212FC0 -> 0x80213168
unsigned char zReactiveMoveThrough(struct zEntSimpleObj & ent /* r30 */, float speed /* r1+0x8 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
    struct xVec3 diff; // r1+0xC
    struct zReactiveAnimationData & react; // r27
    struct xAnimSingle * single; // r29
...
// total size: 0x890
struct /* @class$2067zReactiveAnimation_cpp */ {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6481C
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
    zHS_EXPLOSION = 2,
...
// Range: 0x80213168 -> 0x80213270
void zReactiveDamage(struct zEntSimpleObj & ent /* r31 */, enum zHitSource hs /* r1+0x8 */, float damage /* f31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x80213270 -> 0x80213308
void zReactiveDeactivate(struct zEntSimpleObj & ent /* r31 */, unsigned char immediate /* r1+0x8 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    struct zReactiveAnimationData & react; // r29
    struct xAnimState * state; // r28
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6482C
// Range: 0x80213308 -> 0x80213438
unsigned char zReactiveSelectLOD(struct zEntSimpleObj & ent /* r31 */, float dist2 /* r1+0x8 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    unsigned char was_active; // r29
    unsigned char active; // r28
    struct zReactiveAnimationData & react; // r27
...
// Range: 0x80213438 -> 0x802134B8
int zReactiveCountExtraModels(struct zEntSimpleObj * * ents /* r1+0x8 */, unsigned int size /* r1+0xC */) {
    // Local variables
    int total; // r30
    struct zEntSimpleObj * * it; // r31
    struct zEntSimpleObj * * end; // r27
    struct zEntSimpleObj & ent; // r29
    struct zReactiveGenre & genre; // r28
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80523305
// Range: 0x802134B8 -> 0x802135CC
unsigned char zReactiveNeedExtraModel(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6483F
// Range: 0x802135CC -> 0x80213774
void zReactivePreBucket(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8052331D
// Range: 0x80213774 -> 0x80213A38
void zReactiveAddExtraSimpleMgr(struct zEntSimpleObj & ent /* r31 */, struct zSimpleMgr * smgr /* r27 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
    struct zSimpleMgr * smgr_static; // r29
    struct zSimpleMgr * smgr_burnt; // r28
    unsigned int visible; // r26
...
// Range: 0x80213A38 -> 0x80213AD4
// this: r31
static unsigned char check_bound::operator()(struct xEnt & ent /* r29 */) {
    // Local variables
    struct zEntSimpleObj & simp; // r30
}
