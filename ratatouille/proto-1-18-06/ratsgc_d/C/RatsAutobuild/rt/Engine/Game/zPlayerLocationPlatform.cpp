/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerLocationPlatform.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80319134 -> 0x80319704
*/
class zPlayerLocationPlatformConnector * head; // size: 0x4, address: 0x80D6B980
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67708
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$928zPlayerLocationPlatform_cpp */ {
    // Members
...
union /* @class$1067zPlayerLocationPlatform_cpp */ {
...
zPlayerLocationPlatformConnector::zPlayerLocationPlatformConnector(struct zPlayerLocationPlatformConnectorAsset * theAsset /* r30 */) {
    // Local variables
    class zPlayerLocationPlatformConnector * cur; // r29
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6770D
// Range: 0x803192C4 -> 0x8031948C
void zPlayerLocationPlatformConnector::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67712
// Range: 0x8031948C -> 0x803196B0
// this: r31
...
// total size: 0xC
struct /* @class$869zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$872zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$873zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$874zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$875zPlayerLocationPlatform_cpp */ {
    // Members
...
// Range: 0x803196B0 -> 0x803196F8
void zPlayerLocationPlatformConnector::UpdateAll(float dt /* r1+0x8 */) {
    // Local variables
