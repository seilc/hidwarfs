/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80186830 -> 0x8018A84C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNotSentPoolCreatedEvent; // size: 0x1, address: 0x80D631B0
// total size: 0x14
struct zNPCMgrGroupTarget {
    // Members
    unsigned char valid; // offset 0x0, size 0x1
    struct xVec3 center; // offset 0x4, size 0xC
    float distance2; // offset 0x10, size 0x4
};
struct zNPCMgrGroupTarget gNPCMgrGroupTarget; // size: 0x14, address: 0x80D6A640
// total size: 0xC
struct xModelPool {
    // Members
...
enum ezIncidentalState {
    ezINCIDENTALSTATE_Waiting = 0,
    ezINCIDENTALSTATE_Testing = 1,
    ezINCIDENTALSTATE_InProgress = 2,
    ezINCIDENTALSTATE_Completed = 3,
    ezINCIDENTALSTATE_Total = 4,
};
// total size: 0x14
struct zNPCMgrIncidental {
    // Members
    enum ezIncidentalState state; // offset 0x0, size 0x4
    class zNPCCommon * actor[1]; // offset 0x4, size 0x4
    int actorTotal; // offset 0x8, size 0x4
    float waitTime; // offset 0xC, size 0x4
    int lastTestedIdx; // offset 0x10, size 0x4
};
struct zNPCMgrIncidental gNPCIncidental[1]; // size: 0x14, address: 0x80D6A654
// total size: 0x10
struct zSurroundedBy {
    // Members
    class zNPCCommon * npc; // offset 0x0, size 0x4
    struct xVec3 moveToPos; // offset 0x4, size 0xC
};
struct zSurroundedBy gSurroundedBy[32]; // size: 0x200, address: 0x80D00F88
int gSurroundedByTotal; // size: 0x4, address: 0x80D6A668
float zNPCFreezeTimeTable[3][2]; // size: 0x18, address: 0x80D01188
float zNPCThawTimeTable[3][2]; // size: 0x18, address: 0x80D011A0
// total size: 0x18
struct creationData {
    // Members
    void (* addStaticTweaks)(); // offset 0x0, size 0x4
    void (* createTable)(struct xAnimTable *); // offset 0x4, size 0x4
    void (* initCombatDamage)(); // offset 0x8, size 0x4
    class zNPCInstance * (* createInstance)(void *, struct xModelAssetInfo *, unsigned int, struct zNPCAssetIN2 *, int); // offset 0xC, size 0x4
    unsigned int instanceSize; // offset 0x10, size 0x4
    unsigned int dataSize; // offset 0x14, size 0x4
};
static struct creationData g_creationData[3]; // size: 0x48, address: 0x8051F5F8
// Range: 0x80186830 -> 0x8018689C
static class zNPCInstance * create(void * object /* r1+0x8 */, const struct xModelAssetInfo * model_asset /* r1+0xC */, unsigned int type /* r1+0x10 */, struct zNPCAssetIN2 * npc_asset /* r1+0x14 */, int npc_asset_size /* r1+0x18 */) {}

// Range: 0x8018689C -> 0x80186908
static class zNPCInstance * create(void * object /* r1+0x8 */, const struct xModelAssetInfo * model_asset /* r1+0xC */, unsigned int type /* r1+0x10 */, struct zNPCAssetIN2 * npc_asset /* r1+0x14 */, int npc_asset_size /* r1+0x18 */) {}

// total size: 0xC
struct {} zNPCChef::inst_type::__vtable; // size: 0xC, address: 0x80D6327C
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0xC
struct {} zNPCThiefOld::inst_type::__vtable; // size: 0xC, address: 0x80D63270
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0x60
...
// total size: 0x4
struct /* @class$2110zNPCMgr_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2111zNPCMgr_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zNPCMgr_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zNPCMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zNPCMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zNPCMgr_cpp */ {
    // Members
...
static int g_poolSize[3]; // size: 0xC, address: 0x80D631B4
static int g_modinit; // size: 0x4, address: 0x80D6A66C
static struct zNPCMgr * g_npcmgr; // size: 0x4, address: 0x80D6A670
static float ONE_LINER_NO_ENEMIES_TIME; // size: 0x4, address: 0x80D631C0
// Range: 0x80186908 -> 0x8018694C
void zNPCSetupFreezeAndThawTimeTable() {
    // References
    // -> float zNPCThawTimeTable[3][2];
    // -> float zNPCFreezeTimeTable[3][2];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D631C4
...
// Range: 0x8018694C -> 0x80186DFC
static void event_wrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r21 */, unsigned int toEvent /* r22 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r1+0xC */) {
    // Local variables
    class zNPCInstance * inst; // r31
    struct zNPCMgr * mgr; // r26
    struct xVec3 * pos; // r28
    struct zNPCMgr * mgr; // r25
    class zNPCBaseIN2 * data; // r27
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D631D2
// Range: 0x80186DFC -> 0x80186E7C
struct zNPCMgr * zNPCMgrSelf() {
    // References
    // -> static struct zNPCMgr * g_npcmgr;
    // -> static char __FUNCTION__[12];
}

// Range: 0x80186E7C -> 0x80186EA0
void zNPCMgr_findRumbles() {}

// Range: 0x80186EA0 -> 0x80186EC8
struct st_XORDEREDARRAY * zNPCMgr_GetNPCList() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D631DE
// Range: 0x80186EC8 -> 0x80186F9C
...
struct zNPCRumble {
    // Members
    struct sphericalEmitter * emitter; // offset 0x0, size 0x4
};
// total size: 0x1D8
struct zNPCMgr : public RyzMemData {
    // Functions
    void SwitchedNavmeshes();

    void Startup();

    void FindRumbleFx();

    void ScenePrepare(int cnt);

    void SceneFinish();

    void SceneReset();

    void FillInAllocOrder(class zNPCInstance * * array, enum en_npctyp type);
    ...
    void ScenePostRenderCleanup();

    void SceneRender();

    void SceneRenderFreezing();

    void KillAll();

    void PostCreate(class zNPCInstance * npc);

    int PreCreateNPCs();

    class zNPCInstance * GetInstance(enum en_npctyp type, int index);

    class zNPCBaseIN2 * GetData(enum en_npctyp type, int index);

    struct xBase * CreateDynNPC(const struct xEntAsset * ent_asset, const struct xDynAsset * dyn_asset, int siz_dynass);

    int FindFreeData(class zNPCBaseIN2 * * array, enum en_npctyp type, const struct xVec3 & pos);

    unsigned char GetFreePoolData(class zNPCInstance * inst, int freeIndex);

    void SceneTimestep(struct xScene * xscn, float dt);

    // Members
    struct st_XORDEREDARRAY npclist; // offset 0x0, size 0x10
    struct xBase selfbase; // offset 0x10, size 0x10
    class zNPCSquadMeleeAttack meleeAttackSquad[4]; // offset 0x20, size 0x120
    void * npcPool[3]; // offset 0x140, size 0xC
    int poolCount[3]; // offset 0x14C, size 0xC
    void * instanceList[3]; // offset 0x158, size 0xC
    int instanceCount[3]; // offset 0x164, size 0xC
    float npcOutOfRangeTimer; // offset 0x170, size 0x4
    struct zNPCRumble rumblePool[5][5]; // offset 0x174, size 0x64
};
// Range: 0x80186F9C -> 0x80187000
...
// Range: 0x80187000 -> 0x80187034
void zNPCMgr_scenePrepare(int npccnt /* r1+0x8 */) {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187034 -> 0x80187060
void zNPCMgr_sceneInit() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187060 -> 0x8018708C
void zNPCMgr_sceneSetup() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x8018708C -> 0x801870B8
void zNPCMgr_sceneFinish() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x801870B8 -> 0x801870E4
void zNPCMgr_sceneExit() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x801870E4 -> 0x80187110
void zNPCMgr_sceneReset() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187110 -> 0x8018713C
void zNPCMgr_scenePostInit() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x8018713C -> 0x80187178
void zNPCMgr_sceneTimestep(struct xScene * xscn /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    struct zNPCMgr * mgr; // r31
}
...
// Range: 0x80187178 -> 0x801871A4
void zNPCMgr_switchedNavmeshes() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}
...
// Range: 0x801871A4 -> 0x8018725C
// this: r29
void zNPCMgr::SwitchedNavmeshes() {
    // Local variables
    enum en_npctyp type; // r1+0x8
    int i; // r30
    class zNPCInstance * inst; // r28
    class zNPCCommon * data; // r31
}

// Range: 0x8018725C -> 0x80187288
void zNPCMgr_sceneRender() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187288 -> 0x801872B4
void zNPCMgr_sceneRenderFreezing() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x801872B4 -> 0x801872E0
void zNPCMgr_scenePostRender() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x801872E0 -> 0x8018730C
void zNPCMgr_scenePostRenderCleanup() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x8018730C -> 0x80187338
int zNPCMgr_preCreateNPCs() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187338 -> 0x80187364
void zNPCMgr_KillAll() {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x80187364 -> 0x801873A8
struct xBase * zNPCMgr_createDynNPCInst(const struct xEntAsset * assdat /* r1+0x8 */, const struct xDynAsset * dynass /* r1+0xC */, int siz_dynass /* r1+0x10 */) {
    // Local variables
    struct zNPCMgr * mgr; // r31
}

// Range: 0x801873A8 -> 0x801873C0
// this: r3
void zNPCMgr::Startup() {}

// Range: 0x801873C0 -> 0x801873C4
void zNPCMgr::Shutdown() {}

// Range: 0x801873C4 -> 0x80187554
// this: r30
void zNPCMgr::FindRumbleFx() {
    // Local variables
    char txt[128]; // r1+0x8
    unsigned int rumbleEmitID; // r31
    int i; // r29
    int i; // r28
    int i; // r27
    int i; // r26
...
// Range: 0x80187554 -> 0x801875B4
void zNPCMgr::SceneInit() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r31
}

// Range: 0x801875B4 -> 0x80187638
// this: r1+0x8
void zNPCMgr::ScenePrepare(int cnt /* r1+0xC */) {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r31

    // References
    // -> unsigned char gNotSentPoolCreatedEvent;
}

// Range: 0x80187638 -> 0x8018769C
// this: r30
void zNPCMgr::SceneFinish() {
    // Local variables
    int i; // r31
    class zNPCInstance * npc; // r29
}

// Range: 0x8018769C -> 0x80187724
void zNPCMgr::SceneExit() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r31
}
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D631EE
// Range: 0x80187724 -> 0x80187A5C
// this: r30
void zNPCMgr::SceneReset() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r27
    enum en_npctyp type; // r31+0x10
    class zNPCInstance * * instanceArray; // r29
    int i; // r25
    int i; // r24
    class zNPCBaseIN2 * data; // r22
    int i; // r28
    class zNPCBaseIN2 * data; // r26
    int i; // r23
...
// Range: 0x80187A5C -> 0x80187B5C
static unsigned char instanceCloser(const class zNPCInstance * elem1 /* r29 */, const class zNPCInstance * elem2 /* r30 */, const struct xVec3 & pos /* r31 */) {}
...
static struct xVec3 sNPCMgrSortCamPosition; // size: 0xC, address: 0x80D6A674
// Range: 0x80187B5C -> 0x80187BB4
static int instanceClosestFirstSort(void * elem1 /* r1+0x8 */, void * elem2 /* r1+0xC */) {
    // Local variables
    int icVal; // r31

    // References
    // -> static struct xVec3 sNPCMgrSortCamPosition;
}

// Range: 0x80187BB4 -> 0x80187C3C
static int dataFurthestFirstSort(void * elem1 /* r1+0x8 */, void * elem2 /* r1+0xC */) {
    // Local variables
    const class zNPCBaseIN2 * * elem1Base; // r31
    const class zNPCBaseIN2 * * elem2Base; // r30
    int icVal; // r29
...
// Range: 0x80187C3C -> 0x80187CF4
// this: r30
void zNPCMgr::FillInAllocOrder(class zNPCInstance * * array /* r28 */, enum en_npctyp type /* r29 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051F640
// Range: 0x80187CF4 -> 0x80187DFC
static void _AnimViewerSelectedCB(const struct tweak_info & info /* r28 */) {
    // Local variables
    class zNPCCommon * npc; // r31
    class behavior * curBehavior; // r27
    char * fullName; // r26
    char * animName; // r29
...
// Range: 0x80187E2C -> 0x80187FA0
static void _LogDebugInfoSelectedCB(const struct tweak_info & info /* r30 */) {
    // Local variables
    class zNPCCommon * npc; // r31
}
...
static struct tweak_callback animViewerTestCB; // size: 0x28, address: 0x804AD2F8
static struct tweak_callback logDebugInfoCB; // size: 0x28, address: 0x804AD320
static struct tweak_callback cb_active_model; // size: 0x28, address: 0x8051F658
static signed char init; // size: 0x1, address: 0x80D6A680
static struct tweak_callback cb_debug_me; // size: 0x28, address: 0x8051F680
static signed char init; // size: 0x1, address: 0x80D6A681
static struct tweak_callback cb_show_vertex; // size: 0x28, address: 0x8051F6A8
static signed char init; // size: 0x1, address: 0x80D6A682
...
// Range: 0x80187FA0 -> 0x80188440
static void _OnExpandListAllTypes() {
    // Local variables
    enum en_npctyp type; // r1+0x18
    int i; // r30
    class zNPCBaseIN2 * data; // r31
    char prefix[512]; // r1+0x314
    char _buffer[128]; // r1+0x294
    char _buffer[128]; // r1+0x214
    char _buffer[128]; // r1+0x194
    char _buffer[128]; // r1+0x114
    char _buffer[128]; // r1+0x94

    // References
    // -> static struct tweak_callback cb_debug_me;
    // -> struct xVec3 gEnt_ShowVertexLoc;
    // -> static struct tweak_callback cb_show_vertex;
    // -> int gEnt_ShowVertex;
    // -> struct xVec3 gEnt_ShowBoneLoc;
    // -> int gEnt_ShowBone;
    // -> static struct tweak_callback cb_active_model;
    // -> int gEnt_ActiveModel;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static struct tweak_callback logDebugInfoCB;
}

// Range: 0x80188440 -> 0x801884F4
static void _OnSelectListAllToggle() {
    // Local variables
    enum en_npctyp type; // r1+0x8
    int i; // r31
    class zNPCBaseIN2 * data; // r30
}

static struct tweak_callback cb_active_model; // size: 0x28, address: 0x8051F6D0
static signed char init; // size: 0x1, address: 0x80D6A683
static struct tweak_callback cb_debug_me; // size: 0x28, address: 0x8051F6F8
static signed char init; // size: 0x1, address: 0x80D6A684
static struct tweak_callback cb_show_vertex; // size: 0x28, address: 0x8051F720
static signed char init; // size: 0x1, address: 0x80D6A685
// Range: 0x801884F4 -> 0x80188988
static void _OnExpandBonesNVerts() {
    // Local variables
    enum en_npctyp type; // r1+0x18
    int i; // r30
    class zNPCBaseIN2 * data; // r31
    char prefix[128]; // r1+0x314
    char _buffer[128]; // r1+0x294
    char _buffer[128]; // r1+0x214
    char _buffer[128]; // r1+0x194
    char _buffer[128]; // r1+0x114
...
static struct tweak_callback listAllTypeTweakCB; // size: 0x28, address: 0x804AD3C8
static struct tweak_callback listAllToggleTweakCB; // size: 0x28, address: 0x804AD3F0
static struct tweak_callback bonesNVertsTweakCB; // size: 0x28, address: 0x804AD418
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D631F9
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80188988 -> 0x80188D4C
// this: r30
void zNPCMgr::ScenePostInit() {
    ...
    int i; // r28
    class zNPCBaseIN2 * data; // r26
    struct xAnimState * animNext; // r25
    char prefix[512]; // r31+0x14

    // References
    // -> static struct tweak_callback animViewerTestCB;
    // -> struct zGlobals globals;
    // -> static char __FUNCTION__[14];
    // -> static struct creationData g_creationData[3];
    // -> unsigned int gActiveHeap;
    // -> static int g_poolSize[3];
    // -> static struct tweak_callback bonesNVertsTweakCB;
    // -> static struct tweak_callback listAllToggleTweakCB;
    // -> static struct tweak_callback listAllTypeTweakCB;
}

// Range: 0x80188D4C -> 0x80188DE8
static unsigned char render_npc(class zNPCBaseIN2 * npc /* r31 */) {
    // Local variables
    class zNPCInstance * inst; // r30
}
...
// Range: 0x80188DE8 -> 0x80188F10
// this: r28
void zNPCMgr::SceneSetup() {
    // Local variables
    class zNPCBaseIN2 * npc; // r30
    enum en_npctyp type; // r1+0x8
    int i; // r29
    struct zLODTable * lod; // r31
    const char * prefix; // r27

    // References
    // -> static float ONE_LINER_NO_ENEMIES_TIME;
}

// Range: 0x80188F10 -> 0x80188FDC
// this: r29
void zNPCMgr::ScenePostRender() {
    // Local variables
    class zNPCBaseIN2 * npc; // r31
    enum en_npctyp type; // r1+0x8
    int i; // r30
}

// Range: 0x80188FDC -> 0x80189094
// this: r29
void zNPCMgr::ScenePostRenderCleanup() {
    // Local variables
    class zNPCBaseIN2 * npc; // r30
    enum en_npctyp type; // r1+0x8
    int i; // r31
...
// Range: 0x80189094 -> 0x8018914C
// this: r29
void zNPCMgr::SceneRender() {
    // Local variables
    class zNPCBaseIN2 * npc; // r30
    enum en_npctyp type; // r1+0x8
    int i; // r31
...
// Range: 0x8018914C -> 0x80189204
// this: r29
void zNPCMgr::SceneRenderFreezing() {
    // Local variables
    class zNPCBaseIN2 * npc; // r30
    enum en_npctyp type; // r1+0x8
    int i; // r31
...
// Range: 0x80189204 -> 0x801892E0
// this: r28
void zNPCMgr::KillAll() {
    // Local variables
    enum en_npctyp type; // r1+0xC
    int i; // r31
    class zNPCInstance * inst; // r30
    class zNPCBaseIN2 * data; // r29
}

// Range: 0x801892E0 -> 0x801892E4
void zNPCMgr::PreCreate() {}

// Range: 0x801892E4 -> 0x80189348
// this: r31
void zNPCMgr::PostCreate(class zNPCInstance * npc /* r30 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63207
// Range: 0x80189348 -> 0x80189430
// this: r31
int zNPCMgr::PreCreateNPCs() {
    // Local variables
    int count; // r29
    int i; // r30
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63215
enum eBrainType {
...
// Range: 0x80189430 -> 0x80189524
// this: r31
class zNPCInstance * zNPCMgr::GetInstance(enum en_npctyp type /* r30 */, int index /* r29 */) {
    // Local variables
    enum eBrainType brainType; // r28
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63221
// Range: 0x80189524 -> 0x80189618
// this: r31
class zNPCBaseIN2 * zNPCMgr::GetData(enum en_npctyp type /* r30 */, int index /* r29 */) {
    // Local variables
    enum eBrainType brainType; // r28
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D63229
// Range: 0x80189618 -> 0x80189804
// this: r30
struct xBase * zNPCMgr::CreateDynNPC(const struct xEntAsset * ent_asset /* r31 */, const struct xDynAsset * dyn_asset /* r24 */, int siz_dynass /* r1+0x8 */) {
    // Local variables
    unsigned int size; // r1+0xC
    unsigned int aid_minf; // r27
    void * thing; // r23
    const struct xModelAssetInfo * modelInfoAsset; // r28
    struct xEntAsset * hackiness; // r25
    enum en_npctyp nt; // r29
    int prevCount; // r22
    class zNPCInstance * npc; // r26
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D63236
// Range: 0x80189804 -> 0x80189940
// this: r26
int zNPCMgr::FindFreeData(class zNPCBaseIN2 * * array /* r27 */, enum en_npctyp type /* r25 */, const struct xVec3 & pos /* r1+0x8 */) {
    // Local variables
    int count; // r31
    int i; // r29
    class zNPCBaseIN2 * data; // r28
    class zNPCInstance * inst; // r30
    float dist2; // f31
...
// Range: 0x80189940 -> 0x80189A2C
void zNPCMgr::CalculateUsefulInfo() {
    // Local variables
    struct xVec3 pos0; // r1+0x14
    struct xVec3 pos1; // r1+0x8
    float dist2; // f31

    // References
    // -> struct zNPCMgrGroupTarget gNPCMgrGroupTarget;
    // -> struct xGlobals * xglobals;
}
...
static unsigned char already_asserted; // size: 0x1, address: 0x80D6A686
static signed char init; // size: 0x1, address: 0x80D6A687
static unsigned char already_asserted; // size: 0x1, address: 0x80D6A688
static signed char init; // size: 0x1, address: 0x80D6A689
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63243
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63253
// Range: 0x80189A2C -> 0x80189D28
// this: r28
unsigned char zNPCMgr::GetFreePoolData(class zNPCInstance * inst /* r31 */, int freeIndex /* r24 */) {
    // Local variables
    const struct xVec3 & centerPos; // r26
    int freeCount; // r29
    class zNPCBaseIN2 * * freeArray; // r30
    int i; // r27
    float update_dist; // f31
    float dist; // f30
    class zNPCBaseIN2 * data; // r1+0xC
...
// Range: 0x80189D28 -> 0x80189D68
static class zNPCBaseIN2 * * pushTempArray(int size /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6A68A
static signed char init; // size: 0x1, address: 0x80D6A68B
static unsigned char already_asserted; // size: 0x1, address: 0x80D6A68C
static signed char init; // size: 0x1, address: 0x80D6A68D
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63261
// Range: 0x80189D68 -> 0x8018A398
// this: r31
void zNPCMgr::SceneTimestep(struct xScene * xscn /* r1+0x8 */, float dt /* f31 */) {
    // Local variables
    int playerSize; // r1+0x30
    int i; // r27
    enum en_npctyp type; // r1+0x2C
    int i; // r26
    class zNPCInstance * npcinst; // r21
    class zNPCBaseIN2 * data; // r18
    const struct xVec3 & centerPos; // r20
    unsigned char NPCInUpdateRange; // r17
    enum en_npctyp type; // r1+0x28
    int freeIndex; // r25
    int freeCount; // r24
    class zNPCBaseIN2 * * freeArray; // r29
    int i; // r23
    class zNPCInstance * inst; // r30
    float update_dist; // f30
    float dist; // f29
    enum en_npctyp type; // r1+0x24
    int i; // r22
    class zNPCInstance * inst; // r28
    float update_dist; // f28
    float dist; // f27
    class zNPCBaseIN2 * data; // r19
...
// Range: 0x8018A398 -> 0x8018A3A4
void zNPCMgr_SurroundedReset() {
    // References
    // -> int gSurroundedByTotal;
}

// Range: 0x8018A3A4 -> 0x8018A624
void zNPCMgr_SurroundedUpdate() {
    // Local variables
    int a; // r28
    struct zSurroundedBy * npcA; // r31
    int b; // r27
    struct zSurroundedBy * npcB; // r30
    struct xVec3 vec; // r1+0x14
    float dist2; // f30
    float dist; // f29
    float distHalf; // f31
    struct xVec3 midPoint; // r1+0x8
    int i; // r29

    // References
    // -> int gSurroundedByTotal;
    // -> struct zSurroundedBy gSurroundedBy[32];
}

// Range: 0x8018A624 -> 0x8018A6A8
void zNPCIncidentalReset() {
    // Local variables
    int i; // r31

    // References
    // -> struct zNPCMgrIncidental gNPCIncidental[1];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x8051F748
// Range: 0x8018A6A8 -> 0x8018A7E4
void zNPCIncidentalUpdate(float dt /* r1+0x8 */) {
    // Local variables
    struct zNPCMgrIncidental * incidental; // r31
    int idx; // r30
    int totalPossible; // r29
...
// Range: 0x8018A7E4 -> 0x8018A84C
int zNPCMgr_OrdComp_npcid(void * vkey /* r3 */, void * vitem /* r4 */) {
    // Local variables
    int rc; // r31
    class zNPCInstance * key; // r30
    class zNPCInstance * item; // r29
}
