/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zHeistNPCInterface.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802ED354 -> 0x802F2A30
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66EB0
...
class zHeistNPCInterfaceManager {
    ...
    void ResetSelection(class zHeistLookoutPoint * lookoutPoint);

    void SelectNextGangMember(class zHeistLookoutPoint * lookoutPoint);

    void SelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint);
    ...
    void CheckSelected(class zHeistLookoutPoint * lookoutPoint);

    // Members
protected:
    class zHeistNPCDetectorEnemyInterfaceManager * heistNPCDetectorEnemyInterfaceManager; // offset 0x0, size 0x4
    class zHeistGangMemberInterfaceManager * heistGangMemberInterfaceManager; // offset 0x4, size 0x4
};
// Range: 0x802ED354 -> 0x802ED3E4
// this: r31
void zHeistNPCInterfaceManager::Init() {
    // References
    // -> static char __FUNCTION__[5];
    // -> unsigned int gActiveHeap;
}

// Range: 0x802ED3E4 -> 0x802ED42C
// this: r31
void zHeistNPCInterfaceManager::Exit() {}

// Range: 0x802ED42C -> 0x802ED464
// this: r31
void zHeistNPCInterfaceManager::RenderOverlays() {}
...
// Range: 0x802ED464 -> 0x802ED620
// this: r31
void zHeistNPCInterfaceManager::Update(float dt /* f31 */) {
    // Local variables
    int numDetectors; // r24
    struct zCommonPlayer * player; // r29
    int i; // r26
    class zHeistNPCDetectorEnemyInterface * detector; // r30
    struct xVec3 playerCenter; // r1+0x14
    unsigned int hasBeenDetected; // r28
    int numGangMembers; // r23
    int j; // r25
    class zHeistGangMemberInterface * gangMember; // r27
    struct xVec3 gangMemberLoc; // r1+0x8
...
// total size: 0x1C
struct zHeistGangMemberInterfaceAsset : public xDynAsset {
    // Members
    unsigned int gangMemberId; // offset 0x10, size 0x4
    unsigned int startingPathId; // offset 0x14, size 0x4
    float speed; // offset 0x18, size 0x4
};
// total size: 0x4
struct PrivateFlags {
    // Members
    unsigned char atStart : 1; // offset 0x0, size 0x1
    unsigned char on : 1; // offset 0x0, size 0x1
    unsigned int pad : 30; // offset 0x0, size 0x4
};
// total size: 0x38
class zHeistGangMemberInterface : public xBase {
    // Functions
    zHeistGangMemberInterface(struct zHeistGangMemberInterfaceAsset * theAsset);

    void EventCB(unsigned int toEvent, const float * toParam, struct xBase * toParamWidget);

    void SceneEnter();

    void RenderOverlay(int selectedGangMember);

    void Update(float dt);

    void GetLocation(struct xVec3 * gangMemberLoc);

    // Static members
    static class zHeistGangMemberInterfaceManager * gangMemberInterfaceManager; // size: 0x4

    // Members
protected:
    int interfaceArrayIdx; // offset 0x10, size 0x4
    struct zHeistGangMemberInterfaceAsset * gangMemberAsset; // offset 0x14, size 0x4
    struct xEnt * gangMember; // offset 0x18, size 0x4
    int currPathIdx; // offset 0x1C, size 0x4
    struct zHeistGangMemberPrototypeNavData navData; // offset 0x20, size 0x8
    int actionType; // offset 0x28, size 0x4
    struct xBase * actionObject; // offset 0x2C, size 0x4
    class zHeistMovementPath * lastPath; // offset 0x30, size 0x4
    struct PrivateFlags privateFlags; // offset 0x34, size 0x4
};
// total size: 0x10
class zHeistGangMemberInterfaceManager {
    // Functions
    void Init();
    ...
    int AddToInterfaceCount();

    void RegisterInterface(class zHeistGangMemberInterface * regInterface);

    void InsertInterface(class zHeistGangMemberInterface * insInterface, int idx);

    void PlayerSelectNextGangMember(class zHeistLookoutPoint * lookoutPoint);

    void PlayerSelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint);

    void PlayerSelectNextPath();

    void PlayerSelectPrevPath();

    void ExecuteCommand();

    unsigned char ValidSelectedGangMember(class zHeistLookoutPoint * lookoutPoint);

    void CheckSelectedPath();

    // Members
protected:
    int gangMemberInterfaceCount; // offset 0x0, size 0x4
    class zHeistGangMemberInterface * * interfaceArray; // offset 0x4, size 0x4
    class zHeistMovementPathManager * heistMovementPathManager; // offset 0x8, size 0x4
    int selectedGangMemberIdx; // offset 0xC, size 0x4
};
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct zHeistNPCDetectorPrivateFlags {
    // Members
    unsigned char hasPatrolRoute : 1; // offset 0x0, size 0x1
    unsigned char detectionEnabled : 1; // offset 0x0, size 0x1
    unsigned int Pad : 30; // offset 0x0, size 0x4
};
// total size: 0x8
struct xBaseAsset {
...
// total size: 0x38
struct zHeistNPCDetectorEnemyInterfaceAsset : public xDynAsset {
    // Members
    unsigned int objId; // offset 0x10, size 0x4
    unsigned int startingMovePointId; // offset 0x14, size 0x4
    float detectionRadius; // offset 0x18, size 0x4
    float detectionFOV; // offset 0x1C, size 0x4
    float alertRadius; // offset 0x20, size 0x4
    float alertFOV; // offset 0x24, size 0x4
    float detectionHeight; // offset 0x28, size 0x4
    float detectBelowDist; // offset 0x2C, size 0x4
    float speed; // offset 0x30, size 0x4
    int renderFOVLines; // offset 0x34, size 0x4
};
// total size: 0x50
...
// total size: 0x4
struct /* @class$928zHeistNPCInterface_cpp */ {
    // Members
...
union /* @class$1067zHeistNPCInterface_cpp */ {
...
// total size: 0xC
struct /* @class$1066zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x8
class zHeistDistractionObjectManager {
    // Members
protected:
    class zHeistDistractionObject * * objectArray; // offset 0x0, size 0x4
    int objectCount; // offset 0x4, size 0x4
};
// total size: 0x28
struct zHeistDistractionObjectAsset : public zTriggerInteractionAsset {
    // Members
    unsigned int enemyToDistractId; // offset 0x18, size 0x4
    unsigned int distractionPointId; // offset 0x1C, size 0x4
    float distractionTime; // offset 0x20, size 0x4
    float distractionDelay; // offset 0x24, size 0x4
};
// total size: 0x48
class zHeistDistractionObject : public zTriggerInteraction {
    // Static members
    static class zHeistDistractionObjectManager * heistDistractionObjectManager; // size: 0x4

    // Members
protected:
    struct xEnt * distractEnt; // offset 0x30, size 0x4
    struct xMovePoint * distractPoint; // offset 0x34, size 0x4
    float distractTime; // offset 0x38, size 0x4
    float distractDelay; // offset 0x3C, size 0x4
    float timer; // offset 0x40, size 0x4
    int objectArrayIdx; // offset 0x44, size 0x4
};
// total size: 0x4C
class zHeistNPCDetectorEnemyInterface : public xBase {
    // Functions
    void BuildPatrolRoute();

    class zNPCBase * GetNPCBase();

    int NextPatrolPoint();

    zHeistNPCDetectorEnemyInterface(struct zHeistNPCDetectorEnemyInterfaceAsset * theAsset);

    void EventCB(struct xBase * from, unsigned int toEvent, const float * toParam, struct xBase * toParamWidget);
    ...
    unsigned int Detect(struct xVec3 * location);

    void ShowViewBlockerSafeAreas(class zHeistNPCDetectorViewBlocker * blocker);

    // Static members
    static class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager; // size: 0x4

    // Members
protected:
    struct zHeistNPCDetectorPrivateFlags privateFlags; // offset 0x10, size 0x4
    struct zHeistNPCDetectorEnemyInterfaceAsset * npcAsset; // offset 0x14, size 0x4
    struct xBase * objBase; // offset 0x18, size 0x4
    struct xEnt * detectedObj; // offset 0x1C, size 0x4
    int interfaceArrayIdx; // offset 0x20, size 0x4
    int currentPoint; // offset 0x24, size 0x4
    int numPatrolPoints; // offset 0x28, size 0x4
    struct xMovePoint * * patrolRoute; // offset 0x2C, size 0x4
    int detectionState; // offset 0x30, size 0x4
    struct xMovePoint * destinationPoint; // offset 0x34, size 0x4
    float distractTimer; // offset 0x38, size 0x4
    class zHeistDistractionObject * distractor; // offset 0x3C, size 0x4
    float detectionFOV; // offset 0x40, size 0x4
    float alertFOV; // offset 0x44, size 0x4
    struct xColor_tag safeAreaColor; // offset 0x48, size 0x4
};
// total size: 0x10
class zHeistNPCDetectorEnemyInterfaceManager {
    // Functions
    void Init();
    ...
    int AddToViewBlockerCount();

    void RegisterInterface(class zHeistNPCDetectorEnemyInterface * regInterface);

    void InsertInterface(class zHeistNPCDetectorEnemyInterface * insInterface, int idx);

    void RegisterViewBlocker(class zHeistNPCDetectorViewBlocker * regViewBlocker);

    void InsertViewBlocker(class zHeistNPCDetectorViewBlocker * insViewBlocker, int idx);

    unsigned char IsBlocked(struct xVec3 * viewPos, struct xVec3 * lookPos);

    // Members
protected:
    int interfaceCount; // offset 0x0, size 0x4
    int viewBlockerCount; // offset 0x4, size 0x4
    class zHeistNPCDetectorEnemyInterface * * interfaceArray; // offset 0x8, size 0x4
    class zHeistNPCDetectorViewBlocker * * viewBlockerArray; // offset 0xC, size 0x4
};
// total size: 0xDC
...
// total size: 0x890
struct /* @class$1964zHeistNPCInterface_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$869zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$872zHeistNPCInterface_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$873zHeistNPCInterface_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$874zHeistNPCInterface_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$875zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2111zHeistNPCInterface_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2112zHeistNPCInterface_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2113zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2110zHeistNPCInterface_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2115zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1711zHeistNPCInterface_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802ED620 -> 0x802ED658
// this: r31
void zHeistNPCInterfaceManager::ResetSelection(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {}

// Range: 0x802ED658 -> 0x802ED690
// this: r31
void zHeistNPCInterfaceManager::SelectNextGangMember(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {}

// Range: 0x802ED690 -> 0x802ED6C8
// this: r31
void zHeistNPCInterfaceManager::SelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {}

// Range: 0x802ED6C8 -> 0x802ED6F8
// this: r31
void zHeistNPCInterfaceManager::SelectNextPath() {}

// Range: 0x802ED6F8 -> 0x802ED728
// this: r31
void zHeistNPCInterfaceManager::SelectPrevPath() {}

// Range: 0x802ED728 -> 0x802ED758
// this: r31
void zHeistNPCInterfaceManager::ExecuteCommand() {}

// Range: 0x802ED758 -> 0x802ED7B0
// this: r31
void zHeistNPCInterfaceManager::CheckSelected(class zHeistLookoutPoint * lookoutPoint /* r30 */) {}

class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager; // size: 0x4, address: 0x80D6B768
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66EB5
// total size: 0x4
struct PrivateFlags {
    // Members
    unsigned char isViewed : 1; // offset 0x0, size 0x1
    unsigned char isBlocking : 1; // offset 0x0, size 0x1
    unsigned int Pad : 30; // offset 0x0, size 0x4
};
// total size: 0x20
struct zHeistNPCDetectorViewBlockerAsset : public xDynAsset {
    // Members
    unsigned int blockerObjectId; // offset 0x10, size 0x4
    float blockerRadius; // offset 0x14, size 0x4
    float safeAreaLength; // offset 0x18, size 0x4
    float safeAreaHeight; // offset 0x1C, size 0x4
};
// total size: 0x2C
class zHeistNPCDetectorViewBlocker : public xBase {
    // Functions
    zHeistNPCDetectorViewBlocker(struct zHeistNPCDetectorViewBlockerAsset * theAsset);

    void EventCB(unsigned int toEvent);

    void SceneEnter();

    unsigned char CanBlock();

    void Update();

    void SetViewedFrom(struct xVec3 * viewedFrom, struct xColor_tag * drawColor);
    ...
    // Members
protected:
    struct PrivateFlags privateFlags; // offset 0x10, size 0x4
    struct xEnt * blockerObject; // offset 0x14, size 0x4
    struct xVec3 safeAreaOrientation; // offset 0x18, size 0xC
    struct zHeistNPCDetectorViewBlockerAsset * blockerAsset; // offset 0x24, size 0x4
    int viewBlockerArrayIdx; // offset 0x28, size 0x4
};
// Range: 0x802ED7B0 -> 0x802ED998
// this: r31
zHeistNPCDetectorViewBlocker::zHeistNPCDetectorViewBlocker(struct zHeistNPCDetectorViewBlockerAsset * theAsset /* r30 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66EBA
// Range: 0x802ED998 -> 0x802EDB60
void zHeistNPCDetectorViewBlocker::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802EDB60 -> 0x802EDBE4
// this: r31
void zHeistNPCDetectorViewBlocker::EventCB(unsigned int toEvent /* r1+0x8 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66EBF
// Range: 0x802EDBE4 -> 0x802EDD00
void zHeistNPCDetectorViewBlocker::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHeistNPCDetectorViewBlocker * blocker; // r31

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x802EDD00 -> 0x802EDD2C
// this: r1+0x8
void zHeistNPCDetectorViewBlocker::SceneEnter() {
    // References
    // -> class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager;
}

static unsigned char done; // size: 0x1, address: 0x80D6B76C
static signed char init; // size: 0x1, address: 0x80D6B76D
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D66EC7
// total size: 0x8
...
// Range: 0x802EDD2C -> 0x802EDE40
// this: r31
unsigned char zHeistNPCDetectorViewBlocker::CanBlock() {
    // Local variables
    struct zDestructible * destTemp; // r30
...
// Range: 0x802EDE40 -> 0x802EDE54
// this: r3
void zHeistNPCDetectorViewBlocker::Update() {}

// Range: 0x802EDE54 -> 0x802EE3B4
// this: r31
void zHeistNPCDetectorViewBlocker::SetViewedFrom(struct xVec3 * viewedFrom /* r18 */, struct xColor_tag * drawColor /* r19 */) {
    // Local variables
    struct xVec3 viewVec; // r1+0x118
    float distance; // f31
    float viewAngle; // r1+0x30
    struct xVec3 rightVec; // r1+0x10C
    struct xVec3 leftVec; // r1+0x100
    struct xVec3 rightBottomFront; // r1+0xF4
    struct xVec3 rightBottomBack; // r1+0xE8
    struct xVec3 rightTopFront; // r1+0xDC
    struct xVec3 rightTopBack; // r1+0xD0
    struct xVec3 leftBottomFront; // r1+0xC4
    struct xVec3 leftBottomBack; // r1+0xB8
    struct xVec3 leftTopFront; // r1+0xAC
    struct xVec3 leftTopBack; // r1+0xA0
    struct xVec3 basePoint; // r1+0x94
    struct xVec3 rbf; // r1+0x88
    struct xVec3 rbb; // r1+0x7C
    struct xVec3 rtf; // r1+0x70
    struct xVec3 rtb; // r1+0x64
    struct xVec3 lbf; // r1+0x58
    struct xVec3 lbb; // r1+0x4C
    struct xVec3 ltf; // r1+0x40
    struct xVec3 ltb; // r1+0x34
    int i; // r30
}

// Range: 0x802EE3B4 -> 0x802EE3B8
void zHeistNPCDetectorViewBlocker::RenderOverlay() {}

class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager; // size: 0x4, address: 0x80D6B770
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66ED0
// Range: 0x802EE3B8 -> 0x802EE73C
// this: r31
void zHeistNPCDetectorEnemyInterface::BuildPatrolRoute() {
    // Local variables
    struct xMovePoint * * tempArray; // r30
    int j; // r29
    float params[4]; // r1+0x8
...
// Range: 0x802EE73C -> 0x802EE780
// this: r31
class zNPCBase * zHeistNPCDetectorEnemyInterface::GetNPCBase() {}

// total size: 0x1
class zINPC {};
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66EE1
// Range: 0x802EE780 -> 0x802EE948
// this: r31
int zHeistNPCDetectorEnemyInterface::NextPatrolPoint() {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66EF1
// Range: 0x802EE948 -> 0x802EEB20
// this: r31
zHeistNPCDetectorEnemyInterface::zHeistNPCDetectorEnemyInterface(struct zHeistNPCDetectorEnemyInterfaceAsset * theAsset /* r30 */) {
    // References
    // -> class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager;
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66EF6
// Range: 0x802EEB20 -> 0x802EECE8
void zHeistNPCDetectorEnemyInterface::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66EFB
// Range: 0x802EECE8 -> 0x802EF28C
// this: r31
void zHeistNPCDetectorEnemyInterface::EventCB(struct xBase * from /* r29 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    float params[4]; // r1+0x2C
    float params[4]; // r1+0x1C
...
// Range: 0x802EF28C -> 0x802EF2E8
// this: r30
struct xEnt * zHeistNPCDetectorEnemyInterface::GetEnt() {}
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66F03
// Range: 0x802EF2E8 -> 0x802EF404
void zHeistNPCDetectorEnemyInterface::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHeistNPCDetectorEnemyInterface * npcInt; // r31

    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66F0B
// Range: 0x802EF404 -> 0x802EF544
// this: r31
void zHeistNPCDetectorEnemyInterface::SceneEnter() {
    // Local variables
    struct xBase * tBase; // r30
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66F16
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x802EF544 -> 0x802F0274
// this: r31
void zHeistNPCDetectorEnemyInterface::Update(float dt /* f28 */) {
    // Local variables
    struct xColor_tag drawColor; // r1+0x14
    struct xVec3 rVec; // r1+0x7C
    struct xVec3 straightVec; // r1+0x70
    struct xVec3 entPos; // r1+0x64
    float theta; // r1+0x10
    int j; // r30
    int i; // r29
    int j; // r28
    int i; // r27
    struct xVec3 detectedObjCenter; // r1+0x58
    struct xVec3 facing; // r1+0x4C
    float moveDist; // f31
    float fLength; // f27
    struct xVec3 moveVec; // r1+0x40
    float moveDist; // f30
    float fLength; // f26
    struct xVec3 moveVec; // r1+0x34
    float moveDist; // f29
    float fLength; // f25
    float params[4]; // r1+0x24
    unsigned int hasBeenDetected; // r25
    unsigned int hasBeenDetected; // r26
    class zHeistGangMemberInterface * gangMember; // r24
    struct xVec3 gangMemberLoc; // r1+0x18

    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x802F0274 -> 0x802F0278
void zHeistNPCDetectorEnemyInterface::RenderOverlay() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66F1D
// Range: 0x802F0278 -> 0x802F0538
// this: r31
unsigned int zHeistNPCDetectorEnemyInterface::Detect(struct xVec3 * location /* r30 */) {
    // Local variables
    struct xVec3 testLoc; // r1+0x20
    struct xVec3 npcEntLoc; // r1+0x14
    struct xVec3 toLoc; // r1+0x8
...
// Range: 0x802F0538 -> 0x802F0668
// this: r31
void zHeistNPCDetectorEnemyInterface::ShowViewBlockerSafeAreas(class zHeistNPCDetectorViewBlocker * blocker /* r30 */) {
    // Local variables
    struct xVec3 npcLoc; // r1+0x20
    struct xVec3 blockerLoc; // r1+0x14
    struct xVec3 toLoc; // r1+0x8
}

// Range: 0x802F0668 -> 0x802F069C
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::Init() {}

// Range: 0x802F069C -> 0x802F06C0
void zHeistNPCDetectorEnemyInterfaceManager::Exit() {}

// Range: 0x802F06C0 -> 0x802F0748
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::RenderOverlays() {
    // Local variables
    int i; // r30
    int i; // r29
}

// Range: 0x802F0748 -> 0x802F0838
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
    int j; // r29
    int i; // r28
...
// Range: 0x802F0838 -> 0x802F0860
// this: r3
int zHeistNPCDetectorEnemyInterfaceManager::AddToInterfaceCount() {
    // Local variables
    int idx; // r31
}

// Range: 0x802F0860 -> 0x802F0888
// this: r3
int zHeistNPCDetectorEnemyInterfaceManager::AddToViewBlockerCount() {
    // Local variables
    int idx; // r31
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66F24
// Range: 0x802F0888 -> 0x802F0910
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::RegisterInterface(class zHeistNPCDetectorEnemyInterface * regInterface /* r30 */) {
    // References
    // -> static char __FUNCTION__[18];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66F36
// Range: 0x802F0910 -> 0x802F0A18
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::InsertInterface(class zHeistNPCDetectorEnemyInterface * insInterface /* r1+0x8 */, int idx /* r30 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D66F46
// Range: 0x802F0A18 -> 0x802F0AA0
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::RegisterViewBlocker(class zHeistNPCDetectorViewBlocker * regViewBlocker /* r30 */) {
    // References
    // -> static char __FUNCTION__[20];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66F5A
// Range: 0x802F0AA0 -> 0x802F0BA8
// this: r31
void zHeistNPCDetectorEnemyInterfaceManager::InsertViewBlocker(class zHeistNPCDetectorViewBlocker * insViewBlocker /* r1+0x8 */, int idx /* r30 */) {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x802F0BA8 -> 0x802F0DB0
// this: r26
unsigned char zHeistNPCDetectorEnemyInterfaceManager::IsBlocked(struct xVec3 * viewPos /* r28 */, struct xVec3 * lookPos /* r31 */) {
    // Local variables
    float yCoeff; // f31
    float xCoeff; // f30
    float divisor; // f25
    ...
    float x; // f27
    float y; // f26
    float blockerRadius; // f28
    struct xVec3 * blockerPos; // r30
    class zHeistNPCDetectorViewBlocker * blocker; // r29
    int i; // r27
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66F6C
// Range: 0x802F0DB0 -> 0x802F0E1C
// this: r31
void zHeistGangMemberInterfaceManager::Init() {
    // References
    // -> static char __FUNCTION__[5];
    // -> unsigned int gActiveHeap;
}

class zHeistGangMemberInterfaceManager * gangMemberInterfaceManager; // size: 0x4, address: 0x80D6B774
// Range: 0x802F0E1C -> 0x802F0E5C
// this: r31
void zHeistGangMemberInterfaceManager::Exit() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66F71
// Range: 0x802F0E5C -> 0x802F0F2C
// this: r31
void zHeistGangMemberInterfaceManager::RenderOverlays() {
    // Local variables
    int i; // r30
...
// Range: 0x802F0F2C -> 0x802F0F8C
// this: r30
void zHeistGangMemberInterfaceManager::Update(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

// Range: 0x802F0F8C -> 0x802F1010
// this: r31
void zHeistGangMemberInterfaceManager::ResetSelection(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x802F1010 -> 0x802F1038
// this: r3
int zHeistGangMemberInterfaceManager::AddToInterfaceCount() {
    // Local variables
    int idx; // r31
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66F80
// Range: 0x802F1038 -> 0x802F10C0
// this: r31
void zHeistGangMemberInterfaceManager::RegisterInterface(class zHeistGangMemberInterface * regInterface /* r30 */) {
    // References
    // -> static char __FUNCTION__[18];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66F92
// Range: 0x802F10C0 -> 0x802F11C8
// this: r31
void zHeistGangMemberInterfaceManager::InsertInterface(class zHeistGangMemberInterface * insInterface /* r1+0x8 */, int idx /* r30 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x802F11C8 -> 0x802F12A0
// this: r31
void zHeistGangMemberInterfaceManager::PlayerSelectNextGangMember(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {
    // Local variables
    int startIdx; // r29
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x802F12A0 -> 0x802F1374
// this: r31
void zHeistGangMemberInterfaceManager::PlayerSelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint /* r1+0x8 */) {
    // Local variables
    int startIdx; // r29
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x802F1374 -> 0x802F13E4
// this: r31
void zHeistGangMemberInterfaceManager::PlayerSelectNextPath() {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x802F13E4 -> 0x802F1454
// this: r31
void zHeistGangMemberInterfaceManager::PlayerSelectPrevPath() {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r30
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66FA2
// Range: 0x802F1454 -> 0x802F1774
// this: r31
void zHeistGangMemberInterfaceManager::ExecuteCommand() {
    // Local variables
    class zHeistMovementPath * selectedPath; // r30
    class zHeistMovementPath * currentPath; // r29
    float params[4]; // r1+0x8
...
// Range: 0x802F1774 -> 0x802F189C
// this: r30
unsigned char zHeistGangMemberInterfaceManager::ValidSelectedGangMember(class zHeistLookoutPoint * lookoutPoint /* r31 */) {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r29
    struct xVec3 lookFromLoc; // r1+0x20
    struct xVec3 lookAtVecX; // r1+0x14
    struct xVec3 lookVecX; // r1+0x8
    float dotx; // f31
    float coslookx; // f30
}
...
// total size: 0x1
class zHeistObjectiveManager {};
// total size: 0x8
class zHeistInteractionObjectManager {
    // Members
protected:
    class zHeistDistractionObjectManager * heistDistractionObjectManager; // offset 0x0, size 0x4
    class zHeistObjectiveManager * heistObjectiveManager; // offset 0x4, size 0x4
};
// total size: 0xC
class zHeistManager {
    // Static members
...
// Range: 0x802F189C -> 0x802F191C
// this: r31
void zHeistGangMemberInterfaceManager::CheckSelectedPath() {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r30
}

// total size: 0x8
struct zHeistGangMemberPrototypeNavData {
    // Functions
    void Reset();
    ...
    void SetStartingPointIdx(int inIdx);

    // Members
private:
    int currentMovePointIdx; // offset 0x0, size 0x4
    int direction; // offset 0x4, size 0x4
};
// Range: 0x802F191C -> 0x802F1930
// this: r3
void zHeistGangMemberPrototypeNavData::Reset() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66FB1
// Range: 0x802F1930 -> 0x802F1A04
// this: r31
int zHeistGangMemberPrototypeNavData::GetNextIdx() {
    // Local variables
    int retVal; // r30
...
// Range: 0x802F1A04 -> 0x802F1A0C
// this: r3
void zHeistGangMemberPrototypeNavData::SetDirection(int inDir /* r4 */) {}

// Range: 0x802F1A0C -> 0x802F1A14
// this: r3
void zHeistGangMemberPrototypeNavData::SetStartingPointIdx(int inIdx /* r4 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66FBC
// Range: 0x802F1A14 -> 0x802F1C0C
// this: r31
zHeistGangMemberInterface::zHeistGangMemberInterface(struct zHeistGangMemberInterfaceAsset * theAsset /* r30 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66FC1
// Range: 0x802F1C0C -> 0x802F1DD4
void zHeistGangMemberInterface::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66FC6
// Range: 0x802F1DD4 -> 0x802F1EF0
void zHeistGangMemberInterface::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHeistGangMemberInterface * gangMemberInt; // r31

    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66FCE
// Range: 0x802F1EF0 -> 0x802F2294
// this: r31
void zHeistGangMemberInterface::EventCB(unsigned int toEvent /* r28 */, const float * toParam /* r27 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    int startingPoint; // r29

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x802F2294 -> 0x802F22F4
// this: r31
void zHeistGangMemberInterface::SceneEnter() {
    // Local variables
    class zHeistMovementPath * startPath; // r30

    // References
    // -> class zHeistGangMemberInterfaceManager * gangMemberInterfaceManager;
}

// Range: 0x802F22F4 -> 0x802F247C
// this: r31
void zHeistGangMemberInterface::RenderOverlay(int selectedGangMember /* r1+0x8 */) {
    // Local variables
    struct xColor_tag gangMemberColor; // r1+0x10
    struct xVec3 boxCorner1; // r1+0x20
    struct xVec3 boxCorner2; // r1+0x14
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66FD6
struct xVec3 m_UnitAxisY; // size: 0xC, address: 0x80D6D944
// Range: 0x802F247C -> 0x802F2980
// this: r31
void zHeistGangMemberInterface::Update(float dt /* f25 */) {
    // Local variables
    class zHeistMovementPath * movePath; // r27
    struct xMovePoint * curMovePoint; // r30
    struct xVec3 moveVec; // r1+0x20
    float moveDist; // f31
    float fLength; // f28
    struct xMat4x3 * frameMat; // r29
    struct xVec3 moveVec; // r1+0x14
    float moveDist; // f30
    float fLength; // f27
    struct xMovePoint * targetPoint; // r28
    struct xVec3 moveVec; // r1+0x8
    float moveDist; // f29
    float fLength; // f26
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D66FDD
// Range: 0x802F2980 -> 0x802F2A30
// this: r31
void zHeistGangMemberInterface::GetLocation(struct xVec3 * gangMemberLoc /* r30 */) {
    // References
