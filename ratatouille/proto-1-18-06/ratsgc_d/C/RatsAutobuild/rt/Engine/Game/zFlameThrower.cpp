/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFlameThrower.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802070A0 -> 0x80209D88
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64618
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x44
struct zFlameThrowerAsset : public xDynAsset {
    // Members
    struct xVec3 position; // offset 0x10, size 0xC
    union { // inferred
        struct xVec3 rotation; // offset 0x1C, size 0xC
        struct xVec3 direction; // offset 0x1C, size 0xC
    };
    unsigned char visible; // offset 0x28, size 0x1
    float on_length; // offset 0x2C, size 0x4
    float off_length; // offset 0x30, size 0x4
    struct xColor_tag color; // offset 0x34, size 0x4
    int damage; // offset 0x38, size 0x4
    float knockback; // offset 0x3C, size 0x4
    float damage_radius; // offset 0x40, size 0x4
};
// total size: 0x1C
class zFlameThrowerWidget : private xBase {
    // Functions
    void Init(struct zFlameThrowerAsset * a);

    // Members
    float length; // offset 0x10, size 0x4
    unsigned int flamethrower_handle; // offset 0x14, size 0x4
    struct zFlameThrowerAsset * asset; // offset 0x18, size 0x4
};
// Range: 0x802070A0 -> 0x8020724C
void zFlameThrowerWidget::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6461D
class zLightweightSystem * zLightweight<flamethrower, 10>::GetSystem()::system; // size: 0x4, address: 0x80D6ADD0
signed char zLightweight<flamethrower, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6ADD4
char __FUNCTION__$localstatic1$Add__37zLightweightSystem<12flamethrower,10>FRC12flamethrower[4]; // size: 0x4, address: 0x80D64622
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x188
class flamethrower : public zLightweight {
    // Functions
    flamethrower(const struct xVec3 & position, const struct xVec3 & direction, float length, float burst_time, const struct xColor_tag & color, int damage, float knockback, float damage_radius);
    ...
    void collision_emit(const struct xVec3 & position, const struct xVec3 & direction, const struct xVec3 & velocity, float dt);

    void collision_update(float dt);

    // Static members
    static int max_coll_particle; // size: 0x4

    // Members
    float emit_remaining; // offset 0xC, size 0x4
    struct xVec3 position; // offset 0x10, size 0xC
    struct xVec3 direction; // offset 0x1C, size 0xC
    float length; // offset 0x28, size 0x4
    float time; // offset 0x2C, size 0x4
    struct xColor_tag color; // offset 0x30, size 0x4
    float coll_emit_remaining; // offset 0x34, size 0x4
    float coll_emit_rate; // offset 0x38, size 0x4
    int damage; // offset 0x3C, size 0x4
    float knockback; // offset 0x40, size 0x4
    float damage_radius; // offset 0x44, size 0x4
    struct collision_particle coll_particle[10]; // offset 0x48, size 0x140
};
// Range: 0x8020724C -> 0x802074E8
// this: r30
void zFlameThrowerWidget::Init(struct zFlameThrowerAsset * a /* r31 */) {
    // Local variables
    struct xMat3x3 mat; // r1+0x10
    class flamethrower ft; // r1+0x40
...
class zLightweightSystem : public zLightweightSystemBase {
    // Members
    class flamethrower object[10]; // offset 0x4, size 0xF50
    class zLightweightSystem * * system; // offset 0xF54, size 0x4
    unsigned int current_id; // offset 0xF58, size 0x4
};
// total size: 0x24
struct {} zLightweightSystem<flamethrower, 10>::__vtable; // size: 0x24, address: 0x80523178
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D64626
// Range: 0x802074E8 -> 0x80207808
void zFlameThrowerWidget::EventCB(struct xBase * to /* r23 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */) {
    // Local variables
    class zFlameThrowerWidget & flameThrowerWidget; // r31
    class flamethrower * f; // r29
    class flamethrower ft; // r1+0x31C
    class flamethrower * f; // r28
    class flamethrower ft; // r1+0x194
    class flamethrower * ft; // r27
    class flamethrower * ft; // r26
    class flamethrower * ft; // r25
    class flamethrower * f; // r24
    class flamethrower ft; // r1+0xC
...
static struct config flamethrower_config; // size: 0x44, address: 0x80D18150
static float length_modifier; // size: 0x4, address: 0x80D64630
static float radius_modifier; // size: 0x4, address: 0x80D64634
unsigned char draw_damage; // size: 0x1, address: 0x80D6ADD5
// Range: 0x80207808 -> 0x802079CC
void flamethrower::Setup() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float radius_modifier;
    // -> static float length_modifier;
    // -> unsigned char draw_damage;
    // -> static struct config flamethrower_config;
}

// total size: 0xC
struct /* @class$768zFlameThrower_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zFlameThrower_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zFlameThrower_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zFlameThrower_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zFlameThrower_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zFlameThrower_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zFlameThrower_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64638
// total size: 0x20
struct {} flamethrower::__vtable; // size: 0x20, address: 0x80523138
// Range: 0x802079CC -> 0x80207C80
// this: r31
flamethrower::flamethrower(const struct xVec3 & position /* r26 */, const struct xVec3 & direction /* r27 */, float length /* r1+0x8 */, float burst_time /* r1+0xC */, const struct xColor_tag & color /* r28 */, int damage /* r1+0x10 */, float knockback /* r1+0x14 */, float damage_radius /* r1+0x18 */) {
    // Local variables
    struct collision_particle * end; // r29
    struct collision_particle * p; // r30

    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] flamethrower::__vtable;
}

// total size: 0x20
struct {} zLightweight<flamethrower, 10>::__vtable; // size: 0x20, address: 0x80523158
// Range: 0x80207C80 -> 0x80207CC0
// this: r31
...
// Range: 0x80207CC0 -> 0x80207DA0
// this: r31
void flamethrower::Update(float dt /* f31 */) {
    // Local variables
    float length_mod; // f30
...
// Range: 0x80207DA0 -> 0x80207E98
// this: r30
void flamethrower::collide() {
    // Local variables
    struct collision_particle * p; // r31
    struct collision_particle * end; // r29
...
// total size: 0x4
struct /* @class$1150zFlameThrower_cpp */ {
    // Members
...
union /* @class$819zFlameThrower_cpp */ {
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6463D
// Range: 0x80207E98 -> 0x802083EC
// this: r29
void flamethrower::collision_emit(const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & direction /* r30 */, const struct xVec3 & velocity /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    float time_passed; // f30
    struct collision_particle * p; // r31
    struct collision_particle * end; // r28
    float vel_length; // f29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6464C
// Range: 0x802083EC -> 0x80208860
// this: r29
void flamethrower::collision_update(float dt /* f30 */) {
    // Local variables
    struct collision_particle * p; // r31
    struct collision_particle * end; // r30
...
int NUM_ANIM_TEXTURES; // size: 0x4, address: 0x80D64660
int DO_COLLISION; // size: 0x4, address: 0x80D64664
// total size: 0x80
struct zFlameThrowerCfg {
    ...
    int PARTICLE_B_PROB; // offset 0x44, size 0x4
...
struct FlameThrowerCollisionInfo {
    ...
    float knockBackSpeed; // offset 0xC, size 0x4
    enum iSndGroupHandle soundHit; // offset 0x10, size 0x4
};
struct FlameThrowerCollisionInfo flameThrowerCollisionInfo; // size: 0x14, address: 0x80D6ADD8
struct RwTexture * particleTex; // size: 0x4, address: 0x80D6ADEC
enum FTParType {
    TYPE_A = 0,
    TYPE_B = 1,
};
...
class zFlameThrower {
    ...
    void Update(float dt, struct xVec3 & velocity);

    unsigned char Cull();

    void UpdatePTankPool();

    void UpdateParticles(float dt, struct xVec3 & velocity);

    void UpdateCollision();

    unsigned char IsShutDown();

    unsigned char IsMgrUpdate();
...
private:
    struct zFlameThrowerCfg & cfg; // offset 0x14, size 0x4
    struct FTParticle * particles; // offset 0x18, size 0x4
    unsigned char particleMem[19215]; // offset 0x1C, size 0x4B0F
    int counter; // offset 0x4B2C, size 0x4
    float texScroll; // offset 0x4B30, size 0x4
    int nextParticle; // offset 0x4B34, size 0x4
    unsigned char isFirstUpdate; // offset 0x4B38, size 0x1
    struct xVec3 emitterPos; // offset 0x4B3C, size 0xC
    struct xVec3 emitterDir; // offset 0x4B48, size 0xC
    struct xColor_tag color; // offset 0x4B54, size 0x4
    float pitch; // offset 0x4B58, size 0x4
    float friction; // offset 0x4B5C, size 0x4
    float gravity; // offset 0x4B60, size 0x4
    struct xVec3 velLast; // offset 0x4B64, size 0xC
    struct xVec3 posLast; // offset 0x4B70, size 0xC
    struct xMat4x3 matLast; // offset 0x4B80, size 0x40
    float totalTime; // offset 0x4BC0, size 0x4
    float emitTimeA; // offset 0x4BC4, size 0x4
    float emitTimeB; // offset 0x4BC8, size 0x4
    int enabled; // offset 0x4BCC, size 0x4
    unsigned char doRender; // offset 0x4BD0, size 0x1
    struct xMat4x3 emitterMat; // offset 0x4BE0, size 0x40
    struct xMat4x3 emitterMatB; // offset 0x4C20, size 0x40
    unsigned int count; // offset 0x4C60, size 0x4
    struct xVec3 springResultPos; // offset 0x4C64, size 0xC
    struct xQuat springResultQuat; // offset 0x4C70, size 0x10
    struct xQuat quatLast; // offset 0x4C80, size 0x10
    float springVpos; // offset 0x4C90, size 0x4
    float springVquat; // offset 0x4C94, size 0x4
    float springCurrPos; // offset 0x4C98, size 0x4
    float cullFade; // offset 0x4C9C, size 0x4
    unsigned char matLast_set; // offset 0x4CA0, size 0x1
    unsigned char doShutDown; // offset 0x4CA1, size 0x1
    unsigned char isShutDown; // offset 0x4CA2, size 0x1
    unsigned char doMgrUpdate; // offset 0x4CA3, size 0x1
    unsigned char doMgrRender; // offset 0x4CA4, size 0x1
    unsigned char isCulled; // offset 0x4CA5, size 0x1
};
// Range: 0x80208860 -> 0x80208894
void zFlameThrower::operator delete(void * mem /* r1+0x8 */) {
    // Local variables
    class zFlameThrowerMgr * mgr; // r31
}
...
// Range: 0x80208894 -> 0x802088E8
// this: r31
zFlameThrower::~zFlameThrower() {}
...
// Range: 0x802088E8 -> 0x802089A4
// this: r31
void zFlameThrower::Update(float dt /* r1+0x8 */, struct xVec3 & velocity /* r29 */) {
    // References
    // -> int DO_COLLISION;
}

float FLAMETHROWER_FADE_DIST; // size: 0x4, address: 0x80D64668
float FLAMETHROWER_CULL_DIST; // size: 0x4, address: 0x80D6466C
// Range: 0x802089A4 -> 0x80208AD0
// this: r31
unsigned char zFlameThrower::Cull() {
    // Local variables
    ...
    // References
    // -> float FLAMETHROWER_FADE_DIST;
    // -> float FLAMETHROWER_CULL_DIST;
}

// Range: 0x80208AD0 -> 0x80208B14
void zFlameThrower::RemoveTweaks(unsigned int number /* r1+0x8 */) {
    // Local variables
    char name[64]; // r1+0xC
}
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64670
// total size: 0xC
...
// Range: 0x80208B14 -> 0x80208D10
// this: r29
void zFlameThrower::UpdatePTankPool() {
    // Local variables
    struct ptank_pool__pos_color_size_uv2 pool; // r1+0x18
    int p; // r30
    struct FTParticle & particle; // r31
    float u; // f31
    float v; // f30
...
// total size: 0xC
struct /* @class$1288zFlameThrower_cpp */ {
    // Members
...
// Range: 0x80208D10 -> 0x80208DBC
float zFlameThrower::get_collide_distance(const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & direction /* r1+0xC */) {
    // Local variables
    struct xRay3 ray; // r1+0x10
    struct xCollis collision_record; // r1+0x34

    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64680
// Range: 0x80208DBC -> 0x802097EC
// this: r31
void zFlameThrower::UpdateParticles(float dt /* f31 */, struct xVec3 & velocity /* r28 */) {
    // Local variables
    struct xMat4x3 & mat; // r26
    float collide_distance; // f19
    unsigned char isActive; // r24
    int p; // r25
    struct FTParticle & particle; // r30
    float use_dt; // f29
    float time; // f30
    float size; // f28
    unsigned char alpha; // r27
    float vel_length; // f26
    float life; // f25
    int count; // r1+0x8
    float diffTime; // f27
    struct FTParticle * particle; // r29
    struct FTParticle * end; // r23
    float t; // f24
    struct xVec3 pos; // r1+0xC

    // References
    // -> static char __FUNCTION__[16];
    // -> int NUM_ANIM_TEXTURES;
    // -> struct xVec3 g_O3;
}
...
void zFlameThrower::UpdateCollision() {
    ...
    // References
    // -> struct FlameThrowerCollisionInfo flameThrowerCollisionInfo;
}

// Range: 0x80209908 -> 0x80209988
void zFlameThrower::Collide(const struct xBound & bound /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// total size: 0x890
struct /* @class$1906zFlameThrower_cpp */ {
    // Static members
...
// Range: 0x80209988 -> 0x80209A18
unsigned char zFlameThrower::CollisionCB(struct xEnt & ent /* r1+0x10 */) {
    // Local variables
    struct xVec3 dir; // r1+0x14
...
class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4, address: 0x80D6ADF0
char __FUNCTION__$localstatic1$Get__16zFlameThrowerMgrFv[4]; // size: 0x4, address: 0x80D64690
// total size: 0xC
class zFlameThrowerMgr {
    // Functions
    zFlameThrowerMgr();

    void FreeMem(class zFlameThrower * mem);

    void _Update(float dt);

    // Static members
    static class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4

    // Members
    unsigned char isFirstGet; // offset 0x0, size 0x1
    class zFlameThrower * freeList; // offset 0x4, size 0x4
    class zFlameThrower * usedList; // offset 0x8, size 0x4
};
// Range: 0x80209A18 -> 0x80209B04
class zFlameThrowerMgr * zFlameThrowerMgr::Get() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
    // -> char __FUNCTION__$localstatic1$Get__16zFlameThrowerMgrFv[4];
    // -> struct RwTexture * particleTex;
    // -> struct xGlobals * xglobals;
}

// Range: 0x80209B04 -> 0x80209B1C
void zFlameThrowerMgr::Remove() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x80209B1C -> 0x80209B68
void zFlameThrowerMgr::Reset() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x80209B68 -> 0x80209B74
// this: r3
zFlameThrowerMgr::zFlameThrowerMgr() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D64694
// Range: 0x80209B74 -> 0x80209C6C
// this: r30
void zFlameThrowerMgr::FreeMem(class zFlameThrower * mem /* r31 */) {
    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x80209C6C -> 0x80209CA4
void zFlameThrowerMgr::Update(float dt /* r1+0x8 */) {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x80209CA4 -> 0x80209D78
// this: r28
void zFlameThrowerMgr::_Update(float dt /* r1+0x8 */) {
    // Local variables
    class zFlameThrower * flameThrower; // r31
    struct xVec3 velocity; // r1+0x18
    class zFlameThrower * mem; // r30

    // References
    // -> struct xVec3 g_O3;
}

// Range: 0x80209D78 -> 0x80209D80
// this: r3
unsigned char zFlameThrower::IsShutDown() {}

// Range: 0x80209D80 -> 0x80209D88
// this: r3
unsigned char zFlameThrower::IsMgrUpdate() {}
...
// total size: 0x10
struct /* @class$832zFlameThrower_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
