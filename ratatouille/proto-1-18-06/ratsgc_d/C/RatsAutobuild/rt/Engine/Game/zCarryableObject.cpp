/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCarryableObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802DF700 -> 0x802DFBF4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$934zCarryableObject_cpp */ {
    // Members
...
union /* @class$1073zCarryableObject_cpp */ {
...
// total size: 0xC
struct /* @class$1072zCarryableObject_cpp */ {
    // Members
...
// Range: 0x802DF700 -> 0x802DF730
static void UpdateWrapper(struct xEnt * carryable /* r1+0x8 */, float dt /* r1+0xC */) {}

// Range: 0x802DF730 -> 0x802DF780
...
// total size: 0x4
struct /* @class$1286zCarryableObject_cpp */ {
    // Members
...
class zCarryableObject : public zEntSimpleObj {
    // Functions
    zCarryableObject(struct zCarryableObjectAsset & asset);
...
// Range: 0x802DF780 -> 0x802DF890
// this: r31
zCarryableObject::zCarryableObject(struct zCarryableObjectAsset & asset /* r30 */) {
    // Local variables
    unsigned int tempSize; // r1+0x8
    unsigned int assetID; // r29
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66C20
// Range: 0x802DF890 -> 0x802DFA64
void zCarryableObject::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802DFA64 -> 0x802DFAA4
// this: r31
void zCarryableObject::Setup() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x802DFAA4 -> 0x802DFB0C
// this: r31
void zCarryableObject::Reset() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x802DFB0C -> 0x802DFB48
// this: r1+0x8
void zCarryableObject::Update(float dt /* r1+0xC */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x802DFB48 -> 0x802DFB7C
// this: r31
void zCarryableObject::Drop() {}

// Range: 0x802DFB7C -> 0x802DFBF4
// this: r30
void zCarryableObject::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r31 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetId /* r1+0x14 */) {}
