/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXGlint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80276720 -> 0x80276CEC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80D6B280
// total size: 0x24
struct config {
    // Members
...
class glint {
    ...
    static struct config default_config; // size: 0x24
};
// Range: 0x80276720 -> 0x802767F8
void glint::setup() {
    // References
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D659C0
int system_id; // size: 0x4, address: 0x80D659CC
// total size: 0x28
...
// Range: 0x802767F8 -> 0x802768E0
void glint::scene_setup() {
    // Local variables
...
// total size: 0x1
struct /* @class$833zFXGlint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zFXGlint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zFXGlint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zFXGlint_cpp */ {
    // Members
...
struct particle {
    ...
    struct config * cfg; // offset 0x18, size 0x4
    unsigned int pad; // offset 0x1C, size 0x4
};
// Range: 0x802768E0 -> 0x80276A9C
void glint::emit(const struct xVec3 & position /* r1+0x8 */, float & emit_remaining /* r30 */, float dt /* f30 */, struct config * cfg /* r31 */) {
    // Local variables
...
// Range: 0x80276A9C -> 0x80276CEC
int glint::update(unsigned char * mem /* r26 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
