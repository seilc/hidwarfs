/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRemyPlayerActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029DCD8 -> 0x802A3B84
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$928zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1689zRemyPlayerActions_cpp */ {
    // Members
...
union /* @class$1067zRemyPlayerActions_cpp */ {
...
// total size: 0xC
struct /* @class$869zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$872zRemyPlayerActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$873zRemyPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$874zRemyPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$875zRemyPlayerActions_cpp */ {
    // Members
...
// Range: 0x8029DCD8 -> 0x8029DD58
static void InitAttackState(class zCombatAttack * attack /* r31 */, char * state /* r1+0x8 */, float start /* r1+0xC */, float end /* r1+0x10 */, float radius /* r1+0x14 */, unsigned short bone0 /* r1+0x18 */, enum zHitSource source /* r1+0x1C */, signed short damage /* r1+0x20 */) {}
...
// Range: 0x8029DD58 -> 0x8029DD88
static void AddEffects(class zCombatAttack * attack /* r3 */, enum zAttackHitEffect hitEffect /* r4 */, enum zAttackEffect effect /* r5 */, float start /* f1 */, float end /* f2 */, unsigned short bone0 /* r6 */, unsigned short bone1 /* r7 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r8 */) {}

static signed short szRemyHitPoints_Punch1[3]; // size: 0x6, address: 0x80D660F0
static signed short szRemyHitPoints_Punch2[3]; // size: 0x6, address: 0x80D660F6
static signed short szRemyHitPoints_Punch3[3]; // size: 0x6, address: 0x80D660FC
static signed short szRemyHitPoints_Punch4[3]; // size: 0x6, address: 0x80D66102
static float CARRY_CHECK_RADIUS; // size: 0x4, address: 0x80D66108
static float CARRY_FORWARD_OFFSET; // size: 0x4, address: 0x80D6610C
static float CARRY_HEIGHT_OFFSET; // size: 0x4, address: 0x80D66110
static float CARRY_MIN_HEIGHT; // size: 0x4, address: 0x80D66114
static float CARRY_MAX_HEIGHT; // size: 0x4, address: 0x80D66118
static float CARRY_BOUND_RADIUS; // size: 0x4, address: 0x80D6611C
static unsigned char drawGrabCheck; // size: 0x1, address: 0x80D6B450
static float MAX_GRAB_DIST; // size: 0x4, address: 0x80D66120
// Range: 0x8029DD88 -> 0x8029DD90
static unsigned char IsStaticCarry() {}
...
class zRemyPlayerCarry : public zCommonPlayerAction {
    ...
    unsigned int AnyMoveCheck();

    unsigned int AnyMoveNotUsingCheck();

    unsigned int AnyMoveLandingCheck();

    unsigned int LandingCheck();

    unsigned int AnyStopCheck();

    unsigned int GrabCheck();

    unsigned int DropCheck();

    unsigned int NotUsingCheck();

    unsigned int WhifCheck();

    unsigned int PickedUpCB();

    void GetCarryBound(struct xSphere * sphere);

    unsigned int GrabKillIdleNormalCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int GrabKillIdleEnemyCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int GrabKillWalkCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int GrabKillRunCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned char GrabbedObjectKilled();

    void End();

    unsigned char ExtraCarrySphere();
    ...
    unsigned int GetAnimCode();

    void UpdateCarryAnimCode();

    void TryGrab();

    void GrabCarryBeforeEnter(struct xAnimPlay * play, struct xAnimState * state);
...
// Range: 0x8029DD90 -> 0x8029DEDC
void zRemyPlayerCarry::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float CARRY_BOUND_RADIUS;
    // -> static float CARRY_MAX_HEIGHT;
    // -> static float CARRY_MIN_HEIGHT;
    // -> static float CARRY_HEIGHT_OFFSET;
    // -> static float CARRY_FORWARD_OFFSET;
    // -> static float CARRY_CHECK_RADIUS;
}

// Range: 0x8029DEDC -> 0x8029E17C
// this: r30
void zRemyPlayerCarry::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8029E17C -> 0x8029E2F4
void zRemyPlayerCarry::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8029E2F4 -> 0x8029E580
// this: r31
void zRemyPlayerCarry::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x8029E580 -> 0x8029E610
void zRemyPlayerCarry::AddUseTransitionsFrom(struct xAnimTable * table /* r30 */, const char * fromStates /* r31 */) {}

// Range: 0x8029E610 -> 0x8029E6D4
void zRemyPlayerCarry::AddUseEndTransitionsFrom(struct xAnimTable * table /* r30 */, const char * fromStates /* r31 */) {}

// Range: 0x8029E6D4 -> 0x8029E768
void zRemyPlayerCarry::AddGlideTransitionsFrom(struct xAnimTable * table /* r30 */, const char * fromStates /* r31 */) {}

// Range: 0x8029E768 -> 0x8029E7BC
void zRemyPlayerCarry::AddWhifTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8029E7BC -> 0x8029E824
void zRemyPlayerCarry::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8029E824 -> 0x8029E878
void zRemyPlayerCarry::AddPunchTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8029E878 -> 0x8029E8D8
// this: r30
unsigned int zRemyPlayerCarry::ControlOffCheck() {}

// Range: 0x8029E8D8 -> 0x8029E930
static unsigned char ControlOff(struct zCommonPlayer * player /* r30 */) {}
...
// total size: 0x890
struct /* @class$1944zRemyPlayerActions_cpp */ {
    // Static members
...
// Range: 0x8029E930 -> 0x8029E968
// this: r1+0x8
unsigned int zRemyPlayerCarry::AnyMoveCheck() {}

// total size: 0x4
struct /* @class$2091zRemyPlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2092zRemyPlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2093zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2090zRemyPlayerActions_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2095zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1701zRemyPlayerActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8029E968 -> 0x8029E9C8
// this: r30
unsigned int zRemyPlayerCarry::AnyMoveNotUsingCheck() {}

// Range: 0x8029E9C8 -> 0x8029EA24
// this: r30
unsigned int zRemyPlayerCarry::AnyMoveLandingCheck() {}

// Range: 0x8029EA24 -> 0x8029EA58
// this: r31
unsigned int zRemyPlayerCarry::LandingCheck() {}

// Range: 0x8029EA58 -> 0x8029EA8C
// this: r1+0x8
unsigned int zRemyPlayerCarry::AnyStopCheck() {}

// Range: 0x8029EA8C -> 0x8029EAFC
// this: r31
unsigned int zRemyPlayerCarry::GrabCheck() {}

// Range: 0x8029EAFC -> 0x8029EB30
// this: r31
unsigned int zRemyPlayerCarry::DropCheck() {}

// Range: 0x8029EB30 -> 0x8029EB6C
// this: r31
unsigned int zRemyPlayerCarry::NotUsingCheck() {}

// Range: 0x8029EB6C -> 0x8029EBC8
// this: r31
unsigned int zRemyPlayerCarry::WhifCheck() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66124
// Range: 0x8029EBC8 -> 0x8029ECB4
// this: r31
unsigned int zRemyPlayerCarry::PickedUpCB() {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x8029ECB4 -> 0x8029ED4C
// this: r29
void zRemyPlayerCarry::GetCarryBound(struct xSphere * sphere /* r31 */) {
    // Local variables
    struct xVec3 * playerPos; // r30
    float minY; // f31
...
// Range: 0x8029ED4C -> 0x8029EDDC
// this: r27
unsigned int zRemyPlayerCarry::GrabKillIdleNormalCheck(struct xAnimTransition * tran /* r29 */, struct xAnimSingle * anim /* r1+0x8 */) {
    // Local variables
    class zPlayerIdle * idle; // r28
}

// Range: 0x8029EDDC -> 0x8029EE6C
// this: r27
unsigned int zRemyPlayerCarry::GrabKillIdleEnemyCheck(struct xAnimTransition * tran /* r29 */, struct xAnimSingle * anim /* r1+0x8 */) {
    // Local variables
    class zPlayerIdle * idle; // r28
}

// Range: 0x8029EE6C -> 0x8029EEFC
// this: r27
unsigned int zRemyPlayerCarry::GrabKillWalkCheck(struct xAnimTransition * tran /* r29 */, struct xAnimSingle * anim /* r1+0x8 */) {
    // Local variables
    class zPlayerWalk * walk; // r28
}

// Range: 0x8029EEFC -> 0x8029EF70
// this: r1+0x8
unsigned int zRemyPlayerCarry::GrabKillRunCheck(struct xAnimTransition * tran /* r30 */, struct xAnimSingle * anim /* r1+0xC */) {
    // Local variables
    class zPlayerRun * run; // r29
}

// Range: 0x8029EF70 -> 0x8029EFD4
// this: r30
unsigned char zRemyPlayerCarry::GrabbedObjectKilled() {}

// Range: 0x8029EFD4 -> 0x8029F038
// this: r31
void zRemyPlayerCarry::End() {}

// Range: 0x8029F038 -> 0x8029F09C
// this: r30
unsigned char zRemyPlayerCarry::ExtraCarrySphere() {}

// Range: 0x8029F09C -> 0x8029F3A8
// this: r31
void zRemyPlayerCarry::Move(struct xScene * s /* r1+0x8 */, float dt /* f29 */, struct xEntFrame * frame /* r30 */) {
    // Local variables
    struct xAnimSingle * single; // r29
    struct xAnimState * state; // r28
    unsigned char skipAbsControl; // r27
    float diffAngle; // f31
    float atime; // f30
    float lerp; // f28
}
...
// Range: 0x8029F3A8 -> 0x8029F468
// this: r31
void zRemyPlayerCarry::Setup() {}

// Range: 0x8029F468 -> 0x8029F484
// this: r3
void zRemyPlayerCarry::Reset() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6612F
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8029F484 -> 0x8029FDE0
// this: r31
void zRemyPlayerCarry::Begin() {
    // Local variables
    float tx; // f30
    float ty; // f29
    float tz; // f28
    struct xAnimState * stat; // r30
    class zNPCCommon * npc; // r29
    struct xVec3 tmptran; // r1+0x20
    struct xQuat tmpquat; // r1+0x10
    struct xMat4x3 objMat; // r1+0x70
    struct xMat4x3 targetMat; // r1+0x30
...
// total size: 0x4
struct /* @class$2548zRemyPlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2613zRemyPlayerActions_cpp */ {
    // Members
    unsigned char destroyDrop; // offset 0x0, size 0x1
    unsigned char pad1; // offset 0x1, size 0x1
    unsigned char pad2; // offset 0x2, size 0x1
    unsigned char pad3; // offset 0x3, size 0x1
};
// total size: 0x1C
struct zCarryableProperty : public xDynAsset {
    // Members
    unsigned int shrapnelID; // offset 0x10, size 0x4
    unsigned int animCode; // offset 0x14, size 0x4
    // total size: 0x4
    struct /* @class$2613zRemyPlayerActions_cpp */ {
        // Members
        unsigned char destroyDrop; // offset 0x0, size 0x1
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D66135
// Range: 0x8029FDE0 -> 0x8029FE84
// this: r31
unsigned int zRemyPlayerCarry::GetAnimCode() {
    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x8029FE84 -> 0x8029FEC8
// this: r31
void zRemyPlayerCarry::UpdateCarryAnimCode() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66141
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
class grab_collide_callback {
    // Functions
    static grab_collide_callback(struct zPlayer * player, unsigned int & objectCount, class zCarryableObject * * objects);

    static unsigned char operator()(struct xEnt & ent);

    // Members
    struct zPlayer * player; // offset 0x0, size 0x4
    unsigned int & objectCount; // offset 0x4, size 0x4
    class zCarryableObject * * objects; // offset 0x8, size 0x4
};
// total size: 0x24
struct xRay3 {
    // Members
...
// total size: 0xC
struct /* @class$1066zRemyPlayerActions_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x8029FEC8 -> 0x802A0340
// this: r31
void zRemyPlayerCarry::TryGrab() {
    // Local variables
    unsigned int objectCount; // r1+0xC
    class zCarryableObject * objects[32]; // r1+0x170
    struct xSphere normSphere; // r1+0x50
    struct xSphere lowSphere; // r1+0x40
    struct xVec3 offset; // r1+0x34
    struct xBound normBound; // r1+0x124
    struct xBound lowBound; // r1+0xD8
    class grab_collide_callback cb; // r1+0x28
    float bestDot; // f30
    class zCarryableObject * bestObject; // r28
    unsigned int i; // r29
    class zCarryableObject * carryableObject; // r30
    struct xVec3 center; // r1+0x1C
    struct xVec3 disp; // r1+0x10
    float dist; // f31
    struct xRay3 ray; // r1+0x60
    struct xCollis rayCollis; // r1+0x84
    float newDot; // f29

    // References
    // -> static char __FUNCTION__[8];
    // -> static unsigned char drawGrabCheck;
    // -> struct zGlobals globals;
    // -> static float MAX_GRAB_DIST;
...
// Range: 0x802A0340 -> 0x802A0350
// this: r3
static grab_collide_callback::grab_collide_callback(struct zPlayer * player /* r4 */, unsigned int & objectCount /* r5 */, class zCarryableObject * * objects /* r6 */) {}
...
// Range: 0x802A0350 -> 0x802A0390
// this: r1+0x8
void zRemyPlayerCarry::GrabCarryBeforeEnter(struct xAnimPlay * play /* r1+0xC */, struct xAnimState * state /* r1+0x10 */) {}

// total size: 0xC
class zRemyPlayerUseGeneric : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    void UseBeforeEnter(struct xAnimPlay * play, struct xAnimState * state);
...
// Range: 0x802A0390 -> 0x802A045C
// this: r30
void zRemyPlayerUseGeneric::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A045C -> 0x802A04B0
// this: r30
void zRemyPlayerUseGeneric::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A04B0 -> 0x802A0518
void zRemyPlayerUseGeneric::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66149
// Range: 0x802A0518 -> 0x802A05E0
// this: r31
unsigned int zRemyPlayerUseGeneric::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x20
struct zCarryableGenericUseProperty : public zCarryableProperty {
    // Members
    unsigned int useAnimCode; // offset 0x1C, size 0x4
};
// Range: 0x802A05E0 -> 0x802A0668
// this: r30
void zRemyPlayerUseGeneric::UseBeforeEnter(struct xAnimPlay * play /* r1+0x8 */, struct xAnimState * state /* r1+0xC */) {
    // Local variables
    struct zCarryableGenericUseProperty * useProperty; // r31
}

// Range: 0x802A0668 -> 0x802A0694
// this: r1+0x8
void zRemyPlayerUseGeneric::BeginHide() {}

// Range: 0x802A0694 -> 0x802A06FC
// this: r30
void zRemyPlayerUseGeneric::Begin() {
    // Local variables
    struct zCarryableGenericUseProperty * useProperty; // r31
}

// Range: 0x802A06FC -> 0x802A0740
// this: r31
void zRemyPlayerUseGeneric::Update(float dt /* r1+0x8 */) {}

// Range: 0x802A0740 -> 0x802A076C
// this: r1+0x8
void zRemyPlayerUseGeneric::EndHide() {}

// Range: 0x802A076C -> 0x802A07C0
// this: r30
void zRemyPlayerUseGeneric::End() {
    // Local variables
    struct zCarryableGenericUseProperty * useProperty; // r31
}

// total size: 0xC
class zRemyPlayerUseSwipe : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A07C0 -> 0x802A088C
// this: r30
void zRemyPlayerUseSwipe::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A088C -> 0x802A08E0
// this: r30
void zRemyPlayerUseSwipe::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A08E0 -> 0x802A0948
void zRemyPlayerUseSwipe::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66154
// Range: 0x802A0948 -> 0x802A0A10
// this: r31
unsigned int zRemyPlayerUseSwipe::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x20
struct zCarryableSwipeUseProperty : public zCarryableProperty {
    // Members
    unsigned int useAnimCode; // offset 0x1C, size 0x4
};
static struct xVec3 SWIPE_BONE_OFFSET; // size: 0xC, address: 0x80D70190
// Range: 0x802A0A10 -> 0x802A0A90
static void InitializeSwipeAttack(class zCombatAttack * attack /* r31 */, unsigned int stateID /* r1+0x8 */, unsigned short SwipeBone /* r1+0xC */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r1+0x10 */) {
    // References
    // -> static struct xVec3 SWIPE_BONE_OFFSET;
}

// Range: 0x802A0A90 -> 0x802A0AD0
void zRemyPlayerUseSwipe::AddAttacks(class zCombatAttack * attackStates /* r1+0x8 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r1+0xC */) {}

// Range: 0x802A0AD0 -> 0x802A0B58
// this: r30
void zRemyPlayerUseSwipe::UseBeforeEnter(struct xAnimPlay * play /* r1+0x8 */, struct xAnimState * state /* r1+0xC */) {
    // Local variables
    struct zCarryableSwipeUseProperty * useProperty; // r31
}

// Range: 0x802A0B58 -> 0x802A0B9C
// this: r31
void zRemyPlayerUseSwipe::Update(float dt /* r1+0x8 */) {}

// Range: 0x802A0B9C -> 0x802A0BD0
// this: r1+0x8
void zRemyPlayerUseSwipe::Begin() {}

// total size: 0xC
class zRemyPlayerUseHide : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A0BD0 -> 0x802A0DC4
// this: r30
void zRemyPlayerUseHide::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A0DC4 -> 0x802A0E3C
// this: r29
void zRemyPlayerUseHide::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A0E3C -> 0x802A0EB0
void zRemyPlayerUseHide::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x802A0EB0 -> 0x802A0F18
void zRemyPlayerUseHide::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6615F
// Range: 0x802A0F18 -> 0x802A0FE0
// this: r31
unsigned int zRemyPlayerUseHide::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x20
struct zCarryableHideUseProperty : public zCarryableProperty {
    // Members
    unsigned int useAnimCode; // offset 0x1C, size 0x4
};
// Range: 0x802A0FE0 -> 0x802A1060
// this: r31
void zRemyPlayerUseHide::Update(float dt /* r1+0x8 */) {}

// Range: 0x802A1060 -> 0x802A10A4
// this: r31
void zRemyPlayerUseHide::Begin() {}

// Range: 0x802A10A4 -> 0x802A10E8
// this: r31
void zRemyPlayerUseHide::End() {}

static float sREMYUSEATTRACT_RADIUS; // size: 0x4, address: 0x80D6B454
// total size: 0xC
class zRemyPlayerUseAttract : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A10E8 -> 0x802A12DC
// this: r30
void zRemyPlayerUseAttract::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A12DC -> 0x802A1354
// this: r29
void zRemyPlayerUseAttract::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A1354 -> 0x802A13C8
void zRemyPlayerUseAttract::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x802A13C8 -> 0x802A1430
void zRemyPlayerUseAttract::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6616A
// Range: 0x802A1430 -> 0x802A14F8
// this: r31
unsigned int zRemyPlayerUseAttract::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x1C
struct zCarryableAttractUseProperty : public zCarryableProperty {};
// Range: 0x802A14F8 -> 0x802A15B8
// this: r31
void zRemyPlayerUseAttract::Update(float dt /* f31 */) {
    // References
    // -> static float sREMYUSEATTRACT_RADIUS;
}

// Range: 0x802A15B8 -> 0x802A160C
// this: r31
void zRemyPlayerUseAttract::Begin() {
    // References
    // -> static float sREMYUSEATTRACT_RADIUS;
}

// Range: 0x802A160C -> 0x802A1658
// this: r31
void zRemyPlayerUseAttract::End() {}

// total size: 0xC
class zRemyPlayerUseRepel : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A1658 -> 0x802A184C
// this: r30
void zRemyPlayerUseRepel::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A184C -> 0x802A18C4
// this: r29
void zRemyPlayerUseRepel::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A18C4 -> 0x802A1938
void zRemyPlayerUseRepel::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x802A1938 -> 0x802A19A0
void zRemyPlayerUseRepel::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66175
// Range: 0x802A19A0 -> 0x802A1A68
// this: r31
unsigned int zRemyPlayerUseRepel::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x1C
struct zCarryableRepelUseProperty : public zCarryableProperty {};
// Range: 0x802A1A68 -> 0x802A1B28
// this: r31
void zRemyPlayerUseRepel::Update(float dt /* f31 */) {
    // References
    // -> static float sREMYUSEATTRACT_RADIUS;
}

// Range: 0x802A1B28 -> 0x802A1B7C
// this: r31
void zRemyPlayerUseRepel::Begin() {
    // References
    // -> static float sREMYUSEATTRACT_RADIUS;
}

// Range: 0x802A1B7C -> 0x802A1BC8
// this: r31
void zRemyPlayerUseRepel::End() {}

float REMYGLIDE_JUMPVEL; // size: 0x4, address: 0x80D66180
float REMYGLIDE_GLIDEVEL; // size: 0x4, address: 0x80D66184
float REMYGLIDE_FLYVEL; // size: 0x4, address: 0x80D66188
float REMYGLIDE_ACCEL; // size: 0x4, address: 0x80D6618C
float REMYGLIDE_INITVEL; // size: 0x4, address: 0x80D66190
// total size: 0xC
class zRemyPlayerUseGlide : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A1BC8 -> 0x802A1CE8
void zRemyPlayerUseGlide::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> float REMYGLIDE_INITVEL;
    // -> float REMYGLIDE_ACCEL;
    // -> float REMYGLIDE_FLYVEL;
    // -> float REMYGLIDE_GLIDEVEL;
    // -> float REMYGLIDE_JUMPVEL;
}

// Range: 0x802A1CE8 -> 0x802A1EDC
// this: r30
void zRemyPlayerUseGlide::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A1EDC -> 0x802A1FA4
// this: r29
void zRemyPlayerUseGlide::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A1FA4 -> 0x802A2018
void zRemyPlayerUseGlide::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x802A2018 -> 0x802A2080
void zRemyPlayerUseGlide::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66194
// Range: 0x802A2080 -> 0x802A217C
// this: r31
unsigned int zRemyPlayerUseGlide::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x24
struct zCarryableGlideUseProperty : public zCarryableProperty {
    // Members
    unsigned int DirectionOfFlight; // offset 0x1C, size 0x4
    float timer; // offset 0x20, size 0x4
};
// Range: 0x802A217C -> 0x802A21C8
// this: r1+0x8
unsigned int zRemyPlayerUseGlide::StopCheck() {
    // Local variables
    unsigned int ret; // r31
}

// Range: 0x802A21C8 -> 0x802A22CC
// this: r31
void zRemyPlayerUseGlide::Update(float dt /* f30 */) {
    // Local variables
    struct xVec3 position; // r1+0x8
    float theTime; // f31
}

// Range: 0x802A22CC -> 0x802A23B4
// this: r31
void zRemyPlayerUseGlide::Timestep() {
    // Local variables
    struct zCarryableGlideUseProperty * useProperty; // r30
    char timerText[32]; // r1+0x14
    struct xVec3 pos; // r1+0x8
}

// Range: 0x802A23B4 -> 0x802A2488
// this: r31
void zRemyPlayerUseGlide::Begin() {
    // Local variables
    struct zCarryableGlideUseProperty * useProperty; // r30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6619F
// Range: 0x802A2488 -> 0x802A2650
// this: r31
void zRemyPlayerUseGlide::Move(struct xScene * s /* r1+0x8 */, float dt /* f30 */, struct xEntFrame * frame /* r1+0xC */) {
    // Local variables
    float glideVel; // f31
    struct zCarryableGlideUseProperty * useProperty; // r30
...
// Range: 0x802A2650 -> 0x802A2690
// this: r1+0x8
void zRemyPlayerUseGlide::End() {}

float PLAYER_MAX_STICK_SPEED; // size: 0x4, address: 0x80D661A4
float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80D661A8
float PLAYER_COLLISION_DECEL; // size: 0x4, address: 0x80D661AC
float PLAYER_MAX_VEL; // size: 0x4, address: 0x80D661B0
float PLAYER_FRICTION; // size: 0x4, address: 0x80D661B4
float PLAYER_BOUNCE; // size: 0x4, address: 0x80D661B8
float PLAYER_ACCEL; // size: 0x4, address: 0x80D661BC
// total size: 0x28
...
// total size: 0x40
class zRemyPlayerUseRoll : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    // Members
public:
    class zBallForces forces; // offset 0xC, size 0x34
};
// Range: 0x802A2690 -> 0x802A27B4
void zRemyPlayerUseRoll::AddTweaks() {
    // Local variables
    const char * prefix; // r31
...
// Range: 0x802A27B4 -> 0x802A29A8
// this: r30
void zRemyPlayerUseRoll::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802A29A8 -> 0x802A2A20
// this: r29
void zRemyPlayerUseRoll::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x802A2A20 -> 0x802A2A94
void zRemyPlayerUseRoll::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x802A2A94 -> 0x802A2AFC
void zRemyPlayerUseRoll::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D661C0
// Range: 0x802A2AFC -> 0x802A2BC4
// this: r31
unsigned int zRemyPlayerUseRoll::StartCheck() {
    // References
    // -> static char __FUNCTION__[11];
}

// total size: 0x1C
struct zCarryableRollUseProperty : public zCarryableProperty {};
// Range: 0x802A2BC4 -> 0x802A2C08
// this: r31
void zRemyPlayerUseRoll::Update(float dt /* r1+0x8 */) {}

// Range: 0x802A2C08 -> 0x802A2C7C
// this: r31
void zRemyPlayerUseRoll::Begin() {}

// total size: 0x34
class zBallForces {
    // Functions
    void Update(struct xMat4x3 * directionMat, float xInput, float zInput, float dt);

    void Apply(struct xEntFrame * frame, float dt);

    // Members
protected:
    struct xVec3 velocity; // offset 0x0, size 0xC
    struct xVec3 stickVec; // offset 0xC, size 0xC
    struct xVec3 turboVec; // offset 0x18, size 0xC
    struct xVec3 collisionVec; // offset 0x24, size 0xC
    struct zPlayer * ourPlayer; // offset 0x30, size 0x4
};
// Range: 0x802A2C7C -> 0x802A2D70
// this: r31
void zRemyPlayerUseRoll::UpdateOrientation(float dt /* r1+0x8 */) {
    // Local variables
    struct xVec3 stickVec; // r1+0x20
    struct xVec3 worldStickVec; // r1+0x14
    float angle; // r1+0x10
    float mag; // r1+0xC
    const struct xMat4x3 & camMat; // r30
    float angleDiff; // f31
...
// Range: 0x802A2D70 -> 0x802A2E3C
// this: r31
void zRemyPlayerUseRoll::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r1+0xC */) {}

float sTimeElapsed; // size: 0x4, address: 0x80D6A1A4
// Range: 0x802A2E3C -> 0x802A2F10
// this: r31
unsigned char zRemyPlayerUseRoll::CollisionResponse(const struct xVec3 & currentDir /* r1+0x8 */, const struct SphereCollisionResults & sceneCollide /* r29 */, struct xVec3 & responseDpos /* r1+0xC */) {
    // Local variables
    struct xVec3 velocityVector; // r1+0x28
    struct xVec3 bounceVector; // r1+0x1C
...
// Range: 0x802A2F10 -> 0x802A2F90
static void ReflectVector(struct xVec3 & o /* r29 */, const struct xVec3 & v /* r31 */, const struct xVec3 & unitAxis /* r30 */) {
    // Local variables
    struct xVec3 v_1; // r1+0x8
}

// Range: 0x802A2F90 -> 0x802A2FC4
// this: r1+0x8
void zRemyPlayerUseRoll::End() {}

// total size: 0xC
class zRemyPlayerGrabWhif : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802A2FC4 -> 0x802A3034
// this: r1+0x18
void zRemyPlayerGrabWhif::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x802A3034 -> 0x802A30B4
// this: r31
void zRemyPlayerGrabWhif::AddActionTransitions(struct xAnimTable * table /* r29 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r30
}

// Range: 0x802A30B4 -> 0x802A311C
// this: r31
void zRemyPlayerGrabWhif::Update(float dt /* r1+0x8 */) {}

// Range: 0x802A311C -> 0x802A3170
// this: r1+0x8
void zRemyPlayerGrabWhif::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x802A3170 -> 0x802A31C4
void zRemyPlayerGrabWhif::AddPunchTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x802A31C4 -> 0x802A31CC
unsigned int zRemyPlayerGrabWhif::StartCheck() {}

// Range: 0x802A31CC -> 0x802A3234
void zRemyPlayerGrabWhif::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// total size: 0xC
class zRemyPlayerIdle : public zPlayerIdle {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802A3234 -> 0x802A329C
// this: r31
void zRemyPlayerIdle::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// total size: 0xC
class zPlayerIdle : public zCommonPlayerAction {};
// total size: 0xC
class zRemyPlayerSkidStop : public zPlayerSkidStop {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802A329C -> 0x802A3304
// this: r31
void zRemyPlayerSkidStop::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// total size: 0xC
class zPlayerSkidStop : public zCommonPlayerAction {};
// total size: 0xC
class zRemyPlayerSlip : public zPlayerSlip {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802A3304 -> 0x802A336C
// this: r31
void zRemyPlayerSlip::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// total size: 0xC
class zPlayerSlip : public zCommonPlayerAction {};
// total size: 0xC
class zRemyPlayerWalk : public zPlayerWalk {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802A336C -> 0x802A33D4
// this: r31
void zRemyPlayerWalk::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// total size: 0xC
class zPlayerWalk : public zCommonPlayerAction {};
// total size: 0x10
class zRemyPlayerRun : public zPlayerRun {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802A33D4 -> 0x802A343C
// this: r31
void zRemyPlayerRun::AddActionTransitions(struct xAnimTable * table /* r30 */) {}
...
// total size: 0xC
class zRemyPlayerPunch : public zPlayerPunch {
    // Functions
    void AddActionTransitions(struct xAnimTable * table);
};
...
// Range: 0x802A343C -> 0x802A3530
void zRemyPlayerPunch::SetUpgradeLevel(class zCombatAttack * attackStates /* r4 */, enum zCommonPlayerUpgradeLevel level /* r5 */) {
    // References
    // -> static signed short szRemyHitPoints_Punch4[3];
    // -> static signed short szRemyHitPoints_Punch3[3];
    // -> static signed short szRemyHitPoints_Punch2[3];
    // -> static signed short szRemyHitPoints_Punch1[3];
}

// Range: 0x802A3530 -> 0x802A3804
void zRemyPlayerPunch::AddAttacks(class zCombatAttack * attackStates /* r31 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r30 */) {
    // References
    // -> static signed short szRemyHitPoints_Punch4[3];
    // -> static signed short szRemyHitPoints_Punch3[3];
    // -> static signed short szRemyHitPoints_Punch2[3];
...
// Range: 0x802A3804 -> 0x802A3894
// this: r31
void zRemyPlayerPunch::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zRemyPlayerCarry * carry; // r29
    class zRemyPlayerGrabWhif * whif; // r28
}

// total size: 0xC
class zPlayerPunch : public zCommonPlayerAction {};
// total size: 0x28
class zRemyPlayerDodge : public zPlayerDodge {};
// Range: 0x802A3894 -> 0x802A3A9C
// this: r31
void zBallForces::Update(struct xMat4x3 * directionMat /* r30 */, float xInput /* f26 */, float zInput /* f27 */, float dt /* f23 */) {
    // Local variables
    float angle; // r1+0x8
    float mag; // f25
    float accel; // f31
    ...
    // References
    // -> float PLAYER_MAX_VEL;
    // -> float PLAYER_COLLISION_DECEL;
    // -> float PLAYER_FRICTION;
    // -> float PLAYER_MAX_STICK_SPEED;
    // -> float PLAYER_ACCEL;
}

// Range: 0x802A3A9C -> 0x802A3AD0
// this: r3
void zBallForces::Apply(struct xEntFrame * frame /* r4 */, float dt /* f1 */) {}
...
// total size: 0x58
struct {} zRemyPlayerPunch::__vtable; // size: 0x58, address: 0x805261E0
// total size: 0x54
struct {} zRemyPlayerRun::__vtable; // size: 0x54, address: 0x80526238
// total size: 0x54
struct {} zRemyPlayerWalk::__vtable; // size: 0x54, address: 0x8052628C
// total size: 0x54
struct {} zRemyPlayerSlip::__vtable; // size: 0x54, address: 0x805262E0
// total size: 0x54
struct {} zRemyPlayerSkidStop::__vtable; // size: 0x54, address: 0x80526334
// total size: 0x54
struct {} zRemyPlayerIdle::__vtable; // size: 0x54, address: 0x80526388
// total size: 0x54
struct {} zRemyPlayerGrabWhif::__vtable; // size: 0x54, address: 0x805263DC
// total size: 0x54
struct {} zRemyPlayerUseRoll::__vtable; // size: 0x54, address: 0x80526430
// total size: 0x54
struct {} zRemyPlayerUseGlide::__vtable; // size: 0x54, address: 0x80526484
// total size: 0x54
struct {} zRemyPlayerUseRepel::__vtable; // size: 0x54, address: 0x805264D8
// total size: 0x54
struct {} zRemyPlayerUseAttract::__vtable; // size: 0x54, address: 0x8052652C
// total size: 0x54
struct {} zRemyPlayerUseHide::__vtable; // size: 0x54, address: 0x80526580
// total size: 0x54
struct {} zRemyPlayerUseSwipe::__vtable; // size: 0x54, address: 0x805265D4
// total size: 0x54
struct {} zRemyPlayerUseGeneric::__vtable; // size: 0x54, address: 0x80526628
// total size: 0x54
struct {} zRemyPlayerCarry::__vtable; // size: 0x54, address: 0x8052667C
// total size: 0xC
...
// Range: 0x802A3AD0 -> 0x802A3B84
// this: r31
static unsigned char grab_collide_callback::operator()(struct xEnt & ent /* r30 */) {}
