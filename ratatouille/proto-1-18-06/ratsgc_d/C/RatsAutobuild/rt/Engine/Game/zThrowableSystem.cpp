/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zThrowableSystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021D3B0 -> 0x80220C80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float THROW_MAX_ANGLE; // size: 0x4, address: 0x80D64A00
float SIN_THROW_MAX_ANGLE; // size: 0x4, address: 0x80D64A04
float COS_THROW_MAX_ANGLE; // size: 0x4, address: 0x80D64A08
float TAN_THROW_MAX_ANGLE; // size: 0x4, address: 0x80D64A0C
float DROP_ANGLE; // size: 0x4, address: 0x80D64A10
float SIN_DROP_ANGLE; // size: 0x4, address: 0x80D64A14
float COS_DROP_ANGLE; // size: 0x4, address: 0x80D64A18
float THROW_MAX_TIME; // size: 0x4, address: 0x80D64A1C
float THROW_TARGET_MAX_ANGLE; // size: 0x4, address: 0x80D64A20
float COS_THROW_TARGET_MAX_ANGLE; // size: 0x4, address: 0x80D64A24
float SPLASH_MIN_DIST; // size: 0x4, address: 0x80D64A28
float FALLING_DECELERATION_XZ; // size: 0x4, address: 0x80D64A2C
float FALLING_GRAVITY; // size: 0x4, address: 0x80D64A30
static float carryDamageMultipliers[3]; // size: 0xC, address: 0x80D64A34
static float carryRadiusMultipliers[3]; // size: 0xC, address: 0x80D64A40
static unsigned int throwEffectFlags[3]; // size: 0xC, address: 0x80D6F180
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$892zThrowableSystem_cpp */ {
    // Members
...
union /* @class$1040zThrowableSystem_cpp */ {
...
// total size: 0xC
struct /* @class$1039zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x18
class zFXShockwaveConfig {
    // Members
public:
    float maxTime; // offset 0x0, size 0x4
    struct xVec3 maxScale; // offset 0x4, size 0xC
    struct RpAtomic * modelFile; // offset 0x10, size 0x4
    struct xSurface * surface; // offset 0x14, size 0x4
};
static class zFXShockwaveConfig shockwaveConfig; // size: 0x18, address: 0x80D183B8
static float SHOCKWAVE_TIME; // size: 0x4, address: 0x80D64A4C
// total size: 0xC
struct curve_node {
    // Members
...
static unsigned char throwModelMapUnsorted; // size: 0x1, address: 0x80D6AEC8
static int throwDebugCurrent; // size: 0x4, address: 0x80D6AECC
// total size: 0x28
struct StaticThrowableProperty {
    // Members
    unsigned int animCode; // offset 0x0, size 0x4
    float minThrowSpeed; // offset 0x4, size 0x4
    float maxThrowSpeed; // offset 0x8, size 0x4
    float dropSpeed; // offset 0xC, size 0x4
    float maxThrowTime; // offset 0x10, size 0x4
    float rotationRate; // offset 0x14, size 0x4
    unsigned int (* collideCB)(float &, struct xEnt *, struct xEnt *, struct xVec3 *, struct xVec3 *, float, float, void *); // offset 0x18, size 0x4
    unsigned int (* destroyCB)(struct xEnt *, void *, unsigned char); // offset 0x1C, size 0x4
    const char * splashName; // offset 0x20, size 0x4
    unsigned int flags; // offset 0x24, size 0x4
};
static struct StaticThrowableProperty staticThrowableProperties[3]; // size: 0x78, address: 0x80523430
// total size: 0xC
struct ThrowableModelMap {
    // Members
    unsigned int model; // offset 0x0, size 0x4
    unsigned int property; // offset 0x4, size 0x4
    unsigned int animCode; // offset 0x8, size 0x4
};
static struct ThrowableModelMap * throwModelMap; // size: 0x4, address: 0x80D6AED0
static unsigned int throwModelMapCount; // size: 0x4, address: 0x80D6AED4
static unsigned int throwModelMapMaxCount; // size: 0x4, address: 0x80D6AED8
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
struct zThrowableProperty {
    // Members
    float minThrowSpeed; // offset 0x0, size 0x4
    float maxThrowSpeed; // offset 0x4, size 0x4
    float dropSpeed; // offset 0x8, size 0x4
    float maxThrowTime; // offset 0xC, size 0x4
    float rotationRate; // offset 0x10, size 0x4
    unsigned int (* collideCB)(float &, struct xEnt *, struct xEnt *, struct xVec3 *, struct xVec3 *, float, float, void *); // offset 0x14, size 0x4
    void * collideCBData; // offset 0x18, size 0x4
    unsigned int (* destroyCB)(struct xEnt *, void *, unsigned char); // offset 0x1C, size 0x4
    void * destroyCBData; // offset 0x20, size 0x4
    struct zShrapnelAsset * shrapnel; // offset 0x24, size 0x4
    int splashID; // offset 0x28, size 0x4
    unsigned int flags; // offset 0x2C, size 0x4
    struct xVec3 preferOffset; // offset 0x30, size 0xC
    struct xVec3 preferUp; // offset 0x3C, size 0xC
};
static struct zThrowableProperty * throwProperties; // size: 0x4, address: 0x80D6AEDC
static unsigned int throwPropertiesCount; // size: 0x4, address: 0x80D6AEE0
static unsigned int throwPropertiesMaxCount; // size: 0x4, address: 0x80D6AEE4
// Range: 0x8021D3B0 -> 0x8021D3D8
static int UintCompare(unsigned int a /* r3 */, unsigned int b /* r4 */) {}

// Range: 0x8021D3D8 -> 0x8021D494
static struct zThrowableProperty * GetThrowableProperty(unsigned int id /* r1+0x8 */) {
    // Local variables
    const struct ThrowableModelMap * entry; // r31

    // References
    // -> static struct zThrowableProperty * throwProperties;
    // -> static unsigned int throwModelMapCount;
    // -> static struct ThrowableModelMap * throwModelMap;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64A50
// total size: 0x30B0
struct RunningThrow {
    // Static members
    static int DEBUG_MAX_POINTS; // size: 0x4

    // Members
    struct xEnt * object; // offset 0x0, size 0x4
    const struct xEnt * target; // offset 0x4, size 0x4
    const struct zThrowableProperty * property; // offset 0x8, size 0x4
    float time; // offset 0xC, size 0x4
    float radius; // offset 0x10, size 0x4
    float rotationRate; // offset 0x14, size 0x4
    float emitRemaining; // offset 0x18, size 0x4
    struct xVec3 startPosition; // offset 0x1C, size 0xC
    struct xVec3 velocity; // offset 0x28, size 0xC
    struct xVec3 lastPosition; // offset 0x34, size 0xC
    struct xVec3 collisionCenter; // offset 0x40, size 0xC
    struct xVec3 rotationAxis; // offset 0x4C, size 0xC
    struct xVec3 splashLoc; // offset 0x58, size 0xC
    enum zCommonPlayerUpgradeLevel upgradeLevel; // offset 0x64, size 0x4
    struct xFXRibbon * ribbon; // offset 0x68, size 0x4
    float ribDistance; // offset 0x6C, size 0x4
    struct xVec3 ribAverageWidth; // offset 0x70, size 0xC
    unsigned char splashed; // offset 0x7C, size 0x1
    unsigned char dropped; // offset 0x7D, size 0x1
    unsigned char firstUpdate; // offset 0x7E, size 0x1
    int DEBUG_curPoint; // offset 0x80, size 0x4
    struct xVec3 DEBUG_points[1024]; // offset 0x84, size 0x3000
    float DEBUG_d; // offset 0x3084, size 0x4
    float DEBUG_h; // offset 0x3088, size 0x4
    float DEBUG_V; // offset 0x308C, size 0x4
    float DEBUG_angle; // offset 0x3090, size 0x4
    unsigned char DEBUG_solution; // offset 0x3094, size 0x1
    struct xVec3 DEBUG_start; // offset 0x3098, size 0xC
    struct xVec3 DEBUG_target; // offset 0x30A4, size 0xC
};
static struct RunningThrow * runningThrows; // size: 0x4, address: 0x80D6AEEC
static struct PointTarget * addedTargets; // size: 0x4, address: 0x80D6AEF0
static unsigned int addedTargetsCount; // size: 0x4, address: 0x80D6AEF4
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D64A5F
// Range: 0x8021D494 -> 0x8021D530
static void RadiansToDegrees(void * value /* r30 */) {
    // Local variables
    float * v; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D64A70
// Range: 0x8021D530 -> 0x8021D5CC
static void DegreesToRadians(void * value /* r30 */) {
    // Local variables
    float * v; // r31
...
// Range: 0x8021D5CC -> 0x8021D614
static void OnThrowAngleChange() {
    // References
    // -> float THROW_MAX_ANGLE;
    // -> float TAN_THROW_MAX_ANGLE;
    // -> float COS_THROW_MAX_ANGLE;
    // -> float SIN_THROW_MAX_ANGLE;
}

// Range: 0x8021D614 -> 0x8021D64C
static void OnDropAngleChange() {
    // References
    // -> float DROP_ANGLE;
    // -> float COS_DROP_ANGLE;
    // -> float SIN_DROP_ANGLE;
}

// Range: 0x8021D64C -> 0x8021D674
static void OnThrowTargetAngleChange() {
    // References
    // -> float THROW_TARGET_MAX_ANGLE;
    // -> float COS_THROW_TARGET_MAX_ANGLE;
}

// Range: 0x8021D674 -> 0x8021D6C4
static void OnMaxThrowSpeedChange(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r31

    // References
    // -> static struct StaticThrowableProperty staticThrowableProperties[3];
    // -> static struct zThrowableProperty * throwProperties;
}

// Range: 0x8021D6C4 -> 0x8021D710
static void OnMinThrowSpeedChange(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r31
...
// Range: 0x8021D710 -> 0x8021D760
static void OnDropVelocityChange(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r31
...
// Range: 0x8021D760 -> 0x8021D7B0
static void OnRotationRateChange(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r31
...
static unsigned char sDrawThrowCollision; // size: 0x1, address: 0x80D6AEF8
static unsigned char sDrawThrowTargeting; // size: 0x1, address: 0x80D6AEF9
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x8021D7B0 -> 0x8021DA14
static void ThrowDebugCallback() {
    // Local variables
    const struct RunningThrow & rt; // r31
    int i; // r30
    ...
    // -> static int throwDebugCurrent;
    // -> static struct RunningThrow * runningThrows;
}
...
// Range: 0x8021DA14 -> 0x8021DA68
static void DestroyThrow(struct RunningThrow & thr /* r31 */) {
    // Local variables
    struct xEnt * ent; // r1+0x8
}

static float SPARK_EMIT_PER_DIST; // size: 0x4, address: 0x80D64A84
static float SPARK_EMIT_DIST_RAND; // size: 0x4, address: 0x80D64A88
static float SPARK_DIR_VARIANCE_ANGLE; // size: 0x4, address: 0x80D64A8C
static float SPARK_LIFETIME_MIN; // size: 0x4, address: 0x80D64A90
static float SPARK_LIFETIME_RAND; // size: 0x4, address: 0x80D64A94
static float SPARK_VELOCITY_MIN; // size: 0x4, address: 0x80D64A98
static float SPARK_VELOCITY_RAND; // size: 0x4, address: 0x80D64A9C
static float SPARK_SIZE_MIN; // size: 0x4, address: 0x80D64AA0
static float SPARK_SIZE_RAND; // size: 0x4, address: 0x80D64AA4
static float GLINT_LENGTH_MIN; // size: 0x4, address: 0x80D64AA8
static float GLINT_LENGTH_RAND; // size: 0x4, address: 0x80D64AAC
static float GLINT_LENGTH_CLAMP_MIN; // size: 0x4, address: 0x80D64AB0
static float GLINT_LENGTH_CLAMP_RAND; // size: 0x4, address: 0x80D64AB4
// total size: 0x28
...
// Range: 0x8021DA68 -> 0x8021DD00
static void AddSparkTweaks(const char * prefix /* r31 */) {
    // References
    // -> static float GLINT_LENGTH_CLAMP_RAND;
    // -> static float GLINT_LENGTH_CLAMP_MIN;
    // -> static float GLINT_LENGTH_RAND;
    // -> static float GLINT_LENGTH_MIN;
    // -> static float SPARK_SIZE_RAND;
    // -> static float SPARK_SIZE_MIN;
    // -> static float SPARK_VELOCITY_RAND;
    // -> static float SPARK_VELOCITY_MIN;
    // -> static float SPARK_LIFETIME_RAND;
    // -> static float SPARK_LIFETIME_MIN;
    // -> struct tweak_callback cb_tweak_convert_degrees;
    // -> static float SPARK_DIR_VARIANCE_ANGLE;
    // -> static float SPARK_EMIT_DIST_RAND;
    // -> static float SPARK_EMIT_PER_DIST;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D64AB8
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8021DD00 -> 0x8021E16C
static void EmitSparks(const struct xVec3 & start /* r1+0x10 */, const struct xVec3 & dir /* r23 */, float distance /* f24 */, float dt /* f25 */) {
    // Local variables
    int numParticles; // r31
    struct xVec3 * locList; // r29
    struct xVec3 * dirList; // r30
    float * lenVelList; // r27
    float cosangle; // f30
    struct xMat3x3 dirMat; // r1+0x20
    int particleCounter; // r26
    struct xVec3 * locPtr; // r25
    struct xVec3 * dirPtr; // r28
    float * lenPtr; // r24
    float ang; // f29
    float uz; // f31
    float r; // f28
...
static struct smoke_config smokeConfig; // size: 0x38, address: 0x80D183D0
struct smoke_config default_config; // size: 0x38, address: 0x80D18198
// Range: 0x8021E16C -> 0x8021E23C
static void SetupSmoke() {
    // References
    // -> static struct smoke_config smokeConfig;
    // -> struct smoke_config default_config;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D64AC3
...
// total size: 0x10
struct /* @class$1288zThrowableSystem_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8021E23C -> 0x8021E524
static void EmitRibbon(struct RunningThrow & thr /* r31 */, struct xVec3 & currentPosition /* r28 */, struct xVec3 & lastPosition /* r1+0x8 */) {
    // Local variables
    struct xVec3 dir; // r1+0x48
    struct xVec3 * prevWidth; // r29
    struct xVec3 widthDir; // r1+0x3C
    struct xVec3 negWidthDir; // r1+0x30
...
// total size: 0xC
struct /* @class$833zThrowableSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zThrowableSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zThrowableSystem_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zThrowableSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zThrowableSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zThrowableSystem_cpp */ {
    // Members
...
struct PointTarget {
    // Members
    const struct xVec3 * target; // offset 0x0, size 0x4
    unsigned char priority; // offset 0x4, size 0x1
};
// Range: 0x8021E524 -> 0x8021E558
void zThrowableSystemClearAddedTargets() {
    // References
    // -> static unsigned int addedTargetsCount;
    // -> static struct PointTarget * addedTargets;
}

// Range: 0x8021E558 -> 0x8021E5B4
int zThrowableSystemFindRunningThrow(const struct xEnt * object /* r3 */) {
    // Local variables
    int i; // r31
...
static char __FUNCTION__[34]; // size: 0x22, address: 0x805234A8
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8021E5B4 -> 0x8021E6BC
void zThrowableSystemStartScenePrepare() {
    // References
    // -> static class zFXShockwaveConfig shockwaveConfig;
    // -> static float SHOCKWAVE_TIME;
    // -> static char __FUNCTION__[34];
    // -> unsigned int gActiveHeap;
    // -> static struct PointTarget * addedTargets;
    // -> static struct RunningThrow * runningThrows;
    // -> static unsigned int throwPropertiesMaxCount;
    // -> static unsigned int throwPropertiesCount;
    // -> static struct zThrowableProperty * throwProperties;
    // -> static unsigned char throwModelMapUnsorted;
    // -> static unsigned int throwModelMapMaxCount;
    // -> static unsigned int throwModelMapCount;
    // -> static struct ThrowableModelMap * throwModelMap;
}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x805234CA
// total size: 0x10
struct xTableAsset : public xBaseAsset {
    // Members
    unsigned int version; // offset 0x8, size 0x4
    unsigned int numRows; // offset 0xC, size 0x4
};
// total size: 0x14
struct ThrowableTableAssetRow {
    ...
    unsigned int shrapnel; // offset 0x8, size 0x4
    int damage; // offset 0xC, size 0x4
    float damageRadius; // offset 0x10, size 0x4
};
// total size: 0x10
struct ThrowableTableAsset : public xTableAsset {
    // Members
    struct ThrowableTableAssetRow rows[]; // offset 0x10, size 0x0
};
// Range: 0x8021E6BC -> 0x8021EC90
void zThrowableSystemAddBasicTypes() {
    // Local variables
    int count; // r25
    int i; // r27
    unsigned int size; // r1+0x8
    struct ThrowableTableAsset * table; // r29
    unsigned long expected_asset_size; // r24
    int i; // r26
    struct ThrowableTableAsset * table; // r30
    unsigned int j; // r28
    const struct StaticThrowableProperty & staticProperties; // r31
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x805234E8
struct xVec3 g_O3; // size: 0xC, address: 0x80D6D198
// Range: 0x8021EC90 -> 0x8021EE8C
void zThrowableSystemRegister(unsigned int baseModel /* r26 */, unsigned int animCode /* r27 */, float minThrowSpeed /* r1+0x8 */, float maxThrowSpeed /* r1+0xC */, float dropSpeed /* r1+0x10 */, float maxThrowTime /* r1+0x14 */, float rotationRate /* r1+0x18 */, unsigned int (* collide)(float &, struct xEnt *, struct xEnt *, struct xVec3 *, struct xVec3 *, float, float, void *) /* r1+0x1C */, void * collideData /* r1+0x20 */, unsigned int (* destroy)(struct xEnt *, void *, unsigned char) /* r1+0x24 */, void * destroyData /* r1+0x28 */, struct zShrapnelAsset * shrapnel /* r1+0x2C */, const char * splashName /* r23 */, unsigned int flags /* r1+0x68 */, const struct xVec3 * preferOffset /* r24 */, const struct xVec3 * preferUp /* r25 */) {
    // Local variables
    struct zThrowableProperty & props; // r31
...
// Range: 0x8021EE8C -> 0x8021EF58
static void InsertModelMap(unsigned int model /* r1+0x8 */, unsigned int property /* r1+0xC */, unsigned int animCode /* r1+0x10 */) {
    // Local variables
    struct ThrowableModelMap * point; // r31
...
static struct tweak_callback cbAngle; // size: 0x28, address: 0x80523504
static signed char init; // size: 0x1, address: 0x80D6AEFA
static struct tweak_callback cbDropAngle; // size: 0x28, address: 0x8052352C
static signed char init; // size: 0x1, address: 0x80D6AEFB
static struct tweak_callback cbTargetAngle; // size: 0x28, address: 0x80523554
static signed char init; // size: 0x1, address: 0x80D6AEFC
static struct tweak_callback cbMaxThrowSpeed; // size: 0x28, address: 0x8052357C
static signed char init; // size: 0x1, address: 0x80D6AEFD
static struct tweak_callback cbMinThrowSpeed; // size: 0x28, address: 0x805235A4
static signed char init; // size: 0x1, address: 0x80D6AEFE
static struct tweak_callback cbDrop; // size: 0x28, address: 0x805235CC
static signed char init; // size: 0x1, address: 0x80D6AEFF
static struct tweak_callback cbRotationRate; // size: 0x28, address: 0x805235F4
static signed char init; // size: 0x1, address: 0x80D6AF00
static char __FUNCTION__[35]; // size: 0x23, address: 0x8052361C
// Range: 0x8021EF58 -> 0x8021FA90
void zThrowableSystemFinishScenePrepare() {
    // Local variables
    struct zScene * sc; // r28
    unsigned int i; // r27
    struct xBase * base; // r31
    struct xEnt * ent; // r29
    const char * prefix; // r30

    // References
    // -> static class zFXShockwaveConfig shockwaveConfig;
    // -> static float carryRadiusMultipliers[3];
    // -> static float carryDamageMultipliers[3];
    // -> float FALLING_GRAVITY;
    // -> float FALLING_DECELERATION_XZ;
    // -> static unsigned char sDrawThrowTargeting;
    // -> static unsigned char sDrawThrowCollision;
    // -> static struct StaticThrowableProperty staticThrowableProperties[3];
    // -> static struct tweak_callback cbRotationRate;
    // -> static signed char init;
    // -> static struct tweak_callback cbDrop;
    // -> static signed char init;
    // -> static struct tweak_callback cbMinThrowSpeed;
    // -> static signed char init;
    // -> static struct tweak_callback cbMaxThrowSpeed;
    // -> static signed char init;
    // -> float SPLASH_MIN_DIST;
    // -> static struct tweak_callback cbTargetAngle;
    // -> float THROW_TARGET_MAX_ANGLE;
    // -> static signed char init;
    // -> static struct tweak_callback cbDropAngle;
    // -> float DROP_ANGLE;
    // -> static signed char init;
    // -> float THROW_MAX_TIME;
    // -> static struct tweak_callback cbAngle;
    // -> float THROW_MAX_ANGLE;
    // -> static signed char init;
    // -> static struct RunningThrow * runningThrows;
...
static char __FUNCTION__[37]; // size: 0x25, address: 0x8052363F
// Range: 0x8021FACC -> 0x8021FB8C
unsigned char zThrowableSystemModelAddedBeforeSort(unsigned int model /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
...
static char __FUNCTION__[35]; // size: 0x23, address: 0x80523664
// Range: 0x8021FB8C -> 0x802200D0
void zThrowableSystemSweptSpherePrepare(int index /* r28 */, struct xSweptSphere & sws /* r29 */, float dt /* f23 */, struct xVec3 & curPos /* r30 */, int npcThrow /* r1+0x10 */, int useOldBound /* r1+0x14 */) {
    // Local variables
    struct RunningThrow & thr; // r31
    float locTime; // f31
    struct xVec3 currentPosition; // r1+0x54
    float fallTime; // f30
    struct xVec3 velDirXZ; // r1+0x48
    float speedXZ; // f28
    float maxDecelTime; // f29
    float decelTime; // f27
    float zeroVelocityTime; // f25
    struct xVec3 posToBoundCenter; // r1+0x3C
    struct xMat3x3 rot; // r1+0x60
    const struct xVec3 & position; // r27
    const struct xVec3 & boundCenter; // r26
    const struct xVec3 & position; // r25
    struct xVec3 boundCenter; // r1+0x30
    struct xVec3 collStart; // r1+0x24
    struct xVec3 collEnd; // r1+0x18
...
// total size: 0x4
struct /* @class$2403zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2021zThrowableSystem_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2022zThrowableSystem_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2023zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2020zThrowableSystem_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2025zThrowableSystem_cpp */ {
    // Members
...
// Range: 0x802200D0 -> 0x8022067C
void zThrowableSystemUpdate(float dt /* f31 */) {
    // Local variables
    struct xSweptSphere sws; // r1+0x48
    unsigned int i; // r30
    struct RunningThrow & thr; // r31
    struct xVec3 currentPosition; // r1+0x3C
    unsigned int effectFlags; // r27
    struct xVec3 dir; // r1+0x30
    float dist; // f30
    struct xVec3 start; // r1+0x24
    struct xVec3 start; // r1+0x18
    int result; // r28
    unsigned int old_filter_flags; // r25
    struct xSurface * ground; // r26
    struct zSurfaceProps * prop; // r29
    float dx; // f29
    float dz; // f28
    float xzdist2; // f27
    float ymin; // f26
    ...
    // -> struct zGlobals globals;
    // -> struct xColor_tag g_PINK;
    // -> static unsigned char sDrawThrowCollision;
    // -> float THROW_MAX_TIME;
    // -> static struct smoke_config smokeConfig;
    // -> struct xVec3 m_Null;
    // -> static unsigned int throwEffectFlags[3];
    // -> static struct RunningThrow * runningThrows;
}
...
// total size: 0x890
struct /* @class$1785zThrowableSystem_cpp */ {
    // Static members
...
// Range: 0x8022067C -> 0x802207C4
unsigned char zThrowableSystemHandleCollision(const struct zThrowableProperty * property /* r31 */, struct xEnt * thrown /* r30 */, struct xEnt * hit /* r1+0x8 */, const struct xVec3 * objectPos /* r25 */, const struct xVec3 * point /* r26 */, const struct xVec3 * velocity /* r1+0xC */, enum zCommonPlayerUpgradeLevel upgradeLevel /* r29 */) {
    // Local variables
    float blastRadius; // r1+0x10
    unsigned int result; // r28
    unsigned int result; // r27
...
struct zThrowableSystemTarget {
    // Members
    const struct xVec3 * target; // offset 0x0, size 0x4
    const struct xEnt * ent; // offset 0x4, size 0x4
...
class TargetFind {
    // Members
    struct xVec3 boundCenter; // offset 0x0, size 0xC
    const struct xEnt * thrown; // offset 0xC, size 0x4
    const struct xEnt * currentTarget; // offset 0x10, size 0x4
    struct zThrowableSystemTarget * targets; // offset 0x14, size 0x4
    const struct xVec3 * direction; // offset 0x18, size 0x4
    int targetSize; // offset 0x1C, size 0x4
    int * numFound; // offset 0x20, size 0x4
    const struct zThrowableProperty * property; // offset 0x24, size 0x4
};
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x802207C4 -> 0x802209E4
static unsigned int zThrowableSystemGeneralCollideCB(float & blastRadius /* r28 */, struct xEnt * thrown /* r22 */, struct xEnt * hit /* r30 */, const struct xVec3 * pos /* r23 */, const struct xVec3 * velocity /* r1+0x10 */, float damageMultiplier /* r1+0x14 */, float radiusMultiplier /* r1+0x18 */, void * userData /* r1+0x1C */, int defaultDamage /* r1+0x20 */) {
    // Local variables
    int damage; // r29
    struct ThrowableTableAssetRow * row; // r31
    struct xVec3 knockback; // r1+0x24
    enum zHitTarget hitTarget; // r27
    class zNPCCommon * npc; // r25
    class zNPCCommon * npc; // r24
...
// Range: 0x802209E4 -> 0x80220A4C
unsigned int zThrowableSystemSmallCollideCB(float & blastRadius /* r1+0x8 */, struct xEnt * thrown /* r1+0xC */, struct xEnt * hit /* r1+0x10 */, const struct xVec3 * pos /* r1+0x14 */, const struct xVec3 * velocity /* r1+0x18 */, float damageMultiplier /* r1+0x1C */, float radiusMultiplier /* r1+0x20 */, void * userData /* r1+0x24 */) {}

// Range: 0x80220A4C -> 0x80220AB4
unsigned int zThrowableSystemMediumCollideCB(float & blastRadius /* r1+0x8 */, struct xEnt * thrown /* r1+0xC */, struct xEnt * hit /* r1+0x10 */, const struct xVec3 * pos /* r1+0x14 */, const struct xVec3 * velocity /* r1+0x18 */, float damageMultiplier /* r1+0x1C */, float radiusMultiplier /* r1+0x20 */, void * userData /* r1+0x24 */) {}

// Range: 0x80220AB4 -> 0x80220B1C
unsigned int zThrowableSystemLargeCollideCB(float & blastRadius /* r1+0x8 */, struct xEnt * thrown /* r1+0xC */, struct xEnt * hit /* r1+0x10 */, const struct xVec3 * pos /* r1+0x14 */, const struct xVec3 * velocity /* r1+0x18 */, float damageMultiplier /* r1+0x1C */, float radiusMultiplier /* r1+0x20 */, void * userData /* r1+0x24 */) {}

// Range: 0x80220B1C -> 0x80220C48
unsigned int zThrowableSystemDefaultDestroyCB(struct xEnt * ent /* r31 */) {
    // Local variables
    float params[4]; // r1+0x8
    int runningThrowIndex; // r30
...
// total size: 0x1
class BinaryMapCompare {};
// Range: 0x80220C48 -> 0x80220C80
static int BinaryMapCompare::operator()(unsigned int a /* r1+0x8 */, const struct ThrowableModelMap & b /* r31 */) {}
