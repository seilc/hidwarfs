/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zForceFieldEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028DA60 -> 0x80290CF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int mesh_rows; // size: 0x4, address: 0x80D65D60
static int mesh_columns; // size: 0x4, address: 0x80D65D64
static float wave_decay; // size: 0x4, address: 0x80D65D68
static float wave_decay_result; // size: 0x4, address: 0x80D6B398
static float wave_speed; // size: 0x4, address: 0x80D65D6C
static float wave_clamp; // size: 0x4, address: 0x80D65D70
static float framerate_blend; // size: 0x4, address: 0x80D65D74
// total size: 0x10
struct _xFColor {
    // Members
...
static float initial_stablize_force; // size: 0x4, address: 0x80D65D78
static float ripple_time; // size: 0x4, address: 0x80D65D7C
static float ripple_force; // size: 0x4, address: 0x80D65D80
static float strength_to_ripple; // size: 0x4, address: 0x80D65D84
static float fade_time; // size: 0x4, address: 0x80D65D88
static struct _xFColor default_color; // size: 0x10, address: 0x80D65D8C
static struct _xFColor mid_color; // size: 0x10, address: 0x80D65D9C
static struct _xFColor weak_color; // size: 0x10, address: 0x80D65DAC
static float strength_to_flicker; // size: 0x4, address: 0x80D65DBC
static float max_flicker_time; // size: 0x4, address: 0x80D65DC0
static float min_flicker_time; // size: 0x4, address: 0x80D6B39C
static float transition_time; // size: 0x4, address: 0x80D65DC4
static int wrap_u; // size: 0x4, address: 0x80D65DC8
static int wrap_v; // size: 0x4, address: 0x80D65DCC
static unsigned int texture; // size: 0x4, address: 0x80D65DD0
static int glow_clamp; // size: 0x4, address: 0x80D65DD4
static float height_glow; // size: 0x4, address: 0x80D65DD8
static float spin_speed; // size: 0x4, address: 0x80D65DDC
static float zbias; // size: 0x4, address: 0x80D6B3A0
static float lifetime; // size: 0x4, address: 0x80D65DE0
static float life_rand; // size: 0x4, address: 0x80D65DE4
static float size_min; // size: 0x4, address: 0x80D65DE8
static float size_rand; // size: 0x4, address: 0x80D65DEC
static float velocity; // size: 0x4, address: 0x80D65DF0
static float velocity_rand; // size: 0x4, address: 0x80D65DF4
static float glint_length_min; // size: 0x4, address: 0x80D6B3A4
static float glint_length_rand; // size: 0x4, address: 0x80D65DF8
static float glint_length_max; // size: 0x4, address: 0x80D65DFC
static float gravity; // size: 0x4, address: 0x80D65E00
static int fraction; // size: 0x4, address: 0x80D65E04
static unsigned char render_heightmap; // size: 0x1, address: 0x80D6B3A8
static float render_heightmap_scale; // size: 0x4, address: 0x80D65E08
static float render_heightmap_yoffset; // size: 0x4, address: 0x80D65E0C
static float test_strength; // size: 0x4, address: 0x80D65E10
static class zForceFieldEffect FFEList[9]; // size: 0x870, address: 0x80D26D70
static struct RwRaster * energy_raster; // size: 0x4, address: 0x80D6B3AC
static int sparkSystemID; // size: 0x4, address: 0x80D65E14
static int glintSystemID; // size: 0x4, address: 0x80D65E18
static int electricSystemID; // size: 0x4, address: 0x80D65E1C
// total size: 0x1C
struct ArcConfig {
    // Members
    float lifeMin; // offset 0x0, size 0x4
    float lifeMax; // offset 0x4, size 0x4
    float sizeMin; // offset 0x8, size 0x4
    float sizeMax; // offset 0xC, size 0x4
    float emitRate; // offset 0x10, size 0x4
    float swapTime; // offset 0x14, size 0x4
    unsigned char emitAll; // offset 0x18, size 0x1
    unsigned char attachToParent; // offset 0x19, size 0x1
};
static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig; // size: 0x1C, address: 0x804CB6A8
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65E20
// Range: 0x8028DA60 -> 0x8028DB34
static void unit_sphere_size(int & verts_size /* r28 */, int & indices_size /* r29 */, int rows /* r30 */, int cols /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x8028DB34 -> 0x8028DC2C
static void apply_uv_matrix(struct xVec2 * ouv /* r3 */, const struct xVec2 * iuv /* r4 */, int size /* r5 */, const struct xMat4x3 & uvmat /* r6 */) {
    // Local variables
    float rx; // f29
    float ry; // f28
    float ux; // f27
    ...
    float px; // f25
    float py; // f24
    struct xVec2 * end_ouv; // r31
    float x; // f31
    float y; // f30
}

// Range: 0x8028DC2C -> 0x8028DC78
static void scroll_v(struct xVec2 * ouv /* r3 */, const struct xVec2 * iuv /* r4 */, int size /* r5 */, float uoffset /* f1 */) {
    // Local variables
    struct xVec2 * end_ouv; // r31
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80525448
// Range: 0x8028DC78 -> 0x8028DE24
static void unit_sphere_calc_indices(unsigned short * indices /* r22 */, int rows /* r23 */, int cols /* r29 */) {
    // Local variables
    int i; // r27
    int j; // r30
    unsigned short * index; // r31
    int start; // r28
    int cap_full_strips; // r25
    int cap_remaining; // r1+0x10
    int bottom; // r26
    int expected_verts_size; // r1+0xC
    int expected_indices_size; // r1+0x8
    int indices_size; // r24

    // References
    // -> static char __FUNCTION__[25];
}

static char prefix[128]; // size: 0x80, address: 0x80D275E0
// total size: 0x28
...
static struct tweak_callback cb_energy_uv; // size: 0x28, address: 0x804CB6C4
static struct tweak_callback cb_reload_energy_texture; // size: 0x28, address: 0x804CB6EC
// total size: 0x34
struct meshData {
    // Members
    struct xVec3 * verts; // offset 0x0, size 0x4
    int verts_size; // offset 0x4, size 0x4
    unsigned short * strip_indices; // offset 0x8, size 0x4
    int strip_indices_size; // offset 0xC, size 0x4
    float * full_heightmap[2]; // offset 0x10, size 0x8
    float * heightmap[2]; // offset 0x18, size 0x8
    int active_heightmap; // offset 0x20, size 0x4
    struct xVec2 * energy_uv; // offset 0x24, size 0x4
    struct xColor_tag * refract_color; // offset 0x28, size 0x4
    float * cell_width_scale; // offset 0x2C, size 0x4
    unsigned char malloced; // offset 0x30, size 0x1
};
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$956zForceFieldEffect_cpp */ {
    // Members
    struct xVec3 * verts; // offset 0x0, size 0x4
};
// total size: 0x0
...
// total size: 0xF0
class zForceFieldEffect {
    // Functions
    void unit_sphere_calc_vertices(struct xVec3 * verts, int rows, int cols);

    void refresh_energy_uv();

    void refresh_refract_color();

    void refresh_cell_width_scale();

    void create_sphere_mesh();

    void animate_heightmap(float dt);

    void copy_buffers(struct xIMLockContext & energy_lock, const struct xVec3 * verts, const struct xColor_tag * colors);

    void shade_sphere(struct xVec3 * verts, struct xColor_tag * colors, const struct _xFColor * shieldColor);

    void EmitRandomRipple(float force);

    void Setup();

    void FreeForceField();

    void Move(const struct xMat4x3 & mat);
    ...
    void DestroyShield(float dt, struct xModelInstance * model);

    void updateDestroyEffects(float dt);

    void RenderFront();

    // Members
    struct meshData mesh; // offset 0x0, size 0x34
    struct xMat4x3 ball_mat; // offset 0x40, size 0x40
    float energy_spin; // offset 0x80, size 0x4
    float Aold; // offset 0x84, size 0x4
    float Avel; // offset 0x88, size 0x4
    float midHeight; // offset 0x8C, size 0x4
    int sphereRows; // offset 0x90, size 0x4
    int midRows; // offset 0x94, size 0x4
    struct xVec3 offset; // offset 0x98, size 0xC
    float scale; // offset 0xA4, size 0x4
    unsigned char used; // offset 0xA8, size 0x1
    unsigned char skipFrame; // offset 0xA9, size 0x1
    unsigned char overrideColor; // offset 0xAA, size 0x1
    unsigned char distortShield; // offset 0xAB, size 0x1
    float lastUsedTime; // offset 0xAC, size 0x4
    float fadeTimer; // offset 0xB0, size 0x4
    struct _xFColor baseShieldColor; // offset 0xB4, size 0x10
    struct _xFColor currentColor; // offset 0xC4, size 0x10
    float shieldColorCycle; // offset 0xD4, size 0x4
    float shieldStrength; // offset 0xD8, size 0x4
    float timeToNextRipple; // offset 0xDC, size 0x4
    unsigned char shieldDestroyed; // offset 0xE0, size 0x1
    float arcEmitRemaining; // offset 0xE4, size 0x4
    struct xModelInstance * electricModel; // offset 0xE8, size 0x4
};
// Range: 0x8028DE24 -> 0x8028E690
void zForceFieldEffect::AddTweaks(const char * name /* r1+0x10 */, class zForceFieldEffect * ffe /* r31 */) {
    // Local variables
    const char * * texture_labels; // r1+0x18
    const unsigned int * texture_ids; // r1+0x14
    unsigned int textures; // r30

    // References
    // -> static struct _xFColor weak_color;
    // -> static char prefix[128];
    // -> static struct _xFColor mid_color;
    // -> static struct _xFColor default_color;
    // -> static float transition_time;
    // -> static float min_flicker_time;
    // -> static float max_flicker_time;
    // -> static int fraction;
    // -> static float gravity;
    // -> static float glint_length_max;
    // -> static float glint_length_rand;
    // -> static float glint_length_min;
    // -> static float velocity_rand;
    // -> static float velocity;
    // -> static float size_rand;
    // -> static float size_min;
    // -> static float life_rand;
    // -> static float lifetime;
    // -> static float test_strength;
    // -> static float strength_to_ripple;
    // -> static float initial_stablize_force;
    // -> static float ripple_force;
    // -> static float ripple_time;
    // -> static struct tweak_callback cb_reload_energy_texture;
    // -> static unsigned int texture;
    // -> static float zbias;
    // -> static float spin_speed;
    // -> static float height_glow;
    // -> static int glow_clamp;
    // -> static struct tweak_callback cb_energy_uv;
    // -> static int wrap_v;
    // -> static int wrap_u;
}

// Range: 0x8028E690 -> 0x8028E6C8
void zForceFieldEffect::on_change_energy_uv(const struct tweak_info & info /* r30 */) {
    // Local variables
    class zForceFieldEffect * ffe; // r31
}
...
// total size: 0xC
struct /* @class$799zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$800zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$801zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$802zForceFieldEffect_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$803zForceFieldEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$804zForceFieldEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$805zForceFieldEffect_cpp */ {
    // Members
...
// Range: 0x8028E6C8 -> 0x8028E700
void zForceFieldEffect::on_reload_energy_texture(const struct tweak_info & info /* r30 */) {
    // Local variables
    class zForceFieldEffect * ffe; // r31
}

// Range: 0x8028E700 -> 0x8028E708
int zForceFieldEffect::GetSparkSystemID() {
    // References
    // -> static int sparkSystemID;
}

// Range: 0x8028E708 -> 0x8028E710
int zForceFieldEffect::GetGlintSystemID() {
    // References
    // -> static int glintSystemID;
}
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80525461
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8028E710 -> 0x8028EADC
// this: r31
void zForceFieldEffect::unit_sphere_calc_vertices(struct xVec3 * verts /* r24 */, int rows /* r28 */, int cols /* r26 */) {
    // Local variables
    float heightStep; // f30
    float yoffset; // f31
    float drow; // f29
    float dcol; // f28
    struct xMat3x3 drow_mat; // r1+0x60
    struct xMat3x3 dcol_mat; // r1+0x30
    struct xVec3 * v; // r30
    struct xVec3 row_dir; // r1+0x24
    int i; // r29
    struct xVec3 col_dir; // r1+0x18
    int j; // r27
    int expected_verts_size; // r1+0x14
    int expected_indices_size; // r1+0x10
    int verts_size; // r25
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D65E31
// total size: 0x40
...
// Range: 0x8028EADC -> 0x8028ED00
// this: r31
void zForceFieldEffect::refresh_energy_uv() {
    // Local variables
    struct xVec2 * uv_buffer; // r28
    float halfHeight; // f31
    struct xVec3 * vertNormals; // r27
    struct xVec3 * nEnd; // r25
    struct xVec3 * nPtr; // r30
    struct xMat4x3 uvmat; // r1+0x10
    const unsigned short * index; // r29
    const unsigned short * end_index; // r24
    struct xVec2 * strip_uv; // r26
...
// Range: 0x8028ED00 -> 0x8028ED64
// this: r30
void zForceFieldEffect::refresh_refract_color() {
    // Local variables
    struct xColor_tag * refract_color; // r31
    struct xColor_tag * end_refract_color; // r29

    // References
    // -> struct xColor_tag g_WHITE;
}

// Range: 0x8028ED64 -> 0x8028EEB8
// this: r31
void zForceFieldEffect::refresh_cell_width_scale() {
    // Local variables
    float dang; // f30
    float ang; // f31
    float * scale; // r29
    ...
    float circum; // f29
    float radius; // f28
    float cell_width; // f27

    // References
    // -> static int mesh_rows;
    // -> static int mesh_columns;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D65E43
...
// Range: 0x8028EEB8 -> 0x8028F2C0
// this: r31
void zForceFieldEffect::create_sphere_mesh() {
    // Local variables
    unsigned char debug_malloc; // r29
    int heightmap_size; // r30
...
// Range: 0x8028F2C0 -> 0x8028F338
void zForceFieldEffect::load_energy_raster() {
    // Local variables
    struct RwTexture * texture; // r31

    // References
    // -> static struct RwRaster * energy_raster;
    // -> static unsigned int texture;
}
...
// total size: 0xC
struct /* @class$1112zForceFieldEffect_cpp */ {
    // Members
...
union /* @class$858zForceFieldEffect_cpp */ {
...
// total size: 0x10
struct /* @class$1363zForceFieldEffect_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8028F338 -> 0x8028FCA4
// this: r24
void zForceFieldEffect::animate_heightmap(float dt /* f24 */) {
    // Local variables
    int rows; // r19
    int cols; // r25
    float d; // f27
    ...
    const float * D0; // r27
    float val; // f31
    float min_val; // r1+0x10
    float max_val; // r1+0xC
    float total; // f30
    float abs_total; // f29
    const float * end_M1; // r18
    float dxz; // f25
    struct xVec3 start_loc; // r1+0x48
    const float * hmap; // r21
    int i; // r23
    int j; // r22
    struct xVec3 loc0; // r1+0x3C
    struct xVec3 loc1; // r1+0x30
    struct xVec3 loc2; // r1+0x24
    struct xVec3 loc3; // r1+0x18

    // References
    // -> static float render_heightmap_yoffset;
    // -> struct xGlobals * xglobals;
    // -> static float render_heightmap_scale;
    // -> struct xColor_tag g_GREEN;
    // -> static unsigned char render_heightmap;
    // -> static float wave_clamp;
    // -> static float framerate_blend;
    // -> static float wave_speed;
    // -> static float wave_decay_result;
    // -> static float wave_decay;
    // -> static int mesh_columns;
    // -> static int mesh_rows;
}
...
// total size: 0x890
struct /* @class$1860zForceFieldEffect_cpp */ {
    // Static members
...
// Range: 0x8028FCA4 -> 0x8028FD30
// this: r29
void zForceFieldEffect::copy_buffers(struct xIMLockContext & energy_lock /* r30 */, const struct xVec3 * verts /* r1+0x8 */, const struct xColor_tag * colors /* r1+0xC */) {
    // Local variables
    const unsigned short * indices; // r28
    int indices_size; // r24
    struct xVec3 * lock_pos; // r27
    struct xColor_tag * lock_color; // r26
    int i; // r31
    int index; // r25
}

// Range: 0x8028FD30 -> 0x802900B8
// this: r29
void zForceFieldEffect::shade_sphere(struct xVec3 * verts /* r17 */, struct xColor_tag * colors /* r1+0x8 */, const struct _xFColor * shieldColor /* r28 */) {
    // Local variables
    const struct xMat4x3 & cam_mat; // r25
    struct xVec3 cam_loc; // r1+0x34
    float Cx; // f27
    float Cy; // f26
    float Cz; // f25
    float iEmag; // f24
    const float * hmap; // r26
    float halfHeight; // f29
    const struct xVec3 * iv; // r30
    struct xVec3 * ov; // r31
    struct xVec3 * endov; // r24
    struct xColor_tag * color; // r27
    int hmap_index; // r23
    float height_offset; // f19
    float Nx; // f18
    float Nz; // r1+0x30
    float Ny; // f31
    float height; // f28
...
// Range: 0x802900B8 -> 0x802901D4
void zForceFieldEffect::SceneSetup() {
    // Local variables
    ...
    // References
    // -> static class zForceFieldEffect FFEList[9];
    // -> static int glintSystemID;
    // -> static int sparkSystemID;
    // -> static int electricSystemID;
}

// Range: 0x802901D4 -> 0x80290258
// this: r31
void zForceFieldEffect::EmitRandomRipple(float force /* r1+0x8 */) {
    // Local variables
    int heightmap_size; // r29
...
// Range: 0x80290258 -> 0x802902FC
// this: r31
void zForceFieldEffect::Setup() {
    // References
    // -> struct xMat4x3 g_I3;
}

// Range: 0x802902FC -> 0x80290334
// this: r31
void zForceFieldEffect::FreeForceField() {}

// Range: 0x80290334 -> 0x8029038C
// this: r31
void zForceFieldEffect::Move(const struct xMat4x3 & mat /* r30 */) {}

// Range: 0x8029038C -> 0x80290394
float zForceFieldEffect::GetShieldFadeOutTime() {
    // References
    // -> static float fade_time;
}

// Range: 0x80290394 -> 0x802903A4
// this: r3
void zForceFieldEffect::FadeOutShield() {
    // References
    // -> static float fade_time;
}

// Range: 0x802903A4 -> 0x802906A4
// this: r31
void zForceFieldEffect::updateColor(float dt /* f29 */) {
    // Local variables
    float mult; // f28
    float colorStrength; // f31
    float colorStrength; // f30
    ...
    // -> static float max_flicker_time;
    // -> static float min_flicker_time;
    // -> static float strength_to_flicker;
    // -> static struct _xFColor mid_color;
    // -> static struct _xFColor default_color;
}

// Range: 0x802906A4 -> 0x802907A0
// this: r31
void zForceFieldEffect::Update(float dt /* f31 */) {
    // References
    // -> static float spin_speed;
    // -> static float ripple_force;
    // -> static float ripple_time;
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D65E56
// Range: 0x802907A0 -> 0x8029096C
// this: r31
void zForceFieldEffect::DestroyShield(float dt /* f31 */, struct xModelInstance * model /* r1+0x10 */) {
    // Local variables
    int num_particles; // r30
    struct xVec3 * locList; // r28
    struct xVec3 * dirList; // r27
    float * lenVelList; // r25
    struct xVec3 * locPtr; // r24
    struct xVec3 * dirPtr; // r29
    float * lenPtr; // r26
    struct xVec3 * vertPtr; // r23
    int particleCounter; // r22
...
// Range: 0x8029096C -> 0x802909D4
// this: r31
void zForceFieldEffect::updateDestroyEffects(float dt /* r1+0x8 */) {
    // References
    // -> static int electricSystemID;
    // -> static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig;
}

// Range: 0x802909D4 -> 0x802909D8
void zForceFieldEffect::RenderBack() {}

static int rows; // size: 0x4, address: 0x80D6B3B0
static signed char init; // size: 0x1, address: 0x80D6B3B4
static int cols; // size: 0x4, address: 0x80D6B3B8
static signed char init; // size: 0x1, address: 0x80D6B3BC
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65E64
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
// Range: 0x802909D8 -> 0x80290B84
// this: r31
void zForceFieldEffect::RenderFront() {
    // Local variables
    int verts_size; // r28
    int indices_size; // r27
    unsigned short * indices; // r1+0x10
    struct xMat4x3 view_mat; // r1+0x30
    struct xIMLockContext energy_lock; // r1+0x14
    struct xVec3 * verts; // r30
    struct xColor_tag * colors; // r29
...
// Range: 0x80290B84 -> 0x80290C38
int zForceFieldEffect::sortForceFields(void * elem1 /* r1+0x8 */, void * elem2 /* r1+0xC */) {
    // Local variables
    const class zForceFieldEffect * ffe1; // r31
    const class zForceFieldEffect * ffe2; // r30
    const struct xVec3 & pos1; // r28
    const struct xVec3 & pos2; // r27
    const struct xVec3 & camPos; // r29

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80290C38 -> 0x80290CF8
void zForceFieldEffect::RenderAll() {
    // Local variables
    class zForceFieldEffect * array[9]; // r1+0x8
    int j; // r30
    int i; // r31
