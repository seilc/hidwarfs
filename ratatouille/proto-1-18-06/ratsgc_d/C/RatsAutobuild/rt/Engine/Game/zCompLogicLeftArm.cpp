/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicLeftArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803203B4 -> 0x80321A0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float anim_speed; // size: 0x4, address: 0x80D67868
static unsigned char freeze; // size: 0x1, address: 0x80D6B9B8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$986zCompLogicLeftArm_cpp */ {
    // Members
...
union /* @class$1134zCompLogicLeftArm_cpp */ {
...
// total size: 0xC
struct /* @class$1124zCompLogicLeftArm_cpp */ {
    // Members
...
struct AttachInfo {
    // Members
    const char * model_name; // offset 0x0, size 0x4
    const char * anim_name; // offset 0x4, size 0x4
    const char * obj_name; // offset 0x8, size 0x4
    float start; // offset 0xC, size 0x4
    float stop; // offset 0x10, size 0x4
    struct xVec3 attach_offset; // offset 0x14, size 0xC
    int bone; // offset 0x20, size 0x4
    int right_idx; // offset 0x24, size 0x4
    int up_idx; // offset 0x28, size 0x4
    int at_idx; // offset 0x2C, size 0x4
    unsigned char flip_right; // offset 0x30, size 0x1
    unsigned char flip_up; // offset 0x31, size 0x1
    unsigned char flip_at; // offset 0x32, size 0x1
    unsigned int modelID; // offset 0x34, size 0x4
    unsigned int animID; // offset 0x38, size 0x4
    struct xEnt * obj; // offset 0x3C, size 0x4
    struct RwMatrixTag objmat; // offset 0x40, size 0x40
    struct xVec3 objscale; // offset 0x80, size 0xC
};
static struct AttachInfo Attachments[2]; // size: 0x118, address: 0x8052D6A8
// total size: 0x8
...
static struct zCompStateMachineTable gLeftArmStateMachineTable[5]; // size: 0x28, address: 0x8052D7C0
// Range: 0x803203B4 -> 0x80320810
static void AttachEnt(struct AttachInfo * attach /* r31 */, struct xMat4x3 * rootmat /* r1+0x8 */, struct xMat4x3 * bonemat /* r30 */) {
    // Local variables
    struct xVec3 * wtf[3]; // r1+0xC
    float sign; // f31
}
...
// Range: 0x80320810 -> 0x80320A10
static void HandleAttachments(struct xModelInstance * model /* r29 */, struct AttachInfo * attach /* r31 */, struct xQuat * quat /* r1+0x10 */, struct xVec3 * trans /* r1+0x14 */) {
    // Local variables
    struct xMat4x3 rootmat; // r1+0x60
    struct xMat4x3 bonemat; // r1+0x20
    struct AttachInfo * ap; // r30
    int i; // r28
    float time; // f31

    // References
    // -> static struct AttachInfo Attachments[2];
}

// Range: 0x80320A10 -> 0x80320A88
static struct AttachInfo * FindAttachment(char * anim_name /* r1+0x8 */) {
    // Local variables
    struct AttachInfo * ap; // r31
    int i; // r30
...
// total size: 0x2C
struct {} zLeftArmIdle::__vtable; // size: 0x2C, address: 0x8052D8C0
// total size: 0x14
class zLeftArmIdle : public zCompState {
    // Functions
    zLeftArmIdle();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80320A88 -> 0x80320AC4
// this: r31
zLeftArmIdle::zLeftArmIdle() {
    // References
    // -> struct [anonymous] zLeftArmIdle::__vtable;
}

// Range: 0x80320AC4 -> 0x80320B38
void zLeftArmIdle::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$895zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$896zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$897zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$898zCompLogicLeftArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$899zCompLogicLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$900zCompLogicLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$901zCompLogicLeftArm_cpp */ {
    // Members
...
// Range: 0x80320B38 -> 0x80320B74
// this: r1+0x8
void zLeftArmIdle::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80320B74 -> 0x80320BC8
void zLeftArmIdle::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zLeftArmStir::__vtable; // size: 0x2C, address: 0x8052D894
// total size: 0x14
class zLeftArmStir : public zCompState {
    // Functions
    zLeftArmStir();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80320BC8 -> 0x80320C04
// this: r31
zLeftArmStir::zLeftArmStir() {
    // References
    // -> struct [anonymous] zLeftArmStir::__vtable;
}

// Range: 0x80320C04 -> 0x80320C78
void zLeftArmStir::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r31
...
// Range: 0x80320C78 -> 0x80320CB4
// this: r1+0x8
void zLeftArmStir::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80320CB4 -> 0x80320D08
void zLeftArmStir::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zLeftArmLL::__vtable; // size: 0x2C, address: 0x8052D868
// total size: 0x18
class zLeftArmLL : public zCompState {
    // Functions
    zLeftArmLL();
    ...
    // Members
    struct AttachInfo * attach; // offset 0x14, size 0x4
};
// Range: 0x80320D08 -> 0x80320D44
// this: r31
zLeftArmLL::zLeftArmLL() {
    // References
    // -> struct [anonymous] zLeftArmLL::__vtable;
}

// Range: 0x80320D44 -> 0x80320DB8
void zLeftArmLL::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r31
...
// Range: 0x80320DB8 -> 0x80320DF4
// this: r1+0x8
void zLeftArmLL::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80320DF4 -> 0x80320E48
void zLeftArmLL::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zLeftArmUL::__vtable; // size: 0x2C, address: 0x8052D83C
// total size: 0x18
class zLeftArmUL : public zCompState {
    // Functions
    zLeftArmUL();
...
// Range: 0x80320E48 -> 0x80320E84
// this: r31
zLeftArmUL::zLeftArmUL() {
    // References
    // -> struct [anonymous] zLeftArmUL::__vtable;
}

// Range: 0x80320E84 -> 0x80320EF8
void zLeftArmUL::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r31
...
// Range: 0x80320EF8 -> 0x80320F4C
// this: r31
void zLeftArmUL::Enter(class zNPCBase * owner /* r1+0x8 */) {}

// Range: 0x80320F4C -> 0x80320FA0
void zLeftArmUL::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}
...
class zCompLogicLeftArm : public zCompStateMachine {
    // Functions
    void SetupStateTranstitionTests();
...
// Range: 0x80320FA0 -> 0x80320FE8
unsigned char zCompLogicLeftArm::IsPlayerStirring() {
    // Local variables
    struct _tagxPad * pad; // r1+0x10
...
// Range: 0x80320FE8 -> 0x8032102C
unsigned char zCompLogicLeftArm::IsPlayerDoneStirring(class zNPCBase * owner /* r1+0x8 */, class zCompState * fromState /* r1+0xC */, class zCompState * toState /* r1+0x10 */) {}

// Range: 0x8032102C -> 0x8032106C
unsigned char zCompLogicLeftArm::LLTriggered() {
    // Local variables
...
// Range: 0x8032106C -> 0x803210D0
unsigned char zCompLogicLeftArm::ULTriggered() {
    // Local variables
    struct _tagxPad * pad; // r31
...
// Range: 0x803210D0 -> 0x80321144
unsigned char zCompLogicLeftArm::IsAnimationStopped(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// Range: 0x80321144 -> 0x803211D8
void zCompLogicLeftArm::AddStaticTweaks() {
    // Local variables
    char * prefix; // r31
...
// Range: 0x803211D8 -> 0x80321260
void zCompLogicLeftArm::BeforeAnimMatrices(struct xAnimPlay * play /* r28 */, struct xQuat * quat /* r1+0x8 */, struct xVec3 * tran /* r1+0xC */, int boneCount /* r1+0x10 */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r27
    class zCompLogicLeftArm * arm; // r29
}

// total size: 0x1
class zINPC {};
// Range: 0x80321260 -> 0x80321360
void zCompLogicLeftArm::before_anim_matrices(struct xAnimPlay * play /* r23 */, struct xQuat * quat /* r24 */, struct xVec3 * tran /* r25 */, int boneCount /* r26 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    struct xModelInstance * model; // r31
    struct AttachInfo * attach; // r28
    struct AttachInfo * attach; // r27
}

// Range: 0x80321360 -> 0x803214CC
void zCompLogicLeftArm::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x803214CC -> 0x80321608
// this: r31
void zCompLogicLeftArm::SetupStateTranstitionTests() {}

// Range: 0x80321608 -> 0x80321610
int zCompLogicLeftArm::GetInitialStateEnum() {}

// Range: 0x80321610 -> 0x8032161C
struct zCompStateMachineTable * zCompLogicLeftArm::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gLeftArmStateMachineTable[5];
}

// Range: 0x8032161C -> 0x80321644
// this: r1+0x8
void zCompLogicLeftArm::Attached() {}

// Range: 0x80321644 -> 0x80321A0C
// this: r22
void zCompLogicLeftArm::AllAttached() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r26
    struct xModelInstance * model; // r27
    int i; // r29
    struct AttachInfo * entry; // r31
    unsigned int objID; // r25
    char * base_prefix; // r24
    struct AttachInfo * entry; // r30
    int i; // r28
    char prefix[64]; // r1+0x10
