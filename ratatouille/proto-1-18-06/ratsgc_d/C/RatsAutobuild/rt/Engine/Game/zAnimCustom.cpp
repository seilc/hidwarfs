/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zAnimCustom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80271A24 -> 0x8027229C
*/
static int sAnimCustomCount; // size: 0x4, address: 0x80D6B240
static int sMaxTempTransCount; // size: 0x4, address: 0x80D6B244
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0xC
struct zAnimCustomFile {
    // Members
    struct zAnimCustomFile * next; // offset 0x0, size 0x4
    unsigned int id; // offset 0x4, size 0x4
    struct xAnimFile * data; // offset 0x8, size 0x4
};
static struct zAnimCustomFile * sAnimCustomList; // size: 0x4, address: 0x80D6B248
static struct zAnimCustomFile * sAnimCustomEndOfList; // size: 0x4, address: 0x80D6B24C
// total size: 0x20
struct xMemPool {
    // Members
...
static struct xMemPool szAnimCustomTempTranListPool; // size: 0x20, address: 0x80D25770
static struct xAnimTransitionList * * zAnimCustomActiveTempTrans; // size: 0x4, address: 0x80D6B250
static int sLastIndex; // size: 0x4, address: 0x80D6B254
static char * sCustomStateName; // size: 0x4, address: 0x80D65878
enum xSndHandle {
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$884zAnimCustom_cpp */ {
    // Members
...
static struct xAnimState sDummyState; // size: 0x4C, address: 0x80D25790
// total size: 0x2C
...
static struct xAnimTransition sDummyTran; // size: 0x2C, address: 0x80D257DC
// total size: 0x8
...
static struct xAnimTransitionList sDummyList; // size: 0x8, address: 0x80D6B258
// Range: 0x80271A24 -> 0x80271A34
static unsigned int TempTransCB(struct xAnimTransition * tran /* r3 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6587C
static char __FUNCTION__[22]; // size: 0x16, address: 0x80524B58
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6588D
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80271A34 -> 0x80271BB4
void zAnimCustomInit(int count /* r1+0x8 */) {
    // References
    // -> static struct xAnimTransition sDummyTran;
    // -> static struct xAnimTransitionList sDummyList;
    // -> static struct xAnimState sDummyState;
    // -> static int sLastIndex;
    // -> static char __FUNCTION__[16];
    // -> static int sMaxTempTransCount;
    // -> unsigned int gActiveHeap;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
    // -> static struct xMemPool szAnimCustomTempTranListPool;
    // -> static int sAnimCustomCount;
    // -> static struct zAnimCustomFile * sAnimCustomEndOfList;
    // -> static struct zAnimCustomFile * sAnimCustomList;
}

// Range: 0x80271BB4 -> 0x80271BEC
void zAnimCustomClear() {
    // References
    // -> static struct zAnimCustomFile * sAnimCustomList;
    // -> static int sMaxTempTransCount;
    // -> static int sAnimCustomCount;
...
// Range: 0x80271BEC -> 0x80271C20
static void ClearActiveArray() {
    // References
    // -> static int sLastIndex;
}

// Range: 0x80271C20 -> 0x80271D04
static void DeleteFromActiveArray(int index /* r31 */) {
    // References
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
    // -> static struct xMemPool szAnimCustomTempTranListPool;
...
// Range: 0x80271D04 -> 0x80271D24
void zAnimCustomReset() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6589D
// Range: 0x80271D24 -> 0x80271DF8
void zAnimCustomAdd(unsigned int id /* r1+0x8 */, struct xAnimFile * data /* r30 */, unsigned char hasPhysics /* r1+0xC */) {
    // Local variables
    struct zAnimCustomFile * entry; // r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D658AC
// Range: 0x80271DF8 -> 0x8027218C
void zAnimCustomPlay(unsigned int id /* r23 */, struct xModelInstance * model /* r29 */, unsigned int outStateID /* r24 */, unsigned char loopAnim /* r1+0x8 */, float inBlend /* f28 */, float outBlend /* f29 */, float speed /* r1+0xC */) {
    // Local variables
    struct zAnimCustomFile * file; // r30
    int i; // r27
    struct xAnimState state; // r1+0x10
    struct xAnimTransition * tran; // r31
    struct xAnimTransitionList * tempList; // r28
    struct xAnimTransition * transition; // r26

    // References
    // -> static char __FUNCTION__[16];
    // -> static struct xAnimTransitionList sDummyList;
    // -> static struct xMemPool szAnimCustomTempTranListPool;
    // -> static char * sCustomStateName;
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
    // -> static struct zAnimCustomFile * sAnimCustomList;
}

// Range: 0x8027218C -> 0x80272238
static void AddToActiveArray(struct xAnimTransitionList * l /* r1+0x8 */) {
    // References
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
...
// Range: 0x80272238 -> 0x8027229C
void zAnimCustomUpdate() {
    // Local variables
    int currIndex; // r31
