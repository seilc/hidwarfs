/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompPerception.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80346160 -> 0x80346F10
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x30
struct {} zCompPerception::__vtable; // size: 0x30, address: 0x8052F1A4
// total size: 0x8
...
const class zCompPerceptionParams * spNPCGenericDefault; // size: 0x4, address: 0x80D67EC0
// Range: 0x80346230 -> 0x803462A0
// this: r31
void zCompPerception::Attached() {
    ...
    // References
    // -> const class zCompPerceptionParams * spNPCGenericDefault;
}
...
// total size: 0x4
struct /* @class$957zCompPerception_cpp */ {
    // Members
...
union /* @class$843zCompPerception_cpp */ {
...
// total size: 0xC
struct /* @class$1113zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$898zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$899zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$900zCompPerception_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$901zCompPerception_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$902zCompPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$903zCompPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$904zCompPerception_cpp */ {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67EA8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1647zCompPerception_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1890zCompPerception_cpp */ {
    // Static members
...
// Range: 0x80346414 -> 0x8034648C
// this: r31
void zCompPerception::Perceived(enum eCompPerceptionType perceptionType /* r1+0x8 */, struct xEnt * perceivedEnt /* r1+0xC */, float dt /* r1+0x10 */) {}

// Range: 0x8034648C -> 0x803464DC
// this: r3
void zCompPerception::NotPerceived(float dt /* f1 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67EB4
// total size: 0x4C
...
// Range: 0x80346720 -> 0x803467CC
// this: r31
unsigned char zCompPerceptionDynamics::Reset(class zICompNPCEntity * npcEnt /* r30 */, struct xEnt * perceivedObj /* r29 */) {}

// Range: 0x803467CC -> 0x80346850
// this: r31
unsigned char zCompPerception::CheckSpherePerception(class zCompPerceptionDynamics & percpDyn /* r1+0x8 */) {
    // Local variables
    float checkDistance; // f31
    float checkDistance2; // f30
}

// Range: 0x80346850 -> 0x80346890
// this: r31
float zCompPerceptionDynamics::GetDistance2() {}

// Range: 0x80346890 -> 0x803468DC
// this: r31
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8052F188
// Range: 0x803468DC -> 0x80346A10
// this: r31
unsigned char zCompPerception::CheckSoundSpherePerception(class zCompPerceptionDynamics & percpDyn /* r1+0x8 */) {
    // Local variables
    float noise; // f30
    float checkDistance; // f31
    float checkDistance2; // f29
...
// Range: 0x80346A10 -> 0x80346B1C
// this: r31
unsigned char zCompPerception::CheckCylinderPerception(class zCompPerceptionDynamics & percpDyn /* r30 */) {
    // Local variables
    float cylinderR; // f31
    float cylinderHUp; // f30
    float cylinderHDown; // f29
    float cylinderRatio; // f28
    float diffY; // f27
    float cylinderR2; // f26
}

// Range: 0x80346B1C -> 0x80346B5C
// this: r31
float zCompPerceptionDynamics::GetDistanceXZ2() {}

// Range: 0x80346B5C -> 0x80346BB8
// this: r31
void zCompPerceptionDynamics::CalculateDiffXZ() {}

// Range: 0x80346BB8 -> 0x80346BF8
// this: r31
float zCompPerceptionDynamics::GetDiffY() {}

// Range: 0x80346BF8 -> 0x80346CD8
// this: r31
unsigned char zCompPerception::CheckConePerception(class zCompPerceptionDynamics & percpDyn /* r30 */) {
    // Local variables
    float hTheta; // f31
    float coneD; // f30
    float coneRatio; // f29
...
// Range: 0x80346CD8 -> 0x80346D18
// this: r31
float zCompPerceptionDynamics::GetTanTheta2() {}

// Range: 0x80346D18 -> 0x80346DBC
// this: r31
...
// total size: 0x1
class zNPCHelper {};
// Range: 0x80346DBC -> 0x80346F0C
// this: r31
unsigned char zCompPerception::CheckTriPerception(class zCompPerceptionDynamics & percpDyn /* r30 */) {
    // Local variables
    float hTheta; // f31
    float triD; // f30
    float triHUp; // f28
...
// Range: 0x80346F0C -> 0x80346F10
void zCompPerception::AddStaticTweaks() {}

// total size: 0x30
struct {} zICompPerception::__vtable; // size: 0x30, address: 0x8052F1D4
// total size: 0x8
class zIComponent {
    // Members
public:
