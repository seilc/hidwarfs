/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicStirringPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80316AEC -> 0x80317288
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zCompLogicStirringPlayer : public zICompLogic {
    ...
    unsigned char SystemEvent(unsigned int to_event, const float * to_param, unsigned int to_param_widget_id);
...
// Range: 0x80316AEC -> 0x80316B60
void zCompLogicStirringPlayer::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
static struct xVec3 potPositions[4]; // size: 0x30, address: 0x8052D158
static float sPotBoilStart; // size: 0x4, address: 0x80D676B0
static float sPotBoilHeight; // size: 0x4, address: 0x80D676B4
static unsigned int replyToID; // size: 0x4, address: 0x80D6B938
static unsigned char init; // size: 0x1, address: 0x80D6B93C
// Range: 0x80316B60 -> 0x80316BF0
void zCompLogicStirringPlayer::AddStaticTweaks() {
    // Local variables
    char * prefix; // r31

    // References
    // -> static float sPotBoilHeight;
    // -> static float sPotBoilStart;
}
...
static struct xResponseCurve potColorCurve; // size: 0x14, address: 0x80D6B940
static struct rgba_node potColors[3]; // size: 0x3C, address: 0x804DCAE8
static unsigned int boil[4]; // size: 0x10, address: 0x80D676B8
// total size: 0x2
...
struct rgba_node {
    ...
    float a; // offset 0x10, size 0x4
};
// Range: 0x80316BF0 -> 0x80317240
// this: r31
void zCompLogicStirringPlayer::Update(float dt /* f30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r23
    struct xModelInstance * model; // r27
    struct xEntFrame * frame; // r30
    int i; // r26
    struct _tagxPad * pad; // r28
    class zMiniME & mgr; // r1+0x14
    float frequency; // r1+0x10
    float duration; // r1+0xC
    float speed; // f31
    struct xVec3 pos; // r1+0x24
    struct xVec3 diff; // r1+0x18
    int i; // r29
    struct xEnt * ent; // r24
    struct rgba_node value; // r1+0x30
    float frac; // f29
    unsigned char r; // r1+0xB
    unsigned char g; // r1+0xA
    unsigned char b; // r1+0x9
    struct RpGeometry * geom; // r22
    struct RpMaterial * mater; // r25

    // References
    // -> static struct xResponseCurve potColorCurve;
    // -> static unsigned int boil[4];
    // -> static unsigned int replyToID;
    // -> static float sPotBoilHeight;
    // -> static float sPotBoilStart;
    // -> static struct xVec3 potPositions[4];
    // -> struct _tagxPad mPad[4];
    // -> static unsigned char init;
    // -> static struct rgba_node potColors[3];
}
...
// total size: 0x4
struct /* @class$1002zCompLogicStirringPlayer_cpp */ {
    // Members
...
union /* @class$1142zCompLogicStirringPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1140zCompLogicStirringPlayer_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$928zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$929zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$930zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$931zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$932zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$933zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$934zCompLogicStirringPlayer_cpp */ {
    // Members
...
// Range: 0x80317240 -> 0x80317288
// this: r3
unsigned char zCompLogicStirringPlayer::SystemEvent(unsigned int to_event /* r6 */, const float * to_param /* r7 */, unsigned int to_param_widget_id /* r9 */) {
    // References
    // -> static unsigned int replyToID;
}
