/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPickup.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021ADEC -> 0x8021D0C8
*/
// total size: 0xC
struct RwV3d {
    // Members
...
float kFlyToInterfaceTime; // size: 0x4, address: 0x80D64998
float kFlyToInterfaceX; // size: 0x4, address: 0x80D6499C
float kFlyToInterfaceY; // size: 0x4, address: 0x80D649A0
float kFlyToInterfaceZ; // size: 0x4, address: 0x80D649A4
float kFlyToInterfaceScale; // size: 0x4, address: 0x80D649A8
float SpawnDelayTime; // size: 0x4, address: 0x80D649AC
float SPIRAL_DECAY_TIME; // size: 0x4, address: 0x80D649B0
float SPIRAL_DECAY_STEP; // size: 0x4, address: 0x80D649B4
// total size: 0x30
struct xMat3x3 {
    // Members
...
static struct xMat3x3 sPickupOrientation; // size: 0x30, address: 0x80523400
float PICKUP_FADE_DIST; // size: 0x4, address: 0x80D649B8
float PICKUP_CULL_DIST; // size: 0x4, address: 0x80D649BC
float PICKUP_FADE_DIST_SQR; // size: 0x4, address: 0x80D6AE98
float PICKUP_CULL_DIST_SQR; // size: 0x4, address: 0x80D6AE9C
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct TableEntry {
    // Members
    unsigned int typeHash; // offset 0x0, size 0x4
    unsigned int modelID; // offset 0x4, size 0x4
    unsigned int pulseModelID; // offset 0x8, size 0x4
    float pulseTime; // offset 0xC, size 0x4
    float pulseAddScale; // offset 0x10, size 0x4
    float pulseMoveDown; // offset 0x14, size 0x4
    float red; // offset 0x18, size 0x4
    float green; // offset 0x1C, size 0x4
    float blue; // offset 0x20, size 0x4
    unsigned int color; // offset 0x24, size 0x4
    union { // inferred
        unsigned int flyingSoundGroupID; // offset 0x28, size 0x4
        enum iSndGroupHandle flyingSoundGroupHandle; // offset 0x28, size 0x4
    };
    union { // inferred
        unsigned int usedSoundGroupID; // offset 0x2C, size 0x4
        enum iSndGroupHandle usedSoundGroupHandle; // offset 0x2C, size 0x4
    };
    union { // inferred
        unsigned int cantUseSoundGroupID; // offset 0x30, size 0x4
        enum iSndGroupHandle cantUseSoundGroupHandle; // offset 0x30, size 0x4
    };
    unsigned char healthGain; // offset 0x34, size 0x1
    unsigned char powerGain; // offset 0x35, size 0x1
    unsigned char saveFlag; // offset 0x36, size 0x1
    signed char bInitialized; // offset 0x37, size 0x1
};
// total size: 0x10
struct Table : public xTableAsset {
    // Members
    struct TableEntry entries[]; // offset 0x10, size 0x0
};
struct Table * table; // size: 0x4, address: 0x80D6AEA0
class zPickup * extras; // size: 0x4, address: 0x80D6AEA4
struct InstanceAsset * extra_assets; // size: 0x4, address: 0x80D6AEA8
int extras_used; // size: 0x4, address: 0x80D6AEAC
int extras_max; // size: 0x4, address: 0x80D6AEB0
struct zSparkEmitterAsset * sparkEmitterAsset; // size: 0x4, address: 0x80D6AEB4
float lastdt; // size: 0x4, address: 0x80D6AEB8
struct xFXRibbon ribbon[4]; // size: 0x50, address: 0x80D182B0
float spiralDecay; // size: 0x4, address: 0x80D6AEBC
static struct curve_node ribbon_curve[2]; // size: 0x18, address: 0x804BD048
// total size: 0x10
struct glintInfo {
    // Members
...
static struct zSparkEmitterAsset _sparkEmitterAsset; // size: 0x94, address: 0x80D18300
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D649C0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x5C
class zPickup : public xBase {
    // Functions
    unsigned char Init(struct InstanceAsset & asset_);

    void Reset();

    void EventCB(struct xBase * to, unsigned int toEvent);

    unsigned char IsNearPlayer(struct zPlayer * player, float range) const;

    unsigned char CanGalleryPickupBeUsed(struct zPlayer * player) const;
    ...
    void RenderPostPickedupFX(float dist);

    void Render();

    void FlyToInterface(float dt);

    void DestroyExtra();

    // Static members
    static int extras_max; // size: 0x4
    static int extras_used; // size: 0x4
    static struct InstanceAsset * extra_assets; // size: 0x4
    static struct zSparkEmitterAsset * sparkEmitterAsset; // size: 0x4
    static class zPickup * extras; // size: 0x4
    static struct Table * table; // size: 0x4
    static float lastdt; // size: 0x4
    static float spiralDecay; // size: 0x4
    static struct xFXRibbon ribbon[4]; // size: 0x50

    // Members
    struct TableEntry * tableEntry; // offset 0x10, size 0x4
    struct InstanceAsset * asset; // offset 0x14, size 0x4
    float glow_time; // offset 0x18, size 0x4
    unsigned char available; // offset 0x1C, size 0x1
    enum eState state; // offset 0x20, size 0x4
    enum eType etype; // offset 0x24, size 0x4
    struct xModelInstance * model; // offset 0x28, size 0x4
    struct xModelInstance * effect_model; // offset 0x2C, size 0x4
    void * fx; // offset 0x30, size 0x4
    struct xVec3 grabPos; // offset 0x34, size 0xC
    float timer; // offset 0x40, size 0x4
    float delay; // offset 0x44, size 0x4
    float flyToInterfaceX; // offset 0x48, size 0x4
    unsigned char flyToRight; // offset 0x4C, size 0x1
    struct xShadowSimpleCache * simpShadow; // offset 0x50, size 0x4
    int pointsMultiplier; // offset 0x54, size 0x4
    struct zPlayer * player; // offset 0x58, size 0x4
};
// Range: 0x8021ADEC -> 0x8021B074
void zPickup::SceneSetup() {
    // Local variables
    unsigned int size; // r1+0x8
    unsigned long expected_asset_size; // r31

    // References
    // -> float SpawnDelayTime;
    // -> float kFlyToInterfaceScale;
    // -> float kFlyToInterfaceZ;
    // -> float kFlyToInterfaceY;
    // -> float kFlyToInterfaceX;
    // -> float kFlyToInterfaceTime;
    // -> struct zSparkEmitterAsset * sparkEmitterAsset;
    // -> static struct zSparkEmitterAsset _sparkEmitterAsset;
    // -> float PICKUP_CULL_DIST;
    // -> float PICKUP_CULL_DIST_SQR;
    // -> float PICKUP_FADE_DIST;
    // -> float PICKUP_FADE_DIST_SQR;
    // -> struct Table * table;
    // -> static char __FUNCTION__[11];
}

// Range: 0x8021B074 -> 0x8021B0C0
void zPickup::SceneExit() {
    // Local variables
    unsigned int i; // r31

    // References
    // -> struct xFXRibbon ribbon[4];
}

// Range: 0x8021B0C0 -> 0x8021B0E0
void zPickup::ResetAll() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D649CB
// Range: 0x8021B0E0 -> 0x8021B298
void zPickup::InitDynamic(struct xBase & obj /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// total size: 0x20
struct InstanceAsset : public xDynAsset {
    // Members
    unsigned int typeHash; // offset 0x10, size 0x4
    struct xVec3 pos; // offset 0x14, size 0xC
};
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AEC0
static signed char init; // size: 0x1, address: 0x80D6AEC1
static unsigned char already_asserted; // size: 0x1, address: 0x80D6AEC2
static signed char init; // size: 0x1, address: 0x80D6AEC3
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static struct config_type cfg; // size: 0x20, address: 0x80D18394
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D649D7
enum xCamCoordType {
...
// Range: 0x8021B298 -> 0x8021B9A8
// this: r31
unsigned char zPickup::Init(struct InstanceAsset & asset_ /* r1+0x8 */) {
    // Local variables
    unsigned int tmpSize; // r1+0xC
    struct RpAtomic * modelData; // r29
    unsigned int i; // r30

    // References
    // -> static struct config_type cfg;
    // -> struct xFXRibbon ribbon[4];
    // -> static struct curve_node ribbon_curve[2];
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D649DC
// Range: 0x8021BA48 -> 0x8021BB64
void zPickupEventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r31 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8021BB64 -> 0x8021BC54
// this: r31
void zPickup::EventCB(struct xBase * to /* r1+0x8 */, unsigned int toEvent /* r1+0xC */) {}

static unsigned int SCENEFLAGS_GALLERY; // size: 0x4, address: 0x80D6F13C
// Range: 0x8021BC54 -> 0x8021BD34
void zPickup::TryBeGrabbedAll(struct zPlayer * currentPlayer /* r29 */) {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r28
    int i; // r30

    // References
    // -> int extras_used;
    // -> class zPickup * extras;
    // -> static unsigned int SCENEFLAGS_GALLERY;
}
...
// Range: 0x8021BD34 -> 0x8021BD6C
class zPickup * zPickup::PickupsEnd() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8021BD6C -> 0x8021BD80
class zPickup * zPickup::PickupsBegin() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8021BD80 -> 0x8021BDF8
// this: r1+0x8
unsigned char zPickup::IsNearPlayer(struct zPlayer * player /* r1+0xC */, float range /* f30 */) const {
    // Local variables
    float playerDist2; // f31
}
...
// total size: 0x1
struct /* @class$817zPickup_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$818zPickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$819zPickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$820zPickup_cpp */ {
    // Members
...
// Range: 0x8021BDF8 -> 0x8021BE74
// this: r31
unsigned char zPickup::CanGalleryPickupBeUsed(struct zPlayer * player /* r1+0x8 */) const {}

// Range: 0x8021BE74 -> 0x8021BF28
// this: r31
void zPickup::BeUsed() {}

// Range: 0x8021BF28 -> 0x8021BFC4
// this: r31
void zPickup::BeGrabbedNoFly() {
    // Local variables
    struct xVec3 dir; // r1+0x8

    // References
    // -> float SPIRAL_DECAY_TIME;
    // -> float spiralDecay;
}

// Range: 0x8021BFC4 -> 0x8021C18C
// this: r31
void zPickup::Update(float dt /* f31 */) {
    // Local variables
    float grabDist; // f26
    struct xVec3 playerPos; // r1+0x14
    struct xVec3 toPlayer; // r1+0x8
    float distToPlayer; // f29
    float timeToPlayer; // f28
    float speed; // f30
...
// Range: 0x8021C18C -> 0x8021C190
void zPickup::UpdateFX() {}

// Range: 0x8021C190 -> 0x8021C214
void zPickup::RenderAll() {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r29
    int i; // r30
...
// Range: 0x8021C214 -> 0x8021C35C
// this: r31
void zPickup::RenderPostPickedupFX(float dist /* f31 */) {
    // Local variables
    ...
    // References
    // -> struct xFXRibbon ribbon[4];
    // -> static struct xMat3x3 sPickupOrientation;
}

struct xVec3 g_Y3; // size: 0xC, address: 0x80D6D1B0
// Range: 0x8021C35C -> 0x8021C738
// this: r31
void zPickup::Render() {
    // Local variables
    float distanceFadeAlpha; // r1+0x14
    float u; // f30
    float old_alpha; // r1+0x10
    struct xVec3 effect_scale; // r1+0x24
    struct xVec3 delta; // r1+0x18
    float ds2; // f31
    struct xMat4x3 * frame; // r30
    struct xMat3x3 scale_mat; // r1+0x30
...
// Range: 0x8021C738 -> 0x8021C830
unsigned char zPickup::DistanceCull(struct xVec3 & pos /* r1+0x10 */, float & distanceFadeAlpha /* r31 */) {
    // Local variables
...
// Range: 0x8021C830 -> 0x8021C8C0
void zPickup::UpdateFlyToInterfaceAll(float dt /* r1+0x8 */) {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r29
    int i; // r30
...
// Range: 0x8021C8C0 -> 0x8021CAD0
// this: r31
void zPickup::FlyToInterface(float dt /* f27 */) {
    // Local variables
    float timeToDest; // f31
    struct xVec3 destPos; // r1+0x20
    struct xVec3 screenPos; // r1+0x14
    struct xVec3 vec; // r1+0x8
    float distToDest; // f30
    float speed; // f29
    float percent; // f28
...
// Range: 0x8021CAD0 -> 0x8021CB9C
void zPickup::UpdateAll(float dt /* f31 */) {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r29
    int i; // r30
...
// Range: 0x8021CB9C -> 0x8021CBFC
struct TableEntry * zPickup::FindTableEntry(unsigned int typeHash /* r3 */) {
    // Local variables
    unsigned int i; // r31
    struct TableEntry * entry; // r30
...
// total size: 0x4
struct /* @class$2060zPickup_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2061zPickup_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D649EB
// Range: 0x8021CBFC -> 0x8021CD08
// this: r31
void zPickup::DestroyExtra() {
    // References
...
// Range: 0x8021CD08 -> 0x8021CDD0
void zPickup::SetupExtras() {
    // References
    // -> int extras_used;
    // -> struct InstanceAsset * extra_assets;
    // -> int extras_max;
    // -> class zPickup * extras;
}

// Range: 0x8021CDD0 -> 0x8021CE6C
void zPickup::ResetExtras() {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r30
...
// Range: 0x8021CE6C -> 0x8021CF98
void zPickup::UpdateExtras() {
    // Local variables
    int i; // r31
