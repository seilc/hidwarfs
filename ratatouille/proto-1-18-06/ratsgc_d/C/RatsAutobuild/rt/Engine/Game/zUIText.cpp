/*
    ...
    Language: C++
    Code range: 0x801CDD64 -> 0x801CEA1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char isCJK; // size: 0x1, address: 0x80D6AA70
static float HSCALE; // size: 0x4, address: 0x80D6AA74
static float VSCALE; // size: 0x4, address: 0x80D6AA78
// total size: 0x80
...
// Range: 0x801CDE30 -> 0x801CE0AC
// this: r29
void zUIText::setup_textbox(class xtextbox & tb /* r31 */, const struct zUITextAsset * asset /* r30 */) const {}
...
// Range: 0x801CE3CC -> 0x801CE46C
// this: r31
void zUIText::DoHandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r29 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r30 */) {}

// Range: 0x801CE46C -> 0x801CE4D8
// this: r31
void zUIText::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r30 */) {}

static char * fontNames[4]; // size: 0x10, address: 0x80D63D20
static char * justifyXNames[3]; // size: 0xC, address: 0x80D63D30
static char * justifyYNames[3]; // size: 0xC, address: 0x80D63D3C
// Range: 0x801CE4D8 -> 0x801CE7FC
// this: r29
...
// Range: 0x801CE7FC -> 0x801CE82C
void zUIText_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x801CE82C -> 0x801CE8B8
void zUIText_Init(class zUIText * text /* r29 */, struct zUITextAsset * asset /* r30 */) {}
...
// total size: 0x64
struct {} zUIText::__vtable; // size: 0x64, address: 0x80521F20
