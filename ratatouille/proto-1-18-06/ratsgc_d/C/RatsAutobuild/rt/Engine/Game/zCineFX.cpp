/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCineFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D1B94 -> 0x802D2CE0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x1
struct /* @class$833zCineFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zCineFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zCineFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zCineFX_cpp */ {
    // Members
...
static struct NCINMap * g_cutmap[64]; // size: 0x100, address: 0x80528AD8
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D669C0
// total size: 0x14
...
// Range: 0x802D1B94 -> 0x802D1CD4
// this: r27
void NCINBeNosey::CanRenderNow() {
    // Local variables
    const struct zCutsceneMgr * csnmgr; // r29
    struct NCINEntry * fxtab; // r28
    struct NCINEntry * nextrec; // r30
    struct NCINEntry * fxrec; // r31

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D669CD
// Range: 0x802D1CD4 -> 0x802D1E48
// this: r27
void NCINBeNosey::UpdatedAnimated(struct RpAtomic * model /* r1+0x8 */, struct RwMatrixTag * animMat /* r1+0xC */, unsigned int animIndex /* r1+0x10 */, unsigned int dataIndex /* r26 */, unsigned int & visFlags /* r1+0x14 */) {
    // Local variables
    const struct zCutsceneMgr * csnmgr; // r29
    struct NCINEntry * fxtab; // r28
    struct NCINEntry * nextrec; // r30
...
static struct NCINBeNosey * g_noz_ncin; // size: 0x4, address: 0x80D6B690
static signed char init; // size: 0x1, address: 0x80D6B694
static struct NCINBeNosey nozey_npc_cinematics; // size: 0x14, address: 0x80D6B698
// Range: 0x802D1E48 -> 0x802D1E8C
void zCineFXStartup() {
    // References
...
// Range: 0x802D1ED0 -> 0x802D1ED4
void zCineFXShutdown() {}

// Range: 0x802D1ED4 -> 0x802D1EF4
void zCineFXSceneSetup() {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80528BD8
// Range: 0x802D1EF4 -> 0x802D2028
void zCineFXRegisterTable(struct NCINMap * maplist /* r1+0x8 */) {
    // Local variables
    struct NCINMap * maprec; // r30
    int entry_entered; // r29
    int i; // r31
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80528BED
// Range: 0x802D2028 -> 0x802D22B8
static struct NCINEntry * zCineFXCutscenePickTable(const struct zCutsceneMgr * csnmgr /* r31 */) {
    // Local variables
    struct NCINEntry * da_fxtab; // r28
    int i; // r29
    struct NCINMap * cutrec; // r30
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D669DD
// Range: 0x802D22B8 -> 0x802D244C
int zCineFXCutscenePrep(const struct zCutsceneMgr * csnmgr /* r31 */) {
    // Local variables
    struct NCINEntry * fxtab; // r28
...
// Range: 0x802D244C -> 0x802D245C
// this: r3
void NCINBeNosey::Init(const struct zCutsceneMgr * csnmgr /* r4 */, struct NCINEntry * fxtab /* r5 */, int flags /* r6 */) {}
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D669F1
// Range: 0x802D245C -> 0x802D2654
...
// Range: 0x802D2654 -> 0x802D2670
// this: r3
void NCINBeNosey::Done() {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66A05
// Range: 0x802D2670 -> 0x802D2A18
void zCineFXCutscene(const struct zCutsceneMgr * csnmgr /* r29 */) {
    // Local variables
    struct xCutscene * csn; // r30
    struct NCINEntry * fxtab; // r24
    int need_animated; // r26
    int need_render; // r25
    struct NCINEntry * nextrec; // r27
    struct NCINEntry * fxrec; // r31
    int flags; // r28
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66A15
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x802D2B30 -> 0x802D2CBC
static void zCineFXTweakThisTable(const char * prefix_root /* r1+0x8 */, struct NCINEntry * fxtab /* r1+0xC */) {
    // Local variables
    int idx_entry; // r28
    struct NCINEntry * nextrec; // r30
    struct NCINEntry * fxrec; // r31
    struct TypeInfo * info; // r29
    char tweakBase[128]; // r1+0x190
    char prefix[128]; // r1+0x110
    char _buffer[128]; // r1+0x90
    char _buffer[128]; // r1+0x10
}

// Range: 0x802D2CBC -> 0x802D2CE0
static void AddTables() {}

// total size: 0x10
struct {} XCSNNosey::__vtable; // size: 0x10, address: 0x80D66A28
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x10
struct {} NCINBeNosey::__vtable; // size: 0x10, address: 0x80D66A38
