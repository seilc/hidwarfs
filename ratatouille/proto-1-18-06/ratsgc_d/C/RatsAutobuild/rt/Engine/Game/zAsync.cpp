/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zAsync.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D740C -> 0x801D7880
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwCamera * cam; // size: 0x4, address: 0x80D6AC08
// total size: 0x8
struct RwLinkList {
    // Members
...
struct RpLight * light; // size: 0x4, address: 0x80D6AC0C
// total size: 0xA4
struct RwFrame {
    // Members
    struct RwObject object; // offset 0x0, size 0x8
...
struct RwFrame * frame; // size: 0x4, address: 0x80D6AC10
...
struct RpWorld * world; // size: 0x4, address: 0x80D6AC14
// total size: 0x4
class Screen {
    // Members
public:
...
class Screen * screen; // size: 0x4, address: 0x80D6AC18
// Range: 0x801D740C -> 0x801D7414
void Init(class Screen * scr /* r3 */) {
    // References
    // -> class Screen * screen;
}
...
static float rot; // size: 0x4, address: 0x80D6AC1C
static signed char init; // size: 0x1, address: 0x80D6AC20
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D63E88
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x801D75E0 -> 0x801D7880
void * RenderThread() {
    // Local variables
    long long lastTime; // r29
    unsigned char diskError; // r28
    long long curTime; // r26
    float dt; // f31
    struct RwRGBA bg; // r1+0x8
    struct RwCamera * currentCamera; // r31
