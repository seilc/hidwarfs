/*
    ...
    Language: C++
    Code range: 0x802336F4 -> 0x80233F70
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802336F4 -> 0x80233724
static void * CustomStaticAllocator(unsigned int size /* r1+0x8 */, void * user /* r1+0xC */) {}

// Range: 0x80233724 -> 0x8023377C
static void CustomSignalHandler(class zUI * from /* r1+0x8 */, unsigned int dest /* r1+0xC */, unsigned int event /* r1+0x10 */, const float * param /* r1+0x14 */, struct xBase * paramWidget /* r1+0x18 */, unsigned int paramWidgetID /* r1+0x1C */, void * user /* r1+0x20 */) {}

static unsigned char show_stats; // size: 0x1, address: 0x80D6AF90
// total size: 0x4
class Screen {
    // Members
public:
...
// Range: 0x8023377C -> 0x80233788
void zLoadingScreen::UnSetShowStats() {
    // References
    // -> static unsigned char show_stats;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64D78
...
// Range: 0x80233788 -> 0x80233C18
// this: r31
void zLoadingScreen::Init() {
    // Local variables
    struct xGroupAsset * group; // r28
    signed short i; // r26
    unsigned int size; // r1+0x8
    struct xDynAsset * asset; // r29
    void * test; // r25
    class zUI * element; // r30
    int i; // r27
...
// Range: 0x80233C18 -> 0x80233C90
// this: r30
void zLoadingScreen::Update(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80233C90 -> 0x80233D04
// this: r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64D7D
// Range: 0x80233DDC -> 0x80233EC8
// this: r31
void * zLoadingScreen::CustomAllocate(unsigned int size /* r1+0x8 */) {
    // References
    // -> void * RwEngineInstance;
    // -> unsigned int _rwMemoryLastAllocLine;
    // -> const char * _rwMemoryLastAllocFile;
...
// Range: 0x80233EC8 -> 0x80233F70
// this: r30
void zLoadingScreen::CustomSignal(class zUI * from /* r1+0x8 */, unsigned int dest /* r1+0xC */, unsigned int event /* r1+0x10 */, const float * param /* r1+0x14 */, struct xBase * paramWidget /* r1+0x18 */, unsigned int paramWidgetID /* r1+0x1C */) {
    // Local variables
    int i; // r31
}

// total size: 0x18
struct {} zLoadingScreen::__vtable; // size: 0x18, address: 0x80523D88
