/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zContextObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D44AC -> 0x802D58B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float ROTATION_SPEED; // size: 0x4, address: 0x80D66A58
static float MOUNT_SPEED_MIN; // size: 0x4, address: 0x80D66A5C
// total size: 0x24
struct config {
    // Members
    ...
    float fade_in; // offset 0x14, size 0x4
    float fade_out; // offset 0x18, size 0x4
    unsigned char r; // offset 0x1C, size 0x1
    unsigned char g; // offset 0x1D, size 0x1
    unsigned char b; // offset 0x1E, size 0x1
    unsigned char cinematic_only; // offset 0x1F, size 0x1
    float size_delta; // offset 0x20, size 0x4
};
static struct config glint_config; // size: 0x24, address: 0x80D2D520
static float * glintEmit[5]; // size: 0x14, address: 0x80D6B6C0
static int contextObjCount[5]; // size: 0x14, address: 0x80D6B6D4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$901zContextObject_cpp */ {
    // Members
...
union /* @class$1040zContextObject_cpp */ {
...
// total size: 0xC
struct /* @class$1039zContextObject_cpp */ {
    // Members
...
static struct xEnt * entFXList[16]; // size: 0x40, address: 0x80D2D544
static float GLINT_RANDOM_RADIUS; // size: 0x4, address: 0x80D66A60
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$842zContextObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zContextObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zContextObject_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zContextObject_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zContextObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zContextObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zContextObject_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2062zContextObject_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2061zContextObject_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2064zContextObject_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1549zContextObject_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802D44AC -> 0x802D4688
void zContextObject::AddStaticTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float GLINT_RANDOM_RADIUS;
    // -> static struct config glint_config;
...
// Range: 0x802D4688 -> 0x802D477C
unsigned char zContextObject::MoveTowardsMountPoint(struct xEntFrame * frame /* r31 */, const struct xVec3 & mountPoint /* r1+0x8 */) {
    // Local variables
    float length2; // f31
    float minDist2; // f30
    struct xVec3 diff; // r1+0xC
    float diffLength2; // f29

    // References
    // -> struct zGlobals globals;
    // -> static float MOUNT_SPEED_MIN;
}

// Range: 0x802D477C -> 0x802D4884
unsigned char zContextObject::MatchOrientation(struct xEntFrame * frame /* r31 */, float targetAngle /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    float diffAngle; // f30
    float max; // f31
...
// Range: 0x802D4884 -> 0x802D48F8
unsigned char zContextObject::MatchOrientation(struct xEntFrame * frame /* r1+0x8 */, const struct xVec3 & orientation /* r31 */, float dt /* r1+0xC */, unsigned char forward /* r1+0x10 */) {
    // Local variables
    float targetAngle; // f31
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D66A64
struct config default_config; // size: 0x24, address: 0x80D25880
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// total size: 0x4
struct /* @class$1469zContextObject_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1470zContextObject_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
class zContextObjectManager {
    // Functions
    void SetTransitionType(enum zContextObjectType type);

    void Dismount(struct zCommonPlayer * player);

    void BeginUpdate(struct zCommonPlayer * player);

    void MountReset();

    void Reset();

    void UpdateProximityFX(struct zPlayer * player, float dt);

    void Update(struct zCommonPlayer * player, float dt);

    unsigned char CheckObjectType(enum zContextObjectType objectType);
...
// Range: 0x802D48F8 -> 0x802D4BD0
void zContextObjectManager::Setup() {
    // Local variables
    int baseType; // r26
    int count; // r23
    class zContextObjectTightrope * list; // r22
    int i; // r30
    int baseType; // r25
    int count; // r21
    class zContextObjectPoleSwing * list; // r20
    int i; // r29
    int baseType; // r24
    int count; // r19
    class zContextObjectClimbableRope * list; // r18
    int i; // r28
    int i; // r31
    int i; // r27

    // References
    // -> static struct xEnt * entFXList[16];
    // -> static char __FUNCTION__[6];
    // -> unsigned int gActiveHeap;
    // -> static float * glintEmit[5];
    // -> static int contextObjCount[5];
    // -> struct zGlobals globals;
    // -> static struct config glint_config;
    // -> struct config default_config;
}

// Range: 0x802D4C34 -> 0x802D4C74
void zContextObjectManager::AddEntFX(struct xEnt * ent /* r3 */) {
    // References
    // -> static int contextObjCount[5];
    // -> static struct xEnt * entFXList[16];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66A6A
char __FUNCTION__$localstatic1$set__12bit_array<3>Fib[4]; // size: 0x4, address: 0x80D66A7C
...
// Range: 0x802D4C74 -> 0x802D4D08
// this: r1+0x8
void zContextObjectManager::SetTransitionType(enum zContextObjectType type /* r31 */) {
    // References
...
// Range: 0x802D4D08 -> 0x802D4D70
// this: r31
void zContextObjectManager::Dismount(struct zCommonPlayer * player /* r1+0x8 */) {}
...
// total size: 0x890
struct /* @class$1826zContextObject_cpp */ {
    // Static members
...
// Range: 0x802D4D70 -> 0x802D4DC4
// this: r31
void zContextObjectManager::BeginUpdate(struct zCommonPlayer * player /* r30 */) {}

// Range: 0x802D4DC4 -> 0x802D4DE0
// this: r3
void zContextObjectManager::MountReset() {}

// Range: 0x802D4DE0 -> 0x802D4E7C
// this: r1+0x8
void zContextObjectManager::Reset() {
    // Local variables
    int baseType; // r30
    int count; // r29
    class zContextObjectClimbableRope * list; // r28
    int i; // r31
...
// Range: 0x802D4E7C -> 0x802D4EF0
void zContextObjectManager::Render() {
    // Local variables
    int count; // r30
    class zContextObjectTightrope * tightRopes; // r29
    int i; // r31
...
// Range: 0x802D4EF0 -> 0x802D5038
void zContextObjectManager::EmitSparks(float & emitCount /* r28 */, struct xVec3 & refPos /* r30 */, struct xModelInstance * model /* r31 */, float randR /* f31 */, float dt /* f30 */) {
    // Local variables
    struct RpGeometry * geom; // r29
    struct xVec3 * verts; // r27
    struct xVec3 pos; // r1+0x8
    unsigned int vert; // r26
...
// Range: 0x802D5038 -> 0x802D53E8
// this: r29
void zContextObjectManager::UpdateProximityFX(struct zPlayer * player /* r20 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 playerPos; // r1+0x30
    int count; // r28
    class zContextObjectTightrope * tightRopes; // r23
    int i; // r27
    const class xNurbs * curve; // r22
    struct xVec3 start; // r1+0x24
    struct xVec3 end; // r1+0x18
    class zContextObjectPoleSwing * poleSwings; // r21
    int i; // r25
    struct xVec3 polePos; // r1+0xC
    class zCarryableObject * carryableObjs; // r26
    int i; // r30
    int i; // r24
    struct xEnt * ent; // r31
...
char __FUNCTION__$localstatic1$get__12bit_array<3>Fi[4]; // size: 0x4, address: 0x80D66A80
// Range: 0x802D53E8 -> 0x802D55C4
// this: r31
void zContextObjectManager::Update(struct zCommonPlayer * player /* r30 */, float dt /* f31 */) {
    // Local variables
    float priority; // r1+0x8
    class zContextObject * object; // r29
}

// Range: 0x802D55C4 -> 0x802D5638
// this: r31
unsigned char zContextObjectManager::CheckObjectType(enum zContextObjectType objectType /* r29 */) {}

// Range: 0x802D5638 -> 0x802D56B4
static void CallUpdate(float dt /* r1+0x8 */) {
    // Local variables
    int count; // r30
    class zContextObjectClimbableRope * list; // r29
    int i; // r31
...
// Range: 0x802D56B4 -> 0x802D5760
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r1+0x8 */, union MountData & mountData /* r1+0xC */, float & priority /* r1+0x10 */) {
    // Local variables
    class zContextObject * object; // r30
    int count; // r28
    class zContextObjectClimbableRope * list; // r29
    int i; // r31
...
// Range: 0x802D5760 -> 0x802D580C
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r1+0x8 */, union MountData & mountData /* r1+0xC */, float & priority /* r1+0x10 */) {
    // Local variables
    class zContextObject * object; // r30
    int count; // r28
    class zContextObjectPoleSwing * list; // r29
    int i; // r31
...
// Range: 0x802D580C -> 0x802D58B8
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r1+0x8 */, union MountData & mountData /* r1+0xC */, float & priority /* r1+0x10 */) {
    // Local variables
    class zContextObject * object; // r30
    int count; // r28
    class zContextObjectTightrope * list; // r29
    int i; // r31
