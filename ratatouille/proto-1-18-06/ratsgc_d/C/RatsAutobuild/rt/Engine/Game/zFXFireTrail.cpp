/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXFireTrail.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80247444 -> 0x802480BC
*/
// total size: 0x44
struct config {
    // Members
...
unsigned char need_setup; // size: 0x1, address: 0x80D651C0
// total size: 0x1
class fire_trail {
    // Static members
    static int system_id; // size: 0x4
    static unsigned char need_setup; // size: 0x1
    static struct config default_config; // size: 0x44
};
// Range: 0x80247444 -> 0x80247584
void fire_trail::setup() {
    // References
...
int system_id; // size: 0x4, address: 0x80D6B148
// total size: 0x28
...
// Range: 0x80247584 -> 0x80247628
void fire_trail::scene_setup() {
    // Local variables
...
// Range: 0x80247628 -> 0x802479C4
void fire_trail::add_tweaks(const char * prefix /* r30 */, struct config * fire /* r31 */) {}
...
// total size: 0xC
struct /* @class$795zFXFireTrail_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$796zFXFireTrail_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$797zFXFireTrail_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$798zFXFireTrail_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$799zFXFireTrail_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$800zFXFireTrail_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$801zFXFireTrail_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D651C1
// total size: 0x30
struct particle {
    // Members
    ...
    float size_delta; // offset 0x28, size 0x4
...
// Range: 0x802479C4 -> 0x80247DB0
void fire_trail::emit(const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & normal /* r27 */, float & emit_remaining /* r30 */, const struct xVec3 & velocity /* r1+0xC */, float dt /* f31 */, struct config * cfg /* r31 */) {
    // Local variables
    float time_passed; // f30
    int emit; // r29
    struct particle * p; // r1+0x10
    int count; // r28
    struct particle * end; // r26
...
// total size: 0x4
struct /* @class$1177zFXFireTrail_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1315zFXFireTrail_cpp */ {
    // Members
...
union /* @class$846zFXFireTrail_cpp */ {
...
// total size: 0x10
struct /* @class$859zFXFireTrail_cpp */ {
    // Members
...
// Range: 0x80247DB0 -> 0x802480BC
int fire_trail::update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
