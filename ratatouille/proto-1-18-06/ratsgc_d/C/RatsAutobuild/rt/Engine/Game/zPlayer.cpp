/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8019417C -> 0x8019E068
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float PREDICT_SMOOTH; // size: 0x4, address: 0x80D633A8
float TERMINAL_VELOCITY; // size: 0x4, address: 0x80D633AC
float PLAYER_SCREEN_RADIUS; // size: 0x4, address: 0x80D633B0
float HALF_PLAYER_HEIGHT; // size: 0x4, address: 0x80D633B4
static float EXTRA_START_FADE_DIST; // size: 0x4, address: 0x80D6A6F0
static float EXTRA_END_FADE_DIST; // size: 0x4, address: 0x80D633B8
static float LEVITATE_RATE; // size: 0x4, address: 0x80D633BC
static float SOME_MOVE_CONSTANT; // size: 0x4, address: 0x80D633C0
static unsigned char drawScreenBound; // size: 0x1, address: 0x80D6A6F4
static unsigned char drawDebugAnim; // size: 0x1, address: 0x80D6A6F5
static unsigned char drawPrediction; // size: 0x1, address: 0x80D6A6F6
static float LEDGE_UP_BIAS; // size: 0x4, address: 0x80D633C4
static float LEDGE_DOWN_BIAS; // size: 0x4, address: 0x80D633C8
static float LEDGE_FORWARD_BIAS; // size: 0x4, address: 0x80D633CC
static unsigned char DRAW_JSP_POLY; // size: 0x1, address: 0x80D6A6F7
static unsigned char override; // size: 0x1, address: 0x80D6A6F8
static unsigned char active; // size: 0x1, address: 0x80D6A6F9
static float radius; // size: 0x4, address: 0x80D633D0
static int max_card_renders; // size: 0x4, address: 0x80D633D4
static float color_red; // size: 0x4, address: 0x80D633D8
static float color_green; // size: 0x4, address: 0x80D633DC
static float color_blue; // size: 0x4, address: 0x80D633E0
static float color_alpha; // size: 0x4, address: 0x80D633E4
static float card_dist; // size: 0x4, address: 0x80D633E8
static float zbias; // size: 0x4, address: 0x80D6A6FC
static float lifetime; // size: 0x4, address: 0x80D633EC
// Range: 0x8019417C -> 0x801943C4
...
// total size: 0x1
struct /* @class$890zPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$891zPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$892zPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$893zPlayer_cpp */ {
    // Members
...
// Range: 0x801943C4 -> 0x80194400
static void bound_update_wrapper(struct xEnt * ent /* r1+0x8 */, struct xVec3 * pos /* r1+0xC */) {}

static unsigned char drawPlayerAxis; // size: 0x1, address: 0x80D6A700
static unsigned char drawLorez; // size: 0x1, address: 0x80D6A701
// Range: 0x80194400 -> 0x80194484
...
// Range: 0x80194484 -> 0x80194534
static void ScaleHeadAnimMatrices(struct xVec3 * tran /* r1+0x8 */) {
    // Local variables
    const int * bones; // r31
    float scale; // f31
    int i; // r30
...
// total size: 0x4
struct /* @class$2620zPlayer_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2621zPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
struct config chronos_effect_config; // size: 0x44, address: 0x80D01290
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D633F0
struct config default_config; // size: 0x44, address: 0x80D23B60
float SECS_PER_VBLANK; // size: 0x4, address: 0x80D6A5A8
// total size: 0x4
struct xEntPlayerAsset {
    // Members
    unsigned int lightKitID; // offset 0x0, size 0x4
};
// Range: 0x80194534 -> 0x80194A08
// this: r31
void zPlayer::Init(struct xEntAsset * asset /* r26 */) {
    // Local variables
    struct xEntPlayerAsset * plyrAsset; // r25
    struct xLightKit * pLightKit; // r29
    struct xModelInstance * pModel; // r28
    struct xModelInstance * m; // r27
    struct RpAtomic * file; // r24
...
// Range: 0x80194A08 -> 0x80194A3C
// this: r1+0x8
void zPlayer::SceneSetup() {}

// Range: 0x80194A3C -> 0x80194A40
void zPlayer::SceneEnter() {}

// Range: 0x80194A40 -> 0x80194A44
void zPlayer::SceneExit() {}

// Range: 0x80194A44 -> 0x80194A74
// this: r1+0x8
void zPlayer::SetEnemyIsNear(unsigned char isit /* r1+0xC */) {}

unsigned int BUTTON_JUMP; // size: 0x4, address: 0x80D65698
char * BUTTON_NAMES[12]; // size: 0x30, address: 0x8051F9FC
unsigned int BUTTON_DEFINITIONS[12]; // size: 0x30, address: 0x8051FA2C
...
// Range: 0x80194F1C -> 0x80194FC4
// this: r30
void zPlayer::UseLorezModel(unsigned char useLorez /* r1+0x8 */) {
    // Local variables
    struct xModelInstance * target; // r31
}

// Range: 0x80194FC4 -> 0x80195020
void zPlayer::zPlayerEventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}
...
// Range: 0x80195020 -> 0x80195148
// this: r31
unsigned char zPlayer::Damage(const struct zCombatDamageInfo & damageInfo /* r30 */) {
    // Local variables
    enum zHitSource hitSource; // r29
    int damage; // r1+0x8
...
// Range: 0x80195148 -> 0x80195364
static void box_from_spheres(struct xBox & box /* r3 */, const struct xSphere * * spheres /* r4 */, int spheres_size /* r5 */) {
    // Local variables
    const struct xSphere * * end_spheres; // r31
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D633F5
...
// Range: 0x80195364 -> 0x80195670
// this: r26
void zPlayer::Update_MiscDamage() {
    // Local variables
    struct xSphere * spheres[6]; // r1+0x2C
    int spheres_size; // r28
    struct xBox box; // r1+0x14
    struct damage_result hits[32]; // r1+0x7C
    int hits_found; // r25
    struct damage_result * hit; // r31
    struct damage_result * end_hit; // r24
    const struct xSphere * * o; // r30
    const struct xSphere * * endo; // r27
    const struct xVec3 & hitcenter; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D63407
...
// Range: 0x80195670 -> 0x80195C3C
// this: r30
void zPlayer::CollideTrigger(struct xScene * sc /* r27 */) {
    // Local variables
    ...
    int triggerTypes; // r26
    unsigned int playerMask; // r28
    int i; // r25
    struct zEntTrigger * trig; // r31
    struct xTriggerAsset * tasset; // r29
    struct xRay3 ray; // r1+0x74
    unsigned char start_inside; // r24
    unsigned char end_inside; // r1+0x8
    unsigned char collide; // r23
...
float sFarWall; // size: 0x4, address: 0x80D6B204
// total size: 0x30
struct OOBExtent {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x80195CE0 -> 0x80195D8C
// this: r31
void zPlayer::LoadCheckPointB(struct xVec3 & pos /* r1+0x8 */, float ang /* r1+0xC */) {
    // References
    // -> struct xVec3 m_UnitAxisY;
}

// Range: 0x80195D8C -> 0x80195DC0
// this: r1+0x8
void zPlayer::StoreCheckPoint(const struct zPlayerCheckPoint & theCheckPoint /* r1+0xC */) {}
...
// total size: 0x11C
struct {} zPlayer::__vtable; // size: 0x11C, address: 0x8051FAC0
// Range: 0x80195FB4 -> 0x8019601C
// this: r31
zPlayer::zPlayer() {
    // References
...
// Range: 0x8019601C -> 0x801960E4
// this: r31
struct xVec3 zPlayer::get_bone_world_position(int bone /* r1+0x8 */) {
    // Local variables
    struct xVec3 position; // r1+0x18
    struct xVec3 model_position; // r1+0xC
}

// Range: 0x801960E4 -> 0x8019614C
// this: r30
void zPlayer::GetParameter(const char * name /* r1+0x8 */, unsigned char * value /* r31 */, unsigned char default_value /* r1+0xC */) {}

// Range: 0x8019614C -> 0x801961A8
// this: r30
void zPlayer::GetParameter(const char * name /* r1+0x8 */, float * value /* r31 */, float default_value /* r1+0xC */) {}

// Range: 0x801961A8 -> 0x80196230
// this: r30
void zPlayer::GetParameterList(const char * name /* r1+0x8 */, float * value /* r28 */, int count /* r26 */, const float * default_value /* r27 */) {
    // Local variables
    int i; // r31
    const char * strValue; // r29
}
...
void zPlayer::HeadScaleBeforeRender() {
    ...
    int i; // r29
    struct xMat3x3 * headMat; // r28
}

// Range: 0x801962FC -> 0x80196300
...
// Range: 0x80196300 -> 0x801963C8
// this: r31
void zPlayer::Render() {
    // Local variables
    struct zEnt * ent; // r30
    enum ReticleOrder order; // r29

    // References
    // -> static unsigned char drawLorez;
}

// Range: 0x801963C8 -> 0x8019652C
// this: r30
void zPlayer::RenderTransparent(float alpha /* r1+0x8 */) {
    // Local variables
    int int_alpha; // r29
    unsigned char player_trans; // r28
...
// Range: 0x8019652C -> 0x801968C4
// this: r31
void zPlayer::Reset() {
    // Local variables
    int i; // r29
    struct xAnimState * firstState; // r30
...
// Range: 0x801968C4 -> 0x8019691C
// this: r31
unsigned char zPlayer::IsDead() const {}

// Range: 0x8019691C -> 0x80196920
void zPlayer::ParseIni() {}

// Range: 0x80196920 -> 0x80196954
// this: r1+0x8
void zPlayer::BeginUpdate(float dt /* r1+0xC */) {}

// Range: 0x80196954 -> 0x80196A24
// this: r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63416
// Range: 0x80196A24 -> 0x80196AE8
static unsigned char InheritVelocity(struct zPlayer * player /* r1+0x8 */, struct xEnt * ent_jumping_off_of /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D63426
// total size: 0x0
...
// Range: 0x80196AE8 -> 0x80196F90
// this: r27
void zPlayer::UpdatePlayerDrive(float dt /* f31 */) {
    // Local variables
    struct xEntDrive * drv; // r31
    struct zPlatform * oplat; // r28
    struct xEnt * floor_entity; // r29
    struct zPlatform * platform; // r30
    struct xSurface * surf; // r26

    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x80196F90 -> 0x80196FC4
// this: r1+0x8
void zPlayer::EndUpdate(float dt /* r1+0xC */) {}

struct xColor_tag g_PIMP_GOLD; // size: 0x4, address: 0x80D6C6DC
// Range: 0x80196FC4 -> 0x80197150
// this: r31
...
// Range: 0x80197150 -> 0x80197194
// this: r1+0x8
void zPlayer::Move(struct xScene * s /* r1+0xC */, float dt /* r1+0x10 */, struct xEntFrame * frame /* r1+0x14 */) {}

// Range: 0x80197194 -> 0x801971E4
// this: r3
void zPlayer::Update_BaseTimers(float dt /* f1 */) {}

enum iSndGroupHandle {
};
// Range: 0x801971E4 -> 0x80197330
// this: r31
void zPlayer::Update_PlaySoundInIdleAnim(float dt /* r1+0x8 */) {
    // Local variables
    struct zEnt * ent; // r30
    char idle_sound_number; // r29
    char idle_sound_name[10]; // r1+0xC
    enum iSndGroupHandle sound_id; // r28
}

struct xColor_tag g_BLUE; // size: 0x4, address: 0x80D6C68C
struct xColor_tag g_RED; // size: 0x4, address: 0x80D6C680
// Range: 0x80197330 -> 0x801977F4
// this: r31
void zPlayer::Update_Prediction(float dt /* f24 */) {
    // Local variables
    struct zEnt * ent; // r30
...
// Range: 0x801977F4 -> 0x80197950
// this: r31
void zPlayer::Predict(struct xVec3 * pos /* r30 */, float timeIntoFuture /* f27 */, float leadFactor /* f28 */, unsigned char useTurn /* r1+0x10 */, unsigned char useY /* r1+0x11 */) {
    // Local variables
    float useVel; // f30
    float useAngV; // f31
    float checkTime; // f29
...
// Range: 0x801979E4 -> 0x80197A38
// this: r31
void zPlayer::Update_Fall(float dt /* r1+0x8 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D63438
// Range: 0x80197A38 -> 0x80197B48
// this: r31
void zPlayer::Exit() {
    // References
    // -> static char __FUNCTION__[5];
...
// Range: 0x80197B48 -> 0x80197B98
// this: r1+0x8
struct xVec3 zPlayer::get_target() {}

// Range: 0x80197B98 -> 0x80197C34
// this: r3
void zPlayer::RegisterDamage(int damage /* r4 */, enum zHitSource hitSource /* r5 */) {}

// Range: 0x80197C34 -> 0x80198008
// this: r31
void zPlayer::HandleEvent(struct xBase * from /* r17 */, unsigned int toEvent /* r18 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r1+0x10 */) {
    // Local variables
    unsigned char bPlayerControlWasOn; // r23
    int gamestate; // r22
    struct xLightKit * kit; // r21
    unsigned char bPlayerControlWasOff; // r20
    signed short damage; // r19
    struct xVec3 direction; // r1+0x20
    int amount; // r29
    enum zHitSource source; // r28
    struct xVec3 direction; // r1+0x14
...
static float reactiveAnimSpeed; // size: 0x4, address: 0x80D6A704
// Range: 0x80198008 -> 0x80198050
// this: r31
void zPlayer::Update_Control() {}

// Range: 0x80198050 -> 0x80198084
// this: r1+0x8
void zPlayer::Update(float dt /* r1+0xC */) {}

// Range: 0x80198084 -> 0x801982FC
// this: r31
void zPlayer::DefaultUpdate(float dt /* f31 */) {
    // Local variables
    float distance; // r1+0x8
    unsigned char bNearEnemy; // r30
    unsigned char bNearEnemyPrevious; // r29
...
// Range: 0x801982FC -> 0x80198310
// this: r3
void zPlayer::AnimPhysicsDebugReset() {}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6A708
static signed char init; // size: 0x1, address: 0x80D6A709
static char __FUNCTION__[23]; // size: 0x17, address: 0x8051F9E4
int POS_COUNT_MAX; // size: 0x4, address: 0x80D6E60C
struct xColor_tag g_GREEN; // size: 0x4, address: 0x80D6C688
// Range: 0x80198310 -> 0x80198628
// this: r31
void zPlayer::AnimPhysicsDebugUpdate() {
    // Local variables
    unsigned char prevDebugging; // r26
    struct xAnimPhysicsData * data; // r29
    int i; // r30
...
// Range: 0x80198BB0 -> 0x80198C18
// this: r3
void zPlayer::CalcAnimSpeed(float mag /* f1 */, float * animspeeds /* r4 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6343D
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80198C18 -> 0x80198CF0
// this: r31
void zPlayer::InitHitSoundsMap() {
    // Local variables
    unsigned int assetID; // r27
    int i; // r29
    unsigned short size; // r1+0x8
    struct xModelAssetParam * param; // r30
    int idx; // r28
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6344E
// Range: 0x80198D60 -> 0x80198E54
// this: r31
int zPlayer::GetCollisionSpheres(const struct xSphere * * sphereArray /* r28 */) {
    // Local variables
    int sphereCount; // r30
    int i; // r29
...
static struct xClumpCollBSPTriangle * debug_tris[20]; // size: 0x50, address: 0x80D012D4
static int debug_tris_count; // size: 0x4, address: 0x80D6A70C
static struct xVec3 lines[20][2]; // size: 0x1E0, address: 0x80D01324
static int lines_count; // size: 0x4, address: 0x80D6A710
// Range: 0x80198EC0 -> 0x80198F60
...
// Range: 0x80198F60 -> 0x801990D8
static void RenderDebugTris() {
    // Local variables
    int i; // r29
    struct xClumpCollBSPTriangle * triangle; // r31
    struct xVec3 p0; // r1+0x30
    struct xVec3 p1; // r1+0x24
    struct xVec3 p2; // r1+0x18
    class xPlane surface; // r1+0x8
    int j; // r30

    // References
    // -> static int lines_count;
    // -> static struct xVec3 lines[20][2];
    // -> static int debug_tris_count;
    // -> static struct xClumpCollBSPTriangle * debug_tris[20];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63462
// Range: 0x801990D8 -> 0x80199320
// this: r31
void zPlayer::HandleCollision(struct xScene * sc /* r1+0x8 */, float dt /* r1+0xC */, float settleRate /* r1+0x10 */) {
    // Local variables
...
static unsigned char debug_apply_depen; // size: 0x1, address: 0x80D6A714
static signed char init; // size: 0x1, address: 0x80D6A715
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63472
// Range: 0x80199320 -> 0x80199918
// this: r31
void zPlayer::Collide(float dt /* f31 */, float settle_rate /* r1+0x8 */, float max_settle_amount /* r1+0xC */, float ground_threshold /* r1+0x10 */) {
    // Local variables
    unsigned int animUserFlag; // r1+0x14
    unsigned char last_floor_collision; // r29
    struct xSphere * player_spheres[6]; // r1+0x3C
    int numCollisionSpheres; // r30
    struct xVec3 initial_disp; // r1+0x30
    struct xVec3 depenetration; // r1+0x24

    // References
    // -> static char __FUNCTION__[8];
    // -> static unsigned char debug_apply_depen;
    // -> static signed char init;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6347A
// total size: 0xCC
struct xSweptSphere {
    // Members
...
// Range: 0x80199918 -> 0x80199EB8
// this: r31
void zPlayer::CollideSettle(unsigned char on_ground_last_frame /* r30 */, float dt /* f27 */, float settle_rate /* r1+0x8 */, float max_settle_amount /* f25 */, float ground_threshold /* r1+0xC */) {
    // Local variables
    struct xVec3 start; // r1+0x3C
    struct xVec3 end; // r1+0x30
    struct xSweptSphere sws; // r1+0x114
    unsigned int collide_flags; // r1+0x14
    float radius_shrink; // f31
    struct xVec3 small_start; // r1+0x24
    struct xVec3 small_end; // r1+0x18
    struct xSweptSphere small_sws; // r1+0x48
    unsigned int small_collide_flags; // r1+0x10
    float delta_height; // f26
    float down_vel; // f30
    float settle_amount; // f29
...
// Range: 0x80199EB8 -> 0x80199F2C
// this: r30
unsigned char zPlayer::StayOnGround() {}

// Range: 0x80199F2C -> 0x80199F48
// this: r3
float zPlayer::InitialDepenetrationVelocity() {}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D63488
// Range: 0x80199F48 -> 0x8019A208
// this: r30
void zPlayer::AdjustDepenetration(struct xVec3 & depenetration /* r31 */, float dt /* f30 */) {
    // Local variables
    float wanted_depen_magnitude; // f31
    float max_depenetration; // f29

    // References
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x8051FA5C
// Range: 0x8019A208 -> 0x8019A988
// this: r31
void zPlayer::ComputeDepenetration(const struct xSphere * * spheres /* r22 */, int num_spheres /* r23 */, const struct xVec3 & initial_disp /* r24 */, struct xVec3 & dpos /* r30 */) {
    // Local variables
    int depth; // r28
    struct xVec3 valid_dpen; // r1+0x20
    unsigned int done_env_depen[5]; // r1+0x40
    void * done_obj_depen[5]; // r1+0x2C
    unsigned char tried_depenetrating; // r26
    int i; // r29
    unsigned char already_tried; // r25
    int j; // r27
...
static unsigned char done; // size: 0x1, address: 0x80D6A716
static signed char init; // size: 0x1, address: 0x80D6A717
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6349C
struct xColor_tag g_WHITE; // size: 0x4, address: 0x80D6C6A4
// Range: 0x8019A988 -> 0x8019ABBC
// this: r28
unsigned char zPlayer::FindShortestCollision(struct xSweptSphere & sws /* r31 */, unsigned int & collisionFlags /* r29 */, int penby /* r26 */) {
    // Local variables
    unsigned char hit; // r30
    float last_hit_dist; // r1+0xC
    unsigned char collType; // r25
...
// Range: 0x8019ABBC -> 0x8019ACE8
static void UpdateSWSCollision(struct xSweptSphere & sws /* r31 */, unsigned int whichFlag /* r28 */, unsigned int & collisionFlags /* r29 */, float & last_hit_dist /* r30 */) {
    // References
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051FA71
// Range: 0x8019ACE8 -> 0x8019AFDC
// this: r26
unsigned char zPlayer::FindShortestCollision(const struct xSphere * * spheres /* r29 */, int num_spheres /* r23 */, const struct xVec3 & initial_disp /* r24 */, const struct xVec3 & dir /* r27 */, float dist /* f31 */, struct SphereCollisionResults & results /* r31 */) {
    // Local variables
    int i; // r30
...
// Range: 0x8019B000 -> 0x8019B124
// this: r31
void zPlayer::SweptSphereCollideCheckFloor(struct SphereCollisionResults & scene_collide /* r30 */) {}

static char __FUNCTION__[34]; // size: 0x22, address: 0x8051FA87
// Range: 0x8019B124 -> 0x8019B4DC
// this: r25
void zPlayer::SweptSphereCollideComputeResponse(int stuck_collisions /* r26 */, struct SphereCollisionResults * scene_collide /* r31 */, int depth /* r29 */, const struct xVec3 & current_dir /* r1+0x8 */, struct xVec3 & remaining_dpos /* r30 */) {
    // Local variables
    struct xVec3 naive_response; // r1+0x18
    int partner_offset; // r27
    struct xVec3 combination; // r1+0xC
    int i; // r28
...
// Range: 0x8019B4DC -> 0x8019B59C
static unsigned char CheckCombinationResponseWorks(int stuck_collisions /* r1+0x8 */, struct SphereCollisionResults * scene_collide /* r27 */, int depth /* r28 */, int partner_offset /* r29 */, const struct xVec3 & combined_response /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x8019B59C -> 0x8019B62C
static unsigned char combine_two_normals(const struct xVec3 & n1 /* r1+0x8 */, const struct xVec3 & n2 /* r1+0xC */, const struct xVec3 & orig /* r1+0x10 */, struct xVec3 & result /* r31 */) {
    // Local variables
    struct xVec3 cross; // r1+0x14
}

// Range: 0x8019B62C -> 0x8019B6B0
static unsigned char CheckNaiveResponseWorks(int stuck_collisions /* r1+0x8 */, struct SphereCollisionResults * scene_collide /* r1+0xC */, int depth /* r1+0x10 */, const struct xVec3 & naive_response /* r1+0x14 */) {
    // Local variables
    int i; // r31
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D634AF
// Range: 0x8019B6B0 -> 0x8019C6E8
// this: r29
void zPlayer::SweptSphereCollide(const struct xSphere * * spheres /* r1+0x8 */, int num_spheres /* r1+0xC */, const struct xVec3 & initial_disp /* r27 */, struct xVec3 & dpos /* r31 */) {
    // Local variables
    struct xVec3 valid_dpos; // r1+0x4C
    struct xVec3 full_initial_disp; // r1+0x40
    struct xVec3 originalDpos; // r1+0x34
    struct xVec3 original_desired_dir; // r1+0x28
    float remaining_dist; // f30
    struct xVec3 current_dir; // r1+0x1C
    float current_dist; // f31
    struct SphereCollisionResults scene_collide[8]; // r1+0x58
    int stuck_collisions; // r28
    int depth; // r30
    struct xVec3 remaining_dpos; // r1+0x10

    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x8019C6E8 -> 0x8019C72C
// this: r1+0x8
unsigned char zPlayer::CollisionResponse(const struct xVec3 & currentDir /* r1+0xC */, const struct SphereCollisionResults & sceneCollide /* r1+0x10 */, struct xVec3 & responseDpos /* r1+0x14 */) {}

// Range: 0x8019C72C -> 0x8019C7A4
unsigned char zPlayer::DefaultCollisionResponse(const struct xVec3 & current_dir /* r1+0x8 */, const struct SphereCollisionResults & scene_collide /* r31 */, struct xVec3 & response_dpos /* r30 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6A718
static signed char init; // size: 0x1, address: 0x80D6A719
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D634C2
static char __FUNCTION__[21]; // size: 0x15, address: 0x8051FAA9
// total size: 0x38
struct xGrid {
    // Members
...
// Range: 0x8019C7A4 -> 0x8019CD68
// this: r31
void zPlayer::FindStaticCollisions(const struct xSphere * * spheres /* r29 */, int numSpheres /* r22 */, const struct xVec3 & initialDisplacement /* r23 */, const struct xVec3 & validDepenetration /* r24 */) {
    // Local variables
    int curSphere; // r30
    unsigned char ncolls; // r25
    int i; // r28
    struct xCollis * coll; // r21
...
// Range: 0x8019CD68 -> 0x8019CD84
// this: r3
static depenetrate_callback::depenetrate_callback(const struct xSphere & sphere /* r4 */, struct xCollis * coll /* r5 */, unsigned char & index /* r6 */, unsigned char & start_index /* r7 */, unsigned char & end_index /* r8 */, unsigned char check_inhibit /* r9 */) {}
...
// Range: 0x8019CF2C -> 0x8019CF80
// this: r31
void zPlayer::mblur_setup() {}

// Range: 0x8019CF80 -> 0x8019CFB4
// this: r31
void zPlayer::mblur_reset() {}

// Range: 0x8019CFB4 -> 0x8019CFE8
// this: r31
...
// Range: 0x8019CFE8 -> 0x8019D080
// this: r31
unsigned char zPlayer::mblur_activate(float lifetime /* r1+0x8 */, float alpha /* r1+0xC */) {
    // Local variables
    struct xModelInstance * blur_model; // r30

    // References
    // -> static unsigned char override;
}

// Range: 0x8019D080 -> 0x8019D154
// this: r31
...
// Range: 0x8019D154 -> 0x8019D1C0
// this: r29
void zPlayer::mblur_get_center(struct xVec3 & center /* r30 */) {
    // Local variables
    struct zCombat * combat; // r31
}

// Range: 0x8019D1C0 -> 0x8019D278
// this: r31
...
// Range: 0x8019D278 -> 0x8019D35C
// this: r31
void zPlayer::mblur_set_config(float radius /* r1+0x8 */, float color_red /* r1+0xC */, float color_green /* r1+0x10 */, float color_blue /* r1+0x14 */, float color_alpha /* r1+0x18 */, float card_dist /* r1+0x1C */, float zbias /* r1+0x20 */, int max_card_renders /* r1+0x24 */) {
    // References
    // -> static unsigned char override;
}

// Range: 0x8019D35C -> 0x8019D3AC
// this: r31
void zPlayer::mblur_set_lifetime(float value /* r1+0x8 */, float time /* r1+0xC */) {
    // References
    // -> static unsigned char override;
}

// Range: 0x8019D3AC -> 0x8019D3FC
// this: r31
void zPlayer::mblur_set_alpha(float value /* r1+0x8 */, float time /* r1+0xC */) {
    // References
    // -> static unsigned char override;
}

// Range: 0x8019D3FC -> 0x8019D4D8
// this: r31
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D634C7
// Range: 0x8019D4D8 -> 0x8019D5BC
// this: r31
void zPlayer::NPCAttackerAddPrvt(class zNPCCommon * addAttacker /* r1+0x8 */, int listIdx /* r30 */) {
    // Local variables
    int idx; // r29
...
// Range: 0x8019D690 -> 0x8019D6A0
// this: r3
int zPlayer::NPCAttackerGetTotal(enum ezNPCAttackerType inType /* r4 */) {}

// Range: 0x8019D6A0 -> 0x8019D79C
// this: r31
void zPlayer::EnemyKilled(class zNPCCommon * npc /* r30 */) {
    // Local variables
...
// Range: 0x8019D79C -> 0x8019D7D0
// this: r3
void zPlayer::EnemyKilledComboUpdate(float dt /* f1 */) {}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D634DA
// Range: 0x8019D7D0 -> 0x8019D8E4
// this: r31
...
// Range: 0x8019D8E4 -> 0x8019D944
// this: r31
void zPlayer::RoundRobinUpdate(float dt /* r1+0x8 */) {}

// Range: 0x8019D944 -> 0x8019D9B0
...
// Range: 0x8019DAC8 -> 0x8019DB10
// this: r31
void zPlayer::AddStates(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x8019DB10 -> 0x8019DDA0
// this: r31
unsigned char zPlayer::HandleFlyCheat(float dt /* f26 */, struct xEntFrame * frame /* r30 */) {
    // Local variables
    float x; // f29
    float z; // f28
    float angle; // f30
...
// Range: 0x8019DDA0 -> 0x8019E068
// this: r31
static unsigned char depenetrate_callback::operator()(struct xEnt & ent /* r30 */) {
    // Local variables
    struct xModelInstance * collmod; // r29
