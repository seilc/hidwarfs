/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemRain.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80276D38 -> 0x80277988
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float FADE_TIME; // size: 0x4, address: 0x80D659D0
static float MAX_RENDER_DISTANCE; // size: 0x4, address: 0x80D659D4
// total size: 0x8
...
// total size: 0x24
class zParticleSystemRain : public zParticleSystem {
    // Functions
...
// Range: 0x80276D38 -> 0x80276DAC
// this: r1+0x8
struct zParticleGenerator * zParticleSystemRain::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorRain * gen; // r30
}

// Range: 0x80276DE8 -> 0x80276E14
// this: r1+0x8
void zParticleSystemRain::scene_enter() {}

// Range: 0x80276E14 -> 0x80276E44
// this: r1+0x8
void zParticleSystemRain::update(float dt /* r1+0xC */) {}
...
// Range: 0x80276E44 -> 0x80276E4C
int zParticleSystemRain::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D659D8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$840zParticleSystemRain_cpp */ {
    // Members
...
struct particle_instance {
    ...
    float yOrig; // offset 0xC, size 0x4
};
// total size: 0xC
struct asset_data {
    // Members
    float gravity; // offset 0x0, size 0x4
    float dropWidth; // offset 0x4, size 0x4
    float dropLength; // offset 0x8, size 0x4
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x80276E4C -> 0x802771DC
int zParticleSystemRain::update_particles(unsigned char * mem /* r17 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */, void * context /* r18 */) {
    // Local variables
    ...
    struct zParticleGeneratorRain & g; // r25
    struct asset_data & a; // r28
    float gravity; // f27
    float height; // f29
    float fadeDist; // f30
    float dropLength; // f26
    float dropWidth; // f25
    const struct xMat4x3 & camMat; // r20
    const struct xVec3 & camPos; // r19
    float distTraveled; // f31
    struct RwSphere worldsph; // r1+0x14
    struct xVec3 & _up_; // r21
    struct xVec3 & _at_; // r24
    struct xVec3 & _right_; // r23
    float alpha; // f28
...
// total size: 0xCC
struct zParticleGeneratorRain : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemRain & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemRain * system; // offset 0xA4, size 0x4
    ...
    struct debug debugInfo; // offset 0xC4, size 0x8
};
// Range: 0x802771DC -> 0x802773BC
// this: r31
void zParticleGeneratorRain::update(float dt /* f30 */) {
    // Local variables
    const struct asset_data & a; // r27
    float height; // f31
    int emit; // r29
...
// Range: 0x802773BC -> 0x802774CC
// this: r31
void zParticleGeneratorRain::create(class zParticleSystemRain & system /* r28 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x802774CC -> 0x80277564
// this: r31
void zParticleGeneratorRain::reset() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D659E9
// Range: 0x80277564 -> 0x80277624
// this: r31
void zParticleGeneratorRain::activate() {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x80277624 -> 0x80277670
// this: r31
void zParticleGeneratorRain::deactivate() {}

// Range: 0x80277670 -> 0x802776B8
// this: r31
void zParticleGeneratorRain::resume() {}

// Range: 0x802776B8 -> 0x802776EC
// this: r31
void zParticleGeneratorRain::pause() {}
...
// Range: 0x802776EC -> 0x80277750
// this: r1+0x8
unsigned char zParticleGeneratorRain::cullUpdate() {
    // Local variables
...
// Range: 0x80277750 -> 0x80277930
// this: r31
void zParticleGeneratorRain::add_tweaks(const char * prefix /* r30 */) {
    // Local variables
...
// Range: 0x80277930 -> 0x80277988
// this: r31
void zParticleGeneratorRain::debug_render(unsigned char all /* r30 */) {}

// total size: 0x2C
struct {} zParticleGeneratorRain::__vtable; // size: 0x2C, address: 0x80524C98
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemRain_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemRain_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemRain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemRain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemRain_cpp */ {
    // Members
...
union /* @class$827zParticleSystemRain_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemRain::__vtable; // size: 0x3C, address: 0x80524CC4
// total size: 0x8
