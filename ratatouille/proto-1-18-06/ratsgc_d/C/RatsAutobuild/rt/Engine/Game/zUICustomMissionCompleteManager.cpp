/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomMissionCompleteManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E57B4 -> 0x802E5DCC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char lastSceneWasAlreadyCompleted; // size: 0x1, address: 0x80D6B730
static unsigned char screenEnd; // size: 0x1, address: 0x80D66D28
static unsigned char allowPause; // size: 0x1, address: 0x80D6B731
// Range: 0x802E57B4 -> 0x802E57BC
unsigned char zUICustomMissionComplete_IsAllowedPaused() {
    // References
    // -> static unsigned char allowPause;
}

// total size: 0x54
struct {} zUICustomMissionCompleteManager::__vtable; // size: 0x54, address: 0x80529598
// total size: 0x10
class zUICustomMissionCompleteManager : public zUICustom {
    // Functions
    zUICustomMissionCompleteManager(class zUI * ui);
    ...
    // Members
protected:
    float preupdatetimer; // offset 0x8, size 0x4
    unsigned char saved; // offset 0xC, size 0x1
};
// Range: 0x802E57BC -> 0x802E5810
// this: r31
zUICustomMissionCompleteManager::zUICustomMissionCompleteManager(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomMissionCompleteManager::__vtable;
}
...
// Range: 0x802E5810 -> 0x802E5814
void zUICustomMissionCompleteManager::Init() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D66D29
// total size: 0x34
struct RwRaster {
    // Members
...
// total size: 0x2
struct /* @class$1904zUICustomMissionCompleteManager_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$994zUICustomMissionCompleteManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1132zUICustomMissionCompleteManager_cpp */ {
    // Members
...
union /* @class$1133zUICustomMissionCompleteManager_cpp */ {
...
// total size: 0x10
struct /* @class$1381zUICustomMissionCompleteManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1878zUICustomMissionCompleteManager_cpp */ {
    // Static members
...
// Range: 0x802E5814 -> 0x802E59A8
// this: r31
unsigned char zUICustomMissionCompleteManager::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r29 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // Local variables
    ...
    // -> static unsigned char lastSceneWasAlreadyCompleted;
}
...
// Range: 0x802E59A8 -> 0x802E5A5C
// this: r31
void zUICustomMissionCompleteManager::start_autosave() {
    // References
...
// Range: 0x802E5A5C -> 0x802E5AF4
// this: r31
void zUICustomMissionCompleteManager::end_autosave() {
    // References
    // -> class zUICustom * pSysMessageManager_Custom;
    // -> class zUI * pSysMessageManager;
    // -> struct zGlobals globals;
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66D35
// Range: 0x802E5AF4 -> 0x802E5B88
static void zSystemMessageCB(unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D66D46
unsigned char gSysMessageManager_active; // size: 0x1, address: 0x80D6B159
// Range: 0x802E5B88 -> 0x802E5DCC
// this: r31
void zUICustomMissionCompleteManager::PreUpdate(float dt /* r1+0x10 */) {
    // Local variables
    unsigned int strHash; // r30
    class zUIText * acceptText; // r29
