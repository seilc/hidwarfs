/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCSwarmOwl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8033D57C -> 0x8033D7AC
*/
// total size: 0x68
class zNPCSwarmOwl : public zNPCBase {
    // Functions
...
// Range: 0x8033D57C -> 0x8033D598
int zNPCSwarmOwl::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {
    // Local variables
    struct zNPCAssetSwarm * npcassSwarm; // r31
}

char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicSwarmOwl,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67CB8
signed char zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB68
...
class zComponentPool zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB6C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x8033D598 -> 0x8033D638
// this: r31
unsigned char zNPCSwarmOwl::Activate() {}
...
// Range: 0x8033D638 -> 0x8033D660
// this: r1+0x8
void zNPCSwarmOwl::Deactivate() {}

// Range: 0x8033D660 -> 0x8033D6E8
// this: r29
void zNPCSwarmOwl::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D67CC8
// Range: 0x8033D6E8 -> 0x8033D784
// this: r30
void zNPCSwarmOwl::UpdateNPCBaseData() {
    // Local variables
...
// Range: 0x8033D784 -> 0x8033D7AC
// this: r1+0x8
void zNPCSwarmOwl::Render() {}

// total size: 0x3C
struct {} zNPCSwarmOwl::__vtable; // size: 0x3C, address: 0x8052EB30
