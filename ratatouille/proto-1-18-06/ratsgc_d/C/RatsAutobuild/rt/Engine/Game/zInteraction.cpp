/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zInteraction.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802017B4 -> 0x802059AC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sAlphaUpRate; // size: 0x4, address: 0x80D64490
static float sAlphaDownRate; // size: 0x4, address: 0x80D64494
static float sMaxDrawDist2; // size: 0x4, address: 0x80D64498
static float sMinDrawAlpha; // size: 0x4, address: 0x80D6449C
static float sMaxDrawAlpha; // size: 0x4, address: 0x80D644A0
static float sLogoAngle; // size: 0x4, address: 0x80D6ADC0
static int sLiftBoneIndex; // size: 0x4, address: 0x80D644A4
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 sLiftBoneOffset; // size: 0xC, address: 0x80D644A8
static float sLiftMoveBack; // size: 0x4, address: 0x80D644B4
static float sLaunchMaxDist2; // size: 0x4, address: 0x80D644B8
static float sLaunchHalfYawRange; // size: 0x4, address: 0x80D644BC
static float sLaunchFlipLength; // size: 0x4, address: 0x80D644C0
static float sLaunchThresholdY; // size: 0x4, address: 0x80D644C4
static float sLaunchReelInBeginPull; // size: 0x4, address: 0x80D644C8
static float sLaunchReelInBeginBounce; // size: 0x4, address: 0x80D6ADC4
static float sLaunchFlingBegin; // size: 0x4, address: 0x80D644CC
static float sLaunchBlurLife; // size: 0x4, address: 0x80D644D0
static float sLaunchBlurAlpha; // size: 0x4, address: 0x80D644D4
static float sLaunchBlurFadeInTime; // size: 0x4, address: 0x80D644D8
static float sLaunchBlurFadeOutTime; // size: 0x4, address: 0x80D644DC
static float sLaunchBlurRadius; // size: 0x4, address: 0x80D644E0
static int sLaunchBlurMaxCardRenders; // size: 0x4, address: 0x80D644E4
static float sLaunchBlurColorRed; // size: 0x4, address: 0x80D644E8
static float sLaunchBlurColorGreen; // size: 0x4, address: 0x80D644EC
static float sLaunchBlurColorBlue; // size: 0x4, address: 0x80D644F0
static float sLaunchBlurColorAlpha; // size: 0x4, address: 0x80D644F4
static float sLaunchBlurCardDist; // size: 0x4, address: 0x80D644F8
static float sLaunchBlurZbias; // size: 0x4, address: 0x80D644FC
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$929zInteraction_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zInteraction_cpp */ {
    // Members
...
union /* @class$1068zInteraction_cpp */ {
...
// Range: 0x802017B4 -> 0x802017E0
void zInteraction_SceneInit(struct zScene * zsc /* r1+0x8 */) {}

// Range: 0x802017E0 -> 0x80201814
void zInteraction_SceneReset(struct zScene * zsc /* r31 */) {}
...
// total size: 0x10
struct /* @class$1692zInteraction_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80201814 -> 0x80201920
void zInteraction_Update(float dt /* f31 */) {
    // Local variables
    int count; // r30
    struct zScene * zsc; // r31
    class zSwitchLever * switchList; // r25
    int i; // r29
    class zHeistLookoutPoint * lookoutList; // r24
    int i; // r28
    class zHeistDistractionObject * distractList; // r23
    int i; // r27
    class zLaunch * launchList; // r22
    int i; // r26

    // References
    // -> struct zGlobals globals;
    // -> static float sLogoAngle;
}

// Range: 0x80201920 -> 0x80201A1C
void zInteraction_Render() {
    // Local variables
    int count; // r30
    struct zScene * zsc; // r31
    unsigned char wasBright; // r25
    class zSwitchLever * switchList; // r24
    int i; // r29
    class zHeistLookoutPoint * lookoutList; // r23
    int i; // r28
    class zHeistDistractionObject * distractList; // r22
    int i; // r27
    class zLaunch * launchList; // r21
    int i; // r26
...
// Range: 0x80201A1C -> 0x80201D9C
void zInteraction_AddTweaks() {
    // References
    // -> static float sLaunchBlurZbias;
    // -> static float sLaunchBlurCardDist;
    // -> static float sLaunchBlurColorAlpha;
    // -> static float sLaunchBlurColorBlue;
    // -> static float sLaunchBlurColorGreen;
    // -> static float sLaunchBlurColorRed;
    // -> static int sLaunchBlurMaxCardRenders;
    // -> static float sLaunchBlurRadius;
    // -> static float sLaunchBlurFadeOutTime;
    // -> static float sLaunchBlurFadeInTime;
    // -> static float sLaunchBlurAlpha;
    // -> static float sLaunchBlurLife;
    // -> static float sLaunchFlingBegin;
    // -> static float sLaunchReelInBeginBounce;
    // -> static float sLaunchReelInBeginPull;
    // -> static float sLaunchThresholdY;
    // -> static float sLaunchFlipLength;
    // -> static float sLaunchHalfYawRange;
    // -> static float sLaunchMaxDist2;
    // -> static float sLiftMoveBack;
    // -> static struct xVec3 sLiftBoneOffset;
    // -> static int sLiftBoneIndex;
}

// total size: 0x14
struct {} zInteraction::__vtable; // size: 0x14, address: 0x80D645E0
// total size: 0x14
...
class zInteraction : public xBase {
    // Functions
    zInteraction(struct zInteractionAsset * theAsset);
...
// Range: 0x80201D9C -> 0x80201DE4
// this: r31
zInteraction::zInteraction(struct zInteractionAsset * theAsset /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zInteraction::__vtable;
}

// Range: 0x80201DE4 -> 0x80201E08
// this: r3
void zInteraction::Reset() {}

// Range: 0x80201E08 -> 0x80201E50
// this: r31
void zInteraction::Stop() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64500
// total size: 0x14
struct {} zTriggerInteraction::__vtable; // size: 0x14, address: 0x80D645CC
...
// total size: 0xC
struct /* @class$2250zInteraction_cpp */ {
    // Members
...
class zTriggerInteraction : public zInteraction {
    // Functions
    zTriggerInteraction(struct zTriggerInteractionAsset * theAsset);

    void Reset();

    void Render();

    unsigned char CheckTrigger(struct zCommonPlayer * player);

    unsigned char StartInteracting(struct zCommonPlayer * player);
...
// Range: 0x80201E50 -> 0x80202010
// this: r30
zTriggerInteraction::zTriggerInteraction(struct zTriggerInteractionAsset * theAsset /* r31 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zTriggerInteraction::__vtable;
}

// Range: 0x80202010 -> 0x80202044
// this: r31
void zTriggerInteraction::Reset() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64505
...
// Range: 0x80202044 -> 0x80202250
// this: r31
void zTriggerInteraction::Render() {
    // Local variables
    const struct xMat4x3 & triggerMat; // r30
    struct xMat4x3 mat; // r1+0x10
    struct xTriggerAsset * tasset; // r29
    unsigned char wasBright; // r28
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6450C
// Range: 0x80202250 -> 0x802023D8
// this: r31
unsigned char zTriggerInteraction::CheckTrigger(struct zCommonPlayer * player /* r1+0x8 */) {
    // Local variables
    struct xVec3 playerPos; // r1+0x18
    struct xVec3 pos; // r1+0xC
    struct xTriggerAsset * tasset; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D64519
// Range: 0x802023D8 -> 0x802024D0
// this: r31
unsigned char zTriggerInteraction::StartInteracting(struct zCommonPlayer * player /* r30 */) {
    // References
...
// total size: 0x890
struct /* @class$1935zInteraction_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$870zInteraction_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zInteraction_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$872zInteraction_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$873zInteraction_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$874zInteraction_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$875zInteraction_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$876zInteraction_cpp */ {
    // Members
...
static struct _xFColor LIGHT_OFF_COLOR; // size: 0x10, address: 0x80D6452C
static struct _xFColor LIGHT_ON_COLOR; // size: 0x10, address: 0x80D6453C
static float SWITCH_COMPLETE_PERCENT; // size: 0x4, address: 0x80D6454C
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80D18100
// Range: 0x802024D0 -> 0x80202634
static void SetupEnt(struct xEnt * ent /* r31 */, struct zSwitchLeverAsset * asset /* r30 */) {
    // References
    // -> static struct xEntAsset fakeAsset;
}

// Range: 0x80202634 -> 0x80202670
static unsigned int SwitchingOnCheck(void * object /* r1+0x8 */) {}

// total size: 0x74
class zSwitchLever : public zTriggerInteraction {
    // Functions
    zSwitchLever(struct zSwitchLeverAsset * theAsset);

    void SwitchedOn();

    void SwitchedOff();

    void SwitchChangeCB(struct xAnimSingle * anim);
    ...
    void Activate(unsigned char active);

    void Start(struct zCommonPlayer * thePlayer);
...
// Range: 0x80202670 -> 0x802026AC
static unsigned int SwitchingOffCheck(void * object /* r1+0x8 */) {}

// Range: 0x802026AC -> 0x802026DC
static unsigned int SwitchedOffCB(void * object /* r1+0x8 */) {}

// Range: 0x802026DC -> 0x8020270C
static unsigned int SwitchedOnCB(void * object /* r1+0x8 */) {}

// Range: 0x8020270C -> 0x8020274C
static unsigned int SwitchChangeCB(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */, void * object /* r1+0x10 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D64550
// Range: 0x8020274C -> 0x80202908
static void AddAnim(struct xAnimTable * table /* r1+0x8 */, const char * stateName /* r28 */, unsigned int assetID /* r27 */, unsigned int animID /* r31 */) {
    // Local variables
    void * buffer; // r30
    struct xAnimFile * afile; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64558
// Range: 0x80202908 -> 0x80202DF8
static void SetupAnimTable(struct xEnt * ent /* r29 */, struct zSwitchLeverAsset * asset /* r30 */) {
    // Local variables
    struct xAnimTransition * tran; // r1+0x18
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64567
// Range: 0x80202DF8 -> 0x80202FCC
void zSwitchLever::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6456C
// total size: 0x14
struct {} zSwitchLever::__vtable; // size: 0x14, address: 0x80D645B8
...
// total size: 0xDC
struct SwitchObject : public xEnt {
    // Members
    class zSwitchLever * lever; // offset 0xD8, size 0x4
};
// Range: 0x80202FCC -> 0x802032A4
// this: r31
zSwitchLever::zSwitchLever(struct zSwitchLeverAsset * theAsset /* r1+0x8 */) {
    // Local variables
    struct SwitchObject * switchObject; // r30

    // References
    // -> static char __FUNCTION__[5];
    // -> unsigned int gActiveHeap;
    // -> struct [anonymous] zSwitchLever::__vtable;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D64571
// total size: 0x10
struct glintInfo {
    // Members
...
// total size: 0x58
class zSparkEmitter : public xBase {
    // Members
public:
    unsigned char mRenderLastEmitPoint; // offset 0x10, size 0x1
    struct xVec3 mLastPos; // offset 0x14, size 0xC
    struct xVec3 mLastDir; // offset 0x20, size 0xC
private:
    struct zSparkEmitterAsset * asset; // offset 0x2C, size 0x4
    struct xEnt * track_entity; // offset 0x30, size 0x4
    struct xVec3 emit_dir; // offset 0x34, size 0xC
    float time_until_emit; // offset 0x40, size 0x4
    unsigned char is_on; // offset 0x44, size 0x1
    unsigned char is_active; // offset 0x45, size 0x1
    unsigned char should_look_for_track; // offset 0x46, size 0x1
    enum iSndGroupHandle sparkSound; // offset 0x48, size 0x4
    int mSparkSystemId; // offset 0x4C, size 0x4
    int mGlintSystemId; // offset 0x50, size 0x4
    float last_dt; // offset 0x54, size 0x4
};
// Range: 0x802032A4 -> 0x80203428
// this: r31
void zSwitchLever::SwitchedOn() {
    // Local variables
    struct xGroup * sparkGroup; // r28
    unsigned int count; // r30
    class zSparkEmitter * sparkPtr; // r29
    class zSparkEmitter * sparkPtr; // r27

    // References
    // -> static char __FUNCTION__[11];
    // -> static struct _xFColor LIGHT_ON_COLOR;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6457C
// Range: 0x80203428 -> 0x802035AC
// this: r31
void zSwitchLever::SwitchedOff() {
    // Local variables
    struct xGroup * sparkGroup; // r28
    unsigned int count; // r30
    class zSparkEmitter * sparkPtr; // r29
    ...
    // -> static struct _xFColor LIGHT_OFF_COLOR;
}

// Range: 0x802035AC -> 0x802035D0
// this: r3
void zSwitchLever::SwitchChangeCB(struct xAnimSingle * anim /* r5 */) {}

// Range: 0x802035D0 -> 0x8020371C
// this: r31
void zSwitchLever::Reset() {
    // Local variables
    struct xVec3 ang; // r1+0x8
}

// Range: 0x8020371C -> 0x80203788
// this: r31
void zSwitchLever::CollisionOn() {}

// Range: 0x80203788 -> 0x802037E0
// this: r31
void zSwitchLever::CollisionOff() {}

// Range: 0x802037E0 -> 0x802039C4
// this: r31
void zSwitchLever::EventCB(unsigned int toEvent /* r30 */) {}

// Range: 0x802039C4 -> 0x80203A3C
// this: r31
void zSwitchLever::Activate(unsigned char active /* r1+0x8 */) {}

// Range: 0x80203A3C -> 0x80203A8C
void zSwitchLever::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}

// Range: 0x80203A8C -> 0x80203AF4
void zSwitchLever::SceneReset(struct zScene * zsc /* r30 */) {
    // Local variables
    int count; // r29
    class zSwitchLever * switchList; // r28
    int i; // r31
}

// Range: 0x80203AF4 -> 0x80203B44
// this: r31
void zSwitchLever::Start(struct zCommonPlayer * thePlayer /* r30 */) {}

// Range: 0x80203B44 -> 0x80203BE4
// this: r31
void zSwitchLever::Stop() {
    // Local variables
    const struct xAnimSingle * single; // r30

    // References
    // -> static float SWITCH_COMPLETE_PERCENT;
}

// Range: 0x80203BE4 -> 0x80203D6C
// this: r31
void zSwitchLever::Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
...
// Range: 0x80203D6C -> 0x80203DAC
// this: r31
void zSwitchLever::Render() {}

// Range: 0x80203DAC -> 0x80203DD0
// this: r3
void zSwitchLever::Ready() {}

// Range: 0x80203DD0 -> 0x80203E74
// this: r31
unsigned char zSwitchLever::Available() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D64588
// total size: 0x24
struct xParabola {
    // Members
...
class zLaunch : public zInteraction {
    ...
    zLaunch(struct zLaunchAsset * theAsset);

    void Reset();

    unsigned char CheckPlayer(struct zCommonPlayer * player, float & maxAlpha, float & yaw, float & yawDiff);
...
// Range: 0x80203E74 -> 0x80203F68
// this: r31
void zLaunch::SceneInit() {
    // Local variables
    struct xEnt * ent; // r30
    struct zEntSimpleObj * simp; // r29
...
// Range: 0x80203F68 -> 0x80203FD0
void zLaunch_SceneInit(struct zScene * zsc /* r30 */) {
    // Local variables
    int count; // r29
    class zLaunch * launchList; // r28
    int i; // r31
}

// Range: 0x80203FD0 -> 0x80204040
void zLaunch_SceneReset(struct zScene * zsc /* r30 */) {
    // Local variables
    int count; // r28
    class zLaunch * launchList; // r29
    int i; // r31
    class zLaunch * launch; // r1+0x8
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64592
// Range: 0x80204040 -> 0x80204214
void zLaunch::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64597
// total size: 0x14
struct {} zLaunch::__vtable; // size: 0x14, address: 0x80D645A4
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x80204214 -> 0x802043C0
// this: r31
zLaunch::zLaunch(struct zLaunchAsset * theAsset /* r30 */) {
    // Local variables
    unsigned int size; // r1+0x8
    void * obj; // r29
    struct PKRAssetTOCInfo assetInfo; // r1+0xC
    struct xDynAsset * da; // r28

    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zLaunch::__vtable;
}
...
// Range: 0x802043C0 -> 0x802043F4
// this: r31
void zLaunch::Reset() {}

// Range: 0x802043F4 -> 0x802044E8
void zLaunch::StartBlur() {
    // References
    // -> static float sLaunchBlurFadeInTime;
    // -> static float sLaunchBlurAlpha;
    // -> struct xGlobals * xglobals;
...
// Range: 0x802044E8 -> 0x80204598
void zLaunch::StopBlur() {
    // References
    // -> struct xGlobals * xglobals;
    // -> static float sLaunchBlurFadeOutTime;
    // -> static float sLaunchBlurAlpha;
...
// Range: 0x80204598 -> 0x80204764
// this: r29
unsigned char zLaunch::CheckPlayer(struct zCommonPlayer * player /* r30 */, float & maxAlpha /* r27 */, float & yaw /* r28 */, float & yawDiff /* r31 */) {
    // Local variables
    float newAlpha; // f31
    struct xVec3 disp; // r1+0x8
    float len2; // f30
    unsigned char inRange; // r26

    // References
    // -> static float sMaxDrawDist2;
    // -> static float sLaunchMaxDist2;
    // -> static float sMinDrawAlpha;
    // -> static float sMaxDrawAlpha;
    // -> static float sLaunchHalfYawRange;
}

// total size: 0x4
struct /* @class$2082zInteraction_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2083zInteraction_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2084zInteraction_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2081zInteraction_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2086zInteraction_cpp */ {
    // Members
...
// Range: 0x80204764 -> 0x802047C0
// this: r31
void zLaunch::WindupGrab() {}

// Range: 0x802047C0 -> 0x80204C60
// this: r31
void zLaunch::Update(float dt /* f30 */) {
    // Local variables
    struct zLaunchAsset * asset; // r28
    struct xAnimSingle * playerSingle; // r30
    float newAlpha; // r1+0x10
    int i; // r29
    float yaw; // r1+0xC
    float yawDiff; // r1+0x8
    float factor; // f29
    float currYaw; // f25
    float reelInBegin; // f28
    float alphaDiff; // f31
    float maxUp; // f27
    float maxDown; // f26

    // References
    // -> static float sAlphaDownRate;
    // -> static float sAlphaUpRate;
    // -> static float sLaunchReelInBeginBounce;
    // -> static float sLaunchReelInBeginPull;
    // -> struct xGlobals * xglobals;
}
...
// Range: 0x80204C60 -> 0x80204DF4
// this: r31
void zLaunch::Render() {
    // Local variables
    struct xMat4x3 mat; // r1+0x20
    struct xColor_tag color; // r1+0x1C

    // References
    // -> static float sLogoAngle;
}

// Range: 0x80204DF4 -> 0x80204E7C
// this: r31
void zLaunch::EarlyQuit() {}

// Range: 0x80204E7C -> 0x80204FF8
// this: r31
void zLaunch::GotoLiftState() {
    // Local variables
    struct zLaunchAsset * asset; // r30
    float peak; // f31
    float peakTime; // f30
    float fallTime; // f28
    float airTime; // f29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D6459C
// Range: 0x80204FF8 -> 0x8020511C
void zLaunch::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
...
// Range: 0x8020511C -> 0x802051C8
// this: r31
void zLaunch::EventCB(unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    struct zLaunchAsset * asset; // r1+0xC
}

// Range: 0x802051C8 -> 0x8020528C
static unsigned int zLaunch_PlayGrab(void * object /* r1+0x8 */) {
    // Local variables
    int i; // r30
    struct zCommonPlayer * commonPlayer; // r31
...
// Range: 0x8020528C -> 0x80205350
static unsigned int zLaunch_PlayLaunch(void * object /* r1+0x8 */) {
    // Local variables
    int i; // r30
    struct zCommonPlayer * commonPlayer; // r31
    class zLaunch * launch; // r29
...
// Range: 0x80205350 -> 0x80205434
static void MatchPlayerSpeed(struct xAnimSingle * anim /* r29 */, void * object /* r27 */, const char * name /* r1+0x8 */) {
    // Local variables
    struct xEnt * ent; // r1+0xC
    int i; // r28
    struct zCommonPlayer * commonPlayer; // r31
    struct xAnimSingle * playerSingle; // r30
...
// Range: 0x80205434 -> 0x80205470
static void zLaunch_MatchGrabCB(struct xAnimSingle * anim /* r1+0x8 */, void * object /* r1+0xC */) {}

// Range: 0x80205470 -> 0x802054AC
static void zLaunch_MatchGrabIdleCB(struct xAnimSingle * anim /* r1+0x8 */, void * object /* r1+0xC */) {}

// Range: 0x802054AC -> 0x802054E8
static void zLaunch_LaunchStateCB(struct xAnimSingle * anim /* r1+0x8 */, void * object /* r1+0xC */) {}

// Range: 0x802054E8 -> 0x802055A0
static unsigned int zLaunch_AbortLaunch(void * object /* r1+0x8 */) {
    // Local variables
    struct zCommonPlayer * commonPlayer; // r1+0xC
    int i; // r30
    struct zCommonPlayer * commonPlayer; // r31
    class zLaunch * launch; // r29
...
// Range: 0x802055A0 -> 0x802055C8
static unsigned int zLaunch_StartCB(void * object /* r5 */) {
    // Local variables
    struct xEnt * ent; // r31
}

// Range: 0x802055C8 -> 0x802055F0
static unsigned int zLaunch_StopCB(void * object /* r5 */) {
    // Local variables
    struct xEnt * ent; // r31
}

// Range: 0x802055F0 -> 0x802059AC
struct xAnimTable * zLaunch::CreateAnimTable() {
    // Local variables
    struct xAnimTable * table; // r31
}
