/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zLightning.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017B970 -> 0x8017EE10
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct /* @class$1938zLightning_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1264zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1402zLightning_cpp */ {
    // Members
...
static struct zLightning * sLightning; // size: 0x4, address: 0x80D6A548
// total size: 0x14
struct xPECircle {
    // Members
...
static struct RwRaster * sLightningRaster; // size: 0x4, address: 0x80D6A54C
static struct RwRaster * sLightningRasterBranch; // size: 0x4, address: 0x80D6A550
static struct RwTexture * sLightningParticleRaster; // size: 0x4, address: 0x80D6A554
float LIGHTNING_FADE_DIST; // size: 0x4, address: 0x80D62F60
float LIGHTNING_CULL_DIST; // size: 0x4, address: 0x80D62F64
float LIGHTNING_FADE_DIST_SQR; // size: 0x4, address: 0x80D6A558
float LIGHTNING_CULL_DIST_SQR; // size: 0x4, address: 0x80D6A55C
// total size: 0x20
struct xFuncPiece {
    // Members
...
static struct xFuncPiece sLFuncX[10]; // size: 0x140, address: 0x80CF4A60
static struct xFuncPiece sLFuncY[10]; // size: 0x140, address: 0x80CF4BA0
static struct xFuncPiece sLFuncZ[10]; // size: 0x140, address: 0x80CF4CE0
static struct xVec3 sLFuncVal[10]; // size: 0x78, address: 0x80CF4E20
static struct xVec3 sLFuncSlope[10][2]; // size: 0xF0, address: 0x80CF4E98
static float sLFuncEnd[10]; // size: 0x28, address: 0x80CF4F88
static float sLFuncJerkFreq; // size: 0x4, address: 0x80D62F68
static float sLFuncJerkTime; // size: 0x4, address: 0x80D6A560
static float sLFuncShift; // size: 0x4, address: 0x80D62F6C
static float sLFuncMinScale; // size: 0x4, address: 0x80D62F70
static float sLFuncMaxScale; // size: 0x4, address: 0x80D62F74
static float sLFuncScalePerLength; // size: 0x4, address: 0x80D62F78
static float sLFuncMinSpan; // size: 0x4, address: 0x80D62F7C
static float sLFuncSpanPerLength; // size: 0x4, address: 0x80D62F80
static float sLFuncSlopeRange; // size: 0x4, address: 0x80D62F84
static float sLFuncUVSpeed; // size: 0x4, address: 0x80D62F88
static float sLFuncUVOffset; // size: 0x4, address: 0x80D6A564
static int sNumStrips; // size: 0x4, address: 0x80D62F8C
// total size: 0x20
...
struct zLightningFuncPiece sLFuncNew[11]; // size: 0x160, address: 0x80CF4FB0
// total size: 0x68
...
struct _tagLightningAdd gLightningTweakAddInfo; // size: 0x68, address: 0x80CF5110
// total size: 0xC
struct xVec3 {
    // Static members
...
static struct xVec3 sTweakStart; // size: 0xC, address: 0x80D6A568
static struct xVec3 sTweakEnd; // size: 0xC, address: 0x80D6A574
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$882zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$883zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$884zLightning_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$885zLightning_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$886zLightning_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$887zLightning_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$888zLightning_cpp */ {
    // Members
...
static struct tweak_callback sLightningStartCB; // size: 0x28, address: 0x80CF5178
// total size: 0x20
...
struct CollisionInfo collisionInfo; // size: 0x20, address: 0x80CF51A0
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D62F90
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8017B970 -> 0x8017BB1C
void zLightningWidget::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x8017BB1C -> 0x8017BB84
// this: r31
void zLightningWidget::Init(struct zLightningAsset * a /* r30 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D62F95
// Range: 0x8017BB84 -> 0x8017BE2C
void zLightningWidget::EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    class zLightningWidget & lightningWidget; // r31
...
// total size: 0x10
struct /* @class$946zLightning_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1994zLightning_cpp */ {
    // Static members
...
struct xVec3 * posArray; // size: 0x4, address: 0x80D6A580
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D62F9D
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8017C420 -> 0x8017CA00
void zLightningInit() {
    // Local variables
    int i; // r31
    int j; // r30
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D62FAC
// Range: 0x8017CAA8 -> 0x8017CB98
static struct zLightning * FindFreeLightning(unsigned int flags /* r28 */) {
    // Local variables
    int start; // r30
    int end; // r29
    int i; // r31
...
// Range: 0x8017CB98 -> 0x8017CBCC
struct zLightning * zLightningAdd(struct _tagLightningAdd * add /* r31 */) {}

static float defaultWeightParam[4][12]; // size: 0xC0, address: 0x8051F448
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D62FBE
// Range: 0x8017CBCC -> 0x8017D014
struct zLightning * _zLightningAdd(struct _tagLightningAdd * add /* r30 */) {
    // Local variables
    struct zLightning * l; // r31
    struct RwTexture * tex; // r29
    unsigned int taperIdx; // r28
...
static unsigned char done; // size: 0x1, address: 0x80D6A584
static signed char init; // size: 0x1, address: 0x80D6A585
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051F508
// total size: 0x18
...
// Range: 0x8017D790 -> 0x8017E4FC
static void zLightningFunc_Render(struct zLightning * l /* r31 */) {
    // Local variables
    float percent; // f31
    float pstep; // f30
    struct xVec3 val[2]; // r1+0xFC
    struct xVec3 lastPos; // r1+0xD8
    struct xVec3 currPos; // r1+0xCC
    int i; // r27
    float distanceFade; // r1+0x74
    struct xVec3 drawPos; // r1+0xC0
    struct xVec3 drawAxis[2]; // r1+0xE4
    struct RxObjSpace3DVertex * verts0; // r30
    unsigned int numVerts; // r29
    int u; // r23
    unsigned char aVal; // r25
    int lastSeg; // r1+0x70
    int seg; // r1+0x6C
    float pstep2; // f25
    float pstep3; // f23
    ...
    float w1funcB; // f22
    float w1funcC; // f21
    float w1funcD; // r1+0x68
    float w1funcEnd; // r1+0x64
    float _scl; // r1+0x60
    float _scl1; // r1+0x5C
    float _scl2; // r1+0x58
    float _scl3; // f20
    ...
    float w2funcB; // f19
    float w2funcC; // f18
    float w2funcD; // r1+0x54
    float w2funcEnd; // r1+0x50
    float _scl; // r1+0x4C
    float _scl1; // r1+0x48
    float _scl2; // r1+0x44
    float _scl3; // r1+0x40
    float wsumfunc; // f24
    float wsumfuncB; // r1+0x3C
    float wsumfuncC; // r1+0x38
    float wsumfuncD; // r1+0x34
    float wsumfuncEnd; // r1+0x30
    float _scl; // r1+0x2C
    float _scl1; // r1+0x28
    float _scl2; // r1+0x24
    float _scl3; // r1+0x20
    unsigned char isFinishLoop; // r22
    char tempString[128]; // r1+0x114
    float fParam; // f29
    int iParam; // r26
    struct zLightningFuncPiece * piece; // r28
    float alpha; // f26
    struct xVec3 dir; // r1+0xB4
    float scale; // r1+0x1C
    struct xVec3 dir; // r1+0xA8
    struct RwV3d tmp; // r1+0x9C
    struct RwRGBA col; // r1+0x18
    struct RwV3d tmp; // r1+0x90
    struct RwRGBA col; // r1+0x14
    struct RwV3d packed; // r1+0x84
    struct RwV3d packed; // r1+0x78
    unsigned int vidx; // r24
...
// Range: 0x8017E4FC -> 0x8017E6A0
unsigned char zLightningCull(struct zLightning * l /* r31 */, float & distanceFade /* r29 */) {
    // Local variables
...
// Range: 0x8017E8E0 -> 0x8017E908
void zLightningKill(struct zLightning * l /* r1+0x8 */) {}

// Range: 0x8017E908 -> 0x8017E960
void _zLightningKill(struct zLightning * l /* r31 */) {}

// Range: 0x8017E960 -> 0x8017E99C
void zLightningModifyEndpoints(struct zLightning * l /* r1+0x8 */, const struct xVec3 * start /* r1+0xC */, const struct xVec3 * end /* r1+0x10 */) {
    // References
    // -> static float sLFuncScalePerLength;
}

// Range: 0x8017E99C -> 0x8017EAC8
void zLightningModifyEndpoints(struct zLightning * l /* r31 */, const struct xVec3 * start /* r1+0x8 */, const struct xVec3 * end /* r30 */, float scalePerLength /* r1+0xC */) {
    // References
    // -> static float sLFuncMinSpan;
    // -> static float sLFuncSpanPerLength;
    // -> static float sLFuncMaxScale;
...
// Range: 0x8017EAC8 -> 0x8017EBD0
void zLightningCollision(struct zLightning * l /* r31 */, struct xVec3 & start /* r30 */, struct xVec3 & end /* r1+0x10 */) {
    // Local variables
    struct xBound bound; // r1+0x60
...
// Range: 0x8017EBD0 -> 0x8017ECC4
void zLightningCollide(const struct xBound & bound /* r1+0x8 */) {
    // Local variables
    int i; // r31
    unsigned char onLedge; // r1+0xC
    struct xSphere * player_spheres[5]; // r1+0x10
    int num_spheres; // r28
    unsigned char hitIt; // r29
    int j; // r30
...
// Range: 0x8017ECC4 -> 0x8017EE10
unsigned char zLightningCollisionCB(struct xEnt & ent /* r1+0x10 */) {
    // Local variables
