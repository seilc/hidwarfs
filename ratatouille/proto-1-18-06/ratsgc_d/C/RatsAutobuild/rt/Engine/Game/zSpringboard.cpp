/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSpringboard.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802DE79C -> 0x802DF5A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float SMALL_LAUNCH_HEIGHT; // size: 0x4, address: 0x80D66BD8
static float SIZE_SPACING; // size: 0x4, address: 0x80D66BDC
static float TOP_DIST_MAX; // size: 0x4, address: 0x80D66BE0
static float NORMAL_COS; // size: 0x4, address: 0x80D66BE4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$919zSpringboard_cpp */ {
    // Members
...
union /* @class$1067zSpringboard_cpp */ {
...
// total size: 0xC
struct /* @class$1066zSpringboard_cpp */ {
    // Members
...
// Range: 0x802DE79C -> 0x802DE7EC
static void GenericEntRender(struct xEnt * ent /* r31 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66BE8
// total size: 0x10
...
class zSpringboard : public xEnt {
    ...
    unsigned int ChargeboardCheck();

    unsigned int CompressedCB();

    void EventCB(unsigned int toEvent);

    void Reset();

    zSpringboard(struct zSpringboardAsset * theAsset);

    void GetLaunchVelocity(struct xVec3 & vel);

    unsigned char Mount(const struct SphereCollisionResults & results);
...
// Range: 0x802DE7EC -> 0x802DE8C4
// this: r31
void zSpringboard::Launch() {
    // References
    // -> static char __FUNCTION__[7];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D66BEF
// Range: 0x802DE8C4 -> 0x802DE954
// this: r31
void zSpringboard::Compress() {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x802DE954 -> 0x802DE96C
// this: r3
unsigned int zSpringboard::CompressCheck() {}

// Range: 0x802DE96C -> 0x802DE97C
// this: r3
unsigned int zSpringboard::IdleCB() {}

// Range: 0x802DE97C -> 0x802DE994
// this: r3
unsigned int zSpringboard::LaunchCheck() {}

// Range: 0x802DE994 -> 0x802DE9A4
// this: r3
unsigned int zSpringboard::LaunchCB() {}

// Range: 0x802DE9A4 -> 0x802DE9C4
// this: r3
unsigned int zSpringboard::ChargeboardCheck() {}

// Range: 0x802DE9C4 -> 0x802DE9D4
// this: r3
unsigned int zSpringboard::CompressedCB() {}

// Range: 0x802DE9D4 -> 0x802DED90
struct xAnimTable * zSpringboard::CreateAnimTable() {
    // Local variables
    struct xAnimTable * table; // r31
}

// Range: 0x802DED90 -> 0x802DEDCC
// this: r1+0x8
void zSpringboard::EventCB(unsigned int toEvent /* r1+0xC */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66BF8
// Range: 0x802DEDCC -> 0x802DEE90
void zSpringboard::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r31 */, unsigned int toEvent /* r30 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // References
...
// Range: 0x802DEE90 -> 0x802DEF14
// this: r31
void zSpringboard::Reset() {
    // Local variables
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80D2D588
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1315zSpringboard_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1812zSpringboard_cpp */ {
    // Static members
...
// Range: 0x802DEF14 -> 0x802DF13C
// this: r31
zSpringboard::zSpringboard(struct zSpringboardAsset * theAsset /* r1+0x8 */) {
    // Local variables
    unsigned int assetID; // r30
    unsigned short size; // r1+0xC
    struct xModelAssetParam * param; // r29
    float angleRadians; // f31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66C00
// Range: 0x802DF13C -> 0x802DF304
void zSpringboard::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66C05
// Range: 0x802DF304 -> 0x802DF45C
// this: r31
void zSpringboard::GetLaunchVelocity(struct xVec3 & vel /* r30 */) {
    // Local variables
    float height; // f30
    float magnitude; // f31
    ...
    // References
    // -> struct zGlobals globals;
    // -> static float SIZE_SPACING;
    // -> static float SMALL_LAUNCH_HEIGHT;
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D66C17
...
// Range: 0x802DF45C -> 0x802DF5A8
// this: r31
unsigned char zSpringboard::Mount(const struct SphereCollisionResults & results /* r30 */) {
    // Local variables
    ...
    // References
    // -> static float TOP_DIST_MAX;
    // -> static float NORMAL_COS;
