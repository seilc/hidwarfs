/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCamSpline.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B3598 -> 0x802B40E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char yawCorrection; // size: 0x1, address: 0x80D6B548
// total size: 0x270
struct zCamSpline : public xCam, public zCamSplineCommonMix {
    ...
    void UpdateFloorMount(float dt);

    void CalcPitchGoal(const struct xVec3 & fromPos);

    void CalcOrientGoals(const struct xVec3 & fromPos);

    void CalcXOffsetGoal(float rawXOffset);

    void update(float dt);

    void debug_mode_draw();
...
// Range: 0x802B3598 -> 0x802B35CC
// this: r31
void zCamSpline::create() {}

// Range: 0x802B35CC -> 0x802B3604
// this: r31
void zCamSpline::stop() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D66450
float cDefaultCameraSpring; // size: 0x4, address: 0x80D703D8
...
// total size: 0x890
struct /* @class$1949zCamSpline_cpp */ {
    // Static members
...
// Range: 0x802B3604 -> 0x802B3868
// this: r31
void zCamSpline::start() {
    // Local variables
    const struct BeadInfo & bead; // r30
...
// total size: 0xC
struct /* @class$793zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$794zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$795zCamSpline_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$796zCamSpline_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$797zCamSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$798zCamSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$799zCamSpline_cpp */ {
    // Members
...
// Range: 0x802B3868 -> 0x802B386C
void zCamSpline::pre_update() {}

// Range: 0x802B386C -> 0x802B3870
void zCamSpline::post_update() {}

// Range: 0x802B3870 -> 0x802B38B4
// this: r31
void zCamSpline::UpdateFloorMount(float dt /* r1+0x8 */) {}

static struct xVec3 lastProjectedMidpoint; // size: 0xC, address: 0x80D6B54C
// Range: 0x802B38B4 -> 0x802B38F8
static void GetPlayersProjectedMidpoint(struct xVec3 & midpoint /* r31 */) {
    // References
    // -> static struct xVec3 lastProjectedMidpoint;
}

// Range: 0x802B38F8 -> 0x802B3948
static float CalcYawToPlayers(const struct xVec3 & fromPos /* r30 */) {
    // Local variables
    const struct xVec3 & target; // r31
}

// Range: 0x802B3948 -> 0x802B3A04
// this: r31
void zCamSpline::CalcPitchGoal(const struct xVec3 & fromPos /* r30 */) {
    // Local variables
    struct xVec3 target; // r1+0x14
    struct xVec3 toTarget; // r1+0x8
    float distanceToTarget; // f31
}

// total size: 0x18
class xSpringyAngle : public xSpringyF32 {};
// Range: 0x802B3A04 -> 0x802B3A54
// this: r30
void zCamSpline::CalcOrientGoals(const struct xVec3 & fromPos /* r31 */) {}

// Range: 0x802B3A54 -> 0x802B3B14
// this: r31
void zCamSpline::CalcXOffsetGoal(float rawXOffset /* r1+0x8 */) {
    // Local variables
    struct OOBExtent extent; // r1+0xC
}

// Range: 0x802B3B14 -> 0x802B3B74
void zCamSpline::ApplyBeadSettings(const struct BeadInfo & beadInfo /* r31 */) {
    // Local variables
    float nearWall; // r1+0xC
    float farWall; // r1+0x8
}

// Range: 0x802B3B74 -> 0x802B3FD0
// this: r31
void zCamSpline::update(float dt /* f31 */) {
    // Local variables
    class Follower lastGoodFollower; // r1+0x38
    const struct BeadInfo * bead; // r30
    struct OOBExtent extent; // r1+0x8
...
// total size: 0x4
struct /* @class$1099zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1237zCamSpline_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$857zCamSpline_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B3FD0 -> 0x802B405C
// this: r30
void zCamSpline::debug_mode_draw() {
    // Local variables
    const struct BeadInfo & beadValues; // r31
}

// Range: 0x802B405C -> 0x802B40E0
// this: r30
void zCamSpline::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char _buffer[128]; // r1+0x8

    // References
    // -> static unsigned char yawCorrection;
}

// total size: 0x58
struct {} zCamSpline::__vtable; // size: 0x58, address: 0x80526918
// total size: 0x54
