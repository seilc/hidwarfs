/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameRatOnBall.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8031970C -> 0x8031C388
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float ZTACCEL; // size: 0x4, address: 0x80D67720
static float ZTDEPTH; // size: 0x4, address: 0x80D67724
static float RING_RADIUS; // size: 0x4, address: 0x80D67728
static unsigned int READY_TEX_IDS[3]; // size: 0xC, address: 0x80D6772C
// total size: 0x7C
struct {} zMiniGameRatOnBall::__vtable; // size: 0x7C, address: 0x8052D320
// total size: 0x1C
struct zMiniGameAssetRatOnBall : public zMiniGameAsset {
    // Members
    unsigned int playerSpawnGroupID; // offset 0x14, size 0x4
    unsigned int firstStageID; // offset 0x18, size 0x4
};
// total size: 0x24
struct zMiniGameAssetRatOnBallStage : public zMiniGameAsset {
    // Members
    float timeLimit; // offset 0x14, size 0x4
    unsigned int pickupSpawnGroupID; // offset 0x18, size 0x4
    unsigned int nextStageID; // offset 0x1C, size 0x4
    int stageType; // offset 0x20, size 0x4
};
enum zMiniGameOnionState {
    ezMGOS_On = 0,
    ezMGOS_Shaking = 1,
    ezMGOS_Dropping = 2,
    ezMGOS_Off = 3,
...
union /* @class$1149zMiniGameRatOnBall_cpp */ {
...
// total size: 0xC
struct /* @class$1165zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0xC
struct zMiniGameOnion {
    // Members
    enum zMiniGameOnionState state; // offset 0x0, size 0x4
    float stateTimer; // offset 0x4, size 0x4
    struct xEnt * ent; // offset 0x8, size 0x4
};
// total size: 0x50
...
// total size: 0x2A0
class zMiniGameRatOnBall : public zMiniGameBase {
    // Functions
    zMiniGameRatOnBall(struct zMiniGameAsset * a);

    void StageSetup(unsigned int stageID, unsigned char resetTypes);

    void SceneSetup();

    void GetOnionY(struct xVec3 * inPos);

    void OnionCollisions();

    void TiltStageUpdate(float dt);

    void DropStageUpdate(float dt);

    void GameStartEnter();

    void GameStartUpdate(float dt);

    void ReadySteadyGo();

    void StageStartEnter();

    void StageStartUpdate(float dt);

    unsigned char TestStageWinConditions();

    unsigned char TestGameWinConditions();
    ...
    void SetRespawnPosition(struct xMat4x3 * mat);

    float GetArenaRadius();

    // Members
protected:
    int tiltState; // offset 0x2C, size 0x4
    float tiltTimer; // offset 0x30, size 0x4
    float zT; // offset 0x34, size 0x4
    unsigned char displayInstructions; // offset 0x38, size 0x1
    float displayInstructionsTimer; // offset 0x3C, size 0x4
    unsigned int stageEndSetupStage; // offset 0x40, size 0x4
    class zMiniGamePickupController pickups; // offset 0x50, size 0x1C0
    struct zMiniGameAssetRatOnBall * gameConfig; // offset 0x210, size 0x4
    struct zMiniGameAssetRatOnBallStage * currentStage; // offset 0x214, size 0x4
    float stageTimer; // offset 0x218, size 0x4
    struct zMiniGameOnion onionSlice[7]; // offset 0x21C, size 0x54
    int activeSlices; // offset 0x270, size 0x4
    float dropTimer; // offset 0x274, size 0x4
    float prepScreenTimer; // offset 0x278, size 0x4
    int prepScreenTexIdx; // offset 0x27C, size 0x4
    class zUIImage * msgImage; // offset 0x280, size 0x4
    class zUIImage * uiYouLose; // offset 0x284, size 0x4
    float stageEndTimer; // offset 0x288, size 0x4
    int stageEndState; // offset 0x28C, size 0x4
    class zMiniGameRatOnBallPlayer * stageWinner; // offset 0x290, size 0x4
    int stageWinnerIdx; // offset 0x294, size 0x4
    class zMiniGameRatOnBallPlayer * gameWinner; // offset 0x298, size 0x4
    int gameWinnerIdx; // offset 0x29C, size 0x4
};
// Range: 0x8031970C -> 0x80319760
// this: r31
zMiniGameRatOnBall::zMiniGameRatOnBall(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGameRatOnBall::__vtable;
}

// Range: 0x80319770 -> 0x80319774
void zMiniGameRatOnBall::CreatePlayers() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67738
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1701zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x80319774 -> 0x803199F4
void zMiniGameRatOnBall::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zMiniGameRatOnBall * instance; // r28
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6773D
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x803199F4 -> 0x80319C24
// this: r31
void zMiniGameRatOnBall::StageSetup(unsigned int stageID /* r1+0x8 */, unsigned char resetTypes /* r1+0xC */) {
    // Local variables
    struct xGroup * pickupSpawnGroup; // r28
    int i; // r30
    int i; // r29
    class zMiniGameRatOnBallPlayer * player; // r27
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D67748
// Range: 0x80319C24 -> 0x8031A12C
// this: r31
void zMiniGameRatOnBall::SceneSetup() {
    // Local variables
    unsigned int dispID; // r28
    int i; // r30
    int i; // r29
    char onionName[64]; // r1+0x8
...
// total size: 0x14
struct zRoBPlayerCollision {
    // Members
    class zMiniGameRatOnBallPlayer * ballA; // offset 0x0, size 0x4
    class zMiniGameRatOnBallPlayer * ballB; // offset 0x4, size 0x4
    struct xVec3 normal; // offset 0x8, size 0xC
};
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8031A12C -> 0x8031A5DC
void zMiniGameRatOnBall::PlayerCollisions() {
    // Local variables
    struct zRoBPlayerCollision col[16]; // r1+0xC0
    int totalCol; // r28
    unsigned char skipTest[4][4]; // r1+0xB0
    int i; // r25
    int j; // r26
    int a; // r31
    int b; // r30
    class zMiniGameRatOnBallPlayer * ballA; // r23
    class zMiniGameRatOnBallPlayer * ballB; // r21
    struct xVec3 ballPosA; // r1+0xA4
    struct xVec3 ballPosB; // r1+0x98
    struct xVec3 distVec; // r1+0x8C
    float dist; // f31
    float relativeVelocity; // f30
    struct zRoBPlayerCollision * contact; // r29
    int i; // r22
    class zMiniGameRatOnBallPlayer * ball; // r27
    float VdotN; // f29
    struct xVec3 Vn; // r1+0x80
    struct xVec3 Vt; // r1+0x74
    struct xVec3 Vn1; // r1+0x68
    struct xVec3 btravel; // r1+0x5C
    class zMiniGameRatOnBallPlayer * ball2; // r24
    struct xVec3 btravel2; // r1+0x50
    enum iSndGroupHandle soundGroupHandle; // r20
...
protected:
    ...
    struct xVec3 arenaTiltVec; // offset 0x30, size 0xC
    class zMiniGameRatOnBallPlayer * ourPlayer; // offset 0x3C, size 0x4
};
// total size: 0x58
struct config {
    // Members
...
// total size: 0x18
class zMiniGameRatOnBallAI {
    // Members
protected:
    class zMiniGameRatOnBallPlayer * ourPlayer; // offset 0x0, size 0x4
    class zMiniGameRatOnBallPlayer * target; // offset 0x4, size 0x4
    float reevaluateTargetTimer; // offset 0x8, size 0x4
    float aiTurboAngle; // offset 0xC, size 0x4
    float aiTurboChance; // offset 0x10, size 0x4
    float aiTurboDistance; // offset 0x14, size 0x4
};
// total size: 0xC
struct /* @class$1976zMiniGameRatOnBall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$873zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$874zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$875zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$876zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$877zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$878zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$879zMiniGameRatOnBall_cpp */ {
    // Members
...
public:
    int type; // offset 0x0, size 0x4
    int need; // offset 0x4, size 0x4
    struct zParticleGenerator * * generators; // offset 0x8, size 0x4
    int generators_size; // offset 0xC, size 0x4
    int generators_active; // offset 0x10, size 0x4
    void * __vptr$; // offset 0x14, size 0x4
    const char * name; // offset 0x18, size 0x4
};
// total size: 0xA4
struct zParticleGenerator : public xBase {
    // Members
    struct zParticleAsset * asset; // offset 0x10, size 0x4
    int flags; // offset 0x14, size 0x4
    float lifetime; // offset 0x18, size 0x4
    void * __vptr$; // offset 0x1C, size 0x4
protected:
    char tweakPrefix[128]; // offset 0x20, size 0x80
private:
    struct debug_info * debug; // offset 0xA0, size 0x4
};
...
class xParticleBatchGroup {
    ...
    int elements_size; // offset 0x4, size 0x4
};
// total size: 0x24
class zParticleSystemEarthDust : public zParticleSystem {
    // Members
    class xParticleBatchGroup batch_group; // offset 0x1C, size 0x8
};
// total size: 0x0
...
struct debug {
    // Members
    int attemptedEmit; // offset 0x0, size 0x4
    int failedEmit; // offset 0x4, size 0x4
};
// total size: 0xD4
struct zParticleGeneratorEarthDust : public zParticleGenerator {
    // Members
protected:
    class zParticleSystemEarthDust * system; // offset 0xA4, size 0x4
    struct xEnt * attach_to; // offset 0xA8, size 0x4
    float emitted; // offset 0xAC, size 0x4
    class zParticleLocator locator; // offset 0xB0, size 0xC
    int batch_id; // offset 0xBC, size 0x4
    float shrapEmitted; // offset 0xC0, size 0x4
    struct zShrapnelAsset * shrapAsset; // offset 0xC4, size 0x4
    struct xModelInstance * tempModel; // offset 0xC8, size 0x4
    struct debug debugInfo; // offset 0xCC, size 0x8
};
// total size: 0x14D0
class zMiniGameRatOnBallPlayer : public zMiniGamePlayer {
    // Members
protected:
    struct xModelInstance * ballModel; // offset 0x13B0, size 0x4
public:
    float turbo_emit_remaining; // offset 0x13B4, size 0x4
    struct config turbo_config; // offset 0x13B8, size 0x58
protected:
    float respawnTimer; // offset 0x1410, size 0x4
    int lifeState; // offset 0x1414, size 0x4
    class zRatOnBallForces forces; // offset 0x1418, size 0x40
    float turboTimer; // offset 0x1458, size 0x4
    class zMiniGameRatOnBallAI ai; // offset 0x145C, size 0x18
    int lives; // offset 0x1474, size 0x4
    class zUIImage * uiImage[9]; // offset 0x1478, size 0x24
    class zUIImage * uiMarker; // offset 0x149C, size 0x4
    class zUIImage * uiStagesWon[3]; // offset 0x14A0, size 0xC
    class zUIImage * uiWinner; // offset 0x14AC, size 0x4
    int stagesWon; // offset 0x14B0, size 0x4
    float markerTimer; // offset 0x14B4, size 0x4
    struct zParticleGeneratorEarthDust * deathPGen; // offset 0x14B8, size 0x4
    float deathPGenTimer; // offset 0x14BC, size 0x4
    unsigned char deathPGenOn; // offset 0x14C0, size 0x1
};
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8031A5DC -> 0x8031A8D4
// this: r30
void zMiniGameRatOnBall::GetOnionY(struct xVec3 * inPos /* r31 */) {
    // Local variables
    struct xMat3x3 mat; // r1+0x40
    struct xVec3 v1; // r1+0x34
    struct xVec3 v2; // r1+0x28
    struct xVec3 v3; // r1+0x1C
    struct xVec3 v4; // r1+0x10
    float A; // f29
    float B; // f28
    float C; // f27
    float D; // f25
...
// Range: 0x8031A8D4 -> 0x8031AC58
// this: r29
void zMiniGameRatOnBall::OnionCollisions() {
    // Local variables
    int i; // r30
    struct xMat3x3 mat; // r1+0x40
    struct xVec3 v1; // r1+0x34
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D67753
// Range: 0x8031AC58 -> 0x8031ADDC
// this: r31
void zMiniGameRatOnBall::TiltStageUpdate(float dt /* f30 */) {
    // Local variables
    float accel; // f31

    // References
    // -> static char __FUNCTION__[16];
    // -> static float ZTACCEL;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D67763
// Range: 0x8031ADDC -> 0x8031B0CC
// this: r31
void zMiniGameRatOnBall::DropStageUpdate(float dt /* f31 */) {
    // Local variables
    enum iSndGroupHandle soundGroupHandle; // r29
    int i; // r30
    struct xVec3 * pos; // r28
    enum iSndGroupHandle soundGroupHandle; // r27
    struct xVec3 * pos; // r26

    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x8031B0CC -> 0x8031B154
void zMiniGameRatOnBall::ShowRatsAndHUD() {
    // Local variables
    int i; // r31
    class zMiniGameRatOnBallPlayer * player; // r30
...
// Range: 0x8031B154 -> 0x8031B200
// this: r29
void zMiniGameRatOnBall::GameStartEnter() {
    // Local variables
    int i; // r31
    class zMiniGameRatOnBallPlayer * pplayer; // r28
    class zUIController * uic; // r30

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8031B200 -> 0x8031B2D4
// this: r31
void zMiniGameRatOnBall::GameStartUpdate(float dt /* r1+0x8 */) {
    // Local variables
    class zUIController * uic; // r30
}

// Range: 0x8031B2D4 -> 0x8031B388
// this: r31
void zMiniGameRatOnBall::ReadySteadyGo() {
    // Local variables
    enum iSndGroupHandle soundGroupHandle; // r30

    // References
    // -> static unsigned int READY_TEX_IDS[3];
}

// Range: 0x8031B388 -> 0x8031B3C0
// this: r31
void zMiniGameRatOnBall::StageStartEnter() {}

// Range: 0x8031B3C0 -> 0x8031B528
// this: r31
void zMiniGameRatOnBall::StageStartUpdate(float dt /* r1+0x8 */) {
    // Local variables
    enum iSndGroupHandle soundGroupHandle; // r30
    enum iSndGroupHandle soundGroupHandle; // r29
...
// Range: 0x8031B528 -> 0x8031B5E4
// this: r31
unsigned char zMiniGameRatOnBall::TestStageWinConditions() {
    // Local variables
    int totalAlive; // r29
    unsigned char humanAlive; // r27
    int i; // r30
    class zMiniGameRatOnBallPlayer * player; // r28
...
// total size: 0x13B0
class zMiniGamePlayer : public zPlayer {
    // Members
protected:
    int activePickupType; // offset 0x13A0, size 0x4
    float activePickupTimer; // offset 0x13A4, size 0x4
    unsigned char isAI; // offset 0x13A8, size 0x1
};
// Range: 0x8031B5E4 -> 0x8031B690
// this: r31
unsigned char zMiniGameRatOnBall::TestGameWinConditions() {
    // Local variables
    int i; // r30
    class zMiniGameRatOnBallPlayer * player; // r29

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8031B690 -> 0x8031B720
unsigned char zMiniGameRatOnBall::TestStageLoseConditions() {
    // Local variables
    unsigned char humanAlive; // r1+0x8
    int i; // r31
    class zMiniGameRatOnBallPlayer * player; // r30
...
// Range: 0x8031B720 -> 0x8031B780
void zMiniGameRatOnBall::GamePlayEnter() {
    // Local variables
    int i; // r31
    class zMiniGameRatOnBallPlayer * player; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D67773
// Range: 0x8031B780 -> 0x8031BCCC
// this: r31
void zMiniGameRatOnBall::GamePlayUpdate(float dt /* f31 */) {
    // Local variables
    class zPad * pad; // r24
    int i; // r28
    class zMiniGameRatOnBallPlayer * player; // r23
    float zAngle; // f29
    struct xMat3x3 rotMat; // r1+0x30
    int i; // r27
    struct xVec3 tilt; // r1+0x20
    int i; // r26
    struct xVec3 * pickupPos; // r30
    float dist2; // f28
    float arenaRadius; // f30
    int i; // r29
    int grabbedPickup; // r1+0x10
    int i; // r25

    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[15];
    // -> static float ZTDEPTH;
}
...
// total size: 0x14
struct zMiniGamePickupType {
    // Members
    int id; // offset 0x0, size 0x4
    float likelyhood; // offset 0x4, size 0x4
    float activeTime; // offset 0x8, size 0x4
    unsigned int soundID; // offset 0xC, size 0x4
    unsigned int modelID; // offset 0x10, size 0x4
};
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$932zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0x50
struct zMiniGamePickupAvailable {
    // Members
    int idx; // offset 0x0, size 0x4
    struct xModelInstance * modelInstance; // offset 0x4, size 0x4
    struct xMat4x3 position; // offset 0x10, size 0x40
};
// total size: 0x1C0
class zMiniGamePickupController {
    // Members
protected:
    int state; // offset 0x0, size 0x4
    float initialSpawnTime; // offset 0x4, size 0x4
    float currentSpawnTime; // offset 0x8, size 0x4
    float initialShowTime; // offset 0xC, size 0x4
    float currentShowTime; // offset 0x10, size 0x4
    struct xGroup * spawnGroup; // offset 0x14, size 0x4
    struct zMiniGamePickupType type[16]; // offset 0x18, size 0x140
    int typeCount; // offset 0x158, size 0x4
    struct zMiniGamePickupAvailable available; // offset 0x160, size 0x50
public:
    void * __vptr$; // offset 0x1B0, size 0x4
};
// total size: 0xDC
...
// total size: 0x890
struct /* @class$1944zMiniGameRatOnBall_cpp */ {
    // Static members
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D67782
// Range: 0x8031BCCC -> 0x8031BE08
// this: r31
void zMiniGameRatOnBall::StageEndEnter() {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D67790
// Range: 0x8031BE08 -> 0x8031BF18
// this: r31
void zMiniGameRatOnBall::StageEndExit() {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6779D
// Range: 0x8031BF18 -> 0x8031C040
// this: r31
void zMiniGameRatOnBall::StageEndUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8031C040 -> 0x8031C084
// this: r31
void zMiniGameRatOnBall::GameEndEnter() {}

// Range: 0x8031C084 -> 0x8031C0B0
// this: r1+0x8
void zMiniGameRatOnBall::GameEndUpdate() {}

// Range: 0x8031C0B0 -> 0x8031C0E8
// this: r1+0x8
void zMiniGameRatOnBall::Render() {}

// Range: 0x8031C0E8 -> 0x8031C120
// this: r1+0x8
void zMiniGameRatOnBall::Reset() {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D677AC
// total size: 0x28
...
// Range: 0x8031C120 -> 0x8031C250
// this: r28
void zMiniGameRatOnBall::SetRespawnPosition(struct xMat4x3 * mat /* r29 */) {
    // Local variables
    struct xGroup * grp; // r30
    struct pointer_asset * pointer; // r31

    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x8031C250 -> 0x8031C2C8
// this: r3
float zMiniGameRatOnBall::GetArenaRadius() {
    // Local variables
    float arenaRadius[7]; // r1+0x8
    float radius; // f31
}

// Range: 0x8031C2C8 -> 0x8031C2D0
float zMiniGameRatOnBall::GetArenaBufferRadius() {}

// Range: 0x8031C2D0 -> 0x8031C388
void zMiniGameRatOnBall::AddTweaks(const char * prefix /* r31 */) {
    // References
    // -> static float RING_RADIUS;
    // -> static float ZTDEPTH;
    // -> static float ZTACCEL;
}
