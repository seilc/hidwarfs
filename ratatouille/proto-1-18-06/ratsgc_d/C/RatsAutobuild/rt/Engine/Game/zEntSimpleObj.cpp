/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEntSimpleObj.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8014F9E4 -> 0x80152680
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int sMgrCount; // size: 0x4, address: 0x80D6A028
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
union /* @class$601zEntSimpleObj_cpp */ {
...
// total size: 0xC
struct /* @class$1053zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$889zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2206zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$830zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833zEntSimpleObj_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zEntSimpleObj_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zEntSimpleObj_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zEntSimpleObj_cpp */ {
    // Members
...
static struct zSimpleMgr * sMgrList; // size: 0x4, address: 0x80D6A02C
static unsigned int sSimpleCustomCount; // size: 0x4, address: 0x80D6A030
static struct xEnt * * sSimpleCustomList; // size: 0x4, address: 0x80D6A034
// Range: 0x8014F9E4 -> 0x8014FA68
static void CollisionReset(struct zEntSimpleObj * ent /* r3 */) {}

// Range: 0x8014FA68 -> 0x8014FAA4
static void CollisionOn(struct zEntSimpleObj * ent /* r3 */) {}
...
// Range: 0x8014FAA4 -> 0x8014FB34
static int CmpSimpleMgr(void * a /* r1+0x8 */, void * b /* r1+0xC */) {
    // Local variables
    const struct zSimpleMgr * simpA; // r31
    const struct zSimpleMgr * simpB; // r30
    struct xLightKitBlendInfo blendInfoA; // r1+0x1C
    struct xLightKitBlendInfo blendInfoB; // r1+0x10
}

// Range: 0x8014FB34 -> 0x8014FBB8
static void VisUpdateSimpleMgr(struct xEnt * ent /* r30 */) {
    // Local variables
    struct zEntSimpleObj * simpent; // r31
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x8051D7F8
...
// total size: 0x10
struct /* @class$1893zEntSimpleObj_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8014FBB8 -> 0x80150828
void zEntSimpleObj_MgrInit(struct zEntSimpleObj * * entList /* r31 */, unsigned int entCount /* r25 */) {
    // Local variables
    unsigned int i; // r30
    unsigned int reactiveExtras; // r1+0x28
    unsigned int modelsRequired; // r20
    struct zEntSimpleObj * * tempEntList; // r27
    unsigned int tempEntCount; // r24
    unsigned int custEntCount; // r23
    struct zEntSimpleObj * ent; // r26
    float dt; // f29
    float duration; // f26
    int frameCount; // r1+0x24
    int boneCount; // r1+0x20
    struct xQuat * q0; // r19
    struct xVec3 * t0; // r1+0x1C
    float t; // f30
    struct RwMatrixTag * fastMatList; // r18
    int i; // r17
    struct zSimpleMgr * smgr; // r29
    struct RpAtomic * model; // r22
    struct RwSphere oldbound; // r1+0x2C
    struct zLODTable * lod; // r28
    float distscale; // f31
    unsigned char uvAnimated; // r1+0xD
    unsigned char modelFlags; // r21

    // References
    // -> void * RwEngineInstance;
    // -> static unsigned int sMgrCount;
    // -> static struct zSimpleMgr * sMgrList;
    // -> struct zGlobals globals;
    // -> static char __FUNCTION__[22];
    // -> unsigned int gActiveHeap;
    // -> static struct xEnt * * sSimpleCustomList;
    // -> static unsigned int sSimpleCustomCount;
...
static unsigned int check_ent_id; // size: 0x4, address: 0x80D6A038
static signed char init; // size: 0x1, address: 0x80D6A03C
...
// Range: 0x80150828 -> 0x80150C38
void zEntSimpleObj_MgrUpdateRender(float dt /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r27
    unsigned int currPipeFlags; // r30
    unsigned int pipeMask; // r26
    enum RwFogType oldfogtype; // r20
    float camX; // f30
    float camY; // f29
    float camZ; // f28
    struct zSimpleMgr * smgr; // r31
    int asdf; // r1+0x10
    int asdf; // r1+0xC
    unsigned int smgrFlags; // r25
    float camdist2; // f31
    struct zEntSimpleObj * ent; // r29
    unsigned int testPipeFlags; // r21
    unsigned int xorFlags; // r24
    int picklod; // r23
    struct xModelInstance * minst; // r28
    struct RpAtomic * modelData; // r22
...
static unsigned int check_ent_id; // size: 0x4, address: 0x80D6A040
static signed char init; // size: 0x1, address: 0x80D6A044
// Range: 0x80150C38 -> 0x80150CEC
void zEntSimpleObj_MgrCustomUpdate(struct zScene * s /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    unsigned int i; // r31
    int asdf; // r1+0x10
...
static unsigned int check_ent_id; // size: 0x4, address: 0x80D6A048
static signed char init; // size: 0x1, address: 0x80D6A04C
// Range: 0x80150CEC -> 0x80150D90
...
// Range: 0x80150D90 -> 0x80150DE0
static void zEntSimpleObj_Render(struct xEnt * ent /* r31 */) {}

// Range: 0x80150DE0 -> 0x80150E18
void zEntTrackPhysics_Init(void * ent /* r1+0x8 */, void * asset /* r1+0xC */) {}

// Range: 0x80150E18 -> 0x80150E50
void zEntSimpleObj_Init(void * ent /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D62750
// Range: 0x80150E50 -> 0x801512F4
void zEntSimpleObj_Init(struct zEntSimpleObj * ent /* r31 */, struct xEntAsset * asset /* r30 */, unsigned char physparams /* r22 */, unsigned char candestroy /* r1+0x8 */) {
    // Local variables
    struct xSimpleObjAsset * sasset; // r26
    unsigned int tmpsize; // r1+0x10
    struct RpAtomic * modelData; // r25
    void * animData; // r29
    unsigned int animBoneCount; // r24
    const char * name1; // r28
    const char * name2; // r27
    unsigned int size; // r1+0xC
    unsigned int newid; // r23
    struct xDestructibleAsset * destruct; // r21

    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x801512F4 -> 0x801512F8
static void zEntSimpleObj_Move() {}

// Range: 0x801512F8 -> 0x80151334
void zEntSimpleObj_CustomMove(struct xEnt * ent /* r31 */, struct xEntFrame * frame /* r1+0x8 */) {}

// Range: 0x80151334 -> 0x801514F0
void zEntSimpleObj_Update(struct zEntSimpleObj * ent /* r31 */, struct xScene * sc /* r26 */, float dt /* f31 */) {
    // Local variables
    unsigned char use_world_up; // r29
    float duration; // f30
    struct xQuat * q0; // r30
    struct xVec3 * t0; // r28
...
// total size: 0x890
struct /* @class$2136zEntSimpleObj_cpp */ {
    // Static members
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62763
// Range: 0x801514F0 -> 0x801515B8
void zEntSimpleObj_Setup(struct zEntSimpleObj * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D62777
// Range: 0x801515B8 -> 0x801516A8
void zEntSimpleObj_Save(struct zEntSimpleObj * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6278A
// Range: 0x801516A8 -> 0x80151798
void zEntSimpleObj_Load(struct zEntSimpleObj * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x80151798 -> 0x801517EC
void zEntSimpleObj_ReReset(struct zEntSimpleObj * ent /* r31 */) {
    // Local variables
    unsigned int size; // r1+0x8
}

static unsigned int entToCheck; // size: 0x4, address: 0x80D6A050
static signed char init; // size: 0x1, address: 0x80D6A054
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6279D
// Range: 0x801517EC -> 0x80151D70
void zEntSimpleObj_Reset(struct zEntSimpleObj * ent /* r31 */) {
    // Local variables
    int asdf; // r1+0x10
    unsigned int size; // r1+0xC
    struct RpAtomic * imodel; // r26
    struct xLightKit * pLightKit; // r25
    int asdf; // r1+0x8
    struct xSurface * surfaces[32]; // r1+0x14
    int i; // r29
    int j; // r28
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8051D80E
class zLightweightSystem * zLightweight<z::toss, 10>::GetSystem()::system; // size: 0x4, address: 0x80D6A058
signed char zLightweight<z::toss, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6A05C
char __FUNCTION__$localstatic1$Add__32zLightweightSystem<Q21z4toss,10>FRCQ21z4toss[4]; // size: 0x4, address: 0x80D627B1
union FloatAndVoid {
    float f; // offset 0x0, size 0x4
    void * v; // offset 0x0, size 0x4
};
// Range: 0x80151D70 -> 0x80152634
void zEntSimpleObjEventCB(struct xBase * from /* r23 */, struct xBase * to /* r26 */, unsigned int toEvent /* r27 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r28 */, unsigned int toParamWidgetID /* r1+0x8 */) {
    // Local variables
    struct zEntSimpleObj * s; // r31
    struct zShrapnelAsset * shrap; // r29
    union FloatAndVoid dist; // r1+0x14
    struct xVec3 * offset; // r1+0x10
    struct xVec3 * offset; // r1+0xC
    class zMeshCircle * circle; // r25
    class zMeshCircle * circle; // r24
...
class zLightweightSystem : public zLightweightSystemBase {
    // Members
    class toss object[10]; // offset 0x4, size 0x398
    class zLightweightSystem * * system; // offset 0x39C, size 0x4
    unsigned int current_id; // offset 0x3A0, size 0x4
};
// total size: 0x24
struct {} zLightweightSystem<z::toss, 10>::__vtable; // size: 0x24, address: 0x8051D868
// total size: 0x20
struct {} z::toss::__vtable; // size: 0x20, address: 0x80524018
// total size: 0x0
struct pointer_asset {};
// total size: 0x5C
class toss : public zLightweight {
    // Members
    struct xEnt * ent; // offset 0xC, size 0x4
    struct pointer_asset * dest_pointer; // offset 0x10, size 0x4
    float arc_height; // offset 0x14, size 0x4
    float speed; // offset 0x18, size 0x4
    struct xBase * toss_event_sender; // offset 0x1C, size 0x4
    float peakDist; // offset 0x20, size 0x4
    float totalDist; // offset 0x24, size 0x4
    float parabola_scale; // offset 0x28, size 0x4
    struct xVec3 toDest; // offset 0x2C, size 0xC
    struct xQuat startQuat; // offset 0x38, size 0x10
    struct xQuat destQuat; // offset 0x48, size 0x10
    float dist; // offset 0x58, size 0x4
};
// total size: 0x20
struct {} zLightweight<z::toss, 10>::__vtable; // size: 0x20, address: 0x8051D848
// Range: 0x80152634 -> 0x80152680
void zEntSimpleObj_MoveUpdate(struct zEntSimpleObj * object /* r31 */) {}

// total size: 0x24
struct {} zLightweightSystemBase::__vtable; // size: 0x24, address: 0x8051D824
// total size: 0x4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051D88C
