/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicSwarmOwl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8033BFF4 -> 0x8033CA44
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gSwarmOwlSteeringParams; // size: 0x8C, address: 0x80D360D0
...
static class zCompSoundParams gSwarmOwlSoundParams; // size: 0x1C, address: 0x80D3615C
// total size: 0x8
...
static struct zCompStateMachineTable gSwarmOwlStateMachineTable[4]; // size: 0x20, address: 0x8052E9F8
// total size: 0x34
...
// Range: 0x8033BFF4 -> 0x8033C024
void zCompLogicSwarmOwl::AddStaticTweaks() {
    // References
    // -> static class zCompSteeringFlockingParams gSwarmOwlSteeringParams;
}

// Range: 0x8033C024 -> 0x8033C134
void zCompLogicSwarmOwl::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x8033C134 -> 0x8033C138
void zCompLogicSwarmOwl::SetupStateTranstitionTests() {}

// Range: 0x8033C138 -> 0x8033C140
int zCompLogicSwarmOwl::GetInitialStateEnum() {}

// Range: 0x8033C140 -> 0x8033C14C
struct zCompStateMachineTable * zCompLogicSwarmOwl::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gSwarmOwlStateMachineTable[4];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67C60
// Range: 0x8033C14C -> 0x8033C40C
// this: r25
unsigned char zCompLogicSwarmOwl::SystemEvent(unsigned int to_event /* r1+0x8 */, const float * to_param /* r26 */, struct xBase * to_param_widget /* r31 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r24
    class zNPCBase * neighbourNPCs; // r1+0x10
    int numberNeighbourNPCs; // r1+0xC
    int i; // r30
    int i; // r29
    int i; // r28
    int i; // r27
...
// total size: 0x4
struct /* @class$984zCompLogicSwarmOwl_cpp */ {
    // Members
...
union /* @class$1124zCompLogicSwarmOwl_cpp */ {
...
// total size: 0xC
struct /* @class$1122zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$791zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$792zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$794zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$795zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$796zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$797zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0x98
struct zNPCAssetSwarm : public zNPCAssetRATS {
    // Members
    int memberNumber; // offset 0x74, size 0x4
    float spawnRadius; // offset 0x78, size 0x4
    unsigned int attractor; // offset 0x7C, size 0x4
    unsigned int repeller; // offset 0x80, size 0x4
    unsigned int flags; // offset 0x84, size 0x4
    unsigned int loopSound; // offset 0x88, size 0x4
    unsigned int oneShotSound; // offset 0x8C, size 0x4
    float oneShotSoundMinTime; // offset 0x90, size 0x4
    float oneShotSoundMaxTime; // offset 0x94, size 0x4
};
// Range: 0x8033C40C -> 0x8033C5DC
// this: r30
void zCompLogicSwarmOwl::AllAttached() {
    // Local variables
    class zNPCBase * ownerNPC; // r26
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    struct zNPCAssetSwarm * swarmAsset; // r31
    int i; // r29
    class zICompSteering * compSteering; // r27
    class zICompSound * soundComp; // r25
    class zCompSteeringFlockingBrain * compSteeringFlocking; // r28

    // References
    // -> static class zCompSoundParams gSwarmOwlSoundParams;
    // -> static class zCompSteeringFlockingParams gSwarmOwlSteeringParams;
}
...
// total size: 0x14
class zSwarmOwlWander : public zCompState {
    // Functions
    void Update(class zNPCBase * owner);
};
// Range: 0x8033C5DC -> 0x8033C6F4
void zSwarmOwlWander::Enter(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1736zCompLogicSwarmOwl_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8033C6F4 -> 0x8033C788
// this: r1+0x8
void zSwarmOwlWander::Update(class zNPCBase * owner /* r27 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r31
    class zNPCBase * neighbourNPCs; // r1+0x10
    int numberNeighbourNPCs; // r1+0xC
    struct xVec3 * playerPos; // r30
    class zCompSteeringFlockingBrain * flockingBrain; // r29
    const struct xVec3 * swarmPos; // r28
...
// total size: 0x890
struct /* @class$1979zCompLogicSwarmOwl_cpp */ {
    // Static members
...
// total size: 0x14
class zSwarmOwlBlock : public zCompState {
    // Functions
    void Update(class zNPCBase * owner);
};
// Range: 0x8033C788 -> 0x8033C8BC
void zSwarmOwlBlock::Enter(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r28
    class zNPCBase * neighbourNPCs; // r1+0x10
    int numberNeighbourNPCs; // r1+0xC
...
// Range: 0x8033C8BC -> 0x8033C940
// this: r1+0x8
void zSwarmOwlBlock::Update(class zNPCBase * owner /* r1+0xC */) {
    // Local variables
    struct xVec3 * playerPos; // r31
    class zCompSteeringFlockingBrain * flockingBrain; // r30
    const struct xVec3 * swarmPos; // r29
...
// total size: 0x14
class zSwarmOwlAttracted : public zCompState {};
// Range: 0x8033C940 -> 0x8033CA40
void zSwarmOwlAttracted::Enter(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r28
    class zNPCBase * neighbourNPCs; // r1+0x10
    int numberNeighbourNPCs; // r1+0xC
...
// Range: 0x8033CA40 -> 0x8033CA44
void zSwarmOwlAttracted::Update() {}

// total size: 0x2C
struct {} zSwarmOwlAttracted::__vtable; // size: 0x2C, address: 0x8052EA18
// total size: 0x2C
struct {} zSwarmOwlBlock::__vtable; // size: 0x2C, address: 0x8052EA44
// total size: 0x2C
struct {} zSwarmOwlWander::__vtable; // size: 0x2C, address: 0x8052EA70
// total size: 0x50
