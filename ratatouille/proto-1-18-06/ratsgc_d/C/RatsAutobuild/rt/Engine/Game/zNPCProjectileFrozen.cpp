/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCProjectileFrozen.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C2354 -> 0x802C3934
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float angularSpeedMult; // size: 0x4, address: 0x80D66780
// total size: 0x10
struct RwRGBAReal {
    // Members
...
static struct xLightKit * envLightKit; // size: 0x4, address: 0x80D6B588
static float DECAL_LIFETIME; // size: 0x4, address: 0x80D66784
static float DECAL_SIZE; // size: 0x4, address: 0x80D66788
static int THROWN_DAMAGE; // size: 0x4, address: 0x80D6678C
static float THROWN_DAMAGE_RADIUS; // size: 0x4, address: 0x80D66790
static float FROZEN_LIFETIME; // size: 0x4, address: 0x80D66794
static float FALL_OUT_OF_WORLD_THRESHOLD; // size: 0x4, address: 0x80D66798
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node meltedPoolCurveNodes[4]; // size: 0x70, address: 0x804D1878
// Range: 0x802C2354 -> 0x802C236C
static float GetParticleMeltTime() {
    // References
    // -> static struct curve_node meltedPoolCurveNodes[4];
    // -> static float DECAL_LIFETIME;
}
...
// total size: 0xC
struct /* @class$842zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zNPCProjectileFrozen_cpp */ {
    // Members
...
static struct xResponseCurve meltedPoolCurve; // size: 0x14, address: 0x80D6B58C
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$901zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1879zNPCProjectileFrozen_cpp */ {
    // Members
...
union /* @class$1040zNPCProjectileFrozen_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCProjectileFrozen_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0xB0
struct FrozenProjectileAssets {
    // Members
    unsigned int outerModelID; // offset 0x0, size 0x4
    unsigned int innerModelID; // offset 0x4, size 0x4
    unsigned int shrapnelID; // offset 0x8, size 0x4
    unsigned int decalTextureID; // offset 0xC, size 0x4
    struct zShrapnelAsset * shrapnel; // offset 0x10, size 0x4
    struct RpAtomic * innerModelFile; // offset 0x14, size 0x4
    struct RwTexture * decalTexture; // offset 0x18, size 0x4
    struct xEntAsset entAsset; // offset 0x1C, size 0x50
    struct xEntBoulderAsset boulderAsset; // offset 0x6C, size 0x44
};
static struct FrozenProjectileAssets assets[2]; // size: 0x160, address: 0x80528138
// Range: 0x802C236C -> 0x802C239C
static unsigned int DestroyCB(struct xEnt * object /* r1+0x8 */) {}
...
// total size: 0x10
struct /* @class$1576zNPCProjectileFrozen_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802C239C -> 0x802C245C
static unsigned int CollideCB(float & blastRadius /* r31 */, struct xEnt * thrown /* r1+0x8 */, struct xEnt * hit /* r1+0xC */, const struct xVec3 * point /* r1+0x10 */, float damageMultiplier /* r1+0x14 */, float radiusMultiplier /* r1+0x18 */) {
    // Local variables
    enum zHitTarget hitTarget; // r1+0x1C

    // References
    // -> static int THROWN_DAMAGE;
    // -> struct xGlobals * xglobals;
    // -> static float THROWN_DAMAGE_RADIUS;
}
...
// total size: 0x890
struct /* @class$2080zNPCProjectileFrozen_cpp */ {
    // Static members
...
// total size: 0x28
struct zParSysSnowsplosionConfig {
    // Members
    float minLife; // offset 0x0, size 0x4
    float maxLife; // offset 0x4, size 0x4
    float minSize; // offset 0x8, size 0x4
    float maxSize; // offset 0xC, size 0x4
    float minSpeed; // offset 0x10, size 0x4
    float maxSpeed; // offset 0x14, size 0x4
    float deceleration; // offset 0x18, size 0x4
    float fadeStartTime; // offset 0x1C, size 0x4
    float speedDown; // offset 0x20, size 0x4
    unsigned char minParticles; // offset 0x24, size 0x1
    unsigned char maxParticles; // offset 0x25, size 0x1
    unsigned char startAlpha; // offset 0x26, size 0x1
    unsigned char spawnDown; // offset 0x27, size 0x1
};
static struct zParSysSnowsplosionConfig snowConfig; // size: 0x28, address: 0x80528298
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6679C
...
// total size: 0x21C
class zNPCProjectileFrozen : public xEntBoulder {
    // Functions
    static void Init(enum zNPCProjectileFrozenType newType);
    ...
    static void HandleEvent(struct xBase * from, unsigned int toEvent, const float * toParam, struct xBase * toParamWidget, unsigned int toParamWidgetID);

    static void Activate(const struct xMat4x3 & frameMatrix, const struct xVec3 & velocity, enum zNPCProjectileFrozenType newType);

    static void Exit();

    static unsigned char IsActive() const;
    ...
    // Members
protected:
    unsigned char active; // offset 0x20C, size 0x1
    unsigned char pickedUp; // offset 0x20D, size 0x1
    unsigned char melting; // offset 0x20E, size 0x1
    enum zNPCProjectileFrozenType type; // offset 0x210, size 0x4
    struct xModelInstance * innerModel; // offset 0x214, size 0x4
    float timer; // offset 0x218, size 0x4
};
// Range: 0x802C245C -> 0x802C29C0
static void zNPCProjectileFrozen::SceneSetup() {
    // Local variables
    ...
    // References
    // -> static struct FrozenProjectileAssets assets[2];
    // -> static struct xLightKit * envLightKit;
    // -> struct zGlobals globals;
    // -> static struct zParSysSnowsplosionConfig snowConfig;
    // -> static float FROZEN_LIFETIME;
    // -> static int THROWN_DAMAGE;
    // -> static float DECAL_SIZE;
    // -> static float DECAL_LIFETIME;
    // -> char * animix_labels[6];
    // -> static struct xResponseCurve meltedPoolCurve;
    // -> static struct curve_node meltedPoolCurveNodes[4];
}
...
// Range: 0x802C29C0 -> 0x802C2A10
static void FrozenEventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D667A1
enum zNPCProjectileFrozenType {
    ezNPCProjectileFrozenType_Grub = 0,
    ezNPCProjectileFrozenType_TrackingGrub = 1,
    ezNPCProjectileFrozenType_Count = 2,
    ezNPCProjectileFrozenType_Invalid = -1,
};
// Range: 0x802C2A10 -> 0x802C2CF8
// this: r31
static void zNPCProjectileFrozen::Init(enum zNPCProjectileFrozenType newType /* r1+0x8 */) {
    // References
    // -> static struct xLightKit * envLightKit;
    // -> static struct FrozenProjectileAssets assets[2];
...
// Range: 0x802C2CF8 -> 0x802C2D2C
// this: r31
static void zNPCProjectileFrozen::Reset() {}

// Range: 0x802C2D2C -> 0x802C2D68
// this: r31
static void zNPCProjectileFrozen::RemoveFromGrid() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D667A6
// Range: 0x802C2D68 -> 0x802C2F98
// this: r31
static void zNPCProjectileFrozen::Update(float dt /* f29 */) {
    // Local variables
    float totalMeltTime; // f31
    float scale; // f30

    // References
    // -> struct zGlobals globals;
    // -> static float FALL_OUT_OF_WORLD_THRESHOLD;
    // -> static char __FUNCTION__[7];
}

// Range: 0x802C2F98 -> 0x802C3034
// this: r31
static void zNPCProjectileFrozen::Explode() {
    // References
    // -> static struct FrozenProjectileAssets assets[2];
}
...
// Range: 0x802C3034 -> 0x802C317C
// this: r31
static void zNPCProjectileFrozen::Melt() {
    // Local variables
    struct emit_context decalContext; // r1+0x60
    struct xMat4x3 mat; // r1+0x20
    struct xVec3 cast; // r1+0x10
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D667AD
// Range: 0x802C317C -> 0x802C32A8
// this: r31
static void zNPCProjectileFrozen::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r30 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D667B9
// Range: 0x802C32A8 -> 0x802C34C4
// this: r31
static void zNPCProjectileFrozen::Activate(const struct xMat4x3 & frameMatrix /* r1+0x8 */, const struct xVec3 & velocity /* r1+0xC */, enum zNPCProjectileFrozenType newType /* r30 */) {
    // References
    // -> static char __FUNCTION__[9];
    // -> static struct zParSysSnowsplosionConfig snowConfig;
    // -> static float angularSpeedMult;
    // -> static float FROZEN_LIFETIME;
    // -> struct zGlobals globals;
}

char __FUNCTION__$localstatic1$front__71pool_list<Q234@unnamed@zNPCProjectileFrozen_cpp@20zNPCProjectileFrozen>Fv[6]; // size: 0x6, address: 0x80D667C2
// total size: 0x24
class zNPCProjectileFrozenManager : public zLightweightList {
    // Functions
    static void Freeze(const struct xMat4x3 & frameMatrix, const struct xVec3 & velocity, enum zNPCProjectileFrozenType type);

    static class zNPCProjectileFrozen * FindOffscreen();

    static zNPCProjectileFrozenManager();
};
static class zNPCProjectileFrozenManager frozenManager; // size: 0x24, address: 0x80D2CFE0
// Range: 0x802C34C4 -> 0x802C3508
void zNPCProjectileFreeze(const struct xMat4x3 & frameMatrix /* r1+0x8 */, const struct xVec3 & velocity /* r1+0xC */, enum zNPCProjectileFrozenType type /* r1+0x10 */) {
    // References
    // -> static class zNPCProjectileFrozenManager frozenManager;
}

// Range: 0x802C3508 -> 0x802C35FC
// this: r28
static void zNPCProjectileFrozenManager::Freeze(const struct xMat4x3 & frameMatrix /* r1+0x8 */, const struct xVec3 & velocity /* r1+0xC */, enum zNPCProjectileFrozenType type /* r1+0x10 */) {
    // Local variables
    class zNPCProjectileFrozen * newFrozen; // r31
    struct node_type * currentNode; // r30
    struct node_type * const endNode; // r27
    float lowestYHeight; // f31
    class zNPCProjectileFrozen * currentProj; // r29
    float currentNodeY; // f30
}
...
struct node_type {
    ...
    class zNPCProjectileFrozen value; // offset 0x8, size 0x21C
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x802C35FC -> 0x802C36AC
// this: r28
static class zNPCProjectileFrozen * zNPCProjectileFrozenManager::FindOffscreen() {
    // Local variables
    struct node_type * currentNode; // r31
    struct node_type * const endNode; // r29
    class zNPCProjectileFrozen * proj; // r30
...
// total size: 0x24
class zLightweightList : public zLightweightSystemBase {
    // Members
protected:
    class pool_list list; // offset 0x4, size 0x20
};
// Range: 0x802C36AC -> 0x802C36DC
void zNPCProjectileFrozenInit(int maxNumFrozen /* r1+0x8 */) {
    // References
    // -> static class zNPCProjectileFrozenManager frozenManager;
}

static // total size: 0x24
struct {} @unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozenManager::__vtable; // size: 0x24, address: 0x805282E4
// Range: 0x802C36DC -> 0x802C3718
// this: r31
static zNPCProjectileFrozenManager::zNPCProjectileFrozenManager() {
    // References
    // -> static struct [anonymous] @unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozenManager::__vtable;
}
...
// total size: 0x24
struct {} zLightweightList<@unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozen>::__vtable; // size: 0x24, address: 0x805282C0
// Range: 0x802C3754 -> 0x802C37DC
// this: r31
static void zNPCProjectileFrozen::Exit() {
    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x802C37DC -> 0x802C37E0
static void zNPCProjectileFrozen::PostRender3d() {}

// Range: 0x802C37E0 -> 0x802C37E8
// this: r3
static unsigned char zNPCProjectileFrozen::IsActive() const {}

// Range: 0x802C37E8 -> 0x802C37EC
static void zNPCProjectileFrozen::PostRender2d() {}

// Range: 0x802C37EC -> 0x802C38E0
// this: r31
static void zNPCProjectileFrozen::Render() {
    // Local variables
    float totalMeltTime; // f31
    float scale; // f30
}

// Range: 0x802C38E0 -> 0x802C3934
// this: r31
static void zNPCProjectileFrozen::Setup() {
    // References
    // -> static struct FrozenProjectileAssets assets[2];
}
