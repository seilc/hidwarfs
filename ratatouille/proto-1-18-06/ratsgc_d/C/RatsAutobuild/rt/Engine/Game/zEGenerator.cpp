/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80149CB8 -> 0x8014AE5C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80149CB8 -> 0x80149CE8
void zEGenerator_Init(void * egen /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D625D0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$889zEGenerator_cpp */ {
    // Members
...
union /* @class$601zEGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1053zEGenerator_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1628zEGenerator_cpp */ {
    // Members
...
// Range: 0x80149CE8 -> 0x80149FF8
void zEGenerator_Init(struct zEGenerator * egen /* r31 */, struct xEntAsset * asset /* r28 */) {
    // Local variables
    struct zEGenAsset * zasset; // r30
    void * buf; // r29
...
static int been_here; // size: 0x4, address: 0x80D69F98
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D625E1
// Range: 0x80149FF8 -> 0x8014A0FC
void zEGenerator_Setup(struct zEGenerator * egen /* r31 */) {
    // Local variables
    int i; // r29
    const struct xLinkAsset * la; // r28
    struct xBase * b; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D625F3
// total size: 0x0
struct xSerial {};
// Range: 0x8014A0FC -> 0x8014A1EC
void zEGenerator_Save(struct zEGenerator * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D62604
// Range: 0x8014A1EC -> 0x8014A2DC
void zEGenerator_Load(struct zEGenerator * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x8014A2DC -> 0x8014A378
void zEGenerator_Reset(struct zEGenerator * egen /* r31 */) {
    // Local variables
    struct zEGenAsset * zasset; // r30
}

// Range: 0x8014A378 -> 0x8014A37C
void zEGenerator_Move() {}

// Range: 0x8014A37C -> 0x8014A4BC
void zEGenerator_Update(struct zEGenerator * egen /* r31 */, struct xScene * sc /* r1+0x8 */, float dt /* f31 */) {
    // Local variables
    struct xBase * b; // r30
    struct zEnt * ent; // r29
}

// Range: 0x8014A4BC -> 0x8014A4E4
void zEGenerator_Render(struct zEGenerator * egen /* r1+0x8 */) {}

static int been_here; // size: 0x4, address: 0x80D69F9C
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D62615
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x8014A4E4 -> 0x8014AA04
void zEGenerator_TurnOn(struct zEGenerator * egen /* r31 */) {
    // Local variables
    struct zEGenAsset * zasset; // r25
    struct xAnimPlay * aplay; // r27
    struct xAnimSingle * asing; // r23
    unsigned short itgt; // r21
    unsigned short imp; // r24
    int i; // r26
    const struct xLinkAsset * link; // r29
    unsigned int dstAssetID; // r20
    struct xBase * b; // r30
    struct xVec3 destOffset; // r1+0x14
    struct xMovePoint * mp; // r19
    struct xEntBoulder * boulder; // r18
    struct xEnt * ent; // r22
    int i; // r28
    unsigned long il; // r17
    unsigned long ir; // r1+0x10
    struct _tagLightningAdd add; // r1+0x20
    struct xColor_tag addColor1; // r1+0xC
    struct xColor_tag addColor2; // r1+0x8
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62628
// Range: 0x8014AA04 -> 0x8014AB74
void zEGenerator_TurnOff(struct zEGenerator * egen /* r31 */) {
    // Local variables
    struct xAnimPlay * aplay; // r29
    struct xAnimSingle * asing; // r28
    int i; // r30
...
// Range: 0x8014AB74 -> 0x8014ABBC
void zEGenerator_ToggleOn(struct zEGenerator * egen /* r31 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6263C
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
// Range: 0x8014ABBC -> 0x8014AE5C
void zEGeneratorEventCB(struct xBase * to /* r27 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */) {
    // Local variables
    struct zEGenerator * egen; // r31
    struct zShrapnelAsset * shrap; // r30
