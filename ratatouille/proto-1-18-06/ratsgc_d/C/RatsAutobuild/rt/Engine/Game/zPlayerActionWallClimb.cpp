/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerActionWallClimb.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E7F7C -> 0x802E9374
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float CLIMBING_SPEED; // size: 0x4, address: 0x80D66D80
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 HAND_POS; // size: 0xC, address: 0x80D66D84
static struct xVec3 FOOT_POS; // size: 0xC, address: 0x80D66D90
static float WALL_TOLERANCE; // size: 0x4, address: 0x80D66D9C
static float BLEND_VEL_QUAT; // size: 0x4, address: 0x80D66DA0
static float BLEND_VEL_POS_MAX; // size: 0x4, address: 0x80D66DA4
static float LAND_POS; // size: 0x4, address: 0x80D66DA8
static float SWEPT_SPHERE_DIST; // size: 0x4, address: 0x80D66DAC
static float SWEPT_SPHERE_TOLER; // size: 0x4, address: 0x80D66DB0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$892zPlayerActionWallClimb_cpp */ {
    // Members
...
union /* @class$1040zPlayerActionWallClimb_cpp */ {
...
// Range: 0x802E7F7C -> 0x802E7FD0
static unsigned char IsClimbableSurface(struct xSurface * surface /* r3 */) {
    // Local variables
    struct zSurfaceProps * props; // r31
}
...
// total size: 0xC
struct /* @class$1039zPlayerActionWallClimb_cpp */ {
    // Members
...
// Range: 0x802E7FD0 -> 0x802E8030
static unsigned char RayHitsScene(const struct xRay3 & ray /* r1+0x8 */) {
    // Local variables
    struct xCollis collisionResults; // r1+0xC
...
// total size: 0x38
class zPlayerActionWallClimb : public zCommonPlayerAction {
    // Functions
    unsigned int ValidDeltaPos(const struct xVec3 & dpos, struct xVec3 * points);

    unsigned char ValidLimbPos(const struct xVec3 & pos, struct xVec3 & actualPos);

    void AddStates(struct xAnimTable * table);

    void AddActionTransitions(struct xAnimTable * table);

    void TryClimbUp(const struct xVec3 & dpos);
    ...
    unsigned int ClimbUpCheck();

    void NotifyCollision(const struct SphereCollisionResults & sceneCollide);

    // Members
protected:
    struct xQuat targetOrientation; // offset 0xC, size 0x10
    struct xQuat orientation; // offset 0x1C, size 0x10
    float orientationVel; // offset 0x2C, size 0x4
    unsigned char mount; // offset 0x30, size 0x1
    unsigned char isObject; // offset 0x31, size 0x1
    unsigned char climbUp; // offset 0x32, size 0x1
    union { // inferred
        struct xEnt * object; // offset 0x34, size 0x4
        struct xJSPHeader * jsp; // offset 0x34, size 0x4
    };
};
// Range: 0x802E8030 -> 0x802E8214
void zPlayerActionWallClimb::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float SWEPT_SPHERE_TOLER;
    // -> static float SWEPT_SPHERE_DIST;
    // -> static float LAND_POS;
    // -> static float BLEND_VEL_POS_MAX;
    // -> static float BLEND_VEL_QUAT;
    // -> static float WALL_TOLERANCE;
    // -> static struct xVec3 FOOT_POS;
    // -> static struct xVec3 HAND_POS;
    // -> static float CLIMBING_SPEED;
}

// Range: 0x802E8214 -> 0x802E8350
// this: r31
unsigned int zPlayerActionWallClimb::ValidDeltaPos(const struct xVec3 & dpos /* r29 */, struct xVec3 * points /* r30 */) {
    // Local variables
    struct xVec3 limbWorldPos; // r1+0x8
...
// Range: 0x802E8350 -> 0x802E84FC
// this: r31
unsigned char zPlayerActionWallClimb::ValidLimbPos(const struct xVec3 & pos /* r1+0x8 */, struct xVec3 & actualPos /* r28 */) {
    // Local variables
    struct xRay3 ray; // r1+0x30
    struct xCollis collisionResults; // r1+0x54
    unsigned char hit; // r30
    struct xQCData quickCullData; // r1+0x10
...
// Range: 0x802E84FC -> 0x802E865C
// this: r30
void zPlayerActionWallClimb::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802E865C -> 0x802E8778
void zPlayerActionWallClimb::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802E8778 -> 0x802E88D0
// this: r31
void zPlayerActionWallClimb::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x802E88D0 -> 0x802E8938
void zPlayerActionWallClimb::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}
...
// Range: 0x802E8938 -> 0x802E8B88
// this: r31
void zPlayerActionWallClimb::TryClimbUp(const struct xVec3 & dpos /* r1+0x8 */) {
    // Local variables
    struct xRay3 ray; // r1+0x2C
    float backUpDist; // f31
    struct xVec3 start; // r1+0x20
    struct xVec3 end; // r1+0x14
    struct xSweptSphere sws; // r1+0x50
...
// Range: 0x802E8B88 -> 0x802E8F1C
// this: r31
void zPlayerActionWallClimb::Move(struct xScene * s /* r27 */, float dt /* f31 */, struct xEntFrame * frame /* r28 */) {
    // Local variables
    unsigned int animFlags; // r29
    struct xVec3 dpos; // r1+0x2C
    float x; // f29
    float y; // f28
    float translation; // f27
    struct xVec3 points[4]; // r1+0x70
    unsigned int failedLimb; // r30
    class xPlane targetPlane; // r1+0x1C
    struct xVec3 destPos; // r1+0x10
    float distance; // f25
    float length2; // f26
    float maxTranslation; // f30
    struct xMat3x3 orientationMatrix; // r1+0x40
...
// total size: 0x890
struct /* @class$1785zPlayerActionWallClimb_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$833zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zPlayerActionWallClimb_cpp */ {
    // Members
...
struct xSerial {};
// total size: 0x4
struct /* @class$2083zPlayerActionWallClimb_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2084zPlayerActionWallClimb_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2085zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2082zPlayerActionWallClimb_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2087zPlayerActionWallClimb_cpp */ {
    // Members
...
// Range: 0x802E8F1C -> 0x802E8F28
// this: r3
void zPlayerActionWallClimb::Reset() {}

// Range: 0x802E8F28 -> 0x802E8F8C
// this: r31
void zPlayerActionWallClimb::Begin() {}

// Range: 0x802E8F8C -> 0x802E8FD4
// this: r31
void zPlayerActionWallClimb::End() {}

// Range: 0x802E8FD4 -> 0x802E8FDC
// this: r3
unsigned int zPlayerActionWallClimb::StartCheck() {}

// Range: 0x802E8FDC -> 0x802E8FE4
// this: r3
unsigned int zPlayerActionWallClimb::ClimbUpCheck() {}

// Range: 0x802E8FE4 -> 0x802E9140
// this: r31
void zPlayerActionWallClimb::NotifyCollision(const struct SphereCollisionResults & sceneCollide /* r30 */) {
    // Local variables
    struct xVec3 points[4]; // r1+0x50
    unsigned int failedLimb; // r29
    struct xMat3x3 orientationMatrix; // r1+0x20
    struct xVec3 targetDir; // r1+0x10
}

static struct xVec3 JUMP_VEL; // size: 0xC, address: 0x80D66DB4
// total size: 0xC
class zPlayerActionWallClimbJump : public zPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802E9140 -> 0x802E91A0
void zPlayerActionWallClimbJump::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static struct xVec3 JUMP_VEL;
}

// Range: 0x802E91A0 -> 0x802E9210
// this: r1+0x18
void zPlayerActionWallClimbJump::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x802E9210 -> 0x802E9250
// this: r31
void zPlayerActionWallClimbJump::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x802E9250 -> 0x802E92B8
void zPlayerActionWallClimbJump::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802E92B8 -> 0x802E9340
// this: r31
void zPlayerActionWallClimbJump::Begin() {
    // Local variables
    struct xMat3x3 playerMat; // r1+0x10

    // References
    // -> static struct xVec3 JUMP_VEL;
}

// Range: 0x802E9340 -> 0x802E9374
// this: r31
unsigned int zPlayerActionWallClimbJump::StartCheck() {}

// total size: 0x54
struct {} zPlayerActionWallClimbJump::__vtable; // size: 0x54, address: 0x805296F0
...
// total size: 0x54
struct {} zPlayerActionWallClimb::__vtable; // size: 0x54, address: 0x80529744
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1288zPlayerActionWallClimb_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
