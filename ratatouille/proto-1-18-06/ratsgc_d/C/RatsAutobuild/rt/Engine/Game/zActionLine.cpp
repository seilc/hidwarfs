/*
    ...
    Language: C++
    Code range: 0x8012EDE8 -> 0x8012F12C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct _tagActionLine * sActionLine[8]; // size: 0x20, address: 0x80CE8BE0
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * sActionLineRaster; // size: 0x4, address: 0x80D69E40
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8012EE6C -> 0x8012EEF0
void zActionLineUpdate(float seconds /* f1 */) {
    // Local variables
    int i; // r30
    struct _tagActionLine * l; // r31
...
// total size: 0x4
struct /* @class$889zActionLine_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1053zActionLine_cpp */ {
    // Members
...
union /* @class$601zActionLine_cpp */ {
...
// total size: 0x10
struct /* @class$1629zActionLine_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1872zActionLine_cpp */ {
    // Static members
...
static struct RxObjSpace3DVertex sStripVert[4]; // size: 0x90, address: 0x80CE8C00
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D61E00
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8012EEF0 -> 0x8012F094
static void RenderActionLine(struct _tagActionLine * l /* r29 */) {
    // Local variables
