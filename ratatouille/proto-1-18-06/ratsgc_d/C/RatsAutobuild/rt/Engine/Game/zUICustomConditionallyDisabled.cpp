/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomConditionallyDisabled.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E55CC -> 0x802E57A4
*/
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66D20
// total size: 0x54
struct {} zUICustomConditionallyDisabled::__vtable; // size: 0x54, address: 0x80529540
// total size: 0x18
...
// Range: 0x802E55CC -> 0x802E5700
// this: r31
zUICustomConditionallyDisabled::zUICustomConditionallyDisabled(class zUI * ui /* r29 */) {
    // Local variables
    struct xBase * pCond; // r30
...
// Range: 0x802E5700 -> 0x802E5794
// this: r31
void zUICustomConditionallyDisabled::PreUpdate() {
    // Local variables
    unsigned char new_condition; // r30
}

// Range: 0x802E5794 -> 0x802E579C
// this: r3
unsigned char zUICustomConditionallyDisabled::PreAutoMenu() {}

// Range: 0x802E579C -> 0x802E57A4
// this: r3
