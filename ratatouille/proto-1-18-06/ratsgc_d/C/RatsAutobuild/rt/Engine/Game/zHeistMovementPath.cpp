/*
    ...
    Language: C++
    Code range: 0x802EAB78 -> 0x802EC784
*/
class zHeistMovementPathManager * heistMovementPathManager; // size: 0x4, address: 0x80D6B758
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66E00
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$937zHeistMovementPath_cpp */ {
    // Members
...
union /* @class$1076zHeistMovementPath_cpp */ {
...
// total size: 0xC
struct /* @class$1075zHeistMovementPath_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66E05
// Range: 0x802EB004 -> 0x802EB1CC
void zHeistMovementPath::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D66E0A
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x802EB208 -> 0x802EB5BC
// this: r31
unsigned char zHeistMovementPath::ValidatePath() {
    // Local variables
    struct xMovePoint * next; // r30
    signed short i; // r29
...
// Range: 0x802EB5BC -> 0x802EBA64
// this: r31
void zHeistMovementPath::RenderOverlay(int selectedPath /* r1+0x8 */) {
    // Local variables
    struct xColor_tag pathColor; // r1+0x1C
    struct xVec3 forwardVec; // r1+0x80
    int i; // r30
    struct xVec3 centerPoint; // r1+0x74
    struct xVec3 sidewaysVec; // r1+0x68
    struct xVec3 rightPoint; // r1+0x5C
    struct xVec3 leftPoint; // r1+0x50
    ...
    enum RwBlendFunction destBlend; // r1+0xC
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66E17
// Range: 0x802EBA64 -> 0x802EBB80
void zHeistMovementPath::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHeistMovementPath * movementPath; // r31

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x802EBB80 -> 0x802EBBF4
// this: r31
void zHeistMovementPath::EventCB(unsigned int toEvent /* r1+0x8 */) {}

// Range: 0x802EBBF4 -> 0x802EBCE8
// this: r31
void zHeistMovementPath::StoreConnectingPathIndices() {
    // Local variables
    class zHeistMovementPath * sPath; // r29
    class zHeistMovementPath * ePath; // r28
    int i; // r30
}

// Range: 0x802EBCE8 -> 0x802EBDAC
// this: r31
int zHeistMovementPath::GetDefaultPathSelectIdx(int atStart /* r1+0x8 */) {
    // Local variables
    int i; // r30
    int i; // r29
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80529798
// Range: 0x802EBDAC -> 0x802EBF54
// this: r30
int zHeistMovementPath::GetNextPathSelectIdx(int currSelectIdx /* r29 */, int atStart /* r26 */) {
    // Local variables
    int i; // r31
    int prevSelectPath; // r28
    int prevSelectPath; // r27

    // References
    // -> static char __FUNCTION__[21];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x805297AD
// Range: 0x802EBF54 -> 0x802EC174
// this: r30
int zHeistMovementPath::GetPrevPathSelectIdx(int currSelectIdx /* r27 */, int atStart /* r24 */) {
    // Local variables
    int i; // r29
    int i; // r28
    int i; // r31
    int prevSelectPath; // r26
    int prevSelectPath; // r25

    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x802EC174 -> 0x802EC1BC
// this: r3
unsigned char zHeistMovementPath::ConnectedAtStart(int testIdx /* r4 */) {
    // Local variables
    int i; // r31
}

// Range: 0x802EC1BC -> 0x802EC204
// this: r3
unsigned char zHeistMovementPath::ConnectedAtEnd(int testIdx /* r4 */) {
    // Local variables
    int i; // r31
}
...
// Range: 0x802EC204 -> 0x802EC248
// this: r31
void zHeistMovementPathManager::Init() {}

// Range: 0x802EC248 -> 0x802EC26C
void zHeistMovementPathManager::Exit() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66E1F
// Range: 0x802EC26C -> 0x802EC34C
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D66E2E
// Range: 0x802EC34C -> 0x802EC3E4
// this: r31
void zHeistMovementPathManager::RegisterPath(class zHeistMovementPath * regPath /* r30 */) {
    // References
    // -> static char __FUNCTION__[13];
    // -> unsigned int gActiveHeap;
}

// Range: 0x802EC3E4 -> 0x802EC40C
// this: r3
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66E3B
// Range: 0x802EC40C -> 0x802EC514
// this: r31
void zHeistMovementPathManager::InsertPath(class zHeistMovementPath * insPath /* r1+0x8 */, int idx /* r30 */) {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x802EC514 -> 0x802EC560
// this: r31
void zHeistMovementPathManager::SetDefaultPathSelect(int pathIdx /* r1+0x8 */, int atStart /* r1+0xC */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66E46
// Range: 0x802EC560 -> 0x802EC654
// this: r31
void zHeistMovementPathManager::NextPathSelect(int pathIdx /* r1+0x8 */, int atStart /* r1+0xC */) {
    // Local variables
    int tempIdx; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66E55
// Range: 0x802EC654 -> 0x802EC748
// this: r31
void zHeistMovementPathManager::PrevPathSelect(int pathIdx /* r1+0x8 */, int atStart /* r1+0xC */) {
    // Local variables
    int tempIdx; // r30
