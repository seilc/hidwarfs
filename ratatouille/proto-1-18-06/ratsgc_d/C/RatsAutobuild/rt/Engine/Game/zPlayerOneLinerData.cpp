/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerOneLinerData.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80298950 -> 0x80298D40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int SURROUND_COUNT; // size: 0x4, address: 0x80D65FB8
static int KILL_LIMIT; // size: 0x4, address: 0x80D65FBC
static float DAMAGE_TIME; // size: 0x4, address: 0x80D65FC0
static int DAMAGE_AMOUNT; // size: 0x4, address: 0x80D65FC4
// total size: 0x8
struct /* @class$601zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$902zPlayerOneLinerData_cpp */ {
    // Members
...
union /* @class$1041zPlayerOneLinerData_cpp */ {
...
// total size: 0x4
struct /* @class$2090zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2052zPlayerOneLinerData_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2053zPlayerOneLinerData_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2054zPlayerOneLinerData_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2056zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1394zPlayerOneLinerData_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$843zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$845zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$846zPlayerOneLinerData_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$847zPlayerOneLinerData_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$848zPlayerOneLinerData_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$849zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1876zPlayerOneLinerData_cpp */ {
    // Static members
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65FC8
// Range: 0x80298A90 -> 0x80298C40
// this: r31
unsigned char zPlayerOneLinerData::Damage(signed short amount /* r28 */) {
    // Local variables
    float currentTime; // f31
    int totalDamage; // r29
    int i; // r30
