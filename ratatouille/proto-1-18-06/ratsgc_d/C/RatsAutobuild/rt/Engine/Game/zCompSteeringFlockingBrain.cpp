/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompSteeringFlockingBrain.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80336CAC -> 0x80336DA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80336CB0 -> 0x80336DA8
// this: r31
void zCompSteeringFlockingBrain::PreUpdate() {
    // Local variables
    class zNPCBase * ownerNPC; // r28
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    const struct xVec3 * neighbourEntityPos; // r27
    const struct xVec3 * neighbourEntityHeading; // r26
    int i; // r30
    class zICompNPCEntity * curNeighbourEntity; // r29
    float oneOverNumbers; // f31
...
// total size: 0x4
struct /* @class$901zCompSteeringFlockingBrain_cpp */ {
    // Members
...
union /* @class$1040zCompSteeringFlockingBrain_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0x54
struct {} zCompSteeringFlockingBrain::__vtable; // size: 0x54, address: 0x8052E720
// total size: 0x8
