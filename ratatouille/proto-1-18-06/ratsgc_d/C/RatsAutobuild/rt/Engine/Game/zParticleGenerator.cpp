/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80225CDC -> 0x802271F8
*/
static int max_system_asset_size; // size: 0x4, address: 0x80D6AF38
static class zParticleSystem * * systems; // size: 0x4, address: 0x80D6AF3C
static class zParticleSystem * * system_handler_set[7]; // size: 0x1C, address: 0x80D185A8
static int system_handler_set_size[7]; // size: 0x1C, address: 0x80D185C4
static struct zParticleGenerator * * generators; // size: 0x4, address: 0x80D6AF40
static int max_generators; // size: 0x4, address: 0x80D6AF44
static int generators_used; // size: 0x4, address: 0x80D6AF48
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64BA0
// Range: 0x80225CDC -> 0x80226068
static void validate_asset(const struct zParticleAsset & asset /* r31 */, int asset_size /* r29 */) {
    // Local variables
    int expected_asset_size; // r30
...
// total size: 0xC
struct /* @class$1560zParticleGenerator_cpp */ {
    // Members
...
static void create_handler_sets() {
    ...
    class zParticleSystem * * end_sys; // r24
    int need_mask; // r23
    class zParticleSystem * * handler_buffer; // r22
    class zParticleSystem * * set; // r28
    int handler; // r27
    class zParticleSystem * * sys; // r31
    class zParticleSystem * * end_sys; // r21
    int need_mask; // r20
...
// Range: 0x8022617C -> 0x80226180
static void sort_handler_sets() {}

// Range: 0x80226180 -> 0x802261DC
static int compare_generator_systems_function(void * e1 /* r3 */, void * e2 /* r4 */) {
    // Local variables
    const struct zParticleGenerator * g1; // r31
    const struct zParticleGenerator * g2; // r30
}

// Range: 0x802261DC -> 0x802262B0
static void sort_generators() {
    // Local variables
    class zParticleSystem * * sys; // r31
    class zParticleSystem * * end_sys; // r26
    struct zParticleGenerator * * first_gen; // r30
    struct zParticleGenerator * * last_gen; // r28
    int system_type; // r27
    int next_system_type; // r1+0x8
    struct zParticleGenerator * * found_gen; // r29
...
// Range: 0x802262B0 -> 0x802263F4
static void create_generators() {
    // Local variables
    unsigned int type; // r25
    int asses; // r24
    int total; // r29
    int i; // r28
    unsigned int asset_size; // r1+0x8
    const struct zParticleAsset * asset; // r26
    struct zParticleGenerator * * gen; // r31
    int i; // r27
    struct zParticleAsset * asset; // r30
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D64BAF
// Range: 0x802263F4 -> 0x8022652C
void zParticleSceneEnter() {
    // Local variables
    class zParticleSystem * * sys; // r31
    class zParticleSystem * * end_sys; // r28
    int size; // r29
    class zParticleSystem * * set; // r30
    class zParticleSystem * * end_set; // r27
...
// Range: 0x8022652C -> 0x802265FC
void zParticleSceneExit() {
    // Local variables
    struct zParticleGenerator * * gen; // r31
    struct zParticleGenerator * * end_gen; // r29
    class zParticleSystem * * set; // r30
    class zParticleSystem * * end_set; // r28
...
// Range: 0x802265FC -> 0x80226648
void zParticleGenerator::addTweaksCB(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct zParticleGenerator * gen; // r31
}
...
static struct tweak_callback tweakCallback; // size: 0x28, address: 0x80523910
static signed char init; // size: 0x1, address: 0x80D6AF4C
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D64BC3
// Range: 0x80226648 -> 0x80226874
void zParticleSetup() {
    // Local variables
    ...
    class zParticleSystem * * sys; // r31
    class zParticleSystem * * end_sys; // r27
    struct zParticleGenerator * * gen; // r30
    struct zParticleGenerator * * end_gen; // r26
...
// Range: 0x802268E4 -> 0x8022695C
void zParticleUpdate(float dt /* r1+0x8 */) {
    // Local variables
    class zParticleSystem * * set; // r31
    class zParticleSystem * * end_set; // r30
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64BD2
// Range: 0x802269CC -> 0x80226B6C
...
// Range: 0x80226BD8 -> 0x80226C5C
// this: r31
void zParticleGenerator::create(struct zParticleAsset & asset /* r30 */) {
    // References
    // -> static int max_system_asset_size;
}

// Range: 0x80226C5C -> 0x80226C94
// this: r3
void zParticleGenerator::reset() {}

// Range: 0x80226C94 -> 0x80226CA4
// this: r3
void zParticleGenerator::activate() {}

// Range: 0x80226CA4 -> 0x80226CB4
// this: r3
void zParticleGenerator::deactivate() {}

// Range: 0x80226CB4 -> 0x80226CBC
unsigned char zParticleGenerator::cullUpdate() {}

// Range: 0x80226CBC -> 0x80226CCC
// this: r3
void zParticleGenerator::pause() {}

// Range: 0x80226CCC -> 0x80226CDC
// this: r3
void zParticleGenerator::resume() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D64BE2
// Range: 0x80226CDC -> 0x80226E60
void zParticleGenerator::event_handler(struct xBase * to /* r30 */, unsigned int event /* r1+0x8 */, const float * argf /* r29 */) {
    // Local variables
    struct zParticleGenerator & gen; // r31
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D64BF0
// total size: 0x50
...
// total size: 0x4
struct /* @class$1158zParticleGenerator_cpp */ {
    // Members
...
union /* @class$827zParticleGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x80226E60 -> 0x80226F80
struct xEnt * zParticleGenerator::get_attach_entity(const struct zParticleAsset & asset /* r30 */) {
    // Local variables
    unsigned int id; // r29
    struct xBase * ent; // r31
    struct xEnt * pEnt; // r28
...
// Range: 0x80226F80 -> 0x802270AC
void zParticleGenerator::perturb_dir(struct xVec3 & dir /* r31 */, float angle /* f28 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$776zParticleGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleGenerator_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleGenerator_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x802270AC -> 0x80227128
void zParticleGenerator::on_tweaked(const struct tweak_info & info /* r31 */) {
    // Local variables
    struct zParticleGenerator * gen; // r30
}

static struct tweak_callback on_tweaked_cb; // size: 0x28, address: 0x804BEE90
// Range: 0x80227128 -> 0x802271F4
// this: r31
void zParticleGenerator::add_tweaks(const char * prefix /* r29 */) {
    // Local variables
...
enum /* @enum$1564zParticleGenerator_cpp */ {
    FLAG_ON = 1,
    FLAG_RUNNING = 2,
};
// Range: 0x802271F4 -> 0x802271F8
void zParticleGenerator::debug_render(unsigned char all /* r4 */) {}

// total size: 0x2C
struct {} zParticleGenerator::__vtable; // size: 0x2C, address: 0x80523938
// total size: 0x3C
struct {} zParticleSystem::__vtable; // size: 0x3C, address: 0x80523964
// total size: 0x8
