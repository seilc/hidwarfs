/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEntTrigger.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80153048 -> 0x80156EF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gDrawAllTriggers; // size: 0x1, address: 0x80D6A060
unsigned char gDrawNoEnterVolumes; // size: 0x1, address: 0x80D6A061
unsigned char gDrawJumpVolumes; // size: 0x1, address: 0x80D6A062
unsigned char gDrawHeightVolumes; // size: 0x1, address: 0x80D6A063
unsigned char gDrawSlowCollisionVolumes; // size: 0x1, address: 0x80D6A064
unsigned char gDrawAllTheRest; // size: 0x1, address: 0x80D6A065
unsigned char gDrawNPCDeathVolumes; // size: 0x1, address: 0x80D6A066
// Range: 0x80153048 -> 0x80153254
void zEntTriggerSceneEnter() {
    // Local variables
    char prefix[256]; // r1+0x388
    ...
    // References
    // -> unsigned char gDrawNPCDeathVolumes;
    // -> unsigned char gDrawAllTheRest;
    // -> unsigned char gDrawSlowCollisionVolumes;
    // -> unsigned char gDrawHeightVolumes;
    // -> unsigned char gDrawJumpVolumes;
    // -> unsigned char gDrawNoEnterVolumes;
    // -> unsigned char gDrawAllTriggers;
}

// total size: 0xC
struct /* @class$842zEntTrigger_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zEntTrigger_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zEntTrigger_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zEntTrigger_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zEntTrigger_cpp */ {
    // Members
...
// Range: 0x80153254 -> 0x80153280
void zEntTriggerSceneExit() {}
...
// Range: 0x80153280 -> 0x801532B0
void zEntTriggerInit(void * ent /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D627B8
...
// Range: 0x801532B0 -> 0x80153654
void zEntTriggerInit(struct zEntTrigger * ent /* r31 */, struct xEntAsset * asset /* r28 */) {
    // Local variables
    const struct xTriggerAsset * tasset; // r30
    struct xVec3 boxUpper; // r1+0x44
    struct xVec3 boxLower; // r1+0x38
    struct xVec3 center; // r1+0x2C
    struct xVec3 v1; // r1+0x20
    struct xVec3 pointOnPlane; // r1+0x14
...
// total size: 0x4
struct /* @class$901zEntTrigger_cpp */ {
    // Members
...
union /* @class$1040zEntTrigger_cpp */ {
...
// total size: 0xC
struct /* @class$1039zEntTrigger_cpp */ {
    // Members
...
struct zEntTrigger : public zEnt {
    // Functions
    unsigned char PointIntersects(const struct xVec3 & chkPos) const;
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D627C8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x80153654 -> 0x801538CC
void zEntTriggerUpdate(struct zEntTrigger * trig /* r30 */, struct xScene * sc /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    struct xTriggerAsset * tasset; // r25
    unsigned int i; // r26
    const struct xLinkAsset * link; // r31
    unsigned char collide; // r24
    struct xEnt * chkEnt; // r29
    struct xBase * chkBase; // r27
    class zNPCBase * npcBase; // r23
    struct xVec3 * chkPos; // r22
    struct xLinkAsset * linkNC; // r28
...
// Range: 0x801538CC -> 0x80153A5C
// this: r31
unsigned char zEntTrigger::PointIntersects(const struct xVec3 & chkPos /* r27 */) const {
    // Local variables
    struct xVec3 xformVec; // r1+0x28
    struct xIsect isect; // r1+0xCC
    struct xSphere sphere; // r1+0x18
    struct xIsect isect; // r1+0xA0
    struct xTriggerAsset * tasset; // r29
    struct xCylinder cylinder; // r1+0x34
    struct xIsect isect; // r1+0x74
    struct xTriggerAsset * tasset; // r30
    struct xSphere sphere; // r1+0x8
    struct xIsect isect; // r1+0x48
    struct xTriggerAsset * tasset; // r28
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D627DA
// Range: 0x80153A5C -> 0x80153BD8
void zEntTriggerEventCB(struct xBase * to /* r27 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r31 */, struct xBase * toParamWidget /* r28 */) {
    // Local variables
    struct zEntTrigger * trig; // r30
    struct xTriggerAsset * tasset; // r29
    float mt; // f31
    float mt; // f30
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D627ED
// total size: 0x0
...
// Range: 0x80153BD8 -> 0x80153CD0
void zEntTriggerSave(struct zEntTrigger * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D627FD
// Range: 0x80153CD0 -> 0x80153DC8
void zEntTriggerLoad(struct zEntTrigger * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6280D
// Range: 0x80153DC8 -> 0x80153F34
void zEntTriggerReset(struct zEntTrigger * ent /* r31 */) {
    // Local variables
    struct xTriggerAsset * tasset; // r30
    struct xVec3 boxUpper; // r1+0x20
    struct xVec3 boxLower; // r1+0x14
...
// Range: 0x80153F34 -> 0x8015405C
unsigned char zEntTriggerHitsSphere(const struct zEntTrigger & trig /* r29 */, const struct xSphere & o /* r30 */, const struct xVec3 & dir /* r1+0x8 */) {
    // Local variables
    const struct xTriggerAsset & asset; // r31
}

static int sDebugTriggerIdx; // size: 0x4, address: 0x80D62820
static int g_dblog_showusage; // size: 0x4, address: 0x80D6A068
static int g_dblog_listtrig; // size: 0x4, address: 0x80D6A06C
static int g_dblog_solidtrig; // size: 0x4, address: 0x80D6A070
// Range: 0x8015405C -> 0x80154190
static void zEntTriggerDMUsage() {
    // References
    // -> static int g_dblog_showusage;
}

// Range: 0x80154190 -> 0x80154314
static void zEntTriggerDMKeystroke() {
    // References
    // -> struct zGlobals globals;
    // -> static int sDebugTriggerIdx;
    // -> static int g_dblog_listtrig;
    // -> unsigned char gDrawAllTriggers;
    // -> static int g_dblog_showusage;
    // -> static int g_dblog_solidtrig;
}

static int been_here; // size: 0x4, address: 0x80D6A074
static char __FUNCTION__[21]; // size: 0x15, address: 0x8051D8A8
// Range: 0x80154314 -> 0x80154600
static void zEntTriggerDMMessage() {
    // Local variables
    int i; // r30
    struct zEnt * trig; // r31
...
// Range: 0x80154600 -> 0x80154818
void zEntTriggerDMDrawthem() {
    // Local variables
    int i; // r31
    struct zEnt * trig; // r30
    ...
    // -> static int sDebugTriggerIdx;
    // -> struct xColor_tag g_LIGHT_PIMP_GOLD;
...
// Range: 0x80154818 -> 0x80154854
void zEntTriggerDebugModeCB() {
    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x8051D8BD
...
// Range: 0x80154854 -> 0x8015544C
void zEntTriggerDebugDraw(struct xBase * btrig /* r20 */) {
    // Local variables
    struct zEntTrigger * trig; // r31
    struct xTriggerAsset * tasset; // r30
    struct xVec3 v[8]; // r1+0x140
    int i; // r28
    int cullmode; // r29
    struct xColor_tag color; // r1+0xAC
    struct xVec3 dir; // r1+0xBC
    struct xVec3 dir; // r1+0xB0
    struct xVec3 v[8]; // r1+0xE0
    int i; // r27
    int cullmode; // r26
    struct xColor_tag tmpC; // r1+0xA8
    struct xBox box; // r1+0xC8
    ...
    // -> struct xColor_tag g_LIGHT_PIMP_GOLD;
    // -> unsigned char gDrawHeightVolumes;
    // -> struct xColor_tag g_DIRTY_BLUE;
    // -> static char __FUNCTION__[21];
}

// Range: 0x8015544C -> 0x801559D4
unsigned char xRayHitsTrigger(const struct xVec3 & start /* r30 */, const struct xVec3 & end /* r29 */, const struct xBox & b /* r31 */, unsigned char & end_inside /* r28 */) {
    // Local variables
    float hit_x; // r1+0x10
    float hit_y; // r1+0xC
    float hit_z; // r1+0x8
...
// Range: 0x801559D4 -> 0x80155A6C
unsigned char xRayHitsPlaneZ(const struct xVec3 & start /* r3 */, const struct xVec3 & end /* r4 */, float plane /* f1 */, float & x /* r5 */, float & y /* r6 */) {
    // Local variables
    float z_total; // f31
    float percent; // f30
}

// Range: 0x80155A6C -> 0x80155B04
unsigned char xRayHitsPlaneY(const struct xVec3 & start /* r3 */, const struct xVec3 & end /* r4 */, float plane /* f1 */, float & x /* r5 */, float & z /* r6 */) {
    // Local variables
    float y_total; // f31
    float percent; // f30
}

// Range: 0x80155B04 -> 0x80155B9C
unsigned char xRayHitsPlaneX(const struct xVec3 & start /* r3 */, const struct xVec3 & end /* r4 */, float plane /* f1 */, float & y /* r5 */, float & z /* r6 */) {
    // Local variables
    float x_total; // f31
    float percent; // f30
}

// Range: 0x80155B9C -> 0x80155CDC
unsigned char xRayHitsTrigger(const struct xVec3 & start /* r1+0x8 */, const struct xVec3 & end /* r1+0xC */, const struct xVec3 & dir /* r29 */, const struct xSphere & s /* r31 */, unsigned char & end_inside /* r30 */) {
    // Local variables
    float radius_squ; // f31
    struct xVec3 end_to_sphere; // r1+0x28
    struct xVec3 start_to_sphere; // r1+0x1C
    struct xVec3 out_vec; // r1+0x10
}
...
class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD4, address: 0x80CF1308
// total size: 0x1
class zSpecialTriggersTree {
    // Static members
    static class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD4
};
// Range: 0x80155CDC -> 0x80155DCC
void zSpecialTriggersTree::UpdateMinMax(struct zEntTrigger * trigger /* r29 */, float & min /* r30 */, float & max /* r31 */) {
    // Local variables
    struct xBox box; // r1+0x14
    struct xVec3 span; // r1+0x8
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D62824
// Range: 0x80155DCC -> 0x80156074
void zSpecialTriggersTree::SceneEnter() {
    // Local variables
    struct xBox worldBox; // r1+0x28
    int i; // r31
    struct zEntTrigger * trigger; // r30
    struct xBox box; // r1+0x10
    const struct xBox * jspbox; // r29
    const struct xBox * endJspBox; // r28
    char assertString[256]; // r1+0x40
    float maxVolWidth; // r1+0xC
    float minVolWidth; // r1+0x8

    // References
    // -> struct zGlobals globals;
    // -> class xSpacePartitionTree2D SpecialTriggersTree;
    // -> static char __FUNCTION__[11];
}

static unsigned char done; // size: 0x1, address: 0x80D6A078
static signed char init; // size: 0x1, address: 0x80D6A079
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D6282F
// total size: 0xC
struct /* @class$1253zEntTrigger_cpp */ {
    // Members
...
// Range: 0x80156074 -> 0x801563C4
int zSpecialTriggersTree::IntersectingSphere(const struct xVec3 & pos /* r25 */, float radius /* f31 */, unsigned short triggerFilter /* r19 */, unsigned short entFilter /* r20 */, int maxTriggers /* r26 */, struct zEntTrigger * * triggerList /* r21 */) {
    // Local variables
    int i; // r30
    union entry_data * nearByTriggers[48]; // r1+0x84
    int numNearByTriggers; // r29
    int numFoundTriggers; // r28
    struct zEntTrigger * trigger; // r31
    struct xTriggerAsset triggerAsset; // r1+0x44
    unsigned short triggerFlags; // r27
    unsigned short entFlags; // r22
    struct xSphere bound; // r1+0x8
...
// Range: 0x801563C4 -> 0x80156418
struct zEntTrigger * zSpecialTriggersTree::IntersectingSphere(const struct xVec3 & pos /* r1+0x8 */, float radius /* r1+0xC */, unsigned short triggerFilter /* r1+0x10 */, unsigned short entFilter /* r1+0x12 */) {
    // Local variables
    struct zEntTrigger * triggers[1]; // r1+0x14
}

static unsigned char done; // size: 0x1, address: 0x80D6A07A
static signed char init; // size: 0x1, address: 0x80D6A07B
static unsigned char done; // size: 0x1, address: 0x80D6A07C
static signed char init; // size: 0x1, address: 0x80D6A07D
static unsigned char done; // size: 0x1, address: 0x80D6A07E
static signed char init; // size: 0x1, address: 0x80D6A07F
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8051D8D2
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x80156418 -> 0x80156B70
unsigned char zSpecialTriggersTree::xEntIntersectsJumpTrigger(const struct xEnt & ent /* r31 */, const struct zEntTrigger & trigger /* r28 */, struct xVec3 & desiredMoveUnitDirection /* r23 */, struct xVec3 & landingPos /* r27 */, const struct xEnt * humanPlayer /* r25 */, struct xVec3 * jumpDirection /* r26 */) {
    // Local variables
    char errMessage[256]; // r1+0x88
    struct xTriggerAsset triggerAsset; // r1+0x48
    float planeDist[4]; // r1+0x14
    int i; // r30
    int closeFace; // r29
    float jumpDistance; // f30
    unsigned char closeFaceFound; // r24
    float distanceToCheck; // f29
    struct xVec3 entPos; // r1+0x8
    struct xRay3 ray; // r1+0x24
    float facingDotProduct; // f31
...
// Range: 0x80156B70 -> 0x80156DE0
void zSpecialTriggersTree::CheckAgainstEnt(const struct zEntTrigger & trigger /* r31 */, const struct xEnt & humanPlayer /* r25 */, int closeFace /* r27 */, struct xVec3 & landingPos /* r28 */, struct xVec3 * jumpDirection /* r29 */) {
    // Local variables
    struct xVec3 oldLandingPos; // r1+0x14
    struct xVec3 collideEntPos; // r1+0x8
    int newCloseFace; // r30
    float dist; // f31
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D62842
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x80156DE0 -> 0x80156EF8
void zSpecialTriggersTree::GetTolerance(struct zEntTrigger * trigger /* r31 */, float & toleranceLow /* r29 */, float & toleranceHigh /* r30 */) {
    // Local variables
    struct xVec3 boxUpperVert; // r1+0x14
    struct xVec3 boxLowerVert; // r1+0x8
