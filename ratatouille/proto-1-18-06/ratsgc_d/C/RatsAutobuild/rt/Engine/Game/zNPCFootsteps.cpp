/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCFootsteps.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802985FC -> 0x80298880
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1150zNPCFootsteps_cpp */ {
    // Members
...
struct zNPCFootstep {
    // Members
    unsigned int animID; // offset 0x0, size 0x4
    float animTime; // offset 0x4, size 0x4
    float animDuration; // offset 0x8, size 0x4
    unsigned int boneID; // offset 0xC, size 0x4
    float emit_remaining; // offset 0x10, size 0x4
    struct zShrapnelAsset * frag; // offset 0x14, size 0x4
    struct config * config; // offset 0x18, size 0x4
};
struct zNPCFootstep * footstepTables[16]; // size: 0x40, address: 0x80D2AF68
// total size: 0x1
class zNPCFootstepsManager {
    // Static members
    static struct zNPCFootstep * footstepTables[16]; // size: 0x40
};
// Range: 0x802985FC -> 0x8029862C
void zNPCFootstepsManager::Init() {
    // References
    // -> struct zNPCFootstep * footstepTables[16];
}
...
// total size: 0x4
struct /* @class$2115zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2074zNPCFootsteps_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2075zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2076zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2073zNPCFootsteps_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2078zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$832zNPCFootsteps_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$768zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zNPCFootsteps_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zNPCFootsteps_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zNPCFootsteps_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zNPCFootsteps_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zNPCFootsteps_cpp */ {
    // Members
...
// Range: 0x8029862C -> 0x80298880
void zNPCFootstepsManager::UpdateFootsteps(class zNPCCommon * npc /* r29 */, float dt /* f29 */) {
    // Local variables
    struct zNPCFootstep * table; // r31
    int i; // r30
    float tym_animCurr; // f31
    float tym_animDur; // r1+0x10
    float tym_animPlusTime; // f30
    struct xVec3 vel; // r1+0x14
    struct xMat4x3 * mat; // r28
    struct xMat4x3 boneInWorld; // r1+0x20
...
// total size: 0x890
struct /* @class$1897zNPCFootsteps_cpp */ {
    // Static members
...
union /* @class$819zNPCFootsteps_cpp */ {
...
// total size: 0xC
struct /* @class$1288zNPCFootsteps_cpp */ {
    // Members
