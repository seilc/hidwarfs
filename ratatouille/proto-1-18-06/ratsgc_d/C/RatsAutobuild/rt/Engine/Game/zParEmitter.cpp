/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8018D114 -> 0x8018D1C8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$956zParEmitter_cpp */ {
    // Members
...
union /* @class$791zParEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1103zParEmitter_cpp */ {
    // Members
...
// Range: 0x8018D114 -> 0x8018D194
struct zParEmitter * zParEmitterFind(unsigned int asset_id /* r3 */) {
    // Local variables
    struct zScene * s; // r31
    int total; // r28
    struct zParEmitter * pe; // r30
    int i; // r29
...
// Range: 0x8018D194 -> 0x8018D1C8
struct zParEmitter * zParEmitterFind(const char * asset_name /* r1+0x8 */) {
    // Local variables
    unsigned int asset_id; // r31
}
