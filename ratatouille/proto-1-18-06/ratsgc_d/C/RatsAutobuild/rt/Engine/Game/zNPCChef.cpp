/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCChef.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802FEDE8 -> 0x802FF140
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TOLERANCE_DISTANCE; // size: 0x4, address: 0x80D67230
static float PLAYER_TOLERANCE_DISTANCE2; // size: 0x4, address: 0x80D6B7C0
// total size: 0x30
class zNPCChefIdle : public zBehaviorImplementation {
    // Functions
    void enterBehavior();
};
// Range: 0x802FEDE8 -> 0x802FEE50
void zNPCChefIdle::create_anim_table(struct xAnimTable * table /* r1+0x18 */) {}

// Range: 0x802FEE50 -> 0x802FEE94
// this: r1+0x8
void zNPCChefIdle::enterBehavior() {}

// Range: 0x802FEE94 -> 0x802FEEA8
void zNPCChefIdle::updateBehavior() {
    // Local variables
    int doingnothing; // r1+0x8
}

// Range: 0x802FEEA8 -> 0x802FEEAC
void zNPCChefIdle::debugRender() {}

// total size: 0x68
class zNPCChefRun : public zNPCMove {
    // Members
    struct xVec3 targetPos; // offset 0x54, size 0xC
    float timeElapsed; // offset 0x60, size 0x4
    unsigned char arrived; // offset 0x64, size 0x1
};
// Range: 0x802FEEAC -> 0x802FEF18
void zNPCChefRun::create_anim_table(struct xAnimTable * table /* r1+0x18 */) {}
...
// total size: 0x1D4
struct {} zNPCChef::__vtable; // size: 0x1D4, address: 0x80529CA8
// total size: 0xFC0
class zNPCChef : public zNPCCommon {
    // Functions
    zNPCChef();
    ...
    // Members
    class zNPCChefIdle * idleState; // offset 0xFB0, size 0x4
    class zNPCChefRun * moveState; // offset 0xFB4, size 0x4
};
// Range: 0x802FEF18 -> 0x802FEF54
// this: r31
zNPCChef::zNPCChef() {
    // References
    // -> struct [anonymous] zNPCChef::__vtable;
}

// Range: 0x802FEF54 -> 0x802FEF90
void zNPCChef::create_anim_table(struct xAnimTable * table /* r31 */) {}

// Range: 0x802FEF90 -> 0x802FF008
// this: r31
void zNPCChef::BuildStateMachine() {}
...
// total size: 0x4
struct /* @class$2049zNPCChef_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zNPCChef_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zNPCChef_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zNPCChef_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zNPCChef_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zNPCChef_cpp */ {
    // Members
...
// Range: 0x802FF008 -> 0x802FF098
// this: r31
void zNPCChef::init(class zNPCInstance * init_inst /* r1+0x8 */) {}

// Range: 0x802FF098 -> 0x802FF0D8
// this: r31
void zNPCChef::SetDefaultAndEventStates() {}

// Range: 0x802FF0D8 -> 0x802FF140
// this: r26
unsigned char zNPCChef::systemEvent(struct xBase * from /* r27 */, struct xBase * to /* r28 */, unsigned int to_event /* r31 */, const float * to_param /* r29 */, struct xBase * to_param_widget /* r30 */, unsigned int to_param_widget_id /* r1+0x8 */) {}
...
// total size: 0x11C
struct {} zNPCChefIdle::__vtable; // size: 0x11C, address: 0x80529E7C
