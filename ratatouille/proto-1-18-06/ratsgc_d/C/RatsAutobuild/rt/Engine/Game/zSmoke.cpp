/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSmoke.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801DADE8 -> 0x801DD98C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float magnitude_freq; // size: 0x4, address: 0x80D63FB0
static float magnitude_min; // size: 0x4, address: 0x80D63FB4
static float magnitude_max; // size: 0x4, address: 0x80D63FB8
static float yaw_freq; // size: 0x4, address: 0x80D63FBC
static float yaw_min; // size: 0x4, address: 0x80D63FC0
static float yaw_max; // size: 0x4, address: 0x80D63FC4
static float pitch_freq; // size: 0x4, address: 0x80D63FC8
static float pitch_min; // size: 0x4, address: 0x80D63FCC
static float pitch_max; // size: 0x4, address: 0x80D63FD0
// total size: 0x8
struct substr {
    // Members
...
// total size: 0x1
struct /* @class$806zSmoke_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$807zSmoke_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$808zSmoke_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$809zSmoke_cpp */ {
    // Members
...
static struct tweak_callback cb_deg_lteq; // size: 0x28, address: 0x804B6380
static struct tweak_callback cb_deg_gteq; // size: 0x28, address: 0x804B63A8
...
static float wind_magnitude_time; // size: 0x4, address: 0x80D6AC40
static float wind_yaw_time; // size: 0x4, address: 0x80D6AC44
static float wind_pitch_time; // size: 0x4, address: 0x80D6AC48
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 wind_delta; // size: 0xC, address: 0x80D6AC4C
// total size: 0x8
...
static class xParticleBatchGroup batch_group; // size: 0x8, address: 0x80D6AC58
static class zSmokeEmitter * hilighted; // size: 0x4, address: 0x80D6AC60
// total size: 0x18
struct analog_data {
    // Members
...
// Range: 0x801DAFDC -> 0x801DB33C
static int update_particles(unsigned char * mem /* r19 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__pos_color_size_uv2 & _fptank_pool; // r30
    int _fptank_used; // r29
    struct xVec3 * pool_pos; // r27
    struct xColor_tag * pool_color; // r26
    struct xVec2 * pool_size; // r25
    struct xVec2 * pool_uv; // r28
    struct smoke_particle * p; // r31
    struct smoke_particle * end; // r24
    float oldsize; // f27
...
// Range: 0x801DB33C -> 0x801DB3B4
static void set_system(struct xParticleBatchSystem & system /* r3 */, struct RwTexture * texture /* r4 */, unsigned char behind_fire /* r5 */) {}
...
// Range: 0x801DB3B4 -> 0x801DB4E0
static void perturb_dir(struct xVec3 & dir /* r31 */, float mag /* f28 */) {
    // Local variables
...
// Range: 0x801DB4E0 -> 0x801DB7C8
static void update_wind(float dt /* f26 */) {
    // Local variables
    float magnitude_range; // f22
    float magnitude; // f31
    float yaw_range; // f21
    float yaw; // f29
    float pitch_range; // f20
    float pitch; // f28
    float sy; // f25
    float cy; // f24
    float sp; // f23
...
static struct asset_type dummy_asset; // size: 0x80, address: 0x80D13D20
// total size: 0x20
struct xLinkAsset {
    // Members
...
static class zSmokeEmitter dummy_emitter; // size: 0xA0, address: 0x80D13DA0
// Range: 0x801DB7C8 -> 0x801DB9BC
...
// Range: 0x801DB9BC -> 0x801DB9E8
static void debug_init() {
    // References
    // -> static class zSmokeEmitter * hilighted;
}

// Range: 0x801DB9E8 -> 0x801DBA2C
...
// Range: 0x801DBA2C -> 0x801DBA30
void zSmokeSceneExit() {}

// Range: 0x801DBA30 -> 0x801DBA64
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D63FD4
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x801DBA64 -> 0x801DBFC8
void zSmokeEmitSphere(int system_id /* r21 */, const struct zSmokeSphereVolume & volume /* r31 */, int amount /* r29 */) {
    // Local variables
    float size_min; // f31
    float size_rand_scale; // f26
    float age_rate_min; // f30
    float age_rate_max; // f25
    float age_rate_rand_scale; // f24
    struct xColor_tag color_birth; // r1+0x24
    float dr; // f23
    float dg; // f22
    float db; // f21
    float da; // f20
    ...
    float cy; // f18
    float cz; // r1+0x20
    float radius; // r1+0x1C
    struct xVec3 vel_dir; // r1+0x28
    float vel_dir_vary; // r1+0x18
    float vel_min; // f29
    float vel_rand_scale; // r1+0x14
    float growth; // r1+0x10
    float wind; // r1+0xC
    int texture_rows; // r28
    int max_frame; // r25
    float du; // f28
    float dv; // f27
    unsigned char * mem; // r1+0x8
    int have; // r27
    struct smoke_particle * p; // r30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D63FE5
// Range: 0x801DC0C8 -> 0x801DC280
void zSmokeEmitter::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x801DC280 -> 0x801DC290
char * asset_type::type_name() {}

// Range: 0x801DC290 -> 0x801DC520
// this: r31
void zSmokeEmitter::load(const struct asset_type & a /* r1+0x10 */) {
    // Local variables
    struct xMat3x3 dir_mat; // r1+0x20
    float age_rate_max; // f31
}

// Range: 0x801DC520 -> 0x801DC75C
// this: r31
...
// Range: 0x801DC75C -> 0x801DC774
// this: r3
void zSmokeEmitter::reset() {}

// Range: 0x801DC774 -> 0x801DCA44
// this: r31
void zSmokeEmitter::update(float dt /* f30 */) {
    // Local variables
    float rate; // f31
    int emit; // r29
    unsigned char * mem; // r1+0x8
    int have; // r28
    struct smoke_particle * p; // r30
    struct smoke_particle * endp; // r26
    int frame; // r27
    int ui; // r25
    int vi; // r24
}
...
// Range: 0x801DCA44 -> 0x801DCB28
// this: r31
void zSmokeEmitter::prepare_volume(struct zSmokeSphereVolume & volume /* r30 */) const {}

// Range: 0x801DCB28 -> 0x801DCB80
// this: r31
...
// Range: 0x801DCC80 -> 0x801DCD28
void zSmokeEmitter::update_all(float dt /* f31 */) {
    // Local variables
    struct zScene & scene; // r30
    class zSmokeEmitter * it; // r31
    class zSmokeEmitter * end; // r29
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63FEA
// Range: 0x801DCD28 -> 0x801DCE78
void zSmokeEmitter::cb_dispatch(struct xBase * to /* r30 */, unsigned int event /* r1+0x8 */) {
    // Local variables
...
static struct tweak_callback cb_hilight; // size: 0x28, address: 0x804B63D0
static struct tweak_callback cb_move; // size: 0x28, address: 0x804B63F8
static struct tweak_callback cb_move_dir; // size: 0x28, address: 0x804B6420
static struct tweak_callback cb_frame; // size: 0x28, address: 0x804B6448
static struct tweak_callback cb_life; // size: 0x28, address: 0x804B6470
static struct tweak_callback cb_vel_dir; // size: 0x28, address: 0x804B6498
static struct tweak_callback cb_color; // size: 0x28, address: 0x804B64C0
struct tweak_callback cb_tweak_convert_degrees; // size: 0x28, address: 0x80478090
// Range: 0x801DD0EC -> 0x801DD654
// this: r31
...
enum /* @enum$2042zSmoke_cpp */ {
    FLAG_ON = 1,
    FLAG_BEHIND_FIRE = 2,
};
// Range: 0x801DD654 -> 0x801DD660
void zSmokeEmitter::enable_hilight(const struct tweak_info & info /* r3 */) {
    // References
    // -> static class zSmokeEmitter * hilighted;
}

// Range: 0x801DD660 -> 0x801DD66C
void zSmokeEmitter::disable_hilight() {
    // References
    // -> static class zSmokeEmitter * hilighted;
}

// Range: 0x801DD66C -> 0x801DD6E8
void zSmokeEmitter::on_move(const struct tweak_info & info /* r29 */) {
    // Local variables
    class zSmokeEmitter & e; // r30
    struct asset_type & a; // r31
}

// Range: 0x801DD6E8 -> 0x801DD770
void zSmokeEmitter::on_change_frame(const struct tweak_info & info /* r3 */) {
    // Local variables
    class zSmokeEmitter & e; // r31
}

// Range: 0x801DD770 -> 0x801DD7CC
void zSmokeEmitter::on_change_life(const struct tweak_info & info /* r3 */) {
    // Local variables
    class zSmokeEmitter & e; // r31
    struct asset_type & a; // r30
    float age_rate_max; // f31
...
// Range: 0x801DD7CC -> 0x801DD868
void zSmokeEmitter::on_change_vel_dir(const struct tweak_info & info /* r29 */) {
    // Local variables
    class zSmokeEmitter & e; // r30
    struct asset_type & a; // r31
    struct xMat3x3 dir_mat; // r1+0x10
...
// Range: 0x801DD868 -> 0x801DD98C
void zSmokeEmitter::on_change_color(const struct tweak_info & info /* r3 */) {
    // Local variables
    class zSmokeEmitter & e; // r30
    struct asset_type & a; // r31
}
