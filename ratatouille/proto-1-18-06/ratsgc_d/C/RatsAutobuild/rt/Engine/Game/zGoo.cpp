/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGoo.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027C2BC -> 0x8027C850
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zGooParams * zgoo_gps; // size: 0x4, address: 0x80D6B2E0
static int zgoo_ngps; // size: 0x4, address: 0x80D6B2E4
static int zgoo_nused; // size: 0x4, address: 0x80D6B2E8
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65AF8
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8027C2BC -> 0x8027C42C
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D65B01
// Range: 0x8027C448 -> 0x8027C6E0
int zGooAdd(struct xEnt * obj /* r31 */, float depth /* f31 */, int freezeGroup /* r1+0x8 */) {
    // Local variables
    int validGoo; // r27
    int i; // r29
    struct zGooParams * gp; // r30
...
// Range: 0x8027C6E0 -> 0x8027C7C8
int zGooIs(struct xEnt * obj /* r28 */, float & depth /* r30 */, unsigned int playerCheck /* r1+0x8 */) {
    // Local variables
    int ret; // r29
    int i; // r31
...
// Range: 0x8027C7C8 -> 0x8027C850
void zGooMeltFinished(struct RpAtomic * atomic /* r1+0x8 */) {
    // Local variables
    int i; // r31
    struct xEnt * gooey; // r30
