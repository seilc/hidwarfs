/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXPunchStars.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027D3A4 -> 0x8027DF7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80D6B2F8
// total size: 0x5C
struct config {
    // Members
...
class punch_stars {
    ...
    static int system_id; // size: 0x4
    static struct config default_config; // size: 0x5C
};
// Range: 0x8027D3A4 -> 0x8027D50C
void punch_stars::setup() {
    // References
    // -> struct config default_config;
    // -> unsigned char need_setup;
}

int system_id; // size: 0x4, address: 0x80D65B20
// total size: 0x28
...
// Range: 0x8027D50C -> 0x8027D59C
void punch_stars::scene_setup() {
    // Local variables
...
// Range: 0x8027D59C -> 0x8027DA58
void punch_stars::add_tweaks(const char * prefix /* r30 */, struct config * cfg /* r31 */) {}
...
// total size: 0xC
struct /* @class$768zFXPunchStars_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zFXPunchStars_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zFXPunchStars_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zFXPunchStars_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zFXPunchStars_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zFXPunchStars_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zFXPunchStars_cpp */ {
    // Members
...
// Range: 0x8027DA58 -> 0x8027DC90
void punch_stars::emit(const struct xVec3 & position /* r1+0x8 */, float & emit_remaining /* r30 */, const struct xVec3 & velocity /* r26 */, float dt /* f30 */, struct config * cfg /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1150zFXPunchStars_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zFXPunchStars_cpp */ {
    // Members
...
union /* @class$819zFXPunchStars_cpp */ {
...
// total size: 0x10
struct /* @class$832zFXPunchStars_cpp */ {
    // Members
...
// Range: 0x8027DC90 -> 0x8027DF7C
int punch_stars::update(unsigned char * mem /* r26 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
