/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCSimpleton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803384DC -> 0x80338678
*/
char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<19zCompLogicSimpleton,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67B88
signed char zComponentPool<zCompLogicSimpleton, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB08
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicSimpleton, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB0C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// total size: 0x68
class zNPCSimpleton : public zNPCBase {
    // Functions
...
// Range: 0x803384DC -> 0x8033857C
// this: r31
unsigned char zNPCSimpleton::Activate() {}
...
// Range: 0x8033857C -> 0x803385A4
// this: r1+0x8
void zNPCSimpleton::Deactivate() {}

// Range: 0x803385A4 -> 0x8033862C
// this: r29
void zNPCSimpleton::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1032zNPCSimpleton_cpp */ {
    // Members
...
union /* @class$1172zNPCSimpleton_cpp */ {
...
// total size: 0xC
struct /* @class$1170zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$858zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$861zNPCSimpleton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$862zNPCSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$863zNPCSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$864zNPCSimpleton_cpp */ {
    // Members
...
// Range: 0x8033862C -> 0x80338678
// this: r30
void zNPCSimpleton::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x3C
struct {} zNPCSimpleton::__vtable; // size: 0x3C, address: 0x8052E8A0
