/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRatBallPlayerActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8030A870 -> 0x8030D368
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$928zRatBallPlayerActions_cpp */ {
    // Members
...
union /* @class$1067zRatBallPlayerActions_cpp */ {
...
static unsigned char sShowNearestTrack; // size: 0x1, address: 0x80D6B898
static float GRAVITY; // size: 0x4, address: 0x80D67408
static float MAX_ACCELERATION; // size: 0x4, address: 0x80D6740C
static float min_speed; // size: 0x4, address: 0x80D67410
static float norm_speed; // size: 0x4, address: 0x80D67414
static float max_speed; // size: 0x4, address: 0x80D67418
static float ORIENTATION_ELASTIC; // size: 0x4, address: 0x80D6741C
static float COLLISION_REFLECTION_VERTICAL; // size: 0x4, address: 0x80D67420
static float COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x80D67424
static float FAST_MULT; // size: 0x4, address: 0x80D67428
static float MAX_ORIENT_ROT; // size: 0x4, address: 0x80D6742C
static float WEIGHT; // size: 0x4, address: 0x80D67430
static float KNOCKBACK_DIST; // size: 0x4, address: 0x80D67434
static float BIG_EPSILON; // size: 0x4, address: 0x80D67438
static unsigned char fastTrack; // size: 0x1, address: 0x80D6B899
// total size: 0x10
struct rest_config {
    // Members
...
struct asset_type : public xDynAsset {
    // Members
    unsigned int track; // offset 0x10, size 0x4
    unsigned int fastTrack; // offset 0x14, size 0x4
    float minSpeed; // offset 0x18, size 0x4
    float normSpeed; // offset 0x1C, size 0x4
    float maxSpeed; // offset 0x20, size 0x4
};
// total size: 0x6C
struct zRaftTrack : public xBase {
    // Members
    const struct asset_type * asset; // offset 0x10, size 0x4
    int trackCount; // offset 0x14, size 0x4
    struct xEnt * trackEnt[10]; // offset 0x18, size 0x28
    int fastTrackCount; // offset 0x40, size 0x4
    struct xEnt * fastTrackEnt[10]; // offset 0x44, size 0x28
};
// total size: 0x5A0
class zRatBallPlayerDrive : public zPlayerAction {
    // Functions
    void AddTweaks();
    ...
    void ApplyCollisionRebounds(struct xVec3 * pVelocity);

    void DepenetrateCollisionList(struct xVec3 * pPosition);

    void SlideTrackUpdate();

    // Members
protected:
    struct xMat4x3 physicsMat; // offset 0x10, size 0x40
    struct xVec3 velocity; // offset 0x50, size 0xC
    struct xVec3 oldVelocity; // offset 0x5C, size 0xC
    float steeringPosition; // offset 0x68, size 0x4
    unsigned char initPending; // offset 0x6C, size 0x1
    unsigned char started; // offset 0x6D, size 0x1
    float currSpeed; // offset 0x70, size 0x4
    struct xVec3 acc; // offset 0x74, size 0xC
    int numCollisions; // offset 0x80, size 0x4
    struct xCollis collisions[12]; // offset 0x84, size 0x3F0
    unsigned int collisionUserFlags[12]; // offset 0x474, size 0x30
    struct xBound bound[2]; // offset 0x4A4, size 0x98
    int currBound; // offset 0x53C, size 0x4
    unsigned char inGroundContact; // offset 0x540, size 0x1
    int numTracks; // offset 0x544, size 0x4
    struct zRaftTrack * trackList[10]; // offset 0x548, size 0x28
    struct xVec3 slideTrackDir; // offset 0x570, size 0xC
    unsigned char slideFastTrack; // offset 0x57C, size 0x1
    struct xVec3 slideNormal; // offset 0x580, size 0xC
    float slideMinSpeed; // offset 0x58C, size 0x4
    float slideMaxSpeed; // offset 0x590, size 0x4
    float slideNormSpeed; // offset 0x594, size 0x4
    unsigned char slideNotGroundedSinceSlide; // offset 0x598, size 0x1
    unsigned int slideTrackSliding; // offset 0x59C, size 0x4
};
// Range: 0x8030A870 -> 0x8030AADC
// this: r31
void zRatBallPlayerDrive::AddTweaks() {
    // Local variables
    char prefix[128]; // r1+0x8

    // References
    // -> static unsigned char fastTrack;
    // -> static float FAST_MULT;
    // -> static float MAX_ORIENT_ROT;
    // -> static float ORIENTATION_ELASTIC;
    // -> static float GRAVITY;
    // -> static float max_speed;
    // -> static float norm_speed;
    // -> static float min_speed;
}

// Range: 0x8030AADC -> 0x8030ABA0
// this: r30
void zRatBallPlayerDrive::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8030ABA0 -> 0x8030ABA4
void zRatBallPlayerDrive::AddActionTransitions() {}

// Range: 0x8030ABA4 -> 0x8030AC74
void zRatBallPlayerDrive::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8030AC74 -> 0x8030AC7C
unsigned int zRatBallPlayerDrive::MoveStartCheck() {}

// Range: 0x8030AC7C -> 0x8030AC84
unsigned int zRatBallPlayerDrive::MoveStopCheck() {}

// Range: 0x8030AC84 -> 0x8030AC88
void zRatBallPlayerDrive::AddTransitionsFrom() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6743C
...
// Range: 0x8030AC88 -> 0x8030AD9C
// this: r31
void zRatBallPlayerDrive::Setup() {
    // Local variables
    int i; // r30
...
// Range: 0x8030AD9C -> 0x8030AE50
// this: r31
void zRatBallPlayerDrive::Reset() {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x8030AE50 -> 0x8030AECC
// this: r31
void zRatBallPlayerDrive::Begin() {}

// Range: 0x8030AECC -> 0x8030AED0
void zRatBallPlayerDrive::End() {}

// Range: 0x8030AED0 -> 0x8030AF74
// this: r31
void zRatBallPlayerDrive::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r30 */) {}
...
float RB_PLSBOUND_RADIUS; // size: 0x4, address: 0x80D673E4
// total size: 0x40
...
// Range: 0x8030AF74 -> 0x8030B4DC
// this: r31
void zRatBallPlayerDrive::Physics(float dt /* f23 */) {
    // Local variables
    float x; // r1+0x2C
    float z; // r1+0x28
    float stickCameraAngle; // r1+0x24
    float analogMag; // r1+0x20
    float mult; // f28
    float minSpeed; // f27
    float maxSpeed; // f26
    float normalSpeed; // f25
    struct xVec3 force; // r1+0xA8
    struct xVec3 current; // r1+0x9C
    float testlen; // r1+0x1C
    struct xVec3 arrowBase; // r1+0x90
    struct xMat4x3 playerAbsMat; // r1+0x120
    float deltaAccel; // f31
    float camAngle; // r1+0x18
    struct xMat3x3 drot; // r1+0xF0
    struct xVec3 dir; // r1+0x84
    struct xVec3 zeroAngDir; // r1+0x78
    struct xVec3 * entVel; // r30
    struct xVec3 * entOldVel; // r29
    float speed; // f29
    float newSpeed; // f30
    struct xVec3 newPos; // r1+0x6C
    struct xVec3 newVelocity; // r1+0x60
    struct xVec3 groundNormal; // r1+0x54
    struct xVec3 oldPos; // r1+0x48
    struct xVec3 testVel; // r1+0x3C
    struct xMat3x3 rotMat; // r1+0xC0
    struct xVec3 tempUp; // r1+0x30

    // References
    // -> static float MAX_ORIENT_ROT;
    // -> struct xVec3 m_Null;
    // -> float RB_PLSBOUND_RADIUS;
...
// total size: 0x4
struct /* @class$2197zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2049zRatBallPlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zRatBallPlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2051zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2048zRatBallPlayerActions_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2053zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1358zRatBallPlayerActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$869zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$872zRatBallPlayerActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$873zRatBallPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$874zRatBallPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$875zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1855zRatBallPlayerActions_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67442
// Range: 0x8030B4DC -> 0x8030B6FC
// this: r31
unsigned char zRatBallPlayerDrive::operator()(struct xEnt & ent /* r29 */) {
    // Local variables
    struct xCollis * pCollis; // r30
    int collisionsDetected; // r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D67447
static unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x80D70DA8
// total size: 0x38
struct xGrid {
    // Members
...
float RB_boundYShift; // size: 0x4, address: 0x80D673EC
...
// Range: 0x8030B6FC -> 0x8030BFC0
// this: r31
void zRatBallPlayerDrive::SphereCollision(const struct xVec3 * pNewPosition /* r1+0x10 */, const struct xVec3 * pVelocity /* r1+0x14 */, unsigned char * pInGroundContact /* r1+0x18 */, struct xVec3 * pGroundNormal /* r1+0x1C */) {
    // Local variables
    struct xSphere collisionSphere[1]; // r1+0x94
    int i; // r30
    unsigned int numGroundCollisions; // r28
    struct xVec3 averageGroundNormal; // r1+0x88
    struct xEnt * pEntity; // r29
    struct xVec3 playerPos; // r1+0x7C
    struct xVec3 npcPos; // r1+0x70
    struct xVec3 knockback; // r1+0x64
    struct xVec3 delta; // r1+0x58
    float hitParams[6]; // r1+0xA4
    struct zEntSimpleObj * pSimpleObj; // r25
    float hitParams[4]; // r1+0x48
    struct zPlatform * pPlatform; // r24
    float hitParams[4]; // r1+0x38
    struct xVec3 downVec; // r1+0x2C
    float collisionDownDist; // f30
    unsigned char isLowCollision; // r27
    unsigned char isHighCollision; // r1+0x20
    float normDotUp; // f31
    float angleFromFlat; // f26
    unsigned char isSteepSurface; // r26
    unsigned char drawLine; // r19
    float normDot; // f25
    float downDist; // f24
    float distFromMidShockPos; // f23

    // References
    // -> float RB_boundYShift;
    // -> struct xColor_tag g_GREEN;
...
// Range: 0x8030BFC0 -> 0x8030C23C
// this: r30
void zRatBallPlayerDrive::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r31 */) {
    // Local variables
    int i; // r29
    float normDot; // f31
    float normDotUp; // f30
    float angleFromFlat; // f26
    unsigned char isSteepSurface; // r28
    struct xVec3 tempNorm; // r1+0x8
...
// Range: 0x8030C23C -> 0x8030C374
// this: r31
void zRatBallPlayerDrive::DepenetrateCollisionList(struct xVec3 * pPosition /* r29 */) {
    // Local variables
    int i; // r30
...
// total size: 0xC
struct /* @class$1066zRatBallPlayerActions_cpp */ {
    // Members
...
// Range: 0x8030C374 -> 0x8030C558
void zRatBallPlayerDrive::PreventPoppingThroughWorld(const struct xVec3 * pStartPosition /* r1+0x8 */, struct xVec3 * pEndPosition /* r28 */, struct xVec3 * pVelocity /* r31 */) {
    // Local variables
...
// Range: 0x8030C558 -> 0x8030CBCC
static struct RpCollisionTriangle * nearestTrackCB(struct RpCollisionTriangle * collTriangle /* r29 */, void * data /* r1+0x8 */) {
    // Local variables
    struct TrackPolyData * tpoly; // r31
    float currnear; // f31
    struct xVec3 currpt; // r1+0x68
    int currvert; // r28
    int curredge; // r27
    struct xVec3 xformVert[4]; // r1+0x74
    struct xVec3 xformNorm; // r1+0x5C
    int i; // r30
    float pdx[3]; // r1+0x50
    float pdz[3]; // r1+0x44
    float pcross[3]; // r1+0x38
    float numer; // f29
    float denom; // f28
    float t; // f27
    float closedist2; // r1+0x10
    float testdist2; // f30
    struct xVec3 edgevec; // r1+0x2C
    struct xVec3 centvec; // r1+0x20
    struct xVec3 testpt; // r1+0x14

    // References
    // -> static unsigned char sShowNearestTrack;
    // -> struct xColor_tag g_WHITE;
}

// Range: 0x8030CBCC -> 0x8030CBE8
static float det3x3top1(float m21 /* f1 */, float m22 /* f2 */, float m23 /* f3 */, float m31 /* f4 */, float m32 /* f5 */, float m33 /* f6 */) {}

static unsigned int ZPLAYER_IS_TSLIDING; // size: 0x4, address: 0x80D70DC4
// total size: 0x10
struct xSphere {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
...
struct TrackPolyData {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
    struct xMat4x3 * mat; // offset 0xC, size 0x4
    struct xEnt * testEnt; // offset 0x10, size 0x4
    int triIndex; // offset 0x14, size 0x4
    struct xVec3 vert[3]; // offset 0x18, size 0x24
    float neardist; // offset 0x3C, size 0x4
    struct xVec3 nearpt; // offset 0x40, size 0xC
    int nearvert; // offset 0x4C, size 0x4
    int nearedge; // offset 0x50, size 0x4
    struct xEnt * foundEnt; // offset 0x54, size 0x4
    struct xVec3 norm; // offset 0x58, size 0xC
    float currMinSpeed; // offset 0x64, size 0x4
    float currNormSpeed; // offset 0x68, size 0x4
    float currMaxSpeed; // offset 0x6C, size 0x4
    float minSpeed; // offset 0x70, size 0x4
    float normSpeed; // offset 0x74, size 0x4
    float maxSpeed; // offset 0x78, size 0x4
};
// Range: 0x8030CBE8 -> 0x8030D368
// this: r30
void zRatBallPlayerDrive::SlideTrackUpdate() {
    // Local variables
    struct xCollis colltmp; // r1+0x100
    struct xSphere collsph; // r1+0x38
    struct xQCData qcd; // r1+0x64
    struct RpIntersection isect; // r1+0x48
    struct xVec3 * center; // r31
    struct TrackPolyData tpoly; // r1+0x84
    int triIndex; // r24
    int iRaftTrack; // r23
    struct zRaftTrack * curRaftTrack; // r28
    int i; // r22
    struct xEnt * trackEnt; // r26
    struct RwFrame * frame; // r1+0x10
    struct RpGeometry * geom; // r18
    struct RpTriangle * tri; // r1+0xC
    struct RwTexCoords * tex; // r27
    struct RwV3d * vert; // r17
    unsigned short * triidx; // r29
    struct xVec3 transformedVert0; // r1+0x2C
    struct xVec3 transformedVert1; // r1+0x20
    struct xVec3 transformedVert2; // r1+0x14
    float denom; // f29
    float vcenter; // f27
    float dvdx; // f31
    float dvdz; // f30
    float mag; // f28
    int iRaftTrack; // r21
    struct zRaftTrack * curRaftTrack; // r20
    int i; // r19
    struct xEnt * trackEnt; // r25
    struct RwFrame * frame; // r1+0x8

    // References
    // -> static unsigned char fastTrack;
    // -> struct xVec3 m_Null;
    // -> static unsigned int ZPLAYER_IS_TSLIDING;
}

// total size: 0x54
struct {} zRatBallPlayerDrive::__vtable; // size: 0x54, address: 0x8052CD08
// total size: 0xC
