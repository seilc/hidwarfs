/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomMissionSelect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80282F24 -> 0x80284124
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct {} zUICustomMissionSelect::__vtable; // size: 0x54, address: 0x805250BC
// total size: 0xC
...
// total size: 0x50C
class zUICustomMissionSelect : public zUICustom {
    // Functions
    zUICustomMissionSelect(class zUI * ui);
    ...
    struct xBase * GetColorMotionScene(unsigned int idx);

    void GetArenasLevelCompletion(int i, unsigned char & scene1Comp, unsigned char & scene2Comp, unsigned char & scene3Comp, unsigned char & scene1Unlock, unsigned char & scene2Unlock, unsigned char & scene3Unlock);

    void SetLevelBubblesExtraState(int i, unsigned char & allComplete, unsigned char & allUnlocked, unsigned char setExtraBubbles);

    void SetLevelImageState();
    ...
    int countFromSelectedStage(int stage);

    // Static members
    static int MAX_BUBBLES; // size: 0x4

    // Members
    struct _xCounter * counter; // offset 0x8, size 0x4
    class zUIText * activeDesc; // offset 0xC, size 0x4
    class zUIText * inactiveDesc; // offset 0x10, size 0x4
    class zUIText * activeName; // offset 0x14, size 0x4
    class zUIText * inactiveName; // offset 0x18, size 0x4
    class zUIText * levelGoals; // offset 0x1C, size 0x4
    class zUIImage * blinkyLights[14]; // offset 0x20, size 0x38
    class zUIImage * bubbles[14]; // offset 0x58, size 0x38
    class zUIImage * arrows[4]; // offset 0x90, size 0x10
    class zUIImage * arrowGlows[4]; // offset 0xA0, size 0x10
    class zUIImage * bubblesExtra[3]; // offset 0xB0, size 0xC
    class zUIImage * bubblesExtraGlow[3]; // offset 0xBC, size 0xC
    struct xBase * soundFXPing; // offset 0xC8, size 0x4
    struct xBase * soundFXDeny; // offset 0xCC, size 0x4
    struct xBase * soundFXConfirm; // offset 0xD0, size 0x4
    struct xBase * motionOutLeft; // offset 0xD4, size 0x4
    struct xBase * motionInLeft; // offset 0xD8, size 0x4
    struct xBase * motionInRight; // offset 0xDC, size 0x4
    struct xBase * motionOutRight; // offset 0xE0, size 0x4
    struct xBase * motionOutUp; // offset 0xE4, size 0x4
    struct xBase * motionInUp; // offset 0xE8, size 0x4
    struct xBase * motionInDown; // offset 0xEC, size 0x4
    struct xBase * motionOutDown; // offset 0xF0, size 0x4
    struct xBase * motionInvisible; // offset 0xF4, size 0x4
    struct xBase * motionBlink; // offset 0xF8, size 0x4
    int selectedStage; // offset 0xFC, size 0x4
    int selectedMission; // offset 0x100, size 0x4
    int numStoryScenes; // offset 0x104, size 0x4
    int numArenaScenes; // offset 0x108, size 0x4
    char descBuff[1024]; // offset 0x10C, size 0x400
};
// Range: 0x80282F24 -> 0x80282F7C
// this: r31
zUICustomMissionSelect::zUICustomMissionSelect(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomMissionSelect::__vtable;
}
...
// Range: 0x80282F7C -> 0x80282FA4
// this: r1+0x8
void zUICustomMissionSelect::Init() {}

// Range: 0x80282FA4 -> 0x80282FCC
// this: r1+0x8
void zUICustomMissionSelect::Exit() {}

const char * bubbleTextFormat; // size: 0x4, address: 0x80D65BC0
const char * glowTextFormat; // size: 0x4, address: 0x80D65BC4
// Range: 0x80282FCC -> 0x802833E8
// this: r31
void zUICustomMissionSelect::Setup() {
    // Local variables
    char temp[64]; // r1+0x18
    signed short i; // r30
    char * dir[4]; // r1+0x8
    const char * arrowFormat; // r29

    // References
    // -> const char * bubbleTextFormat;
    // -> const char * glowTextFormat;
}

// Range: 0x802833E8 -> 0x80283410
// this: r1+0x8
void zUICustomMissionSelect::Reset() {}

// Range: 0x80283410 -> 0x80283444
// this: r31
void zUICustomMissionSelect::PreUpdate(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r30
    int j; // r29
    int j; // r28
...
// total size: 0x2
struct /* @class$1142zUICustomMissionSelect_cpp */ {
    // Members
...
// Range: 0x80283444 -> 0x802834D8
struct xBase * zUICustomMissionSelect::GetColorMotion(unsigned char completed /* r1+0x8 */, unsigned char unlocked /* r1+0x9 */) {
    // Local variables
    unsigned int size; // r1+0xC
}

// Range: 0x802834D8 -> 0x80283530
// this: r1+0x8
struct xBase * zUICustomMissionSelect::GetColorMotionScene(unsigned int idx /* r31 */) {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x805250A0
// Range: 0x80283530 -> 0x80283640
// this: r1+0x8
void zUICustomMissionSelect::GetArenasLevelCompletion(int i /* r1+0xC */, unsigned char & scene1Comp /* r25 */, unsigned char & scene2Comp /* r26 */, unsigned char & scene3Comp /* r27 */, unsigned char & scene1Unlock /* r28 */, unsigned char & scene2Unlock /* r29 */, unsigned char & scene3Unlock /* r30 */) {
    // Local variables
    int j; // r31
...
// Range: 0x80283640 -> 0x802837F0
// this: r30
void zUICustomMissionSelect::SetLevelBubblesExtraState(int i /* r1+0x8 */, unsigned char & allComplete /* r24 */, unsigned char & allUnlocked /* r25 */, unsigned char setExtraBubbles /* r1+0xC */) {
    // Local variables
    unsigned char scene1Comp; // r1+0x12
    unsigned char scene2Comp; // r1+0x11
    unsigned char scene3Comp; // r1+0x10
    unsigned char scene1Unlock; // r1+0xF
    unsigned char scene2Unlock; // r1+0xE
    unsigned char scene3Unlock; // r1+0xD
    struct xBase * motionExtra; // r31
}

// Range: 0x802837F0 -> 0x8028381C
// this: r3
void zUICustomMissionSelect::SetLevelImageState() {
    // Local variables
    struct xBase * motion; // r30
    int i; // r31
    unsigned char allComplete; // r29
    unsigned char allUnlocked; // r28
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65BC8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$990zUICustomMissionSelect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1155zUICustomMissionSelect_cpp */ {
    // Members
...
union /* @class$858zUICustomMissionSelect_cpp */ {
...
// total size: 0x10
struct /* @class$1695zUICustomMissionSelect_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1938zUICustomMissionSelect_cpp */ {
    // Static members
...
// Range: 0x8028381C -> 0x80283F5C
// this: r31
unsigned char zUICustomMissionSelect::HandleEvent(struct xBase * from /* r24 */, unsigned int toEvent /* r30 */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    float params[4]; // r1+0x68
    struct xBase * motionOut; // r23
    struct xBase * motionIn; // r22
    int count; // r21
    class zUIText * temp; // r1+0x44
    float params[4]; // r1+0x58
    unsigned short count; // r27
    struct xBase * motion; // r1+0x40
    unsigned char allComplete; // r1+0x1D
    unsigned char allUnlocked; // r1+0x1C
    struct xBase * motionOut; // r29
    struct xBase * motionIn; // r28
    class zUIText * temp; // r20
    unsigned short i; // r26
    float toParams[4]; // r1+0x48
    unsigned int missionTextHash; // r25
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D65BD4
// Range: 0x80283F5C -> 0x802840D8
void zUICustomMissionSelect::SetLevelGoalsState(int i /* r29 */) {
    // Local variables
    struct xBase * picImage; // r31
    struct xBase * conHider; // r30

    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x802840D8 -> 0x80284124
// this: r3
int zUICustomMissionSelect::countFromSelectedStage(int stage /* r4 */) {}
