/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomSysMessage.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80249F78 -> 0x8024AAE8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct {} zUICustomSysMessageManager::__vtable; // size: 0x54, address: 0x80523F70
// total size: 0xC
struct ImageState {
    // Members
...
class zUICustomSysMessageManager : public zUICustom {
    // Functions
    zUICustomSysMessageManager(class zUI * ui);

    void Init();

    unsigned char IsSignalAllowed(unsigned int toEvent);

    void SetInvisible(class zUI * uiElement);
    ...
    void ShowSystemMessage(void (* cb)(struct xBase *, struct xBase *, unsigned int, float *, struct xBase *, unsigned int), unsigned int _toCBEvent, const float * _toCBParams, struct xBase * _toCBto, struct xBase * _toCBParamWidget, unsigned int _toCBParamWidgetID, const char * sys_message);
...
// Range: 0x80249F78 -> 0x8024A058
// this: r31
zUICustomSysMessageManager::zUICustomSysMessageManager(class zUI * ui /* r29 */) {
    // Local variables
    int i; // r30
    ...
    // -> struct [anonymous] zUICustomSysMessageManager::__vtable;
}
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D651D8
// total size: 0xC
...
// Range: 0x8024A058 -> 0x8024A390
// this: r31
void zUICustomSysMessageManager::Init() {
    // Local variables
    struct xGroup * group; // r30

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x8024A390 -> 0x8024A3FC
// this: r3
unsigned char zUICustomSysMessageManager::IsSignalAllowed(unsigned int toEvent /* r4 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D651DD
// Range: 0x8024A3FC -> 0x8024A4B4
// this: r31
void zUICustomSysMessageManager::SetInvisible(class zUI * uiElement /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D651EA
// total size: 0x2
...
// Range: 0x8024A4B4 -> 0x8024A9BC
// this: r31
unsigned char zUICustomSysMessageManager::HandleEvent(struct xBase * from /* r25 */, unsigned int toEvent /* r28 */, const float * toParam /* r1+0x8 */, struct xBase * toParamWidget /* r1+0xC */, unsigned int toParamWidgetID /* r26 */) {
    // Local variables
    int i; // r29
    class zUIController * c; // r27
    int i; // r30
...
// total size: 0x2
struct /* @class$1904zUICustomSysMessage_cpp */ {
    // Members
...
// Range: 0x8024A9BC -> 0x8024AA30
// this: r31
void zUICustomSysMessageManager::PreUpdate(float dt /* r1+0x8 */) {}

// Range: 0x8024AA30 -> 0x8024AAE8
// this: r31
void zUICustomSysMessageManager::ShowSystemMessage(void (* cb)(struct xBase *, struct xBase *, unsigned int, float *, struct xBase *, unsigned int) /* r1+0x8 */, unsigned int _toCBEvent /* r1+0xC */, const float * _toCBParams /* r30 */, struct xBase * _toCBto /* r1+0x10 */, struct xBase * _toCBParamWidget /* r1+0x14 */, unsigned int _toCBParamWidgetID /* r1+0x18 */, const char * sys_message /* r1+0x38 */) {}
