/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zShrapnelEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80250818 -> 0x8025302C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char track_player; // size: 0x1, address: 0x80D65300
static float repeat_delay; // size: 0x4, address: 0x80D65304
static float yoffset; // size: 0x4, address: 0x80D6B180
static float dir_yaw; // size: 0x4, address: 0x80D6B184
static float dir_pitch; // size: 0x4, address: 0x80D6B188
static float dir_roll; // size: 0x4, address: 0x80D6B18C
// Range: 0x80250818 -> 0x80250968
static void add_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float dir_roll;
    // -> static float dir_pitch;
    // -> static float dir_yaw;
    // -> static float repeat_delay;
    // -> static float yoffset;
    // -> static unsigned char track_player;
}

static class module_type * module; // size: 0x4, address: 0x80D6B190
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1824zShrapnelEmitter_cpp */ {
    // Members
...
// ERROR: Failed to emit tag 19605D8 (Subroutine)
// total size: 0x1
struct /* @class$2098zShrapnelEmitter_cpp */ {
    // Members
    unsigned char foo; // offset 0x0, size 0x1
};
// total size: 0x1
struct /* @class$2080zShrapnelEmitter_cpp */ {
    // Members
    unsigned char modulate_color; // offset 0x0, size 0x1
};
// total size: 0x16C
struct shared_frag_asset {
    ...
    union { // inferred
        ...
        struct shared_frag_asset * next; // offset 0x0, size 0x4
    };
    class zShrapnelEmitterSphere * owner; // offset 0x4, size 0x4
    struct zShrapnelAsset shrap; // offset 0x8, size 0xC
    struct zFragProjectileAsset proj; // offset 0x14, size 0x158
};
// total size: 0x1A0
struct activity_data {
    ...
    struct /* @class$2080zShrapnelEmitter_cpp */ {
        // Members
        unsigned char modulate_color; // offset 0x0, size 0x1
    } flag; // offset 0x40, size 0x1
    class zShrapnelEmitterSphere * owner; // offset 0x44, size 0x4
    const struct config_type * cfg; // offset 0x48, size 0x4
    struct shared_frag_asset * asset; // offset 0x4C, size 0x4
    struct xModelInstance parent_model; // offset 0x50, size 0xCC
    unsigned int model_ids[12]; // offset 0x11C, size 0x30
    struct RpAtomic * models[12]; // offset 0x14C, size 0x30
    int models_size; // offset 0x17C, size 0x4
    struct xVec3 * dir; // offset 0x180, size 0x4
    float zmin; // offset 0x184, size 0x4
    float zmax; // offset 0x188, size 0x4
    float radius_range; // offset 0x18C, size 0x4
    float vel_range; // offset 0x190, size 0x4
    float intensity_range; // offset 0x194, size 0x4
    float rot_vel_range; // offset 0x198, size 0x4
    float scale_range; // offset 0x19C, size 0x4
};
// total size: 0x80
struct /* @class$2099zShrapnelEmitter_cpp */ {
    // Members
    class zShrapnelEmitterSphere emitter; // offset 0x0, size 0x4
    struct config_type cfg; // offset 0x4, size 0x6C
    struct xVec3 center; // offset 0x70, size 0xC
    float repeat_time; // offset 0x7C, size 0x4
};
// total size: 0x80
struct debug_info {
    // Members
    ...
    struct /* @class$2099zShrapnelEmitter_cpp */ {
        ...
        struct xVec3 center; // offset 0x70, size 0xC
        float repeat_time; // offset 0x7C, size 0x4
    } test_sphere; // offset 0x0, size 0x80
};
// total size: 0x20
class module_type {
    // Functions
    static module_type(int sphere_emitters_max, int frag_asset_max, unsigned char tweak_alloc);

    static void reset();

    static void update(float dt);

    static struct shared_frag_asset * alloc_frag_asset();

    static void free_frag_asset(struct shared_frag_asset * frag);

    static void ref_frag_asset(struct shared_frag_asset * frag);

    static void unref_frag_asset(struct shared_frag_asset * frag);

    static struct shared_frag_asset * get_frag_asset(const struct zFragProjectileAsset * from);

    static void debug_init();

    static void debug_update(float dt);
    ...
    struct activity_data * sphere_emitters; // offset 0x4, size 0x4
    int sphere_emitters_max; // offset 0x8, size 0x4
    int sphere_emitters_used; // offset 0xC, size 0x4
    struct shared_frag_asset * frag_asset_buffer; // offset 0x10, size 0x4
    struct shared_frag_asset * frag_asset_head; // offset 0x14, size 0x4
    int frag_asset_max; // offset 0x18, size 0x4
    struct debug_info * debug; // offset 0x1C, size 0x4
};
// Range: 0x8025097C -> 0x80250AB4
// this: r31
static module_type::module_type(int sphere_emitters_max /* r25 */, int frag_asset_max /* r26 */, unsigned char tweak_alloc /* r1+0x8 */) {}

// Range: 0x80250AB4 -> 0x80250B44
// this: r31
static void module_type::reset() {
    // Local variables
    struct shared_frag_asset * proj; // r30
    struct shared_frag_asset * end_proj; // r29
}

// Range: 0x80250B44 -> 0x80250BC0
// this: r30
static void module_type::update(float dt /* f31 */) {
    // Local variables
    struct activity_data * sphere_emitter; // r31
    struct activity_data * end_sphere_emitter; // r29
}

// Range: 0x80250BC0 -> 0x80250BC4
static void module_type::render() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65308
// Range: 0x80250BC4 -> 0x80250C70
// this: r30
static struct shared_frag_asset * module_type::alloc_frag_asset() {
    // Local variables
    struct shared_frag_asset * proj; // r31

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D65319
// Range: 0x80250C70 -> 0x80250DA8
// this: r31
static void module_type::free_frag_asset(struct shared_frag_asset * frag /* r29 */) {
    // Local variables
    struct shared_frag_asset * it; // r30

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65329
// Range: 0x80250DA8 -> 0x80250FB0
// this: r30
static void module_type::ref_frag_asset(struct shared_frag_asset * frag /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65338
// Range: 0x80250FB0 -> 0x802511D0
// this: r30
static void module_type::unref_frag_asset(struct shared_frag_asset * frag /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65349
// Range: 0x802511D0 -> 0x8025128C
// this: r31
static struct shared_frag_asset * module_type::get_frag_asset(const struct zFragProjectileAsset * from /* r1+0x8 */) {
    // Local variables
    struct shared_frag_asset * proj; // r30
...
// Range: 0x8025128C -> 0x802512A4
static void module_type::add_tweaks() {
    // Local variables
    const char * prefix; // r1+0x8
}

static unsigned int test_models[3]; // size: 0xC, address: 0x80D65358
static signed char init; // size: 0x1, address: 0x80D6B194
// Range: 0x802512A4 -> 0x802513C4
// this: r31
static void module_type::debug_init() {
    // References
    // -> static unsigned int test_models[3];
...
// Range: 0x802513C4 -> 0x8025161C
// this: r31
static void module_type::debug_update(float dt /* r1+0x10 */) {
    // Local variables
    unsigned char havamodel; // r29
    int i; // r30
    float yaw; // f31
    float pitch; // f29
    float roll; // f30
...
// total size: 0x890
struct /* @class$2059zShrapnelEmitter_cpp */ {
    // Static members
...
// Range: 0x8025161C -> 0x80251700
void zShrapnelEmitterSceneEnter() {
    // Local variables
    int sphere_emitters_max; // r1+0xC
    int frag_asset_max; // r1+0x8

    // References
    // -> static class module_type * module;
}

// Range: 0x80251700 -> 0x8025170C
void zShrapnelEmitterSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025170C -> 0x8025173C
void zShrapnelEmitterReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x8025173C -> 0x80251774
void zShrapnelEmitterUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x80251774 -> 0x802517A4
...
class zShrapnelEmitterSphere {
    ...
    void activate(const struct config_type & cfg);

    void deactivate();

    void set_config(const struct config_type & cfg);

    void spawn(const struct xMat4x3 & mat, int amount);

    void init_projectile(struct zFrag * frag);

    // Members
public:
    struct activity_data * act; // offset 0x0, size 0x4
};
// Range: 0x802517A4 -> 0x80251880
void zShrapnelEmitterSphere::set_default_config(struct config_type & cfg /* r3 */) {}
...
// Range: 0x80251880 -> 0x8025188C
// this: r3
void zShrapnelEmitterSphere::create() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65364
// Range: 0x8025188C -> 0x80251AB0
// this: r31
void zShrapnelEmitterSphere::activate(const struct config_type & cfg /* r28 */) {
    // Local variables
    struct zShrapnelAsset & shrap; // r29
    struct zFragProjectileAsset & proj; // r30
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6536D
// Range: 0x80251AB0 -> 0x80251BC8
// this: r31
void zShrapnelEmitterSphere::deactivate() {
    // References
    // -> static class module_type * module;
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65378
// total size: 0x8
struct xModelPipe {
    // Members
    unsigned int Flags; // offset 0x0, size 0x4
...
// Range: 0x80251BC8 -> 0x80252000
// this: r30
void zShrapnelEmitterSphere::set_config(const struct config_type & cfg /* r31 */) {
    // Local variables
    struct zFragProjectileAsset & proj; // r29
    int i; // r28
    unsigned int model_id; // r22
    struct xModelPipe pipe; // r1+0x8
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65383
// Range: 0x80252000 -> 0x80252234
// this: r31
void zShrapnelEmitterSphere::spawn(const struct xMat4x3 & mat /* r1+0x8 */, int amount /* r30 */) {
    // Local variables
    int spawn_range; // r26
    struct xVec3 * dir_buffer; // r28
    struct zShrapnelAsset & shrap; // r24
    struct zFragProjectileAsset & proj; // r29
    int i; // r27
    int model_index; // r25
...
// Range: 0x80252234 -> 0x80252238
void zShrapnelEmitterSphere::update() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65389
// Range: 0x80252238 -> 0x802522F0
struct activity_data * zShrapnelEmitterSphere::alloc_activity() {
    // References
    // -> static class module_type * module;
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D65398
// Range: 0x802522F0 -> 0x802523EC
void zShrapnelEmitterSphere::free_activity(struct activity_data * v /* r31 */) {
    // Local variables
    struct activity_data * tail; // r30
...
// Range: 0x8025257C -> 0x80252868
// this: r31
void zShrapnelEmitterSphere::init_projectile(struct zFrag * frag /* r28 */) {
    // Local variables
    struct zFragProjectile & proj; // r30
    struct xVec3 dir; // r1+0x8
    float radius; // f30
    float velmag; // f29
    float intensity; // f28
    float scale; // f31
    struct xMat4x3 & proj_mat; // r29

    // References
    // -> static class module_type * module;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D653A6
// Range: 0x80252868 -> 0x80252918
void zShrapnelEmitterSphere::cb_init_projectile(struct zFrag * frag /* r30 */, struct zFragAsset * asset /* r1+0x8 */) {
    // Local variables
    struct shared_frag_asset * sfrag; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80524068
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x4
struct /* @class$884zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1628zShrapnelEmitter_cpp */ {
    // Members
...
union /* @class$1048zShrapnelEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1080zShrapnelEmitter_cpp */ {
    // Members
...
// Range: 0x80252918 -> 0x802529D4
void zShrapnelEmitterSphere::cb_destroy_projectile(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zFragProjectile & proj; // r31
    struct shared_frag_asset * sfrag; // r29
...
// total size: 0xC
struct /* @class$734zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zShrapnelEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zShrapnelEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zShrapnelEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zShrapnelEmitter_cpp */ {
    // Members
...
struct config_type {
    // Members
    int spawn_min; // offset 0x0, size 0x4
    int spawn_max; // offset 0x4, size 0x4
    ...
    struct _xFColor color; // offset 0x38, size 0x10
    ...
    int max_bounces; // offset 0x58, size 0x4
    int proj_flags; // offset 0x5C, size 0x4
    unsigned int child; // offset 0x60, size 0x4
    const unsigned int * models; // offset 0x64, size 0x4
    int models_size; // offset 0x68, size 0x4
};
// Range: 0x802529D4 -> 0x8025302C
void zShrapnelEmitterSphere::add_config_tweaks(const char * prefix /* r29 */, struct config_type & cfg /* r31 */, const struct tweak_callback * cb /* r28 */, void * context /* r30 */) {
    // Local variables
    const struct tweak_callback * cb_convert_degrees; // r26
    const char * * frag_labels; // r1+0x20
    const char * * model_labels; // r1+0x1C
    const unsigned int * frag_ids; // r1+0x18
    const unsigned int * model_ids; // r1+0x14
    unsigned int frags; // r24
    unsigned int models; // r25
    int i; // r27
    char name[128]; // r1+0x24
    unsigned int actual_id; // r1+0x10
