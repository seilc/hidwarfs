/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomJoinScreenManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027E0B8 -> 0x8027E79C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65B28
// Range: 0x8027E0B8 -> 0x8027E1F4
static void zSystemEventCB(unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static unsigned char bJoinDropActionConfirmed; // size: 0x1, address: 0x80D6B304
// total size: 0x54
struct {} zUICustomJoinScreenManager::__vtable; // size: 0x54, address: 0x80524D88
// total size: 0x14
class zUICustomJoinScreenManager : public zUICustom {
    // Functions
    zUICustomJoinScreenManager(class zUI * ui);

    void SetDropJoinText(int trccount);

    void SetLockPauseText(unsigned char value);
    ...
    // Members
public:
    class zUIText * textJoinDrop; // offset 0x8, size 0x4
    class zUIText * textReturn; // offset 0xC, size 0x4
    class zUIText * textPause; // offset 0x10, size 0x4
};
// Range: 0x8027E1F4 -> 0x8027E250
// this: r31
zUICustomJoinScreenManager::zUICustomJoinScreenManager(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomJoinScreenManager::__vtable;
}
...
// Range: 0x8027E250 -> 0x8027E2D4
// this: r31
void zUICustomJoinScreenManager::SetDropJoinText(int trccount /* r1+0x8 */) {}
...
// total size: 0x2
struct /* @class$1879zUICustomJoinScreenManager_cpp */ {
    // Members
...
// Range: 0x8027E2D4 -> 0x8027E304
// this: r3
void zUICustomJoinScreenManager::SetLockPauseText(unsigned char value /* r4 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65B37
...
// Range: 0x8027E304 -> 0x8027E624
// this: r31
unsigned char zUICustomJoinScreenManager::HandleEvent(struct xBase * from /* r28 */, unsigned int toEvent /* r1+0x10 */) {
    // Local variables
    int port; // r30
    float toParams[4]; // r1+0x14

    // References
    // -> static unsigned char bJoinDropActionConfirmed;
    // -> class zUICustom * pSysMessageManager_Custom;
    // -> static char __FUNCTION__[12];
    // -> class zUI * pSysMessageManager;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65B43
// Range: 0x8027E624 -> 0x8027E79C
// this: r31
void zUICustomJoinScreenManager::Init() {
    // References
