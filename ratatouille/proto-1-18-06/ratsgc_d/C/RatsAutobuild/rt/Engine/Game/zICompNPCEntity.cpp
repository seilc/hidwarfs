/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zICompNPCEntity.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032CA90 -> 0x8032ED70
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gDefaultNPCEntityParams; // size: 0x30, address: 0x80D345A0
static unsigned char DRAW_ANIM_PHYSICS; // size: 0x1, address: 0x80D6BAB0
// total size: 0x60
...
class zICompNPCEntity : public zIComponent, public xEnt {
    ...
    void Reset(class zNPCBase * ownerNPC);

    void InitializeBounds(struct xVec3 & modelScale);

    void UpdateBounds();

    struct xVec3 GetBoneWorldPosition(int bone);

    void Render();

    void SetDefaultLightKit(class zNPCBase * ownerNPC);
    ...
    unsigned char IsAnimationStopped(unsigned int AnimationID);

    unsigned char IsAnimationTranstitionFinished(unsigned int AnimationID);

    void ApplyAnimPhysics();

    void PreUpdate(struct xScene * xscn, float dt);

    void Update(float dt);

    void PostUpdate(struct xScene * xscn, float dt);

    void ApplyAcc(struct xVec3 & dAcc);

    void UpdateVelocity(float speedLimit, float dt);

    void ApplyVelConstraints(struct xVec3 & dVel);

    void UpdatePosition(float dt);

    void ApplyPosConstraints(struct xVec3 & dPos);

    unsigned char TurnToVelocityXZ(float dt, float turnSpringK);

    unsigned char TurnToFaceXZ(const struct xVec3 * target, float dt, float turnSpringK);

    void KillVelocity();

    void SetFrameFromHeading(struct xVec3 & heading);
...
// Range: 0x8032CA90 -> 0x8032CADC
void zICompNPCEntity::BupdateWrapper(struct xEnt * ent /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r30
}

// Range: 0x8032CADC -> 0x8032CB4C
void zICompNPCEntity::NPCBeforeAnimMatrices(struct xAnimPlay * play /* r30 */, struct xQuat * quat /* r1+0x8 */, struct xVec3 * tran /* r1+0xC */, int boneCount /* r1+0x10 */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r29
}

// Range: 0x8032CB4C -> 0x8032CBC4
void zICompNPCEntity::EventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int to_event /* r1+0x10 */, const float * to_param /* r1+0x14 */, struct xBase * to_param_widget /* r1+0x18 */, unsigned int to_param_widget_id /* r1+0x1C */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r30
    class zNPCBase * npc; // r29
}
...
// Range: 0x8032CBC4 -> 0x8032CC24
void zICompNPCEntity_ScaleModel(struct xModelInstance * modelInst /* r31 */, struct xVec3 & scale /* r30 */) {
    // References
    // -> struct xVec3 m_Ones;
}
...
// Range: 0x8032CC24 -> 0x8032CF34
// this: r31
void zICompNPCEntity::Attached() {
    // Local variables
    class zNPCBase * ownerNPC; // r21
    const struct zNPCAssetRATS * npcAsset; // r30
    struct xEntFrame * savedFrame; // r20
    struct xShadowSimpleCache * savedSimpShadow; // r19
    struct xEntShadow * savedEntShadow; // r18
    struct xSphere s; // r1+0x8

    // References
    // -> struct xGrid npcs_grid;
    // -> static class zICompNPCEntityParams gDefaultNPCEntityParams;
}
...
// total size: 0x4
struct /* @class$901zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zICompNPCEntity_cpp */ {
    // Members
...
union /* @class$1040zICompNPCEntity_cpp */ {
...
// Range: 0x8032CF34 -> 0x8032CFAC
// this: r31
void zICompNPCEntity::Detached() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D679B8
// Range: 0x8032CFAC -> 0x8032D1E4
// this: r31
int zICompNPCEntity::Initialize() {
    // Local variables
    int extraMemUsed; // r30
...
// Range: 0x8032D1E4 -> 0x8032D3D0
// this: r31
void zICompNPCEntity::Reset(class zNPCBase * ownerNPC /* r27 */) {
    // Local variables
    struct xVec3 scaleFromFrame; // r1+0x18
    float yaw; // f31
    struct xSphere s; // r1+0x8
...
// Range: 0x8032D3D0 -> 0x8032D3D4
void zICompNPCEntity::BeforeAnimMatrices() {}

// Range: 0x8032D3D4 -> 0x8032D83C
// this: r31
void zICompNPCEntity::InitializeBounds(struct xVec3 & modelScale /* r30 */) {
    // Local variables
    float width; // f31
    float height; // f30
    float length; // f29
    struct xVec3 boundOffset; // r1+0x14
    float sphereScale; // f25
    struct xVec3 boundOffset; // r1+0x8
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D679C3
// Range: 0x8032D83C -> 0x8032DA30
// this: r31
void zICompNPCEntity::UpdateBounds() {
    // Local variables
    struct xVec3 boundOffset; // r1+0x14
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052E2B0
// Range: 0x8032DA30 -> 0x8032DB44
// this: r31
struct xVec3 zICompNPCEntity::GetBoneWorldPosition(int bone /* r29 */) {
    // Local variables
...
// Range: 0x8032DB44 -> 0x8032DB84
// this: r1+0x8
void zICompNPCEntity::Render() {}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6BAB1
static signed char init; // size: 0x1, address: 0x80D6BAB2
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D679D0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1666zICompNPCEntity_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8032DB84 -> 0x8032DCCC
// this: r28
void zICompNPCEntity::SetDefaultLightKit(class zNPCBase * ownerNPC /* r1+0x8 */) {
    // Local variables
    const struct zNPCAssetRATS * npcAsset; // r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D679E3
// Range: 0x8032DCCC -> 0x8032DDE4
// this: r28
void zICompNPCEntity::SetAnimState(unsigned int new_stateID /* r29 */, float blend /* f31 */, struct xModelInstance * model /* r30 */) {
    // Local variables
...
// Range: 0x8032DDE4 -> 0x8032DE2C
// this: r1+0x8
void zICompNPCEntity::SetAnimState(const char * new_state /* r1+0xC */, float blend /* r1+0x10 */, struct xModelInstance * model /* r1+0x14 */) {}

// Range: 0x8032DE2C -> 0x8032DE7C
// this: r1+0x8
void zICompNPCEntity::SetAnimState(const char * new_state /* r1+0xC */, float blend /* r1+0x10 */, float dest_time /* r1+0x14 */, struct xModelInstance * model /* r1+0x18 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D679F0
// Range: 0x8032DE7C -> 0x8032DFC8
// this: r28
void zICompNPCEntity::SetAnimState(unsigned int new_stateID /* r29 */, float blend /* f31 */, float dest_time /* r1+0x8 */, struct xModelInstance * model /* r30 */) {
    // Local variables
    struct xAnimTransition * transition; // r31
...
// Range: 0x8032DFC8 -> 0x8032E010
// this: r3
void zICompNPCEntity::SetAnimSpeed(float speed /* f1 */) {}

// Range: 0x8032E010 -> 0x8032E074
// this: r3
float zICompNPCEntity::GetAnimTime() {}

// Range: 0x8032E074 -> 0x8032E0E0
// this: r3
float zICompNPCEntity::GetAnimDuration() {}

// Range: 0x8032E0E0 -> 0x8032E1D8
// this: r3
unsigned char zICompNPCEntity::IsAnimationStopped(unsigned int AnimationID /* r4 */) {
    // Local variables
    struct xAnimState * astate; // r31
}

// Range: 0x8032E1D8 -> 0x8032E288
// this: r3
unsigned char zICompNPCEntity::IsAnimationTranstitionFinished(unsigned int AnimationID /* r4 */) {
    // Local variables
    struct xAnimState * astate; // r31
}

// Range: 0x8032E288 -> 0x8032E290
unsigned char zICompNPCEntity::SystemEvent(unsigned int to_event /* r6 */) {}
...
// Range: 0x8032E290 -> 0x8032E59C
// this: r31
void zICompNPCEntity::ApplyAnimPhysics() {
    // Local variables
    float yawDisp; // f30
...
// Range: 0x8032E59C -> 0x8032E680
// this: r31
void zICompNPCEntity::PreUpdate(struct xScene * xscn /* r1+0x8 */, float dt /* r1+0xC */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x8032E680 -> 0x8032E72C
// this: r31
void zICompNPCEntity::Update(float dt /* f31 */) {
    // References
    // -> struct zGlobals globals;
}
...
// Range: 0x8032E72C -> 0x8032E86C
// this: r31
void zICompNPCEntity::PostUpdate(struct xScene * xscn /* r1+0x10 */, float dt /* f31 */) {
    // Local variables
    unsigned int boneIndex; // r30
    struct xMat4x3 boneMat; // r1+0x20
}

// Range: 0x8032E86C -> 0x8032E8A0
// this: r1+0x8
void zICompNPCEntity::ApplyAcc(struct xVec3 & dAcc /* r1+0xC */) {}

// Range: 0x8032E8A0 -> 0x8032E984
// this: r31
void zICompNPCEntity::UpdateVelocity(float speedLimit /* f30 */, float dt /* r1+0x8 */) {
    // Local variables
    struct xVec3 * vel; // r30
    struct xVec3 * oldVel; // r29
    struct xVec3 dAcc; // r1+0xC
    float speed2; // f31
    float speed; // f29
}

// Range: 0x8032E984 -> 0x8032E9C0
// this: r31
void zICompNPCEntity::ApplyVelConstraints(struct xVec3 & dVel /* r1+0x8 */) {}

// Range: 0x8032E9C0 -> 0x8032EA6C
// this: r31
void zICompNPCEntity::UpdatePosition(float dt /* f31 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8032EA6C -> 0x8032EAA8
// this: r31
void zICompNPCEntity::ApplyPosConstraints(struct xVec3 & dPos /* r1+0x8 */) {}

// Range: 0x8032EAA8 -> 0x8032EAEC
// this: r31
unsigned char zICompNPCEntity::TurnToVelocityXZ(float dt /* r1+0x8 */, float turnSpringK /* r1+0xC */) {}

// Range: 0x8032EAEC -> 0x8032EC48
// this: r31
unsigned char zICompNPCEntity::TurnToFaceXZ(const struct xVec3 * target /* r29 */, float dt /* r1+0x8 */, float turnSpringK /* f29 */) {
    // Local variables
    struct xVec3 targetV; // r1+0xC
    float targetVDistance2; // f31
    struct xVec3 * currentHeading; // r30
    float currentYaw; // f30
}
...
// total size: 0xC
struct /* @class$842zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zICompNPCEntity_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zICompNPCEntity_cpp */ {
    // Members
...
// Range: 0x8032EC48 -> 0x8032ECA0
// this: r31
void zICompNPCEntity::KillVelocity() {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x8032ECA0 -> 0x8032ED10
// this: r29
void zICompNPCEntity::SetFrameFromHeading(struct xVec3 & heading /* r30 */) {
    // Local variables
...
// Range: 0x8032ED10 -> 0x8032ED70
// this: r1+0x8
void zICompNPCEntity::SetFrameFromYaw(float yaw /* f31 */) {
    // Local variables
    struct xVec3 heading; // r1+0xC
}
...
// total size: 0x890
struct /* @class$1909zICompNPCEntity_cpp */ {
    // Static members
...
// total size: 0x30
struct {} zICompNPCEntity::__vtable; // size: 0x30, address: 0x8052E2C8
enum eCompType {
    eCompType_Unknown = -1,
