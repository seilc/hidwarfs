/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCheat.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80132918 -> 0x801330A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gCheatBouncyHenchmen; // size: 0x1, address: 0x80D69E8A
unsigned char gCheatExtraShrapnel; // size: 0x1, address: 0x80D69E8B
static float cheatTimer; // size: 0x4, address: 0x80D69E8C
static float headScale; // size: 0x4, address: 0x80D61F00
static float targetHead; // size: 0x4, address: 0x80D61F04
static float discoTimer; // size: 0x4, address: 0x80D69E90
static const char * cheatName; // size: 0x4, address: 0x80D69E94
// total size: 0x18
...
// Range: 0x80132918 -> 0x80132964
static void zCheatRemoveTimed() {
    // References
    // -> static float cheatTimer;
...
enum zCheatStatus {
    zCheatStatus_Bad = 0,
    zCheatStatus_Ok = 1,
    zCheatStatus_CreditCode = 2,
    zCheatStatus_HILogo = 3,
};
// total size: 0x14
...
// Range: 0x80132964 -> 0x8013296C
static unsigned char IncrediBall() {}
...
// Range: 0x8013296C -> 0x80132A44
static void newDiscoColor() {
    // Local variables
    float val; // f31

    // References
    // -> static float discoTimer;
}

// Range: 0x80132A44 -> 0x80132AB8
static enum zCheatStatus Cheat_HeadRescale(float scale /* f31 */) {
    // References
    // -> static float targetHead;
    // -> struct zCheats gCheats;
}

// Range: 0x80132AB8 -> 0x80132ADC
static enum zCheatStatus Cheat_BigHeadMode() {}

// Range: 0x80132ADC -> 0x80132B00
static enum zCheatStatus Cheat_SmallHeadMode() {}

// Range: 0x80132B00 -> 0x80132B28
static enum zCheatStatus Cheat_BigMouth() {
    // References
    // -> struct zCheats gCheats;
}

// Range: 0x80132B28 -> 0x80132B50
static enum zCheatStatus Cheat_BigCritters() {
    // References
    // -> struct zCheats gCheats;
}

// Range: 0x80132B50 -> 0x80132B94
static enum zCheatStatus Cheat_HUD() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80132B94 -> 0x80132BD8
static enum zCheatStatus Cheat_FastMo() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80132BD8 -> 0x80132BE0
static enum zCheatStatus Cheat_HILogo() {}

// Range: 0x80132BE0 -> 0x80132BE8
static enum zCheatStatus Cheat_CreditCode() {}

// Range: 0x80132BE8 -> 0x80132C2C
static enum zCheatStatus Cheat_Nukes() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80132C2C -> 0x80132C70
static enum zCheatStatus Cheat_Invincible() {
    // References
    // -> struct zGlobals globals;
}

// total size: 0x4
struct /* @class$2040zCheat_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2041zCheat_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$833zCheat_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zCheat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zCheat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zCheat_cpp */ {
    // Members
...
// Range: 0x80132C70 -> 0x80132CB4
static enum zCheatStatus Cheat_DoubleXP() {
    // References
    // -> struct zGlobals globals;
}
...
struct Cheat {
    // Members
    const char * name; // offset 0x0, size 0x4
    enum zCheatStatus (* callback)(); // offset 0x4, size 0x4
};
static struct Cheat cheats[11]; // size: 0x58, address: 0x80518BD8
static char unlock_clear[32]; // size: 0x20, address: 0x80518C30
// Range: 0x80132CB4 -> 0x80132D6C
void zCheatInit() {
    // Local variables
    unsigned int UNLOCK_INDEX; // r30
    char * uncrypt; // r31
    const char * crypt; // r29
    char last; // r28

    // References
    // -> static char unlock_clear[32];
    // -> static struct Cheat cheats[11];
}

// Range: 0x80132D6C -> 0x80132DC0
void zCheatRemoveAll() {
    // References
    // -> unsigned char gCheatBouncyHenchmen;
    // -> unsigned char gCheatExtraShrapnel;
    // -> static float targetHead;
...
// Range: 0x80132E68 -> 0x80132FF4
void zCheatUpdate(float dt /* f31 */) {
    // Local variables
...
// Range: 0x80132FF4 -> 0x80132FFC
float zCheatGetHeadScale() {
    // References
    // -> static float headScale;
}

// Range: 0x80132FFC -> 0x801330A8
enum zCheatStatus zCheatProcess(const char * name /* r27 */) {
    // Local variables
    int low; // r30
    int high; // r29
    int mid; // r31
