/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleCustom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8024DE2C -> 0x80250600
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int texture; // size: 0x4, address: 0x80D65280
static float glow; // size: 0x4, address: 0x80D65284
static float color_red; // size: 0x4, address: 0x80D65288
static float color_green; // size: 0x4, address: 0x80D6528C
static float color_blue; // size: 0x4, address: 0x80D65290
static float color_alpha; // size: 0x4, address: 0x80D65294
static unsigned int texture; // size: 0x4, address: 0x80D65298
static float glow; // size: 0x4, address: 0x80D6529C
static float color_red; // size: 0x4, address: 0x80D652A0
static float color_green; // size: 0x4, address: 0x80D652A4
static float color_blue; // size: 0x4, address: 0x80D652A8
static float color_alpha; // size: 0x4, address: 0x80D652AC
static unsigned int texture; // size: 0x4, address: 0x80D652B0
static float gravity; // size: 0x4, address: 0x80D652B4
static unsigned int color; // size: 0x4, address: 0x80D652B8
static float bounce_xzdamp; // size: 0x4, address: 0x80D652BC
static float bounce_ydamp; // size: 0x4, address: 0x80D652C0
static float bounce_kill_vel; // size: 0x4, address: 0x80D652C4
static unsigned int texture; // size: 0x4, address: 0x80D652C8
static float growth; // size: 0x4, address: 0x80D652CC
static float vel_decay; // size: 0x4, address: 0x80D652D0
static float color_red; // size: 0x4, address: 0x80D652D4
static float color_green; // size: 0x4, address: 0x80D652D8
static float color_blue; // size: 0x4, address: 0x80D652DC
static float intensity_min; // size: 0x4, address: 0x80D652E0
static float intensity_max; // size: 0x4, address: 0x80D652E4
static unsigned int texture; // size: 0x4, address: 0x80D652E8
static float growth; // size: 0x4, address: 0x80D652EC
static float color_red; // size: 0x4, address: 0x80D652F0
static float color_green; // size: 0x4, address: 0x80D652F4
static float color_blue; // size: 0x4, address: 0x80D652F8
static float color_alpha; // size: 0x4, address: 0x80D652FC
// Range: 0x8024DE2C -> 0x8024E37C
static void add_tweaks() {
    ...
    // -> static float bounce_kill_vel;
    // -> static float bounce_ydamp;
    // -> static float bounce_xzdamp;
...
// total size: 0xC
struct /* @class$768zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zParticleCustom_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zParticleCustom_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zParticleCustom_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zParticleCustom_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zParticleCustom_cpp */ {
    // Members
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x80D6B170
// total size: 0x18
struct /* @class$2007zParticleCustom_cpp */ {
    // Members
    int spark; // offset 0x0, size 0x4
    int glint; // offset 0x4, size 0x4
    int pebble; // offset 0x8, size 0x4
    int pebble_no_coll; // offset 0xC, size 0x4
    int dust; // offset 0x10, size 0x4
    int fire_smoke; // offset 0x14, size 0x4
};
static // total size: 0x18
struct /* @class$2007zParticleCustom_cpp */ {
    // Members
    int spark; // offset 0x0, size 0x4
    int glint; // offset 0x4, size 0x4
    ...
    int dust; // offset 0x10, size 0x4
    int fire_smoke; // offset 0x14, size 0x4
} system_id; // size: 0x18, address: 0x80D24A28
...
// Range: 0x8024E37C -> 0x8024E484
static void register_particle_system(int & system_id /* r30 */, enum ptank_group_type pool_type /* r1+0x8 */, unsigned int texture_id /* r29 */, unsigned int src_blend /* r1+0xC */, unsigned int dst_blend /* r1+0x10 */, int order_index /* r1+0x14 */, int flags /* r1+0x18 */, int stride /* r1+0x1C */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r1+0xE8 */, const char * debug_name /* r1+0xEC */, const char * dbgFile /* r1+0xF0 */, int dbgLine /* r1+0xF4 */) {
    // Local variables
    struct xParticleBatchSystem system; // r1+0x20
    char prefix[128]; // r1+0x48

    // References
    // -> static class xParticleBatchGroup particle_batch_group;
}
...
// total size: 0x4
struct /* @class$1150zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zParticleCustom_cpp */ {
    // Members
...
union /* @class$819zParticleCustom_cpp */ {
...
// total size: 0x10
struct /* @class$832zParticleCustom_cpp */ {
    // Members
...
struct spark_particle {
    ...
    float yaccel; // offset 0xC, size 0x4
    struct xVec3 loc; // offset 0x10, size 0xC
    struct xVec3 vel; // offset 0x1C, size 0xC
};
// total size: 0x10
struct xVec4 {
    // Members
...
// Range: 0x8024E484 -> 0x8024E79C
static int update_spark_particles(unsigned char * mem /* r24 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    ...
    float base_glow; // f28
    float base_red; // f27
    float base_green; // f26
    float base_blue; // f25
    struct spark_particle * p; // r30
    struct spark_particle * end; // r25
    float age1; // f31
    float t1; // f29
    float age2; // f24
...
// Range: 0x8024E79C -> 0x8024E7E8
float zParticleCustomRequestSpark(float amount /* r1+0x8 */, int systemID /* r31 */) {
    // References
    // -> static // total size: 0x18
struct /* @class$2007zParticleCustom_cpp */ {
    // Members
...
// Range: 0x8024E7E8 -> 0x8024E9B0
void zParticleCustomEmitSpark(const struct xVec3 * loc /* r26 */, const struct xVec3 * vel /* r27 */, int amount /* r30 */, float life_min /* r1+0x8 */, float life_range /* f29 */, float size_min /* r1+0xC */, float size_range /* f30 */, float dt /* r1+0x10 */, float gravity /* r1+0x14 */, int systemID /* r28 */) {
    // Local variables
    float yaccel; // f28
    float age; // f31
    float dage; // f27
    ...
    int have; // r29
    struct spark_particle * p; // r31
    struct spark_particle * endp; // r25
    float life; // f26
...
// Range: 0x8024E9B0 -> 0x8024EA20
void zParticleCustomCreateSparkSystem(int & systemID /* r1+0x18 */, unsigned int textureID /* r1+0x1C */, const char * debugName /* r31 */) {}
...
struct glint_particle {
    ...
    float length_vel; // offset 0xC, size 0x4
    float length_clamp; // offset 0x10, size 0x4
    float width; // offset 0x14, size 0x4
    struct xVec3 loc; // offset 0x18, size 0xC
    struct xVec3 vel; // offset 0x24, size 0xC
    float yaccel; // offset 0x30, size 0x4
};
// Range: 0x8024EA20 -> 0x8024EED4
static int update_glint_particles(unsigned char * mem /* r24 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    struct ptank_pool__color_mat & _fptank_pool; // r30
    int _fptank_used; // r28
    struct xColor_tag * pool_color; // r26
    struct xMat4x3 * pool_mat; // r29
    const struct xMat4x3 & cam_mat; // r27
    float Ax; // f20
    float Ay; // f19
    float Az; // f18
    float base_glow; // r1+0x58
    float base_red; // r1+0x54
    float base_green; // r1+0x50
    float base_blue; // r1+0x4C
    struct glint_particle * p; // r31
    struct glint_particle * end; // r25
    float age1; // f31
    float t1; // r1+0x48
    float length; // f27
    float Vx; // f30
    ...
    float Uz; // r1+0x34
    float age2; // r1+0x30
    struct xVec4 loc; // r1+0x6C
    struct RwSphere worldsph; // r1+0x5C
    float it1; // f26
    float red; // r1+0x2C
    float green; // r1+0x28
    float blue; // r1+0x24
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80524038
// Range: 0x8024EED4 -> 0x8024F2E8
void zParticleCustomEmitGlint(const struct xVec3 * loc /* r25 */, const struct xVec3 * vel /* r31 */, const float * length_vel /* r27 */, int amount /* r29 */, float life_min /* r1+0x8 */, float life_range /* f26 */, float width_min /* r1+0xC */, float width_range /* f27 */, float length_min /* r1+0x10 */, float length_range /* f28 */, float length_clamp_min /* r1+0x14 */, float length_clamp_range /* f29 */, float dt /* r1+0xF8 */, float gravity /* r1+0xFC */, int systemID /* r26 */) {
    // Local variables
    float yaccel; // f25
    float age; // f31
    float dage; // f24
    unsigned char * mem; // r1+0x18
    int have; // r28
    struct glint_particle * p; // r30
    struct glint_particle * endp; // r24
    float life; // f23
    float rlen; // f30
...
// Range: 0x8024F2E8 -> 0x8024F358
void zParticleCustomCreateGlintSystem(int & systemID /* r1+0x18 */, unsigned int textureID /* r1+0x1C */, const char * debugName /* r31 */) {}
...
struct pebble_particle {
    ...
    float plane_y; // offset 0x1C, size 0x4
};
// Range: 0x8024F358 -> 0x8024F62C
static int update_pebble_particles(unsigned char * mem /* r24 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    ...
    struct xColor_tag * pool_color; // r27
    struct xVec2 * pool_size; // r26
    struct pebble_particle * p; // r31
    struct pebble_particle * end; // r25
    float oldy; // f26
    float dv; // f28
    float asize; // f30
    float plane_y; // f29
    float under; // f27
    struct xVec4 loc; // r1+0x20
...
// total size: 0x20
struct pebble_particle_no_coll {
    // Members
    struct xVec3 loc; // offset 0x0, size 0xC
    struct xVec3 vel; // offset 0xC, size 0xC
    float size; // offset 0x18, size 0x4
...
// Range: 0x8024F670 -> 0x8024F890
static int update_pebble_particles_no_coll(unsigned char * mem /* r24 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r29
    struct xVec3 * pool_pos; // r28
    struct xColor_tag * pool_color; // r27
    struct xVec2 * pool_size; // r26
    struct pebble_particle_no_coll * p; // r30
    struct pebble_particle_no_coll * end; // r25
    float dv; // f29
    float asize; // f30
    struct xVec4 loc; // r1+0x20
    struct RwSphere worldsph; // r1+0x10
...
static float dust_vel_decay; // size: 0x4, address: 0x80D6B178
// Range: 0x8024F8D4 -> 0x8024F90C
static void pre_update_dust_particles(float dt /* r1+0x8 */) {
    // References
    // -> static float vel_decay;
    // -> static float dust_vel_decay;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80524051
// total size: 0x30
struct dust_particle {
    ...
    float age_rate; // offset 0x4, size 0x4
    float size; // offset 0x8, size 0x4
    float scale_yoffset; // offset 0xC, size 0x4
    struct xVec3 loc; // offset 0x10, size 0xC
    struct xVec3 vel; // offset 0x1C, size 0xC
    struct xColor_tag color; // offset 0x28, size 0x4
    unsigned char frame; // offset 0x2C, size 0x1
    unsigned char pad1; // offset 0x2D, size 0x1
    signed char xflip; // offset 0x2E, size 0x1
    signed char yflip; // offset 0x2F, size 0x1
};
// Range: 0x8024F90C -> 0x8024FD5C
static int update_dust_particles(unsigned char * mem /* r23 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f28 */) {
    // Local variables
    struct ptank_pool__pos_color_size_uv2 & _fptank_pool; // r30
    int _fptank_used; // r28
    struct xVec3 * pool_pos; // r26
    struct xColor_tag * pool_color; // r29
    struct xVec2 * pool_size; // r25
    struct xVec2 * pool_uv; // r27
    float growth; // f23
    float vel_decay; // f22
    struct dust_particle * p; // r31
    struct dust_particle * end; // r24
    float t1; // f31
    float size; // f30
    struct xVec4 loc; // r1+0x20
    struct RwSphere worldsph; // r1+0x10
...
struct fire_smoke_particle {
    ...
    struct xVec3 vel; // offset 0x18, size 0xC
    signed char xflip; // offset 0x24, size 0x1
    signed char yflip; // offset 0x25, size 0x1
    unsigned char pad1; // offset 0x26, size 0x1
    unsigned char pad2; // offset 0x27, size 0x1
};
// Range: 0x8024FD5C -> 0x802500F8
static int update_fire_smoke_particles(unsigned char * mem /* r23 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r29
    struct xVec3 * pool_pos; // r28
    ...
    float growth; // f25
    float base_red; // f24
    float base_green; // f23
    float base_blue; // f22
    float base_alpha; // f29
    float a1; // f21
    float a2; // f20
    float a3; // f19
    unsigned int color; // r24
    struct fire_smoke_particle * p; // r30
    struct fire_smoke_particle * end; // r25
    float age1; // f31
    float t1; // f30
    float age2; // r1+0x14
    float size; // f28
    struct xVec4 loc; // r1+0x28
    struct RwSphere worldsph; // r1+0x18
    float t2; // f26
    float t3; // f18
    float alpha; // f27
...
// Range: 0x80250164 -> 0x8025019C
float zParticleCustomRequestFireSmoke(float amount /* r1+0x8 */) {
    // References
    // -> static // total size: 0x18
struct /* @class$2007zParticleCustom_cpp */ {
    // Members
...
// Range: 0x8025019C -> 0x80250374
void zParticleCustomEmitFireSmoke(const struct xVec3 * loc /* r29 */, const struct xVec3 * vel /* r30 */, int amount /* r28 */, float life_min /* r1+0x8 */, float life_range /* f29 */, float size_min /* r1+0xC */, float size_range /* f30 */, float dt /* r1+0x10 */) {
    // Local variables
    float age; // f31
    float dage; // f28
    unsigned char * mem; // r1+0x14
    int have; // r27
    struct fire_smoke_particle * p; // r31
    struct fire_smoke_particle * endp; // r25
    float life; // f27
...
// Range: 0x802505D8 -> 0x80250600
void zParticleCustomUpdate(float dt /* r1+0x8 */) {}
