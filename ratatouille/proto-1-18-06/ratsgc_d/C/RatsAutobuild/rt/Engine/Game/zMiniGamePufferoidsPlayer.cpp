/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGamePufferoidsPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032A5B4 -> 0x8032B894
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80D67940
static float PLAYER_MOVE_SPEED; // size: 0x4, address: 0x80D67944
static unsigned int SHOT_MODEL_ID; // size: 0x4, address: 0x80D6BA88
static unsigned int SHOT_LONG_MODEL_ID; // size: 0x4, address: 0x80D6BA8C
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67948
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$901zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
class zMiniGamePufferoidsShot {
    // Functions
    void Init(class zMiniGamePufferoidsPlayer * owner);
    ...
    void Fire(unsigned char longRange, int power, float yRot);
...
protected:
    ...
    struct xModelInstance * longModel; // offset 0x4, size 0x4
    struct xModelInstance * shortModel; // offset 0x8, size 0x4
    struct xMat4x3 mat; // offset 0x10, size 0x40
    int power; // offset 0x50, size 0x4
    float range; // offset 0x54, size 0x4
    float currRange; // offset 0x58, size 0x4
    class zMiniGamePufferoidsPlayer * owner; // offset 0x5C, size 0x4
    unsigned char active; // offset 0x60, size 0x1
};
// Range: 0x8032A5B4 -> 0x8032A800
// this: r31
void zMiniGamePufferoidsShot::Init(class zMiniGamePufferoidsPlayer * owner /* r1+0x8 */) {
    // Local variables
    struct RpAtomic * data; // r30

    // References
    // -> static unsigned int SHOT_LONG_MODEL_ID;
    // -> static char __FUNCTION__[5];
    // -> static unsigned int SHOT_MODEL_ID;
}
...
// total size: 0x10
struct /* @class$1288zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8032A800 -> 0x8032AA0C
// this: r31
void zMiniGamePufferoidsShot::Update(float dt /* r1+0x8 */) {
    // Local variables
    float disp; // f31
    struct xSweptSphere sws; // r1+0x34
    struct xVec3 start; // r1+0x28
    struct xVec3 end; // r1+0x1C
    int result; // r28
    int i; // r29
    class zMiniGamePufferoidsPuff * puffs; // r30
    struct xSphere sph; // r1+0xC
...
// total size: 0x1
struct /* @class$1857zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1859zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1860zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1861zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
enum /* @enum$1862zMiniGamePufferoidsPlayer_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1863zMiniGamePufferoidsPlayer_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1864zMiniGamePufferoidsPlayer_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1866zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1854zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// Range: 0x8032AA0C -> 0x8032AA44
// this: r3
float zMiniGamePufferoidsShot::GetRadius() {}
...
// Range: 0x8032AA44 -> 0x8032AB38
// this: r31
void zMiniGamePufferoidsShot::Render() {
    // References
    // -> struct xColor_tag g_BLUE;
    // -> struct xColor_tag g_RED;
}

// Range: 0x8032AB38 -> 0x8032ABE0
// this: r31
void zMiniGamePufferoidsShot::Fire(unsigned char longRange /* r1+0x8 */, int power /* r1+0xC */, float yRot /* r1+0x10 */) {}

// Range: 0x8032ABE0 -> 0x8032ABEC
// this: r3
void zMiniGamePufferoidsShot::Kill() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6794D
// Range: 0x8032ABEC -> 0x8032AC74
// this: r31
void zMiniGamePufferoidsShot::Exit() {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67952
...
class zMiniGamePufferoidsPlayer : public zMiniGamePlayer {
    ...
    class zMiniGamePufferoidsShot * GetFreeShot();
...
// Range: 0x8032AC74 -> 0x8032AD28
// this: r31
void zMiniGamePufferoidsPlayer::Init(struct xEntAsset * asset /* r1+0x8 */) {
    // Local variables
    int i; // r30
...
// Range: 0x8032AD28 -> 0x8032ADD4
// this: r31
void zMiniGamePufferoidsPlayer::BeginUpdate(float dt /* f31 */) {
    // Local variables
    struct zEnt * ent; // r30
...
union /* @class$1040zMiniGamePufferoidsPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1039zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zMiniGamePufferoidsPlayer_cpp */ {
    // Static members
...
// Range: 0x8032ADD4 -> 0x8032AEBC
// this: r31
void zMiniGamePufferoidsPlayer::UpdateOrientation(float dt /* r1+0x8 */) {
    // Local variables
...
// Range: 0x8032AEBC -> 0x8032B044
// this: r31
void zMiniGamePufferoidsPlayer::UpdatePosition(float dt /* r1+0x8 */) {
    // Local variables
    float x; // r1+0x18
    float y; // r1+0x14
    float angle; // r1+0x10
    float mag; // r1+0xC
    struct xVec3 moveVec; // r1+0x4C
    float moveMag; // f31
    struct xSweptSphere sws; // r1+0x58
    struct xVec3 start; // r1+0x40
    struct xVec3 end; // r1+0x34
    int result; // r30
    struct xVec3 slideDir; // r1+0x28
    struct xVec3 leftToMove; // r1+0x1C
    float slideMag; // f30
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67957
// Range: 0x8032B044 -> 0x8032B1E4
// this: r31
void zMiniGamePufferoidsPlayer::ApplyPickup(int applyPickup /* r30 */, float activeTime /* f31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x8032B1E4 -> 0x8032B278
// this: r31
void zMiniGamePufferoidsPlayer::HitByPuff() {}
...
// Range: 0x8032B278 -> 0x8032B2E8
// this: r30
class zMiniGamePufferoidsShot * zMiniGamePufferoidsPlayer::GetFreeShot() {
    // Local variables
    int i; // r31
}

// Range: 0x8032B2E8 -> 0x8032B2F0
// this: r3
unsigned char zMiniGamePufferoidsShot::IsActive() {}

// Range: 0x8032B2F0 -> 0x8032B5C0
// this: r31
void zMiniGamePufferoidsPlayer::Update(float dt /* f31 */) {
    // Local variables
    int power; // r25
    unsigned char longRange; // r24
    int numShots; // r23
    int j; // r30
    class zMiniGamePufferoidsShot * freeShot; // r28
    int i; // r29
...
// Range: 0x8032B5C0 -> 0x8032B5F0
// this: r1+0x8
void zMiniGamePufferoidsPlayer::EndUpdate(float dt /* r1+0xC */) {}

// Range: 0x8032B5F0 -> 0x8032B6F8
// this: r31
void zMiniGamePufferoidsPlayer::Render() {
    // Local variables
    int i; // r30
...
// Range: 0x8032B6F8 -> 0x8032B738
// this: r31
void zMiniGamePufferoidsPlayer::SceneSetup() {}

// Range: 0x8032B738 -> 0x8032B77C
// this: r31
void zMiniGamePufferoidsPlayer::Reset() {}

// Range: 0x8032B77C -> 0x8032B7D4
// this: r30
void zMiniGamePufferoidsPlayer::Exit() {
    // Local variables
    int i; // r31
}

// Range: 0x8032B7D4 -> 0x8032B894
void zMiniGamePufferoidsPlayer::AddStates(struct xAnimTable * table /* r31 */) {}

// total size: 0x12C
struct {} zMiniGamePufferoidsPlayer::__vtable; // size: 0x12C, address: 0x8052E050
