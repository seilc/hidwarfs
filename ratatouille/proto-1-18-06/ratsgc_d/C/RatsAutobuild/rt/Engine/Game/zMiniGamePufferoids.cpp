/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGamePufferoids.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80328DB8 -> 0x8032A43C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x80D6BA68
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x80D6BA6C
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x80D6BA70
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x80D6BA74
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x80D6BA78
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x80D6BA7C
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x80D6BA80
static unsigned int PUFF_MODEL_IDS[5]; // size: 0x14, address: 0x80D67908
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6791C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$932zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1184zMiniGamePufferoids_cpp */ {
    // Members
...
union /* @class$1168zMiniGamePufferoids_cpp */ {
...
// total size: 0x10
struct /* @class$1712zMiniGamePufferoids_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x70
class zMiniGamePufferoidsPuff {
    // Functions
    void Init(struct PuffInitData * data);
    ...
    void ProjectileHit(int owner, int value);

    void Kill();

    // Members
protected:
    int ownerIndex; // offset 0x0, size 0x4
    float currentSize; // offset 0x4, size 0x4
    float speed; // offset 0x8, size 0x4
    float bounceTime; // offset 0xC, size 0x4
    struct xMat4x3 mat; // offset 0x10, size 0x40
    struct xModelInstance * models[5]; // offset 0x50, size 0x14
    int state; // offset 0x64, size 0x4
public:
    class zMiniGamePufferoidsPuff * next; // offset 0x68, size 0x4
};
// Range: 0x80328DB8 -> 0x80329008
// this: r31
void zMiniGamePufferoidsPuff::Init(struct PuffInitData * data /* r1+0x8 */) {
    // Local variables
    struct PuffInitData * initData; // r28
    struct pointer_asset * pointer; // r29
    struct _zEnv * zen; // r25
    struct xEnvAsset * easset; // r27
    struct xLightKit * lightKit; // r1+0xC
    int i; // r30
    struct RpAtomic * data; // r26

    // References
    // -> static unsigned int PUFF_MODEL_IDS[5];
...
// Range: 0x80329008 -> 0x80329464
// this: r31
void zMiniGamePufferoidsPuff::Update(float dt /* f31 */) {
    // Local variables
    struct xVec3 moveVec; // r1+0x50
    float moveMag; // f30
    struct xSweptSphere sws; // r1+0x128
    struct xVec3 start; // r1+0x44
    struct xVec3 end; // r1+0x38
    float r; // f29
    int i; // r30
    int result; // r29
    struct xVec3 reflectDir; // r1+0x2C
    struct xVec3 alreadyMoved; // r1+0x20
    float mag; // f27
    float angleDiff; // f26
    float moveMag; // f28
    struct xSweptSphere sws; // r1+0x5C
...
// total size: 0x0
class zMiniGamePufferoidsShot {};
// total size: 0x1410
class zMiniGamePufferoidsPlayer : public zMiniGamePlayer {
    // Members
protected:
    int state; // offset 0x13B0, size 0x4
    struct xMat3x3 restoreMat; // offset 0x13C0, size 0x30
    int lives; // offset 0x13F0, size 0x4
    int score; // offset 0x13F4, size 0x4
    float invincibleTimer; // offset 0x13F8, size 0x4
    float fellTimer; // offset 0x13FC, size 0x4
    unsigned char trip; // offset 0x1400, size 0x1
    unsigned char skipRender; // offset 0x1401, size 0x1
    int skipCounter; // offset 0x1404, size 0x4
    class zMiniGamePufferoidsShot * shots; // offset 0x1408, size 0x4
};
// total size: 0xDC
...
// total size: 0x890
struct /* @class$1955zMiniGamePufferoids_cpp */ {
    // Static members
...
// Range: 0x80329464 -> 0x803294E0
// this: r31
void zMiniGamePufferoidsPuff::Render() {
    // Local variables
    struct xModelInstance * model; // r30
}

// Range: 0x803294E0 -> 0x80329538
// this: r30
float zMiniGamePufferoidsPuff::GetRadius() {
    // Local variables
    struct xModelInstance * model; // r31
}

// Range: 0x80329538 -> 0x8032963C
// this: r3
void zMiniGamePufferoidsPuff::ProjectileHit(int owner /* r4 */, int value /* r5 */) {}

// Range: 0x8032963C -> 0x80329648
// this: r3
void zMiniGamePufferoidsPuff::Kill() {}

// total size: 0x7C
struct {} zMiniGamePufferoids::__vtable; // size: 0x7C, address: 0x8052DFD0
// total size: 0x34
struct zMiniGameAssetPufferoidsStage : public zMiniGameAsset {
    // Members
    unsigned int totalPuffs; // offset 0x14, size 0x4
    unsigned int initialPuffs; // offset 0x18, size 0x4
    unsigned int spawnMin; // offset 0x1C, size 0x4
    unsigned int spawnMax; // offset 0x20, size 0x4
    float puffSpeed; // offset 0x24, size 0x4
    unsigned int puffSpawnGroupID; // offset 0x28, size 0x4
    unsigned int pickupSpawnGroupID; // offset 0x2C, size 0x4
    unsigned int nextStageID; // offset 0x30, size 0x4
};
// total size: 0x1
struct /* @class$1080zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1082zMiniGamePufferoids_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1083zMiniGamePufferoids_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1084zMiniGamePufferoids_cpp */ {
    // Members
...
enum /* @enum$1085zMiniGamePufferoids_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1086zMiniGamePufferoids_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1087zMiniGamePufferoids_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1089zMiniGamePufferoids_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1077zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0x220
class zMiniGamePufferoids : public zMiniGameBase {
    // Functions
    zMiniGamePufferoids(struct zMiniGameAsset * a);

    void SpawnPuffs(int num);

    void SetupStage(unsigned int id, unsigned char resetPickup);
    ...
    // Members
protected:
    class zMiniGamePickupController pickups; // offset 0x30, size 0x1C0
    struct zMiniGameAssetPufferoidsStage * currStage; // offset 0x1F0, size 0x4
    struct xGroup * puffSpawnGroup; // offset 0x1F4, size 0x4
    unsigned int puffSpawned; // offset 0x1F8, size 0x4
    class zMiniGamePufferoidsPuff * freePuffs; // offset 0x1FC, size 0x4
    class zMiniGamePufferoidsPuff * activePuffs; // offset 0x200, size 0x4
    float resetTimer; // offset 0x204, size 0x4
    int winner; // offset 0x208, size 0x4
    struct ztextbox * statsText[4]; // offset 0x20C, size 0x10
    class zUIImage * resultImage; // offset 0x21C, size 0x4
};
// Range: 0x80329648 -> 0x8032969C
// this: r31
zMiniGamePufferoids::zMiniGamePufferoids(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGamePufferoids::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67921
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8032969C -> 0x8032997C
void zMiniGamePufferoids::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r26 */) {
    // Local variables
    unsigned long expected_asset_size; // r27
    class zMiniGamePufferoids * instance; // r30
    int i; // r29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D67926
// total size: 0x28
...
struct PuffInitData {
    // Members
    struct pointer_asset * pointer; // offset 0x0, size 0x4
    float speed; // offset 0x4, size 0x4
};
// Range: 0x8032997C -> 0x80329A80
// this: r31
void zMiniGamePufferoids::SpawnPuffs(int num /* r1+0x8 */) {
    // Local variables
    int i; // r29
    class zMiniGamePufferoidsPuff * puff; // r30
    struct PuffInitData data; // r1+0xC

    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D67931
// Range: 0x80329A80 -> 0x80329B80
// this: r31
void zMiniGamePufferoids::SetupStage(unsigned int id /* r1+0x8 */, unsigned char resetPickup /* r1+0xC */) {
    // Local variables
    struct xGroup * pickupSpawnGroup; // r30

    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x80329B80 -> 0x80329D3C
// this: r31
void zMiniGamePufferoids::SceneSetup() {
    // Local variables
    unsigned int goodPickup; // r30
...
// total size: 0x1C
struct zMiniGameAssetPufferoids : public zMiniGameAsset {
    // Members
    unsigned int playerLives; // offset 0x14, size 0x4
    unsigned int firstStageID; // offset 0x18, size 0x4
};
// Range: 0x80329D3C -> 0x80329E00
// this: r31
void zMiniGamePufferoids::CheckWinLoseConditions() {
    // Local variables
    int i; // r30
...
// Range: 0x80329E00 -> 0x80329F08
// this: r31
void zMiniGamePufferoids::SetWinLoseDisplay() {
    // Local variables
    int i; // r30
...
static char statsBuf[4][128]; // size: 0x200, address: 0x80D34320
// Range: 0x80329F08 -> 0x8032A284
// this: r31
void zMiniGamePufferoids::Update(float dt /* f31 */) {
    // Local variables
    int i; // r28
    int grabbedPickup; // r1+0x8
    class zMiniGamePufferoidsPuff * curr; // r30
    class zMiniGamePufferoidsPuff * prev; // r27
    class zMiniGamePufferoidsPuff * next; // r24
    int num; // r26
    int deadCount; // r23
    int k; // r25
    int j; // r29
...
// Range: 0x8032A284 -> 0x8032A2F0
// this: r30
void zMiniGamePufferoids::Render() {
    // Local variables
    class zMiniGamePufferoidsPuff * puff; // r31
}

// Range: 0x8032A2F0 -> 0x8032A438
// this: r31
void zMiniGamePufferoids::Reset() {
    // Local variables
    class zMiniGamePufferoidsPuff * puff; // r30
    int i; // r29
    int i; // r28
...
// Range: 0x8032A438 -> 0x8032A43C
void zMiniGamePufferoids::AddTweaks() {}
