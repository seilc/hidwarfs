/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCProjectileTrackingGrub.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C9220 -> 0x802CA774
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float TGRUB_TURN_SPEED; // size: 0x4, address: 0x80D66878
static float TGRUB_SPEED; // size: 0x4, address: 0x80D6687C
static float TGRUB_EXPLOSION_RADIUS; // size: 0x4, address: 0x80D66880
static float TGRUB_AWAY_KNOCKBACK; // size: 0x4, address: 0x80D66884
static float TGRUB_UP_KNOCKBACK; // size: 0x4, address: 0x80D66888
static float TGRUB_TRAIL_OFFSET; // size: 0x4, address: 0x80D6688C
static float TGRUB_SHADOW_OFFSET; // size: 0x4, address: 0x80D66890
static float TGRUB_DECAL_SIZE; // size: 0x4, address: 0x80D66894
static float TGRUB_LIFETIME; // size: 0x4, address: 0x80D66898
static float TGRUB_RADIUS; // size: 0x4, address: 0x80D6689C
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x804D2288
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x80D6B5D8
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x80D6B5DC
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x80D6B5E0
static unsigned int TGRUB_BUG_MODEL_ID; // size: 0x4, address: 0x80D6B5E4
static unsigned int TGRUB_WING_MODEL_ID; // size: 0x4, address: 0x80D6B5E8
static unsigned int TGRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x80D6B5EC
static unsigned int TGRUB_WING_SURFACE_ID; // size: 0x4, address: 0x80D6B5F0
// total size: 0x38
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x38, address: 0x805284E8
static struct TrailConfig ShortTrailConfig; // size: 0x38, address: 0x80528520
enum iSndGroupHandle {
};
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x80D668A0
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x80D668A4
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x80D668A8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$892zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
union /* @class$1040zNPCProjectileTrackingGrub_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCProjectileTrackingGrub_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct xSurface * tgrubScrollingSurf; // size: 0x4, address: 0x80D6B5F4
struct xSurface * tgrubWingScrollingSurf; // size: 0x4, address: 0x80D6B5F8
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1911zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$833zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x178
class zNPCProjectileTrackingGrub : public zNPCProjectileBase {
    // Functions
    void Reset();
    ...
    void Explode(unsigned char doDamage, const struct xEnt * ent);

    unsigned char LaunchFromEnt(struct xEnt * ent, const struct xVec3 * localOffset, float target, struct xEnt * refObj);

    // Static members
    static enum iSndGroupHandle splatSoundGroup; // size: 0x4
    static enum iSndGroupHandle flyingSoundGroup; // size: 0x4
    static enum iSndGroupHandle launchSoundGroup; // size: 0x4

    // Members
    struct xEnt * owner; // offset 0x18, size 0x4
    struct xEnt * target; // offset 0x1C, size 0x4
    struct xModelInstance * bugModel; // offset 0x20, size 0x4
    struct xModelInstance * wingModel; // offset 0x24, size 0x4
    struct xVec3 dir; // offset 0x28, size 0xC
    float turnSpeed; // offset 0x34, size 0x4
    int damage; // offset 0x38, size 0x4
    float lifetime; // offset 0x3C, size 0x4
    struct xVec3 startPos; // offset 0x40, size 0xC
    float emit_remaining; // offset 0x4C, size 0x4
    float spark_emit_remaining; // offset 0x50, size 0x4
    float arc_emit_remaining; // offset 0x54, size 0x4
    struct zShrapnelAsset * launchGoo; // offset 0x58, size 0x4
    struct zShrapnelAsset * hitGoo; // offset 0x5C, size 0x4
    struct emit_context decalContext; // offset 0x60, size 0x5C
    struct xResponseCurve decalResponseCurve; // offset 0xBC, size 0x14
    enum xSndHandle flyingSound; // offset 0xD0, size 0x4
    struct xShadowSimpleCache simpShadow; // offset 0xD4, size 0xA4
};
// Range: 0x802C9220 -> 0x802C9254
// this: r1+0x8
void zNPCProjectileTrackingGrub::Reset() {}

// Range: 0x802C9254 -> 0x802C925C
float zNPCProjectileTrackingGrub::GetRadius() {
    // References
    // -> static float TGRUB_RADIUS;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D668AC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x802C925C -> 0x802C9330
// this: r31
void zNPCProjectileTrackingGrub::Freeze() {
    // Local variables
    struct xVec3 velocity; // r1+0x8

    // References
    // -> static char __FUNCTION__[7];
    // -> static float TGRUB_SPEED;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D668B3
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1288zNPCProjectileTrackingGrub_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802C9330 -> 0x802C946C
void zNPCProjectileTrackingGrub::StaticSetup() {
    // References
    // -> struct xSurface * tgrubWingScrollingSurf;
    // -> static char __FUNCTION__[12];
    // -> static unsigned int TGRUB_WING_SURFACE_ID;
    // -> struct zGlobals globals;
    // -> struct xSurface * tgrubScrollingSurf;
    // -> static unsigned int TGRUB_BUG_SURFACE_ID;
    // -> static unsigned int SPLAT_SOUND_ID;
    // -> enum iSndGroupHandle splatSoundGroup;
    // -> static unsigned int LAUNCH_SOUND_ID;
    // -> enum iSndGroupHandle launchSoundGroup;
    // -> static unsigned int FLY_SOUND_ID;
    // -> enum iSndGroupHandle flyingSoundGroup;
}
...
// Range: 0x802C946C -> 0x802C988C
// this: r31
void zNPCProjectileTrackingGrub::Update(float dt /* f31 */) {
    // Local variables
    struct xVec3 velocity; // r1+0x88
    struct xVec3 targetPos; // r1+0x7C
    struct xVec3 toHit; // r1+0x70
    struct xVec3 perp; // r1+0x64
    float perp_length; // f30
    struct xVec3 dpos; // r1+0x58
    struct xMat4x3 * frame; // r30
    struct xVec3 up; // r1+0x4C
    struct xMat4x3 * frame2; // r29
    struct xVec3 trail_pos; // r1+0x40
    struct xVec3 vel0; // r1+0x34
    struct xMat4x3 shadowMat; // r1+0xA0

    // References
    // -> static float TGRUB_SHADOW_OFFSET;
    // -> enum iSndGroupHandle flyingSoundGroup;
    // -> static struct TrailConfig ShortTrailConfig;
    // -> static struct TrailConfig PuffConfig;
    // -> static float TGRUB_LIFETIME;
    // -> static float TGRUB_TRAIL_OFFSET;
    // -> struct xVec3 g_NZ3;
    // -> static float TGRUB_TURN_SPEED;
    // -> static float TGRUB_SPEED;
}
...
// Range: 0x802C988C -> 0x802C98DC
// this: r31
void zNPCProjectileTrackingGrub::Render() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D668BF
// Range: 0x802C98DC -> 0x802C9990
// this: r31
void zNPCProjectileTrackingGrub::Destroy() {
    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D668C7
// Range: 0x802C9990 -> 0x802CA0B8
// this: r31
unsigned char zNPCProjectileTrackingGrub::Setup(void * configData /* r20 */) {
    // Local variables
    struct TGrubConfig * config; // r30
    struct RpAtomic * data; // r26
    struct _zEnv * zen; // r24
    struct xEnvAsset * easset; // r28
    struct RpAtomic * data; // r25
    struct _zEnv * zen; // r23
    struct xEnvAsset * easset; // r27
    struct xMat4x3 * frame; // r29
    struct xVec3 up; // r1+0x14
    struct xMat4x3 * frame2; // r22
    struct xVec3 vel; // r1+0x8

    // References
    // -> enum iSndGroupHandle launchSoundGroup;
    // -> static float TGRUB_DECAL_SIZE;
    // -> static struct curve_node decalCurve[5];
    // -> struct xSurface * tgrubWingScrollingSurf;
    // -> struct xSurface * tgrubScrollingSurf;
    // -> static float TGRUB_LIFETIME;
    // -> static float TGRUB_TURN_SPEED;
    ...
    // -> struct zGlobals globals;
    // -> static unsigned int TGRUB_WING_MODEL_ID;
    // -> static unsigned int TGRUB_BUG_MODEL_ID;
}
...
// Range: 0x802CA0B8 -> 0x802CA368
// this: r31
void zNPCProjectileTrackingGrub::Collide(const struct xVec3 & dpos /* r1+0x10 */) {
    // Local variables
    struct xVec3 velocity; // r1+0x38
    struct xSweptSphere sws; // r1+0xA0
    struct xVec3 start; // r1+0x2C
    struct xVec3 end; // r1+0x20
    unsigned int old_filter_flags; // r27
    int result; // r26
    struct xMat4x3 mat; // r1+0x60
    struct xVec3 at; // r1+0x14
    int i; // r30
    struct xSphere * extra_spheres[5]; // r1+0x44
    int num_spheres; // r25
    int j; // r29
...
struct ArcConfig zNPCProjectileGrubArcPlayerConfig; // size: 0x1C, address: 0x80528390
struct ArcConfig zNPCProjectileGrubArcNPCConfig; // size: 0x1C, address: 0x805283AC
// total size: 0x34
struct SparkConfig {
    // Members
    float lifeMin; // offset 0x0, size 0x4
...
// Range: 0x802CA368 -> 0x802CA5BC
// this: r31
void zNPCProjectileTrackingGrub::Explode(unsigned char doDamage /* r1+0x10 */, const struct xEnt * ent /* r30 */) {
    // Local variables
    struct xVec3 vel; // r1+0x20
    struct xMat4x3 * frame; // r29
    struct xMat4x3 dummyMat; // r1+0x70
    struct xMat4x3 fxFrame; // r1+0x30

    // References
    // -> enum iSndGroupHandle splatSoundGroup;
    // -> struct SparkConfig burstSparkConfig;
    // -> struct ArcConfig zNPCProjectileGrubArcNPCConfig;
    // -> struct ArcConfig zNPCProjectileGrubArcPlayerConfig;
    // -> static float TGRUB_UP_KNOCKBACK;
    // -> static float TGRUB_AWAY_KNOCKBACK;
    // -> static float TGRUB_EXPLOSION_RADIUS;
}
...
struct TGrubConfig {
    ...
    struct xEnt * target; // offset 0x4, size 0x4
    struct xVec3 startPos; // offset 0x8, size 0xC
    struct xVec3 startDir; // offset 0x14, size 0xC
    int damage; // offset 0x20, size 0x4
};
// Range: 0x802CA5BC -> 0x802CA770
// this: r1+0x8
unsigned char zNPCProjectileTrackingGrub::LaunchFromEnt(struct xEnt * ent /* r27 */, const struct xVec3 * localOffset /* r1+0xC */, float target /* r1+0x10 */, struct xEnt * refObj /* r28 */) {
    // Local variables
    struct TGrubConfig config; // r1+0x20
    struct xMat4x3 * mat; // r30
    struct xVec3 offset; // r1+0x14
    int closestTarget; // r29
    float closestDist2; // f31
    int tgt; // r26
    int i; // r31
    float dist2; // f30
...
// total size: 0x4
struct /* @class$2280zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2239zNPCProjectileTrackingGrub_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2240zNPCProjectileTrackingGrub_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2241zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2238zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2243zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zNPCProjectileTrackingGrub_cpp */ {
    // Static members
...
// Range: 0x802CA770 -> 0x802CA774
void zNPCProjectileTrackingGrub::AddStaticTweaks() {}

// total size: 0x38
struct {} zNPCProjectileTrackingGrub::__vtable; // size: 0x38, address: 0x80528558
// total size: 0x0
