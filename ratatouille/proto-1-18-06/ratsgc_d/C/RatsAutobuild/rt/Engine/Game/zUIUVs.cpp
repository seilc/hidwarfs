/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUIUVs.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80289B6C -> 0x80289D08
*/
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65CE8
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x80289B6C -> 0x80289D08
float * zUIUVs_Init(struct RpAtomic * atomic /* r1+0x8 */, unsigned int & texCoordsCount /* r29 */) {
    // Local variables
    float * uvCoords; // r27
    struct RpGeometry * geom; // r30
    struct RwTexCoords * c; // r31
    int numcoordsets; // r1+0xC
    int i; // r26
    int numVerts; // r25
    float * uv; // r28
