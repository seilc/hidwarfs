/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNavigationMesh.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802852F0 -> 0x80285844
*/
class zNavigationMesh * activeNavMesh; // size: 0x4, address: 0x80D6B348
// Range: 0x802852F0 -> 0x80285320
void zNavigationMesh_Init(void * base /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80525170
// Range: 0x80285320 -> 0x802853A8
void zNavigationMeshEventCB(struct xBase * to /* r31 */) {
    // Local variables
    class zNavigationMesh * navMesh; // r1+0x8
...
// total size: 0x4
struct /* @class$916zNavigationMesh_cpp */ {
    // Members
...
union /* @class$628zNavigationMesh_cpp */ {
...
// total size: 0xC
struct /* @class$1080zNavigationMesh_cpp */ {
    // Members
...
class zNavigationMesh : public xBase {
    // Functions
    void Init(class xNavigationMeshAsset * asset);

    void SetEnable(unsigned char state);

    unsigned char IsEnabled();

    void SetNavigationMeshActive();
...
// Range: 0x802853A8 -> 0x80285404
// this: r31
void zNavigationMesh::Init(class xNavigationMeshAsset * asset /* r30 */) {}

// Range: 0x80285404 -> 0x8028546C
void zNavigationMesh::SceneReset() {
    // Local variables
    class zNavigationMesh * activeNavMesh; // r30
    class zNavigationMesh * curNavMesh; // r31

    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x8028546C -> 0x80285478
void zNavigationMesh::SceneEnd() {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80525187
// Range: 0x80285478 -> 0x8028553C
class zMeshCircle * zNavigationMesh::FindMeshCircleForEnt(const struct xEnt * ent /* r29 */) {
    // Local variables
    class zNavigationMesh * currMesh; // r31
...
// Range: 0x8028553C -> 0x802855B8
class zNavigationMesh * zNavigationMesh::FindMeshForPosition(const struct xVec3 & pos /* r1+0x8 */, int & submeshIdx /* r1+0xC */, int & triIdx /* r1+0x10 */) {
    // Local variables
    class zNavigationMesh * currMesh; // r31
}

// Range: 0x802855B8 -> 0x802855E8
void zNavigationMesh::AddNavMeshToLinkedList(class zNavigationMesh * navMesh /* r4 */) {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x802855E8 -> 0x80285638
void zNavigationMesh::FindActiveNavMesh() {
    // Local variables
    class zNavigationMesh * testNavMesh; // r31

    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x80285638 -> 0x80285660
// this: r3
void zNavigationMesh::SetEnable(unsigned char state /* r4 */) {}

// Range: 0x80285660 -> 0x8028566C
// this: r3
unsigned char zNavigationMesh::IsEnabled() {}

static char __FUNCTION__[24]; // size: 0x18, address: 0x8052519C
// Range: 0x8028566C -> 0x80285738
// this: r30
void zNavigationMesh::SetNavigationMeshActive() {
    // Local variables
    class zNavigationMesh * testNavMesh; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65C28
// Range: 0x80285738 -> 0x80285804
class zNavigationMesh * zNavigationMesh::GetActiveNavMesh() {
    // References
    // -> class zNavigationMesh * activeNavMesh;
    // -> static char __FUNCTION__[17];
}

// Range: 0x80285804 -> 0x80285844
class xNavigationMeshAsset * zNavigationMesh::GetActiveNavMeshAsset() {
    // Local variables
    class zNavigationMesh * activeNavMesh; // r31
}
