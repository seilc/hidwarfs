/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUberLaser.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8023042C -> 0x80232C1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64D30
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8023042C -> 0x802306B8
void zUberLaser::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r28
    class zUberLaser & ulaser; // r31
    struct zUberLaserAsset & uasset; // r29
...
class zLightweightSystem * zLightweight<z::uber_laser, 5>::GetSystem()::system; // size: 0x4, address: 0x80D6AF60
signed char zLightweight<z::uber_laser, 5>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6AF64
char __FUNCTION__$localstatic1$Add__38zLightweightSystem<Q21z10uber_laser,5>FRCQ21z10uber_laser[4]; // size: 0x4, address: 0x80D64D35
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// total size: 0x2C
struct /* @class$1879zUberLaser_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$1880zUberLaser_cpp */ {
    // Members
...
struct config default_config; // size: 0x180, address: 0x80523B88
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$1243zUberLaser_cpp */ {
    // Members
...
union /* @class$1425zUberLaser_cpp */ {
...
// Range: 0x802306B8 -> 0x80230778
void zUberLaser::handle_event(struct xBase * to /* r1+0x8 */, unsigned int event /* r1+0xC */, struct xBase * widget_param /* r1+0x10 */) {
    // Local variables
    class zUberLaser * ulaser; // r31
    class uber_laser new_ulaser; // r1+0x14
    class uber_laser * laser; // r30
...
// total size: 0x24
struct {} zLightweightSystem<z::uber_laser, 5>::__vtable; // size: 0x24, address: 0x80523D64
int ring_explosion; // size: 0x4, address: 0x80D6AF68
enum iSndGroupHandle {
};
enum iSndGroupHandle shoot_charge; // size: 0x4, address: 0x80D6AF6C
enum iSndGroupHandle shoot; // size: 0x4, address: 0x80D6AF70
enum iSndGroupHandle shoot_end; // size: 0x4, address: 0x80D6AF74
enum iSndGroupHandle explode; // size: 0x4, address: 0x80D6AF78
struct RwRaster * beam_raster; // size: 0x4, address: 0x80D6AF7C
// total size: 0x24
...
struct RxObjSpace3DVertex * vert; // size: 0x4, address: 0x80D6AF80
// Range: 0x80230778 -> 0x80230EE0
...
// total size: 0xC
struct /* @class$1184zUberLaser_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1185zUberLaser_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1186zUberLaser_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1187zUberLaser_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1188zUberLaser_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1189zUberLaser_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1190zUberLaser_cpp */ {
    // Members
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D64D39
// total size: 0x18
...
// Range: 0x80230EE0 -> 0x80231054
void uber_laser::Setup() {
    // Local variables
    const char * prefix; // r30
    void * mem; // r29
    unsigned int LASER_TEXTURE_ID; // r28
    struct RwTexture * beam_texture; // r31
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D64D3F
// Range: 0x80231054 -> 0x802310C8
// this: r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64D47
// total size: 0x20
struct {} z::uber_laser::__vtable; // size: 0x20, address: 0x80523D24
// Range: 0x802310C8 -> 0x80231360
// this: r31
uber_laser::uber_laser() {
    // Local variables
    unsigned int ball_model_id; // r29
    unsigned int size; // r1+0x8
    struct RpAtomic * imodel; // r30
    unsigned int beam_model_id; // r28
...
// total size: 0x20
struct {} zLightweight<z::uber_laser, 5>::__vtable; // size: 0x20, address: 0x80523D44
// total size: 0xC
struct xVec3 {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64D4C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1438zUberLaser_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80231360 -> 0x80231598
// this: r31
uber_laser::uber_laser(struct xEnt * owner /* r1+0x8 */, const struct xVec3 & start /* r28 */, const struct xVec3 & end /* r29 */, struct config * cfg /* r30 */) {
    // Local variables
    float distance_to_laser; // f31
...
// Range: 0x80231598 -> 0x802316A0
static float distance(const struct xVec3 & P /* r30 */, const struct xVec3 & A /* r31 */, const struct xVec3 & B /* r29 */) {
    // Local variables
...
static int trail_type; // size: 0x4, address: 0x80D6AF84
static signed char init; // size: 0x1, address: 0x80D6AF88
// Range: 0x802316A0 -> 0x80231770
// this: r31
...
// Range: 0x802317E0 -> 0x80231A74
// this: r31
void uber_laser::update_ring(float dt /* f30 */) {
    // Local variables
    struct xVec3 ring_start; // r1+0x20
    float angle_delta; // f25
    float intensity; // f24
    float angle; // f31
    int i; // r30
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64D51
...
// total size: 0xC
struct /* @class$1381zUberLaser_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1972zUberLaser_cpp */ {
    // Static members
...
// Range: 0x80232320 -> 0x80232408
// this: r31
class uber_laser & uber_laser::operator=(const class uber_laser & ulaser /* r30 */) {}
...
static int laser_count; // size: 0x4, address: 0x80D6AF8C
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64D58
// Range: 0x802327D0 -> 0x80232874
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D64D68
// Range: 0x80232874 -> 0x80232B40
// this: r31
void uber_laser::PostRender2d() const {
    // Local variables
    struct xVec3 end_loc; // r1+0x2C
    const struct xMat4x3 & cam_mat; // r30
    const struct xVec3 & dir; // r29
...
// Range: 0x80232B40 -> 0x80232BC4
void set_vert(struct RxObjSpace3DVertex & vert /* r3 */, const struct xVec3 & loc /* r4 */, float u /* f1 */, float v /* f2 */, const struct xColor_tag & color /* r5 */) {
    // Local variables
    struct RwV3d tmp; // r1+0xC
    struct RwRGBA col; // r1+0x8
}

// Range: 0x80232BC4 -> 0x80232C1C
