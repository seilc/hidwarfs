/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zWaterhose.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D2034 -> 0x801D4EF4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwRaster * textureRaster; // size: 0x4, address: 0x80D6AB70
// total size: 0x8
struct RwObject {
    // Members
...
struct RwTexture * particleTex; // size: 0x4, address: 0x80D6AB74
...
struct WaterhoseCollisionInfo waterhoseCollisionInfo; // size: 0x14, address: 0x80D63DF0
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D63E04
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x34
struct zWaterhoseAsset : public xDynAsset {
    // Members
    struct xVec3 startPos; // offset 0x10, size 0xC
    struct xVec3 endPos; // offset 0x1C, size 0xC
    struct xColor_tag color; // offset 0x28, size 0x4
    unsigned int sound; // offset 0x2C, size 0x4
    unsigned int soundHit; // offset 0x30, size 0x4
};
// total size: 0x18
class zWaterhoseWidget : private xBase {
    // Functions
    void Init(struct zWaterhoseAsset * a);

    // Members
    class zWaterhose * waterhose; // offset 0x10, size 0x4
    struct zWaterhoseAsset * asset; // offset 0x14, size 0x4
};
// Range: 0x801D2034 -> 0x801D21E0
void zWaterhoseWidget::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x801D21E0 -> 0x801D223C
// this: r31
void zWaterhoseWidget::Init(struct zWaterhoseAsset * a /* r30 */) {
    // References
    // -> struct WaterhoseCollisionInfo waterhoseCollisionInfo;
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63E09
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x801D223C -> 0x801D24A8
void zWaterhoseWidget::EventCB(struct xBase * to /* r28 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r29 */) {
    // Local variables
    class zWaterhoseWidget & waterhoseWidget; // r31
...
struct Layer {
    // Members
    struct xVec3 pos[20]; // offset 0x0, size 0xF0
    struct xVec3 vel[20]; // offset 0xF0, size 0xF0
...
struct CrossCardMesh {
    // Members
    struct xVec3 line[7][8]; // offset 0x0, size 0x2A0
...
class zWaterhose {
    ...
    zWaterhose(struct xVec3 & startPos, struct xVec3 & endPos);
    ...
    void AddTweaks(unsigned int number);

    void UpdatePTankPool();

    void UpdateParticles(float dt);

    void UpdateCrossCards(float dt);

    void CreateCardEdge(int l, float dirX, float dirY);

    void GetSecondEmitterPoint();

    void RenderCrossCardSections();

    void RenderCrossCardSection(int i);
    ...
    unsigned char IsMgrRender();

    // Static members
    static struct RwTexture * particleTex; // size: 0x4
    static struct RwRaster * textureRaster; // size: 0x4
...
private:
    struct Particle * particles; // offset 0x10, size 0x4
    unsigned char particleMem[32015]; // offset 0x14, size 0x7D0F
    struct Layer layer[1]; // offset 0x7D24, size 0x1E8
    struct CrossCardMesh crossCardMesh; // offset 0x7F0C, size 0x2D4
    int nextLayer; // offset 0x81E0, size 0x4
    int counter; // offset 0x81E4, size 0x4
    float texScroll; // offset 0x81E8, size 0x4
    int nextParticle; // offset 0x81EC, size 0x4
    struct _tagxPad * pad; // offset 0x81F0, size 0x4
    unsigned char isFirstPass; // offset 0x81F4, size 0x1
    float angleLast; // offset 0x81F8, size 0x4
    struct xVec3 emitterPos; // offset 0x81FC, size 0xC
    struct xVec3 emitterDir; // offset 0x8208, size 0xC
    struct xColor_tag color; // offset 0x8214, size 0x4
    ...
    int enabled; // offset 0x8228, size 0x4
    unsigned char doRender; // offset 0x822C, size 0x1
    struct tweak_callback waterhoseStartCB; // offset 0x8230, size 0x28
    struct xMat4x3 emitterMat; // offset 0x8260, size 0x40
    struct xMat4x3 emitterMatB; // offset 0x82A0, size 0x40
...
// Range: 0x801D24A8 -> 0x801D24DC
void * zWaterhose::operator new(unsigned long size /* r1+0x8 */) {
    // Local variables
    class zWaterhoseMgr * mgr; // r31
}

// Range: 0x801D24DC -> 0x801D2510
void zWaterhose::operator delete(void * mem /* r1+0x8 */) {
    // Local variables
    class zWaterhoseMgr * mgr; // r31
}

// Range: 0x801D2510 -> 0x801D252C
// this: r3
void zWaterhose::SetSegmentLength(float length /* f1 */) {}

// Range: 0x801D252C -> 0x801D25C8
// this: r31
zWaterhose::zWaterhose(struct xVec3 & startPos /* r30 */, struct xVec3 & endPos /* r1+0x8 */) {
    // Local variables
...
// Range: 0x801D25C8 -> 0x801D2620
// this: r31
zWaterhose::~zWaterhose() {}

static unsigned int counter; // size: 0x4, address: 0x80D6AB78
static signed char init; // size: 0x1, address: 0x80D6AB7C
// Range: 0x801D2620 -> 0x801D27DC
// this: r31
...
// Range: 0x801D27EC -> 0x801D289C
// this: r31
void zWaterhose::Update(float dt /* f31 */) {}

float WATERHOSE_FADE_DIST; // size: 0x4, address: 0x80D63E14
float WATERHOSE_CULL_DIST; // size: 0x4, address: 0x80D63E18
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$832zWaterhose_cpp */ {
    // Members
...
// Range: 0x801D289C -> 0x801D2B28
// this: r31
unsigned char zWaterhose::Cull() {
    // Local variables
    struct xMat4x3 mat; // r1+0x70
    struct xVec3 pos; // r1+0x5C
    float dist2; // f31
    struct xVec3 start; // r1+0x50
    struct xVec3 end; // r1+0x44
    struct xVec3 step; // r1+0x38
    int i; // r30
    unsigned char doDraw; // r29
    struct RwSphere worldsph; // r1+0x28
    struct xVec3 oldPos; // r1+0x1C
    struct xVec3 oldPos; // r1+0x10

    // References
    // -> struct xGlobals * xglobals;
    // -> float WATERHOSE_FADE_DIST;
    // -> float WATERHOSE_CULL_DIST;
}

// Range: 0x801D2B28 -> 0x801D2B88
// this: r31
void zWaterhose::Render() {}

unsigned int tweakWHcardTextureID; // size: 0x4, address: 0x80D6AB80
unsigned int tweakWHParticleTextureID; // size: 0x4, address: 0x80D6AB84
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63E1C
// Range: 0x801D2B88 -> 0x801D2CF0
// this: r31
void zWaterhose::FirstPassInit() {
    // Local variables
    struct RwTexture * tex; // r30

    // References
    // -> struct RwRaster * textureRaster;
    // -> static char __FUNCTION__[14];
    // -> unsigned int tweakWHcardTextureID;
    // -> struct RwTexture * particleTex;
    // -> unsigned int tweakWHParticleTextureID;
}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x805224C0
// Range: 0x801D2CF0 -> 0x801D2D8C
...
static char __FUNCTION__[31]; // size: 0x1F, address: 0x805224DB
// Range: 0x801D2D8C -> 0x801D2E1C
...
// total size: 0xC
struct /* @class$768zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zWaterhose_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zWaterhose_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zWaterhose_cpp */ {
    // Members
...
static struct tweak_callback cb_change_texture; // size: 0x28, address: 0x805224FC
static signed char init; // size: 0x1, address: 0x80D6AB88
static struct tweak_callback cb_change_textureB; // size: 0x28, address: 0x80522524
static signed char init; // size: 0x1, address: 0x80D6AB89
...
// Range: 0x801D2E1C -> 0x801D322C
// this: r31
void zWaterhose::AddTweaks(unsigned int number /* r1+0x18 */) {
    // Local variables
    char name[64]; // r1+0xB0
    char name1[64]; // r1+0x70
    char prefix[1]; // r1+0x1C
    char _buffer[128]; // r1+0x170
    char _buffer[128]; // r1+0xF0

    // References
    // -> static struct tweak_callback cb_change_textureB;
...
// Range: 0x801D322C -> 0x801D3270
void zWaterhose::RemoveTweaks(unsigned int number /* r1+0x8 */) {
    // Local variables
    char name[64]; // r1+0xC
}
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63E2A
// total size: 0x40
...
static float speed; // size: 0x4, address: 0x80D6AB8C
static signed char init; // size: 0x1, address: 0x80D6AB90
static float start; // size: 0x4, address: 0x80D6AB94
static signed char init; // size: 0x1, address: 0x80D6AB98
static float yOffset; // size: 0x4, address: 0x80D6AB9C
static signed char init; // size: 0x1, address: 0x80D6ABA0
static float spread; // size: 0x4, address: 0x80D6ABA4
static float life; // size: 0x4, address: 0x80D6ABA8
// Range: 0x801D33F4 -> 0x801D3B24
// this: r31
void zWaterhose::UpdateParticles(float dt /* f29 */) {
    // Local variables
    int numSteps; // r24
    float angle; // f28
    struct xMat3x3 matEmitter; // r1+0x30
    float emitterLen; // r1+0x10
    struct xVec3 emitterUp; // r1+0x20
    struct xVec3 emitterRight; // r1+0x14
    int p; // r27
    struct Particle & particle; // r30
    float time; // f31
    float size; // f30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D63E3A
// Range: 0x801D3B24 -> 0x801D3F38
// this: r31
void zWaterhose::UpdateCrossCards(float dt /* r1+0x8 */) {
    // Local variables
    struct RwTexture * tex; // r30
    float angle; // f30
    float angleDiff; // f31
...
static float start; // size: 0x4, address: 0x80D6ABAC
static signed char init; // size: 0x1, address: 0x80D6ABB0
static float yOffset; // size: 0x4, address: 0x80D6ABB4
static signed char init; // size: 0x1, address: 0x80D6ABB8
static float spread; // size: 0x4, address: 0x80D6ABBC
static signed char init; // size: 0x1, address: 0x80D6ABC0
static float speed; // size: 0x4, address: 0x80D6ABC4
static signed char init; // size: 0x1, address: 0x80D6ABC8
// Range: 0x801D3F38 -> 0x801D41EC
// this: r31
void zWaterhose::CreateCardEdge(int l /* r1+0x10 */, float dirX /* f30 */, float dirY /* f31 */) {
    // Local variables
    struct xVec3 dir; // r1+0x38
    struct xMat3x3 matC; // r1+0x50
    struct xVec3 * pos; // r29
    struct xMat4x3 & mat; // r28
    int i; // r30
    struct xVec3 move; // r1+0x2C
    struct xVec3 acc; // r1+0x20
    struct xVec3 dirB; // r1+0x14
...
static float start; // size: 0x4, address: 0x80D6ABCC
static signed char init; // size: 0x1, address: 0x80D6ABD0
static float yOffset; // size: 0x4, address: 0x80D6ABD4
static signed char init; // size: 0x1, address: 0x80D6ABD8
static float spread; // size: 0x4, address: 0x80D6ABDC
static signed char init; // size: 0x1, address: 0x80D6ABE0
static float speed; // size: 0x4, address: 0x80D6ABE4
static signed char init; // size: 0x1, address: 0x80D6ABE8
// Range: 0x801D41EC -> 0x801D4404
// this: r31
void zWaterhose::GetSecondEmitterPoint() {
    // Local variables
    struct xVec3 dir; // r1+0x34
    struct xMat4x3 matC; // r1+0x40
    struct xVec3 pos; // r1+0x28
    struct xMat4x3 & mat; // r30
    int i; // r29
    struct xVec3 move; // r1+0x1C
    struct xVec3 acc; // r1+0x10
...
// Range: 0x801D4404 -> 0x801D4460
// this: r30
void zWaterhose::RenderCrossCardSections() {
    // Local variables
    int i; // r31
}

// Range: 0x801D4460 -> 0x801D4660
// this: r31
void zWaterhose::RenderCrossCardSection(int i /* r1+0x8 */) {
    // Local variables
    struct RxObjSpace3DVertex vert[14]; // r1+0x14
    float s; // f30
    float t; // f31
    int p; // r30
...
// Range: 0x801D4660 -> 0x801D46E4
void zWaterhose::SetVert(struct RxObjSpace3DVertex & vert /* r4 */, const struct xVec3 & loc /* r5 */, float u /* f1 */, float v /* f2 */, struct xColor_tag & color /* r6 */) {
    // Local variables
...
// Range: 0x801D4804 -> 0x801D48C8
void zWaterhose::Collide(const struct xBound & bound /* r1+0x8 */) {
    // Local variables
    int i; // r30
    struct xSphere * player_spheres[5]; // r1+0xC
    int player_spheres_size; // r29
    int j; // r31
...
// total size: 0x890
struct /* @class$1906zWaterhose_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$1150zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zWaterhose_cpp */ {
    // Members
...
// Range: 0x801D48C8 -> 0x801D499C
unsigned char zWaterhose::CollisionCB(struct xEnt & ent /* r1+0x10 */) {
    // Local variables
...
// Range: 0x801D499C -> 0x801D49A0
void zWaterhose::BeginRender() {}

// Range: 0x801D49A0 -> 0x801D49A4
void zWaterhose::EndRender() {}
...
class zWaterhoseMgr * waterhoseMgr; // size: 0x4, address: 0x80D6ABEC
// total size: 0xC
class zWaterhoseMgr {
    // Functions
    zWaterhoseMgr();

    class zWaterhose * GetMem(unsigned long size);

    void FreeMem(class zWaterhose * mem);
    ...
    // Static members
    static class zWaterhoseMgr * waterhoseMgr; // size: 0x4

    // Members
    unsigned char isFirstGet; // offset 0x0, size 0x1
    class zWaterhose * freeList; // offset 0x4, size 0x4
    class zWaterhose * usedList; // offset 0x8, size 0x4
};
// Range: 0x801D49A4 -> 0x801D4A04
class zWaterhoseMgr * zWaterhoseMgr::Get() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x801D4A04 -> 0x801D4A1C
void zWaterhoseMgr::Remove() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x801D4A1C -> 0x801D4A68
void zWaterhoseMgr::Reset() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x801D4A68 -> 0x801D4A74
// this: r3
zWaterhoseMgr::zWaterhoseMgr() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D63E4B
// Range: 0x801D4A74 -> 0x801D4C80
// this: r31
class zWaterhose * zWaterhoseMgr::GetMem(unsigned long size /* r26 */) {
    // Local variables
    class zWaterhose * mem; // r30
    class zWaterhose * prev; // r28
    unsigned int i; // r27
    class zWaterhose * mem; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63E52
// Range: 0x801D4C80 -> 0x801D4D78
// this: r30
void zWaterhoseMgr::FreeMem(class zWaterhose * mem /* r31 */) {
    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x801D4D78 -> 0x801D4DB0
void zWaterhoseMgr::Update(float dt /* r1+0x8 */) {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x801D4DB0 -> 0x801D4E44
// this: r29
void zWaterhoseMgr::_Update(float dt /* r1+0x8 */) {
    // Local variables
    class zWaterhose * waterhose; // r31
    class zWaterhose * mem; // r30
}

// Range: 0x801D4E44 -> 0x801D4E50
// this: r3
unsigned char zWaterhose::IsShutDown() {}

// Range: 0x801D4E50 -> 0x801D4E5C
// this: r3
unsigned char zWaterhose::IsMgrUpdate() {}

// Range: 0x801D4E5C -> 0x801D4E8C
void zWaterhoseMgr::Render() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x801D4E8C -> 0x801D4EE8
// this: r30
void zWaterhoseMgr::_Render() {
    // Local variables
    class zWaterhose * waterhose; // r31
}

// Range: 0x801D4EE8 -> 0x801D4EF4
// this: r3
unsigned char zWaterhose::IsMgrRender() {}
