/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicSimpleton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80336DD0 -> 0x803382AC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams; // size: 0x70, address: 0x80D35F00
// total size: 0x8
...
static struct zCompStateMachineTable gSimpletonStateMachineTable[5]; // size: 0x28, address: 0x8052E778
// total size: 0x34
...
// Range: 0x80336DD0 -> 0x80336E18
void zCompLogicSimpleton::AddStaticTweaks() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67B48
// Range: 0x80336E18 -> 0x803372C8
// this: r30
unsigned char zCompLogicSimpleton::SystemEvent(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int to_event /* r21 */, const float * to_param /* r31 */, struct xBase * to_param_widget /* r29 */, unsigned int to_param_widget_id /* r1+0x10 */) {
    // Local variables
    class zSimpletonMoveTo * moveState; // r25
    class zSimpletonPatrol * patrolState; // r24
    class zICompNPCEntity * compNPCEntity; // r26
    class zSimpletonPlayCustomAnim * animState; // r23
    unsigned int animId; // r28
    class zSimpletonPlayCustomAnim * animState; // r22
    unsigned int animId; // r27

    // References
    // -> static char __FUNCTION__[12];
    // -> static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams;
}
...
struct zAnimListAsset {
    ...
    unsigned int stateHashes[10]; // offset 0x28, size 0x28
    unsigned char hasPhysics[10]; // offset 0x50, size 0xA
};
// total size: 0x20
class zSimpletonPlayCustomAnim : public zCompState {
    // Functions
    zSimpletonPlayCustomAnim();
    ...
    // Members
    struct zAnimListAsset * animListAsset; // offset 0x14, size 0x4
    unsigned int animID; // offset 0x18, size 0x4
    unsigned int looped; // offset 0x1C, size 0x4
};
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x20
class zSimpletonPatrol : public zCompState {
    // Functions
    zSimpletonPatrol();
    ...
    unsigned char SystemEvent(struct xBase * to, unsigned int to_event);

    // Members
    struct xMovePoint * curMovePoint; // offset 0x14, size 0x4
    struct xMovePoint * prevMovePoint; // offset 0x18, size 0x4
    unsigned int isPaused; // offset 0x1C, size 0x4
};
// total size: 0x28
...
// total size: 0x1C
class zSimpletonMoveTo : public zCompState {
    // Functions
    zSimpletonMoveTo();
    ...
    // Members
    struct xMovePoint * curMovePoint; // offset 0x14, size 0x4
    unsigned int isPaused; // offset 0x18, size 0x4
};
// Range: 0x803372C8 -> 0x8033738C
void zCompLogicSimpleton::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x8033738C -> 0x80337390
void zCompLogicSimpleton::SetupStateTranstitionTests() {}

// Range: 0x80337390 -> 0x80337398
int zCompLogicSimpleton::GetInitialStateEnum() {}

// Range: 0x80337398 -> 0x803373A4
struct zCompStateMachineTable * zCompLogicSimpleton::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gSimpletonStateMachineTable[5];
}

// Range: 0x803373A4 -> 0x803373D4
void zSimpletonMoveTo::AddStaticTweaks(const char * name /* r1+0x8 */) {
    // References
    // -> static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams;
}

// total size: 0x2C
struct {} zSimpletonMoveTo::__vtable; // size: 0x2C, address: 0x8052E824
// Range: 0x803373D4 -> 0x80337428
// this: r31
zSimpletonMoveTo::zSimpletonMoveTo() {
    // References
    // -> static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams;
    // -> struct [anonymous] zSimpletonMoveTo::__vtable;
}
...
// Range: 0x80337428 -> 0x80337538
// this: r29
void zSimpletonMoveTo::Update(class zNPCBase * owner /* r30 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r28
    class zICompNPCEntity * compNPCEntity; // r31
    class zCompLogicSimpleton * compLogic; // r27
    const struct xVec3 * movePointPos; // r26
    struct xVec3 * NPCPos; // r25
    class zCompSteeringBasic * steering; // r1+0xC
    float boundRadius; // f31
    struct xVec3 distanceVec; // r1+0x10
}

// Range: 0x80337538 -> 0x80337594
// this: r30
void zSimpletonMoveTo::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// total size: 0x4
struct /* @class$923zCompLogicSimpleton_cpp */ {
    // Members
...
union /* @class$1071zCompLogicSimpleton_cpp */ {
...
// total size: 0xC
struct /* @class$1061zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$791zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$792zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$794zCompLogicSimpleton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$795zCompLogicSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$796zCompLogicSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$797zCompLogicSimpleton_cpp */ {
    // Members
...
// Range: 0x80337594 -> 0x803375D0
// this: r1+0x8
void zSimpletonMoveTo::Enter(class zNPCBase * owner /* r1+0xC */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67B54
// Range: 0x803375D0 -> 0x803376F8
// this: r31
void zSimpletonMoveTo::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67B5B
// Range: 0x803376F8 -> 0x803378DC
// this: r31
unsigned char zSimpletonMoveTo::SystemEvent(struct xBase * to /* r30 */, unsigned int to_event /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
...
// Range: 0x803378DC -> 0x803378E0
void zSimpletonPatrol::AddStaticTweaks() {}

// total size: 0x2C
struct {} zSimpletonPatrol::__vtable; // size: 0x2C, address: 0x8052E7F8
// Range: 0x803378E0 -> 0x8033793C
// this: r31
zSimpletonPatrol::zSimpletonPatrol() {
    // References
    // -> static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams;
    // -> struct [anonymous] zSimpletonPatrol::__vtable;
}

// Range: 0x8033793C -> 0x80337AC4
// this: r31
void zSimpletonPatrol::Update(class zNPCBase * owner /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r27
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicSimpleton * compLogic; // r1+0x10
    const struct xVec3 * movePointPos; // r26
    struct xVec3 * NPCPos; // r25
    class zCompSteeringBasic * steering; // r28
    float boundRadius; // f31
    struct xVec3 distanceVec; // r1+0x14
    struct xMovePoint * newMovePoint; // r1+0xC
...
// Range: 0x80337AC4 -> 0x80337B20
// this: r30
void zSimpletonPatrol::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    const struct xVec3 * curPos; // r1+0xC
}

// Range: 0x80337B20 -> 0x80337B5C
// this: r1+0x8
void zSimpletonPatrol::Enter(class zNPCBase * owner /* r1+0xC */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67B67
// Range: 0x80337B5C -> 0x80337C84
// this: r31
void zSimpletonPatrol::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    class zICompSteering * compSteering; // r30
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67B6E
// Range: 0x80337C84 -> 0x80337E6C
// this: r31
unsigned char zSimpletonPatrol::SystemEvent(struct xBase * to /* r30 */, unsigned int to_event /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    class zICompNPCEntity * compNPCEntity; // r28
...
// total size: 0x14
class zSimpletonIdle : public zCompState {
    // Functions
    zSimpletonIdle();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80337E6C -> 0x80337E70
void zSimpletonIdle::AddStaticTweaks() {}

// total size: 0x2C
struct {} zSimpletonIdle::__vtable; // size: 0x2C, address: 0x8052E7CC
// Range: 0x80337E70 -> 0x80337EAC
// this: r31
zSimpletonIdle::zSimpletonIdle() {
    // References
    // -> struct [anonymous] zSimpletonIdle::__vtable;
}

// Range: 0x80337EAC -> 0x80337EB0
void zSimpletonIdle::Update() {}

// Range: 0x80337EB0 -> 0x80337EEC
// this: r1+0x8
void zSimpletonIdle::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80337EEC -> 0x80337F40
void zSimpletonIdle::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zSimpletonPlayCustomAnim::__vtable; // size: 0x2C, address: 0x8052E7A0
// Range: 0x80337F40 -> 0x80337F84
// this: r31
zSimpletonPlayCustomAnim::zSimpletonPlayCustomAnim() {
    // References
    // -> struct [anonymous] zSimpletonPlayCustomAnim::__vtable;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67B7A
// Range: 0x80337F84 -> 0x80338090
// this: r29
void zSimpletonPlayCustomAnim::Update(class zNPCBase * owner /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// Range: 0x80338090 -> 0x803380CC
// this: r1+0x8
void zSimpletonPlayCustomAnim::Enter(class zNPCBase * owner /* r1+0xC */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67B81
// Range: 0x803380CC -> 0x803382AC
// this: r31
void zSimpletonPlayCustomAnim::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    unsigned char loopThatAnim; // r29
