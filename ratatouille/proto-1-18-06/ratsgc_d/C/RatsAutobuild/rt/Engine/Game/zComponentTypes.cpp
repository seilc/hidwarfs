/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zComponentTypes.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8033D9F4 -> 0x8033E5E4
*/
enum eCompType {
    eCompType_Unknown = -1,
...
// total size: 0x2C
struct zComponentTypesTable {
    // Members
    enum eCompType componentType; // offset 0x0, size 0x4
    int componentPoolSize; // offset 0x4, size 0x4
    void (* initializeFunction)(int); // offset 0x8, size 0x4
    void (* deInitializeFunction)(); // offset 0xC, size 0x4
    void (* paramsInitializeFunction)(); // offset 0x10, size 0x4
    const char * name; // offset 0x14, size 0x4
    void (* fillDebugStatsFunction)(struct zComponentTypesTable *); // offset 0x18, size 0x4
    int PoolUsage; // offset 0x1C, size 0x4
    int PoolTotal; // offset 0x20, size 0x4
    int MemPerComp; // offset 0x24, size 0x4
    int MemoryTotal; // offset 0x28, size 0x4
};
static struct zComponentTypesTable gComponentTypesTable[25]; // size: 0x44C, address: 0x8052EB70
static char __FUNCTION__[24]; // size: 0x18, address: 0x8052EFBC
// Range: 0x8033D9F4 -> 0x8033DB2C
void zComponentTypes_Startup() {
    // Local variables
    struct zComponentTypesTable * tableEntry; // r31
    int i; // r30

    // References
    // -> static struct zComponentTypesTable gComponentTypesTable[25];
    // -> static char __FUNCTION__[24];
}

// Range: 0x8033DB2C -> 0x8033DB30
void zComponentTypes_Shutdown() {}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x8052EFD4
// Range: 0x8033DB30 -> 0x8033DBEC
void zComponentTypes_SceneInit() {
    // Local variables
    struct zComponentTypesTable * tableEntry; // r31
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8052EFEE
// Range: 0x8033DBEC -> 0x8033DCA0
void zComponentTypes_SceneExit() {
    // Local variables
    struct zComponentTypesTable * tableEntry; // r31
...
static int sComponentTypes_DebugCurLine; // size: 0x4, address: 0x80D6BB78
// Range: 0x8033DCA0 -> 0x8033DE5C
static void zComponentTypes_DebugRender() {
    // Local variables
    struct zComponentTypesTable * tableEntry; // r31
    int LastLine; // r29
    int i; // r30
    ...
    // References
    // -> static struct zComponentTypesTable gComponentTypesTable[25];
    // -> static int sComponentTypes_DebugCurLine;
}

// Range: 0x8033DE5C -> 0x8033DED4
static void zComponentTypes_DebugInput() {
    // References
    // -> static int sComponentTypes_DebugCurLine;
}

// Range: 0x8033DED4 -> 0x8033DEF8
static void zComponentTypes_DebugCB() {}

// Range: 0x8033DEF8 -> 0x8033DF24
void zComponentTypes_SetupDebugServices() {}

char __FUNCTION__$localstatic1$Initialize__54zComponentPool<11zCompCombat,12zICompCombat,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67CE0
char __FUNCTION__$localstatic1$Initialize__52zComponentPool<10zCompSound,11zICompSound,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67CEB
char __FUNCTION__$localstatic1$Initialize__61zComponentPool<19zCompLogicInstaKill,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67CF6
char __FUNCTION__$localstatic1$Initialize__61zComponentPool<19zCompLogicSimpleton,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D01
char __FUNCTION__$localstatic1$Initialize__60zComponentPool<18zCompLogicSwarmBug,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D0C
char __FUNCTION__$localstatic1$Initialize__60zComponentPool<18zCompLogicSwarmOwl,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D17
char __FUNCTION__$localstatic1$Initialize__62zComponentPool<20zCompLogicAnimViewer,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D22
char __FUNCTION__$localstatic1$Initialize__68zComponentPool<26zCompLogicContextSensitive,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D2D
char __FUNCTION__$localstatic1$Initialize__63zComponentPool<21zCompLogicSpringBoard,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D38
char __FUNCTION__$localstatic1$Initialize__62zComponentPool<20zCompLogicPourNSwirl,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D43
char __FUNCTION__$localstatic1$Initialize__60zComponentPool<18zCompLogicRightArm,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D4E
char __FUNCTION__$localstatic1$Initialize__59zComponentPool<17zCompLogicLeftArm,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D59
char __FUNCTION__$localstatic1$Initialize__64zComponentPool<22zCompLogicStirringRemy,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D64
char __FUNCTION__$localstatic1$Initialize__66zComponentPool<24zCompLogicStirringPlayer,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D6F
char __FUNCTION__$localstatic1$Initialize__58zComponentPool<16zCompLogicWaiter,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D7A
char __FUNCTION__$localstatic1$Initialize__59zComponentPool<17zCompLogicAlarmer,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D85
char __FUNCTION__$localstatic1$Initialize__57zComponentPool<15zCompLogicThief,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D90
char __FUNCTION__$localstatic1$Initialize__63zComponentPool<21zCompLogicSwarmMember,11zICompLogic,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67D9B
char __FUNCTION__$localstatic1$Initialize__62zComponentPool<15zCompPerception,16zICompPerception,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DA6
char __FUNCTION__$localstatic1$Initialize__61zComponentPool<15zICompNPCEntity,15zICompNPCEntity,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DB1
char __FUNCTION__$localstatic1$Initialize__65zComponentPool<20zCompSteeringGeneric,14zICompSteering,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DBC
char __FUNCTION__$localstatic1$Initialize__66zComponentPool<21zCompSteeringFlocking,14zICompSteering,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DC7
char __FUNCTION__$localstatic1$Initialize__71zComponentPool<26zCompSteeringFlockingBrain,14zICompSteering,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DD2
char __FUNCTION__$localstatic1$Initialize__63zComponentPool<18zCompSteeringBasic,14zICompSteering,8zNPCBase>Fi[11]; // size: 0xB, address: 0x80D67DDD
// total size: 0x70
...
class zComponentPool {
    ...
    class zCompSteeringBasic * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
...
// total size: 0x8C
class zCompSteeringFlockingParams : public zCompSteeringBasicParams {
    // Members
public:
    float seperationMultiplier; // offset 0x70, size 0x4
    float seperationNeighbourRadius; // offset 0x74, size 0x4
    float playerAvoidenceMultiplier; // offset 0x78, size 0x4
    float playerAvoidenceRadius; // offset 0x7C, size 0x4
    float playerAvoidenceForceLimit; // offset 0x80, size 0x4
    float alignmentMultiplier; // offset 0x84, size 0x4
    float cohesionMultiplier; // offset 0x88, size 0x4
};
// total size: 0x3C
class zCompSteeringFlocking : public zCompSteeringBasic {
    // Members
    const class zCompSteeringFlockingParams * flockingParameters; // offset 0x34, size 0x4
    class zCompSteeringFlockingBrain * flockingBrain; // offset 0x38, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompSteeringFlocking * components; // offset 0x8, size 0x4
};
signed char zComponentPool<zCompSteeringGeneric, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB7C
enum eSteeringType {
    eSteeringType_Straight = 0,
    eSteeringTyoe_Turn = 1,
    eSteeringType_Stop = 2,
    eSteeringType_Wander = 3,
    eSteeringType_Seek = 4,
    eSteeringType_Flee = 5,
    eSteeringType_Arrive = 6,
    eSteeringType_Pursuit = 7,
    eSteeringType_Evade = 8,
};
// total size: 0x38
class zCompSteeringGenericParams : public zCompParameters {
    // Members
public:
    float maxAcc; // offset 0x0, size 0x4
    float maxSpeed; // offset 0x4, size 0x4
    float turnSpringK; // offset 0x8, size 0x4
    float wallAvoidenceRatio; // offset 0xC, size 0x4
    float wallFeelerLength; // offset 0x10, size 0x4
    float sphereAvoidenceRatio; // offset 0x14, size 0x4
    float sphereAvoidenceRange; // offset 0x18, size 0x4
    float sphereAvoidenceBreakRatio; // offset 0x1C, size 0x4
    float wanderRatio; // offset 0x20, size 0x4
    float wanderFOV; // offset 0x24, size 0x4
    float wanderJitterPerSec; // offset 0x28, size 0x4
    enum eSteeringType steeringType; // offset 0x2C, size 0x4
    unsigned char wallAvoidenceOn; // offset 0x30, size 0x1
    unsigned char sphereAvoidenceOn; // offset 0x31, size 0x1
    unsigned char wanderOn; // offset 0x32, size 0x1
    unsigned char gravityOn; // offset 0x33, size 0x1
    void * __vptr$; // offset 0x34, size 0x4
};
// total size: 0x18
class zSteeringGenericDynamics {
    // Members
public:
    const struct xVec3 * oldPos; // offset 0x0, size 0x4
    const struct xVec3 * pos; // offset 0x4, size 0x4
...
// total size: 0x30
class zCompSteeringGeneric : public zICompSteering {
    // Members
protected:
    struct xVec3 * destination; // offset 0x8, size 0x4
    struct xVec3 * facing; // offset 0xC, size 0x4
private:
    const class zCompSteeringGenericParams * steeringParameters; // offset 0x10, size 0x4
    struct xVec3 prevWanderDir; // offset 0x14, size 0xC
    struct xVec3 prevRandomizerDir; // offset 0x20, size 0xC
    class zNPCWalls * npcWalls; // offset 0x2C, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompSteeringGeneric * components; // offset 0x8, size 0x4
};
class zComponentPool zComponentPool<zCompSteeringGeneric, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB80
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
signed char zComponentPool<zCompPerception, zICompPerception, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB8C
// total size: 0x78
...
enum eCompPerceptionType {
    eCompPerceptionType_None = 0,
    eCompPerceptionType_Sphere = 1,
    eCompPerceptionType_SoundSphere = 2,
    eCompPerceptionType_Cylinder = 3,
    eCompPerceptionType_Cone = 4,
    eCompPerceptionType_Tri = 5,
};
// total size: 0x0
class zCompPerceptionDynamics {};
// total size: 0x3C
class zCompPerception : public zICompPerception {
    // Members
    const class zCompPerceptionParams * params; // offset 0x8, size 0x4
    struct xEnt * perceivedEntity; // offset 0xC, size 0x4
    enum eCompPerceptionType perceptionType; // offset 0x10, size 0x4
    struct xVec3 perceivedLocation; // offset 0x14, size 0xC
    float updateTimer; // offset 0x20, size 0x4
    float perceivedTimer; // offset 0x24, size 0x4
    float lostTimer; // offset 0x28, size 0x4
    float tanConeHTheta; // offset 0x2C, size 0x4
    float tanTriHTheta; // offset 0x30, size 0x4
    float tanLosHTheta; // offset 0x34, size 0x4
    unsigned char perceived; // offset 0x38, size 0x1
    unsigned char remembered; // offset 0x39, size 0x1
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompPerception * components; // offset 0x8, size 0x4
};
class zComponentPool zComponentPool<zCompPerception, zICompPerception, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB90
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicSwarmMember * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicThief * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicAlarmer * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicWaiter * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
...
class zComponentPool {
    ...
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicStirringRemy * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicLeftArm * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicRightArm * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicPourNSwirl * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicSpringBoard * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicContextSensitive * components; // offset 0x8, size 0x4
};
// total size: 0x18
class zCompLogicAnimViewer : public zICompLogic {
    // Static members
    static unsigned int mAutoAction; // size: 0x4
    static unsigned char mIsActive; // size: 0x1
    static unsigned char mActionPressed; // size: 0x1
    static unsigned int mNeedTweaks; // size: 0x4

    // Members
    float mCurAnimCycleDuration; // offset 0x8, size 0x4
    float mAutoActionTimer; // offset 0xC, size 0x4
    int mAutoActionCount; // offset 0x10, size 0x4
    float mTimer; // offset 0x14, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicAnimViewer * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicSwarmOwl * components; // offset 0x8, size 0x4
};
// total size: 0xC
class zComponentPool {
    // Members
...
class zComponentPool {
    ...
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicSimpleton * components; // offset 0x8, size 0x4
};
signed char zComponentPool<zCompLogicInstaKill, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB9C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompLogicInstaKill * components; // offset 0x8, size 0x4
};
class zComponentPool zComponentPool<zCompLogicInstaKill, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BBA0
...
class zComponentPool {
    ...
    int extraComponentMemUsage; // offset 0x0, size 0x4
    int poolSize; // offset 0x4, size 0x4
    class zCompCombat * components; // offset 0x8, size 0x4
};
// Range: 0x8033DF24 -> 0x8033DF6C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033DF6C -> 0x8033DFB4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033DFB4 -> 0x8033DFFC
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033DFFC -> 0x8033E044
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E044 -> 0x8033E08C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E08C -> 0x8033E0D4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E0D4 -> 0x8033E11C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E11C -> 0x8033E164
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E164 -> 0x8033E1AC
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E1AC -> 0x8033E1F4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E1F4 -> 0x8033E23C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E23C -> 0x8033E284
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E284 -> 0x8033E2CC
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E2CC -> 0x8033E314
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E314 -> 0x8033E35C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E35C -> 0x8033E3A4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E3A4 -> 0x8033E3EC
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E3EC -> 0x8033E434
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E434 -> 0x8033E47C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E47C -> 0x8033E4C4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E4C4 -> 0x8033E50C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E50C -> 0x8033E554
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E554 -> 0x8033E59C
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}

// Range: 0x8033E59C -> 0x8033E5E4
void zComponentTypes_FillDebugStats(struct zComponentTypesTable * tableEntry /* r31 */) {}
...
// total size: 0x8
class zICompPerception : public zIComponent {};
// total size: 0x8
class zICompSound : public zIComponent {};
// total size: 0x8
class zICompCombat : public zIComponent {};
// total size: 0x68
...
// total size: 0xC
struct /* @class$734zComponentTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zComponentTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zComponentTypes_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zComponentTypes_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zComponentTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zComponentTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zComponentTypes_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zCompLogicSwarmMember::__vtable; // size: 0x3C, address: 0x8052D018
// total size: 0x50
struct {} zCompLogicThief::__vtable; // size: 0x50, address: 0x8052A4EC
...
// total size: 0x60
class zCompLogicThief : public zCompStateMachine {
    // Members
    struct xVec3 acc; // offset 0x34, size 0xC
    struct xVec3 oldAcc; // offset 0x40, size 0xC
public:
    unsigned char objectUnderControl; // offset 0x4C, size 0x1
    class zCarryableObject * attractor; // offset 0x50, size 0x4
    struct xVec3 zoneCenter; // offset 0x54, size 0xC
};
// total size: 0x40
struct {} zCompLogicAlarmer::__vtable; // size: 0x40, address: 0x8052CE18
enum eAlarmerStates {
    eAlarmerStates_None = -1,
    eAlarmerStates_SearchPlayer = 0,
    eAlarmerStates_ActivatingAlarm = 1,
    eAlarmerStates_Alarm = 2,
    eAlarmerStates_DeactivatingAlarm = 3,
};
// total size: 0xC
class zCompLogicAlarmer : public zICompLogic {
    // Members
    enum eAlarmerStates curState; // offset 0x8, size 0x4
};
// total size: 0x3C
struct {} zCompLogicWaiter::__vtable; // size: 0x3C, address: 0x8052D098
// total size: 0x0
struct xMovePoint {};
// total size: 0x4CC
class zCompLogicWaiter : public zICompLogic {
    // Static members
    static unsigned int zCOLLISION_NPC; // size: 0x4
    static unsigned int zCOLLISION_NEEDS_DEPEN_INNER_BOUND; // size: 0x4
    static unsigned int zCOLLISION_NEEDS_DEPEN_OUTER_BOUND; // size: 0x4
    static unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4
    static int NUM_BOUNDS; // size: 0x4
    static unsigned int MAX_COLLISIONS; // size: 0x4
    static unsigned int MAX_OBJECT_COLLISIONS; // size: 0x4
    static unsigned int MAX_JSP_COLLISIONS; // size: 0x4

    // Members
    struct xVec3 vel; // offset 0x8, size 0xC
    struct xVec3 oldPos; // offset 0x14, size 0xC
    struct xVec3 preKnockbackVel; // offset 0x20, size 0xC
    float knockbackTimer; // offset 0x2C, size 0x4
    unsigned char activated; // offset 0x30, size 0x1
    unsigned char playingSpecialAnim; // offset 0x31, size 0x1
    float scalarVel; // offset 0x34, size 0x4
    unsigned char hitReactPending; // offset 0x38, size 0x1
    int numCollisions; // offset 0x3C, size 0x4
    struct xCollis collisions[12]; // offset 0x40, size 0x3F0
    unsigned int collisionUserFlags[12]; // offset 0x430, size 0x30
    struct xBound bound[1]; // offset 0x460, size 0x4C
    int currBound; // offset 0x4AC, size 0x4
    struct xMovePoint * curPatrolPoint; // offset 0x4B0, size 0x4
    unsigned char arrived; // offset 0x4B4, size 0x1
    float timer; // offset 0x4B8, size 0x4
    unsigned char init; // offset 0x4BC, size 0x1
    float animWalk[3]; // offset 0x4C0, size 0xC
};
// total size: 0x3C
struct {} zCompLogicStirringPlayer::__vtable; // size: 0x3C, address: 0x8052D188
// total size: 0x4C
...
// total size: 0x50
struct {} zCompLogicStirringRemy::__vtable; // size: 0x50, address: 0x8052D1E8
// total size: 0x4C
class zCompLogicStirringRemy : public zCompStateMachine {
    // Members
    struct xVec3 acc; // offset 0x34, size 0xC
    struct xVec3 oldAcc; // offset 0x40, size 0xC
};
// total size: 0x54
struct {} zCompLogicLeftArm::__vtable; // size: 0x54, address: 0x8052D7E8
// total size: 0x34
class zCompLogicLeftArm : public zCompStateMachine {};
// total size: 0x54
struct {} zCompLogicRightArm::__vtable; // size: 0x54, address: 0x8052DA28
// total size: 0x34
class zCompLogicRightArm : public zCompStateMachine {};
// total size: 0x3C
struct {} zCompLogicPourNSwirl::__vtable; // size: 0x3C, address: 0x8052E200
// total size: 0x4C
class zCompLogicPourNSwirl : public zICompLogic {
    // Members
    unsigned int whichPot; // offset 0x8, size 0x4
    unsigned int targetPot; // offset 0xC, size 0x4
    float stirringAccum; // offset 0x10, size 0x4
...
// total size: 0x50
struct {} zCompLogicSpringBoard::__vtable; // size: 0x50, address: 0x8052DC4C
// total size: 0x4C
...
// total size: 0x50
struct {} zCompLogicContextSensitive::__vtable; // size: 0x50, address: 0x8052E40C
// total size: 0x40
class zCompLogicContextSensitive : public zCompStateMachine {
    // Members
    struct xVec3 zoneCenter; // offset 0x34, size 0xC
};
// total size: 0x50
struct {} zCompLogicSwarmOwl::__vtable; // size: 0x50, address: 0x8052EA9C
// total size: 0x34
class zCompLogicSwarmOwl : public zCompStateMachine {};
// total size: 0x50
struct {} zCompLogicSwarmBug::__vtable; // size: 0x50, address: 0x8052E9A4
// total size: 0x34
class zCompLogicSwarmBug : public zCompStateMachine {};
// total size: 0x50
struct {} zCompLogicSimpleton::__vtable; // size: 0x50, address: 0x8052E850
// total size: 0x34
class zCompLogicSimpleton : public zCompStateMachine {};
// total size: 0x40
class zCompLogicInstaKill : public zCompStateMachine {
    // Members
public:
    struct xVec3 zoneCenter; // offset 0x34, size 0xC
};
...
// total size: 0x18
class zCompCombatParams : public zCompParameters {
    // Members
public:
    int hitPoints; // offset 0x0, size 0x4
    struct xHierarchyBoundInitData * hierarchy; // offset 0x4, size 0x4
    float masterRadius; // offset 0x8, size 0x4
    class zCombatAttack * attackTableStates; // offset 0xC, size 0x4
    unsigned short stateCount; // offset 0x10, size 0x2
...
// total size: 0x18C
class zCompCombat : public zICompCombat {
    // Members
    const class zCompCombatParams * parameters; // offset 0x8, size 0x4
    struct zCombat combatData; // offset 0xC, size 0x180
};
// total size: 0x30
struct {} zICompCombat::__vtable; // size: 0x30, address: 0x8052F008
// total size: 0xC
...
// total size: 0x4
struct /* @class$901zComponentTypes_cpp */ {
    // Members
...
union /* @class$1040zComponentTypes_cpp */ {
...
// total size: 0xC
struct /* @class$1039zComponentTypes_cpp */ {
    // Members
