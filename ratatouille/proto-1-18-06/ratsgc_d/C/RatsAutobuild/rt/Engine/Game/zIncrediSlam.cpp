/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zIncrediSlam.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E3D08 -> 0x801E62DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int isStartOnKey; // size: 0x4, address: 0x80D6ACC8
float shake_time; // size: 0x4, address: 0x80D640C0
float shake_mag; // size: 0x4, address: 0x80D640C4
float shake_cycle_max; // size: 0x4, address: 0x80D640C8
float shake_rot_mag; // size: 0x4, address: 0x80D640CC
float shake_radius; // size: 0x4, address: 0x80D6ACCC
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1104zIncrediSlam_cpp */ {
    // Members
...
union /* @class$1249zIncrediSlam_cpp */ {
...
struct WaveLayer {
    // Members
    struct Point point[20]; // offset 0x0, size 0x1E0
};
// total size: 0x10F4
struct Wave {
    // Members
    ...
    struct WaveLayer layer[9]; // offset 0xC, size 0x10E0
    float particleGenTime; // offset 0x10EC, size 0x4
    float particleGenDeltaTime; // offset 0x10F0, size 0x4
};
// total size: 0x50
struct WaveParticle {
    // Members
    union { // inferred
        struct { // inferred
            ...
            float deltaRot; // offset 0x24, size 0x4
            float lifeAtStart; // offset 0x28, size 0x4
            int gen; // offset 0x2C, size 0x4
            float w; // offset 0x30, size 0x4
            float h; // offset 0x34, size 0x4
            float deltaSize; // offset 0x38, size 0x4
            float fadeTime; // offset 0x3C, size 0x4
            float alpha; // offset 0x40, size 0x4
            unsigned char active; // offset 0x44, size 0x1
        };
        unsigned char pad[80]; // offset 0x0, size 0x50
    };
};
// total size: 0x4
struct node {
...
// total size: 0xC
struct /* @class$768zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zIncrediSlam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zIncrediSlam_cpp */ {
    // Members
...
class zIncrediSlam {
    ...
    void GenerateParticle(struct xVec3 & pos, struct xVec3 & vel, float size, float deltaSize, float life, float fadeTime, float alpha);

    void UpdateParticles(float dt);

    void Start(const struct xMat4x3 & _startMat, float _hitRadius, signed short _hitPoints, struct config * new_cfg, struct xEnt * _owner, unsigned char drawDecal, enum zHitSource _hitSource);
    ...
    // Static members
    static int isStartOnKey; // size: 0x4
    static struct config default_config; // size: 0xC4

    // Members
public:
    class zIncrediSlam * prev; // offset 0x0, size 0x4
    class zIncrediSlam * next; // offset 0x4, size 0x4
private:
    struct config * cfg; // offset 0x8, size 0x4
    struct xEnt * owner; // offset 0xC, size 0x4
    enum zHitSource hitSource; // offset 0x10, size 0x4
    struct Wave wave[3]; // offset 0x14, size 0x32DC
    struct xMat4x3 startMat; // offset 0x32F0, size 0x40
    float scaleOfEffect; // offset 0x3330, size 0x4
    unsigned char isFirstPass; // offset 0x3334, size 0x1
    unsigned char isActive; // offset 0x3335, size 0x1
    unsigned char isFinished; // offset 0x3336, size 0x1
    unsigned char isCulled; // offset 0x3337, size 0x1
    struct WaveParticle * particles; // offset 0x3338, size 0x4
    unsigned char particleMem[11215]; // offset 0x333C, size 0x2BCF
    float waveTimer; // offset 0x5F0C, size 0x4
    int nextWave; // offset 0x5F10, size 0x4
    float texScroll; // offset 0x5F14, size 0x4
    int nextParticle; // offset 0x5F18, size 0x4
    struct xColor_tag color; // offset 0x5F1C, size 0x4
    float friction; // offset 0x5F20, size 0x4
    float cullFade; // offset 0x5F24, size 0x4
    struct xResponseCurve curve; // offset 0x5F28, size 0x14
    struct emit_context ec; // offset 0x5F3C, size 0x5C
    enum iSndGroupHandle sound; // offset 0x5F98, size 0x4
    int hitPoints; // offset 0x5F9C, size 0x4
    float hitRadius; // offset 0x5FA0, size 0x4
};
// Range: 0x801E3D08 -> 0x801E3D3C
void * zIncrediSlam::operator new(unsigned long size /* r1+0x8 */) {
    // Local variables
    class zIncrediSlamMgr * mgr; // r31
}

unsigned int tweakSlamWaveTextureID; // size: 0x4, address: 0x80D6ACD0
unsigned int tweakSlamParticleTextureID; // size: 0x4, address: 0x80D6ACD4
// total size: 0x34
struct RwRaster {
    // Members
...
// total size: 0x50
struct /* @class$2125zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x44
struct /* @class$2126zIncrediSlam_cpp */ {
    // Members
...
// Range: 0x801E3D3C -> 0x801E3E1C
// this: r31
zIncrediSlam::zIncrediSlam() {
    // Local variables
    int p; // r30
...
void config::SetDefaults() {
    ...
    // References
    // -> unsigned int tweakSlamWaveTextureID;
    // -> unsigned int tweakSlamParticleTextureID;
}

// Range: 0x801E4038 -> 0x801E40E4
// this: r31
void zIncrediSlam::Update(float dt /* f31 */) {}

// Range: 0x801E40E4 -> 0x801E40F4
// this: r3
unsigned char zIncrediSlam::Cull() {}

// Range: 0x801E40F4 -> 0x801E413C
// this: r31
void zIncrediSlam::Render() {}
...
static struct curve_node footstep_curve[3]; // size: 0x54, address: 0x804B7428
// Range: 0x801E413C -> 0x801E41E8
// this: r31
void zIncrediSlam::Init() {
    // References
...
// Range: 0x801E41E8 -> 0x801E48C8
void zIncrediSlam::AddTweaks(const char * prefix /* r31 */, struct config * slam /* r30 */) {
    // References
    // -> float shake_radius;
    // -> float shake_rot_mag;
    // -> float shake_cycle_max;
    // -> float shake_mag;
    // -> float shake_time;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D640D0
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1333zIncrediSlam_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801E48C8 -> 0x801E4A3C
// this: r29
void zIncrediSlam::UpdatePTankPool() {
    // Local variables
    struct ptank_pool__pos_color_size_rot pool; // r1+0x18
    int p; // r30
    struct WaveParticle & particle; // r31
...
// Range: 0x801E4A3C -> 0x801E4A50
// this: r3
void zIncrediSlam::GenerateParticle(struct xVec3 & pos /* r4 */, struct xVec3 & vel /* r5 */, float size /* f1 */, float deltaSize /* f2 */, float life /* f3 */, float fadeTime /* f4 */, float alpha /* f5 */) {
    // Local variables
    struct WaveParticle & particle; // r31
}

// Range: 0x801E4A50 -> 0x801E4BBC
// this: r30
void zIncrediSlam::UpdateParticles(float dt /* f31 */) {
    // Local variables
    int p; // r29
    struct WaveParticle & particle; // r31
    float fadeTime; // f30
...
static float cast_dist; // size: 0x4, address: 0x80D6ACD8
static signed char init; // size: 0x1, address: 0x80D6ACDC
static float upbias; // size: 0x4, address: 0x80D6ACE0
static signed char init; // size: 0x1, address: 0x80D6ACE4
// total size: 0x1C
...
// total size: 0xC
struct /* @class$1559zIncrediSlam_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x801E4BBC -> 0x801E4F5C
// this: r31
void zIncrediSlam::Start(const struct xMat4x3 & _startMat /* r1+0x10 */, float _hitRadius /* r1+0x14 */, signed short _hitPoints /* r1+0x18 */, struct config * new_cfg /* r1+0x1C */, struct xEnt * _owner /* r1+0x20 */, unsigned char drawDecal /* r1+0x24 */, enum zHitSource _hitSource /* r1+0x28 */) {
    // Local variables
    struct xScene & scene; // r28
    struct zCommonPlayer * player; // r27
    struct xRay3 ray; // r1+0x70
...
// total size: 0x4
struct /* @class$2106zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2049zIncrediSlam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2051zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2048zIncrediSlam_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2053zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1901zIncrediSlam_cpp */ {
    // Static members
...
// Range: 0x801E4F5C -> 0x801E5854
// this: r31
void zIncrediSlam::UpdateWaves(float dt /* f30 */) {
    // Local variables
    float lengthA; // f26
    float lengthB; // f31
    float dLength; // f29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D640E0
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x801E5854 -> 0x801E5BF0
// this: r31
void zIncrediSlam::RenderWave() {
    // Local variables
    struct RxObjSpace3DVertex vert[40]; // r1+0x3C
    struct xColor_tag color1; // r1+0x14
    struct xColor_tag color2; // r1+0x10
    float alphaTable[9]; // r1+0x18
    int w; // r30
    float t; // f31
    int strip; // r29
    float s; // f30
...
// Range: 0x801E5BF0 -> 0x801E5C74
void zIncrediSlam::SetVert(struct RxObjSpace3DVertex & vert /* r4 */, const struct xVec3 & loc /* r5 */, float u /* f1 */, float v /* f2 */, struct xColor_tag & color /* r6 */) {
    // Local variables
    struct RwV3d tmp; // r1+0xC
    struct RwRGBA col; // r1+0x8
}

// Range: 0x801E5C74 -> 0x801E5CD0
// this: r31
void zIncrediSlam::SendDamage() {}
...
// Range: 0x801E5CD0 -> 0x801E5CD4
void zIncrediSlam::BeginRender() {}

// Range: 0x801E5CD4 -> 0x801E5CD8
void zIncrediSlam::EndRender() {}

class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4, address: 0x80D6ACE8
// total size: 0xC
class zIncrediSlamMgr {
    // Functions
    zIncrediSlamMgr();

    class zIncrediSlam * GetMem(unsigned long size);

    void _Update(float dt);

    void _Render();

    unsigned char _StartSlam(const struct xMat4x3 & startMat, float hitRadius, signed short hitPoints, struct config * cfg, struct xEnt * owner, unsigned char drawDecal, enum zHitSource hitSource);

    // Static members
    static class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4

    // Members
    unsigned char isFirstGet; // offset 0x0, size 0x1
    class zIncrediSlam * freeList; // offset 0x4, size 0x4
    class zIncrediSlam * usedList; // offset 0x8, size 0x4
};
// Range: 0x801E5CD8 -> 0x801E5D38
class zIncrediSlamMgr * zIncrediSlamMgr::Get() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x801E5D38 -> 0x801E5D50
void zIncrediSlamMgr::Remove() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x801E5D50 -> 0x801E5DA0
void zIncrediSlamMgr::Reset() {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31

    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x801E5DA0 -> 0x801E5DAC
// this: r3
void zIncrediSlam::SetInactive() {}

// Range: 0x801E5DAC -> 0x801E5DB8
// this: r3
zIncrediSlamMgr::zIncrediSlamMgr() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D640EB
// Range: 0x801E5DB8 -> 0x801E5FD0
// this: r31
class zIncrediSlam * zIncrediSlamMgr::GetMem(unsigned long size /* r26 */) {
    // Local variables
    class zIncrediSlam * mem; // r30
    class zIncrediSlam * prev; // r28
    unsigned int i; // r27
    class zIncrediSlam * mem; // r29
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D640F2
struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80B86CF8
// Range: 0x801E5FD0 -> 0x801E60F4
void zIncrediSlamMgr::Update(float dt /* r1+0x8 */) {
    // Local variables
    struct zPlayer * player; // r31
    int port; // r30
...
// Range: 0x801E60F4 -> 0x801E6148
// this: r30
void zIncrediSlamMgr::_Update(float dt /* r1+0x8 */) {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31
}

// Range: 0x801E6148 -> 0x801E6178
void zIncrediSlamMgr::Render() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x801E6178 -> 0x801E61C4
// this: r30
void zIncrediSlamMgr::_Render() {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31
}

// Range: 0x801E61C4 -> 0x801E6234
unsigned char zIncrediSlamMgr::StartSlam(const struct xMat4x3 & startMat /* r1+0x8 */, float hitRadius /* r1+0xC */, signed short hitPoints /* r1+0x10 */, struct config * cfg /* r1+0x14 */, struct xEnt * owner /* r1+0x18 */, unsigned char drawDecal /* r1+0x1C */, enum zHitSource hitSource /* r1+0x20 */) {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x801E6234 -> 0x801E62D4
// this: r30
unsigned char zIncrediSlamMgr::_StartSlam(const struct xMat4x3 & startMat /* r1+0x8 */, float hitRadius /* r1+0xC */, signed short hitPoints /* r1+0x10 */, struct config * cfg /* r1+0x14 */, struct xEnt * owner /* r1+0x18 */, unsigned char drawDecal /* r1+0x1C */, enum zHitSource hitSource /* r1+0x20 */) {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31
}

// Range: 0x801E62D4 -> 0x801E62DC
// this: r3
unsigned char zIncrediSlam::IsActive() {}
