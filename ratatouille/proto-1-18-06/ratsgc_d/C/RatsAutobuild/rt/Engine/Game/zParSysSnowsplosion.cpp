/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParSysSnowsplosion.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80280FF0 -> 0x802817FC
*/
static int systemID; // size: 0x4, address: 0x80D65B90
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65B94
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$892zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zParSysSnowsplosion_cpp */ {
    // Members
...
union /* @class$1031zParSysSnowsplosion_cpp */ {
...
// total size: 0x10
struct /* @class$1304zParSysSnowsplosion_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80280FF0 -> 0x80281190
static int ParticleUpdate(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
...
struct Particle {
    ...
    static void Setup(const struct xVec3 & position, const struct zParSysSnowsplosionConfig & cfg);
    ...
    const struct zParSysSnowsplosionConfig * config; // offset 0x24, size 0x4
    float pad[2]; // offset 0x28, size 0x8
};
// Range: 0x80281190 -> 0x8028122C
// this: r31
static void Particle::Update(float dt /* f31 */) {
    // References
...
// Range: 0x8028122C -> 0x802814AC
// this: r30
void zParSysSnowsplosionConfig::AddTweaks(const char * prefix /* r31 */) {}
...
// total size: 0xC
struct /* @class$833zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zParSysSnowsplosion_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zParSysSnowsplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zParSysSnowsplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zParSysSnowsplosion_cpp */ {
    // Members
...
// Range: 0x802814AC -> 0x8028155C
void zParSysSnowsplosionSceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batchSystem; // r1+0x8

    // References
    // -> static int systemID;
}

// Range: 0x8028155C -> 0x80281644
void zParSysSnowsplosionEmit(const struct xVec3 & pos /* r1+0x8 */, const struct zParSysSnowsplosionConfig & config /* r30 */) {
    // Local variables
    int emitCount; // r31
...
// Range: 0x80281644 -> 0x802817FC
// this: r31
static void Particle::Setup(const struct xVec3 & position /* r1+0x8 */, const struct zParSysSnowsplosionConfig & cfg /* r1+0xC */) {
    // Local variables
    float theta; // f30
    float phi; // f31
