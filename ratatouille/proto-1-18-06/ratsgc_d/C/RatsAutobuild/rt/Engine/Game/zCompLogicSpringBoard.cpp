/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicSpringBoard.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80323740 -> 0x80324754
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gSpringBoardPatrolSteeringParams; // size: 0x70, address: 0x80D33E70
// total size: 0x8
...
static struct zCompStateMachineTable gSpringboardStateMachineTable[6]; // size: 0x30, address: 0x8052DB40
// total size: 0x4C
class zCompLogicSpringBoard : public zCompStateMachine {
    ...
    unsigned char InteractionCheck(const struct SphereCollisionResults & results);
...
// Range: 0x80323740 -> 0x80323768
void zCompLogicSpringBoard::AddStaticTweaks() {}

// Range: 0x80323768 -> 0x80323770
unsigned char zCompLogicSpringBoard::SystemEvent() {}

// Range: 0x80323770 -> 0x803239FC
void zCompLogicSpringBoard::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x803239FC -> 0x80323AA8
// this: r31
void zCompLogicSpringBoard::SetupStateTranstitionTests() {}

// Range: 0x80323AA8 -> 0x80323AB0
int zCompLogicSpringBoard::GetInitialStateEnum() {}

// Range: 0x80323AB0 -> 0x80323ABC
struct zCompStateMachineTable * zCompLogicSpringBoard::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gSpringboardStateMachineTable[6];
}

// Range: 0x80323ABC -> 0x80323AE4
// this: r1+0x8
void zCompLogicSpringBoard::Attached() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D67888
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80323AE4 -> 0x80323C58
// this: r29
unsigned char zCompLogicSpringBoard::InteractionCheck(const struct SphereCollisionResults & results /* r30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 cornerPos; // r1+0x8
    float d; // f31
    float playerD; // f30
...
// total size: 0x10
struct /* @class$1288zCompLogicSpringBoard_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80323C58 -> 0x80323CE0
unsigned char zCompLogicSpringBoard::IsPlayerInRange(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// total size: 0x890
struct /* @class$1785zCompLogicSpringBoard_cpp */ {
    // Static members
...
// Range: 0x80323CE0 -> 0x80323D68
unsigned char zCompLogicSpringBoard::IsPlayerOutRange(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r30
    struct xVec3 * NPCPos; // r29
...
// Range: 0x80323D68 -> 0x80323DA0
unsigned char zCompLogicSpringBoard::IsAnimationStopped(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// Range: 0x80323DA0 -> 0x80323DBC
void zCompLogicSpringBoard::GetLaunchVelocity(struct xVec3 & vel /* r4 */) {}

// Range: 0x80323DBC -> 0x80323DE8
// this: r1+0x8
void zCompLogicSpringBoard::Launch() {}

struct xVec3 m_Null; // size: 0xC, address: 0x80D6D920
// Range: 0x80323DE8 -> 0x80323F20
// this: r31
void zCompLogicSpringBoard::StopNPC(float StopForceMag /* r1+0x8 */, float dt /* f29 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$892zCompLogicSpringBoard_cpp */ {
    // Members
...
union /* @class$1040zCompLogicSpringBoard_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$833zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0x18
class zSpringBoardPatrol : public zCompState {
    // Functions
    zSpringBoardPatrol();
...
// Range: 0x80323F20 -> 0x80323F50
void zSpringBoardPatrol::AddStaticTweaks(const char * name /* r1+0x8 */) {
    // References
    // -> static class zCompSteeringBasicParams gSpringBoardPatrolSteeringParams;
}

// total size: 0x14
class zSpringBoardTurnAround : public zCompState {
    // Functions
    zSpringBoardTurnAround();

    void Enter(class zNPCBase * owner);
};
// total size: 0x14
class zSpringBoardIdle : public zCompState {
    // Functions
    zSpringBoardIdle();
...
// total size: 0x2C
struct {} zSpringBoardPatrol::__vtable; // size: 0x2C, address: 0x8052DC20
// Range: 0x80323F50 -> 0x80324004
// this: r31
zSpringBoardPatrol::zSpringBoardPatrol() {
    // References
    // -> static class zCompSteeringBasicParams gSpringBoardPatrolSteeringParams;
    // -> struct [anonymous] zSpringBoardPatrol::__vtable;
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6B9D8
static signed char init; // size: 0x1, address: 0x80D6B9D9
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67899
// Range: 0x80324004 -> 0x803241BC
// this: r31
void zSpringBoardPatrol::Update(class zNPCBase * owner /* r28 */, float dt /* r1+0x8 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D678A0
// total size: 0x68
class zNPCSpringBoard : public zNPCBase {};
// total size: 0x78
struct zNPCAssetSpringBoard : public zNPCAssetRATS {
    // Members
    unsigned int firstMovePoint; // offset 0x74, size 0x4
};
// Range: 0x803241BC -> 0x803242AC
// this: r30
void zSpringBoardPatrol::Enter(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zNPCSpringBoard * npcSpringBoard; // r29
    struct zNPCAssetSpringBoard * npcassSpringBoard; // r31
...
// Range: 0x803242AC -> 0x80324370
// this: r30
void zSpringBoardPatrol::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
...
// Range: 0x80324370 -> 0x803243CC
// this: r30
void zSpringBoardPatrol::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// total size: 0x2C
struct {} zSpringBoardTurnAround::__vtable; // size: 0x2C, address: 0x8052DBF4
// Range: 0x803243CC -> 0x80324408
// this: r31
zSpringBoardTurnAround::zSpringBoardTurnAround() {
    // References
    // -> struct [anonymous] zSpringBoardTurnAround::__vtable;
}

// Range: 0x80324408 -> 0x80324454
void zSpringBoardTurnAround::Update(class zNPCBase * owner /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    class zCompLogicSpringBoard * compLogic; // r31
}

// Range: 0x80324454 -> 0x80324490
// this: r1+0x8
void zSpringBoardTurnAround::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80324490 -> 0x803244E4
void zSpringBoardTurnAround::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zSpringBoardIdle::__vtable; // size: 0x2C, address: 0x8052DBC8
// Range: 0x803244E4 -> 0x80324520
// this: r31
zSpringBoardIdle::zSpringBoardIdle() {
    // References
    // -> struct [anonymous] zSpringBoardIdle::__vtable;
}

// Range: 0x80324520 -> 0x80324524
void zSpringBoardIdle::Update() {}

// Range: 0x80324524 -> 0x80324560
// this: r1+0x8
void zSpringBoardIdle::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80324560 -> 0x803245B4
void zSpringBoardIdle::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zSpringBoardLaunch::__vtable; // size: 0x2C, address: 0x8052DB9C
// total size: 0x14
class zSpringBoardLaunch : public zCompState {
    // Functions
    zSpringBoardLaunch();

    void Enter(class zNPCBase * owner);
};
// Range: 0x803245B4 -> 0x803245F0
// this: r31
zSpringBoardLaunch::zSpringBoardLaunch() {
    // References
    // -> struct [anonymous] zSpringBoardLaunch::__vtable;
}

// Range: 0x803245F0 -> 0x803245F4
void zSpringBoardLaunch::Update() {}

// Range: 0x803245F4 -> 0x80324630
// this: r1+0x8
void zSpringBoardLaunch::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80324630 -> 0x80324684
void zSpringBoardLaunch::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// total size: 0x2C
struct {} zSpringBoardGoToPatrol::__vtable; // size: 0x2C, address: 0x8052DB70
// total size: 0x14
class zSpringBoardGoToPatrol : public zCompState {
    // Functions
    zSpringBoardGoToPatrol();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80324684 -> 0x803246C0
// this: r31
zSpringBoardGoToPatrol::zSpringBoardGoToPatrol() {
    // References
    // -> struct [anonymous] zSpringBoardGoToPatrol::__vtable;
}

// Range: 0x803246C0 -> 0x803246C4
void zSpringBoardGoToPatrol::Update() {}

// Range: 0x803246C4 -> 0x80324700
// this: r1+0x8
void zSpringBoardGoToPatrol::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80324700 -> 0x80324754
void zSpringBoardGoToPatrol::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}
