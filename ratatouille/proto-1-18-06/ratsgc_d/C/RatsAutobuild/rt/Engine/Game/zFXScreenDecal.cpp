/*
    ...
    Language: C++
    Code range: 0x80282BB4 -> 0x80282F24
*/
static int decalCount; // size: 0x4, address: 0x80D6B338
static class Decal decals[8]; // size: 0x40, address: 0x80D264A8
// total size: 0x10
struct xFRect {
    // Members
...
// total size: 0xC
struct /* @class$809zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$810zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$811zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$812zFXScreenDecal_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$813zFXScreenDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$814zFXScreenDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$815zFXScreenDecal_cpp */ {
    // Members
...
// Range: 0x80282BB4 -> 0x80282BC0
void zFXScreenDecalSceneEnter() {
    // References
    // -> static int decalCount;
}

// Range: 0x80282BC0 -> 0x80282BCC
void zFXScreenDecalSceneReset() {
    // References
    // -> static int decalCount;
}

// Range: 0x80282BCC -> 0x80282C88
void zFXScreenDecalUpdate(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// Range: 0x80282CEC -> 0x80282F24
// this: r31
static void Decal::Render() {
    // Local variables
    unsigned int alpha; // r30
    float fadeInTime; // f31
