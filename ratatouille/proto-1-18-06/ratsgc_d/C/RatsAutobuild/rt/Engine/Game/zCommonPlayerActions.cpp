/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCommonPlayerActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026670C -> 0x8026EFD8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$anDismountCheck__22zPlayerActionRopeClimbFP15xAnimTransitionP11xAnimSinglePv[16]; // size: 0x10, address: 0x80D656E8
char __FUNCTION__$localstatic1$anStickNeutralCheck__22zPlayerActionRopeClimbFP15xAnimTransitionP11xAnimSinglePv[20]; // size: 0x14, address: 0x80D656F8
char __FUNCTION__$localstatic1$anStickDownCheck__22zPlayerActionRopeClimbFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80D6570C
char __FUNCTION__$localstatic1$anStickUpCheck__22zPlayerActionRopeClimbFP15xAnimTransitionP11xAnimSinglePv[15]; // size: 0xF, address: 0x80D6571D
char __FUNCTION__$localstatic1$anMountedCB__22zPlayerActionRopeClimbFP15xAnimTransitionP11xAnimSinglePv[12]; // size: 0xC, address: 0x80D6572C
// total size: 0xC
...
// Range: 0x8026670C -> 0x802667E0
void zCommonPlayerActionsNormalTransitions(class zPlayerActionManager * manager /* r26 */, struct xAnimTable * table /* r27 */, const char * fromState /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x802667E0 -> 0x8026691C
void zCommonPlayerActionsAirTransitions(class zPlayerActionManager * manager /* r29 */, struct xAnimTable * table /* r30 */, const char * transitionString /* r31 */) {}
...
class zCommonPlayerAction : public zPlayerAction {
    ...
    unsigned int FallCheck();

    unsigned int WalkCheck();

    unsigned int RunCheck();
};
// Range: 0x8026691C -> 0x802669E4
// this: r31
unsigned int zCommonPlayerAction::LandCheck() {}
...
// total size: 0x4
struct /* @class$929zCommonPlayerActions_cpp */ {
    // Members
...
union /* @class$1068zCommonPlayerActions_cpp */ {
...
// total size: 0xC
struct /* @class$1067zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1934zCommonPlayerActions_cpp */ {
    // Static members
...
// Range: 0x802669E4 -> 0x80266A6C
// this: r31
unsigned int zCommonPlayerAction::FallCheck() {}

// Range: 0x80266A6C -> 0x80266AA8
// this: r1+0x8
unsigned int zCommonPlayerAction::WalkCheck() {}

// total size: 0x4
struct /* @class$2081zCommonPlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2082zCommonPlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2083zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2080zCommonPlayerActions_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2085zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1691zCommonPlayerActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80266AA8 -> 0x80266B0C
// this: r30
unsigned int zCommonPlayerAction::RunCheck() {}

float PLAYER_WALK_MIN_TIME; // size: 0x4, address: 0x80D65738
// total size: 0xC
class zPlayerIdle : public zCommonPlayerAction {
    // Functions
    void Reset();
    ...
    unsigned int InactiveIdleCB(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int IdleCB();

    unsigned int FrontPlayerHitCheck();

    unsigned int BackPlayerHitCheck();

    unsigned int IdleAnyCheck();

    unsigned int IdleNormalCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int IdleEnemyCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int InactiveCheck();

    void IdleBeforeHandler12(struct xAnimState * state);

    void IdleBeforeHandler3(struct xAnimPlay * play, struct xAnimState * state);

    void IdleBeforeHandler4(struct xAnimPlay * play, struct xAnimState * state);

    unsigned int StartWalkDoneCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);
};
// Range: 0x80266B0C -> 0x80266B68
void zPlayerIdle::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> float PLAYER_WALK_MIN_TIME;
}

// Range: 0x80266B68 -> 0x80266BD8
// this: r31
void zPlayerIdle::Reset() {}

// Range: 0x80266BD8 -> 0x80266D94
// this: r30
void zPlayerIdle::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x80266D94 -> 0x80266DC4
// this: r1+0x8
void zPlayerIdle::Begin() {}

// Range: 0x80266DC4 -> 0x80266E64
void zPlayerIdle::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x80266E64 -> 0x80266EB8
void zPlayerIdle::AddRunningLandTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x80266EB8 -> 0x80266F0C
void zPlayerIdle::AddStartWalkTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x80266F0C -> 0x8026733C
void zPlayerIdle::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026733C -> 0x802674A4
void zPlayerIdle::AddTransitionsTo(class zPlayerActionManager * manager /* r29 */, struct xAnimTable * table /* r30 */, const char * state /* r31 */) {}

// Range: 0x802674A4 -> 0x802674E4
// this: r31
void zPlayerIdle::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x802674E4 -> 0x80267530
// this: r31
unsigned int zPlayerIdle::InactiveIdleCB(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x80267530 -> 0x802675BC
// this: r31
unsigned int zPlayerIdle::IdleCB() {}

// Range: 0x802675BC -> 0x802675F8
// this: r1+0x8
unsigned int zPlayerIdle::FrontPlayerHitCheck() {}

// Range: 0x802675F8 -> 0x80267634
// this: r1+0x8
unsigned int zPlayerIdle::BackPlayerHitCheck() {}

// Range: 0x80267634 -> 0x80267668
// this: r1+0x8
unsigned int zPlayerIdle::IdleAnyCheck() {}

// Range: 0x80267668 -> 0x8026775C
// this: r31
unsigned int zPlayerIdle::IdleNormalCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x8026775C -> 0x80267850
// this: r31
unsigned int zPlayerIdle::IdleEnemyCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}
...
// Range: 0x80267850 -> 0x802678DC
// this: r30
unsigned int zPlayerIdle::InactiveCheck() {
    // References
...
// total size: 0xC
struct /* @class$861zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$862zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$863zCommonPlayerActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$864zCommonPlayerActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$865zCommonPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$866zCommonPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$867zCommonPlayerActions_cpp */ {
    // Members
...
// Range: 0x802678DC -> 0x802679A4
// this: r1+0x8
void zPlayerIdle::IdleBeforeHandler12(struct xAnimState * state /* r31 */) {
    // Local variables
    unsigned int ID; // r28
    unsigned int i; // r30
}
...
// Range: 0x802679A4 -> 0x80267A04
// this: r1+0x8
void zPlayerIdle::IdleBeforeHandler3(struct xAnimPlay * play /* r1+0xC */, struct xAnimState * state /* r1+0x10 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80267A04 -> 0x80267A64
// this: r1+0x8
void zPlayerIdle::IdleBeforeHandler4(struct xAnimPlay * play /* r1+0xC */, struct xAnimState * state /* r1+0x10 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80267A64 -> 0x80267B40
void zPlayerIdle::IdleBeforeHandler(struct xAnimState * state /* r30 */, struct xAnimFile * * extras /* r27 */, unsigned int extraCount /* r1+0x8 */) {
    // Local variables
    struct xAnimFile * idles[32]; // r1+0xC
    unsigned int idleCount; // r31
    unsigned int i; // r29
    unsigned int i; // r28
}

// Range: 0x80267B40 -> 0x80267BA8
// this: r1+0x8
unsigned int zPlayerIdle::StartWalkDoneCheck(struct xAnimTransition * tran /* r1+0xC */, struct xAnimSingle * anim /* r30 */) {
    // References
    // -> float PLAYER_WALK_MIN_TIME;
}
...
class zPlayerSkidStop : public zCommonPlayerAction {
    ...
    unsigned int IdleNormalStopCheck();

    unsigned int IdleEnemyStopCheck();
};
// Range: 0x80267BA8 -> 0x80267C24
// this: r1+0x18
void zPlayerSkidStop::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x80267C24 -> 0x80267DB8
// this: r31
void zPlayerSkidStop::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x80267DB8 -> 0x80267E58
void zPlayerSkidStop::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x80267E58 -> 0x80267E84
// this: r1+0x8
void zPlayerSkidStop::Begin() {}

// Range: 0x80267E84 -> 0x80267F60
// this: r31
unsigned int zPlayerSkidStop::IdleNormalStopCheck() {}

// Range: 0x80267F60 -> 0x8026803C
// this: r31
unsigned int zPlayerSkidStop::IdleEnemyStopCheck() {}
...
// Range: 0x8026803C -> 0x802680B0
// this: r1+0x18
void zPlayerWalkStart::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x802680B0 -> 0x80268328
// this: r31
void zPlayerWalkStart::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerIdle * idle; // r29
    class zPlayerDefeated * defeated; // r28
}
...
// Range: 0x80268328 -> 0x8026838C
void zPlayerWalkStart::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, unsigned int flags /* r1+0x14 */, unsigned int userFlags /* r1+0x18 */) {}

// Range: 0x8026838C -> 0x802683D8
// this: r31
void zPlayerWalkStart::Update(float dt /* r1+0x8 */) {}

// total size: 0xC
class zPlayerWalk : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);

    void AddActionTransitions(struct xAnimTable * table);
};
// Range: 0x802683D8 -> 0x8026844C
// this: r1+0x18
void zPlayerWalk::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x8026844C -> 0x8026868C
// this: r31
void zPlayerWalk::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerDefeated * defeated; // r29
    class zPlayerRun * run; // r28
}

// Range: 0x8026868C -> 0x802686F4
void zPlayerWalk::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802686F4 -> 0x80268764
void zPlayerWalk::AddRunTransitionsFrom(struct xAnimTable * table /* r1+0x10 */, const char * fromStates /* r1+0x14 */) {}

static unsigned int FAST_RUN_ENABLE; // size: 0x4, address: 0x80D6B220
static float FAST_RUN_STICK_THRESHOLD; // size: 0x4, address: 0x80D6573C
static float FAST_RUN_TIME; // size: 0x4, address: 0x80D65740
// total size: 0x10
class zPlayerRun : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int FastRunCheck();

    unsigned int SlowRunCheck();

    // Members
protected:
    float runTimer; // offset 0xC, size 0x4
};
// Range: 0x80268764 -> 0x80268828
void zPlayerRun::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static unsigned int FAST_RUN_ENABLE;
    // -> static float FAST_RUN_TIME;
    // -> static float FAST_RUN_STICK_THRESHOLD;
}

// Range: 0x80268828 -> 0x80268998
// this: r30
void zPlayerRun::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x80268998 -> 0x80268B08
void zPlayerRun::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x80268B08 -> 0x80268D58
// this: r31
void zPlayerRun::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerJump * jump; // r29
    class zPlayerFall * fall; // r28
    class zPlayerDefeated * defeated; // r27
    class zPlayerWalk * walk; // r26
}

// Range: 0x80268D58 -> 0x80268DC0
void zPlayerRun::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x80268DC0 -> 0x80268E14
void zPlayerRun::AddWalkTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x80268E14 -> 0x80268E20
// this: r3
void zPlayerRun::Begin() {}

// Range: 0x80268E20 -> 0x80268F10
// this: r30
void zPlayerRun::Update(float dt /* f29 */) {
    // Local variables
    const struct AnalogStick & stick1; // r31
    float mag; // f30
...
// Range: 0x80268F10 -> 0x80268F50
// this: r3
unsigned int zPlayerRun::FastRunCheck() {
    // References
    // -> static float FAST_RUN_TIME;
    // -> static unsigned int FAST_RUN_ENABLE;
}

// Range: 0x80268F50 -> 0x80268F68
// this: r3
unsigned int zPlayerRun::SlowRunCheck() {
    // References
    // -> static float FAST_RUN_TIME;
}
...
class zPlayerSlip : public zCommonPlayerAction {
    ...
    unsigned int SlipCheck();
};
// Range: 0x80268F68 -> 0x80268FDC
// this: r1+0x18
void zPlayerSlip::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x80268FDC -> 0x80269174
// this: r31
void zPlayerSlip::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerDefeated * defeated; // r29
}

// Range: 0x80269174 -> 0x802691C8
// this: r1+0x8
void zPlayerSlip::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x802691C8 -> 0x80269230
void zPlayerSlip::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x80269230 -> 0x80269294
// this: r30
unsigned int zPlayerSlip::SlipCheck() {}

static const char * JUMP_START_DEFAULT_STATE; // size: 0x4, address: 0x80D65744
static float JUMP_TIME_TOTAL; // size: 0x4, address: 0x80D65748
static float JUMP_TIME_DECEL; // size: 0x4, address: 0x80D6574C
static float JUMP_TIME_CONST; // size: 0x4, address: 0x80D6B224
static float JUMP_HEIGHT; // size: 0x4, address: 0x80D65750
static float JUMP_VELOCITY; // size: 0x4, address: 0x80D6B228
static float JUMP_DECEL; // size: 0x4, address: 0x80D6B22C
static float JUMP_FLOAT; // size: 0x4, address: 0x80D65754
// Range: 0x80269294 -> 0x802692D4
static void RecalcJumpParams() {
    // References
    // -> static float JUMP_TIME_DECEL;
    // -> static float JUMP_VELOCITY;
    // -> static float JUMP_DECEL;
    // -> static float JUMP_TIME_TOTAL;
    // -> static float JUMP_TIME_CONST;
...
static struct tweak_callback recalcJumpParamsCB; // size: 0x28, address: 0x804C6580
// total size: 0x14
class zPlayerJump : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x802692D4 -> 0x80269408
void zPlayerJump::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static struct tweak_callback recalcJumpParamsCB;
    // -> static float JUMP_FLOAT;
    // -> static float JUMP_HEIGHT;
    // -> static float JUMP_DECEL;
    // -> static float JUMP_TIME_DECEL;
    // -> static float JUMP_TIME_TOTAL;
...
// Range: 0x80269408 -> 0x80269478
// this: r1+0x18
void zPlayerJump::AddStates(struct xAnimTable * table /* r1+0x1C */) {
    // References
    // -> static const char * JUMP_START_DEFAULT_STATE;
}

// Range: 0x80269478 -> 0x802694D8
void zPlayerJump::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {
    // References
    // -> static const char * JUMP_START_DEFAULT_STATE;
}

// Range: 0x802694D8 -> 0x8026964C
// this: r31
void zPlayerJump::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerFall * fall; // r29
    class zPlayerDoubleJump * doubleJump; // r28
}

// Range: 0x8026964C -> 0x802696A0
void zPlayerJump::AddRunningTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x802696A0 -> 0x802697A0
// this: r31
unsigned int zPlayerJump::JumpCheck() {}

// Range: 0x802697A0 -> 0x802697BC
// this: r3
void zPlayerJump::Begin() {}

// Range: 0x802697BC -> 0x80269894
// this: r31
void zPlayerJump::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r30 */) {
    // References
    // -> static float JUMP_FLOAT;
    // -> static float JUMP_TIME_TOTAL;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65758
// Range: 0x80269894 -> 0x80269988
// this: r31
float zPlayerJump::GetY(float t /* f30 */) const {
    // Local variables
    float yVal; // f31
    float decelTime; // f29
...
// Range: 0x80269988 -> 0x80269A24
// this: r31
float zPlayerJump::PredictY(float t /* f30 */) const {
    // Local variables
    float fallTime; // f31
...
// Range: 0x80269A24 -> 0x80269A3C
// this: r3
unsigned char zPlayerJump::CanLand() const {
    // References
    // -> static float JUMP_TIME_TOTAL;
}

static float DOUBLE_JUMP_HEIGHT; // size: 0x4, address: 0x80D65760
// total size: 0x10
class zPlayerDoubleJump : public zPlayerAction {
    ...
    // Members
protected:
    unsigned char doubleJumped; // offset 0xC, size 0x1
};
// Range: 0x80269A3C -> 0x80269A9C
void zPlayerDoubleJump::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float DOUBLE_JUMP_HEIGHT;
}

// Range: 0x80269A9C -> 0x80269B14
// this: r1+0x18
void zPlayerDoubleJump::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x80269B14 -> 0x80269C48
// this: r31
void zPlayerDoubleJump::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerFall * fall; // r29
}

// Range: 0x80269C48 -> 0x80269CAC
// this: r31
...
// Range: 0x80269CAC -> 0x80269D14
void zPlayerDoubleJump::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x80269D14 -> 0x80269D68
void zPlayerDoubleJump::AddMatchedTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x80269D68 -> 0x80269DC4
// this: r31
unsigned int zPlayerDoubleJump::StartCheck() {}

// Range: 0x80269DC4 -> 0x80269DD0
// this: r3
void zPlayerDoubleJump::Reset() {}

// Range: 0x80269DD0 -> 0x80269E3C
// this: r31
void zPlayerDoubleJump::Timestep() {}

// total size: 0xC
class zPlayerFall : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
...
// Range: 0x80269E3C -> 0x80269F14
// this: r30
void zPlayerFall::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x80269F14 -> 0x80269F84
void zPlayerFall::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x80269F84 -> 0x8026A0FC
// this: r31
void zPlayerFall::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerLand * land; // r29
    class zPlayerDoubleJump * doubleJump; // r28
}

// Range: 0x8026A0FC -> 0x8026A150
// this: r1+0x8
void zPlayerFall::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026A150 -> 0x8026A1B8
void zPlayerFall::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026A1B8 -> 0x8026A20C
void zPlayerFall::AddRunningTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8026A20C -> 0x8026A25C
void zPlayerFall::AddMatchedTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// total size: 0x10
class zPlayerLand : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int LandWalkCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int LandRunCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    void LandBeforeEnter(struct xAnimState * state);

    void Reset();

    // Members
protected:
    unsigned int landHint; // offset 0xC, size 0x4
};
// Range: 0x8026A25C -> 0x8026A3C4
// this: r30
void zPlayerLand::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026A3C4 -> 0x8026A434
void zPlayerLand::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x8026A434 -> 0x8026A6AC
// this: r31
void zPlayerLand::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerIdle * idle; // r29
    class zPlayerJump * jump; // r28
}

// Range: 0x8026A6AC -> 0x8026A700
// this: r1+0x8
void zPlayerLand::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026A700 -> 0x8026A7A0
void zPlayerLand::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026A7A0 -> 0x8026A7F4
void zPlayerLand::AddHighTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8026A7F4 -> 0x8026A820
// this: r1+0x8
void zPlayerLand::Begin() {}

// Range: 0x8026A820 -> 0x8026A88C
// this: r30
unsigned int zPlayerLand::LandWalkCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x8026A88C -> 0x8026A8F8
// this: r30
unsigned int zPlayerLand::LandRunCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x8026A8F8 -> 0x8026A984
// this: r3
void zPlayerLand::LandBeforeEnter(struct xAnimState * state /* r5 */) {
    // Local variables
    unsigned int i; // r31
}

// Range: 0x8026A984 -> 0x8026A990
// this: r3
void zPlayerLand::Reset() {}
...
class zPlayerTriggered : public zPlayerAction {
    ...
    unsigned int TriggeredAnimCheck(struct xAnimTransition * tran);

    void End();

    void Reset();

    void TriggerAnim(int index, struct xBase * sender);
...
// Range: 0x8026A990 -> 0x8026AAFC
// this: r31
void zPlayerTriggered::AddStates(struct xAnimTable * table /* r30 */) {}

// Range: 0x8026AAFC -> 0x8026AB54
// this: r31
void zPlayerTriggered::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x8026AB54 -> 0x8026AC54
void zPlayerTriggered::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026AC54 -> 0x8026ACA8
// this: r1+0x8
void zPlayerTriggered::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026ACA8 -> 0x8026ACF0
// this: r3
unsigned int zPlayerTriggered::TriggeredAnimCheck(struct xAnimTransition * tran /* r4 */) {}

// Range: 0x8026ACF0 -> 0x8026AD84
// this: r31
void zPlayerTriggered::End() {
    // Local variables
    float parms[4]; // r1+0x8
}

// Range: 0x8026AD84 -> 0x8026AD90
// this: r3
void zPlayerTriggered::Reset() {}

// Range: 0x8026AD90 -> 0x8026AD9C
// this: r3
void zPlayerTriggered::TriggerAnim(int index /* r4 */, struct xBase * sender /* r5 */) {}

float zPlayerDodge_delay; // size: 0x4, address: 0x80D65764
static float CROUCHCOMBODELAY; // size: 0x4, address: 0x80D65768
static float DODGE_BLUR_ALPHA; // size: 0x4, address: 0x80D6576C
static float DODGE_BLUR_LIFE; // size: 0x4, address: 0x80D65770
static float DODGE_BLUR_FADE_IN_TIME; // size: 0x4, address: 0x80D65774
static float DODGE_BLUR_FADE_OUT_TIME; // size: 0x4, address: 0x80D65778
// Range: 0x8026AD9C -> 0x8026ADD4
static void InitializeDodgeAttack(class zCombatAttack * attack /* r3 */, unsigned int stateID /* r4 */, unsigned short dodgeBone /* r5 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r6 */) {}
...
// total size: 0x28
class zPlayerDodge : public zPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int DodgeFrontCheck();

    unsigned int DodgeLeftCheck();

    unsigned int DodgeBackCheck();

    unsigned int DodgeRightCheck();
    ...
    unsigned int DodgeJumpCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int DodgeWalkCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int DodgeRunCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    unsigned int DodgePunchCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    // Members
protected:
    enum DodgeState dodgeState; // offset 0xC, size 0x4
    enum DodgeDir dodgeDir; // offset 0x10, size 0x4
    float dodgeDRot; // offset 0x14, size 0x4
    unsigned char dodgeBlurring; // offset 0x18, size 0x1
    float dodgeRollVelocity; // offset 0x1C, size 0x4
    float dodgeRunVelocity; // offset 0x20, size 0x4
    float dodgeTimer; // offset 0x24, size 0x4
};
// Range: 0x8026ADD4 -> 0x8026AF40
// this: r30
void zPlayerDodge::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026AF40 -> 0x8026B0C4
// this: r30
void zPlayerDodge::AddActionTransitions(struct xAnimTable * table /* r31 */) {
    // References
    // -> static const char * JUMP_START_DEFAULT_STATE;
}

// Range: 0x8026B0C4 -> 0x8026B118
// this: r1+0x8
void zPlayerDodge::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026B118 -> 0x8026B218
void zPlayerDodge::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026B218 -> 0x8026B2B0
void zPlayerDodge::AddAttacks(class zCombatAttack * attackStates /* r29 */, unsigned short dodgeBone /* r30 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r31 */) {}

// Range: 0x8026B2B0 -> 0x8026B334
// this: r31
void zPlayerDodge::Move(struct xScene * s /* r1+0x8 */, float dt /* r1+0xC */, struct xEntFrame * frame /* r30 */) {}

// Range: 0x8026B334 -> 0x8026B36C
// this: r3
unsigned int zPlayerDodge::DodgeFrontCheck() {}

// Range: 0x8026B36C -> 0x8026B3A4
// this: r3
unsigned int zPlayerDodge::DodgeLeftCheck() {}

// Range: 0x8026B3A4 -> 0x8026B3DC
// this: r3
unsigned int zPlayerDodge::DodgeBackCheck() {}

// Range: 0x8026B3DC -> 0x8026B414
// this: r3
unsigned int zPlayerDodge::DodgeRightCheck() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6577C
// Range: 0x8026B414 -> 0x8026B500
// this: r31
void zPlayerDodge::Begin() {
    // Local variables
    struct xAnimState * astate; // r30

    // References
    // -> static char __FUNCTION__[6];
}

// Range: 0x8026B500 -> 0x8026B528
// this: r1+0x8
void zPlayerDodge::End() {}

// Range: 0x8026B528 -> 0x8026B52C
void zPlayerDodge::Timestep() {}

// Range: 0x8026B52C -> 0x8026B538
// this: r3
void zPlayerDodge::Reset() {}

// Range: 0x8026B538 -> 0x8026B5DC
// this: r31
void zPlayerDodge::StartDodgeBlur() {
    // References
    // -> static float DODGE_BLUR_FADE_IN_TIME;
    // -> static float DODGE_BLUR_ALPHA;
    // -> static float DODGE_BLUR_LIFE;
}

// Range: 0x8026B5DC -> 0x8026B648
// this: r31
void zPlayerDodge::StopDodgeBlur() {
    // References
    // -> static float DODGE_BLUR_FADE_OUT_TIME;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65782
// Range: 0x8026B648 -> 0x8026B710
// this: r29
unsigned int zPlayerDodge::DodgeJumpCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r30 */) {
    // Local variables
    class zPlayerJump * jump; // r31

    // References
    // -> static char __FUNCTION__[15];
    // -> static float CROUCHCOMBODELAY;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65791
// Range: 0x8026B710 -> 0x8026B7D8
// this: r29
unsigned int zPlayerDodge::DodgeWalkCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r30 */) {
    // Local variables
    class zPlayerWalk * action; // r31

    // References
    // -> static char __FUNCTION__[15];
    // -> float zPlayerDodge_delay;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D657A0
// Range: 0x8026B7D8 -> 0x8026B8A0
// this: r29
unsigned int zPlayerDodge::DodgeRunCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r30 */) {
    // Local variables
    class zPlayerRun * action; // r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D657AE
// Range: 0x8026B8A0 -> 0x8026B968
// this: r29
unsigned int zPlayerDodge::DodgePunchCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r30 */) {
    // Local variables
    class zPlayerPunch * action; // r31
...
// Range: 0x8026B968 -> 0x8026BAB0
void zPlayerDodge::AddTweaks() {
    // Local variables
    const char * prefix; // r31
...
// total size: 0xC
class zPlayerLedge : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int LedgeGrabCheck();

    void Begin();

    void End();

    unsigned int LedgeGrabUpCB();

    void Update(float dt);
};
// Range: 0x8026BAB0 -> 0x8026BBC4
// this: r30
void zPlayerLedge::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026BBC4 -> 0x8026BC90
void zPlayerLedge::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026BC90 -> 0x8026BCD0
void zPlayerLedge::AddAttacks(class zCombatAttack * attackStates /* r4 */, unsigned short bone /* r5 */, void (* hitCB)(struct xEnt *, class zCombatAttack *, struct xEnt *, struct xVec3 *, struct xVec3 *) /* r6 */) {}

// Range: 0x8026BCD0 -> 0x8026BDEC
// this: r31
void zPlayerLedge::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x8026BDEC -> 0x8026BE40
// this: r1+0x8
void zPlayerLedge::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026BE40 -> 0x8026BEA8
void zPlayerLedge::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026BEA8 -> 0x8026BEE4
// this: r1+0x8
unsigned int zPlayerLedge::LedgeGrabCheck() {}

// Range: 0x8026BEE4 -> 0x8026BF50
// this: r31
...
// Range: 0x8026BF50 -> 0x8026BFC0
// this: r31
void zPlayerLedge::End() {}

// Range: 0x8026BFC0 -> 0x8026C024
// this: r31
unsigned int zPlayerLedge::LedgeGrabUpCB() {}

// Range: 0x8026C024 -> 0x8026C0BC
// this: r31
void zPlayerLedge::Update(float dt /* r1+0x8 */) {}
...
class zPlayerHit : public zCommonPlayerAction {
    ...
    unsigned int HitFrontCheck();

    unsigned int HitBackCheck();
};
// Range: 0x8026C0BC -> 0x8026C180
// this: r30
void zPlayerHit::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026C180 -> 0x8026C250
void zPlayerHit::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026C250 -> 0x8026C2C4
// this: r31
void zPlayerHit::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x8026C2C4 -> 0x8026C310
// this: r31
void zPlayerHit::End() {}

// Range: 0x8026C310 -> 0x8026C3B0
void zPlayerHit::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026C3B0 -> 0x8026C418
// this: r30
unsigned int zPlayerHit::HitFrontCheck() {}

// Range: 0x8026C418 -> 0x8026C480
// this: r30
unsigned int zPlayerHit::HitBackCheck() {}

// total size: 0xC
class zPlayerLaunch : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int HitLandCB();

    void AddStandardTransitionsFrom(struct xAnimTable * table, const char * fromStates);

    unsigned int LaunchFrontCheck();

    unsigned int LaunchBackCheck();
};
// Range: 0x8026C480 -> 0x8026C5DC
// this: r30
void zPlayerLaunch::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026C5DC -> 0x8026C75C
void zPlayerLaunch::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026C75C -> 0x8026C814
// this: r31
void zPlayerLaunch::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerDefeated * defeated; // r29
}

// Range: 0x8026C814 -> 0x8026C880
// this: r31
void zPlayerLaunch::End() {}

// Range: 0x8026C880 -> 0x8026C8C8
// this: r31
unsigned int zPlayerLaunch::HitLandCB() {}

// Range: 0x8026C8C8 -> 0x8026C91C
// this: r1+0x8
void zPlayerLaunch::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x8026C91C -> 0x8026C9BC
void zPlayerLaunch::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026C9BC -> 0x8026C9F8
// this: r1+0x8
unsigned int zPlayerLaunch::LaunchFrontCheck() {}

// Range: 0x8026C9F8 -> 0x8026CA34
// this: r1+0x8
unsigned int zPlayerLaunch::LaunchBackCheck() {}

// total size: 0xC
class zPlayerDefeated : public zCommonPlayerAction {
    // Functions
    void Begin();
    ...
    unsigned int LandDeadCheck(struct xAnimTransition * tran, struct xAnimSingle * anim);

    void Update(float dt);
};
// Range: 0x8026CA34 -> 0x8026CA38
void zPlayerDefeated::AddTweaks() {}

// Range: 0x8026CA38 -> 0x8026CA88
// this: r31
void zPlayerDefeated::Begin() {}

// Range: 0x8026CA88 -> 0x8026CBE4
// this: r30
void zPlayerDefeated::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026CBE4 -> 0x8026CC24
// this: r31
unsigned int zPlayerDefeated::DeathCheck() {}

// Range: 0x8026CC24 -> 0x8026CC98
// this: r30
unsigned int zPlayerDefeated::LandDeadCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x8026CC98 -> 0x8026CD14
// this: r30
void zPlayerDefeated::Update(float dt /* r1+0x8 */) {
    // Local variables
    struct xAnimSingle * single; // r31
}

// Range: 0x8026CD14 -> 0x8026CD18
void zPlayerDefeated::AddInternalTransitions() {}

// Range: 0x8026CD18 -> 0x8026CD1C
void zPlayerDefeated::End() {}

// Range: 0x8026CD1C -> 0x8026CD20
void zPlayerDefeated::AddActionTransitions() {}

// Range: 0x8026CD20 -> 0x8026CD88
void zPlayerDefeated::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026CD88 -> 0x8026CDDC
void zPlayerDefeated::AddMovingTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8026CDDC -> 0x8026CE30
void zPlayerDefeated::AddLandFrontTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x8026CE30 -> 0x8026CE84
void zPlayerDefeated::AddLandBackTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

static float FALL_DISTANCE_LIMIT; // size: 0x4, address: 0x80D657C0
static float FALL_TIMER; // size: 0x4, address: 0x80D657C4
// total size: 0x10
...
// Range: 0x8026CE84 -> 0x8026CF14
void zPlayerFallToDeath::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float FALL_TIMER;
    // -> static float FALL_DISTANCE_LIMIT;
}

struct xVec3 m_Null; // size: 0xC, address: 0x80D6D920
// Range: 0x8026CF14 -> 0x8026CFB8
// this: r31
...
// Range: 0x8026CFB8 -> 0x8026D07C
// this: r30
void zPlayerFallToDeath::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026D07C -> 0x8026D0E4
void zPlayerFallToDeath::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026D0E4 -> 0x8026D158
void zPlayerFallToDeath::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x8026D158 -> 0x8026D1DC
// this: r31
unsigned int zPlayerFallToDeath::StartCheck() {
    // References
    // -> static float FALL_DISTANCE_LIMIT;
}

// Range: 0x8026D1DC -> 0x8026D254
// this: r31
void zPlayerFallToDeath::Update(float dt /* f31 */) {
    // References
    // -> static float FALL_TIMER;
}
...
class zPlayerCheat : public zPlayerAction {
    ...
    unsigned int CheatBeginCheck();

    unsigned int CheatEndCheck();
};
// Range: 0x8026D254 -> 0x8026D2C8
// this: r1+0x18
void zPlayerCheat::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x8026D2C8 -> 0x8026D368
void zPlayerCheat::AddActionTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026D368 -> 0x8026D39C
// this: r31
unsigned int zPlayerCheat::CheatBeginCheck() {}

// Range: 0x8026D39C -> 0x8026D3D8
// this: r31
unsigned int zPlayerCheat::CheatEndCheck() {}

float zPlayerPunchInterruptTime; // size: 0x4, address: 0x80D657C8
unsigned char zPlayerPunchForceFinishingMoves; // size: 0x1, address: 0x80D6B230
float zPlayerPunchStartLerp; // size: 0x4, address: 0x80D657CC
// total size: 0xC
class zPlayerPunch : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);
    ...
    unsigned int PunchButtonCheck();

    unsigned int PunchNoFinishCheck(struct xAnimSingle * anim);

    unsigned int PunchFinishCheck(struct xAnimSingle * anim);

    unsigned int Punch1CB();

    unsigned int Punch2CB();

    unsigned int Punch3CB();

    unsigned int Punch4CB();

    void Update(float dt);
};
// Range: 0x8026D3D8 -> 0x8026D6A4
// this: r30
void zPlayerPunch::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026D6A4 -> 0x8026D78C
// this: r31
void zPlayerPunch::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x8026D78C -> 0x8026DC84
void zPlayerPunch::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026DC84 -> 0x8026DCD0
// this: r31
void zPlayerPunch::Begin() {}

// Range: 0x8026DCD0 -> 0x8026DCD4
void zPlayerPunch::End() {}

// Range: 0x8026DCD4 -> 0x8026DD3C
void zPlayerPunch::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026DD3C -> 0x8026DD70
// this: r31
unsigned int zPlayerPunch::PunchButtonCheck() {}

// Range: 0x8026DD70 -> 0x8026DDE4
// this: r31
unsigned int zPlayerPunch::PunchNoFinishCheck(struct xAnimSingle * anim /* r30 */) {
    // References
    // -> float zPlayerPunchInterruptTime;
}

// Range: 0x8026DDE4 -> 0x8026DE00
unsigned int zPlayerPunch::PunchInterruptCheck(struct xAnimSingle * anim /* r5 */) {
    // References
    // -> float zPlayerPunchInterruptTime;
}

// Range: 0x8026DE00 -> 0x8026DEAC
// this: r29
unsigned int zPlayerPunch::PunchFinishCheck(struct xAnimSingle * anim /* r28 */) {
    // References
    // -> unsigned char zPlayerPunchForceFinishingMoves;
    // -> float zPlayerPunchInterruptTime;
}

// Range: 0x8026DEAC -> 0x8026DEF8
// this: r31
unsigned int zPlayerPunch::Punch1CB() {}

// Range: 0x8026DEF8 -> 0x8026DF44
// this: r31
unsigned int zPlayerPunch::Punch2CB() {}

// Range: 0x8026DF44 -> 0x8026DF90
// this: r31
unsigned int zPlayerPunch::Punch3CB() {}

// Range: 0x8026DF90 -> 0x8026DFDC
// this: r31
unsigned int zPlayerPunch::Punch4CB() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D657D0
// Range: 0x8026DFDC -> 0x8026E0EC
// this: r31
void zPlayerPunch::Update(float dt /* r1+0x8 */) {
    // Local variables
    float lerp; // f31

    // References
    // -> static char __FUNCTION__[7];
    // -> float zPlayerPunchStartLerp;
}

// Range: 0x8026E0EC -> 0x8026E178
void zPlayerPunch::AddTweaks() {
    // References
    // -> float zPlayerPunchStartLerp;
    // -> unsigned char zPlayerPunchForceFinishingMoves;
    // -> float zPlayerPunchInterruptTime;
...
class zPlayerInteraction : public zCommonPlayerAction {
    ...
    unsigned int NotInteractingCheck();

    unsigned int StartCheck(enum zInteractionType type);
};
// Range: 0x8026E178 -> 0x8026E1AC
// this: r31
void zPlayerInteraction::Begin() {}
...
// Range: 0x8026E1AC -> 0x8026E210
// this: r31
void zPlayerInteraction::End() {}

// Range: 0x8026E210 -> 0x8026E254
// this: r1+0x8
unsigned int zPlayerInteraction::NotInteractingCheck() {}
...
// Range: 0x8026E254 -> 0x8026E2DC
// this: r31
unsigned int zPlayerInteraction::StartCheck(enum zInteractionType type /* r1+0x8 */) {}
...
// total size: 0x14
class zPlayerSwitchLever : public zPlayerInteraction {
    // Functions
    void AddTweaks();
    ...
    unsigned int TurnCheck(enum zSwitchLeverState state);

    unsigned int TurnOnCheck();

    unsigned int TurnOffCheck();
...
// Range: 0x8026E2DC -> 0x8026E364
// this: r31
void zPlayerSwitchLever::AddTweaks() {
    // Local variables
    char prefix[256]; // r1+0x8

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8026E364 -> 0x8026E474
// this: r30
void zPlayerSwitchLever::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026E474 -> 0x8026E514
void zPlayerSwitchLever::AddTransitionsFrom(struct xAnimTable * table /* r27 */, const char * fromStates /* r28 */, unsigned short priority /* r29 */, float blend /* f31 */, unsigned int flags /* r30 */, unsigned int userFlags /* r31 */) {}

// Range: 0x8026E514 -> 0x8026E588
void zPlayerSwitchLever::AddInternalTransitions(struct xAnimTable * table /* r1+0x10 */) {}

// Range: 0x8026E588 -> 0x8026E650
// this: r31
void zPlayerSwitchLever::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x8026E650 -> 0x8026E680
// this: r1+0x8
unsigned int zPlayerSwitchLever::LandCB() {}
...
// Range: 0x8026E680 -> 0x8026E6EC
// this: r30
unsigned int zPlayerSwitchLever::TurnCheck(enum zSwitchLeverState state /* r1+0x8 */) {
    // Local variables
    class zSwitchLever * switchLever; // r31
}
...
// Range: 0x8026E6EC -> 0x8026E718
// this: r1+0x8
unsigned int zPlayerSwitchLever::TurnOnCheck() {}

// Range: 0x8026E718 -> 0x8026E744
// this: r1+0x8
unsigned int zPlayerSwitchLever::TurnOffCheck() {}

// Range: 0x8026E744 -> 0x8026E7FC
// this: r31
void zPlayerSwitchLever::Update(float dt /* r1+0x8 */) {}

// Range: 0x8026E7FC -> 0x8026E868
// this: r31
void zPlayerSwitchLever::Begin() {}

// Range: 0x8026E868 -> 0x8026E8A0
// this: r31
void zPlayerSwitchLever::End() {}

static float FILL_RATE; // size: 0x4, address: 0x80D657D8
static float DASH_TIME; // size: 0x4, address: 0x80D657DC
static float DASH_THRESHOLD; // size: 0x4, address: 0x80D657E0
static unsigned int DASH_AUTO; // size: 0x4, address: 0x80D6B234
static unsigned int DASH_USE_FILLRATE; // size: 0x4, address: 0x80D6B238
// total size: 0x10
class zCommonPlayerDash : public zCommonPlayerAction {
    ...
    // Members
protected:
    float dashAmount; // offset 0xC, size 0x4
};
// Range: 0x8026E8A0 -> 0x8026E9C8
void zCommonPlayerDash::AddTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static unsigned int DASH_USE_FILLRATE;
    // -> static unsigned int DASH_AUTO;
    // -> static float DASH_THRESHOLD;
    // -> static float DASH_TIME;
    // -> static float FILL_RATE;
}

// Range: 0x8026E9C8 -> 0x8026EAE8
// this: r30
void zCommonPlayerDash::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026EAE8 -> 0x8026EAF4
// this: r3
void zCommonPlayerDash::Reset() {}

// Range: 0x8026EAF4 -> 0x8026EBF8
// this: r31
void zCommonPlayerDash::Timestep(float dt /* f31 */) {
    // References
    // -> static float FILL_RATE;
    // -> static float DASH_TIME;
    // -> static unsigned int DASH_USE_FILLRATE;
...
// Range: 0x8026EBF8 -> 0x8026ECC4
void zCommonPlayerDash::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x8026ECC4 -> 0x8026EE74
// this: r31
void zCommonPlayerDash::AddActionTransitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    class zPlayerJump * jump; // r29
    class zPlayerFall * fall; // r28
    class zPlayerDefeated * defeated; // r27
...
// Range: 0x8026EE74 -> 0x8026EEDC
void zCommonPlayerDash::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x8026EEDC -> 0x8026EF40
// this: r31
unsigned int zCommonPlayerDash::StartCheck() {
    // References
    // -> static float DASH_THRESHOLD;
}

// Range: 0x8026EF40 -> 0x8026EFD8
// this: r31
unsigned int zCommonPlayerDash::EndCheck() {
    // Local variables
    unsigned int endIt; // r30
...
// total size: 0x54
struct {} zCommonPlayerDash::__vtable; // size: 0x54, address: 0x805243A8
// total size: 0x54
struct {} zPlayerSwitchLever::__vtable; // size: 0x54, address: 0x805243FC
// total size: 0x54
struct {} zPlayerInteraction::__vtable; // size: 0x54, address: 0x80524450
// total size: 0x58
struct {} zPlayerPunch::__vtable; // size: 0x58, address: 0x805244A4
// total size: 0x54
struct {} zPlayerCheat::__vtable; // size: 0x54, address: 0x805244FC
// total size: 0x54
struct {} zPlayerFallToDeath::__vtable; // size: 0x54, address: 0x80524550
// total size: 0x54
struct {} zPlayerDefeated::__vtable; // size: 0x54, address: 0x805245A4
// total size: 0x54
struct {} zPlayerLaunch::__vtable; // size: 0x54, address: 0x805245F8
// total size: 0x54
struct {} zPlayerHit::__vtable; // size: 0x54, address: 0x8052464C
// total size: 0x54
struct {} zPlayerLedge::__vtable; // size: 0x54, address: 0x805246A0
// total size: 0x54
struct {} zPlayerDodge::__vtable; // size: 0x54, address: 0x805246F4
// total size: 0x54
struct {} zPlayerTriggered::__vtable; // size: 0x54, address: 0x80524748
// total size: 0x54
struct {} zPlayerLand::__vtable; // size: 0x54, address: 0x8052479C
// total size: 0x54
struct {} zPlayerFall::__vtable; // size: 0x54, address: 0x805247F0
// total size: 0x54
struct {} zPlayerDoubleJump::__vtable; // size: 0x54, address: 0x80524844
// total size: 0x54
struct {} zPlayerJump::__vtable; // size: 0x54, address: 0x80524898
// total size: 0x54
struct {} zPlayerSlip::__vtable; // size: 0x54, address: 0x805248EC
// total size: 0x54
struct {} zPlayerRun::__vtable; // size: 0x54, address: 0x80524940
// total size: 0x54
struct {} zPlayerWalk::__vtable; // size: 0x54, address: 0x80524994
// total size: 0x54
struct {} zPlayerWalkStart::__vtable; // size: 0x54, address: 0x805249E8
// total size: 0x54
struct {} zPlayerSkidStop::__vtable; // size: 0x54, address: 0x80524A3C
// total size: 0x54
struct {} zPlayerIdle::__vtable; // size: 0x54, address: 0x80524A90
