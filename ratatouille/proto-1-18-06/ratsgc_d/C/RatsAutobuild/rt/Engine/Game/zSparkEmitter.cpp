/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSparkEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8024B578 -> 0x8024CF80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSparkEmitterAsset default_spark_asset; // size: 0x94, address: 0x80D24930
// Range: 0x8024B578 -> 0x8024B5A8
// this: r1+0x8
void zSparkEmitterAsset::SetDefaults() {
    // References
    // -> static struct zSparkEmitterAsset default_spark_asset;
}

const char * defaultTweakPrefix; // size: 0x4, address: 0x80D65230
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$799zSparkEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$800zSparkEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$801zSparkEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$802zSparkEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$803zSparkEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$804zSparkEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$805zSparkEmitter_cpp */ {
    // Members
...
// Range: 0x8024B6EC -> 0x8024BBB0
// this: r30
void zSparkEmitterAsset::AddTweaks(const char * prefix /* r31 */) {
    // References
    // -> struct tweak_callback cb_tweak_convert_degrees;
}

// Range: 0x8024BBB0 -> 0x8024BDD0
...
// Range: 0x8024BDD0 -> 0x8024BDD4
void zSparkSceneExit() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65234
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$940zSparkEmitter_cpp */ {
    // Members
...
union /* @class$895zSparkEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1096zSparkEmitter_cpp */ {
    // Members
...
class zSparkEmitter : public xBase {
    // Functions
    void Load(struct zSparkEmitterAsset * asset);

    void EmitOnce(const struct xVec3 & pos, const struct xVec3 & dir);

    void EmitOnce(struct xEnt * ent);

    void Update(float dt);

    void Reset();

    void Event(unsigned int toEvent);
...
// Range: 0x8024BDD4 -> 0x8024BF8C
void zSparkEmitter::Load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
static struct tweak_callback tweakCallback; // size: 0x28, address: 0x80523FC8
static signed char init; // size: 0x1, address: 0x80D6B168
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1786zSparkEmitter_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8024BF8C -> 0x8024C170
// this: r31
void zSparkEmitter::Load(struct zSparkEmitterAsset * asset /* r30 */) {
    // Local variables
    float cpitch; // f31
    ...
    // -> const char * defaultTweakPrefix;
}

// Range: 0x8024C170 -> 0x8024C1E4
// this: r31
void zSparkEmitter::EmitOnce(const struct xVec3 & pos /* r1+0x8 */, const struct xVec3 & dir /* r1+0xC */) {
    // Local variables
    unsigned char successfulEmit; // r30
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D65239
// Range: 0x8024C1E4 -> 0x8024C2E4
// this: r31
void zSparkEmitter::EmitOnce(struct xEnt * ent /* r30 */) {
    // Local variables
    struct xVec3 cur_pos; // r1+0x14
    struct xVec3 cur_dir; // r1+0x8
    unsigned char successfulEmit; // r29

    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x8024C2E4 -> 0x8024C5C0
// this: r31
void zSparkEmitter::Update(float dt /* f31 */) {
    // Local variables
    unsigned int sparkTexID; // r27
    unsigned int glintTexID; // r26
    unsigned char successfulEmit; // r30
    struct xVec3 cur_pos; // r1+0x14
    struct xVec3 cur_dir; // r1+0x8
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65242
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8024C5C0 -> 0x8024C9E0
unsigned char zSparkEmitter::EmitSparks(const struct zSparkEmitterAsset & emitData /* r31 */, const struct xVec3 & pos /* r20 */, const struct xVec3 & dir /* r1+0x10 */, float dt /* f25 */, int sparkSystemId /* r19 */, int glintSystemId /* r1+0x14 */, enum iSndGroupHandle sound /* r21 */) {
    // Local variables
    int num_particles; // r29
    struct xVec3 * locList; // r27
    struct xVec3 * dirList; // r26
    float * lenVelList; // r24
    float cosangle; // f30
    ...
    float r; // f28
    float length; // f27
    const struct lightInfo & light; // r30
...
// Range: 0x8024C9E0 -> 0x8024CB24
// this: r31
void zSparkEmitter::Reset() {
    // Local variables
    struct zSparkEmitterAsset * a; // r30
    float cpitch; // f31
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6524D
// Range: 0x8024CB24 -> 0x8024CBE4
void zSparkEmitter::Event(struct xBase * from /* r1+0x8 */, struct xBase * to /* r31 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // References
    // -> static char __FUNCTION__[6];
}

// Range: 0x8024CBE4 -> 0x8024CCE8
// this: r31
void zSparkEmitter::Event(unsigned int toEvent /* r1+0x8 */) {}

// Range: 0x8024CCE8 -> 0x8024CD98
void zSparkEmitter::updateEmitDir(const struct tweak_info & info /* r29 */) {
    // Local variables
    class zSparkEmitter * s; // r30
    struct zSparkEmitterAsset * a; // r31
    float cpitch; // f31
}

// Range: 0x8024CD98 -> 0x8024CE08
void zSparkEmitter::AddTweaks(const struct tweak_info & info /* r30 */) {
    // Local variables
    char prefix[128]; // r1+0x8
    class zSparkEmitter * emitter; // r31
...
static struct tweak_callback cb_update_dir; // size: 0x28, address: 0x80523FF0
// Range: 0x8024CE08 -> 0x8024CF80
// this: r31
void zSparkEmitter::AddTweaks(const char * prefix /* r30 */) {
    // References
    // -> static struct tweak_callback cb_update_dir;
}

enum /* @enum$894zSparkEmitter_cpp */ {
    FLAG_INITIALLY_ON = 1,
    FLAG_USE_LIGHT = 2,
};
