/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zHud.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D40C0 -> 0x802D4498
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802D40C0 -> 0x802D40C4
void hud_system::Startup() {}

// Range: 0x802D40C4 -> 0x802D40C8
void hud_system::Shutdown() {}

// Range: 0x802D40C8 -> 0x802D413C
// this: r31
void hud_system::init() {
    // Local variables
    class hud_element * element; // r30
}

// Range: 0x802D413C -> 0x802D4208
// this: r31
void hud_system::update(float dt /* f31 */) {
    // Local variables
    class hud_element * element; // r30
}
...
// Range: 0x802D4208 -> 0x802D428C
// this: r30
void hud_system::render() {
    // Local variables
    class hud_element * e; // r31

    // References
    // -> struct zGlobals globals;
}

// Range: 0x802D428C -> 0x802D4318
// this: r31
...
// Range: 0x802D4390 -> 0x802D43FC
// this: r30
void hud_system::destroy() {
    // Local variables
    class hud_element * element; // r31
}

static signed char init; // size: 0x1, address: 0x80D6B6B0
static class hud_system _instance; // size: 0xC, address: 0x80D6B6B4
// Range: 0x802D43FC -> 0x802D4438
class hud_system & hud_system::instance() {
    // References
    // -> static class hud_system _instance;
    // -> static signed char init;
}

// total size: 0xC
struct {} zHud::hud_system::__vtable; // size: 0xC, address: 0x80D66A48
// Range: 0x802D4438 -> 0x802D4498
// this: r30
void hud_system::add_tweaks() {
    // Local variables
    class hud_element * element; // r31
}
