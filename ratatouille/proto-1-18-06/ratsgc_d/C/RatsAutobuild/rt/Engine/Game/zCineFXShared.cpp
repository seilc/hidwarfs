/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCineFXShared.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D2D74 -> 0x802D3B00
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x0
struct RpSkin {};
// Range: 0x802D2D74 -> 0x802D2DFC
void zCinFX_clamp_bone_index(int * index /* r31 */, struct RpAtomic * model /* r1+0x8 */) {
    // Local variables
    int bones; // r30
...
// total size: 0x54
struct /* @class$1677zCineFXShared_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$897zCineFXShared_cpp */ {
    // Members
...
union /* @class$609zCineFXShared_cpp */ {
...
// total size: 0xC
struct /* @class$1101zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$838zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$839zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$840zCineFXShared_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$841zCineFXShared_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$842zCineFXShared_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$843zCineFXShared_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$844zCineFXShared_cpp */ {
    // Members
...
// Range: 0x802D2DFC -> 0x802D2F74
void zCinFX_IndexInput_Twk(const char * prefix_root /* r1+0x8 */, struct NCINEntry * fxrec /* r1+0xC */) {
    // Local variables
    char prefix_base[128]; // r1+0x290
    char prefix[128]; // r1+0x210
    struct IndexInput * pi; // r31
...
// Range: 0x802D2F74 -> 0x802D30EC
void zCinFX_BasicInput_Twk(const char * prefix_root /* r1+0x8 */, struct NCINEntry * fxrec /* r1+0xC */) {
    // Local variables
    char prefix_base[128]; // r1+0x290
    char prefix[128]; // r1+0x210
    struct PosInput * pi; // r31
    char _buffer[128]; // r1+0x190
    char _buffer[128]; // r1+0x110
    char _buffer[128]; // r1+0x90
    char _buffer[128]; // r1+0x10
...
// Range: 0x802D30EC -> 0x802D3118
void zCinFX_BoneProbe_Upd(struct NCINEntry * fxrec /* r4 */, int killit /* r5 */) {}
...
// Range: 0x802D3118 -> 0x802D34D0
void zCinFX_BoneProbe_AR(struct NCINEntry * fxrec /* r30 */, struct RpAtomic * model /* r1+0x8 */, struct RwMatrixTag * animMat /* r29 */, unsigned int animIndex /* r1+0xC */) {
    // Local variables
    struct xVec3 pnt1; // r1+0x40
    struct xVec3 pnt2; // r1+0x34
...
// Range: 0x802D34D0 -> 0x802D368C
void zCinFX_BoneProbe_Twk(const char * prefix_root /* r1+0x8 */, struct NCINEntry * fxrec /* r30 */) {
    // Local variables
    char prefix_base[128]; // r1+0x30C
    char prefix[128]; // r1+0x28C
    struct PosInput * pi; // r31
...
// Range: 0x802D368C -> 0x802D3B00
void zCinFX_EntityBonePar_AR(struct NCINEntry * fxrec /* r26 */, struct RpAtomic * model /* r1+0x10 */, struct RwMatrixTag * animMat /* r1+0x14 */, unsigned int animIndex /* r1+0x18 */) {
    // Local variables
    float dt; // f31
    struct xParEmitter * pe; // r31
    struct xParEmitterAsset * a; // r24
    struct xParEmitterPropsAsset * prop; // r30
    struct xParSys * ps; // r28
    struct xParGroup * g; // r23
    int rate_has_elapsed; // r21
    float rate; // f29
    int count; // r25
    float life; // f30
    float size_birth; // f28
    float size_death; // f26
    struct xMat4x3 bone_mat; // r1+0x50
    struct xVec3 oldloc; // r1+0x40
    struct xVec3 loc; // r1+0x34
    struct xVec3 vel; // r1+0x28
    struct xVec3 add_vel; // r1+0x1C
    int i; // r22
    struct xPar * p; // r29
    int c; // r27
    float fc1; // f27
