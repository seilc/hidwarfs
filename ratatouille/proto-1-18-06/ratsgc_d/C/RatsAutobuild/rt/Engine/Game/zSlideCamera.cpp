/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSlideCamera.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B4A64 -> 0x802B4F74
*/
// total size: 0x10
struct /* @class$955zSlideCamera_cpp */ {
    // Members
...
struct zSlideCam : public xCam {
    ...
    void setCurrTgtPos(const struct xVec3 & pos, const struct xVec3 & up);

    void setPrevTgtPos(const struct xVec3 & pos, const struct xVec3 & up);
...
// Range: 0x802B4A64 -> 0x802B4AB8
// this: r31
void zSlideCam::create() {}

// Range: 0x802B4AB8 -> 0x802B4ADC
// this: r3
void zSlideCam::load_cfg() {}

// Range: 0x802B4ADC -> 0x802B4B20
// this: r31
void zSlideCam::start() {}

// Range: 0x802B4B20 -> 0x802B4C60
// this: r30
void zSlideCam::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$768zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zSlideCamera_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zSlideCamera_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zSlideCamera_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zSlideCamera_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zSlideCamera_cpp */ {
    // Members
...
// Range: 0x802B4C60 -> 0x802B4D88
static struct xVec3 SpringDamp(const struct xVec3 & currPos /* r30 */, const struct xVec3 & trgPos /* r31 */, const struct xVec3 & prevTrgPos /* r1+0x8 */, float deltaTime /* f28 */, float springConst /* r1+0xC */, float dampConst /* r1+0x10 */, float springLen /* r1+0x14 */) {
    // Local variables
    struct xVec3 disp; // r1+0x30
    struct xVec3 velocity; // r1+0x24
    float forceMag; // f30
    float len; // f31
    float dot; // f29
    struct xVec3 r; // r1+0x18
}

// Range: 0x802B4D88 -> 0x802B4DD4
// this: r31
void zSlideCam::setCurrTgtPos(const struct xVec3 & pos /* r1+0x8 */, const struct xVec3 & up /* r1+0xC */) {}

// Range: 0x802B4DD4 -> 0x802B4E20
// this: r31
void zSlideCam::setPrevTgtPos(const struct xVec3 & pos /* r1+0x8 */, const struct xVec3 & up /* r1+0xC */) {}

// Range: 0x802B4E20 -> 0x802B4F74
// this: r31
void zSlideCam::update(float dt /* r1+0x8 */) {
    // Local variables
    float len; // f31
    struct xVec3 y_axis; // r1+0x18
}

// total size: 0x4C
struct {} zSlideCam::__vtable; // size: 0x4C, address: 0x805269C8
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$1066zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1204zSlideCamera_cpp */ {
    // Members
...
union /* @class$819zSlideCamera_cpp */ {
...
// total size: 0x10
struct /* @class$832zSlideCamera_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
