/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUIUserString.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801CEA78 -> 0x801CF088
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x2
struct /* @class$1614zUIUserString_cpp */ {
    // Members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63D48
// Range: 0x801CEAE8 -> 0x801CEBDC
// this: r31
void zUIUserString::DoReset() {
    // Local variables
    const char * initialText; // r30

    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63D50
// Range: 0x801CEBDC -> 0x801CEF94
// this: r31
void zUIUserString::DoHandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r25 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r1+0xC */, unsigned int toParamWidgetID /* r26 */) {
    // Local variables
    unsigned int len; // r1+0x10
    const char * asset; // r29
    const char * text; // r28
    char ch; // r27
...
// Range: 0x801CEF94 -> 0x801CEFC0
// this: r1+0x8
unsigned int zUIUserString::GetSortKey() const {}

// Range: 0x801CEFC0 -> 0x801CEFF0
void zUIUserString_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x801CEFF0 -> 0x801CF04C
void zUIUserString_Init(class zUIUserString * userString /* r30 */, struct zUIUserStringAsset * asset /* r1+0x8 */) {}

// total size: 0x64
struct {} zUIUserString::__vtable; // size: 0x64, address: 0x80521F88
