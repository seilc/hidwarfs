/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXRibbonPool.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80169DFC -> 0x8016A1A4
*/
static unsigned int ribbonCount; // size: 0x4, address: 0x80D6A188
static struct xFXRibbon * ribbonPool; // size: 0x4, address: 0x80D6A18C
static unsigned char * ribbonInUse; // size: 0x4, address: 0x80D6A190
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D62BA0
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80169DFC -> 0x80169F10
void zFXRibbonPoolInit(unsigned int maxNumRibbons /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
    struct config_type * cfg; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D62BB2
int __float_max[]; // size: 0x0, address: 0x80D67F90
// Range: 0x80169F10 -> 0x8016A0A0
...
// total size: 0xC
struct /* @class$734zFXRibbonPool_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zFXRibbonPool_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zFXRibbonPool_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zFXRibbonPool_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zFXRibbonPool_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zFXRibbonPool_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zFXRibbonPool_cpp */ {
    // Members
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62BC3
// Range: 0x8016A0A0 -> 0x8016A16C
void zFXRibbonPoolDelete(struct xFXRibbon * & ribbon /* r31 */) {
    // Local variables
    int index; // r30
