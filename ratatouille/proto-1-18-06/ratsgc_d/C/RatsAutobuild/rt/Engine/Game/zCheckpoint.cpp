/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCheckpoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80290F54 -> 0x802917DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int currentActive; // size: 0x4, address: 0x80D6B3C0
unsigned int lastCheckpointNumber; // size: 0x4, address: 0x80D6B3C4
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$865zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$866zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$867zCheckpoint_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$868zCheckpoint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$869zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$870zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$871zCheckpoint_cpp */ {
    // Members
...
static struct tweak_callback tweakOnOffCB; // size: 0x28, address: 0x80525480
static signed char init; // size: 0x1, address: 0x80D6B3C8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$924zCheckpoint_cpp */ {
    // Members
...
union /* @class$759zCheckpoint_cpp */ {
...
// total size: 0xC
struct /* @class$1080zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1898zCheckpoint_cpp */ {
    // Members
...
// Range: 0x80290F54 -> 0x802910A4
void zCheckpoint::SceneInit(struct zScene * scene /* r30 */) {
    // Local variables
    int count; // r27
    class zCheckpoint * checkpointList; // r28
...
// Range: 0x802910A4 -> 0x80291128
void zCheckpoint::SceneReset(struct zScene * scene /* r30 */) {
    // Local variables
    int count; // r28
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65E70
// Range: 0x80291128 -> 0x802912E0
void zCheckpoint::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65E75
// Range: 0x802912E0 -> 0x802914C0
// this: r31
void zCheckpoint::Init(struct zCheckpointAsset * asset /* r30 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1631zCheckpoint_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1874zCheckpoint_cpp */ {
    // Static members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D65E7A
// Range: 0x80291620 -> 0x80291740
void zCheckpoint::EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
...
// Range: 0x80291750 -> 0x802917DC
void zCheckpoint::TweakFinishEditCB() {
    // Local variables
    unsigned int takeDamage; // r31
