/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCAlarmer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803106EC -> 0x80310DC8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$AttachComponent__59zComponentPool<17zCompLogicAlarmer,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D674C8
signed char zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B8D0
// total size: 0xC
...
class zComponentPool zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B8D4
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x8031076C -> 0x80310794
// this: r1+0x8
void zNPCAlarmer::Deactivate() {}

// Range: 0x80310794 -> 0x80310858
// this: r30
...
class zCompLogicAlarmer : public zICompLogic {
    ...
    void ChangeState(enum eAlarmerStates nextState);

    // Members
    enum eAlarmerStates curState; // offset 0x8, size 0x4
};
// Range: 0x80310B30 -> 0x80310B34
void zCompLogicAlarmer::AddStaticTweaks() {}

// Range: 0x80310B34 -> 0x80310B40
// this: r3
void zCompLogicAlarmer::Attached() {}
...
// total size: 0x10
struct /* @class$1653zNPCAlarmer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80310B40 -> 0x80310CB4
// this: r31
void zCompLogicAlarmer::Update() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xVec3 * playerPos; // r28
    const struct xVec3 * myPos; // r27
    float playerDist2; // f31
    float CheckDist; // f30
    unsigned char PlayerInDetection; // r29
...
// total size: 0x4
struct /* @class$966zNPCAlarmer_cpp */ {
    // Members
...
union /* @class$1106zNPCAlarmer_cpp */ {
...
// total size: 0xC
struct /* @class$1104zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$858zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$861zNPCAlarmer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$862zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$863zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$864zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1896zNPCAlarmer_cpp */ {
    // Static members
...
// Range: 0x80310CB4 -> 0x80310DC8
// this: r31
void zCompLogicAlarmer::ChangeState(enum eAlarmerStates nextState /* r29 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
}
...
// total size: 0x3C
struct {} zNPCAlarmer::__vtable; // size: 0x3C, address: 0x8052CE58
