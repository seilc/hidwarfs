/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemWaterfall.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022CB64 -> 0x8022FD84
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zParticleSystemWaterfall : public zParticleSystem {
    // Functions
    struct zParticleGenerator * create_generator(struct zParticleAsset & asset);
...
// Range: 0x8022CB64 -> 0x8022CBD8
// this: r1+0x8
struct zParticleGenerator * zParticleSystemWaterfall::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorWaterfall * gen; // r30
}

// Range: 0x8022CC24 -> 0x8022CC50
// this: r1+0x8
void zParticleSystemWaterfall::scene_enter() {}

// Range: 0x8022CC50 -> 0x8022CC80
// this: r1+0x8
void zParticleSystemWaterfall::update(float dt /* r1+0xC */) {}
...
// Range: 0x8022CC80 -> 0x8022CC88
int zParticleSystemWaterfall::get_asset_size() {}
...
// total size: 0x10
struct /* @class$840zParticleSystemWaterfall_cpp */ {
    // Members
...
// Range: 0x8022CC88 -> 0x8022CE9C
int zParticleSystemWaterfall::update_particles(unsigned char * mem /* r24 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r30
    int _fptank_used; // r29
    struct xVec3 * pool_pos; // r28
    struct xColor_tag * pool_color; // r27
    struct xVec2 * pool_size; // r26
    struct particle_instance * p; // r31
    struct particle_instance * end; // r25
    float yupper; // f30
    struct xVec4 v; // r1+0x20
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64D10
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// total size: 0xCC
struct zParticleGeneratorWaterfall : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemWaterfall & system, struct zParticleAsset & asset);
    ...
    unsigned char cullUpdate();

    void add_tweaks(const char * prefix);

    void debug_render(unsigned char all);

    // Members
protected:
    class zParticleSystemWaterfall * system; // offset 0xA4, size 0x4
    ...
    struct xVec3 vel_dir; // offset 0xC0, size 0xC
};
// total size: 0xC
struct /* @class$1566zParticleSystemWaterfall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// Range: 0x8022CE9C -> 0x8022D344
// this: r29
void zParticleGeneratorWaterfall::update(float dt /* r1+0x8 */) {
    // Local variables
    int emit; // r28
    const struct asset_data & a; // r31
    const struct xMat4x3 & mat; // r26
    struct xVec3 vel_dir; // r1+0x20
    float width_min; // f28
    float width_delta; // f27
    float vel_min; // f26
    float vel_delta; // f25
    float vel_dir_vary; // f24
    float intensity_min; // f30
    float intensity_delta; // f23
    float red; // f22
    float green; // f21
    float blue; // f20
    unsigned char alpha; // r25
    float gravity; // f29
    float ymin; // f19
    float height_start_min; // f18
    float height_start_delta; // r1+0x1C
    float height_vel; // r1+0x18
    float height_accel; // r1+0x14
    float height_max; // r1+0x10
    unsigned char * mem; // r1+0xC
    int have; // r27
    struct particle_instance * p; // r30
    struct particle_instance * endp; // r24
    float intensity; // f31
...
// Range: 0x8022D344 -> 0x8022D4E8
// this: r31
void zParticleGeneratorWaterfall::create(class zParticleSystemWaterfall & system /* r27 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
    const struct asset_data & a; // r29
    float yaw; // f31
    float pitch; // f30
    float sy; // f28
    float cy; // f27
...
// Range: 0x8022D4E8 -> 0x8022D548
// this: r31
void zParticleGeneratorWaterfall::reset() {}

// Range: 0x8022D548 -> 0x8022D588
// this: r31
void zParticleGeneratorWaterfall::activate() {}

// Range: 0x8022D588 -> 0x8022D5C0
// this: r31
void zParticleGeneratorWaterfall::deactivate() {}

// Range: 0x8022D5C0 -> 0x8022D624
// this: r31
unsigned char zParticleGeneratorWaterfall::cullUpdate() {
    // Local variables
...
static struct tweak_callback cb_vel_dir; // size: 0x28, address: 0x804BF9E8
struct tweak_callback cb_tweak_convert_degrees; // size: 0x28, address: 0x80478090
// Range: 0x8022D624 -> 0x8022DA50
// this: r29
void zParticleGeneratorWaterfall::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x10
    struct asset_data & a; // r30

    // References
    // -> static struct tweak_callback cb_vel_dir;
    // -> struct tweak_callback cb_tweak_convert_degrees;
}

enum /* @enum$1565zParticleSystemWaterfall_cpp */ {
    FLAG_TRANSFORM_VELOCITY = 1,
};
struct xColor_tag g_PIMP_GOLD; // size: 0x4, address: 0x80D6C6DC
// Range: 0x8022DA50 -> 0x8022DBDC
// this: r30
void zParticleGeneratorWaterfall::debug_render(unsigned char all /* r28 */) {
    // Local variables
    struct asset_data & a; // r31
    struct xVec3 center; // r1+0x24
    struct xVec3 vel_dir; // r1+0x18
    float cone_ang; // f30
    float cone_radius; // f29
    struct xVec3 center2; // r1+0xC

    // References
    // -> struct xColor_tag g_PIMP_GOLD;
}

// Range: 0x8022DBDC -> 0x8022DCC4
void zParticleGeneratorWaterfall::on_change_vel_dir(const struct tweak_info & info /* r29 */) {
    // Local variables
    struct zParticleGeneratorWaterfall & owner; // r30
    struct asset_data & a; // r31
    float yaw; // f31
    float pitch; // f30
    float sy; // f28
...
static float alpha_coeff1; // size: 0x4, address: 0x80D64D18
static float alpha_coeff2; // size: 0x4, address: 0x80D64D1C
static float alpha_coeff3; // size: 0x4, address: 0x80D64D20
static float fade_in_time; // size: 0x4, address: 0x80D64D24
static float fade_out_time; // size: 0x4, address: 0x80D64D28
// Range: 0x8022DD68 -> 0x8022DE0C
static void on_change_fade(const struct tweak_info & info /* r31 */) {
    // Local variables
...
static struct tweak_callback cb_fade; // size: 0x28, address: 0x804BFA10
// Range: 0x8022DE0C -> 0x8022DF28
static void add_tweaks(const char * prefix /* r31 */) {
    // References
    // -> static struct tweak_callback cb_fade;
    // -> static float fade_out_time;
    // -> static float fade_in_time;
    // -> static float alpha_coeff3;
    // -> static float alpha_coeff2;
...
// Range: 0x8022DF28 -> 0x8022DF9C
// this: r1+0x8
struct zParticleGenerator * zParticleSystemWaterfallMist::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorWaterfallMist * gen; // r30
}

// Range: 0x8022DFD8 -> 0x8022E004
// this: r1+0x8
void zParticleSystemWaterfallMist::scene_enter() {}

// Range: 0x8022E004 -> 0x8022E034
// this: r1+0x8
void zParticleSystemWaterfallMist::update(float dt /* r1+0xC */) {}

// Range: 0x8022E034 -> 0x8022E03C
int zParticleSystemWaterfallMist::get_asset_size() {}

// Range: 0x8022E03C -> 0x8022E064
void zParticleSystemWaterfallMist::add_tweaks(const char * prefix /* r1+0x8 */) {}
...
// Range: 0x8022E064 -> 0x8022E358
int zParticleSystemWaterfallMist::update_particles(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f23 */) {
    // Local variables
    ...
    float a3; // f25
    struct particle_instance * p; // r31
    struct particle_instance * end; // r29
    float t; // f31
    float age; // f30
    struct xVec4 v; // r1+0x20
    struct RwSphere worldsph; // r1+0x10
...
// total size: 0xC0
struct zParticleGeneratorWaterfallMist : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemWaterfallMist & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemWaterfallMist * system; // offset 0xA4, size 0x4
    struct xEnt * attach_to; // offset 0xA8, size 0x4
    float emitted; // offset 0xAC, size 0x4
    class zParticleLocator locator; // offset 0xB0, size 0xC
    int batch_id; // offset 0xBC, size 0x4
...
// Range: 0x8022E358 -> 0x8022E8A8
// this: r29
void zParticleGeneratorWaterfallMist::update(float dt /* r1+0x8 */) {
    // Local variables
    int emit; // r28
    const struct asset_data & a; // r30
    float life_min; // f28
    float life_delta; // r1+0x48
    float size_birth; // r1+0x44
    float size_death; // r1+0x40
    float size_vary; // r1+0x3C
    float intensity_min; // f27
    float intensity_delta; // r1+0x38
    float red; // r1+0x34
    float green; // r1+0x30
    float blue; // r1+0x2C
    unsigned char alpha; // r25
    float rot_vel_min; // f26
    float rot_vel_delta; // r1+0x28
    float vel_min; // f25
    float vel_delta; // r1+0x24
    float vel_pitch_delta; // r1+0x20
    struct xVec3 center; // r1+0x4C
    float cx; // r1+0x1C
    float cz; // r1+0x18
    unsigned char * mem; // r1+0x14
    int have; // r27
    struct particle_instance * p; // r31
    struct particle_instance * endp; // r24
    float life; // r1+0x10
...
// Range: 0x8022E8A8 -> 0x8022E9BC
// this: r31
void zParticleGeneratorWaterfallMist::create(class zParticleSystemWaterfallMist & system /* r28 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x8022E9BC -> 0x8022EA1C
// this: r31
void zParticleGeneratorWaterfallMist::reset() {}

// Range: 0x8022EA1C -> 0x8022EA5C
// this: r31
void zParticleGeneratorWaterfallMist::activate() {}

// Range: 0x8022EA5C -> 0x8022EA94
// this: r31
void zParticleGeneratorWaterfallMist::deactivate() {}

// Range: 0x8022EA94 -> 0x8022EAF8
// this: r31
unsigned char zParticleGeneratorWaterfallMist::cullUpdate() {
    // Local variables
    struct xVec3 center; // r1+0x8
...
// Range: 0x8022EAF8 -> 0x8022EE08
// this: r29
void zParticleGeneratorWaterfallMist::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x10
    struct asset_data & a; // r30
...
// Range: 0x8022EE08 -> 0x8022EE60
// this: r31
void zParticleGeneratorWaterfallMist::debug_render(unsigned char all /* r30 */) {}
...
// Range: 0x8022EE60 -> 0x8022EED4
// this: r1+0x8
struct zParticleGenerator * zParticleSystemWaterfallSplash::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorWaterfallSplash * gen; // r30
}

// Range: 0x8022EF10 -> 0x8022EF3C
// this: r1+0x8
void zParticleSystemWaterfallSplash::scene_enter() {}

// Range: 0x8022EF3C -> 0x8022EF6C
// this: r1+0x8
void zParticleSystemWaterfallSplash::update(float dt /* r1+0xC */) {}

// Range: 0x8022EF6C -> 0x8022EF74
int zParticleSystemWaterfallSplash::get_asset_size() {}
...
// Range: 0x8022EF74 -> 0x8022F1D8
int zParticleSystemWaterfallSplash::update_particles(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r30
    struct particle_instance * p; // r31
    struct particle_instance * end; // r29
...
// total size: 0xC0
struct zParticleGeneratorWaterfallSplash : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemWaterfallSplash & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemWaterfallSplash * system; // offset 0xA4, size 0x4
    struct xEnt * attach_to; // offset 0xA8, size 0x4
    float emitted; // offset 0xAC, size 0x4
    class zParticleLocator locator; // offset 0xB0, size 0xC
    int batch_id; // offset 0xBC, size 0x4
...
// Range: 0x8022F264 -> 0x8022F7A0
// this: r29
void zParticleGeneratorWaterfallSplash::update(float dt /* r1+0x8 */) {
    // Local variables
    int emit; // r28
    const struct asset_data & a; // r30
    const struct xMat4x3 & mat; // r26
    float life_min; // f28
    float life_delta; // f18
    float size_birth; // r1+0x4C
    float size_death; // r1+0x48
    float size_vary; // r1+0x44
    float ay; // r1+0x40
    float ymin; // r1+0x3C
    float intensity_min; // f27
    float intensity_delta; // r1+0x38
    ...
    unsigned char alpha; // r25
    float vel_min; // f26
    float vel_delta; // r1+0x28
    float vel_pitch_min; // r1+0x24
    float vel_pitch_delta; // r1+0x20
    struct xVec3 center; // r1+0x50
    float cx; // r1+0x1C
    float cz; // r1+0x18
    unsigned char * mem; // r1+0x14
    int have; // r27
...
// Range: 0x8022F7A0 -> 0x8022F8B4
// this: r31
void zParticleGeneratorWaterfallSplash::create(class zParticleSystemWaterfallSplash & system /* r28 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x8022F8B4 -> 0x8022F914
// this: r31
void zParticleGeneratorWaterfallSplash::reset() {}

// Range: 0x8022F914 -> 0x8022F954
// this: r31
void zParticleGeneratorWaterfallSplash::activate() {}

// Range: 0x8022F954 -> 0x8022F98C
// this: r31
void zParticleGeneratorWaterfallSplash::deactivate() {}

// Range: 0x8022F98C -> 0x8022F9F0
// this: r31
unsigned char zParticleGeneratorWaterfallSplash::cullUpdate() {
    // Local variables
    struct xVec3 center; // r1+0x8
...
// Range: 0x8022F9F0 -> 0x8022FD2C
// this: r29
void zParticleGeneratorWaterfallSplash::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x10
    struct asset_data & a; // r30
...
// Range: 0x8022FD2C -> 0x8022FD84
// this: r31
void zParticleGeneratorWaterfallSplash::debug_render(unsigned char all /* r30 */) {}

// total size: 0x2C
struct {} zParticleGeneratorWaterfallSplash::__vtable; // size: 0x2C, address: 0x80523A50
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemWaterfall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemWaterfall_cpp */ {
    // Members
...
union /* @class$827zParticleSystemWaterfall_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemWaterfallSplash::__vtable; // size: 0x3C, address: 0x80523A7C
// total size: 0x8
...
// total size: 0x2C
struct {} zParticleGeneratorWaterfallMist::__vtable; // size: 0x2C, address: 0x80523AB8
// total size: 0x3C
struct {} zParticleSystemWaterfallMist::__vtable; // size: 0x3C, address: 0x80523AE4
// total size: 0x2C
struct {} zParticleGeneratorWaterfall::__vtable; // size: 0x2C, address: 0x80523B20
// total size: 0x3C
struct {} zParticleSystemWaterfall::__vtable; // size: 0x3C, address: 0x80523B4C
