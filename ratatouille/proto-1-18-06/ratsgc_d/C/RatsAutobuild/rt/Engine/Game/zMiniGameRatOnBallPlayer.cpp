/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameRatOnBallPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8031C528 -> 0x8031EE38
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80D677C0
static float PLAYER_STICK_VEC; // size: 0x4, address: 0x80D677C4
static float PLAYER_TURBO; // size: 0x4, address: 0x80D677C8
static float PLAYER_TURBO_DECEL; // size: 0x4, address: 0x80D677CC
static float PLAYER_COLLISION; // size: 0x4, address: 0x80D677D0
static float PLAYER_COLLISION_DECEL; // size: 0x4, address: 0x80D677D4
static float PLAYER_TURBO_TIMER; // size: 0x4, address: 0x80D677D8
static float PLAYER_TILT; // size: 0x4, address: 0x80D677DC
static float PLAYER_FADE_PERCENT; // size: 0x4, address: 0x80D677E0
static unsigned char showVelocity; // size: 0x1, address: 0x80D677E4
static unsigned char showStickVec; // size: 0x1, address: 0x80D6B988
static unsigned char showTurboVec; // size: 0x1, address: 0x80D6B989
static unsigned char showCollisionVec; // size: 0x1, address: 0x80D677E5
static unsigned char showArenaTiltVec; // size: 0x1, address: 0x80D6B98A
static struct compositeEffect rumbleEffects[3]; // size: 0xF0, address: 0x80D33D50
// total size: 0x40
class zRatOnBallForces {
    // Functions
    void SetTurbo(struct xVec3 & vec, struct xVec3 & pos);

    void Dead();

    void Reset(class zMiniGameRatOnBallPlayer * inPlayer);

    void SetArenaTiltVec(struct xVec3 & tilt);

    void SetCollisionVec(struct xVec3 & col);

    void Update(class zMiniGameRatOnBallPlayer * player, struct xMat4x3 * directionMat, float dt);

    void Apply(struct xMat4x3 * applyToMat, float dt);
...
// Range: 0x8031C528 -> 0x8031C5A0
// this: r1+0x8
void zRatOnBallForces::SetTurbo(struct xVec3 & vec /* r1+0xC */, struct xVec3 & pos /* r1+0x10 */) {
    // Local variables
    enum iSndGroupHandle handle; // r31
}

// Range: 0x8031C5A0 -> 0x8031C5D0
// this: r31
void zRatOnBallForces::Dead() {}
...
// Range: 0x8031C5D0 -> 0x8031C664
// this: r31
void zRatOnBallForces::Reset(class zMiniGameRatOnBallPlayer * inPlayer /* r1+0x8 */) {}

// Range: 0x8031C664 -> 0x8031C6AC
// this: r1+0x8
void zRatOnBallForces::SetArenaTiltVec(struct xVec3 & tilt /* r31 */) {
    // References
    // -> static float PLAYER_TILT;
}

// Range: 0x8031C6AC -> 0x8031C72C
// this: r1+0x8
void zRatOnBallForces::SetCollisionVec(struct xVec3 & col /* r31 */) {
    // Local variables
    float len; // f31

    // References
    // -> static float PLAYER_COLLISION;
}

// Range: 0x8031C72C -> 0x8031C994
// this: r31
void zRatOnBallForces::Update(class zMiniGameRatOnBallPlayer * player /* r29 */, struct xMat4x3 * directionMat /* r30 */, float dt /* f27 */) {
    // Local variables
    float accel; // f31
    float colLen; // f28
    float colT; // f29
    ...
    // References
    // -> static float PLAYER_COLLISION_DECEL;
    // -> static float PLAYER_TURBO_DECEL;
    // -> static float PLAYER_STICK_VEC;
}
...
// Range: 0x8031C994 -> 0x8031C9C8
// this: r3
void zRatOnBallForces::Apply(struct xMat4x3 * applyToMat /* r4 */, float dt /* f1 */) {}
...
// total size: 0xC
struct /* @class$1870zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
class zMiniGameRatOnBallPlayer : public zMiniGamePlayer {
    ...
    void UpdateUIMarker(unsigned char onff);

    void UpdateUI();

    void StartUIMarker();

    void UpdateRespawningPause(float dt);

    void UpdateMarkerTimer(float dt);
    ...
    void SceneSetupUI(const char * prefix);

    void DisplayWinnerIcon(unsigned char visible);

    void SceneSetupBall(int idx);

    void SceneSetupParticles(int idx);

    void Reset();

    void Exit();

    void Depenetrate(class zMiniGameRatOnBallPlayer * awayFrom);

    void ApplyPickup(int applyPickup, float activeTime);
...
// Range: 0x8031C9C8 -> 0x8031CAD8
void zMiniGameRatOnBallPlayer::SetupRumbles() {
    // References
    // -> static struct compositeEffect rumbleEffects[3];
}

// Range: 0x8031CAD8 -> 0x8031CB38
// this: r3
void zMiniGameRatOnBallPlayer::DebugHacks() {}

// Range: 0x8031CB38 -> 0x8031CBB4
// this: r31
void zMiniGameRatOnBallPlayer::Rumble(unsigned int rumbleType /* r1+0x8 */) {
    // References
    // -> static struct compositeEffect rumbleEffects[3];
}
...
// total size: 0x4
struct /* @class$901zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
union /* @class$1040zMiniGameRatOnBallPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1039zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1823zMiniGameRatOnBallPlayer_cpp */ {
    // Static members
...
// total size: 0x10
struct /* @class$1326zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8031CBB4 -> 0x8031CCE4
// this: r31
void zMiniGameRatOnBallPlayer::Init(struct xEntAsset * asset /* r1+0x8 */) {
    // Local variables
    int lastUsedPad; // r30
...
// Range: 0x8031CCE4 -> 0x8031CDC4
// this: r31
void zMiniGameRatOnBallPlayer::BeginUpdate(float dt /* f31 */) {
    // Local variables
    struct zEnt * ent; // r30
...
// Range: 0x8031CDC4 -> 0x8031CEAC
// this: r31
void zMiniGameRatOnBallPlayer::UpdateOrientation(float dt /* r1+0x8 */) {
    // Local variables
...
// Range: 0x8031CEAC -> 0x8031CFD0
// this: r31
void zMiniGameRatOnBallPlayer::UpdateTurbo(float dt /* f30 */) {
    // Local variables
    class zPad * pad; // r30
    struct xVec3 turboVec; // r1+0x14
    float len2; // f31

    // References
    // -> struct xVec3 g_O3;
    // -> static float PLAYER_TURBO;
}

// Range: 0x8031CFD0 -> 0x8031D080
// this: r31
void zMiniGameRatOnBallPlayer::UseTurbo() {
    // Local variables
    struct xVec3 turboVec; // r1+0x8

    // References
    // -> static float PLAYER_TURBO;
    // -> static float PLAYER_TURBO_TIMER;
}

// Range: 0x8031D080 -> 0x8031D184
// this: r31
void zMiniGameRatOnBallPlayer::UseAITurbo() {
    // Local variables
    struct xVec3 turboVec; // r1+0x14
    struct xVec3 turboVec; // r1+0x8
...
// Range: 0x8031D184 -> 0x8031D288
// this: r31
void zMiniGameRatOnBallPlayer::UpdateUIMarker(unsigned char onff /* r1+0x8 */) {
    // Local variables
    struct xVec3 worldPos; // r1+0x18
    struct xVec3 screenPos; // r1+0xC
...
// Range: 0x8031D288 -> 0x8031D484
// this: r31
void zMiniGameRatOnBallPlayer::UpdateUI() {
    // Local variables
    int i; // r28
    int i; // r29
    int active; // r27
...
// Range: 0x8031D484 -> 0x8031D488
void zMiniGameRatOnBallPlayer::UpdateDead() {}

// Range: 0x8031D488 -> 0x8031D4CC
// this: r31
void zMiniGameRatOnBallPlayer::StartUIMarker() {}

// Range: 0x8031D4CC -> 0x8031D5EC
// this: r31
void zMiniGameRatOnBallPlayer::UpdateRespawningPause(float dt /* f31 */) {
    // Local variables
    enum iSndGroupHandle soundGroupHandle; // r30

    // References
    // -> static float PLAYER_FADE_PERCENT;
}

// Range: 0x8031D5EC -> 0x8031D678
// this: r31
void zMiniGameRatOnBallPlayer::UpdateMarkerTimer(float dt /* r1+0x8 */) {}

// Range: 0x8031D678 -> 0x8031D88C
// this: r31
void zMiniGameRatOnBallPlayer::UpdateActive(float dt /* f31 */) {
    // Local variables
    float arenaRadius; // f30
    struct xVec3 vecToUs; // r1+0x8
    enum iSndGroupHandle soundGroupHandle; // r30
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D677E6
// Range: 0x8031D88C -> 0x8031DA84
// this: r31
void zMiniGameRatOnBallPlayer::Update(float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[7];
    // -> struct zGlobals globals;
}

// Range: 0x8031DA84 -> 0x8031DADC
// this: r1+0x8
void zMiniGameRatOnBallPlayer::EndUpdate(float dt /* r1+0xC */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8031DADC -> 0x8031DD34
// this: r31
void zMiniGameRatOnBallPlayer::Render() {
    // Local variables
    float scale; // f31
...
// Range: 0x8031DD34 -> 0x8031DD74
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetup() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D677ED
// Range: 0x8031DD74 -> 0x8031DE54
class zUIImage * zMiniGameRatOnBallPlayer::FindUIObject(const char * prefix /* r29 */, const char * desc /* r30 */) {
    // Local variables
    char txt[256]; // r1+0x8
    class zUIImage * img; // r31

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x8031DE54 -> 0x8031E008
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetupUI(const char * prefix /* r30 */) {}

// Range: 0x8031E008 -> 0x8031E068
// this: r31
void zMiniGameRatOnBallPlayer::DisplayWinnerIcon(unsigned char visible /* r1+0x8 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D677FA
// Range: 0x8031E068 -> 0x8031E254
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetupBall(int idx /* r27 */) {
    // Local variables
    char * ballModelName[4]; // r1+0x8
    unsigned int modelID; // r30
    struct RpAtomic * imodel; // r29

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67809
// Range: 0x8031E254 -> 0x8031E3C0
// this: r26
void zMiniGameRatOnBallPlayer::SceneSetupParticles(int idx /* r28 */) {
    // Local variables
    char * pGenName[4]; // r1+0x1C
    char * entName[4]; // r1+0xC
    unsigned int pGenID; // r27
    struct xBase * ent; // r31
    unsigned int entID; // r1+0x8

    // References
    // -> static char __FUNCTION__[20];
}

// Range: 0x8031E3C0 -> 0x8031E464
// this: r31
void zMiniGameRatOnBallPlayer::Reset() {}

// Range: 0x8031E464 -> 0x8031E48C
// this: r1+0x8
void zMiniGameRatOnBallPlayer::Exit() {}

// Range: 0x8031E48C -> 0x8031E5C8
// this: r29
void zMiniGameRatOnBallPlayer::Depenetrate(class zMiniGameRatOnBallPlayer * awayFrom /* r30 */) {
    // Local variables
    struct xVec3 betweenVec; // r1+0x14
    struct xVec3 betweenPos; // r1+0x8
    struct xVec3 * pushPos; // r31
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6781D
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x8031E5C8 -> 0x8031E90C
// this: r31
void zMiniGameRatOnBallPlayer::ApplyPickup(int applyPickup /* r28 */, float activeTime /* f31 */) {
    // Local variables
    int i; // r30
    class zMiniGameRatOnBallPlayer * otherPlayer; // r29
...
// Range: 0x8031E90C -> 0x8031E978
void zMiniGameRatOnBallPlayer::AddStates(struct xAnimTable * table /* r1+0x18 */) {}

// Range: 0x8031E978 -> 0x8031EA7C
void zMiniGameRatOnBallPlayer::SetupTweaks() {
    // Local variables
    char prefix[128]; // r1+0x8

    // References
    // -> static float PLAYER_FADE_PERCENT;
    // -> static unsigned char showArenaTiltVec;
    // -> static unsigned char showCollisionVec;
    // -> static unsigned char showTurboVec;
    // -> static unsigned char showStickVec;
    // -> static unsigned char showVelocity;
}

// total size: 0x18
class zMiniGameRatOnBallAI {
    // Functions
    void Init(class zMiniGameRatOnBallPlayer * inPlayer);
...
// Range: 0x8031EA7C -> 0x8031EA94
// this: r3
void zMiniGameRatOnBallAI::Init(class zMiniGameRatOnBallPlayer * inPlayer /* r4 */) {}

// Range: 0x8031EA94 -> 0x8031EB20
// this: r31
void zMiniGameRatOnBallAI::Reset() {}

// Range: 0x8031EB20 -> 0x8031EBF0
// this: r31
void zMiniGameRatOnBallAI::ReevaluateTarget() {
    // Local variables
    class zMiniGameRatOnBallPlayer * tlist[4]; // r1+0x8
    int total; // r30
    int i; // r29
    class zMiniGameRatOnBallPlayer * testTarget; // r28
    int idx; // r27
...
// Range: 0x8031EBF0 -> 0x8031EE38
// this: r31
void zMiniGameRatOnBallAI::Update(float dt /* f25 */) {
    // Local variables
    struct xVec3 targetPos; // r1+0x14
    float arenaRadius; // f29
    float arenaBufferRadius; // f28
    float distFromCenter; // f31
    float innerArena; // f30
    struct xVec3 toTargetVec; // r1+0x8
    float distToTarget; // f27
    float angleDiff; // f26
...
// total size: 0x13C
struct {} zMiniGameRatOnBallPlayer::__vtable; // size: 0x13C, address: 0x8052D3A0
// total size: 0x50
