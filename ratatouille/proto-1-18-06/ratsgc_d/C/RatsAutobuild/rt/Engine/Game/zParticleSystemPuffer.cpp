/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemPuffer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E3D78 -> 0x802E4E80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x24
class zParticleSystemPuffer : public zParticleSystem {
    // Functions
...
// Range: 0x802E3D78 -> 0x802E3DEC
// this: r1+0x8
struct zParticleGenerator * zParticleSystemPuffer::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorPuffer * gen; // r30
}

// Range: 0x802E3E28 -> 0x802E3E54
// this: r1+0x8
void zParticleSystemPuffer::scene_enter() {}

// Range: 0x802E3E54 -> 0x802E3E84
// this: r1+0x8
void zParticleSystemPuffer::update(float dt /* r1+0xC */) {}
...
// Range: 0x802E3E84 -> 0x802E3E8C
int zParticleSystemPuffer::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66CF8
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$840zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1756zParticleSystemPuffer_cpp */ {
    // Members
    unsigned int shrapID; // offset 0x0, size 0x4
    int numShrap; // offset 0x4, size 0x4
    float initDownVel; // offset 0x8, size 0x4
    float randVel; // offset 0xC, size 0x4
};
// total size: 0x3C
struct asset_data {
    // Members
    float minTimeOn; // offset 0x0, size 0x4
    float maxTimeOn; // offset 0x4, size 0x4
    float minTimeOff; // offset 0x8, size 0x4
    float maxTimeOff; // offset 0xC, size 0x4
    float gravity; // offset 0x10, size 0x4
    float drift; // offset 0x14, size 0x4
    float size; // offset 0x18, size 0x4
    float rotSpeed; // offset 0x1C, size 0x4
    float lifetime; // offset 0x20, size 0x4
    float birthAlpha; // offset 0x24, size 0x4
    float deathAlpha; // offset 0x28, size 0x4
    // total size: 0x10
    struct /* @class$1756zParticleSystemPuffer_cpp */ {
        // Members
        unsigned int shrapID; // offset 0x0, size 0x4
...
// Range: 0x802E3E8C -> 0x802E4330
int zParticleSystemPuffer::update_particles(unsigned char * mem /* r19 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */, void * context /* r20 */) {
    // Local variables
    ...
    struct zParticleGeneratorPuffer & g; // r21
    struct asset_data & a; // r29
    float size; // f28
    float lifetime; // f30
    float birthAlpha; // r1+0x1C
    float deathAlpha; // f31
    float alphaRange; // f29
    struct RwSphere worldsph; // r1+0x20
    float alpha; // r1+0x18
    float u; // f27
    float v; // f26
    float uOffset; // f25
...
// total size: 0xEC
struct zParticleGeneratorPuffer : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemPuffer & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemPuffer * system; // offset 0xA4, size 0x4
    ...
    float timer; // offset 0xC0, size 0x4
    float nextTimeEvent; // offset 0xC4, size 0x4
    unsigned char isParticlesOn; // offset 0xC8, size 0x1
    struct xVec3 curLoc; // offset 0xCC, size 0xC
    float shrapEmitted; // offset 0xD8, size 0x4
    struct zShrapnelAsset * shrapAsset; // offset 0xDC, size 0x4
    struct xModelInstance * tempModel; // offset 0xE0, size 0x4
    struct debug debugInfo; // offset 0xE4, size 0x8
};
// Range: 0x802E4330 -> 0x802E4680
// this: r31
void zParticleGeneratorPuffer::update(float dt /* f30 */) {
    // Local variables
    const struct asset_data & a; // r30
    unsigned char startEmit; // r25
    int emit; // r28
    float lifetime; // f29
    float drift; // f31
    float rotSpeed; // f28
    ...
    int have; // r27
    struct particle_instance * p; // r29
    struct particle_instance * endp; // r24
    int emit; // r26
    float initX; // f26
    float initZ; // f25
    struct xVec3 initVel; // r1+0xC
}
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66D09
...
// Range: 0x802E4680 -> 0x802E4900
// this: r31
void zParticleGeneratorPuffer::create(class zParticleSystemPuffer & system /* r26 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
...
// Range: 0x802E4900 -> 0x802E4994
// this: r31
void zParticleGeneratorPuffer::reset() {}

// Range: 0x802E4994 -> 0x802E49EC
// this: r31
void zParticleGeneratorPuffer::activate() {}

// Range: 0x802E49EC -> 0x802E4A30
// this: r31
void zParticleGeneratorPuffer::deactivate() {}

// Range: 0x802E4A30 -> 0x802E4A94
// this: r31
unsigned char zParticleGeneratorPuffer::cullUpdate() {
    // Local variables
...
// Range: 0x802E4A94 -> 0x802E4E28
// this: r29
void zParticleGeneratorPuffer::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x10
    struct asset_data & a; // r30
}

// Range: 0x802E4E28 -> 0x802E4E80
// this: r31
void zParticleGeneratorPuffer::debug_render(unsigned char all /* r30 */) {}

// total size: 0x2C
struct {} zParticleGeneratorPuffer::__vtable; // size: 0x2C, address: 0x805294B8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemPuffer_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemPuffer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemPuffer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemPuffer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemPuffer_cpp */ {
    // Members
...
union /* @class$827zParticleSystemPuffer_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemPuffer::__vtable; // size: 0x3C, address: 0x805294E4
// total size: 0x8
