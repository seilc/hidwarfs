/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCThief.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802FF728 -> 0x80301F2C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gThiefEntParameters; // size: 0x30, address: 0x80D2DB90
// total size: 0x70
...
static class zCompSteeringBasicParams gThiefSteeringParams; // size: 0x70, address: 0x80D2DBC0
// total size: 0xC
...
// total size: 0x4
struct /* @class$1032zNPCThief_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1170zNPCThief_cpp */ {
    // Members
...
static class zCompCombatParams gThiefCombatParams; // size: 0x18, address: 0x80D2DC30
// total size: 0x30
struct xMat3x3 {
    // Members
...
static struct xMat3x3 gThiefPickUpObjOrient; // size: 0x30, address: 0x8052A290
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 gThiefPickUpObjOffset; // size: 0xC, address: 0x80D70BE8
static class zCombatAttack sThiefCombatAttack[1]; // size: 0xB4, address: 0x80D2DC48
static struct xHierarchyBoundInitData sThiefCharacterBounds[9]; // size: 0x6C, address: 0x8052A2C0
static int tolga; // size: 0x4, address: 0x80D67240
// total size: 0x68
class zNPCThief : public zNPCBase {
    // Functions
...
// Range: 0x802FF728 -> 0x802FF780
void zNPCThief::AddTweaks(const char * branchString /* r1+0x8 */) {
    // Local variables
...
// Range: 0x802FF780 -> 0x802FF974
void zNPCThief::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x802FF974 -> 0x802FFA5C
void zNPCThief::InitCombatDamage() {
    // References
    // -> static class zCombatAttack sThiefCombatAttack[1];
}

char __FUNCTION__$localstatic1$AttachComponent__57zComponentPool<15zCompLogicThief,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67244
signed char zComponentPool<zCompLogicThief, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B7D0
// total size: 0xC
...
class zComponentPool zComponentPool<zCompLogicThief, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B7D4
char __FUNCTION__$localstatic1$Attach__22zIComponent<8zNPCBase>FP8zNPCBaseP15zCompParameters[7]; // size: 0x7, address: 0x80D67254
char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<15zICompNPCEntity,15zICompNPCEntity,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D6725B
signed char zComponentPool<zICompNPCEntity, zICompNPCEntity, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B7E0
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
class zComponentPool zComponentPool<zICompNPCEntity, zICompNPCEntity, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B7E4
char __FUNCTION__$localstatic1$AttachComponent__63zComponentPool<18zCompSteeringBasic,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D6726B
signed char zComponentPool<zCompSteeringBasic, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B7F0
// total size: 0x0
class zNPCWalls {};
// total size: 0x4
struct xColor_tag {
...
class zComponentPool zComponentPool<zCompSteeringBasic, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B7F4
char __FUNCTION__$localstatic1$AttachComponent__54zComponentPool<11zCompCombat,12zICompCombat,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D6727B
signed char zComponentPool<zCompCombat, zICompCombat, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B800
// total size: 0x14
...
class zComponentPool zComponentPool<zCompCombat, zICompCombat, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B804
// Range: 0x802FFA5C -> 0x802FFB78
// this: r31
unsigned char zNPCThief::Activate() {
    // References
    // -> static class zCompCombatParams gThiefCombatParams;
    // -> static class zICompNPCEntityParams gThiefEntParameters;
    // -> static class zCombatAttack sThiefCombatAttack[1];
    // -> static struct xHierarchyBoundInitData sThiefCharacterBounds[9];
}
...
// Range: 0x802FFB78 -> 0x802FFBA0
// this: r1+0x8
void zNPCThief::Deactivate() {}

// Range: 0x802FFBA0 -> 0x802FFC28
// this: r29
void zNPCThief::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
    class zICompLogic * logicComponent; // r31
}
...
// Range: 0x802FFC28 -> 0x802FFC74
// this: r30
void zNPCThief::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

static struct zCompStateMachineTable gThiefStateMachineTable[9]; // size: 0x48, address: 0x8052A32C
// total size: 0x60
class zCompLogicThief : public zCompStateMachine {
    ...
    void StopNPC(float StopForceMag, float dt);
...
// Range: 0x802FFC74 -> 0x802FFCA8
void zCompLogicThief::AddStaticTweaks() {
    // References
    // -> static class zCompSteeringBasicParams gThiefSteeringParams;
}

// Range: 0x802FFCA8 -> 0x802FFCAC
void zCompLogicThief::SetupStateTranstitionTests() {}

// Range: 0x802FFCAC -> 0x802FFCB4
int zCompLogicThief::GetInitialStateEnum() {}

// Range: 0x802FFCB4 -> 0x802FFCC0
struct zCompStateMachineTable * zCompLogicThief::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gThiefStateMachineTable[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D6728B
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1719zNPCThief_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x80
struct zNPCAssetThief : public zNPCAssetRATS {
    // Members
    unsigned int firstMovePoint; // offset 0x74, size 0x4
    unsigned int attractor; // offset 0x78, size 0x4
    unsigned int hideCirclesGroup; // offset 0x7C, size 0x4
};
// Range: 0x802FFCC0 -> 0x802FFD9C
// this: r31
void zCompLogicThief::Attached() {
    // Local variables
    class zNPCThief * npcThief; // r29
    struct zNPCAssetThief * npcassThief; // r30
...
// Range: 0x802FFD9C -> 0x802FFE0C
// this: r30
void zCompLogicThief::Detached() {
    // Local variables
    class zCompLogicThief * compLogic; // r31
}
...
// Range: 0x802FFE0C -> 0x802FFE5C
// this: r31
void zCompLogicThief::AllAttached() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
}
...
// total size: 0x1
struct /* @class$861zNPCThief_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$862zNPCThief_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$863zNPCThief_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$864zNPCThief_cpp */ {
    // Members
...
// Range: 0x802FFE5C -> 0x802FFEA4
// this: r30
void zCompLogicThief::NPCGetsDamage() {
    // Local variables
    class zThiefRunAway * runAwayState; // r31
}

// total size: 0x38
class zThiefRunAway : public zCompState {
    // Functions
    zThiefRunAway();

    void Update(class zNPCBase * owner, float dt);

    void Enter(class zNPCBase * owner);

    void Resume(class zNPCBase * owner);

    void UpdateHideBehavior(class zNPCBase * owner);

    void UpdateHidePoint(class zNPCBase * owner);

    void DebugRender(class zNPCBase * owner);

    // Members
    float initialObjYaw; // offset 0x14, size 0x4
    float initialNPCYaw; // offset 0x18, size 0x4
    struct xGroup * hideCirclesGroup; // offset 0x1C, size 0x4
    struct xVec3 currentHidePoint; // offset 0x20, size 0xC
    float hideUpdateTimer; // offset 0x2C, size 0x4
    float burstTimer; // offset 0x30, size 0x4
    unsigned char hidingPointActive; // offset 0x34, size 0x1
    unsigned char playerTagSuccessful; // offset 0x35, size 0x1
};
// Range: 0x802FFEA4 -> 0x802FFEEC
// this: r30
void zCompLogicThief::NPCGivesDamage() {
    // Local variables
    class zThiefTagPlayer * tagPlayerState; // r31
}

// total size: 0x18
class zThiefTagPlayer : public zCompState {
    // Functions
    void Enter(class zNPCBase * owner);
    ...
    // Members
    unsigned char tagSuccessful; // offset 0x14, size 0x1
};
struct xVec3 m_Null; // size: 0xC, address: 0x80D6D920
// Range: 0x802FFEEC -> 0x80300024
// this: r31
void zCompLogicThief::StopNPC(float StopForceMag /* r1+0x8 */, float dt /* f29 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    struct xEntFrame * entFrame; // r28
    struct xVec3 * entVel; // r27
    struct xVec3 * entOldVel; // r30
    float oldSpeed; // f31
    float accMag; // f30
    struct xVec3 VelocityDir; // r1+0x18
    struct xVec3 dAcc; // r1+0xC
...
// total size: 0x2C
struct {} zThiefPatrol::__vtable; // size: 0x2C, address: 0x8052A4C0
// total size: 0x28
...
// total size: 0x18
class zThiefPatrol : public zCompState {
    // Functions
    zThiefPatrol();

    void Update(class zNPCBase * owner, float dt);

    void CheckTranstitions(class zNPCBase * owner);
    ...
    // Members
    struct xMovePoint * curPatrolPoint; // offset 0x14, size 0x4
};
// Range: 0x80300024 -> 0x80300068
// this: r31
zThiefPatrol::zThiefPatrol() {
    // References
    // -> struct [anonymous] zThiefPatrol::__vtable;
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6B810
static signed char init; // size: 0x1, address: 0x80D6B811
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67294
// Range: 0x80300068 -> 0x80300234
// this: r31
void zThiefPatrol::Update(class zNPCBase * owner /* r28 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r29
    class zICompNPCEntity * compNPCEntity; // r30
    const struct xVec3 * curPos; // r27
    float mpArriveDistance; // f31
    struct xMovePoint * nextPatrolPoint; // r1+0xC
...
// total size: 0x4
struct /* @class$2138zNPCThief_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2139zNPCThief_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2140zNPCThief_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2137zNPCThief_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2142zNPCThief_cpp */ {
    // Members
...
// Range: 0x80300234 -> 0x803002F8
// this: r27
void zThiefPatrol::CheckTranstitions(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r31
    struct zCommonPlayer * player; // r30
    class zICompNPCEntity * compNPCEntity; // r1+0x8
    struct xVec3 * playerPos; // r29
...
// total size: 0x890
struct /* @class$1962zNPCThief_cpp */ {
    // Static members
...
// Range: 0x803002F8 -> 0x80300354
// this: r30
void zThiefPatrol::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    const struct xVec3 * curPos; // r1+0xC
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6729B
// Range: 0x80300354 -> 0x80300444
// this: r30
void zThiefPatrol::Enter(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zNPCThief * npcThief; // r29
    struct zNPCAssetThief * npcassThief; // r31
...
// Range: 0x80300444 -> 0x80300584
// this: r30
void zThiefPatrol::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    class zICompSteering * compSteering; // r31
...
// total size: 0x2C
struct {} zThiefAlert::__vtable; // size: 0x2C, address: 0x8052A494
// total size: 0x14
class zThiefAlert : public zCompState {
    // Functions
    zThiefAlert();
...
// Range: 0x80300584 -> 0x803005C0
// this: r31
zThiefAlert::zThiefAlert() {
    // References
    // -> struct [anonymous] zThiefAlert::__vtable;
}

// Range: 0x803005C0 -> 0x8030065C
// this: r1+0x8
void zThiefAlert::Update(class zNPCBase * owner /* r31 */, float dt /* r1+0xC */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    class zCompLogicThief * compLogic; // r1+0x10
}

// Range: 0x8030065C -> 0x803006AC
// this: r1+0x8
void zThiefAlert::CheckTranstitions(class zNPCBase * owner /* r1+0xC */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// Range: 0x803006AC -> 0x803007E0
void zThiefAlert::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r31
    class zICompNPCEntity * compNPCEntity; // r30
    class zICompSteering * compSteering; // r29
...
// total size: 0x2C
struct {} zThiefChase::__vtable; // size: 0x2C, address: 0x8052A468
// total size: 0x14
class zThiefChase : public zCompState {
    // Functions
    zThiefChase();
...
// Range: 0x803007E0 -> 0x8030081C
// this: r31
zThiefChase::zThiefChase() {
    // References
    // -> struct [anonymous] zThiefChase::__vtable;
}

// Range: 0x8030081C -> 0x803008AC
// this: r1+0x8
void zThiefChase::Update(class zNPCBase * owner /* r29 */, float dt /* r1+0xC */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r30
}

// Range: 0x803008AC -> 0x80300958
// this: r25
void zThiefChase::CheckTranstitions(class zNPCBase * owner /* r26 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicThief * compLogic; // r31
    struct xVec3 * carryPos; // r28
    struct xVec3 * NPCPos; // r27
...
// Range: 0x80300958 -> 0x80300994
// this: r1+0x8
void zThiefChase::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80300994 -> 0x80300ACC
void zThiefChase::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zICompSteering * compSteering; // r31
    class zCompLogicThief * compLogic; // r29

    // References
    // -> static class zCompSteeringBasicParams gThiefSteeringParams;
}

// Range: 0x80300ACC -> 0x80300B08
// this: r1+0x8
void zThiefTagPlayer::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80300B08 -> 0x80300B0C
void zThiefTagPlayer::Exit() {}

// Range: 0x80300B0C -> 0x80300C38
// this: r27
void zThiefTagPlayer::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zICompSteering * compSteering; // r31
    class zCompLogicThief * compLogic; // r29
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D672A1
// Range: 0x80300C38 -> 0x80300DF4
// this: r29
void zThiefTagPlayer::Update(class zNPCBase * owner /* r30 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r28
    class zICompNPCEntity * compNPCEntity; // r31
    class zCompStateMachine * stateMachine; // r1+0xC
    struct zCommonPlayer * player; // r27
    class zCompLogicThief * compLogic; // r26
...
// total size: 0x2C
struct {} zThiefPickUp::__vtable; // size: 0x2C, address: 0x8052A410
// total size: 0x34
class zThiefPickUp : public zCompState {
    // Functions
    zThiefPickUp();

    void Update(class zNPCBase * owner, float dt);

    unsigned char PickUpObj(class zNPCBase * owner, float dt);

    void Resume(class zNPCBase * owner);

    // Members
    unsigned char readyToPickupObj; // offset 0x14, size 0x1
    struct xVec3 initialObjEuler; // offset 0x18, size 0xC
    struct xVec3 initialObjPos; // offset 0x24, size 0xC
    float interpolationTime; // offset 0x30, size 0x4
};
// Range: 0x80300DF4 -> 0x80300E30
// this: r31
zThiefPickUp::zThiefPickUp() {
    // References
    // -> struct [anonymous] zThiefPickUp::__vtable;
}

// Range: 0x80300E30 -> 0x80300EC0
// this: r31
void zThiefPickUp::Update(class zNPCBase * owner /* r30 */, float dt /* f31 */) {}

// Range: 0x80300EC0 -> 0x80301058
// this: r31
unsigned char zThiefPickUp::PickUpObj(class zNPCBase * owner /* r25 */, float dt /* r1+0x8 */) {
    // Local variables
    unsigned char pickedUp; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    class zCompLogicThief * compLogic; // r28
    const struct xMat4x3 * npcMat; // r26
    struct xMat4x3 * objMat; // r27
    struct xVec3 curObjEuler; // r1+0x3C
    struct xVec3 curObjPos; // r1+0x30
    struct xVec3 destObjEuler; // r1+0x24
    struct xVec3 destObjPos; // r1+0x18
    struct xVec3 worldPickUpOffset; // r1+0xC
    float interpPercent; // f31

    // References
    // -> static struct xVec3 gThiefPickUpObjOffset;
}
...
// Range: 0x80301058 -> 0x80301238
unsigned char zThiefPickUp::MoveThiefForPickup(class zNPCBase * owner /* r24 */, float dt /* f30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    class zCompLogicThief * compLogic; // r30
    struct xVec3 * objPos; // r29
    const struct xVec3 * npcPos; // r28
    struct xVec3 objDir; // r1+0x8
    unsigned char aligned; // r25
    unsigned char inDistance; // r27
    float objDistance; // f31
    float distWithChaseSpeed; // f29
    float distWithChaseSpeed; // f28

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80301238 -> 0x803012EC
// this: r30
void zThiefPickUp::Resume(class zNPCBase * owner /* r26 */) {
    // Local variables
...
// total size: 0x2C
struct {} zThiefRunAway::__vtable; // size: 0x2C, address: 0x8052A3E4
// Range: 0x803012EC -> 0x80301330
// this: r31
zThiefRunAway::zThiefRunAway() {
    // References
    // -> struct [anonymous] zThiefRunAway::__vtable;
}

// Range: 0x80301330 -> 0x803014C8
// this: r31
void zThiefRunAway::Update(class zNPCBase * owner /* r27 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r26
    class zICompNPCEntity * compNPCEntity; // r29
    class zCompLogicThief * compLogic; // r25
    const struct xMat4x3 * npcMat; // r30
    struct xMat4x3 * objMat; // r28
    struct xVec3 worldPickUpOffset; // r1+0x14
    float curNPCYaw; // f30
    float yawDiff; // f29
    struct xVec3 curObjEuler; // r1+0x8
...
// Range: 0x803014C8 -> 0x80301504
// this: r1+0x8
void zThiefRunAway::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80301504 -> 0x803016D8
// this: r31
void zThiefRunAway::Resume(class zNPCBase * owner /* r26 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r28
    class zICompSteering * compSteering; // r27
    class zCompLogicThief * compLogic; // r25
    struct xMat4x3 * objMat; // r30
    const struct xMat4x3 * npcMat; // r29
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052A374
// Range: 0x803016D8 -> 0x803018D0
struct xGroup * zThiefRunAway::FindHideCirclesGroup(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zNPCThief * npcThief; // r31
    struct zNPCAssetThief * npcassThief; // r26
    unsigned int groupAssetId; // r25
    struct xGroup * hideCirclesGroup; // r30
    struct xBase * b; // r29
    unsigned int numberOfHidingCircles; // r23
    unsigned char validGroup; // r24
    unsigned int i; // r28
    struct xBase * b; // r27
...
// Range: 0x803018D0 -> 0x803019CC
// this: r31
void zThiefRunAway::UpdateHideBehavior(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    struct xVec3 * playerPos; // r27
    struct xVec3 * NPCPos; // r26

    // References
    // -> struct xGlobals * xglobals;
}

int __float_max[]; // size: 0x0, address: 0x80D67F90
// Range: 0x803019CC -> 0x80301B28
// this: r31
void zThiefRunAway::UpdateHidePoint(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r28
    struct xVec3 * playerPos; // r27
    struct xVec3 * NPCPos; // r25
    float closestHidingPointDistance2; // f31
    unsigned int numberOfHidingCircles; // r24
    unsigned int i; // r30
    struct xMovePoint * mp; // r29
    struct xVec3 * circleCenter; // r26
    float circleRadius; // f29
    struct xVec3 circleHidePos; // r1+0xC
    float npcDistance2; // f30
...
// Range: 0x80301B28 -> 0x80301B78
// this: r30
void zThiefRunAway::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    const struct xVec3 * curPos; // r1+0xC
}
...
// total size: 0x2C
struct {} zThiefDrop::__vtable; // size: 0x2C, address: 0x8052A3B8
// total size: 0x18
class zThiefDrop : public zCompState {
    // Functions
    zThiefDrop();
    ...
    // Members
    float stateTime; // offset 0x14, size 0x4
};
// Range: 0x80301B78 -> 0x80301BB4
// this: r31
zThiefDrop::zThiefDrop() {
    // References
    // -> struct [anonymous] zThiefDrop::__vtable;
}

// Range: 0x80301BB4 -> 0x80301C78
// this: r31
void zThiefDrop::Update(class zNPCBase * owner /* r28 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r29
}

// Range: 0x80301C78 -> 0x80301CB4
// this: r1+0x8
void zThiefDrop::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80301CB4 -> 0x80301E34
// this: r27
void zThiefDrop::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    class zICompSteering * compSteering; // r30
    class zCompLogicThief * compLogic; // r31
...
// total size: 0x18
class zThiefConfused : public zCompState {
    // Functions
    void Resume(class zNPCBase * owner);
...
// Range: 0x80301E34 -> 0x80301E9C
// this: r30
void zThiefConfused::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}

// Range: 0x80301E9C -> 0x80301F2C
// this: r31
void zThiefConfused::Update(class zNPCBase * owner /* r1+0x8 */, float dt /* f31 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r30
}

// total size: 0x2C
struct {} zThiefConfused::__vtable; // size: 0x2C, address: 0x8052A38C
// total size: 0x2C
struct {} zThiefTagPlayer::__vtable; // size: 0x2C, address: 0x8052A43C
// total size: 0x50
struct {} zCompLogicThief::__vtable; // size: 0x50, address: 0x8052A4EC
// total size: 0x3C
struct {} zNPCThief::__vtable; // size: 0x3C, address: 0x8052A53C
// total size: 0xC
struct {} zCompCombatParams::__vtable; // size: 0xC, address: 0x80D672B4
// total size: 0xC
struct {} zICompNPCEntityParams::__vtable; // size: 0xC, address: 0x80D672A8
