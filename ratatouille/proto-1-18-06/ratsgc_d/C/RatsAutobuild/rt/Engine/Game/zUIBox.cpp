/*
    ...
    Language: C++
    Code range: 0x801C8488 -> 0x801C9F0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x1
struct /* @class$780zUIBox_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$781zUIBox_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$782zUIBox_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$783zUIBox_cpp */ {
    // Members
...
// Range: 0x801C8488 -> 0x801C84C0
static void OnUpdateTexture(const struct tweak_info & info /* r30 */) {
    // Local variables
    class zUIBox * ui; // r31
}
...
static struct tweak_callback textureCB; // size: 0x28, address: 0x80521D50
static signed char init; // size: 0x1, address: 0x80D6AA50
...
// Range: 0x801C8884 -> 0x801C88B8
// this: r31
void zUIBox::DoReset() {}

// Range: 0x801C88B8 -> 0x801C88EC
// this: r31
void zUIBox::DoResetMotion() {}

// Range: 0x801C88EC -> 0x801C8A28
// this: r28
void zUIBox::DoHandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r24 */, const float * toParam /* r31 */, struct xBase * toParamWidget /* r25 */, unsigned int toParamWidgetID /* r26 */) {
    // Local variables
...
// Range: 0x801C8A28 -> 0x801C8A68
// this: r30
void zUIBox::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r31 */) {}

// Range: 0x801C8A68 -> 0x801C8F3C
// this: r30
void zUIBox::DoRender() const {
    // Local variables
    const struct zUIBoxAsset * asset; // r31
    float x1; // f25
    float y1; // f24
    float x2; // f23
    float y2; // f22
    float curBorderWidth; // f19
    float curBorderHeight; // f18
    float x1i; // f29
    float y1i; // f28
    float x2i; // f27
    float y2i; // f26
...
// Range: 0x801C8F3C -> 0x801C9298
// this: r29
void zUIBox::DoAddTweaks(const char * baseName /* r30 */) {
    // Local variables
    struct zUIBoxAsset * asset; // r31
...
static struct rwGameCube2DVertex vertex[4]; // size: 0x60, address: 0x80D0C228
...
// Range: 0x801C9298 -> 0x801C9DA8
// this: r30
void zUIBox::RenderPart(int p /* r20 */, float x1 /* f22 */, float y1 /* f23 */, float x2 /* f24 */, float y2 /* f25 */, float uScale /* f20 */, float vScale /* f21 */, float rotation /* f31 */, float xPivot /* r1+0x8 */, float yPivot /* r1+0x1F8 */) const {
    // Local variables
    ...
    float sinA; // f30
    float cosA; // f29
    float tempScale; // r1+0x60
    struct RwTexture * pTexture; // r28
    struct RwRaster * raster; // r22
    const struct xColor_tag * color; // r1+0x5C
    float z; // f28
    struct RwCamera * camera; // r27
    float cz; // r1+0x58
    float cooz; // r1+0x54
    float offset_x; // r1+0x50
    float offset_y; // r1+0x4C
    float offset_px; // r1+0x48
    float offset_py; // r1+0x44
    float offset_cx; // r1+0x40
    float offset_cy; // r1+0x3C
    float x_sign; // f27
    float y_sign; // f26
    float g_center_x; // r1+0x38
    float g_center_y; // r1+0x34
    unsigned short indexes[4]; // r1+0x7C
    const struct zUIBoxAsset * asset; // r29
    unsigned int enableMask; // r21
    enum RwBlendFunction srcblend; // r1+0x30
    enum RwBlendFunction dstblend; // r1+0x2C
...
// Range: 0x801C9E14 -> 0x801C9E44
void zUIBox_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x801C9E44 -> 0x801C9EA0
void zUIBox_Init(class zUIBox * uibox /* r30 */, struct zUIBoxAsset * asset /* r1+0x8 */) {}

// total size: 0x64
struct {} zUIBox::__vtable; // size: 0x64, address: 0x80521D78
