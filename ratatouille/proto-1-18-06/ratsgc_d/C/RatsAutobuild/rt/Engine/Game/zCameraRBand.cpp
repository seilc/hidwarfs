/*
    ...
    Language: C++
    Code range: 0x802A9DA4 -> 0x802A9FE8
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0x4
struct /* @class$901zCameraRBand_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zCameraRBand_cpp */ {
    // Members
...
union /* @class$1040zCameraRBand_cpp */ {
...
// total size: 0x10
struct /* @class$1288zCameraRBand_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1832zCameraRBand_cpp */ {
    // Members
...
struct zSlideCam * rbCam; // size: 0x4, address: 0x80D6B4A0
unsigned char zRBAND_CAMERA_ACTIVE; // size: 0x1, address: 0x80D6B4A4
// total size: 0x10
...
// Range: 0x802A9DA4 -> 0x802A9DD4
void zCameraRBandAsset_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}
...
// Range: 0x802A9DD4 -> 0x802A9EB0
void zCameraRBandAsset_Init(struct zCameraRBandObject * object /* r29 */, struct zCameraRBandAsset * asset /* r31 */) {
    // References
...
// Range: 0x802A9EEC -> 0x802A9FE8
void zCameraRBandAsset_EventCB(struct xBase * to /* r1+0x8 */, unsigned int toEvent /* r1+0xC */) {
    // Local variables
    const struct zCameraRBandObject * scamera; // r31
    const struct zCameraRBandAsset * asset; // r1+0x10
...
// total size: 0x890
struct /* @class$1785zCameraRBand_cpp */ {
    // Static members
