/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRemyPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80299724 -> 0x8029CFC4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$anFallCheck__20zPlayerActionWallRunFP15xAnimTransitionP11xAnimSinglePv[12]; // size: 0xC, address: 0x80D65FD8
char __FUNCTION__$localstatic1$anClimbUpCheck__22zPlayerActionWallClimbFP15xAnimTransitionP11xAnimSinglePv[15]; // size: 0xF, address: 0x80D65FE4
char __FUNCTION__$localstatic1$anGrabFinishCB__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[15]; // size: 0xF, address: 0x80D65FF3
char __FUNCTION__$localstatic1$anReleaseCheck__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[15]; // size: 0xF, address: 0x80D66002
char __FUNCTION__$localstatic1$anMoveReleaseCheck__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[19]; // size: 0x13, address: 0x80D66011
char __FUNCTION__$localstatic1$anMoveStopCheck__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[16]; // size: 0x10, address: 0x80D66024
char __FUNCTION__$localstatic1$anPullCheck__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[12]; // size: 0xC, address: 0x80D66034
char __FUNCTION__$localstatic1$anPushCheck__27zCommonPlayerActionPushPullFP15xAnimTransitionP11xAnimSinglePv[12]; // size: 0xC, address: 0x80D66040
static int lastUsedPadMRI; // size: 0x4, address: 0x80D6604C
static unsigned char TEST_NPC_COLLIDE; // size: 0x1, address: 0x80D66050
static unsigned char sChargeStandScreenWarp; // size: 0x1, address: 0x80D66051
static float sChargeStandMinLifetime; // size: 0x4, address: 0x80D66054
static float sChargeStandMinRadius; // size: 0x4, address: 0x80D66058
static float sChargeStandMinSustain; // size: 0x4, address: 0x80D6605C
static float sChargeStandMaxLifetime; // size: 0x4, address: 0x80D66060
static float sChargeStandMaxRadius; // size: 0x4, address: 0x80D66064
static float sChargeStandMaxSustain; // size: 0x4, address: 0x80D66068
static unsigned char sChargeStandRed; // size: 0x1, address: 0x80D6606C
static unsigned char sChargeStandGreen; // size: 0x1, address: 0x80D6606D
static unsigned char sChargeStandBlue; // size: 0x1, address: 0x80D6606E
static unsigned char sChargeStandAlpha; // size: 0x1, address: 0x80D6606F
static float sChargeStandFadeTime; // size: 0x4, address: 0x80D66070
static float sChargeStandIntensity; // size: 0x4, address: 0x80D66074
static float sChargeStandRadiusBloat; // size: 0x4, address: 0x80D66078
static float sChargeStandStartRadius; // size: 0x4, address: 0x80D6607C
static float sChargeStandVRange; // size: 0x4, address: 0x80D66080
static float sChargeStandVSpeed; // size: 0x4, address: 0x80D66084
static int sChargeStandNumSections; // size: 0x4, address: 0x80D66088
static int sChargeStandNumSlices; // size: 0x4, address: 0x80D6608C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static float PLSBOUND_RADIUS; // size: 0x4, address: 0x80D66090
static float PLSBOUND_MIDRADIUS; // size: 0x4, address: 0x80D66094
static float PLSBOUND_SCOOT_BACK; // size: 0x4, address: 0x80D66098
static unsigned int BUTTON_THROW1; // size: 0x4, address: 0x80D6609C
static unsigned int BUTTON_THROW2; // size: 0x4, address: 0x80D660A0
static unsigned int BUTTON_GRAB; // size: 0x4, address: 0x80D660A4
static unsigned int BUTTON_CYCLE_TARGET; // size: 0x4, address: 0x80D660A8
static unsigned int EMIT_BONE1; // size: 0x4, address: 0x80D660AC
// total size: 0x10
struct hitBoneInfo {
    // Members
...
union /* @class$1040zRemyPlayer_cpp */ {
...
// total size: 0x4
struct /* @class$901zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2285zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zRemyPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zRemyPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zRemyPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zRemyPlayer_cpp */ {
    // Members
...
static class zCombatAttack remyAttackStates[14]; // size: 0x9D8, address: 0x80D2BC48
static unsigned int NUM_HIT_STARS; // size: 0x4, address: 0x80D660B0
// total size: 0x5C
struct config {
    // Members
    ...
    float emit; // offset 0x10, size 0x4
    float emit_rate; // offset 0x14, size 0x4
    float emit_radius; // offset 0x18, size 0x4
    ...
    float glow; // offset 0x2C, size 0x4
    float min_rot; // offset 0x30, size 0x4
    float max_rot; // offset 0x34, size 0x4
    float size_delta; // offset 0x38, size 0x4
    float vel_at; // offset 0x3C, size 0x4
    float vel_up; // offset 0x40, size 0x4
    float vel_right; // offset 0x44, size 0x4
    float nrm_at; // offset 0x48, size 0x4
    float nrm_up; // offset 0x4C, size 0x4
    float nrm_right; // offset 0x50, size 0x4
    float cone_rnd; // offset 0x54, size 0x4
    float cone_vel; // offset 0x58, size 0x4
};
static struct config punch_stars_config; // size: 0x5C, address: 0x80D2C620
static struct config hit_stars_config; // size: 0x5C, address: 0x80D2C67C
// total size: 0x50
struct /* @class$2578zRemyPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
    struct xVec3 velMul; // offset 0xC, size 0xC
    struct xVec3 velAdd; // offset 0x18, size 0xC
...
// total size: 0x44
struct /* @class$2579zRemyPlayer_cpp */ {
    // Members
    struct xVec3 velMul; // offset 0x0, size 0xC
    struct xVec3 velAdd; // offset 0xC, size 0xC
...
struct config {
    // Members
    int num_waves; // offset 0x0, size 0x4
    struct RwRaster * textureRaster; // offset 0x4, size 0x4
    struct RwTexture * particleTex; // offset 0x8, size 0x4
    struct RwTexture * decalDefault; // offset 0xC, size 0x4
    struct RwTexture * decalConcrete; // offset 0x10, size 0x4
    struct RwTexture * decalDirt; // offset 0x14, size 0x4
    unsigned char use_scroll; // offset 0x18, size 0x1
    unsigned char shake_camera; // offset 0x19, size 0x1
    float gravity; // offset 0x1C, size 0x4
    float start_alpha; // offset 0x20, size 0x4
    float genParTime; // offset 0x24, size 0x4
    float delta_rot; // offset 0x28, size 0x4
    float decal_size; // offset 0x2C, size 0x4
    // total size: 0x50
    struct /* @class$2578zRemyPlayer_cpp */ {
        // Members
        struct xVec3 pos; // offset 0x0, size 0xC
    ...
    struct /* @class$2579zRemyPlayer_cpp */ {
        ...
        float height; // offset 0x3C, size 0x4
        float scrollSpeed; // offset 0x40, size 0x4
    } waveParams; // offset 0x80, size 0x44
};
static struct config uppercut_slam_config; // size: 0xC4, address: 0x80D2C6D8
static struct config finish_slam_config; // size: 0xC4, address: 0x80D2C79C
// total size: 0xC
struct curve_node {
    // Members
...
static struct config_type punch_streak_cfg; // size: 0x20, address: 0x80D2C860
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x80525C00
// total size: 0xC
struct HFXSlamInfo {
    // Members
    float damage_radius; // offset 0x0, size 0x4
    unsigned int damage; // offset 0x4, size 0x4
    struct config * config; // offset 0x8, size 0x4
};
static struct HFXSlamInfo uppercut_slam; // size: 0xC, address: 0x80D660B4
static struct HFXSlamInfo finish_slam; // size: 0xC, address: 0x80D660C0
// total size: 0x20
struct AttackFX {
    // Members
...
static struct AttackFX AttackFXList[15]; // size: 0x1E0, address: 0x80525C24
// total size: 0x14
struct HitFX {
    // Members
    unsigned int anim; // offset 0x0, size 0x4
...
static struct HitFX HitFXList[2]; // size: 0x28, address: 0x80525E04
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1288zRemyPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80299724 -> 0x80299A24
static void RemyMeleeHit(struct xEnt * hitter /* r26 */, const class zCombatAttack * runningAttack /* r22 */, struct xEnt * hittee /* r1+0x10 */, const struct xVec3 * hit_loc /* r25 */, const struct xVec3 * hit_norm /* r27 */) {
    // Local variables
    struct zRemyPlayer * player; // r29
    unsigned int anim; // r24
    struct HitFX * hfx; // r31
    struct HitFX * end; // r23
    float time; // f31
    struct xMat4x3 mat; // r1+0x40
    struct HFXSlamInfo * info; // r30
    struct xVec3 nrm; // r1+0x2C
    struct xVec3 pos; // r1+0x20
    float dt; // f30
    unsigned int i; // r28
    struct xVec3 vel; // r1+0x14

    // References
    // -> static unsigned int NUM_HIT_STARS;
    // -> static struct config hit_stars_config;
    // -> struct xGlobals * xglobals;
    // -> static struct HitFX HitFXList[2];
}
...
static struct compositeEffect rumbleEffects[1]; // size: 0x50, address: 0x80D2C880
// Range: 0x80299A24 -> 0x80299A3C
static struct compositeEffect & GetRumble(unsigned int type /* r3 */) {
    // References
    // -> static struct compositeEffect rumbleEffects[1];
}

// total size: 0x18B0
struct zRemyPlayer : public zCommonPlayer {
    // Functions
    void Exit();
    ...
    void BoundUpdate(struct xVec3 * _pos);

    void SetupTweaks();

    void BeforeAnimMatrices(struct xQuat * quat, struct xVec3 * tran);

    void Update_FX(float dt);

    unsigned char AllowInteraction();
    ...
    // Members
    int lastSlickness; // offset 0x1840, size 0x4
    float minVelmag; // offset 0x1844, size 0x4
    float surfDamping; // offset 0x1848, size 0x4
    int surfSlickness; // offset 0x184C, size 0x4
    float surfFriction; // offset 0x1850, size 0x4
    unsigned int surfSticky; // offset 0x1854, size 0x4
private:
    float ShockRadius; // offset 0x1858, size 0x4
    float ShockRadiusOld; // offset 0x185C, size 0x4
    unsigned int * atomics_order; // offset 0x1860, size 0x4
    unsigned int atomics_count; // offset 0x1864, size 0x4
    struct xVec3 bone_adjust; // offset 0x1868, size 0xC
    struct xVec3 prev_at; // offset 0x1874, size 0xC
    struct xVec3 prev_bi_normal; // offset 0x1880, size 0xC
    float x_lean; // offset 0x188C, size 0x4
    float y_lean; // offset 0x1890, size 0x4
    float last_sign; // offset 0x1894, size 0x4
    unsigned int modelRender; // offset 0x1898, size 0x4
    struct xResponseCurve mShockWaveAlphaCurve; // offset 0x189C, size 0x14
};
// Range: 0x80299A3C -> 0x80299A90
// this: r31
void zRemyPlayer::Exit() {
    // References
    // -> static int lastUsedPadMRI;
}

// total size: 0x4
struct /* @class$2021zRemyPlayer_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2022zRemyPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2023zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2020zRemyPlayer_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2025zRemyPlayer_cpp */ {
    // Members
...
// Range: 0x80299A90 -> 0x80299AB8
// this: r1+0x8
void zRemyPlayer::SetupRumbles() {}

// Range: 0x80299AB8 -> 0x80299B48
// this: r31
void zRemyPlayer::Rumble(unsigned int rumbleType /* r30 */) {}
...
// total size: 0x4
struct /* @class$2559zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zRemyPlayer_cpp */ {
    // Static members
...
// total size: 0x8
struct alpha_curve_node {
    // Members
    float time; // offset 0x0, size 0x4
    struct alpha_value value; // offset 0x4, size 0x4
};
static struct alpha_curve_node alphaCurve[4]; // size: 0x20, address: 0x804CD030
struct config default_config; // size: 0x5C, address: 0x80D26448
struct config default_config; // size: 0xC4, address: 0x80D13E60
// total size: 0xC
...
// Range: 0x80299B48 -> 0x8029A18C
// this: r31
void zRemyPlayer::Init(struct xEntAsset * asset /* r1+0x8 */) {
    // Local variables
    class zRemyPlayerPunch * punch; // r27
    class zPlayerDodge * dodge; // r26
    class zPlayerLedge * ledge; // r25
    class zRemyPlayerUseSwipe * swipe; // r24

    // References
    // -> static struct AttackFX AttackFXList[15];
    // -> static struct config_type punch_streak_cfg;
    // -> static struct curve_node punch_streak_ribbon_curve[3];
    // -> static struct alpha_curve_node alphaCurve[4];
    // -> static struct config finish_slam_config;
    // -> struct config default_config;
    // -> static struct config uppercut_slam_config;
    // -> static struct config hit_stars_config;
    // -> struct config default_config;
    // -> static struct config punch_stars_config;
    // -> static class zCombatAttack remyAttackStates[14];
    // -> static int lastUsedPadMRI;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80525E2C
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8029A31C -> 0x8029A520
// this: r31
void zRemyPlayer::InitAtomicRenderOrder() {
    // Local variables
    unsigned int assetID; // r27
    unsigned int i; // r29
    unsigned short size; // r1+0x8
    struct xModelAssetParam * param; // r30
    char buffer[256]; // r1+0xA
    unsigned int idx; // r28
...
// Range: 0x8029A520 -> 0x8029A580
// this: r1+0x8
void zRemyPlayer::SceneSetup() {
    // References
    // -> struct xColor_tag g_RED;
}

// Range: 0x8029A580 -> 0x8029A5DC
// this: r31
void zRemyPlayer::Reset() {}

// Range: 0x8029A5DC -> 0x8029A6C0
// this: r30
void zRemyPlayer::DefaultBeginUpdate(float dt /* r1+0x8 */) {
    // Local variables
    int num_bones; // r28
...
// Range: 0x8029A6C0 -> 0x8029A730
// this: r31
void zRemyPlayer::DefaultUpdate(float dt /* f31 */) {}

// Range: 0x8029A730 -> 0x8029A758
// this: r1+0x8
void zRemyPlayer::RenderEffects() {}
...
// total size: 0xC
struct /* @class$1039zRemyPlayer_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D660CC
// Range: 0x8029A758 -> 0x8029A8C0
// this: r31
void zRemyPlayer::BoundUpdate(struct xVec3 * _pos /* r1+0x8 */) {
    // Local variables
    unsigned int animFlags; // r29
    unsigned int playerMove; // r28
    class zRemyPlayerCarry * carry; // r30
    struct xSphere * itemSphere; // r27

    // References
    // -> static char __FUNCTION__[12];
    // -> static float PLSBOUND_SCOOT_BACK;
    // -> static float PLSBOUND_MIDRADIUS;
    // -> static float PLSBOUND_RADIUS;
}

char * BUTTON_NAMES[12]; // size: 0x30, address: 0x8051F9FC
unsigned int BUTTON_DEFINITIONS[12]; // size: 0x30, address: 0x8051FA2C
// Range: 0x8029A8C0 -> 0x8029B0D4
// this: r31
void zRemyPlayer::SetupTweaks() {
    // Local variables
    char prefix[128]; // r1+0x10

    // References
    // -> static unsigned char TEST_NPC_COLLIDE;
    // -> static struct config finish_slam_config;
    // -> static struct config uppercut_slam_config;
    // -> static struct config hit_stars_config;
    // -> static struct config punch_stars_config;
    // -> static unsigned int NUM_HIT_STARS;
    // -> static float sChargeStandVSpeed;
    // -> static float sChargeStandVRange;
    // -> static float sChargeStandStartRadius;
    // -> static unsigned char sChargeStandScreenWarp;
    // -> static float sChargeStandRadiusBloat;
    // -> static int sChargeStandNumSlices;
    // -> static int sChargeStandNumSections;
    // -> static float sChargeStandIntensity;
    // -> static float sChargeStandFadeTime;
    // -> static unsigned char sChargeStandRed;
    // -> static unsigned char sChargeStandAlpha;
    // -> static unsigned char sChargeStandBlue;
    // -> static unsigned char sChargeStandGreen;
    // -> static float sChargeStandMaxLifetime;
    // -> static float sChargeStandMaxSustain;
    // -> static float sChargeStandMaxRadius;
    // -> static float sChargeStandMinLifetime;
    // -> static float sChargeStandMinSustain;
    // -> static float sChargeStandMinRadius;
    // -> struct xGlobals * xglobals;
    // -> static float PLSBOUND_SCOOT_BACK;
    // -> static float PLSBOUND_MIDRADIUS;
    // -> static float PLSBOUND_RADIUS;
    // -> static unsigned int EMIT_BONE1;
    // -> unsigned int BUTTON_DEFINITIONS[12];
    // -> char * BUTTON_NAMES[12];
    // -> static unsigned int BUTTON_CYCLE_TARGET;
    // -> static unsigned int BUTTON_GRAB;
    // -> static unsigned int BUTTON_THROW2;
    // -> static unsigned int BUTTON_THROW1;
}

// Range: 0x8029B0D4 -> 0x8029B118
// this: r1+0x8
void zRemyPlayer::BeforeAnimMatrices(struct xQuat * quat /* r1+0xC */, struct xVec3 * tran /* r1+0x10 */) {}

// Range: 0x8029B118 -> 0x8029B11C
void zRemyPlayer::Update_Particles() {}

// Range: 0x8029B11C -> 0x8029B158
// this: r1+0x8
void zRemyPlayer::Update_FX(float dt /* r1+0xC */) {}

// Range: 0x8029B158 -> 0x8029B274
// this: r31
unsigned char zRemyPlayer::AllowInteraction() {
    // Local variables
...
static float time; // size: 0x4, address: 0x80D6B430
static float lastTime; // size: 0x4, address: 0x80D6B434
static struct xFXRibbon * up; // size: 0x4, address: 0x80D6B438
static float distance; // size: 0x4, address: 0x80D6B43C
static struct xVec3 averageWidth; // size: 0xC, address: 0x80D6B440
static float segmentLayDist; // size: 0x4, address: 0x80D660D8
static int averagePrevNormals; // size: 0x4, address: 0x80D660DC
...
// Range: 0x8029B274 -> 0x8029B4A4
static void fix_punch_streak_ribbon(struct xFXRibbon * effect /* r31 */, const struct xVec3 * diff /* r22 */) {
    // Local variables
    class iterator it; // r1+0x48
    struct xVec3 dir; // r1+0x50
...
// Range: 0x8029B4A4 -> 0x8029B518
static void start_punch_streak() {
    // References
    // -> static struct config_type punch_streak_cfg;
    // -> static struct xFXRibbon * up;
    // -> static float lastTime;
    // -> static float time;
}

// Range: 0x8029B518 -> 0x8029B524
static void stop_punch_streak() {
    // References
    // -> static float time;
}

static char __FUNCTION__[31]; // size: 0x1F, address: 0x80525E42
// total size: 0x10
struct xQuat {
    // Members
    struct xVec3 v; // offset 0x0, size 0xC
...
// Range: 0x8029B524 -> 0x8029B9A0
static void update_and_add_to_punch_streak(struct xFXRibbon * effect /* r28 */, struct xMat4x3 * mat /* r20 */, unsigned int count /* r26 */, struct xEntFrame * frame /* r29 */) {
    // Local variables
    struct xVec3 prevElement; // r1+0xA0
    struct xVec3 * cacheElement; // r25
    struct xQuat oldOrient; // r1+0x90
    struct xQuat newOrient; // r1+0x80
    unsigned int i; // r31
    struct xVec3 * cacheElement; // r24
    ...
    // -> struct xVec3 m_Null;
    // -> static struct xVec3 averageWidth;
    // -> static struct xFXRibbon * up;
...
// Range: 0x8029B9A0 -> 0x8029BA30
static void update_punch_streak(struct xMat4x3 * mat /* r1+0x8 */, unsigned int count /* r1+0xC */, struct xEntFrame * frame /* r31 */, float dt /* r1+0x10 */) {
    // Local variables
...
// Range: 0x8029BA30 -> 0x8029BA3C
static void reset_punch_streak() {
    // References
    // -> static struct xFXRibbon * up;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D660E0
...
// Range: 0x8029BA3C -> 0x8029BED0
// this: r30
void zRemyPlayer::UpdateAttackFX(float dt /* f30 */) {
    // Local variables
    enum zCommonPlayerUpgradeLevel meleeUpgrade; // r22
    unsigned char upgrade; // r21
    struct AttackFX * atk; // r31
    struct AttackFX * end; // r20
    float time; // f31
    unsigned int anim; // r19
    unsigned char attackStart; // r18
    unsigned char attackStop; // r17
    const struct xModelInstance * playerModel; // r1+0x20
    struct xMat4x3 boneMat; // r1+0xA0
    struct xVec3 pos; // r1+0x54
    struct xVec3 nrm; // r1+0x48
    float frac; // r1+0x1C
    int start; // r29
    int end; // r27
    struct xMat4x3 * atk_mat; // r26
    int i; // r25
    struct xMat4x3 mat; // r1+0x60
    struct xVec3 vel; // r1+0x3C
    struct xVec3 nrm; // r1+0x30
    struct xVec3 pos; // r1+0x24
    int start; // r28
    int end; // r24
    struct xMat4x3 * atk_mat; // r1+0x18
    unsigned int count; // r1+0x14
...
// Range: 0x8029BED0 -> 0x8029BF18
// this: r31
float zRemyPlayer::InitialDepenetrationVelocity() {}

// Range: 0x8029BF18 -> 0x8029BF54
// this: r1+0x8
void zRemyPlayer::BreakGrab() {
    // Local variables
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x8029BF54 -> 0x8029BFF0
// this: r30
struct xVec3 zRemyPlayer::get_target() {
    // Local variables
    struct xVec3 centerPos; // r1+0x14
    class zRemyPlayerCarry * carry; // r31
}

// Range: 0x8029BFF0 -> 0x8029BFF8
int * zRemyPlayer::GetHeadBones() {}

// Range: 0x8029BFF8 -> 0x8029CAC0
// this: r31
void zRemyPlayer::InitActions() {}
...
static struct xHierarchyBoundInitData bounds[14]; // size: 0xA8, address: 0x80525E64
// Range: 0x8029CE18 -> 0x8029CE24
struct xHierarchyBoundInitData * zRemyPlayer::GetHierarchyBoundInitData() {
    // References
    // -> static struct xHierarchyBoundInitData bounds[14];
}

// Range: 0x8029CE24 -> 0x8029CE2C
float zRemyPlayer::GetHierarchyMasterRadius() {}

static char * remyBoneNames[52]; // size: 0xD0, address: 0x80525F0C
// Range: 0x8029CE2C -> 0x8029CE38
char * * zRemyPlayer::GetBoneNames() {
    // References
    // -> static char * remyBoneNames[52];
}
...
// Range: 0x8029CE38 -> 0x8029CED8
// this: r28
void zRemyPlayer::SetUpgrade(enum zCommonPlayerUpgradeType forThisType /* r29 */, enum zCommonPlayerUpgradeLevel level /* r30 */) {
    // Local variables
    class zRemyPlayerPunch * punch; // r31
    class zRemyPlayerDodge * dodge; // r1+0xC
    class zRemyPlayerCarry * carry; // r1+0x8

    // References
    // -> static class zCombatAttack remyAttackStates[14];
}

// Range: 0x8029CED8 -> 0x8029CF3C
// this: r31
void zRemyPlayer::LoadUpgrades() {
    // Local variables
    class zRemyPlayerPunch * punch; // r30

    // References
    // -> static class zCombatAttack remyAttackStates[14];
}

// Range: 0x8029CF3C -> 0x8029CF7C
// this: r31
void zRemyPlayer::LoadSetupUpgrades() {
    // References
    // -> struct zGlobals globals;
}

// total size: 0x54
struct {} zPlayerContextAction::__vtable; // size: 0x54, address: 0x80525FDC
...
// total size: 0x54
struct {} zCommonPlayerAction::__vtable; // size: 0x54, address: 0x80526030
// total size: 0x158
struct {} zRemyPlayer::__vtable; // size: 0x158, address: 0x80526084
// total size: 0xC
