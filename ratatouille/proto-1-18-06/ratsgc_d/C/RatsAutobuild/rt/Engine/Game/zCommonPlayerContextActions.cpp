/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCommonPlayerContextActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D755C -> 0x802DCC58
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802D755C -> 0x802D7590
// this: r1+0x8
unsigned int zPlayerContextAction::MountedCheck() {}

// total size: 0x4
struct /* @class$2082zCommonPlayerContextActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2083zCommonPlayerContextActions_cpp */ {
    // Members
...
static float TURN_ANIM_TIME; // size: 0x4, address: 0x80D66B20
static float WALK_SPEED; // size: 0x4, address: 0x80D66B24
static float LEAN_BALANCING_FORCE; // size: 0x4, address: 0x80D66B28
static float LEAN_GRAVITY_FORCE; // size: 0x4, address: 0x80D66B2C
static float LEAN_FALL_ANGLE; // size: 0x4, address: 0x80D66B30
static float LEAN_DIFF_ACCEL; // size: 0x4, address: 0x80D66B34
static float TURN_AROUND_ANGLE; // size: 0x4, address: 0x80D66B38
static float TURN_AROUND_MAGNITUDE; // size: 0x4, address: 0x80D66B3C
static float ORIENTATION_LOOK_AHEAD_SPEED; // size: 0x4, address: 0x80D66B40
static float SPEED_INPUT_THETA; // size: 0x4, address: 0x80D66B44
static float START_BLEND_TIME; // size: 0x4, address: 0x80D66B48
static float INAIR_LEAN_RATE; // size: 0x4, address: 0x80D66B4C
static unsigned char CONST_LEAN_GRAVITY; // size: 0x1, address: 0x80D6B6F8
static float CONST_LEAN_GRAVITY_FORCE; // size: 0x4, address: 0x80D66B50
static float LEAN_GRAVITY_FORCE_MAX; // size: 0x4, address: 0x80D66B54
static float LEAN_GRAVITY_FORCE_MIN; // size: 0x4, address: 0x80D66B58
// total size: 0x10
struct rest_config {
    // Members
...
static struct rest_config tightropeRest; // size: 0x10, address: 0x80D66B5C
static unsigned char debugDraw; // size: 0x1, address: 0x80D6B6F9
static unsigned char debugDrawLandState; // size: 0x1, address: 0x80D66B6C
static unsigned char debugDrawBalanceMeter; // size: 0x1, address: 0x80D66B6D
// total size: 0x28
...
// Range: 0x802D7A10 -> 0x802D7F54
// this: r30
void zPlayerTightrope::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802D7F54 -> 0x802D8434
void zPlayerTightrope::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802D8434 -> 0x802D8528
// this: r31
void zPlayerTightrope::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x802D8528 -> 0x802D8590
void zPlayerTightrope::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802D8590 -> 0x802D85C8
// this: r1+0x8
...
// total size: 0x4
struct /* @class$892zCommonPlayerContextActions_cpp */ {
    // Members
...
union /* @class$1040zCommonPlayerContextActions_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zCommonPlayerContextActions_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$833zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zCommonPlayerContextActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zCommonPlayerContextActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zCommonPlayerContextActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zCommonPlayerContextActions_cpp */ {
    // Members
...
// Range: 0x802D8638 -> 0x802D866C
// this: r31
unsigned int zPlayerTightrope::CaughtCheck() {}

// Range: 0x802D866C -> 0x802D8684
// this: r3
unsigned int zPlayerTightrope::CaughtCB() {}

// Range: 0x802D8684 -> 0x802D86D0
// this: r3
...
// Range: 0x802D86D0 -> 0x802D86E8
// this: r3
unsigned int zPlayerTightrope::TurnAroundCB() {}

// Range: 0x802D86E8 -> 0x802D86F0
// this: r3
unsigned int zPlayerTightrope::DismountCheck() {}

// Range: 0x802D86F0 -> 0x802D8708
// this: r3
unsigned int zPlayerTightrope::IdleCheck() {}

// Range: 0x802D8708 -> 0x802D8720
// this: r3
unsigned int zPlayerTightrope::WalkCheck() {}

// Range: 0x802D8720 -> 0x802D878C
// this: r30
unsigned int zPlayerTightrope::IdleMountCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x802D878C -> 0x802D87F8
// this: r30
unsigned int zPlayerTightrope::WalkMountCheck(struct xAnimTransition * tran /* r1+0x8 */, struct xAnimSingle * anim /* r1+0xC */) {}

// Range: 0x802D87F8 -> 0x802D8840
// this: r31
...
// Range: 0x802D8840 -> 0x802D8940
// this: r31
void zPlayerTightrope::Begin() {
    // Local variables
    const class zContextObjectTightrope * tightrope; // r30
...
// total size: 0x14
struct /* @class$2462zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$2463zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$2464zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x6C
struct /* @class$2465zCommonPlayerContextActions_cpp */ {
    // Members
    float dist; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$2466zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2467zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2469zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2470zCommonPlayerContextActions_cpp */ {
    // Members
...
// Range: 0x802D8A3C -> 0x802D8CBC
// this: r31
void zPlayerTightrope::UpdateLean(float magnitude /* r1+0x8 */, float cosDiff /* f22 */, float dt /* f30 */) {
    // Local variables
    float leanDeltaSpeed; // f29
    float gravityAdj; // f31
    float sin; // f28
...
// Range: 0x802D8CBC -> 0x802D8D84
// this: r31
void zPlayerTightrope::UpdatePos(const class zContextObjectTightrope * tightrope /* r30 */, float dt /* r1+0x8 */) {
    // Local variables
    struct xVec3 newPos; // r1+0xC
...
// Range: 0x802D8D84 -> 0x802D93DC
// this: r31
void zPlayerTightrope::TightropeMove(float dt /* f30 */, struct xEntFrame * frame /* r28 */, const class zContextObjectTightrope * tightrope /* r27 */) {
    // Local variables
    float x; // f29
    float z; // f28
    float stickAngle; // f31
    float orientationLookAheadU; // r1+0x1C
    float lookAheadDist; // f25
    struct xVec3 lookAheadSplineDir; // r1+0x8C
    float lookAheadSplineAngle; // f27
    float cosDiff; // f24
    struct xVec3 splineDir; // r1+0x80
    struct xAnimSingle * single; // r30
    struct xMat3x3 test; // r1+0xE0
    struct xVec3 stickDir; // r1+0x74
    struct xVec3 drawPos; // r1+0x68
    struct xVec3 drawDir; // r1+0x5C
    struct xVec3 leanDir; // r1+0x50
    struct xAnimSingle * playerSingle; // r29
    char text[32]; // r1+0xB8
    struct xVec3 pos; // r1+0x44
    char text[32]; // r1+0x98
    float leanAngleAbs; // f26
...
// Range: 0x802D93DC -> 0x802D9510
// this: r31
void zPlayerTightrope::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r28 */) {
    // Local variables
    const class zContextObjectTightrope * tightrope; // r30
    unsigned char prevChkby; // r29
...
static float DISMOUNT_VEL_Y; // size: 0x4, address: 0x80D66B70
static float DISMOUNT_VEL_XZ; // size: 0x4, address: 0x80D66B74
static float FLING_TIME; // size: 0x4, address: 0x80D66B78
static float FLING_FUDGE_TIME; // size: 0x4, address: 0x80D66B7C
static float REVERSE_STICK_MAG_MIN; // size: 0x4, address: 0x80D66B80
static float REVERSE_STICK_ANGLE; // size: 0x4, address: 0x80D66B84
static unsigned int ALLOW_FULL_JUMP_CONTROL; // size: 0x4, address: 0x80D6B6FC
// total size: 0x18
...
// Range: 0x802D97F0 -> 0x802D9950
// this: r30
void zPlayerPoleSwing::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802D9950 -> 0x802D99A4
void zPlayerPoleSwing::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */) {}

// Range: 0x802D99A4 -> 0x802D9C20
void zPlayerPoleSwing::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802D9C20 -> 0x802D9CEC
// this: r31
void zPlayerPoleSwing::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x802D9CEC -> 0x802D9D24
// this: r1+0x8
unsigned int zPlayerPoleSwing::StartCheck() {}

// Range: 0x802D9D24 -> 0x802D9D2C
// this: r3
unsigned int zPlayerPoleSwing::FlingDefCheck() {}

// Range: 0x802D9D2C -> 0x802D9D7C
// this: r3
...
// Range: 0x802D9D7C -> 0x802D9DA8
// this: r1+0x8
unsigned int zPlayerPoleSwing::ReverseDefCheck() {}

// Range: 0x802D9DA8 -> 0x802D9E18
// this: r30
...
// Range: 0x802D9E18 -> 0x802D9E28
// this: r3
unsigned int zPlayerPoleSwing::ReverseCB() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66B88
// Range: 0x802D9E28 -> 0x802D9F70
// this: r31
unsigned int zPlayerPoleSwing::FlingCB(struct xAnimTransition * tran /* r29 */, struct xAnimSingle * anim /* r30 */) {
    // References
    // -> static float FLING_TIME;
    // -> static float DISMOUNT_VEL_Y;
    // -> static float DISMOUNT_VEL_XZ;
...
// Range: 0x802D9F70 -> 0x802D9FB8
// this: r31
unsigned int zPlayerPoleSwing::GrabbedCB() {}

// Range: 0x802D9FB8 -> 0x802DA0CC
// this: r31
...
// Range: 0x802DA0CC -> 0x802DA118
// this: r31
void zPlayerPoleSwing::Begin() {}

// Range: 0x802DA118 -> 0x802DA150
// this: r31
void zPlayerPoleSwing::End() {}

// Range: 0x802DA150 -> 0x802DA2C0
// this: r31
void zPlayerPoleSwing::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r1+0xC */) {
    // Local variables
    unsigned int animFlags; // r29
    const class zContextObjectPoleSwing * poleSwing; // r30
    unsigned char prevChkby; // r28
...
// Range: 0x802DA2C0 -> 0x802DA2F0
// this: r1+0x8
void zPlayerPoleSwing::Update(float dt /* r1+0xC */) {}

static float INTERP_SPEED; // size: 0x4, address: 0x80D66B90
static float ROTATION_SPEED; // size: 0x4, address: 0x80D66B94
// Range: 0x802DA2F0 -> 0x802DA3E4
static unsigned char TurnToFace(struct xEntFrame * frame /* r31 */, const struct xVec3 & dir /* r30 */, float dt /* r1+0x8 */) {
    // Local variables
    float targetAngle; // f29
    float angleDiff; // f31
    float deltaRot; // f30
...
// Range: 0x802DA478 -> 0x802DA5C8
// this: r31
void zPlayerSpringboard::InterpolateToBoard(class zSpringboard * springboard /* r30 */, float dt /* f29 */) {
    // Local variables
...
static float VEL_FAILED; // size: 0x4, address: 0x80D66B98
static float TIME_COMPRESS_SUCCEEDED; // size: 0x4, address: 0x80D66B9C
static float TIME_LAUNCH_SUCCEEDED; // size: 0x4, address: 0x80D66BA0
static unsigned int PLAYERANIM_SPRINGBOARD_LAUNCH; // size: 0x4, address: 0x80D66BA4
enum /* @enum$2355zCommonPlayerContextActions_cpp */ {
    NO_INPUT = 0,
    SUCCESS = 1,
    FAILURE = 2,
};
...
// Range: 0x802DA694 -> 0x802DA6E0
// this: r1+0x8
void zPlayerTrampoline::SpringboardBeforeEnter(struct xAnimPlay * play /* r1+0xC */, struct xAnimState * state /* r1+0x10 */) {}

// Range: 0x802DA6E0 -> 0x802DA7FC
// this: r30
...
// Range: 0x802DA7FC -> 0x802DA864
void zPlayerTrampoline::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802DA864 -> 0x802DA988
void zPlayerTrampoline::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DA988 -> 0x802DA9A0
// this: r3
unsigned int zPlayerTrampoline::SuccessCheck() {}

// Range: 0x802DA9A0 -> 0x802DAA08
// this: r30
unsigned int zPlayerTrampoline::StartCheck() {}

// Range: 0x802DAA08 -> 0x802DAAA8
// this: r30
...
// Range: 0x802DAAA8 -> 0x802DAADC
// this: r1+0x8
unsigned int zPlayerTrampoline::LaunchEarlyCB() {}

// Range: 0x802DAADC -> 0x802DAB64
// this: r31
...
// Range: 0x802DAB64 -> 0x802DABF8
void zPlayerTrampoline::AddActionTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DABF8 -> 0x802DAC34
// this: r31
void zPlayerTrampoline::Begin() {}

// Range: 0x802DAC34 -> 0x802DAD50
// this: r31
void zPlayerTrampoline::Move(struct xScene * s /* r26 */, float dt /* f31 */, struct xEntFrame * frame /* r27 */) {
    // Local variables
    struct xAnimSingle * single; // r30
    unsigned int animFlags; // r29
...
// Range: 0x802DAD50 -> 0x802DAE60
// this: r30
void zPlayerBoardLaunch::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DAE60 -> 0x802DAEB4
// this: r1+0x8
void zPlayerBoardLaunch::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x802DAEB4 -> 0x802DAFA4
// this: r26
...
// Range: 0x802DAFA4 -> 0x802DB0B0
// this: r31
void zPlayerBoardLaunch::AddActionTransitions(struct xAnimTable * table /* r30 */) {}

// Range: 0x802DB0B0 -> 0x802DB17C
void zPlayerBoardLaunch::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DB17C -> 0x802DB228
// this: r31
unsigned int zPlayerBoardLaunch::StartBounceCheck() {
    // Local variables
    unsigned char springBoardNPC; // r27
    unsigned char realSpringBoard; // r26
}
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66BA8
// total size: 0x1C
...
// Range: 0x802DB228 -> 0x802DB394
// this: r30
unsigned int zPlayerBoardLaunch::StartApexCheck(struct xAnimTransition * tran /* r31 */, struct xAnimSingle * anim /* r1+0x8 */) {
    // Local variables
    struct xVec3 launchVel; // r1+0xC
    class zICompLogic * npcLogic; // r29
    class zCompLogicSpringBoard * springBoardLogic; // r28
    float time; // f31
...
// Range: 0x802DB394 -> 0x802DB404
// this: r3
unsigned int zPlayerBoardLaunch::ApexCheck(struct xAnimTransition * tran /* r4 */) {
    // Local variables
    float time; // f31
...
// Range: 0x802DB404 -> 0x802DB634
// this: r31
void zPlayerBoardLaunch::Begin() {
    // Local variables
    class zICompLogic * npcLogic; // r23
    class zCompLogicSpringBoard * springBoardLogic; // r30
}

// Range: 0x802DB634 -> 0x802DB6E4
// this: r31
void zPlayerBoardLaunch::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r1+0xC */) {}
...
// Range: 0x802DB6E4 -> 0x802DB730
// this: r31
void zPlayerChargeboard::SpringboardBeforeEnter(struct xAnimPlay * play /* r1+0x8 */, struct xAnimState * state /* r1+0xC */) {}

// Range: 0x802DB730 -> 0x802DB850
// this: r30
void zPlayerChargeboard::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DB850 -> 0x802DB8B8
void zPlayerChargeboard::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802DB8B8 -> 0x802DB988
void zPlayerChargeboard::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DB988 -> 0x802DBA24
// this: r31
unsigned int zPlayerChargeboard::StartCheck() {
    // Local variables
    class zSpringboard * groundBoard; // r30
}

// Range: 0x802DBA24 -> 0x802DBA60
// this: r31
unsigned int zPlayerChargeboard::LaunchCheck() {}

// Range: 0x802DBA60 -> 0x802DBADC
// this: r31
...
// Range: 0x802DBADC -> 0x802DBB30
void zPlayerChargeboard::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x802DBB30 -> 0x802DBB68
// this: r31
void zPlayerChargeboard::Begin() {}

// Range: 0x802DBB68 -> 0x802DBBD4
// this: r31
void zPlayerChargeboard::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r1+0xC */) {}

// Range: 0x802DBBD4 -> 0x802DBC74
// this: r31
...
static unsigned int PLAYERANIM_LAUNCH_FLYING; // size: 0x4, address: 0x80D66BB8
// total size: 0xC
...
// Range: 0x802DBC74 -> 0x802DBC78
void zPlayerActionLaunch::AddTweaks() {}

// Range: 0x802DBC78 -> 0x802DBF18
// this: r30
...
// Range: 0x802DBF18 -> 0x802DBF80
void zPlayerActionLaunch::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802DBF80 -> 0x802DC1F0
void zPlayerActionLaunch::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DC1F0 -> 0x802DC2BC
// this: r30
void zPlayerActionLaunch::AddActionTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802DC2BC -> 0x802DC32C
// this: r30
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66BBC
// Range: 0x802DC32C -> 0x802DC54C
// this: r27
void zPlayerActionLaunch::LaunchBeforeEnter(struct xAnimState * state /* r31 */) {
    // Local variables
    class zLaunch * launch; // r29
    unsigned int animCode; // r28
    unsigned int i; // r30
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D66BCE
// Range: 0x802DC5EC -> 0x802DC6A0
// this: r30
...
// total size: 0x4
struct /* @class$2084zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2081zCommonPlayerContextActions_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$2086zCommonPlayerContextActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1288zCommonPlayerContextActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802DC880 -> 0x802DC95C
// this: r30
void zPlayerActionLaunch::Move(struct xScene * s /* r1+0x8 */, float dt /* f31 */, struct xEntFrame * frame /* r31 */) {
    // Local variables
    class zLaunch * launch; // r29
...
// Range: 0x802DC95C -> 0x802DC9CC
// this: r1+0x18
void zPlayerActionUseLookoutPoint::AddStates(struct xAnimTable * table /* r1+0x1C */) {}

// Range: 0x802DC9CC -> 0x802DCA34
void zPlayerActionUseLookoutPoint::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802DCA34 -> 0x802DCA8C
void zPlayerActionUseLookoutPoint::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}
...
// Range: 0x802DCAC4 -> 0x802DCB54
// this: r31
unsigned int zPlayerActionUseLookoutPoint::StartCheck() {
    // Local variables
    class zHeistLookoutPoint * lookoutPoint; // r30
}

// Range: 0x802DCB54 -> 0x802DCB90
// this: r1+0x8
...
// Range: 0x802DCB90 -> 0x802DCC58
// this: r31
void zPlayerActionUseLookoutPoint::Move(float dt /* f31 */) {
    // Local variables
    class zHeistLookoutPoint * lookoutPoint; // r30
    class zPad * currPad; // r29
}

// total size: 0x54
struct {} zPlayerActionUseLookoutPoint::__vtable; // size: 0x54, address: 0x80529098
// total size: 0xC
...
// total size: 0x54
struct {} zPlayerActionLaunch::__vtable; // size: 0x54, address: 0x805290EC
// total size: 0x58
struct {} zPlayerChargeboard::__vtable; // size: 0x58, address: 0x80529140
// total size: 0x54
struct {} zPlayerBoardLaunch::__vtable; // size: 0x54, address: 0x80529198
// total size: 0x54
struct {} zPlayerTrampoline::__vtable; // size: 0x54, address: 0x805291EC
// total size: 0x54
struct {} zPlayerSpringboard::__vtable; // size: 0x54, address: 0x80529240
// total size: 0x54
struct {} zPlayerPoleSwing::__vtable; // size: 0x54, address: 0x80529294
// total size: 0x54
struct {} zPlayerTightrope::__vtable; // size: 0x54, address: 0x805292E8
