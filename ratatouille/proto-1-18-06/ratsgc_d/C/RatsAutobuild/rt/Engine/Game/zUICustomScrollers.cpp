/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomScrollers.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80294A90 -> 0x80295938
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int NUMBER_SCROLLER_ELEMENTS_PER_LINE; // size: 0x4, address: 0x80D65F08
float NUMBER_SCROLLER_SWITCH_TIME; // size: 0x4, address: 0x80D65F0C
float DESCRIPTION_SCROLLER_SPEED; // size: 0x4, address: 0x80D65F10
int DESCRIPTION_SCROLLER_FADE_CHARS; // size: 0x4, address: 0x80D65F14
float MAP_SCROLLER_MAX_SPEED; // size: 0x4, address: 0x80D65F18
float MAP_SCROLLER_ACCELERATION; // size: 0x4, address: 0x80D65F1C
float MAP_SCROLLER_SLOW_SPEED; // size: 0x4, address: 0x80D65F20
float MAP_SCROLLER_SLOW_DISTANCE; // size: 0x4, address: 0x80D65F24
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65F28
// total size: 0x54
struct {} zUICustomDescriptionScroller::__vtable; // size: 0x54, address: 0x80525804
// total size: 0xC
...
// total size: 0x198
class zUICustomDescriptionScroller : public zUICustom {
    // Functions
    zUICustomDescriptionScroller(class zUI * ui);

    void Reset();

    void PreUpdate(float dt);

    unsigned char HandleEvent(unsigned int toEvent);

    // Members
    struct _xCounter * counter; // offset 0x8, size 0x4
    const char * baseText; // offset 0xC, size 0x4
    char buffer[384]; // offset 0x10, size 0x180
    float currentTime; // offset 0x190, size 0x4
    unsigned char running; // offset 0x194, size 0x1
};
// Range: 0x80294A90 -> 0x80294B4C
// this: r31
zUICustomDescriptionScroller::zUICustomDescriptionScroller(class zUI * ui /* r30 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomDescriptionScroller::__vtable;
}
...
// Range: 0x80294B4C -> 0x80294BFC
// this: r31
void zUICustomDescriptionScroller::Reset() {
    // Local variables
    struct xBase * b; // r30
}
...
// total size: 0x2
struct /* @class$1614zUICustomScrollers_cpp */ {
    // Members
...
// Range: 0x80294BFC -> 0x80294C90
static int descstrlen(const char * baseText /* r3 */) {
    // Local variables
    int ret; // r30
    unsigned char inBlock; // r29
    unsigned int ch; // r31
}

// Range: 0x80294C90 -> 0x80294D68
static char * descstrncpy(char * dest /* r3 */, const char * source /* r4 */, int chars /* r5 */, char * * outDest /* r6 */, const char * * outSource /* r7 */) {
    // Local variables
    unsigned char inBlock; // r30
    unsigned int ch; // r31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65F2D
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$916zUICustomScrollers_cpp */ {
    // Members
...
union /* @class$628zUICustomScrollers_cpp */ {
...
// total size: 0xC
struct /* @class$1080zUICustomScrollers_cpp */ {
    // Members
...
// Range: 0x80294D68 -> 0x80294FB0
// this: r31
void zUICustomDescriptionScroller::PreUpdate(float dt /* r1+0x8 */) {
    // Local variables
    int numCharacters; // r29
    int length; // r25
    char * outDest; // r1+0x10
    int CHARS; // r30
    enum xRegion region; // r27
    const char * outSource; // r1+0xC
    int start; // r24
    int i; // r28
    float alpha; // f31
    ...
    // -> int DESCRIPTION_SCROLLER_FADE_CHARS;
    // -> float DESCRIPTION_SCROLLER_SPEED;
}
...
// Range: 0x80294FB0 -> 0x8029506C
// this: r31
unsigned char zUICustomDescriptionScroller::HandleEvent(unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    unsigned int sceneCurrent; // r27
    int scene; // r30
    struct Scene * sceneCur; // r29
}

// Range: 0x8029506C -> 0x8029510C
void zUICustomDescriptionScroller::AddTweaks(const char * baseName /* r31 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65F37
// total size: 0x54
struct {} zUICustomMapScroller::__vtable; // size: 0x54, address: 0x805257B0
// total size: 0x24
class zUICustomMapScroller : public zUICustom {
    // Functions
    zUICustomMapScroller(class zUI * ui);
    ...
    // Members
    struct _xCounter * counter; // offset 0x8, size 0x4
    float currentX; // offset 0xC, size 0x4
    float currentY; // offset 0x10, size 0x4
    float destX; // offset 0x14, size 0x4
    float destY; // offset 0x18, size 0x4
    float currentSpeed; // offset 0x1C, size 0x4
    unsigned char lastRunning; // offset 0x20, size 0x1
};
// Range: 0x8029510C -> 0x802951D4
// this: r31
zUICustomMapScroller::zUICustomMapScroller(class zUI * ui /* r30 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomMapScroller::__vtable;
}

// Range: 0x802951D4 -> 0x80295270
// this: r31
void zUICustomMapScroller::Reset() {
    // Local variables
    struct xBase * b; // r30
}

// Range: 0x80295270 -> 0x802952B8
// this: r1+0x8
unsigned char zUICustomMapScroller::HandleEvent(unsigned int toEvent /* r1+0xC */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65F3C
// Range: 0x802952B8 -> 0x80295594
// this: r31
void zUICustomMapScroller::PreUpdate(float dt /* f26 */) {
    // Local variables
    float dx; // f31
    float dy; // f30
    float distance; // f28
    ...
    // References
    // -> static char __FUNCTION__[10];
    // -> float MAP_SCROLLER_MAX_SPEED;
    // -> float MAP_SCROLLER_ACCELERATION;
    // -> float MAP_SCROLLER_SLOW_SPEED;
    // -> float MAP_SCROLLER_SLOW_DISTANCE;
}
...
// Range: 0x80295594 -> 0x802956AC
void zUICustomMapScroller::AddTweaks(const char * baseName /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8
...
// Range: 0x802956AC -> 0x802956C0
// this: r3
void zUICustomMapScroller::PreApplyMotionFrame(struct zUIMotionFrame * frame /* r4 */) {}

// Range: 0x802956C0 -> 0x802956C4
void zUICustomMapScroller::SignalEffect() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65F46
// total size: 0x54
struct {} zUICustomNumberScroller::__vtable; // size: 0x54, address: 0x8052575C
// total size: 0x90
class zUICustomNumberScroller : public zUICustom {
    // Functions
    zUICustomNumberScroller(class zUI * ui);
    ...
    // Members
    char buffer[128]; // offset 0x8, size 0x80
    int current; // offset 0x88, size 0x4
    float timeLeft; // offset 0x8C, size 0x4
};
// Range: 0x802956C4 -> 0x80295794
// this: r31
zUICustomNumberScroller::zUICustomNumberScroller(class zUI * ui /* r30 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomNumberScroller::__vtable;
}

// Range: 0x80295794 -> 0x802957A8
// this: r3
void zUICustomNumberScroller::Reset() {}

static int numbers[19]; // size: 0x4C, address: 0x80525710
// Range: 0x802957A8 -> 0x802958DC
// this: r31
void zUICustomNumberScroller::PreUpdate(float dt /* r1+0x8 */) {
    // Local variables
    char * bufferIterator; // r29
    int i; // r30
    class zUIText * text; // r26

    // References
    // -> float NUMBER_SCROLLER_SWITCH_TIME;
    // -> int NUMBER_SCROLLER_ELEMENTS_PER_LINE;
    // -> static int numbers[19];
}

// Range: 0x802958DC -> 0x80295938
void zUICustomNumberScroller::AddTweaks(const char * baseName /* r1+0x8 */) {
    // Local variables
