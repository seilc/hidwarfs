/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zWater.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801EBA2C -> 0x801EBDD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct /* @class$1663zWater_cpp */ {
    ...
    float reflectance_max; // offset 0x1C, size 0x4
    float reflect_intensity; // offset 0x20, size 0x4
    float reflect_magnitude; // offset 0x24, size 0x4
    float refract_min; // offset 0x28, size 0x4
    float refract_index; // offset 0x2C, size 0x4
};
// total size: 0xB4
struct motion_config {
    ...
    int motion_type; // offset 0x44, size 0x4
    unsigned char active; // offset 0x48, size 0x1
    float lod_dist_min; // offset 0x4C, size 0x4
    float lod_dist_interval; // offset 0x50, size 0x4
    int shimmer; // offset 0x54, size 0x4
    int refract_glow; // offset 0x58, size 0x4
    unsigned int random_seed; // offset 0x5C, size 0x4
    float gravity; // offset 0x60, size 0x4
    float wind_speed; // offset 0x64, size 0x4
    float wind_dir; // offset 0x68, size 0x4
    float scale_speed; // offset 0x6C, size 0x4
    float phil_const; // offset 0x70, size 0x4
    float wave_scale; // offset 0x74, size 0x4
    float convergence; // offset 0x78, size 0x4
    float choppiness; // offset 0x7C, size 0x4
    float max_height; // offset 0x80, size 0x4
    // total size: 0x30
    struct /* @class$1663zWater_cpp */ {
        // Members
        float color_mul_red; // offset 0x0, size 0x4
...
// total size: 0x1
struct /* @class$745zWater_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$746zWater_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$747zWater_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$748zWater_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64228
// total size: 0x8
struct debug_info {
    // Members
    float light_dir_yaw; // offset 0x0, size 0x4
    float light_dir_pitch; // offset 0x4, size 0x4
};
// total size: 0x3C
...
// Range: 0x801EBA2C -> 0x801EBBE4
void zWaterBody::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x801EBBE4 -> 0x801EBBF4
char * asset_type::type_name() {}

// Range: 0x801EBBF4 -> 0x801EBC00
// this: r3
void zWaterBody::show() {}

// Range: 0x801EBC00 -> 0x801EBC0C
// this: r3
void zWaterBody::hide() {}

// Range: 0x801EBC0C -> 0x801EBC8C
// this: r31
void zWaterBody::load(const struct asset_type & a /* r1+0x8 */) {}

// Range: 0x801EBC8C -> 0x801EBC98
// this: r3
unsigned int zWaterBody::get_bodyID() {}
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6422D
// Range: 0x801EBC98 -> 0x801EBDD4
void zWaterBody::cb_dispatch(struct xBase * to /* r30 */, unsigned int event /* r1+0x8 */) {
    // Local variables
    class zWaterBody & e; // r31

    // References
    // -> static char __FUNCTION__[12];
}

enum /* @enum$1650zWater_cpp */ {
    FLAG_VISIBLE = 1,
    FLAG_NO_OVERFILL = 2,
};
...
struct xWaterShading {
    // Members
    struct xVec3 light_dir; // offset 0x0, size 0xC
    ...
    float reflectance_max; // offset 0x2C, size 0x4
    float reflect_intensity; // offset 0x30, size 0x4
    float reflect_magnitude; // offset 0x34, size 0x4
    float refract_min; // offset 0x38, size 0x4
    float refract_index; // offset 0x3C, size 0x4
    enum RwBlendFunction blend_src; // offset 0x40, size 0x4
    enum RwBlendFunction blend_dst; // offset 0x44, size 0x4
};
// total size: 0x1
