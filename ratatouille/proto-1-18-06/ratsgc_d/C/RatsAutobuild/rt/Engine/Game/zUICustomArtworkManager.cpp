/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomArtworkManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802979D0 -> 0x802985EC
*/
class zUICustomArtworkManager * pUICustomArtworkManager; // size: 0x4, address: 0x80D6B418
static float ARTWORK_SCROLL_TIMER; // size: 0x4, address: 0x80D65FA8
static unsigned char unlockedBonus[80]; // size: 0x50, address: 0x80D2AF18
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x802979D0 -> 0x802979E4
void zUIIncrediblesSetUnlockedBonus(unsigned int i /* r3 */, unsigned char value /* r4 */) {
    // References
    // -> static unsigned char unlockedBonus[80];
}

// Range: 0x802979E4 -> 0x802979F8
unsigned char zUIIncrediblesGetUnlockedBonus(unsigned int i /* r3 */) {
    // References
    // -> static unsigned char unlockedBonus[80];
}

// Range: 0x802979F8 -> 0x80297A00
unsigned int zUIIncrediblesGet_TOTAL_BONUS() {}

// total size: 0x54
struct {} zUICustomArtworkManager::__vtable; // size: 0x54, address: 0x80525B50
// total size: 0x34
...
// Range: 0x80297A00 -> 0x80297A44
// this: r31
zUICustomArtworkManager::zUICustomArtworkManager(class zUI * ui /* r1+0x8 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65FAC
// total size: 0xC
...
void zUICustomArtworkManager::Init() {
    ...
    unsigned int i; // r25
    struct xBase * b; // r28
    class zUIImage * ui; // r30
    int itemIterator; // r23
    unsigned int i; // r24
    struct xBase * b; // r27
    class zUIImage * image; // r22
    unsigned int i; // r26
...
// Range: 0x80297E70 -> 0x80298294
// this: r31
unsigned char zUICustomArtworkManager::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r1+0xC */) {
    // Local variables
    int i; // r30
    char buffer[32]; // r1+0x10
    char textBuffer[48]; // r1+0x30
...
// Range: 0x80298294 -> 0x802983E8
// this: r31
void zUICustomArtworkManager::PreUpdate(float dt /* r1+0x8 */) {}
...
// Range: 0x802983E8 -> 0x80298444
void zUICustomArtworkManager::AddTweaks(const char * baseName /* r1+0x8 */) {
    // Local variables
...
static int translationTable[80]; // size: 0x140, address: 0x80525A10
// Range: 0x80298520 -> 0x802985EC
void zUICustomArtworkManager::AddArtworkIndex(char * buffer /* r31 */, int index /* r29 */) {
    // Local variables
    int realIndex; // r28
    int unlockIndex; // r30
