/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemSnow.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802748C0 -> 0x80276328
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float FADE_TIME; // size: 0x4, address: 0x80D65978
static float DAMPENING; // size: 0x4, address: 0x80D6597C
static float MAX_RENDER_DISTANCE; // size: 0x4, address: 0x80D65980
static float MAX_BOX_SIZE; // size: 0x4, address: 0x80D65984
static int MAX_PARTICLE_BLOCKS; // size: 0x4, address: 0x80D65988
// total size: 0x8
...
// total size: 0x24
class zParticleSystemSnow : public zParticleSystem {
    // Functions
...
// Range: 0x802748C0 -> 0x80274934
// this: r1+0x8
struct zParticleGenerator * zParticleSystemSnow::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorSnow * gen; // r30
}

unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80274970 -> 0x8027499C
// this: r1+0x8
void zParticleSystemSnow::scene_enter() {}

// Range: 0x8027499C -> 0x802749CC
// this: r1+0x8
void zParticleSystemSnow::update(float dt /* r1+0xC */) {}
...
// Range: 0x802749CC -> 0x802749D4
int zParticleSystemSnow::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6598C
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$840zParticleSystemSnow_cpp */ {
    // Members
...
struct particle_instance {
    ...
    struct zParticleSnowSubBox * subBoxPtr; // offset 0xC, size 0x4
    struct xVec3 orig; // offset 0x10, size 0xC
    float scale; // offset 0x1C, size 0x4
    struct xVec2 driftSpeed; // offset 0x20, size 0x8
    float rotation; // offset 0x28, size 0x4
    signed short rotSpeed; // offset 0x2C, size 0x2
    unsigned short flags; // offset 0x2E, size 0x2
};
// total size: 0x1C
struct asset_data {
    // Members
    float gravity; // offset 0x0, size 0x4
    float driftForce; // offset 0x4, size 0x4
    float maxDriftSpeed; // offset 0x8, size 0x4
    float maxDriftDist; // offset 0xC, size 0x4
    float minScale; // offset 0x10, size 0x4
    float maxScale; // offset 0x14, size 0x4
    float maxRotSpeed; // offset 0x18, size 0x4
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x802749D4 -> 0x80275128
int zParticleSystemSnow::update_particles(unsigned char * mem /* r18 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f27 */, void * context /* r19 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & _fptank_pool; // r30
    int _fptank_used; // r27
    struct xVec3 * pool_pos; // r24
    struct xColor_tag * pool_color; // r28
    struct xVec2 * pool_size; // r23
    float * pool_rot; // r26
    struct xVec2 * pool_uv; // r25
    struct particle_instance * p; // r31
    struct particle_instance * end; // r21
    struct zParticleGeneratorSnow & g; // r22
    struct asset_data & a; // r29
    float gravity; // f22
    float height; // f24
    float driftForce; // f21
    float maxDriftSpeed; // f31
    float maxDriftDist; // f26
    float fadeDist; // f25
    const struct xVec3 & camPos; // r20
    float distTraveled; // f28
    float newDriftForceX; // f30
    float newDriftForceZ; // f29
    float driftDistanceX; // f20
    float driftDistanceZ; // f19
    struct RwSphere worldsph; // r1+0x44
    float alpha; // f23
    float u; // f18
    float v; // r1+0x40
    float uOffset; // r1+0x3C
    float vOffset; // r1+0x38
...
// total size: 0x20
struct zParticleSnowSubBox {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
    struct xVec3 translatedCenter; // offset 0xC, size 0xC
    float emitted; // offset 0x18, size 0x4
    unsigned char active; // offset 0x1C, size 0x1
    unsigned char firstEmit; // offset 0x1D, size 0x1
};
// total size: 0xC
struct debug {
    // Members
    ...
    int activeBoxes; // offset 0x8, size 0x4
};
// total size: 0x130
struct zParticleGeneratorSnow : public zParticleGenerator {
    // Functions
    void updateSubBoxStatus(int & activeBoxes, int & newBoxes);

    int makeLocations(struct particleLocation * locList, float dt);

    void update(float dt);

    void create(class zParticleSystemSnow & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemSnow * system; // offset 0xA4, size 0x4
    ...
    unsigned char firstEmit; // offset 0xC0, size 0x1
    unsigned char killParticles; // offset 0xC1, size 0x1
    int numSubBoxes; // offset 0xC4, size 0x4
    float subBoxRowSize; // offset 0xC8, size 0x4
    float subBoxColSize; // offset 0xCC, size 0x4
    float subBoxHeight; // offset 0xD0, size 0x4
    float subBoxRadius; // offset 0xD4, size 0x4
    struct xMat4x3 subBoxRotMat; // offset 0xE0, size 0x40
    struct zParticleSnowSubBox * subBoxList; // offset 0x120, size 0x4
    struct debug debugInfo; // offset 0x124, size 0xC
};
// Range: 0x80275128 -> 0x8027522C
// this: r30
void zParticleGeneratorSnow::updateSubBoxStatus(int & activeBoxes /* r28 */, int & newBoxes /* r29 */) {
    // Local variables
    struct zParticleSnowSubBox * boxPtr; // r31
    struct zParticleSnowSubBox * endPtr; // r27
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6599D
// total size: 0x10
struct particleLocation {
    // Members
    struct xVec3 loc; // offset 0x0, size 0xC
    struct zParticleSnowSubBox * boxPtr; // offset 0xC, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8027522C -> 0x802754A8
// this: r31
int zParticleGeneratorSnow::makeLocations(struct particleLocation * locList /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    const struct asset_data & a; // r26
    int particleCounter; // r27
    struct zParticleSnowSubBox * boxPtr; // r30
    struct zParticleSnowSubBox * endPtr; // r25
    int emit; // r28
    float x; // f31
    float z; // f30
    ...
    // References
    // -> static int MAX_PARTICLE_BLOCKS;
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D659AB
// Range: 0x802754A8 -> 0x802758A0
// this: r31
void zParticleGeneratorSnow::update(float dt /* f31 */) {
    // Local variables
    const struct asset_data & a; // r29
    int activeBoxes; // r1+0x10
    int newBoxes; // r1+0xC
    int partAllocate; // r28
    struct particleLocation * locList; // r26
    int emit; // r27
    float minScale; // f30
    float maxScale; // f29
    float maxRotSpeed; // f28
    struct particleLocation * locPtr; // r25
    unsigned char * mem; // r1+0x8
    int have; // r24
    struct particle_instance * p; // r30
    struct particle_instance * endp; // r23
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D659B2
...
// Range: 0x802758A0 -> 0x80275C6C
// this: r31
void zParticleGeneratorSnow::create(class zParticleSystemSnow & system /* r23 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x14
    int numRows; // r29
    int numCols; // r28
    int rowsToEdge; // r22
    int colsToEdge; // r21
    struct xVec3 topLeft; // r1+0x8
    struct zParticleSnowSubBox * boxPtr; // r27
    int i; // r26
    int j; // r25
    ...
    // -> static float MAX_BOX_SIZE;
}

// Range: 0x80275C6C -> 0x80275D04
// this: r31
void zParticleGeneratorSnow::reset() {}

// Range: 0x80275D04 -> 0x80275D58
// this: r31
void zParticleGeneratorSnow::activate() {}

// Range: 0x80275D58 -> 0x80275DA4
// this: r31
void zParticleGeneratorSnow::deactivate() {}

// Range: 0x80275DA4 -> 0x80275DEC
// this: r31
void zParticleGeneratorSnow::resume() {}

// Range: 0x80275DEC -> 0x80275E20
// this: r31
void zParticleGeneratorSnow::pause() {}
...
// Range: 0x80275E20 -> 0x80275E84
// this: r1+0x8
unsigned char zParticleGeneratorSnow::cullUpdate() {
    // Local variables
    struct xSphere sphere; // r1+0xC
...
// Range: 0x80275E84 -> 0x802761B8
// this: r30
void zParticleGeneratorSnow::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
...
// Range: 0x802761B8 -> 0x80276328
// this: r31
void zParticleGeneratorSnow::debug_render(unsigned char all /* r29 */) {
    // Local variables
    struct xVec3 dimensions; // r1+0x10
    struct xBox box; // r1+0x1C
    int i; // r30
    struct xMat4x3 mat; // r1+0x40
}

// total size: 0x2C
struct {} zParticleGeneratorSnow::__vtable; // size: 0x2C, address: 0x80524C30
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemSnow_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemSnow_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemSnow_cpp */ {
    // Members
...
union /* @class$827zParticleSystemSnow_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemSnow::__vtable; // size: 0x3C, address: 0x80524C5C
// total size: 0x8
