/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPendulum.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8018D1C8 -> 0x8018DBC8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8018D1C8 -> 0x8018D1F8
void zPendulum_Init(void * pend /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D632C0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1053zPendulum_cpp */ {
    // Members
...
// total size: 0x1F0
struct _zPendulum : public zEnt {
    // Members
    struct xEntMotion motion; // offset 0xE0, size 0x100
    float lt; // offset 0x1E0, size 0x4
    float q1t; // offset 0x1E4, size 0x4
    float q3t; // offset 0x1E8, size 0x4
};
// Range: 0x8018D1F8 -> 0x8018D428
void zPendulum_Init(struct _zPendulum * pend /* r31 */, struct xEntAsset * asset /* r29 */) {
    // Local variables
    struct xEntMotionAsset * motionAsset; // r30

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D632CF
// total size: 0x0
struct xSerial {};
// Range: 0x8018D428 -> 0x8018D518
void zPendulum_Save(struct _zPendulum * pend /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D632DE
// Range: 0x8018D518 -> 0x8018D608
void zPendulum_Load(struct _zPendulum * pend /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8018D608 -> 0x8018D644
void zPendulum_Setup(struct _zPendulum * pend /* r31 */, struct xScene * sc /* r1+0x8 */) {}

// Range: 0x8018D644 -> 0x8018D770
void zPendulum_Reset(struct _zPendulum * pend /* r31 */, struct xScene * sc /* r1+0x8 */) {
    // Local variables
    struct xEntMotionPenData * aspen; // r30
}

// Range: 0x8018D770 -> 0x8018D848
void zPendulum_Update(struct _zPendulum * pend /* r31 */, struct xScene * sc /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    struct xEntMotionPenData * aspen; // r30
    float t; // f31
}

// Range: 0x8018D848 -> 0x8018D88C
void zPendulum_Move(struct _zPendulum * pend /* r1+0x8 */, struct xScene * s /* r1+0xC */, float dt /* r1+0x10 */, struct xEntFrame * frame /* r1+0x14 */) {}

// Range: 0x8018D88C -> 0x8018D8E8
static void zPendulumTranslate(struct xEnt * xent /* r1+0x8 */, struct xVec3 * dpos /* r29 */, struct xMat4x3 * dmat /* r30 */) {
    // Local variables
    struct _zPendulum * pend; // r31
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D632ED
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x8018D8E8 -> 0x8018DBC8
void zPendulumEventCB(struct xBase * to /* r26 */, unsigned int toEvent /* r27 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r28 */) {
    // Local variables
    struct _zPendulum * pend; // r31
