/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGrid.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80174140 -> 0x80174CB0
*/
// total size: 0x18
struct xGridBound {
    // Members
...
static int zGridInitted; // size: 0x4, address: 0x80D6A508
static unsigned int special_models[58]; // size: 0xE8, address: 0x8051F198
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80174140 -> 0x801741FC
static void hack_flag_shadows(struct zScene * s /* r3 */) {
    // Local variables
    const unsigned int * end_special_models; // r28
    struct xBase * * it; // r30
    struct xBase * * end; // r27
    struct xEnt * ent; // r31
    unsigned int * id; // r29

    // References
    // -> static unsigned int special_models[58];
}

// Range: 0x801741FC -> 0x801742E8
void zGridReset(struct zScene * s /* r28 */) {
    // Local variables
    int i; // r29
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D62E08
// total size: 0x18
struct xBox {
    // Members
...
// Range: 0x801742E8 -> 0x80174A30
void zGridInit(struct zScene * s /* r1+0x8 */) {
    // Local variables
    const struct xBox * ebox; // r31
    float grsizex; // f30
    float grsizez; // f29
    float defr; // f28
    float min_csize; // f31
    struct xBox osobox; // r1+0x54
...
// Range: 0x80174A84 -> 0x80174AF0
static unsigned char IsEntityGrabbable(struct xEnt * ent /* r3 */) {
    // Local variables
    struct zSurfaceProps * props; // r31
}

// Range: 0x80174AF0 -> 0x80174CB0
void zGridUpdateEnt(struct xEnt * ent /* r31 */) {
    // Local variables
    unsigned char oversize; // r29
    struct xGrid * grid; // r30
