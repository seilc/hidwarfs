/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXLightDust.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025A9E8 -> 0x8025B7FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80D6B1D0
// total size: 0x58
struct config {
    // Members
...
// Range: 0x8025A9E8 -> 0x8025ABAC
void light_dust::setup() {
    // References
...
int system_id; // size: 0x4, address: 0x80D65590
// total size: 0x28
...
// Range: 0x8025ABAC -> 0x8025AC44
void light_dust::scene_setup() {
    // Local variables
...
// Range: 0x8025AC44 -> 0x8025B048
void light_dust::add_tweaks(const char * prefix /* r30 */, struct config * dust /* r31 */) {}
...
// total size: 0xC
struct /* @class$768zFXLightDust_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$769zFXLightDust_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zFXLightDust_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$771zFXLightDust_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$772zFXLightDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$773zFXLightDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$774zFXLightDust_cpp */ {
    // Members
...
// Range: 0x8025B048 -> 0x8025B4A8
void light_dust::emit(const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & normal /* r27 */, float & emit_remaining /* r30 */, const struct xVec3 & velocity /* r1+0xC */, float dt /* f31 */, struct config * cfg /* r31 */, float velocity_scale /* r1+0x10 */, float emit_scale /* f29 */) {
    // Local variables
    float denom; // f25
...
// total size: 0x4
struct /* @class$1150zFXLightDust_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zFXLightDust_cpp */ {
    // Members
...
union /* @class$819zFXLightDust_cpp */ {
...
// total size: 0x10
struct /* @class$832zFXLightDust_cpp */ {
    // Members
...
// Range: 0x8025B4A8 -> 0x8025B7FC
int light_dust::update(unsigned char * mem /* r26 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
