/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCLeftArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8031FBB4 -> 0x8031FD6C
*/
char __FUNCTION__$localstatic1$AttachComponent__59zComponentPool<17zCompLogicLeftArm,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67848
signed char zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B998
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B99C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x8031FC34 -> 0x8031FC5C
// this: r1+0x8
void zNPCLeftArm::Deactivate() {}

// Range: 0x8031FC5C -> 0x8031FD20
// this: r30
void zNPCLeftArm::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$984zNPCLeftArm_cpp */ {
    // Members
...
union /* @class$1124zNPCLeftArm_cpp */ {
...
// total size: 0xC
struct /* @class$1122zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$861zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$862zNPCLeftArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$863zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$864zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$865zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCLeftArm::__vtable; // size: 0x3C, address: 0x8052D628
