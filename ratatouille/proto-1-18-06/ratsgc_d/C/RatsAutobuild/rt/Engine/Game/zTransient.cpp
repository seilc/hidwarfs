/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zTransient.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C42CC -> 0x801C4848
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1096zTransient_cpp */ {
    // Members
...
union /* @class$1085zTransient_cpp */ {
...
// total size: 0xC
struct /* @class$1243zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$925zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$926zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$927zTransient_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$928zTransient_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$929zTransient_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$930zTransient_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$931zTransient_cpp */ {
    // Members
...
// Range: 0x801C42CC -> 0x801C43A4
static void get_world_box(struct xBox & world_box /* r28 */) {
    // Local variables
    struct zScene & scene; // r29
    struct xBox box; // r1+0x8
    const struct zFlameEmitter * flame; // r31
    const struct zFlameEmitter * end_flame; // r27
    const struct xBox * jspbox; // r30
    const struct xBox * const end_jspbox; // r26

    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D63C78
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x801C43A4 -> 0x801C4644
static unsigned char cb_check_damage(union entry_data * e /* r28 */, void * context /* r1+0x8 */) {
    // Local variables
    struct check_damage_data * data; // r30
    struct damage_result & result; // r31
    const struct zFlame * flame; // r27
    const struct presence_volume * plode; // r29
...
// Range: 0x801C4644 -> 0x801C4678
void scene_enter() {
    // Local variables
    struct xBox world_box; // r1+0x8
}

// Range: 0x801C4678 -> 0x801C46A0
void scene_exit() {}

// Range: 0x801C46A0 -> 0x801C46C0
void setup() {}

// Range: 0x801C46C0 -> 0x801C46EC
void reset() {}

// Range: 0x801C46EC -> 0x801C4728
void update(float dt /* f31 */) {}

// Range: 0x801C4728 -> 0x801C4750
void render() {}
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D63C88
// Range: 0x801C4750 -> 0x801C4848
int check_damage(struct damage_result * results /* r1+0x8 */, const struct xBox & box /* r31 */, int max_results /* r30 */, int coll_type /* r1+0xC */, int type_filter /* r1+0x10 */) {
    // Local variables
    struct check_damage_data data; // r1+0x14
