/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMission.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8030F150 -> 0x803106E4
*/
static unsigned char sDebugOutput; // size: 0x1, address: 0x80D67480
static unsigned char sConditionMadeChange; // size: 0x1, address: 0x80D6B8C8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8030F150 -> 0x8030F1A0
static void TaskEventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67481
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
// total size: 0x5C
struct zTaskAsset : public xDynAsset {
    // Static members
    static int VERSION; // size: 0x4

    // Members
    unsigned int checkpointID; // offset 0x10, size 0x4
    unsigned char required; // offset 0x14, size 0x1
    enum ezTaskAvailability initialAvailability; // offset 0x18, size 0x4
    unsigned int requiredTask[16]; // offset 0x1C, size 0x40
};
// total size: 0x28
struct zCheckpointAsset : public xDynAsset {
    // Members
    unsigned int number; // offset 0x10, size 0x4
    unsigned int triggerID; // offset 0x14, size 0x4
    unsigned int scriptID; // offset 0x18, size 0x4
    unsigned int cameraID; // offset 0x1C, size 0x4
    unsigned int pointerMrIID; // offset 0x20, size 0x4
    unsigned int pointerFrozoneID; // offset 0x24, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0x1
struct /* @class$868zMission_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$869zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$870zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$871zMission_cpp */ {
    // Members
...
// total size: 0x40
class zCheckpoint : private xBase {
    // Static members
    static unsigned int lastCheckpointNumber; // size: 0x4
    static unsigned int currentActive; // size: 0x4

    // Members
    struct zCheckpointAsset * asset; // offset 0x10, size 0x4
    struct zEntTrigger * trigger; // offset 0x14, size 0x4
    struct pointer_asset * pointerMrI; // offset 0x18, size 0x4
    struct pointer_asset * pointerFrozone; // offset 0x1C, size 0x4
    struct xLinkAsset triggerLink; // offset 0x20, size 0x20
};
enum ezTaskCompletionStatus {
    eTCS_Incomplete = 0,
    eTCS_Completed = 1,
};
// total size: 0x60
class zTask : public xBase {
    // Functions
    void Setup();
    ...
    void TestForAvailability();

    void OnChangeInConditions();

    void Save(struct xSerial * s);

    void Load(struct xSerial * s);

    char * GetTxtTaskStatus();

    char * GetTxtTaskAvailable();

    char * GetTxtRequired();

    // Members
protected:
    struct zTaskAsset * asset; // offset 0x10, size 0x4
    class zCheckpoint * checkpoint; // offset 0x14, size 0x4
    class zTask * requiredTask[16]; // offset 0x18, size 0x40
    enum ezTaskAvailability available; // offset 0x58, size 0x4
    enum ezTaskCompletionStatus completionStatus; // offset 0x5C, size 0x4
};
// Range: 0x8030F1A0 -> 0x8030F380
void zTask::Init(struct xBase & data /* r27 */, struct xDynAsset & dynasset /* r30 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zTask * newTask; // r31

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x8030F380 -> 0x8030F384
void zTask::Reset() {}

// Range: 0x8030F384 -> 0x8030F418
// this: r31
void zTask::Setup() {
    // Local variables
    int i; // r30
...
// Range: 0x8030F418 -> 0x8030F534
// this: r31
void zTask::HandleEvent(unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static unsigned char sDebugOutput;
}

// Range: 0x8030F534 -> 0x8030F5AC
// this: r31
void zTask::Fail() {
    // References
    // -> static unsigned char sDebugOutput;
...
// Range: 0x8030F638 -> 0x8030F6CC
// this: r31
void zTask::TestForAvailability() {
    // References
    // -> static unsigned char sConditionMadeChange;
    // -> static unsigned char sDebugOutput;
}

// Range: 0x8030F6CC -> 0x8030F6F4
// this: r1+0x8
void zTask::OnChangeInConditions() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67486
// Range: 0x8030F6F4 -> 0x8030F7D0
// this: r30
void zTask::Save(struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6748B
// total size: 0x0
...
// Range: 0x8030F7D0 -> 0x8030F8C4
// this: r31
void zTask::Load(struct xSerial * s /* r30 */) {
    // Local variables
    unsigned int input; // r1+0x8

    // References
    // -> static char __FUNCTION__[5];
}

static char * taskTxt[2]; // size: 0x8, address: 0x80D67490
// Range: 0x8030F8C4 -> 0x8030F8D8
// this: r3
char * zTask::GetTxtTaskStatus() {
    // References
    // -> static char * taskTxt[2];
}

static char * taskTxt[2]; // size: 0x8, address: 0x80D67498
// Range: 0x8030F8D8 -> 0x8030F8EC
// this: r3
char * zTask::GetTxtTaskAvailable() {
    // References
    // -> static char * taskTxt[2];
}

static char * taskTxt[2]; // size: 0x8, address: 0x80D674A0
// Range: 0x8030F8EC -> 0x8030F910
// this: r3
char * zTask::GetTxtRequired() {
    // References
    // -> static char * taskTxt[2];
}

// Range: 0x8030F910 -> 0x8030F960
static void MissionEventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D674A8
enum ezMissionStatus {
    eMS_Locked = 0,
    eMS_Unlocked = 1,
    eMS_Completed = 2,
};
// total size: 0x6C
struct zMissionAsset : public xDynAsset {
    // Static members
    static int VERSION; // size: 0x4

    // Members
    unsigned int requiredMission[4]; // offset 0x10, size 0x10
    enum ezMissionStatus initialLockStatus; // offset 0x20, size 0x4
    unsigned char onceOnly; // offset 0x24, size 0x1
    unsigned char loadInSlot; // offset 0x25, size 0x1
    unsigned int task[16]; // offset 0x28, size 0x40
    unsigned int externalLoadID; // offset 0x68, size 0x4
};
// total size: 0x14
...
// total size: 0x74
class zMission : public xBase {
    // Functions
    void Setup();

    char * GetTxtMissionStatus();
    ...
    // Members
protected:
    struct zMissionAsset * asset; // offset 0x10, size 0x4
    class zMission * requiredMission[4]; // offset 0x14, size 0x10
    class zTask * missionTask[16]; // offset 0x24, size 0x40
    struct _zScript * scriptReset; // offset 0x64, size 0x4
    struct _zScript * scriptCompletion; // offset 0x68, size 0x4
    struct _zScript * scriptFail; // offset 0x6C, size 0x4
    enum ezMissionStatus missionStatus; // offset 0x70, size 0x4
};
// Range: 0x8030F960 -> 0x8030FB4C
void zMission::Init(struct xBase & data /* r27 */, struct xDynAsset & dynasset /* r30 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zMission * newMission; // r31

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x8030FB4C -> 0x8030FB50
void zMission::Reset() {}

// Range: 0x8030FB50 -> 0x8030FC08
// this: r31
void zMission::Setup() {
    // Local variables
    int i; // r30
...
static char * missionTxt[3]; // size: 0xC, address: 0x80D674B0
// Range: 0x8030FC08 -> 0x8030FC1C
// this: r3
char * zMission::GetTxtMissionStatus() {
    // References
    // -> static char * missionTxt[3];
}

// Range: 0x8030FC1C -> 0x8030FDDC
// this: r31
void zMission::DumpLog() {
    // Local variables
...
// Range: 0x8030FDDC -> 0x8030FE14
static struct xBase * _DumpLogCB(struct xBase * obj /* r1+0x8 */) {
    // Local variables
    class zMission * mission; // r31
}

// Range: 0x8030FE14 -> 0x8030FE58
static void zMissionDumpALog() {}

static unsigned char alreadyAdded; // size: 0x1, address: 0x80D6B8C9
static signed char init; // size: 0x1, address: 0x80D6B8CA
// total size: 0x28
...
static struct tweak_callback cb_dump_a_log; // size: 0x28, address: 0x804DB480
// Range: 0x8030FE58 -> 0x8030FEEC
void zMission::AddStaticTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static unsigned char alreadyAdded;
    // -> static struct tweak_callback cb_dump_a_log;
    // -> static signed char init;
}

// Range: 0x8030FEEC -> 0x8030FEF0
void zMission::AddDebugTweaks() {}

// Range: 0x8030FEF0 -> 0x8030FFD8
// this: r31
void zMission::Unlock() {
    // References
    // -> static unsigned char sDebugOutput;
}

// Range: 0x8030FFD8 -> 0x8031007C
// this: r31
void zMission::Lock() {
    // References
    // -> static unsigned char sDebugOutput;
...
// Range: 0x8031007C -> 0x80310198
// this: r31
void zMission::HandleEvent(unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static unsigned char sDebugOutput;
}

// Range: 0x80310198 -> 0x80310264
// this: r31
void zMission::TestForUnlocking() {
    // Local variables
    int i; // r30
    class zMission * rq; // r29
...
// Range: 0x80310264 -> 0x80310358
// this: r31
void zMission::TestForCompletion() {
    // Local variables
    int i; // r29
    class zTask * task; // r30
...
// Range: 0x80310358 -> 0x8031038C
// this: r31
void zMission::OnChangeInConditions() {}

// Range: 0x8031038C -> 0x803103C4
static struct xBase * _MissionIterator(struct xBase * obj /* r1+0x8 */) {
    // Local variables
    class zMission * mission; // r31
}

// Range: 0x803103C4 -> 0x803103FC
static struct xBase * _TaskIterator(struct xBase * obj /* r1+0x8 */) {
    // Local variables
    class zTask * task; // r31
}

// Range: 0x803103FC -> 0x80310468
void zMission::OnChangeInMissionConditions() {
    // References
    // -> static unsigned char sConditionMadeChange;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D674BC
// Range: 0x80310468 -> 0x8031059C
// this: r29
void zMission::Save(struct xSerial * s /* r30 */) {
    // Local variables
    unsigned int output; // r31

    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D674C1
// Range: 0x8031059C -> 0x803106E4
// this: r31
void zMission::Load(struct xSerial * s /* r30 */) {
    // Local variables
    unsigned int input; // r1+0x8
