/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zScreenWarp.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027C858 -> 0x8027D1C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zScreenWarp * sWarpList; // size: 0x4, address: 0x80D6B2F0
static char * sWarpTypeLabels[6]; // size: 0x18, address: 0x80524D70
static unsigned int sWarpTypeValues[6]; // size: 0x18, address: 0x804C8E70
// total size: 0x28
...
static struct tweak_callback cb_enable; // size: 0x28, address: 0x804C8E88
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$925zScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1081zScreenWarp_cpp */ {
    // Members
...
union /* @class$827zScreenWarp_cpp */ {
...
// total size: 0x10
struct /* @class$1631zScreenWarp_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
class zScreenWarp : private xBase {
    ...
    void Enable(unsigned char bEnable);
    ...
    // Members
public:
    unsigned char renderDebugSphere; // offset 0x10, size 0x1
private:
    class zScreenWarp * next; // offset 0x14, size 0x4
    struct zScreenWarpAsset * asset; // offset 0x18, size 0x4
    float timer; // offset 0x1C, size 0x4
    unsigned int flags; // offset 0x20, size 0x4
};
// Range: 0x8027C858 -> 0x8027CAF0
// this: r31
void zScreenWarp::addDebugTweaks() {
    // Local variables
    char prefix[128]; // r1+0x10

    // References
    // -> static struct tweak_callback cb_enable;
    // -> static unsigned int sWarpTypeValues[6];
    // -> static char * sWarpTypeLabels[6];
    // -> struct xGlobals * xglobals;
}

enum zScreenWarpFlags {
    SW_FLAG_ENABLED = 1,
    SW_FLAG_RUNNING = 2,
};
enum type_enum {
...
// total size: 0xC
struct /* @class$761zScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$762zScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$763zScreenWarp_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$764zScreenWarp_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$765zScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$766zScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$767zScreenWarp_cpp */ {
    // Members
...
// Range: 0x8027CAF0 -> 0x8027CB50
void zScreenWarp::on_enable(const struct tweak_info & info /* r29 */) {
    // Local variables
    class zScreenWarp * sw; // r31
}

// Range: 0x8027CB50 -> 0x8027CB5C
void zScreenWarp::SceneEnter() {
    // References
    // -> static class zScreenWarp * sWarpList;
}

// Range: 0x8027CB5C -> 0x8027CB9C
void zScreenWarp::ResetAll() {
    // Local variables
    class zScreenWarp * sw; // r31
...
// Range: 0x8027CB9C -> 0x8027CBE4
void zScreenWarp::UpdateAll(float dt /* r1+0x8 */) {
    // Local variables
    class zScreenWarp * sw; // r31
...
// Range: 0x8027CBE4 -> 0x8027CC24
void zScreenWarp::RenderAll() {
    // Local variables
    class zScreenWarp * sw; // r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65B10
// Range: 0x8027CC24 -> 0x8027CDF4
void zScreenWarp::Init(struct xBase & data /* r27 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zScreenWarp * sw; // r30
...
// total size: 0x3C
struct zScreenWarpAsset : public xDynAsset {
    // Members
    unsigned int effectType; // offset 0x10, size 0x4
    unsigned int flags; // offset 0x14, size 0x4
    struct xVec3 pos; // offset 0x18, size 0xC
    float radius; // offset 0x24, size 0x4
    float duration; // offset 0x28, size 0x4
    float repeatDelay; // offset 0x2C, size 0x4
    float intensity; // offset 0x30, size 0x4
    float frequency; // offset 0x34, size 0x4
    float triggerDistance; // offset 0x38, size 0x4
};
// Range: 0x8027CDF4 -> 0x8027CE04
char * zScreenWarpAsset::type_name() {}

// Range: 0x8027CE04 -> 0x8027CE6C
// this: r31
void zScreenWarp::Reset() {}

// Range: 0x8027CE6C -> 0x8027CE94
// this: r3
void zScreenWarp::Enable(unsigned char bEnable /* r4 */) {}

// Range: 0x8027CE94 -> 0x8027CF34
// this: r31
void zScreenWarp::Update(float dt /* r1+0x8 */) {}
...
// Range: 0x8027CF34 -> 0x8027D020
// this: r31
void zScreenWarp::UpdateState() {
    // Local variables
    const struct xVec3 * camPos; // r28
    float dist; // f31
    unsigned char bRunning; // r30

    // References
    // -> struct zGlobals globals;
}

// Range: 0x8027D020 -> 0x8027D070
// this: r31
void zScreenWarp::Render() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D65B15
// Range: 0x8027D070 -> 0x8027D1C4
void zScreenWarp::EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    class zScreenWarp * sw; // r31
