/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zVar.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801CF0C8 -> 0x801D15C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801CF0C8 -> 0x801CF0D0
unsigned int zVarEntryCB_IsSignedIn() {}

// Range: 0x801CF0D0 -> 0x801CF0D8
unsigned int zVarEntryCB_PendingFriendRequest() {}

// Range: 0x801CF0D8 -> 0x801CF0E0
unsigned int zVarEntryCB_PendingGameInvite() {}

int bad_card_available; // size: 0x4, address: 0x80D6AA80
int bad_card_needed; // size: 0x4, address: 0x80D6AA84
static char buffer[64]; // size: 0x40, address: 0x80D0D2B0
// Range: 0x801CF0E0 -> 0x801CF17C
...
static char buffer[12]; // size: 0xC, address: 0x80D6AA88
// Range: 0x801CF17C -> 0x801CF1B8
...
static char buffer[12]; // size: 0xC, address: 0x80D6AA94
// Range: 0x801CF1B8 -> 0x801CF1F4
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D63D60
// total size: 0x6C
...
struct zSaveLoadGame zSaveLoadGameTable[]; // size: 0x0, address: 0x80D01530
// Range: 0x801CF1F4 -> 0x801CFB6C
static char * zVarGameSlotInfo(int i /* r31 */, char * buffer /* r29 */, unsigned long max_len /* r22 */) {
    // Local variables
    char date[32]; // r1+0x48
    char time[32]; // r1+0x28
    int hour; // r30
    char ampm[32]; // r1+0x8
    char biggerbuf[256]; // r1+0x68
    const char * empty_string; // r28
    const char * damaged_save_name; // r27
    int size; // r21
    int size; // r20

    // References
    // -> static char __FUNCTION__[17];
    // -> struct zSaveLoadGame zSaveLoadGameTable[];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D2F0
// Range: 0x801CFB6C -> 0x801CFB9C
static char * var_text_GameSlot0() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D370
// Range: 0x801CFB9C -> 0x801CFBCC
static char * var_text_GameSlot1() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D3F0
// Range: 0x801CFBCC -> 0x801CFBFC
static char * var_text_GameSlot2() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D470
// Range: 0x801CFBFC -> 0x801CFC2C
static char * var_text_GameSlot3() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D4F0
// Range: 0x801CFC2C -> 0x801CFC5C
static char * var_text_GameSlot4() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D570
// Range: 0x801CFC5C -> 0x801CFC8C
static char * var_text_GameSlot5() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D5F0
// Range: 0x801CFC8C -> 0x801CFCBC
static char * var_text_GameSlot6() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80D0D670
// Range: 0x801CFCBC -> 0x801CFCEC
static char * var_text_GameSlot7() {
    // References
    // -> static char buffer[128];
}

static unsigned int state_text[4]; // size: 0x10, address: 0x80D6E960
static char __FUNCTION__[22]; // size: 0x16, address: 0x80521FF0
// Range: 0x801CFCEC -> 0x801CFD94
static char * var_text_MCAccessType() {
    // Local variables
    int i; // r31

    // References
    // -> static unsigned int state_text[4];
    // -> static char __FUNCTION__[22];
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAA0
// Range: 0x801CFD94 -> 0x801CFDD8
static char * var_text_MCAutoSaveCard() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x80D0D6F0
// Range: 0x801CFDD8 -> 0x801CFE78
...
static char buffer[12]; // size: 0xC, address: 0x80D6AAAC
// Range: 0x801CFE78 -> 0x801CFEBC
static char * var_text_MCSelectedGame() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAB8
// Range: 0x801CFEBC -> 0x801CFEFC
static char * var_text_SpaceAvailable() {
    // References
    // -> static char buffer[12];
}

static char buffer[64]; // size: 0x40, address: 0x80D0D710
// Range: 0x801CFEFC -> 0x801CFF90
static char * var_text_SpaceAvailableString() {
    // Local variables
    char spaceStr[32]; // r1+0x8
    int spaceAvailable; // r31

    // References
    // -> static char buffer[64];
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAC4
// Range: 0x801CFF90 -> 0x801CFFD0
static char * var_text_SpaceNeeded() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x80D0D750
// Range: 0x801CFFD0 -> 0x801D0060
static char * var_text_MCName() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x80D0D770
// Range: 0x801D0060 -> 0x801D00A4
static char * var_text_MCMaxSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x80D0D790
// Range: 0x801D00A4 -> 0x801D00E8
static char * var_text_MCMinSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAD0
// Range: 0x801D00E8 -> 0x801D013C
...
static char buffer[12]; // size: 0xC, address: 0x80D6AADC
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D63D71
// Range: 0x801D013C -> 0x801D01EC
static char * var_text_MissingPad() {
    // Local variables
    int startidx; // r1+0x8
...
// Range: 0x801D01EC -> 0x801D021C
static char * var_text_CurrentArea() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x80D0D7B0
static char __FUNCTION__[21]; // size: 0x15, address: 0x80522006
// Range: 0x801D021C -> 0x801D02BC
...
// Range: 0x801D02BC -> 0x801D02EC
static char * var_text_CurrentLevel() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x80D0D7D0
// Range: 0x801D02EC -> 0x801D0348
...
static char buffer[32]; // size: 0x20, address: 0x80D0D7F0
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052201B
// Range: 0x801D0348 -> 0x801D03E8
...
static char buffer[48]; // size: 0x30, address: 0x80D0D810
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x801D03E8 -> 0x801D0474
static char * var_text_PlayerPosition() {
    // Local variables
    const struct xVec3 & v; // r31
...
static unsigned int selSceneID; // size: 0x4, address: 0x80D6AAE8
// Range: 0x801D0474 -> 0x801D0498
static char * var_text_SelectedArea() {
    // References
    // -> static unsigned int selSceneID;
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAEC
// Range: 0x801D0498 -> 0x801D04DC
static char * var_text_SoundFXVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x80D6AAF8
// Range: 0x801D04DC -> 0x801D0520
static char * var_text_SoundMusicVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[5]; // size: 0x5, address: 0x80D6AB04
// Range: 0x801D0520 -> 0x801D0560
static char * var_text_HitCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x80D6AB09
// Range: 0x801D0560 -> 0x801D05A0
static char * var_text_TotalCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x80D6AB0E
// Range: 0x801D05A0 -> 0x801D0604
static char * var_text_UpgradePoints0() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[5]; // size: 0x5, address: 0x80D6AB13
// Range: 0x801D0604 -> 0x801D061C
static char * var_text_UpgradePoints1() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB18
// Range: 0x801D061C -> 0x801D0698
static char * var_text_Health0() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB22
// Range: 0x801D0698 -> 0x801D0714
static char * var_text_Health1() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB2C
// Range: 0x801D0714 -> 0x801D0778
static char * var_text_Experience0() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
// total size: 0x4
struct /* @class$2029zVar_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2030zVar_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$791zVar_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$792zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$793zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$794zVar_cpp */ {
    // Members
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB36
// Range: 0x801D0778 -> 0x801D0800
static char * var_text_Experience1() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB40
// Range: 0x801D0800 -> 0x801D0864
static char * var_text_XPtoUpgrade0() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[10]; // size: 0xA, address: 0x80D6AB4A
// Range: 0x801D0864 -> 0x801D08EC
static char * var_text_XPtoUpgrade1() {
    // Local variables
    struct zCommonPlayer * play; // r31
...
static char buffer[8]; // size: 0x8, address: 0x80D6AB54
// Range: 0x801D08EC -> 0x801D0938
static char * var_text_SceneBonus() {
    // References
...
static struct var_type vars[43]; // size: 0x204, address: 0x80522030
// Range: 0x801D0938 -> 0x801D09C4
static struct var_type * find_var(const struct substr & s /* r1+0x8 */) {
    // Local variables
    unsigned long start; // r31
    unsigned long end; // r30
    unsigned long i; // r29
    struct var_type & t; // r28
    int c; // r27

    // References
    // -> static struct var_type vars[43];
}

// total size: 0x2
struct /* @class$1885zVar_cpp */ {
    // Members
...
// Range: 0x801D09C4 -> 0x801D0A70
static void parse_tag_var(struct jot & j /* r31 */, const struct split_tag & ti /* r30 */) {}
...
static struct tag_type var_tag; // size: 0x14, address: 0x80D63D88
// Range: 0x801D0A70 -> 0x801D0A98
void var_init() {
    // References
    // -> static struct tag_type var_tag;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D63D9C
// Range: 0x801D0A98 -> 0x801D0B48
char * var_text(const struct substr & name /* r1+0x8 */) {
    // Local variables
    const struct var_type * var; // r31
...
struct zVarEntry zVarEntryTable[36]; // size: 0x240, address: 0x80522234
// total size: 0xC
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D63DA5
// Range: 0x801D0B48 -> 0x801D0C14
void zVarInit(struct zVarEntry * table /* r30 */) {
    // Local variables
    int i; // r31
...
// Range: 0x801D0C18 -> 0x801D0C50
unsigned int zVarEntryCB_SndMode() {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x801D0C50 -> 0x801D0CA4
unsigned int zVarEntryCB_SndMusicVol() {
    // Local variables
    unsigned int volume; // r31
    float floatVol; // f31
}

// Range: 0x801D0CA4 -> 0x801D0CF8
...
// Range: 0x801D0CF8 -> 0x801D0DBC
unsigned int zVarEntryCB_MCAvailable() {
    // Local variables
    struct st_XSAVEGAME_DATA * data; // r31
}

// Range: 0x801D0DBC -> 0x801D0DD0
unsigned int zVarEntryCB_VibrationOnP1() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D0DD0 -> 0x801D0DE4
unsigned int zVarEntryCB_VibrationOnP2() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D0DE4 -> 0x801D0DF8
unsigned int zVarEntryCB_SubtitlesOn() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D0DF8 -> 0x801D0EA4
...
// Range: 0x801D0F90 -> 0x801D0FD0
unsigned int zVarEntryCB_Date() {
    // Local variables
    unsigned int date; // r31
}

// Range: 0x801D0FD0 -> 0x801D0FF8
unsigned int zVarEntryCB_Hour() {
    // Local variables
    unsigned int hour; // r31
}

// Range: 0x801D0FF8 -> 0x801D1020
unsigned int zVarEntryCB_Minute() {
    // Local variables
    unsigned int minute; // r31
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80522474
// total size: 0xC
...
// Range: 0x801D1020 -> 0x801D10BC
unsigned int zVarEntryCB_CounterValue(void * context /* r1+0x8 */) {
    // Local variables
    struct xBase * b; // r31
    struct _xCounter * counter; // r30

    // References
    // -> static char __FUNCTION__[25];
}

// Range: 0x801D10BC -> 0x801D10F4
unsigned int zVarEntryCB_ShowHints() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D10F4 -> 0x801D10FC
unsigned int zVarEntryCB_IsSceneUnlocked() {}

// Range: 0x801D10FC -> 0x801D1104
unsigned int zVarEntryCB_IsSceneCompleted() {}

static char __FUNCTION__[22]; // size: 0x16, address: 0x8052248D
// Range: 0x801D1104 -> 0x801D11B0
unsigned int zVarEntryCB_IsEnabled(void * context /* r1+0x8 */) {
    // Local variables
    struct xBase * b; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x805224A3
// Range: 0x801D11B0 -> 0x801D126C
unsigned int zVarEntryCB_IsVisible(void * context /* r1+0x8 */) {
    // Local variables
    struct xEnt * ent; // r31
...
// Range: 0x801D126C -> 0x801D12C4
unsigned int zVarEntryCB_TimerSecondsLeftValue(void * context /* r1+0x8 */) {
    // Local variables
    struct xTimer * timer; // r31
}

// Range: 0x801D12C4 -> 0x801D1324
unsigned int zVarEntryCB_TimerMilliSecondsLeftValue(void * context /* r1+0x8 */) {
    // Local variables
    struct xTimer * timer; // r31
}

unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x80D6A5B0
// Range: 0x801D1324 -> 0x801D1364
...
// Range: 0x801D143C -> 0x801D1468
unsigned int zVarEntryCB_PlayerType() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D1468 -> 0x801D1478
...
// Range: 0x801D1478 -> 0x801D14A0
unsigned int zVarEntryCB_IsReferenceNULL(void * context /* r3 */) {
    // Local variables
    struct zReference * reference; // r31
}

// Range: 0x801D14A0 -> 0x801D14D4
unsigned int zVarEntryCB_StriaghtToMainMenuOnXbox() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801D14D4 -> 0x801D14F4
unsigned int zVarEntryCB_HitCheckpoints() {}

// Range: 0x801D14F4 -> 0x801D1514
unsigned int zVarEntryCB_TotalCheckpoints() {}

// Range: 0x801D1514 -> 0x801D1534
...
// Range: 0x801D1534 -> 0x801D15C0
unsigned int zVarEntryCB_ShowEnglishVideos() {
    // Local variables
