/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802F7DA4 -> 0x802F91CC
*/
char __FUNCTION__$localstatic1$SetFacing__14zICompSteeringFP5xVec3[10]; // size: 0xA, address: 0x80D670C8
char __FUNCTION__$localstatic1$SetDestination__14zICompSteeringFP5xVec3[15]; // size: 0xF, address: 0x80D670D2
char __FUNCTION__$localstatic1$SetArriverV__14zICompSteeringFP5xVec3[12]; // size: 0xC, address: 0x80D670E1
char __FUNCTION__$localstatic1$SetRepellerV__14zICompSteeringFP5xVec3[13]; // size: 0xD, address: 0x80D670ED
char __FUNCTION__$localstatic1$SetAttractorV__14zICompSteeringFP5xVec3[14]; // size: 0xE, address: 0x80D670FA
char __FUNCTION__$localstatic1$SetArriver__14zICompSteeringFP4xEnt[11]; // size: 0xB, address: 0x80D67108
char __FUNCTION__$localstatic1$SetRepeller__14zICompSteeringFP4xEnt[12]; // size: 0xC, address: 0x80D67113
char __FUNCTION__$localstatic1$SetAttractor__14zICompSteeringFP4xEnt[13]; // size: 0xD, address: 0x80D6711F
// total size: 0x3C
struct {} zNPCBase::__vtable; // size: 0x3C, address: 0x80529AE0
// total size: 0x20
struct xLinkAsset {
    // Members
...
class zNPCBase : public xBase {
    ...
    void TimeStep(struct xVec3 * cullOrigin, struct xScene * xscn, float dt);
...
// Range: 0x802F7DFC -> 0x802F7EE8
void zNPCBase::EventWrapper(struct xBase * from /* r24 */, struct xBase * to /* r25 */, unsigned int to_event /* r29 */, const float * to_param /* r26 */, struct xBase * to_param_widget /* r27 */, unsigned int to_param_widget_id /* r28 */) {
    // Local variables
    class zNPCBase * npc; // r31
    int i; // r30
}

// Range: 0x802F7EE8 -> 0x802F7FE8
// this: r31
unsigned char zNPCBase::SystemEvent(unsigned int to_event /* r1+0x8 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6712C
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x802F7FE8 -> 0x802F8128
// this: r31
void zNPCBase::Load(enum eNPCType type /* r1+0x8 */, const struct xModelAssetInfo * modelAsset /* r1+0xC */, struct zNPCAssetRATS * npcAsset /* r28 */, unsigned int npcAssetSize /* r1+0x10 */) {
    // Local variables
    char * ptr; // r29
    int amt_linkdata; // r30
...
// Range: 0x802F8230 -> 0x802F83A4
// this: r31
void zNPCBase::TimeStep(struct xVec3 * cullOrigin /* r1+0x8 */, struct xScene * xscn /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    float distanceFromPlayer2; // f31
}
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67131
// Range: 0x802F84D8 -> 0x802F872C
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6713B
// Range: 0x802F872C -> 0x802F88F8
// this: r31
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D67148
// Range: 0x802F899C -> 0x802F8A3C
// this: r31
...
// Range: 0x802F8A3C -> 0x802F8AD0
// this: r31
void zNPCBase::SetChildren(class zNPCBase * firstChildren /* r1+0x8 */, int numChildren /* r29 */) {
    // Local variables
    char indexStr[32]; // r1+0xC
    int i; // r30
}

// Range: 0x802F8AD0 -> 0x802F8AD8
// this: r3
void zNPCBase::SetParent(class zNPCBase * parent /* r4 */) {}

// Range: 0x802F8AD8 -> 0x802F8BC0
// this: r31
...
// total size: 0x1
struct /* @class$903zNPCBase_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$904zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$905zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$906zNPCBase_cpp */ {
    // Members
...
// Range: 0x802F8BC0 -> 0x802F8CF0
// this: r31
void zNPCBase::PreUpdateAllComponents(struct xScene * xscn /* r30 */, float dt /* f31 */) {}
...
// Range: 0x802F8CF0 -> 0x802F8E20
// this: r31
void zNPCBase::PostUpdateAllComponents(struct xScene * xscn /* r30 */, float dt /* f31 */) {}

// Range: 0x802F8E20 -> 0x802F8F08
// this: r31
void zNPCBase::DebugRenderAllComponents() {}

// Range: 0x802F8F08 -> 0x802F90FC
// this: r31
unsigned char zNPCBase::ForwardEventToComponents(struct xBase * from /* r25 */, struct xBase * to /* r26 */, unsigned int to_event /* r27 */, const float * to_param /* r28 */, struct xBase * to_param_widget /* r29 */, unsigned int to_param_widget_id /* r30 */) {}

// Range: 0x802F90FC -> 0x802F91CC
// this: r31
