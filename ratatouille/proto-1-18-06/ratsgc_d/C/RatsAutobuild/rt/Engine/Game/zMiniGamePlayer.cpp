/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGamePlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80304990 -> 0x80304CD0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sFirstPlayerPadPort; // size: 0x4, address: 0x80D6B850
// total size: 0x13B0
class zMiniGamePlayer : public zPlayer {
    // Functions
    unsigned char IsActionButtonPressed();

    unsigned char IsActionButtonReleased();
    ...
    void SceneExit(struct zScene * scene);
...
// Range: 0x80304990 -> 0x803049BC
// this: r1+0x8
unsigned char zMiniGamePlayer::IsActionButtonPressed() {}
...
// total size: 0x4
struct /* @class$901zMiniGamePlayer_cpp */ {
    // Members
...
union /* @class$1040zMiniGamePlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1039zMiniGamePlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zMiniGamePlayer_cpp */ {
    // Static members
...
// Range: 0x803049BC -> 0x803049E8
// this: r1+0x8
unsigned char zMiniGamePlayer::IsActionButtonReleased() {}
...
// total size: 0x10
struct /* @class$1288zMiniGamePlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x803049E8 -> 0x80304B30
// this: r31
void zMiniGamePlayer::Init(struct xEntAsset * asset /* r1+0x8 */) {
    // Local variables
    int playerCount; // r29
    int i; // r30

    // References
    // -> static int sFirstPlayerPadPort;
...
// Range: 0x80304B30 -> 0x80304B58
// this: r1+0x8
void zMiniGamePlayer::SceneSetup() {}

// Range: 0x80304B58 -> 0x80304B94
// this: r31
void zMiniGamePlayer::Reset() {}

// Range: 0x80304B94 -> 0x80304BC4
// this: r1+0x8
void zMiniGamePlayer::BeginUpdate(float dt /* r1+0xC */) {}

// Range: 0x80304BC4 -> 0x80304C04
// this: r3
void zMiniGamePlayer::Update(float dt /* f1 */) {}

// Range: 0x80304C04 -> 0x80304C34
// this: r1+0x8
void zMiniGamePlayer::EndUpdate(float dt /* r1+0xC */) {}

// Range: 0x80304C34 -> 0x80304CD0
// this: r30
void zMiniGamePlayer::SceneExit(struct zScene * scene /* r1+0x8 */) {
    // Local variables
    int port; // r31
...
// total size: 0x12C
struct {} zMiniGamePlayer::__vtable; // size: 0x12C, address: 0x8052A788
