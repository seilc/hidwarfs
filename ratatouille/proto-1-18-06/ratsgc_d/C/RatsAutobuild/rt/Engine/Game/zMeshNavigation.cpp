/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMeshNavigation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025D7E4 -> 0x8025F3B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float STEERING_FAKE_VELOCITY; // size: 0x4, address: 0x80D655C0
static float STEERING_PUSHVEC_SCALE; // size: 0x4, address: 0x80D655C4
static unsigned char STEERING_DEBUG_RENDER; // size: 0x1, address: 0x80D6B1E0
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D655C8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
struct xVec2 g_O2; // size: 0x8, address: 0x80D6D170
// Range: 0x8025D7E4 -> 0x8025DCAC
static struct xVec2 GetMeshDirection(class zMeshPosition & start /* r29 */, const class zMeshPosition & destination /* r27 */, float radius /* f27 */, struct xVec2 & leftNormal /* r30 */, struct xVec2 & rightNormal /* r31 */) {
    // Local variables
    struct xVec2 destinationPoint; // r1+0x40
    struct xVec2 startPoint; // r1+0x38
    struct xVec2 difference; // r1+0x30
    struct xVec2 portal[2]; // r1+0x48
    int portalSide; // r28
    struct xVec2 direction; // r1+0x28
    struct xVec2 direction; // r1+0x20
    struct xVec2 direction; // r1+0x18
    struct xVec2 direction; // r1+0x10
    struct xVec2 direction; // r1+0x8
...
// Range: 0x8025DCAC -> 0x8025DD18
static struct xVec2 GetMeshDirection(const class zMeshPosition & start /* r1+0x8 */, const class zMeshPosition & destination /* r1+0xC */, float radius /* r1+0x10 */) {
    // Local variables
    class zMeshPosition nonConstStart; // r1+0x24
    struct xVec2 leftNormal; // r1+0x1C
    struct xVec2 rightNormal; // r1+0x14
}

static char __FUNCTION__[28]; // size: 0x1C, address: 0x80524220
// Range: 0x8025DD18 -> 0x8025DE78
unsigned char zMeshNavigationGetDirection(const class zMeshPosition & start /* r30 */, const class zMeshPosition & destination /* r31 */, float radius /* r1+0x8 */, struct xVec3 & direction /* r1+0xC */) {
    // Local variables
    class zMeshPosition bestDestination; // r1+0x18
    struct xVec2 direction2D; // r1+0x10
...
// Range: 0x8025DE78 -> 0x8025DF04
void zMeshNavigationAddTweaks() {
    // References
    // -> static float STEERING_PUSHVEC_SCALE;
    // -> static float STEERING_FAKE_VELOCITY;
    // -> static unsigned char STEERING_DEBUG_RENDER;
}
...
// total size: 0x1
class zMeshNavigationCommon {};
// Range: 0x8025DF04 -> 0x8025E238
void zMeshNavigationCommon::DetermineSteeringDirection(struct xEnt * entity /* r1+0x8 */, const class zMeshCircle & entCircle /* r18 */, const struct xVec2 & entDir /* r20 */, class zMeshCircle & threatCircle /* r24 */, struct xVec2 & resultDir /* r1+0xC */, unsigned int & threatClusterSize /* r21 */) {
    // Local variables
    struct xVec3 threatPos; // r1+0x64
    struct xVec3 entPos; // r1+0x58
    class zMeshCircle * danglingList; // r19
    class zMeshCircle * clusterList; // r30
    class zMeshCircle * endOfClusterList; // r27
    class zMeshCircle * circleToCheck; // r29
    class zMeshCircle * currentDanglingCircle; // r31
    class zMeshCircle * prevDanglingCircle; // r23
    class zMeshCircle * nextDanglingCircle; // r22
    struct xVec3 pos1; // r1+0x4C
    struct xVec3 pos2; // r1+0x40
    struct xVec3 diff; // r1+0x34
    float noIntersectDist2; // f31
    class zMeshCircle * curr; // r28
    struct xVec2 normalDir; // r1+0x2C
    struct xVec2 entPos2D; // r1+0x24
    class zMeshCircle * curr; // r26
    int weight; // r25
    struct xVec2 currPos2D; // r1+0x1C
    struct xVec2 toCurr; // r1+0x14
...
// total size: 0x4
struct /* @class$892zMeshNavigation_cpp */ {
    // Members
...
union /* @class$1031zMeshNavigation_cpp */ {
...
// total size: 0xC
struct /* @class$1030zMeshNavigation_cpp */ {
    // Members
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D655D9
...
// Range: 0x8025E238 -> 0x8025E9A4
class zMeshCircle * zMeshNavigationCommon::AvoidCircles(struct xEnt * entity /* r28 */, const class zMeshPosition * meshPosition /* r26 */, const class zMeshCircle & my_circle /* r27 */, const struct xVec2 & dir /* r30 */, struct xVec2 & newDir /* r25 */) {
    // Local variables
    struct xVec2 resultDir; // r1+0xB0
    struct xVec3 myPos3D; // r1+0xF4
    struct xVec2 myPos2D; // r1+0xA8
    class zMeshCircle * threatCircle; // r31
    float threatCheckDist; // f25
    struct xVec2 threatPerpVec; // r1+0xA0
    struct xVec2 threatParalVec; // r1+0x98
    class zMeshCircle * nearbyCircles; // r24
    float minDist2; // f28
    class zMeshCircle * currentCircle; // r29
    struct xVec3 hisCenter; // r1+0xE8
    struct xVec2 targetPos; // r1+0x90
    struct xVec2 toTarget; // r1+0x88
    float theDot; // f30
    struct xVec2 closestPt; // r1+0x80
    struct xVec2 perpVec; // r1+0x78
    float checkLength; // f29
    float targetDist; // f27
    struct xVec3 myCenter; // r1+0xDC
    struct xVec3 tcenter; // r1+0xD0
    struct xVec2 pushVec2D; // r1+0x70
    struct xVec2 pushDir2D; // r1+0x68
    float length; // f24
    float scale; // f31
    unsigned int threatClusterSize; // r1+0x34
    struct xVec3 myCenter; // r1+0xC4
    struct xVec3 pushDir3D; // r1+0xB8
...
// Range: 0x8025E9A4 -> 0x8025EA28
float zMeshNavigationCommon::Normalize(struct xVec3 & v /* r31 */) {
    // Local variables
    float len2; // f31
    float length; // f30
}

// Range: 0x8025EA28 -> 0x8025EAB8
unsigned char zMeshNavigationCommon::CombineTwoNormals(const struct xVec3 & n1 /* r1+0x8 */, const struct xVec3 & n2 /* r1+0xC */, const struct xVec3 & orig /* r1+0x10 */, struct xVec3 & result /* r31 */) {
    // Local variables
    struct xVec3 cross; // r1+0x14
}

// Range: 0x8025EAB8 -> 0x8025EB3C
unsigned char zMeshNavigationCommon::CheckNaiveResponseWorks(int stuckCollisions /* r1+0x8 */, struct SphereCollisionResults * sceneCollide /* r1+0xC */, int depth /* r1+0x10 */, const struct xVec3 & naiveResponse /* r1+0x14 */) {
    // Local variables
    int i; // r31
}

// Range: 0x8025EB3C -> 0x8025EBFC
unsigned char zMeshNavigationCommon::CheckCombinationResponseWorks(int stuckCollisions /* r1+0x8 */, struct SphereCollisionResults * sceneCollide /* r27 */, int depth /* r28 */, int partner_offset /* r29 */, const struct xVec3 & combinedResponse /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x8025EBFC -> 0x8025EC50
unsigned char zMeshNavigationCommon::CollisionResponse(const struct SphereCollisionResults & sceneCollide /* r30 */, struct xVec3 & responseDPos /* r31 */) {}

// Range: 0x8025EC50 -> 0x8025EDC4
void zMeshNavigationCommon::SweptSphereCollideComputeResponse(int stuckCollisions /* r27 */, struct SphereCollisionResults * sceneCollide /* r29 */, int depth /* r30 */, const struct xVec3 & currentDir /* r1+0x8 */, struct xVec3 & remainingDPos /* r31 */) {
    // Local variables
    struct xVec3 naiveResponse; // r1+0x18
    int partner_offset; // r28
...
// total size: 0x10
struct /* @class$1375zMeshNavigation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$2159zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2118zMeshNavigation_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2119zMeshNavigation_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2120zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2117zMeshNavigation_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2122zMeshNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$833zMeshNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zMeshNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zMeshNavigation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zMeshNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zMeshNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1853zMeshNavigation_cpp */ {
    // Static members
...
// Range: 0x8025EDC4 -> 0x8025EF90
unsigned char zMeshNavigationCommon::FindShortestCollision(struct xEnt & ent /* r30 */, struct xSweptSphere & sws /* r31 */, int penby /* r24 */) {
    // Local variables
    unsigned char hit; // r29
    float lastHitDist; // f31
    unsigned char hitSomething; // r27
    unsigned char collisionType; // r28
    class zNPCCommon & npc; // r26
    unsigned char checkGoo; // r23
...
// Range: 0x8025EF90 -> 0x8025F0F4
unsigned char zMeshNavigationCommon::FindShortestCollision(struct xEnt & ent /* r28 */, const struct xSphere & sphere /* r30 */, const struct xVec3 & initialDisp /* r1+0x8 */, const struct xVec3 & dir /* r27 */, float dist /* f31 */, struct SphereCollisionResults & results /* r31 */) {
    // Local variables
    struct xVec3 start; // r1+0xC
    struct xSweptSphere bestSweptSphere; // r1+0x18
    unsigned char penby; // r29
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8052423C
// Range: 0x8025F0F4 -> 0x8025F3B0
void zMeshNavigationCommon::SimpleSweptSphereCollide(struct xEnt & ent /* r1+0x8 */, const struct xSphere & sphere /* r1+0xC */, const struct xVec3 & initialDisp /* r28 */, struct xVec3 & dpos /* r29 */) {
    // Local variables
    struct xVec3 validDPos; // r1+0x40
    struct xVec3 fullInitialDisp; // r1+0x34
    struct xVec3 originalDesiredDir; // r1+0x28
    float remainingDist; // f30
    struct xVec3 currentDir; // r1+0x1C
    float currentDist; // f31
    struct SphereCollisionResults sceneCollide[8]; // r1+0x4C
    int stuckCollisions; // r30
    int depth; // r31
    struct xVec3 remainingDPos; // r1+0x10
