/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zBomb.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80205A68 -> 0x80205F48
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80205A68 -> 0x80205AFC
static struct xVec3 getKnockback(const struct xBound * explosion /* r1+0x8 */, const struct xVec3 & target /* r1+0xC */, float away_speed /* r1+0x10 */, float up_speed /* r1+0x14 */) {
    // Local variables
    struct xVec3 knockback; // r1+0x18
...
class damage_callback {
    // Functions
    static damage_callback(struct xEnt * from, struct xBound * bound, int damage, float away_speed, float up_speed, enum zHitSource hit_source, enum zHitTarget hit_target);

    static unsigned char operator()(struct xEnt & ent);

    // Members
    struct xEnt * from; // offset 0x0, size 0x4
    struct xBound * bound; // offset 0x4, size 0x4
    int damage; // offset 0x8, size 0x4
    float away_speed; // offset 0xC, size 0x4
    float up_speed; // offset 0x10, size 0x4
    enum zHitSource hit_source; // offset 0x14, size 0x4
    enum zHitTarget hit_target; // offset 0x18, size 0x4
};
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x80205AFC -> 0x80205D38
void bound_damage(struct xBound & bound /* r31 */, struct xEnt * fromEnt /* r28 */, int player_damage /* r22 */, int obj_damage /* r23 */, int npc_damage /* r24 */, float awayKnockback /* f30 */, float upKnockback /* f31 */, enum zHitSource hitSource /* r26 */, enum zHitTarget hitTarget /* r27 */) {
    // Local variables
    class damage_callback cb; // r1+0x64
    class damage_callback cb; // r1+0x48
    int i; // r30
    struct xSphere * player_spheres[5]; // r1+0x34
    int num_spheres; // r25
    int j; // r29
    struct xBound test_bound; // r1+0xB8
    struct xVec3 hit_pos; // r1+0x28
    struct xVec3 hit; // r1+0x1C
...
// total size: 0x4
struct /* @class$2260zBomb_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2261zBomb_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$845zBomb_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zBomb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zBomb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zBomb_cpp */ {
    // Members
...
// Range: 0x80205D38 -> 0x80205DC0
static unsigned char boundHitsBound(const struct xBound & bound1 /* r31 */, const struct xBound & bound2 /* r1+0x8 */, struct xVec3 & hitPos /* r1+0xC */) {
    // Local variables
    struct xCollis coll; // r1+0x10
}

// Range: 0x80205DC0 -> 0x80205DE0
// this: r3
static damage_callback::damage_callback(struct xEnt * from /* r4 */, struct xBound * bound /* r5 */, int damage /* r6 */, float away_speed /* f1 */, float up_speed /* f2 */, enum zHitSource hit_source /* r7 */, enum zHitTarget hit_target /* r8 */) {}
...
// Range: 0x80205DE0 -> 0x80205E68
void sphere_damage(struct xEnt * fromEnt /* r1+0x8 */, const struct xVec3 & epicenter /* r1+0xC */, float blastRadius /* r1+0x10 */, int player_damage /* r1+0x14 */, int obj_damage /* r1+0x18 */, int npc_damage /* r1+0x1C */, float awayKnockback /* r1+0x20 */, float upKnockback /* r1+0x24 */, enum zHitSource hitSource /* r1+0x28 */, enum zHitTarget hitTarget /* r1+0x2C */) {
    // Local variables
    struct xBound bound; // r1+0x30
}
...
// Range: 0x80205E68 -> 0x80205F48
// this: r31
static unsigned char damage_callback::operator()(struct xEnt & ent /* r30 */) {
    // Local variables
    struct xVec3 hit_pos; // r1+0x28
    struct xVec3 hit; // r1+0x1C
