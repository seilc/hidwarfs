/*
    ...
    Language: C++
    Code range: 0x80313628 -> 0x80313B3C
*/
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D675E0
// total size: 0x54
struct {} zUICustomImageSlideshow::__vtable; // size: 0x54, address: 0x8052CF68
// total size: 0xC
...
// Range: 0x80313628 -> 0x80313728
// this: r31
zUICustomImageSlideshow::zUICustomImageSlideshow(class zUI * ui /* r30 */) {
    // Local variables
    unsigned int widgetID; // r29
...
// Range: 0x80313728 -> 0x8031376C
// this: r31
void zUICustomImageSlideshow::Reset() {}

// Range: 0x8031376C -> 0x8031386C
// this: r31
unsigned char zUICustomImageSlideshow::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r28 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D675E5
// Range: 0x8031386C -> 0x803139D4
// this: r1+0x8
void zUICustomImageSlideshow::SetTextureList(unsigned int groupID /* r30 */) {
    // Local variables
    struct xBase * textureGroup; // r31

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D675F4
// Range: 0x803139D4 -> 0x80313AE0
// this: r31
void zUICustomImageSlideshow::SetTextureList(struct xGroup * textureList /* r30 */) {
    // References
    // -> static char __FUNCTION__[15];
}
...
// Range: 0x80313AE0 -> 0x80313B3C
// this: r31
void zUICustomImageSlideshow::UpdateTexture() {
    // Local variables
    unsigned int textureID; // r30
    class zUIImage * image; // r29
}
