/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUIController.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80220EF0 -> 0x80221004
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80220F38 -> 0x80220F3C
void zUIController::DoRender() {}

// Range: 0x80220F3C -> 0x80220F6C
void zUIController_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x80220F6C -> 0x80220FC8
void zUIController_Init(class zUIController * text /* r30 */, struct zUIControllerAsset * asset /* r1+0x8 */) {}

// total size: 0x64
struct {} zUIController::__vtable; // size: 0x64, address: 0x80523688
