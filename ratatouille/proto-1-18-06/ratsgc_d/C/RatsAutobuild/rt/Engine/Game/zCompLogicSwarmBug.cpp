/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicSwarmBug.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8033B71C -> 0x8033BEFC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gSwarmBugSteeringParams; // size: 0x8C, address: 0x80D36028
...
static class zCompSoundParams gSwarmBugSoundParams; // size: 0x1C, address: 0x80D360B4
// total size: 0x8
...
static struct zCompStateMachineTable gSwarmBugStateMachineTable[2]; // size: 0x10, address: 0x80D67C40
// total size: 0x34
...
// Range: 0x8033B71C -> 0x8033B74C
void zCompLogicSwarmBug::AddStaticTweaks() {
    // References
    // -> static class zCompSteeringFlockingParams gSwarmBugSteeringParams;
}

// Range: 0x8033B74C -> 0x8033B750
void zCompLogicSwarmBug::SetupStateTranstitionTests() {}

// Range: 0x8033B750 -> 0x8033B758
int zCompLogicSwarmBug::GetInitialStateEnum() {}

// Range: 0x8033B758 -> 0x8033B760
struct zCompStateMachineTable * zCompLogicSwarmBug::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gSwarmBugStateMachineTable[2];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67C50
// Range: 0x8033B760 -> 0x8033BA04
// this: r24
unsigned char zCompLogicSwarmBug::SystemEvent(unsigned int to_event /* r1+0x8 */, const float * to_param /* r26 */, struct xBase * to_param_widget /* r31 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r25
...
// Range: 0x8033BA04 -> 0x8033BBD4
// this: r30
void zCompLogicSwarmBug::AllAttached() {
    // Local variables
    ...
    // References
    // -> static class zCompSoundParams gSwarmBugSoundParams;
    // -> static class zCompSteeringFlockingParams gSwarmBugSteeringParams;
}
...
// total size: 0x2C
struct {} zSwarmBugWander::__vtable; // size: 0x2C, address: 0x8052E978
// total size: 0x14
class zSwarmBugWander : public zCompState {
    // Functions
    zSwarmBugWander();
};
// Range: 0x8033BBD4 -> 0x8033BCAC
// this: r31
zSwarmBugWander::zSwarmBugWander() {
    // References
    // -> static class zCompSteeringFlockingParams gSwarmBugSteeringParams;
    // -> struct [anonymous] zSwarmBugWander::__vtable;
}
...
// Range: 0x8033BCAC -> 0x8033BD9C
void zSwarmBugWander::Enter(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1736zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2128zCompLogicSwarmBug_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2129zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2130zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2127zCompLogicSwarmBug_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2132zCompLogicSwarmBug_cpp */ {
    // Members
...
// Range: 0x8033BD9C -> 0x8033BEFC
void zSwarmBugWander::Update(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zNPCBase * ownerNPC; // r27
    class zNPCBase * neighbourNPCs; // r1+0x10
    int numberNeighbourNPCs; // r1+0xC
    struct zCommonPlayer * player; // r31
    struct xVec3 * playerPos; // r26
    class zCompSteeringFlockingBrain * flockingBrain; // r25
    const struct xVec3 * swarmPos; // r1+0x8
    class zCompSteeringBasic * compNPCSteering; // r24
    const struct xEnt * repeller; // r29
    float minPlayerDist2; // f31
    float playerDist2; // f30
    int i; // r30
    class zICompNPCEntity * compNPCEntity; // r23
    struct zCombatDamageInfo combatDamageInfo; // r1+0x14
...
// total size: 0x4
struct /* @class$984zCompLogicSwarmBug_cpp */ {
    // Members
...
union /* @class$1124zCompLogicSwarmBug_cpp */ {
...
// total size: 0xC
struct /* @class$1122zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$791zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$792zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$794zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$795zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$796zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$797zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1979zCompLogicSwarmBug_cpp */ {
    // Static members
