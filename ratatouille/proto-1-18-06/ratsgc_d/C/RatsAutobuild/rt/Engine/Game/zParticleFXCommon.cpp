/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleFXCommon.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8023DD58 -> 0x8023E510
*/
unsigned int EnergyPulseSystem::Register()::value; // size: 0x4, address: 0x80D6B088
signed char EnergyPulseSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B08C
unsigned char EnergyPulseSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B08D
signed char EnergyPulseSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B08E
char __FUNCTION__$localstatic1$Register__17EnergyPulseSystemFv[9]; // size: 0x9, address: 0x80D64EF8
char __FUNCTION__$localstatic1$Register__263RegisterOnFirstEmitSystem<213zParticleUVStaticTile<3,3,183zParticleEmitterConeSurface<151zParticleColorWhiteFadeOut<120zParticleMoverLinearDecel<91zParticleRadiusConst<67zParticlePoolType<30ptank_pool__pos_color_size_uv2,13zParticleBase>>>>>>,17EnergyPulseSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F01
char __FUNCTION__$localstatic1$Init__259zParticleSystemHelper<213zParticleUVStaticTile<3,3,183zParticleEmitterConeSurface<151zParticleColorWhiteFadeOut<120zParticleMoverLinearDecel<91zParticleRadiusConst<67zParticlePoolType<30ptank_pool__pos_color_size_uv2,13zParticleBase>>>>>>,17EnergyPulseSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F0A
// total size: 0xC
class EnergyPulseSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class EnergyPulseSystem energy_pulse_system; // size: 0xC, address: 0x80D6B090
// total size: 0x1
struct EmitState {};
// total size: 0x4
struct EmitState : public EmitState {
    // Members
...
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x4, size 0xC
...
struct EmitState : public EmitState {
    // Members
    struct xVec3 dir; // offset 0x2C, size 0xC
    struct xVec3 plane_x; // offset 0x38, size 0xC
    struct xVec3 plane_y; // offset 0x44, size 0xC
...
class zParticleSystemHelper : public zParticleSystemHelperEmitter {
    // Members
    int particle_batch_id; // offset 0x0, size 0x4
};
// total size: 0x1
class zParticleSystemHelperEmitter {};
union padded_particle {
...
unsigned int RubbleSystem::Register()::value; // size: 0x4, address: 0x80D6B09C
signed char RubbleSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B0A0
unsigned char RubbleSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B0A1
signed char RubbleSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B0A2
char __FUNCTION__$localstatic1$Register__12RubbleSystemFv[9]; // size: 0x9, address: 0x80D64F0F
char __FUNCTION__$localstatic1$Register__221RegisterOnFirstEmitSystem<176zParticleEmitterConeSurface<144zParticleColorWhiteOpaque<114zParticleMoverGravity<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,12RubbleSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F18
char __FUNCTION__$localstatic1$Init__217zParticleSystemHelper<176zParticleEmitterConeSurface<144zParticleColorWhiteOpaque<114zParticleMoverGravity<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,12RubbleSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F21
// total size: 0xC
class RubbleSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class RubbleSystem rubble_system; // size: 0xC, address: 0x80D6B0A4
// total size: 0x8
struct EmitState : public EmitState {
    // Members
...
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x8, size 0xC
    float vel; // offset 0x14, size 0x4
    float vel_rand; // offset 0x18, size 0x4
    struct xVec3 start; // offset 0x1C, size 0xC
...
struct EmitState : public EmitState {
    // Members
    struct xVec3 dir; // offset 0x34, size 0xC
    struct xVec3 plane_x; // offset 0x40, size 0xC
    struct xVec3 plane_y; // offset 0x4C, size 0xC
...
class zParticleMoverGravity : public zParticleRadiusPercent {
    // Members
public:
    struct xVec3 start; // offset 0x18, size 0xC
    struct xVec3 vel0; // offset 0x24, size 0xC
...
unsigned int FlameConeSystem::Register()::value; // size: 0x4, address: 0x80D6B0B0
signed char FlameConeSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B0B4
unsigned char FlameConeSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B0B5
signed char FlameConeSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B0B6
char __FUNCTION__$localstatic1$Register__15FlameConeSystemFv[9]; // size: 0x9, address: 0x80D64F26
char __FUNCTION__$localstatic1$Register__228RegisterOnFirstEmitSystem<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15FlameConeSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F2F
char __FUNCTION__$localstatic1$Init__224zParticleSystemHelper<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15FlameConeSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F38
// total size: 0xC
class FlameConeSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class FlameConeSystem flame_cone_system; // size: 0xC, address: 0x80D6B0B8
// total size: 0x30
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x8, size 0xC
    struct xVec3 start; // offset 0x14, size 0xC
...
struct EmitState : public EmitState {
    // Members
    struct xVec3 dir; // offset 0x38, size 0xC
...
public:
    struct xVec3 start; // offset 0x18, size 0xC
    struct xVec3 velocity; // offset 0x24, size 0xC
    float time_elapsed; // offset 0x30, size 0x4
    float lifetime; // offset 0x34, size 0x4
};
unsigned int SmokePuffSystem::Register()::value; // size: 0x4, address: 0x80D6B0C4
signed char SmokePuffSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B0C8
unsigned char SmokePuffSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B0C9
signed char SmokePuffSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B0CA
char __FUNCTION__$localstatic1$Register__15SmokePuffSystemFv[9]; // size: 0x9, address: 0x80D64F3D
char __FUNCTION__$localstatic1$Register__228RegisterOnFirstEmitSystem<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15SmokePuffSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F46
char __FUNCTION__$localstatic1$Init__224zParticleSystemHelper<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15SmokePuffSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F4F
// total size: 0xC
class SmokePuffSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class SmokePuffSystem smoke_puff_system; // size: 0xC, address: 0x80D6B0CC
// total size: 0xC
class RegisterOnFirstEmitSystem : public zParticleSystemHelper {
    // Members
    unsigned char registered; // offset 0x4, size 0x1
...
unsigned int LavaDripSystem::Register()::value; // size: 0x4, address: 0x80D6B0D8
signed char LavaDripSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B0DC
unsigned char LavaDripSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B0DD
signed char LavaDripSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B0DE
char __FUNCTION__$localstatic1$Register__14LavaDripSystemFv[9]; // size: 0x9, address: 0x80D64F54
char __FUNCTION__$localstatic1$Register__225RegisterOnFirstEmitSystem<178zParticleEmitterConeVolume<147zParticleColorWhiteFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,14LavaDripSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F5D
char __FUNCTION__$localstatic1$Init__221zParticleSystemHelper<178zParticleEmitterConeVolume<147zParticleColorWhiteFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,14LavaDripSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F66
// total size: 0xC
class LavaDripSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class LavaDripSystem lava_drip_system; // size: 0xC, address: 0x80D6B0E0
// total size: 0x40
struct EmitState : public EmitState {
    // Members
    struct xVec3 dir; // offset 0x30, size 0xC
...
unsigned int SparkSystem::Register()::value; // size: 0x4, address: 0x80D6B0EC
signed char SparkSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80D6B0F0
unsigned char SparkSystem::Register()::already_asserted; // size: 0x1, address: 0x80D6B0F1
signed char SparkSystem::Register()::localstatic6 guard; // size: 0x1, address: 0x80D6B0F2
char __FUNCTION__$localstatic1$Register__11SparkSystemFv[9]; // size: 0x9, address: 0x80D64F6B
char __FUNCTION__$localstatic1$Register__218RegisterOnFirstEmitSystem<174zParticleEmitterConeVolume<143zParticleColorWhiteFadeOut<112zParticleMoverGravity<87zParticleRadiusConst<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,11SparkSystem>FUiUiiPvP9RwTexturePCci[9]; // size: 0x9, address: 0x80D64F74
char __FUNCTION__$localstatic1$Init__214zParticleSystemHelper<174zParticleEmitterConeVolume<143zParticleColorWhiteFadeOut<112zParticleMoverGravity<87zParticleRadiusConst<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,11SparkSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80D64F7D
// total size: 0xC
class SparkSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class SparkSystem spark_system; // size: 0xC, address: 0x80D6B0F4
// total size: 0x4
struct EmitState : public EmitState {
    // Members
    float radius; // offset 0x0, size 0x4
...
public:
    struct xVec3 start; // offset 0x10, size 0xC
    struct xVec3 vel0; // offset 0x1C, size 0xC
    float time_elapsed; // offset 0x28, size 0x4
    float lifetime; // offset 0x2C, size 0x4
    float A; // offset 0x30, size 0x4
};
// total size: 0x10
class zParticleRadiusConst : public zParticlePoolType {};
// Range: 0x8023DD58 -> 0x8023DE54
void zParticleFXCommon_SceneInit() {
    // References
    // -> static class SparkSystem spark_system;
    // -> static class LavaDripSystem lava_drip_system;
    // -> static class SmokePuffSystem smoke_puff_system;
    // -> static class FlameConeSystem flame_cone_system;
    // -> static class RubbleSystem rubble_system;
    // -> static class EnergyPulseSystem energy_pulse_system;
}

// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleUVStaticTile<3, 3, zParticleEmitterConeSurface<zParticleColorWhiteFadeOut<zParticleMoverLinearDecel<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size_uv2, zParticleBase>>>>>>, EnergyPulseSystem>::__vtable; // size: 0xC, address: 0x80D64F84
// total size: 0xC
struct {} EnergyPulseSystem::__vtable; // size: 0xC, address: 0x80D64F90
// Range: 0x8023DE54 -> 0x8023DF70
// this: r1+0x8
void EnergyPulseSystem::Register() {
    // Local variables
    unsigned int texture_name_hash; // r30
    struct RwTexture * texture; // r31

    // References
    // -> char __FUNCTION__$localstatic1$Register__17EnergyPulseSystemFv[9];
    // -> unsigned char EnergyPulseSystem::Register()::already_asserted;
    // -> signed char EnergyPulseSystem::Register()::localstatic6 guard;
    // -> unsigned int EnergyPulseSystem::Register()::value;
    // -> signed char EnergyPulseSystem::Register()::localstatic4 guard;
}
...
// total size: 0x4
struct /* @class$1150zParticleFXCommon_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zParticleFXCommon_cpp */ {
    // Members
...
union /* @class$819zParticleFXCommon_cpp */ {
...
// total size: 0x10
struct /* @class$832zParticleFXCommon_cpp */ {
    // Members
...
struct ptank_pool__pos_color_size_uv2 : public ptank_pool {
    ...
    int stride_uv; // offset 0x3C, size 0x4
};
// total size: 0x8
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeSurface<zParticleColorWhiteOpaque<zParticleMoverGravity<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, RubbleSystem>::__vtable; // size: 0xC, address: 0x80D64F9C
// total size: 0xC
struct {} RubbleSystem::__vtable; // size: 0xC, address: 0x80D64FA8
// Range: 0x8023DF70 -> 0x8023E090
// this: r1+0x8
void RubbleSystem::Register() {
    ...
    // References
    // -> char __FUNCTION__$localstatic1$Register__12RubbleSystemFv[9];
    // -> unsigned char RubbleSystem::Register()::already_asserted;
    // -> signed char RubbleSystem::Register()::localstatic6 guard;
    // -> unsigned int RubbleSystem::Register()::value;
    // -> signed char RubbleSystem::Register()::localstatic4 guard;
}
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, FlameConeSystem>::__vtable; // size: 0xC, address: 0x80D64FB4
// total size: 0xC
struct {} FlameConeSystem::__vtable; // size: 0xC, address: 0x80D64FC0
// Range: 0x8023E090 -> 0x8023E1B0
// this: r1+0x8
void FlameConeSystem::Register() {
    ...
    // References
    // -> char __FUNCTION__$localstatic1$Register__15FlameConeSystemFv[9];
    // -> unsigned char FlameConeSystem::Register()::already_asserted;
    // -> signed char FlameConeSystem::Register()::localstatic6 guard;
    // -> unsigned int FlameConeSystem::Register()::value;
    // -> signed char FlameConeSystem::Register()::localstatic4 guard;
}

// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SmokePuffSystem>::__vtable; // size: 0xC, address: 0x80D64FCC
// total size: 0xC
struct {} SmokePuffSystem::__vtable; // size: 0xC, address: 0x80D64FD8
// Range: 0x8023E1B0 -> 0x8023E2D0
// this: r1+0x8
void SmokePuffSystem::Register() {
    ...
    // References
    // -> char __FUNCTION__$localstatic1$Register__15SmokePuffSystemFv[9];
    // -> unsigned char SmokePuffSystem::Register()::already_asserted;
    // -> signed char SmokePuffSystem::Register()::localstatic6 guard;
    // -> unsigned int SmokePuffSystem::Register()::value;
    // -> signed char SmokePuffSystem::Register()::localstatic4 guard;
}

// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, LavaDripSystem>::__vtable; // size: 0xC, address: 0x80D64FE4
// total size: 0xC
struct {} LavaDripSystem::__vtable; // size: 0xC, address: 0x80D64FF0
// Range: 0x8023E2D0 -> 0x8023E3F0
// this: r1+0x8
void LavaDripSystem::Register() {
    ...
    // References
    // -> char __FUNCTION__$localstatic1$Register__14LavaDripSystemFv[9];
    // -> unsigned char LavaDripSystem::Register()::already_asserted;
    // -> signed char LavaDripSystem::Register()::localstatic6 guard;
    // -> unsigned int LavaDripSystem::Register()::value;
    // -> signed char LavaDripSystem::Register()::localstatic4 guard;
}

// total size: 0x38
class zParticleColorWhiteFadeOut : public zParticleMoverLinearVel {};
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverGravity<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SparkSystem>::__vtable; // size: 0xC, address: 0x80D64FFC
// total size: 0xC
struct {} SparkSystem::__vtable; // size: 0xC, address: 0x80D65008
// Range: 0x8023E3F0 -> 0x8023E510
// this: r1+0x8
void SparkSystem::Register() {
    ...
    // References
    // -> char __FUNCTION__$localstatic1$Register__11SparkSystemFv[9];
    // -> unsigned char SparkSystem::Register()::already_asserted;
    // -> signed char SparkSystem::Register()::localstatic6 guard;
    // -> unsigned int SparkSystem::Register()::value;
    // -> signed char SparkSystem::Register()::localstatic4 guard;
}
