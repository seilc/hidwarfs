/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zVent.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80278568 -> 0x80279B98
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zVent * hilighted; // size: 0x4, address: 0x80D6B288
static char * zVentStateNames[4]; // size: 0x10, address: 0x80D65A00
static unsigned int zVentStateValues[4]; // size: 0x10, address: 0x80D65A10
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65A20
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x20
struct zVentType : public xBase {
    // Members
    const struct asset_type * asset; // offset 0x10, size 0x4
    struct xParEmitter * idleEmitter; // offset 0x14, size 0x4
    struct xParEmitter * warnEmitter; // offset 0x18, size 0x4
    struct xParEmitter * damageEmitter; // offset 0x1C, size 0x4
};
// total size: 0xC
struct /* @class$742zVent_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$745zVent_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$746zVent_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$747zVent_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$748zVent_cpp */ {
    // Members
...
struct zVent : public xBase {
    ...
    int checkHitPlayer(struct xEnt * tgt, struct xCollis * collide);

    void update(float dt);

    enum xSndHandle playSound(enum iSndGroupHandle sndID);

    void changeState(enum eVentState newState);
    ...
    // Static members
    static struct zVent * hilighted; // size: 0x4
    ...
    enum xSndHandle snd; // offset 0x68, size 0x4
...
private:
    struct zVentType * ventType; // offset 0x78, size 0x4
    struct xVec3 initVelocity[4]; // offset 0x7C, size 0x30
    struct xParEmitter idleEmit; // offset 0xAC, size 0x94
    struct xParEmitter warnEmit; // offset 0x140, size 0x94
    struct xParEmitter damageEmit; // offset 0x1D4, size 0x94
};
// Range: 0x80278568 -> 0x8027872C
// this: r31
void zVent::load(const struct asset_type & a /* r30 */) {
    // Local variables
    struct xBase * obj; // r29

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x80278890 -> 0x802788D8
// this: r31
void zVent::refreshMat() {}

// Range: 0x802788D8 -> 0x802788F0
// this: r3
void zVent::reset() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65A25
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x802788F0 -> 0x802789E4
// this: r30
int zVent::checkHitPlayer(struct xEnt * tgt /* r29 */, struct xCollis * collide /* r26 */) {
    // Local variables
    struct xBound bnd; // r1+0x8
    struct xCollis * colrec; // r31
    int hittgt; // r27
...
// total size: 0x14
struct cbVentHitsBoulder {
    // Functions
    cbVentHitsBoulder(struct xBase * owner, const struct xBox & box, const struct xMat4x3 & mat, float boulderInfluence, unsigned char fDestroyBoulders);

    unsigned char operator()(struct xEnt & ent);

    // Members
    struct xBase * owner; // offset 0x0, size 0x4
    const struct xBox & box; // offset 0x4, size 0x4
    const struct xMat4x3 & mat; // offset 0x8, size 0x4
    float boulderInfluence; // offset 0xC, size 0x4
    unsigned char fDestroyBoulders; // offset 0x10, size 0x1
};
// Range: 0x802789E4 -> 0x80278CFC
// this: r31
void zVent::update(float dt /* f31 */) {
    // Local variables
    struct xParEmitter * pEmit; // r30
    struct xParEmitterCustomSettings ventInfo; // r1+0x120
    struct xMat4x3 * pMat; // r28
    struct xVec3 ventVel; // r1+0x10
    int i; // r29
    struct xCollis collide; // r1+0xCC
    struct zCombatDamageInfo params; // r1+0x48
    struct xBound bnd; // r1+0x80
    struct xBox box; // r1+0x30
    struct cbVentHitsBoulder cb; // r1+0x1C
...
// Range: 0x80278CFC -> 0x80278D14
// this: r3
cbVentHitsBoulder::cbVentHitsBoulder(struct xBase * owner /* r4 */, const struct xBox & box /* r5 */, const struct xMat4x3 & mat /* r6 */, float boulderInfluence /* f1 */, unsigned char fDestroyBoulders /* r7 */) {}
...
// Range: 0x80278D14 -> 0x80278D84
// this: r29
enum xSndHandle zVent::playSound(enum iSndGroupHandle sndID /* r30 */) {
    // Local variables
    int sndFlags; // r31
}
...
// Range: 0x80278D84 -> 0x80278EA8
// this: r31
void zVent::changeState(enum eVentState newState /* r1+0x8 */) {}

// Range: 0x80278EA8 -> 0x80278ED0
// this: r1+0x8
void zVent::render() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65A34
// Range: 0x80278ED0 -> 0x80279088
void zVent::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
struct asset_type : public xDynAsset {
    ...
    struct xVec3 upperRight; // offset 0x38, size 0xC
    ...
    int damagePoints; // offset 0x58, size 0x4
};
// total size: 0x8
struct substr {
    // Members
...
// Range: 0x80279088 -> 0x802790F0
void zVent::setupAll() {
    // Local variables
    struct zScene & scene; // r30
    struct zVent * it; // r31
    struct zVent * end; // r29

    // References
    // -> struct zGlobals globals;
}

static unsigned char done; // size: 0x1, address: 0x80D6B28C
static signed char init; // size: 0x1, address: 0x80D6B28D
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65A39
// Range: 0x802790F0 -> 0x802791F4
void zVent::updateAll(float dt /* r1+0x8 */) {
    // Local variables
    struct zScene & scene; // r31
    struct zVent * it; // r30
    struct zVent * end; // r29
...
// Range: 0x802791F4 -> 0x8027925C
void zVent::renderAll() {
    // Local variables
    struct zScene & scene; // r30
    struct zVent * it; // r31
    struct zVent * end; // r29
...
// Range: 0x8027925C -> 0x802792C4
// this: r31
void zVent::setup() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D65A43
// Range: 0x802792C4 -> 0x80279454
void zVent::cbDispatch(struct xBase * to /* r30 */, unsigned int event /* r1+0x8 */) {
    // Local variables
    struct zVent & e; // r31
...
// Range: 0x80279454 -> 0x802794C8
// this: r31
void zVent::debugRender() {
    // Local variables
    struct xBox box; // r1+0x8

    // References
    // -> struct zVent * hilighted;
}

// Range: 0x802794C8 -> 0x802794D4
void zVent::enableHilight(const struct tweak_info & info /* r3 */) {
    // References
    // -> struct zVent * hilighted;
}

// Range: 0x802794D4 -> 0x802794E0
void zVent::disableHilight() {
    // References
    // -> struct zVent * hilighted;
}

// Range: 0x802794E0 -> 0x80279518
void zVent::onMove(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct zVent * f; // r31
}

// Range: 0x80279518 -> 0x80279540
void zVent::tweakRToD(void * value /* r4 */) {
    // Local variables
    float & f; // r31
}

// Range: 0x80279540 -> 0x80279568
void zVent::tweakDToR(void * value /* r4 */) {
    // Local variables
    float & f; // r31
}

// Range: 0x80279568 -> 0x80279590
// this: r1+0x8
void zVent::debugInit() {}
...
static struct tweak_callback cbHilight; // size: 0x28, address: 0x804C8568
static struct tweak_callback cbMove; // size: 0x28, address: 0x804C8590
static struct tweak_callback cbMoveDir; // size: 0x28, address: 0x804C85B8
// Range: 0x80279590 -> 0x80279A8C
// this: r30
void zVent::addTweaks() {
    // Local variables
    char prefix[128]; // r1+0x888
    ...
    // References
    // -> static unsigned int zVentStateValues[4];
    // -> static char * zVentStateNames[4];
    // -> static struct tweak_callback cbMove;
    // -> static struct tweak_callback cbMoveDir;
    // -> static struct tweak_callback cbHilight;
}
...
// Range: 0x80279A8C -> 0x80279B98
// this: r31
unsigned char cbVentHitsBoulder::operator()(struct xEnt & ent /* r30 */) {
    // Local variables
    struct xEntBoulder * boulder; // r29
    struct xVec3 force; // r1+0x8
}
