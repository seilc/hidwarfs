/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUIModel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801CD540 -> 0x801CDD08
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D63CF0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x801CD7F8 -> 0x801CD834
// this: r31
void zUIModel::InitUVs() {}

// Range: 0x801CD834 -> 0x801CD85C
// this: r1+0x8
...
static struct xVec3 from; // size: 0xC, address: 0x80D63CFC
static struct xVec3 to; // size: 0xC, address: 0x80D63D08
struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x801CD85C -> 0x801CDA54
// this: r31
void zUIModel::DoRender() const {
    // Local variables
    struct basic_rect r; // r1+0x8
    unsigned int srcblend; // r30
    unsigned int destblend; // r29

    // References
    // -> static struct xVec3 to;
    // -> static struct xVec3 from;
    // -> struct xGlobals * xglobals;
}

// Range: 0x801CDA54 -> 0x801CDAAC
// this: r31
void zUIModel::DoUpdate(float dt /* f31 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D63D14
// Range: 0x801CDAAC -> 0x801CDB10
// this: r31
...
// Range: 0x801CDB10 -> 0x801CDC10
// this: r31
void zUIModel::DoHandleEvent(struct xBase * from /* r26 */, unsigned int toEvent /* r30 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r27 */, unsigned int toParamWidgetID /* r28 */) {}

// Range: 0x801CDC10 -> 0x801CDC40
// this: r1+0x8
void zUIModel::DoAddTweaks(const char * baseName /* r1+0xC */) {}

// Range: 0x801CDC40 -> 0x801CDC70
void zUIModel_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r1+0xC */) {}

// Range: 0x801CDC70 -> 0x801CDCCC
void zUIModel_Init(class zUIModel * model /* r30 */, struct zUIModelAsset * asset /* r1+0x8 */) {}

// total size: 0x64
struct {} zUIModel::__vtable; // size: 0x64, address: 0x80521EB8
