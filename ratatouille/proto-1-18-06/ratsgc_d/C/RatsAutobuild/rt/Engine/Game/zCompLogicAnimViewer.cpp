/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicAnimViewer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80331EEC -> 0x80333FC8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int mNeedTweaks; // size: 0x4, address: 0x80D67A80
unsigned char mActionPressed; // size: 0x1, address: 0x80D6BAE0
unsigned char mIsActive; // size: 0x1, address: 0x80D6BAE1
unsigned int mAutoAction; // size: 0x4, address: 0x80D6BAE4
static class zCompLogicAnimViewer * viewer; // size: 0x4, address: 0x80D6BAE8
// total size: 0x20
class AnimFrameStepper {
    // Functions
    void AdvanceOneStep();
    ...
    void Init(struct xModelInstance * model);

    float Update();

    void AdvanceByTime(float dt);

    float PreUpdate(float dt);

    // Members
    unsigned char paused; // offset 0x0, size 0x1
    unsigned char pendingStep; // offset 0x1, size 0x1
    float timer; // offset 0x4, size 0x4
    float timeScale; // offset 0x8, size 0x4
    unsigned int stepFPS; // offset 0xC, size 0x4
    float timeToAdvance; // offset 0x10, size 0x4
    unsigned int frame; // offset 0x14, size 0x4
    unsigned char needsAligning; // offset 0x18, size 0x1
    struct xModelInstance * model; // offset 0x1C, size 0x4
};
// Range: 0x80331EEC -> 0x80331F1C
void AnimFrameStepper::TweakCB_SingleStep(const struct tweak_info & info /* r31 */) {}

// Range: 0x80331F1C -> 0x80331F30
// this: r3
void AnimFrameStepper::AdvanceOneStep() {}

// Range: 0x80331F30 -> 0x80331F60
void AnimFrameStepper::TweakCB_SingleStepEnter(const struct tweak_info & info /* r31 */) {}

// Range: 0x80331F60 -> 0x80331FE4
// this: r31
void AnimFrameStepper::Pause() {
    // Local variables
    float remainder; // f31
}

// Range: 0x80331FE4 -> 0x80332014
void AnimFrameStepper::TweakCB_SingleStepExit(const struct tweak_info & info /* r31 */) {}

// Range: 0x80332014 -> 0x80332020
// this: r3
void AnimFrameStepper::Resume() {}
...
// total size: 0xC
struct /* @class$791zCompLogicAnimViewer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$792zCompLogicAnimViewer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zCompLogicAnimViewer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$794zCompLogicAnimViewer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$795zCompLogicAnimViewer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$796zCompLogicAnimViewer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$797zCompLogicAnimViewer_cpp */ {
    // Members
...
static struct tweak_callback cb_tweak_single_step; // size: 0x28, address: 0x804E09D8
// Range: 0x80332020 -> 0x80332144
// this: r30
void AnimFrameStepper::AddTweaks(const char * prefix /* r31 */) {
    // Local variables
    char buf[256]; // r1+0x8

    // References
    // -> static struct tweak_callback cb_tweak_single_step;
}

static class AnimFrameStepper sAnimFrameStepper; // size: 0x20, address: 0x80D346B0
char __FUNCTION__$localstatic1$__vc__16AnimViewerStatesFi[5]; // size: 0x5, address: 0x80D67A84
static char * stateNames[8]; // size: 0x20, address: 0x8052E460
// total size: 0x508
class AnimViewerStates {
    // Functions
    AnimViewerStates();

    int NumStates() const;

    struct StateConfig & operator[](int i);

    void ParseAnimInfo(const char * infoString);

    void CreateAnimTable(struct xAnimTable * table);

    // Members
    int mNumStates; // offset 0x0, size 0x4
    int mNumActive; // offset 0x4, size 0x4
    struct StateConfig mStates[16]; // offset 0x8, size 0x500
};
// Range: 0x80332144 -> 0x803321BC
// this: r30
AnimViewerStates::AnimViewerStates() {
    // Local variables
    int i; // r31

    // References
    // -> static char * stateNames[8];
}
...
struct StateConfig {
    ...
    struct xAnimSingle * FindSingle(const struct xModelInstance * model) const;

    // Members
    const char * mName; // offset 0x0, size 0x4
    unsigned int mHashID; // offset 0x4, size 0x4
    char mFileName[64]; // offset 0x8, size 0x40
    unsigned char mLooped; // offset 0x48, size 0x1
    unsigned char mHasInfo; // offset 0x49, size 0x1
    struct xAnimState * mAnimState; // offset 0x4C, size 0x4
};
// Range: 0x803321BC -> 0x80332224
// this: r31
void StateConfig::Init(const char * name /* r30 */) {}

// Range: 0x80332224 -> 0x8033222C
// this: r3
int AnimViewerStates::NumStates() const {}

// Range: 0x8033222C -> 0x803322C8
// this: r30
struct StateConfig & AnimViewerStates::operator[](int i /* r31 */) {
    // References
    // -> char __FUNCTION__$localstatic1$__vc__16AnimViewerStatesFi[5];
}
...
class zIniString {
    ...
    void NextToken(char startAfter, char endAt);

    char * EndTo(char c);

    char * StartSkip(char c);

    zIniString(const char * str);

    void SetString(const char * str);

    // Members
    char work[256]; // offset 0x0, size 0x100
    const char * start; // offset 0x100, size 0x4
    const char * end; // offset 0x104, size 0x4
};
// Range: 0x803322C8 -> 0x803323D8
// this: r30
void AnimViewerStates::ParseAnimInfo(const char * infoString /* r1+0x8 */) {
    // Local variables
    class zIniString info; // r1+0x114
    int index; // r31
    class zIniString anim; // r1+0xC
}

// Range: 0x803323D8 -> 0x80332410
// this: r3
void zIniString::Skip(char c /* r4 */) {}

// Range: 0x80332410 -> 0x8033245C
// this: r31
void StateConfig::SetFileName(const char * filename /* r1+0x8 */) {}

// Range: 0x8033245C -> 0x80332460
// this: r3
char * zIniString::TokenAsStr() {}

// Range: 0x80332460 -> 0x8033248C
// this: r1+0x8
int zIniString::TokenAsInt() {}

// Range: 0x8033248C -> 0x803324E0
// this: r31
void zIniString::NextToken(char startAfter /* r1+0x8 */, char endAt /* r1+0x9 */) {}

// Range: 0x803324E0 -> 0x80332544
void zIniString::copy(char * dest /* r29 */, const char * start /* r31 */, const char * end /* r30 */) {}

// Range: 0x80332544 -> 0x80332584
// this: r31
char * zIniString::EndTo(char c /* r1+0x8 */) {}

// Range: 0x80332584 -> 0x803325B0
char * zIniString::ToChar(const char * str /* r3 */, char c /* r4 */) {}

// Range: 0x803325B0 -> 0x803325F0
// this: r31
char * zIniString::StartSkip(char c /* r1+0x8 */) {}

// Range: 0x803325F0 -> 0x8033261C
char * zIniString::SkipChar(const char * str /* r3 */, char c /* r4 */) {}

// Range: 0x8033261C -> 0x80332654
// this: r31
zIniString::zIniString(const char * str /* r1+0x8 */) {}

// Range: 0x80332654 -> 0x80332668
// this: r3
void zIniString::SetString(const char * str /* r4 */) {}

// Range: 0x80332668 -> 0x8033276C
// this: r30
void AnimViewerStates::CreateAnimTable(struct xAnimTable * table /* r1+0x18 */) {
    // Local variables
    int i; // r31
}

class AnimViewerStates sAnimViewerStates; // size: 0x508, address: 0x80D346D0
// total size: 0x10C
struct Step {
    // Functions
    void UpdateTweaks(const struct xModelInstance * model);

    void AddTweaks(const char * prefix, int index);

    struct xAnimTransition * GetTransition() const;

    unsigned char EndlessLooping() const;

    // Members
    const struct StateConfig * stateCfg; // offset 0x0, size 0x4
    unsigned int blendFrames; // offset 0x4, size 0x4
    unsigned int numRepeats; // offset 0x8, size 0x4
    char tweakName[256]; // offset 0xC, size 0x100
};
// Range: 0x8033276C -> 0x8033283C
// this: r31
void Step::UpdateTweaks(const struct xModelInstance * model /* r1+0x8 */) {
    // Local variables
    char frameBuf[16]; // r1+0xC
    const struct xAnimSingle * single; // r30
}

// Range: 0x8033283C -> 0x80332890
unsigned int AnimFrameStepper::CalcFrame(const struct xAnimSingle * single /* r31 */) {
    // Local variables
    float frame; // f31
}

// Range: 0x80332890 -> 0x803328F0
// this: r3
struct xAnimSingle * StateConfig::FindSingle(const struct xModelInstance * model /* r4 */) const {
    // Local variables
    struct xAnimSingle * single; // r31
}

// Range: 0x803328F0 -> 0x803329B4
// this: r31
void Step::AddTweaks(const char * prefix /* r29 */, int index /* r30 */) {
    // Local variables
    char buf[256]; // r1+0x8
}
...
class AnimSequence {
    ...
    unsigned char Init(const char * seqString, class AnimViewerStates & animStates);

    struct Step & CurrentStep();

    void SetModel(struct xModelInstance * model);
    ...
    // Members
    struct Step mSteps[16]; // offset 0x0, size 0x10C0
    int mNumSteps; // offset 0x10C0, size 0x4
    int mCurStep; // offset 0x10C4, size 0x4
    unsigned int mLoopsLeft; // offset 0x10C8, size 0x4
    struct xModelInstance * mModel; // offset 0x10CC, size 0x4
    char mTweakPrefix[256]; // offset 0x10D0, size 0x100
};
// Range: 0x803329B4 -> 0x80332A0C
// this: r30
void AnimSequence::UpdateTweaks() {
    // Local variables
    int i; // r31
}

// Range: 0x80332A0C -> 0x80332A78
// this: r30
void AnimSequence::AddTweaks(const char * prefix /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67A89
// Range: 0x80332A78 -> 0x80332CFC
// this: r31
unsigned char AnimSequence::Init(const char * seqString /* r29 */, class AnimViewerStates & animStates /* r24 */) {
    // Local variables
    unsigned int frames; // r28
    unsigned char inTime; // r27
    int prevAnim; // r26
    int i; // r30
    int index; // r25
...
// Range: 0x80332CFC -> 0x80332D28
static int tolower(char c /* r1+0x8 */) {}

// Range: 0x80332D28 -> 0x80332D34
static int tolower(int c /* r3 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D67A8E
// Range: 0x80332D34 -> 0x80332E14
// this: r30
struct xAnimTransition * Step::GetTransition() const {
    // Local variables
    struct xAnimTransition * trans; // r31

    // References
    // -> static char __FUNCTION__[14];
}

static class AnimSequence sAnimSequence; // size: 0x11D0, address: 0x80D34BD8
float MAX_DISTANCE; // size: 0x4, address: 0x80D71248
float MIN_DISTANCE; // size: 0x4, address: 0x80D7124C
float START_DISTANCE; // size: 0x4, address: 0x80D71250
float START_PITCH; // size: 0x4, address: 0x80D71254
float SPEED_PITCH; // size: 0x4, address: 0x80D71258
float SPEED_YAW; // size: 0x4, address: 0x80D7125C
float SPEED_DISTANCE; // size: 0x4, address: 0x80D71260
// total size: 0x150
class zAnimViewerCamera : public xCam {
    // Functions
    void Init(const struct xEnt * targetEnt);
    ...
    // Static members
    static float SPEED_DISTANCE; // size: 0x4
    static float SPEED_YAW; // size: 0x4
    static float SPEED_PITCH; // size: 0x4
    static float START_PITCH; // size: 0x4
    static float START_DISTANCE; // size: 0x4
    static float MIN_DISTANCE; // size: 0x4
    static float MAX_DISTANCE; // size: 0x4

    // Members
    float distance; // offset 0x140, size 0x4
    struct xVec3 target; // offset 0x144, size 0xC
};
static class zAnimViewerCamera sAnimViewerCamera; // size: 0x150, address: 0x80D35DB0
// total size: 0x3C
struct {} zCompLogicAnimViewer::__vtable; // size: 0x3C, address: 0x8052E480
// total size: 0x18
class zCompLogicAnimViewer : public zICompLogic {
    ...
    void SetAutoActionIteration(int iteration);
...
// Range: 0x80332E14 -> 0x80332E50
// this: r31
zCompLogicAnimViewer::zCompLogicAnimViewer() {
    // References
    // -> struct [anonymous] zCompLogicAnimViewer::__vtable;
}

// Range: 0x80332E50 -> 0x80332E54
void zCompLogicAnimViewer::AddStaticTweaks() {}

// Range: 0x80332E54 -> 0x80332E5C
unsigned char zCompLogicAnimViewer::SystemEvent() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67A9C
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x80332E5C -> 0x80333044
void zCompLogicAnimViewer::ReadINI(unsigned char sequenceOnly /* r1+0x8 */) {
    // Local variables
    const char * ANIMVIEWER_INI; // r29
    unsigned int size; // r1+0x10
    unsigned int * buf; // r31
    unsigned int * file; // r28
    struct xIniFile * ini; // r27
    const char * iniString; // r30
    const char * ANIMKEY; // r26
    int idx; // r1+0xC
    const char * SEQKEY; // r25

    // References
    // -> class AnimViewerStates sAnimViewerStates;
    // -> static class AnimSequence sAnimSequence;
    // -> static char __FUNCTION__[8];
}

// Range: 0x80333044 -> 0x8033308C
void zCompLogicAnimViewer::CreateAnimTable(struct xAnimTable * table /* r31 */) {
    // References
    // -> class AnimViewerStates sAnimViewerStates;
}
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D67AA4
// Range: 0x8033308C -> 0x8033310C
// this: r1+0x8
void zCompLogicAnimViewer::Attached() {
    // References
    // -> static class zCompLogicAnimViewer * viewer;
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D67AAD
// Range: 0x8033310C -> 0x80333188
void zCompLogicAnimViewer::Detached() {
    // References
    // -> static class zCompLogicAnimViewer * viewer;
    // -> static char __FUNCTION__[9];
}

static struct tweak_callback cb_tweak_reload_ini; // size: 0x28, address: 0x804E0A00
static struct tweak_callback cb_tweak_action; // size: 0x28, address: 0x804E0A28
static struct tweak_callback cb_tweak_autoAction; // size: 0x28, address: 0x804E0A50
static char * autoLabels[2]; // size: 0x8, address: 0x80D67AB8
static unsigned int autoValues[2]; // size: 0x8, address: 0x80D71264
// Range: 0x80333188 -> 0x803332FC
void zCompLogicAnimViewer::AddAllTweaks() {
    // Local variables
    int i; // r31

    // References
    // -> static class AnimFrameStepper sAnimFrameStepper;
    // -> static class AnimSequence sAnimSequence;
    // -> static struct tweak_callback cb_tweak_autoAction;
    // -> static unsigned int autoValues[2];
    // -> static char * autoLabels[2];
    // -> unsigned int mAutoAction;
    // -> static struct tweak_callback cb_tweak_action;
    // -> static struct tweak_callback cb_tweak_reload_ini;
}
...
// Range: 0x803332FC -> 0x80333328
void zCompLogicAnimViewer::TweakCB_ReloadINI() {
    // References
    // -> unsigned int mNeedTweaks;
}

// Range: 0x80333328 -> 0x80333334
void zCompLogicAnimViewer::TweakCB_Action() {
    // References
    // -> unsigned char mActionPressed;
}

// Range: 0x80333334 -> 0x803333B4
void zCompLogicAnimViewer::TweakCB_AutoAction() {
    // References
    // -> static class zCompLogicAnimViewer * viewer;
    // -> static class AnimSequence sAnimSequence;
    // -> unsigned int mAutoAction;
...
// Range: 0x803333B4 -> 0x803333C4
// this: r3
unsigned char Step::EndlessLooping() const {}

// Range: 0x803333C4 -> 0x803333D4
// this: r3
struct Step & AnimSequence::CurrentStep() {}

// Range: 0x803333D4 -> 0x8033342C
// this: r3
void zCompLogicAnimViewer::SetAutoActionIteration(int iteration /* r4 */) {}

// Range: 0x8033342C -> 0x803334B8
// this: r31
void zCompLogicAnimViewer::SetAnimationState() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    const struct Step & step; // r29
...
// total size: 0x4
struct /* @class$923zCompLogicAnimViewer_cpp */ {
    // Members
...
union /* @class$1071zCompLogicAnimViewer_cpp */ {
...
// total size: 0xC
struct /* @class$1061zCompLogicAnimViewer_cpp */ {
    // Members
...
// Range: 0x803334B8 -> 0x803335A0
// this: r31
void zCompLogicAnimViewer::AllAttached() {
    // Local variables
    struct xEnt * ent; // r30

    // References
    // -> static class zAnimViewerCamera sAnimViewerCamera;
    // -> static class AnimFrameStepper sAnimFrameStepper;
    // -> static class AnimSequence sAnimSequence;
...
// Range: 0x803335A0 -> 0x80333628
// this: r31
void zAnimViewerCamera::Init(const struct xEnt * targetEnt /* r29 */) {
    // Local variables
...
// Range: 0x80333628 -> 0x80333664
// this: r31
void zAnimViewerCamera::create() {}

// Range: 0x80333664 -> 0x803336EC
// this: r31
void AnimFrameStepper::Init(struct xModelInstance * model /* r30 */) {}

// Range: 0x803336EC -> 0x803336F4
// this: r3
void AnimSequence::SetModel(struct xModelInstance * model /* r4 */) {}
...
// total size: 0x890
struct /* @class$1914zCompLogicAnimViewer_cpp */ {
    // Static members
...
// Range: 0x803336F4 -> 0x80333910
// this: r31
void zCompLogicAnimViewer::Update(float dt /* r1+0x8 */) {
    // Local variables
    unsigned char transition; // r30
    float stepped_dt; // f31
    class zICompNPCEntity * compNPCEntity; // r29
    const struct Step & step; // r28
    ...
    // -> unsigned int mNeedTweaks;
    // -> static class zAnimViewerCamera sAnimViewerCamera;
    // -> unsigned char mIsActive;
}

// Range: 0x80333910 -> 0x80333938
// this: r1+0x8
void AnimSequence::Update() {}

// Range: 0x80333938 -> 0x80333994
// this: r31
float AnimFrameStepper::Update() {}

// Range: 0x80333994 -> 0x803339E0
// this: r31
void AnimFrameStepper::AdvanceByTime(float dt /* r1+0x8 */) {}

// Range: 0x803339E0 -> 0x80333A14
// this: r31
struct Step & AnimSequence::NextStep() {}

// Range: 0x80333A14 -> 0x80333A64
// this: r3
int AnimSequence::NextIndex() {}

// Range: 0x80333A64 -> 0x80333AC8
// this: r31
void AnimSequence::Advance() {}

// Range: 0x80333AC8 -> 0x80333CF4
// this: r31
float AnimFrameStepper::PreUpdate(float dt /* f31 */) {
    // Local variables
    float timeInc; // f27
}
...
// total size: 0x10
struct /* @class$1671zCompLogicAnimViewer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80333CF4 -> 0x80333CF8
void zCompLogicAnimViewer::DebugRender() {}
...
// total size: 0x4C
struct {} zAnimViewerCamera::__vtable; // size: 0x4C, address: 0x8052E4BC
// Range: 0x80333CF8 -> 0x80333EE0
// this: r31
void zAnimViewerCamera::update(float dt /* f25 */) {
    // References
    // -> float MAX_DISTANCE;
    // -> float MIN_DISTANCE;
...
// Range: 0x80333EE0 -> 0x80333FB4
void zAnimViewerCamera::polar_to_cart(struct xVec3 & loc /* r30 */, const struct xVec3 & origin /* r31 */, float theta /* f28 */, float phi /* f29 */, float dist /* f30 */) {
    // Local variables
    float cp; // f31
}

// Range: 0x80333FB4 -> 0x80333FC8
void zAnimViewerCamera::StickAdjust(float & val /* r3 */, float adjustment /* f1 */, float scale /* f2 */, float dt /* f3 */) {}
