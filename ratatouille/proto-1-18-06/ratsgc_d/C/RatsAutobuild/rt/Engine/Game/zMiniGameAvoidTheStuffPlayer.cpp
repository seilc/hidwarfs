/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameAvoidTheStuffPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80334694 -> 0x80334F48
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80D67AD0
// total size: 0xC
class zAvoidTheStuffPlayerMove : public zPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);

    void Reset();
};
// Range: 0x80334694 -> 0x80334968
// this: r30
void zAvoidTheStuffPlayerMove::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x80334968 -> 0x80334AD0
void zAvoidTheStuffPlayerMove::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x80334AD0 -> 0x80334B3C
// this: r31
void zAvoidTheStuffPlayerMove::Reset() {}

// Range: 0x80334B3C -> 0x80334B44
unsigned int zAvoidTheStuffPlayerMove::StartJumpCheck() {}

// Range: 0x80334B44 -> 0x80334B4C
unsigned int zAvoidTheStuffPlayerMove::StartDuckCheck() {}

// Range: 0x80334B4C -> 0x80334B54
unsigned int zAvoidTheStuffPlayerMove::StartBlockLeftCheck() {}

// Range: 0x80334B54 -> 0x80334B5C
unsigned int zAvoidTheStuffPlayerMove::StartBlockRightCheck() {}

// total size: 0x13B0
class zMiniGameAvoidTheStuffPlayer : public zMiniGamePlayer {
    // Functions
...
// Range: 0x80334B5C -> 0x80334B8C
// this: r1+0x8
void zMiniGameAvoidTheStuffPlayer::Init(struct xEntAsset * asset /* r1+0xC */) {}
...
// total size: 0x10
struct /* @class$1288zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
// Range: 0x80334B8C -> 0x80334C38
// this: r31
void zMiniGameAvoidTheStuffPlayer::BeginUpdate(float dt /* f31 */) {
    // Local variables
    struct zEnt * ent; // r30
...
// total size: 0x4
struct /* @class$901zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
union /* @class$1040zMiniGameAvoidTheStuffPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1039zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Static members
...
// Range: 0x80334C38 -> 0x80334D20
// this: r31
void zMiniGameAvoidTheStuffPlayer::UpdateOrientation(float dt /* r1+0x8 */) {
    // Local variables
...
// Range: 0x80334D20 -> 0x80334D5C
// this: r31
void zMiniGameAvoidTheStuffPlayer::Update(float dt /* r1+0x8 */) {}

// Range: 0x80334D5C -> 0x80334D8C
// this: r1+0x8
void zMiniGameAvoidTheStuffPlayer::EndUpdate(float dt /* r1+0xC */) {}
...
// Range: 0x80334D8C -> 0x80334E08
// this: r31
void zMiniGameAvoidTheStuffPlayer::Render() {
    // References
    // -> struct xColor_tag g_RED;
}

// Range: 0x80334E08 -> 0x80334E48
// this: r31
void zMiniGameAvoidTheStuffPlayer::SceneSetup() {}

// Range: 0x80334E48 -> 0x80334E70
// this: r1+0x8
void zMiniGameAvoidTheStuffPlayer::Reset() {}

// Range: 0x80334E70 -> 0x80334E98
// this: r1+0x8
void zMiniGameAvoidTheStuffPlayer::Exit() {}

// Range: 0x80334E98 -> 0x80334F0C
// this: r30
void zMiniGameAvoidTheStuffPlayer::InitActions() {}

// total size: 0x12C
struct {} zMiniGameAvoidTheStuffPlayer::__vtable; // size: 0x12C, address: 0x8052E5A0
// total size: 0x13B0
...
// total size: 0x54
struct {} zAvoidTheStuffPlayerMove::__vtable; // size: 0x54, address: 0x8052E6CC
// total size: 0xC
