/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCommonPlayerActionPushPull.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802FA5A8 -> 0x802FB9E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float STICK_MAGNITUDE; // size: 0x4, address: 0x80D671C8
static float PERP_DIST; // size: 0x4, address: 0x80D671CC
static float ACCELERATION; // size: 0x4, address: 0x80D671D0
static float SPEED_MAX; // size: 0x4, address: 0x80D671D4
// total size: 0x20
struct Asset : public xDynAsset {
    // Members
    unsigned int modelID; // offset 0x10, size 0x4
    int locationX; // offset 0x14, size 0x4
    float locationY; // offset 0x18, size 0x4
    int locationZ; // offset 0x1C, size 0x4
};
// total size: 0xEC
class zPushableObject : public xEnt {
    // Members
protected:
    const struct Asset & asset; // offset 0xD8, size 0x4
    float speed; // offset 0xDC, size 0x4
    struct xVec3 dir; // offset 0xE0, size 0xC
};
// total size: 0x2C
class zCommonPlayerActionPushPull : public zCommonPlayerAction {
    // Functions
    void AddStates(struct xAnimTable * table);

    void AddActionTransitions(struct xAnimTable * table);

    unsigned int PushCheck();

    unsigned int StartCheck();

    unsigned int PullCheck();

    unsigned int MoveStopCheck();

    unsigned int MoveReleaseCheck();

    unsigned int ReleaseCheck();

    unsigned int GrabFinishCB();
    ...
    unsigned char PullCanSucceed(float translation);

    unsigned char PushCanSucceed(float translation);
    ...
    // Members
protected:
    class zPushableObject * object; // offset 0xC, size 0x4
    class zPushableObject * nextObject; // offset 0x10, size 0x4
    unsigned char held; // offset 0x14, size 0x1
    unsigned char state; // offset 0x15, size 0x1
    union { // inferred
        struct xVec3 blendVel; // offset 0x18, size 0xC
        float distance; // offset 0x18, size 0x4
    };
    float targetAngle; // offset 0x24, size 0x4
    float speed; // offset 0x28, size 0x4
};
// Range: 0x802FA5A8 -> 0x802FA698
void zCommonPlayerActionPushPull::AddTweaks() {
    // Local variables
    ...
    // -> static float PERP_DIST;
    // -> static float STICK_MAGNITUDE;
}

// Range: 0x802FA698 -> 0x802FA844
// this: r30
void zCommonPlayerActionPushPull::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802FA844 -> 0x802FA898
// this: r31
void zCommonPlayerActionPushPull::AddActionTransitions(struct xAnimTable * table /* r1+0x8 */) {}

// Range: 0x802FA898 -> 0x802FABC0
void zCommonPlayerActionPushPull::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802FABC0 -> 0x802FAC1C
// this: r30
unsigned int zCommonPlayerActionPushPull::PushCheck() {}

// Range: 0x802FAC1C -> 0x802FAC78
// this: r31
unsigned int zCommonPlayerActionPushPull::StartCheck() {}
...
// total size: 0x4
struct /* @class$892zCommonPlayerActionPushPull_cpp */ {
    // Members
...
union /* @class$1040zCommonPlayerActionPushPull_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zCommonPlayerActionPushPull_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$833zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// Range: 0x802FAC78 -> 0x802FACD4
// this: r30
unsigned int zCommonPlayerActionPushPull::PullCheck() {}

// Range: 0x802FACD4 -> 0x802FAD0C
// this: r3
unsigned int zCommonPlayerActionPushPull::MoveStopCheck() {}

// Range: 0x802FAD0C -> 0x802FAD44
// this: r3
unsigned int zCommonPlayerActionPushPull::MoveReleaseCheck() {}

// Range: 0x802FAD44 -> 0x802FAD54
// this: r3
unsigned int zCommonPlayerActionPushPull::ReleaseCheck() {}

// Range: 0x802FAD54 -> 0x802FADA0
// this: r31
unsigned int zCommonPlayerActionPushPull::GrabFinishCB() {}

// Range: 0x802FADA0 -> 0x802FADF4
// this: r1+0x8
void zCommonPlayerActionPushPull::AddStandardTransitionsFrom(struct xAnimTable * table /* r1+0xC */, const char * fromStates /* r1+0x10 */) {}

// Range: 0x802FADF4 -> 0x802FAE5C
void zCommonPlayerActionPushPull::AddTransitionsFrom(struct xAnimTable * table /* r1+0x8 */, const char * fromStates /* r1+0xC */, unsigned short priority /* r1+0x10 */, float blend /* r1+0x14 */, unsigned int flags /* r1+0x18 */, unsigned int userFlags /* r1+0x1C */) {}

// Range: 0x802FAE5C -> 0x802FAE70
// this: r3
void zCommonPlayerActionPushPull::Reset() {}
...
// Range: 0x802FAE70 -> 0x802FAFB4
// this: r30
unsigned char zCommonPlayerActionPushPull::GetDesiredState() {
    // Local variables
    const struct AnalogStick & controlStick; // r31
    struct xVec3 stickDir; // r1+0x8
...
// Range: 0x802FAFB4 -> 0x802FB068
// this: r31
unsigned char zCommonPlayerActionPushPull::PullCanSucceed(float translation /* r1+0x8 */) {
    // Local variables
    struct xVec3 startPos; // r1+0x18
    struct xVec3 endPos; // r1+0xC
...
// Range: 0x802FB068 -> 0x802FB0E0
// this: r31
unsigned char zCommonPlayerActionPushPull::PushCanSucceed(float translation /* r1+0x8 */) {
    // Local variables
    struct xVec3 pos; // r1+0xC
}

// Range: 0x802FB0E0 -> 0x802FB144
// this: r31
void zCommonPlayerActionPushPull::Timestep() {}

// Range: 0x802FB144 -> 0x802FB63C
// this: r31
void zCommonPlayerActionPushPull::Move(struct xScene * s /* r1+0x8 */, float dt /* f29 */, struct xEntFrame * frame /* r29 */) {
    // Local variables
    float gridCellSize; // f30
    unsigned char toIdle; // r26
    float translation; // f31
    unsigned int animFlags; // r27
    unsigned char moved; // r25
    unsigned char moveable; // r24
    unsigned char desiredState; // r28
    float oldSpeed; // f24
    int newCell; // r23
    float pos; // f28
    float cellPos; // f27
    float toCell; // f25
    float actualTranslation; // f26
    struct xVec3 & objectPos; // r30
...
// Range: 0x802FB63C -> 0x802FB980
// this: r30
void zCommonPlayerActionPushPull::Begin() {
    // Local variables
    int side; // r29
    float distance; // f30
    const struct xBound & bound; // r31
    const struct xVec3 & playerPos; // r28
    class xPlane plane; // r1+0x2C
    struct xVec3 upper; // r1+0x20
    struct xVec3 lower; // r1+0x14
    float tempDist; // f31
    float tempDist; // f29
    float tempDist; // f28
    struct xVec3 norm; // r1+0x8
    float timeScale; // f27
...
// total size: 0x4
struct /* @class$2081zCommonPlayerActionPushPull_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2082zCommonPlayerActionPushPull_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2083zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2080zCommonPlayerActionPushPull_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2085zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1288zCommonPlayerActionPushPull_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802FB980 -> 0x802FB9B8
// this: r31
void zCommonPlayerActionPushPull::End() {}

// Range: 0x802FB9B8 -> 0x802FB9E0
// this: r3
void zCommonPlayerActionPushPull::NotifyCollision(const struct SphereCollisionResults & sceneCollide /* r5 */) {}

// total size: 0x54
struct {} zCommonPlayerActionPushPull::__vtable; // size: 0x54, address: 0x80529B20
// total size: 0xC
