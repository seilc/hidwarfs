/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCRightArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8031FFB4 -> 0x8032016C
*/
char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicRightArm,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67858
signed char zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B9A8
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B9AC
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x80320034 -> 0x8032005C
// this: r1+0x8
void zNPCRightArm::Deactivate() {}

// Range: 0x8032005C -> 0x80320120
// this: r30
void zNPCRightArm::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$984zNPCRightArm_cpp */ {
    // Members
...
union /* @class$1124zNPCRightArm_cpp */ {
...
// total size: 0xC
struct /* @class$1122zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$861zNPCRightArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$862zNPCRightArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$863zNPCRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$864zNPCRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$865zNPCRightArm_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCRightArm::__vtable; // size: 0x3C, address: 0x8052D668
