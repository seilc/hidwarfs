/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCOneLiner.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E5178 -> 0x802E55C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sTimeSinceLastOneLiner; // size: 0x4, address: 0x80D6B718
// total size: 0x10
struct zNPCOneLiner {
    // Members
    class zNPCCommon * source; // offset 0x0, size 0x4
    int priority; // offset 0x4, size 0x4
    enum ezNPCOneLinerType type; // offset 0x8, size 0x4
    enum iSndGroupHandle soundGroup; // offset 0xC, size 0x4
};
// total size: 0x204
struct zNPCOneLinerSystem {
    // Members
    struct zNPCOneLiner line[32]; // offset 0x0, size 0x200
    int total; // offset 0x200, size 0x4
};
static struct zNPCOneLinerSystem sInternal; // size: 0x204, address: 0x80D2D5D8
static struct zNPCOneLinerSystem sExternal; // size: 0x204, address: 0x80D2D7DC
// total size: 0xC
struct zNPCOneLinerExternalSource {
    // Members
    class zNPCCommon * source; // offset 0x0, size 0x4
    enum iSndGroupHandle soundGroup; // offset 0x4, size 0x4
    float timeLeft; // offset 0x8, size 0x4
};
static struct zNPCOneLinerExternalSource sExternalSource; // size: 0xC, address: 0x80D6B71C
enum iSndGroupHandle {
};
static enum iSndGroupHandle sLastPlayed; // size: 0x4, address: 0x80D6B728
// Range: 0x802E5178 -> 0x802E5184
static void _ResetList(struct zNPCOneLinerSystem * ol /* r3 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D66D10
...
// Range: 0x802E5184 -> 0x802E5258
static void _AddOneLiner(struct zNPCOneLinerSystem * ols /* r30 */, class zNPCCommon * inSource /* r1+0x8 */, enum ezNPCOneLinerType inType /* r1+0xC */, int inPriority /* r1+0x10 */, enum iSndGroupHandle inSoundGroup /* r1+0x14 */) {
    // Local variables
    struct zNPCOneLiner * ol; // r31

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x802E5258 -> 0x802E52FC
void zNPCOneLinerSystemPreUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static struct zNPCOneLinerExternalSource sExternalSource;
    // -> static struct zNPCOneLinerSystem sExternal;
    // -> static struct zNPCOneLinerSystem sInternal;
}
...
// Range: 0x802E52FC -> 0x802E5490
void zNPCOneLinerSystemPostUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static struct zNPCOneLinerSystem sInternal;
    // -> static enum iSndGroupHandle sLastPlayed;
    // -> static float sTimeSinceLastOneLiner;
    // -> static struct zNPCOneLinerSystem sExternal;
    // -> struct zGlobals globals;
    // -> static struct zNPCOneLinerExternalSource sExternalSource;
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80529520
enum ezNPCOneLinerPriority {
    ezOLP_Lowest = 0,
    ezOLP_Low = 1,
    ezOLP_Medium = 2,
    ezOLP_High = 3,
...
// Range: 0x802E5490 -> 0x802E556C
void zNPCOneLinerPlayInternal(class zNPCCommon * inSource /* r30 */, enum ezNPCOneLinerType inType /* r29 */, enum ezNPCOneLinerPriority inPriority /* r1+0x8 */) {
    // Local variables
    enum iSndGroupHandle soundHandle; // r31
...
// total size: 0x4
struct /* @class$916zNPCOneLiner_cpp */ {
    // Members
...
union /* @class$1055zNPCOneLiner_cpp */ {
...
// total size: 0xC
struct /* @class$1054zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2090zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1872zNPCOneLiner_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$2049zNPCOneLiner_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zNPCOneLiner_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2051zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2048zNPCOneLiner_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2053zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1390zNPCOneLiner_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$791zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$792zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$794zNPCOneLiner_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$795zNPCOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$796zNPCOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$797zNPCOneLiner_cpp */ {
    // Members
...
// Range: 0x802E556C -> 0x802E5584
void zNPCOneLinerPlayExternal(class zNPCCommon * inSource /* r3 */, enum iSndGroupHandle inSoundGroup /* r4 */, float inTime /* f1 */) {
    // References
    // -> static struct zNPCOneLinerExternalSource sExternalSource;
}

// Range: 0x802E5584 -> 0x802E55C4
void zNPCOneLinerSceneReset() {
    // References
    // -> static enum iSndGroupHandle sLastPlayed;
    // -> static struct zNPCOneLinerExternalSource sExternalSource;
    // -> static float sTimeSinceLastOneLiner;
