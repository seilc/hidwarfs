/*
    ...
    Language: C++
    Code range: 0x801B3604 -> 0x801B4478
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801B3604 -> 0x801B3634
void zScriptInit(void * b /* r1+0x8 */, void * tasset /* r1+0xC */) {}

static unsigned int checkScriptInitID; // size: 0x4, address: 0x80D6A988
static signed char init; // size: 0x1, address: 0x80D6A98C
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63810
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801B3634 -> 0x801B37BC
void zScriptInit(struct xBase * b /* r29 */, struct xScriptAsset * tasset /* r30 */) {
    // Local variables
    struct _zScript * t; // r31
    int asdf; // r1+0x8

    // References
    // -> static unsigned int checkScriptInitID;
    // -> static signed char init;
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6381C
// Range: 0x801B37BC -> 0x801B38D0
void zScriptReset(struct _zScript * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63829
// total size: 0x0
struct xSerial {};
// Range: 0x801B38D0 -> 0x801B39C0
void zScriptSave(struct _zScript * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63835
// Range: 0x801B39C0 -> 0x801B3AB0
void zScriptLoad(struct _zScript * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D63841
// Range: 0x801B3AB0 -> 0x801B3D28
void zScriptEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */) {
    // Local variables
    struct _zScript * t; // r31
...
static unsigned int checkScriptID; // size: 0x4, address: 0x80D6A990
static signed char init; // size: 0x1, address: 0x80D6A994
static char __FUNCTION__[21]; // size: 0x15, address: 0x80521860
unsigned int gThisPlayer; // size: 0x4, address: 0x80D6903C
// Range: 0x801B3D28 -> 0x801B415C
static unsigned char zScriptExecuteEvents(struct _zScript * t /* r31 */, float start /* r1+0x8 */, float end /* r1+0xC */) {
    // Local variables
    struct xScriptEventAsset * endEvent; // r28
    int asdf; // r1+0x10
    float lastAbsTime; // f31
    int current; // r26
    unsigned int widget; // r25
    struct xBase * b; // r27
    struct xBase * paramWidget; // r30
    struct xScriptEventAsset * curr; // r29

    // References
    // -> static char __FUNCTION__[21];
    // -> unsigned int gThisPlayer;
    // -> static unsigned int checkScriptID;
    // -> static signed char init;
}

static float script_accel; // size: 0x4, address: 0x80D6A998
static signed char init; // size: 0x1, address: 0x80D6A99C
static unsigned char _temp_tweaks_registered; // size: 0x1, address: 0x80D6A99D
static signed char init; // size: 0x1, address: 0x80D6A99E
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D63850
// total size: 0x2
...
// Range: 0x801B415C -> 0x801B4478
void zScriptUpdate(struct xBase * to /* r29 */, struct xScene * sc /* r1+0x8 */, float dt /* f31 */) {
    // Local variables
    struct _zScript * t; // r31
    int i; // r1+0xC
    struct _tagxPad * padToCheck; // r30
    const char * prefix; // r28

    // References
    // -> static char __FUNCTION__[14];
    // -> static float script_accel;
...
// total size: 0x1
struct /* @class$841zScript_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$842zScript_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$843zScript_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$844zScript_cpp */ {
    // Members
