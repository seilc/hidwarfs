/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicStirringRemy.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80317304 -> 0x80318004
*/
// total size: 0x1
...
static class zCompSteeringBasicParams sSteeringParams; // size: 0x70, address: 0x80D33AC0
float sRemySpeed; // size: 0x4, address: 0x80D676C8
float sRemyAnimSpeed; // size: 0x4, address: 0x80D676CC
float sRemyWeight; // size: 0x4, address: 0x80D676D0
float sArriveDistance2; // size: 0x4, address: 0x80D676D4
static unsigned char gotPush; // size: 0x1, address: 0x80D6B958
static unsigned char gotRun; // size: 0x1, address: 0x80D6B959
static unsigned char arrived; // size: 0x1, address: 0x80D6B95A
static int runIdx; // size: 0x4, address: 0x80D6B95C
static int curIdx; // size: 0x4, address: 0x80D676D8
// total size: 0x0
class zMovePoint {};
static class zMovePoint * mp[100]; // size: 0x190, address: 0x80D33B30
static int mp_count; // size: 0x4, address: 0x80D6B960
static unsigned int replyToID; // size: 0x4, address: 0x80D6B964
// total size: 0x8
...
static struct zCompStateMachineTable gStirringRemyStateMachineTable[4]; // size: 0x20, address: 0x8052D1C8
// total size: 0x2C
struct {} zStirringRemyIdle::__vtable; // size: 0x2C, address: 0x8052D290
// total size: 0x14
class zStirringRemyIdle : public zCompState {
    // Functions
    zStirringRemyIdle();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80317304 -> 0x80317340
// this: r31
zStirringRemyIdle::zStirringRemyIdle() {
    // References
    // -> struct [anonymous] zStirringRemyIdle::__vtable;
}
...
// Range: 0x80317340 -> 0x803173A4
void zStirringRemyIdle::Update(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xEntFrame * entFrame; // r30
    struct xVec3 * entVel; // r29
...
// total size: 0x4
struct /* @class$1068zCompLogicStirringRemy_cpp */ {
    // Members
...
union /* @class$1208zCompLogicStirringRemy_cpp */ {
...
// total size: 0xC
struct /* @class$1206zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$929zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$930zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$932zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$933zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$934zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$935zCompLogicStirringRemy_cpp */ {
    // Members
...
// Range: 0x803173A4 -> 0x803173E0
// this: r1+0x8
void zStirringRemyIdle::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x803173E0 -> 0x80317438
void zStirringRemyIdle::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31

    // References
    // -> static unsigned char arrived;
}

// total size: 0x2C
struct {} zStirringRemyRun::__vtable; // size: 0x2C, address: 0x8052D264
// total size: 0x28
...
// total size: 0x18
class zStirringRemyRun : public zCompState {
    // Functions
    zStirringRemyRun();
...
// Range: 0x80317438 -> 0x80317504
// this: r31
zStirringRemyRun::zStirringRemyRun() {
    // References
    // -> static class zCompSteeringBasicParams sSteeringParams;
    // -> float sRemySpeed;
    // -> struct [anonymous] zStirringRemyRun::__vtable;
}

// Range: 0x80317504 -> 0x80317684
// this: r31
void zStirringRemyRun::Update(class zNPCBase * owner /* r27 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r29
    class zICompNPCEntity * compNPCEntity; // r30
    const struct xVec3 * curPos; // r28
    float mpArriveDistance; // f31

    // References
    // -> static int curIdx;
    // -> static class zMovePoint * mp[100];
    // -> static int runIdx;
    // -> static unsigned int replyToID;
    // -> static unsigned char arrived;
    // -> float sArriveDistance2;
}

// total size: 0x8
class zICompSteering : public zIComponent {};
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D676DC
// Range: 0x80317684 -> 0x80317748
// this: r31
void zStirringRemyRun::Enter(class zNPCBase * owner /* r1+0x8 */) {
    // References
    // -> static int curIdx;
    // -> static class zMovePoint * mp[100];
...
// Range: 0x80317748 -> 0x80317808
// this: r27
void zStirringRemyRun::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    ...
    // References
    // -> static unsigned char gotRun;
    // -> static class zCompSteeringBasicParams sSteeringParams;
    // -> float sRemyAnimSpeed;
}
...
// total size: 0x2C
struct {} zStirringRemyPush::__vtable; // size: 0x2C, address: 0x8052D238
// total size: 0x14
class zStirringRemyPush : public zCompState {
    // Functions
    zStirringRemyPush();

    void Enter(class zNPCBase * owner);
};
// Range: 0x80317808 -> 0x80317844
// this: r31
zStirringRemyPush::zStirringRemyPush() {
    // References
    // -> struct [anonymous] zStirringRemyPush::__vtable;
}

// Range: 0x80317844 -> 0x80317848
void zStirringRemyPush::Update() {}

// Range: 0x80317848 -> 0x80317884
// this: r1+0x8
void zStirringRemyPush::Enter(class zNPCBase * owner /* r1+0xC */) {}

// Range: 0x80317884 -> 0x803178E0
void zStirringRemyPush::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31

    // References
    // -> static unsigned char gotPush;
}
...
// Range: 0x803178E0 -> 0x803178E8
unsigned char zCompLogicStirringRemy::AreWeThereYet() {
    // References
    // -> static unsigned char arrived;
}

// Range: 0x803178E8 -> 0x803178F0
unsigned char zCompLogicStirringRemy::GotRunEvent() {
    // References
    // -> static unsigned char gotRun;
}

// Range: 0x803178F0 -> 0x803178F8
unsigned char zCompLogicStirringRemy::GotPushEvent() {
    // References
    // -> static unsigned char gotPush;
}

// Range: 0x803178F8 -> 0x8031796C
unsigned char zCompLogicStirringRemy::IsAnimationStopped(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
...
// Range: 0x8031796C -> 0x80317C30
void zCompLogicStirringRemy::AddStaticTweaks() {
    // Local variables
    char * prefix; // r30
    char * prefix; // r31
...
// Range: 0x80317C30 -> 0x80317D3C
void zCompLogicStirringRemy::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x80317D3C -> 0x80317DC8
// this: r31
void zCompLogicStirringRemy::SetupStateTranstitionTests() {}

// Range: 0x80317DC8 -> 0x80317DD0
int zCompLogicStirringRemy::GetInitialStateEnum() {}

// Range: 0x80317DD0 -> 0x80317DDC
struct zCompStateMachineTable * zCompLogicStirringRemy::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gStirringRemyStateMachineTable[4];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D676E2
// Range: 0x80317DDC -> 0x80317F14
// this: r1+0x8
void zCompLogicStirringRemy::Attached() {
    // Local variables
    int i; // r31
    char name[32]; // r1+0xC
    class zMovePoint * zmp; // r30
...
// Range: 0x80317F14 -> 0x80318004
unsigned char zCompLogicStirringRemy::SystemEvent(unsigned int to_event /* r1+0x8 */, const float * to_param /* r31 */, unsigned int to_param_widget_id /* r1+0xC */) {
    // References
    // -> static unsigned int replyToID;
    // -> static unsigned char gotPush;
    // -> static unsigned char gotRun;
