/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompSteeringFlocking.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803181DC -> 0x80318F90
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zCompSteeringFlockingParams : public zCompSteeringBasicParams {
    // Functions
    void AddTweaks(const char * name);
...
static class zCompSteeringFlockingParams gDefaultFlockingParams; // size: 0x8C, address: 0x80D33CC0
// Range: 0x803181DC -> 0x80318348
// this: r31
void zCompSteeringFlockingParams::AddTweaks(const char * name /* r30 */) {}

// total size: 0x60
struct {} zCompSteeringFlocking::__vtable; // size: 0x60, address: 0x8052D2C0
// total size: 0x3C
class zCompSteeringFlocking : public zCompSteeringBasic {
    // Functions
    zCompSteeringFlocking();
    ...
    void GetSeperationForce(struct xVec3 & SeperationForce, class zSteeringBasicDynamics & steeringDynamics);

    void GetPlayerAvoidenceForce(struct xVec3 & PlayerAvoidenceForce, class zSteeringBasicDynamics & steeringDynamics);

    void GetAlignmentForce(struct xVec3 & AlignmentForce, class zSteeringBasicDynamics & steeringDynamics);

    void GetCohesionForce(struct xVec3 & CohesionForce, class zSteeringBasicDynamics & steeringDynamics);
...
// Range: 0x80318348 -> 0x80318384
// this: r31
zCompSteeringFlocking::zCompSteeringFlocking() {
    // References
    // -> struct [anonymous] zCompSteeringFlocking::__vtable;
}

// Range: 0x80318384 -> 0x803183CC
// this: r31
void zCompSteeringFlocking::Attached() {
    // References
    // -> static class zCompSteeringFlockingParams gDefaultFlockingParams;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D676F0
// Range: 0x803183CC -> 0x803184C4
// this: r31
void zCompSteeringFlocking::AllAttached() {
    // Local variables
    class zNPCBase * ownerNPC; // r29
    class zNPCBase * parentNPC; // r30
...
// Range: 0x803184C4 -> 0x803184EC
// this: r1+0x8
void zCompSteeringFlocking::Detached() {}

// Range: 0x803184EC -> 0x80318524
// this: r1+0x8
void zCompSteeringFlocking::Update(struct xScene * xscn /* r1+0xC */, float dt /* r1+0x10 */) {}

static unsigned char renderSeperationForce; // size: 0x1, address: 0x80D6B968
static unsigned char renderPlayerAvoidenceForce; // size: 0x1, address: 0x80D6B969
static unsigned char renderAlignmentForce; // size: 0x1, address: 0x80D6B96A
static unsigned char renderCohesionForce; // size: 0x1, address: 0x80D6B96B
static unsigned char renderWallAvoidenceForce; // size: 0x1, address: 0x80D6B96C
static unsigned char renderSphereAvoidenceForce; // size: 0x1, address: 0x80D6B96D
static unsigned char renderWanderForce; // size: 0x1, address: 0x80D6B96E
static unsigned char renderSeekForce; // size: 0x1, address: 0x80D6B96F
static unsigned char renderFleeForce; // size: 0x1, address: 0x80D6B970
// Range: 0x80318524 -> 0x80318728
void zCompSteeringFlocking::AddStaticTweaks() {
    // Local variables
    ...
    // -> static unsigned char renderCohesionForce;
    // -> static unsigned char renderAlignmentForce;
    // -> static unsigned char renderPlayerAvoidenceForce;
    // -> static unsigned char renderSeperationForce;
}

static class zNPCBase * gNeighbourNPCs; // size: 0x4, address: 0x80D6B974
static int gNumberNeighbourNPCs; // size: 0x4, address: 0x80D6B978
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80318728 -> 0x80318C28
// this: r30
void zCompSteeringFlocking::CalculateForce(struct xVec3 & force /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */, float dt /* f31 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r31
    class zNPCBase * curNPC; // r27
    class zNPCBase * parentSwarmNPC; // r26
    struct xVec3 WallAvoidenceForce; // r1+0x8C
    struct xVec3 SphereAvoidenceForce; // r1+0x80
    struct xVec3 SeperationForce; // r1+0x74
    struct xVec3 PlayerAvoidenceForce; // r1+0x68
    struct xVec3 AlignmentForce; // r1+0x5C
    struct xVec3 CohesionForce; // r1+0x50
    ...
    // -> static unsigned char renderCohesionForce;
    // -> static int gNumberNeighbourNPCs;
    // -> static unsigned char renderAlignmentForce;
    // -> static unsigned char renderPlayerAvoidenceForce;
    // -> static unsigned char renderSeperationForce;
    // -> static unsigned char renderSphereAvoidenceForce;
    ...
    // -> struct xVec3 m_Null;
    // -> static class zNPCBase * gNeighbourNPCs;
}

// Range: 0x80318C28 -> 0x80318D40
// this: r27
void zCompSteeringFlocking::GetSeperationForce(struct xVec3 & SeperationForce /* r25 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r30
    const struct xVec3 * neighbourEntityPos; // r28
    int i; // r31
    class zICompNPCEntity * curNeighbourEntity; // r26
    float dist2; // f31
    struct xVec3 SeperationFromAgent; // r1+0x8
    float dist; // f30
...
// total size: 0x4
struct /* @class$901zCompSteeringFlocking_cpp */ {
    // Members
...
union /* @class$1040zCompSteeringFlocking_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zCompSteeringFlocking_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1750zCompSteeringFlocking_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80318D40 -> 0x80318E6C
// this: r1+0x8
void zCompSteeringFlocking::GetPlayerAvoidenceForce(struct xVec3 & PlayerAvoidenceForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r31
    struct xVec3 * playerPos; // r29
    float dist2; // f31
    struct xVec3 SeperationFromPlayer; // r1+0xC
    float dist; // f29
    float forceMag; // f30
...
// total size: 0x890
struct /* @class$1993zCompSteeringFlocking_cpp */ {
    // Static members
...
// Range: 0x80318E6C -> 0x80318EDC
// this: r28
void zCompSteeringFlocking::GetAlignmentForce(struct xVec3 & AlignmentForce /* r29 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */) {
    // Local variables
    const struct xVec3 * flockAlignment; // r31
...
// Range: 0x80318EDC -> 0x80318F90
// this: r29
void zCompSteeringFlocking::GetCohesionForce(struct xVec3 & CohesionForce /* r30 */, class zSteeringBasicDynamics & steeringDynamics /* r31 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r1+0x8
    const struct xVec3 * flockCenter; // r28
    struct xVec3 desiredVelocity; // r1+0xC
...
// total size: 0xC
struct {} zCompSteeringFlockingParams::__vtable; // size: 0xC, address: 0x80D676FC
// total size: 0x1
