/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompStateMachine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80311028 -> 0x80313534
*/
// total size: 0x50
struct {} zCompStateMachine::__vtable; // size: 0x50, address: 0x8052CEDC
// total size: 0x8
...
class zCompStateMachine : public zICompLogic {
    ...
    unsigned char RunStateTests(class zCompState * ownerState, float dt);

    unsigned char RunTests(struct zCompStateTest * tests, float dt, class zCompState * ownerState);

    void AddSwitchTest(int fromStateEnum, int toStateEnum, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *), float testPeriod);

    void AddPushTest(int fromStateEnum, int toStateEnum, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *), float testPeriod);

    void AddPopTest(int fromStateEnum, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *), float testPeriod);

    void SwitchState(int fromStateEnum, int toStateEnum);

    void PushState(int fromStateEnum, int toStateEnum);

    void PopState(int stateEnum);

    void PushStateOnLast(int toStateEnum);

    void SwitchLastState(int toStateEnum);

    void AddTranstitionEvent(enum eStateTranstitionType transtitionType, class zCompState * fromState, class zCompState * toState);

    void HandleStateTranstitions();

    void HandleSwitch(class zCompState * fromState, class zCompState * toState);

    void HandlePop(class zCompState * fromState);

    void HandlePush(class zCompState * fromState, class zCompState * toState);

    unsigned char AppendDebugString(char * string, int stringSize);
...
// Range: 0x80311028 -> 0x80311094
// this: r31
zCompStateMachine::zCompStateMachine() {
    // References
    // -> struct [anonymous] zCompStateMachine::__vtable;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D674D8
// Range: 0x803110D0 -> 0x803111C0
// this: r31
void zCompStateMachine::Update(float dt /* f31 */) {
    // References
...
// Range: 0x803111C0 -> 0x80311240
// this: r31
unsigned char zCompStateMachine::SystemEvent(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int to_event /* r1+0x10 */, const float * to_param /* r1+0x14 */, struct xBase * to_param_widget /* r1+0x18 */, unsigned int to_param_widget_id /* r1+0x1C */) {}

// Range: 0x80311240 -> 0x8031128C
// this: r31
void zCompStateMachine::DebugRender() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D674DF
// Range: 0x8031128C -> 0x80311420
// this: r31
void zCompStateMachine::Attached() {
    // Local variables
    int initialStateEnum; // r30
    int globalStateEnum; // r28
    int i; // r29
...
// Range: 0x80311420 -> 0x8031146C
// this: r31
void zCompStateMachine::AllAttached() {}

// Range: 0x8031146C -> 0x803114C0
// this: r31
void zCompStateMachine::Detached() {}

static int gStateMachineExtraMemUsed; // size: 0x4, address: 0x80D6B8E0
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D674E8
// Range: 0x803114C0 -> 0x80311810
// this: r31
int zCompStateMachine::Initialize() {
    // Local variables
    int i; // r30
    int initialStateEnum; // r29
    int globalStateEnum; // r28

    // References
    // -> static int gStateMachineExtraMemUsed;
    // -> static char __FUNCTION__[11];
}

// Range: 0x80311810 -> 0x80311854
// this: r1+0x8
unsigned char zCompStateMachine::RunStateTests(class zCompState * ownerState /* r31 */, float dt /* r1+0xC */) {}

// Range: 0x80311854 -> 0x8031196C
// this: r30
unsigned char zCompStateMachine::RunTests(struct zCompStateTest * tests /* r27 */, float dt /* r1+0x8 */, class zCompState * ownerState /* r28 */) {
    // Local variables
    unsigned char CurStateChanging; // r29
    struct zCompStateTest * curTest; // r31
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D674F3
// Range: 0x8031196C -> 0x80311A8C
void zCompStateMachine::AppendTest(struct zCompStateTest * testToAppend /* r29 */, struct zCompStateTest * * linkedList /* r30 */) {
    // Local variables
    struct zCompStateTest * curTest; // r31
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D674FE
...
// Range: 0x80311A8C -> 0x80311B70
struct zCompStateTest * zCompStateMachine::NewTest(class zCompState * toState /* r1+0x8 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r1+0xC */, enum eStateTranstitionType type /* r1+0x10 */, float testPeriod /* f31 */) {
    // Local variables
    struct zCompStateTest * newStateTest; // r31
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D67506
// Range: 0x80311B70 -> 0x80311D2C
// this: r29
void zCompStateMachine::AddSwitchTest(int fromStateEnum /* r1+0x8 */, int toStateEnum /* r1+0xC */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r1+0x10 */, float testPeriod /* r1+0x14 */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r30
    struct zCompStateTest * newStateTest; // r28

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67514
// Range: 0x80311D2C -> 0x80311EE8
// this: r29
void zCompStateMachine::AddPushTest(int fromStateEnum /* r1+0x8 */, int toStateEnum /* r1+0xC */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r1+0x10 */, float testPeriod /* r1+0x14 */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r30
    struct zCompStateTest * newStateTest; // r28
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D67520
// Range: 0x80311EE8 -> 0x80311FC4
// this: r29
void zCompStateMachine::AddPopTest(int fromStateEnum /* r1+0x8 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r1+0xC */, float testPeriod /* r1+0x10 */) {
    // Local variables
    class zCompState * fromState; // r31
    struct zCompStateTest * newStateTest; // r30

    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6752B
// Range: 0x80311FC4 -> 0x803120EC
// this: r29
void zCompStateMachine::SwitchState(int fromStateEnum /* r1+0x8 */, int toStateEnum /* r1+0xC */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67537
// Range: 0x803120EC -> 0x80312214
// this: r29
void zCompStateMachine::PushState(int fromStateEnum /* r1+0x8 */, int toStateEnum /* r1+0xC */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r30
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D67541
// Range: 0x80312214 -> 0x803122C4
// this: r30
void zCompStateMachine::PopState(int stateEnum /* r1+0x8 */) {
    // Local variables
    class zCompState * State; // r31

    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6754A
// Range: 0x803122C4 -> 0x80312374
// this: r30
void zCompStateMachine::PushStateOnLast(int toStateEnum /* r1+0x8 */) {
    // Local variables
    class zCompState * toState; // r31

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6755A
// Range: 0x80312374 -> 0x80312424
// this: r30
void zCompStateMachine::SwitchLastState(int toStateEnum /* r1+0x8 */) {
    // Local variables
    class zCompState * toState; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6756A
// Range: 0x80312424 -> 0x803124C0
// this: r1+0x8
void zCompStateMachine::AddTranstitionEvent(enum eStateTranstitionType transtitionType /* r1+0xC */, class zCompState * fromState /* r1+0x10 */, class zCompState * toState /* r1+0x14 */) {
    // Local variables
    unsigned char pushSuccessful; // r31
...
class zCompStateTransEventFIFO {
    // Functions
    zCompStateTransEventFIFO();

    int Initialize(int size);

    zCompStateTransEventFIFO(struct zCompStateTransEvent * eventsPool, int size);

    unsigned char PushEvent(enum eStateTranstitionType transtitionType, class zCompState * fromState, class zCompState * toState);

    unsigned char PushEvent(struct zCompStateTransEvent * event);

    struct zCompStateTransEvent * PopEvent();

    void Clear();

    unsigned char AppendDebugString(char * string, int stringSize, unsigned char markLast);
...
// Range: 0x803124C0 -> 0x803124EC
// this: r3
zCompStateTransEventFIFO::zCompStateTransEventFIFO() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D6757E
// Range: 0x803124EC -> 0x803125B8
// this: r31
int zCompStateTransEventFIFO::Initialize(int size /* r30 */) {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x803125B8 -> 0x803125E0
// this: r3
zCompStateTransEventFIFO::zCompStateTransEventFIFO(struct zCompStateTransEvent * eventsPool /* r4 */, int size /* r5 */) {}

// Range: 0x803125E0 -> 0x80312668
// this: r3
unsigned char zCompStateTransEventFIFO::PushEvent(enum eStateTranstitionType transtitionType /* r4 */, class zCompState * fromState /* r5 */, class zCompState * toState /* r6 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67589
// Range: 0x80312668 -> 0x80312700
// this: r1+0x8
unsigned char zCompStateTransEventFIFO::PushEvent(struct zCompStateTransEvent * event /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x80312700 -> 0x80312768
// this: r3
struct zCompStateTransEvent * zCompStateTransEventFIFO::PopEvent() {
    // Local variables
    int curEvent; // r31
}

// Range: 0x80312768 -> 0x80312784
// this: r3
void zCompStateTransEventFIFO::Clear() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D67593
// Range: 0x80312784 -> 0x80312A38
// this: r30
unsigned char zCompStateTransEventFIFO::AppendDebugString(char * string /* r28 */, int stringSize /* r27 */, unsigned char markLast /* r1+0x8 */) {
    // Local variables
    char buffer[32]; // r1+0x9
    int curEventNum; // r29
    struct zCompStateTransEvent * curEvent; // r31

    // References
    // -> static char __FUNCTION__[18];
}

struct zCompStateTransEvent debugEventsFifoPool[24]; // size: 0x120, address: 0x80D33970
static class zCompStateTransEventFIFO debugEventsFifo; // size: 0x14, address: 0x80D6B8E4
static char __FUNCTION__[24]; // size: 0x18, address: 0x8052CE98
// Range: 0x80312A38 -> 0x80312C84
// this: r31
void zCompStateMachine::HandleStateTranstitions() {
    // Local variables
    struct zCompStateTransEvent * curEvent; // r30
    int stateTranstitionsNumber; // r29
    char debugText[256]; // r1+0x8

    // References
    // -> static char __FUNCTION__[24];
    // -> static class zCompStateTransEventFIFO debugEventsFifo;
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D675A5
// Range: 0x80312C84 -> 0x80312EC8
// this: r31
void zCompStateMachine::HandleSwitch(class zCompState * fromState /* r1+0x8 */, class zCompState * toState /* r30 */) {
    // Local variables
    char debugText[256]; // r1+0x10C
    char debugText[256]; // r1+0xC
    class zCompState * oldCurStatePrev; // r29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D675B2
// Range: 0x80312EC8 -> 0x803130C4
// this: r31
void zCompStateMachine::HandlePop(class zCompState * fromState /* r1+0x8 */) {
    // Local variables
    char debugText[256]; // r1+0xC
    class zCompState * prevState; // r30

    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D675BC
// Range: 0x803130C4 -> 0x803132DC
// this: r31
void zCompStateMachine::HandlePush(class zCompState * fromState /* r27 */, class zCompState * toState /* r30 */) {
    // Local variables
    char debugText[256]; // r1+0x108
    char debugText[256]; // r1+0x8
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D675C7
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x803132DC -> 0x80313514
// this: r28
unsigned char zCompStateMachine::AppendDebugString(char * string /* r31 */, int stringSize /* r29 */) {
    // Local variables
    char buffer1[128]; // r1+0x28
    char buffer2[32]; // r1+0x8
    class zNPCBase * npcBase; // r27
    class zCompState * state; // r30
...
// total size: 0x2C
struct {} zCompState::__vtable; // size: 0x2C, address: 0x8052CEB0
// Range: 0x80313514 -> 0x80313534
// this: r3
zCompState::zCompState() {
    // References
    // -> struct [anonymous] zCompState::__vtable;
}
...
// total size: 0x3C
struct {} zICompLogic::__vtable; // size: 0x3C, address: 0x8052CF2C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$892zCompStateMachine_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zCompStateMachine_cpp */ {
    // Members
...
union /* @class$1031zCompStateMachine_cpp */ {
