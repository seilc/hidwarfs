/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomControllerManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E2BE8 -> 0x802E3418
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char mriIsOnTheLeft; // size: 0x1, address: 0x80D66CB0
static int secondPlayerPort; // size: 0x4, address: 0x80D66CB4
static int totalPlayers; // size: 0x4, address: 0x80D66CB8
static int sysMsgType; // size: 0x4, address: 0x80D66CBC
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66CC0
// Range: 0x802E2BE8 -> 0x802E2C68
...
// total size: 0x54
struct {} zUICustomControllerManager::__vtable; // size: 0x54, address: 0x805293E8
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x802E2C68 -> 0x802E2CC4
// this: r31
zUICustomControllerManager::zUICustomControllerManager(class zUI * ui /* r1+0x8 */) {
    // References
...
// Range: 0x802E2CD4 -> 0x802E336C
// this: r31
unsigned char zUICustomControllerManager::HandleEvent(struct xBase * from /* r30 */, unsigned int toEvent /* r29 */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
...
// total size: 0x2
struct /* @class$1904zUICustomControllerManager_cpp */ {
    // Members
...
// Range: 0x802E336C -> 0x802E3418
// this: r31
void zUICustomControllerManager::ShowSystemMessage(struct xBase * from /* r1+0x10 */, unsigned int strHash /* r1+0x14 */) {
    // Local variables
    float toParams[4]; // r1+0x18
