/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFrostEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80273EC8 -> 0x802740D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float MAX_DECAL_CAST_DIST; // size: 0x4, address: 0x80D65940
static float MAX_DECAL_CAST_DIST_HALF; // size: 0x4, address: 0x80D6B278
static float FROST_DECAL_LIFETIME; // size: 0x4, address: 0x80D65944
static float FROST_EFFECT_EMIT_RATE; // size: 0x4, address: 0x80D65948
static float DECAL_MAX_SIZE; // size: 0x4, address: 0x80D6594C
static float DECAL_MIN_SIZE; // size: 0x4, address: 0x80D65950
static float sEmitTimer; // size: 0x4, address: 0x80D65954
// total size: 0x4
struct node {
    // Members
...
// total size: 0xC
struct /* @class$830zFrostEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831zFrostEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832zFrostEffect_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833zFrostEffect_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zFrostEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zFrostEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zFrostEffect_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$889zFrostEffect_cpp */ {
    // Members
...
union /* @class$601zFrostEffect_cpp */ {
...
// total size: 0xC
struct /* @class$1053zFrostEffect_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
static class zFrostEffect sFrostEmitter; // size: 0x74, address: 0x80D25808
// Range: 0x80273EC8 -> 0x80273F08
void zFrostEffect::ApplyFrost(struct xRay3 & ray /* r1+0x8 */, float emitRate /* r1+0xC */, float emitDistance /* r1+0x10 */) {
    // References
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65958
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x80273F08 -> 0x802740BC
// this: r31
void zFrostEffect::_ApplyFrost(struct xRay3 & ray /* r30 */, float emitRate /* f29 */, float emitDistance /* f31 */) {
    // Local variables
    float decalSize; // f30
