/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zSplash.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801DDD40 -> 0x801E3704
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float emit_y_bias; // size: 0x4, address: 0x80D63FF8
static float zbias; // size: 0x4, address: 0x80D63FFC
static float alpha_coeff1; // size: 0x4, address: 0x80D64000
static float alpha_coeff2; // size: 0x4, address: 0x80D64004
static float alpha_coeff3; // size: 0x4, address: 0x80D64008
static float fade_in_time; // size: 0x4, address: 0x80D6400C
static float fade_out_time; // size: 0x4, address: 0x80D64010
static int type; // size: 0x4, address: 0x80D64014
static unsigned char track_player; // size: 0x1, address: 0x80D6AC68
static float emit_rate; // size: 0x4, address: 0x80D6AC6C
static float emit_random_radius; // size: 0x4, address: 0x80D64018
static float emit_loc_x; // size: 0x4, address: 0x80D6401C
static float emit_loc_y; // size: 0x4, address: 0x80D64020
static float emit_loc_z; // size: 0x4, address: 0x80D64024
// total size: 0xC
struct /* @class$734zSplash_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zSplash_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zSplash_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zSplash_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zSplash_cpp */ {
    // Members
...
static struct tweak_callback cb_emit; // size: 0x28, address: 0x804B6960
static struct tweak_callback cb_plume_fade; // size: 0x28, address: 0x804B6988
// Range: 0x801DDD40 -> 0x801DE01C
static void add_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static float emit_loc_z;
    // -> static float emit_loc_y;
    // -> static float emit_loc_x;
    // -> static float emit_random_radius;
    // -> static float emit_rate;
    // -> static unsigned char track_player;
    // -> static struct tweak_callback cb_emit;
    // -> static struct tweak_callback cb_plume_fade;
    // -> static float fade_out_time;
    // -> static float fade_in_time;
    // -> static float alpha_coeff3;
    // -> static float alpha_coeff2;
    // -> static float alpha_coeff1;
    // -> static float zbias;
    // -> static float emit_y_bias;
}

// Range: 0x801DE01C -> 0x801DE0C0
static void on_change_plume_fade(const struct tweak_info & info /* r31 */) {
    // Local variables
...
static char ini_filename[11]; // size: 0xB, address: 0x80D6EB80
static char * texture_key_names[8]; // size: 0x20, address: 0x80522608
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwTexture * cone_texture; // size: 0x4, address: 0x80D6AC70
// total size: 0x28
struct /* @class$2150zSplash_cpp */ {
    // Members
    float emit_end; // offset 0x0, size 0x4
    float rate; // offset 0x4, size 0x4
    float emitted; // offset 0x8, size 0x4
    float age_rate; // offset 0xC, size 0x4
    float size_start; // offset 0x10, size 0x4
    float size_delta; // offset 0x14, size 0x4
    float size_vel; // offset 0x18, size 0x4
    struct xColor_tag color; // offset 0x1C, size 0x4
    float y_vel; // offset 0x20, size 0x4
    float y_accel; // offset 0x24, size 0x4
};
// total size: 0x24
struct /* @class$2151zSplash_cpp */ {
    // Members
    float emit_begin; // offset 0x0, size 0x4
    float emit_end; // offset 0x4, size 0x4
    float rate; // offset 0x8, size 0x4
    float emitted; // offset 0xC, size 0x4
    float age_rate_min; // offset 0x10, size 0x4
    float age_rate_delta; // offset 0x14, size 0x4
    float size_min; // offset 0x18, size 0x4
    float size_delta; // offset 0x1C, size 0x4
    struct xColor_tag color; // offset 0x20, size 0x4
};
// total size: 0x2C
struct /* @class$2152zSplash_cpp */ {
    // Members
    float emit_end; // offset 0x0, size 0x4
    float rate; // offset 0x4, size 0x4
    float emitted; // offset 0x8, size 0x4
    float age_rate_min; // offset 0xC, size 0x4
    float age_rate_delta; // offset 0x10, size 0x4
    ...
    float y_accel; // offset 0x28, size 0x4
};
// total size: 0xB4
struct splash_emitter {
    ...
    float radius_vel; // offset 0x18, size 0x4
    float dxz; // offset 0x1C, size 0x4
    float dxz_vel; // offset 0x20, size 0x4
    float dy; // offset 0x24, size 0x4
    float dy_vel; // offset 0x28, size 0x4
    float dy_accel; // offset 0x2C, size 0x4
    float alpha_start; // offset 0x30, size 0x4
    float alpha_delta; // offset 0x34, size 0x4
    ...
    struct /* @class$2152zSplash_cpp */ {
        ...
        struct xColor_tag color; // offset 0x24, size 0x4
        float y_accel; // offset 0x28, size 0x4
    } streak; // offset 0x88, size 0x2C
};
static struct splash_emitter * splash_emitters; // size: 0x4, address: 0x80D6AC74
static int splash_emitters_size; // size: 0x4, address: 0x80D6AC78
// total size: 0x48
struct plume_emitter {
    ...
    float vel_delta; // offset 0x24, size 0x4
    float vel_angle; // offset 0x28, size 0x4
    float size_min; // offset 0x2C, size 0x4
    float size_delta; // offset 0x30, size 0x4
    float size_scale; // offset 0x34, size 0x4
    float age_rate_min; // offset 0x38, size 0x4
    float age_rate_delta; // offset 0x3C, size 0x4
    float y_accel; // offset 0x40, size 0x4
    struct xColor_tag color; // offset 0x44, size 0x4
};
static struct plume_emitter * plume_emitters; // size: 0x4, address: 0x80D6AC7C
static int plume_emitters_size; // size: 0x4, address: 0x80D6AC80
// total size: 0x14
...
static struct bubble_emitter * bubble_emitters; // size: 0x4, address: 0x80D6AC84
static int bubble_emitters_size; // size: 0x4, address: 0x80D6AC88
// total size: 0x8
struct chain_link {
    // Members
...
struct chain_config {
    // Members
    struct chain_link links[8]; // offset 0x0, size 0x40
    struct chain_link ordered_links[8]; // offset 0x40, size 0x40
    int links_size; // offset 0x80, size 0x4
};
// total size: 0x18
struct chain_emitter {
    // Members
    const struct chain_config * chain; // offset 0x0, size 0x4
    struct xVec3 loc; // offset 0x4, size 0xC
    float time; // offset 0x10, size 0x4
    int next_link; // offset 0x14, size 0x4
};
static struct chain_emitter * chain_emitters; // size: 0x4, address: 0x80D6AC8C
static int chain_emitters_size; // size: 0x4, address: 0x80D6AC90
static int mist_system_id; // size: 0x4, address: 0x80D6AC94
static int ring_system_id; // size: 0x4, address: 0x80D6AC98
static int streak_system_id; // size: 0x4, address: 0x80D6AC9C
static int plume_system_id; // size: 0x4, address: 0x80D6ACA0
static int trail_system_id; // size: 0x4, address: 0x80D6ACA4
static int drips_system_id; // size: 0x4, address: 0x80D6ACA8
enum type_enum {
    TYPE_SPLASH = 0,
    TYPE_PLUME = 1,
    TYPE_BUBBLE = 2,
...
// total size: 0x2C
struct /* @class$2153zSplash_cpp */ {
    // Members
    float life; // offset 0x0, size 0x4
    float radius_birth; // offset 0x4, size 0x4
    float radius_death; // offset 0x8, size 0x4
    float dxz_birth; // offset 0xC, size 0x4
    float dxz_death; // offset 0x10, size 0x4
    float dy_birth; // offset 0x14, size 0x4
    float dy_max; // offset 0x18, size 0x4
    float dy_airtime; // offset 0x1C, size 0x4
    int alpha_birth; // offset 0x20, size 0x4
    int alpha_death; // offset 0x24, size 0x4
    unsigned int sound_group_id; // offset 0x28, size 0x4
};
// total size: 0x20
struct /* @class$2154zSplash_cpp */ {
    // Members
    float rate; // offset 0x0, size 0x4
    float size_min; // offset 0x4, size 0x4
    float size_max; // offset 0x8, size 0x4
    float size_scale; // offset 0xC, size 0x4
    float life; // offset 0x10, size 0x4
    float y_vel; // offset 0x14, size 0x4
    float y_accel; // offset 0x18, size 0x4
    struct xColor_tag color; // offset 0x1C, size 0x4
};
// total size: 0x20
struct /* @class$2155zSplash_cpp */ {
    // Members
    float emit_begin; // offset 0x0, size 0x4
    float emit_end; // offset 0x4, size 0x4
    float rate; // offset 0x8, size 0x4
    float life_min; // offset 0xC, size 0x4
    float life_max; // offset 0x10, size 0x4
    float size_min; // offset 0x14, size 0x4
    float size_max; // offset 0x18, size 0x4
    struct xColor_tag color; // offset 0x1C, size 0x4
};
// total size: 0x28
struct /* @class$2156zSplash_cpp */ {
    // Members
    float emit_end; // offset 0x0, size 0x4
    float rate; // offset 0x4, size 0x4
    float life_min; // offset 0x8, size 0x4
    float life_max; // offset 0xC, size 0x4
    ...
    float y_accel; // offset 0x20, size 0x4
    struct xColor_tag color; // offset 0x24, size 0x4
};
// total size: 0x148
struct splash_config {
    ...
    struct /* @class$2156zSplash_cpp */ {
        ...
        float y_accel; // offset 0x20, size 0x4
        struct xColor_tag color; // offset 0x24, size 0x4
    } streak; // offset 0x6C, size 0x28
    struct splash_emitter initial; // offset 0x94, size 0xB4
};
// total size: 0x7C
struct plume_config {
    // Members
    ...
    float size_max; // offset 0x24, size 0x4
    float size_scale; // offset 0x28, size 0x4
    float y_accel; // offset 0x2C, size 0x4
    struct xColor_tag color; // offset 0x30, size 0x4
    struct plume_emitter initial; // offset 0x34, size 0x48
};
// total size: 0x1C
struct bubble_config {
    ...
    struct bubble_emitter initial; // offset 0x8, size 0x14
};
// total size: 0x18C
struct splash_planner {
    // Members
    char name[64]; // offset 0x0, size 0x40
    enum type_enum type; // offset 0x40, size 0x4
    union { // inferred
        struct splash_config splash; // offset 0x44, size 0x148
        struct plume_config plume; // offset 0x44, size 0x7C
        struct bubble_config bubble; // offset 0x44, size 0x1C
        struct chain_config chain; // offset 0x44, size 0x84
    };
};
static struct splash_planner * planners; // size: 0x4, address: 0x80D6ACAC
// total size: 0x8
struct type_mapping {
    // Members
...
static struct type_mapping * type_mappings; // size: 0x4, address: 0x80D6ACB0
static int types_size; // size: 0x4, address: 0x80D6ACB4
static unsigned int texture_ids[8]; // size: 0x20, address: 0x80D13E40
static int cone_texture_repeats; // size: 0x4, address: 0x80D64028
// Range: 0x801DE0C0 -> 0x801DE164
static void compute_cubic_coeff(float & a /* r3 */, float & b /* r4 */, float & c /* r5 */, float S /* f1 */, float T /* f2 */) {
    // Local variables
    float S2; // f29
    float T2; // f31
    float idenom; // f30
...
// Range: 0x801DE164 -> 0x801DE4C0
static void refresh_splash(struct splash_config & cfg /* r31 */) {
    // Local variables
    struct splash_emitter & initial; // r30
    float ilife; // f31
    float Y0; // f29
    float Ym; // f30
    float Yd; // f26
    ...
    float iT1; // f28
    float temp; // f27
    float ring_age_rate_max; // f24
    float streak_age_rate_max; // f23
}

// Range: 0x801DE4C0 -> 0x801DE5B0
static void refresh_plume(struct plume_config & cfg /* r30 */) {
    // Local variables
    struct plume_emitter & initial; // r31
    float age_rate_max; // f31
}

// Range: 0x801DE5B0 -> 0x801DE5C4
static void refresh_bubble(struct bubble_config & cfg /* r3 */) {
    // Local variables
    struct bubble_emitter & initial; // r1+0x8
}

// Range: 0x801DE5C4 -> 0x801DE614
static void refresh_chain(struct chain_config & chain /* r31 */) {}
...
// Range: 0x801DE614 -> 0x801DEA5C
static void load_splash(struct splash_config & cfg /* r29 */, const struct xIniValue * values /* r30 */, int values_size /* r31 */) {}

// Range: 0x801DEA5C -> 0x801DEB24
...
// Range: 0x801DEB24 -> 0x801DEBA4
static struct xIniValue * get_value(const char * name /* r1+0x8 */, const struct xIniValue * values /* r29 */, int values_size /* r27 */) {
    // Local variables
    const struct xIniValue * val; // r31
}

// Range: 0x801DEBA4 -> 0x801DEC04
...
// Range: 0x801DEC04 -> 0x801DEC64
static void read_value(int & v /* r30 */, const char * name /* r1+0x8 */, const struct xIniValue * values /* r1+0xC */, int values_size /* r1+0x10 */) {
    // Local variables
    const struct xIniValue * iv; // r31
}

// Range: 0x801DEC64 -> 0x801DECC8
static void read_value(float & v /* r30 */, const char * name /* r1+0x8 */, const struct xIniValue * values /* r1+0xC */, int values_size /* r1+0x10 */) {
    // Local variables
    const struct xIniValue * iv; // r31
}

// Range: 0x801DECC8 -> 0x801DEE70
static void load_plume(struct plume_config & cfg /* r29 */, const struct xIniValue * values /* r30 */, int values_size /* r31 */) {}

// Range: 0x801DEE70 -> 0x801DEEE4
static void load_bubble(struct bubble_config & cfg /* r29 */, const struct xIniValue * values /* r30 */, int values_size /* r31 */) {}

// Range: 0x801DEEE4 -> 0x801DEFDC
static void load_chain(struct chain_config & chain /* r28 */, const struct xIniValue * values /* r1+0x8 */, int values_size /* r1+0xC */) {
    // Local variables
    struct chain_link * link; // r31
    struct chain_link * max_link; // r1+0x14
    const struct xIniValue * iv; // r29
    const struct xIniValue * end_iv; // r27
    char * nextoken; // r1+0x10
    char * s; // r30
}
...
// Range: 0x801DEFDC -> 0x801DF154
static void load_planner(struct splash_planner & plan /* r31 */, struct xIniSection & sec /* r27 */, struct xIniFile & ini /* r24 */) {
    // Local variables
    struct xIniValue * values; // r29
    int values_size; // r28
    const struct xIniValue * iv; // r30
    const struct xIniValue * end_iv; // r25
    const char * type; // r26
}

// Range: 0x801DF154 -> 0x801DF1FC
static void load_globals(struct xIniValue * values /* r29 */, int values_size /* r30 */) {
    // Local variables
    int i; // r31

    // References
    // -> static int cone_texture_repeats;
    // -> static char * texture_key_names[8];
    // -> static unsigned int texture_ids[8];
}
...
// Range: 0x801DF1FC -> 0x801DF484
static void load_ini_configs() {
    // Local variables
    void * mem; // r25
    struct xIniFile * ini; // r31
    struct xIniSection * sections; // r27
    unsigned int memsize; // r1+0x8
    struct xIniSection * isec; // r30
    struct xIniSection * end_isec; // r22
    struct xIniSection * osec; // r24
    struct splash_planner * plan; // r29
    struct splash_planner * end_plan; // r23
    struct xIniSection * sec; // r28
    struct type_mapping * m; // r26

    // References
    // -> void * RwEngineInstance;
    // -> static struct splash_planner * planners;
    // -> static int types_size;
    // -> static struct type_mapping * type_mappings;
    // -> unsigned int _rwMemoryLastAllocLine;
    // -> const char * _rwMemoryLastAllocFile;
    // -> static char ini_filename[11];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80522628
// Range: 0x801DF484 -> 0x801DF520
static struct splash_emitter * alloc_splash_emitter() {
    // References
    // -> static int splash_emitters_size;
    // -> static struct splash_emitter * splash_emitters;
    // -> static char __FUNCTION__[21];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6402C
// Range: 0x801DF520 -> 0x801DF5E8
static void free_splash_emitter(struct splash_emitter * emitter /* r31 */) {
    // References
    // -> static int splash_emitters_size;
    // -> static struct splash_emitter * splash_emitters;
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D64040
// Range: 0x801DF754 -> 0x801DF7EC
static struct plume_emitter * alloc_plume_emitter() {
    // References
    // -> static int plume_emitters_size;
    // -> static struct plume_emitter * plume_emitters;
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D64054
// Range: 0x801DF7EC -> 0x801DF8B4
static void free_plume_emitter(struct plume_emitter * emitter /* r31 */) {
    // References
    // -> static int plume_emitters_size;
    // -> static struct plume_emitter * plume_emitters;
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x8052263D
// Range: 0x801DF960 -> 0x801DF9FC
static struct bubble_emitter * alloc_bubble_emitter() {
    // References
    // -> static int bubble_emitters_size;
    // -> static struct bubble_emitter * bubble_emitters;
    // -> static char __FUNCTION__[21];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D64067
// Range: 0x801DF9FC -> 0x801DFAC4
static void free_bubble_emitter(struct bubble_emitter * emitter /* r31 */) {
    // References
    // -> static int bubble_emitters_size;
    // -> static struct bubble_emitter * bubble_emitters;
    // -> static char __FUNCTION__[20];
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D6407B
// Range: 0x801DFAF0 -> 0x801DFB88
static struct chain_emitter * alloc_chain_emitter() {
    // References
    // -> static int chain_emitters_size;
    // -> static struct chain_emitter * chain_emitters;
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80522652
// Range: 0x801DFBBC -> 0x801DFD74
static void emit_splash_internal(int type /* r25 */, const struct xVec3 & loc /* r28 */) {
    // Local variables
    const struct splash_planner & plan; // r31
    struct splash_emitter & splash; // r29
    struct plume_emitter & plume; // r27
    struct bubble_emitter & bubble; // r26
    struct chain_emitter & emitter; // r30
...
struct mist_particle {
    ...
    float y_vel; // offset 0x18, size 0x4
    float y_accel; // offset 0x1C, size 0x4
    float size_vel; // offset 0x20, size 0x4
    struct xColor_tag color; // offset 0x24, size 0x4
...
// Range: 0x801DFD74 -> 0x801DFF40
static int update_mist_particles(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r30
    struct mist_particle * p; // r31
    struct mist_particle * end; // r29
    float t; // f30
    float dv; // f29
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80522667
// total size: 0x30
struct ring_particle {
    ...
    float age; // offset 0x10, size 0x4
    float age_rate; // offset 0x14, size 0x4
    float rx; // offset 0x18, size 0x4
    float rz; // offset 0x1C, size 0x4
    float size_vel; // offset 0x20, size 0x4
    struct xColor_tag color; // offset 0x24, size 0x4
    float alpha; // offset 0x28, size 0x4
    unsigned char fade_in; // offset 0x2C, size 0x1
    unsigned char pad[3]; // offset 0x2D, size 0x3
};
// Range: 0x801DFF40 -> 0x801E01E4
static int update_ring_particles(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f27 */) {
    // Local variables
    struct ptank_pool__color_mat & pool; // r30
    struct ring_particle * p; // r31
    struct ring_particle * end; // r29
    float t; // f31
    struct RwSphere worldsph; // r1+0x10
    float alpha; // f28
    float rx; // f30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6408F
// total size: 0x1C
...
struct streak_particle {
    ...
    struct xVec3 vel; // offset 0x14, size 0xC
    float age; // offset 0x20, size 0x4
    float age_rate; // offset 0x24, size 0x4
    float length_vel; // offset 0x28, size 0x4
    float length_max; // offset 0x2C, size 0x4
    float y_accel; // offset 0x30, size 0x4
    struct xColor_tag color; // offset 0x34, size 0x4
    float alpha; // offset 0x38, size 0x4
    float pad1; // offset 0x3C, size 0x4
};
// Range: 0x801E01E4 -> 0x801E052C
static int update_streak_particles(unsigned char * mem /* r27 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__color_mat & pool; // r30
    ...
    float ay; // f28
    float az; // f27
    struct streak_particle * p; // r31
    struct streak_particle * end; // r28
    float t; // f26
    struct RwSphere worldsph; // r1+0x10
    float mag; // f31
...
// Range: 0x801E052C -> 0x801E0700
static void update_splash_emitters(float dt /* f31 */) {
    // Local variables
    struct splash_emitter * e; // r31
    struct splash_emitter * ende; // r30
    float old_age; // r1+0x8
    float r0; // f30
    float y0; // f29
    float dyv; // f28
...
// Range: 0x801E0700 -> 0x801E0940
static void emit_splash_streak(struct splash_emitter & splash /* r31 */, float dt /* r1+0x8 */) {
    // Local variables
    int emit; // r29
    float cx; // f27
    float cy; // f26
    ...
    int have; // r28
    struct streak_particle * p; // r30
    struct streak_particle * endp; // r27
    float ang; // f30
    float ca; // f29
    float sa; // f28
    float vel; // f31
    ...
    // References
    // -> static int streak_system_id;
}

// Range: 0x801E0940 -> 0x801E0C58
static void emit_splash_ring(struct splash_emitter & splash /* r30 */, float r0 /* f20 */, float y0 /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    int emit; // r29
    float r1; // f28
    float y1; // f27
    ...
    float cy; // f24
    float cz; // f23
    unsigned char * mem; // r1+0x10
    int have; // r28
    struct ring_particle * p; // r31
    struct ring_particle * endp; // r27
    float ang; // f31
    float ca; // f22
    float sa; // f21
    float r; // f30
    ...
    // -> static int ring_system_id;
}

// Range: 0x801E0C58 -> 0x801E0FF8
static void emit_splash_mist(struct splash_emitter & splash /* r31 */, float r0 /* r1+0x8 */, float y0 /* r1+0xC */, float dt /* r1+0x10 */) {
    // Local variables
    int emit; // r29
    float r1; // f22
    float y1; // f21
    ...
    float cy; // f27
    float cz; // r1+0x30
    float size_start; // r1+0x2C
    float size_delta; // r1+0x28
    float A; // f30
    float iA; // r1+0x24
    float V0; // f31
    unsigned char * mem; // r1+0x20
    int have; // r28
    struct mist_particle * p; // r30
    struct mist_particle * endp; // r27
    float ang; // f26
    float ca; // r1+0x1C
    float sa; // r1+0x18
    float t; // f25
...
struct plume_particle {
    ...
    float age_rate; // offset 0x14, size 0x4
    float y_accel; // offset 0x18, size 0x4
    float size_vel; // offset 0x1C, size 0x4
    struct xVec3 vel; // offset 0x20, size 0xC
    struct xColor_tag color; // offset 0x2C, size 0x4
};
// Range: 0x801E0FF8 -> 0x801E1268
static int update_plume_particles(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r30
    float a1; // f27
    float a2; // f26
    float a3; // f25
    struct plume_particle * p; // r31
    struct plume_particle * end; // r29
    float t1; // f31
    struct RwSphere worldsph; // r1+0x10
    float t2; // f29
    float t3; // f24
...
// Range: 0x801E12E4 -> 0x801E1640
static void update_plume_emitters(float dt /* r1+0x8 */) {
    // Local variables
    struct plume_emitter * e; // r31
    struct plume_emitter * ende; // r28
    int emit; // r29
    float cx; // f25
    float cy; // f24
    float cz; // f23
    unsigned char * mem; // r1+0x10
    int have; // r27
    struct plume_particle * p; // r30
    struct plume_particle * endp; // r26
    float ang; // f30
    float ca; // f22
    float sa; // f21
    float rr; // f29
    ...
    float svr; // f19
    float cvr; // f18
    float end_size; // r1+0xC

    // References
    // -> static int plume_system_id;
    // -> static int plume_emitters_size;
    // -> static struct plume_emitter * plume_emitters;
}

// Range: 0x801E1640 -> 0x801E16D0
static void update_bubble_emitters(float dt /* r1+0x8 */) {
    // Local variables
    struct bubble_emitter * e; // r31
    struct bubble_emitter * ende; // r30
    float old_age; // r1+0xC
...
// Range: 0x801E16D0 -> 0x801E17C4
static void update_chain_emitters(float dt /* r1+0x8 */) {
    // Local variables
    struct chain_emitter * e; // r31
    const struct chain_link * const links; // r29
    int links_size; // r28
    const struct chain_link * link; // r30
    const struct chain_link * end_link; // r27
...
// Range: 0x801E17C4 -> 0x801E1894
static void refresh_system(int & system_id /* r31 */, enum ptank_group_type pool_type /* r1+0x8 */, unsigned int texture_id /* r29 */, int stride /* r1+0xC */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r1+0x10 */) {
    // Local variables
    struct xParticleBatchSystem system; // r1+0x14
}

// Range: 0x801E1894 -> 0x801E19C4
static void refresh_textures() {
    // References
    // -> static unsigned int texture_ids[8];
    // -> static int drips_system_id;
    // -> static int trail_system_id;
    // -> static int plume_system_id;
    // -> static int streak_system_id;
    // -> static int ring_system_id;
    // -> static int mist_system_id;
    // -> static struct RwTexture * cone_texture;
}

// Range: 0x801E19C4 -> 0x801E1A30
static void begin_render_cones() {
    // Local variables
...
// Range: 0x801E1A30 -> 0x801E1A50
static void end_render_cones() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D640A0
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
// Range: 0x801E1A50 -> 0x801E1E68
static void render_cones() {
    // Local variables
    int verts_size; // r26
    struct xIMLockContext lock; // r1+0x18
    struct xVec3 * pos; // r30
    struct xVec2 * uv; // r28
    unsigned int * color; // r29
    float du; // r1+0x14
    const struct splash_emitter * splash; // r31
    const struct splash_emitter * end_splash; // r25
    float cx; // f21
    float cy; // f20
    float cz; // f19
    float radius; // f25
    ...
    float By; // f23
    float Bz; // f22
    struct xVec3 * const end_pos; // r24
    float tempc; // r1+0x8
...
// total size: 0x8
struct /* @class$3049zSplash_cpp */ {
    // Members
    float splashes_emitted; // offset 0x0, size 0x4
    const char * * type_labels; // offset 0x4, size 0x4
};
...
struct /* @class$3049zSplash_cpp */ {
    ...
    float splashes_emitted; // offset 0x0, size 0x4
    const char * * type_labels; // offset 0x4, size 0x4
} debug; // size: 0x8, address: 0x80D6ACBC
// Range: 0x801E1EA0 -> 0x801E1F64
...
// Range: 0x801E1F64 -> 0x801E1F84
static void debug_emit() {}

// Range: 0x801E1F84 -> 0x801E2078
static void update_test(float dt /* r1+0x8 */) {
    // Local variables
    int emit; // r31
    int max_emit; // r29
    int i; // r30
...
// Range: 0x801E2078 -> 0x801E20A8
static void on_change_splash_config(const struct tweak_info & info /* r31 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x80522680
// Range: 0x801E20A8 -> 0x801E288C
static void add_splash_tweaks(struct splash_planner & plan /* r30 */) {
    // Local variables
    char prefix[128]; // r1+0x10
    struct splash_config & cfg; // r31

    // References
    // -> static struct tweak_callback cb_cfg;
}

// Range: 0x801E288C -> 0x801E28BC
static void on_change_plume_config(const struct tweak_info & info /* r31 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x805226A8
// Range: 0x801E28BC -> 0x801E2BE4
static void add_plume_tweaks(struct splash_planner & plan /* r30 */) {
    // Local variables
    char prefix[128]; // r1+0x10
    struct plume_config & cfg; // r31

    // References
    // -> static struct tweak_callback cb_cfg;
}

// Range: 0x801E2BE4 -> 0x801E2C14
static void on_change_bubble_config(const struct tweak_info & info /* r31 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x805226D0
// Range: 0x801E2C14 -> 0x801E2CFC
static void add_bubble_tweaks(struct splash_planner & plan /* r30 */) {
    // Local variables
    char prefix[128]; // r1+0x8
    struct bubble_config & cfg; // r31

    // References
    // -> static struct tweak_callback cb_cfg;
}

// Range: 0x801E2CFC -> 0x801E2D1C
static void on_change_texture() {}

static struct tweak_callback cb_texture; // size: 0x28, address: 0x804B69B0
...
static void add_global_tweaks() {
    ...
    // References
    // -> static int cone_texture_repeats;
    // -> static struct tweak_callback cb_texture;
...
// Range: 0x801E2DF8 -> 0x801E2E34
static void on_change_link(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct splash_planner & plan; // r31
}

static struct tweak_callback cb_link; // size: 0x28, address: 0x804B69D8
// Range: 0x801E2E34 -> 0x801E2EE8
static void add_link_tweaks(const char * prefix /* r29 */, struct splash_planner & plan /* r30 */, struct chain_link & link /* r31 */) {
    // References
    // -> static struct tweak_callback cb_link;
    // -> static int types_size;
    // -> static // total size: 0x8
struct /* @class$3049zSplash_cpp */ {
    // Members
...
// Range: 0x801E2EE8 -> 0x801E3000
static void on_change_links_size(const struct tweak_info & info /* r24 */) {
    // Local variables
    struct splash_planner & plan; // r29
    struct chain_config & chain; // r30
    char prefix[128]; // r1+0x8
    char * end; // r28
    const struct tweak_info * parent; // r27
    int tweaks; // r25
    int old_links_size; // r26
    int i; // r31
}
...
static struct tweak_callback cb_links_size; // size: 0x28, address: 0x804B6A00
// Range: 0x801E3000 -> 0x801E3118
static void add_chain_tweaks(struct splash_planner & plan /* r31 */) {
    // Local variables
    char prefix[128]; // r1+0x10
    char * end; // r29
    int i; // r30
    ...
    // References
    // -> static struct tweak_callback cb_links_size;
}

// Range: 0x801E3118 -> 0x801E3298
static void debug_init() {
    // Local variables
    int labels_size; // r29
    int i; // r30
    struct splash_planner * plan; // r31
    struct splash_planner * end_plan; // r28
    const char * prefix; // r27
...
// Range: 0x801E3298 -> 0x801E3300
static void debug_update(float dt /* r1+0x8 */) {
    // Local variables
    const struct xVec3 & player_loc; // r31
...
struct SwimEmitter {
    ...
    struct xColor_tag color; // offset 0x38, size 0x4
    float age_rate; // offset 0x3C, size 0x4
};
// Range: 0x801E3300 -> 0x801E3324
void zSplashStartup() {}

// Range: 0x801E3324 -> 0x801E348C
void zSplashSceneEnter() {
    // Local variables
    struct splash_planner * plan; // r31
    struct splash_planner * end_plan; // r30
...
// Range: 0x801E348C -> 0x801E3490
void zSplashSceneExit() {}

// Range: 0x801E3490 -> 0x801E34EC
void zSplashUpdate(float dt /* f31 */) {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x801E34EC -> 0x801E3518
void zSplashRender() {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D640AD
// Range: 0x801E3518 -> 0x801E3604
int zSplashFindType(const char * name /* r1+0x8 */) {
    // Local variables
    struct type_mapping * end; // r30
    const struct type_mapping * found; // r31
...
// Range: 0x801E3604 -> 0x801E3694
void zSplashEmit(int type /* r30 */, const struct xVec3 & loc /* r31 */) {
    // Local variables
    struct xVec3 bias_loc; // r1+0x8
...
// total size: 0x1
struct compare_ini_values {};
// Range: 0x801E3694 -> 0x801E36CC
static int compare_ini_values::operator()(const char * v1 /* r1+0x8 */, const struct xIniValue & v2 /* r31 */) {}

// total size: 0x1
struct compare_type_mapping {};
// Range: 0x801E36CC -> 0x801E3704
static int compare_type_mapping::operator()(const char * name /* r1+0x8 */, const struct type_mapping & m /* r31 */) {}
