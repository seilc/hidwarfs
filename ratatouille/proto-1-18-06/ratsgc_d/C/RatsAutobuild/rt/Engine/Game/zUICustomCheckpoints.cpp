/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomCheckpoints.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80291D54 -> 0x8029217C
*/
static unsigned int sceneCheckPointTotal; // size: 0x4, address: 0x80D6B3D0
static unsigned int sceneCheckPointHit; // size: 0x4, address: 0x80D6B3D4
// Range: 0x80291D54 -> 0x80291D5C
void zUIIncrediblesSetSceneCheckPointHit(unsigned int value /* r3 */) {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80291D5C -> 0x80291D64
unsigned int zUIIncrediblesGetSceneCheckPointHit() {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80291D64 -> 0x80291D6C
...
// total size: 0x54
struct {} zUICustomCheckpoints::__vtable; // size: 0x54, address: 0x805254C0
// total size: 0x34
struct RwRaster {
    // Members
...
// Range: 0x80291D6C -> 0x80291DB0
// this: r31
zUICustomCheckpoints::zUICustomCheckpoints(class zUI * ui /* r1+0x8 */) {
    // References
...
// Range: 0x80291DF0 -> 0x802920DC
// this: r31
unsigned char zUICustomCheckpoints::PreRender() {
    // Local variables
    struct RwRaster * raster; // r28
    unsigned int effectiveCheckpoints; // r27
    float widthPerItem; // f31
