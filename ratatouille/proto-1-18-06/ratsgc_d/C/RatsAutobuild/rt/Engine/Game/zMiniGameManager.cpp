/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80303C70 -> 0x803040D8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static const char * TWEAK_PREFIX; // size: 0x4, address: 0x80D672E0
static unsigned char parallel; // size: 0x1, address: 0x80D6B820
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct PlayerCreationData {
    // Members
    unsigned int gameType; // offset 0x0, size 0x4
    void (* create)(struct xDynAsset *); // offset 0x4, size 0x4
};
static struct PlayerCreationData playerCreationTable[3]; // size: 0x18, address: 0x8052A670
static signed char init; // size: 0x1, address: 0x80D6B821
// total size: 0xC
...
static class zMiniGameManager mgr; // size: 0xC, address: 0x80D6B824
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1152zMiniGameManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1328zMiniGameManager_cpp */ {
    // Members
...
union /* @class$1289zMiniGameManager_cpp */ {
...
// total size: 0x10
struct /* @class$1629zMiniGameManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1872zMiniGameManager_cpp */ {
    // Static members
...
// Range: 0x80303C70 -> 0x80303CCC
void zMiniGameManager::Startup() {
    // References
    // -> static class zMiniGameManager mgr;
    // -> struct zGlobals globals;
    // -> static signed char init;
}

// Range: 0x80303CCC -> 0x80303DA0
void zMiniGameManager::SceneInit() {
    // Local variables
    class zMiniGameManager * mgr; // r28
    int dynSize; // r27
    int i; // r30
    int cnt; // r1+0xC
    ...
    // References
    // -> static struct PlayerCreationData playerCreationTable[3];
    // -> struct zGlobals globals;
}

struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// total size: 0xC
struct /* @class$1093zMiniGameManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1094zMiniGameManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1095zMiniGameManager_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1096zMiniGameManager_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1097zMiniGameManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1098zMiniGameManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1099zMiniGameManager_cpp */ {
    // Members
...
// Range: 0x80303DA0 -> 0x80303E00
static void SetCameraProj(const struct tweak_info & info /* r31 */) {
    // References
    // -> static unsigned char parallel;
...
static struct tweak_callback SetCamProjCB; // size: 0x28, address: 0x804D9DD8
// Range: 0x80303E00 -> 0x80303ED4
// this: r31
void zMiniGameManager::SceneSetup() {
    // Local variables
    const char * prefix; // r30

    // References
    // -> static struct tweak_callback SetCamProjCB;
    // -> static const char * TWEAK_PREFIX;
}
...
// Range: 0x80303ED4 -> 0x80303EDC
unsigned char zMiniGameManager::IsParallelCam() {
    // References
    // -> static unsigned char parallel;
}

// Range: 0x80303EDC -> 0x80303F24
// this: r31
void zMiniGameManager::Reset() {}

// Range: 0x80303F24 -> 0x80303F74
// this: r31
void zMiniGameManager::Update(float dt /* r1+0x8 */) {}

// Range: 0x80303F74 -> 0x80303FBC
// this: r31
void zMiniGameManager::Render() {}

// Range: 0x80303FBC -> 0x80303FC0
void zMiniGameManager::PostRender2d() {}

// Range: 0x80303FC0 -> 0x80303FC4
void zMiniGameManager::PostRender3d() {}

// Range: 0x80303FC4 -> 0x80304008
void zMiniGameManager::Exit() {
    // Local variables
    class zMiniGameManager * mgr; // r31
...
static unsigned int sMiniGameSceneMap[8][4]; // size: 0x80, address: 0x8052A688
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8052A708
// total size: 0xC
...
// Range: 0x80304008 -> 0x803040D8
unsigned int zMiniGameManagerGetSceneID(struct _xCounter * counter /* r31 */) {
    // References
    // -> struct zGlobals globals;
    // -> static unsigned int sMiniGameSceneMap[8][4];
    // -> static char __FUNCTION__[27];
}

// total size: 0x24
struct {} zMiniGameManager::__vtable; // size: 0x24, address: 0x8052A724
// total size: 0x4
