/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGamePickups.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032C358 -> 0x8032CA88
*/
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D67980
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$924zMiniGamePickups_cpp */ {
    // Members
...
class zMiniGamePickupController {
    // Functions
    void Setup(struct xGroup * inGroup, float spawnTime, float showTime, unsigned char resetTypes);

    void SetAvailablePickup(int idx);

    void Update(float dt);

    void AddType(int id, float likelyhood, float activeTime, unsigned int modelID, unsigned int soundID);
    ...
    unsigned char Test(struct xVec3 * pos, float radius, int * availableIdx);
...
// Range: 0x8032C358 -> 0x8032C428
// this: r31
void zMiniGamePickupController::Setup(struct xGroup * inGroup /* r30 */, float spawnTime /* r1+0x8 */, float showTime /* r1+0xC */, unsigned char resetTypes /* r1+0x10 */) {
    // References
    // -> static char __FUNCTION__[6];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D67986
// total size: 0x10
...
// Range: 0x8032C428 -> 0x8032C5D0
// this: r31
void zMiniGamePickupController::SetAvailablePickup(int idx /* r27 */) {
    // Local variables
...
// Range: 0x8032C5D0 -> 0x8032C6B8
// this: r31
void zMiniGamePickupController::Update(float dt /* f31 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67999
// Range: 0x8032C6B8 -> 0x8032C7C4
// this: r31
void zMiniGamePickupController::AddType(int id /* r1+0x8 */, float likelyhood /* r1+0xC */, float activeTime /* r1+0x10 */, unsigned int modelID /* r1+0x14 */, unsigned int soundID /* r1+0x18 */) {
    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x8032C7C4 -> 0x8032C7D8
// this: r3
void zMiniGamePickupController::Reset() {}

// Range: 0x8032C7D8 -> 0x8032C834
// this: r31
void zMiniGamePickupController::Render() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D679A1
// Range: 0x8032C834 -> 0x8032C94C
// this: r29
int zMiniGamePickupController::GetRandomType() {
    // Local variables
    int typeRangeIndices[16]; // r1+0x8
    int inRangeCount; // r31
    float randomValue; // f31
    int i; // r30
    int pickedIdx; // r28
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D679AF
enum iSndGroupHandle {
};
// Range: 0x8032C94C -> 0x8032CA88
// this: r31
unsigned char zMiniGamePickupController::Test(struct xVec3 * pos /* r27 */, float radius /* r1+0x8 */, int * availableIdx /* r28 */) {
    // Local variables
    float dist; // f31
    struct zMiniGamePickupType * testType; // r30
...
// total size: 0x2C
struct {} zMiniGamePickupController::__vtable; // size: 0x2C, address: 0x8052E280
