/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGrapple.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80173A8C -> 0x80174138
*/
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D62DD0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80173A8C -> 0x80173C38
void zGrapple_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// total size: 0x24
struct zGrappleAsset : public xDynAsset {
    // Members
...
// total size: 0x18
struct zGrapple : public xBase {
    // Members
    struct zGrappleAsset * grappleAsset; // offset 0x10, size 0x4
    unsigned int flags; // offset 0x14, size 0x4
};
// Range: 0x80173C38 -> 0x80173CA0
void zGrapple_Init(struct zGrapple * grapple /* r31 */, struct zGrappleAsset * asset /* r30 */) {}
...
struct zGrapplePoint {
    // Members
    struct zGrapple * grap; // offset 0x0, size 0x4
    struct xVec3 * pos; // offset 0x4, size 0x4
    struct xMat3x3 * local; // offset 0x8, size 0x4
    struct xVec3 * offset; // offset 0xC, size 0x4
    void * optr; // offset 0x10, size 0x4
};
static struct zGrapplePoint * sGrapplePoints; // size: 0x4, address: 0x80D6A500
static int sNumGrapplePoints; // size: 0x4, address: 0x80D6A504
// total size: 0xC
...
// Range: 0x80173CA0 -> 0x80173E3C
int zGrapple_Recurse(unsigned int id /* r22 */, struct zGrapplePoint * gpList /* r31 */, struct zGrapple * grapple /* r27 */) {
    // Local variables
    unsigned int i; // r28
    int result; // r30
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D62DDE
...
// Range: 0x80173E3C -> 0x80173FBC
void zGrapple_SceneInit(struct zScene * zsc /* r28 */) {
    // Local variables
    int i; // r31
    int count; // r27
    int numGrapples; // r29
    struct zGrapple * grapple; // r30
    struct zGrappleAsset * asset; // r26

    // References
    // -> static int sNumGrapplePoints;
    // -> static struct zGrapplePoint * sGrapplePoints;
    // -> static char __FUNCTION__[19];
    // -> unsigned int gActiveHeap;
}

// Range: 0x80173FBC -> 0x80174010
void zGrapple_Reset() {
    // Local variables
    int i; // r31
    struct zGrapple * grapple; // r30
    struct zGrappleAsset * asset; // r29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D62DF1
// Range: 0x80174010 -> 0x80174138
void zGrapple_EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    struct zGrapple * grap; // r31
