/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomOptionsManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E5DDC -> 0x802E6F20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char inOverlayScreen; // size: 0x1, address: 0x80D6B738
float inOverlayScreenExitTimer; // size: 0x4, address: 0x80D6B73C
static int sysMsgType; // size: 0x4, address: 0x80D6B740
static unsigned char screenAdjusted; // size: 0x1, address: 0x80D6B744
static unsigned char screenIsInSystemMessage; // size: 0x1, address: 0x80D6B745
// Range: 0x802E5DDC -> 0x802E5DE4
unsigned char zUICustomOptionsScreenIsInSystemMessage() {
    // References
    // -> static unsigned char screenIsInSystemMessage;
}

// Range: 0x802E5DE4 -> 0x802E5DEC
void zUICustomOptionsScreenAdjust(unsigned char value /* r3 */) {
    // References
    // -> static unsigned char screenAdjusted;
}

// total size: 0x54
struct {} zUICustomOptionsManager::__vtable; // size: 0x54, address: 0x805295F0
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x28
class zUICustomOptionsManager : public zUICustom {
    // Functions
    zUICustomOptionsManager(class zUI * ui);
    ...
    void AdjustScreenOnOff();

    // Members
public:
    float musicVolume; // offset 0x8, size 0x4
    float sfxVolume; // offset 0xC, size 0x4
    int soundMode; // offset 0x10, size 0x4
    unsigned char vibrationOnP1; // offset 0x14, size 0x1
    unsigned char vibrationOnP2; // offset 0x15, size 0x1
protected:
    unsigned char doupdate; // offset 0x16, size 0x1
    class zUIText * optionVibP1Text; // offset 0x18, size 0x4
    class zUIText * optionVibP2Text; // offset 0x1C, size 0x4
    class zUIBox * optionVibP1Box; // offset 0x20, size 0x4
    class zUIBox * optionVibP2Box; // offset 0x24, size 0x4
};
// Range: 0x802E5DEC -> 0x802E5E88
// this: r31
zUICustomOptionsManager::zUICustomOptionsManager(class zUI * ui /* r1+0x8 */) {
    // References
    // -> static unsigned char screenAdjusted;
    // -> struct [anonymous] zUICustomOptionsManager::__vtable;
}
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66D50
// Range: 0x802E5E88 -> 0x802E606C
// this: r31
void zUICustomOptionsManager::Init() {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D66D55
...
// total size: 0x14
class zUICustomVolume : public zUICustom {
    // Members
    enum xSndMixerFaderName sndMixerFader; // offset 0x8, size 0x4
    int numItems; // offset 0xC, size 0x4
    class zUIImage * * bars; // offset 0x10, size 0x4
};
class zUICustomVolume * pUICustomMusicVolumeManager; // size: 0x4, address: 0x80D6B368
class zUICustomVolume * pUICustomSFXVolumeManager; // size: 0x4, address: 0x80D6B36C
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1006zUICustomOptionsManager_cpp */ {
    // Members
...
union /* @class$961zUICustomOptionsManager_cpp */ {
...
// total size: 0xC
struct /* @class$1162zUICustomOptionsManager_cpp */ {
    // Members
...
// Range: 0x802E606C -> 0x802E6D60
// this: r31
unsigned char zUICustomOptionsManager::HandleEvent(struct xBase * from /* r26 */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {
    // Local variables
    unsigned char isBreak; // r25
    float curMusicVolume; // f31
    float curSfxVolume; // f30
    int curSoundMode; // r1+0x28
    unsigned char isBreak; // r24
    struct xBase * d; // r30
    struct xBase * d; // r29
    class zUIText * adjustText; // r28
    class zUIText * controlsText; // r27
    float curMusicVolume; // f29
    float curSfxVolume; // f28
    int curSoundMode; // r1+0x24

    // References
    // -> float inOverlayScreenExitTimer;
    // -> class zUICustom * pSysMessageManager_Custom;
    // -> class zUI * pSysMessageManager;
    // -> static unsigned char screenIsInSystemMessage;
    // -> static unsigned char screenAdjusted;
    // -> struct zGlobals globals;
    // -> class zUICustomVolume * pUICustomSFXVolumeManager;
    // -> class zUICustomVolume * pUICustomMusicVolumeManager;
    // -> static int sysMsgType;
    // -> static char __FUNCTION__[12];
    // -> unsigned char inOverlayScreen;
}
...
// total size: 0xC
struct /* @class$734zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$735zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$736zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$737zUICustomOptionsManager_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$738zUICustomOptionsManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$739zUICustomOptionsManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$740zUICustomOptionsManager_cpp */ {
    // Members
...
// Range: 0x802E6D60 -> 0x802E6E88
// this: r31
void zUICustomOptionsManager::PreUpdate(float dt /* r1+0x8 */) {
    // References
    // -> float inOverlayScreenExitTimer;
}
...
// total size: 0x2
struct /* @class$1681zUICustomOptionsManager_cpp */ {
    // Members
...
// Range: 0x802E6E88 -> 0x802E6F20
// this: r31
void zUICustomOptionsManager::AdjustScreenOnOff() {
    // Local variables
    class zUIText * textField; // r30
}
