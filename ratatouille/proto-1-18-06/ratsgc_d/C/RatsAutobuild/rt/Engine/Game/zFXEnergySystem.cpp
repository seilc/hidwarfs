/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXEnergySystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80248200 -> 0x80249CF4
*/
int streak_system_id; // size: 0x4, address: 0x80D651C8
int point_system_id; // size: 0x4, address: 0x80D651CC
unsigned char need_setup; // size: 0x1, address: 0x80D6B150
// total size: 0x3C
class energy_system {
    // Functions
    void setup(struct config * new_config, unsigned char additive);

    void emit(const struct xVec3 & pos, const struct xMat3x3 & mat, float dt, struct xVec3 * new_target);

    void emit_points(const struct xMat3x3 & mat, float dt);

    void emit_streaks(const struct xMat3x3 & mat, float dt);
...
// Range: 0x80248200 -> 0x8024820C
void energy_system::scene_setup() {
    // References
    // -> unsigned char need_setup;
}

// total size: 0x2C
struct /* @class$1548zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$1549zFXEnergySystem_cpp */ {
    // Members
...
static struct config default_config; // size: 0x74, address: 0x80D23BA8
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D651D0
// total size: 0x28
...
// Range: 0x8024820C -> 0x80248634
// this: r31
void energy_system::setup(struct config * new_config /* r29 */, unsigned char additive /* r1+0x8 */) {
    // Local variables
    struct RwTexture * texture; // r30
    struct xParticleBatchSystem batch_system; // r1+0xC

    // References
    // -> int streak_system_id;
    // -> int point_system_id;
...
// Range: 0x80248634 -> 0x80248CE0
void energy_system::add_tweaks(const char * prefix /* r30 */, struct config * energy /* r31 */) {}
...
// total size: 0xC
struct /* @class$795zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$796zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$797zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$798zFXEnergySystem_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$799zFXEnergySystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$800zFXEnergySystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$801zFXEnergySystem_cpp */ {
    // Members
...
// Range: 0x80248CE0 -> 0x80248DA0
// this: r31
void energy_system::emit(const struct xVec3 & pos /* r28 */, const struct xMat3x3 & mat /* r30 */, float dt /* f31 */, struct xVec3 * new_target /* r29 */) {}
...
struct particle {
    ...
    union { // inferred
        float rot_multiplier; // offset 0x14, size 0x4
        float master_lifetime; // offset 0x14, size 0x4
    };
    float a; // offset 0x18, size 0x4
    class energy_system * system; // offset 0x1C, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80248DA0 -> 0x802490E0
// this: r31
void energy_system::emit_points(const struct xMat3x3 & mat /* r27 */, float dt /* r1+0x8 */) {
    // Local variables
    ...
    float start_distance; // f28

    // References
    // -> int point_system_id;
}

// Range: 0x802490E0 -> 0x80249340
// this: r31
void energy_system::emit_streaks(const struct xMat3x3 & mat /* r27 */, float dt /* r1+0x8 */) {
    // Local variables
    float time_passed; // f31
    int emit; // r30
    struct particle * p; // r1+0xC
...
// total size: 0x4
struct /* @class$1177zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1315zFXEnergySystem_cpp */ {
    // Members
...
union /* @class$846zFXEnergySystem_cpp */ {
...
// total size: 0x10
struct /* @class$859zFXEnergySystem_cpp */ {
    // Members
...
// Range: 0x80249340 -> 0x802498EC
int energy_system::point_update(unsigned char * mem /* r25 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r28
    struct particle * p; // r31
    struct particle * end; // r27
    class energy_system * system; // r29
    struct xVec3 & system_position; // r1+0x10
    struct xVec3 & system_target; // r26
    struct config * use_config; // r30
    struct xVec3 particle_to_position; // r1+0x3C
    float length; // f29
    float distance_along_normal; // f22
    struct xVec3 rotationAxis; // r1+0x30
    struct xVec3 rotation; // r1+0x24
    float multiplier; // f28
...
// Range: 0x802498EC -> 0x8024997C
static void world_to_screen(struct xVec3 & screen_loc /* r1+0x10 */, const struct xVec3 & loc /* r1+0x14 */) {
    // Local variables
    struct xMat4x3 view_mat; // r1+0x30
    struct xVec3 view_loc; // r1+0x18
    float iz; // f31
...
// Range: 0x8024997C -> 0x80249BF4
int energy_system::streak_update(unsigned char * mem /* r25 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f28 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r29
    struct particle * p; // r31
    struct particle * end; // r28
    class energy_system * system; // r27
    struct xVec3 & system_position; // r26
    struct config * use_config; // r30
    struct xVec3 & normal; // r1+0x10
    struct xVec3 particle_to_position; // r1+0x48
    float length; // f31
    struct xVec3 screen_space_position; // r1+0x3C
    struct xVec3 screen_space_system_position; // r1+0x30
    struct xVec3 screen_space_direction; // r1+0x24
    float rot; // f30
    float multiplier; // f27
    struct RwSphere worldsph; // r1+0x14
...
// Range: 0x80249CB4 -> 0x80249CC0
// this: r3
void energy_system::end() {}

// Range: 0x80249CC0 -> 0x80249CF4
// this: r31
