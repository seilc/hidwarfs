/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCameraFly.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A8C5C -> 0x802A9D38
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66238
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x802A8C5C -> 0x802A8E08
void zCameraFly_Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D66248
// total size: 0x14
struct CameraFly_asset : public xDynAsset {
    // Members
    unsigned int flyID; // offset 0x10, size 0x4
};
// total size: 0x14
struct zCameraFly : public xBase {
    // Members
    struct CameraFly_asset * casset; // offset 0x10, size 0x4
};
// Range: 0x802A8E08 -> 0x802A8F94
void zCameraFly_Init(struct zCameraFly * fly /* r31 */, struct CameraFly_asset * asset /* r29 */) {
    // Local variables
    struct CameraFly_asset * casset; // r30

    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x802A8F94 -> 0x802A8FA4
void zCameraFly_Setup(struct zCameraFly * fly /* r3 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66258
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$901zCameraFly_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zCameraFly_cpp */ {
    // Members
...
union /* @class$1040zCameraFly_cpp */ {
...
// Range: 0x802A8FA4 -> 0x802A9088
void zCameraFly_Update(struct xBase * to /* r1+0x8 */, struct xScene * sc /* r1+0xC */) {
    // References
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6626A
// total size: 0x0
struct xSerial {};
// Range: 0x802A9088 -> 0x802A917C
void zCameraFly_Save(struct zCameraFly * fly /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6627A
// Range: 0x802A917C -> 0x802A9270
void zCameraFly_Load(struct zCameraFly * fly /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}
...
// total size: 0x160
class zCamFlyThrough : public xCam {
    // Functions
    ...
    void SetFlyData(void * data, unsigned int size, struct zCameraFly * fly, struct xCam * previous);

    // Static members
    static float skipTimeFlythrough; // size: 0x4
    static float FLY_FRAMERATE; // size: 0x4

    // Members
    struct xCam * mPreviousCam; // offset 0x140, size 0x4
    struct zFlyKey * mKeyFrames; // offset 0x144, size 0x4
    int mNumKeys; // offset 0x148, size 0x4
    float mFlyTime; // offset 0x14C, size 0x4
    float mFlyRate; // offset 0x150, size 0x4
    unsigned char mStopFly; // offset 0x154, size 0x1
    struct zCameraFly * mCamFly; // offset 0x158, size 0x4
};
class zCamFlyThrough sFlyCam; // size: 0x160, address: 0x80D2CBF0
float skipTimeFlythrough; // size: 0x4, address: 0x80D6628C
// Range: 0x802A9270 -> 0x802A9394
float zCamFlyThrough::MatrixSpeed(struct zFlyKey * keys /* r31 */) {
    // Local variables
    float dot; // f31
}
...
// Range: 0x802A9394 -> 0x802A97BC
// this: r31
void zCamFlyThrough::update(float dt /* r1+0x10 */) {
    // Local variables
    int i; // r29
    int flyIdx; // r28
    float flyLerp; // f31
    float flyFrame; // f30
    struct zFlyKey keys[4]; // r1+0x80
    unsigned char * data; // r30
    unsigned char tmpA; // r25
    unsigned char tmpB; // r24
    float trandiff1; // f27
    float trandiff2; // f29
    float trandiff3; // f26
    float matdiff1; // f25
    float matdiff2; // f28
    float matdiff3; // f24
    struct xMat3x3 tmpMat; // r1+0x50
    struct xQuat quats[2]; // r1+0x24
    struct xQuat qresult; // r1+0x14

    // References
    // -> float skipTimeFlythrough;
    // -> struct xGlobals * xglobals;
}

// Range: 0x802A97BC -> 0x802A97F8
float zCamFlyThrough::TranSpeed(struct zFlyKey * keys /* r31 */) {}
...
// total size: 0x890
struct /* @class$1785zCameraFly_cpp */ {
    // Static members
...
// Range: 0x802A987C -> 0x802A98C4
// this: r31
void zCamFlyThrough::create() {}

// Range: 0x802A98C4 -> 0x802A9950
// this: r31
void zCamFlyThrough::start() {
    // Local variables
    int i; // r30
...
// Range: 0x802A9950 -> 0x802A99E0
// this: r31
void zCamFlyThrough::stop() {
    // Local variables
    int i; // r30
...
// Range: 0x802A99E0 -> 0x802A99F4
// this: r3
struct xCam * zCamFlyThrough::get_next() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D66290
// Range: 0x802A99F4 -> 0x802A9AB4
// this: r31
void zCamFlyThrough::SetFlyData(void * data /* r1+0x8 */, unsigned int size /* r1+0xC */, struct zCameraFly * fly /* r1+0x10 */, struct xCam * previous /* r30 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D6629B
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x802A9AB4 -> 0x802A9C50
void zCamFlyThrough::StartFly(struct zCameraFly * fly /* r31 */) {
    // Local variables
    struct PKRAssetTOCInfo ainfo; // r1+0x8

    // References
    // -> class zCamFlyThrough sFlyCam;
...
// total size: 0x10
struct /* @class$1288zCameraFly_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D662A4
// Range: 0x802A9C50 -> 0x802A9D38
void zCameraFlyEventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    struct zCameraFly * fly; // r31
...
// total size: 0x4C
struct {} zCamFlyThrough::__vtable; // size: 0x4C, address: 0x80526748
// total size: 0x0
