/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomCheatsManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80313B44 -> 0x80313D94
*/
class zUICustomCheatsManager * pUICustomCheatsManager; // size: 0x4, address: 0x80D6B8F8
static unsigned char gCreditCode; // size: 0x1, address: 0x80D6B8FC
static unsigned char gClearUserString; // size: 0x1, address: 0x80D6B8FD
// total size: 0x54
struct {} zUICustomCheatsManager::__vtable; // size: 0x54, address: 0x8052CFC0
// total size: 0x8
...
// Range: 0x80313B44 -> 0x80313B88
// this: r31
zUICustomCheatsManager::zUICustomCheatsManager(class zUI * ui /* r1+0x8 */) {
    // References
...
// Range: 0x80313B88 -> 0x80313B8C
void zUICustomCheatsManager::Init() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67608
...
// Range: 0x80313B8C -> 0x80313D94
// this: r30
unsigned char zUICustomCheatsManager::HandleEvent(struct xBase * from /* r29 */, unsigned int toEvent /* r1+0x10 */) {
    // Local variables
