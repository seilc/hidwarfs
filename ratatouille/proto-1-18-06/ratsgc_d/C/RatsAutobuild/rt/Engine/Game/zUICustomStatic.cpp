/*
    ...
    Language: C++
    Code range: 0x802967C8 -> 0x80296CAC
*/
float STATIC_ALPHA; // size: 0x4, address: 0x80D65F70
float STATIC_MIN_OFF_TIME; // size: 0x4, address: 0x80D65F74
float STATIC_MAX_OFF_TIME; // size: 0x4, address: 0x80D65F78
float STATIC_FADE_IN_TIME; // size: 0x4, address: 0x80D65F7C
float STATIC_MIN_ON_TIME; // size: 0x4, address: 0x80D65F80
float STATIC_MAX_ON_TIME; // size: 0x4, address: 0x80D65F84
float STATIC_FADE_OUT_TIME; // size: 0x4, address: 0x80D65F88
float STATIC_UV_STRENGTH; // size: 0x4, address: 0x80D65F8C
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65F90
// total size: 0x54
struct {} zUICustomStatic::__vtable; // size: 0x54, address: 0x80525908
enum Stage {
    Stage_Off = 0,
    Stage_FadeIn = 1,
    Stage_On = 2,
...
// Range: 0x802967C8 -> 0x80296884
// this: r31
zUICustomStatic::zUICustomStatic(class zUI * ui /* r30 */) {
    // References
...
// Range: 0x802968C4 -> 0x8029699C
// this: r31
void zUICustomStatic::PreUpdate(float dt /* r1+0x8 */) {
    // References
    // -> float STATIC_MAX_OFF_TIME;
    // -> float STATIC_MIN_OFF_TIME;
