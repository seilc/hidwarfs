/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicPourNSwirl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032BD20 -> 0x8032BEF0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8032BD20 -> 0x8032BD24
void zCompLogicPourNSwirl::AddStaticTweaks() {}

// Range: 0x8032BD24 -> 0x8032BD28
void zCompLogicPourNSwirl::CreateAnimTable() {}
...
static struct xEnt * small_glass; // size: 0x4, address: 0x80D6BA90
// total size: 0x40
struct RwMatrixTag {
    // Members
...
static struct RwMatrixTag small_glass_mat; // size: 0x40, address: 0x80D34520
static struct xEnt * large_glass; // size: 0x4, address: 0x80D6BA94
static struct RwMatrixTag large_glass_mat; // size: 0x40, address: 0x80D34560
static unsigned char init; // size: 0x1, address: 0x80D6BA98
// total size: 0x2
...
// Range: 0x8032BD28 -> 0x8032BEF0
// this: r29
void zCompLogicPourNSwirl::Update() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    struct xModelInstance * model; // r1+0xC
    struct xEntFrame * frame; // r1+0x8
    struct _tagxPad * pad; // r31
    struct xVec3 YPR; // r1+0x1C
    struct xVec3 pos; // r1+0x10

    // References
    // -> static struct RwMatrixTag large_glass_mat;
    // -> static struct xEnt * large_glass;
    // -> struct _tagxPad mPad[4];
    // -> static unsigned char init;
    // -> static struct xEnt * small_glass;
    // -> static struct RwMatrixTag small_glass_mat;
}
...
// total size: 0x4
struct /* @class$1002zCompLogicPourNSwirl_cpp */ {
    // Members
...
union /* @class$1142zCompLogicPourNSwirl_cpp */ {
...
// total size: 0xC
struct /* @class$1140zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$928zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$929zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$930zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$931zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$932zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$933zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$934zCompLogicPourNSwirl_cpp */ {
    // Members
