/*
    ...
    Language: C++
    Code range: 0x8033CC84 -> 0x8033CEB4
*/
// total size: 0x68
...
// Range: 0x8033CC84 -> 0x8033CCA0
int zNPCSwarmBug::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {
    // Local variables
    struct zNPCAssetSwarm * npcassSwarm; // r31
}

char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicSwarmBug,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67C70
signed char zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB38
...
class zComponentPool zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB3C
char __FUNCTION__$localstatic1$AttachComponent__71zComponentPool<26zCompSteeringFlockingBrain,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67C80
signed char zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB48
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
class zComponentPool zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB4C
char __FUNCTION__$localstatic1$AttachComponent__52zComponentPool<10zCompSound,11zICompSound,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67C90
signed char zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6BB58
...
class zComponentPool zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6BB5C
// Range: 0x8033CCA0 -> 0x8033CD40
// this: r31
...
// Range: 0x8033CD40 -> 0x8033CD68
// this: r1+0x8
void zNPCSwarmBug::Deactivate() {}

// Range: 0x8033CD68 -> 0x8033CDF0
// this: r29
void zNPCSwarmBug::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D67CA0
// Range: 0x8033CDF0 -> 0x8033CE8C
// this: r30
void zNPCSwarmBug::UpdateNPCBaseData() {
    // Local variables
    class zCompSteeringFlockingBrain * flockingBrain; // r31
...
// Range: 0x8033CE8C -> 0x8033CEB4
// this: r1+0x8
void zNPCSwarmBug::Render() {}

// total size: 0x3C
struct {} zNPCSwarmBug::__vtable; // size: 0x3C, address: 0x8052EAF0
