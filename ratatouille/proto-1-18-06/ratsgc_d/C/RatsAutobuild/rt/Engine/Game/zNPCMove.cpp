/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCMove.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027E7A4 -> 0x8027F34C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char _static_setup; // size: 0x1, address: 0x80D6B308
static signed char init; // size: 0x1, address: 0x80D6B309
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65B48
...
class zNPCMove : public move {
    ...
    unsigned char systemEvent(struct xBase * from, struct xBase * to, unsigned int toEvent, const float * toParam, struct xBase * toParamWidget, unsigned int toParamWidgetID);

    unsigned char has_mesh();

    void move_to(const struct xVec3 & destination, float dt, unsigned char move_away, unsigned char face_dir, unsigned char change_anim_speed, float arrived_threshold2);

    unsigned char physics_move(float dt);

    void move_away_from(const struct xVec3 & point, float dt);

    unsigned char is_stuck() const;

    unsigned char have_arrived() const;

    void step_move(const struct xVec3 & direction, float distance, float dt);

    // Members
    struct xVec3 last_destination; // offset 0x44, size 0xC
    float cos_min_move_angle; // offset 0x50, size 0x4
};
// Range: 0x8027E7A4 -> 0x8027E890
// this: r31
void zNPCMove::setup() {
    // Local variables
    float moveAngle; // r1+0x8

    // References
    // -> static signed char init;
    // -> static unsigned char _static_setup;
    // -> static char __FUNCTION__[6];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65B4E
// Range: 0x8027E890 -> 0x8027E95C
// this: r1+0x8
unsigned char zNPCMove::systemEvent(struct xBase * from /* r1+0xC */, struct xBase * to /* r1+0x10 */, unsigned int toEvent /* r30 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r31 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // References
...
// Range: 0x8027E95C -> 0x8027E9BC
// this: r31
unsigned char zNPCMove::has_mesh() {}
...
// Range: 0x8027E9BC -> 0x8027E9C0
void zNPCMove::jump_to() {}

unsigned char draw_move_to; // size: 0x1, address: 0x80D6B30A
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D65B5A
...
// Range: 0x8027E9C0 -> 0x8027EF40
// this: r31
void zNPCMove::move_to(const struct xVec3 & destination /* r26 */, float dt /* f31 */, unsigned char move_away /* r23 */, unsigned char face_dir /* r21 */, unsigned char change_anim_speed /* r24 */, float arrived_threshold2 /* r1+0x8 */) {
    // Local variables
    class zMeshPosition * curMeshPos; // r30
    unsigned char goodMeshPos; // r27
    class zMeshCircle * myCircle; // r29
    class zMeshCircle * nearbyCircles; // r22
    float distanceToPoint2; // f30
    class zNPCCommon * npc; // r28
    struct xVec3 npcPos; // r1+0x30
    struct zCombat * npcCombat; // r25
    struct zCombatDamageInfo dmInfo; // r1+0x3C
    struct xVec3 to_destination; // r1+0x24
    float distance2; // f29
    struct xVec3 desired_facing; // r1+0x18
    struct xVec3 backward; // r1+0xC
...
// Range: 0x8027EF40 -> 0x8027F10C
// this: r31
unsigned char zNPCMove::physics_move(float dt /* f29 */) {
    // Local variables
    struct xVec3 target_dpos; // r1+0x18
    float target_length; // f31
    unsigned char succeeded; // r29
    const struct xVec3 & actual_dpos; // r30
    float actual_length; // f30
    struct xVec2 target; // r1+0x10
    struct xVec2 actual; // r1+0x8
}

// Range: 0x8027F10C -> 0x8027F160
// this: r1+0x8
void zNPCMove::move_away_from(const struct xVec3 & point /* r1+0xC */, float dt /* r1+0x10 */) {}

// Range: 0x8027F160 -> 0x8027F1AC
// this: r31
unsigned char zNPCMove::is_stuck() const {}

// Range: 0x8027F1AC -> 0x8027F1F8
// this: r31
unsigned char zNPCMove::have_arrived() const {}

// Range: 0x8027F1F8 -> 0x8027F34C
// this: r31
void zNPCMove::step_move(const struct xVec3 & direction /* r1+0x8 */, float distance /* f26 */, float dt /* f31 */) {
    // Local variables
    float move_dist; // f27
...
// total size: 0x138
struct {} zNPCMove::__vtable; // size: 0x138, address: 0x80524DE0
// total size: 0x10
...
// total size: 0x4
struct /* @class$2049zNPCMove_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zNPCMove_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$860zNPCMove_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$861zNPCMove_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$862zNPCMove_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$863zNPCMove_cpp */ {
    // Members
