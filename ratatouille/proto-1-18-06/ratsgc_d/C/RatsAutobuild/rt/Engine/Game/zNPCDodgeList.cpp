/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCDodgeList.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027A0FC -> 0x8027A640
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float ZNPC_DODGE_LIST_CONE_INTERSECT_ANGLE; // size: 0x4, address: 0x80D65A58
float ZNPC_DODGE_LIST_CONE_HEIGHT_SQ_MULTIPLIER; // size: 0x4, address: 0x80D65A5C
float ZNPC_DODGE_LIST_FROZONE_ICE_BLAST_RANGE_MULTIPLIER; // size: 0x4, address: 0x80D65A60
unsigned char ZNPC_DODGE_LIST_ENABLE_DODGE; // size: 0x1, address: 0x80D65A64
unsigned char ZNPC_DODGE_LIST_DRAW_CONE; // size: 0x1, address: 0x80D6B290
// Range: 0x8027A0FC -> 0x8027A1CC
static float sNPCDodgeListGetCos2BetweenVectors(const struct xVec3 & vec1 /* r29 */, const struct xVec3 & vec2 /* r30 */, float & a2b2 /* r31 */) {
    // Local variables
    float dotVec1Vec2; // f31
    float sqVec1; // f30
    float sqVec2; // f29
}
...
// total size: 0x4
struct /* @class$892zNPCDodgeList_cpp */ {
    // Members
...
union /* @class$1040zNPCDodgeList_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCDodgeList_cpp */ {
    // Members
...
// total size: 0x50
struct zNPCDodgeListObject {
    // Members
    const struct xEnt * target; // offset 0x0, size 0x4
    const struct xEnt * flyingObject; // offset 0x4, size 0x4
    struct xMat4x3 oldMat; // offset 0x10, size 0x40
};
static struct zNPCDodgeListObject * sNPCDodgeListObjects; // size: 0x4, address: 0x80D6B294
static struct xVec3 * sNPCDodgeListObjectsVelocity; // size: 0x4, address: 0x80D6B298
static struct xVec3 * sNPCDodgeListObjectsVelocityNormalized; // size: 0x4, address: 0x80D6B29C
static struct xVec3 * sNPCDodgeListObjectsLocation; // size: 0x4, address: 0x80D6B2A0
static float sSinAngle; // size: 0x4, address: 0x80D6B2A4
static float sCos2Angle; // size: 0x4, address: 0x80D6B2A8
// Range: 0x8027A1CC -> 0x8027A29C
static void sNPCDodgeListAddTweaks() {
    // References
    // -> unsigned char ZNPC_DODGE_LIST_ENABLE_DODGE;
    // -> float ZNPC_DODGE_LIST_FROZONE_ICE_BLAST_RANGE_MULTIPLIER;
    // -> unsigned char ZNPC_DODGE_LIST_DRAW_CONE;
    // -> float ZNPC_DODGE_LIST_CONE_HEIGHT_SQ_MULTIPLIER;
    // -> float ZNPC_DODGE_LIST_CONE_INTERSECT_ANGLE;
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D65A65
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8027A29C -> 0x8027A3B0
void zNPCDodgeListInit() {
    // References
    // -> static float sSinAngle;
    // -> static float sCos2Angle;
    // -> float ZNPC_DODGE_LIST_CONE_INTERSECT_ANGLE;
    // -> static char __FUNCTION__[18];
    // -> unsigned int gActiveHeap;
    // -> static struct xVec3 * sNPCDodgeListObjectsLocation;
    // -> static struct xVec3 * sNPCDodgeListObjectsVelocityNormalized;
    // -> static struct xVec3 * sNPCDodgeListObjectsVelocity;
    // -> static struct zNPCDodgeListObject * sNPCDodgeListObjects;
}

// Range: 0x8027A3B0 -> 0x8027A3FC
void zNPCDodgeListReset() {
    // Local variables
    int i; // r31
...
// Range: 0x8027A3FC -> 0x8027A620
unsigned int zNPCDodgeListGetDodgeDirection(struct xEnt * ent /* r30 */, struct xVec3 & poi /* r1+0x8 */) {
    // Local variables
    int iter; // r31
    struct xVec3 projToNPC; // r1+0x1C
    float checkDist2; // f30
    float cos2; // f31
    float a2b2; // r1+0xC
    struct xVec3 sphereIsectConeOrigin; // r1+0x10
...
// Range: 0x8027A620 -> 0x8027A63C
static float sNPCDodgeListCrossXZ(const struct xVec3 & a /* r3 */, const struct xVec3 & b /* r4 */) {}

// Range: 0x8027A63C -> 0x8027A640
void zNPCDodgeListUpdate() {}
