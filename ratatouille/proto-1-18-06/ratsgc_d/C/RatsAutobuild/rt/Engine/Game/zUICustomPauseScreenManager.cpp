/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomPauseScreenManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802940EC -> 0x802943E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
enum enPAUSE_TYPE {
    PAUSE_QUIT = 0,
    PAUSE_SWITCH_LEVEL = 1,
    PAUSE_JOIN = 2,
};
static enum enPAUSE_TYPE pauseSysType_cur; // size: 0x4, address: 0x80D65EE0
static enum enPAUSE_TYPE pauseSysType_old; // size: 0x4, address: 0x80D65EE4
// total size: 0x54
struct {} zUICustomPauseScreenManager::__vtable; // size: 0x54, address: 0x80525608
// total size: 0x8
class zUICustomPauseScreenManager : public zUICustom {
    // Functions
    zUICustomPauseScreenManager(class zUI * ui);
...
// Range: 0x802940EC -> 0x80294130
// this: r31
zUICustomPauseScreenManager::zUICustomPauseScreenManager(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomPauseScreenManager::__vtable;
}
...
// Range: 0x80294130 -> 0x80294134
void zUICustomPauseScreenManager::Init() {}
...
// total size: 0x4
struct /* @class$897zUICustomPauseScreenManager_cpp */ {
    // Members
...
union /* @class$765zUICustomPauseScreenManager_cpp */ {
...
// total size: 0xC
struct /* @class$1156zUICustomPauseScreenManager_cpp */ {
    // Members
...
// Range: 0x80294134 -> 0x802943E0
// this: r30
unsigned char zUICustomPauseScreenManager::HandleEvent(struct xBase * from /* r27 */, unsigned int toEvent /* r25 */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    unsigned int strHash; // r29
    float toParams[4]; // r1+0x1C
    int i; // r31
    int portInitiatedSysMsg; // r26

    // References
    // -> static enum enPAUSE_TYPE pauseSysType_old;
    // -> static enum enPAUSE_TYPE pauseSysType_cur;
...
// total size: 0x2
struct /* @class$1049zUICustomPauseScreenManager_cpp */ {
    // Members
