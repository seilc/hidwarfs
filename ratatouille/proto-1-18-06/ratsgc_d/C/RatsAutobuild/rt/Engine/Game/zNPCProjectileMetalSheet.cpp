/*
    ...
    Language: C++
    Code range: 0x802C8610 -> 0x802C9150
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float OFFSET_X; // size: 0x4, address: 0x80D66848
static float OFFSET_Y; // size: 0x4, address: 0x80D6684C
static float OFFSET_Z; // size: 0x4, address: 0x80D66850
static float METAL_SHEET_SHADOW_R; // size: 0x4, address: 0x80D66854
static unsigned char METAL_SHEET_SHADOW_STRENGTH; // size: 0x1, address: 0x80D66858
// total size: 0x8
struct RwObject {
    // Members
...
struct RpAtomic * modelFile; // size: 0x4, address: 0x80D6B5C8
// total size: 0x20
struct xQCData {
    // Members
...
struct xBound modelOOBBound; // size: 0x4C, address: 0x80D2D170
float radius; // size: 0x4, address: 0x80D6B5CC
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$901zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1910zNPCProjectileMetalSheet_cpp */ {
    // Members
...
union /* @class$1040zNPCProjectileMetalSheet_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zNPCProjectileMetalSheet_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zNPCProjectileMetalSheet_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zNPCProjectileMetalSheet_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zNPCProjectileMetalSheet_cpp */ {
    // Members
...
struct zShrapnelAsset * explosion_shrapnel; // size: 0x4, address: 0x80D6B5D0
// total size: 0x14C
...
void zNPCProjectileMetalSheet::Update(float dt /* f31 */) {
    ...
    // References
    // -> static float METAL_SHEET_SHADOW_R;
    // -> static float OFFSET_Z;
    // -> static float OFFSET_Y;
    // -> static float OFFSET_X;
}

// Range: 0x802C88DC -> 0x802C890C
// this: r31
void zNPCProjectileMetalSheet::Render() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66859
// Range: 0x802C890C -> 0x802C8990
// this: r31
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D66861
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1374zNPCProjectileMetalSheet_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802C8990 -> 0x802C8CA8
// this: r31
unsigned char zNPCProjectileMetalSheet::Setup(void * configData /* r26 */) {
    // Local variables
    struct MetalSheetConfig * config; // r30
    struct _zEnv * zen; // r27
    struct xEnvAsset * easset; // r29
    struct xMat4x3 * modelFrame; // r28

    // References
    // -> static unsigned char METAL_SHEET_SHADOW_STRENGTH;
...
// Range: 0x802C8CA8 -> 0x802C8F5C
// this: r31
void zNPCProjectileMetalSheet::Collide(const struct xVec3 & dpos /* r1+0x8 */) {
    // Local variables
    struct xVec3 centers[8]; // r1+0x38
    struct xMat4x3 * modelFrame; // r26
    unsigned int k; // r30
    struct xSweptSphere sws; // r1+0x98
    struct xVec3 start; // r1+0x18
    struct xVec3 end; // r1+0xC
    int i; // r29
    struct xSphere * extra_spheres[5]; // r1+0x24
    int num_spheres; // r25
    int j; // r28
...
// total size: 0x4
struct /* @class$2280zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2239zNPCProjectileMetalSheet_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2240zNPCProjectileMetalSheet_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2241zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2238zNPCProjectileMetalSheet_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2243zNPCProjectileMetalSheet_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1856zNPCProjectileMetalSheet_cpp */ {
    // Static members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D66867
// Range: 0x802C8FE8 -> 0x802C914C
void zNPCProjectileMetalSheet::StaticSetup() {
    // Local variables
    struct xModelInstance * tempInst; // r31
...
// Range: 0x802C914C -> 0x802C9150
void zNPCProjectileMetalSheet::AddStaticTweaks() {}

// total size: 0x38
struct {} zNPCProjectileMetalSheet::__vtable; // size: 0x38, address: 0x805284B0
