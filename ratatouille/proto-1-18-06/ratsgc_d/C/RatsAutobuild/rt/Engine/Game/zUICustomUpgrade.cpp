/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomUpgrade.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80296CB4 -> 0x80297060
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int playerCount; // size: 0x4, address: 0x80D6B408
class zUICustomUpgrade * pUICustomUpgradeManager; // size: 0x4, address: 0x80D6B40C
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1356zUICustomUpgrade_cpp */ {
    // Members
...
// total size: 0xC0
class zUICustomUpgrade : public zUICustom {
    // Functions
    zUICustomUpgrade(class zUI * ui);
    ...
    void SwapSides(signed short active, signed short inactive);
    ...
    // Members
public:
    char temp[128]; // offset 0x8, size 0x80
private:
    int numItems; // offset 0x88, size 0x4
    int activeItem; // offset 0x8C, size 0x4
    unsigned char firstTime; // offset 0x90, size 0x1
    int columnNum; // offset 0x94, size 0x4
    int brainID; // offset 0x98, size 0x4
    struct zPlayer * pPlayer; // offset 0x9C, size 0x4
    class zUIText * * upgrades; // offset 0xA0, size 0x4
    class zUIText * * counts; // offset 0xA4, size 0x4
    struct xBase * soundFXLeft; // offset 0xA8, size 0x4
    struct xBase * soundFXRight; // offset 0xAC, size 0x4
    struct xBase * soundFXUp; // offset 0xB0, size 0x4
    struct xBase * soundFXDown; // offset 0xB4, size 0x4
    struct xBase * soundFXDeny; // offset 0xB8, size 0x4
    struct xBase * soundFXConfirm; // offset 0xBC, size 0x4
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$969zUICustomUpgrade_cpp */ {
    // Members
...
union /* @class$1108zUICustomUpgrade_cpp */ {
...
// total size: 0xC
struct /* @class$1107zUICustomUpgrade_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1853zUICustomUpgrade_cpp */ {
    // Static members
...
// total size: 0x54
struct {} zUICustomUpgrade::__vtable; // size: 0x54, address: 0x80525960
// Range: 0x80296CB4 -> 0x80296CF8
// this: r31
zUICustomUpgrade::zUICustomUpgrade(class zUI * ui /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zUICustomUpgrade::__vtable;
}
...
// Range: 0x80296CF8 -> 0x80296CFC
// this: r3
void zUICustomUpgrade::Init() {}

// Range: 0x80296CFC -> 0x80296D24
// this: r1+0x8
void zUICustomUpgrade::Reset() {}

// Range: 0x80296D24 -> 0x80296D50
// this: r3
void zUICustomUpgrade::Setup() {
    // Local variables
    class zUIText * menuitem; // r30
    int i; // r31
    const char * leftOrRight; // r29
}

// Range: 0x80296D50 -> 0x80296D78
// this: r1+0x8
void zUICustomUpgrade::Exit() {}

// Range: 0x80296D78 -> 0x80296D7C
// this: r3
void zUICustomUpgrade::SwapSides(signed short active /* r4 */, signed short inactive /* r5 */) {}

// Range: 0x80296D7C -> 0x80296D80
// this: r3
void zUICustomUpgrade::SelectActive() {}
...
// Range: 0x80296D80 -> 0x80296D84
// this: r3
void zUICustomUpgrade::DeselectActive() {}
...
enum en_xEventTags {
    ...
    eEventIncrement = 11,
    eEventDecrement = 12,
    UNUSED_eEventOpen = 13,
    UNUSED_eEventClose = 14,
    eEventToggle = 15,
    ...
    eEventStop = 19,
    eEventExpired = 20,
    UNUSED_eEventMove = 21,
    eEventDestroy = 22,
    eEventPause = 23,
    eEventPlay = 24,
    UNUSED_eEventPlayOne = 25,
    eEventPlayMaybe = 26,
    UNUSED_eEventRoomStart = 27,
    UNUSED_eEventInvalidate = 28,
    UNUSED_eEventTilt = 29,
    eEventUntilt = 30,
    eEventArrive = 31,
    eEventMount = 32,
    eEventDismount = 33,
    UNUSED_eEventBreak = 34,
    eEventPickup = 35,
    eEventKilled = 36,
    eEventKill = 37,
    eEventOn = 38,
    ...
    eEventLeverSwitchTurnedOn = 42,
    eEventLeverSwitchTurnedOff = 43,
    eEventNPCDetectOn = 44,
    eEventNPCDetectOff = 45,
    eEventNPCChaseOn = 46,
    eEventNPCChaseOff = 47,
    eEventNPCAttackOn = 48,
    eEventNPCAttackOff = 49,
    UNUSED_eEventNPCRespawn = 50,
    eEventPlayerDeath = 51,
    UNUSED_eEventGiveChance = 52,
    UNUSED_eEventGiveShinyObjects = 53,
    UNUSED_eEventGiveHealth = 54,
    eEventPress = 55,
    eEventUnpress = 56,
    ...
    eEventRoomBegin = 89,
    eEventRoomEnd = 90,
    UNUSED_eEventLobMasterShoot = 91,
    UNUSED_eEventLobMasterReset = 92,
    ...
    eEventDispatcher_PadVibrateOn_P1 = 100,
    eEventDispatcher_PadVibrateOff_P1 = 101,
    ...
    UNUSED_eEventDispatcher_LoadState_Count = 121,
    eEventDispatcher_OptionsState_Options = 122,
    UNUSED_eEventDispatcher_OptionsState_Count = 123,
    ...
    UNUSED_eEventDispatcher_SaveState_Count = 127,
    eEventDispatcher_PauseState_Pause = 128,
    eEventDispatcher_PauseState_Options = 129,
    UNUSED_eEventDispatcher_PauseState_Count = 130,
    ...
    UNUSED_eEventVilHurtBoss = 174,
    UNUSED_eEventAttack = 175,
    UNUSED_eEventAttackOn = 176,
    UNUSED_eEventAttackOff = 177,
    eEventDrop = 178,
    eEventUIAddChar = 179,
    eEventUIDelChar = 180,
    ...
    UNUSED_eEventVilReport_StartingChase = 187,
    UNUSED_eEventVilReport_StartingAttack = 188,
    UNUSED_eEventVilReport_StartingRetreat = 189,
    eEventPreload = 190,
    eEventDone = 191,
    eEventArcto = 192,
    UNUSED_eEventDigupReaction = 193,
    ...
    eEventImpact = 207,
    eEventEffectTurnedOn = 208,
    eEventEffectTurnedOff = 209,
    eEventUIReset = 210,
    ...
    eEventDrivenby = 216,
    UNUSED_eEventFollowTarget = 217,
    UNUSED_eEventFaceTarget = 218,
    UNUSED_eEventWatchTarget = 219,
    UNUSED_eEventCarChangeLaneRight = 220,
    UNUSED_eEventCarChangeLaneLeft = 221,
    UNUSED_eEventCarStart = 222,
    UNUSED_eEventCarSetSwerveMode = 223,
    ...
    UNUSED_eEventNavigateTo = 232,
    eEventNPCSpeakStart = 233,
    eEventNPCAlert = 234,
    eEventNPCPatrolDelay = 235,
    eEventNPCScrambleActionEnd = 236,
    UNUSED_eEventVilFakeChaseOff = 237,
    UNUSED_eEventBossMMPushButton = 238,
    UNUSED_eEventVilReport_DecayComplete = 239,
    UNUSED_eEventVilGuardWidget = 240,
    ...
    eEventEmit = 250,
    eEventEmitted = 251,
    UNUSED_eEventTranslucentOn = 252,
    UNUSED_eEventTranslucentOff = 253,
    UNUSED_eEventTranslucentToggle = 254,
    eEventZipLineEnvDamage = 255,
    UNUSED_eEventVilGangTalkOff = 256,
    eEventGivePowerUp = 257,
    UNUSED_eEventRaceTimerReset = 258,
    UNUSED_eEventFireCruiseBubble = 259,
    UNUSED_eEventCarSuccessAnimPlay = 260,
    UNUSED_eEventCarFailureAnimPlay = 261,
    eEventDisableGroupContents = 262,
    UNUSED_eEventNPCCharge = 263,
    eEventOccludeOn = 264,
    eEventOccludeOff = 265,
    UNUSED_eEventRaceTimerPause = 266,
    UNUSED_eEventRaceTimerResume = 267,
    UNUSED_eEventRaceTimerSetBestTime = 268,
    UNUSED_eEventRaceTimerWarning1 = 269,
    UNUSED_eEventRaceTimerWarning2 = 270,
    UNUSED_eEventRaceTimerWarning3 = 271,
    UNUSED_eEventRingChallengeStart = 272,
    UNUSED_eEventCarStop = 273,
    UNUSED_eEventRingChallengeRun = 274,
    UNUSED_eEventRingChallengeReset = 275,
    UNUSED_eEventRingChallengeSuccess = 276,
    UNUSED_eEventRingChallengeFailed = 277,
    UNUSED_eEventFormationChanged = 278,
    UNUSED_eEventChargeResume = 279,
    UNUSED_eEventChargePause = 280,
    UNUSED_eEventNPCChargeStop = 281,
    UNUSED_eEventNPCChargeCompleted = 282,
    UNUSED_eEventFormationChargeStart = 283,
    UNUSED_eEventSituationPlayerSuccess = 284,
    UNUSED_eEventSituationPlayerFailure = 285,
    ...
    UNUSED_eEventWaitForInput = 293,
    eEventPlayMovie = 294,
    UNUSED_eEventCelebrationAnimPlay = 295,
    eEventDispatcher_SetGameState_GameStats = 296,
    eEventMusicNewSong = 297,
    eEventForward = 298,
    eEventReverse = 299,
    UNUSED_eEventDeprecatedRumbleTest = 300,
    UNUSED_eEventDeprecatedRumbleLight = 301,
    UNUSED_eEventDeprecatedRumbleMedium = 302,
    UNUSED_eEventDeprecatedRumbleHeavy = 303,
    eEventDispatcherScreenAdjustON = 304,
    eEventDispatcherScreenAdjustOFF = 305,
    eEventSetSkyDome = 306,
    eEventConnectToChild = 307,
    UNUSED_eEventDuploWaveBegin = 308,
    UNUSED_eEventDuploWaveComplete = 309,
    UNUSED_eEventDuploNPCBorn = 310,
    UNUSED_eEventDuploNPCKilled = 311,
    UNUSED_eEventDuploExpiredMaxNPC = 312,
    UNUSED_eEventDuploPause = 313,
    UNUSED_eEventDuploResume = 314,
    eEventSetGoo = 315,
    UNUSED_eEventNPCScript_ScriptBegin = 316,
    UNUSED_eEventNPCScript_ScriptEnd = 317,
    UNUSED_eEventNPCScript_ScriptReady = 318,
    UNUSED_eEventNPCScript_Halt = 319,
    UNUSED_eEventNPCScript_SetPos = 320,
    UNUSED_eEventNPCScript_SetDir = 321,
    UNUSED_eEventNPCScript_LookNormal = 322,
    UNUSED_eEventNPCScript_LookAlert = 323,
    UNUSED_eEventNPCScript_FaceWidget = 324,
    UNUSED_eEventNPCScript_FaceWidgetDone = 325,
    UNUSED_eEventNPCScript_GotoWidget = 326,
    UNUSED_eEventNPCScript_GotoWidgetDone = 327,
    UNUSED_eEventNPCScript_AttackWidget = 328,
    UNUSED_eEventNPCScript_AttackWidgetDone = 329,
    UNUSED_eEventNPCScript_FollowWidget = 330,
    UNUSED_eEventNPCScript_PlayAnim = 331,
    UNUSED_eEventNPCScript_PlayAnimDone = 332,
    UNUSED_eEventNPCScript_LeadPlayer = 333,
    eEventSetText = 334,
    ...
    eEventAddText = 338,
    eEventClearText = 339,
    UNUSED_eEventOpenTBox = 340,
    UNUSED_eEventCloseTBox = 341,
    ...
    UNUSED_eEventDuploSuperDuperDone = 373,
    UNUSED_eEventDuploDuperIsDoner = 374,
    UNUSED_eEventBusStopSwitchChr = 375,
    ...
    eEventCount19 = 420,
    eEventCount20 = 421,
    UNUSED_eEventSetState = 422,
    eEventEnterMrI = 423,
    eEventEnterFrozone = 424,
    eEventEnterOne = 425,
    eEventEnterAll = 426,
    eEventExitMrI = 427,
    eEventExitFrozone = 428,
    eEventExitOne = 429,
    eEventExitAll = 430,
    eEventGooSetWarb = 431,
    eEventGooSetFreezeDuration = 432,
    eEventGooMelt = 433,
    UNUSED_eEventSetStateRange = 434,
    UNUSED_eEventSetStateDelay = 435,
    UNUSED_eEventSetTransitionDelay = 436,
    UNUSED_eEventNPCFightOn = 437,
    UNUSED_eEventNPCFightOff = 438,
    UNUSED_eEventNPCSplineOKOn = 439,
    UNUSED_eEventNPCSplineOKOff = 440,
    UNUSED_eEventNPCKillQuietly = 441,
    UNUSED_eEventHitHead = 442,
    UNUSED_eEventHitUpperBody = 443,
    UNUSED_eEventHitLeftArm = 444,
    UNUSED_eEventHitRightArm = 445,
    UNUSED_eEventHitLeftLeg = 446,
    UNUSED_eEventHitRightLeg = 447,
    UNUSED_eEventHitLowerBody = 448,
    UNUSED_eEventGiveCurrLevelSocks = 449,
    UNUSED_eEventGiveCurrLevelPickup = 450,
    UNUSED_eEventSetCurrLevelSocks = 451,
    UNUSED_eEventSetCurrLevelPickup = 452,
    eEventTalkBox_OnYes = 453,
    eEventTalkBox_OnNo = 454,
    eEventHit_Cruise = 455,
    UNUSED_eEventDuploKillKids = 456,
    ...
    UNUSED_eEventSpongeballOn = 467,
    UNUSED_eEventSpongeballOff = 468,
    eEventLaunchShrapnel = 469,
    eEventSetIntensity = 470,
    eEventSetFrequency = 471,
    eEventNPCSetActiveOn = 472,
    eEventNPCSetActiveOff = 473,
    UNUSED_eEventPlrSwitchCharacter = 474,
    eEventLevelBegin = 475,
    eEventSceneReset = 476,
    eEventSceneEnter = 477,
    UNUSED_eEventSituationDestroyedTiki = 478,
    UNUSED_eEventSituationDestroyedRobot = 479,
    UNUSED_eEventSituationSeeWoodTiki = 480,
    UNUSED_eEventSituationSeeLoveyTiki = 481,
    UNUSED_eEventSituationSeeShhhTiki = 482,
    UNUSED_eEventSituationSeeThunderTiki = 483,
    UNUSED_eEventSituationSeeStoneTiki = 484,
    UNUSED_eEventSituationSeeFodder = 485,
    UNUSED_eEventSituationSeeHammer = 486,
    UNUSED_eEventSituationSeeTarTar = 487,
    UNUSED_eEventSituationSeeGLove = 488,
    UNUSED_eEventSituationSeeMonsoon = 489,
    UNUSED_eEventSituationSeeSleepyTime = 490,
    UNUSED_eEventSituationSeeArf = 491,
    UNUSED_eEventSituationSeeTubelets = 492,
    UNUSED_eEventSituationSeeSlick = 493,
    UNUSED_eEventSituationSeeKingJellyfish = 494,
    UNUSED_eEventSituationSeePrawn = 495,
    UNUSED_eEventSituationSeeDutchman = 496,
    UNUSED_eEventSituationSeeSandyBossUNUSED = 497,
    UNUSED_eEventSituationSeePatrickBoss = 498,
    UNUSED_eEventSituationSeeSpongeBobBoss = 499,
    UNUSED_eEventSituationSeeRobotPlankton = 500,
    eEventUIChangeTexture = 501,
    UNUSED_eEventNPCCheerForMe = 502,
    ...
    eEventThrown = 511,
    UNUSED_eEventNPCPatrol = 512,
    UNUSED_eEventEnterCruise = 513,
    UNUSED_eEventExitCruise = 514,
    UNUSED_eEventCruiseFired = 515,
    UNUSED_eEventCruiseDied = 516,
    UNUSED_eEventCruiseAddLife = 517,
    UNUSED_eEventCruiseSetLife = 518,
    UNUSED_eEventCruiseResetLife = 519,
    eEventCameraCollideOff = 520,
    eEventCameraCollideOn = 521,
    UNUSED_eEventOnSliding = 522,
    UNUSED_eEventOffSliding = 523,
    eEventTimerSet = 524,
    eEventTimerAdd = 525,
    UNUSED_eEventNPCForceConverseStart = 526,
    UNUSED_eEventMakeASplash = 527,
    eEventCreditsStart = 528,
    eEventCreditsStop = 529,
    eEventCreditsEnded = 530,
    UNUSED_eEventBubbleWipe = 531,
    ...
    eEventWarpGo = 539,
    eEventSetCount = 540,
    UNUSED_eEventGetDashSpeed = 541,
    eEventDashTrip = 542,
    UNUSED_eEventDashBurst = 543,
    UNUSED_eEventDashFast = 544,
    UNUSED_eEventDashNormal = 545,
    UNUSED_eEventDashSlow = 546,
    UNUSED_eEventTakeSocks = 547,
    eEventDispatcherAssert = 548,
    UNUSED_eEventBorn = 549,
    eEventPlatPause = 550,
    eEventPlatUnpause = 551,
    UNUSED_eEventStoreOptions = 552,
    UNUSED_eEventRestoreOptions = 553,
    ...
    UNUSED_eEventKaboomStart = 559,
    UNUSED_eEventKaboomStop = 560,
    UNUSED_eEventNPCAttack = 561,
    UNUSED_eEventNPCDefend = 562,
    UNUSED_eEventTrainCarSpeed = 563,
    UNUSED_eEventTrainJunctOut1 = 564,
    UNUSED_eEventTrainJunctOut2 = 565,
    UNUSED_eEventTrainJunctSwitch = 566,
    UNUSED_eEventTrainJunctPassed = 567,
    UNUSED_eEventTrainCarDetach = 568,
    UNUSED_eEventTrainCarExplode = 569,
    ...
    UNUSED_eEventChangeBossUIStage = 589,
    eEventStaticCameraStart = 590,
    eEventStaticCameraEnd = 591,
    eEventSetCameraStartOrientation = 592,
    UNUSED_eEventNMESetMovepointPath = 593,
    UNUSED_eEventNMEScareBegin = 594,
    UNUSED_eEventNMEScareSkip = 595,
    UNUSED_eEventNMESetMovepointGroup = 596,
    ...
    UNUSED_eEventDashNotOutOfTime = 630,
    eEventDashOutOfTime = 631,
    eEventForceSceneReset = 632,
    UNUSED_eEventNPCActive = 633,
    UNUSED_eEventNPCInactive = 634,
    ...
    UNUSED_eEventHit_Cartwheel = 643,
    ...
    UNUSED_eEventUISignalMainBoxInDone = 657,
    UNUSED_eEventUISignalMainBoxOutDone = 658,
    ...
    UNUSED_eEventNPCDetectAlways = 665,
    UNUSED_eEventNPCDetectNever = 666,
    UNUSED_eEventNPCDetectNormal = 667,
    UNUSED_eEventNPCFightDefault = 668,
    ...
    UNUSED_eEventFreezePlayer = 686,
    UNUSED_eEventUnfreezePlayer = 687,
    ...
    UNUSED_eEventViperFacePlayer = 699,
    UNUSED_eEventViperFaceMovement = 700,
    ...
    eEventNPCNotice = 717,
    UNUSED_eEventBossStageSet = 718,
    UNUSED_eEventBossStageBegan = 719,
    UNUSED_eEventBossStageEnded = 720,
    ...
    UNUSED_eEventMindyStart = 731,
    UNUSED_eEventMindyEnd = 732,
    ...
    UNUSED_eEventStaticCameraStartFOVFilter = 738,
    UNUSED_eEventStaticCameraRestoreFOV = 739,
    ...
    UNUSED_eEventSetAsBounceBack_Cancel = 770,
    eEventDispatcher_PauseGame = 771,
    UNUSED_eEventPattyWagonStartEngine = 772,
    UNUSED_eEventPattyWagonStopEngine = 773,
    UNUSED_eEventSpawnBubblesOn = 774,
    UNUSED_eEventSpawnBubblesOff = 775,
    ...
    UNUSED_eEventUIGetBattleScenes = 786,
    UNUSED_eEventUIBattleScenesAvailable = 787,
    UNUSED_eEventUIBattleScenesNotAvailable = 788,
    ...
    UNUSED_eEventTBoxPlayerEjected = 795,
    eEventDamagePlayer = 796,
    eEventFirstHealthPickup = 797,
    UNUSED_eEventTokenPickupComplete = 798,
    eEventDispatcher_LoadSavePromptDead = 799,
    eEventUIFlipVisibility = 800,
    eEventNet_XBLiveRebootToDashboard = 801,
    UNUSED_eEventFirstPowerupPoint = 802,
    UNUSED_eEventUIIsBattleScene = 803,
    UNUSED_eEventUIBattleSceneYes = 804,
    UNUSED_eEventUIBattleSceneNo = 805,
    eEventUILock = 806,
    eEventUIUnlock = 807,
    eEventDrivenbyOff = 808,
    eEventDrivenbyOn = 809,
    eEventUISignalCreditCode = 810,
    eEventUISignalHILogo = 811,
    eEventDispatcher_DisableAutoSave = 812,
    eEventUISignalEnlargeWindow = 813,
    eEventDispatcher_PromptExiting = 814,
    eEventDispatcher_PromptForceExit = 815,
    eEventUISysMessageActionConfirmed = 816,
    eEventUISysMessageActionDeclined = 817,
    eEventUnpause = 818,
    eEventSetColorIntensity = 819,
    eEventStartLightEffect = 820,
    eEventStopLightEffect = 821,
    eEventNPCHasTakenDamage = 822,
    eEventNPCHalfHealth = 823,
    eEventNPCQuarterHealth = 824,
    eEventNPCHitWithoutDamage = 825,
    eEventNPCHasArrived = 826,
    eEventNPCKillsPlayer = 827,
    eEventNPCCeaseToExist = 828,
    eEventNPCPlayAnim = 829,
    eEventNPCRetreatToCover = 830,
    eEventNPCAttackPlayer = 831,
    eEventNPCFreeze = 832,
    eEventNPCThaw = 833,
    eEventNPCMoveTo = 834,
    eEventCameraTransitionBegin = 835,
    eEventCameraTransitionDone = 836,
    eEventNPCEnterSpawn = 837,
    eEventNPCEnterScare = 838,
    eEventNPCStartCustomAV = 839,
    eEventCustomAVAnimStarted = 840,
    eEventCustomAVAnimFinished = 841,
    eEventCustomAVSoundStarted = 842,
    eEventCustomAVSoundFinished = 843,
    eEventCustomAVFinished = 844,
    eEventNPCAttackWidget = 845,
    eEventNPCAttackWidgetForever = 846,
    eEventNPCAttackedWidget = 847,
    eEventNPCFinishedAttackingWidget = 848,
    eEventNPCFindCover = 849,
    eEventNPCEnterDriller = 850,
    eEventDeactivate = 851,
    eEventActivate = 852,
    eEventNPCLeverOn = 853,
    eEventNPCLeverOff = 854,
    eEventNPCLeverIgnore = 855,
    eEventNPCEnterRunningSpawn = 856,
    eEventNPCRespawned = 857,
    eEventLaunchGrub = 858,
    eEventLaunchTGrub = 859,
    eEventNPCEnterDefaultJumpSpawn = 860,
    eEventNPCDeathDamage = 861,
    eEventNPCGotoIdle = 862,
    eEventNPCGotoCombatIdle = 863,
    eEventNPCGotoChase = 864,
    eEventDispatcher_SetPauseType = 865,
    eEventUIJoinDropGame = 866,
    eEventNPCFinishedSpawning = 867,
    eEventNPCScientistScared = 868,
    eEventNPCScientistComputer = 869,
    eEventNPCScientistPoint = 870,
    eEventNPCScientistInvestigate = 871,
    eEventNPCScientistWalk = 872,
    eEventNPCScientistRun = 873,
    eEventNPCScientistKill = 874,
    eEventNPCScientistIdle = 875,
    eEventNPCTakeDamageOn = 876,
    eEventNPCTakeDamageOff = 877,
    eEventSetActiveNavigationMesh = 878,
    eEventNPCIsStuck = 879,
    eEventStopIceGlide = 880,
    eEventEnterAny = 881,
    eEventExitAny = 882,
    eEventPlayerCameraFocusOff = 883,
    eEventPlayerCameraFocusOn = 884,
    eEventNPCEnterIdleSpawn = 885,
    eEventEnterCameraTarget = 886,
    eEventExitCameraTarget = 887,
    eEventSetCounterToCurrentLevel = 888,
    eEventSetCounterToLevelStatus = 889,
    eEventCameraFocusOnAI = 890,
    eEventCameraFocusOnAIReset = 891,
    eEventRotSetOrientation = 892,
    eEventRotGotoOrientation = 893,
    eEventNPCRangerSetFiringPattern = 894,
    eEventRotGotoOrientationDone = 895,
    eEventScaleDone = 896,
    eEventScaleX = 897,
    eEventScaleY = 898,
    eEventScaleZ = 899,
    eEventScaleXDone = 900,
    eEventScaleYDone = 901,
    eEventScaleZDone = 902,
    eEventNPCDrillOff = 903,
    eEventNPCDrillOn = 904,
    eEventCameraTransitionToADone = 905,
    eEventCameraTransitionToBDone = 906,
    eEventSmashMePleaseOn = 907,
    eEventSmashMePleaseOff = 908,
    eEventChangeVolume = 909,
    eEventFadeVolume = 910,
    eEventNPCSetMovementRadius = 911,
    eEventNPCNoMovementRadius = 912,
    eEventNPCDrillDownAndWait = 913,
    eEventNPCEnterCustomAnimSpawn = 914,
    eEventNPCScientistCheer = 915,
    eEventEnableGroupContents = 916,
    eEventStartMovingHalfway = 917,
    eEventSetLightEffectSpeed = 918,
    eEventBlastDoorsOpening = 919,
    eEventBlastDoorsOpened = 920,
    eEventUIHUDOn = 921,
    eEventUIHUDOff = 922,
    eEventUIHUDHealthChange = 923,
    eEventUIHUDMRIExpPointsChange = 924,
    eEventUIHUDMRIExpPointsToUpgradeChange = 925,
    eEventUIHUDMRIPowerUpAdd = 926,
    eEventUIHUDHumanPlayerPauseGame = 927,
    eEventUIHUDAIPlayerPauseGame = 928,
    eEventUIHUDSwitchPlayers = 929,
    eEventNPCBrokeCover = 930,
    eEventUIHUDPauseGame = 931,
    eEventUIHUDResumeGame = 932,
    eEventUIHUDPlayerMRIActive = 933,
    eEventUIHUDPlayerMRIFollow = 934,
    eEventUIHUDPlayerMRICloseFollow = 935,
    eEventUIHUDPlayerMRIStunned = 936,
    eEventUIHUDPlayerMRIGuard = 937,
    eEventUIHUDPlayerFROActive = 938,
    eEventUIHUDPlayerFROFollow = 939,
    eEventUIHUDPlayerFROCloseFollow = 940,
    eEventUIHUDPlayerFROStunned = 941,
    eEventUIHUDPlayerFROGuard = 942,
    eEventUIHUDFROExpPointsChange = 943,
    eEventUIHUDFROExpPointsToUpgradeChange = 944,
    eEventUIHUDFROPowerUpAdd = 945,
    eEventUIHUDMRIPowerUpRemove = 946,
    eEventUIHUDFROPowerUpRemove = 947,
    eEventNPCPlayTaunt = 948,
    eEventNPCFinishedTakingDamage = 949,
    eEventNPCNukeOn = 950,
    eEventNPCNukeOff = 951,
    eEventNPCArrivedAtPointer = 952,
    eEventNPCMoveToReset = 953,
    eEventAvailable = 954,
    eEventUnavailable = 955,
    eEventUIHUDMRIPowerUpUpgrade = 956,
    eEventUIHUDFROPowerUpUpgrade = 957,
    eEventCheckpointActivate = 958,
    eEventObjectNPCCollisionOn = 959,
    eEventObjectNPCCollisionOff = 960,
    eEventUIQuitGame = 961,
    eEventNPCEnterFallingDirtSpawn = 962,
    eEventNPCEnterFallingIceSpawn = 963,
    eEventBossStageBeganD = 964,
    eEventBossStageEndedD = 965,
    eEventCameraYTrackingOn = 966,
    eEventCameraYTrackingReset = 967,
    eEventUIHUDPlayerMRIHealthIncrease = 968,
    eEventUIHUDPlayerMRIHealthDecrease = 969,
    eEventUIHUDPlayerFROHealthIncrease = 970,
    eEventUIHUDPlayerFROHealthDecrease = 971,
    eEventUIHUDGenericIncrease = 972,
    eEventUIHUDGenericDecrease = 973,
    eEventUISysMessageActionCanceled = 974,
    eEventUI_StartNewGame = 975,
    eEventUI_StartNewGameNoCreateGame = 976,
    eEventUI_StartNewGameYesCreateGame = 977,
    eEventNPCTankSetAttackPattern = 978,
    eEventNPCThreeQuarterHealth = 979,
    eEventNPCPoolCreated = 980,
    eEventUISysMessageWaitInfo = 981,
    eEventNPCPoolReset = 982,
    eEventUIModelBarOffsetNext = 983,
    eEventUIModelBarOffsetPrevious = 984,
    eEventBossMinionsDead = 985,
    eEventNPCOneLiner = 986,
    eEventNPCEnterFallingNoFX = 987,
    eEventCreditsEndedBackToMainMenu = 988,
    eEventDestroyAllRubbles = 989,
    eEventNPCSetCloseEnoughToTargetDist = 990,
    eEventBossStageBeganA1 = 991,
    eEventBossStageEndedA1 = 992,
    eEventBossStageBeganB1 = 993,
    eEventBossStageEndedB1 = 994,
    eEventBossStageBeganC1 = 995,
    eEventBossStageEndedC1 = 996,
    eEventBossStageBeganA2 = 997,
    eEventBossStageEndedA2 = 998,
    eEventBossStageBeganB2 = 999,
    eEventBossStageEndedB2 = 1000,
    eEventBossStageBeganC2 = 1001,
    eEventBossStageEndedC2 = 1002,
    eEventBossStageBeganA3 = 1003,
    eEventBossStageEndedA3 = 1004,
    eEventBossStageBeganB3 = 1005,
    eEventBossStageEndedB3 = 1006,
    eEventBossStageBeganC3 = 1007,
    eEventBossStageEndedC3 = 1008,
    eEventNPCScientistInDanger = 1009,
    eEventNPCIgnoreAllDamageOn = 1010,
    eEventNPCIgnoreAllDamageOff = 1011,
    eEventUIEnterControlsScreen = 1012,
    eEventSwitchLeverStart = 1013,
    eEventUIHUDLeftPlayerDrop = 1014,
    eEventPlayerWalkOnDisable = 1015,
    eEventPlayerWalkOnEnable = 1016,
    eEventSwitchLeverStop = 1017,
    eEventUIMainMenuSecondPlayerJoin = 1018,
    eEventUIMainMenuSecondPlayerDrop = 1019,
    eEventUIHUDRecoveryFRO = 1020,
    eEventUIHUDRecoveryMRI = 1021,
    eEventDispatcher_PadVibrateOn_P2 = 1022,
    eEventDispatcher_PadVibrateOff_P2 = 1023,
    eEventHitFiltered = 1024,
    eEventDestroyFiltered = 1025,
    eEventUISignalCreditCodeStart = 1026,
    eEventSuperMoveStarted = 1027,
    eEventSuperMoveFinished = 1028,
    eEventNPCAttackWidgetSmashMe = 1029,
    eEventDispatcher_SLContinue = 1030,
    eEventUISysMessageWaitResponseExtra = 1031,
    eEventHeistExecute = 1032,
    eEventDetected = 1033,
    eEventDistracted = 1034,
    eEventCookingMinigameStart = 1035,
    eEventCookingMinigameScore = 1036,
    eEventAlerted = 1037,
    eEventPacified = 1038,
    eEventAlertedFromDetected = 1039,
    eEventTaskWasCompleted = 1040,
    eEventTaskWasFailed = 1041,
    eEventTaskWasMadeAvailable = 1042,
    eEventTaskFail = 1043,
    eEventTaskComplete = 1044,
    eEventTaskMakeAvailable = 1045,
    eEventTaskMakeRequired = 1046,
    eEventTaskMakeBonus = 1047,
    eEventMissionWasUnlocked = 1048,
    eEventMissionWasCompleted = 1049,
    eEventMissionWasFailed = 1050,
    eEventMissionUnlock = 1051,
    eEventMissionLock = 1052,
    eEventDetectionEnable = 1053,
    eEventDetectionDisable = 1054,
    eEventHeistLookoutStart = 1055,
    eEventHeistLookoutStop = 1056,
    eEventHeistLookoutXCentered = 1057,
    eEventHeistLookoutYCentered = 1058,
    eEventHeistLookoutRight = 1059,
    eEventHeistLookoutLeft = 1060,
    eEventHeistLookoutUp = 1061,
    eEventHeistLookoutDown = 1062,
    eEventMiniGameWin = 1063,
    eEventMiniGameLose = 1064,
    eEventMiniGameTie = 1065,
    eEventMiniGameStageFinish = 1066,
    eEventOpenPath = 1067,
    eEventClosePath = 1068,
    eEventBlockerOn = 1069,
    eEventBlockerOff = 1070,
    eEventGangMemberOn = 1071,
    eEventGangMemberOff = 1072,
    eEventFinishedDistraction = 1073,
    eEventDistractionStarted = 1074,
    eEventNPCAnimStopped = 1075,
    eEventHUDCompassSwapTexture = 1076,
    eEventPickupUseStartAction = 1077,
    eEventPickupUseStopAction = 1078,
    eEventAnalogDeflection = 1079,
    eEventAnalogDirection = 1080,
    eEventControlOffNoLetterbox = 1081,
    eEventHighRateThreshold = 1082,
    eEventMedRateThreshold = 1083,
    eEventLowRateThreshold = 1084,
    eEventNoRateThreshold = 1085,
    eEventSwitchNPCWalls = 1086,
    eEventSetAttractor = 1087,
    eEventSetRepeller = 1088,
    eEventDisableAttractor = 1089,
    eEventDisableRepeller = 1090,
    eEventSetMagneticOn = 1091,
    eEventSetMagneticOff = 1092,
    eEventMiniGameSetPlayerCount = 1093,
    eEventAnalogValue = 1094,
    eEventMiniGameEnd = 1095,
    eEventMiniGameReset = 1096,
    eEventCMG_DDRSuccess = 1097,
    eEventCMG_DDRFailure = 1098,
    eEventCMG_DDRGroupSuccess = 1099,
    eEventCMG_DDRGroupFailure = 1100,
    eEventSetBoundAvoidance = 1101,
    eEventSetBoundSize = 1102,
    eEventMiniGameWinnerP1 = 1103,
    eEventMiniGameWinnerP2 = 1104,
    eEventMiniGameWinnerP3 = 1105,
    eEventMiniGameWinnerP4 = 1106,
    eEventContextFX = 1107,
    eEventPlayerDetected = 1108,
    eEventCount = 1109,
};
...
// Range: 0x80296D84 -> 0x80296DA0
// this: r3
void zUICustomUpgrade::PreUpdate(float dt /* f1 */) {
    // Local variables
    int i; // r31
    enum zCommonPlayerUpgradeLevel meleeUpgrade; // r30
}
...
// total size: 0x2
struct /* @class$1979zUICustomUpgrade_cpp */ {
    // Members
...
// Range: 0x80296DA0 -> 0x80297060
// this: r31
unsigned char zUICustomUpgrade::HandleEvent(struct xBase * from /* r27 */, unsigned int toEvent /* r23 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r24 */, unsigned int toParamWidgetID /* r25 */) {
    // Local variables
    class zUIText * ui_text; // r1+0x8
    int currentval; // r29
    unsigned int toUpgrade; // r28
    class zUI * controller; // r26
