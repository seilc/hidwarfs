/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameGrapeStomper.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803261A0 -> 0x80327908
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x80D6BA28
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x80D6BA2C
static unsigned int TIMER_BOX_ID; // size: 0x4, address: 0x80D6BA30
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x80D6BA34
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x80D6BA38
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x80D6BA3C
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x80D6BA40
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x80D6BA44
static unsigned int TIE_TEX_ID; // size: 0x4, address: 0x80D6BA48
static unsigned int DECAL_OWNER_ID; // size: 0x4, address: 0x80D6BA4C
static unsigned int RSCREEN_DECAL_TEX_IDS[4][3]; // size: 0x30, address: 0x8052DD30
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[3]; // size: 0x54, address: 0x804DEF38
static unsigned int READY_TEX_IDS[3]; // size: 0xC, address: 0x80D678C0
static unsigned int READY_SFX_ID; // size: 0x4, address: 0x80D6BA50
static unsigned int STEADY_SFX_ID; // size: 0x4, address: 0x80D6BA54
static unsigned int GO_SFX_ID; // size: 0x4, address: 0x80D6BA58
static unsigned int SUCCESS_SFX_ID; // size: 0x4, address: 0x80D6BA5C
static unsigned int SQUISH_SFX_ID; // size: 0x4, address: 0x80D6BA60
char __FUNCTION__$localstatic1$SetScore__12ResultScreenFii[9]; // size: 0x9, address: 0x80D678CC
char __FUNCTION__$localstatic1$SetPlayerCount__12ResultScreenFi[15]; // size: 0xF, address: 0x80D678D5
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D678E4
...
// total size: 0x1
struct /* @class$1078zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1080zMiniGameGrapeStomper_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1081zMiniGameGrapeStomper_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1082zMiniGameGrapeStomper_cpp */ {
    // Members
...
enum /* @enum$1083zMiniGameGrapeStomper_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1084zMiniGameGrapeStomper_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1085zMiniGameGrapeStomper_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1087zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x2
struct /* @class$1075zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$932zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1178zMiniGameGrapeStomper_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
union /* @class$1154zMiniGameGrapeStomper_cpp */ {
...
// total size: 0xC
struct /* @class$873zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$874zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$875zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$876zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$877zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$878zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$879zMiniGameGrapeStomper_cpp */ {
    // Members
...
class ResultScreen {
    // Functions
    void Init(struct zMiniGameAssetGrapeStomper * a);
    ...
    // Members
protected:
    int playerCount; // offset 0x0, size 0x4
    float increment[4]; // offset 0x4, size 0x10
    int scores[4]; // offset 0x14, size 0x10
    int dispScores[4]; // offset 0x24, size 0x10
    struct ztextbox * scoresText[4]; // offset 0x34, size 0x10
    int spitterCount; // offset 0x44, size 0x4
    struct xEnt * * spitters; // offset 0x48, size 0x4
    struct emit_context decalContext[4][3]; // offset 0x4C, size 0x450
    struct xResponseCurve decalResponseCurve; // offset 0x49C, size 0x14
    enum iSndGroupHandle splatSound; // offset 0x4B0, size 0x4
    float endTimer; // offset 0x4B4, size 0x4
    unsigned char done; // offset 0x4B8, size 0x1
};
// total size: 0x14
...
// total size: 0x20
struct zMiniGameAssetGrapeStomper : public zMiniGameAsset {
    // Members
    float timeLimit; // offset 0x14, size 0x4
    unsigned int controlType; // offset 0x18, size 0x4
    unsigned int spitterGroupID; // offset 0x1C, size 0x4
};
// total size: 0xC
...
// Range: 0x803261A0 -> 0x803262B4
// this: r31
void ResultScreen::Init(struct zMiniGameAssetGrapeStomper * a /* r28 */) {
    // Local variables
    struct xGroup * g; // r29
    int i; // r30

    // References
    // -> static unsigned int SQUISH_SFX_ID;
    // -> static char __FUNCTION__[5];
    // -> unsigned int gActiveHeap;
}

// Range: 0x803262B4 -> 0x80326354
// this: r31
void ResultScreen::Prepare() {
    // Local variables
    int i; // r30
}

// Range: 0x80326354 -> 0x80326540
// this: r31
void ResultScreen::SceneSetup() {
    // Local variables
    int i; // r30
    int j; // r29
    float randomSize; // f31

    // References
    // -> static unsigned int RSCREEN_DECAL_TEX_IDS[4][3];
    // -> static unsigned int DECAL_OWNER_ID;
    // -> static struct curve_node decalCurve[3];
...
static char scoresBuf[4][128]; // size: 0x200, address: 0x80D33F00
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x80326540 -> 0x803269AC
// this: r31
void ResultScreen::Update(float dt /* f26 */) {
    // Local variables
    int j; // r30
    float half; // f27
    float rate; // f31
    ...
    // References
    // -> static char scoresBuf[4][128];
    // -> static unsigned int DECAL_OWNER_ID;
}

// total size: 0x7C
struct {} zMiniGameGrapeStomper::__vtable; // size: 0x7C, address: 0x8052DD60
// total size: 0x50
...
// total size: 0x78
class zMiniGameGrapeStomper : public zMiniGameBase {
    // Functions
    zMiniGameGrapeStomper(struct zMiniGameAsset * a);
...
protected:
    ...
    float prepStageTimer; // offset 0x30, size 0x4
    int prepStageTexIdx; // offset 0x34, size 0x4
    float gameEndTimer; // offset 0x38, size 0x4
    float resultScreenDelayTimer; // offset 0x3C, size 0x4
    int highscore; // offset 0x40, size 0x4
    int winner; // offset 0x44, size 0x4
    float instructPauseTimer; // offset 0x48, size 0x4
    enum iSndGroupHandle prepScreenSounds[3]; // offset 0x4C, size 0xC
    enum iSndGroupHandle resultSound; // offset 0x58, size 0x4
    struct ztextbox * statsText[4]; // offset 0x5C, size 0x10
    struct ztextbox * timerText; // offset 0x6C, size 0x4
    class zUIImage * resultImage; // offset 0x70, size 0x4
    class ResultScreen * rScreen; // offset 0x74, size 0x4
};
// Range: 0x803269AC -> 0x803269F8
// this: r31
zMiniGameGrapeStomper::zMiniGameGrapeStomper(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGameGrapeStomper::__vtable;
}

// Range: 0x803269F8 -> 0x803269FC
void zMiniGameGrapeStomper::CreatePlayers() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D678E9
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1707zMiniGameGrapeStomper_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x803269FC -> 0x80326CBC
void zMiniGameGrapeStomper::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r28
    class zMiniGameGrapeStomper * instance; // r30
...
// Range: 0x80326CBC -> 0x80326DE4
// this: r31
void zMiniGameGrapeStomper::SceneSetup() {
    // Local variables
    unsigned int dispID; // r29
    int i; // r30

    // References
    // -> static unsigned int LOSE_TEX_ID;
    // -> static unsigned int RESULT_IMG_ID;
    // -> static unsigned int TIMER_BOX_ID;
    // -> static unsigned int P2_STATS_BOX_ID;
    // -> static unsigned int P1_STATS_BOX_ID;
    // -> static unsigned int SUCCESS_SFX_ID;
    // -> static unsigned int GO_SFX_ID;
    // -> static unsigned int STEADY_SFX_ID;
    // -> static unsigned int READY_SFX_ID;
}

// Range: 0x80326DE4 -> 0x80326E70
// this: r30
void ResultScreen::SetPlayerCount(int count /* r31 */) {
    // References
    // -> char __FUNCTION__$localstatic1$SetPlayerCount__12ResultScreenFi[15];
}

struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x80326E70 -> 0x80326F7C
// this: r31
void zMiniGameGrapeStomper::CheckWinLoseConditions() {
    // Local variables
    int i; // r30
...
class InputChecker {};
// total size: 0x13F0
class zMiniGameGrapeStomperPlayer : public zMiniGamePlayer {
    // Members
protected:
    unsigned int curStomp; // offset 0x13B0, size 0x4
    unsigned int prevStomp; // offset 0x13B4, size 0x4
    int score; // offset 0x13B8, size 0x4
    struct xModelInstance * models[3]; // offset 0x13BC, size 0xC
    int frameCount; // offset 0x13C8, size 0x4
    int whichModel; // offset 0x13CC, size 0x4
    class InputChecker * inputChecker; // offset 0x13D0, size 0x4
    struct zShrapnelAsset * leftSplash[3]; // offset 0x13D4, size 0xC
    struct zShrapnelAsset * rightSplash[3]; // offset 0x13E0, size 0xC
};
// total size: 0xDC
...
// total size: 0x890
struct /* @class$1950zMiniGameGrapeStomper_cpp */ {
    // Static members
...
// total size: 0x54
struct /* @class$1974zMiniGameGrapeStomper_cpp */ {
    // Members
...
// Range: 0x80326F7C -> 0x80327180
// this: r31
void zMiniGameGrapeStomper::SetWinLoseDisplay() {
    // Local variables
    int i; // r29
    unsigned int texID; // r28
    int j; // r30

    // References
    // -> struct xGlobals * xglobals;
    // -> static unsigned int TIE_TEX_ID;
    // -> static unsigned int LOSE_TEX_ID;
...
// Range: 0x80327180 -> 0x8032725C
// this: r31
void zMiniGameGrapeStomper::GameStartUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static unsigned int READY_TEX_IDS[3];
}

// Range: 0x8032725C -> 0x8032732C
// this: r31
void zMiniGameGrapeStomper::StageStartUpdate(float dt /* r1+0x8 */) {
    // References
    // -> static unsigned int READY_TEX_IDS[3];
}

static char timerBuf[32]; // size: 0x20, address: 0x80D34100
// Range: 0x8032732C -> 0x803273B8
// this: r31
void zMiniGameGrapeStomper::SetTimerText() {
    // References
    // -> static char timerBuf[32];
}

static char statsBuf[4][128]; // size: 0x200, address: 0x80D34120
// Range: 0x803273B8 -> 0x803275C4
// this: r31
void zMiniGameGrapeStomper::GamePlayUpdate(float dt /* f31 */) {
    // Local variables
    int i; // r29
    int j; // r30
...
// Range: 0x803275C4 -> 0x80327670
// this: r30
void ResultScreen::SetScore(int index /* r31 */, int score /* r1+0x8 */) {
    // References
    // -> char __FUNCTION__$localstatic1$SetScore__12ResultScreenFii[9];
}

// Range: 0x80327670 -> 0x80327780
// this: r31
void zMiniGameGrapeStomper::StageEndUpdate(float dt /* r1+0x8 */) {}

// Range: 0x80327780 -> 0x80327788
// this: r3
unsigned char ResultScreen::IsDone() {}

// Range: 0x80327788 -> 0x80327820
// this: r31
void zMiniGameGrapeStomper::GameEndUpdate(float dt /* r1+0x8 */) {}

// Range: 0x80327820 -> 0x80327824
void zMiniGameGrapeStomper::Render() {}

// Range: 0x80327824 -> 0x80327904
// this: r31
void zMiniGameGrapeStomper::Reset() {
    // Local variables
    int j; // r30
...
// Range: 0x80327904 -> 0x80327908
void zMiniGameGrapeStomper::AddTweaks() {}
