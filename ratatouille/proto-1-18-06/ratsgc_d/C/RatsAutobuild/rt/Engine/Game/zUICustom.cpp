/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802214B4 -> 0x80221EC8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802214B4 -> 0x802214B8
void zUICustom::Init() {}

// Range: 0x802214B8 -> 0x802214BC
void zUICustom::Setup() {}

// Range: 0x802214BC -> 0x802214C0
void zUICustom::Reset() {}

// Range: 0x802214C0 -> 0x802214C4
void zUICustom::ResetMotion() {}

// Range: 0x802214C4 -> 0x802214CC
unsigned char zUICustom::HandleEvent() {}

// Range: 0x802214CC -> 0x802214D0
void zUICustom::PreUpdate() {}

// Range: 0x802214D0 -> 0x802214D4
void zUICustom::PostUpdate() {}

// Range: 0x802214D4 -> 0x802214DC
unsigned char zUICustom::PreRender() {}

// Range: 0x802214DC -> 0x802214E4
unsigned char zUICustom::PreAutoMenu() {}

// Range: 0x802214E4 -> 0x802214E8
void zUICustom::PostRender() {}

// Range: 0x802214E8 -> 0x802214EC
void zUICustom::Exit() {}

// Range: 0x802214EC -> 0x802214F0
void zUICustom::AddTweaks() {}

// Range: 0x802214F0 -> 0x802214F4
void zUICustom::PreInitMotion() {}

// Range: 0x802214F4 -> 0x802214F8
void zUICustom::PostInitMotion() {}

// Range: 0x802214F8 -> 0x802214FC
void zUICustom::PreApplyMotionFrame() {}

// Range: 0x802214FC -> 0x80221500
void zUICustom::PostApplyMotionFrame() {}

// Range: 0x80221500 -> 0x80221528
void * zUICustom::operator new(unsigned long size /* r1+0x8 */) {}
...
// total size: 0xC
struct /* @class$1121zUICustom_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1695zUICustom_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1938zUICustom_cpp */ {
    // Static members
...
// total size: 0x2
struct /* @class$1655zUICustom_cpp */ {
    // Members
...
// total size: 0x14
class zUICustomSoundMode : public zUICustom {
    // Members
    class zUIText * optionMono; // offset 0x8, size 0x4
    class zUIText * optionStereo; // offset 0xC, size 0x4
    class zUIText * optionDolby; // offset 0x10, size 0x4
};
class zUICustomSoundMode * pUICustomSoundMode; // size: 0x4, address: 0x80D6B400
// total size: 0x34
...
class zUICustomArtworkManager * pUICustomArtworkManager; // size: 0x4, address: 0x80D6B418
...
class zUICustomCheatsManager * pUICustomCheatsManager; // size: 0x4, address: 0x80D6B8F8
// Range: 0x80221528 -> 0x80221CB0
class zUICustom * zUICustomAllocate(unsigned int hashID /* r1+0x8 */, class zUI * ui /* r31 */) {
    // References
    // -> class zUICustomCheatsManager * pUICustomCheatsManager;
    ...
    // -> class zUICustomParrBestScreen * pUICustomParrBestScreen;
    // -> class zUICustomUpgrade * pUICustomUpgradeManager;
    // -> class zUICustomVolume * pUICustomSFXVolumeManager;
    // -> class zUICustomArtworkManager * pUICustomArtworkManager;
    // -> class zUICustomSoundMode * pUICustomSoundMode;
    // -> struct zGlobals globals;
    // -> class zUICustomVolume * pUICustomMusicVolumeManager;
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D64AF0
// Range: 0x80221CB0 -> 0x80221E18
void zSendUIEvent(const char * widgetName /* r29 */, unsigned int event /* r1+0x8 */) {
    // Local variables
    unsigned int id; // r31
    struct xBase * sendTo; // r30

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x80221E18 -> 0x80221E70
void zUIAutoScreenManagerFocusOnSelect() {}

// Range: 0x80221E70 -> 0x80221EC8
void zUIAutoScreenManagerFocusOffUnselect() {}

// total size: 0x54
struct {} zUICustom::__vtable; // size: 0x54, address: 0x805236F0
