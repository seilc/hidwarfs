/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zHeistLookoutPoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802E9B24 -> 0x802EAB14
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66DD0
// total size: 0x14
struct {} zHeistLookoutPoint::__vtable; // size: 0x14, address: 0x80D66DE8
...
// total size: 0xC
struct /* @class$1827zHeistLookoutPoint_cpp */ {
    // Members
...
class zHeistLookoutPoint : public zTriggerInteraction {
    // Functions
    zHeistLookoutPoint(struct zHeistLookoutPointAsset * theAsset);

    void EventCB(unsigned int toEvent);

    void Update(float dt);

    void HandleInput(class zPad * currPad, float dt);

    void Start(struct zCommonPlayer * player);

    void Stop();

    void GetLookAtVec(struct xVec3 & inVec);

    void GetLookFromPos(struct xVec3 & inVec);
...
// Range: 0x802E9B24 -> 0x802E9F58
// this: r31
zHeistLookoutPoint::zHeistLookoutPoint(struct zHeistLookoutPointAsset * theAsset /* r30 */) {
    // Local variables
    struct xVec3 pointAt; // r1+0x10
    struct xMat3x3 pointAtMat; // r1+0x20

    // References
    // -> static char __FUNCTION__[5];
    // -> class zHeistManager * heistManager;
    // -> struct xGlobals * xglobals;
    // -> struct [anonymous] zHeistLookoutPoint::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66DD5
// Range: 0x802E9F58 -> 0x802EA120
void zHeistLookoutPoint::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802EA120 -> 0x802EA158
void zHeistLookoutPoint::UpdateHeistManager(float dt /* r1+0x8 */) {
    // References
    // -> class zHeistManager * heistManager;
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66DDA
// Range: 0x802EA158 -> 0x802EA274
void zHeistLookoutPoint::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
...
// Range: 0x802EA274 -> 0x802EA308
// this: r31
void zHeistLookoutPoint::EventCB(unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    struct zHeistLookoutPointAsset * asset; // r1+0xC
}
...
// Range: 0x802EA308 -> 0x802EA454
// this: r31
void zHeistLookoutPoint::Update(float dt /* f30 */) {
    // Local variables
    int i; // r30
    float palpha; // f31
...
// Range: 0x802EA454 -> 0x802EA478
void zHeistLookoutPoint::RenderOverlays() {
    // References
    // -> class zHeistManager * heistManager;
}
...
// Range: 0x802EA478 -> 0x802EA8C8
// this: r31
void zHeistLookoutPoint::HandleInput(class zPad * currPad /* r30 */, float dt /* f30 */) {
    // Local variables
    struct xMat4x3 rotMat; // r1+0x50
    struct xMat4x3 valMat; // r1+0x10
    float rotAngle; // f31
...
// Range: 0x802EA8C8 -> 0x802EA998
// this: r31
void zHeistLookoutPoint::Start(struct zCommonPlayer * player /* r30 */) {
    // References
    // -> class zHeistManager * heistManager;
}
...
// total size: 0x4
struct /* @class$928zHeistLookoutPoint_cpp */ {
    // Members
...
union /* @class$1067zHeistLookoutPoint_cpp */ {
...
// total size: 0xC
struct /* @class$1066zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2098zHeistLookoutPoint_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$869zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$871zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$872zHeistLookoutPoint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$873zHeistLookoutPoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$874zHeistLookoutPoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$875zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2245zHeistLookoutPoint_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2246zHeistLookoutPoint_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2247zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2244zHeistLookoutPoint_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2249zHeistLookoutPoint_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1701zHeistLookoutPoint_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66DE2
// total size: 0x1C
...
// Range: 0x802EA998 -> 0x802EAA88
// this: r31
void zHeistLookoutPoint::Stop() {
    // References
    // -> class zHeistManager * heistManager;
...
// Range: 0x802EAA88 -> 0x802EAAD4
// this: r31
void zHeistLookoutPoint::GetLookAtVec(struct xVec3 & inVec /* r1+0x8 */) {}

// Range: 0x802EAAD4 -> 0x802EAB14
// this: r31
void zHeistLookoutPoint::GetLookFromPos(struct xVec3 & inVec /* r1+0x8 */) {}
