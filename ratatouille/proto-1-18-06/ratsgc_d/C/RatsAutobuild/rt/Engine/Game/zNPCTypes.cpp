/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCTypes.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BFC34 -> 0x802C220C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zNPCTypesTable gNPCTypesTable[17]; // size: 0x50C, address: 0x80527C10
enum eCompType {
    eCompType_Unknown = -1,
...
// total size: 0xC
struct /* @class$1123zNPCTypes_cpp */ {
    // Members
...
static unsigned char gNPCTypesTableInitialized; // size: 0x1, address: 0x80D6B580
// Range: 0x802BFC34 -> 0x802BFC40
struct zNPCTypesTable * zNPCTypes_GetTable() {
    // References
    // -> static struct zNPCTypesTable gNPCTypesTable[17];
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x8052811C
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x802BFC40 -> 0x802BFCE8
struct zNPCTypesTable * zNPCTypes_GetTableEntry(enum eNPCType npcType /* r31 */) {
    // References
    // -> static struct zNPCTypesTable gNPCTypesTable[17];
...
// Range: 0x802BFCE8 -> 0x802BFD48
enum eNPCType zNPCTypes_GetNPCType(enum eBrainType brainType /* r1+0x8 */) {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D66668
// Range: 0x802BFD48 -> 0x802BFE80
void zNPCTypes_Prepare() {
    // Local variables
    struct zNPCTypesTable * npcTypesTableEntry; // r31
    int i; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6667A
// Range: 0x802BFE80 -> 0x802C0034
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6668B
// Range: 0x802C0034 -> 0x802C01E8
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D6669C
// Range: 0x802C01E8 -> 0x802C039C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D666AD
// Range: 0x802C039C -> 0x802C0550
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D666BE
// Range: 0x802C0550 -> 0x802C0704
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D666CF
// Range: 0x802C0704 -> 0x802C08B8
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D666E0
// Range: 0x802C08B8 -> 0x802C0A6C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D666F1
// Range: 0x802C0A6C -> 0x802C0C20
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66702
// Range: 0x802C0C20 -> 0x802C0DD4
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66713
// Range: 0x802C0DD4 -> 0x802C0F88
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66724
// Range: 0x802C0F88 -> 0x802C113C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66735
// Range: 0x802C113C -> 0x802C12F0
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66746
// Range: 0x802C12F0 -> 0x802C14A4
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66757
// Range: 0x802C14A4 -> 0x802C1658
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D66768
// Range: 0x802C1658 -> 0x802C180C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
// Range: 0x802C180C -> 0x802C1870
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C18AC -> 0x802C1910
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C194C -> 0x802C19B0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C19EC -> 0x802C1A50
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1A8C -> 0x802C1AF0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1B2C -> 0x802C1B90
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1BCC -> 0x802C1C30
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1C6C -> 0x802C1CD0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1D0C -> 0x802C1D70
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1DAC -> 0x802C1E10
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1E4C -> 0x802C1EB0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1EEC -> 0x802C1F50
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C1F8C -> 0x802C1FF0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C202C -> 0x802C2090
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C20CC -> 0x802C2130
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}

// Range: 0x802C216C -> 0x802C21D0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r1+0x8 */) {}
