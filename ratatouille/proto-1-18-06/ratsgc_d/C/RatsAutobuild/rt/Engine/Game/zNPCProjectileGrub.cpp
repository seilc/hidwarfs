/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCProjectileGrub.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C3F88 -> 0x802C4F34
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float GRUB_SPEED; // size: 0x4, address: 0x80D667C8
static float GRUB_EXPLOSION_RADIUS; // size: 0x4, address: 0x80D667CC
static float GRUB_AWAY_KNOCKBACK; // size: 0x4, address: 0x80D667D0
static float GRUB_UP_KNOCKBACK; // size: 0x4, address: 0x80D667D4
static float GRUB_TRAIL_OFFSET; // size: 0x4, address: 0x80D667D8
static float GRUB_SHADOW_OFFSET; // size: 0x4, address: 0x80D667DC
static float GRUB_DECAL_SIZE; // size: 0x4, address: 0x80D667E0
static float GRUB_LIFETIME; // size: 0x4, address: 0x80D667E4
static float GRUB_RADIUS; // size: 0x4, address: 0x80D667E8
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x804D1C00
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x80D6B5A0
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x80D6B5A4
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x80D6B5A8
static unsigned int GRUB_BUG_MODEL_ID; // size: 0x4, address: 0x80D6B5AC
static unsigned int GRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x80D6B5B0
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x44, address: 0x80528308
static struct TrailConfig ShortTrailConfig; // size: 0x44, address: 0x8052834C
// total size: 0x1C
struct ArcConfig {
    // Members
...
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x80D667EC
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x80D667F0
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x80D667F4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$892zNPCProjectileGrub_cpp */ {
    // Members
...
union /* @class$1040zNPCProjectileGrub_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCProjectileGrub_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct xSurface * grubScrollingSurf; // size: 0x4, address: 0x80D6B5B4
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1912zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$833zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zNPCProjectileGrub_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zNPCProjectileGrub_cpp */ {
    // Members
...
// Range: 0x802C3F88 -> 0x802C3F90
float zNPCProjectileGrub::GetRadius() {
    // References
    // -> static float GRUB_RADIUS;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D667F8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D667FF
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1288zNPCProjectileGrub_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D6680B
// total size: 0x30
struct xMat3x3 {
    // Members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D66812
// Range: 0x802C449C -> 0x802C4520
// this: r31
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D6681A
struct xVec3 g_NZ3; // size: 0xC, address: 0x80D6D1D4
// Range: 0x802C4520 -> 0x802C49C4
// this: r31
unsigned char zNPCProjectileGrub::Setup(void * configData /* r24 */) {
    // Local variables
    struct GrubConfig * config; // r30
    struct RpAtomic * data; // r27
    struct _zEnv * zen; // r26
...
// Range: 0x802C49C4 -> 0x802C4C7C
// this: r31
void zNPCProjectileGrub::Collide(const struct xVec3 & dpos /* r1+0x10 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$2281zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2240zNPCProjectileGrub_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2241zNPCProjectileGrub_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2242zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2239zNPCProjectileGrub_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2244zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1785zNPCProjectileGrub_cpp */ {
    // Static members
...
// Range: 0x802C4C7C -> 0x802C4E6C
// this: r31
void zNPCProjectileGrub::Explode(unsigned char inflictDamage /* r1+0x10 */, const struct xEnt * ent /* r30 */) {
    // Local variables
...
// Range: 0x802C4E6C -> 0x802C4F30
// this: r1+0x8
unsigned char zNPCProjectileGrub::LaunchFromEnt(struct xEnt * ent /* r29 */, const struct xVec3 * localOffset /* r1+0xC */, float speed /* r1+0x10 */, struct xEnt * refObj /* r30 */) {
    // Local variables
    struct GrubConfig config; // r1+0x20
    struct xMat4x3 * mat; // r31
    struct xVec3 offset; // r1+0x14
}

// Range: 0x802C4F30 -> 0x802C4F34
void zNPCProjectileGrub::AddStaticTweaks() {}

// total size: 0x38
struct {} zNPCProjectileGrub::__vtable; // size: 0x38, address: 0x805283C8
// total size: 0x0
