/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRaftTrack.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803365EC -> 0x80336C3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67B38
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$901zRaftTrack_cpp */ {
    // Members
...
union /* @class$1040zRaftTrack_cpp */ {
...
// total size: 0xC
struct /* @class$1039zRaftTrack_cpp */ {
    // Members
...
// Range: 0x803365EC -> 0x80336918
// this: r31
void zRaftTrack::load(const struct asset_type & a /* r17 */) {
    // Local variables
    struct xBase * obj; // r30
    struct xGroup * group; // r21
    unsigned int i; // r23
    unsigned int end; // r19
    struct xBase * entry; // r25
    struct xEnt * raftTrackEnt; // r29
    struct xEnt * raftTrackEnt; // r28
    struct xGroup * group; // r20
    unsigned int i; // r22
    unsigned int end; // r18
    struct xBase * entry; // r24
    struct xEnt * raftTrackEnt; // r27
    struct xEnt * raftTrackEnt; // r26

    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67B3D
// Range: 0x80336918 -> 0x80336AC4
void zRaftTrack::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x80336AC4 -> 0x80336AEC
// this: r1+0x8
void zRaftTrack::debugInit() {}

// Range: 0x80336AEC -> 0x80336C3C
// this: r30
void zRaftTrack::addTweaks() {
    // Local variables
    char prefix[128]; // r1+0x188
...
// total size: 0xC
struct /* @class$742zRaftTrack_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$743zRaftTrack_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$744zRaftTrack_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$745zRaftTrack_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$746zRaftTrack_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$747zRaftTrack_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$748zRaftTrack_cpp */ {
    // Members
