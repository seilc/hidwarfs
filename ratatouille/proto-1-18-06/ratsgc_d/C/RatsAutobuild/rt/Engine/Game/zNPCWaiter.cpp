/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCWaiter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80313E28 -> 0x80313FF4
*/
// total size: 0x1
...
static class zICompNPCEntityParams gWaiterEntParameters; // size: 0x30, address: 0x80D33A90
char __FUNCTION__$localstatic1$AttachComponent__58zComponentPool<16zCompLogicWaiter,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67618
signed char zComponentPool<zCompLogicWaiter, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B900
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicWaiter, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B904
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x80313EC8 -> 0x80313EF0
// this: r1+0x8
void zNPCWaiter::Deactivate() {}

// Range: 0x80313EF0 -> 0x80313FB4
// this: r30
void zNPCWaiter::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$959zNPCWaiter_cpp */ {
    // Members
...
union /* @class$1099zNPCWaiter_cpp */ {
...
// total size: 0xC
struct /* @class$1097zNPCWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$900zNPCWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$901zNPCWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$902zNPCWaiter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$903zNPCWaiter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$904zNPCWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$905zNPCWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$906zNPCWaiter_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCWaiter::__vtable; // size: 0x3C, address: 0x8052D058
// total size: 0xC
struct RwV3d {
    // Members
