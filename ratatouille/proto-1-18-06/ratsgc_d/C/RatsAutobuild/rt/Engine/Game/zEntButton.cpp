/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEntButton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8014E848 -> 0x8014F9B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sRedMultiplier; // size: 0x4, address: 0x80D626E0
static float sGreenMultiplier; // size: 0x4, address: 0x80D626E4
static float sBlueMultiplier; // size: 0x4, address: 0x80D626E8
// Range: 0x8014E848 -> 0x8014E878
void zEntButton_Init(void * ent /* r1+0x8 */, void * asset /* r1+0xC */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D626EC
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$889zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1053zEntButton_cpp */ {
    // Members
...
struct zEntButtonAsset {
    ...
    int initButtonState; // offset 0x8, size 0x4
    int isReset; // offset 0xC, size 0x4
...
// total size: 0x210
struct _zEntButton : public zEnt {
    // Members
    struct zEntButtonAsset * basset; // offset 0xDC, size 0x4
    struct xEntMotion motion; // offset 0xE0, size 0x100
    unsigned int state; // offset 0x1E0, size 0x4
    float speed; // offset 0x1E4, size 0x4
    unsigned int oldState; // offset 0x1E8, size 0x4
    int oldMotState; // offset 0x1EC, size 0x4
    float counter; // offset 0x1F0, size 0x4
    struct xModelInstance * modelPressed; // offset 0x1F4, size 0x4
    float holdTimer; // offset 0x1F8, size 0x4
    unsigned int hold; // offset 0x1FC, size 0x4
    float topHeight; // offset 0x200, size 0x4
};
// Range: 0x8014E878 -> 0x8014EB2C
void zEntButton_Init(struct _zEntButton * ent /* r31 */, struct xEntAsset * asset /* r30 */) {
    // Local variables
    struct zEntButtonAsset * passet; // r29
    struct xEntMotionAsset * emasset; // r28
...
static unsigned char already_asserted; // size: 0x1, address: 0x80D6A020
static signed char init; // size: 0x1, address: 0x80D6A021
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D626FC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8014EB2C -> 0x8014EC54
void zEntButton_Move(struct _zEntButton * ent /* r31 */, struct xScene * s /* r1+0x8 */, float dt /* r1+0xC */, struct xEntFrame * frame /* r1+0x10 */) {
    // Local variables
...
// Range: 0x8014EC54 -> 0x8014EC90
void zEntButton_Setup(struct _zEntButton * ent /* r31 */, struct xScene * sc /* r1+0x8 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6270C
// total size: 0x0
...
// Range: 0x8014EC90 -> 0x8014EDD0
void zEntButton_Save(struct _zEntButton * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80D6271C
// Range: 0x8014EDD0 -> 0x8014EF10
void zEntButton_Load(struct _zEntButton * ent /* r31 */, struct xSerial * s /* r30 */) {
    // Local variables
    int pressed; // r1+0xC
    int pushing; // r1+0x8
...
// Range: 0x8014EF10 -> 0x8014EFD8
void zEntButton_Reset(struct _zEntButton * ent /* r31 */, struct xScene * sc /* r1+0x8 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D6272C
// Range: 0x8014EFD8 -> 0x8014F2E4
void zEntButton_Update(struct _zEntButton * ent /* r31 */, struct xScene * sc /* r1+0x8 */, float dt /* f31 */) {
    // References
...
// Range: 0x8014F2E4 -> 0x8014F388
void zEntButton_Render(struct _zEntButton * ent /* r31 */) {
    // Local variables
    struct xModelInstance * model; // r30

    // References
    // -> static float sBlueMultiplier;
    // -> static float sGreenMultiplier;
    // -> static float sRedMultiplier;
}

// Range: 0x8014F388 -> 0x8014F3A0
void zEntButton_SetReady(struct _zEntButton * ent /* r3 */) {}

// Range: 0x8014F3A0 -> 0x8014F3C0
static void zEntButton_Press(struct _zEntButton * ent /* r3 */) {}

// Range: 0x8014F3C0 -> 0x8014F41C
static void _PressButtonSound(struct _zEntButton * ent /* r31 */) {}

// Range: 0x8014F41C -> 0x8014F484
void zEntButton_Press(struct _zEntButton * ent /* r31 */, unsigned int mask /* r30 */) {}
...
// total size: 0x10
struct /* @class$1699zEntButton_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8014F484 -> 0x8014F5A0
void zEntButton_Hold(struct _zEntButton * ent /* r31 */, unsigned int mask /* r28 */) {
    // Local variables
    struct xVec3 * player; // r29
    struct xBound * bound; // r30
    struct xVec3 lv; // r1+0x8
...
// total size: 0x890
struct /* @class$1942zEntButton_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$830zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832zEntButton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833zEntButton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zEntButton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zEntButton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zEntButton_cpp */ {
    // Members
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80D6273E
// total size: 0x1C
...
// Range: 0x8014F5A0 -> 0x8014F9B0
void zEntButtonEventCB(struct xBase * to /* r26 */, unsigned int toEvent /* r27 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r28 */) {
    // Local variables
    struct _zEntButton * s; // r31
