/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zTimer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C4084 -> 0x801C429C
*/
// Range: 0x801C4084 -> 0x801C40B4
void zTimerDebugModeCB() {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80521BA8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801C40B4 -> 0x801C429C
static struct xBase * zTimeDebugModeIteratorCB(struct xBase * b /* r30 */, struct zScene * s /* r1+0x8 */) {
    // Local variables
    struct xTimer * t; // r31
