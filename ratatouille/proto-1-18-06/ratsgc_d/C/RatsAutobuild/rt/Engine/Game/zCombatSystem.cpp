/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCombatSystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802D18C8 -> 0x802D1B8C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$901zCombatSystem_cpp */ {
    // Members
...
union /* @class$1040zCombatSystem_cpp */ {
...
// total size: 0xC
struct /* @class$1039zCombatSystem_cpp */ {
    // Members
...
static struct xEnt * combatList[96]; // size: 0x180, address: 0x80D2D3A0
static unsigned int currentCombat; // size: 0x4, address: 0x80D6B688
// Range: 0x802D18C8 -> 0x802D18E8
...
// total size: 0x10
struct /* @class$1313zCombatSystem_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802D18E8 -> 0x802D1904
void zCombatSystemReset() {
    // References
    // -> struct zGlobals globals;
    // -> static unsigned int currentCombat;
}

// Range: 0x802D1904 -> 0x802D1910
...
// Range: 0x802D1910 -> 0x802D19A8
void zCombatSystemUpdate(float dt /* r1+0x8 */) {
    // Local variables
    unsigned int i; // r31
    struct xEnt * ent; // r30
    ...
    // References
    // -> static unsigned int currentCombat;
    // -> static struct xEnt * combatList[96];
    // -> struct zGlobals globals;
}

// Range: 0x802D19A8 -> 0x802D1A24
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80528AB8
// Range: 0x802D1A24 -> 0x802D1B8C
void zCombatSystemUpdateEntity(struct xEnt * ent /* r31 */, float dt /* r1+0x8 */) {
    // Local variables
