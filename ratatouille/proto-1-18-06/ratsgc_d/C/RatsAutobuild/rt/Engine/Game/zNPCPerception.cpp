/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCPerception.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802640B8 -> 0x8026540C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802640B8 -> 0x802640DC
static void CLAMP021(float min /* f1 */, float * test /* r3 */, float max /* f2 */) {}

// total size: 0xC
struct {} zNPCPerceptionTarget::__vtable; // size: 0xC, address: 0x80D6568C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$892zNPCPerception_cpp */ {
    // Members
...
union /* @class$1031zNPCPerception_cpp */ {
...
// total size: 0xC
struct /* @class$1030zNPCPerception_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2090zNPCPerception_cpp */ {
    // Members
...
class zNPCPerceptionTarget {
    ...
    void SetEnt(struct xEnt * inEnt);

    float GetPriority();

    void AddToPriority(float addPriority, float importance);

    void CalculateDistance(class zNPCCommon * owner);

    float GetDistance();

    void UpdatePriorityHealth(float importance);

    void UpdatePriorityDistance(class zNPCCommon * owner, float importance);

    void UpdatePriorityFacing(class zNPCCommon * owner, float importance);

    void UpdatePriorityEquallyDivide(float importance);

    void UpdatePriorityDamagedBy(float importance);

    void UpdatePriorityWidget(float importance);

    void UpdatePriorityInaction(float importance);

    void UpdatePriority(class zNPCCommon * owner);

    void UpdateBasics(float seconds);
...
// Range: 0x802640DC -> 0x80264108
// this: r3
zNPCPerceptionTarget::zNPCPerceptionTarget() {
    // References
    // -> struct [anonymous] zNPCPerceptionTarget::__vtable;
}

// Range: 0x80264108 -> 0x8026412C
// this: r3
void zNPCPerceptionTarget::Reset() {}

// Range: 0x8026412C -> 0x80264138
// this: r3
void zNPCPerceptionTarget::DamagedBy() {}

// Range: 0x80264138 -> 0x80264188
// this: r31
zNPCPerceptionTarget::~zNPCPerceptionTarget() {
    // References
    // -> struct [anonymous] zNPCPerceptionTarget::__vtable;
...
// Range: 0x80264188 -> 0x802641E0
// this: r31
void zNPCPerceptionTarget::SetEnt(struct xEnt * inEnt /* r1+0x8 */) {
    // Local variables
    const char * name; // r30
}

// Range: 0x802641E0 -> 0x802641E8
// this: r3
float zNPCPerceptionTarget::GetPriority() {}

// Range: 0x802641E8 -> 0x802641F8
// this: r3
void zNPCPerceptionTarget::AddToPriority(float addPriority /* f1 */, float importance /* f2 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D65668
// Range: 0x802641F8 -> 0x80264394
// this: r31
void zNPCPerceptionTarget::CalculateDistance(class zNPCCommon * owner /* r1+0x8 */) {
    // Local variables
    struct xVec3 * targetPos; // r30
    struct xVec3 * ourPos; // r29
...
// Range: 0x80264394 -> 0x8026439C
// this: r3
float zNPCPerceptionTarget::GetDistance() {}

// Range: 0x8026439C -> 0x8026444C
// this: r31
void zNPCPerceptionTarget::UpdatePriorityHealth(float importance /* r1+0x8 */) {
    // Local variables
    float hpPriority; // r1+0xC
    struct zCommonPlayer * player; // r30
}

// Range: 0x8026444C -> 0x80264518
// this: r31
void zNPCPerceptionTarget::UpdatePriorityDistance(class zNPCCommon * owner /* r1+0x8 */, float importance /* r1+0xC */) {
    // Local variables
    float distPriority; // f30
    float maxRange; // f31
    float tempPriority; // r1+0x10
}

// Range: 0x80264518 -> 0x802645E0
// this: r31
void zNPCPerceptionTarget::UpdatePriorityFacing(class zNPCCommon * owner /* r27 */, float importance /* r1+0x8 */) {
    // Local variables
    struct xVec3 * ownerDir; // r30
    struct xVec3 * targetPos; // r29
    struct xVec3 * ownerPos; // r28
    struct xVec3 toTargetDir; // r1+0x10
    float facingPriority; // r1+0xC
}

// Range: 0x802645E0 -> 0x802645E4
void zNPCPerceptionTarget::UpdatePriorityLineOfSight() {}
...
// Range: 0x802645E4 -> 0x802646FC
// this: r28
void zNPCPerceptionTarget::UpdatePriorityEquallyDivide(float importance /* r1+0x8 */) {
    // Local variables
    int playerSize; // r27
    int ourTotal; // r30
    int otherTotal; // r29
...
// Range: 0x802646FC -> 0x80264700
void zNPCPerceptionTarget::UpdatePriorityAttackVulnerabilities() {}

// Range: 0x80264700 -> 0x80264704
void zNPCPerceptionTarget::UpdatePriorityDefenseVulnerabilities() {}

// Range: 0x80264704 -> 0x80264768
// this: r31
void zNPCPerceptionTarget::UpdatePriorityDamagedBy(float importance /* r1+0x8 */) {
    // Local variables
    float damagedByPriority; // f31
}

// Range: 0x80264768 -> 0x802647D8
// this: r31
void zNPCPerceptionTarget::UpdatePriorityWidget(float importance /* r1+0x8 */) {
    // Local variables
    float widgetPriority; // f31
}
...
// Range: 0x802647D8 -> 0x80264890
// this: r31
void zNPCPerceptionTarget::UpdatePriorityInaction(float importance /* r1+0x8 */) {
    // Local variables
    float inactionPriority; // r1+0xC
    class zPlayerInput playerInput; // r1+0x10
}
...
// total size: 0x890
struct /* @class$1785zNPCPerception_cpp */ {
    // Static members
...
// Range: 0x80264890 -> 0x80264964
// this: r31
void zNPCPerceptionTarget::UpdatePriority(class zNPCCommon * owner /* r30 */) {}

// Range: 0x80264964 -> 0x8026499C
// this: r3
void zNPCPerceptionTarget::UpdateBasics(float seconds /* f1 */) {}

// total size: 0x24
struct {} zNPCPerception::__vtable; // size: 0x24, address: 0x80524380
// total size: 0x270
class zNPCPerception {
    ...
    void Reset(class zNPCCommon * npc);

    void UpdateBasics(float seconds);

    void DamagedBy(struct xEnt * damagedByEnt);

    void ForceCompleteUpdate();

    unsigned char CanWeDoCompleteUpdate(float seconds);

    void ResetCompleteUpdateTimers();

    void UpdateCompleteDoWork();

    void UpdateComplete(float seconds, unsigned char force);

    struct xEnt * GetPriorityTarget();

    unsigned char IsPriorityTargetAPlayer();

    struct xVec3 * GetPriorityTargetPos();

    float GetPriorityTargetDistance();
...
// Range: 0x8026499C -> 0x80264A04
// this: r31
zNPCPerception::zNPCPerception() {
    // References
    // -> struct [anonymous] zNPCPerception::__vtable;
}

// Range: 0x80264A04 -> 0x80264A70
// this: r31
zNPCPerception::~zNPCPerception() {
    // References
    // -> struct [anonymous] zNPCPerception::__vtable;
...
// Range: 0x80264A70 -> 0x80264AD8
// this: r30
void zNPCPerception::Reset(class zNPCCommon * npc /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80264AD8 -> 0x80264B38
// this: r30
void zNPCPerception::UpdateBasics(float seconds /* r1+0x8 */) {
    // Local variables
    int i; // r31
}

// Range: 0x80264B38 -> 0x80264C08
// this: r31
void zNPCPerception::DamagedBy(struct xEnt * damagedByEnt /* r29 */) {
    // Local variables
    int i; // r30
}

int completeUpdateCount; // size: 0x4, address: 0x80D6B1F8
// Range: 0x80264C08 -> 0x80264C14
void zNPCPerception::ResetCompleteUpdateCount() {
    // References
    // -> int completeUpdateCount;
}

// Range: 0x80264C14 -> 0x80264C20
// this: r3
void zNPCPerception::ForceCompleteUpdate() {}

// Range: 0x80264C20 -> 0x80264C98
// this: r3
unsigned char zNPCPerception::CanWeDoCompleteUpdate(float seconds /* f1 */) {
    // References
    // -> int completeUpdateCount;
}

// Range: 0x80264C98 -> 0x80264D90
// this: r31
void zNPCPerception::ResetCompleteUpdateTimers() {
    // Local variables
    float dist2Target; // f31
    int i; // r30
    float tempDist; // f30
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80524368
// Range: 0x80264D90 -> 0x802651A8
// this: r31
void zNPCPerception::UpdateCompleteDoWork() {
    // Local variables
    class zNPCPerceptionTarget oldTarget[4]; // r1+0x9C
    int oldTotalTargets; // r26
    int size; // r23
    int i; // r25
    int a; // r28
    struct xEnt * tempWidgetTarget; // r24
    int a; // r27
    int a; // r30
    int b; // r29
    class zNPCPerceptionTarget tmp; // r1+0x8
...
// Range: 0x802651F8 -> 0x80265264
// this: r31
void zNPCPerception::UpdateComplete(float seconds /* f31 */, unsigned char force /* r1+0x8 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D6567A
// Range: 0x80265264 -> 0x80265310
// this: r30
struct xEnt * zNPCPerception::GetPriorityTarget() {
    // Local variables
    struct xEnt * ent; // r31
...
// Range: 0x80265310 -> 0x8026536C
// this: r1+0x8
unsigned char zNPCPerception::IsPriorityTargetAPlayer() {
    // Local variables
    struct xEnt * ent; // r31
}

// Range: 0x8026536C -> 0x802653C8
// this: r1+0x8
struct xVec3 * zNPCPerception::GetPriorityTargetPos() {
    // Local variables
    struct xEnt * ent; // r31
    struct xVec3 * targetPos; // r30
}

// Range: 0x802653C8 -> 0x8026540C
// this: r31
float zNPCPerception::GetPriorityTargetDistance() {}

// total size: 0x4
struct /* @class$2021zNPCPerception_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2022zNPCPerception_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2023zNPCPerception_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2020zNPCPerception_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2025zNPCPerception_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1307zNPCPerception_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$833zNPCPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$834zNPCPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$835zNPCPerception_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$836zNPCPerception_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$837zNPCPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$838zNPCPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$839zNPCPerception_cpp */ {
    // Members
