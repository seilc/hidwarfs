/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerConstrainer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80265954 -> 0x8026647C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float sDefaultNearWall; // size: 0x4, address: 0x80D656B0
float sDefaultFarWall; // size: 0x4, address: 0x80D656B4
float sNearWall; // size: 0x4, address: 0x80D6B200
float sFarWall; // size: 0x4, address: 0x80D6B204
unsigned char sEnabled; // size: 0x1, address: 0x80D656B8
unsigned char sDebugRender; // size: 0x1, address: 0x80D6B208
unsigned char sPlayerDisable; // size: 0x1, address: 0x80D6B209
unsigned char sCameraDisable; // size: 0x1, address: 0x80D6B20A
unsigned int sDrawnFrame; // size: 0x4, address: 0x80D6B20C
float cPlayerRadius; // size: 0x4, address: 0x80D656BC
float cCamMotionMarginAngle; // size: 0x4, address: 0x80D656C0
float cPlayerMotionMarginAngle; // size: 0x4, address: 0x80D656C4
// total size: 0x1
...
// Range: 0x80265954 -> 0x80265970
// this: r3
zPlayerConstrainer::zPlayerConstrainer() {
    // References
    // -> unsigned int sDrawnFrame;
    // -> unsigned char sDebugRender;
    // -> unsigned char sEnabled;
}

// Range: 0x80265970 -> 0x8026597C
void zPlayerConstrainer::SetConstraints(float nearWall /* f1 */, float farWall /* f2 */) {
    // References
    // -> float sFarWall;
    // -> float sNearWall;
}

// Range: 0x8026597C -> 0x80265990
void zPlayerConstrainer::GetDefaults(float & nearWall /* r3 */, float & farWall /* r4 */) {
    // References
    // -> float sDefaultFarWall;
    // -> float sDefaultNearWall;
}
...
// Range: 0x80265990 -> 0x80265A50
static void DrawPlane(const struct xVec3 & normal /* r30 */, const struct xMat4x3 & viewMat /* r31 */, float offset /* r1+0x8 */, float width /* r1+0xC */, float height /* f31 */) {
    // Local variables
    struct xVec3 forward; // r1+0x28
    struct xVec3 c1; // r1+0x1C
    struct xVec3 c2; // r1+0x10
}

// Range: 0x80265A50 -> 0x80265AC0
static void DrawFrustrumPlanes(struct xVec3 & nLeft /* r1+0x8 */, struct xVec3 & nRight /* r1+0xC */, const struct xMat4x3 & viewMat /* r31 */, float offset /* f31 */) {}
...
// total size: 0x10
struct PlayerPlaneInfo {
    // Members
    struct xVec3 nPlane; // offset 0x0, size 0xC
    float newDistToPlane; // offset 0xC, size 0x4
};
// Range: 0x80265AC0 -> 0x80265B2C
static void FrustrumSideNormals(struct xVec3 & nLeft /* r30 */, struct xVec3 & nRight /* r1+0x8 */, const struct xMat4x3 & viewMat /* r31 */, float fov /* r1+0xC */) {}

// Range: 0x80265B2C -> 0x80265B94
static void ReflectVector(struct xVec3 & o /* r29 */, const struct xVec3 & v /* r30 */, const struct xVec3 & unitAxis /* r31 */) {}

// Range: 0x80265B94 -> 0x80265BB0
static float DotXZ(const struct xVec3 & a /* r3 */, const struct xVec3 & b /* r4 */) {}

// Range: 0x80265BB0 -> 0x80265C5C
void zPlayerConstrainer::FarWallCollisionResponse(const struct SphereCollisionResults & scene_collide /* r29 */, struct xVec3 & response_dpos /* r30 */) {
    // Local variables
    const struct xMat4x3 & camMat; // r31
    struct xVec3 toDesired; // r1+0x14
    struct xVec3 toContact; // r1+0x8
    float contactDistance; // f31

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80265C5C -> 0x80265C98
static void myDrawArrow(const struct xVec3 * origin /* r1+0x8 */, const struct xVec3 * dir /* r1+0xC */, float length /* r1+0x10 */) {}
...
// Range: 0x80265C98 -> 0x80265D60
unsigned char OOBExtent::CalcDepen(float & sideMargin /* r31 */, const struct xMat4x3 & camMat /* r1+0x8 */, const struct xVec3 & toTarget /* r1+0xC */, const struct xVec3 & nPlane /* r30 */, unsigned int calcFlags /* r1+0x10 */) {
    // Local variables
    float perpDistance; // f30
    float margin; // f31
...
// total size: 0x10
struct /* @class$1671zPlayerConstrainer_cpp */ {
    // Members
...
// Range: 0x80265D60 -> 0x80265ED8
unsigned int zPlayerConstrainer::PlayersOOB(struct OOBExtent & extent /* r31 */, const struct xCam & cam /* r28 */, const struct xVec3 & depenAxis /* r1+0x8 */, unsigned int calcFlags /* r1+0xC */) {
    // Local variables
    unsigned int flags; // r30
    int i; // r29
    struct OOBExtent localExtent; // r1+0x10

    // References
    // -> struct xGlobals * xglobals;
    // -> float cCamMotionMarginAngle;
}
...
// total size: 0x4
struct /* @class$900zPlayerConstrainer_cpp */ {
    // Members
...
union /* @class$646zPlayerConstrainer_cpp */ {
...
// total size: 0xC
struct /* @class$1056zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1914zPlayerConstrainer_cpp */ {
    // Static members
...
static unsigned int drawnFrame; // size: 0x4, address: 0x80D6B210
static signed char init; // size: 0x1, address: 0x80D6B214
static unsigned int drawnFrame; // size: 0x4, address: 0x80D6B218
static signed char init; // size: 0x1, address: 0x80D6B21C
unsigned int gFrameCount; // size: 0x4, address: 0x80D68CE8
// Range: 0x80265ED8 -> 0x80266250
unsigned int zPlayerConstrainer::PositionOOB(struct OOBExtent & extent /* r30 */, const struct xMat4x3 & camMat /* r31 */, float fov /* f27 */, const struct xVec3 & position /* r28 */, unsigned int calcFlags /* r27 */) {
    // Local variables
    struct xVec3 to; // r1+0x44
    unsigned int flags; // r29
    struct xVec3 atNormalizedXZ; // r1+0x38
    float adjustedFarWall; // f31
    float dist2; // f30
    float perpDistance; // f29
    struct xVec3 nLeftPlane; // r1+0x2C
    struct xVec3 nRightPlane; // r1+0x20
    struct xVec3 left; // r1+0x14
    struct xVec3 right; // r1+0x8

    // References
    // -> unsigned int gFrameCount;
    // -> static unsigned int drawnFrame;
...
// total size: 0xC
struct /* @class$841zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$842zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$844zPlayerConstrainer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$845zPlayerConstrainer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$846zPlayerConstrainer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$847zPlayerConstrainer_cpp */ {
    // Members
...
// Range: 0x80266250 -> 0x8026647C
void zPlayerConstrainer::SetupTweaks(const char * prefix /* r31 */) {
    // Local variables
    ...
    // -> float cPlayerMotionMarginAngle;
    // -> float cCamMotionMarginAngle;
    // -> float cPlayerRadius;
    // -> unsigned char sCameraDisable;
    // -> unsigned char sPlayerDisable;
    // -> unsigned char sDebugRender;
    // -> float sDefaultFarWall;
    // -> float sDefaultNearWall;
}
