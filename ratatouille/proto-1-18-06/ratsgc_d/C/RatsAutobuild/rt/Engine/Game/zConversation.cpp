/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zConversation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80287384 -> 0x802880FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float dampValue; // size: 0x4, address: 0x80D65C80
static float dampFadeInVel; // size: 0x4, address: 0x80D6B360
static float dampFadeOutVel; // size: 0x4, address: 0x80D6B364
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80287384 -> 0x802873D4
static void EventHandlerWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}
...
enum zConversationManagerState {
    eConversationNone = 0,
    eConversationFadeIn = 1,
    eConversationPlaying = 2,
    eConversationFadeOut = 3,
    eConversationDone = 4,
};
// total size: 0x3C
class zConversationManager : public zLightweightSystemBase {
    // Functions
    static float GetJaw(enum xJawSpeaker speaker);
    ...
    static unsigned char IsConversing();

    static void Play(class zConversation * conversation, const struct xBase * otherSpeakerBase);

    static unsigned char Play(enum iSndGroupHandle groupHandle, const struct xBase * otherSpeakerBase, class zConversation * conversation);

    static void UpdateConversation();

    static void Update(float dt);

    static void Stop(class zConversation * conversation);

    // Members
protected:
    unsigned char asserted; // offset 0x4, size 0x1
    unsigned int badSoundID; // offset 0x8, size 0x4
    const struct xBase * queuedOtherSpeaker; // offset 0xC, size 0x4
    class zConversation * queuedConversation; // offset 0x10, size 0x4
    class zConversation * currentConversation; // offset 0x14, size 0x4
    class xJawData * currentJawData; // offset 0x18, size 0x4
    enum xSndHandle soundHandle; // offset 0x1C, size 0x4
    struct xVec3 * currentVoicePosition; // offset 0x20, size 0x4
    const struct xBase * otherSpeaker; // offset 0x24, size 0x4
    float jawValue; // offset 0x28, size 0x4
    float conversationTime; // offset 0x2C, size 0x4
    enum xJawSpeaker currentSpeaker; // offset 0x30, size 0x4
    enum zConversationManagerState state; // offset 0x34, size 0x4
    float curVolumeDamp; // offset 0x38, size 0x4
};
static class zConversationManager manager; // size: 0x3C, address: 0x80D26D30
enum xJawSpeaker {
    exJawSpeaker_Remy = 0,
    exJawSpeaker_Count = 1,
};
// Range: 0x802873D4 -> 0x80287420
// this: r3
static float zConversationManager::GetJaw(enum xJawSpeaker speaker /* r4 */) {}

// Range: 0x80287420 -> 0x80287470
// this: r31
static void zConversationManager::Init() {}

// Range: 0x80287470 -> 0x802874BC
// this: r31
static void zConversationManager::Reset() {}

// Range: 0x802874BC -> 0x8028754C
// this: r31
static void zConversationManager::ClearConversation() {}

// Range: 0x8028754C -> 0x80287568
// this: r3
static unsigned char zConversationManager::IsConversing() {}
...
// total size: 0x4
struct /* @class$1179zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1317zConversation_cpp */ {
    // Members
...
union /* @class$1318zConversation_cpp */ {
...
// total size: 0x10
struct /* @class$1566zConversation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80287568 -> 0x80287618
// this: r31
static void zConversationManager::Play(class zConversation * conversation /* r30 */, const struct xBase * otherSpeakerBase /* r29 */) {
    // References
...
// total size: 0x14
struct zConversationAsset : public xDynAsset {
    // Members
    unsigned int soundGroupID; // offset 0x10, size 0x4
};
// total size: 0x18
class zConversation : public xBase {
    // Functions
    zConversation(const struct zConversationAsset & myAsset);

    void HandleEvent(unsigned int toEvent, struct xBase * toParamWidget);

    // Members
protected:
    const struct zConversationAsset & asset; // offset 0x10, size 0x4
    enum iSndGroupHandle soundGroup; // offset 0x14, size 0x4
};
enum iSndGroupHandle {
};
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65C84
...
// total size: 0xC
struct /* @class$1046zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1047zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zConversation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1049zConversation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1050zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1051zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1052zConversation_cpp */ {
    // Members
...
// Range: 0x80287618 -> 0x8028789C
// this: r31
static unsigned char zConversationManager::Play(enum iSndGroupHandle groupHandle /* r29 */, const struct xBase * otherSpeakerBase /* r1+0x8 */, class zConversation * conversation /* r27 */) {
    // Local variables
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D65C89
// Range: 0x8028789C -> 0x80287B2C
// this: r31
static void zConversationManager::UpdateConversation() {
    // References
    // -> struct xGlobals * xglobals;
...
// total size: 0x890
struct /* @class$1828zConversation_cpp */ {
    // Static members
...
// Range: 0x80287B2C -> 0x80287C94
// this: r31
static void zConversationManager::Update(float dt /* f31 */) {
    // References
    // -> static float dampFadeOutVel;
    // -> static float dampValue;
    // -> static float dampFadeInVel;
}

// Range: 0x80287C94 -> 0x80287CD8
// this: r31
static void zConversationManager::Stop(class zConversation * conversation /* r1+0x8 */) {}
...
// Range: 0x80287CD8 -> 0x80287CDC
static void zConversationManager::Exit() {}

// Range: 0x80287CDC -> 0x80287D2C
void zConversationInit() {
    // References
    // -> static float dampValue;
    // -> static class zConversationManager manager;
}
...
// Range: 0x80287D2C -> 0x80287D5C
float zConversationGetJaw(enum xJawSpeaker speaker /* r1+0x8 */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x80287D5C -> 0x80287D84
unsigned char zConversationIsConversing() {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x80287D84 -> 0x80287DC4
void zConversationPlay(enum iSndGroupHandle soundGroup /* r1+0x8 */, const struct xBase * otherSpeakerBase /* r1+0xC */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x80287DC4 -> 0x80287E4C
// this: r31
zConversation::zConversation(const struct zConversationAsset & myAsset /* r30 */) {
    // Local variables
    const struct zConversationAsset * assetPtr; // r29
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65C9C
// Range: 0x80287E4C -> 0x80288014
void zConversation::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D65CA1
// Range: 0x80288014 -> 0x802880FC
// this: r30
void zConversation::HandleEvent(unsigned int toEvent /* r1+0x8 */, struct xBase * toParamWidget /* r31 */) {
    // References
    // -> static class zConversationManager manager;
...
struct {} @unnamed@zConversation_cpp@::zConversationManager::__vtable; // size: 0x24, address: 0x80525220
// total size: 0x4
