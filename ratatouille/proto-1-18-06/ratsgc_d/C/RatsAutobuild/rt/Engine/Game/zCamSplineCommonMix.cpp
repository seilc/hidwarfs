/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCamSplineCommonMix.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B4194 -> 0x802B44BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct {} zCamSplineCommonMix::__vtable; // size: 0xC, address: 0x80D66458
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$902zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zCamSplineCommonMix_cpp */ {
    // Members
...
union /* @class$1041zCamSplineCommonMix_cpp */ {
...
// total size: 0x10
struct /* @class$1346zCamSplineCommonMix_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B41D8 -> 0x802B4210
// this: r31
void zCamSplineCommonMix::SetCurves(class zCameraCurve * curveInfo /* r1+0x8 */) {}
...
// total size: 0xC
struct /* @class$777zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$779zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$780zCamSplineCommonMix_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$781zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$782zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$783zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1933zCamSplineCommonMix_cpp */ {
    // Static members
