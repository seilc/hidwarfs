/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRubbleGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80239D84 -> 0x8023D964
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char displayBounds; // size: 0x1, address: 0x80D6B070
unsigned char displayToPoints; // size: 0x1, address: 0x80D6B071
int numActiveGenerators; // size: 0x4, address: 0x80D6B074
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$943zRubbleGenerator_cpp */ {
    // Members
...
union /* @class$1082zRubbleGenerator_cpp */ {
...
// Range: 0x80239D84 -> 0x80239DB4
unsigned int DestroyCB(struct xEnt * object /* r1+0x8 */) {}

int THROWN_DAMAGE; // size: 0x4, address: 0x80D64E80
float THROWN_DAMAGE_RADIUS; // size: 0x4, address: 0x80D64E84
float MELTING_TIME; // size: 0x4, address: 0x80D64E88
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1913zRubbleGenerator_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80239DB4 -> 0x80239E5C
static unsigned int CollideCB(float & blastRadius /* r31 */, const struct xVec3 * point /* r1+0x8 */, float damageMultiplier /* r1+0xC */, float radiusMultiplier /* r1+0x10 */) {
    // References
    // -> int THROWN_DAMAGE;
    // -> struct xGlobals * xglobals;
    // -> float THROWN_DAMAGE_RADIUS;
}
...
// total size: 0x890
struct /* @class$2174zRubbleGenerator_cpp */ {
    // Static members
...
static int numActiveRubble; // size: 0x4, address: 0x80D6B078
// total size: 0xC
...
// total size: 0x5C
struct zFakeRubbleAsset : public xEntAsset {
    // Members
    struct xSimpleObjAsset simp; // offset 0x50, size 0xC
};
static struct zFakeRubbleAsset fakeAsset; // size: 0x5C, address: 0x80D18840
// total size: 0x58
struct config {
    // Members
...
static struct config landDustConfig; // size: 0x58, address: 0x80D1889C
static class zRubble * rubblePool; // size: 0x4, address: 0x80D6B07C
static unsigned int rubblePoolCount; // size: 0x4, address: 0x80D6B080
static char __FUNCTION__[30]; // size: 0x1E, address: 0x80523E18
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1758zRubbleGenerator_cpp */ {
    // Members
    float emitRemaining; // offset 0x0, size 0x4
};
// total size: 0x148
struct /* @class$1759zRubbleGenerator_cpp */ {
    // Members
    struct zDestructible destructible; // offset 0x0, size 0x7C
    struct zDestructibleState states[3]; // offset 0x7C, size 0xCC
};
enum MotionState {
    MS_INFLIGHT = 0,
    MS_BOUNCING = 1,
...
// total size: 0x304
class zRubble : public zEntSimpleObj {
    // Functions
    unsigned char CalculateSimulationParameters(const struct xVec3 * source, const struct xVec3 * target, float launchAngle, float gravity, float rotations, float totalBouncesDistRatio, unsigned char isSpherical);

    unsigned char TestSimulationParameters(const struct xVec3 * source, const struct xVec3 * target, float minLaunchAngle, float maxLaunchAngle, float gravity, float rotations, float minTotalBouncesDistRatio, float maxTotalBouncesDistRatio);

    void BoundsUpdate(const struct xVec3 & pos);

    void Init(unsigned int index, unsigned int randomModelID);

    void DeallocateDestructible();

    unsigned char DestructibleInit(struct xDestructibleAsset * d_asset);

    unsigned char HitPlayer();

    void Destroy();

    unsigned char Activate(const struct xVec3 & source, const struct xVec3 & target, float launchAngle, float rotations, float totalBouncesDistRatio, const struct ModelData & data, unsigned int modelID, class zRubbleGenerator * par, enum zRubbleLandType landEffect, enum iSndGroupHandle theLandSoundGroup, unsigned char isSpherical);

    void HandleGroundHit(float dt, unsigned int hitNum, unsigned char lastHit);

    void UpdateRubbleModel();

    void SetupMeshCircle();

    void SetSmashMePlease(unsigned char smashMe);
    ...
    // Members
    unsigned char active; // offset 0x108, size 0x1
    unsigned char NPCCollision; // offset 0x109, size 0x1
    class zRubbleGenerator * parent; // offset 0x10C, size 0x4
    enum zRubbleLandType landEffectType; // offset 0x110, size 0x4
    // total size: 0x4
    struct /* @class$1758zRubbleGenerator_cpp */ {
        // Members
        float emitRemaining; // offset 0x0, size 0x4
    } dustEffect; // offset 0x114, size 0x4
    enum iSndGroupHandle landSoundGroup; // offset 0x118, size 0x4
    // total size: 0x148
    struct /* @class$1759zRubbleGenerator_cpp */ {
        // Members
        struct zDestructible destructible; // offset 0x0, size 0x7C
        struct zDestructibleState states[3]; // offset 0x7C, size 0xCC
    } destructData; // offset 0x11C, size 0x148
    enum MotionState motionState; // offset 0x264, size 0x4
    struct xVec3 modelCenterOffset; // offset 0x268, size 0xC
    struct xVec3 source; // offset 0x274, size 0xC
    struct xVec3 target; // offset 0x280, size 0xC
    float time; // offset 0x28C, size 0x4
    float inFlightTime; // offset 0x290, size 0x4
    float totalBounceTime; // offset 0x294, size 0x4
    float oneBounceTimeCoef; // offset 0x298, size 0x4
    float dustVelocity; // offset 0x29C, size 0x4
    float dustSize; // offset 0x2A0, size 0x4
    unsigned int currentBounceNum; // offset 0x2A4, size 0x4
    struct xVec3 mPos; // offset 0x2A8, size 0xC
    struct xVec3 initVelXZ; // offset 0x2B4, size 0xC
    float initVelY; // offset 0x2C0, size 0x4
    float bounceCoef; // offset 0x2C4, size 0x4
    float inAirEndVelY; // offset 0x2C8, size 0x4
    struct xVec3 rotationAxis; // offset 0x2CC, size 0xC
    float rotationalVelocity; // offset 0x2D8, size 0x4
    float rotationalAcceleration; // offset 0x2DC, size 0x4
    float mCurAngle; // offset 0x2E0, size 0x4
    float mInitialAngle; // offset 0x2E4, size 0x4
    unsigned char sphericalRubbleRotation; // offset 0x2E8, size 0x1
    float timeToDestroy; // offset 0x2EC, size 0x4
    unsigned char pickedup; // offset 0x2F0, size 0x1
    class zMeshCircle * circle; // offset 0x2F4, size 0x4
    struct xModelInstance * allocModel; // offset 0x2F8, size 0x4
    unsigned char linearSolution; // offset 0x2FC, size 0x1
    unsigned char melting; // offset 0x2FD, size 0x1
    float meltingTime; // offset 0x300, size 0x4
};
// Range: 0x80239E5C -> 0x8023A784
// this: r31
unsigned char zRubble::CalculateSimulationParameters(const struct xVec3 * source /* r29 */, const struct xVec3 * target /* r30 */, float launchAngle /* r1+0x8 */, float gravity /* f31 */, float rotations /* r1+0xC */, float totalBouncesDistRatio /* r1+0x10 */, unsigned char isSpherical /* r1+0x14 */) {
    // Local variables
    float simHeight; // f28
    float dx; // r1+0x2C
    float dz; // r1+0x28
    float totalSimDistance; // f24
    float simDistance1; // f23
    float simDistance0; // f26
    float launchAngleRad; // f22
    float sinLaunchAngle; // r1+0x24
    float cosLaunchAngle; // f30
    float tanLaunchAngle; // r1+0x20
    float launchAngleCheck; // f21
    float initVelocity; // f20
    float hMax; // f19
    float V0x; // f18
    float energyLeftForBounces; // f27
    float V0Endy; // f29
    float c; // f25
    float ang; // r1+0x1C
    float totalRotations; // r1+0x18
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80523E36
// Range: 0x8023A784 -> 0x8023AAD0
// this: r28
unsigned char zRubble::TestSimulationParameters(const struct xVec3 * source /* r30 */, const struct xVec3 * target /* r31 */, float minLaunchAngle /* f26 */, float maxLaunchAngle /* f27 */, float gravity /* f28 */, float rotations /* f29 */, float minTotalBouncesDistRatio /* f30 */, float maxTotalBouncesDistRatio /* f31 */) {
    // Local variables
...
// Range: 0x8023AAD0 -> 0x8023ABB8
void EventHandler(struct xBase * from /* r1+0x8 */, struct xBase * to /* r29 */, unsigned int toEvent /* r30 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {
    // Local variables
    class zRubble * rubble; // r31
}

// total size: 0x54
struct zRubbleGeneratorAsset : public xDynAsset {
    // Members
    unsigned int flags; // offset 0x10, size 0x4
    unsigned int spawnFrom; // offset 0x14, size 0x4
    unsigned int spawnTo; // offset 0x18, size 0x4
    unsigned int modelCount; // offset 0x1C, size 0x4
    unsigned int modelOffset; // offset 0x20, size 0x4
    float spawnRate; // offset 0x24, size 0x4
    unsigned int spawnLimit; // offset 0x28, size 0x4
    float minLaunchAngle; // offset 0x2C, size 0x4
    float maxLaunchAngle; // offset 0x30, size 0x4
    float minBouncesDistRatio; // offset 0x34, size 0x4
    float maxBouncesDistRatio; // offset 0x38, size 0x4
    float minRotations; // offset 0x3C, size 0x4
    float maxRotations; // offset 0x40, size 0x4
    enum zRubbleLandType landEffectType; // offset 0x44, size 0x4
    unsigned int repeatType; // offset 0x48, size 0x4
    union { // inferred
        unsigned int launchSoundGroupId; // offset 0x4C, size 0x4
        enum iSndGroupHandle launchSoundGroup; // offset 0x4C, size 0x4
    };
    union { // inferred
        unsigned int landSoundGroupId; // offset 0x50, size 0x4
        enum iSndGroupHandle landSoundGroup; // offset 0x50, size 0x4
    };
};
// total size: 0xC
struct ModelData {
    // Members
    struct RpAtomic * file; // offset 0x0, size 0x4
    struct xModelBucket * * bucket; // offset 0x4, size 0x4
    struct xDestructibleAsset * destructibleAsset; // offset 0x8, size 0x4
};
// total size: 0x44
class zRubbleGenerator : public xBase {
    // Functions
    zRubbleGenerator(struct zRubbleGeneratorAsset * asset);

    void Update(float dt);

    void HandleEvent(unsigned int toEvent);

    void Reset();

    void Spawn();

    void Spawn(const struct zRubbleMarker & from);

    void SignalDeactivated(void * object);

    unsigned int GetFirstModel() const;

    unsigned char CheckSpawnStatus(struct RpAtomic * file, unsigned int which) const;

    void DebugRender();

    // Members
    const struct zRubbleGeneratorAsset * asset; // offset 0x10, size 0x4
    struct ModelData * models; // offset 0x14, size 0x4
    unsigned int spawnFromCount; // offset 0x18, size 0x4
    struct zRubbleMarker * spawnFrom; // offset 0x1C, size 0x4
    unsigned int spawnToCount; // offset 0x20, size 0x4
    struct zRubbleMarker * spawnTo; // offset 0x24, size 0x4
    void * spawnToOccupied; // offset 0x28, size 0x4
    float nextSpawnTime; // offset 0x2C, size 0x4
    int spawnCount; // offset 0x30, size 0x4
    unsigned char on; // offset 0x34, size 0x1
    unsigned char frozenObjectFountain; // offset 0x35, size 0x1
    unsigned char hitByFreezeRay; // offset 0x36, size 0x1
    float timeToFreeze; // offset 0x38, size 0x4
    unsigned char initialGeneration; // offset 0x3C, size 0x1
    unsigned char modelUsedSetBits; // offset 0x3D, size 0x1
    unsigned int modelUsedMask; // offset 0x40, size 0x4
};
// Range: 0x8023ABB8 -> 0x8023ABE8
void zRubble::StaticBoundsUpdate(struct xEnt * ent /* r1+0x8 */, struct xVec3 * pos /* r1+0xC */) {}

// Range: 0x8023ABE8 -> 0x8023AC2C
// this: r31
void zRubble::BoundsUpdate(const struct xVec3 & pos /* r1+0x8 */) {}

static unsigned char done; // size: 0x1, address: 0x80D6B084
static signed char init; // size: 0x1, address: 0x80D6B085
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64E8C
int xModelInstStaticAlloc; // size: 0x4, address: 0x80D692FC
// Range: 0x8023AC2C -> 0x8023AEFC
// this: r31
void zRubble::Init(unsigned int index /* r1+0x18 */, unsigned int randomModelID /* r30 */) {
    // Local variables
    char indexStr[32]; // r1+0x1C
    ...
    // -> static struct zFakeRubbleAsset fakeAsset;
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80523E4F
// Range: 0x8023AEFC -> 0x8023AFFC
// this: r31
void zRubble::DeallocateDestructible() {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D64E91
// Range: 0x8023AFFC -> 0x8023B3AC
// this: r31
unsigned char zRubble::DestructibleInit(struct xDestructibleAsset * d_asset /* r28 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r30
    unsigned char modelAllocFailed; // r25
    unsigned int i; // r29
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r27
    unsigned int modelID; // r26
    struct RpAtomic * imodel; // r24
    void * tmp_ptr; // r23
...
// Range: 0x8023B3AC -> 0x8023B408
// this: r31
unsigned char zRubble::HitPlayer() {}

// Range: 0x8023B408 -> 0x8023B444
// this: r1+0x8
void zRubble::Destroy() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D64EA2
// total size: 0x1C
...
enum zRubbleLandType {
    ezRubbleLandType_None = 0,
    ezRubbleLandType_Dust = 1,
    ezRubbleLandType_ForceSize = 2147483647,
};
enum iSndGroupHandle {
};
// Range: 0x8023B444 -> 0x8023B760
// this: r31
unsigned char zRubble::Activate(const struct xVec3 & source /* r1+0x8 */, const struct xVec3 & target /* r1+0xC */, float launchAngle /* r1+0x10 */, float rotations /* r1+0x14 */, float totalBouncesDistRatio /* r1+0x18 */, const struct ModelData & data /* r30 */, unsigned int modelID /* r26 */, class zRubbleGenerator * par /* r1+0x1C */, enum zRubbleLandType landEffect /* r1+0x20 */, enum iSndGroupHandle theLandSoundGroup /* r1+0x24 */, unsigned char isSpherical /* r1+0x4B */) {
    // Local variables
    struct _zEnv * zen; // r28
    struct xEnvAsset * easset; // r29
    struct xLightKit * objLightKit; // r27

    // References
    // -> static int numActiveRubble;
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D64EAB
struct xVec3 m_Null; // size: 0xC, address: 0x80D6D920
enum xSndHandle {
};
// Range: 0x8023B760 -> 0x8023B96C
// this: r31
void zRubble::HandleGroundHit(float dt /* r1+0x8 */, unsigned int hitNum /* r30 */, unsigned char lastHit /* r1+0xC */) {
    // Local variables
    float dustSizeMultiplier; // f31
    float soundVolume; // f30
    float mult; // f29
    enum xSndHandle playingSound; // r1+0x10
    struct xVec3 hitPos; // r1+0x14

    // References
    // -> static char __FUNCTION__[16];
    // -> static struct config landDustConfig;
    // -> struct xVec3 m_Null;
    // -> struct xVec3 m_UnitAxisY;
}

// Range: 0x8023B96C -> 0x8023B9F8
// this: r31
void zRubble::UpdateRubbleModel() {
    // Local variables
    struct xMat4x3 * modelMat; // r30
    struct xMat3x3 * modelRotMat; // r29
    struct xVec3 worldModelCenterOffset; // r1+0x8
}
...
// Range: 0x8023B9F8 -> 0x8023BB48
// this: r31
void zRubble::SetupMeshCircle() {
    // Local variables
    struct xSphere sphere; // r1+0x1C
    int submeshIdx; // r1+0xC
    int triIdx; // r1+0x8
    class zNavigationMesh * mesh; // r30
    struct xCylinder cylinder; // r1+0x2C
    struct xVec3 myPos; // r1+0x10
}
...
// total size: 0x18
class zNavigationMesh : public xBase {
    // Static members
    static class zNavigationMesh * activeNavMesh; // size: 0x4

    // Members
    class xNavigationMeshAsset * mAsset; // offset 0x10, size 0x4
    class zNavigationMesh * nextNavMesh; // offset 0x14, size 0x4
};
// Range: 0x8023BB48 -> 0x8023BB70
// this: r3
void zRubble::SetSmashMePlease(unsigned char smashMe /* r4 */) {}

// Range: 0x8023BB70 -> 0x8023BBD4
// this: r31
void zRubble::ReleaseCircle() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64EBB
// Range: 0x8023BBD4 -> 0x8023C15C
// this: r31
void zRubble::Update(float dt /* f30 */) {
    // Local variables
    float scale; // f31
    float remainingTime; // f25
    float curVelocity; // f21
    float currentBounceVelY0; // f27
    float currentBounceTime; // f29
    float checkTime; // f28
    unsigned int i; // r30
    float inBounceTime; // f26
...
// Range: 0x8023C15C -> 0x8023C208
// this: r31
void zRubble::Reset() {}

// Range: 0x8023C208 -> 0x8023C258
void RubbleEventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80523E66
struct config default_config; // size: 0x58, address: 0x80D24A40
// Range: 0x8023C258 -> 0x8023C4EC
void zRubbleGeneratorSceneSetup(struct zScene * scene /* r29 */) {
    // Local variables
    unsigned int randomModelID; // r28
    class zRubbleGenerator * current; // r31
    class zRubbleGenerator * last; // r26
    unsigned int i; // r30

    // References
    // -> static struct config landDustConfig;
    // -> unsigned char displayToPoints;
    // -> unsigned char displayBounds;
    // -> struct config default_config;
    // -> static int numActiveRubble;
    // -> static unsigned int rubblePoolCount;
    // -> static class zRubble * rubblePool;
    // -> static char __FUNCTION__[27];
    // -> int numActiveGenerators;
}

// Range: 0x8023C4EC -> 0x8023C5D0
void zRubbleGeneratorUpdate(struct zScene * scene /* r29 */, float dt /* f31 */) {
    // Local variables
    class zRubbleGenerator * current; // r31
    class zRubbleGenerator * last; // r28
    unsigned int i; // r30
...
// Range: 0x8023C5D0 -> 0x8023C6F8
void zRubbleGeneratorRender() {
    // Local variables
    unsigned int i; // r31
    class zRubbleGenerator * current; // r30
    class zRubbleGenerator * last; // r29
...
// Range: 0x8023C6F8 -> 0x8023C798
void zRubbleGeneratorReset(struct zScene * scene /* r29 */) {
    // Local variables
    unsigned int i; // r30
    class zRubbleGenerator * current; // r31
    class zRubbleGenerator * last; // r28
...
// Range: 0x8023C798 -> 0x8023C7EC
void zRubbleGenerator::DestroyAllRubbles() {
    // Local variables
    unsigned int i; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D64EC2
// Range: 0x8023C7EC -> 0x8023C9C4
void zRubbleGenerator::InitDynamic(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D64ECE
// Range: 0x8023C9C4 -> 0x8023CCC4
// this: r31
zRubbleGenerator::zRubbleGenerator(struct zRubbleGeneratorAsset * asset /* r30 */) {
    // Local variables
    unsigned int * modelIDs; // r28
    unsigned int i; // r29
    unsigned int i; // r27
    class zRubble TestRubble; // r1+0x8
...
// Range: 0x8023CCC4 -> 0x8023CE58
// this: r31
void zRubbleGenerator::Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D64ED3
// Range: 0x8023CE58 -> 0x8023CFA8
// this: r31
void zRubbleGenerator::HandleEvent(unsigned int toEvent /* r1+0x8 */) {
    // References
    // -> static char __FUNCTION__[12];
    // -> int numActiveGenerators;
}

// Range: 0x8023CFA8 -> 0x8023D02C
// this: r3
void zRubbleGenerator::Reset() {
    // References
    // -> int numActiveGenerators;
}

// Range: 0x8023D02C -> 0x8023D08C
// this: r31
void zRubbleGenerator::Spawn() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D64EDF
// Range: 0x8023D08C -> 0x8023D490
// this: r31
void zRubbleGenerator::Spawn(const struct zRubbleMarker & from /* r1+0x10 */) {
    // Local variables
    unsigned int spawnStatus[32]; // r1+0x14
    unsigned int spawnStatusCount; // r29
    unsigned int i; // r27
    unsigned int modelIndex; // r25
    const struct ModelData & data; // r24
    unsigned int spawnToIndex; // r28
    unsigned int i; // r26
    const struct zRubbleMarker & to; // r22
    int i; // r30
    const unsigned int * modelIDs; // r23
    float launchAngle; // f31
    float rotations; // f30
    float totalBouncesDistRatio; // f29
    unsigned char isSphericalRubble; // r21
...
// Range: 0x8023D490 -> 0x8023D4E4
// this: r3
void zRubbleGenerator::SignalDeactivated(void * object /* r4 */) {
    // Local variables
    unsigned int i; // r31
}

// Range: 0x8023D4E4 -> 0x8023D544
// this: r31
unsigned int zRubbleGenerator::GetFirstModel() const {
    // Local variables
    const unsigned int * modelIDs; // r30
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D64EE5
// Range: 0x8023D544 -> 0x8023D7D8
void zRubbleGenerator::SetupMarkers(unsigned int baseID /* r22 */, struct zRubbleMarker * & marker /* r31 */, unsigned int & count /* r30 */) {
    // Local variables
    struct xBase * b; // r28
...
// total size: 0x8
class zRubbleHitCallback {
    // Members
    const struct xSphere * sphere; // offset 0x0, size 0x4
    unsigned char * hit; // offset 0x4, size 0x4
};
// Range: 0x8023D7D8 -> 0x8023D8F8
// this: r30
unsigned char zRubbleGenerator::CheckSpawnStatus(struct RpAtomic * file /* r31 */, unsigned int which /* r1+0x8 */) const {
    // Local variables
    struct xSphere sphere; // r1+0x18
    struct xBound bound; // r1+0x28
    unsigned char hit; // r1+0xC
    class zRubbleHitCallback cb; // r1+0x10
...
// Range: 0x8023D8F8 -> 0x8023D964
// this: r30
void zRubbleGenerator::DebugRender() {
    // Local variables
    unsigned int i; // r31
...
// total size: 0xC
struct /* @class$1081zRubbleGenerator_cpp */ {
    // Members
