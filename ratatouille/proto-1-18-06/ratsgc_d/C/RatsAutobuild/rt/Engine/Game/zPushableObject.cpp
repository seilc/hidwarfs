/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPushableObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802FBEB0 -> 0x802FC8E8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float SPEED_KNOCKBACK; // size: 0x4, address: 0x80D671D8
static float GRID_CELL_SIZE; // size: 0x4, address: 0x80D671DC
static float DECEL; // size: 0x4, address: 0x80D6B7B0
// Range: 0x802FBEB0 -> 0x802FBED4
static void CalcDecel() {
    // References
    // -> static float GRID_CELL_SIZE;
    // -> static float SPEED_KNOCKBACK;
    // -> static float DECEL;
}
...
// total size: 0x4
struct /* @class$934zPushableObject_cpp */ {
    // Members
...
union /* @class$1073zPushableObject_cpp */ {
...
// total size: 0xC
struct /* @class$1072zPushableObject_cpp */ {
    // Members
...
// Range: 0x802FBED4 -> 0x802FBF14
static void MoveWrapper(struct xEnt * ent /* r1+0x8 */, struct xScene * scene /* r1+0xC */, float dt /* r1+0x10 */, struct xEntFrame * frame /* r1+0x14 */) {}

// Range: 0x802FBF14 -> 0x802FBF64
static void EventWrapper(struct xBase * from /* r1+0x8 */, struct xBase * to /* r1+0xC */, unsigned int toEvent /* r1+0x10 */, const float * toParam /* r1+0x14 */, struct xBase * toParamWidget /* r1+0x18 */, unsigned int toParamWidgetID /* r1+0x1C */) {}
...
// total size: 0xC
struct /* @class$875zPushableObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$876zPushableObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$877zPushableObject_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$878zPushableObject_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$879zPushableObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$880zPushableObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$881zPushableObject_cpp */ {
    // Members
...
static struct tweak_callback calcDecelCB; // size: 0x28, address: 0x80529B78
// total size: 0x10
...
class zPushableObject : public xEnt {
    // Functions
    unsigned char CheckPos(const struct xVec3 & destPos);

    zPushableObject(const struct Asset & theAsset);

    void Move(float dt, struct xEntFrame * frame);

    void Reset();

    void EntityHit(struct xEnt * hit);

    void HandleEvent(struct xBase * from, unsigned int toEvent);
...
// Range: 0x802FBF64 -> 0x802FBFF8
void zPushableObject::AddStaticTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static struct tweak_callback calcDecelCB;
    // -> static float GRID_CELL_SIZE;
    // -> static float SPEED_KNOCKBACK;
}

// Range: 0x802FBFF8 -> 0x802FC000
float zPushableObject::GetGridCellSize() {
    // References
    // -> static float GRID_CELL_SIZE;
}
...
// Range: 0x802FC000 -> 0x802FC084
// this: r31
unsigned char zPushableObject::CheckPos(const struct xVec3 & destPos /* r1+0x10 */) {
    // Local variables
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80D2DAD0
static unsigned char needInit; // size: 0x1, address: 0x80D6B7B4
static signed char init; // size: 0x1, address: 0x80D6B7B5
// Range: 0x802FC084 -> 0x802FC21C
// this: r31
zPushableObject::zPushableObject(const struct Asset & theAsset /* r1+0x8 */) {
    // References
    // -> static struct xEntAsset fakeAsset;
    // -> static unsigned char needInit;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D671E0
// Range: 0x802FC21C -> 0x802FC3F0
void zPushableObject::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802FC3F0 -> 0x802FC478
float zPushableObject::RoundToGrid(float pos /* f1 */) {
    // Local variables
    float grid; // f31
    int cell; // r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D671E5
// Range: 0x802FC478 -> 0x802FC650
// this: r31
void zPushableObject::Move(float dt /* f28 */, struct xEntFrame * frame /* r30 */) {
    // Local variables
    float newSpeed; // f31
    float gridPos; // f30
    float gridPos; // f29
...
// Range: 0x802FC650 -> 0x802FC710
// this: r31
void zPushableObject::Reset() {
    // Local variables
...
// Range: 0x802FC710 -> 0x802FC860
// this: r31
void zPushableObject::EntityHit(struct xEnt * hit /* r30 */) {
    // Local variables
    struct xVec3 diff; // r1+0x14
    float atDot; // f31
    float rightDot; // f30
    struct xVec3 destPos; // r1+0x8
...
// Range: 0x802FC860 -> 0x802FC8C4
// this: r31
void zPushableObject::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r1+0xC */) {}
