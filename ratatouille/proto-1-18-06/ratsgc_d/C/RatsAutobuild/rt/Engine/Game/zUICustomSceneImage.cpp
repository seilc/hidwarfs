/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomSceneImage.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802947B0 -> 0x80294A5C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65F00
// total size: 0x54
struct {} zUICustomSceneImage::__vtable; // size: 0x54, address: 0x805256B8
// total size: 0xC
...
// total size: 0xC
class zUICustomSceneImage : public zUICustom {
    // Functions
    zUICustomSceneImage(class zUI * ui);
...
// Range: 0x802947B0 -> 0x80294878
// this: r31
zUICustomSceneImage::zUICustomSceneImage(class zUI * ui /* r30 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomSceneImage::__vtable;
}
...
// Range: 0x80294878 -> 0x80294904
// this: r31
void zUICustomSceneImage::Reset() {
    // Local variables
    struct xBase * b; // r30
}

// Range: 0x80294904 -> 0x80294980
// this: r30
unsigned char zUICustomSceneImage::HandleEvent(struct xBase * from /* r1+0x8 */, unsigned int toEvent /* r31 */, const float * toParam /* r1+0xC */, struct xBase * toParamWidget /* r1+0x10 */, unsigned int toParamWidgetID /* r1+0x14 */) {}
...
// total size: 0x4
struct /* @class$924zUICustomSceneImage_cpp */ {
    // Members
...
union /* @class$636zUICustomSceneImage_cpp */ {
...
// total size: 0xC
struct /* @class$1080zUICustomSceneImage_cpp */ {
    // Members
...
// Range: 0x80294980 -> 0x80294A5C
// this: r31
void zUICustomSceneImage::UpdateTexture() {
    // Local variables
    unsigned int sceneCurrent; // r27
    unsigned int scene; // r30
    char full[64]; // r1+0x10
    char sceneStr[8]; // r1+0x8
    unsigned int imageID; // r26
