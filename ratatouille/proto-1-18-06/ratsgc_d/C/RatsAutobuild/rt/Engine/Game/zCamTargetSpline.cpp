/*
    ...
    Language: C++
    Code range: 0x802B456C -> 0x802B4A40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802B456C -> 0x802B45A0
// this: r31
void zCamTargetSpline::create() {}

// Range: 0x802B45A0 -> 0x802B45D8
// this: r31
void zCamTargetSpline::stop() {}

// Range: 0x802B45D8 -> 0x802B466C
// this: r31
...
// Range: 0x802B466C -> 0x802B46AC
// this: r31
void zCamTargetSpline::pre_update() {}

// Range: 0x802B46AC -> 0x802B46B0
...
// Range: 0x802B46B0 -> 0x802B47C4
// this: r30
void zCamTargetSpline::ApplyBeadValues(unsigned char lazy /* r1+0x8 */) {
    // Local variables
    const struct BeadInfo & beadInfo; // r31
    struct rest_config newRest; // r1+0x14
    float nearWall; // r1+0x10
    float farWall; // r1+0xC
}

// total size: 0x18
struct /* @class$1052zCamTargetSpline_cpp */ {
    // Members
...
int mDebugDraw; // size: 0x4, address: 0x80D6B558
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x802B47C4 -> 0x802B4920
// this: r31
void zCamTargetSpline::update(struct xScene & scene /* r1+0x8 */, float dt /* f31 */) {
    // References
...
// total size: 0xC
struct /* @class$793zCamTargetSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$794zCamTargetSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$795zCamTargetSpline_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$796zCamTargetSpline_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$797zCamTargetSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$798zCamTargetSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$799zCamTargetSpline_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1120zCamTargetSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1258zCamTargetSpline_cpp */ {
    // Members
...
union /* @class$844zCamTargetSpline_cpp */ {
...
// total size: 0x10
struct /* @class$857zCamTargetSpline_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B49FC -> 0x802B4A40
// this: r30
void zCamTargetSpline::add_tweaks(const char * prefix /* r31 */) {}

// total size: 0x58
struct {} zCamTargetSpline::__vtable; // size: 0x58, address: 0x80526970
// total size: 0x54
