/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCCommonBehavior.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BE3CC -> 0x802BFB34
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802BE3CC -> 0x802BE410
void zNPCInterestPointerInit(class zNPCInterestPointer * data /* r31 */, struct zNPCInterestPointerAsset * asset /* r30 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D665D0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x802BE410 -> 0x802BE5BC
void zNPCInterestPointer::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
...
// Range: 0x802BE5BC -> 0x802BE5E0
// this: r3
unsigned char zNPCInterestPointer::Seize() {}

// Range: 0x802BE5E0 -> 0x802BE604
// this: r3
unsigned char zNPCInterestPointer::Release() {}

// total size: 0x30
class zNPCCommonAnimTest : public zBehaviorImplementation {};
// Range: 0x802BE604 -> 0x802BE608
void zNPCCommonAnimTest::enterBehavior() {}

// Range: 0x802BE608 -> 0x802BE60C
void zNPCCommonAnimTest::updateBehavior() {}
...
class zNPCCommonPlayTaunt : public zBehaviorImplementation {
    ...
    unsigned char isTransientComplete();

    // Members
public:
    float playTimer; // offset 0x30, size 0x4
};
// Range: 0x802BE60C -> 0x802BE708
// this: r31
void zNPCCommonPlayTaunt::enterBehavior() {
    // Local variables
    unsigned int hash; // r30
    float timesToPlay; // f31
}

// Range: 0x802BE708 -> 0x802BE718
// this: r3
void zNPCCommonPlayTaunt::updateBehavior(float dt /* f1 */) {}

// Range: 0x802BE718 -> 0x802BE73C
// this: r3
unsigned char zNPCCommonPlayTaunt::isTransientComplete() {}
...
// Range: 0x802BE73C -> 0x802BE7A8
void zNPCCommonNukeTransient::create_anim_table(struct xAnimTable * table /* r1+0x18 */) {}

// Range: 0x802BE7A8 -> 0x802BE870
// this: r31
void zNPCCommonNukeTransient::enterBehavior() {
    // Local variables
    float inTime; // f31
}

// Range: 0x802BE870 -> 0x802BE880
// this: r3
void zNPCCommonNukeTransient::updateBehavior(float dt /* f1 */) {}

// Range: 0x802BE880 -> 0x802BE8A4
// this: r3
unsigned char zNPCCommonNukeTransient::isTransientComplete() {}
...
class zNPCCommonMoveToTransient : public zNPCMove {
    ...
    struct xEnt * GetMoveToEnt();

    struct xVec3 * GetMoveToPosition();

    unsigned char HasReachedTarget();

    struct pointer_asset * HasPointer();

    unsigned char UpdateFacedDirection(float dt);
...
// Range: 0x802BE8A4 -> 0x802BE8D8
// this: r31
void zNPCCommonMoveToTransient::setup() {}

// Range: 0x802BE8D8 -> 0x802BE964
// this: r31
void zNPCCommonMoveToTransient::enterBehavior() {
    // Local variables
    unsigned int animHandle; // r30
}

// Range: 0x802BE964 -> 0x802BE9E0
// this: r31
void zNPCCommonMoveToTransient::exitBehavior() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D665D5
// Range: 0x802BE9E0 -> 0x802BEAF8
// this: r31
struct xEnt * zNPCCommonMoveToTransient::GetMoveToEnt() {
    // Local variables
    struct xEnt * entDest; // r30
    struct xBase * baseDest; // r29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D665E2
// total size: 0x0
struct xSpline3 {};
// total size: 0x34
...
// Range: 0x802BEAF8 -> 0x802BEBE0
// this: r27
struct xVec3 * zNPCCommonMoveToTransient::GetMoveToPosition() {
    // Local variables
    struct xEnt * dest; // r31
    struct xVec3 * pos; // r30
    struct pointer_asset * pointerAsset; // r29
    struct xMovePoint * mp; // r28
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D665F4
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x802BEBE0 -> 0x802BED18
// this: r31
unsigned char zNPCCommonMoveToTransient::HasReachedTarget() {
    // Local variables
    struct xVec3 * pos; // r30
    float closeEnoughToTarget; // f31
    struct xVec3 pos2d; // r1+0x14
    struct xVec3 ent2d; // r1+0x8
    float dist; // f30
...
// Range: 0x802BED18 -> 0x802BED8C
// this: r1+0x8
struct pointer_asset * zNPCCommonMoveToTransient::HasPointer() {
    // Local variables
    struct xEnt * entDest; // r31
    struct pointer_asset * pointerAsset; // r30
}

// Range: 0x802BED8C -> 0x802BEE74
// this: r30
unsigned char zNPCCommonMoveToTransient::UpdateFacedDirection(float dt /* r1+0x8 */) {
    // Local variables
    struct pointer_asset * pointer; // r31
    struct xVec3 direction; // r1+0xC
    float COS_FACED_ANGLE; // f31
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66605
// Range: 0x802BEE74 -> 0x802BF018
// this: r31
void zNPCCommonMoveToTransient::updateBehavior(float dt /* f31 */) {
    // Local variables
    struct xVec3 * pos; // r30
...
// Range: 0x802BF018 -> 0x802BF034
// this: r3
unsigned char zNPCCommonMoveToTransient::isTransientComplete() {}
...
// total size: 0x4
struct /* @class$2090zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1872zNPCCommonBehavior_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$2049zNPCCommonBehavior_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2051zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2048zNPCCommonBehavior_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2053zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1390zNPCCommonBehavior_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$842zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zNPCCommonBehavior_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zNPCCommonBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zNPCCommonBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zNPCCommonBehavior_cpp */ {
    // Members
...
class zNPCCommonInterestingIdle : public zNPCMove {
    ...
    class zNPCInterestPointer * PickInterestPointer();
...
// Range: 0x802BF034 -> 0x802BF090
// this: r31
void zNPCCommonInterestingIdle::enterBehavior() {}

// Range: 0x802BF090 -> 0x802BF0CC
// this: r31
void zNPCCommonInterestingIdle::exitBehavior() {}

// Range: 0x802BF0CC -> 0x802BF100
// this: r1+0x8
void zNPCCommonInterestingIdle::SetAsNotCurrent() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66614
// Range: 0x802BF100 -> 0x802BF464
// this: r31
void zNPCCommonInterestingIdle::updateBehavior(float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x802BF464 -> 0x802BF54C
// this: r31
unsigned char zNPCCommonInterestingIdle::UpdateFacedDirection(float dt /* r1+0x8 */) {
    // Local variables
    struct xVec3 direction; // r1+0xC
    float COS_FACED_ANGLE; // f31
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D66623
// Range: 0x802BF54C -> 0x802BF6AC
// this: r30
class zNPCInterestPointer * zNPCCommonInterestingIdle::PickInterestPointer() {
    // Local variables
    struct xGroup * ipGroup; // r31
    int idx; // r29
...
static unsigned int zBEHAVIORFLAG_Jumping; // size: 0x4, address: 0x80D70504
// total size: 0x3C
...
// Range: 0x802BF6AC -> 0x802BF6C0
// this: r3
void zNPCCommonPlayCustomTransient::setup() {
    // References
    // -> static unsigned int zBEHAVIORFLAG_Jumping;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D66637
// Range: 0x802BF6C0 -> 0x802BF778
// this: r31
void zNPCCommonPlayCustomTransient::enterBehavior() {
    // References
    // -> static char __FUNCTION__[14];
}

// Range: 0x802BF778 -> 0x802BF7C8
// this: r31
void zNPCCommonPlayCustomTransient::exitBehavior() {}
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D66645
...
// Range: 0x802BF7C8 -> 0x802BF92C
// this: r31
void zNPCCommonPlayCustomTransient::updateBehavior(float dt /* f31 */) {
    // Local variables
    struct xVec3 turnToPos; // r1+0x14
    struct xVec3 * priorityTargetPos; // r30
    struct xVec3 direction; // r1+0x8
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D66654
// total size: 0x0
...
// Range: 0x802BF92C -> 0x802BFB34
// this: r31
unsigned char zNPCCommonPlayCustomTransient::isTransientComplete() {
    // Local variables
    class zNPCCommon * npc; // r30
    struct xVec3 npcPos; // r1+0x8
    class zMeshPosition localMeshPos; // r1+0x14
...
// total size: 0x138
struct {} zNPC::zNPCCommonPlayCustomTransient::__vtable; // size: 0x138, address: 0x80527510
// total size: 0x50
...
// total size: 0x4
struct /* @class$901zNPCCommonBehavior_cpp */ {
    // Members
...
union /* @class$1040zNPCCommonBehavior_cpp */ {
...
// total size: 0xC
struct /* @class$1039zNPCCommonBehavior_cpp */ {
    // Members
...
// total size: 0x138
struct {} zNPC::zNPCCommonInterestingIdle::__vtable; // size: 0x138, address: 0x80527648
// total size: 0x138
struct {} zNPC::zNPCCommonMoveToTransient::__vtable; // size: 0x138, address: 0x80527780
// total size: 0x11C
struct {} zNPC::zNPCCommonNukeTransient::__vtable; // size: 0x11C, address: 0x805278B8
// total size: 0x11C
struct {} zNPC::zNPCCommonPlayTaunt::__vtable; // size: 0x11C, address: 0x805279D4
// total size: 0x11C
struct {} zNPC::zNPCCommonAnimTest::__vtable; // size: 0x11C, address: 0x80527AF0
// total size: 0x30
