/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompSteeringGeneric.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8034464C -> 0x803452FC
*/
// total size: 0x1
...
static class zCompSteeringGenericParams gDefaultSteeringBasicParams; // size: 0x38, address: 0x80D36178
// total size: 0x18
...
// Range: 0x8034464C -> 0x803446D4
// this: r31
void zSteeringGenericDynamics::Initialize(class zICompNPCEntity * npcEnt /* r30 */) {}
...
// total size: 0xC
struct /* @class$842zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zCompSteeringGeneric_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0x64
struct {} zCompSteeringGeneric::__vtable; // size: 0x64, address: 0x8052F068
// total size: 0x18
...
class zCompSteeringGeneric : public zICompSteering {
    ...
    void CalculateVelConstraints(struct xVec3 & dVel);
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D67E00
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80344830 -> 0x80344834
void zCompSteeringGeneric::Detached() {}

// Range: 0x80344834 -> 0x80344838
void zCompSteeringGeneric::Update() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D67E09
// Range: 0x80344838 -> 0x80344904
// this: r30
unsigned char zCompSteeringGeneric::SystemEvent(unsigned int to_event /* r1+0x8 */, struct xBase * to_param_widget /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static unsigned char renderWallAvoidenceForce; // size: 0x1, address: 0x80D6BBB8
static unsigned char renderSphereAvoidenceForce; // size: 0x1, address: 0x80D6BBB9
static unsigned char renderWanderForce; // size: 0x1, address: 0x80D6BBBA
static unsigned char renderDestForce; // size: 0x1, address: 0x80D6BBBB
static unsigned char renderTotalForce; // size: 0x1, address: 0x80D6BBBC
// Range: 0x80344904 -> 0x80344A38
...
static struct xVec3 ArrowDrawOffset; // size: 0xC, address: 0x80D67E18
// Range: 0x80344A38 -> 0x80344AD0
void zCompSteeringGeneric::DebugRenderForce(const struct xVec3 * entPos /* r1+0x8 */, struct xVec3 * Force /* r1+0xC */, struct xColor_tag & color /* r30 */) {
    // Local variables
    struct xVec3 HeadingArrowStart; // r1+0x20
    struct xVec3 ForceMult; // r1+0x14

    // References
    // -> static struct xVec3 ArrowDrawOffset;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D67E24
// Range: 0x80344AD0 -> 0x80344C64
// this: r30
void zCompSteeringGeneric::ApplySteering(class zICompNPCEntity * npcEnt /* r31 */, float dt /* f31 */) {
    // Local variables
    class zSteeringGenericDynamics steeringDynamics; // r1+0x38
    struct xVec3 acc; // r1+0x2C
    struct xVec3 dVel; // r1+0x20
    struct xVec3 dPos; // r1+0x14
    struct xVec3 facing; // r1+0x8

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D67E32
...
// Range: 0x80344C64 -> 0x80344E5C
// this: r30
void zCompSteeringGeneric::CalculateAcc(struct xVec3 & acc /* r28 */, class zSteeringGenericDynamics & steeringDynamics /* r29 */, float dt /* f29 */) {
    // Local variables
    float accMag; // r1+0x10
    const class zCompSteeringGenericParams * params; // r31
    struct xVec3 destAcc; // r1+0x20
    float destMag; // f31
    struct xVec3 WanderAcc; // r1+0x14
    float WanderMag; // f30
...
// Range: 0x80344E5C -> 0x80344E98
// this: r1+0x8
void zCompSteeringGeneric::CalculateVelConstraints(struct xVec3 & dVel /* r1+0xC */) {
    // Local variables
    const class zCompSteeringGenericParams * params; // r1+0x10

    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x80344E98 -> 0x80344EC4
void zCompSteeringGeneric::CalculatePosConstraints(struct xVec3 & dPos /* r1+0x8 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x80344EC4 -> 0x80344EFC
void zCompSteeringGeneric::CalculateFacing(struct xVec3 & facing /* r1+0x8 */, class zSteeringGenericDynamics & steeringDynamics /* r31 */) {}

// Range: 0x80344EFC -> 0x80345008
unsigned char zCompSteeringGeneric::AccumulateVec(struct xVec3 & curTotalVec /* r29 */, float & curTotalMag /* r31 */, float maxMag /* f29 */, const struct xVec3 & vecToAdd /* r30 */, float magToAdd /* f31 */) {
    // Local variables
    float wantedMag; // f30
    struct xVec3 truncatedVector; // r1+0x8
}

// Range: 0x80345008 -> 0x8034513C
// this: r30
float zCompSteeringGeneric::GetWanderAcc(struct xVec3 & wanderAcc /* r29 */, class zSteeringGenericDynamics & steeringDynamics /* r28 */, float dt /* r1+0x8 */) {
    // Local variables
    const class zCompSteeringGenericParams * params; // r31
    float JitterThisTimeSlice; // f30
    struct xVec3 RandomVector; // r1+0x18
    float magForward; // f31
    float magRandom; // f29
    struct xVec3 wanderForceLocal; // r1+0xC
...
// total size: 0x1
class zNPCHelper {};
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D67E3F
int __float_max[]; // size: 0x0, address: 0x80D67F90
// Range: 0x8034513C -> 0x803452FC
// this: r31
float zCompSteeringGeneric::GetSeekAcc(struct xVec3 & seekAcc /* r28 */, class zSteeringGenericDynamics & steeringDynamics /* r29 */, float dt /* f29 */) {
    // Local variables
    const class zCompSteeringGenericParams * params; // r30
    struct xVec3 desiredVelocity; // r1+0x14
...
// total size: 0x4
struct /* @class$901zCompSteeringGeneric_cpp */ {
    // Members
...
union /* @class$1040zCompSteeringGeneric_cpp */ {
...
// total size: 0xC
struct {} zCompSteeringGenericParams::__vtable; // size: 0xC, address: 0x80D67E4C
