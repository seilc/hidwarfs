/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025C1BC -> 0x8025D52C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zPad pads[6]; // size: 0xD8, address: 0x80D24A98
static class zPad * debugPad; // size: 0x4, address: 0x80D6B1D8
static class zPad * dualControlPad; // size: 0x4, address: 0x80D6B1DC
// Range: 0x8025C1BC -> 0x8025C210
void zPadsReleaseDebugAndDual() {
    // References
    // -> static class zPad * dualControlPad;
    // -> static class zPad * debugPad;
}

// Range: 0x8025C210 -> 0x8025C274
void zPadsInit() {
    // Local variables
    int i; // r31

    // References
    // -> static class zPad pads[6];
}
...
class zPad {
    ...
    unsigned char Toggle(int & newPort);
    ...
    unsigned char Pressed(unsigned int button);

    unsigned char On(unsigned int button);

    unsigned char Released(unsigned int button);

    unsigned char PressedDirect(unsigned int button);

    unsigned char OnDirect(unsigned int button);

    unsigned char ReleasedDirect(unsigned int button);
...
class zPadAnalogControl {
    ...
    void Get(float & x, float & y, float & angle, float & mag);
...
// Range: 0x8025C2F0 -> 0x8025C324
// this: r3
void zPad::Init() {}

// Range: 0x8025C324 -> 0x8025C39C
unsigned char zPad::IsPadAtPort(int port /* r3 */, int & arrayIndex /* r4 */) {
    // Local variables
    int j; // r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D65598
// Range: 0x8025C39C -> 0x8025C45C
class zPad * zPad::GetFirstUnused() {
    // Local variables
    int i; // r31
...
// Range: 0x8025C45C -> 0x8025C514
class zPad * zPad::CreatePadAtPort(int port /* r30 */, unsigned char isAI /* r29 */) {
    // Local variables
    class zPad * firstUnusedPad; // r31
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D655A7
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x8025C514 -> 0x8025C64C
class zPad * zPad::GetUnusedPad(unsigned char isAI /* r30 */) {
    // Local variables
    int arrayIndex; // r1+0x8
    int i; // r31
...
// Range: 0x8025C64C -> 0x8025C6BC
class zPad * zPad::GetTriggeredPad(unsigned int key1 /* r1+0x8 */, unsigned int key2 /* r1+0xC */, unsigned int key3 /* r1+0x10 */) {
    // Local variables
    class zPad * pad; // r31
}

// Range: 0x8025C6BC -> 0x8025C6F0
class zPad * zPad::GetTriggeredPad(unsigned int key1 /* r1+0x8 */, unsigned int key2 /* r1+0xC */) {}

// Range: 0x8025C6F0 -> 0x8025C72C
class zPad * zPad::GetDebugPad() {
    // References
    // -> static class zPad * debugPad;
}

// Range: 0x8025C72C -> 0x8025C868
// this: r31
unsigned char zPad::KeyCheck() {}

// Range: 0x8025C868 -> 0x8025C91C
// this: r31
unsigned char zPad::Toggle(int & newPort /* r28 */) {
    // Local variables
    int oldPort; // r29
    int i; // r30
...
// Range: 0x8025C91C -> 0x8025C9F4
void zPad::RefreshActivePad(int port /* r29 */) {
    // Local variables
    int i; // r30
    class zPad * p; // r31
...
// Range: 0x8025C9F4 -> 0x8025CA38
// this: r31
void zPad::DisablePad() {}

// Range: 0x8025CA38 -> 0x8025CA7C
// this: r31
void zPad::EnablePad() {}

// Range: 0x8025CA7C -> 0x8025CBC0
void zPad::CheckPadTriggers() {
    // Local variables
    int j; // r30
    int i; // r31
    int newPort; // r1+0x8
...
// Range: 0x8025CBC0 -> 0x8025CBE8
// this: r1+0x8
unsigned char zPad::Active() {}

// Range: 0x8025CBE8 -> 0x8025CC28
// this: r31
void zPad::DeactivateTRC() {}

// Range: 0x8025CC28 -> 0x8025CC54
// this: r3
void zPad::Clear() {
    // References
    // -> struct _tagxPad mPad[4];
...
// Range: 0x8025CC54 -> 0x8025CC70
// this: r3
void zPad::ReleasePad() {}

// Range: 0x8025CC70 -> 0x8025CCD0
// this: r30
unsigned char zPad::Pressed(unsigned int button /* r1+0x8 */) {}

// Range: 0x8025CCD0 -> 0x8025CD30
// this: r30
unsigned char zPad::On(unsigned int button /* r1+0x8 */) {}

// Range: 0x8025CD30 -> 0x8025CD90
// this: r30
unsigned char zPad::Released(unsigned int button /* r1+0x8 */) {}

// Range: 0x8025CD90 -> 0x8025CDDC
// this: r3
unsigned char zPad::PressedDirect(unsigned int button /* r4 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8025CDDC -> 0x8025CE28
// this: r3
unsigned char zPad::OnDirect(unsigned int button /* r4 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8025CE28 -> 0x8025CE74
// this: r3
unsigned char zPad::ReleasedDirect(unsigned int button /* r4 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8025CE74 -> 0x8025CF34
// this: r31
unsigned char zPad::Enabled() {
    // Local variables
    int i; // r30
}

// Range: 0x8025CF34 -> 0x8025D130
// this: r31
float zPadAnalogControl::GetX() {
    // Local variables
    float v; // f31
    float y; // f30
...
// Range: 0x8025D130 -> 0x8025D32C
// this: r31
float zPadAnalogControl::GetY() {
    // Local variables
    float v; // f31
    float x; // f30
...
// Range: 0x8025D32C -> 0x8025D378
float zPadAnalogControl::GetMag(float x /* f1 */, float y /* f2 */) {}

// Range: 0x8025D378 -> 0x8025D3BC
// this: r31
float zPadAnalogControl::GetMag() {
    // Local variables
    float x; // r1+0xC
    float y; // r1+0x8
}

// Range: 0x8025D3BC -> 0x8025D408
// this: r31
float zPadAnalogControl::GetAngle() {}

// Range: 0x8025D408 -> 0x8025D438
float zPadAnalogControl::GetAngle(float x /* r1+0x8 */, float y /* r1+0xC */) {}

// Range: 0x8025D438 -> 0x8025D49C
// this: r29
void zPadAnalogControl::Get(float & x /* r30 */, float & y /* r31 */, float & angle /* r27 */, float & mag /* r28 */) {}

// Range: 0x8025D49C -> 0x8025D4F0
// this: r29
void zPadAnalogControl::Get(float & x /* r30 */, float & y /* r31 */) {}
