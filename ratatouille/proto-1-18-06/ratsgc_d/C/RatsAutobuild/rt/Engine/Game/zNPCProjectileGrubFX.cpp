/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCProjectileGrubFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C5080 -> 0x802C84BC
*/
// total size: 0x44
struct TrailConfig {
    // Members
    ...
    float R_MULT; // offset 0x34, size 0x4
    float G_MULT; // offset 0x38, size 0x4
    float B_MULT; // offset 0x3C, size 0x4
    unsigned char distance_emit; // offset 0x40, size 0x1
};
static struct TrailConfig defaultConfig; // size: 0x44, address: 0x80D2D008
// total size: 0x1
class zNPCProjectileGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802C5080 -> 0x802C5084
void zNPCProjectileGrubTrail::AddStaticTweaks() {}

int systemID; // size: 0x4, address: 0x80D66820
// total size: 0x28
...
// Range: 0x802C5084 -> 0x802C5220
void zNPCProjectileGrubTrail::SceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batch_system; // r1+0x8

    // References
    // -> static struct TrailConfig defaultConfig;
    // -> int systemID;
}
...
// total size: 0x4
struct /* @class$901zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zNPCProjectileGrubFX_cpp */ {
    // Members
...
union /* @class$1040zNPCProjectileGrubFX_cpp */ {
...
// total size: 0x10
struct /* @class$1304zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1813zNPCProjectileGrubFX_cpp */ {
    // Static members
...
struct Particle {
    ...
    float rot_delta; // offset 0x28, size 0x4
    struct TrailConfig * cfg; // offset 0x2C, size 0x4
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x802C5220 -> 0x802C54CC
int zNPCProjectileGrubTrail::Update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r30
    struct Particle * p; // r31
    struct Particle * end; // r29
...
// Range: 0x802C54CC -> 0x802C578C
void zNPCProjectileGrubTrail::Emit(float & emit_remaining /* r30 */, const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & velocity /* r26 */, float dt /* f30 */, float scale /* f28 */, struct TrailConfig * cfg /* r31 */) {
    // Local variables
    float emit_rate; // f31
    float time_passed; // f29
    int emit; // r29
    struct Particle * p; // r1+0xC
    int count; // r28
...
static struct TrailConfig defaultTConfig; // size: 0x38, address: 0x80D2D04C
// total size: 0x1
class zNPCProjectileTGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802C578C -> 0x802C5790
void zNPCProjectileTGrubTrail::AddStaticTweaks() {}

int systemID; // size: 0x4, address: 0x80D66824
// Range: 0x802C5790 -> 0x802C58F4
void zNPCProjectileTGrubTrail::SceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batch_system; // r1+0x8

    // References
    // -> static struct TrailConfig defaultTConfig;
    // -> int systemID;
}
...
// Range: 0x802C58F4 -> 0x802C5B68
int zNPCProjectileTGrubTrail::Update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r30
    struct Particle * p; // r31
    struct Particle * end; // r29
...
// Range: 0x802C5BCC -> 0x802C5E8C
void zNPCProjectileTGrubTrail::Emit(float & emit_remaining /* r30 */, const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & velocity /* r26 */, float dt /* f30 */, float scale /* f28 */, struct TrailConfig * cfg /* r31 */) {
    // Local variables
    float emit_rate; // f31
    float time_passed; // f29
    int emit; // r29
...
struct SparkConfig {
    ...
    float rotateDeltaMin; // offset 0x14, size 0x4
    float rotateDeltaMax; // offset 0x18, size 0x4
    float velRandom; // offset 0x1C, size 0x4
    float posRandom; // offset 0x20, size 0x4
    float swapTime; // offset 0x24, size 0x4
    float endFadeIn; // offset 0x28, size 0x4
    float startFadeOut; // offset 0x2C, size 0x4
    unsigned char distance_emit; // offset 0x30, size 0x1
};
struct SparkConfig defaultSparkConfig; // size: 0x34, address: 0x80D2D084
struct SparkConfig burstSparkConfig; // size: 0x34, address: 0x80D2D0B8
int systemID; // size: 0x4, address: 0x80D66828
// total size: 0x1
class zNPCProjectileGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802C5E8C -> 0x802C6124
void zNPCProjectileGrubSparks::SceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batch_system; // r1+0x8
    ...
    // References
    // -> int systemID;
    // -> struct SparkConfig burstSparkConfig;
    // -> struct SparkConfig defaultSparkConfig;
}
...
struct Particle {
    ...
    struct xVec3 vel; // offset 0x10, size 0xC
    float rot; // offset 0x1C, size 0x4
    float swapTime; // offset 0x20, size 0x4
    unsigned int cell; // offset 0x24, size 0x4
    float rot_delta; // offset 0x28, size 0x4
    struct SparkConfig * cfg; // offset 0x2C, size 0x4
    float life; // offset 0x30, size 0x4
    float maxLife; // offset 0x34, size 0x4
    float endFadeIn; // offset 0x38, size 0x4
    float startFadeOut; // offset 0x3C, size 0x4
};
// Range: 0x802C6124 -> 0x802C648C
int zNPCProjectileGrubSparks::Update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x802C648C -> 0x802C67D8
void zNPCProjectileGrubSparks::Emit(float & emit_remaining /* r30 */, const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & velocity /* r26 */, float dt /* f30 */, struct SparkConfig * cfg /* r31 */) {
    // Local variables
    float emit_rate; // f31
    float time_passed; // f29
    int emit; // r29
...
struct SparkConfig defaultESparkConfig; // size: 0x34, address: 0x80D2D0EC
struct SparkConfig burstESparkConfig; // size: 0x34, address: 0x80D2D120
int systemID; // size: 0x4, address: 0x80D6682C
// total size: 0x1
class zNPCProjectileEGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802C67D8 -> 0x802C6C48
void zNPCProjectileEGrubSparks::SceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batch_system; // r1+0x8
    ...
    // References
    // -> int systemID;
    // -> struct SparkConfig burstESparkConfig;
    // -> struct SparkConfig burstSparkConfig;
    // -> struct SparkConfig defaultESparkConfig;
    // -> struct SparkConfig defaultSparkConfig;
}
...
// Range: 0x802C6C48 -> 0x802C6FB0
int zNPCProjectileEGrubSparks::Update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r30
    struct Particle * p; // r31
    struct Particle * end; // r29
...
static struct ArcConfig defaultArcConfig; // size: 0x1C, address: 0x80D2D154
int systemID; // size: 0x4, address: 0x80D66830
// total size: 0x1
class zNPCProjectileGrubArc {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802C7034 -> 0x802C714C
void zNPCProjectileGrubArc::SceneSetup() {
    // Local variables
    struct RwTexture * texture; // r31
    struct xParticleBatchSystem batch_system; // r1+0x8
    ...
    // References
    // -> int systemID;
    // -> static struct ArcConfig defaultArcConfig;
}
...
struct Particle {
    ...
    struct xVec3 pos; // offset 0x0, size 0xC
    float size; // offset 0xC, size 0x4
    struct xModelInstance * refModel; // offset 0x10, size 0x4
    unsigned int vertIdx; // offset 0x14, size 0x4
    float rot; // offset 0x18, size 0x4
    float life; // offset 0x1C, size 0x4
    float swapTime; // offset 0x20, size 0x4
    unsigned int cell; // offset 0x24, size 0x4
    const struct ArcConfig * cfg; // offset 0x28, size 0x4
    class zNPCProjectile * ownerGrub; // offset 0x2C, size 0x4
};
// Range: 0x802C714C -> 0x802C74AC
int zNPCProjectileGrubArc::Update(unsigned char * mem /* r27 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r30
    struct Particle * p; // r31
    struct Particle * end; // r29
    unsigned char die; // r28
    struct xVec3 newPos; // r1+0x30
    struct xVec3 vertOffset; // r1+0x24
    struct RpGeometry * geom; // r1+0x10
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D66834
struct xVec3 m_Null; // size: 0xC, address: 0x80D6D920
// Range: 0x802C74AC -> 0x802C7738
void zNPCProjectileGrubArc::Emit(float & emit_remaining /* r28 */, const struct ArcConfig * cfg /* r31 */, struct xModelInstance * model /* r29 */, class zNPCProjectile * ownerGrub /* r23 */, float dt /* f30 */, int sysID /* r25 */) {
    // Local variables
    int emit; // r30
    float emit_rate; // f31
    struct Particle * p; // r1+0x8
    int count; // r27
    struct Particle * end; // r24
...
static unsigned int HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x80D6B5B8
// total size: 0x10
struct GrubHitExplosion {
    // Members
    struct xModelInstance * model; // offset 0x0, size 0x4
    float maxLife; // offset 0x4, size 0x4
    float currLife; // offset 0x8, size 0x4
    unsigned char active; // offset 0xC, size 0x1
};
static struct GrubHitExplosion * sHitExplosions; // size: 0x4, address: 0x80D6B5BC
static char __FUNCTION__[41]; // size: 0x29, address: 0x80528400
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x802C7738 -> 0x802C778C
void zNPCProjectileGrubHitExplosionSceneSetup() {
    // References
    // -> static char __FUNCTION__[41];
    // -> unsigned int gActiveHeap;
    // -> static struct GrubHitExplosion * sHitExplosions;
}

static char __FUNCTION__[41]; // size: 0x29, address: 0x80528429
// Range: 0x802C778C -> 0x802C7914
void zNPCProjectileGrubHitExplosionSceneReset() {
    // Local variables
    struct RpAtomic * data; // r30
    int i; // r31

    // References
    // -> static struct GrubHitExplosion * sHitExplosions;
    // -> static unsigned int HIT_EXPLOSION_MODEL_ID;
    // -> static char __FUNCTION__[41];
}

// Range: 0x802C7914 -> 0x802C7A44
void zNPCProjectileGrubHitExplosionEmit(const struct xMat4x3 & mat /* r1+0x8 */) {
    // Local variables
    int i; // r31
...
// Range: 0x802C7A44 -> 0x802C7B9C
void zNPCProjectileGrubHitExplosionUpdate(float dt /* f1 */) {
    // Local variables
    int i; // r31
    float scale; // f31
...
// Range: 0x802C7B9C -> 0x802C7C08
void zNPCProjectileGrubHitExplosionRender() {
    // Local variables
    int i; // r31
...
static unsigned int BIG_HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x80D6B5C0
float BIG_HIT_AWAY_KNOCKBACK; // size: 0x4, address: 0x80D6683C
float BIG_HIT_UP_KNOCKBACK; // size: 0x4, address: 0x80D66840
// total size: 0x80
struct GrubBigHitExplosion {
    // Members
    struct xModelInstance * model; // offset 0x0, size 0x4
    struct xMat4x3 ffeMat; // offset 0x10, size 0x40
    float maxLife; // offset 0x50, size 0x4
    float currLife; // offset 0x54, size 0x4
    float modelMaxLife; // offset 0x58, size 0x4
    float modelCurrLife; // offset 0x5C, size 0x4
    unsigned char active; // offset 0x60, size 0x1
    float radius; // offset 0x64, size 0x4
    struct xEnt * owner; // offset 0x68, size 0x4
    int damage; // offset 0x6C, size 0x4
    class zForceFieldEffect * ffe; // offset 0x70, size 0x4
    unsigned char fading; // offset 0x74, size 0x1
    float rippleTimer; // offset 0x78, size 0x4
};
static struct GrubBigHitExplosion * sBigHitExplosions; // size: 0x4, address: 0x80D6B5C4
// total size: 0x10
struct _xFColor {
    // Members
...
static char __FUNCTION__[44]; // size: 0x2C, address: 0x80528452
// Range: 0x802C7C08 -> 0x802C7C88
void zNPCProjectileGrubBigHitExplosionSceneSetup() {
    // Local variables
    int i; // r31

    // References
    // -> static struct GrubBigHitExplosion * sBigHitExplosions;
    // -> static char __FUNCTION__[44];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[44]; // size: 0x2C, address: 0x8052847E
// Range: 0x802C7C88 -> 0x802C7E10
void zNPCProjectileGrubBigHitExplosionSceneReset() {
    // Local variables
    struct RpAtomic * data; // r30
    int i; // r31
    ...
    // References
    // -> static struct GrubBigHitExplosion * sBigHitExplosions;
    // -> static unsigned int BIG_HIT_EXPLOSION_MODEL_ID;
    // -> static char __FUNCTION__[44];
}
...
// total size: 0xC
struct /* @class$842zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$843zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$844zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$845zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$846zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$847zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$848zNPCProjectileGrubFX_cpp */ {
    // Members
...
// Range: 0x802C7E10 -> 0x802C831C
void zNPCProjectileGrubBigHitExplosionUpdate(float dt /* f28 */) {
    // Local variables
    int i; // r31
    float modelScale; // f30
    float fadeOut; // f29
    float maxLife; // f27
    float scale; // f31
    struct xVec3 position; // r1+0x10
    struct xMat4x3 model_mat; // r1+0x20

    // References
    // -> static struct GrubBigHitExplosion * sBigHitExplosions;
    // -> float BIG_HIT_UP_KNOCKBACK;
    // -> float BIG_HIT_AWAY_KNOCKBACK;
}

// Range: 0x802C831C -> 0x802C83B8
void zNPCProjectileGrubBigHitExplosionRender() {
    // Local variables
    int i; // r31
...
// Range: 0x802C83B8 -> 0x802C83E8
void zNPCProjectileGrubFX_SceneSetup() {}

// Range: 0x802C83E8 -> 0x802C83FC
void zNPCProjectileGrubFX_SceneExit() {
    // References
    // -> static struct GrubBigHitExplosion * sBigHitExplosions;
    // -> static struct GrubHitExplosion * sHitExplosions;
}

// Range: 0x802C83FC -> 0x802C8420
void zNPCProjectileGrubFX_SceneReset() {}

// Range: 0x802C8420 -> 0x802C8454
void zNPCProjectileGrubFX_Update(float dt /* f31 */) {}

// Range: 0x802C8454 -> 0x802C8478
void zNPCProjectileGrubFX_RenderModels() {}
