/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemBurrowKickup.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80288190 -> 0x802891B4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x24
class zParticleSystemBurrowKickup : public zParticleSystem {
    // Functions
...
// Range: 0x80288190 -> 0x80288204
// this: r1+0x8
struct zParticleGenerator * zParticleSystemBurrowKickup::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorBurrowKickup * gen; // r30
}

// Range: 0x80288240 -> 0x8028826C
// this: r1+0x8
void zParticleSystemBurrowKickup::scene_enter() {}

// Range: 0x8028826C -> 0x8028829C
// this: r1+0x8
void zParticleSystemBurrowKickup::update(float dt /* r1+0xC */) {}
...
// Range: 0x8028829C -> 0x802882A4
int zParticleSystemBurrowKickup::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65CB0
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$840zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1756zParticleSystemBurrowKickup_cpp */ {
    // Members
    unsigned int shrapID; // offset 0x0, size 0x4
    float shrapEmitRate; // offset 0x4, size 0x4
    float initUpVel; // offset 0x8, size 0x4
    float initOutVel; // offset 0xC, size 0x4
};
// total size: 0x2C
struct asset_data {
    // Members
    ...
    float rotSpeed; // offset 0x8, size 0x4
    float lifetime; // offset 0xC, size 0x4
    float maxAlpha; // offset 0x10, size 0x4
    float initUpVel; // offset 0x14, size 0x4
    float randOutVel; // offset 0x18, size 0x4
    // total size: 0x10
    struct /* @class$1756zParticleSystemBurrowKickup_cpp */ {
        // Members
        unsigned int shrapID; // offset 0x0, size 0x4
...
// Range: 0x802882A4 -> 0x802886C0
int zParticleSystemBurrowKickup::update_particles(unsigned char * mem /* r19 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* f30 */, void * context /* r20 */) {
    // Local variables
    ...
    struct zParticleGeneratorBurrowKickup & g; // r21
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65CC1
...
// total size: 0xD4
struct zParticleGeneratorBurrowKickup : public zParticleGenerator {
    // Functions
    void update(float dt);

    void create(class zParticleSystemBurrowKickup & system, struct zParticleAsset & asset);
    ...
    // Members
protected:
    class zParticleSystemBurrowKickup * system; // offset 0xA4, size 0x4
...
// Range: 0x802886C0 -> 0x80288AB0
// this: r31
void zParticleGeneratorBurrowKickup::update(float dt /* f31 */) {
    // Local variables
    const struct asset_data & a; // r30
    struct xMat4x3 volumeFrame; // r1+0x80
    struct xMat3x3 verticalMat; // r1+0x50
    struct xVec3 center; // r1+0x3C
    int emit; // r29
    float lifetime; // f30
    float rotSpeed; // f29
    float gravity; // r1+0x14
    struct xVec3 upVel; // r1+0x30
    unsigned char * mem; // r1+0x10
    int have; // r27
    struct particle_instance * p; // r28
    struct particle_instance * endp; // r23
    struct xVec3 & vel; // r26
    struct xVec3 * posList; // r24
    struct xVec3 upVel; // r1+0x24
    struct xVec3 * posPtr; // r25
    struct xVec3 initVel; // r1+0x18
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65CC8
...
// Range: 0x80288AB0 -> 0x80288D30
// this: r31
void zParticleGeneratorBurrowKickup::create(class zParticleSystemBurrowKickup & system /* r26 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
    const struct asset_data & a; // r30
    struct RpAtomic * m; // r28

    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x80288D30 -> 0x80288DAC
// this: r31
void zParticleGeneratorBurrowKickup::reset() {}

// Range: 0x80288DAC -> 0x80288DEC
// this: r31
void zParticleGeneratorBurrowKickup::activate() {}

// Range: 0x80288DEC -> 0x80288E28
// this: r31
void zParticleGeneratorBurrowKickup::deactivate() {}

// Range: 0x80288E28 -> 0x80288E8C
// this: r31
unsigned char zParticleGeneratorBurrowKickup::cullUpdate() {
    // Local variables
...
// Range: 0x80288E8C -> 0x8028915C
// this: r30
void zParticleGeneratorBurrowKickup::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    struct asset_data & a; // r29
}

// Range: 0x8028915C -> 0x802891B4
// this: r31
void zParticleGeneratorBurrowKickup::debug_render(unsigned char all /* r30 */) {}

// total size: 0x2C
struct {} zParticleGeneratorBurrowKickup::__vtable; // size: 0x2C, address: 0x80525248
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemBurrowKickup_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemBurrowKickup_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemBurrowKickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemBurrowKickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemBurrowKickup_cpp */ {
    // Members
...
union /* @class$827zParticleSystemBurrowKickup_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemBurrowKickup_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemBurrowKickup::__vtable; // size: 0x3C, address: 0x80525274
// total size: 0x8
