/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zLOD.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017F170 -> 0x8017FB98
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int sLODTableCount; // size: 0x4, address: 0x80D6A590
// total size: 0x8
struct RwObject {
    // Members
...
static struct zLODTable * sLODTableList; // size: 0x4, address: 0x80D6A594
static unsigned int sManagerIndex; // size: 0x4, address: 0x80D6A598
static unsigned int sManagerCount; // size: 0x4, address: 0x80D6A59C
static float sLODFadeDistance; // size: 0x4, address: 0x80D62FE8
// total size: 0x10
struct zLODManager {
    // Members
...
static struct zLODManager sManagerList[2900]; // size: 0xB540, address: 0x80CF51E8
static unsigned char done; // size: 0x1, address: 0x80D6A5A0
static signed char init; // size: 0x1, address: 0x80D6A5A1
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D62FEC
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8017F170 -> 0x8017F460
static void AddToLODList(struct xEnt * ent /* r29 */) {
    // Local variables
    unsigned int i; // r30
    struct xModelInstance * minst; // r31
    float distscale; // f31
    struct xModelInstance * extra; // r28
    struct zDestructible * destructible; // r27
...
// Range: 0x8017F460 -> 0x8017F4A8
static struct xEnt * AddToLODList(struct xEnt * ent /* r31 */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D62FF9
...
// Range: 0x8017F4A8 -> 0x8017F7B4
void zLOD_Setup(float fadeDistance /* r1+0x8 */) {
    // Local variables
    ...
    struct RpAtomic * model; // r26
    struct RpAtomic * model; // r25
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63004
// Range: 0x8017F7B4 -> 0x8017FB0C
void zLOD_Update(unsigned int percent_update /* r1+0x8 */) {
    // Local variables
    struct xVec3 * campos; // r29
    unsigned int numUpdates; // r26
    struct zLODManager & lodManager; // r28
    struct zLODTable * lod; // r30
...
// Range: 0x8017FB0C -> 0x8017FB98
struct zLODTable * zLOD_Get(struct xEnt * ent /* r3 */) {
    // Local variables
    unsigned int i; // r31
