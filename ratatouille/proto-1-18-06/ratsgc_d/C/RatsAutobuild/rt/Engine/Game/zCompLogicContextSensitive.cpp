/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCompLogicContextSensitive.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80330B08 -> 0x80331BF4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gConSenPatrolSteeringParams; // size: 0x70, address: 0x80D345D0
static class zCompSteeringBasicParams gConSenChaseSteeringParams; // size: 0x70, address: 0x80D34640
// total size: 0x8
...
static struct zCompStateMachineTable gContextSensitiveStateMachineTable[10]; // size: 0x50, address: 0x8052E338
// total size: 0x40
...
// Range: 0x80330B08 -> 0x80330B30
void zCompLogicContextSensitive::AddStaticTweaks() {}

// Range: 0x80330B30 -> 0x80330B38
unsigned char zCompLogicContextSensitive::SystemEvent() {}

// Range: 0x80330B38 -> 0x80330E5C
void zCompLogicContextSensitive::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// total size: 0x1C
class zAnimPlayState : public zCompState {
    // Members
    unsigned int animStateID; // offset 0x14, size 0x4
    int stateEnumToGo; // offset 0x18, size 0x4
};
// Range: 0x80330E5C -> 0x8033100C
// this: r31
void zCompLogicContextSensitive::SetupStateTranstitionTests() {
    // Local variables
    class zAnimWTimerState * TauntState; // r30
    class zAnimWTimerState * VulnerableState; // r29
    class zAnimPlayState * AttackDoneState; // r28
    class zAnimPlayState * PlayerGoesOnTop; // r27
    class zAnimPlayState * PlayerHit; // r26
    class zAnimPlayState * NPCMiss; // r25
}
...
// Range: 0x8033100C -> 0x80331014
int zCompLogicContextSensitive::GetInitialStateEnum() {}

// Range: 0x80331014 -> 0x80331020
struct zCompStateMachineTable * zCompLogicContextSensitive::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gContextSensitiveStateMachineTable[10];
}

// Range: 0x80331020 -> 0x80331048
// this: r1+0x8
void zCompLogicContextSensitive::Attached() {}

// Range: 0x80331048 -> 0x80331098
// this: r31
void zCompLogicContextSensitive::AllAttached() {
    // Local variables
...
// total size: 0x4
struct /* @class$968zCompLogicContextSensitive_cpp */ {
    // Members
...
union /* @class$1108zCompLogicContextSensitive_cpp */ {
...
// total size: 0xC
struct /* @class$1106zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$878zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$879zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$880zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$881zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$882zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$883zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$884zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1728zCompLogicContextSensitive_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80331098 -> 0x80331110
unsigned char zCompLogicContextSensitive::GoToChase(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zCompLogicContextSensitive * logicComp; // r31
...
// total size: 0x890
struct /* @class$1971zCompLogicContextSensitive_cpp */ {
    // Static members
...
// Range: 0x80331110 -> 0x80331188
unsigned char zCompLogicContextSensitive::BackToPatrol(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zCompLogicContextSensitive * logicComp; // r31
    struct xVec3 * playerPos; // r30
...
// Range: 0x80331188 -> 0x80331228
unsigned char zCompLogicContextSensitive::IsInAttackDistance(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r30
    const struct xVec3 * NPCPos; // r29
...
// Range: 0x80331228 -> 0x80331268
unsigned char zCompLogicContextSensitive::ButtonPressed() {
    // Local variables
...
// Range: 0x80331268 -> 0x80331304
unsigned char zCompLogicContextSensitive::ButtonPressLast(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// Range: 0x80331304 -> 0x8033139C
unsigned char zCompLogicContextSensitive::GroundAttackMissed(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r30
...
// Range: 0x8033139C -> 0x80331434
unsigned char zCompLogicContextSensitive::GroundAttackHit(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r30
...
// total size: 0x18
class zConSenPatrol : public zCompState {
    // Functions
    zConSenPatrol();
...
// Range: 0x80331434 -> 0x80331464
void zConSenPatrol::AddStaticTweaks(const char * name /* r1+0x8 */) {
    // References
    // -> static class zCompSteeringBasicParams gConSenPatrolSteeringParams;
}

// total size: 0x2C
struct {} zConSenPatrol::__vtable; // size: 0x2C, address: 0x8052E3E0
// Range: 0x80331464 -> 0x80331528
// this: r31
zConSenPatrol::zConSenPatrol() {
    // References
    // -> static class zCompSteeringBasicParams gConSenPatrolSteeringParams;
    // -> struct [anonymous] zConSenPatrol::__vtable;
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D6BAD8
static signed char init; // size: 0x1, address: 0x80D6BAD9
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67A70
// Range: 0x80331528 -> 0x803316E0
// this: r31
void zConSenPatrol::Update(class zNPCBase * owner /* r28 */, float dt /* r1+0x8 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D67A77
// total size: 0x68
class zNPCContextSensitive : public zNPCBase {};
// total size: 0x78
struct zNPCAssetContextSensitive : public zNPCAssetRATS {
    // Members
    unsigned int firstMovePoint; // offset 0x74, size 0x4
};
// Range: 0x803316E0 -> 0x803317D0
// this: r30
void zConSenPatrol::Enter(class zNPCBase * owner /* r28 */) {
    // Local variables
    class zNPCContextSensitive * npcConSen; // r29
    struct zNPCAssetContextSensitive * npcassConSen; // r31
...
// Range: 0x803317D0 -> 0x80331894
// this: r30
void zConSenPatrol::Resume(class zNPCBase * owner /* r28 */) {
    // Local variables
...
// Range: 0x80331894 -> 0x803318F0
// this: r30
void zConSenPatrol::DebugRender(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// total size: 0x2C
struct {} zConSenChase::__vtable; // size: 0x2C, address: 0x8052E3B4
// total size: 0x14
class zConSenChase : public zCompState {
    // Functions
    zConSenChase();
};
// Range: 0x803318F0 -> 0x803319AC
// this: r31
zConSenChase::zConSenChase() {
    // References
    // -> static class zCompSteeringBasicParams gConSenChaseSteeringParams;
    // -> static class zCompSteeringBasicParams gConSenPatrolSteeringParams;
    // -> struct [anonymous] zConSenChase::__vtable;
}

// Range: 0x803319AC -> 0x80331A2C
void zConSenChase::Update(class zNPCBase * owner /* r29 */, float dt /* r1+0x8 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r30
}

// Range: 0x80331A2C -> 0x80331AE4
void zConSenChase::Resume(class zNPCBase * owner /* r29 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zICompSteering * compSteering; // r31
...
// total size: 0x14
class zConSenAttack1 : public zCompState {};
// Range: 0x80331AE4 -> 0x80331B38
void zConSenAttack1::Resume(class zNPCBase * owner /* r1+0x8 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
}
...
// Range: 0x80331B38 -> 0x80331BF4
void zConSenAttack1::Exit(class zNPCBase * owner /* r30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct zCombatDamageInfo combatDamageInfo; // r1+0x8
...
// total size: 0x2C
struct {} zConSenAttack1::__vtable; // size: 0x2C, address: 0x8052E388
// total size: 0x14
class zCompState {
    // Members
    int stateEnum; // offset 0x0, size 0x4
