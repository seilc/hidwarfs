/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zRocket.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020A7A8 -> 0x8020B07C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class smoke_trail {
    // Static members
    static struct smoke_config default_config; // size: 0x38
    static int system_id; // size: 0x4
};
// Range: 0x8020A7A8 -> 0x8020A9B8
void smoke_trail::add_tweaks(const char * prefix /* r30 */, struct smoke_config * smoke /* r31 */) {}
...
// total size: 0x1
struct /* @class$991zRocket_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$992zRocket_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$993zRocket_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$994zRocket_cpp */ {
    // Members
...
int system_id; // size: 0x4, address: 0x80D646A0
static unsigned char need_setup; // size: 0x1, address: 0x80D646A4
// Range: 0x8020A9B8 -> 0x8020AAA4
void smoke_trail::setup() {
    // References
    // -> struct smoke_config default_config;
    // -> static unsigned char need_setup;
}
...
// Range: 0x8020AAA4 -> 0x8020AB60
void smoke_trail::scene_setup() {
    // Local variables
...
// total size: 0x4
struct /* @class$2269zRocket_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2270zRocket_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
struct particle {
    ...
    struct smoke_config * cfg; // offset 0x2C, size 0x4
};
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x8020AB60 -> 0x8020ADE8
int smoke_trail::update(unsigned char * mem /* r28 */, int count /* r1+0x8 */, struct ptank_pool & pool_ /* r1+0xC */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x8020ADE8 -> 0x8020B07C
void smoke_trail::emit(float & emit_remaining /* r30 */, const struct xVec3 & position /* r1+0x8 */, const struct xVec3 & velocity /* r26 */, float dt /* f30 */, struct smoke_config * cfg /* r31 */) {
    // Local variables
    float emit_rate; // f31
