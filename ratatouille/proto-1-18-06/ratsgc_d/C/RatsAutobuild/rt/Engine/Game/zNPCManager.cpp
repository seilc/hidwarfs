/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802F9254 -> 0x802FA594
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNPCManagerInitialized; // size: 0x1, address: 0x80D6B7A0
class zNPCManager * gNPCManager; // size: 0x4, address: 0x80D6B7A4
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D67160
// Range: 0x802F9254 -> 0x802F9308
...
// Range: 0x802F9364 -> 0x802F9390
void zNPCManagerSceneInit() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F9390 -> 0x802F93C4
void zNPCManagerScenePrepare(int npccnt /* r1+0x8 */) {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F93C4 -> 0x802F93F0
void zNPCManagerSceneFinish() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F93F0 -> 0x802F941C
void zNPCManagerSceneExit() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F941C -> 0x802F9448
void zNPCManagerSceneReset() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F9448 -> 0x802F9474
void zNPCManagerScenePostInit() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F9474 -> 0x802F94A0
void zNPCManagerSceneSetup() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F94A0 -> 0x802F94CC
void zNPCManagerSceneRender() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F94CC -> 0x802F9508
void zNPCManagerSceneTimestep(struct xScene * xscn /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    class zNPCManager * npcManager; // r31
}
...
// Range: 0x802F9508 -> 0x802F953C
struct xAnimTable * zNPCManagerCreateAnimTable(enum eBrainType brainType /* r1+0x8 */) {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F953C -> 0x802F9568
int zNPCManagerAllocateNPCs() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F9568 -> 0x802F9594
void zNPCManagerLoadNPCs() {
    // Local variables
    class zNPCManager * npcManager; // r31
}

// Range: 0x802F9594 -> 0x802F95D0
void zNPCManagerRegisterNPCs(struct zScene * zscn /* r1+0x8 */, int * base_idx /* r1+0xC */) {
    // Local variables
    class zNPCManager * npcManager; // r31
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67173
// Range: 0x802F95D0 -> 0x802F9650
...
// Range: 0x802F9748 -> 0x802F974C
void zNPCManager::Shutdown() {}

// Range: 0x802F974C -> 0x802F97A4
void zNPCManager::SceneInit() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x802F97A4 -> 0x802F9830
void zNPCManager::ScenePrepare() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x802F9830 -> 0x802F9834
void zNPCManager::SceneFinish() {}

// Range: 0x802F9834 -> 0x802F9900
// this: r28
void zNPCManager::SceneExit() {
    // Local variables
    unsigned int npcType; // r30
    int i; // r29
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}
...
// Range: 0x802F99CC -> 0x802F99D0
void zNPCManager::ScenePostInit() {}

// Range: 0x802F99D0 -> 0x802F9A28
void zNPCManager::SceneSetup() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

static unsigned char done; // size: 0x1, address: 0x80D6B7A8
static signed char init; // size: 0x1, address: 0x80D6B7A9
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D67187
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x802F9A28 -> 0x802F9B4C
struct xAnimTable * zNPCManager::CreateAnimTable(enum eBrainType brainType /* r28 */) {
    // Local variables
    enum eNPCType npcType; // r29
    struct xAnimTable * table; // r30
    const struct zNPCTypesTable * npcTypeTableEntry; // r31
...
// total size: 0x4
struct /* @class$889zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1112zNPCManager_cpp */ {
    // Members
...
union /* @class$601zNPCManager_cpp */ {
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D67197
// Range: 0x802F9B4C -> 0x802F9CA0
// this: r30
int zNPCManager::AllocateNPCs() {
    // Local variables
    int totalNPCCount; // r28
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
    enum eNPCType curNPCType; // r29

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D671A4
// Range: 0x802F9CA0 -> 0x802F9EF8
int zNPCManager::FindNumberOfNPCs(int * typeCount /* r27 */) {
    // Local variables
    int i; // r26
    int NPCNumber; // r28
    int num_alldyn; // r23
    ...
    const struct xDynAsset * dynAsset; // r29
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D671B5
// Range: 0x802F9EF8 -> 0x802FA190
// this: r29
void zNPCManager::LoadNPCs() {
    ...
    int i; // r25
    unsigned int dynAssetSize; // r1+0x8
    const struct xDynAsset * dynAsset; // r28
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
    enum eNPCType curNPCType; // r30
    class zNPCBase * curNPC; // r23
    int numChildren; // r22
    class zNPCBase * firstChildNPC; // r18
    int j; // r21
    class zNPCBase * curChildNPC; // r20
    unsigned int npcType; // r27
    int i; // r24
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D671BE
// Range: 0x802FA190 -> 0x802FA398
void zNPCManager::LoadNPC(class zNPCBase * npc /* r23 */, enum eNPCType type /* r24 */, const struct xDynAsset * dynAsset /* r30 */, unsigned int dynAssetSize /* r25 */) {
    // Local variables
    struct zNPCAssetRATS * npcass; // r29
    struct xEntAsset * entass; // r31
    struct xBaseAsset * baseass; // r1+0xC
    unsigned int size; // r1+0x8
    struct xModelAssetInfo * modelInfoAssetMINF; // r28
    struct xModelAssetInfo * modelInfoAsset; // r27
...
// Range: 0x802FA398 -> 0x802FA430
// this: r27
void zNPCManager::RegisterNPCs(int * base_idx /* r28 */) {
    // Local variables
    unsigned int npcType; // r31
    int i; // r30
    class zNPCBase * curNPC; // r29
}

// Range: 0x802FA430 -> 0x802FA4C8
// this: r29
...
// total size: 0x10
struct /* @class$1897zNPCManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802FA4C8 -> 0x802FA594
// this: r29
void zNPCManager::SceneTimestep(struct xScene * xscn /* r1+0x8 */, float dt /* r1+0xC */) {
    // Local variables
    struct xVec3 * playerPos; // r28
    unsigned int npcType; // r31
    int i; // r30
...
// total size: 0x4
struct /* @class$2329zNPCManager_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2288zNPCManager_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2289zNPCManager_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2290zNPCManager_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2287zNPCManager_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2292zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$830zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832zNPCManager_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833zNPCManager_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zNPCManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zNPCManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zNPCManager_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2140zNPCManager_cpp */ {
    // Static members
