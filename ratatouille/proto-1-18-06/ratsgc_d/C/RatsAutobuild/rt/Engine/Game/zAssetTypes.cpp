/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zAssetTypes.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012FF28 -> 0x80132700
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$anStartBlockRightCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[23]; // size: 0x17, address: 0x80517768
char __FUNCTION__$localstatic1$anStartBlockLeftCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[22]; // size: 0x16, address: 0x8051777F
char __FUNCTION__$localstatic1$anStartDuckCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80D61E38
char __FUNCTION__$localstatic1$anStartJumpCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80D61E49
// total size: 0x28
struct PKRAssetType {
    // Members
...
static struct PKRAssetType assetTypeHandlers[101]; // size: 0xFC8, address: 0x80517798
// total size: 0xC
struct BrainTableEntry {
    // Members
    const char * name; // offset 0x0, size 0x4
    enum eBrainType type; // offset 0x4, size 0x4
    unsigned int id; // offset 0x8, size 0x4
};
struct BrainTableEntry g_brainTable[23]; // size: 0x114, address: 0x80518760
static unsigned char initialized; // size: 0x1, address: 0x80D69E60
static signed char init; // size: 0x1, address: 0x80D69E61
static unsigned char already_asserted; // size: 0x1, address: 0x80D69E62
static signed char init; // size: 0x1, address: 0x80D69E63
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D61E5A
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$916zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1054zAssetTypes_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1629zAssetTypes_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8012FF28 -> 0x801300AC
enum eBrainType GetBrainType(unsigned int brainNameHash /* r1+0x8 */, unsigned int assetid /* r1+0xC */) {
    // Local variables
    int i; // r31
    int i; // r30
    ...
    // -> struct BrainTableEntry g_brainTable[23];
    // -> static unsigned char initialized;
    // -> static signed char init;
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D61E67
// Range: 0x801300AC -> 0x80130194
char * GetBrainName(enum eBrainType brainType /* r1+0x8 */) {
    // Local variables
    int i; // r31
    char buff[5]; // r1+0xC
...
// Range: 0x80130194 -> 0x801301C0
void zAssetStartup() {
    // References
    // -> static struct PKRAssetType assetTypeHandlers[101];
}

// Range: 0x801301C0 -> 0x801301E0
void zAssetShutdown() {}

unsigned int gModelReadAssetIDDebug; // size: 0x4, address: 0x80D69E64
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61E74
// Range: 0x801301E0 -> 0x80130324
static void * Model_Read(unsigned int assetid /* r31 */, void * indata /* r29 */, unsigned int insize /* r1+0x8 */, unsigned int * outsize /* r26 */) {
    // Local variables
    struct RpAtomic * model; // r30
    struct RpClump * pClump; // r28
    struct RwFrame * pRootFrame; // r27
...
// Range: 0x80130324 -> 0x80130364
void * Spline_Read(void * indata /* r5 */, unsigned int insize /* r6 */, unsigned int * outsize /* r7 */) {
    // Local variables
    class xNurbs * nurbs; // r31
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80518874
// Range: 0x80130364 -> 0x8013050C
static void * Navigation_Mesh_Read(void * indata /* r1+0x8 */, unsigned int insize /* r1+0xC */, unsigned int * outsize /* r27 */) {
    // Local variables
    class xNavigationMeshAsset * meshAsset; // r30
    int m; // r29
    class xNavigationMeshAssetSubMesh * sub_mesh; // r31
    int portal_lookup_size; // r28

    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x8013050C -> 0x80130570
static unsigned int * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    unsigned int * ret; // r30
}

// Range: 0x80130570 -> 0x80130584
static void advance_to_type_size(void * packed_mem_addr /* r3 */) {}

// Range: 0x80130584 -> 0x801305E8
static struct Triangle * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    struct Triangle * ret; // r30
}

// Range: 0x801305E8 -> 0x8013064C
static struct xVec3 * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    struct xVec3 * ret; // r30
}

// Range: 0x8013064C -> 0x801306B0
static struct Exit * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    struct Exit * ret; // r30
}

// Range: 0x801306B0 -> 0x80130714
static float * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    float * ret; // r30
}

// Range: 0x80130714 -> 0x80130774
static unsigned char * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    unsigned char * ret; // r30
}

// Range: 0x80130774 -> 0x80130778
static void advance_to_type_size(void * packed_mem_addr /* r3 */) {}

// Range: 0x80130778 -> 0x801307DC
static class xNavigationMeshAssetSubMesh * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh * ret; // r30
}

// Range: 0x801307DC -> 0x80130840
static class xNavigationMeshAsset * get_next_packed_mem(void * packed_mem_addr /* r31 */, int array_len /* r29 */) {
    // Local variables
    class xNavigationMeshAsset * ret; // r30
}

// total size: 0x30
struct spline_path : public xBaseAsset {
    // Members
    ...
    struct xVec3 hover_point; // offset 0x18, size 0xC
    union { // inferred
        struct { // inferred
        ...
        struct { // inferred
            class xNurbs * spline; // offset 0x24, size 0x4
            struct spline_path * * forward_paths; // offset 0x28, size 0x4
            struct spline_path * * backward_paths; // offset 0x2C, size 0x4
        };
    };
};
// Range: 0x80130840 -> 0x8013092C
void * spline_path::init(void * indata /* r1+0x8 */, unsigned int insize /* r1+0xC */, unsigned int * outsize /* r26 */) {
    // Local variables
    struct spline_path * path; // r31
    unsigned int * forward_ids; // r28
    unsigned int * backward_ids; // r27
    int i; // r30
    int i; // r29
}

// Range: 0x8013092C -> 0x80130960
static void Model_Unload(void * userdata /* r31 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D61E7F
enum RwStreamType {
    rwNASTREAM = 0,
    rwSTREAMFILE = 1,
    rwSTREAMFILENAME = 2,
...
// Range: 0x80130960 -> 0x80130C74
static void * BSP_Read(unsigned int assetid /* r1+0x8 */, void * indata /* r27 */, unsigned int insize /* r1+0xC */, unsigned int * outsize /* r30 */) {
    // Local variables
    struct RwStream * stream; // r31
    struct RwMemory rwmem; // r1+0x10
    struct RwChunkHeaderInfo chunkHeaderInfo; // r1+0x18
    struct RpWorld * bsp; // r29

    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61E88
// total size: 0x1C
...
// Range: 0x80130C74 -> 0x80130D78
static void BSP_Unload(void * userdata /* r1+0x8 */) {
    // References
...
union /* @class$1055zAssetTypes_cpp */ {
...
static struct xJSPHeader sDummyEmptyJSP; // size: 0x2C, address: 0x80CF0A90
static struct xJSPHeader * sTempJSP; // size: 0x4, address: 0x80D69E68
// Range: 0x80130D78 -> 0x80130E00
static void * JSP_Read(unsigned int assetid /* r1+0x8 */, void * indata /* r1+0xC */, unsigned int insize /* r1+0x10 */, unsigned int * outsize /* r31 */) {
    // Local variables
    struct xJSPHeader * retjsp; // r30

    // References
    // -> static struct xJSPHeader * sTempJSP;
    // -> static struct xJSPHeader sDummyEmptyJSP;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D61E93
// Range: 0x80130E00 -> 0x80130F08
static void JSP_Unload(void * userdata /* r31 */) {
    // References
    // -> static struct xJSPHeader sDummyEmptyJSP;
    // -> static char __FUNCTION__[11];
    // -> struct zGlobals globals;
...
// Range: 0x80130F08 -> 0x80130F30
static struct RwTexture * TexCB(struct RwTexture * texture /* r3 */, void * data /* r4 */) {
    // Local variables
    struct RwTexture * * texFound; // r31
}
...
struct RwError {
    // Members
    int pluginID; // offset 0x0, size 0x4
    int errorCode; // offset 0x4, size 0x4
};
// Range: 0x80130F30 -> 0x801310A4
void * RWTX_Read(void * indata /* r1+0x8 */, unsigned int insize /* r28 */, unsigned int * outsize /* r29 */) {
    // Local variables
    struct RwTexDictionary * txd; // r30
    struct RwMemory rwmem; // r1+0x1C
    struct RwStream * stream; // r31
    struct RwTexture * tex; // r1+0x10
    struct iAsyncLockRWSentry rw_sentry; // r1+0xC
    struct RwError error; // r1+0x14
}

// Range: 0x801310A4 -> 0x801310E8
void TextureRW3_Unload(void * userdata /* r1+0x8 */) {
    // Local variables
...
struct AnimTableList animTable[2]; // size: 0x18, address: 0x8051888C
// Range: 0x801310E8 -> 0x8013114C
static void ATBL_Init() {
    // Local variables
    int i; // r31

    // References
    // -> struct AnimTableList animTable[2];
}

static struct xAnimTable * (* tableFuncList[1])(); // size: 0x4, address: 0x80D61EA0
// Range: 0x8013114C -> 0x80131154
static unsigned int dummyEffectCB() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80D61EA4
// Range: 0x80131154 -> 0x801312EC
static unsigned int soundEffectCB(unsigned int cbenum /* r24 */, struct xAnimActiveEffect * acteffect /* r31 */, void * object /* r25 */) {
    // Local variables
    unsigned int sndhandle; // r29
    struct xEnt * ent_tmp; // r30
    struct zAnimFxSoundGroup * snd; // r28
    class zNPCBaseIN2 * npc; // r27
    struct xEnt * EntObject; // r26
...
static unsigned int (* effectFuncList[3])(unsigned int, struct xAnimActiveEffect *, struct xAnimSingle *, void *); // size: 0xC, address: 0x80D61EB4
// Range: 0x801312EC -> 0x80131318
static void * FindAssetCB(unsigned int ID /* r1+0x8 */) {
    // Local variables
    unsigned int size; // r1+0xC
}

static unsigned char already_asserted; // size: 0x1, address: 0x80D69E6C
static signed char init; // size: 0x1, address: 0x80D69E6D
static struct zPlayer * player; // size: 0x4, address: 0x80D69E70
static signed char init; // size: 0x1, address: 0x80D69E74
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D61EC0
...
struct xAnimAssetFile {
    ...
    int Physics; // offset 0x14, size 0x4
    int StartPose; // offset 0x18, size 0x4
    int EndPose; // offset 0x1C, size 0x4
};
// total size: 0x1C
...
// Range: 0x80131318 -> 0x801323D0
static void * ATBL_Read(unsigned int assetid /* r1+0x18 */, void * indata /* r1+0x1C */, unsigned int * outsize /* r1+0x20 */) {
    // Local variables
    unsigned int i; // r31
    unsigned int j; // r22
    unsigned int debugNum; // r1+0xB4
    unsigned int tmpsize; // r1+0xB0
    struct xAnimTable * table; // r27
    struct xAnimState * astate; // r30
    unsigned char * zaBytes; // r1+0xAC
    struct xAnimAssetTable * zaTbl; // r28
    void * zaRaw; // r25
    struct xAnimAssetFile * zaFile; // r29
    struct xAnimAssetState * zaState; // r26
    unsigned int raw_animation_ids[256]; // r1+0x8B8
    unsigned int file_used_animation[256]; // r1+0x4B8
    unsigned int num_used_file_used_animations; // r1+0xA8
    int file_first_index[256]; // r1+0xB8
    int k; // r19
    int num_raw_data; // r1+0xA4
    struct xAnimFile * * fList; // r20
    const char * animation_name; // r1+0xA0
    unsigned int animation_name_id; // r1+0x9C
    struct xAnimTable * (* constructor)(); // r1+0x98
    int i; // r1+0x94
    enum eBrainType brainType; // r21
    class zBehaviorManager * npc_manager; // r1+0x90
    struct zPlayer * newPlayer; // r18
    struct zPlayer * newPlayer; // r17
    struct zPlayer * newPlayer; // r1+0x8C
    struct zPlayer * newPlayer; // r1+0x88
    struct zPlayer * newPlayer; // r1+0x84
    struct zPlayer * newPlayer; // r1+0x80
    struct zPlayer * newPlayer; // r1+0x7C
    const char * assetName; // r1+0x78
    struct xAnimTransition * atran; // r1+0x74
    char * tmpstr; // r1+0x70
    struct xAnimFile * foundFile; // r1+0x6C
    struct xAnimState * endState; // r23
    struct xAnimFile * endPose; // r1+0x68
    unsigned int i; // r1+0x64
    struct xAnimFile * file; // r1+0x60
    unsigned int j; // r1+0x5C
    struct xAnimFile * endPose; // r1+0x58
    struct xAnimState * state; // r1+0x54
    struct xAnimAssetEffect * zaEffect; // r24
    struct xAnimEffect * effect; // r1+0x50

    // References
    // -> unsigned int gxAnimUseGrowAlloc;
    // -> static unsigned int (* effectFuncList[3])(unsigned int, struct xAnimActiveEffect *, struct xAnimSingle *, void *);
    // -> static char __FUNCTION__[10];
    // -> unsigned int gActiveHeap;
    // -> struct xGlobals * xglobals;
    // -> static signed char init;
    // -> static struct zPlayer * player;
    // -> static unsigned char already_asserted;
    // -> static signed char init;
    // -> struct AnimTableList animTable[2];
    // -> static struct xAnimTable * (* tableFuncList[1])();
}
...
// total size: 0x4
struct /* @class$2109zAssetTypes_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2028zAssetTypes_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2029zAssetTypes_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2030zAssetTypes_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2027zAssetTypes_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2032zAssetTypes_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2221zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$806zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$807zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$808zAssetTypes_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$809zAssetTypes_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$810zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$811zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$812zAssetTypes_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1872zAssetTypes_cpp */ {
    // Static members
...
static int been_here; // size: 0x4, address: 0x80D69E78
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61ECA
// Range: 0x801325B0 -> 0x80132620
static void Anim_Unload(void * userdata /* r1+0x8 */) {
    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[12];
}

// Range: 0x80132620 -> 0x80132650
static void LightKit_Unload(void * userdata /* r1+0x8 */) {
    // Local variables
    struct xLightKit * lkit; // r31
}

static int been_here; // size: 0x4, address: 0x80D69E7C
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D61ED6
// Range: 0x80132650 -> 0x801326D8
static struct xAnimTable * Anim_ATBL_getTable(struct xAnimTable * (* func)() /* r1+0x8 */) {
    // Local variables
...
// Range: 0x801326D8 -> 0x80132700
static void MovePoint_Unload(void * userdata /* r1+0x8 */) {}
