/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEconomics.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80298E44 -> 0x8029971C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int instanceCount; // size: 0x4, address: 0x80D6B420
int lastUpgradeValue; // size: 0x4, address: 0x80D6B424
static signed char init; // size: 0x1, address: 0x80D6B428
// total size: 0x8
struct Threshold {
    // Members
...
class zEconomics {
    ...
    void ParseINI(struct xIniFile * ini);

    void CalcLastUpgradeValue();

    int GetPointsToUpgrade(int curPoints);

    int GetUpgradesEarned(int expPoints);

    int GetLevelCompletionBonus();

    void GiveLevelCompletionBonus();

    void GiveComboPoints(int enemyKilledCombo, struct zPlayer * player);

    int GetTotalPoints2UpgradeLevel(int level);
...
static class zEconomics economics; // size: 0xC9C, address: 0x80D2AFA8
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1683zEconomics_cpp */ {
    // Members
...
// Range: 0x80298E44 -> 0x80298EB4
void zEconomics::Init(struct xIniFile * ini /* r1+0x8 */) {
    // References
    // -> static class zEconomics economics;
    // -> struct zGlobals globals;
    // -> static signed char init;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65FD0
// Range: 0x80298EB4 -> 0x80298F38
// this: r1+0x8
zEconomics::zEconomics() {
    // References
...
// Range: 0x80298F38 -> 0x80299234
// this: r31
void zEconomics::ParseINI(struct xIniFile * ini /* r28 */) {
    // Local variables
    char normal[64]; // r1+0x188
    char below[64]; // r1+0x148
    char above[64]; // r1+0x108
    char low[64]; // r1+0xC8
    char high[64]; // r1+0x88
    char upgrade[64]; // r1+0x48
    char bonus[64]; // r1+0x8
    int i; // r29
    int level; // r30
    const char * levelName; // r26
    int npc; // r27
    const char * NPCName; // r24
    int i; // r25
}

// Range: 0x80299234 -> 0x8029927C
// this: r3
void zEconomics::CalcLastUpgradeValue() {
    // Local variables
    int i; // r31
...
// Range: 0x8029927C -> 0x802992CC
// this: r3
int zEconomics::GetPointsToUpgrade(int curPoints /* r4 */) {
    // Local variables
    int points; // r31
    int i; // r30
}

// Range: 0x802992CC -> 0x8029933C
// this: r3
int zEconomics::GetUpgradesEarned(int expPoints /* r4 */) {
    // Local variables
    int points; // r30
...
// total size: 0x4
struct /* @class$2075zEconomics_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2076zEconomics_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2077zEconomics_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2074zEconomics_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2079zEconomics_cpp */ {
    // Members
...
// Range: 0x8029933C -> 0x8029937C
// this: r31
int zEconomics::GetLevelCompletionBonus() {
    // Local variables
    int level; // r30
}

// Range: 0x8029937C -> 0x802993A8
// this: r3
void zEconomics::GiveLevelCompletionBonus() {
    // Local variables
    int level; // r28
    int expBonus; // r29
    int expBonusToGive; // r30
    int currentExp; // r31
}
...
// total size: 0x4
struct /* @class$889zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1053zEconomics_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1926zEconomics_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$830zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$831zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$832zEconomics_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$833zEconomics_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zEconomics_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zEconomics_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zEconomics_cpp */ {
    // Members
...
// Range: 0x802993A8 -> 0x802993BC
// this: r3
void zEconomics::GiveComboPoints(int enemyKilledCombo /* r4 */, struct zPlayer * player /* r5 */) {
    // Local variables
    int level; // r29
    int currentExp; // r28
    int expPoints; // r31
...
// Range: 0x802993BC -> 0x802994E0
char * zEconomics::GetLevelName(int level /* r4 */) {
    // Local variables
    const char * name; // r31
}

// Range: 0x802994E0 -> 0x80299504
char * zEconomics::GetNPCName(int npc /* r4 */) {
    // Local variables
    const char * name; // r31
}

// Range: 0x80299504 -> 0x8029964C
int zEconomics::GetLevelNumber() {
    // Local variables
    int level; // r31
...
static char __FUNCTION__[28]; // size: 0x1C, address: 0x80525BE0
// Range: 0x8029964C -> 0x8029971C
// this: r28
int zEconomics::GetTotalPoints2UpgradeLevel(int level /* r29 */) {
    // Local variables
    int count; // r30
    int i; // r31
