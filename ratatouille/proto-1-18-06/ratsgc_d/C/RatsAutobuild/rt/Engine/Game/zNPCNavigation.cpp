/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCNavigation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8018AE98 -> 0x8018B930
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float STEERING_MIN_DIST2; // size: 0x4, address: 0x80D63288
static unsigned char USE_STEERING; // size: 0x1, address: 0x80D6328C
static unsigned char need_add_tweak; // size: 0x1, address: 0x80D6328D
// total size: 0x44
class zNPCJump {
    // Members
    ...
    float totalTime; // offset 0x18, size 0x4
    float timeUp; // offset 0x1C, size 0x4
    struct xVec3 target; // offset 0x20, size 0xC
    struct xVec3 source; // offset 0x2C, size 0xC
    struct xVec3 position; // offset 0x38, size 0xC
};
// total size: 0xC
struct RwV3d {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6328E
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// total size: 0x50
class zNPCNavigate {
    // Functions
    zNPCNavigate(class zNPCCommon * npc);

    void reset();

    unsigned char findChangedNavMesh();

    void collide(float dt);

    unsigned char IsStuck() const;

    unsigned char HasNavmesh() const;

    void apply_dpos(float dt);

    void remove();

    void GetDirection(const struct xVec3 & destination, struct xVec3 & direction);

    void update_stuck(float dt);

    void InvalidateMeshPosition();
...
// Range: 0x8018AE98 -> 0x8018AF6C
// this: r31
zNPCNavigate::zNPCNavigate(class zNPCCommon * npc /* r1+0x8 */) {
    // References
    // -> static unsigned char USE_STEERING;
    // -> static unsigned char need_add_tweak;
...
// total size: 0x4
struct /* @class$919zNPCNavigation_cpp */ {
    // Members
...
union /* @class$1058zNPCNavigation_cpp */ {
...
// total size: 0xC
struct /* @class$1057zNPCNavigation_cpp */ {
    // Members
...
// Range: 0x8018AF6C -> 0x8018B06C
// this: r31
void zNPCNavigate::reset() {
    // Local variables
    float npcRadius; // r1+0x8
...
// total size: 0x4
struct /* @class$2100zNPCNavigation_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2059zNPCNavigation_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2060zNPCNavigation_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2061zNPCNavigation_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2058zNPCNavigation_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2063zNPCNavigation_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1408zNPCNavigation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$860zNPCNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$861zNPCNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$862zNPCNavigation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$863zNPCNavigation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$864zNPCNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$865zNPCNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$866zNPCNavigation_cpp */ {
    // Members
...
// Range: 0x8018B06C -> 0x8018B120
// this: r31
unsigned char zNPCNavigate::findChangedNavMesh() {
    // Local variables
    unsigned char navMeshFound; // r30
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D63293
// Range: 0x8018B120 -> 0x8018B4B4
// this: r31
void zNPCNavigate::collide(float dt /* r1+0x8 */) {
    // Local variables
    struct xVec3 initialDpos; // r1+0x20
    class zMeshCircle * nearbyCircles; // r30
    class zMeshPosition updatedPosition; // r1+0x2C
    unsigned char result; // r29
    struct xVec2 dpos; // r1+0xC
    float newDposLength; // f30
    float dposOldY; // f29
    struct xVec3 endingDpos; // r1+0x14
    float endingDposLength2; // f31
...
// Range: 0x8018B4B4 -> 0x8018B50C
// this: r30
unsigned char zNPCNavigate::IsStuck() const {}

// Range: 0x8018B50C -> 0x8018B53C
// this: r31
unsigned char zNPCNavigate::HasNavmesh() const {}

// Range: 0x8018B53C -> 0x8018B708
// this: r31
void zNPCNavigate::apply_dpos(float dt /* r1+0x8 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$2205zNPCNavigation_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1882zNPCNavigation_cpp */ {
    // Static members
...
// Range: 0x8018B708 -> 0x8018B748
// this: r31
void zNPCNavigate::remove() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D6329B
// Range: 0x8018B748 -> 0x8018B8B4
// this: r31
void zNPCNavigate::GetDirection(const struct xVec3 & destination /* r1+0x8 */, struct xVec3 & direction /* r30 */) {
    // Local variables
    class zMeshPosition destinationMeshPos; // r1+0x14
    unsigned char result; // r29
    struct xVec2 dir2D; // r1+0xC

    // References
    // -> static unsigned char USE_STEERING;
    // -> static float STEERING_MIN_DIST2;
    // -> static char __FUNCTION__[13];
}

// Range: 0x8018B8B4 -> 0x8018B900
// this: r3
void zNPCNavigate::update_stuck(float dt /* f1 */) {}

// Range: 0x8018B900 -> 0x8018B930
// this: r31
void zNPCNavigate::InvalidateMeshPosition() {}
