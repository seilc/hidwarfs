/*
    ...
    Language: C++
    Code range: 0x801EBDDC -> 0x801EBEEC
*/
// total size: 0xA08
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D64240
// Range: 0x801EBDDC -> 0x801EBEEC
// this: r29
void zTimeHandlerMgr::update(float dt /* f31 */) {
    // Local variables
    int i; // r30
    struct zTimeHandlerStruct * thandler; // r31
