/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCamPool.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B22D4 -> 0x802B2580
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802B22D4 -> 0x802B22E8
// this: r3
zCamPoolBase::zCamPoolBase() {}

// Range: 0x802B22E8 -> 0x802B2350
// this: r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D66428
// Range: 0x802B2350 -> 0x802B2448
// this: r31
void zCamPoolBase::AddCamera(struct xCam * newCam /* r30 */, const char * tweakPrefix /* r29 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static int depth; // size: 0x4, address: 0x80D6B540
static signed char init; // size: 0x1, address: 0x80D6B544
// Range: 0x802B2448 -> 0x802B24FC
// this: r31
