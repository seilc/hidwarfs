/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zEnv.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8015781C -> 0x801584E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char renderJSPs; // size: 0x1, address: 0x80D62850
// Range: 0x8015781C -> 0x8015784C
void zEnvInit(void * env /* r1+0x8 */, void * easset /* r1+0xC */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D62851
...
// total size: 0x1
struct /* @class$841zEnv_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$842zEnv_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$843zEnv_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$844zEnv_cpp */ {
    // Members
...
// Range: 0x8015784C -> 0x80157A98
void zEnvInit(struct _zEnv * env /* r31 */, struct xEnvAsset * easset /* r29 */) {
    // Local variables
    int mapper_count; // r26
    int i; // r28
    unsigned int size; // r1+0x8
    struct xBase * material_map; // r27
    int i; // r30

    // References
    // -> struct zGlobals globals;
    // -> static char __FUNCTION__[9];
    // -> unsigned char renderJSPs;
    // -> unsigned char iEnvAllJSPSActive;
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D6285A
// Range: 0x80157A98 -> 0x80157BA4
void zEnvSetup(struct _zEnv * env /* r31 */) {
    // References
    // -> struct zGlobals globals;
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80D62864
// Range: 0x80157BA4 -> 0x80157C8C
void zEnvStartingCamera(struct _zEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80D62877
// total size: 0x18
struct zSurfMatFX {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x80157C8C -> 0x80157EA8
void zEnvRender(struct xEnv * env /* r30 */) {
    // Local variables
    struct RpWorld * world; // r28
    int num; // r22
    int i; // r29
    const struct xSurface * sp; // r27
    struct zSurfaceProps * pp; // r31
    int tdx; // r26
    struct RpMaterial * mp; // r25
    struct xGroup * g; // r24
    unsigned int texid; // r21
    struct RwTexture * texptr; // r23
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D62882
// Range: 0x80157EA8 -> 0x80157FA0
void zEnvSave(struct _zEnv * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80D6288B
// Range: 0x80157FA0 -> 0x80158098
void zEnvLoad(struct _zEnv * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80D62894
// Range: 0x80158098 -> 0x8015818C
void zEnvReset(struct _zEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6289E
struct xEnv * gCurXEnv; // size: 0x4, address: 0x80D69028
// Range: 0x8015818C -> 0x80158480
void zEnvEventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */, struct xBase * toParamWidget /* r31 */) {
    // References
    // -> struct xEnv * gCurXEnv;
    // -> struct zGlobals globals;
    // -> static char __FUNCTION__[12];
}

// Range: 0x80158480 -> 0x801584E0
struct xLightKit * zEnvGetGlobalObjectLightKit() {
    // Local variables
    struct _zEnv * zen; // r30
