/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zGame.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8016A2EC -> 0x801719F0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80D6E130
char __FUNCTION__$localstatic1$get_grid_index__6zGrassFii[15]; // size: 0xF, address: 0x80D62BD8
char __FUNCTION__$localstatic1$get_grid_index__6zGrassFRC5xVec3RC5xVec3RC5xVec3[15]; // size: 0xF, address: 0x80D62BE7
char __FUNCTION__$localstatic1$get_grid_box__6zGrassFi[13]; // size: 0xD, address: 0x80D62BF6
enum eFMVFile {
    eFMVFile_NoMovie = 0,
    eFMVFile_HeavyIronLOGO = 1,
    eFMVFile_PixarLOGO = 2,
    eFMVFile_DisneyLOGO = 3,
    eFMVFile_THQLOGO = 5,
    eFMVFile_D3 = 6,
    eFMVFile_PROMO1 = 7,
    eFMVFile_PROMO2 = 8,
    eFMVFile_PROMO3 = 9,
    eFMVFile_AttractMode1 = 10,
    eFMVFile_AttractMode2 = 11,
    eFMVFile_AttractMode3 = 12,
    eFMVFile_AttractMode4 = 13,
    eFMVFile_AttractMode5 = 14,
    eFMVFile_Title = 15,
    eFMVFile_Intro = 16,
    eFMVFile_IntroText = 17,
    eFMVFile_ut_o = 51,
    eFMVFile_dd_o = 52,
    eFMVFile_dd_e = 53,
    eFMVFile_b1_o = 54,
    ...
    eFMVFile_bb_e = 67,
    eFMVFile_ut_e = 68,
    eFMVFile_ChunkBot = 151,
    eFMVFile_TrenchBot = 152,
    eFMVFile_GrubBot = 153,
    eFMVFile_DrillBot = 154,
    eFMVFile_Excavator = 155,
    eFMVFile_WarkerBot = 156,
    eFMVFile_Bonus1 = 201,
    eFMVFile_Bonus2 = 202,
    eFMVFile_Bonus3 = 203,
    eFMVFile_Bonus4 = 204,
    ...
    eFMVFile_Bonus8 = 208,
    eFMVFile_Bonus9 = 209,
    eFMVFile_Bonus10 = 210,
    eFMVFile_Bonus11 = 211,
    eFMVFile_Bonus12 = 212,
    eFMVFileCount = 213,
};
// total size: 0xC
struct zFMVFile {
    ...
    const char * fileName; // offset 0x4, size 0x4
    unsigned int subtitleID; // offset 0x8, size 0x4
};
unsigned int gzAsyncRenderDisable; // size: 0x4, address: 0x80D6A198
static unsigned int sPlayerMarkerStartID; // size: 0x4, address: 0x80D6A19C
static float sGameOverTimer; // size: 0x4, address: 0x80D6A1A0
float sTimeElapsed; // size: 0x4, address: 0x80D6A1A4
float gRealTimeElapsed; // size: 0x4, address: 0x80D6A1A8
long long sTimeLast; // size: 0x8, address: 0x80D6A1B0
long long sTimeCurrent; // size: 0x8, address: 0x80D6A1B8
unsigned int gLevelChanged; // size: 0x4, address: 0x80D6A1C0
unsigned char gExitAfterPause; // size: 0x1, address: 0x80D6A1C4
static int sPlaybackForceDump; // size: 0x4, address: 0x80D6A1C8
static int g_hiphopReloadHIP; // size: 0x4, address: 0x80D6A1CC
static int g_hiphopForcePortal; // size: 0x4, address: 0x80D6A1D0
static int g_hiphopResetOnly; // size: 0x4, address: 0x80D6A1D4
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static unsigned char g_renderPreEffects; // size: 0x1, address: 0x80D62C03
unsigned int gzAsyncSceneID; // size: 0x4, address: 0x80D6A1D8
static int g_inited; // size: 0x4, address: 0x80D6A1DC
unsigned int gSoak; // size: 0x4, address: 0x80D6A1E0
float s_dbloop_elapsec; // size: 0x4, address: 0x80D6A1E4
static unsigned int s_dbloop_elaptick; // size: 0x4, address: 0x80D6A1E8
static float s_dbloop_fps; // size: 0x4, address: 0x80D6A1EC
static float s_curFPSCounterTime; // size: 0x4, address: 0x80D6A1F0
static float s_curFPSFrames; // size: 0x4, address: 0x80D6A1F4
static float s_curFPS; // size: 0x4, address: 0x80D6A1F8
static char switchSceneDest[4]; // size: 0x4, address: 0x80D6A1FC
static unsigned char switchScene; // size: 0x1, address: 0x80D6A200
...
// Range: 0x8016A2EC -> 0x8016A344
static void * ssMalloc(unsigned long size /* r1+0x8 */) {
    // References
...
// Range: 0x8016A344 -> 0x8016A378
static void ssFree(void * block /* r1+0x8 */) {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x8016A378 -> 0x8016A3B8
static void zGame_Loop_DBLogMsg() {
    // References
    // -> static float s_dbloop_fps;
    // -> float s_dbloop_elapsec;
    // -> static unsigned int s_dbloop_elaptick;
}

static int init; // size: 0x4, address: 0x80D6A204
static signed char init; // size: 0x1, address: 0x80D6A208
// Range: 0x8016A3B8 -> 0x8016A41C
static void zGame_Loop_DBLogInit() {
    // References
    // -> static int init;
    // -> static signed char init;
}

char * * soaklevels; // size: 0x4, address: 0x80D6A20C
static float SOAK_DELAY; // size: 0x4, address: 0x80D62C04
static float SOAK_DELAYRAND; // size: 0x4, address: 0x80D62C08
static float soaktime; // size: 0x4, address: 0x80D62C0C
int enableMenuMasher; // size: 0x4, address: 0x80D6A210
int enableAudioAnnihilator; // size: 0x4, address: 0x80D6A214
int enableSuperSoaker; // size: 0x4, address: 0x80D6A218
static int superSoak_simulatePlayerAction; // size: 0x4, address: 0x80D62C10
static unsigned int superSoakExtraPadOnInput; // size: 0x4, address: 0x80D6A21C
static unsigned int superSoakExtraPadPressInput; // size: 0x4, address: 0x80D6A220
// total size: 0x2
...
static struct _tagPadAnalog savedAnalog1; // size: 0x2, address: 0x80D6A224
static struct _tagPadAnalog savedAnalog2; // size: 0x2, address: 0x80D6A226
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct xPortalAsset dummyPortalAsset; // size: 0x18, address: 0x80CF1CF4
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct _zPortal dummyPortal; // size: 0x14, address: 0x80D6A228
static unsigned int loadMeter; // size: 0x4, address: 0x80D6A23C
static int sForceUpdateRate; // size: 0x4, address: 0x80D6A240
static int soakidx; // size: 0x4, address: 0x80D6A244
static signed char init; // size: 0x1, address: 0x80D6A248
static int soakcnt; // size: 0x4, address: 0x80D6A24C
static signed char init; // size: 0x1, address: 0x80D6A250
enum en_SOAK_DIR {
    SOAK_FOR = 0,
    SOAK_BACK = 1,
    SOAK_RAND = 2,
...
static enum en_SOAK_DIR soakdir; // size: 0x4, address: 0x80D6A254
static signed char init; // size: 0x1, address: 0x80D6A258
static int justwrap; // size: 0x4, address: 0x80D6A25C
static signed char init; // size: 0x1, address: 0x80D6A260
static unsigned int sumtotal; // size: 0x4, address: 0x80D6A264
static signed char init; // size: 0x1, address: 0x80D6A268
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D62C14
static int been_here; // size: 0x4, address: 0x80D6A26C
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D62C21
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
struct PlaybackStruct {
    // Members
    unsigned int on; // offset 0x0, size 0x4
    struct _tagPadAnalog analog1; // offset 0x4, size 0x2
    struct _tagPadAnalog analog2; // offset 0x6, size 0x2
    unsigned int randseed1; // offset 0x8, size 0x4
    unsigned int randseed2; // offset 0xC, size 0x4
};
// total size: 0xC
...
// Range: 0x8016A41C -> 0x8016A800
static unsigned int PickNextSoak() {
    // Local variables
    unsigned int nextsoak; // r29
    const char * name; // r31
    const char * spiral; // r30
    unsigned int tag; // r27
    int num_search; // r28
    char useme[5]; // r1+0x8

    // References
    // -> static unsigned int sumtotal;
    // -> static signed char init;
    ...
    // -> char * * soaklevels;
    // -> static int soakidx;
    // -> static enum en_SOAK_DIR soakdir;
    // -> static int justwrap;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
...
// Range: 0x8016A800 -> 0x8016A82C
static void * asyncLoadSubthread() {
    // References
    // -> unsigned int gzAsyncSceneID;
}

struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x8016A82C -> 0x8016A914
static void zGameInit_Guts(unsigned int theSceneID /* r30 */) {
    // Local variables
    int i; // r31
    ...
    // -> struct zGlobals globals;
    // -> static int g_hiphopForcePortal;
    // -> static int g_hiphopReloadHIP;
}
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D62C2E
unsigned int loadSceneID; // size: 0x4, address: 0x80D6B410
// total size: 0x4
class Screen {
    // Members
public:
...
// Range: 0x8016A914 -> 0x8016AB14
void zGameInit(unsigned int theSceneID /* r28 */) {
    // Local variables
    long long t; // r29
    int i; // r31
    class zLoadingScreen screen; // r1+0x8
...
// total size: 0x4
struct /* @class$2188zGame_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2189zGame_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$780zGame_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$781zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$782zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$783zGame_cpp */ {
    // Members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D62C38
// Range: 0x8016AB60 -> 0x8016AC90
void zGameExit() {
    // Local variables
    long long t; // r30
...
int sFrameRateMonitorDesiredFPS; // size: 0x4, address: 0x80D6A270
static char * FORCE_UPDATE_LABELS[13]; // size: 0x34, address: 0x8051EC98
static int FORCE_UPDATE_VALUES[13]; // size: 0x34, address: 0x8051ECCC
static char * FPS_MONITOR_LABELS[6]; // size: 0x18, address: 0x8051ED00
static int FPS_MONITOR_VALUES[6]; // size: 0x18, address: 0x8051ED18
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D62C42
struct _zEnv * gCurEnv; // size: 0x4, address: 0x80D6A88C
float VBLANKS_PER_SEC; // size: 0x4, address: 0x80D63010
// Range: 0x8016AC90 -> 0x8016B118
void zGameSetup() {
    // Local variables
    long long t; // r29
    ...
    // -> static int FPS_MONITOR_VALUES[6];
    // -> static char * FPS_MONITOR_LABELS[6];
    // -> int sFrameRateMonitorDesiredFPS;
    // -> int enableAudioAnnihilator;
    // -> static unsigned char g_renderPreEffects;
    // -> static int FORCE_UPDATE_VALUES[13];
    // -> static char * FORCE_UPDATE_LABELS[13];
    // -> static int sForceUpdateRate;
    // -> float VBLANKS_PER_SEC;
    // -> struct xGlobals * xglobals;
    // -> struct _zEnv * gCurEnv;
    // -> static char __FUNCTION__[11];
}

static long long t0; // size: 0x8, address: 0x80D6A278
static long long t1; // size: 0x8, address: 0x80D6A280
static long long w0; // size: 0x8, address: 0x80D6A288
static long long w1; // size: 0x8, address: 0x80D6A290
static long long gloop_time; // size: 0x8, address: 0x80D6A298
static long long gwait_time; // size: 0x8, address: 0x80D6A2A0
static int gloop_ct; // size: 0x4, address: 0x80D6A2A8
static float gloop_time_secs; // size: 0x4, address: 0x80D6A2AC
static float gwait_time_secs; // size: 0x4, address: 0x80D6A2B0
static float gloop_net_time_secs; // size: 0x4, address: 0x80D6A2B4
unsigned int gLastProfileDump; // size: 0x4, address: 0x80D6A2B8
// Range: 0x8016B118 -> 0x8016B174
void zGamePreRender() {
    // References
    // -> struct zGlobals globals;
    // -> static unsigned char g_renderPreEffects;
...
static float gc_max_dt; // size: 0x4, address: 0x80D6A2BC
static signed char init; // size: 0x1, address: 0x80D6A2C0
enum xSndHandle {
};
static enum xSndHandle hSound; // size: 0x4, address: 0x80D6A2C4
static signed char init; // size: 0x1, address: 0x80D6A2C8
enum iSndGroupHandle {
};
static enum iSndGroupHandle hSndGroup; // size: 0x4, address: 0x80D6A2CC
static signed char init; // size: 0x1, address: 0x80D6A2D0
static unsigned char initSavedInput; // size: 0x1, address: 0x80D6A2D1
static signed char init; // size: 0x1, address: 0x80D6A2D2
static float sAttractMode_timer; // size: 0x4, address: 0x80D6A2D4
static signed char init; // size: 0x1, address: 0x80D6A2D8
static float paccum; // size: 0x4, address: 0x80D6A2DC
static float pcount; // size: 0x4, address: 0x80D6A2E0
static int include_xcambegtime_too; // size: 0x4, address: 0x80D6A2E4
static signed char init; // size: 0x1, address: 0x80D6A2E8
static int displayToggle; // size: 0x4, address: 0x80D6A2EC
static signed char init; // size: 0x1, address: 0x80D6A2F0
// total size: 0x30
class xfont {
    // Members
public:
...
static class xfont debugStr; // size: 0x30, address: 0x8051ED30
static signed char init; // size: 0x1, address: 0x80D6A2F1
// total size: 0x14
struct tag_entry {
    // Members
    struct substr name; // offset 0x0, size 0x8
...
static class xtextbox tb; // size: 0x74, address: 0x8051ED60
static signed char init; // size: 0x1, address: 0x80D6A2F2
static struct _zPortal portal; // size: 0x14, address: 0x80D6A2F4
static struct xPortalAsset portalAsset; // size: 0x18, address: 0x80CF1D0C
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D62C4D
unsigned int gSceneFrameCount; // size: 0x4, address: 0x80D68CEC
// total size: 0x118
struct xStats {
    // Members
...
enum eGameMode gGameMode; // size: 0x4, address: 0x80D6A4F8
...
class zUICustom * pUICustomDropJoinSceneManager; // size: 0x4, address: 0x80D6B300
// total size: 0x20
struct DVDDiskID {
    // Members
...
// Range: 0x8016B174 -> 0x8016DD94
void zGameLoop() {
    // Local variables
    long long t; // r1+0xC8
    int ostrich_delay; // r1+0x80
    long long diff; // r1+0xC0
    float ratio; // f29
    signed short csncount; // r21
    int i; // r1+0x7C
    int cnum; // r26
    long long cpustat_sum; // r1+0xB8
    int startidx; // r1+0x78
    int port; // r20
    int i; // r27
    unsigned char padActive; // r1+0x16
    unsigned char anyMotion; // r1+0x15
    int i; // r30
    unsigned char initBailTimer; // r1+0x14
    int i; // r19
    int i; // r29
    struct PlaybackStruct * cur; // r1+0x74
    int j; // r31
    struct PlaybackStruct * cur; // r28
    unsigned int last_on; // r1+0x70
    int i; // r1+0x6C
    long long tprof0; // r1+0xB0
    long long tprof1; // r1+0xA8
    int i; // r1+0x68
    float elapsed; // f28
    float elapsed; // f27
    int k; // r25
    struct tag_xFile file; // r1+0x4A4
    char filename[128]; // r1+0x1A4
    int isPaused; // r18
    int i; // r1+0x64
    int i; // r1+0x60
    int i; // r17
    ...
    float gdt; // f31
    int asfg; // r1+0x58
    long long cpustat_camtime; // r1+0xA0
    long long cpustat_sumtoo; // r1+0x98
    char tmpStr[384]; // r1+0x324
    struct _tagxPad * pad; // r24
    int port; // r1+0x54
    struct zPlayer * human; // r23
    char * nextToken; // r1+0x50
    const char * foo; // r1+0x4C
    float y; // f30
    char str[8]; // r1+0x90
    char tmpstr[256]; // r1+0x224
    int memfree; // r1+0x48
    long long cpustat_sumthrice; // r1+0x88
    int j; // r1+0x44
    void * disp; // r1+0x40
    void * copy; // r1+0x3C
    unsigned char okToPause; // r1+0x13
    int startidx; // r1+0x38
    int trccount; // r22

    // References
    // -> int enableMenuMasher;
    // -> float sTimeElapsed;
    // -> unsigned char gExitAfterPause;
    // -> static struct _zPortal portal;
    // -> static struct xPortalAsset portalAsset;
    // -> static char switchSceneDest[4];
    // -> static unsigned char switchScene;
    // -> struct xStats gPendingStats;
    // -> class zUICustom * pUICustomDropJoinSceneManager;
    // -> static char __FUNCTION__[10];
    // -> struct zGlobals globals;
    // -> unsigned int gSceneFrameCount;
    // -> unsigned int gFrameCount;
    // -> enum xScreenDump gScreenDump;
    // -> int enableSuperSoaker;
    ...
    // -> static class xfont debugStr;
    // -> static signed char init;
    // -> static float s_dbloop_fps;
    // -> static int displayToggle;
    // -> static signed char init;
    // -> static int include_xcambegtime_too;
    // -> static int gloop_ct;
    // -> static long long gwait_time;
    // -> static float gwait_time_secs;
    // -> static long long w0;
    // -> static long long w1;
    // -> static signed char init;
    // -> enum eGameMode gGameMode;
    // -> static int sPlaybackForceDump;
    // -> unsigned int gLastProfileDump;
    // -> static int sForceUpdateRate;
    // -> unsigned int xprintf_display;
    // -> static float sAttractMode_timer;
    // -> static signed char init;
    // -> static struct _tagPadAnalog savedAnalog2;
    // -> static struct _tagPadAnalog savedAnalog1;
    // -> static unsigned int superSoakExtraPadPressInput;
    // -> static unsigned int superSoakExtraPadOnInput;
    // -> static unsigned char initSavedInput;
    // -> static signed char init;
    // -> unsigned int gSoak;
    // -> static long long gloop_time;
    // -> static float gloop_net_time_secs;
    // -> static float gloop_time_secs;
    // -> static long long t0;
    // -> static long long t1;
    // -> long long sTimeCurrent;
    // -> long long sTimeLast;
    // -> float VBLANKS_PER_SEC;
    // -> struct xStats gStats;
    // -> static float s_curFPSFrames;
    // -> static float s_curFPSCounterTime;
    // -> static float s_curFPS;
    // -> float gRealTimeElapsed;
    // -> float s_dbloop_elapsec;
    // -> static unsigned int s_dbloop_elaptick;
    // -> float SECS_PER_VBLANK;
    // -> static enum xSndHandle hSound;
    // -> static enum iSndGroupHandle hSndGroup;
    // -> int sFrameRateMonitorDesiredFPS;
    // -> static signed char init;
    // -> static signed char init;
    // -> static float gc_max_dt;
    // -> static signed char init;
    // -> int gWasDiskError;
}

// total size: 0x2
struct /* @class$1006zGame_cpp */ {
    // Members
...
// Range: 0x8016DD94 -> 0x8016DE28
int zGameIsPaused() {
    // References
    // -> enum eGameMode gGameMode;
}

int gGameState; // size: 0x4, address: 0x80D62D30
// Range: 0x8016DE28 -> 0x8016DEF8
static int zGameLoopContinue() {
    // References
    // -> static long long t1;
    // -> long long sTimeLast;
    // -> enum eGameMode gGameMode;
...
// Range: 0x8016DEF8 -> 0x8016DF74
enum pause_ability zGameOkToPause() {
    // Local variables
    int startidx; // r1+0x8
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80D62C57
// Range: 0x8016DF74 -> 0x8016E090
void zGamePause() {
    // Local variables
    long long t; // r30
...
// Range: 0x8016E090 -> 0x8016E118
void zGamePauseIfPossible() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8016E118 -> 0x8016E11C
void zGameStall() {}
...
void * barray[1024]; // size: 0x1000, address: 0x80CF1D24
unsigned long sarray[1024]; // size: 0x1000, address: 0x80CF2D24
unsigned long bvisited; // size: 0x4, address: 0x80D6A308
// Range: 0x8016E11C -> 0x8016E168
static void visit_heap(void * block /* r3 */, unsigned long size /* r4 */) {
    // References
    // -> unsigned long bvisited;
    // -> unsigned long sarray[1024];
    // -> void * barray[1024];
}

long mem_free_size; // size: 0x4, address: 0x80D62C64
long omem_free_size; // size: 0x4, address: 0x80D62C68
int the_heap; // size: 0x4, address: 0x80D69AD4
// Range: 0x8016E168 -> 0x8016E214
void scene_switch_mem_check() {
    // References
    // -> unsigned long bvisited;
    // -> long omem_free_size;
    // -> long mem_free_size;
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D62C6C
...
enum _tagTRCState {
    ...
    TRC_PadInserted = 2,
    TRC_PadActive = 3,
    TRC_PadPreInserted = 4,
    TRC_PadInvalidNoAnalog = 5,
    TRC_PadInvalidType = 6,
    TRC_DiskNotIdentified = 7,
    TRC_DiskIdentified = 8,
    TRC_DiskTrayOpen = 9,
    TRC_DiskTrayClosed = 10,
    TRC_DiskNoDisk = 11,
    TRC_DiskInvalid = 12,
    TRC_DiskRetry = 13,
    TRC_DiskFatal = 14,
...
// Range: 0x8016E214 -> 0x8016E8D4
static void zGameUpdateMode() {
    // Local variables
    int startidx; // r1+0xC
    struct _tagxPad * pad; // r31
    int port; // r27
    enum _tagTRCState state; // r25
    int startpadidx; // r1+0x8
    int padcount; // r28
    struct xPortalAsset * passet; // r30
    unsigned int nextSceneID; // r24
    unsigned int sPlayerMarkerStartCamID; // r26
    int i; // r29

    // References
    // -> static float sGameOverTimer;
    // -> int gGameState;
    // -> float sTimeElapsed;
    // -> struct xColor_tag g_BLACK;
    ...
    // -> static int g_hiphopResetOnly;
    // -> struct _tagxPad mPad[4];
    // -> int enableSuperSoaker;
    // -> static float SOAK_DELAYRAND;
    // -> static float SOAK_DELAY;
    // -> static float soaktime;
    // -> struct _zPortal dummyPortal;
    // -> struct xPortalAsset dummyPortalAsset;
    // -> float SECS_PER_VBLANK;
    // -> unsigned int gSoak;
    // -> enum eGameMode gGameMode;
}

struct RwCamera * sGameScreenTransCam; // size: 0x4, address: 0x80D6A30C
static struct RpWorld * gWorld; // size: 0x4, address: 0x80D6A310
static struct RpLight * DirectionalLight; // size: 0x4, address: 0x80D6A314
// Range: 0x8016E8D4 -> 0x8016E8D8
void zGameTakeSnapShot() {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x8051EDD4
...
// Range: 0x8016E8D8 -> 0x8016EBD0
void zGameScreenTransitionBegin() {
    // Local variables
    long long t; // r30
    struct RwFrame * frame; // r29
    struct RwRGBAReal col; // r1+0x8
    struct RwBBox box; // r1+0x18

    // References
    // -> struct RwCamera * sGameScreenTransCam;
    // -> static struct RpWorld * gWorld;
    // -> static char __FUNCTION__[27];
    // -> static struct RpLight * DirectionalLight;
    // -> unsigned int FB_YRES;
    // -> unsigned int FB_XRES;
    // -> struct zGlobals globals;
}

// Range: 0x8016EBD0 -> 0x8016EC24
void zGameScreenTransitionUpdate(float percentComplete /* r1+0x8 */, char * msg /* r1+0xC */) {
    // References
    // -> struct zGlobals globals;
}

unsigned int bgID; // size: 0x4, address: 0x80D62C7C
float bgu1; // size: 0x4, address: 0x80D6A318
float bgv1; // size: 0x4, address: 0x80D6A31C
float bgu2; // size: 0x4, address: 0x80D62C80
float bgv2; // size: 0x4, address: 0x80D62C84
unsigned char bgr; // size: 0x1, address: 0x80D62C88
unsigned char bgg; // size: 0x1, address: 0x80D62C89
unsigned char bgb; // size: 0x1, address: 0x80D62C8A
unsigned char bga; // size: 0x1, address: 0x80D62C8B
static char __FUNCTION__[28]; // size: 0x1C, address: 0x8051EDEF
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x8016EC24 -> 0x8016F094
void zGameScreenTransitionUpdate(float percentComplete /* r1+0x8 */, char * msg /* r27 */, unsigned char * rgba /* r31 */) {
    // Local variables
    struct RwRGBA back_col; // r1+0x10
    struct RwTexture * tex; // r30
    struct RwRaster * ras; // r29
    float recipCamZ; // r1+0xC
    struct rwGameCube2DVertex vx[4]; // r1+0x14
    float z; // f31
    char meter[256]; // r1+0x74
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8051EE0B
// Range: 0x8016F094 -> 0x8016F1F0
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D62C8C
// Range: 0x8016F1F0 -> 0x8016F364
void zGameInitPlayer() {
    // Local variables
    struct xEntAsset * asset; // r30
    int playerCount; // r28
    int i; // r31
    unsigned int playerTag; // r29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80D62C9C
// Range: 0x8016F364 -> 0x8016F444
...
// Range: 0x8016F444 -> 0x8016F570
static void zGameResetPlayerToSceneStart() {
    // Local variables
    struct pointer_asset * pointer; // r30
    struct xEntFrame * frame; // r31
    struct xMarkerAsset * marker; // r29
...
static int been_here; // size: 0x4, address: 0x80D6A320
static int been_here; // size: 0x4, address: 0x80D6A324
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8051EE24
// Range: 0x8016F570 -> 0x8016F6D4
static void zGame_hiphop_setupPending(struct zScene * zscn /* r29 */, struct _zPortal * port /* r25 */, struct xPortalAsset * pass /* r31 */) {
    // Local variables
    unsigned int camid; // r28
    char * src; // r27
    char * tgt; // r26
    int i; // r30
...
static struct _zPortal fakePortal; // size: 0x14, address: 0x80D6A328
static struct xPortalAsset fakePortalAsset; // size: 0x18, address: 0x80CF3D24
// Range: 0x8016F6D4 -> 0x8016F8D0
static void zGame_DM_reloadCB() {
    // Local variables
    struct zScene * zscn; // r30
    const char * pmsg; // r31

    // References
    // -> static struct xPortalAsset fakePortalAsset;
    // -> static struct _zPortal fakePortal;
    // -> static int g_hiphopForcePortal;
    // -> static int g_hiphopResetOnly;
    // -> static int g_hiphopReloadHIP;
    // -> struct zGlobals globals;
...
static float lastTime; // size: 0x4, address: 0x80D6A33C
static signed char init; // size: 0x1, address: 0x80D6A340
static float presentTime; // size: 0x4, address: 0x80D6A344
static signed char init; // size: 0x1, address: 0x80D6A348
static const char * TXT_DEMO; // size: 0x4, address: 0x80D6A34C
static signed char init; // size: 0x1, address: 0x80D6A350
static class xtextbox tb; // size: 0x74, address: 0x8051EE40
static signed char init; // size: 0x1, address: 0x80D6A351
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D62CAD
// Range: 0x8016F8D0 -> 0x8016FD90
void zGameDemoText(float fTime /* f30 */) {
    // Local variables
    float elapsedTime; // f29
    float fAlpha; // f31
    float fPot; // f28
    float fPot; // f27
    unsigned char alpha; // r31
    ...
    // References
    // -> static class xtextbox tb;
    // -> static const char * TXT_DEMO;
    // -> static signed char init;
    // -> static float presentTime;
...
static int max_nextPickupMove; // size: 0x4, address: 0x80D6A354
static signed char init; // size: 0x1, address: 0x80D6A358
static int max_nextMove; // size: 0x4, address: 0x80D6A35C
static signed char init; // size: 0x1, address: 0x80D6A360
static int max_nextKillNPC; // size: 0x4, address: 0x80D6A364
static signed char init; // size: 0x1, address: 0x80D6A368
static int max_nextKillPlayer; // size: 0x4, address: 0x80D6A36C
static signed char init; // size: 0x1, address: 0x80D6A370
static int max_nextOOBTest; // size: 0x4, address: 0x80D6A374
static signed char init; // size: 0x1, address: 0x80D6A378
static int max_nextPlayerAction; // size: 0x4, address: 0x80D6A37C
static signed char init; // size: 0x1, address: 0x80D6A380
static int max_nextPlayerSwitch; // size: 0x4, address: 0x80D6A384
static signed char init; // size: 0x1, address: 0x80D6A388
static int max_nextRunScript; // size: 0x4, address: 0x80D6A38C
static signed char init; // size: 0x1, address: 0x80D6A390
static int max_nextMoveAnalogSticks; // size: 0x4, address: 0x80D6A394
static signed char init; // size: 0x1, address: 0x80D6A398
static int min_nextInAHurry; // size: 0x4, address: 0x80D6A39C
static signed char init; // size: 0x1, address: 0x80D6A3A0
static int max_nextInAHurry; // size: 0x4, address: 0x80D6A3A4
static signed char init; // size: 0x1, address: 0x80D6A3A8
static int cnt_nextPickupMove; // size: 0x4, address: 0x80D6A3AC
static signed char init; // size: 0x1, address: 0x80D6A3B0
static int cnt_nextMove; // size: 0x4, address: 0x80D6A3B4
static signed char init; // size: 0x1, address: 0x80D6A3B8
static int cnt_nextKillNPC; // size: 0x4, address: 0x80D6A3BC
static signed char init; // size: 0x1, address: 0x80D6A3C0
static int cnt_nextKillPlayer; // size: 0x4, address: 0x80D6A3C4
static signed char init; // size: 0x1, address: 0x80D6A3C8
static int cnt_nextOOBTest; // size: 0x4, address: 0x80D6A3CC
static signed char init; // size: 0x1, address: 0x80D6A3D0
static int cnt_nextPlayerAction; // size: 0x4, address: 0x80D6A3D4
static signed char init; // size: 0x1, address: 0x80D6A3D8
static int cnt_nextPlayerSwitch; // size: 0x4, address: 0x80D6A3DC
static signed char init; // size: 0x1, address: 0x80D6A3E0
static int cnt_nextRunScript; // size: 0x4, address: 0x80D6A3E4
static signed char init; // size: 0x1, address: 0x80D6A3E8
static int cnt_nextMoveAnalogSticks; // size: 0x4, address: 0x80D6A3EC
static signed char init; // size: 0x1, address: 0x80D6A3F0
static int cnt_nextInAHurry; // size: 0x4, address: 0x80D6A3F4
static signed char init; // size: 0x1, address: 0x80D6A3F8
static int workOn; // size: 0x4, address: 0x80D6A3FC
static signed char init; // size: 0x1, address: 0x80D6A400
static int onElsePress; // size: 0x4, address: 0x80D6A404
static signed char init; // size: 0x1, address: 0x80D6A408
static int idx_action; // size: 0x4, address: 0x80D6A40C
static signed char init; // size: 0x1, address: 0x80D6A410
// total size: 0x14
...
// Range: 0x8016FD90 -> 0x801705D4
static void MoveThePlayerAround() {
    // Local variables
    struct zScene & s; // r30
    struct _zScript * scriptlist; // r23
    int idx_count; // r22
    int idx_torun; // r21
    struct _zScript * script; // r28
    int predictableActionTable[40]; // r1+0x48
    int randomActionTable[16]; // r1+0x8
    int action; // r31
    int num_action; // r29
    int numSimulKeyPresses; // r20
    int i; // r27

    // References
    // -> static struct _tagPadAnalog savedAnalog2;
    // -> static struct _tagPadAnalog savedAnalog1;
    // -> static int max_nextMoveAnalogSticks;
    // -> static int cnt_nextMoveAnalogSticks;
    // -> int enableMenuMasher;
    // -> static unsigned int superSoakExtraPadPressInput;
    // -> static unsigned int superSoakExtraPadOnInput;
    // -> static int onElsePress;
    // -> static int idx_action;
    // -> static signed char init;
    // -> static signed char init;
    // -> static int max_nextPlayerAction;
    // -> static int cnt_nextPlayerAction;
    // -> static int superSoak_simulatePlayerAction;
    // -> struct zGlobals globals;
    // -> static int max_nextInAHurry;
    // -> static int min_nextInAHurry;
    // -> static int cnt_nextInAHurry;
    // -> struct xGlobals * xglobals;
    // -> static int max_nextRunScript;
    // -> static int cnt_nextRunScript;
    // -> static int max_nextMove;
    // -> static int cnt_nextMove;
    // -> static int cnt_nextPlayerSwitch;
    // -> static int cnt_nextOOBTest;
    // -> static int cnt_nextKillPlayer;
    // -> static int cnt_nextKillNPC;
    // -> static float soaktime;
    // -> static signed char init;
    // -> static int workOn;
    // -> static float SOAK_DELAYRAND;
    // -> static float SOAK_DELAY;
    // -> static int cnt_nextPickupMove;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static int max_nextPlayerSwitch;
    // -> static signed char init;
    // -> static signed char init;
    // -> static int max_nextOOBTest;
    // -> static signed char init;
    // -> static int max_nextKillPlayer;
    // -> static signed char init;
    // -> static int max_nextKillNPC;
    // -> static signed char init;
    // -> static signed char init;
    // -> static int max_nextPickupMove;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
...
static int nextButtonPress; // size: 0x4, address: 0x80D6A414
static signed char init; // size: 0x1, address: 0x80D6A418
// Range: 0x801705D4 -> 0x8017071C
static void SpamTheFaceButtons() {
    // Local variables
    int framesBetweenSpam; // r30
    int faceButtons[10]; // r1+0x8
    int numButtonPresses; // r28
    int i; // r31
    int arrayIndex; // r27

    // References
    // -> static unsigned int superSoakExtraPadPressInput;
    // -> static int nextButtonPress;
    // -> static unsigned int superSoakExtraPadOnInput;
    // -> static signed char init;
    // -> static struct _tagPadAnalog savedAnalog2;
    // -> static struct _tagPadAnalog savedAnalog1;
...
static int num_nextKeyPress; // size: 0x4, address: 0x80D6A41C
static signed char init; // size: 0x1, address: 0x80D6A420
static int num_nextAnalogMovement; // size: 0x4, address: 0x80D6A424
static signed char init; // size: 0x1, address: 0x80D6A428
static int cnt_nextKeyPress; // size: 0x4, address: 0x80D6A42C
static signed char init; // size: 0x1, address: 0x80D6A430
static int cnt_nextAnalogMovement; // size: 0x4, address: 0x80D6A434
static signed char init; // size: 0x1, address: 0x80D6A438
static float weightTable[18]; // size: 0x48, address: 0x8051EEB4
static int needNormalize; // size: 0x4, address: 0x80D6A43C
static signed char init; // size: 0x1, address: 0x80D6A440
static long long tym_last; // size: 0x8, address: 0x80D6A448
static signed char init; // size: 0x1, address: 0x80D6A450
static int enableLogging; // size: 0x4, address: 0x80D6A454
static signed char init; // size: 0x1, address: 0x80D6A458
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D62CBB
static int been_here; // size: 0x4, address: 0x80D6A45C
static char __FUNCTION__[13]; // size: 0xD, address: 0x80D62CCB
// Range: 0x8017071C -> 0x80170B70
static void DoTheMenuMasher() {
    // Local variables
    int actionTable[18]; // r1+0x50
    char * strz_action[18]; // r1+0x8
    int action; // r26
    float sum; // f31
    int i; // r28
    int i; // r27
    ...
    // References
    // -> static unsigned int superSoakExtraPadPressInput;
    // -> static long long tym_last;
    // -> static int enableLogging;
    // -> static signed char init;
    // -> static float weightTable[18];
    // -> static char __FUNCTION__[16];
    // -> static int needNormalize;
    // -> static signed char init;
    // -> static signed char init;
    // -> static unsigned int superSoakExtraPadOnInput;
    // -> static int num_nextKeyPress;
    // -> static int cnt_nextKeyPress;
    // -> static struct _tagPadAnalog savedAnalog1;
    // -> static int num_nextAnalogMovement;
    // -> static int cnt_nextAnalogMovement;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
...
static int numLooped; // size: 0x4, address: 0x80D6A460
static signed char init; // size: 0x1, address: 0x80D6A464
// total size: 0xC
struct loopedSound {
    // Members
    enum xSndHandle sndHandle; // offset 0x0, size 0x4
    float stopTime; // offset 0x4, size 0x4
    unsigned char streamed; // offset 0x8, size 0x1
};
static struct loopedSound looped[256]; // size: 0xC00, address: 0x80CF3D3C
static float num_nextPlayFixed; // size: 0x4, address: 0x80D6A468
static signed char init; // size: 0x1, address: 0x80D6A46C
static float num_nextPlayRand; // size: 0x4, address: 0x80D6A470
static signed char init; // size: 0x1, address: 0x80D6A474
static int num_nextEcho; // size: 0x4, address: 0x80D6A478
static signed char init; // size: 0x1, address: 0x80D6A47C
static int cnt_nextPlay; // size: 0x4, address: 0x80D6A480
static signed char init; // size: 0x1, address: 0x80D6A484
static int cnt_nextEcho; // size: 0x4, address: 0x80D6A488
static signed char init; // size: 0x1, address: 0x80D6A48C
static int echo_on; // size: 0x4, address: 0x80D6A490
static signed char init; // size: 0x1, address: 0x80D6A494
static float remainingTime; // size: 0x4, address: 0x80D6A498
static signed char init; // size: 0x1, address: 0x80D6A49C
static struct xVec3 pos_sound; // size: 0xC, address: 0x80D62CD8
static signed char init; // size: 0x1, address: 0x80D6A49D
static struct xVec3 vel_sound; // size: 0xC, address: 0x80D62CE4
static signed char init; // size: 0x1, address: 0x80D6A49E
static int moveAndOrbit; // size: 0x4, address: 0x80D6A4A0
static signed char init; // size: 0x1, address: 0x80D6A4A4
static float cycle; // size: 0x4, address: 0x80D6A4A8
static signed char init; // size: 0x1, address: 0x80D6A4AC
static float rad_orbitBase; // size: 0x4, address: 0x80D6A4B0
static signed char init; // size: 0x1, address: 0x80D6A4B4
static float height; // size: 0x4, address: 0x80D6A4B8
static signed char init; // size: 0x1, address: 0x80D6A4BC
static int doDebugDraw; // size: 0x4, address: 0x80D6A4C0
static signed char init; // size: 0x1, address: 0x80D6A4C4
static struct xVec3 pos_plyrLast; // size: 0xC, address: 0x80D62CF0
static signed char init; // size: 0x1, address: 0x80D6A4C5
...
// Range: 0x80170B70 -> 0x80171218
static void DoTheAudioAnnihilator(float dt /* r1+0x8 */) {
    // Local variables
    int i; // r31
    float nextSoundTime; // f30
    int cnt_soundGroups; // r29
    int idx_toPlay; // r28
    unsigned int size; // r1+0x14
    void * asset; // r30
    enum iSndGroupHandle groupHandle; // r27
    float ang; // f29
    float cv; // f31
    float sv; // f27
    float rad_orbit; // f28
    enum xSndHandle sndH; // r1+0x10

    // References
    // -> static float remainingTime;
    // -> static int numLooped;
    // -> static struct loopedSound looped[256];
    // -> static struct xVec3 vel_sound;
    // -> static struct xVec3 pos_sound;
    // -> struct xGlobals * xglobals;
    // -> struct xColor_tag g_FORESTGREEN;
    // -> static int doDebugDraw;
    // -> static float height;
    // -> struct xVec3 g_Y3;
    // -> struct xVec3 g_Z3;
    // -> struct xVec3 g_X3;
    // -> static float rad_orbitBase;
    // -> static struct xVec3 pos_plyrLast;
    // -> static signed char init;
    // -> struct xVec3 g_O3;
    // -> static signed char init;
    // -> static signed char init;
    ...
    // -> static float cycle;
    // -> static signed char init;
    // -> static int moveAndOrbit;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static float num_nextPlayRand;
    // -> static float num_nextPlayFixed;
    // -> static signed char init;
    // -> static int echo_on;
    // -> static signed char init;
    // -> static int num_nextEcho;
    // -> static int cnt_nextEcho;
    // -> static signed char init;
    // -> static signed char init;
    // -> static int cnt_nextPlay;
    // -> static signed char init;
    // -> static signed char init;
    // -> static signed char init;
    // -> static float SOAK_DELAYRAND;
...
// Range: 0x80171218 -> 0x801715E8
static void zGameSndInitListener() {
    // Local variables
    struct xMat4x3 playerMat; // r1+0x40
    int NumberOfPlayers; // r26
    int NumberOfHumanPlayers; // r25
    int HumanPlayerNumber; // r24
    int i; // r28
    struct xVec3 max; // r1+0x34
    struct xVec3 min; // r1+0x28
    struct xMat4x3 * curPlayerMat; // r31
    int i; // r27
    struct xVec3 max; // r1+0x1C
    struct xVec3 min; // r1+0x10
    struct xMat4x3 * curPlayerMat; // r30
    int i; // r29
...
// total size: 0x20
struct xSndGroupHeader : public xBaseAsset {
    // Members
    ...
    unsigned char uLastSelected; // offset 0x13, size 0x1
    float fInnerRadius; // offset 0x14, size 0x4
    float fOuterRadius; // offset 0x18, size 0x4
    const char * pszGroupName; // offset 0x1C, size 0x4
};
// total size: 0x10
...
struct xSndGroup {
    // Members
    struct xSndGroupHeader header; // offset 0x0, size 0x20
    struct xSndGroupInfo aSndGroupInfo[]; // offset 0x20, size 0x0
};
// total size: 0x4
struct iSndHandle {
    // Members
private:
    unsigned int voiceRef : 8; // offset 0x0, size 0x4
    unsigned int uniqueId : 24; // offset 0x0, size 0x4
};
// total size: 0x0
...
struct iSndInfo {
    // Members
    struct FSOUND_STREAM * pStream; // offset 0x0, size 0x4
    int nChannel; // offset 0x4, size 0x4
};
// total size: 0x8
struct gcWavInfo {
    // Members
    unsigned int uAssetID; // offset 0x0, size 0x4
    unsigned char uFlags; // offset 0x4, size 0x1
    unsigned char uAudioSampleIndex; // offset 0x5, size 0x1
    unsigned char uFSBIndex; // offset 0x6, size 0x1
    unsigned char uSoundInfoIndex; // offset 0x7, size 0x1
};
// total size: 0x8
struct iSndFileInfo : public gcWavInfo {};
// total size: 0x6C
struct xSndVoiceInfo {
    // Members
    int flags; // offset 0x0, size 0x4
    union { // inferred
        struct xSndGroup * soundGroup; // offset 0x4, size 0x4
        enum iSndGroupHandle soundGroupHandle; // offset 0x4, size 0x4
    };
    unsigned int assetID; // offset 0x8, size 0x4
    union { // inferred
        enum xSndHandle sndUniqueID; // offset 0xC, size 0x4
        struct iSndHandle sndID; // offset 0xC, size 0x4
    };
    struct xEnt * pParent; // offset 0x10, size 0x4
    const struct xVec3 * pPosition; // offset 0x14, size 0x4
    float vol; // offset 0x18, size 0x4
    float assetVol; // offset 0x1C, size 0x4
    float xpitch; // offset 0x20, size 0x4
    float dopplerFreqCoef; // offset 0x24, size 0x4
    signed short category; // offset 0x28, size 0x2
    unsigned char bformerlyAPartOfPriority; // offset 0x2A, size 0x1
    unsigned char priority; // offset 0x2B, size 0x1
    struct xVec3 actualPos; // offset 0x2C, size 0xC
    struct xVec3 playPos; // offset 0x38, size 0xC
    const struct xVec3 * pVelocity; // offset 0x44, size 0x4
    struct xVec3 actualVelocity; // offset 0x48, size 0xC
    float distToListener; // offset 0x54, size 0x4
    float innerRadius; // offset 0x58, size 0x4
    float outerRadius; // offset 0x5C, size 0x4
    struct iSndInfo ps; // offset 0x60, size 0x8
    struct iSndFileInfo * pSndFileInfo; // offset 0x68, size 0x4
};
// total size: 0x4
struct xSndVoiceRefInfo {
    // Members
private:
    unsigned int voiceIndex : 8; // offset 0x0, size 0x4
    unsigned int uniqueId : 24; // offset 0x0, size 0x4
};
// total size: 0x4
class xSpringy {
...
enum eSndListenerSpringType {
    eListenerSpringType_None = 0,
    eListenerSpringType_Soft = 1,
    eListenerSpringType_Hard = 2,
};
enum xSndMode {
    xSndMode_Mono = 0,
    xSndMode_Stereo = 1,
...
struct xSndGlobals {
    // Static members
    static float speedOfSound; // size: 0x4

    // Members
    struct xSndVoiceInfo voice[256]; // offset 0x0, size 0x6C00
    struct xSndVoiceRefInfo voiceRefs[256]; // offset 0x6C00, size 0x400
    struct xMat4x3 listenerMat[2]; // offset 0x7000, size 0x80
    struct xVec3 listenerVel[2]; // offset 0x7080, size 0x18
    struct xVec3 right; // offset 0x7098, size 0xC
    struct xVec3 up; // offset 0x70A4, size 0xC
    struct xVec3 at; // offset 0x70B0, size 0xC
    struct xVec3 pos; // offset 0x70BC, size 0xC
    struct xVec3 velocity; // offset 0x70C8, size 0xC
    class xSpringyVec3 springyPos; // offset 0x70D4, size 0x28
    enum eSndListenerSpringType sndListenerSpringType; // offset 0x70FC, size 0x4
    unsigned int m_uSndMgrFlags; // offset 0x7100, size 0x4
    enum xSndMode sndMode; // offset 0x7104, size 0x4
    unsigned int SndCount; // offset 0x7108, size 0x4
    enum xSndListener listenerMode; // offset 0x710C, size 0x4
};
struct xSndGlobals gSnd; // size: 0x7110, address: 0x80B9D430
float speedOfSound; // size: 0x4, address: 0x80D60EB8
enum xSndListener {
    xSndListener_CAMERA = 0,
    xSndListener_PLAYER = 1,
    xSndListener_MAX_TYPES = 2,
};
static int PrevHumanPlayerNumber; // size: 0x4, address: 0x80D6A4C8
static signed char init; // size: 0x1, address: 0x80D6A4CC
// Range: 0x801715E8 -> 0x801719F0
static void zGameSndListenerUpdate(float dt /* f31 */) {
    // Local variables
    struct xMat4x3 playerMat; // r1+0xA0
    struct xVec3 playerVel; // r1+0x4C
    struct xMat4x3 cameraMat; // r1+0x60
    int NumberOfHumanPlayers; // r29
    int HumanPlayerNumber; // r31
    int i; // r30
    struct xVec3 camLookAt; // r1+0x40
    struct xVec3 camPos; // r1+0x34
    float cameraPlayerBias; // f30
    struct xVec3 playerLisPos; // r1+0x28
    struct xVec3 player0Vel; // r1+0x1C
    struct xVec3 player1Vel; // r1+0x10

    // References
    // -> static int PrevHumanPlayerNumber;
    // -> static signed char init;
    // -> struct zGlobals globals;
    // -> float sTimeElapsed;
    // -> struct xGlobals * xglobals;
...
// total size: 0x18
struct {} zAsync::Screen::__vtable; // size: 0x18, address: 0x8051EEFC
