/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameCongaLine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032BA08 -> 0x8032BD18
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x7C
struct {} zMiniGameCongaLine::__vtable; // size: 0x7C, address: 0x8052E180
// total size: 0x18
struct zMiniGameAssetCongaLine : public zMiniGameAsset {
    // Members
    unsigned int firstStageID; // offset 0x14, size 0x4
};
// total size: 0x2C
class zMiniGameCongaLine : public zMiniGameBase {
    // Functions
    zMiniGameCongaLine(struct zMiniGameAsset * a);

    void SceneSetup();
};
// Range: 0x8032BA08 -> 0x8032BA54
// this: r31
zMiniGameCongaLine::zMiniGameCongaLine(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGameCongaLine::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67968
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$932zMiniGameCongaLine_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1094zMiniGameCongaLine_cpp */ {
    // Members
...
union /* @class$1078zMiniGameCongaLine_cpp */ {
...
// total size: 0x10
struct /* @class$1630zMiniGameCongaLine_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1873zMiniGameCongaLine_cpp */ {
    // Static members
...
// Range: 0x8032BA54 -> 0x8032BCD4
void zMiniGameCongaLine::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r27 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zMiniGameCongaLine * instance; // r28
...
// Range: 0x8032BCD4 -> 0x8032BD08
// this: r1+0x8
void zMiniGameCongaLine::SceneSetup() {}

// Range: 0x8032BD08 -> 0x8032BD0C
void zMiniGameCongaLine::Update() {}

// Range: 0x8032BD0C -> 0x8032BD10
void zMiniGameCongaLine::Render() {}

// Range: 0x8032BD10 -> 0x8032BD14
void zMiniGameCongaLine::Reset() {}

// Range: 0x8032BD14 -> 0x8032BD18
void zMiniGameCongaLine::AddTweaks() {}
