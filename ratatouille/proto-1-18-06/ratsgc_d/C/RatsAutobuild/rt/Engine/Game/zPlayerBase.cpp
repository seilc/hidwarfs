/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPlayerBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8019EB5C -> 0x8019F224
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sMemDepthJustHIPStartPlayer; // size: 0x4, address: 0x80D634F0
static float time_scale; // size: 0x4, address: 0x80D6A720
static signed char init; // size: 0x1, address: 0x80D6A724
static unsigned char _temp_tweaks_registered; // size: 0x1, address: 0x80D6A725
static signed char init; // size: 0x1, address: 0x80D6A726
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$932zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1113zPlayerBase_cpp */ {
    // Members
...
union /* @class$644zPlayerBase_cpp */ {
...
// total size: 0x10
struct /* @class$1656zPlayerBase_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8019EB5C -> 0x8019ECF8
void zPlayerUpdate(struct xEnt * ent /* r1+0x8 */, struct xScene * sc /* r1+0xC */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$1899zPlayerBase_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$873zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$874zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$875zPlayerBase_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$876zPlayerBase_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$877zPlayerBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$878zPlayerBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$879zPlayerBase_cpp */ {
    // Members
...
// Range: 0x8019ECF8 -> 0x8019ED48
void zPlayerRender(struct zEnt * ent /* r1+0x8 */) {
    // Local variables
    struct zPlayer * player; // r31
}

// Range: 0x8019ED48 -> 0x8019ED88
void zPlayerReset(struct zEnt * ent /* r1+0x8 */) {
    // Local variables
    struct zPlayer * player; // r31
}

// Range: 0x8019ED88 -> 0x8019EDE0
void zPlayerMove(struct xEnt * ent /* r1+0x8 */, struct xScene * s /* r1+0xC */, float dt /* r1+0x10 */, struct xEntFrame * frame /* r1+0x14 */) {
    // Local variables
    struct zPlayer * player; // r31
}

// Range: 0x8019EDE0 -> 0x8019EEF4
void zPlayerLoadHIP(unsigned int gameSceneID /* r27 */) {
    // Local variables
    int playerCount; // r1+0xC
    unsigned int playersToLoad; // r1+0x8
    unsigned int tagPlayer; // r29
    unsigned char playerHipLoaded[9]; // r1+0x10
    int j; // r31
    int i; // r30
    ...
    // References
    // -> struct zGlobals globals;
    // -> static int sMemDepthJustHIPStartPlayer;
}

struct xGlobals * xglobals; // size: 0x4, address: 0x80D63020
// Range: 0x8019EEF4 -> 0x8019F00C
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x8051FBE0
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8019F00C -> 0x8019F108
void zPlayer_StoreCheckPoint(const struct zPlayerCheckPoint * checkPoints /* r1+0x8 */, unsigned int initialCameraID /* r1+0xC */) {
    // Local variables
    int i; // r31
...
// Range: 0x8019F108 -> 0x8019F1C0
void zPlayerSceneInit(unsigned int sceneID /* r30 */) {
    // Local variables
    int i; // r31
