/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zHUDCompass.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8032EEC8 -> 0x803306D0
*/
// Range: 0x8032EEC8 -> 0x8032EF24
static int zHUDCompassObjectSort(void * elem1 /* r1+0x8 */, void * elem2 /* r1+0xC */) {}
...
struct PrivateFlags {
    ...
    unsigned char outOfRange : 1; // offset 0x0, size 0x1
    unsigned char updatedThisFrame : 1; // offset 0x0, size 0x1
...
// total size: 0x4
struct /* @class$928zHUDCompass_cpp */ {
    // Members
...
union /* @class$1067zHUDCompass_cpp */ {
...
// total size: 0xC
struct /* @class$1066zHUDCompass_cpp */ {
    // Members
...
// total size: 0x58
class zHUDCompassObject : public xBase {
    // Functions
    zHUDCompassObject(struct zHUDCompassObjectAsset * theAsset);
    ...
    // Members
protected:
    unsigned int timerState; // offset 0x10, size 0x4
    float secondsLeft; // offset 0x14, size 0x4
    float maxSeconds; // offset 0x18, size 0x4
    struct PrivateFlags privateFlags; // offset 0x1C, size 0x4
    int objectArrayIdx; // offset 0x20, size 0x4
    struct xEnt * object; // offset 0x24, size 0x4
    struct xVec3 location; // offset 0x28, size 0xC
    struct RwTexture * objectTexture; // offset 0x34, size 0x4
    class zHUDCompassSystem * compassSystem; // offset 0x38, size 0x4
    struct xFRect screenSpace; // offset 0x3C, size 0x10
    struct xVec3 beadLoc; // offset 0x4C, size 0xC
};
class zHUDCompassObject * * objectArray; // size: 0x4, address: 0x80D6BAB8
class zHUDCompassSystem * * systemArray; // size: 0x4, address: 0x80D6BABC
int objectCount; // size: 0x4, address: 0x80D6BAC0
int systemCount; // size: 0x4, address: 0x80D6BAC4
// total size: 0x1
class zHUDCompassController {
    // Static members
    static class zHUDCompassSystem * * systemArray; // size: 0x4
    static class zHUDCompassObject * * objectArray; // size: 0x4
    static int systemCount; // size: 0x4
    static int objectCount; // size: 0x4
};
// Range: 0x8032EF24 -> 0x8032EF48
void zHUDCompassController::Init() {
    // References
    // -> class zHUDCompassSystem * * systemArray;
    // -> int systemCount;
    // -> class zHUDCompassObject * * objectArray;
    // -> int objectCount;
}

// Range: 0x8032EF48 -> 0x8032EFF0
void zHUDCompassController::UpdateAll(float dt /* f31 */) {
    // Local variables
    int j; // r31
    int i; // r30
...
// Range: 0x8032EFF0 -> 0x8032F06C
void zHUDCompassController::RenderAll() {
    // Local variables
    int j; // r31
    int i; // r30
...
// Range: 0x8032F06C -> 0x8032F094
int zHUDCompassController::AddToObjectCount() {
    // Local variables
    int t; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67A00
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x8032F094 -> 0x8032F16C
void zHUDCompassController::InsertInObjectArray(class zHUDCompassObject * inObj /* r1+0x8 */, int idx /* r31 */) {
    // References
    // -> class zHUDCompassObject * * objectArray;
...
// Range: 0x8032F16C -> 0x8032F194
int zHUDCompassController::AddToSystemCount() {
    // Local variables
    int t; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D67A14
// Range: 0x8032F194 -> 0x8032F26C
void zHUDCompassController::InsertInSystemArray(class zHUDCompassSystem * inSys /* r1+0x8 */, int idx /* r31 */) {
    // References
    // -> class zHUDCompassSystem * * systemArray;
    // -> static char __FUNCTION__[20];
    // -> int systemCount;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67A28
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
struct PrivateFlags {
    // Members
    unsigned char on : 1; // offset 0x0, size 0x1
    unsigned int pad : 31; // offset 0x0, size 0x4
};
// total size: 0x3C
class zHUDCompassSystem : public xBase {
    // Functions
    zHUDCompassSystem(struct zHUDCompassSystemAsset * theAsset);

    void EventCB(unsigned int toEvent, struct xBase * toParamWidget);
...
protected:
    ...
    float compassCenterX; // offset 0x14, size 0x4
    float compassCenterY; // offset 0x18, size 0x4
    float compassRadius; // offset 0x1C, size 0x4
    struct RwTexture * compassTexture; // offset 0x20, size 0x4
    float maxDistance; // offset 0x24, size 0x4
    float minBeadSize; // offset 0x28, size 0x4
    float maxBeadSize; // offset 0x2C, size 0x4
    unsigned int systemOpacity; // offset 0x30, size 0x4
    unsigned int beadOpacity; // offset 0x34, size 0x4
    int systemArrayIdx; // offset 0x38, size 0x4
};
// total size: 0x34
struct zHUDCompassSystemAsset : public xDynAsset {
    // Members
    float radius; // offset 0x10, size 0x4
    float centerY; // offset 0x14, size 0x4
    float centerX; // offset 0x18, size 0x4
    unsigned int textureId; // offset 0x1C, size 0x4
    float maxDistance; // offset 0x20, size 0x4
    float minBeadSize; // offset 0x24, size 0x4
    float maxBeadSize; // offset 0x28, size 0x4
    unsigned int systemOpacity; // offset 0x2C, size 0x4
    unsigned int beadOpacity; // offset 0x30, size 0x4
};
// Range: 0x8032F26C -> 0x8032F414
// this: r31
zHUDCompassSystem::zHUDCompassSystem(struct zHUDCompassSystemAsset * theAsset /* r30 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67A2D
// total size: 0x10
...
// Range: 0x8032F414 -> 0x8032F5DC
void zHUDCompassSystem::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8032F5DC -> 0x8032F680
// this: r31
void zHUDCompassSystem::EventCB(unsigned int toEvent /* r1+0x8 */, struct xBase * toParamWidget /* r1+0xC */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67A32
// Range: 0x8032F680 -> 0x8032F79C
void zHUDCompassSystem::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHUDCompassSystem * compass; // r31

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x8032F79C -> 0x8032F7A8
// this: r3
void zHUDCompassSystem::Update() {}

unsigned int FB_XRES; // size: 0x4, address: 0x80D63014
unsigned int FB_YRES; // size: 0x4, address: 0x80D63018
// Range: 0x8032F7A8 -> 0x8032F8CC
// this: r31
void zHUDCompassSystem::Render() {
    // References
    // -> unsigned int FB_YRES;
    // -> unsigned int FB_XRES;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67A3A
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x28
struct zHUDCompassObjectAsset : public xDynAsset {
    // Members
    unsigned int objectId; // offset 0x10, size 0x4
    struct xVec3 location; // offset 0x14, size 0xC
    unsigned int textureId; // offset 0x20, size 0x4
    unsigned int compassSystemId; // offset 0x24, size 0x4
};
// Range: 0x8032F8CC -> 0x8032FC68
// this: r31
zHUDCompassObject::zHUDCompassObject(struct zHUDCompassObjectAsset * theAsset /* r30 */) {
    // References
    // -> struct xVec3 m_Null;
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67A3F
// Range: 0x8032FC68 -> 0x8032FE30
void zHUDCompassObject::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67A44
// Range: 0x8032FE30 -> 0x80330000
// this: r31
void zHUDCompassObject::EventCB(unsigned int toEvent /* r1+0x8 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r1+0xC */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80D67A4C
// Range: 0x80330000 -> 0x8033011C
void zHUDCompassObject::EventCB(struct xBase * from /* r1+0x8 */, struct xBase * to /* r30 */, unsigned int toEvent /* r1+0xC */, const float * toParam /* r1+0x10 */, struct xBase * toParamWidget /* r1+0x14 */, unsigned int toParamWidgetID /* r1+0x18 */) {
    // Local variables
    class zHUDCompassObject * obj; // r31

    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x8033011C -> 0x80330364
// this: r31
void zHUDCompassObject::Render() {
    // Local variables
    unsigned int r; // r30
    unsigned int g; // r29
    unsigned int b; // r28
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D67A54
...
// Range: 0x80330364 -> 0x803306D0
// this: r31
void zHUDCompassObject::Update(float dt /* r1+0x10 */) {
    // Local variables
    struct xMat4x3 camMat; // r1+0x40
    struct xVec3 facing; // r1+0x28
    float cosTheta; // f29
    float theta; // r1+0x18
    struct xVec3 toObj; // r1+0x1C
    float maxDist; // f31
    float realLength; // f28
    float minBeadSize; // f30
    float maxBeadSize; // f27
