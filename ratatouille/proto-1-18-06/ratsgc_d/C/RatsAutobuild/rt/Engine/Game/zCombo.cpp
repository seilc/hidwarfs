/*
    ...
    Language: C++
    Code range: 0x80242420 -> 0x802424A0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct widget_chunk * comboHUD; // size: 0x4, address: 0x80D6B110
enum zComboType {
...
// total size: 0x1
struct /* @class$833zCombo_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$834zCombo_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$835zCombo_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$836zCombo_cpp */ {
    // Members
...
// Range: 0x80242420 -> 0x80242434
void zCombo_Add(float points /* f1 */, enum zComboType type /* r3 */) {
    // Local variables
    int rewardLevel; // r31
}
...
static unsigned char sComboIsPaused; // size: 0x1, address: 0x80D6B114
// Range: 0x80242434 -> 0x802424A0
void zCombo_Paused() {
    // References
