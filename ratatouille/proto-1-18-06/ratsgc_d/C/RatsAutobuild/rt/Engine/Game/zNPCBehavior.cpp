/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCBehavior.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025BA50 -> 0x8025C0FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class move : public zBehaviorImplementation {
    // Functions
    float get_angle_difference(const struct xVec3 * direction) const;

    float turn_to_face(const struct xVec3 * direction, float dt, float turning_speed);

    float apply_angle_diff(float angle_difference, float dt, float turning_speed);

    void accelerate(float dt, const struct xVec3 & direction, unsigned char change_anim_speed, float move_speed);
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x805240E8
// Range: 0x8025BA50 -> 0x8025BB44
// this: r30
float move::get_angle_difference(const struct xVec3 * direction /* r31 */) const {
    // Local variables
...
// Range: 0x8025BB44 -> 0x8025BBC8
// this: r31
float move::turn_to_face(const struct xVec3 * direction /* r30 */, float dt /* r1+0x8 */, float turning_speed /* f31 */) {}

// Range: 0x8025BBC8 -> 0x8025BD00
// this: r31
float move::apply_angle_diff(float angle_difference /* f29 */, float dt /* f30 */, float turning_speed /* f31 */) {
    // Local variables
...
// Range: 0x8025BD00 -> 0x8025BED8
// this: r31
void move::accelerate(float dt /* f30 */, const struct xVec3 & direction /* r1+0x8 */, unsigned char change_anim_speed /* r1+0xC */, float move_speed /* f31 */) {}
...
// Range: 0x8025BED8 -> 0x8025BF24
// this: r31
void move::stop() {}

// Range: 0x8025BF24 -> 0x8025BFCC
// this: r31
void move::setup() {
    // Local variables
    float turn_speed_degrees; // r1+0x8
}

// Range: 0x8025BFCC -> 0x8025BFD8
// this: r3
void move::reset() {}

// Range: 0x8025BFD8 -> 0x8025C0FC
// this: r30
void move::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[1024]; // r1+0x8
}

// total size: 0x4C
class take_damage : public zBehaviorImplementation {
    // Members
    unsigned char hasBeenDamaged; // offset 0x30, size 0x1
    struct xVec3 contact; // offset 0x34, size 0xC
    struct xVec3 direction; // offset 0x40, size 0xC
};
...
// total size: 0x4
struct /* @class$2090zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2049zNPCBehavior_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2050zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2051zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2048zNPCBehavior_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2053zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1390zNPCBehavior_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1872zNPCBehavior_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$857zNPCBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$858zNPCBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$860zNPCBehavior_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$861zNPCBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$862zNPCBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$863zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x30
class idle : public zBehaviorImplementation {};
// total size: 0x30
class npc_death : public zBehaviorImplementation {};
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$916zNPCBehavior_cpp */ {
    // Members
...
union /* @class$1055zNPCBehavior_cpp */ {
...
// total size: 0xC
struct /* @class$1054zNPCBehavior_cpp */ {
    // Members
...
// total size: 0x120
struct {} zNPC::move::__vtable; // size: 0x120, address: 0x80524100
// total size: 0x30
