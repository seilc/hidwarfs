/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zAnimCache.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012F134 -> 0x8012F5F8
*/
static unsigned int cachedAnimations; // size: 0x4, address: 0x80D69E48
static struct zAnimCacheEntry cachedEntry[128]; // size: 0x600, address: 0x80CE8C90
static unsigned int currentCacheIndex; // size: 0x4, address: 0x80D69E4C
static struct xVec3 cache[2560]; // size: 0x7800, address: 0x80CE9290
static char __FUNCTION__[12]; // size: 0xC, address: 0x80D61E18
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8012F134 -> 0x8012F2B4
static void fillInCache(struct zAnimCacheEntry * cacheEntry /* r31 */, struct RpAtomic * model /* r1+0x10 */, float startTime /* f29 */, float endTime /* f30 */) {
    // Local variables
    struct xVec3 tempPositions[100]; // r1+0x1F60
    struct xQuat tempQuats[100]; // r1+0x1920
    struct xMat4x3 tempMats[100]; // r1+0x20
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80517700
// total size: 0x10
struct hitBoneInfo {
    // Members
...
// total size: 0x4
struct /* @class$884zAnimCache_cpp */ {
    // Members
...
union /* @class$1049zAnimCache_cpp */ {
...
// total size: 0xC
struct /* @class$1288zAnimCache_cpp */ {
    // Members
...
// Range: 0x8012F2C8 -> 0x8012F59C
void zAnimCacheCreateData(class zCombatAttack * attackTableStates /* r31 */, unsigned int attackTableCount /* r1+0x8 */, struct xAnimPlay * animPlay /* r26 */) {
    // Local variables
    unsigned int i; // r30
    unsigned int j; // r28
    struct zAnimCacheEntry newCacheEntry; // r1+0xC
    struct xAnimState * state; // r27
    unsigned int entryIndex; // r29
...
// Range: 0x8012F5B8 -> 0x8012F5F8
static unsigned char operator!=(const struct zAnimCacheEntry & entry1 /* r3 */, const struct zAnimCacheEntry & entry2 /* r4 */) {}
