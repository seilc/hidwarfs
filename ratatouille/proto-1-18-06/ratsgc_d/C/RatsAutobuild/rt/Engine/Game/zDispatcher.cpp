/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zDispatcher.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80146974 -> 0x80149A7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$GetState__17zCompStateMachineFi[9]; // size: 0x9, address: 0x80D62538
char __FUNCTION__$localstatic1$GetCurrentStateEnum__17zCompStateMachineFv[20]; // size: 0x14, address: 0x80D62541
static int g_zdsp_init; // size: 0x4, address: 0x80D69F30
static int g_zdsp_dblog_init; // size: 0x4, address: 0x80D69F34
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x1C
struct st_ZDISPATCH_DATA : public xBase {
    // Members
    const struct xBaseAsset * rawass; // offset 0x10, size 0x4
    int placeholder; // offset 0x14, size 0x4
    void * last_checkpoint_hit; // offset 0x18, size 0x4
};
// total size: 0x8
struct st_ZDISPATCH_DEPOT {
    // Members
    struct st_ZDISPATCH_DATA * raw_pool; // offset 0x0, size 0x4
    int raw_cnt; // offset 0x4, size 0x4
};
static struct st_ZDISPATCH_DEPOT g_zdsp_depot; // size: 0x8, address: 0x80D62558
static char * g_zdsp_cmdstrz[26]; // size: 0x68, address: 0x8051D668
// total size: 0x6
struct /* @class$2123zDispatcher_cpp */ {
    // Members
    char id[4]; // offset 0x0, size 0x4
    char startPointer[2]; // offset 0x4, size 0x2
};
// total size: 0x3E
struct World {
    // Members
    ...
    struct /* @class$2123zDispatcher_cpp */ {
        ...
        char id[4]; // offset 0x0, size 0x4
        char startPointer[2]; // offset 0x4, size 0x2
    } tasks[10]; // offset 0x2, size 0x3C
};
static struct World worlds[20]; // size: 0x4D8, address: 0x80CF0D90
static signed short currentWorld; // size: 0x2, address: 0x80D69F38
static signed short currentTask; // size: 0x2, address: 0x80D69F3A
static signed short currentPointer; // size: 0x2, address: 0x80D69F3C
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x80146974 -> 0x80146DAC
void zDispatcherParseINI(struct xIniFile * ini /* r1+0x8 */) {
    // Local variables
    int i; // r30
    char itemName[16]; // r1+0x10
    char value[256]; // r1+0x20
    const char * value_; // r28
    int j; // r29
    char * ltok; // r1+0xC
    char * tok; // r31

    // References
    // -> static struct World worlds[20];
    // -> static signed short currentPointer;
    // -> static signed short currentTask;
    // -> static signed short currentWorld;
}

static int been_here; // size: 0x4, address: 0x80D69F40
static int been_here; // size: 0x4, address: 0x80D69F44
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62560
// Range: 0x80146DAC -> 0x80146EC4
void zDispatcher_Startup() {
    // Local variables
    int i; // r31
    const char * * strptr; // r30

    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[20];
    // -> static int been_here;
    // -> static char * g_zdsp_cmdstrz[26];
}

// Range: 0x80146EC4 -> 0x80146EC8
void zDispatcher_Shutdown() {}

// Range: 0x80146EC8 -> 0x80146F18
void zDispatcher_scenePrepare() {
    // Local variables
    struct st_ZDISPATCH_DEPOT * depot; // r31

    // References
    // -> static int g_zdsp_init;
    // -> static struct st_ZDISPATCH_DEPOT g_zdsp_depot;
}

// Range: 0x80146F18 -> 0x80146F60
...
static int been_here; // size: 0x4, address: 0x80D69F48
static int been_here; // size: 0x4, address: 0x80D69F4C
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62574
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80146F60 -> 0x80147090
struct st_ZDISPATCH_DATA * zDispatcher_memPool(int cnt /* r29 */) {
    // Local variables
    struct st_ZDISPATCH_DATA * pool; // r31
    struct st_ZDISPATCH_DEPOT * depot; // r30
...
static int been_here; // size: 0x4, address: 0x80D69F50
static char __FUNCTION__[20]; // size: 0x14, address: 0x80D62588
// Range: 0x80147090 -> 0x80147110
struct st_ZDISPATCH_DATA * zDispatcher_getInst(struct st_ZDISPATCH_DATA * pool /* r1+0x8 */, int idx /* r31 */) {
    // References
    // -> static int been_here;
    // -> static char __FUNCTION__[20];
}

// Range: 0x80147110 -> 0x8014714C
void zDispatcher_Init(struct st_ZDISPATCH_DATA * dspdata /* r31 */, struct xBaseAsset * bass /* r1+0x8 */) {}
...
// total size: 0x4
struct /* @class$924zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1080zDispatcher_cpp */ {
    // Members
...
union /* @class$636zDispatcher_cpp */ {
...
// Range: 0x8014714C -> 0x8014717C
void zDispatcher_InitDep(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, struct zScene * zscn /* r1+0xC */) {}
...
// Range: 0x8014717C -> 0x801471AC
void zDispatcher_Save(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, struct xSerial * s /* r1+0xC */) {}

// Range: 0x801471AC -> 0x801471DC
void zDispatcher_Load(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, struct xSerial * s /* r1+0xC */) {}

static int been_here; // size: 0x4, address: 0x80D69F54
static int been_here; // size: 0x4, address: 0x80D69F58
static char __FUNCTION__[14]; // size: 0xE, address: 0x80D6259C
// Range: 0x801471DC -> 0x801472F0
static void ZDSP_instInit(struct st_ZDISPATCH_DATA * dspdata /* r31 */, struct xBaseAsset * bass /* r30 */) {
    // References
    // -> static int been_here;
...
// Range: 0x801472F0 -> 0x801472F4
static void ZDSP_instInitDep() {}

// Range: 0x801472F4 -> 0x80147358
static void ZDSP_instReset(struct st_ZDISPATCH_DATA * dspdata /* r31 */, struct zScene * zscn /* r1+0x8 */) {
    // Local variables
    struct xBaseAsset * hold_rawass; // r30
}

// Range: 0x80147358 -> 0x8014735C
static void ZDSP_readAsset() {}

enum en_DISPATCH_COMMAND {
    ZDSP_CMD_INITDFLT = -1,
    ZDSP_CMD_CTRL_CFGGET = 0,
    ZDSP_CMD_CTRL_CFGSET = 1,
    ZDSP_CMD_CTRL_VIBE_P1_GET = 2,
    ZDSP_CMD_CTRL_VIBE_P1_SET = 3,
    ...
    ZDSP_CMD_CTRL_VIBE_P2_GET = 25,
    ZDSP_CMD_CTRL_VIBE_P2_SET = 26,
    ZDSP_CMD_NOMORE = 27,
};
// Range: 0x8014735C -> 0x80147398
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, enum en_DISPATCH_COMMAND cmd /* r1+0xC */) {}

// Range: 0x80147398 -> 0x801473D8
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, enum en_DISPATCH_COMMAND cmd /* r1+0xC */, int indata /* r1+0x10 */) {}
...
// Range: 0x801473D8 -> 0x80147488
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r1+0x8 */, enum en_DISPATCH_COMMAND cmd /* r27 */, void * indata /* r28 */, void * inxtra /* r29 */, void * result /* r30 */) {
    // Local variables
    struct st_ZDISPATCH_CONTEXT cmdctxt; // r1+0xC
    int rc; // r31
}

static int warned; // size: 0x4, address: 0x80D69F5C
static signed char init; // size: 0x1, address: 0x80D69F60
static int been_here; // size: 0x4, address: 0x80D69F64
static int been_here; // size: 0x4, address: 0x80D69F68
static int been_here; // size: 0x4, address: 0x80D69F6C
// total size: 0x38
...
static struct effectAsset effectAsset; // size: 0x38, address: 0x80CF1268
static signed char init; // size: 0x1, address: 0x80D69F70
// total size: 0x18
...
// total size: 0x18
struct effect : public emitterBase {};
static struct effect effect; // size: 0x18, address: 0x80CF12A0
static struct effectAsset effectAsset; // size: 0x38, address: 0x80CF12B8
static signed char init; // size: 0x1, address: 0x80D69F71
static struct effect effect; // size: 0x18, address: 0x80CF12F0
static int been_here; // size: 0x4, address: 0x80D69F74
static int been_here; // size: 0x4, address: 0x80D69F78
static int been_here; // size: 0x4, address: 0x80D69F7C
static int been_here; // size: 0x4, address: 0x80D69F80
static int been_here; // size: 0x4, address: 0x80D69F84
static char __FUNCTION__[15]; // size: 0xF, address: 0x80D625AA
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1641zDispatcher_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80147488 -> 0x8014823C
static int ZDSP_doCommand(struct st_ZDISPATCH_CONTEXT * cmdCtxt /* r28 */) {
    // Local variables
    int isok; // r24
    int iv; // r31
    enum en_DISPATCH_COMMAND cmd; // r27
    void * indata; // r29
    void * result; // r30
    unsigned char changed; // r26
    int padPort; // r1+0xC
    unsigned char changed; // r25
    int padPort; // r1+0x8
    enum eGameMode want; // r23
    ...
    // -> static struct effect effect;
    // -> struct _tagxPad mPad[4];
    // -> static signed char init;
    // -> static struct effectAsset effectAsset;
    // -> static struct effect effect;
    // -> static signed char init;
    // -> static struct effectAsset effectAsset;
    // -> static int been_here;
...
// total size: 0xC
struct /* @class$865zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$866zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$867zDispatcher_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$868zDispatcher_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$869zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$870zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$871zDispatcher_cpp */ {
    // Members
...
static int been_here; // size: 0x4, address: 0x80D69F88
static char __FUNCTION__[16]; // size: 0x10, address: 0x80D625B9
...
// Range: 0x8014823C -> 0x801496F8
void ZDSP_elcb_event(struct xBase * from /* r26 */, struct xBase * xb /* r1+0x8 */, unsigned int toEvent /* r23 */, const float * toParam /* r31 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r1+0xC */) {
    // Local variables
    struct st_ZDISPATCH_DATA * dspdata; // r29
    int old_vibration; // r1+0x48
    int padPort; // r18
    int old_vibration; // r1+0x44
    int padPort; // r17
    enum xSndEffect seffect; // r1+0x40
    enum ePauseType pauseType; // r1+0x3C
    class zNavigationMesh * navMesh; // r1+0x38
    struct zPlayerCheckPoint checkPoints[4]; // r1+0x4C
    struct xGroup * pointerGroup; // r25
    int i; // r24
    struct pointer_asset * pointerAsset; // r21
    struct pointer_asset * pointerAsset; // r20
    char events[512]; // r1+0x28C
    unsigned int c; // r28
    unsigned int len; // r1+0x34
    unsigned int i; // r19
    char log[512]; // r1+0x8C
    int glow; // r1+0x30
    int darken; // r1+0x2C
    enum eFMVFile fmv; // r1+0x28
    const struct zFMVFile * file; // r22
    unsigned int buttons; // r27
    enum xRegion region; // r1+0x24
    const char * pMovieFileName; // r1+0x20
    float pointer; // f31
    struct _xCounter * counter; // r1+0x1C
...
// total size: 0x890
struct /* @class$1884zDispatcher_cpp */ {
    // Static members
...
static int been_here; // size: 0x4, address: 0x80D69F8C
static char __FUNCTION__[25]; // size: 0x19, address: 0x8051D73C
// Range: 0x801496F8 -> 0x80149828
static void WRAP_xsnd_setMusicVolume(int volLevel /* r31 */) {
    // Local variables
    float flt_snd; // f31
...
static int been_here; // size: 0x4, address: 0x80D69F90
static char __FUNCTION__[23]; // size: 0x17, address: 0x8051D755
// Range: 0x80149828 -> 0x80149958
static void WRAP_xsnd_setSFXVolume(int volLevel /* r31 */) {
    // Local variables
    float flt_snd; // f31
...
// Range: 0x80149958 -> 0x80149970
static char * ZDSP_db_cmdStr(enum en_DISPATCH_COMMAND cmd /* r3 */) {
    // References
    // -> static char * g_zdsp_cmdstrz[26];
}

// Range: 0x80149970 -> 0x801499B8
static void ZDSP_db_logsetup() {
    // References
    // -> static int g_zdsp_dblog_init;
}

// Range: 0x801499B8 -> 0x801499BC
static void ZDSP_db_screenlog() {}

// Range: 0x801499BC -> 0x80149A7C
void zDispatcher_FindWorldTask(unsigned int sceneID /* r3 */, int & world /* r4 */, int & task /* r5 */) {
    // Local variables
    char sceneName[4]; // r1+0x8
    int i; // r31
    int j; // r30
