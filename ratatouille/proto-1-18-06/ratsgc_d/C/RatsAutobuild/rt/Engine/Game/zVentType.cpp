/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zVentType.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80279E68 -> 0x8027A0E4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct /* @class$1069zVentType_cpp */ {
    // Members
...
// Range: 0x80279E68 -> 0x80279F38
// this: r31
void zVentType::load(const struct asset_type & a /* r30 */) {
    // Local variables
    struct xBase * obj; // r29
    struct xBase * obj; // r28
    struct xBase * obj; // r27
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D65A50
// Range: 0x80279F38 -> 0x8027A0E4
void zVentType::load(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r29 */) {
    // Local variables
