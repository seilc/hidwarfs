/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zFXShockwave.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027F38C -> 0x8027FB88
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D65B68
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$884zFXShockwave_cpp */ {
    // Members
...
class zFXShockwave {
    ...
    static void Start(class zFXShockwaveConfig * cfg, const struct xVec3 & pos, float instanceScale, unsigned char killProj);

    static unsigned char Update(float dt);
...
protected:
    ...
    class zFXShockwaveConfig * config; // offset 0xC, size 0x4
    unsigned char killProjectiles; // offset 0x10, size 0x1
public:
    class zFXShockwave * next; // offset 0x14, size 0x4
};
// Range: 0x8027F38C -> 0x8027F3E4
// this: r31
static void zFXShockwave::FreeModel() {
    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x8027F3E4 -> 0x8027F40C
// this: r1+0x8
static void zFXShockwave::SceneExit() {}

// Range: 0x8027F40C -> 0x8027F448
// this: r31
static void zFXShockwave::Reset() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65B72
// Range: 0x8027F448 -> 0x8027F580
// this: r31
static void zFXShockwave::Start(class zFXShockwaveConfig * cfg /* r1+0x8 */, const struct xVec3 & pos /* r1+0xC */, float instanceScale /* r1+0x10 */, unsigned char killProj /* r1+0x14 */) {
    // References
    // -> static char __FUNCTION__[6];
}

class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::system; // size: 0x4, address: 0x80D6B310
signed char zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6B314
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::system; // size: 0x4, address: 0x80D6B318
signed char zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6B31C
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::system; // size: 0x4, address: 0x80D6B320
signed char zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80D6B324
// Range: 0x8027F580 -> 0x8027F6AC
// this: r31
static unsigned char zFXShockwave::Update(float dt /* r1+0x8 */) {}

// total size: 0x1A4C
class zNPCProjectileSystem : public zLightweightSystemBase {
    // Members
    class zNPCProjectileMetalSheet projectiles[20]; // offset 0x4, size 0x19F0
    int activeList[20]; // offset 0x19F4, size 0x50
    int endIndex; // offset 0x1A44, size 0x4
    int totalCount; // offset 0x1A48, size 0x4
};
// total size: 0x18
...
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileMetalSheet, 20>::__vtable; // size: 0x28, address: 0x80525010
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::__vtable; // size: 0x38, address: 0x80524FD8
// total size: 0x14
struct {} zNPCProjectile::__vtable; // size: 0x14, address: 0x80D65B78
...
class zNPCProjectileSystem : public zLightweightSystemBase {
    // Members
    class zNPCProjectileTrackingGrub projectiles[40]; // offset 0x4, size 0x3AC0
    int activeList[40]; // offset 0x3AC4, size 0xA0
    int endIndex; // offset 0x3B64, size 0x4
    int totalCount; // offset 0x3B68, size 0x4
};
// total size: 0x18
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileTrackingGrub, 40>::__vtable; // size: 0x28, address: 0x80524FB0
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::__vtable; // size: 0x38, address: 0x80524F78
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1897zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$825zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$826zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$827zFXShockwave_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$828zFXShockwave_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$829zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$830zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$831zFXShockwave_cpp */ {
    // Members
...
class zNPCProjectileSystem : public zLightweightSystemBase {
    // Members
    class zNPCProjectileGrub projectiles[40]; // offset 0x4, size 0x3980
    int activeList[40]; // offset 0x3984, size 0xA0
    int endIndex; // offset 0x3A24, size 0x4
    int totalCount; // offset 0x3A28, size 0x4
};
// total size: 0x50
...
union /* @class$1040zFXShockwave_cpp */ {
...
// total size: 0xC
struct /* @class$1039zFXShockwave_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileGrub, 40>::__vtable; // size: 0x28, address: 0x80524F50
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::__vtable; // size: 0x38, address: 0x80524F18
// Range: 0x8027F6AC -> 0x8027F77C
// this: r31
static void zFXShockwave::Render() {}

static int shockwavesSize; // size: 0x4, address: 0x80D6B328
static class zFXShockwave * shockwaves; // size: 0x4, address: 0x80D6B32C
static class zFXShockwave * freeList; // size: 0x4, address: 0x80D6B330
static class zFXShockwave * usedList; // size: 0x4, address: 0x80D6B334
// Range: 0x8027F77C -> 0x8027F78C
static void ListPush(class zFXShockwave * & list /* r3 */, class zFXShockwave * element /* r4 */) {}

// Range: 0x8027F78C -> 0x8027F7C8
static class zFXShockwave * ListPop(class zFXShockwave * & list /* r3 */) {
    // Local variables
    class zFXShockwave * element; // r31
}

// Range: 0x8027F7C8 -> 0x8027F800
static class zFXShockwave * ListRemove(class zFXShockwave * & list /* r3 */, class zFXShockwave * element /* r4 */, class zFXShockwave * prev /* r5 */) {}

// Range: 0x8027F800 -> 0x8027F860
static void FreeAllShockwaves() {
    // Local variables
    int i; // r31

    // References
    // -> static class zFXShockwave * shockwaves;
    // -> static class zFXShockwave * freeList;
    // -> static int shockwavesSize;
    // -> static class zFXShockwave * usedList;
}
...
// Range: 0x8027F860 -> 0x8027F8F8
// this: r30
void zFXShockwaveConfig::AddTweaks(const char * prefix /* r31 */) {}

// Range: 0x8027F8F8 -> 0x8027F970
void zFXShockwaveSceneEnter(int maxInScene /* r1+0x8 */) {
    // References
    // -> static class zFXShockwave * shockwaves;
    // -> static int shockwavesSize;
}

// Range: 0x8027F970 -> 0x8027F9A8
// this: r31
static zFXShockwave::zFXShockwave() {}

// Range: 0x8027F9A8 -> 0x8027F9F8
void zFXShockwaveSceneReset() {
    // Local variables
    int i; // r31
...
// Range: 0x8027F9F8 -> 0x8027FA88
void zFXShockwaveUpdate(float dt /* r1+0x8 */) {
    // Local variables
    class zFXShockwave * currWave; // r31
    class zFXShockwave * prevWave; // r30
    class zFXShockwave * next; // r29
...
// Range: 0x8027FA88 -> 0x8027FAFC
unsigned char zFXShockwaveStart(class zFXShockwaveConfig * config /* r1+0x8 */, const struct xVec3 & pos /* r1+0xC */, float scale /* r1+0x10 */, unsigned char killproj /* r1+0x14 */) {
    // Local variables
    class zFXShockwave * newWave; // r31
...
// Range: 0x8027FAFC -> 0x8027FB3C
void zFXShockwaveRender() {
    // Local variables
    class zFXShockwave * currWave; // r31
...
// Range: 0x8027FB3C -> 0x8027FB88
void zFXShockwaveSceneExit() {
    // Local variables
    int i; // r31
