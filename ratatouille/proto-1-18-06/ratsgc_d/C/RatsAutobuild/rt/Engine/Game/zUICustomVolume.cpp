/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomVolume.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80289508 -> 0x80289B58
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct xColor_tag VOLUME_ACTIVE_COLOR; // size: 0x4, address: 0x80D65CD0
float VOLUME_WIDTH_PERCENTAGE; // size: 0x4, address: 0x80D65CD4
float VOLUME_HEIGHT_PERCENTAGE; // size: 0x4, address: 0x80D65CD8
...
// total size: 0x54
struct {} zUICustomVolume::__vtable; // size: 0x54, address: 0x805252B0
// total size: 0xC
struct ImageState {
    // Members
...
class zUICustomVolume : public zUICustom {
    // Functions
    zUICustomVolume(class zUI * ui, enum xSndMixerFaderName sndMixerFader);
...
// Range: 0x80289508 -> 0x80289558
// this: r31
zUICustomVolume::zUICustomVolume(class zUI * ui /* r1+0x8 */, enum xSndMixerFaderName sndMixerFader /* r1+0xC */) {
    // References
    // -> struct [anonymous] zUICustomVolume::__vtable;
}
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D65CDC
// total size: 0xC
...
// Range: 0x80289558 -> 0x80289758
// this: r31
void zUICustomVolume::Setup() {
    // Local variables
    struct xGroup * group; // r30
    unsigned int i; // r29
    struct xBase * b; // r25
    int itemIterator; // r27
    unsigned int i; // r28
    struct xBase * b; // r26
...
// Range: 0x80289758 -> 0x80289760
unsigned char zUICustomVolume::PreRender() {}

// Range: 0x80289760 -> 0x8028981C
// this: r31
void zUICustomVolume::RefreshBars() {
    // Local variables
    int volume; // r28
    int i; // r30
}
...
// Range: 0x8028981C -> 0x80289894
// this: r31
void zUICustomVolume::HideBars() {
    // Local variables
    int i; // r30
}

// Range: 0x80289894 -> 0x80289A1C
// this: r31
unsigned char zUICustomVolume::HandleEvent(unsigned int toEvent /* r1+0x8 */) {
    // Local variables
    float oldVol; // f29
    float vol; // f31
    float oldVol; // f28
...
// Range: 0x80289A1C -> 0x80289AF0
void zUICustomVolume::AddTweaks(const char * baseName /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8

    // References
    // -> float VOLUME_WIDTH_PERCENTAGE;
    // -> float VOLUME_HEIGHT_PERCENTAGE;
    // -> struct xColor_tag VOLUME_ACTIVE_COLOR;
}

// Range: 0x80289AF0 -> 0x80289B20
// this: r31
float zUICustomVolume::GetVolume() const {}

// Range: 0x80289B20 -> 0x80289B58
// this: r31
void zUICustomVolume::SetVolume(float volume /* r1+0x8 */) {}
