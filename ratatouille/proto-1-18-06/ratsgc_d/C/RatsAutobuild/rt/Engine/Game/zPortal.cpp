/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zPortal.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8019F2A8 -> 0x8019F788
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8019F2A8 -> 0x8019F2D8
void zPortalInit(void * portal /* r1+0x8 */, void * passet /* r1+0xC */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D634F8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8019F2D8 -> 0x8019F398
void zPortalInit(struct _zPortal * portal /* r31 */, struct xPortalAsset * passet /* r30 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80D63504
// Range: 0x8019F398 -> 0x8019F484
void zPortalReset(struct _zPortal * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D63511
// total size: 0x0
...
// Range: 0x8019F484 -> 0x8019F574
void zPortalSave(struct _zPortal * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80D6351D
// Range: 0x8019F574 -> 0x8019F664
void zPortalLoad(struct _zPortal * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D63529
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8019F664 -> 0x8019F788
void zPortalEventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r1+0x8 */, const float * toParam /* r31 */) {
    // References
