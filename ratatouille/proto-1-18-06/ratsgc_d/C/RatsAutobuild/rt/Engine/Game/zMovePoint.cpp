/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMovePoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80184D84 -> 0x801852FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zMovePoint * g_mvpt_list; // size: 0x4, address: 0x80D6A620
static int g_mvpt_cnt; // size: 0x4, address: 0x80D6A624
static char __FUNCTION__[22]; // size: 0x16, address: 0x8051F5E0
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// Range: 0x80184D84 -> 0x80184DF8
struct zMovePoint * zMovePoint_GetMemPool(int cnt /* r31 */, unsigned int memtag /* r1+0x8 */) {
    // References
    // -> static struct zMovePoint * g_mvpt_list;
    // -> static int g_mvpt_cnt;
    // -> static char __FUNCTION__[22];
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D630E8
// Range: 0x80184DF8 -> 0x80184ED0
void zMovePointInit(struct zMovePoint * m /* r31 */, struct xMovePointAsset * asset /* r30 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static int been_here; // size: 0x4, address: 0x80D6A628
static char __FUNCTION__[19]; // size: 0x13, address: 0x80D630F7
// Range: 0x80184ED0 -> 0x80184FB0
struct zMovePoint * zMovePoint_GetInst(int n /* r31 */) {
    // References
    // -> static struct zMovePoint * g_mvpt_list;
...
// total size: 0x4
struct /* @class$941zMovePoint_cpp */ {
    // Members
...
// Range: 0x80184FB0 -> 0x80184FE0
void zMovePointSetup(struct zMovePoint * mvpt /* r1+0x8 */, struct zScene * scn /* r1+0xC */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D6310A
// total size: 0x0
struct xSerial {};
// Range: 0x80184FE0 -> 0x801850D0
void zMovePointSave(struct zMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80D63119
// Range: 0x801850D0 -> 0x801851C0
void zMovePointLoad(struct zMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x801851C0 -> 0x801851E8
void zMovePointReset(struct zMovePoint * ent /* r1+0x8 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80D63128
// Range: 0x801851E8 -> 0x801852D4
void zMovePointEventCB(struct xBase * to /* r1+0x8 */, unsigned int toEvent /* r1+0xC */) {
    // Local variables
    struct zMovePoint * m; // r31

    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x801852D4 -> 0x801852FC
struct xVec3 * zMovePointGetPos(const struct zMovePoint * m /* r1+0x8 */) {}
...
// total size: 0xC
struct /* @class$1089zMovePoint_cpp */ {
    // Members
