/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zParticleSystemEarthDust.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80281940 -> 0x80282924
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80281940 -> 0x802819B4
// this: r1+0x8
struct zParticleGenerator * zParticleSystemEarthDust::create_generator(struct zParticleAsset & asset /* r1+0xC */) {
    // Local variables
    struct zParticleGeneratorEarthDust * gen; // r30
}

// Range: 0x802819F0 -> 0x80281A1C
// this: r1+0x8
void zParticleSystemEarthDust::scene_enter() {}

// Range: 0x80281A1C -> 0x80281A4C
// this: r1+0x8
void zParticleSystemEarthDust::update(float dt /* r1+0xC */) {}
...
// Range: 0x80281A4C -> 0x80281A54
int zParticleSystemEarthDust::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80D65BA0
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$840zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1756zParticleSystemEarthDust_cpp */ {
    // Members
...
struct asset_data {
    ...
    float rotSpeed; // offset 0xC, size 0x4
    float lifetime; // offset 0x10, size 0x4
    float birthAlpha; // offset 0x14, size 0x4
    float deathAlpha; // offset 0x18, size 0x4
    // total size: 0x10
    struct /* @class$1756zParticleSystemEarthDust_cpp */ {
        // Members
        unsigned int shrapID; // offset 0x0, size 0x4
...
// Range: 0x80281A54 -> 0x80281EF8
int zParticleSystemEarthDust::update_particles(unsigned char * mem /* r19 */, int count /* r1+0x8 */, struct ptank_pool & apool /* r1+0xC */, float dt /* r1+0x10 */, void * context /* r20 */) {
    // Local variables
    ...
    struct zParticleGeneratorEarthDust & g; // r21
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65BB1
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
struct zParticleGeneratorEarthDust : public zParticleGenerator {
    ...
    void create(class zParticleSystemEarthDust & system, struct zParticleAsset & asset);
...
// Range: 0x80281EF8 -> 0x80282220
// this: r31
void zParticleGeneratorEarthDust::update(float dt /* f30 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80D65BB8
...
// Range: 0x80282220 -> 0x802824A0
// this: r31
void zParticleGeneratorEarthDust::create(class zParticleSystemEarthDust & system /* r26 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
...
// Range: 0x802824A0 -> 0x8028251C
// this: r31
void zParticleGeneratorEarthDust::reset() {}

// Range: 0x8028251C -> 0x8028255C
// this: r31
void zParticleGeneratorEarthDust::activate() {}

// Range: 0x8028255C -> 0x80282598
// this: r31
void zParticleGeneratorEarthDust::deactivate() {}

// Range: 0x80282598 -> 0x802825FC
// this: r31
unsigned char zParticleGeneratorEarthDust::cullUpdate() {
    // Local variables
...
// Range: 0x802825FC -> 0x802828CC
// this: r30
void zParticleGeneratorEarthDust::add_tweaks(const char * prefix /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    struct asset_data & a; // r29
}

// Range: 0x802828CC -> 0x80282924
// this: r31
void zParticleGeneratorEarthDust::debug_render(unsigned char all /* r30 */) {}

// total size: 0x2C
struct {} zParticleGeneratorEarthDust::__vtable; // size: 0x2C, address: 0x80525038
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1560zParticleSystemEarthDust_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$776zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$777zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$778zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$779zParticleSystemEarthDust_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$780zParticleSystemEarthDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$781zParticleSystemEarthDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$782zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1158zParticleSystemEarthDust_cpp */ {
    // Members
...
union /* @class$827zParticleSystemEarthDust_cpp */ {
...
// total size: 0xC
struct /* @class$1296zParticleSystemEarthDust_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemEarthDust::__vtable; // size: 0x3C, address: 0x80525064
// total size: 0x8
