/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zMiniGameDefendTheBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8030D6F8 -> 0x8030EF04
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zMiniGameDefendTheBaseEnemy sEnemies[50]; // size: 0x15E0, address: 0x80D32170
static class zMiniGameDefendTheBaseEnemy * sEnemyPool; // size: 0x4, address: 0x80D67458
static float DAMAGE_BASE_TIME; // size: 0x4, address: 0x80D6745C
static unsigned int ENEMY_MODEL_ID; // size: 0x4, address: 0x80D6B8A0
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x80D6B8A4
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x80D6B8A8
static unsigned int WAVE_BOX_ID; // size: 0x4, address: 0x80D6B8AC
static unsigned int WAVE_DONE_BOX_ID; // size: 0x4, address: 0x80D6B8B0
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x80D6B8B4
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x80D6B8B8
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x80D6B8BC
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x80D6B8C0
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x80D6B8C4
static char __FUNCTION__[6]; // size: 0x6, address: 0x80D67460
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1079zMiniGameDefendTheBase_cpp */ {
    // Members
...
union /* @class$1080zMiniGameDefendTheBase_cpp */ {
...
// total size: 0x10
struct /* @class$1328zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x70
class zMiniGameDefendTheBaseEnemy : public zMiniGameObject {
    // Functions
    void Spawn(struct pointer_asset * pointer, float speed, int pIdx);
    ...
    // Members
protected:
    int playerIdx; // offset 0x14, size 0x4
    struct xMat4x3 mat; // offset 0x20, size 0x40
    float speed; // offset 0x60, size 0x4
    float damageBaseTimer; // offset 0x64, size 0x4
};
// total size: 0x8
struct xBaseAsset {
    // Members
...
// Range: 0x8030D6F8 -> 0x8030D8F4
// this: r31
void zMiniGameDefendTheBaseEnemy::Spawn(struct pointer_asset * pointer /* r1+0x8 */, float speed /* r1+0xC */, int pIdx /* r29 */) {
    // Local variables
    struct RpAtomic * data; // r30
    struct xVec3 target; // r1+0x1C
    struct xVec3 toTgt; // r1+0x10
    float angleDiff; // f31

    // References
    // -> struct xVec3 m_Null;
    // -> struct xGlobals * xglobals;
    // -> static unsigned int ENEMY_MODEL_ID;
...
// total size: 0x890
struct /* @class$1825zMiniGameDefendTheBase_cpp */ {
    // Static members
...
// Range: 0x8030D8F4 -> 0x8030DAD8
// this: r31
void zMiniGameDefendTheBaseEnemy::Update(float dt /* f31 */) {
    // Local variables
    struct xSweptSphere sws; // r1+0x20
...
// total size: 0x60
class zMiniGameDefendTheBasePlayerShot : public zMiniGameObject {
    // Members
protected:
    class zMiniGameDefendTheBasePlayer * owner; // offset 0x14, size 0x4
    struct xMat4x3 mat; // offset 0x20, size 0x40
};
// total size: 0x1B50
class zMiniGameDefendTheBasePlayer : public zMiniGamePlayer {
    // Members
protected:
    class zMiniGameDefendTheBasePlayerShot shots[20]; // offset 0x13B0, size 0x780
    int maxBaseHP; // offset 0x1B30, size 0x4
    int currentBaseHP; // offset 0x1B34, size 0x4
    int enemiesKilled; // offset 0x1B38, size 0x4
    int wavesWon; // offset 0x1B3C, size 0x4
    float coolDown; // offset 0x1B40, size 0x4
    float coolDownTimer; // offset 0x1B44, size 0x4
};
// total size: 0x4
...
// Range: 0x8030DAD8 -> 0x8030DB6C
// this: r31
void zMiniGameDefendTheBaseEnemy::Render() {
    // References
    // -> struct xColor_tag g_RED;
}

// Range: 0x8030DB6C -> 0x8030DBB4
// this: r31
float zMiniGameDefendTheBaseEnemy::GetRadius() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67466
// Range: 0x8030DBB4 -> 0x8030DC14
// this: r31
void zMiniGameDefendTheBaseEnemy::Kill() {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80D6746B
unsigned int gActiveHeap; // size: 0x4, address: 0x80D692A8
// total size: 0x38
struct zMiniGameAssetDefendTheBaseWave : public zMiniGameAsset {
    // Members
    int enemyCount; // offset 0x14, size 0x4
    float enemySpeed; // offset 0x18, size 0x4
    int initialMin; // offset 0x1C, size 0x4
    int initialMax; // offset 0x20, size 0x4
    float delayMin; // offset 0x24, size 0x4
    float delayMax; // offset 0x28, size 0x4
    unsigned int spawnGroupP1ID; // offset 0x2C, size 0x4
    unsigned int spawnGroupP2ID; // offset 0x30, size 0x4
    unsigned int nextWaveID; // offset 0x34, size 0x4
};
// total size: 0x14
struct PlayerData {
    // Members
    int pointerCount; // offset 0x0, size 0x4
    struct pointer_asset * * spawnPointers; // offset 0x4, size 0x4
    int enemiesActive; // offset 0x8, size 0x4
    int enemiesToSpawn; // offset 0xC, size 0x4
    float spawnTimer; // offset 0x10, size 0x4
};
// total size: 0x60
class Wave {
    // Functions
    void Init(struct zMiniGameAssetDefendTheBaseWave * a, int pc);

    class zMiniGameObject * Spawn(struct pointer_asset * * pointers, int count, int playerIdx);
    ...
    unsigned char WaveIsDone();

    void ForceDone();

    // Members
    struct zMiniGameAssetDefendTheBaseWave * asset; // offset 0x0, size 0x4
    class zMiniGameDefendTheBaseEnemy * activeEnemyList; // offset 0x4, size 0x4
    int playerCount; // offset 0x8, size 0x4
    struct PlayerData plyrData[4]; // offset 0xC, size 0x50
public:
    class Wave * next; // offset 0x5C, size 0x4
};
// Range: 0x8030DC14 -> 0x8030DDC0
// this: r31
void Wave::Init(struct zMiniGameAssetDefendTheBaseWave * a /* r1+0x8 */, int pc /* r1+0xC */) {
    // Local variables
    unsigned int spawnGroupIDTable[4]; // r1+0x10
    int j; // r30
...
// Range: 0x8030DDC0 -> 0x8030DE58
// this: r28
class zMiniGameObject * Wave::Spawn(struct pointer_asset * * pointers /* r29 */, int count /* r1+0x8 */, int playerIdx /* r1+0xC */) {
    // Local variables
    int index; // r30
    class zMiniGameDefendTheBaseEnemy * enemy; // r31

    // References
    // -> static class zMiniGameDefendTheBaseEnemy * sEnemyPool;
}

// Range: 0x8030DE58 -> 0x8030DF60
// this: r31
void Wave::Start() {
    // Local variables
    int numToSpawn; // r28
    int i; // r27
    int j; // r30
    class zMiniGameDefendTheBaseEnemy * obj; // r26
    int k; // r29
}

// Range: 0x8030DF60 -> 0x8030E158
// this: r31
void Wave::Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
    int numToSpawn; // r26
    int j; // r25
    class zMiniGameDefendTheBaseEnemy * enm; // r28
    class zMiniGameDefendTheBaseEnemy * curr; // r29
    class zMiniGameDefendTheBaseEnemy * prev; // r27
    class zMiniGameDefendTheBaseEnemy * next; // r24
...
// total size: 0x4
struct /* @class$932zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x14
class zMiniGameObject {
    // Members
protected:
    struct xModelInstance * model; // offset 0x0, size 0x4
    int objectType; // offset 0x4, size 0x4
    unsigned char active; // offset 0x8, size 0x1
public:
    class zMiniGameObject * next; // offset 0xC, size 0x4
    void * __vptr$; // offset 0x10, size 0x4
};
// Range: 0x8030E158 -> 0x8030E1B0
// this: r30
void Wave::Render() {
    // Local variables
    class zMiniGameDefendTheBaseEnemy * obj; // r31
}

// Range: 0x8030E1B0 -> 0x8030E220
// this: r3
unsigned char Wave::WaveIsDone() {
    // Local variables
    unsigned char done; // r1+0x8
    int i; // r31
}

// Range: 0x8030E220 -> 0x8030E2D8
// this: r31
void Wave::ForceDone() {
    // Local variables
    class zMiniGameDefendTheBaseEnemy * obj; // r30
    class zMiniGameDefendTheBaseEnemy * nextObj; // r28
    int i; // r29
...
// total size: 0x7C
struct {} zMiniGameDefendTheBase::__vtable; // size: 0x7C, address: 0x8052CD60
// total size: 0x1
struct /* @class$1856zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1858zMiniGameDefendTheBase_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1859zMiniGameDefendTheBase_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1860zMiniGameDefendTheBase_cpp */ {
    // Members
...
enum /* @enum$1861zMiniGameDefendTheBase_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1862zMiniGameDefendTheBase_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1863zMiniGameDefendTheBase_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1865zMiniGameDefendTheBase_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1853zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x70
class zMiniGameDefendTheBase : public zMiniGameBase {
    // Functions
    zMiniGameDefendTheBase(struct zMiniGameAsset * a);
    ...
    void SetWinLoseDisplay();

    void Render();

    void Reset();

    int WhichPlayerBase(unsigned int id);

    // Members
protected:
    class Wave * firstWave; // offset 0x2C, size 0x4
    class Wave * currentWave; // offset 0x30, size 0x4
    int waveNum; // offset 0x34, size 0x4
    unsigned char waitingForWaveDone; // offset 0x38, size 0x1
    float waveDoneTimer; // offset 0x3C, size 0x4
    int winner; // offset 0x40, size 0x4
    struct xGroup * baseGroups[4]; // offset 0x44, size 0x10
    struct ztextbox * statsText[4]; // offset 0x54, size 0x10
    struct ztextbox * waveText; // offset 0x64, size 0x4
    struct ztextbox * waveDoneText; // offset 0x68, size 0x4
    class zUIImage * resultImage; // offset 0x6C, size 0x4
};
// Range: 0x8030E2D8 -> 0x8030E324
// this: r31
zMiniGameDefendTheBase::zMiniGameDefendTheBase(struct zMiniGameAsset * a /* r1+0x8 */) {
    // References
    // -> struct [anonymous] zMiniGameDefendTheBase::__vtable;
}

// Range: 0x8030E324 -> 0x8030E3C4
void zMiniGameDefendTheBase::CreatePlayers() {
    // Local variables
    struct zScene * s; // r28
    int count; // r27
    int i; // r29
    struct zPlayer * newPlayer; // r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80D67470
// Range: 0x8030E3C4 -> 0x8030E6EC
void zMiniGameDefendTheBase::Init(struct xBase & data /* r1+0x8 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r25 */) {
    // Local variables
    unsigned long expected_asset_size; // r26
    class zMiniGameDefendTheBase * instance; // r30
    int j; // r29
    int i; // r28
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80D67475
// Range: 0x8030E6EC -> 0x8030E860
// this: r31
void zMiniGameDefendTheBase::InitWaves() {
    // Local variables
    struct zMiniGameAssetDefendTheBase * a; // r27
    struct zScene * s; // r25
    unsigned int waveID; // r26
    class Wave * curr; // r30
    struct zMiniGameAssetDefendTheBaseWave * waveAsset; // r29
    class Wave * newWave; // r28
...
// total size: 0x28
struct zMiniGameAssetDefendTheBase : public zMiniGameAsset {
    // Members
    unsigned int playerModelGroupID; // offset 0x14, size 0x4
    float coolDown; // offset 0x18, size 0x4
    unsigned int p1BaseGroupID; // offset 0x1C, size 0x4
    unsigned int p2BaseGroupID; // offset 0x20, size 0x4
    unsigned int firstWaveID; // offset 0x24, size 0x4
};
// Range: 0x8030E860 -> 0x8030E98C
// this: r31
void zMiniGameDefendTheBase::SceneSetup() {
    // Local variables
    int i; // r30

    // References
    // -> static unsigned int LOSE_TEX_ID;
    // -> static unsigned int RESULT_IMG_ID;
    // -> static unsigned int WAVE_DONE_BOX_ID;
    // -> static unsigned int WAVE_BOX_ID;
    // -> static unsigned int P2_STATS_BOX_ID;
    // -> static unsigned int P1_STATS_BOX_ID;
}

// Range: 0x8030E98C -> 0x8030E9C0
// this: r31
void zMiniGameDefendTheBase::EndGame() {}

static char statsBuf[4][128]; // size: 0x200, address: 0x80D33750
static char waveBuf[32]; // size: 0x20, address: 0x80D33950
// Range: 0x8030E9C0 -> 0x8030EC60
// this: r31
void zMiniGameDefendTheBase::Update(float dt /* f31 */) {
    // Local variables
    int prevAlivePlayer; // r27
    int aliveCount; // r28
    int i; // r29
    int j; // r30

    // References
    // -> static char waveBuf[32];
    // -> static char statsBuf[4][128];
    // -> struct xGlobals * xglobals;
}

// Range: 0x8030EC60 -> 0x8030ED84
// this: r31
void zMiniGameDefendTheBase::SetWinLoseDisplay() {
    // Local variables
    int i; // r30
    unsigned int texID; // r29

    // References
    // -> static unsigned int WIN_TEX_ID;
    // -> static unsigned int LOSE_TEX_ID;
    // -> static unsigned int P2_WIN_TEX_ID;
    // -> static unsigned int P1_WIN_TEX_ID;
}

// Range: 0x8030ED84 -> 0x8030EDD8
// this: r31
void zMiniGameDefendTheBase::Render() {}
...
// Range: 0x8030EDD8 -> 0x8030EE48
// this: r31
void zMiniGameDefendTheBase::Reset() {}
...
// Range: 0x8030EE48 -> 0x8030EF00
// this: r30
int zMiniGameDefendTheBase::WhichPlayerBase(unsigned int id /* r1+0x8 */) {
    // Local variables
    int i; // r31
    unsigned int j; // r29
}

// Range: 0x8030EF00 -> 0x8030EF04
void zMiniGameDefendTheBase::AddTweaks() {}

// total size: 0x1C
struct {} zMiniGameObject::__vtable; // size: 0x1C, address: 0x8052CDDC
// total size: 0x1C
struct {} zMiniGameDefendTheBaseEnemy::__vtable; // size: 0x1C, address: 0x8052CDF8
