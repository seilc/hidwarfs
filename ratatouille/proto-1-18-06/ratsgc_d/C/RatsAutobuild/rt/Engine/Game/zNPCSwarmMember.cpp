/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPCSwarmMember.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x803041A4 -> 0x803044BC
*/
// total size: 0x1
...
static class zICompNPCEntityParams gSwarmBugEntParameters; // size: 0x30, address: 0x80D2DD00
static class zICompNPCEntityParams gSwarmOwlEntParameters; // size: 0x30, address: 0x80D2DD30
static char __FUNCTION__[9]; // size: 0x9, address: 0x80D672E8
// total size: 0x60
...
// total size: 0xC
struct /* @class$858zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$859zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$860zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$861zNPCSwarmMember_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$862zNPCSwarmMember_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$863zNPCSwarmMember_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$864zNPCSwarmMember_cpp */ {
    // Members
...
char __FUNCTION__$localstatic1$AttachComponent__63zComponentPool<21zCompLogicSwarmMember,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D672F1
signed char zComponentPool<zCompLogicSwarmMember, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B830
// total size: 0x8
...
class zComponentPool zComponentPool<zCompLogicSwarmMember, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B834
char __FUNCTION__$localstatic1$AttachComponent__66zComponentPool<21zCompSteeringFlocking,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80D67301
signed char zComponentPool<zCompSteeringFlocking, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80D6B840
// total size: 0x70
...
class zComponentPool zComponentPool<zCompSteeringFlocking, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80D6B844
// total size: 0x68
class zNPCSwarmMember : public zNPCBase {
    // Functions
...
// Range: 0x803041A4 -> 0x80304308
// this: r31
unsigned char zNPCSwarmMember::Activate() {
    // References
    // -> static char __FUNCTION__[9];
    // -> static class zICompNPCEntityParams gSwarmOwlEntParameters;
    // -> static class zICompNPCEntityParams gSwarmBugEntParameters;
}
...
// total size: 0x4
struct /* @class$1030zNPCSwarmMember_cpp */ {
    // Members
...
union /* @class$1170zNPCSwarmMember_cpp */ {
...
// total size: 0xC
struct /* @class$1168zNPCSwarmMember_cpp */ {
    // Members
...
// Range: 0x80304308 -> 0x80304330
// this: r1+0x8
void zNPCSwarmMember::Deactivate() {}

// Range: 0x80304330 -> 0x803043B8
// this: r29
void zNPCSwarmMember::Update(struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
    class zICompLogic * logicComponent; // r31
}

// Range: 0x803043B8 -> 0x80304404
// this: r30
void zNPCSwarmMember::Render() {
    // Local variables
...
// Range: 0x80304404 -> 0x803044BC
// this: r31
void zNPCSwarmMember::Reset() {
    // Local variables
    struct zNPCAssetSwarm * npcassSwarm; // r30
...
// total size: 0x3C
struct {} zNPCSwarmMember::__vtable; // size: 0x3C, address: 0x8052A748
