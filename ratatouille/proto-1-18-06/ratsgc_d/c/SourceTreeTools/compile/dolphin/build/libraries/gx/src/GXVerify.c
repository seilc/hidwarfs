/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\gx\src\GXVerify.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803BF1C0 -> 0x803BF628
*/
// total size: 0x13F8
struct __GXVerifyData {
    // Members
    void (* cb)(enum /* @enum$5GXVerify_c */ {
        GX_WARN_NONE = 0,
        GX_WARN_SEVERE = 1,
        GX_WARN_MEDIUM = 2,
        GX_WARN_ALL = 3,
    }, unsigned long, char *); // offset 0x0, size 0x4
    enum /* @enum$5GXVerify_c */ {
        GX_WARN_NONE = 0,
        GX_WARN_SEVERE = 1,
        GX_WARN_MEDIUM = 2,
        GX_WARN_ALL = 3,
...
static struct __GXVerifyData __gxVerifData; // size: 0x13F8, address: 0x80D58138
struct __GXVerifyData * __gxVerif; // size: 0x4, address: 0x80D680E8
char * __gxvWarnings[125]; // size: 0x1F4, address: 0x80545688
enum /* @enum$5GXVerify_c */ {
    GX_WARN_NONE = 0,
    GX_WARN_SEVERE = 1,
    GX_WARN_MEDIUM = 2,
    GX_WARN_ALL = 3,
} __gxvWarnLev[125]; // size: 0x1F4, address: 0x8054587C
// Range: 0x803BF1C0 -> 0x803BF1C4
static void __GXVerifyGlobal() {}
...
char __gxvDummyStr[256]; // size: 0x100, address: 0x80D59530
enum _GXVtxFmt {
    GX_VTXFMT0 = 0,
    GX_VTXFMT1 = 1,
    GX_VTXFMT2 = 2,
...
// Range: 0x803BF1C4 -> 0x803BF2E0
static void __GXVerifyCP(enum _GXVtxFmt fmt /* r1+0x8 */) {
    // Local variables
    unsigned long nrmCnt; // r29
...
// Range: 0x803BF2E0 -> 0x803BF334
void __GXVerifyState(enum _GXVtxFmt vtxfmt /* r1+0x8 */) {
    // References
    // -> struct __GXVerifyData * __gxVerif;
}
...
// Range: 0x803BF334 -> 0x803BF5F4
void __GXVerifyVATImm(enum _GXAttr attr /* r29 */, enum _GXCompCnt cnt /* r26 */, enum _GXCompType type /* r27 */, unsigned char frac /* r28 */) {
    // References
    // -> char * __gxvWarnings[125];
    // -> enum /* @enum$5GXVerify_c */ {
    GX_WARN_NONE = 0,
...
// Range: 0x803BF5F4 -> 0x803BF600
void GXSetVerifyLevel(enum /* @enum$5GXVerify_c */ {
    GX_WARN_NONE = 0,
    GX_WARN_SEVERE = 1,
    GX_WARN_MEDIUM = 2,
    GX_WARN_ALL = 3,
...
// Range: 0x803BF600 -> 0x803BF628
void (* GXSetVerifyCallback(void (* cb)(enum /* @enum$5GXVerify_c */ {
    GX_WARN_NONE = 0,
    GX_WARN_SEVERE = 1,
    GX_WARN_MEDIUM = 2,
    GX_WARN_ALL = 3,
}, unsigned long, char *) /* r3 */))(enum /* @enum$5GXVerify_c */ {
    GX_WARN_NONE = 0,
    GX_WARN_SEVERE = 1,
    GX_WARN_MEDIUM = 2,
    GX_WARN_ALL = 3,
    ...
    // Local variables
    void (* old_cb)(enum /* @enum$5GXVerify_c */ {
        GX_WARN_NONE = 0,
        GX_WARN_SEVERE = 1,
        GX_WARN_MEDIUM = 2,
        GX_WARN_ALL = 3,
    }, unsigned long, char *); // r31
