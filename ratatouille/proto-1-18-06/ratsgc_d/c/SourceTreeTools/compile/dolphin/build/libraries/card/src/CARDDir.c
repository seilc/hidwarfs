/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDDir.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x8039EDE0 -> 0x8039F0FC
*/
// total size: 0x40
struct CARDDir {
    // Members
...
// Range: 0x8039F014 -> 0x8039F0FC
long __CARDUpdateDir(long chan /* r28 */, void (* callback)(long, long) /* r1+0xC */) {
    // Local variables
    struct CARDControl * card; // r31
    struct CARDDirCheck * check; // r29
    unsigned long addr; // r27
    struct CARDDir * dir; // r30
