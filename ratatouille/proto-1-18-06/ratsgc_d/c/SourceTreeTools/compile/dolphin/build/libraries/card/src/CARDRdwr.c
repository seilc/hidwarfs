/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDRdwr.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x8039E484 -> 0x8039E868
*/
// total size: 0x50
...
// Range: 0x8039E484 -> 0x8039E558
static void BlockReadCallback(long chan /* r28 */, long result /* r30 */) {
    // Local variables
...
// Range: 0x8039E558 -> 0x8039E634
long __CARDRead(long chan /* r29 */, unsigned long addr /* r1+0xC */, long length /* r28 */, void * dst /* r1+0x14 */, void (* callback)(long, long) /* r1+0x18 */) {
    // Local variables
...
// Range: 0x8039E634 -> 0x8039E714
static void BlockWriteCallback(long chan /* r28 */, long result /* r30 */) {
    // Local variables
    struct CARDControl * card; // r31
    void (* callback)(long, long); // r29
...
// Range: 0x8039E714 -> 0x8039E800
long __CARDWrite(long chan /* r29 */, unsigned long addr /* r1+0xC */, long length /* r28 */, void * dst /* r1+0x14 */, void (* callback)(long, long) /* r1+0x18 */) {
    // Local variables
    struct CARDControl * card; // r31
...
// Range: 0x8039E800 -> 0x8039E868
long CARDGetXferredBytes(long chan /* r31 */) {
    // References
    // -> struct CARDControl __CARDBlock[2];
}
