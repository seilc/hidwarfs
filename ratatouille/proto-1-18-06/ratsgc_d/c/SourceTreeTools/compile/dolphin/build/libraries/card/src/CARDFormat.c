/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDFormat.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A0894 -> 0x803A0DB0
*/
// total size: 0x50
...
// Range: 0x803A0894 -> 0x803A09FC
static void FormatCallback(long chan /* r29 */, long result /* r30 */) {
    // Local variables
...
// Range: 0x803A09FC -> 0x803A0D54
long __CARDFormatRegionAsync(long chan /* r24 */, unsigned short encode /* r20 */, void (* callback)(long, long) /* r1+0x10 */) {
    // Local variables
    ...
    signed short i; // r31
    long result; // r28
    struct OSSram * sram; // r21
    struct OSSramEx * sramEx; // r19
    unsigned short dvdstatus; // r18
    long long time; // r16
    long long rand; // r25
    struct CARDDirCheck * check; // r22
}

// Range: 0x803A0D54 -> 0x803A0DB0
long CARDFormat(long chan /* r30 */) {
    // Local variables
    long result; // r31
}
