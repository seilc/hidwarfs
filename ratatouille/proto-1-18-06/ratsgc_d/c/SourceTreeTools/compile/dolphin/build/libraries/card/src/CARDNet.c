/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDNet.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A2EBC -> 0x803A3018
*/
...
// Range: 0x803A2EBC -> 0x803A2FB4
long CARDSetAttributesAsync(long chan /* r28 */, long fileNo /* r29 */, unsigned char attr /* r31 */, void (* callback)(long, long) /* r1+0x14 */) {
    // Local variables
    struct CARDDir dirent; // r1+0x18
    long result; // r30
...
// Range: 0x803A2FB4 -> 0x803A3018
long CARDSetAttributes(long chan /* r30 */, long fileNo /* r1+0xC */, unsigned char attr /* r1+0x10 */) {
    // Local variables
    long result; // r31
}
