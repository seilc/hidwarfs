/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\gx\src\GXBump.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803B7FF4 -> 0x803B8E40
*/
...
// Range: 0x803B7FF4 -> 0x803B81E4
void GXSetTevIndirect(enum _GXTevStageID tev_stage /* r20 */, enum _GXIndTexStageID ind_stage /* r21 */, enum _GXIndTexFormat format /* r22 */, enum _GXIndTexBiasSel bias_sel /* r23 */, enum _GXIndTexMtxID matrix_sel /* r24 */, enum _GXIndTexWrap wrap_s /* r25 */, enum _GXIndTexWrap wrap_t /* r26 */, unsigned char add_prev /* r27 */, unsigned char utc_lod /* r28 */, enum _GXIndTexAlphaSel alpha_sel /* r29 */) {
    // Local variables
...
// Range: 0x803B81E4 -> 0x803B85C8
void GXSetIndTexMtx(enum _GXIndTexMtxID mtx_id /* r26 */, const float (* offset)[3] /* r27 */, signed char scale_exp /* r28 */) {
    // Local variables
    long mtx[6]; // r1+0x14
...
// Range: 0x803B85C8 -> 0x803B894C
void GXSetIndTexCoordScale(enum _GXIndTexStageID ind_state /* r1+0x8 */, enum _GXIndTexScale scale_s /* r29 */, enum _GXIndTexScale scale_t /* r30 */) {
    // References
    // -> struct __GXData_struct * const __GXData;
    // -> struct __GXVerifyData * __gxVerif;
    // -> unsigned char __GXinBegin;
...
// Range: 0x803B894C -> 0x803B8C1C
void GXSetIndTexOrder(enum _GXIndTexStageID ind_stage /* r1+0x8 */, enum _GXTexCoordID tex_coord /* r29 */, enum _GXTexMapID tex_map /* r30 */) {
    // References
    // -> struct __GXData_struct * const __GXData;
    // -> struct __GXVerifyData * __gxVerif;
    // -> unsigned char __GXinBegin;
...
// Range: 0x803B8C1C -> 0x803B8CCC
void GXSetNumIndStages(unsigned char nIndStages /* r30 */) {
    // References
    // -> struct __GXData_struct * const __GXData;
    // -> unsigned char __GXinBegin;
}

// Range: 0x803B8CCC -> 0x803B8D48
void GXSetTevDirect(enum _GXTevStageID tev_stage /* r1+0x10 */) {
    // References
    // -> unsigned char __GXinBegin;
}

// Range: 0x803B8D48 -> 0x803B8D4C
void __GXUpdateBPMask() {}

// Range: 0x803B8D4C -> 0x803B8DF4
void __GXSetIndirectMask(unsigned long mask /* r31 */) {
    // References
    // -> struct __GXData_struct * const __GXData;
    // -> struct __GXVerifyData * __gxVerif;
}

// Range: 0x803B8DF4 -> 0x803B8E40
