/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDStat.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A24E8 -> 0x803A2A28
*/
// total size: 0x40
struct CARDDir {
    // Members
...
// Range: 0x803A24E8 -> 0x803A261C
static void UpdateIconOffsets(struct CARDDir * ent /* r3 */, struct CARDStat * stat /* r4 */) {
    // Local variables
...
// Range: 0x803A261C -> 0x803A278C
long CARDGetStatus(long chan /* r26 */, long fileNo /* r27 */, struct CARDStat * stat /* r30 */) {
    // Local variables
    struct CARDControl * card; // r1+0x14
    struct CARDDir * dir; // r25
    struct CARDDir * ent; // r31
    long result; // r28
}

// Range: 0x803A278C -> 0x803A29C4
long CARDSetStatusAsync(long chan /* r26 */, long fileNo /* r27 */, struct CARDStat * stat /* r31 */, void (* callback)(long, long) /* r1+0x14 */) {
    // Local variables
...
// Range: 0x803A29C4 -> 0x803A2A28
long CARDSetStatus(long chan /* r30 */, long fileNo /* r1+0xC */, struct CARDStat * stat /* r1+0x10 */) {
    // Local variables
    long result; // r31
}
