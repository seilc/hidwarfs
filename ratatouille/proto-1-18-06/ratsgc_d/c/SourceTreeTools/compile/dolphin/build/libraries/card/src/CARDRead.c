/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDRead.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A1800 -> 0x803A1ED0
*/
// total size: 0x14
struct CARDFileInfo {
    // Members
...
// Range: 0x803A1800 -> 0x803A1AD4
long __CARDSeek(struct CARDFileInfo * fileInfo /* r31 */, long length /* r24 */, long offset /* r28 */, struct CARDControl * * pcard /* r1+0x14 */) {
    // Local variables
    struct CARDControl * card; // r1+0x18
    struct CARDDir * dir; // r26
    struct CARDDir * ent; // r29
    long result; // r27
    unsigned short * fat; // r25
}

struct CARDControl __CARDBlock[2]; // size: 0x220, address: 0x80D57600
// Range: 0x803A1AD4 -> 0x803A1C98
static void ReadCallback(long chan /* r25 */, long result /* r29 */) {
    // Local variables
    struct CARDControl * card; // r30
    void (* callback)(long, long); // r27
    unsigned short * fat; // r24
    struct CARDFileInfo * fileInfo; // r31
    long length; // r26
...
// Range: 0x803A1C98 -> 0x803A1E64
long CARDReadAsync(struct CARDFileInfo * fileInfo /* r27 */, void * buf /* r26 */, long length /* r30 */, long offset /* r29 */, void (* callback)(long, long) /* r23 */) {
    // Local variables
    struct CARDControl * card; // r1+0x1C
    long result; // r31
    struct CARDDir * dir; // r25
    struct CARDDir * ent; // r24
}

// Range: 0x803A1E64 -> 0x803A1ED0
long CARDRead(struct CARDFileInfo * fileInfo /* r30 */, void * buf /* r1+0xC */, long length /* r1+0x10 */, long offset /* r1+0x14 */) {
    // Local variables
    long result; // r31
}
