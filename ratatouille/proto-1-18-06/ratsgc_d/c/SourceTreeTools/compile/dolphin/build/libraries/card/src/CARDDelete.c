/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDDelete.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A2338 -> 0x803A24E8
*/
// total size: 0x50
...
// Range: 0x803A2338 -> 0x803A23CC
static void DeleteCallback(long chan /* r28 */, long result /* r30 */) {
    // Local variables
...
// Range: 0x803A23CC -> 0x803A24E8
long CARDDeleteAsync(long chan /* r27 */, const char * fileName /* r1+0xC */, void (* callback)(long, long) /* r28 */) {
    // Local variables
    struct CARDControl * card; // r1+0x18
    long fileNo; // r1+0x14
    long result; // r31
    struct CARDDir * dir; // r29
