/*
    Compile unit: c:\SourceTreeTools\compile\dolphin\build\libraries\card\src\CARDCreate.c
    Producer: MW EABI PPC C-Compiler
    Language: C89
    Code range: 0x803A13B4 -> 0x803A1800
*/
// total size: 0x50
...
// Range: 0x803A13B4 -> 0x803A1544
static void CreateCallbackFat(long chan /* r27 */, long result /* r29 */) {
    // Local variables
...
// Range: 0x803A1544 -> 0x803A1800
long CARDCreateAsync(long chan /* r25 */, const char * fileName /* r24 */, unsigned long size /* r27 */, struct CARDFileInfo * fileInfo /* r22 */, void (* callback)(long, long) /* r20 */) {
    // Local variables
    struct CARDControl * card; // r1+0x1C
    struct CARDDir * dir; // r23
    struct CARDDir * ent; // r30
    unsigned short fileNo; // r26
    unsigned short freeNo; // r29
    unsigned short * fat; // r21
    long result; // r28
}
