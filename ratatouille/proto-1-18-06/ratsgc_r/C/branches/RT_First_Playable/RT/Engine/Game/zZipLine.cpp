/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zZipLine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80181C40 -> 0x80181E80
*/
// Range: 0x80181C40 -> 0x80181C60
void zZipLineInit(void * plat /* r0 */, void * asset /* r0 */) {}
...
// total size: 0x2C
struct zZipLineAsset : public xBaseAsset {
    // Members
    ...
    union { // inferred
        ...
        class xNurbs * spline; // offset 0x1C, size 0x4
    };
    union { // inferred
        unsigned int boundEntityID; // offset 0x20, size 0x4
        struct xEnt * boundEntity; // offset 0x20, size 0x4
    };
    float speed; // offset 0x24, size 0x4
    unsigned int flags; // offset 0x28, size 0x4
};
// total size: 0x18
struct zZipLine : public xBase {
    // Members
    struct zZipLineAsset * asset; // offset 0x10, size 0x4
    unsigned char enabled; // offset 0x14, size 0x1
    unsigned char gotDismount; // offset 0x15, size 0x1
};
// Range: 0x80181C60 -> 0x80181CC0
void zZipLineInit(struct zZipLine * zipline /* r30 */, struct zZipLineAsset * asset /* r31 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C01DD8
// total size: 0xC
...
// Range: 0x80181CC0 -> 0x80181E38
void zZipLineSetup(struct zZipLine * zipline /* r31 */) {
    // Local variables
    unsigned int id; // r30
...
// Range: 0x80181E38 -> 0x80181E80
void zZipLineEventCB(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */) {
    // Local variables
    struct zZipLine * zipline; // r0
}
...
struct config : public xCamConfigFollow {
    ...
    struct zone_data zone_side; // offset 0x5C, size 0x18
    float side_yaw; // offset 0x74, size 0x4
};
// total size: 0x280
struct zZipLineCam : public xCam {
    // Members
    struct config cfg; // offset 0x140, size 0x78
private:
    struct xMat4x3 basis; // offset 0x1C0, size 0x40
    struct xCamCoordSphere end_coord; // offset 0x200, size 0x20
    struct xVec3 end_offset; // offset 0x220, size 0xC
    float vel_dist; // offset 0x22C, size 0x4
    float vel_turn; // offset 0x230, size 0x4
    struct zone_data zone; // offset 0x234, size 0x18
    struct zone_data end_zone; // offset 0x24C, size 0x18
    struct zone_data vel_zone; // offset 0x264, size 0x18
};
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0x1
struct /* @class$977zZipLine_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$978zZipLine_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$979zZipLine_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$980zZipLine_cpp */ {
    // Members
