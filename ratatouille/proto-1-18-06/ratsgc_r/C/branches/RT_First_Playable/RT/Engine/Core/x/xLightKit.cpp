/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xLightKit.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800797E0 -> 0x8007A198
*/
// total size: 0x8
struct RwObject {
    // Members
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD208
// total size: 0x1
...
// Range: 0x800797E0 -> 0x80079CE4
struct xLightKit * xLightKit_Prepare(void * data /* r24 */) {
    // Local variables
    struct iAsyncLockRWSentry rw_sentry; // r1+0x8
    struct xLightKit * lkit; // r29
    struct xLightKitLight * currlight; // r28
    unsigned int i; // r27
    unsigned int numdir; // r26
    unsigned int numamb; // r25
    float s; // f1
    struct RwFrame * frame; // r24
    struct RwMatrixTag tmpmat; // r1+0xC
...
// total size: 0x4
struct /* @class$1080xLightKit_cpp */ {
    // Members
...
// Range: 0x80079CE4 -> 0x80079D08
void xLightKit_GetBlendInfo(struct xLightKitBlendInfo & lkitInfo /* r0 */, struct xModelInstance * model /* r0 */) {}

// Range: 0x80079D08 -> 0x80079D7C
int xLightKit_Compare(struct xLightKitBlendInfo & lkitInfo1 /* r0 */, struct xLightKitBlendInfo & lkitInfo2 /* r0 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD21C
...
// Range: 0x80079D7C -> 0x80079E44
void xLightKit_Enable(const struct xModelInstance & model /* r30 */, struct RpWorld * world /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD230
// total size: 0x10
struct RwRGBAReal {
    // Members
...
// Range: 0x80079E44 -> 0x8007A104
void xLightKit_Enable(struct xLightKit * lkit /* r29 */, struct RpWorld * world /* r28 */, struct xLightKit * lkit_blend /* r30 */, float blendPercentage /* f31 */) {
    // Local variables
    unsigned int i; // r27
    struct RwRGBAReal blendedColor; // r1+0x8
...
// Range: 0x8007A104 -> 0x8007A10C
struct xLightKitBlendInfo * xLightKit_GetCurrent() {
    // References
    // -> struct xLightKitBlendInfo gLastLightKit;
}

// Range: 0x8007A10C -> 0x8007A198
void xLightKit_Destroy(struct xLightKit * lkit /* r27 */) {
    // Local variables
    unsigned int i; // r30
    struct xLightKitLight * currLight; // r29
    struct RwFrame * tframe; // r28
}
