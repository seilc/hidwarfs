/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8010B468 -> 0x8010C360
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8010B468 -> 0x8010B488
void zEGenerator_Init(void * egen /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFFFE0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1085zEGenerator_cpp */ {
    // Members
...
union /* @class$820zEGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1249zEGenerator_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1785zEGenerator_cpp */ {
    // Members
...
// Range: 0x8010B488 -> 0x8010B738
void zEGenerator_Init(struct zEGenerator * egen /* r30 */, struct xEntAsset * asset /* r31 */) {
    // Local variables
    struct zEGenAsset * zasset; // r0
    void * buf; // r0
...
// Range: 0x8010B738 -> 0x8010B7F8
void zEGenerator_Setup(struct zEGenerator * egen /* r28 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFFFF4
// total size: 0x0
struct xSerial {};
// Range: 0x8010B7F8 -> 0x8010B8C8
void zEGenerator_Save(struct zEGenerator * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C00008
// Range: 0x8010B8C8 -> 0x8010B998
void zEGenerator_Load(struct zEGenerator * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x8010B998 -> 0x8010BA34
void zEGenerator_Reset(struct zEGenerator * egen /* r30 */) {
    // Local variables
    struct zEGenAsset * zasset; // r31
}

// Range: 0x8010BA34 -> 0x8010BA38
void zEGenerator_Move() {}

// Range: 0x8010BA38 -> 0x8010BB48
void zEGenerator_Update(struct zEGenerator * egen /* r31 */, struct xScene * sc /* r0 */, float dt /* f31 */) {
    // Local variables
    struct xBase * b; // r0
    struct zEnt * ent; // r0
}

// Range: 0x8010BB48 -> 0x8010BB68
void zEGenerator_Render(struct zEGenerator * egen /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0001C
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x8010BB68 -> 0x8010BF60
void zEGenerator_TurnOn(struct zEGenerator * egen /* r31 */) {
    // Local variables
    struct zEGenAsset * zasset; // r29
    struct xAnimPlay * aplay; // r30
    unsigned short itgt; // r29
    unsigned short imp; // r28
    int i; // r27
    const struct xLinkAsset * link; // r26
    struct xBase * b; // r25
    struct xVec3 destOffset; // r1+0x10
    int i; // r25
    struct _tagLightningAdd add; // r1+0x1C
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C00030
// Range: 0x8010BF60 -> 0x8010C090
void zEGenerator_TurnOff(struct zEGenerator * egen /* r29 */) {
    // Local variables
    struct xAnimPlay * aplay; // r30
    int i; // r29
...
// Range: 0x8010C090 -> 0x8010C0C4
void zEGenerator_ToggleOn(struct zEGenerator * egen /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00044
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
// Range: 0x8010C0C4 -> 0x8010C360
void zEGeneratorEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
