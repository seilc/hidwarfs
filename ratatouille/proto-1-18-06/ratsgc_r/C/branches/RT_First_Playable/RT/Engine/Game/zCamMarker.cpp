/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamMarker.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8023D320 -> 0x8023EEB4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char activated; // size: 0x1, address: 0x80C090F0
static struct zCamWidget * widget_cam; // size: 0x4, address: 0x80C090F4
enum _tagTransType {
    eTransType_None = 0,
...
static struct xCamAsset static_cam_asset; // size: 0x88, address: 0x80BCB320
// Range: 0x8023D320 -> 0x8023D3B4
static void activate_camera(const struct xCamAsset & a /* r30 */, struct xEnt * ent /* r31 */) {
    // References
...
// Range: 0x8023D3B4 -> 0x8023D430
// this: r31
static void zCamWidget::transition(const struct xCamAsset * asset /* r0 */, float time /* f1 */, struct xEnt * target_ent /* r0 */) {}

// Range: 0x8023D430 -> 0x8023D4A8
// this: r31
static void zCamWidget::start_transition() {}

// Range: 0x8023D4A8 -> 0x8023D50C
// this: r31
...
// total size: 0x10
struct /* @class$1073zCamMarker_cpp */ {
    // Members
...
// Range: 0x8023D50C -> 0x8023D5E8
// this: r31
static void zCamWidget::refresh_end_mat() {
    // Local variables
    const struct xVec3 & target; // r0
    struct xVec3 at; // r1+0x8
}

// Range: 0x8023D5E8 -> 0x8023D668
static void deactivate_camera(unsigned char force_cut /* r3 */, unsigned char restore_original /* r0 */) {
    // References
    // -> static struct zCamWidget * widget_cam;
    // -> static unsigned char activated;
}

// Range: 0x8023D668 -> 0x8023D6C4
static void refresh_active_camera(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xCamAsset & a; // r4

    // References
    // -> static struct zCamWidget * widget_cam;
}

// Range: 0x8023D6C4 -> 0x8023D718
static void on_change_active(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xCamAsset & a; // r3
...
// Range: 0x8023D740 -> 0x8023D860
static void on_change_direction(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct xCamAsset & a; // r31
    struct xVec3 & rdir; // r0
...
// total size: 0xC
struct /* @class$1009zCamMarker_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1010zCamMarker_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1011zCamMarker_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1012zCamMarker_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1013zCamMarker_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1014zCamMarker_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1015zCamMarker_cpp */ {
    // Members
...
static struct tweak_callback cb_active; // size: 0x28, address: 0x803FA928
static struct tweak_callback cb_refresh; // size: 0x28, address: 0x803FA950
static struct tweak_callback cb_direction; // size: 0x28, address: 0x803FA978
// Range: 0x8023D860 -> 0x8023DA6C
...
// Range: 0x8023DA6C -> 0x8023DAD8
static void on_explode_tweaks(const struct tweak_info & info /* r30 */) {
    // Local variables
    struct xCamAsset & a; // r31
    char prefix[128]; // r1+0x8
}

static struct tweak_callback cb_explode; // size: 0x28, address: 0x80440C20
static signed char init; // size: 0x1, address: 0x80C090F8
// Range: 0x8023DAD8 -> 0x8023DBD0
...
static char active_camera_name[64]; // size: 0x40, address: 0x80BCB3A8
static struct tweak_callback cb_deactivate; // size: 0x28, address: 0x803FA9A0
// Range: 0x8023DBD0 -> 0x8023DC48
...
// Range: 0x8023DCC8 -> 0x8023DCE8
void zCamMarkerActivateCamera(const struct xCamAsset & a /* r0 */, struct xEnt * ent /* r0 */) {}

// Range: 0x8023DCE8 -> 0x8023DD4C
...
// Range: 0x8023DD4C -> 0x8023DDA0
// this: r31
static void zCamWidget::create() {}

// Range: 0x8023DDDC -> 0x8023DE18
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04A20
// Range: 0x8023DE18 -> 0x8023DECC
void zCamMarkerInit(struct xBase * b /* r30 */, struct xCamAsset * asset /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04A30
// total size: 0x14
...
// total size: 0x0
struct xSerial {};
// Range: 0x8023DECC -> 0x8023DFA4
void zCamMarkerSave(struct zCamMarker * m /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04A40
// Range: 0x8023DFA4 -> 0x8023E07C
void zCamMarkerLoad(struct zCamMarker * m /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static unsigned char done; // size: 0x1, address: 0x80C090F9
static signed char init; // size: 0x1, address: 0x80C090FA
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C04A50
// Range: 0x8023E07C -> 0x8023E1C8
void zCamMarkerEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r30 */, struct xBase * toParamWidget /* r31 */) {
    // References
...
// Range: 0x8023E1C8 -> 0x8023E1E8
void zStaticCameraAsset_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x8023E1E8 -> 0x8023E230
void zStaticCameraAsset_Init(struct zStaticCameraObject * object /* r30 */, struct zStaticCameraAsset * asset /* r31 */) {}

// Range: 0x8023E230 -> 0x8023E2D0
void zStaticCameraAsset_EventCB(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
...
unsigned char zCamPlayerPOI::ApplyAssetSettings(const xCamBinaryAsset&)::already_asserted; // size: 0x1, address: 0x80C090FB
signed char zCamPlayerPOI::ApplyAssetSettings(const xCamBinaryAsset&)::localstatic4 guard; // size: 0x1, address: 0x80C090FC
char __FUNCTION__$localstatic1$ApplyAssetSettings__13zCamPlayerPOIFRC15xCamBinaryAsset[19]; // size: 0x13, address: 0x80C04A64
// total size: 0x18
class zCamPool : public zCamPoolBase {};
static class zCamPool POICamPool; // size: 0x18, address: 0x80C09100
// total size: 0x14
...
// Range: 0x8023E2D0 -> 0x8023E334
// this: r30
void zCamBinaryPOI::Init(const struct xCamBinaryAsset & asset /* r31 */) {}
...
// Range: 0x8023E334 -> 0x8023E3A0
void zCamBinaryPOI::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {
    // References
...
// Range: 0x8023E3A0 -> 0x8023E3C4
void zCamBinaryPOI::SceneExit() {
    // References
    // -> static class zCamPool POICamPool;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C04A78
...
// Range: 0x8023E3C4 -> 0x8023E544
// this: r28
unsigned char zCamBinaryPOI::Activate(const struct xCamTransitionParams * transitionParams /* r29 */, unsigned char forceRestart /* r30 */) {
    // Local variables
    struct xBase * target; // r31
    struct zCamPlayerPOI * cam; // r27
...
// Range: 0x8023E544 -> 0x8023E598
void zCamBinaryPOI::EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {}

unsigned char mDebugDraw; // size: 0x1, address: 0x80C09118
unsigned char sTweakedAssetActive; // size: 0x1, address: 0x80C09119
struct xCamBinaryAsset sTweakedAsset; // size: 0x34, address: 0x80BCB3E8
// total size: 0x4D0
...
// Range: 0x8023E598 -> 0x8023E5A4
void zCamPlayerPOI::asset_tweak_open() {
    // References
    // -> unsigned char sTweakedAssetActive;
}

// Range: 0x8023E5A4 -> 0x8023E5B0
void zCamPlayerPOI::asset_tweak_close() {
    // References
    // -> unsigned char sTweakedAssetActive;
}

static unsigned char tweaksAdded; // size: 0x1, address: 0x80C0911A
static signed char init; // size: 0x1, address: 0x80C0911B
static struct tweak_callback asset_tweak_cb; // size: 0x28, address: 0x80440C48
static signed char init; // size: 0x1, address: 0x80C0911C
static char * prefix; // size: 0x4, address: 0x80C09120
static signed char init; // size: 0x1, address: 0x80C09124
// Range: 0x8023E5B0 -> 0x8023E890
...
// total size: 0x4C
struct {} zCamPlayerPOI::__vtable; // size: 0x4C, address: 0x80440C70
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x8023E890 -> 0x8023E90C
// this: r31
void zCamPlayerPOI::update(struct xScene & scene /* r0 */, float dt /* f0 */) {
    // References
...
// Range: 0x8023E90C -> 0x8023EBE8
// this: r30
void zCamPlayerPOI::ApplyAssetSettings(const struct xCamBinaryAsset & asset /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1300zCamMarker_cpp */ {
    // Members
...
union /* @class$1060zCamMarker_cpp */ {
...
// total size: 0xC
struct /* @class$1438zCamMarker_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1999zCamMarker_cpp */ {
    // Members
...
struct {} @unnamed@zCamMarker_cpp@::zCamWidget::__vtable; // size: 0x4C, address: 0x80440CBC
// Range: 0x8023ECEC -> 0x8023ECF4
static float zCamWidget::getCameraPlayerAudioBias() {}

// Range: 0x8023ECF4 -> 0x8023ED70
// this: r31
...
// Range: 0x8023EDC4 -> 0x8023EEB4
// this: r31
static void zCamWidget::update(float dt /* f0 */) {
    // Local variables
    float s; // f31
}
