/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCarryableObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026B790 -> 0x8026BBC4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1130zCarryableObject_cpp */ {
    // Members
...
union /* @class$1269zCarryableObject_cpp */ {
...
// total size: 0xC
struct /* @class$1268zCarryableObject_cpp */ {
    // Members
...
// Range: 0x8026B790 -> 0x8026B7B0
static void UpdateWrapper(struct xEnt * carryable /* r0 */, float dt /* f0 */) {}

// Range: 0x8026B7B0 -> 0x8026B7DC
...
// total size: 0x4
struct /* @class$1482zCarryableObject_cpp */ {
    // Members
...
// Range: 0x8026B7DC -> 0x8026B8EC
// this: r31
zCarryableObject::zCarryableObject(struct zCarryableObjectAsset & asset /* r29 */) {
    // Local variables
    unsigned int tempSize; // r1+0x8
    unsigned int assetID; // r0
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C054F0
// Range: 0x8026B8EC -> 0x8026BA8C
void zCarryableObject::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8026BB30 -> 0x8026BB5C
// this: r0
void zCarryableObject::Update(float dt /* f0 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8026BB5C -> 0x8026BB84
// this: r0
void zCarryableObject::Drop() {}

// Range: 0x8026BB84 -> 0x8026BBC4
// this: r0
void zCarryableObject::HandleEvent(struct xBase * from /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetId /* r0 */) {}
