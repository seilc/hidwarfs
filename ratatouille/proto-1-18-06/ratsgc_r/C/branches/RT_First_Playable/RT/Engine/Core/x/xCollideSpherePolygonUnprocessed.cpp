/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollideSpherePolygonUnprocessed.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801A7074 -> 0x801A8368
*/
// Range: 0x801A7074 -> 0x801A70E0
...
// Range: 0x801A70E0 -> 0x801A7188
static unsigned char ComputeSurface(class xPlane & surface /* r28 */, const struct xVec3 & pt0 /* r29 */, const struct xVec3 & pt1 /* r30 */, const struct xVec3 & pt2 /* r31 */) {
    // Local variables
    struct xVec3 edge0; // r1+0x14
    struct xVec3 edge1; // r1+0x8
}
...
// Range: 0x801A7188 -> 0x801A7210
static unsigned char ComputeEdge(struct xVec3 & dir /* r27 */, float & len /* r28 */, class xPlane & plane /* r29 */, const class xPlane & surface /* r30 */, const struct xVec3 & pt0 /* r31 */, const struct xVec3 & pt1 /* r8 */) {}
...
// Range: 0x801A7210 -> 0x801A7A50
unsigned char TriangleTestSphereOnPlaneUnprocessed(const class xPlane & surface /* r26 */, const struct xVec3 & p0 /* r27 */, const struct xVec3 & p1 /* r28 */, const struct xVec3 & p2 /* r29 */, const struct xSweptSphere & sphere /* r30 */, struct xCollideSphereToPolygonResults & results /* r31 */, float vertical_d0 /* f30 */) {
    // Local variables
    struct xVec3 edge0dir; // r1+0xFC
    struct xVec3 edge1dir; // r1+0xF0
    struct xVec3 edge2dir; // r1+0xE4
    float edge0len; // r1+0x10
    float edge1len; // r1+0xC
    float edge2len; // r1+0x8
    class xPlane edge0plane; // r1+0xD4
    class xPlane edge1plane; // r1+0xC4
    class xPlane edge2plane; // r1+0xB4
    float above_edge_d0; // f0
    float above_edge_vel; // f0
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0xA4
    struct xVec3 to_sphere; // r1+0x98
    float along_edge_d0; // f0
    struct xVec3 to_sphere; // r1+0x8C
    float along_edge_d0; // f0
    struct xVec3 to_sphere; // r1+0x80
    float along_edge_d0; // f0
    struct xVec3 to_sphere; // r1+0x74
    float along_edge_d0; // f0
    struct xVec3 to_sphere; // r1+0x68
    float along_edge_d0; // f0
    struct xVec3 to_sphere; // r1+0x5C
    float along_edge_d0; // f0
}
...
// total size: 0x4
struct /* @class$1088xCollideSpherePolygonUnprocessed_cpp */ {
    // Members
...
union /* @class$1236xCollideSpherePolygonUnprocessed_cpp */ {
...
// Range: 0x801A7A50 -> 0x801A7CE4
unsigned char xSweptSphereToTriangleDoubleSidedUnprocessed(const struct xSweptSphere & sphere /* r26 */, const struct xVec3 & pt0 /* r27 */, const struct xVec3 & pt1 /* r28 */, const struct xVec3 & pt2 /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */, class xPlane & surface /* r31 */) {
    // Local variables
...
// Range: 0x801A7CE4 -> 0x801A7E64
unsigned char xSweptSphereToTriangleUnprocessed(const struct xSweptSphere & sphere /* r26 */, const struct xVec3 & pt0 /* r27 */, const struct xVec3 & pt1 /* r28 */, const struct xVec3 & pt2 /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */, class xPlane & surface /* r31 */) {
    // Local variables
    float vertical_vel; // f0
    float vertical_d0; // f0
    float vertical_de; // f4
...
// Range: 0x801A7E64 -> 0x801A81EC
static unsigned char TriangleTestSphereToThreePoints(const struct xSweptSphere & sphere /* r27 */, struct xCollideSphereToPolygonResults & results /* r31 */, const struct xVec3 & pt0 /* r28 */, const struct xVec3 & pt1 /* r29 */, const struct xVec3 & pt2 /* r30 */) {
    // Local variables
    ...
    float dist_to_pt0; // f0
    float dist_to_pt1; // f0
    float dist_to_pt2; // f0
}

// Range: 0x801A81EC -> 0x801A8368
static unsigned char TriangleTestSphereToTwoPoints(const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r29 */, const struct xVec3 & pt0 /* r30 */, const struct xVec3 & pt1 /* r31 */) {
    // Local variables
