/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMenu.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8013D214 -> 0x8013E58C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float time_elapsed; // size: 0x4, address: 0x80C00C94
static float time_last; // size: 0x4, address: 0x80C08260
static float time_current; // size: 0x4, address: 0x80C08264
static float sAttractMode_timer; // size: 0x4, address: 0x80C08268
static float sOneLiner_timer; // size: 0x4, address: 0x80C0826C
enum xSndHandle {
};
static enum xSndHandle frozone_speaks; // size: 0x4, address: 0x80C00C98
static int card; // size: 0x4, address: 0x80C08270
static int sInMenu; // size: 0x4, address: 0x80C08274
static float ONELINER_WAITTIME; // size: 0x4, address: 0x80C00C9C
static float holdTmr; // size: 0x4, address: 0x80C00CA0
static unsigned char sAllowAttract; // size: 0x1, address: 0x80C08278
// Range: 0x8013D214 -> 0x8013D234
...
// Range: 0x8013D248 -> 0x8013D250
int zMenuRunning() {
    // References
    // -> static int sInMenu;
}

enum eFMVFile attractMovies[5]; // size: 0x14, address: 0x80C00CA4
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00CB8
// Range: 0x8013D250 -> 0x8013D38C
void zMenuInitLoad(unsigned int theSceneID /* r31 */) {
    // Local variables
    long long t; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00CC8
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8013D3EC -> 0x8013D534
void zMenuExit() {
    // Local variables
    long long t; // r31
    int i; // r30
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00CD4
...
// total size: 0x4
struct /* @class$2223zMenu_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2224zMenu_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$1029zMenu_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zMenu_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zMenu_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zMenu_cpp */ {
    // Members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00CE0
...
// Range: 0x8013D810 -> 0x8013E290
unsigned int zMenuLoop(int force_draw_black /* r31 */) {
    // Local variables
    long long t; // r15
    int ostrich_delay; // r20
    unsigned int nextSceneID; // r16
    unsigned int attractsPlayed; // r19
    int draw_black; // r18
    int ss; // r0
    const char * fname; // r0
...
// Range: 0x8013E474 -> 0x8013E480
unsigned int zMenuGetBadCard() {
    // References
    // -> static int card;
}

// Range: 0x8013E480 -> 0x8013E504
unsigned int zMenuFMVPlay(const char * filename /* r30 */, unsigned int buttons /* r0 */, float time /* f0 */, unsigned int uSubtitlesAID /* r0 */, unsigned char skippable /* r0 */, unsigned char lockController /* r0 */, unsigned char displayDemoBlink /* r0 */) {
    // Local variables
...
// Range: 0x8013E504 -> 0x8013E50C
int zMenuIsFirstBoot() {
    // References
    // -> int sFirstBoot;
}

// Range: 0x8013E50C -> 0x8013E514
void zMenuFirstBootSet(int val /* r0 */) {
    // References
    // -> int sFirstBoot;
}

// Range: 0x8013E514 -> 0x8013E584
void zMenuPause(unsigned char bPause /* r0 */) {
    // References
    // -> long long sTimeLast;
    // -> float SECS_PER_VBLANK;
    // -> static float time_last;
...
// Range: 0x8013E584 -> 0x8013E58C
void zMenuAllowAtract(unsigned char allowAttract /* r0 */) {
    // References
    // -> static unsigned char sAllowAttract;
}
