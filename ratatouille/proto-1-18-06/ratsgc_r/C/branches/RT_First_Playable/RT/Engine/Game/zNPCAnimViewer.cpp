/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCAnimViewer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B5AB0 -> 0x802B5C18
*/
unsigned char mIsPresent; // size: 0x1, address: 0x80C09730
char __FUNCTION__$localstatic1$AttachComponent__62zComponentPool<20zCompLogicAnimViewer,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06580
signed char zComponentPool<zCompLogicAnimViewer, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09731
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicAnimViewer, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C09734
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x802B5B5C -> 0x802B5BD8
// this: r30
void zNPCAnimViewer::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1173zNPCAnimViewer_cpp */ {
    // Members
...
union /* @class$1313zNPCAnimViewer_cpp */ {
...
// total size: 0xC
struct /* @class$1311zNPCAnimViewer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1047zNPCAnimViewer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCAnimViewer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCAnimViewer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCAnimViewer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCAnimViewer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCAnimViewer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCAnimViewer_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCAnimViewer::__vtable; // size: 0x30, address: 0x80448628
