/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHeistNPCInterface.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80277ABC -> 0x8027C93C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80277B24 -> 0x80277B68
// this: r31
void zHeistNPCInterfaceManager::Exit() {}

// Range: 0x80277B68 -> 0x80277BA0
// this: r31
...
void zHeistNPCInterfaceManager::Update(float dt /* f31 */) {
    ...
    int i; // r28
    class zHeistNPCDetectorEnemyInterface * detector; // r27
    struct xVec3 playerCenter; // r1+0x14
    unsigned int hasBeenDetected; // r0
    int numGangMembers; // r0
    int j; // r26
    class zHeistGangMemberInterface * gangMember; // r25
...
// total size: 0x4
struct /* @class$1124zHeistNPCInterface_cpp */ {
    // Members
...
union /* @class$1263zHeistNPCInterface_cpp */ {
...
// total size: 0xC
struct /* @class$1262zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2104zHeistNPCInterface_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1065zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1068zHeistNPCInterface_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1069zHeistNPCInterface_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1070zHeistNPCInterface_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1071zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2251zHeistNPCInterface_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2252zHeistNPCInterface_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2253zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2250zHeistNPCInterface_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2255zHeistNPCInterface_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1847zHeistNPCInterface_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80277D58 -> 0x80277D7C
// this: r3
void zHeistNPCInterfaceManager::ResetSelection(class zHeistLookoutPoint * lookoutPoint /* r0 */) {}

// Range: 0x80277D7C -> 0x80277DA0
// this: r3
void zHeistNPCInterfaceManager::SelectNextGangMember(class zHeistLookoutPoint * lookoutPoint /* r0 */) {}

// Range: 0x80277DA0 -> 0x80277DC4
// this: r3
void zHeistNPCInterfaceManager::SelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint /* r0 */) {}

// Range: 0x80277DC4 -> 0x80277DE8
// this: r3
void zHeistNPCInterfaceManager::SelectNextPath() {}

// Range: 0x80277DE8 -> 0x80277E0C
// this: r3
void zHeistNPCInterfaceManager::SelectPrevPath() {}

// Range: 0x80277E0C -> 0x80277E30
// this: r3
void zHeistNPCInterfaceManager::ExecuteCommand() {}

// Range: 0x80277E30 -> 0x80277E88
// this: r30
void zHeistNPCInterfaceManager::CheckSelected(class zHeistLookoutPoint * lookoutPoint /* r31 */) {}

class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager; // size: 0x4, address: 0x80C09388
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C057A8
// total size: 0x4
struct PrivateFlags {
    // Members
...
// Range: 0x80277E88 -> 0x8027805C
// this: r30
zHeistNPCDetectorViewBlocker::zHeistNPCDetectorViewBlocker(struct zHeistNPCDetectorViewBlockerAsset * theAsset /* r31 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C057B0
// Range: 0x8027805C -> 0x802781FC
void zHeistNPCDetectorViewBlocker::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802781FC -> 0x80278268
// this: r0
void zHeistNPCDetectorViewBlocker::EventCB(unsigned int toEvent /* r0 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C057B8
// Range: 0x80278268 -> 0x80278360
void zHeistNPCDetectorViewBlocker::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static unsigned char done; // size: 0x1, address: 0x80C0938C
static signed char init; // size: 0x1, address: 0x80C0938D
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C057C0
// total size: 0x8
...
// Range: 0x80278388 -> 0x8027847C
// this: r31
unsigned char zHeistNPCDetectorViewBlocker::CanBlock() {
    // Local variables
    struct zDestructible * destTemp; // r0
...
// Range: 0x8027847C -> 0x80278490
// this: r0
void zHeistNPCDetectorViewBlocker::Update() {}

// Range: 0x80278490 -> 0x80278964
// this: r30
void zHeistNPCDetectorViewBlocker::SetViewedFrom(struct xVec3 * viewedFrom /* r31 */, struct xColor_tag * drawColor /* r29 */) {
    // Local variables
    struct xVec3 viewVec; // r1+0x124
    float distance; // f0
    float viewAngle; // r1+0x30
    struct xVec3 rightVec; // r1+0x118
    struct xVec3 leftVec; // r1+0x10C
    struct xVec3 rightBottomFront; // r1+0x100
    struct xVec3 rightBottomBack; // r1+0xF4
    struct xVec3 rightTopFront; // r1+0xE8
    struct xVec3 rightTopBack; // r1+0xDC
    struct xVec3 leftBottomFront; // r1+0xD0
    struct xVec3 leftBottomBack; // r1+0xC4
    struct xVec3 leftTopFront; // r1+0xB8
    struct xVec3 leftTopBack; // r1+0xAC
    struct xVec3 basePoint; // r1+0xA0
    struct xVec3 rbf; // r1+0x94
    struct xVec3 rbb; // r1+0x88
    struct xVec3 rtf; // r1+0x7C
    struct xVec3 rtb; // r1+0x70
    struct xVec3 lbf; // r1+0x64
    struct xVec3 lbb; // r1+0x58
    struct xVec3 ltf; // r1+0x4C
    struct xVec3 ltb; // r1+0x40
    int i; // r30
}

// Range: 0x80278964 -> 0x80278968
void zHeistNPCDetectorViewBlocker::RenderOverlay() {}

class zHeistNPCDetectorEnemyInterfaceManager * detectorEnemyInterfaceManager; // size: 0x4, address: 0x80C09390
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C057CC
// Range: 0x80278968 -> 0x80278C54
// this: r30
void zHeistNPCDetectorEnemyInterface::BuildPatrolRoute() {
    // Local variables
    struct xMovePoint * * tempArray; // r31
    int j; // r6
...
// Range: 0x80278C54 -> 0x80278C98
// this: r31
class zNPCBase * zHeistNPCDetectorEnemyInterface::GetNPCBase() {}

// total size: 0x1
class zINPC {};
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C057E0
// Range: 0x80278C98 -> 0x80278E1C
// this: r3
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C057F0
// Range: 0x80278E1C -> 0x80278FC8
// this: r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C057F8
// Range: 0x80278FC8 -> 0x80279168
void zHeistNPCDetectorEnemyInterface::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05800
// Range: 0x80279168 -> 0x80279694
// this: r29
void zHeistNPCDetectorEnemyInterface::EventCB(struct xBase * from /* r30 */, unsigned int toEvent /* r0 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r31 */) {
    // Local variables
    float params[4]; // r1+0x28
    float params[4]; // r1+0x18
    float params[4]; // r1+0x8
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05808
// Range: 0x802796E4 -> 0x802797DC
void zHeistNPCDetectorEnemyInterface::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05810
// Range: 0x802797DC -> 0x80279918
// this: r31
void zHeistNPCDetectorEnemyInterface::SceneEnter() {
    // Local variables
    struct xBase * tBase; // r0
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0581C
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x80279918 -> 0x8027A4D8
// this: r31
void zHeistNPCDetectorEnemyInterface::Update(float dt /* f31 */) {
    // Local variables
    ...
    unsigned int hasBeenDetected; // r0
    unsigned int hasBeenDetected; // r3
...
// Range: 0x8027A4D8 -> 0x8027A4DC
void zHeistNPCDetectorEnemyInterface::RenderOverlay() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05824
// Range: 0x8027A4DC -> 0x8027A760
// this: r30
unsigned int zHeistNPCDetectorEnemyInterface::Detect(struct xVec3 * location /* r31 */) {
    // Local variables
...
// Range: 0x8027A760 -> 0x8027A888
// this: r30
void zHeistNPCDetectorEnemyInterface::ShowViewBlockerSafeAreas(class zHeistNPCDetectorViewBlocker * blocker /* r31 */) {
    // Local variables
...
// Range: 0x8027AA74 -> 0x8027AAE8
// this: r30
void zHeistNPCDetectorEnemyInterfaceManager::RegisterInterface(class zHeistNPCDetectorEnemyInterface * regInterface /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0582C
// Range: 0x8027AAE8 -> 0x8027ABDC
// this: r29
void zHeistNPCDetectorEnemyInterfaceManager::InsertInterface(class zHeistNPCDetectorEnemyInterface * insInterface /* r30 */, int idx /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x8027ABDC -> 0x8027AC50
// this: r30
void zHeistNPCDetectorEnemyInterfaceManager::RegisterViewBlocker(class zHeistNPCDetectorViewBlocker * regViewBlocker /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C0583C
// Range: 0x8027AC50 -> 0x8027AD44
// this: r29
void zHeistNPCDetectorEnemyInterfaceManager::InsertViewBlocker(class zHeistNPCDetectorViewBlocker * insViewBlocker /* r30 */, int idx /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x8027AD44 -> 0x8027AF14
// this: r25
unsigned char zHeistNPCDetectorEnemyInterfaceManager::IsBlocked(struct xVec3 * viewPos /* r26 */, struct xVec3 * lookPos /* r27 */) {
    // Local variables
    float yCoeff; // f31
    float xCoeff; // f30
    float divisor; // f29
    ...
    float x; // f3
    float y; // f4
    float blockerRadius; // f0
    struct xVec3 * blockerPos; // r0
    class zHeistNPCDetectorViewBlocker * blocker; // r29
    int i; // r28
}

// Range: 0x8027AF14 -> 0x8027AF6C
// this: r31
...
class zHeistGangMemberInterfaceManager * gangMemberInterfaceManager; // size: 0x4, address: 0x80C09394
// Range: 0x8027AF6C -> 0x8027AFAC
// this: r31
void zHeistGangMemberInterfaceManager::Exit() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05850
// Range: 0x8027AFAC -> 0x8027B07C
// this: r29
...
// Range: 0x8027B07C -> 0x8027B0F0
// this: r29
void zHeistGangMemberInterfaceManager::Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
}

// Range: 0x8027B0F0 -> 0x8027B168
// this: r29
void zHeistGangMemberInterfaceManager::ResetSelection(class zHeistLookoutPoint * lookoutPoint /* r0 */) {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x8027B168 -> 0x8027B17C
// this: r0
...
// Range: 0x8027B17C -> 0x8027B1F0
// this: r30
void zHeistGangMemberInterfaceManager::RegisterInterface(class zHeistGangMemberInterface * regInterface /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05860
// Range: 0x8027B1F0 -> 0x8027B2E4
// this: r29
void zHeistGangMemberInterfaceManager::InsertInterface(class zHeistGangMemberInterface * insInterface /* r30 */, int idx /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x8027B2E4 -> 0x8027B3B4
// this: r28
void zHeistGangMemberInterfaceManager::PlayerSelectNextGangMember(class zHeistLookoutPoint * lookoutPoint /* r29 */) {
    // Local variables
    int startIdx; // r30
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x8027B3B4 -> 0x8027B478
// this: r29
void zHeistGangMemberInterfaceManager::PlayerSelectPrevGangMember(class zHeistLookoutPoint * lookoutPoint /* r30 */) {
    // Local variables
    int startIdx; // r31
    class zHeistGangMemberInterface * currGangMember; // r30
}

// Range: 0x8027B478 -> 0x8027B4E4
// this: r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05870
// Range: 0x8027B550 -> 0x8027B84C
// this: r30
void zHeistGangMemberInterfaceManager::ExecuteCommand() {
    // Local variables
    class zHeistMovementPath * selectedPath; // r31
...
// Range: 0x8027B84C -> 0x8027B950
// this: r0
unsigned char zHeistGangMemberInterfaceManager::ValidSelectedGangMember(class zHeistLookoutPoint * lookoutPoint /* r30 */) {
    // Local variables
    class zHeistGangMemberInterface * currGangMember; // r31
...
// Range: 0x8027B9CC -> 0x8027B9E0
// this: r0
void zHeistGangMemberPrototypeNavData::Reset() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05880
// Range: 0x8027B9E0 -> 0x8027BA9C
// this: r0
...
// Range: 0x8027BA9C -> 0x8027BAA4
// this: r0
void zHeistGangMemberPrototypeNavData::SetDirection(int inDir /* r0 */) {}

// Range: 0x8027BAA4 -> 0x8027BAAC
// this: r0
void zHeistGangMemberPrototypeNavData::SetStartingPointIdx(int inIdx /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0588C
// Range: 0x8027BAAC -> 0x8027BC8C
// this: r30
zHeistGangMemberInterface::zHeistGangMemberInterface(struct zHeistGangMemberInterfaceAsset * theAsset /* r31 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05894
// Range: 0x8027BC8C -> 0x8027BE2C
void zHeistGangMemberInterface::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C0589C
// Range: 0x8027BE2C -> 0x8027BF24
void zHeistGangMemberInterface::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C058A4
// Range: 0x8027BF24 -> 0x8027C2A0
// this: r30
void zHeistGangMemberInterface::EventCB(unsigned int toEvent /* r0 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r31 */) {
    // Local variables
...
// Range: 0x8027C2A0 -> 0x8027C2F0
// this: r31
void zHeistGangMemberInterface::SceneEnter() {
    // Local variables
    class zHeistMovementPath * startPath; // r0

    // References
    // -> class zHeistGangMemberInterfaceManager * gangMemberInterfaceManager;
}

// Range: 0x8027C2F0 -> 0x8027C410
// this: r30
void zHeistGangMemberInterface::RenderOverlay(int selectedGangMember /* r31 */) {
    // Local variables
    struct xColor_tag gangMemberColor; // r1+0xC
    struct xVec3 boxCorner1; // r1+0x1C
    struct xVec3 boxCorner2; // r1+0x10
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C058AC
struct xVec3 m_UnitAxisY; // size: 0xC, address: 0x80C0B564
// Range: 0x8027C410 -> 0x8027C89C
// this: r31
void zHeistGangMemberInterface::Update(float dt /* f31 */) {
    // Local variables
    class zHeistMovementPath * movePath; // r30
    struct xMovePoint * curMovePoint; // r29
    ...
    float moveDist; // f31
    float fLength; // f1
    struct xMovePoint * targetPoint; // r0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C058B4
// Range: 0x8027C89C -> 0x8027C93C
// this: r30
void zHeistGangMemberInterface::GetLocation(struct xVec3 * gangMemberLoc /* r31 */) {
    // References
