/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCTypes.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8024FFE4 -> 0x80252270
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zNPCTypesTable gNPCTypesTable[17]; // size: 0x50C, address: 0x80441FF8
enum eCompType {
    eCompType_Unknown = -1,
...
// total size: 0x4
struct /* @class$1174zNPCTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1312zNPCTypes_cpp */ {
    // Members
...
static unsigned char gNPCTypesTableInitialized; // size: 0x1, address: 0x80C091A0
// Range: 0x8024FFE4 -> 0x8024FFF0
struct zNPCTypesTable * zNPCTypes_GetTable() {
    // References
    // -> static struct zNPCTypesTable gNPCTypesTable[17];
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80C04E58
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x8024FFF0 -> 0x8025007C
struct zNPCTypesTable * zNPCTypes_GetTableEntry(enum eNPCType npcType /* r0 */) {
    // References
    // -> static struct zNPCTypesTable gNPCTypesTable[17];
...
// Range: 0x8025007C -> 0x802500D4
enum eNPCType zNPCTypes_GetNPCType(enum eBrainType brainType /* r31 */) {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r3
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C04E70
// Range: 0x802500D4 -> 0x802501FC
void zNPCTypes_Prepare() {
    // Local variables
    struct zNPCTypesTable * npcTypesTableEntry; // r30
    int i; // r29

    // References
    // -> static unsigned char gNPCTypesTableInitialized;
    // -> static struct zNPCTypesTable gNPCTypesTable[17];
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04E84
// Range: 0x802501FC -> 0x80250388
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04E98
// Range: 0x80250388 -> 0x80250514
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04EAC
// Range: 0x80250514 -> 0x802506A0
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04EC0
// Range: 0x802506A0 -> 0x8025082C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04ED4
// Range: 0x8025082C -> 0x802509B8
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04EE8
// Range: 0x802509B8 -> 0x80250B44
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04EFC
// Range: 0x80250B44 -> 0x80250CD0
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F10
// Range: 0x80250CD0 -> 0x80250E5C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F24
// Range: 0x80250E5C -> 0x80250FE8
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F38
// Range: 0x80250FE8 -> 0x80251174
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F4C
// Range: 0x80251174 -> 0x80251300
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F60
// Range: 0x80251300 -> 0x8025148C
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F74
// Range: 0x8025148C -> 0x80251618
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F88
// Range: 0x80251618 -> 0x802517A4
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04F9C
// Range: 0x802517A4 -> 0x80251930
unsigned char ValidateNPCAsset(const struct xDynAsset * dynAsset /* r31 */, unsigned int dynAssetSize /* r28 */, const char * assetTypeName /* r29 */) {
    // Local variables
    unsigned long expected_asset_size; // r30
...
// Range: 0x80251930 -> 0x80251988
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x802519C4 -> 0x80251A1C
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251A58 -> 0x80251AB0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251AEC -> 0x80251B44
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251B80 -> 0x80251BD8
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251C14 -> 0x80251C6C
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251CA8 -> 0x80251D00
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251D3C -> 0x80251D94
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251DD0 -> 0x80251E28
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251E64 -> 0x80251EBC
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251EF8 -> 0x80251F50
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80251F8C -> 0x80251FE4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80252020 -> 0x80252078
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x802520B4 -> 0x8025210C
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80252148 -> 0x802521A0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x802521DC -> 0x80252234
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}
