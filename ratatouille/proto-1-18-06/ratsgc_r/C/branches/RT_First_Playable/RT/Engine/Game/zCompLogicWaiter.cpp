/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicWaiter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029A404 -> 0x8029BE94
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float WAITER_BOUND_RADIUS; // size: 0x4, address: 0x80C06018
static float WAITER_BOUND_MIDRADIUS; // size: 0x4, address: 0x80C0601C
static float WAITER_BOUND_YSHIFT; // size: 0x4, address: 0x80C06020
static float BIG_EPSILON; // size: 0x4, address: 0x80C06024
static float WAITER_COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x80C06028
static float WAITER_TURN_SPEED; // size: 0x4, address: 0x80C0602C
static float WAITER_SPEED; // size: 0x4, address: 0x80C06030
static float WAITER_IDLE_SPEED; // size: 0x4, address: 0x80C06034
static float showScalarVel; // size: 0x4, address: 0x80C09568
static float KNOCKBACK_DIST; // size: 0x4, address: 0x80C06038
static unsigned int WAITER_TORSO; // size: 0x4, address: 0x80C0603C
static unsigned int WAITER_HEAD; // size: 0x4, address: 0x80C06040
static unsigned int WAITER_LHAND; // size: 0x4, address: 0x80C06044
static unsigned int WAITER_RHAND; // size: 0x4, address: 0x80C06048
// total size: 0x28
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C0604C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$2090zCompLogicWaiter_cpp */ {
    // Members
...
// Range: 0x8029A564 -> 0x8029A6C4
// this: r31
unsigned char zCompLogicWaiter::SystemEvent(unsigned int to_event /* r26 */, const float * to_param /* r27 */, struct xBase * to_param_widget /* r28 */, unsigned int to_param_widget_id /* r29 */) {
    // Local variables
...
// Range: 0x8029A800 -> 0x8029A83C
// this: r0
unsigned char zCompLogicWaiter::MoveStartCheck(class zICompNPCEntity * compNPCEntity /* r0 */) {
    // References
    // -> static float WAITER_IDLE_SPEED;
}

// Range: 0x8029A83C -> 0x8029A8A8
// this: r0
unsigned char zCompLogicWaiter::MoveStopCheck(class zICompNPCEntity * compNPCEntity /* r0 */) {
    // References
    // -> static float WAITER_IDLE_SPEED;
}

// Range: 0x8029A8A8 -> 0x8029A8E4
// this: r0
unsigned char zCompLogicWaiter::HitReactStartCheck(class zICompNPCEntity * compNPCEntity /* r0 */) {}

// Range: 0x8029A8E4 -> 0x8029A940
// this: r0
unsigned char zCompLogicWaiter::HitReactStopCheck(class zICompNPCEntity * compNPCEntity /* r0 */) {}
...
// Range: 0x8029A940 -> 0x8029AA14
// this: r30
void zCompLogicWaiter::Attached() {
    // Local variables
    class zNPCWaiter * npcWaiter; // r31
    struct zNPCAssetWaiter * npcassWaiter; // r0

    // References
    // -> struct xVec3 m_Null;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06058
// Range: 0x8029AA14 -> 0x8029AAF8
// this: r30
...
// Range: 0x8029AAF8 -> 0x8029AB70
// this: r30
void zCompLogicWaiter::knockback(struct xVec3 * knockback /* r31 */) {}

// Range: 0x8029AB70 -> 0x8029AFAC
// this: r29
void zCompLogicWaiter::Update(float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// total size: 0x4
struct /* @class$1111zCompLogicWaiter_cpp */ {
    // Members
...
union /* @class$1250zCompLogicWaiter_cpp */ {
...
// total size: 0xC
struct /* @class$1030zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1032zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1033zCompLogicWaiter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1034zCompLogicWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1035zCompLogicWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1036zCompLogicWaiter_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06064
// Range: 0x8029AFAC -> 0x8029B278
// this: r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0606C
unsigned int zCOLLISION_NPC; // size: 0x4, address: 0x80C0EC34
unsigned int zCOLLISION_NEEDS_DEPEN_OUTER_BOUND; // size: 0x4, address: 0x80C0EC38
unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x80C0EC3C
// total size: 0x1C
...
// Range: 0x8029B278 -> 0x8029BAB0
// this: r30
void zCompLogicWaiter::SphereCollision(const struct xVec3 * pNewPosition /* r21 */, const struct xVec3 * pVelocity /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xEntFrame * frame; // r0
    struct xSphere collisionSphere[5]; // r1+0x118
    int i; // r0
    struct xSphere * extra_spheres[5]; // r1+0xCC
    int num_spheres; // r0
    struct xSweptSphere sws; // r1+0x168
    struct xVec3 deltaPos; // r1+0xC0
    struct xVec3 testNewPos; // r1+0xB4
    struct xVec3 testOldPos; // r1+0xA8
    int j; // r21
    struct xVec3 myPos; // r1+0x9C
    struct xVec3 theirPos; // r1+0x90
    struct xVec3 knockback; // r1+0x84
    struct xVec3 delta; // r1+0x78
    struct zCombatDamageInfo combatDamageInfo; // r1+0xE0
    struct xVec3 averageGroundNormal; // r1+0x6C
    struct xEnt * pEntity; // r3
    class zICompNPCEntity * npcEnt; // r0
    struct xVec3 myPos; // r1+0x60
    struct xVec3 theirPos; // r1+0x54
    struct xVec3 knockback; // r1+0x48
    struct xVec3 delta; // r1+0x3C
...
// total size: 0x890
struct /* @class$2337zCompLogicWaiter_cpp */ {
    // Static members
...
// Range: 0x8029BAB0 -> 0x8029BC00
// this: r26
void zCompLogicWaiter::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r27 */, struct xEntFrame * frame /* r28 */) {
    // Local variables
    int i; // r29
    float normDot; // f0
...
// Range: 0x8029BC00 -> 0x8029BD00
// this: r27
void zCompLogicWaiter::DepenetrateCollisionList(struct xVec3 * pPosition /* r28 */) {
    // Local variables
    int i; // r29
...
// total size: 0xC
struct /* @class$1249zCompLogicWaiter_cpp */ {
    // Members
...
// Range: 0x8029BD00 -> 0x8029BE30
unsigned char zCompLogicWaiterTurnToFace(struct xEntFrame * frame /* r30 */, const struct xVec3 * target /* r31 */, float speedLimit /* f29 */, float dt /* f30 */) {
    // Local variables
