/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicStirringPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029C68C -> 0x8029CD40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xVec3 potPositions[4]; // size: 0x30, address: 0x80447360
static float sPotBoilStart; // size: 0x4, address: 0x80C060A0
static float sPotBoilHeight; // size: 0x4, address: 0x80C060A4
static unsigned int replyToID; // size: 0x4, address: 0x80C09590
static unsigned char init; // size: 0x1, address: 0x80C09594
// Range: 0x8029C6F8 -> 0x8029C780
...
static struct xResponseCurve potColorCurve; // size: 0x14, address: 0x80C09598
static struct rgba_node potColors[3]; // size: 0x3C, address: 0x804083D0
static unsigned int boil[4]; // size: 0x10, address: 0x80C060A8
// total size: 0x2
...
// Range: 0x8029C780 -> 0x8029CCF8
// this: r29
void zCompLogicStirringPlayer::Update(float dt /* f27 */) {
    // Local variables
    ...
    int i; // r27
    struct xEnt * ent; // r0
    struct rgba_node value; // r1+0x28
    struct RpGeometry * geom; // r7
    struct RpMaterial * mater; // r3
...
// total size: 0x4
struct /* @class$1191zCompLogicStirringPlayer_cpp */ {
    // Members
...
union /* @class$1331zCompLogicStirringPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1329zCompLogicStirringPlayer_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1117zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1118zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1119zCompLogicStirringPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1120zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1121zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1122zCompLogicStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1123zCompLogicStirringPlayer_cpp */ {
    // Members
...
// Range: 0x8029CCF8 -> 0x8029CD40
// this: r0
unsigned char zCompLogicStirringPlayer::SystemEvent(unsigned int to_event /* r0 */, const float * to_param /* r0 */, unsigned int to_param_widget_id /* r0 */) {
    // References
    // -> static unsigned int replyToID;
}
