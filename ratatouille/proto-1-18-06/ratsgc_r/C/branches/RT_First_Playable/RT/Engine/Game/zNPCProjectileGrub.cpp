/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCProjectileGrub.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80253BCC -> 0x80254A68
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float GRUB_SPEED; // size: 0x4, address: 0x80C05008
static float GRUB_EXPLOSION_RADIUS; // size: 0x4, address: 0x80C0500C
static float GRUB_AWAY_KNOCKBACK; // size: 0x4, address: 0x80C05010
static float GRUB_UP_KNOCKBACK; // size: 0x4, address: 0x80C05014
static float GRUB_TRAIL_OFFSET; // size: 0x4, address: 0x80C05018
static float GRUB_SHADOW_OFFSET; // size: 0x4, address: 0x80C0501C
static float GRUB_DECAL_SIZE; // size: 0x4, address: 0x80C05020
static float GRUB_LIFETIME; // size: 0x4, address: 0x80C05024
static float GRUB_RADIUS; // size: 0x4, address: 0x80C05028
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x803FD738
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x80C091C0
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x80C091C4
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x80C091C8
static unsigned int GRUB_BUG_MODEL_ID; // size: 0x4, address: 0x80C091CC
static unsigned int GRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x80C091D0
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x44, address: 0x804426D8
static struct TrailConfig ShortTrailConfig; // size: 0x44, address: 0x8044271C
// total size: 0x1C
struct ArcConfig {
    // Members
...
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x80C0502C
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x80C05030
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x80C05034
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088zNPCProjectileGrub_cpp */ {
    // Members
...
union /* @class$1236zNPCProjectileGrub_cpp */ {
...
// total size: 0xC
struct /* @class$1235zNPCProjectileGrub_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct xSurface * grubScrollingSurf; // size: 0x4, address: 0x80C091D4
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$2073zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zNPCProjectileGrub_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x170
class zNPCProjectileGrub : public zNPCProjectileBase {
    // Functions
    void Freeze();
    ...
    void Explode(unsigned char inflictDamage, const struct xEnt * ent);

    unsigned char LaunchFromEnt(struct xEnt * ent, const struct xVec3 * localOffset, float speed, struct xEnt * refObj);
    ...
    struct xModelInstance * bugModel; // offset 0x1C, size 0x4
    struct xVec3 startPos; // offset 0x20, size 0xC
    ...
    float emit_remaining; // offset 0x44, size 0x4
    float spark_emit_remaining; // offset 0x48, size 0x4
    float arc_emit_remaining; // offset 0x4C, size 0x4
    struct zShrapnelAsset * launchGoo; // offset 0x50, size 0x4
    struct zShrapnelAsset * hitGoo; // offset 0x54, size 0x4
    struct emit_context decalContext; // offset 0x58, size 0x5C
    struct xResponseCurve decalResponseCurve; // offset 0xB4, size 0x14
    enum xSndHandle flyingSound; // offset 0xC8, size 0x4
    struct xShadowSimpleCache simpShadow; // offset 0xCC, size 0xA4
};
// Range: 0x80253BCC -> 0x80253BD4
float zNPCProjectileGrub::GetRadius() {
    // References
    // -> static float GRUB_RADIUS;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05038
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80253BD4 -> 0x80253C84
// this: r31
void zNPCProjectileGrub::Freeze() {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C05040
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1484zNPCProjectileGrub_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80253C84 -> 0x80253D34
void zNPCProjectileGrub::StaticSetup() {
    // References
    // -> struct xSurface * grubScrollingSurf;
    // -> static char __FUNCTION__[12];
    // -> static unsigned int GRUB_BUG_SURFACE_ID;
...
// Range: 0x80253D34 -> 0x80253D60
// this: r0
void zNPCProjectileGrub::Reset() {}
...
// Range: 0x80253D60 -> 0x80253FA0
// this: r31
void zNPCProjectileGrub::Update(float dt /* f31 */) {
    // Local variables
    struct xVec3 velocity; // r1+0x58
    struct xVec3 dpos; // r1+0x4C
    struct xVec3 trail_pos; // r1+0x40
    struct xVec3 vel0; // r1+0x34
    struct xMat4x3 shadowMat; // r1+0x70

    // References
    // -> static float GRUB_SHADOW_OFFSET;
    // -> enum iSndGroupHandle flyingSoundGroup;
    // -> static struct TrailConfig ShortTrailConfig;
    // -> static struct TrailConfig PuffConfig;
    // -> static float GRUB_LIFETIME;
    // -> static float GRUB_TRAIL_OFFSET;
}
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0504C
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x80253FA0 -> 0x80254078
// this: r30
void zNPCProjectileGrub::Render() {
    // Local variables
    struct xMat4x3 * frame; // r31
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05054
// Range: 0x80254078 -> 0x802540F8
// this: r31
void zNPCProjectileGrub::Destroy() {
    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C0505C
struct xVec3 g_NZ3; // size: 0xC, address: 0x80C0ADDC
// Range: 0x802540F8 -> 0x80254508
// this: r30
unsigned char zNPCProjectileGrub::Setup(void * configData /* r31 */) {
    // Local variables
    struct GrubConfig * config; // r0
    ...
    // References
    // -> enum iSndGroupHandle launchSoundGroup;
    // -> static float GRUB_DECAL_SIZE;
    // -> static struct curve_node decalCurve[5];
    // -> struct xSurface * grubScrollingSurf;
    // -> static float GRUB_SPEED;
    // -> static float GRUB_LIFETIME;
    // -> struct xVec3 g_NZ3;
    // -> static char __FUNCTION__[6];
    // -> struct zGlobals globals;
    // -> static unsigned int GRUB_BUG_MODEL_ID;
}
...
// Range: 0x80254508 -> 0x802547C8
// this: r31
void zNPCProjectileGrub::Collide(const struct xVec3 & dpos /* r26 */) {
    // Local variables
    struct xVec3 velocity; // r1+0x34
    struct xSweptSphere sws; // r1+0xA0
    struct xVec3 start; // r1+0x28
    struct xVec3 end; // r1+0x1C
    unsigned int old_filter_flags; // r28
...
// total size: 0x4
struct /* @class$2442zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2401zNPCProjectileGrub_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2402zNPCProjectileGrub_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2403zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2400zNPCProjectileGrub_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2405zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zNPCProjectileGrub_cpp */ {
    // Static members
...
// Range: 0x802547C8 -> 0x80254994
// this: r31
void zNPCProjectileGrub::Explode(unsigned char inflictDamage /* r0 */, const struct xEnt * ent /* r30 */) {
    // Local variables
    ...
    // -> static float GRUB_UP_KNOCKBACK;
    // -> static float GRUB_AWAY_KNOCKBACK;
    // -> static float GRUB_EXPLOSION_RADIUS;
}
...
struct GrubConfig {
    // Members
    struct xEnt * owner; // offset 0x0, size 0x4
    struct xVec3 startPos; // offset 0x4, size 0xC
    struct xVec3 dir; // offset 0x10, size 0xC
    int damage; // offset 0x1C, size 0x4
    float speed; // offset 0x20, size 0x4
};
// Range: 0x80254994 -> 0x80254A64
// this: r28
unsigned char zNPCProjectileGrub::LaunchFromEnt(struct xEnt * ent /* r29 */, const struct xVec3 * localOffset /* r30 */, float speed /* f31 */, struct xEnt * refObj /* r31 */) {
    // Local variables
    struct GrubConfig config; // r1+0x14
    struct xMat4x3 * mat; // r31
    struct xVec3 offset; // r1+0x8
}

// Range: 0x80254A64 -> 0x80254A68
void zNPCProjectileGrub::AddStaticTweaks() {}

// total size: 0x38
struct {} zNPCProjectileGrub::__vtable; // size: 0x38, address: 0x80442798
// total size: 0x0
