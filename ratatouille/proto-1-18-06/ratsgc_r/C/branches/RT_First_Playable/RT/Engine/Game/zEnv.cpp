/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEnv.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80116CB8 -> 0x801177D8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char renderJSPs; // size: 0x1, address: 0x80C00310
// Range: 0x80116CB8 -> 0x80116CD8
void zEnvInit(void * env /* r0 */, void * easset /* r0 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C00314
...
// total size: 0x1
struct /* @class$1037zEnv_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1038zEnv_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1039zEnv_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1040zEnv_cpp */ {
    // Members
...
// Range: 0x80116CD8 -> 0x80116EC0
void zEnvInit(struct _zEnv * env /* r27 */, struct xEnvAsset * easset /* r30 */) {
    // Local variables
    int mapper_count; // r0
    int i; // r27
    unsigned int size; // r1+0x8
    struct xBase * material_map; // r0
    int i; // r27
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00320
// Range: 0x80116EC0 -> 0x80116FAC
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0032C
// Range: 0x80116FAC -> 0x80117074
void zEnvStartingCamera(struct _zEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00340
// total size: 0x18
struct zSurfMatFX {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x80117074 -> 0x80117240
void zEnvRender(struct xEnv * env /* r31 */) {
    // Local variables
    struct RpWorld * world; // r29
    int num; // r28
    int i; // r27
    const struct xSurface * sp; // r0
    struct zSurfaceProps * pp; // r4
    struct RpMaterial * mp; // r26
    struct xGroup * g; // r3
    unsigned int texid; // r0
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C0034C
// Range: 0x80117240 -> 0x80117318
void zEnvSave(struct _zEnv * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C00358
// Range: 0x80117318 -> 0x801173F0
void zEnvLoad(struct _zEnv * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00364
// Range: 0x801173F0 -> 0x801174C4
void zEnvReset(struct _zEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00370
struct xEnv * gCurXEnv; // size: 0x4, address: 0x80C07270
// Range: 0x801174C4 -> 0x8011778C
void zEnvEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r30 */, struct xBase * toParamWidget /* r31 */) {
    // References
