/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zReference.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80155380 -> 0x8015569C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1121zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1277zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1062zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1063zReference_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1064zReference_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1065zReference_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1066zReference_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1067zReference_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1068zReference_cpp */ {
    // Members
...
// Range: 0x80155380 -> 0x801553DC
static void ReferenceMemToTweak(const struct tweak_info & info /* r0 */, void * value /* r31 */) {
    // Local variables
    const char * * valueStr; // r0

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x801553DC -> 0x801553FC
...
static struct tweak_callback cb; // size: 0x28, address: 0x8043AA78
static signed char init; // size: 0x1, address: 0x80C08380
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C011E0
// total size: 0x14
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C011F0
// Range: 0x80155580 -> 0x8015569C
void zReferenceEventCB(struct xBase * from /* r0 */, struct xBase * to /* r30 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r31 */, unsigned int toParamWidgetID /* r0 */) {
    // Local variables
