/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicSimpleton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B8590 -> 0x802B9790
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gSimpletonMoveToSteeringParams; // size: 0x70, address: 0x80BD4490
// total size: 0x8
...
static struct zCompStateMachineTable gSimpletonStateMachineTable[5]; // size: 0x28, address: 0x80448890
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06618
// total size: 0x34
...
// Range: 0x802B8590 -> 0x802B89AC
// this: r30
unsigned char zCompLogicSimpleton::SystemEvent(struct xBase * from /* r4 */, struct xBase * to /* r5 */, unsigned int to_event /* r6 */, const float * to_param /* r31 */, struct xBase * to_param_widget /* r29 */, unsigned int to_param_widget_id /* r9 */) {
    // Local variables
    class zSimpletonMoveTo * moveState; // r0
    class zSimpletonPatrol * patrolState; // r0
    class zICompNPCEntity * compNPCEntity; // r0
    class zSimpletonPlayCustomAnim * animState; // r31
    class zSimpletonPlayCustomAnim * animState; // r31
...
// total size: 0x30
struct {} zSimpletonMoveTo::__vtable; // size: 0x30, address: 0x80448948
// Range: 0x802B8A78 -> 0x802B8ACC
// this: r31
...
// Range: 0x802B8ACC -> 0x802B8BF4
// this: r25
void zSimpletonMoveTo::Update(class zNPCBase * owner /* r26 */, float dt /* f30 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicSimpleton * compLogic; // r29
    const struct xVec3 * movePointPos; // r28
    struct xVec3 * NPCPos; // r27
    float boundRadius; // f31
    struct xVec3 distanceVec; // r1+0x8
}

// Range: 0x802B8BF4 -> 0x802B8C3C
// this: r31
void zSimpletonMoveTo::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}
...
// total size: 0x4
struct /* @class$1119zCompLogicSimpleton_cpp */ {
    // Members
...
union /* @class$1267zCompLogicSimpleton_cpp */ {
...
// total size: 0xC
struct /* @class$1257zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$987zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zCompLogicSimpleton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zCompLogicSimpleton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zCompLogicSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zCompLogicSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zCompLogicSimpleton_cpp */ {
    // Members
...
// Range: 0x802B8C3C -> 0x802B8C68
// this: r0
void zSimpletonMoveTo::Enter(class zNPCBase * owner /* r0 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06624
// Range: 0x802B8C68 -> 0x802B8D68
// this: r30
void zSimpletonMoveTo::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C0662C
// Range: 0x802B8D68 -> 0x802B8F00
// this: r30
unsigned char zSimpletonMoveTo::SystemEvent(struct xBase * to /* r31 */, unsigned int to_event /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x30
struct {} zSimpletonPatrol::__vtable; // size: 0x30, address: 0x80448918
// Range: 0x802B8F00 -> 0x802B8F58
// this: r31
...
// Range: 0x802B8F58 -> 0x802B90F0
// this: r31
void zSimpletonPatrol::Update(class zNPCBase * owner /* r25 */, float dt /* f30 */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    const struct xVec3 * movePointPos; // r28
    struct xVec3 * NPCPos; // r27
    class zCompSteeringBasic * steering; // r26
    float boundRadius; // f31
    struct xVec3 distanceVec; // r1+0xC
    struct xMovePoint * newMovePoint; // r1+0x8
...
// Range: 0x802B90F0 -> 0x802B9138
// this: r31
void zSimpletonPatrol::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// Range: 0x802B9138 -> 0x802B9164
// this: r0
void zSimpletonPatrol::Enter(class zNPCBase * owner /* r0 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06638
// Range: 0x802B9164 -> 0x802B9264
// this: r30
void zSimpletonPatrol::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06640
// Range: 0x802B9264 -> 0x802B9400
// this: r30
unsigned char zSimpletonPatrol::SystemEvent(struct xBase * to /* r31 */, unsigned int to_event /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x30
struct {} zSimpletonIdle::__vtable; // size: 0x30, address: 0x804488E8
// total size: 0x14
...
// Range: 0x802B943C -> 0x802B9440
void zSimpletonIdle::Update() {}

// Range: 0x802B9440 -> 0x802B946C
// this: r0
void zSimpletonIdle::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802B946C -> 0x802B94B0
void zSimpletonIdle::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zSimpletonPlayCustomAnim::__vtable; // size: 0x30, address: 0x804488B8
// Range: 0x802B94B0 -> 0x802B94F4
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0664C
// Range: 0x802B94F4 -> 0x802B95D0
// this: r30
void zSimpletonPlayCustomAnim::Update(class zNPCBase * owner /* r4 */, float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    float duration; // f1
...
// Range: 0x802B95D0 -> 0x802B95FC
// this: r0
void zSimpletonPlayCustomAnim::Enter(class zNPCBase * owner /* r0 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06654
// Range: 0x802B95FC -> 0x802B9790
// this: r30
void zSimpletonPlayCustomAnim::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
