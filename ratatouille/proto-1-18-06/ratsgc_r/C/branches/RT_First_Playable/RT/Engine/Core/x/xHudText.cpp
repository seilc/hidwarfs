/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xHudText.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801ACB3C -> 0x801AD454
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C02798
// total size: 0x17C
...
// Range: 0x801ACB3C -> 0x801ACCD0
void text_widget::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// total size: 0x34
struct {} xhud::text_widget::__vtable; // size: 0x34, address: 0x8043D9B0
// Range: 0x801ACCD0 -> 0x801ACD14
// this: r31
text_widget::text_widget(const struct text_asset & a /* r0 */) {
    // References
    // -> struct [anonymous] xhud::text_widget::__vtable;
}

// total size: 0x8
struct /* @class$1310xHudText_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029xHudText_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030xHudText_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031xHudText_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032xHudText_cpp */ {
    // Members
...
// Range: 0x801ACD14 -> 0x801ACD34
// this: r0
void text_widget::destruct() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C027A0
// total size: 0x1
struct /* @class$1324xHudText_cpp */ {
    // Members
...
enum /* @enum$1329xHudText_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1330xHudText_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1331xHudText_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// Range: 0x801ACD34 -> 0x801ACFE8
// this: r31
void text_widget::setup() {
    // Local variables
    const struct text_asset & ta; // r29
    struct ztextbox * ztb; // r28
...
// Range: 0x801ACFE8 -> 0x801AD008
// this: r0
void text_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80C08960
static signed char init; // size: 0x1, address: 0x80C08964
// Range: 0x801AD008 -> 0x801AD048
...
// Range: 0x801AD0B0 -> 0x801AD18C
// this: r31
void text_widget::update(float dt /* f0 */) {
    // References
    // -> unsigned int FB_YRES;
    // -> unsigned int FB_XRES;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C027A8
// Range: 0x801AD18C -> 0x801AD3A0
// this: r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C027B0
// Range: 0x801AD3A0 -> 0x801AD454
// this: r29
void text_widget::set_text(const char * intext /* r30 */) {
    // Local variables
    unsigned long textchars; // r3
