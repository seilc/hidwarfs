/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zReactiveAnimation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801B511C -> 0x801B7C50
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float anim_blend_time; // size: 0x4, address: 0x80C02940
static float heat; // size: 0x4, address: 0x80C089A0
static float damage; // size: 0x4, address: 0x80C089A4
static float knockback; // size: 0x4, address: 0x80C089A8
static float burnt_color; // size: 0x4, address: 0x80C02944
// Range: 0x801B511C -> 0x801B5230
...
static int total_reactives; // size: 0x4, address: 0x80C089AC
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$1097zReactiveAnimation_cpp */ {
    // Members
...
static struct zReactiveGenre * genres; // size: 0x4, address: 0x80C089B0
static int genres_size; // size: 0x4, address: 0x80C089B4
// total size: 0x20
struct xLinkAsset {
    // Members
...
union /* @class$1236zReactiveAnimation_cpp */ {
...
// total size: 0xC
struct /* @class$1235zReactiveAnimation_cpp */ {
    // Members
...
static struct zReactiveAnimationData * activities; // size: 0x4, address: 0x80C089B8
static int activities_size; // size: 0x4, address: 0x80C089BC
static int activities_used; // size: 0x4, address: 0x80C089C0
// total size: 0x60
struct property_set {
    // Members
...
static struct property_set fire_props; // size: 0x60, address: 0x80BB6750
// Range: 0x801B5230 -> 0x801B5238
static unsigned int AlwaysConditional() {}

// Range: 0x801B5238 -> 0x801B5258
static void on_respawn_all() {}

// Range: 0x801B5258 -> 0x801B5280
static void on_change_burn_fuel(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zReactiveGenre & genre; // r5
}
...
// total size: 0xC
struct /* @class$1038zReactiveAnimation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zReactiveAnimation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zReactiveAnimation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zReactiveAnimation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zReactiveAnimation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zReactiveAnimation_cpp */ {
    // Members
...
static struct tweak_callback cb_respawn_all; // size: 0x28, address: 0x803E7B58
// Range: 0x801B5280 -> 0x801B52C4
...
static struct tweak_callback cb_burn_fuel; // size: 0x28, address: 0x803E7B80
// Range: 0x801B52C4 -> 0x801B53CC
static void add_tweaks(const char * name /* r3 */, struct zReactiveGenre & genre /* r31 */) {
    // Local variables
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02948
// Range: 0x801B53CC -> 0x801B55B8
static struct xAnimState * add_anim_state(struct xAnimTable * table /* r29 */, unsigned int id /* r28 */, const char * name /* r30 */, struct xAnimState * transitionTo /* r31 */, unsigned char loop /* r27 */) {
    // Local variables
    void * anim_data; // r0
    struct xAnimFile * afile; // r28
    unsigned int end; // r5
    struct xAnimState * state; // r27

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02958
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02968
// total size: 0x3C
struct asset_entry {
    // Members
...
// Range: 0x801B55B8 -> 0x801B58B4
static void load_genre(struct zReactiveGenre & genre /* r30 */, const struct asset_entry & entry /* r31 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1981zReactiveAnimation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02974
// total size: 0x10
...
// Range: 0x801B59CC -> 0x801B5C24
static void load_genres() {
    // Local variables
    int tables; // r0
    int i; // r29
    unsigned int asset_size; // r1+0xC
    const struct asset_type * asset; // r28
...
// Range: 0x801B5C24 -> 0x801B5C74
static struct zReactiveGenre * find_genre(struct zEntSimpleObj & ent /* r0 */) {
    // Local variables
    struct RpAtomic * model; // r5
    struct zReactiveGenre * genre; // r3
    struct zReactiveGenre * end_genre; // r4
...
// Range: 0x801B5C74 -> 0x801B5CDC
static void setup_entity(struct zEntSimpleObj & ent /* r0 */, struct zReactiveGenre * genre /* r0 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80C089C4
static signed char init; // size: 0x1, address: 0x80C089C5
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02980
// total size: 0x1C
...
// Range: 0x801B5CDC -> 0x801B5E30
static void setup_entities() {
    // Local variables
    int total; // r31
    struct zScene & scene; // r3
    struct zEntSimpleObj * it; // r30
    struct zEntSimpleObj * end; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02990
// Range: 0x801B5E30 -> 0x801B5EBC
static struct zReactiveAnimationData * alloc_activity() {
    // Local variables
    struct zReactiveAnimationData * act; // r3
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C029A0
// Range: 0x801B5EBC -> 0x801B5F7C
static void free_activity(struct zReactiveAnimationData * act /* r31 */) {
    // Local variables
    struct zReactiveAnimationData * tail_act; // r4
...
// Range: 0x801B5FA0 -> 0x801B6040
static void swap_model(struct zEntSimpleObj & ent /* r0 */, struct RpAtomic * atomic /* r30 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C029B0
// Range: 0x801B6040 -> 0x801B62F8
static unsigned char activate_entity(struct zEntSimpleObj & ent /* r30 */, struct zReactiveGenre & genre /* r31 */) {
    // Local variables
    struct xModelInstance * model; // r29
    struct xAnimPlay * play; // r0
    struct zReactiveAnimationData & react; // r0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C029C0
// Range: 0x801B62F8 -> 0x801B64D0
static void set_static_model(struct zEntSimpleObj & ent /* r30 */, struct zReactiveGenre & genre /* r31 */) {
    // Local variables
    struct zSimpleMgr * temp; // r0
    unsigned int visible; // r5

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C029D4
// Range: 0x801B64D0 -> 0x801B65E0
static void set_burnt_model(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
    struct zSimpleMgr * temp; // r0
    unsigned int visible; // r5
...
// Range: 0x801B65E0 -> 0x801B65E8
static struct zReactiveGenre * get_genre(struct zEntSimpleObj & ent /* r3 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C029E4
// Range: 0x801B65E8 -> 0x801B6714
static void deactivate_entity(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
    struct zReactiveAnimationData & react; // r30
    unsigned char burning; // r29

    // References
    // -> static char __FUNCTION__[18];
}

static unsigned char already_asserted; // size: 0x1, address: 0x80C089C6
static signed char init; // size: 0x1, address: 0x80C089C7
static unsigned char already_asserted; // size: 0x1, address: 0x80C089C8
static signed char init; // size: 0x1, address: 0x80C089C9
static unsigned char already_asserted; // size: 0x1, address: 0x80C089CA
static signed char init; // size: 0x1, address: 0x80C089CB
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C029F8
// Range: 0x801B6714 -> 0x801B6A3C
static unsigned char update_activity(struct zReactiveAnimationData & react /* r29 */, float dt /* f31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
    struct zEntSimpleObj & ent; // r30
    struct xModelInstance * model; // r4
    struct xAnimSingle * single; // r3
    struct xAnimState * state; // r5
    float time; // f0
    float duration; // f1
    float time_left; // f2
...
// Range: 0x801B6A3C -> 0x801B6A5C
static void grid_check_bound(struct xGrid & grid /* r0 */, const struct xBound & bound /* r0 */, const struct xQCData & qcd /* r0 */, struct check_bound & cb /* r0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C02A08
// Range: 0x801B6A5C -> 0x801B6C08
static void play_anim(struct zEntSimpleObj & ent /* r30 */, struct xAnimState * state /* r31 */, float speed /* f31 */, unsigned char force_restart /* r27 */) {
    // Local variables
    struct xModelInstance * model; // r29
    struct xAnimPlay * play; // r3
    struct xAnimSingle * single; // r28
    struct xAnimTransition * tran; // r27
...
// Range: 0x801B6C08 -> 0x801B6C88
static unsigned char activate_if_possible(struct zEntSimpleObj & ent /* r0 */, struct zReactiveGenre & genre /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C02A14
// total size: 0x30
struct spawn_data {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x801B6C88 -> 0x801B6E24
static void apply_fire_damage(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02A28
// Range: 0x801B6E24 -> 0x801B6EFC
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02A34
// Range: 0x801B6F60 -> 0x801B7070
void zReactiveReset() {
    // Local variables
...
// Range: 0x801B7070 -> 0x801B70E8
void zReactiveUpdate(float dt /* f31 */) {
    // Local variables
    struct zReactiveAnimationData * act; // r31
    struct zReactiveAnimationData * end_act; // r30
...
// Range: 0x801B7144 -> 0x801B71D0
int zReactiveHitTestBound(struct zEntSimpleObj * * hits /* r30 */, int max_hits /* r0 */, const struct xBound & bound /* r31 */) {
    // Local variables
    struct check_bound cb; // r1+0x8
...
// Range: 0x801B71D0 -> 0x801B71E8
// this: r0
static check_bound::check_bound(struct zEntSimpleObj * * hits /* r0 */, int max_hits /* r0 */, const struct xBound & bound /* r0 */) {}
...
// Range: 0x801B71E8 -> 0x801B7238
int zReactiveHitTestSphere(struct zEntSimpleObj * * hits /* r30 */, int max_hits /* r31 */, const struct xSphere & sphere /* r5 */) {
    // Local variables
    struct xBound bound; // r1+0x8
}
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02A44
// Range: 0x801B7238 -> 0x801B73E8
unsigned char zReactiveMoveThrough(struct zEntSimpleObj & ent /* r31 */, float speed /* f31 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$2228zReactiveAnimation_cpp */ {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02A5C
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
    zHS_EXPLOSION = 2,
...
// Range: 0x801B73E8 -> 0x801B74E4
void zReactiveDamage(struct zEntSimpleObj & ent /* r30 */, enum zHitSource hs /* r31 */, float damage /* f31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x801B74E4 -> 0x801B7548
void zReactiveDeactivate(struct zEntSimpleObj & ent /* r0 */, unsigned char immediate /* r0 */) {
    // Local variables
    struct zReactiveGenre & genre; // r7
    struct xAnimState * state; // r4
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C02A6C
// Range: 0x801B7548 -> 0x801B7674
unsigned char zReactiveSelectLOD(struct zEntSimpleObj & ent /* r30 */, float dist2 /* f31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
    unsigned char was_active; // r3
...
// Range: 0x801B7674 -> 0x801B7700
int zReactiveCountExtraModels(struct zEntSimpleObj * * ents /* r3 */, unsigned int size /* r0 */) {
    // Local variables
    int total; // r31
    struct zEntSimpleObj * * it; // r30
    struct zEntSimpleObj * * end; // r29
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80C02A80
// Range: 0x801B7700 -> 0x801B77E4
unsigned char zReactiveNeedExtraModel(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C02A98
// Range: 0x801B77E4 -> 0x801B7954
void zReactivePreBucket(struct zEntSimpleObj & ent /* r31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r30
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043DB48
// Range: 0x801B7954 -> 0x801B7BC0
void zReactiveAddExtraSimpleMgr(struct zEntSimpleObj & ent /* r27 */, struct zSimpleMgr * smgr /* r28 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
    struct zSimpleMgr * smgr_static; // r30
    struct zSimpleMgr * smgr_burnt; // r29
    unsigned int visible; // r0
...
// Range: 0x801B7BC0 -> 0x801B7C50
// this: r30
static unsigned char check_bound::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
