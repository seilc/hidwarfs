/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zLoadingScreen.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D39E0 -> 0x801D4140
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char show_stats; // size: 0x1, address: 0x80C08B50
// total size: 0x4
class Screen {
    // Members
public:
...
// Range: 0x801D3A64 -> 0x801D3A70
void zLoadingScreen::UnSetShowStats() {
    // References
    // -> static unsigned char show_stats;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C030C8
...
void zLoadingScreen::Init() {
    ...
    struct xDynAsset * asset; // r27
    void * test; // r3
    class zUI * element; // r26
    int i; // r27
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C030D0
// Range: 0x801D3FE0 -> 0x801D40A4
// this: r30
void * zLoadingScreen::CustomAllocate(unsigned int size /* r31 */) {
    // References
    // -> void * RwEngineInstance;
    // -> static char __FUNCTION__[15];
}

// Range: 0x801D40A4 -> 0x801D4140
// this: r23
...
// total size: 0x18
struct {} zLoadingScreen::__vtable; // size: 0x18, address: 0x80C030E0
