/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUIUserString.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017C6C0 -> 0x8017CC3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x2
struct /* @class$1771zUIUserString_cpp */ {
    // Members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C01C40
// Range: 0x8017C72C -> 0x8017C810
// this: r30
void zUIUserString::DoReset() {
    // Local variables
    const char * initialText; // r31

    // References
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C01C48
// Range: 0x8017C810 -> 0x8017CB64
// this: r31
void zUIUserString::DoHandleEvent(struct xBase * from /* r4 */, unsigned int toEvent /* r5 */, const float * toParam /* r6 */, struct xBase * toParamWidget /* r7 */, unsigned int toParamWidgetID /* r8 */) {
    // Local variables
...
// Range: 0x8017CB64 -> 0x8017CB88
// this: r0
unsigned int zUIUserString::GetSortKey() const {}

// Range: 0x8017CB88 -> 0x8017CBA8
void zUIUserString_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x8017CBA8 -> 0x8017CC00
void zUIUserString_Init(class zUIUserString * userString /* r30 */, struct zUIUserStringAsset * asset /* r31 */) {}

// total size: 0x64
struct {} zUIUserString::__vtable; // size: 0x64, address: 0x8043CA40
