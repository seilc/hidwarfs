/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGrapple.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012F82C -> 0x8012FDE4
*/
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00980
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8012F82C -> 0x8012F9B0
void zGrapple_Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8012F9B0 -> 0x8012FA18
void zGrapple_Init(struct zGrapple * grapple /* r30 */, struct zGrappleAsset * asset /* r31 */) {}
...
static struct zGrapplePoint * sGrapplePoints; // size: 0x4, address: 0x80C08168
static int sNumGrapplePoints; // size: 0x4, address: 0x80C0816C
// total size: 0xC
...
// Range: 0x8012FA18 -> 0x8012FB4C
int zGrapple_Recurse(unsigned int id /* r26 */, struct zGrapplePoint * gpList /* r30 */, struct zGrapple * grapple /* r31 */) {
    // Local variables
    unsigned int i; // r28
    int result; // r27
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00990
...
// Range: 0x8012FB4C -> 0x8012FCAC
void zGrapple_SceneInit(struct zScene * zsc /* r26 */) {
    // Local variables
    int i; // r29
    int count; // r28
    int numGrapples; // r27
    struct zGrapple * grapple; // r5
...
// Range: 0x8012FCAC -> 0x8012FCE4
void zGrapple_Reset() {
    // Local variables
    int i; // r5
    struct zGrapple * grapple; // r6
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C009A4
// Range: 0x8012FCE4 -> 0x8012FDE4
void zGrapple_EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r31 */) {
    // Local variables
    struct zGrapple * grap; // r0
