/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xTRC.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800CFF0C -> 0x800D1988
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80C0B4F8
static struct _tagTRCPadInfo gTrcPad[4]; // size: 0x40, address: 0x80AA6BA8
// total size: 0x8
...
static struct _tagTRCDiskInfo gTrcDisk; // size: 0x8, address: 0x80C07878
static const char * k_CONTROLLER_MISSING_MESSAGE; // size: 0x4, address: 0x80C07880
static const char * k_CONTROLLER_INVALID_MESSAGE; // size: 0x4, address: 0x80C07884
enum _tagTRCState {
    TRC_Unknown = 0,
    TRC_PadMissing = 1,
    TRC_PadInserted = 2,
...
// Range: 0x800CFF0C -> 0x800CFF14
unsigned char xTRCMemCardCheck() {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80430790
// Range: 0x800CFF14 -> 0x800CFFCC
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFEC28
// Range: 0x800CFFCC -> 0x800D008C
int xTRCPadGetArrayIdx(int port /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x800D008C -> 0x800D019C
void xTRCPadRemove(int port /* r0 */) {
    // Local variables
    int i; // r5
...
// Range: 0x800D019C -> 0x800D01E0
static void xTRCSwapPads(struct _tagTRCPadInfo & pad0 /* r0 */, struct _tagTRCPadInfo & pad1 /* r0 */) {
    // Local variables
    struct _tagTRCPadInfo temppad; // r1+0x8
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFEC3C
// total size: 0x2
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFEC50
// Range: 0x800D02BC -> 0x800D0354
void xTRCPadSetState(int idx /* r30 */, enum _tagTRCState state /* r31 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[16];
}

// Range: 0x800D0354 -> 0x800D03BC
int xTRCPadCount(enum _tagTRCState state /* r30 */) {
    // Local variables
    int counter; // r31
    int startidx; // r1+0x8
}
...
// Range: 0x800D03BC -> 0x800D0424
int xTRCPadCount(enum _tagTRCPadState padstate /* r30 */) {
    // Local variables
    int counter; // r31
    int startidx; // r1+0x8
}

// Range: 0x800D0424 -> 0x800D04CC
int xTRCPadCountWereActiveTotal() {
    // Local variables
    int activecount; // r0
    int missingcount; // r0
    int padstatecount; // r0
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFEC60
// Range: 0x800D04CC -> 0x800D05A4
void xTRCPadSetStatePadPort(int port /* r30 */, enum _tagTRCState state /* r31 */) {
    // Local variables
    int i; // r0
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFEC78
// Range: 0x800D05A4 -> 0x800D067C
void xTRCPadSetPadStatePort(int port /* r30 */, enum _tagTRCPadState state /* r31 */) {
    // Local variables
    int i; // r0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFEC90
// Range: 0x800D067C -> 0x800D07C4
unsigned char xTRCPadFindFirst(int & idx /* r31 */, enum _tagTRCState state /* r29 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804307AC
// Range: 0x800D07C4 -> 0x800D0914
unsigned char xTRCPadFindFirstPadState(int & idx /* r31 */, enum _tagTRCPadState state /* r29 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFECA4
// Range: 0x800D0914 -> 0x800D09B8
unsigned char xTRCPadIsIdx(int idx /* r30 */, enum _tagTRCState state /* r31 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFECB4
// Range: 0x800D09B8 -> 0x800D0A44
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFECC8
// Range: 0x800D0A44 -> 0x800D0AD0
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFECDC
// Range: 0x800D0AD0 -> 0x800D0B90
enum _tagTRCState xTRCPadGetStatePort(int port /* r31 */) {
    // Local variables
    int i; // r4
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFECF0
// Range: 0x800D0B90 -> 0x800D0C50
enum _tagTRCPadState xTRCPadGetPadStatePort(int port /* r31 */) {
    // Local variables
    int i; // r4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFED08
// Range: 0x800D0C50 -> 0x800D0CDC
...
// Range: 0x800D0CDC -> 0x800D0D38
unsigned char xTRCPadIsPort(int port /* r0 */, enum _tagTRCState state /* r0 */) {
    // Local variables
    int i; // r6
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFED20
// Range: 0x800D0D38 -> 0x800D0E30
unsigned char xTRCPadGetPadPort(int & idx /* r31 */, enum _tagTRCState state /* r0 */) {
    // Local variables
    int i; // r30
...
// Range: 0x800D0E30 -> 0x800D0EA0
unsigned char xTRCPadPortWasActive(int port /* r30 */) {}

// Range: 0x800D0EA0 -> 0x800D0ED4
static unsigned char xTRCIsNextState(int i /* r0 */, unsigned int state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x800D0ED4 -> 0x800D0F08
static unsigned char xTRCIsNextPadState(int i /* r0 */, unsigned int state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x800D0F08 -> 0x800D0FA8
static unsigned char xTRCBabbleSort(unsigned char (* funcShake)(int, unsigned int) /* r25 */, unsigned int state /* r26 */) {
    // Local variables
    unsigned char babble; // r29
    int counter; // r28
    int i; // r27
...
// Range: 0x800D10BC -> 0x800D12BC
void xTRCUpdate(int i /* r29 */) {
    // Local variables
    int padPortP1; // r0
    int padPortP2; // r0
    int startidx; // r1+0x8
...
// Range: 0x800D12BC -> 0x800D133C
void xTRCPadInsert(int i /* r31 */) {
    // Local variables
    struct _tagTRCPadInfo & trcpad; // r0
}

// Range: 0x800D133C -> 0x800D13BC
void xTRCInit() {
    // References
...
// Range: 0x800D1408 -> 0x800D1578
static void render_message(const char * s /* r31 */) {
    // Local variables
    class xtextbox tb; // r1+0xBC
    struct xColor_tag c; // r1+0x14
...
unsigned int lastSetFBMSK; // size: 0x4, address: 0x80C078C8
// total size: 0x388
struct jot_block {
    // Members
...
static char composed_message_text[256]; // size: 0x100, address: 0x80AA6BE8
static const char * message_text; // size: 0x4, address: 0x80C07888
// Range: 0x800D1578 -> 0x800D158C
...
// Range: 0x800D15E4 -> 0x800D1604
void xTRCReset() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFED34
// Range: 0x800D1604 -> 0x800D1720
void xTRCPadSetPressed(int port /* r29 */, int value /* r30 */, unsigned char reverse /* r31 */) {
    // References
    // -> struct _tagxPad mPad[4];
    // -> static char __FUNCTION__[18];
}

// Range: 0x800D1720 -> 0x800D174C
void xTRCDisk(enum _tagTRCState state /* r0 */) {
    // References
    // -> static struct _tagTRCDiskInfo gTrcDisk;
}
...
// Range: 0x800D174C -> 0x800D17E0
void render_mem_card_no_space(int needed /* r0 */, int available /* r4 */, int neededFiles /* r0 */, unsigned char enabled /* r6 */) {
    // Local variables
    const char * error_text; // r0
...
static class xtextbox tb; // size: 0x74, address: 0x804307C8
static signed char init; // size: 0x1, address: 0x80C0788C
// Range: 0x800D17E0 -> 0x800D1988
void RenderText(const char * text /* r30 */, unsigned char enabled /* r31 */) {
    // Local variables
    struct xColor_tag c1; // r1+0x18
    struct xColor_tag c2; // r1+0x14
