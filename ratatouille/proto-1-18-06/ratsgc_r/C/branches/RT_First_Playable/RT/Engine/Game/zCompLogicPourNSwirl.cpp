/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicPourNSwirl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AE5E8 -> 0x802AE770
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xEnt * small_glass; // size: 0x4, address: 0x80C096D0
// total size: 0x40
struct RwMatrixTag {
    // Members
...
static struct RwMatrixTag small_glass_mat; // size: 0x40, address: 0x80BD2AA8
static struct xEnt * large_glass; // size: 0x4, address: 0x80C096D4
static struct RwMatrixTag large_glass_mat; // size: 0x40, address: 0x80BD2AE8
static unsigned char init; // size: 0x1, address: 0x80C096D8
// total size: 0x2
...
// total size: 0x4
struct /* @class$1191zCompLogicPourNSwirl_cpp */ {
    // Members
...
union /* @class$1331zCompLogicPourNSwirl_cpp */ {
...
// total size: 0xC
struct /* @class$1329zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1117zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1118zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1119zCompLogicPourNSwirl_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1120zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1121zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1122zCompLogicPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1123zCompLogicPourNSwirl_cpp */ {
    // Members
