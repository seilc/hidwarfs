/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompStateMachine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802976E8 -> 0x802998A0
*/
// total size: 0x54
struct {} zCompStateMachine::__vtable; // size: 0x54, address: 0x80447108
// total size: 0x8
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05E98
// Range: 0x80297780 -> 0x80297878
// this: r31
...
// Range: 0x80297878 -> 0x802978B8
// this: r0
unsigned char zCompStateMachine::SystemEvent(struct xBase * from /* r0 */, struct xBase * to /* r0 */, unsigned int to_event /* r0 */, const float * to_param /* r0 */, struct xBase * to_param_widget /* r0 */, unsigned int to_param_widget_id /* r0 */) {}

// Range: 0x802978B8 -> 0x802978F8
// this: r4
void zCompStateMachine::DebugRender() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05EA0
// Range: 0x802978F8 -> 0x80297A68
// this: r31
void zCompStateMachine::Attached() {
    // Local variables
    int initialStateEnum; // r0
    int globalStateEnum; // r0
    int i; // r30
...
// Range: 0x80297A68 -> 0x80297B0C
// this: r30
void zCompStateMachine::AllAttached() {
    // Local variables
    class zCompState * savedState; // r0
}

// Range: 0x80297B0C -> 0x80297B68
// this: r31
void zCompStateMachine::Detached() {}

// Range: 0x80297B68 -> 0x80297BC8
// this: r31
void zCompStateMachine::Reset() {}

static int gStateMachineExtraMemUsed; // size: 0x4, address: 0x80C09538
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05EAC
// Range: 0x80297BC8 -> 0x80297EBC
// this: r31
...
// Range: 0x80297EBC -> 0x80297EE4
// this: r0
unsigned char zCompStateMachine::RunStateTests(class zCompState * ownerState /* r5 */, float dt /* f0 */) {}

// Range: 0x80297EE4 -> 0x80298024
// this: r29
unsigned char zCompStateMachine::RunTests(struct zCompStateTest * tests /* r4 */, float dt /* f30 */, class zCompState * ownerState /* r30 */) {
    // Local variables
    struct zCompStateTest * curTest; // r31
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05EB8
// Range: 0x80298024 -> 0x8029810C
void zCompStateMachine::AppendTest(struct zCompStateTest * testToAppend /* r0 */, struct zCompStateTest * * linkedList /* r0 */) {
    // Local variables
    struct zCompStateTest * curTest; // r3

    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05EC4
...
// Range: 0x8029810C -> 0x802981E0
struct zCompStateTest * zCompStateMachine::NewTest(class zCompState * toState /* r29 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r30 */, enum eStateTranstitionType type /* r31 */, float testPeriod /* f31 */) {
    // Local variables
    struct zCompStateTest * newStateTest; // r0
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C05ECC
// Range: 0x802981E0 -> 0x80298364
// this: r28
void zCompStateMachine::AddSwitchTest(int fromStateEnum /* r0 */, int toStateEnum /* r29 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r30 */, float testPeriod /* f31 */) {
    // Local variables
    class zCompState * fromState; // r0
    class zCompState * toState; // r4
    struct zCompStateTest * newStateTest; // r4

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C05EDC
// Range: 0x80298364 -> 0x802984E8
// this: r28
void zCompStateMachine::AddPushTest(int fromStateEnum /* r0 */, int toStateEnum /* r29 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r30 */, float testPeriod /* f31 */) {
    // Local variables
    class zCompState * fromState; // r0
    class zCompState * toState; // r4
    struct zCompStateTest * newStateTest; // r4
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05EE8
// Range: 0x802984E8 -> 0x802985B0
// this: r29
void zCompStateMachine::AddPopTest(int fromStateEnum /* r0 */, unsigned char (* test)(class zNPCBase *, class zCompState *, class zCompState *) /* r30 */, float testPeriod /* f31 */) {
    // Local variables
    class zCompState * fromState; // r0
    struct zCompStateTest * newStateTest; // r4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C05EF4
// Range: 0x802985B0 -> 0x802986AC
// this: r29
void zCompStateMachine::SwitchState(int fromStateEnum /* r0 */, int toStateEnum /* r30 */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r6

    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05F00
// Range: 0x802986AC -> 0x802987A8
// this: r29
void zCompStateMachine::PushState(int fromStateEnum /* r0 */, int toStateEnum /* r30 */) {
    // Local variables
    class zCompState * fromState; // r31
    class zCompState * toState; // r6
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05F0C
// Range: 0x802987A8 -> 0x80298834
// this: r31
void zCompStateMachine::PopState(int stateEnum /* r0 */) {
    // Local variables
    class zCompState * State; // r5

    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05F18
// Range: 0x80298834 -> 0x802988C0
// this: r31
void zCompStateMachine::PushStateOnLast(int toStateEnum /* r0 */) {
    // Local variables
    class zCompState * toState; // r6
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05F28
// Range: 0x802988C0 -> 0x8029894C
// this: r31
void zCompStateMachine::SwitchLastState(int toStateEnum /* r0 */) {
    // Local variables
    class zCompState * toState; // r6
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C05F38
// Range: 0x8029894C -> 0x802989B8
// this: r3
void zCompStateMachine::AddTranstitionEvent(enum eStateTranstitionType transtitionType /* r0 */, class zCompState * fromState /* r0 */, class zCompState * toState /* r0 */) {
    // Local variables
    unsigned char pushSuccessful; // r0
...
// Range: 0x802989B8 -> 0x802989D4
// this: r0
zCompStateTransEventFIFO::zCompStateTransEventFIFO() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05F4C
// Range: 0x802989D4 -> 0x80298A90
// this: r29
...
// Range: 0x80298A90 -> 0x80298AB0
// this: r0
zCompStateTransEventFIFO::zCompStateTransEventFIFO(struct zCompStateTransEvent * eventsPool /* r0 */, int size /* r0 */) {}

// Range: 0x80298AB0 -> 0x80298B38
// this: r0
unsigned char zCompStateTransEventFIFO::PushEvent(enum eStateTranstitionType transtitionType /* r0 */, class zCompState * fromState /* r0 */, class zCompState * toState /* r0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05F58
// Range: 0x80298B38 -> 0x80298BC8
// this: r30
...
// Range: 0x80298C1C -> 0x80298C30
// this: r0
void zCompStateTransEventFIFO::Clear() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C05F64
// Range: 0x80298C30 -> 0x80298EC0
// this: r27
unsigned char zCompStateTransEventFIFO::AppendDebugString(char * string /* r28 */, int stringSize /* r29 */, unsigned char markLast /* r25 */) {
    // Local variables
    char buffer[32]; // r1+0x8
    int curEventNum; // r30
    struct zCompStateTransEvent * curEvent; // r25

    // References
    // -> static char __FUNCTION__[18];
}

struct zCompStateTransEvent debugEventsFifoPool[24]; // size: 0x120, address: 0x80BD1F18
static class zCompStateTransEventFIFO debugEventsFifo; // size: 0x14, address: 0x80C0953C
static char __FUNCTION__[24]; // size: 0x18, address: 0x80C05F78
// Range: 0x80298EC0 -> 0x8029910C
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C05F90
// Range: 0x8029910C -> 0x80299320
// this: r31
void zCompStateMachine::HandleSwitch(class zCompState * fromState /* r0 */, class zCompState * toState /* r30 */) {
    // Local variables
    char debugText[256]; // r1+0x108
    char debugText[256]; // r1+0x8
    class zCompState * oldCurStatePrev; // r4

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05FA0
// Range: 0x80299320 -> 0x80299470
// this: r31
void zCompStateMachine::HandlePop(class zCompState * fromState /* r0 */) {
    // Local variables
    char debugText[256]; // r1+0x8
    class zCompState * prevState; // r4

    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05FAC
// Range: 0x80299470 -> 0x80299670
// this: r31
void zCompStateMachine::HandlePush(class zCompState * fromState /* r29 */, class zCompState * toState /* r30 */) {
    // Local variables
    char debugText[256]; // r1+0x108
    char debugText[256]; // r1+0x8
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C05FB8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x80299670 -> 0x80299884
// this: r29
unsigned char zCompStateMachine::AppendDebugString(char * string /* r30 */, int stringSize /* r31 */) {
    // Local variables
    char buffer1[128]; // r1+0x28
    char buffer2[32]; // r1+0x8
    class zCompState * state; // r27
...
// total size: 0x30
struct {} zCompState::__vtable; // size: 0x30, address: 0x804470D8
// Range: 0x80299884 -> 0x802998A0
// this: r0
...
// total size: 0x40
struct {} zICompLogic::__vtable; // size: 0x40, address: 0x8044715C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088zCompStateMachine_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1226zCompStateMachine_cpp */ {
    // Members
...
union /* @class$1227zCompStateMachine_cpp */ {
