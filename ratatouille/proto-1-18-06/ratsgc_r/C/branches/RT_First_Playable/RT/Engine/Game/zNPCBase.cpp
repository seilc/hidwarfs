/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80281150 -> 0x8028250C
*/
char __FUNCTION__$localstatic1$SetFacing__14zICompSteeringFP5xVec3[10]; // size: 0xA, address: 0x80C059A8
char __FUNCTION__$localstatic1$SetDestination__14zICompSteeringFP5xVec3[15]; // size: 0xF, address: 0x80C059B4
char __FUNCTION__$localstatic1$SetArriverV__14zICompSteeringFP5xVec3[12]; // size: 0xC, address: 0x80C059C4
char __FUNCTION__$localstatic1$SetRepellerV__14zICompSteeringFP5xVec3[13]; // size: 0xD, address: 0x80C059D0
char __FUNCTION__$localstatic1$SetAttractorV__14zICompSteeringFP5xVec3[14]; // size: 0xE, address: 0x80C059E0
char __FUNCTION__$localstatic1$SetArriver__14zICompSteeringFP4xEnt[11]; // size: 0xB, address: 0x80C059F0
char __FUNCTION__$localstatic1$SetRepeller__14zICompSteeringFP4xEnt[12]; // size: 0xC, address: 0x80C059FC
char __FUNCTION__$localstatic1$SetAttractor__14zICompSteeringFP4xEnt[13]; // size: 0xD, address: 0x80C05A08
// total size: 0x30
struct {} zNPCBase::__vtable; // size: 0x30, address: 0x80443DB8
// total size: 0x20
struct xLinkAsset {
    // Members
...
class zNPCBase : public xBase {
    ...
    unsigned char SystemEvent(unsigned int to_event);

    void Load(enum eNPCType type, const struct xModelAssetInfo * modelAsset, struct zNPCAssetRATS * npcAsset, unsigned int npcAssetSize);

    void Reset();

    void BaseTimeStep(struct xVec3 * cullOrigin, struct xScene * xscn, float dt);

    void BaseRender();

    void BaseReset();

    void BaseUpdate(struct xScene * xscn, float dt);

    unsigned char BaseSpawn();

    unsigned char BaseActivate();

    void BaseDeactivate();

    void UpdateNPCBaseData();

    void SetChildren(class zNPCBase * firstChildren, int numChildren);

    void SetParent(class zNPCBase * parent);

    void Deactivate();

    void AllAttached();

    void PreUpdateAllComponents(struct xScene * xscn, float dt);

    void PostUpdateAllComponents(struct xScene * xscn, float dt);

    void DebugRenderAllComponents();

    unsigned char ForwardEventToComponents(struct xBase * from, struct xBase * to, unsigned int to_event, const float * to_param, struct xBase * to_param_widget, unsigned int to_param_widget_id);
...
// Range: 0x80281150 -> 0x80281188
// this: r0
zNPCBase::zNPCBase() {
    // References
    // -> struct [anonymous] zNPCBase::__vtable;
}

// Range: 0x80281188 -> 0x80281278
void zNPCBase::EventWrapper(struct xBase * from /* r24 */, struct xBase * to /* r29 */, unsigned int to_event /* r25 */, const float * to_param /* r26 */, struct xBase * to_param_widget /* r27 */, unsigned int to_param_widget_id /* r28 */) {
    // Local variables
    class zNPCBase * npc; // r30
    int i; // r29
}

// Range: 0x80281278 -> 0x80281360
// this: r31
unsigned char zNPCBase::SystemEvent(unsigned int to_event /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05A18
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x80281360 -> 0x8028146C
// this: r31
void zNPCBase::Load(enum eNPCType type /* r0 */, const struct xModelAssetInfo * modelAsset /* r0 */, struct zNPCAssetRATS * npcAsset /* r0 */, unsigned int npcAssetSize /* r0 */) {
    // Local variables
    char * ptr; // r30
    int amt_linkdata; // r29
...
// Range: 0x8028152C -> 0x80281674
// this: r31
void zNPCBase::BaseTimeStep(struct xVec3 * cullOrigin /* r4 */, struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
    float distanceFromPlayer2; // f0
}
...
// Range: 0x80281674 -> 0x8028170C
// this: r29
void zNPCBase::BaseRender() {
    // Local variables
    int i; // r30
}

// Range: 0x8028170C -> 0x802817A0
// this: r29
...
// Range: 0x802817A0 -> 0x8028184C
// this: r28
void zNPCBase::BaseUpdate(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
    int i; // r30
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05A20
// Range: 0x8028184C -> 0x80281A6C
// this: r31
unsigned char zNPCBase::BaseSpawn() {
    // Local variables
    int i; // r29
    int i; // r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C05A2C
// Range: 0x80281A6C -> 0x80281C20
// this: r31
unsigned char zNPCBase::BaseActivate() {
    // Local variables
    int i; // r29
    int i; // r28
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C05A3C
// Range: 0x80281CD4 -> 0x80281D6C
// this: r31
void zNPCBase::UpdateNPCBaseData() {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x80281D6C -> 0x80281DEC
// this: r27
void zNPCBase::SetChildren(class zNPCBase * firstChildren /* r0 */, int numChildren /* r28 */) {
    // Local variables
    char indexStr[32]; // r1+0x8
    int i; // r29
}

// Range: 0x80281DEC -> 0x80281DF4
// this: r0
void zNPCBase::SetParent(class zNPCBase * parent /* r0 */) {}

// Range: 0x80281DF4 -> 0x80281E14
// this: r0
void zNPCBase::Deactivate() {}

// Range: 0x80281E14 -> 0x80281EE4
// this: r31
...
// total size: 0x1
struct /* @class$1092zNPCBase_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1093zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1094zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1095zNPCBase_cpp */ {
    // Members
...
// Range: 0x80281EE4 -> 0x80281FF4
// this: r30
void zNPCBase::PreUpdateAllComponents(struct xScene * xscn /* r31 */, float dt /* f31 */) {}
...
// Range: 0x80281FF4 -> 0x80282104
// this: r30
void zNPCBase::PostUpdateAllComponents(struct xScene * xscn /* r31 */, float dt /* f31 */) {}

// Range: 0x80282104 -> 0x802821D4
// this: r31
void zNPCBase::DebugRenderAllComponents() {}

// Range: 0x802821D4 -> 0x80282398
// this: r25
unsigned char zNPCBase::ForwardEventToComponents(struct xBase * from /* r26 */, struct xBase * to /* r27 */, unsigned int to_event /* r28 */, const float * to_param /* r29 */, struct xBase * to_param_widget /* r30 */, unsigned int to_param_widget_id /* r31 */) {}

// Range: 0x80282398 -> 0x8028243C
// this: r31
void zNPCBase::DetachAllComponents() {}

// Range: 0x8028243C -> 0x8028250C
// this: r31
void zNPCBase::ResetAllComponents() {}
