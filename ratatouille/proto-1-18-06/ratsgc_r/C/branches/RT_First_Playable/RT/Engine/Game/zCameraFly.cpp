/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCameraFly.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8023B758 -> 0x8023C5C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04940
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8023B758 -> 0x8023B8DC
void zCameraFly_Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04950
// total size: 0x14
...
// Range: 0x8023B8DC -> 0x8023BA2C
void zCameraFly_Init(struct zCameraFly * fly /* r31 */, struct CameraFly_asset * asset /* r30 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x8023BA2C -> 0x8023BA3C
void zCameraFly_Setup(struct zCameraFly * fly /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C04960
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1097zCameraFly_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zCameraFly_cpp */ {
    // Members
...
union /* @class$1236zCameraFly_cpp */ {
...
// Range: 0x8023BA3C -> 0x8023BAFC
void zCameraFly_Update(struct xBase * to /* r0 */, struct xScene * sc /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04974
// total size: 0x0
struct xSerial {};
// Range: 0x8023BAFC -> 0x8023BBD0
void zCameraFly_Save(struct zCameraFly * fly /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04984
// Range: 0x8023BBD0 -> 0x8023BCA4
...
class zCamFlyThrough sFlyCam; // size: 0x160, address: 0x80BCB0E0
float skipTimeFlythrough; // size: 0x4, address: 0x80C04994
// Range: 0x8023BCA4 -> 0x8023BD78
...
// Range: 0x8023BD78 -> 0x8023C12C
// this: r30
void zCamFlyThrough::update(float dt /* f30 */) {
    // Local variables
    int i; // r0
    int flyIdx; // r31
    float flyLerp; // f31
    float flyFrame; // f28
    struct zFlyKey keys[4]; // r1+0x70
    unsigned char * data; // r3
    unsigned char tmpA; // r4
    unsigned char tmpB; // r5
    float trandiff1; // f0
    float trandiff2; // f0
    float trandiff3; // f0
    float matdiff1; // f0
    float matdiff2; // f0
    float matdiff3; // f0
    struct xMat3x3 tmpMat; // r1+0x40
    struct xQuat quats[2]; // r1+0x20
    struct xQuat qresult; // r1+0x10
...
// Range: 0x8023C12C -> 0x8023C160
float zCamFlyThrough::TranSpeed(struct zFlyKey * keys /* r4 */) {}
...
// total size: 0x890
struct /* @class$1946zCameraFly_cpp */ {
    // Static members
...
// Range: 0x8023C160 -> 0x8023C1A4
// this: r31
void zCamFlyThrough::create() {}

// Range: 0x8023C1A4 -> 0x8023C230
// this: r30
...
// Range: 0x8023C2C0 -> 0x8023C2D4
// this: r3
struct xCam * zCamFlyThrough::get_next() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C04998
// Range: 0x8023C2D4 -> 0x8023C370
// this: r27
void zCamFlyThrough::SetFlyData(void * data /* r28 */, unsigned int size /* r29 */, struct zCameraFly * fly /* r30 */, struct xCam * previous /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C049A4
// total size: 0x28
struct PKRAssetType {
    // Members
...
// total size: 0x10
struct /* @class$1484zCameraFly_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C049B0
// Range: 0x8023C4F4 -> 0x8023C5C4
void zCameraFlyEventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r31 */) {
    // Local variables
    struct zCameraFly * fly; // r0
...
// total size: 0x4C
struct {} zCamFlyThrough::__vtable; // size: 0x4C, address: 0x80440BD0
// total size: 0x0
