/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMovePoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8013E5D4 -> 0x8013EA40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zMovePoint * g_mvpt_list; // size: 0x4, address: 0x80C08280
static int g_mvpt_cnt; // size: 0x4, address: 0x80C08284
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8013E5D4 -> 0x8013E624
struct zMovePoint * zMovePoint_GetMemPool(int cnt /* r31 */, unsigned int memtag /* r6 */) {
    // References
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00CF0
// Range: 0x8013E624 -> 0x8013E6E4
void zMovePointInit(struct zMovePoint * m /* r30 */, struct xMovePointAsset * asset /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00D00
// Range: 0x8013E6E4 -> 0x8013E768
...
// total size: 0x4
struct /* @class$1137zMovePoint_cpp */ {
    // Members
...
// Range: 0x8013E768 -> 0x8013E788
void zMovePointSetup(struct zMovePoint * mvpt /* r0 */, struct zScene * scn /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00D14
// total size: 0x0
struct xSerial {};
// Range: 0x8013E788 -> 0x8013E858
void zMovePointSave(struct zMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00D24
// Range: 0x8013E858 -> 0x8013E928
void zMovePointLoad(struct zMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8013E928 -> 0x8013E948
void zMovePointReset(struct zMovePoint * ent /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C00D34
// Range: 0x8013E948 -> 0x8013EA20
void zMovePointEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r30 */) {
    // Local variables
...
// Range: 0x8013EA20 -> 0x8013EA40
struct xVec3 * zMovePointGetPos(const struct zMovePoint * m /* r0 */) {}
...
// total size: 0xC
struct /* @class$1285zMovePoint_cpp */ {
    // Members
