/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGamePlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028C268 -> 0x8028C550
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sFirstPlayerPadPort; // size: 0x4, address: 0x80C09488
// total size: 0x13B0
...
// total size: 0x4
struct /* @class$1097zMiniGamePlayer_cpp */ {
    // Members
...
union /* @class$1236zMiniGamePlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1235zMiniGamePlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zMiniGamePlayer_cpp */ {
    // Static members
...
// total size: 0x10
struct /* @class$1484zMiniGamePlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8028C2B8 -> 0x8028C3E0
// this: r30
void zMiniGamePlayer::Init(struct xEntAsset * asset /* r0 */) {
    // Local variables
    int playerCount; // r0
    int i; // r31
...
// Range: 0x8028C3E0 -> 0x8028C400
// this: r0
void zMiniGamePlayer::SceneSetup() {}

// Range: 0x8028C400 -> 0x8028C43C
// this: r31
void zMiniGamePlayer::Reset() {}

// Range: 0x8028C43C -> 0x8028C45C
// this: r0
void zMiniGamePlayer::BeginUpdate(float dt /* f0 */) {}

// Range: 0x8028C45C -> 0x8028C490
// this: r0
void zMiniGamePlayer::Update(float dt /* f0 */) {}

// Range: 0x8028C490 -> 0x8028C4B0
// this: r0
void zMiniGamePlayer::EndUpdate(float dt /* f0 */) {}

// Range: 0x8028C4B0 -> 0x8028C550
// this: r29
void zMiniGamePlayer::SceneExit(struct zScene * scene /* r30 */) {
    // Local variables
    int port; // r31
...
// total size: 0x12C
struct {} zMiniGamePlayer::__vtable; // size: 0x12C, address: 0x80444A30
