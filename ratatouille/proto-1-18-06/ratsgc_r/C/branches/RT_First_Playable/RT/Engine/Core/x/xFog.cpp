/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xFog.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8005B2B4 -> 0x8005B824
*/
// Range: 0x8005B2B4 -> 0x8005B2DC
void xFogClearFog() {}

// Range: 0x8005B2DC -> 0x8005B2FC
...
// Range: 0x8005B2FC -> 0x8005B368
void xFogInit(struct xBase * b /* r30 */, struct xFogAsset * tasset /* r31 */) {
    // Local variables
    struct _xFog * t; // r0
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFCAA0
// Range: 0x8005B368 -> 0x8005B434
void xFogReset(struct _xFog * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFCAAC
// total size: 0x0
struct xSerial {};
// Range: 0x8005B434 -> 0x8005B504
void xFogSave(struct _xFog * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFCAB8
// Range: 0x8005B504 -> 0x8005B5D4
void xFogLoad(struct _xFog * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFCAC4
enum RwFogType {
...
// Range: 0x8005B5D4 -> 0x8005B764
void xFogEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r30 */) {
    // Local variables
    struct _xFog * t; // r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFCAD0
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8005B764 -> 0x8005B824
void xFogUpdate(struct xBase * to /* r0 */, struct xScene * sc /* r31 */) {
    // References
