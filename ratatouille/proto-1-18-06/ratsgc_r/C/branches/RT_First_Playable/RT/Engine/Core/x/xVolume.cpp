/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xVolume.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800D4010 -> 0x800D41F0
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
class xVolume : public xBase {
    // Functions
    void Init(struct xVolumeAsset * asset);
    ...
    struct xBound * GetBound();

    // Members
public:
    struct xVolumeAsset * asset; // offset 0x10, size 0x4
};
// Range: 0x800D4010 -> 0x800D4070
// this: r30
void xVolume::Init(struct xVolumeAsset * asset /* r31 */) {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFEDD8
// Range: 0x800D4070 -> 0x800D40F4
// this: r31
void xVolume::Reset() {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFEDE0
// Range: 0x800D40F4 -> 0x800D416C
// this: r0
void xVolume::Save(struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFEDE8
// total size: 0x0
struct xSerial {};
// Range: 0x800D416C -> 0x800D41E4
// this: r0
void xVolume::Load(struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x800D41E4 -> 0x800D41F0
// this: r0
struct xBound * xVolume::GetBound() {}
