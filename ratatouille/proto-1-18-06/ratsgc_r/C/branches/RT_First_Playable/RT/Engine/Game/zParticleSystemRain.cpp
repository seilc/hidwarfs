/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleSystemRain.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020E45C -> 0x8020F024
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float FADE_TIME; // size: 0x4, address: 0x80C03FD0
static float MAX_RENDER_DISTANCE; // size: 0x4, address: 0x80C03FD4
// total size: 0x8
...
// Range: 0x8020E45C -> 0x8020E4D0
// this: r29
struct zParticleGenerator * zParticleSystemRain::create_generator(struct zParticleAsset & asset /* r30 */) {}

// Range: 0x8020E50C -> 0x8020E530
// this: r3
void zParticleSystemRain::scene_enter() {}

// Range: 0x8020E530 -> 0x8020E550
// this: r0
void zParticleSystemRain::update(float dt /* f0 */) {}
...
// Range: 0x8020E550 -> 0x8020E558
int zParticleSystemRain::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03FD8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1036zParticleSystemRain_cpp */ {
    // Members
...
// Range: 0x8020E558 -> 0x8020E8C0
int zParticleSystemRain::update_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f24 */, void * context /* r25 */) {
    // Local variables
    ...
    struct particle_instance * end; // r26
    struct zParticleGeneratorRain & g; // r0
    struct asset_data & a; // r0
    float gravity; // f30
    float height; // f0
    float fadeDist; // f28
    float dropLength; // f27
    float dropWidth; // f26
    const struct xMat4x3 & camMat; // r25
    const struct xVec3 & camPos; // r23
    float distTraveled; // f25
    struct RwSphere worldsph; // r1+0x8
    struct xVec3 & _up_; // r22
    struct xVec3 & _at_; // r21
    float alpha; // f24
...
void zParticleGeneratorRain::update(float dt /* f30 */) {
    ...
    struct particle_instance * endp; // r28
}
...
// Range: 0x8020EA98 -> 0x8020EB94
// this: r30
void zParticleGeneratorRain::create(class zParticleSystemRain & system /* r31 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x8020EB94 -> 0x8020EC28
// this: r31
void zParticleGeneratorRain::reset() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C03FEC
// Range: 0x8020EC28 -> 0x8020ECD4
// this: r31
...
// Range: 0x8020ECD4 -> 0x8020ED20
// this: r31
void zParticleGeneratorRain::deactivate() {}

// Range: 0x8020ED20 -> 0x8020ED68
// this: r31
void zParticleGeneratorRain::resume() {}

// Range: 0x8020ED68 -> 0x8020ED9C
// this: r31
...
// Range: 0x8020EFCC -> 0x8020F024
// this: r30
void zParticleGeneratorRain::debug_render(unsigned char all /* r31 */) {}

// total size: 0x2C
struct {} zParticleGeneratorRain::__vtable; // size: 0x2C, address: 0x8043F220
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1760zParticleSystemRain_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$972zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$973zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$975zParticleSystemRain_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$976zParticleSystemRain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$977zParticleSystemRain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$978zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1358zParticleSystemRain_cpp */ {
    // Members
...
union /* @class$1023zParticleSystemRain_cpp */ {
...
// total size: 0xC
struct /* @class$1496zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemRain::__vtable; // size: 0x3C, address: 0x8043F24C
// total size: 0x8
