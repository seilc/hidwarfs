/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFrostEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020BB48 -> 0x8020BD1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float MAX_DECAL_CAST_DIST; // size: 0x4, address: 0x80C03F28
static float MAX_DECAL_CAST_DIST_HALF; // size: 0x4, address: 0x80C08E50
static float FROST_DECAL_LIFETIME; // size: 0x4, address: 0x80C03F2C
static float FROST_EFFECT_EMIT_RATE; // size: 0x4, address: 0x80C03F30
static float DECAL_MAX_SIZE; // size: 0x4, address: 0x80C03F34
static float DECAL_MIN_SIZE; // size: 0x4, address: 0x80C03F38
static float sEmitTimer; // size: 0x4, address: 0x80C03F3C
// total size: 0x4
struct node {
    // Members
...
// total size: 0xC
struct /* @class$1026zFrostEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zFrostEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zFrostEffect_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zFrostEffect_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zFrostEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zFrostEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zFrostEffect_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1085zFrostEffect_cpp */ {
    // Members
...
union /* @class$820zFrostEffect_cpp */ {
...
// total size: 0xC
struct /* @class$1249zFrostEffect_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
class zFrostEffect {
    // Functions
    void _ApplyFrost(struct xRay3 & ray, float emitRate, float emitDistance);

    // Members
    struct xResponseCurve mDecalResponseCurve; // offset 0x0, size 0x14
    struct emit_context mDecalEmitContext; // offset 0x14, size 0x5C
    struct RwTexture * mFrostTexture; // offset 0x70, size 0x4
};
static class zFrostEffect sFrostEmitter; // size: 0x74, address: 0x80BC3D20
// Range: 0x8020BB48 -> 0x8020BB74
void zFrostEffect::ApplyFrost(struct xRay3 & ray /* r4 */, float emitRate /* f0 */, float emitDistance /* f0 */) {
    // References
    // -> static class zFrostEffect sFrostEmitter;
}
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03F40
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x8020BB74 -> 0x8020BD08
// this: r30
void zFrostEffect::_ApplyFrost(struct xRay3 & ray /* r31 */, float emitRate /* f1 */, float emitDistance /* f31 */) {
    // Local variables
    float decalSize; // f2
    struct xMat4x3 mat; // r1+0x90
    struct xVec3 vec; // r1+0x10
    struct xMat3x3 rotZ; // r1+0x60
    struct xMat4x3 rotMat; // r1+0x20

    // References
    // -> static float FROST_DECAL_LIFETIME;
    // -> static float DECAL_MAX_SIZE;
    // -> static float DECAL_MIN_SIZE;
    // -> static char __FUNCTION__[12];
    // -> static float MAX_DECAL_CAST_DIST;
    // -> static float sEmitTimer;
    // -> static float FROST_EFFECT_EMIT_RATE;
}

// total size: 0x18
struct config {
    // Members
    float areaPerIcicle; // offset 0x0, size 0x4
    float lifetime; // offset 0x4, size 0x4
    float maxScale; // offset 0x8, size 0x4
    float minScale; // offset 0xC, size 0x4
    float growTime; // offset 0x10, size 0x4
    float shrinkTime; // offset 0x14, size 0x4
};
// total size: 0x1
class zFrostIcicle {};
// total size: 0x1C
struct icicle {
    ...
    const struct xMat4x3 * driver; // offset 0x4, size 0x4
    const struct xEnt * driver_ent; // offset 0x8, size 0x4
    void * initModelData; // offset 0xC, size 0x4
    float lifetime; // offset 0x10, size 0x4
    float scale; // offset 0x14, size 0x4
    const struct config * iceConfig; // offset 0x18, size 0x4
};
