/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xHudModel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8007302C -> 0x80073490
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1085xHudModel_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFD088
// total size: 0x98
class model_widget : public widget {
    // Functions
    model_widget(const struct model_asset & a);
    ...
    void set_params(struct xModelInstance * & model, struct render_context & rc, float xs, float ys, float lx, float ly);
...
public:
    ...
    struct xModelInstance * model; // offset 0x8C, size 0x4
    float x_scale; // offset 0x90, size 0x4
    float y_scale; // offset 0x94, size 0x4
};
// Range: 0x8007302C -> 0x800731CC
void model_widget::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFD090
// total size: 0x34
struct {} xhud::model_widget::__vtable; // size: 0x34, address: 0x80418668
// Range: 0x800731CC -> 0x80073298
// this: r30
model_widget::model_widget(const struct model_asset & a /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] xhud::model_widget::__vtable;
}

// total size: 0x8
struct /* @class$1310xHudModel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1026xHudModel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027xHudModel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028xHudModel_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029xHudModel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030xHudModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031xHudModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032xHudModel_cpp */ {
    // Members
...
// Range: 0x80073298 -> 0x800732B8
// this: r0
void model_widget::destruct() {}

// Range: 0x800732B8 -> 0x800732D8
// this: r0
void model_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80C073F0
static signed char init; // size: 0x1, address: 0x80C073F4
// Range: 0x800732D8 -> 0x80073318
unsigned int model_widget::type() {
    // References
    // -> static unsigned int myid;
    // -> static signed char init;
}

// Range: 0x80073318 -> 0x80073380
// this: r29
unsigned char model_widget::is(unsigned int id /* r30 */) const {}

// Range: 0x80073380 -> 0x800733FC
// this: r31
void model_widget::update(float dt /* f31 */) {}

// Range: 0x800733FC -> 0x80073420
// this: r0
void model_widget::set_params(struct xModelInstance * & model /* r0 */, struct render_context & rc /* r0 */, float xs /* f0 */, float ys /* f0 */, float lx /* f0 */, float ly /* f0 */) {}

// Range: 0x80073420 -> 0x80073490
// this: r3
