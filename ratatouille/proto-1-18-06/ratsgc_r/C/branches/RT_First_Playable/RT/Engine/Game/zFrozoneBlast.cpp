/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFrozoneBlast.cpp
...
// total size: 0x4
struct /* @class$1350zFrozoneBlast_cpp */ {
    // Members
...
struct blastStream {
    // Members
    struct xRay3 direction; // offset 0x0, size 0x24
    float emitTimer; // offset 0x24, size 0x4
    float initSize; // offset 0x28, size 0x4
    int upgradeLevel; // offset 0x2C, size 0x4
    unsigned char active; // offset 0x30, size 0x1
    unsigned char colliding; // offset 0x31, size 0x1
    float velMultiplier; // offset 0x34, size 0x4
    unsigned char singleBlast; // offset 0x38, size 0x1
    float singleTimer; // offset 0x3C, size 0x4
    float velocity; // offset 0x40, size 0x4
    struct xLight * light; // offset 0x44, size 0x4
    float lightIntensity; // offset 0x48, size 0x4
    float lightTimer; // offset 0x4C, size 0x4
};
// total size: 0x104
class zFrozoneBlast {
    // Members
    int mSystemID; // offset 0x0, size 0x4
    struct blastStream mStreams[3]; // offset 0x4, size 0xF0
    int mMistSystemID; // offset 0xF4, size 0x4
    float mMistEmitTimer; // offset 0xF8, size 0x4
    int mGlintSystemID; // offset 0xFC, size 0x4
    float mGlintSplashTimer; // offset 0x100, size 0x4
};
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$964zFrozoneBlast_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zFrozoneBlast_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zFrozoneBlast_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zFrozoneBlast_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zFrozoneBlast_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zFrozoneBlast_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zFrozoneBlast_cpp */ {
    // Members
...
struct _blastConfig {
    // Members
    unsigned int alpha; // offset 0x0, size 0x4
    float emit_rate; // offset 0x4, size 0x4
    float growthRate; // offset 0x8, size 0x4
    float randomEmitDir; // offset 0xC, size 0x4
    float randomEmitLoc; // offset 0x10, size 0x4
    float size; // offset 0x14, size 0x4
    float velocity; // offset 0x18, size 0x4
    float velocityRange; // offset 0x1C, size 0x4
    float blueTint; // offset 0x20, size 0x4
    float blueTintDist; // offset 0x24, size 0x4
};
// total size: 0x28
...
struct blastParticle {
    ...
    unsigned char flags; // offset 0x1C, size 0x1
    unsigned char r; // offset 0x1D, size 0x1
    unsigned char g; // offset 0x1E, size 0x1
    unsigned char b; // offset 0x1F, size 0x1
    float scaleX; // offset 0x20, size 0x4
    float scaleY; // offset 0x24, size 0x4
    float growthRateX; // offset 0x28, size 0x4
    float growthRateY; // offset 0x2C, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0xC
struct /* @class$1488zFrozoneBlast_cpp */ {
    // Members
...
union /* @class$1015zFrozoneBlast_cpp */ {
...
// total size: 0x10
struct /* @class$1028zFrozoneBlast_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
