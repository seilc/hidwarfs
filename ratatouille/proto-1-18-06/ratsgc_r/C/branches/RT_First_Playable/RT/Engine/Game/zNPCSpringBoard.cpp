/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCSpringBoard.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A743C -> 0x802A75AC
*/
// total size: 0x1
...
static class zICompNPCEntityParams gSpringBoardEntParameters; // size: 0x30, address: 0x80BD23E8
char __FUNCTION__$localstatic1$AttachComponent__63zComponentPool<21zCompLogicSpringBoard,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06278
signed char zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09620
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C09624
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x802A74F0 -> 0x802A756C
// this: r30
void zNPCSpringBoard::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1148zNPCSpringBoard_cpp */ {
    // Members
...
union /* @class$1288zNPCSpringBoard_cpp */ {
...
// total size: 0xC
struct /* @class$1286zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1089zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1090zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1091zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1092zNPCSpringBoard_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1093zNPCSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1094zNPCSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1095zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCSpringBoard::__vtable; // size: 0x30, address: 0x80447D20
// total size: 0xC
struct RwV3d {
    // Members
