/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xEnv.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800597E0 -> 0x80059E08
*/
// total size: 0x8
struct RwObject {
    // Members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFC970
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x800597E0 -> 0x80059988
void xEnvLoadJSPList(struct xEnv * env /* r30 */, int dataType /* r31 */) {
    // Local variables
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFC980
// Range: 0x80059988 -> 0x80059A20
void xEnvSetup(struct xEnv * env /* r31 */) {
    // References
    // -> struct xEnv * gCurXEnv;
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC98C
// Range: 0x80059A20 -> 0x80059B04
void xEnvFree(struct xEnv * env /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static unsigned char done; // size: 0x1, address: 0x80C07275
static signed char init; // size: 0x1, address: 0x80C07276
static unsigned char done; // size: 0x1, address: 0x80C07277
static signed char init; // size: 0x1, address: 0x80C07278
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC998
// Range: 0x80059B04 -> 0x80059D4C
void xEnvRender(struct xEnv * env /* r29 */, unsigned char alpha /* r30 */) {
    // Local variables
    int i; // r30
    char text[128]; // r1+0x8
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804161D8
// Range: 0x80059D4C -> 0x80059E08
void xEnvResetJSPVisibilities(struct xEnv * env /* r31 */) {
    // Local variables
    int i; // r6
