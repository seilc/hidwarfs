/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xGroup.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8006DA58 -> 0x8006E6A0
*/
// Range: 0x8006DA58 -> 0x8006DA78
void xGroupInit(void * b /* r0 */, void * asset /* r0 */) {}
...
// Range: 0x8006DA78 -> 0x8006DB30
void xGroupInit(struct xBase * b /* r3 */, struct xGroupAsset * asset /* r30 */) {
    // Local variables
    struct xGroup * t; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFCF00
// Range: 0x8006DB30 -> 0x8006DCAC
void xGroupSetup(struct xGroup * g /* r31 */) {
    // Local variables
    unsigned int count; // r0
    unsigned int i; // r28
    unsigned int itemID; // r27

    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFCF0C
// total size: 0x0
struct xSerial {};
// Range: 0x8006DCAC -> 0x8006DD7C
void xGroupSave(struct xGroup * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFCF18
// Range: 0x8006DD7C -> 0x8006DE4C
void xGroupLoad(struct xGroup * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFCF24
// Range: 0x8006DE4C -> 0x8006DF18
void xGroupReset(struct xGroup * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFCF30
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8006DF18 -> 0x8006E238
void xGroupEventCB(struct xBase * from /* r24 */, struct xBase * to /* r4 */, unsigned int toEvent /* r25 */, const float * toParam /* r26 */, struct xBase * toParamWidget /* r27 */, unsigned int toParamWidgetID /* r28 */) {
    // Local variables
    struct xGroup * g; // r31
    int rand; // r30
    unsigned int * idx; // r0
    void (* entVisEventHandler)(struct xEnt *); // r29
    int i; // r23
    struct xBase * b; // r22
    int i; // r22
    struct xBase * b; // r3
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFCF40
// Range: 0x8006E238 -> 0x8006E300
unsigned int xGroupGetCount(struct xGroup * g /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFCF50
// Range: 0x8006E300 -> 0x8006E3C4
struct xBase * xGroupGetItemPtr(struct xGroup * g /* r30 */, unsigned int index /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFCF64
// Range: 0x8006E3C4 -> 0x8006E4F4
unsigned int xGroupGetItem(struct xGroup * g /* r30 */, unsigned int index /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFCF74
// Range: 0x8006E4F4 -> 0x8006E600
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFCF84
// Range: 0x8006E600 -> 0x8006E6A0
