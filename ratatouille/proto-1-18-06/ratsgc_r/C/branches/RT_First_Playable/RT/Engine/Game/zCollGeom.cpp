/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCollGeom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800F8158 -> 0x800F862C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zCollisionGeomTableEntry sCollisionGeomTable[20]; // size: 0xA0, address: 0x80B8EA20
static unsigned int sCollisionGeomTableCount; // size: 0x4, address: 0x80C07BA8
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFF838
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1085zCollGeom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zCollGeom_cpp */ {
    // Members
...
// Range: 0x800F8158 -> 0x800F83A0
unsigned int zCollGeom_EntSetup(struct xEnt * ent /* r26 */) {
    // Local variables
    unsigned int i; // r29
    unsigned int j; // r28
    unsigned char auto_cam_coll; // r27
    struct RpAtomic * imodel; // r25
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF84C
// Range: 0x800F83A0 -> 0x800F8608
void zCollGeom_Init() {
    // Local variables
    ...
    unsigned int k; // r26
    void * data; // r0
    unsigned int hash; // r25
    unsigned int aid; // r25
...
// Range: 0x800F8608 -> 0x800F8620
void zCollGeom_CamEnable(struct xEnt * ent /* r0 */) {}

// Range: 0x800F8620 -> 0x800F862C
void zCollGeom_CamDisable(struct xEnt * ent /* r0 */) {}
