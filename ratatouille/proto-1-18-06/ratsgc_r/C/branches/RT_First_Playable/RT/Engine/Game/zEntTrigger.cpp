/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEntTrigger.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80113074 -> 0x8011665C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gDrawAllTriggers; // size: 0x1, address: 0x80C07CC0
unsigned char gDrawNoEnterVolumes; // size: 0x1, address: 0x80C07CC1
unsigned char gDrawJumpVolumes; // size: 0x1, address: 0x80C07CC2
unsigned char gDrawHeightVolumes; // size: 0x1, address: 0x80C07CC3
unsigned char gDrawSlowCollisionVolumes; // size: 0x1, address: 0x80C07CC4
unsigned char gDrawAllTheRest; // size: 0x1, address: 0x80C07CC5
unsigned char gDrawNPCDeathVolumes; // size: 0x1, address: 0x80C07CC6
// Range: 0x80113074 -> 0x80113278
...
// total size: 0xC
struct /* @class$1038zEntTrigger_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zEntTrigger_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zEntTrigger_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zEntTrigger_cpp */ {
    // Members
...
// Range: 0x801132A4 -> 0x801132C4
void zEntTriggerInit(void * ent /* r0 */, void * asset /* r0 */) {}
...
// Range: 0x801132C4 -> 0x8011362C
void zEntTriggerInit(struct zEntTrigger * ent /* r30 */, struct xEntAsset * asset /* r29 */) {
    // Local variables
    const struct xTriggerAsset * tasset; // r31
...
// total size: 0x4
struct /* @class$1097zEntTrigger_cpp */ {
    // Members
...
union /* @class$1236zEntTrigger_cpp */ {
...
// total size: 0xC
struct /* @class$1235zEntTrigger_cpp */ {
    // Members
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C00268
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x8011362C -> 0x80113894
void zEntTriggerUpdate(struct zEntTrigger * trig /* r28 */, struct xScene * sc /* r25 */, float dt /* f31 */) {
    // Local variables
    struct xTriggerAsset * tasset; // r0
    unsigned int i; // r30
    const struct xLinkAsset * link; // r29
    unsigned char collide; // r26
    struct xEnt * chkEnt; // r27
    struct xBase * chkBase; // r25
    class zNPCBase * npcBase; // r0
    struct xVec3 * chkPos; // r4
...
// Range: 0x80113894 -> 0x80113A28
// this: r31
unsigned char zEntTrigger::PointIntersects(const struct xVec3 & chkPos /* r30 */) const {
    // Local variables
    struct xVec3 xformVec; // r1+0x28
    struct xIsect isect; // r1+0xCC
    struct xSphere sphere; // r1+0x18
    struct xIsect isect; // r1+0xA0
    struct xTriggerAsset * tasset; // r31
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0027C
// Range: 0x80113A28 -> 0x80113B78
void zEntTriggerEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00290
// total size: 0x0
...
// Range: 0x80113B78 -> 0x80113C50
void zEntTriggerSave(struct zEntTrigger * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C002A0
// Range: 0x80113C50 -> 0x80113D28
void zEntTriggerLoad(struct zEntTrigger * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C002B0
// Range: 0x80113D28 -> 0x80113E84
void zEntTriggerReset(struct zEntTrigger * ent /* r30 */) {
    // Local variables
    struct xTriggerAsset * tasset; // r31
...
// Range: 0x80113E84 -> 0x80113FB0
unsigned char zEntTriggerHitsSphere(const struct zEntTrigger & trig /* r28 */, const struct xSphere & o /* r29 */, const struct xVec3 & dir /* r30 */) {
    // Local variables
    const struct xTriggerAsset & asset; // r31
}

static int sDebugTriggerIdx; // size: 0x4, address: 0x80C002C4
static int g_dblog_showusage; // size: 0x4, address: 0x80C07CC8
static int g_dblog_listtrig; // size: 0x4, address: 0x80C07CCC
static int g_dblog_solidtrig; // size: 0x4, address: 0x80C07CD0
// Range: 0x80113FB0 -> 0x801140E4
static void zEntTriggerDMUsage() {
    // References
    // -> static int g_dblog_showusage;
}

// Range: 0x801140E4 -> 0x80114254
...
// Range: 0x80114254 -> 0x80114470
static void zEntTriggerDMMessage() {
    // Local variables
    int i; // r29
    struct zEnt * trig; // r26
...
// Range: 0x80114470 -> 0x80114610
void zEntTriggerDMDrawthem() {
    // Local variables
    int i; // r28
    struct zEnt * trig; // r29
...
// Range: 0x80114610 -> 0x8011464C
void zEntTriggerDebugModeCB() {
    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C002C8
...
// Range: 0x8011464C -> 0x80114F34
void zEntTriggerDebugDraw(struct xBase * btrig /* r22 */) {
    // Local variables
    struct zEntTrigger * trig; // r31
    struct xTriggerAsset * tasset; // r23
    struct xVec3 v[8]; // r1+0xF4
    int i; // r24
    int cullmode; // r23
    struct xColor_tag color; // r1+0x60
    struct xVec3 dir; // r1+0x70
    struct xVec3 dir; // r1+0x64
    struct xVec3 v[8]; // r1+0x94
    int i; // r24
    int cullmode; // r22
    struct xColor_tag tmpC; // r1+0x5C
    struct xBox box; // r1+0x7C
...
// Range: 0x80114F34 -> 0x801153F4
unsigned char xRayHitsTrigger(const struct xVec3 & start /* r29 */, const struct xVec3 & end /* r30 */, const struct xBox & b /* r31 */, unsigned char & end_inside /* r0 */) {
    // Local variables
    float hit_x; // r1+0x10
    float hit_y; // r1+0xC
    float hit_z; // r1+0x8
...
// Range: 0x801153F4 -> 0x80115458
unsigned char xRayHitsPlaneZ(const struct xVec3 & start /* r0 */, const struct xVec3 & end /* r0 */, float plane /* f0 */, float & x /* r0 */, float & y /* r0 */) {
    // Local variables
    float z_total; // f4
    float percent; // f4
}

// Range: 0x80115458 -> 0x801154BC
unsigned char xRayHitsPlaneY(const struct xVec3 & start /* r0 */, const struct xVec3 & end /* r0 */, float plane /* f0 */, float & x /* r0 */, float & z /* r0 */) {
    // Local variables
    float y_total; // f4
    float percent; // f4
}

// Range: 0x801154BC -> 0x80115520
unsigned char xRayHitsPlaneX(const struct xVec3 & start /* r0 */, const struct xVec3 & end /* r0 */, float plane /* f0 */, float & y /* r0 */, float & z /* r0 */) {
    // Local variables
    float x_total; // f4
    float percent; // f4
}

// Range: 0x80115520 -> 0x80115664
unsigned char xRayHitsTrigger(const struct xVec3 & start /* r28 */, const struct xVec3 & end /* r0 */, const struct xVec3 & dir /* r29 */, const struct xSphere & s /* r30 */, unsigned char & end_inside /* r31 */) {
    // Local variables
    float radius_squ; // f31
    struct xVec3 end_to_sphere; // r1+0x20
    struct xVec3 start_to_sphere; // r1+0x14
    struct xVec3 out_vec; // r1+0x8
}
...
class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD4, address: 0x80B8FB98
// total size: 0x1
class zSpecialTriggersTree {
    // Static members
    static class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD4
};
// Range: 0x80115664 -> 0x80115734
void zSpecialTriggersTree::UpdateMinMax(struct zEntTrigger * trigger /* r6 */, float & min /* r30 */, float & max /* r31 */) {
    // Local variables
    struct xBox box; // r1+0x14
    struct xVec3 span; // r1+0x8
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C002E0
// Range: 0x80115734 -> 0x80115954
void zSpecialTriggersTree::SceneEnter() {
    // Local variables
    struct xBox worldBox; // r1+0x28
    int i; // r28
    struct zEntTrigger * trigger; // r27
    struct xBox box; // r1+0x10
    const struct xBox * jspbox; // r27
...
static unsigned char done; // size: 0x1, address: 0x80C07CD4
static signed char init; // size: 0x1, address: 0x80C07CD5
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C002EC
// total size: 0xC
struct /* @class$1449zEntTrigger_cpp */ {
    // Members
...
// Range: 0x80115954 -> 0x80115C5C
int zSpecialTriggersTree::IntersectingSphere(const struct xVec3 & pos /* r22 */, float radius /* f31 */, unsigned short triggerFilter /* r17 */, unsigned short entFilter /* r15 */, int maxTriggers /* r16 */, struct zEntTrigger * * triggerList /* r23 */) {
    // Local variables
    int i; // r26
    union entry_data * nearByTriggers[48]; // r1+0x84
    int numNearByTriggers; // r3
    int numFoundTriggers; // r25
    struct zEntTrigger * trigger; // r24
    struct xTriggerAsset triggerAsset; // r1+0x44
    unsigned short triggerFlags; // r15
    unsigned short entFlags; // r0
...
// Range: 0x80115C5C -> 0x80115C90
struct zEntTrigger * zSpecialTriggersTree::IntersectingSphere(const struct xVec3 & pos /* r0 */, float radius /* f0 */, unsigned short triggerFilter /* r0 */, unsigned short entFilter /* r0 */) {
    // Local variables
    struct zEntTrigger * triggers[1]; // r1+0x8
}

static unsigned char done; // size: 0x1, address: 0x80C07CD6
static signed char init; // size: 0x1, address: 0x80C07CD7
static unsigned char done; // size: 0x1, address: 0x80C07CD8
static signed char init; // size: 0x1, address: 0x80C07CD9
static unsigned char done; // size: 0x1, address: 0x80C07CDA
static signed char init; // size: 0x1, address: 0x80C07CDB
static char __FUNCTION__[26]; // size: 0x1A, address: 0x804389C8
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x80115C90 -> 0x8011634C
unsigned char zSpecialTriggersTree::xEntIntersectsJumpTrigger(const struct xEnt & ent /* r24 */, const struct zEntTrigger & trigger /* r25 */, struct xVec3 & desiredMoveUnitDirection /* r26 */, struct xVec3 & landingPos /* r27 */, const struct xEnt * humanPlayer /* r28 */, struct xVec3 * jumpDirection /* r29 */) {
    // Local variables
    ...
    int i; // r22
    int closeFace; // r30
    float jumpDistance; // f31
    unsigned char closeFaceFound; // r4
    float distanceToCheck; // f30
    struct xVec3 entPos; // r1+0x8
    struct xRay3 ray; // r1+0x24
    float facingDotProduct; // f0
...
// Range: 0x8011634C -> 0x80116554
void zSpecialTriggersTree::CheckAgainstEnt(const struct zEntTrigger & trigger /* r28 */, const struct xEnt & humanPlayer /* r27 */, int closeFace /* r29 */, struct xVec3 & landingPos /* r30 */, struct xVec3 * jumpDirection /* r31 */) {
    // Local variables
    struct xVec3 oldLandingPos; // r1+0x14
    struct xVec3 collideEntPos; // r1+0x8
    int newCloseFace; // r27
    float dist; // f0
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00300
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x80116554 -> 0x8011665C
void zSpecialTriggersTree::GetTolerance(struct zEntTrigger * trigger /* r29 */, float & toleranceLow /* r30 */, float & toleranceHigh /* r31 */) {
    // Local variables
