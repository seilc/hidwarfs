/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8023F114 -> 0x8024363C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sCamPlayerTweakMountMinOffset; // size: 0x4, address: 0x80C09128
static float pivot_height; // size: 0x4, address: 0x80C04A88
static float rest_dist_accel; // size: 0x4, address: 0x80C04A8C
static float rest_dist_max_vel; // size: 0x4, address: 0x80C04A90
static float rest_phi_accel; // size: 0x4, address: 0x80C04A94
static float rest_phi_max_vel; // size: 0x4, address: 0x80C04A98
static float pitch_offset; // size: 0x4, address: 0x80C0912C
static float look_offset_min; // size: 0x4, address: 0x80C04A9C
static float look_offset_max; // size: 0x4, address: 0x80C04AA0
static float pitch_clamp_min; // size: 0x4, address: 0x80C04AA4
static float pitch_clamp_max; // size: 0x4, address: 0x80C04AA8
static float escape_dist; // size: 0x4, address: 0x80C09130
static float escape_accel; // size: 0x4, address: 0x80C04AAC
static float escape_max_vel; // size: 0x4, address: 0x80C04AB0
static float defaultFOV; // size: 0x4, address: 0x80C04AB4
static float max_vel_y; // size: 0x4, address: 0x80C04AB8
static float max_vel_xz; // size: 0x4, address: 0x80C04ABC
static float min_offset; // size: 0x4, address: 0x80C04AC0
static float max_offset; // size: 0x4, address: 0x80C09134
static float phi; // size: 0x4, address: 0x80C04AC4
static float pitch_offset; // size: 0x4, address: 0x80C04AC8
static float dist; // size: 0x4, address: 0x80C04ACC
static float phi; // size: 0x4, address: 0x80C04AD0
static float pitch_offset; // size: 0x4, address: 0x80C04AD4
static float dist; // size: 0x4, address: 0x80C04AD8
static float phi; // size: 0x4, address: 0x80C04ADC
static float pitch_offset; // size: 0x4, address: 0x80C09138
static float dist; // size: 0x4, address: 0x80C04AE0
static float x_accel; // size: 0x4, address: 0x80C04AE4
static float x_vel; // size: 0x4, address: 0x80C04AE8
static float dist_start; // size: 0x4, address: 0x80C04AEC
static float dist_stop; // size: 0x4, address: 0x80C04AF0
static float delay_start; // size: 0x4, address: 0x80C0913C
static float theta_vel; // size: 0x4, address: 0x80C04AF4
static float rest_phi; // size: 0x4, address: 0x80C04AF8
static float rest_dist; // size: 0x4, address: 0x80C04AFC
static float look_xz; // size: 0x4, address: 0x80C04B00
static float input_theta; // size: 0x4, address: 0x80C04B04
static float input_phi; // size: 0x4, address: 0x80C04B08
static float input_pitch_offset; // size: 0x4, address: 0x80C04B0C
static float collide_dist; // size: 0x4, address: 0x80C04B10
static float target_y; // size: 0x4, address: 0x80C04B14
static float target_xz; // size: 0x4, address: 0x80C04B18
static float pitch; // size: 0x4, address: 0x80C04B1C
static float pitch_rest; // size: 0x4, address: 0x80C04B20
static float pitch_clamp; // size: 0x4, address: 0x80C04B24
static float mount; // size: 0x4, address: 0x80C04B28
static float lazy_yaw_offset; // size: 0x4, address: 0x80C04B2C
static float lazy_pitch_offset; // size: 0x4, address: 0x80C04B30
static unsigned char track_in_y; // size: 0x1, address: 0x80C09140
static unsigned char strafe; // size: 0x1, address: 0x80C09141
static unsigned char render_secondary; // size: 0x1, address: 0x80C09142
static unsigned char disable_secondary; // size: 0x1, address: 0x80C09143
static unsigned char force; // size: 0x1, address: 0x80C09144
static unsigned int entity; // size: 0x4, address: 0x80C09148
static float radius; // size: 0x4, address: 0x80C04B34
static float margin_angle; // size: 0x4, address: 0x80C0914C
// total size: 0x8
struct substr {
    // Members
...
// total size: 0x1
struct /* @class$967zCamPlayer_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$970zCamPlayer_cpp */ {
    // Members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04B38
// Range: 0x8023FAF0 -> 0x8023FC7C
static void bound_sphere_xz(float & Ax /* r28 */, float & Az /* r29 */, float & Bx /* r30 */, float & Bz /* r31 */, float Cx /* f25 */, float Cz /* f26 */, float r /* f27 */, float Vx /* f28 */, float Vz /* f29 */, float d /* f30 */) {
    // Local variables
    float rd; // f31
    float w1; // f0
    float w2; // f2
...
// Range: 0x8023FC7C -> 0x8023FD1C
static void sphere_to_screen(struct xVec3 & out_center /* r30 */, float & out_radius /* r31 */, const struct xVec3 & in_center /* r0 */, float in_radius /* f30 */) {
    // Local variables
...
struct config cfg; // size: 0x18, address: 0x80C06E80
// total size: 0x30
...
// total size: 0x14
struct /* @class$1157zCamPlayer_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$1158zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1159zCamPlayer_cpp */ {
    // Members
...
// total size: 0x6C
struct /* @class$1160zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1161zCamPlayer_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1162zCamPlayer_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1164zCamPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2169zCamPlayer_cpp */ {
    // Members
    float move_to; // offset 0x0, size 0x4
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C04B48
// Range: 0x8023FDE4 -> 0x8023FE98
// this: r31
...
// Range: 0x8023FE98 -> 0x8023FFDC
// this: r31
void zCamPlayer::update(float dt /* f31 */) {}

// Range: 0x80240064 -> 0x8024006C
float zCamPlayer::get_rest_dist_default() {
    // References
    // -> static float dist;
}

// Range: 0x8024006C -> 0x8024008C
void zCamPlayer::get_rest_default(struct rest_config & cfg /* r0 */) {
    // References
    // -> static float phi;
    // -> static float dist;
}

// Range: 0x8024008C -> 0x80240158
// this: r0
void zCamPlayer::set_rest(const struct rest_config & cfg /* r0 */, unsigned char lazy /* r0 */, float blend_time /* f0 */) {}

// Range: 0x80240158 -> 0x802401CC
// this: r0
void zCamPlayer::set_rest_dist(float dist /* f0 */, unsigned char lazy /* r0 */, float blend_time /* f0 */) {}

// Range: 0x802401CC -> 0x802401D4
// this: r0
void zCamPlayer::set_speed_input_theta(float new_speed /* f0 */) {}

// Range: 0x802401D4 -> 0x802401DC
float zCamPlayer::get_speed_input_theta_default() {
    // References
    // -> static float input_theta;
}

// Range: 0x802401DC -> 0x802401E8
// this: r0
void zCamPlayer::set_pitch_offset(float pitch_offset /* f0 */, float blend_speed /* f0 */) {}
...
// total size: 0x4
struct /* @class$1282zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1420zCamPlayer_cpp */ {
    // Members
...
union /* @class$1015zCamPlayer_cpp */ {
...
// total size: 0x10
struct /* @class$1028zCamPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802401E8 -> 0x8024024C
// this: r31
void zCamPlayer::set_secondary_target(const struct xVec3 & center /* r0 */, float radius /* f30 */, float margin_angle /* f31 */) {}

// Range: 0x8024024C -> 0x80240280
// this: r31
float zCamPlayer::get_current_default_height() {}

// Range: 0x80240280 -> 0x80240288
// this: r0
void zCamPlayer::set_current_height(float val /* f0 */) {}

// Range: 0x80240288 -> 0x80240290
float zCamPlayer::get_current_default_pitch_offset() {
    // References
    // -> static float pitch_offset;
}

// Range: 0x80240290 -> 0x80240298
// this: r0
void zCamPlayer::set_current_pitch_offset(float val /* f0 */) {}

// Range: 0x80240298 -> 0x802402DC
// this: r31
float zCamPlayer::get_current_default_pitch() {}

// Range: 0x802402DC -> 0x802402E4
// this: r0
void zCamPlayer::set_current_look_xz(float val /* f0 */) {}

// Range: 0x802402E4 -> 0x802402EC
float zCamPlayer::get_current_default_look_xz() {
    // References
    // -> static float look_xz;
}

// Range: 0x802402EC -> 0x80240320
// this: r31
float zCamPlayer::get_current_default_fov() {}

// Range: 0x80240320 -> 0x80240328
// this: r0
void zCamPlayer::set_current_fov(float val /* f0 */) {}

// Range: 0x80240328 -> 0x80240338
...
// Range: 0x80240338 -> 0x80240340
void zCamPlayer::set_mount_min_offset_tweak(float tweak /* f0 */) {
    // References
    // -> static float sCamPlayerTweakMountMinOffset;
}
...
// Range: 0x80240340 -> 0x802404B8
// this: r30
void zCamPlayer::snap_reset(const struct xMat4x3 & mat /* r31 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$2072zCamPlayer_cpp */ {
    // Static members
...
// Range: 0x80240978 -> 0x8024097C
void zCamPlayer::reset_drift() {}

// Range: 0x8024097C -> 0x8024099C
// this: r0
...
// Range: 0x80240CD8 -> 0x80240ED0
// this: r31
void zCamPlayer::update_mount(float dt /* f30 */) {
    // Local variables
    float prev_mount_height; // f31
    float dmount; // f3
...
// Range: 0x80241164 -> 0x8024127C
// this: r31
void zCamPlayer::update_input(float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04B50
// Range: 0x8024127C -> 0x802413E0
// this: r31
...
// Range: 0x802413E0 -> 0x80241680
// this: r31
void zCamPlayer::update_zone_dist(float dt /* f30 */) {
    // Local variables
    float dist_away; // f29
    float ddist; // f31
    float dxz; // f1
    float rest_to_goal; // f1
    float dirx; // f0
    float dirz; // f0
    float veldot; // f4
...
// Range: 0x80241680 -> 0x80241684
void zCamPlayer::update_zone_phi() {}

// Range: 0x80241684 -> 0x802416BC
// this: r6
void zCamPlayer::update_zone_pitch_offset(float dt /* f0 */) {}

// Range: 0x802416BC -> 0x8024181C
// this: r31
void zCamPlayer::update_input_theta(float dt /* f31 */) {
    // Local variables
    float stickx; // f3
    float max_vel_theta; // f2
...
// Range: 0x8024181C -> 0x80241C08
// this: r29
void zCamPlayer::update_secondary_clamping(float dt /* f31 */) {
    // Local variables
    unsigned char have_secondary; // r31
    const struct xEnt * ent; // r3
    struct xVec3 * center; // r30
    float radius; // f30
    float margin_angle; // f29
    struct xSphere test_sphere; // r1+0x1C
    struct xEnt * ent; // r0
    float Ax; // f28
    float Az; // f27
    float Bx; // f26
...
// Range: 0x80241C08 -> 0x80241EA8
// this: r31
void zCamPlayer::update_aggression(float dt /* f31 */) {
    // Local variables
    float opt_dtheta; // f0
...
// Range: 0x80241EA8 -> 0x8024215C
// this: r31
void zCamPlayer::update_restoration(float dt /* f31 */) {
    // Local variables
    float drest_phi; // f3
    float max_dphi; // f2
    float dphi; // f4
...
// Range: 0x8024215C -> 0x802422B0
// this: r31
void zCamPlayer::update_dist_restoration(float dt /* f31 */) {
    // Local variables
    float dist_away; // f3
    struct xVec3 mount_origin; // r1+0x8
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C04B5C
// Range: 0x802423C4 -> 0x80242510
// this: r31
void zCamPlayer::update_result(float dt /* f30 */) {
    // Local variables
    float start_dist; // f31
...
// Range: 0x80242510 -> 0x80242790
// this: r31
void zCamPlayer::update_pitch(float dt /* f29 */) {
    // Local variables
    float goal_pitch_rest; // f31
    float goal_pitch_clamp0; // f30
    float dx; // f1
    float dz; // f2
    float xzdist; // f30
    float target_height; // f28
    float look_height; // f0
    float look_diff; // f0
    float clamped_pitch; // f2
    float goal_pitch_clamp1; // f2
    float pitch_clamp_center; // f3
    float pitch_min; // f28
    float pitch_max; // f27
    struct xVec3 mount_origin; // r1+0x1C
    struct xVec3 offset; // r1+0x10
    float pitch; // f0
    float goal_pitch_clamp; // r1+0xC
...
// Range: 0x80242790 -> 0x802427C8
// this: r31
void zCamPlayer::update_fov() {}

// Range: 0x802427C8 -> 0x802428A8
// this: r31
...
void zCamPlayer::collide_pivot() {
    ...
    struct xVec3 mount_origin; // r1+0x8
    float dphi; // f3
    float rest_to_input_phi; // f4

    // References
    // -> static float rest_phi_max_vel;
}

// Range: 0x80242B28 -> 0x80242C4C
// this: r31
...
static float graph_ydelta; // size: 0x4, address: 0x80C09150
static float graph_height; // size: 0x4, address: 0x80C09154
static float graph_path_dist; // size: 0x4, address: 0x80C09158
// Range: 0x80242C4C -> 0x80242CCC
// this: r31
...
// Range: 0x80243310 -> 0x80243368
// this: r31
void zCamPlayer::debug_init() {}

static struct tweak_callback cb_test_dist_set; // size: 0x28, address: 0x803FADD0
static struct tweak_callback cb_test_dist_reset; // size: 0x28, address: 0x803FADF8
static struct tweak_callback cb_test_pitch_offset_set; // size: 0x28, address: 0x803FAE20
static struct tweak_callback cb_test_pitch_offset_reset; // size: 0x28, address: 0x803FAE48
// Range: 0x80243368 -> 0x80243564
// this: r31
void zCamPlayer::add_instance_tweaks(const char * prefix /* r4 */) {
    // Local variables
...
// Range: 0x80243564 -> 0x80243598
void zCamPlayer::on_test_dist_set(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zCamPlayer & cam; // r3
}

// Range: 0x80243598 -> 0x802435CC
void zCamPlayer::on_test_dist_reset(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zCamPlayer & cam; // r3
...
// Range: 0x802435CC -> 0x802435FC
void zCamPlayer::on_test_pitch_offset_set(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zCamPlayer & cam; // r3
}

// Range: 0x802435FC -> 0x8024362C
void zCamPlayer::on_test_pitch_offset_reset(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zCamPlayer & cam; // r3
}

// Range: 0x8024362C -> 0x80243634
float zCamPlayer::get_default_blend_speed_rest_dist() {
    // References
    // -> static float rest_dist;
}

// Range: 0x80243634 -> 0x8024363C
...
// total size: 0x4C
struct {} zCamPlayer::__vtable; // size: 0x4C, address: 0x80440D08
// total size: 0x0
