/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\water\fxmain.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D84AC -> 0x801D874C
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct FxParam * (* EffectOpenFunctions[1])(); // size: 0x4, address: 0x80C031E0
static char * EffectNames[1]; // size: 0x4, address: 0x80C08C10
static struct FxParam * Effects[1]; // size: 0x4, address: 0x80C08C14
static int EffectIndex; // size: 0x4, address: 0x80C08C18
// total size: 0x0
...
// Range: 0x801D84AC -> 0x801D85C4
static struct RpMaterial * MaterialSetupEffect(struct RpMaterial * material /* r28 */, void * data /* r4 */) {
    // Local variables
    struct RpMultiTexture * srcMT; // r31
    struct RpMultiTexture * dstMT; // r30
    unsigned int numTextures; // r29
    unsigned int i; // r28
    struct RpMaterial * (* preRender)(struct RpMaterial *, void *, struct RxGameCubePipeData *, void *); // r1+0x10
    struct RpMaterial * (* postRender)(struct RpMaterial *, void *, struct RxGameCubePipeData *, void *); // r1+0xC
    void * cbData; // r1+0x8
}
...
// Range: 0x801D85C4 -> 0x801D8638
struct RpAtomic * AtomicSetupEffect(struct RpAtomic * atomic /* r31 */, void * data /* r4 */) {
    // Local variables
    struct RpMaterial * material; // r4
