/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zTaskBox.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80171018 -> 0x80171ED4
*/
class talk_callback * tcb; // size: 0x4, address: 0x80C08550
char __FUNCTION__$localstatic1$on_stop__Q28ztaskbox13talk_callbackFv[8]; // size: 0x8, address: 0x80C01A10
char __FUNCTION__$localstatic1$on_start__Q28ztaskbox13talk_callbackFv[9]; // size: 0x9, address: 0x80C01A18
// total size: 0x4
struct /* @class$1550zTaskBox_cpp */ {
    // Members
    struct ztaskbox * active; // offset 0x0, size 0x4
};
static // total size: 0x4
struct /* @class$1550zTaskBox_cpp */ {
    // Members
    struct ztaskbox * active; // offset 0x0, size 0x4
} shared; // size: 0x4, address: 0x80C08554
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$960zTaskBox_cpp */ {
    // Members
    unsigned char enabled : 8; // offset 0x0, size 0x1
    unsigned char running : 8; // offset 0x1, size 0x1
    unsigned int dummy : 16; // offset 0x0, size 0x4
};
// total size: 0x24
struct ztaskbox : public xBase {
    // Functions
    void load(const struct asset_type & a);

    void read(struct xSerial & s);

    void write(struct xSerial & s);

    void start_talk(class zNPCBaseIN2 * npc);
    ...
    void set_callback(class callback * cb);

    unsigned char exists(enum state_enum state);

    void set_state(enum state_enum state);
    ...
    // Static members
    static class talk_callback * tcb; // size: 0x4
...
private:
    ...
    struct ztaskbox * current; // offset 0x20, size 0x4
};
// Range: 0x80171018 -> 0x801710D8
// this: r30
void ztaskbox::load(const struct asset_type & a /* r31 */) {}

// Range: 0x801710D8 -> 0x80171120
// this: r31
void ztaskbox::read(struct xSerial & s /* r4 */) {
    // Local variables
    unsigned char state; // r1+0x8
}
...
// Range: 0x80171120 -> 0x8017114C
// this: r3
void ztaskbox::write(struct xSerial & s /* r4 */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C01A24
// total size: 0x0
class zNPCBaseIN2 {};
// total size: 0x1
struct /* @class$957zTaskBox_cpp */ {
    // Members
...
// Range: 0x8017114C -> 0x801712E8
// this: r30
void ztaskbox::start_talk(class zNPCBaseIN2 * npc /* r31 */) {
    // Local variables
    struct ztalkbox * talk; // r29
    const char * s; // r28

    // References
    // -> class talk_callback * tcb;
    // -> static // total size: 0x4
struct /* @class$1550zTaskBox_cpp */ {
    // Members
    struct ztaskbox * active; // offset 0x0, size 0x4
...
class talk_callback : public callback {
    // Functions
    void reset(struct ztaskbox & task);

    void on_start();

    void on_stop();

    void on_answer(enum answer_enum answer);

    // Members
public:
    struct ztaskbox * task; // offset 0x4, size 0x4
    enum answer_enum answer; // offset 0x8, size 0x4
};
// Range: 0x801712E8 -> 0x801712F8
// this: r0
void talk_callback::reset(struct ztaskbox & task /* r0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C01A30
// Range: 0x801712F8 -> 0x80171428
// this: r31
...
// Range: 0x80171428 -> 0x80171460
// this: r0
void ztaskbox::enable() {}

// Range: 0x80171460 -> 0x801714AC
// this: r31
void ztaskbox::disable() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C01A3C
// Range: 0x801714AC -> 0x80171544
// this: r31
void ztaskbox::reset() {
    // References
...
// Range: 0x80171544 -> 0x80171574
// this: r0
void ztaskbox::initiate() {}

// Range: 0x80171574 -> 0x801715B4
// this: r3
void ztaskbox::succeed() {}

// Range: 0x801715B4 -> 0x801715F4
// this: r3
void ztaskbox::fail() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C01A44
// Range: 0x801715F4 -> 0x801716B0
// this: r31
...
// Range: 0x801716B0 -> 0x801716B8
// this: r0
void ztaskbox::set_callback(class callback * cb /* r0 */) {}

static signed char init; // size: 0x1, address: 0x80C08558
static class talk_callback tcb; // size: 0xC, address: 0x80C0855C
// Range: 0x801716B8 -> 0x80171700
void ztaskbox::init() {
    // References
    // -> static class talk_callback tcb;
    // -> class talk_callback * tcb;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C01A50
// Range: 0x80171744 -> 0x801718B8
void ztaskbox::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x801718C8 -> 0x80171920
// this: r0
unsigned char ztaskbox::exists(enum state_enum state /* r0 */) {
    // Local variables
    unsigned int id; // r3
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C01A58
// Range: 0x80171920 -> 0x80171A6C
// this: r30
void ztaskbox::set_state(enum state_enum state /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x80171A6C -> 0x80171AAC
// this: r0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C01A64
// Range: 0x80171AAC -> 0x80171BEC
// this: r31
...
// Range: 0x80171BEC -> 0x80171C64
char * ztaskbox::get_text(unsigned int id /* r31 */) {
    // Local variables
    struct xGroup * text_group; // r0
    const char * text; // r0
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01A74
// Range: 0x80171C64 -> 0x80171DC8
void ztaskbox::cb_dispatch(struct xBase * to /* r31 */, unsigned int event /* r30 */) {
    // Local variables
    struct ztaskbox & e; // r31
...
// total size: 0x18
struct {} ztalkbox::callback::__vtable; // size: 0x18, address: 0x80C01A80
// total size: 0x4
struct callback {
    // Members
    void * __vptr$; // offset 0x0, size 0x4
...
// total size: 0x18
struct {} ztaskbox::talk_callback::__vtable; // size: 0x18, address: 0x80C01A98
// Range: 0x80171DC8 -> 0x80171E48
// this: r31
void talk_callback::on_start() {
    // References
    // -> char __FUNCTION__$localstatic1$on_start__Q28ztaskbox13talk_callbackFv[9];
}

// Range: 0x80171E48 -> 0x80171ECC
// this: r31
void talk_callback::on_stop() {
    // References
    // -> char __FUNCTION__$localstatic1$on_stop__Q28ztaskbox13talk_callbackFv[8];
}
...
// Range: 0x80171ECC -> 0x80171ED4
// this: r0
void talk_callback::on_answer(enum answer_enum answer /* r0 */) {}
