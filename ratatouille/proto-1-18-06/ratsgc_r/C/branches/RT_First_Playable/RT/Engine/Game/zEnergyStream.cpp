/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEnergyStream.cpp
...
struct config {
    ...
    int ribbon_segments; // offset 0x20, size 0x4
...
// total size: 0x90
class EnergyStream : public zLightweight {
    // Static members
    static struct config default_config; // size: 0x4C

    // Members
    struct xVec3 * target; // offset 0xC, size 0x4
    struct xVec3 * velocity; // offset 0x10, size 0x4
    float * velocity_v; // offset 0x14, size 0x4
    float * ribbon_size; // offset 0x18, size 0x4
    int ribbon_size_start; // offset 0x1C, size 0x4
    ...
    struct xVec3 * control; // offset 0x38, size 0x4
    const struct xVec3 * start; // offset 0x3C, size 0x4
    const struct xVec3 * end; // offset 0x40, size 0x4
    struct xVec3 direction; // offset 0x44, size 0xC
    struct xMat3x3 mat; // offset 0x50, size 0x30
    struct xFXRibbon * ribbon; // offset 0x80, size 0x4
};
// total size: 0x0
class zLightweightSystem {};
// total size: 0xC
class zLightweight {
    // Members
...
// total size: 0x890
struct /* @class$2072zEnergyStream_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1119zEnergyStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1120zEnergyStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1121zEnergyStream_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1122zEnergyStream_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1123zEnergyStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1124zEnergyStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1125zEnergyStream_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1269zEnergyStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1700zEnergyStream_cpp */ {
    // Members
...
union /* @class$1457zEnergyStream_cpp */ {
...
// total size: 0x10
struct /* @class$1470zEnergyStream_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
