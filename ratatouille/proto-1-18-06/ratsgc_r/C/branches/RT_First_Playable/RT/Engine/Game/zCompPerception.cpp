/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompPerception.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C6024 -> 0x802C6CF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompPerceptionParams gDefaultPerceptionParams; // size: 0x78, address: 0x80BD48A8
// Range: 0x802C6024 -> 0x802C60A8
// this: r0
zCompPerceptionParams::zCompPerceptionParams() {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C069A8
// Range: 0x802C60A8 -> 0x802C612C
class zCompPerceptionParams * zCompPerceptionParams::GetParamsFromAsset(unsigned int aid /* r0 */) {
    // Local variables
    unsigned int assetSize; // r1+0x8
    class zCompPerceptionParams * params; // r31
...
// total size: 0x3C
struct {} zCompPerception::__vtable; // size: 0x3C, address: 0x8044921C
// total size: 0x8
...
class zCompPerception : public zICompPerception {
    ...
    void Perceived(enum eCompPerceptionType perceptionType, struct xEnt * perceivedEnt, float dt);

    void NotPerceived(float dt);

    void PreUpdate(float dt);

    unsigned char CheckSpherePerception(class zCompPerceptionDynamics & percpDyn);

    unsigned char CheckSoundSpherePerception(class zCompPerceptionDynamics & percpDyn);

    unsigned char CheckCylinderPerception(class zCompPerceptionDynamics & percpDyn);

    unsigned char CheckConePerception(class zCompPerceptionDynamics & percpDyn);

    unsigned char CheckTriPerception(class zCompPerceptionDynamics & percpDyn);
...
// Range: 0x802C612C -> 0x802C619C
// this: r31
zCompPerception::zCompPerception() {
    // References
    // -> struct [anonymous] zCompPerception::__vtable;
}

// Range: 0x802C61D8 -> 0x802C6234
// this: r31
void zCompPerception::Attached() {
    // Local variables
    const struct zNPCAssetRATS * npcAsset; // r0

    // References
    // -> static class zCompPerceptionParams gDefaultPerceptionParams;
}
...
// total size: 0x4
struct /* @class$1146zCompPerception_cpp */ {
    // Members
...
union /* @class$1032zCompPerception_cpp */ {
...
// total size: 0xC
struct /* @class$1302zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1087zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1088zCompPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1089zCompPerception_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1090zCompPerception_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1091zCompPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1092zCompPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1093zCompPerception_cpp */ {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C069BC
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1804zCompPerception_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802C6234 -> 0x802C6338
// this: r30
void zCompPerception::AllAttached() {
    // Local variables
    struct xBase * b; // r0
...
// total size: 0x890
struct /* @class$2051zCompPerception_cpp */ {
    // Static members
...
// Range: 0x802C6338 -> 0x802C636C
// this: r0
void zCompPerception::Detached() {}

// Range: 0x802C636C -> 0x802C6390
// this: r0
void zCompPerception::Reset() {}
...
// Range: 0x802C6390 -> 0x802C6410
// this: r30
void zCompPerception::Perceived(enum eCompPerceptionType perceptionType /* r31 */, struct xEnt * perceivedEnt /* r5 */, float dt /* f31 */) {}

// Range: 0x802C6410 -> 0x802C6460
// this: r0
void zCompPerception::NotPerceived(float dt /* f0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C069C8
// total size: 0x4C
class zCompPerceptionDynamics {
    // Functions
    unsigned char Reset(class zICompNPCEntity * npcEnt, struct xEnt * perceivedObj);

    float GetDistance2();

    void CalculateDiff();

    float GetDistanceXZ2();

    void CalculateDiffXZ();

    float GetDiffY();

    float GetTanTheta2();

    void CalculateTanTheta();

    // Members
    class zICompNPCEntity * npcEnt; // offset 0x0, size 0x4
    struct xEnt * perceivedObj; // offset 0x4, size 0x4
    struct xVec3 * npcPos; // offset 0x8, size 0x4
    struct xVec3 * npcAt; // offset 0xC, size 0x4
    struct xVec3 * perceivedObjPos; // offset 0x10, size 0x4
    struct xVec3 diffVector; // offset 0x14, size 0xC
    float distance2; // offset 0x20, size 0x4
    struct xVec3 diffVectorXZ; // offset 0x24, size 0xC
    float distanceXZ2; // offset 0x30, size 0x4
    float diffY; // offset 0x34, size 0x4
    float tanTheta2; // offset 0x38, size 0x4
    float tanThetaXZ; // offset 0x3C, size 0x4
    float tanThetaYZ; // offset 0x40, size 0x4
    unsigned char inNPCWalls; // offset 0x44, size 0x1
    unsigned char diffCalculated; // offset 0x45, size 0x1
    unsigned char diffXZCalculated; // offset 0x46, size 0x1
    unsigned char tanThetaCalculated; // offset 0x47, size 0x1
    unsigned char inNPCWallsCalculated; // offset 0x48, size 0x1
};
// Range: 0x802C6460 -> 0x802C6694
// this: r31
void zCompPerception::PreUpdate(float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompPerceptionDynamics perceptionDynamics; // r1+0x8

    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x802C6694 -> 0x802C6720
// this: r31
unsigned char zCompPerceptionDynamics::Reset(class zICompNPCEntity * npcEnt /* r0 */, struct xEnt * perceivedObj /* r5 */) {}

// Range: 0x802C6720 -> 0x802C6780
// this: r0
unsigned char zCompPerception::CheckSpherePerception(class zCompPerceptionDynamics & percpDyn /* r4 */) {
    // Local variables
    float checkDistance; // f31
}

// Range: 0x802C6780 -> 0x802C67BC
// this: r31
float zCompPerceptionDynamics::GetDistance2() {}

// Range: 0x802C67BC -> 0x802C6808
// this: r31
void zCompPerceptionDynamics::CalculateDiff() {}
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80449200
// Range: 0x802C6808 -> 0x802C6908
// this: r30
unsigned char zCompPerception::CheckSoundSpherePerception(class zCompPerceptionDynamics & percpDyn /* r31 */) {
    // Local variables
    float noise; // f0
    float checkDistance; // f31
...
// Range: 0x802C6908 -> 0x802C69C8
// this: r0
unsigned char zCompPerception::CheckCylinderPerception(class zCompPerceptionDynamics & percpDyn /* r31 */) {
    // Local variables
    float cylinderR; // f31
    float cylinderHUp; // f30
    float cylinderHDown; // f29
    float cylinderRatio; // f0
    float diffY; // f0
}

// Range: 0x802C69C8 -> 0x802C6A04
// this: r31
float zCompPerceptionDynamics::GetDistanceXZ2() {}

// Range: 0x802C6A04 -> 0x802C6A60
// this: r31
void zCompPerceptionDynamics::CalculateDiffXZ() {}

// Range: 0x802C6A60 -> 0x802C6A9C
// this: r31
float zCompPerceptionDynamics::GetDiffY() {}

// Range: 0x802C6A9C -> 0x802C6B3C
// this: r0
unsigned char zCompPerception::CheckConePerception(class zCompPerceptionDynamics & percpDyn /* r31 */) {
    // Local variables
    float hTheta; // f31
    float coneD; // f30
    float coneRatio; // f0
...
// Range: 0x802C6B3C -> 0x802C6B78
// this: r31
float zCompPerceptionDynamics::GetTanTheta2() {}

// Range: 0x802C6B78 -> 0x802C6C04
// this: r31
void zCompPerceptionDynamics::CalculateTanTheta() {
    // Local variables
    struct xVec3 diffLocal; // r1+0x8
    float oneOverZ; // f1
}

// total size: 0x1
class zNPCHelper {};
// Range: 0x802C6C04 -> 0x802C6CF8
// this: r0
unsigned char zCompPerception::CheckTriPerception(class zCompPerceptionDynamics & percpDyn /* r31 */) {
    // Local variables
    float hTheta; // f31
    float triD; // f30
    float triHUp; // f29
...
// total size: 0x3C
struct {} zICompPerception::__vtable; // size: 0x3C, address: 0x80449258
// total size: 0x8
class zIComponent {
    // Members
public:
