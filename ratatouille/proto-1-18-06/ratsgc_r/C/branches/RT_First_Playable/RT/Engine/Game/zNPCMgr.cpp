/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8013F950 -> 0x8014331C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNotSentPoolCreatedEvent; // size: 0x1, address: 0x80C00DC8
// total size: 0x14
...
struct zNPCMgrGroupTarget gNPCMgrGroupTarget; // size: 0x14, address: 0x80C08298
// total size: 0xC
struct xModelPool {
    // Members
...
struct zNPCMgrIncidental gNPCIncidental[1]; // size: 0x14, address: 0x80C082AC
// total size: 0x10
...
struct zSurroundedBy gSurroundedBy[32]; // size: 0x200, address: 0x80B9F7D8
int gSurroundedByTotal; // size: 0x4, address: 0x80C082C0
...
static struct creationData g_creationData[3]; // size: 0x48, address: 0x8043A5D0
// Range: 0x8013F950 -> 0x8013F9CC
static class zNPCInstance * create(void * object /* r3 */, const struct xModelAssetInfo * model_asset /* r28 */, unsigned int type /* r29 */, struct zNPCAssetIN2 * npc_asset /* r30 */, int npc_asset_size /* r31 */) {}

// Range: 0x8013F9CC -> 0x8013FA48
static class zNPCInstance * create(void * object /* r3 */, const struct xModelAssetInfo * model_asset /* r28 */, unsigned int type /* r29 */, struct zNPCAssetIN2 * npc_asset /* r30 */, int npc_asset_size /* r31 */) {}

// total size: 0xC
struct {} zNPCChef::inst_type::__vtable; // size: 0xC, address: 0x80C00EA4
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0xC
struct {} zNPCThiefOld::inst_type::__vtable; // size: 0xC, address: 0x80C00E98
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0x60
...
// total size: 0x4
struct /* @class$2264zNPCMgr_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2265zNPCMgr_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933zNPCMgr_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zNPCMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zNPCMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zNPCMgr_cpp */ {
    // Members
...
static int g_poolSize[3]; // size: 0xC, address: 0x80C00DCC
static int g_modinit; // size: 0x4, address: 0x80C082F4
static struct zNPCMgr * g_npcmgr; // size: 0x4, address: 0x80C082F8
static float ONE_LINER_NO_ENEMIES_TIME; // size: 0x4, address: 0x80C00DD8
// Range: 0x8013FA48 -> 0x8013FA68
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00DDC
...
// Range: 0x8013FA68 -> 0x8013FF08
static void event_wrapper(struct xBase * from /* r25 */, struct xBase * to /* r31 */, unsigned int toEvent /* r26 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r27 */, unsigned int toParamWidgetID /* r28 */) {
    // Local variables
    class zNPCInstance * inst; // r31
    struct zNPCMgr * mgr; // r0
    struct xVec3 * pos; // r0
    struct zNPCMgr * mgr; // r0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00DEC
// Range: 0x8013FF08 -> 0x8013FF78
...
// Range: 0x8013FF78 -> 0x8013FF9C
void zNPCMgr_findRumbles() {}

// Range: 0x8013FF9C -> 0x8013FFBC
struct st_XORDEREDARRAY * zNPCMgr_GetNPCList() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00DF8
// Range: 0x8013FFBC -> 0x80140070
...
// Range: 0x801400CC -> 0x80140100
void zNPCMgr_scenePrepare(int npccnt /* r31 */) {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140100 -> 0x80140124
void zNPCMgr_sceneInit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140124 -> 0x80140148
void zNPCMgr_sceneSetup() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140148 -> 0x8014016C
void zNPCMgr_sceneFinish() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x8014016C -> 0x80140190
void zNPCMgr_sceneExit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140190 -> 0x801401B4
void zNPCMgr_sceneReset() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x801401B4 -> 0x801401D8
void zNPCMgr_scenePostInit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x801401D8 -> 0x8014021C
void zNPCMgr_sceneTimestep(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
    struct zNPCMgr * mgr; // r0
}
...
// Range: 0x80140240 -> 0x801402F0
// this: r28
void zNPCMgr::SwitchedNavmeshes() {
    // Local variables
    enum en_npctyp type; // r1+0x8
    int i; // r29
    class zNPCInstance * inst; // r0
    class zNPCCommon * data; // r0
}

// Range: 0x801402F0 -> 0x80140314
void zNPCMgr_sceneRender() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140314 -> 0x80140338
void zNPCMgr_sceneRenderFreezing() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140338 -> 0x8014035C
void zNPCMgr_scenePostRender() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x8014035C -> 0x80140380
void zNPCMgr_scenePostRenderCleanup() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x80140380 -> 0x801403A4
int zNPCMgr_preCreateNPCs() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x801403A4 -> 0x801403C8
void zNPCMgr_KillAll() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x801403C8 -> 0x8014041C
struct xBase * zNPCMgr_createDynNPCInst(const struct xEntAsset * assdat /* r29 */, const struct xDynAsset * dynass /* r30 */, int siz_dynass /* r31 */) {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x8014041C -> 0x80140434
// this: r0
void zNPCMgr::Startup() {}

// Range: 0x80140434 -> 0x80140438
void zNPCMgr::Shutdown() {}

// Range: 0x80140438 -> 0x801405CC
// this: r31
void zNPCMgr::FindRumbleFx() {
    // Local variables
    char txt[128]; // r1+0x8
    unsigned int rumbleEmitID; // r0
    int i; // r28
    int i; // r28
    int i; // r28
    int i; // r28
...
// Range: 0x801405CC -> 0x80140628
void zNPCMgr::SceneInit() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r31
}

// Range: 0x80140628 -> 0x801406B0
// this: r30
void zNPCMgr::ScenePrepare(int cnt /* r31 */) {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00E08
// Range: 0x801407A4 -> 0x80140A9C
// this: r27
void zNPCMgr::SceneReset() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r26
    enum en_npctyp type; // r31+0x10
    class zNPCInstance * * instanceArray; // r29
    int i; // r25
    int i; // r25
    class zNPCBaseIN2 * data; // r0
    int i; // r28
    class zNPCBaseIN2 * data; // r25
    int i; // r25
...
static struct xVec3 sNPCMgrSortCamPosition; // size: 0xC, address: 0x80C082FC
// Range: 0x80140BAC -> 0x80140BE8
static int instanceClosestFirstSort(void * elem1 /* r3 */, void * elem2 /* r4 */) {
    // Local variables
    int icVal; // r0
...
// Range: 0x80140BE8 -> 0x80140C50
static int dataFurthestFirstSort(void * elem1 /* r30 */, void * elem2 /* r0 */) {
    // Local variables
    int icVal; // r0
...
// Range: 0x80140C50 -> 0x80140CF0
// this: r25
void zNPCMgr::FillInAllocOrder(class zNPCInstance * * array /* r26 */, enum en_npctyp type /* r27 */) {
    // Local variables
    int i; // r28
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C00E14
// Range: 0x80140CF0 -> 0x80140DF0
static void _AnimViewerSelectedCB(const struct tweak_info & info /* r29 */) {
    // Local variables
...
// Range: 0x80140E10 -> 0x80140F78
static void _LogDebugInfoSelectedCB(const struct tweak_info & info /* r0 */) {
    // Local variables
    class zNPCCommon * npc; // r31
}
...
static struct tweak_callback animViewerTestCB; // size: 0x28, address: 0x803D9758
static struct tweak_callback logDebugInfoCB; // size: 0x28, address: 0x803D9780
static struct tweak_callback cb_active_model; // size: 0x28, address: 0x8043A618
static signed char init; // size: 0x1, address: 0x80C08308
static struct tweak_callback cb_debug_me; // size: 0x28, address: 0x8043A640
static signed char init; // size: 0x1, address: 0x80C08309
static struct tweak_callback cb_show_vertex; // size: 0x28, address: 0x8043A668
static signed char init; // size: 0x1, address: 0x80C0830A
int gEnt_ActiveModel; // size: 0x4, address: 0x80C0723C
int gEnt_ShowBone; // size: 0x4, address: 0x80BFC5C8
struct xVec3 gEnt_ShowBoneLoc; // size: 0xC, address: 0x80C07240
int gEnt_ShowVertex; // size: 0x4, address: 0x80BFC5CC
struct xVec3 gEnt_ShowVertexLoc; // size: 0xC, address: 0x80C0724C
// Range: 0x80140F78 -> 0x801413BC
static void _OnExpandListAllTypes() {
    // Local variables
    enum en_npctyp type; // r1+0x18
    int i; // r24
    class zNPCBaseIN2 * data; // r23
...
static struct tweak_callback cb_active_model; // size: 0x28, address: 0x8043A690
static signed char init; // size: 0x1, address: 0x80C0830B
static struct tweak_callback cb_debug_me; // size: 0x28, address: 0x8043A6B8
static signed char init; // size: 0x1, address: 0x80C0830C
static struct tweak_callback cb_show_vertex; // size: 0x28, address: 0x8043A6E0
static signed char init; // size: 0x1, address: 0x80C0830D
// Range: 0x80141468 -> 0x8014189C
...
static struct tweak_callback listAllTypeTweakCB; // size: 0x28, address: 0x803D9828
static struct tweak_callback listAllToggleTweakCB; // size: 0x28, address: 0x803D9850
static struct tweak_callback bonesNVertsTweakCB; // size: 0x28, address: 0x803D9878
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8014189C -> 0x80141BCC
// this: r26
void zNPCMgr::ScenePostInit() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r23
    enum en_npctyp type; // r31+0x10
    class zNPCInstance * * instanceArray; // r23
    int i; // r28
    class zNPCBaseIN2 * data; // r27
    struct xAnimState * animNext; // r22
...
// Range: 0x80141BCC -> 0x80141C7C
static unsigned char render_npc(class zNPCBaseIN2 * npc /* r28 */) {
    // Local variables
    class zNPCInstance * inst; // r29
}
...
// Range: 0x80141C7C -> 0x80141D88
// this: r31
void zNPCMgr::SceneSetup() {
    // Local variables
    class zNPCBaseIN2 * npc; // r28
    enum en_npctyp type; // r1+0x8
    int i; // r27
    struct zLODTable * lod; // r0
...
// Range: 0x80141D88 -> 0x80141E3C
// this: r27
void zNPCMgr::ScenePostRender() {
    // Local variables
    class zNPCBaseIN2 * npc; // r29
    enum en_npctyp type; // r1+0x8
    int i; // r28
}

// Range: 0x80141E3C -> 0x80141EDC
// this: r27
...
// Range: 0x801420F4 -> 0x801420F8
void zNPCMgr::PreCreate() {}

// Range: 0x801420F8 -> 0x80142150
// this: r31
void zNPCMgr::PostCreate(class zNPCInstance * npc /* r0 */) {}

// Range: 0x80142150 -> 0x801421E4
// this: r27
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00E2C
enum eBrainType {
...
// Range: 0x801421E4 -> 0x801422A8
// this: r27
class zNPCInstance * zNPCMgr::GetInstance(enum en_npctyp type /* r29 */, int index /* r28 */) {
    // Local variables
    enum eBrainType brainType; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C00E38
// Range: 0x801422A8 -> 0x8014236C
// this: r27
class zNPCBaseIN2 * zNPCMgr::GetData(enum en_npctyp type /* r29 */, int index /* r28 */) {
    // Local variables
    enum eBrainType brainType; // r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00E40
// Range: 0x8014236C -> 0x80142528
// this: r27
struct xBase * zNPCMgr::CreateDynNPC(const struct xEntAsset * ent_asset /* r28 */, const struct xDynAsset * dyn_asset /* r29 */, int siz_dynass /* r30 */) {
    // Local variables
    unsigned int size; // r1+0x8
    unsigned int aid_minf; // r26
    void * thing; // r3
    const struct xModelAssetInfo * modelInfoAsset; // r31
    enum en_npctyp nt; // r26
    int prevCount; // r5
    class zNPCInstance * npc; // r28
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00E50
// Range: 0x80142528 -> 0x80142658
// this: r28
int zNPCMgr::FindFreeData(class zNPCBaseIN2 * * array /* r29 */, enum en_npctyp type /* r30 */, const struct xVec3 & pos /* r31 */) {
    // Local variables
    int count; // r24
    int i; // r23
    class zNPCBaseIN2 * data; // r0
    class zNPCInstance * inst; // r22
    float dist2; // f0
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C0830E
static signed char init; // size: 0x1, address: 0x80C0830F
static unsigned char already_asserted; // size: 0x1, address: 0x80C08310
static signed char init; // size: 0x1, address: 0x80C08311
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00E60
// Range: 0x80142728 -> 0x80142A14
// this: r24
unsigned char zNPCMgr::GetFreePoolData(class zNPCInstance * inst /* r25 */, int freeIndex /* r26 */) {
    // Local variables
    const struct xVec3 & centerPos; // r30
    int freeCount; // r29
    class zNPCBaseIN2 * * freeArray; // r28
    int i; // r27
    float update_dist; // f0
    float dist; // f0
...
// Range: 0x80142A14 -> 0x80142A38
static class zNPCBaseIN2 * * pushTempArray(int size /* r3 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80C08312
static signed char init; // size: 0x1, address: 0x80C08313
static unsigned char already_asserted; // size: 0x1, address: 0x80C08314
static signed char init; // size: 0x1, address: 0x80C08315
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00E70
// Range: 0x80142A38 -> 0x80142FFC
// this: r30
void zNPCMgr::SceneTimestep(struct xScene * xscn /* r31 */, float dt /* f29 */) {
    // Local variables
    int playerSize; // r0
    int i; // r22
    enum en_npctyp type; // r1+0x1C
    int i; // r23
    class zNPCInstance * npcinst; // r24
    class zNPCBaseIN2 * data; // r25
    const struct xVec3 & centerPos; // r27
    unsigned char NPCInUpdateRange; // r26
    enum en_npctyp type; // r1+0x18
    int freeIndex; // r25
    int freeCount; // r24
    class zNPCBaseIN2 * * freeArray; // r23
    int i; // r22
    class zNPCInstance * inst; // r21
    float update_dist; // f0
    float dist; // f0
    enum en_npctyp type; // r1+0x14
    int i; // r21
    class zNPCInstance * inst; // r24
    float update_dist; // f0
    float dist; // f0
    class zNPCBaseIN2 * data; // r25
...
// Range: 0x80142FFC -> 0x80143008
void zNPCMgr_SurroundedReset() {
    // References
    // -> int gSurroundedByTotal;
}

// Range: 0x80143008 -> 0x801431E8
void zNPCMgr_SurroundedUpdate() {
    // Local variables
    int a; // r28
    struct zSurroundedBy * npcA; // r0
    int b; // r27
...
// Range: 0x801431E8 -> 0x80143204
void zNPCIncidentalReset() {
    // References
    // -> struct zNPCMgrIncidental gNPCIncidental[1];
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C00E80
// Range: 0x80143204 -> 0x801432F0
void zNPCIncidentalUpdate(float dt /* f0 */) {
    // Local variables
...
// Range: 0x801432F0 -> 0x8014331C
int zNPCMgr_OrdComp_npcid(void * vkey /* r0 */, void * vitem /* r0 */) {
    // Local variables
    int rc; // r3
}
