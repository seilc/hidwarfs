/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerOneLinerData.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022CE08 -> 0x8022D1E4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int SURROUND_COUNT; // size: 0x4, address: 0x80C04658
static int KILL_LIMIT; // size: 0x4, address: 0x80C0465C
static float DAMAGE_TIME; // size: 0x4, address: 0x80C04660
static int DAMAGE_AMOUNT; // size: 0x4, address: 0x80C04664
// total size: 0x8
struct /* @class$820zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1098zPlayerOneLinerData_cpp */ {
    // Members
...
union /* @class$1237zPlayerOneLinerData_cpp */ {
...
// total size: 0xC
struct /* @class$1236zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2251zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2213zPlayerOneLinerData_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2214zPlayerOneLinerData_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2215zPlayerOneLinerData_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2217zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1583zPlayerOneLinerData_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1039zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1041zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1042zPlayerOneLinerData_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1043zPlayerOneLinerData_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1044zPlayerOneLinerData_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1045zPlayerOneLinerData_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2037zPlayerOneLinerData_cpp */ {
    // Static members
...
class zPlayerOneLinerData {
    ...
    unsigned char Damage(signed short amount);
...
// Range: 0x8022CE08 -> 0x8022CEF8
void zPlayerOneLinerData::AddTweaks(const char * prefix /* r31 */) {
    // References
    // -> static float DAMAGE_TIME;
    // -> static int DAMAGE_AMOUNT;
    // -> static int KILL_LIMIT;
    // -> static int SURROUND_COUNT;
}

// Range: 0x8022CEF8 -> 0x8022CF3C
// this: r3
void zPlayerOneLinerData::AddKillCount() {
    // References
    // -> static int KILL_LIMIT;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C04668
// Range: 0x8022CF3C -> 0x8022D0D0
// this: r30
unsigned char zPlayerOneLinerData::Damage(signed short amount /* r29 */) {
    // Local variables
    float currentTime; // f0
    int totalDamage; // r31
    int i; // r4
...
// Range: 0x8022D0D0 -> 0x8022D140
// this: r31
void zPlayerOneLinerData::Reset() {
    // Local variables
    int i; // r0
}
...
// Range: 0x8022D140 -> 0x8022D1E4
// this: r28
void zPlayerOneLinerData::Update() {
    // Local variables
    int surroundedCount; // r30
    int i; // r29
