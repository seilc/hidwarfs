/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFMV.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80126F88 -> 0x80127218
*/
// total size: 0xC
struct zFMVFile {
    // Members
...
static struct zFMVFile zFMVFileTable[53]; // size: 0x27C, address: 0x803D54B0
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C006C0
enum eFMVFile {
    eFMVFile_NoMovie = 0,
...
// Range: 0x80126F88 -> 0x8012703C
struct zFMVFile * zFMVFileGetFile(enum eFMVFile fmvId /* r31 */) {
    // Local variables
    int i; // r3

    // References
    // -> static char __FUNCTION__[16];
    // -> static struct zFMVFile zFMVFileTable[53];
}

// Range: 0x8012703C -> 0x80127070
char * zFMVFileGetName(enum eFMVFile fmvId /* r0 */) {
    // Local variables
...
// Range: 0x80127070 -> 0x80127218
unsigned int zFMVPlay(const char * name /* r24 */, unsigned int buttons /* r25 */, float time /* f30 */, unsigned int uSubtitlesAID /* r26 */, unsigned char skippable /* r27 */, unsigned char lockController /* r28 */, unsigned char displayDemoBlink /* r29 */) {
    // Local variables
    unsigned int retval; // r31
    float oldSize; // f31
    enum xSndEffect currentEffect; // r30
    char localizedName[64]; // r1+0x8
    int i; // r30
