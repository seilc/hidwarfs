/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xParEmitterType.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80096F3C -> 0x80099374
*/
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFDA40
// total size: 0x8
struct xBaseAsset {
    // Members
...
// Range: 0x8009701C -> 0x80097154
static void xParEmitterAngleVariation(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */) {
    // Local variables
    struct xMat3x3 mat_rot; // r1+0x20
    float ang_debrisCone; // f0
    float ang[3]; // r1+0x10
}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x804199D0
// total size: 0x10
struct _xMat2x2 {
    // Members
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFDA58
// Range: 0x80097354 -> 0x8009755C
void xParEmitterEmitCircle(struct xPar * p /* r29 */, struct xParEmitterAsset * a /* r30 */) {
    // Local variables
    float rot_amount; // f30
    float ct; // f30
    float st; // f31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFDA70
// Range: 0x8009755C -> 0x8009768C
void xParEmitterEmitRect(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */) {
    // References
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFDA84
// Range: 0x8009768C -> 0x800977E0
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFDA9C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFDAB0
// Range: 0x80097A00 -> 0x80097B68
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x804199EC
// Range: 0x80097B68 -> 0x80097E2C
void xParEmitterEmitSphereEdge(struct xPar * p /* r29 */, struct xParEmitterAsset * a /* r30 */, int subtype /* r31 */) {
    // Local variables
    struct xVec3 dirvec; // r1+0x1C
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFDAC8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80097E2C -> 0x8009802C
void xParEmitterEmitVolume(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, class xVolume * vol /* r29 */) {
    // Local variables
    const struct xBound * b; // r0
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFDAE0
// total size: 0x50
...
// total size: 0x4
struct /* @class$1097xParEmitterType_cpp */ {
    // Members
...
union /* @class$1236xParEmitterType_cpp */ {
...
// total size: 0xC
struct /* @class$1235xParEmitterType_cpp */ {
    // Members
...
// Range: 0x8009802C -> 0x8009821C
void xParEmitterEmitEntity(struct xPar * p /* r28 */, struct xParEmitterAsset * a /* r29 */, struct xEnt * ent /* r30 */) {
    // Local variables
    unsigned int size; // r31
    struct xModelInstance * model; // r26
    struct RpGeometry * geom; // r25
    struct xVec3 loc; // r1+0x8
    unsigned int which; // r4
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80419A08
// total size: 0x8
struct xParCmdAsset {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// Range: 0x8009821C -> 0x80098354
void xParEmitterEmitOffsetPoint(struct xParEmitter * pe /* r29 */, struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, struct xEnt * ent /* r28 */) {
    // References
    // -> static char __FUNCTION__[27];
}

// Range: 0x80098354 -> 0x80098440
void xParEmitterEmitVCylEdge(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */) {
    // Local variables
    float ang; // f31
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80419A24
// Range: 0x80098440 -> 0x80098538
void xParEmitterEmitOCircleEdge(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[27];
}

// Range: 0x80098538 -> 0x80098660
static void ocircle_emit(struct xPar & p /* r30 */, struct xParEmitterAsset & a /* r31 */, float radius /* f29 */) {
    // Local variables
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFDAF8
// Range: 0x80098660 -> 0x80098760
void xParEmitterEmitOCircle(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, float dt /* f31 */) {
    // Local variables
    float rr; // f0
...
static struct xMat4x3 buffer_mat; // size: 0x40, address: 0x80A92AA0
static char __FUNCTION__[28]; // size: 0x1C, address: 0x80419A40
// Range: 0x80098760 -> 0x80098854
struct xMat4x3 * xParEmitterTransformEntBone(struct xVec3 & loc /* r29 */, struct xVec3 & vel /* r30 */, const struct xParEmitterAsset & a /* r31 */, const struct xEnt & ent /* r0 */) {
    // Local variables
    const struct xPEEntBone & region; // r0
...
// Range: 0x80098854 -> 0x80098964
static void transform_ent_bone(struct xVec3 & loc /* r29 */, struct xVec3 & vel /* r4 */, const struct xParEmitterAsset & a /* r30 */, const struct xMat4x3 & mat /* r31 */) {
    // Local variables
    const struct xPEEntBone & region; // r0
    struct xVec3 offset; // r1+0x8
}

// Range: 0x80098964 -> 0x80098984
void xParEmitterTransformEntBone(struct xVec3 & loc /* r0 */, struct xVec3 & vel /* r0 */, const struct xParEmitterAsset & a /* r0 */, const struct xMat4x3 & mat /* r0 */) {}

// Range: 0x80098984 -> 0x80098A1C
void xParEmitterEmitEntBone(struct xPar * p /* r29 */, struct xParEmitterAsset * a /* r30 */, const struct xMat4x3 & mat /* r0 */) {
    // Local variables
    const struct xPEEntBone & region; // r31
    struct xVec3 offset; // r1+0x14
}

// Range: 0x80098A1C -> 0x80098DE8
static struct xVec3 get_random_offset(const struct xPEEntBone & region /* r30 */, const struct xMat4x3 & mat /* r31 */) {
    // Local variables
    struct xVec3 offset; // r1+0x8
    float ang; // f28
    float uz; // f27
...
// Range: 0x80098DE8 -> 0x80098EC8
void xParEmitterEmitEntBound(struct xPar * p /* r28 */, struct xParEmitterAsset * a /* r29 */, const struct xEnt * ent /* r30 */) {
    // Local variables
    const struct xPEEntBound & region; // r0
    const struct xMat4x3 & mat; // r31
    struct xVec3 offset; // r1+0x14
}

// Range: 0x80098EC8 -> 0x80099374
static struct xVec3 get_random_offset(const struct xBound & bound /* r31 */, float expand /* f30 */, unsigned int vtype /* r0 */) {
    // Local variables
    struct xVec3 offset; // r1+0x2C
    struct xVec3 expandVec; // r1+0x20
    float ang; // f28
    float uz; // f27
    float r; // f0
    float rr; // f0
    ...
    float uz; // f28
    float r; // f29
    unsigned int pick; // r5
    unsigned int side; // r0
    struct xVec3 scale; // r1+0x14
    unsigned int pick; // r5
    unsigned int side; // r0
    struct xVec3 scale; // r1+0x8
}
