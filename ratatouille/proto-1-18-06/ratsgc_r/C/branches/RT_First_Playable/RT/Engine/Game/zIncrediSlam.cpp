/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zIncrediSlam.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8018EE54 -> 0x801910C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int isStartOnKey; // size: 0x4, address: 0x80C08840
float shake_time; // size: 0x4, address: 0x80C02100
float shake_mag; // size: 0x4, address: 0x80C02104
float shake_cycle_max; // size: 0x4, address: 0x80C02108
float shake_rot_mag; // size: 0x4, address: 0x80C0210C
float shake_radius; // size: 0x4, address: 0x80C08844
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1268zIncrediSlam_cpp */ {
    // Members
...
union /* @class$1413zIncrediSlam_cpp */ {
...
// total size: 0xC
struct /* @class$964zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zIncrediSlam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zIncrediSlam_cpp */ {
    // Members
...
// Range: 0x8018EE54 -> 0x8018EE88
void * zIncrediSlam::operator new(unsigned long size /* r31 */) {
    // Local variables
    class zIncrediSlamMgr * mgr; // r0
}

unsigned int tweakSlamWaveTextureID; // size: 0x4, address: 0x80C08848
unsigned int tweakSlamParticleTextureID; // size: 0x4, address: 0x80C0884C
// total size: 0x34
struct RwRaster {
    // Members
...
// total size: 0x50
struct /* @class$2286zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x44
struct /* @class$2287zIncrediSlam_cpp */ {
    // Members
...
// Range: 0x8018F1A4 -> 0x8018F250
// this: r31
void zIncrediSlam::Update(float dt /* f31 */) {}

// Range: 0x8018F250 -> 0x8018F260
// this: r0
unsigned char zIncrediSlam::Cull() {}

// Range: 0x8018F260 -> 0x8018F298
// this: r0
...
static struct curve_node footstep_curve[3]; // size: 0x54, address: 0x803E3238
// Range: 0x8018F298 -> 0x8018F340
// this: r31
...
// Range: 0x8018F340 -> 0x8018FA20
void zIncrediSlam::AddTweaks(const char * prefix /* r30 */, struct config * slam /* r31 */) {
    // References
    // -> float shake_radius;
    // -> float shake_rot_mag;
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02110
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1497zIncrediSlam_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8018FB8C -> 0x8018FB90
void zIncrediSlam::GenerateParticle() {}

// Range: 0x8018FB90 -> 0x8018FCE8
// this: r28
void zIncrediSlam::UpdateParticles(float dt /* f31 */) {
    // Local variables
    int p; // r30
    struct WaveParticle & particle; // r29
    float fadeTime; // f0
}
...
static float cast_dist; // size: 0x4, address: 0x80C08850
static signed char init; // size: 0x1, address: 0x80C08854
static float upbias; // size: 0x4, address: 0x80C08858
static signed char init; // size: 0x1, address: 0x80C0885C
// total size: 0x1C
...
// total size: 0xC
struct /* @class$1727zIncrediSlam_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x8018FCE8 -> 0x80190058
// this: r29
void zIncrediSlam::Start(const struct xMat4x3 & _startMat /* r30 */, float _hitRadius /* f0 */, signed short _hitPoints /* r0 */, struct config * new_cfg /* r0 */, struct xEnt * _owner /* r0 */, unsigned char drawDecal /* r28 */, enum zHitSource _hitSource /* r0 */) {
    // Local variables
    struct xScene & scene; // r31
    struct zCommonPlayer * player; // r30
    struct xRay3 ray; // r1+0x50
    struct xCollis coll; // r1+0x74
    struct xMat4x3 mat; // r1+0x10
    float rot; // f31
    float cr; // f31
    float cs; // f30
    struct xSurface * surface; // r0
    const struct zSurfaceProps * sp; // r3
...
// total size: 0x4
struct /* @class$2267zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2210zIncrediSlam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2212zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2209zIncrediSlam_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2214zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2062zIncrediSlam_cpp */ {
    // Static members
...
// Range: 0x80190058 -> 0x80190794
// this: r27
void zIncrediSlam::UpdateWaves(float dt /* f31 */) {
    // Local variables
    float lengthA; // f22
    float lengthB; // f21
    float dLength; // f20
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02120
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x80190A90 -> 0x80190AD4
void zIncrediSlam::SetVert(struct RxObjSpace3DVertex & vert /* r0 */, const struct xVec3 & loc /* r0 */, float u /* f0 */, float v /* f0 */, struct xColor_tag & color /* r0 */) {}

// Range: 0x80190AD4 -> 0x80190B24
// this: r7
...
// Range: 0x80190B24 -> 0x80190B28
void zIncrediSlam::BeginRender() {}

// Range: 0x80190B28 -> 0x80190B2C
void zIncrediSlam::EndRender() {}

class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4, address: 0x80C08860
// total size: 0xC
...
// Range: 0x80190B80 -> 0x80190B98
void zIncrediSlamMgr::Remove() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x80190B98 -> 0x80190BE4
...
// Range: 0x80190BE4 -> 0x80190BF0
// this: r0
void zIncrediSlam::SetInactive() {}

// Range: 0x80190BF0 -> 0x80190BFC
// this: r0
zIncrediSlamMgr::zIncrediSlamMgr() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0212C
// Range: 0x80190BFC -> 0x80190DCC
// this: r30
class zIncrediSlam * zIncrediSlamMgr::GetMem(unsigned long size /* r31 */) {
    // Local variables
    class zIncrediSlam * mem; // r29
    class zIncrediSlam * prev; // r3
    class zIncrediSlam * mem; // r3
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C02134
struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80A84818
// Range: 0x80190DCC -> 0x80190EEC
void zIncrediSlamMgr::Update(float dt /* f31 */) {
    // Local variables
    struct zPlayer * player; // r0
    int port; // r0
...
// Range: 0x80190EEC -> 0x80190F3C
// this: r0
void zIncrediSlamMgr::_Update(float dt /* f31 */) {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31
}

// Range: 0x80190F3C -> 0x80190F68
void zIncrediSlamMgr::Render() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x80190F68 -> 0x80190FA8
// this: r0
...
// Range: 0x80190FA8 -> 0x8019101C
unsigned char zIncrediSlamMgr::StartSlam(const struct xMat4x3 & startMat /* r30 */, float hitRadius /* f0 */, signed short hitPoints /* r31 */, struct config * cfg /* r12 */, struct xEnt * owner /* r11 */, unsigned char drawDecal /* r10 */, enum zHitSource hitSource /* r9 */) {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x8019101C -> 0x801910B8
// this: r0
unsigned char zIncrediSlamMgr::_StartSlam(const struct xMat4x3 & startMat /* r25 */, float hitRadius /* f31 */, signed short hitPoints /* r26 */, struct config * cfg /* r27 */, struct xEnt * owner /* r28 */, unsigned char drawDecal /* r29 */, enum zHitSource hitSource /* r30 */) {
    // Local variables
    class zIncrediSlam * incrediSlam; // r31
}

// Range: 0x801910B8 -> 0x801910C0
// this: r3
