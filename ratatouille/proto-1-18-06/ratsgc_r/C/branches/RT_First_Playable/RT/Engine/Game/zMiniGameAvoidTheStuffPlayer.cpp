/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameAvoidTheStuffPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B5FEC -> 0x802B679C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80C06590
// total size: 0xC
...
// Range: 0x802B642C -> 0x802B644C
// this: r0
void zMiniGameAvoidTheStuffPlayer::Init(struct xEntAsset * asset /* r0 */) {}
...
// total size: 0x10
struct /* @class$1484zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1097zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
union /* @class$1236zMiniGameAvoidTheStuffPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1235zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zMiniGameAvoidTheStuffPlayer_cpp */ {
    // Static members
...
// Range: 0x802B64E8 -> 0x802B65C4
// this: r31
void zMiniGameAvoidTheStuffPlayer::UpdateOrientation(float dt /* f31 */) {
    // Local variables
...
// Range: 0x802B65C4 -> 0x802B6608
// this: r31
void zMiniGameAvoidTheStuffPlayer::Update(float dt /* f31 */) {}

// Range: 0x802B6608 -> 0x802B6628
// this: r0
void zMiniGameAvoidTheStuffPlayer::EndUpdate(float dt /* f0 */) {}
...
// Range: 0x802B667C -> 0x802B66BC
// this: r31
void zMiniGameAvoidTheStuffPlayer::SceneSetup() {}

// Range: 0x802B66BC -> 0x802B66DC
// this: r0
void zMiniGameAvoidTheStuffPlayer::Reset() {}

// Range: 0x802B66DC -> 0x802B66FC
// this: r0
void zMiniGameAvoidTheStuffPlayer::Exit() {}

// Range: 0x802B66FC -> 0x802B6760
// this: r31
void zMiniGameAvoidTheStuffPlayer::InitActions() {}

// total size: 0x12C
struct {} zMiniGameAvoidTheStuffPlayer::__vtable; // size: 0x12C, address: 0x804486B8
// total size: 0x13B0
...
// total size: 0x54
struct {} zAvoidTheStuffPlayerMove::__vtable; // size: 0x54, address: 0x804487E4
// total size: 0xC
