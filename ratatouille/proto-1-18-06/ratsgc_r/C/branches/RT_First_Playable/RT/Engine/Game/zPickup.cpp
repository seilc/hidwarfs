/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPickup.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801BDE20 -> 0x801BFDB0
*/
// total size: 0xC
struct RwV3d {
    // Members
...
float kFlyToInterfaceTime; // size: 0x4, address: 0x80C02C08
float kFlyToInterfaceX; // size: 0x4, address: 0x80C02C0C
float kFlyToInterfaceY; // size: 0x4, address: 0x80C02C10
float kFlyToInterfaceZ; // size: 0x4, address: 0x80C02C14
float kFlyToInterfaceScale; // size: 0x4, address: 0x80C02C18
float SpawnDelayTime; // size: 0x4, address: 0x80C02C1C
float SPIRAL_DECAY_TIME; // size: 0x4, address: 0x80C02C20
float SPIRAL_DECAY_STEP; // size: 0x4, address: 0x80C02C24
// total size: 0x30
struct xMat3x3 {
    // Members
...
static struct xMat3x3 sPickupOrientation; // size: 0x30, address: 0x8043DC20
float PICKUP_FADE_DIST; // size: 0x4, address: 0x80C02C28
float PICKUP_CULL_DIST; // size: 0x4, address: 0x80C02C2C
float PICKUP_FADE_DIST_SQR; // size: 0x4, address: 0x80C08A30
float PICKUP_CULL_DIST_SQR; // size: 0x4, address: 0x80C08A34
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct Table * table; // size: 0x4, address: 0x80C08A38
class zPickup * extras; // size: 0x4, address: 0x80C08A3C
struct InstanceAsset * extra_assets; // size: 0x4, address: 0x80C08A40
int extras_used; // size: 0x4, address: 0x80C08A44
int extras_max; // size: 0x4, address: 0x80C08A48
struct zSparkEmitterAsset * sparkEmitterAsset; // size: 0x4, address: 0x80C08A4C
float lastdt; // size: 0x4, address: 0x80C08A50
struct xFXRibbon ribbon[4]; // size: 0x50, address: 0x80BB6830
float spiralDecay; // size: 0x4, address: 0x80C08A54
static struct curve_node ribbon_curve[2]; // size: 0x18, address: 0x80C0CE60
// total size: 0x10
struct glintInfo {
    // Members
...
static struct zSparkEmitterAsset _sparkEmitterAsset; // size: 0x94, address: 0x80BB6880
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02C30
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801BE0C0 -> 0x801BE0E0
void zPickup::ResetAll() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02C3C
// Range: 0x801BE0E0 -> 0x801BE260
void zPickup::InitDynamic(struct xBase & obj /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C08A58
static signed char init; // size: 0x1, address: 0x80C08A59
static unsigned char already_asserted; // size: 0x1, address: 0x80C08A5A
static signed char init; // size: 0x1, address: 0x80C08A5B
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static struct config_type cfg; // size: 0x20, address: 0x80BB6914
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C02C48
enum xCamCoordType {
...
// Range: 0x801BE260 -> 0x801BE8C8
// this: r31
unsigned char zPickup::Init(struct InstanceAsset & asset_ /* r28 */) {
    // Local variables
    unsigned int tmpSize; // r1+0x8
    struct RpAtomic * modelData; // r0
    unsigned int i; // r28
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02C50
// Range: 0x801BE960 -> 0x801BEA5C
void zPickupEventCB(struct xBase * from /* r26 */, struct xBase * to /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x801BEA5C -> 0x801BEB2C
// this: r3
void zPickup::EventCB(struct xBase * to /* r5 */, unsigned int toEvent /* r0 */) {}

static unsigned int SCENEFLAGS_GALLERY; // size: 0x4, address: 0x80C0CE8C
// Range: 0x801BEB2C -> 0x801BEC0C
void zPickup::TryBeGrabbedAll(struct zPlayer * currentPlayer /* r28 */) {
    // Local variables
...
// Range: 0x801BEC0C -> 0x801BEC44
class zPickup * zPickup::PickupsEnd() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801BEC44 -> 0x801BEC58
class zPickup * zPickup::PickupsBegin() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x801BEC58 -> 0x801BECB8
// this: r0
unsigned char zPickup::IsNearPlayer(struct zPlayer * player /* r31 */, float range /* f31 */) const {
    // Local variables
    float playerDist2; // f0
}
...
// total size: 0x1
struct /* @class$1006zPickup_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1007zPickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1008zPickup_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1009zPickup_cpp */ {
    // Members
...
// Range: 0x801BECB8 -> 0x801BED1C
// this: r0
unsigned char zPickup::CanGalleryPickupBeUsed(struct zPlayer * player /* r4 */) const {}

// Range: 0x801BED1C -> 0x801BEDC8
// this: r31
void zPickup::BeUsed() {}

// Range: 0x801BEDC8 -> 0x801BEE44
// this: r31
...
// Range: 0x801BEE44 -> 0x801BEFBC
// this: r31
void zPickup::Update(float dt /* f30 */) {
    // Local variables
    float grabDist; // f31
    struct xVec3 playerPos; // r1+0x14
    struct xVec3 toPlayer; // r1+0x8
    float distToPlayer; // f0
    float timeToPlayer; // f2
    float speed; // f31
...
// Range: 0x801BEFBC -> 0x801BEFC0
void zPickup::UpdateFX() {}

// Range: 0x801BEFC0 -> 0x801BF048
...
// Range: 0x801BF190 -> 0x801BF508
// this: r31
void zPickup::Render() {
    // Local variables
    float distanceFadeAlpha; // r1+0x10
    float u; // f31
    struct xVec3 effect_scale; // r1+0x20
    struct xVec3 delta; // r1+0x14
    float ds2; // f1
...
// Range: 0x801BF508 -> 0x801BF5E4
unsigned char zPickup::DistanceCull(struct xVec3 & pos /* r30 */, float & distanceFadeAlpha /* r31 */) {
    // Local variables
...
// Range: 0x801BF5E4 -> 0x801BF680
void zPickup::UpdateFlyToInterfaceAll(float dt /* f31 */) {
    // Local variables
    class zPickup * it; // r31
    class zPickup * end; // r30
    int i; // r29
...
// Range: 0x801BF680 -> 0x801BF844
// this: r31
void zPickup::FlyToInterface(float dt /* f30 */) {
    // Local variables
...
// Range: 0x801BF910 -> 0x801BF94C
struct TableEntry * zPickup::FindTableEntry(unsigned int typeHash /* r0 */) {
    // Local variables
    unsigned int i; // r0
    struct TableEntry * entry; // r5
...
// total size: 0x4
struct /* @class$2221zPickup_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2222zPickup_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C02C60
// Range: 0x801BF94C -> 0x801BFA3C
// this: r31
...
// Range: 0x801BFAD0 -> 0x801BFB6C
void zPickup::ResetExtras() {
    // Local variables
    class zPickup * it; // r30
