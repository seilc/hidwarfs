/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomConditionallyDisabled.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80270B84 -> 0x80270D1C
*/
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C055F0
// total size: 0x54
struct {} zUICustomConditionallyDisabled::__vtable; // size: 0x54, address: 0x80443860
// total size: 0x18
...
class zUICustomConditionallyDisabled : public zUICustom {
    // Functions
    zUICustomConditionallyDisabled(class zUI * ui);

    void PreUpdate();

    unsigned char PreAutoMenu();

    unsigned char PreRender();

    // Members
    struct _zConditional * m_pCondition; // offset 0x8, size 0x4
    unsigned char m_bCondition; // offset 0xC, size 0x1
};
// Range: 0x80270B84 -> 0x80270C8C
// this: r30
zUICustomConditionallyDisabled::zUICustomConditionallyDisabled(class zUI * ui /* r31 */) {
    // Local variables
    struct xBase * pCond; // r0

    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomConditionallyDisabled::__vtable;
}
...
// Range: 0x80270C8C -> 0x80270D0C
// this: r31
void zUICustomConditionallyDisabled::PreUpdate() {
    // Local variables
    unsigned char new_condition; // r0
}

// Range: 0x80270D0C -> 0x80270D14
// this: r3
unsigned char zUICustomConditionallyDisabled::PreAutoMenu() {}

// Range: 0x80270D14 -> 0x80270D1C
// this: r3
