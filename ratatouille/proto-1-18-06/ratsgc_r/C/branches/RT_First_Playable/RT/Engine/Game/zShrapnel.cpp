/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zShrapnel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801660A4 -> 0x8016AA1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char GOO_DRAW_BOUNDING_SPHERE; // size: 0x1, address: 0x80C084E8
static float GOO_SLIDE_Y_THRESHOLD; // size: 0x4, address: 0x80C01608
static float GOO_DECAL_EMIT_TIME; // size: 0x4, address: 0x80C0160C
static float GOO_DECAL_SCALE; // size: 0x4, address: 0x80C01610
static float GOO_STICK_TIME; // size: 0x4, address: 0x80C01614
static float GOO_FADE_TIME; // size: 0x4, address: 0x80C01618
static float GOO_FADE_DELAY; // size: 0x4, address: 0x80C0161C
static float GOO_SLIDE_ACCEL; // size: 0x4, address: 0x80C01620
static float GOO_MAX_SLIDE_SPEED; // size: 0x4, address: 0x80C01624
static float GOO_FLY_GRAVITY; // size: 0x4, address: 0x80C01628
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xMat4x3 tmpMat; // size: 0x40, address: 0x80BA0590
static int sNumActiveFrags; // size: 0x4, address: 0x80C084EC
static struct zFrag sFragPool[150]; // size: 0x9150, address: 0x80BA05D0
// total size: 0x54
struct zFragGroup {
    // Members
...
// total size: 0x54
struct /* @class$1785zShrapnel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1021zShrapnel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1022zShrapnel_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1023zShrapnel_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1024zShrapnel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025zShrapnel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026zShrapnel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027zShrapnel_cpp */ {
    // Members
...
static struct zFrag sFirstFreeFrag; // size: 0xF8, address: 0x80BA9720
static struct zFrag sFirstActiveFrag; // size: 0xF8, address: 0x80BA9818
static struct zFrag sProjectileList; // size: 0xF8, address: 0x80BA9910
static struct zFrag sLightningList; // size: 0xF8, address: 0x80BA9A08
static struct zFrag sParticleList; // size: 0xF8, address: 0x80BA9B00
static struct zFrag sSoundList; // size: 0xF8, address: 0x80BA9BF8
static struct zFrag sExplosionList; // size: 0xF8, address: 0x80BA9CF0
static struct zFrag sDistortionList; // size: 0xF8, address: 0x80BA9DE8
static struct zFrag sGooList; // size: 0xF8, address: 0x80BA9EE0
float cFragThrottleCeiling; // size: 0x4, address: 0x80C0162C
float cFragThrottleThresholdPercent; // size: 0x4, address: 0x80C01630
// total size: 0x68
...
static struct _tagLightningAdd sLightningAddInfo; // size: 0x68, address: 0x80BA9FD8
// total size: 0xC
...
static struct zShrapnelInitTable sShrapnelTable[1]; // size: 0xC, address: 0x80C01634
// Range: 0x801660A4 -> 0x8016617C
...
// Range: 0x8016617C -> 0x80166238
unsigned char zFrag_Throttler_Permission(enum zFragType type /* r0 */) {
    // Local variables
    int cFragThrottleThreshold; // r5
    float range; // f1
    float t; // f0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01640
// Range: 0x80166238 -> 0x801663FC
struct zFrag * zFrag_Alloc(enum zFragType type /* r31 */, unsigned char useThrottling /* r29 */) {
    // Local variables
    struct zFrag * result; // r3
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0164C
// Range: 0x801663FC -> 0x80166564
...
// Range: 0x80166568 -> 0x80166624
void zShrapnel_GameInit() {
    // Local variables
    struct zShrapnelInitTable * curr; // r30
...
static struct smoke_config smoke_config; // size: 0x38, address: 0x80BAA040
struct smoke_config default_config; // size: 0x38, address: 0x80BB6718
// Range: 0x801666D0 -> 0x80166778
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043C448
// Range: 0x80166778 -> 0x80166814
void zShrapnel_SmokeSceneInit(struct zFragSmokeAsset * asset /* r31 */) {
    // References
    // -> static char __FUNCTION__[25];
}

// Range: 0x80166814 -> 0x801668A4
void zShrapnel_GooSceneInit(struct zFragGooAsset * asset /* r31 */) {
    // References
    // -> static unsigned char GOO_DRAW_BOUNDING_SPHERE;
}

// Range: 0x801668A4 -> 0x801668F0
void zShrapnel_SetShrapnelAssetInitCB(struct zShrapnelAsset * sasset /* r0 */) {
    // Local variables
    struct zShrapnelInitTable * curr; // r6

    // References
    // -> static struct zShrapnelInitTable sShrapnelTable[1];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80C01658
// Range: 0x801668F0 -> 0x80166C50
void zShrapnel_SceneInit() {
    // Local variables
    int i; // r5
    int numShrapnel; // r0
    int j; // r27
    struct zShrapnelAsset * sa; // r0
    struct zFragAsset * fa; // r26
    struct zFragProjectileAsset * projAss; // r0
    struct zFragParticleAsset * partAss; // r0
    struct zFragSmokeAsset * ass; // r0
    struct zFragGooAsset * ass; // r0
    struct zFragShrapnelAsset * shrapAss; // r0
...
// Range: 0x80166C50 -> 0x80166DC4
void zShrapnel_Update(float dt /* f30 */) {
    // Local variables
    struct zFrag * curr; // r3
    struct zFrag * next; // r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0166C
// Range: 0x80166DC4 -> 0x80166E70
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C0167C
// total size: 0x8
...
// Range: 0x80166EC8 -> 0x8016718C
void zShrapnel_DefaultInit(struct zShrapnelAsset * shrap /* r19 */, struct xModelInstance * parent /* r20 */, struct xVec3 * initOffset /* r21 */, struct xVec3 * initVel /* r22 */, void (* cb)(struct zFrag *, struct zFragAsset *) /* r23 */) {
    // Local variables
    struct zShrapnelParentList * plist; // r28
    struct zFrag * frag; // r27
    struct zFragAsset * fasset; // r26
    int i; // r25
    int j; // r24
    int k; // r5
...
static struct zFragProjectileAsset sCinProj; // size: 0x158, address: 0x80BAA078
static struct RpAtomic * sCinModel; // size: 0x4, address: 0x80C084F0
// Range: 0x8016718C -> 0x80167260
void zShrapnel_GameInit_Cinematic() {
    // References
    // -> static struct zFragProjectileAsset sCinProj;
}

// Range: 0x80167260 -> 0x80167298
void zShrapnel_SceneInit_Cinematic() {
    // Local variables
    const char * dummyModel; // r3

    // References
    // -> static struct RpAtomic * sCinModel;
}

// Range: 0x80167298 -> 0x801672E0
void zFragLoc_Setup(struct zFragLocation * loc /* r5 */, struct xModelInstance * parent /* r4 */) {}

// Range: 0x801672E0 -> 0x801673C4
...
// Range: 0x801673C4 -> 0x801675B8
void zFragLoc_InitMat(struct zFragLocation * loc /* r28 */, struct xMat4x3 * mat /* r29 */, struct xModelInstance * parent /* r30 */, unsigned int flags /* r31 */) {
    // Local variables
    int index; // r3
...
// Range: 0x801675B8 -> 0x80167728
void zFragLoc_InitVec(struct zFragLocation * loc /* r29 */, struct xVec3 * vec /* r30 */, struct xModelInstance * parent /* r31 */) {
    // Local variables
...
// Range: 0x80167728 -> 0x80167834
void zFragLoc_InitDir(struct zFragLocation * loc /* r29 */, struct xVec3 * vec /* r30 */, struct xModelInstance * parent /* r31 */) {
    // Local variables
    int index; // r3
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C084F4
static signed char init; // size: 0x1, address: 0x80C084F5
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C01694
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$2009zShrapnel_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80167834 -> 0x801683F4
unsigned char zFrag_DefaultInit(struct zFrag * frag /* r30 */, struct zFragAsset * fasset /* r31 */) {
    // Local variables
    struct zFragProjectileAsset * passet; // r31
    struct RpAtomic * m; // r29
    struct zFragProjectile * proj; // r0
    struct zFragLightningAsset * lasset; // r0
    struct zFragParticleAsset * prasset; // r0
    struct zFragSoundAsset * sasset; // r0
    struct zFragExplosionAsset * easset; // r0
    struct zFragLightAsset * lasset; // r0
    struct zFragSmoke & smokeFrag; // r0
    struct zFragSmokeAsset * prasset; // r0
    struct zFragGooAsset * gasset; // r0
    struct zFragGoo * goo; // r0
    struct RpAtomic * m1; // r29
    struct RpAtomic * m2; // r29
...
// total size: 0x890
struct /* @class$2248zShrapnel_cpp */ {
    // Static members
...
// Range: 0x801683F4 -> 0x801684A4
void zFrag_DefaultParticleUpdate(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zFragParticleAsset * passet; // r31

    // References
    // -> static struct zFrag sParticleList;
}

// Range: 0x801684A4 -> 0x801685A4
void zFrag_ParticleManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFrag * next; // r30
    struct zFragParticleAsset * passet; // r29

    // References
    // -> static struct zFrag sParticleList;
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043C50C
// total size: 0xC
struct /* @class$1276zShrapnel_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x801685A4 -> 0x80168758
void zFrag_ProjectileCollData(struct zFrag * frag /* r31 */) {
    // Local variables
    struct zFragProjectile * proj; // r0
    float radius; // f31
...
char __FUNCTION__$localstatic1$zFrag_ProjectileSetupPath__FP5zFragP20zFragProjectileAsset[26]; // size: 0x1A, address: 0x8043C528
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x80168758 -> 0x80168D8C
void zFrag_ProjectileSetupPath(struct zFrag * frag /* r30 */, struct zFragProjectileAsset * passet /* r31 */) {
    // Local variables
    struct zFragProjectile * proj; // r0
...
// Range: 0x80168D8C -> 0x80168E68
void zFrag_DefaultProjectileUpdate(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zFragProjectileAsset * passet; // r31
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C016A8
// Range: 0x80168E68 -> 0x80168F40
void zFrag_DeleteProjectile(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zShrapnelAsset * child; // r31
...
// Range: 0x80168F40 -> 0x80169348
void zFrag_ProjectileManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFragProjectile * proj; // r0
    struct zFrag * next; // r30
...
static char __FUNCTION__[29]; // size: 0x1D, address: 0x8043C544
// Range: 0x80169348 -> 0x80169494
void zFrag_DefaultLightningUpdate(struct zFrag * frag /* r31 */) {
    // Local variables
    struct zFragLightningAsset * lasset; // r29
...
// Range: 0x80169494 -> 0x801695E4
void zFrag_LightningManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFragLightning * ligh; // r0
...
// Range: 0x801695E4 -> 0x801696AC
void zFrag_DefaultSoundUpdate(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zFragSound * sound; // r0
    struct zFragSoundAsset * sasset; // r31
...
// Range: 0x801696AC -> 0x80169770
void zFrag_SoundManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFragSound * sound; // r0
    struct zFrag * next; // r30
...
// Range: 0x8016987C -> 0x80169954
static void zFrag_ExplosionManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFrag * next; // r30
    struct zFragExplosion * f; // r0
    struct zFragExplosionAsset * a; // r3
    struct xVec3 loc; // r1+0x8
...
// Range: 0x80169954 -> 0x80169A70
static void zFrag_DefaultDistortionUpdate(struct zFrag * frag /* r30 */) {
    // Local variables
    struct zFragDistortion * f; // r0
...
// Range: 0x80169A70 -> 0x80169B3C
static void zFrag_DefaultFireUpdate(struct zFrag * frag /* r29 */) {
    // Local variables
    struct zFragFireAsset * a; // r30
    struct spawn_data spawn; // r1+0x8
}

// Range: 0x80169B3C -> 0x80169BDC
static struct xLight * zFrag_InitLight(struct zFragLightInfo & lightInfo /* r30 */, float lifetime /* f0 */) {
    // Local variables
    struct xLight * tempLight; // r31
}

// Range: 0x80169BDC -> 0x80169C0C
static void zFrag_FreeLight(struct xLight * light /* r0 */) {}
...
// Range: 0x80169C0C -> 0x80169CC8
static void zFrag_UpdateLightIntensity(struct xLight * light /* r3 */, const struct zFragLightInfo & info /* r0 */, float lifetime /* f0 */) {
    // Local variables
    struct _xFColor col; // r1+0x8
    float percentage; // f3
    float percentage; // f3
}

// Range: 0x80169CC8 -> 0x80169D74
static void zFrag_DefaultLightUpdate(struct zFrag * frag /* r30 */, float dt /* f31 */) {
    // Local variables
    struct zFragLight * lf; // r0
    struct zFragLightAsset * a; // r31
    struct xVec3 loc; // r1+0x8
}

// Range: 0x80169D74 -> 0x80169E98
static void zFrag_DistortionManager(float dt /* f30 */) {
    // Local variables
    struct zFrag * frag; // r31
    struct zFrag * next; // r30
    struct zFragDistortion * f; // r0
    struct zFragDistortionAsset * a; // r29

    // References
    // -> static struct zFrag sDistortionList;
}

// Range: 0x80169E98 -> 0x80169F7C
void zFrag_DefaultSmokeUpdate(struct zFrag * frag /* r30 */, float dt /* f31 */) {
    // Local variables
    struct zFragSmoke & smokeFrag; // r0
    struct zFragSmokeAsset * passet; // r31
    int emitAmount; // r5
}

// Range: 0x80169F7C -> 0x80169FDC
static void zFrag_DefaultGooUpdate(struct zFrag * frag /* r0 */) {
    // References
    // -> static struct zFrag sGooList;
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C016C0
struct xVec3 g_NZ3; // size: 0xC, address: 0x80C0ADDC
// total size: 0xCC
struct xSweptSphere {
    // Members
...
// Range: 0x80169FDC -> 0x8016A770
static void zFrag_GooManager(float dt /* f29 */) {
    // Local variables
    struct zFrag * frag; // r26
    struct zFrag * next; // r25
    struct zFragGoo * goo; // r0
    struct xModelInstance * model; // r27
...
// Range: 0x8016A770 -> 0x8016A7D4
void zFrag_DefaultShrapnelUpdate(struct zFrag * frag /* r31 */) {
    // Local variables
    struct zShrapnelAsset * sasset; // r3
}

// Range: 0x8016A7D4 -> 0x8016A930
...
// Range: 0x8016A930 -> 0x8016AA1C
void zFrag_GooRenderer() {
    // Local variables
    struct zFrag * frag; // r31
    struct zFragGoo * goo; // r0
    struct xModelInstance * currModel; // r30
