/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zVolume.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017E8D0 -> 0x8017F160
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zVolume * vols; // size: 0x4, address: 0x80C086B8
static unsigned short nvols; // size: 0x2, address: 0x80C086BC
// Range: 0x8017E8D0 -> 0x8017E908
static void zVolumeInit(class zVolume * vol /* r31 */, struct xVolumeAsset * asset /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01D28
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8017E908 -> 0x8017EA58
void zVolumeInit() {
    // Local variables
    unsigned short i; // r30
    unsigned int size; // r1+0x8
    struct xVolumeAsset * asset; // r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C01D34
// Range: 0x8017EA58 -> 0x8017EB08
void zVolumeSetup() {
    // Local variables
    unsigned int i; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C01D44
// Range: 0x8017EB08 -> 0x8017EC34
...
class zVolume * gOccludeList[10]; // size: 0x28, address: 0x80BABE00
int gOccludeCalcCount; // size: 0x4, address: 0x80C086C4
// total size: 0x10
struct xVec4 {
    // Members
    float x; // offset 0x0, size 0x4
...
struct PreCalcOcclude gOccludeCalc[10]; // size: 0x320, address: 0x80BABE28
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C01D58
// Range: 0x8017EF60 -> 0x8017F160
void zVolumeEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r30 */) {
    // Local variables
