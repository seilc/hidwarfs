/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iMorph.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800E4BA4 -> 0x800E5EE8
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct RpGeometry * s_geom; // size: 0x4, address: 0x80C079B8
static struct RpMorphTarget * s_tgt; // size: 0x4, address: 0x80C079BC
static float * s_alloc; // size: 0x4, address: 0x80C079C0
static float * s_vTemp; // size: 0x4, address: 0x80C079C4
static float * s_nTemp; // size: 0x4, address: 0x80C079C8
static int s_numV; // size: 0x4, address: 0x80C079CC
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFF380
// total size: 0x14
...
// Range: 0x800E4BA4 -> 0x800E53D0
static void MorphCommon(struct RpAtomic * model /* r25 */, struct RwMatrixTag * mat /* r26 */, signed short * * v_array /* r20 */, signed short * weight /* r0 */, unsigned int normals /* r27 */, float scale /* f31 */, int dorender /* r22 */) {
    // Local variables
    unsigned int i; // r0
    unsigned int a; // r31
    signed short wa[4]; // r1+0x8
    signed short * va[4]; // r1+0x10
    int wsum; // r30
    struct RwV3d * vold; // r19
    struct RwV3d * nold; // r29
    int lockMode; // r21
    void * temp_scratch; // r28
    struct RpUserDataArray * usr; // r0
    struct DirtyMorph * dm; // r7
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF38C
// Range: 0x800E53D0 -> 0x800E54B0
void iMorphOptimize(struct RpAtomic * model /* r0 */, int normals /* r0 */) {
    // Local variables
...
// Range: 0x800E54B0 -> 0x800E54EC
void iMorphRender(struct RpAtomic * model /* r0 */, struct RwMatrixTag * mat /* r0 */, signed short * * v_array /* r0 */, signed short * weight /* r0 */, unsigned int normals /* r0 */, float scale /* f0 */) {
    // References
    // -> static float * s_alloc;
}

// Range: 0x800E54EC -> 0x800E5698
void FastS16unpack(float * dest /* r3 */, signed short * v /* r4 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r6
}

// Range: 0x800E5698 -> 0x800E5990
void FastS16weight2(float * dest /* r3 */, signed short * * v_array /* r0 */, signed short * weight /* r0 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r8
    signed short * v0; // r9
    signed short * v1; // r10
...
// Range: 0x800E5990 -> 0x800E5EE8
void FastS16weight4(float * dest /* r3 */, signed short * * v_array /* r0 */, signed short * weight /* r0 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r10
    signed short * v0; // r11
    signed short * v1; // r12
