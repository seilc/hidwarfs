/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zVentType.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021115C -> 0x80211384
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1127zVentType_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1265zVentType_cpp */ {
    // Members
...
// Range: 0x8021115C -> 0x80211210
// this: r30
void zVentType::load(const struct asset_type & a /* r31 */) {
    // Local variables
    struct xBase * obj; // r0
    struct xBase * obj; // r0
    struct xBase * obj; // r0
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04070
// Range: 0x80211210 -> 0x80211384
void zVentType::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
