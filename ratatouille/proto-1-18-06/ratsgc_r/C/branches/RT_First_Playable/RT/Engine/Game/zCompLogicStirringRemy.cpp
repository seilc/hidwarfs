/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicStirringRemy.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029CD78 -> 0x8029D900
*/
// total size: 0x1
...
static class zCompSteeringBasicParams sSteeringParams; // size: 0x70, address: 0x80BD2068
float sRemySpeed; // size: 0x4, address: 0x80C060B8
float sRemyAnimSpeed; // size: 0x4, address: 0x80C060BC
float sRemyWeight; // size: 0x4, address: 0x80C060C0
float sArriveDistance2; // size: 0x4, address: 0x80C060C4
static unsigned char gotPush; // size: 0x1, address: 0x80C095B0
static unsigned char gotRun; // size: 0x1, address: 0x80C095B1
static unsigned char arrived; // size: 0x1, address: 0x80C095B2
static int runIdx; // size: 0x4, address: 0x80C095B4
static int curIdx; // size: 0x4, address: 0x80C060C8
// total size: 0x0
class zMovePoint {};
static class zMovePoint * mp[100]; // size: 0x190, address: 0x80BD20D8
static int mp_count; // size: 0x4, address: 0x80C095B8
static unsigned int replyToID; // size: 0x4, address: 0x80C095BC
// total size: 0x8
...
static struct zCompStateMachineTable gStirringRemyStateMachineTable[4]; // size: 0x20, address: 0x804473D0
// total size: 0x30
struct {} zStirringRemyIdle::__vtable; // size: 0x30, address: 0x804474A4
// total size: 0x14
...
// Range: 0x8029CDB4 -> 0x8029CDF0
void zStirringRemyIdle::Update(class zNPCBase * owner /* r4 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1257zCompLogicStirringRemy_cpp */ {
    // Members
...
union /* @class$1397zCompLogicStirringRemy_cpp */ {
...
// total size: 0xC
struct /* @class$1395zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1118zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1119zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1120zCompLogicStirringRemy_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1121zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1122zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1123zCompLogicStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1124zCompLogicStirringRemy_cpp */ {
    // Members
...
// Range: 0x8029CDF0 -> 0x8029CE1C
// this: r0
void zStirringRemyIdle::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x8029CE1C -> 0x8029CE64
void zStirringRemyIdle::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x30
struct {} zStirringRemyRun::__vtable; // size: 0x30, address: 0x80447474
// total size: 0x28
...
// Range: 0x8029CED8 -> 0x8029D048
// this: r31
void zStirringRemyRun::Update(class zNPCBase * owner /* r29 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C060CC
// Range: 0x8029D048 -> 0x8029D100
// this: r30
void zStirringRemyRun::Enter(class zNPCBase * owner /* r31 */) {
    // References
    // -> static int curIdx;
    // -> static class zMovePoint * mp[100];
...
// Range: 0x8029D100 -> 0x8029D1C8
// this: r29
void zStirringRemyRun::Resume(class zNPCBase * owner /* r30 */) {
    // Local variables
...
// total size: 0x30
struct {} zStirringRemyPush::__vtable; // size: 0x30, address: 0x80447444
// total size: 0x14
...
// Range: 0x8029D204 -> 0x8029D208
void zStirringRemyPush::Update() {}

// Range: 0x8029D208 -> 0x8029D234
// this: r0
void zStirringRemyPush::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x8029D234 -> 0x8029D280
void zStirringRemyPush::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// Range: 0x8029D280 -> 0x8029D288
unsigned char zCompLogicStirringRemy::AreWeThereYet() {
    // References
    // -> static unsigned char arrived;
}

// Range: 0x8029D288 -> 0x8029D290
unsigned char zCompLogicStirringRemy::GotRunEvent() {
    // References
    // -> static unsigned char gotRun;
}

// Range: 0x8029D290 -> 0x8029D298
unsigned char zCompLogicStirringRemy::GotPushEvent() {
    // References
    // -> static unsigned char gotPush;
}

// Range: 0x8029D298 -> 0x8029D2E4
unsigned char zCompLogicStirringRemy::IsAnimationStopped(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xModelInstance * model; // r0
}

// Range: 0x8029D2E4 -> 0x8029D590
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C060D4
// Range: 0x8029D724 -> 0x8029D840
// this: r0
void zCompLogicStirringRemy::Attached() {
    // Local variables
    int i; // r29
    char name[32]; // r1+0x8
    class zMovePoint * zmp; // r0
...
// Range: 0x8029D840 -> 0x8029D900
unsigned char zCompLogicStirringRemy::SystemEvent(unsigned int to_event /* r0 */, const float * to_param /* r0 */, unsigned int to_param_widget_id /* r0 */) {
    // References
    // -> static unsigned int replyToID;
    // -> static unsigned char gotPush;
    // -> static unsigned char gotRun;
