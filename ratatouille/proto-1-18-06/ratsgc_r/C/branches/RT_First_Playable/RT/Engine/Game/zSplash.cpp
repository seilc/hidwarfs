/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSplash.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80189568 -> 0x8018E9F4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float emit_y_bias; // size: 0x4, address: 0x80C01FD0
static float zbias; // size: 0x4, address: 0x80C01FD4
static float alpha_coeff1; // size: 0x4, address: 0x80C01FD8
static float alpha_coeff2; // size: 0x4, address: 0x80C01FDC
static float alpha_coeff3; // size: 0x4, address: 0x80C01FE0
static float fade_in_time; // size: 0x4, address: 0x80C01FE4
static float fade_out_time; // size: 0x4, address: 0x80C01FE8
static int type; // size: 0x4, address: 0x80C01FEC
static unsigned char track_player; // size: 0x1, address: 0x80C087E0
static float emit_rate; // size: 0x4, address: 0x80C087E4
static float emit_random_radius; // size: 0x4, address: 0x80C01FF0
static float emit_loc_x; // size: 0x4, address: 0x80C01FF4
static float emit_loc_y; // size: 0x4, address: 0x80C01FF8
static float emit_loc_z; // size: 0x4, address: 0x80C01FFC
// total size: 0xC
struct /* @class$930zSplash_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933zSplash_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zSplash_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zSplash_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zSplash_cpp */ {
    // Members
...
static struct tweak_callback cb_emit; // size: 0x28, address: 0x803E2778
static struct tweak_callback cb_plume_fade; // size: 0x28, address: 0x803E27A0
// Range: 0x80189568 -> 0x80189834
...
// Range: 0x80189834 -> 0x801898AC
static void on_change_plume_fade(const struct tweak_info & info /* r0 */) {
    // References
    // -> static float fade_out_time;
    // -> static float fade_in_time;
    // -> static float alpha_coeff3;
...
static char ini_filename[11]; // size: 0xB, address: 0x80C0C8A8
static char * texture_key_names[8]; // size: 0x20, address: 0x8043D010
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwTexture * cone_texture; // size: 0x4, address: 0x80C087E8
// total size: 0x28
struct /* @class$2298zSplash_cpp */ {
    // Members
...
static struct splash_emitter * splash_emitters; // size: 0x4, address: 0x80C087EC
static int splash_emitters_size; // size: 0x4, address: 0x80C087F0
// total size: 0x48
...
static struct plume_emitter * plume_emitters; // size: 0x4, address: 0x80C087F4
static int plume_emitters_size; // size: 0x4, address: 0x80C087F8
// total size: 0x14
...
static struct bubble_emitter * bubble_emitters; // size: 0x4, address: 0x80C087FC
static int bubble_emitters_size; // size: 0x4, address: 0x80C08800
// total size: 0x8
struct chain_link {
    // Members
...
static struct chain_emitter * chain_emitters; // size: 0x4, address: 0x80C08804
static int chain_emitters_size; // size: 0x4, address: 0x80C08808
static int mist_system_id; // size: 0x4, address: 0x80C0880C
static int ring_system_id; // size: 0x4, address: 0x80C08810
static int streak_system_id; // size: 0x4, address: 0x80C08814
static int plume_system_id; // size: 0x4, address: 0x80C08818
static int trail_system_id; // size: 0x4, address: 0x80C0881C
static int drips_system_id; // size: 0x4, address: 0x80C08820
enum type_enum {
    TYPE_SPLASH = 0,
    TYPE_PLUME = 1,
    TYPE_BUBBLE = 2,
...
static struct splash_planner * planners; // size: 0x4, address: 0x80C08824
// total size: 0x8
struct type_mapping {
    // Members
...
static struct type_mapping * type_mappings; // size: 0x4, address: 0x80C08828
static int types_size; // size: 0x4, address: 0x80C0882C
static unsigned int texture_ids[8]; // size: 0x20, address: 0x80BB23F0
static int cone_texture_repeats; // size: 0x4, address: 0x80C02000
// Range: 0x801898AC -> 0x80189910
static void compute_cubic_coeff(float & a /* r0 */, float & b /* r0 */, float & c /* r0 */, float S /* f0 */, float T /* f0 */) {
    // Local variables
    float T2; // f8
    float idenom; // f2
}

// Range: 0x80189910 -> 0x80189BF0
static void refresh_splash(struct splash_config & cfg /* r31 */) {
    // Local variables
    struct splash_emitter & initial; // r0
    float ilife; // f31
    float Y0; // f29
    float Ym; // f28
    float iT1; // f27
...
// Range: 0x80189BF0 -> 0x80189CB4
static void refresh_plume(struct plume_config & cfg /* r5 */) {
    // Local variables
    struct plume_emitter & initial; // r0
}

// Range: 0x80189CB4 -> 0x80189CB8
static void refresh_bubble() {}

// Range: 0x80189CB8 -> 0x80189D08
...
// Range: 0x8018A1F8 -> 0x8018A250
static struct xIniValue * get_value(const char * name /* r1+0x8 */, const struct xIniValue * values /* r4 */, int values_size /* r0 */) {
    // Local variables
    const struct xIniValue * val; // r0
}

// Range: 0x8018A250 -> 0x8018A29C
static void read_hashed_text(unsigned int & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

// Range: 0x8018A29C -> 0x8018A2E8
static void read_value(int & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

// Range: 0x8018A2E8 -> 0x8018A338
static void read_value(float & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

// Range: 0x8018A338 -> 0x8018A4E0
static void load_plume(struct plume_config & cfg /* r29 */, const struct xIniValue * values /* r30 */, int values_size /* r31 */) {}

// Range: 0x8018A4E0 -> 0x8018A554
static void load_bubble(struct bubble_config & cfg /* r29 */, const struct xIniValue * values /* r30 */, int values_size /* r31 */) {}

// Range: 0x8018A554 -> 0x8018A630
static void load_chain(struct chain_config & chain /* r27 */, const struct xIniValue * values /* r4 */, int values_size /* r0 */) {
    // Local variables
    struct chain_link * link; // r30
    const struct xIniValue * iv; // r29
    const struct xIniValue * end_iv; // r28
    char * nextoken; // r1+0x8
    char * s; // r0
}
...
// Range: 0x8018A630 -> 0x8018A7A4
static void load_planner(struct splash_planner & plan /* r30 */, struct xIniSection & sec /* r25 */, struct xIniFile & ini /* r0 */) {
    // Local variables
    struct xIniValue * values; // r28
    int values_size; // r31
    const struct xIniValue * iv; // r27
    const struct xIniValue * end_iv; // r26
    const char * type; // r26
}

// Range: 0x8018A7A4 -> 0x8018A834
static void load_globals(struct xIniValue * values /* r27 */, int values_size /* r28 */) {
    // Local variables
    int i; // r29
...
// Range: 0x8018A834 -> 0x8018AA98
static void load_ini_configs() {
    // Local variables
    void * mem; // r31
    struct xIniFile * ini; // r30
    struct xIniSection * sections; // r29
    unsigned int memsize; // r1+0x8
    struct xIniSection * isec; // r27
    struct xIniSection * end_isec; // r28
    struct xIniSection * osec; // r26
    struct splash_planner * plan; // r26
    struct splash_planner * end_plan; // r25
    struct xIniSection * sec; // r27
    struct type_mapping * m; // r24
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02004
// Range: 0x8018AA98 -> 0x8018AB20
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C0201C
// Range: 0x8018AB20 -> 0x8018ABD0
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02030
// Range: 0x8018AD3C -> 0x8018ADC4
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C02044
// Range: 0x8018ADC4 -> 0x8018AE74
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02058
// Range: 0x8018AF08 -> 0x8018AF90
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02070
// Range: 0x8018AF90 -> 0x8018B040
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02084
// Range: 0x8018B06C -> 0x8018B0F4
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02098
// Range: 0x8018B128 -> 0x8018B2DC
static void emit_splash_internal(int type /* r29 */, const struct xVec3 & loc /* r31 */) {
    // Local variables
    const struct splash_planner & plan; // r29
    struct splash_emitter & splash; // r0
    struct plume_emitter & plume; // r0
    struct bubble_emitter & bubble; // r0
    struct chain_emitter & emitter; // r0
...
// Range: 0x8018B2DC -> 0x8018B49C
static int update_mist_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C020B0
// total size: 0x30
...
// Range: 0x8018B49C -> 0x8018B718
static int update_ring_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__color_mat & pool; // r31
    struct ring_particle * p; // r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C020C8
// total size: 0x1C
...
// Range: 0x8018B718 -> 0x8018BA30
static int update_streak_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */) {
    // Local variables
    struct ptank_pool__color_mat & pool; // r31
    ...
    struct streak_particle * end; // r29
    float t; // f27
    struct RwSphere worldsph; // r1+0x8
    float mag; // f0
...
// Range: 0x8018BA30 -> 0x8018BBF4
static void update_splash_emitters(float dt /* f28 */) {
    // Local variables
...
// Range: 0x8018BBF4 -> 0x8018BE48
static void emit_splash_streak(struct splash_emitter & splash /* r26 */, float dt /* f1 */) {
    // Local variables
    int emit; // r29
    float cx; // f30
    float cy; // f29
    float cz; // f28
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct streak_particle * p; // r28
...
// Range: 0x8018BE48 -> 0x8018C11C
static void emit_splash_ring(struct splash_emitter & splash /* r26 */, float r0 /* f25 */, float dt /* f0 */) {
    // Local variables
    int emit; // r29
    float dr; // f29
    float cx; // f28
...
// Range: 0x8018C11C -> 0x8018C494
static void emit_splash_mist(struct splash_emitter & splash /* r27 */, float r0 /* f16 */, float y0 /* f17 */, float dt /* f0 */) {
    // Local variables
    int emit; // r30
    float dr; // f27
    float dy; // f26
    ...
    float cy; // f24
    float cz; // f23
    float size_start; // f22
    float size_delta; // f21
    float A; // f20
    float iA; // f19
    float V0; // f18
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct mist_particle * p; // r29
    struct mist_particle * endp; // r28
    float ang; // f17
    float ca; // f0
    float sa; // f0
    float t; // f0
...
// Range: 0x8018C494 -> 0x8018C6D8
static int update_plume_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
    float a1; // f30
    float a2; // f29
...
// Range: 0x8018C73C -> 0x8018CA50
static void update_plume_emitters(float dt /* f24 */) {
    // Local variables
    struct plume_emitter * e; // r30
    struct plume_emitter * ende; // r29
    int emit; // r28
    float cx; // f28
    float cy; // f27
    float cz; // f26
...
// Range: 0x8018CA50 -> 0x8018CAF8
static void update_bubble_emitters(float dt /* f30 */) {
    // Local variables
...
// Range: 0x8018CAF8 -> 0x8018CBF0
static void update_chain_emitters(float dt /* f31 */) {
    // Local variables
    struct chain_emitter * e; // r31
    const struct chain_link * const links; // r30
    int links_size; // r29
    const struct chain_link * link; // r28
...
// Range: 0x8018CBF0 -> 0x8018CCA8
static void refresh_system(int & system_id /* r29 */, enum ptank_group_type pool_type /* r0 */, unsigned int texture_id /* r5 */, int stride /* r30 */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r31 */) {
    // Local variables
    struct xParticleBatchSystem system; // r1+0x8
}

// Range: 0x8018CCA8 -> 0x8018CDC4
...
// Range: 0x8018CE10 -> 0x8018CE30
static void end_render_cones() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C020DC
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
static void render_cones() {
    ...
    float du; // f27
    const struct splash_emitter * splash; // r27
    const struct splash_emitter * end_splash; // r26
    float cx; // f26
    float cy; // f25
    float cz; // f28
    float radius; // f24
...
struct /* @class$3281zSplash_cpp */ {
    ...
    float splashes_emitted; // offset 0x0, size 0x4
    const char * * type_labels; // offset 0x4, size 0x4
} debug; // size: 0x8, address: 0x80C08834
// Range: 0x8018D214 -> 0x8018D2C4
...
// Range: 0x8018D2C4 -> 0x8018D2E4
static void debug_emit() {}

// Range: 0x8018D2E4 -> 0x8018D3B0
static void update_test(float dt /* f0 */) {
    // Local variables
    int emit; // r31
    int max_emit; // r0
    int i; // r30
...
// Range: 0x8018D3B0 -> 0x8018D3D4
static void on_change_splash_config(const struct tweak_info & info /* r3 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x8043D030
// Range: 0x8018D3D4 -> 0x8018DBA8
static void add_splash_tweaks(struct splash_planner & plan /* r31 */) {
    // Local variables
...
// Range: 0x8018DBA8 -> 0x8018DBCC
static void on_change_plume_config(const struct tweak_info & info /* r3 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x8043D058
// Range: 0x8018DBCC -> 0x8018DEE4
static void add_plume_tweaks(struct splash_planner & plan /* r31 */) {
    // Local variables
    char prefix[128]; // r1+0x10
...
// Range: 0x8018DEE4 -> 0x8018DF08
static void on_change_bubble_config(const struct tweak_info & info /* r3 */) {}

static struct tweak_callback cb_cfg; // size: 0x28, address: 0x8043D080
// Range: 0x8018DF08 -> 0x8018DFE0
static void add_bubble_tweaks(struct splash_planner & plan /* r31 */) {
    // Local variables
...
// Range: 0x8018DFE0 -> 0x8018E000
static void on_change_texture() {}

static struct tweak_callback cb_texture; // size: 0x28, address: 0x803E27C8
...
// Range: 0x8018E0C0 -> 0x8018E0E8
static void on_change_link(const struct tweak_info & info /* r0 */) {}

static struct tweak_callback cb_link; // size: 0x28, address: 0x803E27F0
// Range: 0x8018E0E8 -> 0x8018E198
...
// Range: 0x8018E198 -> 0x8018E2A8
static void on_change_links_size(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct splash_planner & plan; // r28
    struct chain_config & chain; // r27
    char prefix[128]; // r1+0x8
    char * end; // r26
    const struct tweak_info * parent; // r0
    int tweaks; // r0
    int old_links_size; // r29
    int i; // r30
}
...
static struct tweak_callback cb_links_size; // size: 0x28, address: 0x803E2818
// Range: 0x8018E2A8 -> 0x8018E3A8
static void add_chain_tweaks(struct splash_planner & plan /* r27 */) {
    // Local variables
    char prefix[128]; // r1+0x10
    char * end; // r29
    int i; // r28
...
// Range: 0x8018E3A8 -> 0x8018E634
static void debug_init() {
    // Local variables
    int labels_size; // r31
    int i; // r5
    struct splash_planner * plan; // r26
    struct splash_planner * end_plan; // r27
...
// Range: 0x8018E634 -> 0x8018E6A4
static void debug_update(float dt /* f31 */) {
    // Local variables
    const struct xVec3 & player_loc; // r0
...
// Range: 0x8018E6A4 -> 0x8018E6C8
void zSplashStartup() {}

// Range: 0x8018E6C8 -> 0x8018E808
...
// Range: 0x8018E808 -> 0x8018E80C
void zSplashSceneExit() {}

// Range: 0x8018E80C -> 0x8018E864
void zSplashUpdate(float dt /* f31 */) {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x8018E864 -> 0x8018E890
void zSplashRender() {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C020EC
// Range: 0x8018E890 -> 0x8018E940
int zSplashFindType(const char * name /* r1+0x8 */) {
    // Local variables
    struct type_mapping * end; // r31
    const struct type_mapping * found; // r0
...
// Range: 0x8018E940 -> 0x8018E9A4
void zSplashEmit(int type /* r0 */, const struct xVec3 & loc /* r0 */) {
    // Local variables
...
// Range: 0x8018E9A4 -> 0x8018E9CC
static int compare_ini_values::operator()(const char * v1 /* r3 */, const struct xIniValue & v2 /* r0 */) {}

// total size: 0x1
struct compare_type_mapping {};
// Range: 0x8018E9CC -> 0x8018E9F4
static int compare_type_mapping::operator()(const char * name /* r3 */, const struct type_mapping & m /* r0 */) {}
