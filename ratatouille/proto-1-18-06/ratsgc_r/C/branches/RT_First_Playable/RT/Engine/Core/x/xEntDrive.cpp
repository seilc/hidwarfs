/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xEntDrive.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80053B10 -> 0x80054C08
*/
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFC848
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088xEntDrive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1226xEntDrive_cpp */ {
    // Members
...
// Range: 0x80053B10 -> 0x80053BBC
void xEntDriveInit(struct xEntDrive * drv /* r30 */, struct xEnt * driven /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFC858
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80053BBC -> 0x80054130
void xEntDriveMount(struct xEntDrive * drv /* r29 */, struct xEnt * driver /* r30 */, float mt /* f31 */, const struct xCollis * coll /* r31 */) {
    // Local variables
    struct xVec3 euler; // r1+0x1C
    struct xMat3x3 a_descaled; // r1+0x30
    float dummy; // f0
    float len2; // f1
    float len_inv; // f1
    float len2; // f1
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFC868
// Range: 0x80054130 -> 0x80054240
void xEntDriveDismount(struct xEntDrive * drv /* r31 */, float dmt /* f31 */) {
    // Local variables
    struct xEnt * pDriver; // r6

    // References
    // -> static char __FUNCTION__[18];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFC87C
// total size: 0x40
...
// Range: 0x80054240 -> 0x80054A68
void xEntDriveUpdate(struct xEntDrive * drv /* r31 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 euler; // r1+0x4C
    struct xMat3x3 rot; // r1+0xD0
    struct xMat3x3 a_descaled; // r1+0xA0
    float dummy; // f0
    float len2; // f1
    float len_inv; // f1
    float len2; // f1
    ...
    float len2; // f1
    float len_inv; // f1
    struct xVec3 newq; // r1+0x40
    struct xModelInstance & m; // r30
    struct xVec3 world_loc; // r1+0x34
    struct xVec3 new_loc; // r1+0x28
    struct xMat4x3 oldmat; // r1+0x60
...
// Range: 0x80054A68 -> 0x80054AC0
void xEntDriveSimpleInit(struct xEntDriveSimple * drv /* r31 */, struct xMat4x3 * mat /* r0 */) {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFC88C
// Range: 0x80054AC0 -> 0x80054B68
void xEntDriveSimpleMount(struct xEntDriveSimple * drv /* r30 */, struct xEnt * driver /* r31 */) {
    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x80054B68 -> 0x80054BB8
void xEntDriveSimpleUpdate(struct xEntDriveSimple * drv /* r31 */) {
    // Local variables
    struct xVec3 newq; // r1+0x8
}

// Range: 0x80054BB8 -> 0x80054C08
void xEntDriveSimplePostUpdate(struct xEntDriveSimple * drv /* r31 */) {}
