/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zShowerSystem.cpp
...
// total size: 0xC
struct /* @class$1021zShowerSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1022zShowerSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1023zShowerSystem_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1024zShowerSystem_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025zShowerSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026zShowerSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027zShowerSystem_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1080zShowerSystem_cpp */ {
    // Members
...
union /* @class$1263zShowerSystem_cpp */ {
...
// total size: 0xC
struct /* @class$1262zShowerSystem_cpp */ {
    // Members
...
struct ConfigType {
    // Members
    class zFXShockwaveConfig * shockwaveConfig; // offset 0x0, size 0x4
    struct xCameraFXShakeParams * cameraShakeParams; // offset 0x4, size 0x4
    unsigned int modelID; // offset 0x8, size 0x4
    unsigned int shrapnelID; // offset 0xC, size 0x4
    float shrapnelSpeedY; // offset 0x10, size 0x4
    float radius; // offset 0x14, size 0x4
    float damageRadius; // offset 0x18, size 0x4
    unsigned short damage; // offset 0x1C, size 0x2
};
// total size: 0x0
struct zFrag {};
enum zFragType {
...
// total size: 0xC0
class zShowerParticle {
    // Members
protected:
    struct xShadowSimpleCache shadow; // offset 0x0, size 0xA4
    float speed; // offset 0xA4, size 0x4
    float time; // offset 0xA8, size 0x4
    const struct ConfigType * config; // offset 0xAC, size 0x4
    struct xModelInstance * model; // offset 0xB0, size 0x4
    struct zShrapnelAsset * shrapnel; // offset 0xB4, size 0x4
    struct xFXRibbon * ribbon; // offset 0xB8, size 0x4
    unsigned char alive; // offset 0xBC, size 0x1
};
// total size: 0x8
struct xVec2 {
    // Members
...
// total size: 0x10
struct /* @class$1511zShowerSystem_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1973zShowerSystem_cpp */ {
    // Static members
...
struct ConfigType {
    // Members
    struct ConfigType particleConfig; // offset 0x0, size 0x20
    int maxParticles; // offset 0x20, size 0x4
    float minRadius; // offset 0x24, size 0x4
    float maxRadius; // offset 0x28, size 0x4
    float showerTime; // offset 0x2C, size 0x4
    float minSpawnTime; // offset 0x30, size 0x4
    float maxSpawnTime; // offset 0x34, size 0x4
    float minSpeed; // offset 0x38, size 0x4
    float maxSpeed; // offset 0x3C, size 0x4
    float endStormTime; // offset 0x40, size 0x4
    float endSpawnTime; // offset 0x44, size 0x4
    float stormDamageRadius; // offset 0x48, size 0x4
};
// total size: 0x5C
class zShowerSystem : public zLightweightSystemBase {
    // Members
protected:
    struct ConfigType * config; // offset 0x4, size 0x4
    class pool_list particleList; // offset 0x8, size 0x20
    struct xVec3 center; // offset 0x28, size 0xC
    float effectTimer; // offset 0x34, size 0x4
    float spawnTimer; // offset 0x38, size 0x4
    struct xEnt * owner; // offset 0x3C, size 0x4
    class zShowerCBInterface * collideCallback; // offset 0x40, size 0x4
    unsigned char renderBounds; // offset 0x44, size 0x1
    struct xFXRibbon tweakRibbon; // offset 0x48, size 0x14
};
// total size: 0x8
struct node_base {
    // Members
...
struct node_type {
    ...
    class zShowerParticle value; // offset 0x8, size 0xC0
};
// total size: 0x28
