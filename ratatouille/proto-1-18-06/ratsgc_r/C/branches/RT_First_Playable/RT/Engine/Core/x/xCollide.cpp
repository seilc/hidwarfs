/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollide.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8001BB64 -> 0x80023DE8
*/
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFBA68
enum _xCollsIdx {
...
// Range: 0x8001BB64 -> 0x8001BD88
enum _xCollsIdx xCollideGetCollsIdx(const struct xCollis * coll /* r29 */, const struct xVec3 * tohit /* r30 */, const struct xMat3x3 * mat /* r31 */) {
    // Local variables
    float local_x; // f3
    float local_z; // f1
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFBA7C
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x8001BD88 -> 0x8001BFE0
unsigned int xSphereHitsSphere(const struct xSphere * a /* r29 */, const struct xSphere * b /* r30 */, struct xCollis * coll /* r31 */) {
    // Local variables
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFBA90
// Range: 0x8001BFE0 -> 0x8001C200
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFBAA0
// total size: 0x40
...
// Range: 0x8001C72C -> 0x8001C9CC
static int PointWithinTriangle(struct xVec3 * _pt /* r0 */, struct xVec3 * * _tri /* r4 */, struct xVec3 * _normal /* r0 */) {
    // Local variables
    struct RwV3d * pt; // r0
    struct RwV3d * * tri; // r4
...
// Range: 0x8001CAC4 -> 0x8001CC38
static void properSphereIsectTri(const struct xVec3 * center /* r25 */, float radius /* f29 */, struct xVec3 * tohit /* r26 */, float * dist_ptr /* r27 */, struct RpCollisionTriangle * tri /* r28 */) {
    // Local variables
...
static int sCollidingJSP; // size: 0x4, address: 0x80C06EC0
// total size: 0x4
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFBAB4
// total size: 0x18
struct RwLine {
    // Members
...
// Range: 0x8001CE60 -> 0x8001D144
unsigned int xSphereHitsModel(const struct xSphere * b /* r28 */, const struct xModelInstance * m /* r29 */, struct xCollis * coll /* r30 */) {
    // Local variables
...
struct RpMorphTarget anim_coll_old_mt; // size: 0x1C, address: 0x80A84078
// total size: 0x20
struct xLinkAsset {
    // Members
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFBAC8
// Range: 0x8001D204 -> 0x8001D7B8
...
static const struct xCapsule * cb_capsule; // size: 0x4, address: 0x80C06EC4
int CapsuleEnvClosestToLineCB_trifilter; // size: 0x4, address: 0x80BFBAD8
int CapsuleEnvClosestToLineCB_triindex; // size: 0x4, address: 0x80C06EC8
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80414410
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x8001DA54 -> 0x8001DE1C
static struct RpCollisionTriangle * CapsuleEnvClosestToLineCB(struct RpCollisionTriangle * tri /* r30 */, void * data /* r31 */) {
    // Local variables
    struct xCollis * colls; // r0
    const struct xVec3 * p1; // r29
    const struct xVec3 * p2; // r28
    const struct xVec3 * v0; // r27
    const struct xVec3 * v1; // r26
    const struct xVec3 * v2; // r25
    float t; // r1+0x14
    float u; // r1+0x10
    float v; // r1+0xC
    float ln_ptz; // f4
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8041442C
// total size: 0x28
...
// Range: 0x8001DE4C -> 0x8001E0B4
static int LeafNodeCapsuleIntersect(struct xClumpCollBSPTriangle * triangles /* r30 */, void * data /* r31 */) {
    // Local variables
...
static char __FUNCTION__[33]; // size: 0x21, address: 0x80414448
// total size: 0x1C
struct xCapsule {
    // Members
...
static unsigned char registered; // size: 0x1, address: 0x80C06ECC
static signed char init; // size: 0x1, address: 0x80C06ECD
static char __FUNCTION__[31]; // size: 0x1F, address: 0x8041446C
// total size: 0x18
...
// Range: 0x8001E5E4 -> 0x8001EA58
int xCapsuleIsectsEnvClosestToLine(const struct xCapsule * c /* r29 */, const struct xEnv * env /* r30 */, struct xCollis * colls /* r31 */) {
    // Local variables
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFBADC
// Range: 0x8001EA58 -> 0x8001EC78
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFBAEC
// Range: 0x8001F71C -> 0x8001F920
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFBAF8
struct xMat4x3 g_I3; // size: 0x40, address: 0x80A7D5C0
// Range: 0x8001F920 -> 0x8001FAEC
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBB04
// total size: 0x10
struct /* @class$3676xCollide_cpp */ {
    // Members
    struct xVec3 norm; // offset 0x0, size 0xC
    float D; // offset 0xC, size 0x4
};
// Range: 0x8001FAEC -> 0x80020110
void xCollideCalcTri(struct tri_data & tri /* r27 */, const struct xModelInstance & model /* r28 */, const struct xVec3 & center /* r29 */, const struct xVec3 & heading /* r30 */) {
    // Local variables
...
// Range: 0x80020110 -> 0x80020114
static void render_tri() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFBB14
// Range: 0x80020114 -> 0x80020468
struct xVec3 xCollisTriHit(const struct tri_data & tri /* r28 */, const struct xModelInstance & model /* r29 */) {
    // Local variables
    const struct xMat4x3 & m; // r31
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFBB24
struct xVec3 m_Null; // size: 0xC, address: 0x80C0B540
// Range: 0x80020778 -> 0x80020A2C
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFBB3C
// Range: 0x80020A2C -> 0x80020CC0
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBB50
// Range: 0x80020DC8 -> 0x80021040
...
// Range: 0x80021040 -> 0x80021140
void xBoxForTriangle(struct xBox & box /* r0 */, const struct xVec3 & p0 /* r0 */, const struct xVec3 & p1 /* r0 */, const struct xVec3 & p2 /* r0 */) {}

// Range: 0x80021140 -> 0x80021198
void xBoxForModel(struct xBox & o /* r30 */, const struct xModelInstance * m /* r31 */, unsigned char childModels /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFBB60
// Range: 0x80021198 -> 0x80021398
void xBoxForIModelLocal(struct xBox & o /* r31 */, const struct RpAtomic * imodel /* r29 */, unsigned char initBox /* r28 */) {
    // Local variables
    struct RpGeometry * geom; // r30
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFBB74
// Range: 0x80021398 -> 0x800214CC
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBB88
// Range: 0x800214CC -> 0x800216E8
void xSphereForModel(struct xSphere & o /* r29 */, const struct xModelInstance * model /* r30 */, unsigned char childModels /* r25 */) {
    // Local variables
    struct RpAtomic * imodel; // r27
    struct RpGeometry * geom; // r26
    struct RpMorphTarget * mtgt; // r27
    unsigned short idx; // r25
    const struct xModelInstance * cur_model; // r31
...
static struct xRay3 cbray; // size: 0x24, address: 0x804598A8
static unsigned char cbnumcs; // size: 0x1, address: 0x80C06ECE
static unsigned char cbmaxcs; // size: 0x1, address: 0x80C06ECF
static unsigned char FLOOR; // size: 0x1, address: 0x80C06ED0
static unsigned char NEXT2; // size: 0x1, address: 0x80C06ED1
static unsigned char OTHER; // size: 0x1, address: 0x80C06ED2
static struct RpIntersection cbisx_local; // size: 0x1C, address: 0x804598CC
static float cbath; // size: 0x4, address: 0x80C06ED4
// Range: 0x800216E8 -> 0x80021780
static struct RpCollisionTriangle * rayHitsEnvBackwardCB(struct RpWorldSector * sector /* r0 */, struct RpCollisionTriangle * tri /* r5 */, float dist /* f2 */, void * data /* r0 */) {
    // Local variables
    struct xCollis * coll; // r0
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFBB98
// Range: 0x800218EC -> 0x80021CF4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFBBAC
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFBBB8
// Range: 0x800221CC -> 0x800225B8
unsigned int xRayHitsEnv(const struct xRay3 * r /* r26 */, const struct xEnv * env /* r27 */, struct xCollis * coll /* r28 */) {
    // Local variables
    struct RpIntersection isx; // r1+0x8
    float len; // f3
    int i; // r29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFBBC4
// Range: 0x800225B8 -> 0x80022C3C
...
// Range: 0x80022C3C -> 0x80022C74
static struct RpCollisionTriangle * sphereHitsModel3CB(struct RpCollisionTriangle * tri /* r0 */, float dist /* f0 */, void * data /* r6 */) {
    // References
    // -> static struct RpIntersection cbisx_local;
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFBBD8
// Range: 0x80022C74 -> 0x8002313C
int xSphereHitsModel3(const struct xSphere * b /* r27 */, const struct xModelInstance * m /* r28 */, struct xCollis * colls /* r29 */, unsigned char ncolls /* r31 */, float sth /* f30 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBBEC
// Range: 0x8002313C -> 0x800235DC
int xSphereHitsEnv3(const struct xSphere * b /* r25 */, const struct xEnv * env /* r26 */, struct xCollis * colls /* r27 */, unsigned char ncolls /* r28 */, float sth /* f31 */) {
    // Local variables
    struct RpIntersection isx; // r1+0x8
    unsigned char idx; // r3
    int i; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFBBFC
// Range: 0x800235DC -> 0x800237F8
unsigned int xSphereHitsEnv(const struct xSphere * b /* r26 */, const struct xEnv * env /* r27 */, struct xCollis * coll /* r28 */) {
    // Local variables
    struct RpIntersection isx; // r1+0x8
    int i; // r29
...
// Range: 0x800239EC -> 0x80023B14
unsigned char xOBBHitsScene(const struct xBox & box /* r29 */, const struct xMat4x3 & mat /* r30 */, struct xScene * sc /* r31 */, const struct xEnt * object /* r26 */, unsigned char collType /* r27 */, unsigned char chk /* r28 */) {
    // Local variables
