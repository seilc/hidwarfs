/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCamFollow.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80013694 -> 0x80013694
*/
char __FUNCTION__$localstatic1$unlock_block__10ptank_poolFv[13]; // size: 0xD, address: 0x80BFB978
char __FUNCTION__$localstatic1$SetRot__30ptank_pool__pos_color_size_rotFf[7]; // size: 0x7, address: 0x80BFB988
char __FUNCTION__$localstatic1$SetRot__34ptank_pool__pos_color_size_rot_uv2Ff[7]; // size: 0x7, address: 0x80BFB990
// total size: 0x8
struct /* @class$1151xCamFollow_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float dist_min; // offset 0x4, size 0x4
};
// total size: 0x20
struct /* @class$1152xCamFollow_cpp */ {
    // Members
    float speed; // offset 0x0, size 0x4
    float dist; // offset 0x4, size 0x4
    float dist_min; // offset 0x8, size 0x4
    float delay; // offset 0xC, size 0x4
    float fade_time; // offset 0x10, size 0x4
    float vel_min; // offset 0x14, size 0x4
    float hang_min; // offset 0x18, size 0x4
    float hang_max; // offset 0x1C, size 0x4
};
// total size: 0x94
struct config : public xCamConfigFollow {
    // Members
    float speed_move; // offset 0x54, size 0x4
    struct xVec2 stick_vel; // offset 0x58, size 0x8
    struct xVec2 stick_accel; // offset 0x60, size 0x8
    float stick_speed; // offset 0x68, size 0x4
    // total size: 0x8
    struct /* @class$1151xCamFollow_cpp */ {
        // Members
        float width; // offset 0x0, size 0x4
        float dist_min; // offset 0x4, size 0x4
    } collide; // offset 0x6C, size 0x8
    // total size: 0x20
    struct /* @class$1152xCamFollow_cpp */ {
        // Members
        float speed; // offset 0x0, size 0x4
        ...
        float hang_min; // offset 0x18, size 0x4
        float hang_max; // offset 0x1C, size 0x4
    } vel_drift; // offset 0x74, size 0x20
};
// total size: 0x230
struct xCamFollow : public xCam {
    // Members
    struct config cfg; // offset 0x140, size 0x94
private:
    const struct xVec3 * target; // offset 0x1D4, size 0x4
    struct xCamCoordCylinder end_coord; // offset 0x1D8, size 0x18
    struct xVec3 face; // offset 0x1F0, size 0xC
    struct xVec3 end_face; // offset 0x1FC, size 0xC
    float vel_dist; // offset 0x208, size 0x4
    float vel_height; // offset 0x20C, size 0x4
    float vel_theta; // offset 0x210, size 0x4
    float vel_face_height; // offset 0x214, size 0x4
    float vel_origin_y; // offset 0x218, size 0x4
    float drift_time; // offset 0x21C, size 0x4
    float vel_stick; // offset 0x220, size 0x4
    struct xVec2 drift_loc; // offset 0x224, size 0x8
    float drift_vel; // offset 0x22C, size 0x4
};
// total size: 0x40
...
// total size: 0x4
struct /* @class$1263xCamFollow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1401xCamFollow_cpp */ {
    // Members
...
union /* @class$1015xCamFollow_cpp */ {
...
// total size: 0x10
struct /* @class$1028xCamFollow_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$964xCamFollow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965xCamFollow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966xCamFollow_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967xCamFollow_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968xCamFollow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969xCamFollow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970xCamFollow_cpp */ {
    // Members
