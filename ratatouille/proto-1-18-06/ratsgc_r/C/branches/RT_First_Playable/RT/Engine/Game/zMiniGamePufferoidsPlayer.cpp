/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGamePufferoidsPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AD0CC -> 0x802AE21C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80C063B0
static float PLAYER_MOVE_SPEED; // size: 0x4, address: 0x80C063B4
static unsigned int SHOT_MODEL_ID; // size: 0x4, address: 0x80C096C8
static unsigned int SHOT_LONG_MODEL_ID; // size: 0x4, address: 0x80C096CC
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C063B8
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$1097zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// Range: 0x802AD0CC -> 0x802AD2E8
// this: r31
void zMiniGamePufferoidsShot::Init(class zMiniGamePufferoidsPlayer * owner /* r0 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1484zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802AD2E8 -> 0x802AD4CC
// this: r31
void zMiniGamePufferoidsShot::Update(float dt /* f0 */) {
    // Local variables
    float disp; // f31
    struct xSweptSphere sws; // r1+0x30
    struct xVec3 start; // r1+0x24
    struct xVec3 end; // r1+0x18
    int result; // r0
    int i; // r30
    class zMiniGamePufferoidsPuff * puffs; // r30
    struct xSphere sph; // r1+0x8
...
// total size: 0x1
struct /* @class$2018zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2020zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$2021zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$2022zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
enum /* @enum$2023zMiniGamePufferoidsPlayer_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$2024zMiniGamePufferoidsPlayer_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$2025zMiniGamePufferoidsPlayer_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$2027zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$2015zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// Range: 0x802AD590 -> 0x802AD638
// this: r31
void zMiniGamePufferoidsShot::Fire(unsigned char longRange /* r0 */, int power /* r0 */, float yRot /* f31 */) {}

// Range: 0x802AD638 -> 0x802AD644
// this: r0
void zMiniGamePufferoidsShot::Kill() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C063C0
// Range: 0x802AD644 -> 0x802AD6C4
// this: r31
...
// Range: 0x802AD6C4 -> 0x802AD764
// this: r29
void zMiniGamePufferoidsPlayer::Init(struct xEntAsset * asset /* r0 */) {
    // Local variables
    int i; // r30
...
union /* @class$1236zMiniGamePufferoidsPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1235zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zMiniGamePufferoidsPlayer_cpp */ {
    // Static members
...
// Range: 0x802AD800 -> 0x802AD8DC
// this: r31
void zMiniGamePufferoidsPlayer::UpdateOrientation(float dt /* f31 */) {
    // Local variables
...
// Range: 0x802AD8DC -> 0x802ADA40
// this: r30
void zMiniGamePufferoidsPlayer::UpdatePosition(float dt /* f31 */) {
    // Local variables
    float x; // r1+0x14
    float y; // r1+0x10
    float angle; // r1+0xC
    float mag; // r1+0x8
    struct xVec3 moveVec; // r1+0x48
    struct xSweptSphere sws; // r1+0x54
    struct xVec3 start; // r1+0x3C
    struct xVec3 end; // r1+0x30
    int result; // r0
    struct xVec3 slideDir; // r1+0x24
    struct xVec3 leftToMove; // r1+0x18
    float slideMag; // f0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C063C8
// Range: 0x802ADA40 -> 0x802ADBB0
// this: r30
void zMiniGamePufferoidsPlayer::ApplyPickup(int applyPickup /* r31 */, float activeTime /* f31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x802ADBB0 -> 0x802ADC44
// this: r31
...
// Range: 0x802ADCBC -> 0x802ADCC4
// this: r3
unsigned char zMiniGamePufferoidsShot::IsActive() {}

// Range: 0x802ADCC4 -> 0x802ADF60
// this: r31
void zMiniGamePufferoidsPlayer::Update(float dt /* f31 */) {
    // Local variables
    unsigned char longRange; // r28
    int j; // r27
    class zMiniGamePufferoidsShot * freeShot; // r0
    int i; // r27
...
// Range: 0x802ADF60 -> 0x802ADF80
// this: r0
void zMiniGamePufferoidsPlayer::EndUpdate(float dt /* f0 */) {}

// Range: 0x802ADF80 -> 0x802AE08C
// this: r29
...
// Range: 0x802AE08C -> 0x802AE0CC
// this: r31
void zMiniGamePufferoidsPlayer::SceneSetup() {}

// Range: 0x802AE0CC -> 0x802AE10C
// this: r31
void zMiniGamePufferoidsPlayer::Reset() {}

// Range: 0x802AE10C -> 0x802AE16C
// this: r29
...
// Range: 0x802AE16C -> 0x802AE21C
void zMiniGamePufferoidsPlayer::AddStates(struct xAnimTable * table /* r31 */) {}

// total size: 0x12C
struct {} zMiniGamePufferoidsPlayer::__vtable; // size: 0x12C, address: 0x80448188
