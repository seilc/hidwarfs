/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSpringboard.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026AA0C -> 0x8026B650
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float SMALL_LAUNCH_HEIGHT; // size: 0x4, address: 0x80C054A0
static float SIZE_SPACING; // size: 0x4, address: 0x80C054A4
static float TOP_DIST_MAX; // size: 0x4, address: 0x80C054A8
static float NORMAL_COS; // size: 0x4, address: 0x80C054AC
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1115zSpringboard_cpp */ {
    // Members
...
union /* @class$1263zSpringboard_cpp */ {
...
// total size: 0xC
struct /* @class$1262zSpringboard_cpp */ {
    // Members
...
// Range: 0x8026AA0C -> 0x8026AA58
static void GenericEntRender(struct xEnt * ent /* r31 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C054B0
// total size: 0x10
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C054B8
// Range: 0x8026AB1C -> 0x8026ABA0
// this: r31
...
// Range: 0x8026ABA0 -> 0x8026ABB4
// this: r0
unsigned int zSpringboard::CompressCheck() {}

// Range: 0x8026ABB4 -> 0x8026ABC4
// this: r0
unsigned int zSpringboard::IdleCB() {}

// Range: 0x8026ABC4 -> 0x8026ABD8
// this: r0
unsigned int zSpringboard::LaunchCheck() {}

// Range: 0x8026ABD8 -> 0x8026ABE8
// this: r0
unsigned int zSpringboard::LaunchCB() {}

// Range: 0x8026ABE8 -> 0x8026AC00
// this: r0
unsigned int zSpringboard::ChargeboardCheck() {}

// Range: 0x8026AC00 -> 0x8026AC10
// this: r0
unsigned int zSpringboard::CompressedCB() {}

// Range: 0x8026AC10 -> 0x8026AF58
struct xAnimTable * zSpringboard::CreateAnimTable() {
    // Local variables
    struct xAnimTable * table; // r31
}

// Range: 0x8026AF58 -> 0x8026AF84
// this: r0
void zSpringboard::EventCB(unsigned int toEvent /* r0 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C054C4
// Range: 0x8026AF84 -> 0x8026B038
void zSpringboard::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r31 */) {
    // References
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80BCBA60
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1511zSpringboard_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1973zSpringboard_cpp */ {
    // Static members
...
// Range: 0x8026B094 -> 0x8026B250
// this: r31
zSpringboard::zSpringboard(struct zSpringboardAsset * theAsset /* r0 */) {
    // Local variables
    unsigned int assetID; // r30
    unsigned short size; // r1+0x8
    struct xModelAssetParam * param; // r0
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C054CC
// Range: 0x8026B250 -> 0x8026B3E4
void zSpringboard::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C054D4
// Range: 0x8026B3E4 -> 0x8026B520
// this: r30
void zSpringboard::GetLaunchVelocity(struct xVec3 & vel /* r31 */) {
    // Local variables
    float magnitude; // f0
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C054E8
...
// Range: 0x8026B520 -> 0x8026B650
// this: r30
unsigned char zSpringboard::Mount(const struct SphereCollisionResults & results /* r31 */) {
    // Local variables
