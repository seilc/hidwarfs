/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompSound.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BC2F4 -> 0x802BC500
*/
// total size: 0x1
...
static class zCompSoundParams gDefaultSoundParams; // size: 0x1C, address: 0x80BD4598
// total size: 0x34
struct {} zCompSound::__vtable; // size: 0x34, address: 0x80448A20
// total size: 0x8
...
// Range: 0x802BC394 -> 0x802BC398
void zCompSound::AllAttached() {}

// Range: 0x802BC398 -> 0x802BC3E4
// this: r31
void zCompSound::Detached() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C06710
// Range: 0x802BC3E4 -> 0x802BC500
// this: r30
...
// total size: 0x34
struct {} zICompSound::__vtable; // size: 0x34, address: 0x80448A54
// total size: 0x0
class zNPCBase {};
enum eCompType {
    eCompType_Unknown = -1,
...
// total size: 0xC
struct {} zCompSoundParams::__vtable; // size: 0xC, address: 0x80C0671C
