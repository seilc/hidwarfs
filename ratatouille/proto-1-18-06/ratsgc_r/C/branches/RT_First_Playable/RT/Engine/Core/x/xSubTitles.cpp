/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xSubTitles.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800CDBE8 -> 0x800CE048
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80C0B498
static float subtitleFontWidth; // size: 0x4, address: 0x80BFEB20
static float subtitleFontHeight; // size: 0x4, address: 0x80BFEB24
static float subtitleSize; // size: 0x4, address: 0x80C07850
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct xSubtitlesAsset * m_pCurrentAsset; // size: 0x4, address: 0x80C07854
static unsigned int m_uLastTimeKey; // size: 0x4, address: 0x80C07858
// Range: 0x800CDBE8 -> 0x800CDCA0
void xSubTitlesInit() {
    // References
...
// Range: 0x800CDCA0 -> 0x800CDD0C
void * xSubTitlesRead(void * indata /* r31 */, unsigned int insize /* r29 */, unsigned int * outsize /* r30 */) {
    // Local variables
...
// Range: 0x800CDD0C -> 0x800CDD10
void xSubTitlesUnloaded() {}

static unsigned int last_failed_aid; // size: 0x4, address: 0x80C0785C
static signed char init; // size: 0x1, address: 0x80C07860
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFEB28
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x800CDD10 -> 0x800CE038
unsigned char xSubTitlesRender(unsigned int aid /* r30 */, float fTime /* f31 */) {
    // Local variables
    unsigned int uSearchIndex; // r30
    char * pszDisplay; // r30
    class xtextbox tbSubtitles; // r1+0xB4
...
// total size: 0x2
struct /* @class$988xSubTitles_cpp */ {
    // Members
...
// Range: 0x800CE038 -> 0x800CE040
void xSubTitlesSetSize(float size /* f0 */) {
    // References
    // -> static float subtitleSize;
}

// Range: 0x800CE040 -> 0x800CE048
