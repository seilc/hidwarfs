/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMusic.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8013EA48 -> 0x8013F948
*/
enum xSndHandle {
};
// total size: 0x24
...
static struct zMusicTrackInfo sMusicTrack[2]; // size: 0x48, address: 0x80B9F790
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct xSndGroup * spMusicGroup; // size: 0x4, address: 0x80C08288
// total size: 0x8
struct zMusicState {
    // Members
...
static struct zMusicState sMusic; // size: 0x8, address: 0x80C0828C
float gDialogueMusicLevel; // size: 0x4, address: 0x80C00D48
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00D4C
enum iSndGroupHandle {
};
// Range: 0x8013EA48 -> 0x8013EB0C
static void _zMusicStart(unsigned int uWhichSlot /* r31 */, unsigned int uTune /* r30 */) {
    // Local variables
    enum iSndGroupHandle hSoundGroup; // r0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00D5C
// Range: 0x8013EB0C -> 0x8013EBB0
static void _zMusicPause(unsigned int uWhichSlot /* r30 */, unsigned char bPause /* r31 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00D6C
// Range: 0x8013EBB0 -> 0x8013EC58
...
// Range: 0x8013EC58 -> 0x8013ED40
void zMusicInit() {
    // Local variables
    enum iSndGroupHandle hMusicDefGroup; // r31
    unsigned char uSoundCount; // r0
    unsigned char randSound; // r4
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00D78
enum eGameMode {
    eGameMode_Boot = 0,
    eGameMode_Intro = 1,
    eGameMode_Title = 2,
...
// Range: 0x8013ED40 -> 0x8013F0B4
void zMusicUpdate() {
    // Local variables
    float fNowTime; // f0
    unsigned int i; // r28
    float fDeltaTime; // f1
    float fHowLongPlaying; // f0
    unsigned int nOtherTrack; // r27
...
// Range: 0x8013F100 -> 0x8013F13C
void zMusicKill() {
    // Local variables
    unsigned int i; // r31
}

// Range: 0x8013F13C -> 0x8013F19C
void zMusicPause() {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x8013F1FC -> 0x8013F240
void zMusicSetVolume(float vol /* f0 */, float delay /* f0 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C00D88
enum eTrackReason {
    eMusic = 0,
    eNewMusic = 1,
    eTempMusic = 2,
};
// Range: 0x8013F240 -> 0x8013F504
static unsigned int _zMusicCrossFade(float fNewVolume /* f30 */, float fNewVolTime /* f31 */, unsigned int newTrack /* r29 */, enum eTrackReason eReason /* r30 */) {
    // Local variables
    unsigned int i; // r27
...
// Range: 0x8013F504 -> 0x8013F574
void ZeroVolumeHack::StopZeroVolume(unsigned int slot /* r0 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00D9C
// Range: 0x8013F574 -> 0x8013F744
void zMusicNewSongEvent(const float * toParam /* r30 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
    float fFadeVolTime; // f31
    float fNewVolTime; // f30
    float fFadeVolume; // f29
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C00DB0
// Range: 0x8013F764 -> 0x8013F904
void zMusicTempSongEvent(const float * toParam /* r30 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
    float fFadeVolTime; // f29
    float fNewVolTime; // f28
    float fPlayTime; // f0
    float fNewVolume; // f27
    unsigned int i; // r30
    unsigned int nSlot; // r0
