/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCounter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800248CC -> 0x8002510C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char buffer[16]; // size: 0x10, address: 0x80C06ED8
// total size: 0x8
struct xBaseAsset {
    // Members
...
// Range: 0x800248CC -> 0x8002492C
static char * get_asset_name(struct xCounterAsset * asset /* r31 */) {
    // Local variables
    const char * name; // r0
...
// total size: 0x1
struct /* @class$1037xCounter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1038xCounter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1039xCounter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1040xCounter_cpp */ {
    // Members
...
// Range: 0x8002492C -> 0x800249E4
static void on_update_counter_tweak(const struct tweak_info & info /* r0 */) {
    // Local variables
...
static struct tweak_callback cb_update; // size: 0x28, address: 0x80414490
static signed char init; // size: 0x1, address: 0x80C06EE8
// Range: 0x800249E4 -> 0x80024AD8
...
// Range: 0x80024C10 -> 0x80024D00
void xCounterSave(struct _xCounter * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFBC48
// Range: 0x80024D00 -> 0x80024DF0
void xCounterLoad(struct _xCounter * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBC58
// Range: 0x80024DF0 -> 0x8002510C
void xCounterEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    struct _xCounter * t; // r31
