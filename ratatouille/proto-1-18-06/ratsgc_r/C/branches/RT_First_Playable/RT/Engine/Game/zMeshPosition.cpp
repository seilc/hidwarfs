/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMeshPosition.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801FB2CC -> 0x801FC78C
*/
// total size: 0x8
struct xVec2 {
    // Members
...
// total size: 0x4
struct /* @class$1175zMeshPosition_cpp */ {
    // Members
...
union /* @class$1314zMeshPosition_cpp */ {
...
// total size: 0xC
struct /* @class$1313zMeshPosition_cpp */ {
    // Members
...
// Range: 0x801FB2CC -> 0x801FB2FC
// this: r31
zMeshPosition::zMeshPosition() {}

// Range: 0x801FB2FC -> 0x801FB314
// this: r0
...
// Range: 0x801FB314 -> 0x801FB37C
// this: r0
unsigned char zMeshPosition::CheckIntegrity() const {}

// Range: 0x801FB37C -> 0x801FB3E4
// this: r0
unsigned char zMeshPosition::Valid() const {}

// Range: 0x801FB3E4 -> 0x801FB434
// this: r31
unsigned char zMeshPosition::IsMeshEnabled() const {}

// Range: 0x801FB434 -> 0x801FB49C
// this: r0
int zMeshPosition::GetPortal(const class zMeshPosition & destination /* r0 */, struct xVec2 * portal /* r30 */, float radius /* f0 */) const {
    // Local variables
    struct xVec3 tempPortal[2]; // r1+0x8
    int value; // r31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03A98
struct xVec3 g_O3; // size: 0xC, address: 0x80C0ADA0
// Range: 0x801FB49C -> 0x801FB908
// this: r27
int zMeshPosition::GetPortal(const class zMeshPosition & destination /* r25 */, struct xVec3 * portal /* r28 */, float radius /* f30 */) const {
    // Local variables
    struct Exit & exit; // r0
    class zMeshPosition exitPosition; // r1+0x20
    class xNavigationMeshAssetSubMesh * subMesh; // r31
    int portalIndex; // r30
    int next; // r29
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C03AA4
// Range: 0x801FB908 -> 0x801FB9AC
void zMeshPosition::GetClosestPosition(const struct xVec3 & pos /* r30 */, class zMeshPosition & result /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x801FB9AC -> 0x801FBBC8
// this: r21
void zMeshPosition::GetClosestPosition(class zMeshPosition & result /* r20 */) const {
    // Local variables
    class zMeshPosition meshPosition; // r1+0x10
    ...
    int i; // r25
    const unsigned char * portal; // r24
    const unsigned char * a; // r23
    const unsigned char * b; // r22
    const unsigned char * end; // r21
    const struct xVec3 & vertex_a; // r5
    const struct xVec3 & vertex_b; // r5
    float portal_point_x; // r1+0xC
    float portal_point_y; // r1+0x8
    float CPx; // f3
    float CPy; // f0
    float line_dist2; // f27
    float y_diff; // f0
}
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C03AB8
// Range: 0x801FBBC8 -> 0x801FBC6C
// this: r31
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C03AC8
// Range: 0x801FBC6C -> 0x801FBD30
// this: r30
void zMeshPosition::AdvanceThroughPortal(int side /* r31 */) {
    // References
...
// total size: 0xC
struct /* @class$990zMeshPosition_cpp */ {
    // Members
...
// Range: 0x801FBD30 -> 0x801FBDB4
// this: r30
unsigned char zMeshPosition::UpdatePositionAutoY(const struct xVec3 & newPos /* r31 */, unsigned short entFilter /* r0 */) {
    // Local variables
...
static unsigned char done; // size: 0x1, address: 0x80C08DC8
static signed char init; // size: 0x1, address: 0x80C08DC9
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C03AE0
// Range: 0x801FBDB4 -> 0x801FBE7C
// this: r3
unsigned char zMeshPosition::UpdatePositionAutoY(const struct xVec3 & newPos /* r4 */, const struct xEnt & ent /* r0 */) {
    // References
...
// Range: 0x801FBE7C -> 0x801FBFEC
// this: r28
unsigned char zMeshPosition::UpdatePosition(const struct xVec3 & newPos /* r29 */, const float * overrideYLow /* r30 */, const float * overrideYHigh /* r31 */) {
    // Local variables
    int testSubMesh; // r1+0xC
    int testTriangle; // r1+0x8
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C03AF4
// Range: 0x801FBFEC -> 0x801FC1FC
// this: r26
unsigned char zMeshPosition::CheckInTriangle(const struct xVec3 & position /* r27 */, int subMesh /* r0 */, int triangle /* r28 */, const float * overrideYLow /* r29 */, const float * overrideYHigh /* r30 */) {
    // Local variables
    float triangleHeight; // f0
    float yHigh; // f1
    float yLow; // f2
    float yHigh; // f3
...
// Range: 0x801FC1FC -> 0x801FC26C
// this: r30
unsigned char zMeshPosition::FindAnyValid(const struct xVec3 & position /* r0 */, const float * yLow /* r0 */, const float * yHigh /* r0 */, unsigned char findClosestValid /* r31 */) {
    // Local variables
    unsigned char found; // r3
}

// Range: 0x801FC26C -> 0x801FC314
// this: r29
unsigned char zMeshPosition::FindAnyValidAutoY(const struct xVec3 & position /* r30 */, unsigned short entFilter /* r0 */, unsigned char findClosestValid /* r31 */) {
    // Local variables
    struct zEntTrigger * trigger; // r0
    float toleranceHigh; // r1+0xC
    float toleranceLow; // r1+0x8
...
// Range: 0x801FC314 -> 0x801FC40C
// this: r25
unsigned char zMeshPosition::FindAnyValid(const struct xVec3 & position /* r26 */, const float * overrideYLow /* r27 */, const float * overrideYHigh /* r28 */) {
    // Local variables
    int subMesh; // r30
    int i; // r29
}

// Range: 0x801FC40C -> 0x801FC574
unsigned char zMeshPosition::CheckCrossEdge(const struct xVec3 * v0 /* r29 */, const struct xVec3 * v1 /* r0 */, const struct xVec3 & startPos /* r30 */, const struct xVec3 & endPos /* r31 */) {
    // Local variables
    float Ex; // f31
    float Ez; // f30
    float edgeLen; // f0
    float invEdgeLen; // f2
    float Nx; // f4
    float startDistAbove; // f12
    float endDistAbove; // f2
    float percent; // f4
    float along; // f2
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C03B04
// Range: 0x801FC574 -> 0x801FC78C
// this: r23
unsigned char zMeshPosition::FindNeighborOnPath(const struct xVec3 & startPos /* r24 */, const struct xVec3 & endPos /* r25 */, int subMeshIndex /* r0 */, int triangle /* r26 */, int & neighborTriangle /* r27 */) {
    // Local variables
    const class xNavigationMeshAssetSubMesh & subMesh; // r30
    const struct Triangle & tri; // r6
    struct xVec3 * vertices[3]; // r1+0x8
    int v0; // r29
    int v1; // r28
