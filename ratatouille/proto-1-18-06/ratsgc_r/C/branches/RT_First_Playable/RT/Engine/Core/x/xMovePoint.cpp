/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xMovePoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008B088 -> 0x8008BB58
*/
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD5C0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD5D0
// total size: 0x0
struct xSerial {};
// Range: 0x8008B168 -> 0x8008B238
void xMovePointSave(struct xMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD5E0
// Range: 0x8008B238 -> 0x8008B308
void xMovePointLoad(struct xMovePoint * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD5F0
// Range: 0x8008B308 -> 0x8008B3F4
void xMovePointReset(struct xMovePoint * m /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD600
// total size: 0x0
struct xEnt {};
// total size: 0x8
struct RwObject {
...
// Range: 0x8008B3F4 -> 0x8008B618
void xMovePointSetup(struct xMovePoint * m /* r27 */, struct xScene * sc /* r28 */) {
    // Local variables
    unsigned int * id; // r30
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFD610
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8008B618 -> 0x8008B958
void xMovePointSplineSetup(struct xMovePoint * m /* r31 */) {
    // Local variables
    struct xMovePoint * w0; // r30
    struct xMovePoint * w2; // r29
    struct xMovePoint * w3; // r30
...
// Range: 0x8008B958 -> 0x8008B970
void xMovePointSplineDestroy(struct xMovePoint * m /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD628
// Range: 0x8008B970 -> 0x8008BAE4
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD63C
// Range: 0x8008BAE4 -> 0x8008BB58
