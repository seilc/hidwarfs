/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleSystemSnow.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020C42C -> 0x8020DC0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float FADE_TIME; // size: 0x4, address: 0x80C03F78
static float DAMPENING; // size: 0x4, address: 0x80C03F7C
static float MAX_RENDER_DISTANCE; // size: 0x4, address: 0x80C03F80
static float MAX_BOX_SIZE; // size: 0x4, address: 0x80C03F84
static int MAX_PARTICLE_BLOCKS; // size: 0x4, address: 0x80C03F88
// total size: 0x8
...
// Range: 0x8020C42C -> 0x8020C4A0
// this: r29
struct zParticleGenerator * zParticleSystemSnow::create_generator(struct zParticleAsset & asset /* r30 */) {}

unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8020C4DC -> 0x8020C500
// this: r3
void zParticleSystemSnow::scene_enter() {}

// Range: 0x8020C500 -> 0x8020C520
// this: r0
void zParticleSystemSnow::update(float dt /* f0 */) {}
...
// Range: 0x8020C520 -> 0x8020C528
int zParticleSystemSnow::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03F8C
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1036zParticleSystemSnow_cpp */ {
    // Members
...
// Range: 0x8020C528 -> 0x8020CB34
int zParticleSystemSnow::update_particles(unsigned char * mem /* r21 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f20 */, void * context /* r22 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & _fptank_pool; // r31
    ...
    struct particle_instance * p; // r24
    struct particle_instance * end; // r23
    struct zParticleGeneratorSnow & g; // r0
    struct asset_data & a; // r0
    float gravity; // f18
    float height; // f0
    float driftForce; // f26
    float maxDriftSpeed; // f25
    float maxDriftDist; // f24
    float fadeDist; // f23
    const struct xVec3 & camPos; // r22
    float distTraveled; // f22
    float newDriftForceX; // f21
    float newDriftForceZ; // f3
    float driftDistanceX; // f2
    float driftDistanceZ; // f1
...
// Range: 0x8020CB34 -> 0x8020CC34
// this: r29
void zParticleGeneratorSnow::updateSubBoxStatus(int & activeBoxes /* r30 */, int & newBoxes /* r31 */) {
    // Local variables
    struct zParticleSnowSubBox * boxPtr; // r28
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C03FA0
// total size: 0x10
...
// Range: 0x8020CC34 -> 0x8020CE88
// this: r30
int zParticleGeneratorSnow::makeLocations(struct particleLocation * locList /* r31 */, float dt /* f31 */) {
    // Local variables
    const struct asset_data & a; // r0
    int particleCounter; // r28
    struct zParticleSnowSubBox * boxPtr; // r27
    struct zParticleSnowSubBox * endPtr; // r26
    int emit; // r25
    float x; // f29
    float z; // f1
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C03FB0
// Range: 0x8020CE88 -> 0x8020D1FC
// this: r27
void zParticleGeneratorSnow::update(float dt /* f31 */) {
    ...
    int newBoxes; // r1+0xC
    int partAllocate; // r26
    struct particleLocation * locList; // r30
    int emit; // r29
    float minScale; // f30
    float maxScale; // f29
    float maxRotSpeed; // f28
    struct particleLocation * locPtr; // r28
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C03FB8
...
// Range: 0x8020D1FC -> 0x8020D56C
// this: r28
void zParticleGeneratorSnow::create(class zParticleSystemSnow & system /* r30 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x14
    int numRows; // r31
    int numCols; // r30
    struct xVec3 topLeft; // r1+0x8
    struct zParticleSnowSubBox * boxPtr; // r26
    int i; // r25
    int j; // r24
...
// Range: 0x8020D778 -> 0x8020DAA0
// this: r31
void zParticleGeneratorSnow::add_tweaks(const char * prefix /* r30 */) {
    // Local variables
...
// total size: 0x2C
struct {} zParticleGeneratorSnow::__vtable; // size: 0x2C, address: 0x8043F1B8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1760zParticleSystemSnow_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$972zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$973zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$975zParticleSystemSnow_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$976zParticleSystemSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$977zParticleSystemSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$978zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1358zParticleSystemSnow_cpp */ {
    // Members
...
union /* @class$1023zParticleSystemSnow_cpp */ {
...
// total size: 0xC
struct /* @class$1496zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemSnow::__vtable; // size: 0x3C, address: 0x8043F1E4
// total size: 0x8
