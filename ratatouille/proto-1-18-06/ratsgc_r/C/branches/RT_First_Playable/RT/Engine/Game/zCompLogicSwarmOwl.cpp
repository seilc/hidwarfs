/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicSwarmOwl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BCD9C -> 0x802BD720
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gSwarmOwlSteeringParams; // size: 0x8C, address: 0x80BD4660
...
static class zCompSoundParams gSwarmOwlSoundParams; // size: 0x1C, address: 0x80BD46EC
// total size: 0x8
...
static struct zCompStateMachineTable gSwarmOwlStateMachineTable[4]; // size: 0x20, address: 0x80448B10
// total size: 0x34
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06748
// Range: 0x802BCEA8 -> 0x802BD16C
// this: r28
unsigned char zCompLogicSwarmOwl::SystemEvent(unsigned int to_event /* r30 */, const float * to_param /* r29 */, struct xBase * to_param_widget /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1173zCompLogicSwarmOwl_cpp */ {
    // Members
...
union /* @class$1313zCompLogicSwarmOwl_cpp */ {
...
// total size: 0xC
struct /* @class$1311zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$987zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zCompLogicSwarmOwl_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zCompLogicSwarmOwl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zCompLogicSwarmOwl_cpp */ {
    // Members
...
void zCompLogicSwarmOwl::AllAttached() {
    ...
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    struct zNPCAssetSwarm * swarmAsset; // r0
    int i; // r28
    class zICompSteering * compSteering; // r27
    class zICompSound * soundComp; // r27
...
// Range: 0x802BD318 -> 0x802BD414
void zSwarmOwlWander::Enter(class zNPCBase * owner /* r3 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    int i; // r29
    class zICompSteering * compSteering; // r28
    class zICompNPCEntity * compNPCEntity; // r27
...
// total size: 0x10
struct /* @class$1893zCompLogicSwarmOwl_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802BD414 -> 0x802BD4A8
// this: r30
void zSwarmOwlWander::Update(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    struct xVec3 * playerPos; // r31
    class zCompSteeringFlockingBrain * flockingBrain; // r0
    const struct xVec3 * swarmPos; // r0
...
// total size: 0x890
struct /* @class$2140zCompLogicSwarmOwl_cpp */ {
    // Static members
...
// Range: 0x802BD4A8 -> 0x802BD5C0
void zSwarmOwlBlock::Enter(class zNPCBase * owner /* r3 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    int i; // r29
...
// Range: 0x802BD5C0 -> 0x802BD638
// this: r30
void zSwarmOwlBlock::Update(class zNPCBase * owner /* r31 */) {
    // Local variables
    struct xVec3 * playerPos; // r31
    class zCompSteeringFlockingBrain * flockingBrain; // r0
    const struct xVec3 * swarmPos; // r0
...
// Range: 0x802BD638 -> 0x802BD71C
void zSwarmOwlAttracted::Enter(class zNPCBase * owner /* r3 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    int i; // r29
...
// Range: 0x802BD71C -> 0x802BD720
void zSwarmOwlAttracted::Update() {}

// total size: 0x30
struct {} zSwarmOwlAttracted::__vtable; // size: 0x30, address: 0x80448B30
// total size: 0x30
struct {} zSwarmOwlBlock::__vtable; // size: 0x30, address: 0x80448B60
// total size: 0x30
struct {} zSwarmOwlWander::__vtable; // size: 0x30, address: 0x80448B90
// total size: 0x54
