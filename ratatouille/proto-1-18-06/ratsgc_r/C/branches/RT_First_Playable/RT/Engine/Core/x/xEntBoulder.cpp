/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xEntBoulder.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80050B94 -> 0x800539A4
*/
char __FUNCTION__$localstatic1$xMovePointGetPoint__FPC10xMovePointUs[19]; // size: 0x13, address: 0x80BFC770
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$update__Q24xhud6motiveFRQ24xhud6widgetf[7]; // size: 0x7, address: 0x80BFC784
char __FUNCTION__$localstatic1$category__Q24xhud6widgetFv[9]; // size: 0x9, address: 0x80BFC78C
char __FUNCTION__$localstatic1$reset__Q24zNPC11zNPCBaseIN2Fv[6]; // size: 0x6, address: 0x80BFC798
char __FUNCTION__$localstatic1$ShouldEscapeGrab__Q24zNPC10zNPCCommonFv[17]; // size: 0x11, address: 0x80BFC7A0
// total size: 0xC
struct xModelPool {
    // Members
...
union /* @class$1236xEntBoulder_cpp */ {
...
// total size: 0x4
struct /* @class$1097xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235xEntBoulder_cpp */ {
    // Members
...
static struct xEntCollis sBoulderCollis; // size: 0x5FC, address: 0x80A5D860
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFC7B4
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80050CB4 -> 0x80050DC8
void xEntBoulder_Render(struct xEnt * ent /* r30 */) {
    // Local variables
...
// Range: 0x80050DC8 -> 0x80050DE8
void xEntBoulder_Init(void * ent /* r0 */, void * asset /* r0 */) {}

// Range: 0x80050DE8 -> 0x80050E2C
void xEntBoulder_Init(struct xEntBoulder * ent /* r30 */, struct xEntAsset * asset /* r31 */) {}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x80416078
...
// total size: 0x10
struct /* @class$1484xEntBoulder_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80050E2C -> 0x80051040
void xEntBoulder_InitNoEntInit(struct xEntBoulder * ent /* r30 */, struct xEntAsset * asset /* r31 */) {
    // Local variables
    struct xEntBoulderAsset * basset; // r31
...
// Range: 0x80051040 -> 0x80051164
void xEntBoulder_ApplyForces(struct zPlayer * player /* r27 */, struct xEntCollis * collis /* r28 */) {
    // Local variables
    int i; // r30
    struct xVec3 f; // r1+0x10
    struct xEntBoulder * boul; // r29
    struct xEntDrive * drv; // r0
...
// total size: 0x4
struct /* @class$2259xEntBoulder_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2218xEntBoulder_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2219xEntBoulder_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2220xEntBoulder_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2217xEntBoulder_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2222xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1038xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040xEntBoulder_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041xEntBoulder_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042xEntBoulder_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043xEntBoulder_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044xEntBoulder_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946xEntBoulder_cpp */ {
    // Static members
...
// Range: 0x80051164 -> 0x80051194
void xEntBoulder_AddInstantForce(struct xEntBoulder * ent /* r3 */, struct xVec3 * force /* r0 */) {}

// Range: 0x80051194 -> 0x800511C4
void xEntBoulder_AddForce(struct xEntBoulder * ent /* r3 */, struct xVec3 * force /* r0 */) {}

// Range: 0x800511C4 -> 0x800511C8
void xEntBoulder_BUpdate() {}

// Range: 0x800511C8 -> 0x8005122C
void xEntBoulder_RealBUpdate(struct xEnt * ent /* r3 */, struct xVec3 * pos /* r30 */) {
    // Local variables
    struct xEntBoulder * boul; // r31
    struct xVec3 rotatedLC; // r1+0x8
}
...
// Range: 0x8005122C -> 0x80051FC0
void xEntBoulder_Update(struct xEntBoulder * ent /* r25 */, struct xScene * sc /* r26 */, float dt /* f30 */) {
    // Local variables
    int i; // r30
    struct xVec3 rotatedLC; // r1+0x9C
    struct xVec3 oldPos; // r1+0x90
    struct xVec3 sweptDisp; // r1+0x84
    unsigned char definitelyBounce; // r29
    float sweptDistSqr; // f0
    float penAllowed; // f29
    struct xSweptSphere sws; // r1+0x1C0
    float scaleBack; // f29
    int numDepens; // r28
    struct xVec3 depen; // r1+0x78
    float penComp; // f0
    struct xEnt * optr; // r3
    float penComp; // f0
    struct xEnt * xb; // r27
    struct xEntBoulder * boul; // r27
    struct xVec3 force; // r1+0x6C
    struct xVec3 toAdd; // r1+0x60
    float v1; // f0
    float v2; // f0
    struct xEnt * optr; // r3
    float penComp; // f0
    struct xEnt * xb; // r4
    float hitParams[6]; // r1+0xC0
    class zNPCBaseIN2 * npc; // r27
    float penComp; // f0
    float hitParams[6]; // r1+0xA8
    struct zPlayer * player; // r1+0x14
    struct xVec3 playerDepen; // r1+0x54
    float penComp; // f0
    struct xVec3 newVel; // r1+0x48
    float newMag; // f0
    float oldMag; // f29
    struct xVec3 depenNorm; // r1+0x3C
    float depenComp; // f31
    float afterBounce; // f0
    struct xVec3 fricComp; // r1+0x30
    struct xMat4x3 baseMatrix; // r1+0x180
    struct xVec3 vForcedRotationAxis; // r1+0x24
    float fMagnitudeAgainstAxis; // f0
    struct xVec3 newRotVec; // r1+0x18
    float newAngVel; // f4
    struct xMat3x3 rotM; // r1+0x150
    float vol; // r1+0x10
...
// Range: 0x80051FC0 -> 0x80052124
int xEntBoulder_KilledBySurface(struct xEntBoulder * ent /* r29 */) {
    // Local variables
    struct xCollis * coll; // r31
    struct xCollis * cend; // r30
    struct xSurface * surf; // r0
    struct zSurfaceProps * prop; // r5
}

// Range: 0x80052124 -> 0x80052180
void xEntBoulder_Kill(struct xEntBoulder * ent /* r31 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFC7CC
// Range: 0x80052180 -> 0x80052238
void xEntBoulder_Setup(struct xEntBoulder * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x80052238 -> 0x80052338
void xEntBoulder_Reset(struct xEntBoulder * ent /* r31 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC7E0
union FloatAndVoid {
    float f; // offset 0x0, size 0x4
    void * v; // offset 0x0, size 0x4
};
// Range: 0x80052338 -> 0x800526DC
void xEntBoulderEventCB(struct xBase * from /* r30 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */) {
    // Local variables
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFC7F4
// Range: 0x800526DC -> 0x800527F4
static int RecurseLinks(const struct xLinkAsset * link /* r3 */, int count /* r27 */, struct xEntBoulder * * boulList /* r28 */) {
    // Local variables
    int i; // r30
    int numInList; // r1+0x8
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFC804
// Range: 0x800527F4 -> 0x80052928
static void RecurseChild(struct xBase * child /* r3 */, struct xEntBoulder * * boulList /* r30 */, int & currBoul /* r31 */) {
    // Local variables
    unsigned int i; // r28
    unsigned int cnt; // r0
    struct xGroup * grp; // r27
    struct xBase * grpitem; // r26

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFC814
// Range: 0x80052928 -> 0x80052AAC
void xBoulderGenerator_Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFC82C
// total size: 0x48
...
// Range: 0x80052CD8 -> 0x80052D50
void xBoulderGenerator_Reset(struct xBoulderGenerator * bg /* r28 */) {
    // Local variables
    int i; // r29
}

// Range: 0x80052D50 -> 0x80052D94
static void BoulderGen_GiveBirth(struct xBoulderGenerator * bg /* r0 */, int indx /* r0 */) {
    // Local variables
    int i; // r8
}

// Range: 0x80052D94 -> 0x80052F00
static int GetBoulderForGenerating(struct xBoulderGenerator * bg /* r26 */) {
    // Local variables
    int i; // r30
    int j; // r29
    int oldestCulled; // r28
    int minAge; // r27
    int numList; // r0
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80416094
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x80052F00 -> 0x80053198
void xBoulderGenerator_Launch(struct xBoulderGenerator * bg /* r27 */, struct xVec3 * pnt /* r28 */, float t /* f31 */) {
    // Local variables
    int i; // r30
    struct xEntBoulder * b; // r29
    struct xEnt * genEnt; // r0
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x804160B0
// Range: 0x80053198 -> 0x80053560
void xBoulderGenerator_EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    struct xBoulderGenerator * bg; // r31
...
// Range: 0x80053560 -> 0x800539A4
void xBoulderGenerator_GenBoulder(struct xBoulderGenerator * bg /* r28 */) {
    // Local variables
    int i; // r30
    struct xEntBoulder * b; // r29
    struct xEnt * genEnt; // r0
