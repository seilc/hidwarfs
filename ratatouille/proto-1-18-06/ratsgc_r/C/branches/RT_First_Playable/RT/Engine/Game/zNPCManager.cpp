/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80282584 -> 0x802836A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNPCManagerInitialized; // size: 0x1, address: 0x80C093C0
class zNPCManager * gNPCManager; // size: 0x4, address: 0x80C093C4
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C05A50
// Range: 0x80282584 -> 0x80282624
void zNPCManagerStartup() {
    // References
    // -> unsigned char gNPCManagerInitialized;
    // -> class zNPCManager * gNPCManager;
    // -> static char __FUNCTION__[19];
}

// Range: 0x80282624 -> 0x8028267C
void zNPCManagerShutdown() {
    // Local variables
    class zNPCManager * mgr; // r31
...
// Range: 0x8028267C -> 0x802826A0
void zNPCManagerSceneInit() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x802826A0 -> 0x802826D4
void zNPCManagerScenePrepare(int npccnt /* r31 */) {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x802826D4 -> 0x802826F8
void zNPCManagerSceneFinish() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x802826F8 -> 0x8028271C
void zNPCManagerSceneExit() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x8028271C -> 0x80282740
void zNPCManagerSceneReset() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x80282740 -> 0x80282764
void zNPCManagerScenePostInit() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x80282764 -> 0x80282788
void zNPCManagerSceneSetup() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x80282788 -> 0x802827AC
void zNPCManagerSceneRender() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x802827AC -> 0x802827F0
void zNPCManagerSceneTimestep(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
    class zNPCManager * npcManager; // r0
}
...
// Range: 0x802827F0 -> 0x80282824
struct xAnimTable * zNPCManagerCreateAnimTable(enum eBrainType brainType /* r31 */) {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x80282824 -> 0x80282848
int zNPCManagerAllocateNPCs() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x80282848 -> 0x8028286C
void zNPCManagerLoadNPCs() {
    // Local variables
    class zNPCManager * npcManager; // r0
}

// Range: 0x8028286C -> 0x802828B0
void zNPCManagerRegisterNPCs(struct zScene * zscn /* r30 */, int * base_idx /* r31 */) {
    // Local variables
    class zNPCManager * npcManager; // r0
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80C05A64
// Range: 0x802828B0 -> 0x80282920
class zNPCManager * zNPCManagerInstance() {
    // References
    // -> class zNPCManager * gNPCManager;
...
// total size: 0x90
class zNPCManager : public RyzMemData {
    // Functions
    void Startup();
    ...
    void RegisterNPCs(int * base_idx);
    ...
    // Members
    struct xBase selfbase; // offset 0x0, size 0x10
    class zNPCBase * NPCs[16]; // offset 0x10, size 0x40
    int numberOfNPC[16]; // offset 0x50, size 0x40
};
// total size: 0x4C
struct zNPCTypesTable {
    // Members
    enum eNPCType npcType; // offset 0x0, size 0x4
    enum eBrainType brainType; // offset 0x4, size 0x4
    const char * dynAssetTypeName; // offset 0x8, size 0x4
    enum eNPCType childrenType; // offset 0xC, size 0x4
    unsigned char isChildNPC; // offset 0x10, size 0x1
    class zNPCBase * (* allocateNPCFunction)(int); // offset 0x14, size 0x4
    unsigned char (* validateAssetFunction)(struct xDynAsset *, unsigned int, char *); // offset 0x18, size 0x4
    const char * name; // offset 0x1C, size 0x4
    void (* addDebugTweaksFunction)(char *); // offset 0x20, size 0x4
    void (* createAnimTableFunction)(struct xAnimTable *); // offset 0x24, size 0x4
    void (* combatDamageInitFunction)(); // offset 0x28, size 0x4
    void (* compParametersInitFunction)(); // offset 0x2C, size 0x4
    int (* countChildrenInAsset)(struct xDynAsset *, unsigned int, char *); // offset 0x30, size 0x4
    void (* sceneInitFunction)(); // offset 0x34, size 0x4
    void (* scenePrepareFunction)(); // offset 0x38, size 0x4
    void (* sceneSetupFunction)(); // offset 0x3C, size 0x4
    void (* sceneResetFunction)(); // offset 0x40, size 0x4
    void (* sceneExitFunction)(); // offset 0x44, size 0x4
    unsigned int hashDynAssetTypeName; // offset 0x48, size 0x4
};
// Range: 0x80282920 -> 0x80282998
// this: r31
void zNPCManager::Startup() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x80282998 -> 0x80282A10
void zNPCManager::SetupTweaks() {
    // Local variables
    char buffer[256]; // r1+0x8
    const struct zNPCTypesTable * npcTypesTableEntry; // r30
}

// Range: 0x80282A10 -> 0x80282A14
void zNPCManager::Shutdown() {}

// Range: 0x80282A14 -> 0x80282A68
void zNPCManager::SceneInit() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x80282A68 -> 0x80282AEC
void zNPCManager::ScenePrepare() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x80282AEC -> 0x80282AF0
void zNPCManager::SceneFinish() {}

// Range: 0x80282AF0 -> 0x80282B44
void zNPCManager::SceneExit() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x80282B44 -> 0x80282B48
void zNPCManager::ScenePostInit() {}

// Range: 0x80282B48 -> 0x80282B9C
void zNPCManager::SceneSetup() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

static unsigned char done; // size: 0x1, address: 0x80C093C8
static signed char init; // size: 0x1, address: 0x80C093C9
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05A78
enum eNPCType {
    eNPCType_None = -1,
    eNPCType_Unknown = -1,
    eNPCType_First = 0,
...
// Range: 0x80282B9C -> 0x80282C94
struct xAnimTable * zNPCManager::CreateAnimTable(enum eBrainType brainType /* r4 */) {
    // Local variables
    enum eNPCType npcType; // r31
    struct xAnimTable * table; // r31
    const struct zNPCTypesTable * npcTypeTableEntry; // r0
...
// total size: 0x4
struct /* @class$1085zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1301zNPCManager_cpp */ {
    // Members
...
union /* @class$820zNPCManager_cpp */ {
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C05A88
// Range: 0x80282C94 -> 0x80282DC8
// this: r31
int zNPCManager::AllocateNPCs() {
    // Local variables
    int totalNPCCount; // r29
    const struct zNPCTypesTable * npcTypesTableEntry; // r28
    enum eNPCType curNPCType; // r30

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C05A98
// Range: 0x80282DC8 -> 0x80283018
int zNPCManager::FindNumberOfNPCs(int * typeCount /* r25 */) {
    // Local variables
    int i; // r0
    int NPCNumber; // r29
    int num_alldyn; // r0
    int i; // r28
    unsigned int dynAssetSize; // r1+0x8
    const struct xDynAsset * dynAsset; // r27
    const struct zNPCTypesTable * npcTypesTableEntry; // r26
    enum eNPCType curNPCType; // r24
    int numChildren; // r3
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05AAC
// Range: 0x80283018 -> 0x80283238
// this: r31
void zNPCManager::LoadNPCs() {
    // Local variables
    int curNPCNum[16]; // r1+0xC
    int i; // r0
    int num_alldyn; // r0
    int i; // r24
    unsigned int dynAssetSize; // r1+0x8
    const struct xDynAsset * dynAsset; // r23
    const struct zNPCTypesTable * npcTypesTableEntry; // r26
    enum eNPCType curNPCType; // r5
    class zNPCBase * curNPC; // r22
    int numChildren; // r21
    class zNPCBase * firstChildNPC; // r20
    int j; // r19
    class zNPCBase * curChildNPC; // r18

    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05AB8
// Range: 0x80283238 -> 0x80283410
void zNPCManager::LoadNPC(class zNPCBase * npc /* r28 */, enum eNPCType type /* r29 */, const struct xDynAsset * dynAsset /* r30 */, unsigned int dynAssetSize /* r31 */) {
    // Local variables
    struct xEntAsset * entass; // r0
    unsigned int size; // r1+0x8
    struct xModelAssetInfo * modelInfoAssetMINF; // r26
    struct xModelAssetInfo * modelInfoAsset; // r5
...
// Range: 0x80283410 -> 0x8028349C
// this: r3
void zNPCManager::RegisterNPCs(int * base_idx /* r26 */) {
    // Local variables
    unsigned int npcType; // r29
    int i; // r28
    class zNPCBase * curNPC; // r27
}

// Range: 0x8028349C -> 0x80283530
// this: r3
void zNPCManager::SceneRender() {
    // Local variables
    unsigned int npcType; // r29
    int i; // r28
}

// Range: 0x80283530 -> 0x802835F4
// this: r3
...
// total size: 0x10
struct /* @class$2030zNPCManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802835F4 -> 0x802836A8
// this: r27
void zNPCManager::SceneTimestep(struct xScene * xscn /* r26 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 * playerPos; // r29
    unsigned int npcType; // r28
    int i; // r27
...
// total size: 0x4
struct /* @class$2466zNPCManager_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2425zNPCManager_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2426zNPCManager_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2427zNPCManager_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2424zNPCManager_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2429zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1026zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zNPCManager_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zNPCManager_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zNPCManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zNPCManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zNPCManager_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2277zNPCManager_cpp */ {
    // Static members
