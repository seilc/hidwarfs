/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUIUVs.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021FB28 -> 0x8021FD3C
*/
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04388
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8021FB28 -> 0x8021FD3C
float * zUIUVs_Init(struct RpAtomic * atomic /* r0 */, unsigned int & texCoordsCount /* r27 */) {
    // Local variables
    float * uvCoords; // r31
    struct RpGeometry * geom; // r30
    struct RwTexCoords * c; // r29
    int i; // r4
    int numVerts; // r28
    float * uv; // r27
