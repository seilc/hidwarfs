/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCineFXShared.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80260A54 -> 0x80261600
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x0
struct RpSkin {};
// Range: 0x80260A54 -> 0x80260AC0
void zCinFX_clamp_bone_index(int * index /* r30 */, struct RpAtomic * model /* r0 */) {
    // Local variables
    int bones; // r31
...
// total size: 0x54
struct /* @class$1813zCineFXShared_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1093zCineFXShared_cpp */ {
    // Members
...
union /* @class$828zCineFXShared_cpp */ {
...
// total size: 0xC
struct /* @class$1276zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1034zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1035zCineFXShared_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1036zCineFXShared_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1037zCineFXShared_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1038zCineFXShared_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1039zCineFXShared_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1040zCineFXShared_cpp */ {
    // Members
...
// Range: 0x80260AC0 -> 0x80260C28
void zCinFX_IndexInput_Twk(const char * prefix_root /* r3 */, struct NCINEntry * fxrec /* r31 */) {
    // Local variables
    char prefix_base[128]; // r1+0x288
...
// Range: 0x80260C28 -> 0x80260D90
void zCinFX_BasicInput_Twk(const char * prefix_root /* r3 */, struct NCINEntry * fxrec /* r31 */) {
    // Local variables
    char prefix_base[128]; // r1+0x288
    char prefix[128]; // r1+0x208
...
// Range: 0x80260D90 -> 0x80260DBC
void zCinFX_BoneProbe_Upd(struct NCINEntry * fxrec /* r0 */, int killit /* r0 */) {}
...
// Range: 0x80260DBC -> 0x80261084
void zCinFX_BoneProbe_AR(struct NCINEntry * fxrec /* r27 */, struct RpAtomic * model /* r0 */, struct RwMatrixTag * animMat /* r28 */, unsigned int animIndex /* r0 */) {
    // Local variables
    struct xVec3 pnt1; // r1+0x38
    struct xVec3 pnt2; // r1+0x2C
...
// Range: 0x80261084 -> 0x80261234
void zCinFX_BoneProbe_Twk(const char * prefix_root /* r3 */, struct NCINEntry * fxrec /* r30 */) {
    // Local variables
    char prefix_base[128]; // r1+0x308
    char prefix[128]; // r1+0x288
    struct PosInput * pi; // r31
...
// Range: 0x80261234 -> 0x80261600
void zCinFX_EntityBonePar_AR(struct NCINEntry * fxrec /* r25 */, struct RpAtomic * model /* r5 */, struct RwMatrixTag * animMat /* r26 */, unsigned int animIndex /* r0 */) {
    // Local variables
    float dt; // f31
    struct xParEmitter * pe; // r31
    struct xParEmitterAsset * a; // r30
    struct xParEmitterPropsAsset * prop; // r29
    struct xParSys * ps; // r28
    struct xParGroup * g; // r24
    int rate_has_elapsed; // r5
    float rate; // f0
    int count; // r27
    float life; // f0
    float size_birth; // f0
    float size_death; // f0
    struct xMat4x3 bone_mat; // r1+0x40
    struct xVec3 oldloc; // r1+0x34
    struct xVec3 loc; // r1+0x28
    struct xVec3 vel; // r1+0x1C
    struct xVec3 add_vel; // r1+0x10
    int i; // r24
    struct xPar * p; // r23
    int c; // r22
    float fc1; // f0
