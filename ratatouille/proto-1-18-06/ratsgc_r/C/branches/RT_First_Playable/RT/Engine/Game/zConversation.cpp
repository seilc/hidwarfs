/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zConversation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021D714 -> 0x8021E360
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float dampValue; // size: 0x4, address: 0x80C04318
static float dampFadeInVel; // size: 0x4, address: 0x80C08F38
static float dampFadeOutVel; // size: 0x4, address: 0x80C08F3C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8021D714 -> 0x8021D740
static void EventHandlerWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}
...
static class zConversationManager manager; // size: 0x3C, address: 0x80BC5248
enum xJawSpeaker {
    exJawSpeaker_Remy = 0,
    exJawSpeaker_Count = 1,
};
// Range: 0x8021D740 -> 0x8021D770
// this: r0
static float zConversationManager::GetJaw(enum xJawSpeaker speaker /* r0 */) {}

// Range: 0x8021D770 -> 0x8021D7C0
// this: r31
static void zConversationManager::Init() {}

// Range: 0x8021D7C0 -> 0x8021D808
// this: r31
static void zConversationManager::Reset() {}

// Range: 0x8021D808 -> 0x8021D884
// this: r31
static void zConversationManager::ClearConversation() {}

// Range: 0x8021D884 -> 0x8021D89C
// this: r0
...
// total size: 0x4
struct /* @class$1336zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1474zConversation_cpp */ {
    // Members
...
union /* @class$1475zConversation_cpp */ {
...
// total size: 0x10
struct /* @class$1723zConversation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8021D89C -> 0x8021D944
// this: r29
static void zConversationManager::Play(class zConversation * conversation /* r30 */, const struct xBase * otherSpeakerBase /* r31 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0431C
...
// total size: 0xC
struct /* @class$1210zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1211zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1212zConversation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1213zConversation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1214zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1215zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1216zConversation_cpp */ {
    // Members
...
// Range: 0x8021D944 -> 0x8021DBB8
// this: r29
static unsigned char zConversationManager::Play(enum iSndGroupHandle groupHandle /* r28 */, const struct xBase * otherSpeakerBase /* r30 */, class zConversation * conversation /* r31 */) {
    // Local variables
    unsigned int soundID; // r28
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C04324
// Range: 0x8021DBB8 -> 0x8021DE10
// this: r31
...
// total size: 0x890
struct /* @class$1989zConversation_cpp */ {
    // Static members
...
// Range: 0x8021DF6C -> 0x8021DF98
// this: r0
static void zConversationManager::Stop(class zConversation * conversation /* r0 */) {}
...
// Range: 0x8021DF98 -> 0x8021DF9C
static void zConversationManager::Exit() {}

// Range: 0x8021DF9C -> 0x8021DFEC
...
// Range: 0x8021DFEC -> 0x8021E018
float zConversationGetJaw(enum xJawSpeaker speaker /* r4 */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x8021E018 -> 0x8021E040
unsigned char zConversationIsConversing() {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x8021E040 -> 0x8021E078
void zConversationPlay(enum iSndGroupHandle soundGroup /* r0 */, const struct xBase * otherSpeakerBase /* r4 */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x8021E078 -> 0x8021E0F4
// this: r30
zConversation::zConversation(const struct zConversationAsset & myAsset /* r31 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04338
// Range: 0x8021E0F4 -> 0x8021E288
void zConversation::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04340
// Range: 0x8021E288 -> 0x8021E360
// this: r30
void zConversation::HandleEvent(unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r31 */) {
    // References
    // -> static class zConversationManager manager;
...
struct {} @unnamed@zConversation_cpp@::zConversationManager::__vtable; // size: 0x24, address: 0x8043F718
// total size: 0x4
