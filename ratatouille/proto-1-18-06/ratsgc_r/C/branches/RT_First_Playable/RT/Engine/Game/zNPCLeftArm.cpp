/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCLeftArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A44C4 -> 0x802A4648
*/
char __FUNCTION__$localstatic1$AttachComponent__59zComponentPool<17zCompLogicLeftArm,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06248
signed char zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C095F0
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C095F4
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// total size: 0x68
class zNPCLeftArm : public zNPCBase {
    // Functions
...
// Range: 0x802A44C4 -> 0x802A4540
// this: r31
unsigned char zNPCLeftArm::Activate() {}
...
// Range: 0x802A4540 -> 0x802A4608
// this: r28
void zNPCLeftArm::Update(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1173zNPCLeftArm_cpp */ {
    // Members
...
union /* @class$1313zNPCLeftArm_cpp */ {
...
// total size: 0xC
struct /* @class$1311zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1050zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1051zNPCLeftArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1052zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1053zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1054zNPCLeftArm_cpp */ {
    // Members
...
// Range: 0x802A4608 -> 0x802A4648
// this: r31
void zNPCLeftArm::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zNPCLeftArm::__vtable; // size: 0x30, address: 0x80447848
