/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHitParameters.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80131790 -> 0x80131820
*/
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
...
unsigned int zHitSourceCCs[65]; // size: 0x104, address: 0x8043A2B8
// Range: 0x80131790 -> 0x80131820
int getSourceCCIdx(unsigned int value /* r29 */) {
    // Local variables
    int i; // r30
    char tag[4]; // r1+0x8
