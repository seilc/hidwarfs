/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamPool.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80243B50 -> 0x80243E00
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zCamPoolBase {
    ...
    void AddCamera(struct xCam * newCam, const char * tweakPrefix);

    struct xCam * GetNextCamera();

    void CheckCameraFlags();
...
// Range: 0x80243B50 -> 0x80243B60
// this: r0
zCamPoolBase::zCamPoolBase() {}

// Range: 0x80243B60 -> 0x80243BD4
// this: r29
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C04B70
// Range: 0x80243BD4 -> 0x80243CBC
// this: r29
void zCamPoolBase::AddCamera(struct xCam * newCam /* r30 */, const char * tweakPrefix /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static int depth; // size: 0x4, address: 0x80C09160
static signed char init; // size: 0x1, address: 0x80C09164
// Range: 0x80243CBC -> 0x80243D78
// this: r28
struct xCam * zCamPoolBase::GetNextCamera() {
    // Local variables
    int i; // r30
    struct xCam * cam; // r29
...
// Range: 0x80243D78 -> 0x80243E00
// this: r28
void zCamPoolBase::CheckCameraFlags() {
    // Local variables
    int i; // r29
}
