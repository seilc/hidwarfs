/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zDispatcher.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80109254 -> 0x8010B3E8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$GetState__17zCompStateMachineFi[9]; // size: 0x9, address: 0x80BFFF98
char __FUNCTION__$localstatic1$GetCurrentStateEnum__17zCompStateMachineFv[20]; // size: 0x14, address: 0x80BFFFA4
static int g_zdsp_init; // size: 0x4, address: 0x80C07C20
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct st_ZDISPATCH_DEPOT g_zdsp_depot; // size: 0x8, address: 0x80BFFFB8
// total size: 0x6
struct /* @class$2236zDispatcher_cpp */ {
    // Members
...
static struct World worlds[20]; // size: 0x4D8, address: 0x80B8F650
static signed short currentWorld; // size: 0x2, address: 0x80C07C24
static signed short currentTask; // size: 0x2, address: 0x80C07C26
static signed short currentPointer; // size: 0x2, address: 0x80C07C28
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x80109254 -> 0x801094FC
void zDispatcherParseINI(struct xIniFile * ini /* r25 */) {
    // Local variables
    int i; // r27
    char itemName[16]; // r1+0xC
    char value[256]; // r1+0x1C
    const char * value_; // r3
    int j; // r26
    char * ltok; // r1+0x8
    char * tok; // r0
...
// Range: 0x801094FC -> 0x80109500
void zDispatcher_Startup() {}

// Range: 0x80109500 -> 0x80109504
void zDispatcher_Shutdown() {}

// Range: 0x80109504 -> 0x80109544
void zDispatcher_scenePrepare() {
    // Local variables
    struct st_ZDISPATCH_DEPOT * depot; // r3
...
// Range: 0x801095FC -> 0x80109608
struct st_ZDISPATCH_DATA * zDispatcher_getInst(struct st_ZDISPATCH_DATA * pool /* r3 */, int idx /* r0 */) {}

// Range: 0x80109608 -> 0x8010963C
void zDispatcher_Init(struct st_ZDISPATCH_DATA * dspdata /* r31 */, struct xBaseAsset * bass /* r0 */) {}
...
// total size: 0x4
struct /* @class$1120zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1276zDispatcher_cpp */ {
    // Members
...
union /* @class$855zDispatcher_cpp */ {
...
// Range: 0x8010963C -> 0x8010965C
void zDispatcher_InitDep(struct st_ZDISPATCH_DATA * dspdata /* r0 */, struct zScene * zscn /* r0 */) {}
...
// Range: 0x8010965C -> 0x8010967C
void zDispatcher_Save(struct st_ZDISPATCH_DATA * dspdata /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8010967C -> 0x8010969C
void zDispatcher_Load(struct st_ZDISPATCH_DATA * dspdata /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8010969C -> 0x80109710
static void ZDSP_instInit(struct st_ZDISPATCH_DATA * dspdata /* r30 */, struct xBaseAsset * bass /* r31 */) {}

// Range: 0x80109710 -> 0x80109714
static void ZDSP_instInitDep() {}

// Range: 0x80109714 -> 0x8010977C
static void ZDSP_instReset(struct st_ZDISPATCH_DATA * dspdata /* r29 */, struct zScene * zscn /* r30 */) {
    // Local variables
    struct xBaseAsset * hold_rawass; // r31
}

// Range: 0x8010977C -> 0x80109780
...
// Range: 0x80109780 -> 0x801097AC
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r0 */, enum en_DISPATCH_COMMAND cmd /* r0 */) {}

// Range: 0x801097AC -> 0x801097DC
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r0 */, enum en_DISPATCH_COMMAND cmd /* r0 */, int indata /* r1+0x8 */) {}
...
// Range: 0x801097DC -> 0x80109890
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r0 */, enum en_DISPATCH_COMMAND cmd /* r28 */, void * indata /* r29 */, void * inxtra /* r30 */, void * result /* r31 */) {
    // Local variables
    struct st_ZDISPATCH_CONTEXT cmdctxt; // r1+0x8
    int rc; // r0
}

static int warned; // size: 0x4, address: 0x80C07C2C
static signed char init; // size: 0x1, address: 0x80C07C30
// total size: 0x38
...
static struct effectAsset effectAsset; // size: 0x38, address: 0x80B8FB28
static signed char init; // size: 0x1, address: 0x80C07C31
// total size: 0x18
...
static struct effect effect; // size: 0x18, address: 0x80C07C34
static struct effectAsset effectAsset; // size: 0x38, address: 0x80B8FB60
static signed char init; // size: 0x1, address: 0x80C07C4C
static struct effect effect; // size: 0x18, address: 0x80C07C50
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFFFC0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1798zDispatcher_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80109890 -> 0x80109FD0
static int ZDSP_doCommand(struct st_ZDISPATCH_CONTEXT * cmdCtxt /* r0 */) {
    // Local variables
    int iv; // r31
    enum en_DISPATCH_COMMAND cmd; // r31
    void * indata; // r30
    void * result; // r29
...
// total size: 0xC
struct /* @class$1061zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1062zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1063zDispatcher_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1064zDispatcher_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1065zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1066zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1067zDispatcher_cpp */ {
    // Members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFFFD0
...
// Range: 0x80109FD0 -> 0x8010B258
void ZDSP_elcb_event(struct xBase * from /* r29 */, struct xBase * xb /* r4 */, unsigned int toEvent /* r27 */, const float * toParam /* r26 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r25 */) {
    // Local variables
    struct st_ZDISPATCH_DATA * dspdata; // r31
    int old_vibration; // r27
    int padPort; // r27
    int old_vibration; // r27
    int padPort; // r27
    struct zPlayerCheckPoint checkPoints[4]; // r1+0x8
    struct xGroup * pointerGroup; // r0
    int i; // r26
    struct pointer_asset * pointerAsset; // r25
    struct pointer_asset * pointerAsset; // r0
    char events[512]; // r1+0x248
    unsigned int c; // r25
    unsigned int len; // r26
    unsigned int i; // r25
    char log[512]; // r1+0x48
    enum eFMVFile fmv; // r25
    const struct zFMVFile * file; // r0
    unsigned int buttons; // r25
...
// total size: 0x890
struct /* @class$2045zDispatcher_cpp */ {
    // Static members
...
// Range: 0x8010B258 -> 0x8010B2D8
static void WRAP_xsnd_setMusicVolume(int volLevel /* r0 */) {
    // Local variables
    float flt_snd; // f1
}

// Range: 0x8010B2D8 -> 0x8010B358
static void WRAP_xsnd_setSFXVolume(int volLevel /* r0 */) {
    // Local variables
    float flt_snd; // f1
}

// Range: 0x8010B358 -> 0x8010B3E8
void zDispatcher_FindWorldTask(unsigned int sceneID /* r0 */, int & world /* r0 */, int & task /* r0 */) {
    // Local variables
