/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iAsync.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800D6014 -> 0x800D6334
*/
// total size: 0x8
struct RwLLLink {
    // Members
...
struct RwLinkList asyncDirtyFrameList; // size: 0x8, address: 0x80C07898
unsigned char asyncThreadDone; // size: 0x1, address: 0x80BFEE30
// total size: 0x2C8
struct OSContext {
    // Members
...
struct OSThread asyncThread; // size: 0x318, address: 0x80AA6CE8
static unsigned char ThreadStack[8192]; // size: 0x2000, address: 0x80AA7000
unsigned int asyncStartFrame; // size: 0x4, address: 0x80C078A0
// total size: 0xC
struct OSSemaphore {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFEE34
unsigned int gFrameCount; // size: 0x4, address: 0x80C06F38
// Range: 0x800D6014 -> 0x800D6134
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFEE40
// Range: 0x800D6134 -> 0x800D61B4
int iAsyncIsDone() {
    // References
    // -> unsigned char asyncThreadDone;
...
// Range: 0x800D61F0 -> 0x800D6218
void iAsyncBeginUpdate() {}

// Range: 0x800D6218 -> 0x800D6244
void iAsyncEndUpdate() {}

// Range: 0x800D6244 -> 0x800D6298
void iAsyncSuspend() {
    // References
    // -> struct OSThread asyncThread;
    // -> unsigned char asyncThreadDone;
