/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCCoverPoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020F1F4 -> 0x8020FAC8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C03FF8
// Range: 0x8020F1F4 -> 0x8020F528
static void sNPCCoverPointFindNPC(class zNPCCoverPoint * coverPoint /* r25 */, struct xGroup * coverPointGroup /* r26 */, struct xGroup * npcGroup /* r27 */) {
    // Local variables
    int npcIter; // r29
    int cpCheckIter; // r22
    int bestNPC; // r28
    ...
    class zNPCCommon * npcCheck; // r0
    class zNPCCoverPoint * coverPointCheck; // r21
    unsigned char bestFlag; // r20
    unsigned char replacedFlag; // r20
...
// total size: 0x2C
struct zNPCCoverPointAsset : public xDynAsset {
    // Static members
    static int VERSION; // size: 0x4

    // Members
    struct xVec3 location; // offset 0x10, size 0xC
    float directionYaw; // offset 0x1C, size 0x4
    float directionPitch; // offset 0x20, size 0x4
    float directionRoll; // offset 0x24, size 0x4
    unsigned int assetID; // offset 0x28, size 0x4
};
// total size: 0x50
...
// total size: 0x4
struct /* @class$1124zNPCCoverPoint_cpp */ {
    // Members
...
union /* @class$1263zNPCCoverPoint_cpp */ {
...
// total size: 0xC
struct /* @class$1262zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2251zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2210zNPCCoverPoint_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zNPCCoverPoint_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2212zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2209zNPCCoverPoint_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2214zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1579zNPCCoverPoint_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1065zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1066zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1068zNPCCoverPoint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1069zNPCCoverPoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1070zNPCCoverPoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1071zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x2C
class zNPCCoverPoint : public xBase {
    // Functions
    unsigned char Seize(class zNPCCommon * seizer);

    unsigned char Release(class zNPCCommon * releaser);

    // Members
protected:
    struct zNPCCoverPointAsset * coverPointAsset; // offset 0x10, size 0x4
    struct xEnt * coverObject; // offset 0x14, size 0x4
    class xPlane playerCrossPlane; // offset 0x18, size 0x10
    class zNPCCommon * seizedBy; // offset 0x28, size 0x4
};
// total size: 0x18
struct testNode {
    // Members
...
// total size: 0x890
struct /* @class$2033zNPCCoverPoint_cpp */ {
    // Static members
...
static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043F288
...
// Range: 0x8020F528 -> 0x8020F880
void zNPCCoverManageRetreatToCover(struct xBase * from /* r26 */, struct xGroup * npcGroup /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xGroup * coverPointGroup /* r30 */, unsigned int toParamWidgetID /* r31 */) {
    // Local variables
    int cpIter; // r24
    class zNPCCoverPoint * coverPoint; // r23
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04010
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8020F880 -> 0x8020FA84
void zNPCCoverPoint::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zNPCCoverPoint * newCP; // r0
    struct xMat3x3 eulerMat; // r1+0x10

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x8020FA84 -> 0x8020FAA4
// this: r0
unsigned char zNPCCoverPoint::Seize(class zNPCCommon * seizer /* r0 */) {}

// Range: 0x8020FAA4 -> 0x8020FAC8
// this: r0
unsigned char zNPCCoverPoint::Release(class zNPCCommon * releaser /* r0 */) {}
