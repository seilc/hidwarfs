/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCProjectileGrubFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80254B54 -> 0x80257610
*/
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig defaultConfig; // size: 0x44, address: 0x80BCB4E0
// total size: 0x1
class zNPCProjectileGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80254B54 -> 0x80254B58
void zNPCProjectileGrubTrail::AddStaticTweaks() {}

int systemID; // size: 0x4, address: 0x80C05068
// total size: 0x28
...
// total size: 0x4
struct /* @class$1097zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zNPCProjectileGrubFX_cpp */ {
    // Members
...
union /* @class$1236zNPCProjectileGrubFX_cpp */ {
...
// total size: 0x10
struct /* @class$1500zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1974zNPCProjectileGrubFX_cpp */ {
    // Static members
...
// Range: 0x80254C70 -> 0x80254EF0
int zNPCProjectileGrubTrail::Update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r31
    struct Particle * p; // r30
...
// Range: 0x80254EF0 -> 0x802551DC
void zNPCProjectileGrubTrail::Emit(float & emit_remaining /* r25 */, const struct xVec3 & position /* r26 */, const struct xVec3 & velocity /* r27 */, float dt /* f26 */, float scale /* f27 */, struct TrailConfig * cfg /* r28 */) {
    // Local variables
    float emit_rate; // f23
    float time_passed; // f28
    int emit; // r30
...
static struct TrailConfig defaultTConfig; // size: 0x38, address: 0x80BCB524
// total size: 0x1
class zNPCProjectileTGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x802551DC -> 0x802551E0
void zNPCProjectileTGrubTrail::AddStaticTweaks() {}

int systemID; // size: 0x4, address: 0x80C0506C
// Range: 0x802551E0 -> 0x802552E8
...
// Range: 0x802552E8 -> 0x80255534
int zNPCProjectileTGrubTrail::Update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r31
    struct Particle * p; // r30
    struct Particle * end; // r29
...
// Range: 0x80255598 -> 0x80255884
void zNPCProjectileTGrubTrail::Emit(float & emit_remaining /* r25 */, const struct xVec3 & position /* r26 */, const struct xVec3 & velocity /* r27 */, float dt /* f26 */, float scale /* f27 */, struct TrailConfig * cfg /* r28 */) {
    // Local variables
    float emit_rate; // f23
    float time_passed; // f28
    int emit; // r30
...
struct SparkConfig defaultSparkConfig; // size: 0x34, address: 0x80BCB55C
struct SparkConfig burstSparkConfig; // size: 0x34, address: 0x80BCB590
int systemID; // size: 0x4, address: 0x80C05070
// total size: 0x1
class zNPCProjectileGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80255884 -> 0x802559B4
...
// Range: 0x802559B4 -> 0x80255CD4
int zNPCProjectileGrubSparks::Update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r31
    struct Particle * p; // r30
    struct Particle * end; // r29
    struct RwSphere worldsph; // r1+0x8
...
// Range: 0x80255CD4 -> 0x80256028
void zNPCProjectileGrubSparks::Emit(float & emit_remaining /* r25 */, const struct xVec3 & position /* r26 */, const struct xVec3 & velocity /* r27 */, float dt /* f25 */, struct SparkConfig * cfg /* r28 */) {
    // Local variables
    float emit_rate; // f4
    float time_passed; // f26
    int emit; // r30
    struct Particle * p; // r1+0x8
    int count; // r0
    struct Particle * end; // r29
...
struct SparkConfig defaultESparkConfig; // size: 0x34, address: 0x80BCB5C4
struct SparkConfig burstESparkConfig; // size: 0x34, address: 0x80BCB5F8
int systemID; // size: 0x4, address: 0x80C05074
// total size: 0x1
class zNPCProjectileEGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80256028 -> 0x802561D8
...
// Range: 0x802561D8 -> 0x802564F8
int zNPCProjectileEGrubSparks::Update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r31
    struct Particle * p; // r30
    struct Particle * end; // r29
...
static struct ArcConfig defaultArcConfig; // size: 0x1C, address: 0x80BCB62C
int systemID; // size: 0x4, address: 0x80C05078
// total size: 0x1
class zNPCProjectileGrubArc {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x8025657C -> 0x80256648
...
// Range: 0x80256648 -> 0x80256960
int zNPCProjectileGrubArc::Update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r31
    struct Particle * p; // r30
    struct Particle * end; // r29
    unsigned char die; // r27
    struct xVec3 newPos; // r1+0x24
    struct xVec3 vertOffset; // r1+0x18
    struct RwSphere worldsph; // r1+0x8
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0507C
struct xVec3 m_Null; // size: 0xC, address: 0x80C0B540
// Range: 0x80256960 -> 0x80256BE8
void zNPCProjectileGrubArc::Emit(float & emit_remaining /* r24 */, const struct ArcConfig * cfg /* r25 */, struct xModelInstance * model /* r26 */, class zNPCProjectile * ownerGrub /* r27 */, float dt /* f29 */, int sysID /* r28 */) {
    // Local variables
    int emit; // r30
    float emit_rate; // f2
    struct Particle * p; // r1+0x8
...
static unsigned int HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x80C091D8
// total size: 0x10
...
static struct GrubHitExplosion * sHitExplosions; // size: 0x4, address: 0x80C091DC
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80256BE8 -> 0x80256C20
...
static char __FUNCTION__[41]; // size: 0x29, address: 0x804427D0
// Range: 0x80256C20 -> 0x80256D80
...
// Range: 0x80256D80 -> 0x80256E64
void zNPCProjectileGrubHitExplosionEmit(const struct xMat4x3 & mat /* r3 */) {
    // Local variables
    int i; // r6
...
// Range: 0x80256E64 -> 0x80256F20
void zNPCProjectileGrubHitExplosionUpdate(float dt /* f0 */) {
    // Local variables
    int i; // r0
    float scale; // f0
...
static unsigned int BIG_HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x80C091E0
float BIG_HIT_AWAY_KNOCKBACK; // size: 0x4, address: 0x80C05084
float BIG_HIT_UP_KNOCKBACK; // size: 0x4, address: 0x80C05088
// total size: 0x80
...
static struct GrubBigHitExplosion * sBigHitExplosions; // size: 0x4, address: 0x80C091E4
// total size: 0x10
struct _xFColor {
    // Members
...
static char __FUNCTION__[44]; // size: 0x2C, address: 0x804427FC
// Range: 0x80256FD4 -> 0x80257134
...
// total size: 0xC
struct /* @class$1038zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zNPCProjectileGrubFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zNPCProjectileGrubFX_cpp */ {
    // Members
...
// Range: 0x80257134 -> 0x8025747C
void zNPCProjectileGrubBigHitExplosionUpdate(float dt /* f31 */) {
    // Local variables
    int i; // r28
    float modelScale; // f0
    float fadeOut; // f0
...
// Range: 0x80257510 -> 0x80257540
void zNPCProjectileGrubFX_SceneSetup() {}

// Range: 0x80257540 -> 0x80257550
...
// Range: 0x80257550 -> 0x80257574
void zNPCProjectileGrubFX_SceneReset() {}

// Range: 0x80257574 -> 0x802575A8
void zNPCProjectileGrubFX_Update(float dt /* f31 */) {}

// Range: 0x802575A8 -> 0x802575CC
