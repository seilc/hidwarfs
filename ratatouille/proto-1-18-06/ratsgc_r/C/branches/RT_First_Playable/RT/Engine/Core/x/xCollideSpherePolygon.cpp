/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollideSpherePolygon.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80182624 -> 0x80183C20
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80182624 -> 0x80182718
unsigned char xSweptSphereToPoint(const struct xSweptSphere & sphere /* r30 */, const struct xVec3 & pt /* r0 */, struct xCollideSphereToPointResults & results /* r31 */) {
    // Local variables
    struct xVec3 to_pt; // r1+0x14
    float along_d0; // f0
    struct xVec3 proj_vec; // r1+0x8
    float dist_from_line_squ; // f0
    float sphere_radius_squ; // f0
    float forward_distance; // f0
    float along_d_impact; // f1
}
...
// Range: 0x80182718 -> 0x80182B7C
unsigned char xSweptSphereToLineSement(const struct xSweptSphere & sphere /* r28 */, const struct xVec3 & segment_start /* r29 */, const struct xVec3 & segment_dir /* r30 */, float segment_length /* f28 */, struct xCollideSphereToLineSegmentResults & results /* r31 */) {
    // Local variables
    class xPlane shear; // r1+0x2C
    float shear_normal_len2; // f0
    float sphere_height; // f0
    struct xVec3 shear_sphere_center; // r1+0x20
    struct xVec3 segment_start_to_sphere; // r1+0x14
    float proj_center_along_seg_d0; // f30
    float proj_center_along_seg_de; // f29
    float proj_center_along_seg_vel; // f0
    struct xVec3 segment_out_normal; // r1+0x8
    float proj_center_above_seg_d0; // f0
    float proj_center_above_seg_de; // f4
    float proj_center_above_seg_vel; // f0
    float sphere_intersect_radius; // f0
    float travel_total; // f2
    float travel_percent; // f2
    float impact_along_dist; // f1
    float travel_total; // f4
    float travel_percent; // f2
    float impact_along_dist; // f1
}
...
// total size: 0x4
struct /* @class$1088xCollideSpherePolygon_cpp */ {
    // Members
...
union /* @class$1236xCollideSpherePolygon_cpp */ {
...
// Range: 0x80182B7C -> 0x80182CD4
unsigned char xSweptSphereToPolygon(const struct xSweptSphere & sphere /* r27 */, const class xPlane & surface /* r28 */, const struct xEdge * edges /* r29 */, int num_edges /* r30 */, struct xCollideSphereToPolygonResults & results /* r31 */) {
    // Local variables
    float vertical_vel; // f0
    float vertical_d0; // f0
    float vertical_de; // f4
    float to_plane_move_dist; // f31
    struct xSweptSphere at_plane_sphere; // r1+0x8
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043CF98
// total size: 0x10
...
// Range: 0x80182CD4 -> 0x8018357C
static unsigned char PolygonTestSphereOnPlane(const class xPlane & surface /* r26 */, const struct xEdge * edges /* r27 */, int num_edges /* r28 */, const struct xSweptSphere & sphere /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */, float vertical_d0 /* f28 */) {
    // Local variables
    float above_edge_d0; // f0
    float above_edge_vel; // f0
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x60
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    struct xVec3 sphere_to_vertex; // r1+0x54
    float closest_dist_squ; // f28
    int i; // r31
    struct xVec3 sphere_to_vertex; // r1+0x48
    float closest_dist_squ; // f28
    struct xVec3 sphere_to_vertex; // r1+0x3C
    float closest_dist_squ; // f28
    struct xVec3 sphere_to_vertex; // r1+0x30
    float closest_dist_squ; // f28
    struct xVec3 sphere_to_vertex; // r1+0x24
    float closest_dist_squ; // f28
    int i; // r31
    struct xVec3 sphere_to_vertex; // r1+0x18
    float closest_dist_squ; // f28
    struct xVec3 sphere_to_vertex; // r1+0xC
    float closest_dist_squ; // f28
...
// Range: 0x8018357C -> 0x8018378C
static unsigned char PolygonTestAH0a(int i /* r26 */, float closest_dist_squ /* f29 */, const struct xEdge * edges /* r27 */, int num_edges /* r28 */, const struct xSweptSphere & sphere /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x24
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    float above_edge_d0; // f0
    struct xVec3 sphere_to_vert; // r1+0x18
    float new_dist_squ; // f0
    struct xVec3 sphere_to_vert; // r1+0xC
    float new_dist_squ; // f30
}

// Range: 0x8018378C -> 0x801838A4
static unsigned char PolygonTestAH0b(int i /* r27 */, float closest_dist_squ /* f30 */, const struct xEdge * edges /* r0 */, int num_edges /* r28 */, const struct xSweptSphere & sphere /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x18
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    struct xVec3 sphere_to_vert; // r1+0xC
    float new_dist_squ; // f31
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C01DF0
// Range: 0x801838A4 -> 0x80183AB8
static unsigned char PolygonTestAH0c(int i /* r25 */, float closest_dist_squ /* f29 */, const class xPlane & surface /* r26 */, const struct xEdge * edges /* r27 */, int num_edges /* r28 */, const struct xSweptSphere & sphere /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x24
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    float above_edge_d0; // f0
...
// Range: 0x80183AB8 -> 0x80183C20
static unsigned char PolygonTestBH0a(int i /* r25 */, float closest_dist_squ /* f30 */, const class xPlane & surface /* r26 */, const struct xEdge * edges /* r27 */, int num_edges /* r28 */, const struct xSweptSphere & sphere /* r29 */, struct xCollideSphereToPolygonResults & results /* r30 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x18
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    float above_edge_d0; // f0
