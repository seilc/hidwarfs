/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCSwarmOwl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BE0C0 -> 0x802BE290
*/
// total size: 0x68
...
// Range: 0x802BE0C0 -> 0x802BE0C8
int zNPCSwarmOwl::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {}

char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicSwarmOwl,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C067A0
signed char zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C097A8
...
class zComponentPool zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C097AC
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x802BE160 -> 0x802BE1DC
// this: r30
void zNPCSwarmOwl::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C067B0
// Range: 0x802BE1DC -> 0x802BE270
// this: r30
...
// Range: 0x802BE270 -> 0x802BE290
// this: r0
void zNPCSwarmOwl::Render() {}

// total size: 0x30
struct {} zNPCSwarmOwl::__vtable; // size: 0x30, address: 0x80448C48
