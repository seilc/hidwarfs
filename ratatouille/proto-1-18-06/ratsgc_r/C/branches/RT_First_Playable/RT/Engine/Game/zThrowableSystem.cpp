/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zThrowableSystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C0020 -> 0x801C314C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float THROW_MAX_ANGLE; // size: 0x4, address: 0x80C02C78
float SIN_THROW_MAX_ANGLE; // size: 0x4, address: 0x80C02C7C
float COS_THROW_MAX_ANGLE; // size: 0x4, address: 0x80C02C80
float TAN_THROW_MAX_ANGLE; // size: 0x4, address: 0x80C02C84
float DROP_ANGLE; // size: 0x4, address: 0x80C02C88
float SIN_DROP_ANGLE; // size: 0x4, address: 0x80C02C8C
float COS_DROP_ANGLE; // size: 0x4, address: 0x80C02C90
float THROW_MAX_TIME; // size: 0x4, address: 0x80C02C94
float THROW_TARGET_MAX_ANGLE; // size: 0x4, address: 0x80C02C98
float COS_THROW_TARGET_MAX_ANGLE; // size: 0x4, address: 0x80C02C9C
float SPLASH_MIN_DIST; // size: 0x4, address: 0x80C02CA0
float FALLING_DECELERATION_XZ; // size: 0x4, address: 0x80C02CA4
float FALLING_GRAVITY; // size: 0x4, address: 0x80C02CA8
static float carryDamageMultipliers[3]; // size: 0xC, address: 0x80C02CAC
static float carryRadiusMultipliers[3]; // size: 0xC, address: 0x80C02CB8
static unsigned int throwEffectFlags[3]; // size: 0xC, address: 0x80C0CEC8
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$1088zThrowableSystem_cpp */ {
    // Members
...
union /* @class$1236zThrowableSystem_cpp */ {
...
// total size: 0xC
struct /* @class$1235zThrowableSystem_cpp */ {
    // Members
...
static class zFXShockwaveConfig shockwaveConfig; // size: 0x18, address: 0x80C08A60
static float SHOCKWAVE_TIME; // size: 0x4, address: 0x80C02CC4
// total size: 0xC
struct curve_node {
    // Members
...
static unsigned char throwModelMapUnsorted; // size: 0x1, address: 0x80C08A78
// total size: 0x28
...
static struct StaticThrowableProperty staticThrowableProperties[3]; // size: 0x78, address: 0x8043DC50
// total size: 0xC
...
static struct ThrowableModelMap * throwModelMap; // size: 0x4, address: 0x80C08A7C
static unsigned int throwModelMapCount; // size: 0x4, address: 0x80C08A80
static unsigned int throwModelMapMaxCount; // size: 0x4, address: 0x80C08A84
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
static struct zThrowableProperty * throwProperties; // size: 0x4, address: 0x80C08A88
static unsigned int throwPropertiesCount; // size: 0x4, address: 0x80C08A8C
static unsigned int throwPropertiesMaxCount; // size: 0x4, address: 0x80C08A90
// Range: 0x801C0020 -> 0x801C0044
static int UintCompare(unsigned int a /* r0 */, unsigned int b /* r0 */) {}

// Range: 0x801C0044 -> 0x801C00CC
static struct zThrowableProperty * GetThrowableProperty(unsigned int id /* r1+0x8 */) {
    // Local variables
    const struct ThrowableModelMap * entry; // r0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02CC8
// total size: 0x80
struct RunningThrow {
    // Members
...
static struct RunningThrow * runningThrows; // size: 0x4, address: 0x80C08A98
static struct PointTarget * addedTargets; // size: 0x4, address: 0x80C08A9C
static unsigned int addedTargetsCount; // size: 0x4, address: 0x80C08AA0
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C02CD8
// Range: 0x801C00CC -> 0x801C0150
static void RadiansToDegrees(void * value /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C02CEC
// Range: 0x801C0150 -> 0x801C01D4
static void DegreesToRadians(void * value /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x801C01D4 -> 0x801C0214
...
// Range: 0x801C0270 -> 0x801C02B0
static void OnMaxThrowSpeedChange(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r5
...
// Range: 0x801C02B0 -> 0x801C02EC
static void OnMinThrowSpeedChange(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r4
...
static void OnDropVelocityChange(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r5
...
// Range: 0x801C032C -> 0x801C036C
static void OnRotationRateChange(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct StaticThrowableProperty * prop; // r5
...
static unsigned char sDrawThrowCollision; // size: 0x1, address: 0x80C08AA4
static unsigned char sDrawThrowTargeting; // size: 0x1, address: 0x80C08AA5
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801C036C -> 0x801C03B8
static void DestroyThrow(struct RunningThrow & thr /* r31 */) {}

static float SPARK_EMIT_PER_DIST; // size: 0x4, address: 0x80C02D00
static float SPARK_EMIT_DIST_RAND; // size: 0x4, address: 0x80C02D04
static float SPARK_DIR_VARIANCE_ANGLE; // size: 0x4, address: 0x80C02D08
static float SPARK_LIFETIME_MIN; // size: 0x4, address: 0x80C02D0C
static float SPARK_LIFETIME_RAND; // size: 0x4, address: 0x80C02D10
static float SPARK_VELOCITY_MIN; // size: 0x4, address: 0x80C02D14
static float SPARK_VELOCITY_RAND; // size: 0x4, address: 0x80C02D18
static float SPARK_SIZE_MIN; // size: 0x4, address: 0x80C02D1C
static float SPARK_SIZE_RAND; // size: 0x4, address: 0x80C02D20
static float GLINT_LENGTH_MIN; // size: 0x4, address: 0x80C02D24
static float GLINT_LENGTH_RAND; // size: 0x4, address: 0x80C02D28
static float GLINT_LENGTH_CLAMP_MIN; // size: 0x4, address: 0x80C02D2C
static float GLINT_LENGTH_CLAMP_RAND; // size: 0x4, address: 0x80C02D30
// total size: 0x28
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02D34
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801C0650 -> 0x801C0A68
static void EmitSparks(const struct xVec3 & start /* r24 */, const struct xVec3 & dir /* r25 */, float distance /* f26 */, float dt /* f27 */) {
    // Local variables
    int numParticles; // r29
    struct xVec3 * locList; // r28
    struct xVec3 * dirList; // r27
    float * lenVelList; // r26
    float cosangle; // f0
    struct xMat3x3 dirMat; // r1+0x10
    int particleCounter; // r23
    struct xVec3 * locPtr; // r22
    struct xVec3 * dirPtr; // r21
    float * lenPtr; // r20
    float ang; // f22
    float uz; // f21
    float r; // f0
...
static struct smoke_config smokeConfig; // size: 0x38, address: 0x80BB6938
struct smoke_config default_config; // size: 0x38, address: 0x80BB6718
// Range: 0x801C0A68 -> 0x801C0AF0
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02D40
...
// total size: 0x10
struct /* @class$1484zThrowableSystem_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801C0AF0 -> 0x801C0DBC
static void EmitRibbon(struct RunningThrow & thr /* r29 */, struct xVec3 & currentPosition /* r30 */, struct xVec3 & lastPosition /* r31 */) {
    // Local variables
    struct xVec3 dir; // r1+0x44
    struct xVec3 * prevWidth; // r31
    struct xVec3 widthDir; // r1+0x38
    struct xVec3 negWidthDir; // r1+0x2C
    struct xVec3 norm; // r1+0x20
    int ct; // r31
...
// total size: 0xC
struct /* @class$1029zThrowableSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zThrowableSystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zThrowableSystem_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zThrowableSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zThrowableSystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zThrowableSystem_cpp */ {
    // Members
...
// Range: 0x801C0DF0 -> 0x801C0EAC
int zThrowableSystemFindRunningThrow(const struct xEnt * object /* r0 */) {
    // Local variables
    int i; // r0
...
static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043DCC8
// total size: 0x10
...
void zThrowableSystemAddBasicTypes() {
    ...
    unsigned long expected_asset_size; // r23
    int i; // r26
    struct ThrowableTableAsset * table; // r25
    unsigned int j; // r24
    const struct StaticThrowableProperty & staticProperties; // r23
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043DCE8
struct xVec3 g_O3; // size: 0xC, address: 0x80C0ADA0
// Range: 0x801C1458 -> 0x801C1620
void zThrowableSystemRegister(unsigned int baseModel /* r21 */, unsigned int animCode /* r22 */, float minThrowSpeed /* f27 */, float maxThrowSpeed /* f28 */, float dropSpeed /* f29 */, float maxThrowTime /* f30 */, float rotationRate /* f31 */, unsigned int (* collide)(float &, struct xEnt *, struct xEnt *, struct xVec3 *, struct xVec3 *, float, float, void *) /* r23 */, void * collideData /* r24 */, unsigned int (* destroy)(struct xEnt *, void *, unsigned char) /* r25 */, void * destroyData /* r26 */, struct zShrapnelAsset * shrapnel /* r27 */, const char * splashName /* r28 */, unsigned int flags /* r29 */, const struct xVec3 * preferOffset /* r30 */, const struct xVec3 * preferUp /* r31 */) {
    // Local variables
    struct zThrowableProperty & props; // r20
...
// Range: 0x801C1620 -> 0x801C16E0
static void InsertModelMap(unsigned int model /* r29 */, unsigned int property /* r30 */, unsigned int animCode /* r31 */) {
    // Local variables
    struct ThrowableModelMap * point; // r3
...
static struct tweak_callback cbAngle; // size: 0x28, address: 0x8043DD04
static signed char init; // size: 0x1, address: 0x80C08AA6
static struct tweak_callback cbDropAngle; // size: 0x28, address: 0x8043DD2C
static signed char init; // size: 0x1, address: 0x80C08AA7
static struct tweak_callback cbTargetAngle; // size: 0x28, address: 0x8043DD54
static signed char init; // size: 0x1, address: 0x80C08AA8
static struct tweak_callback cbMaxThrowSpeed; // size: 0x28, address: 0x8043DD7C
static signed char init; // size: 0x1, address: 0x80C08AA9
static struct tweak_callback cbMinThrowSpeed; // size: 0x28, address: 0x8043DDA4
static signed char init; // size: 0x1, address: 0x80C08AAA
static struct tweak_callback cbDrop; // size: 0x28, address: 0x8043DDCC
static signed char init; // size: 0x1, address: 0x80C08AAB
static struct tweak_callback cbRotationRate; // size: 0x28, address: 0x8043DDF4
static signed char init; // size: 0x1, address: 0x80C08AAC
static char __FUNCTION__[35]; // size: 0x23, address: 0x8043DE1C
// Range: 0x801C16E0 -> 0x801C2134
void zThrowableSystemFinishScenePrepare() {
    // Local variables
    struct zScene * sc; // r31
    unsigned int i; // r29
...
static char __FUNCTION__[37]; // size: 0x25, address: 0x8043DE40
// Range: 0x801C216C -> 0x801C221C
unsigned char zThrowableSystemModelAddedBeforeSort(unsigned int model /* r31 */) {
    // Local variables
    unsigned int i; // r0
...
static char __FUNCTION__[35]; // size: 0x23, address: 0x8043DE68
// Range: 0x801C221C -> 0x801C26BC
void zThrowableSystemSweptSpherePrepare(int index /* r31 */, struct xSweptSphere & sws /* r27 */, float dt /* f31 */, struct xVec3 & curPos /* r28 */, int npcThrow /* r29 */, int useOldBound /* r30 */) {
    // Local variables
    struct RunningThrow & thr; // r31
    float locTime; // f30
    struct xVec3 currentPosition; // r1+0x4C
    float fallTime; // f29
    struct xVec3 velDirXZ; // r1+0x40
    float speedXZ; // f0
    float maxDecelTime; // f28
    struct xVec3 posToBoundCenter; // r1+0x34
    struct xMat3x3 rot; // r1+0x60
    const struct xVec3 & boundCenter; // r4
    const struct xVec3 & position; // r29
    struct xVec3 boundCenter; // r1+0x28
    struct xVec3 collStart; // r1+0x1C
    struct xVec3 collEnd; // r1+0x10
...
// total size: 0x4
struct /* @class$2564zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2182zThrowableSystem_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2183zThrowableSystem_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2184zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2181zThrowableSystem_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2186zThrowableSystem_cpp */ {
    // Members
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C02D4C
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// total size: 0x890
struct /* @class$1946zThrowableSystem_cpp */ {
    // Static members
...
// Range: 0x801C2BF4 -> 0x801C2D24
unsigned char zThrowableSystemHandleCollision(const struct zThrowableProperty * property /* r25 */, struct xEnt * thrown /* r26 */, struct xEnt * hit /* r27 */, const struct xVec3 * objectPos /* r28 */, const struct xVec3 * point /* r29 */, const struct xVec3 * velocity /* r30 */, enum zCommonPlayerUpgradeLevel upgradeLevel /* r31 */) {
    // Local variables
    float blastRadius; // r1+0x8
...
static char __FUNCTION__[33]; // size: 0x21, address: 0x8043DE8C
enum zHitTarget {
    zHT_GENERAL = 0,
    zHT_FRONT = 1,
    zHT_BACK = 2,
...
// Range: 0x801C2D24 -> 0x801C2FA4
static unsigned int zThrowableSystemGeneralCollideCB(float & blastRadius /* r25 */, struct xEnt * thrown /* r26 */, struct xEnt * hit /* r27 */, const struct xVec3 * pos /* r28 */, const struct xVec3 * velocity /* r7 */, float damageMultiplier /* f0 */, float radiusMultiplier /* f31 */, void * userData /* r29 */, int defaultDamage /* r9 */) {
    // Local variables
    int damage; // r9
    struct ThrowableTableAssetRow * row; // r0
    struct xVec3 knockback; // r1+0x10
    enum zHitTarget hitTarget; // r30
...
// Range: 0x801C2FA4 -> 0x801C2FCC
unsigned int zThrowableSystemSmallCollideCB(float & blastRadius /* r0 */, struct xEnt * thrown /* r0 */, struct xEnt * hit /* r0 */, const struct xVec3 * pos /* r0 */, const struct xVec3 * velocity /* r0 */, float damageMultiplier /* f0 */, float radiusMultiplier /* f0 */, void * userData /* r0 */) {}

// Range: 0x801C2FCC -> 0x801C2FF4
unsigned int zThrowableSystemMediumCollideCB(float & blastRadius /* r0 */, struct xEnt * thrown /* r0 */, struct xEnt * hit /* r0 */, const struct xVec3 * pos /* r0 */, const struct xVec3 * velocity /* r0 */, float damageMultiplier /* f0 */, float radiusMultiplier /* f0 */, void * userData /* r0 */) {}

// Range: 0x801C2FF4 -> 0x801C301C
unsigned int zThrowableSystemLargeCollideCB(float & blastRadius /* r0 */, struct xEnt * thrown /* r0 */, struct xEnt * hit /* r0 */, const struct xVec3 * pos /* r0 */, const struct xVec3 * velocity /* r0 */, float damageMultiplier /* f0 */, float radiusMultiplier /* f0 */, void * userData /* r0 */) {}

// Range: 0x801C301C -> 0x801C3124
unsigned int zThrowableSystemDefaultDestroyCB(struct xEnt * ent /* r31 */) {
    // Local variables
    float params[4]; // r1+0x8
    int runningThrowIndex; // r0
...
// Range: 0x801C3124 -> 0x801C314C
static int BinaryMapCompare::operator()(unsigned int a /* r3 */, const struct ThrowableModelMap & b /* r0 */) {}
