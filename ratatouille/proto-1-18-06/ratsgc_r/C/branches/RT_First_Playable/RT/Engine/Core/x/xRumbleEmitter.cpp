/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xRumbleEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800A4C64 -> 0x800A5DA0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE000
// total size: 0x2
...
// Range: 0x800A4C64 -> 0x800A4E68
static void emitter_EventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {
    // Local variables
    struct emitterBase * pEffect; // r29
    int startidx; // r1+0xC
    int padPort; // r0
    struct emitterBase * pEffect; // r29
    int startidx; // r1+0x8
...
// total size: 0xC
struct /* @class$1038xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041xRumbleEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042xRumbleEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043xRumbleEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044xRumbleEmitter_cpp */ {
    // Members
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE010
// Range: 0x800A503C -> 0x800A5268
// this: r31
float effectAsset::GetIntensity(float currentTime /* f29 */, float totalTime /* f30 */) const {
    // Local variables
    float pulsePeriod; // f30

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE020
// total size: 0x18
...
// Range: 0x800A5268 -> 0x800A53FC
void effect::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// total size: 0x10
struct {} xRumble::effect::__vtable; // size: 0x10, address: 0x80BFE084
// Range: 0x800A53FC -> 0x800A5478
// this: r30
effect::effect(struct effectAsset * pAsset /* r31 */) {
    // References
...
// total size: 0x4
struct /* @class$1097xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235xRumbleEmitter_cpp */ {
    // Members
...
union /* @class$1236xRumbleEmitter_cpp */ {
...
// total size: 0x10
struct /* @class$1797xRumbleEmitter_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE028
// total size: 0x30
...
// Range: 0x800A54E4 -> 0x800A5678
void boxEmitter::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
// total size: 0x10
struct {} xRumble::boxEmitter::__vtable; // size: 0x10, address: 0x80BFE064
// Range: 0x800A5678 -> 0x800A56FC
// this: r30
boxEmitter::boxEmitter(struct boxEmitterAsset * pAsset /* r31 */) {
    // Local variables
...
// Range: 0x800A56FC -> 0x800A5804
// this: r28
unsigned char boxEmitter::GetIntensity(const struct xVec3 & playerPos /* r29 */, float & intensity /* r30 */) const {
    // Local variables
    int charIndex; // r31
...
// Range: 0x800A5804 -> 0x800A5880
unsigned char inBox(const struct xVec3 & v /* r0 */, const struct xVec3 & min /* r0 */, const struct xVec3 & max /* r0 */) {}
...
// total size: 0x890
struct /* @class$2044xRumbleEmitter_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE030
// total size: 0x28
...
// Range: 0x800A5880 -> 0x800A5A14
void sphericalEmitter::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE038
// total size: 0x14
struct {} xRumble::sphericalEmitter::__vtable; // size: 0x14, address: 0x80BFE050
// Range: 0x800A5A14 -> 0x800A5AF4
// this: r30
sphericalEmitter::sphericalEmitter(struct sphericalEmitterAsset * pAsset /* r31 */) {
    // Local variables
    unsigned int size; // r1+0x8
...
// Range: 0x800A5AF4 -> 0x800A5C94
// this: r29
unsigned char sphericalEmitter::GetIntensity(const struct xVec3 & playerPos /* r31 */, float & intensity /* r30 */) const {
    // Local variables
    float distSqrd; // f31
    int charIndex; // r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE040
// Range: 0x800A5C94 -> 0x800A5D28
// this: r30
void sphericalEmitter::UpdatePosition(const struct xVec3 & playerPos /* r31 */) const {
    // References
...
// total size: 0x10
struct {} xRumble::emitterBase::__vtable; // size: 0x10, address: 0x80BFE074
