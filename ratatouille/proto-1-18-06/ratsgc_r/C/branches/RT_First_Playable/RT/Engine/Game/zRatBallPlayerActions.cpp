/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zRatBallPlayerActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802916A4 -> 0x80293B78
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1124zRatBallPlayerActions_cpp */ {
    // Members
...
union /* @class$1263zRatBallPlayerActions_cpp */ {
...
static unsigned char sShowNearestTrack; // size: 0x1, address: 0x80C094D0
static float GRAVITY; // size: 0x4, address: 0x80C05D70
static float MAX_ACCELERATION; // size: 0x4, address: 0x80C05D74
static float min_speed; // size: 0x4, address: 0x80C05D78
static float norm_speed; // size: 0x4, address: 0x80C05D7C
static float max_speed; // size: 0x4, address: 0x80C05D80
static float ORIENTATION_ELASTIC; // size: 0x4, address: 0x80C05D84
static float COLLISION_REFLECTION_VERTICAL; // size: 0x4, address: 0x80C05D88
static float COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x80C05D8C
static float FAST_MULT; // size: 0x4, address: 0x80C05D90
static float MAX_ORIENT_ROT; // size: 0x4, address: 0x80C05D94
static float WEIGHT; // size: 0x4, address: 0x80C05D98
static float KNOCKBACK_DIST; // size: 0x4, address: 0x80C05D9C
static float BIG_EPSILON; // size: 0x4, address: 0x80C05DA0
static unsigned char fastTrack; // size: 0x1, address: 0x80C094D1
// total size: 0x10
struct rest_config {
    // Members
...
// Range: 0x80291C44 -> 0x80291CC0
// this: r31
void zRatBallPlayerDrive::Begin() {}

// Range: 0x80291CC0 -> 0x80291CC4
void zRatBallPlayerDrive::End() {}

// Range: 0x80291CC4 -> 0x80291D70
// this: r29
void zRatBallPlayerDrive::Move(struct xScene * s /* r30 */, float dt /* f31 */, struct xEntFrame * frame /* r31 */) {}
...
float RB_PLSBOUND_RADIUS; // size: 0x4, address: 0x80C05D34
// total size: 0x40
...
// Range: 0x80291D70 -> 0x80292238
// this: r31
void zRatBallPlayerDrive::Physics(float dt /* f28 */) {
    // Local variables
    float x; // r1+0x24
    float z; // r1+0x20
    float stickCameraAngle; // r1+0x1C
    float analogMag; // r1+0x18
    float minSpeed; // f31
    float maxSpeed; // f30
    float normalSpeed; // f29
    struct xVec3 force; // r1+0xA0
    struct xVec3 current; // r1+0x94
    struct xVec3 arrowBase; // r1+0x88
    struct xMat4x3 playerAbsMat; // r1+0x110
    float deltaAccel; // f26
    struct xMat3x3 drot; // r1+0xE0
    struct xVec3 dir; // r1+0x7C
    struct xVec3 zeroAngDir; // r1+0x70
    struct xVec3 * entVel; // r30
    float speed; // f0
    float newSpeed; // f26
    struct xVec3 newPos; // r1+0x64
    struct xVec3 newVelocity; // r1+0x58
    struct xVec3 groundNormal; // r1+0x4C
    struct xVec3 oldPos; // r1+0x40
    struct xVec3 testVel; // r1+0x34
    struct xMat3x3 rotMat; // r1+0xB0
    struct xVec3 tempUp; // r1+0x28
...
// total size: 0x4
struct /* @class$2337zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2210zRatBallPlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zRatBallPlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2212zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2209zRatBallPlayerActions_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2214zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1554zRatBallPlayerActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1065zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1068zRatBallPlayerActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1069zRatBallPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1070zRatBallPlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1071zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2016zRatBallPlayerActions_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05DAC
// Range: 0x80292238 -> 0x80292504
// this: r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05DB4
static unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x80C0EB78
// total size: 0x38
struct xGrid {
    // Members
...
float RB_boundYShift; // size: 0x4, address: 0x80C05D3C
struct xVec3 g_Y3; // size: 0xC, address: 0x80C0ADB8
// Range: 0x80292504 -> 0x80292C18
// this: r23
void zRatBallPlayerDrive::SphereCollision(const struct xVec3 * pNewPosition /* r0 */, const struct xVec3 * pVelocity /* r24 */, unsigned char * pInGroundContact /* r25 */, struct xVec3 * pGroundNormal /* r26 */) {
    // Local variables
    struct xSphere collisionSphere[1]; // r1+0x80
    int i; // r0
    unsigned int numGroundCollisions; // r28
    struct xVec3 averageGroundNormal; // r1+0x74
    struct xEnt * pEntity; // r27
    struct xVec3 playerPos; // r1+0x68
    struct xVec3 npcPos; // r1+0x5C
    struct xVec3 knockback; // r1+0x50
    struct xVec3 delta; // r1+0x44
    float hitParams[6]; // r1+0x90
    float hitParams[4]; // r1+0x34
    float hitParams[4]; // r1+0x24
    struct xVec3 downVec; // r1+0x18
...
// Range: 0x80292C18 -> 0x80292DC8
// this: r27
void zRatBallPlayerDrive::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r28 */) {
    // Local variables
    int i; // r29
    float normDot; // f0
    float normDotUp; // f1
...
// Range: 0x80292DC8 -> 0x80292EA0
// this: r27
void zRatBallPlayerDrive::DepenetrateCollisionList(struct xVec3 * pPosition /* r28 */) {
    // Local variables
    int i; // r29
...
// total size: 0xC
struct /* @class$1262zRatBallPlayerActions_cpp */ {
    // Members
...
// Range: 0x80292EA0 -> 0x80293010
void zRatBallPlayerDrive::PreventPoppingThroughWorld(const struct xVec3 * pStartPosition /* r0 */, struct xVec3 * pEndPosition /* r30 */, struct xVec3 * pVelocity /* r31 */) {
    // Local variables
...
// Range: 0x80293010 -> 0x80293494
static struct RpCollisionTriangle * nearestTrackCB(struct RpCollisionTriangle * collTriangle /* r31 */, void * data /* r24 */) {
    // Local variables
    struct TrackPolyData * tpoly; // r0
    float currnear; // f31
    struct xVec3 currpt; // r1+0x3C
    int currvert; // r27
    int curredge; // r26
    struct xVec3 xformVert[4]; // r1+0x48
    struct xVec3 xformNorm; // r1+0x30
    int i; // r25
    float pdx[3]; // r1+0x24
    float pdz[3]; // r1+0x18
    float numer; // f0
...
// Range: 0x80293494 -> 0x802934B0
static float det3x3top1(float m21 /* f0 */, float m22 /* f0 */, float m23 /* f0 */, float m31 /* f0 */, float m32 /* f0 */, float m33 /* f0 */) {}

static unsigned int ZPLAYER_IS_TSLIDING; // size: 0x4, address: 0x80C0EB90
// total size: 0x10
struct xSphere {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
...
// Range: 0x802934B0 -> 0x80293B78
// this: r31
void zRatBallPlayerDrive::SlideTrackUpdate() {
    // Local variables
    struct xCollis colltmp; // r1+0xF4
    struct xSphere collsph; // r1+0x2C
    struct xQCData qcd; // r1+0x58
    struct RpIntersection isect; // r1+0x3C
    struct xVec3 * center; // r0
    struct TrackPolyData tpoly; // r1+0x78
    int triIndex; // r28
    int iRaftTrack; // r27
    struct zRaftTrack * curRaftTrack; // r26
    int i; // r25
    struct xEnt * trackEnt; // r24
    struct RpGeometry * geom; // r7
    struct RpTriangle * tri; // r24
    struct RwTexCoords * tex; // r25
    struct RwV3d * vert; // r26
    struct xVec3 transformedVert0; // r1+0x20
    struct xVec3 transformedVert1; // r1+0x14
    struct xVec3 transformedVert2; // r1+0x8
    float denom; // f0
    float vcenter; // f30
    float dvdx; // f29
    float dvdz; // f28
    float mag; // f0
    int iRaftTrack; // r24
    struct zRaftTrack * curRaftTrack; // r25
    int i; // r26
    struct xEnt * trackEnt; // r27
...
// total size: 0x54
struct {} zRatBallPlayerDrive::__vtable; // size: 0x54, address: 0x80446F98
// total size: 0xC
