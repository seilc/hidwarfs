/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUberLaser.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D0D98 -> 0x801D30E8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03070
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x1C
struct zUberLaserAsset : public xDynAsset {
    // Static members
    static int VERSION; // size: 0x4

    // Members
    unsigned int marker_start_id; // offset 0x10, size 0x4
    unsigned int marker_end_id; // offset 0x14, size 0x4
    float time; // offset 0x18, size 0x4
};
// Range: 0x801D0D98 -> 0x801D0FF4
void zUberLaser::load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zUberLaser & ulaser; // r29
    struct zUberLaserAsset & uasset; // r0
...
class zLightweightSystem * zLightweight<z::uber_laser, 5>::GetSystem()::system; // size: 0x4, address: 0x80C08B20
signed char zLightweight<z::uber_laser, 5>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C08B24
char __FUNCTION__$localstatic1$Add__38zLightweightSystem<Q21z10uber_laser,5>FRCQ21z10uber_laser[4]; // size: 0x4, address: 0x80C03078
// total size: 0x4
struct RwRGBA {
    // Members
...
// total size: 0x2C
struct /* @class$2047zUberLaser_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$2048zUberLaser_cpp */ {
    // Members
...
struct config {
    ...
    signed short target_damage; // offset 0x8C, size 0x2
    signed short explode_damage; // offset 0x8E, size 0x2
    signed short beam_damage; // offset 0x90, size 0x2
    struct xColor_tag color; // offset 0x92, size 0x4
    struct config charge_config; // offset 0x98, size 0x74
    struct config fire_config; // offset 0x10C, size 0x74
};
struct config default_config; // size: 0x180, address: 0x8043E330
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$1407zUberLaser_cpp */ {
    // Members
...
union /* @class$1589zUberLaser_cpp */ {
...
// total size: 0x8EC
class uber_laser : public zLightweight {
    // Functions
    void Destroy();

    uber_laser();

    uber_laser(struct xEnt * owner, const struct xVec3 & start, const struct xVec3 & end, struct config * cfg);

    void start_ring();

    void stop_ring();

    void update_ring(float dt);

    void Update(float dt);

    class uber_laser & operator=(const class uber_laser & ulaser);

    void Render() const;

    void PostRender2d() const;

    // Static members
    static enum iSndGroupHandle explode; // size: 0x4
    static enum iSndGroupHandle shoot_end; // size: 0x4
    static enum iSndGroupHandle shoot; // size: 0x4
    static enum iSndGroupHandle shoot_charge; // size: 0x4
    static int ring_explosion; // size: 0x4
    static struct RwRaster * beam_raster; // size: 0x4
    static struct RxObjSpace3DVertex * vert; // size: 0x4
    static int num_trails; // size: 0x4
    static struct config default_config; // size: 0x180

    // Members
    struct config * cfg; // offset 0xC, size 0x4
    struct xVec3 start; // offset 0x10, size 0xC
    struct xVec3 end; // offset 0x1C, size 0xC
    struct xVec3 direction; // offset 0x28, size 0xC
    ...
    struct xModelInstance * orb_model_inner; // offset 0x4C, size 0x4
    struct xModelInstance * orb_model_outer; // offset 0x50, size 0x4
    struct xModelInstance * model; // offset 0x54, size 0x4
    class energy_system charge; // offset 0x58, size 0x3C
    class energy_system fire; // offset 0x94, size 0x3C
    struct config fire_config; // offset 0xD0, size 0x74
    enum xSndHandle shoot_sound_charge; // offset 0x144, size 0x4
    enum xSndHandle shoot_sound; // offset 0x148, size 0x4
    enum xSndHandle shoot_sound_end; // offset 0x14C, size 0x4
    enum xSndHandle explode_sound; // offset 0x150, size 0x4
    enum /* @enum$2050zUberLaser_cpp */ {
        NONE = 0,
        CYLINDER = 1,
        CARD = 2,
    } laser_render_type; // offset 0x154, size 0x4
    enum uber_state state; // offset 0x158, size 0x4
    struct xEnt * owner; // offset 0x15C, size 0x4
    float alpha; // offset 0x160, size 0x4
    float ring_size; // offset 0x164, size 0x4
    float ring_delta; // offset 0x168, size 0x4
    struct trail_emitter trail[40]; // offset 0x16C, size 0x780
};
// Range: 0x801D0FF4 -> 0x801D109C
void zUberLaser::handle_event(struct xBase * to /* r31 */, unsigned int event /* r0 */, struct xBase * widget_param /* r7 */) {
    // Local variables
    class zUberLaser * ulaser; // r0
    class uber_laser new_ulaser; // r1+0x8
    class uber_laser * laser; // r31
...
// total size: 0x2CA8
class zLightweightSystem : public zLightweightSystemBase {
    // Members
    class uber_laser object[5]; // offset 0x4, size 0x2C9C
    class zLightweightSystem * * system; // offset 0x2CA0, size 0x4
    unsigned int current_id; // offset 0x2CA4, size 0x4
};
// total size: 0x24
struct {} zLightweightSystem<z::uber_laser, 5>::__vtable; // size: 0x24, address: 0x8043E50C
int ring_explosion; // size: 0x4, address: 0x80C08B28
enum iSndGroupHandle {
};
enum iSndGroupHandle shoot_charge; // size: 0x4, address: 0x80C08B2C
enum iSndGroupHandle shoot; // size: 0x4, address: 0x80C08B30
enum iSndGroupHandle shoot_end; // size: 0x4, address: 0x80C08B34
enum iSndGroupHandle explode; // size: 0x4, address: 0x80C08B38
struct RwRaster * beam_raster; // size: 0x4, address: 0x80C08B3C
// total size: 0x24
...
struct RxObjSpace3DVertex * vert; // size: 0x4, address: 0x80C08B40
// Range: 0x801D109C -> 0x801D1804
void uber_laser::add_tweaks(struct config * cfg /* r30 */, const char * prefix /* r31 */) {
    // Local variables
    char temp[128]; // r1+0x10
}
...
// total size: 0xC
struct /* @class$1348zUberLaser_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1349zUberLaser_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1350zUberLaser_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1351zUberLaser_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1352zUberLaser_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1353zUberLaser_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1354zUberLaser_cpp */ {
    // Members
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C0307C
// total size: 0x18
...
// Range: 0x801D1804 -> 0x801D1950
void uber_laser::Setup() {
    // Local variables
    const char * prefix; // r31
    unsigned int LASER_TEXTURE_ID; // r0
    struct RwTexture * beam_texture; // r0

    // References
    // -> static char __FUNCTION__[6];
    // -> struct RwRaster * beam_raster;
    // -> struct tagiRenderInput gRenderBuffer;
    // -> struct RxObjSpace3DVertex * vert;
    // -> enum iSndGroupHandle explode;
    // -> enum iSndGroupHandle shoot_end;
    // -> enum iSndGroupHandle shoot;
    // -> enum iSndGroupHandle shoot_charge;
    // -> int ring_explosion;
    // -> struct config default_config;
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C03084
// Range: 0x801D1950 -> 0x801D19C0
// this: r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0308C
// total size: 0x20
struct {} z::uber_laser::__vtable; // size: 0x20, address: 0x8043E4CC
// Range: 0x801D19C0 -> 0x801D1C28
// this: r30
uber_laser::uber_laser() {
    // Local variables
    unsigned int ball_model_id; // r31
    unsigned int size; // r1+0x8
    struct RpAtomic * imodel; // r29
    unsigned int beam_model_id; // r29

    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] z::uber_laser::__vtable;
}

// total size: 0x20
struct {} zLightweight<z::uber_laser, 5>::__vtable; // size: 0x20, address: 0x8043E4EC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03094
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1602zUberLaser_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801D1C28 -> 0x801D1E0C
// this: r28
uber_laser::uber_laser(struct xEnt * owner /* r27 */, const struct xVec3 & start /* r29 */, const struct xVec3 & end /* r30 */, struct config * cfg /* r31 */) {
    // Local variables
    float distance_to_laser; // f0
...
// Range: 0x801D1E0C -> 0x801D1EFC
static float distance(const struct xVec3 & P /* r29 */, const struct xVec3 & A /* r30 */, const struct xVec3 & B /* r31 */) {
    // Local variables
    struct xVec3 D; // r1+0x14
    float D_length; // f0
    struct xVec3 PD; // r1+0x8
    float dot; // f0
}

static int trail_type; // size: 0x4, address: 0x80C08B44
static signed char init; // size: 0x1, address: 0x80C08B48
// Range: 0x801D1EFC -> 0x801D1FD4
// this: r29
void uber_laser::start_ring() {
    // Local variables
    struct xVec3 ring_start; // r1+0x8
    int i; // r30

    // References
    // -> static int trail_type;
    // -> static signed char init;
}

// Range: 0x801D1FD4 -> 0x801D2044
// this: r29
void uber_laser::stop_ring() {
    // Local variables
    int i; // r30
}

// Range: 0x801D2044 -> 0x801D2220
// this: r29
void uber_laser::update_ring(float dt /* f31 */) {
    // Local variables
    struct xVec3 ring_start; // r1+0x20
    float angle_delta; // f29
    float angle; // f28
    int i; // r30
    struct xVec3 direction; // r1+0x14
    struct xVec3 trail_position; // r1+0x8
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0309C
...
// total size: 0xC
struct /* @class$1545zUberLaser_cpp */ {
    // Members
...
// Range: 0x801D2220 -> 0x801D2948
// this: r26
void uber_laser::Update(float dt /* f31 */) {
    // Local variables
    struct xMat3x3 mat; // r1+0xA0
    unsigned char damage; // r23
    struct xVec3 B; // r1+0x1C
    float distance_to_laser; // f0
    struct xRay3 ray; // r1+0x74
    struct xCollis collision_record; // r1+0x11C
    int i; // r27
    struct xSphere * player_spheres[5]; // r1+0x28
    int num_spheres; // r0
    int j; // r22
    struct xBound bound; // r1+0xD0
    struct zCombatDamageInfo info; // r1+0x3C
...
// total size: 0x890
struct /* @class$2133zUberLaser_cpp */ {
    // Static members
...
class energy_system {
    ...
    static int streak_system_id; // size: 0x4
    static int point_system_id; // size: 0x4

    // Members
    struct config * use_config; // offset 0x0, size 0x4
    ...
    struct xVec3 target; // offset 0x18, size 0xC
    struct xVec3 position; // offset 0x24, size 0xC
    struct xVec3 normal; // offset 0x30, size 0xC
};
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
...
// Range: 0x801D2948 -> 0x801D2A30
// this: r30
class uber_laser & uber_laser::operator=(const class uber_laser & ulaser /* r31 */) {}
...
// Range: 0x801D2A30 -> 0x801D2D4C
// this: r31
void uber_laser::Render() const {
    // Local variables
    struct xMat4x3 & mat; // r30
    struct xMat3x3 rot; // r1+0xC0
    struct xVec3 s; // r1+0x1C
    struct xMat3x3 scale_mat; // r1+0x90
    struct xMat4x3 & mat; // r30
    float orb_scale; // f2
    struct xVec3 size; // r1+0x10
    struct xMat3x3 scale; // r1+0x60
    struct xMat3x3 scale; // r1+0x30
...
static int laser_count; // size: 0x4, address: 0x80C08B4C
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C030A4
// Range: 0x801D2D4C -> 0x801D2DE0
void uber_laser::PostRenderStart() {
    // References
    // -> static char __FUNCTION__[16];
    // -> struct RxObjSpace3DVertex * vert;
    // -> struct RwRaster * beam_raster;
    // -> static int laser_count;
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C030B4
// Range: 0x801D2DE0 -> 0x801D305C
// this: r31
void uber_laser::PostRender2d() const {
    // Local variables
    struct xVec3 end_loc; // r1+0x2C
    struct xVec3 right; // r1+0x20
    float right_mag2; // f0
    struct xVec3 half_right; // r1+0x14
    struct xVec3 vertPos; // r1+0x8
...
// Range: 0x801D305C -> 0x801D30A0
void set_vert(struct RxObjSpace3DVertex & vert /* r0 */, const struct xVec3 & loc /* r0 */, float u /* f0 */, float v /* f0 */, const struct xColor_tag & color /* r0 */) {}

// Range: 0x801D30A0 -> 0x801D30E8
void uber_laser::PostRenderEnd() {
    // References
    // -> struct RxObjSpace3DVertex * vert;
    // -> static int laser_count;
}
