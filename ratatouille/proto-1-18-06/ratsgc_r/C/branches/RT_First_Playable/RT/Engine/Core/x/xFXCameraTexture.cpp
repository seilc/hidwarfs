/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xFXCameraTexture.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801A3A08 -> 0x801A4844
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801A3A08 -> 0x801A3CD8
// this: r27
unsigned char xFXCameraTexture::create(int w /* r28 */, int h /* r29 */, unsigned char need_zwrite /* r30 */, int bpp /* r26 */, int zbpp /* r31 */) {
    // Local variables
    struct iAsyncLockRWSentry rw_sentry; // r1+0x8
    struct RwBBox bbox; // r1+0x14
...
// Range: 0x801A3CD8 -> 0x801A3D9C
// this: r30
void xFXCameraTexture::destroy() {
    // Local variables
    struct RwFrame * tmpframe; // r31
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C02530
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1108xFXCameraTexture_cpp */ {
    // Members
...
union /* @class$877xFXCameraTexture_cpp */ {
...
// total size: 0xC
struct /* @class$1272xFXCameraTexture_cpp */ {
    // Members
...
// Range: 0x801A3D9C -> 0x801A3FBC
// this: r30
void xFXCameraTexture::begin_render(int clear_flags /* r31 */, unsigned int fbmsk_write /* r28 */, float near_plane /* f30 */, float far_plane /* f31 */) {
    // References
...
// Range: 0x801A414C -> 0x801A4224
// this: r28
void xFXCameraTexture::setup_subview(struct RwCamera * src_cam /* r29 */, const struct xFRect & src_rect /* r30 */, const struct xFRect & dst_rect /* r31 */) {
    // Local variables
    struct xMat4x3 ltm; // r1+0x20
    struct xVec2 view_window; // r1+0x18
    struct xVec2 view_offset; // r1+0x10
}
...
// Range: 0x801A4224 -> 0x801A4430
// this: r0
void xFXCameraTexture::get_subview(struct xMat4x3 & ltm /* r27 */, struct xVec2 & view_window /* r28 */, struct xVec2 & view_offset /* r29 */, struct RwCamera * src_cam /* r30 */, const struct xFRect & src_rect /* r0 */, const struct xFRect & dst_rect /* r0 */) const {
    // Local variables
    struct RwRaster * src_raster; // r11
    const struct xMat4x3 & src_ltm; // r31
    const struct xVec2 & src_view_window; // r0
    const struct xVec2 & src_view_offset; // r0
    float src_iwidth; // f28
    float src_iheight; // f29
    float dst_iwidth; // f27
    float dst_iheight; // f10
    float rw; // f31
    float rh; // f30
    float mx; // f29
    float my; // f28
...
// Range: 0x801A4430 -> 0x801A45C4
unsigned char xFXFastRaster::clip_rect(struct xFRect & dst_rect /* r31 */, struct RwRaster * dst_raster /* r0 */) {
    // Local variables
    int width; // r7
    int height; // r8
    int dst_x; // r30
...
// Range: 0x801A45C4 -> 0x801A4684
static unsigned char clip_rect(int & x /* r0 */, int & y /* r0 */, int & w /* r0 */, int & h /* r0 */, int wclip /* r0 */, int hclip /* r0 */) {}

// Range: 0x801A4684 -> 0x801A47A8
unsigned char xFXFastRaster::clip_rect(struct xFRect & dst_rect /* r30 */, struct RwRaster * dst_raster /* r0 */, struct xFRect & src_rect /* r31 */) {
    // Local variables
    float oldx; // f30
    float oldw; // f29
    float oldy; // f28
...
// Range: 0x801A47A8 -> 0x801A47AC
void xFXFastRaster::begin_render() {}

// Range: 0x801A47AC -> 0x801A47B0
void xFXFastRaster::end_render() {}

// Range: 0x801A47B0 -> 0x801A47B4
void xFXFastRaster::set_source() {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02540
// Range: 0x801A47B4 -> 0x801A4844
// this: r29
void xFXFastRaster::set_destination(struct RwRaster * dst /* r30 */, unsigned int fbmsk /* r31 */) {
    // References
