/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSmashRing.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801EEC00 -> 0x801F0BF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char loop; // size: 0x1, address: 0x80C08D70
static unsigned char stoppit; // size: 0x1, address: 0x80C08D71
static unsigned char track_player; // size: 0x1, address: 0x80C037E0
static float repeat_delay; // size: 0x4, address: 0x80C08D74
static float yoffset; // size: 0x4, address: 0x80C08D78
// Range: 0x801EEC00 -> 0x801EED20
...
// total size: 0xC
struct /* @class$930zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932zSmashRing_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933zSmashRing_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zSmashRing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zSmashRing_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zSmashRing_cpp */ {
    // Members
...
static class module_type * module; // size: 0x4, address: 0x80C08D7C
// Range: 0x801EED20 -> 0x801EED34
static void get_scene_parameters(int & max_rings /* r0 */, int & ring_emitters_max /* r0 */) {}

// total size: 0x1
struct /* @class$2081zSmashRing_cpp */ {
    // Members
...
// Range: 0x801EED34 -> 0x801EEE34
// this: r31
static module_type::module_type(int rings_max /* r0 */, int ring_emitters_max /* r0 */, unsigned char tweak_alloc /* r0 */) {}

// Range: 0x801EEE34 -> 0x801EEEBC
// this: r0
...
// Range: 0x801EEF50 -> 0x801EEF7C
// this: r0
static void module_type::render() {}

// Range: 0x801EEF7C -> 0x801EEFCC
// this: r31
static int module_type::get_raster_id(unsigned int texture /* r4 */) {}
...
// Range: 0x801EEFCC -> 0x801EF000
// this: r0
static int module_type::get_raster_id(struct RwTexture * texture /* r4 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C037E4
// Range: 0x801EF000 -> 0x801EF104
// this: r29
static int module_type::get_raster_id(struct RwRaster * raster /* r30 */) {
    // Local variables
    int i; // r3
    int unused; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C037F4
// Range: 0x801EF104 -> 0x801EF19C
// this: r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C03808
// Range: 0x801EF19C -> 0x801EF2BC
// this: r31
static void module_type::free_emitter_id(int id /* r29 */) {
    // Local variables
    struct emitter_id_node * it; // r30
    struct emitter_id_node * node; // r3

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C03818
// Range: 0x801EF2BC -> 0x801EF3B8
// this: r27
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0382C
// Range: 0x801EF3B8 -> 0x801EF460
// this: r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03838
// Range: 0x801EF460 -> 0x801EF530
// this: r30
static void module_type::free_ring(struct ring_type * ring /* r31 */) {
    // Local variables
    struct ring_type * tail; // r4

    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x801EF5DC -> 0x801EF6C0
// this: r29
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C03844
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
static void module_type::render_rings() {
    ...
    float s; // f21
    float c; // f20
    struct xVec3 * const end_pos; // r20
    float tempc; // f0
...
// total size: 0x4
struct /* @class$1090zSmashRing_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1254zSmashRing_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1791zSmashRing_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801EFC70 -> 0x801EFDB4
// this: r31
static void module_type::debug_update(float dt /* f31 */) {
    // References
    // -> static unsigned char loop;
    // -> static float repeat_delay;
    // -> static float yoffset;
...
// total size: 0x890
struct /* @class$2038zSmashRing_cpp */ {
    // Static members
...
// Range: 0x801EFE6C -> 0x801EFE78
void zSmashRingSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x801EFE78 -> 0x801EFEA4
void zSmashRingReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x801EFEA4 -> 0x801EFED0
void zSmashRingUpdate(float dt /* f0 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x801EFED0 -> 0x801EFEFC
void zSmashRingRender() {
    // References
    // -> static class module_type * module;
}

// Range: 0x801EFEFC -> 0x801EFF5C
void zSmashRingEmitter::load_default_config(struct config_type & cfg /* r0 */) {}

// Range: 0x801EFF5C -> 0x801EFF68
// this: r0
void zSmashRingEmitter::create() {}

// Range: 0x801EFF68 -> 0x801F01B0
// this: r30
void zSmashRingEmitter::start(const struct config_type & cfg /* r31 */, const struct xVec3 & center /* r29 */) {
    // Local variables
    float dang; // f31
    float ilife; // f3
...
// Range: 0x801F01B0 -> 0x801F01EC
// this: r31
void zSmashRingEmitter::stop() {}

// Range: 0x801F01EC -> 0x801F04FC
// this: r30
...
// Range: 0x801F04FC -> 0x801F0514
// this: r0
static void ring_type::set_sort_key(int raster_id /* r0 */, int emitter_id /* r0 */, int ring_id /* r0 */) {}

// Range: 0x801F0514 -> 0x801F0530
// this: r0
static unsigned char module_type::rings_full() const {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03854
// Range: 0x801F0530 -> 0x801F05D0
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C03864
// Range: 0x801F05D0 -> 0x801F06A0
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C03874
// Range: 0x801F0764 -> 0x801F0824
// this: r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03880
// Range: 0x801F0824 -> 0x801F0914
// this: r31
