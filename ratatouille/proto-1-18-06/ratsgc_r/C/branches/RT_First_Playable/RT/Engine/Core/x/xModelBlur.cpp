/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xModelBlur.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D4148 -> 0x801D63BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char sModelBlurEnabled; // size: 0x1, address: 0x80C030F8
static unsigned char render; // size: 0x1, address: 0x80C030F9
static unsigned char render_texture; // size: 0x1, address: 0x80C08B58
static unsigned char render_opaque; // size: 0x1, address: 0x80C08B59
static unsigned char render_card_spheres; // size: 0x1, address: 0x80C08B5A
static int alpha_compare; // size: 0x4, address: 0x80C030FC
static int min_alpha; // size: 0x4, address: 0x80C03100
// Range: 0x801D4148 -> 0x801D42A4
...
// total size: 0xC
struct /* @class$930xModelBlur_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931xModelBlur_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932xModelBlur_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933xModelBlur_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934xModelBlur_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935xModelBlur_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936xModelBlur_cpp */ {
    // Members
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x80BB6B30
unsigned char prelit_and_thats_the_way_we_likes_it; // size: 0x1, address: 0x80C0749C
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1080xModelBlur_cpp */ {
    // Members
...
union /* @class$1262xModelBlur_cpp */ {
...
// total size: 0xC
struct /* @class$1261xModelBlur_cpp */ {
    // Members
...
struct activity_data * activity_buffer; // size: 0x4, address: 0x80C08B5C
struct activity_data * activities[6]; // size: 0x18, address: 0x80C08B60
int activities_used; // size: 0x4, address: 0x80C08B78
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x801D44C8 -> 0x801D45C8
void xModelBlur::scene_enter() {
    // Local variables
    struct activity_data * activity; // r0
...
// Range: 0x801D45C8 -> 0x801D45F0
void xModelBlur::scene_exit() {
    // References
    // -> static class xFXCameraTexture camtex;
}

// Range: 0x801D45F0 -> 0x801D46C4
void xModelBlur::reset_all() {
    // Local variables
    int i; // r6
    struct activity_data * activity; // r10
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03104
// Range: 0x801D46C4 -> 0x801D47B0
void xModelBlur::update_all(float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03110
// Range: 0x801D47B0 -> 0x801D4880
...
// Range: 0x801D4880 -> 0x801D488C
// this: r0
void xModelBlur::create() {}

// Range: 0x801D488C -> 0x801D497C
// this: r29
unsigned char xModelBlur::activate(float lifetime /* f30 */, float alpha /* f31 */, const struct config_data & cfg /* r30 */, struct xModelInstance * model /* r31 */) {
    // References
    // -> int activities_used;
}
...
// Range: 0x801D497C -> 0x801D4998
// this: r0
static void interpolator::reset(float value /* f0 */) {}

// Range: 0x801D4998 -> 0x801D49E4
// this: r31
void xModelBlur::deactivate() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0311C
// Range: 0x801D49E4 -> 0x801D4B70
// this: r30
void xModelBlur::move(const struct xVec3 & center /* r31 */) {
    // Local variables
    int second_index; // r7
    const struct xVec3 & A; // r4
    const struct xVec3 & B; // r3
    float ABx; // f4
    float ABy; // f1
    float ABz; // f2
    float min_dist; // f0
    struct path_node & p; // r6

    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03124
// Range: 0x801D4B70 -> 0x801D4C00
// this: r30
void xModelBlur::set_config(const struct config_data & cfg /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x801D4C00 -> 0x801D4C50
// this: r0
unsigned char xModelBlur::visible() const {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C03130
// Range: 0x801D4C50 -> 0x801D4CF8
// this: r31
void xModelBlur::set_lifetime(float value /* f30 */, float time /* f31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x801D4CF8 -> 0x801D4D50
// this: r3
static void interpolator::go(float value /* f1 */, float time /* f0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03140
// Range: 0x801D4D50 -> 0x801D4DF8
// this: r31
void xModelBlur::set_alpha(float value /* f30 */, float time /* f31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0314C
// Range: 0x801D4DF8 -> 0x801D5230
// this: r25
unsigned char xModelBlur::update(float dt /* f20 */) {
    // Local variables
    int i; // r5
    float lifetime; // f29
    struct path_node & p; // r3
    float card_dist; // f28
    int max_card_renders; // r28
    float alpha_scale; // f27
    int cards_size; // r27
    float path_dist; // f26
    struct path_node & p0; // r26
    struct path_node & p1; // r24
    const struct xVec3 & A; // r0
    const struct xVec3 & B; // r0
    float ABx; // f25
    float ABy; // f24
    float ABz; // f23
    float segment_dist; // f0
    float idist; // f22
    float age0; // f0
    float dage; // f21
    float dist; // f20
...
// Range: 0x801D5230 -> 0x801D5294
// this: r0
static void interpolator::update(float dt /* f0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03154
// Range: 0x801D5294 -> 0x801D531C
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C03164
// Range: 0x801D531C -> 0x801D5434
void xModelBlur::free_activity(struct activity_data * activity /* r1+0x8 */) {
    // Local variables
    struct activity_data * * tail_activity; // r5
    struct activity_data * temp; // r6
...
static unsigned int * FBSaveMem; // size: 0x4, address: 0x80C08B7C
static unsigned int * textureMem; // size: 0x4, address: 0x80C08B80
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C03174
// total size: 0x1C
...
// Range: 0x801D5434 -> 0x801D5BAC
// this: r30
void xModelBlur::render() {
    // Local variables
    unsigned int oldFBMSK; // r31
    struct RwRaster * draw_raster; // r29
    struct xVec3 view_center; // r1+0x34
    struct RwCamera * world_cam; // r28
    float rz; // f3
    float screen_x; // f31
    float screen_y; // f30
    float screen_radius; // f5
    const struct xVec2 & world_view_window; // r0
    struct xFRect scr_rect; // r1+0x24
    struct xFRect tex_rect; // r1+0x14
    float old_projection[7]; // r1+0x60
    void * FBSaveMemPopAddr; // r0
    void * textureMemPopAddr; // r0
    struct xModelInstance * m; // r28
    float oldalpha; // f29
    float mProjection[4][4]; // r1+0xBC
    float mIdentity[4][4]; // r1+0x7C
...
// Range: 0x801D5BF8 -> 0x801D6390
// this: r25
void xModelBlur::render_cards(const struct xFRect & src_rect /* r26 */, float xoff0 /* f23 */, float yoff0 /* f24 */, float xoff1 /* f25 */, float yoff1 /* f26 */) {
    // Local variables
    struct RwRaster * draw_raster; // r21
    class xFXFastRaster fr; // r1+0x90
    struct RwCamera * world_cam; // r29
    const struct xMat4x3 & view_mat; // r28
    struct _xFColor color; // r1+0x40
    float zscale; // f28
    int i; // r27
    const struct card_data & card; // r5
    struct xVec3 sp; // r1+0x34
    float rz; // f27
    float cx; // f4
    float cy; // f0
    float x0; // f3
    float y0; // f2
    struct xFRect clip_src_rect; // r1+0x24
    struct xFRect clip_dst_rect; // r1+0x14
    struct _GXTexObj screenBack; // r1+0x70
    float projVector[7]; // r1+0x50
    float posMatrix[3][4]; // r1+0xA4
    unsigned char r; // r21
    unsigned char g; // r22
    unsigned char b; // r23
    unsigned char a; // r24
