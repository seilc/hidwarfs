/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEconomics.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022D260 -> 0x8022DB00
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int instanceCount; // size: 0x4, address: 0x80C08FF8
int lastUpgradeValue; // size: 0x4, address: 0x80C08FFC
static signed char init; // size: 0x1, address: 0x80C09000
// total size: 0x8
struct Threshold {
    // Members
...
// total size: 0x4
struct /* @class$1085zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zEconomics_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2087zEconomics_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1026zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zEconomics_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zEconomics_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zEconomics_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zEconomics_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zEconomics_cpp */ {
    // Members
...
static class zEconomics economics; // size: 0xC9C, address: 0x80BC94C8
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1840zEconomics_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8022D260 -> 0x8022D2D0
void zEconomics::Init(struct xIniFile * ini /* r31 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04670
// Range: 0x8022D2D0 -> 0x8022D350
// this: r31
...
// Range: 0x8022D350 -> 0x8022D5C0
// this: r30
void zEconomics::ParseINI(struct xIniFile * ini /* r31 */) {
    // Local variables
    ...
    int i; // r25
    int level; // r24
    const char * levelName; // r23
    int npc; // r22
    const char * NPCName; // r21
    int i; // r21
}

// Range: 0x8022D5C0 -> 0x8022D65C
// this: r0
...
// Range: 0x8022D65C -> 0x8022D690
// this: r3
int zEconomics::GetPointsToUpgrade(int curPoints /* r0 */) {
    // Local variables
    int points; // r5
    int i; // r6
}

// Range: 0x8022D690 -> 0x8022D748
// this: r3
int zEconomics::GetUpgradesEarned(int expPoints /* r0 */) {
    // Local variables
    int points; // r6
    int earnedUpgrades; // r7
    int i; // r8
}

// total size: 0x4
struct /* @class$2236zEconomics_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2237zEconomics_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2238zEconomics_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2235zEconomics_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2240zEconomics_cpp */ {
    // Members
...
// Range: 0x8022D784 -> 0x8022D788
void zEconomics::GiveComboPoints() {}

// Range: 0x8022D788 -> 0x8022D898
char * zEconomics::GetLevelName(int level /* r0 */) {
    // Local variables
    const char * name; // r3
}

// Range: 0x8022D898 -> 0x8022D8A8
char * zEconomics::GetNPCName() {
    // Local variables
    const char * name; // r3
}

// Range: 0x8022D8A8 -> 0x8022D9D4
...
static char __FUNCTION__[28]; // size: 0x1C, address: 0x804400B0
// Range: 0x8022D9D4 -> 0x8022DB00
// this: r30
int zEconomics::GetTotalPoints2UpgradeLevel(int level /* r31 */) {
    // Local variables
    int count; // r3
    int i; // r6
