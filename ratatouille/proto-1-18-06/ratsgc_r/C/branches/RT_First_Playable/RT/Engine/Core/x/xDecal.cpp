/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xDecal.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8003A460 -> 0x8004458C
*/
char __FUNCTION__$localstatic1$xEntMotionGetSpeed__FPC10xEntMotion[19]; // size: 0x13, address: 0x80BFC1C8
char __FUNCTION__$localstatic1$xEntSpeedDataSet__FP13xEntSpeedDataff[17]; // size: 0x11, address: 0x80BFC1DC
char __FUNCTION__$localstatic1$xEntMotionAccelerate__FP10xEntMotionff[21]; // size: 0x15, address: 0x80BFC1F0
char __FUNCTION__$localstatic1$xEntMPAtEnd__FP10xEntMotion[12]; // size: 0xC, address: 0x80BFC208
char __FUNCTION__$localstatic1$xEntMotionSetSpeed__FP10xEntMotionf[19]; // size: 0x13, address: 0x80BFC214
char __FUNCTION__$localstatic1$xEntMotionReverse__FP10xEntMotion[18]; // size: 0x12, address: 0x80BFC228
char __FUNCTION__$localstatic1$insert__21xSpacePartitionTree2DFPvifff[7]; // size: 0x7, address: 0x80BFC23C
char __FUNCTION__$localstatic1$insert__21xSpacePartitionTree2DFPviffff[7]; // size: 0x7, address: 0x80BFC244
char __FUNCTION__$localstatic1$alloc_entry__21xSpacePartitionTree2DFv[12]; // size: 0xC, address: 0x80BFC24C
char __FUNCTION__$localstatic1$alloc_node__21xSpacePartitionTree2DFv[11]; // size: 0xB, address: 0x80BFC258
char __FUNCTION__$localstatic1$alloc_children__21xSpacePartitionTree2DFv[15]; // size: 0xF, address: 0x80BFC264
char __FUNCTION__$localstatic1$free_children__21xSpacePartitionTree2DFPQ221xSpacePartitionTree2D4cell[14]; // size: 0xE, address: 0x80BFC274
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char skip_backface; // size: 0x1, address: 0x80C07160
static unsigned char skip_facing_away; // size: 0x1, address: 0x80BFC282
static float skip_facing_cos; // size: 0x4, address: 0x80BFC284
static float zbias; // size: 0x4, address: 0x80BFC288
static float conv_fade_time; // size: 0x4, address: 0x80BFC28C
static int filter_tri; // size: 0x4, address: 0x80BFC290
static unsigned char invert_normals; // size: 0x1, address: 0x80C07161
static unsigned char render_hit_tests; // size: 0x1, address: 0x80C07162
static unsigned char render_volume; // size: 0x1, address: 0x80C07163
static unsigned char render_normals; // size: 0x1, address: 0x80C07164
static unsigned char render_tri_face; // size: 0x1, address: 0x80C07165
static unsigned char render_tri_intersect; // size: 0x1, address: 0x80C07166
static unsigned char render_tri_clipped; // size: 0x1, address: 0x80C07167
static unsigned char render_tri_unclipped; // size: 0x1, address: 0x80C07168
static unsigned char enable; // size: 0x1, address: 0x80C07169
static unsigned char track_camera; // size: 0x1, address: 0x80BFC294
static float size; // size: 0x4, address: 0x80BFC298
static float dist_min; // size: 0x4, address: 0x80BFC29C
static float dist_max; // size: 0x4, address: 0x80BFC2A0
static float sweep_arc; // size: 0x4, address: 0x80BFC2A4
static float sweep_speed; // size: 0x4, address: 0x80C0716C
static int blend_mode; // size: 0x4, address: 0x80C07170
static unsigned int texture; // size: 0x4, address: 0x80BFC2A8
static unsigned char cycle; // size: 0x1, address: 0x80C07174
static float life; // size: 0x4, address: 0x80BFC2AC
static float size; // size: 0x4, address: 0x80BFC2B0
static float dist_min; // size: 0x4, address: 0x80BFC2B4
static float dist_max; // size: 0x4, address: 0x80BFC2B8
static int blend_mode; // size: 0x4, address: 0x80C07178
static unsigned int texture; // size: 0x4, address: 0x80BFC2BC
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node test_curve_nodes[2]; // size: 0x38, address: 0x804155A8
// total size: 0x4
struct node {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0x1
struct /* @class$967xDecal_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968xDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969xDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970xDecal_cpp */ {
    // Members
...
static struct xResponseCurve test_curve; // size: 0x14, address: 0x80C0717C
// Range: 0x8003A460 -> 0x8003A480
static void emit_from_camera() {}

// Range: 0x8003A480 -> 0x8003A4A0
...
static struct tweak_callback cb_emit_from_camera; // size: 0x28, address: 0x803AA908
static struct tweak_callback cb_emit_clear; // size: 0x28, address: 0x803AA930
...
char * blend_mode_labels[3]; // size: 0xC, address: 0x80BFC3B4
...
static struct decal_instance * decals; // size: 0x4, address: 0x80C07190
static struct decal_instance * * render_list; // size: 0x4, address: 0x80C07194
static struct immediate_mode_data * immediate_buffer; // size: 0x4, address: 0x80C07198
static struct immediate_mode_data * immediate_free; // size: 0x4, address: 0x80C0719C
static int order_current_place; // size: 0x4, address: 0x80C071A0
static int decals_used; // size: 0x4, address: 0x80C071A4
static unsigned char decals_sorted; // size: 0x1, address: 0x80C071A8
static int immediate_indices_used; // size: 0x4, address: 0x80C071AC
static int immediate_verts_used; // size: 0x4, address: 0x80C071B0
// total size: 0x1C
struct node_type {
    // Members
...
static class pool_list owner_groups; // size: 0x20, address: 0x80A5BFD0
enum _SDRenderState {
...
static const struct xMat4x3 * debug_mat; // size: 0x4, address: 0x80C071B4
// Range: 0x8003ABA8 -> 0x8003AC1C
static void debug_transform(struct xVec3 * ov /* r3 */, const struct xVec3 * iv /* r4 */, int size /* r28 */) {
    // Local variables
    int i; // r29
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804155E0
// total size: 0x10
struct combo_vertex {
    // Members
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC2C0
static int MAX_CLIPPED_VERTS; // size: 0x4, address: 0x80C0A564
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x8003ADC4 -> 0x8003B9F0
static void clip_decal(struct clip_decal_params & arg /* r15 */) {
    // Local variables
    ...
    float ux; // f27
    float uy; // f26
    struct xVec3 tv[3]; // r1+0x90
    struct xVec3 l1; // r1+0x3C
    struct xVec3 l2; // r1+0x30
    struct xVec3 norm; // r1+0x24
    struct xVec3 norm_loc; // r1+0x18
    struct xVec3 tv[3]; // r1+0x6C
    int out_union; // r16
    struct xVec3 tv[3]; // r1+0x48
    int cv_offset; // r17
    int vsize; // r18
    float _c; // f25
    ...
    float _c; // f25
    const struct xVec3 * s0; // r3
    const struct xVec3 * s1; // r20
    const struct xVec3 * ends1; // r18
    struct xVec3 * d; // r21
    float s; // f2
    float s; // f2
    float _c; // f25
    ...
    float s; // f2
    float s; // f2
    const struct xVec3 * poly_vert; // r22
    struct xVec2 * poly_uv; // r21
    struct xVec3 tv[9]; // r1+0xB4
    int i; // r17
    const struct xVec3 * pv; // r3
    struct xVec2 * puv; // r4
    struct xVec2 * end_puv; // r0
    const struct xVec3 * tri_vert1; // r20
    const struct xVec3 * tri_vert2; // r19
    const struct xVec3 * end_tri_vert2; // r18
    const struct xVec2 * tri_uv1; // r17
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC2CC
struct xColor_tag g_MAGENTA; // size: 0x4, address: 0x80C0A270
// total size: 0x44
struct /* @class$2924xDecal_cpp */ {
    // Members
...
// Range: 0x8003B9F0 -> 0x8003CE54
static void clip_decal_indexed(struct clip_decal_indexed_params & arg /* r31 */) {
    // Local variables
    const struct xVec3 * iv; // r28
    const struct RpTriangle * it; // r27
    const struct RpTriangle * end_it; // r1+0x158
    struct RpTriangle * ot; // r26
    struct RpTriangle * end_ot; // r1+0x154
    struct combo_vertex * ov; // r25
    struct combo_vertex * end_ov; // r1+0x150
    struct xVec2 * ouv; // r24
    struct clip_vertex * cv; // r23
    unsigned short * used; // r22
    float su; // f31
    float sv; // f30
    float du; // f29
    float dv; // f28
    ...
    int out1; // r15
    int out2; // r16
    struct xVec3 tv[3]; // r1+0xB8
    int i; // r29
    struct xVec3 tv[3]; // r1+0x94
    int i; // r29
    struct xVec3 l1; // r1+0x40
    struct xVec3 l2; // r1+0x34
    struct xVec3 norm; // r1+0x28
    struct xVec3 norm_loc; // r1+0x1C
    float c1; // f2
    float c2; // f0
    struct xVec3 tv[3]; // r1+0x70
    int i; // r29
    int out_union; // r1+0x14C
    struct xVec3 tv[3]; // r1+0x4C
    int i; // r16
    int i; // r0
    int vi; // r7
    unsigned short & stored; // r0
    const struct xVec3 & vxy; // r7
    int cv_offset; // r18
    int vsize; // r17
    float _c; // f25
    const struct clip_vertex * s0; // r3
    const struct clip_vertex * s1; // r17
    const struct clip_vertex * ends1; // r16
    ...
    float s; // f3
    float s; // f3
    const struct clip_vertex * rcv; // r15
    const struct clip_vertex * end_rcv; // r16
    int * poly_vert_index; // r1+0x148
    int * pvi; // r18
    int vi; // r4
    unsigned short & stored; // r0
    struct xVec3 tv1[9]; // r1+0xDC
    int i; // r18
    int i; // r15
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFC2E0
// total size: 0x0
struct RpSkin {};
// Range: 0x8003D168 -> 0x8003D25C
...
// Range: 0x8003D25C -> 0x8003D474
static struct RpAtomic * create_decal_atomic(const struct decal_instance & decal /* r26 */, int vert_size /* r27 */, int tri_size /* r28 */) {
    // Local variables
    unsigned int geom_flags; // r29
    ...
    struct RpTriangle * end_tri; // r28
    struct xColor_tag * color; // r24
    struct xColor_tag * end_color; // r27
...
// Range: 0x8003D474 -> 0x8003D4A8
static void copy_uvmat(struct RwMatrixTag & omat /* r0 */, const struct _xMat3x2 & imat /* r0 */) {}

static char __FUNCTION__[31]; // size: 0x1F, address: 0x804155FC
// total size: 0x10
struct RwSphere {
    // Members
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFC2F0
// Range: 0x8003D710 -> 0x8003D7E4
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC304
char __FUNCTION__$localstatic1$back__53pool_list<Q220@unnamed@xDecal_cpp@16owner_group_type>Fv[5]; // size: 0x5, address: 0x80BFC318
// Range: 0x8003D85C -> 0x8003D900
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFC320
char __FUNCTION__$localstatic1$get_iterator__53pool_list<Q220@unnamed@xDecal_cpp@16owner_group_type>FPCQ220@unnamed@xDecal_cpp@16owner_group_type[13]; // size: 0xD, address: 0x80BFC338
// Range: 0x8003D900 -> 0x8003DBE4
static void remove_from_owner_group(struct decal_instance & decal /* r30 */) {
    // Local variables
    struct owner_group_type * owner_group; // r31
    struct decal_instance * test_decal; // r3
...
// Range: 0x8003DBE4 -> 0x8003DC34
static void queue_removal(struct decal_instance & decal /* r31 */) {}

static unsigned char done; // size: 0x1, address: 0x80C071B8
static signed char init; // size: 0x1, address: 0x80C071B9
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC348
// Range: 0x8003DC34 -> 0x8003DE30
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC35C
// Range: 0x8003DEA8 -> 0x8003DF70
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFC368
// Range: 0x8003E088 -> 0x8003E358
...
static unsigned short rwmodes[3][2]; // size: 0xC, address: 0x80C0A584
// Range: 0x8003E358 -> 0x8003E51C
...
// Range: 0x8003E5D8 -> 0x8003E664
static void destroy_decal(struct decal_instance & decal /* r31 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFC378
// Range: 0x8003E664 -> 0x8003E700
...
// Range: 0x8003E738 -> 0x8003E7D0
static int compare_decals(void * e1 /* r0 */, void * e2 /* r0 */) {
    // Local variables
    const struct decal_instance * d1; // r5
    const struct decal_instance * d2; // r6
}

// Range: 0x8003E7D0 -> 0x8003E7F8
static void begin_render() {
    // References
    // -> static float zbias;
}

// Range: 0x8003E7F8 -> 0x8003E824
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFC388
// Range: 0x8003E878 -> 0x8003E96C
...
// Range: 0x8003E97C -> 0x8003E99C
static void end_render_immediate(const struct decal_instance * instance /* r0 */) {}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFC3A0
// total size: 0x80
...
static int CLIP_XLOWER; // size: 0x4, address: 0x80C0A590
static int CLIP_XUPPER; // size: 0x4, address: 0x80C0A594
static int CLIP_YLOWER; // size: 0x4, address: 0x80C0A598
static int CLIP_YUPPER; // size: 0x4, address: 0x80C0A59C
static int CLIP_ZLOWER; // size: 0x4, address: 0x80C0A5A0
static int CLIP_ZUPPER; // size: 0x4, address: 0x80C0A5A4
// Range: 0x8003EBC4 -> 0x8003EC58
...
static int debug_volumes_start; // size: 0x4, address: 0x80C071BC
static int debug_volumes_size; // size: 0x4, address: 0x80C071C0
// total size: 0x60
...
static struct debug_volume_type debug_volumes[10]; // size: 0x3C0, address: 0x80A5BFF0
// Range: 0x8003EDBC -> 0x8003EDF8
...
// Range: 0x8003EDF8 -> 0x8003EE04
static void debug_update() {
    // References
    // -> static unsigned char enable;
}

// Range: 0x8003EE04 -> 0x8003EFC0
...
// Range: 0x8003F004 -> 0x8003F1D8
static void render_decal_atomic(const struct decal_instance & decal /* r30 */) {
    // Local variables
    struct RpMaterial * material; // r29
    struct RwMatrixTag uvmat; // r1+0x8
    struct RpHAnimHierarchy * heir; // r0
    struct RwMatrixTag * oldheirmat; // r31
...
// Range: 0x8003F1D8 -> 0x8003F248
static unsigned char check_driver_hidden(const struct decal_instance & decal /* r31 */) {}

static struct xMat4x3 cast_test_mat; // size: 0x40, address: 0x80A5C3B0
static float cast_test_sweep; // size: 0x4, address: 0x80C071C4
// total size: 0x34
struct RwRaster {
    // Members
...
// Range: 0x8003F4F8 -> 0x8003F520
static void debug_emit_clear() {}

// Range: 0x8003F520 -> 0x8003F528
static void debug_render_begin(const struct xMat4x3 & mat /* r0 */) {
    // References
    // -> static const struct xMat4x3 * debug_mat;
}

// Range: 0x8003F528 -> 0x8003F5FC
...
// Range: 0x8003F5FC -> 0x8003F6C8
static void debug_render_volume(const struct xBox & box /* r3 */, const struct xMat4x3 & mat /* r31 */) {
    // References
    // -> static int debug_volumes_size;
    // -> static int debug_volumes_start;
    // -> static struct debug_volume_type debug_volumes[10];
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFC3D8
// total size: 0x0
...
// Range: 0x8003F854 -> 0x8003FABC
void update_conveyed_decal(struct decal_instance * decal /* r31 */, float dt /* f0 */) {
    // Local variables
    struct zPlatform * driver_plat; // r30
    float platSpeed; // f31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFC3F0
// Range: 0x8003FABC -> 0x8003FCB4
...
// Range: 0x8003FF18 -> 0x80040160
void emit(const struct emit_context & ec /* r29 */, const struct xMat4x3 & mat /* r30 */, int check_flags /* r31 */) {
    // Local variables
...
// Range: 0x8004017C -> 0x80040414
void sphere_emit(const struct emit_context & ec /* r26 */, const struct xVec3 & center /* r27 */, float radius /* f30 */, int check_flags /* r28 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFC3F8
// Range: 0x800404A4 -> 0x80040C68
void emit(const struct emit_context & ec /* r31 */, const struct xMat4x3 & mat /* r23 */, struct RpAtomic * model /* r24 */, const struct xMat4x3 * model_mat /* r25 */, unsigned char moving_model /* r26 */, struct xEnt * driver_ent /* r27 */) {
    // Local variables
    struct RpGeometry * geom; // r4
    struct RpTriangle * tri; // r21
    struct xVec3 * vert; // r30
    int tri_size; // r20
    int vert_size; // r19
    struct xMat4x3 oldmmat; // r1+0x50
    struct xMat4x3 imat; // r1+0x10
    struct xVec3 * decal_vert; // r29
    unsigned char * temp_scratch; // r28
    struct clip_decal_indexed_params * arg; // r0
    float * weight_buffer; // r18
    float rx; // f31
    float ry; // f30
    unsigned char mountable; // r0
    struct decal_instance * decal; // r19
    struct immediate_mode_data * im; // r18
    int i; // r4
...
// Range: 0x80040D38 -> 0x8004155C
static unsigned char transform_decal_atomic_skinned(struct RpAtomic * atomic /* r1+0x8 */, const struct combo_vertex * cv /* r26 */, struct RpAtomic * iatomic /* r1+0xC */, float * weight_buffer /* r27 */) {
    // Local variables
    struct RpGeometry * geom; // r1+0x28
    struct xVec3 * vert; // r31
    int vert_size; // r1+0x24
    struct RwMatrixWeights * weights; // r1+0x20
    unsigned int * indices; // r1+0x1C
    struct RpGeometry * igeom; // r0
    const struct xVec3 * ivert; // r30
    ...
    struct RwMatrixWeights * bone_weight; // r29
    unsigned int * bone_index; // r28
    int i0; // r14
    int i1; // r6
    float n; // f1
    float o; // f6
    const struct xVec3 & s0; // r5
    const struct xVec3 & s1; // r7
    unsigned int bi0; // r14
    const struct RwMatrixWeights & wt0; // r10
    unsigned int bi1; // r15
    const struct RwMatrixWeights & wt1; // r17
    float sum; // f2
    int i; // r16
    float highest; // f4
    int highest_index; // r17
    int j; // r18
    int i1; // r6
    int i2; // r8
    float m; // f1
    ...
    const struct xVec3 & s2; // r12
    unsigned int bi0; // r22
    const struct RwMatrixWeights & wt0; // r3
    unsigned int bi1; // r21
    const struct RwMatrixWeights & wt1; // r4
    unsigned int bi2; // r20
    const struct RwMatrixWeights & wt2; // r11
    float sum; // f5
    int i; // r19
    float highest; // f3
    int highest_index; // r18
    int j; // r17
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC400
// Range: 0x80041688 -> 0x80041CF0
void emit_env(const struct emit_context & ec /* r31 */, const struct xMat4x3 & mat /* r25 */) {
    // Local variables
    unsigned char * temp_scratch; // r29
    struct intersect_env_params * iarg; // r0
    struct clip_decal_params * carg; // r28
    struct xVec3 * decal_vert; // r27
    unsigned char * outcode; // r26
    float rx; // f31
    float ry; // f30
    struct decal_instance * decal; // r26
    struct immediate_mode_data * im; // r27
    unsigned short * index; // r3
    unsigned short i; // r4
    int free_space; // r0
    struct RpGeometry * geom; // r27
    struct RpTriangle * atri; // r25
    unsigned short i; // r4
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFC40C
// Range: 0x80041CF0 -> 0x80041DD0
...
static struct xDecalEmitter * active_emitters[32]; // size: 0x80, address: 0x80A5C3F0
static unsigned int active_emitters_size; // size: 0x4, address: 0x80C071C8
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC414
// Range: 0x80041DD0 -> 0x80041EE8
static void register_emitter(struct xDecalEmitter * emitter /* r31 */) {
    // Local variables
    unsigned long i; // r0
...
static struct xDecalEmitter dummy_emitter; // size: 0x6C, address: 0x80A5C470
// Range: 0x80041EE8 -> 0x80041F40
void xDecalInit() {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFC428
char __FUNCTION__$localstatic1$init__41static_queue<Q213xDecalEmitter9unit_data>FUlUi[5]; // size: 0x5, address: 0x80BFC430
// Range: 0x80041FB8 -> 0x80042068
// this: r29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC438
char __FUNCTION__$localstatic1$tweak_init__41static_queue<Q213xDecalEmitter9unit_data>FUl[11]; // size: 0xB, address: 0x80BFC444
// Range: 0x80042068 -> 0x80042114
// this: r29
void xDecalEmitter::tweak_init(int max_size /* r30 */, const char * debug_name /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x80042114 -> 0x80042198
// this: r31
void xDecalEmitter::set_default_config() {}

// Range: 0x80042198 -> 0x800421D4
// this: r31
void xDecalEmitter::set_texture(const char * name /* r4 */) {}

// Range: 0x800421D4 -> 0x8004222C
// this: r31
void xDecalEmitter::set_texture(unsigned int id /* r4 */) {}

// Range: 0x8004222C -> 0x8004223C
// this: r0
void xDecalEmitter::set_texture(struct RwTexture * texture /* r0 */) {}

// Range: 0x8004223C -> 0x80042394
// this: r31
void xDecalEmitter::refresh_config() {}

// Range: 0x80042394 -> 0x800423BC
// this: r0
void xDecalEmitter::set_curve(const struct curve_node * curve /* r0 */, unsigned long size /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFC450
char __FUNCTION__$localstatic1$pop_back__41static_queue<Q213xDecalEmitter9unit_data>Fv[9]; // size: 0x9, address: 0x80BFC458
char __FUNCTION__$localstatic1$push_front__41static_queue<Q213xDecalEmitter9unit_data>Fv[11]; // size: 0xB, address: 0x80BFC464
char __FUNCTION__$localstatic1$front__41static_queue<Q213xDecalEmitter9unit_data>Fv[6]; // size: 0x6, address: 0x80BFC470
char __FUNCTION__$localstatic1$__ml__Q241static_queue<Q213xDecalEmitter9unit_data>8iteratorCFv[5]; // size: 0x5, address: 0x80BFC478
// Range: 0x800423BC -> 0x80042568
// this: r28
void xDecalEmitter::emit(const struct xMat4x3 & mat /* r29 */, int texture_index /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFC480
// Range: 0x80042584 -> 0x8004274C
// this: r31
void xDecalEmitter::emit(const struct xMat4x3 & mat /* r27 */, const struct xVec3 & scale /* r28 */, int texture_index /* r29 */) {
    // Local variables
    struct unit_data & unit; // r0
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFC488
char __FUNCTION__$localstatic1$__apl__Q241static_queue<Q213xDecalEmitter9unit_data>8iteratorFi[6]; // size: 0x6, address: 0x80BFC490
char __FUNCTION__$localstatic1$erase__41static_queue<Q213xDecalEmitter9unit_data>FRCQ241static_queue<Q213xDecalEmitter9unit_data>8iteratorRCQ241static_queue<Q213xDecalEmitter9unit_data>8iterator[6]; // size: 0x6, address: 0x80BFC498
// total size: 0x38
...
int _rpPTankAtomicDataOffset; // size: 0x4, address: 0x80C09DD8
// total size: 0x8
...
// Range: 0x8004307C -> 0x80043124
// this: r31
void xDecalEmitter::debug_update_curve() {}

static struct tweak_callback cb_config; // size: 0x28, address: 0x8041561C
static signed char init; // size: 0x1, address: 0x80C071CC
static struct tweak_callback cb_ztest; // size: 0x28, address: 0x80415644
static signed char init; // size: 0x1, address: 0x80C071CD
static struct tweak_callback cb_curve; // size: 0x28, address: 0x8041566C
static signed char init; // size: 0x1, address: 0x80C071CE
static struct tweak_callback cb_change_texture; // size: 0x28, address: 0x80415694
static signed char init; // size: 0x1, address: 0x80C071CF
static char * tm_labels[3]; // size: 0xC, address: 0x80BFC4A0
...
static struct tweak_callback cb_node_time; // size: 0x28, address: 0x804156BC
static signed char init; // size: 0x1, address: 0x80C071D0
// Range: 0x80043B58 -> 0x80043D70
// this: r27
...
// Range: 0x80043D70 -> 0x80043E74
// this: r26
void xDecalEmitter::create_test_curve(unsigned long size /* r27 */) {
    // Local variables
    struct curve_node * curve; // r0
    unsigned long i; // r28
...
// Range: 0x80043EC4 -> 0x80043EEC
void xDecalEmitter::on_change_curve(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xDecalEmitter & owner; // r3
}

// Range: 0x80043EEC -> 0x80043F10
void xDecalEmitter::on_change_config(const struct tweak_info & info /* r3 */) {}

// Range: 0x80043F10 -> 0x80043FE4
void xDecalEmitter::on_change_node_time(const struct tweak_info & info /* r3 */) {
    // Local variables
    struct xDecalEmitter & owner; // r30
    char * found; // r0
    unsigned long i; // r0
    struct curve_node * curve; // r6
}

// Range: 0x80043FE4 -> 0x80044010
void xDecalEmitter::on_change_texture(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xDecalEmitter & owner; // r3
}

// Range: 0x80044010 -> 0x80044014
void xDecalEmitter::on_change_ztest() {}

static float sDirDecalMoveUp; // size: 0x4, address: 0x80BFC4AC
static float sDirDecalDepth; // size: 0x4, address: 0x80BFC4B0
static float sDirDecalMinNormY; // size: 0x4, address: 0x80BFC4B4
static unsigned char DRAW_BOX; // size: 0x1, address: 0x80C071D1
int MAX_FRAMES_TO_SKIP; // size: 0x4, address: 0x80BFC4B8
// total size: 0x10
class xDecalSimple {
    // Functions
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFC4BC
// Range: 0x80044100 -> 0x800441B0
// this: r30
void xDecalSimple::Setup(unsigned int textureID /* r31 */) {
    // Local variables
