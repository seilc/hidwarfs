/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zICompNPCEntity.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AF230 -> 0x802B1218
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gDefaultNPCEntityParams; // size: 0x30, address: 0x80BD2B28
static unsigned char DRAW_ANIM_PHYSICS; // size: 0x1, address: 0x80C096F0
// total size: 0x60
...
class zICompNPCEntity : public zIComponent, public xEnt {
    ...
    void ApplyPosConstraints(struct xVec3 & dPos, float velCorrectionRatio);
...
// Range: 0x802AF230 -> 0x802AF25C
void zICompNPCEntity::BupdateWrapper(struct xEnt * ent /* r3 */) {}

// Range: 0x802AF25C -> 0x802AF2A8
void zICompNPCEntity::NPCBeforeAnimMatrices(struct xAnimPlay * play /* r9 */, struct xQuat * quat /* r8 */, struct xVec3 * tran /* r0 */, int boneCount /* r7 */) {}

// Range: 0x802AF2A8 -> 0x802AF2D8
void zICompNPCEntity::EventWrapper(struct xBase * from /* r3 */, struct xBase * to /* r4 */, unsigned int to_event /* r5 */, const float * to_param /* r6 */, struct xBase * to_param_widget /* r7 */, unsigned int to_param_widget_id /* r8 */) {}
...
// Range: 0x802AF2D8 -> 0x802AF338
void zICompNPCEntity_ScaleModel(struct xModelInstance * modelInst /* r30 */, struct xVec3 & scale /* r31 */) {
    // References
    // -> struct xVec3 m_Ones;
}
...
// Range: 0x802AF338 -> 0x802AF684
// this: r30
void zICompNPCEntity::Attached() {
    // Local variables
    class zNPCBase * ownerNPC; // r29
    const struct zNPCAssetRATS * npcAsset; // r0
    struct xEntFrame * savedFrame; // r29
    struct xShadowSimpleCache * savedSimpShadow; // r28
    struct xEntShadow * savedEntShadow; // r27
...
// total size: 0x4
struct /* @class$1097zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zICompNPCEntity_cpp */ {
    // Members
...
union /* @class$1236zICompNPCEntity_cpp */ {
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C06430
// Range: 0x802AF684 -> 0x802AF704
// this: r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0643C
// Range: 0x802AF704 -> 0x802AF900
// this: r31
...
// Range: 0x802AF900 -> 0x802AFAF4
// this: r31
void zICompNPCEntity::Reset() {
    // Local variables
    class zNPCBase * ownerNPC; // r28
...
// Range: 0x802AFAF4 -> 0x802AFB58
// this: r31
void zICompNPCEntity::InitializeShadowFlag() {}

// Range: 0x802AFB58 -> 0x802AFB5C
void zICompNPCEntity::BeforeAnimMatrices() {}

// Range: 0x802AFB5C -> 0x802AFF1C
// this: r30
void zICompNPCEntity::InitializeBounds(struct xVec3 & modelScale /* r31 */) {
    // Local variables
    float width; // f7
    float height; // f4
    float length; // f3
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06448
// Range: 0x802AFF1C -> 0x802B00E8
// this: r31
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C06458
// Range: 0x802B00E8 -> 0x802B01E0
// this: r29
struct xVec3 zICompNPCEntity::GetBoneWorldPosition(int bone /* r30 */) {
    // Local variables
...
// Range: 0x802B01E0 -> 0x802B020C
// this: r3
void zICompNPCEntity::Render() {}

static unsigned char already_asserted; // size: 0x1, address: 0x80C096F1
static signed char init; // size: 0x1, address: 0x80C096F2
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C06470
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1823zICompNPCEntity_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B020C -> 0x802B0354
// this: r30
void zICompNPCEntity::SetDefaultLightKit(class zNPCBase * ownerNPC /* r4 */) {
    // Local variables
    const struct zNPCAssetRATS * npcAsset; // r0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06484
// Range: 0x802B0354 -> 0x802B0478
// this: r0
...
// Range: 0x802B0478 -> 0x802B04D4
// this: r30
void zICompNPCEntity::SetAnimState(const char * new_state /* r4 */, float blend /* f31 */, struct xModelInstance * model /* r31 */) {}

// Range: 0x802B04D4 -> 0x802B0540
// this: r30
void zICompNPCEntity::SetAnimState(const char * new_state /* r4 */, float blend /* f30 */, float dest_time /* f31 */, struct xModelInstance * model /* r31 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06494
// Range: 0x802B0540 -> 0x802B067C
// this: r0
void zICompNPCEntity::SetAnimState(unsigned int new_stateID /* r29 */, float blend /* f30 */, float dest_time /* f31 */, struct xModelInstance * model /* r30 */) {
    // Local variables
    struct xAnimTransition * transition; // r31
...
// Range: 0x802B067C -> 0x802B06AC
// this: r0
void zICompNPCEntity::SetAnimSpeed(float speed /* f0 */) {}

// Range: 0x802B06AC -> 0x802B06EC
// this: r0
float zICompNPCEntity::GetAnimTime() {}

// Range: 0x802B06EC -> 0x802B0730
// this: r0
float zICompNPCEntity::GetAnimDuration() {}

// Range: 0x802B0730 -> 0x802B07CC
// this: r0
unsigned char zICompNPCEntity::IsAnimationStopped(unsigned int AnimationID /* r0 */) {}

// Range: 0x802B07CC -> 0x802B0838
// this: r0
unsigned char zICompNPCEntity::IsAnimationTranstitionFinished(unsigned int AnimationID /* r0 */) {}

// Range: 0x802B0838 -> 0x802B0840
unsigned char zICompNPCEntity::SystemEvent() {}
...
// Range: 0x802B0B00 -> 0x802B0BF0
// this: r30
void zICompNPCEntity::PreUpdate(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x802B0BF0 -> 0x802B0C88
// this: r31
...
// Range: 0x802B0C88 -> 0x802B0DAC
// this: r30
void zICompNPCEntity::PostUpdate(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
    unsigned int boneIndex; // r3
    struct xMat4x3 boneMat; // r1+0x10
}

// Range: 0x802B0DAC -> 0x802B0DD0
// this: r3
void zICompNPCEntity::ApplyAcc(struct xVec3 & dAcc /* r0 */) {}

// Range: 0x802B0DD0 -> 0x802B0E84
// this: r5
void zICompNPCEntity::UpdateVelocity(float speedLimit /* f30 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x802B0E84 -> 0x802B0EAC
// this: r0
void zICompNPCEntity::ApplyVelConstraints(struct xVec3 & dVel /* r0 */) {}

// Range: 0x802B0EAC -> 0x802B0F44
// this: r31
...
// Range: 0x802B0F44 -> 0x802B0F94
// this: r31
void zICompNPCEntity::ApplyPosConstraints(struct xVec3 & dPos /* r0 */, float velCorrectionRatio /* f31 */) {}

// Range: 0x802B0F94 -> 0x802B0FBC
// this: r0
unsigned char zICompNPCEntity::TurnToVelocityXZ(float dt /* f0 */, float turnSpringK /* f0 */) {}

// Range: 0x802B0FBC -> 0x802B10F8
// this: r30
unsigned char zICompNPCEntity::TurnToFaceXZ(const struct xVec3 * target /* r0 */, float dt /* f30 */, float turnSpringK /* f31 */) {
    // Local variables
    struct xVec3 targetV; // r1+0x8
    float targetVDistance2; // f0
    struct xVec3 * currentHeading; // r31
    float currentYaw; // f0
}
...
// total size: 0xC
struct /* @class$1038zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zICompNPCEntity_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2070zICompNPCEntity_cpp */ {
    // Static members
...
// total size: 0x34
struct {} zICompNPCEntity::__vtable; // size: 0x34, address: 0x804483D8
enum eCompType {
    eCompType_Unknown = -1,
