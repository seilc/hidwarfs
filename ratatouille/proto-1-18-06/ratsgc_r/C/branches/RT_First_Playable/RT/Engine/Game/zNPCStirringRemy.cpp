/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCStirringRemy.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029C340 -> 0x8029C494
*/
char __FUNCTION__$localstatic1$AttachComponent__64zComponentPool<22zCompLogicStirringRemy,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06090
signed char zComponentPool<zCompLogicStirringRemy, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09580
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicStirringRemy, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C09584
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x8029C3D8 -> 0x8029C454
// this: r30
void zNPCStirringRemy::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1221zNPCStirringRemy_cpp */ {
    // Members
...
union /* @class$1361zNPCStirringRemy_cpp */ {
...
// total size: 0xC
struct /* @class$1359zNPCStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCStirringRemy_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1050zNPCStirringRemy_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1051zNPCStirringRemy_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1052zNPCStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1053zNPCStirringRemy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1054zNPCStirringRemy_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCStirringRemy::__vtable; // size: 0x30, address: 0x80447330
