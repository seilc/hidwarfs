/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHud.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80261A94 -> 0x80261E34
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80261A94 -> 0x80261A98
void hud_system::Startup() {}

// Range: 0x80261A98 -> 0x80261A9C
void hud_system::Shutdown() {}

// Range: 0x80261A9C -> 0x80261B04
// this: r31
...
// Range: 0x80261BC8 -> 0x80261C4C
// this: r30
void hud_system::render() {
    // Local variables
    class hud_element * e; // r30

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80261C4C -> 0x80261CCC
// this: r0
...
static signed char init; // size: 0x1, address: 0x80C092D0
static class hud_system _instance; // size: 0xC, address: 0x80C092D4
// Range: 0x80261DA4 -> 0x80261DE0
...
// total size: 0xC
struct {} zHud::hud_system::__vtable; // size: 0xC, address: 0x80C05308
// Range: 0x80261DE0 -> 0x80261E34
// this: r0
