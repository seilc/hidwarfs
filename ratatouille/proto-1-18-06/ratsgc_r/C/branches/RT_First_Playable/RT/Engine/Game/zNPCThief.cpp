/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCThief.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80287A08 -> 0x80289DA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gThiefEntParameters; // size: 0x30, address: 0x80BCC068
// total size: 0x70
...
static class zCompSteeringBasicParams gThiefSteeringParams; // size: 0x70, address: 0x80BCC098
// total size: 0xC
...
// total size: 0x4
struct /* @class$1221zNPCThief_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1359zNPCThief_cpp */ {
    // Members
...
static class zCompCombatParams gThiefCombatParams; // size: 0x18, address: 0x80C093F0
// total size: 0x30
struct xMat3x3 {
    // Members
...
static struct xMat3x3 gThiefPickUpObjOrient; // size: 0x30, address: 0x80444560
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 gThiefPickUpObjOffset; // size: 0xC, address: 0x80C0E9A0
static class zCombatAttack sThiefCombatAttack[1]; // size: 0xB4, address: 0x80BCC108
static struct xHierarchyBoundInitData sThiefCharacterBounds[9]; // size: 0x6C, address: 0x80444590
// total size: 0x68
...
// Range: 0x80287BC8 -> 0x80287C44
void zNPCThief::InitCombatDamage() {
    // References
    // -> static class zCombatAttack sThiefCombatAttack[1];
}

char __FUNCTION__$localstatic1$AttachComponent__57zComponentPool<15zCompLogicThief,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05B38
signed char zComponentPool<zCompLogicThief, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09408
// total size: 0xC
...
class zComponentPool zComponentPool<zCompLogicThief, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0940C
char __FUNCTION__$localstatic1$Attach__22zIComponent<8zNPCBase>FP8zNPCBaseP15zCompParameters[7]; // size: 0x7, address: 0x80C05B48
char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<15zICompNPCEntity,15zICompNPCEntity,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05B50
signed char zComponentPool<zICompNPCEntity, zICompNPCEntity, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09418
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
class zComponentPool zComponentPool<zICompNPCEntity, zICompNPCEntity, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0941C
char __FUNCTION__$localstatic1$AttachComponent__63zComponentPool<18zCompSteeringBasic,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05B60
signed char zComponentPool<zCompSteeringBasic, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09428
// total size: 0x0
class zNPCWalls {};
// total size: 0x4
struct xColor_tag {
...
class zComponentPool zComponentPool<zCompSteeringBasic, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0942C
char __FUNCTION__$localstatic1$AttachComponent__54zComponentPool<11zCompCombat,12zICompCombat,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05B70
signed char zComponentPool<zCompCombat, zICompCombat, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09438
// total size: 0x14
...
class zComponentPool zComponentPool<zCompCombat, zICompCombat, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0943C
// Range: 0x80287C44 -> 0x80287D38
// this: r31
...
// Range: 0x80287D38 -> 0x80287DB4
// this: r30
void zNPCThief::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x80287DB4 -> 0x80287DF4
// this: r31
void zNPCThief::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

static struct zCompStateMachineTable gThiefStateMachineTable[9]; // size: 0x48, address: 0x804445FC
// total size: 0x60
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05B80
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1876zNPCThief_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80287E0C -> 0x80287ED0
// this: r30
void zCompLogicThief::Attached() {
    // Local variables
    class zNPCThief * npcThief; // r31
    struct zNPCAssetThief * npcassThief; // r0
...
// Range: 0x80287ED0 -> 0x80287F40
// this: r30
void zCompLogicThief::Detached() {
    // Local variables
    class zCompLogicThief * compLogic; // r0
}
...
// total size: 0xC
struct /* @class$1047zNPCThief_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCThief_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCThief_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCThief_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCThief_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCThief_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCThief_cpp */ {
    // Members
...
// Range: 0x80287F88 -> 0x80287FC8
// this: r31
void zCompLogicThief::NPCGetsDamage() {
    // Local variables
    class zThiefRunAway * runAwayState; // r0
}
...
// Range: 0x80287FC8 -> 0x80288008
// this: r31
void zCompLogicThief::NPCGivesDamage() {
    // Local variables
    class zThiefTagPlayer * tagPlayerState; // r0
}
...
// Range: 0x80288008 -> 0x80288130
// this: r29
void zCompLogicThief::StopNPC(float StopForceMag /* f30 */, float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xEntFrame * entFrame; // r0
    struct xVec3 * entVel; // r31
    struct xVec3 * entOldVel; // r30
    float oldSpeed; // f0
    struct xVec3 VelocityDir; // r1+0x14
    struct xVec3 dAcc; // r1+0x8
...
// total size: 0x30
struct {} zThiefPatrol::__vtable; // size: 0x30, address: 0x80444794
// total size: 0x28
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C09448
static signed char init; // size: 0x1, address: 0x80C09449
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05B8C
// Range: 0x80288174 -> 0x80288350
// this: r28
void zThiefPatrol::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    const struct xVec3 * curPos; // r4
    float mpArriveDistance; // f31
    struct xMovePoint * nextPatrolPoint; // r1+0x8
...
// total size: 0x4
struct /* @class$2299zNPCThief_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2300zNPCThief_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2301zNPCThief_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2298zNPCThief_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2303zNPCThief_cpp */ {
    // Members
...
// Range: 0x80288350 -> 0x80288420
// this: r28
void zThiefPatrol::CheckTranstitions(class zNPCBase * owner /* r29 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r0
    struct zCommonPlayer * player; // r0
...
// total size: 0x890
struct /* @class$2123zNPCThief_cpp */ {
    // Static members
...
// Range: 0x80288420 -> 0x80288468
// this: r31
void zThiefPatrol::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C05B94
// Range: 0x80288468 -> 0x80288534
// this: r30
void zThiefPatrol::Enter(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zNPCThief * npcThief; // r31
    struct zNPCAssetThief * npcassThief; // r0
...
// Range: 0x80288534 -> 0x8028861C
// this: r30
void zThiefPatrol::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x30
struct {} zThiefAlert::__vtable; // size: 0x30, address: 0x80444764
// total size: 0x14
...
// Range: 0x80288658 -> 0x80288714
// this: r28
void zThiefAlert::Update(class zNPCBase * owner /* r29 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r30
}

// Range: 0x80288714 -> 0x80288760
// this: r31
void zThiefAlert::CheckTranstitions(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// Range: 0x80288760 -> 0x8028883C
void zThiefAlert::Resume(class zNPCBase * owner /* r30 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r0
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r0
...
// total size: 0x30
struct {} zThiefChase::__vtable; // size: 0x30, address: 0x80444734
// total size: 0x14
...
// Range: 0x80288878 -> 0x8028891C
// this: r29
void zThiefChase::Update(class zNPCBase * owner /* r30 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r4
}

// Range: 0x8028891C -> 0x802889D0
// this: r29
void zThiefChase::CheckTranstitions(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zCompLogicThief * compLogic; // r0
    struct zCommonPlayer * player; // r0
...
// Range: 0x802889D0 -> 0x802889FC
// this: r0
void zThiefChase::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802889FC -> 0x80288AE8
void zThiefChase::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r30
    class zCompLogicThief * compLogic; // r0
...
// Range: 0x80288AE8 -> 0x80288B14
// this: r0
void zThiefTagPlayer::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x80288B14 -> 0x80288B18
void zThiefTagPlayer::Exit() {}

// Range: 0x80288B18 -> 0x80288C08
// this: r0
void zThiefTagPlayer::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r30
    class zCompLogicThief * compLogic; // r0
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05B9C
// Range: 0x80288C08 -> 0x80288DC4
// this: r30
void zThiefTagPlayer::Update(class zNPCBase * owner /* r28 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x30
struct {} zThiefPickUp::__vtable; // size: 0x30, address: 0x804446D4
// total size: 0x34
...
// Range: 0x80288E00 -> 0x80288E84
// this: r30
void zThiefPickUp::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {}

// Range: 0x80288E84 -> 0x80289014
// this: r27
unsigned char zThiefPickUp::PickUpObj(class zNPCBase * owner /* r28 */, float dt /* f31 */) {
    // Local variables
    unsigned char pickedUp; // r30
    class zICompNPCEntity * compNPCEntity; // r29
    class zCompLogicThief * compLogic; // r0
    const struct xMat4x3 * npcMat; // r0
    struct xMat4x3 * objMat; // r28
    struct xVec3 curObjEuler; // r1+0x38
    struct xVec3 curObjPos; // r1+0x2C
    struct xVec3 destObjEuler; // r1+0x20
    struct xVec3 destObjPos; // r1+0x14
    struct xVec3 worldPickUpOffset; // r1+0x8
...
// Range: 0x80289014 -> 0x802891D4
unsigned char zThiefPickUp::MoveThiefForPickup(class zNPCBase * owner /* r28 */, float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicThief * compLogic; // r0
    ...
    unsigned char aligned; // r0
    unsigned char inDistance; // r28
    float objDistance; // f0
    float distWithChaseSpeed; // f3
    float distWithChaseSpeed; // f3
...
// Range: 0x802891D4 -> 0x80289298
// this: r29
void zThiefPickUp::Resume(class zNPCBase * owner /* r30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicThief * compLogic; // r0
...
// total size: 0x30
struct {} zThiefRunAway::__vtable; // size: 0x30, address: 0x804446A4
// Range: 0x80289298 -> 0x802892DC
// this: r31
...
// Range: 0x802892DC -> 0x80289468
// this: r28
void zThiefRunAway::Update(class zNPCBase * owner /* r29 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r30
    class zCompLogicThief * compLogic; // r0
...
// Range: 0x80289468 -> 0x80289494
// this: r0
void zThiefRunAway::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x80289494 -> 0x8028961C
// this: r30
void zThiefRunAway::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r29
    class zICompSteering * compSteering; // r28
    class zCompLogicThief * compLogic; // r0
    struct xMat4x3 * objMat; // r3
    const struct xMat4x3 * npcMat; // r0
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C05BA4
// Range: 0x8028961C -> 0x802897E4
struct xGroup * zThiefRunAway::FindHideCirclesGroup(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zNPCThief * npcThief; // r30
    struct zNPCAssetThief * npcassThief; // r0
    unsigned int groupAssetId; // r3
    struct xGroup * hideCirclesGroup; // r29
    struct xBase * b; // r4
    unsigned int numberOfHidingCircles; // r0
    unsigned char validGroup; // r28
    unsigned int i; // r27
    struct xBase * b; // r0
...
// Range: 0x802897E4 -> 0x802898F4
// this: r28
void zThiefRunAway::UpdateHideBehavior(class zNPCBase * owner /* r29 */) {
    // Local variables
    class zICompSteering * compSteering; // r30
    class zICompNPCEntity * compNPCEntity; // r0
    struct xVec3 * playerPos; // r4
...
// Range: 0x802898F4 -> 0x80289A5C
// this: r26
void zThiefRunAway::UpdateHidePoint(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xVec3 * playerPos; // r30
    struct xVec3 * NPCPos; // r29
    float closestHidingPointDistance2; // f29
    unsigned int numberOfHidingCircles; // r0
    unsigned int i; // r28
    struct xMovePoint * mp; // r0
    struct xVec3 * circleCenter; // r27
    float circleRadius; // f28
    struct xVec3 circleHidePos; // r1+0x8
    float npcDistance2; // f1
...
// Range: 0x80289A5C -> 0x80289A90
// this: r0
void zThiefRunAway::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zThiefDrop::__vtable; // size: 0x30, address: 0x80444674
// total size: 0x18
...
// Range: 0x80289ACC -> 0x80289B80
// this: r30
void zThiefDrop::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r4
}

// Range: 0x80289B80 -> 0x80289BAC
// this: r0
void zThiefDrop::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x80289BAC -> 0x80289CD8
// this: r0
void zThiefDrop::Resume(class zNPCBase * owner /* r30 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r30
    class zCompLogicThief * compLogic; // r0
...
// Range: 0x80289CD8 -> 0x80289D24
// this: r0
void zThiefConfused::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// Range: 0x80289D24 -> 0x80289DA4
// this: r31
void zThiefConfused::Update(class zNPCBase * owner /* r4 */, float dt /* f31 */) {
    // Local variables
    class zCompLogicThief * compLogic; // r0
}

// total size: 0x30
struct {} zThiefConfused::__vtable; // size: 0x30, address: 0x80444644
// total size: 0x30
struct {} zThiefTagPlayer::__vtable; // size: 0x30, address: 0x80444704
// total size: 0x54
struct {} zCompLogicThief::__vtable; // size: 0x54, address: 0x804447C4
// total size: 0x30
struct {} zNPCThief::__vtable; // size: 0x30, address: 0x80444818
// total size: 0xC
struct {} zCompCombatParams::__vtable; // size: 0xC, address: 0x80C05BC8
// total size: 0xC
struct {} zICompNPCEntityParams::__vtable; // size: 0xC, address: 0x80C05BBC
