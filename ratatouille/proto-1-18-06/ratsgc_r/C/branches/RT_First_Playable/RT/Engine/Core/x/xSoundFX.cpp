/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xSoundFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800C278C -> 0x800C3234
*/
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFE860
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800C2848 -> 0x800C2868
void xSoundFXInit(void * t /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE878
// Range: 0x800C2868 -> 0x800C2A48
void xSoundFXInit(struct xSoundFX * t /* r30 */, struct xSoundFXAsset * asset /* r31 */) {
    // References
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFE888
// Range: 0x800C2A48 -> 0x800C2B14
void xSoundFXReset(struct xSoundFX * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE898
// Range: 0x800C2B14 -> 0x800C2E94
void xSoundFXEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
    struct xSoundFX * t; // r31
    float destVolume; // f31
    float startVolume; // f31
    float destVolume; // f30

    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x8042E348
// Range: 0x800C2E94 -> 0x800C2FC0
static unsigned char xSoundFXEnsureFreeAudioStream(unsigned char willingToStopMainGameMusic /* r31 */) {
    // Local variables
    unsigned char haveFreeStreamedVoice; // r0

    // References
    // -> static char __FUNCTION__[30];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE8A8
// total size: 0x50
...
// total size: 0x1
struct /* @class$1041xSoundFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044xSoundFX_cpp */ {
    // Members
...
// Range: 0x800C31CC -> 0x800C31F0
static void xSoundFXStop(struct xSoundFX * t /* r3 */) {}
...
// Range: 0x800C31F0 -> 0x800C3234
struct xSoundFX * xSoundFXGet(unsigned int soundfxID /* r0 */) {
    // Local variables
    struct zScene * s; // r4
    int count; // r0
    struct xSoundFX * sfx; // r6
    int i; // r0
