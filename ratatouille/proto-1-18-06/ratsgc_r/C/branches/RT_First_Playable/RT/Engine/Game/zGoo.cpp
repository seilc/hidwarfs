/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGoo.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80213770 -> 0x80213C4C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct zGooParams {
    ...
    struct xEnt * goo_ent; // offset 0x8, size 0x4
};
static struct zGooParams * zgoo_gps; // size: 0x4, address: 0x80C08EB8
static int zgoo_ngps; // size: 0x4, address: 0x80C08EBC
static int zgoo_nused; // size: 0x4, address: 0x80C08EC0
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C04128
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80213770 -> 0x80213898
void zGooInit(int nobj /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
    // -> static int zgoo_nused;
    // -> static int zgoo_ngps;
    // -> static struct zGooParams * zgoo_gps;
    // -> unsigned int gActiveHeap;
}

// Range: 0x80213898 -> 0x802138AC
void zGooExit() {
    // References
    // -> static int zgoo_nused;
    // -> static int zgoo_ngps;
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C04134
// Range: 0x802138AC -> 0x80213B04
int zGooAdd(struct xEnt * obj /* r30 */, float depth /* f31 */, int freezeGroup /* r31 */) {
    // Local variables
    int i; // r0
    struct zGooParams * gp; // r3
...
// Range: 0x80213B04 -> 0x80213BC0
int zGooIs(struct xEnt * obj /* r3 */, float & depth /* r30 */, unsigned int playerCheck /* r5 */) {
    // Local variables
    int ret; // r7
    int i; // r8
...
// Range: 0x80213BC0 -> 0x80213C4C
void zGooMeltFinished(struct RpAtomic * atomic /* r29 */) {
    // Local variables
    int i; // r30
    struct xEnt * gooey; // r3
