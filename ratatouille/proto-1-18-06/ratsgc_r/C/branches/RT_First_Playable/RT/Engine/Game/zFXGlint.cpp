/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFXGlint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020DF18 -> 0x8020E410
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80C08E58
// total size: 0x24
struct config {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03FC0
int system_id; // size: 0x4, address: 0x80C03FCC
// total size: 0x28
...
// total size: 0x1
struct /* @class$1029zFXGlint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zFXGlint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zFXGlint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zFXGlint_cpp */ {
    // Members
...
// Range: 0x8020E054 -> 0x8020E210
void glint::emit(const struct xVec3 & position /* r29 */, float & emit_remaining /* r30 */, float dt /* f30 */, struct config * cfg /* r31 */) {
    // Local variables
...
// Range: 0x8020E210 -> 0x8020E410
int glint::update(unsigned char * mem /* r27 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
