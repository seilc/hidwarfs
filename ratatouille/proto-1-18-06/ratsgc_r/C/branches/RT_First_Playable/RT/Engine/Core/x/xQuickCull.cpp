/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xQuickCull.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800A230C -> 0x800A31CC
*/
// total size: 0x3C
struct xQCControl {
    // Members
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFDE98
// Range: 0x800A230C -> 0x800A25F8
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFDEA8
// Range: 0x800A25F8 -> 0x800A2694
void xQuickCullInit(struct xQCControl * ctrl /* r30 */, const struct xBox * box /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x800A2694 -> 0x800A2734
int xQuickCullIsects(const struct xQCData * a /* r0 */, const struct xQCData * b /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFDEB8
// total size: 0x10
struct xSphere {
    // Members
...
// Range: 0x800A2734 -> 0x800A283C
void xQuickCullForBound(struct xQCControl * ctrl /* r29 */, struct xQCData * q /* r30 */, const struct xBound * b /* r31 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFDEE0
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x800A2B90 -> 0x800A2DE4
void xQuickCullForRay(struct xQCControl * ctrl /* r29 */, struct xQCData * q /* r30 */, const struct xRay3 * r /* r31 */) {
    // Local variables
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFDEF4
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x800A2DE4 -> 0x800A2F9C
void xQuickCullForSphere(struct xQCControl * ctrl /* r29 */, struct xQCData * q /* r30 */, const struct xSphere * s /* r31 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFDF08
// Range: 0x800A2F9C -> 0x800A30EC
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFDF1C
// Range: 0x800A30EC -> 0x800A31A0
void xQuickCullForOBB(struct xQCControl * ctrl /* r28 */, struct xQCData * q /* r29 */, const struct xBox * b /* r30 */, const struct xMat4x3 * m /* r31 */) {
    // Local variables
