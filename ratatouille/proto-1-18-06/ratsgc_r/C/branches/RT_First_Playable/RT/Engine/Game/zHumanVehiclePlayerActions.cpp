/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHumanVehiclePlayerActions.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8027DEF0 -> 0x80280A7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
union /* @class$1263zHumanVehiclePlayerActions_cpp */ {
...
// total size: 0x4
struct /* @class$1124zHumanVehiclePlayerActions_cpp */ {
    // Members
...
static char * surfaceNames[4]; // size: 0x10, address: 0x80C05910
// total size: 0x10
...
static struct driveSurfaceDescriptor surfaceDescriptors[4]; // size: 0x40, address: 0x80443D20
static unsigned char cameraRestartHack; // size: 0x1, address: 0x80C093A0
static unsigned char altControls; // size: 0x1, address: 0x80C05920
static float IDLE_SPEED; // size: 0x4, address: 0x80C05924
static float WALK_SPEED; // size: 0x4, address: 0x80C05928
static float GRAVITY; // size: 0x4, address: 0x80C0592C
static float FORWARD_ROLL_RETARDING; // size: 0x4, address: 0x80C05930
static float MAX_ACCELERATION; // size: 0x4, address: 0x80C05934
static float MAX_NORMAL_SPEED; // size: 0x4, address: 0x80C05938
static float MAX_TURN_SPEED; // size: 0x4, address: 0x80C0593C
static float MIN_SPEED; // size: 0x4, address: 0x80C093A4
static float ENGINE_BRAKING_DECELERATION; // size: 0x4, address: 0x80C05940
static float TURN_MAX; // size: 0x4, address: 0x80C05944
static float COLLISION_REFLECTION_VERTICAL; // size: 0x4, address: 0x80C05948
static float COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x80C093A8
static float COLLISION_REFLECTION_HORIZONTAL_NPC; // size: 0x4, address: 0x80C0594C
static float COLLISION_REFLECTION_HORIZONTAL_DST; // size: 0x4, address: 0x80C05950
static float SECONDARY_DIST; // size: 0x4, address: 0x80C05954
static float MARGIN_ANGLE; // size: 0x4, address: 0x80C093AC
static float TURN_SPEED; // size: 0x4, address: 0x80C05958
static float ACCEL_THRESHOLD; // size: 0x4, address: 0x80C0595C
static unsigned char ACCEL_ON_STICK; // size: 0x1, address: 0x80C093B0
static unsigned char HIT_REACT_ANIM; // size: 0x1, address: 0x80C093B1
static float KNOCKBACK_DIST; // size: 0x4, address: 0x80C05960
static float BIG_EPSILON; // size: 0x4, address: 0x80C05964
// total size: 0x10
struct rest_config {
    // Members
...
static struct rest_config driveRest; // size: 0x10, address: 0x80C05968
float boundYShift; // size: 0x4, address: 0x80C058C8
// total size: 0x7DC
...
// total size: 0x14
struct /* @class$2410zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$2411zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$2412zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x6C
struct /* @class$2413zHumanVehiclePlayerActions_cpp */ {
    // Members
    float dist; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$2414zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2415zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2417zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2418zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2390zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2193zHumanVehiclePlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2194zHumanVehiclePlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2195zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2192zHumanVehiclePlayerActions_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2197zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1537zHumanVehiclePlayerActions_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1999zHumanVehiclePlayerActions_cpp */ {
    // Static members
...
static float driveAngle; // size: 0x4, address: 0x80C093B4
static signed char init; // size: 0x1, address: 0x80C093B8
float PLSBOUND_RADIUS; // size: 0x4, address: 0x80C058C0
// total size: 0x40
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05978
static unsigned int zCOLLISION_REFLECT_Y; // size: 0x4, address: 0x80C0E884
// Range: 0x8027F87C -> 0x8027FA98
// this: r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C05980
char __FUNCTION__$localstatic1$GetOwner__22zIComponent<8zNPCBase>Fv[9]; // size: 0x9, address: 0x80C05990
static unsigned int zCOLLISION_NPC; // size: 0x4, address: 0x80C0E8AC
static unsigned int zCOLLISION_DST; // size: 0x4, address: 0x80C0E8B0
static unsigned int zCOLLISION_NEEDS_DEPEN_OUTER_BOUND; // size: 0x4, address: 0x80C0E8B4
static unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x80C0E8B8
static unsigned int zCOLLISION_NEEDS_DEPEN_INNER_BOUND; // size: 0x4, address: 0x80C0E8BC
float PLSBOUND_MIDRADIUS; // size: 0x4, address: 0x80C058C4
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x8027FA98 -> 0x80280490
// this: r27
void zHumanVehiclePlayerDrive::SphereCollision(const struct xVec3 * pNewPosition /* r0 */, const struct xVec3 * pVelocity /* r28 */, unsigned char * pInGroundContact /* r29 */, struct xVec3 * pGroundNormal /* r30 */) {
    // Local variables
    struct xSphere collisionSphere[5]; // r1+0x84
    int i; // r22
    int i; // r0
    int numGroundCollisions; // r31
    int tempNumCollisions; // r3
    int i; // r5
    struct xVec3 averageGroundNormal; // r1+0x78
    int i; // r21
    const struct xSurface * pSurface; // r3
    struct zSurfaceProps * pSurfaceProps; // r20
    unsigned int surfaceType; // r0
    struct xEnt * pEntity; // r20
    struct xVec3 playerPos; // r1+0x6C
    struct xVec3 npcPos; // r1+0x60
    struct xVec3 knockback; // r1+0x54
    struct xVec3 delta; // r1+0x48
    struct xVec3 tempVelocity; // r1+0x3C
    float scalarVel2; // f0
    class zNPCBase * npcOwn; // r0
    class zICompLogic * logicComponent; // r0
    float hitParams[4]; // r1+0x2C
    float hitParams[4]; // r1+0x1C
    struct xVec3 downVec; // r1+0x10
...
// total size: 0xC
struct /* @class$1065zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1068zHumanVehiclePlayerActions_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1069zHumanVehiclePlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1070zHumanVehiclePlayerActions_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1071zHumanVehiclePlayerActions_cpp */ {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C0599C
enum eCollisionType {
    eCollisionTypeHeadOn = 0,
    eCollisionTypeSideKnock = 1,
    eCollisionTypeDamage = 2,
};
// Range: 0x80280490 -> 0x80280574
// this: r0
...
// Range: 0x80280574 -> 0x802807F0
// this: r26
void zHumanVehiclePlayerDrive::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r27 */, struct xEntFrame * frame /* r28 */) {
    // Local variables
    int i; // r29
...
// Range: 0x802807F0 -> 0x802808C8
// this: r27
void zHumanVehiclePlayerDrive::DepenetrateCollisionList(struct xVec3 * pPosition /* r28 */) {
    // Local variables
    int i; // r29
...
// total size: 0xC
struct /* @class$1262zHumanVehiclePlayerActions_cpp */ {
    // Members
...
// total size: 0x54
struct {} zHumanVehiclePlayerDrive::__vtable; // size: 0x54, address: 0x80443D60
// total size: 0xC
