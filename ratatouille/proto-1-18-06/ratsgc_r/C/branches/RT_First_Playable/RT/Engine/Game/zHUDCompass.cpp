/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHUDCompass.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B1300 -> 0x802B2834
*/
// Range: 0x802B1300 -> 0x802B1358
static int zHUDCompassObjectSort(void * elem1 /* r31 */, void * elem2 /* r0 */) {}
...
// total size: 0x4
struct /* @class$1124zHUDCompass_cpp */ {
    // Members
...
union /* @class$1263zHUDCompass_cpp */ {
...
// total size: 0xC
struct /* @class$1262zHUDCompass_cpp */ {
    // Members
...
class zHUDCompassObject * * objectArray; // size: 0x4, address: 0x80C096F8
class zHUDCompassSystem * * systemArray; // size: 0x4, address: 0x80C096FC
int objectCount; // size: 0x4, address: 0x80C09700
int systemCount; // size: 0x4, address: 0x80C09704
// total size: 0x1
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C064A8
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x802B14B0 -> 0x802B1568
void zHUDCompassController::InsertInObjectArray(class zHUDCompassObject * inObj /* r30 */, int idx /* r31 */) {
    // References
    // -> class zHUDCompassObject * * objectArray;
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C064BC
// Range: 0x802B1578 -> 0x802B1630
void zHUDCompassController::InsertInSystemArray(class zHUDCompassSystem * inSys /* r30 */, int idx /* r31 */) {
    // References
    // -> class zHUDCompassSystem * * systemArray;
    // -> static char __FUNCTION__[20];
    // -> int systemCount;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C064D0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x802B1630 -> 0x802B17C4
// this: r30
zHUDCompassSystem::zHUDCompassSystem(struct zHUDCompassSystemAsset * theAsset /* r31 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C064D8
// total size: 0x10
...
// Range: 0x802B17C4 -> 0x802B1958
void zHUDCompassSystem::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802B1958 -> 0x802B19DC
// this: r0
void zHUDCompassSystem::EventCB(unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r0 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C064E0
// Range: 0x802B19DC -> 0x802B1ACC
void zHUDCompassSystem::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C064E8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x802B1BC0 -> 0x802B1F18
// this: r30
zHUDCompassObject::zHUDCompassObject(struct zHUDCompassObjectAsset * theAsset /* r31 */) {
    // References
    // -> struct xVec3 m_Null;
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C064F0
// Range: 0x802B1F18 -> 0x802B20AC
void zHUDCompassObject::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C064F8
// Range: 0x802B20AC -> 0x802B2250
// this: r31
void zHUDCompassObject::EventCB(unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[8];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C06500
// Range: 0x802B2250 -> 0x802B2340
void zHUDCompassObject::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06508
...
// Range: 0x802B251C -> 0x802B2834
// this: r31
void zHUDCompassObject::Update(float dt /* f31 */) {
    // Local variables
    struct xMat4x3 camMat; // r1+0x30
    struct xVec3 facing; // r1+0x24
    float cosTheta; // f0
    float theta; // r1+0x14
    struct xVec3 toObj; // r1+0x18
    float maxDist; // f0
    float realLength; // f0
    float minBeadSize; // f0
    float maxBeadSize; // f0
