/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xTimer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800CF634 -> 0x800CFE54
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800CF6C8 -> 0x800CF6E8
void xTimerInit(void * b /* r0 */, void * tasset /* r0 */) {}

static unsigned int sPauseTimerHash[20]; // size: 0x50, address: 0x804306C0
// Range: 0x800CF6E8 -> 0x800CF818
...
// Range: 0x800CF818 -> 0x800CF8AC
void xTimerInit(struct xBase * b /* r30 */, struct xTimerAsset * tasset /* r31 */) {
    // Local variables
    struct xTimer * t; // r0
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFEBE0
// Range: 0x800CF8AC -> 0x800CF994
void xTimerReset(struct xTimer * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFEBEC
// total size: 0x0
...
// Range: 0x800CF994 -> 0x800CFA7C
void xTimerSave(struct xTimer * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFEBF8
// Range: 0x800CFA7C -> 0x800CFB64
void xTimerLoad(struct xTimer * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFEC04
// Range: 0x800CFB64 -> 0x800CFCE8
void xTimerEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
    struct xTimer * t; // r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFEC14
// total size: 0x50
...
// Range: 0x800CFCE8 -> 0x800CFE54
void xTimerUpdate(struct xBase * to /* r30 */, struct xScene * sc /* r31 */, float dt /* f31 */) {
    // Local variables
    struct xTimer * t; // r31
