/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCLevelSpecific.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80226EF8 -> 0x80227354
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C044EC
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1085zNPCLevelSpecific_cpp */ {
    // Members
...
union /* @class$820zNPCLevelSpecific_cpp */ {
...
// total size: 0xC
struct /* @class$1249zNPCLevelSpecific_cpp */ {
    // Members
...
// Range: 0x80226EF8 -> 0x80227168
void zNPCLevelSpecificSetup() {
    // References
...
// Range: 0x80227168 -> 0x8022720C
float zNPCLevelSpecificGetRoundRobinTimeOut() {
    // Local variables
    float timeOutValue[15]; // r1+0x8

    // References
    // -> enum ezGameLevel gNPCGameLevel;
}

// Range: 0x8022720C -> 0x802272B0
float zNPCLevelSpecificGetUpdateDistance() {
    // Local variables
    float updateDistanceValue[15]; // r1+0x8

    // References
    // -> enum ezGameLevel gNPCGameLevel;
}

// Range: 0x802272B0 -> 0x80227354
float zNPCLevelSpecificGetSurrenderDistance() {
    // Local variables
    float surrenderDistanceValue[15]; // r1+0x8
