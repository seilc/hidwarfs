/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomSysMessage.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E6C3C -> 0x801E7674
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct {} zUICustomSysMessageManager::__vtable; // size: 0x54, address: 0x8043E688
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x801E6C3C -> 0x801E6CE4
// this: r30
zUICustomSysMessageManager::zUICustomSysMessageManager(class zUI * ui /* r31 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C035A8
// total size: 0xC
...
// Range: 0x801E6CE4 -> 0x801E6FC4
// this: r31
void zUICustomSysMessageManager::Init() {
    // Local variables
    struct xGroup * group; // r0

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x801E6FC4 -> 0x801E7030
// this: r0
unsigned char zUICustomSysMessageManager::IsSignalAllowed(unsigned int toEvent /* r0 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C035B0
// Range: 0x801E7030 -> 0x801E70D8
// this: r30
void zUICustomSysMessageManager::SetInvisible(class zUI * uiElement /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C035C0
// total size: 0x2
...
// Range: 0x801E70D8 -> 0x801E75A4
// this: r30
unsigned char zUICustomSysMessageManager::HandleEvent(struct xBase * from /* r28 */, unsigned int toEvent /* r31 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
    int i; // r0
    class zUIController * c; // r29
    int i; // r0
...
// total size: 0x2
struct /* @class$2044zUICustomSysMessage_cpp */ {
    // Members
...
// Range: 0x801E75A4 -> 0x801E75F8
// this: r3
void zUICustomSysMessageManager::PreUpdate(float dt /* f0 */) {}

// Range: 0x801E75F8 -> 0x801E7674
// this: r3
void zUICustomSysMessageManager::ShowSystemMessage(void (* cb)(struct xBase *, struct xBase *, unsigned int, float *, struct xBase *, unsigned int) /* r0 */, unsigned int _toCBEvent /* r0 */, const float * _toCBParams /* r0 */, struct xBase * _toCBto /* r0 */, struct xBase * _toCBParamWidget /* r0 */, unsigned int _toCBParamWidgetID /* r0 */, const char * sys_message /* r4 */) {}
