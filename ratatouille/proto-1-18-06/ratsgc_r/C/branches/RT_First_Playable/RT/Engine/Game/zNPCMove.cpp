/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCMove.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021572C -> 0x80216118
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char _static_setup; // size: 0x1, address: 0x80C08EE0
static signed char init; // size: 0x1, address: 0x80C08EE1
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04198
// Range: 0x802157F0 -> 0x80215870
// this: r0
unsigned char zNPCMove::systemEvent(struct xBase * from /* r0 */, struct xBase * to /* r0 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {
    // References
...
// Range: 0x802158BC -> 0x802158C0
void zNPCMove::jump_to() {}

unsigned char draw_move_to; // size: 0x1, address: 0x80C08EE2
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C041A4
...
// Range: 0x802158C0 -> 0x80215E08
// this: r25
void zNPCMove::move_to(const struct xVec3 & destination /* r26 */, float dt /* f29 */, unsigned char move_away /* r27 */, unsigned char face_dir /* r28 */, unsigned char change_anim_speed /* r29 */, float arrived_threshold2 /* f30 */) {
    // Local variables
    class zMeshPosition * curMeshPos; // r31
    unsigned char goodMeshPos; // r30
    class zMeshCircle * myCircle; // r0
    class zMeshCircle * nearbyCircles; // r4
    float distanceToPoint2; // f0
    class zNPCCommon * npc; // r23
    struct zCombat * npcCombat; // r0
    struct zCombatDamageInfo dmInfo; // r1+0x2C
    struct xVec3 to_destination; // r1+0x20
    float distance2; // f0
    struct xVec3 desired_facing; // r1+0x14
    struct xVec3 backward; // r1+0x8
...
// Range: 0x80215E08 -> 0x80215FA0
// this: r29
unsigned char zNPCMove::physics_move(float dt /* f30 */) {
    // Local variables
    struct xVec3 target_dpos; // r1+0x18
    float target_length; // f0
    unsigned char succeeded; // r31
    const struct xVec3 & actual_dpos; // r30
    float actual_length; // f0
    struct xVec2 target; // r1+0x10
    struct xVec2 actual; // r1+0x8
}

// Range: 0x80215FA0 -> 0x80215FDC
// this: r0
void zNPCMove::move_away_from(const struct xVec3 & point /* r0 */, float dt /* f0 */) {}

// Range: 0x80215FDC -> 0x80216014
// this: r0
unsigned char zNPCMove::is_stuck() const {}

// Range: 0x80216014 -> 0x8021604C
// this: r0
unsigned char zNPCMove::have_arrived() const {}

// Range: 0x8021604C -> 0x80216118
// this: r31
void zNPCMove::step_move(const struct xVec3 & direction /* r4 */, float distance /* f1 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 pos; // r1+0x8
}

// total size: 0x138
struct {} zNPCMove::__vtable; // size: 0x138, address: 0x8043F320
// total size: 0x10
...
// total size: 0x4
struct /* @class$2210zNPCMove_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zNPCMove_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$1049zNPCMove_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1050zNPCMove_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1051zNPCMove_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1052zNPCMove_cpp */ {
    // Members
