/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zVent.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8020FAF4 -> 0x80210F80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zVent * hilighted; // size: 0x4, address: 0x80C08E60
static char * zVentStateNames[4]; // size: 0x10, address: 0x80C04018
static unsigned int zVentStateValues[4]; // size: 0x10, address: 0x80C04028
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04038
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x1
struct /* @class$941zVent_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$942zVent_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$943zVent_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$944zVent_cpp */ {
    // Members
...
// Range: 0x8020FDF0 -> 0x8020FE38
// this: r31
void zVent::refreshMat() {}

// Range: 0x8020FE38 -> 0x8020FE50
// this: r0
void zVent::reset() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04040
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x8020FE50 -> 0x8020FF1C
// this: r6
int zVent::checkHitPlayer(struct xEnt * tgt /* r30 */, struct xCollis * collide /* r31 */) {
    // Local variables
...
// Range: 0x802101F4 -> 0x8021020C
// this: r0
cbVentHitsBoulder::cbVentHitsBoulder(struct xBase * owner /* r0 */, const struct xBox & box /* r0 */, const struct xMat4x3 & mat /* r0 */, float boulderInfluence /* f0 */, unsigned char fDestroyBoulders /* r0 */) {}
...
// Range: 0x8021020C -> 0x8021025C
// this: r3
enum xSndHandle zVent::playSound(enum iSndGroupHandle sndID /* r4 */) {}
...
// Range: 0x8021025C -> 0x80210378
// this: r31
void zVent::changeState(enum eVentState newState /* r0 */) {}

// Range: 0x80210378 -> 0x80210398
// this: r0
void zVent::render() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04050
// Range: 0x80210398 -> 0x80210518
void zVent::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x80210518 -> 0x80210578
void zVent::setupAll() {
    // Local variables
    struct zScene & scene; // r3
    struct zVent * it; // r31
    struct zVent * end; // r30

    // References
    // -> struct zGlobals globals;
}

static unsigned char done; // size: 0x1, address: 0x80C08E64
static signed char init; // size: 0x1, address: 0x80C08E65
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C04058
// Range: 0x80210578 -> 0x8021066C
void zVent::updateAll(float dt /* f31 */) {
    // Local variables
...
// Range: 0x802106CC -> 0x80210734
// this: r31
void zVent::setup() {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C04064
// Range: 0x80210734 -> 0x8021089C
void zVent::cbDispatch(struct xBase * to /* r31 */, unsigned int event /* r30 */) {
    // Local variables
    struct zVent & e; // r31
...
// Range: 0x80210908 -> 0x80210914
void zVent::enableHilight(const struct tweak_info & info /* r0 */) {
    // References
    // -> struct zVent * hilighted;
}

// Range: 0x80210914 -> 0x80210920
void zVent::disableHilight() {
    // References
    // -> struct zVent * hilighted;
}

// Range: 0x80210920 -> 0x80210944
void zVent::onMove(const struct tweak_info & info /* r3 */) {}

// Range: 0x80210944 -> 0x80210958
void zVent::tweakRToD(void * value /* r0 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x80210958 -> 0x8021096C
void zVent::tweakDToR(void * value /* r0 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x8021096C -> 0x8021098C
// this: r0
...
static struct tweak_callback cbHilight; // size: 0x28, address: 0x803F4410
static struct tweak_callback cbMove; // size: 0x28, address: 0x803F4438
static struct tweak_callback cbMoveDir; // size: 0x28, address: 0x803F4460
// Range: 0x8021098C -> 0x80210E80
// this: r30
...
// Range: 0x80210E80 -> 0x80210F80
// this: r30
unsigned char cbVentHitsBoulder::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
