/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCPourNSwirl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AE7DC -> 0x802AE960
*/
char __FUNCTION__$localstatic1$AttachComponent__62zComponentPool<20zCompLogicPourNSwirl,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C063E0
signed char zComponentPool<zCompLogicPourNSwirl, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C096E0
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicPourNSwirl, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C096E4
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// total size: 0x68
class zNPCPourNSwirl : public zNPCBase {
    // Functions
...
// Range: 0x802AE7DC -> 0x802AE858
// this: r31
unsigned char zNPCPourNSwirl::Activate() {}
...
// Range: 0x802AE858 -> 0x802AE920
// this: r28
void zNPCPourNSwirl::Update(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1155zNPCPourNSwirl_cpp */ {
    // Members
...
union /* @class$1295zNPCPourNSwirl_cpp */ {
...
// total size: 0xC
struct /* @class$1293zNPCPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1047zNPCPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCPourNSwirl_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCPourNSwirl_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCPourNSwirl_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCPourNSwirl_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCPourNSwirl_cpp */ {
    // Members
...
// Range: 0x802AE920 -> 0x802AE960
// this: r31
void zNPCPourNSwirl::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zNPCPourNSwirl::__vtable; // size: 0x30, address: 0x80448378
