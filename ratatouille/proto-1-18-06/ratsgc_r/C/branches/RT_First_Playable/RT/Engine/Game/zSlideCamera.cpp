/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSlideCamera.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80245F40 -> 0x80246460
*/
// total size: 0x10
struct /* @class$1151zSlideCamera_cpp */ {
    // Members
...
// Range: 0x80245F40 -> 0x80245F90
// this: r31
void zSlideCam::create() {}

// Range: 0x80245F90 -> 0x80245FB4
// this: r0
void zSlideCam::load_cfg() {}

// Range: 0x80245FB4 -> 0x80245FF8
// this: r31
void zSlideCam::start() {}

// Range: 0x80245FF8 -> 0x80246138
// this: r30
...
// total size: 0xC
struct /* @class$964zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zSlideCamera_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zSlideCamera_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zSlideCamera_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zSlideCamera_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zSlideCamera_cpp */ {
    // Members
...
// Range: 0x80246138 -> 0x8024627C
static struct xVec3 SpringDamp(const struct xVec3 & currPos /* r29 */, const struct xVec3 & trgPos /* r30 */, const struct xVec3 & prevTrgPos /* r31 */, float deltaTime /* f26 */, float springConst /* f27 */, float dampConst /* f28 */, float springLen /* f29 */) {
    // Local variables
    struct xVec3 disp; // r1+0x20
    struct xVec3 velocity; // r1+0x14
    float len; // f0
    float dot; // f0
    struct xVec3 r; // r1+0x8
}

// Range: 0x8024627C -> 0x802462C8
// this: r30
void zSlideCam::setCurrTgtPos(const struct xVec3 & pos /* r0 */, const struct xVec3 & up /* r31 */) {}

// Range: 0x802462C8 -> 0x80246314
// this: r30
void zSlideCam::setPrevTgtPos(const struct xVec3 & pos /* r0 */, const struct xVec3 & up /* r31 */) {}

// Range: 0x80246314 -> 0x80246460
// this: r31
void zSlideCam::update(float dt /* f31 */) {
    // Local variables
    float len; // f0
    struct xVec3 y_axis; // r1+0x14
}

// total size: 0x4C
struct {} zSlideCam::__vtable; // size: 0x4C, address: 0x80440E08
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$1262zSlideCamera_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1400zSlideCamera_cpp */ {
    // Members
...
union /* @class$1015zSlideCamera_cpp */ {
...
// total size: 0x10
struct /* @class$1028zSlideCamera_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
