/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zWaterhose.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017F168 -> 0x80181BD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwRaster * textureRaster; // size: 0x4, address: 0x80C086C8
// total size: 0x8
struct RwObject {
    // Members
...
struct RwTexture * particleTex; // size: 0x4, address: 0x80C086CC
...
struct WaterhoseCollisionInfo waterhoseCollisionInfo; // size: 0x14, address: 0x80C01D68
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C01D7C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8017F168 -> 0x8017F2EC
void zWaterhoseWidget::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8017F2EC -> 0x8017F348
// this: r30
void zWaterhoseWidget::Init(struct zWaterhoseAsset * a /* r31 */) {
    // References
    // -> struct WaterhoseCollisionInfo waterhoseCollisionInfo;
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C01D84
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8017F348 -> 0x8017F560
void zWaterhoseWidget::EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
    class zWaterhoseWidget & waterhoseWidget; // r0
...
// Range: 0x8017F560 -> 0x8017F594
void * zWaterhose::operator new(unsigned long size /* r31 */) {
    // Local variables
    class zWaterhoseMgr * mgr; // r0
}

// Range: 0x8017F594 -> 0x8017F5C8
void zWaterhose::operator delete(void * mem /* r31 */) {
    // Local variables
    class zWaterhoseMgr * mgr; // r0
}

// Range: 0x8017F5C8 -> 0x8017F5E0
// this: r0
void zWaterhose::SetSegmentLength(float length /* f0 */) {}

// Range: 0x8017F5E0 -> 0x8017F66C
// this: r30
zWaterhose::zWaterhose(struct xVec3 & startPos /* r31 */, struct xVec3 & endPos /* r5 */) {
    // Local variables
...
// Range: 0x8017F66C -> 0x8017F6C4
// this: r30
zWaterhose::~zWaterhose() {}

static unsigned int counter; // size: 0x4, address: 0x80C086D0
static signed char init; // size: 0x1, address: 0x80C086D4
// Range: 0x8017F6C4 -> 0x8017F8F0
// this: r31
...
// Range: 0x8017F900 -> 0x8017F9A8
// this: r31
void zWaterhose::Update(float dt /* f31 */) {}

float WATERHOSE_FADE_DIST; // size: 0x4, address: 0x80C01D8C
float WATERHOSE_CULL_DIST; // size: 0x4, address: 0x80C01D90
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1028zWaterhose_cpp */ {
    // Members
...
// Range: 0x8017FBD0 -> 0x8017FC18
// this: r0
void zWaterhose::Render() {}

unsigned int tweakWHcardTextureID; // size: 0x4, address: 0x80C086D8
unsigned int tweakWHParticleTextureID; // size: 0x4, address: 0x80C086DC
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C01D94
// Range: 0x8017FC18 -> 0x8017FD48
// this: r30
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043CF08
// Range: 0x8017FD48 -> 0x8017FDD0
...
static char __FUNCTION__[31]; // size: 0x1F, address: 0x8043CF24
// Range: 0x8017FDD0 -> 0x8017FE4C
...
// total size: 0xC
struct /* @class$964zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zWaterhose_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zWaterhose_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zWaterhose_cpp */ {
    // Members
...
static struct tweak_callback cb_change_texture; // size: 0x28, address: 0x8043CF44
static signed char init; // size: 0x1, address: 0x80C086E0
static struct tweak_callback cb_change_textureB; // size: 0x28, address: 0x8043CF6C
static signed char init; // size: 0x1, address: 0x80C086E1
...
// Range: 0x8017FE4C -> 0x80180238
// this: r31
void zWaterhose::AddTweaks(unsigned int number /* r4 */) {
    // Local variables
    char name[64]; // r1+0xAC
    char name1[64]; // r1+0x6C
    char prefix[1]; // r1+0x18
    char _buffer[128]; // r1+0x16C
    char _buffer[128]; // r1+0xEC
...
// Range: 0x80180238 -> 0x80180278
void zWaterhose::RemoveTweaks(unsigned int number /* r4 */) {
    // Local variables
    char name[64]; // r1+0x8
}
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C01DA4
// total size: 0x40
...
static float speed; // size: 0x4, address: 0x80C086E4
static signed char init; // size: 0x1, address: 0x80C086E8
static float start; // size: 0x4, address: 0x80C086EC
static signed char init; // size: 0x1, address: 0x80C086F0
static float yOffset; // size: 0x4, address: 0x80C086F4
static signed char init; // size: 0x1, address: 0x80C086F8
static float spread; // size: 0x4, address: 0x80C086FC
static float life; // size: 0x4, address: 0x80C08700
// Range: 0x801803F4 -> 0x80180A6C
// this: r31
void zWaterhose::UpdateParticles(float dt /* f31 */) {
    // Local variables
    int numSteps; // r29
    float angle; // f30
    struct xMat3x3 matEmitter; // r1+0x30
    struct xVec3 emitterUp; // r1+0x1C
    struct xVec3 emitterRight; // r1+0x10
    int p; // r29
    struct Particle & particle; // r28
    float time; // f1
    float size; // f2
    unsigned char alpha; // r3
    int gen; // r28
    struct xMat4x3 & mat; // r27
    int j; // r26
    struct Particle & particle; // r25
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C01DB4
// Range: 0x80180A6C -> 0x80180D80
// this: r31
void zWaterhose::UpdateCrossCards(float dt /* f31 */) {
    // Local variables
    struct RwTexture * tex; // r0
    float angle; // f2
    float angleDiff; // f0
...
static float start; // size: 0x4, address: 0x80C08704
static signed char init; // size: 0x1, address: 0x80C08708
static float yOffset; // size: 0x4, address: 0x80C0870C
static signed char init; // size: 0x1, address: 0x80C08710
static float spread; // size: 0x4, address: 0x80C08714
static signed char init; // size: 0x1, address: 0x80C08718
static float speed; // size: 0x4, address: 0x80C0871C
static signed char init; // size: 0x1, address: 0x80C08720
// Range: 0x80180D80 -> 0x80180FB4
// this: r31
void zWaterhose::CreateCardEdge(int l /* r0 */, float dirX /* f0 */, float dirY /* f0 */) {
    // Local variables
    struct xVec3 dir; // r1+0x28
    struct xMat3x3 matC; // r1+0x40
...
static float start; // size: 0x4, address: 0x80C08724
static signed char init; // size: 0x1, address: 0x80C08728
static float yOffset; // size: 0x4, address: 0x80C0872C
static signed char init; // size: 0x1, address: 0x80C08730
static float spread; // size: 0x4, address: 0x80C08734
static signed char init; // size: 0x1, address: 0x80C08738
static float speed; // size: 0x4, address: 0x80C0873C
static signed char init; // size: 0x1, address: 0x80C08740
// Range: 0x80180FB4 -> 0x801811B0
// this: r31
...
// Range: 0x80181208 -> 0x80181390
// this: r31
void zWaterhose::RenderCrossCardSection(int i /* r25 */) {
    // Local variables
    struct RxObjSpace3DVertex vert[14]; // r1+0x10
    float t; // f30
    int p; // r25
...
// Range: 0x80181390 -> 0x801813D4
void zWaterhose::SetVert(struct RxObjSpace3DVertex & vert /* r0 */, const struct xVec3 & loc /* r0 */, float u /* f0 */, float v /* f0 */, struct xColor_tag & color /* r0 */) {}
...
// Range: 0x801814EC -> 0x801815B8
void zWaterhose::Collide(const struct xBound & bound /* r28 */) {
    // Local variables
    int i; // r30
    struct xSphere * player_spheres[5]; // r1+0x8
    int player_spheres_size; // r0
    int j; // r29
...
// total size: 0x890
struct /* @class$2067zWaterhose_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$1350zWaterhose_cpp */ {
    // Members
...
union /* @class$1015zWaterhose_cpp */ {
...
// total size: 0xC
struct /* @class$1488zWaterhose_cpp */ {
    // Members
...
// Range: 0x801815B8 -> 0x80181690
unsigned char zWaterhose::CollisionCB(struct xEnt & ent /* r31 */) {
    // Local variables
...
// Range: 0x80181690 -> 0x80181694
void zWaterhose::BeginRender() {}

// Range: 0x80181694 -> 0x80181698
...
class zWaterhoseMgr * waterhoseMgr; // size: 0x4, address: 0x80C08744
// total size: 0xC
class zWaterhoseMgr {
    // Functions
    zWaterhoseMgr();
...
// Range: 0x801816EC -> 0x80181704
void zWaterhoseMgr::Remove() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x80181704 -> 0x80181744
void zWaterhoseMgr::Reset() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x80181744 -> 0x80181750
// this: r0
zWaterhoseMgr::zWaterhoseMgr() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C01DC8
// Range: 0x80181750 -> 0x8018199C
// this: r30
class zWaterhose * zWaterhoseMgr::GetMem(unsigned long size /* r31 */) {
    // Local variables
    class zWaterhose * mem; // r29
    class zWaterhose * prev; // r5
    unsigned int i; // r0
    class zWaterhose * mem; // r3
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C01DD0
// Range: 0x8018199C -> 0x80181A78
// this: r30
...
// Range: 0x80181A78 -> 0x80181AA4
void zWaterhoseMgr::Update(float dt /* f0 */) {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x80181AA4 -> 0x80181B34
// this: r0
void zWaterhoseMgr::_Update(float dt /* f31 */) {
    // Local variables
    class zWaterhose * waterhose; // r31
    class zWaterhose * mem; // r30
}

// Range: 0x80181B34 -> 0x80181B40
// this: r0
unsigned char zWaterhose::IsShutDown() {}

// Range: 0x80181B40 -> 0x80181B4C
// this: r0
unsigned char zWaterhose::IsMgrUpdate() {}

// Range: 0x80181B4C -> 0x80181B78
void zWaterhoseMgr::Render() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x80181B78 -> 0x80181BC8
// this: r0
