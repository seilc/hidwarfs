/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicLeftArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A4BBC -> 0x802A5F5C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float anim_speed; // size: 0x4, address: 0x80C06268
static unsigned char freeze; // size: 0x1, address: 0x80C09610
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1182zCompLogicLeftArm_cpp */ {
    // Members
...
union /* @class$1330zCompLogicLeftArm_cpp */ {
...
// total size: 0xC
struct /* @class$1320zCompLogicLeftArm_cpp */ {
    // Members
...
static struct AttachInfo Attachments[2]; // size: 0x118, address: 0x804478A8
// total size: 0x8
...
static struct zCompStateMachineTable gLeftArmStateMachineTable[5]; // size: 0x28, address: 0x804479C0
// Range: 0x802A4BBC -> 0x802A4F40
static void AttachEnt(struct AttachInfo * attach /* r29 */, struct xMat4x3 * rootmat /* r30 */, struct xMat4x3 * bonemat /* r31 */) {
    // Local variables
    struct xVec3 * wtf[3]; // r1+0x8
}
...
// Range: 0x802A4F40 -> 0x802A513C
static void HandleAttachments(struct xModelInstance * model /* r28 */, struct AttachInfo * attach /* r29 */, struct xQuat * quat /* r5 */, struct xVec3 * trans /* r6 */) {
    // Local variables
    struct xMat4x3 rootmat; // r1+0x50
...
// Range: 0x802A513C -> 0x802A51B4
static struct AttachInfo * FindAttachment(char * anim_name /* r29 */) {
    // Local variables
    struct AttachInfo * ap; // r31
    int i; // r30
...
// total size: 0x30
struct {} zLeftArmIdle::__vtable; // size: 0x30, address: 0x80447AD0
// total size: 0x14
...
// Range: 0x802A51F0 -> 0x802A523C
void zLeftArmIdle::Update(class zNPCBase * owner /* r4 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1091zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1092zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1093zCompLogicLeftArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1094zCompLogicLeftArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1095zCompLogicLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1096zCompLogicLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1097zCompLogicLeftArm_cpp */ {
    // Members
...
// Range: 0x802A523C -> 0x802A5268
// this: r0
void zLeftArmIdle::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A5268 -> 0x802A52AC
void zLeftArmIdle::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zLeftArmStir::__vtable; // size: 0x30, address: 0x80447AA0
// total size: 0x14
...
// Range: 0x802A52E8 -> 0x802A5334
void zLeftArmStir::Update(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xModelInstance * model; // r0
...
// Range: 0x802A5334 -> 0x802A5360
// this: r0
void zLeftArmStir::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A5360 -> 0x802A53A4
void zLeftArmStir::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zLeftArmLL::__vtable; // size: 0x30, address: 0x80447A70
// total size: 0x18
...
// Range: 0x802A53E0 -> 0x802A542C
void zLeftArmLL::Update(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xModelInstance * model; // r0
...
// Range: 0x802A542C -> 0x802A5458
// this: r0
void zLeftArmLL::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A5458 -> 0x802A549C
void zLeftArmLL::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zLeftArmUL::__vtable; // size: 0x30, address: 0x80447A40
// total size: 0x18
...
// Range: 0x802A54D8 -> 0x802A5524
void zLeftArmUL::Update(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xModelInstance * model; // r0
...
// Range: 0x802A5524 -> 0x802A5570
// this: r31
void zLeftArmUL::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A5570 -> 0x802A55B4
void zLeftArmUL::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}
...
// Range: 0x802A55E4 -> 0x802A5610
unsigned char zCompLogicLeftArm::IsPlayerDoneStirring(class zNPCBase * owner /* r0 */, class zCompState * fromState /* r0 */, class zCompState * toState /* r0 */) {}

struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80A84818
// Range: 0x802A5610 -> 0x802A5624
unsigned char zCompLogicLeftArm::LLTriggered() {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x802A5624 -> 0x802A565C
...
// Range: 0x802A565C -> 0x802A56A8
unsigned char zCompLogicLeftArm::IsAnimationStopped(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xModelInstance * model; // r0
}

// Range: 0x802A56A8 -> 0x802A5734
...
// Range: 0x802A5734 -> 0x802A57C8
void zCompLogicLeftArm::BeforeAnimMatrices(struct xAnimPlay * play /* r28 */, struct xQuat * quat /* r29 */, struct xVec3 * tran /* r30 */, int boneCount /* r31 */) {
    // Local variables
    class zICompNPCEntity * npcEntity; // r0
    class zCompLogicLeftArm * arm; // r0
}

// total size: 0x1
class zINPC {};
// Range: 0x802A57C8 -> 0x802A58D4
void zCompLogicLeftArm::before_anim_matrices(struct xAnimPlay * play /* r0 */, struct xQuat * quat /* r28 */, struct xVec3 * tran /* r29 */, int boneCount /* r30 */) {
    // Local variables
    struct xModelInstance * model; // r31
    struct AttachInfo * attach; // r4
    struct AttachInfo * attach; // r4
}

// Range: 0x802A58D4 -> 0x802A5A30
...
// Range: 0x802A5B80 -> 0x802A5BA0
// this: r0
void zCompLogicLeftArm::Attached() {}

// Range: 0x802A5BA0 -> 0x802A5F5C
// this: r3
void zCompLogicLeftArm::AllAttached() {
    ...
    struct xModelInstance * model; // r0
    int i; // r28
    unsigned int objID; // r27
    char * base_prefix; // r31
