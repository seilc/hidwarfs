/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSpotlight.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801BA480 -> 0x801BDBB4
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct xColor_tag warnAuraColor; // size: 0x4, address: 0x80C02B68
struct xColor_tag warnLightColor; // size: 0x4, address: 0x80C02B6C
static float camera_clip_radius; // size: 0x4, address: 0x80C02B70
static float camera_clip_expand; // size: 0x4, address: 0x80C02B74
static float player_detect_radius; // size: 0x4, address: 0x80C02B78
static unsigned char enable; // size: 0x1, address: 0x80C08A00
static unsigned char track_camera; // size: 0x1, address: 0x80C02B7C
static float radius; // size: 0x4, address: 0x80C02B80
static float max_dist; // size: 0x4, address: 0x80C02B84
static float view_angle; // size: 0x4, address: 0x80C02B88
static unsigned char render_bounds; // size: 0x1, address: 0x80C08A01
static struct xColor_tag color; // size: 0x4, address: 0x80C02B8C
static unsigned char render_flares; // size: 0x1, address: 0x80C02B90
static unsigned char render_auras; // size: 0x1, address: 0x80C02B91
static unsigned char disable_glow; // size: 0x1, address: 0x80C08A02
static unsigned char render_wireframes; // size: 0x1, address: 0x80C08A03
static unsigned char render_bounds; // size: 0x1, address: 0x80C08A04
static int render_only; // size: 0x4, address: 0x80C02B94
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$1021zSpotlight_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1022zSpotlight_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1023zSpotlight_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1024zSpotlight_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025zSpotlight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026zSpotlight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027zSpotlight_cpp */ {
    // Members
...
static struct flare_element * flares; // size: 0x4, address: 0x80C08A08
static int flares_used; // size: 0x4, address: 0x80C08A0C
// total size: 0x4
struct cone_element {
    // Members
    struct zSpotlight * spotlight; // offset 0x0, size 0x4
};
static struct cone_element * cones; // size: 0x4, address: 0x80C08A10
static int cones_used; // size: 0x4, address: 0x80C08A14
static struct RpAtomic * * light_cone_atomics; // size: 0x4, address: 0x80C08A18
static struct RpAtomic * * aura_cone_atomics; // size: 0x4, address: 0x80C08A1C
static int light_cone_atomics_size; // size: 0x4, address: 0x80C08A20
static int aura_cone_atomics_size; // size: 0x4, address: 0x80C08A24
static struct RpAtomic * test_cone_atomic; // size: 0x4, address: 0x80C08A28
...
// Range: 0x801BA7E8 -> 0x801BA8A0
static int compare_cones(void * e1 /* r0 */, void * e2 /* r0 */) {
    // Local variables
    const struct cone_attrib & a1; // r0
    const struct cone_attrib & a2; // r0
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02B98
// Range: 0x801BA8A0 -> 0x801BA908
static void set_cone_tris(struct RpAtomic * atomic /* r0 */) {
    // Local variables
    struct RpTriangle * tri; // r4
    struct RpTriangle * end_tri; // r5
    int index0; // r6
    int index1; // r7
    int end_index1; // r8
}
...
// Range: 0x801BA908 -> 0x801BAB28
static void set_cone_verts(struct RpAtomic * atomic /* r0 */, float radius /* f29 */, float slope /* f30 */, float max_dist /* f31 */) {
    // Local variables
    struct RpMorphTarget * mt; // r31
    struct xVec3 * vert; // r30
    struct xVec3 * end_vert; // r29
    float dz; // f26
    float dradius; // f25
    float dcos; // f0
    float dsin; // f0
    ...
    float dx; // f19
    float dy; // f18
    struct xVec3 * end_column_vert; // r28
    float end_radius; // f18
    float hdist; // f3
    float hdist2; // f19
...
// Range: 0x801BAC74 -> 0x801BACA4
static void set_cone_atomic_color_solid(struct RpAtomic * atomic /* r0 */, struct xColor_tag & color /* r4 */) {}

// Range: 0x801BACA4 -> 0x801BADFC
static void set_cone_atomic_color_faded(struct RpAtomic * atomic /* r0 */, struct xColor_tag & color /* r0 */) {
    // Local variables
    struct xColor_tag * lum; // r4
    struct xColor_tag * end_lum; // r5
    float rstart; // f5
    float gstart; // f6
    float bstart; // f7
    float astart; // f8
    ...
    float b; // f30
    float a; // f29
    struct xColor_tag * end_column_lum; // r6
}
...
// Range: 0x801BADFC -> 0x801BAF10
static struct RpMeshHeader * cone_stripper(struct RpBuildMesh * build_mesh /* r31 */) {
    // Local variables
    struct RpMeshHeader * mesh_header; // r3
    struct RpMesh * mesh; // r0
    unsigned short * indices; // r7
    int left_index_value; // r6
    int right_index_value; // r8
    unsigned short * end_column; // r0
    int il; // r4
    int ir; // r5
}

// Range: 0x801BAF10 -> 0x801BAF68
static void finalize_cone_atomic(struct RpAtomic * atomic /* r31 */) {
    // Local variables
    struct RpMeshHeader * (* old_callback)(struct RpBuildMesh *, void *); // r1+0xC
    void * old_data; // r1+0x8
}

// Range: 0x801BAF68 -> 0x801BAFC0
static void destroy_atomic(struct RpAtomic * atomic /* r30 */) {
    // Local variables
    struct RwFrame * frame; // r31
}

// Range: 0x801BAFC0 -> 0x801BB040
static void refresh_cone_atomic(struct RpAtomic * atomic /* r30 */, float radius /* f29 */, float slope /* f30 */, float max_dist /* f31 */) {
    // Local variables
    struct RpGeometry * geom; // r31
}

// Range: 0x801BB040 -> 0x801BB0A0
static void set_atomic_color(struct RpAtomic * atomic /* r0 */, struct xColor_tag & color /* r27 */) {
    // Local variables
    struct RpGeometry * geom; // r30
    int materials; // r29
    int i; // r28
...
// Range: 0x801BB0A0 -> 0x801BB114
static void move_atomic(struct RpAtomic * atomic /* r30 */, const struct xMat4x3 & mat /* r31 */, float scale /* f31 */) {}

// Range: 0x801BB114 -> 0x801BB118
static void debug_render() {}

// Range: 0x801BB118 -> 0x801BB194
...
// total size: 0x4
struct /* @class$1080zSpotlight_cpp */ {
    // Members
...
union /* @class$1239zSpotlight_cpp */ {
...
// total size: 0xC
struct /* @class$1238zSpotlight_cpp */ {
    // Members
...
// Range: 0x801BB1B8 -> 0x801BB1DC
void zSpotlight::scene_enter() {}

// Range: 0x801BB1DC -> 0x801BB264
void zSpotlight::scene_exit() {
    // Local variables
    struct RpAtomic * * light; // r31
    struct RpAtomic * * end_light; // r30
    struct RpAtomic * * aura; // r30
    struct RpAtomic * * end_aura; // r31
...
// total size: 0x10
struct /* @class$2079zSpotlight_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801BB264 -> 0x801BB56C
void zSpotlight::setup_all() {
    // Local variables
    struct zScene & s; // r3
    struct zSpotlight * spots; // r25
    int spots_size; // r22
    struct zSpotlight * spot; // r26
    struct zSpotlight * const end_spot; // r29
    struct cone_attrib * cone_buffer; // r28
    struct cone_attrib * cone; // r5
    struct cone_attrib * end_cone; // r27
    struct RpAtomic * * lights; // r26
    struct RpAtomic * * auras; // r25
    int lights_size; // r24
    int auras_size; // r23
    struct cone_attrib * last_light_cone; // r22
...
// total size: 0x10
struct {} zSpotlight::light_volume_type::__vtable; // size: 0x10, address: 0x80C02BF4
// total size: 0x18
...
// Range: 0x801BB56C -> 0x801BB5CC
// this: r29
light_volume_type::light_volume_type(struct RpAtomic * atomic /* r30 */, const struct xMat4x3 & mat /* r31 */) {
    // References
    // -> struct [anonymous] zSpotlight::light_volume_type::__vtable;
}

// Range: 0x801BB5D8 -> 0x801BB654
void zSpotlight::update_all(float dt /* f31 */) {
    // Local variables
    struct zScene & s; // r3
    struct zSpotlight * it; // r31
    struct zSpotlight * end; // r30

    // References
    // -> struct zGlobals globals;
}

// Range: 0x801BB654 -> 0x801BB6B4
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C02BB0
// Range: 0x801BBBC8 -> 0x801BBD4C
void zSpotlight::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1642zSpotlight_cpp */ {
    // Members
    struct xColor_tag color; // offset 0x0, size 0x4
};
// total size: 0x4
struct /* @class$1643zSpotlight_cpp */ {
    // Members
    struct xColor_tag color; // offset 0x0, size 0x4
};
// total size: 0x14
struct /* @class$1644zSpotlight_cpp */ {
    // Members
...
// Range: 0x801BBD4C -> 0x801BBDB4
// this: r31
void zSpotlight::load(const struct zSpotlightAsset & a /* r0 */) {}

// Range: 0x801BBDB4 -> 0x801BBDFC
// this: r31
void zSpotlight::setup() {}

// Range: 0x801BBDFC -> 0x801BBED0
// this: r31
void zSpotlight::reset() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C02BB8
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
unsigned int gThisPlayer; // size: 0x4, address: 0x80C07284
// Range: 0x801BBED0 -> 0x801BC1FC
// this: r30
...
// total size: 0x890
struct /* @class$2326zSpotlight_cpp */ {
    // Static members
...
// Range: 0x801BC1FC -> 0x801BC274
// this: r31
void zSpotlight::activate() {}

// Range: 0x801BC274 -> 0x801BC2C8
// this: r31
void zSpotlight::deactivate() {}

// Range: 0x801BC2C8 -> 0x801BC3B0
// this: r31
void zSpotlight::reload_asset() {}

// Range: 0x801BC3B0 -> 0x801BC420
// this: r31
void zSpotlight::load_attach_to(unsigned int id /* r4 */) {
    // Local variables
    struct xBase * ent; // r0
...
// Range: 0x801BC420 -> 0x801BC480
// this: r31
void zSpotlight::load_target(unsigned int id /* r4 */) {
    // Local variables
    struct xBase * obj; // r0
}

// Range: 0x801BC480 -> 0x801BC4F8
// this: r31
void zSpotlight::load_textures() {}

// Range: 0x801BC4F8 -> 0x801BC644
// this: r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C02BC0
// Range: 0x801BC644 -> 0x801BC7C0
// this: r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C02BCC
// Range: 0x801BC7C0 -> 0x801BC864
// this: r31
void zSpotlight::add_aura() {
    // Local variables
    struct cone_element * cone; // r0
...
// Range: 0x801BCC00 -> 0x801BCC60
// this: r3
void zSpotlight::dispatch(unsigned int event /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02BD8
// Range: 0x801BCC60 -> 0x801BCD58
void zSpotlight::cb_dispatch(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int event /* r27 */, const float * argf /* r28 */, struct xBase * argw /* r29 */, unsigned int argwi /* r30 */) {
    // Local variables
...
// Range: 0x801BCD58 -> 0x801BD080
void zSpotlight::render_flares() {
    // Local variables
    struct RxObjSpace3DVertex * vert_buffer; // r31
    struct RxObjSpace3DVertex * vert; // r26
    struct RxObjSpace3DVertex * end_vert; // r30
    struct RwRaster * raster; // r29
    struct flare_element * flare; // r28
    struct flare_element * end_flare; // r27
...
// Range: 0x801BD080 -> 0x801BD0B8
static void set_vert(struct RxObjSpace3DVertex & vert /* r0 */, float x /* f0 */, float y /* f0 */, float z /* f0 */, float u /* f0 */, float v /* f0 */, struct xColor_tag & color /* r0 */) {}

// Range: 0x801BD11C -> 0x801BD1B0
static void flush_textured_strip(struct RxObjSpace3DVertex * verts /* r30 */, int size /* r31 */) {
    // References
...
// Range: 0x801BD214 -> 0x801BD26C
// this: r31
void zSpotlight::debug_init() {}

// Range: 0x801BD26C -> 0x801BD3FC
// this: r31
...
// Range: 0x801BD44C -> 0x801BD45C
// this: r0
void zSpotlight::debug_refresh_atomics() {}

static struct tweak_callback cb_move_player; // size: 0x28, address: 0x8043DBA0
static signed char init; // size: 0x1, address: 0x80C08A2C
static struct tweak_callback cb_reload; // size: 0x28, address: 0x8043DBC8
static signed char init; // size: 0x1, address: 0x80C08A2D
static struct tweak_callback cb_reload_degrees; // size: 0x28, address: 0x803E8930
static struct tweak_callback cb_rotate_attach_to; // size: 0x28, address: 0x8043DBF0
static signed char init; // size: 0x1, address: 0x80C08A2E
// Range: 0x801BD45C -> 0x801BDA34
// this: r31
void zSpotlight::add_tweaks() {
    // Local variables
    char prefix[64]; // r1+0x98
    struct zSpotlightAsset & a; // r30
...
enum /* @enum$1641zSpotlight_cpp */ {
    FLAG_ON = 1,
    FLAG_DETECT_PLAYER = 2,
    FLAG_ROTATE_ATTACH_TO = 4,
};
// Range: 0x801BDA34 -> 0x801BDA6C
void zSpotlight::on_reload(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zSpotlight & owner; // r31
}

// Range: 0x801BDA6C -> 0x801BDB08
void zSpotlight::on_move_player(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zSpotlight & owner; // r31
...
// Range: 0x801BDB08 -> 0x801BDB50
void zSpotlight::on_rotate_attach_to(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zSpotlight & owner; // r4
}

// total size: 0x10
struct {} xLightVolume::__vtable; // size: 0x10, address: 0x80C02BE4
// Range: 0x801BDB50 -> 0x801BDBB4
// this: r31
