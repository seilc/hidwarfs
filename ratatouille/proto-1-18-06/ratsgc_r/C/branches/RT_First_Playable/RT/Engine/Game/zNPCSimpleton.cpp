/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCSimpleton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B9958 -> 0x802B9AAC
*/
char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<19zCompLogicSimpleton,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06660
signed char zComponentPool<zCompLogicSimpleton, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09748
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicSimpleton, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0974C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x802B99F0 -> 0x802B9A6C
// this: r30
void zNPCSimpleton::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1221zNPCSimpleton_cpp */ {
    // Members
...
union /* @class$1361zNPCSimpleton_cpp */ {
...
// total size: 0xC
struct /* @class$1359zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1047zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCSimpleton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCSimpleton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCSimpleton_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCSimpleton::__vtable; // size: 0x30, address: 0x804489D0
