/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zAssetTypes.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800F57A8 -> 0x800F78E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char __FUNCTION__$localstatic1$anStartBlockRightCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[23]; // size: 0x17, address: 0x80BFF728
char __FUNCTION__$localstatic1$anStartBlockLeftCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[22]; // size: 0x16, address: 0x80BFF740
char __FUNCTION__$localstatic1$anStartDuckCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80BFF758
char __FUNCTION__$localstatic1$anStartJumpCheck__24zAvoidTheStuffPlayerMoveFP15xAnimTransitionP11xAnimSinglePv[17]; // size: 0x11, address: 0x80BFF76C
// total size: 0x28
struct PKRAssetType {
    // Members
...
static struct PKRAssetType assetTypeHandlers[101]; // size: 0xFC8, address: 0x80432B10
// total size: 0xC
...
struct BrainTableEntry g_brainTable[24]; // size: 0x120, address: 0x80433AD8
static unsigned char initialized; // size: 0x1, address: 0x80C07B80
static signed char init; // size: 0x1, address: 0x80C07B81
static unsigned char already_asserted; // size: 0x1, address: 0x80C07B82
static signed char init; // size: 0x1, address: 0x80C07B83
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFF780
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1105zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1243zAssetTypes_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1786zAssetTypes_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x800F57A8 -> 0x800F5914
enum eBrainType GetBrainType(unsigned int brainNameHash /* r28 */, unsigned int assetid /* r31 */) {
    // Local variables
    int i; // r29
    int i; // r4
    ...
    // -> struct BrainTableEntry g_brainTable[24];
    // -> static unsigned char initialized;
    // -> static signed char init;
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFF790
// Range: 0x800F5914 -> 0x800F59E0
...
// Range: 0x800F59E0 -> 0x800F5A0C
void zAssetStartup() {
    // References
    // -> static struct PKRAssetType assetTypeHandlers[101];
}

// Range: 0x800F5A0C -> 0x800F5A2C
void zAssetShutdown() {}

unsigned int gModelReadAssetIDDebug; // size: 0x4, address: 0x80C07B84
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFF7A0
// Range: 0x800F5A2C -> 0x800F5B74
static void * Model_Read(unsigned int assetid /* r28 */, void * indata /* r29 */, unsigned int insize /* r31 */, unsigned int * outsize /* r30 */) {
    // Local variables
    struct RpAtomic * model; // r31
...
// Range: 0x800F5B74 -> 0x800F5BA0
void * Spline_Read(void * indata /* r5 */, unsigned int insize /* r0 */, unsigned int * outsize /* r0 */) {
    // Local variables
    class xNurbs * nurbs; // r5
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFF7AC
// Range: 0x800F5BA0 -> 0x800F5D10
static void * Navigation_Mesh_Read(void * indata /* r1+0x8 */, unsigned int insize /* r30 */, unsigned int * outsize /* r31 */) {
    // Local variables
    class xNavigationMeshAsset * meshAsset; // r28
    int m; // r27
    class xNavigationMeshAssetSubMesh * sub_mesh; // r26

    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x800F5D10 -> 0x800F5D64
static unsigned int * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    unsigned int * ret; // r3
}

// Range: 0x800F5D64 -> 0x800F5D78
static void advance_to_type_size(void * packed_mem_addr /* r0 */) {}

// Range: 0x800F5D78 -> 0x800F5DCC
static struct Triangle * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    struct Triangle * ret; // r3
}

// Range: 0x800F5DCC -> 0x800F5E20
static struct xVec3 * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    struct xVec3 * ret; // r3
}

// Range: 0x800F5E20 -> 0x800F5E74
static struct Exit * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    struct Exit * ret; // r3
}

// Range: 0x800F5E74 -> 0x800F5EC8
static float * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    float * ret; // r3
}

// Range: 0x800F5EC8 -> 0x800F5F18
static unsigned char * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    unsigned char * ret; // r3
}

// Range: 0x800F5F18 -> 0x800F5F1C
static void advance_to_type_size(void * packed_mem_addr /* r0 */) {}

// Range: 0x800F5F1C -> 0x800F5F70
static class xNavigationMeshAssetSubMesh * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh * ret; // r3
}

// Range: 0x800F5F70 -> 0x800F5FC4
static class xNavigationMeshAsset * get_next_packed_mem(void * packed_mem_addr /* r30 */, int array_len /* r31 */) {
    // Local variables
    class xNavigationMeshAsset * ret; // r3
}
...
// Range: 0x800F5FC4 -> 0x800F60A8
void * spline_path::init(void * indata /* r5 */, unsigned int insize /* r0 */, unsigned int * outsize /* r0 */) {
    // Local variables
    struct spline_path * path; // r29
    unsigned int * forward_ids; // r3
    unsigned int * backward_ids; // r28
    int i; // r27
    int i; // r27
}

// Range: 0x800F60A8 -> 0x800F60D0
static void Model_Unload(void * userdata /* r0 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFF7C4
enum RwStreamType {
    rwNASTREAM = 0,
    rwSTREAMFILE = 1,
    rwSTREAMFILENAME = 2,
...
// Range: 0x800F60D0 -> 0x800F6398
static void * BSP_Read(unsigned int assetid /* r29 */, void * indata /* r31 */, unsigned int insize /* r28 */, unsigned int * outsize /* r30 */) {
    // Local variables
    struct RwStream * stream; // r31
    struct RwMemory rwmem; // r1+0x8
    struct RwChunkHeaderInfo chunkHeaderInfo; // r1+0x10
    struct RpWorld * bsp; // r28

    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFF7D0
// total size: 0x1C
...
// Range: 0x800F6398 -> 0x800F6474
static void BSP_Unload(void * userdata /* r0 */) {
    // References
    // -> static char __FUNCTION__[11];
...
union /* @class$1244zAssetTypes_cpp */ {
...
static struct xJSPHeader sDummyEmptyJSP; // size: 0x2C, address: 0x80B8E9F0
static struct xJSPHeader * sTempJSP; // size: 0x4, address: 0x80C07B88
// Range: 0x800F6474 -> 0x800F64F8
static void * JSP_Read(unsigned int assetid /* r7 */, void * indata /* r5 */, unsigned int insize /* r6 */, unsigned int * outsize /* r30 */) {
    // Local variables
    struct xJSPHeader * retjsp; // r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFF7DC
// Range: 0x800F64F8 -> 0x800F65E0
...
// Range: 0x800F65E0 -> 0x800F65F4
static struct RwTexture * TexCB(struct RwTexture * texture /* r3 */, void * data /* r0 */) {
    // Local variables
    struct RwTexture * * texFound; // r0
}
...
// Range: 0x800F65F4 -> 0x800F677C
void * RWTX_Read(void * indata /* r31 */, unsigned int insize /* r29 */, unsigned int * outsize /* r30 */) {
    // Local variables
    struct RwTexDictionary * txd; // r31
    struct RwMemory rwmem; // r1+0x18
    struct RwStream * stream; // r31
    struct RwTexture * tex; // r1+0xC
    struct iAsyncLockRWSentry rw_sentry; // r1+0x8
    struct RwError error; // r1+0x10
}

// Range: 0x800F677C -> 0x800F67AC
void TextureRW3_Unload(void * userdata /* r0 */) {
    // Local variables
...
struct AnimTableList animTable[2]; // size: 0x18, address: 0x80BFF7E8
// Range: 0x800F67AC -> 0x800F67FC
...
static struct xAnimTable * (* tableFuncList[1])(); // size: 0x4, address: 0x80BFF800
// Range: 0x800F67FC -> 0x800F6804
static unsigned int dummyEffectCB() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFF804
// Range: 0x800F6804 -> 0x800F6980
static unsigned int soundEffectCB(unsigned int cbenum /* r30 */, struct xAnimActiveEffect * acteffect /* r31 */, void * object /* r28 */) {
    // Local variables
    unsigned int sndhandle; // r29
    struct xEnt * ent_tmp; // r0
    struct zAnimFxSoundGroup * snd; // r4
...
static unsigned int (* effectFuncList[3])(unsigned int, struct xAnimActiveEffect *, struct xAnimSingle *, void *); // size: 0xC, address: 0x80BFF814
// Range: 0x800F6980 -> 0x800F69A4
static void * FindAssetCB(unsigned int ID /* r0 */) {
    // Local variables
    unsigned int size; // r1+0x8
}

static unsigned char already_asserted; // size: 0x1, address: 0x80C07B8C
static signed char init; // size: 0x1, address: 0x80C07B8D
static struct zPlayer * player; // size: 0x4, address: 0x80C07B90
static signed char init; // size: 0x1, address: 0x80C07B94
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFF820
...
// Range: 0x800F69A4 -> 0x800F7694
static void * ATBL_Read(unsigned int assetid /* r28 */, void * indata /* r31 */, unsigned int * outsize /* r25 */) {
    // Local variables
    unsigned int i; // r27
    unsigned int j; // r4
    unsigned int debugNum; // r30
    unsigned int tmpsize; // r1+0x18
    struct xAnimTable * table; // r27
    struct xAnimState * astate; // r22
    unsigned char * zaBytes; // r0
    struct xAnimAssetTable * zaTbl; // r0
    void * zaRaw; // r24
    struct xAnimAssetFile * zaFile; // r29
    struct xAnimAssetState * zaState; // r26
    unsigned int raw_animation_ids[256]; // r1+0x81C
    unsigned int file_used_animation[256]; // r1+0x41C
    unsigned int num_used_file_used_animations; // r21
    int file_first_index[256]; // r1+0x1C
    int k; // r9
    int num_raw_data; // r6
    struct xAnimFile * * fList; // r0
    const char * animation_name; // r21
    unsigned int animation_name_id; // r5
    struct xAnimTable * (* constructor)(); // r3
    int i; // r6
    enum eBrainType brainType; // r27
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    struct zPlayer * newPlayer; // r0
    const char * assetName; // r21
    struct xAnimTransition * atran; // r0
    char * tmpstr; // r21
    struct xAnimFile * foundFile; // r5
    struct xAnimState * endState; // r21
    struct xAnimFile * endPose; // r4
    unsigned int i; // r23
    struct xAnimFile * file; // r3
    unsigned int j; // r10
    struct xAnimFile * endPose; // r4
    struct xAnimState * state; // r26
    struct xAnimAssetEffect * zaEffect; // r28
    struct xAnimEffect * effect; // r0
...
// total size: 0x4
struct /* @class$2270zAssetTypes_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2189zAssetTypes_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2190zAssetTypes_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2191zAssetTypes_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2188zAssetTypes_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2193zAssetTypes_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2354zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$995zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$996zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$997zAssetTypes_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$998zAssetTypes_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$999zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1000zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1001zAssetTypes_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2033zAssetTypes_cpp */ {
    // Static members
...
// Range: 0x800F7874 -> 0x800F7878
static void Anim_Unload() {}

// Range: 0x800F7878 -> 0x800F7898
static void LightKit_Unload(void * userdata /* r0 */) {}

// Range: 0x800F7898 -> 0x800F78C0
static struct xAnimTable * Anim_ATBL_getTable(struct xAnimTable * (* func)() /* r3 */) {
    // Local variables
    struct xAnimTable * table; // r0
}

// Range: 0x800F78C0 -> 0x800F78E0
static void MovePoint_Unload(void * userdata /* r0 */) {}
