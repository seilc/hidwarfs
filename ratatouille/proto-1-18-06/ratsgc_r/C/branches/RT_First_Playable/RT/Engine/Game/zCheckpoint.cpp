/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCheckpoint.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80226634 -> 0x80226E38
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int currentActive; // size: 0x4, address: 0x80C08F98
unsigned int lastCheckpointNumber; // size: 0x4, address: 0x80C08F9C
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$1061zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1062zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1063zCheckpoint_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1064zCheckpoint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1065zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1066zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1067zCheckpoint_cpp */ {
    // Members
...
static struct tweak_callback tweakOnOffCB; // size: 0x28, address: 0x8043F978
static signed char init; // size: 0x1, address: 0x80C08FA0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1120zCheckpoint_cpp */ {
    // Members
...
union /* @class$955zCheckpoint_cpp */ {
...
// total size: 0xC
struct /* @class$1276zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$2059zCheckpoint_cpp */ {
    // Members
...
class zCheckpoint : private xBase {
    // Functions
    void Init(struct zCheckpointAsset * asset);
...
// Range: 0x80226634 -> 0x80226774
void zCheckpoint::SceneInit(struct zScene * scene /* r0 */) {
    // Local variables
    int count; // r29
    class zCheckpoint * checkpointList; // r4
    unsigned int number; // r0
    int i; // r28

    // References
    // -> static struct tweak_callback tweakOnOffCB;
    // -> unsigned int lastCheckpointNumber;
...
// Range: 0x80226774 -> 0x802267F8
void zCheckpoint::SceneReset(struct zScene * scene /* r0 */) {
    // Local variables
    int count; // r30
    class zCheckpoint * checkpointList; // r29
    int i; // r28
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C044D0
// Range: 0x802267F8 -> 0x80226988
void zCheckpoint::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C044D8
// Range: 0x80226988 -> 0x80226B50
// this: r30
void zCheckpoint::Init(struct zCheckpointAsset * asset /* r31 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1788zCheckpoint_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80226B50 -> 0x80226CAC
// this: r29
void zCheckpoint::Reset() {
    // Local variables
...
// total size: 0x890
struct /* @class$2035zCheckpoint_cpp */ {
    // Static members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C044E0
// Range: 0x80226CAC -> 0x80226DA4
void zCheckpoint::EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r30 */) {
    // Local variables
    class zCheckpoint & checkpoint; // r31
...
// Range: 0x80226DA4 -> 0x80226DB4
// this: r0
void zCheckpoint::Activate() {
    // References
    // -> unsigned int currentActive;
}
...
// Range: 0x80226DB4 -> 0x80226E38
void zCheckpoint::TweakFinishEditCB() {
    // Local variables
    unsigned int takeDamage; // r30
