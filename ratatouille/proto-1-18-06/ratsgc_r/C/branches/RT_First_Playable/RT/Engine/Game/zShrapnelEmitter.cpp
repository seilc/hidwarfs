/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zShrapnelEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801EC728 -> 0x801EEAB4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char track_player; // size: 0x1, address: 0x80C036F8
static float repeat_delay; // size: 0x4, address: 0x80C036FC
static float yoffset; // size: 0x4, address: 0x80C08D58
static float dir_yaw; // size: 0x4, address: 0x80C08D5C
static float dir_pitch; // size: 0x4, address: 0x80C08D60
static float dir_roll; // size: 0x4, address: 0x80C08D64
// Range: 0x801EC728 -> 0x801EC870
...
static class module_type * module; // size: 0x4, address: 0x80C08D68
// Range: 0x801EC870 -> 0x801EC884
static void get_scene_parameters(int & sphere_emitters_max /* r0 */, int & frag_asset_max /* r0 */) {}

// total size: 0x1
struct /* @class$2265zShrapnelEmitter_cpp */ {
    // Members
    unsigned char foo; // offset 0x0, size 0x1
};
// total size: 0x1
struct /* @class$2241zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0x80
struct /* @class$2266zShrapnelEmitter_cpp */ {
    // Members
...
// Range: 0x801EC884 -> 0x801EC9A8
// this: r29
static module_type::module_type(int sphere_emitters_max /* r4 */, int frag_asset_max /* r30 */, unsigned char tweak_alloc /* r0 */) {}

// Range: 0x801EC9A8 -> 0x801ECA28
// this: r31
static void module_type::reset() {
    // Local variables
    struct shared_frag_asset * proj; // r4
    struct shared_frag_asset * end_proj; // r3
}

// Range: 0x801ECA28 -> 0x801ECAA4
// this: r29
static void module_type::update(float dt /* f31 */) {
    // Local variables
    struct activity_data * sphere_emitter; // r31
    struct activity_data * end_sphere_emitter; // r30
}

// Range: 0x801ECAA4 -> 0x801ECAA8
static void module_type::render() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03700
// Range: 0x801ECAA8 -> 0x801ECB38
// this: r31
static struct shared_frag_asset * module_type::alloc_frag_asset() {
    // Local variables
    struct shared_frag_asset * proj; // r3

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C03714
// Range: 0x801ECB38 -> 0x801ECC4C
// this: r28
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03724
// Range: 0x801ECC4C -> 0x801ECE08
// this: r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03734
// Range: 0x801ECE08 -> 0x801ECFDC
// this: r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03748
// Range: 0x801ECFDC -> 0x801ED070
// this: r0
static struct shared_frag_asset * module_type::get_frag_asset(const struct zFragProjectileAsset * from /* r0 */) {
    // Local variables
...
// Range: 0x801ED070 -> 0x801ED074
static void module_type::add_tweaks() {}

static unsigned int test_models[3]; // size: 0xC, address: 0x80C03758
static signed char init; // size: 0x1, address: 0x80C08D6C
// Range: 0x801ED074 -> 0x801ED15C
// this: r31
...
// total size: 0x10
struct /* @class$1981zShrapnelEmitter_cpp */ {
    // Members
...
// Range: 0x801ED15C -> 0x801ED394
// this: r31
static void module_type::debug_update(float dt /* f29 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$2220zShrapnelEmitter_cpp */ {
    // Static members
...
// Range: 0x801ED44C -> 0x801ED458
void zShrapnelEmitterSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x801ED458 -> 0x801ED484
void zShrapnelEmitterReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x801ED484 -> 0x801ED4B0
void zShrapnelEmitterUpdate(float dt /* f0 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x801ED4B0 -> 0x801ED4DC
...
// Range: 0x801ED4DC -> 0x801ED578
void zShrapnelEmitterSphere::set_default_config(struct config_type & cfg /* r0 */) {}
...
// Range: 0x801ED578 -> 0x801ED584
// this: r0
void zShrapnelEmitterSphere::create() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C03764
// Range: 0x801ED584 -> 0x801ED764
// this: r30
void zShrapnelEmitterSphere::activate(const struct config_type & cfg /* r31 */) {
    // Local variables
    struct zShrapnelAsset & shrap; // r0
    struct zFragProjectileAsset & proj; // r0
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03770
// Range: 0x801ED764 -> 0x801ED85C
// this: r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0377C
// total size: 0x8
struct xModelPipe {
    // Members
    unsigned int Flags; // offset 0x0, size 0x4
...
// Range: 0x801ED85C -> 0x801EDBDC
// this: r28
void zShrapnelEmitterSphere::set_config(const struct config_type & cfg /* r29 */) {
    // Local variables
    struct zFragProjectileAsset & proj; // r0
    int i; // r30
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03788
// Range: 0x801EDBDC -> 0x801EDDB0
// this: r28
void zShrapnelEmitterSphere::spawn(const struct xMat4x3 & mat /* r30 */, int amount /* r29 */) {
    // Local variables
    int spawn_range; // r26
    struct xVec3 * dir_buffer; // r31
    struct zShrapnelAsset & shrap; // r25
    struct zFragProjectileAsset & proj; // r0
    int i; // r30
    int model_index; // r0
...
// Range: 0x801EDDB0 -> 0x801EDDB4
void zShrapnelEmitterSphere::update() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03790
// Range: 0x801EDDB4 -> 0x801EDE54
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C037A0
// Range: 0x801EDE54 -> 0x801EDF24
...
// Range: 0x801EE0B4 -> 0x801EE330
// this: r30
void zShrapnelEmitterSphere::init_projectile(struct zFrag * frag /* r31 */) {
    // Local variables
    ...
    float intensity; // f1
    float scale; // f31
    struct xMat4x3 & proj_mat; // r3

    // References
    // -> static class module_type * module;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C037B0
// Range: 0x801EE330 -> 0x801EE3D0
void zShrapnelEmitterSphere::cb_init_projectile(struct zFrag * frag /* r30 */, struct zFragAsset * asset /* r31 */) {
    // Local variables
    struct shared_frag_asset * sfrag; // r0
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C037C4
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1785zShrapnelEmitter_cpp */ {
    // Members
...
union /* @class$1244zShrapnelEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1276zShrapnelEmitter_cpp */ {
    // Members
...
// Range: 0x801EE3D0 -> 0x801EE468
void zShrapnelEmitterSphere::cb_destroy_projectile(struct zFrag * frag /* r31 */) {
    // Local variables
    struct shared_frag_asset * sfrag; // r4
...
// total size: 0xC
struct /* @class$930zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932zShrapnelEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933zShrapnelEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zShrapnelEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zShrapnelEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zShrapnelEmitter_cpp */ {
    // Members
...
// Range: 0x801EE468 -> 0x801EEAB4
void zShrapnelEmitterSphere::add_config_tweaks(const char * prefix /* r25 */, struct config_type & cfg /* r26 */, const struct tweak_callback * cb /* r27 */, void * context /* r28 */) {
    // Local variables
    const struct tweak_callback * cb_convert_degrees; // r0
