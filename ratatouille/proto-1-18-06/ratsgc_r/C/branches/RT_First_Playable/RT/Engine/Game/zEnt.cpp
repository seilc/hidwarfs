/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEnt.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8010C368 -> 0x8010F12C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int g_dbdisp_stdlog; // size: 0x4, address: 0x80C07C68
static int g_dbdisp_showusage; // size: 0x4, address: 0x80C07C6C
unsigned int checkpoint_collision_hack(zEnt*)::model_id; // size: 0x4, address: 0x80C07C70
signed char checkpoint_collision_hack(zEnt*)::localstatic4 guard; // size: 0x1, address: 0x80C07C74
float checkpoint_collision_hack(zEnt*)::xlower; // size: 0x4, address: 0x80C07C78
signed char checkpoint_collision_hack(zEnt*)::localstatic6 guard; // size: 0x1, address: 0x80C07C7C
float checkpoint_collision_hack(zEnt*)::xupper; // size: 0x4, address: 0x80C07C80
signed char checkpoint_collision_hack(zEnt*)::localstatic8 guard; // size: 0x1, address: 0x80C07C84
float checkpoint_collision_hack(zEnt*)::ylower; // size: 0x4, address: 0x80C07C88
signed char checkpoint_collision_hack(zEnt*)::localstatic10 guard; // size: 0x1, address: 0x80C07C8C
float checkpoint_collision_hack(zEnt*)::yupper; // size: 0x4, address: 0x80C07C90
signed char checkpoint_collision_hack(zEnt*)::localstatic12 guard; // size: 0x1, address: 0x80C07C94
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C00058
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x1
struct /* @class$1041zEnt_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zEnt_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zEnt_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zEnt_cpp */ {
    // Members
...
// Range: 0x8010C368 -> 0x8010CB00
void zEntInit(struct zEnt * ent /* r29 */, struct xEntAsset * asset /* r30 */, unsigned int type /* r31 */) {
    // Local variables
    int num_used; // r0
    struct xAnimState * ast; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00064
// Range: 0x8010CB00 -> 0x8010CB80
void zEntSetup(struct zEnt * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x8010CB80 -> 0x8010CD70
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C00070
// Range: 0x8010CD70 -> 0x8010CE40
void zEntSave(struct zEnt * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C0007C
// Range: 0x8010CE40 -> 0x8010CF10
void zEntLoad(struct zEnt * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static unsigned char already_asserted; // size: 0x1, address: 0x80C07C95
static signed char init; // size: 0x1, address: 0x80C07C96
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00088
// Range: 0x8010CF10 -> 0x8010D118
void zEntReset(struct zEnt * ent /* r30 */) {
    // Local variables
    struct xAnimState * ast; // r0
...
// Range: 0x8010D118 -> 0x8010D138
void zEntUpdate(struct zEnt * ent /* r0 */, struct zScene * scene /* r0 */, float elapsedSec /* f0 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00094
// Range: 0x8010D138 -> 0x8010D274
void zEntEventAll(struct xBase * from /* r27 */, unsigned int fromEvent /* r28 */, unsigned int toEvent /* r29 */, float * toParam /* r30 */) {
    // Local variables
    struct zScene * s; // r31
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C000A4
// Range: 0x8010D274 -> 0x8010D370
void zEntEventAllOfType(struct xBase * from /* r25 */, unsigned int fromEvent /* r26 */, unsigned int toEvent /* r27 */, float * toParam /* r28 */, unsigned int type /* r29 */) {
    // Local variables
    struct zScene * s; // r31
...
// Range: 0x8010D370 -> 0x8010D3A4
void zEntEventAllOfType(unsigned int toEvent /* r3 */, unsigned int type /* r4 */) {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C000B8
// total size: 0x14
...
// Range: 0x8010D3A4 -> 0x8010D780
struct xModelInstance * zEntRecurseModelInfo(void * info /* r30 */, struct xEnt * ent /* r31 */) {
    // Local variables
    unsigned int i; // r27
    unsigned int bufsize; // r1+0x8
    struct RpAtomic * imodel; // r26
    struct xModelInstance * tempInst[64]; // r1+0xC
    struct xModelAssetInfo * zinfo; // r0
    struct xModelAssetInst * zinst; // r26
    struct xAnimTable * table; // r3
...
// Range: 0x8010D780 -> 0x8010D800
void zEntParseModelInfo(struct xEnt * ent /* r30 */, unsigned int assetID /* r31 */) {
    // Local variables
    unsigned int bufsize; // r1+0x8
    void * info; // r4
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C000D0
// Range: 0x8010D800 -> 0x8010D8D8
static void zEntTransitionToState(struct xAnimPlay * play /* r29 */, struct xAnimState * state /* r30 */) {
    // Local variables
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C000E8
// Range: 0x8010D8D8 -> 0x8010DC30
void zEntAnimEventCore(struct xModelInstance * model /* r0 */, struct xAnimTable * atbl /* r28 */, unsigned int animEvent /* r27 */, const float * animParam /* r29 */) {
    // Local variables
    struct xAnimPlay * play; // r31
    struct xAnimSingle * single; // r30
    int anum; // r5
    char name[12]; // r1+0x2C
    struct xAnimState * ast; // r28
    char name[12]; // r1+0x20
    struct xAnimState * ast; // r0
    int anum1; // r0
    int anum2; // r3
    char name[12]; // r1+0x14
    struct xAnimState * ast; // r4
    int anum; // r0
    float prob; // f31
    char name[12]; // r1+0x8
    struct xAnimState * ast; // r4
...
// Range: 0x8010DC30 -> 0x8010DC78
void zEntAnimEvent(struct zEnt * ent /* r7 */, unsigned int animEvent /* r4 */, const float * animParam /* r6 */) {}

unsigned int g_hash_xentanim[5]; // size: 0x14, address: 0x80C000FC
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C00110
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8010DC78 -> 0x8010E400
void zEntAnimEvent_AutoAnim(struct zEnt * ent /* r31 */, unsigned int animEvent /* r26 */, const float * animParam /* r27 */) {
    // Local variables
    struct xAnimPlay * play; // r30
    struct xAnimSingle * single; // r29
    int anum; // r28
    struct xAnimTable * tab; // r3
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00128
// Range: 0x8010E400 -> 0x8010E4D4
struct xModelAssetParam * zEntGetModelParams(unsigned int assetID /* r0 */, unsigned short * size /* r30 */) {
    // Local variables
    unsigned int bufsize; // r1+0x8
    unsigned int tempsize; // r3
    void * info; // r0
    struct xModelAssetInfo * minf; // r0

    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x8010E4D4 -> 0x8010E524
struct xModelAssetParam * zParamGetNext(struct xModelAssetParam * param /* r3 */, unsigned short * size /* r0 */) {}

// Range: 0x8010E524 -> 0x8010E544
char * zParamGetString(struct xModelAssetParam * param /* r0 */, unsigned int size /* r0 */, const char * tok /* r0 */, const char * def /* r0 */) {}

// Range: 0x8010E544 -> 0x8010E5CC
char * zParamGetString(struct xModelAssetParam * param /* r29 */, unsigned int size /* r30 */, char * tok /* r5 */, char * def /* r31 */) {
    // Local variables
    unsigned int testhash; // r0
}

// Range: 0x8010E5CC -> 0x8010E5EC
int zParamGetInt(struct xModelAssetParam * param /* r0 */, unsigned int size /* r0 */, const char * tok /* r0 */, int def /* r0 */) {}

// Range: 0x8010E5EC -> 0x8010E660
int zParamGetInt(struct xModelAssetParam * param /* r0 */, unsigned int size /* r0 */, char * tok /* r0 */, int def /* r30 */) {
    // Local variables
    char * str; // r31
}

// Range: 0x8010E660 -> 0x8010E680
float zParamGetFloat(struct xModelAssetParam * param /* r0 */, unsigned int size /* r0 */, const char * tok /* r0 */, float def /* f0 */) {}

// Range: 0x8010E680 -> 0x8010E6C4
float zParamGetFloat(struct xModelAssetParam * param /* r0 */, unsigned int size /* r0 */, char * tok /* r0 */, float def /* f31 */) {
    // Local variables
    char * str; // r0
}
...
// Range: 0x8010E6C4 -> 0x8010E8B8
void zEntGetShadowParams(struct xEnt * ent /* r27 */, struct xVec3 * center /* r28 */, struct xVec3 * radius /* r29 */, float * strength /* r30 */, enum radius_enum rtype /* r31 */) {
    // Local variables
    struct xBox * bbox; // r0
    float r; // f1
...
// Range: 0x8010E8B8 -> 0x8010EB04
void zEntGetShadowParams(struct xEnt * ent /* r27 */, struct xVec3 * center /* r28 */, float * radius /* r29 */, float * strength /* r31 */, enum radius_enum rtype /* r30 */) {
    // Local variables
    struct xBox * bbox; // r0
    float r; // f1
    struct xVec3 * lower; // r0
...
// Range: 0x8010EB04 -> 0x8010ECF4
void zEntSetOrientation(const struct xMat4x3 & mat /* r29 */, struct RwMatrixTag * modelmat /* r30 */, unsigned char use_world_up /* r31 */) {
    // Local variables
    float right_len; // f0
    float up_len; // f0
    float at_len; // f0
    struct xVec3 _up_; // r1+0x20
    struct xVec3 _at_; // r1+0x14
    struct xVec3 _right_; // r1+0x8
}

int zEventLogBufInit; // size: 0x4, address: 0x80C07280
char zEventLogBuf[20][256]; // size: 0x1400, address: 0x80A5DE60
// Range: 0x8010ECF4 -> 0x8010EF40
void zEventDebugLog(struct xBase * from /* r26 */, unsigned int fromEvent /* r29 */, struct xBase * to /* r27 */, unsigned int toEvent /* r28 */) {
    // Local variables
    int i; // r25
    const char * te; // r28
    char dkf[64]; // r1+0x48
