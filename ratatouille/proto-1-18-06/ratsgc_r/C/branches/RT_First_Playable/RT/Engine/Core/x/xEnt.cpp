/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xEnt.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80048920 -> 0x800507B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float nsn_angle; // size: 0x4, address: 0x80BFC4F8
// total size: 0x18
struct xBox {
    // Members
...
static struct xBox all_ents_box; // size: 0x18, address: 0x80C071E0
static int all_ents_box_init; // size: 0x4, address: 0x80C071F8
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct xEnt * * dbg_xents; // size: 0x4, address: 0x80C071FC
static unsigned short dbg_num; // size: 0x2, address: 0x80C07200
static signed short dbg_idx; // size: 0x2, address: 0x80BFC4FC
static int dbg_mode; // size: 0x4, address: 0x80C07204
static int dbg_holding_inc; // size: 0x4, address: 0x80C07208
static int dbg_holding_dec; // size: 0x4, address: 0x80C0720C
static float dbg_tmr; // size: 0x4, address: 0x80C07210
static float dbg_ltm; // size: 0x4, address: 0x80C07214
// total size: 0x20
struct xModCollRec {
    // Members
...
static struct xModCollRec * mcrecs; // size: 0x4, address: 0x80C07218
static int num_mcrecs; // size: 0x4, address: 0x80C0721C
static long long mctime; // size: 0x8, address: 0x80C07220
static struct xModCollRec smcrecs[150]; // size: 0x12C0, address: 0x80A5C5A0
enum eModCollMode {
    eModCollMode_None = 0,
    eModCollMode_CTime = 1,
    eModCollMode_LTime = 2,
};
static enum eModCollMode mcmode; // size: 0x4, address: 0x80C07228
static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFC500
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80BFC508
// Range: 0x80048C48 -> 0x80048E78
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC510
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFC51C
// Range: 0x80048E78 -> 0x80048EA0
void xEntSceneInit() {
    // References
    // -> static int all_ents_box_init;
}

// Range: 0x80048EA0 -> 0x80048EC0
void xEntSceneExit() {}

// Range: 0x80048EC0 -> 0x80048F70
static void xEntAddHittableFlag(struct xEnt * ent /* r0 */) {
    // Local variables
    unsigned int i; // r0
}

static unsigned int receive_models[29]; // size: 0x74, address: 0x80415EE8
// Range: 0x80048F70 -> 0x80048FC4
...
// Range: 0x80049250 -> 0x8004947C
void xEntInitForType(struct xEnt * ent /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC534
// Range: 0x8004947C -> 0x8004958C
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC548
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8004958C -> 0x800497F4
static unsigned char collide_downward(struct xVec3 & loc /* r29 */, struct xEnt * & hit /* r30 */, struct xScene & s /* r26 */, struct xEnt & ent /* r31 */, float max_dist /* f30 */) {
    // Local variables
    float lower_bound_extent; // f0
    struct xVec3 & center; // r27
    struct xRay3 ray; // r1+0x1C
    unsigned char old_bound_type; // r28
...
// total size: 0x1
struct /* @class$1042xEnt_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1043xEnt_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1044xEnt_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1045xEnt_cpp */ {
    // Members
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFC55C
// Range: 0x800497F4 -> 0x80049870
...
// Range: 0x80049C44 -> 0x80049C64
void xEntDrop(struct xEnt * ent /* r0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFC574
// total size: 0x1C
...
// Range: 0x80049C64 -> 0x8004A0D8
void xEntSetup(struct xEnt * ent /* r30 */) {
    // Local variables
    struct xSurface * surf; // r0
    struct zSurfaceProps * pp; // r28
    struct xModelInstance * minst; // r3
...
// Range: 0x8004A0D8 -> 0x8004A158
static void HackHoldableTurret(struct xEnt * ent /* r31 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFC580
// Range: 0x8004A158 -> 0x8004A2F4
void xEntDrivenBySetup(struct xEnt * ent /* r26 */) {
    // Local variables
    int i; // r27
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC594
// Range: 0x8004A3BC -> 0x8004A4BC
void xEntSave(struct xEnt * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC5A0
// Range: 0x8004A4BC -> 0x8004A5C8
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFC5B8
// Range: 0x8004ABCC -> 0x8004AD50
struct xModelInstance * xEntLoadModel(struct xEnt * ent /* r27 */, struct RpAtomic * imodel /* r28 */, struct xModelInstance * reuseInstance /* r29 */) {
    // Local variables
...
// Range: 0x8004AD50 -> 0x8004AD78
static void xEntAddToPos(struct xEnt * ent /* r0 */, const struct xVec3 * dpos /* r0 */) {}

static int setMaterialTextureRestore; // size: 0x4, address: 0x80C0722C
int LocateSurfTexture_TexAnim(zSurfaceProps*, int)::useGroups; // size: 0x4, address: 0x80C07230
signed char LocateSurfTexture_TexAnim(zSurfaceProps*, int)::localstatic4 guard; // size: 0x1, address: 0x80C07234
char __FUNCTION__$localstatic1$LocateSurfTexture_TexAnim__FP13zSurfacePropsi[26]; // size: 0x1A, address: 0x80415FBC
// Range: 0x8004AD78 -> 0x8004ADA4
void xEntSetupPipeline(struct xModelInstance * model /* r4 */) {}

unsigned char ReportUVProb; // size: 0x1, address: 0x80BFCD48
// Range: 0x8004ADA4 -> 0x8004AF54
void xEntSetupPipeline(struct xSurface * surf /* r30 */, struct RpAtomic * model /* r31 */) {
    // Local variables
    int setPipeline; // r29
    struct zSurfaceProps * pp; // r28
    struct RwTexture * texptr; // r4
    struct RwTexture * texptr; // r27
    char err[1024]; // r1+0x8
...
// Range: 0x8004B054 -> 0x8004B080
void xEntRestorePipeline(struct xModelInstance * model /* r4 */) {}

// Range: 0x8004B080 -> 0x8004B0B8
void xEntRestorePipeline(struct RpAtomic * model /* r4 */) {
    // References
    // -> static int setMaterialTextureRestore;
}

struct xEnt * gEnt_Debug; // size: 0x4, address: 0x80C07238
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC5D0
int gDrawInvisibleWalls; // size: 0x4, address: 0x80C08228
// Range: 0x8004B0B8 -> 0x8004B298
...
// Range: 0x8004B298 -> 0x8004B504
static void xEntRender_DebugInfo(struct xEnt * ent /* r31 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFC5DC
// total size: 0x118
struct xStats {
    // Members
...
// Range: 0x8004B504 -> 0x8004B724
void xEntUpdate(struct xEnt * ent /* r29 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
    long long t0; // r0
    long long tec; // r0
    long long t1; // r0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC638
// Range: 0x8004C4C8 -> 0x8004C72C
...
int xent_nupdates; // size: 0x4, address: 0x80BFC64C
int xent_entent_nchks; // size: 0x4, address: 0x80BFC650
float xent_ee_per_upd; // size: 0x4, address: 0x80BFC654
int xent_nentcoll; // size: 0x4, address: 0x80BFC658
float xent_ec_per_upd; // size: 0x4, address: 0x80BFC65C
float xent_ee_per_ec; // size: 0x4, address: 0x80BFC660
int xent_nqcrejects; // size: 0x4, address: 0x80BFC664
float xent_qcr_per_upd; // size: 0x4, address: 0x80BFC668
float xent_qcr_per_ec; // size: 0x4, address: 0x80BFC66C
float xent_qcr_per_ee; // size: 0x4, address: 0x80BFC670
// Range: 0x8004C72C -> 0x8004C858
...
// Range: 0x8004C858 -> 0x8004CB08
void xEntCollide(struct xEnt * ent /* r28 */, struct xScene * sc /* r29 */, float dt /* f29 */) {
    // Local variables
    long long t2; // r0
...
// Range: 0x8004CB08 -> 0x8004CC6C
void xEntBeginCollide(struct xEnt * ent /* r31 */) {
    // Local variables
    unsigned char idx; // r11
    struct xCollis * coll; // r12
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFC674
struct xColor_tag g_NEON_BLUE; // size: 0x4, address: 0x80C0A298
struct xColor_tag g_NEON_RED; // size: 0x4, address: 0x80C0A290
// Range: 0x8004CC6C -> 0x8004CE6C
void xEntEndCollide(struct xEnt * ent /* r31 */, struct xScene * sc /* r29 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC684
// Range: 0x8004CE6C -> 0x8004CFF8
void xEntCollCheckEnv(struct xEnt * p /* r30 */, struct xScene * sc /* r31 */) {
    // Local variables
...
static int offs[4][3][2]; // size: 0x60, address: 0x80415FD8
static int k; // size: 0x4, address: 0x80C07258
// total size: 0xC
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFC698
// total size: 0x38
struct xGrid {
    // Members
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFC6AC
struct xGrid npcs_grid; // size: 0x38, address: 0x80B931F8
// Range: 0x8004D33C -> 0x8004D400
void xEntCollCheckNPCsByGrid(struct xEnt * p /* r29 */, struct xScene * sc /* r30 */, struct xEnt * (* hitIt)(struct xEnt *, struct xScene *, void *) /* r31 */) {
    // References
    // -> struct xGrid npcs_grid;
    // -> static char __FUNCTION__[24];
}

int xent_entent; // size: 0x4, address: 0x80C0725C
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80416038
// Range: 0x8004D400 -> 0x8004D984
struct xEnt * xEntCollCheckOneEntNoDepen(struct xEnt * ent /* r31 */, void * data /* r26 */) {
    // Local variables
    struct xEnt * p; // r0
    struct xCollis * coll; // r28
    unsigned int modl_coll; // r29
    struct xBound tmp; // r1+0x8
    struct xBound * bptr; // r0
    long long t0; // r0
    unsigned char ncolls; // r27
    struct xVec3 * upper; // r25
    struct xVec3 * lower; // r24
    long long t1; // r0
    unsigned char idx; // r4
    float rsum; // f4
    float dx; // f2
    float dy; // f31
    float dz; // f1
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC6C4
// Range: 0x8004D984 -> 0x8004DD6C
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC6D8
// Range: 0x8004DD6C -> 0x8004E014
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFC6EC
// Range: 0x8004E014 -> 0x8004E4AC
void xEntCollideWalls(struct xEnt * p /* r28 */, struct xScene * sc /* r29 */, float dt /* f31 */) {
    // Local variables
    struct xCollis * coll; // r26
    struct xEnt * cent; // r27
    unsigned char eidx; // r30
...
// Range: 0x8004E4AC -> 0x8004E4B4
struct xBox * xEntGetAllEntsBox() {
    // References
    // -> static struct xBox all_ents_box;
}

// Range: 0x8004E4B4 -> 0x8004E51C
void xEntDebugInit() {
    // References
...
// Range: 0x8004E558 -> 0x8004E5B4
void xEntDebugAdd(struct xEnt * xent /* r0 */) {
    // References
    // -> static unsigned short dbg_num;
    // -> static struct xEnt * * dbg_xents;
}

static int sBoneIndex; // size: 0x4, address: 0x80C07260
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFC700
// Range: 0x8004E5B4 -> 0x8004E710
...
// Range: 0x8004E710 -> 0x8004E7EC
static char * xEntCollTypeStrSingle(unsigned char type /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFC70C
// Range: 0x8004E7EC -> 0x8004E940
static char * xEntCollTypeStrAll(char * str /* r30 */, unsigned char type /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x8004E940 -> 0x8004E9E8
static char * xEntCollLevStr(unsigned char lev /* r0 */) {}

// Range: 0x8004E9E8 -> 0x8004EA78
static char * xEntBoundTypeStr(unsigned char type /* r0 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFC720
// Range: 0x8004EA78 -> 0x8004EC10
static char * xEntBoundValStr(char * str /* r30 */, const struct xBound * b /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char scoll_name[6][6]; // size: 0x24, address: 0x80416054
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFC730
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8004F370 -> 0x8004F498
static void xEntDebugDraw(const struct xEnt * xent /* r30 */) {
    // Local variables
...
// Range: 0x8004F9F4 -> 0x8004FAE4
static void xModCollAdd(struct xEnt * xent /* r0 */) {
    // Local variables
    struct xModCollRec * end; // r6
    struct xModCollRec * mc; // r7
...
// Range: 0x8004FAE4 -> 0x8004FBAC
void xModCollAddSample(struct xEnt * xent /* r0 */, long long elapsed /* r0 */) {
    // Local variables
    struct xModCollRec * end; // r7
    struct xModCollRec * mc; // r8
...
// Range: 0x8004FBAC -> 0x8004FC08
static int CmpModCollCtime(void * a /* r0 */, void * b /* r0 */) {}

// Range: 0x8004FC08 -> 0x8004FCB8
static int CmpModCollLtime(void * a /* r0 */, void * b /* r0 */) {
    // Local variables
    struct xModCollRec * mca; // r0
    struct xModCollRec * mcb; // r0
}

// Range: 0x8004FCB8 -> 0x8004FFEC
static void xModCollCB() {
    // Local variables
    struct xModCollRec * mc; // r28
    int i; // r29
    float scale; // f31
...
// Range: 0x80050494 -> 0x800504D8
void xEntOpacityInit(struct xEntOpacity * opacity /* r0 */, struct xEnt * ent /* r0 */) {}

// Range: 0x800504D8 -> 0x80050610
void xEntOpacityUpdate(struct xEntOpacity * opacity /* r0 */, struct xEnt * ent /* r0 */, float dt /* f0 */) {}

// Range: 0x80050610 -> 0x80050614
void xEntLoadCheckPoint() {}

// Range: 0x80050614 -> 0x80050618
void xEntStoreCheckPoint() {}

// Range: 0x80050618 -> 0x80050624
void on_select_debug_me(const struct tweak_info & info /* r0 */) {
    // References
    // -> struct xEnt * gEnt_Debug;
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFC740
// Range: 0x80050624 -> 0x800506E0
void on_change_active_model(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xEnt * this_ent; // r31
    struct xModelInstance * active_model; // r3
    int i; // r4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFC758
// Range: 0x800506E0 -> 0x800507B8
void on_change_show_vertex(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xEnt * this_ent; // r31
    struct xModelInstance * active_model; // r3
    int i; // r4
    signed short verts; // r3
