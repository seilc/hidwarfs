/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xHudUnitMeter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800734B8 -> 0x800740B4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float tweak_anim_time_delta; // size: 0x4, address: 0x80BFD098
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFD09C
// total size: 0x18C
...
// Range: 0x800734B8 -> 0x8007364C
void unit_meter_widget::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
static unsigned char registered; // size: 0x1, address: 0x80C073F8
static signed char init; // size: 0x1, address: 0x80C073F9
// total size: 0x30
struct {} xhud::unit_meter_widget::__vtable; // size: 0x30, address: 0x804186A0
// Range: 0x8007364C -> 0x800737D8
// this: r15
unit_meter_widget::unit_meter_widget(const struct unit_meter_asset & a /* r16 */) {
    // Local variables
    int i; // r18
    int j; // r17
...
// total size: 0x10
struct /* @class$1270xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1085xHudUnitMeter_cpp */ {
    // Members
...
union /* @class$820xHudUnitMeter_cpp */ {
...
// total size: 0xC
struct /* @class$1347xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1310xHudUnitMeter_cpp */ {
    // Members
...
enum /* @enum$1311xHudUnitMeter_cpp */ {
    ACT_NONE = 0,
    ACT_SHOW = 1,
    ACT_HIDE = 2,
    MAX_ACT = 3,
...
// total size: 0xC
struct /* @class$1026xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029xHudUnitMeter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030xHudUnitMeter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031xHudUnitMeter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032xHudUnitMeter_cpp */ {
    // Members
...
// Range: 0x800737D8 -> 0x800737F8
// this: r0
void unit_meter_widget::destruct() {}

// Range: 0x800737F8 -> 0x80073818
// this: r0
void unit_meter_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x80C073FC
static signed char init; // size: 0x1, address: 0x80C07400
// Range: 0x80073818 -> 0x80073858
...
static struct tweak_callback tweakOffsetX; // size: 0x28, address: 0x803AFD90
static struct tweak_callback tweakOffsetY; // size: 0x28, address: 0x803AFDB8
unsigned int FB_XRES; // size: 0x4, address: 0x80C00BDC
unsigned int FB_YRES; // size: 0x4, address: 0x80C00BE0
// Range: 0x800738C0 -> 0x80073C04
// this: r30
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFD0A4
// Range: 0x80073C04 -> 0x80073E08
// this: r28
void unit_meter_widget::update(float dt /* f31 */) {
    // Local variables
    int units; // r30
    int i; // r29
    int which; // r5
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFD0AC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
