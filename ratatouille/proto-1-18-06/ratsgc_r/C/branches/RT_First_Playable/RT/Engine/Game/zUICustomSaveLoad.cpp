/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomSaveLoad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026ED28 -> 0x8026F5DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
class zUICustomNewGameManager : public zUICustom {
    // Members
public:
...
// total size: 0x4
struct /* @class$1169zUICustomSaveLoad_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1307zUICustomSaveLoad_cpp */ {
    // Members
...
union /* @class$1308zUICustomSaveLoad_cpp */ {
...
// total size: 0x10
struct /* @class$1556zUICustomSaveLoad_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2018zUICustomSaveLoad_cpp */ {
    // Static members
...
static int sysMsgType; // size: 0x4, address: 0x80C055A8
// total size: 0x54
struct {} zUICustomSaveLoadManager::__vtable; // size: 0x54, address: 0x80443780
// total size: 0x10
class zUICustomSaveLoadManager : public zUICustom {
    // Functions
    zUICustomSaveLoadManager(class zUI * ui);

    void Init();

    unsigned char HandleEvent(struct xBase * from, unsigned int toEvent, const float * toParam);
...
// Range: 0x8026ED28 -> 0x8026ED70
// this: r31
zUICustomSaveLoadManager::zUICustomSaveLoadManager(class zUI * ui /* r0 */) {
    // References
    // -> struct [anonymous] zUICustomSaveLoadManager::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C055AC
// Range: 0x8026ED70 -> 0x8026EE70
// this: r31
void zUICustomSaveLoadManager::Init() {
    // References
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C055B4
// Range: 0x8026EE70 -> 0x8026F5DC
// this: r29
unsigned char zUICustomSaveLoadManager::HandleEvent(struct xBase * from /* r30 */, unsigned int toEvent /* r0 */, const float * toParam /* r31 */) {
    // Local variables
    struct xGroup * slotGroup; // r30
...
// total size: 0x2
struct /* @class$2044zUICustomSaveLoad_cpp */ {
    // Members
