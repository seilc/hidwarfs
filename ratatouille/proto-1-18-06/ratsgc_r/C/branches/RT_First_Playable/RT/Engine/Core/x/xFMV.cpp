/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xFMV.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8005AE8C -> 0x8005B2AC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sFMVVolumeScale; // size: 0x4, address: 0x80BFCA88
static void (* sxFMVPauseSoundCB)(unsigned char); // size: 0x4, address: 0x80BFCA8C
// Range: 0x8005AE8C -> 0x8005AED0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFCA90
// total size: 0x10
struct BINKRECT {
    // Members
...
// Range: 0x8005AFC0 -> 0x8005B2AC
struct RwTexture * xFMVGetTexture(struct MOVIE * pMovie /* r27 */, unsigned short looping /* r28 */, unsigned short freezeframed /* r29 */, unsigned int startframe /* r30 */, unsigned int endframe /* r31 */) {
    // Local variables
    struct RwRaster * pBinkRaster; // r25
    unsigned char * pBits; // r26
    int bFailed; // r0
