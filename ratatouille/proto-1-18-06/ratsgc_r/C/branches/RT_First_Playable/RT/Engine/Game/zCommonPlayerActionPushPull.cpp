/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCommonPlayerActionPushPull.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802836BC -> 0x80284860
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float STICK_MAGNITUDE; // size: 0x4, address: 0x80C05AC0
static float PERP_DIST; // size: 0x4, address: 0x80C05AC4
static float ACCELERATION; // size: 0x4, address: 0x80C05AC8
static float SPEED_MAX; // size: 0x4, address: 0x80C05ACC
// total size: 0x20
...
// Range: 0x802837A4 -> 0x80283928
// this: r30
void zCommonPlayerActionPushPull::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x80283928 -> 0x80283968
// this: r3
void zCommonPlayerActionPushPull::AddActionTransitions(struct xAnimTable * table /* r0 */) {}

// Range: 0x80283968 -> 0x80283C24
void zCommonPlayerActionPushPull::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x80283C24 -> 0x80283C70
// this: r0
unsigned int zCommonPlayerActionPushPull::PushCheck() {}

// Range: 0x80283C70 -> 0x80283CC0
// this: r3
...
// total size: 0x4
struct /* @class$1088zCommonPlayerActionPushPull_cpp */ {
    // Members
...
union /* @class$1236zCommonPlayerActionPushPull_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zCommonPlayerActionPushPull_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1029zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zCommonPlayerActionPushPull_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// Range: 0x80283CC0 -> 0x80283D0C
// this: r0
unsigned int zCommonPlayerActionPushPull::PullCheck() {}

// Range: 0x80283D0C -> 0x80283D34
// this: r0
unsigned int zCommonPlayerActionPushPull::MoveStopCheck() {}

// Range: 0x80283D34 -> 0x80283D5C
// this: r0
unsigned int zCommonPlayerActionPushPull::MoveReleaseCheck() {}

// Range: 0x80283D5C -> 0x80283D6C
// this: r0
unsigned int zCommonPlayerActionPushPull::ReleaseCheck() {}

// Range: 0x80283D6C -> 0x80283DB4
// this: r31
unsigned int zCommonPlayerActionPushPull::GrabFinishCB() {}

// Range: 0x80283DB4 -> 0x80283DF0
// this: r0
void zCommonPlayerActionPushPull::AddStandardTransitionsFrom(struct xAnimTable * table /* r0 */, const char * fromStates /* r0 */) {}

// Range: 0x80283DF0 -> 0x80283E3C
void zCommonPlayerActionPushPull::AddTransitionsFrom(struct xAnimTable * table /* r4 */, const char * fromStates /* r5 */, unsigned short priority /* r6 */, float blend /* f0 */, unsigned int flags /* r8 */, unsigned int userFlags /* r9 */) {}

// Range: 0x80283E3C -> 0x80283E4C
// this: r0
...
// Range: 0x80283E4C -> 0x80283F78
// this: r30
unsigned char zCommonPlayerActionPushPull::GetDesiredState() {
    // Local variables
    const struct AnalogStick & controlStick; // r0
...
// Range: 0x80283F78 -> 0x80284034
// this: r31
unsigned char zCommonPlayerActionPushPull::PullCanSucceed(float translation /* f31 */) {
    // Local variables
    struct xVec3 startPos; // r1+0x14
    struct xVec3 endPos; // r1+0x8
...
// Range: 0x80284034 -> 0x802840B8
// this: r31
unsigned char zCommonPlayerActionPushPull::PushCanSucceed(float translation /* f31 */) {
    // Local variables
    struct xVec3 pos; // r1+0x8
}

// Range: 0x802840B8 -> 0x8028411C
// this: r30
void zCommonPlayerActionPushPull::Timestep() {}

// Range: 0x8028411C -> 0x80284538
// this: r27
void zCommonPlayerActionPushPull::Move(struct xScene * s /* r28 */, float dt /* f29 */, struct xEntFrame * frame /* r29 */) {
    // Local variables
    float gridCellSize; // f0
    unsigned char toIdle; // r31
    float translation; // f30
    unsigned int animFlags; // r0
    unsigned char moved; // r30
    unsigned char moveable; // r0
    unsigned char desiredState; // r0
    float oldSpeed; // f0
    float pos; // f4
    float cellPos; // f1
    float toCell; // f31
    float actualTranslation; // f1
    struct xVec3 & objectPos; // r26
...
// Range: 0x80284538 -> 0x80284814
// this: r31
void zCommonPlayerActionPushPull::Begin() {
    // Local variables
    int side; // r29
    float distance; // f31
    const struct xBound & bound; // r0
...
// total size: 0x4
struct /* @class$2221zCommonPlayerActionPushPull_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2222zCommonPlayerActionPushPull_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2223zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2220zCommonPlayerActionPushPull_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2225zCommonPlayerActionPushPull_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1484zCommonPlayerActionPushPull_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80284814 -> 0x80284840
// this: r0
void zCommonPlayerActionPushPull::End() {}

// Range: 0x80284840 -> 0x80284860
// this: r0
void zCommonPlayerActionPushPull::NotifyCollision(const struct SphereCollisionResults & sceneCollide /* r0 */) {}

// total size: 0x54
struct {} zCommonPlayerActionPushPull::__vtable; // size: 0x54, address: 0x80443DE8
// total size: 0xC
