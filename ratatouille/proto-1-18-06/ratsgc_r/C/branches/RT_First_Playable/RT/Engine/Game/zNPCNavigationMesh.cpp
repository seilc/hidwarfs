/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCNavigationMesh.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801442B8 -> 0x801445B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char draw_mesh; // size: 0x1, address: 0x80C08318
static unsigned char draw_bounds; // size: 0x1, address: 0x80C08319
static unsigned char draw_decision; // size: 0x1, address: 0x80C0831A
static unsigned char draw_direction; // size: 0x1, address: 0x80C0831B
static unsigned char draw_portals; // size: 0x1, address: 0x80C0831C
// total size: 0x1
class zNPCNavigationMesh {};
// Range: 0x801442B8 -> 0x80144374
unsigned char zNPCNavigationMesh::static_setup() {
    // References
    // -> static unsigned char draw_portals;
    // -> static unsigned char draw_direction;
    // -> static unsigned char draw_decision;
    // -> static unsigned char draw_bounds;
    // -> static unsigned char draw_mesh;
}
...
// total size: 0x4
struct /* @class$1138zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1276zNPCNavigationMesh_cpp */ {
    // Members
...
union /* @class$1277zNPCNavigationMesh_cpp */ {
...
// total size: 0x10
struct /* @class$1866zNPCNavigationMesh_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$2294zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2253zNPCNavigationMesh_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2254zNPCNavigationMesh_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2255zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2252zNPCNavigationMesh_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2257zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1079zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1080zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1081zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1082zNPCNavigationMesh_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1083zNPCNavigationMesh_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1084zNPCNavigationMesh_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1085zNPCNavigationMesh_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2105zNPCNavigationMesh_cpp */ {
    // Static members
...
// Range: 0x80144374 -> 0x801445B8
void zNPCNavigationMesh::draw_all_meshes() {
    // Local variables
    const struct xMat4x3 & camMat; // r0
    int count; // r26
    class xNavigationMeshAsset * asset; // r0
    class zMeshCircle * currentCircle; // r23
    struct xVec3 center; // r1+0x40
    struct xVec3 offset; // r1+0x34
    int m; // r25
    class xNavigationMeshAssetSubMesh * sub_mesh; // r24
    int i; // r23
    struct xVec3 a; // r1+0x28
    struct xVec3 b; // r1+0x1C
    struct xVec3 c; // r1+0x10

    // References
    // -> struct xColor_tag g_CHARTREUSE;
    // -> static unsigned char draw_mesh;
