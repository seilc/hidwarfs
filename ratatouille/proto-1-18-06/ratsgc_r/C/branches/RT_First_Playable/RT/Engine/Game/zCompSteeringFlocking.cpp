/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompSteeringFlocking.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029DA48 -> 0x8029E504
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gDefaultFlockingParams; // size: 0x8C, address: 0x80BD2268
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$1038zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zCompSteeringFlocking_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x64
struct {} zCompSteeringFlocking::__vtable; // size: 0x64, address: 0x804474D8
// total size: 0x3C
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C060E0
// Range: 0x8029DABC -> 0x8029DB9C
// this: r30
void zCompSteeringFlocking::AllAttached() {
    // Local variables
    class zNPCBase * parentNPC; // r31
...
// Range: 0x8029DB9C -> 0x8029DBBC
// this: r0
void zCompSteeringFlocking::Detached() {}

// Range: 0x8029DBBC -> 0x8029DBDC
// this: r0
void zCompSteeringFlocking::Reset() {}

// Range: 0x8029DBDC -> 0x8029DBFC
// this: r0
void zCompSteeringFlocking::Update(struct xScene * xscn /* r0 */, float dt /* f0 */) {}

static unsigned char renderSeperationForce; // size: 0x1, address: 0x80C095C0
static unsigned char renderPlayerAvoidenceForce; // size: 0x1, address: 0x80C095C1
static unsigned char renderAlignmentForce; // size: 0x1, address: 0x80C095C2
static unsigned char renderCohesionForce; // size: 0x1, address: 0x80C095C3
static unsigned char renderWallAvoidenceForce; // size: 0x1, address: 0x80C095C4
static unsigned char renderSphereAvoidenceForce; // size: 0x1, address: 0x80C095C5
static unsigned char renderWanderForce; // size: 0x1, address: 0x80C095C6
static unsigned char renderSeekForce; // size: 0x1, address: 0x80C095C7
static unsigned char renderFleeForce; // size: 0x1, address: 0x80C095C8
// Range: 0x8029DBFC -> 0x8029DDF8
...
static class zNPCBase * gNeighbourNPCs; // size: 0x4, address: 0x80C095CC
static int gNumberNeighbourNPCs; // size: 0x4, address: 0x80C095D0
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8029DDF8 -> 0x8029E210
// this: r28
void zCompSteeringFlocking::CalculateForce(struct xVec3 & force /* r29 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */, float dt /* f31 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r0
    class zNPCBase * parentSwarmNPC; // r0
...
// Range: 0x8029E210 -> 0x8029E308
// this: r25
void zCompSteeringFlocking::GetSeperationForce(struct xVec3 & SeperationForce /* r26 */, class zSteeringBasicDynamics & steeringDynamics /* r27 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r0
    const struct xVec3 * neighbourEntityPos; // r29
    int i; // r28
    class zICompNPCEntity * curNeighbourEntity; // r0
    float dist2; // f31
...
// total size: 0x4
struct /* @class$1097zCompSteeringFlocking_cpp */ {
    // Members
...
union /* @class$1236zCompSteeringFlocking_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1907zCompSteeringFlocking_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8029E308 -> 0x8029E400
// this: r0
void zCompSteeringFlocking::GetPlayerAvoidenceForce(struct xVec3 & PlayerAvoidenceForce /* r28 */, class zSteeringBasicDynamics & steeringDynamics /* r29 */) {
    // Local variables
    const class zCompSteeringFlockingParams * params; // r0
    struct xVec3 * playerPos; // r30
    float dist2; // f31
    struct xVec3 SeperationFromPlayer; // r1+0x8
    float dist; // f0
    float forceMag; // f1
...
// total size: 0x890
struct /* @class$2154zCompSteeringFlocking_cpp */ {
    // Static members
...
// Range: 0x8029E400 -> 0x8029E464
// this: r29
void zCompSteeringFlocking::GetAlignmentForce(struct xVec3 & AlignmentForce /* r30 */, class zSteeringBasicDynamics & steeringDynamics /* r31 */) {
    // Local variables
    const struct xVec3 * flockAlignment; // r4
...
void zCompSteeringFlocking::GetCohesionForce(struct xVec3 & CohesionForce /* r30 */, class zSteeringBasicDynamics & steeringDynamics /* r31 */) {
    // Local variables
    const struct xVec3 * flockCenter; // r4
...
// total size: 0xC
struct {} zCompSteeringFlockingParams::__vtable; // size: 0xC, address: 0x80C060EC
// total size: 0x1
