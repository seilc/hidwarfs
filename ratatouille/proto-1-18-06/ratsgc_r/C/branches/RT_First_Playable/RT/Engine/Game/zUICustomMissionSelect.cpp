/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomMissionSelect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802198B8 -> 0x8021A8A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct {} zUICustomMissionSelect::__vtable; // size: 0x54, address: 0x8043F5FC
// total size: 0xC
...
// Range: 0x802198B8 -> 0x80219904
// this: r31
zUICustomMissionSelect::zUICustomMissionSelect(class zUI * ui /* r0 */) {
    // References
...
// Range: 0x80219904 -> 0x80219924
// this: r0
void zUICustomMissionSelect::Init() {}

// Range: 0x80219924 -> 0x80219944
// this: r0
void zUICustomMissionSelect::Exit() {}

const char * bubbleTextFormat; // size: 0x4, address: 0x80C04208
const char * glowTextFormat; // size: 0x4, address: 0x80C0420C
// Range: 0x80219944 -> 0x80219D04
// this: r31
...
// Range: 0x80219D04 -> 0x80219D24
// this: r0
void zUICustomMissionSelect::Reset() {}

// Range: 0x80219D24 -> 0x80219D44
// this: r0
void zUICustomMissionSelect::PreUpdate(float dt /* f0 */) {}
...
// total size: 0x2
struct /* @class$1317zUICustomMissionSelect_cpp */ {
    // Members
...
// Range: 0x80219D44 -> 0x80219DC8
struct xBase * zUICustomMissionSelect::GetColorMotion(unsigned char completed /* r0 */, unsigned char unlocked /* r0 */) {
    // Local variables
    unsigned int size; // r1+0x8
}

// Range: 0x80219DC8 -> 0x80219E28
// this: r29
struct xBase * zUICustomMissionSelect::GetColorMotionScene(unsigned int idx /* r30 */) {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043F5E0
// Range: 0x80219E28 -> 0x80219F04
// this: r0
void zUICustomMissionSelect::GetArenasLevelCompletion(int i /* r0 */, unsigned char & scene1Comp /* r25 */, unsigned char & scene2Comp /* r26 */, unsigned char & scene3Comp /* r27 */, unsigned char & scene1Unlock /* r28 */, unsigned char & scene2Unlock /* r29 */, unsigned char & scene3Unlock /* r30 */) {
    // Local variables
    int j; // r31
...
// Range: 0x80219F04 -> 0x8021A0A4
// this: r28
void zUICustomMissionSelect::SetLevelBubblesExtraState(int i /* r0 */, unsigned char & allComplete /* r29 */, unsigned char & allUnlocked /* r30 */, unsigned char setExtraBubbles /* r31 */) {
    // Local variables
    unsigned char scene1Comp; // r1+0xD
    unsigned char scene2Comp; // r1+0xC
    unsigned char scene3Comp; // r1+0xB
    unsigned char scene1Unlock; // r1+0xA
    unsigned char scene2Unlock; // r1+0x9
    unsigned char scene3Unlock; // r1+0x8
    struct xBase * motionExtra; // r31
}

// Range: 0x8021A0A4 -> 0x8021A0A8
void zUICustomMissionSelect::SetLevelImageState() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04210
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1165zUICustomMissionSelect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1330zUICustomMissionSelect_cpp */ {
    // Members
...
union /* @class$1033zUICustomMissionSelect_cpp */ {
...
// total size: 0x10
struct /* @class$1831zUICustomMissionSelect_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2078zUICustomMissionSelect_cpp */ {
    // Static members
...
// Range: 0x8021A0A8 -> 0x8021A720
// this: r25
unsigned char zUICustomMissionSelect::HandleEvent(struct xBase * from /* r26 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
    float params[4]; // r1+0x34
    int count; // r23
    class zUIText * temp; // r3
    float params[4]; // r1+0x24
    unsigned short count; // r31
    unsigned char allComplete; // r1+0x11
    unsigned char allUnlocked; // r1+0x10
    class zUIText * temp; // r3
    unsigned short i; // r23
    float toParams[4]; // r1+0x14
    unsigned int missionTextHash; // r23
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0421C
// Range: 0x8021A720 -> 0x8021A87C
