/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameCongaLine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AE330 -> 0x802AE5E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x7C
struct {} zMiniGameCongaLine::__vtable; // size: 0x7C, address: 0x804482B8
// total size: 0x18
...
// Range: 0x802AE330 -> 0x802AE374
// this: r31
zMiniGameCongaLine::zMiniGameCongaLine(struct zMiniGameAsset * a /* r0 */) {
    // References
    // -> struct [anonymous] zMiniGameCongaLine::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C063D8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1128zMiniGameCongaLine_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1290zMiniGameCongaLine_cpp */ {
    // Members
...
union /* @class$1274zMiniGameCongaLine_cpp */ {
...
// total size: 0x10
struct /* @class$1787zMiniGameCongaLine_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2034zMiniGameCongaLine_cpp */ {
    // Static members
...
// Range: 0x802AE374 -> 0x802AE5A4
void zMiniGameCongaLine::Init(struct xBase & data /* r28 */, struct xDynAsset & asset /* r29 */, unsigned long asset_size /* r30 */) {
    // Local variables
...
// Range: 0x802AE5A4 -> 0x802AE5D0
// this: r0
void zMiniGameCongaLine::SceneSetup() {}

// Range: 0x802AE5D0 -> 0x802AE5D4
void zMiniGameCongaLine::Update() {}

// Range: 0x802AE5D4 -> 0x802AE5D8
void zMiniGameCongaLine::Render() {}

// Range: 0x802AE5D8 -> 0x802AE5DC
void zMiniGameCongaLine::Reset() {}

// Range: 0x802AE5DC -> 0x802AE5E0
