/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameRatOnBall.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029EBD4 -> 0x802A1374
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float ZTACCEL; // size: 0x4, address: 0x80C06110
static float ZTDEPTH; // size: 0x4, address: 0x80C06114
static float RING_RADIUS; // size: 0x4, address: 0x80C06118
static unsigned int READY_TEX_IDS[3]; // size: 0xC, address: 0x80C0611C
// total size: 0x7C
struct {} zMiniGameRatOnBall::__vtable; // size: 0x7C, address: 0x80447540
// total size: 0x1C
...
union /* @class$1324zMiniGameRatOnBall_cpp */ {
...
// total size: 0xC
struct /* @class$1340zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x8029EBD4 -> 0x8029EC20
// this: r31
zMiniGameRatOnBall::zMiniGameRatOnBall(struct zMiniGameAsset * a /* r0 */) {
    // References
    // -> struct [anonymous] zMiniGameRatOnBall::__vtable;
}

// Range: 0x8029EC30 -> 0x8029EC34
void zMiniGameRatOnBall::CreatePlayers() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06128
enum xCamCoordType {
...
// total size: 0x10
struct /* @class$1837zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x8029EC34 -> 0x8029EE64
void zMiniGameRatOnBall::Init(struct xBase & data /* r28 */, struct xDynAsset & asset /* r29 */, unsigned long asset_size /* r30 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C06130
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8029EE64 -> 0x8029F074
// this: r31
void zMiniGameRatOnBall::StageSetup(unsigned int stageID /* r0 */, unsigned char resetTypes /* r28 */) {
    // Local variables
    struct xGroup * pickupSpawnGroup; // r29
    int i; // r28
    int i; // r28
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0613C
// Range: 0x8029F074 -> 0x8029F54C
// this: r31
...
void zMiniGameRatOnBall::PlayerCollisions() {
    ...
    int a; // r24
    int b; // r23
    class zMiniGameRatOnBallPlayer * ballA; // r22
    ...
    float dist; // f1
    float relativeVelocity; // f0
    struct zRoBPlayerCollision * contact; // r21
    int i; // r22
    class zMiniGameRatOnBallPlayer * ball; // r23
    float VdotN; // f0
    struct xVec3 Vn; // r1+0x80
    struct xVec3 Vt; // r1+0x74
    struct xVec3 Vn1; // r1+0x68
    struct xVec3 btravel; // r1+0x5C
    class zMiniGameRatOnBallPlayer * ball2; // r26
...
// total size: 0xC
struct /* @class$2116zMiniGameRatOnBall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$1069zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1070zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1071zMiniGameRatOnBall_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1072zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1073zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1074zMiniGameRatOnBall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1075zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x8029F9A0 -> 0x8029FBC8
// this: r3
void zMiniGameRatOnBall::GetOnionY(struct xVec3 * inPos /* r30 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C06148
// Range: 0x8029FED4 -> 0x802A0024
// this: r31
void zMiniGameRatOnBall::TiltStageUpdate(float dt /* f31 */) {
    // Local variables
    float accel; // f2
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C06158
// Range: 0x802A0024 -> 0x802A02BC
// this: r29
void zMiniGameRatOnBall::DropStageUpdate(float dt /* f31 */) {
    ...
    int i; // r29
    struct xVec3 * pos; // r0
    enum iSndGroupHandle soundGroupHandle; // r31
    struct xVec3 * pos; // r0
...
// Range: 0x802A0344 -> 0x802A03DC
// this: r30
void zMiniGameRatOnBall::GameStartEnter() {
    // Local variables
    int i; // r31
    class zMiniGameRatOnBallPlayer * pplayer; // r0
    class zUIController * uic; // r0

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x802A03DC -> 0x802A0494
// this: r31
void zMiniGameRatOnBall::GameStartUpdate(float dt /* f0 */) {
    // Local variables
    class zUIController * uic; // r0
}

// Range: 0x802A0494 -> 0x802A053C
// this: r31
...
// Range: 0x802A053C -> 0x802A0574
// this: r31
void zMiniGameRatOnBall::StageStartEnter() {}

// Range: 0x802A0574 -> 0x802A06B4
// this: r31
void zMiniGameRatOnBall::StageStartUpdate(float dt /* f0 */) {
    // Local variables
    enum iSndGroupHandle soundGroupHandle; // r0
    enum iSndGroupHandle soundGroupHandle; // r0
...
// Range: 0x802A06B4 -> 0x802A0770
// this: r27
unsigned char zMiniGameRatOnBall::TestStageWinConditions() {
    // Local variables
    int totalAlive; // r31
    unsigned char humanAlive; // r30
    int i; // r29
...
// total size: 0x890
struct /* @class$2084zMiniGameRatOnBall_cpp */ {
    // Static members
...
// Range: 0x802A08A4 -> 0x802A08FC
void zMiniGameRatOnBall::GamePlayEnter() {
    // Local variables
    int i; // r31
    class zMiniGameRatOnBallPlayer * player; // r0

    // References
    // -> struct xGlobals * xglobals;
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C06168
// Range: 0x802A08FC -> 0x802A0D68
// this: r31
void zMiniGameRatOnBall::GamePlayUpdate(float dt /* f29 */) {
    // Local variables
    float zAngle; // f3
    ...
    int i; // r27
    struct xVec3 * pickupPos; // r27
    float dist2; // f0
    float arenaRadius; // f1
    int i; // r27
...
// total size: 0x4
struct /* @class$1128zMiniGameRatOnBall_cpp */ {
    // Members
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C06178
// Range: 0x802A0D68 -> 0x802A0E84
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06188
// Range: 0x802A0E84 -> 0x802A0F80
// this: r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C06198
// Range: 0x802A0F80 -> 0x802A10A4
// this: r31
void zMiniGameRatOnBall::StageEndUpdate(float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x802A10A4 -> 0x802A10DC
// this: r3
void zMiniGameRatOnBall::GameEndEnter() {}

// Range: 0x802A10DC -> 0x802A1100
// this: r0
void zMiniGameRatOnBall::GameEndUpdate() {}

// Range: 0x802A1100 -> 0x802A1130
// this: r3
void zMiniGameRatOnBall::Render() {}

// Range: 0x802A1130 -> 0x802A1160
// this: r0
void zMiniGameRatOnBall::Reset() {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C061A8
// total size: 0x28
...
// Range: 0x802A1160 -> 0x802A125C
// this: r0
void zMiniGameRatOnBall::SetRespawnPosition(struct xMat4x3 * mat /* r30 */) {
    // Local variables
    struct xGroup * grp; // r31
...
// Range: 0x802A12B4 -> 0x802A12BC
float zMiniGameRatOnBall::GetArenaBufferRadius() {}

// Range: 0x802A12BC -> 0x802A1374
