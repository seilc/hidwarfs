/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicSpringBoard.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A77CC -> 0x802A8594
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gSpringBoardPatrolSteeringParams; // size: 0x70, address: 0x80BD2418
// total size: 0x8
...
static struct zCompStateMachineTable gSpringboardStateMachineTable[6]; // size: 0x30, address: 0x80447D50
// total size: 0x4C
...
// Range: 0x802A77CC -> 0x802A77D4
unsigned char zCompLogicSpringBoard::SystemEvent() {}

// Range: 0x802A77D4 -> 0x802A7A1C
...
// Range: 0x802A7ADC -> 0x802A7AFC
// this: r0
void zCompLogicSpringBoard::Attached() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C06288
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1484zCompLogicSpringBoard_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802A7C48 -> 0x802A7CB0
unsigned char zCompLogicSpringBoard::IsPlayerInRange(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x890
struct /* @class$1946zCompLogicSpringBoard_cpp */ {
    // Static members
...
// Range: 0x802A7CB0 -> 0x802A7D18
unsigned char zCompLogicSpringBoard::IsPlayerOutRange(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    struct xVec3 * playerPos; // r4
...
// Range: 0x802A7D18 -> 0x802A7D40
unsigned char zCompLogicSpringBoard::IsAnimationStopped(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// Range: 0x802A7D40 -> 0x802A7D58
void zCompLogicSpringBoard::GetLaunchVelocity(struct xVec3 & vel /* r0 */) {}

// Range: 0x802A7D58 -> 0x802A7D7C
// this: r0
void zCompLogicSpringBoard::Launch() {}

struct xVec3 m_Null; // size: 0xC, address: 0x80C0B540
// Range: 0x802A7D7C -> 0x802A7EA4
// this: r29
void zCompLogicSpringBoard::StopNPC(float StopForceMag /* f30 */, float dt /* f31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// total size: 0x4
struct /* @class$1088zCompLogicSpringBoard_cpp */ {
    // Members
...
union /* @class$1236zCompLogicSpringBoard_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zCompLogicSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zCompLogicSpringBoard_cpp */ {
    // Members
...
// total size: 0x30
struct {} zSpringBoardPatrol::__vtable; // size: 0x30, address: 0x80447E40
// total size: 0x28
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C09630
static signed char init; // size: 0x1, address: 0x80C09631
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0629C
// Range: 0x802A7F24 -> 0x802A80D0
// this: r28
void zSpringBoardPatrol::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C062A4
// total size: 0x68
...
// Range: 0x802A80D0 -> 0x802A819C
// this: r30
void zSpringBoardPatrol::Enter(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zNPCSpringBoard * npcSpringBoard; // r31
    struct zNPCAssetSpringBoard * npcassSpringBoard; // r0
...
// Range: 0x802A819C -> 0x802A8244
// this: r30
void zSpringBoardPatrol::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// Range: 0x802A8244 -> 0x802A828C
// this: r31
void zSpringBoardPatrol::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zSpringBoardTurnAround::__vtable; // size: 0x30, address: 0x80447E10
// total size: 0x14
...
// Range: 0x802A82C8 -> 0x802A8314
void zSpringBoardTurnAround::Update(class zNPCBase * owner /* r4 */, float dt /* f31 */) {
    // Local variables
    class zCompLogicSpringBoard * compLogic; // r0
}

// Range: 0x802A8314 -> 0x802A8340
// this: r0
void zSpringBoardTurnAround::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A8340 -> 0x802A8384
void zSpringBoardTurnAround::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zSpringBoardIdle::__vtable; // size: 0x30, address: 0x80447DE0
// total size: 0x14
...
// Range: 0x802A83C0 -> 0x802A83C4
void zSpringBoardIdle::Update() {}

// Range: 0x802A83C4 -> 0x802A83F0
// this: r0
void zSpringBoardIdle::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A83F0 -> 0x802A8434
void zSpringBoardIdle::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zSpringBoardLaunch::__vtable; // size: 0x30, address: 0x80447DB0
// total size: 0x14
...
// Range: 0x802A8470 -> 0x802A8474
void zSpringBoardLaunch::Update() {}

// Range: 0x802A8474 -> 0x802A84A0
// this: r0
void zSpringBoardLaunch::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A84A0 -> 0x802A84E4
void zSpringBoardLaunch::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zSpringBoardGoToPatrol::__vtable; // size: 0x30, address: 0x80447D80
// total size: 0x14
...
// Range: 0x802A8520 -> 0x802A8524
void zSpringBoardGoToPatrol::Update() {}

// Range: 0x802A8524 -> 0x802A8550
// this: r0
void zSpringBoardGoToPatrol::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x802A8550 -> 0x802A8594
void zSpringBoardGoToPatrol::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}
