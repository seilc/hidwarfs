/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCombo.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E0384 -> 0x801E03F0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zComboReward {
    // Members
    int numHits; // offset 0x0, size 0x4
    int powerMult; // offset 0x4, size 0x4
    unsigned int textAssetID; // offset 0x8, size 0x4
    struct xTextAsset * textAsset; // offset 0xC, size 0x4
...
// total size: 0x1
struct /* @class$1029zCombo_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zCombo_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zCombo_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zCombo_cpp */ {
    // Members
...
static unsigned char sComboIsPaused; // size: 0x1, address: 0x80C08CD4
// Range: 0x801E0388 -> 0x801E03F0
void zCombo_Paused() {
    // References
    // -> static struct widget_chunk * comboHUD;
    // -> static unsigned char sComboIsPaused;
}
