/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xSkyDome.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800BD30C -> 0x800BD8E4
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct SkyDomeInfo sSkyList[16]; // size: 0x140, address: 0x80A9ADB0
static int sSkyCount; // size: 0x4, address: 0x80C077F0
// Range: 0x800BD30C -> 0x800BD310
void xSkyDome_EmptyRender() {}

// Range: 0x800BD310 -> 0x800BD31C
void xSkyDome_Setup() {
    // References
    // -> static int sSkyCount;
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFE6A8
// Range: 0x800BD31C -> 0x800BD608
void xSkyDome_AddEntity(struct xEnt * ent /* r25 */, int sortorder /* r26 */, int lockY /* r27 */, int lockXZ /* r28 */, int ZReadWrite /* r29 */) {
    // Local variables
    int index; // r24
    unsigned char inList; // r24
    int i; // r4
    int j; // r23
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C077F4
static signed char init; // size: 0x1, address: 0x80C077F5
static unsigned char already_asserted; // size: 0x1, address: 0x80C077F6
static signed char init; // size: 0x1, address: 0x80C077F7
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE6BC
