/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleCustom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801EA11C -> 0x801EC590
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int texture; // size: 0x4, address: 0x80C03660
static float glow; // size: 0x4, address: 0x80C03664
static float color_red; // size: 0x4, address: 0x80C03668
static float color_green; // size: 0x4, address: 0x80C0366C
static float color_blue; // size: 0x4, address: 0x80C03670
static float color_alpha; // size: 0x4, address: 0x80C03674
static unsigned int texture; // size: 0x4, address: 0x80C03678
static float glow; // size: 0x4, address: 0x80C0367C
static float color_red; // size: 0x4, address: 0x80C03680
static float color_green; // size: 0x4, address: 0x80C03684
static float color_blue; // size: 0x4, address: 0x80C03688
static float color_alpha; // size: 0x4, address: 0x80C0368C
static unsigned int texture; // size: 0x4, address: 0x80C03690
static float gravity; // size: 0x4, address: 0x80C03694
static unsigned int color; // size: 0x4, address: 0x80C03698
static float bounce_xzdamp; // size: 0x4, address: 0x80C0369C
static float bounce_ydamp; // size: 0x4, address: 0x80C036A0
static float bounce_kill_vel; // size: 0x4, address: 0x80C036A4
static unsigned int texture; // size: 0x4, address: 0x80C036A8
static float growth; // size: 0x4, address: 0x80C036AC
static float vel_decay; // size: 0x4, address: 0x80C036B0
static float color_red; // size: 0x4, address: 0x80C036B4
static float color_green; // size: 0x4, address: 0x80C036B8
static float color_blue; // size: 0x4, address: 0x80C036BC
static float intensity_min; // size: 0x4, address: 0x80C036C0
static float intensity_max; // size: 0x4, address: 0x80C036C4
static unsigned int texture; // size: 0x4, address: 0x80C036C8
static float growth; // size: 0x4, address: 0x80C036CC
static float color_red; // size: 0x4, address: 0x80C036D0
static float color_green; // size: 0x4, address: 0x80C036D4
static float color_blue; // size: 0x4, address: 0x80C036D8
static float color_alpha; // size: 0x4, address: 0x80C036DC
// Range: 0x801EA11C -> 0x801EA66C
...
// total size: 0xC
struct /* @class$964zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zParticleCustom_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zParticleCustom_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zParticleCustom_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zParticleCustom_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zParticleCustom_cpp */ {
    // Members
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x80C08D30
// total size: 0x18
struct /* @class$2174zParticleCustom_cpp */ {
    // Members
...
struct /* @class$2174zParticleCustom_cpp */ {
    ...
    int dust; // offset 0x10, size 0x4
    int fire_smoke; // offset 0x14, size 0x4
} system_id; // size: 0x18, address: 0x80C08D38
...
// Range: 0x801EA66C -> 0x801EA744
static void register_particle_system(int & system_id /* r25 */, enum ptank_group_type pool_type /* r0 */, unsigned int texture_id /* r5 */, unsigned int src_blend /* r0 */, unsigned int dst_blend /* r0 */, int order_index /* r26 */, int flags /* r0 */, int stride /* r27 */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r28 */, const char * debug_name /* r29 */, const char * dbgFile /* r30 */, int dbgLine /* r31 */) {
    // Local variables
    struct xParticleBatchSystem system; // r1+0x8
    char prefix[128]; // r1+0x30
...
// total size: 0x4
struct /* @class$1350zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1488zParticleCustom_cpp */ {
    // Members
...
union /* @class$1015zParticleCustom_cpp */ {
...
// total size: 0x10
struct /* @class$1028zParticleCustom_cpp */ {
    // Members
...
// Range: 0x801EA744 -> 0x801EA9D4
static int update_spark_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f25 */) {
    // Local variables
    ...
    float base_glow; // f30
    float base_red; // f29
    float base_green; // f28
    float base_blue; // f27
    struct spark_particle * p; // r26
...
// Range: 0x801EA9D4 -> 0x801EAA04
float zParticleCustomRequestSpark(float amount /* f1 */, int systemID /* r3 */) {
    // References
    // -> static // total size: 0x18
struct /* @class$2174zParticleCustom_cpp */ {
    // Members
...
// Range: 0x801EAA04 -> 0x801EABDC
void zParticleCustomEmitSpark(const struct xVec3 * loc /* r24 */, const struct xVec3 * vel /* r25 */, int amount /* r26 */, float life_min /* f30 */, float life_range /* f22 */, float size_min /* f31 */, float size_range /* f23 */, float dt /* f0 */, float gravity /* f0 */, int systemID /* r27 */) {
    // Local variables
    float yaccel; // f27
    float age; // f26
    float dage; // f25
    ...
    int have; // r0
    struct spark_particle * p; // r29
    struct spark_particle * endp; // r28
    float life; // f24
...
// Range: 0x801EABDC -> 0x801EAC38
void zParticleCustomCreateSparkSystem(int & systemID /* r0 */, unsigned int textureID /* r11 */, const char * debugName /* r0 */) {}
...
// Range: 0x801EAC38 -> 0x801EB054
static int update_glint_particles(unsigned char * mem /* r25 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f31 */) {
    // Local variables
    ...
    float base_glow; // f27
    float base_red; // f26
    float base_green; // f25
    float base_blue; // f24
    struct glint_particle * p; // r27
    struct glint_particle * end; // r26
    float age1; // f23
    float t1; // f22
    float length; // f21
    float Vx; // f20
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043E750
// Range: 0x801EB054 -> 0x801EB414
void zParticleCustomEmitGlint(const struct xVec3 * loc /* r27 */, const struct xVec3 * vel /* r28 */, const float * length_vel /* r29 */, int amount /* r30 */, float life_min /* f18 */, float life_range /* f19 */, float width_min /* f20 */, float width_range /* f21 */, float length_min /* f22 */, float length_range /* f23 */, float length_clamp_min /* f24 */, float length_clamp_range /* f25 */, float dt /* f11 */, float gravity /* f3 */, int systemID /* r31 */) {
    // Local variables
    float yaccel; // f28
    float age; // f27
    float dage; // f26
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct glint_particle * p; // r24
    struct glint_particle * endp; // r23
    float life; // f17
    float rlen; // f0
...
// Range: 0x801EB414 -> 0x801EB470
void zParticleCustomCreateGlintSystem(int & systemID /* r0 */, unsigned int textureID /* r11 */, const char * debugName /* r0 */) {}
...
// Range: 0x801EB470 -> 0x801EB720
static int update_pebble_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f27 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
...
// Range: 0x801EB764 -> 0x801EB988
static int update_pebble_particles_no_coll(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
    struct xColor_tag * pool_color; // r28
    struct xVec2 * pool_size; // r27
    struct pebble_particle_no_coll * p; // r26
...
static float dust_vel_decay; // size: 0x4, address: 0x80C08D50
// Range: 0x801EB9CC -> 0x801EB9FC
static void pre_update_dust_particles(float dt /* f1 */) {
    // References
    // -> static float vel_decay;
    // -> static float dust_vel_decay;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C036E0
// total size: 0x30
...
// Range: 0x801EB9FC -> 0x801EBDCC
static int update_dust_particles(unsigned char * mem /* r23 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */) {
    // Local variables
    struct ptank_pool__pos_color_size_uv2 & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
    struct xColor_tag * pool_color; // r28
    struct xVec2 * pool_size; // r27
    struct xVec2 * pool_uv; // r26
    float growth; // f30
    float vel_decay; // f29
    struct dust_particle * p; // r25
...
// Range: 0x801EBDCC -> 0x801EC0E8
static int update_fire_smoke_particles(unsigned char * mem /* r23 */, int count /* r25 */, struct ptank_pool & apool /* r5 */, float dt /* f23 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
    ...
    float a2; // f27
    float a3; // f26
    unsigned int color; // r26
    struct fire_smoke_particle * p; // r25
    struct fire_smoke_particle * end; // r24
    float age1; // f3
    float t1; // f25
    float size; // f24
    struct xVec4 loc; // r1+0x18
...
// Range: 0x801EC154 -> 0x801EC180
float zParticleCustomRequestFireSmoke(float amount /* f0 */) {
    // References
    // -> static // total size: 0x18
struct /* @class$2174zParticleCustom_cpp */ {
    // Members
...
// Range: 0x801EC180 -> 0x801EC36C
void zParticleCustomEmitFireSmoke(const struct xVec3 * loc /* r24 */, const struct xVec3 * vel /* r25 */, int amount /* r26 */, float life_min /* f25 */, float life_range /* f26 */, float size_min /* f27 */, float size_range /* f28 */, float dt /* f0 */) {
    // Local variables
    float age; // f30
    float dage; // f29
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct fire_smoke_particle * p; // r28
    struct fire_smoke_particle * endp; // r27
    float life; // f23
...
// Range: 0x801EC570 -> 0x801EC590
void zParticleCustomUpdate(float dt /* f0 */) {}
