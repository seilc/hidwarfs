/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSaveLoad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80155E7C -> 0x8015B05C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int saveSuccess; // size: 0x4, address: 0x80C08390
static float saveload_time_elapsed; // size: 0x4, address: 0x80C01220
static float saveload_time_last; // size: 0x4, address: 0x80C08394
static float saveload_time_current; // size: 0x4, address: 0x80C08398
static int currentCard; // size: 0x4, address: 0x80C01224
static int currentGame; // size: 0x4, address: 0x80C01228
static int saveLoadPromptSel; // size: 0x4, address: 0x80C0839C
static int badCard; // size: 0x4, address: 0x80C083A0
static unsigned int startSceneID; // size: 0x4, address: 0x80C083A4
static int sAvailable; // size: 0x4, address: 0x80C083A8
static int sNeeded; // size: 0x4, address: 0x80C083AC
static int sAccessType; // size: 0x4, address: 0x80C083B0
static float dontPoll; // size: 0x4, address: 0x80C0122C
int autoSaveCard; // size: 0x4, address: 0x80C01230
int prevSelectCard; // size: 0x4, address: 0x80C01234
int prevSelectGame; // size: 0x4, address: 0x80C01238
static unsigned char sIsLoading; // size: 0x1, address: 0x80C0123C
static int loadState; // size: 0x4, address: 0x80C083B4
static int saveState; // size: 0x4, address: 0x80C083B8
static char currSceneStr[32]; // size: 0x20, address: 0x8043AB78
static char sceneRead[32]; // size: 0x20, address: 0x8043AB98
int g_promptUserSelection; // size: 0x4, address: 0x80C01240
// total size: 0xC
struct zSaveLoadUI {
    // Members
...
struct zSaveLoadUI zSaveLoadUITable[73]; // size: 0x36C, address: 0x8043ABB8
// total size: 0x6C
...
struct zSaveLoadGame zSaveLoadGameTable[3]; // size: 0x144, address: 0x80B9FAF8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1086zSaveLoad_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1250zSaveLoad_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1795zSaveLoad_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80155E7C -> 0x80155F1C
static void WaitAndSpin(float sec /* f31 */) {
    // Local variables
    long long startTime; // r30
    long long now; // r5
    struct XSGAutoData * autodata; // r0
...
class zUICustomSaveLoadManager * pUICustomSaveLoadManager; // size: 0x4, address: 0x80C09330
// Range: 0x80155F1C -> 0x80155FD4
static void zUI_SysMessage(int msgType /* r0 */, unsigned int event /* r0 */, unsigned char delay /* r31 */) {
    // Local variables
    float toParams[4]; // r1+0x8
...
// Range: 0x80155FD4 -> 0x80156078
static void zUI_SysMessageID(int msgType /* r0 */, unsigned int msgID /* r0 */, unsigned char delay /* r31 */) {
    // Local variables
    float toParams[4]; // r1+0x8
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C01244
...
// total size: 0xC
struct /* @class$1027zSaveLoad_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zSaveLoad_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zSaveLoad_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1030zSaveLoad_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1031zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1032zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1033zSaveLoad_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2042zSaveLoad_cpp */ {
    // Static members
...
// Range: 0x80156464 -> 0x801564DC
unsigned int zSaveLoad_poll(int retValue /* r31 */) {
    // Local variables
    int val; // r0
    struct XSGAutoData * autodata; // r0
...
// Range: 0x80156510 -> 0x80156554
void zSaveLoadGameTableInit(struct zSaveLoadGame * table /* r0 */) {}

// Range: 0x80156554 -> 0x801565A4
void zSaveLoadUITableInit(struct zSaveLoadUI * table /* r3 */) {
    // Local variables
    int i; // r30
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C01254
// Range: 0x801565A4 -> 0x80156648
void zSaveLoad_UIEvent(int ui /* r0 */, unsigned int event /* r30 */) {
    // Local variables
...
// Range: 0x80156648 -> 0x801566AC
struct st_XSAVEGAME_DATA * zSaveLoadSGInit(enum en_SAVEGAME_MODE mode /* r31 */) {}

// Range: 0x801566AC -> 0x801566CC
int zSaveLoadSGDone(struct st_XSAVEGAME_DATA * xsgdata /* r0 */) {}

// Range: 0x801566CC -> 0x801566D4
int zSaveLoad_getgame() {
    // References
    // -> static int currentGame;
}

// Range: 0x801566D4 -> 0x801566DC
int zSaveLoad_getcard() {
    // References
    // -> static int currentCard;
}

// Range: 0x801566DC -> 0x801566E4
int zSaveLoad_getMCavailable() {
    // References
    // -> static int sAvailable;
}

// Range: 0x801566E4 -> 0x801566EC
int zSaveLoad_getMCneeded() {
    // References
    // -> static int sNeeded;
}

// Range: 0x801566EC -> 0x801566F4
int zSaveLoad_getMCAccessType() {
    // References
    // -> static int sAccessType;
}

// Range: 0x801566F4 -> 0x801566FC
int zSaveLoadGetAutoSaveCard() {
    // References
    // -> int autoSaveCard;
}

// Range: 0x801566FC -> 0x801568D0
...
// Range: 0x801568D0 -> 0x80156968
int CardtoTgt(int card /* r30 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r0
    int tgtmax; // r1+0x8
...
// Range: 0x801569C0 -> 0x80156A54
int zSaveLoad_Loop(unsigned char freeInv /* r29 */, int returnEvent /* r30 */, int pollEvent /* r31 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x80156A54 -> 0x80156AA0
int zSaveLoad_CardPrompt(int mode /* r0 */) {}

// Range: 0x80156AA0 -> 0x80156AF8
int zSaveLoad_CardPromptFormat(int mode /* r0 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x80156AF8 -> 0x80156B44
int zSaveLoad_CardPromptSpace(int mode /* r0 */) {}

// Range: 0x80156B44 -> 0x80156B90
int zSaveLoad_CardPromptGames(int mode /* r0 */) {}

// Range: 0x80156B90 -> 0x80156BDC
int zSaveLoad_CardPromptGameSlotEmpty(int mode /* r0 */) {}

// Range: 0x80156BDC -> 0x80156C18
int zSaveLoad_CardPromptOverwrite() {}

// Range: 0x80156C18 -> 0x80156C9C
int zSaveLoad_ErrorPrompt(int mode /* r31 */) {
    // References
    // -> static int saveLoadPromptSel;
}

// Range: 0x80156C9C -> 0x80156CD8
int zSaveLoad_DamagedSaveGameErrorPrompt() {}

// Range: 0x80156CD8 -> 0x80156D30
int zSaveLoad_CardWrongDeviceErrorPrompt(int mode /* r0 */) {}

// Range: 0x80156D30 -> 0x80156D88
int zSaveLoad_CardDamagedErrorPrompt(int mode /* r0 */) {}

// Range: 0x80156D88 -> 0x80156DD4
int zSaveLoad_SaveDamagedErrorPrompt(int mode /* r0 */) {}

// Range: 0x80156DD4 -> 0x80156E20
int zSaveLoad_CardYankedErrorPrompt(int mode /* r0 */) {}

// Range: 0x80156E20 -> 0x80156E78
int zSaveLoad_ErrorFormatPrompt(int mode /* r0 */) {}

// Range: 0x80156E78 -> 0x80156ED0
int zSaveLoad_ErrorFormatCardYankedPrompt(int mode /* r0 */) {}

// Range: 0x80156ED0 -> 0x80156FDC
int zSaveLoad_CardCheckSingle(int num /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r30
    int tgtcnt; // r0
    int tgtmax; // r1+0x8
...
// Range: 0x80157268 -> 0x80157338
int zSaveLoad_CardCheckSpaceSingle(int num /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r0
    int tgtmax; // r1+0x8
...
// Range: 0x80157338 -> 0x801573DC
int zSaveLoad_CardCheckGamesSingle_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r30 */, int num /* r31 */) {
    // Local variables
    int rc; // r0
...
// Range: 0x801573DC -> 0x801574AC
int zSaveLoad_CardCheckGamesSingle(int num /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r0
    int tgtmax; // r1+0x8
...
// Range: 0x801574AC -> 0x80157534
int zSaveLoad_CardCheckSlotEmpty_hasGame_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, int num /* r30 */, int game /* r31 */) {
    // Local variables
    int rc; // r0
}

// Range: 0x80157534 -> 0x80157624
int zSaveLoad_CardCheckSlotEmpty_hasGame(int num /* r28 */, int game /* r29 */) {
    // Local variables
    struct st_XSAVEGAME_DATA * ldinst; // r31
    int tgtcnt; // r0
    int tgtmax; // r1+0x8
...
static char __FUNCTION__[38]; // size: 0x26, address: 0x8043AF24
// Range: 0x80157624 -> 0x801576D8
int zSaveLoad_CardCheckSlotOverwrite_Free(int num /* r0 */, int game /* r0 */) {
    // Local variables
    int result; // r0
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C01268
// Range: 0x801576D8 -> 0x801578DC
int zSaveLoad_CardCheck(int cardNumber /* r29 */, int mode /* r30 */) {
    // Local variables
    int result; // r31
    int cardResult; // r28
...
// Range: 0x801578DC -> 0x80157998
int zSaveLoad_CardCheckFormatted(int cardNumber /* r30 */, int mode /* r31 */) {
    // Local variables
    int result; // r3
...
// Range: 0x80157998 -> 0x801579C8
int zSaveLoad_CardCheckValid(int cardNumber /* r0 */, int mode /* r0 */) {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043AF4C
// Range: 0x801579C8 -> 0x80157AE4
int zSaveLoad_CardCheckSpace(int cardNumber /* r29 */, int mode /* r30 */) {
    // Local variables
    int result; // r31
    int tmp; // r3
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043AF68
// Range: 0x80157AE4 -> 0x80157C00
int zSaveLoad_CardCheckGames(int cardNumber /* r29 */, int mode /* r30 */) {
    // Local variables
    int result; // r31
    int tmp; // r3
...
// Range: 0x80157C00 -> 0x80157C30
int zSaveLoad_CardCheckGameSlot(int cardNumber /* r0 */, int gameNumber /* r0 */, int mode /* r0 */) {}

// Range: 0x80157C30 -> 0x80157CCC
int zSaveLoad_CardCheckSlotEmpty(int cardNumber /* r29 */, int gameNumber /* r30 */, int mode /* r31 */) {
    // Local variables
    int result; // r3
}

// Range: 0x80157CCC -> 0x80157D40
int zSaveLoad_CardCheckSlotOverwrite(int cardNumber /* r0 */, int gameNumber /* r0 */) {
    // Local variables
    int result; // r3
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0127C
unsigned char gSysMessageManager_active; // size: 0x1, address: 0x80C08D19
// Range: 0x80157D40 -> 0x801584D0
int zSaveLoad_CardPick(int mode /* r28 */) {
    // Local variables
    int done; // r30
    unsigned char formatDone; // r29
    class zUI * mc1; // r0
    class zUI * mc2; // r0
...
// Range: 0x801584D0 -> 0x80158548
static unsigned char IsValidName(char * name /* r31 */) {}

// Range: 0x80158548 -> 0x801587C4
static void BuildIt(char * build_txt /* r29 */, int i /* r30 */) {
    // Local variables
    char date1[32]; // r1+0x48
    char date2[32]; // r1+0x28
    char biggerbuf[256]; // r1+0x68
    char displaySizeUnit[32]; // r1+0x8
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C01290
// Range: 0x801587C4 -> 0x8015896C
void zSaveLoad_BuildName(char * name_txt /* r29 */, unsigned long max_len /* r30 */, int idx /* r31 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C012A4
unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x80C08218
// Range: 0x8015896C -> 0x80159034
int zSaveLoad_GameSelect(int mode /* r31 */, unsigned char waitInput /* r23 */) {
    // Local variables
    int done; // r26
    class zUIText * uiTxtSavedGame1; // r27
    class zUIText * uiTxtSavedGame2; // r28
    class zUIText * uiTxtSavedGame3; // r24
    struct st_XSAVEGAME_DATA * svinst; // r25
    int use_tgt; // r24
    int i; // r23
    const char * empty_string; // r22
    const char * damaged_string; // r22
...
// total size: 0x2
struct /* @class$1772zSaveLoad_cpp */ {
    // Members
...
static unsigned char preAutoSaving; // size: 0x1, address: 0x80C083BC
// Range: 0x80159034 -> 0x8015903C
unsigned char zSaveLoadGetPreAutoSave() {
    // References
    // -> static unsigned char preAutoSaving;
}

unsigned char autosaveErrorHack; // size: 0x1, address: 0x80C083BD
// Range: 0x8015903C -> 0x8015908C
void zSaveLoadPreAutoSave(unsigned char onOff /* r0 */) {
    // References
    // -> static unsigned char preAutoSaving;
    // -> unsigned char autosaveErrorHack;
}

// Range: 0x8015908C -> 0x801591C4
void zSaveLoadAutoSaveUpdate() {
    // Local variables
    char * list[3]; // r1+0x10
    struct zUITextAsset * asset; // r0
    struct XSGAutoData * autodata; // r0
    int lastCard; // r0
    long memSize; // r1+0xC
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C012BC
...
// Range: 0x801591C4 -> 0x80159614
int zSaveLoad_DoAutoSave() {
    // Local variables
    int success; // r31
    int teststat; // r30
    int rc; // r0
    enum en_XSGASYNC_STATUS asstat; // r29
    struct st_XSAVEGAME_DATA * svinst; // r28
    struct XSGAutoData * autodata; // r27
    int use_tgt; // r26
    int use_game; // r25
    int lastPhysicalSlot; // r0
    int physicalSlot; // r0
    unsigned int progress; // r24
    char label[64]; // r1+0x8
    const char * area; // r23
    int physicalSlot; // r6
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C012D4
enum en_XSG_WHYFAIL {
    XSG_WHYERR_NONE = 0,
    XSG_WHYERR_NOCARD = 1,
    XSG_WHYERR_NOROOM = 2,
...
int zSaveLoad_SaveGame() {
    ...
    int use_tgt; // r27
    int use_game; // r26
    unsigned int progress; // r25
    char label[256]; // r1+0xC
    const char * area; // r24
    enum en_XSG_WHYFAIL whyFail; // r1+0x8
    struct XSGAutoData * asg; // r24
    int physicalSlot; // r6
...
// Range: 0x801599FC -> 0x80159CD0
int zSaveLoad_LoadGame() {
    // Local variables
    int success; // r31
    int teststat; // r30
    int rc; // r0
    enum en_XSGASYNC_STATUS asstat; // r26
    struct st_XSAVEGAME_DATA * ldinst; // r29
    int use_tgt; // r28
    enum en_XSG_WHYFAIL whyFail; // r1+0x8
    struct XSGAutoData * asg; // r26
    int use_game; // r27
    int physicalSlot; // r6
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C012E8
// Range: 0x80159CD0 -> 0x8015A170
unsigned int zSaveLoad_LoadLoop() {
    // Local variables
    int result; // r30
    unsigned char hasCard; // r29
    int wrongDeviceSlot; // r0
    int tmp; // r0
    int tmp; // r0
    int result; // r0
    struct XSGAutoData * autodata; // r0
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C012FC
enum eGameMode {
    eGameMode_Boot = 0,
    eGameMode_Intro = 1,
    eGameMode_Title = 2,
...
// Range: 0x8015A170 -> 0x8015A8D8
unsigned int zSaveLoad_SaveLoop() {
    // Local variables
    int result; // r30
    unsigned char hasCard; // r28
    int wrongDeviceSlot; // r0
    int tmp; // r0
    int tmp; // r0
    int oldGame; // r30
    class zUIText * uiTxtSavedGame1; // r29
    class zUIText * uiTxtSavedGame2; // r28
    class zUIText * uiTxtSavedGame3; // r27
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C01310
// Range: 0x8015A8D8 -> 0x8015AA68
void zSaveLoad_DispatchCB(unsigned int dispatchEvent /* r0 */, const float * toParam /* r0 */) {
    // Local variables
...
// Range: 0x8015AA68 -> 0x8015AAF4
int xSGT_SaveInfoCB(int * need /* r30 */, int * most /* r31 */) {
    // Local variables
    int slen; // r0
...
// Range: 0x8015AAF4 -> 0x8015AB88
int xSGT_SaveProcCB(struct st_XSAVEGAME_DATA * xsgdata /* r30 */, struct st_XSAVEGAME_WRITECONTEXT * wctxt /* r31 */) {
    // Local variables
    int amy; // r0
    int sum; // r0
...
// Range: 0x8015AB88 -> 0x8015ABDC
int xSGT_SaveInfoPrefsCB(int * need /* r5 */, int * most /* r6 */) {}

// Range: 0x8015ABDC -> 0x8015ACFC
int xSGT_SaveProcPrefsCB(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, struct st_XSAVEGAME_WRITECONTEXT * wctxt /* r30 */) {
    // Local variables
    int amy; // r0
    int sum; // r31
...
// Range: 0x8015ACFC -> 0x8015AE40
int xSGT_LoadLoadCB(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, struct st_XSAVEGAME_READCONTEXT * rctxt /* r30 */) {
    // Local variables
    char bigbuf[32]; // r1+0x8
    int compdiff; // r31
