/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCOneLiner.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802707AC -> 0x80270B7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sTimeSinceLastOneLiner; // size: 0x4, address: 0x80C09338
// total size: 0x10
struct zNPCOneLiner {
    // Members
...
static struct zNPCOneLinerSystem sInternal; // size: 0x204, address: 0x80BCBAB0
static struct zNPCOneLinerSystem sExternal; // size: 0x204, address: 0x80BCBCB4
// total size: 0xC
...
static struct zNPCOneLinerExternalSource sExternalSource; // size: 0xC, address: 0x80C0933C
enum iSndGroupHandle {
};
static enum iSndGroupHandle sLastPlayed; // size: 0x4, address: 0x80C09348
// Range: 0x802707AC -> 0x802707B8
static void _ResetList(struct zNPCOneLinerSystem * ol /* r0 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C055E0
...
// Range: 0x802707B8 -> 0x80270864
static void _AddOneLiner(struct zNPCOneLinerSystem * ols /* r27 */, class zNPCCommon * inSource /* r28 */, enum ezNPCOneLinerType inType /* r29 */, int inPriority /* r30 */, enum iSndGroupHandle inSoundGroup /* r31 */) {
    // Local variables
    struct zNPCOneLiner * ol; // r3

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x80270864 -> 0x80270908
void zNPCOneLinerSystemPreUpdate(float dt /* f31 */) {
    // References
...
// Range: 0x80270908 -> 0x80270A60
void zNPCOneLinerSystemPostUpdate(float dt /* f31 */) {
    // References
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80443840
...
// Range: 0x80270A60 -> 0x80270B28
void zNPCOneLinerPlayInternal(class zNPCCommon * inSource /* r29 */, enum ezNPCOneLinerType inType /* r30 */, enum ezNPCOneLinerPriority inPriority /* r31 */) {
    // Local variables
    enum iSndGroupHandle soundHandle; // r7
...
// total size: 0x4
struct /* @class$1105zNPCOneLiner_cpp */ {
    // Members
...
union /* @class$1244zNPCOneLiner_cpp */ {
...
// total size: 0xC
struct /* @class$1243zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2251zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2033zNPCOneLiner_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$2210zNPCOneLiner_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zNPCOneLiner_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2212zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2209zNPCOneLiner_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2214zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1579zNPCOneLiner_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$987zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zNPCOneLiner_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zNPCOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zNPCOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zNPCOneLiner_cpp */ {
    // Members
...
// Range: 0x80270B28 -> 0x80270B3C
void zNPCOneLinerPlayExternal(class zNPCCommon * inSource /* r0 */, enum iSndGroupHandle inSoundGroup /* r0 */, float inTime /* f0 */) {
    // References
    // -> static struct zNPCOneLinerExternalSource sExternalSource;
}

// Range: 0x80270B3C -> 0x80270B7C
