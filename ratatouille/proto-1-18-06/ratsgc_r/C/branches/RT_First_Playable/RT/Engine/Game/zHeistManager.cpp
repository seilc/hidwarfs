/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHeistManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802745C4 -> 0x802748C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zHeistManager * heistManager; // size: 0x4, address: 0x80C09368
...
// total size: 0x4
struct /* @class$1124zHeistManager_cpp */ {
    // Members
...
union /* @class$1263zHeistManager_cpp */ {
...
// total size: 0xC
struct /* @class$1262zHeistManager_cpp */ {
    // Members
...
// Range: 0x802745FC -> 0x80274630
void zHeistManager::Exit() {
    // References
    // -> class zHeistManager * heistManager;
}

// Range: 0x80274630 -> 0x8027467C
// this: r31
void zHeistManager::ShutDown() {}

class zHeistManager * heistManager; // size: 0x4, address: 0x80C09370
enum _tagTransType {
    eTransType_None = 0,
...
// total size: 0x10
struct /* @class$1847zHeistManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802746F4 -> 0x8027472C
// this: r31
void zHeistManager::RenderOverlays() {}

// Range: 0x8027472C -> 0x80274850
// this: r29
void zHeistManager::HandleInput(class zPad * currPad /* r30 */, float dt /* f0 */, class zHeistLookoutPoint * lookoutPoint /* r31 */) {}

// Range: 0x80274850 -> 0x80274898
// this: r31
void zHeistManager::Update(float dt /* f31 */) {}

// Range: 0x80274898 -> 0x802748BC
// this: r3
void zHeistManager::BeginInteraction(class zHeistLookoutPoint * lookoutPoint /* r0 */) {}

// Range: 0x802748BC -> 0x802748C0
