/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCGate.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B9CA4 -> 0x802BACA0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zNPCGateMgr gNPCGateMgr; // size: 0xC, address: 0x80C09758
// Range: 0x802B9CA4 -> 0x802B9CE8
void zNPCGateMgr::SceneSetup() {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06670
// Range: 0x802B9CE8 -> 0x802B9DD8
// this: r30
void zNPCGateMgr::Assign(class zNPCGate * npcGate /* r31 */) {
    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x802B9DD8 -> 0x802B9E3C
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06678
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x802B9F18 -> 0x802BA0B8
void zNPCGate::InitDynamic(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x802BA0B8 -> 0x802BA11C
// this: r30
zNPCGate::zNPCGate(struct zNPCGateAsset * asset /* r31 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06684
// Range: 0x802BA11C -> 0x802BA1CC
void zNPCGate::EventHandler(struct xBase * to /* r30 */, unsigned int toEvent /* r31 */) {
    // Local variables
    class zNPCGate * npcGate; // r0

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x802BA1CC -> 0x802BA20C
// this: r31
void zNPCGate::Setup() {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C06694
// total size: 0xC
...
// Range: 0x802BA20C -> 0x802BA448
// this: r29
void zNPCGate::SetupAttachedNPCs() {
    // Local variables
    struct xBase * b; // r4
    struct xGroup * npcsGroup; // r30
    int numberInGroup; // r0
    int i; // r27
    struct xBase * b; // r0
    int curNPC; // r26
    int i; // r25
    struct xBase * b; // r0
    class zNPCBase * npc; // r0
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C066A8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x1
struct /* @class$1214zNPCGate_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1215zNPCGate_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1216zNPCGate_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1217zNPCGate_cpp */ {
    // Members
...
// Range: 0x802BA8C0 -> 0x802BA910
// this: r31
float zNPCGate::ConvertWorldToGateLocalZ(const struct xVec3 & iWorld /* r0 */) {
    // Local variables
    struct xVec3 diff; // r1+0x8
}

// Range: 0x802BA910 -> 0x802BA998
// this: r30
void zNPCGate::ConvertWorldToBoxLocal(const struct xVec3 & iWorld /* r0 */, struct xVec3 & oLocal /* r31 */) {
    // Local variables
    struct xVec3 diff; // r1+0x8
    struct xVec3 * matAt; // r0
}

// Range: 0x802BA998 -> 0x802BAA04
// this: r7
void zNPCGate::ConvertBoxLocalToWorld(const struct xVec3 & iLocal /* r0 */, struct xVec3 & oWorld /* r5 */) {
    // Local variables
    struct xVec3 * matAt; // r0
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C066BC
// Range: 0x802BAA04 -> 0x802BAC60
// this: r28
void zNPCGate::HandlePlayerCollision() {
    // Local variables
    struct xVec3 * playerOldPos; // r31
    struct xVec3 * playerDPos; // r30
    struct xVec3 playerNewPos; // r1+0x24
    struct xVec3 localPlayerNewPos; // r1+0x18
    float wallDistances[4]; // r1+0x8
    int closestWall; // r29
    float closestWallDist; // f2
    int i; // r0
