/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zScript.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801653E0 -> 0x8016607C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801653E0 -> 0x80165400
void zScriptInit(void * b /* r0 */, void * tasset /* r0 */) {}

static unsigned int checkScriptInitID; // size: 0x4, address: 0x80C084D0
static signed char init; // size: 0x1, address: 0x80C084D4
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01598
// total size: 0x20
struct xLinkAsset {
    // Members
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C015A4
// Range: 0x80165544 -> 0x80165638
void zScriptReset(struct _zScript * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C015B4
// total size: 0x0
struct xSerial {};
// Range: 0x80165638 -> 0x80165708
void zScriptSave(struct _zScript * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C015C0
// Range: 0x80165708 -> 0x801657D8
void zScriptLoad(struct _zScript * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C015CC
// Range: 0x801657D8 -> 0x80165A20
void zScriptEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
...
static unsigned int checkScriptID; // size: 0x4, address: 0x80C084D8
static signed char init; // size: 0x1, address: 0x80C084DC
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C015DC
unsigned int gThisPlayer; // size: 0x4, address: 0x80C07284
// Range: 0x80165A20 -> 0x80165DD0
static unsigned char zScriptExecuteEvents(struct _zScript * t /* r30 */, float start /* f29 */, float end /* f30 */) {
    // Local variables
    struct xScriptEventAsset * endEvent; // r31
    float lastAbsTime; // f31
    int current; // r28
    unsigned int widget; // r28
    struct xBase * b; // r28
...
static float script_accel; // size: 0x4, address: 0x80C084E0
static signed char init; // size: 0x1, address: 0x80C084E4
static unsigned char _temp_tweaks_registered; // size: 0x1, address: 0x80C084E5
static signed char init; // size: 0x1, address: 0x80C084E6
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C015F4
// total size: 0x2
...
// Range: 0x80165DD0 -> 0x8016607C
void zScriptUpdate(struct xBase * to /* r31 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
    struct _zScript * t; // r31
    int i; // r1+0x8
...
// total size: 0x1
struct /* @class$1037zScript_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1038zScript_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1039zScript_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1040zScript_cpp */ {
    // Members
