/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollideFast.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80024640 -> 0x800248C4
*/
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFBC10
// total size: 0x10
struct xSphere {
    // Members
...
// Range: 0x80024640 -> 0x800247BC
unsigned int xRayHitsSphereFast(const struct xRay3 * r /* r30 */, const struct xSphere * s /* r31 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFBC24
// total size: 0x18
struct xBox {
    // Members
...
// Range: 0x800247BC -> 0x800248C4
unsigned int xRayHitsBoxFast(const struct xRay3 * r /* r30 */, const struct xBox * b /* r31 */) {
    // Local variables
