/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zDestructible.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80105D28 -> 0x80109088
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float DEG_TO_RAD; // size: 0x4, address: 0x80BFFF20
static float LAUNCH_ANGLE; // size: 0x4, address: 0x80BFFF24
static float LAUNCH_VEL; // size: 0x4, address: 0x80BFFF28
static float DAMAGE_RADIUS; // size: 0x4, address: 0x80BFFF2C
static float MAX_TIME_NO_COLLISIONS; // size: 0x4, address: 0x80BFFF30
static float HIT_TO_DESTROY_TIME; // size: 0x4, address: 0x80BFFF34
static float Y_VELOCITY; // size: 0x4, address: 0x80BFFF38
static float RESPAWN_THRESHOLD; // size: 0x4, address: 0x80BFFF3C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1097zDestructible_cpp */ {
    // Members
...
union /* @class$1236zDestructible_cpp */ {
...
// Range: 0x80105D28 -> 0x80105DA0
static void UpdateModelBound(struct xEnt * ent /* r29 */, struct xModelInstance * model /* r30 */, unsigned char gridUpdate /* r31 */) {}
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFFF40
// total size: 0x8
...
// Range: 0x80105DA0 -> 0x80105EF8
static void LoadModel(struct xEnt * ent /* r29 */, struct zDestructible * dest /* r28 */, unsigned char gridUpdate /* r30 */) {
    // Local variables
    unsigned int modelID; // r31
    struct RpAtomic * imodel; // r3
    struct RwV3d temp_pos; // r1+0x8

    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFFF4C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$2058zDestructible_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80105EF8 -> 0x80106150
static void SwapModelThroughState(struct xEnt * ent /* r29 */, struct zDestructibleState * state /* r30 */, struct zDestructible * dest /* r31 */) {
    // Local variables
    struct xModelInstance * curr; // r4
...
// Range: 0x80106320 -> 0x80106410
static void zDestructible_Launch(struct xEnt * ent /* r31 */, struct xVec3 & direction /* r0 */) {
    // Local variables
...
static float DOBJ_STD_BOUND_VAR; // size: 0x4, address: 0x80BFFF64
// Range: 0x80106410 -> 0x801064B4
static void DOBJ_alwaysUseSphere(struct xEnt * ent /* r31 */) {
    // Local variables
...
struct zHitSourceMapEntry zHitSourceMap[66]; // size: 0x210, address: 0x803D6D58
// Range: 0x801064B4 -> 0x80106574
static void zDestructible_SendEvent(struct xEnt * ent /* r3 */, struct xBase * dest /* r4 */) {
    // Local variables
    int hit_sourcetype; // r6
    const struct zHitSourceMapEntry * damage_type_map; // r0
...
// total size: 0xC
struct /* @class$1235zDestructible_cpp */ {
    // Members
...
// Range: 0x80106574 -> 0x8010686C
static void zDestructible_AffectAll(struct xEnt * ent /* r28 */, struct zDestructible * dest /* r29 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
    int i; // r31
    struct xVec3 dist; // r1+0x8
    void (* bak_bupdate)(struct xEnt *, struct xVec3 *); // r31
...
// Range: 0x8010686C -> 0x801068B0
static unsigned int BurnSinRateCallback(float time /* f0 */) {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80438760
// Range: 0x801068B0 -> 0x80107178
void zDestructibleAsset_Reset(struct zDestructible * & dest /* r31 */, struct xEnt * ent /* r27 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r29
    unsigned int i; // r28
    struct RpAtomic * imodel; // r0
    unsigned int fx_count; // r5
    unsigned int j; // r24
    struct zDestructibleStateFXParams * fx_Param; // r21
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r24
    unsigned int * animListIDs; // r25
    unsigned int j; // r23
    void * tmp_ptr; // r3
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043877C
// Range: 0x80107178 -> 0x801072A0
void zDestructibleAsset_ReReset(struct zDestructible * & dest /* r30 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r28
    unsigned int i; // r31
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFFF68
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x801072A0 -> 0x8010773C
void zDestructibleAsset_Init(unsigned int assetID /* r24 */, struct zDestructible * & dest /* r26 */, struct xEnt * ent /* r27 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r29
    unsigned int i; // r6
    struct xModelInstance * baseModel; // r4
    unsigned int fx_count; // r6
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r28
...
// Range: 0x8010773C -> 0x80107784
void zDestructibleAsset_CopyLODDistances(struct xEnt * ent /* r0 */, struct zDestructible * destructible /* r0 */) {
    // Local variables
    unsigned int state; // r8
    struct xModelInstance * model; // r6
}

static char __FUNCTION__[31]; // size: 0x1F, address: 0x80438798
// Range: 0x80107784 -> 0x80107824
static struct zEntAnimData * zDestructible_GetOwnerAnimData(struct xEnt * ent /* r3 */, int ownerID /* r0 */) {
    // References
    // -> static char __FUNCTION__[31];
}

// Range: 0x80107824 -> 0x80107890
static void zDestructible_SetAnimation(struct xEnt * ent /* r0 */, struct zDestructible * dest /* r4 */, struct zDestructibleState * state /* r31 */, int idx /* r30 */) {
    // Local variables
...
static char __FUNCTION__[29]; // size: 0x1D, address: 0x804387B8
// Range: 0x80107890 -> 0x8010799C
static void zDestructible_SwapAnimations(struct xEnt * ent /* r30 */, struct zDestructible * dest /* r31 */) {
    // Local variables
    struct zDestructibleState * state; // r29

    // References
    // -> static char __FUNCTION__[29];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFFF80
// Range: 0x8010799C -> 0x80107B54
static void zDestructible_Swap(struct xEnt * ent /* r26 */, struct zDestructible * dest /* r27 */, struct xVec3 & initial_velocity /* r28 */, int pad_port /* r29 */, unsigned char state_change /* r30 */) {
    // Local variables
...
static char __FUNCTION__[38]; // size: 0x26, address: 0x804387D8
// Range: 0x80107B54 -> 0x80107CE0
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80438800
// Range: 0x80107CE0 -> 0x80107E9C
static void zDestructible_StateChange(struct xEnt * ent /* r28 */, struct zDestructible * dest /* r29 */, int pad_port /* r30 */) {
    // Local variables
    struct zDestructibleState * state; // r31
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043881C
// Range: 0x80107E9C -> 0x8010800C
static void zDestructible_StopSounds(struct xEnt * ent /* r30 */, struct zDestructible * dest /* r31 */) {
    // Local variables
    int lastidx; // r0
...
static char __FUNCTION__[32]; // size: 0x20, address: 0x80438838
// Range: 0x8010800C -> 0x801080F8
static void zDestructible_StopAllIdleSounds(struct xEnt * ent /* r0 */, struct zDestructible * dest /* r29 */) {
    // Local variables
    unsigned int i; // r30
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80438858
// Range: 0x801080F8 -> 0x801082D8
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80438874
// Range: 0x801082D8 -> 0x8010855C
static void zDestructible_StateProcess(struct xEnt * ent /* r25 */, struct zDestructible * dest /* r26 */, unsigned int damage /* r27 */, unsigned int idx /* r24 */, const float * toParam /* r28 */, struct xVec3 & initial_velocity /* r29 */, int pad_port /* r30 */, unsigned char state_change /* r31 */) {
    // Local variables
    struct xModelInstance * curr; // r4
    unsigned int _percent; // r0

    // References
    // -> static char __FUNCTION__[27];
}

// Range: 0x8010857C -> 0x801085A8
static void zDestructible_PlayAnim(struct xEnt * ent /* r0 */, struct zDestructible * dest /* r0 */, struct zDestructibleState * state /* r0 */, int idx /* r0 */) {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80438890
// total size: 0x8
struct AnalogStick {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801085A8 -> 0x80108D38
void zDestructibleAsset_EventCB(struct xBase * from /* r30 */, struct xBase * root_base /* r26 */, struct zDestructible * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */) {
    // Local variables
    struct xEnt * ent; // r30
    struct xEnt * root_ent; // r0
    struct zDestructibleState * dstates; // r29
    ...
    int padport; // r26
    class zPlayerInput pinput; // r1+0x3C
    struct xSurface * surf; // r26
    struct zEntAnimData * ent_animdata; // r0
    unsigned int hit_source_flag; // r26
    unsigned int damage; // r29
    int i; // r27
    struct xVec3 kickback; // r1+0x8
    int padport; // r26
    class zPlayerInput pinput; // r1+0x20
    unsigned char isEnabled; // r0
...
// total size: 0x890
struct /* @class$2305zDestructible_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1038zDestructible_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zDestructible_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zDestructible_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zDestructible_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zDestructible_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zDestructible_cpp */ {
    // Members
...
// Range: 0x80108D38 -> 0x80108EAC
void zDestructibleAsset_Update(struct xEnt * ent /* r30 */, struct zDestructible * dest /* r31 */, struct xScene * sc /* r5 */, float dt /* f31 */) {
    // References
    // -> static float HIT_TO_DESTROY_TIME;
}

// Range: 0x80108EAC -> 0x80108EE0
struct zDestructible * zDestructibleGetFromEntity(struct xEnt * ent /* r3 */) {}

// Range: 0x80108EE0 -> 0x80109088
