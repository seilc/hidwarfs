/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUI.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80173B40 -> 0x80176C90
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char bAllowInput; // size: 0x1, address: 0x80C01B60
unsigned char bAllowSelectInput; // size: 0x1, address: 0x80C01B61
// Range: 0x80173B40 -> 0x80173B6C
static void UIEventHandler(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}
...
// total size: 0x1
struct /* @class$1029zUI_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zUI_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zUI_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zUI_cpp */ {
    // Members
...
// Range: 0x80173B8C -> 0x80173BFC
static void OnCurrentMotion(const struct tweak_info & info /* r3 */, void * value /* r31 */) {
    // Local variables
    const char * * str; // r0
    struct zUIMotionAsset * motion; // r0

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80173BFC -> 0x80173C20
static void OnStopMotion(const struct tweak_info & info /* r3 */) {}

static void * (* staticAllocator)(unsigned int, void *); // size: 0x4, address: 0x80C08570
static void * staticUser; // size: 0x4, address: 0x80C08574
static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *); // size: 0x4, address: 0x80C08578
static void * signalUser; // size: 0x4, address: 0x80C0857C
static int padPortInitiatedPause; // size: 0x4, address: 0x80C01B64
static int playersActiveAtInitiatedPause; // size: 0x4, address: 0x80C08580
// Range: 0x80173C20 -> 0x80173C28
void zUISetActivePlayersAtInitiatedPause(int value /* r0 */) {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x80173C28 -> 0x80173C30
int zUIGetActivePlayersAtInitiatedPause() {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x80173C30 -> 0x80173C38
void zUISetPadPortInitiatedPause(int port /* r0 */) {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x80173C38 -> 0x80173C40
int zUIGetPadPortInitiatedPause() {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x80173C40 -> 0x80173CB0
void zUI_Init(class zUI * text /* r30 */, struct zUIAsset * asset /* r31 */) {}

// Range: 0x80173CB0 -> 0x80173CB8
...
// Range: 0x80173CB8 -> 0x80173EDC
// this: r29
void zUI::Signal(struct xBase * from /* r30 */, unsigned int event /* r31 */) {
    // Local variables
    int i; // r31
    struct xBase * dest; // r26
    struct xBase * base; // r7
    int i; // r26
    struct xBase * base; // r7
...
// Range: 0x80173EDC -> 0x80173F88
// this: r31
void zUI::DoInit() {}

// Range: 0x80173F88 -> 0x80173F8C
void zUI::DoSetup() {}

// Range: 0x80173F8C -> 0x80174014
// this: r31
void zUI::DoReset() {}

// Range: 0x80174014 -> 0x8017409C
// this: r31
void zUI::DoResetMotion() {}

// Range: 0x8017409C -> 0x80174430
// this: r31
void zUI::DoHandleEvent(unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r7 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C01B68
// total size: 0x1C
...
unsigned char gPassAnyActveController; // size: 0x1, address: 0x80C08D1A
// total size: 0x30
class xfont {
    // Members
public:
...
// Range: 0x80174430 -> 0x80174AB8
// this: r27
void zUI::DoUpdate(float dt /* f31 */) {
    // Local variables
    struct _tagxPad * pad; // r28
    int startidx; // r1+0x8
    int port; // r0
    enum _tagTRCState state; // r0
    enum ePauseType pausetype; // r28
    int portInitiatedSysMsg; // r0
    unsigned char pressedDirection; // r4
...
static struct tweak_callback cbChangeZ; // size: 0x28, address: 0x8043C6C8
static signed char init; // size: 0x1, address: 0x80C08584
static struct tweak_callback cbCurrentMotion; // size: 0x28, address: 0x8043C6F0
static signed char init; // size: 0x1, address: 0x80C08585
static struct tweak_callback cbStopMotion; // size: 0x28, address: 0x8043C718
static signed char init; // size: 0x1, address: 0x80C08586
// Range: 0x80174ABC -> 0x80174F58
// this: r30
...
// Range: 0x80174F58 -> 0x80174FA8
// this: r31
void zUI::StopMotion() {}

// Range: 0x80174FA8 -> 0x80175044
// this: r29
void zUI::RunMotion(struct zUIMotionAsset * asset /* r30 */, unsigned char loop /* r31 */, unsigned char reset /* r0 */) {}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80C01B74
// Range: 0x80175044 -> 0x80175290
// this: r31
float zUI::CalcAcceleratedDistance(float totalDistance /* f31 */, float startTime /* f23 */, float endTime /* f24 */, float accelTime /* f25 */, float decelTime /* f26 */) {
    // Local variables
    float timePassed; // f29
    float timeLength; // f28
    float topVelocity; // f1
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01B8C
// total size: 0x34
...
// Range: 0x80175290 -> 0x80175CC0
// this: r27
void zUI::ApplyMotion() {
    // Local variables
    struct zUIMotionFrame frame; // r1+0x18
    float timeCompensation; // f31
    unsigned char fireEndEvent; // r31
    const char * entity; // r30
    int i; // r29
    int size; // r28
    const struct zUIMotionCmdMove * cmd; // r0
    const struct zUIMotionCmdScale * cmd; // r0
    float scaleX; // f30
    float scaleY; // f29
    const struct zUIMotionCmdRotate * cmd; // r0
    float rotation; // f2
    float sinA; // f0
    float cosA; // f0
    const struct zUIMotionCmdOpacity * cmd; // r0
    float opacityChange; // f0
    const struct zUIMotionCmdAbsoluteScale * cmd; // r0
    float scaleX; // f1
    float scaleY; // f0
    float percent; // f2
    const struct zUIMotionCmdBrightness * cmd; // r0
    float brightnessChange; // f0
    const struct zUIMotionCmdColor * cmd; // r0
    float redChange; // f0
    float greenChange; // f0
    float blueChange; // f0
    const struct zUIMotionCmdUVScroll * cmd; // r0
    unsigned char in; // r28
    struct xBase uiMotionBase; // r1+0x8
    struct zUIMotionAsset * oldMotion; // r28

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x80175CC0 -> 0x80175CEC
// this: r4
void zUI::DoInitMotion() {}

// Range: 0x80175D5C -> 0x80175E3C
// this: r30
void zUI::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r31 */) {}

static char * TYPES[8]; // size: 0x20, address: 0x8043C760
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C01B98
// Range: 0x80175E3C -> 0x801767A8
void zUI_ExpandMotionTweaks(const struct tweak_info & info /* r0 */) {
    // Local variables
    char base[128]; // r1+0x88
    struct zUIMotionAsset * asset; // r29
    char buffer[128]; // r1+0x8
    char * start; // r28
    int i; // r27
    struct zUIMotionCmdAsset * cmd; // r0
    struct zUIMotionCmdMove * derived; // r0
    struct zUIMotionCmdScale * derived; // r0
    struct zUIMotionCmdRotate * derived; // r0
    struct zUIMotionCmdOpacity * derived; // r0
    struct zUIMotionCmdAbsoluteScale * derived; // r0
    struct zUIMotionCmdBrightness * derived; // r0
    struct zUIMotionCmdColor * derived; // r0
    struct zUIMotionCmdUVScroll * derived; // r0
...
unsigned char gDontAutoMenu; // size: 0x1, address: 0x80C08D18
// Range: 0x801767A8 -> 0x8017698C
// this: r26
void zUI::AutoMenu(unsigned int (zUIAsset::* item) /* r27 */, unsigned int event /* r28 */) {
    // Local variables
    class zUI * ui; // r31
    const struct zUIAsset * asset; // r0
    unsigned int id; // r3
    unsigned int autoMenuLimit; // r30
    unsigned char bAllowAutoMenu; // r29
...
// Range: 0x8017698C -> 0x801769EC
// this: r31
void zUI::FocusOn() {}

// Range: 0x801769EC -> 0x80176A4C
// this: r31
void zUI::FocusOff() {}

// Range: 0x80176A4C -> 0x80176A9C
// this: r31
void zUI::Visible() {}

// Range: 0x80176A9C -> 0x80176AE4
// this: r31
void zUI::Invisible() {}

// Range: 0x80176AE4 -> 0x80176B88
// this: r30
void zUI::Select() {}

// Range: 0x80176B88 -> 0x80176C2C
// this: r30
void zUI::Unselect() {}

unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80176C2C -> 0x80176C78
void * zUIAllocStaticMemory(unsigned int size /* r4 */) {
    // References
...
// Range: 0x80176C78 -> 0x80176C84
void zUISetCustomStaticAllocator(void * (* allocator)(unsigned int, void *) /* r0 */, void * user /* r0 */) {
    // References
    // -> static void * staticUser;
    // -> static void * (* staticAllocator)(unsigned int, void *);
}

// Range: 0x80176C84 -> 0x80176C90
void zUISetCustomSignalHandler(void (* handler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *) /* r0 */, void * user /* r0 */) {
    // References
    // -> static void * signalUser;
    // -> static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *);
}
...
// total size: 0x64
struct {} zUI::__vtable; // size: 0x64, address: 0x8043C7A0
