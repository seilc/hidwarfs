/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomScrollers.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022976C -> 0x8022A4C8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int NUMBER_SCROLLER_ELEMENTS_PER_LINE; // size: 0x4, address: 0x80C045A0
float NUMBER_SCROLLER_SWITCH_TIME; // size: 0x4, address: 0x80C045A4
float DESCRIPTION_SCROLLER_SPEED; // size: 0x4, address: 0x80C045A8
int DESCRIPTION_SCROLLER_FADE_CHARS; // size: 0x4, address: 0x80C045AC
float MAP_SCROLLER_MAX_SPEED; // size: 0x4, address: 0x80C045B0
float MAP_SCROLLER_ACCELERATION; // size: 0x4, address: 0x80C045B4
float MAP_SCROLLER_SLOW_SPEED; // size: 0x4, address: 0x80C045B8
float MAP_SCROLLER_SLOW_DISTANCE; // size: 0x4, address: 0x80C045BC
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C045C0
// total size: 0x54
struct {} zUICustomDescriptionScroller::__vtable; // size: 0x54, address: 0x8043FCD4
// total size: 0xC
...
// Range: 0x8022976C -> 0x80229818
// this: r30
zUICustomDescriptionScroller::zUICustomDescriptionScroller(class zUI * ui /* r31 */) {
    // References
...
// total size: 0x2
struct /* @class$1771zUICustomScrollers_cpp */ {
    // Members
...
// Range: 0x802298B4 -> 0x80229928
static int descstrlen(const char * baseText /* r3 */) {
    // Local variables
    int ret; // r4
    unsigned char inBlock; // r5
    unsigned int ch; // r6
}

// Range: 0x80229928 -> 0x802299E4
static char * descstrncpy(char * dest /* r3 */, const char * source /* r4 */, int chars /* r5 */, char * * outDest /* r0 */, const char * * outSource /* r0 */) {
    // Local variables
    unsigned char inBlock; // r9
    unsigned int ch; // r10
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C045C8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1112zUICustomScrollers_cpp */ {
    // Members
...
union /* @class$847zUICustomScrollers_cpp */ {
...
// total size: 0xC
struct /* @class$1276zUICustomScrollers_cpp */ {
    // Members
...
// Range: 0x802299E4 -> 0x80229C24
// this: r29
void zUICustomDescriptionScroller::PreUpdate(float dt /* f29 */) {
    // Local variables
    int numCharacters; // r31
    int length; // r0
    char * outDest; // r1+0xC
    int CHARS; // r30
    enum xRegion region; // r0
    const char * outSource; // r1+0x8
    int i; // r26
    float alpha; // f1
...
// Range: 0x80229C24 -> 0x80229CD4
// this: r30
unsigned char zUICustomDescriptionScroller::HandleEvent(unsigned int toEvent /* r0 */) {
    // Local variables
    unsigned int sceneCurrent; // r3
    int scene; // r31
    struct Scene * sceneCur; // r0
}

// Range: 0x80229CD4 -> 0x80229D74
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C045D4
// total size: 0x54
struct {} zUICustomMapScroller::__vtable; // size: 0x54, address: 0x8043FC80
// total size: 0x24
...
// Range: 0x80229D74 -> 0x80229E2C
// this: r30
zUICustomMapScroller::zUICustomMapScroller(class zUI * ui /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomMapScroller::__vtable;
}

// Range: 0x80229E2C -> 0x80229EB4
// this: r31
...
// Range: 0x80229EB4 -> 0x80229EEC
// this: r0
unsigned char zUICustomMapScroller::HandleEvent(unsigned int toEvent /* r0 */) {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C045DC
// Range: 0x80229EEC -> 0x8022A160
// this: r31
void zUICustomMapScroller::PreUpdate(float dt /* f31 */) {
    // Local variables
    float dx; // f30
    float dy; // f29
    float distance; // f0
...
// Range: 0x8022A278 -> 0x8022A28C
// this: r0
void zUICustomMapScroller::PreApplyMotionFrame(struct zUIMotionFrame * frame /* r0 */) {}

// Range: 0x8022A28C -> 0x8022A290
void zUICustomMapScroller::SignalEffect() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C045E8
// total size: 0x54
struct {} zUICustomNumberScroller::__vtable; // size: 0x54, address: 0x8043FC2C
// total size: 0x90
...
// Range: 0x8022A290 -> 0x8022A34C
// this: r30
zUICustomNumberScroller::zUICustomNumberScroller(class zUI * ui /* r31 */) {
    // References
    // -> static char __FUNCTION__[5];
    // -> struct [anonymous] zUICustomNumberScroller::__vtable;
}

// Range: 0x8022A34C -> 0x8022A360
// this: r0
void zUICustomNumberScroller::Reset() {}

static int numbers[19]; // size: 0x4C, address: 0x8043FBE0
// Range: 0x8022A360 -> 0x8022A470
// this: r27
void zUICustomNumberScroller::PreUpdate(float dt /* f0 */) {
    // Local variables
...
// Range: 0x8022A470 -> 0x8022A4C8
void zUICustomNumberScroller::AddTweaks(const char * baseName /* r4 */) {
    // Local variables
    char buffer[128]; // r1+0x8
