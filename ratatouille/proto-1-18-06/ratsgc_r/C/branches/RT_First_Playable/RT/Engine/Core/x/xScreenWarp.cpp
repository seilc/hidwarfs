/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xScreenWarp.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800AED9C -> 0x800B1AD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float radius_cull; // size: 0x4, address: 0x80BFE428
static float radius_fade; // size: 0x4, address: 0x80BFE42C
static float mag; // size: 0x4, address: 0x80BFE430
static float mag; // size: 0x4, address: 0x80BFE434
static float freq; // size: 0x4, address: 0x80BFE438
static float mag; // size: 0x4, address: 0x80BFE43C
static float freq; // size: 0x4, address: 0x80BFE440
static float freq2; // size: 0x4, address: 0x80BFE444
static float mag; // size: 0x4, address: 0x80BFE448
static float freq; // size: 0x4, address: 0x80BFE44C
static float dthetax; // size: 0x4, address: 0x80BFE450
static float dthetay; // size: 0x4, address: 0x80BFE454
static float dxcos0; // size: 0x4, address: 0x80C07668
static float dxsin0; // size: 0x4, address: 0x80BFE458
static float dycos0; // size: 0x4, address: 0x80BFE45C
static float dysin0; // size: 0x4, address: 0x80BFE460
static int type; // size: 0x4, address: 0x80BFE464
static float repeat_every; // size: 0x4, address: 0x80C0766C
static float radius; // size: 0x4, address: 0x80BFE468
static float duration; // size: 0x4, address: 0x80BFE46C
static float intensity; // size: 0x4, address: 0x80BFE470
static float freq; // size: 0x4, address: 0x80BFE474
static float emit_height; // size: 0x4, address: 0x80BFE478
static float emit_random_offset; // size: 0x4, address: 0x80C07670
static unsigned char on; // size: 0x1, address: 0x80C07674
static int type; // size: 0x4, address: 0x80BFE47C
static float radius; // size: 0x4, address: 0x80BFE480
static float duration; // size: 0x4, address: 0x80BFE484
static float intensity; // size: 0x4, address: 0x80BFE488
static float freq; // size: 0x4, address: 0x80BFE48C
static float emit_height; // size: 0x4, address: 0x80BFE490
static unsigned char enable; // size: 0x1, address: 0x80BFE494
static unsigned char render_bounds; // size: 0x1, address: 0x80C07675
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$965xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$967xScreenWarp_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$968xScreenWarp_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$969xScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$970xScreenWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$971xScreenWarp_cpp */ {
    // Members
...
static struct tweak_callback cb_debug_emit; // size: 0x28, address: 0x803B9298
static struct tweak_callback cb_debug_print_warps; // size: 0x28, address: 0x803B92C0
static struct tweak_callback cb_heat_dtheta; // size: 0x28, address: 0x803B92E8
...
char * common_warp_names[7]; // size: 0x1C, address: 0x8042DFD8
// Range: 0x800AED9C -> 0x800AF3C0
...
static struct xVec2 * uvmap_buffer; // size: 0x4, address: 0x80C07678
static float uvmap_uoffset; // size: 0x4, address: 0x80C0767C
static float uvmap_voffset; // size: 0x4, address: 0x80C07680
static float uvmap_uscale; // size: 0x4, address: 0x80C07684
static float uvmap_vscale; // size: 0x4, address: 0x80C07688
static float uvmap_udelta; // size: 0x4, address: 0x80C0768C
static float uvmap_vdelta; // size: 0x4, address: 0x80C07690
static float uvmap_xscale; // size: 0x4, address: 0x80C07694
static float uvmap_yscale; // size: 0x4, address: 0x80C07698
static float uvmap_xdelta; // size: 0x4, address: 0x80C0769C
static float uvmap_ydelta; // size: 0x4, address: 0x80C076A0
static unsigned int common_warp_ids[6]; // size: 0x18, address: 0x80C076A4
// total size: 0x30
struct warper {
    // Members
...
static struct warper warp_buffer[128]; // size: 0x1800, address: 0x80A93E58
static struct warper warp_lists[6]; // size: 0x120, address: 0x80A95658
static struct warper * warp_stack; // size: 0x4, address: 0x80C076BC
static unsigned char render_this_frame; // size: 0x1, address: 0x80C076C0
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFE498
// Range: 0x800AF3C0 -> 0x800AF4D0
static struct warper * alloc_warp(enum type_enum type /* r31 */) {
    // Local variables
...
// Range: 0x800AF4D0 -> 0x800AF500
static void free_warp(struct warper * warp /* r0 */) {
    // References
    // -> static struct warper * warp_stack;
}

// Range: 0x800AF500 -> 0x800AF564
...
// Range: 0x800AF564 -> 0x800AF5B8
static unsigned char warp_exists(struct warper * warp /* r0 */) {
    // Local variables
    struct warper * w; // r4
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFE4A4
// Range: 0x800AF5B8 -> 0x800AF6BC
static void set_warp(struct warper & warp /* r29 */, float radius /* f28 */, float duration /* f29 */, enum type_enum type /* r30 */, float intensity /* f30 */, float freq /* f31 */, int flags /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x800AF6BC -> 0x800AF744
...
void (* common_warp_animate[6])(struct xVec2 *, struct warper &, struct xVec2 &, float, float, float, float); // size: 0x18, address: 0x80BFE4C8
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x800AF808 -> 0x800AFA2C
static unsigned char animate_uvmap(struct xVec2 * uvmap /* r24 */, struct RwCamera * cam /* r0 */) {
    // Local variables
    const struct xMat4x3 & view_mat; // r29
    unsigned char need_render; // r28
    int type; // r27
    void (* const animate_cb)(struct xVec2 *, struct warper &, struct xVec2 &, float, float, float, float); // r26
    struct warper * warp; // r25
...
// Range: 0x800AFA2C -> 0x800AFB84
static void debug_print_warps() {
    // Local variables
    int type; // r29
    const char * type_name; // r28
    struct warper * warp; // r27
...
// Range: 0x800AFB84 -> 0x800AFBA4
static void debug_emit() {}

// Range: 0x800AFBA4 -> 0x800AFC24
...
static float debug_emit_time; // size: 0x4, address: 0x80C076C4
static struct warper * debug_warp; // size: 0x4, address: 0x80C076C8
// Range: 0x800AFC24 -> 0x800AFD08
...
// total size: 0x4
struct /* @class$1254xScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1392xScreenWarp_cpp */ {
    // Members
...
union /* @class$1025xScreenWarp_cpp */ {
...
// total size: 0x10
struct /* @class$1038xScreenWarp_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2173xScreenWarp_cpp */ {
    // Static members
...
// Range: 0x800AFFF0 -> 0x800B0010
void scene_exit() {}

// Range: 0x800B0010 -> 0x800B0030
void reset() {}
...
// Range: 0x800B0030 -> 0x800B01DC
void update(float dt /* f31 */) {
    // Local variables
    int type; // r30
    struct warper * warp; // r29
...
// Range: 0x800B01DC -> 0x800B01E0
void pre_render() {}

// Range: 0x800B01E0 -> 0x800B024C
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE4B0
// Range: 0x800B033C -> 0x800B0474
struct warper * emit(const struct xVec3 & loc /* r29 */, float radius /* f28 */, float duration /* f29 */, enum type_enum type /* r30 */, float intensity /* f30 */, float freq /* f31 */, int flags /* r31 */) {
    // Local variables
    struct warper * warp; // r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFE4B8
// Range: 0x800B0474 -> 0x800B06C4
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFE4C0
// Range: 0x800B06C4 -> 0x800B07A0
void remove(struct warper * warp /* r31 */) {
    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x800B07A0 -> 0x800B0874
static void get_uvmap_range(int & istart /* r0 */, int & iend /* r0 */, int & jstart /* r0 */, int & jend /* r0 */, float x /* f0 */, float y /* f0 */, float r /* f0 */) {}

// Range: 0x800B0874 -> 0x800B0AE0
static void warp_animate_warble(struct xVec2 * uvmap /* r29 */, struct warper & warp /* r0 */, const struct xVec2 & loc /* r27 */, float radius /* f1 */, float base_intensity /* f0 */, float s /* f2 */) {
    // Local variables
    float randumag; // f0
    float random_u; // f27
    float random_v; // f26
...
// Range: 0x800B0AE0 -> 0x800B0CA8
static void warp_animate_lens(struct xVec2 * uvmap /* r30 */, const struct xVec2 & loc /* r31 */, float radius /* f30 */, float base_intensity /* f29 */, float s /* f28 */) {
    // Local variables
    float mag; // f5
    float r2; // f31
    float ir2; // f30
...
// Range: 0x800B0CA8 -> 0x800B0F60
static void warp_animate_ripple(struct xVec2 * uvmap /* r29 */, struct warper & warp /* r0 */, const struct xVec2 & loc /* r27 */, float radius /* f1 */, float base_intensity /* f0 */, float s /* f17 */) {
    // Local variables
    float mag; // f6
    float umag; // f26
    float vmag; // f25
...
// Range: 0x800B0F60 -> 0x800B1240
static void warp_animate_shockwave(struct xVec2 * uvmap /* r29 */, const struct xVec2 & loc /* r27 */, float radius /* f3 */, float base_intensity /* f0 */, float s /* f16 */) {
    // Local variables
    float freq; // f26
    float freq2; // f17
    float mag; // f5
...
// Range: 0x800B1240 -> 0x800B150C
static void warp_animate_heat_shimmer(struct xVec2 * uvmap /* r30 */, struct warper & warp /* r0 */, const struct xVec2 & loc /* r31 */, float radius /* f25 */, float base_intensity /* f0 */, float s /* f0 */) {
    // Local variables
    float mag; // f31
    float start_theta; // f26
    int istart; // r1+0x14
    int iend; // r1+0x10
    int jstart; // r1+0xC
    int jend; // r1+0x8
...
// Range: 0x800B150C -> 0x800B16A4
static void warp_animate_static_lens(struct xVec2 * uvmap /* r30 */, const struct xVec2 & loc /* r31 */, float radius /* f1 */, float base_intensity /* f0 */) {
    // Local variables
    float mag; // f6
    float r2; // f31
    float ir2; // f30
