/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCombatSystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025F840 -> 0x8025FAD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1097zCombatSystem_cpp */ {
    // Members
...
union /* @class$1236zCombatSystem_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCombatSystem_cpp */ {
    // Members
...
static struct xEnt * combatList[96]; // size: 0x180, address: 0x80BCB878
static unsigned int currentCombat; // size: 0x4, address: 0x80C092A8
// Range: 0x8025F840 -> 0x8025F860
...
// total size: 0x10
struct /* @class$1509zCombatSystem_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8025F884 -> 0x8025F920
void zCombatSystemUpdate(float dt /* f31 */) {
    // Local variables
    unsigned int i; // r30
    struct xEnt * ent; // r29
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80442E18
// Range: 0x8025F998 -> 0x8025FAD4
void zCombatSystemUpdateEntity(struct xEnt * ent /* r31 */, float dt /* f31 */) {
    // Local variables
