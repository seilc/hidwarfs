/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSymbol.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8016C830 -> 0x8016C83C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct symbol_map {
    // Members
    struct symbol_map * next; // offset 0x0, size 0x4
    unsigned int id; // offset 0x4, size 0x4
    struct xModelInstance * model; // offset 0x8, size 0x4
};
struct symbol_map * map; // size: 0x4, address: 0x80C08508
// total size: 0x1
class symbol {
    // Static members
    static struct symbol_map * map; // size: 0x4
};
// Range: 0x8016C830 -> 0x8016C83C
void symbol::init() {
    // References
