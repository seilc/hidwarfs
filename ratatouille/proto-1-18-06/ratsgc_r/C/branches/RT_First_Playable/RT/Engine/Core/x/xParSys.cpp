/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xParSys.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8009A5DC -> 0x8009B858
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sBlendTable[11]; // size: 0x2C, address: 0x803B49B0
...
static enum ptank_render_mode_enum ptank_render_mode; // size: 0x4, address: 0x80BFDC28
static unsigned char ptank_render_mode_registered; // size: 0x1, address: 0x80C07578
static char * ptank_render_mode_labels[3]; // size: 0xC, address: 0x80BFDC2C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 par_offset_right; // size: 0xC, address: 0x80C0757C
static struct xVec3 par_offset_up; // size: 0xC, address: 0x80C07588
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8009A624 -> 0x8009A95C
static void par_sprite_update(struct xParSys & sys /* r30 */, struct xParGroup & group /* r29 */) {
    // Local variables
    unsigned int pivot; // r31
...
// Range: 0x8009A95C -> 0x8009A9EC
unsigned char using_ptank_render(const struct xParSysAsset & sys /* r31 */) {
    // References
...
// Range: 0x8009A9EC -> 0x8009AA3C
static void render_par_sprite(void * data /* r30 */, struct xParGroup * ps /* r31 */) {}
...
static struct xParSysInfo sParSysInfo[7]; // size: 0x38, address: 0x80419AF8
static char __FUNCTION__[25]; // size: 0x19, address: 0x80419B30
// Range: 0x8009AA3C -> 0x8009AAD0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFDC38
// Range: 0x8009AAD0 -> 0x8009ACB0
void xParCmdTexInit(struct xParCmdTex * cmd /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x8009ACB0 -> 0x8009ACD0
void xParSysInit(void * b /* r0 */, void * tasset /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFDC48
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8009ACD0 -> 0x8009B004
void xParSysInit(struct xBase * b /* r30 */, struct xParSysAsset * tasset /* r31 */) {
    // Local variables
    struct xParSys * t; // r0
    unsigned int i; // r26
    unsigned char * cmdPtr; // r27
    unsigned int i; // r26
    unsigned int i; // r25
    struct xParCmdMove & cmd; // r4
...
// Range: 0x8009B004 -> 0x8009B064
void xParSysSetup(struct xParSys * t /* r31 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFDC54
// Range: 0x8009B064 -> 0x8009B19C
void xParSysReset(struct xParSys * t /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x8009B19C -> 0x8009B1CC
struct xBase * xParSysExit(struct xBase * b /* r31 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFDC64
// Range: 0x8009B1CC -> 0x8009B258
...
// total size: 0x0
struct xSerial {};
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFDC70
// Range: 0x8009B258 -> 0x8009B39C
void xParSysEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r30 */) {
    // Local variables
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFDC80
// Range: 0x8009B39C -> 0x8009B520
void xParSysUpdate(struct xBase * to /* r29 */, float dt /* f31 */) {
    // Local variables
    struct xParSys * s; // r31
    struct xParSys * parent; // r30
    struct xParGroup * g; // r29

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFDC90
// Range: 0x8009B520 -> 0x8009B770
static void xParGroupUpdateR(struct xParSys * s /* r30 */, struct xParGroup * g /* r31 */, float dt /* f31 */) {
    // Local variables
    unsigned int i; // r28
    struct xParCmd * cmd; // r27
    void (* func)(struct xParCmd *, struct xParGroup *, float); // r3

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFDCA4
// Range: 0x8009B770 -> 0x8009B858
void xParGroupUpdate(struct xParSys * s /* r27 */, struct xParGroup * g /* r28 */, float dt /* f31 */) {
    // Local variables
    unsigned int i; // r30
