/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGamePufferoids.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802ABA48 -> 0x802ACF60
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x80C096A8
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x80C096AC
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x80C096B0
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x80C096B4
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x80C096B8
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x80C096BC
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x80C096C0
static unsigned int PUFF_MODEL_IDS[5]; // size: 0x14, address: 0x80C06370
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06384
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1128zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1359zMiniGamePufferoids_cpp */ {
    // Members
...
union /* @class$1343zMiniGamePufferoids_cpp */ {
...
// total size: 0x10
struct /* @class$1848zMiniGamePufferoids_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802ABA48 -> 0x802ABC40
// this: r29
void zMiniGamePufferoidsPuff::Init(struct PuffInitData * data /* r30 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$2095zMiniGamePufferoids_cpp */ {
    // Static members
...
// Range: 0x802AC0B4 -> 0x802AC1B0
// this: r0
void zMiniGamePufferoidsPuff::ProjectileHit(int owner /* r0 */, int value /* r0 */) {}

// Range: 0x802AC1B0 -> 0x802AC1BC
// this: r0
void zMiniGamePufferoidsPuff::Kill() {}

// total size: 0x7C
struct {} zMiniGamePufferoids::__vtable; // size: 0x7C, address: 0x80448108
// total size: 0x34
...
// total size: 0x1
struct /* @class$1276zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1278zMiniGamePufferoids_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1279zMiniGamePufferoids_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1280zMiniGamePufferoids_cpp */ {
    // Members
...
enum /* @enum$1281zMiniGamePufferoids_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1282zMiniGamePufferoids_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1283zMiniGamePufferoids_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1285zMiniGamePufferoids_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1273zMiniGamePufferoids_cpp */ {
    // Members
...
// Range: 0x802AC1BC -> 0x802AC208
// this: r31
zMiniGamePufferoids::zMiniGamePufferoids(struct zMiniGameAsset * a /* r0 */) {
    // References
    // -> struct [anonymous] zMiniGamePufferoids::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0638C
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x802AC208 -> 0x802AC518
void zMiniGamePufferoids::Init(struct xBase & data /* r28 */, struct xDynAsset & asset /* r29 */, unsigned long asset_size /* r30 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C06394
// total size: 0x28
...
// Range: 0x802AC518 -> 0x802AC614
// this: r28
void zMiniGamePufferoids::SpawnPuffs(int num /* r29 */) {
    // Local variables
    int i; // r31
    class zMiniGamePufferoidsPuff * puff; // r30
    struct PuffInitData data; // r1+0x8

    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C063A0
// Range: 0x802AC614 -> 0x802AC708
// this: r29
void zMiniGamePufferoids::SetupStage(unsigned int id /* r0 */, unsigned char resetPickup /* r30 */) {
    // Local variables
    struct xGroup * pickupSpawnGroup; // r31

    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x802AC708 -> 0x802AC8AC
// this: r31
...
static char statsBuf[4][128]; // size: 0x200, address: 0x80BD28A8
// Range: 0x802ACA64 -> 0x802ACDA8
// this: r31
void zMiniGamePufferoids::Update(float dt /* f30 */) {
    // Local variables
    int i; // r27
    int grabbedPickup; // r1+0x8
    class zMiniGamePufferoidsPuff * curr; // r27
    class zMiniGamePufferoidsPuff * prev; // r28
    class zMiniGamePufferoidsPuff * next; // r29
    int num; // r4
    int deadCount; // r27
    int k; // r28
    int j; // r26
