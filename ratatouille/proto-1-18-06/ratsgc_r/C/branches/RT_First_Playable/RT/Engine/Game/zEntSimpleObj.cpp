/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEntSimpleObj.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80110200 -> 0x8011275C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int sMgrCount; // size: 0x4, address: 0x80C07CA0
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
union /* @class$820zEntSimpleObj_cpp */ {
...
// total size: 0xC
struct /* @class$1249zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1085zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2367zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1026zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zEntSimpleObj_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zEntSimpleObj_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zEntSimpleObj_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zEntSimpleObj_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zEntSimpleObj_cpp */ {
    // Members
...
static struct zSimpleMgr * sMgrList; // size: 0x4, address: 0x80C07CA4
static unsigned int sSimpleCustomCount; // size: 0x4, address: 0x80C07CA8
static struct xEnt * * sSimpleCustomList; // size: 0x4, address: 0x80C07CAC
// Range: 0x80110200 -> 0x80110264
static void CollisionReset(struct zEntSimpleObj * ent /* r0 */) {}

// Range: 0x80110264 -> 0x8011029C
static void CollisionOn(struct zEntSimpleObj * ent /* r0 */) {}
...
// Range: 0x8011029C -> 0x8011030C
static int CmpSimpleMgr(void * a /* r3 */, void * b /* r31 */) {
    // Local variables
    const struct zSimpleMgr * simpA; // r0
    const struct zSimpleMgr * simpB; // r0
    struct xLightKitBlendInfo blendInfoA; // r1+0x14
    struct xLightKitBlendInfo blendInfoB; // r1+0x8
}

// Range: 0x8011030C -> 0x80110380
static void VisUpdateSimpleMgr(struct xEnt * ent /* r31 */) {
    // Local variables
    struct zEntSimpleObj * simpent; // r0
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C001B8
...
// total size: 0x10
struct /* @class$2050zEntSimpleObj_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80110380 -> 0x80110D04
void zEntSimpleObj_MgrInit(struct zEntSimpleObj * * entList /* r16 */, unsigned int entCount /* r21 */) {
    // Local variables
    unsigned int i; // r27
    unsigned int reactiveExtras; // r0
    unsigned int modelsRequired; // r26
    struct zEntSimpleObj * * tempEntList; // r31
    unsigned int tempEntCount; // r25
    unsigned int custEntCount; // r24
    ...
    struct xVec3 * t0; // r22
    float t; // f31
    struct RwMatrixTag * fastMatList; // r17
    int i; // r16
    struct zSimpleMgr * smgr; // r22
    struct RpAtomic * model; // r16
    struct RwSphere oldbound; // r1+0x8
    struct zLODTable * lod; // r0
    float distscale; // f2
    unsigned char uvAnimated; // r3
...
unsigned char sRenderModels; // size: 0x1, address: 0x80BFD570
enum RwFogType {
...
// Range: 0x80110D04 -> 0x80111070
void zEntSimpleObj_MgrUpdateRender(float dt /* f27 */) {
    // Local variables
    unsigned int i; // r31
    unsigned int currPipeFlags; // r30
    unsigned int pipeMask; // r29
    enum RwFogType oldfogtype; // r0
    float camX; // f31
    float camY; // f30
    float camZ; // f29
    struct zSimpleMgr * smgr; // r28
    unsigned int smgrFlags; // r27
    float camdist2; // f28
    struct zEntSimpleObj * ent; // r26
    unsigned int testPipeFlags; // r25
    unsigned int xorFlags; // r24
    int picklod; // r0
    struct xModelInstance * minst; // r3
    struct RpAtomic * modelData; // r24
...
// Range: 0x80111070 -> 0x801110F0
void zEntSimpleObj_MgrCustomUpdate(struct zScene * s /* r29 */, float dt /* f31 */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x80111150 -> 0x8011119C
static void zEntSimpleObj_Render(struct xEnt * ent /* r31 */) {}

// Range: 0x8011119C -> 0x801111C4
void zEntTrackPhysics_Init(void * ent /* r0 */, void * asset /* r0 */) {}

// Range: 0x801111C4 -> 0x801111EC
void zEntSimpleObj_Init(void * ent /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C001D0
// Range: 0x801111EC -> 0x801115CC
void zEntSimpleObj_Init(struct zEntSimpleObj * ent /* r27 */, struct xEntAsset * asset /* r28 */, unsigned char physparams /* r30 */, unsigned char candestroy /* r29 */) {
    // Local variables
    struct xSimpleObjAsset * sasset; // r0
    unsigned int tmpsize; // r1+0xC
    struct RpAtomic * modelData; // r31
    void * animData; // r30
    unsigned int animBoneCount; // r0
    unsigned int size; // r1+0x8
    unsigned int newid; // r28
...
// Range: 0x801115CC -> 0x801115D0
static void zEntSimpleObj_Move() {}

// Range: 0x801115D0 -> 0x801115FC
void zEntSimpleObj_CustomMove(struct xEnt * ent /* r3 */, struct xEntFrame * frame /* r5 */) {}

// Range: 0x801115FC -> 0x80111784
void zEntSimpleObj_Update(struct zEntSimpleObj * ent /* r31 */, struct xScene * sc /* r29 */, float dt /* f31 */) {
    // Local variables
    float duration; // f0
    struct xQuat * q0; // r30
    struct xVec3 * t0; // r29
...
// total size: 0x890
struct /* @class$2297zEntSimpleObj_cpp */ {
    // Static members
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C001E4
// Range: 0x80111784 -> 0x80111830
void zEntSimpleObj_Setup(struct zEntSimpleObj * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[20];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C001F8
// Range: 0x80111830 -> 0x80111900
void zEntSimpleObj_Save(struct zEntSimpleObj * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C0020C
// Range: 0x80111900 -> 0x801119D0
void zEntSimpleObj_Load(struct zEntSimpleObj * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

// Range: 0x801119D0 -> 0x80111A10
void zEntSimpleObj_ReReset(struct zEntSimpleObj * ent /* r3 */) {}

static unsigned int entToCheck; // size: 0x4, address: 0x80C07CB0
static signed char init; // size: 0x1, address: 0x80C07CB4
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C00220
// Range: 0x80111A10 -> 0x80111F14
void zEntSimpleObj_Reset(struct zEntSimpleObj * ent /* r28 */) {
    // Local variables
    struct RpAtomic * imodel; // r31
    struct xLightKit * pLightKit; // r30
    struct xSurface * surfaces[32]; // r1+0x8
    int i; // r29
    int j; // r26
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C00234
class zLightweightSystem * zLightweight<z::toss, 10>::GetSystem()::system; // size: 0x4, address: 0x80C07CB8
signed char zLightweight<z::toss, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C07CBC
char __FUNCTION__$localstatic1$Add__32zLightweightSystem<Q21z4toss,10>FRCQ21z4toss[4]; // size: 0x4, address: 0x80C0024C
union FloatAndVoid {
    float f; // offset 0x0, size 0x4
    void * v; // offset 0x0, size 0x4
};
// Range: 0x80111F14 -> 0x80112724
void zEntSimpleObjEventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r28 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
...
// total size: 0x24
struct {} zLightweightSystem<z::toss, 10>::__vtable; // size: 0x24, address: 0x804389A4
// total size: 0x20
struct {} z::toss::__vtable; // size: 0x20, address: 0x8043E730
// total size: 0x0
...
// total size: 0x20
struct {} zLightweight<z::toss, 10>::__vtable; // size: 0x20, address: 0x80438984
// Range: 0x80112724 -> 0x8011275C
void zEntSimpleObj_MoveUpdate(struct zEntSimpleObj * object /* r0 */) {}

// total size: 0x24
struct {} zLightweightSystemBase::__vtable; // size: 0x24, address: 0x80438960
// total size: 0x4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C00250
