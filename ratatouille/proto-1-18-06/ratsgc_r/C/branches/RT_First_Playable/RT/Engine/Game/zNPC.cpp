/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPC.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80246480 -> 0x80246968
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zNPCInstance : public xBase {
    // Functions
    void set_data(class zNPCBaseIN2 * data);

    zNPCInstance(const struct xModelAssetInfo * model_asset, unsigned int type, struct zNPCAssetIN2 * npc_asset, int npc_asset_size);

    void Reset();

    void SetMovementRadius(float inRadius);

    void SetManualMovementRadiusCenter(struct xVec3 * inCenter);

    void ExitingSpawnState();

    unsigned char ShouldHaveData();
...
// Range: 0x80246480 -> 0x802464D0
// this: r30
void zNPCInstance::set_data(class zNPCBaseIN2 * data /* r31 */) {}
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04BC8
// total size: 0xC
struct {} zNPC::zNPCInstance::__vtable; // size: 0xC, address: 0x80C04BE4
enum ezGameLevel {
    ezGAMELEVEL_UT01 = 0,
    ezGAMELEVEL_DD01 = 1,
    ezGAMELEVEL_MT01 = 2,
    ...
    ezGAMELEVEL_A30x = 13,
    ezGAMELEVEL_Misc = 14,
    ezGAMELEVEL_Total = 15,
};
enum ezGameLevel gNPCGameLevel; // size: 0x4, address: 0x80C044E8
// Range: 0x802464D0 -> 0x80246694
// this: r31
zNPCInstance::zNPCInstance(const struct xModelAssetInfo * model_asset /* r0 */, unsigned int type /* r0 */, struct zNPCAssetIN2 * npc_asset /* r29 */, int npc_asset_size /* r0 */) {
    // Local variables
    char * ptr; // r30
    ...
    // -> enum ezGameLevel gNPCGameLevel;
    // -> struct [anonymous] zNPC::zNPCInstance::__vtable;
}

// Range: 0x80246694 -> 0x802466B4
// this: r0
void zNPCInstance::Reset() {}

// Range: 0x802466B4 -> 0x802466E0
// this: r0
void zNPCInstance::SetMovementRadius(float inRadius /* f0 */) {}

// Range: 0x802466E0 -> 0x80246724
// this: r31
void zNPCInstance::SetManualMovementRadiusCenter(struct xVec3 * inCenter /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C04BD0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$2210zNPC_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2211zNPC_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$1041zNPC_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zNPC_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zNPC_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zNPC_cpp */ {
    // Members
...
// Range: 0x80246724 -> 0x80246820
// this: r31
void zNPCInstance::ExitingSpawnState() {
    // Local variables
    class zMeshPosition localMeshPos; // r1+0x8
...
// Range: 0x80246820 -> 0x80246844
float zNPCInstance::get_update_dist2() {
    // Local variables
    float updateDist; // f0
}

// Range: 0x80246844 -> 0x80246868
float zNPCInstance::get_surrender_dist2() {
    // Local variables
    float surrenderDist; // f0
}

// Range: 0x80246868 -> 0x802468D8
static void sNPCInstanceSetMatchingEntityVisibilityCullFlag(class zNPCBaseIN2 * npc /* r31 */, unsigned int visibilityCullFlag /* r0 */) {}

// Range: 0x802468D8 -> 0x80246968
// this: r31
unsigned char zNPCInstance::ShouldHaveData() {}
