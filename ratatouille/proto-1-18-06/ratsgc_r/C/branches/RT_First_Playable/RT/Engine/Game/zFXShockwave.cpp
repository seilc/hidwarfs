/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFXShockwave.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80216158 -> 0x802168E4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C041B0
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$1080zFXShockwave_cpp */ {
    // Members
...
// Range: 0x802161AC -> 0x802161CC
// this: r0
static void zFXShockwave::SceneExit() {}

// Range: 0x802161CC -> 0x80216208
// this: r31
static void zFXShockwave::Reset() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C041BC
// Range: 0x80216208 -> 0x8021632C
// this: r30
static void zFXShockwave::Start(class zFXShockwaveConfig * cfg /* r0 */, const struct xVec3 & pos /* r29 */, float instanceScale /* f0 */, unsigned char killProj /* r31 */) {
    // References
    // -> static char __FUNCTION__[6];
}

class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::system; // size: 0x4, address: 0x80C08EE8
signed char zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C08EEC
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::system; // size: 0x4, address: 0x80C08EF0
signed char zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C08EF4
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::system; // size: 0x4, address: 0x80C08EF8
signed char zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C08EFC
// Range: 0x8021632C -> 0x80216430
// this: r30
static unsigned char zFXShockwave::Update(float dt /* f0 */) {}
...
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileMetalSheet, 20>::__vtable; // size: 0x28, address: 0x8043F550
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::__vtable; // size: 0x38, address: 0x8043F518
// total size: 0x14
struct {} zNPCProjectile::__vtable; // size: 0x14, address: 0x80C041C4
...
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileTrackingGrub, 40>::__vtable; // size: 0x28, address: 0x8043F4F0
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::__vtable; // size: 0x38, address: 0x8043F4B8
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$2058zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1021zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1022zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1023zFXShockwave_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1024zFXShockwave_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027zFXShockwave_cpp */ {
    // Members
...
union /* @class$1236zFXShockwave_cpp */ {
...
// total size: 0xC
struct /* @class$1235zFXShockwave_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x28
struct {} zNPCProjectileSystem<zNPCProjectileGrub, 40>::__vtable; // size: 0x28, address: 0x8043F490
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::__vtable; // size: 0x38, address: 0x8043F458
// Range: 0x80216430 -> 0x802164CC
// this: r0
static void zFXShockwave::Render() {}

static int shockwavesSize; // size: 0x4, address: 0x80C08F00
static class zFXShockwave * shockwaves; // size: 0x4, address: 0x80C08F04
static class zFXShockwave * freeList; // size: 0x4, address: 0x80C08F08
static class zFXShockwave * usedList; // size: 0x4, address: 0x80C08F0C
// Range: 0x802164CC -> 0x802164DC
static void ListPush(class zFXShockwave * & list /* r0 */, class zFXShockwave * element /* r0 */) {}

// Range: 0x802164DC -> 0x80216500
static class zFXShockwave * ListPop(class zFXShockwave * & list /* r0 */) {}

// Range: 0x80216500 -> 0x80216538
static class zFXShockwave * ListRemove(class zFXShockwave * & list /* r3 */, class zFXShockwave * element /* r0 */, class zFXShockwave * prev /* r0 */) {}

// Range: 0x80216538 -> 0x802165A0
...
// Range: 0x802165A0 -> 0x80216638
// this: r30
void zFXShockwaveConfig::AddTweaks(const char * prefix /* r31 */) {}

// Range: 0x80216638 -> 0x8021669C
void zFXShockwaveSceneEnter(int maxInScene /* r3 */) {
    // References
    // -> static class zFXShockwave * shockwaves;
    // -> static int shockwavesSize;
}

// Range: 0x8021669C -> 0x802166D4
// this: r31
static zFXShockwave::zFXShockwave() {}

// Range: 0x802166D4 -> 0x80216730
...
// Range: 0x80216730 -> 0x802167BC
void zFXShockwaveUpdate(float dt /* f31 */) {
    // Local variables
    class zFXShockwave * currWave; // r31
    class zFXShockwave * prevWave; // r30
    class zFXShockwave * next; // r31
...
// Range: 0x802167BC -> 0x8021684C
unsigned char zFXShockwaveStart(class zFXShockwaveConfig * config /* r28 */, const struct xVec3 & pos /* r29 */, float scale /* f31 */, unsigned char killproj /* r30 */) {
    // Local variables
