/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMeshNavigation.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F7AB0 -> 0x801F93D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float STEERING_FAKE_VELOCITY; // size: 0x4, address: 0x80C03A68
static float STEERING_PUSHVEC_SCALE; // size: 0x4, address: 0x80C03A6C
static unsigned char STEERING_DEBUG_RENDER; // size: 0x1, address: 0x80C08DB8
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03A70
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
struct xVec2 g_O2; // size: 0x8, address: 0x80C0AD78
// Range: 0x801F7AB0 -> 0x801F7F08
static struct xVec2 GetMeshDirection(class zMeshPosition & start /* r26 */, const class zMeshPosition & destination /* r27 */, float radius /* f31 */, struct xVec2 & leftNormal /* r28 */, struct xVec2 & rightNormal /* r29 */) {
    // Local variables
...
// Range: 0x801F7F08 -> 0x801F7F84
static struct xVec2 GetMeshDirection(const class zMeshPosition & start /* r0 */, const class zMeshPosition & destination /* r31 */, float radius /* f31 */) {
    // Local variables
    class zMeshPosition nonConstStart; // r1+0x18
    struct xVec2 leftNormal; // r1+0x10
    struct xVec2 rightNormal; // r1+0x8
}

static char __FUNCTION__[28]; // size: 0x1C, address: 0x8043E8D0
// Range: 0x801F7F84 -> 0x801F80D8
unsigned char zMeshNavigationGetDirection(const class zMeshPosition & start /* r29 */, const class zMeshPosition & destination /* r30 */, float radius /* f31 */, struct xVec3 & direction /* r31 */) {
    // Local variables
    class zMeshPosition bestDestination; // r1+0x10
    struct xVec2 direction2D; // r1+0x8
...
// Range: 0x801F8164 -> 0x801F8428
void zMeshNavigationCommon::DetermineSteeringDirection(struct xEnt * entity /* r26 */, const class zMeshCircle & entCircle /* r21 */, const struct xVec2 & entDir /* r22 */, class zMeshCircle & threatCircle /* r23 */, struct xVec2 & resultDir /* r24 */, unsigned int & threatClusterSize /* r25 */) {
    // Local variables
    struct xVec3 threatPos; // r1+0x50
    class zMeshCircle * danglingList; // r31
    class zMeshCircle * endOfClusterList; // r30
    class zMeshCircle * circleToCheck; // r29
    class zMeshCircle * currentDanglingCircle; // r28
    class zMeshCircle * prevDanglingCircle; // r27
    class zMeshCircle * nextDanglingCircle; // r26
    struct xVec3 pos1; // r1+0x44
    struct xVec3 pos2; // r1+0x38
    struct xVec3 diff; // r1+0x2C
    float noIntersectDist2; // f31
    class zMeshCircle * curr; // r26
    struct xVec2 normalDir; // r1+0x24
    struct xVec2 entPos2D; // r1+0x1C
    class zMeshCircle * curr; // r21
    int weight; // r22
    struct xVec2 currPos2D; // r1+0x14
    struct xVec2 toCurr; // r1+0xC
...
// total size: 0x4
struct /* @class$1088zMeshNavigation_cpp */ {
    // Members
...
union /* @class$1227zMeshNavigation_cpp */ {
...
// total size: 0xC
struct /* @class$1226zMeshNavigation_cpp */ {
    // Members
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C03A84
...
// Range: 0x801F8428 -> 0x801F8A28
class zMeshCircle * zMeshNavigationCommon::AvoidCircles(struct xEnt * entity /* r27 */, const class zMeshPosition * meshPosition /* r26 */, const class zMeshCircle & my_circle /* r28 */, const struct xVec2 & dir /* r29 */, struct xVec2 & newDir /* r30 */) {
    // Local variables
    struct xVec2 resultDir; // r1+0x9C
    struct xVec3 myPos3D; // r1+0xE0
    struct xVec2 myPos2D; // r1+0x94
    class zMeshCircle * threatCircle; // r31
    float threatCheckDist; // f28
    struct xVec2 threatPerpVec; // r1+0x8C
    struct xVec2 threatParalVec; // r1+0x84
    class zMeshCircle * nearbyCircles; // r3
    float minDist2; // f27
    class zMeshCircle * currentCircle; // r26
    struct xVec3 hisCenter; // r1+0xD4
    struct xVec2 targetPos; // r1+0x7C
    struct xVec2 toTarget; // r1+0x74
    float theDot; // f26
    struct xVec2 closestPt; // r1+0x6C
    struct xVec2 perpVec; // r1+0x64
    float checkLength; // f31
    float targetDist; // f1
    struct xVec3 myCenter; // r1+0xC8
    struct xVec3 tcenter; // r1+0xBC
    struct xVec2 pushVec2D; // r1+0x5C
    struct xVec2 pushDir2D; // r1+0x54
    float length; // f0
    float scale; // f26
    unsigned int threatClusterSize; // r1+0x20
    struct xVec3 myCenter; // r1+0xB0
    struct xVec3 pushDir3D; // r1+0xA4
...
// Range: 0x801F8A94 -> 0x801F8B24
unsigned char zMeshNavigationCommon::CombineTwoNormals(const struct xVec3 & n1 /* r3 */, const struct xVec3 & n2 /* r0 */, const struct xVec3 & orig /* r30 */, struct xVec3 & result /* r31 */) {
    // Local variables
    struct xVec3 cross; // r1+0x8
}

// Range: 0x801F8B24 -> 0x801F8BAC
unsigned char zMeshNavigationCommon::CheckNaiveResponseWorks(int stuckCollisions /* r27 */, struct SphereCollisionResults * sceneCollide /* r28 */, int depth /* r29 */, const struct xVec3 & naiveResponse /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x801F8BAC -> 0x801F8C78
unsigned char zMeshNavigationCommon::CheckCombinationResponseWorks(int stuckCollisions /* r26 */, struct SphereCollisionResults * sceneCollide /* r27 */, int depth /* r28 */, int partner_offset /* r29 */, const struct xVec3 & combinedResponse /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x801F8C78 -> 0x801F8CCC
...
// Range: 0x801F8CCC -> 0x801F8E34
void zMeshNavigationCommon::SweptSphereCollideComputeResponse(int stuckCollisions /* r26 */, struct SphereCollisionResults * sceneCollide /* r30 */, int depth /* r27 */, const struct xVec3 & currentDir /* r6 */, struct xVec3 & remainingDPos /* r31 */) {
    // Local variables
    struct xVec3 naiveResponse; // r1+0x14
...
// total size: 0x10
struct /* @class$1544zMeshNavigation_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$2293zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2252zMeshNavigation_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2253zMeshNavigation_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2254zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2251zMeshNavigation_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2256zMeshNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zMeshNavigation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zMeshNavigation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zMeshNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zMeshNavigation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1987zMeshNavigation_cpp */ {
    // Static members
...
// Range: 0x801F8E34 -> 0x801F8FF4
unsigned char zMeshNavigationCommon::FindShortestCollision(struct xEnt & ent /* r28 */, struct xSweptSphere & sws /* r29 */, int penby /* r30 */) {
    // Local variables
    unsigned char hit; // r31
    float lastHitDist; // f31
    unsigned char hitSomething; // r3
...
// Range: 0x801F8FF4 -> 0x801F9158
unsigned char zMeshNavigationCommon::FindShortestCollision(struct xEnt & ent /* r27 */, const struct xSphere & sphere /* r28 */, const struct xVec3 & initialDisp /* r29 */, const struct xVec3 & dir /* r30 */, float dist /* f31 */, struct SphereCollisionResults & results /* r31 */) {
    // Local variables
    struct xVec3 start; // r1+0x8
    struct xSweptSphere bestSweptSphere; // r1+0x14
    unsigned char penby; // r5
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043E8EC
// Range: 0x801F9158 -> 0x801F93D4
void zMeshNavigationCommon::SimpleSweptSphereCollide(struct xEnt & ent /* r28 */, const struct xSphere & sphere /* r29 */, const struct xVec3 & initialDisp /* r30 */, struct xVec3 & dpos /* r31 */) {
    // Local variables
    struct xVec3 validDPos; // r1+0x38
    struct xVec3 fullInitialDisp; // r1+0x2C
    struct xVec3 originalDesiredDir; // r1+0x20
    float remainingDist; // f27
    struct xVec3 currentDir; // r1+0x14
    float currentDist; // f26
    struct SphereCollisionResults sceneCollide[8]; // r1+0x44
    int stuckCollisions; // r26
    int depth; // r25
    struct xVec3 remainingDPos; // r1+0x8
