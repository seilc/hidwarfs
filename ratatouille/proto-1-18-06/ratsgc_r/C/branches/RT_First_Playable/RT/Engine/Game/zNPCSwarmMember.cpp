/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCSwarmMember.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028BB84 -> 0x8028BE34
*/
// total size: 0x1
...
static class zICompNPCEntityParams gSwarmBugEntParameters; // size: 0x30, address: 0x80BCC1C0
static class zICompNPCEntityParams gSwarmOwlEntParameters; // size: 0x30, address: 0x80BCC1F0
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05C18
// total size: 0x60
...
// total size: 0xC
struct /* @class$1047zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCSwarmMember_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCSwarmMember_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCSwarmMember_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCSwarmMember_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCSwarmMember_cpp */ {
    // Members
...
char __FUNCTION__$localstatic1$AttachComponent__63zComponentPool<21zCompLogicSwarmMember,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05C24
signed char zComponentPool<zCompLogicSwarmMember, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09468
// total size: 0x8
...
class zComponentPool zComponentPool<zCompLogicSwarmMember, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0946C
char __FUNCTION__$localstatic1$AttachComponent__66zComponentPool<21zCompSteeringFlocking,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05C34
signed char zComponentPool<zCompSteeringFlocking, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09478
// total size: 0x70
...
class zComponentPool zComponentPool<zCompSteeringFlocking, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0947C
// total size: 0x68
...
// total size: 0x4
struct /* @class$1219zNPCSwarmMember_cpp */ {
    // Members
...
union /* @class$1359zNPCSwarmMember_cpp */ {
...
// total size: 0xC
struct /* @class$1357zNPCSwarmMember_cpp */ {
    // Members
...
// Range: 0x8028BCD4 -> 0x8028BD50
// this: r30
void zNPCSwarmMember::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompLogic * logicComponent; // r0
}

// Range: 0x8028BD50 -> 0x8028BD90
// this: r31
...
// Range: 0x8028BD90 -> 0x8028BE34
// this: r30
void zNPCSwarmMember::Reset() {
    // Local variables
    struct zNPCAssetSwarm * npcassSwarm; // r31
...
// total size: 0x30
struct {} zNPCSwarmMember::__vtable; // size: 0x30, address: 0x80444A00
