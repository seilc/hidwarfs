/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFlameThrower.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801AD47C -> 0x801AFA48
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C027C0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801AD47C -> 0x801AD600
void zFlameThrowerWidget::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C027C8
class zLightweightSystem * zLightweight<flamethrower, 10>::GetSystem()::system; // size: 0x4, address: 0x80C08968
signed char zLightweight<flamethrower, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x80C0896C
char __FUNCTION__$localstatic1$Add__37zLightweightSystem<12flamethrower,10>FRC12flamethrower[4]; // size: 0x4, address: 0x80C027D0
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x24
struct {} zLightweightSystem<flamethrower, 10>::__vtable; // size: 0x24, address: 0x8043DA28
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C027D4
// Range: 0x801AD820 -> 0x801ADAC8
void zFlameThrowerWidget::EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
    class zFlameThrowerWidget & flameThrowerWidget; // r0
    class flamethrower * f; // r0
    class flamethrower ft; // r1+0x318
    class flamethrower * f; // r0
    class flamethrower ft; // r1+0x190
    class flamethrower * ft; // r0
    class flamethrower * ft; // r0
    class flamethrower * ft; // r0
    class flamethrower * f; // r0
    class flamethrower ft; // r1+0x8
...
static struct config flamethrower_config; // size: 0x44, address: 0x80BB66D0
static float length_modifier; // size: 0x4, address: 0x80C027DC
static float radius_modifier; // size: 0x4, address: 0x80C027E0
unsigned char draw_damage; // size: 0x1, address: 0x80C0896D
// Range: 0x801ADAC8 -> 0x801ADC0C
...
// total size: 0xC
struct /* @class$964zFlameThrower_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zFlameThrower_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zFlameThrower_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zFlameThrower_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zFlameThrower_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zFlameThrower_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zFlameThrower_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C027E4
// total size: 0x20
struct {} flamethrower::__vtable; // size: 0x20, address: 0x8043D9E8
// Range: 0x801ADC0C -> 0x801ADE60
// this: r31
flamethrower::flamethrower(const struct xVec3 & position /* r27 */, const struct xVec3 & direction /* r28 */, float length /* f28 */, float burst_time /* f29 */, const struct xColor_tag & color /* r29 */, int damage /* r30 */, float knockback /* f30 */, float damage_radius /* f31 */) {
    // Local variables
    struct collision_particle * end; // r0
    struct collision_particle * p; // r3
...
// total size: 0x20
struct {} zLightweight<flamethrower, 10>::__vtable; // size: 0x20, address: 0x8043DA08
// Range: 0x801ADE60 -> 0x801ADEA0
// this: r31
...
// total size: 0x4
struct /* @class$1350zFlameThrower_cpp */ {
    // Members
...
union /* @class$1015zFlameThrower_cpp */ {
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C027EC
// Range: 0x801AE044 -> 0x801AE434
// this: r25
void flamethrower::collision_emit(const struct xVec3 & position /* r26 */, const struct xVec3 & direction /* r27 */, const struct xVec3 & velocity /* r28 */, float dt /* f29 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C027FC
// Range: 0x801AE434 -> 0x801AE794
// this: r0
...
int NUM_ANIM_TEXTURES; // size: 0x4, address: 0x80C02810
int DO_COLLISION; // size: 0x4, address: 0x80C02814
// total size: 0x80
...
struct FlameThrowerCollisionInfo flameThrowerCollisionInfo; // size: 0x14, address: 0x80C08970
struct RwTexture * particleTex; // size: 0x4, address: 0x80C08984
enum FTParType {
    TYPE_A = 0,
    TYPE_B = 1,
};
...
// Range: 0x801AE794 -> 0x801AE7C8
void zFlameThrower::operator delete(void * mem /* r31 */) {
    // Local variables
    class zFlameThrowerMgr * mgr; // r0
}
...
// Range: 0x801AE81C -> 0x801AE8D4
// this: r30
void zFlameThrower::Update(float dt /* f31 */, struct xVec3 & velocity /* r31 */) {
    // References
    // -> int DO_COLLISION;
}

float FLAMETHROWER_FADE_DIST; // size: 0x4, address: 0x80C02818
float FLAMETHROWER_CULL_DIST; // size: 0x4, address: 0x80C0281C
// Range: 0x801AE8D4 -> 0x801AE9C4
// this: r31
...
// Range: 0x801AE9C4 -> 0x801AEA04
void zFlameThrower::RemoveTweaks(unsigned int number /* r4 */) {
    // Local variables
    char name[64]; // r1+0x8
}
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02820
// total size: 0xC
...
// total size: 0xC
struct /* @class$1488zFlameThrower_cpp */ {
    // Members
...
// Range: 0x801AEBEC -> 0x801AEC90
float zFlameThrower::get_collide_distance(const struct xVec3 & position /* r0 */, const struct xVec3 & direction /* r31 */) {
    // Local variables
    struct xRay3 ray; // r1+0x8
    struct xCollis collision_record; // r1+0x2C

    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02830
// Range: 0x801AEC90 -> 0x801AF53C
// this: r24
void zFlameThrower::UpdateParticles(float dt /* f28 */, struct xVec3 & velocity /* r25 */) {
    // Local variables
    struct xMat4x3 & mat; // r30
    float collide_distance; // f0
    unsigned char isActive; // r29
    int p; // r28
    struct FTParticle & particle; // r27
    float size; // f29
    unsigned char alpha; // r26
    float vel_length; // f0
    float life; // f1
    float diffTime; // f30
    struct FTParticle * particle; // r26
    struct FTParticle * end; // r27
    float t; // f31
...
// Range: 0x801AF634 -> 0x801AF6BC
void zFlameThrower::Collide(const struct xBound & bound /* r30 */) {
    // Local variables
    int i; // r31
...
// total size: 0x890
struct /* @class$2067zFlameThrower_cpp */ {
    // Static members
...
// Range: 0x801AF6BC -> 0x801AF754
unsigned char zFlameThrower::CollisionCB(struct xEnt & ent /* r31 */) {
    // Local variables
...
class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4, address: 0x80C08988
char __FUNCTION__$localstatic1$Get__16zFlameThrowerMgrFv[4]; // size: 0x4, address: 0x80C02840
// total size: 0xC
...
// Range: 0x801AF820 -> 0x801AF838
void zFlameThrowerMgr::Remove() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x801AF838 -> 0x801AF878
void zFlameThrowerMgr::Reset() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x801AF878 -> 0x801AF884
// this: r0
zFlameThrowerMgr::zFlameThrowerMgr() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C02844
// Range: 0x801AF884 -> 0x801AF960
// this: r30
...
// Range: 0x801AF960 -> 0x801AF98C
void zFlameThrowerMgr::Update(float dt /* f0 */) {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x801AF98C -> 0x801AFA38
// this: r0
void zFlameThrowerMgr::_Update(float dt /* f31 */) {
    // Local variables
...
// Range: 0x801AFA38 -> 0x801AFA40
// this: r3
unsigned char zFlameThrower::IsShutDown() {}

// Range: 0x801AFA40 -> 0x801AFA48
// this: r3
...
// total size: 0x10
struct /* @class$1028zFlameThrower_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
