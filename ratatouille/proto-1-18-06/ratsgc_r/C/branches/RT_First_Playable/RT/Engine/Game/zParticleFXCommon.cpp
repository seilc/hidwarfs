/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleFXCommon.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801DCBD8 -> 0x801DD224
*/
unsigned char EnergyPulseSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08C60
signed char EnergyPulseSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08C61
char __FUNCTION__$localstatic1$Register__17EnergyPulseSystemFv[9]; // size: 0x9, address: 0x80C032B0
char __FUNCTION__$localstatic1$Init__259zParticleSystemHelper<213zParticleUVStaticTile<3,3,183zParticleEmitterConeSurface<151zParticleColorWhiteFadeOut<120zParticleMoverLinearDecel<91zParticleRadiusConst<67zParticlePoolType<30ptank_pool__pos_color_size_uv2,13zParticleBase>>>>>>,17EnergyPulseSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C032BC
// total size: 0xC
class EnergyPulseSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class EnergyPulseSystem energy_pulse_system; // size: 0xC, address: 0x80C08C64
// total size: 0x1
struct EmitState {};
// total size: 0x4
...
unsigned char RubbleSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08C70
signed char RubbleSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08C71
char __FUNCTION__$localstatic1$Register__12RubbleSystemFv[9]; // size: 0x9, address: 0x80C032C4
char __FUNCTION__$localstatic1$Init__217zParticleSystemHelper<176zParticleEmitterConeSurface<144zParticleColorWhiteOpaque<114zParticleMoverGravity<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,12RubbleSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C032D0
// total size: 0xC
class RubbleSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class RubbleSystem rubble_system; // size: 0xC, address: 0x80C08C74
// total size: 0x8
struct EmitState : public EmitState {
    // Members
...
unsigned char FlameConeSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08C80
signed char FlameConeSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08C81
char __FUNCTION__$localstatic1$Register__15FlameConeSystemFv[9]; // size: 0x9, address: 0x80C032D8
char __FUNCTION__$localstatic1$Init__224zParticleSystemHelper<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15FlameConeSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C032E4
// total size: 0xC
class FlameConeSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class FlameConeSystem flame_cone_system; // size: 0xC, address: 0x80C08C84
// total size: 0x30
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x8, size 0xC
...
unsigned char SmokePuffSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08C90
signed char SmokePuffSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08C91
char __FUNCTION__$localstatic1$Register__15SmokePuffSystemFv[9]; // size: 0x9, address: 0x80C032EC
char __FUNCTION__$localstatic1$Init__224zParticleSystemHelper<180zParticleEmitterConeVolume<149zParticleColorToBlackFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,15SmokePuffSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C032F8
// total size: 0xC
class SmokePuffSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class SmokePuffSystem smoke_puff_system; // size: 0xC, address: 0x80C08C94
// total size: 0xC
class RegisterOnFirstEmitSystem : public zParticleSystemHelper {
    // Members
    unsigned char registered; // offset 0x4, size 0x1
...
unsigned char LavaDripSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08CA0
signed char LavaDripSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08CA1
char __FUNCTION__$localstatic1$Register__14LavaDripSystemFv[9]; // size: 0x9, address: 0x80C03300
char __FUNCTION__$localstatic1$Init__221zParticleSystemHelper<178zParticleEmitterConeVolume<147zParticleColorWhiteFadeOut<116zParticleMoverLinearVel<89zParticleRadiusPercent<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,14LavaDripSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C0330C
// total size: 0xC
class LavaDripSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class LavaDripSystem lava_drip_system; // size: 0xC, address: 0x80C08CA4
// total size: 0x40
struct EmitState : public EmitState {
    // Members
...
unsigned char SparkSystem::Register()::already_asserted; // size: 0x1, address: 0x80C08CB0
signed char SparkSystem::Register()::localstatic4 guard; // size: 0x1, address: 0x80C08CB1
char __FUNCTION__$localstatic1$Register__11SparkSystemFv[9]; // size: 0x9, address: 0x80C03314
char __FUNCTION__$localstatic1$Init__214zParticleSystemHelper<174zParticleEmitterConeVolume<143zParticleColorWhiteFadeOut<112zParticleMoverGravity<87zParticleRadiusConst<63zParticlePoolType<26ptank_pool__pos_color_size,13zParticleBase>>>>>,11SparkSystem>FR20xParticleBatchSystemPCci[5]; // size: 0x5, address: 0x80C03320
// total size: 0xC
class SparkSystem : public RegisterOnFirstEmitSystem {
    // Functions
    void Register();
};
static class SparkSystem spark_system; // size: 0xC, address: 0x80C08CB4
// total size: 0x4
struct EmitState : public EmitState {
    // Members
    float radius; // offset 0x0, size 0x4
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleUVStaticTile<3, 3, zParticleEmitterConeSurface<zParticleColorWhiteFadeOut<zParticleMoverLinearDecel<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size_uv2, zParticleBase>>>>>>, EnergyPulseSystem>::__vtable; // size: 0xC, address: 0x80C03328
// total size: 0xC
struct {} EnergyPulseSystem::__vtable; // size: 0xC, address: 0x80C03334
// Range: 0x801DCCB4 -> 0x801DCD9C
// this: r30
...
// total size: 0x4
struct /* @class$1350zParticleFXCommon_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1488zParticleFXCommon_cpp */ {
    // Members
...
union /* @class$1015zParticleFXCommon_cpp */ {
...
// total size: 0x10
struct /* @class$1028zParticleFXCommon_cpp */ {
    // Members
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeSurface<zParticleColorWhiteOpaque<zParticleMoverGravity<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, RubbleSystem>::__vtable; // size: 0xC, address: 0x80C03340
// total size: 0xC
struct {} RubbleSystem::__vtable; // size: 0xC, address: 0x80C0334C
// Range: 0x801DCD9C -> 0x801DCE84
// this: r30
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, FlameConeSystem>::__vtable; // size: 0xC, address: 0x80C03358
// total size: 0xC
struct {} FlameConeSystem::__vtable; // size: 0xC, address: 0x80C03364
// Range: 0x801DCE84 -> 0x801DCF6C
// this: r30
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SmokePuffSystem>::__vtable; // size: 0xC, address: 0x80C03370
// total size: 0xC
struct {} SmokePuffSystem::__vtable; // size: 0xC, address: 0x80C0337C
// Range: 0x801DCF6C -> 0x801DD054
// this: r30
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, LavaDripSystem>::__vtable; // size: 0xC, address: 0x80C03388
// total size: 0xC
struct {} LavaDripSystem::__vtable; // size: 0xC, address: 0x80C03394
// Range: 0x801DD054 -> 0x801DD13C
// this: r30
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverGravity<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SparkSystem>::__vtable; // size: 0xC, address: 0x80C033A0
// total size: 0xC
struct {} SparkSystem::__vtable; // size: 0xC, address: 0x80C033AC
// Range: 0x801DD13C -> 0x801DD224
// this: r30
