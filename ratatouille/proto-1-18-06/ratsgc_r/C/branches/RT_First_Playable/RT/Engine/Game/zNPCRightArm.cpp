/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCRightArm.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A4840 -> 0x802A49C4
*/
char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicRightArm,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06258
signed char zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09600
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C09604
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// total size: 0x68
class zNPCRightArm : public zNPCBase {
    // Functions
...
// Range: 0x802A4840 -> 0x802A48BC
// this: r31
unsigned char zNPCRightArm::Activate() {}
...
// Range: 0x802A48BC -> 0x802A4984
// this: r28
void zNPCRightArm::Update(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1173zNPCRightArm_cpp */ {
    // Members
...
union /* @class$1313zNPCRightArm_cpp */ {
...
// total size: 0xC
struct /* @class$1311zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCRightArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1050zNPCRightArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1051zNPCRightArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1052zNPCRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1053zNPCRightArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1054zNPCRightArm_cpp */ {
    // Members
...
// Range: 0x802A4984 -> 0x802A49C4
// this: r31
void zNPCRightArm::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zNPCRightArm::__vtable; // size: 0x30, address: 0x80447878
