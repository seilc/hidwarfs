/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollideSweptSphere.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80196168 -> 0x801999C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSweptSphereGlobals sSwsGlobal; // size: 0x8, address: 0x80C08888
// Range: 0x80196168 -> 0x801961D0
...
// Range: 0x801961D0 -> 0x801961DC
void xSweptSphereDetectInitialPenetration(struct xSweptSphere & sws /* r0 */) {}
...
// Range: 0x801961DC -> 0x80196300
void xSweptSpherePrepare(struct xSweptSphere & sws /* r29 */, const struct xVec3 & start /* r30 */, const struct xVec3 & dir /* r31 */, float dist /* f30 */, float radius /* f31 */, unsigned int filterFlags /* r0 */) {
    // Local variables
    struct xCapsule tmpC; // r1+0x8
}
...
// Range: 0x80196300 -> 0x8019640C
void xSweptSpherePrepare(struct xSweptSphere * sws /* r29 */, const struct xVec3 * start /* r30 */, const struct xVec3 * end /* r31 */, float radius /* f31 */, unsigned int filterFlags /* r0 */) {
    // Local variables
    struct xCapsule tmpC; // r1+0x8
}

// Range: 0x8019640C -> 0x80196430
void xSweptSphereResetCollision(struct xSweptSphere * sws /* r0 */) {}

// Range: 0x80196430 -> 0x80196580
...
// Range: 0x80196580 -> 0x80196640
static int SweptSphereLeafNodeCB(struct xClumpCollBSPTriangle * triangles /* r29 */, void * data /* r4 */) {
    // Local variables
    struct xSweptSphere * sws; // r30
    struct xCollideSphereToPolygonResults tri_collide; // r1+0x18
...
// Range: 0x80196640 -> 0x80196708
unsigned char TestSingleEnvTri(struct xSweptSphere * sws /* r26 */, struct xClumpCollBSPTriangle * triangle /* r29 */, struct xCollideSphereToPolygonResults & tri_collide /* r27 */, class xPlane & surface /* r28 */) {
    // Local variables
    struct xVec3 * p0; // r31
    struct xVec3 * p1; // r30
    struct xVec3 * p2; // r29
    struct xBox tri_box; // r1+0x8
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C022F0
...
// total size: 0xC
struct /* @class$1235xCollideSweptSphere_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1088xCollideSweptSphere_cpp */ {
    // Members
...
union /* @class$1236xCollideSweptSphere_cpp */ {
...
// Range: 0x80196708 -> 0x80196B00
int xSweptSphereToEnv(struct xSweptSphere * sws /* r27 */, struct xEnv * env /* r28 */) {
    // Local variables
    ...
    int i; // r29
    float testdist; // f31
    struct xSweptSphere newsws; // r1+0x9C
    float testdist; // f31
...
// Range: 0x80196E48 -> 0x80196EC4
static void xSweptSphereFillFromCollision(struct xSweptSphere * sws /* r30 */, const struct xCollis * coll /* r31 */) {}
...
// Range: 0x80196EC4 -> 0x8019703C
static int SweptSphereModelCB(int numTriangles /* r23 */, int triOffset /* r4 */, void * data /* r24 */) {
    // Local variables
    struct SweptSphereCollParam * isData; // r0
    struct RpGeometry * geometry; // r6
    struct xSweptSphere * sws; // r29
    struct RwV3d * vertices; // r28
    struct RpTriangle * triangles; // r27
    int triSlot; // r26
    unsigned short * triIndex; // r25
    struct RpTriangle * tri; // r6
    struct RwV3d * v0; // r22
    struct RwV3d * v1; // r21
    struct RwV3d * v2; // r20
    struct xBox tri_box; // r1+0x1C
    struct xCollideSphereToPolygonResults tri_collide; // r1+0x8
...
// Range: 0x8019703C -> 0x801976AC
void RpCollTreeForAllCapsuleIntsec(struct RpCollTree * tree /* r0 */, struct RwLine * line /* r28 */, float radius /* f29 */, int (* callBack)(int, int, void *) /* r26 */, void * data /* r27 */) {
    // Local variables
    struct RpCollSectorCapsuleIt it; // r1+0x8
    float pa; // f31
    float pb; // f30
    int result; // r0
    float recip; // f3
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02304
// total size: 0x4
...
// Range: 0x801976AC -> 0x80197BB4
int xSweptSphereToModel(struct xSweptSphere * sws /* r24 */, struct RpAtomic * model /* r27 */, const struct RwMatrixTag * mat /* r26 */, unsigned char singleSided /* r25 */) {
    // Local variables
    struct xVec3 old_start; // r1+0x40
    struct xVec3 old_end; // r1+0x34
    struct xVec3 old_dir; // r1+0x28
    float old_radius; // f30
    struct xBox old_box; // r1+0x78
    float old_dist; // f0
    float model_scale; // f0
    float old_curdist; // f29
...
// Range: 0x80197BB4 -> 0x80197D24
static unsigned char GrossCullTri(struct xSweptSphere * sws /* r0 */, struct xVec3 * v0 /* r0 */, struct xVec3 * v1 /* r0 */, struct xVec3 * v2 /* r0 */) {}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02318
// Range: 0x80197D24 -> 0x80198160
int xSweptSphereToSphere(struct xSweptSphere & sws /* r30 */, const struct xVec3 & center /* r31 */, float radius /* f31 */) {
    // Local variables
    struct xVec3 center_to_center; // r1+0x20
    float dist_along; // f0
    struct xVec3 along; // r1+0x14
    struct xVec3 out; // r1+0x8
    float out_dist_squ; // f0
    float combined_raidus; // f28
    float combined_radius_squ; // f2
    float stop_dist; // f0
    float dist_to_collide; // f1
    float dist_between; // f0
    float ratio; // f28
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02330
// total size: 0x24
struct xBBox {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
...
// Range: 0x80198160 -> 0x8019821C
int xSweptSphereToBound(struct xSweptSphere * sws /* r0 */, const struct xBound * bound /* r4 */) {
    // References
    // -> static char __FUNCTION__[20];
}

static int sSweptSphereEntFound; // size: 0x4, address: 0x80C08890
// total size: 0x20
struct xLinkAsset {
    // Members
...
static const struct xEnt * sSweptSphereMover; // size: 0x4, address: 0x80C08894
static unsigned char sSweptSphereCollType; // size: 0x1, address: 0x80C08898
static int sSweptSpherePenby; // size: 0x4, address: 0x80C0889C
static unsigned int sSweptSphereIgnoreMovers; // size: 0x4, address: 0x80C088A0
static unsigned char sSweptSphereNPCIgnoreGoo; // size: 0x1, address: 0x80C088A4
// Range: 0x8019821C -> 0x801983AC
static void SweptSphereHitsEntCB(struct xRay3 * ray /* r29 */, struct xQCData * qcd /* r5 */, struct xEnt * ent /* r30 */, void * data /* r7 */) {
    // Local variables
    struct xSweptSphere * sws; // r31
    struct xMat4x3 * m1; // r0
    struct xMat4x3 * m2; // r3
...
// Range: 0x801983AC -> 0x8019856C
static void NPCSweptSphereHitsEntCB(struct xRay3 * ray /* r29 */, struct xQCData * qcd /* r28 */, struct xEnt * ent /* r30 */, void * data /* r7 */) {
    // Local variables
    struct xSweptSphere * sws; // r31
    int goo; // r0
    struct xMat4x3 * m1; // r0
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C088A5
static signed char init; // size: 0x1, address: 0x80C088A6
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C02344
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8019856C -> 0x80198A24
int xSweptSphereToEnt(struct xSweptSphere * sws /* r29 */, struct xEnt * ent /* r30 */, struct xRay3 * ray /* r28 */) {
    // Local variables
    struct xSweptSphere sweptSphere; // r1+0x94
    unsigned int result; // r27
    float oldrad; // f31
    struct xBox tmpbox; // r1+0x28
    struct xBox tmpbox; // r1+0x10
    struct xRay3 lr; // r1+0x70
    struct xMat3x3 mn; // r1+0x40
    float ms; // f0
...
// Range: 0x80198A24 -> 0x80198A78
static unsigned char sphereToEntResults(struct xSweptSphere * sws /* r0 */, struct xEnt * ent /* r4 */, unsigned char react /* r0 */) {}

static unsigned char already_asserted; // size: 0x1, address: 0x80C088A7
static signed char init; // size: 0x1, address: 0x80C088A8
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02358
// Range: 0x80198A78 -> 0x80198F5C
int xNPCSweptSphereToEnt(struct xSweptSphere * sws /* r29 */, struct xEnt * ent /* r30 */, struct xRay3 * ray /* r28 */) {
    // Local variables
    int goo; // r0
    struct xSweptSphere sweptSphere; // r1+0x94
    unsigned int result; // r27
...
// Range: 0x80198F5C -> 0x801990DC
int xSweptSphereToScene(struct xSweptSphere * sws /* r29 */, struct xScene * sc /* r30 */, const struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int envcollfound; // r0
...
// Range: 0x801990DC -> 0x801992C4
int xSweptSphereToNonMoving(struct xSweptSphere * sws /* r29 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int envcollfound; // r31
...
// Range: 0x801992C4 -> 0x80199420
int xSweptSphereToStatDyn(struct xSweptSphere * sws /* r29 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    struct xRay3 ray; // r1+0x8
...
// Range: 0x80199420 -> 0x80199580
int xNPCSweptSphereToStatDyn(struct xSweptSphere * sws /* r29 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */, unsigned char ignoreGoo /* r0 */) {
    // Local variables
    struct xRay3 ray; // r1+0x8
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02370
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1484xCollideSweptSphere_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80199580 -> 0x801996FC
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r29 */, struct xEnt * mover /* r30 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int i; // r31
    struct xSphere * extra_spheres[10]; // r1+0x8
    int numSpheres; // r0
    int j; // r26
...
// total size: 0x890
struct /* @class$1946xCollideSweptSphere_cpp */ {
    // Static members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02388
// Range: 0x801996FC -> 0x80199888
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r29 */, struct xEnt * mover /* r25 */, struct zPlayer * * player /* r30 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int i; // r31
    struct xSphere * extra_spheres[10]; // r1+0x8
    int numSpheres; // r0
...
// Range: 0x80199888 -> 0x801999C0
int xSweptSphereToNPC(struct xSweptSphere * sws /* r29 */, struct xScene * sc /* r30 */, struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    struct xRay3 ray; // r1+0x8
