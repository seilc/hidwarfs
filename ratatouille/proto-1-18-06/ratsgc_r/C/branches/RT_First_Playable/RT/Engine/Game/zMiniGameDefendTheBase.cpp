/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameDefendTheBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80293E48 -> 0x80295480
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zMiniGameDefendTheBaseEnemy sEnemies[50]; // size: 0x15E0, address: 0x80BD0630
static class zMiniGameDefendTheBaseEnemy * sEnemyPool; // size: 0x4, address: 0x80C05DC8
static float DAMAGE_BASE_TIME; // size: 0x4, address: 0x80C05DCC
static unsigned int ENEMY_MODEL_ID; // size: 0x4, address: 0x80C094D8
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x80C094DC
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x80C094E0
static unsigned int WAVE_BOX_ID; // size: 0x4, address: 0x80C094E4
static unsigned int WAVE_DONE_BOX_ID; // size: 0x4, address: 0x80C094E8
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x80C094EC
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x80C094F0
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x80C094F4
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x80C094F8
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x80C094FC
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C05DD0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1275zMiniGameDefendTheBase_cpp */ {
    // Members
...
union /* @class$1276zMiniGameDefendTheBase_cpp */ {
...
// total size: 0x10
struct /* @class$1524zMiniGameDefendTheBase_cpp */ {
    // Members
...
// Range: 0x80293E48 -> 0x8029402C
// this: r29
void zMiniGameDefendTheBaseEnemy::Spawn(struct pointer_asset * pointer /* r30 */, float speed /* f31 */, int pIdx /* r31 */) {
    // Local variables
    struct RpAtomic * data; // r28
    struct xVec3 target; // r1+0x14
    struct xVec3 toTgt; // r1+0x8
    float angleDiff; // f0
...
// total size: 0x890
struct /* @class$1986zMiniGameDefendTheBase_cpp */ {
    // Static members
...
// Range: 0x8029426C -> 0x802942A4
// this: r0
float zMiniGameDefendTheBaseEnemy::GetRadius() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05DD8
// Range: 0x802942A4 -> 0x80294300
// this: r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05DE0
...
// Range: 0x80294300 -> 0x80294450
// this: r28
void Wave::Init(struct zMiniGameAssetDefendTheBaseWave * a /* r0 */, int pc /* r0 */) {
    // Local variables
    unsigned int spawnGroupIDTable[4]; // r1+0x8
    int j; // r29
...
// Range: 0x80294450 -> 0x802944DC
// this: r28
class zMiniGameObject * Wave::Spawn(struct pointer_asset * * pointers /* r29 */, int count /* r0 */, int playerIdx /* r30 */) {
    // Local variables
    int index; // r0
...
void Wave::Start() {
    ...
    int i; // r29
    int j; // r28
    class zMiniGameDefendTheBaseEnemy * obj; // r0
    int k; // r28
}

// Range: 0x802945C0 -> 0x80294778
// this: r31
void Wave::Update(float dt /* f30 */) {
    // Local variables
    int i; // r29
    int numToSpawn; // r28
    int j; // r27
    class zMiniGameDefendTheBaseEnemy * enm; // r0
    class zMiniGameDefendTheBaseEnemy * curr; // r27
    class zMiniGameDefendTheBaseEnemy * prev; // r28
    class zMiniGameDefendTheBaseEnemy * next; // r29
...
// total size: 0x4
struct /* @class$1128zMiniGameDefendTheBase_cpp */ {
    // Members
...
// Range: 0x8029480C -> 0x802948AC
// this: r29
void Wave::ForceDone() {
    // Local variables
    class zMiniGameDefendTheBaseEnemy * obj; // r31
    class zMiniGameDefendTheBaseEnemy * nextObj; // r30
    int i; // r5
...
// total size: 0x7C
struct {} zMiniGameDefendTheBase::__vtable; // size: 0x7C, address: 0x80446FF0
// total size: 0x1
struct /* @class$2017zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2019zMiniGameDefendTheBase_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$2020zMiniGameDefendTheBase_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$2021zMiniGameDefendTheBase_cpp */ {
    // Members
...
enum /* @enum$2022zMiniGameDefendTheBase_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$2023zMiniGameDefendTheBase_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$2024zMiniGameDefendTheBase_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$2026zMiniGameDefendTheBase_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$2014zMiniGameDefendTheBase_cpp */ {
    // Members
...
// Range: 0x802948AC -> 0x802948F0
// this: r31
zMiniGameDefendTheBase::zMiniGameDefendTheBase(struct zMiniGameAsset * a /* r0 */) {
    // References
    // -> struct [anonymous] zMiniGameDefendTheBase::__vtable;
}

// Range: 0x802948F0 -> 0x80294998
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05DE8
// Range: 0x80294998 -> 0x80294CF0
void zMiniGameDefendTheBase::Init(struct xBase & data /* r28 */, struct xDynAsset & asset /* r29 */, unsigned long asset_size /* r30 */) {
    // Local variables
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05DF0
// Range: 0x80294CF0 -> 0x80294E58
// this: r31
void zMiniGameDefendTheBase::InitWaves() {
    // Local variables
    struct zMiniGameAssetDefendTheBase * a; // r0
    unsigned int waveID; // r30
    class Wave * curr; // r29
    struct zMiniGameAssetDefendTheBaseWave * waveAsset; // r28
    class Wave * newWave; // r30
...
// Range: 0x80294F74 -> 0x80294F9C
// this: r0
void zMiniGameDefendTheBase::EndGame() {}

static char statsBuf[4][128]; // size: 0x200, address: 0x80BD1C10
static char waveBuf[32]; // size: 0x20, address: 0x80BD1E10
// Range: 0x80294F9C -> 0x80295228
// this: r31
...
// Range: 0x80295228 -> 0x80295338
// this: r29
void zMiniGameDefendTheBase::SetWinLoseDisplay() {
    // Local variables
    int i; // r30
    unsigned int texID; // r4
...
// Range: 0x802953E8 -> 0x8029547C
// this: r27
int zMiniGameDefendTheBase::WhichPlayerBase(unsigned int id /* r28 */) {
    // Local variables
    int i; // r30
    unsigned int j; // r29
}

// Range: 0x8029547C -> 0x80295480
void zMiniGameDefendTheBase::AddTweaks() {}

// total size: 0x1C
struct {} zMiniGameObject::__vtable; // size: 0x1C, address: 0x8044706C
// total size: 0x1C
struct {} zMiniGameDefendTheBaseEnemy::__vtable; // size: 0x1C, address: 0x80447088
