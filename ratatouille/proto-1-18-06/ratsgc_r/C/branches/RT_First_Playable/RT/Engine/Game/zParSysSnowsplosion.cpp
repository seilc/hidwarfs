/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParSysSnowsplosion.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80217CC4 -> 0x80218488
*/
static int systemID; // size: 0x4, address: 0x80C041D8
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C041DC
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$1088zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1226zParSysSnowsplosion_cpp */ {
    // Members
...
union /* @class$1227zParSysSnowsplosion_cpp */ {
...
// total size: 0x10
struct /* @class$1500zParSysSnowsplosion_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80217CC4 -> 0x80217E68
static int ParticleUpdate(unsigned char * mem /* r31 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f30 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1029zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zParSysSnowsplosion_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zParSysSnowsplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zParSysSnowsplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zParSysSnowsplosion_cpp */ {
    // Members
...
// Range: 0x80218228 -> 0x802182F0
void zParSysSnowsplosionEmit(const struct xVec3 & pos /* r27 */, const struct zParSysSnowsplosionConfig & config /* r28 */) {
    // Local variables
    int emitCount; // r0
...
// Range: 0x802182F0 -> 0x80218488
// this: r30
static void Particle::Setup(const struct xVec3 & position /* r0 */, const struct zParSysSnowsplosionConfig & cfg /* r31 */) {
    // Local variables
    float theta; // f29
    float phi; // f0
