/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleSystemWaterfall.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801CD900 -> 0x801D07BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801CD900 -> 0x801CD974
// this: r29
struct zParticleGenerator * zParticleSystemWaterfall::create_generator(struct zParticleAsset & asset /* r30 */) {}

// Range: 0x801CD9C0 -> 0x801CD9E4
// this: r3
void zParticleSystemWaterfall::scene_enter() {}

// Range: 0x801CD9E4 -> 0x801CDA04
// this: r0
void zParticleSystemWaterfall::update(float dt /* f0 */) {}
...
// total size: 0x10
struct /* @class$1036zParticleSystemWaterfall_cpp */ {
    // Members
...
// Range: 0x801CDA0C -> 0x801CDC10
int zParticleSystemWaterfall::update_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
    struct xColor_tag * pool_color; // r28
    struct xVec2 * pool_size; // r27
    struct particle_instance * p; // r26
    struct particle_instance * end; // r25
    struct xVec4 v; // r1+0x18
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C03050
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// total size: 0xC
struct /* @class$1766zParticleSystemWaterfall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// Range: 0x801CDC10 -> 0x801CE078
// this: r30
void zParticleGeneratorWaterfall::update(float dt /* f14 */) {
    // Local variables
    int emit; // r31
    const struct asset_data & a; // r0
    const struct xMat4x3 & mat; // r29
    struct xVec3 vel_dir; // r1+0xC
    float width_min; // f0
    float width_delta; // f14
    float vel_min; // f0
    float vel_delta; // f27
    float vel_dir_vary; // f26
    float intensity_min; // f25
    float intensity_delta; // f24
    float red; // f23
    float green; // f22
    float blue; // f21
    ...
    float gravity; // f20
    float ymin; // f19
    float height_start_min; // f0
    float height_start_delta; // f18
    float height_vel; // f17
    float height_accel; // f16
    float height_max; // f15
    unsigned char * mem; // r1+0x8
    int have; // r28
    struct particle_instance * p; // r26
    struct particle_instance * endp; // r25
    float intensity; // f0
...
// Range: 0x801CE078 -> 0x801CE204
// this: r29
void zParticleGeneratorWaterfall::create(class zParticleSystemWaterfall & system /* r30 */, struct zParticleAsset & asset /* r31 */) {
    // Local variables
...
static struct tweak_callback cb_vel_dir; // size: 0x28, address: 0x803EB908
struct tweak_callback cb_tweak_convert_degrees; // size: 0x28, address: 0x803A9AF0
// Range: 0x801CE338 -> 0x801CE758
// this: r30
...
enum /* @enum$1765zParticleSystemWaterfall_cpp */ {
    FLAG_TRANSFORM_VELOCITY = 1,
};
struct xColor_tag g_PIMP_GOLD; // size: 0x4, address: 0x80C0A2B4
// Range: 0x801CE758 -> 0x801CE884
// this: r30
void zParticleGeneratorWaterfall::debug_render(unsigned char all /* r31 */) {
    // Local variables
    struct asset_data & a; // r0
...
// Range: 0x801CE884 -> 0x801CE93C
void zParticleGeneratorWaterfall::on_change_vel_dir(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zParticleGeneratorWaterfall & owner; // r31
    struct asset_data & a; // r0
    float yaw; // f30
    float pitch; // f28
    float sy; // f0
...
static float alpha_coeff1; // size: 0x4, address: 0x80C03058
static float alpha_coeff2; // size: 0x4, address: 0x80C0305C
static float alpha_coeff3; // size: 0x4, address: 0x80C03060
static float fade_in_time; // size: 0x4, address: 0x80C03064
static float fade_out_time; // size: 0x4, address: 0x80C03068
// Range: 0x801CE9A0 -> 0x801CEA18
static void on_change_fade(const struct tweak_info & info /* r0 */) {
    // References
...
static struct tweak_callback cb_fade; // size: 0x28, address: 0x803EB930
// Range: 0x801CEA18 -> 0x801CEB34
...
// Range: 0x801CEB34 -> 0x801CEBA8
// this: r29
struct zParticleGenerator * zParticleSystemWaterfallMist::create_generator(struct zParticleAsset & asset /* r30 */) {}

// Range: 0x801CEBE4 -> 0x801CEC08
// this: r3
void zParticleSystemWaterfallMist::scene_enter() {}

// Range: 0x801CEC08 -> 0x801CEC28
// this: r0
void zParticleSystemWaterfallMist::update(float dt /* f0 */) {}

// Range: 0x801CEC28 -> 0x801CEC30
int zParticleSystemWaterfallMist::get_asset_size() {}

// Range: 0x801CEC30 -> 0x801CEC54
void zParticleSystemWaterfallMist::add_tweaks(const char * prefix /* r4 */) {}
...
// Range: 0x801CEC54 -> 0x801CEEF4
int zParticleSystemWaterfallMist::update_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */) {
    // Local variables
...
// Range: 0x801CEEF4 -> 0x801CF3E8
// this: r31
void zParticleGeneratorWaterfallMist::update(float dt /* f14 */) {
    // Local variables
    int emit; // r29
    const struct asset_data & a; // r0
    float life_min; // f28
    float life_delta; // r1+0x70
    float size_birth; // r1+0x6C
    float size_death; // r1+0x68
    float size_vary; // r1+0x64
    float intensity_min; // f27
    float intensity_delta; // r1+0x60
    float red; // r1+0x5C
    float green; // r1+0x58
    float blue; // f26
    unsigned char alpha; // r28
    float rot_vel_min; // f25
    float rot_vel_delta; // f24
    float vel_min; // f23
    float vel_delta; // f22
    float vel_pitch_delta; // f21
...
// Range: 0x801CF3E8 -> 0x801CF4E8
// this: r30
void zParticleGeneratorWaterfallMist::create(class zParticleSystemWaterfallMist & system /* r31 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x801CF4E8 -> 0x801CF548
// this: r31
void zParticleGeneratorWaterfallMist::reset() {}

// Range: 0x801CF548 -> 0x801CF588
// this: r31
void zParticleGeneratorWaterfallMist::activate() {}

// Range: 0x801CF588 -> 0x801CF5C0
// this: r31
void zParticleGeneratorWaterfallMist::deactivate() {}

// Range: 0x801CF5C0 -> 0x801CF61C
// this: r31
...
// Range: 0x801CF920 -> 0x801CF978
// this: r30
void zParticleGeneratorWaterfallMist::debug_render(unsigned char all /* r31 */) {}
...
// Range: 0x801CF978 -> 0x801CF9EC
// this: r29
struct zParticleGenerator * zParticleSystemWaterfallSplash::create_generator(struct zParticleAsset & asset /* r30 */) {}

// Range: 0x801CFA28 -> 0x801CFA4C
// this: r3
void zParticleSystemWaterfallSplash::scene_enter() {}

// Range: 0x801CFA4C -> 0x801CFA6C
// this: r0
void zParticleSystemWaterfallSplash::update(float dt /* f0 */) {}

// Range: 0x801CFA6C -> 0x801CFA74
...
// Range: 0x801CFA74 -> 0x801CFCA4
int zParticleSystemWaterfallSplash::update_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r31
    struct particle_instance * p; // r30
    struct particle_instance * end; // r29
...
// Range: 0x801CFD18 -> 0x801D0200
// this: r31
void zParticleGeneratorWaterfallSplash::update(float dt /* f14 */) {
    // Local variables
    int emit; // r29
    const struct asset_data & a; // r0
    const struct xMat4x3 & mat; // r0
    float life_min; // f27
    float life_delta; // r1+0x7C
    float size_birth; // r1+0x78
    float size_death; // r1+0x74
    float size_vary; // r1+0x70
    float ay; // r1+0x6C
    float ymin; // r1+0x68
    float intensity_min; // f26
    float intensity_delta; // r1+0x64
    float red; // r1+0x60
    float green; // f25
    float blue; // f24
    unsigned char alpha; // r28
...
// Range: 0x801D0200 -> 0x801D0300
// this: r30
void zParticleGeneratorWaterfallSplash::create(class zParticleSystemWaterfallSplash & system /* r31 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x801D0300 -> 0x801D0360
// this: r31
void zParticleGeneratorWaterfallSplash::reset() {}

// Range: 0x801D0360 -> 0x801D03A0
// this: r31
void zParticleGeneratorWaterfallSplash::activate() {}

// Range: 0x801D03A0 -> 0x801D03D8
// this: r31
void zParticleGeneratorWaterfallSplash::deactivate() {}

// Range: 0x801D03D8 -> 0x801D0434
// this: r31
...
// Range: 0x801D0764 -> 0x801D07BC
// this: r30
void zParticleGeneratorWaterfallSplash::debug_render(unsigned char all /* r31 */) {}

// total size: 0x2C
struct {} zParticleGeneratorWaterfallSplash::__vtable; // size: 0x2C, address: 0x8043E1F8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1760zParticleSystemWaterfall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$972zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$973zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$975zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$976zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$977zParticleSystemWaterfall_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$978zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1358zParticleSystemWaterfall_cpp */ {
    // Members
...
union /* @class$1023zParticleSystemWaterfall_cpp */ {
...
// total size: 0xC
struct /* @class$1496zParticleSystemWaterfall_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemWaterfallSplash::__vtable; // size: 0x3C, address: 0x8043E224
// total size: 0x8
...
// total size: 0x2C
struct {} zParticleGeneratorWaterfallMist::__vtable; // size: 0x2C, address: 0x8043E260
// total size: 0x3C
struct {} zParticleSystemWaterfallMist::__vtable; // size: 0x3C, address: 0x8043E28C
// total size: 0x2C
struct {} zParticleGeneratorWaterfall::__vtable; // size: 0x2C, address: 0x8043E2C8
// total size: 0x3C
struct {} zParticleSystemWaterfall::__vtable; // size: 0x3C, address: 0x8043E2F4
