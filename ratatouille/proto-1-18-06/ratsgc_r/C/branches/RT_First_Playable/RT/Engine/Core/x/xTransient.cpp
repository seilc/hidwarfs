/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xTransient.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800CFE5C -> 0x800CFF0C
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x800CFE5C -> 0x800CFEB4
void scene_enter(const struct xBox & world_box /* r3 */) {
    // References
    // -> class xSpacePartitionTree2D space_tree;
}

// Range: 0x800CFEB4 -> 0x800CFEB8
void scene_exit() {}

// Range: 0x800CFEB8 -> 0x800CFEE0
void reset() {
    // References
    // -> class xSpacePartitionTree2D space_tree;
}

// Range: 0x800CFEE0 -> 0x800CFF08
void debug_update(float dt /* f0 */) {
    // References
    // -> class xSpacePartitionTree2D space_tree;
}

// Range: 0x800CFF08 -> 0x800CFF0C
void debug_render() {}
