/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamSpline.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80244BE4 -> 0x802456C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char yawCorrection; // size: 0x1, address: 0x80C09168
// total size: 0x270
...
// Range: 0x80244BE4 -> 0x80244C18
// this: r31
void zCamSpline::create() {}

// Range: 0x80244C18 -> 0x80244C50
// this: r31
void zCamSpline::stop() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C04BB0
float cDefaultCameraSpring; // size: 0x4, address: 0x80C0E190
...
// total size: 0x890
struct /* @class$2110zCamSpline_cpp */ {
    // Static members
...
// Range: 0x80244C50 -> 0x80244EA0
// this: r30
void zCamSpline::start() {
    // Local variables
    const struct BeadInfo & bead; // r0
...
// total size: 0xC
struct /* @class$989zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$990zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$991zCamSpline_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$992zCamSpline_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$993zCamSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$994zCamSpline_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$995zCamSpline_cpp */ {
    // Members
...
// Range: 0x80244EA0 -> 0x80244EA4
void zCamSpline::pre_update() {}

// Range: 0x80244EA4 -> 0x80244EA8
void zCamSpline::post_update() {}

// Range: 0x80244EA8 -> 0x80244EF4
// this: r31
void zCamSpline::UpdateFloorMount(float dt /* f31 */) {}

static struct xVec3 lastProjectedMidpoint; // size: 0xC, address: 0x80C0916C
// Range: 0x80244EF4 -> 0x80244F38
static void GetPlayersProjectedMidpoint(struct xVec3 & midpoint /* r31 */) {
    // References
    // -> static struct xVec3 lastProjectedMidpoint;
}

// Range: 0x80244F38 -> 0x80244F80
static float CalcYawToPlayers(const struct xVec3 & fromPos /* r31 */) {
    // Local variables
    const struct xVec3 & target; // r0
}

// Range: 0x80244F80 -> 0x80245014
// this: r30
void zCamSpline::CalcPitchGoal(const struct xVec3 & fromPos /* r31 */) {
    // Local variables
    struct xVec3 target; // r1+0x14
    struct xVec3 toTarget; // r1+0x8
    float distanceToTarget; // f0
}

// total size: 0x18
class xSpringyAngle : public xSpringyF32 {};
// Range: 0x80245014 -> 0x80245064
// this: r30
void zCamSpline::CalcOrientGoals(const struct xVec3 & fromPos /* r31 */) {}

// Range: 0x80245064 -> 0x80245118
// this: r31
void zCamSpline::CalcXOffsetGoal(float rawXOffset /* f0 */) {
    // Local variables
    struct OOBExtent extent; // r1+0x8
}

// Range: 0x80245118 -> 0x80245170
...
// total size: 0x4
struct /* @class$1295zCamSpline_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1433zCamSpline_cpp */ {
    // Members
...
union /* @class$1040zCamSpline_cpp */ {
...
// total size: 0x10
struct /* @class$1053zCamSpline_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802455BC -> 0x8024563C
// this: r31
void zCamSpline::debug_mode_draw() {
    // Local variables
    const struct BeadInfo & beadValues; // r0
}

// Range: 0x8024563C -> 0x802456C0
// this: r30
...
// total size: 0x58
struct {} zCamSpline::__vtable; // size: 0x58, address: 0x80440D58
// total size: 0x54
