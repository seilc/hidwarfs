/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iLight.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800DCDB8 -> 0x800DD8BC
*/
// Range: 0x800DCDB8 -> 0x800DCDBC
void iLightInit() {}

// Range: 0x800DCDBC -> 0x800DCDC0
void iLightDeinit() {}
...
// Range: 0x800DCDC0 -> 0x800DCF4C
struct iLight * iLightCreate(struct iLight * light /* r29 */, unsigned int type /* r30 */) {
    // Local variables
...
// Range: 0x800DCF4C -> 0x800DCF94
void iLightSetColor(struct iLight * light /* r30 */, const struct _xFColor & col /* r31 */) {}

// Range: 0x800DCF94 -> 0x800DCFC0
void iLightGetColor(struct iLight * light /* r5 */, struct _xFColor & col /* r4 */) {}

// Range: 0x800DCFC0 -> 0x800DD028
void iLightSetPos(struct iLight * light /* r3 */, const struct xVec3 & pos /* r0 */) {
    // Local variables
    struct RwFrame * f; // r31
    struct RwMatrixTag * m; // r30
}

// Range: 0x800DD028 -> 0x800DD054
void iLightGetPos(struct iLight * light /* r5 */, struct xVec3 & pos /* r4 */) {}

// Range: 0x800DD054 -> 0x800DD08C
void iLightSetRadius(struct iLight * light /* r4 */, float radius /* f0 */) {}

// Range: 0x800DD08C -> 0x800DD094
struct xSphere * iLightGetBoundingSphere(struct iLight * light /* r3 */) {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFF0C8
// Range: 0x800DD094 -> 0x800DD18C
void iLightDestroy(struct iLight * light /* r31 */) {
    // Local variables
    struct RwFrame * frame; // r3
...
static struct RpTie dummyTie; // size: 0x18, address: 0x80C07938
// total size: 0x8
struct RpTriangle {
    // Members
...
static struct RpWorldSector dummyWorldSector; // size: 0x88, address: 0x80B6D690
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFF0D8
// total size: 0xC
struct xModelPool {
    // Members
...
// Range: 0x800DD18C -> 0x800DD384
void iLightAddForModel(struct xModelInstance * minst /* r27 */, struct iLight * * lights /* r29 */, int numLights /* r28 */) {
    // Local variables
    struct RpAtomic * atomic; // r6
    int i; // r29

    // References
    // -> static char __FUNCTION__[18];
    // -> static struct RpTie dummyTie;
    // -> static struct RpWorldSector dummyWorldSector;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFF0EC
// Range: 0x800DD384 -> 0x800DD55C
void iLightRemoveFromModel(struct xModelInstance * minst /* r0 */, struct iLight * * lights /* r29 */, int numLights /* r31 */) {
    // Local variables
    int i; // r29
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFF104
// Range: 0x800DD55C -> 0x800DD628
void iLightEnv(struct iLight * light /* r30 */, int env /* r0 */) {
    // Local variables
...
// Range: 0x800DD628 -> 0x800DD650
void iLightJSPPreRender(struct xEnv * env /* r3 */, struct iLight * light /* r4 */) {}

// Range: 0x800DD650 -> 0x800DD674
void iLightJSPPostRender(struct xEnv * env /* r3 */) {}
...
// total size: 0x1
struct /* @class$1029iLight_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030iLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031iLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032iLight_cpp */ {
    // Members
...
static struct tweak_callback colorUpdateCallback; // size: 0x28, address: 0x80B6D718
static struct tweak_callback radiusUpdateCallback; // size: 0x28, address: 0x80B6D740
static struct tweak_callback positionUpdateCallback; // size: 0x28, address: 0x80B6D768
// Range: 0x800DD674 -> 0x800DD69C
void OnUpdateColorTweak(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct iLight * light; // r3
}

// Range: 0x800DD69C -> 0x800DD6C4
void OnUpdateRadiusTweak(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct iLight * light; // r3
}

// Range: 0x800DD6C4 -> 0x800DD6EC
void OnUpdatePositionTweak(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct iLight * light; // r3
}

// Range: 0x800DD6EC -> 0x800DD8BC
void iLightAddTweak(struct iLight * light /* r30 */, const char * name /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x80

    // References
    // -> static struct tweak_callback colorUpdateCallback;
    // -> static struct tweak_callback radiusUpdateCallback;
    // -> static struct tweak_callback positionUpdateCallback;
}
