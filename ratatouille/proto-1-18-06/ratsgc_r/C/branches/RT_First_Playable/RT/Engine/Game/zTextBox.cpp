/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zTextBox.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80171EE0 -> 0x8017342C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct ztextbox * head_active; // size: 0x4, address: 0x80C08568
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C01AB0
// Range: 0x80171EE0 -> 0x80171F74
...
// Range: 0x80172194 -> 0x80172198
static void render_bk_tex_wrap() {}

// total size: 0x20
struct /* @class$1162zTextBox_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
    float w; // offset 0x8, size 0x4
...
// Range: 0x80172198 -> 0x801725A8
static void render_bk_by_pieces(const struct ztextbox & e /* r21 */) {
    // Local variables
    struct xColor_tag color; // r1+0x18
    float rcz; // f31
    float nsz; // f30
...
static void (* render_bk_table[4])(struct ztextbox &); // size: 0x10, address: 0x80C01AC0
static unsigned int xjlookup[3]; // size: 0xC, address: 0x80C0C4FC
static unsigned int yjlookup[3]; // size: 0xC, address: 0x80C0C508
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C01AD0
// Range: 0x801725A8 -> 0x801728F0
...
// Range: 0x801728F0 -> 0x801728F4
static void parse_tag_blahblah() {}

static struct tag_type new_tags[1]; // size: 0x14, address: 0x80C01AE0
static unsigned long new_tags_size; // size: 0x4, address: 0x80C01AF4
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01AF8
// Range: 0x801728F4 -> 0x80172AF8
static void cb_dispatch(struct xBase * to /* r31 */, unsigned int event /* r29 */, const float * argf /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C01B04
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80172AF8 -> 0x80172C70
// this: r31
void ztextbox::load(const struct asset_type & a /* r28 */) {
    // Local variables
...
// Range: 0x80172C70 -> 0x80172C74
void ztextbox::update() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C01B0C
// Range: 0x80172C74 -> 0x80172D5C
// this: r31
void ztextbox::reset() {
    // References
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C01B14
// Range: 0x80172D5C -> 0x80172E14
// this: r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C01B1C
// Range: 0x80172E14 -> 0x80172EB4
// this: r31
...
// Range: 0x80172F4C -> 0x80172F90
// this: r30
void ztextbox::set_text(const char * s /* r31 */) {}

// Range: 0x80172F90 -> 0x80172FE8
// this: r31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C01B2C
// Range: 0x80172FE8 -> 0x8017309C
// this: r30
void ztextbox::add_text(const char * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[9];
}

// Range: 0x8017309C -> 0x801730E8
// this: r31
...
// Range: 0x801730E8 -> 0x80173104
// this: r0
void ztextbox::clear_text() {}

// Range: 0x80173104 -> 0x8017314C
// this: r31
void ztextbox::refresh() {}

// Range: 0x8017314C -> 0x801731E8
// this: r0
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C01B38
// Range: 0x80173218 -> 0x8017338C
void ztextbox::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
enum /* @enum$1003zTextBox_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1004zTextBox_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1005zTextBox_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
