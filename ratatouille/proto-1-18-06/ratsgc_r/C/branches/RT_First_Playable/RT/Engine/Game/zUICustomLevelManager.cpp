/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomLevelManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80228474 -> 0x80228EA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct Scene scenes[200]; // size: 0x2580, address: 0x80BC5B80
// total size: 0x14
struct SceneUnlock {
    // Members
...
static struct SceneUnlock scenesUnlock[200]; // size: 0xFA0, address: 0x80BC8100
static unsigned int sceneCurrent; // size: 0x4, address: 0x80C08FB0
...
char * allsoaklevels[200]; // size: 0x320, address: 0x80BC90A0
// Range: 0x80228474 -> 0x8022847C
unsigned int zUIIncrediblesGetNumScenes() {
    // References
    // -> int numScenes;
}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043FA50
// Range: 0x8022847C -> 0x802284F8
...
// Range: 0x802284F8 -> 0x80228500
unsigned int zUIIncrediblesGetSceneCurrent() {
    // References
    // -> static unsigned int sceneCurrent;
}

static char __FUNCTION__[36]; // size: 0x24, address: 0x8043FA70
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1120zUICustomLevelManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1276zUICustomLevelManager_cpp */ {
    // Members
...
union /* @class$855zUICustomLevelManager_cpp */ {
...
// total size: 0x10
struct /* @class$1787zUICustomLevelManager_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2034zUICustomLevelManager_cpp */ {
    // Static members
...
// Range: 0x80228600 -> 0x8022867C
unsigned int zUIGetSceneNumberByID(unsigned int sceneID /* r0 */) {
    // Local variables
    unsigned int i; // r8
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C04520
// Range: 0x8022867C -> 0x80228700
struct Scene * zUIGetSceneByID(unsigned int sceneID /* r31 */) {
    // Local variables
...
// Range: 0x80228700 -> 0x80228708
int zUIIncrediblesGetNumStoryScenes() {
    // References
    // -> int numStoryScenes;
}

// Range: 0x80228708 -> 0x80228710
int zUIIncrediblesGetNumArenaScenes() {
    // References
    // -> int numArenaScenes;
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80C04530
// Range: 0x80228710 -> 0x802287A4
struct Scene * zUIIncrediblesGetScene(unsigned int level /* r31 */) {
    // References
    // -> static struct Scene scenes[200];
    // -> static char __FUNCTION__[23];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C04548
// Range: 0x802287A4 -> 0x80228828
...
// Range: 0x80228828 -> 0x80228858
struct Scene * zUIIncrediblesFindCurrentScene() {
    // References
    // -> static struct Scene scenes[200];
}

static char __FUNCTION__[31]; // size: 0x1F, address: 0x8043FA94
// Range: 0x80228858 -> 0x802288E8
unsigned char zUIIncrediblesSceneIsCompleted(unsigned int level /* r31 */) {
    // References
    // -> static struct Scene scenes[200];
    // -> static char __FUNCTION__[31];
}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043FAB4
// Range: 0x802288E8 -> 0x80228978
unsigned char zUIIncrediblesSceneIsUnlocked(unsigned int level /* r31 */) {
    // References
    // -> static struct Scene scenes[200];
    // -> static char __FUNCTION__[30];
}
...
class zUISceneGroups sSceneGroups; // size: 0x54, address: 0x80BC93C0
char __FUNCTION__$localstatic1$__vc__14zUISceneGroupsFUi[5]; // size: 0x5, address: 0x80C0455C
char __FUNCTION__$localstatic1$AddSceneGroup__14zUISceneGroupsFPCc[14]; // size: 0xE, address: 0x80C04564
// total size: 0xC
...
// Range: 0x80228978 -> 0x80228A74
unsigned int zUISceneNumberFromCounter(struct _xCounter * counter /* r30 */) {
    // Local variables
    unsigned int groupIndex; // r31
    const struct Group & group; // r0

    // References
    // -> class zUISceneGroups sSceneGroups;
}

// Range: 0x80228A74 -> 0x80228B04
// this: r30
struct Group & zUISceneGroups::operator[](unsigned int index /* r31 */) {
    // References
    // -> char __FUNCTION__$localstatic1$__vc__14zUISceneGroupsFUi[5];
}

// Range: 0x80228B04 -> 0x80228B0C
// this: r3
unsigned int zUISceneGroups::NumGroups() {}

// Range: 0x80228B0C -> 0x80228B38
unsigned char zUISceneExists(struct _xCounter * mission /* r0 */) {}

// Range: 0x80228B38 -> 0x80228C5C
void zUIAddScene(unsigned int sceneID /* r31 */) {
    // Local variables
    char sceneIDStr[5]; // r1+0x8
    unsigned int number; // r0
...
// Range: 0x80228C5C -> 0x80228C90
// this: r0
void zUISceneGroups::AddSceneGroup(unsigned int sceneID /* r0 */) {
    // Local variables
    char code[2]; // r1+0x8
}

// Range: 0x80228C90 -> 0x80228D90
// this: r30
void zUISceneGroups::AddSceneGroup(const char * sceneID /* r31 */) {
    // Local variables
    unsigned int i; // r0
...
static unsigned int cMissionCounterID; // size: 0x4, address: 0x80C08FC4
static signed char init; // size: 0x1, address: 0x80C08FC8
static unsigned int cMissionValidCounterID; // size: 0x4, address: 0x80C08FCC
static signed char init; // size: 0x1, address: 0x80C08FD0
// Range: 0x80228DB0 -> 0x80228E74
void zUILevelsUpdate() {
    // Local variables
    struct _xCounter * mission; // r30
    struct _xCounter * missionValid; // r0
