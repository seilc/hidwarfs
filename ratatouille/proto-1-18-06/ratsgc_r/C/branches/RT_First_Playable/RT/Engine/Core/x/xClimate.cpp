/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xClimate.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80017BF4 -> 0x80017BF4
*/
// total size: 0x8
struct _tagRain {
    // Members
    int rain; // offset 0x0, size 0x4
...
struct _tagClimate {
    // Members
    struct _tagRain rain; // offset 0x0, size 0x8
    struct _tagWind wind; // offset 0x8, size 0x14
};
// total size: 0x30
struct xMat3x3 {
    // Members
