/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xPad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008D9B8 -> 0x8008E280
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8008D9B8 -> 0x8008DA54
int xPadInit() {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8008DA54 -> 0x8008DA88
struct _tagxPad * xPadEnable(int idx /* r3 */) {
    // Local variables
    struct _tagxPad * p; // r3

    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8008DA88 -> 0x8008DAE0
void xPadRumbleEnable(int idx /* r0 */, int enable /* r4 */) {
    // Local variables
    struct _tagxPad * p; // r5

    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x8008DAE0 -> 0x8008DB1C
void xPadClear() {
    // Local variables
    int i; // r31
}

// Range: 0x8008DB1C -> 0x8008DB3C
void xPadClear(int idx /* r0 */) {
    // Local variables
    struct _tagxPad * p; // r3
...
static int submap; // size: 0x4, address: 0x80C07518
static signed char init; // size: 0x1, address: 0x80C0751C
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFD720
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x8008DB3C -> 0x8008DF10
int xPadUpdate(int idx /* r31 */, float time_passed /* f31 */) {
    // Local variables
    unsigned int new_on; // r1+0x8
    struct _tagxPad * p; // r31
    unsigned int fake_dpad; // r3
    int i; // r6
...
// Range: 0x8008DF10 -> 0x8008DF60
void xPadUpdateAllPads(float time_passed /* f31 */) {
    // Local variables
    int j; // r31
}

// Range: 0x8008DF60 -> 0x8008E078
void SubMapAll(int * neuon /* r0 */, struct _tagxPad * xp /* r0 */) {
    // Local variables
    int old; // r7
    int keys; // r0
}

// Range: 0x8008E078 -> 0x8008E1E0
void xPadNormalizeAnalog(struct _tagxPad & pad /* r3 */, int inner_zone /* r25 */, int outer_zone /* r26 */) {
    // Local variables
    int i; // r27
}
...
// Range: 0x8008E1E0 -> 0x8008E200
void xPadKill() {}

// Range: 0x8008E200 -> 0x8008E280
void xPadAnalogIsDigital(int idx /* r0 */, int enable /* r0 */) {
    // Local variables
