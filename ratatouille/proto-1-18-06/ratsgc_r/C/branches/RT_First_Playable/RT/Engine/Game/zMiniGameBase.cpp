/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028AD3C -> 0x8028B5D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zMiniGameBase * currentMiniGame; // size: 0x4, address: 0x80C09450
// total size: 0x7C
struct {} zMiniGameBase::__vtable; // size: 0x7C, address: 0x804448C4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8028AD3C -> 0x8028AD8C
// this: r30
zMiniGameBase::zMiniGameBase(struct zMiniGameAsset * a /* r31 */) {
    // References
...
// total size: 0x4
struct /* @class$1128zMiniGameBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1289zMiniGameBase_cpp */ {
    // Members
...
union /* @class$1265zMiniGameBase_cpp */ {
...
// total size: 0x10
struct /* @class$1786zMiniGameBase_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2033zMiniGameBase_cpp */ {
    // Static members
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05BD8
// Range: 0x8028ADD8 -> 0x8028AE48
...
// Range: 0x8028AE48 -> 0x8028AFB4
// this: r30
void zMiniGameBase::SwitchGameState(enum eMiniGameState newState /* r31 */) {}

// Range: 0x8028AFB4 -> 0x8028B060
// this: r0
void zMiniGameBase::Update(float dt /* f0 */) {}

// total size: 0x7C
struct {} zMiniGameType1::__vtable; // size: 0x7C, address: 0x80444848
// total size: 0x30
...
// Range: 0x8028B060 -> 0x8028B0A4
// this: r31
zMiniGameType1::zMiniGameType1(struct zMiniGameAsset * a /* r0 */) {
    // References
    // -> struct [anonymous] zMiniGameType1::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05BE0
// Range: 0x8028B0A4 -> 0x8028B2D4
void zMiniGameType1::Init(struct xBase & data /* r28 */, struct xDynAsset & asset /* r29 */, unsigned long asset_size /* r30 */) {
    // Local variables
...
// Range: 0x8028B408 -> 0x8028B40C
void zMiniGameType1::Render() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C05BE8
// Range: 0x8028B40C -> 0x8028B508
float GetAngleDiff(const struct xVec3 * startDir /* r30 */, const struct xVec3 * endDir /* r31 */) {
    // Local variables
    float angle_caller; // f0
    float angle_true; // f0
...
// Range: 0x8028B508 -> 0x8028B5D4
float ApplyAngleDiff(struct xMat3x3 * mat /* r31 */, float angle_difference /* f1 */, float dt /* f0 */, float turning_speed /* f0 */) {
    // Local variables
