/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGame.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80127794 -> 0x8012DA70
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x80C0BE00
char __FUNCTION__$localstatic1$get_grid_index__6zGrassFii[15]; // size: 0xF, address: 0x80C006F8
char __FUNCTION__$localstatic1$get_grid_index__6zGrassFRC5xVec3RC5xVec3RC5xVec3[15]; // size: 0xF, address: 0x80C00708
char __FUNCTION__$localstatic1$get_grid_box__6zGrassFi[13]; // size: 0xD, address: 0x80C00718
enum eFMVFile {
    eFMVFile_NoMovie = 0,
...
unsigned int gzAsyncRenderDisable; // size: 0x4, address: 0x80C07DF8
static unsigned int sPlayerMarkerStartID; // size: 0x4, address: 0x80C07DFC
static float sGameOverTimer; // size: 0x4, address: 0x80C07E00
float sTimeElapsed; // size: 0x4, address: 0x80C07E04
float gRealTimeElapsed; // size: 0x4, address: 0x80C07E08
long long sTimeLast; // size: 0x8, address: 0x80C07E10
long long sTimeCurrent; // size: 0x8, address: 0x80C07E18
unsigned int gLevelChanged; // size: 0x4, address: 0x80C07E20
unsigned char gExitAfterPause; // size: 0x1, address: 0x80C07E24
static int sPlaybackForceDump; // size: 0x4, address: 0x80C07E28
static int g_hiphopReloadHIP; // size: 0x4, address: 0x80C07E2C
static int g_hiphopForcePortal; // size: 0x4, address: 0x80C07E30
static int g_hiphopResetOnly; // size: 0x4, address: 0x80C07E34
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static unsigned char g_renderPreEffects; // size: 0x1, address: 0x80C00725
unsigned int gzAsyncSceneID; // size: 0x4, address: 0x80C07E38
unsigned int gSoak; // size: 0x4, address: 0x80C07E3C
float s_dbloop_elapsec; // size: 0x4, address: 0x80C07E40
static unsigned int s_dbloop_elaptick; // size: 0x4, address: 0x80C07E44
static float s_dbloop_fps; // size: 0x4, address: 0x80C07E48
static float s_curFPSCounterTime; // size: 0x4, address: 0x80C07E4C
static float s_curFPSFrames; // size: 0x4, address: 0x80C07E50
static float s_curFPS; // size: 0x4, address: 0x80C07E54
static char switchSceneDest[4]; // size: 0x4, address: 0x80C07E58
static unsigned char switchScene; // size: 0x1, address: 0x80C07E5C
void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
// Range: 0x80127794 -> 0x801277C4
static void * ssMalloc(unsigned long size /* r0 */) {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x801277C4 -> 0x801277F0
static void ssFree(void * block /* r0 */) {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x801277F0 -> 0x80127830
...
static int init; // size: 0x4, address: 0x80C07E60
static signed char init; // size: 0x1, address: 0x80C07E64
// Range: 0x80127830 -> 0x80127894
...
char * * soaklevels; // size: 0x4, address: 0x80C07E68
static float SOAK_DELAY; // size: 0x4, address: 0x80C00728
static float SOAK_DELAYRAND; // size: 0x4, address: 0x80C0072C
static float soaktime; // size: 0x4, address: 0x80C00730
int enableMenuMasher; // size: 0x4, address: 0x80C07E6C
int enableAudioAnnihilator; // size: 0x4, address: 0x80C07E70
int enableSuperSoaker; // size: 0x4, address: 0x80C07E74
static int superSoak_simulatePlayerAction; // size: 0x4, address: 0x80C00734
static unsigned int superSoakExtraPadOnInput; // size: 0x4, address: 0x80C07E78
static unsigned int superSoakExtraPadPressInput; // size: 0x4, address: 0x80C07E7C
// total size: 0x2
...
static struct _tagPadAnalog savedAnalog1; // size: 0x2, address: 0x80C07E80
static struct _tagPadAnalog savedAnalog2; // size: 0x2, address: 0x80C07E84
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct xPortalAsset dummyPortalAsset; // size: 0x18, address: 0x80C07E88
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct _zPortal dummyPortal; // size: 0x14, address: 0x80C07EA0
static unsigned int loadMeter; // size: 0x4, address: 0x80C07EB4
static int sForceUpdateRate; // size: 0x4, address: 0x80C07EB8
static int soakidx; // size: 0x4, address: 0x80C07EBC
static signed char init; // size: 0x1, address: 0x80C07EC0
static int soakcnt; // size: 0x4, address: 0x80C07EC4
static signed char init; // size: 0x1, address: 0x80C07EC8
enum en_SOAK_DIR {
    SOAK_FOR = 0,
    SOAK_BACK = 1,
    SOAK_RAND = 2,
...
static enum en_SOAK_DIR soakdir; // size: 0x4, address: 0x80C07ECC
static signed char init; // size: 0x1, address: 0x80C07ED0
static int justwrap; // size: 0x4, address: 0x80C07ED4
static signed char init; // size: 0x1, address: 0x80C07ED8
static unsigned int sumtotal; // size: 0x4, address: 0x80C07EDC
static signed char init; // size: 0x1, address: 0x80C07EE0
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00738
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00748
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80127894 -> 0x80127C24
static unsigned int PickNextSoak() {
    // Local variables
    unsigned int nextsoak; // r28
    const char * name; // r30
    const char * spiral; // r29
    unsigned int tag; // r4
    int num_search; // r28
    char useme[5]; // r1+0x8
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00758
unsigned int loadSceneID; // size: 0x4, address: 0x80C08FE8
// total size: 0x4
class Screen {
    // Members
public:
...
// Range: 0x80127D2C -> 0x80127EDC
void zGameInit(unsigned int theSceneID /* r31 */) {
    // Local variables
    long long t; // r30
    int i; // r29
...
// total size: 0x4
struct /* @class$2328zGame_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2329zGame_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$976zGame_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$977zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$978zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$979zGame_cpp */ {
    // Members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C00764
// Range: 0x80127F20 -> 0x8012804C
void zGameExit() {
    // Local variables
    long long t; // r31
...
int sFrameRateMonitorDesiredFPS; // size: 0x4, address: 0x80C07EE4
static char * FORCE_UPDATE_LABELS[13]; // size: 0x34, address: 0x80439D60
static int FORCE_UPDATE_VALUES[13]; // size: 0x34, address: 0x80439D94
static char * FPS_MONITOR_LABELS[6]; // size: 0x18, address: 0x80C00770
static int FPS_MONITOR_VALUES[6]; // size: 0x18, address: 0x80C00788
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C007A0
struct _zEnv * gCurEnv; // size: 0x4, address: 0x80C083F0
float VBLANKS_PER_SEC; // size: 0x4, address: 0x80C00BD8
// Range: 0x8012804C -> 0x80128480
void zGameSetup() {
    // Local variables
    long long t; // r29
    struct RpWorld * world; // r30
    int csncount; // r0
    int cnum; // r28
...
static long long t0; // size: 0x8, address: 0x80C07EE8
static long long t1; // size: 0x8, address: 0x80C07EF0
static long long w0; // size: 0x8, address: 0x80C07EF8
static long long w1; // size: 0x8, address: 0x80C07F00
static long long gloop_time; // size: 0x8, address: 0x80C07F08
static long long gwait_time; // size: 0x8, address: 0x80C07F10
static int gloop_ct; // size: 0x4, address: 0x80C07F18
static float gloop_time_secs; // size: 0x4, address: 0x80C07F1C
static float gwait_time_secs; // size: 0x4, address: 0x80C07F20
static float gloop_net_time_secs; // size: 0x4, address: 0x80C07F24
unsigned int gLastProfileDump; // size: 0x4, address: 0x80C07F28
// Range: 0x80128480 -> 0x801284DC
void zGamePreRender() {
    // References
    // -> struct zGlobals globals;
    // -> static unsigned char g_renderPreEffects;
...
static float gc_max_dt; // size: 0x4, address: 0x80C07F2C
static signed char init; // size: 0x1, address: 0x80C07F30
enum xSndHandle {
};
static enum xSndHandle hSound; // size: 0x4, address: 0x80C07F34
static signed char init; // size: 0x1, address: 0x80C07F38
enum iSndGroupHandle {
};
static enum iSndGroupHandle hSndGroup; // size: 0x4, address: 0x80C07F3C
static signed char init; // size: 0x1, address: 0x80C07F40
static unsigned char initSavedInput; // size: 0x1, address: 0x80C07F41
static signed char init; // size: 0x1, address: 0x80C07F42
static float sAttractMode_timer; // size: 0x4, address: 0x80C07F44
static signed char init; // size: 0x1, address: 0x80C07F48
static float paccum; // size: 0x4, address: 0x80C07F4C
static float pcount; // size: 0x4, address: 0x80C07F50
static int include_xcambegtime_too; // size: 0x4, address: 0x80C07F54
static signed char init; // size: 0x1, address: 0x80C07F58
static int displayToggle; // size: 0x4, address: 0x80C07F5C
static signed char init; // size: 0x1, address: 0x80C07F60
// total size: 0x30
class xfont {
    // Members
public:
...
static class xfont debugStr; // size: 0x30, address: 0x80439DC8
static signed char init; // size: 0x1, address: 0x80C07F61
// total size: 0x14
struct tag_entry {
    // Members
    struct substr name; // offset 0x0, size 0x8
...
static class xtextbox tb; // size: 0x74, address: 0x80439DF8
static signed char init; // size: 0x1, address: 0x80C07F62
static struct _zPortal portal; // size: 0x14, address: 0x80C07F64
static struct xPortalAsset portalAsset; // size: 0x18, address: 0x80C07F78
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C007AC
unsigned int gSceneFrameCount; // size: 0x4, address: 0x80C06F3C
// total size: 0x118
struct xStats {
    // Members
...
struct xStats gStats; // size: 0x118, address: 0x8045A210
...
float ShortbreadCookieJar; // size: 0x4, address: 0x80C08224
enum eGameMode {
    eGameMode_Boot = 0,
    eGameMode_Intro = 1,
    eGameMode_Title = 2,
...
unsigned int gFrameCount; // size: 0x4, address: 0x80C06F38
// total size: 0x20
struct DVDDiskID {
    // Members
...
// Range: 0x801284DC -> 0x8012A668
void zGameLoop() {
    // Local variables
    long long t; // r14
    int ostrich_delay; // r18
    long long diff; // r14
    signed short csncount; // r14
    int i; // r1+0x2C
    int cnum; // r15
    long long cpustat_sum; // r0
    int startidx; // r1+0x28
    int port; // r0
    int i; // r16
    unsigned char padActive; // r0
    int i; // r15
    unsigned char initBailTimer; // r16
    int i; // r17
    int i; // r16
    struct PlaybackStruct * cur; // r17
    int j; // r23
    struct PlaybackStruct * cur; // r30
    int i; // r1+0x24
    long long tprof0; // r17
    long long tprof1; // r0
    int i; // r1+0x20
    int k; // r17
    struct tag_xFile file; // r1+0x40C
    char filename[128]; // r1+0x10C
    long long start; // r15
    int isPaused; // r0
    int i; // r19
    int i; // r19
    ...
    int i; // r15
    float gdt; // f22
    long long cpustat_camtime; // r0
    long long cpustat_sumtoo; // r0
    char tmpStr[384]; // r1+0x28C
    struct _tagxPad * pad; // r19
    int port; // r1+0x1C
    char * nextToken; // r1+0x18
    const char * foo; // r19
    float y; // f24
    char str[8]; // r1+0x30
    char tmpstr[256]; // r1+0x18C
    long long cpustat_sumthrice; // r0
    int j; // r17
    void * disp; // r1+0x14
    void * copy; // r1+0x10
...
// Range: 0x8012A668 -> 0x8012A6D8
int zGameIsPaused() {
    // References
    // -> enum eGameMode gGameMode;
}

int gGameState; // size: 0x4, address: 0x80C008E0
// Range: 0x8012A6D8 -> 0x8012A77C
...
// Range: 0x8012A77C -> 0x8012A7F0
enum pause_ability zGameOkToPause() {
    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C007B8
// Range: 0x8012A7F0 -> 0x8012A908
void zGamePause() {
    // Local variables
    long long t; // r31
...
void * barray[1024]; // size: 0x1000, address: 0x80B90584
unsigned long sarray[1024]; // size: 0x1000, address: 0x80B91584
unsigned long bvisited; // size: 0x4, address: 0x80C07F90
// Range: 0x8012A90C -> 0x8012A944
static void visit_heap(void * block /* r0 */, unsigned long size /* r0 */) {
    // References
...
long mem_free_size; // size: 0x4, address: 0x80C007C4
long omem_free_size; // size: 0x4, address: 0x80C007C8
int the_heap; // size: 0x4, address: 0x80C07964
// Range: 0x8012A944 -> 0x8012A9D4
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C007CC
...
// Range: 0x8012A9D4 -> 0x8012AF84
static void zGameUpdateMode() {
    // Local variables
    int startidx; // r1+0x8
    struct _tagxPad * pad; // r28
    int port; // r27
    enum _tagTRCState state; // r0
    int padcount; // r0
    struct xPortalAsset * passet; // r4
    unsigned int nextSceneID; // r27
    int i; // r27
...
struct RwCamera * sGameScreenTransCam; // size: 0x4, address: 0x80C07F94
static struct RpWorld * gWorld; // size: 0x4, address: 0x80C07F98
static struct RpLight * DirectionalLight; // size: 0x4, address: 0x80C07F9C
// Range: 0x8012AF84 -> 0x8012AF88
void zGameTakeSnapShot() {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80439E6C
...
// Range: 0x8012B220 -> 0x8012B284
void zGameScreenTransitionUpdate(float percentComplete /* f31 */, char * msg /* r31 */) {
    // References
    // -> struct zGlobals globals;
}

unsigned int bgID; // size: 0x4, address: 0x80C007DC
float bgu1; // size: 0x4, address: 0x80C07FA0
float bgv1; // size: 0x4, address: 0x80C07FA4
float bgu2; // size: 0x4, address: 0x80C007E0
float bgv2; // size: 0x4, address: 0x80C007E4
unsigned char bgr; // size: 0x1, address: 0x80C007E8
unsigned char bgg; // size: 0x1, address: 0x80C007E9
unsigned char bgb; // size: 0x1, address: 0x80C007EA
unsigned char bga; // size: 0x1, address: 0x80C007EB
static char __FUNCTION__[28]; // size: 0x1C, address: 0x80439E88
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x8012B284 -> 0x8012B634
void zGameScreenTransitionUpdate(float percentComplete /* f31 */, char * msg /* r31 */, unsigned char * rgba /* r30 */) {
    // Local variables
    struct RwRGBA back_col; // r1+0x8
    struct RwTexture * tex; // r0
    struct RwRaster * ras; // r30
    struct rwGameCube2DVertex vx[4]; // r1+0xC
    float z; // f10
    char meter[256]; // r1+0x6C
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x80439EA4
// Range: 0x8012B634 -> 0x8012B77C
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C007EC
// Range: 0x8012B77C -> 0x8012B8DC
void zGameInitPlayer() {
    // Local variables
    struct xEntAsset * asset; // r28
    int i; // r27
    unsigned int playerTag; // r31
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C007FC
// Range: 0x8012B8DC -> 0x8012B9B8
...
// Range: 0x8012B9B8 -> 0x8012BAD4
static void zGameResetPlayerToSceneStart() {
    // Local variables
    struct pointer_asset * pointer; // r0
    struct xEntFrame * frame; // r30
    struct xMarkerAsset * marker; // r30
...
static float lastTime; // size: 0x4, address: 0x80C07FA8
static signed char init; // size: 0x1, address: 0x80C07FAC
static float presentTime; // size: 0x4, address: 0x80C07FB0
static signed char init; // size: 0x1, address: 0x80C07FB4
static const char * TXT_DEMO; // size: 0x4, address: 0x80C07FB8
static signed char init; // size: 0x1, address: 0x80C07FBC
static class xtextbox tb; // size: 0x74, address: 0x80439EC0
static signed char init; // size: 0x1, address: 0x80C07FBD
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00810
// Range: 0x8012BAD4 -> 0x8012BE24
void zGameDemoText(float fTime /* f30 */) {
    // Local variables
    float elapsedTime; // f31
    float fAlpha; // f1
    float fPot; // f5
    float fPot; // f5
    unsigned char alpha; // r7
...
static int max_nextPickupMove; // size: 0x4, address: 0x80C07FC0
static signed char init; // size: 0x1, address: 0x80C07FC4
static int max_nextMove; // size: 0x4, address: 0x80C07FC8
static signed char init; // size: 0x1, address: 0x80C07FCC
static int max_nextKillNPC; // size: 0x4, address: 0x80C07FD0
static signed char init; // size: 0x1, address: 0x80C07FD4
static int max_nextKillPlayer; // size: 0x4, address: 0x80C07FD8
static signed char init; // size: 0x1, address: 0x80C07FDC
static int max_nextOOBTest; // size: 0x4, address: 0x80C07FE0
static signed char init; // size: 0x1, address: 0x80C07FE4
static int max_nextPlayerAction; // size: 0x4, address: 0x80C07FE8
static signed char init; // size: 0x1, address: 0x80C07FEC
static int max_nextPlayerSwitch; // size: 0x4, address: 0x80C07FF0
static signed char init; // size: 0x1, address: 0x80C07FF4
static int max_nextRunScript; // size: 0x4, address: 0x80C07FF8
static signed char init; // size: 0x1, address: 0x80C07FFC
static int max_nextMoveAnalogSticks; // size: 0x4, address: 0x80C08000
static signed char init; // size: 0x1, address: 0x80C08004
static int min_nextInAHurry; // size: 0x4, address: 0x80C08008
static signed char init; // size: 0x1, address: 0x80C0800C
static int max_nextInAHurry; // size: 0x4, address: 0x80C08010
static signed char init; // size: 0x1, address: 0x80C08014
static int cnt_nextPickupMove; // size: 0x4, address: 0x80C08018
static signed char init; // size: 0x1, address: 0x80C0801C
static int cnt_nextMove; // size: 0x4, address: 0x80C08020
static signed char init; // size: 0x1, address: 0x80C08024
static int cnt_nextKillNPC; // size: 0x4, address: 0x80C08028
static signed char init; // size: 0x1, address: 0x80C0802C
static int cnt_nextKillPlayer; // size: 0x4, address: 0x80C08030
static signed char init; // size: 0x1, address: 0x80C08034
static int cnt_nextOOBTest; // size: 0x4, address: 0x80C08038
static signed char init; // size: 0x1, address: 0x80C0803C
static int cnt_nextPlayerAction; // size: 0x4, address: 0x80C08040
static signed char init; // size: 0x1, address: 0x80C08044
static int cnt_nextPlayerSwitch; // size: 0x4, address: 0x80C08048
static signed char init; // size: 0x1, address: 0x80C0804C
static int cnt_nextRunScript; // size: 0x4, address: 0x80C08050
static signed char init; // size: 0x1, address: 0x80C08054
static int cnt_nextMoveAnalogSticks; // size: 0x4, address: 0x80C08058
static signed char init; // size: 0x1, address: 0x80C0805C
static int cnt_nextInAHurry; // size: 0x4, address: 0x80C08060
static signed char init; // size: 0x1, address: 0x80C08064
static int workOn; // size: 0x4, address: 0x80C08068
static signed char init; // size: 0x1, address: 0x80C0806C
static int onElsePress; // size: 0x4, address: 0x80C08070
static signed char init; // size: 0x1, address: 0x80C08074
static int idx_action; // size: 0x4, address: 0x80C08078
static signed char init; // size: 0x1, address: 0x80C0807C
// total size: 0x14
...
// Range: 0x8012BE24 -> 0x8012C5B4
static void MoveThePlayerAround() {
    // Local variables
    struct zScene & s; // r3
    struct _zScript * scriptlist; // r25
    int idx_count; // r26
    int idx_torun; // r0
    struct _zScript * script; // r25
    int randomActionTable[16]; // r1+0x8
    int action; // r31
    int numSimulKeyPresses; // r25
    int i; // r26
...
static int nextButtonPress; // size: 0x4, address: 0x80C08080
static signed char init; // size: 0x1, address: 0x80C08084
// Range: 0x8012C5B4 -> 0x8012C6F8
static void SpamTheFaceButtons() {
    // Local variables
    int faceButtons[10]; // r1+0x8
    int numButtonPresses; // r29
    int i; // r28
    int arrayIndex; // r0
...
static int num_nextKeyPress; // size: 0x4, address: 0x80C08088
static signed char init; // size: 0x1, address: 0x80C0808C
static int num_nextAnalogMovement; // size: 0x4, address: 0x80C08090
static signed char init; // size: 0x1, address: 0x80C08094
static int cnt_nextKeyPress; // size: 0x4, address: 0x80C08098
static signed char init; // size: 0x1, address: 0x80C0809C
static int cnt_nextAnalogMovement; // size: 0x4, address: 0x80C080A0
static signed char init; // size: 0x1, address: 0x80C080A4
static float weightTable[18]; // size: 0x48, address: 0x80439F34
static int needNormalize; // size: 0x4, address: 0x80C080A8
static signed char init; // size: 0x1, address: 0x80C080AC
static long long tym_last; // size: 0x8, address: 0x80C080B0
static signed char init; // size: 0x1, address: 0x80C080B8
static int enableLogging; // size: 0x4, address: 0x80C080BC
static signed char init; // size: 0x1, address: 0x80C080C0
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00820
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C00830
// Range: 0x8012C6F8 -> 0x8012CCE4
...
static int numLooped; // size: 0x4, address: 0x80C080C4
static signed char init; // size: 0x1, address: 0x80C080C8
// total size: 0xC
struct loopedSound {
    // Members
...
static struct loopedSound looped[256]; // size: 0xC00, address: 0x80B92584
static float num_nextPlayFixed; // size: 0x4, address: 0x80C080CC
static signed char init; // size: 0x1, address: 0x80C080D0
static float num_nextPlayRand; // size: 0x4, address: 0x80C080D4
static signed char init; // size: 0x1, address: 0x80C080D8
static int num_nextEcho; // size: 0x4, address: 0x80C080DC
static signed char init; // size: 0x1, address: 0x80C080E0
static int cnt_nextPlay; // size: 0x4, address: 0x80C080E4
static signed char init; // size: 0x1, address: 0x80C080E8
static int cnt_nextEcho; // size: 0x4, address: 0x80C080EC
static signed char init; // size: 0x1, address: 0x80C080F0
static int echo_on; // size: 0x4, address: 0x80C080F4
static signed char init; // size: 0x1, address: 0x80C080F8
static float remainingTime; // size: 0x4, address: 0x80C080FC
static signed char init; // size: 0x1, address: 0x80C08100
static struct xVec3 pos_sound; // size: 0xC, address: 0x80C00840
static signed char init; // size: 0x1, address: 0x80C08101
static struct xVec3 vel_sound; // size: 0xC, address: 0x80C0084C
static signed char init; // size: 0x1, address: 0x80C08102
static int moveAndOrbit; // size: 0x4, address: 0x80C08104
static signed char init; // size: 0x1, address: 0x80C08108
static float cycle; // size: 0x4, address: 0x80C0810C
static signed char init; // size: 0x1, address: 0x80C08110
static float rad_orbitBase; // size: 0x4, address: 0x80C08114
static signed char init; // size: 0x1, address: 0x80C08118
static float height; // size: 0x4, address: 0x80C0811C
static signed char init; // size: 0x1, address: 0x80C08120
static int doDebugDraw; // size: 0x4, address: 0x80C08124
static signed char init; // size: 0x1, address: 0x80C08128
static struct xVec3 pos_plyrLast; // size: 0xC, address: 0x80C00858
static signed char init; // size: 0x1, address: 0x80C08129
struct xVec3 g_O3; // size: 0xC, address: 0x80C0ADA0
struct xVec3 g_X3; // size: 0xC, address: 0x80C0ADAC
struct xVec3 g_Z3; // size: 0xC, address: 0x80C0ADC4
struct xVec3 g_Y3; // size: 0xC, address: 0x80C0ADB8
struct xColor_tag g_FORESTGREEN; // size: 0x4, address: 0x80C0A2B0
// Range: 0x8012CCE4 -> 0x8012D2F4
static void DoTheAudioAnnihilator(float dt /* f28 */) {
    // Local variables
    int i; // r29
    float nextSoundTime; // f1
    int cnt_soundGroups; // r0
    int idx_toPlay; // r4
    unsigned int size; // r1+0x10
    void * asset; // r3
    enum iSndGroupHandle groupHandle; // r30
    float ang; // f30
    float cv; // f0
    float sv; // f0
    float rad_orbit; // f28
    enum xSndHandle sndH; // r1+0xC
...
// Range: 0x8012D2F4 -> 0x8012D68C
static void zGameSndInitListener() {
    // Local variables
    struct xMat4x3 playerMat; // r1+0x40
    int NumberOfPlayers; // r0
    int NumberOfHumanPlayers; // r31
    int HumanPlayerNumber; // r29
    int i; // r28
    struct xVec3 max; // r1+0x34
    struct xVec3 min; // r1+0x28
    struct xMat4x3 * curPlayerMat; // r0
    int i; // r28
...
struct xSndGlobals gSnd; // size: 0x7110, address: 0x80A9AEF0
float speedOfSound; // size: 0x4, address: 0x80BFE6D0
enum xSndListener {
    xSndListener_CAMERA = 0,
    xSndListener_PLAYER = 1,
    xSndListener_MAX_TYPES = 2,
};
static int PrevHumanPlayerNumber; // size: 0x4, address: 0x80C0812C
static signed char init; // size: 0x1, address: 0x80C08130
// Range: 0x8012D68C -> 0x8012DA70
...
// total size: 0x18
struct {} zAsync::Screen::__vtable; // size: 0x18, address: 0x80C00864
