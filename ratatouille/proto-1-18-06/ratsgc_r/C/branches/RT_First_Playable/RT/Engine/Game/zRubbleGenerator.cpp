/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zRubbleGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D9244 -> 0x801DC870
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char displayBounds; // size: 0x1, address: 0x80C08C48
unsigned char displayToPoints; // size: 0x1, address: 0x80C08C49
int numActiveGenerators; // size: 0x4, address: 0x80C08C4C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1139zRubbleGenerator_cpp */ {
    // Members
...
union /* @class$1278zRubbleGenerator_cpp */ {
...
// Range: 0x801D9244 -> 0x801D926C
unsigned int DestroyCB(struct xEnt * object /* r0 */) {}

int THROWN_DAMAGE; // size: 0x4, address: 0x80C03210
float THROWN_DAMAGE_RADIUS; // size: 0x4, address: 0x80C03214
float MELTING_TIME; // size: 0x4, address: 0x80C03218
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$2077zRubbleGenerator_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801D926C -> 0x801D9320
static unsigned int CollideCB(float & blastRadius /* r30 */, const struct xVec3 * point /* r31 */, float damageMultiplier /* f31 */, float radiusMultiplier /* f0 */) {
    // References
    // -> int THROWN_DAMAGE;
...
// total size: 0x890
struct /* @class$2335zRubbleGenerator_cpp */ {
    // Static members
...
static int numActiveRubble; // size: 0x4, address: 0x80C08C50
// total size: 0xC
...
static struct zFakeRubbleAsset fakeAsset; // size: 0x5C, address: 0x80BB6D78
// total size: 0x58
struct config {
    // Members
...
static struct config landDustConfig; // size: 0x58, address: 0x80BB6DD4
static class zRubble * rubblePool; // size: 0x4, address: 0x80C08C54
static unsigned int rubblePoolCount; // size: 0x4, address: 0x80C08C58
static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043E590
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1922zRubbleGenerator_cpp */ {
    // Members
    float emitRemaining; // offset 0x0, size 0x4
};
// total size: 0x148
struct /* @class$1923zRubbleGenerator_cpp */ {
    // Members
...
// Range: 0x801D9320 -> 0x801D9AF8
// this: r30
unsigned char zRubble::CalculateSimulationParameters(const struct xVec3 * source /* r28 */, const struct xVec3 * target /* r29 */, float launchAngle /* f30 */, float gravity /* f26 */, float rotations /* f27 */, float totalBouncesDistRatio /* f28 */, unsigned char isSpherical /* r31 */) {
    // Local variables
    float simHeight; // f29
    float dx; // f2
    float dz; // f4
    float totalSimDistance; // f0
    float simDistance1; // f28
    float simDistance0; // f23
    float launchAngleRad; // f24
    float sinLaunchAngle; // f0
    float cosLaunchAngle; // f0
    float tanLaunchAngle; // f0
    float launchAngleCheck; // f30
    float initVelocity; // f0
    float hMax; // f23
    float energyLeftForBounces; // f23
    float V0Endy; // f0
    float c; // f23
    float ang; // f23
    float totalRotations; // f0
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043E5B0
// Range: 0x801D9AF8 -> 0x801D9E1C
// this: r29
...
// Range: 0x801D9E1C -> 0x801D9EF0
void EventHandler(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
// Range: 0x801D9EF0 -> 0x801D9F10
void zRubble::StaticBoundsUpdate(struct xEnt * ent /* r0 */, struct xVec3 * pos /* r0 */) {}

// Range: 0x801D9F10 -> 0x801D9F4C
// this: r31
void zRubble::BoundsUpdate(const struct xVec3 & pos /* r0 */) {}

static unsigned char done; // size: 0x1, address: 0x80C08C5C
static signed char init; // size: 0x1, address: 0x80C08C5D
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0321C
int xModelInstStaticAlloc; // size: 0x4, address: 0x80C07494
// Range: 0x801D9F4C -> 0x801DA19C
// this: r30
void zRubble::Init(unsigned int index /* r29 */, unsigned int randomModelID /* r31 */) {
    // Local variables
    char indexStr[32]; // r1+0x18
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C03224
// Range: 0x801DA19C -> 0x801DA288
// this: r28
void zRubble::DeallocateDestructible() {
    // Local variables
    int i; // r29
    struct xModelInstance * model; // r3

    // References
    // -> static char __FUNCTION__[23];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C0323C
// Range: 0x801DA288 -> 0x801DA5D0
// this: r25
unsigned char zRubble::DestructibleInit(struct xDestructibleAsset * d_asset /* r26 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r30
    unsigned char modelAllocFailed; // r29
    unsigned int i; // r28
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r27
    unsigned int modelID; // r24
...
// Range: 0x801DA5D0 -> 0x801DA61C
// this: r0
unsigned char zRubble::HitPlayer() {}

// Range: 0x801DA61C -> 0x801DA650
// this: r0
void zRubble::Destroy() {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C03250
// total size: 0x1C
...
// Range: 0x801DA650 -> 0x801DA964
// this: r24
unsigned char zRubble::Activate(const struct xVec3 & source /* r25 */, const struct xVec3 & target /* r26 */, float launchAngle /* f29 */, float rotations /* f30 */, float totalBouncesDistRatio /* f31 */, const struct ModelData & data /* r27 */, unsigned int modelID /* r28 */, class zRubbleGenerator * par /* r29 */, enum zRubbleLandType landEffect /* r30 */, enum iSndGroupHandle theLandSoundGroup /* r23 */, unsigned char isSpherical /* r31 */) {
    // Local variables
    struct xLightKit * objLightKit; // r4
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0325C
struct xVec3 m_Null; // size: 0xC, address: 0x80C0B540
enum xSndHandle {
};
// Range: 0x801DA964 -> 0x801DAB5C
// this: r29
void zRubble::HandleGroundHit(float dt /* f29 */, unsigned int hitNum /* r30 */, unsigned char lastHit /* r31 */) {
    // Local variables
    float dustSizeMultiplier; // f31
    float soundVolume; // f30
    float mult; // f0
    enum xSndHandle playingSound; // r1+0x8
    struct xVec3 hitPos; // r1+0xC
...
// Range: 0x801DAB5C -> 0x801DABD8
// this: r30
void zRubble::UpdateRubbleModel() {
    // Local variables
    struct xMat4x3 * modelMat; // r0
    struct xMat3x3 * modelRotMat; // r31
...
void zRubble::SetupMeshCircle() {
    ...
    int triIdx; // r1+0x8
    class zNavigationMesh * mesh; // r31
...
// Range: 0x801DAD1C -> 0x801DAD44
// this: r0
void zRubble::SetSmashMePlease(unsigned char smashMe /* r0 */) {}

// Range: 0x801DAD44 -> 0x801DAD98
// this: r31
void zRubble::ReleaseCircle() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0326C
// Range: 0x801DAD98 -> 0x801DB214
// this: r31
void zRubble::Update(float dt /* f31 */) {
    // Local variables
    float scale; // f2
    float remainingTime; // f2
    float currentBounceVelY0; // f4
    float currentBounceTime; // f1
    float checkTime; // f2
    unsigned int i; // r4
    float inBounceTime; // f2
...
// Range: 0x801DB214 -> 0x801DB2B0
// this: r31
void zRubble::Reset() {}

// Range: 0x801DB2B0 -> 0x801DB2DC
void RubbleEventWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043E5CC
struct config default_config; // size: 0x58, address: 0x80BC2F58
// Range: 0x801DB2DC -> 0x801DB52C
void zRubbleGeneratorSceneSetup(struct zScene * scene /* r0 */) {
    // Local variables
    unsigned int randomModelID; // r31
...
// Range: 0x801DB52C -> 0x801DB5FC
void zRubbleGeneratorUpdate(struct zScene * scene /* r0 */, float dt /* f31 */) {
    // Local variables
    class zRubbleGenerator * current; // r31
    class zRubbleGenerator * last; // r30
    unsigned int i; // r30
...
// Range: 0x801DB5FC -> 0x801DB6F4
void zRubbleGeneratorRender() {
    // Local variables
    unsigned int i; // r29
    class zRubbleGenerator * current; // r29
    class zRubbleGenerator * last; // r30
...
// Range: 0x801DB6F4 -> 0x801DB78C
void zRubbleGeneratorReset(struct zScene * scene /* r29 */) {
    // Local variables
    unsigned int i; // r30
    class zRubbleGenerator * current; // r30
    class zRubbleGenerator * last; // r31
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03274
// Range: 0x801DB7E8 -> 0x801DB98C
void zRubbleGenerator::InitDynamic(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03280
// Range: 0x801DB98C -> 0x801DBC5C
// this: r26
zRubbleGenerator::zRubbleGenerator(struct zRubbleGeneratorAsset * asset /* r27 */) {
    // Local variables
    unsigned int * modelIDs; // r29
    unsigned int i; // r28
    unsigned int i; // r6
    class zRubble TestRubble; // r1+0x8
    unsigned char valid; // r3
    unsigned int i; // r30
    unsigned int j; // r31
...
// Range: 0x801DBC5C -> 0x801DBDE0
// this: r30
void zRubbleGenerator::Update(float dt /* f30 */) {
    // Local variables
    int i; // r31
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03288
// Range: 0x801DBDE0 -> 0x801DBEF8
// this: r3
void zRubbleGenerator::HandleEvent(unsigned int toEvent /* r0 */) {
    // References
    // -> static char __FUNCTION__[12];
    // -> int numActiveGenerators;
}

// Range: 0x801DBEF8 -> 0x801DBF70
// this: r0
...
// Range: 0x801DBF70 -> 0x801DBFCC
// this: r31
void zRubbleGenerator::Spawn() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03294
// Range: 0x801DBFCC -> 0x801DC404
// this: r25
void zRubbleGenerator::Spawn(const struct zRubbleMarker & from /* r26 */) {
    // Local variables
    unsigned int spawnStatus[32]; // r1+0x10
    unsigned int spawnStatusCount; // r29
    unsigned int i; // r7
    unsigned int modelIndex; // r0
    const struct ModelData & data; // r28
    unsigned int spawnToIndex; // r24
    unsigned int i; // r6
    const struct zRubbleMarker & to; // r27
    int i; // r30
    const unsigned int * modelIDs; // r0
    float launchAngle; // f31
    float rotations; // f30
    float totalBouncesDistRatio; // f3
...
// Range: 0x801DC404 -> 0x801DC44C
// this: r0
void zRubbleGenerator::SignalDeactivated(void * object /* r0 */) {
    // Local variables
    unsigned int i; // r7
}

// Range: 0x801DC44C -> 0x801DC490
// this: r0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C0329C
// Range: 0x801DC490 -> 0x801DC6FC
void zRubbleGenerator::SetupMarkers(unsigned int baseID /* r27 */, struct zRubbleMarker * & marker /* r29 */, unsigned int & count /* r30 */) {
    // Local variables
    struct xBase * b; // r4
...
// Range: 0x801DC6FC -> 0x801DC7F8
// this: r3
unsigned char zRubbleGenerator::CheckSpawnStatus(struct RpAtomic * file /* r31 */, unsigned int which /* r0 */) const {
    // Local variables
    struct xSphere sphere; // r1+0x14
    struct xBound bound; // r1+0x24
    unsigned char hit; // r1+0x8
    class zRubbleHitCallback cb; // r1+0xC
...
// total size: 0xC
struct /* @class$1277zRubbleGenerator_cpp */ {
    // Members
