/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xDebugLink.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021AF74 -> 0x8021B8C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
char mBuffer[2048]; // size: 0x800, address: 0x80BC4A00
// total size: 0x30
struct {} xDebugLink::__vtable; // size: 0x30, address: 0x8043F680
// total size: 0x804
struct Command {
    // Members
...
// total size: 0x4
struct /* @class$1114xDebugLink_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1278xDebugLink_cpp */ {
    // Members
...
// Range: 0x8021AFE4 -> 0x8021B31C
// this: r26
enum eError xDebugLink::UpdateSceneObject(char * receivedBuffer /* r27 */) {
    // Local variables
    struct xBase * sceneObject; // r25
    char * asset; // r31
    unsigned int oldAssetSize; // r1+0x8
    char * oldAsset; // r30
    char * tempAllocation; // r29
    struct st_PACKER_ATOC_NODE * assetNode; // r28
    int numberOfCameraCurvesInScene; // r0
    int count; // r31
    struct zCameraCurveAsset * cameraCurveAsset; // r24
    unsigned int i; // r23
    struct zEntTrigger & trigger; // r23
    const struct xTriggerAsset & triggerAsset; // r0
...
// total size: 0xC
struct /* @class$1520xDebugLink_cpp */ {
    // Members
...
// Range: 0x8021B31C -> 0x8021B440
enum eError xDebugLink::SendEntEvent(char * * argv /* r26 */, int argc /* r27 */) {
    // Local variables
    float params[4]; // r1+0xC
    int i; // r29
    unsigned int event; // r28
    unsigned int widgetID; // r27
    unsigned int paramWidgetID; // r1+0x8
    struct xBase * sceneObject; // r29
}

// Range: 0x8021B440 -> 0x8021B480
// this: r0
enum eError xDebugLink::Connect(char * * argv /* r4 */, int argc /* r0 */) {}

// Range: 0x8021B480 -> 0x8021B4D4
// this: r31
enum eError xDebugLink::Disconnect() {}

// Range: 0x8021B4D4 -> 0x8021B5F0
int xDebugLink::CmdToArgv(char * str /* r28 */, char * * argv /* r29 */, int maxargs /* r30 */) {
    // Local variables
    int argc; // r26
    int argcT; // r31
    char * strNil; // r5
...
void xDebugLink::Update() {
    ...
    enum eError result; // r0
    unsigned int cmdPrefixLen; // r0
