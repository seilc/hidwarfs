/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xFFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8005A568 -> 0x8005AE60
*/
static unsigned int psize; // size: 0x4, address: 0x80C07298
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct xFFX * pool; // size: 0x4, address: 0x80C0729C
static struct xFFX * alist; // size: 0x4, address: 0x80C072A0
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFC9D8
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x8005A568 -> 0x8005A648
void xFFXPoolInit(unsigned int num_ffx /* r31 */) {
    // Local variables
    unsigned int i; // r6
...
// Range: 0x8005A648 -> 0x8005A668
struct xFFX * xFFXAlloc() {
    // References
    // -> static struct xFFX * alist;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80BFC9E8
// Range: 0x8005A668 -> 0x8005A6E4
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFC9F4
// Range: 0x8005A6E4 -> 0x8005A7D0
signed short xFFXAddEffect(struct xEnt * ent /* r30 */, struct xFFX * f /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFCA04
// Range: 0x8005A7D0 -> 0x8005A8A0
unsigned int xFFXRemoveEffectByFData(struct xEnt * ent /* r29 */, void * fdata /* r30 */) {
    // Local variables
    struct xFFX * * ffxh; // r31
    struct xFFX * next; // r30

    // References
    // -> static char __FUNCTION__[24];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFCA1C
// Range: 0x8005A8A0 -> 0x8005A978
static void xFFXApplyOne(struct xFFX * ffx /* r29 */, struct xEnt * ent /* r30 */, struct xScene * sc /* r31 */, float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFCA2C
// Range: 0x8005A978 -> 0x8005AA1C
void xFFXApply(struct xEnt * ent /* r30 */, struct xScene * sc /* r31 */, float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFCA38
// total size: 0x24
...
// Range: 0x8005AA1C -> 0x8005AC04
void xFFXShakeUpdateEnt(struct xEnt * ent /* r29 */, struct xScene * sc /* r30 */, float dt /* f30 */, void * fdata /* r31 */) {
    // Local variables
...
static unsigned int shake_psize; // size: 0x4, address: 0x80C072A4
static struct xFFXShakeState * shake_pool; // size: 0x4, address: 0x80C072A8
static struct xFFXShakeState * shake_alist; // size: 0x4, address: 0x80C072AC
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFCA4C
// Range: 0x8005AC04 -> 0x8005ACE4
void xFFXShakePoolInit(unsigned int num /* r31 */) {
    // Local variables
    unsigned int i; // r6
...
// Range: 0x8005ACE4 -> 0x8005AD04
struct xFFXShakeState * xFFXShakeAlloc() {
    // References
    // -> static struct xFFXShakeState * shake_alist;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFCA60
// Range: 0x8005AD04 -> 0x8005AD80
...
static unsigned int rot_match_psize; // size: 0x4, address: 0x80C072B0
static struct xFFXRotMatchState * rot_match_pool; // size: 0x4, address: 0x80C072B4
static struct xFFXRotMatchState * rot_match_alist; // size: 0x4, address: 0x80C072B8
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFCA70
// Range: 0x8005AD80 -> 0x8005AE60
void xFFXRotMatchPoolInit(unsigned int num /* r31 */) {
    // Local variables
    unsigned int i; // r6
