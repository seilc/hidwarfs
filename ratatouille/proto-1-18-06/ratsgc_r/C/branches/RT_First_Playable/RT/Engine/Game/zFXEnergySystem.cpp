/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFXEnergySystem.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E540C -> 0x801E6ADC
*/
int streak_system_id; // size: 0x4, address: 0x80C03598
int point_system_id; // size: 0x4, address: 0x80C0359C
unsigned char need_setup; // size: 0x1, address: 0x80C08D10
// total size: 0x3C
class energy_system {
    // Functions
...
// total size: 0x2C
struct /* @class$1748zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$1749zFXEnergySystem_cpp */ {
    // Members
...
static struct config default_config; // size: 0x74, address: 0x80BC20D8
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C035A0
// total size: 0x28
...
// Range: 0x801E5418 -> 0x801E5698
// this: r30
void energy_system::setup(struct config * new_config /* r0 */, unsigned char additive /* r29 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$991zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$992zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$993zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$994zFXEnergySystem_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$995zFXEnergySystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$996zFXEnergySystem_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$997zFXEnergySystem_cpp */ {
    // Members
...
// Range: 0x801E5D44 -> 0x801E5E00
// this: r28
void energy_system::emit(const struct xVec3 & pos /* r29 */, const struct xMat3x3 & mat /* r30 */, float dt /* f31 */, struct xVec3 * new_target /* r31 */) {}
...
// Range: 0x801E5E00 -> 0x801E60B4
// this: r27
void energy_system::emit_points(const struct xMat3x3 & mat /* r28 */, float dt /* f1 */) {
    // Local variables
    ...
    float start_distance; // f1

    // References
    // -> int point_system_id;
}

// Range: 0x801E60B4 -> 0x801E62E4
// this: r27
void energy_system::emit_streaks(const struct xMat3x3 & mat /* r28 */, float dt /* f1 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1377zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1515zFXEnergySystem_cpp */ {
    // Members
...
union /* @class$1042zFXEnergySystem_cpp */ {
...
// total size: 0x10
struct /* @class$1055zFXEnergySystem_cpp */ {
    // Members
...
// Range: 0x801E62E4 -> 0x801E6728
int energy_system::point_update(unsigned char * mem /* r27 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f30 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
    struct particle * p; // r30
    struct particle * end; // r29
    class energy_system * system; // r26
    struct xVec3 & system_target; // r25
    struct config * use_config; // r28
    struct xVec3 particle_to_position; // r1+0x30
    float length; // f29
    float distance_along_normal; // f1
    struct xVec3 rotationAxis; // r1+0x24
    struct xVec3 rotation; // r1+0x18
...
// Range: 0x801E6728 -> 0x801E67B4
static void world_to_screen(struct xVec3 & screen_loc /* r30 */, const struct xVec3 & loc /* r31 */) {
    // Local variables
    struct xMat4x3 view_mat; // r1+0x20
...
// Range: 0x801E67B4 -> 0x801E69EC
int energy_system::streak_update(unsigned char * mem /* r31 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
    ...
    struct config * use_config; // r25
    struct xVec3 particle_to_position; // r1+0x3C
    float length; // f0
    struct xVec3 screen_space_position; // r1+0x30
    struct xVec3 screen_space_system_position; // r1+0x24
    struct xVec3 screen_space_direction; // r1+0x18
    float rot; // f29
    struct RwSphere worldsph; // r1+0x8
...
// Range: 0x801E6A9C -> 0x801E6AA8
// this: r0
void energy_system::end() {}

// Range: 0x801E6AA8 -> 0x801E6ADC
// this: r31
