/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCAlarmer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80296BDC -> 0x80297004
*/
// total size: 0x1
...
class zICompNPCEntityParams sEntParams; // size: 0x30, address: 0x80BD1E30
// total size: 0x8
struct xBaseAsset {
    // Members
...
class zCompPerceptionParams sPerceptionParams; // size: 0x78, address: 0x80BD1E60
enum eSteeringType {
...
class zCompSteeringGenericParams sSteeringPatrolParams; // size: 0x3C, address: 0x80BD1ED8
// total size: 0x68
class zNPCAlarmer : public zNPCBase {
    // Functions
    ...
    static class zCompPerceptionParams sPerceptionParams; // size: 0x78
    static class zICompNPCEntityParams sEntParams; // size: 0x30
};
// Range: 0x80296BDC -> 0x80296C44
void zNPCAlarmer::CompParametersInit() {
    // References
    // -> class zCompSteeringGenericParams sSteeringPatrolParams;
    // -> class zCompPerceptionParams sPerceptionParams;
    // -> class zICompNPCEntityParams sEntParams;
}

// Range: 0x80296C44 -> 0x80296E8C
void zNPCAlarmer::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
char __FUNCTION__$localstatic1$AttachComponent__59zComponentPool<17zCompLogicAlarmer,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05E58
signed char zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09508
enum eAlarmerStates {
...
class zComponentPool zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0950C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
char __FUNCTION__$localstatic1$AttachComponent__65zComponentPool<20zCompSteeringGeneric,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05E68
signed char zComponentPool<zCompSteeringGeneric, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09518
// total size: 0x8
struct xVec2 {
    // Members
...
class zComponentPool zComponentPool<zCompSteeringGeneric, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0951C
char __FUNCTION__$localstatic1$AttachComponent__62zComponentPool<15zCompPerception,16zICompPerception,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C05E78
signed char zComponentPool<zCompPerception, zICompPerception, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09528
...
class zComponentPool zComponentPool<zCompPerception, zICompPerception, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0952C
// Range: 0x80296E8C -> 0x80296F48
// this: r31
unsigned char zNPCAlarmer::Activate() {
    // References
    // -> class zCompPerceptionParams sPerceptionParams;
    // -> class zICompNPCEntityParams sEntParams;
}
...
// total size: 0x4
struct /* @class$1155zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1293zNPCAlarmer_cpp */ {
    // Members
...
union /* @class$1295zNPCAlarmer_cpp */ {
...
// Range: 0x80296F48 -> 0x80296FC4
// this: r30
void zNPCAlarmer::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1047zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCAlarmer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCAlarmer_cpp */ {
    // Members
...
// Range: 0x80296FC4 -> 0x80297004
// this: r31
void zNPCAlarmer::Render() {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zNPCAlarmer::__vtable; // size: 0x30, address: 0x804470A8
// total size: 0xC
struct {} zCompSteeringGenericParams::__vtable; // size: 0xC, address: 0x80C05E88
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
