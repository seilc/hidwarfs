/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C7970 -> 0x801C8CEC
*/
static int max_system_asset_size; // size: 0x4, address: 0x80C08AF8
static class zParticleSystem * * systems; // size: 0x4, address: 0x80C08AFC
static class zParticleSystem * * system_handler_set[7]; // size: 0x1C, address: 0x80BB6AF8
static int system_handler_set_size[7]; // size: 0x1C, address: 0x80BB6B14
static struct zParticleGenerator * * generators; // size: 0x4, address: 0x80C08B00
static int max_generators; // size: 0x4, address: 0x80C08B04
static int generators_used; // size: 0x4, address: 0x80C08B08
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02E68
// Range: 0x801C7970 -> 0x801C7C8C
static void validate_asset(const struct zParticleAsset & asset /* r30 */, int asset_size /* r31 */) {
    // Local variables
    int expected_asset_size; // r28

    // References
    // -> static char __FUNCTION__[15];
    // -> static int max_system_asset_size;
}
...
// total size: 0xC
struct /* @class$1760zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x801C7C8C -> 0x801C7D8C
static void create_handler_sets() {
    // Local variables
    int total_size; // r9
    int handler; // r10
    int size; // r11
    class zParticleSystem * * sys; // r12
    class zParticleSystem * * end_sys; // r0
    class zParticleSystem * * handler_buffer; // r3
    class zParticleSystem * * set; // r3
    int handler; // r8
    class zParticleSystem * * sys; // r9
    class zParticleSystem * * end_sys; // r10

    // References
    // -> static class zParticleSystem * * systems;
    // -> static class zParticleSystem * * system_handler_set[7];
    // -> static int system_handler_set_size[7];
}

// Range: 0x801C7D8C -> 0x801C7D90
static void sort_handler_sets() {}

// Range: 0x801C7D90 -> 0x801C7DC0
static int compare_generator_systems_function(void * e1 /* r0 */, void * e2 /* r0 */) {
    // Local variables
    const struct zParticleGenerator * g1; // r5
    const struct zParticleGenerator * g2; // r6
}

// Range: 0x801C7DC0 -> 0x801C7E94
static void sort_generators() {
    // Local variables
    class zParticleSystem * * sys; // r5
    class zParticleSystem * * end_sys; // r6
    struct zParticleGenerator * * first_gen; // r4
    struct zParticleGenerator * * last_gen; // r7
    int system_type; // r8
    struct zParticleGenerator * * found_gen; // r9

    // References
    // -> static class zParticleSystem * * systems;
    // -> static int generators_used;
    // -> static struct zParticleGenerator * * generators;
}

// Range: 0x801C7E94 -> 0x801C7FC8
static void create_generators() {
    // Local variables
    ...
    const struct zParticleAsset * asset; // r0
    struct zParticleGenerator * * gen; // r27
    int i; // r28
    struct zParticleAsset * asset; // r3

    // References
    // -> static struct zParticleGenerator * * generators;
    // -> static int generators_used;
    // -> static class zParticleSystem * * systems;
    // -> static int max_generators;
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02E78
// Range: 0x801C7FC8 -> 0x801C80F4
void zParticleSceneEnter() {
    // Local variables
    class zParticleSystem * * sys; // r31
    class zParticleSystem * * end_sys; // r30
    int size; // r0
    class zParticleSystem * * set; // r30
    class zParticleSystem * * end_set; // r31
...
// Range: 0x801C80F4 -> 0x801C81B4
void zParticleSceneExit() {
    // Local variables
    struct zParticleGenerator * * gen; // r31
    struct zParticleGenerator * * end_gen; // r30
    class zParticleSystem * * set; // r30
    class zParticleSystem * * end_set; // r31
...
struct zParticleGenerator : public xBase {
    // Functions
    void create(struct zParticleAsset & asset);
...
// Range: 0x801C81B4 -> 0x801C81E8
void zParticleGenerator::addTweaksCB(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zParticleGenerator * gen; // r3
}
...
static struct tweak_callback tweakCallback; // size: 0x28, address: 0x8043E128
static signed char init; // size: 0x1, address: 0x80C08B0C
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02E8C
// Range: 0x801C81E8 -> 0x801C83F8
void zParticleSetup() {
    // Local variables
    class zParticleSystem * * set; // r25
    class zParticleSystem * * end_set; // r26
    char prefix[128]; // r1+0x30
    class zParticleSystem * * sys; // r30
    class zParticleSystem * * end_sys; // r29
    struct zParticleGenerator * * gen; // r28
    struct zParticleGenerator * * end_gen; // r27

    // References
    // -> static struct tweak_callback tweakCallback;
...
// Range: 0x801C83F8 -> 0x801C8468
void zParticleReset() {
    // Local variables
    class zParticleSystem * * set; // r31
    class zParticleSystem * * end_set; // r30
...
// Range: 0x801C8468 -> 0x801C84E8
void zParticleUpdate(float dt /* f31 */) {
    // Local variables
    class zParticleSystem * * set; // r31
    class zParticleSystem * * end_set; // r30
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02E9C
// Range: 0x801C8558 -> 0x801C86E0
void zParticleRender() {
    // Local variables
    class zParticleSystem * * set; // r29
    class zParticleSystem * * end_set; // r30
...
// Range: 0x801C86E0 -> 0x801C8740
// this: r0
void zParticleSystem::reset() {
    // Local variables
    struct zParticleGenerator * * gen; // r31
    struct zParticleGenerator * * end_gen; // r30
}

// Range: 0x801C8740 -> 0x801C87C4
// this: r30
void zParticleGenerator::create(struct zParticleAsset & asset /* r31 */) {
    // References
    // -> static int max_system_asset_size;
}

// Range: 0x801C87C4 -> 0x801C87FC
// this: r0
void zParticleGenerator::reset() {}

// Range: 0x801C87FC -> 0x801C880C
// this: r0
void zParticleGenerator::activate() {}

// Range: 0x801C880C -> 0x801C881C
// this: r0
void zParticleGenerator::deactivate() {}

// Range: 0x801C881C -> 0x801C8824
unsigned char zParticleGenerator::cullUpdate() {}

// Range: 0x801C8824 -> 0x801C8834
// this: r0
void zParticleGenerator::pause() {}

// Range: 0x801C8834 -> 0x801C8844
// this: r0
void zParticleGenerator::resume() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C02EAC
// Range: 0x801C8844 -> 0x801C8998
void zParticleGenerator::event_handler(struct xBase * to /* r29 */, unsigned int event /* r30 */, const float * argf /* r31 */) {
    // Local variables
    struct zParticleGenerator & gen; // r3
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C02EBC
// total size: 0x50
...
// total size: 0x4
struct /* @class$1358zParticleGenerator_cpp */ {
    // Members
...
union /* @class$1023zParticleGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1496zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x801C8998 -> 0x801C8ABC
struct xEnt * zParticleGenerator::get_attach_entity(const struct zParticleAsset & asset /* r29 */) {
    // Local variables
    unsigned int id; // r31
    struct xBase * ent; // r30
    struct xEnt * pEnt; // r0
...
// Range: 0x801C8ABC -> 0x801C8BC4
void zParticleGenerator::perturb_dir(struct xVec3 & dir /* r31 */, float angle /* f0 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$972zParticleGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$973zParticleGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zParticleGenerator_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$975zParticleGenerator_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$976zParticleGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$977zParticleGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$978zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x801C8BC4 -> 0x801C8C24
void zParticleGenerator::on_tweaked(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zParticleGenerator * gen; // r3
}

static struct tweak_callback on_tweaked_cb; // size: 0x28, address: 0x803EAE10
// Range: 0x801C8C24 -> 0x801C8CE8
// this: r31
void zParticleGenerator::add_tweaks(const char * prefix /* r30 */) {
    // Local variables
    struct zParticleAsset & a; // r31

    // References
    // -> static struct tweak_callback on_tweaked_cb;
}

enum /* @enum$1764zParticleGenerator_cpp */ {
    FLAG_ON = 1,
    FLAG_RUNNING = 2,
};
// Range: 0x801C8CE8 -> 0x801C8CEC
void zParticleGenerator::debug_render() {}

// total size: 0x2C
struct {} zParticleGenerator::__vtable; // size: 0x2C, address: 0x8043E150
// total size: 0x3C
struct {} zParticleSystem::__vtable; // size: 0x3C, address: 0x8043E17C
// total size: 0x8
