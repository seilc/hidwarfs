/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompSteeringGeneric.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C4438 -> 0x802C5834
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zCompSteeringGenericParams : public zCompParameters {
    // Functions
    void AddTweaks(const char * parentName, const char * branchName);
...
static class zCompSteeringGenericParams gDefaultSteeringBasicParams; // size: 0x3C, address: 0x80BD4708
// Range: 0x802C4438 -> 0x802C4700
// this: r31
void zCompSteeringGenericParams::AddTweaks(const char * parentName /* r0 */, const char * branchName /* r5 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1038zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zCompSteeringGeneric_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zCompSteeringGeneric_cpp */ {
    // Members
...
// Range: 0x802C4700 -> 0x802C4778
// this: r30
void zSteeringGenericDynamics::Initialize(class zICompNPCEntity * npcEnt /* r31 */) {}
...
// total size: 0x68
struct {} zCompSteeringGeneric::__vtable; // size: 0x68, address: 0x80449168
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
class zCompSteeringGeneric : public zICompSteering {
    // Functions
    zCompSteeringGeneric();

    void Attached();

    void SetParameters(const class zCompParameters * parameters);
    ...
    void CalculateAcc(struct xVec3 & acc, class zSteeringGenericDynamics & steeringDynamics, float dt);

    unsigned char CalculateVelConstraints(struct xVec3 & dVel, class zSteeringGenericDynamics & steeringDynamics, float dt);

    unsigned char CalculatePosConstraints(struct xVec3 & dPos, float & velCorrectionRatio, class zSteeringGenericDynamics & steeringDynamics, float dt);

    void CalculateFacing(struct xVec3 & facing, class zSteeringGenericDynamics & steeringDynamics);

    float GetWanderAcc(struct xVec3 & wanderAcc, class zSteeringGenericDynamics & steeringDynamics, float dt);

    float GetWallAvoidenceAcc(struct xVec3 & avoidenceForce);

    float GetVelCorrectionAcc(struct xVec3 & corAcc, const struct xVec3 & desiredVel, const class zSteeringGenericDynamics & steeringDynamics, float dt);

    float GetSeekAcc(struct xVec3 & seekAcc, class zSteeringGenericDynamics & steeringDynamics, float dt);

    unsigned char GetSweptCircleCollDPos(struct xVec3 & collDPos, float & velCorrectionRatio, class zSteeringGenericDynamics & steeringDynamics, float dt);
...
// Range: 0x802C4778 -> 0x802C47B4
// this: r31
zCompSteeringGeneric::zCompSteeringGeneric() {
    // References
    // -> struct [anonymous] zCompSteeringGeneric::__vtable;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C06918
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x802C47B4 -> 0x802C48CC
// this: r30
void zCompSteeringGeneric::Attached() {
    // Local variables
    ...
    // -> static class zCompSteeringGenericParams gDefaultSteeringBasicParams;
}
...
// Range: 0x802C48CC -> 0x802C48E0
// this: r0
void zCompSteeringGeneric::SetParameters(const class zCompParameters * parameters /* r0 */) {}

// Range: 0x802C48E0 -> 0x802C48E4
void zCompSteeringGeneric::Detached() {}

// Range: 0x802C48E4 -> 0x802C48E8
void zCompSteeringGeneric::Reset() {}

// Range: 0x802C48E8 -> 0x802C48EC
void zCompSteeringGeneric::Update() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06924
// Range: 0x802C48EC -> 0x802C4988
// this: r0
unsigned char zCompSteeringGeneric::SystemEvent(unsigned int to_event /* r0 */, struct xBase * to_param_widget /* r0 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static unsigned char renderWallAvoidenceForce; // size: 0x1, address: 0x80C06930
static unsigned char renderSphereAvoidenceForce; // size: 0x1, address: 0x80C097D8
static unsigned char renderWanderForce; // size: 0x1, address: 0x80C097D9
static unsigned char renderDestForce; // size: 0x1, address: 0x80C06931
static unsigned char renderTotalForce; // size: 0x1, address: 0x80C097DA
// Range: 0x802C4988 -> 0x802C4AB4
void zCompSteeringGeneric::AddStaticTweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static unsigned char renderTotalForce;
    // -> static unsigned char renderDestForce;
...
static struct xVec3 ArrowDrawOffset; // size: 0xC, address: 0x80C06934
// Range: 0x802C4AB4 -> 0x802C4B30
void zCompSteeringGeneric::DebugRenderForce(const struct xVec3 * entPos /* r0 */, struct xVec3 * Force /* r30 */, unsigned char render /* r0 */, struct xColor_tag & color /* r31 */) {
    // Local variables
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C06940
// Range: 0x802C4B30 -> 0x802C4CCC
// this: r30
void zCompSteeringGeneric::ApplySteering(class zICompNPCEntity * npcEnt /* r31 */, float dt /* f31 */) {
    // Local variables
    class zSteeringGenericDynamics steeringDynamics; // r1+0x3C
    struct xVec3 acc; // r1+0x30
    struct xVec3 dVel; // r1+0x24
    struct xVec3 dPos; // r1+0x18
    struct xVec3 facing; // r1+0xC
    float velCorrectionRatio; // r1+0x8

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C06950
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x802C4CCC -> 0x802C4F0C
// this: r28
void zCompSteeringGeneric::CalculateAcc(struct xVec3 & acc /* r29 */, class zSteeringGenericDynamics & steeringDynamics /* r30 */, float dt /* f30 */) {
    // Local variables
    float accMag; // r1+0x14
    const class zCompSteeringGenericParams * params; // r0
    struct xVec3 WallAvoidenceAcc; // r1+0x30
    float WallAvoidenceMag; // f31
    struct xVec3 destAcc; // r1+0x24
    float destMag; // f31
    struct xVec3 WanderAcc; // r1+0x18
    float WanderMag; // f31
...
// Range: 0x802C4F0C -> 0x802C5070
// this: r30
unsigned char zCompSteeringGeneric::CalculateVelConstraints(struct xVec3 & dVel /* r28 */, class zSteeringGenericDynamics & steeringDynamics /* r29 */, float dt /* f30 */) {
    // Local variables
    unsigned char nonZeroDVel; // r30
    const class zCompSteeringGenericParams * params; // r0
...
// Range: 0x802C5070 -> 0x802C50EC
// this: r28
unsigned char zCompSteeringGeneric::CalculatePosConstraints(struct xVec3 & dPos /* r29 */, float & velCorrectionRatio /* r30 */, class zSteeringGenericDynamics & steeringDynamics /* r31 */, float dt /* f31 */) {
    // Local variables
    unsigned char nonZeroDPos; // r0

    // References
    // -> struct xVec3 m_Null;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C06960
// Range: 0x802C50EC -> 0x802C51CC
// this: r29
void zCompSteeringGeneric::CalculateFacing(struct xVec3 & facing /* r30 */, class zSteeringGenericDynamics & steeringDynamics /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x802C51CC -> 0x802C52AC
unsigned char zCompSteeringGeneric::AccumulateVec(struct xVec3 & curTotalVec /* r30 */, float & curTotalMag /* r31 */, float maxMag /* f0 */, const struct xVec3 & vecToAdd /* r6 */, float magToAdd /* f30 */) {
    // Local variables
    float wantedMag; // f31
    struct xVec3 truncatedVector; // r1+0x8
}

// Range: 0x802C52AC -> 0x802C53B0
// this: r28
float zCompSteeringGeneric::GetWanderAcc(struct xVec3 & wanderAcc /* r29 */, class zSteeringGenericDynamics & steeringDynamics /* r30 */, float dt /* f31 */) {
    // Local variables
    const class zCompSteeringGenericParams * params; // r0
    float JitterThisTimeSlice; // f31
    struct xVec3 RandomVector; // r1+0x14
    float magForward; // f31
...
// total size: 0x1
class zNPCHelper {};
// Range: 0x802C53B0 -> 0x802C5488
// this: r30
float zCompSteeringGeneric::GetWallAvoidenceAcc(struct xVec3 & avoidenceForce /* r31 */) {
    // Local variables
    float avoidenceForceScale; // f31
    struct xVec2 * wallNormal; // r0
...
// Range: 0x802C5488 -> 0x802C559C
// this: r28
float zCompSteeringGeneric::GetVelCorrectionAcc(struct xVec3 & corAcc /* r29 */, const struct xVec3 & desiredVel /* r30 */, const class zSteeringGenericDynamics & steeringDynamics /* r31 */, float dt /* f30 */) {
    // Local variables
    struct xVec3 diffVelocity; // r1+0x8
    float diffVelocityMag; // f31
    float accMag; // f30
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C06970
// Range: 0x802C559C -> 0x802C56A8
// this: r29
float zCompSteeringGeneric::GetSeekAcc(struct xVec3 & seekAcc /* r30 */, class zSteeringGenericDynamics & steeringDynamics /* r31 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C0697C
// Range: 0x802C56A8 -> 0x802C5834
// this: r28
unsigned char zCompSteeringGeneric::GetSweptCircleCollDPos(struct xVec3 & collDPos /* r29 */, float & velCorrectionRatio /* r30 */, class zSteeringGenericDynamics & steeringDynamics /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1097zCompSteeringGeneric_cpp */ {
    // Members
...
union /* @class$1236zCompSteeringGeneric_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCompSteeringGeneric_cpp */ {
    // Members
