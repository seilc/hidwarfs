/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zContextObjectClimbableRope.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026BBCC -> 0x8026D310
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float ROPE_RADIUS; // size: 0x4, address: 0x80C054F8
static int ROPE_SEGMENTS; // size: 0x4, address: 0x80C054FC
static float SPEED_Y_MIN; // size: 0x4, address: 0x80C05500
static float SPEED_XZ_MIN; // size: 0x4, address: 0x80C05504
static float MOUNT_RADIUS; // size: 0x4, address: 0x80C05508
static float DIR_COS; // size: 0x4, address: 0x80C0550C
static float Y_ABOVE; // size: 0x4, address: 0x80C05510
static float Y_BELOW; // size: 0x4, address: 0x80C05514
static float SWING_DIST; // size: 0x4, address: 0x80C05518
static float SPEED_UP; // size: 0x4, address: 0x80C0551C
static float SPEED_DOWN; // size: 0x4, address: 0x80C05520
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 GRAB_POINT_UP; // size: 0xC, address: 0x80C05524
static struct xVec3 GRAB_POINT_DOWN; // size: 0xC, address: 0x80C05530
static float SWING_PERIOD; // size: 0x4, address: 0x80C0553C
static float SWING_ANGULAR_FREQ; // size: 0x4, address: 0x80C09320
static float SWING_ANGLE_MAX; // size: 0x4, address: 0x80C05540
static float SWING_INPUT_ACCEL; // size: 0x4, address: 0x80C05544
static float SWING_DAMPEN_K; // size: 0x4, address: 0x80C05548
static float SWING_DAMPEN_K_FREE; // size: 0x4, address: 0x80C0554C
// Range: 0x8026BBCC -> 0x8026BBE0
...
// total size: 0x4
struct /* @class$1136zContextObjectClimbableRope_cpp */ {
    // Members
...
union /* @class$1275zContextObjectClimbableRope_cpp */ {
...
// total size: 0xC
struct /* @class$1274zContextObjectClimbableRope_cpp */ {
    // Members
...
// Range: 0x8026BC30 -> 0x8026BCFC
// this: r30
void zCollidable::SetupCollision(const struct xBox & box /* r31 */) {}

// Range: 0x8026BCFC -> 0x8026BD44
// this: r30
void zCollidable::UpdateCollision(const struct xMat4x3 & mat /* r31 */) {}

// Range: 0x8026BD44 -> 0x8026BDB0
// this: r30
void zCollidable::UpdateCollision(const struct xVec3 & pos /* r31 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1077zContextObjectClimbableRope_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1079zContextObjectClimbableRope_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1080zContextObjectClimbableRope_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1081zContextObjectClimbableRope_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1082zContextObjectClimbableRope_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1083zContextObjectClimbableRope_cpp */ {
    // Members
...
static struct tweak_callback recalcAngFreqCB; // size: 0x28, address: 0x80401120
...
// Range: 0x8026C0EC -> 0x8026C124
// this: r0
unsigned char zContextObjectClimbableRope::Ascend(float dt /* f0 */) {
    // References
    // -> static float SPEED_UP;
}

// Range: 0x8026C124 -> 0x8026C188
// this: r31
unsigned char zContextObjectClimbableRope::Descend(float dt /* f0 */) {
    // References
    // -> static float SPEED_DOWN;
}

// Range: 0x8026C188 -> 0x8026C190
// this: r0
void zContextObjectClimbableRope::SwingInput(float stickMagnitude /* f0 */) {}

// Range: 0x8026C190 -> 0x8026C1F4
// this: r31
...
// Range: 0x8026C1F4 -> 0x8026C5D8
// this: r31
void zContextObjectClimbableRope::Update(float dt /* f29 */) {
    // Local variables
    float swingAngleMax; // f30
    float gravityAcceleration; // f31
    float newVel; // f28
    float maxVel; // f1
    struct xVec3 ropeUp; // r1+0x14
    struct xBBox & topBox; // r0
    struct xMat4x3 topMat; // r1+0x20
    struct xBBox & bottomBox; // r0
    int i; // r29
...
// Range: 0x8026C5D8 -> 0x8026CA4C
// this: r31
void zContextObjectClimbableRope::Render() const {
    // Local variables
    struct xIMLockContext lock; // r1+0x74
    class xIMVertexIterator currentVertex; // r1+0x68
    float swingAngleCos; // f29
    float swingAngleSin; // f0
    struct xVec3 topUp; // r1+0x5C
    struct xVec3 topRight; // r1+0x50
    float bottomAngle; // f28
    float bottomAngleCos; // f29
    float bottomAngleSin; // f0
    struct xVec3 bottomUp; // r1+0x44
    struct xVec3 bottomRight; // r1+0x38
    int i; // r25
    float fraction; // f27
    float angle; // f26
    float sinRadius; // f25
    float cosRadius; // f26
    struct xVec3 topPos; // r1+0x2C
    struct xVec3 bottomPos; // r1+0x20
    struct xVec3 endPos; // r1+0x14
    int i; // r25
    float fraction; // f25
    float angle; // f26
    float sinRadius; // f27
    float cosRadius; // f26
    struct xVec3 bottomPos; // r1+0x8
...
// Range: 0x8026CA4C -> 0x8026CB34
void zContextObjectClimbableRope::RenderAll() {
    // Local variables
    unsigned int count; // r26
    class zContextObjectClimbableRope * ropeList; // r25
    unsigned char * rendered; // r24
    unsigned int i; // r23
    unsigned int j; // r22
...
// total size: 0x14
struct {} zContextObjectClimbableRope::__vtable; // size: 0x14, address: 0x80C05558
struct xVec3 m_UnitAxisY; // size: 0xC, address: 0x80C0B564
// Range: 0x8026CB34 -> 0x8026CBCC
// this: r30
zContextObjectClimbableRope::zContextObjectClimbableRope(struct Asset * theAsset /* r31 */) {
    // References
    // -> struct xVec3 m_UnitAxisY;
    // -> struct [anonymous] zContextObjectClimbableRope::__vtable;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05550
// Range: 0x8026CBCC -> 0x8026CD6C
void zContextObjectClimbableRope::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8026CE88 -> 0x8026CEC0
// this: r3
struct xVec3 & zContextObjectClimbableRope::GetPos() const {}

// Range: 0x8026CEC0 -> 0x8026D028
// this: r29
unsigned char zContextObjectClimbableRope::CanMount(struct zCommonPlayer * player /* r30 */, float & priority /* r31 */) const {
    // Local variables
    struct xVec3 playerPos; // r1+0x14
    const struct xVec3 & ropePos; // r3
...
// total size: 0x890
struct /* @class$2064zContextObjectClimbableRope_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$1672zContextObjectClimbableRope_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1673zContextObjectClimbableRope_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2211zContextObjectClimbableRope_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2210zContextObjectClimbableRope_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2213zContextObjectClimbableRope_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1817zContextObjectClimbableRope_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8026D028 -> 0x8026D208
// this: r27
unsigned char zContextObjectClimbableRope::Mount(struct zCommonPlayer * player /* r28 */, float dt /* f31 */) {
    // Local variables
    unsigned char match; // r0
    struct xVec3 playerPos; // r1+0x18
    const struct xVec3 & ropePos; // r30
    struct xVec3 & dpos; // r29
    struct xVec3 diff; // r1+0xC
    float minUpDpos; // f1
    float diffXZLength2; // f0
    float dposXZLength2; // f3
    float minTranslation2; // f2
...
// Range: 0x8026D208 -> 0x8026D278
// this: r31
void zContextObjectClimbableRope::Reset() {}

// Range: 0x8026D278 -> 0x8026D2C4
// this: r3
