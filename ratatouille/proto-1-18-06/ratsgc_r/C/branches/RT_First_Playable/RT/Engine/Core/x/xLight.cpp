/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xLight.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800769DC -> 0x80079544
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xLight * sLight[128]; // size: 0x200, address: 0x80A7A0D0
static int sLightTotal; // size: 0x4, address: 0x80C07420
static struct xLight sTempLights[16]; // size: 0x2580, address: 0x80A7A2D0
static struct xLightAsset sTempLightAssets[16]; // size: 0x4C0, address: 0x80A7C850
static struct xModelInstance * sTempLightCards[16]; // size: 0x40, address: 0x80A7CD10
// total size: 0xC
struct lightFlash {
    // Members
...
static struct lightFlash sLightFlashes[4]; // size: 0x30, address: 0x80A7CD50
// Range: 0x800769DC -> 0x80076AF4
void xLightResetAll() {
    // Local variables
    int i; // r0
...
// Range: 0x80076AF4 -> 0x80076B1C
void xLightSceneInit() {}

// Range: 0x80076B1C -> 0x80076B40
void xLightSceneExit() {}

// Range: 0x80076B40 -> 0x80076B60
void xLightSceneReset() {
    // References
    // -> static struct lightFlash sLightFlashes[4];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFD118
// Range: 0x80076B60 -> 0x80076CD4
void xLightInit(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// total size: 0x1
struct /* @class$1065xLight_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1066xLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1067xLight_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1068xLight_cpp */ {
    // Members
...
// Range: 0x80076CD4 -> 0x80076D10
void DetachLightCB(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct xLight * light; // r5
}
...
static struct tweak_callback detachLight; // size: 0x28, address: 0x803B0378
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFD124
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80076D10 -> 0x8007731C
void xLightInit(struct xBase * b /* r31 */, struct xLightAsset * tasset /* r30 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFD130
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8007731C -> 0x800774F0
void xLightInitTempLights() {
    // Local variables
    struct RpAtomic * lightCardModel; // r26
    int i; // r25
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804186F8
// total size: 0x10
struct _xFColor {
    // Members
...
// Range: 0x800774F0 -> 0x80077694
struct xLight * xLightCreateTempInternal(unsigned char useLightCard /* r26 */, const char * fileName /* r27 */, unsigned int lineNumber /* r28 */) {
    // Local variables
    int i; // r29
    struct _xFColor color; // r1+0x8
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80418714
// Range: 0x80077694 -> 0x80077798
void xLightDestroyTempInternal(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[26];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFD148
// Range: 0x80077798 -> 0x800778A4
void xLightResolveLinks() {
    // Local variables
    int i; // r30
    struct xLight * xl; // r29
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFD15C
// Range: 0x80077918 -> 0x800779BC
void xLightDestroy(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD16C
// Range: 0x800779BC -> 0x80077B40
void xLightReset(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFD178
// Range: 0x80077B40 -> 0x80077F04
void xLightEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r29 */) {
    // Local variables
    struct xLight * xl; // r31
    unsigned char resetEffect; // r30
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFD188
// total size: 0x1C
...
// Range: 0x80077F04 -> 0x80078294
static void xLightUpdateLightCard(struct xLight * xl /* r31 */) {
    // Local variables
    struct xVec3 pos; // r1+0x48
    struct xMat4x3 cameraMat; // r1+0x60
    struct RwMatrixTag * modelMat; // r30
    float right_len; // f31
    float up_len; // f30
    float at_len; // f29
    ...
    struct RpGeometry * geometery; // r30
...
// Range: 0x80078294 -> 0x8007854C
void xLightUpdateAll(float dt /* f31 */) {
    // Local variables
    int i; // r30
    struct xLight * xl; // r29
    float percentage; // f2
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD1A0
// total size: 0x40
struct RwMatrixTag {
    // Members
...
// Range: 0x8007854C -> 0x800786B8
void xLightRenderAll() {
    // Local variables
    int i; // r30
    struct xLight * xlight; // r29
...
// Range: 0x800786B8 -> 0x80078760
void xLightAddLocalEnv(struct xEnv * env /* r28 */) {
    // Local variables
    int i; // r30
    struct xLight * xlight; // r4
...
// Range: 0x80078760 -> 0x80078780
void xLightRemoveLocalEnv(struct xEnv * env /* r0 */) {}
...
struct xGrid grabbable_grid; // size: 0x38, address: 0x80B93230
...
// Range: 0x80078780 -> 0x8007894C
void xLightPrepLocal() {
    // Local variables
    int i; // r29
    struct xLight * xlight; // r28
    const struct xSphere * lightSphere; // r27
...
// Range: 0x8007894C -> 0x80078B3C
// this: r31
static unsigned char xLightCollisionCallback::operator()(struct xEnt & ent /* r30 */) {
    // Local variables
    struct xCollis coll; // r1+0x8
    struct xModelInstance * model; // r5
    int furthestLight; // r4
    int i; // r0
    int freeLight; // r6
}

// Range: 0x80078B3C -> 0x80078B48
// this: r0
static xLightCollisionCallback::xLightCollisionCallback(const struct xSphere & sphere /* r0 */, struct xLight * light /* r0 */) {}
...
// Range: 0x80078B48 -> 0x80078BB0
void xLightAddLocal(struct xModelInstance * minst /* r3 */) {
    // Local variables
    struct xLight * * xlights; // r4
    struct iLight * ilights[4]; // r1+0x8
    int i; // r5
}

// Range: 0x80078BB0 -> 0x80078C34
void xLightRemoveLocal(struct xModelInstance * minst /* r3 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD1B0
// Range: 0x80078C34 -> 0x80078D04
void xLightSetEffect(struct xLight * xl /* r29 */, unsigned int effectID /* r30 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD1C0
// Range: 0x80078D04 -> 0x80078DFC
void xLightResetEffect(struct xLight * xl /* r31 */) {
    // References
    // -> static char __FUNCTION__[18];
}

// Range: 0x80078DFC -> 0x80078EC0
void xLightOn(struct xLight * xl /* r31 */, unsigned char on /* r0 */, float transitionTime /* f0 */) {}

// Range: 0x80078EC0 -> 0x80078EFC
void xLightToggle(struct xLight * xl /* r0 */, float transitionTime /* f0 */) {}

// Range: 0x80078EFC -> 0x80078F50
void xLightSetColor(struct xLight * xl /* r0 */, float r /* f0 */, float g /* f0 */, float b /* f0 */, float transitionTime /* f4 */) {
    // Local variables
    struct _xFColor col; // r1+0x8
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD1D4
// Range: 0x80078F50 -> 0x80079134
void xLightSetColor(struct xLight * xl /* r30 */, const struct _xFColor & col /* r31 */, float transitionTime /* f31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x80079158 -> 0x8007917C
void xLightGetColor(struct xLight * xl /* r3 */, struct _xFColor & col /* r0 */) {}

// Range: 0x8007917C -> 0x800791A0
void xLightSetPos(struct xLight * xl /* r3 */, const struct xVec3 & pos /* r0 */) {}

// Range: 0x800791A0 -> 0x800791C4
void xLightSetRadius(struct xLight * xl /* r3 */, float radius /* f0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD1E4
// Range: 0x800791C4 -> 0x80079404
void xLightFlash(const struct xVec3 & pos /* r30 */, const struct _xFColor & color /* r31 */, float radius /* f28 */, float upTime /* f29 */, float maxTime /* f30 */, float downTime /* f31 */) {
    // Local variables
    struct lightFlash * flash; // r29
    int i; // r4
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD1F0
// Range: 0x80079404 -> 0x80079544
