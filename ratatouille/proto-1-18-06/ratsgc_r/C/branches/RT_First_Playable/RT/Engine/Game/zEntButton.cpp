/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zEntButton.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8010F150 -> 0x801101D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sRedMultiplier; // size: 0x4, address: 0x80C00140
static float sGreenMultiplier; // size: 0x4, address: 0x80C00144
static float sBlueMultiplier; // size: 0x4, address: 0x80C00148
// Range: 0x8010F150 -> 0x8010F170
void zEntButton_Init(void * ent /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0014C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1085zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zEntButton_cpp */ {
    // Members
...
// Range: 0x8010F170 -> 0x8010F40C
void zEntButton_Init(struct _zEntButton * ent /* r30 */, struct xEntAsset * asset /* r28 */) {
    // Local variables
    struct zEntButtonAsset * passet; // r29
    struct xEntMotionAsset * emasset; // r31
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C07C98
static signed char init; // size: 0x1, address: 0x80C07C99
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0015C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8010F40C -> 0x8010F53C
void zEntButton_Move(struct _zEntButton * ent /* r29 */, struct xScene * s /* r30 */, float dt /* f31 */, struct xEntFrame * frame /* r31 */) {
    // Local variables
    struct xEntFrame * dframe; // r5
...
// Range: 0x8010F53C -> 0x8010F580
void zEntButton_Setup(struct _zEntButton * ent /* r30 */, struct xScene * sc /* r31 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0016C
// total size: 0x0
...
// Range: 0x8010F580 -> 0x8010F6A0
void zEntButton_Save(struct _zEntButton * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0017C
// Range: 0x8010F6A0 -> 0x8010F7BC
void zEntButton_Load(struct _zEntButton * ent /* r30 */, struct xSerial * s /* r31 */) {
    // Local variables
    int pressed; // r1+0xC
    int pushing; // r1+0x8
...
// Range: 0x8010F7BC -> 0x8010F88C
void zEntButton_Reset(struct _zEntButton * ent /* r30 */, struct xScene * sc /* r31 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C0018C
// Range: 0x8010F88C -> 0x8010FB68
void zEntButton_Update(struct _zEntButton * ent /* r31 */, struct xScene * sc /* r4 */, float dt /* f31 */) {
    // References
...
// Range: 0x8010FB68 -> 0x8010FC08
void zEntButton_Render(struct _zEntButton * ent /* r30 */) {
    // Local variables
...
// Range: 0x8010FC08 -> 0x8010FC20
void zEntButton_SetReady(struct _zEntButton * ent /* r0 */) {}

// Range: 0x8010FC20 -> 0x8010FC40
static void zEntButton_Press(struct _zEntButton * ent /* r0 */) {}

// Range: 0x8010FC40 -> 0x8010FC9C
static void _PressButtonSound(struct _zEntButton * ent /* r31 */) {}

// Range: 0x8010FC9C -> 0x8010FD00
void zEntButton_Press(struct _zEntButton * ent /* r30 */, unsigned int mask /* r31 */) {}
...
// total size: 0x10
struct /* @class$1856zEntButton_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x8010FD00 -> 0x8010FDF8
void zEntButton_Hold(struct _zEntButton * ent /* r31 */, unsigned int mask /* r0 */) {
    // Local variables
    struct xVec3 * player; // r5
...
// total size: 0x890
struct /* @class$2103zEntButton_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1026zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zEntButton_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zEntButton_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zEntButton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zEntButton_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zEntButton_cpp */ {
    // Members
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C001A0
// total size: 0x1C
...
// Range: 0x8010FDF8 -> 0x801101D4
void zEntButtonEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
