/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCollideSphereBox.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8019A3A0 -> 0x8019CBD0
*/
// total size: 0x24
struct xRay3 {
    // Members
...
static struct xBoxFace box_faces[6]; // size: 0x480, address: 0x8043D2B0
static struct xEdge * box_edges[6][6]; // size: 0x90, address: 0x8043D730
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D7C0
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D7DC
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D7F8
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D814
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D830
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D84C
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D868
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D884
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D8A0
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D8BC
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D8D8
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043D8F4
// total size: 0x18
struct xBox {
    // Members
...
// total size: 0x4
struct /* @class$1088xCollideSphereBox_cpp */ {
    // Members
...
union /* @class$1236xCollideSphereBox_cpp */ {
...
// Range: 0x8019AA90 -> 0x8019AB68
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019AB68 -> 0x8019AC18
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019AC18 -> 0x8019ACF4
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019ACF4 -> 0x8019AD10
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x8019AD10 -> 0x8019ADC0
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019ADC0 -> 0x8019AE9C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019AE9C -> 0x8019AF6C
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019AF6C -> 0x8019B01C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B01C -> 0x8019B0F8
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019B0F8 -> 0x8019B114
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x8019B114 -> 0x8019B1C4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B1C4 -> 0x8019B2A0
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019B2A0 -> 0x8019B378
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B378 -> 0x8019B428
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B428 -> 0x8019B504
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019B504 -> 0x8019B5B4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B5B4 -> 0x8019B690
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019B690 -> 0x8019B740
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B740 -> 0x8019B7F0
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B7F0 -> 0x8019B8A0
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019B8A0 -> 0x8019B97C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019B97C -> 0x8019BA2C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BA2C -> 0x8019BADC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BADC -> 0x8019BAF8
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x8019BAF8 -> 0x8019BBA8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BBA8 -> 0x8019BC80
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019BC80 -> 0x8019BD50
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BD50 -> 0x8019BE00
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BE00 -> 0x8019BED8
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019BED8 -> 0x8019BF88
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019BF88 -> 0x8019C064
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019C064 -> 0x8019C114
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019C114 -> 0x8019C1C4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019C1C4 -> 0x8019C274
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019C274 -> 0x8019C350
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x8019C350 -> 0x8019C400
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019C400 -> 0x8019C4B0
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}
...
// Range: 0x8019C9A0 -> 0x8019CA68
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x8019CA68 -> 0x8019CAF8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8
