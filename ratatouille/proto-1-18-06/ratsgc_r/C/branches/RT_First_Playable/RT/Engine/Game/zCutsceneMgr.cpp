/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCutsceneMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80104454 -> 0x80105D20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int demoDisableHackTable[1]; // size: 0x4, address: 0x80BFFE40
// total size: 0x8
struct RwObject {
    // Members
...
struct zCutsceneHack cutsceneHackTable[15]; // size: 0xC30, address: 0x80437B30
// Range: 0x80104454 -> 0x8010445C
int zCutsceneMgrGetHackTableSize() {}

// Range: 0x8010445C -> 0x80104470
struct zCutsceneHack & zCutsceneMgrGetHackTableDataByIdx(int idx /* r0 */) {
    // References
    // -> struct zCutsceneHack cutsceneHackTable[15];
}

static int gCutsceneSkipOK; // size: 0x4, address: 0x80C07BD8
static unsigned char ents_hidden; // size: 0x1, address: 0x80C07BDC
// Range: 0x80104470 -> 0x80104490
void zCutsceneMgrInit(void * b /* r0 */, void * tasset /* r0 */) {}
...
// Range: 0x80104490 -> 0x80104510
void zCutsceneMgrInit(struct xBase * b /* r30 */, struct xCutsceneMgrAsset * tasset /* r31 */) {
    // Local variables
    struct zCutsceneMgr * t; // r0

    // References
    // -> static unsigned char ents_hidden;
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFFE44
// Range: 0x80104510 -> 0x80104600
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFFE58
// total size: 0x0
...
// Range: 0x80104600 -> 0x8010466C
void zCutsceneMgrSave(struct xSerial * s /* r0 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFFE6C
// Range: 0x8010466C -> 0x801046D8
void zCutsceneMgrLoad(struct xSerial * s /* r0 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x801046D8 -> 0x80104700
static struct RpAtomic * NextAtomicCallback(struct RpAtomic * atomic /* r3 */, void * data /* r0 */) {
    // Local variables
    struct RpAtomic * * nextModel; // r0
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFFE80
// Range: 0x80104700 -> 0x80104A7C
static void zCutsceneMgrPlayStart(struct zCutsceneMgr * t /* r28 */) {
    // Local variables
    unsigned int i; // r15
    unsigned int j; // r31
    unsigned int hackid; // r30
    unsigned char hacked; // r0
    unsigned int counter; // r29
    struct RpAtomic * tmpModel; // r6
    struct xCutsceneData * mphdata; // r3
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFFE98
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$1085zCutsceneMgr_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zCutsceneMgr_cpp */ {
    // Members
...
union /* @class$820zCutsceneMgr_cpp */ {
...
// total size: 0x10
struct /* @class$1814zCutsceneMgr_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80104A7C -> 0x80104DD8
void zCutsceneMgrEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r29 */, const float * toParam /* r30 */) {
    // Local variables
    struct zCutsceneMgr * t; // r31
    unsigned char disableCutscene; // r4
    unsigned int i; // r0
    int rc; // r0
...
float csDebug_Speed; // size: 0x4, address: 0x80BFFEAC
int csDebug_KeepSpeed; // size: 0x4, address: 0x80C07BE0
unsigned char thisShouldAlwaysBeFalseItsJustToFoolTheStupidCompiler; // size: 0x1, address: 0x80C07BE4
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFFEB0
// Range: 0x80104DD8 -> 0x80104F20
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFFEC7
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x80104F20 -> 0x801050D8
...
// total size: 0x890
struct /* @class$2061zCutsceneMgr_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1026zCutsceneMgr_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zCutsceneMgr_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zCutsceneMgr_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zCutsceneMgr_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zCutsceneMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zCutsceneMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zCutsceneMgr_cpp */ {
    // Members
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFFEE0
// total size: 0x14
struct xPECircle {
    // Members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFFEF4
// Range: 0x801051E0 -> 0x8010538C
...
static int doCineFX; // size: 0x4, address: 0x80C07BE8
static signed char init; // size: 0x1, address: 0x80C07BEC
static int roller; // size: 0x4, address: 0x80C07BF0
static signed char init; // size: 0x1, address: 0x80C07BF4
static int inker; // size: 0x4, address: 0x80C07BF8
static signed char init; // size: 0x1, address: 0x80C07BFC
static float scl_fasterMin; // size: 0x4, address: 0x80C07C00
static signed char init; // size: 0x1, address: 0x80C07C04
static float scl_fasterMax; // size: 0x4, address: 0x80C07C08
static signed char init; // size: 0x1, address: 0x80C07C0C
static float scl_faster; // size: 0x4, address: 0x80C07C10
static signed char init; // size: 0x1, address: 0x80C07C14
static float makeFastFaster; // size: 0x4, address: 0x80C07C18
static signed char init; // size: 0x1, address: 0x80C07C1C
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFFF0C
struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80A84818
float VBLANKS_PER_SEC; // size: 0x4, address: 0x80C00BD8
// Range: 0x8010538C -> 0x80105B84
