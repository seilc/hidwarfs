/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMeshCollision.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F95A4 -> 0x801FB0B4
*/
static unsigned int gTriangleFlags[3][256]; // size: 0xC00, address: 0x80BC3088
static unsigned int gCurrentFlagValue; // size: 0x4, address: 0x80C08DC0
static int gRecursiveCallCount; // size: 0x4, address: 0x80C08DC4
// Range: 0x801F95A4 -> 0x801F95F8
...
// Range: 0x801F95F8 -> 0x801F9794
static unsigned char zMeshCollisionSweptCircleToPoint(class zMeshSweptCircle & sweptCircle /* r28 */, const struct xVec3 & point /* r29 */, const struct xVec2 & toStart /* r30 */, const struct xVec2 & fallbackHitNormal /* r31 */) {
    // Local variables
...
static char __FUNCTION__[39]; // size: 0x27, address: 0x8043E908
// Range: 0x801F9794 -> 0x801F9D94
static unsigned char zMeshCollisionSweptCircleToMeshRecurse(class zMeshSweptCircle & sweptCircle /* r21 */, class xNavigationMeshAsset * mesh /* r22 */, int subMeshIndex /* r23 */, int triangleIndex /* r24 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh & subMesh; // r28
    struct Triangle & tri; // r27
    ...
    float startAlong; // f28
    float endAlong; // f0
    struct xVec2 v1ToStart; // r1+0x10
    float percentDistTillTouchEdge; // f2
    float touchAlong; // f1
...
static char __FUNCTION__[32]; // size: 0x20, address: 0x8043E930
// Range: 0x801F9D94 -> 0x801F9E7C
unsigned char zMeshCollisionSweptCircleToMesh(class zMeshSweptCircle & sweptCircle /* r28 */, class zMeshPosition & meshPosition /* r29 */) {
    // References
    // -> static int gRecursiveCallCount;
...
// Range: 0x801F9E7C -> 0x801FA054
unsigned char zMeshCollisionSweptCircleToCircles(class zMeshSweptCircle & sweptCircle /* r29 */, class zMeshCircle * nearbyCircles /* r4 */) {
    // Local variables
    struct xVec2 movementNormal; // r1+0x18
    unsigned char hitSomething; // r31
    class zMeshCircle * circle; // r30
    struct xVec2 startToCenter; // r1+0x10
    float distAway; // f30
    float combinedRadius; // f29
    float distAlong; // f0
    float firstContactDist; // f0
    struct xVec2 end; // r1+0x8
}
...
// total size: 0x4
struct /* @class$1136zMeshCollision_cpp */ {
    // Members
...
union /* @class$1284zMeshCollision_cpp */ {
...
// total size: 0xC
struct /* @class$1274zMeshCollision_cpp */ {
    // Members
...
// Range: 0x801FA054 -> 0x801FA0DC
static unsigned char zMeshCollisionCheckNaiveResponseWorks(int stuckCollisions /* r27 */, struct CircleCollisionResults * sceneCollide /* r28 */, int depth /* r29 */, const struct xVec2 & naiveResponse /* r30 */) {
    // Local variables
    int i; // r31
}

// Range: 0x801FA0DC -> 0x801FA194
static void zMeshCollisionComputeResponse(int stuckCollisions /* r27 */, struct CircleCollisionResults * sceneCollide /* r28 */, int depth /* r29 */, struct xVec2 & remainingDpos /* r30 */) {
    // Local variables
    struct xVec2 naiveResponse; // r1+0x8
}

// total size: 0x50
class zMeshSweptCircle {
    // Functions
...
// Range: 0x801FA194 -> 0x801FA2AC
static unsigned char zMeshCollisionFindShortestCollision(const struct xVec2 & center /* r26 */, float radius /* f30 */, const struct xVec2 & validDpos /* r27 */, const struct xVec2 & dir /* r28 */, float dist /* f31 */, struct CircleCollisionResults & results /* r29 */, class zMeshPosition & meshPosition /* r30 */, class zMeshCircle * nearbyCircles /* r31 */) {
    // Local variables
    struct xVec2 start; // r1+0x8
    class zMeshSweptCircle sweptCircle; // r1+0x10
}

static char __FUNCTION__[33]; // size: 0x21, address: 0x8043E950
// Range: 0x801FA2AC -> 0x801FA5B4
unsigned char zMeshCollisionSweptCircleEnemies(class zMeshPosition & meshPosition /* r30 */, float radius /* f26 */, const struct xVec2 & desiredDpos /* r27 */, class zMeshCircle * nearbyCircles /* r31 */) {
    // Local variables
    struct xVec2 validDpos; // r1+0x28
    struct xVec2 originalDesiredDir; // r1+0x20
    float remainingDist; // f28
    struct xVec2 currentDir; // r1+0x18
    float currentDist; // f27
    struct xVec2 circleStart; // r1+0x10
    struct CircleCollisionResults sceneCollide[8]; // r1+0x3C
    int stuckCollisions; // r28
    int depth; // r27
    struct xVec2 remainingDpos; // r1+0x8
...
// Range: 0x801FA5B4 -> 0x801FA608
static unsigned char zMeshCollisionSeenBefore(int subMeshIndex /* r0 */, int vert0Index /* r0 */, int vert1Index /* r0 */, struct zMeshCollisionRecord * previousCollisions /* r6 */, int numCollisions /* r7 */) {
    // Local variables
    unsigned int edgeID; // r0
    int i; // r0
}

// Range: 0x801FA608 -> 0x801FA6A0
static void zMeshCollisionFillRecord(int subMeshIndex /* r28 */, int vert0Index /* r29 */, int vert1Index /* r30 */, const struct xVec2 & depenDir /* r6 */, float depenDist /* f31 */, struct zMeshCollisionRecord & collision /* r31 */) {}

// Range: 0x801FA6A0 -> 0x801FAAF4
static unsigned char zMeshCollisionFindMeshPenetrationRecurse(const struct xVec3 & center /* r20 */, float radius /* f29 */, class xNavigationMeshAsset * mesh /* r21 */, int subMeshIndex /* r22 */, int triangleIndex /* r23 */, struct zMeshCollisionRecord * allCollisions /* r24 */, int & collisionCount /* r25 */) {
    // Local variables
    class xNavigationMeshAssetSubMesh & subMesh; // r29
    struct Triangle & tri; // r28
    ...
    float distAwayEdge; // f0
    int neighborSubMesh; // r1+0x8
    float distAlongEdge; // f0
    float dist2; // f0
    float dist; // f0
...
static char __FUNCTION__[34]; // size: 0x22, address: 0x8043E974
// Range: 0x801FAAF4 -> 0x801FABDC
static unsigned char zMeshCollisionFindMeshPenetration(const class zMeshPosition & meshPosition /* r26 */, float radius /* f31 */, struct zMeshCollisionRecord * allCollisions /* r27 */, int & collisionCount /* r28 */) {
    // References
    // -> static char __FUNCTION__[34];
}

// Range: 0x801FABDC -> 0x801FAC38
static unsigned char zMeshCollisionCirclesIntersecting(const struct xVec3 & center1 /* r0 */, float radius1 /* f30 */, const struct xVec3 & center2 /* r0 */, float radius2 /* f31 */) {
    // Local variables
    float distBetween2; // f0
    float combinedRadius2; // f0
}

// Range: 0x801FAC38 -> 0x801FAC68
static unsigned char zMeshCollisionSeenBefore(class zMeshCircle * circle /* r0 */, struct zMeshCollisionRecord * previousCollisions /* r4 */, int numCollisions /* r5 */) {
    // Local variables
    int i; // r0
}

// Range: 0x801FAC68 -> 0x801FAD44
static void zMeshCollisionFillRecord(const struct xVec3 & center /* r29 */, float radius /* f30 */, class zMeshCircle * hitCircle /* r30 */, struct zMeshCollisionRecord & record /* r31 */) {
    // Local variables
    struct xVec3 toCircle; // r1+0x8
    float currentSeparation; // f0
}

// Range: 0x801FAD44 -> 0x801FAE30
static unsigned char zMeshCollisionFindCirclePenetration(const struct xVec3 & center /* r27 */, float radius /* f30 */, class zMeshCircle * nearbyCircles /* r4 */, struct zMeshCollisionRecord * previousCollisions /* r28 */, int & collisionCount /* r29 */, unsigned int filterBaseType /* r30 */) {
    // Local variables
    class zMeshCircle * circle; // r31
}

static char __FUNCTION__[33]; // size: 0x21, address: 0x8043E998
// Range: 0x801FAE30 -> 0x801FAF98
unsigned char zMeshCollisionDepenetrateEnemies(class zMeshPosition & meshPosition /* r28 */, float radius /* f31 */, class zMeshCircle * nearbyCircles /* r29 */, unsigned int filterBaseType /* r30 */) {
    // Local variables
    struct zMeshCollisionRecord allCollisions[5]; // r1+0x14
    int collisionCount; // r1+0x8
    struct xVec2 depenetration; // r1+0xC

    // References
    // -> static char __FUNCTION__[33];
}

// Range: 0x801FAF98 -> 0x801FB054
// this: r29
void zMeshSweptCircle::Prepare(const struct xVec2 & start /* r30 */, float radius /* f30 */, const struct xVec2 & dir /* r31 */, float dist /* f31 */) {}

// Range: 0x801FB054 -> 0x801FB0B4
// this: r31
void zMeshSweptCircle::GetResults() {}
