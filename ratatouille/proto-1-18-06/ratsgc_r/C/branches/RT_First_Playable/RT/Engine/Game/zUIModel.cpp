/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUIModel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017B3EC -> 0x8017BAA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C01BE8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x8017B43C -> 0x8017B690
// this: r30
void zUIModel::InitModel() {
    // Local variables
    const struct zUIModelAsset * asset; // r0
...
// Range: 0x8017B690 -> 0x8017B6CC
// this: r31
void zUIModel::InitUVs() {}

// Range: 0x8017B6CC -> 0x8017B6EC
// this: r0
...
static struct xVec3 from; // size: 0xC, address: 0x80C01BF4
static struct xVec3 to; // size: 0xC, address: 0x80C01C00
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8017B6EC -> 0x8017B88C
// this: r31
void zUIModel::DoRender() const {
    // Local variables
    struct basic_rect r; // r1+0x8
    unsigned int srcblend; // r4
    unsigned int destblend; // r5
...
// Range: 0x8017B88C -> 0x8017B8E0
// this: r31
void zUIModel::DoUpdate(float dt /* f31 */) {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C01C0C
// Range: 0x8017B8E0 -> 0x8017B93C
// this: r31
...
// Range: 0x8017B93C -> 0x8017B9D0
// this: r31
void zUIModel::DoHandleEvent(struct xBase * from /* r4 */, unsigned int toEvent /* r5 */, const float * toParam /* r6 */, struct xBase * toParamWidget /* r7 */, unsigned int toParamWidgetID /* r8 */) {}

// Range: 0x8017B9D0 -> 0x8017B9F0
// this: r0
void zUIModel::DoAddTweaks(const char * baseName /* r0 */) {}

// Range: 0x8017B9F0 -> 0x8017BA10
void zUIModel_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x8017BA10 -> 0x8017BA68
void zUIModel_Init(class zUIModel * model /* r30 */, struct zUIModelAsset * asset /* r31 */) {}

// total size: 0x64
struct {} zUIModel::__vtable; // size: 0x64, address: 0x8043C970
