/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCProjectileTrackingGrub.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802581FC -> 0x80259600
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float TGRUB_TURN_SPEED; // size: 0x4, address: 0x80C050C0
static float TGRUB_SPEED; // size: 0x4, address: 0x80C050C4
static float TGRUB_EXPLOSION_RADIUS; // size: 0x4, address: 0x80C050C8
static float TGRUB_AWAY_KNOCKBACK; // size: 0x4, address: 0x80C050CC
static float TGRUB_UP_KNOCKBACK; // size: 0x4, address: 0x80C050D0
static float TGRUB_TRAIL_OFFSET; // size: 0x4, address: 0x80C050D4
static float TGRUB_SHADOW_OFFSET; // size: 0x4, address: 0x80C050D8
static float TGRUB_DECAL_SIZE; // size: 0x4, address: 0x80C050DC
static float TGRUB_LIFETIME; // size: 0x4, address: 0x80C050E0
static float TGRUB_RADIUS; // size: 0x4, address: 0x80C050E4
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x803FDDC0
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x80C091F8
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x80C091FC
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x80C09200
static unsigned int TGRUB_BUG_MODEL_ID; // size: 0x4, address: 0x80C09204
static unsigned int TGRUB_WING_MODEL_ID; // size: 0x4, address: 0x80C09208
static unsigned int TGRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x80C0920C
static unsigned int TGRUB_WING_SURFACE_ID; // size: 0x4, address: 0x80C09210
// total size: 0x38
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x38, address: 0x80442860
static struct TrailConfig ShortTrailConfig; // size: 0x38, address: 0x80442898
enum iSndGroupHandle {
};
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x80C050E8
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x80C050EC
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x80C050F0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
union /* @class$1236zNPCProjectileTrackingGrub_cpp */ {
...
// total size: 0xC
struct /* @class$1235zNPCProjectileTrackingGrub_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct xSurface * tgrubScrollingSurf; // size: 0x4, address: 0x80C09214
struct xSurface * tgrubWingScrollingSurf; // size: 0x4, address: 0x80C09218
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$2072zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zNPCProjectileTrackingGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// Range: 0x802581FC -> 0x80258228
// this: r0
void zNPCProjectileTrackingGrub::Reset() {}

// Range: 0x80258228 -> 0x80258230
float zNPCProjectileTrackingGrub::GetRadius() {
    // References
    // -> static float TGRUB_RADIUS;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C050F4
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C050FC
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1484zNPCProjectileTrackingGrub_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80258800 -> 0x80258848
// this: r31
void zNPCProjectileTrackingGrub::Render() {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05108
// Range: 0x80258848 -> 0x802588F4
// this: r31
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C05110
// Range: 0x802588F4 -> 0x80258F68
// this: r31
unsigned char zNPCProjectileTrackingGrub::Setup(void * configData /* r30 */) {
    // Local variables
    struct TGrubConfig * config; // r0
    struct RpAtomic * data; // r29
    struct xEnvAsset * easset; // r29
    struct RpAtomic * data; // r29
    struct xEnvAsset * easset; // r29
    struct xMat4x3 * frame; // r29
    struct xVec3 up; // r1+0x8
...
// Range: 0x80258F68 -> 0x80259220
// this: r31
void zNPCProjectileTrackingGrub::Collide(const struct xVec3 & dpos /* r27 */) {
    // Local variables
    struct xVec3 velocity; // r1+0x34
    struct xSweptSphere sws; // r1+0xA0
    struct xVec3 start; // r1+0x28
    struct xVec3 end; // r1+0x1C
    unsigned int old_filter_flags; // r29
...
struct ArcConfig zNPCProjectileGrubArcPlayerConfig; // size: 0x1C, address: 0x80442760
struct ArcConfig zNPCProjectileGrubArcNPCConfig; // size: 0x1C, address: 0x8044277C
// total size: 0x34
struct SparkConfig {
    // Members
    float lifeMin; // offset 0x0, size 0x4
...
// Range: 0x80259220 -> 0x8025944C
// this: r31
void zNPCProjectileTrackingGrub::Explode(unsigned char doDamage /* r0 */, const struct xEnt * ent /* r30 */) {
    // Local variables
    struct xVec3 vel; // r1+0x1C
    struct xMat4x3 * frame; // r30
...
// Range: 0x8025944C -> 0x802595FC
// this: r31
unsigned char zNPCProjectileTrackingGrub::LaunchFromEnt(struct xEnt * ent /* r29 */, const struct xVec3 * localOffset /* r28 */, float target /* f30 */, struct xEnt * refObj /* r27 */) {
    // Local variables
    struct TGrubConfig config; // r1+0x14
...
// total size: 0x4
struct /* @class$2441zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2400zNPCProjectileTrackingGrub_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2401zNPCProjectileTrackingGrub_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2402zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2399zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2404zNPCProjectileTrackingGrub_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zNPCProjectileTrackingGrub_cpp */ {
    // Static members
...
// Range: 0x802595FC -> 0x80259600
void zNPCProjectileTrackingGrub::AddStaticTweaks() {}

// total size: 0x38
struct {} zNPCProjectileTrackingGrub::__vtable; // size: 0x38, address: 0x804428D0
// total size: 0x0
