/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerConstrainer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801FEBC4 -> 0x801FF68C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float sDefaultNearWall; // size: 0x4, address: 0x80C03BE8
float sDefaultFarWall; // size: 0x4, address: 0x80C03BEC
float sNearWall; // size: 0x4, address: 0x80C08DD8
float sFarWall; // size: 0x4, address: 0x80C08DDC
unsigned char sEnabled; // size: 0x1, address: 0x80C03BF0
unsigned char sDebugRender; // size: 0x1, address: 0x80C08DE0
unsigned char sPlayerDisable; // size: 0x1, address: 0x80C08DE1
unsigned char sCameraDisable; // size: 0x1, address: 0x80C08DE2
unsigned int sDrawnFrame; // size: 0x4, address: 0x80C08DE4
float cPlayerRadius; // size: 0x4, address: 0x80C03BF4
float cCamMotionMarginAngle; // size: 0x4, address: 0x80C03BF8
float cPlayerMotionMarginAngle; // size: 0x4, address: 0x80C03BFC
// total size: 0x1
...
// Range: 0x801FEBE0 -> 0x801FEBEC
void zPlayerConstrainer::SetConstraints(float nearWall /* f0 */, float farWall /* f0 */) {
    // References
    // -> float sFarWall;
    // -> float sNearWall;
}

// Range: 0x801FEBEC -> 0x801FEC00
void zPlayerConstrainer::GetDefaults(float & nearWall /* r0 */, float & farWall /* r0 */) {
    // References
...
// Range: 0x801FEC00 -> 0x801FECE0
static void DrawPlane(const struct xVec3 & normal /* r30 */, const struct xMat4x3 & viewMat /* r31 */, float offset /* f29 */, float width /* f30 */, float height /* f31 */) {
    // Local variables
    struct xVec3 forward; // r1+0x20
    struct xVec3 c1; // r1+0x14
    struct xVec3 c2; // r1+0x8
}

// Range: 0x801FECE0 -> 0x801FED50
static void DrawFrustrumPlanes(struct xVec3 & nLeft /* r0 */, struct xVec3 & nRight /* r30 */, const struct xMat4x3 & viewMat /* r31 */, float offset /* f31 */) {}
...
// Range: 0x801FED50 -> 0x801FEDBC
static void FrustrumSideNormals(struct xVec3 & nLeft /* r29 */, struct xVec3 & nRight /* r30 */, const struct xMat4x3 & viewMat /* r31 */, float fov /* f1 */) {}

// Range: 0x801FEDBC -> 0x801FEE24
static void ReflectVector(struct xVec3 & o /* r29 */, const struct xVec3 & v /* r30 */, const struct xVec3 & unitAxis /* r31 */) {}

// Range: 0x801FEE24 -> 0x801FEE40
static float DotXZ(const struct xVec3 & a /* r0 */, const struct xVec3 & b /* r0 */) {}

// Range: 0x801FEE40 -> 0x801FEEE8
void zPlayerConstrainer::FarWallCollisionResponse(const struct SphereCollisionResults & scene_collide /* r29 */, struct xVec3 & response_dpos /* r30 */) {
    ...
    float contactDistance; // f0

    // References
    // -> struct zGlobals globals;
}

// Range: 0x801FEEE8 -> 0x801FEF0C
static void myDrawArrow(const struct xVec3 * origin /* r0 */, const struct xVec3 * dir /* r0 */, float length /* f0 */) {}
...
// Range: 0x801FEF0C -> 0x801FEFC8
unsigned char OOBExtent::CalcDepen(float & sideMargin /* r28 */, const struct xMat4x3 & camMat /* r29 */, const struct xVec3 & toTarget /* r6 */, const struct xVec3 & nPlane /* r30 */, unsigned int calcFlags /* r31 */) {
    // Local variables
    float perpDistance; // f31
    float margin; // f1
...
// total size: 0x10
struct /* @class$1828zPlayerConstrainer_cpp */ {
    // Members
...
// Range: 0x801FEFC8 -> 0x801FF124
unsigned int zPlayerConstrainer::PlayersOOB(struct OOBExtent & extent /* r24 */, const struct xCam & cam /* r25 */, const struct xVec3 & depenAxis /* r26 */, unsigned int calcFlags /* r27 */) {
    // Local variables
    unsigned int flags; // r29
    int i; // r28
    struct OOBExtent localExtent; // r1+0x8
...
// total size: 0x4
struct /* @class$1096zPlayerConstrainer_cpp */ {
    // Members
...
union /* @class$865zPlayerConstrainer_cpp */ {
...
// total size: 0xC
struct /* @class$1252zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2075zPlayerConstrainer_cpp */ {
    // Static members
...
static unsigned int drawnFrame; // size: 0x4, address: 0x80C08DE8
static signed char init; // size: 0x1, address: 0x80C08DEC
static unsigned int drawnFrame; // size: 0x4, address: 0x80C08DF0
static signed char init; // size: 0x1, address: 0x80C08DF4
unsigned int gFrameCount; // size: 0x4, address: 0x80C06F38
// Range: 0x801FF124 -> 0x801FF460
unsigned int zPlayerConstrainer::PositionOOB(struct OOBExtent & extent /* r28 */, const struct xMat4x3 & camMat /* r29 */, float fov /* f31 */, const struct xVec3 & position /* r30 */, unsigned int calcFlags /* r27 */) {
    // Local variables
    struct xVec3 to; // r1+0x44
    unsigned int flags; // r31
    struct xVec3 atNormalizedXZ; // r1+0x38
    float adjustedFarWall; // f30
    float dist2; // f0
    float perpDistance; // f0
...
// total size: 0xC
struct /* @class$1037zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1038zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1039zPlayerConstrainer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1040zPlayerConstrainer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1041zPlayerConstrainer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1042zPlayerConstrainer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1043zPlayerConstrainer_cpp */ {
    // Members
