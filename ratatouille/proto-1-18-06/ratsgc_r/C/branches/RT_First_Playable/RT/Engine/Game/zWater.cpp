/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zWater.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80195BCC -> 0x80195F0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x1
struct /* @class$941zWater_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$942zWater_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$943zWater_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$944zWater_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C022D0
// total size: 0x8
struct debug_info {
    // Members
...
// Range: 0x80195BCC -> 0x80195D4C
void zWaterBody::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x80195D4C -> 0x80195D5C
char * asset_type::type_name() {}

// Range: 0x80195D5C -> 0x80195D68
// this: r0
void zWaterBody::show() {}

// Range: 0x80195D68 -> 0x80195D74
// this: r0
void zWaterBody::hide() {}

// Range: 0x80195D74 -> 0x80195DEC
// this: r31
void zWaterBody::load(const struct asset_type & a /* r0 */) {}

// Range: 0x80195DEC -> 0x80195DF8
// this: r0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C022D8
// Range: 0x80195DF8 -> 0x80195F0C
void zWaterBody::cb_dispatch(struct xBase * to /* r31 */, unsigned int event /* r30 */) {
    // Local variables
