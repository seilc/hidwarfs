/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zHeistMovementPath.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802757C4 -> 0x80277038
*/
class zHeistMovementPathManager * heistMovementPathManager; // size: 0x4, address: 0x80C09378
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C056D0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1133zHeistMovementPath_cpp */ {
    // Members
...
union /* @class$1272zHeistMovementPath_cpp */ {
...
// total size: 0xC
struct /* @class$1271zHeistMovementPath_cpp */ {
    // Members
...
// Range: 0x802757C4 -> 0x80275BF8
// this: r31
zHeistMovementPath::zHeistMovementPath(struct zHeistMovementPathAsset * theAsset /* r30 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C056D8
// Range: 0x80275BF8 -> 0x80275D8C
void zHeistMovementPath::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C056E0
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80275DC8 -> 0x80276108
// this: r31
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C056F0
// Range: 0x80276408 -> 0x802764F8
void zHeistMovementPath::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C056F8
// Range: 0x802766A8 -> 0x80276874
// this: r30
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C05710
// Range: 0x80276874 -> 0x80276AB8
// this: r30
...
// Range: 0x80276B40 -> 0x80276B70
// this: r0
void zHeistMovementPathManager::Init() {}

// Range: 0x80276B70 -> 0x80276B94
void zHeistMovementPathManager::Exit() {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05728
// Range: 0x80276B94 -> 0x80276C6C
// this: r29
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05738
// Range: 0x80276D04 -> 0x80276DF0
// this: r29
void zHeistMovementPathManager::InsertPath(class zHeistMovementPath * insPath /* r30 */, int idx /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

// Range: 0x80276DF0 -> 0x80276E30
// this: r31
void zHeistMovementPathManager::SetDefaultPathSelect(int pathIdx /* r0 */, int atStart /* r5 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05744
// Range: 0x80276E30 -> 0x80276F1C
// this: r28
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05754
// Range: 0x80276F1C -> 0x80277008
// this: r28
