/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\isavegame.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800E88B8 -> 0x800ECFE0
*/
...
static enum en_VERBOSE_MSGLEVEL _g_mlvl; // size: 0x4, address: 0x80BFF400
static char * ISG_GC_GAMENAME; // size: 0x4, address: 0x80BFF404
// total size: 0x10
struct basic_rect {
    // Static members
...
static int g_isginit; // size: 0x4, address: 0x80C07A28
...
static struct st_ISGSESSION g_isgdata_MAIN; // size: 0x280, address: 0x80432160
static char cardwork[2][40960]; // size: 0x14000, address: 0x80B6E5C0
static char * g_rawicon; // size: 0x4, address: 0x80C07A2C
static char * g_rawbanr; // size: 0x4, address: 0x80C07A30
static int g_iconsize; // size: 0x4, address: 0x80C07A34
static int g_banrsize; // size: 0x4, address: 0x80C07A38
static int g_legalSectSize[3]; // size: 0xC, address: 0x80BFF408
static unsigned char isMounted; // size: 0x1, address: 0x80C07A3C
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFF414
// Range: 0x800E88B8 -> 0x800E8AA0
int iSGStartup() {
    // Local variables
    int rc; // r0
...
// Range: 0x800E8AA0 -> 0x800E8AC4
int iSGShutdown() {}

static char rotatebuf[8][32]; // size: 0x100, address: 0x804323E0
static int rotate; // size: 0x4, address: 0x80C07A40
static signed char init; // size: 0x1, address: 0x80C07A44
...
// Range: 0x800E8AC4 -> 0x800E8BF0
char * iSGMakeName(enum en_NAMEGEN_TYPE type /* r3 */, const char * base /* r8 */, int idx /* r7 */) {
    // Local variables
    char * use_buf; // r31
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFF420
// Range: 0x800E8BF0 -> 0x800E8C68
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFF430
// Range: 0x800E8C68 -> 0x800E8D00
...
// Range: 0x800E8D00 -> 0x800E8D08
int iSGMaxSaveGame() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFF440
// Range: 0x800E8D08 -> 0x800E8E2C
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFF44C
// Range: 0x800E8E74 -> 0x800E8F70
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFF45C
// Range: 0x800E8F70 -> 0x800E9140
unsigned int iSGTgtState(struct st_ISGSESSION * isgdata /* r28 */, int tgtidx /* r29 */) {
    // Local variables
    unsigned int state; // r30
    int rc; // r0
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFF468
// Range: 0x800E9140 -> 0x800E91E4
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF478
// total size: 0x14
struct CARDFileInfo {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFF488
// Range: 0x800E93A0 -> 0x800E9428
...
// Range: 0x800E9428 -> 0x800E9460
char * iSGFileModDate(struct st_ISGSESSION * isgdata /* r0 */, const char * fname /* r0 */) {
    // Local variables
    const char * date_str; // r0
}

static char datestr[256]; // size: 0x100, address: 0x804324E0
// Range: 0x800E9460 -> 0x800E95E8
...
// Range: 0x800E97D4 -> 0x800E97DC
int iSGSetupGameDir() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFF494
enum en_ASYNC_OPERR {
    ISG_OPERR_NONE = 0,
    ISG_OPERR_NOOPER = 1,
...
// Range: 0x800E97DC -> 0x800E9B88
int iSGSaveFile(struct st_ISGSESSION * isgdata /* r24 */, const char * fname /* r25 */, char * data /* r26 */, int n /* r27 */, char * label /* r28 */) {
    // Local variables
    int result; // r31
    int rc; // r0
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFF4A0
// Range: 0x800E9BF4 -> 0x800E9EB0
int iSGReadLeader(struct st_ISGSESSION * isgdata /* r24 */, const char * fname /* r25 */, char * databuf /* r26 */, int numbytes /* r27 */) {
    // Local variables
    int result; // r31
    int rc; // r0
    struct st_ISG_MEMCARD_DATA * mcdata; // r30
...
// Range: 0x800E9EB0 -> 0x800E9EB8
enum en_ASYNC_OPSTAT iSGPollStatus(struct st_ISGSESSION * isgdata /* r3 */) {}

static char * errmsgs[22]; // size: 0x58, address: 0x804325E0
// Range: 0x800E9EB8 -> 0x800E9F48
enum en_ASYNC_OPERR iSGOpError(struct st_ISGSESSION * isgdata /* r30 */, char * errbuf /* r31 */) {
    // References
    // -> static char * errmsgs[22];
}

// Range: 0x800E9F48 -> 0x800E9F84
static int iSG_start_your_engines() {}

// Range: 0x800E9F84 -> 0x800EA0E0
int iSG_mcidx2slot(int mcidx /* r26 */, int * slot /* r27 */, int * concnt /* r28 */) {
    // Local variables
    int result; // r30
    int rc; // r23
    int idx; // r29
...
static int callbackResult; // size: 0x4, address: 0x80C07A48
static unsigned char checkExInProgress; // size: 0x1, address: 0x80C07A4C
// Range: 0x800EA21C -> 0x800EA22C
...
char __FUNCTION__$localstatic1$iSG_CARDCheckEx__FiPl[16]; // size: 0x10, address: 0x80BFF4B0
// Range: 0x800EA22C -> 0x800EA390
static int iSG_mc_tryRepair(struct st_ISG_MEMCARD_DATA * mcdata /* r29 */) {
    // Local variables
    int result; // r31
    int rc; // r30
...
// Range: 0x800EA3F4 -> 0x800EA54C
static int iSG_mc_isformatted(struct st_ISG_MEMCARD_DATA * mcdata /* r29 */) {
    // Local variables
    int is_fmtd; // r31
    int rc; // r30
    long repaired; // r1+0x8
...
static int iSG_mc_isGCcard(struct st_ISG_MEMCARD_DATA * mcdata /* r28 */, int * badencode /* r29 */, int * wornout /* r30 */) {
    ...
    long duma; // r1+0x10
    long dumb; // r1+0xC
    unsigned short target_enc; // r26

    // References
    // -> static enum en_VERBOSE_MSGLEVEL _g_mlvl;
}

// Range: 0x800EA89C -> 0x800EAA40
static int iSG_isSpaceForFile(struct st_ISG_MEMCARD_DATA * mcdata /* r25 */, int fsize /* r23 */, const char * fname /* r26 */, int * amtneed /* r27 */, int * amtfree /* r28 */, int * needFiles /* r29 */) {
    // Local variables
    int haveroom; // r30
    int needamt; // r6
    int rc; // r23
...
// Range: 0x800EAAFC -> 0x800EAC30
static int iSG_get_finfo(struct st_ISG_MEMCARD_DATA * mcdata /* r29 */, const char * fname /* r0 */) {
    // Local variables
    int result; // r31
    int rc; // r0
    struct CARDStat * stat; // r30
    enum en_ASYNC_OPERR whyFail; // r1+0x8
}

// Range: 0x800EAC30 -> 0x800EAFF8
static int iSG_curKosher(struct CARDStat * stat /* r28 */, struct CARDFileInfo * finf /* r29 */) {
    // Local variables
    int isok; // r31
    char * b; // r30
    char * ba; // r21
...
// Range: 0x800EB114 -> 0x800EB288
static int iSG_get_fmoddate(struct st_ISG_MEMCARD_DATA * mcdata /* r24 */, const char * fname /* r0 */, int * sec /* r25 */, int * min /* r26 */, int * hr /* r27 */, int * mon /* r28 */, int * day /* r29 */, int * yr /* r30 */) {
    // Local variables
    int result; // r31
    int rc; // r0
    struct OSCalendarTime caltym; // r1+0x8
...
// Range: 0x800EB288 -> 0x800EB28C
static void iSG_timestamp() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFF4C0
// Range: 0x800EB28C -> 0x800EB368
static int iSG_cubeicon_size(int cardslot /* r30 */, int sectsize /* r31 */) {
    // Local variables
    int jump; // r4
...
// Range: 0x800EB368 -> 0x800EB370
static int iSG_chk_icondata() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFF4D4
// Range: 0x800EB370 -> 0x800EB498
...
int __OSCurrHeap; // size: 0x4, address: 0x80C06BE8
// Range: 0x800EB498 -> 0x800EB4F8
...
static struct st_ISG_TPL_TEXPALETTE * ico_pal; // size: 0x4, address: 0x80C07A50
static struct st_ISG_TPL_TEXDESCRIP * ico_desc; // size: 0x4, address: 0x80C07A54
static unsigned long i; // size: 0x4, address: 0x80C07A58
static signed char init; // size: 0x1, address: 0x80C07A5C
// total size: 0x5C40
...
static int iSG_tpl_unpack(struct st_ISG_TPL_TEXPALETTE * pal /* r0 */) {
    ...
    unsigned long tmppos; // r4
}

// Range: 0x800EBA20 -> 0x800EBA68
static int iSG_bnr_unpack(struct st_ISG_TPL_TEXPALETTE * pal /* r31 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF4E8
// Range: 0x800EBA68 -> 0x800EBAFC
static struct st_ISG_TPL_TEXDESCRIP * iSG_tpl_TEXGet(struct st_ISG_TPL_TEXPALETTE * pal /* r30 */, unsigned int idx /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x800EBAFC -> 0x800EBC18
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF4F8
// Range: 0x800EBCDC -> 0x800EBDDC
static void iSG_cb_unmount(long chan /* r29 */, long retcode /* r30 */) {
    // Local variables
...
// Range: 0x800EBDDC -> 0x800EBF6C
static int iSG_mc_format(struct st_ISG_MEMCARD_DATA * mcdata /* r28 */, int * canRecover /* r29 */) {
    // Local variables
    int result; // r31
    int rc; // r30
...
static unsigned char cardCreateInProgress; // size: 0x1, address: 0x80C07A5D
// Range: 0x800EBF6C -> 0x800EBF7C
...
char __FUNCTION__$localstatic1$iSG_CARDCreate__FlPCcUlP12CARDFileInfo[15]; // size: 0xF, address: 0x80BFF508
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFF518
enum en_ISG_IOMODE {
    ISG_IOMODE_READ = 1,
    ISG_IOMODE_WRITE = 2,
    ISG_IOMODE_APPEND = 3,
};
// Range: 0x800EBF7C -> 0x800EC300
static int iSG_mc_fopen(struct st_ISG_MEMCARD_DATA * mcdata /* r26 */, const char * fname /* r27 */, int fsize /* r24 */, enum en_ISG_IOMODE mode /* r23 */, enum en_ASYNC_OPERR * whyFail /* r28 */) {
    // Local variables
    int result; // r31
    int rc; // r23
    struct CARDFileInfo * finf; // r30
    struct CARDStat * stat; // r29
    unsigned int langConfig; // r0
...
// Range: 0x800EC364 -> 0x800EC388
static int iSG_mc_fclose(struct st_ISG_MEMCARD_DATA * mcdata /* r0 */) {}

// Range: 0x800EC388 -> 0x800EC4A0
static int iSG_mc_fclose(struct st_ISG_MEMCARD_DATA * mcdata /* r27 */, struct CARDStat * statcopy /* r28 */) {
    // Local variables
    int result; // r30
    int rc; // r29
...
static unsigned char cardDeleteInProgress; // size: 0x1, address: 0x80C07A5E
// Range: 0x800EC4A0 -> 0x800EC4B0
...
char __FUNCTION__$localstatic1$iSG_CARDDelete__FlPCc[15]; // size: 0xF, address: 0x80BFF528
// Range: 0x800EC4B0 -> 0x800EC64C
static int iSG_mc_fdel(struct st_ISG_MEMCARD_DATA * mcdata /* r28 */, const char * fname /* r29 */) {
    // Local variables
    int result; // r31
    int rc; // r30
...
// Range: 0x800EC6B0 -> 0x800EC6F0
static void iSG_cb_asyndone(long retcode /* r4 */) {}

// Range: 0x800EC6F0 -> 0x800EC710
static int iSG_mc_fread(struct st_ISG_MEMCARD_DATA * mcdata /* r0 */, char * buf /* r0 */, int bufsize /* r0 */, int skipbyte /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFF538
// Range: 0x800EC710 -> 0x800EC97C
static int iSG_mcqa_fread(struct st_ISG_MEMCARD_DATA * mcdata /* r27 */, char * buf /* r23 */, int bufsize /* r28 */, int skipbyte /* r29 */) {
    // Local variables
    int result; // r24
    int rc; // r24
    int amt_start; // r0
...
// Range: 0x800EC97C -> 0x800EC99C
static int iSG_mc_fwrite(struct st_ISG_MEMCARD_DATA * mcdata /* r0 */, char * data /* r0 */, int n /* r0 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFF548
// Range: 0x800EC99C -> 0x800ECC88
static int iSG_mcqa_fwrite(struct st_ISG_MEMCARD_DATA * mcdata /* r24 */, char * data /* r25 */, int n /* r26 */) {
    // Local variables
    int result; // r30
    int rc; // r23
    int updintv; // r29
...
// Range: 0x800ECE14 -> 0x800ECE18
void iSGAutoSave_Startup() {}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFF558
// Range: 0x800ECE18 -> 0x800ECED8
struct st_ISGSESSION * iSGAutoSave_Connect(int idx_target /* r31 */, void * cltdata /* r4 */, void (* chg)(void *, enum en_CHGCODE) /* r0 */) {
    // Local variables
    struct st_ISGSESSION * isg; // r30
    int rc; // r0
...
// total size: 0x4
struct /* @class$1087isavegame_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1251isavegame_cpp */ {
    // Members
...
static struct st_ERROR_LOOKUP errlook[17]; // size: 0x88, address: 0x8043269C
// Range: 0x800ECF58 -> 0x800ECFE0
static char * iSGDB_tlate_cardres(int errid /* r3 */) {
    // Local variables
    char * da_errmsg; // r31
    struct st_ERROR_LOOKUP * tmprec; // r5
