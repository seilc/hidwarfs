/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zAnimCustom.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80209A9C -> 0x8020A1F0
*/
static int sAnimCustomCount; // size: 0x4, address: 0x80C08E18
static int sMaxTempTransCount; // size: 0x4, address: 0x80C08E1C
// total size: 0xC
struct RwV3d {
    // Members
...
static struct zAnimCustomFile * sAnimCustomList; // size: 0x4, address: 0x80C08E20
static struct zAnimCustomFile * sAnimCustomEndOfList; // size: 0x4, address: 0x80C08E24
// total size: 0x1C
struct xMemPool {
    // Members
...
static struct xMemPool szAnimCustomTempTranListPool; // size: 0x1C, address: 0x80BC3C88
static struct xAnimTransitionList * * zAnimCustomActiveTempTrans; // size: 0x4, address: 0x80C08E28
static int sLastIndex; // size: 0x4, address: 0x80C08E2C
static char * sCustomStateName; // size: 0x4, address: 0x80C03DC8
enum xSndHandle {
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$1080zAnimCustom_cpp */ {
    // Members
...
static struct xAnimState sDummyState; // size: 0x4C, address: 0x80BC3CA4
// total size: 0x2C
...
static struct xAnimTransition sDummyTran; // size: 0x2C, address: 0x80BC3CF0
// total size: 0x8
...
static struct xAnimTransitionList sDummyList; // size: 0x8, address: 0x80C08E30
// Range: 0x80209A9C -> 0x80209AAC
static unsigned int TempTransCB(struct xAnimTransition * tran /* r0 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03DCC
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C03DE0
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80209AAC -> 0x80209BE4
void zAnimCustomInit(int count /* r0 */) {
    // References
...
// Range: 0x80209C14 -> 0x80209C48
static void ClearActiveArray() {
    // References
    // -> static int sLastIndex;
}

// Range: 0x80209C48 -> 0x80209D0C
...
// Range: 0x80209D0C -> 0x80209D2C
void zAnimCustomReset() {}

// Range: 0x80209D2C -> 0x80209DD0
void zAnimCustomAdd(unsigned int id /* r30 */, struct xAnimFile * data /* r31 */, unsigned char hasPhysics /* r0 */) {
    // Local variables
    struct zAnimCustomFile * entry; // r0
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C03DF8
// Range: 0x80209DD0 -> 0x8020A0E4
void zAnimCustomPlay(unsigned int id /* r27 */, struct xModelInstance * model /* r28 */, unsigned int outStateID /* r29 */, unsigned char loopAnim /* r30 */, float inBlend /* f29 */, float outBlend /* f30 */, float speed /* f31 */) {
    // Local variables
    struct zAnimCustomFile * file; // r31
    int i; // r3
    struct xAnimState state; // r1+0x8
    struct xAnimTransition * tran; // r0
    struct xAnimTransitionList * tempList; // r0
    struct xAnimTransition * transition; // r3
...
// Range: 0x8020A0E4 -> 0x8020A180
static void AddToActiveArray(struct xAnimTransitionList * l /* r31 */) {
    // References
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
