/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPortal.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80154F28 -> 0x80155378
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80154F28 -> 0x80154F48
void zPortalInit(void * portal /* r0 */, void * passet /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C01198
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80154F48 -> 0x80154FF8
void zPortalInit(struct _zPortal * portal /* r30 */, struct xPortalAsset * passet /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C011A4
// Range: 0x80154FF8 -> 0x801550C4
void zPortalReset(struct _zPortal * ent /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C011B4
// total size: 0x0
...
// Range: 0x801550C4 -> 0x80155194
void zPortalSave(struct _zPortal * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C011C0
// Range: 0x80155194 -> 0x80155264
void zPortalLoad(struct _zPortal * ent /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C011CC
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x80155264 -> 0x80155378
void zPortalEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r30 */, const float * toParam /* r31 */) {
    // References
