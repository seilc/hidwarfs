/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xHud.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8006FEA8 -> 0x8007206C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct /* @class$2120xHud_cpp */ {
    ...
    unsigned char type; // offset 0x0, size 0x1
    unsigned int size; // offset 0x4, size 0x4
} known_types[5]; // size: 0x28, address: 0x803AF7D8
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFD018
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// total size: 0x4
struct header {
    // Members
    struct holder * next; // offset 0x0, size 0x4
};
// total size: 0x8
struct holder {
    // Members
    struct header h; // offset 0x0, size 0x4
...
// Range: 0x8006FEA8 -> 0x8006FF78
// this: r28
void block_allocator::create(int block_size /* r29 */, int max_blocks /* r30 */, unsigned int memtag /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
    // -> static char __FUNCTION__[7];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFD020
// Range: 0x8006FF78 -> 0x80070000
// this: r31
void * block_allocator::alloc() {
    // Local variables
    struct holder * obj; // r0

    // References
    // -> static char __FUNCTION__[6];
}

// Range: 0x80070000 -> 0x80070010
// this: r0
void block_allocator::free(void * mem /* r0 */) {
    // Local variables
    struct holder * obj; // r4
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFD028
// Range: 0x80070010 -> 0x800700D0
// this: r31
...
class block_allocator motive_allocator; // size: 0x10, address: 0x80C073B8
static unsigned char inited; // size: 0x1, address: 0x80C073C8
// Range: 0x800700D0 -> 0x8007010C
void init() {
    // References
    // -> static unsigned char inited;
}

// Range: 0x8007010C -> 0x80070140
void destroy() {}
...
// Range: 0x80070140 -> 0x80070160
void update(float dt /* f0 */) {}

// Range: 0x80070160 -> 0x8007018C
void render() {
    // References
    // -> static unsigned char inited;
}
...
// total size: 0x30
struct {} xhud::widget::__vtable; // size: 0x30, address: 0x804185D4
// total size: 0x8
struct /* @class$1310xHud_cpp */ {
    // Members
...
// Range: 0x8007018C -> 0x80070248
// this: r30
widget::widget(const struct asset & a /* r31 */) {
    // References
...
// Range: 0x800702B4 -> 0x80070318
void widget::init_base(struct xBase & data /* r29 */, const struct xBaseAsset & asset /* r30 */, unsigned long chunk_size /* r31 */) {
    // Local variables
    struct widget_chunk & wc; // r0
}

// Range: 0x80070318 -> 0x80070338
// this: r0
void widget::destruct() {}

// Range: 0x80070338 -> 0x80070360
// this: r0
void widget::presetup() {}

// Range: 0x80070360 -> 0x8007047C
// this: r29
...
// Range: 0x8007047C -> 0x8007053C
// this: r0
void widget::dispatcher(unsigned int event /* r0 */) {}

// Range: 0x8007053C -> 0x8007056C
void widget::scene_enter() {
    // References
    // -> class block_allocator motive_allocator;
}

// Range: 0x8007056C -> 0x800705E0
unsigned char widget::valid_type(int base_type /* r0 */) {}

static unsigned int myid; // size: 0x4, address: 0x80C073CC
static signed char init; // size: 0x1, address: 0x80C073D0
// Range: 0x800705E0 -> 0x80070620
...
// Range: 0x80070620 -> 0x80070658
// this: r0
unsigned char widget::is(unsigned int id /* r31 */) const {}
...
// Range: 0x80070658 -> 0x8007083C
// this: r29
void widget::show(enum move_direction dir /* r30 */, unsigned char clearmotives /* r0 */, unsigned char bSkipShowMotive /* r31 */) {
    // Local variables
    float dx; // f31
    float dy; // f30
    float d2; // f1
...
// Range: 0x8007083C -> 0x80070AE8
// this: r29
void widget::hide(enum move_direction d /* r30 */, unsigned char clearmotives /* r0 */, unsigned char bSkipHideMotive /* r31 */) {
    // Local variables
    float sx; // f6
    float sy; // f7
    float cx; // f2
...
// Range: 0x80070B30 -> 0x80070B9C
void widget::disable_all(unsigned char destroy_widgets /* r4 */) {
    // Local variables
    struct functor_disable f; // r1+0xC
    unsigned long i; // r30
...
// Range: 0x80070B9C -> 0x80070BA4
// this: r0
static functor_disable::functor_disable(unsigned char destroy_widgets /* r0 */) {}
...
// Range: 0x80070BA4 -> 0x80070C0C
void widget::update_all(float dt /* f0 */) {
    // Local variables
    struct functor_update f; // r1+0xC
    unsigned long i; // r30
...
// Range: 0x80070C0C -> 0x80070C14
// this: r0
static functor_update::functor_update(float dt /* f0 */) {}
...
// Range: 0x80070CBC -> 0x80070D60
// this: r29
void widget::add_motive(const struct motive & m /* r30 */) {
    // Local variables
    struct motive_node * n; // r31

    // References
    // -> class block_allocator motive_allocator;
}

// Range: 0x80070D60 -> 0x80070DCC
// this: r30
void widget::clear_motives() {
    // Local variables
    struct motive_node * * itp; // r0
    struct motive_node * it; // r31

    // References
    // -> class block_allocator motive_allocator;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD030
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80070DCC -> 0x80070ED0
void widget::cb_dispatch(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int event /* r27 */, const float * argf /* r28 */, struct xBase * argw /* r29 */, unsigned int argwi /* r30 */) {
    // Local variables
    struct widget_chunk * wc; // r0
    class widget * w; // r31
...
static struct tweak_callback tweakConvertX; // size: 0x28, address: 0x803AF800
static struct tweak_callback tweakConvertY; // size: 0x28, address: 0x803AF828
unsigned int FB_XRES; // size: 0x4, address: 0x80C00BDC
// Range: 0x80070ED0 -> 0x80070F34
void screenToNormalizedX(void * value /* r31 */) {
    // Local variables
    float & f; // r0
...
// Range: 0x80070F34 -> 0x80070F98
void screenToNormalizedY(void * value /* r31 */) {
    // Local variables
    float & f; // r0
...
// Range: 0x80070F98 -> 0x80070FFC
void normalizedToScreenX(void * value /* r31 */) {
    // Local variables
    float & f; // r0
...
// Range: 0x80070FFC -> 0x80071060
void normalizedToScreenY(void * value /* r31 */) {
    // Local variables
    float & f; // r0
...
// Range: 0x80071444 -> 0x80071558
// this: r30
void widget::add_common_tweaks(const char * object_prefix /* r5 */) {
    // Local variables
    char name[128]; // r1+0x108
    char * buffer; // r31
    char _buffer[128]; // r1+0x88
    char _buffer[128]; // r1+0x8
}

static struct tweak_callback cb_explode; // size: 0x28, address: 0x80418590
static signed char init; // size: 0x1, address: 0x80C073D1
// Range: 0x80071558 -> 0x80071660
// this: r31
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFD03C
// total size: 0xC
struct /* @class$1026xHud_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029xHud_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030xHud_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031xHud_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032xHud_cpp */ {
    // Members
...
// Range: 0x80071744 -> 0x800717C0
void widget::on_expand(const struct tweak_info & info /* r0 */) {
    // Local variables
    class widget * w; // r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFD048
// total size: 0x14
...
// Range: 0x800717C0 -> 0x800718EC
struct xModelInstance * load_model(unsigned int id /* r30 */) {
    // Local variables
...
// Range: 0x800718EC -> 0x800719C0
static void render_one_model(struct xModelInstance & m /* r27 */, float alpha /* f31 */, const struct basic_rect & r /* r28 */, const struct xVec3 & from /* r29 */, const struct xVec3 & to /* r30 */, const struct xMat4x3 & frame /* r31 */) {
    // References
    // -> struct xGlobals * xglobals;
}
...
// Range: 0x800719C0 -> 0x80071B0C
void render_model(struct xModelInstance & m /* r31 */, const struct render_context & rc /* r30 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFD054
// Range: 0x80071B0C -> 0x80071CE4
unsigned char linear_motive_update(class widget & w /* r30 */, struct motive & m /* r31 */, float dt /* f31 */) {
    // Local variables
    float diff; // f3
    float remaining; // f1
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804185B8
// Range: 0x80071CE4 -> 0x80071E30
unsigned char accelerate_motive_update(struct motive & m /* r31 */, float dt /* f31 */) {
    // Local variables
    float diff; // f3
    float remaining; // f1
...
// Range: 0x80071E30 -> 0x80071EB0
static void for_each(unsigned char type /* r0 */, unsigned int size /* r28 */, struct functor_update & f /* r29 */) {
    // Local variables
    struct zScene & s; // r3
...
// Range: 0x80071EB0 -> 0x80071F34
static void for_each(unsigned char type /* r0 */, unsigned int size /* r28 */, void (* f)(class widget &) /* r29 */) {
    // Local variables
    struct zScene & s; // r3
    unsigned char * it; // r31
    unsigned char * end; // r30
...
// Range: 0x80071F34 -> 0x80071FB4
static void for_each(unsigned char type /* r0 */, unsigned int size /* r28 */, struct functor_disable & f /* r29 */) {
    // Local variables
    struct zScene & s; // r3
    unsigned char * it; // r31
    unsigned char * end; // r30
