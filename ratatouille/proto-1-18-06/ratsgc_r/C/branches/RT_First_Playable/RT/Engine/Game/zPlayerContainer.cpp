/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerContainer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802118B4 -> 0x802118E8
*/
// total size: 0x0
struct zPlayer {};
// total size: 0x14
class zPlayerContainer {
    // Functions
    unsigned char IsPlayer(struct xEnt * ptr);
...
// total size: 0x4
struct /* @class$1097zPlayerContainer_cpp */ {
    // Members
...
union /* @class$1236zPlayerContainer_cpp */ {
...
// total size: 0xC
struct /* @class$1235zPlayerContainer_cpp */ {
    // Members
...
// Range: 0x802118B4 -> 0x802118E8
// this: r3
unsigned char zPlayerContainer::IsPlayer(struct xEnt * ptr /* r0 */) {
    // Local variables
    int i; // r0
}
