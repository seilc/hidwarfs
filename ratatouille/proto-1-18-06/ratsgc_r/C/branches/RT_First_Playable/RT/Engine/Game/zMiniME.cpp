/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniME.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8028C560 -> 0x8029078C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char curveCmds[1][16]; // size: 0x10, address: 0x80C05C48
static char actionCmds[3][16]; // size: 0x30, address: 0x80444B60
static char minigameCmds[1][16]; // size: 0x10, address: 0x80C05C58
// total size: 0x8
struct /* @class$1797zMiniME_cpp */ {
    // Members
...
struct /* @class$1797zMiniME_cpp */ {
    ...
    char * string; // offset 0x0, size 0x4
    unsigned int value; // offset 0x4, size 0x4
} inputData[9]; // size: 0x48, address: 0x80444B90
// total size: 0x4
struct node {
    // Members
...
// total size: 0x1
struct /* @class$1070zMiniME_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1071zMiniME_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1072zMiniME_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1073zMiniME_cpp */ {
    // Members
...
static struct xResponseCurve alphaCurve; // size: 0x14, address: 0x80C09490
// total size: 0x8
struct /* @class$1807zMiniME_cpp */ {
    // Members
...
struct /* @class$1807zMiniME_cpp */ {
    ...
    unsigned int hash; // offset 0x0, size 0x4
    unsigned int event; // offset 0x4, size 0x4
} eventData[1067]; // size: 0x2158, address: 0x80444BD8
// total size: 0x8
struct curve_node {
    // Members
    float t; // offset 0x0, size 0x4
...
static class zMiniME singleMM; // size: 0x41CC, address: 0x80BCC220
// Range: 0x8028C560 -> 0x8028C56C
class zMiniME & zMiniME::GetMgr() {
    // References
    // -> static class zMiniME singleMM;
}

// Range: 0x8028C56C -> 0x8028C58C
void zMiniME::Init() {}

// total size: 0x8
struct /* @class$1822zMiniME_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct /* @class$1822zMiniME_cpp */ {
    ...
    float t; // offset 0x0, size 0x4
    float a; // offset 0x4, size 0x4
} alphas[4]; // size: 0x20, address: 0x80405A58
enum xCamCoordType {
...
// Range: 0x8028C58C -> 0x8028C6BC
void zMiniME::SceneEnter(struct zScene * zsc /* r31 */) {
    // Local variables
...
// Range: 0x8028C6BC -> 0x8028C72C
static float get_F32(char * in /* r30 */, char * * out /* r31 */) {
    // Local variables
    float val; // f31
}

// Range: 0x8028C72C -> 0x8028C810
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05C68
// Range: 0x8028C810 -> 0x8028C8F8
static unsigned int get_input(char * in /* r29 */, char * * out /* r4 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C05C74
// Range: 0x8028C8F8 -> 0x8028C9D4
...
// Range: 0x8028C9D4 -> 0x8028CA64
static int get_group_type(char * in /* r31 */, char * * out /* r4 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05C80
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
// Range: 0x8028CA64 -> 0x8028D564
void zMiniME::ParseMGD(unsigned int * buffer /* r15 */, unsigned int size /* r14 */) {
    // Local variables
    class zMiniME & mgr; // r0
    struct xIniFile * ini; // r20
    unsigned char isCurve; // r16
    unsigned char isMinigame; // r17
    int numCurves; // r18
    int numCurvepoints; // r19
    int numMinigames; // r21
    int numActions; // r22
    struct xIniSection * isec; // r23
    struct xIniSection * end_sec; // r24
    int i; // r25
    unsigned int amt; // r14
    unsigned char groupStart; // r14
    int groupType; // r1+0x3C
    struct zMinigameInput * lastInput; // r19
    char * idxs; // r1+0x38
    int * curveIdx; // r5
    unsigned char isAction; // r18
    int i; // r17
    char * s; // r1+0xC
    unsigned char cmd_ok; // r16
    int j; // r0
    int j; // r15
    char * s; // r1+0x8
    char * t; // r0
    float time; // f1
    struct zMinigameEvent * event; // r16
    struct zMinigameInput * input; // r16
    struct zMinigameText * text; // r16
    int j; // r15
    char * s; // r30
    char * s; // r15
    char * q; // r0
    int i; // r18
    class zMinigame * mg; // r19
    unsigned int j; // r21
    struct zMinigameInput * input; // r0
    char flags[32]; // r1+0x10
    struct zMinigameText * text; // r0
...
// Range: 0x8028DCA4 -> 0x8028DD44
void zMiniME::StartMinigame(unsigned int replyWidgetID /* r26 */, unsigned int minigameID /* r27 */, const float * params /* r28 */) {
    // Local variables
    class zMiniME & mgr; // r0
    class zMinigame * mg; // r30
    class zMinigame * mgend; // r29
...
// Range: 0x8028DD44 -> 0x8028DD70
// this: r0
void zMinigame::Start(unsigned int ID /* r0 */) {}

// Range: 0x8028DD70 -> 0x8028DD84
// this: r0
void zMinigame::Stop() {}

static float last_hit[10]; // size: 0x28, address: 0x80BD03EC
// Range: 0x8028DD84 -> 0x8028E360
// this: r27
...
struct /* @class$2499zMiniME_cpp */ {
    ...
    unsigned int id; // offset 0x0, size 0x4
    struct RwTexture * texture; // offset 0x4, size 0x4
} textures[5]; // size: 0x28, address: 0x80446D30
// Range: 0x8028E558 -> 0x8028E7FC
// this: r31
void zMinigame::Render() {
    // Local variables
    int i; // r29
    union _zMinigameActions * action; // r29
    union _zMinigameActions * end_action; // r30
    float start; // f3
    float end; // f0
    float pct; // f1
    float x; // f31
...
// Range: 0x8028E7FC -> 0x8028E848
static void U8_COLOR_CLAMP(unsigned char & destu8 /* r0 */, float srcf32 /* f0 */) {}

static float GX1; // size: 0x4, address: 0x80C05C8C
static float GY1; // size: 0x4, address: 0x80C05C90
static float GDX; // size: 0x4, address: 0x80C05C94
static float GDY; // size: 0x4, address: 0x80C05C98
// total size: 0x4
struct /* @class$2561zMiniME_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
};
...
struct /* @class$2561zMiniME_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
} sGoodFX[8]; // size: 0x20, address: 0x80BD0414
static int sNumGoodFX; // size: 0x4, address: 0x80C094AC
static struct RwTexture * sGoodFXTex; // size: 0x4, address: 0x80C094B0
// Range: 0x8028E848 -> 0x8028E8B0
...
static int numDeflectors; // size: 0x4, address: 0x80C094B4
static class zAnalogInputDeflection * deflectors[16]; // size: 0x40, address: 0x80BD0434
static int numDirectors; // size: 0x4, address: 0x80C094B8
static class zAnalogInputDirection * directors[16]; // size: 0x40, address: 0x80BD0474
static int numTwiddlers; // size: 0x4, address: 0x80C094BC
static class zAnalogInputTwiddler * twiddlers[16]; // size: 0x40, address: 0x80BD04B4
static int numPours; // size: 0x4, address: 0x80C094C0
static class zCMGPourWidget * pours[16]; // size: 0x40, address: 0x80BD04F4
// total size: 0x1
class zAnalogInput {};
// Range: 0x8028EA50 -> 0x8028EB78
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05C9C
// Range: 0x8028EB78 -> 0x8028ECD8
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CA8
// total size: 0x20
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CB0
// Range: 0x8028EDC8 -> 0x8028EF68
void zAnalogInputDeflection::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05CB8
// Range: 0x8028EF68 -> 0x8028F060
void zAnalogInputDeflection::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CC0
// total size: 0x1C
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CC8
// Range: 0x8028F2FC -> 0x8028F49C
void zAnalogInputDirection::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05CD0
// Range: 0x8028F49C -> 0x8028F594
void zAnalogInputDirection::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CD8
// total size: 0x30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CE0
// Range: 0x8028F908 -> 0x8028FAA8
void zAnalogInputTwiddler::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05CE8
// Range: 0x8028FAA8 -> 0x8028FBA0
void zAnalogInputTwiddler::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CF0
// total size: 0x50
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05CF8
// Range: 0x8028FE8C -> 0x8029002C
void zCMGPourWidget::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C05D00
// Range: 0x8029002C -> 0x80290124
void zCMGPourWidget::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
unsigned int pourBarTexID; // size: 0x4, address: 0x80C05D08
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
