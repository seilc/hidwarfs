/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCProjectileFrozen.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80252390 -> 0x80253630
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float angularSpeedMult; // size: 0x4, address: 0x80C04FB0
// total size: 0x10
struct RwRGBAReal {
    // Members
...
static struct xLightKit * envLightKit; // size: 0x4, address: 0x80C091A8
static float DECAL_LIFETIME; // size: 0x4, address: 0x80C04FB4
static float DECAL_SIZE; // size: 0x4, address: 0x80C04FB8
static int THROWN_DAMAGE; // size: 0x4, address: 0x80C04FBC
static float THROWN_DAMAGE_RADIUS; // size: 0x4, address: 0x80C04FC0
static float FROZEN_LIFETIME; // size: 0x4, address: 0x80C04FC4
static float FALL_OUT_OF_WORLD_THRESHOLD; // size: 0x4, address: 0x80C04FC8
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node meltedPoolCurveNodes[4]; // size: 0x70, address: 0x803FD3B0
// Range: 0x80252390 -> 0x802523A8
...
// total size: 0xC
struct /* @class$1038zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zNPCProjectileFrozen_cpp */ {
    // Members
...
static struct xResponseCurve meltedPoolCurve; // size: 0x14, address: 0x80C091AC
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$1097zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$2040zNPCProjectileFrozen_cpp */ {
    // Members
...
union /* @class$1236zNPCProjectileFrozen_cpp */ {
...
// total size: 0xC
struct /* @class$1235zNPCProjectileFrozen_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
static struct FrozenProjectileAssets assets[2]; // size: 0x160, address: 0x80442508
// Range: 0x802523A8 -> 0x802523D0
static unsigned int DestroyCB(struct xEnt * object /* r0 */) {}
...
// total size: 0x10
struct /* @class$1740zNPCProjectileFrozen_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802523D0 -> 0x80252490
static unsigned int CollideCB(float & blastRadius /* r30 */, struct xEnt * thrown /* r4 */, struct xEnt * hit /* r5 */, const struct xVec3 * point /* r31 */, float damageMultiplier /* f31 */, float radiusMultiplier /* f0 */) {
    // References
...
// total size: 0x890
struct /* @class$2241zNPCProjectileFrozen_cpp */ {
    // Static members
...
static struct zParSysSnowsplosionConfig snowConfig; // size: 0x28, address: 0x80442668
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04FCC
...
// Range: 0x80252814 -> 0x80252840
static void FrozenEventWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04FD4
...
// Range: 0x80252840 -> 0x80252AE4
// this: r31
static void zNPCProjectileFrozen::Init(enum zNPCProjectileFrozenType newType /* r0 */) {
    // References
    // -> static struct xLightKit * envLightKit;
    // -> static struct FrozenProjectileAssets assets[2];
...
// Range: 0x80252AE4 -> 0x80252B0C
// this: r0
static void zNPCProjectileFrozen::Reset() {}

// Range: 0x80252B0C -> 0x80252B3C
// this: r3
static void zNPCProjectileFrozen::RemoveFromGrid() {}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C04FDC
// Range: 0x80252B3C -> 0x80252D50
// this: r31
static void zNPCProjectileFrozen::Update(float dt /* f31 */) {
    // Local variables
    float totalMeltTime; // f0
    float scale; // f29
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04FE4
// Range: 0x80252F00 -> 0x80253008
// this: r30
static void zNPCProjectileFrozen::HandleEvent(struct xBase * from /* r4 */, unsigned int toEvent /* r31 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C04FF0
// Range: 0x80253008 -> 0x8025321C
// this: r29
static void zNPCProjectileFrozen::Activate(const struct xMat4x3 & frameMatrix /* r30 */, const struct xVec3 & velocity /* r31 */, enum zNPCProjectileFrozenType newType /* r28 */) {
    // References
...
char __FUNCTION__$localstatic1$front__71pool_list<Q234@unnamed@zNPCProjectileFrozen_cpp@20zNPCProjectileFrozen>Fv[6]; // size: 0x6, address: 0x80C04FFC
// total size: 0x24
...
static class zNPCProjectileFrozenManager frozenManager; // size: 0x24, address: 0x80BCB4B8
// Range: 0x8025321C -> 0x80253254
void zNPCProjectileFreeze(const struct xMat4x3 & frameMatrix /* r4 */, const struct xVec3 & velocity /* r0 */, enum zNPCProjectileFrozenType type /* r5 */) {
    // References
    // -> static class zNPCProjectileFrozenManager frozenManager;
}

// Range: 0x80253254 -> 0x80253328
// this: r26
static void zNPCProjectileFrozenManager::Freeze(const struct xMat4x3 & frameMatrix /* r27 */, const struct xVec3 & velocity /* r28 */, enum zNPCProjectileFrozenType type /* r29 */) {
    // Local variables
    class zNPCProjectileFrozen * newFrozen; // r30
    struct node_type * currentNode; // r4
    struct node_type * const endNode; // r0
    float lowestYHeight; // f0
    class zNPCProjectileFrozen * currentProj; // r5
    float currentNodeY; // f1
}
...
// Range: 0x802533C8 -> 0x802533F4
void zNPCProjectileFrozenInit(int maxNumFrozen /* r4 */) {
    // References
    // -> static class zNPCProjectileFrozenManager frozenManager;
}

static // total size: 0x24
struct {} @unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozenManager::__vtable; // size: 0x24, address: 0x804426B4
// Range: 0x802533F4 -> 0x80253430
// this: r31
...
// total size: 0x24
struct {} zLightweightList<@unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozen>::__vtable; // size: 0x24, address: 0x80442690
// Range: 0x8025346C -> 0x802534EC
// this: r31
