/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xScene.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800AB76C -> 0x800AE9A4
*/
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFE2F8
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFE304
// Range: 0x800ABB08 -> 0x800ABB70
void xSceneExit(struct xScene * sc /* r0 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFE310
// total size: 0x0
struct xSerial {};
// Range: 0x800ABB70 -> 0x800ABC30
void xSceneSave(struct xScene * ent /* r0 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80BFE31C
// Range: 0x800ABC30 -> 0x800ABCF0
void xSceneLoad(struct xScene * ent /* r0 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[11];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFE328
// Range: 0x800ABCF0 -> 0x800ABD68
void xSceneSetup(struct xScene * sc /* r31 */) {
    // References
    // -> static char __FUNCTION__[12];
}

static unsigned char done; // size: 0x1, address: 0x80C07648
static signed char init; // size: 0x1, address: 0x80C07649
static unsigned char done; // size: 0x1, address: 0x80C0764A
static signed char init; // size: 0x1, address: 0x80C0764B
static unsigned char done; // size: 0x1, address: 0x80C0764C
static signed char init; // size: 0x1, address: 0x80C0764D
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE334
// Range: 0x800ABD68 -> 0x800AC230
void xSceneAddEnt(struct xScene * sc /* r30 */, struct xEnt * ent /* r31 */) {
    // References
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE344
// Range: 0x800AC230 -> 0x800AC2CC
struct xBase * xSceneResolvID(struct xScene * sc /* r30 */, unsigned int id /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFE354
// Range: 0x800AC2CC -> 0x800AC380
char * xSceneID2Name(struct xScene * sc /* r30 */, unsigned int id /* r31 */) {
    // References
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFE364
// Range: 0x800AC380 -> 0x800AC4A0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE378
// total size: 0x24
struct xRay3 {
    // Members
...
// Range: 0x800AC4A0 -> 0x800AD18C
void xRayHitsGrid(struct xGrid * grid /* r26 */, struct xScene * sc /* r29 */, struct xRay3 * r /* r30 */, void (* rentcb)(struct xScene *, struct xRay3 *, struct xQCData *, struct xEnt *, void *) /* r28 */, struct xQCData * qcr /* r31 */, void * data /* r27 */) {
    // Local variables
...
int xscRayentNchks; // size: 0x4, address: 0x80BFE388
int xscNupdates; // size: 0x4, address: 0x80BFE38C
float xscRePerUpd; // size: 0x4, address: 0x80BFE390
int xscRayscNchks; // size: 0x4, address: 0x80BFE394
int xscRaycamscNchks; // size: 0x4, address: 0x80BFE398
int xscRayscfNchks; // size: 0x4, address: 0x80BFE39C
float xscRsPerUpd; // size: 0x4, address: 0x80BFE3A0
float xscRcamsPerUpd; // size: 0x4, address: 0x80BFE3A4
float xscRsfPerUpd; // size: 0x4, address: 0x80BFE3A8
float xscRePerRs; // size: 0x4, address: 0x80BFE3AC
int xscNqcrejects; // size: 0x4, address: 0x80BFE3B0
float xscQcrPerUpd; // size: 0x4, address: 0x80BFE3B4
float xscQcrPerRs; // size: 0x4, address: 0x80BFE3B8
float xscQcrPerRe; // size: 0x4, address: 0x80BFE3BC
// Range: 0x800AD18C -> 0x800AD318
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFE3C0
// Range: 0x800AD318 -> 0x800AD434
void xRayHitsEnt(struct xRay3 * r /* r28 */, struct xQCData * qcr /* r29 */, struct xEnt * ent /* r30 */, void * colldata /* r31 */) {
    // Local variables
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFE3CC
// Range: 0x800AD434 -> 0x800AD6E0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFE3DC
// Range: 0x800AD6E0 -> 0x800AD814
void xRayHitsEntFlags(struct xRay3 * r /* r27 */, struct xCollis * coll /* r31 */, struct xQCData * qcr /* r28 */, struct xEnt * ent /* r29 */, unsigned char collType /* r30 */) {
    // Local variables
    struct xCollis c; // r1+0x8
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C0764E
static signed char init; // size: 0x1, address: 0x80C0764F
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE3F0
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFE3F8
// total size: 0x10
struct cbRayHitsEnt {
    // Functions
...
// Range: 0x800AD814 -> 0x800AD9C8
void xRayHitsSceneFlags(struct xScene * sc /* r29 */, const struct xRay3 * r /* r30 */, struct xCollis * coll /* r31 */, unsigned char collType /* r27 */, unsigned char chk /* r26 */) {
    // Local variables
...
// Range: 0x800ADB40 -> 0x800ADE14
static unsigned int Mgc_TriBoxTest(struct xVec3 * apkTri /* r26 */, struct xBox * rkBox /* r27 */) {
    // Local variables
    float fMin0; // r1+0x14
    float fMax0; // r1+0x10
    float fMin1; // r1+0xC
...
static struct xMat4x3 * sBoxTestMat; // size: 0x4, address: 0x80C07650
static unsigned char sUseJSP; // size: 0x1, address: 0x80C07654
static void * sTestOPtr; // size: 0x4, address: 0x80C07658
static struct xModelInstance * sTestMPtr; // size: 0x4, address: 0x80C0765C
// total size: 0x28
...
// Range: 0x800ADE14 -> 0x800AE174
static struct RpCollisionTriangle * nearestFloorCB(struct RpCollisionTriangle * collTriangle /* r25 */, void * data /* r26 */) {
    // Local variables
...
static struct xBound sNearestBound; // size: 0x4C, address: 0x80A93DF0
static unsigned char sNearestChk; // size: 0x1, address: 0x80C07660
static unsigned char sNearestCollType; // size: 0x1, address: 0x80C07661
// total size: 0x18
struct RwLine {
    // Members
...
static struct RpIntersection sSphereIsx; // size: 0x1C, address: 0x80A93E3C
// Range: 0x800AE254 -> 0x800AE27C
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80BFE40C
struct xGrid grabbable_grid; // size: 0x38, address: 0x80B93230
// Range: 0x800AE3CC -> 0x800AE708
...
// Range: 0x800AE708 -> 0x800AE9A4
// this: r29
static unsigned char cbRayHitsEnt::operator()(struct xEnt & ent /* r30 */) {
    // Local variables
