/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCInstaKill.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C5974 -> 0x802C5E18
*/
// total size: 0x1
...
class zICompNPCEntityParams sEntParams; // size: 0x30, address: 0x80BD4748
// total size: 0x8
struct xBaseAsset {
    // Members
...
class zCompPerceptionParams sPerceptionParams; // size: 0x78, address: 0x80BD4778
enum eSteeringType {
...
// Range: 0x802C5A1C -> 0x802C5C20
void zNPCInstaKill::CreateAnimTable(struct xAnimTable * table /* r31 */) {}
...
// Range: 0x802C5C20 -> 0x802C5C24
void zNPCInstaKill::InitCombatDamage() {}

// Range: 0x802C5C24 -> 0x802C5CA0
void zNPCInstaKill::AddTweaks(const char * branchString /* r31 */) {
    // References
    // -> class zCompSteeringGenericParams sSteeringChaseParams;
    // -> class zCompSteeringGenericParams sSteeringAlertParams;
    // -> class zCompSteeringGenericParams sSteeringPatrolParams;
...
char __FUNCTION__$localstatic1$AttachComponent__61zComponentPool<19zCompLogicInstaKill,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06998
...
// total size: 0x4
struct /* @class$1148zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1286zNPCInstaKill_cpp */ {
    // Members
...
union /* @class$1288zNPCInstaKill_cpp */ {
...
// total size: 0xC
struct /* @class$1089zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1090zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1091zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1092zNPCInstaKill_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1093zNPCInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1094zNPCInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1095zNPCInstaKill_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCInstaKill::__vtable; // size: 0x30, address: 0x804491D0
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
