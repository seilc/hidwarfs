/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zBehavior.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80191AA8 -> 0x80195908
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char sDebugBehavior; // size: 0x1, address: 0x80C08868
// Range: 0x80191AA8 -> 0x80191AB0
unsigned int ErrorCB() {}

static long long lastTime; // size: 0x8, address: 0x80C08870
static signed char init; // size: 0x1, address: 0x80C08878
static float lastDiff; // size: 0x4, address: 0x80C0887C
static signed char init; // size: 0x1, address: 0x80C08880
// Range: 0x80191AB0 -> 0x80191C20
static void BehaviorLog(class behavior * inBehavior /* r28 */, const char * inTxt1 /* r29 */, const char * inTxt2 /* r30 */) {
    // Local variables
    class zNPCCommon * npc; // r31
    long long curTime; // r27
...
// total size: 0x4
struct /* @class$1097zBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$2447zBehavior_cpp */ {
    // Members
...
// total size: 0x70
struct {} zBehaviorManager::__vtable; // size: 0x70, address: 0x8043D23C
// total size: 0x14
...
// total size: 0x890
struct /* @class$2212zBehavior_cpp */ {
    // Static members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02158
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80191CD0 -> 0x80191D74
// this: r30
void zBehaviorManager::createTransientStack(int inMax /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
    // -> static char __FUNCTION__[21];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02170
// Range: 0x80191D74 -> 0x80191EFC
// this: r24
unsigned char zBehaviorManager::systemEvent(struct xBase * from /* r25 */, struct xBase * to /* r26 */, unsigned int to_event /* r27 */, const float * to_param /* r28 */, struct xBase * to_param_widget /* r29 */, unsigned int to_param_widget_id /* r30 */) {
    // Local variables
    class behavior * curBehavior; // r31
    struct behavior_node * node; // r23

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x80191EFC -> 0x80191F74
// this: r0
void zBehaviorManager::beforeAnimMatrices(struct xAnimPlay * play /* r28 */, struct xQuat * quat /* r29 */, struct xVec3 * tran /* r30 */, int boneCount /* r31 */) {
    // Local variables
    class behavior * curBehavior; // r0
}

// Range: 0x80191F74 -> 0x80191FE8
// this: r0
unsigned char zBehaviorManager::collisionResponse(const struct xVec3 & current_dir /* r27 */, const struct SphereCollisionResults & scene_collide /* r28 */, struct xVec3 & response_dpos /* r29 */) {
    // Local variables
    unsigned char collide_on; // r31
    struct behavior_node * node; // r30
}

// Range: 0x80191FE8 -> 0x80192044
// this: r0
void zBehaviorManager::registerCollision(const struct SphereCollisionResults & scene_collide /* r30 */) {
    // Local variables
    struct behavior_node * node; // r31
}

// Range: 0x80192044 -> 0x801920A0
// this: r0
void zBehaviorManager::add_states(struct xAnimTable * table /* r30 */) {
    // Local variables
    struct behavior_node * node; // r31
}

// Range: 0x801920A0 -> 0x801920FC
// this: r0
void zBehaviorManager::add_transitions(struct xAnimTable * table /* r30 */) {
    // Local variables
    struct behavior_node * node; // r31
}

// Range: 0x801920FC -> 0x80192188
// this: r0
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C0217C
// Range: 0x801921F8 -> 0x80192284
// this: r0
...
static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043D0A8
// Range: 0x80192284 -> 0x80192314
// this: r0
...
// Range: 0x80192378 -> 0x801925D0
// this: r29
void zBehaviorManager::nuke(struct xVec3 * sourcePos /* r30 */, float inTime /* f27 */, float inRadius /* f28 */, float outRadius /* f29 */) {
    // Local variables
    class zNPCCommon * npc; // r0
    float outRadius2; // f31
    float inRadius2; // f30
    float dist2; // f0
    float dist; // f1
    float at; // f1
    struct zTransientNodeData transientData; // r1+0x8
}
...
// Range: 0x801925D0 -> 0x80192690
// this: r28
void zBehaviorManager::RunDamageBehavior(class behavior * dmgBehavior /* r29 */, struct zCombatDamageInfo & damageInfo /* r30 */) {
    // Local variables
    unsigned char transit; // r0
    class zNPCCommon * npcOwner; // r0
}
...
// total size: 0x4
struct /* @class$2430zBehavior_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2389zBehavior_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2390zBehavior_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2391zBehavior_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2388zBehavior_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2393zBehavior_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1954zBehavior_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1038zBehavior_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zBehavior_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zBehavior_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zBehavior_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zBehavior_cpp */ {
    // Members
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0218C
enum ezHitReaction {
    zHR_None = 0,
    zHR_Smash = 1,
    zHR_Damage = 2,
...
// Range: 0x801926F8 -> 0x80192EA0
// this: r30
void zBehaviorManager::damage(struct zCombatDamageInfo & damageInfo /* r31 */) {
    // Local variables
    class zNPCCommon * npcOwner; // r28
    unsigned char blocked; // r27
    enum ezHitReaction hitReaction; // r0
    enum ezHitReaction hitReaction; // r0
...
// Range: 0x80192EA0 -> 0x80192EA4
void zBehaviorManager::carry() {}

static unsigned char done; // size: 0x1, address: 0x80C08881
static signed char init; // size: 0x1, address: 0x80C08882
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8043D108
// total size: 0x0
...
unsigned char zBehaviorManager::TestForJumpBehaviorChange() {
    ...
    struct zEntTrigger * isectrigger; // r29
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C02194
// Range: 0x8019335C -> 0x8019350C
// this: r28
void zBehaviorManager::testForBehaviorChange(float dt /* f31 */) {
    // Local variables
    class behavior * changeTo; // r30
    class zNPCCommon * npc; // r0
    struct xVec3 * npcPos; // r29

    // References
    // -> static char __FUNCTION__[22];
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C021AC
// Range: 0x8019350C -> 0x8019363C
// this: r30
unsigned char zBehaviorManager::testForCompleteChange() {
    // Local variables
    class behavior * transient; // r31

    // References
    // -> static char __FUNCTION__[22];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C021C4
// Range: 0x8019363C -> 0x80193770
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C021D0
// Range: 0x80193770 -> 0x8019391C
// this: r29
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C021D8
// Range: 0x8019391C -> 0x80193AAC
// this: r28
void zBehaviorManager::addBehavior(class behavior * new_behavior /* r29 */, int priority /* r30 */) {
    // Local variables
    struct behavior_node * node; // r31
    struct behavior_node * inserted_node; // r0
    struct behavior_node * post; // r4
...
// Range: 0x80193AAC -> 0x80193BB4
// this: r29
void zBehaviorManager::setBehavior(class behavior * new_behavior /* r30 */) {
    // Local variables
    class behavior * prevBehavior; // r0
    class behavior * const previous_behavior; // r31
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C021E4
// Range: 0x80193BB4 -> 0x80193C48
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C021F0
// Range: 0x80193C48 -> 0x80193CDC
// this: r31
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C021F8
// Range: 0x80193CDC -> 0x80193EA4
// this: r31
void zBehaviorManager::reset() {
    // Local variables
    unsigned short beforeFlags; // r30
...
// Range: 0x80193EF4 -> 0x80193EF8
void zBehaviorManager::addTweaks() {}

// Range: 0x80193EF8 -> 0x80193F28
// this: r3
unsigned char behavior::JumpTransitionAllowable() {}

// Range: 0x80193F28 -> 0x80193F58
// this: r3
unsigned char behavior::DodgeTransitionAllowable() {}

// Range: 0x80193F58 -> 0x80193FC0
// this: r30
unsigned char behavior::inAnimState(const char * state /* r4 */, float look_ahead /* f31 */, struct xModelInstance * model /* r31 */) const {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C02200
// Range: 0x80193FC0 -> 0x801940EC
// this: r0
unsigned char behavior::inAnimStateRange(unsigned int stateIDstart /* r0 */, unsigned int stateIDend /* r0 */, float look_ahead /* f0 */, struct xModelInstance * model /* r6 */) const {
    // Local variables
    struct xAnimState * astate; // r6

    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02214
// Range: 0x801940EC -> 0x80194294
// this: r29
unsigned char behavior::inAnimState(unsigned int stateID /* r30 */, float look_ahead /* f31 */, struct xModelInstance * model /* r31 */) const {
    // Local variables
    struct xAnimState * astate; // r4

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x80194294 -> 0x801942EC
// this: r30
unsigned char behavior::isAnimStateStopped(const char * state /* r4 */, struct xModelInstance * model /* r31 */) const {}

// Range: 0x801942EC -> 0x80194374
// this: r0
unsigned char behavior::isAnimStateStopped(unsigned int stateID /* r0 */, struct xModelInstance * model /* r5 */) const {
    // Local variables
    struct xAnimState * astate; // r3
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C02220
// Range: 0x80194374 -> 0x8019446C
// this: r0
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02230
// Range: 0x8019446C -> 0x80194550
// this: r0
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C0223C
// Range: 0x80194550 -> 0x8019466C
// this: r28
void behavior::setAnimState(unsigned int new_stateID /* r29 */, float blend /* f31 */, struct xModelInstance * model /* r30 */) {
    // Local variables
...
// Range: 0x8019466C -> 0x801946D4
// this: r30
void behavior::setAnimState(const char * new_state /* r4 */, float blend /* f31 */, struct xModelInstance * model /* r31 */) {}

// Range: 0x801946D4 -> 0x8019474C
// this: r30
void behavior::setAnimState(const char * new_state /* r4 */, float blend /* f30 */, float dest_time /* f31 */, struct xModelInstance * model /* r31 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C0224C
// Range: 0x8019474C -> 0x80194880
// this: r28
void behavior::setAnimState(unsigned int new_stateID /* r29 */, float blend /* f30 */, float dest_time /* f31 */, struct xModelInstance * model /* r30 */) {
    // Local variables
    struct xAnimTransition * transition; // r31
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C0225C
// Range: 0x801948F8 -> 0x80194AB0
// this: r27
void behavior::addTest(class behavior * destBehavior /* r28 */, unsigned char (* inTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r29 */, char * description /* r30 */, float waitTime /* f31 */) {
    // Local variables
    struct testNode * append_node; // r0
    int len; // r0
...
// Range: 0x80194AB0 -> 0x80194AEC
// this: r0
void behavior::addTest(class behavior * destBehavior /* r0 */, unsigned char (* inTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02264
// Range: 0x80194AEC -> 0x80194CBC
// this: r0
void behavior::replaceTest(class behavior * oldDestBehavior /* r0 */, unsigned char (* oldTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * newDestBehavior /* r28 */, unsigned char (* newTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r29 */, char * description /* r30 */) {
    // Local variables
...
// Range: 0x80194CBC -> 0x80194CF4
// this: r0
void behavior::replaceTest(class behavior * oldDestBehavior /* r0 */, unsigned char (* oldTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * newDestBehavior /* r0 */, unsigned char (* newTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r0 */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02270
// Range: 0x80194CF4 -> 0x80194EB8
// this: r0
void behavior::insertTest(class behavior * oldDestBehavior1 /* r0 */, unsigned char (* oldTestFunc1)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * oldDestBehavior2 /* r0 */, unsigned char (* oldTestFunc2)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * newDestBehavior /* r27 */, unsigned char (* newTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r28 */, char * description /* r29 */) {
    // Local variables
    struct testNode * node; // r30
    struct testNode * insert_node; // r0
    int len; // r0
...
// Range: 0x80194EB8 -> 0x80194EF0
// this: r0
void behavior::insertTest(class behavior * oldDestBehavior1 /* r0 */, unsigned char (* oldTestFunc1)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * oldDestBehavior2 /* r0 */, unsigned char (* oldTestFunc2)(struct xEnt *, class behavior *, class behavior *) /* r0 */, class behavior * newDestBehavior /* r0 */, unsigned char (* newTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r0 */) {}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C0227C
// Range: 0x80194EF0 -> 0x80195040
// this: r30
class behavior * behavior::runTests(float seconds /* f30 */) {
    // Local variables
    struct testNode * node; // r31
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02288
// Range: 0x80195040 -> 0x801950E0
// this: r0
...
// total size: 0x118
struct {} behavior::__vtable; // size: 0x118, address: 0x8043D124
// Range: 0x801950E0 -> 0x801950FC
// this: r0
behavior::behavior() {
    // References
...
// Range: 0x801950FC -> 0x80195108
// this: r0
unsigned char behavior::isAttackState() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C0229C
// Range: 0x80195108 -> 0x80195338
// this: r28
void zBehaviorManager::PushTransient(class behavior * pushTransient /* r29 */, struct zTransientNodeData * initData /* r30 */) {
    // Local variables
    class behavior * prevBehavior; // r31
    struct zTransientNodeData * contextData; // r30

    // References
    // -> static char __FUNCTION__[14];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C022AC
// Range: 0x80195338 -> 0x80195684
// this: r30
void zBehaviorManager::PopTransient() {
    // Local variables
    class behavior * poppedTransient; // r31
    struct zTransientNode * tnode; // r29
    class behavior * nextTransient; // r28

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C022BC
// Range: 0x80195684 -> 0x80195908
// this: r29
void zBehaviorManager::ResetTransients(unsigned char enterCurBehavior /* r0 */) {
    // Local variables
