/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFire.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8011EAC8 -> 0x801243FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float alpha; // size: 0x4, address: 0x80C00500
static float flame_tall_width; // size: 0x4, address: 0x80C00504
static float flame_tall_height; // size: 0x4, address: 0x80C00508
static float flame_short_width; // size: 0x4, address: 0x80C0050C
static float flame_short_height; // size: 0x4, address: 0x80C00510
static float rand_offset; // size: 0x4, address: 0x80C07D80
static float overlap_max; // size: 0x4, address: 0x80C00514
static float overlap_normal; // size: 0x4, address: 0x80C00518
static float heat_spread_radius; // size: 0x4, address: 0x80C0051C
static float heat_spread_factor; // size: 0x4, address: 0x80C00520
static float shrink_heat; // size: 0x4, address: 0x80C00524
static float hot; // size: 0x4, address: 0x80C00528
static float card_frame_rate; // size: 0x4, address: 0x80C0052C
static float heat_decay; // size: 0x4, address: 0x80C00530
static float heat_rate_death; // size: 0x4, address: 0x80C00534
static float heat_rate_growth; // size: 0x4, address: 0x80C00538
static float heat_rate_decay; // size: 0x4, address: 0x80C0053C
static float heat_rate_spread; // size: 0x4, address: 0x80C00540
static float heat_growth_max; // size: 0x4, address: 0x80C00544
static float blend_rate_down; // size: 0x4, address: 0x80C00548
static float blend_rate_up; // size: 0x4, address: 0x80C0054C
static float ground_dist_max; // size: 0x4, address: 0x80C00550
static float ground_dist_bias; // size: 0x4, address: 0x80C00554
static float ground_max_tilt; // size: 0x4, address: 0x80C00558
static float clip_scale_radius; // size: 0x4, address: 0x80C0055C
static float reblast_delay; // size: 0x4, address: 0x80C00560
static int brightness; // size: 0x4, address: 0x80C00564
static unsigned int emitter; // size: 0x4, address: 0x80C00568
static float emit_radius; // size: 0x4, address: 0x80C0056C
static float rate_scale_heat; // size: 0x4, address: 0x80C00570
static float rate_scale_dheat; // size: 0x4, address: 0x80C00574
static float rate_max; // size: 0x4, address: 0x80C00578
static float emit_width; // size: 0x4, address: 0x80C0057C
static float y_min; // size: 0x4, address: 0x80C00580
static float y_max; // size: 0x4, address: 0x80C07D84
static float vel_min; // size: 0x4, address: 0x80C00584
static float vel_max; // size: 0x4, address: 0x80C00588
static float life_min; // size: 0x4, address: 0x80C0058C
static float life_max; // size: 0x4, address: 0x80C00590
static float size_min; // size: 0x4, address: 0x80C00594
static float size_max; // size: 0x4, address: 0x80C00598
static unsigned int texture; // size: 0x4, address: 0x80C07D88
static float emit_rate; // size: 0x4, address: 0x80C0059C
static float emit_radius; // size: 0x4, address: 0x80C005A0
static float size_min; // size: 0x4, address: 0x80C005A4
static float size_max; // size: 0x4, address: 0x80C005A8
static float vel_dir_vary; // size: 0x4, address: 0x80C005AC
static float vel_dir_ymin; // size: 0x4, address: 0x80C005B0
static float vel_min; // size: 0x4, address: 0x80C005B4
static float vel_max; // size: 0x4, address: 0x80C005B8
static float life_min; // size: 0x4, address: 0x80C005BC
static float life_max; // size: 0x4, address: 0x80C005C0
static float growth; // size: 0x4, address: 0x80C005C4
static float rot_vel_min; // size: 0x4, address: 0x80C005C8
static float rot_vel_max; // size: 0x4, address: 0x80C005CC
static float intensity; // size: 0x4, address: 0x80C005D0
static float freq; // size: 0x4, address: 0x80C005D4
static unsigned char active; // size: 0x1, address: 0x80C07D8C
static unsigned char grounded; // size: 0x1, address: 0x80C005D8
static float radius; // size: 0x4, address: 0x80C005DC
static float fuel; // size: 0x4, address: 0x80C005E0
static unsigned char render_fire; // size: 0x1, address: 0x80C005E4
static unsigned char render_clipped_tris; // size: 0x1, address: 0x80C07D8D
// Range: 0x8011EAC8 -> 0x8011EB04
static void tweak_cos_to_deg(void * value /* r31 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x8011EB04 -> 0x8011EB40
static void tweak_deg_to_cos(void * value /* r31 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x8011EB40 -> 0x8011EB60
static void on_refresh_smoke_emitter() {}

// Range: 0x8011EB60 -> 0x8011EB80
static void on_refresh_wisp_system() {}

// Range: 0x8011EB80 -> 0x8011EBB0
...
// total size: 0x1
struct /* @class$933zFire_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zFire_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zFire_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zFire_cpp */ {
    // Members
...
static struct tweak_callback cb_deg_cos; // size: 0x28, address: 0x803D4478
static struct tweak_callback cb_refresh_smoke_emitter; // size: 0x28, address: 0x803D44A0
static struct tweak_callback cb_refresh_wisp_system; // size: 0x28, address: 0x803D44C8
static struct tweak_callback cb_wisp_vel_dir_vary; // size: 0x28, address: 0x803D44F0
struct tweak_callback cb_tweak_convert_degrees; // size: 0x28, address: 0x803A9AF0
// Range: 0x8011EBB0 -> 0x8011F7D0
...
unsigned char _enabled; // size: 0x1, address: 0x80C07D8E
unsigned char frame_changed; // size: 0x1, address: 0x80C07D8F
struct zFlame * flames; // size: 0x4, address: 0x80C07D90
unsigned int flames_size; // size: 0x4, address: 0x80C07D94
unsigned int flames_used; // size: 0x4, address: 0x80C07D98
// total size: 0x1C
struct card_info {
    // Members
...
static struct card_info short_card_info; // size: 0x1C, address: 0x803D4518
static struct card_info tall_card_info; // size: 0x1C, address: 0x803D4534
static struct RwTexture * face_texture; // size: 0x4, address: 0x80C07D9C
static struct RwTexture * floor_texture; // size: 0x4, address: 0x80C07DA0
static float anim_frame_time; // size: 0x4, address: 0x80C07DA4
static int anim_frame; // size: 0x4, address: 0x80C07DA8
static struct zFlame * im_flames[64]; // size: 0x100, address: 0x80B90460
static int im_flames_size; // size: 0x4, address: 0x80C07DAC
static int last_brightness; // size: 0x4, address: 0x80C07DB0
static int last_background_glow; // size: 0x4, address: 0x80C07DB4
// total size: 0x0
struct asset_type {};
// total size: 0x0
struct debug_info {};
...
static class zSmokeEmitter * smoke_emitter; // size: 0x4, address: 0x80C07DB8
static struct RwTexture * wisp_texture; // size: 0x4, address: 0x80C07DBC
static int wisp_system_id; // size: 0x4, address: 0x80C07DC0
static int spawn_explosion_type; // size: 0x4, address: 0x80C07DC4
// Range: 0x8011F7D0 -> 0x8011F808
...
// Range: 0x8011F9F8 -> 0x8011FA84
static void spread_heat(float dt /* f0 */) {
    // Local variables
    float spread_delta; // f2
...
// Range: 0x8011FBD4 -> 0x8011FE10
static int update_wisp_particles(unsigned char * mem /* r31 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__pos_color_size_rot & pool; // r30
    float glow; // f30
    struct wisp_particle * p; // r29
    struct wisp_particle * end; // r28
...
static struct property_set debug_props; // size: 0x60, address: 0x80439C78
// total size: 0x30
struct spawn_data {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C005E8
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80120228 -> 0x80120380
void scene_enter() {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C005F4
// Range: 0x801203B8 -> 0x80120444
void setup() {
    // References
...
static struct property_set debug_props; // size: 0x60, address: 0x80439CD8
// total size: 0x2
struct zCheats {
    // Members
...
static unsigned char always_render_im; // size: 0x1, address: 0x80C07DC8
static signed char init; // size: 0x1, address: 0x80C07DC9
// total size: 0x1C
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C005FC
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
void render() {
    ...
    int floor_verts; // r29
    int i; // r6
    struct xVec3 * face_pos; // r28
    struct xVec3 * floor_pos; // r27
    struct xVec2 * face_uv; // r26
    struct xVec2 * floor_uv; // r25
    unsigned int * face_color; // r24
    unsigned int * floor_color; // r23
    unsigned char firstVert; // r17
    float Cx; // r1+0x6C
    float Cy; // r1+0x68
    float Cz; // r1+0x64
    struct xVec3 lastPos; // r1+0x8
    struct zFlame * flame; // r18
    float s; // f0
    float Ex; // f19
    float Ey; // f18
    float Ez; // f17
...
// Range: 0x801220E4 -> 0x80122554
void emit_sphere(const struct spawn_data & params /* r0 */, const struct xVec3 & center /* r26 */, float radius /* f19 */) {
    // Local variables
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C0060C
// Range: 0x80122554 -> 0x8012260C
...
// Range: 0x80122BC4 -> 0x80122BF0
// this: r3
void zFlame::get_bound(struct xBound & bound /* r4 */) const {}

// Range: 0x80122BF0 -> 0x80122C7C
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C0062C
// Range: 0x80122C7C -> 0x80122F40
// this: r31
...
// Range: 0x80122F40 -> 0x801230DC
// this: r31
void zFlame::update_effects(float dt /* f29 */) {
    // Local variables
    float end_heat; // f31
    float dh; // f30
    float diff; // f2
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C00634
// Range: 0x801230DC -> 0x8012340C
// this: r30
...
// Range: 0x8012340C -> 0x80123460
// this: r31
void zFlame::destroy() {}

// Range: 0x80123460 -> 0x80123490
// this: r0
float zFlame::absorb_heat(float dh /* f1 */) {}

// Range: 0x80123490 -> 0x80123898
// this: r26
void zFlame::emit_wisps(float dt /* f0 */) {
    // Local variables
    int emit; // r29
    float cx; // r1+0x58
    float cy; // r1+0x54
    float cz; // r1+0x50
    float radius; // r1+0x4C
    float size_min; // f24
    float size_delta; // r1+0x48
    float vy_min; // f0
    float vy_delta; // f23
    float vmag_min; // f0
    float vmag_delta; // f22
    float life_min; // f0
    float life_delta; // f21
    float growth; // f20
    float drot_min; // f0
    float drot_delta; // f19
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct wisp_particle * p; // r28
...
// Range: 0x80123898 -> 0x80123994
static void random_sphere_offset(struct xVec3 & offset /* r31 */, float radius /* f27 */) {
    // Local variables
    float ang; // f30
    float uz; // f29
    float r; // f28
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C0063C
// Range: 0x80123994 -> 0x80123CA4
// this: r24
void zFlame::emit_smoke(float dheat /* f0 */, float dt /* f23 */) {
    // Local variables
    float rate; // f1
    int emit; // r28
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00648
// Range: 0x80123CA4 -> 0x80123E3C
// this: r27
void zFlame::unlink_nearby() {
    // Local variables
    struct zFlame * * n; // r31
    struct zFlame * * endn; // r30
    struct zFlame & nf; // r29
    struct zFlame * * m; // r28
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00658
// Range: 0x80123E3C -> 0x80123F60
// this: r27
void zFlame::relink_nearby(struct zFlame * old_addr /* r28 */) {
    // Local variables
    struct zFlame * * n; // r31
    struct zFlame * * endn; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00668
// total size: 0x8
...
void zFlame::refresh_nearby() {
    ...
    struct flame_distance_pair * p; // r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00678
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00688
// Range: 0x8012426C -> 0x8012435C
// this: r30
