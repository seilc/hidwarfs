/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iDebugLink.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021A8B0 -> 0x8021AF74
*/
static long exiChan; // size: 0x4, address: 0x80C08F18
unsigned long mailbox; // size: 0x4, address: 0x80C08F1C
// Range: 0x8021A8B0 -> 0x8021A8F4
int hioEnumCallback(long chan /* r31 */) {
    // References
    // -> static long exiChan;
}

// Range: 0x8021A8F4 -> 0x8021A914
void hioCallback() {}

// Range: 0x8021A914 -> 0x8021A954
...
// total size: 0x4
struct /* @class$1088iDebugLink_cpp */ {
    // Members
...
union /* @class$1227iDebugLink_cpp */ {
...
// total size: 0xC
struct /* @class$1226iDebugLink_cpp */ {
    // Members
...
// Range: 0x8021AB54 -> 0x8021ACF8
// this: r31
enum eError iDebugLink::ReadyForAssetData() {
    // Local variables
    unsigned char hdrBuffer[32]; // r1+0x20
    unsigned int assetSize; // r29
    const char * assetName; // r3
    int roundedAssetSize; // r30
    unsigned char * buffer; // r28
    enum eError retval; // r28
}

// Range: 0x8021ACF8 -> 0x8021AE5C
...
// Range: 0x8021AF6C -> 0x8021AF74
enum eError iDebugLink::HeartBeatResponse() {}

// total size: 0x30
struct {} iDebugLink::__vtable; // size: 0x30, address: 0x8043F650
