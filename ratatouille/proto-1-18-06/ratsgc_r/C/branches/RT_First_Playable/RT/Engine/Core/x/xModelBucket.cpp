/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xModelBucket.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80087E50 -> 0x8008A884
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct RpWorld * sBucketDummyWorld; // size: 0x4, address: 0x80C074B8
// total size: 0x14
...
static struct RwCamera * sBucketDummyCamera; // size: 0x4, address: 0x80C074BC
static int sBucketCurr; // size: 0x4, address: 0x80C074C0
static int sBucketCount; // size: 0x4, address: 0x80C074C4
// total size: 0x10
struct RwSphere {
    // Members
...
// total size: 0x4
struct /* @class$1080xModelBucket_cpp */ {
    // Members
...
static struct xModelBucket * sBucketList; // size: 0x4, address: 0x80C074C8
static int sBucketClipCullCurr; // size: 0x4, address: 0x80C074CC
static int sBucketClipCullCount; // size: 0x4, address: 0x80C074D0
static struct xModelBucket * * sBucketClipCullList; // size: 0x4, address: 0x80C074D4
static int sAlphaCurr; // size: 0x4, address: 0x80C074D8
static int sAlphaStart; // size: 0x4, address: 0x80C074DC
static int sAlphaCount; // size: 0x4, address: 0x80C074E0
// total size: 0x14
...
static struct xModelAlphaBucket * sAlphaList; // size: 0x4, address: 0x80C074E4
unsigned char sRenderModels; // size: 0x1, address: 0x80BFD570
unsigned char sRenderAlpha; // size: 0x1, address: 0x80BFD571
unsigned char sRenderClones; // size: 0x1, address: 0x80BFD572
static int sBucketOpaqueRenderStart; // size: 0x4, address: 0x80C074E8
// Range: 0x80087E50 -> 0x80087ED8
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x804190F0
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0xC
struct /* @class$1236xModelBucket_cpp */ {
    // Members
...
union /* @class$1237xModelBucket_cpp */ {
...
// total size: 0x10
struct /* @class$1501xModelBucket_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80087ED8 -> 0x80088084
unsigned int xModelBucket_HackPipeFlags(struct RpAtomic * data /* r29 */, unsigned int pipeFlags /* r30 */, unsigned int aid /* r31 */) {
    // Local variables
    int rc; // r0
...
// Range: 0x80088084 -> 0x8008808C
int DBG_SkipCloneHelperComment() {}

// Range: 0x8008808C -> 0x800880BC
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8041910C
...
// Range: 0x80088328 -> 0x80088330
static struct RpAtomic * GimmeAtomicCallback(struct RpAtomic * atomic /* r0 */, void * tmp /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD574
...
// total size: 0x0
struct RpSkin {};
// Range: 0x80088330 -> 0x800888E4
void FullAtomicDupe(struct RpAtomic * atomic /* r28 */, int count /* r29 */, struct RpAtomic * * output /* r26 */) {
    // Local variables
    int i; // r30
    ...
    int result; // r0
    struct RpClump * tempClump; // r26
    struct RwMemory rwmemB; // r1+0xC
    struct RpClump * outClump; // r0
    struct RpHAnimHierarchy * pHier; // r26
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80419128
// Range: 0x800889DC -> 0x80088D14
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD584
// Range: 0x80088D14 -> 0x80088EEC
...
struct RpAtomic * gxModelBucketProfileModel; // size: 0x4, address: 0x80C074EC
unsigned int gxModelBucketProfileCount; // size: 0x4, address: 0x80C074F0
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD598
enum xScreenDump {
    exSD_NONE = 0,
    exSD_NATIVE = 1,
    exSD_MASSIVE = 2,
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x80419144
// Range: 0x80089340 -> 0x800896C8
void xModelBucket_AddAlphaFade(struct xModelInstance * minst /* r30 */, float alphaFade /* f31 */) {
    // Local variables
    struct xMat4x3 * cammat; // r3
    struct xModelBucket * bucket; // r31
    float camdot; // f3
...
// Range: 0x800896C8 -> 0x800896D4
void xModelBucket_RenderOpaqueBegin() {
    // References
    // -> static int sBucketOpaqueRenderStart;
}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x80419160
// Range: 0x800896D4 -> 0x800898A4
void xModelBucket_RenderOpaque(int maxLayer /* r26 */) {
    // Local variables
    int i; // r30
    struct xModelBucket * bucket; // r29
...
static int enableValidation; // size: 0x4, address: 0x80C074F8
static signed char init; // size: 0x1, address: 0x80C074FC
static const struct xModelInstance * lastModel; // size: 0x4, address: 0x80C07500
static signed char init; // size: 0x1, address: 0x80C07504
static char __FUNCTION__[32]; // size: 0x20, address: 0x8041917C
unsigned char HDR_brightening; // size: 0x1, address: 0x80C088E0
// total size: 0x28
struct PKRAssetType {
    // Members
...
void ValidateRenderStateExpectations(const struct xModelInstance * model /* r29 */, unsigned int pipeFlags /* r30 */) {
    ...
    enum en_pkrfindmyass quality; // r30
...
static char __FUNCTION__[38]; // size: 0x26, address: 0x8041919C
enum RwFogType {
...
// Range: 0x80089DA0 -> 0x8008A320
static void xModelBucket_RenderAlphaLayerInternal(int maxLayer /* r31 */) {
    // Local variables
    unsigned int pipeMask; // r30
    unsigned int curPipeFlags; // r29
    unsigned int lastPipeFlags; // r21
    ...
    enum RwBlendFunction destBlend; // r3
...
static struct xModelBadLayer xModelBucket_BadSetModels[16]; // size: 0x100, address: 0x80A84118
static int currentCountBadSetModels; // size: 0x4, address: 0x80C07508
// Range: 0x8008A320 -> 0x8008A390
static void xModelBucket_CheckModel(unsigned int modelID /* r0 */, int curLayer /* r0 */, int modelLayer /* r0 */) {
    // Local variables
    int i; // r0
    struct xModelBadLayer & tempModel; // r6
...
static char __FUNCTION__[33]; // size: 0x21, address: 0x804191C4
// Range: 0x8008A390 -> 0x8008A490
...
// Range: 0x8008A490 -> 0x8008A530
static void xModelBucket_ClearModelsArray() {
    // Local variables
    int i; // r0
    struct xModelBadLayer & model; // r10

    // References
    // -> static struct xModelBadLayer xModelBucket_BadSetModels[16];
}

// Range: 0x8008A530 -> 0x8008A558
void xModelBucket_InitBadSetModelsCheck() {
    // References
    // -> static int currentCountBadSetModels;
}

// Range: 0x8008A558 -> 0x8008A578
void xModelBucket_DoGCAsserts() {}

// Range: 0x8008A578 -> 0x8008A634
void xModelBucket_RenderAlphaLayer(int maxLayer /* r29 */) {
    // Local variables
    int lastLayer; // r31
    int layer; // r30
