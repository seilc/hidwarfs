/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xScreenFade.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80199AB8 -> 0x8019A388
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cnt_fadesInProgress; // size: 0x4, address: 0x80C088B0
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x80199AB8 -> 0x80199BA0
// this: r30
void xScreenFade::load(struct asset_type & a /* r31 */) {
    // References
    // -> struct xColor_tag g_CLEAR;
}

// Range: 0x80199BA0 -> 0x80199BFC
unsigned char xScreenFade::InterpCol(float t /* f0 */, unsigned char s /* r0 */, unsigned char d /* r0 */) {
    // Local variables
    float val; // f3
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C023A0
// Range: 0x80199BFC -> 0x80199C84
// this: r0
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C023AC
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1127xScreenFade_cpp */ {
    // Members
...
union /* @class$1266xScreenFade_cpp */ {
...
// total size: 0xC
struct /* @class$1265xScreenFade_cpp */ {
    // Members
...
// Range: 0x80199C84 -> 0x80199F7C
// this: r31
void xScreenFade::update(float seconds /* f31 */) {
    // Local variables
    float percent; // f31
    float percent; // f31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C023B4
// Range: 0x8019A02C -> 0x8019A1A0
void xScreenFade::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x8019A1A0 -> 0x8019A20C
void xScreenFade::update_all(float dt /* f31 */) {
    // Local variables
    struct zScene & scene; // r3
    struct xScreenFade * it; // r31
    struct xScreenFade * end; // r30

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8019A20C -> 0x8019A268
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C023BC
// Range: 0x8019A268 -> 0x8019A388
void xScreenFade::cb_dispatch(struct xBase * from /* r29 */, struct xBase * to /* r31 */, unsigned int event /* r30 */) {
    // Local variables
