/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zVar.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8017CC74 -> 0x8017E8C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8017CC74 -> 0x8017CC7C
unsigned int zVarEntryCB_IsSignedIn() {}

// Range: 0x8017CC7C -> 0x8017CC84
unsigned int zVarEntryCB_PendingFriendRequest() {}

// Range: 0x8017CC84 -> 0x8017CC8C
unsigned int zVarEntryCB_PendingGameInvite() {}

int bad_card_available; // size: 0x4, address: 0x80C085C0
int bad_card_needed; // size: 0x4, address: 0x80C085C4
static char buffer[64]; // size: 0x40, address: 0x80BAB870
// Range: 0x8017CC8C -> 0x8017CD1C
...
static char buffer[12]; // size: 0xC, address: 0x80C085C8
// Range: 0x8017CD1C -> 0x8017CD58
...
static char buffer[12]; // size: 0xC, address: 0x80C085D4
// Range: 0x8017CD58 -> 0x8017CD94
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C01C58
// total size: 0x6C
...
struct zSaveLoadGame zSaveLoadGameTable[]; // size: 0x0, address: 0x80B9FAF8
// Range: 0x8017CD94 -> 0x8017D22C
static char * zVarGameSlotInfo(int i /* r29 */, char * buffer /* r30 */, unsigned long max_len /* r31 */) {
    // Local variables
    ...
    const char * empty_string; // r14
    const char * damaged_save_name; // r16
    int size; // r0
    int size; // r0
...
static char buffer[128]; // size: 0x80, address: 0x80BAB8B0
// Range: 0x8017D22C -> 0x8017D25C
static char * var_text_GameSlot0() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BAB930
// Range: 0x8017D25C -> 0x8017D28C
static char * var_text_GameSlot1() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BAB9B0
// Range: 0x8017D28C -> 0x8017D2BC
static char * var_text_GameSlot2() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BABA30
// Range: 0x8017D2BC -> 0x8017D2EC
static char * var_text_GameSlot3() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BABAB0
// Range: 0x8017D2EC -> 0x8017D31C
static char * var_text_GameSlot4() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BABB30
// Range: 0x8017D31C -> 0x8017D34C
static char * var_text_GameSlot5() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BABBB0
// Range: 0x8017D34C -> 0x8017D37C
static char * var_text_GameSlot6() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80BABC30
// Range: 0x8017D37C -> 0x8017D3AC
static char * var_text_GameSlot7() {
    // References
    // -> static char buffer[128];
}

static unsigned int state_text[4]; // size: 0x10, address: 0x80C0C670
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C01C6C
// Range: 0x8017D3AC -> 0x8017D440
...
static char buffer[12]; // size: 0xC, address: 0x80C085E0
// Range: 0x8017D440 -> 0x8017D484
static char * var_text_MCAutoSaveCard() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x80BABCB0
// Range: 0x8017D484 -> 0x8017D504
...
static char buffer[12]; // size: 0xC, address: 0x80C085EC
// Range: 0x8017D504 -> 0x8017D548
static char * var_text_MCSelectedGame() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x80C085F8
// Range: 0x8017D548 -> 0x8017D588
static char * var_text_SpaceAvailable() {
    // References
    // -> static char buffer[12];
}

static char buffer[64]; // size: 0x40, address: 0x80BABCD0
// Range: 0x8017D588 -> 0x8017D620
...
static char buffer[12]; // size: 0xC, address: 0x80C08604
// Range: 0x8017D620 -> 0x8017D660
static char * var_text_SpaceNeeded() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x80BABD10
// Range: 0x8017D660 -> 0x8017D6F0
static char * var_text_MCName() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x80BABD30
// Range: 0x8017D6F0 -> 0x8017D734
static char * var_text_MCMaxSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x80BABD50
// Range: 0x8017D734 -> 0x8017D778
static char * var_text_MCMinSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[12]; // size: 0xC, address: 0x80C08610
// Range: 0x8017D778 -> 0x8017D7CC
...
static char buffer[12]; // size: 0xC, address: 0x80C0861C
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C01C84
// Range: 0x8017D7CC -> 0x8017D874
...
// Range: 0x8017D874 -> 0x8017D8A4
static char * var_text_CurrentArea() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x80BABD70
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C01C98
// Range: 0x8017D8A4 -> 0x8017D924
...
// Range: 0x8017D924 -> 0x8017D954
static char * var_text_CurrentLevel() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x80BABD90
// Range: 0x8017D954 -> 0x8017D9B0
...
static char buffer[32]; // size: 0x20, address: 0x80BABDB0
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C01CB0
// Range: 0x8017D9B0 -> 0x8017DA30
...
static char buffer[48]; // size: 0x30, address: 0x80BABDD0
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8017DA30 -> 0x8017DAB4
static char * var_text_PlayerPosition() {
    // Local variables
    const struct xVec3 & v; // r0
...
static unsigned int selSceneID; // size: 0x4, address: 0x80C08628
// Range: 0x8017DAB4 -> 0x8017DAD8
static char * var_text_SelectedArea() {
    // References
    // -> static unsigned int selSceneID;
}

static char buffer[12]; // size: 0xC, address: 0x80C0862C
// Range: 0x8017DAD8 -> 0x8017DB1C
static char * var_text_SoundFXVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x80C08638
// Range: 0x8017DB1C -> 0x8017DB60
static char * var_text_SoundMusicVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[5]; // size: 0x5, address: 0x80C08644
// Range: 0x8017DB60 -> 0x8017DBA0
static char * var_text_HitCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x80C0864C
// Range: 0x8017DBA0 -> 0x8017DBE0
static char * var_text_TotalCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x80C08654
// Range: 0x8017DBE0 -> 0x8017DC38
static char * var_text_UpgradePoints0() {
    // Local variables
    struct zCommonPlayer * play; // r0
...
static char buffer[5]; // size: 0x5, address: 0x80C0865C
// Range: 0x8017DC38 -> 0x8017DC40
static char * var_text_UpgradePoints1() {
    // References
    // -> static char buffer[5];
}

static char buffer[10]; // size: 0xA, address: 0x80C08664
// Range: 0x8017DC40 -> 0x8017DCB8
static char * var_text_Health0() {
    // Local variables
    struct zCommonPlayer * play; // r30
...
static char buffer[10]; // size: 0xA, address: 0x80C08670
// Range: 0x8017DCB8 -> 0x8017DD30
...
static char buffer[10]; // size: 0xA, address: 0x80C0867C
// Range: 0x8017DD30 -> 0x8017DD88
...
// total size: 0x4
struct /* @class$2190zVar_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2191zVar_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$987zVar_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$988zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$989zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$990zVar_cpp */ {
    // Members
...
static char buffer[10]; // size: 0xA, address: 0x80C08688
// Range: 0x8017DD88 -> 0x8017DE04
...
static char buffer[10]; // size: 0xA, address: 0x80C08694
// Range: 0x8017DE04 -> 0x8017DE5C
...
static char buffer[10]; // size: 0xA, address: 0x80C086A0
// Range: 0x8017DE5C -> 0x8017DED8
...
static char buffer[8]; // size: 0x8, address: 0x80C086AC
// Range: 0x8017DED8 -> 0x8017DF24
...
static struct var_type vars[43]; // size: 0x204, address: 0x8043CAA8
// Range: 0x8017DF24 -> 0x8017DFAC
static struct var_type * find_var(const struct substr & s /* r26 */) {
    // Local variables
    unsigned long start; // r30
    unsigned long end; // r29
    unsigned long i; // r28
    struct var_type & t; // r27
    int c; // r0
...
// Range: 0x8017DFAC -> 0x8017E04C
static void parse_tag_var(struct jot & j /* r31 */, const struct split_tag & ti /* r0 */) {}
...
static struct tag_type var_tag; // size: 0x14, address: 0x80C01CC8
// Range: 0x8017E04C -> 0x8017E074
void var_init() {
    // References
    // -> static struct tag_type var_tag;
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C01CDC
// Range: 0x8017E074 -> 0x8017E10C
char * var_text(const struct substr & name /* r0 */) {
    // Local variables
    const struct var_type * var; // r0
...
struct zVarEntry zVarEntryTable[36]; // size: 0x240, address: 0x8043CCAC
// total size: 0xC
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C01CE8
// Range: 0x8017E10C -> 0x8017E1B0
void zVarInit(struct zVarEntry * table /* r3 */) {
    // Local variables
    int i; // r30
...
// Range: 0x8017E464 -> 0x8017E498
unsigned int zVarEntryCB_Date() {
    // Local variables
    unsigned int date; // r3
}

// Range: 0x8017E498 -> 0x8017E4B8
unsigned int zVarEntryCB_Hour() {
    // Local variables
    unsigned int hour; // r0
}

// Range: 0x8017E4B8 -> 0x8017E4D8
unsigned int zVarEntryCB_Minute() {
    // Local variables
    unsigned int minute; // r0
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043CEEC
// Range: 0x8017E4D8 -> 0x8017E55C
unsigned int zVarEntryCB_CounterValue(void * context /* r31 */) {
    // Local variables
    struct xBase * b; // r0
...
// Range: 0x8017E55C -> 0x8017E578
unsigned int zVarEntryCB_ShowHints() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x8017E578 -> 0x8017E580
unsigned int zVarEntryCB_IsSceneUnlocked() {}

// Range: 0x8017E580 -> 0x8017E588
unsigned int zVarEntryCB_IsSceneCompleted() {}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C01CF4
// Range: 0x8017E588 -> 0x8017E610
unsigned int zVarEntryCB_IsEnabled(void * context /* r3 */) {
    // Local variables
    struct xBase * b; // r31
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C01D0C
// Range: 0x8017E610 -> 0x8017E6A4
unsigned int zVarEntryCB_IsVisible(void * context /* r3 */) {
    // Local variables
    struct xEnt * ent; // r31
...
// Range: 0x8017E6A4 -> 0x8017E6DC
unsigned int zVarEntryCB_TimerSecondsLeftValue(void * context /* r0 */) {
    // Local variables
    struct xTimer * timer; // r0
}

// Range: 0x8017E6DC -> 0x8017E71C
unsigned int zVarEntryCB_TimerMilliSecondsLeftValue(void * context /* r0 */) {
    // Local variables
    struct xTimer * timer; // r0
}

unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x80C08218
// Range: 0x8017E71C -> 0x8017E740
