/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerActionWallClimb.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80273040 -> 0x8027429C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float CLIMBING_SPEED; // size: 0x4, address: 0x80C05658
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 HAND_POS; // size: 0xC, address: 0x80C0565C
static struct xVec3 FOOT_POS; // size: 0xC, address: 0x80C05668
static float WALL_TOLERANCE; // size: 0x4, address: 0x80C05674
static float BLEND_VEL_QUAT; // size: 0x4, address: 0x80C05678
static float BLEND_VEL_POS_MAX; // size: 0x4, address: 0x80C0567C
static float LAND_POS; // size: 0x4, address: 0x80C05680
static float SWEPT_SPHERE_DIST; // size: 0x4, address: 0x80C05684
static float SWEPT_SPHERE_TOLER; // size: 0x4, address: 0x80C05688
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088zPlayerActionWallClimb_cpp */ {
    // Members
...
union /* @class$1236zPlayerActionWallClimb_cpp */ {
...
// Range: 0x80273040 -> 0x80273078
static unsigned char IsClimbableSurface(struct xSurface * surface /* r0 */) {
    // Local variables
    struct zSurfaceProps * props; // r4
}
...
// total size: 0xC
struct /* @class$1235zPlayerActionWallClimb_cpp */ {
    // Members
...
// Range: 0x80273078 -> 0x802730E0
static unsigned char RayHitsScene(const struct xRay3 & ray /* r31 */) {
    // Local variables
    struct xCollis collisionResults; // r1+0x8
...
// Range: 0x802732BC -> 0x802733F4
// this: r29
unsigned int zPlayerActionWallClimb::ValidDeltaPos(const struct xVec3 & dpos /* r30 */, struct xVec3 * points /* r31 */) {
    // Local variables
...
// Range: 0x802733F4 -> 0x80273584
// this: r28
unsigned char zPlayerActionWallClimb::ValidLimbPos(const struct xVec3 & pos /* r29 */, struct xVec3 & actualPos /* r30 */) {
    // Local variables
    struct xRay3 ray; // r1+0x2C
    struct xCollis collisionResults; // r1+0x50
    unsigned char hit; // r3
    struct xQCData quickCullData; // r1+0xC
...
// Range: 0x80273584 -> 0x802736C4
// this: r30
void zPlayerActionWallClimb::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x802736C4 -> 0x802737BC
void zPlayerActionWallClimb::AddInternalTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802737BC -> 0x80273914
// this: r30
void zPlayerActionWallClimb::AddActionTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x80273914 -> 0x80273960
void zPlayerActionWallClimb::AddTransitionsFrom(struct xAnimTable * table /* r4 */, const char * fromStates /* r5 */, unsigned short priority /* r6 */, float blend /* f0 */, unsigned int flags /* r8 */, unsigned int userFlags /* r9 */) {}
...
// Range: 0x80273960 -> 0x80273B78
// this: r31
void zPlayerActionWallClimb::TryClimbUp(const struct xVec3 & dpos /* r29 */) {
    // Local variables
    struct xRay3 ray; // r1+0x28
    float backUpDist; // f31
    struct xVec3 start; // r1+0x1C
    struct xVec3 end; // r1+0x10
    struct xSweptSphere sws; // r1+0x4C
...
// Range: 0x80273B78 -> 0x80273EB0
// this: r29
void zPlayerActionWallClimb::Move(struct xScene * s /* r30 */, float dt /* f31 */, struct xEntFrame * frame /* r31 */) {
    // Local variables
    unsigned int animFlags; // r0
    struct xVec3 dpos; // r1+0x2C
    float x; // f30
    float y; // f29
    float translation; // f28
    struct xVec3 points[4]; // r1+0x70
    unsigned int failedLimb; // r0
    class xPlane targetPlane; // r1+0x1C
    struct xVec3 destPos; // r1+0x10
    float distance; // f1
    float length2; // f0
    float maxTranslation; // f28
...
// total size: 0x890
struct /* @class$1946zPlayerActionWallClimb_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1029zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1030zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zPlayerActionWallClimb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zPlayerActionWallClimb_cpp */ {
    // Members
...
struct xSerial {};
// total size: 0x4
struct /* @class$2223zPlayerActionWallClimb_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2224zPlayerActionWallClimb_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2225zPlayerActionWallClimb_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2222zPlayerActionWallClimb_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2227zPlayerActionWallClimb_cpp */ {
    // Members
...
// Range: 0x80273EB0 -> 0x80273EBC
// this: r0
void zPlayerActionWallClimb::Reset() {}

// Range: 0x80273EBC -> 0x80273F20
// this: r31
void zPlayerActionWallClimb::Begin() {}

// Range: 0x80273F20 -> 0x80273F68
// this: r31
void zPlayerActionWallClimb::End() {}

// Range: 0x80273F68 -> 0x80273F70
// this: r3
unsigned int zPlayerActionWallClimb::StartCheck() {}

// Range: 0x80273F70 -> 0x80273F78
// this: r3
unsigned int zPlayerActionWallClimb::ClimbUpCheck() {}

// Range: 0x80273F78 -> 0x802740C4
// this: r31
void zPlayerActionWallClimb::NotifyCollision(const struct SphereCollisionResults & sceneCollide /* r29 */) {
    // Local variables
...
static struct xVec3 JUMP_VEL; // size: 0xC, address: 0x80C0568C
// total size: 0xC
...
// Range: 0x80274110 -> 0x80274168
// this: r0
void zPlayerActionWallClimbJump::AddStates(struct xAnimTable * table /* r0 */) {}

// Range: 0x80274168 -> 0x802741B0
// this: r30
void zPlayerActionWallClimbJump::AddActionTransitions(struct xAnimTable * table /* r31 */) {}

// Range: 0x802741B0 -> 0x802741FC
void zPlayerActionWallClimbJump::AddTransitionsFrom(struct xAnimTable * table /* r4 */, const char * fromStates /* r5 */, unsigned short priority /* r6 */, float blend /* f0 */, unsigned int flags /* r8 */, unsigned int userFlags /* r9 */) {}

// Range: 0x802741FC -> 0x80274270
// this: r0
...
// Range: 0x80274270 -> 0x8027429C
// this: r3
unsigned int zPlayerActionWallClimbJump::StartCheck() {}

// total size: 0x54
struct {} zPlayerActionWallClimbJump::__vtable; // size: 0x54, address: 0x80443A10
...
// total size: 0x54
struct {} zPlayerActionWallClimb::__vtable; // size: 0x54, address: 0x80443A64
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1484zPlayerActionWallClimb_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
