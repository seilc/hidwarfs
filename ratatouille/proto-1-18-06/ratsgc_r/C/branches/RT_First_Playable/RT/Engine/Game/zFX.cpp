/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80127220 -> 0x8012735C
*/
unsigned int gFXSurfaceFlags; // size: 0x4, address: 0x80C07DE0
// Range: 0x80127220 -> 0x80127244
void zFXModelRender() {}

// Range: 0x80127244 -> 0x80127248
void zFXPostModelRender() {}

// Range: 0x80127248 -> 0x80127268
void zFXScreenRender() {}

// Range: 0x80127268 -> 0x801272B4
void zFXUpdate(float dt /* f31 */) {}
...
// Range: 0x801272B4 -> 0x80127304
void zFX_SceneEnter(struct RpWorld * world /* r31 */) {}

// Range: 0x80127304 -> 0x80127330
void zFX_SceneExit(struct RpWorld * world /* r0 */) {}

// Range: 0x80127330 -> 0x8012735C
void zFX_SceneReset() {}
