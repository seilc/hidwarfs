/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicInstaKill.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802C6D78 -> 0x802C7550
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zCompStateMachineTable gInstaKillStateMachineTable[4]; // size: 0x20, address: 0x80449298
// total size: 0x40
...
// total size: 0x24
class zAnimWTimerState : public zCompState {
    // Members
    unsigned int animStateID; // offset 0x14, size 0x4
    int stateEnumToGo; // offset 0x18, size 0x4
    float stateTime; // offset 0x1C, size 0x4
    float endTime; // offset 0x20, size 0x4
};
// Range: 0x802C6D78 -> 0x802C6DB0
// this: r0
void zCompLogicInstaKill::SetupStateTranstitionTests() {
    // Local variables
    class zAnimWTimerState * AlertState; // r0
}
...
// Range: 0x802C6DB0 -> 0x802C6DB8
int zCompLogicInstaKill::GetInitialStateEnum() {}

// Range: 0x802C6DB8 -> 0x802C6DC4
struct zCompStateMachineTable * zCompLogicInstaKill::GetStateTable() {
    // References
    // -> static struct zCompStateMachineTable gInstaKillStateMachineTable[4];
}

// Range: 0x802C6DC4 -> 0x802C6E0C
// this: r31
...
// total size: 0x4
struct /* @class$1119zCompLogicInstaKill_cpp */ {
    // Members
...
union /* @class$1267zCompLogicInstaKill_cpp */ {
...
// total size: 0xC
struct /* @class$1257zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$987zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zCompLogicInstaKill_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zCompLogicInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zCompLogicInstaKill_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0x30
struct {} zInstaKillPatrolXZ::__vtable; // size: 0x30, address: 0x80449318
// total size: 0x28
...
// total size: 0x18
class zInstaKillPatrolXZ : public zCompState {
    // Functions
    zInstaKillPatrolXZ();

    void Activate(class zNPCBase * owner);
...
// Range: 0x802C6E0C -> 0x802C6E50
// this: r31
zInstaKillPatrolXZ::zInstaKillPatrolXZ() {
    // References
    // -> struct [anonymous] zInstaKillPatrolXZ::__vtable;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C069D8
// Range: 0x802C6E50 -> 0x802C6FA0
struct xMovePoint * zInstaKillPatrolXZ::FindClosestMP(class zNPCBase * owner /* r29 */, unsigned int firstMovePointID /* r5 */) {
    // Local variables
    struct xMovePoint * firstMP; // r31
    class zICompNPCEntity * compNPCEntity; // r0
    const struct xVec3 * npcPos; // r30
    struct xMovePoint * curMP; // r1+0x8
    float curMPDistance2; // f1
    struct xMovePoint * minDistMP; // r29
    float minMPDistance2; // f31
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C069E8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1884zCompLogicInstaKill_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
class zCompSteeringGenericParams sSteeringPatrolParams; // size: 0x3C, address: 0x80BD47F0
// total size: 0x0
class zCompPerceptionParams {};
// total size: 0x68
class zNPCInstaKill : public zNPCBase {
    // Static members
    static class zCompSteeringGenericParams sSteeringChaseParams; // size: 0x3C
    static class zCompSteeringGenericParams sSteeringAlertParams; // size: 0x3C
    static class zCompSteeringGenericParams sSteeringPatrolParams; // size: 0x3C
    static class zCompPerceptionParams sPerceptionParams; // size: 0x0
    static class zICompNPCEntityParams sEntParams; // size: 0x30
};
// total size: 0x78
...
// Range: 0x802C6FA0 -> 0x802C70CC
// this: r30
void zInstaKillPatrolXZ::Activate(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zNPCInstaKill * npcInstaKill; // r31
    struct zNPCAssetInstaKill * npcassInstaKill; // r0
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r31

    // References
    // -> class zCompSteeringGenericParams sSteeringPatrolParams;
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C097E0
static signed char init; // size: 0x1, address: 0x80C097E1
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C069F4
// Range: 0x802C70CC -> 0x802C7290
// this: r28
void zInstaKillPatrolXZ::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x802C7290 -> 0x802C72E4
// this: r31
void zInstaKillPatrolXZ::CheckTranstitions(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompPerception * npcPerc; // r0
}
...
// Range: 0x802C72E4 -> 0x802C732C
// this: r31
void zInstaKillPatrolXZ::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

class zCompSteeringGenericParams sSteeringAlertParams; // size: 0x3C, address: 0x80BD482C
// total size: 0x24
class zInstaKillAlertState : public zAnimWTimerState {
    // Functions
    void Activate(class zNPCBase * owner);
...
// total size: 0x4
struct /* @class$2280zCompLogicInstaKill_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2281zCompLogicInstaKill_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2282zCompLogicInstaKill_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2279zCompLogicInstaKill_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2284zCompLogicInstaKill_cpp */ {
    // Members
...
// Range: 0x802C732C -> 0x802C73B0
// this: r0
void zInstaKillAlertState::Activate(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    ...
    // References
    // -> struct xGlobals * xglobals;
    // -> class zCompSteeringGenericParams sSteeringAlertParams;
}
...
// total size: 0x890
struct /* @class$2131zCompLogicInstaKill_cpp */ {
    // Static members
...
// Range: 0x802C73B0 -> 0x802C742C
// this: r0
void zInstaKillAlertState::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r4
}

class zCompSteeringGenericParams sSteeringChaseParams; // size: 0x3C, address: 0x80BD4868
// total size: 0x14
class zInstaKillChase : public zCompState {};
// Range: 0x802C742C -> 0x802C74D4
void zInstaKillChase::Activate(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r31
    struct zCommonPlayer * player; // r0
    ...
    // References
    // -> struct xGlobals * xglobals;
    // -> class zCompSteeringGenericParams sSteeringChaseParams;
}

// Range: 0x802C74D4 -> 0x802C754C
void zInstaKillChase::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r4
}

// Range: 0x802C754C -> 0x802C7550
void zInstaKillChase::CheckTranstitions() {}

// total size: 0x30
struct {} zInstaKillChase::__vtable; // size: 0x30, address: 0x804492B8
// total size: 0x30
struct {} zInstaKillAlertState::__vtable; // size: 0x30, address: 0x804492E8
// total size: 0x54
struct {} zCompLogicInstaKill::__vtable; // size: 0x54, address: 0x80449348
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
    zHS_EXPLOSION = 2,
