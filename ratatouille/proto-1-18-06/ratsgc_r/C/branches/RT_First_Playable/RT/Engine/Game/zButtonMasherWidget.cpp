/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zButtonMasherWidget.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B6AB8 -> 0x802B73A8
*/
class zButtonMasherMashChecker * * objectArray; // size: 0x4, address: 0x80C09740
int objectCount; // size: 0x4, address: 0x80C09744
// total size: 0x1
...
// Range: 0x802B6AC8 -> 0x802B6B3C
void zButtonMasherController::UpdateAll(float dt /* f31 */) {
    // Local variables
    int i; // r30
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C06598
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x802B6B4C -> 0x802B6C04
void zButtonMasherController::InsertInObjectArray(class zButtonMasherMashChecker * inObj /* r30 */, int idx /* r31 */) {
    // References
    // -> class zButtonMasherMashChecker * * objectArray;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C065AC
// total size: 0x14
struct {} zButtonMasherMashChecker::__vtable; // size: 0x14, address: 0x80C065C4
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$1153zButtonMasherWidget_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1291zButtonMasherWidget_cpp */ {
    // Members
...
union /* @class$1292zButtonMasherWidget_cpp */ {
...
// total size: 0x10
struct /* @class$1512zButtonMasherWidget_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B6C04 -> 0x802B6DA8
// this: r30
zButtonMasherMashChecker::zButtonMasherMashChecker(struct zButtonMasherWidgetAsset * theAsset /* r31 */) {
    // Local variables
...
// total size: 0x890
struct /* @class$1974zButtonMasherWidget_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C065B4
// Range: 0x802B6DA8 -> 0x802B6F3C
void zButtonMasherMashChecker::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x802B6F3C -> 0x802B6FCC
// this: r31
void zButtonMasherMashChecker::EventCB(unsigned int toEvent /* r0 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C065BC
// Range: 0x802B6FCC -> 0x802B70BC
void zButtonMasherMashChecker::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
// Range: 0x802B70BC -> 0x802B70C4
// this: r3
unsigned char zButtonMasherMashChecker::CycleDone() {}

// Range: 0x802B70C4 -> 0x802B7398
// this: r31
void zButtonMasherMashChecker::Update(float dt /* f0 */) {
    // Local variables
    float retRate; // f31
}

// Range: 0x802B7398 -> 0x802B73A8
// this: r0
