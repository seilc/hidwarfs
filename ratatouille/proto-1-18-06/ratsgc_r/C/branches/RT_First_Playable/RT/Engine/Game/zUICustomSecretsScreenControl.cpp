/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomSecretsScreenControl.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022A4D0 -> 0x8022ACF8
*/
// total size: 0x54
struct {} zUICustomSecretsScreenControl::__vtable; // size: 0x54, address: 0x8043FD28
// total size: 0x10
...
// Range: 0x8022A514 -> 0x8022A518
void zUICustomSecretsScreenControl::Init() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C045F0
// Range: 0x8022A518 -> 0x8022A5FC
// this: r31
...
// Range: 0x8022AA28 -> 0x8022AA3C
// this: r0
void zUICustomSecretsScreenControl::Reset() {}

// Range: 0x8022AA3C -> 0x8022AB20
// this: r0
...
// Range: 0x8022AB20 -> 0x8022ACF8
// this: r0
void zUICustomSecretsScreenControl::changeFocusY(int dir /* r0 */) {
    // Local variables
    int rows[6]; // r1+0x8
    unsigned char isSpecialCase; // r10
    int oldRow; // r11
    int oldCol; // r12
    signed char i; // r6
}
