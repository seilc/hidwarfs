/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zContextObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80261E48 -> 0x80262F7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float ROTATION_SPEED; // size: 0x4, address: 0x80C05318
static float MOUNT_SPEED_MIN; // size: 0x4, address: 0x80C0531C
// total size: 0x24
struct config {
    // Members
...
static struct config glint_config; // size: 0x24, address: 0x80BCB9F8
static float * glintEmit[5]; // size: 0x14, address: 0x80C092E0
static int contextObjCount[5]; // size: 0x14, address: 0x80C092F4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1097zContextObject_cpp */ {
    // Members
...
union /* @class$1236zContextObject_cpp */ {
...
// total size: 0xC
struct /* @class$1235zContextObject_cpp */ {
    // Members
...
static struct xEnt * entFXList[16]; // size: 0x40, address: 0x80BCBA1C
static float GLINT_RANDOM_RADIUS; // size: 0x4, address: 0x80C05320
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$1038zContextObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zContextObject_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zContextObject_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zContextObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zContextObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zContextObject_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2223zContextObject_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2222zContextObject_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2225zContextObject_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1713zContextObject_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
struct config default_config; // size: 0x24, address: 0x80BC3D98
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// total size: 0x4
struct /* @class$1633zContextObject_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1634zContextObject_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C05324
char __FUNCTION__$localstatic1$set__12bit_array<3>Fib[4]; // size: 0x4, address: 0x80C05338
...
// total size: 0x890
struct /* @class$1987zContextObject_cpp */ {
    // Static members
...
// Range: 0x802626AC -> 0x80262804
void zContextObjectManager::EmitSparks(float & emitCount /* r26 */, struct xVec3 & refPos /* r27 */, struct xModelInstance * model /* r28 */, float randR /* f28 */, float dt /* f29 */) {
    // Local variables
    struct RpGeometry * geom; // r30
    struct xVec3 * verts; // r29
...
// Range: 0x80262804 -> 0x80262B40
// this: r30
void zContextObjectManager::UpdateProximityFX(struct zPlayer * player /* r31 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 playerPos; // r1+0x30
    int count; // r25
    int i; // r24
    const class xNurbs * curve; // r23
...
char __FUNCTION__$localstatic1$get__12bit_array<3>Fi[4]; // size: 0x4, address: 0x80C0533C
// Range: 0x80262B40 -> 0x80262D10
// this: r30
...
// Range: 0x80262DF0 -> 0x80262E74
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r25 */, union MountData & mountData /* r26 */, float & priority /* r27 */) {
    // Local variables
