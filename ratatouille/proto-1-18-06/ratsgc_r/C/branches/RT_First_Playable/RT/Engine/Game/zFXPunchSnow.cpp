/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFXPunchSnow.cpp
...
struct config {
    ...
    unsigned char cinematic_only; // offset 0x27, size 0x1
    ...
    float vel_right; // offset 0x38, size 0x4
    float vel_up; // offset 0x3C, size 0x4
    float vel_at; // offset 0x40, size 0x4
    float nrm_right; // offset 0x44, size 0x4
    float nrm_up; // offset 0x48, size 0x4
    float nrm_at; // offset 0x4C, size 0x4
    float cone_rnd; // offset 0x50, size 0x4
    float cone_vel; // offset 0x54, size 0x4
};
// total size: 0x1
class punch_snow {
    // Static members
...
// total size: 0xC
struct /* @class$964zFXPunchSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zFXPunchSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zFXPunchSnow_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zFXPunchSnow_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zFXPunchSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zFXPunchSnow_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zFXPunchSnow_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1350zFXPunchSnow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1488zFXPunchSnow_cpp */ {
    // Members
...
union /* @class$1015zFXPunchSnow_cpp */ {
...
// total size: 0x10
struct /* @class$1028zFXPunchSnow_cpp */ {
    // Members
