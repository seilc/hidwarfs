/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xCam.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8000F068 -> 0x80012128
*/
char __FUNCTION__$localstatic1$normalize_analog__Fiiiiii[17]; // size: 0x11, address: 0x80BFB7B8
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR5xVec3[8]; // size: 0x8, address: 0x80BFB7CC
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR17xCamCoordCylinder[8]; // size: 0x8, address: 0x80BFB7D4
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR15xCamCoordSphere[8]; // size: 0x8, address: 0x80BFB7DC
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR5xQuat[8]; // size: 0x8, address: 0x80BFB7E4
char __FUNCTION__$localstatic1$convert__9xCamBlendCFRC4xCamR15xCamOrientEuler[8]; // size: 0x8, address: 0x80BFB7EC
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR5xVec3[13]; // size: 0xD, address: 0x80BFB7F4
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR17xCamCoordCylinder[13]; // size: 0xD, address: 0x80BFB804
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR15xCamCoordSphere[13]; // size: 0xD, address: 0x80BFB814
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR5xQuat[13]; // size: 0xD, address: 0x80BFB824
char __FUNCTION__$localstatic1$coll_convert__9xCamBlendCFRC4xCamR15xCamOrientEuler[13]; // size: 0xD, address: 0x80BFB834
char __FUNCTION__$localstatic1$xEntGetPos__FPC4xEnt[11]; // size: 0xB, address: 0x80BFB844
char __FUNCTION__$localstatic1$xEntGetFacingDirection__FPC4xEnt[23]; // size: 0x17, address: 0x80BFB850
char __FUNCTION__$localstatic1$xEntGetUpDirection__FPC4xEnt[19]; // size: 0x13, address: 0x80BFB868
char __FUNCTION__$localstatic1$xEntGetFrame__FPC4xEnt[13]; // size: 0xD, address: 0x80BFB87C
char __FUNCTION__$localstatic1$xEntGetAnimFlags__FPC4xEnt[17]; // size: 0x11, address: 0x80BFB88C
char __FUNCTION__$localstatic1$PushBack__16zPlayerContainerFP7zPlayer[9]; // size: 0x9, address: 0x80BFB8A0
char __FUNCTION__$localstatic1$__vc__16zPlayerContainerFi[5]; // size: 0x5, address: 0x80BFB8AC
char xSTAssetNameOrID(unsigned int)::buffer[16]; // size: 0x10, address: 0x80C06E40
char xSTAssetNameOrID(void*)::buffer[16]; // size: 0x10, address: 0x80C06E50
char __FUNCTION__$localstatic1$unlink__14pool_list_baseFPQ214pool_list_base9node_base[7]; // size: 0x7, address: 0x80BFB8B4
char __FUNCTION__$localstatic1$free__14pool_list_baseFPQ214pool_list_base9node_base[5]; // size: 0x5, address: 0x80BFB8BC
char __FUNCTION__$localstatic1$alloc__14pool_list_baseFv[6]; // size: 0x6, address: 0x80BFB8C4
char __FUNCTION__$localstatic1$alloc_block_data__20tier_queue_allocatorCFUi[17]; // size: 0x11, address: 0x80BFB8CC
char __FUNCTION__$localstatic1$get_block__20tier_queue_allocatorCFUl[10]; // size: 0xA, address: 0x80BFB8E0
char __FUNCTION__$localstatic1$free_block__20tier_queue_allocatorFUc[11]; // size: 0xB, address: 0x80BFB8EC
char __FUNCTION__$localstatic1$alloc_block__20tier_queue_allocatorFUi[12]; // size: 0xC, address: 0x80BFB8F8
char __FUNCTION__$localstatic1$clear__20tier_queue_allocatorFv[6]; // size: 0x6, address: 0x80BFB904
char __FUNCTION__$localstatic1$full__20tier_queue_allocatorCFv[5]; // size: 0x5, address: 0x80BFB90C
char __FUNCTION__$localstatic1$init__20tier_queue_allocatorFUlUlUlUi[5]; // size: 0x5, address: 0x80BFB914
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gxCamShowDebugMessages; // size: 0x1, address: 0x80C06E60
static int blendDepth; // size: 0x4, address: 0x80C06E64
static int super_sample_updates; // size: 0x4, address: 0x80C06E68
// Range: 0x8000F068 -> 0x8000F0B0
static void add_tweaks(const char * prefix /* r0 */) {
    // References
...
// Range: 0x8000F0B0 -> 0x8000F0C0
// this: r0
void xCam::start() {}

// Range: 0x8000F0C0 -> 0x8000F0D0
// this: r0
void xCam::stop() {}

// Range: 0x8000F0D0 -> 0x8000F0FC
void xCam::scene_enter() {}

// Range: 0x8000F0FC -> 0x8000F128
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFB91C
// Range: 0x8000F128 -> 0x8000F28C
// this: r29
...
// Range: 0x8000F28C -> 0x8000F2F8
// this: r31
void xCam::refresh_mat() {}

// Range: 0x8000F41C -> 0x8000F454
// this: r0
void xCam::create() {}

// Range: 0x8000F454 -> 0x8000F460
// this: r0
unsigned char xCam::active() {}

static struct xColor_tag colors[22]; // size: 0x58, address: 0x80414190
static signed char init; // size: 0x1, address: 0x80C06E6C
static int last_color; // size: 0x4, address: 0x80C06E70
static signed char init; // size: 0x1, address: 0x80C06E74
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// total size: 0x1
struct /* @class$967xCam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968xCam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969xCam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970xCam_cpp */ {
    // Members
...
// Range: 0x8000F760 -> 0x8000FC10
// this: r30
void xCam::add_tweaks_common(const char * prefix /* r31 */) {
    // Local variables
...
// Range: 0x8000FFE4 -> 0x80010170
// this: r30
void xCamGroup::update(struct xScene & scene /* r31 */, float dt /* f31 */) {
    // Local variables
    struct xVec3 prev_pos; // r1+0x8
    float len; // f0
    float len2; // f1
    float len_inv; // f1
...
// Range: 0x80010170 -> 0x80010238
// this: r27
void xCamGroup::transition_to(struct xCam & cam /* r28 */, const struct xCamTransitionParams * params /* r29 */, unsigned char force_cut /* r30 */, unsigned char force_restart /* r31 */) {
    // Local variables
    struct xCam * next; // r4
}

// Range: 0x80010238 -> 0x800102A4
// this: r29
void xCamGroup::add(struct xCam & cam /* r30 */, unsigned char force_cut /* r31 */) {}

// Range: 0x800102A4 -> 0x80010328
// this: r30
...
// Range: 0x80010328 -> 0x80010358
// this: r0
struct xCamBlend * xCamGroup::grab_blend_cam() {
    // Local variables
    struct xCamBlend * * it; // r4
    struct xCamBlend * * end; // r5
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFB928
// Range: 0x80010358 -> 0x80010578
// this: r31
void xCamGroup::set_primary(struct xCam * toCamera /* r30 */, unsigned char force_restart /* r0 */) {
    // Local variables
    float len; // f0
    float len2; // f1
    float len_inv; // f1
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFB934
// Range: 0x80010578 -> 0x800107D0
// this: r30
struct xCam * xCamGroup::get_blend(class xCamTransition * transition /* r28 */, struct xCam & to /* r31 */) {
    // Local variables
    float blend_time; // f31
    struct xCamBlend * parent; // r29
    struct xCam * pTo; // r3
    struct xCamBlend * blend; // r29

    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x800107D0 -> 0x800107E8
void xCamGroup::notify_released(struct xCam & cam /* r0 */) {}

// Range: 0x800107E8 -> 0x80010800
// this: r0
void xCamGroup::set_child_flags(int add /* r0 */, int remove /* r0 */) {}

// Range: 0x80010800 -> 0x800108A0
static void do_transient_replacement(struct xCam * & curCam /* r30 */) {
    // Local variables
    struct xCam * next; // r0
}

// Range: 0x800108A0 -> 0x80010928
// this: r3
void xCamGroup::debug_render(unsigned char force /* r0 */, unsigned char sparse /* r0 */) {}

// Range: 0x80010928 -> 0x800109AC
struct xCamBlend * xCamGroup::create_blend() {}

// total size: 0x20
struct {} xCamBias::__vtable; // size: 0x20, address: 0x804142A0
// total size: 0x8
class xCamBias {
    // Members
public:
...
// Range: 0x80010A2C -> 0x80010AC0
// this: r0
void xCamGroup::PrintCamMsg(const char * msg /* r30 */, unsigned int ownerID /* r31 */) const {
    // References
    // -> struct zGlobals globals;
    // -> unsigned char gxCamShowDebugMessages;
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFB940
...
// Range: 0x80010AC0 -> 0x80010B54
// this: r31
void xCamScreen::create(int w /* r4 */, int h /* r0 */) {
    // References
    // -> static char __FUNCTION__[7];
}

// Range: 0x80010B54 -> 0x80010B78
// this: r3
void xCamScreen::destroy() {}

// Range: 0x80010B78 -> 0x80010BA4
// this: r3
void xCamScreen::set_scene(struct xScene & scene /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFB948
// Range: 0x80010BA4 -> 0x80010C28
// this: r31
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFB958
// Range: 0x80010C28 -> 0x80010CCC
// this: r30
void xCamScreen::begin_render(unsigned char clear /* r31 */) {
    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x80010CCC -> 0x80010CF0
// this: r3
void xCamScreen::end_render() {}

// Range: 0x80010CF0 -> 0x80010D14
// this: r3
void xCamScreen::set_world_matrix(const struct xMat4x3 & mat /* r0 */) {}

// Range: 0x80010D14 -> 0x80010D44
// this: r3
void xCamScreen::get_world_matrix(struct xMat4x3 & mat /* r4 */) {}

// Range: 0x80010D44 -> 0x80010D74
// this: r3
void xCamScreen::set_fov(float fov /* f1 */) {}

// Range: 0x80010D74 -> 0x80010DE4
// this: r3
float xCamScreen::world_to_screen(struct xVec3 & screen_loc /* r31 */, const struct xVec3 & world_loc /* r0 */) const {
    // Local variables
    struct xVec3 view_loc; // r1+0x8
    float rz; // f31
}
...
// Range: 0x80010DE4 -> 0x80010DEC
// this: r0
void xCamTimeBias::Init(float blendTime /* f0 */) {}

// Range: 0x80010DEC -> 0x80010DFC
// this: r0
void xCamTimeBias::Start() {}

// Range: 0x80010DFC -> 0x80010E28
// this: r0
void xCamTimeBias::Update(float dt /* f0 */) {}

// Range: 0x80010E28 -> 0x80010E6C
// this: r3
void xCamTimeBias::Reverse() {}

// Range: 0x80010E6C -> 0x80010E74
// this: r0
float xCamTimeBias::GetBias() {}

// Range: 0x80010E74 -> 0x80010E8C
// this: r0
unsigned char xCamTimeBias::IsActive() {}

// Range: 0x80010E8C -> 0x80010EA8
// this: r0
unsigned char xCamTimeBias::DidComplete() {}

// Range: 0x80010EA8 -> 0x80010EF4
// this: r31
...
// Range: 0x80010EF4 -> 0x80010F54
class xCamBias * xCamBias::GetBiasObject(class xCamTransition * transition /* r30 */, class xCamTimeBias & timeBias /* r31 */) {}
...
// Range: 0x80010F54 -> 0x80010F98
// this: r31
void xCamBlend::create() {}

// Range: 0x80010F98 -> 0x80010F9C
void xCamBlend::destroy() {}

static enum xCamCoordType coord_table[3][3]; // size: 0x24, address: 0x803A6528
static enum xCamOrientType orient_table[2][2]; // size: 0x10, address: 0x80C0A100
static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFB968
// Range: 0x80010F9C -> 0x8001137C
// this: r31
...
// Range: 0x800114AC -> 0x8001150C
// this: r30
void xCamBlend::pre_update(struct xScene & scene /* r31 */) {}
...
// Range: 0x8001150C -> 0x8001156C
// this: r30
void xCamBlend::post_update(struct xScene & scene /* r31 */) {}

// Range: 0x8001156C -> 0x80011694
// this: r30
void xCamBlend::update(struct xScene & scene /* r31 */, float dt /* f30 */) {
    // Local variables
    float s; // f31
}

// Range: 0x80011694 -> 0x8001170C
// this: r31
struct xCam * xCamBlend::get_next() {}

// Range: 0x8001170C -> 0x800117A0
// this: r31
...
// Range: 0x800117A0 -> 0x8001180C
// this: r30
struct xCam * xCamBlend::find_camera(unsigned int ownerID /* r31 */) {
    // Local variables
    struct xCam * found; // r3
}

// Range: 0x8001180C -> 0x80011840
// this: r0
void xCamBlend::attach(struct xCam & src /* r0 */, struct xCam & dst /* r0 */) {}

// Range: 0x80011840 -> 0x80011880
// this: r3
...
// Range: 0x80011B64 -> 0x80011BE0
// this: r31
void xCamBlend::debug_render() {}

// Range: 0x80011BE0 -> 0x80011C00
// this: r0
void xCamBlend::add_tweaks(const char * prefix /* r0 */) {}
...
// Range: 0x80011C00 -> 0x80011C3C
// this: r31
void xCamDebug::create() {}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80BFB970
// Range: 0x80011C3C -> 0x80011CEC
// this: r31
...
// Range: 0x80011CEC -> 0x80011EA4
// this: r31
void xCamDebug::update(float dt /* f30 */) {
    // Local variables
    float turn_mult; // f29
    float move_mult; // f31
    float dyaw; // f1
...
// Range: 0x80011EA4 -> 0x80011F90
// this: r31
void xCamDebug::refresh_input() {}

// Range: 0x80011F90 -> 0x80011FB0
// this: r0
void xCamDebug::debug_render() {}

// Range: 0x80011FB0 -> 0x80012128
// this: r30
...
// total size: 0x4C
struct {} xCamDebug::__vtable; // size: 0x4C, address: 0x804141E8
// total size: 0x0
class zCamSplineCommonMix {};
// total size: 0x4C
struct {} xCamBlend::__vtable; // size: 0x4C, address: 0x80414234
// total size: 0x0
class zCam2Player {};
// total size: 0x20
struct {} xCamTimeBias::__vtable; // size: 0x20, address: 0x80414280
// total size: 0x4C
struct {} xCam::__vtable; // size: 0x4C, address: 0x804142C0
