/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCContextSensitive.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B2888 -> 0x802B29DC
*/
char __FUNCTION__$localstatic1$AttachComponent__68zComponentPool<26zCompLogicContextSensitive,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06510
signed char zComponentPool<zCompLogicContextSensitive, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09708
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicContextSensitive, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0970C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x802B2920 -> 0x802B299C
// this: r30
void zNPCContextSensitive::Update(struct xScene * xscn /* r31 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1148zNPCContextSensitive_cpp */ {
    // Members
...
union /* @class$1288zNPCContextSensitive_cpp */ {
...
// total size: 0xC
struct /* @class$1286zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1089zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1090zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1091zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1092zNPCContextSensitive_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1093zNPCContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1094zNPCContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1095zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCContextSensitive::__vtable; // size: 0x30, address: 0x80448410
