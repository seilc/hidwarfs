/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zBomb.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801AC008 -> 0x801AC528
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801AC008 -> 0x801AC0B4
static struct xVec3 getKnockback(const struct xBound * explosion /* r6 */, const struct xVec3 & target /* r5 */, float away_speed /* f30 */, float up_speed /* f31 */) {
    // Local variables
...
// Range: 0x801AC0B4 -> 0x801AC2F4
void bound_damage(struct xBound & bound /* r22 */, struct xEnt * fromEnt /* r23 */, int player_damage /* r24 */, int obj_damage /* r27 */, int npc_damage /* r21 */, float awayKnockback /* f30 */, float upKnockback /* f31 */, enum zHitSource hitSource /* r25 */, enum zHitTarget hitTarget /* r26 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$2421zBomb_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2422zBomb_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$1041zBomb_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zBomb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zBomb_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zBomb_cpp */ {
    // Members
...
// Range: 0x801AC2F4 -> 0x801AC38C
static unsigned char boundHitsBound(const struct xBound & bound1 /* r29 */, const struct xBound & bound2 /* r30 */, struct xVec3 & hitPos /* r31 */) {
    // Local variables
    struct xCollis coll; // r1+0x8
}

// Range: 0x801AC38C -> 0x801AC3AC
// this: r0
static damage_callback::damage_callback(struct xEnt * from /* r0 */, struct xBound * bound /* r0 */, int damage /* r0 */, float away_speed /* f0 */, float up_speed /* f0 */, enum zHitSource hit_source /* r0 */, enum zHitTarget hit_target /* r0 */) {}
...
// Range: 0x801AC3AC -> 0x801AC448
void sphere_damage(struct xEnt * fromEnt /* r26 */, const struct xVec3 & epicenter /* r0 */, float blastRadius /* f29 */, int player_damage /* r27 */, int obj_damage /* r28 */, int npc_damage /* r29 */, float awayKnockback /* f30 */, float upKnockback /* f31 */, enum zHitSource hitSource /* r30 */, enum zHitTarget hitTarget /* r31 */) {
    // Local variables
...
// Range: 0x801AC448 -> 0x801AC528
// this: r30
static unsigned char damage_callback::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
    struct xVec3 hit_pos; // r1+0x28
    struct xVec3 hit; // r1+0x1C
