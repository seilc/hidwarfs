/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicContextSensitive.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B2BD4 -> 0x802B3A20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringBasicParams gConSenPatrolSteeringParams; // size: 0x70, address: 0x80BD2B58
static class zCompSteeringBasicParams gConSenChaseSteeringParams; // size: 0x70, address: 0x80BD2BC8
// total size: 0x8
...
static struct zCompStateMachineTable gContextSensitiveStateMachineTable[10]; // size: 0x50, address: 0x80448440
// total size: 0x40
...
// Range: 0x802B2BD4 -> 0x802B2BDC
unsigned char zCompLogicContextSensitive::SystemEvent() {}

// Range: 0x802B2BDC -> 0x802B2EAC
...
// Range: 0x802B2EAC -> 0x802B305C
// this: r31
void zCompLogicContextSensitive::SetupStateTranstitionTests() {
    // Local variables
    class zAnimWTimerState * TauntState; // r0
    class zAnimWTimerState * VulnerableState; // r0
    class zAnimPlayState * AttackDoneState; // r0
    class zAnimPlayState * PlayerGoesOnTop; // r0
    class zAnimPlayState * PlayerHit; // r0
    class zAnimPlayState * NPCMiss; // r0
}
...
// Range: 0x802B305C -> 0x802B3064
int zCompLogicContextSensitive::GetInitialStateEnum() {}

// Range: 0x802B3064 -> 0x802B3070
...
// Range: 0x802B3070 -> 0x802B3090
// this: r0
void zCompLogicContextSensitive::Attached() {}

// Range: 0x802B3090 -> 0x802B30D8
// this: r31
...
// total size: 0x4
struct /* @class$1164zCompLogicContextSensitive_cpp */ {
    // Members
...
union /* @class$1304zCompLogicContextSensitive_cpp */ {
...
// total size: 0xC
struct /* @class$1302zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1074zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1075zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1076zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1077zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1078zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1079zCompLogicContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1080zCompLogicContextSensitive_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1885zCompLogicContextSensitive_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802B30D8 -> 0x802B3134
unsigned char zCompLogicContextSensitive::GoToChase(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zCompLogicContextSensitive * logicComp; // r0
    struct xVec3 * playerPos; // r3
...
// total size: 0x890
struct /* @class$2132zCompLogicContextSensitive_cpp */ {
    // Static members
...
// Range: 0x802B3134 -> 0x802B3190
unsigned char zCompLogicContextSensitive::BackToPatrol(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zCompLogicContextSensitive * logicComp; // r0
    struct xVec3 * playerPos; // r3
...
// Range: 0x802B3190 -> 0x802B320C
unsigned char zCompLogicContextSensitive::IsInAttackDistance(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r31
    const struct xVec3 * NPCPos; // r0
...
// Range: 0x802B320C -> 0x802B3220
unsigned char zCompLogicContextSensitive::ButtonPressed() {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x802B3220 -> 0x802B3290
unsigned char zCompLogicContextSensitive::ButtonPressLast(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
...
// Range: 0x802B3290 -> 0x802B3314
unsigned char zCompLogicContextSensitive::GroundAttackMissed(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r31
...
// Range: 0x802B3314 -> 0x802B3390
unsigned char zCompLogicContextSensitive::GroundAttackHit(class zNPCBase * owner /* r0 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r31
    struct xVec3 * playerPos; // r31
...
// total size: 0x30
struct {} zConSenPatrol::__vtable; // size: 0x30, address: 0x804484F0
// total size: 0x28
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C09718
static signed char init; // size: 0x1, address: 0x80C09719
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06520
// Range: 0x802B3418 -> 0x802B35C4
// this: r28
void zConSenPatrol::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C06528
// total size: 0x68
...
// Range: 0x802B35C4 -> 0x802B3690
// this: r30
void zConSenPatrol::Enter(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zNPCContextSensitive * npcConSen; // r31
    struct zNPCAssetContextSensitive * npcassConSen; // r0
...
// Range: 0x802B3690 -> 0x802B3738
// this: r30
void zConSenPatrol::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// Range: 0x802B3738 -> 0x802B3780
// this: r31
void zConSenPatrol::DebugRender(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}

// total size: 0x30
struct {} zConSenChase::__vtable; // size: 0x30, address: 0x804484C0
// total size: 0x14
class zConSenChase : public zCompState {
    // Functions
    zConSenChase();
};
// Range: 0x802B3780 -> 0x802B3800
// this: r31
...
// Range: 0x802B3800 -> 0x802B3878
void zConSenChase::Update(class zNPCBase * owner /* r31 */, float dt /* f31 */) {
    // Local variables
    class zICompSteering * compSteering; // r31
    class zICompNPCEntity * compNPCEntity; // r4
}

// Range: 0x802B3878 -> 0x802B3918
void zConSenChase::Resume(class zNPCBase * owner /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
    class zICompSteering * compSteering; // r31
...
// Range: 0x802B3918 -> 0x802B395C
void zConSenAttack1::Resume(class zNPCBase * owner /* r4 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}
...
// total size: 0x30
struct {} zConSenAttack1::__vtable; // size: 0x30, address: 0x80448490
// total size: 0x14
class zCompState {
    // Members
    int stateEnum; // offset 0x0, size 0x4
