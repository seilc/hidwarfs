/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zContextObjectTightrope.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802631C0 -> 0x80263D00
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float MAGNETIZE_DIST; // size: 0x4, address: 0x80C05340
static float LOOK_AHEAD_TIME; // size: 0x4, address: 0x80C05344
static unsigned int LOOK_AHEAD_POINTS; // size: 0x4, address: 0x80C05348
static float PREDICT_DIST; // size: 0x4, address: 0x80C0534C
static float PREDICT_Y_SNAP; // size: 0x4, address: 0x80C05350
static float START_CHECK_TIME; // size: 0x4, address: 0x80C05354
static unsigned char drawDebugChecks; // size: 0x1, address: 0x80C09308
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05358
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05360
// total size: 0x14
struct {} zContextObjectTightrope::__vtable; // size: 0x14, address: 0x80C05384
// total size: 0x10
struct xVec4 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8026343C -> 0x802635AC
// this: r29
zContextObjectTightrope::zContextObjectTightrope(struct zContextObjectTightropeAsset * theAsset /* r30 */) {
    // References
    // -> static float MAGNETIZE_DIST;
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05368
// Range: 0x802635B8 -> 0x8026374C
void zContextObjectTightrope::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C05370
// Range: 0x8026374C -> 0x802637EC
// this: r31
...
// Range: 0x802637EC -> 0x80263830
// this: r3
unsigned char zContextObjectTightrope::Advance(float dist /* f1 */, float & u /* r6 */, unsigned char forward /* r5 */) const {}

static struct xColor_tag colors[10]; // size: 0x28, address: 0x80443390
static signed char init; // size: 0x1, address: 0x80C09309
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C05378
...
// Range: 0x80263830 -> 0x80263C84
// this: r25
unsigned char zContextObjectTightrope::CanMount(struct zCommonPlayer * player /* r26 */, union MountData & mountData /* r27 */, float & priority /* r28 */) const {
    // Local variables
    const struct xVec3 & dpos; // r24
    const struct xVec3 & pos; // r29
    struct xIsect intersectData; // r1+0x44
    float dposLength2; // f0
    float curvePosU; // r1+0x10
    struct xVec3 curvePos; // r1+0x38
    float magnetizeDistSqr; // f29
    float currDistance2; // f0
    float currPriority; // f0
    float xzVel; // f0
    unsigned char validEstimate; // r30
    float timeAbove; // f31
    float timeBelow; // f30
    float checkTime; // f29
    unsigned int i; // r29
    struct xVec3 predictPos; // r1+0x2C
    float currDistance2; // f0
...
// total size: 0x4
struct /* @class$1088zContextObjectTightrope_cpp */ {
    // Members
...
union /* @class$1227zContextObjectTightrope_cpp */ {
...
// total size: 0xC
struct /* @class$1226zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2018zContextObjectTightrope_cpp */ {
    // Static members
...
// total size: 0x54
struct /* @class$2263zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1029zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zContextObjectTightrope_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zContextObjectTightrope_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zContextObjectTightrope_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1712zContextObjectTightrope_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1713zContextObjectTightrope_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2227zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2226zContextObjectTightrope_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2229zContextObjectTightrope_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1763zContextObjectTightrope_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80263C84 -> 0x80263CC8
// this: r3
unsigned char zContextObjectTightrope::Mount(struct zCommonPlayer * player /* r31 */, union MountData & mountData /* r0 */) {
    // Local variables
    struct xVec3 pos; // r1+0x8
}

// Range: 0x80263CC8 -> 0x80263CEC
// this: r0
unsigned char zContextObjectTightrope::ClearChkby() const {
    // Local variables
    unsigned char prevVal; // r3
}

// Range: 0x80263CEC -> 0x80263D00
// this: r0
void zContextObjectTightrope::RestoreChkby(unsigned char prevValue /* r0 */) const {}
...
// total size: 0x14
struct {} zContextObject::__vtable; // size: 0x14, address: 0x80C05398
