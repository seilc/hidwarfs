/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomStatsScreen.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802226E4 -> 0x80223528
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cheapCreditsCheat; // size: 0x4, address: 0x80C08F68
static enum en_zStatistics PlayerStats[8]; // size: 0x20, address: 0x803F7030
// total size: 0x54
struct {} zUICustomStatsScreen::__vtable; // size: 0x54, address: 0x8043F8E8
enum xSndHandle {
};
// total size: 0x114
...
// Range: 0x802226E4 -> 0x80222728
// this: r31
zUICustomStatsScreen::zUICustomStatsScreen(class zUI * ui /* r0 */) {
    // References
...
// Range: 0x80222728 -> 0x8022276C
// this: r31
void zUICustomStatsScreen::Init() {}

// Range: 0x8022276C -> 0x80222878
// this: r28
...
// Range: 0x80222878 -> 0x802228BC
// this: r31
void zUICustomStatsScreen::Reset() {}

// Range: 0x802228BC -> 0x802228F0
// this: r31
void zUICustomStatsScreen::Exit() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C043D0
// Range: 0x802228F0 -> 0x80222B78
// this: r30
void zUICustomStatsScreen::PreUpdate(float dt /* f31 */) {
    // Local variables
    int CurLine; // r31
    float fraction; // f31
    unsigned char MRICounting; // r0
    unsigned char FROCounting; // r0
    class zUIText * acceptText; // r28
...
// Range: 0x80222B78 -> 0x80222C64
void zUICustomStatsScreen::FormatTextLines(class zUIText * * lines /* r4 */, int playerIndex /* r0 */, int curLine /* r28 */) {
    // Local variables
    char temp[128]; // r1+0x8
    int i; // r29
    const char * line; // r4
...
// total size: 0x2
struct /* @class$1771zUICustomStatsScreen_cpp */ {
    // Members
...
// this: r24
void zUICustomStatsScreen::FormatPrevNumberLines(class zUIText * * lines /* r4 */, char (* buffers)[10] /* r5 */, int playerIndex /* r25 */, int curLine /* r26 */) {
    // Local variables
    int i; // r27
    int stat; // r5
...
// Range: 0x80222D18 -> 0x80222E68
// this: r0
unsigned char zUICustomStatsScreen::FormatLastNumberLine(class zUIText * * lines /* r27 */, char (* buffers)[10] /* r28 */, int playerIndex /* r6 */, int curLine /* r31 */, float fraction /* f31 */) {
    // Local variables
    int realStat; // r3
    int dispStat; // r5
    unsigned char stillCounting; // r29

    // References
    // -> static enum en_zStatistics PlayerStats[8];
}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C043DC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1085zUICustomStatsScreen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zUICustomStatsScreen_cpp */ {
    // Members
...
union /* @class$820zUICustomStatsScreen_cpp */ {
...
// total size: 0x10
struct /* @class$1831zUICustomStatsScreen_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80222E68 -> 0x80222FB0
int zUICustomStatsScreen::GetStat(enum en_zStatistics statIndex /* r0 */, int playerIndex /* r5 */) {
    // References
...
// total size: 0x890
struct /* @class$2078zUICustomStatsScreen_cpp */ {
    // Static members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C043E4
// Range: 0x80222FB0 -> 0x802230E0
// this: r26
unsigned char zUICustomStatsScreen::HandleEvent(struct xBase * from /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r31 */) {
    // Local variables
    class zUIText * acceptText; // r25

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x802230E0 -> 0x802230E4
void zUICustomStatsScreen::AllocateBuffers() {}

// Range: 0x802230E4 -> 0x802230E8
void zUICustomStatsScreen::DeAllocateBuffers() {}

class zUICustomParrBestScreen * pUICustomParrBestScreen; // size: 0x4, address: 0x80C08F6C
// total size: 0x54
struct {} zUICustomParrBestScreen::__vtable; // size: 0x54, address: 0x8043F894
// total size: 0xB0
...
// Range: 0x802230E8 -> 0x80223124
// this: r31
zUICustomParrBestScreen::zUICustomParrBestScreen(class zUI * ui /* r0 */) {
    // References
    // -> struct [anonymous] zUICustomParrBestScreen::__vtable;
}

// Range: 0x80223124 -> 0x80223160
// this: r31
void zUICustomParrBestScreen::Init() {}

// Range: 0x80223160 -> 0x80223194
// this: r31
void zUICustomParrBestScreen::Exit() {}

// Range: 0x80223194 -> 0x802232BC
// this: r28
...
// Range: 0x802232BC -> 0x802232F8
// this: r31
void zUICustomParrBestScreen::Reset() {}

// Range: 0x802232F8 -> 0x80223318
// this: r0
void zUICustomParrBestScreen::PreUpdate(float dt /* f0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C043F0
// total size: 0x1C
...
// Range: 0x80223318 -> 0x802234E8
// this: r26
unsigned char zUICustomParrBestScreen::HandleEvent(struct xBase * from /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r31 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
    class zUIController * ref; // r31
    unsigned char cheapCredits; // r30
...
// Range: 0x802234E8 -> 0x80223510
// this: r0
unsigned char zUICustomParrBestScreen::IsSignalAllowed(unsigned int toEvent /* r0 */) {}

// Range: 0x80223510 -> 0x80223514
void zUICustomParrBestScreen::SetCompletedGoalsFlags() {}

// Range: 0x80223514 -> 0x80223520
// this: r0
void zUICustomParrBestScreen::SetupText() {}

// Range: 0x80223520 -> 0x80223524
void zUICustomParrBestScreen::AllocateBuffers() {}

// Range: 0x80223524 -> 0x80223528
