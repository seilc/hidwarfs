/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMission.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802956CC -> 0x80296BD4
*/
static unsigned char sDebugOutput; // size: 0x1, address: 0x80C05E00
static unsigned char sConditionMadeChange; // size: 0x1, address: 0x80C09500
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x802956CC -> 0x802956F8
static void TaskEventWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E04
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
// total size: 0x1
struct /* @class$1064zMission_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1065zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1066zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1067zMission_cpp */ {
    // Members
...
// Range: 0x802956F8 -> 0x802958BC
void zTask::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zTask * newTask; // r0

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x802958BC -> 0x802958C0
void zTask::Reset() {}

// Range: 0x802958C0 -> 0x80295964
// this: r28
void zTask::Setup() {
    // Local variables
    int i; // r29
...
// Range: 0x80295964 -> 0x80295A60
// this: r31
void zTask::HandleEvent(unsigned int toEvent /* r0 */) {
    // References
    // -> static unsigned char sDebugOutput;
}

// Range: 0x80295A60 -> 0x80295AD0
// this: r31
void zTask::Fail() {
    // References
    // -> static unsigned char sDebugOutput;
...
// Range: 0x80295BD8 -> 0x80295BF8
// this: r0
void zTask::OnChangeInConditions() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E0C
// Range: 0x80295BF8 -> 0x80295CC4
// this: r30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E14
// total size: 0x0
...
// Range: 0x80295CC4 -> 0x80295DA8
// this: r30
void zTask::Load(struct xSerial * s /* r31 */) {
    // Local variables
...
static char * taskTxt[2]; // size: 0x8, address: 0x80C05E1C
// Range: 0x80295DA8 -> 0x80295DBC
// this: r0
...
static char * taskTxt[2]; // size: 0x8, address: 0x80C05E24
// Range: 0x80295DBC -> 0x80295DD0
// this: r0
...
static char * taskTxt[2]; // size: 0x8, address: 0x80C05E2C
// Range: 0x80295DD0 -> 0x80295DF4
// this: r0
...
// Range: 0x80295DF4 -> 0x80295E20
static void MissionEventWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E34
...
// Range: 0x80295E20 -> 0x80295FF0
void zMission::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class zMission * newMission; // r0

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x80295FF0 -> 0x80295FF4
void zMission::Reset() {}

// Range: 0x80295FF4 -> 0x802960B4
// this: r28
void zMission::Setup() {
    // Local variables
    int i; // r29
...
static char * missionTxt[3]; // size: 0xC, address: 0x80C05E3C
// Range: 0x802960B4 -> 0x802960C8
// this: r0
...
// Range: 0x802962DC -> 0x8029630C
static struct xBase * _DumpLogCB(struct xBase * obj /* r3 */) {
    // Local variables
    class zMission * mission; // r31
}

// Range: 0x8029630C -> 0x80296350
static void zMissionDumpALog() {}

static unsigned char alreadyAdded; // size: 0x1, address: 0x80C09501
static signed char init; // size: 0x1, address: 0x80C09502
// total size: 0x28
...
static struct tweak_callback cb_dump_a_log; // size: 0x28, address: 0x80406D58
// Range: 0x80296350 -> 0x802963C8
...
// Range: 0x802963C8 -> 0x802963CC
void zMission::AddDebugTweaks() {}

// Range: 0x802963CC -> 0x8029649C
// this: r31
...
// Range: 0x80296530 -> 0x8029662C
// this: r31
void zMission::HandleEvent(unsigned int toEvent /* r0 */) {
    // References
    // -> static unsigned char sDebugOutput;
}

// Range: 0x8029662C -> 0x8029670C
// this: r31
void zMission::TestForUnlocking() {
    // Local variables
    int i; // r0
    class zMission * rq; // r4
...
// Range: 0x80296880 -> 0x802968B4
// this: r31
void zMission::OnChangeInConditions() {}

// Range: 0x802968B4 -> 0x802968E4
static struct xBase * _MissionIterator(struct xBase * obj /* r3 */) {
    // Local variables
    class zMission * mission; // r31
}

// Range: 0x802968E4 -> 0x80296914
static struct xBase * _TaskIterator(struct xBase * obj /* r3 */) {
    // Local variables
    class zTask * task; // r31
}

// Range: 0x80296914 -> 0x80296998
void zMission::OnChangeInMissionConditions() {
    // References
    // -> static unsigned char sConditionMadeChange;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E48
// Range: 0x80296998 -> 0x80296AAC
// this: r29
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05E50
// Range: 0x80296AAC -> 0x80296BD4
// this: r30
void zMission::Load(struct xSerial * s /* r31 */) {
    // Local variables
    unsigned int input; // r1+0x8
