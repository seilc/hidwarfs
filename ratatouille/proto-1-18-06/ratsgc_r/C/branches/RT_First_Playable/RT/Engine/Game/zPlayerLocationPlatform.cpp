/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerLocationPlatform.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029E660 -> 0x8029EBCC
*/
class zPlayerLocationPlatformConnector * head; // size: 0x4, address: 0x80C095D8
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C060F8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x18
struct zPlayerLocationPlatformConnectorAsset : public xDynAsset {
    // Members
    unsigned int platformId; // offset 0x10, size 0x4
    unsigned int playerId; // offset 0x14, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0x4
struct /* @class$1124zPlayerLocationPlatform_cpp */ {
    // Members
...
union /* @class$1263zPlayerLocationPlatform_cpp */ {
...
// total size: 0xC
struct /* @class$1262zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0x24
class zPlayerLocationPlatformConnector : public xBase {
    // Functions
    zPlayerLocationPlatformConnector(struct zPlayerLocationPlatformConnectorAsset * theAsset);

    void Update();

    // Static members
    static class zPlayerLocationPlatformConnector * head; // size: 0x4

    // Members
protected:
    struct zPlayerLocationPlatformConnectorAsset * asset; // offset 0x10, size 0x4
    unsigned char firstUpdate; // offset 0x14, size 0x1
    struct xEnt * platform; // offset 0x18, size 0x4
    struct xEnt * attachEnt; // offset 0x1C, size 0x4
    class zPlayerLocationPlatformConnector * next; // offset 0x20, size 0x4
};
// Range: 0x8029E660 -> 0x8029E7D4
// this: r31
zPlayerLocationPlatformConnector::zPlayerLocationPlatformConnector(struct zPlayerLocationPlatformConnectorAsset * theAsset /* r30 */) {
    // Local variables
    class zPlayerLocationPlatformConnector * cur; // r3

    // References
    // -> class zPlayerLocationPlatformConnector * head;
    // -> struct xGlobals * xglobals;
    // -> static char __FUNCTION__[5];
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06100
// Range: 0x8029E7D4 -> 0x8029E968
void zPlayerLocationPlatformConnector::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C06108
// Range: 0x8029E968 -> 0x8029EB70
// this: r31
void zPlayerLocationPlatformConnector::Update() {
    // Local variables
    struct xBase * tbase; // r29
...
// total size: 0xC
struct /* @class$1065zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1066zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1067zPlayerLocationPlatform_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1068zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1069zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1070zPlayerLocationPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1071zPlayerLocationPlatform_cpp */ {
    // Members
...
// Range: 0x8029EB70 -> 0x8029EBC0
void zPlayerLocationPlatformConnector::UpdateAll(float dt /* f31 */) {
    // Local variables
    class zPlayerLocationPlatformConnector * cur; // r31

    // References
    // -> class zPlayerLocationPlatformConnector * head;
}

// Range: 0x8029EBC0 -> 0x8029EBCC
void zPlayerLocationPlatformConnector::Exit() {
    // References
    // -> class zPlayerLocationPlatformConnector * head;
}
