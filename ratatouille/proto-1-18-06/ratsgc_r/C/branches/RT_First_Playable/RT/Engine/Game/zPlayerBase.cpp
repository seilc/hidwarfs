/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerBase.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80154904 -> 0x80154EEC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sMemDepthJustHIPStartPlayer; // size: 0x4, address: 0x80C01190
static float time_scale; // size: 0x4, address: 0x80C08378
static signed char init; // size: 0x1, address: 0x80C0837C
static unsigned char _temp_tweaks_registered; // size: 0x1, address: 0x80C0837D
static signed char init; // size: 0x1, address: 0x80C0837E
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1128zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1288zPlayerBase_cpp */ {
    // Members
...
union /* @class$863zPlayerBase_cpp */ {
...
// total size: 0x10
struct /* @class$1792zPlayerBase_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80154904 -> 0x80154A6C
void zPlayerUpdate(struct xEnt * ent /* r30 */, struct xScene * sc /* r31 */, float dt /* f31 */) {
    // Local variables
    const char * prefix; // r0
    struct zPlayer * player; // r30
...
// total size: 0x890
struct /* @class$2039zPlayerBase_cpp */ {
    // Static members
...
// total size: 0xC
struct /* @class$1069zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1070zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1071zPlayerBase_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1072zPlayerBase_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1073zPlayerBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1074zPlayerBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1075zPlayerBase_cpp */ {
    // Members
...
// Range: 0x80154A6C -> 0x80154AB4
void zPlayerRender(struct zEnt * ent /* r3 */) {
    // Local variables
    struct zPlayer * player; // r31
}

// Range: 0x80154AB4 -> 0x80154AE0
void zPlayerReset(struct zEnt * ent /* r0 */) {}

// Range: 0x80154AE0 -> 0x80154B0C
void zPlayerMove(struct xEnt * ent /* r0 */, struct xScene * s /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r0 */) {}

// Range: 0x80154B0C -> 0x80154C10
void zPlayerLoadHIP(unsigned int gameSceneID /* r27 */) {
    // Local variables
    unsigned int playersToLoad; // r1+0x8
    unsigned int tagPlayer; // r31
    unsigned char playerHipLoaded[9]; // r1+0xC
    int j; // r0
    int i; // r28
...
// Range: 0x80154D04 -> 0x80154DCC
void zPlayer_StoreCheckPoint(const struct zPlayerCheckPoint * checkPoints /* r30 */, unsigned int initialCameraID /* r0 */) {
    // Local variables
    int i; // r30
...
// Range: 0x80154DCC -> 0x80154E88
void zPlayerSceneInit(unsigned int sceneID /* r29 */) {
    // Local variables
    int i; // r30
