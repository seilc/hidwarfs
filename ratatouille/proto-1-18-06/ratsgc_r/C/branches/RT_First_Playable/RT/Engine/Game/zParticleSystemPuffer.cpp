/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleSystemPuffer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8026F5E4 -> 0x80270574
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8026F5E4 -> 0x8026F658
// this: r29
struct zParticleGenerator * zParticleSystemPuffer::create_generator(struct zParticleAsset & asset /* r30 */) {}

// Range: 0x8026F694 -> 0x8026F6B8
// this: r3
void zParticleSystemPuffer::scene_enter() {}

// Range: 0x8026F6B8 -> 0x8026F6D8
// this: r0
void zParticleSystemPuffer::update(float dt /* f0 */) {}
...
// Range: 0x8026F6D8 -> 0x8026F6E0
int zParticleSystemPuffer::get_asset_size() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C055C0
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x10
struct /* @class$1036zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1956zParticleSystemPuffer_cpp */ {
    // Members
...
// Range: 0x8026F6E0 -> 0x8026FAB8
int zParticleSystemPuffer::update_particles(unsigned char * mem /* r22 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */, void * context /* r21 */) {
    // Local variables
    ...
    float size; // f30
    float lifetime; // f29
    float deathAlpha; // f28
    float alphaRange; // f27
...
// Range: 0x8026FAB8 -> 0x8026FDC4
// this: r30
void zParticleGeneratorPuffer::update(float dt /* f27 */) {
    // Local variables
    const struct asset_data & a; // r0
    unsigned char startEmit; // r28
    int emit; // r27
    float lifetime; // f30
    float drift; // f29
    float rotSpeed; // f28
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C055D4
...
// Range: 0x8026FDC4 -> 0x80270018
// this: r29
void zParticleGeneratorPuffer::create(class zParticleSystemPuffer & system /* r30 */, struct zParticleAsset & asset /* r31 */) {
    // Local variables
...
// Range: 0x8027051C -> 0x80270574
// this: r30
void zParticleGeneratorPuffer::debug_render(unsigned char all /* r31 */) {}

// total size: 0x2C
struct {} zParticleGeneratorPuffer::__vtable; // size: 0x2C, address: 0x804437D8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0xC
struct /* @class$1760zParticleSystemPuffer_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// total size: 0xC
struct /* @class$972zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$973zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$975zParticleSystemPuffer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$976zParticleSystemPuffer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$977zParticleSystemPuffer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$978zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1358zParticleSystemPuffer_cpp */ {
    // Members
...
union /* @class$1023zParticleSystemPuffer_cpp */ {
...
// total size: 0xC
struct /* @class$1496zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zParticleSystemPuffer::__vtable; // size: 0x3C, address: 0x80443804
// total size: 0x8
