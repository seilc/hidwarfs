/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xMath3.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8007BDA0 -> 0x80081414
*/
// total size: 0xC
struct RwV3d {
    // Members
...
struct xQuat g_IQ; // size: 0x10, address: 0x80C0ADE8
// Range: 0x8007BDA0 -> 0x8007BE34
void xMath3Init() {
    // References
    // -> struct xVec3 g_O3;
    // -> struct xMat4x3 g_I3;
...
static float gs_fTolerance; // size: 0x4, address: 0x80BFD2A8
// Range: 0x8007BF3C -> 0x8007C400
...
// Range: 0x8007E8C4 -> 0x8007E940
int xPointInBox(const struct xBox * b /* r0 */, const struct xVec3 * p /* r0 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD2AC
// Range: 0x8007E940 -> 0x8007EBDC
void xBoxInitBoundOBB(struct xBox * o /* r29 */, const struct xBox * b /* r30 */, const struct xMat4x3 * m /* r31 */) {
    // Local variables
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFD2C0
// total size: 0x1C
struct xCapsule {
    // Members
...
// Range: 0x8007EE20 -> 0x8007EE84
void xMat3x3Init(struct xMat3x3 * m /* r29 */, const struct xVec3 * _right /* r0 */, const struct xVec3 * _up /* r30 */, const struct xVec3 * _at /* r31 */) {}

// Range: 0x8007EE84 -> 0x8007EF14
float xMat3x3NormalError(const struct xMat3x3 * m /* r3 */) {
    // Local variables
    const struct xVec3 * up; // r31
    const struct xVec3 * at; // r30
    float re; // f0
    float ue; // f0
    float ae; // f0
}

// Range: 0x8007EF14 -> 0x8007EF64
void xMat3x3Normalize(struct xMat3x3 * o /* r30 */, const struct xMat3x3 * m /* r31 */) {}

// Range: 0x8007EF64 -> 0x8007EFB8
void xMat3x3GetScale(const struct xMat3x3 * m /* r30 */, struct xVec3 * s /* r31 */) {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD2D8
// Range: 0x8007EFB8 -> 0x8007F1C8
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD2F8
// Range: 0x8007FBA0 -> 0x8007FD28
...
// Range: 0x80080BE0 -> 0x80080D40
void xQuatToMat(const struct xQuat * q /* r30 */, struct xMat3x3 * m /* r31 */) {
    // Local variables
    float tx; // f7
    float ty; // f3
    float tz; // f8
...
// Range: 0x80081394 -> 0x80081414
unsigned char xVec3Eq(const struct xVec3 & a /* r3 */, const struct xVec3 & b /* r4 */, float tol /* f0 */) {
    // Local variables
    int i; // r0
}
