/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomStatic.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022B0D0 -> 0x8022B594
*/
float STATIC_ALPHA; // size: 0x4, address: 0x80C04610
float STATIC_MIN_OFF_TIME; // size: 0x4, address: 0x80C04614
float STATIC_MAX_OFF_TIME; // size: 0x4, address: 0x80C04618
float STATIC_FADE_IN_TIME; // size: 0x4, address: 0x80C0461C
float STATIC_MIN_ON_TIME; // size: 0x4, address: 0x80C04620
float STATIC_MAX_ON_TIME; // size: 0x4, address: 0x80C04624
float STATIC_FADE_OUT_TIME; // size: 0x4, address: 0x80C04628
float STATIC_UV_STRENGTH; // size: 0x4, address: 0x80C0462C
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04630
// total size: 0x54
struct {} zUICustomStatic::__vtable; // size: 0x54, address: 0x8043FDD8
enum Stage {
    Stage_Off = 0,
    Stage_FadeIn = 1,
    Stage_On = 2,
...
// Range: 0x8022B0D0 -> 0x8022B17C
// this: r30
zUICustomStatic::zUICustomStatic(class zUI * ui /* r31 */) {
    // References
...
// Range: 0x8022B17C -> 0x8022B1BC
// this: r31
void zUICustomStatic::Reset() {
    // References
    // -> float STATIC_MAX_OFF_TIME;
    // -> float STATIC_MIN_OFF_TIME;
}

// Range: 0x8022B1BC -> 0x8022B28C
// this: r31
void zUICustomStatic::PreUpdate(float dt /* f0 */) {
    // References
    // -> float STATIC_MAX_OFF_TIME;
    // -> float STATIC_MIN_OFF_TIME;
    // -> float STATIC_FADE_OUT_TIME;
    // -> float STATIC_MAX_ON_TIME;
    // -> float STATIC_MIN_ON_TIME;
    // -> float STATIC_FADE_IN_TIME;
}

// Range: 0x8022B28C -> 0x8022B38C
// this: r30
void zUICustomStatic::PreApplyMotionFrame(struct zUIMotionFrame * frame /* r31 */) {
    // References
    // -> float STATIC_ALPHA;
    // -> float STATIC_FADE_OUT_TIME;
    // -> float STATIC_UV_STRENGTH;
}

// Range: 0x8022B38C -> 0x8022B594
void zUICustomStatic::AddTweaks(const char * baseName /* r31 */) {
    // Local variables
