/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\water\texconv.c
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801D89D0 -> 0x801D8D78
*/
// total size: 0x4
struct RwRGBA {
    // Members
