/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCAsset.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F4AB0 -> 0x801F52E0
*/
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C039B0
// total size: 0x8
struct xBaseAsset {
    // Members
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C039BC
// Range: 0x801F4C4C -> 0x801F4DE8
...
static struct DynNPCInfo g_DynNPCInfo[3]; // size: 0x3C, address: 0x8043E770
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C039C8
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x801F4DE8 -> 0x801F4E8C
static struct xBase * MakeNPCGeneric(const struct xDynAsset * dynAsset /* r7 */, unsigned int dynAssetSize /* r5 */) {
    // Local variables
    struct xEntAsset * entass; // r3
    struct xBase * npc; // r31

    // References
    // -> static char __FUNCTION__[15];
}

static int needToHash; // size: 0x4, address: 0x80C08DA0
static signed char init; // size: 0x1, address: 0x80C08DA4
// Range: 0x801F4E8C -> 0x801F4F14
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C039D8
// Range: 0x801F4F14 -> 0x801F504C
int zNPCAsset_CountNPCs(int * typeCount /* r26 */) {
    // Local variables
    int count_NPC; // r28
    int num_alldyn; // r0
    int i; // r27
    unsigned int dynAssetSize; // r1+0x8
    const struct xDynAsset * dynAsset; // r0
    int isOurs; // r4
    struct DynNPCInfo * npcinf_next; // r5
    struct DynNPCInfo * npcinf; // r6
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C039EC
// Range: 0x801F504C -> 0x801F51BC
void zNPCAsset_CreateNPCs() {
    ...
    struct DynNPCInfo * npcinf_next; // r4
    struct DynNPCInfo * npcinf; // r27
...
static char __FUNCTION__[23]; // size: 0x17, address: 0x80C03A04
// total size: 0x10
...
// total size: 0x4
struct /* @class$1112zNPCAsset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1276zNPCAsset_cpp */ {
    // Members
...
// Range: 0x801F51BC -> 0x801F5288
void zNPCAsset_RegisterNPCs(int * base_idx /* r26 */) {
    // Local variables
    struct st_XORDEREDARRAY * npclist; // r0
    int num_npc; // r29
    int i; // r28
...
// Range: 0x801F5288 -> 0x801F52E0
unsigned char zNPCAsset_IsNPC(const struct xDynAsset & asset /* r0 */) {
    // Local variables
    int i; // r0
