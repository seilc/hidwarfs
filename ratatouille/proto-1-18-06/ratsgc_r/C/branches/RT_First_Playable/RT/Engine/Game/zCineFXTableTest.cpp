/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCineFXTableTest.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80261760 -> 0x80261A8C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[36]; // size: 0x24, address: 0x80443118
// total size: 0x10
struct TypeInfo {
    // Members
    union { // inferred
...
// total size: 0x54
struct /* @class$1813zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1093zCineFXTableTest_cpp */ {
    // Members
...
union /* @class$828zCineFXTableTest_cpp */ {
...
// total size: 0xC
struct /* @class$1276zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1034zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1035zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1036zCineFXTableTest_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1037zCineFXTableTest_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1038zCineFXTableTest_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1039zCineFXTableTest_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1040zCineFXTableTest_cpp */ {
    // Members
...
// Range: 0x80261760 -> 0x80261888
static void zCinFX_Par_CINFX_TEST_PAR_SMOKE_Upd(struct NCINEntry * fxrec /* r31 */, int killit /* r0 */) {
    // Local variables
    struct zParEmitter * & emitter; // r0
    struct xParEmitterAsset * a; // r3
...
// Range: 0x80261888 -> 0x80261970
static void NCIN_upd_test(const struct zCutsceneMgr * csnmgr /* r29 */, struct NCINEntry * fxrec /* r30 */, int killit /* r31 */) {
    // Local variables
    struct PosInput * pi; // r0
}

// Range: 0x80261970 -> 0x802619F0
static void NCIN_anim_test(const struct zCutsceneMgr * csnmgr /* r3 */, struct NCINEntry * fxrec /* r29 */, struct RpAtomic * model /* r30 */, struct RwMatrixTag * animMat /* r31 */, unsigned int animIndex /* r12 */, unsigned int dataIndex /* r0 */, unsigned int & visflags /* r9 */) {}

// Range: 0x802619F0 -> 0x80261A30
static void NCIN_rend_test(const struct zCutsceneMgr * csnmgr /* r3 */, struct NCINEntry * fxrec /* r5 */) {}

// Range: 0x80261A30 -> 0x80261A68
static void NCIN_tweak_test(const char * prefix /* r3 */) {}

static struct NCINEntry g_TR02_cin_test[4]; // size: 0x250, address: 0x8044313C
// total size: 0xC
struct NCINMap {
    // Members
...
static struct NCINMap cutmap[2]; // size: 0x18, address: 0x80C052F0
// Range: 0x80261A68 -> 0x80261A8C
