/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGameState.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012F0E8 -> 0x8012F824
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
enum _GameOstrich gGameOstrich; // size: 0x4, address: 0x80C08164
static unsigned int sGameMode_DispatchTable[12]; // size: 0x30, address: 0x8043A130
static unsigned int sGameState_DispatchTable[8]; // size: 0x20, address: 0x8043A160
static unsigned int sPauseState_DispatchTable[2]; // size: 0x8, address: 0x80C008E4
static unsigned int sSaveState_DispatchTable[3]; // size: 0xC, address: 0x80C008EC
static unsigned int sOptionsState_DispatchTable[1]; // size: 0x4, address: 0x80C008F8
static unsigned int sLoadState_DispatchTable[3]; // size: 0xC, address: 0x80C008FC
static unsigned int sTitleState_DispatchTable[2]; // size: 0x8, address: 0x80C00908
static unsigned int sIntroState_DispatchTable[4]; // size: 0x10, address: 0x80C00910
static unsigned int sGameState_DoDispatchTable[8]; // size: 0x20, address: 0x8043A180
static unsigned int sPauseState_DoDispatchTable[2]; // size: 0x8, address: 0x80C00920
static unsigned int sSaveState_DoDispatchTable[3]; // size: 0xC, address: 0x80C00928
static unsigned int sOptionsState_DoDispatchTable[1]; // size: 0x4, address: 0x80C00934
static unsigned int sLoadState_DoDispatchTable[3]; // size: 0xC, address: 0x80C00938
static unsigned int sTitleState_DoDispatchTable[2]; // size: 0x8, address: 0x80C00944
static unsigned int sIntroState_DoDispatchTable[4]; // size: 0x10, address: 0x80C0094C
...
// Range: 0x8012F0F0 -> 0x8012F0F8
int zGameModeGet() {
    // References
    // -> enum eGameMode gGameMode;
}

// Range: 0x8012F0F8 -> 0x8012F100
enum _GameOstrich zGameGetOstrich() {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

// Range: 0x8012F100 -> 0x8012F108
void zGameSetOstrich(enum _GameOstrich o /* r0 */) {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80C0095C
// Range: 0x8012F108 -> 0x8012F2B0
int zGameStateFindEvent(unsigned int * array /* r26 */, int size /* r27 */, int mode /* r28 */, int event /* r29 */, int * ret_mode /* r30 */, int * ret_state /* r31 */) {
    // Local variables
    int i; // r4
...
// total size: 0x4
struct /* @class$1148zGameState_cpp */ {
    // Members
...
union /* @class$1287zGameState_cpp */ {
...
// total size: 0xC
struct /* @class$1286zGameState_cpp */ {
    // Members
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00970
// total size: 0x1C
