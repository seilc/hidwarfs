/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zRaftTrack.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B7E78 -> 0x802B8414
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06608
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1097zRaftTrack_cpp */ {
    // Members
...
union /* @class$1236zRaftTrack_cpp */ {
...
// total size: 0xC
struct /* @class$1235zRaftTrack_cpp */ {
    // Members
...
// Range: 0x802B7E78 -> 0x802B8140
// this: r31
void zRaftTrack::load(const struct asset_type & a /* r27 */) {
    // Local variables
    struct xBase * obj; // r5
    struct xGroup * group; // r28
    unsigned int i; // r27
    unsigned int end; // r0
    struct xBase * entry; // r0
    struct xEnt * raftTrackEnt; // r0
    struct xEnt * raftTrackEnt; // r0
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06610
// Range: 0x802B8140 -> 0x802B82B4
void zRaftTrack::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// Range: 0x802B82B4 -> 0x802B82D4
// this: r0
void zRaftTrack::debugInit() {}

// Range: 0x802B82D4 -> 0x802B8414
// this: r31
...
// total size: 0xC
struct /* @class$938zRaftTrack_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$939zRaftTrack_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$940zRaftTrack_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$941zRaftTrack_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$942zRaftTrack_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$943zRaftTrack_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$944zRaftTrack_cpp */ {
    // Members
