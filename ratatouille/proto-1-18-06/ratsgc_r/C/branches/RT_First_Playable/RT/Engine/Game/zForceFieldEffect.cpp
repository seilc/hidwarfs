/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zForceFieldEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80223538 -> 0x80226500
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int mesh_rows; // size: 0x4, address: 0x80C04400
static int mesh_columns; // size: 0x4, address: 0x80C04404
static float wave_decay; // size: 0x4, address: 0x80C04408
static float wave_decay_result; // size: 0x4, address: 0x80C08F70
static float wave_speed; // size: 0x4, address: 0x80C0440C
static float framerate_blend; // size: 0x4, address: 0x80C04410
// total size: 0x10
struct _xFColor {
    // Members
...
static float initial_stablize_force; // size: 0x4, address: 0x80C04414
static float ripple_time; // size: 0x4, address: 0x80C04418
static float ripple_force; // size: 0x4, address: 0x80C0441C
static float strength_to_ripple; // size: 0x4, address: 0x80C04420
static float fade_time; // size: 0x4, address: 0x80C04424
static struct _xFColor default_color; // size: 0x10, address: 0x80C04428
static struct _xFColor mid_color; // size: 0x10, address: 0x80C04438
static struct _xFColor weak_color; // size: 0x10, address: 0x80C04448
static float strength_to_flicker; // size: 0x4, address: 0x80C04458
static float max_flicker_time; // size: 0x4, address: 0x80C0445C
static float min_flicker_time; // size: 0x4, address: 0x80C08F74
static float transition_time; // size: 0x4, address: 0x80C04460
static int wrap_u; // size: 0x4, address: 0x80C04464
static int wrap_v; // size: 0x4, address: 0x80C04468
static unsigned int texture; // size: 0x4, address: 0x80C0446C
static int glow_clamp; // size: 0x4, address: 0x80C04470
static float height_glow; // size: 0x4, address: 0x80C04474
static float spin_speed; // size: 0x4, address: 0x80C04478
static float zbias; // size: 0x4, address: 0x80C08F78
static float lifetime; // size: 0x4, address: 0x80C0447C
static float life_rand; // size: 0x4, address: 0x80C04480
static float size_min; // size: 0x4, address: 0x80C04484
static float size_rand; // size: 0x4, address: 0x80C04488
static float velocity; // size: 0x4, address: 0x80C0448C
static float velocity_rand; // size: 0x4, address: 0x80C04490
static float glint_length_min; // size: 0x4, address: 0x80C08F7C
static float glint_length_rand; // size: 0x4, address: 0x80C04494
static float glint_length_max; // size: 0x4, address: 0x80C04498
static float gravity; // size: 0x4, address: 0x80C0449C
static int fraction; // size: 0x4, address: 0x80C044A0
static unsigned char render_heightmap; // size: 0x1, address: 0x80C08F80
static float render_heightmap_scale; // size: 0x4, address: 0x80C044A4
static float render_heightmap_yoffset; // size: 0x4, address: 0x80C044A8
static float test_strength; // size: 0x4, address: 0x80C044AC
static class zForceFieldEffect FFEList[9]; // size: 0x870, address: 0x80BC5290
static struct RwRaster * energy_raster; // size: 0x4, address: 0x80C08F84
static int sparkSystemID; // size: 0x4, address: 0x80C044B0
static int glintSystemID; // size: 0x4, address: 0x80C044B4
static int electricSystemID; // size: 0x4, address: 0x80C044B8
// total size: 0x1C
struct ArcConfig {
    // Members
...
static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig; // size: 0x1C, address: 0x803F7220
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C044BC
// Range: 0x80223538 -> 0x802235FC
...
// Range: 0x802235FC -> 0x8022365C
static void apply_uv_matrix(struct xVec2 * ouv /* r3 */, const struct xVec2 * iuv /* r4 */, int size /* r0 */, const struct xMat4x3 & uvmat /* r0 */) {
    // Local variables
    float rx; // f2
    float ry; // f3
    float ux; // f4
    ...
    float px; // f6
    float py; // f7
    struct xVec2 * end_ouv; // r0
    float x; // f8
    float y; // f0
}

// Range: 0x8022365C -> 0x80223690
static void scroll_v(struct xVec2 * ouv /* r3 */, const struct xVec2 * iuv /* r4 */, int size /* r0 */, float uoffset /* f0 */) {
    // Local variables
    struct xVec2 * end_ouv; // r0
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043F940
// Range: 0x80223690 -> 0x802239F0
static void unit_sphere_calc_indices(unsigned short * indices /* r30 */, int rows /* r4 */, int cols /* r6 */) {
    // Local variables
    int i; // r5
    int j; // r12
...
static char prefix[128]; // size: 0x80, address: 0x80BC5B00
// total size: 0x28
...
static struct tweak_callback cb_energy_uv; // size: 0x28, address: 0x803F723C
static struct tweak_callback cb_reload_energy_texture; // size: 0x28, address: 0x803F7264
// total size: 0x34
struct meshData {
    // Members
...
// total size: 0x4
struct /* @class$1152zForceFieldEffect_cpp */ {
    // Members
    struct xVec3 * verts; // offset 0x0, size 0x4
};
// total size: 0x0
...
// Range: 0x802239F0 -> 0x80224258
void zForceFieldEffect::AddTweaks(const char * name /* r5 */, class zForceFieldEffect * ffe /* r30 */) {
    // Local variables
    const char * * texture_labels; // r1+0x14
    const unsigned int * texture_ids; // r1+0x10
    unsigned int textures; // r31
...
// Range: 0x80224258 -> 0x8022427C
void zForceFieldEffect::on_change_energy_uv(const struct tweak_info & info /* r3 */) {}
...
// total size: 0xC
struct /* @class$995zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$996zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$997zForceFieldEffect_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$998zForceFieldEffect_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$999zForceFieldEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1000zForceFieldEffect_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1001zForceFieldEffect_cpp */ {
    // Members
...
// Range: 0x8022427C -> 0x802242A0
void zForceFieldEffect::on_reload_energy_texture(const struct tweak_info & info /* r3 */) {}

// Range: 0x802242A0 -> 0x802242A8
int zForceFieldEffect::GetSparkSystemID() {
    // References
    // -> static int sparkSystemID;
}

// Range: 0x802242A8 -> 0x802242B0
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8043F95C
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x802242B0 -> 0x80224618
// this: r28
void zForceFieldEffect::unit_sphere_calc_vertices(struct xVec3 * verts /* r29 */, int rows /* r30 */, int cols /* r31 */) {
    // Local variables
...
// Range: 0x80224618 -> 0x8022480C
// this: r29
void zForceFieldEffect::refresh_energy_uv() {
    // Local variables
    struct xVec2 * uv_buffer; // r31
    float halfHeight; // f31
    struct xVec3 * vertNormals; // r30
    struct xVec3 * nEnd; // r4
    struct xVec3 * nPtr; // r5
    struct xMat4x3 uvmat; // r1+0x10
    const unsigned short * index; // r28
    const unsigned short * end_index; // r29
    struct xVec2 * strip_uv; // r27
...
// total size: 0xC
struct /* @class$1308zForceFieldEffect_cpp */ {
    // Members
...
union /* @class$1054zForceFieldEffect_cpp */ {
...
// total size: 0x10
struct /* @class$1559zForceFieldEffect_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80224CC4 -> 0x802256C0
// this: r20
void zForceFieldEffect::animate_heightmap(float dt /* f28 */) {
    // Local variables
    int rows; // r26
    int cols; // r25
    float d; // f31
    ...
    float total; // f1
    float abs_total; // f28
    const float * end_M1; // r19
    float dxz; // f28
    struct xVec3 start_loc; // r1+0x40
    const float * hmap; // r24
    int i; // r23
    int j; // r22
    struct xVec3 loc0; // r1+0x34
    struct xVec3 loc1; // r1+0x28
    struct xVec3 loc2; // r1+0x1C
...
// total size: 0x890
struct /* @class$2021zForceFieldEffect_cpp */ {
    // Static members
...
// Range: 0x802256C0 -> 0x8022573C
// this: r0
void zForceFieldEffect::copy_buffers(struct xIMLockContext & energy_lock /* r0 */, const struct xVec3 * verts /* r24 */, const struct xColor_tag * colors /* r25 */) {
    // Local variables
    int indices_size; // r30
    struct xVec3 * lock_pos; // r29
    struct xColor_tag * lock_color; // r28
    int i; // r27
    int index; // r26
}

// Range: 0x8022573C -> 0x80225A0C
// this: r28
void zForceFieldEffect::shade_sphere(struct xVec3 * verts /* r31 */, struct xColor_tag * colors /* r29 */, const struct _xFColor * shieldColor /* r30 */) {
    // Local variables
    struct xVec3 cam_loc; // r1+0x8
    float Cx; // f0
    float Cy; // f30
    float Cz; // f29
    float iEmag; // f0
    const float * hmap; // r9
    float halfHeight; // f3
    const struct xVec3 * iv; // r10
    struct xVec3 * ov; // r3
    struct xVec3 * endov; // r11
    struct xColor_tag * color; // r4
    float height_offset; // f8
    float Nx; // f13
    float Nz; // f28
    float Ny; // f27
    float height; // f6
...
// Range: 0x80225B18 -> 0x80225B88
// this: r31
void zForceFieldEffect::EmitRandomRipple(float force /* f31 */) {
    // Local variables
...
// Range: 0x80225C18 -> 0x80225C50
// this: r31
void zForceFieldEffect::FreeForceField() {}

// Range: 0x80225C50 -> 0x80225CA8
// this: r30
void zForceFieldEffect::Move(const struct xMat4x3 & mat /* r31 */) {}

// Range: 0x80225CA8 -> 0x80225CB0
float zForceFieldEffect::GetShieldFadeOutTime() {
    // References
    // -> static float fade_time;
}

// Range: 0x80225CB0 -> 0x80225CC0
// this: r0
...
// Range: 0x80225CC0 -> 0x80225EFC
// this: r31
void zForceFieldEffect::updateColor(float dt /* f31 */) {
    // Local variables
    float colorStrength; // f2
    float colorStrength; // f2
...
// Range: 0x80225FE4 -> 0x8022618C
// this: r31
void zForceFieldEffect::DestroyShield(float dt /* f30 */, struct xModelInstance * model /* r22 */) {
    // Local variables
    int num_particles; // r29
    struct xVec3 * locList; // r30
    struct xVec3 * dirList; // r28
    float * lenVelList; // r27
    struct xVec3 * locPtr; // r26
    struct xVec3 * dirPtr; // r25
    float * lenPtr; // r24
...
// Range: 0x8022618C -> 0x802261F8
// this: r31
void zForceFieldEffect::updateDestroyEffects(float dt /* f31 */) {
    // References
    // -> static int electricSystemID;
    // -> static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig;
}

// Range: 0x802261F8 -> 0x802261FC
void zForceFieldEffect::RenderBack() {}

static int rows; // size: 0x4, address: 0x80C08F88
static signed char init; // size: 0x1, address: 0x80C08F8C
static int cols; // size: 0x4, address: 0x80C08F90
static signed char init; // size: 0x1, address: 0x80C08F94
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
...
// Range: 0x802261FC -> 0x80226398
// this: r31
void zForceFieldEffect::RenderFront() {
    // Local variables
    int verts_size; // r30
    int indices_size; // r29
    struct xMat4x3 view_mat; // r1+0x30
    struct xIMLockContext energy_lock; // r1+0x10
    struct xVec3 * verts; // r30
    struct xColor_tag * colors; // r28
...
// Range: 0x80226398 -> 0x8022643C
int zForceFieldEffect::sortForceFields(void * elem1 /* r0 */, void * elem2 /* r0 */) {
    // Local variables
    const class zForceFieldEffect * ffe1; // r31
    const class zForceFieldEffect * ffe2; // r3
    const struct xVec3 & camPos; // r30

    // References
    // -> struct zGlobals globals;
}

// Range: 0x8022643C -> 0x80226500
