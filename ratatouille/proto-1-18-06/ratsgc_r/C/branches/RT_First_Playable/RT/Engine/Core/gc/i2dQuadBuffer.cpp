/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\i2dQuadBuffer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F78C0 -> 0x801F7AA8
*/
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03A60
// total size: 0x18
