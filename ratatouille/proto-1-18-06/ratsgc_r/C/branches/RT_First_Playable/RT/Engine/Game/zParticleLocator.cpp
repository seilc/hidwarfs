/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParticleLocator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C8D7C -> 0x801CD1CC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02ED0
static unsigned short popper_weight_sizes[8]; // size: 0x10, address: 0x80C0CF70
static struct activity_data * activities; // size: 0x4, address: 0x80C08B10
static int activities_used; // size: 0x4, address: 0x80C08B14
static struct popper_data * poppers; // size: 0x4, address: 0x80C08B18
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02EDC
// Range: 0x801C8D7C -> 0x801C8E00
static struct activity_data * alloc_activity() {
    // Local variables
    struct activity_data * activity; // r3
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C02EEC
// Range: 0x801C8E00 -> 0x801C8EE0
static void free_activity(struct activity_data * activity /* r30 */) {
    // Local variables
    struct activity_data * tail_activity; // r31
...
// Range: 0x801C9008 -> 0x801C9074
static unsigned char setup_attach_fixed(struct activity_data & activity /* r30 */, const struct zParticleAsset & asset /* r31 */) {}

// Range: 0x801C9074 -> 0x801C90A8
static void update_attach_entity(struct activity_data & activity /* r3 */) {}
...
// Range: 0x801C90A8 -> 0x801C9104
static void update_attach_entity_bone(struct activity_data & activity /* r31 */) {
    // Local variables
    struct xMat4x3 bone_mat; // r1+0x10
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80C02EFC
// Range: 0x801C9104 -> 0x801C9274
static unsigned char setup_attach_entity(struct activity_data & activity /* r29 */, const struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xEnt * attach_to; // r31

    // References
    // -> static char __FUNCTION__[20];
}

// Range: 0x801C9274 -> 0x801C927C
static unsigned char setup_attach_entity_tag() {}

// Range: 0x801C927C -> 0x801C92A0
static void get_offset_point(struct xVec3 & offset /* r0 */) {}
...
// Range: 0x801C92A0 -> 0x801C92B4
static unsigned char setup_volume_point(struct activity_data & activity /* r0 */) {}

// Range: 0x801C92B4 -> 0x801C92BC
static void edge_emit_point(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}

// Range: 0x801C92BC -> 0x801C93FC
static void get_offset_sphere(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f28
    float uz; // f27
    float r; // f0
...
// Range: 0x801C93FC -> 0x801C9504
static void get_offset_sphere_edge(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f29
    float uz; // f28
    float r; // f27
...
// Range: 0x801C9504 -> 0x801C9538
static unsigned char setup_volume_sphere(struct activity_data & activity /* r0 */, const struct zParticleAsset & asset /* r0 */) {
    // Local variables
    int edge_only; // r5
}

// Range: 0x801C9538 -> 0x801C955C
static void edge_emit_sphere(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}

// Range: 0x801C955C -> 0x801C963C
static void get_offset_circle(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f30
    float rr; // f29
}

// Range: 0x801C963C -> 0x801C96F0
static void get_offset_circle_edge(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f30
    float rr; // f29
}

// Range: 0x801C96F0 -> 0x801C980C
static void get_offset_circle_cylinder(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f30
    float rr; // f29
    float z; // f28
...
// Range: 0x801C980C -> 0x801C9860
static void edge_emit_circle(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}

// Range: 0x801C9860 -> 0x801C98E0
static unsigned char setup_volume_circle(struct activity_data & activity /* r30 */, const struct zParticleAsset & asset /* r31 */) {}

// Range: 0x801C98E0 -> 0x801C9950
static void get_offset_line(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float d; // f3
}

// Range: 0x801C9950 -> 0x801C9B50
...
// Range: 0x801C9CEC -> 0x801C9E18
static void get_offset_cylinder(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f30
    float d; // f29
    float rr; // f28
...
// Range: 0x801C9E18 -> 0x801C9F18
static void get_offset_cylinder_edge(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float ang; // f30
    float d; // f29
    float rr; // f28
...
// Range: 0x801C9F18 -> 0x801CA004
static unsigned char setup_volume_line(struct activity_data & activity /* r31 */, const struct zParticleAsset & asset /* r0 */) {
    // Local variables
    const struct volume_line_data & line; // r0
    int edge_only; // r5
    struct volume_data & ovolume; // r0
    float r; // f1
    float d; // f2
    float rr; // f3
}

// Range: 0x801CA004 -> 0x801CA07C
static void edge_emit_line(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {
    // Local variables
    const struct volume_line_data & line; // r0
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C02F10
// Range: 0x801CA07C -> 0x801CA1AC
static void get_offset_model_vert(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    int vert_index; // r29
    struct xModelInstance * * models; // r28
    const int * vertices; // r27

    // References
    // -> static char __FUNCTION__[22];
}

// Range: 0x801CA1AC -> 0x801CA1CC
static void get_offset_model_vert_expand(struct xVec3 & offset /* r0 */, struct volume_data & data /* r0 */) {}

// Range: 0x801CA1CC -> 0x801CA210
static void get_offset_model_surface(struct xVec3 & offset /* r0 */, struct volume_data & data /* r7 */) {
    // Local variables
    struct xVec3 vel; // r1+0x8
}

// Range: 0x801CA210 -> 0x801CA35C
static unsigned char setup_volume_model(struct activity_data & activity /* r31 */, const struct zParticleAsset & asset /* r0 */) {
    // Local variables
    struct xEnt * attach_to; // r30
    const struct volume_model_data & model; // r0
    int model_index; // r7
    int models_size; // r8
    int total_vertices; // r9
    struct xModelInstance * m; // r10
    int size; // r0
}

// Range: 0x801CA35C -> 0x801CA364
static void edge_emit_model(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}

// Range: 0x801CA364 -> 0x801CA458
static void get_offset_box(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float x; // f31
    float y; // f30
    float z; // f3
...
// Range: 0x801CA458 -> 0x801CA50C
static void get_offset_box_edge(struct xVec3 & offset /* r30 */, struct volume_data & data /* r31 */) {
    // Local variables
    float x; // f31
    float z; // f3
}

// Range: 0x801CA50C -> 0x801CA590
static unsigned char setup_volume_box(struct activity_data & activity /* r30 */, const struct zParticleAsset & asset /* r31 */) {
    // Local variables
    int edge_only; // r3
}

// Range: 0x801CA590 -> 0x801CA5B4
static void edge_emit_box(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}
...
// total size: 0x4
struct /* @class$1080zParticleLocator_cpp */ {
    // Members
...
union /* @class$1236zParticleLocator_cpp */ {
...
// total size: 0xC
struct /* @class$1235zParticleLocator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1485zParticleLocator_cpp */ {
    // Members
...
// Range: 0x801CA5B4 -> 0x801CA690
void zParticleLocator::scene_enter() {
    // Local variables
    struct popper_data * it; // r29
    struct popper_data * end; // r28
...
// Range: 0x801CA6A4 -> 0x801CA6B0
// this: r0
void zParticleLocator::create() {}

// Range: 0x801CA6B0 -> 0x801CA6B4
void zParticleLocator::restart() {}

static unsigned char (* const setup_attach_table[3])(struct activity_data &, struct zParticleAsset &); // size: 0xC, address: 0x80C0CFB4
static unsigned char (* const setup_volume_table[6])(struct activity_data &, struct zParticleAsset &); // size: 0x18, address: 0x80C0CFC0
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C02F28
// Range: 0x801CA6B4 -> 0x801CA84C
// this: r30
unsigned char zParticleLocator::activate(const struct zParticleAsset & asset /* r31 */, struct xEnt * attach_to /* r29 */) {
    // References
...
// Range: 0x801CA84C -> 0x801CA8B8
// this: r31
void zParticleLocator::deactivate() {}

static void (* const edge_emit_table[6])(struct activity_data &, unsigned char); // size: 0x18, address: 0x80C0CFD8
// Range: 0x801CA8B8 -> 0x801CA8F4
// this: r0
void zParticleLocator::setEmitFromEdge(unsigned char edgeEmit /* r0 */) {
    // References
    // -> static void (* const edge_emit_table[6])(struct activity_data &, unsigned char);
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C02F34
// Range: 0x801CA8F4 -> 0x801CA994
// this: r31
void zParticleLocator::update(float dt /* f31 */) {
    // References
    // -> static char __FUNCTION__[7];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C02F3C
// Range: 0x801CA994 -> 0x801CAA94
// this: r29
void zParticleLocator::make_locations(void * data /* r24 */, int stride /* r30 */, int elements /* r23 */, int loc_offset /* r31 */) {
    // Local variables
    const struct xMat4x3 & amat; // r28
    void (* const get_offset)(struct xVec3 &, struct volume_data &); // r27
    struct volume_data & volume; // r26
    unsigned char * p; // r25
    unsigned char * endp; // r24
    struct xVec3 & loc; // r23
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C02F4C
// Range: 0x801CAA94 -> 0x801CAB14
// this: r31
...
// Range: 0x801CAB14 -> 0x801CABE0
// this: r0
void zParticleLocator::get_center(struct xVec3 & center /* r31 */) const {
    // Local variables
    const struct xMat4x3 & mat; // r6
    float hlen; // f2
}

// Range: 0x801CABE0 -> 0x801CAD28
// this: r30
void zParticleLocator::get_bounding_sphere(struct xSphere & sphere /* r31 */) const {
    // Local variables
    const struct xMat4x3 & mat; // r5
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02F58
// Range: 0x801CAD28 -> 0x801CAE18
// this: r0
float zParticleLocator::get_height() const {
    // Local variables
    const struct xMat4x3 & mat; // r3
    float yend; // f1
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C02F64
// Range: 0x801CAE18 -> 0x801CAFA4
// this: r31
...
char __FUNCTION__$localstatic1$SkinXformVertAndNormal__FP5xVec3P5xVec3PC5xVec3PC5xVec3PC7xMat4x3PC7xMat4x3PCfPCUiPCUsUi[23]; // size: 0x17, address: 0x80C02F70
// total size: 0x0
struct RpSkin {};
// Range: 0x801CAFA4 -> 0x801CB0FC
void eval_tri(struct xVec3 * vert /* r26 */, struct xVec3 * norm /* r27 */, const struct xMat4x3 * mat /* r28 */, const struct RpGeometry * geom /* r24 */, const struct RpTriangle * tri /* r29 */) {
    // Local variables
    const struct RpSkin * skin; // r25
    const struct RpMorphTarget * mt; // r4
    const struct xVec3 * in_vert; // r31
    const struct xVec3 * in_norm; // r30
    const struct xMat4x3 * skinmat; // r24
    const float * vert_bone_weight; // r25
    const unsigned int * vert_bone_index; // r10
}

// Range: 0x801CB0FC -> 0x801CB374
void SkinXformVertAndNormal(struct xVec3 * vert /* r30 */, struct xVec3 * norm /* r31 */, const struct xVec3 * in_vert /* r1+0x8 */, const struct xVec3 * in_norm /* r1+0xC */, const struct xMat4x3 * mat /* r23 */, const struct xMat4x3 * skinmat /* r15 */, const float * wt /* r14 */, const unsigned int * idx /* r1+0x10 */, const unsigned short * vert_index /* r16 */, unsigned int count /* r17 */) {
    // Local variables
    unsigned int catMatFlags[2]; // r1+0x14
    struct xMat4x3 * catmat; // r24
    const struct xMat4x3 * rootmat; // r23
    unsigned short i; // r3
    const struct xVec3 * cur_in_vert; // r22
    const struct xVec3 * cur_in_norm; // r21
    unsigned int cur_idx; // r20
    const float * cur_wt; // r19
    unsigned int i; // r18
    unsigned int midx; // r3
    const struct xMat4x3 * pMatrix; // r0
    const float * fwt; // r18
    unsigned int wtidx; // r26
    unsigned int maxwt; // r27
    struct xVec3 accumV; // r1+0x34
    struct xVec3 v; // r1+0x28
    struct xVec3 v; // r1+0x1C
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02F88
// Range: 0x801CB4DC -> 0x801CB600
void random_surface_point(struct xVec3 & loc /* r30 */, struct xVec3 & norm /* r31 */, const struct popper_data & popper /* r28 */) {
    // Local variables
    const struct xMat4x3 * mat; // r29
    int which; // r3
    struct RpGeometry * geom; // r6
    struct RpAtomic * const * atomic; // r5
    struct RpAtomic * const * end; // r0
    int size; // r4
    struct xVec3 v[3]; // r1+0x2C
    struct xVec3 n[3]; // r1+0x8
...
// Range: 0x801CB600 -> 0x801CB730
// this: r0
static int popper_data::find_weight(float v /* f0 */) const {
    // Local variables
    int start; // r31
    int end; // r6
    int index; // r3
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C02FA0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1541zParticleLocator_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801CB730 -> 0x801CB8DC
unsigned char setup_popper_emitter(struct popper_data & popper /* r29 */) {
    // Local variables
    float * weight; // r31
    struct xModelInstance * model; // r30
    struct RpGeometry * geom; // r4
    const struct xVec3 * vert; // r28
    const struct RpTriangle * tri; // r27
    float * end; // r26
...
// Range: 0x801CB8DC -> 0x801CB908
int count_faces(struct xModelInstance * model /* r3 */) {
    // Local variables
    int total; // r5
}

// Range: 0x801CB908 -> 0x801CB9F4
float get_triangle_area(const struct xVec3 & a /* r0 */, const struct xVec3 & b /* r0 */, const struct xVec3 & c /* r0 */) {
    // Local variables
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FB8
// Range: 0x801CB9F4 -> 0x801CBABC
...
// Range: 0x801CBABC -> 0x801CBAF0
struct popper_data * find_popper(struct xEnt * ent /* r0 */) {
    // Local variables
    struct popper_data * it; // r4
    struct popper_data * end; // r5

    // References
    // -> static struct popper_data * poppers;
}

// Range: 0x801CBAF0 -> 0x801CBB44
struct popper_data * find_free_popper(int facesNeeded /* r0 */) {
    // Local variables
    struct popper_data * found; // r5
    struct popper_data * it; // r4
    struct popper_data * end; // r6
...
static struct tweak_callback cb_tweaked; // size: 0x28, address: 0x803EB118
static struct tweak_callback cb_tweaked_degrees; // size: 0x28, address: 0x803EB140
// total size: 0xC
struct range_type {
    // Members
...
static struct range_type attach_range[3]; // size: 0x24, address: 0x803EB168
static struct range_type motion_range[2]; // size: 0x18, address: 0x80C0CFFC
static struct range_type volume_range[6]; // size: 0x48, address: 0x803EB18C
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FC4
// Range: 0x801CBB44 -> 0x801CBBFC
static void copy_attach(struct debug_info & debug /* r29 */, const struct zParticleAsset & asset /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type attach_range[3];
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FD0
// Range: 0x801CBBFC -> 0x801CBCB4
static void copy_attach(struct zParticleAsset & asset /* r29 */, const struct debug_info & debug /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type attach_range[3];
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FDC
// Range: 0x801CBCB4 -> 0x801CBD68
static void copy_motion(struct debug_info & debug /* r29 */, const struct zParticleAsset & asset /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type motion_range[2];
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FE8
// Range: 0x801CBD68 -> 0x801CBE1C
static void copy_motion(struct zParticleAsset & asset /* r29 */, const struct debug_info & debug /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type motion_range[2];
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C02FF4
// Range: 0x801CBE1C -> 0x801CBED4
static void copy_volume(struct debug_info & debug /* r29 */, const struct zParticleAsset & asset /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type volume_range[6];
    // -> static char __FUNCTION__[12];
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03000
// Range: 0x801CBED4 -> 0x801CBF8C
static void copy_volume(struct zParticleAsset & asset /* r29 */, const struct debug_info & debug /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type volume_range[6];
    // -> static char __FUNCTION__[12];
}

static char * attach_labels[3]; // size: 0xC, address: 0x80C0300C
static char * motion_labels[2]; // size: 0x8, address: 0x80C03018
static char * volume_labels[6]; // size: 0x18, address: 0x80C03020
// Range: 0x801CBF8C -> 0x801CC300
// this: r29
void zParticleLocator::add_tweaks(const char * prefix /* r30 */, struct zParticleAsset & asset /* r31 */, struct xEnt * attach_to /* r28 */) {
    // References
...
// Range: 0x801CC300 -> 0x801CC590
// this: r28
void zParticleLocator::debug_render() {
    // Local variables
    const struct xMat4x3 & amat; // r31
    const struct xVec3 & ref; // r30
    const struct xVec3 & center; // r29
    float radius; // f31
    struct xVec3 end; // r1+0x28
    const struct volume_line_data & line; // r0
    const struct xVec3 & start; // r29
...
// total size: 0x890
struct /* @class$2003zParticleLocator_cpp */ {
    // Static members
...
static struct attach_fixed_data default_attach_fixed; // size: 0x1, address: 0x80C0D020
// total size: 0x8
...
static struct attach_entity_data default_attach_entity; // size: 0x8, address: 0x80C0D024
// total size: 0x10
...
static struct attach_entity_tag_data default_attach_entity_tag; // size: 0x10, address: 0x80C0D02C
// total size: 0x1
struct motion_none_data {};
static struct motion_none_data default_motion_none; // size: 0x1, address: 0x80C0D03C
// total size: 0x14
...
static struct motion_spiral_data default_motion_spiral; // size: 0x14, address: 0x80C0D040
// total size: 0x1
struct volume_point_data {};
static struct volume_point_data default_volume_point; // size: 0x1, address: 0x80C0D054
// total size: 0x4
struct volume_sphere_data {
    // Members
    float radius; // offset 0x0, size 0x4
};
static struct volume_sphere_data default_volume_sphere; // size: 0x4, address: 0x80C0D058
// total size: 0xC
...
static struct volume_circle_data default_volume_circle; // size: 0xC, address: 0x80C0D05C
// total size: 0xC
...
static struct volume_line_data default_volume_line; // size: 0xC, address: 0x80C0D068
// total size: 0x8
...
static struct volume_model_data default_volume_model; // size: 0x8, address: 0x80C0D074
// total size: 0xC
struct volume_box_data {
    // Members
    struct xVec3 dimensions; // offset 0x0, size 0xC
};
static struct volume_box_data default_volume_box; // size: 0xC, address: 0x80C0D07C
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03038
// Range: 0x801CC590 -> 0x801CC6CC
// this: r31
...
// total size: 0xC
struct /* @class$1021zParticleLocator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1022zParticleLocator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1023zParticleLocator_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1024zParticleLocator_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025zParticleLocator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026zParticleLocator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027zParticleLocator_cpp */ {
    // Members
...
// Range: 0x801CC8A8 -> 0x801CC8CC
void zParticleLocator::on_tweaked(const struct tweak_info & info /* r3 */) {}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03044
// total size: 0x8
struct /* @class$2096zParticleLocator_cpp */ {
    // Members
    float ang_delta; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$2097zParticleLocator_cpp */ {
    // Members
    float length; // offset 0x0, size 0x4
    unsigned int cap_weight; // offset 0x4, size 0x4
};
// total size: 0x48
struct /* @class$2098zParticleLocator_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2099zParticleLocator_cpp */ {
    // Members
    struct popper_data * popper; // offset 0x0, size 0x4
};
// total size: 0x18
struct /* @class$2100zParticleLocator_cpp */ {
    // Members
...
// total size: 0x50
struct /* @class$2102zParticleLocator_cpp */ {
    // Members
    struct xMat4x3 mat; // offset 0x0, size 0x40
...
void zParticleLocator::refresh_attach_tweaks() {
    ...
    unsigned int ents; // r3
    struct attach_entity_data & d; // r30
    struct attach_entity_tag_data & d; // r30
...
// Range: 0x801CCBD8 -> 0x801CCDDC
// this: r30
void zParticleLocator::refresh_motion_tweaks() {
    // Local variables
    char prefix[128]; // r1+0x10
    struct motion_spiral_data & d; // r31

    // References
    // -> static struct tweak_callback cb_tweaked;
}

enum /* @enum$1479zParticleLocator_cpp */ {
    FLAG_REVERSE_REPEAT = 1,
};
// Range: 0x801CCDDC -> 0x801CD1CC
// this: r31
void zParticleLocator::refresh_volume_tweaks() {
    // Local variables
    char prefix[128]; // r1+0x8
    struct volume_circle_data & d; // r30
    struct volume_line_data & d; // r30
...
enum /* @enum$1483zParticleLocator_cpp */ {
    FLAG_SURFACE = 1,
};
enum /* @enum$1482zParticleLocator_cpp */ {
    FLAG_CYLINDRICAL = 1,
};
