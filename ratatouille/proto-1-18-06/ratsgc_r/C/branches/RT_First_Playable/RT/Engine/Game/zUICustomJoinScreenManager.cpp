/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomJoinScreenManager.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021518C -> 0x80215724
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04170
// Range: 0x8021518C -> 0x80215290
static void zSystemEventCB(unsigned int toEvent /* r0 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static unsigned char bJoinDropActionConfirmed; // size: 0x1, address: 0x80C08EDC
// total size: 0x54
struct {} zUICustomJoinScreenManager::__vtable; // size: 0x54, address: 0x8043F2C8
// total size: 0x14
...
// Range: 0x80215290 -> 0x802152DC
// this: r31
zUICustomJoinScreenManager::zUICustomJoinScreenManager(class zUI * ui /* r0 */) {
    // References
...
// total size: 0x2
struct /* @class$2040zUICustomJoinScreenManager_cpp */ {
    // Members
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C04180
...
// Range: 0x802152DC -> 0x802155C4
// this: r30
unsigned char zUICustomJoinScreenManager::HandleEvent(struct xBase * from /* r31 */, unsigned int toEvent /* r0 */) {
    // Local variables
    int port; // r30
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0418C
// Range: 0x802155C4 -> 0x80215724
// this: r31
