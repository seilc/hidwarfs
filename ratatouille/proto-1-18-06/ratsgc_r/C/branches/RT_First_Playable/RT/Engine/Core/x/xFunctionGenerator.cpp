/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xFunctionGenerator.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801DF36C -> 0x801DFF6C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1123xFunctionGenerator_cpp */ {
    // Members
...
union /* @class$1262xFunctionGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$1261xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$930xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932xFunctionGenerator_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933xFunctionGenerator_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934xFunctionGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935xFunctionGenerator_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936xFunctionGenerator_cpp */ {
    // Members
...
// Range: 0x801DF398 -> 0x801DF3FC
static void FunctionGeneratorExpandTweaks(const struct tweak_info & info /* r0 */) {
    // Local variables
...
// Range: 0x801DF3FC -> 0x801DF444
static void FunctionGeneratorStartTweak(const struct tweak_info & info /* r0 */) {
    // Local variables
    class xFunctionGenerator * fg; // r31
}

// Range: 0x801DF444 -> 0x801DF468
static void FunctionGeneratorStopTweak(const struct tweak_info & info /* r3 */) {}
...
static struct tweak_callback cb; // size: 0x28, address: 0x8043E5E8
static signed char init; // size: 0x1, address: 0x80C08CC0
// Range: 0x801DF468 -> 0x801DF59C
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C033E0
// Range: 0x801DF59C -> 0x801DF8B8
// this: r31
...
// Range: 0x801DF8B8 -> 0x801DF980
// this: r3
void xFunctionGenerator::HandleEvent(unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {}

// Range: 0x801DF980 -> 0x801DF9C0
// this: r0
void xFunctionGenerator::Start() {}

// Range: 0x801DF9C0 -> 0x801DF9CC
// this: r0
void xFunctionGenerator::Stop() {}

// Range: 0x801DF9CC -> 0x801DF9D8
// this: r0
void xFunctionGenerator::Reset() {}

static struct tweak_callback cb1; // size: 0x28, address: 0x8043E610
static signed char init; // size: 0x1, address: 0x80C08CC1
static struct tweak_callback cb2; // size: 0x28, address: 0x8043E638
static signed char init; // size: 0x1, address: 0x80C08CC2
// Range: 0x801DF9D8 -> 0x801DFF28
// this: r29
void xFunctionGenerator::AddTweaks(const char * base /* r30 */) {
    // Local variables
    char buffer[128]; // r1+0x58
    struct xFunctionGeneratorAsset * ncasset; // r31
