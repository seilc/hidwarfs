/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xModel.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800842F4 -> 0x80087A00
*/
char __FUNCTION__$localstatic1$xMemorySetV32A32__FPvUiUi[17]; // size: 0x11, address: 0x80BFD3D0
char __FUNCTION__$localstatic1$xMemoryCopyUpA32__FPvPCvUi[17]; // size: 0x11, address: 0x80BFD3E4
char __FUNCTION__$localstatic1$xMemoryCopyUpA128__FPvPCvUi[18]; // size: 0x12, address: 0x80BFD3F8
char __FUNCTION__$localstatic1$xMemoryCopyDownA128__FPvPCvUi[20]; // size: 0x14, address: 0x80BFD40C
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int poolSize[101]; // size: 0x194, address: 0x80A83D50
unsigned int poolUsed[101]; // size: 0x194, address: 0x80A83EE4
// total size: 0x8
struct RwObject {
    // Members
...
static struct xModelPool * sxModelPoolList; // size: 0x4, address: 0x80C07480
...
static struct RwCamera * subcamera; // size: 0x4, address: 0x80C07484
int xModelPipeNumTables; // size: 0x4, address: 0x80C07488
int xModelPipeCount[16]; // size: 0x40, address: 0x80A84094
// total size: 0x10
...
struct xModelPipeTable * xModelPipeData[16]; // size: 0x40, address: 0x80A840D4
...
int xModelBucketEnabled; // size: 0x4, address: 0x80C07498
int xModelAlphaBucketEnabled; // size: 0x4, address: 0x80BFD420
// total size: 0x8
struct xModelPipe {
    // Members
    unsigned int Flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD42C
// Range: 0x800843A4 -> 0x80084430
void xModelInitOnce() {
    // References
...
// Range: 0x80084430 -> 0x80084688
void xModelPoolInit(unsigned int count /* r30 */, unsigned int numMatrices /* r31 */) {
    // Local variables
    int i; // r5
    unsigned char * buffer; // r3
    struct RwMatrixTag * mat; // r6
    struct xModelPool * pool; // r0
    struct xModelPool * curr; // r4
    struct xModelPool * * prev; // r6
    struct xModelInstance * inst; // r7
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x804190B8
// Range: 0x80084688 -> 0x80084AE8
...
// Range: 0x80084B88 -> 0x80084BB8
static struct xModelInstance * FindChild(struct xModelInstance * inst /* r0 */) {
    // Local variables
    struct xModelInstance * curr; // r4
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFD43C
// Range: 0x80084BB8 -> 0x80084DE4
void xModelInstanceFreeDebug(struct xModelInstance * modelInst /* r27 */, unsigned char animFree /* r28 */, const char * file /* r29 */, int line /* r30 */, const char * function /* r31 */) {
    // Local variables
    struct xModelInstance * child; // r3
    struct xModelInstance * curr; // r29
    struct xModelInstance * * prev; // r30
...
// Range: 0x80084E30 -> 0x80084F28
void xModelUpdate(struct xModelInstance * modelInst /* r29 */, float timeDelta /* f31 */) {
    // Local variables
    long long t0; // r0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD454
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x80084F28 -> 0x80085290
void xModelEvalSingle(struct xModelInstance * modelInst /* r27 */, struct xBox * combinedAnimBound /* r28 */) {
    // Local variables
    int i; // r29
...
// Range: 0x80085290 -> 0x80085330
void xModelEval(struct xModelInstance * modelInst /* r28 */) {
    // Local variables
    long long t0; // r0
    struct xBox * combinedAnimBound; // r29
...
unsigned int xModel_LastModelID; // size: 0x4, address: 0x80C074A0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
struct xEnt * render_log_entity; // size: 0x4, address: 0x80C074A8
unsigned char render_log_enabled; // size: 0x1, address: 0x80C074A4
// Range: 0x80085624 -> 0x800856C8
void xModelRender(struct xModelInstance * modelInst /* r29 */) {
    // Local variables
    long long t0; // r0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD468
// Range: 0x800856C8 -> 0x80085984
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD478
// Range: 0x80085AF0 -> 0x80085B70
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD48C
// Range: 0x80085B70 -> 0x80085BF4
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFD4A0
// Range: 0x80085BF4 -> 0x80085CB4
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFD4B4
// Range: 0x80085CB4 -> 0x80085E38
void xModelAnimCollRefresh(const struct xModelInstance & cm /* r31 */) {
    // Local variables
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80BFD4CC
// Range: 0x80085E38 -> 0x80085EFC
void xModelGetBoneLocation(struct xVec3 & loc /* r29 */, const struct xModelInstance & model /* r30 */, unsigned long index /* r31 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD4E4
// Range: 0x80085EFC -> 0x80085FBC
void xModelGetBoneMat(struct xMat4x3 & mat /* r29 */, const struct xModelInstance & model /* r30 */, unsigned long index /* r31 */) {
    // Local variables
...
static char __FUNCTION__[28]; // size: 0x1C, address: 0x804190D4
// Range: 0x80085FBC -> 0x800860D8
...
// Range: 0x800860D8 -> 0x8008611C
int xModelSphereCull(struct xSphere * sphere /* r3 */) {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x8008611C -> 0x80086298
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFD4F8
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFD508
// Range: 0x800864E0 -> 0x80086868
int xModelBoxCullPlusShadow(struct xBox * box /* r0 */, struct xVec3 * shadowVec /* r29 */, int * shadowOutside /* r30 */) {
    // Local variables
    const struct RwFrustumPlane * frustumPlane; // r3
    int numPlanes; // r4
    struct RwCamera * camera; // r31
...
int BoxEnable; // size: 0x4, address: 0x80BFD520
// Range: 0x80086868 -> 0x800868C0
int xModelCullGroup(struct xModelInstance * minst /* r4 */) {
    // References
    // -> int BoxEnable;
}

// Range: 0x800868C0 -> 0x80086998
...
// Range: 0x80086AB0 -> 0x80086BE4
unsigned char xModelGetPipe(unsigned int modelID /* r28 */, unsigned int atomicNumber /* r0 */, struct xModelPipe * * pipe /* r29 */) {
    // Local variables
    int j; // r30
    int k; // r23
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFD524
// total size: 0x14
...
// Range: 0x80086BE4 -> 0x80086CC4
static struct RpAtomic * find_first_atomic(struct xModelAssetInfo * minf /* r30 */) {
    // Local variables
...
unsigned char render_log_enabled; // size: 0x1, address: 0x80C074A4
struct xEnt * render_log_entity; // size: 0x4, address: 0x80C074A8
static const char * render_log_output_file; // size: 0x4, address: 0x80BFD538
static unsigned char render_log_output_to_file; // size: 0x1, address: 0x80BFD53C
// total size: 0x10C
...
static struct render_log_entry * render_log; // size: 0x4, address: 0x80C074AC
static int render_log_size; // size: 0x4, address: 0x80C074B0
static int render_log_sort_by; // size: 0x4, address: 0x80C074B4
// total size: 0xC
...
// Range: 0x80086D9C -> 0x80086DF4
static int compare_log_text(void * e1 /* r30 */, void * e2 /* r31 */) {
    // Local variables
    const struct render_output_entry & r1; // r0
    const struct render_output_entry & r2; // r0
    int c0; // r3
}

// Range: 0x80086DF4 -> 0x80086F28
static char * print_spaced(char * out /* r25 */, const char * s0 /* r26 */, int min_len0 /* r27 */, const char * s1 /* r28 */, int min_len1 /* r29 */) {
    // Local variables
    int len0; // r0
    int len1; // r0
}
...
// Range: 0x80086F28 -> 0x80087620
static void dump_log(class log_stream & os /* r29 */) {
    // Local variables
    struct render_output_entry * output_entry_buffer; // r31
    struct render_output_entry * output_entries; // r30
    int i; // r5
    int i; // r5
    int i; // r5
    ...
    int len0; // r3
    int len1; // r3
    const struct render_output_entry & entry; // r0
    char * end; // r21
    int i; // r22
    char * end; // r23
...
// total size: 0x1
struct /* @class$1024xModel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1025xModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1026xModel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1027xModel_cpp */ {
    // Members
...
// Range: 0x80087620 -> 0x80087640
static void on_dump_log(const struct tweak_info & info /* r0 */) {
    // References
    // -> unsigned char render_log_enabled;
    // -> static unsigned char render_log_output_to_file;
}

static char * sort_by_labels[3]; // size: 0xC, address: 0x80BFD540
// total size: 0x28
...
static struct tweak_callback cb_dump_log; // size: 0x28, address: 0x803B20C0
// Range: 0x80087640 -> 0x80087714
...
enum /* @enum$3293xModel_cpp */ {
    RL_SORT_NONE = 0,
    RL_SORT_MODEL = 1,
    RL_SORT_ENTITY = 2,
    MAX_RL_SORT = 3,
};
// Range: 0x80087714 -> 0x8008772C
...
struct {} @unnamed@xModel_cpp@::file_log_stream::__vtable; // size: 0xC, address: 0x80BFD54C
// Range: 0x800877F4 -> 0x8008783C
// this: r30
...
// Range: 0x8008783C -> 0x8008794C
void xModelRenderLogAdd(struct RpAtomic * model /* r29 */, unsigned char cloned /* r30 */) {
    // Local variables
    struct render_log_entry & entry; // r31
    const char * model_name; // r4
    struct RpGeometry * geom; // r3
...
// Range: 0x8008798C -> 0x800879D8
// this: r30
static void file_log_stream::write(const char * text /* r31 */) {}

static // total size: 0xC
struct {} @unnamed@xModel_cpp@::log_stream::__vtable; // size: 0xC, address: 0x80BFD558
static // total size: 0xC
struct {} @unnamed@xModel_cpp@::print_log_stream::__vtable; // size: 0xC, address: 0x80BFD564
// Range: 0x800879D8 -> 0x80087A00
static void print_log_stream::write(const char * text /* r4 */) {}
