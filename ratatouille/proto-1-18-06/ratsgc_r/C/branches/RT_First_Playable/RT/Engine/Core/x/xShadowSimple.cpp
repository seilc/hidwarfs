/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xShadowSimple.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800BBB64 -> 0x800BD26C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1085xShadowSimple_cpp */ {
    // Members
...
union /* @class$820xShadowSimple_cpp */ {
...
// total size: 0xC
struct /* @class$1232xShadowSimple_cpp */ {
    // Members
...
static struct xShadowSimpleQueue sCollQueue[2]; // size: 0x38, address: 0x80A975C0
static struct xMat4x3 sCollModelMatrices[2]; // size: 0x80, address: 0x80A97600
enum RwShadeMode {
...
static struct RxRenderStateVector xrsv; // size: 0x2C, address: 0x80A97680
// total size: 0x24
...
static struct RxObjSpace3DVertex sShadVert[384]; // size: 0x3600, address: 0x80A976AC
static struct RwRaster * sShadRasters[64]; // size: 0x100, address: 0x80A9ACAC
static struct RwRaster * sShadRaster; // size: 0x4, address: 0x80C077E0
static unsigned int sShadVertCount; // size: 0x4, address: 0x80C077E4
static struct RwMatrixTag * sModelMat; // size: 0x4, address: 0x80C077E8
// total size: 0x28
...
// Range: 0x800BBB64 -> 0x800BBC48
static struct RpCollisionTriangle * shadowRayCB(struct RpCollisionTriangle * tri /* r29 */, float dist /* f31 */, void * data /* r30 */) {
    // Local variables
    struct xVec3 xformnorm; // r1+0x8
    struct xVec3 * norm; // r3
    float * testdist; // r31
    struct xShadowSimpleCache * cache; // r0

    // References
    // -> static struct RwMatrixTag * sModelMat;
}

// Range: 0x800BBC48 -> 0x800BBC74
static struct RpCollisionTriangle * shadowRayModelCB(struct RpIntersection * isx /* r0 */, struct RpCollisionTriangle * tri /* r4 */, float dist /* f0 */, void * data /* r6 */) {}

// Range: 0x800BBC74 -> 0x800BBD7C
static int shadowRayEntCB(struct xEnt * ent /* r29 */, void * cbdata /* r30 */) {
    // Local variables
    struct ShadowSimpleCBParam * cbparam; // r0
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8042E1A8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x800BBD7C -> 0x800BBFC0
static void xShadowSimple_SceneCollide(struct xShadowSimpleCache * cache /* r31 */, const struct xVec3 * pos /* r27 */, float depth /* f31 */) {
    // Local variables
    struct xEnv * env; // r28
    struct RpIntersection isx; // r1+0x30
    int i; // r27
    struct ShadowSimpleCBParam cbparam; // r1+0x8
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8042E1C4
// Range: 0x800BBFC0 -> 0x800BC264
static void xShadowSimple_CalcCorners(struct xShadowSimpleCache * cache /* r30 */, const struct xMat4x3 * mat /* r31 */, float radius /* f30 */, float ecc /* f31 */) {
    // Local variables
...
// Range: 0x800BC264 -> 0x800BC3CC
static void xShadowSimple_AddVerts(struct xShadowSimpleCache * cache /* r0 */) {
    // References
...
static char __FUNCTION__[19]; // size: 0x13, address: 0x80BFE678
// Range: 0x800BC3CC -> 0x800BC578
...
static char __FUNCTION__[24]; // size: 0x18, address: 0x80BFE68C
// total size: 0x4
struct zSimpleShadowTableHeader {
    // Members
    unsigned int num; // offset 0x0, size 0x4
};
// Range: 0x800BC5BC -> 0x800BC774
void xShadowSimple_CacheInit(struct xShadowSimpleCache * cache /* r24 */, struct xEnt * ent /* r25 */, unsigned char alpha /* r20 */) {
    // Local variables
    int i; // r28
    int n; // r0
    unsigned int j; // r20
    struct zSimpleShadowTableHeader * sst; // r0
...
// Range: 0x800BC774 -> 0x800BC7DC
void xShadowSimple_CacheInit(struct xShadowSimpleCache * cache /* r30 */, unsigned char alpha /* r31 */) {
    // References
    // -> static struct RwRaster * sShadRaster;
}

// Range: 0x800BC7DC -> 0x800BC814
void xShadowSimple_Add(struct xShadowSimpleCache * cache /* r0 */, struct xEnt * ent /* r0 */, float radius /* f0 */, float ecc /* f2 */) {}

// Range: 0x800BC814 -> 0x800BC844
void xShadowSimple_Add(struct xShadowSimpleCache * cache /* r0 */, struct xMat4x3 * entMat /* r0 */, float radius /* f0 */, float ecc /* f3 */) {}

// Range: 0x800BC844 -> 0x800BC9F4
void xShadowSimple_Render() {
    // Local variables
    int qnum; // r31
    unsigned int i; // r28
    unsigned int j; // r27
    struct RwRaster * raster; // r4
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8042E1E0
// Range: 0x800BC9F4 -> 0x800BCD40
void xShadowSimple_Add_Expert(struct xShadowSimpleCache * cache /* r29 */, const struct xMat4x3 * mat_owner /* r30 */, unsigned char alpha /* r28 */, float radius /* f29 */, float height /* f30 */, float ecc /* f31 */, unsigned char copyMat /* r31 */) {
    // Local variables
    unsigned int ownerMoved; // r28
...
// Range: 0x800BCFC4 -> 0x800BD26C
void XSSC_Add_NudgeItAndFudgeIt(struct xShadowSimpleCache * cache /* r30 */, const struct xMat4x3 * mat_owner /* r31 */) {
    // Local variables
    struct xVec3 * vert; // r5
