/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xSpacePartitionTree.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800C33A4 -> 0x800C60AC
*/
static unsigned char render_intersect; // size: 0x1, address: 0x80C07820
static unsigned char render_empty; // size: 0x1, address: 0x80C07821
static int cast_player_point; // size: 0x4, address: 0x80C07824
static int cast_player_sphere; // size: 0x4, address: 0x80C07828
static int cast_player_line; // size: 0x4, address: 0x80C0782C
static float cast_line_length; // size: 0x4, address: 0x80BFE8B8
static unsigned char validate; // size: 0x1, address: 0x80C07830
static unsigned char added; // size: 0x1, address: 0x80C07831
static signed char init; // size: 0x1, address: 0x80C07832
// Range: 0x800C33A4 -> 0x800C355C
...
// total size: 0xC
struct /* @class$1038xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041xSpacePartitionTree_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042xSpacePartitionTree_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043xSpacePartitionTree_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044xSpacePartitionTree_cpp */ {
    // Members
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80BFE8BC
union entry_data {
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFE8C4
// Range: 0x800C3B14 -> 0x800C3C30
// this: r0
void xSpacePartitionTree2D::create_cell(union cell & c /* r31 */, unsigned short parent /* r0 */, int cid /* r29 */) {
    // Local variables
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE8D0
// Range: 0x800C3C30 -> 0x800C3D34
// this: r26
void xSpacePartitionTree2D::create_children(union cell & c /* r27 */) {
    // Local variables
    union cell * const cell_list; // r30
    union cell * cc; // r29
    union cell * end_cc; // r28
    unsigned short parent; // r25

    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x800C3D34 -> 0x800C3D68
// this: r0
...
static unsigned char done; // size: 0x1, address: 0x80C07833
static signed char init; // size: 0x1, address: 0x80C07834
static char __FUNCTION__[5]; // size: 0x5, address: 0x80BFE8E0
// total size: 0x8
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE8E8
// Range: 0x800C3E80 -> 0x800C4330
// this: r26
void xSpacePartitionTree2D::insert_internal(union entry_data * e /* r27 */, float x0 /* f28 */, float y0 /* f29 */, float x1 /* f30 */, float y1 /* f31 */, float width /* f25 */) {
    // Local variables
    float scale; // f8
    int end_depth; // r25
    int gy; // r24
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFE8F8
// total size: 0x10
struct /* @class$2452xSpacePartitionTree_cpp */ {
    // Members
...
// Range: 0x800C4330 -> 0x800C4738
// this: r20
void xSpacePartitionTree2D::insert_internal(union entry_data * e /* r21 */, union cell * c /* r22 */, int end_depth /* r23 */, float x0 /* f19 */, float y0 /* f20 */, float x1 /* f21 */, float y1 /* f22 */) {
    // Local variables
    int index; // r27
    float dxy; // f2
    float cx0; // f30
    ...
    union entry_data * const entry_list; // r0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE908
// Range: 0x800C4738 -> 0x800C4B1C
// this: r22
void xSpacePartitionTree2D::erase_internal(union entry_data * e /* r23 */) {
    // Local variables
    int i; // r25
    int i; // r26
    union cell * const cell_list; // r31
    union entry_node * const node_list; // r30
    unsigned short * owner; // r29
    unsigned short * end_owner; // r28
    union cell * c; // r27
    union entry_node * prev; // r26
    union entry_node * n; // r25
    unsigned short key; // r24

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFE918
// Range: 0x800C4B1C -> 0x800C4C14
// this: r31
...
// Range: 0x800C4C14 -> 0x800C4D80
// this: r0
int xSpacePartitionTree2D::get_cell_bound(const union cell * c /* r4 */, float & x /* r0 */, float & y /* r0 */, float & r /* r0 */) const {
    // Local variables
    union cell * const cell_list; // r11
    int depth; // r8
    int iy; // r10
    int grid_index; // r9
    int gx; // r0
...
// Range: 0x800C4D80 -> 0x800C4FE0
// this: r0
unsigned char xSpacePartitionTree2D::clip_line(float & x0 /* r0 */, float & y0 /* r0 */, float & x1 /* r0 */, float & y1 /* r0 */) const {
    // Local variables
    float _c; // f1
    float _c; // f1
}

// Range: 0x800C4FE0 -> 0x800C53CC
// this: r18
unsigned char xSpacePartitionTree2D::intersect_line_setup(float x0 /* r1+0x8 */, float y0 /* r1+0xC */, float x1 /* r1+0x10 */, float y1 /* r1+0x14 */, int & ix /* r19 */, int & iy /* r20 */, int & dix /* r21 */, int & diy /* r22 */, int & end_ix /* r23 */, int & end_iy /* r24 */, int & a /* r25 */, float & tx0 /* r26 */, float & ty0 /* r27 */, float & tx1 /* r28 */, float & ty1 /* r29 */, float & dtx /* r30 */, float & dty /* r31 */) {
    // Local variables
    float dx; // f0
    float dy; // f1
    float idx; // f2
...
// total size: 0x4
struct /* @class$1097xSpacePartitionTree_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235xSpacePartitionTree_cpp */ {
    // Members
...
union /* @class$1236xSpacePartitionTree_cpp */ {
...
// total size: 0x10
struct /* @class$1649xSpacePartitionTree_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
void xSpacePartitionTree2D::debug_update() {
    ...
    int i; // r29
    const struct xSphere & player_bound; // r0
    int i; // r28
    const struct xVec3 & player_loc; // r0
    const struct xVec3 & player_dir; // r5
...
// total size: 0x890
struct /* @class$2092xSpacePartitionTree_cpp */ {
    // Static members
...
// Range: 0x800C5588 -> 0x800C5590
// this: r0
cb_test_intersect::cb_test_intersect(int & count /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE928
// Range: 0x800C5590 -> 0x800C59A0
// this: r30
void xSpacePartitionTree2D::debug_validate() const {
    // Local variables
    int gy; // r28
    int gx; // r27
    const union cell * c; // r26
    union entry_data * e; // r26
    int i; // r27
    union entry_data * ende; // r30
    int i; // r26
    int i; // r26
    int i; // r26
...
// Range: 0x800C59A0 -> 0x800C5A5C
// this: r28
unsigned char xSpacePartitionTree2D::any_layer_empty(const union cell * c /* r0 */) const {
    // Local variables
    int total; // r31
    const union cell * cc; // r30
    const union cell * end_cc; // r29
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFE938
// Range: 0x800C5A5C -> 0x800C5EA0
// this: r24
void xSpacePartitionTree2D::debug_validate_cell(const union cell * c /* r25 */) const {
    // Local variables
    union cell * const cell_list; // r31
    union entry_node * const node_list; // r30
    union entry_data * const entry_list; // r29
    unsigned short key; // r28
    unsigned short i; // r5
    union entry_node * const n; // r27
    union entry_data * const e; // r26
    int j; // r21
    int j; // r21
    unsigned short * owner; // r3
    unsigned short * end_owner; // r4

    // References
    // -> static char __FUNCTION__[20];
}

static struct xColor_tag box_colors[8]; // size: 0x20, address: 0x803BB930
// Range: 0x800C5EA0 -> 0x800C5F68
// this: r3
void xSpacePartitionTree2D::debug_intersect_cell(const union cell * c /* r4 */) const {
    // Local variables
    float x; // r1+0x14
    float z; // r1+0x10
    float r; // r1+0xC
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE94C
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE95C
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE96C
// Range: 0x800C5F68 -> 0x800C5F9C
// this: r5
static unsigned char cb_fp_wrapper::operator()(union entry_data * e /* r4 */) const {}

// Range: 0x800C5F9C -> 0x800C6094
// this: r31
static unsigned char cb_accum_wrapper::operator()(union entry_data * e /* r0 */) {
    // Local variables
    char tempString[128]; // r1+0x8
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFE97C
