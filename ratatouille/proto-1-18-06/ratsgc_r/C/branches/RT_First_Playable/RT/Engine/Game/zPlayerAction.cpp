/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPlayerAction.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80208AD8 -> 0x80209A94
*/
// total size: 0xC
class zPlayerAction {
    // Functions
...
// Range: 0x80208AD8 -> 0x80208B34
// this: r11
struct xAnimState * zPlayerAction::NewState(struct xAnimTable * table /* r4 */, const char * name /* r5 */, unsigned int flags /* r6 */, unsigned int userFlags /* r7 */, float speed /* f0 */, float * boneBlend /* r8 */, float * timeSnap /* r9 */, float fadeRecip /* f0 */, unsigned short * fadeOffset /* r10 */, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *) /* r0 */, void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *) /* r3 */, void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int) /* r0 */) {}

// Range: 0x80208B34 -> 0x80208B94
// this: r0
void zPlayerAction::NewStateMany(struct xAnimTable * table /* r4 */, const char * name /* r5 */, int howMany /* r6 */, unsigned int flags /* r7 */, unsigned int userFlags /* r8 */, float speed /* f0 */, float * boneBlend /* r9 */, float * timeSnap /* r10 */, float fadeRecip /* f0 */, unsigned short * fadeOffset /* r11 */, void (* beforeEnter)(struct xAnimPlay *, struct xAnimState *, void *) /* r0 */, void (* stateCallback)(struct xAnimState *, struct xAnimSingle *, void *) /* r3 */, void (* beforeAnimMatrices)(struct xAnimPlay *, struct xQuat *, struct xVec3 *, int) /* r0 */) {}

// Range: 0x80208B94 -> 0x80208BD8
void zPlayerAction::AddActionTransition(struct xAnimTable * table /* r0 */, const char * source /* r0 */, const char * dest /* r0 */, unsigned int (* condition)(struct xAnimTransition *, struct xAnimSingle *, void *) /* r0 */, unsigned short priority /* r10 */, float blend /* f3 */, unsigned int flags /* r0 */, unsigned int userFlags /* r0 */) {}

// Range: 0x80208BD8 -> 0x80208C08
unsigned int zPlayerAction::ActionChange(struct xAnimTransition * tran /* r0 */) {
    // Local variables
    class zPlayerAction * nextAction; // r4
}

// Range: 0x80208C08 -> 0x80208C38
// this: r3
void zPlayerAction::Move(struct xScene * s /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r0 */) {}
...
// total size: 0x4
struct /* @class$1097zPlayerAction_cpp */ {
    // Members
...
union /* @class$1236zPlayerAction_cpp */ {
...
// total size: 0xC
struct /* @class$1235zPlayerAction_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1946zPlayerAction_cpp */ {
    // Static members
...
// Range: 0x80208C38 -> 0x80208C68
// this: r3
void zPlayerAction::BeginUpdate(float dt /* f0 */) {}

// Range: 0x80208C68 -> 0x80208C98
// this: r3
void zPlayerAction::Update(float dt /* f0 */) {}

// Range: 0x80208C98 -> 0x80208CC8
// this: r3
void zPlayerAction::EndUpdate(float dt /* f0 */) {}

// Range: 0x80208CC8 -> 0x80208CF8
// this: r3
unsigned char zPlayerAction::CollisionResponse(const struct xVec3 & currentDir /* r0 */, const struct SphereCollisionResults & sceneCollide /* r0 */, struct xVec3 & responseDpos /* r0 */) {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03D28
// total size: 0xC
...
// Range: 0x80208CF8 -> 0x80208DA4
// this: r30
void zPlayerActionManager::SetCurrentAction(class zPlayerAction * newCurrentAction /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x80208DA4 -> 0x80208DE4
// this: r0
unsigned int zPlayerActionManager::GetCurrentActionID() const {}

unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x80208DE4 -> 0x80208E50
// this: r30
void zPlayerActionManager::Init(unsigned int actionCount /* r0 */) {
    // Local variables
    unsigned int listMemSize; // r31

    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[4]; // size: 0x4, address: 0x80C03D3C
// Range: 0x80208E50 -> 0x80208F8C
// this: r30
void zPlayerActionManager::Add(struct zPlayer * player /* r0 */, class zPlayerAction * action /* r31 */) {
    // References
    // -> static char __FUNCTION__[4];
}

static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03D40
// Range: 0x80208F8C -> 0x80209054
// this: r29
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03D48
// Range: 0x80209054 -> 0x80209188
// this: r29
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C03D50
// Range: 0x80209188 -> 0x80209274
// this: r29
...
// Range: 0x80209274 -> 0x802092A4
// this: r3
void zPlayerActionManager::Update(float dt /* f0 */) {}

// Range: 0x802092A4 -> 0x802092D4
// this: r3
void zPlayerActionManager::EndUpdate(float dt /* f0 */) {}

// Range: 0x802092D4 -> 0x80209304
// this: r3
void zPlayerActionManager::Move(struct xScene * s /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r0 */) {}

// Range: 0x80209304 -> 0x80209334
// this: r3
void zPlayerActionManager::Render() {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C03D5C
// Range: 0x80209334 -> 0x8020941C
// this: r26
unsigned char zPlayerActionManager::CollisionResponse(const struct xVec3 & currentDir /* r27 */, const struct SphereCollisionResults & sceneCollide /* r28 */, struct xVec3 & responseDpos /* r29 */) {
    // Local variables
    unsigned int i; // r30
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03D70
// Range: 0x8020941C -> 0x802094F0
// this: r28
void zPlayerActionManager::AddStates(struct xAnimTable * table /* r29 */) {
    // Local variables
    unsigned int i; // r30
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03D7C
// Range: 0x802094F0 -> 0x802095E0
// this: r28
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03D8C
// Range: 0x802095E0 -> 0x802096A4
// this: r29
...
static char __FUNCTION__[25]; // size: 0x19, address: 0x8043F128
// Range: 0x802096A4 -> 0x802097A4
// this: r28
void zPlayerActionManager::AddStandardTransitionsTo(unsigned int actionID /* r29 */, struct xAnimTable * table /* r30 */, const char * fromStates /* r31 */) {
    // References
    // -> static char __FUNCTION__[25];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C03D98
// Range: 0x802097A4 -> 0x802098C4
// this: r29
void zPlayerActionManager::AddTransitionsTo(unsigned int actionID /* r24 */, struct xAnimTable * table /* r30 */, const char * fromStates /* r31 */, unsigned short priority /* r25 */, float blend /* f31 */, unsigned int flags /* r26 */, unsigned int userFlags /* r27 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03DAC
// Range: 0x802098C4 -> 0x802099AC
// this: r29
...
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C03DB8
// Range: 0x802099AC -> 0x80209A94
// this: r29
...
// total size: 0x54
struct {} zPlayerAction::__vtable; // size: 0x54, address: 0x8043F144
