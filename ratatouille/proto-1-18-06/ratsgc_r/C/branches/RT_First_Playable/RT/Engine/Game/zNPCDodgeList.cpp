/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCDodgeList.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021139C -> 0x802118B4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float ZNPC_DODGE_LIST_CONE_INTERSECT_ANGLE; // size: 0x4, address: 0x80C04078
float ZNPC_DODGE_LIST_CONE_HEIGHT_SQ_MULTIPLIER; // size: 0x4, address: 0x80C0407C
float ZNPC_DODGE_LIST_FROZONE_ICE_BLAST_RANGE_MULTIPLIER; // size: 0x4, address: 0x80C04080
unsigned char ZNPC_DODGE_LIST_ENABLE_DODGE; // size: 0x1, address: 0x80C04084
unsigned char ZNPC_DODGE_LIST_DRAW_CONE; // size: 0x1, address: 0x80C08E68
// Range: 0x8021139C -> 0x80211440
static float sNPCDodgeListGetCos2BetweenVectors(const struct xVec3 & vec1 /* r29 */, const struct xVec3 & vec2 /* r30 */, float & a2b2 /* r31 */) {
    // Local variables
    float dotVec1Vec2; // f0
    float sqVec1; // f0
    float sqVec2; // f0
}
...
// total size: 0x4
struct /* @class$1088zNPCDodgeList_cpp */ {
    // Members
...
union /* @class$1236zNPCDodgeList_cpp */ {
...
// total size: 0xC
struct /* @class$1235zNPCDodgeList_cpp */ {
    // Members
...
static struct zNPCDodgeListObject * sNPCDodgeListObjects; // size: 0x4, address: 0x80C08E6C
static struct xVec3 * sNPCDodgeListObjectsVelocity; // size: 0x4, address: 0x80C08E70
static struct xVec3 * sNPCDodgeListObjectsVelocityNormalized; // size: 0x4, address: 0x80C08E74
static struct xVec3 * sNPCDodgeListObjectsLocation; // size: 0x4, address: 0x80C08E78
static float sSinAngle; // size: 0x4, address: 0x80C08E7C
static float sCos2Angle; // size: 0x4, address: 0x80C08E80
// Range: 0x80211440 -> 0x80211510
...
// Range: 0x802116AC -> 0x80211894
unsigned int zNPCDodgeListGetDodgeDirection(struct xEnt * ent /* r27 */, struct xVec3 & poi /* r28 */) {
    // Local variables
    int iter; // r29
    struct xVec3 projToNPC; // r1+0x18
    float checkDist2; // f0
    float cos2; // f0
    float a2b2; // r1+0x8
    struct xVec3 sphereIsectConeOrigin; // r1+0xC
...
// Range: 0x80211894 -> 0x802118B0
static float sNPCDodgeListCrossXZ(const struct xVec3 & a /* r0 */, const struct xVec3 & b /* r0 */) {}

// Range: 0x802118B0 -> 0x802118B4
