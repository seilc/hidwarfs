/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zActionLine.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800F4914 -> 0x800F4C10
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct _tagActionLine * sActionLine[8]; // size: 0x20, address: 0x80B86B40
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * sActionLineRaster; // size: 0x4, address: 0x80C07B60
// total size: 0x8
struct RwObject {
    // Members
...
static struct RxObjSpace3DVertex sStripVert[4]; // size: 0x90, address: 0x80B86B60
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFF6D8
// Range: 0x800F4A28 -> 0x800F4BA0
static void RenderActionLine(struct _tagActionLine * l /* r31 */) {
    // Local variables
