/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCam2Player.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021FD44 -> 0x80221CCC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float enable; // size: 0x4, address: 0x80C04398
float mountY; // size: 0x4, address: 0x80C0439C
float thetaRestore; // size: 0x4, address: 0x80C043A0
float phiRestore; // size: 0x4, address: 0x80C043A4
float distRestore; // size: 0x4, address: 0x80C043A8
float maxspeed_theta; // size: 0x4, address: 0x80C043AC
float maxspeed_yaw; // size: 0x4, address: 0x80C043B0
float maxspeed_dist; // size: 0x4, address: 0x80C043B4
unsigned char render; // size: 0x1, address: 0x80C08F48
unsigned char lock_enable; // size: 0x1, address: 0x80C043B8
// Range: 0x8021FD44 -> 0x8021FDE8
...
float cPlayerMarginAngleNormal; // size: 0x4, address: 0x80C043BC
float cPlayerMarginAngleLocking; // size: 0x4, address: 0x80C043C0
float cNearWallMaxPushDistance; // size: 0x4, address: 0x80C043C4
unsigned char lock_yaw_to_theta; // size: 0x1, address: 0x80C08F49
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$964zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zCam2Player_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zCam2Player_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zCam2Player_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zCam2Player_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zCam2Player_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2101zCam2Player_cpp */ {
    // Members
...
// Range: 0x8022002C -> 0x8022004C
void zCam2Player::get_rest_default(struct rest_config & cfg /* r0 */) {}

// Range: 0x8022004C -> 0x802200AC
// this: r31
void zCam2Player::set_secondary_target(const struct xVec3 & targetPos /* r0 */, float radius /* f30 */, float marginAngle /* f31 */) {}

// Range: 0x802200AC -> 0x802200C4
// this: r0
void zCam2Player::set_secondary_target(const struct xEnt & ent /* r0 */, float radius /* f0 */, float marginAngle /* f0 */) {}
...
// Range: 0x80220344 -> 0x802203C8
// this: r31
void zCam2Player::inherit_basis() {
    // Local variables
    const class zCam2Player * srcCam; // r0
}
...
// total size: 0x4
struct /* @class$1097zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zCam2Player_cpp */ {
    // Members
...
union /* @class$1236zCam2Player_cpp */ {
...
// total size: 0x10
struct /* @class$1825zCam2Player_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static int count; // size: 0x4, address: 0x80C08F4C
static signed char init; // size: 0x1, address: 0x80C08F50
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
void zCam2Player::clamp_secondary() {
    ...
    struct xVec3 * center; // r31
    float radius; // f29
    struct xVec3 camToTarget; // r1+0x8
    float xzDistanceCam; // f2
    float arc; // f31
    float dx__; // f29
    float dz__; // f1
    float theta; // f29
    float yawFromOrigin; // f0
    float deltaMax; // f29
    float startYaw; // f31
    float deltaYaw; // f1
    float endYaw; // f30
...
// Range: 0x802206B4 -> 0x80220758
// this: r30
void zCam2Player::update_target_info(float dt /* f31 */) {}

// Range: 0x80220758 -> 0x802207F4
// this: r30
...
// total size: 0x890
struct /* @class$2072zCam2Player_cpp */ {
    // Static members
...
// Range: 0x802207F4 -> 0x80220B94
// this: r28
int zCam2Player::yaw_past_limit(float & pastLimit /* r29 */, float guardBandYaw /* f27 */) {
    // Local variables
    struct xVec3 camPos; // r1+0x38
    float camGoalYaw; // f0
    const struct zPlayer * player0; // r0
    const struct zPlayer * player1; // r0
    struct xVec3 player0Pos; // r1+0x2C
    struct xVec3 camGoalToPlayer0; // r1+0x20
    float player0Arc; // f30
    float toPlayer0Yaw; // f0
    float dYawFromPlayer0; // f29
    struct xVec3 player1Pos; // r1+0x14
    struct xVec3 camGoalToPlayer1; // r1+0x8
    float player1Arc; // f28
    float toPlayer1Yaw; // f0
    float dYawFromPlayer1; // f31
    float dYawMax; // f27
    float dAbsYawFromPlayer0; // f26
    float dAbsYawFromPlayer1; // f25
    float adjustedDYawP0; // f0
    float adjustedDYawP1; // f1
    float dYawMostOut; // f2
    float radiusArcOfMostOut; // f3
    float dYawPastLimit; // f1
...
static int i; // size: 0x4, address: 0x80C08F54
static signed char init; // size: 0x1, address: 0x80C08F58
// Range: 0x80220D04 -> 0x80220EE0
// this: r31
void zCam2Player::clamp_players_nearwall() {
    // Local variables
    float camGoalYaw; // f31
    struct xVec3 camPos; // r1+0x20
    struct xVec3 atXZ; // r1+0x14
    float planarDistance; // f0
    float deltaD; // f31
    const struct xVec3 & origin; // r0
    struct xVec3 camGoalToOriginN; // r1+0x8
    float dot; // f2
    float xzDDistToOrigin; // f31
    float cosPhi; // f0
    float finalDist; // f31
    float finalDDist; // f31
...
float sNearWall; // size: 0x4, address: 0x80C08DD8
// total size: 0x1
...
// Range: 0x80220F48 -> 0x80221040
static void MinPlanarDistanceXZ(float & minDistance /* r28 */, int playerIndex /* r29 */, const struct xVec3 & camPos /* r30 */, const struct xVec3 & atXZ /* r31 */) {
    // Local variables
    const struct xVec3 & playerPos; // r0
...
// Range: 0x80221134 -> 0x80221184
// this: r31
void zCam2Player::update_precollide() {}

// Range: 0x80221184 -> 0x802211F0
// this: r31
void zCam2Player::update_pivot() {}

// Range: 0x802211F0 -> 0x8022125C
// this: r31
...
// Range: 0x8022125C -> 0x802212A0
// this: r31
void zCam2Player::update_phi() {
    // Local variables
    struct OOBExtent extent; // r1+0x8
}

// Range: 0x802212A0 -> 0x802212EC
// this: r31
...
// Range: 0x802212EC -> 0x802212F0
void zCam2Player::update_distance() {}

// Range: 0x802212F0 -> 0x80221420
// this: r31
...
// Range: 0x802215A4 -> 0x802215E8
// this: r31
void zCam2Player::start_position_aim() {}

// Range: 0x802215E8 -> 0x80221608
// this: r0
void zCam2Player::stop() {}

// Range: 0x80221608 -> 0x802216C8
// this: r31
void zCam2Player::update_camera_goals(float dt /* f31 */) {}

static unsigned int i; // size: 0x4, address: 0x80C08F5C
static signed char init; // size: 0x1, address: 0x80C08F60
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C043C8
struct xVec3 g_Y3; // size: 0xC, address: 0x80C0ADB8
// Range: 0x802216C8 -> 0x80221BF0
// this: r29
void zCam2Player::update(float dt /* f26 */) {
    // Local variables
    unsigned int savedClumpFilter; // r31
    float pastLimit; // r1+0xC
    float pastLimit; // r1+0x8
    float lockIntensity; // f30
...
// total size: 0x4C
struct {} zCam2Player::__vtable; // size: 0x4C, address: 0x8043F800
// total size: 0x0
