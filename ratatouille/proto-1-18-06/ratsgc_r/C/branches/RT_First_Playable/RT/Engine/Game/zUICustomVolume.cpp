/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomVolume.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021F564 -> 0x8021FB14
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct xColor_tag VOLUME_ACTIVE_COLOR; // size: 0x4, address: 0x80C04370
float VOLUME_WIDTH_PERCENTAGE; // size: 0x4, address: 0x80C04374
float VOLUME_HEIGHT_PERCENTAGE; // size: 0x4, address: 0x80C04378
...
// total size: 0x54
struct {} zUICustomVolume::__vtable; // size: 0x54, address: 0x8043F7A8
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x8021F564 -> 0x8021F5B0
// this: r30
zUICustomVolume::zUICustomVolume(class zUI * ui /* r0 */, enum xSndMixerFaderName sndMixerFader /* r31 */) {
    // References
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C0437C
// total size: 0xC
...
// Range: 0x8021F5B0 -> 0x8021F788
// this: r31
void zUICustomVolume::Setup() {
    // Local variables
    struct xGroup * group; // r29
    unsigned int i; // r30
    struct xBase * b; // r0
...
// Range: 0x8021F788 -> 0x8021F790
unsigned char zUICustomVolume::PreRender() {}

// Range: 0x8021F790 -> 0x8021F844
// this: r28
...
// Range: 0x8021F8C8 -> 0x8021F9F8
// this: r31
unsigned char zUICustomVolume::HandleEvent(unsigned int toEvent /* r0 */) {
    // Local variables
    float oldVol; // f0
    float vol; // f30
    float oldVol; // f0
...
// Range: 0x8021FACC -> 0x8021FAF0
// this: r3
float zUICustomVolume::GetVolume() const {}

// Range: 0x8021FAF0 -> 0x8021FB14
// this: r3
void zUICustomVolume::SetVolume(float volume /* f0 */) {}
