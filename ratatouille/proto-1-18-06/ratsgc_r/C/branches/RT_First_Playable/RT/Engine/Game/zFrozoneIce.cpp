/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFrozoneIce.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E03F0 -> 0x801E44CC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static const char * dump_output_file; // size: 0x4, address: 0x80C03408
// total size: 0x10
...
static struct zFrozoneIceRecordEntry record[1024]; // size: 0x4000, address: 0x80BB7280
static int record_size; // size: 0x4, address: 0x80C08CD8
static float lead_time; // size: 0x4, address: 0x80C0340C
enum MeltType {
    MeltType_INSTANT = 0,
    MeltType_DISTANCE = 1,
    MeltType_NONE = 2,
...
static struct zFrozoneIceConfig default_config; // size: 0x28, address: 0x8043E660
static unsigned char anim_linear; // size: 0x1, address: 0x80C03410
static unsigned char anim_scurve; // size: 0x1, address: 0x80C03411
static unsigned int texture; // size: 0x4, address: 0x80C03414
static unsigned int cap_texture; // size: 0x4, address: 0x80C03418
static int alpha_discard; // size: 0x4, address: 0x80C0341C
static float rand_tilt; // size: 0x4, address: 0x80C03420
static float rand_width; // size: 0x4, address: 0x80C03424
static float rand_offset_x; // size: 0x4, address: 0x80C03428
static float rand_offset_y; // size: 0x4, address: 0x80C08CDC
static float rand_offset_z; // size: 0x4, address: 0x80C08CE0
static int rand_blue; // size: 0x4, address: 0x80C0342C
static float test_lower_scale; // size: 0x4, address: 0x80C03430
static int glow_lower; // size: 0x4, address: 0x80C08CE4
static int glow_upper; // size: 0x4, address: 0x80C03434
// total size: 0x4
struct RwRGBA {
    // Members
...
static struct xColor_tag lower_color; // size: 0x4, address: 0x80C03438
static float pillar_width; // size: 0x4, address: 0x80C08CE8
static float spawn_time; // size: 0x4, address: 0x80C0343C
static float decay_time; // size: 0x4, address: 0x80C03440
static float decay_dist; // size: 0x4, address: 0x80C03444
static float max_dist; // size: 0x4, address: 0x80C03448
static float cap_offset_y; // size: 0x4, address: 0x80C0344C
static float decal_emit_distance; // size: 0x4, address: 0x80C03450
static unsigned int texture; // size: 0x4, address: 0x80C03454
static float fade_in_time; // size: 0x4, address: 0x80C03458
static float fade_out_time; // size: 0x4, address: 0x80C0345C
static float emit_rate; // size: 0x4, address: 0x80C03460
static float life_min; // size: 0x4, address: 0x80C03464
static float life_max; // size: 0x4, address: 0x80C03468
static float intensity_min; // size: 0x4, address: 0x80C0346C
static float intensity_max; // size: 0x4, address: 0x80C03470
static float width_min; // size: 0x4, address: 0x80C03474
static float width_max; // size: 0x4, address: 0x80C03478
static float start_height; // size: 0x4, address: 0x80C0347C
static float gravity_top; // size: 0x4, address: 0x80C03480
static float gravity_bottom; // size: 0x4, address: 0x80C03484
static float color_red; // size: 0x4, address: 0x80C03488
static float color_green; // size: 0x4, address: 0x80C0348C
static float color_blue; // size: 0x4, address: 0x80C03490
static float color_alpha; // size: 0x4, address: 0x80C03494
static float add_color_red; // size: 0x4, address: 0x80C03498
static float add_color_green; // size: 0x4, address: 0x80C0349C
static float add_color_blue; // size: 0x4, address: 0x80C08CEC
static unsigned char active; // size: 0x1, address: 0x80C08CF0
static unsigned char render; // size: 0x1, address: 0x80C08CF1
static float dist_min; // size: 0x4, address: 0x80C034A0
static float vel_break; // size: 0x4, address: 0x80C034A4
static float color_speed; // size: 0x4, address: 0x80C034A8
static unsigned char render_cinepath; // size: 0x1, address: 0x80C08CF2
// Range: 0x801E03F0 -> 0x801E0410
...
// total size: 0xC
struct /* @class$990zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$991zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$992zFrozoneIce_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$993zFrozoneIce_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$994zFrozoneIce_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$995zFrozoneIce_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$996zFrozoneIce_cpp */ {
    // Members
...
static struct tweak_callback cb_reload_assets; // size: 0x28, address: 0x803EE3B8
static struct tweak_callback cb_decay_fade; // size: 0x28, address: 0x803EE3E0
// Range: 0x801E0410 -> 0x801E0430
static void on_dump() {}

static struct tweak_callback cb_dump; // size: 0x28, address: 0x803EE408
// Range: 0x801E0430 -> 0x801E105C
...
// Range: 0x801E105C -> 0x801E109C
static void on_change_decay_fade(const struct tweak_info & info /* r0 */) {
    // References
    // -> static float fade_out_time;
    // -> static float fade_in_time;
}
...
// total size: 0x1C
struct /* @class$2345zFrozoneIce_cpp */ {
    // Members
...
static struct frozone_data * frodata; // size: 0x4, address: 0x80C08CF4
// total size: 0x18
...
static struct frobridge_spike_curve_node spike_appear_curve[4]; // size: 0x60, address: 0x803EE430
static struct frobridge_spike_curve_node spike_disappear_curve[3]; // size: 0x48, address: 0x803EE490
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x801E109C -> 0x801E10E4
static struct RwRaster * load_raster(unsigned int id /* r0 */) {
    // Local variables
...
// Range: 0x801E10E4 -> 0x801E11AC
static int create_particle_system(int old_system_id /* r27 */, unsigned int texture /* r4 */, unsigned int src_blend /* r28 */, unsigned int dst_blend /* r29 */, int stride /* r30 */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r31 */) {
    // Local variables
    struct xParticleBatchSystem system; // r1+0x8
}

// Range: 0x801E11AC -> 0x801E1214
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C034AC
// Range: 0x801E1214 -> 0x801E12A4
static struct frobridge_spike * alloc_spike() {
    // Local variables
    struct frobridge_spike * spike; // r3
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C034B8
// Range: 0x801E12A4 -> 0x801E1370
static void free_spike(struct frobridge_spike * spike /* r31 */) {
    // Local variables
    struct frobridge_spike * tail_spike; // r4
...
// Range: 0x801E140C -> 0x801E14E0
static int reserve_spikes(int amount /* r29 */) {
    // Local variables
    int spikes_left; // r31
    struct frobridge_spike * spikes; // r30
    int eldest; // r5
    float eldest_age; // f1
    int i; // r3
    int endi; // r6
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C034C4
// Range: 0x801E14E0 -> 0x801E15EC
static void create_parabola(float & v /* r30 */, float & a /* r31 */, float y0 /* f29 */, float y1 /* f30 */, float t /* f31 */) {
    // References
    // -> static char __FUNCTION__[16];
}

// Range: 0x801E15EC -> 0x801E1608
static float evaluate_parabola(float y0 /* f1 */, float v /* f0 */, float a /* f0 */, float t /* f0 */) {}

// Range: 0x801E1608 -> 0x801E16A8
...
// Range: 0x801E16A8 -> 0x801E1820
static float get_parabola_height() {
    // Local variables
    float parabola_dist_min; // f31
    float parabola_dist_max; // f30
    float parabola_height_min; // f29
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C034D4
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801E1820 -> 0x801E1EF4
static void emit_spikes(const struct xVec3 & A /* r25 */, const struct xVec3 & B /* r0 */, float dt /* f14 */) {
    // Local variables
    float width; // f19
    float rand_offset_x; // f20
    float ABx; // f21
    float ABy; // f22
    float ABz; // f23
    float ABmag; // f0
    float old_emitted; // f24
    int emit; // r3
    float ABrmag; // f0
    float xdir; // f26
    float ydir; // f18
    float zdir; // f17
    struct xMat3x3 path_mat; // r1+0x140
    struct xMat3x3 path_imat; // r1+0x110
    struct xVec3 path_at; // r1+0x1C
    float dage; // f31
    float age; // f30
    float emit_dist; // f29
    float start_dist; // f9
    ...
    float dy; // r1+0x1C0
    float dz; // f17
    struct frobridge_spike * spike; // r25
    float parabola_height; // f0
    float yscale; // f18
    float xscale; // f16
    float zscale; // f18
    struct xMat3x3 pre_scale_mat; // r1+0xE0
    float yaw; // f15
    float pitch; // f14
    float roll; // f0
    struct xMat3x3 rot_mat; // r1+0xB0
    struct xMat3x3 post_scale_mat; // r1+0x80
    struct xMat3x3 temp_mat; // r1+0x50
    struct xVec3 offset; // r1+0x10
    int dblue; // r8
    int upper_red; // r0
    struct xRay3 ray; // r1+0x28
...
// Range: 0x801E1EF4 -> 0x801E2030
static void refresh_spike(struct frobridge_spike & spike /* r30 */) {
    // Local variables
    const struct xResponseCurve & curve; // r31
    float t; // f1
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C034E4
// total size: 0x8
...
// Range: 0x801E2030 -> 0x801E253C
static void transform_spikes(struct xVec3 * pos /* r20 */, struct xVec2 * uv /* r27 */, unsigned int * color /* r28 */, const struct frobridge_spike_ref * sspikes /* r21 */, int spikes_size /* r29 */, struct xVec3 * cap_pos /* r22 */) {
    // Local variables
    struct xVec3 * start_pos; // r26
    struct xVec2 * start_uv; // r31
    unsigned int * start_color; // r30
    const struct frobridge_spike_ref * sspike; // r25
    ...
    float boz; // f21
    float cap_off; // f21
    unsigned int upper_color; // r0
    unsigned int lower_color; // r3
    int verts_size; // r29
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C034F8
// Range: 0x801E253C -> 0x801E26BC
static void setup_spike_caps(struct xVec3 * pos /* r0 */, struct xVec2 * uv /* r25 */, unsigned int * color /* r31 */, const struct frobridge_spike_ref * sspikes /* r26 */, int spikes_size /* r27 */, struct xVec3 * cap_pos /* r9 */) {
    // Local variables
    struct xVec2 * start_uv; // r30
    unsigned int * start_color; // r29
    int verts_size; // r28
    const struct frobridge_spike_ref * sspike; // r4
    const struct frobridge_spike_ref * const end_sspike; // r0
    unsigned int upper_color; // r3

    // References
    // -> static char __FUNCTION__[17];
}

// Range: 0x801E26BC -> 0x801E2748
static void im_lock(struct xVec3 * & pos /* r28 */, struct xVec2 * & uv /* r29 */, unsigned int * & color /* r30 */, unsigned int * & glow_color /* r31 */, int verts_size /* r7 */) {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x801E2748 -> 0x801E2770
static void im_unlock() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x801E2770 -> 0x801E27AC
...
// Range: 0x801E27AC -> 0x801E29E0
static void render_spikes() {
    // Local variables
    int spikes_size; // r30
    struct frobridge_spike_ref * sspikes; // r29
    struct frobridge_spike_ref * sspike; // r4
    ...
    float cam_dist; // f0
    int i; // r0
    const struct xVec3 & center; // r0
    float depth; // f0
    int verts_size; // r30
    int verts_size_top; // r28
    struct xVec3 * spike_cap_pos; // r27
...
// Range: 0x801E29E0 -> 0x801E2A50
static void start_spike_decay(struct frobridge_spike & spike /* r31 */) {
    // References
    // -> static float decay_time;
}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80C0350C
// total size: 0x18
struct analog_data {
    // Members
...
// total size: 0x4
struct /* @class$1376zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1514zFrozoneIce_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
union /* @class$1041zFrozoneIce_cpp */ {
...
// total size: 0x10
struct /* @class$1054zFrozoneIce_cpp */ {
    // Members
...
// Range: 0x801E2A50 -> 0x801E2D14
static int update_decay_particles(unsigned char * mem /* r30 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r29
    float yaccel0; // f30
    float yaccel1; // f29
    struct decay_particle * p; // r31
    struct decay_particle * end; // r28
    float t1; // f28
    float age2; // f3
    float y0; // f2
    float y1; // f1
    float height; // f27
    struct xVec4 loc; // r1+0x18
...
// Range: 0x801E2D14 -> 0x801E3270
static void emit_decay_particles(struct frobridge_spike & spike /* r30 */, float dt /* f0 */) {
    // Local variables
    int emit; // r31
    float life_min; // f0
    float life_range; // r1+0x64
    float width_min; // f0
    float width_range; // r1+0x60
    float intensity_min; // f0
    float intensity_range; // r1+0x5C
    float xzscale_range; // r1+0x58
    float y_min; // f25
    float y_range; // f24
    float xz_min; // f23
    float xz_range; // f22
    ...
    float red_lower; // f21
    float red_range; // f20
    float green_upper; // f2
    float green_lower; // f19
    float green_range; // f18
    float blue_upper; // f2
    float blue_lower; // f17
    float blue_range; // f16
    int system_id; // r27
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct decay_particle * p; // r26
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03524
// Range: 0x801E3270 -> 0x801E3340
static void record_render(const struct zFrozoneIceRecordEntry * record /* r27 */, int record_size /* r28 */) {
    // Local variables
    int i; // r30
...
// Range: 0x801E338C -> 0x801E3528
static void record_add(const struct xVec3 & loc /* r30 */) {
    // Local variables
    float time; // f31
    struct zFrozoneIceRecordEntry & entry; // r31
    struct zFrozoneIceRecordEntry & prev; // r29
    float dist; // f0
    float dt; // f2
    struct zFrozoneIceRecordEntry & prev1; // r29
    float dist0; // f0
    float dist1; // f0
...
// Range: 0x801E37EC -> 0x801E3838
// this: r30
static void file_log_stream::write(const char * text /* r31 */) {}

static // total size: 0xC
struct {} @unnamed@zFrozoneIce_cpp@::file_log_stream::__vtable; // size: 0xC, address: 0x80C0357C
// Range: 0x801E3838 -> 0x801E3880
// this: r30
static file_log_stream::file_log_stream(struct tag_xFile & file /* r31 */) {
    // References
    // -> static struct [anonymous] @unnamed@zFrozoneIce_cpp@::file_log_stream::__vtable;
}

static char * spike_anim_value_names[5]; // size: 0x14, address: 0x80C0352C
// Range: 0x801E388C -> 0x801E3968
...
// Range: 0x801E3968 -> 0x801E396C
void zFrozoneIceSceneExit() {}

// Range: 0x801E396C -> 0x801E3B38
void zFrozoneIceUpdate(float dt /* f31 */) {
    // Local variables
    float cx; // f30
    float cy; // f29
    float cz; // f28
    float max_dist2; // f27
    float decay_dist2; // f26
...
// Range: 0x801E3B38 -> 0x801E3B7C
void zFrozoneIceRender() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x801E3B7C -> 0x801E3BE4
void zFrozoneIceBridgeStart(unsigned char force_gap /* r0 */) {
    // References
    // -> static struct frozone_data * frodata;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C03540
// Range: 0x801E3BE4 -> 0x801E3D70
void zFrozoneIceBridgeMove(const struct xVec3 & lead_loc /* r29 */, const struct xVec3 & foot_loc /* r30 */, unsigned char gap /* r31 */) {
    // References
    // -> static struct frozone_data * frodata;
    // -> struct zGlobals globals;
...
// Range: 0x801E3D70 -> 0x801E3D80
void zFrozoneIceBridgeStop() {
    // References
    // -> static struct frozone_data * frodata;
}

static char __FUNCTION__[22]; // size: 0x16, address: 0x80C03558
// Range: 0x801E3D80 -> 0x801E41AC
unsigned char zFrozoneIceEvalRecord(struct xVec3 & v0 /* r24 */, struct xVec3 & v1 /* r25 */, float t0 /* r1+0x8 */, float t1 /* r1+0xC */, const struct zFrozoneIceRecordEntry * record /* r26 */, int record_size /* r27 */) {
    // Local variables
    const struct zFrozoneIceRecordEntry * e0; // r31
    const struct zFrozoneIceRecordEntry * e1; // r30
    const struct zFrozoneIceRecordEntry * end; // r29
    const struct zFrozoneIceRecordEntry * tail; // r28
    const struct zFrozoneIceRecordEntry * e; // r3
    const struct zFrozoneIceRecordEntry * enext; // r0

    // References
    // -> static char __FUNCTION__[22];
}

// Range: 0x801E41AC -> 0x801E41F4
static void lerp(struct xVec3 & v /* r0 */, const struct xVec3 & a /* r0 */, const struct xVec3 & b /* r0 */, float s /* f0 */) {}
...
// total size: 0x54
struct /* @class$2070zFrozoneIce_cpp */ {
    // Members
...
// Range: 0x801E41F4 -> 0x801E4264
void cinfx_frobridge_update(struct NCINEntry * fxrec /* r31 */, int killit /* r0 */) {
    // Local variables
    const struct cinfx_frobridge_context & context; // r3
...
// Range: 0x801E4264 -> 0x801E43F4
void cinfx_frobridge_animate(struct NCINEntry * fxrec /* r30 */, struct RwMatrixTag * animMat /* r6 */, unsigned int animIndex /* r0 */) {
    // Local variables
    const struct xMat4x3 & root_mat; // r6
    const struct xMat4x3 & foot_bone_mat; // r4
    struct xMat4x3 foot_mat; // r1+0x40
    struct xVec3 record_loc; // r1+0x30
    const struct cinfx_frobridge_context & context; // r31
    float t0; // f31
    struct xVec3 foot_loc; // r1+0x24
    struct xVec3 lead_loc; // r1+0x18
    unsigned char gap; // r30
    const struct xVec3 & v; // r3
...
// Range: 0x801E43F4 -> 0x801E43F8
void cinfx_frobridge_render() {}

// Range: 0x801E43F8 -> 0x801E43FC
void cinfx_frobridge_add_tweaks() {}

static // total size: 0xC
struct {} @unnamed@zFrozoneIce_cpp@::log_stream::__vtable; // size: 0xC, address: 0x80C03570
// total size: 0x1
struct cb_compare_records {};
// Range: 0x801E43FC -> 0x801E44CC
static int cb_compare_records::operator()(float time /* f31 */, const struct zFrozoneIceRecordEntry & e /* r31 */) {
    // Local variables
    float d; // f1
