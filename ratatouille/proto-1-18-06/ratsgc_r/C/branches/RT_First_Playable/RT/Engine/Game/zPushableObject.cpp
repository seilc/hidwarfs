/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPushableObject.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80284CA8 -> 0x80285538
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float SPEED_KNOCKBACK; // size: 0x4, address: 0x80C05AD0
static float GRID_CELL_SIZE; // size: 0x4, address: 0x80C05AD4
static float DECEL; // size: 0x4, address: 0x80C093D0
// Range: 0x80284CA8 -> 0x80284CC8
...
// total size: 0x4
struct /* @class$1130zPushableObject_cpp */ {
    // Members
...
union /* @class$1269zPushableObject_cpp */ {
...
// total size: 0xC
struct /* @class$1268zPushableObject_cpp */ {
    // Members
...
// Range: 0x80284CC8 -> 0x80284CE8
static void MoveWrapper(struct xEnt * ent /* r0 */, struct xScene * scene /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r0 */) {}

// Range: 0x80284CE8 -> 0x80284D14
static void EventWrapper(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}
...
// total size: 0xC
struct /* @class$1071zPushableObject_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1073zPushableObject_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1074zPushableObject_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1075zPushableObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1076zPushableObject_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1077zPushableObject_cpp */ {
    // Members
...
static struct tweak_callback calcDecelCB; // size: 0x28, address: 0x80443E40
// total size: 0x10
...
// Range: 0x80284DA8 -> 0x80284E34
// this: r30
unsigned char zPushableObject::CheckPos(const struct xVec3 & destPos /* r31 */) {
    // Local variables
    struct xMat4x3 matrix; // r1+0x10
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80BCBFA8
static unsigned char needInit; // size: 0x1, address: 0x80C093D4
static signed char init; // size: 0x1, address: 0x80C093D5
// Range: 0x80284E34 -> 0x80284F74
// this: r31
zPushableObject::zPushableObject(const struct Asset & theAsset /* r0 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05AD8
// Range: 0x80284F74 -> 0x80285114
void zPushableObject::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x80285114 -> 0x80285180
float zPushableObject::RoundToGrid(float pos /* f0 */) {
    // Local variables
    float grid; // f3
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C05AE0
// Range: 0x80285180 -> 0x802852F8
// this: r30
void zPushableObject::Move(float dt /* f0 */, struct xEntFrame * frame /* r31 */) {
    // Local variables
    float newSpeed; // f31
    float gridPos; // f0
    float gridPos; // f0
...
// Range: 0x80285398 -> 0x802854D8
// this: r31
void zPushableObject::EntityHit(struct xEnt * hit /* r4 */) {
    // Local variables
...
// Range: 0x802854D8 -> 0x80285518
// this: r0
void zPushableObject::HandleEvent(struct xBase * from /* r0 */, unsigned int toEvent /* r0 */) {}
