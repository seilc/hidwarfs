/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xModelWarp.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801DFFAC -> 0x801E0308
*/
// total size: 0x10
struct _xFColor {
    // Members
...
static struct _xFColor default_color; // size: 0x10, address: 0x80C033E8
static int render_texture; // size: 0x4, address: 0x80C033F8
static int render_bound; // size: 0x4, address: 0x80C033FC
static int render_rect; // size: 0x4, address: 0x80C03400
static unsigned char force_default_color; // size: 0x1, address: 0x80C08CC8
// Range: 0x801DFFAC -> 0x801E016C
static void add_tweaks() {
    // Local variables
    const char * prefix; // r31

    // References
    // -> static unsigned char force_default_color;
    // -> static int render_rect;
    // -> static int render_bound;
...
// total size: 0xC
struct /* @class$1044xModelWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1045xModelWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1046xModelWarp_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1047xModelWarp_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1048xModelWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1049xModelWarp_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1050xModelWarp_cpp */ {
    // Members
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x80BB6E30
// total size: 0x18
struct xBox {
    // Members
...
struct render_context {
    // Members
    struct xMat4x3 uvmat; // offset 0x0, size 0x40
    int flags; // offset 0x40, size 0x4
    struct xBox box; // offset 0x44, size 0x18
    struct _xFColor color; // offset 0x5C, size 0x10
    struct RpAtomic * atomic; // offset 0x6C, size 0x4
    struct RpAtomic * original_atomic; // offset 0x70, size 0x4
    struct RpAtomic * (* original_render_callback)(struct RpAtomic *); // offset 0x74, size 0x4
};
static struct render_context render_contexts[8]; // size: 0x400, address: 0x80BB6E80
static int render_contexts_size; // size: 0x4, address: 0x80C08CCC
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x801E016C -> 0x801E0198
static void destroy_render_context(struct render_context & context /* r0 */) {}
...
// Range: 0x801E0198 -> 0x801E01F8
void xModelWarpSceneEnter() {
    // References
    // -> static int render_contexts_size;
    // -> static class xFXCameraTexture camtex;
    // -> struct xColor_tag g_CLEAR;
}

// Range: 0x801E01F8 -> 0x801E0268
void xModelWarpSceneExit() {
    // Local variables
    struct render_context * context; // r31
    struct render_context * end_context; // r30

    // References
    // -> static class xFXCameraTexture camtex;
    // -> static int render_contexts_size;
    // -> static struct render_context render_contexts[8];
}

// Range: 0x801E0268 -> 0x801E0308
void xModelWarpSphereMapUVsByNormals(struct xVec2 * uv /* r29 */, int verts_size /* r0 */, const struct xVec3 * norm /* r30 */) {
    // Local variables
    struct xVec2 * end_uv; // r31
}
