/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCStirringPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8029BFC4 -> 0x8029C148
*/
char __FUNCTION__$localstatic1$AttachComponent__66zComponentPool<24zCompLogicStirringPlayer,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06080
signed char zComponentPool<zCompLogicStirringPlayer, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09570
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicStirringPlayer, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C09574
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x8029C040 -> 0x8029C108
// this: r28
void zNPCStirringPlayer::Update(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1155zNPCStirringPlayer_cpp */ {
    // Members
...
union /* @class$1295zNPCStirringPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1293zNPCStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1047zNPCStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1048zNPCStirringPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1049zNPCStirringPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1050zNPCStirringPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1051zNPCStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1052zNPCStirringPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1053zNPCStirringPlayer_cpp */ {
    // Members
...
// total size: 0x30
struct {} zNPCStirringPlayer::__vtable; // size: 0x30, address: 0x80447300
