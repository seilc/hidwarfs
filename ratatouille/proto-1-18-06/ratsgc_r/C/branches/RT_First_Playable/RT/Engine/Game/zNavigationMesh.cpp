/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNavigationMesh.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8021B8D0 -> 0x8021BDD4
*/
class zNavigationMesh * activeNavMesh; // size: 0x4, address: 0x80C08F20
// Range: 0x8021B8D0 -> 0x8021B8F0
void zNavigationMesh_Init(void * base /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[23]; // size: 0x17, address: 0x80C04270
// Range: 0x8021B8F0 -> 0x8021B958
void zNavigationMeshEventCB(struct xBase * to /* r0 */) {
    // References
...
// total size: 0x4
struct /* @class$1112zNavigationMesh_cpp */ {
    // Members
...
union /* @class$847zNavigationMesh_cpp */ {
...
// total size: 0xC
struct /* @class$1276zNavigationMesh_cpp */ {
    // Members
...
// Range: 0x8021B958 -> 0x8021B9B4
// this: r30
void zNavigationMesh::Init(class xNavigationMeshAsset * asset /* r31 */) {}

// Range: 0x8021B9B4 -> 0x8021BA20
void zNavigationMesh::SceneReset() {
    // Local variables
    class zNavigationMesh * activeNavMesh; // r31
    class zNavigationMesh * curNavMesh; // r30

    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x8021BA20 -> 0x8021BA2C
void zNavigationMesh::SceneEnd() {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

static char __FUNCTION__[21]; // size: 0x15, address: 0x80C04288
// Range: 0x8021BA2C -> 0x8021BAE0
...
// Range: 0x8021BAE0 -> 0x8021BB74
class zNavigationMesh * zNavigationMesh::FindMeshForPosition(const struct xVec3 & pos /* r28 */, int & submeshIdx /* r29 */, int & triIdx /* r30 */) {
    // Local variables
    class zNavigationMesh * currMesh; // r31
}

// Range: 0x8021BB74 -> 0x8021BBA0
void zNavigationMesh::AddNavMeshToLinkedList(class zNavigationMesh * navMesh /* r0 */) {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x8021BBA0 -> 0x8021BBF0
...
// Range: 0x8021BBF0 -> 0x8021BC18
// this: r0
void zNavigationMesh::SetEnable(unsigned char state /* r0 */) {}

// Range: 0x8021BC18 -> 0x8021BC24
// this: r0
unsigned char zNavigationMesh::IsEnabled() {}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80C042A0
// Range: 0x8021BC24 -> 0x8021BCE4
// this: r30
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C042B8
// Range: 0x8021BCE4 -> 0x8021BDA0
...
// Range: 0x8021BDA0 -> 0x8021BDD4
class xNavigationMeshAsset * zNavigationMesh::GetActiveNavMeshAsset() {
    // Local variables
    class zNavigationMesh * activeNavMesh; // r0
}
