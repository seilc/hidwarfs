/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPad.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F6730 -> 0x801F7844
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zPad pads[6]; // size: 0xD8, address: 0x80BC2FB0
static class zPad * debugPad; // size: 0x4, address: 0x80C08DB0
static class zPad * dualControlPad; // size: 0x4, address: 0x80C08DB4
// Range: 0x801F6730 -> 0x801F677C
...
// Range: 0x801F6844 -> 0x801F6868
// this: r0
void zPad::Init() {}

// Range: 0x801F6868 -> 0x801F696C
unsigned char zPad::IsPadAtPort(int port /* r0 */, int & arrayIndex /* r0 */) {
    // Local variables
    int j; // r6
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C03A40
// Range: 0x801F696C -> 0x801F6A10
...
// Range: 0x801F6A10 -> 0x801F6AC0
class zPad * zPad::CreatePadAtPort(int port /* r29 */, unsigned char isAI /* r30 */) {
    // Local variables
    class zPad * firstUnusedPad; // r31
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C03A50
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x801F6AC0 -> 0x801F6BF0
class zPad * zPad::GetUnusedPad(unsigned char isAI /* r29 */) {
    // Local variables
...
// Range: 0x801F6BF0 -> 0x801F6C5C
class zPad * zPad::GetTriggeredPad(unsigned int key1 /* r29 */, unsigned int key2 /* r30 */, unsigned int key3 /* r31 */) {
    // Local variables
    class zPad * pad; // r3
}

// Range: 0x801F6C5C -> 0x801F6C80
class zPad * zPad::GetTriggeredPad(unsigned int key1 /* r0 */, unsigned int key2 /* r0 */) {}

// Range: 0x801F6C80 -> 0x801F6CBC
class zPad * zPad::GetDebugPad() {
    // References
    // -> static class zPad * debugPad;
}

// Range: 0x801F6CBC -> 0x801F6D84
// this: r30
unsigned char zPad::KeyCheck() {}

// Range: 0x801F6D84 -> 0x801F6E34
// this: r28
unsigned char zPad::Toggle(int & newPort /* r29 */) {
    // Local variables
    int oldPort; // r31
    int i; // r30
...
// Range: 0x801F6E34 -> 0x801F6ED8
void zPad::RefreshActivePad(int port /* r26 */) {
    // Local variables
    int i; // r27
...
// Range: 0x801F6ED8 -> 0x801F6F0C
// this: r0
void zPad::DisablePad() {}

// Range: 0x801F6F0C -> 0x801F6F40
// this: r0
void zPad::EnablePad() {}

// Range: 0x801F6F40 -> 0x801F701C
...
// Range: 0x801F701C -> 0x801F703C
// this: r0
unsigned char zPad::Active() {}

// Range: 0x801F703C -> 0x801F706C
// this: r0
void zPad::DeactivateTRC() {}

// Range: 0x801F706C -> 0x801F7094
// this: r0
void zPad::Clear() {
    // References
    // -> struct _tagxPad mPad[4];
...
// Range: 0x801F7094 -> 0x801F70AC
// this: r0
void zPad::ReleasePad() {}

// Range: 0x801F70AC -> 0x801F7114
// this: r29
unsigned char zPad::Pressed(unsigned int button /* r30 */) {}

// Range: 0x801F7114 -> 0x801F717C
// this: r29
unsigned char zPad::On(unsigned int button /* r30 */) {}

// Range: 0x801F717C -> 0x801F71E4
// this: r29
unsigned char zPad::Released(unsigned int button /* r30 */) {}

// Range: 0x801F71E4 -> 0x801F7218
// this: r0
unsigned char zPad::PressedDirect(unsigned int button /* r0 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x801F7218 -> 0x801F724C
// this: r0
unsigned char zPad::OnDirect(unsigned int button /* r0 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x801F724C -> 0x801F7280
// this: r0
unsigned char zPad::ReleasedDirect(unsigned int button /* r0 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x801F7280 -> 0x801F7330
// this: r30
...
// Range: 0x801F7680 -> 0x801F76A0
float zPadAnalogControl::GetMag(float x /* f0 */, float y /* f0 */) {}

// Range: 0x801F76A0 -> 0x801F76E4
// this: r31
...
// Range: 0x801F76E4 -> 0x801F7730
// this: r31
float zPadAnalogControl::GetAngle() {}

// Range: 0x801F7730 -> 0x801F7750
float zPadAnalogControl::GetAngle(float x /* f0 */, float y /* f0 */) {}

// Range: 0x801F7750 -> 0x801F77B4
// this: r27
void zPadAnalogControl::Get(float & x /* r28 */, float & y /* r29 */, float & angle /* r30 */, float & mag /* r31 */) {}

// Range: 0x801F77B4 -> 0x801F7808
// this: r29
