/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPourStream.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BACD4 -> 0x802BC204
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x80C09768
unsigned int numTextureSystems; // size: 0x4, address: 0x80C0976C
// total size: 0x58
struct config {
    // Members
...
struct config default_config; // size: 0x58, address: 0x80BD4500
// total size: 0x8
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C066D8
struct TextureSystem textureSystems[8]; // size: 0x40, address: 0x80BD4558
// Range: 0x802BADA8 -> 0x802BAEEC
unsigned int zPourStreamParticleSystem::register_texture(unsigned int texId /* r31 */) {
    // Local variables
    unsigned int i; // r3
...
char * zPourStreamParticleSystemNames[8]; // size: 0x20, address: 0x80448A00
// total size: 0x28
...
// total size: 0xC
struct /* @class$964zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zPourStream_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zPourStream_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zPourStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zPourStream_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zPourStream_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1350zPourStream_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1488zPourStream_cpp */ {
    // Members
...
union /* @class$1015zPourStream_cpp */ {
...
// total size: 0x10
struct /* @class$1028zPourStream_cpp */ {
    // Members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C066EC
// total size: 0x18
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C066F4
// Range: 0x802BBC34 -> 0x802BBDC8
void zPourStreamWidget::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static char __FUNCTION__[8]; // size: 0x8, address: 0x80C066FC
// Range: 0x802BBF18 -> 0x802BC008
void zPourStreamWidget::EventCB(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
...
struct PourStreamList * headList; // size: 0x4, address: 0x80C09770
// total size: 0x1
class zPourStreamManager {
    // Static members
    static struct PourStreamList * headList; // size: 0x4
};
// Range: 0x802BC080 -> 0x802BC0A8
void zPourStreamManager::Init() {
    // References
    // -> struct PourStreamList * headList;
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C06704
// Range: 0x802BC0A8 -> 0x802BC14C
