/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompSteeringFlockingBrain.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802B844C -> 0x802B8564
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x802B8450 -> 0x802B8564
// this: r28
void zCompSteeringFlockingBrain::PreUpdate() {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    const struct xVec3 * neighbourEntityPos; // r30
    const struct xVec3 * neighbourEntityHeading; // r30
    int i; // r29
    class zICompNPCEntity * curNeighbourEntity; // r30
...
// total size: 0x4
struct /* @class$1097zCompSteeringFlockingBrain_cpp */ {
    // Members
...
union /* @class$1236zCompSteeringFlockingBrain_cpp */ {
...
// total size: 0xC
struct /* @class$1235zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1038zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zCompSteeringFlockingBrain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zCompSteeringFlockingBrain_cpp */ {
    // Members
...
// total size: 0x58
struct {} zCompSteeringFlockingBrain::__vtable; // size: 0x58, address: 0x80448838
// total size: 0x8
