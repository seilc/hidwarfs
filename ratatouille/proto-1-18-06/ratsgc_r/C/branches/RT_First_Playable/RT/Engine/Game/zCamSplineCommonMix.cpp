/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamSplineCommonMix.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80245744 -> 0x80245A4C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct {} zCamSplineCommonMix::__vtable; // size: 0xC, address: 0x80C04BB8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1098zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1236zCamSplineCommonMix_cpp */ {
    // Members
...
union /* @class$1237zCamSplineCommonMix_cpp */ {
...
// total size: 0x10
struct /* @class$1542zCamSplineCommonMix_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
class zCamSplineCommonMix {
    ...
    void SetCurves(class zCameraCurve * curveInfo);
...
// Range: 0x80245744 -> 0x80245788
// this: r31
zCamSplineCommonMix::zCamSplineCommonMix() {
    // References
    // -> struct [anonymous] zCamSplineCommonMix::__vtable;
}
...
// Range: 0x80245788 -> 0x802457AC
// this: r0
void zCamSplineCommonMix::SetCurves(class zCameraCurve * curveInfo /* r0 */) {}
...
// Range: 0x802457AC -> 0x80245808
// this: r31
void zCamSplineCommonMix::InitPaths() {
    // References
...
// total size: 0xC
struct /* @class$973zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$974zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$975zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$976zCamSplineCommonMix_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$977zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$978zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$979zCamSplineCommonMix_cpp */ {
    // Members
...
// Range: 0x80245808 -> 0x80245858
// this: r31
void zCamSplineCommonMix::UpdatePaths() {
    // References
    // -> struct zGlobals globals;
}
...
// Range: 0x80245858 -> 0x80245888
// this: r3
void zCamSplineCommonMix::DebugRender() {
    // References
    // -> int mDebugDraw;
}
...
// Range: 0x80245888 -> 0x8024599C
// this: r30
void zCamSplineCommonMix::DM_Draw() {
    // Local variables
    float playersDistanceApart; // f31
...
// total size: 0x890
struct /* @class$2094zCamSplineCommonMix_cpp */ {
    // Static members
...
// Range: 0x8024599C -> 0x80245A4C
// this: r30
void zCamSplineCommonMix::AddTweaks(const char * prefix /* r31 */) {
    // Local variables
