/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xBound.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8000CF0C -> 0x8000E9DC
*/
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x8000CF0C -> 0x8000CFB4
void xBoundUpdate(struct xBound * b /* r31 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFB708
// Range: 0x8000CFB4 -> 0x8000D10C
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFB718
// Range: 0x8000D10C -> 0x8000D298
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFB72C
// Range: 0x8000D2C4 -> 0x8000D414
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFB74C
// Range: 0x8000D6BC -> 0x8000D8A0
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFB75C
// total size: 0x24
struct xRay3 {
    // Members
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFB770
// total size: 0x2C
struct xIsect {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x8000DD28 -> 0x8000DF70
void xRayHitsBound(const struct xRay3 * r /* r29 */, const struct xBound * b /* r30 */, struct xCollis * c /* r31 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFB780
// Range: 0x8000DF70 -> 0x8000E114
void xSphereHitsBound(const struct xSphere * o /* r29 */, const struct xBound * b /* r30 */, struct xCollis * c /* r31 */) {
    // References
    // -> static char __FUNCTION__[17];
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFB794
// Range: 0x8000E114 -> 0x8000E344
void xVecHitsBound(const struct xVec3 * v /* r29 */, const struct xBound * b /* r30 */, struct xCollis * c /* r31 */) {
    // Local variables
