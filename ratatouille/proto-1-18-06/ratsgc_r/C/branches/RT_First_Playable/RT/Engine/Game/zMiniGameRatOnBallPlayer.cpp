/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGameRatOnBallPlayer.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A14B8 -> 0x802A394C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float PLAYER_TURN_SPEED; // size: 0x4, address: 0x80C061C0
static float PLAYER_STICK_VEC; // size: 0x4, address: 0x80C061C4
static float PLAYER_TURBO; // size: 0x4, address: 0x80C061C8
static float PLAYER_TURBO_DECEL; // size: 0x4, address: 0x80C061CC
static float PLAYER_COLLISION; // size: 0x4, address: 0x80C061D0
static float PLAYER_COLLISION_DECEL; // size: 0x4, address: 0x80C061D4
static float PLAYER_TURBO_TIMER; // size: 0x4, address: 0x80C061D8
static float PLAYER_TILT; // size: 0x4, address: 0x80C061DC
static float PLAYER_FADE_PERCENT; // size: 0x4, address: 0x80C061E0
static unsigned char showVelocity; // size: 0x1, address: 0x80C061E4
static unsigned char showStickVec; // size: 0x1, address: 0x80C095E0
static unsigned char showTurboVec; // size: 0x1, address: 0x80C095E1
static unsigned char showCollisionVec; // size: 0x1, address: 0x80C061E5
static unsigned char showArenaTiltVec; // size: 0x1, address: 0x80C095E2
static struct compositeEffect rumbleEffects[3]; // size: 0xF0, address: 0x80BD22F8
// total size: 0x40
...
// Range: 0x802A14B8 -> 0x802A151C
// this: r3
void zRatOnBallForces::SetTurbo(struct xVec3 & vec /* r0 */, struct xVec3 & pos /* r31 */) {
    // Local variables
    enum iSndGroupHandle handle; // r0
}

// Range: 0x802A151C -> 0x802A1540
// this: r0
...
// Range: 0x802A1540 -> 0x802A15CC
// this: r31
void zRatOnBallForces::Reset(class zMiniGameRatOnBallPlayer * inPlayer /* r0 */) {}

// Range: 0x802A15CC -> 0x802A1618
// this: r30
...
// Range: 0x802A1684 -> 0x802A1870
// this: r29
void zRatOnBallForces::Update(class zMiniGameRatOnBallPlayer * player /* r30 */, struct xMat4x3 * directionMat /* r31 */, float dt /* f31 */) {
    // Local variables
    float accel; // f30
    float colLen; // f0
    float colT; // f1
...
// Range: 0x802A1870 -> 0x802A18A4
// this: r0
void zRatOnBallForces::Apply(struct xMat4x3 * applyToMat /* r0 */, float dt /* f0 */) {}
...
// total size: 0xC
struct /* @class$2031zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1038zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1040zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1041zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1042zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1043zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1044zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// Range: 0x802A18A4 -> 0x802A190C
void zMiniGameRatOnBallPlayer::SetupRumbles() {
    // References
    // -> static struct compositeEffect rumbleEffects[3];
}

// Range: 0x802A190C -> 0x802A1980
// this: r31
void zMiniGameRatOnBallPlayer::Rumble(unsigned int rumbleType /* r30 */) {
    // References
    // -> static struct compositeEffect rumbleEffects[3];
}
...
// total size: 0x4
struct /* @class$1097zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
union /* @class$1236zMiniGameRatOnBallPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$1235zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$1984zMiniGameRatOnBallPlayer_cpp */ {
    // Static members
...
// total size: 0x10
struct /* @class$1522zMiniGameRatOnBallPlayer_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x802A1980 -> 0x802A1A78
// this: r31
void zMiniGameRatOnBallPlayer::Init(struct xEntAsset * asset /* r0 */) {
    // Local variables
    int lastUsedPad; // r0
...
// Range: 0x802A1B4C -> 0x802A1C28
// this: r31
void zMiniGameRatOnBallPlayer::UpdateOrientation(float dt /* f31 */) {
    // Local variables
...
// Range: 0x802A1C28 -> 0x802A1D28
// this: r31
void zMiniGameRatOnBallPlayer::UpdateTurbo(float dt /* f31 */) {
    // Local variables
    class zPad * pad; // r0
...
// Range: 0x802A1EDC -> 0x802A1FC8
// this: r31
void zMiniGameRatOnBallPlayer::UpdateUIMarker(unsigned char onff /* r0 */) {
    // Local variables
    struct xVec3 worldPos; // r1+0x14
    struct xVec3 screenPos; // r1+0x8
...
// Range: 0x802A2190 -> 0x802A2194
void zMiniGameRatOnBallPlayer::UpdateDead() {}

// Range: 0x802A2194 -> 0x802A21CC
// this: r0
void zMiniGameRatOnBallPlayer::StartUIMarker() {}

// Range: 0x802A21CC -> 0x802A22C8
// this: r30
void zMiniGameRatOnBallPlayer::UpdateRespawningPause(float dt /* f0 */) {
    // Local variables
...
// Range: 0x802A22C8 -> 0x802A2334
// this: r0
void zMiniGameRatOnBallPlayer::UpdateMarkerTimer(float dt /* f0 */) {}

// Range: 0x802A2334 -> 0x802A2528
// this: r31
void zMiniGameRatOnBallPlayer::UpdateActive(float dt /* f31 */) {
    // Local variables
    float arenaRadius; // f0
    struct xVec3 vecToUs; // r1+0x8
    enum iSndGroupHandle soundGroupHandle; // r30
}

static char __FUNCTION__[7]; // size: 0x7, address: 0x80C061E8
// Range: 0x802A2528 -> 0x802A2708
// this: r31
...
// Range: 0x802A2708 -> 0x802A2770
// this: r31
void zMiniGameRatOnBallPlayer::EndUpdate(float dt /* f31 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x802A2770 -> 0x802A2990
// this: r31
...
// Range: 0x802A2990 -> 0x802A29D0
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetup() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C061F0
// Range: 0x802A29D0 -> 0x802A2A98
class zUIImage * zMiniGameRatOnBallPlayer::FindUIObject(const char * prefix /* r29 */, const char * desc /* r30 */) {
    // Local variables
    char txt[256]; // r1+0x8
    class zUIImage * img; // r0

    // References
    // -> static char __FUNCTION__[13];
}

// Range: 0x802A2A98 -> 0x802A2C4C
// this: r30
void zMiniGameRatOnBallPlayer::SceneSetupUI(const char * prefix /* r31 */) {}

// Range: 0x802A2C4C -> 0x802A2C90
// this: r0
void zMiniGameRatOnBallPlayer::DisplayWinnerIcon(unsigned char visible /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C06200
// Range: 0x802A2C90 -> 0x802A2E50
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetupBall(int idx /* r30 */) {
    // Local variables
...
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C06210
// Range: 0x802A2E50 -> 0x802A2F9C
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetupParticles(int idx /* r29 */) {
    // Local variables
    char * pGenName[4]; // r1+0x18
    char * entName[4]; // r1+0x8
    unsigned int pGenID; // r0
    struct xBase * ent; // r0
...
// Range: 0x802A2F9C -> 0x802A3040
// this: r31
void zMiniGameRatOnBallPlayer::Reset() {}

// Range: 0x802A3040 -> 0x802A3060
// this: r0
void zMiniGameRatOnBallPlayer::Exit() {}

// Range: 0x802A3060 -> 0x802A318C
// this: r31
...
// Range: 0x802A3480 -> 0x802A34E0
void zMiniGameRatOnBallPlayer::AddStates(struct xAnimTable * table /* r4 */) {}

// Range: 0x802A34E0 -> 0x802A35E4
...
// Range: 0x802A35E4 -> 0x802A35FC
// this: r0
void zMiniGameRatOnBallAI::Init(class zMiniGameRatOnBallPlayer * inPlayer /* r0 */) {}

// Range: 0x802A35FC -> 0x802A3680
// this: r31
void zMiniGameRatOnBallAI::Reset() {}

// Range: 0x802A3680 -> 0x802A3750
// this: r26
void zMiniGameRatOnBallAI::ReevaluateTarget() {
    ...
    int total; // r28
    int i; // r27
    class zMiniGameRatOnBallPlayer * testTarget; // r0
    int idx; // r0
...
// Range: 0x802A3750 -> 0x802A394C
// this: r31
void zMiniGameRatOnBallAI::Update(float dt /* f29 */) {
    // Local variables
    struct xVec3 targetPos; // r1+0x14
    float arenaRadius; // f0
    float arenaBufferRadius; // f0
    float distFromCenter; // f0
    float innerArena; // f30
    struct xVec3 toTargetVec; // r1+0x8
    float distToTarget; // f0
    float angleDiff; // f0
...
// total size: 0x13C
struct {} zMiniGameRatOnBallPlayer::__vtable; // size: 0x13C, address: 0x804475C0
// total size: 0x50
