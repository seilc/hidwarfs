/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zLaserBeam.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80131820 -> 0x80135ED8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80131820 -> 0x80131824
static void add_tweaks() {}

static char * bm_labels[4]; // size: 0x10, address: 0x80C00A00
static char * mt_labels[3]; // size: 0xC, address: 0x80C00A10
static char * bv_labels[2]; // size: 0x8, address: 0x80C00A1C
static char * ro_labels[2]; // size: 0x8, address: 0x80C00A24
static char * rc_labels[2]; // size: 0x8, address: 0x80C00A2C
static char * ca_labels[3]; // size: 0xC, address: 0x80C00A34
static char * fi_labels[3]; // size: 0xC, address: 0x80C00A40
static char * fo_labels[3]; // size: 0xC, address: 0x80C00A4C
static unsigned int blend_modes[4][2]; // size: 0x20, address: 0x803D7220
// total size: 0xC
struct curve_node {
    // Members
...
static struct curve_node burn_ribbon_curve[7]; // size: 0x54, address: 0x803D7240
static struct curve_node fade_ribbon_curve[2]; // size: 0x18, address: 0x80C0BF58
// total size: 0x8
struct /* @class$2786zLaserBeam_cpp */ {
    // Members
...
struct /* @class$2786zLaserBeam_cpp */ {
    ...
    const struct curve_node * curve; // offset 0x0, size 0x4
    int size; // offset 0x4, size 0x4
} ribbon_curves[2]; // size: 0x10, address: 0x80C00A58
static char * fade_value_labels[2]; // size: 0x8, address: 0x80C00A68
// total size: 0xC
...
static struct fade_curve_node fade_in_curve_immediate[2]; // size: 0x18, address: 0x80C0BF70
static struct fade_curve_node fade_in_curve_linear[2]; // size: 0x18, address: 0x80C0BF88
static struct fade_curve_node fade_in_curve_overshoot[3]; // size: 0x24, address: 0x803D7294
// total size: 0x4
struct node {
    // Members
    float t; // offset 0x0, size 0x4
...
struct debug_data {};
// total size: 0xC
struct /* @class$938zLaserBeam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$939zLaserBeam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$940zLaserBeam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$941zLaserBeam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$942zLaserBeam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$943zLaserBeam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$944zLaserBeam_cpp */ {
    // Members
...
static struct xResponseCurve fade_in_curve[3]; // size: 0x3C, address: 0x80B93268
// total size: 0x24
...
// Range: 0x80131824 -> 0x80131878
static void render_quad_outline(struct RxObjSpace3DVertex * v /* r31 */) {}

static struct RxObjSpace3DVertex * vert_buffer; // size: 0x4, address: 0x80C08190
static struct RxObjSpace3DVertex * end_vert_buffer; // size: 0x4, address: 0x80C08194
static int vert_indices_set; // size: 0x4, address: 0x80C08198
static unsigned char brightening; // size: 0x1, address: 0x80C0819C
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * current_raster; // size: 0x4, address: 0x80C081A0
static unsigned char render_laser_outlines; // size: 0x1, address: 0x80C081A4
static signed char init; // size: 0x1, address: 0x80C081A5
static unsigned char _temp_tweaks_registered; // size: 0x1, address: 0x80C081A6
static signed char init; // size: 0x1, address: 0x80C081A7
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C00A70
// total size: 0x18
...
// Range: 0x80131878 -> 0x80131AD4
static void flush_vert_buffer() {
    // Local variables
    int vert_size; // r31
    unsigned short * index_buffer; // r30
    int index_size; // r29
    unsigned short * index; // r5
    unsigned short * end_index; // r6
    int vi; // r7
...
// total size: 0x4
struct /* @class$1115zLaserBeam_cpp */ {
    // Members
...
union /* @class$1512zLaserBeam_cpp */ {
...
// Range: 0x80131B58 -> 0x80131BD0
static unsigned char entity_moves(struct xEnt & ent /* r0 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1485zLaserBeam_cpp */ {
    // Members
...
// total size: 0x40
struct /* @class$1487zLaserBeam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1493zLaserBeam_cpp */ {
    // Members
    float age; // offset 0x0, size 0x4
    float rate; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1494zLaserBeam_cpp */ {
    // Members
...
union /* @class$1492zLaserBeam_cpp */ {
    // total size: 0x8
    struct /* @class$1493zLaserBeam_cpp */ {
        // Members
        float age; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1496zLaserBeam_cpp */ {
    // Members
    float phase; // offset 0x0, size 0x4
};
// total size: 0x1
struct /* @class$1497zLaserBeam_cpp */ {};
union /* @class$1495zLaserBeam_cpp */ {
    // total size: 0x4
    struct /* @class$1496zLaserBeam_cpp */ {
        // Members
        float phase; // offset 0x0, size 0x4
    ...
    // total size: 0x1
    struct /* @class$1497zLaserBeam_cpp */ {} flicker; // offset 0x0, size 0x1
};
// total size: 0x3C
struct motion_data {
    // Members
...
// total size: 0x10
struct /* @class$2021zLaserBeam_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80131C74 -> 0x80131CD4
void zLaserBeam::setup_all() {
    // Local variables
    struct zScene & s; // r3
    struct zLaserBeam * it; // r31
    struct zLaserBeam * end; // r30

    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C00A84
// Range: 0x80131CD4 -> 0x80131E58
void zLaserBeam::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// total size: 0x10
struct /* @class$1483zLaserBeam_cpp */ {
    // Members
    unsigned int texture; // offset 0x0, size 0x4
...
union /* @class$1484zLaserBeam_cpp */ {
...
// Range: 0x801320A8 -> 0x80132130
// this: r30
void zLaserBeam::load(const struct zLaserBeamAsset & a /* r0 */, unsigned char use_tag /* r31 */) {}

// Range: 0x80132130 -> 0x80132198
// this: r31
void zLaserBeam::setup() {}

// Range: 0x80132198 -> 0x801321E4
// this: r31
void zLaserBeam::reset() {}

// Range: 0x801321E4 -> 0x8013227C
// this: r31
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00A8C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801322F8 -> 0x80132558
// this: r31
void zLaserBeam::update_motion(float dt /* f0 */) {
    // Local variables
    int motion_flags; // r30
    float old_segment_dist; // f31
    float ddist; // f3
    float start_subdist; // f1
    float subdist; // f2
    struct xMat4x3 & model_mat; // r30
    struct xVec3 right; // r1+0x8

    // References
    // -> static char __FUNCTION__[14];
}

// Range: 0x80132558 -> 0x801325BC
// this: r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00A9C
// Range: 0x801325BC -> 0x80132670
// this: r31
...
// Range: 0x8013290C -> 0x80132AB4
// this: r31
void zLaserBeam::reload_asset() {}

// Range: 0x80132AB4 -> 0x80132BA8
// this: r31
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00AAC
// Range: 0x80132BA8 -> 0x80132CD0
// this: r29
void zLaserBeam::load_attach_to(unsigned int id /* r31 */) {
    // Local variables
    unsigned int size; // r1+0x8
    struct location_asset * location; // r0
    struct xBase * ent; // r0
...
// Range: 0x80132CD0 -> 0x80132D70
// this: r31
void zLaserBeam::load_target(unsigned int id /* r4 */) {
    // Local variables
    struct xBase * obj; // r4
}

// Range: 0x80132D70 -> 0x80132D7C
// this: r0
void zLaserBeam::load_target_direct() {}

// Range: 0x80132D7C -> 0x80132DB4
// this: r0
void zLaserBeam::load_target_movepoint(struct xMovePoint * mp /* r0 */) {}

// Range: 0x80132DB4 -> 0x80132DC4
// this: r0
void zLaserBeam::load_target_entity(struct xEnt * ent /* r0 */) {}

// Range: 0x80132DC4 -> 0x80132E2C
// this: r31
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00ABC
struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8013305C -> 0x801332FC
// this: r31
void zLaserBeam::next_point(float ddist /* f0 */) {
    // Local variables
    struct xVec3 direction; // r1+0x18
    struct xMovePoint * next_mp; // r1+0x8
    struct xMovePoint * prev_mp; // r4
    float u; // f30
...
// Range: 0x801332FC -> 0x8013344C
// this: r28
void zLaserBeam::apply_motion_direct(float start_subdist /* f31 */, float subdist /* f30 */, int motion_flags /* r29 */) {
    // Local variables
    unsigned long i; // r30
    float ddist; // f31
    unsigned long i; // r30
...
// Range: 0x8013344C -> 0x801334E8
// this: r28
void zLaserBeam::apply_motion_movepoint(float start_subdist /* f1 */, float subdist /* f30 */, int motion_flags /* r29 */) {
    // Local variables
    float offset; // f31
    unsigned long i; // r30
}

// Range: 0x801334E8 -> 0x801336EC
// this: r31
void zLaserBeam::update_target(float dt /* f0 */) {
    // Local variables
    struct xVec3 targetOffsetWorld; // r1+0x34
    struct xMat3x3 entRotMat; // r1+0x40
    struct xModelInstance * model; // r0
    int bone; // r4
    const struct xVec3 & bone_dir; // r5
    struct xVec3 dir; // r1+0x28
    struct xVec3 start_loc; // r1+0x1C
}

// Range: 0x801336EC -> 0x80133758
// this: r31
void zLaserBeam::reset_color_anim() {}

// Range: 0x80133758 -> 0x801337CC
// this: r31
void zLaserBeam::update_color_anim(float dt /* f0 */) {
    // Local variables
    float & phase; // r0
}

// Range: 0x801337CC -> 0x801338A8
// this: r0
void zLaserBeam::get_color_anim(float & intensity /* r30 */, float & glow /* r31 */) {
    // Local variables
    float intensity_min; // f0
    float intensity_delta; // f29
    float glow_min; // f0
    float glow_delta; // f28
    float t; // f0
}

// Range: 0x801338A8 -> 0x80133984
// this: r3
void zLaserBeam::update_fade(float dt /* f0 */) {}

// Range: 0x80133984 -> 0x80133A2C
// this: r3
void zLaserBeam::get_fade(float & intensity /* r30 */, float & glow /* r31 */) {
    // Local variables
    struct fade_value value; // r1+0x8
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C00AC8
// Range: 0x80133B80 -> 0x80133E04
// this: r31
...
// total size: 0xC
struct /* @class$1511zLaserBeam_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x80134324 -> 0x80134338
// this: r0
static cb_beam_hits_ent::cb_beam_hits_ent(struct xRay3 & ray /* r0 */, struct xCollis & coll /* r0 */, unsigned int owner_id /* r0 */, unsigned char chkby /* r0 */) {}
...
// total size: 0x4
struct /* @class$2587zLaserBeam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2546zLaserBeam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2547zLaserBeam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2548zLaserBeam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2545zLaserBeam_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2550zLaserBeam_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2260zLaserBeam_cpp */ {
    // Static members
...
// Range: 0x80134338 -> 0x80134620
// this: r30
void zLaserBeam::apply_damage(const struct motion_data & m /* r29 */, struct xEnt * ent /* r31 */) {
    // Local variables
    struct xVec3 knockback_vel; // r1+0x28
    struct xVec3 knockback_perp; // r1+0x1C
    struct xVec3 perpDisp; // r1+0x10
    float parallelComp; // f0
...
// Range: 0x801349D4 -> 0x80134A3C
// this: r3
void zLaserBeam::dispatch(unsigned int event /* r0 */, const float * argf /* r0 */) {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00AD8
// Range: 0x80134A3C -> 0x80134B34
void zLaserBeam::cb_dispatch(struct xBase * from /* r26 */, struct xBase * to /* r31 */, unsigned int event /* r27 */, const float * argf /* r28 */, struct xBase * argw /* r29 */, unsigned int argwi /* r30 */) {
    // Local variables
...
static struct range_type color_anim_range[3]; // size: 0x24, address: 0x803D7360
// total size: 0x28
...
static struct tweak_callback cb_tweak_color_anim; // size: 0x28, address: 0x803D7384
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00AE4
// Range: 0x80134B34 -> 0x80134BF0
static void copy_color_anim(struct debug_info & debug /* r29 */, const struct zLaserBeamAsset & asset /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type color_anim_range[3];
    // -> static char __FUNCTION__[16];
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C00AF4
// Range: 0x80134BF0 -> 0x80134CAC
static void copy_color_anim(struct zLaserBeamAsset & asset /* r29 */, const struct debug_info & debug /* r30 */, int type /* r31 */) {
    // References
    // -> static struct range_type color_anim_range[3];
    // -> static char __FUNCTION__[16];
}

// Range: 0x80134CAC -> 0x80134CFC
// this: r31
...
static struct color_anim_pulse_data default_color_anim_pulse; // size: 0x14, address: 0x80C0BFF4
// total size: 0x4
struct color_anim_flicker_data {
    // Members
    float dummy; // offset 0x0, size 0x4
};
static struct color_anim_flicker_data default_color_anim_flicker; // size: 0x4, address: 0x80C0C008
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00B04
// Range: 0x80134CFC -> 0x80134DF0
// this: r31
...
static struct tweak_callback cb_move_player; // size: 0x28, address: 0x8043A3E0
static signed char init; // size: 0x1, address: 0x80C081AC
static struct tweak_callback cb_reload; // size: 0x28, address: 0x8043A408
static signed char init; // size: 0x1, address: 0x80C081AD
static struct tweak_callback cb_onoff; // size: 0x28, address: 0x8043A430
static signed char init; // size: 0x1, address: 0x80C081AE
static struct tweak_callback cb_rotate_attach_to; // size: 0x28, address: 0x8043A458
static signed char init; // size: 0x1, address: 0x80C081AF
// Range: 0x80134E28 -> 0x801359A8
// this: r30
void zLaserBeam::add_tweaks() {
    ...
    unsigned int mps; // r27
    unsigned int paremits; // r26
...
enum /* @enum$1477zLaserBeam_cpp */ {
    RC_BURN = 0,
    RC_FADE = 1,
    MAX_RC = 2,
    RC_DEFAULT = 0,
};
enum /* @enum$1476zLaserBeam_cpp */ {
    RO_PLANAR = 0,
    RO_TANGENT = 1,
    MAX_RO = 2,
};
enum /* @enum$1475zLaserBeam_cpp */ {
    BV_CARD = 0,
    BV_CONE = 1,
    MAX_BV = 2,
};
enum /* @enum$1480zLaserBeam_cpp */ {
    FO_IMMEDIATE = 0,
    FO_LINEAR = 1,
    FO_BLINK = 2,
    MAX_FO = 3,
};
enum /* @enum$1479zLaserBeam_cpp */ {
    FI_IMMEDIATE = 0,
    FI_LINEAR = 1,
    FI_OVERSHOOT = 2,
    MAX_FI = 3,
};
enum /* @enum$1478zLaserBeam_cpp */ {
    CA_NONE = 0,
    CA_PULSE = 1,
    CA_FLICKER = 2,
    MAX_CA = 3,
};
enum /* @enum$1474zLaserBeam_cpp */ {
    MT_LOOP = 0,
    MT_REVERSE = 1,
    MT_STOP = 2,
    MAX_MT = 3,
};
enum /* @enum$1472zLaserBeam_cpp */ {
    FLAG_ON = 1,
...
// Range: 0x801359A8 -> 0x80135B80
// this: r30
void zLaserBeam::refresh_color_anim_tweaks() {
    // Local variables
    char prefix[128]; // r1+0x8
    struct color_anim_pulse_data & d; // r31
...
// Range: 0x80135B80 -> 0x80135BB4
// this: r31
void zLaserBeam::on_change_color_anim() {}

// Range: 0x80135BB4 -> 0x80135BD8
void zLaserBeam::on_reload(const struct tweak_info & info /* r3 */) {}

// Range: 0x80135BD8 -> 0x80135C1C
void zLaserBeam::on_onoff(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zLaserBeam & owner; // r3
}

// Range: 0x80135C1C -> 0x80135C58
void zLaserBeam::on_rotate_attach_to(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zLaserBeam & owner; // r5
}

// Range: 0x80135C58 -> 0x80135CF4
void zLaserBeam::on_move_player(const struct tweak_info & info /* r0 */) {
    // Local variables
...
// Range: 0x80135CF4 -> 0x80135D18
void zLaserBeam::on_change_color_anim(const struct tweak_info & info /* r3 */) {}
...
// Range: 0x80135D18 -> 0x80135ED8
// this: r30
static unsigned char cb_beam_hits_ent::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
