/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iParMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800E721C -> 0x800E88B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int gColorTableInit; // size: 0x4, address: 0x80C07A20
static float gColorTable[256]; // size: 0x400, address: 0x80B6DFF8
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x800E7364 -> 0x800E7368
void iParMgrUpdate() {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x80432128
// total size: 0x18
...
// Range: 0x800E7368 -> 0x800E7738
void iParMgrRenderParSys_Sprite(void * data /* r25 */, struct xParGroup * ps /* r26 */) {
    // Local variables
    struct xPar * idx; // r29
    ...
    struct RxObjSpace3DVertex * v3d; // r27
    struct xParCmdTex * tex; // r26
    struct xPar * p; // r5
    float size; // f8
    unsigned char r; // r0
    unsigned char g; // r3
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80432144
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x80B6E3F8
static unsigned short i3d[6]; // size: 0xC, address: 0x80BFF3D8
// Range: 0x800E782C -> 0x800E7B48
void iRenderPushQuadStreak(struct xPar * p /* r26 */, struct xParCmdTex * tex /* r27 */) {
    // Local variables
    void * vertices; // r29
    ...
    float v1; // f7
    float v2; // f0
    unsigned short * src; // r0
    unsigned short * dst; // r5
...
static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x80B6E488
static unsigned short i3d[6]; // size: 0xC, address: 0x80BFF3E4
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x800E7B48 -> 0x800E7E9C
static void iRenderPushFlat(struct xPar * p /* r26 */, struct xParCmdTex * tex /* r27 */) {
    // Local variables
    void * vertices; // r29
    unsigned short * indices; // r28
    unsigned char r; // r25
    ...
    unsigned char a; // r22
    float size; // f31
    struct xMat3x3 groundmat; // r1+0x10
    float yaw; // f1
    float u1; // f6
    float u2; // f4
    float v1; // f7
...
// Range: 0x800E7E9C -> 0x800E7F00
void iRenderFlush() {
    // References
    // -> struct tagiRenderInput gRenderBuffer;
}

// Range: 0x800E7F00 -> 0x800E7F78
void iRenderTrianglesImmediate(void * vertices /* r5 */, int vertexCount /* r6 */, unsigned short * indices /* r30 */, int indexCount /* r31 */) {}

// Range: 0x800E7F78 -> 0x800E8164
void iParMgrRenderParSys_Streak(void * data /* r31 */, struct xParGroup * ps /* r0 */) {
    // Local variables
    struct xPar * idx; // r30
    struct RwTexture * texture; // r0
    struct RwRaster * raster; // r4
    struct RxObjSpace3DVertex * v3d; // r4
    float size; // f12
    unsigned char r; // r0
    unsigned char g; // r3
    unsigned char b; // r5
...
// Range: 0x800E8164 -> 0x800E8350
void iParMgrRenderParSys_InvStreak(void * data /* r31 */, struct xParGroup * ps /* r0 */) {
    // Local variables
    struct xPar * idx; // r30
    struct RwTexture * texture; // r0
    struct RwRaster * raster; // r4
...
// Range: 0x800E8350 -> 0x800E83F4
void iParMgrRenderParSys_QuadStreak(void * data /* r29 */, struct xParGroup * ps /* r30 */) {
    // Local variables
    struct xPar * idx; // r31
    struct RwTexture * texture; // r0
    struct RwRaster * raster; // r4
...
// Range: 0x800E83F4 -> 0x800E83F8
void iParMgrRenderParSys_Static() {}

static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x80B6E518
static unsigned short i3d[6]; // size: 0xC, address: 0x80BFF3F0
// Range: 0x800E83F8 -> 0x800E881C
void iParMgrRenderParSys_Ground(void * data /* r22 */, struct xParGroup * ps /* r26 */) {
    // Local variables
    struct xPar * idx; // r29
    struct RwTexture * texture; // r0
    struct RwRaster * raster; // r4
    struct xParCmdTex * tex; // r28
    void * vertices; // r31
    unsigned short * indices; // r27
    float size; // f30
    unsigned char r; // r25
    unsigned char g; // r24
    unsigned char b; // r23
...
// Range: 0x800E881C -> 0x800E88B0
void iParMgrRenderParSys_Flat(void * data /* r29 */, struct xParGroup * ps /* r30 */) {
    // Local variables
    struct xPar * idx; // r31
    struct RwTexture * texture; // r0
    struct RwRaster * raster; // r4
