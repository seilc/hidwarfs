/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCombat.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80259714 -> 0x8025BF30
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char hasAddedToCount; // size: 0x1, address: 0x80C09220
static char * combatBoundsDrawString[4]; // size: 0x10, address: 0x80C05118
static int drawCombatBounds; // size: 0x4, address: 0x80C09224
static unsigned char drawCombatAttack; // size: 0x1, address: 0x80C09228
// total size: 0x8
struct substr {
    // Members
...
// total size: 0x1
struct /* @class$933zCombat_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zCombat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zCombat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zCombat_cpp */ {
    // Members
...
// Range: 0x80259714 -> 0x80259744
static void ExplodeCombatTweaks(const struct tweak_info & info /* r5 */) {}

// Range: 0x80259744 -> 0x802597BC
void zCombatInit() {
    // References
...
// Range: 0x802597BC -> 0x80259820
// this: r30
unsigned char CheckForCollisionWrapper::operator()(struct xEnt & ent /* r31 */) const {}
...
// Range: 0x80259820 -> 0x80259858
// this: r0
int zCombat::Setup(const struct xHierarchyBoundInitData * initHierarchy /* r0 */, unsigned int boundsNumber /* r0 */) {}
...
// Range: 0x80259858 -> 0x8025992C
// this: r24
void zCombat::Init(const struct xHierarchyBoundInitData * initHierarchy /* r25 */, float masterRadius /* f0 */, const class zCombatAttack * stateTable /* r26 */, unsigned short stateTableSize /* r27 */, int hitPoints /* r28 */, float scale /* f0 */, const char * baseName /* r29 */, const char * * boneNames /* r30 */, int boneCount /* r31 */) {
    // Local variables
    char name[128]; // r1+0x8
}

// Range: 0x8025992C -> 0x80259930
void zCombat::PreUpdate() {}

// Range: 0x80259930 -> 0x8025997C
// this: r0
unsigned char zCombat::ShouldRunEffect() {}

// Range: 0x8025997C -> 0x802599BC
// this: r0
class zCombatAttack * zCombat::FindAttackState(unsigned int id /* r0 */) {
    // Local variables
    const class zCombatAttack * result; // r7
    int i; // r0
}

static char __FUNCTION__[11]; // size: 0xB, address: 0x80C05128
// total size: 0x18
struct analog_data {
    // Members
...
// Range: 0x802599BC -> 0x8025A00C
// this: r28
void zCombat::PostUpdate(struct xEnt * ent /* r29 */, float dt /* f31 */) {
    // Local variables
    int i; // r26
    struct xHierarchyNode & node; // r3
    struct effect * rumble; // r26
    unsigned char needToContinue; // r31
    unsigned char resetSphere; // r30
    const struct xAnimState * curState; // r3
    const class zCombatAttack * temp; // r0
    int i; // r25
    unsigned char ranAttack; // r25
    int i; // r25
...
// total size: 0x4
struct /* @class$2274zCombat_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2275zCombat_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x8025A00C -> 0x8025A088
static void GetBonePos(struct xVec3 & pos /* r29 */, int boneNumber /* r30 */, const struct xMat4x3 * mats /* r31 */) {}
...
static struct tweak_callback cb; // size: 0x28, address: 0x80442908
static signed char init; // size: 0x1, address: 0x80C09229
// Range: 0x8025A088 -> 0x8025A168
// this: r30
void zCombat::SetupTweaks(const char * base /* r31 */, struct xEnt * ent /* r0 */, const char * * bones /* r0 */, int boneCount /* r0 */) {
    // References
    // -> static struct tweak_callback cb;
    // -> static signed char init;
}

// Range: 0x8025A168 -> 0x8025A760
// this: r26
void zCombat::ExplodeCombatTweaks(const char * base /* r0 */, int baseSize /* r23 */) {
    // Local variables
    char buffer[128]; // r1+0x48
    int i; // r28
    class zCombatAttack * asset; // r27
    char statename[64]; // r1+0x8
    int i; // r23
}

static struct zCombatDamageInfo * damage_info_stack[4]; // size: 0x10, address: 0x80C0922C
static int damage_info_stack_count; // size: 0x4, address: 0x80C0923C
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C05134
// Range: 0x8025A760 -> 0x8025A7F4
static void PushDamageInfo(const struct zCombatDamageInfo * info /* r0 */) {
    // References
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C05144
// Range: 0x8025A7F4 -> 0x8025A870
...
// Range: 0x8025AA68 -> 0x8025AAA4
unsigned int zCombatGetHitTarget(struct xEnt * attacker /* r0 */, struct xEnt * target /* r0 */) {
    // Local variables
    enum zHitTarget hitTarget; // r0
}
...
// Range: 0x8025AAA4 -> 0x8025ABD0
unsigned int zCombatGetHitTarget(struct xVec3 * attackerPos /* r0 */, struct xEnt * target /* r31 */) {
    // Local variables
    enum zHitTarget hitTarget; // r0
...
// Range: 0x8025ABD0 -> 0x8025AC58
void zCombat::UpdateSphere(struct xSphere * sphere /* r29 */, int boneNumber /* r0 */, const struct xMat4x3 * mats /* r30 */, const struct xVec3 * boneOffset /* r7 */) {
    // Local variables
    struct xVec3 offset; // r1+0x14
    struct xVec3 bone; // r1+0x8
}

struct xGlobals * xglobals; // size: 0x4, address: 0x80C00BE8
// Range: 0x8025AC58 -> 0x8025ADBC
// this: r31
void zCombat::UpdateBounds(struct xEnt * ent /* r4 */) {
    // Local variables
    const struct xVec3 * pos; // r30
    const struct xVec3 * playerCenter; // r5
    struct xVec3 objectDirection; // r1+0x20
    float length2; // f0
    unsigned char rs; // r6
...
static unsigned char done; // size: 0x1, address: 0x80C09240
static signed char init; // size: 0x1, address: 0x80C09241
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C05154
...
// Range: 0x8025ADBC -> 0x8025B0DC
// this: r22
void zCombat::SendObjectHit(struct xEnt * attacker /* r23 */, struct xEnt * target /* r24 */, struct xSurface * surface /* r25 */, enum zHitTarget hitTarget /* r26 */, const struct xVec3 * direction /* r27 */, const struct xVec3 * hit_loc /* r28 */, const struct xVec3 * hit_norm /* r29 */, const struct xVec3 * move_dir /* r30 */, unsigned char hitEffect /* r31 */) {
    // Local variables
    int i; // r0
    struct xVec3 dir; // r1+0x10
    struct zCombatDamageInfo params; // r1+0x1C
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C05164
// Range: 0x8025B0DC -> 0x8025B4FC
// this: r24
void zCombat::CheckForCollision(struct xEnt * attacker /* r25 */, struct xEnt * target /* r26 */, struct xSweptSphere * sphere /* r27 */, const struct xVec3 * hitDirection /* r28 */) {
    // Local variables
    unsigned char isPlayer; // r31
    unsigned char hitIt; // r30
    enum zHitTarget hitTarget; // r29
    struct zCombat * targetCombat; // r29
    signed char subsphere; // r1+0x10
    unsigned short hitTargetU16; // r1+0x12
    struct xVec3 attack_dir; // r1+0x38
    float dot; // f0
    struct xVec3 direction; // r1+0x2C
    struct xVec3 hitLoc; // r1+0x20
    struct xVec3 hitNorm; // r1+0x14
    unsigned char hitEffect; // r27
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C05178
// total size: 0x1C
...
// Range: 0x8025B4FC -> 0x8025B6DC
// this: r27
void zCombat::CheckForCollisionEnv(struct xEnt * attacker /* r28 */, struct xEnv * env /* r29 */, struct xSweptSphere * sphere /* r30 */, const struct xVec3 * hitDirection /* r31 */) {
    // Local variables
    struct xVec3 hdng; // r1+0x10
    unsigned char oldHitEnv; // r26
    struct xSurface * pXSurface; // r26
    struct zSurfaceProps * prop; // r3
    enum iSndGroupHandle pSmackSound; // r0
...
// Range: 0x8025B6DC -> 0x8025B8C4
// this: r30
void zCombat::SweepSphere(struct xEnt * attacker /* r31 */, struct xVec3 * pos1 /* r27 */, struct xVec3 * pos2 /* r29 */, float radius /* f31 */) {
    // Local variables
    struct xVec3 moveDirection; // r1+0x38
    float moveMagnitude2; // f1
    struct xVec3 * moveDirectionPtr; // r28
...
// Range: 0x8025B8C4 -> 0x8025B94C
// this: r27
void zCombat::CheckForHit(struct xEnt * attacker /* r28 */) {
    // Local variables
    int i; // r29
    float radius; // f1
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C05190
...
// Range: 0x8025BAE4 -> 0x8025BB20
// this: r3
void zCombat::StopEffect() {}

// Range: 0x8025BB20 -> 0x8025BB68
// this: r31
void zCombat::RenderEffectModel() {}

// Range: 0x8025BB68 -> 0x8025BB8C
// this: r3
...
static struct xFXRing sBodySlamRing[3]; // size: 0xC0, address: 0x80442930
// Range: 0x8025BB8C -> 0x8025BCEC
// this: r30
void zCombat::UpdateEffect(struct xEnt * attacker /* r31 */, float dt /* f30 */) {
    // Local variables
    float startDiff; // f0
...
// Range: 0x8025BCEC -> 0x8025BD20
// this: r3
void zCombat::ContinueEffect() {}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C0519C
// Range: 0x8025BD20 -> 0x8025BE00
// this: r30
void zCombat::StartBlur(struct xEnt * attacker /* r31 */) {
    // References
    // -> static char __FUNCTION__[10];
}

// Range: 0x8025BE00 -> 0x8025BE80
// this: r30
void zCombat::StopBlur(struct xEnt * attacker /* r31 */) {}

// Range: 0x8025BE80 -> 0x8025BF30
// this: r3
void zCombat::UpdateBlur(struct xEnt * attacker /* r4 */) {}
