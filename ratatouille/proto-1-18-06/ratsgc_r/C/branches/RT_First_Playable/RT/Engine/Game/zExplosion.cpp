/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zExplosion.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801178CC -> 0x8011E3A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char ini_filename[12]; // size: 0xC, address: 0x80C0BBF0
static float decal_cast_dist; // size: 0x4, address: 0x80C00390
static int type; // size: 0x4, address: 0x80C07CE0
static float repeat_every; // size: 0x4, address: 0x80C07CE4
static float emit_height; // size: 0x4, address: 0x80C00394
static float emit_random_offset; // size: 0x4, address: 0x80C00398
static int type; // size: 0x4, address: 0x80C07CE8
static unsigned char active; // size: 0x1, address: 0x80C07CEC
static unsigned char bind_to_player; // size: 0x1, address: 0x80C0039C
static float height; // size: 0x4, address: 0x80C003A0
static float radius_inner; // size: 0x4, address: 0x80C003A4
static float radius_outer; // size: 0x4, address: 0x80C003A8
static float freq; // size: 0x4, address: 0x80C003AC
static float duration; // size: 0x4, address: 0x80C003B0
static int type; // size: 0x4, address: 0x80C07CF0
static float rate; // size: 0x4, address: 0x80C07CF4
static float life; // size: 0x4, address: 0x80C003B4
static float width; // size: 0x4, address: 0x80C003B8
static float length; // size: 0x4, address: 0x80C003BC
static float vel; // size: 0x4, address: 0x80C003C0
static float radius; // size: 0x4, address: 0x80C07CF8
static float gravity; // size: 0x4, address: 0x80C003C4
static float alpha; // size: 0x4, address: 0x80C003C8
static float height_above_player; // size: 0x4, address: 0x80C003CC
static int type; // size: 0x4, address: 0x80C07CFC
static float rate; // size: 0x4, address: 0x80C07D00
static float life; // size: 0x4, address: 0x80C003D0
static float scale; // size: 0x4, address: 0x80C003D4
static float vel_min; // size: 0x4, address: 0x80C003D8
static float vel_max; // size: 0x4, address: 0x80C003DC
static float radius; // size: 0x4, address: 0x80C07D04
static float gravity; // size: 0x4, address: 0x80C003E0
static float alpha; // size: 0x4, address: 0x80C003E4
static float height_above_player; // size: 0x4, address: 0x80C003E8
static unsigned char render_fire; // size: 0x1, address: 0x80C003EC
static unsigned char render_smoke_backface; // size: 0x1, address: 0x80C003ED
static unsigned char render_smoke_frontface; // size: 0x1, address: 0x80C003EE
static unsigned char render_streaks; // size: 0x1, address: 0x80C003EF
static unsigned char render_sparks; // size: 0x1, address: 0x80C003F0
static unsigned char render_presence; // size: 0x1, address: 0x80C07D08
static unsigned char invert_front_back; // size: 0x1, address: 0x80C07D09
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$987zExplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zExplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zExplosion_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zExplosion_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zExplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zExplosion_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zExplosion_cpp */ {
    // Members
...
static struct tweak_callback cb_debug_emit; // size: 0x28, address: 0x803D3600
// Range: 0x801178CC -> 0x80117FFC
...
static unsigned int decal_type_ids[4]; // size: 0x10, address: 0x80C0BC0C
static int decal_blend_mode[3]; // size: 0xC, address: 0x80C0BC1C
static int decal_flags[3]; // size: 0xC, address: 0x80C0BC28
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decal_anim_impact[3]; // size: 0x54, address: 0x803D3628
static struct curve_node decal_anim_burn[7]; // size: 0xC4, address: 0x803D367C
static struct curve_node decal_anim_plasma[3]; // size: 0x54, address: 0x803D3740
static struct xResponseCurve decal_curve[3]; // size: 0x3C, address: 0x80B8FC70
// total size: 0x14
struct anim_data {
    // Members
...
static struct mote * motes; // size: 0x4, address: 0x80C07D0C
static int motes_used; // size: 0x4, address: 0x80C07D10
// total size: 0x40
...
static struct streak_particle * streaks; // size: 0x4, address: 0x80C07D14
static int streaks_used; // size: 0x4, address: 0x80C07D18
// total size: 0x1C
...
static struct streak_emitter * streak_emitters; // size: 0x4, address: 0x80C07D1C
static int streak_emitters_used; // size: 0x4, address: 0x80C07D20
// total size: 0x34
struct RwRaster {
    // Members
...
static struct streak_group * streak_groups; // size: 0x4, address: 0x80C07D24
static int streak_groups_used; // size: 0x4, address: 0x80C07D28
// total size: 0x30
...
static struct spark_particle * sparks; // size: 0x4, address: 0x80C07D2C
static int sparks_used; // size: 0x4, address: 0x80C07D30
// total size: 0x1C
...
static struct spark_emitter * spark_emitters; // size: 0x4, address: 0x80C07D34
static int spark_emitters_used; // size: 0x4, address: 0x80C07D38
// total size: 0x8
struct spark_group {
    // Members
    struct RwTexture * texture; // offset 0x0, size 0x4
...
static struct spark_group * spark_groups; // size: 0x4, address: 0x80C07D3C
static int spark_groups_used; // size: 0x4, address: 0x80C07D40
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x14
struct /* @class$2238zExplosion_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$2239zExplosion_cpp */ {
    // Members
...
static struct ini_config * ini_configs; // size: 0x4, address: 0x80C07D44
enum iSndGroupHandle {
};
// total size: 0x14
struct /* @class$2240zExplosion_cpp */ {
    // Members
    int type; // offset 0x0, size 0x4
    float radius; // offset 0x4, size 0x4
    float duration; // offset 0x8, size 0x4
...
// total size: 0x18
struct /* @class$2241zExplosion_cpp */ {
    // Members
...
static struct runtime_config * runtime_configs; // size: 0x4, address: 0x80C07D48
// total size: 0x8
...
static struct material_group * materials; // size: 0x4, address: 0x80C07D4C
static unsigned int configs_size; // size: 0x4, address: 0x80C07D50
static int materials_used; // size: 0x4, address: 0x80C07D54
// total size: 0x20
...
static struct presence_node presi[32]; // size: 0x780, address: 0x80B8FCAC
static int presi_size; // size: 0x4, address: 0x80C07D58
// Range: 0x80117FFC -> 0x80118040
static int find_decal_type(unsigned int id /* r0 */) {
    // Local variables
    const unsigned int * it; // r4
    const unsigned int * end; // r5

    // References
    // -> static unsigned int decal_type_ids[4];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C003F4
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C00404
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C00410
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C00428
// Range: 0x80118040 -> 0x80118100
static void spawn_streak_emitter(int type /* r28 */, const struct xVec3 & loc /* r29 */) {
    // Local variables
    const struct runtime_config & cfg; // r30
    struct streak_emitter * emitter; // r0
...
// Range: 0x80118100 -> 0x80118188
static struct streak_emitter * alloc_streak_emitter() {
    // Local variables
    struct streak_emitter * se; // r3
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C0043C
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C00448
static char __FUNCTION__[20]; // size: 0x14, address: 0x80C00454
static char __FUNCTION__[19]; // size: 0x13, address: 0x80C00468
// Range: 0x80118188 -> 0x80118248
static void spawn_spark_emitter(int type /* r28 */, const struct xVec3 & loc /* r29 */) {
    // Local variables
    const struct runtime_config & cfg; // r30
    struct spark_emitter * emitter; // r0
...
// Range: 0x80118248 -> 0x801182D0
static struct spark_emitter * alloc_spark_emitter() {
    // Local variables
    struct spark_emitter * se; // r3
...
// Range: 0x801182D0 -> 0x80118388
static void random_direction(struct xVec3 & dir /* r31 */) {
    // Local variables
    float ang; // f29
    float uz; // f28
    float r; // f0
...
// Range: 0x80118388 -> 0x8011846C
static void random_sphere_offset(struct xVec3 & offset /* r31 */, float radius /* f30 */) {
    // Local variables
    float ang; // f28
    float uz; // f27
    float r; // f0
...
// Range: 0x8011846C -> 0x801185F0
static void launch_sphere(int type /* r28 */, int size /* r0 */, const struct xVec3 & loc /* r0 */) {
    // Local variables
    const struct runtime_config & cfg; // r31
    struct mote * m; // r30
    struct mote * endm; // r29
    float r; // f1
    float rv; // f0
...
// Range: 0x801185F0 -> 0x801188D0
static void launch_line(int type /* r25 */, int size /* r28 */, const struct xVec3 & loc0 /* r26 */, const struct xVec3 & offset /* r27 */, float age_delta /* f21 */) {
    // Local variables
    const struct runtime_config & cfg; // r30
    struct xMat3x3 lookmat; // r1+0x40
    struct mote * m; // r29
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C07D5C
static signed char init; // size: 0x1, address: 0x80C07D5D
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C0047C
// Range: 0x801188D0 -> 0x80118AAC
static void emit_streaks(const struct runtime_config & cfg /* r26 */, const struct xVec3 & loc /* r27 */, int amount /* r28 */) {
    // Local variables
    int remaining; // r0
    int group; // r31
    float alpha_vel; // f30
...
// Range: 0x80118AAC -> 0x80118BCC
static struct streak_particle * alloc_streak(int group_index /* r31 */) {
    // Local variables
    struct streak_group & group; // r7
    struct streak_particle * streak; // r30
    struct streak_particle * tail; // r3
    struct streak_group * mg; // r29
    struct streak_group * endmg; // r28
...
// Range: 0x80118C68 -> 0x80118DD4
static void emit_sparks(const struct runtime_config & cfg /* r26 */, const struct xVec3 & loc /* r27 */, int amount /* r28 */) {
    // Local variables
    int remaining; // r0
    int group; // r31
    float alpha_vel; // f30
...
// Range: 0x80118DD4 -> 0x80118EF4
static struct spark_particle * alloc_spark(int group_index /* r31 */) {
    // Local variables
    struct spark_group & group; // r5
    struct spark_particle * spark; // r30
    struct spark_particle * tail; // r3
    struct spark_group * mg; // r29
    struct spark_group * endmg; // r28
...
// total size: 0x4
struct /* @class$1259zExplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1423zExplosion_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
union /* @class$1117zExplosion_cpp */ {
...
// total size: 0x10
struct /* @class$1130zExplosion_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x80118F70 -> 0x80119324
static struct ordered_mote * transform_motes(struct ordered_mote * om /* r29 */) {
    // Local variables
    const struct xMat4x3 & cam_mat; // r0
    float dx; // f29
    float dy; // f28
    float dz; // f27
    float cam_depth; // f0
...
// Range: 0x8011937C -> 0x801196B4
static void ptank_render_streaks() {
    // Local variables
    const struct xMat4x3 & cam_mat; // r0
    struct ptank_pool__color_mat pool; // r1+0x18
    float Ax; // f31
    float Ay; // f30
    float Az; // f29
    struct streak_group * group; // r31
    struct streak_group * end_group; // r30
    struct ptank_pool__color_mat & _fptank_pool; // r29
    int _fptank_used; // r28
    struct xColor_tag * pool_color; // r27
    struct xMat4x3 * pool_mat; // r26
    struct streak_particle * streak; // r25
    struct streak_particle * end_streak; // r24
    struct RwSphere worldsph; // r1+0x8
    float Vx; // f28
    float Vy; // f27
    float Vz; // f26
...
// Range: 0x801196B4 -> 0x80119850
static void ptank_render_sparks() {
    // Local variables
    struct ptank_pool__pos_color_size pool; // r1+0x18
    unsigned char min_alpha; // r31
    struct spark_group * group; // r30
    struct spark_group * end_group; // r29
    struct spark_particle * spark; // r28
    struct spark_particle * end_spark; // r27
    struct RwSphere worldsph; // r1+0x8
...
// Range: 0x80119950 -> 0x80119AD4
static void ptank_render_smoke_frontface(struct ptank_pool__pos_color_size & pool /* r28 */, const struct ordered_mote * om /* r29 */, const struct ordered_mote * end_om /* r30 */) {
    // Local variables
    int material_index; // r31
    const struct runtime_config & cfg; // r31
...
// Range: 0x80119AD4 -> 0x80119C30
static void ptank_render_fire(struct ptank_pool__pos_color_size & pool /* r27 */, const struct ordered_mote * om /* r28 */, const struct ordered_mote * end_om /* r29 */) {
    // Local variables
    int material_index; // r31
    unsigned char min_glow; // r30
    const struct runtime_config & cfg; // r31
...
// Range: 0x80119C30 -> 0x80119DB8
static void ptank_render_smoke_backface(struct ptank_pool__pos_color_size & pool /* r28 */, const struct ordered_mote * om /* r29 */, const struct ordered_mote * end_om /* r30 */) {
    // Local variables
    int material_index; // r31
    const struct runtime_config & cfg; // r31
...
// Range: 0x80119DB8 -> 0x80119DE0
static int compare_ini_sections(void * e1 /* r3 */, void * e2 /* r4 */) {}

// Range: 0x80119DE0 -> 0x80119E08
static int compare_ini_values(void * e1 /* r3 */, void * e2 /* r4 */) {}

// Range: 0x80119E08 -> 0x80119F84
...
// Range: 0x80119F84 -> 0x8011A7F4
static void load_config(struct ini_config & cfg /* r29 */, struct xIniSection & sec /* r30 */, struct xIniFile & ini /* r0 */) {
    // Local variables
    struct xIniValue * values; // r31
    unsigned int decal_type_hash; // r1+0x8
    char buffer[32]; // r1+0xC
    unsigned int total; // r26
    unsigned int i; // r25
}

// Range: 0x8011A828 -> 0x8011A8F0
static unsigned int read_list(float * v /* r29 */, unsigned int vsize /* r28 */, const char * name /* r5 */, const struct xIniValue * values /* r6 */, int values_size /* r7 */) {
    // Local variables
    const struct xIniValue * iv; // r0
    char * nextoken; // r1+0x8
    char * s; // r3
    unsigned int total; // r29
}
...
// Range: 0x8011A8F0 -> 0x8011A934
static struct xIniValue * get_value(const char * name /* r0 */, const struct xIniValue * values /* r0 */, int values_size /* r0 */) {
    // Local variables
    struct xIniValue key; // r1+0x8
}

// Range: 0x8011A934 -> 0x8011A9DC
static void read_value(struct xColor_tag & v /* r29 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
    char * nextoken; // r1+0x8
    char * s; // r3
    unsigned char * c; // r30
    unsigned char * endc; // r29
}

// Range: 0x8011A9DC -> 0x8011AA28
static void read_hashed_text(unsigned int & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

// Range: 0x8011AA28 -> 0x8011AA74
static void read_value(unsigned int & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

// Range: 0x8011AA74 -> 0x8011AAC4
static void read_value(float & v /* r31 */, const char * name /* r4 */, const struct xIniValue * values /* r5 */, int values_size /* r6 */) {
    // Local variables
    const struct xIniValue * iv; // r0
}

static struct curve_node anim[4]; // size: 0x60, address: 0x80439B40
// Range: 0x8011AAC4 -> 0x8011AD04
static void load_default_config_fire(struct ini_config & cfg /* r31 */) {
    // References
    // -> static struct curve_node anim[4];
}

static struct curve_node anim[4]; // size: 0x60, address: 0x80439BA0
// Range: 0x8011AD04 -> 0x8011AF10
static void load_default_config_plasma(struct ini_config & cfg /* r31 */) {
    // References
    // -> static struct curve_node anim[4];
}

static struct curve_node anim[5]; // size: 0x78, address: 0x80439C00
// Range: 0x8011AF10 -> 0x8011B134
...
static struct default_type_loader default_types[3]; // size: 0x18, address: 0x80C0BCD4
void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
// Range: 0x8011B134 -> 0x8011B3C4
static void load_ini_configs() {
    // Local variables
    struct xIniFile * ini; // r31
    struct xIniSection * sections; // r30
    unsigned int memsize; // r1+0x8
    void * mem; // r29
    struct xIniSection * isec; // r27
    struct xIniSection * end_isec; // r26
    struct xIniSection * osec; // r25
    unsigned char is_default; // r24
    const struct default_type_loader * dtl; // r23
    const struct default_type_loader * end_dtl; // r0
    struct ini_config * cfg; // r23
    struct ini_config * end_cfg; // r24
    int i; // r23
    struct ini_config * cfg; // r23
    struct ini_config * end_cfg; // r24
    struct xIniSection * sec; // r25
...
// Range: 0x8011B3E0 -> 0x8011B53C
static void load_config_textures(struct runtime_config & ocfg /* r31 */, const struct ini_config & icfg /* r30 */) {}

// Range: 0x8011B53C -> 0x8011B600
static void refresh_materials() {
    // Local variables
    struct runtime_config * cfg; // r6
    struct runtime_config * end_cfg; // r7
    int mat_index; // r5
...
// Range: 0x8011B600 -> 0x8011B6DC
static void refresh_streak_groups() {
    // Local variables
    struct runtime_config * cfg; // r5
    struct runtime_config * end_cfg; // r6
    int i; // r7
    struct streak_group * sg; // r4
    struct streak_group * endsg; // r0
...
// Range: 0x8011B6DC -> 0x8011B7B8
static void refresh_spark_groups() {
    // Local variables
    struct runtime_config * cfg; // r5
    struct runtime_config * end_cfg; // r6
    int i; // r7
    struct spark_group * sg; // r4
    struct spark_group * endsg; // r0
...
// Range: 0x8011B7B8 -> 0x8011B830
static void update_configs(float dt /* f31 */) {
    // Local variables
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C0048C
// Range: 0x8011B830 -> 0x8011B970
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C0049C
// Range: 0x8011B970 -> 0x8011BAB8
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80C004AC
union entry_node {
...
class xSpacePartitionTree2D space_tree; // size: 0xD4, address: 0x80AA6AD0
// Range: 0x8011BB70 -> 0x8011BC20
...
// Range: 0x8011BC20 -> 0x8011BDFC
static struct presence_node * create_presence(const struct xVec3 & center /* r28 */, float delay /* f24 */, float life /* f25 */, float knockback /* f26 */, float radius_begin /* f27 */, float radius_end /* f28 */, float damage_player /* f29 */, float damage_npc /* f30 */, float damage_other /* f31 */, unsigned char infinite /* r29 */, struct trail_emitter * trail /* r30 */) {
    // Local variables
    struct presence_node * presence; // r31
...
// Range: 0x8011BE6C -> 0x8011BF00
static void damage_reactives(struct presence_node & presence /* r28 */) {
    // Local variables
    struct zEntSimpleObj * reactive_hits[16]; // r1+0x18
    struct xSphere sphere; // r1+0x8
    int reactive_hits_size; // r0
    int i; // r29
}
...
// Range: 0x8011C348 -> 0x8011C460
static void update_streaks(float dt /* f30 */) {
    // Local variables
...
// Range: 0x8011C460 -> 0x8011C5A8
static void free_streak(struct streak_particle * streak /* r29 */) {
    // Local variables
    struct streak_group & group; // r31
    struct streak_particle * tail; // r30
    struct streak_group * mg; // r31
    struct streak_group * endmg; // r29
    struct streak_particle * next; // r30
...
// Range: 0x8011C898 -> 0x8011C9E0
static void free_spark(struct spark_particle * spark /* r29 */) {
    // Local variables
    struct spark_group & group; // r31
    struct spark_particle * tail; // r30
    struct spark_group * mg; // r31
    struct spark_group * endmg; // r29
    struct spark_particle * next; // r30
...
// Range: 0x8011C9E0 -> 0x8011CBF4
static void load_runtime_configs() {
    // Local variables
    struct ini_config * icfg; // r31
    struct ini_config * end_icfg; // r30
    struct runtime_config * ocfg; // r29
...
// Range: 0x8011CBF4 -> 0x8011CBF8
static void add_config_tweaks() {}

char * animix_labels[6]; // size: 0x18, address: 0x80BFC3C0
// Range: 0x8011CD60 -> 0x8011CE4C
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C004C0
// total size: 0x5C
struct emit_context {
    // Members
...
// Range: 0x8011CE4C -> 0x8011CFA8
static void paint_decals(const struct xVec3 & loc /* r30 */, const struct runtime_config & cfg /* r31 */) {
    // Local variables
    struct emit_context ec; // r1+0x8
...
static float repeat_time; // size: 0x4, address: 0x80C07D60
// Range: 0x8011CFA8 -> 0x8011D038
...
// total size: 0x890
struct /* @class$2196zExplosion_cpp */ {
    // Static members
...
// Range: 0x8011D038 -> 0x8011D058
static void debug_emit() {}

// Range: 0x8011D058 -> 0x8011D340
static void debug_init() {
    // Local variables
    const char * prefix; // r30
    unsigned int labels_size; // r31
    const char * * labels; // r30
    unsigned int i; // r4
...
// Range: 0x8011D340 -> 0x8011D394
static void debug_update_test(float dt /* f0 */) {
    // References
    // -> static float repeat_time;
    // -> static float repeat_every;
}
...
static struct trail_emitter te; // size: 0x30, address: 0x80B9042C
static unsigned char was_active; // size: 0x1, address: 0x80C07D64
static signed char init; // size: 0x1, address: 0x80C07D65
static float spiral_time; // size: 0x4, address: 0x80C07D68
static signed char init; // size: 0x1, address: 0x80C07D6C
static struct xVec3 center; // size: 0xC, address: 0x80C004D0
// Range: 0x8011D394 -> 0x8011D5A8
static void debug_update_test_spiral(float dt /* f31 */) {
    // Local variables
    const struct xMat4x3 & mat; // r4
    float frac; // f4
    float ang; // f29
    float radius; // f30
    struct xVec3 norm; // r1+0x14
    struct xVec3 loc; // r1+0x8
...
static float emitted; // size: 0x4, address: 0x80C07D70
static signed char init; // size: 0x1, address: 0x80C07D74
// Range: 0x8011D5A8 -> 0x8011D7BC
static void debug_update_test_streaks(float dt /* f0 */) {
    // Local variables
    int emit; // r31
    int type; // r0
    int group; // r30
    ...
    int i; // r29
    struct streak_particle * streak; // r28
    float ilife; // f2
...
static float emitted; // size: 0x4, address: 0x80C07D78
static signed char init; // size: 0x1, address: 0x80C07D7C
// Range: 0x8011D7BC -> 0x8011D9CC
static void debug_update_test_sparks(float dt /* f0 */) {
    // Local variables
    int emit; // r31
    int type; // r0
    int group; // r30
...
// Range: 0x8011D9CC -> 0x8011DA10
static void debug_update(float dt /* f31 */) {}

// Range: 0x8011DA10 -> 0x8011DA14
static void debug_render() {}

// Range: 0x8011DA14 -> 0x8011DA34
void startup() {}

// Range: 0x8011DA34 -> 0x8011DAE0
void scene_enter() {
    // References
    // -> static int presi_size;
    // -> static struct spark_emitter * spark_emitters;
...
// Range: 0x8011DAE0 -> 0x8011DAE4
void scene_exit() {}

// Range: 0x8011DAE4 -> 0x8011DB70
void reset() {
    // Local variables
    struct presence_node * pres; // r4
    struct presence_node * end_pres; // r5
...
// Range: 0x8011DB70 -> 0x8011DBD4
void update(float dt /* f31 */) {}

// Range: 0x8011DBD4 -> 0x8011DBF4
void pre_render() {}

// Range: 0x8011DBF4 -> 0x8011DC14
void render() {}

// Range: 0x8011DC14 -> 0x8011DC54
int find_type(unsigned int id /* r0 */) {
    // Local variables
    int i; // r5
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C004DC
// Range: 0x8011DC54 -> 0x8011DE30
void emit(int type /* r30 */, const struct xVec3 & loc /* r31 */) {
    // Local variables
    const struct runtime_config & cfg; // r28
    unsigned int motes_available; // r27
    unsigned int motes_required; // r4
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C004E4
// Range: 0x8011DE30 -> 0x8011DF7C
// this: r29
void trail_emitter::start(int type /* r31 */, const struct xVec3 & loc /* r30 */) {
    // Local variables
    const struct runtime_config & cfg; // r31
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C004EC
// Range: 0x8011DF7C -> 0x8011E040
// this: r31
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C004F4
// Range: 0x8011E040 -> 0x8011E3A8
// this: r29
void trail_emitter::update(const struct xVec3 & loc /* r30 */, float dt /* f30 */, float intensity /* f31 */) {
    // Local variables
    const struct runtime_config & cfg; // r31
    int emit_rand; // r0
    int emit_total; // r4
    int motes_available; // r5
    const struct xVec3 & loc0; // r5
    struct xVec3 offset; // r1+0x8
    int streak_amount; // r28
    int spark_amount; // r28
