/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800DC9A4 -> 0x800DCDB0
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFF0B0
unsigned short _RwDlTokenCurrent; // size: 0x2, address: 0x80C06D70
int _rpDlGeomVtxFmtOffset; // size: 0x4, address: 0x80C09EA8
void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
int _rpDlWorldVtxFmtOffset; // size: 0x4, address: 0x80C09EAC
...
// Range: 0x800DC9A4 -> 0x800DCCE4
static void * _iGCUVRenderCallback(void * object /* r28 */, struct RxGameCubePipeData * pipeData /* r29 */) {
    // Local variables
    unsigned int numMeshes; // r19
    struct RxGameCubeVertexBuffer * vbHeader; // r31
    struct RxGameCubeDisplayList * dList; // r30
    struct RpMesh * mesh; // r20
    struct RwMatrixTag * ltm; // r19
    void (* matFunc)(struct RwRGBAReal *, struct RwRGBA *, float); // r31
