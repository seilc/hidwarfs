/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xUpdateCull.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800D19A8 -> 0x800D2540
*/
// total size: 0x10
...
// Range: 0x800D19A8 -> 0x800D1A28
static void xUpdateCull_Swap(struct xUpdateCullMgr * m /* r0 */, unsigned int a /* r0 */, unsigned int b /* r0 */) {
    // Local variables
    struct xUpdateCullEnt * cullA; // r0
    struct xUpdateCullEnt * cullB; // r6
    struct xUpdateCullEnt * curr; // r9
    void * tmpent; // r5
    struct xUpdateCullEnt * tmpmgr; // r5
}

// Range: 0x800D1A28 -> 0x800D1AA4
static void xUpdateCull_MakeActive(struct xUpdateCullMgr * m /* r30 */, struct xUpdateCullEnt * cent /* r31 */) {}

// Range: 0x800D1AA4 -> 0x800D1B28
static void xUpdateCull_MakeInactive(struct xUpdateCullMgr * m /* r30 */, struct xUpdateCullEnt * cent /* r31 */) {}

// Range: 0x800D1B28 -> 0x800D1B30
...
// total size: 0x4
struct /* @class$1097xUpdateCull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235xUpdateCull_cpp */ {
    // Members
...
union /* @class$1236xUpdateCull_cpp */ {
...
// total size: 0x10
struct /* @class$1500xUpdateCull_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x800D1B30 -> 0x800D1BCC
unsigned int xUpdateCull_DistanceSquaredCB(void * ent /* r0 */, void * cbdata /* r0 */) {
    // Local variables
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFED48
void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
unsigned int gActiveHeap; // size: 0x4, address: 0x80C07448
// Range: 0x800D1BCC -> 0x800D2190
struct xUpdateCullMgr * xUpdateCull_Init(void * ent /* r17 */, unsigned int entCount /* r16 */, struct xGroup * * group /* r18 */, unsigned int groupCount /* r31 */) {
    // Local variables
    void * tempEnt; // r23
    unsigned int tempCount; // r22
    unsigned int idx; // r0
    unsigned int i; // r24
    unsigned int j; // r25
    unsigned int k; // r6
    unsigned int gcnt; // r0
    unsigned int entsInThisGroup; // r26
    unsigned int entsInGroups; // r15
    unsigned int nonEmptyGroups; // r16
    unsigned int x; // r0
    unsigned char * inGroupArray; // r21
    struct xBase * base; // r0
    unsigned int mgrCount; // r17
    struct xUpdateCullMgr * m; // r20
    unsigned int grpIndex; // r19
    unsigned int mgrIndex; // r18
    unsigned int startIndex; // r17
    struct xBase * base; // r0
    struct xUpdateCullEnt * * prevPtr; // r9
...
// Range: 0x800D2190 -> 0x800D23A8
void xUpdateCull_Update(struct xUpdateCullMgr * m /* r29 */, unsigned int percent_update /* r0 */) {
    // Local variables
    int numiters; // r31
    unsigned int i; // r27
    struct xUpdateCullEnt * cent; // r27
    unsigned int result; // r0
    struct xUpdateCullGroup * grp; // r30
    struct xUpdateCullEnt * curr; // r5
}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80BFED5C
// Range: 0x800D23A8 -> 0x800D24D8
void xUpdateCull_SetCB(struct xUpdateCullMgr * m /* r28 */, void * entity /* r29 */, unsigned int (* cb)(void *, void *) /* r30 */, void * cbdata /* r31 */) {
    // Local variables
    unsigned int i; // r6
...
// Range: 0x800D24D8 -> 0x800D2540
void xUpdateCull_Reset(struct xUpdateCullMgr * m /* r29 */) {
    // Local variables
    unsigned int i; // r30
}
