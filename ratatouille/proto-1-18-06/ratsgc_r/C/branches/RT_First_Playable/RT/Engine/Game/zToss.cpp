/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zToss.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E9860 -> 0x801E9C6C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801E9860 -> 0x801E9864
void toss::Setup() {}

char __FUNCTION__$localstatic1$GetIndex__32zLightweightSystem<Q21z4toss,10>FUi[9]; // size: 0x9, address: 0x80C03640
// Range: 0x801E9864 -> 0x801E98DC
class toss * toss::find(struct xEnt * ent /* r29 */) {
    // Local variables
    unsigned int i; // r31
    class toss * cur; // r30
}
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0364C
// total size: 0x8
struct xVec2 {
    // Members
...
// Range: 0x801E98DC -> 0x801E9B78
// this: r31
toss::toss(struct xEnt * ent /* r28 */, struct pointer_asset * dest_pointer /* r29 */, float arc_height /* f31 */, float speed /* f30 */, struct xBase * toss_event_sender /* r30 */) {
    // Local variables
    struct xVec2 toDest2d; // r1+0x18
    float m0; // r1+0x14
    float m1; // r1+0x10
    unsigned int num; // r0
    struct xMat3x3 finalMat; // r1+0x20
    struct xMat3x3 * curMat; // r4
...
// Range: 0x801E9B78 -> 0x801E9C6C
// this: r31
void toss::Update(float dt /* f0 */) {
    // Local variables
    float pct; // f31
    struct xVec3 newLoc; // r1+0x18
    float ox; // f3
    struct xQuat curOrient; // r1+0x8
}
