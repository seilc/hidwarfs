/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCPerception.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801FD50C -> 0x801FE6C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801FD50C -> 0x801FD530
static void CLAMP021(float min /* f0 */, float * test /* r0 */, float max /* f0 */) {}

// total size: 0xC
struct {} zNPCPerceptionTarget::__vtable; // size: 0xC, address: 0x80C03BC0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1088zNPCPerception_cpp */ {
    // Members
...
union /* @class$1227zNPCPerception_cpp */ {
...
// total size: 0xC
struct /* @class$1226zNPCPerception_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2251zNPCPerception_cpp */ {
    // Members
...
// Range: 0x801FD554 -> 0x801FD570
// this: r0
void zNPCPerceptionTarget::Reset() {}

// Range: 0x801FD570 -> 0x801FD57C
// this: r0
void zNPCPerceptionTarget::DamagedBy() {}

// Range: 0x801FD57C -> 0x801FD5C0
// this: r31
zNPCPerceptionTarget::~zNPCPerceptionTarget() {
    // References
    // -> struct [anonymous] zNPCPerceptionTarget::__vtable;
...
// Range: 0x801FD5C0 -> 0x801FD5C8
// this: r0
void zNPCPerceptionTarget::SetEnt(struct xEnt * inEnt /* r0 */) {}

// Range: 0x801FD5C8 -> 0x801FD5D0
// this: r0
float zNPCPerceptionTarget::GetPriority() {}

// Range: 0x801FD5D0 -> 0x801FD5E0
// this: r0
void zNPCPerceptionTarget::AddToPriority(float addPriority /* f0 */, float importance /* f0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C03B80
// Range: 0x801FD5E0 -> 0x801FD744
// this: r31
void zNPCPerceptionTarget::CalculateDistance(class zNPCCommon * owner /* r29 */) {
    // Local variables
...
// Range: 0x801FD744 -> 0x801FD74C
// this: r0
float zNPCPerceptionTarget::GetDistance() {}

// Range: 0x801FD74C -> 0x801FD808
// this: r30
void zNPCPerceptionTarget::UpdatePriorityHealth(float importance /* f31 */) {
    // Local variables
    float hpPriority; // r1+0x8
    struct zCommonPlayer * player; // r31
}

// Range: 0x801FD808 -> 0x801FD8B4
// this: r31
void zNPCPerceptionTarget::UpdatePriorityDistance(class zNPCCommon * owner /* r4 */, float importance /* f31 */) {
    // Local variables
    float distPriority; // f1
    float maxRange; // f0
    float tempPriority; // r1+0x8
}

// Range: 0x801FD8B4 -> 0x801FD99C
// this: r29
void zNPCPerceptionTarget::UpdatePriorityFacing(class zNPCCommon * owner /* r30 */, float importance /* f31 */) {
    // Local variables
    struct xVec3 * ownerDir; // r31
    struct xVec3 * targetPos; // r30
    struct xVec3 * ownerPos; // r5
    struct xVec3 toTargetDir; // r1+0xC
    float facingPriority; // r1+0x8
}

// Range: 0x801FD99C -> 0x801FD9A0
...
// Range: 0x801FD9A0 -> 0x801FDAC8
// this: r31
void zNPCPerceptionTarget::UpdatePriorityEquallyDivide(float importance /* f31 */) {
    // Local variables
    int playerSize; // r0
    int ourTotal; // r28
    int otherTotal; // r27
    int i; // r26
    float dividePriority; // r1+0x8
...
// Range: 0x801FDAC8 -> 0x801FDACC
void zNPCPerceptionTarget::UpdatePriorityAttackVulnerabilities() {}

// Range: 0x801FDACC -> 0x801FDAD0
void zNPCPerceptionTarget::UpdatePriorityDefenseVulnerabilities() {}

// Range: 0x801FDAD0 -> 0x801FDB0C
// this: r0
void zNPCPerceptionTarget::UpdatePriorityDamagedBy(float importance /* f1 */) {}

// Range: 0x801FDB0C -> 0x801FDB54
// this: r3
void zNPCPerceptionTarget::UpdatePriorityWidget(float importance /* f2 */) {
    // Local variables
    float widgetPriority; // f1
}
...
// Range: 0x801FDB54 -> 0x801FDC14
// this: r31
void zNPCPerceptionTarget::UpdatePriorityInaction(float importance /* f31 */) {
    // Local variables
    float inactionPriority; // r1+0x8
    class zPlayerInput playerInput; // r1+0xC
}
...
// total size: 0x890
struct /* @class$1946zNPCPerception_cpp */ {
    // Static members
...
// Range: 0x801FDC14 -> 0x801FDCE8
// this: r30
void zNPCPerceptionTarget::UpdatePriority(class zNPCCommon * owner /* r31 */) {}

// Range: 0x801FDCE8 -> 0x801FDD14
// this: r0
void zNPCPerceptionTarget::UpdateBasics(float seconds /* f0 */) {}

// total size: 0x24
struct {} zNPCPerception::__vtable; // size: 0x24, address: 0x8043E9C0
// total size: 0x70
...
// Range: 0x801FDDE8 -> 0x801FDE40
// this: r3
void zNPCPerception::Reset(class zNPCCommon * npc /* r0 */) {
    // Local variables
    int i; // r30
}

// Range: 0x801FDE40 -> 0x801FDEB0
// this: r29
void zNPCPerception::UpdateBasics(float seconds /* f31 */) {
    // Local variables
    int i; // r30
}

// Range: 0x801FDEB0 -> 0x801FDF88
// this: r28
...
int completeUpdateCount; // size: 0x4, address: 0x80C08DD0
// Range: 0x801FDF88 -> 0x801FDF94
void zNPCPerception::ResetCompleteUpdateCount() {
    // References
    // -> int completeUpdateCount;
}

// Range: 0x801FDF94 -> 0x801FDFA0
// this: r0
void zNPCPerception::ForceCompleteUpdate() {}

// Range: 0x801FDFA0 -> 0x801FE010
// this: r0
unsigned char zNPCPerception::CanWeDoCompleteUpdate(float seconds /* f0 */) {
    // References
    // -> int completeUpdateCount;
}

// Range: 0x801FE010 -> 0x801FE0EC
// this: r29
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C03B94
// Range: 0x801FE0EC -> 0x801FE4E4
// this: r25
void zNPCPerception::UpdateCompleteDoWork() {
    // Local variables
    class zNPCPerceptionTarget oldTarget[4]; // r1+0x1C
    int oldTotalTargets; // r27
    int size; // r0
    int i; // r26
    int a; // r22
    struct xEnt * tempWidgetTarget; // r22
    int a; // r22
    int a; // r22
    int b; // r31
...
// Range: 0x801FE510 -> 0x801FE56C
// this: r31
void zNPCPerception::UpdateComplete(float seconds /* f31 */, unsigned char force /* r0 */) {}

static char __FUNCTION__[18]; // size: 0x12, address: 0x80C03BAC
// Range: 0x801FE56C -> 0x801FE5FC
// this: r3
...
// Range: 0x801FE648 -> 0x801FE688
// this: r0
struct xVec3 * zNPCPerception::GetPriorityTargetPos() {
    // Local variables
    struct xEnt * ent; // r0
    struct xVec3 * targetPos; // r0
}

// Range: 0x801FE688 -> 0x801FE6C0
// this: r3
float zNPCPerception::GetPriorityTargetDistance() {}

// total size: 0x4
struct /* @class$2182zNPCPerception_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2183zNPCPerception_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2184zNPCPerception_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2181zNPCPerception_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2186zNPCPerception_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1503zNPCPerception_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$1029zNPCPerception_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1031zNPCPerception_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1032zNPCPerception_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1033zNPCPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1034zNPCPerception_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1035zNPCPerception_cpp */ {
    // Members
