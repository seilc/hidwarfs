/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xMemMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008167C -> 0x800842EC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
void (* sMemBaseNotifyFunc)(); // size: 0x4, address: 0x80C0744C
// Range: 0x8008167C -> 0x800816C8
...
static struct tag_xFile DBSSoakLogFile; // size: 0x114, address: 0x80A7F9FC
static unsigned char DBSSoakLogOpen; // size: 0x1, address: 0x80C07450
static int DBSSceneMemFree; // size: 0x4, address: 0x80BFD310
static unsigned int DBSLastSceneId; // size: 0x4, address: 0x80C07454
static int soakcnt; // size: 0x4, address: 0x80C07458
static signed char init; // size: 0x1, address: 0x80C0745C
static int soakidx; // size: 0x4, address: 0x80C07460
static signed char init; // size: 0x1, address: 0x80C07464
char * * soaklevels; // size: 0x4, address: 0x80C07E68
// Range: 0x800816C8 -> 0x80081908
void xMemDebug_SoakLog(unsigned int SceneId /* r31 */) {
    // Local variables
    const char * DBSFileName; // r30
...
// Range: 0x800819B4 -> 0x800819D8
void xMemExit() {}

static int sMemMgrTrckLogDisplayDumpedDelay; // size: 0x4, address: 0x80C07468
static int sMemMgrUsageTrackerTopLine; // size: 0x4, address: 0x80C0746C
static struct tag_xFile sMemMgrTrckLog; // size: 0x114, address: 0x80A7FB10
static unsigned char sMemMgrTrckLogIsOpen; // size: 0x1, address: 0x80C07470
static unsigned int sMemMgrGenericMallocTag[8]; // size: 0x20, address: 0x80A7FC24
static unsigned int sMemMgrUsageTrackerPackerMallocMem[90]; // size: 0x168, address: 0x80418770
static unsigned int sMemMgrUsageTrackerPackerApproxRWMallocMem[90]; // size: 0x168, address: 0x804188D8
static unsigned int sMemMgrUsageTrackerGenericMallocMem[90]; // size: 0x168, address: 0x80418A40
static struct xMemMgrUsageTrackerLookup xMemMgrUsageTrackerLookupTable[90]; // size: 0x438, address: 0x80418BA8
struct xMemMgrDeptLookup xMemMgrDeptLookupTable[4]; // size: 0x40, address: 0x80418FE0
// Range: 0x800819D8 -> 0x80081A60
void xMemMgrSetDeptMaxMem(unsigned int deptID /* r3 */, unsigned int deptMaxMem /* r0 */) {
    // Local variables
    struct xMemHeap * heap; // r0
    struct xHeapState * sp; // r9
    unsigned int i; // r10
...
// Range: 0x80081C28 -> 0x80081C4C
void xMemMgrUsageTrackerCB() {}

// Range: 0x80081C4C -> 0x80081CC8
static void xMemMgrUsageTrackerGetDeptTotals(unsigned int * totArray /* r29 */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x80081F88 -> 0x80081FB4
void xMemMgrUsageTrackerSetDumpFile(char * filename /* r3 */) {
    // References
    // -> struct xGlobals * xglobals;
}
...
// Range: 0x80081FB4 -> 0x800822DC
void xMemMgrUsageTrackerDumpLog(char * fmt /* r24 */) {
    // Local variables
...
// Range: 0x8008230C -> 0x80082310
void xMemMgrPackerStaticTally() {}

// Range: 0x80082310 -> 0x80082314
void xMemMgrPackerStaticRemove() {}

static char __FUNCTION__[25]; // size: 0x19, address: 0x80419020
// Range: 0x80082314 -> 0x80082434
void xMemMgrPackerMallocTally(unsigned int size /* r27 */, unsigned int tag /* r28 */) {
    // Local variables
    unsigned int deptTotals[4]; // r1+0x8
    unsigned int depmaxmemk; // r29
    const char * depname; // r26
    unsigned int deptot; // r0
...
// Range: 0x80082434 -> 0x80082450
void xMemMgrPackerMallocRemove(unsigned int size /* r0 */, unsigned int tag /* r0 */) {
    // References
    // -> static unsigned int sMemMgrUsageTrackerPackerMallocMem[90];
}

static char __FUNCTION__[33]; // size: 0x21, address: 0x8041903C
// Range: 0x80082450 -> 0x80082570
void xMemMgrPackerApproxRWMallocTally(unsigned int size /* r27 */, unsigned int tag /* r28 */) {
    // Local variables
    unsigned int deptTotals[4]; // r1+0x8
    unsigned int depmaxmemk; // r29
    const char * depname; // r26
...
// Range: 0x80082570 -> 0x8008258C
void xMemMgrPackerApproxRWMallocRemove(unsigned int size /* r0 */, unsigned int tag /* r0 */) {
    // References
    // -> static unsigned int sMemMgrUsageTrackerPackerApproxRWMallocMem[90];
}

static char __FUNCTION__[26]; // size: 0x1A, address: 0x80419060
// Range: 0x8008258C -> 0x800826AC
void xMemMgrGenericMallocTally(unsigned int size /* r27 */, unsigned int tag /* r28 */) {
    // Local variables
    unsigned int deptTotals[4]; // r1+0x8
    unsigned int depmaxmemk; // r29
    const char * depname; // r26
...
// Range: 0x800826AC -> 0x800826DC
void xMemMgrGenericMallocRemove(unsigned int size /* r0 */, unsigned int tag /* r0 */) {
    // References
    // -> static unsigned int sMemMgrUsageTrackerGenericMallocMem[90];
}

static char __FUNCTION__[28]; // size: 0x1C, address: 0x8041907C
// Range: 0x800826DC -> 0x80082788
void xMemMgrGenericMallocPushTag(unsigned int tag /* r0 */) {
    // Local variables
    unsigned char i; // r6
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x80419098
// Range: 0x800827E8 -> 0x800828CC
...
// Range: 0x800828E4 -> 0x8008290C
// this: r0
void xMemMgrUsageTracker::Init() {}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD314
// Range: 0x8008290C -> 0x80082AA4
// this: r25
void xMemMgrUsageTracker::TrackAllocation(unsigned int size /* r26 */, unsigned int tag /* r27 */) {
    // Local variables
    unsigned int deptTotals[4]; // r1+0x8
    unsigned int depmaxmemk; // r28
    const char * depname; // r24
    unsigned int deptot; // r0
...
static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD324
// Range: 0x80082AA4 -> 0x80082B5C
// this: r30
...
// Range: 0x80082B5C -> 0x80082B98
unsigned int xMemMgrGetTotalMemUsageByTag(unsigned int tag /* r3 */) {
    // References
    // -> struct xMemHeap gxHeap[2];
}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFD338
// Range: 0x80082B98 -> 0x80082E2C
void xMemInitHeap(struct xMemHeap * heap /* r27 */, unsigned int base /* r28 */, unsigned int size /* r29 */, unsigned int flags /* r30 */) {
    // Local variables
    unsigned int old_base; // r31
    int align; // r26
    struct xHeapState * sp; // r5

    // References
    // -> static char __FUNCTION__[13];
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80BFD348
// Range: 0x80082E2C -> 0x800830B0
static unsigned int xMemGetBlockInfo(struct xMemHeap * heap /* r22 */, unsigned int size /* r23 */, int align /* r29 */, struct xMemBlkInfo * info /* r24 */) {
    // Local variables
    int total; // r3
    int hdr; // r28
    int pre; // r27
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFD35C
// Range: 0x800830B0 -> 0x8008331C
void * xMemGrowAlloc(unsigned int heapID /* r29 */, unsigned int size /* r27 */, unsigned int tag /* r28 */) {
    // Local variables
    unsigned int oldalignsize; // r0
    struct xMemHeap * heap; // r31
    struct xMemBlock * hdr; // r30
...
static unsigned char already_asserted; // size: 0x1, address: 0x80C07471
static signed char init; // size: 0x1, address: 0x80C07472
static char __FUNCTION__[10]; // size: 0xA, address: 0x80BFD36C
// total size: 0x1C
...
// Range: 0x8008331C -> 0x8008395C
void * xMemAlloc(unsigned int heapID /* r22 */, unsigned int size /* r30 */, int align /* r21 */, unsigned int tag /* r31 */) {
    // Local variables
    int reservedMem; // r28
    int availMem; // r0
    struct xMemHeap * heap; // r27
    struct xMemBlock * hdr; // r26
    struct xHeapState * sp; // r25
    struct xMemBlkInfo info; // r1+0x8
    unsigned int i; // r31
    unsigned int total; // r24
    signed short idx; // r23
    struct xMemHeap * other; // r22
    struct xHeapState * op; // r21
    unsigned int collision; // r20
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80BFD378
// Range: 0x8008395C -> 0x80083AA4
int xMemPushBase(unsigned int heapID /* r30 */) {
    // Local variables
    struct xMemHeap * heap; // r31
...
// Range: 0x80083AFC -> 0x80083B20
int xMemPushBase() {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x80083B20 -> 0x80083B68
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD388
// Range: 0x80083B68 -> 0x80083CE4
int xMemPopBase(unsigned int heapID /* r28 */, int depth /* r27 */) {
    // Local variables
...
// Range: 0x80083CE4 -> 0x80083D0C
int xMemPopBase(int depth /* r4 */) {
    // References
    // -> unsigned int gActiveHeap;
}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80BFD394
// Range: 0x80083D0C -> 0x80083D94
...
// Range: 0x80083D94 -> 0x80083D9C
void xMemRegisterBaseNotifyFunc(void (* func)() /* r0 */) {
    // References
    // -> void (* sMemBaseNotifyFunc)();
}

// Range: 0x80083D9C -> 0x80083DC0
int xMemGetBase() {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x80083DC0 -> 0x80083E68
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80BFD3A0
// Range: 0x80083EB4 -> 0x80083F90
void * xMemPoolAlloc(struct xMemPool * pool /* r27 */, unsigned int memtag /* r28 */) {
    // Local variables
    void * retval; // r3
...
unsigned int scratch_mem_used; // size: 0x4, address: 0x80C07474
static unsigned short scratch_stack[128]; // size: 0x100, address: 0x80A7FC44
static unsigned char scratch_buffer[16384]; // size: 0x4000, address: 0x80A7FD50
static int scratch_allocations; // size: 0x4, address: 0x80C07478
static char __FUNCTION__[16]; // size: 0x10, address: 0x80BFD3B0
// Range: 0x80083FEC -> 0x80084174
void * xMemScratchPush(unsigned int size /* r31 */, unsigned int align /* r28 */) {
    // Local variables
    unsigned char * scratch; // r0
    unsigned int align_mask; // r29
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80BFD3C0
// Range: 0x80084174 -> 0x800842EC
void xMemScratchPop(void * mem /* r31 */) {
    // Local variables
    unsigned char * scratch; // r0
