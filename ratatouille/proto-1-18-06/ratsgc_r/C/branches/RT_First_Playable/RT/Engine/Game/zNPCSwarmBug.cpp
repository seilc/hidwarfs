/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCSwarmBug.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BD918 -> 0x802BDAE8
*/
// total size: 0x68
...
// Range: 0x802BD918 -> 0x802BD920
int zNPCSwarmBug::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {}

char __FUNCTION__$localstatic1$AttachComponent__60zComponentPool<18zCompLogicSwarmBug,11zICompLogic,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06758
signed char zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09778
...
class zComponentPool zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0977C
char __FUNCTION__$localstatic1$AttachComponent__71zComponentPool<26zCompSteeringFlockingBrain,14zICompSteering,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06768
signed char zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09788
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
class zComponentPool zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0978C
char __FUNCTION__$localstatic1$AttachComponent__52zComponentPool<10zCompSound,11zICompSound,8zNPCBase>FP8zNPCBaseP15zCompParameters[16]; // size: 0x10, address: 0x80C06778
signed char zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x80C09798
...
class zComponentPool zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x80C0979C
// Range: 0x802BD920 -> 0x802BD9B8
// this: r31
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C06788
// Range: 0x802BDA34 -> 0x802BDAC8
// this: r30
...
// Range: 0x802BDAC8 -> 0x802BDAE8
// this: r0
void zNPCSwarmBug::Render() {}

// total size: 0x30
struct {} zNPCSwarmBug::__vtable; // size: 0x30, address: 0x80448C18
