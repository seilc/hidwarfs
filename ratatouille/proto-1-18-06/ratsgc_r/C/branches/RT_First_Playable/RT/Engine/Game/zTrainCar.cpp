/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zTrainCar.cpp
...
public:
    ...
    class xNurbs * curve; // offset 0x18, size 0x4
    float forward_u; // offset 0x1C, size 0x4
    float back_u; // offset 0x20, size 0x4
    class segment * next; // offset 0x24, size 0x4
    unsigned char traveling_positive_u; // offset 0x28, size 0x1
};
// total size: 0x8
class zFollowPath {
    // Members
public:
    class segment * front; // offset 0x0, size 0x4
    class segment * free_segments; // offset 0x4, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
class zPathWalker {
    // Members
    class segment * segment; // offset 0x0, size 0x4
    float last_used_u; // offset 0x4, size 0x4
};
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1124zTrainCar_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1262zTrainCar_cpp */ {
    // Members
...
// total size: 0x28
class front_car_data {
    // Members
public:
    class xNurbs * current_path; // offset 0x0, size 0x4
    float front_u; // offset 0x4, size 0x4
    struct xVec3 spline_dir; // offset 0x8, size 0xC
    float spline_dir_mag; // offset 0x14, size 0x4
    class zFollowPath * follow_path; // offset 0x18, size 0x4
    float velocity; // offset 0x1C, size 0x4
    float dest_velocity; // offset 0x20, size 0x4
    float acceleration_time_remain; // offset 0x24, size 0x4
};
// total size: 0x10
...
// total size: 0x8C
class zTrainCarAsset : public xDynAsset {
    // Members
public:
    struct xEntAsset ent_asset; // offset 0x10, size 0x50
    unsigned int parent_car; // offset 0x60, size 0x4
    unsigned int start_spline; // offset 0x64, size 0x4
    float initial_u; // offset 0x68, size 0x4
    float front_axle_dist; // offset 0x6C, size 0x4
    float rear_axle_dist; // offset 0x70, size 0x4
    float front_hitch_dist; // offset 0x74, size 0x4
    float rear_hitch_dist; // offset 0x78, size 0x4
    float axle_width; // offset 0x7C, size 0x4
    unsigned char have_sparks; // offset 0x80, size 0x1
    unsigned char destructible; // offset 0x81, size 0x1
    unsigned int nav_mesh; // offset 0x84, size 0x4
    unsigned char nav_mesh_group_index; // offset 0x88, size 0x1
};
// total size: 0x8
...
// total size: 0x0
class navigation_mesh_driven {};
// total size: 0x124
class zTrainCar : public xEnt {
    // Static members
    static int spark_particle_batch_id; // size: 0x4
    static class zTrainCar * first_train_car; // size: 0x4
    static class zPathWalker * walker; // size: 0x4

    // Members
    class front_car_data * front_car; // offset 0xD8, size 0x4
    class zTrainCarAsset * train_asset; // offset 0xDC, size 0x4
    class zTrainCar * parent_car; // offset 0xE0, size 0x4
    class zTrainCar * child_car; // offset 0xE4, size 0x4
    struct xVec3 front_axle_pos; // offset 0xE8, size 0xC
    struct xVec3 rear_axle_pos; // offset 0xF4, size 0xC
    unsigned char have_positions; // offset 0x100, size 0x1
    class zTrainCar * global_car_list_next; // offset 0x104, size 0x4
    struct zDestructible * destructible; // offset 0x108, size 0x4
    float cur_pos_curviness; // offset 0x10C, size 0x4
    float leftover_sparks[4]; // offset 0x110, size 0x10
    class navigation_mesh_driven * driven_nav_mesh; // offset 0x120, size 0x4
};
// total size: 0x0
struct xSerial {};
// total size: 0x28
...
class zTrainPathJunction : public xBase {
    // Static members
    static class zTrainPathJunction * all_junctions; // size: 0x4

    // Members
    class zTrainPathJunctionAsset * junct_asset; // offset 0x10, size 0x4
    class xNurbs * in_spline; // offset 0x14, size 0x4
    class xNurbs * out1_spline; // offset 0x18, size 0x4
    class xNurbs * out2_spline; // offset 0x1C, size 0x4
