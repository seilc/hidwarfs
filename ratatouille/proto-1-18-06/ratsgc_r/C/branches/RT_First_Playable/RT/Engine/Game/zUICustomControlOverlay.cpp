/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomControlOverlay.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80227754 -> 0x8022846C
*/
// total size: 0x54
struct {} zUICustomControlOverlay::__vtable; // size: 0x54, address: 0x8043F9F8
// total size: 0x10
...
// Range: 0x80227790 -> 0x802277A4
// this: r0
void zUICustomControlOverlay::Init() {}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C04508
// Range: 0x802277A4 -> 0x80227DC4
// this: r31
...
unsigned char inOverlayScreen; // size: 0x1, address: 0x80C09358
float inOverlayScreenExitTimer; // size: 0x4, address: 0x80C0935C
// Range: 0x802283F8 -> 0x8022846C
// this: r3
