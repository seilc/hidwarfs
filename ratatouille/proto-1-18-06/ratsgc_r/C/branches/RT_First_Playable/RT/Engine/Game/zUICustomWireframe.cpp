/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomWireframe.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8022B8AC -> 0x8022BFF4
*/
float WIREFRAME_ROTATE_SPEED; // size: 0x4, address: 0x80C04638
float WIREFRAME_UPDATE_RATE; // size: 0x4, address: 0x80C0463C
unsigned int loadSceneID; // size: 0x4, address: 0x80C08FE8
// total size: 0x54
struct {} zUICustomWireframe::__vtable; // size: 0x54, address: 0x8043FE88
// total size: 0xC
...
// Range: 0x8022B8AC -> 0x8022B8F4
// this: r31
zUICustomWireframe::zUICustomWireframe(class zUI * ui /* r0 */) {
    // References
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04640
// total size: 0x28
struct PKRAssetType {
    // Members
...
void zUICustomWireframe::Init() {
    ...
    const char * hipFilename; // r29
    unsigned char error; // r28
...
unsigned char zUICustomWireframe::PreRender() {
    ...
    unsigned short * indices; // r31
    float WIREFRAME_ROTATE_UNIT; // f3
    float phi; // f30
    float sinPhi; // f0
    float cosPhi; // f0
    float sinTheta; // f0
...
// Range: 0x8022BF84 -> 0x8022BFF0
// this: r0
void zUICustomWireframe::PreUpdate(float dt /* f0 */) {
    // References
    // -> float WIREFRAME_ROTATE_SPEED;
}

// Range: 0x8022BFF0 -> 0x8022BFF4
