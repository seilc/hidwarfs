/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUIIncredibles.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C40F4 -> 0x801C54D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char unlockedMovies[53]; // size: 0x35, address: 0x80BB6970
char sceneBaseName[32]; // size: 0x20, address: 0x80BB69A8
char sceneBaseDescription[256]; // size: 0x100, address: 0x80BB69C8
static const char * SCENE_STATUS_BONUS; // size: 0x4, address: 0x80C08AB8
static unsigned char unlockCheatOn; // size: 0x1, address: 0x80C08ABC
static unsigned char sceneUnlockAll; // size: 0x1, address: 0x80C08ABD
int numScenes; // size: 0x4, address: 0x80C08FB4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801C40F4 -> 0x801C432C
static unsigned int GetSceneNumber(const char * str /* r30 */, unsigned int size /* r31 */, unsigned char * isBM01 /* r0 */) {
    // Local variables
    unsigned int sceneCurrent; // r29
    unsigned char isNumber; // r28
    unsigned int i; // r27
    unsigned int sceneNumber; // r3
    unsigned int i; // r11
    unsigned int id; // r0
    struct xBase * base; // r0
...
// total size: 0x4
struct /* @class$1097zUIIncredibles_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1235zUIIncredibles_cpp */ {
    // Members
...
union /* @class$1236zUIIncredibles_cpp */ {
...
// total size: 0x10
struct /* @class$1484zUIIncredibles_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$1946zUIIncredibles_cpp */ {
    // Static members
...
// total size: 0x2
struct /* @class$1972zUIIncredibles_cpp */ {
    // Members
...
// Range: 0x801C45F8 -> 0x801C4668
static void ParseTagLoadingSceneName(struct jot & j /* r31 */) {
    // Local variables
    const char * sceneName; // r0

    // References
    // -> unsigned int loadSceneID;
}

// Range: 0x801C4668 -> 0x801C46B4
static void ParseTagIgnore(struct jot & j /* r31 */) {}

// Range: 0x801C46B4 -> 0x801C4720
static void ParseTagSpace(struct jot & j /* r31 */) {}

static struct tag_type newTags[7]; // size: 0x8C, address: 0x8043DF70
static unsigned int SCENEFLAGS_UNLOCKED; // size: 0x4, address: 0x80C0CF40
// total size: 0x14
struct SceneUnlock {
    // Members
    unsigned int sceneID; // offset 0x0, size 0x4
...
// Range: 0x801C4720 -> 0x801C47C8
static void zUIUnlockRelatedStages(unsigned int sceneID /* r27 */) {
    // Local variables
    int i; // r29
    struct SceneUnlock * scene; // r28
    int j; // r27
    struct Scene * sceneToUnlock; // r0
...
// Range: 0x801C47C8 -> 0x801C47F0
unsigned char zUIIncrediblesIsSceneCompleted(int idx /* r0 */) {}

// Range: 0x801C47F0 -> 0x801C4818
unsigned char zUIIncrediblesIsSceneUnlocked(int idx /* r0 */) {}

static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043DFFC
static unsigned int SCENEFLAGS_COMPLETED; // size: 0x4, address: 0x80C0CF44
static unsigned int SCENEFLAGS_WAS_COMPLETED; // size: 0x4, address: 0x80C0CF48
// total size: 0x1C
...
int latestScene; // size: 0x4, address: 0x80C08FC0
// Range: 0x801C4818 -> 0x801C4964
unsigned char zUIIncrediblesAdvanceStage() {
    // Local variables
    unsigned char sceneWasCompleted; // r30
    int i; // r29
    struct Scene * scene; // r0
    unsigned int sceneID; // r5
...
// Range: 0x801C4964 -> 0x801C49F0
unsigned char zUIIncrediblesAllGoalsCompleted(unsigned int i /* r0 */) {
    // Local variables
    struct Scene * scene; // r0
    int j; // r0
}

static char __FUNCTION__[32]; // size: 0x20, address: 0x8043E018
// Range: 0x801C49F0 -> 0x801C4A98
...
static char __FUNCTION__[38]; // size: 0x26, address: 0x8043E038
// Range: 0x801C4A98 -> 0x801C4BA4
...
static char __FUNCTION__[39]; // size: 0x27, address: 0x8043E060
// Range: 0x801C4BA4 -> 0x801C4C54
...
static char __FUNCTION__[33]; // size: 0x21, address: 0x8043E088
// Range: 0x801C4C54 -> 0x801C4CFC
...
// Range: 0x801C4CFC -> 0x801C4D44
unsigned char zUIIncrediblesAllCompleted() {}

enum UnlockFeature {
    Unlock_Scenes = 0,
};
int numStoryScenes; // size: 0x4, address: 0x80C08FB8
int numArenaScenes; // size: 0x4, address: 0x80C08FBC
char * allsoaklevels[]; // size: 0x0, address: 0x80BC90A0
char sceneBaseImage[32]; // size: 0x20, address: 0x80BC9418
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x801C4D44 -> 0x801C4E50
void zUIIncrediblesInitINI(struct xIniFile * ini /* r31 */) {
    // Local variables
    struct Scene * sceneMain; // r0
...
// Range: 0x801C5024 -> 0x801C5058
void zUIIncrediblesSceneSetup() {
    // References
    // -> static const char * SCENE_STATUS_BONUS;
}

// Range: 0x801C5058 -> 0x801C5078
unsigned int zUIIncrediblesGetTotalCheckpoints() {}

// Range: 0x801C5078 -> 0x801C5098
unsigned int zUIIncrediblesGetHitCheckpoints() {}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C02DA0
// total size: 0xC
...
// Range: 0x801C5098 -> 0x801C5120
void zUIIncrediblesWarp(struct _xCounter * counter /* r31 */) {
    // References
    // -> static char __FUNCTION__[19];
}

static char __FUNCTION__[25]; // size: 0x19, address: 0x8043E0AC
// Range: 0x801C5120 -> 0x801C5244
void zUIIncrediblesWarpDirect(unsigned int sceneIndex /* r31 */) {
    // Local variables
    struct Scene * scene; // r0
...
static struct _zPortal portal; // size: 0x14, address: 0x80C08AC0
// total size: 0x18
...
// Range: 0x801C535C -> 0x801C5384
void zUIIncrediblesHitCheckPoint() {}

// Range: 0x801C5384 -> 0x801C53A8
void zUIIncrediblesPlayedMovie(int index /* r0 */) {
    // References
    // -> static unsigned char unlockedMovies[53];
}

static char __FUNCTION__[24]; // size: 0x18, address: 0x80C02DB4
// Range: 0x801C53A8 -> 0x801C5458
...
// Range: 0x801C5458 -> 0x801C545C
void zUIIncrediblesSave() {}
...
static enum ePauseType pause_type; // size: 0x4, address: 0x80C08AEC
// Range: 0x801C545C -> 0x801C5464
enum ePauseType zUIIncrediblesGetPauseType() {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x801C5464 -> 0x801C546C
void zUIIncrediblesSetPauseType(enum ePauseType type /* r0 */) {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x801C546C -> 0x801C5470
void zUIIncrediblesLoad() {}

// Range: 0x801C5470 -> 0x801C54A4
unsigned int zUIIncrediblesGetGameProgress() {}

// Range: 0x801C54A4 -> 0x801C54D0
