/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\gc\iDraw.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800D7844 -> 0x800D80A0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float PAL_OFFX; // size: 0x4, address: 0x80BFEED8
float PAL_OFFY; // size: 0x4, address: 0x80BFEEDC
...
static struct RxObjSpace3DVertex gLineVerts[10000]; // size: 0x57E40, address: 0x80AA9000
static unsigned short gLineIndicies[40000]; // size: 0x13880, address: 0x80B00E40
static struct RxObjSpace3DVertex gShadedVerts[10000]; // size: 0x57E40, address: 0x80B146C0
static unsigned int gNumLineVerts; // size: 0x4, address: 0x80C078CC
static unsigned int gNumLineIndices; // size: 0x4, address: 0x80C078D0
static unsigned int gNumShadedVerts; // size: 0x4, address: 0x80C078D4
// Range: 0x800D7A00 -> 0x800D7A14
void iDrawBegin() {
    // References
...
// Range: 0x800D7A14 -> 0x800D7BCC
void iQueueLineList(struct xColor_tag & color /* r30 */, struct RwV3d * verts /* r4 */, unsigned int * indices /* r5 */, struct RwMatrixTag * mat /* r31 */, unsigned int numVerts /* r0 */, unsigned int numIndices /* r0 */) {
    // Local variables
    unsigned int maxi; // r10
    unsigned int i; // r0
...
// Range: 0x800D7CD4 -> 0x800D7FF0
void iDrawShadedQuad(struct xColor_tag & color /* r31 */, struct RwMatrixTag * mat /* r23 */, struct xVec3 * v1 /* r24 */, struct xVec3 * v2 /* r25 */, struct xVec3 * v3 /* r26 */, struct xVec3 * v4 /* r27 */, int cullmode /* r28 */) {
    // Local variables
    struct RwCamera * camera; // r30
    struct RxObjSpace3DVertex * v3d; // r29
    float eyedot; // f0
...
static struct GCmemXFB xfb; // size: 0xC, address: 0x80C078D8
static void * xfbDisp; // size: 0x4, address: 0x80C078E4
static void * xfbCopy; // size: 0x4, address: 0x80C078E8
// Range: 0x800D7FF0 -> 0x800D8018
void iXFBinit() {
    // References
    // -> static void * xfbCopy;
    // -> static void * xfbDisp;
