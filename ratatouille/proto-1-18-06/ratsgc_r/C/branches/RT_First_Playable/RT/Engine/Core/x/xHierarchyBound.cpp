/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xHierarchyBound.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8006E7CC -> 0x8006F270
*/
// Range: 0x8006E7CC -> 0x8006E7F4
static unsigned int CountElements(const char * * list /* r3 */) {
    // Local variables
    const char * * it; // r4
}

// Range: 0x8006E7F4 -> 0x8006E868
static int GetNumberFromString(const char * string /* r0 */, unsigned long size /* r0 */) {
    // Local variables
    const char * end; // r31
    const char * start; // r30
    char buffer[32]; // r1+0x8
}

// total size: 0xC
struct /* @class$930xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932xHierarchyBound_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933xHierarchyBound_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934xHierarchyBound_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935xHierarchyBound_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936xHierarchyBound_cpp */ {
    // Members
...
// Range: 0x8006E868 -> 0x8006E878
static void OnHierarchyRootSelect(const struct tweak_info & info /* r0 */) {}

// Range: 0x8006E878 -> 0x8006E888
static void OnHierarchyRootUnselect(const struct tweak_info & info /* r0 */) {}
...
// Range: 0x8006E888 -> 0x8006E8C4
static void OnHierarchySelect(const struct tweak_info & info /* r4 */) {
    // Local variables
    struct xHierarchyBound * bound; // r31
}

// Range: 0x8006E8C4 -> 0x8006E8D4
static void OnHierarchyUnselect(const struct tweak_info & info /* r0 */) {}
...
static struct tweak_callback tweak_param_cb; // size: 0x28, address: 0x803AF428
// Range: 0x8006E8D4 -> 0x8006EA7C
static void AddHierarchyTweak(const char * base /* r29 */, struct xHierarchyBound * bound /* r30 */, unsigned int which /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    unsigned int boneNameCount; // r7
...
// Range: 0x8006EA7C -> 0x8006EB80
static void OnHierachyChangeCount(const struct tweak_info & info /* r29 */) {
    // Local variables
    struct xHierarchyBound * bound; // r30
    char baseName[128]; // r1+0x88
    const char * nameEnd; // r31
    unsigned int i; // r29
    char buffer[128]; // r1+0x8
    unsigned int i; // r29
}
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFCFA0
...
// Range: 0x8006EB80 -> 0x8006EC50
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r29 */, const struct xHierarchyBoundInitData * init /* r4 */, unsigned int extraBounds /* r0 */) {
    // Local variables
    unsigned int nodesSize; // r30
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80BFCFB8
// Range: 0x8006EC50 -> 0x8006ED00
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r29 */, unsigned int nodesNumber /* r30 */) {
    // References
    // -> unsigned int gActiveHeap;
    // -> static char __FUNCTION__[21];
}

static char __FUNCTION__[20]; // size: 0x14, address: 0x80BFCFD0
// Range: 0x8006ED00 -> 0x8006EEB0
void xHierarchyBoundInit(struct xHierarchyBound * bound /* r31 */, const struct xHierarchyBoundInitData * init /* r26 */, float masterRadius /* f30 */, float scale /* f31 */) {
    // Local variables
...
// Range: 0x8006EEB0 -> 0x8006EFA4
void xHierarchyBoundDraw(const struct xHierarchyBound * bound /* r23 */, unsigned char mR /* r4 */, unsigned char mG /* r5 */, unsigned char mB /* r6 */, unsigned char mA /* r7 */, unsigned char sR /* r24 */, unsigned char sG /* r25 */, unsigned char sB /* r26 */, unsigned char sA /* r27 */, signed char hilight /* r18 */, unsigned char hR /* r28 */, unsigned char hG /* r29 */, unsigned char hB /* r30 */, unsigned char hA /* r31 */) {
    // Local variables
    unsigned int i; // r18
}
...
// total size: 0x4
struct /* @class$1090xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1228xHierarchyBound_cpp */ {
    // Members
...
union /* @class$1237xHierarchyBound_cpp */ {
...
// Range: 0x8006EFA4 -> 0x8006F070
unsigned char xHierarchyBoundTest(const struct xHierarchyBound * bound /* r24 */, struct xSweptSphere * sphere /* r25 */, unsigned short * boundUserData /* r26 */, signed char * subsphere /* r27 */, unsigned char skipMasterCheck /* r0 */) {
    // Local variables
    unsigned int i; // r28
}

static struct tweak_callback master_tweaks; // size: 0x28, address: 0x803AF450
static struct tweak_callback entry_tweaks; // size: 0x28, address: 0x803AF478
static char __FUNCTION__[30]; // size: 0x1E, address: 0x80417FF8
// Range: 0x8006F070 -> 0x8006F270
void xHierarchyBoundAddDebugTweaks(struct xHierarchyBound * bound /* r28 */, const char * base /* r29 */, const char * * boneNames /* r30 */, int boneCount /* r31 */) {
    // Local variables
    char buffer[128]; // r1+0x8
    unsigned int i; // r30
