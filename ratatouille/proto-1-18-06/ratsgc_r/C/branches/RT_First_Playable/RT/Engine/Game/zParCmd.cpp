/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zParCmd.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801445B8 -> 0x80145714
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zVolume * sClipVolume[32]; // size: 0x80, address: 0x80B9F9D8
static int sClipVolumeTotal; // size: 0x4, address: 0x80C08320
// Range: 0x801445B8 -> 0x80144678
void zParCmdInit() {}

// Range: 0x80144678 -> 0x8014471C
void zParCmdFindClipVolumes() {
    // Local variables
    char findname[64]; // r1+0x8
    class zVolume * vol; // r0
...
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043A708
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8014471C -> 0x801448AC
void xParCmdKillDistance_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r29 */) {
    // Local variables
    struct xPar * p; // r30
    struct xParCmdKillDistance * cmd; // r31
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8043A724
// total size: 0xC
struct /* @class$1415zParCmd_cpp */ {
    // Members
...
// Range: 0x801448AC -> 0x801449E0
void xParCmdClipVolumes_Update(struct xParGroup * ps /* r27 */) {
    // Local variables
    struct xPar * p; // r29
    int i; // r28
...
// Range: 0x801449E0 -> 0x801449E4
void xParCmdPlayerCollision_Update() {}

static char __FUNCTION__[30]; // size: 0x1E, address: 0x8043A740
...
// Range: 0x801449E4 -> 0x80144C28
void xParCmdAnimalMagentism_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r31 */, float dt /* f27 */) {
    // Local variables
    struct xPar * p; // r31
...
static struct xCollis collis; // size: 0x54, address: 0x80B9FA58
// total size: 0x20
struct xQCData {
    // Members
...
static struct xBound bnd_fake; // size: 0x4C, address: 0x8043A760
static char __FUNCTION__[27]; // size: 0x1B, address: 0x8043A7AC
...
// Range: 0x80144C28 -> 0x80144E98
void xParCmdDamagePlayer_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r26 */) {
    // Local variables
    struct xPar * p; // r29
    struct xParCmdDamagePlayer * cmd; // r28
    struct xBound * pbound; // r27
    int last_idx; // r3
    int i; // r0
...
static char __FUNCTION__[18]; // size: 0x12, address: 0x80C00ED0
// total size: 0x2C
...
// Range: 0x80144E98 -> 0x801450E4
void xParCmdJet_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r30 */, float dt /* f31 */) {
    // Local variables
    struct xPar * p; // r30
...
// Range: 0x801450E4 -> 0x80145240
void xParCmdCustom_Grass_Update(struct xParGroup * ps /* r0 */, float dt /* f29 */) {
    // Local variables
    struct xPar * p; // r31
    struct xVec3 center; // r1+0x14
    struct xVec3 dir; // r1+0x8
...
static char __FUNCTION__[26]; // size: 0x1A, address: 0x8043A7C8
// total size: 0x14
struct xParCmdApplyCamMat : public xParCmdAsset {
    // Members
    struct xVec3 apply; // offset 0x8, size 0xC
};
// Range: 0x80145240 -> 0x80145440
void xParCmdApplyCamMat_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r31 */, float dt /* f31 */) {
    // Local variables
    struct xPar * p; // r3
    struct xParCmdApplyCamMat * cmd; // r30
...
float STANK_SLOW_RATE; // size: 0x4, address: 0x80C00EE4
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C00EE8
// total size: 0x1C
...
// Range: 0x80145440 -> 0x80145714
void xParCmdCustom_Update(struct xParCmd * c /* r29 */, struct xParGroup * ps /* r30 */, float dt /* f30 */) {
    // Local variables
    struct xPar * p; // r31
    struct xParCmdCustom * cmd; // r31
    float mdt; // f31
    struct xVec3 center; // r1+0x14
    struct xVec3 dir; // r1+0x8
    float rSqr; // f1
