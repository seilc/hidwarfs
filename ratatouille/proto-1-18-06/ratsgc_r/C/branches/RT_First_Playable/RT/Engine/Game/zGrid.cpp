/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGrid.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012FDEC -> 0x80130710
*/
// total size: 0x18
struct xGridBound {
    // Members
...
static int zGridInitted; // size: 0x4, address: 0x80C08170
static unsigned int special_models[58]; // size: 0xE8, address: 0x8043A1D0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8012FDEC -> 0x8012FE98
static void hack_flag_shadows(struct zScene * s /* r0 */) {
    // Local variables
    const unsigned int * end_special_models; // r5
    struct xBase * * it; // r6
    struct xBase * * end; // r7
    struct xEnt * ent; // r8
    unsigned int * id; // r9
...
// Range: 0x8012FE98 -> 0x8012FF70
void zGridReset(struct zScene * s /* r28 */) {
    // Local variables
    int i; // r30
    struct xBase * base; // r3
    struct xEnt * ent; // r29
}

static char __FUNCTION__[10]; // size: 0xA, address: 0x80C009B8
// total size: 0x18
struct xBox {
    // Members
...
// Range: 0x8012FF70 -> 0x801304D0
void zGridInit(struct zScene * s /* r30 */) {
    // Local variables
    const struct xBox * ebox; // r31
    float min_csize; // f31
    struct xBox osobox; // r1+0x8
...
// Range: 0x80130524 -> 0x80130568
static unsigned char IsEntityGrabbable(struct xEnt * ent /* r0 */) {}

// Range: 0x80130568 -> 0x80130710
