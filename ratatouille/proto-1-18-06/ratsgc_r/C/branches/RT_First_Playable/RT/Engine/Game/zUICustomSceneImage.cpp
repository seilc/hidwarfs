/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUICustomSceneImage.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80229508 -> 0x8022973C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04598
// total size: 0x54
struct {} zUICustomSceneImage::__vtable; // size: 0x54, address: 0x8043FB88
// total size: 0xC
...
// Range: 0x80229508 -> 0x802295BC
// this: r30
zUICustomSceneImage::zUICustomSceneImage(class zUI * ui /* r31 */) {
    // References
...
// Range: 0x8022962C -> 0x80229664
// this: r0
unsigned char zUICustomSceneImage::HandleEvent(struct xBase * from /* r0 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}
...
// total size: 0x4
struct /* @class$1120zUICustomSceneImage_cpp */ {
    // Members
...
union /* @class$855zUICustomSceneImage_cpp */ {
...
// total size: 0xC
struct /* @class$1276zUICustomSceneImage_cpp */ {
    // Members
