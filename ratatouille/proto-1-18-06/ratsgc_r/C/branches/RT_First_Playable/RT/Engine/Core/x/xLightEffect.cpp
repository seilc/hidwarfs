/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Core\x\xLightEffect.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801FC808 -> 0x801FD4CC
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801FC808 -> 0x801FC840
unsigned char xLightEffectIsValid(struct xBase * base /* r0 */) {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03B18
// total size: 0x30
...
// Range: 0x801FC840 -> 0x801FC9EC
void xLightEffectFlicker::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class xLightEffectFlicker * flickerEffect; // r29
...
union /* @class$956xLightEffect_cpp */ {
...
// total size: 0xC
struct /* @class$1277xLightEffect_cpp */ {
    // Members
...
// Range: 0x801FCC64 -> 0x801FCCB0
void xLightEffectFlicker::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r0 */) {}

// Range: 0x801FCCB0 -> 0x801FCCEC
void xLightEffectFlicker::StopEffect(struct xLight & light /* r4 */, unsigned char resetColor /* r0 */) {}
...
// Range: 0x801FCCEC -> 0x801FCE4C
// this: r29
void xLightEffectFlicker::UpdateEffect(struct xLight & light /* r30 */, float dt /* f0 */) {
    // Local variables
    struct xLightEffectFlickerData & flickerData; // r0
    struct _xFColor newColor; // r1+0x8
    float randomNum; // f0
}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03B20
// total size: 0x38
...
// Range: 0x801FCE4C -> 0x801FD004
void xLightEffectStrobe::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
    unsigned long expected_asset_size; // r29
    class xLightEffectStrobe * strobeEffect; // r29

    // References
    // -> static char __FUNCTION__[5];
}

// Range: 0x801FD03C -> 0x801FD2F4
// this: r31
...
// Range: 0x801FD2F4 -> 0x801FD348
void xLightEffectStrobe::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r0 */) {}

// Range: 0x801FD348 -> 0x801FD384
void xLightEffectStrobe::StopEffect(struct xLight & light /* r4 */, unsigned char resetColor /* r0 */) {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C03B28
// Range: 0x801FD384 -> 0x801FD4CC
// this: r28
void xLightEffectStrobe::UpdateEffect(struct xLight & light /* r29 */, float dt /* f0 */) {
    // Local variables
...
// total size: 0x18
struct {} xLightEffectStrobe::__vtable; // size: 0x18, address: 0x80C03B38
// total size: 0x18
struct {} xLightEffectFlicker::__vtable; // size: 0x18, address: 0x80C03B50
// total size: 0x18
struct {} xLightEffectBase::__vtable; // size: 0x18, address: 0x80C03B68
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1121xLightEffect_cpp */ {
    // Members
