/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zGameExtras.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012E39C -> 0x8012EF2C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int g_enableGameExtras; // size: 0x4, address: 0x80C08138
static int g_currDay; // size: 0x4, address: 0x80C0813C
static int g_currMonth; // size: 0x4, address: 0x80C08140
static int g_gameExtraFlags; // size: 0x4, address: 0x80C08144
// total size: 0x4
struct EGGMisc {
    // Members
...
static struct EGGItemFuncs EGGEmpty; // size: 0x10, address: 0x80C00880
static struct EGGItem g_eggBasket[2]; // size: 0x20, address: 0x80439F80
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C00890
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$1085zGameExtras_cpp */ {
    // Members
...
union /* @class$1004zGameExtras_cpp */ {
...
// total size: 0xC
struct /* @class$1249zGameExtras_cpp */ {
    // Members
...
// Range: 0x8012E39C -> 0x8012E4B8
void zGameExtras_SceneInit() {
    // Local variables
    int somethingIsEnabled; // r31
    struct EGGItem * egg_next; // r30
    struct EGGItem * egg; // r29
...
// Range: 0x8012E4B8 -> 0x8012E530
void zGameExtras_SceneReset() {
    // Local variables
    struct EGGItem * egg_next; // r31
    struct EGGItem * egg; // r3
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C008A8
// Range: 0x8012E694 -> 0x8012E8C0
...
static int g_flg_chEnabled; // size: 0x4, address: 0x80C08148
// Range: 0x8012E8C0 -> 0x8012E8CC
...
// Range: 0x8012E8CC -> 0x8012E8F4
void zGameExtras_Save(struct xSerial * xser /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

// Range: 0x8012E8F4 -> 0x8012E930
void zGameExtras_Load(struct xSerial * xser /* r0 */) {
    // Local variables
    int keepers; // r1+0x8
...
static float k_CHEATTIMER_START; // size: 0x4, address: 0x80C008C0
static float sCheatTimer; // size: 0x4, address: 0x80C0814C
static int sCheatInputCount; // size: 0x4, address: 0x80C08150
unsigned int sCheatTestCheats[16]; // size: 0x40, address: 0x80439FD4
unsigned int sCheatSwapCCLR[16]; // size: 0x40, address: 0x8043A014
unsigned int sCheatSwapCCUD[16]; // size: 0x40, address: 0x8043A054
// total size: 0x10
struct GECheat {
    // Members
...
static struct GECheat cheatList[4]; // size: 0x40, address: 0x8043A094
unsigned int sCheatPressed[16]; // size: 0x40, address: 0x8043A0D4
static char __FUNCTION__[10]; // size: 0xA, address: 0x80C008C4
// Range: 0x8012E930 -> 0x8012EAB4
...
// Range: 0x8012EAB4 -> 0x8012EB3C
static void AddToCheatPressed(unsigned int button /* r0 */) {
    // Local variables
    int i; // r0
...
static int displayPresses; // size: 0x4, address: 0x80C08154
static signed char init; // size: 0x1, address: 0x80C08158
...
// Range: 0x8012EB3C -> 0x8012EE2C
void zGameCheatsUpdate(float dt /* f31 */) {
    // Local variables
    int i; // r29
    int startover; // r30
    int i; // r1+0xC
...
// Range: 0x8012EE2C -> 0x8012EE3C
void GEC_CheatFlagAdd(int flg /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

// Range: 0x8012EE3C -> 0x8012EE4C
void GEC_CheatFlagToggle(int flg /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

static unsigned int aid_sndList[7]; // size: 0x1C, address: 0x8043A114
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C008D0
// Range: 0x8012EE4C -> 0x8012EE90
static void GEC_dfltSound() {
    // References
    // -> static unsigned int aid_sndList[7];
}

// Range: 0x8012EE90 -> 0x8012EEC4
static void GEC_cb_TestCheats() {}

// Range: 0x8012EEC4 -> 0x8012EEF8
static void GEC_cb_SwapCCLR() {}

// Range: 0x8012EEF8 -> 0x8012EF2C
