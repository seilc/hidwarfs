/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zMiniGamePickups.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802AEB58 -> 0x802AF228
*/
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C063F0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1120zMiniGamePickups_cpp */ {
    // Members
...
// Range: 0x802AEB58 -> 0x802AEC24
// this: r29
void zMiniGamePickupController::Setup(struct xGroup * inGroup /* r30 */, float spawnTime /* f30 */, float showTime /* f31 */, unsigned char resetTypes /* r31 */) {
    // References
    // -> static char __FUNCTION__[6];
}

static char __FUNCTION__[19]; // size: 0x13, address: 0x80C063F8
// total size: 0x10
...
// Range: 0x802AEC24 -> 0x802AEDB8
// this: r31
void zMiniGamePickupController::SetAvailablePickup(int idx /* r29 */) {
    // Local variables
...
// Range: 0x802AEDB8 -> 0x802AEE88
// this: r31
void zMiniGamePickupController::Update(float dt /* f0 */) {}

static char __FUNCTION__[8]; // size: 0x8, address: 0x80C0640C
// Range: 0x802AEE88 -> 0x802AEF98
// this: r29
void zMiniGamePickupController::AddType(int id /* r28 */, float likelyhood /* f30 */, float activeTime /* f31 */, unsigned int modelID /* r30 */, unsigned int soundID /* r31 */) {
    // References
    // -> static char __FUNCTION__[8];
}

// Range: 0x802AEF98 -> 0x802AEFAC
// this: r0
void zMiniGamePickupController::Reset() {}

// Range: 0x802AEFAC -> 0x802AF004
// this: r31
void zMiniGamePickupController::Render() {}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C06414
// Range: 0x802AF004 -> 0x802AF0F8
// this: r29
int zMiniGamePickupController::GetRandomType() {
    // Local variables
    int typeRangeIndices[16]; // r1+0x8
    int inRangeCount; // r30
    float randomValue; // f0
    int i; // r5
    int pickedIdx; // r0
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C06424
enum iSndGroupHandle {
};
// Range: 0x802AF0F8 -> 0x802AF228
// this: r29
unsigned char zMiniGamePickupController::Test(struct xVec3 * pos /* r30 */, float radius /* f31 */, int * availableIdx /* r31 */) {
    // Local variables
    float dist; // f0
    struct zMiniGamePickupType * testType; // r4
...
// total size: 0x2C
struct {} zMiniGamePickupController::__vtable; // size: 0x2C, address: 0x804483A8
