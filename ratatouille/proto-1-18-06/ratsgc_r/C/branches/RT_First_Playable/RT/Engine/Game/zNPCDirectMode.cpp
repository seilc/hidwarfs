/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCDirectMode.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801F7858 -> 0x801F7858
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x270
class zDirectModeCam : public xCam {
    // Members
    class zPad * pad; // offset 0x140, size 0x4
    struct xVec3 direction; // offset 0x144, size 0xC
    float x; // offset 0x150, size 0x4
    float x_v; // offset 0x154, size 0x4
    float y; // offset 0x158, size 0x4
    float y_v; // offset 0x15C, size 0x4
    struct xVec3 target; // offset 0x160, size 0xC
    float target_v; // offset 0x16C, size 0x4
    struct xVec3 * object_position; // offset 0x170, size 0x4
    float path_v; // offset 0x174, size 0x4
    struct xVec3 lastCameraPosition; // offset 0x178, size 0xC
    class xCamSupportLOSBar losbar; // offset 0x184, size 0x38
    class xCamSupportPath path; // offset 0x1BC, size 0xB0
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$1268zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1607zNPCDirectMode_cpp */ {
    // Members
...
union /* @class$1441zNPCDirectMode_cpp */ {
...
// total size: 0x10
struct /* @class$1454zNPCDirectMode_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
class invis_walk {};
// total size: 0x2D0
class zDirectMode : public zBehaviorImplementation {
    // Members
    class zDirectModeCam cam; // offset 0x30, size 0x270
    class zPad * pad; // offset 0x2A0, size 0x4
    struct xVec3 target; // offset 0x2A4, size 0xC
    float rotation; // offset 0x2B0, size 0x4
    float analog_x; // offset 0x2B4, size 0x4
    float analog_x_v; // offset 0x2B8, size 0x4
    float analog_y; // offset 0x2BC, size 0x4
    float analog_y_v; // offset 0x2C0, size 0x4
    float growEffectTime; // offset 0x2C4, size 0x4
    class invis_walk & controlBehavior; // offset 0x2C8, size 0x4
};
// total size: 0x40
...
// total size: 0xC
struct /* @class$964zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zNPCDirectMode_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zNPCDirectMode_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zNPCDirectMode_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2255zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2037zNPCDirectMode_cpp */ {
    // Static members
...
// total size: 0x4
struct /* @class$2214zNPCDirectMode_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2215zNPCDirectMode_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2216zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2213zNPCDirectMode_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2218zNPCDirectMode_cpp */ {
    // Members
