/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zSparkEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801E7EEC -> 0x801E96FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSparkEmitterAsset default_spark_asset; // size: 0x94, address: 0x80BC2E60
// Range: 0x801E7EEC -> 0x801E7F14
// this: r0
...
const char * defaultTweakPrefix; // size: 0x4, address: 0x80C03610
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$995zSparkEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$996zSparkEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$997zSparkEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$998zSparkEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$999zSparkEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1000zSparkEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1001zSparkEmitter_cpp */ {
    // Members
...
// Range: 0x801E8630 -> 0x801E8634
void zSparkSceneExit() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C03614
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1136zSparkEmitter_cpp */ {
    // Members
...
union /* @class$1091zSparkEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1292zSparkEmitter_cpp */ {
    // Members
...
// Range: 0x801E8634 -> 0x801E87C4
void zSparkEmitter::Load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
static struct tweak_callback tweakCallback; // size: 0x28, address: 0x8043E6E0
static signed char init; // size: 0x1, address: 0x80C08D28
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x10
struct /* @class$1943zSparkEmitter_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// Range: 0x801E8994 -> 0x801E89F0
// this: r31
void zSparkEmitter::EmitOnce(const struct xVec3 & pos /* r0 */, const struct xVec3 & dir /* r0 */) {
    // Local variables
    unsigned char successfulEmit; // r0
}

static char __FUNCTION__[9]; // size: 0x9, address: 0x80C0361C
// Range: 0x801E89F0 -> 0x801E8AD8
// this: r30
void zSparkEmitter::EmitOnce(struct xEnt * ent /* r31 */) {
    // Local variables
...
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C03628
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801E8D94 -> 0x801E91AC
unsigned char zSparkEmitter::EmitSparks(const struct zSparkEmitterAsset & emitData /* r26 */, const struct xVec3 & pos /* r27 */, const struct xVec3 & dir /* r28 */, float dt /* f31 */, int sparkSystemId /* r29 */, int glintSystemId /* r30 */, enum iSndGroupHandle sound /* r31 */) {
    // Local variables
    int num_particles; // r24
    struct xVec3 * locList; // r25
    struct xVec3 * dirList; // r23
    float * lenVelList; // r22
    float cosangle; // f0
    struct xMat3x3 dirMat; // r1+0x10
    int particleCounter; // r28
    struct xVec3 * locPtr; // r21
    struct xVec3 * dirPtr; // r20
    float * lenPtr; // r19
    float ang; // f19
    float uz; // f18
    float r; // f0
    float length; // f0
    const struct lightInfo & light; // r4
...
static char __FUNCTION__[6]; // size: 0x6, address: 0x80C03634
// Range: 0x801E92DC -> 0x801E938C
void zSparkEmitter::Event(struct xBase * from /* r26 */, struct xBase * to /* r27 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */, unsigned int toParamWidgetID /* r31 */) {
    // References
    // -> static char __FUNCTION__[6];
}

// Range: 0x801E938C -> 0x801E947C
// this: r30
void zSparkEmitter::Event(unsigned int toEvent /* r0 */) {}

// Range: 0x801E947C -> 0x801E9520
void zSparkEmitter::updateEmitDir(const struct tweak_info & info /* r0 */) {
    // Local variables
    class zSparkEmitter * s; // r31
    struct zSparkEmitterAsset * a; // r30
    float cpitch; // f0
}

// Range: 0x801E9520 -> 0x801E9584
void zSparkEmitter::AddTweaks(const struct tweak_info & info /* r0 */) {
    // Local variables
...
static struct tweak_callback cb_update_dir; // size: 0x28, address: 0x8043E708
// Range: 0x801E9584 -> 0x801E96FC
// this: r30
void zSparkEmitter::AddTweaks(const char * prefix /* r31 */) {
    // References
    // -> static struct tweak_callback cb_update_dir;
}

enum /* @enum$1090zSparkEmitter_cpp */ {
    FLAG_INITIALLY_ON = 1,
    FLAG_USE_LIGHT = 2,
};
