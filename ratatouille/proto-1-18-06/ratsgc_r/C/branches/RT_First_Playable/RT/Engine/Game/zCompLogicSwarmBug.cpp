/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCompLogicSwarmBug.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802BC5B8 -> 0x802BCCCC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gSwarmBugSteeringParams; // size: 0x8C, address: 0x80BD45B8
...
static class zCompSoundParams gSwarmBugSoundParams; // size: 0x1C, address: 0x80BD4644
// total size: 0x8
...
static struct zCompStateMachineTable gSwarmBugStateMachineTable[2]; // size: 0x10, address: 0x80C06728
// total size: 0x34
...
static char __FUNCTION__[12]; // size: 0xC, address: 0x80C06738
// Range: 0x802BC5CC -> 0x802BC860
// this: r3
unsigned char zCompLogicSwarmBug::SystemEvent(unsigned int to_event /* r30 */, const float * to_param /* r29 */, struct xBase * to_param_widget /* r31 */) {
    // Local variables
...
// total size: 0x30
struct {} zSwarmBugWander::__vtable; // size: 0x30, address: 0x80448A88
// total size: 0x14
class zSwarmBugWander : public zCompState {
    // Functions
    zSwarmBugWander();
};
// Range: 0x802BCA0C -> 0x802BCA98
// this: r31
...
// Range: 0x802BCA98 -> 0x802BCB84
void zSwarmBugWander::Enter(class zNPCBase * owner /* r3 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    int i; // r30
...
// total size: 0x10
struct /* @class$1893zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2289zCompLogicSwarmBug_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2290zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2291zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2288zCompLogicSwarmBug_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$2293zCompLogicSwarmBug_cpp */ {
    // Members
...
// Range: 0x802BCB84 -> 0x802BCCCC
void zSwarmBugWander::Update(class zNPCBase * owner /* r27 */) {
    // Local variables
    class zNPCBase * neighbourNPCs; // r1+0xC
    int numberNeighbourNPCs; // r1+0x8
    ...
    class zCompSteeringBasic * compNPCSteering; // r0
    const struct xEnt * repeller; // r0
    float minPlayerDist2; // f31
    float playerDist2; // f1
    int i; // r28
    class zICompNPCEntity * compNPCEntity; // r0
    struct zCombatDamageInfo combatDamageInfo; // r1+0x10
...
// total size: 0x4
struct /* @class$1173zCompLogicSwarmBug_cpp */ {
    // Members
...
union /* @class$1313zCompLogicSwarmBug_cpp */ {
...
// total size: 0xC
struct /* @class$1311zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$987zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$988zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$989zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$990zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$991zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$992zCompLogicSwarmBug_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$993zCompLogicSwarmBug_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2140zCompLogicSwarmBug_cpp */ {
    // Static members
