/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFXScreenDecal.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802195C4 -> 0x802198B8
*/
static int decalCount; // size: 0x4, address: 0x80C08F10
static class Decal decals[8]; // size: 0x40, address: 0x80BC49C0
// total size: 0x10
struct xFRect {
    // Members
...
// total size: 0xC
struct /* @class$1005zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1006zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1007zFXScreenDecal_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1008zFXScreenDecal_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1009zFXScreenDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1010zFXScreenDecal_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1011zFXScreenDecal_cpp */ {
    // Members
...
// Range: 0x802195C4 -> 0x802195D0
void zFXScreenDecalSceneEnter() {
    // References
    // -> static int decalCount;
}

// Range: 0x802195D0 -> 0x802195DC
void zFXScreenDecalSceneReset() {
    // References
    // -> static int decalCount;
}

// Range: 0x802195DC -> 0x8021969C
