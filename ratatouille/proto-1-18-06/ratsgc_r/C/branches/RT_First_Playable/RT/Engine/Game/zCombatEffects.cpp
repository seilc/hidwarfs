/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCombatEffects.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8025C1F0 -> 0x8025F538
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct hit_effect_data hit_effects[3][10]; // size: 0x1E0, address: 0x804429F0
// total size: 0xC
struct curve_node {
    // Members
...
static struct curve_node splash_curve[3]; // size: 0x24, address: 0x803FE6A0
enum texture_mode {
    TM_DEFAULT = 0,
    TM_RANDOM = 1,
    TM_CYCLE = 2,
...
// total size: 0x18
struct /* @class$1936zCombatEffects_cpp */ {
    // Members
...
static struct config decal_config[1]; // size: 0x28, address: 0x80442BD0
// total size: 0x80
...
static struct decal_emitter_data decal_emitters[1]; // size: 0x80, address: 0x80442BF8
static float rock_alpha; // size: 0x4, address: 0x80C051A8
static float rock_size; // size: 0x4, address: 0x80C051AC
static float rock_velocity; // size: 0x4, address: 0x80C051B0
static float rock_random_velocity; // size: 0x4, address: 0x80C051B4
static float rock_lifetime; // size: 0x4, address: 0x80C051B8
static float rock_emit_rate; // size: 0x4, address: 0x80C051BC
static float rock_min_y_vel; // size: 0x4, address: 0x80C051C0
static float rock_gravity; // size: 0x4, address: 0x80C051C4
static float rock_color; // size: 0x4, address: 0x80C051C8
static float rock_bounce_factor; // size: 0x4, address: 0x80C051CC
static float rock_system_emit_time; // size: 0x4, address: 0x80C051D0
...
// Range: 0x8025C2B0 -> 0x8025C2EC
// this: r31
void SparkParticleSystem::reset(const struct xVec3 & loc /* r0 */, const struct xVec3 & dir /* r0 */) {}
...
// Range: 0x8025C59C -> 0x8025C824
// this: r27
void SparkParticleSystem::emit(float dt /* f28 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1350zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1488zCombatEffects_cpp */ {
    // Members
...
union /* @class$1015zCombatEffects_cpp */ {
...
// total size: 0x10
struct /* @class$1028zCombatEffects_cpp */ {
    // Members
...
// Range: 0x8025C824 -> 0x8025CA34
int SparkParticleSystem::update(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
    struct SparkParticle * p; // r30
...
static float bits_min_life; // size: 0x4, address: 0x80C051D4
static float bits_max_life; // size: 0x4, address: 0x80C051D8
static float bits_min_size; // size: 0x4, address: 0x80C051DC
static float bits_max_size; // size: 0x4, address: 0x80C051E0
static float bits_rot_max; // size: 0x4, address: 0x80C051E4
static float bits_rot_min; // size: 0x4, address: 0x80C051E8
static float bits_rot_slow; // size: 0x4, address: 0x80C051EC
static float bits_velocity; // size: 0x4, address: 0x80C051F0
static float bits_emit_rate; // size: 0x4, address: 0x80C051F4
static float bits_gravity; // size: 0x4, address: 0x80C051F8
static unsigned char bits_r; // size: 0x1, address: 0x80C051FC
static unsigned char bits_g; // size: 0x1, address: 0x80C051FD
static unsigned char bits_b; // size: 0x1, address: 0x80C051FE
static float bits_system_emit_time; // size: 0x4, address: 0x80C05200
static float bits_bounce_factor; // size: 0x4, address: 0x80C09248
static class ParticleSystem * par_emitters[3]; // size: 0xC, address: 0x80C0924C
// total size: 0x4
struct node {
    // Members
    float t; // offset 0x0, size 0x4
...
static struct xResponseCurve proj_curve; // size: 0x14, address: 0x80C09258
static char * emitter_labels[1]; // size: 0x4, address: 0x80C05204
// Range: 0x8025CA34 -> 0x8025CB6C
...
static char * labels[10]; // size: 0x28, address: 0x80442C78
// Range: 0x8025CB6C -> 0x8025CC14
...
static struct curve_node proj_decal_curve[3]; // size: 0x54, address: 0x803FE6C4
// Range: 0x8025CC14 -> 0x8025CCA8
...
// Range: 0x8025CCFC -> 0x8025CDF8
static void emit_decal(const struct decal_data & decal /* r29 */, const struct xVec3 & loc /* r30 */, const struct xVec3 & dir /* r31 */) {
    // Local variables
    struct xDecalEmitter & emitter; // r26
    int first; // r0
    int last; // r0
    int which; // r27
    struct xMat4x3 mat; // r1+0x20
    struct xVec3 decalsize; // r1+0x10
...
// total size: 0x1C
struct /* @class$1937zCombatEffects_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$1939zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$964zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$965zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$966zCombatEffects_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$967zCombatEffects_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$968zCombatEffects_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$969zCombatEffects_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$970zCombatEffects_cpp */ {
    // Members
...
// Range: 0x8025CDF8 -> 0x8025CED8
static void emit_surface_decal(const struct xVec3 & loc /* r29 */, const struct xVec3 & dir /* r30 */, const struct zHitDecalData & data /* r31 */) {
    // Local variables
...
static signed char init; // size: 0x1, address: 0x80C0926C
static class SparkParticleSystem sparkSystem; // size: 0x88, address: 0x80BCB698
static signed char init; // size: 0x1, address: 0x80C0926D
// total size: 0x5C
...
static class RockParticleSystem rockSystem; // size: 0x5C, address: 0x80BCB720
static signed char init; // size: 0x1, address: 0x80C0926E
// total size: 0x5C
...
static class BitsParticleSystem bitsSystem; // size: 0x5C, address: 0x80BCB77C
// Range: 0x8025CED8 -> 0x8025D010
static void init_par_emitters() {
    // Local variables
    int i; // r29
    class ParticleSystem & ed; // r28
...
// Range: 0x8025D0FC -> 0x8025D2F8
void hit_effect(const class zCombatAttack * runningAttack /* r28 */, struct xSurface * surface /* r0 */, const struct xVec3 * hit_loc /* r29 */, const struct xVec3 * hit_norm /* r30 */, unsigned char connect /* r31 */) {
    // Local variables
    unsigned int hitSurfaceType; // r4
    unsigned int surfaceType; // r3
    struct hit_effect_data & hit_effect; // r27
    const struct zHitDecalData & decalData; // r5
    struct xColor_tag start; // r1+0x14
    struct xColor_tag end; // r1+0x10
    struct xColor_tag start; // r1+0xC
    struct xColor_tag end; // r1+0x8
...
// Range: 0x8025D2F8 -> 0x8025D398
void update_hit_effects(float dt /* f30 */) {
    // Local variables
    int i; // r30
...
// Range: 0x8025D398 -> 0x8025D3B0
static void start_spiral_ribbon(struct spiral_data & data /* r0 */) {}

// Range: 0x8025D3B0 -> 0x8025D53C
static void spiral_ribbon_emit(struct xFXRibbon & ribbon /* r28 */, struct spiral_config & cfg /* r29 */, struct spiral_data & data /* r30 */, const struct xVec3 & center /* r31 */, float frac /* f29 */) {
    // Local variables
    float ang; // f31
    float radius; // f30
    ...
    float so; // f0
    float co; // f0
    struct xVec3 otan; // r1+0x8
}

// Range: 0x8025D53C -> 0x8025D684
static void update_spiral_ribbon(struct xFXRibbon & ribbon /* r27 */, struct spiral_config & cfg /* r28 */, struct spiral_data & data /* r29 */, const struct xVec3 & center /* r6 */, float dt /* f0 */) {
    // Local variables
    float oldtime; // f31
    int emit; // r31
...
static struct xFXRibbon slam_drop_ribbon; // size: 0x14, address: 0x80C09270
// total size: 0x38
...
static struct spiral_config slam_drop_cfg; // size: 0x38, address: 0x80442CA0
// total size: 0xC
struct spiral_data {
    // Members
...
static struct spiral_data slam_drop_data; // size: 0xC, address: 0x80C09284
// Range: 0x8025D684 -> 0x8025D688
void init_slam_drop_ribbon() {}

// Range: 0x8025D688 -> 0x8025D6B8
...
// Range: 0x8025D6B8 -> 0x8025D6EC
void update_slam_drop_ribbon(const struct xVec3 & center /* r6 */, float dt /* f0 */) {
    // References
    // -> static struct spiral_data slam_drop_data;
    // -> static struct spiral_config slam_drop_cfg;
    // -> static struct xFXRibbon slam_drop_ribbon;
...
static struct xFXRibbon slam_land_ribbon[3]; // size: 0x3C, address: 0x80BCB7D8
static struct spiral_config slam_land_cfg[3]; // size: 0xA8, address: 0x80442CD8
static struct spiral_data slam_land_data[3]; // size: 0x24, address: 0x80BCB814
// Range: 0x8025D6EC -> 0x8025D744
...
// Range: 0x8025D7C4 -> 0x8025D844
void update_slam_land_ribbon(const struct xVec3 & center /* r27 */, float dt /* f31 */) {
    // Local variables
    int i; // r28
...
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x80442D80
// total size: 0xC
struct curve_node {
    // Members
    float time; // offset 0x0, size 0x4
...
static struct config_type cfg; // size: 0x20, address: 0x80BCB838
...
// Range: 0x8025D844 -> 0x8025DA40
static void fix_punch_streak_ribbon(struct xFXRibbon * effect /* r30 */, const struct xVec3 * volatile diff /* r1+0x8 */) {
    // Local variables
...
static float streakHeadScale; // size: 0x4, address: 0x80C05208
static float segmentLayDist; // size: 0x4, address: 0x80C0520C
static int averagePrevNormals; // size: 0x4, address: 0x80C05210
static struct xFXRibbon debugStreakRibbon; // size: 0x14, address: 0x80C09290
// total size: 0x38
class PunchEffect {
    // Functions
...
// Range: 0x8025DA40 -> 0x8025DA9C
void PunchEffect::SetPunchEffectColor(struct xColor_tag & color /* r0 */) {
    // References
    // -> static struct xFXRibbon debugStreakRibbon;
    // -> static struct curve_node punch_streak_ribbon_curve[3];
}

// Range: 0x8025DA9C -> 0x8025DB28
static void default_ribbon(struct xFXRibbon * effect /* r31 */) {
    // References
    // -> static struct config_type cfg;
    // -> static struct curve_node punch_streak_ribbon_curve[3];
}

static struct config_type debug_ribbon_cfg; // size: 0x20, address: 0x80BCB858
// Range: 0x8025DB28 -> 0x8025DC0C
...
// Range: 0x8025DC0C -> 0x8025DC9C
// this: r3
void PunchEffect::Start(const class zCombatAttack * runningAttack /* r4 */) {
    // Local variables
    unsigned int i; // r29
...
// Range: 0x8025DC9C -> 0x8025DCAC
// this: r0
void PunchEffect::Continue() {}

// Range: 0x8025DCAC -> 0x8025DCB8
// this: r0
void PunchEffect::Stop() {}

static char __FUNCTION__[13]; // size: 0xD, address: 0x80C05214
// total size: 0x10
struct xQuat {
    // Members
...
// Range: 0x8025DCB8 -> 0x8025E144
// this: r24
void PunchEffect::updateRibbon(unsigned int index /* r25 */, const struct xVec3 * cacheElement /* r26 */, const struct xEntFrame * frame /* r27 */, unsigned int addCount /* r28 */) {
    // Local variables
...
static char __FUNCTION__[7]; // size: 0x7, address: 0x80C05224
// Range: 0x8025E144 -> 0x8025E2C4
// this: r24
void PunchEffect::Update(const class zCombatAttack * runningAttack /* r25 */, struct xEnt * attacker /* r26 */, float dt /* f31 */) {
    // Local variables
    unsigned int cachePos; // r0
    unsigned int addCount; // r28
    unsigned int i; // r27
...
// Range: 0x8025E2C4 -> 0x8025E2C8
void PunchEffect::RenderModels() {}

// Range: 0x8025E2C8 -> 0x8025E348
// this: r29
...
struct {} @unnamed@zCombatEffects_cpp@::RockParticleSystem::__vtable; // size: 0x1C, address: 0x80442DA4
// Range: 0x8025E348 -> 0x8025E358
static char * RockParticleSystem::tweak_name() {}

// Range: 0x8025E358 -> 0x8025E418
// this: r31
...
// Range: 0x8025E418 -> 0x8025E640
static int RockParticleSystem::update(unsigned char * mem /* r30 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f30 */, void * context /* r31 */) {
    // Local variables
    class RockParticleSystem * system; // r0
    struct ptank_pool__pos_color_size_rot & pool; // r29
    struct RockParticle * p; // r28
    struct RockParticle * end; // r27
    float bounce_y; // f28
    struct RwSphere worldsph; // r1+0x8
...
// Range: 0x8025E640 -> 0x8025E6E4
// this: r31
static void RockParticleSystem::reset(const struct xVec3 & loc /* r0 */, const struct xVec3 & dir /* r0 */) {
    // References
    // -> struct xGlobals * xglobals;
...
// total size: 0x4
struct /* @class$2437zCombatEffects_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$2368zCombatEffects_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$2369zCombatEffects_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$2370zCombatEffects_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$2367zCombatEffects_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$2372zCombatEffects_cpp */ {
    // Members
...
// total size: 0x890
struct /* @class$2225zCombatEffects_cpp */ {
    // Static members
...
// Range: 0x8025E91C -> 0x8025EB6C
// this: r28
static void RockParticleSystem::emit(float dt /* f0 */) {
    // Local variables
    float time_passed; // f28
    int emit; // r30
    struct RockParticle * p; // r1+0x8
    int count; // r0
...
// total size: 0x1C
struct {} zCombatEffects::ParticleSystem::__vtable; // size: 0x1C, address: 0x80442DC0
static // total size: 0x1C
struct {} @unnamed@zCombatEffects_cpp@::BitsParticleSystem::__vtable; // size: 0x1C, address: 0x80442DDC
// Range: 0x8025EB6C -> 0x8025EB7C
static char * BitsParticleSystem::tweak_name() {}

// Range: 0x8025EB7C -> 0x8025EC38
// this: r31
...
// Range: 0x8025EC38 -> 0x8025EE94
static int BitsParticleSystem::update(unsigned char * mem /* r27 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f29 */, void * context /* r28 */) {
    // Local variables
    class BitsParticleSystem * system; // r0
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r31
    struct BitParticle * p; // r30
...
// Range: 0x8025EE94 -> 0x8025EF38
// this: r31
static void BitsParticleSystem::reset(const struct xVec3 & loc /* r0 */, const struct xVec3 & dir /* r0 */) {
    // References
    // -> struct xGlobals * xglobals;
    // -> static float bits_system_emit_time;
}

// Range: 0x8025EF38 -> 0x8025F23C
...
// Range: 0x8025F23C -> 0x8025F538
// this: r28
static void BitsParticleSystem::emit(float dt /* f0 */) {
    // Local variables
    float time_passed; // f26
    int emit; // r30
    struct BitParticle * p; // r1+0x8
    int count; // r0
    struct BitParticle * end; // r29
    float dir_dot; // f0
...
// total size: 0x1C
struct {} zCombatEffects::SparkParticleSystem::__vtable; // size: 0x1C, address: 0x80442DF8
