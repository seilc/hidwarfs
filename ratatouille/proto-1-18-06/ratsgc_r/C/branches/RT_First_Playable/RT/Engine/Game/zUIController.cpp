/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zUIController.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801C32F0 -> 0x801C33F0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801C3338 -> 0x801C333C
void zUIController::DoRender() {}

// Range: 0x801C333C -> 0x801C335C
void zUIController_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x801C335C -> 0x801C33B4
void zUIController_Init(class zUIController * text /* r30 */, struct zUIControllerAsset * asset /* r31 */) {}

// total size: 0x64
struct {} zUIController::__vtable; // size: 0x64, address: 0x8043DEB0
