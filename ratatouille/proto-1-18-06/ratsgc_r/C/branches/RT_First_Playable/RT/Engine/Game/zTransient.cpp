/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zTransient.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80173520 -> 0x80173A68
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$1292zTransient_cpp */ {
    // Members
...
union /* @class$1281zTransient_cpp */ {
...
// total size: 0xC
struct /* @class$1439zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1121zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1122zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1123zTransient_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1124zTransient_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1125zTransient_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1126zTransient_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1127zTransient_cpp */ {
    // Members
...
// Range: 0x80173520 -> 0x801735F4
static void get_world_box(struct xBox & world_box /* r28 */) {
    // Local variables
    struct zScene & scene; // r3
    struct xBox box; // r1+0x8
    const struct zFlameEmitter * flame; // r30
    const struct zFlameEmitter * end_flame; // r29
    const struct xBox * jspbox; // r29
    const struct xBox * const end_jspbox; // r30

    // References
    // -> struct zGlobals globals;
}

static char __FUNCTION__[16]; // size: 0x10, address: 0x80C01B40
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x801735F4 -> 0x80173888
static unsigned char cb_check_damage(union entry_data * e /* r30 */, void * context /* r31 */) {
    // Local variables
    struct check_damage_data * data; // r0
    struct damage_result & result; // r29
    const struct zFlame * flame; // r28
    const struct presence_volume * plode; // r28
...
// Range: 0x80173888 -> 0x801738BC
void scene_enter() {
    // Local variables
    struct xBox world_box; // r1+0x8
}

// Range: 0x801738BC -> 0x801738E4
void scene_exit() {}

// Range: 0x801738E4 -> 0x80173904
void setup() {}

// Range: 0x80173904 -> 0x80173930
void reset() {}

// Range: 0x80173930 -> 0x8017396C
void update(float dt /* f31 */) {}

// Range: 0x8017396C -> 0x80173994
void render() {}
...
struct check_damage_data {
    // Members
    struct damage_result * results; // offset 0x0, size 0x4
    int coll_type; // offset 0x4, size 0x4
    int type_filter; // offset 0x8, size 0x4
    int max_results; // offset 0xC, size 0x4
    int total; // offset 0x10, size 0x4
    struct xBound bound; // offset 0x14, size 0x4C
};
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C01B50
// Range: 0x80173994 -> 0x80173A68
int check_damage(struct damage_result * results /* r27 */, const struct xBox & box /* r28 */, int max_results /* r29 */, int coll_type /* r30 */, int type_filter /* r31 */) {
    // Local variables
    struct check_damage_data data; // r1+0x8
