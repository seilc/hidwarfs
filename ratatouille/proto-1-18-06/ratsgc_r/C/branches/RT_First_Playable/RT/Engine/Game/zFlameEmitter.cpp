/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zFlameEmitter.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80125620 -> 0x80126EEC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float rand_offset; // size: 0x4, address: 0x80C07DD0
static float oscil_rate; // size: 0x4, address: 0x80C00698
// Range: 0x80125620 -> 0x801256A0
static void add_tweaks(const char * prefix /* r31 */) {
    // References
    // -> static float oscil_rate;
    // -> static float rand_offset;
}

struct zFlameEmitter * hilighted; // size: 0x4, address: 0x80C07DD4
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct debug_data {
    // Members
    char flame_heat[128]; // offset 0x0, size 0x80
};
// total size: 0xF0
struct zFlameEmitter : public xBase {
    // Functions
    ...
    void get_bounding_box(struct xBox & box) const;
    ...
    void create_flames(int flags);

    void destroy_flames();

    void dump_flames();

    void start_flames_sound();

    void end_flames_sound();
    ...
    void update_heat_stats();

    // Static members
    static struct zFlameEmitter * hilighted; // size: 0x4
...
private:
    ...
    struct handle * flames; // offset 0x64, size 0x4
    struct property_set props; // offset 0x68, size 0x60
    int flames_size; // offset 0xC8, size 0x4
    int flames_allocated; // offset 0xCC, size 0x4
    enum iSndGroupHandle sound_group; // offset 0xD0, size 0x4
    enum xSndHandle sound_playing; // offset 0xD4, size 0x4
    float oscil; // offset 0xD8, size 0x4
    struct xVec3 driverOffset; // offset 0xDC, size 0xC
    struct debug_data * debug; // offset 0xE8, size 0x4
};
// Range: 0x801256A0 -> 0x80125754
// this: r30
void zFlameEmitter::load(const struct asset_type & a /* r31 */) {}

// Range: 0x80125754 -> 0x801257A4
// this: r31
void zFlameEmitter::debug_reset() {}

// Range: 0x801257A4 -> 0x801257DC
// this: r0
void zFlameEmitter::reset() {}

// Range: 0x801257DC -> 0x80125820
// this: r31
void zFlameEmitter::hide() {}

// Range: 0x80125820 -> 0x80125868
// this: r31
void zFlameEmitter::show() {}

// Range: 0x80125868 -> 0x801258B0
// this: r31
void zFlameEmitter::spawn() {}

// Range: 0x801258B0 -> 0x801258F4
// this: r31
void zFlameEmitter::kill() {}

// Range: 0x801258F4 -> 0x80125958
// this: r31
void zFlameEmitter::update(float dt /* f1 */) {
    // References
    // -> static float oscil_rate;
}

// Range: 0x80125958 -> 0x80125978
// this: r0
void zFlameEmitter::render() {}

static char __FUNCTION__[5]; // size: 0x5, address: 0x80C0069C
// Range: 0x80125978 -> 0x80125AF8
void zFlameEmitter::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
struct asset_type : public xDynAsset {
    ...
    struct xVec3 loc; // offset 0x14, size 0xC
    ...
    float damageBoxHeightRatio; // offset 0x40, size 0x4
    float knockback; // offset 0x44, size 0x4
    unsigned int soundID; // offset 0x48, size 0x4
    unsigned int driverID; // offset 0x4C, size 0x4
};
// Range: 0x80125AF8 -> 0x80125B08
...
// Range: 0x80125B08 -> 0x80125B8C
// this: r29
void zFlameEmitter::get_bounding_box(struct xBox & box /* r30 */) const {
    // Local variables
    struct xBox obb; // r1+0x8
}
...
// Range: 0x80125B8C -> 0x80125BC0
void zFlameEmitter::scene_enter() {
    // References
    // -> struct zFlameEmitter * hilighted;
}
...
// Range: 0x80125BC0 -> 0x80125C30
void zFlameEmitter::scene_exit() {
    // Local variables
    struct zScene & scene; // r3
    struct zFlameEmitter * it; // r31
    struct zFlameEmitter * end; // r30
...
// Range: 0x80125C90 -> 0x80125D00
void zFlameEmitter::update_all(float dt /* f31 */) {
    // Local variables
    struct zScene & scene; // r3
    struct zFlameEmitter * it; // r31
    struct zFlameEmitter * end; // r30
...
// Range: 0x80125DC0 -> 0x80125E24
// this: r31
void zFlameEmitter::refresh_mat() {}

// Range: 0x80125E24 -> 0x80125EEC
// this: r30
void zFlameEmitter::refresh_properties() {
    // Local variables
...
// Range: 0x80125EEC -> 0x80125F20
// this: r0
void zFlameEmitter::setup() {}

void * RwEngineInstance; // size: 0x4, address: 0x80C09F34
// Range: 0x80125F20 -> 0x80125F60
// this: r31
void zFlameEmitter::destroy() {
    // References
    // -> void * RwEngineInstance;
}

static char __FUNCTION__[14]; // size: 0xE, address: 0x80C006A4
// total size: 0x30
struct spawn_data {
    // Members
...
// Range: 0x80125F60 -> 0x801264A0
// this: r27
void zFlameEmitter::create_flames(int flags /* r28 */) {
    // Local variables
    float radius; // f29
    float width; // f30
    int ux; // r30
    int uz; // r29
    struct spawn_data sd; // r1+0x3C
    const struct xVec3 & center; // r0
    struct xVec3 dx; // r1+0x30
    struct xVec3 dz; // r1+0x24
    float hx; // f7
    float hz; // f8
    float rr; // f29
    struct xVec3 corner; // r1+0x18
    struct handle * flame; // r25
    struct handle * const end_flame; // r26
    unsigned int ix; // r28
    struct xVec3 v; // r1+0xC
    unsigned int iz; // r24
...
// Range: 0x801264A0 -> 0x80126530
// this: r29
void zFlameEmitter::destroy_flames() {
    // Local variables
    struct handle * flame; // r31
    struct handle * end_flame; // r30
}

// Range: 0x80126530 -> 0x8012656C
// this: r0
void zFlameEmitter::dump_flames() {}

// Range: 0x8012656C -> 0x801265CC
// this: r31
void zFlameEmitter::start_flames_sound() {}

// Range: 0x801265CC -> 0x80126624
// this: r31
void zFlameEmitter::end_flames_sound() {}

static char __FUNCTION__[12]; // size: 0xC, address: 0x80C006B4
// Range: 0x80126624 -> 0x801267D0
void zFlameEmitter::cb_dispatch(struct xBase * to /* r31 */, unsigned int event /* r29 */, const float * argf /* r30 */) {
    // Local variables
    struct zFlameEmitter & e; // r31

    // References
    // -> static char __FUNCTION__[12];
}

// Range: 0x801267D0 -> 0x8012681C
// this: r31
void zFlameEmitter::debug_init() {}

// Range: 0x8012681C -> 0x801268D0
// this: r30
void zFlameEmitter::debug_render() {
    // Local variables
    struct xBox box; // r1+0x8
...
// total size: 0xC
struct /* @class$930zFlameEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$931zFlameEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$932zFlameEmitter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$933zFlameEmitter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$934zFlameEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$935zFlameEmitter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$936zFlameEmitter_cpp */ {
    // Members
...
static struct tweak_callback cb_hilight; // size: 0x28, address: 0x803D5100
static struct tweak_callback cb_visible; // size: 0x28, address: 0x803D5128
static struct tweak_callback cb_move; // size: 0x28, address: 0x803D5150
static struct tweak_callback cb_move_dir; // size: 0x28, address: 0x803D5178
static struct tweak_callback cb_refresh_props; // size: 0x28, address: 0x803D51A0
static struct tweak_callback cb_update_flame_heat; // size: 0x28, address: 0x80439D38
static signed char init; // size: 0x1, address: 0x80C07DD8
// Range: 0x801268D0 -> 0x80126C74
// this: r30
void zFlameEmitter::add_tweaks() {
    // Local variables
    char prefix[128]; // r1+0x38
    struct asset_type & a; // r31

    // References
    // -> static struct tweak_callback cb_update_flame_heat;
    // -> static signed char init;
    // -> static struct tweak_callback cb_refresh_props;
    // -> static struct tweak_callback cb_move;
    // -> static struct tweak_callback cb_move_dir;
    // -> static struct tweak_callback cb_visible;
    // -> static struct tweak_callback cb_hilight;
}

enum /* @enum$1959zFlameEmitter_cpp */ {
    FLAG_GROUND = 1,
    FLAG_VISIBLE = 2,
    FLAG_DRAW_GROUND = 4,
    FLAG_DRAW_SHORT = 8,
};
// Range: 0x80126C74 -> 0x80126C80
void zFlameEmitter::enable_hilight(const struct tweak_info & info /* r0 */) {
    // References
    // -> struct zFlameEmitter * hilighted;
}

// Range: 0x80126C80 -> 0x80126C8C
void zFlameEmitter::disable_hilight() {
    // References
    // -> struct zFlameEmitter * hilighted;
}

// Range: 0x80126C8C -> 0x80126CC8
void zFlameEmitter::on_change_visible(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zFlameEmitter * f; // r3
}

// Range: 0x80126CC8 -> 0x80126D40
void zFlameEmitter::on_move(const struct tweak_info & info /* r0 */) {
    // Local variables
    struct zFlameEmitter * f; // r31
    struct asset_type & a; // r0
}

// Range: 0x80126D40 -> 0x80126D54
void zFlameEmitter::tweak_rtod(void * value /* r0 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x80126D54 -> 0x80126D68
void zFlameEmitter::tweak_dtor(void * value /* r0 */) {
    // Local variables
    float & f; // r0
}

// Range: 0x80126D68 -> 0x80126EA4
// this: r28
void zFlameEmitter::update_heat_stats() {
    // Local variables
    char * s; // r30
    char header_text[29]; // r1+0x8
    int max_entries; // r3
    struct handle * flame; // r29
    struct handle * end_flame; // r28
    int heat; // r3
}
...
// total size: 0x4
struct /* @class$1306zFlameEmitter_cpp */ {
    // Members
...
union /* @class$1214zFlameEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$1453zFlameEmitter_cpp */ {
    // Members
...
// Range: 0x80126EA4 -> 0x80126EC8
void zFlameEmitter::on_update_flame_heat(const struct tweak_info & info /* r3 */) {}

// Range: 0x80126EC8 -> 0x80126EEC
void zFlameEmitter::on_refresh_props(const struct tweak_info & info /* r3 */) {}
