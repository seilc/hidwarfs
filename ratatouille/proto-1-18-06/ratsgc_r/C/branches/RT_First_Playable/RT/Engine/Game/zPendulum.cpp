/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zPendulum.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80145798 -> 0x8014605C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80145798 -> 0x801457B8
void zPendulum_Init(void * pend /* r0 */, void * asset /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00F00
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$1085zPendulum_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1249zPendulum_cpp */ {
    // Members
...
// Range: 0x801457B8 -> 0x801459A0
void zPendulum_Init(struct _zPendulum * pend /* r30 */, struct xEntAsset * asset /* r31 */) {
    // Local variables
    struct xEntMotionAsset * motionAsset; // r31

    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00F10
// total size: 0x0
struct xSerial {};
// Range: 0x801459A0 -> 0x80145A70
void zPendulum_Save(struct _zPendulum * pend /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C00F20
// Range: 0x80145A70 -> 0x80145B40
void zPendulum_Load(struct _zPendulum * pend /* r30 */, struct xSerial * s /* r31 */) {
    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x80145B40 -> 0x80145B84
void zPendulum_Setup(struct _zPendulum * pend /* r30 */, struct xScene * sc /* r31 */) {}

// Range: 0x80145B84 -> 0x80145C88
void zPendulum_Reset(struct _zPendulum * pend /* r30 */, struct xScene * sc /* r31 */) {
    // Local variables
    struct xEntMotionPenData * aspen; // r0
}

// Range: 0x80145C88 -> 0x80145D24
void zPendulum_Update(struct _zPendulum * pend /* r31 */, struct xScene * sc /* r0 */, float dt /* f0 */) {
    // Local variables
    struct xEntMotionPenData * aspen; // r0
    float t; // f2
}

// Range: 0x80145D24 -> 0x80145D48
void zPendulum_Move(struct _zPendulum * pend /* r3 */, struct xScene * s /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r0 */) {}

// Range: 0x80145D48 -> 0x80145D9C
static void zPendulumTranslate(struct xEnt * xent /* r29 */, struct xVec3 * dpos /* r30 */, struct xMat4x3 * dmat /* r31 */) {
    // Local variables
    struct _zPendulum * pend; // r0
}

static char __FUNCTION__[17]; // size: 0x11, address: 0x80C00F30
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// Range: 0x80145D9C -> 0x8014605C
void zPendulumEventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
