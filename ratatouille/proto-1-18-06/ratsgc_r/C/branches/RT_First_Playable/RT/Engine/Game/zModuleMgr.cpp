/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zModuleMgr.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802A875C -> 0x802A931C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct st_XORDEREDARRAY g_modlist; // size: 0x10, address: 0x80C09638
static struct st_XORDEREDARRAY g_modlistUpdateSort; // size: 0x10, address: 0x80C09648
static struct st_XORDEREDARRAY g_modlistRenderSort; // size: 0x10, address: 0x80C09658
// total size: 0x1C
struct zModule {
    // Members
...
// Range: 0x802A88D4 -> 0x802A8964
void zModule::Mgr_SceneInit() {
    // Local variables
    int num_mod; // r30
    int i; // r29
    struct zModule * mod; // r28

    // References
    // -> static struct st_XORDEREDARRAY g_modlistUpdateSort;
}

// Range: 0x802A8964 -> 0x802A89D4
...
// total size: 0x4
struct /* @class$1080zModuleMgr_cpp */ {
    // Members
...
union /* @class$1227zModuleMgr_cpp */ {
...
// total size: 0xC
struct /* @class$1278zModuleMgr_cpp */ {
    // Members
...
// Range: 0x802A8B94 -> 0x802A8C8C
void zModule::Mgr_Timestep(float dt /* f31 */) {
    // Local variables
    int isPaused; // r0
    int isCinematic; // r29
    int num_mod; // r28
    int i; // r27
    struct zModule * mod; // r3
...
// Range: 0x802A8C8C -> 0x802A8D84
void zModule::Mgr_PostTimestep(float dt /* f31 */) {
    // Local variables
    int isPaused; // r0
    int isCinematic; // r29
    int num_mod; // r28
...
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C062B0
enum zLayerType {
    eLAYER_FIRST = 0,
    eLAYER_PREPICKUP = 1,
    eLAYER_POSTPICKUP = 2,
...
// Range: 0x802A8F6C -> 0x802A9140
void zModule::Mgr_RenderLayer(enum zLayerType endLayer /* r25 */) {
    // Local variables
    int isPaused; // r0
    int isCinematic; // r29
    int num_mod; // r28
    int i; // r27
    struct zModule * mod; // r26
    int start; // r24
    int j; // r24
    enum zLayerType layer_curr; // r0
