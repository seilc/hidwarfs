/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCameraCurve.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80239A38 -> 0x8023B2AC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80239A38 -> 0x80239A80
// this: r30
void Follower::Init(const class zCameraCurve & curveInfo /* r0 */, const struct xVec3 & playerPos /* r31 */) {}

// Range: 0x80239A80 -> 0x80239A8C
// this: r0
void Follower::Reset() {}

// Range: 0x80239A8C -> 0x80239AC8
float Follower::InterpVal(float frac /* f1 */, float start /* f2 */, float end /* f3 */, float defaultValue /* f4 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C048D0
unsigned char sTweakedBeadActive; // size: 0x1, address: 0x80C0909C
// total size: 0x48
struct BeadInfo {
    // Members
...
struct BeadInfo sTweakedBead; // size: 0x48, address: 0x80BCB090
// Range: 0x80239AC8 -> 0x80239CFC
// this: r29
void Follower::UpdatePosition(float playerU /* f31 */) {
    // Local variables
    const struct zCameraCurveBead * const b0; // r0
    const struct zCameraCurveBead * const b1; // r0
...
static char __FUNCTION__[15]; // size: 0xF, address: 0x80C048E0
// Range: 0x80239D90 -> 0x80239E48
// this: r30
void Follower::UpdatePosition(const struct xVec3 & playerPos /* r31 */) {
    // Local variables
    float newPlayerU; // r1+0x8

    // References
    // -> static char __FUNCTION__[15];
}

// Range: 0x80239E48 -> 0x80239EB0
// this: r31
struct xVec3 & Follower::PlayerPathPos() {}

// Range: 0x80239EB0 -> 0x80239F20
// this: r31
struct BeadInfo & Follower::InterpBeadInfo(unsigned char wantPlayerPathPosition /* r0 */) {
    // References
    // -> unsigned char sTweakedBeadActive;
    // -> struct BeadInfo sTweakedBead;
}
...
// Range: 0x80239F20 -> 0x8023A070
// this: r30
float Follower::CameraUFromPlayerU(float playerU /* f29 */, int & outBeadIndex /* r28 */, float & outBeadIndexFrac /* r29 */) const {
    // Local variables
    int index; // r31
    const struct zCameraCurveBead * result; // r30
    float frac; // f0
    float diffPlayerU; // f31
    float cameraU; // f1
}
...
static class zCamPool sCamCurvePOIPool; // size: 0x18, address: 0x80C09060
// total size: 0x270
...
// total size: 0x18
class zCamPool : public zCamPoolBase {};
static class zCamPool sCamCurveRailPool; // size: 0x18, address: 0x80C09078
static int sForceBlendCompletion; // size: 0x4, address: 0x80C048F0
struct xCam * sLastAddedCam; // size: 0x4, address: 0x80C09090
// Range: 0x8023A070 -> 0x8023A090
void zCameraCurve_Init(void * base /* r0 */, void * asset /* r0 */) {}

static unsigned char DMInited; // size: 0x1, address: 0x80C09094
static signed char init; // size: 0x1, address: 0x80C09095
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C048F4
// Range: 0x8023A090 -> 0x8023A2B0
// this: r31
...
// total size: 0x4
struct /* @class$1336zCameraCurve_cpp */ {
    // Members
...
union /* @class$1077zCameraCurve_cpp */ {
...
// total size: 0xC
struct /* @class$1484zCameraCurve_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1287zCameraCurve_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1090zCameraCurve_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
static char __FUNCTION__[13]; // size: 0xD, address: 0x80C048FC
// Range: 0x8023A328 -> 0x8023A408
// this: r29
void zCameraCurve::InitOneCurve(enum eCamCurve whichCurve /* r0 */) {
    // Local variables
...
// Range: 0x8023A408 -> 0x8023A434
struct xColor_tag zCameraCurve::CurveColor(enum eCamCurve whichCurve /* r0 */) {
    // References
    // -> struct xColor_tag g_BLUE;
    // -> struct xColor_tag g_RED;
}

// Range: 0x8023A434 -> 0x8023A538
// this: r29
void zCameraCurve::RenderOneCurve(enum eCamCurve whichCurve /* r0 */) const {
    // Local variables
    const class xNurbs * pCurve; // r30
    float step; // f31
    float end; // f30
...
static unsigned char done; // size: 0x1, address: 0x80C09096
static signed char init; // size: 0x1, address: 0x80C09097
static unsigned char done; // size: 0x1, address: 0x80C09098
static signed char init; // size: 0x1, address: 0x80C09099
static unsigned char done; // size: 0x1, address: 0x80C0909A
static signed char init; // size: 0x1, address: 0x80C0909B
static char __FUNCTION__[16]; // size: 0x10, address: 0x80C0490C
// Range: 0x8023A538 -> 0x8023A7B0
// this: r31
int zCameraCurve::FindBeadPlayerU(float playerU /* f30 */) const {
    // Local variables
    const struct zCameraCurveBead * search; // r0
    int lo; // r5
    int hi; // r4
    int test; // r6
    float testU; // f0
...
static char __FUNCTION__[9]; // size: 0x9, address: 0x80C0491C
// Range: 0x8023A8E8 -> 0x8023AA70
// this: r29
unsigned char zCameraCurve::Activate(const struct xCamTransitionParams * transition /* r30 */, unsigned char forceRestart /* r31 */) {
    // Local variables
    struct xCam * theCam; // r28
    class zCamSplineCommonMix * splineHelper; // r27
...
static char __FUNCTION__[21]; // size: 0x15, address: 0x80C04928
// Range: 0x8023AA70 -> 0x8023AB6C
void zCameraCurve_EventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r30 */, const float * toParam /* r31 */) {
    // References
    // -> static char __FUNCTION__[21];
}

// Range: 0x8023AB6C -> 0x8023AC30
// this: r29
void zCameraCurve::GetBeadInfo(int beadIndex /* r31 */, struct BeadInfo & info /* r30 */) const {
    // Local variables
    const struct zCameraCurveBead * bead; // r0
}
...
// Range: 0x8023AC30 -> 0x8023AEDC
// this: r30
void Follower::DebugRender() {
    // Local variables
    const struct BeadInfo & curBeadInfo; // r0
...
// total size: 0x890
struct /* @class$2123zCameraCurve_cpp */ {
    // Static members
...
// Range: 0x8023AEDC -> 0x8023AF38
void zCameraCurve::AddTweaks(const char * prefix /* r4 */) {
    // Local variables
...
// Range: 0x8023AF38 -> 0x8023AF44
void Follower::bead_tweak_open() {
    // References
    // -> unsigned char sTweakedBeadActive;
}

// Range: 0x8023AF44 -> 0x8023AF50
...
// total size: 0xC
struct /* @class$1026zCameraCurve_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1027zCameraCurve_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1028zCameraCurve_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1029zCameraCurve_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1030zCameraCurve_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1031zCameraCurve_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1032zCameraCurve_cpp */ {
    // Members
...
static struct tweak_callback bead_tweak_cb; // size: 0x28, address: 0x80440BA8
static signed char init; // size: 0x1, address: 0x80C0909D
static char * prefix; // size: 0x4, address: 0x80C090A0
static signed char init; // size: 0x1, address: 0x80C090A4
// Range: 0x8023AF50 -> 0x8023B1FC
