/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zCamPreset.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80243E08 -> 0x80244B20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char __FUNCTION__[22]; // size: 0x16, address: 0x80C04B80
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1304zCamPreset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1460zCamPreset_cpp */ {
    // Members
...
union /* @class$1055zCamPreset_cpp */ {
...
// total size: 0x10
struct /* @class$1068zCamPreset_cpp */ {
    // Members
    int flags; // offset 0x0, size 0x4
...
// total size: 0x890
struct /* @class$2060zCamPreset_cpp */ {
    // Static members
...
static char __FUNCTION__[5]; // size: 0x5, address: 0x80C04B98
// total size: 0x2
struct debug_info {
    // Members
...
// Range: 0x80243F48 -> 0x802440BC
void zCamPreset::load(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$957zCamPreset_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// Range: 0x802440BC -> 0x80244154
void zCamPreset::update_all() {
    // Local variables
    unsigned char snapped; // r4
    struct zScene & s; // r3
    struct zCamPreset * preset; // r30
    struct zCamPreset * const end_preset; // r29

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80244154 -> 0x80244184
void zCamPreset::apply_on_scene_prepare() {
    // Local variables
    struct zCamPreset * preset; // r0
}

// Range: 0x80244184 -> 0x802441B4
void zCamPreset::apply_on_reset() {
    // Local variables
    struct zCamPreset * preset; // r0
}

// Range: 0x802441B4 -> 0x802442D0
struct zCamPreset * zCamPreset::find_preset(unsigned char scene_prepare /* r28 */) {
    // Local variables
    struct zCamPreset * best_preset; // r31
    float best_dist2; // f31
    unsigned char best_has_checkpoint; // r30
    struct xVec3 to; // r1+0x14
    struct zScene & s; // r3
    struct zCamPreset * preset; // r29
    struct zCamPreset * const end_preset; // r26
    unsigned char has_checkpoint; // r25
    float dist2; // f1
...
// Range: 0x802442D0 -> 0x80244344
// this: r31
void zCamPreset::load(const struct asset_type & a /* r0 */) {}

static char __FUNCTION__[15]; // size: 0xF, address: 0x80C04BA0
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x80244344 -> 0x802444C0
// this: r31
unsigned char zCamPreset::get_checkpoint(struct xVec3 & loc /* r29 */, float & yaw /* r30 */) const {
    // Local variables
    struct PKRAssetTOCInfo ainfo; // r1+0x14
    int found; // r0
    struct xBaseAsset * checkpoint; // r31
    unsigned int type; // r3
    struct xEntAsset * player; // r0
...
// Range: 0x802444C0 -> 0x80244510
// this: r0
unsigned char zCamPreset::at_checkpoint() const {
    // Local variables
    struct xVec3 check_loc; // r1+0x18
    float check_yaw; // r1+0x8
}
...
// Range: 0x80244580 -> 0x80244584
void zCamPreset::apply() {}

// Range: 0x80244584 -> 0x80244634
// this: r0
unsigned char zCamPreset::get_relative(struct xVec3 & offset /* r29 */, float & yaw /* r30 */) const {
    // Local variables
    const struct xMat4x3 & player_mat; // r0

    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80244634 -> 0x802446E8
// this: r30
void zCamPreset::get_matrix(struct xMat4x3 & mat /* r31 */) const {
    // Local variables
...
// Range: 0x802446E8 -> 0x8024474C
// this: r0
void zCamPreset::event_handler(unsigned int event /* r0 */) {}

// Range: 0x8024474C -> 0x80244778
void zCamPreset::event_handler_callback(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r0 */, struct xBase * argw /* r0 */, unsigned int argwi /* r0 */) {}

// Range: 0x80244778 -> 0x802447CC
// this: r31
...
// total size: 0xC
struct /* @class$1004zCamPreset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1005zCamPreset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1006zCamPreset_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1007zCamPreset_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1008zCamPreset_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1009zCamPreset_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1010zCamPreset_cpp */ {
    // Members
...
void zCamPreset::add_tweaks() {
    ...
    unsigned int players; // r0
    unsigned int pointers; // r0
    unsigned int checkpoints; // r27
    char * * checkpoint_labels; // r26
    unsigned int * checkpoint_ids; // r25
