/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zNPCTypesIN2.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x802836B0 -> 0x802836BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zNPCTypeInfoIN2 info[3]; // size: 0x48, address: 0x804047A8
// Range: 0x802836B0 -> 0x802836BC
