/*
    Compile unit: C:\branches\RT_First_Playable\RT\Engine\Game\zReticle.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8019CBD8 -> 0x8019E24C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xFuncPiece sFadeSize[2]; // size: 0x40, address: 0x80BB6570
// total size: 0x20
struct xFuncPiece {
    // Members
...
static struct xFuncPiece sDistSize; // size: 0x20, address: 0x80BB65B0
static float sAlpha; // size: 0x4, address: 0x80C023C8
static float sFadeInSpeed; // size: 0x4, address: 0x80C023CC
static float sFadeOutSpeed; // size: 0x4, address: 0x80C023D0
static float sMinDist; // size: 0x4, address: 0x80C023D4
static float sPulseAmp; // size: 0x4, address: 0x80C023D8
static float sPulseSpeed; // size: 0x4, address: 0x80C023DC
static float sRotSpeed; // size: 0x4, address: 0x80C023E0
static float sSwirlMaxU; // size: 0x4, address: 0x80C023E4
static float sSwirlMinU; // size: 0x4, address: 0x80C023E8
static float sSwirlMaxV; // size: 0x4, address: 0x80C023EC
static float sSwirlMinV; // size: 0x4, address: 0x80C023F0
static unsigned char sSwirlRed; // size: 0x1, address: 0x80C023F4
static unsigned char sSwirlGreen; // size: 0x1, address: 0x80C023F5
static unsigned char sSwirlBlue; // size: 0x1, address: 0x80C023F6
static unsigned char sSwirlRedSwitchLever1; // size: 0x1, address: 0x80C023F7
static unsigned char sSwirlGreenSwitchLever1; // size: 0x1, address: 0x80C088B8
static unsigned char sSwirlBlueSwitchLever1; // size: 0x1, address: 0x80C023F8
static unsigned char sSwirlRedSwitchLever2; // size: 0x1, address: 0x80C023F9
static unsigned char sSwirlGreenSwitchLever2; // size: 0x1, address: 0x80C023FA
static unsigned char sSwirlBlueSwitchLever2; // size: 0x1, address: 0x80C023FB
static float sLetterMaxU; // size: 0x4, address: 0x80C023FC
static float sLetterMinU; // size: 0x4, address: 0x80C02400
static float sLetterMaxV; // size: 0x4, address: 0x80C02404
static float sLetterMinV; // size: 0x4, address: 0x80C02408
static unsigned char sLetterRed; // size: 0x1, address: 0x80C0240C
static unsigned char sLetterGreen; // size: 0x1, address: 0x80C0240D
static unsigned char sLetterBlue; // size: 0x1, address: 0x80C0240E
static float sXMult; // size: 0x4, address: 0x80C02410
static float sZBias; // size: 0x4, address: 0x80C02414
// total size: 0x24
struct zReticle {
    // Members
...
static struct zReticle reticle[4]; // size: 0x90, address: 0x80BB65D0
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * reticleRast; // size: 0x4, address: 0x80C088BC
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8019CCDC -> 0x8019CD10
float zReticle_RotateSwirl(float angle /* f0 */, float dt /* f0 */) {
    // Local variables
    float result; // f1
...
// Range: 0x8019CD10 -> 0x8019CDEC
static void UpdateReticle(struct zReticle * ret /* r31 */, float dt /* f1 */) {
    // References
...
// Range: 0x8019CDEC -> 0x8019CE58
void zReticle_Update(float dt /* f31 */) {
    // Local variables
    int i; // r30
...
// Range: 0x8019CE58 -> 0x8019CE74
void zReticle_GetSwirlColor(struct xColor_tag * color /* r0 */) {
    // References
...
// Range: 0x8019CE74 -> 0x8019CE90
void zReticle_GetLetterColor(struct xColor_tag * color /* r0 */) {
    // References
...
// Range: 0x8019CE90 -> 0x8019D184
void zReticle_RenderSwirl(struct xMat4x3 * mat /* r21 */, float angle /* f26 */, struct xColor_tag & color1 /* r22 */, struct xColor_tag & color2 /* r23 */) {
    // Local variables
...
// Range: 0x8019D184 -> 0x8019D3CC
void zReticle_RenderLetter(struct xMat4x3 * mat /* r29 */, struct xColor_tag & color /* r30 */) {
    // Local variables
...
// total size: 0x1
struct /* @class$1054zReticle_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$1055zReticle_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$1056zReticle_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$1057zReticle_cpp */ {
    // Members
...
// Range: 0x8019D3CC -> 0x8019D604
static void RenderReticle(struct zReticle * ret /* r29 */) {
    // Local variables
    struct xMat4x3 * cam; // r0
...
static float sAlphaUpRate; // size: 0x4, address: 0x80C02418
static float sAlphaDownRate; // size: 0x4, address: 0x80C0241C
static float sMinDrawDist2; // size: 0x4, address: 0x80C02420
static float sMaxDrawAlpha; // size: 0x4, address: 0x80C02424
static float sIconAngle; // size: 0x4, address: 0x80C088C0
static char __FUNCTION__[11]; // size: 0xB, address: 0x80C02428
// Range: 0x8019DA4C -> 0x8019DBDC
void zIcon_Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */, unsigned long asset_size /* r28 */) {
    // Local variables
...
// Range: 0x8019DBDC -> 0x8019DC7C
void zIcon_Init(struct zIcon * icon /* r30 */, struct zIconAsset * asset /* r31 */) {}

// Range: 0x8019DC7C -> 0x8019DD5C
void zIcon_Reset() {
    // Local variables
    struct zScene * zsc; // r3
    int count; // r5
    struct zIcon * iconList; // r6
    int i; // r7
...
// Range: 0x8019DE04 -> 0x8019DF18
float zIcon_GetNewAlpha(float currAlpha /* f29 */, float dt /* f30 */, const struct xVec3 & pos /* r3 */, unsigned char active /* r0 */, float radius /* f31 */) {
    // Local variables
    float newAlpha; // f0
...
static char __FUNCTION__[14]; // size: 0xE, address: 0x80C02434
// Range: 0x8019DF18 -> 0x8019E020
void zIcon_EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r31 */) {
    // Local variables
    struct zIcon * icon; // r0

    // References
    // -> static char __FUNCTION__[14];
}

// Range: 0x8019E020 -> 0x8019E08C
void zIcon_Render() {
    // Local variables
    struct zScene * zsc; // r3
    int count; // r30
...
// Range: 0x8019E08C -> 0x8019E108
void zIcon_Render(const struct xMat4x3 & mat /* r0 */, float alpha /* f0 */) {
    // Local variables
    struct xColor_tag color1; // r1+0xC
    struct xColor_tag color2; // r1+0x8
...
// Range: 0x8019E108 -> 0x8019E16C
void zIcon_Render(const struct xMat4x3 & mat /* r0 */, float alpha /* f0 */) {
    // Local variables
    struct xColor_tag color; // r1+0x8
...
// Range: 0x8019E16C -> 0x8019E24C
void zIcon_Render(const struct xMat4x3 & mat /* r0 */, struct xColor_tag & color1 /* r31 */, struct xColor_tag & color2 /* r0 */) {
    // Local variables
