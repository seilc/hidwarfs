/*
    ...
    Language: C++
    Code range: 0x8018C4D0 -> 0x8018C5D0
*/
// total size: 0x50
struct {} zUICustomConditionallyDisabled::__vtable; // size: 0x50, address: 0x802E0B58
// total size: 0x18
