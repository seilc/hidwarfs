/*
    ...
    Language: C++
    Code range: 0x8015CF98 -> 0x8015D5D8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int instanceCount; // size: 0x4, address: 0x803C3130
int lastUpgradeValue; // size: 0x4, address: 0x803C3134
static signed char init; // size: 0x1, address: 0x803C3138
// total size: 0x8
struct Threshold {
    // Members
...
static class zEconomics economics; // size: 0xC9C, address: 0x8038E348
enum xCamCoordType {
...
// Range: 0x8015D388 -> 0x8015D38C
void zEconomics::GiveComboPoints() {}

// Range: 0x8015D38C -> 0x8015D49C
char * zEconomics::GetLevelName(int level /* r0 */) {
    // Local variables
    const char * name; // r3
}

// Range: 0x8015D49C -> 0x8015D4AC
char * zEconomics::GetNPCName() {
    // Local variables
    const char * name; // r3
}

// Range: 0x8015D4AC -> 0x8015D5D8
