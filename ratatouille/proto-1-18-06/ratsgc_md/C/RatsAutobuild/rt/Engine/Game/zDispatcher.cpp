/*
    ...
    Language: C++
    Code range: 0x8009AEEC -> 0x8009C718
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int g_zdsp_init; // size: 0x4, address: 0x803C19C0
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct st_ZDISPATCH_DEPOT g_zdsp_depot; // size: 0x8, address: 0x803BDD68
// total size: 0x6
struct /* @class$1238zDispatcher_cpp */ {
    // Members
...
static struct World worlds[20]; // size: 0x4D8, address: 0x8035C8B8
static signed short currentWorld; // size: 0x2, address: 0x803C19C4
static signed short currentTask; // size: 0x2, address: 0x803C19C6
static signed short currentPointer; // size: 0x2, address: 0x803C19C8
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x8009B12C -> 0x8009B130
void zDispatcher_Startup() {}

// Range: 0x8009B130 -> 0x8009B134
void zDispatcher_Shutdown() {}

// Range: 0x8009B134 -> 0x8009B174
...
// total size: 0x4
struct /* @class$804zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$824zDispatcher_cpp */ {
    // Members
...
union /* @class$635zDispatcher_cpp */ {
...
// Range: 0x8009B3E0 -> 0x8009B434
void ZDSP_injectCmd(struct st_ZDISPATCH_DATA * dspdata /* r0 */, enum en_DISPATCH_COMMAND cmd /* r0 */, void * indata /* r0 */, void * inxtra /* r0 */, void * result /* r0 */) {
    // Local variables
    struct st_ZDISPATCH_CONTEXT cmdctxt; // r1+0x8
}

static int warned; // size: 0x4, address: 0x803C19CC
static signed char init; // size: 0x1, address: 0x803C19D0
// total size: 0x38
...
static struct effectAsset effectAsset; // size: 0x38, address: 0x803C19D4
static signed char init; // size: 0x1, address: 0x803C1A0C
// total size: 0x18
...
static struct effect effect; // size: 0x18, address: 0x803C1A10
static struct effectAsset effectAsset; // size: 0x38, address: 0x803C1A28
static signed char init; // size: 0x1, address: 0x803C1A60
static struct effect effect; // size: 0x18, address: 0x803C1A64
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$769zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zDispatcher_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$771zDispatcher_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$772zDispatcher_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$773zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$774zDispatcher_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$775zDispatcher_cpp */ {
    // Members
...
// Range: 0x8009B960 -> 0x8009C57C
void ZDSP_elcb_event(struct xBase * xb /* r4 */, unsigned int toEvent /* r28 */, const float * toParam /* r26 */, struct xBase * toParamWidget /* r31 */, unsigned int toParamWidgetID /* r25 */) {
    // Local variables
    struct st_ZDISPATCH_DATA * dspdata; // r27
