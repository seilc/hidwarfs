/*
    ...
    Language: C++
    Code range: 0x800D93EC -> 0x800DCDD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xMat4x3 tmpMat; // size: 0x40, address: 0x803C2270
static int sNumActiveFrags; // size: 0x4, address: 0x803C22B0
static struct zFrag sFragPool[150]; // size: 0x9150, address: 0x8036A9F8
// total size: 0x54
struct zFragGroup {
    // Members
...
// total size: 0x1
struct /* @class$753zShrapnel_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$754zShrapnel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$755zShrapnel_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$756zShrapnel_cpp */ {
    // Members
...
static struct zFrag sFirstFreeFrag; // size: 0xF8, address: 0x80373B48
static struct zFrag sFirstActiveFrag; // size: 0xF8, address: 0x80373C40
static struct zFrag sProjectileList; // size: 0xF8, address: 0x80373D38
static struct zFrag sLightningList; // size: 0xF8, address: 0x80373E30
static struct zFrag sParticleList; // size: 0xF8, address: 0x80373F28
static struct zFrag sSoundList; // size: 0xF8, address: 0x80374020
static struct zFrag sExplosionList; // size: 0xF8, address: 0x80374118
static struct zFrag sDistortionList; // size: 0xF8, address: 0x80374210
static struct zFrag sGooList; // size: 0xF8, address: 0x80374308
// total size: 0x68
...
static struct _tagLightningAdd sLightningAddInfo; // size: 0x68, address: 0x80374400
// total size: 0xC
...
static struct zShrapnelInitTable sShrapnelTable[1]; // size: 0xC, address: 0x803BE2A8
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// Range: 0x800D9480 -> 0x800D9574
struct zFrag * zFrag_Alloc(enum zFragType type /* r31 */, unsigned char useThrottling /* r0 */) {
    // Local variables
...
static struct smoke_config smoke_config; // size: 0x38, address: 0x803C22B4
struct smoke_config default_config; // size: 0x38, address: 0x803C2968
// Range: 0x800D97A0 -> 0x800D982C
...
// Range: 0x800D9D70 -> 0x800D9FAC
void zShrapnel_DefaultInit(struct zShrapnelAsset * shrap /* r23 */, struct xModelInstance * parent /* r24 */, struct xVec3 * initOffset /* r25 */, struct xVec3 * initVel /* r26 */, void (* cb)(struct zFrag *, struct zFragAsset *) /* r27 */) {
    // Local variables
    struct zShrapnelParentList * plist; // r31
    struct zFrag * frag; // r30
    struct zFragAsset * fasset; // r29
    int i; // r28
    int j; // r7
    int k; // r8
}
...
static struct zFragProjectileAsset sCinProj; // size: 0x158, address: 0x80374468
static struct RpAtomic * sCinModel; // size: 0x4, address: 0x803C22EC
// Range: 0x800D9FAC -> 0x800DA0A0
...
unsigned char zFrag_DefaultInit(struct zFrag * frag /* r30 */, struct zFragAsset * fasset /* r31 */) {
    ...
    struct RpAtomic * m1; // r3
    struct RpAtomic * m2; // r3
...
// Range: 0x800DC49C -> 0x800DCBB8
static void zFrag_GooManager(float dt /* f28 */) {
    // Local variables
...
// Range: 0x800DCD70 -> 0x800DCDD4
void zFrag_GooRenderer() {
    // Local variables
    struct zFrag * frag; // r31
    struct zFragGoo * goo; // r0
    struct xModelInstance * currModel; // r3
