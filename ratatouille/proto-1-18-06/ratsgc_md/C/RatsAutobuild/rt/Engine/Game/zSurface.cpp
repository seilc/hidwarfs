/*
    ...
    Language: C++
    Code range: 0x800DCE60 -> 0x800DDF8C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSurfaceProps * zsps; // size: 0x4, address: 0x803C22F0
static int sMapperCount; // size: 0x4, address: 0x803C22F4
// total size: 0x8
...
static struct zMaterialMapAsset * sMapper[20]; // size: 0x50, address: 0x802DB990
// total size: 0x50
...
static struct xSurface sDefaultSurface; // size: 0x28, address: 0x803C22F8
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zSurfaceProps sDefaultSurfaceProps; // size: 0x118, address: 0x803745C0
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
static struct zSurfAssetIN sDefaultSurfaceAsset; // size: 0x1B8, address: 0x803746D8
static struct xSurface * pDefaultSurface; // size: 0x4, address: 0x803C2320
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x800DCE60 -> 0x800DD0D0
void zSurfaceInit() {
    // Local variables
    ...
    struct zSurfAssetIN * asset; // r24
    struct xSurface * surf; // r27
    struct zSurfaceProps * moprops; // r23
    int j; // r22
...
// Range: 0x800DD16C -> 0x800DD1CC
void zSurfaceRegisterMapper(unsigned int assetId /* r0 */) {
    // References
    // -> static int sMapperCount;
    // -> static struct zMaterialMapAsset * sMapper[20];
}

// Range: 0x800DD1CC -> 0x800DD1F4
void zSurfaceExit() {
    // References
    // -> static int sMapperCount;
}

// Range: 0x800DD1F4 -> 0x800DD230
...
// Range: 0x800DD230 -> 0x800DD2FC
struct xSurface * zSurfaceGetSurface(unsigned int mat_id /* r23 */) {
    // Local variables
    int map; // r28
    struct zMaterialMapAsset * mapper; // r27
...
// Range: 0x800DD350 -> 0x800DD3C8
struct xSurface * zSurfaceGetSurface(const struct xSweptSphere * sphere /* r3 */) {
    // Local variables
    struct xSurface * surf; // r4

    // References
    // -> static struct xSurface * pDefaultSurface;
}

// Range: 0x800DD3C8 -> 0x800DD434
struct xSurface * zSurfaceGetSurface(const struct xCollis * coll /* r3 */) {
    // Local variables
    struct xSurface * surf; // r5

    // References
    // -> static struct xSurface * pDefaultSurface;
}

// Range: 0x800DD434 -> 0x800DD458
unsigned char zSurfaceOutOfBounds(const struct xSurface & s /* r0 */) {}

// Range: 0x800DD458 -> 0x800DD478
int zSurfaceGetDamageType(const struct xSurface * surf /* r0 */) {}

// Range: 0x800DD478 -> 0x800DD4A4
unsigned int zSurfaceGetStandOn(const struct xSurface * surf /* r0 */) {}

// total size: 0x0
struct xSerial {};
// Range: 0x800DD4A4 -> 0x800DD4C4
void zSurfaceSave(struct xSurface * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800DD4C4 -> 0x800DD4E4
void zSurfaceLoad(struct xSurface * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800DD4E4 -> 0x800DD57C
void zSurfaceSetup(struct xSurface * s /* r0 */) {
    // Local variables
...
// Range: 0x800DD57C -> 0x800DD63C
void CacheTextureRefs(struct zSurfacePropTexAnim * texanim /* r27 */) {
    // Local variables
    struct xGroup * grp; // r29
    unsigned int num_items; // r0
    unsigned int amt; // r28
    void * mem; // r0
    int i; // r28
    unsigned int aid_item; // r0
    void * memptr; // r0
...
// Range: 0x800DD63C -> 0x800DD660
void zSurfaceUpdate(struct xBase * to /* r0 */, float dt /* f0 */) {
    // Local variables
    struct xSurface * t; // r0
}

// Range: 0x800DD660 -> 0x800DD930
static void zSurfaceEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */) {
    // Local variables
