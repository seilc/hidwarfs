/*
    ...
    Language: C++
    Code range: 0x80187CD8 -> 0x80188580
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x803904B8
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
