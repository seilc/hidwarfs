/*
    ...
    Language: C++
    Code range: 0x800B41B0 -> 0x800B44DC
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800B41B0 -> 0x800B41D0
void zGrapple_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
static struct zGrapplePoint * sGrapplePoints; // size: 0x4, address: 0x803C1E38
static int sNumGrapplePoints; // size: 0x4, address: 0x803C1E3C
// total size: 0xC
...
// Range: 0x800B44A8 -> 0x800B44DC
void zGrapple_EventCB(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */) {
    // Local variables
