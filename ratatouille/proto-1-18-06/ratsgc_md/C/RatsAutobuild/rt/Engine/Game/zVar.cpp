/*
    ...
    Language: C++
    Code range: 0x800E9504 -> 0x800EABD8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800E9504 -> 0x800E950C
unsigned int zVarEntryCB_IsSignedIn() {}

// Range: 0x800E950C -> 0x800E9514
unsigned int zVarEntryCB_PendingFriendRequest() {}

// Range: 0x800E9514 -> 0x800E951C
unsigned int zVarEntryCB_PendingGameInvite() {}

int bad_card_available; // size: 0x4, address: 0x803C23D0
int bad_card_needed; // size: 0x4, address: 0x803C23D4
static char buffer[64]; // size: 0x40, address: 0x803C23D8
// Range: 0x800E951C -> 0x800E959C
...
static char buffer[12]; // size: 0xC, address: 0x803C2418
// Range: 0x800E959C -> 0x800E95D8
...
static char buffer[12]; // size: 0xC, address: 0x803C2424
// Range: 0x800E95D8 -> 0x800E9614
...
struct zSaveLoadGame zSaveLoadGameTable[]; // size: 0x0, address: 0x8036A8B0
// Range: 0x800E9614 -> 0x800E98F0
static char * zVarGameSlotInfo(int i /* r27 */, char * buffer /* r28 */, unsigned long max_len /* r29 */) {
    // Local variables
    ...
    const char * empty_string; // r26
    const char * damaged_save_name; // r31

    // References
    // -> struct zSaveLoadGame zSaveLoadGameTable[];
}

static char buffer[128]; // size: 0x80, address: 0x80375C10
// Range: 0x800E98F0 -> 0x800E9920
static char * var_text_GameSlot0() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375C90
// Range: 0x800E9920 -> 0x800E9950
static char * var_text_GameSlot1() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375D10
// Range: 0x800E9950 -> 0x800E9980
static char * var_text_GameSlot2() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375D90
// Range: 0x800E9980 -> 0x800E99B0
static char * var_text_GameSlot3() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375E10
// Range: 0x800E99B0 -> 0x800E99E0
static char * var_text_GameSlot4() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375E90
// Range: 0x800E99E0 -> 0x800E9A10
static char * var_text_GameSlot5() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375F10
// Range: 0x800E9A10 -> 0x800E9A40
static char * var_text_GameSlot6() {
    // References
    // -> static char buffer[128];
}

static char buffer[128]; // size: 0x80, address: 0x80375F90
// Range: 0x800E9A40 -> 0x800E9A70
static char * var_text_GameSlot7() {
    // References
    // -> static char buffer[128];
}

static unsigned int state_text[4]; // size: 0x10, address: 0x803C6958
// Range: 0x800E9A70 -> 0x800E9AA4
...
static char buffer[12]; // size: 0xC, address: 0x803C2430
// Range: 0x800E9AA4 -> 0x800E9AE8
static char * var_text_MCAutoSaveCard() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x803C243C
// Range: 0x800E9AE8 -> 0x800E9B60
...
static char buffer[12]; // size: 0xC, address: 0x803C245C
// Range: 0x800E9B60 -> 0x800E9BA4
static char * var_text_MCSelectedGame() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x803C2468
// Range: 0x800E9BA4 -> 0x800E9BE4
static char * var_text_SpaceAvailable() {
    // References
    // -> static char buffer[12];
}

static char buffer[64]; // size: 0x40, address: 0x803C2474
// Range: 0x800E9BE4 -> 0x800E9C70
...
static char buffer[12]; // size: 0xC, address: 0x803C24B4
// Range: 0x800E9C70 -> 0x800E9CB0
static char * var_text_SpaceNeeded() {
    // References
    // -> static char buffer[12];
}

static char buffer[32]; // size: 0x20, address: 0x803C24C0
// Range: 0x800E9CB0 -> 0x800E9D30
static char * var_text_MCName() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x803C24E0
// Range: 0x800E9D30 -> 0x800E9D6C
static char * var_text_MCMaxSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[32]; // size: 0x20, address: 0x803C2500
// Range: 0x800E9D6C -> 0x800E9DA8
static char * var_text_MCMinSpace() {
    // References
    // -> static char buffer[32];
}

static char buffer[12]; // size: 0xC, address: 0x803C2520
// Range: 0x800E9DA8 -> 0x800E9DFC
...
static char buffer[12]; // size: 0xC, address: 0x803C252C
// Range: 0x800E9DFC -> 0x800E9E58
...
// Range: 0x800E9E58 -> 0x800E9E88
static char * var_text_CurrentArea() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x803C2538
// Range: 0x800E9E88 -> 0x800E9EB0
static char * var_text_CurrentDate() {
    // References
    // -> static char buffer[32];
}

// Range: 0x800E9EB0 -> 0x800E9EE0
static char * var_text_CurrentLevel() {
    // References
    // -> struct zGlobals globals;
}

static char buffer[32]; // size: 0x20, address: 0x803C2558
// Range: 0x800E9EE0 -> 0x800E9F34
...
static char buffer[32]; // size: 0x20, address: 0x803C2578
// Range: 0x800E9F34 -> 0x800E9F5C
static char * var_text_CurrentTime() {
    // References
    // -> static char buffer[32];
}

static char buffer[48]; // size: 0x30, address: 0x803C2598
struct xGlobals * xglobals; // size: 0x4, address: 0x803BE168
// Range: 0x800E9F5C -> 0x800E9FD8
...
static unsigned int selSceneID; // size: 0x4, address: 0x803C25C8
// Range: 0x800E9FD8 -> 0x800E9FFC
static char * var_text_SelectedArea() {
    // References
    // -> static unsigned int selSceneID;
}

static char buffer[12]; // size: 0xC, address: 0x803C25CC
// Range: 0x800E9FFC -> 0x800EA040
static char * var_text_SoundFXVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[12]; // size: 0xC, address: 0x803C25D8
// Range: 0x800EA040 -> 0x800EA084
static char * var_text_SoundMusicVolume() {
    // References
    // -> static char buffer[12];
}

static char buffer[5]; // size: 0x5, address: 0x803C25E4
// Range: 0x800EA084 -> 0x800EA0C4
static char * var_text_HitCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x803C25EC
// Range: 0x800EA0C4 -> 0x800EA104
static char * var_text_TotalCheckpoints() {
    // References
    // -> static char buffer[5];
}

static char buffer[5]; // size: 0x5, address: 0x803C25F4
// Range: 0x800EA104 -> 0x800EA15C
...
static char buffer[5]; // size: 0x5, address: 0x803C25FC
// Range: 0x800EA15C -> 0x800EA164
static char * var_text_UpgradePoints1() {
    // References
    // -> static char buffer[5];
}

static char buffer[10]; // size: 0xA, address: 0x803C2604
// Range: 0x800EA164 -> 0x800EA1D4
...
static char buffer[10]; // size: 0xA, address: 0x803C2610
// Range: 0x800EA1D4 -> 0x800EA244
...
static char buffer[10]; // size: 0xA, address: 0x803C261C
// Range: 0x800EA244 -> 0x800EA29C
...
// total size: 0x4
struct /* @class$1193zVar_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1194zVar_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
static char buffer[10]; // size: 0xA, address: 0x803C2628
// Range: 0x800EA29C -> 0x800EA318
...
static char buffer[10]; // size: 0xA, address: 0x803C2634
// Range: 0x800EA318 -> 0x800EA370
...
static char buffer[10]; // size: 0xA, address: 0x803C2640
// Range: 0x800EA370 -> 0x800EA3EC
...
static char buffer[8]; // size: 0x8, address: 0x803C264C
// Range: 0x800EA3EC -> 0x800EA438
...
static struct var_type vars[43]; // size: 0x204, address: 0x802DBD50
// Range: 0x800EA438 -> 0x800EA4C0
...
static struct tag_type var_tag; // size: 0x14, address: 0x803BE3B8
// Range: 0x800EA560 -> 0x800EA588
void var_init() {
    // References
    // -> static struct tag_type var_tag;
}

// Range: 0x800EA588 -> 0x800EA5C4
...
struct zVarEntry zVarEntryTable[36]; // size: 0x240, address: 0x802DBF54
// total size: 0xC
...
// Range: 0x800EA5C4 -> 0x800EA614
void zVarInit(struct zVarEntry * table /* r28 */) {
    // Local variables
    int i; // r29
}

// Range: 0x800EA614 -> 0x800EA618
void zVarNewGame() {}
...
// total size: 0x1
struct /* @class$716zVar_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$717zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$718zVar_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$719zVar_cpp */ {
    // Members
...
// Range: 0x800EA8C4 -> 0x800EA8F8
unsigned int zVarEntryCB_Date() {
    // Local variables
    unsigned int date; // r3
}

// Range: 0x800EA8F8 -> 0x800EA918
unsigned int zVarEntryCB_Hour() {
    // Local variables
    unsigned int hour; // r0
}

// Range: 0x800EA918 -> 0x800EA938
unsigned int zVarEntryCB_Minute() {
    // Local variables
    unsigned int minute; // r0
}

// Range: 0x800EA938 -> 0x800EA940
unsigned int zVarEntryCB_CounterValue(void * context /* r3 */) {}

// Range: 0x800EA940 -> 0x800EA958
unsigned int zVarEntryCB_ShowHints() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x800EA958 -> 0x800EA960
unsigned int zVarEntryCB_IsSceneUnlocked() {}

// Range: 0x800EA960 -> 0x800EA968
unsigned int zVarEntryCB_IsSceneCompleted() {}

// Range: 0x800EA968 -> 0x800EA994
unsigned int zVarEntryCB_IsEnabled(void * context /* r0 */) {}

// Range: 0x800EA994 -> 0x800EA9BC
unsigned int zVarEntryCB_IsVisible(void * context /* r0 */) {}
