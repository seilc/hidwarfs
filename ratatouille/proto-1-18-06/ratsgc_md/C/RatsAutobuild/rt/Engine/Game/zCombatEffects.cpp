/*
    ...
    Language: C++
    Code range: 0x8017E1FC -> 0x80180878
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct hit_effect_data hit_effects[3][10]; // size: 0x1E0, address: 0x802E00D0
// total size: 0xC
struct curve_node {
    // Members
...
static struct curve_node splash_curve[3]; // size: 0x24, address: 0x803C8700
enum texture_mode {
    TM_DEFAULT = 0,
    TM_RANDOM = 1,
    TM_CYCLE = 2,
...
// total size: 0x18
struct /* @class$1010zCombatEffects_cpp */ {
    // Members
...
static struct config decal_config[1]; // size: 0x28, address: 0x803BF288
// total size: 0x7C
struct decal_emitter_data {
    ...
    struct xDecalEmitter emitter; // offset 0x14, size 0x68
};
static struct decal_emitter_data decal_emitters[1]; // size: 0x7C, address: 0x802E02B0
...
// Range: 0x8017E2E8 -> 0x8017E2EC
void SparkParticleSystem::add_tweaks() {}
...
// total size: 0x4
struct /* @class$923zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zCombatEffects_cpp */ {
    // Members
...
union /* @class$746zCombatEffects_cpp */ {
...
static class ParticleSystem * par_emitters[3]; // size: 0xC, address: 0x803C3448
// total size: 0x4
struct node {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$727zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$728zCombatEffects_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zCombatEffects_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$730zCombatEffects_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zCombatEffects_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zCombatEffects_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zCombatEffects_cpp */ {
    // Members
...
static struct xResponseCurve proj_curve; // size: 0x10, address: 0x803C3454
// Range: 0x8017E75C -> 0x8017E760
...
static struct curve_node proj_decal_curve[3]; // size: 0x54, address: 0x802B2FC8
// Range: 0x8017E760 -> 0x8017E7E4
static void init_decal_emitters() {
    // Local variables
    int i; // r0
    struct decal_emitter_data & ded; // r0
...
// total size: 0x1C
struct /* @class$1011zCombatEffects_cpp */ {
    // Members
...
static signed char init; // size: 0x1, address: 0x803C3464
static class SparkParticleSystem sparkSystem; // size: 0x88, address: 0x803901F8
static signed char init; // size: 0x1, address: 0x803C3465
// total size: 0x5C
...
static class RockParticleSystem rockSystem; // size: 0x5C, address: 0x80390280
static signed char init; // size: 0x1, address: 0x803C3466
// total size: 0x5C
...
static class BitsParticleSystem bitsSystem; // size: 0x5C, address: 0x803902DC
// Range: 0x8017E9F8 -> 0x8017EAD0
...
static struct xFXRibbon slam_drop_ribbon; // size: 0x10, address: 0x803C3468
// total size: 0x38
...
static struct spiral_config slam_drop_cfg; // size: 0x38, address: 0x803BF2B0
// total size: 0xC
struct spiral_data {
    // Members
...
static struct spiral_data slam_drop_data; // size: 0xC, address: 0x803C3478
// Range: 0x8017F118 -> 0x8017F11C
void init_slam_drop_ribbon() {}

// Range: 0x8017F11C -> 0x8017F148
...
static struct xFXRibbon slam_land_ribbon[3]; // size: 0x30, address: 0x803C3484
static struct spiral_config slam_land_cfg[3]; // size: 0xA8, address: 0x802E032C
static struct spiral_data slam_land_data[3]; // size: 0x24, address: 0x803C34B4
// Range: 0x8017F178 -> 0x8017F1C8
...
// Range: 0x8017F234 -> 0x8017F2B8
void update_slam_land_ribbon(const struct xVec3 & center /* r26 */, float dt /* f31 */) {
    // Local variables
    int i; // r27
...
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x803BF2E8
// total size: 0xC
struct curve_node {
    // Members
    float time; // offset 0x0, size 0x4
...
static struct config_type cfg; // size: 0x20, address: 0x803C34D8
...
// Range: 0x8017F4E4 -> 0x8017F4E8
void PunchEffect::Init() {}

// Range: 0x8017F4E8 -> 0x8017F574
// this: r26
void PunchEffect::Start(const class zCombatAttack * runningAttack /* r27 */) {
    // Local variables
    unsigned int i; // r28
}

// Range: 0x8017F574 -> 0x8017F5F8
...
// Range: 0x8017F5F8 -> 0x8017F608
// this: r0
void PunchEffect::Continue() {}

// Range: 0x8017F608 -> 0x8017F614
// this: r0
...
// Range: 0x8017F614 -> 0x8017F9A0
// this: r24
void PunchEffect::updateRibbon(unsigned int index /* r28 */, const struct xVec3 * cacheElement /* r25 */, const struct xEntFrame * frame /* r26 */, unsigned int addCount /* r27 */) {
    // Local variables
...
// Range: 0x8017F9A0 -> 0x8017FAD4
// this: r31
void PunchEffect::Update(const class zCombatAttack * runningAttack /* r24 */, struct xEnt * attacker /* r25 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x8017FAD4 -> 0x8017FAD8
void PunchEffect::RenderModels() {}

// Range: 0x8017FAD8 -> 0x8017FB4C
// this: r28
...
struct {} @unnamed@zCombatEffects_cpp@::RockParticleSystem::__vtable; // size: 0x1C, address: 0x803BF30C
// Range: 0x8017FB4C -> 0x8017FB5C
static char * RockParticleSystem::tweak_name() {}

// Range: 0x8017FB5C -> 0x8017FC0C
// this: r31
...
// Range: 0x8017FC0C -> 0x8017FE38
static int RockParticleSystem::update(unsigned char * mem /* r30 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f28 */, void * context /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1374zCombatEffects_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1329zCombatEffects_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1330zCombatEffects_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1331zCombatEffects_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1328zCombatEffects_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1333zCombatEffects_cpp */ {
    // Members
...
// Range: 0x8017FEDC -> 0x8017FEE0
static void RockParticleSystem::add_tweaks() {}

// Range: 0x8017FEE0 -> 0x80180174
// this: r28
static void RockParticleSystem::emit(float dt /* f0 */) {
    // Local variables
    float time_passed; // f23
    int emit; // r30
...
// total size: 0x1C
struct {} zCombatEffects::ParticleSystem::__vtable; // size: 0x1C, address: 0x803BF328
static // total size: 0x1C
struct {} @unnamed@zCombatEffects_cpp@::BitsParticleSystem::__vtable; // size: 0x1C, address: 0x803BF344
// Range: 0x80180174 -> 0x80180184
static char * BitsParticleSystem::tweak_name() {}

// Range: 0x80180184 -> 0x80180230
// this: r31
...
// Range: 0x80180230 -> 0x80180484
static int BitsParticleSystem::update(unsigned char * mem /* r30 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f28 */, void * context /* r31 */) {
    // Local variables
    class BitsParticleSystem * system; // r0
    struct ptank_pool__pos_color_size_rot_uv2 & pool; // r29
    struct BitParticle * p; // r28
    struct BitParticle * end; // r27
    float bounce_y; // f26
    struct RwSphere worldsph; // r1+0x8
...
// Range: 0x80180528 -> 0x8018052C
static void BitsParticleSystem::add_tweaks() {}

// Range: 0x8018052C -> 0x80180878
// this: r28
static void BitsParticleSystem::emit(float dt /* f0 */) {
    // Local variables
    float time_passed; // f17
    int emit; // r30
...
// total size: 0x1C
struct {} zCombatEffects::SparkParticleSystem::__vtable; // size: 0x1C, address: 0x803BF360
