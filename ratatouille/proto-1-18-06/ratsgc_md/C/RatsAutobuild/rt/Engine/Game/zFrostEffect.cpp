/*
    ...
    Language: C++
    Code range: 0x801472F0 -> 0x80147450
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sEmitTimer; // size: 0x4, address: 0x803BEB50
// total size: 0x4
struct node {
    // Members
...
static class zFrostEffect sFrostEmitter; // size: 0x70, address: 0x80389608
// Range: 0x801472F0 -> 0x8014731C
