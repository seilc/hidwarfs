/*
    ...
    Language: C++
    Code range: 0x800B44DC -> 0x800B4D44
*/
// total size: 0x18
struct xGridBound {
    // Members
...
static int zGridInitted; // size: 0x4, address: 0x803C1F20
static unsigned int special_models[58]; // size: 0xE8, address: 0x802D9DE8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800B4B80 -> 0x800B4BC4
static unsigned char IsEntityGrabbable(struct xEnt * ent /* r0 */) {}

// Range: 0x800B4BC4 -> 0x800B4D44
void zGridUpdateEnt(struct xEnt * ent /* r30 */) {
    // Local variables
    struct xGrid * grid; // r31
