/*
    ...
    Language: C++
    Code range: 0x8015831C -> 0x8015877C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int currentActive; // size: 0x4, address: 0x803C3070
unsigned int lastCheckpointNumber; // size: 0x4, address: 0x803C3074
// total size: 0x8
struct substr {
    // Members
...
static struct tweak_callback tweakOnOffCB; // size: 0x28, address: 0x803BEEB0
static signed char init; // size: 0x1, address: 0x803C3078
// total size: 0x20
struct xLinkAsset {
    // Members
