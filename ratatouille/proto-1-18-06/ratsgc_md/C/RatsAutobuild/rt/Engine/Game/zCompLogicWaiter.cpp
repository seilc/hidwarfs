/*
    ...
    Language: C++
    Code range: 0x801A9C7C -> 0x801AB288
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float WAITER_BOUND_RADIUS; // size: 0x4, address: 0x803BFAA0
static float WAITER_BOUND_MIDRADIUS; // size: 0x4, address: 0x803BFAA4
static float WAITER_BOUND_YSHIFT; // size: 0x4, address: 0x803BFAA8
static float BIG_EPSILON; // size: 0x4, address: 0x803BFAAC
static float WAITER_COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x803BFAB0
static float showScalarVel; // size: 0x4, address: 0x803C39A8
static unsigned int WAITER_TORSO; // size: 0x4, address: 0x803BFAB4
static unsigned int WAITER_HEAD; // size: 0x4, address: 0x803BFAB8
static unsigned int WAITER_LHAND; // size: 0x4, address: 0x803BFABC
static unsigned int WAITER_RHAND; // size: 0x4, address: 0x803BFAC0
// total size: 0x28
...
unsigned int zCOLLISION_NPC; // size: 0x4, address: 0x803C9008
unsigned int zCOLLISION_NEEDS_DEPEN_OUTER_BOUND; // size: 0x4, address: 0x803C900C
unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x803C9010
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
