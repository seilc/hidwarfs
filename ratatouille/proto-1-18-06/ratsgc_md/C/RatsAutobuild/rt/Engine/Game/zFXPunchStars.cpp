/*
    ...
    Language: C++
    Code range: 0x8014C5AC -> 0x8014CBBC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x803C2F70
// total size: 0x5C
struct config {
    // Members
...
int system_id; // size: 0x4, address: 0x803BEC10
// total size: 0x28
