/*
    ...
    Language: C++
    Code range: 0x801B9CF8 -> 0x801B9DE8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x78
struct {} zMiniGameCongaLine::__vtable; // size: 0x78, address: 0x802E4878
// total size: 0x18
...
// Range: 0x801B9DB0 -> 0x801B9DDC
// this: r0
void zMiniGameCongaLine::SceneSetup() {}

// Range: 0x801B9DDC -> 0x801B9DE0
void zMiniGameCongaLine::Update() {}

// Range: 0x801B9DE0 -> 0x801B9DE4
void zMiniGameCongaLine::Render() {}

// Range: 0x801B9DE4 -> 0x801B9DE8
