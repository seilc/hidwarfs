/*
    ...
    Language: C++
    Code range: 0x800FF948 -> 0x801008EC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xFuncPiece sFadeSize[2]; // size: 0x40, address: 0x803C2858
// total size: 0x20
struct xFuncPiece {
    // Members
...
static struct xFuncPiece sDistSize; // size: 0x20, address: 0x803C2898
static float sAlpha; // size: 0x4, address: 0x803BE460
static float sFadeInSpeed; // size: 0x4, address: 0x803BE464
static float sFadeOutSpeed; // size: 0x4, address: 0x803BE468
static float sMinDist; // size: 0x4, address: 0x803BE46C
static float sPulseAmp; // size: 0x4, address: 0x803BE470
static float sPulseSpeed; // size: 0x4, address: 0x803BE474
static float sRotSpeed; // size: 0x4, address: 0x803BE478
static float sSwirlMaxU; // size: 0x4, address: 0x803BE47C
static float sSwirlMinU; // size: 0x4, address: 0x803BE480
static float sSwirlMaxV; // size: 0x4, address: 0x803BE484
static float sSwirlMinV; // size: 0x4, address: 0x803BE488
static unsigned char sSwirlRed; // size: 0x1, address: 0x803BE48C
static unsigned char sSwirlGreen; // size: 0x1, address: 0x803BE48D
static unsigned char sSwirlBlue; // size: 0x1, address: 0x803BE48E
static unsigned char sSwirlRedSwitchLever1; // size: 0x1, address: 0x803BE48F
static unsigned char sSwirlGreenSwitchLever1; // size: 0x1, address: 0x803C28B8
static unsigned char sSwirlBlueSwitchLever1; // size: 0x1, address: 0x803BE490
static unsigned char sSwirlRedSwitchLever2; // size: 0x1, address: 0x803BE491
static unsigned char sSwirlGreenSwitchLever2; // size: 0x1, address: 0x803BE492
static unsigned char sSwirlBlueSwitchLever2; // size: 0x1, address: 0x803BE493
static float sLetterMaxU; // size: 0x4, address: 0x803BE494
static float sLetterMinU; // size: 0x4, address: 0x803BE498
static float sLetterMaxV; // size: 0x4, address: 0x803BE49C
static float sLetterMinV; // size: 0x4, address: 0x803BE4A0
static unsigned char sLetterRed; // size: 0x1, address: 0x803BE4A4
static unsigned char sLetterGreen; // size: 0x1, address: 0x803BE4A5
static unsigned char sLetterBlue; // size: 0x1, address: 0x803BE4A6
static float sXMult; // size: 0x4, address: 0x803BE4A8
static float sZBias; // size: 0x4, address: 0x803BE4AC
// total size: 0x24
struct zReticle {
    // Members
...
static struct zReticle reticle[4]; // size: 0x90, address: 0x803802A0
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * reticleRast; // size: 0x4, address: 0x803C28BC
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x800FFBFC -> 0x800FFF00
void zReticle_RenderSwirl(struct xMat4x3 * mat /* r25 */, float angle /* f26 */, struct xColor_tag & color1 /* r26 */, struct xColor_tag & color2 /* r27 */) {
    // Local variables
...
// Range: 0x80100374 -> 0x80100404
void zReticle_Render() {
    // Local variables
    int i; // r29
    unsigned char wasBright; // r29

    // References
    // -> static struct zReticle reticle[4];
}

static float sAlphaUpRate; // size: 0x4, address: 0x803BE4B0
static float sAlphaDownRate; // size: 0x4, address: 0x803BE4B4
static float sMinDrawDist2; // size: 0x4, address: 0x803BE4B8
static float sMaxDrawAlpha; // size: 0x4, address: 0x803BE4BC
static float sIconAngle; // size: 0x4, address: 0x803C28C0
// Range: 0x80100404 -> 0x80100424
void zIcon_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x80100424 -> 0x801004BC
void zIcon_Init(struct zIcon * icon /* r30 */, struct zIconAsset * asset /* r31 */) {}

// Range: 0x801004BC -> 0x801004FC
void zIcon_Reset() {
    // Local variables
    struct zScene * zsc; // r4
    int count; // r0
...
// Range: 0x801006B0 -> 0x801006E4
void zIcon_EventCB(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */) {
    // Local variables
    struct zIcon * icon; // r0
}

// Range: 0x801006E4 -> 0x80100748
void zIcon_Render() {
    // Local variables
    struct zScene * zsc; // r3
    int count; // r30
