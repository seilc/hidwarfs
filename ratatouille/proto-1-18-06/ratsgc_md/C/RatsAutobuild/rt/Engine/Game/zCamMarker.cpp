/*
    ...
    Language: C++
    Code range: 0x80168F30 -> 0x80169BA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char activated; // size: 0x1, address: 0x803C3230
static struct zCamWidget * widget_cam; // size: 0x4, address: 0x803C3234
enum _tagTransType {
    eTransType_None = 0,
...
static struct xCamAsset static_cam_asset; // size: 0x88, address: 0x80390040
// Range: 0x80168F30 -> 0x80168FA0
...
struct zCamWidget : public xCam {
    ...
    // Members
    unsigned char transitioning; // offset 0x130, size 0x1
    unsigned char restore_original; // offset 0x131, size 0x1
    const struct xCamAsset * asset; // offset 0x134, size 0x4
    float time; // offset 0x138, size 0x4
    float end_time; // offset 0x13C, size 0x4
    float start_fov; // offset 0x140, size 0x4
    float end_fov; // offset 0x144, size 0x4
    struct xVec3 start_loc; // offset 0x148, size 0xC
    struct xQuat start_dir; // offset 0x154, size 0x10
    struct xQuat end_dir; // offset 0x164, size 0x10
    float last_s; // offset 0x174, size 0x4
    struct xEnt * target_ent; // offset 0x178, size 0x4
    struct xMat4x3 end_mat; // offset 0x180, size 0x40
    struct xMat4x3 original_mat; // offset 0x1C0, size 0x40
};
// Range: 0x80168FA0 -> 0x8016901C
// this: r31
static void zCamWidget::transition(const struct xCamAsset * asset /* r0 */, float time /* f1 */, struct xEnt * target_ent /* r0 */) {}

// Range: 0x8016901C -> 0x80169094
// this: r31
static void zCamWidget::start_transition() {}

// Range: 0x80169094 -> 0x801690F8
// this: r31
...
// Range: 0x80169238 -> 0x8016923C
static void add_tweak_stub() {}

// Range: 0x8016923C -> 0x80169240
static void add_global_tweaks() {}

// Range: 0x80169240 -> 0x80169244
static void debug_update() {}

// Range: 0x80169244 -> 0x80169264
void zCamMarkerActivateCamera(const struct xCamAsset & a /* r0 */, struct xEnt * ent /* r0 */) {}

// Range: 0x80169264 -> 0x801692C8
...
// Range: 0x801692C8 -> 0x8016931C
// this: r31
static void zCamWidget::create() {}

// Range: 0x80169354 -> 0x80169390
...
// total size: 0x0
struct xSerial {};
// Range: 0x801693EC -> 0x8016940C
void zCamMarkerSave(struct zCamMarker * m /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8016940C -> 0x8016942C
void zCamMarkerLoad(struct zCamMarker * m /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8016942C -> 0x80169474
void zCamMarkerEventCB(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r7 */) {}
...
static class zCamPool POICamPool; // size: 0x18, address: 0x803C3238
// total size: 0x14
...
// total size: 0xC
struct /* @class$747zCamMarker_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$748zCamMarker_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$749zCamMarker_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$750zCamMarker_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$751zCamMarker_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$752zCamMarker_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$753zCamMarker_cpp */ {
    // Members
...
struct zCamPlayerPOI : public zCam2Player {
    ...
    // Members
    const struct xCamBinaryAsset * mAsset; // offset 0x3D0, size 0x4
    struct xBase * mTarget; // offset 0x3D4, size 0x4
};
// Range: 0x80169778 -> 0x801697AC
// this: r31
void zCamPlayerPOI::update(struct xScene & scene /* r0 */, float dt /* f0 */) {}

// Range: 0x801697AC -> 0x801697F4
// this: r31
...
// total size: 0x4
struct /* @class$890zCamMarker_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$908zCamMarker_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$1098zCamMarker_cpp */ {
    // Members
...
protected:
    ...
    struct /* @class$1098zCamMarker_cpp */ {
        ...
        float radius; // offset 0x10, size 0x4
        float marginAngle; // offset 0x14, size 0x4
    } mSecondary; // offset 0x130, size 0x18
    unsigned char mHaveSecondary; // offset 0x148, size 0x1
    struct rest_config rest; // offset 0x14C, size 0x10
    float mPivotYOffset; // offset 0x15C, size 0x4
    unsigned char mFirstFrame; // offset 0x160, size 0x1
    unsigned char mIsLocked; // offset 0x161, size 0x1
    class xCamSupportLOSBar mLOSBar; // offset 0x164, size 0x38
    float mPreCollideThetaRestoreGoal; // offset 0x19C, size 0x4
    class xSpringyVec3 mTargetPos; // offset 0x1A0, size 0x28
    struct basis_traits mBasis; // offset 0x1C8, size 0xDC
    struct basis_traits mLastBasis; // offset 0x2A4, size 0xDC
    class xSpringyF32 mMountY; // offset 0x380, size 0x18
    class xSpringyAngle mPitchOffset; // offset 0x398, size 0x18
    class xSpringyAngle mYawOffset; // offset 0x3B0, size 0x18
};
// total size: 0x78
...
public:
    void * __vptr$; // offset 0x0, size 0x4
protected:
    class zCameraCurve * mCurveInfo; // offset 0x4, size 0x4
    class Follower mCurveFollower; // offset 0x8, size 0x50
    class xSpringyVec3 mCameraPathPosSprung; // offset 0x58, size 0x28
};
// total size: 0x54
...
struct {} @unnamed@zCamMarker_cpp@::zCamWidget::__vtable; // size: 0x40, address: 0x803BEFB0
// Range: 0x801699DC -> 0x801699E4
static float zCamWidget::getCameraPlayerAudioBias() {}

// Range: 0x801699E4 -> 0x80169A60
// this: r31
