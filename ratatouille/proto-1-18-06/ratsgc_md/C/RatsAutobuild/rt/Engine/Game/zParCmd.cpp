/*
    ...
    Language: C++
    Code range: 0x800C2E88 -> 0x800C3ABC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zVolume * sClipVolume[32]; // size: 0x80, address: 0x8036A790
static int sClipVolumeTotal; // size: 0x4, address: 0x803C2168
// Range: 0x800C2E88 -> 0x800C2F48
void zParCmdInit() {}

// Range: 0x800C2F48 -> 0x800C2FE4
...
// Range: 0x800C2FE4 -> 0x800C30B8
void xParCmdKillDistance_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r0 */) {
    // Local variables
    struct xPar * p; // r31
...
// Range: 0x800C30B8 -> 0x800C3154
void xParCmdClipVolumes_Update(struct xParGroup * ps /* r0 */) {
    // Local variables
    struct xPar * p; // r29
    int i; // r28
...
// Range: 0x800C3158 -> 0x800C32EC
void xParCmdAnimalMagentism_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r30 */, float dt /* f27 */) {
    // Local variables
    struct xPar * p; // r31
    struct xParCmdAnimalMagentism * cmd; // r31
...
static struct xCollis collis; // size: 0x54, address: 0x8036A810
// total size: 0x20
struct xQCData {
    // Members
...
static struct xBound bnd_fake; // size: 0x4C, address: 0x802DA110
...
// Range: 0x800C34B4 -> 0x800C3654
void xParCmdJet_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r31 */, float dt /* f0 */) {
    // Local variables
    struct xPar * p; // r31
    struct xParCmdJet * cmd; // r30
    float mdt; // f31
...
// Range: 0x800C37B0 -> 0x800C38C8
void xParCmdApplyCamMat_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r0 */, float dt /* f0 */) {
    // Local variables
    struct xPar * p; // r3
    struct xParCmdApplyCamMat * cmd; // r5
    struct xMat4x3 * mat; // r6
    float mul; // f3
...
// Range: 0x800C38C8 -> 0x800C3ABC
void xParCmdCustom_Update(struct xParCmd * c /* r0 */, struct xParGroup * ps /* r0 */, float dt /* f0 */) {
    // Local variables
    struct xPar * p; // r31
    float mdt; // f31
    struct xVec3 center; // r1+0x14
