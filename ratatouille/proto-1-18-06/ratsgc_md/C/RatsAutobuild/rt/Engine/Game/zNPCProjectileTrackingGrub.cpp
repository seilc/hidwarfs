/*
    ...
    Language: C++
    Code range: 0x8017B42C -> 0x8017C3E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x802B2EA8
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x803C3408
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x803C340C
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x803C3410
static unsigned int TGRUB_BUG_MODEL_ID; // size: 0x4, address: 0x803C3414
static unsigned int TGRUB_WING_MODEL_ID; // size: 0x4, address: 0x803C3418
static unsigned int TGRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x803C341C
static unsigned int TGRUB_WING_SURFACE_ID; // size: 0x4, address: 0x803C3420
// total size: 0x38
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x38, address: 0x803BF1D0
static struct TrailConfig ShortTrailConfig; // size: 0x38, address: 0x803BF208
enum iSndGroupHandle {
};
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x803BF240
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x803BF244
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x803BF248
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct xSurface * tgrubScrollingSurf; // size: 0x4, address: 0x803C3424
struct xSurface * tgrubWingScrollingSurf; // size: 0x4, address: 0x803C3428
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// Range: 0x8017B42C -> 0x8017B458
// this: r0
void zNPCProjectileTrackingGrub::Reset() {}

// Range: 0x8017B458 -> 0x8017B460
...
// Range: 0x8017B920 -> 0x8017B968
// this: r31
void zNPCProjectileTrackingGrub::Render() {}

// Range: 0x8017B968 -> 0x8017B9F4
// this: r31
void zNPCProjectileTrackingGrub::Destroy() {}

// Range: 0x8017B9F4 -> 0x8017BD5C
// this: r30
...
struct ArcConfig zNPCProjectileGrubArcPlayerConfig; // size: 0x1C, address: 0x803BF100
struct ArcConfig zNPCProjectileGrubArcNPCConfig; // size: 0x1C, address: 0x803BF11C
// total size: 0x34
struct SparkConfig {
    // Members
    float lifeMin; // offset 0x0, size 0x4
...
// total size: 0x38
struct {} zNPCProjectileTrackingGrub::__vtable; // size: 0x38, address: 0x803BF24C
// total size: 0x0
