/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCameraRBand.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x801685DC -> 0x80168778
*/
// total size: 0x10
struct /* @class$1063zCameraRBand_cpp */ {
    // Members
...
struct zSlideCam * rbCam; // size: 0x4, address: 0x803C31E8
unsigned char zRBAND_CAMERA_ACTIVE; // size: 0x1, address: 0x803C31EC
// total size: 0x10
...
// Range: 0x801685DC -> 0x801685FC
void zCameraRBandAsset_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// total size: 0x20
struct zCameraRBandAsset : public xDynAsset {
    // Members
    float spring_len; // offset 0x10, size 0x4
    float spring_const; // offset 0x14, size 0x4
    float damp_const; // offset 0x18, size 0x4
    float vertical_offset; // offset 0x1C, size 0x4
};
// total size: 0x14
struct zCameraRBandObject : public xBase {
    // Members
    struct zCameraRBandAsset * asset; // offset 0x10, size 0x4
};
// Range: 0x801685FC -> 0x801686B8
void zCameraRBandAsset_Init(struct zCameraRBandObject * object /* r30 */, struct zCameraRBandAsset * asset /* r31 */) {
    // References
    // -> struct zSlideCam * rbCam;
}
...
// total size: 0x4
struct /* @class$786zCameraRBand_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zCameraRBand_cpp */ {
    // Members
...
union /* @class$805zCameraRBand_cpp */ {
...
// Range: 0x801686B8 -> 0x80168778
void zCameraRBandAsset_EventCB(unsigned int toEvent /* r0 */) {
    // References
    // -> struct zSlideCam * rbCam;
    // -> unsigned char zRBAND_CAMERA_ACTIVE;
