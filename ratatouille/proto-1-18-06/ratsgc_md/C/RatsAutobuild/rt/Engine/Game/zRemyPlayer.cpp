/*
    ...
    Language: C++
    Code range: 0x8015D5D8 -> 0x8015FC3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int lastUsedPadMRI; // size: 0x4, address: 0x803BEEE8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static class zCombatAttack remyAttackStates[14]; // size: 0x9D8, address: 0x8038EFE8
static unsigned int NUM_HIT_STARS; // size: 0x4, address: 0x803BEEEC
// total size: 0x5C
struct config {
    // Members
...
static struct config punch_stars_config; // size: 0x5C, address: 0x8038F9C0
static struct config hit_stars_config; // size: 0x5C, address: 0x8038FA1C
// total size: 0x50
...
static struct config uppercut_slam_config; // size: 0xC4, address: 0x8038FA78
static struct config finish_slam_config; // size: 0xC4, address: 0x8038FB3C
// total size: 0xC
struct curve_node {
    // Members
...
static struct config_type punch_streak_cfg; // size: 0x20, address: 0x803C3140
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x803BEEF0
// total size: 0xC
struct HFXSlamInfo {
    // Members
...
static struct HFXSlamInfo uppercut_slam; // size: 0xC, address: 0x803BEF14
static struct HFXSlamInfo finish_slam; // size: 0xC, address: 0x803BEF20
// total size: 0x20
struct AttackFX {
    // Members
...
static struct AttackFX AttackFXList[15]; // size: 0x1E0, address: 0x802DDE10
// total size: 0x14
struct HitFX {
    // Members
    unsigned int anim; // offset 0x0, size 0x4
...
static struct HitFX HitFXList[2]; // size: 0x28, address: 0x803BEF2C
// total size: 0x18
struct analog_data {
    // Members
...
static struct compositeEffect rumbleEffects[1]; // size: 0x50, address: 0x8038FC00
// Range: 0x8015D868 -> 0x8015D880
...
// Range: 0x8015D8CC -> 0x8015D8EC
// this: r0
void zRemyPlayer::SetupRumbles() {}

// Range: 0x8015D8EC -> 0x8015D964
// this: r31
...
static struct alpha_curve_node alphaCurve[4]; // size: 0x20, address: 0x803C8108
struct config default_config; // size: 0x5C, address: 0x8038A218
struct config default_config; // size: 0xC4, address: 0x8037C140
// total size: 0xC
...
// Range: 0x8015E050 -> 0x8015E0A4
// this: r31
void zRemyPlayer::Reset() {}

// Range: 0x8015E0A4 -> 0x8015E144
// this: r3
...
// Range: 0x8015E144 -> 0x8015E1B4
// this: r31
void zRemyPlayer::DefaultUpdate(float dt /* f31 */) {}

// Range: 0x8015E1B4 -> 0x8015E1D4
// this: r0
...
static float time; // size: 0x4, address: 0x803C3160
static float lastTime; // size: 0x4, address: 0x803C3164
static struct xFXRibbon * up; // size: 0x4, address: 0x803C3168
static float distance; // size: 0x4, address: 0x803C316C
static struct xVec3 averageWidth; // size: 0xC, address: 0x803C3170
...
// Range: 0x8015EE24 -> 0x8015EE68
// this: r31
float zRemyPlayer::InitialDepenetrationVelocity() {}

// Range: 0x8015EE68 -> 0x8015EE94
// this: r3
...
// Range: 0x8015EF20 -> 0x8015EF28
int * zRemyPlayer::GetHeadBones() {}

// Range: 0x8015EF28 -> 0x8015F7A0
// this: r31
...
static struct xHierarchyBoundInitData bounds[14]; // size: 0xA8, address: 0x802DDFF0
// Range: 0x8015FAF8 -> 0x8015FB04
struct xHierarchyBoundInitData * zRemyPlayer::GetHierarchyBoundInitData() {
    // References
    // -> static struct xHierarchyBoundInitData bounds[14];
}

// Range: 0x8015FB04 -> 0x8015FB0C
...
// Range: 0x8015FBD4 -> 0x8015FBF4
// this: r0
void zRemyPlayer::LoadSetupUpgrades() {}

// total size: 0x50
struct {} zPlayerSpringboard::__vtable; // size: 0x50, address: 0x802DE098
...
// total size: 0x50
struct {} zPlayerContextAction::__vtable; // size: 0x50, address: 0x802DE0E8
// total size: 0x50
struct {} zCommonPlayerAction::__vtable; // size: 0x50, address: 0x802DE138
// total size: 0x154
struct {} zRemyPlayer::__vtable; // size: 0x154, address: 0x802DE188
// total size: 0xC
