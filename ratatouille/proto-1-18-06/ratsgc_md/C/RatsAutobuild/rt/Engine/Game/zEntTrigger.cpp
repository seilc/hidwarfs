/*
    ...
    Language: C++
    Code range: 0x800A1E18 -> 0x800A39A4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800A1E18 -> 0x800A1E1C
void zEntTriggerSceneEnter() {}

// Range: 0x800A1E1C -> 0x800A1E20
void zEntTriggerSceneExit() {}

// Range: 0x800A1E20 -> 0x800A1E40
...
// total size: 0x4
struct /* @class$786zEntTrigger_cpp */ {
    // Members
...
union /* @class$805zEntTrigger_cpp */ {
...
// total size: 0xC
struct /* @class$804zEntTrigger_cpp */ {
    // Members
...
// Range: 0x800A21A0 -> 0x800A239C
void zEntTriggerUpdate(struct zEntTrigger * trig /* r29 */, struct xScene * sc /* r26 */, float dt /* f31 */) {
    // Local variables
    struct xTriggerAsset * tasset; // r0
    unsigned int i; // r31
    const struct xLinkAsset * link; // r30
    unsigned char collide; // r27
    struct xEnt * chkEnt; // r28
    struct xBase * chkBase; // r26
...
// total size: 0xC
struct /* @class$751zEntTrigger_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zEntTrigger_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zEntTrigger_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zEntTrigger_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zEntTrigger_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zEntTrigger_cpp */ {
    // Members
...
// Range: 0x800A2528 -> 0x800A2614
void zEntTriggerEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r28 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
...
// Range: 0x800A2614 -> 0x800A2634
void zEntTriggerSave(struct zEntTrigger * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800A2634 -> 0x800A2654
void zEntTriggerLoad(struct zEntTrigger * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800A2654 -> 0x800A2734
...
class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD0, address: 0x8035CD90
// total size: 0x1
class zSpecialTriggersTree {
    // Static members
    static class xSpacePartitionTree2D SpecialTriggersTree; // size: 0xD0
};
// total size: 0x18
struct xBox {
    // Members
...
// total size: 0xC
struct /* @class$827zEntTrigger_cpp */ {
    // Members
...
// Range: 0x800A31C0 -> 0x800A3350
int zSpecialTriggersTree::IntersectingSphere(const struct xVec3 & pos /* r22 */, float radius /* f31 */, unsigned short triggerFilter /* r0 */, unsigned short entFilter /* r20 */, int maxTriggers /* r6 */, struct zEntTrigger * * triggerList /* r23 */) {
    // Local variables
    int i; // r26
    ...
    unsigned short triggerFlags; // r4
