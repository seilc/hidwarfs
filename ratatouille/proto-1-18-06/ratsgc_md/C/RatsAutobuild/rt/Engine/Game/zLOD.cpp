/*
    ...
    Language: C++
    Code range: 0x800BB2A0 -> 0x800BB974
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int sLODTableCount; // size: 0x4, address: 0x803C2068
// total size: 0x8
struct RwObject {
    // Members
...
static struct zLODTable * sLODTableList; // size: 0x4, address: 0x803C206C
static unsigned int sManagerIndex; // size: 0x4, address: 0x803C2070
static unsigned int sManagerCount; // size: 0x4, address: 0x803C2074
static float sLODFadeDistance; // size: 0x4, address: 0x803BE150
// total size: 0x10
struct zLODManager {
    // Members
...
static struct zLODManager sManagerList[2900]; // size: 0xB540, address: 0x8035E9D8
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800BB2A0 -> 0x800BB480
static void AddToLODList(struct xEnt * ent /* r30 */) {
    // Local variables
    unsigned int i; // r31
...
// Range: 0x800BB6CC -> 0x800BB910
void zLOD_Update(unsigned int percent_update /* r0 */) {
    // Local variables
    struct xVec3 * campos; // r0
    unsigned int numUpdates; // r0
    struct zLODManager & lodManager; // r7
    struct zLODTable * lod; // r8
    struct xModelInstance * model; // r9
    float camdist2; // f4
    float distscale; // f5
    int i; // r10
