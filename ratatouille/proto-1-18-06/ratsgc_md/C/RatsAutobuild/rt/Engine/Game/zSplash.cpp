/*
    ...
    Language: C++
    Code range: 0x800F1E20 -> 0x800F5388
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char ini_filename[11]; // size: 0xB, address: 0x803C6B48
static char * texture_key_names[8]; // size: 0x20, address: 0x803BE438
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwTexture * cone_texture; // size: 0x4, address: 0x803C27B0
// total size: 0x28
struct /* @class$1213zSplash_cpp */ {
    // Members
...
static struct splash_emitter * splash_emitters; // size: 0x4, address: 0x803C27B4
static int splash_emitters_size; // size: 0x4, address: 0x803C27B8
// total size: 0x48
...
static struct plume_emitter * plume_emitters; // size: 0x4, address: 0x803C27BC
static int plume_emitters_size; // size: 0x4, address: 0x803C27C0
// total size: 0x14
...
static struct bubble_emitter * bubble_emitters; // size: 0x4, address: 0x803C27C4
static int bubble_emitters_size; // size: 0x4, address: 0x803C27C8
// total size: 0x8
struct chain_link {
    // Members
...
static struct chain_emitter * chain_emitters; // size: 0x4, address: 0x803C27CC
static int chain_emitters_size; // size: 0x4, address: 0x803C27D0
static int mist_system_id; // size: 0x4, address: 0x803C27D4
static int ring_system_id; // size: 0x4, address: 0x803C27D8
static int streak_system_id; // size: 0x4, address: 0x803C27DC
static int plume_system_id; // size: 0x4, address: 0x803C27E0
static int trail_system_id; // size: 0x4, address: 0x803C27E4
static int drips_system_id; // size: 0x4, address: 0x803C27E8
enum type_enum {
    TYPE_SPLASH = 0,
    TYPE_PLUME = 1,
    TYPE_BUBBLE = 2,
...
static struct splash_planner * planners; // size: 0x4, address: 0x803C27EC
// total size: 0x8
struct type_mapping {
    // Members
...
static struct type_mapping * type_mappings; // size: 0x4, address: 0x803C27F0
static int types_size; // size: 0x4, address: 0x803C27F4
static unsigned int texture_ids[8]; // size: 0x20, address: 0x803C27F8
static int cone_texture_repeats; // size: 0x4, address: 0x803BE458
// Range: 0x800F1E20 -> 0x800F2100
...
// Range: 0x800F2F68 -> 0x800F2FA0
static void free_splash_emitter(struct splash_emitter * emitter /* r0 */) {
    // References
    // -> static int splash_emitters_size;
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x800F3098 -> 0x800F30B4
...
// Range: 0x800F30B4 -> 0x800F30EC
static void free_plume_emitter(struct plume_emitter * emitter /* r0 */) {
    // References
    // -> static int plume_emitters_size;
    // -> static struct plume_emitter * plume_emitters;
}

// Range: 0x800F3180 -> 0x800F319C
...
// Range: 0x800F319C -> 0x800F31D4
static void free_bubble_emitter(struct bubble_emitter * emitter /* r0 */) {
    // References
    // -> static int bubble_emitters_size;
    // -> static struct bubble_emitter * bubble_emitters;
}

// Range: 0x800F3200 -> 0x800F321C
...
// Range: 0x800F3250 -> 0x800F3398
static void emit_splash_internal(int type /* r0 */, const struct xVec3 & loc /* r29 */) {
    // Local variables
    const struct splash_planner & plan; // r30
...
// Range: 0x800F3530 -> 0x800F371C
static int update_ring_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x800F4424 -> 0x800F4610
static int update_plume_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
...
static void render_cones() {
    ...
    float du; // f27
    const struct splash_emitter * splash; // r28
    const struct splash_emitter * end_splash; // r27
    float cx; // f26
    float cy; // f25
    float cz; // f28
    float radius; // f24
    ...
    float Az; // f18
    float Bz; // f18
    struct xVec3 * const end_pos; // r25
    float tempc; // f0
...
// Range: 0x800F5080 -> 0x800F50A4
void zSplashStartup() {}

// Range: 0x800F50A4 -> 0x800F51DC
...
// Range: 0x800F51DC -> 0x800F51E0
static void debug_init() {}

// Range: 0x800F51E0 -> 0x800F51E4
void zSplashSceneExit() {}

// Range: 0x800F51E4 -> 0x800F523C
void zSplashUpdate(float dt /* f31 */) {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x800F523C -> 0x800F5240
static void debug_update() {}

// Range: 0x800F5240 -> 0x800F526C
void zSplashRender() {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x800F526C -> 0x800F52D4
