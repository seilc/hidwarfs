/*
    ...
    Language: C++
    Code range: 0x80100950 -> 0x801033DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80100950 -> 0x80100954
static void add_tweaks() {}

class zGrass * grass; // size: 0x4, address: 0x803C28C8
// total size: 0x18
struct analog_data {
    // Members
...
// Range: 0x80100A98 -> 0x80100ACC
void zGrass::scene_exit() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100ACC -> 0x80100AD8
void zGrass::setup() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100AD8 -> 0x80100BB0
void zGrass::reset() {
    // Local variables
    struct knoll_type * knoll; // r4
    struct knoll_type * const end_knoll; // r5
    struct clone_node * clone; // r3
    struct clone_node * end_clone; // r4
    struct grass_cache * cache; // r31
    struct grass_cache * end_cache; // r30

    // References
    // -> class zGrass * grass;
}

// Range: 0x80100BB0 -> 0x80100BDC
void zGrass::update(float dt /* f0 */) {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100BDC -> 0x80100BE8
void zGrass::pre_render() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100BE8 -> 0x80100C3C
void zGrass::render() {
    // References
    // -> class zGrass * grass;
}
...
// Range: 0x80100C3C -> 0x80100CDC
void zGrass::load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */) {
    // Local variables
    struct asset_type & a; // r0
    struct base_widget * w; // r0
    struct knoll_type * knoll; // r3
    struct knoll_type * end_knoll; // r4

    // References
    // -> class zGrass * grass;
}

// Range: 0x80100CDC -> 0x80100D48
void zGrass::event_handler(struct xBase * to /* r0 */, unsigned int event /* r0 */) {
    // References
    // -> class zGrass * grass;
}
...
// Range: 0x80100D48 -> 0x80100F3C
void zGrass::create_knolls(struct knoll_type * & knolls /* r28 */, int & knolls_size /* r27 */) {
    // Local variables
    unsigned int type; // r0
    int asses; // r0
    int i; // r26
    unsigned int asset_size; // r1+0x14
    struct asset_type * asset; // r0
    struct zGrassMeshAsset * mesh; // r0
    unsigned int model_id; // r1+0x10
    struct RpAtomic * atomic; // r0
    struct xModelPipe pipe; // r1+0x20
    struct knoll_type * knoll; // r28
    int i; // r27
    unsigned int asset_size; // r1+0xC
    struct asset_type * asset; // r0
    struct zGrassMeshAsset * mesh; // r0
    unsigned int model_id; // r1+0x8
    struct RpAtomic * atomic; // r0
    struct xModelPipe pipe; // r1+0x18
}
...
// Range: 0x80100F3C -> 0x80100FC0
// this: r0
void zGrass::apply_visibility(struct knoll_type & knoll /* r0 */) {
    // Local variables
    unsigned char knoll_index; // r4
    union grass_mesh_tri * tri; // r5
    union grass_mesh_tri * const end_tri; // r6
}

// Range: 0x80100FC0 -> 0x80101028
// this: r29
void zGrass::refresh_visibility() {
    // Local variables
    struct knoll_type * knoll; // r31
    struct knoll_type * const end_knoll; // r30
}

// Range: 0x80101028 -> 0x80101030
struct RpAtomic * zGrass::setup_atomic(struct RpAtomic * atomic /* r4 */) {}

// Range: 0x80101030 -> 0x80101084
void zGrass::destroy_atomic(struct RpAtomic * atomic /* r30 */) {
    // Local variables
    struct RwFrame * frame; // r31
}

// Range: 0x80101084 -> 0x801011D0
// this: r31
void zGrass::create_caches() {
    // Local variables
    struct RpAtomic * atomics_found[8]; // r1+0x8
    struct knoll_type * knoll; // r6
    struct knoll_type * end_knoll; // r7
    struct RpAtomic * * t; // r8
    struct RpAtomic * * endt; // r0
    struct grass_cache * cache; // r29
    struct grass_cache * end_cache; // r28
    struct RpAtomic * * atomic; // r27
}

// Range: 0x801011D0 -> 0x80101230
// this: r29
...
// Range: 0x80101230 -> 0x80101240
void zGrass::reset_cache(struct grass_cache & cache /* r0 */) {}

// Range: 0x80101240 -> 0x801012A4
// this: r31
void zGrass::reset_view_area() {}

// Range: 0x801012A4 -> 0x801012B8
// this: r0
...
// Range: 0x801012B8 -> 0x80101458
// this: r0
void zGrass::refresh_density(union grass_mesh_tri & tri /* r31 */) {
    // Local variables
    struct knoll_type & knoll; // r30
    const struct zGrassMeshVertex & A; // r29
...
// Range: 0x80101458 -> 0x8010151C
// this: r30
void zGrass::allocate_grid_cell_boxes() {
    // Local variables
    int grid_size; // r27
    int nonempty_cells; // r5
    int i; // r31
}

// Range: 0x8010151C -> 0x801017C8
// this: r27
void zGrass::refresh_grid_cell_boxes() {
    ...
    float zlower; // f3
    float zupper; // f29
    const union grass_mesh_tri * tri; // r10
    const union grass_mesh_tri * const end_tri; // r11
    const struct knoll_type & knoll; // r9
    float atomic_radius; // f6
    const struct zGrassMeshVertex & v0; // r12
    float xtrilower; // f7
    float xtriupper; // f8
    float ytrilower; // f9
    float ytriupper; // f10
    ...
    float maxheight; // f13
    int vi; // r0
    const struct zGrassMeshVertex & v; // r5
    float height; // f0
    float width; // f13
    float radius; // f0
    struct xBox & box; // r25
...
// Range: 0x801017C8 -> 0x80101BC4
// this: r24
void zGrass::partition_meshes() {
    // Local variables
    struct knoll_type * knoll; // r6
    struct knoll_type * const end_knoll; // r7
    float xlower; // f1
    float xupper; // f30
    float ylower; // f2
    float yupper; // f3
    ...
    union grass_mesh_tri * const end_otri; // r29
    int i; // r28
    struct knoll_type & knoll; // r27
    struct zGrassMeshFace * itri; // r26
    struct zGrassMeshFace * end_itri; // r25
    int grid_index; // r0
    int tri_index; // r7
    int i; // r8
    int cache_index; // r8
    int knoll_index; // r5
    const struct zGrassMeshFace & itri; // r5
}
...
// Range: 0x80101BC4 -> 0x80102278
// this: r17
void zGrass::emit_clones(struct clone_node * & clones /* r18 */, struct clone_node * & last_clone /* r19 */, const union grass_mesh_tri & tri /* r20 */) {
    // Local variables
    struct knoll_type & knoll; // r8
    int emit; // r27
    unsigned char cache_index; // r26
    struct RpAtomic * atomic; // r25
    const struct xSphere & atomic_sphere; // r0
    struct xVec3 atomic_center; // r1+0x18
    float atomic_radius; // f30
    const struct zGrassMeshVertex & v0; // r24
    const struct zGrassMeshVertex & v1; // r23
    const struct zGrassMeshVertex & v2; // r22
    float rand_width_min; // f29
    float rand_width_scale; // f28
    float rand_height_min; // f27
    float rand_height_scale; // f26
    float width_min; // f25
    float height_min; // f24
    float animate; // f23
    float s; // r1+0x14
    float t; // r1+0x10
    float v; // f22
    float rand_height; // f4
    float height; // f21
    float rand_width; // f20
    float orient; // f19
    struct clone_node * clone; // r21
    float intensity; // f3
    struct xMat4x3 & mat; // r16
    struct xMat3x3 rot_mat; // r1+0xC0
    struct xMat3x3 norm_mat; // r1+0x90
    struct xMat3x3 rot_mat; // r1+0x60
    struct xMat3x3 norm_mat; // r1+0x30
}
...
// Range: 0x80102278 -> 0x8010233C
// this: r30
void zGrass::populate_cell(struct view_cell & vcell /* r31 */, int grid_index /* r0 */) {
    // Local variables
    struct grid_cell & gcell; // r5
    const union grass_mesh_tri * tri; // r29
    const union grass_mesh_tri * const end_tri; // r28
    struct clone_node * clones; // r1+0xC
    struct clone_node * last_clone; // r1+0x8
}

// Range: 0x8010233C -> 0x80102370
// this: r0
void zGrass::wipe_cell(struct view_cell & vcell /* r0 */) {}

// Range: 0x80102370 -> 0x80102670
// this: r15
void zGrass::displace_view_area(int new_xlower /* r16 */, int new_xupper /* r17 */, int new_zlower /* r18 */, int new_zupper /* r19 */) {
    // Local variables
    int old_xlower; // r30
    int old_xupper; // r29
    int old_zlower; // r28
    ...
    int iz; // r22
    int ix; // r21
    struct view_cell & vcell; // r3
    struct view_cell & vcell; // r0
    struct view_cell & icell; // r20
}
...
// Range: 0x8010269C -> 0x80102728
int zGrass::frustum_test_box(const struct xBox & box /* r0 */) {
    // Local variables
...
// Range: 0x80102728 -> 0x8010278C
unsigned char zGrass::cull_clones(struct clone_node * clones /* r4 */) {
    // Local variables
    int total; // r31
...
// Range: 0x8010278C -> 0x801028B4
// this: r30
void zGrass::fade_cell_alpha(struct view_cell & vcell /* r0 */) {
    // Local variables
    float dist_fade; // f0
    float dist_fade2; // f31
    float dist_cull; // f2
    float dist_cull2; // f30
    float tscale; // f29
    float xcenter; // f28
    float zcenter; // f27
...
// Range: 0x801028B4 -> 0x80102914
// this: r30
void zGrass::unfade_cell_alpha(struct view_cell & vcell /* r0 */) {
    // Local variables
    struct clone_node * clone; // r31
}

// Range: 0x80102914 -> 0x80102C28
// this: r19
void zGrass::process_view_area() {
    // Local variables
    struct view_cell (& vcells)[24][24]; // r29
    int originx; // r28
    int sizex; // r27
    int originz; // r26
    int sizez; // r25
...
// Range: 0x80102E4C -> 0x80102F34
// this: r24
void zGrass::render_clones(struct RpAtomic * atomic /* r25 */, struct clone_node * * output /* r26 */, int size /* r27 */) {
    // Local variables
...
void zGrass::render_view_area() {
    ...
    int sizex; // r28
    int sizez; // r27
    struct clone_node * * output_buffer; // r26
    int output_size[8]; // r1+0x8
    int i; // r6
    int viz; // r25
    int vix; // r24
    struct view_cell & vcell; // r3
    struct clone_node * clone; // r23
    int cache_index; // r0
    int & size; // r22
    struct clone_node * & output; // r0
    int i; // r18
}

// Range: 0x801030C0 -> 0x8010313C
// this: r31
void zGrass::create_white_light() {}

// Range: 0x8010313C -> 0x80103164
// this: r3
void zGrass::destroy_white_light() {}

// Range: 0x80103164 -> 0x80103244
// this: r26
...
// Range: 0x80103340 -> 0x801033DC
// this: r26
void zGrass::update_animation_waves(float dt /* f31 */) {
    // Local variables
    int i; // r27
}
