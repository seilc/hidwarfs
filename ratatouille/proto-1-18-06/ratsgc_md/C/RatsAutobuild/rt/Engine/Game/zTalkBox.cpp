/*
    ...
    Language: C++
    Code range: 0x800DDFA8 -> 0x800E0EAC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct shared_type shared; // size: 0x2A0, address: 0x80374890
static unsigned int zero; // size: 0x4, address: 0x803C2330
// Range: 0x800DDFA8 -> 0x800DE00C
static void speak_stop() {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DE00C -> 0x800DE084
...
static struct substr positive[6]; // size: 0x30, address: 0x803C67B0
static struct substr negative[6]; // size: 0x30, address: 0x803C67E0
// Range: 0x800DE0F8 -> 0x800DE1A4
...
static int v[32]; // size: 0x80, address: 0x80374B30
// Range: 0x800DE24C -> 0x800DE474
...
static void parse_tag_auto_wait(struct jot & j /* r0 */, const class xtextbox & ctb /* r0 */, const struct split_tag & ti /* r6 */) {
    ...
    struct tag_entry_list el; // r1+0x8
    const struct tag_entry & e; // r0
...
static unsigned int signals[20]; // size: 0x50, address: 0x802AF568
// Range: 0x800DE774 -> 0x800DE830
static unsigned char trigger_signal(const struct jot & j /* r26 */) {
    // Local variables
...
enum /* @enum$1191zTalkBox_cpp */ {
    ACTION_SET = 0,
    ACTION_PUSH = 1,
    ACTION_POP = 2,
};
enum /* @enum$1192zTalkBox_cpp */ {
    TYPE_INVALID = 0,
    TYPE_VOLUME = 1,
    TYPE_TARGET = 2,
    TYPE_ORIGIN = 3,
...
static void parse_tag_sound(struct jot & j /* r0 */, const class xtextbox & ctb /* r0 */, const struct split_tag & ti /* r6 */) {
    ...
    const struct tag_entry * e; // r0
    struct tag_entry_list el; // r1+0x44
...
// Range: 0x800DEBE4 -> 0x800DEE18
static unsigned char trigger_sound(const struct jot & j /* r0 */) {
    // Local variables
...
// Range: 0x800DEE18 -> 0x800DEE1C
static void parse_tag_pause() {}

// Range: 0x800DEE1C -> 0x800DEE20
static void reset_tag_pause() {}

// Range: 0x800DEE20 -> 0x800DEE28
static unsigned char trigger_pause() {}

// Range: 0x800DEE28 -> 0x800DEE8C
static void parse_tag_allow_quit(struct jot & j /* r30 */, const struct split_tag & ti /* r0 */) {
    // Local variables
    unsigned char & c; // r0
}

// Range: 0x800DEE8C -> 0x800DEEC8
static void reset_tag_allow_quit(struct jot & j /* r0 */, const class xtextbox & ctb /* r0 */) {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DEEC8 -> 0x800DEEE8
...
// Range: 0x800DEEE8 -> 0x800DF008
static void parse_tag_teleport(struct jot & j /* r31 */, const struct split_tag & ti /* r0 */) {
    // Local variables
    struct teleport_context & c; // r29
    unsigned int id; // r3
...
// Range: 0x800DF0DC -> 0x800DF144
static unsigned char trigger_teleport(const struct jot & j /* r0 */) {
    // Local variables
    const struct teleport_context & c; // r31
}

// Range: 0x800DF144 -> 0x800DF1A8
static void parse_tag_trap(struct jot & j /* r30 */, const struct split_tag & ti /* r0 */) {
    // Local variables
    unsigned char & c; // r0
}

// Range: 0x800DF1A8 -> 0x800DF1E4
static void reset_tag_trap(struct jot & j /* r0 */, const class xtextbox & ctb /* r0 */) {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DF1E4 -> 0x800DF1EC
static unsigned char trigger_trap() {}

// Range: 0x800DF1EC -> 0x800DF288
...
static struct tag_type new_tags[12]; // size: 0xF0, address: 0x802DB9E0
static unsigned long new_tags_size; // size: 0x4, address: 0x803BE2B8
static float music_fade; // size: 0x4, address: 0x803C2334
static float music_fade_delay; // size: 0x4, address: 0x803BE2BC
static unsigned char registered; // size: 0x1, address: 0x803C2338
static signed char init; // size: 0x1, address: 0x803C2339
// Range: 0x800DF5D0 -> 0x800DF69C
...
// Range: 0x800DF6F0 -> 0x800DF744
static void deactivate() {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DF744 -> 0x800DF7B4
static void activate(struct ztalkbox & e /* r31 */) {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DF7B4 -> 0x800DF7E0
...
// Range: 0x800DF954 -> 0x800DF9F4
static void stop_wait(struct ztalkbox & e /* r25 */, const float * args /* r26 */, unsigned long args_size /* r27 */) {
    // Local variables
...
// Range: 0x800DF9F4 -> 0x800DFB94
static void cb_dispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r6 */) {
    // Local variables
    struct ztalkbox & e; // r3

    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DFB94 -> 0x800DFBD4
...
enum /* @enum$754zTalkBox_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$755zTalkBox_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$756zTalkBox_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// Range: 0x800DFBD4 -> 0x800DFCC4
// this: r30
void ztalkbox::load(const struct asset_type & a /* r31 */) {}

// Range: 0x800DFCC4 -> 0x800DFD5C
// this: r31
void ztalkbox::reset() {
    // References
    // -> static struct shared_type shared;
...
// Range: 0x800DFD5C -> 0x800DFE1C
// this: r29
void ztalkbox::set_text(const char * s /* r0 */) {
    // Local variables
...
// Range: 0x800DFE1C -> 0x800DFE20
static void state_type::start() {}

// Range: 0x800DFE20 -> 0x800DFE24
static void state_type::stop() {}

// Range: 0x800DFE24 -> 0x800DFE7C
// this: r31
...
// Range: 0x800DFE7C -> 0x800DFED0
// this: r31
void ztalkbox::add_text(const char * s /* r0 */) {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800DFED0 -> 0x800DFF1C
// this: r31
...
// Range: 0x800DFF1C -> 0x800DFF40
// this: r0
void ztalkbox::clear_text() {}

// Range: 0x800DFF40 -> 0x800E0080
// this: r30
void ztalkbox::start_talk(const char * s /* r29 */, struct callback * cb /* r31 */, class zNPCBaseIN2 * npc /* r0 */) {
    // Local variables
    struct ztextbox & d; // r30
...
// Range: 0x800E011C -> 0x800E01C8
static void stop() {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800E01C8 -> 0x800E01EC
// this: r0
...
// Range: 0x800E0278 -> 0x800E02D0
// this: r31
void ztalkbox::hide() {}

// Range: 0x800E02D0 -> 0x800E034C
// this: r28
void ztalkbox::MasterTellSlaves(int isBeginning /* r29 */) {
    // Local variables
    int i; // r30
    const struct xLinkAsset * link; // r3
    struct xBase * mychild; // r4
}

// Range: 0x800E034C -> 0x800E03D8
// this: r27
void ztalkbox::MasterLoveSlave(const struct xBase * slave /* r4 */, int starting /* r28 */) {
    // Local variables
    struct xGroup * grp; // r30
    unsigned int cnt; // r0
    unsigned int i; // r29
    struct xBase * grpitem; // r4
}
...
// Range: 0x800E03D8 -> 0x800E0438
void ztalkbox::load_settings(struct xIniFile & ini /* r0 */) {
    // References
    // -> static struct shared_type shared;
}

static signed char init; // size: 0x1, address: 0x803C233A
// total size: 0x8
class start_state_type : public state_type {
    // Functions
    static start_state_type();
};
static class start_state_type start_state; // size: 0x8, address: 0x803C233C
static signed char init; // size: 0x1, address: 0x803C2344
// total size: 0xC
...
static class next_state_type next_state; // size: 0xC, address: 0x803C2348
static signed char init; // size: 0x1, address: 0x803C2354
// total size: 0xC
...
static class wait_state_type wait_state; // size: 0xC, address: 0x803C2358
static signed char init; // size: 0x1, address: 0x803C2364
// total size: 0x8
class stop_state_type : public state_type {
    // Functions
    static stop_state_type();
};
static class stop_state_type stop_state; // size: 0x8, address: 0x803C2368
// Range: 0x800E0438 -> 0x800E0518
void ztalkbox::init() {
    // References
...
struct {} @unnamed@zTalkBox_cpp@::stop_state_type::__vtable; // size: 0x14, address: 0x803BE310
// Range: 0x800E0518 -> 0x800E0554
// this: r31
...
static // total size: 0x14
struct {} @unnamed@zTalkBox_cpp@::state_type::__vtable; // size: 0x14, address: 0x803BE2FC
enum state_enum {
    STATE_INVALID = -1,
    BEGIN_STATE = 0,
    STATE_START = 1,
...
static // total size: 0x14
struct {} @unnamed@zTalkBox_cpp@::wait_state_type::__vtable; // size: 0x14, address: 0x803BE2E8
// Range: 0x800E0564 -> 0x800E05A0
// this: r31
...
static // total size: 0x14
struct {} @unnamed@zTalkBox_cpp@::next_state_type::__vtable; // size: 0x14, address: 0x803BE2D4
// Range: 0x800E05A0 -> 0x800E05DC
// this: r31
...
static // total size: 0x14
struct {} @unnamed@zTalkBox_cpp@::start_state_type::__vtable; // size: 0x14, address: 0x803BE2C0
// Range: 0x800E05DC -> 0x800E0618
// this: r31
...
// Range: 0x800E0618 -> 0x800E0638
void ztalkbox::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800E0638 -> 0x800E0724
...
// Range: 0x800E0A68 -> 0x800E0A9C
static unsigned char trigger_jot(int index /* r3 */) {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800E0A9C -> 0x800E0AE8
static unsigned char trigger_jot(const struct jot & j /* r0 */) {
    // Local variables
    unsigned char (* trigger)(struct jot &); // r12
}

// Range: 0x800E0AE8 -> 0x800E0AEC
static void next_state_type::stop() {}

// Range: 0x800E0AEC -> 0x800E0B10
static enum state_enum next_state_type::update() {
    // References
    // -> static struct shared_type shared;
}

// Range: 0x800E0B10 -> 0x800E0B38
// this: r0
static void wait_state_type::start() {}

// Range: 0x800E0B38 -> 0x800E0BC8
// this: r0
...
// Range: 0x800E0E38 -> 0x800E0E3C
static void stop_state_type::start() {}

// Range: 0x800E0E3C -> 0x800E0E40
static void stop_state_type::stop() {}

// Range: 0x800E0E40 -> 0x800E0E48
