/*
    ...
    Language: C++
    Code range: 0x800B5B04 -> 0x800B87DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800B5B04 -> 0x800B5B08
static void add_tweaks() {}

static unsigned int blend_modes[4][2]; // size: 0x20, address: 0x803C6250
// total size: 0xC
struct curve_node {
    // Members
...
static struct curve_node burn_ribbon_curve[7]; // size: 0x54, address: 0x802AD018
static struct curve_node fade_ribbon_curve[2]; // size: 0x18, address: 0x803C6270
// total size: 0x8
struct /* @class$1464zLaserBeam_cpp */ {
    // Members
...
struct /* @class$1464zLaserBeam_cpp */ {
    ...
    const struct curve_node * curve; // offset 0x0, size 0x4
    int size; // offset 0x4, size 0x4
} ribbon_curves[2]; // size: 0x10, address: 0x803BE110
static char * fade_value_labels[2]; // size: 0x8, address: 0x803BE120
// total size: 0xC
...
static struct fade_curve_node fade_in_curve_immediate[2]; // size: 0x18, address: 0x803C6288
static struct fade_curve_node fade_in_curve_linear[2]; // size: 0x18, address: 0x803C62A0
static struct fade_curve_node fade_in_curve_overshoot[3]; // size: 0x24, address: 0x803C62B8
static struct xResponseCurve fade_in_curve[3]; // size: 0x30, address: 0x803C1F40
// total size: 0x24
...
static struct RxObjSpace3DVertex * vert_buffer; // size: 0x4, address: 0x803C1F70
static struct RxObjSpace3DVertex * end_vert_buffer; // size: 0x4, address: 0x803C1F74
static int vert_indices_set; // size: 0x4, address: 0x803C1F78
static unsigned char brightening; // size: 0x1, address: 0x803C1F7C
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwRaster * current_raster; // size: 0x4, address: 0x803C1F80
// total size: 0x18
...
// Range: 0x800B5B08 -> 0x800B5BC4
static void flush_vert_buffer() {
    // Local variables
    int vert_size; // r4
    unsigned short * index_buffer; // r7
    int index_size; // r8
    unsigned short * index; // r6
    unsigned short * end_index; // r9
    int vi; // r10
...
// total size: 0x4
struct /* @class$803zLaserBeam_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$882zLaserBeam_cpp */ {
    // Members
    unsigned int texture; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$884zLaserBeam_cpp */ {
    // Members
...
// total size: 0x40
struct /* @class$886zLaserBeam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$892zLaserBeam_cpp */ {
    // Members
    float age; // offset 0x0, size 0x4
    float rate; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$893zLaserBeam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$895zLaserBeam_cpp */ {
    // Members
    float phase; // offset 0x0, size 0x4
};
// total size: 0x1
struct /* @class$896zLaserBeam_cpp */ {};
union /* @class$894zLaserBeam_cpp */ {
    // total size: 0x4
    struct /* @class$895zLaserBeam_cpp */ {
        // Members
        float phase; // offset 0x0, size 0x4
    ...
    // total size: 0x1
    struct /* @class$896zLaserBeam_cpp */ {} flicker; // offset 0x0, size 0x1
};
// total size: 0x3C
struct motion_data {
    // Members
...
// total size: 0xC
struct /* @class$693zLaserBeam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$694zLaserBeam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$695zLaserBeam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$696zLaserBeam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$697zLaserBeam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$698zLaserBeam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$699zLaserBeam_cpp */ {
    // Members
...
// Range: 0x800B5DAC -> 0x800B5DD0
void zLaserBeam::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800B5DD0 -> 0x800B5F00
...
// Range: 0x800B6748 -> 0x800B68E8
// this: r31
void zLaserBeam::reload_asset() {}

// Range: 0x800B68E8 -> 0x800B69D8
// this: r31
...
// Range: 0x800B69D8 -> 0x800B6A78
// this: r29
void zLaserBeam::load_attach_to(unsigned int id /* r30 */) {
    // Local variables
...
// Range: 0x800B6F94 -> 0x800B70DC
// this: r27
void zLaserBeam::apply_motion_direct(float start_subdist /* f31 */, float subdist /* f30 */, int motion_flags /* r28 */) {
    // Local variables
    unsigned long i; // r29
    float ddist; // f31
    unsigned long i; // r29
...
// Range: 0x800B70DC -> 0x800B7168
// this: r27
void zLaserBeam::apply_motion_movepoint(float start_subdist /* f1 */, float subdist /* f30 */, int motion_flags /* r28 */) {
    // Local variables
    float offset; // f31
    unsigned long i; // r29
}

// Range: 0x800B7168 -> 0x800B736C
// this: r31
...
// Range: 0x800B736C -> 0x800B73D8
// this: r31
void zLaserBeam::reset_color_anim() {}

// Range: 0x800B73D8 -> 0x800B744C
// this: r31
...
// Range: 0x800B7520 -> 0x800B75FC
// this: r3
void zLaserBeam::update_fade(float dt /* f0 */) {}

// Range: 0x800B75FC -> 0x800B769C
// this: r6
...
// total size: 0xC
struct /* @class$902zLaserBeam_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1400zLaserBeam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1367zLaserBeam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1368zLaserBeam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1369zLaserBeam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1366zLaserBeam_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1371zLaserBeam_cpp */ {
    // Members
...
// Range: 0x800B8590 -> 0x800B85F8
// this: r3
void zLaserBeam::dispatch(unsigned int event /* r0 */, const float * argf /* r0 */) {}

// Range: 0x800B85F8 -> 0x800B8624
void zLaserBeam::cb_dispatch(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r0 */, struct xBase * argw /* r0 */, unsigned int argwi /* r0 */) {}
