/*
    ...
    Language: C++
    Code range: 0x800CE6C8 -> 0x800CEBDC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sMemDepthJustHIPStartPlayer; // size: 0x4, address: 0x803BE218
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$812zPlayerBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$836zPlayerBase_cpp */ {
    // Members
...
union /* @class$643zPlayerBase_cpp */ {
...
// Range: 0x800CE6C8 -> 0x800CE790
void zPlayerUpdate(struct xEnt * ent /* r3 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x800CEA08 -> 0x800CEAC4
void zPlayer_StoreCheckPoint(const struct zPlayerCheckPoint * checkPoints /* r29 */, unsigned int initialCameraID /* r0 */) {
    // Local variables
    int i; // r30
...
// Range: 0x800CEAC4 -> 0x800CEB78
void zPlayerSceneInit(unsigned int sceneID /* r28 */) {
    // Local variables
    int i; // r29
