/*
    ...
    Language: C++
    Code range: 0x800AEFC8 -> 0x800B2EF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x803C6098
enum eFMVFile {
    eFMVFile_NoMovie = 0,
...
static unsigned int sPlayerMarkerStartID; // size: 0x4, address: 0x803C1B9C
static float sGameOverTimer; // size: 0x4, address: 0x803C1BA0
float sTimeElapsed; // size: 0x4, address: 0x803C1BA4
float gRealTimeElapsed; // size: 0x4, address: 0x803C1BA8
long long sTimeLast; // size: 0x8, address: 0x803C1BB0
long long sTimeCurrent; // size: 0x8, address: 0x803C1BB8
unsigned int gLevelChanged; // size: 0x4, address: 0x803C1BC0
unsigned char gExitAfterPause; // size: 0x1, address: 0x803C1BC4
static int g_hiphopReloadHIP; // size: 0x4, address: 0x803C1BC8
static int g_hiphopForcePortal; // size: 0x4, address: 0x803C1BCC
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
unsigned int gzAsyncSceneID; // size: 0x4, address: 0x803C1BD0
unsigned int gSoak; // size: 0x4, address: 0x803C1BD4
float s_dbloop_elapsec; // size: 0x4, address: 0x803C1BD8
static unsigned int s_dbloop_elaptick; // size: 0x4, address: 0x803C1BDC
static float s_dbloop_fps; // size: 0x4, address: 0x803C1BE0
static float s_curFPSCounterTime; // size: 0x4, address: 0x803C1BE4
static float s_curFPSFrames; // size: 0x4, address: 0x803C1BE8
static float s_curFPS; // size: 0x4, address: 0x803C1BEC
static char switchSceneDest[4]; // size: 0x4, address: 0x803C1BF0
static unsigned char switchScene; // size: 0x1, address: 0x803C1BF4
char * * soaklevels; // size: 0x4, address: 0x803C1BF8
static float SOAK_DELAY; // size: 0x4, address: 0x803BDE00
static float SOAK_DELAYRAND; // size: 0x4, address: 0x803BDE04
static float soaktime; // size: 0x4, address: 0x803BDE08
int enableMenuMasher; // size: 0x4, address: 0x803C1BFC
int enableAudioAnnihilator; // size: 0x4, address: 0x803C1C00
int enableSuperSoaker; // size: 0x4, address: 0x803C1C04
static int superSoak_simulatePlayerAction; // size: 0x4, address: 0x803BDE0C
static unsigned int superSoakExtraPadOnInput; // size: 0x4, address: 0x803C1C08
static unsigned int superSoakExtraPadPressInput; // size: 0x4, address: 0x803C1C0C
// total size: 0x2
...
static struct _tagPadAnalog savedAnalog1; // size: 0x2, address: 0x803C1C10
static struct _tagPadAnalog savedAnalog2; // size: 0x2, address: 0x803C1C14
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct xPortalAsset dummyPortalAsset; // size: 0x18, address: 0x803C1C18
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct _zPortal dummyPortal; // size: 0x14, address: 0x803C1C30
static unsigned int loadMeter; // size: 0x4, address: 0x803C1C44
static int soakidx; // size: 0x4, address: 0x803C1C48
static signed char init; // size: 0x1, address: 0x803C1C4C
static int soakcnt; // size: 0x4, address: 0x803C1C50
static signed char init; // size: 0x1, address: 0x803C1C54
enum en_SOAK_DIR {
    SOAK_FOR = 0,
    SOAK_BACK = 1,
    SOAK_RAND = 2,
...
static enum en_SOAK_DIR soakdir; // size: 0x4, address: 0x803C1C58
static signed char init; // size: 0x1, address: 0x803C1C5C
static int justwrap; // size: 0x4, address: 0x803C1C60
static signed char init; // size: 0x1, address: 0x803C1C64
static unsigned int sumtotal; // size: 0x4, address: 0x803C1C68
static signed char init; // size: 0x1, address: 0x803C1C6C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
unsigned int loadSceneID; // size: 0x4, address: 0x803C30E0
// total size: 0x4
class Screen {
    // Members
public:
...
// total size: 0x4
struct /* @class$1267zGame_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1268zGame_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$739zGame_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$740zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$741zGame_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$742zGame_cpp */ {
    // Members
...
struct _zEnv * gCurEnv; // size: 0x4, address: 0x803C21F4
// Range: 0x800AF560 -> 0x800AF754
void zGameSetup() {
    // Local variables
...
static long long t0; // size: 0x8, address: 0x803C1C70
static long long t1; // size: 0x8, address: 0x803C1C78
static long long w0; // size: 0x8, address: 0x803C1C80
static long long w1; // size: 0x8, address: 0x803C1C88
static long long gloop_time; // size: 0x8, address: 0x803C1C90
static long long gwait_time; // size: 0x8, address: 0x803C1C98
static int gloop_ct; // size: 0x4, address: 0x803C1CA0
static float gloop_time_secs; // size: 0x4, address: 0x803C1CA4
static float gwait_time_secs; // size: 0x4, address: 0x803C1CA8
static float gloop_net_time_secs; // size: 0x4, address: 0x803C1CAC
// Range: 0x800AF754 -> 0x800AF7A0
void zGamePreRender() {
    // References
    // -> struct zGlobals globals;
}

static unsigned char initSavedInput; // size: 0x1, address: 0x803C1CB0
static signed char init; // size: 0x1, address: 0x803C1CB1
static float sAttractMode_timer; // size: 0x4, address: 0x803C1CB4
static signed char init; // size: 0x1, address: 0x803C1CB8
static int displayToggle; // size: 0x4, address: 0x803C1CBC
static signed char init; // size: 0x1, address: 0x803C1CC0
// total size: 0x30
class xfont {
    // Members
public:
...
static class xfont debugStr; // size: 0x30, address: 0x803BDE10
static signed char init; // size: 0x1, address: 0x803C1CC1
// total size: 0x14
struct tag_entry {
    // Members
    struct substr name; // offset 0x0, size 0x8
...
static class xtextbox tb; // size: 0x74, address: 0x802D9C50
static signed char init; // size: 0x1, address: 0x803C1CC2
static struct _zPortal portal; // size: 0x14, address: 0x803C1CC4
static struct xPortalAsset portalAsset; // size: 0x18, address: 0x803C1CD8
float VBLANKS_PER_SEC; // size: 0x4, address: 0x803BE158
unsigned int gSceneFrameCount; // size: 0x4, address: 0x803C0D20
int gWasDiskError; // size: 0x4, address: 0x803C18D4
...
enum eGameMode gGameMode; // size: 0x4, address: 0x803C1E30
struct xColor_tag g_BLACK; // size: 0x4, address: 0x803C4840
struct xColor_tag g_WHITE; // size: 0x4, address: 0x803C4844
unsigned int gFrameCount; // size: 0x4, address: 0x803C0D1C
// Range: 0x800AF7A0 -> 0x800B0890
void zGameLoop() {
    // Local variables
    int ostrich_delay; // r31
    int startidx; // r1+0x1C
    int port; // r0
    int i; // r16
    unsigned char padActive; // r0
    int i; // r16
    unsigned char initBailTimer; // r18
    int i; // r19
    int i; // r1+0x18
    int isPaused; // r0
    int i; // r17
    int i; // r16
    char tmpStr[384]; // r1+0x1FC
    struct _tagxPad * pad; // r16
    int port; // r1+0x14
    char * nextToken; // r1+0x10
    const char * foo; // r17
    float y; // f24
    char str[8]; // r1+0x20
    char tmpstr[256]; // r1+0xFC
    int j; // r16
...
// Range: 0x800B0890 -> 0x800B0900
int zGameIsPaused() {
    // References
    // -> enum eGameMode gGameMode;
}

int gGameState; // size: 0x4, address: 0x803BE020
// Range: 0x800B0900 -> 0x800B09A4
...
// Range: 0x800B09A4 -> 0x800B0A04
enum pause_ability zGameOkToPause() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x800B0A04 -> 0x800B0A60
void zGamePause() {
    // References
    // -> enum eGameMode gGameMode;
}

// Range: 0x800B0A60 -> 0x800B0A64
void zGameStall() {}
...
struct RwCamera * sGameScreenTransCam; // size: 0x4, address: 0x803C1CF0
static struct RpWorld * gWorld; // size: 0x4, address: 0x803C1CF4
static struct RpLight * DirectionalLight; // size: 0x4, address: 0x803C1CF8
// Range: 0x800B0E7C -> 0x800B0E80
...
// Range: 0x800B0F58 -> 0x800B0FBC
void zGameScreenTransitionUpdate(float percentComplete /* f31 */, char * msg /* r31 */) {
    // References
    // -> struct zGlobals globals;
}

unsigned int bgID; // size: 0x4, address: 0x803BDE40
float bgu1; // size: 0x4, address: 0x803C1CFC
float bgv1; // size: 0x4, address: 0x803C1D00
float bgu2; // size: 0x4, address: 0x803BDE44
float bgv2; // size: 0x4, address: 0x803BDE48
unsigned char bgr; // size: 0x1, address: 0x803BDE4C
unsigned char bgg; // size: 0x1, address: 0x803BDE4D
unsigned char bgb; // size: 0x1, address: 0x803BDE4E
unsigned char bga; // size: 0x1, address: 0x803BDE4F
// total size: 0x4
struct RwRGBA {
    // Members
...
static float lastTime; // size: 0x4, address: 0x803C1D04
static signed char init; // size: 0x1, address: 0x803C1D08
static float presentTime; // size: 0x4, address: 0x803C1D0C
static signed char init; // size: 0x1, address: 0x803C1D10
static const char * TXT_DEMO; // size: 0x4, address: 0x803C1D14
static signed char init; // size: 0x1, address: 0x803C1D18
static class xtextbox tb; // size: 0x74, address: 0x802D9CC4
static signed char init; // size: 0x1, address: 0x803C1D19
// Range: 0x800B1620 -> 0x800B1908
void zGameDemoText(float fTime /* f31 */) {
    // Local variables
...
static int cnt_nextPickupMove; // size: 0x4, address: 0x803C1D1C
static signed char init; // size: 0x1, address: 0x803C1D20
static int cnt_nextMove; // size: 0x4, address: 0x803C1D24
static signed char init; // size: 0x1, address: 0x803C1D28
static int cnt_nextKillNPC; // size: 0x4, address: 0x803C1D2C
static signed char init; // size: 0x1, address: 0x803C1D30
static int cnt_nextKillPlayer; // size: 0x4, address: 0x803C1D34
static signed char init; // size: 0x1, address: 0x803C1D38
static int cnt_nextOOBTest; // size: 0x4, address: 0x803C1D3C
static signed char init; // size: 0x1, address: 0x803C1D40
static int cnt_nextPlayerAction; // size: 0x4, address: 0x803C1D44
static signed char init; // size: 0x1, address: 0x803C1D48
static int cnt_nextPlayerSwitch; // size: 0x4, address: 0x803C1D4C
static signed char init; // size: 0x1, address: 0x803C1D50
static int cnt_nextRunScript; // size: 0x4, address: 0x803C1D54
static signed char init; // size: 0x1, address: 0x803C1D58
static int cnt_nextMoveAnalogSticks; // size: 0x4, address: 0x803C1D5C
static signed char init; // size: 0x1, address: 0x803C1D60
static int cnt_nextInAHurry; // size: 0x4, address: 0x803C1D64
static signed char init; // size: 0x1, address: 0x803C1D68
static int workOn; // size: 0x4, address: 0x803C1D6C
static signed char init; // size: 0x1, address: 0x803C1D70
static int onElsePress; // size: 0x4, address: 0x803C1D74
static signed char init; // size: 0x1, address: 0x803C1D78
static int idx_action; // size: 0x4, address: 0x803C1D7C
static signed char init; // size: 0x1, address: 0x803C1D80
// total size: 0x14
...
// Range: 0x800B1908 -> 0x800B1E98
static void MoveThePlayerAround() {
    // Local variables
    struct zScene & s; // r3
    struct _zScript * scriptlist; // r30
    int idx_count; // r31
    int idx_torun; // r0
    struct _zScript * script; // r30
    int randomActionTable[16]; // r1+0x8
    int action; // r31
    int numSimulKeyPresses; // r29
    int i; // r28
...
static int nextButtonPress; // size: 0x4, address: 0x803C1D84
static signed char init; // size: 0x1, address: 0x803C1D88
// Range: 0x800B1E98 -> 0x800B1F88
...
static int cnt_nextKeyPress; // size: 0x4, address: 0x803C1D8C
static signed char init; // size: 0x1, address: 0x803C1D90
static int cnt_nextAnalogMovement; // size: 0x4, address: 0x803C1D94
static signed char init; // size: 0x1, address: 0x803C1D98
static float weightTable[18]; // size: 0x48, address: 0x802D9D38
static int needNormalize; // size: 0x4, address: 0x803C1D9C
static signed char init; // size: 0x1, address: 0x803C1DA0
static long long tym_last; // size: 0x8, address: 0x803C1DA8
static signed char init; // size: 0x1, address: 0x803C1DB0
static int enableLogging; // size: 0x4, address: 0x803C1DB4
static signed char init; // size: 0x1, address: 0x803C1DB8
// Range: 0x800B1F88 -> 0x800B2248
static void DoTheMenuMasher() {
    // Local variables
    int actionTable[18]; // r1+0x8
    int action; // r0
    float sum; // f1
    int i; // r0
    int i; // r0
...
static int numLooped; // size: 0x4, address: 0x803C1DBC
static signed char init; // size: 0x1, address: 0x803C1DC0
// total size: 0xC
struct loopedSound {
    // Members
...
static struct loopedSound looped[256]; // size: 0xC00, address: 0x8035D6E0
static float num_nextPlayFixed; // size: 0x4, address: 0x803C1DC4
static signed char init; // size: 0x1, address: 0x803C1DC8
static float num_nextPlayRand; // size: 0x4, address: 0x803C1DCC
static signed char init; // size: 0x1, address: 0x803C1DD0
static int num_nextEcho; // size: 0x4, address: 0x803C1DD4
static signed char init; // size: 0x1, address: 0x803C1DD8
static int cnt_nextPlay; // size: 0x4, address: 0x803C1DDC
static signed char init; // size: 0x1, address: 0x803C1DE0
static int cnt_nextEcho; // size: 0x4, address: 0x803C1DE4
static signed char init; // size: 0x1, address: 0x803C1DE8
static int echo_on; // size: 0x4, address: 0x803C1DEC
static signed char init; // size: 0x1, address: 0x803C1DF0
static float remainingTime; // size: 0x4, address: 0x803C1DF4
static signed char init; // size: 0x1, address: 0x803C1DF8
static struct xVec3 pos_sound; // size: 0xC, address: 0x803BDE50
static signed char init; // size: 0x1, address: 0x803C1DF9
static struct xVec3 vel_sound; // size: 0xC, address: 0x803BDE5C
static signed char init; // size: 0x1, address: 0x803C1DFA
static float cycle; // size: 0x4, address: 0x803C1DFC
static signed char init; // size: 0x1, address: 0x803C1E00
static struct xVec3 pos_plyrLast; // size: 0xC, address: 0x803BDE68
static signed char init; // size: 0x1, address: 0x803C1E01
...
// Range: 0x800B2248 -> 0x800B27F8
static void DoTheAudioAnnihilator(float dt /* f23 */) {
    // Local variables
    int i; // r31
    ...
    void * asset; // r3
    enum iSndGroupHandle groupHandle; // r29
    float ang; // f30
    float cv; // f0
    float sv; // f0
    float rad_orbit; // f23
...
struct xSndGlobals gSnd; // size: 0x7110, address: 0x8032C9E0
float speedOfSound; // size: 0x4, address: 0x803C5558
enum xSndListener {
    xSndListener_CAMERA = 0,
    xSndListener_PLAYER = 1,
    xSndListener_MAX_TYPES = 2,
};
static int PrevHumanPlayerNumber; // size: 0x4, address: 0x803C1E04
static signed char init; // size: 0x1, address: 0x803C1E08
// Range: 0x800B2B5C -> 0x800B2EF8
...
// total size: 0x18
struct {} zAsync::Screen::__vtable; // size: 0x18, address: 0x803BDE74
