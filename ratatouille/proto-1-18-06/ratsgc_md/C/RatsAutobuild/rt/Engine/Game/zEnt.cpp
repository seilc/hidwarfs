/*
    ...
    Language: C++
    Code range: 0x8009D18C -> 0x8009EC54
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int checkpoint_collision_hack(zEnt*)::model_id; // size: 0x4, address: 0x803C1A80
signed char checkpoint_collision_hack(zEnt*)::localstatic4 guard; // size: 0x1, address: 0x803C1A84
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8009D6B0 -> 0x8009D6E4
void zEntSetup(struct zEnt * ent /* r31 */) {}

// Range: 0x8009D6E4 -> 0x8009D83C
...
// Range: 0x8009D83C -> 0x8009D85C
void zEntSave(struct zEnt * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8009D85C -> 0x8009D87C
void zEntLoad(struct zEnt * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8009D87C -> 0x8009D994
...
// Range: 0x8009D994 -> 0x8009D9B4
void zEntUpdate(struct zEnt * ent /* r0 */, struct zScene * scene /* r0 */, float elapsedSec /* f0 */) {}

// Range: 0x8009D9B4 -> 0x8009DA50
void zEntEventAll(struct xBase * from /* r26 */, unsigned int fromEvent /* r27 */, unsigned int toEvent /* r28 */, float * toParam /* r29 */) {
    // Local variables
    struct zScene * s; // r31
...
// Range: 0x8009DB2C -> 0x8009DD20
struct xModelInstance * zEntRecurseModelInfo(void * info /* r26 */, struct xEnt * ent /* r27 */) {
    // Local variables
    unsigned int i; // r30
    ...
    struct xModelAssetInst * zinst; // r28
...
// Range: 0x8009DD98 -> 0x8009DE14
static void zEntTransitionToState(struct xAnimPlay * play /* r30 */, struct xAnimState * state /* r31 */) {
    // Local variables
    struct xAnimTransition * trans; // r4
}

// Range: 0x8009DE14 -> 0x8009E0DC
void zEntAnimEventCore(struct xModelInstance * model /* r0 */, struct xAnimTable * atbl /* r29 */, unsigned int animEvent /* r0 */, const float * animParam /* r28 */) {
    // Local variables
...
// Range: 0x8009E0DC -> 0x8009E124
void zEntAnimEvent(struct zEnt * ent /* r7 */, unsigned int animEvent /* r4 */, const float * animParam /* r6 */) {}

unsigned int g_hash_xentanim[5]; // size: 0x14, address: 0x803BDD70
// Range: 0x8009E124 -> 0x8009E3C4
void zEntAnimEvent_AutoAnim(struct zEnt * ent /* r26 */, unsigned int animEvent /* r27 */, const float * animParam /* r28 */) {
    // Local variables
    struct xAnimPlay * play; // r31
    struct xAnimSingle * single; // r30
    int anum; // r29
