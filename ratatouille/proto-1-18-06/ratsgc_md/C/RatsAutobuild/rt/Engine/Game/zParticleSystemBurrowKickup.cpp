/*
    ...
    Language: C++
    Code range: 0x80152B44 -> 0x80153568
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x20
struct {} zParticleGeneratorBurrowKickup::__vtable; // size: 0x20, address: 0x803BEE28
// total size: 0x34
struct {} zParticleSystemBurrowKickup::__vtable; // size: 0x34, address: 0x803BEE48
// total size: 0x8
