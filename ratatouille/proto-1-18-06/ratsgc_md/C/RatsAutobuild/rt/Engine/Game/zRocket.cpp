/*
    ...
    Language: C++
    Code range: 0x8010CC60 -> 0x8010D248
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int system_id; // size: 0x4, address: 0x803BE620
static unsigned char need_setup; // size: 0x1, address: 0x803BE624
// total size: 0x1
class smoke_trail {
    // Static members
