/*
    ...
    Language: C++
    Code range: 0x800CF72C -> 0x800D36B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int saveSuccess; // size: 0x4, address: 0x803C2198
static float saveload_time_elapsed; // size: 0x4, address: 0x803BE228
static float saveload_time_last; // size: 0x4, address: 0x803C219C
static float saveload_time_current; // size: 0x4, address: 0x803C21A0
static int currentCard; // size: 0x4, address: 0x803BE22C
static int currentGame; // size: 0x4, address: 0x803BE230
static int saveLoadPromptSel; // size: 0x4, address: 0x803C21A4
static int badCard; // size: 0x4, address: 0x803C21A8
static unsigned int startSceneID; // size: 0x4, address: 0x803C21AC
static int sAvailable; // size: 0x4, address: 0x803C21B0
static int sNeeded; // size: 0x4, address: 0x803C21B4
static int sAccessType; // size: 0x4, address: 0x803C21B8
static float dontPoll; // size: 0x4, address: 0x803BE234
int autoSaveCard; // size: 0x4, address: 0x803BE238
int prevSelectCard; // size: 0x4, address: 0x803BE23C
int prevSelectGame; // size: 0x4, address: 0x803BE240
static unsigned char sIsLoading; // size: 0x1, address: 0x803BE244
static int loadState; // size: 0x4, address: 0x803C21BC
static int saveState; // size: 0x4, address: 0x803C21C0
static char currSceneStr[32]; // size: 0x20, address: 0x803BE248
static char sceneRead[32]; // size: 0x20, address: 0x803BE268
int g_promptUserSelection; // size: 0x4, address: 0x803BE288
// total size: 0xC
struct zSaveLoadUI {
    // Members
...
struct zSaveLoadUI zSaveLoadUITable[73]; // size: 0x36C, address: 0x802DA408
// total size: 0x6C
...
struct zSaveLoadGame zSaveLoadGameTable[3]; // size: 0x144, address: 0x8036A8B0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
class zUICustomSaveLoadManager * pUICustomSaveLoadManager; // size: 0x4, address: 0x803C35C8
// Range: 0x800CF7BC -> 0x800CF874
...
// total size: 0x1
struct /* @class$755zSaveLoad_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$756zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$757zSaveLoad_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$758zSaveLoad_cpp */ {
    // Members
...
// Range: 0x800CFCE4 -> 0x800CFD28
void zSaveLoadGameTableInit(struct zSaveLoadGame * table /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x800CFD28 -> 0x800CFD78
void zSaveLoadUITableInit(struct zSaveLoadUI * table /* r28 */) {
    // Local variables
    int i; // r29
}

// Range: 0x800CFD78 -> 0x800CFDC0
void zSaveLoad_UIEvent(int ui /* r0 */, unsigned int event /* r31 */) {
    // Local variables
...
// Range: 0x800D07B8 -> 0x800D0874
int zSaveLoad_CardCheckSpaceSingle_doCheck(struct st_XSAVEGAME_DATA * xsgdata /* r30 */, int num /* r31 */) {
    // Local variables
    int rc; // r0
...
// Range: 0x800D0BE0 -> 0x800D0C48
int zSaveLoad_CardCheckSlotOverwrite_Free(int num /* r0 */, int game /* r0 */) {
    // Local variables
    int result; // r0
}

// Range: 0x800D0C48 -> 0x800D0D40
int zSaveLoad_CardCheck(int cardNumber /* r28 */, int mode /* r29 */) {
    // Local variables
    int result; // r31
    int cardResult; // r30
...
// Range: 0x800D0DF4 -> 0x800D0E24
int zSaveLoad_CardCheckValid(int cardNumber /* r0 */, int mode /* r0 */) {}

// Range: 0x800D0E24 -> 0x800D0EC8
int zSaveLoad_CardCheckSpace(int cardNumber /* r30 */, int mode /* r31 */) {
    // Local variables
    int result; // r3
    int tmp; // r3
...
// Range: 0x800D0EC8 -> 0x800D0F6C
int zSaveLoad_CardCheckGames(int cardNumber /* r30 */, int mode /* r31 */) {
    // Local variables
    int result; // r3
    int tmp; // r3
...
// Range: 0x800D0F6C -> 0x800D0F9C
int zSaveLoad_CardCheckGameSlot(int cardNumber /* r0 */, int gameNumber /* r0 */, int mode /* r0 */) {}

// Range: 0x800D0F9C -> 0x800D1028
int zSaveLoad_CardCheckSlotEmpty(int cardNumber /* r29 */, int gameNumber /* r30 */, int mode /* r31 */) {
    // Local variables
    int result; // r3
}

// Range: 0x800D1028 -> 0x800D109C
int zSaveLoad_CardCheckSlotOverwrite(int cardNumber /* r0 */, int gameNumber /* r0 */) {
    // Local variables
    int result; // r3
}

unsigned char gSysMessageManager_active; // size: 0x1, address: 0x803C2E21
// Range: 0x800D109C -> 0x800D148C
int zSaveLoad_CardPick(int mode /* r29 */) {
    // Local variables
    int done; // r31
    unsigned char formatDone; // r30
    class zUI * mc1; // r0
    class zUI * mc2; // r0
...
// Range: 0x800D148C -> 0x800D1500
static unsigned char IsValidName(char * name /* r31 */) {}

// Range: 0x800D1500 -> 0x800D1740
...
// Range: 0x800D1740 -> 0x800D1840
void zSaveLoad_BuildName(char * name_txt /* r23 */, unsigned long max_len /* r24 */, int idx /* r25 */) {
    // Local variables
...
unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x803C2080
// Range: 0x800D1840 -> 0x800D1DE8
int zSaveLoad_GameSelect(int mode /* r31 */, unsigned char waitInput /* r24 */) {
    // Local variables
    int done; // r27
    class zUIText * uiTxtSavedGame1; // r22
    class zUIText * uiTxtSavedGame2; // r23
    class zUIText * uiTxtSavedGame3; // r22
    struct st_XSAVEGAME_DATA * svinst; // r26
    int use_tgt; // r25
    int i; // r24
...
static unsigned char preAutoSaving; // size: 0x1, address: 0x803C21C4
// Range: 0x800D1DE8 -> 0x800D1DF0
unsigned char zSaveLoadGetPreAutoSave() {
    // References
    // -> static unsigned char preAutoSaving;
}

unsigned char autosaveErrorHack; // size: 0x1, address: 0x803C21C5
// Range: 0x800D1DF0 -> 0x800D1E40
...
int zSaveLoad_LoadGame() {
    ...
    struct st_XSAVEGAME_DATA * ldinst; // r26
    int use_tgt; // r31
    enum en_XSG_WHYFAIL whyFail; // r1+0x8
    struct XSGAutoData * asg; // r27
    int use_game; // r28
    int physicalSlot; // r6
...
unsigned int zSaveLoad_SaveLoop() {
    ...
    int tmp; // r0
    int oldGame; // r30
    class zUIText * uiTxtSavedGame1; // r28
    class zUIText * uiTxtSavedGame2; // r29
    class zUIText * uiTxtSavedGame3; // r28
    struct xBase * sendTo; // r0
    struct XSGAutoData * autodata; // r0
...
// Range: 0x800D3300 -> 0x800D331C
int xSGT_SaveInfoPrefsCB(int * need /* r0 */, int * most /* r0 */) {}

// Range: 0x800D331C -> 0x800D3414
...
// Range: 0x800D3414 -> 0x800D34C4
int xSGT_LoadLoadCB(struct st_XSAVEGAME_DATA * xsgdata /* r29 */, struct st_XSAVEGAME_READCONTEXT * rctxt /* r31 */) {
    // Local variables
