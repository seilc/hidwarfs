/*
    ...
    Language: C++
    Code range: 0x8014ACB0 -> 0x8014AFF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$785zNPCDodgeList_cpp */ {
    // Members
...
union /* @class$805zNPCDodgeList_cpp */ {
...
// total size: 0xC
struct /* @class$804zNPCDodgeList_cpp */ {
    // Members
...
static struct zNPCDodgeListObject * sNPCDodgeListObjects; // size: 0x4, address: 0x803C2F38
static struct xVec3 * sNPCDodgeListObjectsVelocity; // size: 0x4, address: 0x803C2F3C
static struct xVec3 * sNPCDodgeListObjectsVelocityNormalized; // size: 0x4, address: 0x803C2F40
static struct xVec3 * sNPCDodgeListObjectsLocation; // size: 0x4, address: 0x803C2F44
static float sSinAngle; // size: 0x4, address: 0x803C2F48
static float sCos2Angle; // size: 0x4, address: 0x803C2F4C
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x8014AD44 -> 0x8014ADD4
...
// Range: 0x8014AE08 -> 0x8014AFD8
unsigned int zNPCDodgeListGetDodgeDirection(struct xEnt * ent /* r29 */, struct xVec3 & poi /* r30 */) {
    // Local variables
    int iter; // r31
