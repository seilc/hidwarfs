/*
    ...
    Language: C++
    Code range: 0x800EEC04 -> 0x800EEF84
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwCamera * cam; // size: 0x4, address: 0x803C2738
// total size: 0x8
struct RwLinkList {
    // Members
...
struct RpLight * light; // size: 0x4, address: 0x803C273C
// total size: 0xA4
struct RwFrame {
    // Members
    struct RwObject object; // offset 0x0, size 0x8
...
struct RwFrame * frame; // size: 0x4, address: 0x803C2740
...
struct RpWorld * world; // size: 0x4, address: 0x803C2744
// total size: 0x4
class Screen {
    // Members
public:
...
class Screen * screen; // size: 0x4, address: 0x803C2748
// Range: 0x800EEC04 -> 0x800EEC0C
...
static float rot; // size: 0x4, address: 0x803C274C
static signed char init; // size: 0x1, address: 0x803C2750
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
