/*
    ...
    Language: C++
    Code range: 0x800DDF9C -> 0x800DDFA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct symbol_map * map; // size: 0x4, address: 0x803C2328
// total size: 0x1
class symbol {
    // Static members
    static struct symbol_map * map; // size: 0x4
};
// Range: 0x800DDF9C -> 0x800DDFA8
void symbol::init() {
    // References
