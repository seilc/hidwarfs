/*
    ...
    Language: C++
    Code range: 0x80180CA4 -> 0x80181268
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct NCINMap * g_cutmap[64]; // size: 0x100, address: 0x802E03D8
// total size: 0x14
...
// Range: 0x80180CA4 -> 0x80180D20
// this: r0
void NCINBeNosey::CanRenderNow() {
    // Local variables
    const struct zCutsceneMgr * csnmgr; // r31
    struct NCINEntry * fxtab; // r0
    struct NCINEntry * nextrec; // r30
    struct NCINEntry * fxrec; // r4
}

// Range: 0x80180D20 -> 0x80180DD0
// this: r0
void NCINBeNosey::UpdatedAnimated(struct RpAtomic * model /* r25 */, struct RwMatrixTag * animMat /* r26 */, unsigned int animIndex /* r27 */, unsigned int dataIndex /* r28 */, unsigned int & visFlags /* r29 */) {
    // Local variables
    const struct zCutsceneMgr * csnmgr; // r31
    struct NCINEntry * fxtab; // r0
    struct NCINEntry * nextrec; // r30
...
static struct NCINBeNosey * g_noz_ncin; // size: 0x4, address: 0x803C3500
static signed char init; // size: 0x1, address: 0x803C3504
static struct NCINBeNosey nozey_npc_cinematics; // size: 0x14, address: 0x803C3508
// Range: 0x80180DD0 -> 0x80180E14
void zCineFXStartup() {
    // References
...
// Range: 0x80180E58 -> 0x80180E5C
void zCineFXShutdown() {}

// Range: 0x80180E5C -> 0x80180E60
void zCineFXSceneSetup() {}

// Range: 0x80180E60 -> 0x80180EE0
...
// Range: 0x80180EE0 -> 0x80180F30
static struct NCINEntry * zCineFXCutscenePickTable(const struct zCutsceneMgr * csnmgr /* r0 */) {
    // Local variables
    struct NCINEntry * da_fxtab; // r3
    int i; // r0
    struct NCINMap * cutrec; // r9

    // References
    // -> static struct NCINMap * g_cutmap[64];
}

// Range: 0x80180F30 -> 0x80180FD8
int zCineFXCutscenePrep(const struct zCutsceneMgr * csnmgr /* r29 */) {
    // Local variables
    struct NCINEntry * fxtab; // r30
    struct NCINEntry * nextrec; // r29
    struct NCINEntry * fxrec; // r0

    // References
    // -> static struct NCINBeNosey * g_noz_ncin;
}

// Range: 0x80180FD8 -> 0x80180FE8
// this: r0
...
// Range: 0x80180FE8 -> 0x80181090
void zCineFXCutsceneDone(const struct zCutsceneMgr * csnmgr /* r29 */) {
    // Local variables
...
// Range: 0x80181090 -> 0x801810A4
// this: r0
void NCINBeNosey::Done() {}

// Range: 0x801810A4 -> 0x80181244
...
// Range: 0x80181244 -> 0x80181268
static void AddTables() {}

// total size: 0x10
struct {} XCSNNosey::__vtable; // size: 0x10, address: 0x803BF380
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x10
struct {} NCINBeNosey::__vtable; // size: 0x10, address: 0x803BF390
