/*
    ...
    Language: C++
    Code range: 0x80165AAC -> 0x80167104
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80165C70 -> 0x80165C90
// this: r0
struct xVec3 & zTargetBlender::operator const xVec3&() const {}

// Range: 0x80165C90 -> 0x80165C98
// this: r3
struct xVec3 & zTargetBlender::Result() const {}

// Range: 0x80165C98 -> 0x80165CB0
void zTargetBlender::blend(float & o /* r0 */, float a /* f0 */, float b /* f0 */, float s /* f0 */) {}

// Range: 0x80165CB0 -> 0x80165CB8
// this: r0
float zTargetBlender::BlendTime() {}

static unsigned int input_disabled; // size: 0x4, address: 0x803C3188
static unsigned char have_default_orientation; // size: 0x1, address: 0x803C318C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 default_orientation; // size: 0xC, address: 0x803BEF58
static struct zCamPlayer * follow_cam; // size: 0x4, address: 0x803C3190
// total size: 0x18
struct analog_data {
    // Members
...
static struct xCamGroup global_cam; // size: 0xE0, address: 0x8038FC50
...
static struct xCamScreen global_screen; // size: 0x8, address: 0x803C3194
static class zTargetBlender blendedLookat; // size: 0x48, address: 0x8038FD30
static class zTargetBlender blendedMidPoint; // size: 0x48, address: 0x8038FD78
static class zTargetBlender blendedFloorMount; // size: 0x48, address: 0x8038FDC0
static unsigned char sYTrackingBelowFloorEnabled; // size: 0x1, address: 0x803C319C
static unsigned char firstFrame; // size: 0x1, address: 0x803BEF64
static struct xVec3 lastCameraLookAt; // size: 0xC, address: 0x803C31A0
// total size: 0x10
...
// Range: 0x80165DC8 -> 0x80165DCC
static void init_debug_cam() {}

// Range: 0x80165E04 -> 0x80165E68
void zCamSceneExit() {
    // References
...
// Range: 0x80166214 -> 0x80166234
static void zCamRestartDefaultCamera() {}

// Range: 0x80166234 -> 0x80166264
void zCamSceneSetup() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166264 -> 0x801663F4
