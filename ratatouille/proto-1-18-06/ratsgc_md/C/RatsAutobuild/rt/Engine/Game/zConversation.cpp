/*
    ...
    Language: C++
    Code range: 0x801523D4 -> 0x80152AE0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zConversationManager : public zLightweightSystemBase {
    ...
    static unsigned char Play(enum iSndGroupHandle groupHandle, const struct xBase * otherSpeakerBase);
...
// total size: 0x4
struct /* @class$866zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$884zConversation_cpp */ {
    // Members
...
union /* @class$885zConversation_cpp */ {
...
// total size: 0xC
struct /* @class$772zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$773zConversation_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$774zConversation_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$775zConversation_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$776zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$777zConversation_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$778zConversation_cpp */ {
    // Members
...
// Range: 0x801525EC -> 0x801526B4
// this: r29
static unsigned char zConversationManager::Play(enum iSndGroupHandle groupHandle /* r4 */, const struct xBase * otherSpeakerBase /* r30 */) {
    // Local variables
    unsigned int soundID; // r0
...
// Range: 0x801527AC -> 0x80152908
// this: r31
static void zConversationManager::Update(float dt /* f31 */) {}

// Range: 0x80152908 -> 0x80152934
// this: r0
...
// Range: 0x80152934 -> 0x80152938
static void zConversationManager::Exit() {}

// Range: 0x80152938 -> 0x8015295C
...
// Range: 0x8015295C -> 0x80152984
float zConversationGetJaw(enum xJawSpeaker speaker /* r4 */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x80152984 -> 0x801529A8
unsigned char zConversationIsConversing() {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x801529A8 -> 0x801529D4
void zConversationPlay(enum iSndGroupHandle soundGroup /* r3 */, const struct xBase * otherSpeakerBase /* r5 */) {
    // References
    // -> static class zConversationManager manager;
}

// Range: 0x801529D4 -> 0x80152A48
// this: r30
zConversation::zConversation(const struct zConversationAsset & myAsset /* r31 */) {}

// Range: 0x80152A48 -> 0x80152A8C
void zConversation::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// Range: 0x80152A8C -> 0x80152AE0
// this: r3
void zConversation::HandleEvent(unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r7 */) {
    // References
    // -> static class zConversationManager manager;
}

static // total size: 0x24
struct {} @unnamed@zConversation_cpp@::zConversationManager::__vtable; // size: 0x24, address: 0x803BEE00
// total size: 0x4
