/*
    ...
    Language: C++
    Code range: 0x800AEC90 -> 0x800AEEC4
*/
static unsigned int ribbonCount; // size: 0x4, address: 0x803C1B68
static struct xFXRibbon * ribbonPool; // size: 0x4, address: 0x803C1B6C
static unsigned char * ribbonInUse; // size: 0x4, address: 0x803C1B70
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x800AEC90 -> 0x800AED44
void zFXRibbonPoolInit(unsigned int maxNumRibbons /* r0 */) {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x800AEE60 -> 0x800AEE90
void zFXRibbonPoolDelete(struct xFXRibbon * & ribbon /* r0 */) {
    // References
    // -> static struct xFXRibbon * ribbonPool;
    // -> static unsigned char * ribbonInUse;
}

// Range: 0x800AEE90 -> 0x800AEEC4
