/*
    ...
    Language: C++
    Code range: 0x80131728 -> 0x80133200
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x803C2E30
// total size: 0x18
struct /* @class$1131zParticleCustom_cpp */ {
    // Members
...
struct /* @class$1131zParticleCustom_cpp */ {
    ...
    int dust; // offset 0x10, size 0x4
    int fire_smoke; // offset 0x14, size 0x4
} system_id; // size: 0x18, address: 0x803C2E38
...
// Range: 0x8013172C -> 0x801317C4
static void register_particle_system(int & system_id /* r28 */, enum ptank_group_type pool_type /* r0 */, unsigned int texture_id /* r5 */, unsigned int src_blend /* r0 */, unsigned int dst_blend /* r0 */, int order_index /* r29 */, int flags /* r0 */, int stride /* r30 */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$923zParticleCustom_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zParticleCustom_cpp */ {
    // Members
...
union /* @class$746zParticleCustom_cpp */ {
...
// Range: 0x801317C4 -> 0x801319B8
static int update_spark_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f29 */) {
    // Local variables
...
// Range: 0x80131BC0 -> 0x80131C10
void zParticleCustomCreateSparkSystem(int & systemID /* r0 */, unsigned int textureID /* r9 */, const char * debugName /* r0 */) {}

// Range: 0x80131C10 -> 0x80131C38
static void register_particle_system(int & system_id /* r0 */, enum ptank_group_type pool_type /* r0 */, unsigned int texture_id /* r0 */, unsigned int src_blend /* r0 */, unsigned int dst_blend /* r0 */, int order_index /* r0 */, int flags /* r0 */, int stride /* r0 */, int (* update)(unsigned char *, int, struct ptank_pool &, float, void *) /* r0 */) {}
...
// Range: 0x80131FC0 -> 0x80132228
void zParticleCustomEmitGlint(const struct xVec3 * loc /* r23 */, const struct xVec3 * vel /* r24 */, const float * length_vel /* r25 */, int amount /* r26 */, float life_min /* f20 */, float life_range /* f21 */, float width_min /* f22 */, float width_range /* f23 */, float length_min /* f24 */, float length_range /* f25 */, float length_clamp_min /* f26 */, float length_clamp_range /* f27 */, float dt /* f11 */, float gravity /* f3 */, int systemID /* r27 */) {
    // Local variables
    float yaccel; // f30
    float age; // f29
    float dage; // f28
    unsigned char * mem; // r1+0x8
    int have; // r0
    struct glint_particle * p; // r29
    struct glint_particle * endp; // r28
    float life; // f18
    float rlen; // f0
...
// Range: 0x80132228 -> 0x80132278
void zParticleCustomCreateGlintSystem(int & systemID /* r0 */, unsigned int textureID /* r9 */, const char * debugName /* r0 */) {}
...
// Range: 0x80132558 -> 0x80132780
static int update_pebble_particles_no_coll(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f28 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
...
static float dust_vel_decay; // size: 0x4, address: 0x803C2E50
// Range: 0x801327C4 -> 0x801327F0
...
// Range: 0x801327F0 -> 0x80132B34
static int update_dust_particles(unsigned char * mem /* r23 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f27 */) {
    // Local variables
...
// Range: 0x80132B34 -> 0x80132D8C
static int update_fire_smoke_particles(unsigned char * mem /* r24 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f28 */) {
    // Local variables
    struct ptank_pool__pos_color_size & _fptank_pool; // r31
    int _fptank_used; // r30
    struct xVec3 * pool_pos; // r29
    struct xColor_tag * pool_color; // r28
    struct xVec2 * pool_size; // r27
    struct fire_smoke_particle * p; // r26
