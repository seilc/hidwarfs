/*
    ...
    Language: C++
    Code range: 0x800ADBFC -> 0x800AE8DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800ADBFC -> 0x800ADCA8
// this: r30
void zFlameEmitter::load(const struct asset_type & a /* r31 */) {}

// Range: 0x800ADCA8 -> 0x800ADCE0
// this: r0
void zFlameEmitter::reset() {}

// Range: 0x800ADCE0 -> 0x800ADD24
// this: r31
void zFlameEmitter::hide() {}

// Range: 0x800ADD24 -> 0x800ADD6C
// this: r31
void zFlameEmitter::show() {}

// Range: 0x800ADD6C -> 0x800ADDB4
// this: r31
void zFlameEmitter::spawn() {}

// Range: 0x800ADDB4 -> 0x800ADDF8
// this: r31
void zFlameEmitter::kill() {}

// Range: 0x800ADDF8 -> 0x800ADE54
// this: r31
void zFlameEmitter::update(float dt /* f1 */) {}

// Range: 0x800ADE54 -> 0x800ADE74
// this: r0
void zFlameEmitter::render() {}

// Range: 0x800ADE74 -> 0x800ADE94
void zFlameEmitter::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x800AE0E0 -> 0x800AE144
// this: r31
void zFlameEmitter::refresh_mat() {}

// Range: 0x800AE144 -> 0x800AE204
// this: r30
...
// Range: 0x800AE204 -> 0x800AE238
// this: r0
void zFlameEmitter::setup() {}

// Range: 0x800AE238 -> 0x800AE258
// this: r0
...
void zFlameEmitter::create_flames(int flags /* r28 */) {
    ...
    struct handle * flame; // r26
    struct handle * const end_flame; // r25
    unsigned int ix; // r28
...
// total size: 0x4
struct /* @class$856zFlameEmitter_cpp */ {
    // Members
...
union /* @class$810zFlameEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$875zFlameEmitter_cpp */ {
    // Members
...
// Range: 0x800AE714 -> 0x800AE750
// this: r0
void zFlameEmitter::dump_flames() {}

// Range: 0x800AE750 -> 0x800AE7B0
// this: r31
void zFlameEmitter::start_flames_sound() {}

// Range: 0x800AE7B0 -> 0x800AE808
// this: r31
void zFlameEmitter::end_flames_sound() {}

// Range: 0x800AE808 -> 0x800AE8DC
void zFlameEmitter::cb_dispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r0 */) {
    // Local variables
    struct zFlameEmitter & e; // r4
}
