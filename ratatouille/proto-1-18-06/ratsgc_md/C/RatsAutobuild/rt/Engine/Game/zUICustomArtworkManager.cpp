/*
    ...
    Language: C++
    Code range: 0x8015C2E0 -> 0x8015CB24
*/
class zUICustomArtworkManager * pUICustomArtworkManager; // size: 0x4, address: 0x803C30E8
static unsigned char unlockedBonus[80]; // size: 0x50, address: 0x8038E2F8
// total size: 0x8
struct xIniValue {
    // Members
...
static int translationTable[80]; // size: 0x140, address: 0x802DDC48
// Range: 0x8015CA80 -> 0x8015CB24
