/*
    ...
    Language: C++
    Code range: 0x800F56B8 -> 0x800F6F90
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int isStartOnKey; // size: 0x4, address: 0x803C2820
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800F56B8 -> 0x800F56EC
void * zIncrediSlam::operator new(unsigned long size /* r31 */) {
    // Local variables
    class zIncrediSlamMgr * mgr; // r0
}

unsigned int tweakSlamWaveTextureID; // size: 0x4, address: 0x803C2824
unsigned int tweakSlamParticleTextureID; // size: 0x4, address: 0x803C2828
// total size: 0x34
struct RwRaster {
    // Members
...
// Range: 0x800F5984 -> 0x800F5A30
// this: r31
void zIncrediSlam::Update(float dt /* f31 */) {}

// Range: 0x800F5A30 -> 0x800F5A40
// this: r0
unsigned char zIncrediSlam::Cull() {}

// Range: 0x800F5A40 -> 0x800F5A78
// this: r0
...
static struct curve_node footstep_curve[3]; // size: 0x54, address: 0x802B0270
// Range: 0x800F5A78 -> 0x800F5B20
// this: r31
...
// Range: 0x800F5C28 -> 0x800F5C2C
void zIncrediSlam::GenerateParticle() {}

// Range: 0x800F5C2C -> 0x800F5D6C
// this: r28
...
// Range: 0x800F6B18 -> 0x800F6B1C
void zIncrediSlam::BeginRender() {}

// Range: 0x800F6B1C -> 0x800F6B20
void zIncrediSlam::EndRender() {}

class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4, address: 0x803C282C
// total size: 0xC
...
// Range: 0x800F6B74 -> 0x800F6B8C
void zIncrediSlamMgr::Remove() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x800F6B8C -> 0x800F6BD8
...
// Range: 0x800F6BD8 -> 0x800F6BE4
// this: r0
void zIncrediSlam::SetInactive() {}

// Range: 0x800F6BE4 -> 0x800F6BF0
// this: r0
zIncrediSlamMgr::zIncrediSlamMgr() {}

// Range: 0x800F6BF0 -> 0x800F6D00
// this: r31
...
// Range: 0x800F6E14 -> 0x800F6E40
void zIncrediSlamMgr::Render() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x800F6E40 -> 0x800F6E80
// this: r0
