/*
    ...
    Language: C++
    Code range: 0x801BA260 -> 0x801BA658
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$816zMiniGamePickups_cpp */ {
    // Members
...
// Range: 0x801BA260 -> 0x801BA290
// this: r0
void zMiniGamePickupController::Setup(struct xGroup * inGroup /* r0 */, float spawnTime /* f0 */, float showTime /* f0 */, unsigned char resetTypes /* r0 */) {}
...
// Range: 0x801BA290 -> 0x801BA358
// this: r29
void zMiniGamePickupController::SetAvailablePickup(int idx /* r30 */) {
    // Local variables
...
// Range: 0x801BA358 -> 0x801BA428
// this: r31
void zMiniGamePickupController::Update(float dt /* f0 */) {}

// Range: 0x801BA428 -> 0x801BA488
// this: r0
void zMiniGamePickupController::AddType(int id /* r0 */, float likelyhood /* f0 */, float activeTime /* f0 */, unsigned int modelID /* r0 */, unsigned int soundID /* r0 */) {}

// Range: 0x801BA488 -> 0x801BA49C
// this: r0
void zMiniGamePickupController::Reset() {}

// Range: 0x801BA49C -> 0x801BA4F4
// this: r31
void zMiniGamePickupController::Render() {}

// Range: 0x801BA4F4 -> 0x801BA588
// this: r30
...
// total size: 0x2C
struct {} zMiniGamePickupController::__vtable; // size: 0x2C, address: 0x803C01E0
