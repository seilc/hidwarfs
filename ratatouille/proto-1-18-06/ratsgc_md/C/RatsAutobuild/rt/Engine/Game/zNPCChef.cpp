/*
    ...
    Language: C++
    Code range: 0x8019C6E0 -> 0x8019C990
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8019C6E0 -> 0x8019C738
void zNPCChefIdle::create_anim_table(struct xAnimTable * table /* r0 */) {}

// Range: 0x8019C738 -> 0x8019C774
// this: r0
void zNPCChefIdle::enterBehavior() {}

// Range: 0x8019C774 -> 0x8019C778
void zNPCChefIdle::updateBehavior() {}

// total size: 0x64
class zNPCChefRun : public zNPCMove {
    // Members
    struct xVec3 targetPos; // offset 0x50, size 0xC
    float timeElapsed; // offset 0x5C, size 0x4
    unsigned char arrived; // offset 0x60, size 0x1
};
// Range: 0x8019C778 -> 0x8019C7D4
...
// total size: 0x1C8
struct {} zNPCChef::__vtable; // size: 0x1C8, address: 0x802E1078
// total size: 0x460
class zNPCChef : public zNPCCommon {
    ...
    // Members
    class zNPCChefIdle * idleState; // offset 0x450, size 0x4
    class zNPCChefRun * moveState; // offset 0x454, size 0x4
};
// Range: 0x8019C7D4 -> 0x8019C810
// this: r31
zNPCChef::zNPCChef() {
    // References
...
// total size: 0x4
struct /* @class$1197zNPCChef_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zNPCChef_cpp */ {
    // Members
...
// Range: 0x8019C8B8 -> 0x8019C938
// this: r31
void zNPCChef::init(class zNPCInstance * init_inst /* r0 */) {}

// Range: 0x8019C938 -> 0x8019C970
// this: r4
void zNPCChef::SetDefaultAndEventStates() {}

// Range: 0x8019C970 -> 0x8019C990
// this: r0
unsigned char zNPCChef::systemEvent(struct xBase * from /* r0 */, struct xBase * to /* r0 */, unsigned int to_event /* r0 */, const float * to_param /* r0 */, struct xBase * to_param_widget /* r0 */, unsigned int to_param_widget_id /* r0 */) {}
...
// total size: 0x108
struct {} zNPCChefIdle::__vtable; // size: 0x108, address: 0x802E1240
