/*
    ...
    Language: C++
    Code range: 0x800EB168 -> 0x800ED368
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwRaster * textureRaster; // size: 0x4, address: 0x803C2690
// total size: 0x8
struct RwObject {
    // Members
...
struct RwTexture * particleTex; // size: 0x4, address: 0x803C2694
...
struct WaterhoseCollisionInfo waterhoseCollisionInfo; // size: 0x14, address: 0x803BE3D0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800EB168 -> 0x800EB188
void zWaterhoseWidget::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800EB188 -> 0x800EB1DC
// this: r30
...
// Range: 0x800EB1DC -> 0x800EB2F4
void zWaterhoseWidget::EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {
    // Local variables
...
// Range: 0x800EB3F8 -> 0x800EB448
// this: r30
zWaterhose::~zWaterhose() {}

static unsigned int counter; // size: 0x4, address: 0x803C2698
static signed char init; // size: 0x1, address: 0x803C269C
// Range: 0x800EB448 -> 0x800EB578
// this: r31
...
// Range: 0x800EB824 -> 0x800EB86C
// this: r0
void zWaterhose::Render() {}

unsigned int tweakWHcardTextureID; // size: 0x4, address: 0x803C26A0
unsigned int tweakWHParticleTextureID; // size: 0x4, address: 0x803C26A4
// Range: 0x800EB86C -> 0x800EB8F8
// this: r31
...
// total size: 0xC
struct /* @class$727zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$728zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zWaterhose_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$730zWaterhose_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zWaterhose_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zWaterhose_cpp */ {
    // Members
...
static struct tweak_callback cb_change_texture; // size: 0x28, address: 0x803BE3E4
static signed char init; // size: 0x1, address: 0x803C26A8
static struct tweak_callback cb_change_textureB; // size: 0x28, address: 0x803BE40C
static signed char init; // size: 0x1, address: 0x803C26A9
// Range: 0x800EB954 -> 0x800EBC50
// this: r31
void zWaterhose::AddTweaks(unsigned int number /* r4 */) {
    // Local variables
    char name[64]; // r1+0xA8
    char name1[64]; // r1+0x68
...
static float speed; // size: 0x4, address: 0x803C26AC
static signed char init; // size: 0x1, address: 0x803C26B0
static float start; // size: 0x4, address: 0x803C26B4
static signed char init; // size: 0x1, address: 0x803C26B8
static float yOffset; // size: 0x4, address: 0x803C26BC
static signed char init; // size: 0x1, address: 0x803C26C0
static float spread; // size: 0x4, address: 0x803C26C4
static float life; // size: 0x4, address: 0x803C26C8
// Range: 0x800EBDA8 -> 0x800EC420
// this: r31
...
static float start; // size: 0x4, address: 0x803C26CC
static signed char init; // size: 0x1, address: 0x803C26D0
static float yOffset; // size: 0x4, address: 0x803C26D4
static signed char init; // size: 0x1, address: 0x803C26D8
static float spread; // size: 0x4, address: 0x803C26DC
static signed char init; // size: 0x1, address: 0x803C26E0
static float speed; // size: 0x4, address: 0x803C26E4
static signed char init; // size: 0x1, address: 0x803C26E8
// Range: 0x800EC6E0 -> 0x800EC918
// this: r31
void zWaterhose::CreateCardEdge(int l /* r0 */, float dirX /* f0 */, float dirY /* f0 */) {
    // Local variables
    struct xVec3 dir; // r1+0x28
    struct xMat3x3 matC; // r1+0x40
    struct xVec3 * pos; // r27
...
static float start; // size: 0x4, address: 0x803C26EC
static signed char init; // size: 0x1, address: 0x803C26F0
static float yOffset; // size: 0x4, address: 0x803C26F4
static signed char init; // size: 0x1, address: 0x803C26F8
static float spread; // size: 0x4, address: 0x803C26FC
static signed char init; // size: 0x1, address: 0x803C2700
static float speed; // size: 0x4, address: 0x803C2704
static signed char init; // size: 0x1, address: 0x803C2708
// Range: 0x800EC918 -> 0x800ECB18
// this: r31
...
// total size: 0x4
struct /* @class$923zWaterhose_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zWaterhose_cpp */ {
    // Members
...
class zWaterhoseMgr * waterhoseMgr; // size: 0x4, address: 0x803C270C
// total size: 0xC
class zWaterhoseMgr {
    // Functions
    zWaterhoseMgr();
...
// Range: 0x800ED040 -> 0x800ED058
void zWaterhoseMgr::Remove() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x800ED058 -> 0x800ED098
void zWaterhoseMgr::Reset() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x800ED098 -> 0x800ED0A4
// this: r0
zWaterhoseMgr::zWaterhoseMgr() {}

// Range: 0x800ED0A4 -> 0x800ED1B8
// this: r31
class zWaterhose * zWaterhoseMgr::GetMem(unsigned long size /* r30 */) {
    // Local variables
...
// Range: 0x800ED1B8 -> 0x800ED214
// this: r0
void zWaterhoseMgr::FreeMem(class zWaterhose * mem /* r0 */) {}

// Range: 0x800ED214 -> 0x800ED240
void zWaterhoseMgr::Update(float dt /* f0 */) {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x800ED240 -> 0x800ED2C8
// this: r0
...
// Range: 0x800ED2C8 -> 0x800ED2D4
// this: r0
unsigned char zWaterhose::IsShutDown() {}

// Range: 0x800ED2D4 -> 0x800ED2E0
// this: r0
unsigned char zWaterhose::IsMgrUpdate() {}

// Range: 0x800ED2E0 -> 0x800ED30C
void zWaterhoseMgr::Render() {
    // References
    // -> class zWaterhoseMgr * waterhoseMgr;
}

// Range: 0x800ED30C -> 0x800ED35C
// this: r0
