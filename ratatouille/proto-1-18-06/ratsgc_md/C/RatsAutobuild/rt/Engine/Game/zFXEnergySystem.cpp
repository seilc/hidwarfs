/*
    ...
    Language: C++
    Code range: 0x8012E5E8 -> 0x8012F56C
*/
int streak_system_id; // size: 0x4, address: 0x803BEA08
int point_system_id; // size: 0x4, address: 0x803BEA0C
unsigned char need_setup; // size: 0x1, address: 0x803C2E18
// total size: 0x3C
class energy_system {
    // Functions
...
static struct config default_config; // size: 0x74, address: 0x80387B08
// total size: 0x28
...
// Range: 0x8012F52C -> 0x8012F538
// this: r0
void energy_system::end() {}

// Range: 0x8012F538 -> 0x8012F56C
// this: r31
