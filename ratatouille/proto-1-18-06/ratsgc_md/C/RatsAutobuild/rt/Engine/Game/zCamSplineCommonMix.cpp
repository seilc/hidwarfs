/*
    ...
    Language: C++
    Code range: 0x8016DEF0 -> 0x8016DFDC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct {} zCamSplineCommonMix::__vtable; // size: 0xC, address: 0x803BF030
// total size: 0x20
struct xLinkAsset {
    // Members
