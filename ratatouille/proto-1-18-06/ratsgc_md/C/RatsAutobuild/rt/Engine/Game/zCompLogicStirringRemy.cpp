/*
    ...
    Language: C++
    Code range: 0x801ABEE4 -> 0x801AC668
*/
// total size: 0x1
...
static class zCompSteeringBasicParams sSteeringParams; // size: 0x70, address: 0x80396690
static unsigned char gotPush; // size: 0x1, address: 0x803C39E8
static unsigned char gotRun; // size: 0x1, address: 0x803C39E9
static unsigned char arrived; // size: 0x1, address: 0x803C39EA
static int runIdx; // size: 0x4, address: 0x803C39EC
static int curIdx; // size: 0x4, address: 0x803BFC00
// total size: 0x0
class zMovePoint {};
static class zMovePoint * mp[100]; // size: 0x190, address: 0x80396700
static int mp_count; // size: 0x4, address: 0x803C39F0
static unsigned int replyToID; // size: 0x4, address: 0x803C39F4
// total size: 0x8
...
static struct zCompStateMachineTable gStirringRemyStateMachineTable[4]; // size: 0x20, address: 0x803BFC04
// total size: 0x2C
struct {} zStirringRemyIdle::__vtable; // size: 0x2C, address: 0x803BFC7C
// total size: 0x14
...
// Range: 0x801ABF58 -> 0x801ABF84
// this: r0
void zStirringRemyIdle::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x801ABF84 -> 0x801ABFCC
...
// total size: 0x2C
struct {} zStirringRemyRun::__vtable; // size: 0x2C, address: 0x803BFC50
// total size: 0x28
...
// total size: 0x2C
struct {} zStirringRemyPush::__vtable; // size: 0x2C, address: 0x803BFC24
// total size: 0x14
...
// Range: 0x801AC2D0 -> 0x801AC2D4
void zStirringRemyPush::Update() {}

// Range: 0x801AC2D4 -> 0x801AC300
// this: r0
void zStirringRemyPush::Enter(class zNPCBase * owner /* r0 */) {}

// Range: 0x801AC300 -> 0x801AC34C
