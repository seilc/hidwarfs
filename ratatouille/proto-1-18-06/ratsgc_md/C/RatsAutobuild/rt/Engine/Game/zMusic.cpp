/*
    ...
    Language: C++
    Code range: 0x800BF00C -> 0x800BFC30
*/
enum xSndHandle {
};
// total size: 0x24
...
static struct zMusicTrackInfo sMusicTrack[2]; // size: 0x48, address: 0x8036A548
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct xSndGroup * spMusicGroup; // size: 0x4, address: 0x803C20E8
// total size: 0x8
struct zMusicState {
    // Members
...
static struct zMusicState sMusic; // size: 0x8, address: 0x803C20EC
float gDialogueMusicLevel; // size: 0x4, address: 0x803BE1A8
enum iSndGroupHandle {
};
// Range: 0x800BF00C -> 0x800BF07C
...
// Range: 0x800BF07C -> 0x800BF0B8
static void _zMusicPause(unsigned int uWhichSlot /* r0 */, unsigned char bPause /* r0 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
}

// Range: 0x800BF0B8 -> 0x800BF110
static void _zMusicStop(unsigned int uWhichSlot /* r0 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
}
...
// Range: 0x800BF534 -> 0x800BF570
void zMusicKill() {
    // Local variables
    unsigned int i; // r31
}

// Range: 0x800BF570 -> 0x800BF5C8
void zMusicPause() {
    // Local variables
    unsigned int i; // r30
...
// Range: 0x800BF89C -> 0x800BF90C
void ZeroVolumeHack::StopZeroVolume(unsigned int slot /* r0 */) {
    // References
    // -> static struct zMusicTrackInfo sMusicTrack[2];
}

// Range: 0x800BF90C -> 0x800BFA84
void zMusicNewSongEvent(const float * toParam /* r28 */, unsigned int toParamWidgetID /* r27 */) {
    // Local variables
...
// Range: 0x800BFAA4 -> 0x800BFBEC
void zMusicTempSongEvent(const float * toParam /* r28 */, unsigned int toParamWidgetID /* r27 */) {
    // Local variables
