/*
    ...
    Language: C++
    Code range: 0x801150DC -> 0x80116734
*/
// total size: 0xC
struct RwV3d {
    // Members
...
static struct xMat3x3 sPickupOrientation; // size: 0x30, address: 0x803BE680
float PICKUP_FADE_DIST_SQR; // size: 0x4, address: 0x803C2A08
float PICKUP_CULL_DIST_SQR; // size: 0x4, address: 0x803C2A0C
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct Table * table; // size: 0x4, address: 0x803C2A10
class zPickup * extras; // size: 0x4, address: 0x803C2A14
struct InstanceAsset * extra_assets; // size: 0x4, address: 0x803C2A18
int extras_used; // size: 0x4, address: 0x803C2A1C
int extras_max; // size: 0x4, address: 0x803C2A20
struct zSparkEmitterAsset * sparkEmitterAsset; // size: 0x4, address: 0x803C2A24
float lastdt; // size: 0x4, address: 0x803C2A28
struct xFXRibbon ribbon[4]; // size: 0x40, address: 0x803C2A2C
float spiralDecay; // size: 0x4, address: 0x803C2A6C
static struct curve_node ribbon_curve[2]; // size: 0x18, address: 0x803C7108
// total size: 0x10
struct glintInfo {
    // Members
...
static struct zSparkEmitterAsset _sparkEmitterAsset; // size: 0x94, address: 0x80380428
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80115184 -> 0x801151A4
void zPickup::ResetAll() {}

// Range: 0x801151A4 -> 0x801151C4
...
static struct config_type cfg; // size: 0x20, address: 0x803C2A70
// Range: 0x801151C4 -> 0x80115470
// this: r31
...
// Range: 0x80115548 -> 0x80115618
// this: r3
void zPickup::EventCB(struct xBase * to /* r5 */, unsigned int toEvent /* r0 */) {}

static unsigned int SCENEFLAGS_GALLERY; // size: 0x4, address: 0x803C7134
// Range: 0x80115618 -> 0x801156E0
...
// Range: 0x8011578C -> 0x801157F0
// this: r0
unsigned char zPickup::CanGalleryPickupBeUsed(struct zPlayer * player /* r4 */) const {}

// Range: 0x801157F0 -> 0x8011589C
// this: r31
void zPickup::BeUsed() {}

// Range: 0x8011589C -> 0x80115918
// this: r31
...
// Range: 0x80115A90 -> 0x80115A94
void zPickup::UpdateFX() {}

// Range: 0x80115A94 -> 0x80115B0C
...
// Range: 0x80116390 -> 0x801163F0
// this: r31
void zPickup::DestroyExtra() {}

// Range: 0x801163F0 -> 0x80116484
