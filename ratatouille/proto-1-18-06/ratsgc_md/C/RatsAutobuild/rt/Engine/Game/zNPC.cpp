/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zNPC.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8016E6D8 -> 0x8016EAE8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct {} zNPC::zNPCInstance::__vtable; // size: 0xC, address: 0x803BF080
enum ezGameLevel {
    ezGAMELEVEL_UT01 = 0,
    ezGAMELEVEL_DD01 = 1,
    ezGAMELEVEL_MT01 = 2,
...
enum ezGameLevel gNPCGameLevel; // size: 0x4, address: 0x803BEED8
// Range: 0x8016E720 -> 0x8016E874
// this: r31
zNPCInstance::zNPCInstance(const struct xModelAssetInfo * model_asset /* r0 */, unsigned int type /* r0 */, struct zNPCAssetIN2 * npc_asset /* r30 */, int npc_asset_size /* r0 */) {
    // Local variables
    char * ptr; // r4
    int amt_linkdata; // r5
...
// Range: 0x8016E874 -> 0x8016E894
// this: r0
void zNPCInstance::Reset() {}

// Range: 0x8016E894 -> 0x8016E8C0
// this: r0
void zNPCInstance::SetMovementRadius(float inRadius /* f0 */) {}

// Range: 0x8016E8C0 -> 0x8016E904
// this: r31
...
// total size: 0x4
struct /* @class$1197zNPC_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zNPC_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
