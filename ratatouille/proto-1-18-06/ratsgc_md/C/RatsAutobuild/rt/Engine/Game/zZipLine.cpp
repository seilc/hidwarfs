/*
    ...
    Language: C++
    Code range: 0x8008D4D0 -> 0x8008D5EC
*/
// Range: 0x8008D4D0 -> 0x8008D4F0
...
struct zZipLineCam : public xCam {
    // Members
    struct config cfg; // offset 0x130, size 0x78
private:
    struct xMat4x3 basis; // offset 0x1B0, size 0x40
    struct xCamCoordSphere end_coord; // offset 0x1F0, size 0x20
    struct xVec3 end_offset; // offset 0x210, size 0xC
    float vel_dist; // offset 0x21C, size 0x4
    float vel_turn; // offset 0x220, size 0x4
    struct zone_data zone; // offset 0x224, size 0x18
    struct zone_data end_zone; // offset 0x23C, size 0x18
    struct zone_data vel_zone; // offset 0x254, size 0x18
};
// total size: 0xC
struct RwV3d {
    // Members
