/*
    ...
    Language: C++
    Code range: 0x80197DFC -> 0x80198DE0
*/
// total size: 0x3C
struct {} zNPCBase::__vtable; // size: 0x3C, address: 0x803BF550
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80198194 -> 0x801982D4
// this: r31
void zNPCBase::TimeStep(struct xVec3 * cullOrigin /* r4 */, struct xScene * xscn /* r30 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x801986F4 -> 0x80198740
// this: r31
void zNPCBase::UpdateNPCBaseData() {}

// Range: 0x80198740 -> 0x801987C0
// this: r27
...
// Range: 0x801987C0 -> 0x801987C8
// this: r0
void zNPCBase::SetParent(class zNPCBase * parent /* r0 */) {}

// Range: 0x801987C8 -> 0x80198898
// this: r31
...
// total size: 0x1
struct /* @class$796zNPCBase_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$797zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$798zNPCBase_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$799zNPCBase_cpp */ {
    // Members
