/*
    ...
    Language: C++
    Code range: 0x800C3B38 -> 0x800C40C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x0
struct xSerial {};
// Range: 0x800C3BFC -> 0x800C3C1C
void zPendulum_Save(struct _zPendulum * pend /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800C3C1C -> 0x800C3C3C
void zPendulum_Load(struct _zPendulum * pend /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800C3C3C -> 0x800C3C78
void zPendulum_Setup(struct _zPendulum * pend /* r30 */, struct xScene * sc /* r31 */) {}

// Range: 0x800C3C78 -> 0x800C3D74
void zPendulum_Reset(struct _zPendulum * pend /* r30 */, struct xScene * sc /* r31 */) {
    // Local variables
    struct xEntMotionPenData * aspen; // r0
}

// Range: 0x800C3D74 -> 0x800C3E10
...
// Range: 0x800C3E78 -> 0x800C40C4
void zPendulumEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r5 */, const float * toParam /* r6 */, struct xBase * toParamWidget /* r7 */) {
    // Local variables
