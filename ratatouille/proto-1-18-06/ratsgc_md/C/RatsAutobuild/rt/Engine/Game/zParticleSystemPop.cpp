/*
    ...
    Language: C++
    Code range: 0x80151404 -> 0x80151F18
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zParticleLocator * sLocatorPool; // size: 0x4, address: 0x803C2FF8
static int sLocatorsUsed; // size: 0x4, address: 0x803C2FFC
// total size: 0x8
...
// Range: 0x80151BB0 -> 0x80151C38
// this: r31
void zParticleGeneratorPop::reset() {}

// Range: 0x80151C38 -> 0x80151C54
...
// total size: 0x20
struct {} zParticleGeneratorPop::__vtable; // size: 0x20, address: 0x803BEDA8
// total size: 0x34
struct {} zParticleSystemPop::__vtable; // size: 0x34, address: 0x803BEDC8
// total size: 0x8
