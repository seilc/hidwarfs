/*
    ...
    Language: C++
    Code range: 0x80098B74 -> 0x8009ADB8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float DEG_TO_RAD; // size: 0x4, address: 0x803BDD40
static float LAUNCH_ANGLE; // size: 0x4, address: 0x803BDD44
static float LAUNCH_VEL; // size: 0x4, address: 0x803BDD48
static float DAMAGE_RADIUS; // size: 0x4, address: 0x803BDD4C
static float MAX_TIME_NO_COLLISIONS; // size: 0x4, address: 0x803BDD50
static float HIT_TO_DESTROY_TIME; // size: 0x4, address: 0x803BDD54
static float Y_VELOCITY; // size: 0x4, address: 0x803BDD58
static float RESPAWN_THRESHOLD; // size: 0x4, address: 0x803BDD5C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$786zDestructible_cpp */ {
    // Members
...
union /* @class$805zDestructible_cpp */ {
...
// Range: 0x80098BDC -> 0x80098CCC
static void LoadModel(struct xEnt * ent /* r31 */, struct zDestructible * dest /* r28 */, unsigned char gridUpdate /* r29 */) {
    // Local variables
...
static float DOBJ_STD_BOUND_VAR; // size: 0x4, address: 0x803BDD60
// Range: 0x80099110 -> 0x800991B4
...
struct zHitSourceMapEntry zHitSourceMap[66]; // size: 0x210, address: 0x802ACD00
// Range: 0x800991B4 -> 0x80099268
static void zDestructible_SendEvent(struct xEnt * ent /* r3 */, struct xBase * dest /* r4 */) {
    // Local variables
    int hit_sourcetype; // r8
...
// total size: 0xC
struct /* @class$804zDestructible_cpp */ {
    // Members
...
// Range: 0x80099560 -> 0x800995A4
static unsigned int BurnSinRateCallback(float time /* f0 */) {}

// Range: 0x800995A4 -> 0x80099AF0
void zDestructibleAsset_Reset(struct zDestructible * & dest /* r26 */, struct xEnt * ent /* r27 */) {
    // Local variables
    ...
    unsigned int * animListIDs; // r21
    unsigned int j; // r22
    void * tmp_ptr; // r3
}

// Range: 0x80099AF0 -> 0x80099BA0
...
// Range: 0x80099BA0 -> 0x80099E3C
void zDestructibleAsset_Init(unsigned int assetID /* r25 */, struct zDestructible * & dest /* r27 */, struct xEnt * ent /* r28 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r30
    unsigned int i; // r6
    struct xModelInstance * baseModel; // r5
    unsigned int fx_count; // r6
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r29
...
// Range: 0x80099F28 -> 0x80099F5C
static void zDestructible_SwapAnimations(struct xEnt * ent /* r0 */, struct zDestructible * dest /* r0 */) {}

// Range: 0x80099F5C -> 0x8009A06C
static void zDestructible_Swap(struct xEnt * ent /* r26 */, struct zDestructible * dest /* r27 */, struct xVec3 & initial_velocity /* r31 */, int pad_port /* r28 */, unsigned char state_change /* r29 */) {
    // Local variables
...
// Range: 0x8009A06C -> 0x8009A12C
static void zDestructible_StartSwitchStatesSounds(struct xEnt * ent /* r30 */, struct zDestructible * dest /* r31 */) {
    // Local variables
    struct xSoundFX * soundfxswitch; // r4
}

// Range: 0x8009A12C -> 0x8009A218
static void zDestructible_StateChange(struct xEnt * ent /* r29 */, struct zDestructible * dest /* r0 */, int pad_port /* r30 */) {
    // Local variables
    struct zDestructibleState * state; // r31
}

// Range: 0x8009A218 -> 0x8009A2BC
static void zDestructible_StopSounds(struct xEnt * ent /* r29 */, struct zDestructible * dest /* r30 */) {
    // Local variables
    int lastidx; // r0
    struct xSoundFX * soundfx; // r4
}

// Range: 0x8009A2BC -> 0x8009A334
static void zDestructible_StopAllIdleSounds(struct zDestructible * dest /* r29 */) {
    // Local variables
    unsigned int i; // r30
}

// Range: 0x8009A334 -> 0x8009A448
...
// Range: 0x8009A448 -> 0x8009A66C
static void zDestructible_StateProcess(struct xEnt * ent /* r26 */, struct zDestructible * dest /* r27 */, unsigned int damage /* r5 */, unsigned int idx /* r0 */, const float * toParam /* r28 */, struct xVec3 & initial_velocity /* r29 */, int pad_port /* r30 */, unsigned char state_change /* r31 */) {
    // Local variables
    struct xModelInstance * curr; // r4
    unsigned int _percent; // r0
}

// Range: 0x8009A68C -> 0x8009A6B8
...
// Range: 0x8009A6B8 -> 0x8009AC18
void zDestructibleAsset_EventCB(struct xBase * from /* r31 */, struct xBase * root_base /* r0 */, struct zDestructible * to /* r28 */, unsigned int toEvent /* r0 */, const float * toParam /* r29 */) {
    // Local variables
    struct xEnt * ent; // r31
    struct xEnt * root_ent; // r0
    struct zDestructibleState * cstate; // r30
    int up; // r29
    int idx; // r0
    ...
    unsigned int hit_source_flag; // r27
    unsigned int damage; // r30
    int i; // r26
