/*
    ...
    Language: C++
    Code range: 0x800B8B38 -> 0x800BAEA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct /* @class$1133zLightning_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$980zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$998zLightning_cpp */ {
    // Members
...
static struct zLightning * sLightning; // size: 0x4, address: 0x803C1F88
// total size: 0x14
struct xPECircle {
    // Members
...
static struct RwRaster * sLightningRaster; // size: 0x4, address: 0x803C1F8C
static struct RwRaster * sLightningRasterBranch; // size: 0x4, address: 0x803C1F90
static struct RwTexture * sLightningParticleRaster; // size: 0x4, address: 0x803C1F94
float LIGHTNING_FADE_DIST_SQR; // size: 0x4, address: 0x803C1F98
float LIGHTNING_CULL_DIST_SQR; // size: 0x4, address: 0x803C1F9C
// total size: 0x20
struct xFuncPiece {
    // Members
...
static struct xFuncPiece sLFuncX[10]; // size: 0x140, address: 0x8035E2E0
static struct xFuncPiece sLFuncY[10]; // size: 0x140, address: 0x8035E420
static struct xFuncPiece sLFuncZ[10]; // size: 0x140, address: 0x8035E560
static struct xVec3 sLFuncVal[10]; // size: 0x78, address: 0x8035E6A0
static struct xVec3 sLFuncSlope[10][2]; // size: 0xF0, address: 0x8035E718
static float sLFuncEnd[10]; // size: 0x28, address: 0x803C1FA0
static float sLFuncJerkFreq; // size: 0x4, address: 0x803BE128
static float sLFuncJerkTime; // size: 0x4, address: 0x803C1FC8
static float sLFuncShift; // size: 0x4, address: 0x803BE12C
static float sLFuncMinScale; // size: 0x4, address: 0x803BE130
static float sLFuncMaxScale; // size: 0x4, address: 0x803BE134
static float sLFuncScalePerLength; // size: 0x4, address: 0x803BE138
static float sLFuncMinSpan; // size: 0x4, address: 0x803BE13C
static float sLFuncSpanPerLength; // size: 0x4, address: 0x803BE140
static float sLFuncSlopeRange; // size: 0x4, address: 0x803BE144
static float sLFuncUVSpeed; // size: 0x4, address: 0x803BE148
static float sLFuncUVOffset; // size: 0x4, address: 0x803C1FCC
// total size: 0x20
...
struct zLightningFuncPiece sLFuncNew[11]; // size: 0x160, address: 0x8035E810
// total size: 0x68
...
struct _tagLightningAdd gLightningTweakAddInfo; // size: 0x68, address: 0x8035E970
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 sTweakStart; // size: 0xC, address: 0x803C1FD0
static struct xVec3 sTweakEnd; // size: 0xC, address: 0x803C1FDC
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$784zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$785zLightning_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$786zLightning_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$787zLightning_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$788zLightning_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$789zLightning_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$790zLightning_cpp */ {
    // Members
...
static struct tweak_callback sLightningStartCB; // size: 0x28, address: 0x803C1FE8
// total size: 0x20
...
struct CollisionInfo collisionInfo; // size: 0x20, address: 0x803C2010
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800B8B38 -> 0x800B8B58
void zLightningWidget::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800B8B58 -> 0x800B8BB8
// this: r30
void zLightningWidget::Init(struct zLightningAsset * a /* r31 */) {}

// Range: 0x800B8BB8 -> 0x800B8C60
void zLightningWidget::EventCB(struct xBase * to /* r31 */, unsigned int toEvent /* r0 */) {
    // Local variables
...
static int sNumStrips; // size: 0x4, address: 0x803C6338
// Range: 0x800B8E54 -> 0x800B91C0
...
struct xVec3 * posArray; // size: 0x4, address: 0x803C2030
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x800B91C0 -> 0x800B9618
void zLightningInit() {
    // Local variables
    int i; // r0
    int j; // r4
...
// Range: 0x800B9700 -> 0x800B9728
struct zLightning * zLightningAdd(struct _tagLightningAdd * add /* r0 */) {}

static float defaultWeightParam[4][12]; // size: 0xC0, address: 0x802D9FD8
// Range: 0x800B9728 -> 0x800B996C
...
// Range: 0x800B9ED8 -> 0x800BA6B4
static void zLightningFunc_Render(struct zLightning * l /* r22 */) {
    // Local variables
    float percent; // f25
    float pstep; // f24
    struct xVec3 val[2]; // r1+0x54
    struct xVec3 lastPos; // r1+0x30
    struct xVec3 currPos; // r1+0x24
    int i; // r0
    float distanceFade; // r1+0x8
    struct xVec3 drawPos; // r1+0x18
    struct xVec3 drawAxis[2]; // r1+0x3C
    struct RxObjSpace3DVertex * verts0; // r27
    unsigned int numVerts; // r26
    int u; // r25
    ...
    float w2funcC; // f18
    float w2funcD; // f0
    float w2funcEnd; // r1+0x94
    float wsumfunc; // f17
    float wsumfuncB; // f16
    float wsumfuncC; // f15
    float wsumfuncD; // f0
    float wsumfuncEnd; // r1+0x90
    float _scl; // f0
    float _scl2; // f3
    float _scl3; // f21
    unsigned char isFinishLoop; // r23
    float fParam; // f0
    int iParam; // r6
    struct zLightningFuncPiece * piece; // r6
    float alpha; // f14
    struct xVec3 dir; // r1+0xC
    unsigned int vidx; // r21
...
// Range: 0x800BACA0 -> 0x800BAD6C
void zLightningCollide(const struct xBound & bound /* r25 */) {
    // Local variables
    int i; // r28
    struct xSphere * player_spheres[5]; // r1+0x8
    int num_spheres; // r0
    unsigned char hitIt; // r27
    int j; // r26
