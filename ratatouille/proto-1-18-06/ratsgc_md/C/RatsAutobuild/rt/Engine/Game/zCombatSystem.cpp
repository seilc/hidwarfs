/*
    ...
    Language: C++
    Code range: 0x80180AD8 -> 0x80180CA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$786zCombatSystem_cpp */ {
    // Members
...
union /* @class$805zCombatSystem_cpp */ {
...
// total size: 0xC
struct /* @class$804zCombatSystem_cpp */ {
    // Members
...
static struct xEnt * combatList[96]; // size: 0x180, address: 0x80390338
static unsigned int currentCombat; // size: 0x4, address: 0x803C34F8
// Range: 0x80180AD8 -> 0x80180AF8
