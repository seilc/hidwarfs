/*
    ...
    Language: C++
    Code range: 0x80136A6C -> 0x80137914
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zPad pads[6]; // size: 0xD8, address: 0x803888E0
static class zPad * debugPad; // size: 0x4, address: 0x803C2E88
static class zPad * dualControlPad; // size: 0x4, address: 0x803C2E8C
// Range: 0x80136A6C -> 0x80136AB8
...
// Range: 0x80136B80 -> 0x80136BA4
// this: r0
void zPad::Init() {}

// Range: 0x80136BA4 -> 0x80136C00
...
// Range: 0x80137054 -> 0x80137088
// this: r0
void zPad::DisablePad() {}

// Range: 0x80137088 -> 0x801370BC
// this: r0
void zPad::EnablePad() {}

// Range: 0x801370BC -> 0x80137198
...
// Range: 0x80137198 -> 0x801371B8
// this: r0
unsigned char zPad::Active() {}

// Range: 0x801371B8 -> 0x801371E8
// this: r0
void zPad::DeactivateTRC() {}

// Range: 0x801371E8 -> 0x80137210
// this: r0
void zPad::Clear() {
    // References
    // -> struct _tagxPad mPad[4];
...
// Range: 0x801377C4 -> 0x801377E4
float zPadAnalogControl::GetMag(float x /* f0 */, float y /* f0 */) {}

// Range: 0x801377E4 -> 0x80137828
// this: r31
