/*
    ...
    Language: C++
    Code range: 0x800E2C80 -> 0x800E30A0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$851zTransient_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$870zTransient_cpp */ {
    // Members
...
// Range: 0x800E2F1C -> 0x800E2F50
void scene_enter() {
    // Local variables
    struct xBox world_box; // r1+0x8
}

// Range: 0x800E2F50 -> 0x800E2F78
void scene_exit() {}

// Range: 0x800E2F78 -> 0x800E2F98
void setup() {}

// Range: 0x800E2F98 -> 0x800E2FC4
void reset() {}

// Range: 0x800E2FC4 -> 0x800E3000
void update(float dt /* f31 */) {}

// Range: 0x800E3000 -> 0x800E3028
void render() {}
...
// Range: 0x800E3028 -> 0x800E30A0
int check_damage(struct damage_result * results /* r0 */, const struct xBox & box /* r31 */, int max_results /* r0 */, int coll_type /* r0 */, int type_filter /* r0 */) {
    // Local variables
