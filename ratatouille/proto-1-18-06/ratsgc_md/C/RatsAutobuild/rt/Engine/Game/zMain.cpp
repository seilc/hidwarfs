/*
    ...
    Language: C++
    Code range: 0x800BB974 -> 0x800BDECC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x803C63C8
enum eFMVFile {
    eFMVFile_NoMovie = 0,
...
unsigned int FB_DEPTH; // size: 0x4, address: 0x803BE164
unsigned int SCENE_ID_MNU_INGAME; // size: 0x4, address: 0x803C207C
unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x803C2080
int GCN_DEMO_PARAM; // size: 0x4, address: 0x803C2084
enum _tagGameVidMode {
    eGameVidModeNTSC = 0,
    eGameVidModePAL = 1,
};
enum _tagGameVidMode gVidMode; // size: 0x4, address: 0x803C2088
// Range: 0x800BB974 -> 0x800BB980
void zMainSetPAL() {
    // References
    // -> enum _tagGameVidMode gVidMode;
}

// Range: 0x800BB980 -> 0x800BB98C
void zMainSetNTSC() {
    // References
    // -> enum _tagGameVidMode gVidMode;
}
...
float ShortbreadCookieJar; // size: 0x4, address: 0x803C208C
static int sShowMenuOnBoot; // size: 0x4, address: 0x803BE16C
// total size: 0x8
...
static struct st_SERIAL_PERCID_SIZE g_xser_sizeinfo[2]; // size: 0x10, address: 0x803BE170
static int gCountryCodeCount; // size: 0x4, address: 0x803C2090
static char gCountryCodes[4][3]; // size: 0xC, address: 0x803C2094
...
static float sAttractMode_timer; // size: 0x4, address: 0x803C20A0
static signed char init; // size: 0x1, address: 0x803C20A4
...
static void zMainLanguageSelection() {
    ...
    int highlighted; // r25
    const char * defaultRegion; // r20
    int i; // r21
    unsigned int countryHash; // r22
    struct RwTexture * texture; // r0
    struct RwRaster * background; // r24
    long long prevTime; // r23
    float dt; // f19
    unsigned char pressedA; // r21
    unsigned char pressedStart; // r20
    unsigned char pressedUp; // r19
    unsigned char pressedDown; // r18
    unsigned char pressedLeft; // r17
    unsigned char pressedRight; // r16
    unsigned char exitingFMV; // r31
...
// Range: 0x800BC32C -> 0x800BC6A0
void main(int argc /* r23 */, char * * argv /* r24 */) {
    // Local variables
    const char * ini; // r27
    int i; // r26
    const char * arg; // r25
    int j; // r25
    int i; // r25
    long long startFirstScreen; // r25
...
// Range: 0x800BC6A0 -> 0x800BC6C8
static void zMainOutputMgrSetup() {}

// Range: 0x800BC6C8 -> 0x800BC70C
static void zMainInitGlobals() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x800BC70C -> 0x800BCE94
static void zMainParseINIGlobals(struct xIniFile * ini /* r30 */) {
    // Local variables
    const char * SCENE_ID_MNU_START_TEXT; // r0
    const char * videosys; // r28
    char DEFAULT_REGION_NTSC[3]; // r1+0x10
    char DEFAULT_REGION_PAL[3]; // r1+0xC
    const char * defaultregion; // r29
    const char * iniString; // r31
    int idx; // r1+0x8
    int playerCount; // r27
...
// Range: 0x800BCE94 -> 0x800BCEB4
static void zMainMemLvlChkCB() {}

static unsigned int gameSceneID; // size: 0x4, address: 0x803C20A8
static signed char init; // size: 0x1, address: 0x803C20AC
static unsigned int menuModeID; // size: 0x4, address: 0x803C20B0
static signed char init; // size: 0x1, address: 0x803C20B4
// total size: 0x10
struct zVarEntry {
    // Members
...
int sFirstBoot; // size: 0x4, address: 0x803BE180
...
char * allsoaklevels[]; // size: 0x0, address: 0x8038DF80
...
// Range: 0x800BD888 -> 0x800BDACC
void zMainFirstScreen(int mode /* r27 */) {
    // Local variables
    struct RwCamera * cam; // r29
    struct RwRGBA bg; // r1+0x10
    int i; // r28
    const char * str; // r26
    class xtextbox tb; // r1+0xB8
    long long startTime; // r26
    float diffTime; // f0
...
// Range: 0x800BDACC -> 0x800BDAE0
void zMainMemCardSpaceQuery() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x800BDAE0 -> 0x800BDB18
...
// total size: 0x1
struct /* @class$775zMain_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$776zMain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$777zMain_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$778zMain_cpp */ {
    // Members
...
int percentageDone; // size: 0x4, address: 0x803C20B8
static class xtextbox backGroundTexture; // size: 0x74, address: 0x802DA098
static signed char init; // size: 0x1, address: 0x803C20BC
int sFirstBoot; // size: 0x4, address: 0x803BE180
// Range: 0x800BDB18 -> 0x800BDE30
