/*
    ...
    Language: C++
    Code range: 0x800B3CE8 -> 0x800B41B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
enum _GameOstrich gGameOstrich; // size: 0x4, address: 0x803C1E34
static unsigned int sGameMode_DispatchTable[12]; // size: 0x30, address: 0x803BE024
static unsigned int sGameState_DispatchTable[8]; // size: 0x20, address: 0x803BE054
static unsigned int sPauseState_DispatchTable[2]; // size: 0x8, address: 0x803BE074
static unsigned int sSaveState_DispatchTable[3]; // size: 0xC, address: 0x803BE07C
static unsigned int sOptionsState_DispatchTable[1]; // size: 0x4, address: 0x803BE088
static unsigned int sLoadState_DispatchTable[3]; // size: 0xC, address: 0x803BE08C
static unsigned int sTitleState_DispatchTable[2]; // size: 0x8, address: 0x803BE098
static unsigned int sIntroState_DispatchTable[4]; // size: 0x10, address: 0x803BE0A0
static unsigned int sGameState_DoDispatchTable[8]; // size: 0x20, address: 0x803BE0B0
static unsigned int sPauseState_DoDispatchTable[2]; // size: 0x8, address: 0x803BE0D0
static unsigned int sSaveState_DoDispatchTable[3]; // size: 0xC, address: 0x803BE0D8
static unsigned int sOptionsState_DoDispatchTable[1]; // size: 0x4, address: 0x803BE0E4
static unsigned int sLoadState_DoDispatchTable[3]; // size: 0xC, address: 0x803BE0E8
static unsigned int sTitleState_DoDispatchTable[2]; // size: 0x8, address: 0x803BE0F4
static unsigned int sIntroState_DoDispatchTable[4]; // size: 0x10, address: 0x803BE0FC
// Range: 0x800B3CE8 -> 0x800B3CF0
int zGameStateGet() {
    // References
    // -> int gGameState;
}

// Range: 0x800B3CF0 -> 0x800B3CF8
int zGameModeGet() {
    // References
    // -> enum eGameMode gGameMode;
}

// Range: 0x800B3CF8 -> 0x800B3D00
enum _GameOstrich zGameGetOstrich() {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

// Range: 0x800B3D00 -> 0x800B3D08
void zGameSetOstrich(enum _GameOstrich o /* r0 */) {
    // References
    // -> enum _GameOstrich gGameOstrich;
}

// Range: 0x800B3D08 -> 0x800B3D4C
int zGameStateFindEvent(unsigned int * array /* r0 */, int size /* r0 */, int mode /* r0 */, int event /* r0 */, int * ret_mode /* r0 */, int * ret_state /* r0 */) {
    // Local variables
    int i; // r10
}
...
// total size: 0x4
struct /* @class$828zGameState_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$846zGameState_cpp */ {
    // Members
...
// Range: 0x800B3D4C -> 0x800B3F34
void zGameStateSwitchEvent(int event /* r31 */) {
    // Local variables
    int cur_mode; // r0
    int cur_state; // r0
    int new_mode; // r1+0x10
    int new_state; // r1+0xC
    int startidx; // r1+0x8
    int port; // r0
...
// Range: 0x800B4030 -> 0x800B41B0
void zGameModeSwitch(enum eGameMode modeNew /* r30 */) {
    // Local variables
    enum eGameMode modeOld; // r4
