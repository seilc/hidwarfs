/*
    ...
    Language: C++
    Code range: 0x80181294 -> 0x80181664
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct /* @class$982zCineFXShared_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$786zCineFXShared_cpp */ {
    // Members
...
union /* @class$617zCineFXShared_cpp */ {
...
// total size: 0xC
struct /* @class$824zCineFXShared_cpp */ {
    // Members
...
// Range: 0x80181294 -> 0x80181664
void zCinFX_EntityBonePar_AR(struct NCINEntry * fxrec /* r25 */, struct RpAtomic * model /* r5 */, struct RwMatrixTag * animMat /* r24 */, unsigned int animIndex /* r0 */) {
    // Local variables
    float dt; // f31
