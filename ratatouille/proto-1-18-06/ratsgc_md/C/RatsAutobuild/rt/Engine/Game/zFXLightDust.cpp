/*
    ...
    Language: C++
    Code range: 0x80135D00 -> 0x80136544
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x803C2E80
// total size: 0x58
struct config {
    // Members
...
int system_id; // size: 0x4, address: 0x803BEA78
// total size: 0x28
