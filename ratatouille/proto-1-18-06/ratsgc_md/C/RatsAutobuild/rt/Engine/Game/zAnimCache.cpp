/*
    ...
    Language: C++
    Code range: 0x8008D5EC -> 0x8008D8CC
*/
static unsigned int cachedAnimations; // size: 0x4, address: 0x803C18F0
static struct zAnimCacheEntry cachedEntry[128]; // size: 0x600, address: 0x80354820
static unsigned int currentCacheIndex; // size: 0x4, address: 0x803C18F4
static struct xVec3 cache[2560]; // size: 0x7800, address: 0x80354E20
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$785zAnimCache_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zAnimCache_cpp */ {
    // Members
