/*
    ...
    Language: C++
    Code range: 0x8015375C -> 0x80153B0C
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
// total size: 0x50
struct {} zUICustomVolume::__vtable; // size: 0x50, address: 0x802DD668
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x8015387C -> 0x80153884
unsigned char zUICustomVolume::PreRender() {}

// Range: 0x80153884 -> 0x80153920
// this: r28
...
// Range: 0x80153AC4 -> 0x80153AE8
// this: r3
float zUICustomVolume::GetVolume() const {}

// Range: 0x80153AE8 -> 0x80153B0C
// this: r3
