/*
    ...
    Language: C++
    Code range: 0x801B7B98 -> 0x801B8C5C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x803C3B00
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x803C3B04
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x803C3B08
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x803C3B0C
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x803C3B10
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x803C3B14
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x803C3B18
static unsigned int PUFF_MODEL_IDS[5]; // size: 0x14, address: 0x803C0148
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801B80F4 -> 0x801B81F0
// this: r0
void zMiniGamePufferoidsPuff::ProjectileHit(int owner /* r0 */, int value /* r0 */) {}

// Range: 0x801B81F0 -> 0x801B81FC
// this: r0
void zMiniGamePufferoidsPuff::Kill() {}

// total size: 0x78
struct {} zMiniGamePufferoids::__vtable; // size: 0x78, address: 0x802E46D8
// total size: 0x34
...
static char statsBuf[4][128]; // size: 0x200, address: 0x80396E80
// Range: 0x801B876C -> 0x801B8ABC
// this: r31
