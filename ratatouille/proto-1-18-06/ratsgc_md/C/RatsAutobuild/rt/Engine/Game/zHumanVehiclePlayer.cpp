/*
    ...
    Language: C++
    Code range: 0x80194B44 -> 0x801957F8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int lastUsedPadMRI; // size: 0x4, address: 0x803BF4F4
static struct compositeEffect rumbleEffects[3]; // size: 0xF0, address: 0x80390910
// total size: 0xBB0
...
// Range: 0x80195038 -> 0x801950BC
// this: r31
void zHumanVehiclePlayer::DefaultUpdate(float dt /* f31 */) {}

// Range: 0x801950BC -> 0x801950DC
// this: r0
...
// total size: 0x124
struct {} zHumanVehiclePlayer::__vtable; // size: 0x124, address: 0x802E0DF8
// total size: 0xC
