/*
    ...
    Language: C++
    Code range: 0x801A3A48 -> 0x801A4324
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float RB_PLSBOUND_MIDRADIUS; // size: 0x4, address: 0x803BF8DC
float RB_boundYShift; // size: 0x4, address: 0x803BF8E0
static int lastUsedPadMRI; // size: 0x4, address: 0x803BF8E4
static struct compositeEffect rumbleEffects[3]; // size: 0xF0, address: 0x80394DB8
// total size: 0xB60
struct zRatBallPlayer : public zPlayer {
    ...
    // Members
    float modelYaw; // offset 0xB10, size 0x4
    unsigned char isOn; // offset 0xB14, size 0x1
    class zInteraction * currAction; // offset 0xB18, size 0x4
private:
    unsigned int * atomics_order; // offset 0xB1C, size 0x4
    unsigned int atomics_count; // offset 0xB20, size 0x4
    struct xVec3 bone_adjust; // offset 0xB24, size 0xC
    struct xVec3 prev_at; // offset 0xB30, size 0xC
    struct xVec3 prev_bi_normal; // offset 0xB3C, size 0xC
    float x_lean; // offset 0xB48, size 0x4
    float y_lean; // offset 0xB4C, size 0x4
    float last_sign; // offset 0xB50, size 0x4
    unsigned int modelRender; // offset 0xB54, size 0x4
};
// Range: 0x801A3A48 -> 0x801A3A94
// this: r31
...
// total size: 0x4
struct /* @class$786zRatBallPlayer_cpp */ {
    // Members
...
union /* @class$805zRatBallPlayer_cpp */ {
...
// total size: 0x4
struct /* @class$1185zRatBallPlayer_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1186zRatBallPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1187zRatBallPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1184zRatBallPlayer_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1189zRatBallPlayer_cpp */ {
    // Members
...
// Range: 0x801A3C3C -> 0x801A3C5C
// this: r0
void zRatBallPlayer::SceneSetup() {}

// Range: 0x801A3C5C -> 0x801A3CA8
// this: r31
void zRatBallPlayer::Reset() {}

// Range: 0x801A3CA8 -> 0x801A3DF0
// this: r31
...
// Range: 0x801A3DF0 -> 0x801A3E54
// this: r31
void zRatBallPlayer::DefaultUpdate(float dt /* f31 */) {}

// Range: 0x801A3E54 -> 0x801A3E74
// this: r0
...
// total size: 0xC
struct /* @class$804zRatBallPlayer_cpp */ {
    // Members
...
// total size: 0x124
struct {} zRatBallPlayer::__vtable; // size: 0x124, address: 0x802E3BA0
// total size: 0xC
