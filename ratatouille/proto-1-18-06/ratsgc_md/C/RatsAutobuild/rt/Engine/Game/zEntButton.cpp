/*
    ...
    Language: C++
    Code range: 0x8009EC6C -> 0x8009F894
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sRedMultiplier; // size: 0x4, address: 0x803BDD88
static float sGreenMultiplier; // size: 0x4, address: 0x803BDD8C
static float sBlueMultiplier; // size: 0x4, address: 0x803BDD90
// Range: 0x8009EC6C -> 0x8009EC8C
...
// total size: 0x4
struct /* @class$786zEntButton_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$806zEntButton_cpp */ {
    // Members
...
// Range: 0x8009EC8C -> 0x8009EE20
void zEntButton_Init(struct _zEntButton * ent /* r30 */, struct xEntAsset * asset /* r29 */) {
    // Local variables
    struct zEntButtonAsset * passet; // r3
...
// Range: 0x8009F5A0 -> 0x8009F894
void zEntButtonEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r5 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
    struct _zEntButton * s; // r31
    union FloatAndVoid dist; // r1+0x8
    struct zShrapnelAsset * shrap; // r3
