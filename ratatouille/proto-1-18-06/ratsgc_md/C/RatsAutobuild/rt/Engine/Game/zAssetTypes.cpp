/*
    ...
    Language: C++
    Code range: 0x8008DD9C -> 0x8008F2F8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct PKRAssetType assetTypeHandlers[101]; // size: 0xFC8, address: 0x802D41F0
// total size: 0xC
...
struct BrainTableEntry g_brainTable[23]; // size: 0x114, address: 0x802D51B8
static unsigned char initialized; // size: 0x1, address: 0x803C1908
static signed char init; // size: 0x1, address: 0x803C1909
enum eBrainType {
...
// Range: 0x8008DD9C -> 0x8008DE68
enum eBrainType GetBrainType(unsigned int brainNameHash /* r27 */) {
    // Local variables
    int i; // r28
    int i; // r0
...
// Range: 0x8008DE68 -> 0x8008DE94
void zAssetStartup() {
    // References
    // -> static struct PKRAssetType assetTypeHandlers[101];
}

// Range: 0x8008DE94 -> 0x8008DEB4
void zAssetShutdown() {}
...
// Range: 0x8008DEB4 -> 0x8008DF1C
static void * Model_Read(void * indata /* r5 */, unsigned int insize /* r6 */, unsigned int * outsize /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$794zAssetTypes_cpp */ {
    // Members
...
// Range: 0x8008E3D8 -> 0x8008E500
static void * BSP_Read(void * indata /* r30 */, unsigned int insize /* r29 */, unsigned int * outsize /* r31 */) {
    // Local variables
...
union /* @class$813zAssetTypes_cpp */ {
...
static struct xJSPHeader sDummyEmptyJSP; // size: 0x2C, address: 0x803C190C
static struct xJSPHeader * sTempJSP; // size: 0x4, address: 0x803C1938
// Range: 0x8008E530 -> 0x8008E5A4
static void * JSP_Read(unsigned int assetid /* r4 */, void * indata /* r5 */, unsigned int insize /* r7 */, unsigned int * outsize /* r30 */) {
    // Local variables
...
// Range: 0x8008E5A4 -> 0x8008E5D0
static void JSP_Unload(void * userdata /* r0 */) {
    // References
    // -> static struct xJSPHeader sDummyEmptyJSP;
}

// Range: 0x8008E5D0 -> 0x8008E5E4
...
struct AnimTableList animTable[2]; // size: 0x18, address: 0x803BDCA0
// Range: 0x8008E774 -> 0x8008E7C4
...
static struct xAnimTable * (* tableFuncList[1])(); // size: 0x4, address: 0x803BDCB8
// Range: 0x8008E7C4 -> 0x8008E7CC
static unsigned int dummyEffectCB() {}

// Range: 0x8008E7CC -> 0x8008E890
static unsigned int soundEffectCB(unsigned int cbenum /* r28 */, struct xAnimActiveEffect * acteffect /* r29 */, void * object /* r30 */) {
    // Local variables
    unsigned int sndhandle; // r31
...
static unsigned int (* effectFuncList[3])(unsigned int, struct xAnimActiveEffect *, struct xAnimSingle *, void *); // size: 0xC, address: 0x803BDCBC
// Range: 0x8008E890 -> 0x8008E8B4
static void * FindAssetCB(unsigned int ID /* r0 */) {
    // Local variables
    unsigned int size; // r1+0x8
}

static struct zPlayer * player; // size: 0x4, address: 0x803C193C
static signed char init; // size: 0x1, address: 0x803C1940
unsigned int gxAnimUseGrowAlloc; // size: 0x4, address: 0x803C0C58
...
// Range: 0x8008E8B4 -> 0x8008F0AC
static void * ATBL_Read(unsigned int assetid /* r25 */, void * indata /* r31 */, unsigned int * outsize /* r27 */) {
    // Local variables
    unsigned int i; // r23
    unsigned int j; // r0
    unsigned int tmpsize; // r1+0x8
    struct xAnimTable * table; // r26
    struct xAnimState * astate; // r0
    unsigned char * zaBytes; // r0
    struct xAnimAssetTable * zaTbl; // r0
    void * zaRaw; // r26
    struct xAnimAssetFile * zaFile; // r30
    struct xAnimAssetState * zaState; // r29
    int k; // r0
    int num_raw_data; // r0
    struct xAnimFile * * fList; // r0
    const char * animation_name; // r22
    ...
    struct xAnimState * endState; // r30
    ...
    struct xAnimAssetEffect * zaEffect; // r21
...
// total size: 0x4
struct /* @class$1241zAssetTypes_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1192zAssetTypes_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1193zAssetTypes_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1194zAssetTypes_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1191zAssetTypes_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1196zAssetTypes_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1299zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$724zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$725zAssetTypes_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$726zAssetTypes_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$727zAssetTypes_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$728zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$729zAssetTypes_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$730zAssetTypes_cpp */ {
    // Members
