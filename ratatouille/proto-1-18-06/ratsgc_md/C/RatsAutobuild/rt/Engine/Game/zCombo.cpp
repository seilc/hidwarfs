/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zCombo.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012B724 -> 0x8012B790
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct widget_chunk * comboHUD; // size: 0x4, address: 0x803C2DF0
enum zComboType {
...
static unsigned char sComboIsPaused; // size: 0x1, address: 0x803C2DF4
// Range: 0x8012B728 -> 0x8012B790
void zCombo_Paused() {
    // References
