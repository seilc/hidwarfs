/*
    ...
    Language: C++
    Code range: 0x801B1B00 -> 0x801B1C8C
*/
signed char zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C3A10
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C3A14
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B1B7C -> 0x801B1B9C
// this: r0
void zNPCLeftArm::Deactivate() {}

// Range: 0x801B1B9C -> 0x801B1C4C
// this: r28
...
// total size: 0x3C
struct {} zNPCLeftArm::__vtable; // size: 0x3C, address: 0x803BFCE8
