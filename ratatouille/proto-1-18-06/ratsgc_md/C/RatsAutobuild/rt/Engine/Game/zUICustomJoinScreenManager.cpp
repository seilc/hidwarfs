/*
    ...
    Language: C++
    Code range: 0x8014CC20 -> 0x8014CF28
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8014CC20 -> 0x8014CC24
static void zSystemEventCB() {}

static unsigned char bJoinDropActionConfirmed; // size: 0x1, address: 0x803C2F7C
// total size: 0x50
struct {} zUICustomJoinScreenManager::__vtable; // size: 0x50, address: 0x802DD4A8
// total size: 0x14
