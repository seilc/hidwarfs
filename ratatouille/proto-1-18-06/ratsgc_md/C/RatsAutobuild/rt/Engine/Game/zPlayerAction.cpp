/*
    ...
    Language: C++
    Code range: 0x80145728 -> 0x80145EF8
*/
// total size: 0xC
class zPlayerAction {
    // Functions
...
// total size: 0x4
struct /* @class$786zPlayerAction_cpp */ {
    // Members
...
union /* @class$805zPlayerAction_cpp */ {
...
// total size: 0xC
struct /* @class$804zPlayerAction_cpp */ {
    // Members
...
// Range: 0x80145E4C -> 0x80145E8C
// this: r0
void zPlayerActionManager::AddStandardTransitionsTo(unsigned int actionID /* r0 */, struct xAnimTable * table /* r5 */, const char * fromStates /* r6 */) {}

// Range: 0x80145E8C -> 0x80145ED8
// this: r0
void zPlayerActionManager::AddTransitionsTo(unsigned int actionID /* r0 */, struct xAnimTable * table /* r5 */, const char * fromStates /* r6 */, unsigned short priority /* r7 */, float blend /* f0 */, unsigned int flags /* r8 */, unsigned int userFlags /* r9 */) {}

// Range: 0x80145ED8 -> 0x80145EE8
// this: r0
class zPlayerAction * zPlayerActionManager::GetAction(unsigned int actionID /* r0 */) {}

// Range: 0x80145EE8 -> 0x80145EF8
// this: r0
class zPlayerAction * zPlayerActionManager::GetAction(unsigned int actionID /* r0 */) const {}

// total size: 0x50
struct {} zPlayerAction::__vtable; // size: 0x50, address: 0x802DD458
