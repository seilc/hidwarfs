/*
    ...
    Language: C++
    Code range: 0x800B342C -> 0x800B3BEC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int g_enableGameExtras; // size: 0x4, address: 0x803C1E10
static int g_currDay; // size: 0x4, address: 0x803C1E14
static int g_currMonth; // size: 0x4, address: 0x803C1E18
static int g_gameExtraFlags; // size: 0x4, address: 0x803C1E1C
// total size: 0x4
struct EGGMisc {
    // Members
...
static struct EGGItemFuncs EGGEmpty; // size: 0x10, address: 0x803BDE90
static struct EGGItem g_eggBasket[2]; // size: 0x20, address: 0x803BDEA0
// Range: 0x800B342C -> 0x800B34D8
...
// total size: 0x4
struct /* @class$786zGameExtras_cpp */ {
    // Members
...
union /* @class$717zGameExtras_cpp */ {
...
// total size: 0xC
struct /* @class$806zGameExtras_cpp */ {
    // Members
...
static int g_flg_chEnabled; // size: 0x4, address: 0x803C1E20
// Range: 0x800B3860 -> 0x800B386C
...
// Range: 0x800B386C -> 0x800B3894
void zGameExtras_Save(struct xSerial * xser /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

// Range: 0x800B3894 -> 0x800B38D0
...
static float sCheatTimer; // size: 0x4, address: 0x803C1E24
static int sCheatInputCount; // size: 0x4, address: 0x803C1E28
unsigned int sCheatTestCheats[16]; // size: 0x40, address: 0x803BDEC0
unsigned int sCheatSwapCCLR[16]; // size: 0x40, address: 0x803BDF00
unsigned int sCheatSwapCCUD[16]; // size: 0x40, address: 0x803BDF40
// total size: 0x10
struct GECheat {
    // Members
...
static struct GECheat cheatList[4]; // size: 0x40, address: 0x803BDF80
unsigned int sCheatPressed[16]; // size: 0x40, address: 0x803BDFC0
// Range: 0x800B38D0 -> 0x800B391C
static int TestCheat(unsigned int * cheat_info /* r0 */) {
    // Local variables
    int i; // r0
...
void zGameCheatsUpdate(float dt /* f31 */) {
    ...
    int i; // r1+0x8
    int match; // r30
    struct GECheat * rec_next; // r31
    struct GECheat * rec_curr; // r29
    int rc; // r0
...
// Range: 0x800B3B40 -> 0x800B3B50
void GEC_CheatFlagAdd(int flg /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

// Range: 0x800B3B50 -> 0x800B3B60
void GEC_CheatFlagToggle(int flg /* r0 */) {
    // References
    // -> static int g_flg_chEnabled;
}

static unsigned int aid_sndList[7]; // size: 0x1C, address: 0x803BE000
// Range: 0x800B3B60 -> 0x800B3B8C
static void GEC_dfltSound() {
    // References
    // -> static unsigned int aid_sndList[7];
}

// Range: 0x800B3B8C -> 0x800B3BAC
static void GEC_cb_TestCheats() {}

// Range: 0x800B3BAC -> 0x800B3BCC
static void GEC_cb_SwapCCLR() {}

// Range: 0x800B3BCC -> 0x800B3BEC
