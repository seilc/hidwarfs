/*
    ...
    Language: C++
    Code range: 0x800E3168 -> 0x800E5138
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char bAllowInput; // size: 0x1, address: 0x803BE380
unsigned char bAllowSelectInput; // size: 0x1, address: 0x803BE381
// Range: 0x800E3168 -> 0x800E3194
...
static void * (* staticAllocator)(unsigned int, void *); // size: 0x4, address: 0x803C2390
static void * staticUser; // size: 0x4, address: 0x803C2394
static void (* signalHandler)(class zUI *, unsigned int, unsigned int, float *, struct xBase *, unsigned int, void *); // size: 0x4, address: 0x803C2398
static void * signalUser; // size: 0x4, address: 0x803C239C
static int padPortInitiatedPause; // size: 0x4, address: 0x803BE384
static int playersActiveAtInitiatedPause; // size: 0x4, address: 0x803C23A0
// Range: 0x800E3194 -> 0x800E319C
void zUISetActivePlayersAtInitiatedPause(int value /* r0 */) {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x800E319C -> 0x800E31A4
int zUIGetActivePlayersAtInitiatedPause() {
    // References
    // -> static int playersActiveAtInitiatedPause;
}

// Range: 0x800E31A4 -> 0x800E31AC
void zUISetPadPortInitiatedPause(int port /* r0 */) {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x800E31AC -> 0x800E31B4
int zUIGetPadPortInitiatedPause() {
    // References
    // -> static int padPortInitiatedPause;
}

// Range: 0x800E31B4 -> 0x800E321C
void zUI_Init(class zUI * text /* r30 */, struct zUIAsset * asset /* r31 */) {}

// Range: 0x800E321C -> 0x800E3224
...
// Range: 0x800E3448 -> 0x800E34F4
// this: r31
void zUI::DoInit() {}

// Range: 0x800E34F4 -> 0x800E34F8
void zUI::DoSetup() {}

// Range: 0x800E34F8 -> 0x800E3580
// this: r31
void zUI::DoReset() {}

// Range: 0x800E3580 -> 0x800E3608
// this: r31
void zUI::DoResetMotion() {}

// Range: 0x800E3608 -> 0x800E399C
// this: r31
...
unsigned char gPassAnyActveController; // size: 0x1, address: 0x803C2E22
// total size: 0x30
class xfont {
    // Members
public:
...
class zUICustomControllerManager * pUICustomControllerManager; // size: 0x4, address: 0x803C35C0
enum _tagTRCState {
    TRC_Unknown = 0,
    TRC_PadMissing = 1,
    TRC_PadInserted = 2,
...
// Range: 0x800E3FD8 -> 0x800E3FDC
void zUI::DoExit() {}

// Range: 0x800E3FDC -> 0x800E402C
// this: r31
void zUI::StopMotion() {}

// Range: 0x800E402C -> 0x800E40B8
// this: r29
void zUI::RunMotion(struct zUIMotionAsset * asset /* r30 */, unsigned char loop /* r31 */, unsigned char reset /* r0 */) {}

// Range: 0x800E40B8 -> 0x800E4138
// this: r0
float zUI::CalcAcceleratedDistance(float totalDistance /* f0 */, float startTime /* f0 */, float endTime /* f0 */, float accelTime /* f0 */, float decelTime /* f0 */) {
    // Local variables
    float timePassed; // f10
    float timeLength; // f11
    float topVelocity; // f3
    float curDistance; // f1
    float timeToEnd; // f1
}
...
// Range: 0x800E4AF0 -> 0x800E4B1C
// this: r4
void zUI::DoInitMotion() {}

// Range: 0x800E4B8C -> 0x800E4C64
// this: r30
void zUI::DoApplyMotionFrame(const struct zUIMotionFrame * frame /* r31 */) {}

unsigned char gDontAutoMenu; // size: 0x1, address: 0x803C2E20
// Range: 0x800E4C64 -> 0x800E4E48
// this: r26
...
// Range: 0x800E4E48 -> 0x800E4EA8
// this: r31
void zUI::FocusOn() {}

// Range: 0x800E4EA8 -> 0x800E4F08
// this: r31
void zUI::FocusOff() {}

// Range: 0x800E4F08 -> 0x800E4F58
// this: r31
void zUI::Visible() {}

// Range: 0x800E4F58 -> 0x800E4FA0
// this: r31
void zUI::Invisible() {}

// Range: 0x800E4FA0 -> 0x800E503C
// this: r30
void zUI::Select() {}

// Range: 0x800E503C -> 0x800E50D8
// this: r30
void zUI::Unselect() {}

unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x800E50D8 -> 0x800E5120
...
// total size: 0x60
struct {} zUI::__vtable; // size: 0x60, address: 0x802DBAF0
