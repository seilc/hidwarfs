/*
    ...
    Language: C++
    Code range: 0x800BFC30 -> 0x800C2110
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNotSentPoolCreatedEvent; // size: 0x1, address: 0x803BE1B0
// total size: 0x14
...
struct zNPCMgrGroupTarget gNPCMgrGroupTarget; // size: 0x14, address: 0x803C20F8
// total size: 0xC
struct xModelPool {
    // Members
...
struct zNPCMgrIncidental gNPCIncidental[1]; // size: 0x14, address: 0x803C210C
// total size: 0x10
...
struct zSurroundedBy gSurroundedBy[32]; // size: 0x200, address: 0x8036A590
int gSurroundedByTotal; // size: 0x4, address: 0x803C2120
float zNPCFreezeTimeTable[3][2]; // size: 0x18, address: 0x803C2124
float zNPCThawTimeTable[3][2]; // size: 0x18, address: 0x803C213C
// total size: 0x14
struct creationData {
    // Members
    void (* createTable)(struct xAnimTable *); // offset 0x0, size 0x4
    void (* initCombatDamage)(); // offset 0x4, size 0x4
    class zNPCInstance * (* createInstance)(void *, struct xModelAssetInfo *, unsigned int, struct zNPCAssetIN2 *, int); // offset 0x8, size 0x4
    unsigned int instanceSize; // offset 0xC, size 0x4
    unsigned int dataSize; // offset 0x10, size 0x4
};
static struct creationData g_creationData[3]; // size: 0x3C, address: 0x803BE1B4
// Range: 0x800BFC30 -> 0x800BFC94
...
// Range: 0x800BFC94 -> 0x800BFCF8
static class zNPCInstance * create(void * object /* r3 */, const struct xModelAssetInfo * model_asset /* r28 */, unsigned int type /* r29 */, struct zNPCAssetIN2 * npc_asset /* r30 */, int npc_asset_size /* r31 */) {}

// total size: 0xC
struct {} zNPCChef::inst_type::__vtable; // size: 0xC, address: 0x803BE208
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0xC
struct {} zNPCThiefOld::inst_type::__vtable; // size: 0xC, address: 0x803BE1FC
// total size: 0x98
class inst_type : public zNPCInstance {};
// total size: 0x60
...
// total size: 0x4
struct /* @class$1251zNPCMgr_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1252zNPCMgr_cpp */ {
    // Members
...
static int g_poolSize[3]; // size: 0xC, address: 0x803BE1F0
static int g_modinit; // size: 0x4, address: 0x803C2154
static struct zNPCMgr * g_npcmgr; // size: 0x4, address: 0x803C2158
// Range: 0x800BFCF8 -> 0x800BFD18
...
// Range: 0x800BFD18 -> 0x800C0154
static void event_wrapper(struct xBase * from /* r25 */, struct xBase * to /* r31 */, unsigned int toEvent /* r26 */, const float * toParam /* r27 */, struct xBase * toParamWidget /* r28 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
...
// Range: 0x800C0298 -> 0x800C02BC
void zNPCMgr_sceneInit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C02BC -> 0x800C02E0
void zNPCMgr_sceneSetup() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C02E0 -> 0x800C0304
void zNPCMgr_sceneFinish() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0304 -> 0x800C0328
void zNPCMgr_sceneExit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0328 -> 0x800C034C
void zNPCMgr_sceneReset() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C034C -> 0x800C0370
void zNPCMgr_scenePostInit() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0370 -> 0x800C03B4
...
// Range: 0x800C0470 -> 0x800C0494
void zNPCMgr_sceneRender() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0494 -> 0x800C04B8
void zNPCMgr_sceneRenderFreezing() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C04B8 -> 0x800C04DC
void zNPCMgr_scenePostRender() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C04DC -> 0x800C0500
void zNPCMgr_scenePostRenderCleanup() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0500 -> 0x800C0524
int zNPCMgr_preCreateNPCs() {
    // Local variables
    struct zNPCMgr * mgr; // r0
}

// Range: 0x800C0524 -> 0x800C0568
...
// Range: 0x800C0568 -> 0x800C0580
// this: r0
void zNPCMgr::Startup() {}

// Range: 0x800C0580 -> 0x800C0584
void zNPCMgr::Shutdown() {}

// Range: 0x800C0584 -> 0x800C0714
// this: r31
...
static struct xVec3 sNPCMgrSortCamPosition; // size: 0xC, address: 0x803C215C
// Range: 0x800C0BF8 -> 0x800C0C34
...
// Range: 0x800C0D34 -> 0x800C0F48
// this: r30
void zNPCMgr::ScenePostInit() {
    // Local variables
    const struct zNPCTypeInfoIN2 * npctype; // r28
    enum en_npctyp type; // r31+0x10
    class zNPCInstance * * instanceArray; // r27
    int i; // r26
    class zNPCBaseIN2 * data; // r4
...
// Range: 0x800C1350 -> 0x800C1354
void zNPCMgr::PreCreate() {}

// Range: 0x800C1354 -> 0x800C13AC
// this: r31
void zNPCMgr::PostCreate(class zNPCInstance * npc /* r0 */) {}

// Range: 0x800C13AC -> 0x800C1448
// this: r23
...
// Range: 0x800C1448 -> 0x800C1470
// this: r0
class zNPCInstance * zNPCMgr::GetInstance(enum en_npctyp type /* r0 */, int index /* r0 */) {
    // References
    // -> static struct creationData g_creationData[3];
}

// Range: 0x800C1470 -> 0x800C1498
// this: r0
class zNPCBaseIN2 * zNPCMgr::GetData(enum en_npctyp type /* r0 */, int index /* r0 */) {
    // References
    // -> static struct creationData g_creationData[3];
}

// Range: 0x800C1498 -> 0x800C1568
// this: r29
struct xBase * zNPCMgr::CreateDynNPC(const struct xEntAsset * ent_asset /* r27 */, const struct xDynAsset * dyn_asset /* r30 */, int siz_dynass /* r31 */) {
    // Local variables
    unsigned int size; // r1+0x8
    unsigned int aid_minf; // r0
    void * thing; // r3
    const struct xModelAssetInfo * modelInfoAsset; // r28
    enum en_npctyp nt; // r27
    int prevCount; // r5
...
// Range: 0x800C1568 -> 0x800C163C
// this: r22
int zNPCMgr::FindFreeData(class zNPCBaseIN2 * * array /* r23 */, enum en_npctyp type /* r24 */, const struct xVec3 & pos /* r25 */) {
    // Local variables
    int count; // r28
    int i; // r27
    class zNPCBaseIN2 * data; // r0
    class zNPCInstance * inst; // r26
    float dist2; // f0
}

struct xGlobals * xglobals; // size: 0x4, address: 0x803BE168
// Range: 0x800C163C -> 0x800C170C
...
// Range: 0x800C18F8 -> 0x800C191C
static class zNPCBaseIN2 * * pushTempArray(int size /* r3 */) {}

// Range: 0x800C191C -> 0x800C1DEC
// this: r30
void zNPCMgr::SceneTimestep(struct xScene * xscn /* r31 */, float dt /* f29 */) {
    ...
    const struct xVec3 & centerPos; // r29
    unsigned char NPCInUpdateRange; // r28
    enum en_npctyp type; // r1+0x18
    int freeIndex; // r27
    int freeCount; // r26
    class zNPCBaseIN2 * * freeArray; // r25
    int i; // r24
    class zNPCInstance * inst; // r23
    float update_dist; // f0
    float dist; // f0
...
// Range: 0x800C1DEC -> 0x800C1DF8
void zNPCMgr_SurroundedReset() {
    // References
    // -> int gSurroundedByTotal;
}

// Range: 0x800C1DF8 -> 0x800C1FF8
void zNPCMgr_SurroundedUpdate() {
    // Local variables
    int a; // r28
    struct zSurroundedBy * npcA; // r27
    int b; // r26
    struct zSurroundedBy * npcB; // r25
