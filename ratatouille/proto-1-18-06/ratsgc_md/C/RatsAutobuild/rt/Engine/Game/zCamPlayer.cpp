/*
    ...
    Language: C++
    Code range: 0x80169CD0 -> 0x8016C904
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sCamPlayerTweakMountMinOffset; // size: 0x4, address: 0x803C3250
// Range: 0x80169CD0 -> 0x80169DD0
static void bound_sphere_xz(float & Ax /* r28 */, float & Az /* r29 */, float & Bx /* r30 */, float & Bz /* r31 */, float Cx /* f26 */, float Cz /* f27 */, float r /* f28 */, float Vx /* f29 */, float Vz /* f30 */, float d /* f0 */) {
    // Local variables
    float rd; // f31
    float w1; // f0
    float w2; // f2
...
// total size: 0x14
struct /* @class$821zCamPlayer_cpp */ {
    // Members
...
// total size: 0x30
struct /* @class$822zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$823zCamPlayer_cpp */ {
    // Members
...
// total size: 0x6C
struct /* @class$824zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$825zCamPlayer_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$826zCamPlayer_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$828zCamPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$829zCamPlayer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$888zCamPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$906zCamPlayer_cpp */ {
    // Members
...
// Range: 0x8016A590 -> 0x8016A66C
// this: r31
void zCamPlayer::reset_zone() {}

// Range: 0x8016A690 -> 0x8016A7A0
// this: r31
...
// Range: 0x8016A924 -> 0x8016A928
void zCamPlayer::reset_drift() {}

// Range: 0x8016A928 -> 0x8016A944
// this: r0
void zCamPlayer::reset_input() {}

// Range: 0x8016A944 -> 0x8016A954
// this: r0
void zCamPlayer::reset_aggression() {}

// Range: 0x8016A954 -> 0x8016A994
// this: r31
void zCamPlayer::reset_pitch() {}

// Range: 0x8016A994 -> 0x8016AC70
// this: r30
...
// Range: 0x8016B300 -> 0x8016B500
// this: r31
void zCamPlayer::update_zone_dist(float dt /* f0 */) {
    // Local variables
    float dist_away; // f30
    float ddist; // f31
    float dxz; // f1
...
// Range: 0x8016C444 -> 0x8016C47C
// this: r31
void zCamPlayer::update_fov() {}

// Range: 0x8016C47C -> 0x8016C55C
// this: r31
...
// Range: 0x8016C8F4 -> 0x8016C8FC
float zCamPlayer::get_default_blend_speed_rest_dist() {}

// Range: 0x8016C8FC -> 0x8016C904
float zCamPlayer::get_default_blend_speed_collide_dist() {}

// total size: 0x40
struct {} zCamPlayer::__vtable; // size: 0x40, address: 0x803BEFF0
// total size: 0x0
