/*
    ...
    Language: C++
    Code range: 0x8008F3B0 -> 0x8008FA0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gCheatBouncyHenchmen; // size: 0x1, address: 0x803C194A
unsigned char gCheatExtraShrapnel; // size: 0x1, address: 0x803C194B
static float cheatTimer; // size: 0x4, address: 0x803C194C
static float headScale; // size: 0x4, address: 0x803BDCC8
static float targetHead; // size: 0x4, address: 0x803BDCCC
static float discoTimer; // size: 0x4, address: 0x803C1950
static const char * cheatName; // size: 0x4, address: 0x803C1954
// total size: 0x18
...
// total size: 0x4
struct /* @class$1204zCheat_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1205zCheat_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
static struct Cheat cheats[11]; // size: 0x58, address: 0x802D52F0
static char unlock_clear[32]; // size: 0x20, address: 0x803BDCD0
// Range: 0x8008F6D8 -> 0x8008F764
void zCheatInit() {
    // Local variables
    unsigned int UNLOCK_INDEX; // r5
    char * uncrypt; // r6
    const char * crypt; // r7
    char last; // r8
...
// Range: 0x8008F968 -> 0x8008F970
float zCheatGetHeadScale() {
    // References
    // -> static float headScale;
}

// Range: 0x8008F970 -> 0x8008FA0C
enum zCheatStatus zCheatProcess(const char * name /* r26 */) {
    // Local variables
    int low; // r29
    int high; // r28
    int mid; // r27
