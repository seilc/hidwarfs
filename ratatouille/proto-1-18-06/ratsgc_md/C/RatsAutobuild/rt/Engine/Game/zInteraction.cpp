/*
    ...
    Language: C++
    Code range: 0x80107384 -> 0x80109ED4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sAlphaUpRate; // size: 0x4, address: 0x803BE508
static float sAlphaDownRate; // size: 0x4, address: 0x803BE50C
static float sMaxDrawDist2; // size: 0x4, address: 0x803BE510
static float sMinDrawAlpha; // size: 0x4, address: 0x803BE514
static float sMaxDrawAlpha; // size: 0x4, address: 0x803BE518
static float sLogoAngle; // size: 0x4, address: 0x803C2930
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static float sLaunchMaxDist2; // size: 0x4, address: 0x803BE51C
static float sLaunchHalfYawRange; // size: 0x4, address: 0x803BE520
static float sLaunchFlipLength; // size: 0x4, address: 0x803BE524
static float sLaunchReelInBeginPull; // size: 0x4, address: 0x803BE528
static float sLaunchReelInBeginBounce; // size: 0x4, address: 0x803C2934
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$805zInteraction_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$823zInteraction_cpp */ {
    // Members
...
union /* @class$824zInteraction_cpp */ {
...
// Range: 0x80107384 -> 0x801073A4
void zInteraction_SceneInit(struct zScene * zsc /* r0 */) {}

// Range: 0x801073A4 -> 0x801073D8
...
void zInteraction_Update(float dt /* f31 */) {
    ...
    int i; // r27
    class zHeistLookoutPoint * lookoutList; // r27
    int i; // r28
    class zHeistDistractionObject * distractList; // r27
    int i; // r28
    class zLaunch * launchList; // r27
    int i; // r28
...
// Range: 0x801074F4 -> 0x80107604
void zInteraction_Render() {
    // Local variables
    int count; // r30
    struct zScene * zsc; // r29
    unsigned char wasBright; // r28
    class zSwitchLever * switchList; // r27
    int i; // r26
    class zHeistLookoutPoint * lookoutList; // r26
    int i; // r27
    class zHeistDistractionObject * distractList; // r26
    int i; // r27
    class zLaunch * launchList; // r26
    int i; // r27
...
// total size: 0x14
struct {} zInteraction::__vtable; // size: 0x14, address: 0x803BE568
// total size: 0x14
...
// Range: 0x80107644 -> 0x80107668
// this: r0
void zInteraction::Reset() {}

// Range: 0x80107668 -> 0x801076AC
// this: r31
void zInteraction::Stop() {}

// total size: 0x14
struct {} zTriggerInteraction::__vtable; // size: 0x14, address: 0x803BE554
// total size: 0x50
...
// total size: 0xC
struct /* @class$1283zInteraction_cpp */ {
    // Members
...
// Range: 0x80107728 -> 0x80107830
// this: r30
void zTriggerInteraction::Render() {
    // Local variables
    const struct xMat4x3 & triggerMat; // r31
    struct xMat4x3 mat; // r1+0x10
    unsigned char wasBright; // r31
}

// Range: 0x80107830 -> 0x8010790C
// this: r30
...
static struct _xFColor LIGHT_OFF_COLOR; // size: 0x10, address: 0x803C6EDC
static struct _xFColor LIGHT_ON_COLOR; // size: 0x10, address: 0x803C6EEC
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x80380330
// Range: 0x8010799C -> 0x80107A98
static void SetupEnt(struct xEnt * ent /* r31 */, struct zSwitchLeverAsset * asset /* r30 */) {
    // References
    // -> static struct xEntAsset fakeAsset;
}

// Range: 0x80107A98 -> 0x80107AC8
...
// Range: 0x80107AC8 -> 0x80107AF8
static unsigned int SwitchingOffCheck(void * object /* r0 */) {}

// Range: 0x80107AF8 -> 0x80107B20
static unsigned int SwitchedOffCB(void * object /* r0 */) {}

// Range: 0x80107B20 -> 0x80107B48
static unsigned int SwitchedOnCB(void * object /* r0 */) {}

// Range: 0x80107B48 -> 0x80107B80
static unsigned int SwitchChangeCB(struct xAnimTransition * tran /* r6 */, struct xAnimSingle * anim /* r0 */, void * object /* r0 */) {}

// Range: 0x80107B80 -> 0x80107BF4
static void AddAnim(struct xAnimTable * table /* r30 */, const char * stateName /* r31 */, unsigned int animID /* r6 */) {
    // Local variables
    void * buffer; // r0
    struct xAnimFile * afile; // r4
}

// Range: 0x80107BF4 -> 0x80107FAC
...
// Range: 0x80107FAC -> 0x80107FF0
void zSwitchLever::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x14
struct {} zSwitchLever::__vtable; // size: 0x14, address: 0x803BE540
...
class zSparkEmitter : public xBase {
    // Members
    struct zSparkEmitterAsset * asset; // offset 0x10, size 0x4
    struct xEnt * track_entity; // offset 0x14, size 0x4
    struct xVec3 emit_dir; // offset 0x18, size 0xC
    float time_until_emit; // offset 0x24, size 0x4
    unsigned char is_on; // offset 0x28, size 0x1
    unsigned char is_active; // offset 0x29, size 0x1
    unsigned char should_look_for_track; // offset 0x2A, size 0x1
    enum iSndGroupHandle sparkSound; // offset 0x2C, size 0x4
    int mSparkSystemId; // offset 0x30, size 0x4
    int mGlintSystemId; // offset 0x34, size 0x4
    float last_dt; // offset 0x38, size 0x4
};
// Range: 0x80108164 -> 0x80108214
// this: r29
void zSwitchLever::SwitchedOn() {
    // Local variables
    struct xGroup * sparkGroup; // r31
    unsigned int count; // r30
    class zSparkEmitter * sparkPtr; // r0

    // References
    // -> static struct _xFColor LIGHT_ON_COLOR;
}

// Range: 0x80108214 -> 0x801082C4
// this: r29
...
// Range: 0x8010871C -> 0x8010876C
void zSwitchLever::SceneReset(struct zScene * zsc /* r0 */) {
    // Local variables
    int count; // r30
    class zSwitchLever * switchList; // r29
    int i; // r28
}

// Range: 0x8010876C -> 0x801087B4
// this: r30
void zSwitchLever::Start(struct zCommonPlayer * thePlayer /* r31 */) {}

// Range: 0x801087B4 -> 0x80108840
// this: r31
...
// Range: 0x80108998 -> 0x801089D4
// this: r31
void zSwitchLever::Render() {}

// Range: 0x801089D4 -> 0x801089F8
// this: r0
void zSwitchLever::Ready() {}

// Range: 0x801089F8 -> 0x80108A68
// this: r30
...
// Range: 0x80108B78 -> 0x80108BBC
void zLaunch::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x14
struct {} zLaunch::__vtable; // size: 0x14, address: 0x803BE52C
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x80108C9C -> 0x80108CC4
// this: r0
void zLaunch::Reset() {}

// Range: 0x80108CC4 -> 0x80108D8C
void zLaunch::StartBlur() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80108D8C -> 0x80108E10
void zLaunch::StopBlur() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80108E10 -> 0x80108F98
// this: r27
...
// total size: 0x4
struct /* @class$1208zInteraction_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1209zInteraction_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1210zInteraction_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1207zInteraction_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1212zInteraction_cpp */ {
    // Members
...
// Range: 0x80108F98 -> 0x80108FF0
// this: r31
void zLaunch::WindupGrab() {}

// Range: 0x80108FF0 -> 0x8010941C
// this: r31
...
// Range: 0x80109544 -> 0x801095CC
// this: r31
void zLaunch::EarlyQuit() {}

// Range: 0x801095CC -> 0x80109718
// this: r30
...
// Range: 0x80109718 -> 0x80109744
void zLaunch::EventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x80109744 -> 0x801097E8
// this: r30
void zLaunch::EventCB(unsigned int toEvent /* r31 */) {}

// Range: 0x801097E8 -> 0x80109894
