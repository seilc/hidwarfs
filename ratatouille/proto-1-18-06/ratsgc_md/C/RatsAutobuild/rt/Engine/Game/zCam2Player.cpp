/*
    ...
    Language: C++
    Code range: 0x80153BD0 -> 0x801552C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801541BC -> 0x80154258
// this: r30
void zCam2Player::update_target_info(float dt /* f31 */) {}

// Range: 0x80154258 -> 0x801542EC
// this: r30
...
float sNearWall; // size: 0x4, address: 0x803BEAF0
// total size: 0x30
struct OOBExtent {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x80154B30 -> 0x80154B80
// this: r31
void zCam2Player::update_precollide() {}

// Range: 0x80154B80 -> 0x80154BEC
// this: r31
void zCam2Player::update_pivot() {}

// Range: 0x80154BEC -> 0x80154C58
// this: r31
void zCam2Player::update_compress() {}

// Range: 0x80154C58 -> 0x80154C5C
void zCam2Player::update_phi() {}

// Range: 0x80154C5C -> 0x80154C60
void zCam2Player::update_theta() {}

// Range: 0x80154C60 -> 0x80154C64
void zCam2Player::update_distance() {}

// Range: 0x80154C64 -> 0x80154D20
// this: r31
void zCam2Player::apply_basis() {}

// Range: 0x80154D20 -> 0x80154D70
// this: r31
...
struct config cfg; // size: 0x18, address: 0x803C0C70
// Range: 0x80154D70 -> 0x80154E10
// this: r31
...
// Range: 0x80154E5C -> 0x80154EA0
// this: r31
void zCam2Player::start_position_aim() {}

// Range: 0x80154EA0 -> 0x80154EC0
// this: r0
void zCam2Player::stop() {}

// Range: 0x80154EC0 -> 0x80154F80
// this: r31
void zCam2Player::update_camera_goals(float dt /* f31 */) {}

// Range: 0x80154F80 -> 0x801552BC
// this: r30
...
// Range: 0x801552BC -> 0x801552C0
void zCam2Player::debug_render() {}

// total size: 0x44
struct {} zCam2Player::__vtable; // size: 0x44, address: 0x802DD6B8
// total size: 0x0
