/*
    ...
    Language: C++
    Code range: 0x801359B4 -> 0x80135D00
*/
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct DynNPCInfo g_DynNPCInfo[3]; // size: 0x3C, address: 0x803BEA38
// total size: 0xC
struct RwV3d {
    // Members
...
static int needToHash; // size: 0x4, address: 0x803C2E78
static signed char init; // size: 0x1, address: 0x803C2E7C
// Range: 0x80135A9C -> 0x80135B14
