/*
    ...
    Language: C++
    Code range: 0x800AE908 -> 0x800AEB20
*/
// total size: 0xC
struct zFMVFile {
    // Members
...
static struct zFMVFile zFMVFileTable[53]; // size: 0x27C, address: 0x802AC328
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800AE908 -> 0x800AE944
struct zFMVFile * zFMVFileGetFile(enum eFMVFile fmvId /* r0 */) {
    // Local variables
    int i; // r0
