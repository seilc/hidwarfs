/*
    ...
    Language: C++
    Code range: 0x801A976C -> 0x801A9938
*/
class zUICustomCheatsManager * pUICustomCheatsManager; // size: 0x4, address: 0x803C3960
static unsigned char gCreditCode; // size: 0x1, address: 0x803C3964
static unsigned char gClearUserString; // size: 0x1, address: 0x803C3965
// total size: 0x50
struct {} zUICustomCheatsManager::__vtable; // size: 0x50, address: 0x802E3E30
// total size: 0x8
