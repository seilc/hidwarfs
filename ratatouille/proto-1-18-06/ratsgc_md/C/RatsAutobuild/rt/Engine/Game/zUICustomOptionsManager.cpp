/*
    ...
    Language: C++
    Code range: 0x8018CA24 -> 0x8018D584
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char inOverlayScreen; // size: 0x1, address: 0x803C35F0
float inOverlayScreenExitTimer; // size: 0x4, address: 0x803C35F4
static int sysMsgType; // size: 0x4, address: 0x803C35F8
static unsigned char screenAdjusted; // size: 0x1, address: 0x803C35FC
static unsigned char screenIsInSystemMessage; // size: 0x1, address: 0x803C35FD
// Range: 0x8018CA24 -> 0x8018CA2C
unsigned char zUICustomOptionsScreenIsInSystemMessage() {
    // References
    // -> static unsigned char screenIsInSystemMessage;
}

// Range: 0x8018CA2C -> 0x8018CA34
void zUICustomOptionsScreenAdjust(unsigned char value /* r0 */) {
    // References
    // -> static unsigned char screenAdjusted;
}

// total size: 0x50
struct {} zUICustomOptionsManager::__vtable; // size: 0x50, address: 0x802E0BF8
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8018CA34 -> 0x8018CAAC
// this: r31
zUICustomOptionsManager::zUICustomOptionsManager(class zUI * ui /* r0 */) {
    // References
    // -> static unsigned char screenAdjusted;
...
class zUICustomVolume * pUICustomMusicVolumeManager; // size: 0x4, address: 0x803C3048
class zUICustomVolume * pUICustomSFXVolumeManager; // size: 0x4, address: 0x803C304C
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$863zUICustomOptionsManager_cpp */ {
    // Members
...
union /* @class$822zUICustomOptionsManager_cpp */ {
...
// total size: 0xC
struct /* @class$883zUICustomOptionsManager_cpp */ {
    // Members
...
class zUI * pSysMessageManager; // size: 0x4, address: 0x803C2E24
class zUICustom * pSysMessageManager_Custom; // size: 0x4, address: 0x803C2E28
// Range: 0x8018CB30 -> 0x8018D3E4
// this: r24
unsigned char zUICustomOptionsManager::HandleEvent(struct xBase * from /* r25 */, unsigned int toEvent /* r26 */, const float * toParam /* r27 */, struct xBase * toParamWidget /* r28 */, unsigned int toParamWidgetID /* r29 */) {
    // Local variables
    unsigned char isBreak; // r31
    float curMusicVolume; // f0
    float curSfxVolume; // f0
    int curSoundMode; // r0
    unsigned char isBreak; // r31
    struct xBase * d; // r30
    struct xBase * d; // r30
    class zUIText * adjustText; // r0
    class zUIText * controlsText; // r0
    float curMusicVolume; // f0
    float curSfxVolume; // f0
    int curSoundMode; // r0
...
// total size: 0xC
struct /* @class$693zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$694zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$695zUICustomOptionsManager_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$696zUICustomOptionsManager_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$697zUICustomOptionsManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$698zUICustomOptionsManager_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$699zUICustomOptionsManager_cpp */ {
    // Members
...
// Range: 0x8018D3E4 -> 0x8018D4F4
// this: r31
void zUICustomOptionsManager::PreUpdate(float dt /* f0 */) {
    // References
    // -> float inOverlayScreenExitTimer;
}
...
// total size: 0x2
struct /* @class$1001zUICustomOptionsManager_cpp */ {
    // Members
...
// Range: 0x8018D4F4 -> 0x8018D584
// this: r31
void zUICustomOptionsManager::AdjustScreenOnOff() {
    // Local variables
    class zUIText * textField; // r0
}
