/*
    ...
    Language: C++
    Code range: 0x80116830 -> 0x801183D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float carryDamageMultipliers[3]; // size: 0xC, address: 0x803C7188
static float carryRadiusMultipliers[3]; // size: 0xC, address: 0x803C7194
static unsigned int throwEffectFlags[3]; // size: 0xC, address: 0x803C71A0
// total size: 0x8
struct RwObject {
    // Members
...
static class zFXShockwaveConfig shockwaveConfig; // size: 0x18, address: 0x803C2A90
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static struct StaticThrowableProperty staticThrowableProperties[3]; // size: 0x78, address: 0x802DC8C0
// total size: 0xC
...
static struct ThrowableModelMap * throwModelMap; // size: 0x4, address: 0x803C2AA8
static unsigned int throwModelMapCount; // size: 0x4, address: 0x803C2AAC
static unsigned int throwModelMapMaxCount; // size: 0x4, address: 0x803C2AB0
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
static struct zThrowableProperty * throwProperties; // size: 0x4, address: 0x803C2AB4
static unsigned int throwPropertiesCount; // size: 0x4, address: 0x803C2AB8
static unsigned int throwPropertiesMaxCount; // size: 0x4, address: 0x803C2ABC
// Range: 0x80116830 -> 0x80116850
static int UintCompare(unsigned int a /* r0 */, unsigned int b /* r0 */) {}

// Range: 0x80116850 -> 0x801168D8
...
static struct RunningThrow * runningThrows; // size: 0x4, address: 0x803C2AC4
static struct PointTarget * addedTargets; // size: 0x4, address: 0x803C2AC8
static unsigned int addedTargetsCount; // size: 0x4, address: 0x803C2ACC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct smoke_config smokeConfig; // size: 0x38, address: 0x803C2AD0
struct smoke_config default_config; // size: 0x38, address: 0x803C2968
// Range: 0x80116CA0 -> 0x80116D0C
