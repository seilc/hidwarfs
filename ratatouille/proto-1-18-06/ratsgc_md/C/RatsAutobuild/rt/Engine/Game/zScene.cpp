/*
    ...
    Language: C++
    Code range: 0x800D36D0 -> 0x800D8E9C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int bytesNeeded; // size: 0x4, address: 0x803C21C8
static int availOnDisk; // size: 0x4, address: 0x803C21CC
static int neededFiles; // size: 0x4, address: 0x803C21D0
static unsigned int enableScreenAdj; // size: 0x4, address: 0x803C21D4
static float offsetx; // size: 0x4, address: 0x803C21D8
static float offsety; // size: 0x4, address: 0x803C21DC
static float oldOffsetx; // size: 0x4, address: 0x803C21E0
static float oldOffsety; // size: 0x4, address: 0x803C21E4
static float menuOldOffsetx; // size: 0x4, address: 0x803C21E8
static float menuOldOffsety; // size: 0x4, address: 0x803C21EC
static int sMemDepthSceneStart; // size: 0x4, address: 0x803BE290
static int sMemDepthJustHIPStart; // size: 0x4, address: 0x803BE294
static unsigned char sLoadingPackFile; // size: 0x1, address: 0x803C21F0
// Range: 0x800D36D0 -> 0x800D36D8
...
static struct zSceneObjectInstanceDesc sInitTable[32]; // size: 0x380, address: 0x802DA998
// total size: 0x14
...
static struct dynamic_type_data dynamic_types[92]; // size: 0x730, address: 0x802AE510
// Range: 0x800D36D8 -> 0x800D375C
...
// Range: 0x800D375C -> 0x800D37D8
static void add_dynamic_types(struct zScene & s /* r27 */) {
    // Local variables
    unsigned long i; // r29
    const struct dynamic_type_data & d; // r28
    int count; // r0
...
// Range: 0x800D37D8 -> 0x800D3958
static unsigned int init_dynamic_type(struct zScene & s /* r23 */, unsigned int index /* r24 */, const struct dynamic_type_data & d /* r25 */) {
    // Local variables
    int count; // r3
    unsigned int type; // r0
    int dyn_size; // r0
...
// Range: 0x800D3958 -> 0x800D39C0
static unsigned int init_dynamic_types(struct zScene & s /* r28 */, unsigned int index /* r4 */) {
    // Local variables
    unsigned long i; // r29
    const struct dynamic_type_data & d; // r5
...
// Range: 0x800D39C0 -> 0x800D3AC0
static unsigned int zSceneInitFunc_DefaultEnt(struct zScene * s /* r28 */, struct zSceneObjectInstanceDesc * desc /* r29 */, unsigned int base_idx /* r30 */) {
    // Local variables
    unsigned char * block; // r26
    int count; // r25
...
// Range: 0x800D3AC0 -> 0x800D3BA8
static unsigned int zSceneInitFunc_Default(struct zScene * s /* r24 */, struct zSceneObjectInstanceDesc * desc /* r30 */, unsigned int base_idx /* r31 */) {
    // Local variables
    unsigned char * block; // r29
    int count; // r28
    unsigned int assetSize; // r1+0x8
...
// Range: 0x800D3C80 -> 0x800D3D74
static unsigned int zSceneInitFunc_Player(struct zScene * s /* r30 */, struct zSceneObjectInstanceDesc * desc /* r25 */, unsigned int base_idx /* r31 */) {
    // Local variables
    int count; // r27
...
// Range: 0x800D3D74 -> 0x800D3E48
static unsigned int zSceneInitFunc_Camera(struct zScene * s /* r26 */, struct zSceneObjectInstanceDesc * desc /* r25 */, unsigned int base_idx /* r24 */) {
    // Local variables
    int count; // r28
    struct zCamMarker * camBlock; // r0
    int idx; // r27
    struct xBase * b; // r26
    struct xCamAsset * assetCam; // r25

    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x800D3E48 -> 0x800D3EE4
...
// Range: 0x800D405C -> 0x800D4078
void zSceneSet(struct xBase * b /* r0 */, int idx /* r0 */) {
    // References
    // -> struct zGlobals globals;
}

static unsigned int sPipeSceneAssetID; // size: 0x4, address: 0x803C21F8
int xModelLookupCount; // size: 0x4, address: 0x803C1148
// Range: 0x800D4078 -> 0x800D40BC
...
struct xModelPipeLookup * xModelLookupList; // size: 0x4, address: 0x803C114C
// Range: 0x800D40BC -> 0x800D410C
...
static unsigned int modelToCheck; // size: 0x4, address: 0x803C21FC
static signed char init; // size: 0x1, address: 0x803C2200
// total size: 0x10
...
struct xModelPipeTable * xModelPipeData[]; // size: 0x0, address: 0x803C1108
int xModelPipeCount[]; // size: 0x0, address: 0x803C10C8
int xModelPipeNumTables; // size: 0x4, address: 0x803C10C4
// total size: 0x8
struct xModelPipe {
    // Members
    unsigned int Flags; // offset 0x0, size 0x4
...
struct xModelPipe modelDefaultPipe; // size: 0x8, address: 0x803BD81C
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x800D410C -> 0x800D42F8
static void PipeForAllSceneModels(void (* pipeCB)(struct RpAtomic *, struct xModelPipe &, unsigned int) /* r21 */) {
    // Local variables
    int i; // r27
    int j; // r26
    int k; // r25
    int numModels; // r0
    struct RpAtomic * model; // r24
    struct PKRAssetTOCInfo ainfo; // r1+0x8
    unsigned int numSubObjects; // r19
    unsigned int remainSubObjBits; // r23
    unsigned int currSubObjBits; // r22
...
unsigned int gTransitionSceneID; // size: 0x4, address: 0x803C2204
// Range: 0x800D42F8 -> 0x800D43B8
...
int xModelInstStaticAlloc; // size: 0x4, address: 0x803C1150
// total size: 0x0
struct iAnimFile {};
// Range: 0x800D43B8 -> 0x800D4FC4
void zSceneInit(unsigned int theSceneID /* r1+0x8 */, int reloadInProgress /* r29 */) {
    // Local variables
    float pdone; // f31
    struct zScene * s; // r30
    int i; // r25
    ...
    unsigned int idleWrite; // r25
    unsigned int j; // r29
    struct iAnimFile * raw; // r0
    unsigned int j; // r29
    struct iAnimFile * raw; // r0
    int i; // r25
    void * data; // r0
...
// Range: 0x800D4FC4 -> 0x800D4FC8
void add_scene_tweaks() {}

// Range: 0x800D4FC8 -> 0x800D4FCC
static void IncrementTweakReloadIndex() {}

// Range: 0x800D4FCC -> 0x800D5158
...
// total size: 0x4
struct /* @class$1689zScene_cpp */ {
    // Members
    float phase; // offset 0x0, size 0x4
};
// total size: 0x1
struct /* @class$1690zScene_cpp */ {};
union /* @class$1688zScene_cpp */ {
    // total size: 0x4
    struct /* @class$1689zScene_cpp */ {
        // Members
        float phase; // offset 0x0, size 0x4
    ...
    // total size: 0x1
    struct /* @class$1690zScene_cpp */ {} flicker; // offset 0x0, size 0x1
};
// total size: 0x3C
struct motion_data {
    // Members
...
struct zLaserBeam * additional_lasers; // size: 0x4, address: 0x803C1F84
...
// Range: 0x800D547C -> 0x800D57EC
void zSceneSwitch(struct _zPortal * p /* r0 */, int forceSameScene /* r26 */, unsigned char sameScene /* r29 */, int playerNum /* r30 */) {
    // Local variables
...
// Range: 0x800D5B24 -> 0x800D5B28
void LogFinalStats() {}

// Range: 0x800D5B28 -> 0x800D5B2C
void LogEachItem() {}

// Range: 0x800D5B2C -> 0x800D5B30
void IncTypeCount() {}
...
struct zSlideCam : public xCam {
    // Members
    const struct xMat4x3 * target; // offset 0x130, size 0x4
    // total size: 0x10
    struct /* @class$1720zScene_cpp */ {
        // Members
        float spring_len; // offset 0x0, size 0x4
        ...
        float damp_const; // offset 0x8, size 0x4
        float vertical_offset; // offset 0xC, size 0x4
    } cfg; // offset 0x134, size 0x10
    struct xVec3 curr_tgt_pos; // offset 0x144, size 0xC
    struct xVec3 prev_tgt_pos; // offset 0x150, size 0xC
    struct xVec3 cam_pos; // offset 0x15C, size 0xC
};
// total size: 0x208
...
// Range: 0x800D5B30 -> 0x800D5B34
void Reset() {}

// Range: 0x800D5B34 -> 0x800D5B38
void AddTweaks() {}

// Range: 0x800D5B38 -> 0x800D5EC8
void zSceneLoad(struct zScene * ent /* r27 */) {
    ...
    int i; // r29
    unsigned int serialSceneID; // r30
...
// Range: 0x800D5EC8 -> 0x800D5EF8
void zSceneBlastDoorReset() {
    // Local variables
    struct xBase * loseScript; // r0
}

// Range: 0x800D5EF8 -> 0x800D629C
void zSceneReset() {
    // Local variables
    struct zScene * s; // r30
    int i; // r29
...
// Range: 0x800D629C -> 0x800D6358
void zSceneStoreCheckPoint(unsigned int initialCameraID /* r27 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1359zScene_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1360zScene_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$773zScene_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$774zScene_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$775zScene_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$776zScene_cpp */ {
    // Members
...
void zSceneSetup() {
    ...
    int i; // r20
    int i; // r20
    int max_drivensort_iters; // r7
    unsigned int driven_swapped; // r8
    unsigned int i; // r9
    unsigned int j; // r10
    struct xEnt * bdriven; // r11
    struct xBase * btmp; // r0
    struct zEntSimpleObj * * entList; // r20
    unsigned int entCount; // r21
    struct xEnt * * entList; // r29
    int entCount; // r28
    int i; // r7
    int j; // r27
    unsigned int k; // r26
    unsigned int numPrimeMovers; // r25
    unsigned int numDriven; // r24
    struct xEnt * ent; // r5
    unsigned int numGroups; // r23
    struct xGroup * grp; // r22
    unsigned int gcnt; // r0
    struct xBase * gbase; // r0
    struct xEnt * gent; // r0
    struct xGroup * driveGroupList; // r22
    unsigned int currMover; // r0
    struct xGroupAsset * grpAssetList; // r8
    struct xBase * * grpBaseList; // r3
    unsigned int i; // r0
    int i; // r4
    struct xEnt * ent; // r0
    struct xGroupAsset * gasset; // r10
    struct xEnt * other; // r11
    struct xGroup * * tempGrpList; // r24
    struct xGroup * * tempGrpCurr; // r8
    struct xGroup * grp; // r0
    unsigned int i; // r0
    union FloatAndVoid defaultDist; // r1+0xC
    union FloatAndVoid lodDist; // r1+0x8
    struct zLODTable * lod; // r26
...
static struct xVec3 sOldPosPlayer; // size: 0xC, address: 0x803C2210
static struct xVec3 sOldPosCamera; // size: 0xC, address: 0x803C221C
static unsigned int sSuddenMove; // size: 0x4, address: 0x803C2228
static unsigned int sUITimers[10]; // size: 0x28, address: 0x803C222C
static unsigned int init; // size: 0x4, address: 0x803C2254
static signed char init; // size: 0x1, address: 0x803C2258
struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80316480
// Range: 0x800D7110 -> 0x800D7B34
void zSceneUpdate(float elapsedSec /* f29 */) {
    ...
    float apady; // f0
    int i; // r28
    struct zScene * pScene; // r28
    struct xBase * * ppBaseObjs; // r30
    struct xBase * bob; // r27
    struct xEnt * ent; // r0
    int timer; // r22
    char str[32]; // r1+0x8
    int timer; // r0
...
static void (* zSceneSpecialRender_curFunc[2])(); // size: 0x8, address: 0x803BE298
static int zSceneSpecialRender_numFuncs; // size: 0x4, address: 0x803C225C
// Range: 0x800D7B34 -> 0x800D7B9C
...
int gGCwaterDisable; // size: 0x4, address: 0x803C2C98
float sTimeElapsed; // size: 0x4, address: 0x803C1BA4
// Range: 0x800D7B9C -> 0x800D81EC
...
// total size: 0x0
struct zScreenWarpAsset {};
// total size: 0x20
class zScreenWarp : private xBase {
    // Members
    class zScreenWarp * next; // offset 0x10, size 0x4
    struct zScreenWarpAsset * asset; // offset 0x14, size 0x4
    float timer; // offset 0x18, size 0x4
    unsigned int flags; // offset 0x1C, size 0x4
};
// Range: 0x800D81EC -> 0x800D82C0
...
// Range: 0x800D84D4 -> 0x800D84D8
void model_poly_count_helper() {}

// Range: 0x800D84D8 -> 0x800D85F0
void zSceneRender() {
    // Local variables
    int i; // r31
    int i; // r31
...
static struct IDBasePair * scobj_idbps; // size: 0x4, address: 0x803C2260
static int scobj_size; // size: 0x4, address: 0x803BE2A0
static int nidbps; // size: 0x4, address: 0x803BE2A4
// Range: 0x800D85F0 -> 0x800D8644
...
// Range: 0x800D865C -> 0x800D8664
static int zSceneObjHashtableUsage() {
    // References
    // -> static int nidbps;
}

// Range: 0x800D8664 -> 0x800D86C4
void zSceneObjHashtableAdd(unsigned int id /* r0 */, struct xBase * base /* r0 */) {
    // Local variables
    int k; // r7
    int chkd; // r0
    struct IDBasePair * idbp; // r8
...
// Range: 0x800D8728 -> 0x800D8748
struct xBase * zSceneFindObject(unsigned int gameID /* r0 */) {}

// Range: 0x800D8748 -> 0x800D87A4
...
// Range: 0x800D87A4 -> 0x800D87E8
char * zSceneGetName(struct xBase * b /* r3 */) {
    // Local variables
    const char * n; // r0
}

// Range: 0x800D87E8 -> 0x800D886C
void zSceneForAllBase(struct xBase * (* func)(struct xBase *, struct zScene *, void *) /* r28 */, void * data /* r29 */) {
    // Local variables
    struct zScene * s; // r31
...
// Range: 0x800D886C -> 0x800D8900
void zSceneForAllBase(struct xBase * (* func)(struct xBase *, struct zScene *, void *) /* r27 */, int baseType /* r28 */, void * data /* r29 */) {
    // Local variables
    struct zScene * s; // r31
    unsigned short i; // r30
...
// Range: 0x800D8CA4 -> 0x800D8CC4
void zSceneResetScreenAdj() {}

// Range: 0x800D8CC4 -> 0x800D8CCC
unsigned int zScene_ScreenAdjustMode() {
    // References
    // -> static unsigned int enableScreenAdj;
}

// Range: 0x800D8CCC -> 0x800D8E94
unsigned char zSceneLoadPackFile(unsigned int id /* r31 */, int options /* r28 */, unsigned char noLocalized /* r30 */, const char * filename /* r29 */) {
    // Local variables
...
static unsigned int gLastSceneID; // size: 0x4, address: 0x803C2264
// Range: 0x800D8E94 -> 0x800D8E9C
