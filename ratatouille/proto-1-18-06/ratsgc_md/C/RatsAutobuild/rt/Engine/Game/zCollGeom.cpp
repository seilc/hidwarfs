/*
    ...
    Language: C++
    Code range: 0x8008FA98 -> 0x8008FE3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zCollisionGeomTableEntry sCollisionGeomTable[20]; // size: 0xA0, address: 0x8035C620
static unsigned int sCollisionGeomTableCount; // size: 0x4, address: 0x803C1958
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8008FA98 -> 0x8008FC88
unsigned int zCollGeom_EntSetup(struct xEnt * ent /* r25 */) {
    // Local variables
    unsigned int i; // r29
    unsigned int j; // r28
    unsigned char auto_cam_coll; // r27
    struct zCollGeomTable * tableList; // r26
    struct RpAtomic * imodel; // r22
    struct xModelInstance * model; // r21
    struct xModelInstance * model; // r21
...
// Range: 0x8008FE18 -> 0x8008FE30
void zCollGeom_CamEnable(struct xEnt * ent /* r0 */) {}

// Range: 0x8008FE30 -> 0x8008FE3C
