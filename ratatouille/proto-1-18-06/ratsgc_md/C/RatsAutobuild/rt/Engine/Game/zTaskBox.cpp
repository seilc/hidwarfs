/*
    ...
    Language: C++
    Code range: 0x800E1278 -> 0x800E1B7C
*/
class talk_callback * tcb; // size: 0x4, address: 0x803C2370
// total size: 0x4
struct /* @class$903zTaskBox_cpp */ {
    // Members
...
struct /* @class$903zTaskBox_cpp */ {
    // Members
    struct ztaskbox * active; // offset 0x0, size 0x4
} shared; // size: 0x4, address: 0x803C2374
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x800E1278 -> 0x800E1330
// this: r30
void ztaskbox::load(const struct asset_type & a /* r31 */) {}

// Range: 0x800E1330 -> 0x800E1378
// this: r31
...
// Range: 0x800E13A4 -> 0x800E1488
// this: r28
void ztaskbox::start_talk(class zNPCBaseIN2 * npc /* r29 */) {
    // Local variables
...
// Range: 0x800E1488 -> 0x800E1498
// this: r0
void talk_callback::reset(struct ztaskbox & task /* r0 */) {}

// Range: 0x800E1498 -> 0x800E151C
// this: r0
void ztaskbox::stop_talk() {
    // Local variables
    struct ztalkbox * talk; // r0
...
// Range: 0x800E151C -> 0x800E1554
// this: r0
void ztaskbox::enable() {}

// Range: 0x800E1554 -> 0x800E15A0
// this: r31
void ztaskbox::disable() {}

// Range: 0x800E15A0 -> 0x800E15E4
// this: r31
void ztaskbox::reset() {}

// Range: 0x800E15E4 -> 0x800E1614
// this: r0
void ztaskbox::initiate() {}

// Range: 0x800E1614 -> 0x800E1654
// this: r3
void ztaskbox::succeed() {}

// Range: 0x800E1654 -> 0x800E1694
// this: r3
void ztaskbox::fail() {}

// Range: 0x800E1694 -> 0x800E16FC
// this: r31
void ztaskbox::complete() {}

// Range: 0x800E16FC -> 0x800E1704
// this: r0
void ztaskbox::set_callback(class callback * cb /* r0 */) {}

static signed char init; // size: 0x1, address: 0x803C2378
static class talk_callback tcb; // size: 0xC, address: 0x803C237C
// Range: 0x800E1704 -> 0x800E174C
void ztaskbox::init() {
    // References
...
// Range: 0x800E1790 -> 0x800E17B0
void ztaskbox::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x800E1808 -> 0x800E18D8
// this: r31
void ztaskbox::set_state(enum state_enum state /* r0 */) {}

// Range: 0x800E18D8 -> 0x800E1918
// this: r0
...
// Range: 0x800E1A70 -> 0x800E1B24
void ztaskbox::cb_dispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */) {
    // Local variables
    struct ztaskbox & e; // r4
}

// total size: 0x18
struct {} ztalkbox::callback::__vtable; // size: 0x18, address: 0x803BE328
// total size: 0x4
struct callback {
    // Members
    void * __vptr$; // offset 0x0, size 0x4
...
// total size: 0x18
struct {} ztaskbox::talk_callback::__vtable; // size: 0x18, address: 0x803BE340
// Range: 0x800E1B24 -> 0x800E1B48
// this: r3
void talk_callback::on_start() {}

// Range: 0x800E1B48 -> 0x800E1B74
// this: r4
