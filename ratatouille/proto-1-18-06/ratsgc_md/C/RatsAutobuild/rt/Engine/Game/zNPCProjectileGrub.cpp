/*
    ...
    Language: C++
    Code range: 0x80177630 -> 0x80178238
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x802B2CF8
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x803C32A8
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x803C32AC
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x803C32B0
static unsigned int GRUB_BUG_MODEL_ID; // size: 0x4, address: 0x803C32B4
static unsigned int GRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x803C32B8
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x44, address: 0x802DFF88
static struct TrailConfig ShortTrailConfig; // size: 0x44, address: 0x802DFFCC
// total size: 0x1C
struct ArcConfig {
    // Members
...
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x803BF138
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x803BF13C
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x803BF140
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct xSurface * grubScrollingSurf; // size: 0x4, address: 0x803C32BC
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x38
struct {} zNPCProjectileGrub::__vtable; // size: 0x38, address: 0x803BF144
// total size: 0x0
