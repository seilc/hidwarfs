/*
    ...
    Language: C++
    Code range: 0x801120AC -> 0x80112990
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int texture_rows; // size: 0x4, address: 0x803BE650
static int texture_columns; // size: 0x4, address: 0x803BE654
// Range: 0x801120AC -> 0x801120B0
static void add_tweaks() {}

static int dirt_system_id; // size: 0x4, address: 0x803C29C8
static float ring_vel_decay; // size: 0x4, address: 0x803C29CC
static struct xVec2 * dirt_uvs; // size: 0x4, address: 0x803C29D0
static unsigned char refreshed_ring_chains; // size: 0x1, address: 0x803C29D4
static float ring_chain_ang[2]; // size: 0x8, address: 0x803C29D8
// Range: 0x801120B0 -> 0x801121CC
...
// Range: 0x80112884 -> 0x801128B0
void zDustSceneEnter() {}

// Range: 0x801128B0 -> 0x801128D4
void zDustReset() {}

// Range: 0x801128D4 -> 0x801128F4
void zDustUpdate(float dt /* f0 */) {}

// Range: 0x801128F4 -> 0x80112900
void zDustRender() {
    // References
    // -> static unsigned char refreshed_ring_chains;
}

int activities_used; // size: 0x4, address: 0x803C29E0
// total size: 0x18
struct activity_data {
    // Members
...
struct activity_data * activities; // size: 0x4, address: 0x803C29E4
// total size: 0x14
struct config_type {
    // Members
