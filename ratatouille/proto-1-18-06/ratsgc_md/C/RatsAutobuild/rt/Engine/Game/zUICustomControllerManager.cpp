/*
    ...
    Language: C++
    Code range: 0x8018AA64 -> 0x8018AFF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char mriIsOnTheLeft; // size: 0x1, address: 0x803BF440
static int secondPlayerPort; // size: 0x4, address: 0x803BF444
static int totalPlayers; // size: 0x4, address: 0x803BF448
static int sysMsgType; // size: 0x4, address: 0x803BF44C
// Range: 0x8018AA64 -> 0x8018AA68
static void zSystemEventCB() {}

class zUICustomControllerManager * pUICustomControllerManager; // size: 0x4, address: 0x803C35C0
// total size: 0x50
struct {} zUICustomControllerManager::__vtable; // size: 0x50, address: 0x802E0A98
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x8018AAB4 -> 0x8018AAC0
// this: r0
void zUICustomControllerManager::Init() {}

// Range: 0x8018AAC0 -> 0x8018AAC4
...
// total size: 0x2
struct /* @class$1112zUICustomControllerManager_cpp */ {
    // Members
