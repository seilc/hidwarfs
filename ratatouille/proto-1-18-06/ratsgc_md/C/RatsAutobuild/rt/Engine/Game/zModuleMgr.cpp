/*
    ...
    Language: C++
    Code range: 0x801B4F58 -> 0x801B592C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct st_XORDEREDARRAY g_modlist; // size: 0x10, address: 0x803C3A70
static struct st_XORDEREDARRAY g_modlistUpdateSort; // size: 0x10, address: 0x803C3A80
static struct st_XORDEREDARRAY g_modlistRenderSort; // size: 0x10, address: 0x803C3A90
// total size: 0x1C
struct zModule {
    // Members
