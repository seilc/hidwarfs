/*
    ...
    Language: C++
    Code range: 0x80189C2C -> 0x8018A8C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x50
struct {} zPlayerActionRopeClimb::__vtable; // size: 0x50, address: 0x802E0A48
