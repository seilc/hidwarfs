/*
    ...
    Language: C++
    Code range: 0x8010ABB8 -> 0x8010C49C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8010ABB8 -> 0x8010ABD8
void zFlameThrowerWidget::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

class zLightweightSystem * zLightweight<flamethrower, 10>::GetSystem()::system; // size: 0x4, address: 0x803C2940
signed char zLightweight<flamethrower, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C2944
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x24
struct {} zLightweightSystem<flamethrower, 10>::__vtable; // size: 0x24, address: 0x803BE5F8
// Range: 0x8010ACB8 -> 0x8010AEB4
...
static struct config flamethrower_config; // size: 0x44, address: 0x80380380
static float length_modifier; // size: 0x4, address: 0x803BE5B0
static float radius_modifier; // size: 0x4, address: 0x803BE5B4
unsigned char draw_damage; // size: 0x1, address: 0x803C2945
// Range: 0x8010AEB4 -> 0x8010AF54
...
// total size: 0x20
struct {} flamethrower::__vtable; // size: 0x20, address: 0x803BE5B8
// Range: 0x8010AF54 -> 0x8010B06C
// this: r27
...
// total size: 0x20
struct {} zLightweight<flamethrower, 10>::__vtable; // size: 0x20, address: 0x803BE5D8
// Range: 0x8010B06C -> 0x8010B0A8
// this: r31
...
struct FlameThrowerCollisionInfo flameThrowerCollisionInfo; // size: 0x14, address: 0x803C2948
struct RwTexture * particleTex; // size: 0x4, address: 0x803C295C
enum FTParType {
    TYPE_A = 0,
    TYPE_B = 1,
};
...
class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4, address: 0x803C2960
// total size: 0xC
...
// Range: 0x8010C48C -> 0x8010C494
// this: r3
unsigned char zFlameThrower::IsShutDown() {}

// Range: 0x8010C494 -> 0x8010C49C
// this: r3
