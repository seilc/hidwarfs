/*
    ...
    Language: C++
    Code range: 0x8016CDD4 -> 0x8016CF54
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zCamPoolBase {
    ...
    void AddCamera(struct xCam * newCam);
...
// Range: 0x8016CDD4 -> 0x8016CDE4
// this: r0
zCamPoolBase::zCamPoolBase() {}

// Range: 0x8016CDE4 -> 0x8016CE48
// this: r29
...
// Range: 0x8016CE48 -> 0x8016CEB0
// this: r30
void zCamPoolBase::AddCamera(struct xCam * newCam /* r31 */) {}

static int depth; // size: 0x4, address: 0x803C3258
static signed char init; // size: 0x1, address: 0x803C325C
// Range: 0x8016CEB0 -> 0x8016CF54
// this: r28
