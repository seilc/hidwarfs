/*
    ...
    Language: C++
    Code range: 0x801B5930 -> 0x801B6A2C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x803C3AA0
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x803C3AA4
static unsigned int TIMER_BOX_ID; // size: 0x4, address: 0x803C3AA8
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x803C3AAC
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x803C3AB0
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x803C3AB4
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x803C3AB8
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x803C3ABC
static unsigned int TIE_TEX_ID; // size: 0x4, address: 0x803C3AC0
static unsigned int DECAL_OWNER_ID; // size: 0x4, address: 0x803C3AC4
static unsigned int RSCREEN_DECAL_TEX_IDS[4][3]; // size: 0x30, address: 0x803C0038
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node decalCurve[3]; // size: 0x54, address: 0x802B4D98
static unsigned int READY_TEX_IDS[3]; // size: 0xC, address: 0x803C0068
static unsigned int READY_SFX_ID; // size: 0x4, address: 0x803C3AC8
static unsigned int STEADY_SFX_ID; // size: 0x4, address: 0x803C3ACC
static unsigned int GO_SFX_ID; // size: 0x4, address: 0x803C3AD0
static unsigned int SUCCESS_SFX_ID; // size: 0x4, address: 0x803C3AD4
static unsigned int SQUISH_SFX_ID; // size: 0x4, address: 0x803C3AD8
...
// total size: 0x1
struct /* @class$842zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$844zMiniGameGrapeStomper_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$845zMiniGameGrapeStomper_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$846zMiniGameGrapeStomper_cpp */ {
    // Members
...
enum /* @enum$847zMiniGameGrapeStomper_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$848zMiniGameGrapeStomper_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$849zMiniGameGrapeStomper_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$851zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x2
struct /* @class$839zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$816zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$899zMiniGameGrapeStomper_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
union /* @class$895zMiniGameGrapeStomper_cpp */ {
...
// total size: 0xC
struct /* @class$781zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$782zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$783zMiniGameGrapeStomper_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$784zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$785zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$786zMiniGameGrapeStomper_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$787zMiniGameGrapeStomper_cpp */ {
    // Members
...
protected:
    ...
    struct xResponseCurve decalResponseCurve; // offset 0x49C, size 0x10
    enum iSndGroupHandle splatSound; // offset 0x4AC, size 0x4
    float endTimer; // offset 0x4B0, size 0x4
    unsigned char done; // offset 0x4B4, size 0x1
};
// total size: 0x14
...
static char scoresBuf[4][128]; // size: 0x200, address: 0x80396A80
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x78
struct {} zMiniGameGrapeStomper::__vtable; // size: 0x78, address: 0x802E4538
// total size: 0x50
...
// Range: 0x801B5F2C -> 0x801B5FCC
void zMiniGameGrapeStomper::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r29 */) {
    // References
    // -> unsigned int gActiveHeap;
...
// Range: 0x801B60C4 -> 0x801B60CC
// this: r0
void ResultScreen::SetPlayerCount(int count /* r0 */) {}

struct xGlobals * xglobals; // size: 0x4, address: 0x803BE168
// Range: 0x801B60CC -> 0x801B61C8
// this: r29
...
class zMiniGameGrapeStomperPlayer : public zMiniGamePlayer {
    // Members
protected:
    unsigned int curStomp; // offset 0xB20, size 0x4
    unsigned int prevStomp; // offset 0xB24, size 0x4
    int score; // offset 0xB28, size 0x4
    struct xModelInstance * models[3]; // offset 0xB2C, size 0xC
    int frameCount; // offset 0xB38, size 0x4
    int whichModel; // offset 0xB3C, size 0x4
    class InputChecker * inputChecker; // offset 0xB40, size 0x4
    struct zShrapnelAsset * leftSplash[3]; // offset 0xB44, size 0xC
    struct zShrapnelAsset * rightSplash[3]; // offset 0xB50, size 0xC
};
// total size: 0xDC
...
// total size: 0x54
struct /* @class$1182zMiniGameGrapeStomper_cpp */ {
    // Members
...
static char timerBuf[32]; // size: 0x20, address: 0x803C3ADC
// Range: 0x801B6554 -> 0x801B65D4
// this: r31
...
static char statsBuf[4][128]; // size: 0x200, address: 0x80396C80
// Range: 0x801B65D4 -> 0x801B67B4
// this: r25
...
// Range: 0x801B67B4 -> 0x801B67CC
// this: r0
void ResultScreen::SetScore(int index /* r0 */, int score /* r0 */) {}

// Range: 0x801B67CC -> 0x801B68D0
// this: r31
void zMiniGameGrapeStomper::StageEndUpdate(float dt /* f0 */) {}

// Range: 0x801B68D0 -> 0x801B68D8
// this: r3
unsigned char ResultScreen::IsDone() {}

// Range: 0x801B68D8 -> 0x801B695C
// this: r31
void zMiniGameGrapeStomper::GameEndUpdate(float dt /* f0 */) {}

// Range: 0x801B695C -> 0x801B6960
void zMiniGameGrapeStomper::Render() {}

// Range: 0x801B6960 -> 0x801B6A2C
// this: r30
