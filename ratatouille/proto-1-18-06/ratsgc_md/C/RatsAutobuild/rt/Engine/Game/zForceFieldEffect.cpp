/*
    ...
    Language: C++
    Code range: 0x80156854 -> 0x80158268
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct _xFColor default_color; // size: 0x10, address: 0x803C7E00
static struct _xFColor mid_color; // size: 0x10, address: 0x803C7E10
static struct _xFColor weak_color; // size: 0x10, address: 0x803C7E20
static float lifetime; // size: 0x4, address: 0x803BEE80
static float life_rand; // size: 0x4, address: 0x803BEE84
static float size_min; // size: 0x4, address: 0x803BEE88
static float size_rand; // size: 0x4, address: 0x803BEE8C
static float velocity; // size: 0x4, address: 0x803BEE90
static float velocity_rand; // size: 0x4, address: 0x803BEE94
static float glint_length_min; // size: 0x4, address: 0x803C3058
static float glint_length_rand; // size: 0x4, address: 0x803BEE98
static float gravity; // size: 0x4, address: 0x803BEE9C
static int fraction; // size: 0x4, address: 0x803BEEA0
static class zForceFieldEffect FFEList[9]; // size: 0x7E0, address: 0x8038A280
static struct RwRaster * energy_raster; // size: 0x4, address: 0x803C305C
static int sparkSystemID; // size: 0x4, address: 0x803BEEA4
static int glintSystemID; // size: 0x4, address: 0x803BEEA8
static int electricSystemID; // size: 0x4, address: 0x803BEEAC
// total size: 0x1C
struct ArcConfig {
    // Members
...
static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig; // size: 0x1C, address: 0x803C7E30
// Range: 0x80156854 -> 0x8015687C
static void unit_sphere_size(int & verts_size /* r0 */, int & indices_size /* r0 */, int rows /* r0 */, int cols /* r0 */) {}

// Range: 0x8015687C -> 0x801568DC
...
// Range: 0x80157C84 -> 0x80157D6C
// this: r31
void zForceFieldEffect::Update(float dt /* f31 */) {}

// Range: 0x80157D6C -> 0x80157F14
// this: r31
...
// Range: 0x80157F7C -> 0x80157F80
void zForceFieldEffect::RenderBack() {}

static int rows; // size: 0x4, address: 0x803C3060
static signed char init; // size: 0x1, address: 0x803C3064
static int cols; // size: 0x4, address: 0x803C3068
static signed char init; // size: 0x1, address: 0x803C306C
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
