/*
    ...
    Language: C++
    Code range: 0x80181B4C -> 0x801829D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct config glint_config; // size: 0x24, address: 0x803C3530
static float * glintEmit[5]; // size: 0x14, address: 0x803C3554
static int contextObjCount[5]; // size: 0x14, address: 0x803C3568
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct xEnt * entFXList[16]; // size: 0x40, address: 0x803C357C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
struct config default_config; // size: 0x24, address: 0x803C2F14
