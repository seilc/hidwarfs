/*
    ...
    Language: C++
    Code range: 0x8011B164 -> 0x8011BBB8
*/
static int max_system_asset_size; // size: 0x4, address: 0x803C2BD8
static class zParticleSystem * * systems; // size: 0x4, address: 0x803C2BDC
static class zParticleSystem * * system_handler_set[7]; // size: 0x1C, address: 0x803C2BE0
static int system_handler_set_size[7]; // size: 0x1C, address: 0x803C2BFC
static struct zParticleGenerator * * generators; // size: 0x4, address: 0x803C2C18
static int max_generators; // size: 0x4, address: 0x803C2C1C
static int generators_used; // size: 0x4, address: 0x803C2C20
// Range: 0x8011B164 -> 0x8011B26C
static void create_handler_sets() {
    ...
    int handler; // r9
    class zParticleSystem * * sys; // r10
    class zParticleSystem * * end_sys; // r11
...
// Range: 0x8011B26C -> 0x8011B270
static void sort_handler_sets() {}

// Range: 0x8011B270 -> 0x8011B2A0
...
// Range: 0x8011B4A8 -> 0x8011B4AC
static void validate_asset() {}
...
// total size: 0xC
struct /* @class$992zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x8011B8E8 -> 0x8011B920
// this: r0
void zParticleGenerator::reset() {}

// Range: 0x8011B920 -> 0x8011B930
// this: r0
void zParticleGenerator::activate() {}

// Range: 0x8011B930 -> 0x8011B940
// this: r0
void zParticleGenerator::deactivate() {}

// Range: 0x8011B940 -> 0x8011B948
unsigned char zParticleGenerator::cullUpdate() {}

// Range: 0x8011B948 -> 0x8011B958
// this: r0
void zParticleGenerator::pause() {}

// Range: 0x8011B958 -> 0x8011B968
// this: r0
void zParticleGenerator::resume() {}

// Range: 0x8011B968 -> 0x8011BA18
void zParticleGenerator::event_handler(struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r30 */) {
    // Local variables
    struct zParticleGenerator & gen; // r31
}
...
// total size: 0x4
struct /* @class$923zParticleGenerator_cpp */ {
    // Members
...
union /* @class$746zParticleGenerator_cpp */ {
...
// total size: 0xC
struct /* @class$941zParticleGenerator_cpp */ {
    // Members
...
// Range: 0x8011BA18 -> 0x8011BAB0
struct xEnt * zParticleGenerator::get_attach_entity(const struct zParticleAsset & asset /* r0 */) {
    // Local variables
    unsigned int id; // r3
...
// total size: 0x20
struct {} zParticleGenerator::__vtable; // size: 0x20, address: 0x803BE718
// total size: 0x34
struct {} zParticleSystem::__vtable; // size: 0x34, address: 0x803BE738
// total size: 0x8
