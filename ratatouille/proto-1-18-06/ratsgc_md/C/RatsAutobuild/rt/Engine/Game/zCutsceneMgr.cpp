/*
    ...
    Language: C++
    Code range: 0x80097F20 -> 0x80098B74
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int demoDisableHackTable[1]; // size: 0x4, address: 0x803BDD38
// total size: 0x8
struct RwObject {
    // Members
...
struct zCutsceneHack cutsceneHackTable[15]; // size: 0xC30, address: 0x802D8DD8
// Range: 0x80097F20 -> 0x80097F28
int zCutsceneMgrGetHackTableSize() {}

// Range: 0x80097F28 -> 0x80097F3C
struct zCutsceneHack & zCutsceneMgrGetHackTableDataByIdx(int idx /* r0 */) {
    // References
    // -> struct zCutsceneHack cutsceneHackTable[15];
}

static int gCutsceneSkipOK; // size: 0x4, address: 0x803C19B0
static unsigned char ents_hidden; // size: 0x1, address: 0x803C19B4
// Range: 0x80097F3C -> 0x80097F5C
...
// Range: 0x80097FD4 -> 0x80098020
void zCutsceneMgrReset(struct zCutsceneMgr * t /* r31 */) {
    // References
    // -> static unsigned char ents_hidden;
}

// Range: 0x80098020 -> 0x80098024
void zCutsceneMgrSave() {}

// Range: 0x80098024 -> 0x80098028
void zCutsceneMgrLoad() {}

// Range: 0x80098028 -> 0x80098050
static struct RpAtomic * NextAtomicCallback(struct RpAtomic * atomic /* r3 */, void * data /* r0 */) {
    // Local variables
    struct RpAtomic * * nextModel; // r0
}

// Range: 0x80098050 -> 0x800982C4
static void zCutsceneMgrPlayStart(struct zCutsceneMgr * t /* r16 */) {
    // Local variables
    unsigned int i; // r19
    unsigned int j; // r18
    unsigned int hackid; // r17
    unsigned char hacked; // r0
    unsigned int counter; // r0
...
// total size: 0x4
struct /* @class$786zCutsceneMgr_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$806zCutsceneMgr_cpp */ {
    // Members
...
union /* @class$617zCutsceneMgr_cpp */ {
...
// Range: 0x800982C4 -> 0x800984D4
void zCutsceneMgrEventCB(struct xBase * to /* r29 */, unsigned int toEvent /* r0 */, const float * toParam /* r30 */) {
    // Local variables
    struct zCutsceneMgr * t; // r31
    unsigned char disableCutscene; // r6
    unsigned int i; // r0
...
unsigned char thisShouldAlwaysBeFalseItsJustToFoolTheStupidCompiler; // size: 0x1, address: 0x803C19B5
// Range: 0x800984D4 -> 0x8009854C
...
// Range: 0x8009854C -> 0x80098620
void zCutsceneMgrFinishExit(struct xBase * to /* r1+0x8 */) {
    // Local variables
    struct zCutsceneMgr * t; // r31
    int i; // r30
...
// Range: 0x80098620 -> 0x80098688
static void zCutsceneMgrKillFX(struct zCutsceneMgr * t /* r0 */) {
    // Local variables
    struct xCutsceneMgrAsset * a; // r30
    int i; // r29
    struct zParEmitter * e; // r0
}

// Range: 0x80098688 -> 0x8009873C
static void zCutsceneMgrUpdateFX(struct zCutsceneMgr * t /* r0 */) {
    // Local variables
    struct xCutsceneMgrAsset * a; // r29
    struct xCutscene * csn; // r28
    int i; // r27
    struct zParEmitter * e; // r0
}

static int doCineFX; // size: 0x4, address: 0x803C19B8
static signed char init; // size: 0x1, address: 0x803C19BC
// Range: 0x8009873C -> 0x800989E0
void zCutsceneMgrUpdate(struct xBase * to /* r31 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
    struct zCutsceneMgr * t; // r31
    int i; // r30
    int i; // r1+0x8
...
// Range: 0x80098A80 -> 0x80098B74
static void check_hide_entities() {
    // Local variables
    unsigned char hide; // r4
