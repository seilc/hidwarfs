/*
    ...
    Language: C++
    Code range: 0x800C40C4 -> 0x800C8370
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zParEmitter * sEmitTremble; // size: 0x4, address: 0x803C2170
static struct zParEmitter * sEmitBreakaway; // size: 0x4, address: 0x803C2174
// total size: 0x10
...
static struct effect * sRumbleBreakaway; // size: 0x4, address: 0x803C2178
static unsigned int entToCheck; // size: 0x4, address: 0x803C217C
static signed char init; // size: 0x1, address: 0x803C2180
// total size: 0x50
...
// Range: 0x800C4130 -> 0x800C4134
void zPlatform_ScenePrepare() {}

// Range: 0x800C4134 -> 0x800C4154
...
// Range: 0x800C4154 -> 0x800C4638
void zPlatform_Init(struct zPlatform * plat /* r31 */, struct xEntAsset * asset /* r0 */) {
    // Local variables
...
// Range: 0x800C4710 -> 0x800C4730
void zPlatform_Save(struct zPlatform * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800C4730 -> 0x800C4750
void zPlatform_Load(struct zPlatform * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800C4750 -> 0x800C4784
...
// Range: 0x800C4784 -> 0x800C4C10
void zPlatform_Reset(struct zPlatform * plat /* r30 */, struct xScene * sc /* r31 */) {
    // Local variables
    struct RpAtomic * imodel; // r29
    struct xSurface * surf; // r28
    struct xAnimPlay * tempAnim; // r27
    struct xAnimTable * temptbl; // r26
    unsigned short tempFlags; // r25
    void * tempObject; // r24
    int i; // r0
...
// Range: 0x800C5008 -> 0x800C50F4
void zPlatform_PaddleStartRotate(struct xEnt * entplat /* r3 */, int direction /* r0 */, int stutter /* r0 */) {
    // Local variables
...
// Range: 0x800C50F4 -> 0x800C6010
static void zPlatFM_Update(struct zPlatform * plat /* r29 */, float dt /* f28 */) {
    // Local variables
...
// Range: 0x800C6010 -> 0x800C6518
void zPlatformBreakaway_Update(struct zPlatform * plat /* r31 */, struct xScene * sc /* r30 */, float dt /* f31 */) {
    // Local variables
    struct xAnimState * ast; // r3
...
unsigned char * g_iAnim_workBuffer; // size: 0x4, address: 0x803BDC98
// Range: 0x800C6518 -> 0x800C6DD0
...
// total size: 0x54
struct /* @class$1227zPlatform_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zPlatform_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zPlatform_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zPlatform_cpp */ {
    // Members
...
// Range: 0x800C6DD0 -> 0x800C6E24
void zPlatform_Move(struct xEnt * entplat /* r30 */, struct xScene * s /* r31 */, float dt /* f31 */, struct xEntFrame * frame /* r0 */) {
    // Local variables
...
// Range: 0x800C707C -> 0x800C7128
void zPlatform_Mount(struct zPlatform * plat /* r31 */) {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x800C7128 -> 0x800C71D8
...
// Range: 0x800C71D8 -> 0x800C721C
static void zPlatformTranslate(struct xEnt * xent /* r29 */, struct xVec3 * dpos /* r30 */, struct xMat4x3 * dmat /* r31 */) {
    // Local variables
    struct zPlatform * plat; // r0
}

// Range: 0x800C721C -> 0x800C7344
static void zPlatFM_EventSetup(struct zPlatform * plat /* r3 */, const float * toParam /* r0 */, int idx /* r0 */, unsigned int mask /* r0 */) {
    // Local variables
    struct zPlatFMRunTime * fmrt; // r31
    float ds; // f3
    float ttm; // f4
...
// Range: 0x800C7344 -> 0x800C8370
void zPlatformEventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r28 */, const float * toParam /* r30 */, struct xBase * toParamWidget /* r29 */, unsigned int toParamWidgetID /* r9 */) {
    // Local variables
    struct zPlatform * plat; // r31
    float tp[4]; // r1+0x20
    int iParam0; // r4
