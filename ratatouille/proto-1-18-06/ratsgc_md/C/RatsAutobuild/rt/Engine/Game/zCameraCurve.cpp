/*
    ...
    Language: C++
    Code range: 0x80167110 -> 0x80167A14
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80167358 -> 0x801673C0
// this: r31
struct xVec3 & Follower::PlayerPathPos() {}

// Range: 0x801673C0 -> 0x801673F8
// this: r31
...
struct zCamTargetSpline : public zCam2Player, public zCamSplineCommonMix {
    // Members
    struct xCamSpatialInfo oldSpatial; // offset 0x450, size 0x30
    struct xMat4x3 oldMat; // offset 0x480, size 0x40
    class xSpringyF32 mYOffset; // offset 0x4C0, size 0x18
};
// total size: 0x18
class zCamPool : public zCamPoolBase {};
static class zCamPool sCamCurvePOIPool; // size: 0x18, address: 0x803C31B0
// total size: 0x260
struct zCamSpline : public xCam, public zCamSplineCommonMix {
    // Members
    float mTargetyOffset; // offset 0x1B0, size 0x4
    class xSpringyVec3 mSprungTargetPos; // offset 0x1B4, size 0x28
    class xSpringyF32 mMountY; // offset 0x1DC, size 0x18
    class xSpringyF32 mXOffset; // offset 0x1F4, size 0x18
    class xSpringyF32 mYOffset; // offset 0x20C, size 0x18
    class xSpringyAngle mYaw; // offset 0x224, size 0x18
    class xSpringyAngle mPitch; // offset 0x23C, size 0x18
};
// total size: 0x18
class zCamPool : public zCamPoolBase {};
static class zCamPool sCamCurveRailPool; // size: 0x18, address: 0x803C31C8
struct xCam * sLastAddedCam; // size: 0x4, address: 0x803C31E0
// Range: 0x80167530 -> 0x80167550
void zCameraCurve_Init(void * base /* r0 */, void * asset /* r0 */) {}

// Range: 0x80167550 -> 0x801676BC
// this: r31
...
// total size: 0xC
struct /* @class$747zCameraCurve_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$748zCameraCurve_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$749zCameraCurve_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$750zCameraCurve_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$751zCameraCurve_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$752zCameraCurve_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$753zCameraCurve_cpp */ {
    // Members
...
// Range: 0x80167768 -> 0x80167840
// this: r31
int zCameraCurve::FindBeadPlayerU(float playerU /* f1 */) const {
    // Local variables
...
// Range: 0x80167840 -> 0x80167844
void zCameraCurve::Start() {}

// Range: 0x80167844 -> 0x80167850
// this: r0
...
// Range: 0x80167850 -> 0x801678EC
// this: r28
unsigned char zCameraCurve::Activate(const struct xCamTransitionParams * transition /* r29 */, unsigned char forceRestart /* r30 */) {
    // Local variables
    struct xCam * theCam; // r31
    class zCamSplineCommonMix * splineHelper; // r0
...
// total size: 0x4
struct /* @class$916zCameraCurve_cpp */ {
    // Members
...
union /* @class$766zCameraCurve_cpp */ {
...
// total size: 0xC
struct /* @class$936zCameraCurve_cpp */ {
    // Members
...
// total size: 0x18
struct /* @class$875zCameraCurve_cpp */ {
    // Members
...
// Range: 0x801678EC -> 0x80167964
void zCameraCurve_EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {}
