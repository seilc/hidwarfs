/*
    ...
    Language: C++
    Code range: 0x801390C0 -> 0x8013A9BC
*/
static unsigned int gTriangleFlags[3][256]; // size: 0xC00, address: 0x803889B8
static unsigned int gCurrentFlagValue; // size: 0x4, address: 0x803C2E90
static int gRecursiveCallCount; // size: 0x4, address: 0x803C2E94
// Range: 0x801390C0 -> 0x80139114
...
// Range: 0x80139114 -> 0x80139298
static unsigned char zMeshCollisionSweptCircleToPoint(class zSweptCircle & sweptCircle /* r28 */, const struct xVec3 & point /* r29 */, const struct xVec2 & toStart /* r30 */, const struct xVec2 & fallbackHitNormal /* r31 */) {
    // Local variables
...
// Range: 0x80139298 -> 0x80139880
static unsigned char zMeshCollisionSweptCircleToMeshRecurse(class zSweptCircle & sweptCircle /* r21 */, class xNavigationMeshAsset * mesh /* r22 */, int subMeshIndex /* r23 */, int triangleIndex /* r24 */) {
    // Local variables
...
// Range: 0x80139880 -> 0x80139904
unsigned char zMeshCollisionSweptCircleToMesh(class zSweptCircle & sweptCircle /* r28 */, class zMeshPosition & meshPosition /* r29 */) {
    // References
    // -> static int gRecursiveCallCount;
}
...
// Range: 0x80139904 -> 0x80139ACC
unsigned char zMeshCollisionSweptCircleToCircles(class zSweptCircle & sweptCircle /* r29 */, class zMeshCircle * nearbyCircles /* r4 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$803zMeshCollision_cpp */ {
    // Members
...
union /* @class$823zMeshCollision_cpp */ {
...
// total size: 0xC
struct /* @class$821zMeshCollision_cpp */ {
    // Members
...
static unsigned char zMeshCollisionFindShortestCollision(const struct xVec2 & center /* r26 */, float radius /* f30 */, const struct xVec2 & validDpos /* r27 */, const struct xVec2 & dir /* r28 */, float dist /* f31 */, struct CircleCollisionResults & results /* r29 */, class zMeshPosition & meshPosition /* r30 */, class zMeshCircle * nearbyCircles /* r31 */) {
    ...
    class zSweptCircle sweptCircle; // r1+0x10
}

// Range: 0x80139D24 -> 0x80139F8C
unsigned char zMeshCollisionSweptCircleEnemies(class zMeshPosition & meshPosition /* r31 */, float radius /* f26 */, const struct xVec2 & desiredDpos /* r27 */, class zMeshCircle * nearbyCircles /* r26 */) {
    // Local variables
...
// Range: 0x80139F8C -> 0x80139FE8
static unsigned char zMeshCollisionSeenBefore(int subMeshIndex /* r0 */, int vert0Index /* r0 */, int vert1Index /* r0 */, struct zMeshCollisionRecord * previousCollisions /* r0 */, int numCollisions /* r0 */) {
    // Local variables
    unsigned int edgeID; // r0
    int i; // r0
}

// Range: 0x80139FE8 -> 0x8013A068
...
// Range: 0x8013A5BC -> 0x8013A5F4
static unsigned char zMeshCollisionSeenBefore(class zMeshCircle * circle /* r0 */, struct zMeshCollisionRecord * previousCollisions /* r0 */, int numCollisions /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8013A5F4 -> 0x8013A6C0
...
// Range: 0x8013A8B0 -> 0x8013A95C
// this: r29
void zSweptCircle::Prepare(const struct xVec2 & start /* r30 */, float radius /* f30 */, const struct xVec2 & dir /* r31 */, float dist /* f31 */) {}

// Range: 0x8013A95C -> 0x8013A9BC
// this: r31
