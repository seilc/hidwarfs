/*
    ...
    Language: C++
    Code range: 0x80133610 -> 0x80134410
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80133610 -> 0x80133614
static void add_tweaks() {}

static class module_type * module; // size: 0x4, address: 0x803C2E60
// Range: 0x80133614 -> 0x80133628
...
// Range: 0x801337E4 -> 0x801337E8
static void module_type::debug_update() {}

// Range: 0x801337E8 -> 0x80133814
// this: r0
...
// Range: 0x80133830 -> 0x8013385C
// this: r0
static struct ring_type * module_type::alloc_ring() {}

// Range: 0x8013385C -> 0x801338BC
// this: r31
...
// Range: 0x80133EE0 -> 0x80133EEC
void zSmashRingSceneExit() {
    // References
    // -> static class module_type * module;
}

// Range: 0x80133EEC -> 0x80133F18
void zSmashRingReset() {
    // References
    // -> static class module_type * module;
}

// Range: 0x80133F18 -> 0x80133F44
void zSmashRingUpdate(float dt /* f0 */) {
    // References
    // -> static class module_type * module;
}

// Range: 0x80133F44 -> 0x80133F70
