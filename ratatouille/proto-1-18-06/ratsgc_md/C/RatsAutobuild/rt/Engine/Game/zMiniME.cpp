/*
    ...
    Language: C++
    Code range: 0x801A0A34 -> 0x801A3A1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char curveCmds[1][16]; // size: 0x10, address: 0x803BF858
static char actionCmds[3][16]; // size: 0x30, address: 0x803BF868
static char minigameCmds[1][16]; // size: 0x10, address: 0x803BF898
// total size: 0x8
...
struct /* @class$1029zMiniME_cpp */ {
    ...
    char * string; // offset 0x0, size 0x4
    unsigned int value; // offset 0x4, size 0x4
} inputData[9]; // size: 0x48, address: 0x802E19B8
// total size: 0x4
struct node {
    // Members
...
static struct xResponseCurve alphaCurve; // size: 0x10, address: 0x803C3778
// total size: 0x8
...
struct /* @class$1039zMiniME_cpp */ {
    ...
    unsigned int hash; // offset 0x0, size 0x4
    unsigned int event; // offset 0x4, size 0x4
} eventData[1067]; // size: 0x2158, address: 0x802E1A00
// total size: 0x8
struct curve_node {
    // Members
    float t; // offset 0x0, size 0x4
...
static class zMiniME singleMM; // size: 0x41CC, address: 0x80390BE8
// Range: 0x801A0A34 -> 0x801A0A40
class zMiniME & zMiniME::GetMgr() {
    // References
    // -> static class zMiniME singleMM;
}

// Range: 0x801A0A40 -> 0x801A0A60
void zMiniME::Init() {}
...
struct /* @class$1054zMiniME_cpp */ {
    ...
    float t; // offset 0x0, size 0x4
    float a; // offset 0x4, size 0x4
} alphas[4]; // size: 0x20, address: 0x803C8DD8
enum xCamCoordType {
...
// Range: 0x801A0B58 -> 0x801A0BC0
static float get_F32(char * in /* r30 */, char * * out /* r31 */) {
    // Local variables
    float val; // f31
}

// Range: 0x801A0BC0 -> 0x801A0C94
...
// Range: 0x801A1C34 -> 0x801A1C60
// this: r0
void zMinigame::Start(unsigned int ID /* r0 */) {}

// Range: 0x801A1C60 -> 0x801A1C74
// this: r0
void zMinigame::Stop() {}

static float last_hit[10]; // size: 0x28, address: 0x803C3790
// Range: 0x801A1C74 -> 0x801A2214
// this: r27
...
struct /* @class$1707zMiniME_cpp */ {
    ...
    unsigned int id; // offset 0x0, size 0x4
    struct RwTexture * texture; // offset 0x4, size 0x4
} textures[5]; // size: 0x28, address: 0x803BF8A8
// Range: 0x801A2410 -> 0x801A26A0
// this: r31
...
struct /* @class$1770zMiniME_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
} sGoodFX[8]; // size: 0x20, address: 0x803C37B8
static int sNumGoodFX; // size: 0x4, address: 0x803C37D8
static struct RwTexture * sGoodFXTex; // size: 0x4, address: 0x803C37DC
// Range: 0x801A26EC -> 0x801A2750
...
static int numDeflectors; // size: 0x4, address: 0x803C37E0
static class zAnalogInputDeflection * deflectors[16]; // size: 0x40, address: 0x803C37E4
static int numDirectors; // size: 0x4, address: 0x803C3824
static class zAnalogInputDirection * directors[16]; // size: 0x40, address: 0x803C3828
static int numTwiddlers; // size: 0x4, address: 0x803C3868
static class zAnalogInputTwiddler * twiddlers[16]; // size: 0x40, address: 0x803C386C
static int numPours; // size: 0x4, address: 0x803C38AC
static class zCMGPourWidget * pours[16]; // size: 0x40, address: 0x803C38B0
// total size: 0x1
class zAnalogInput {};
// Range: 0x801A28DC -> 0x801A29FC
...
unsigned int pourBarTexID; // size: 0x4, address: 0x803BF8D0
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
