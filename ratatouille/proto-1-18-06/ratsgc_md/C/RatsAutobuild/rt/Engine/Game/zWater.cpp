/*
    ...
    Language: C++
    Code range: 0x800F9E4C -> 0x800F9F64
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800F9E4C -> 0x800F9E6C
void zWaterBody::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800F9E6C -> 0x800F9E78
// this: r0
void zWaterBody::show() {}

// Range: 0x800F9E78 -> 0x800F9E84
// this: r0
void zWaterBody::hide() {}

// Range: 0x800F9E84 -> 0x800F9EFC
// this: r31
void zWaterBody::load(const struct asset_type & a /* r0 */) {}

// Range: 0x800F9EFC -> 0x800F9F08
// this: r0
...
// Range: 0x800F9F08 -> 0x800F9F64
void zWaterBody::cb_dispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */) {
    // Local variables
    class zWaterBody & e; // r4
}
