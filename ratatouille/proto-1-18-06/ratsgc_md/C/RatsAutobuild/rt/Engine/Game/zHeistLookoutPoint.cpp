/*
    ...
    Language: C++
    Code range: 0x8018F66C -> 0x801900A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x14
struct {} zHeistLookoutPoint::__vtable; // size: 0x14, address: 0x803BF4B8
// total size: 0x50
