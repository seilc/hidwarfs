/*
    ...
    Language: C++
    Code range: 0x80118FA0 -> 0x80119E28
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char unlockedMovies[53]; // size: 0x35, address: 0x803C2B10
char sceneBaseName[32]; // size: 0x20, address: 0x803C2B48
char sceneBaseDescription[256]; // size: 0x100, address: 0x803804C0
static const char * SCENE_STATUS_BONUS; // size: 0x4, address: 0x803C2B68
static unsigned char unlockCheatOn; // size: 0x1, address: 0x803C2B6C
static unsigned char sceneUnlockAll; // size: 0x1, address: 0x803C2B6D
int numScenes; // size: 0x4, address: 0x803C308C
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80118FA0 -> 0x801190FC
static unsigned int GetSceneNumber(const char * str /* r27 */, unsigned int size /* r28 */, unsigned char * isBM01 /* r0 */) {
    // Local variables
    unsigned int sceneCurrent; // r31
    unsigned char isNumber; // r30
    unsigned int i; // r29
...
// total size: 0x4
struct /* @class$786zUIIncredibles_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zUIIncredibles_cpp */ {
    // Members
...
union /* @class$805zUIIncredibles_cpp */ {
...
// total size: 0x2
struct /* @class$1051zUIIncredibles_cpp */ {
    // Members
...
static char buffer[48]; // size: 0x30, address: 0x803C2B70
// Range: 0x801192C0 -> 0x801193A8
...
// Range: 0x80119418 -> 0x80119464
static void ParseTagIgnore(struct jot & j /* r31 */) {}

// Range: 0x80119464 -> 0x801194D0
static void ParseTagSpace(struct jot & j /* r31 */) {}

static struct tag_type newTags[7]; // size: 0x8C, address: 0x802DC9E8
static unsigned int SCENEFLAGS_UNLOCKED; // size: 0x4, address: 0x803C7228
// total size: 0x14
struct SceneUnlock {
    // Members
    unsigned int sceneID; // offset 0x0, size 0x4
...
// Range: 0x801194D0 -> 0x80119574
static void zUIUnlockRelatedStages(unsigned int sceneID /* r28 */) {
    // Local variables
    int i; // r30
    struct SceneUnlock * scene; // r0
    int j; // r28
...
// Range: 0x80119574 -> 0x8011959C
unsigned char zUIIncrediblesIsSceneCompleted(int idx /* r0 */) {}

// Range: 0x8011959C -> 0x801195C4
unsigned char zUIIncrediblesIsSceneUnlocked(int idx /* r0 */) {}

static unsigned int SCENEFLAGS_COMPLETED; // size: 0x4, address: 0x803C722C
static unsigned int SCENEFLAGS_WAS_COMPLETED; // size: 0x4, address: 0x803C7230
// total size: 0x18
...
int latestScene; // size: 0x4, address: 0x803C3098
// Range: 0x801195C4 -> 0x801196B4
...
// Range: 0x80119738 -> 0x80119788
unsigned char zUIIncrediblesAllGoalsCompleted() {
    // Local variables
    int i; // r31
}

// Range: 0x80119788 -> 0x80119824
...
// Range: 0x80119874 -> 0x801198C4
unsigned char zUIIncrediblesAllScenesCompleted() {
    // Local variables
    int i; // r31
}

// Range: 0x801198C4 -> 0x8011990C
unsigned char zUIIncrediblesAllCompleted() {}

enum UnlockFeature {
    Unlock_Scenes = 0,
};
int numStoryScenes; // size: 0x4, address: 0x803C3090
int numArenaScenes; // size: 0x4, address: 0x803C3094
char * allsoaklevels[]; // size: 0x0, address: 0x8038DF80
char sceneBaseImage[32]; // size: 0x20, address: 0x803C30B0
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x80119AF4 -> 0x80119B28
void zUIIncrediblesSceneSetup() {
    // References
    // -> static const char * SCENE_STATUS_BONUS;
}

// Range: 0x80119B28 -> 0x80119B48
unsigned int zUIIncrediblesGetTotalCheckpoints() {}

// Range: 0x80119B48 -> 0x80119B68
...
// Range: 0x80119B68 -> 0x80119B8C
void zUIIncrediblesWarp(struct _xCounter * counter /* r0 */) {}

// Range: 0x80119B8C -> 0x80119BFC
void zUIIncrediblesWarpDirect(unsigned int sceneIndex /* r0 */) {
    // Local variables
    struct Scene * scene; // r0
...
static struct _zPortal portal; // size: 0x14, address: 0x803C2BA0
// total size: 0x18
...
// Range: 0x80119D14 -> 0x80119D3C
void zUIIncrediblesHitCheckPoint() {}

// Range: 0x80119D3C -> 0x80119D5C
void zUIIncrediblesPlayedMovie(int index /* r0 */) {
    // References
    // -> static unsigned char unlockedMovies[53];
}

// Range: 0x80119D5C -> 0x80119DB0
void zUIIncrediblesOpenBonus(int index /* r3 */) {
    // Local variables
    struct Scene * scene; // r0
}

// Range: 0x80119DB0 -> 0x80119DB4
...
static enum ePauseType pause_type; // size: 0x4, address: 0x803C2BCC
// Range: 0x80119DB4 -> 0x80119DBC
enum ePauseType zUIIncrediblesGetPauseType() {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x80119DBC -> 0x80119DC4
void zUIIncrediblesSetPauseType(enum ePauseType type /* r0 */) {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x80119DC4 -> 0x80119DC8
void zUIIncrediblesLoad() {}

// Range: 0x80119DC8 -> 0x80119DFC
unsigned int zUIIncrediblesGetGameProgress() {}

// Range: 0x80119DFC -> 0x80119E28
