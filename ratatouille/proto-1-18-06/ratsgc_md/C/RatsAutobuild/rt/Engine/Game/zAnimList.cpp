/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zAnimList.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8008D8CC -> 0x8008DD9C
*/
static int nals; // size: 0x4, address: 0x803C18F8
static unsigned int * aids; // size: 0x4, address: 0x803C18FC
// total size: 0xC
struct RwV3d {
    // Members
...
static struct xAnimTable * * atbls; // size: 0x4, address: 0x803C1900
static int * anused; // size: 0x4, address: 0x803C1904
static char * astnames[20]; // size: 0x50, address: 0x802D41A0
// Range: 0x8008D8CC -> 0x8008D8D4
...
// Range: 0x8008D8D4 -> 0x8008D974
static void AddAnimCustom(struct zAnimListAsset * a /* r28 */) {
    // Local variables
    int i; // r29
...
void zAnimListInit() {
    ...
    struct xAnimTable * atbl; // r27
    void * buf; // r0
    struct xAnimFile * afile; // r22
    int idle_exists; // r0
    int j; // r26
    struct xAnimFile * afile; // r25
