/*
    ...
    Language: C++
    Code range: 0x80120A1C -> 0x801220A0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zLightweightSystem * zLightweight<z::uber_laser, 5>::GetSystem()::system; // size: 0x4, address: 0x803C2C38
signed char zLightweight<z::uber_laser, 5>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C2C3C
// total size: 0x4
struct RwRGBA {
    // Members
...
struct config default_config; // size: 0x180, address: 0x802DCA78
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x24
struct {} zLightweightSystem<z::uber_laser, 5>::__vtable; // size: 0x24, address: 0x803BE8E8
int ring_explosion; // size: 0x4, address: 0x803C2C40
enum iSndGroupHandle {
};
enum iSndGroupHandle shoot_charge; // size: 0x4, address: 0x803C2C44
enum iSndGroupHandle shoot; // size: 0x4, address: 0x803C2C48
enum iSndGroupHandle shoot_end; // size: 0x4, address: 0x803C2C4C
enum iSndGroupHandle explode; // size: 0x4, address: 0x803C2C50
struct RwRaster * beam_raster; // size: 0x4, address: 0x803C2C54
// total size: 0x24
...
struct RxObjSpace3DVertex * vert; // size: 0x4, address: 0x803C2C58
// total size: 0x18
...
// Range: 0x80120C04 -> 0x80120C64
// this: r31
void uber_laser::Destroy() {}

// total size: 0x20
struct {} z::uber_laser::__vtable; // size: 0x20, address: 0x803BE8A8
// Range: 0x80120C64 -> 0x80120D8C
// this: r31
...
// total size: 0x20
struct {} zLightweight<z::uber_laser, 5>::__vtable; // size: 0x20, address: 0x803BE8C8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static int trail_type; // size: 0x4, address: 0x803C2C5C
static signed char init; // size: 0x1, address: 0x803C2C60
// Range: 0x80120FBC -> 0x80121088
// this: r29
...
static int laser_count; // size: 0x4, address: 0x803C2C64
void * RwEngineInstance; // size: 0x4, address: 0x803C4584
// Range: 0x80121D94 -> 0x80121DE4
