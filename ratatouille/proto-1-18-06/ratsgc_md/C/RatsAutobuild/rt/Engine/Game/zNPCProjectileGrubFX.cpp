/*
    ...
    Language: C++
    Code range: 0x8017831C -> 0x8017AAA4
*/
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig defaultConfig; // size: 0x44, address: 0x80390160
int systemID; // size: 0x4, address: 0x803BF180
// total size: 0x1
...
// total size: 0x4
struct /* @class$786zNPCProjectileGrubFX_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zNPCProjectileGrubFX_cpp */ {
    // Members
...
union /* @class$805zNPCProjectileGrubFX_cpp */ {
...
static struct TrailConfig defaultTConfig; // size: 0x38, address: 0x803C32C0
int systemID; // size: 0x4, address: 0x803BF184
// total size: 0x1
class zNPCProjectileTGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80178954 -> 0x80178A44
...
struct SparkConfig defaultSparkConfig; // size: 0x34, address: 0x803C32F8
struct SparkConfig burstSparkConfig; // size: 0x34, address: 0x803C332C
int systemID; // size: 0x4, address: 0x803BF188
// total size: 0x1
class zNPCProjectileGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80178FA0 -> 0x801790B8
...
struct SparkConfig defaultESparkConfig; // size: 0x34, address: 0x803C3360
struct SparkConfig burstESparkConfig; // size: 0x34, address: 0x803C3394
int systemID; // size: 0x4, address: 0x803BF18C
// total size: 0x1
class zNPCProjectileEGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x8017970C -> 0x80179894
...
static struct ArcConfig defaultArcConfig; // size: 0x1C, address: 0x803C33C8
int systemID; // size: 0x4, address: 0x803BF190
// total size: 0x1
class zNPCProjectileGrubArc {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80179C20 -> 0x80179CD8
...
static unsigned int HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x803C33E4
// total size: 0x10
...
static struct GrubHitExplosion * sHitExplosions; // size: 0x4, address: 0x803C33E8
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x8017A1F0 -> 0x8017A224
...
static unsigned int BIG_HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x803C33EC
// total size: 0x80
...
static struct GrubBigHitExplosion * sBigHitExplosions; // size: 0x4, address: 0x803C33F0
// total size: 0x10
struct _xFColor {
    // Members
...
class zForceFieldEffect {
    // Members
    struct meshData mesh; // offset 0x0, size 0x30
    struct xMat4x3 ball_mat; // offset 0x30, size 0x40
    float energy_spin; // offset 0x70, size 0x4
    float Aold; // offset 0x74, size 0x4
    float Avel; // offset 0x78, size 0x4
    float midHeight; // offset 0x7C, size 0x4
    int sphereRows; // offset 0x80, size 0x4
    int midRows; // offset 0x84, size 0x4
    struct xVec3 offset; // offset 0x88, size 0xC
    float scale; // offset 0x94, size 0x4
    unsigned char used; // offset 0x98, size 0x1
    unsigned char skipFrame; // offset 0x99, size 0x1
    unsigned char overrideColor; // offset 0x9A, size 0x1
    unsigned char distortShield; // offset 0x9B, size 0x1
    float lastUsedTime; // offset 0x9C, size 0x4
    float fadeTimer; // offset 0xA0, size 0x4
    struct _xFColor baseShieldColor; // offset 0xA4, size 0x10
    struct _xFColor currentColor; // offset 0xB4, size 0x10
    float shieldColorCycle; // offset 0xC4, size 0x4
    float shieldStrength; // offset 0xC8, size 0x4
    float timeToNextRipple; // offset 0xCC, size 0x4
    unsigned char shieldDestroyed; // offset 0xD0, size 0x1
    float arcEmitRemaining; // offset 0xD4, size 0x4
    struct xModelInstance * electricModel; // offset 0xD8, size 0x4
};
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8017A9A4 -> 0x8017A9D4
void zNPCProjectileGrubFX_SceneSetup() {}

// Range: 0x8017A9D4 -> 0x8017A9E4
...
// Range: 0x8017A9E4 -> 0x8017AA08
void zNPCProjectileGrubFX_SceneReset() {}

// Range: 0x8017AA08 -> 0x8017AA3C
void zNPCProjectileGrubFX_Update(float dt /* f31 */) {}

// Range: 0x8017AA3C -> 0x8017AA60
