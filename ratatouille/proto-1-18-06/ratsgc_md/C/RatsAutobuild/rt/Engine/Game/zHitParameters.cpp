/*
    ...
    Language: C++
    Code range: 0x800B5A80 -> 0x800B5B04
*/
enum zHitSource {
    zHS_EVENT = 0,
    zHS_GENERAL = 1,
...
unsigned int zHitSourceCCs[65]; // size: 0x104, address: 0x802D9ED0
// Range: 0x800B5A80 -> 0x800B5B04
int getSourceCCIdx(unsigned int value /* r28 */) {
    // Local variables
    int i; // r29
    char tag[4]; // r1+0x8
