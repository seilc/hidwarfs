/*
    ...
    Language: C++
    Code range: 0x800BEE20 -> 0x800BEFFC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zMovePoint * g_mvpt_list; // size: 0x4, address: 0x803C20E0
static int g_mvpt_cnt; // size: 0x4, address: 0x803C20E4
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x800BEE20 -> 0x800BEE6C
struct zMovePoint * zMovePoint_GetMemPool(int cnt /* r31 */) {
    // References
...
// Range: 0x800BEE6C -> 0x800BEED4
void zMovePointInit(struct zMovePoint * m /* r30 */, struct xMovePointAsset * asset /* r31 */) {}

// Range: 0x800BEED4 -> 0x800BEEE4
struct zMovePoint * zMovePoint_GetInst(int n /* r0 */) {
    // References
    // -> static struct zMovePoint * g_mvpt_list;
}
...
// total size: 0x4
struct /* @class$805zMovePoint_cpp */ {
    // Members
...
// Range: 0x800BEEE4 -> 0x800BEF04
void zMovePointSetup(struct zMovePoint * mvpt /* r0 */, struct zScene * scn /* r0 */) {}

// total size: 0x0
struct xSerial {};
// Range: 0x800BEF04 -> 0x800BEF24
void zMovePointSave(struct zMovePoint * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800BEF24 -> 0x800BEF44
void zMovePointLoad(struct zMovePoint * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800BEF44 -> 0x800BEF64
void zMovePointReset(struct zMovePoint * ent /* r0 */) {}

// Range: 0x800BEF64 -> 0x800BEFDC
void zMovePointEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
    struct zMovePoint * m; // r4
}

// Range: 0x800BEFDC -> 0x800BEFFC
...
// total size: 0xC
struct /* @class$825zMovePoint_cpp */ {
    // Members
