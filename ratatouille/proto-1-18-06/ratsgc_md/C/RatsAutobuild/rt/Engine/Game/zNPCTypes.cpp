/*
    ...
    Language: C++
    Code range: 0x801758AC -> 0x8017631C
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zNPCTypesTable gNPCTypesTable[17]; // size: 0x4C8, address: 0x802DF960
enum eCompType {
    eCompType_Unknown = -1,
...
static unsigned char gNPCTypesTableInitialized; // size: 0x1, address: 0x803C3268
// Range: 0x801758AC -> 0x801758B8
...
// Range: 0x801759A4 -> 0x801759AC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759AC -> 0x801759B4
unsigned char ValidateNPCAsset() {}

// Range: 0x801759B4 -> 0x801759BC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759BC -> 0x801759C4
unsigned char ValidateNPCAsset() {}

// Range: 0x801759C4 -> 0x801759CC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759CC -> 0x801759D4
unsigned char ValidateNPCAsset() {}

// Range: 0x801759D4 -> 0x801759DC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759DC -> 0x801759E4
unsigned char ValidateNPCAsset() {}

// Range: 0x801759E4 -> 0x801759EC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759EC -> 0x801759F4
unsigned char ValidateNPCAsset() {}

// Range: 0x801759F4 -> 0x801759FC
unsigned char ValidateNPCAsset() {}

// Range: 0x801759FC -> 0x80175A04
unsigned char ValidateNPCAsset() {}

// Range: 0x80175A04 -> 0x80175A0C
unsigned char ValidateNPCAsset() {}

// Range: 0x80175A0C -> 0x80175A14
unsigned char ValidateNPCAsset() {}

// Range: 0x80175A14 -> 0x80175A1C
unsigned char ValidateNPCAsset() {}

// Range: 0x80175A1C -> 0x80175A74
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175AAC -> 0x80175B04
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175B3C -> 0x80175B94
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175BCC -> 0x80175C24
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175C5C -> 0x80175CB4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175CEC -> 0x80175D44
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175D7C -> 0x80175DD4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175E0C -> 0x80175E64
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175E9C -> 0x80175EF4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175F2C -> 0x80175F84
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175FBC -> 0x80176014
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x8017604C -> 0x801760A4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x801760DC -> 0x80176134
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x8017616C -> 0x801761C4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x801761FC -> 0x80176254
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x8017628C -> 0x801762E4
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}
