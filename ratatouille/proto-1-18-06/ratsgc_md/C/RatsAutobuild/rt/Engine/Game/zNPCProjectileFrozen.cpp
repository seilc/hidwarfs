/*
    ...
    Language: C++
    Code range: 0x801763D4 -> 0x801771C0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xLightKit * envLightKit; // size: 0x4, address: 0x803C3270
// total size: 0x18
struct animix {
    // Members
...
static struct curve_node meltedPoolCurveNodes[4]; // size: 0x70, address: 0x802B2C88
// Range: 0x801763D4 -> 0x801763EC
...
// total size: 0xC
struct /* @class$751zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zNPCProjectileFrozen_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zNPCProjectileFrozen_cpp */ {
    // Members
...
static struct xResponseCurve meltedPoolCurve; // size: 0x10, address: 0x803C3274
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$786zNPCProjectileFrozen_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1112zNPCProjectileFrozen_cpp */ {
    // Members
...
union /* @class$805zNPCProjectileFrozen_cpp */ {
...
// total size: 0xC
struct /* @class$804zNPCProjectileFrozen_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
static struct FrozenProjectileAssets assets[2]; // size: 0x160, address: 0x802DFE28
// Range: 0x801763EC -> 0x80176414
...
static struct zParSysSnowsplosionConfig snowConfig; // size: 0x28, address: 0x803C84F8
// total size: 0x18
...
// Range: 0x80176C80 -> 0x80176DE8
// this: r30
static void zNPCProjectileFrozen::Activate(const struct xMat4x3 & frameMatrix /* r29 */, const struct xVec3 & velocity /* r31 */, enum zNPCProjectileFrozenType newType /* r6 */) {
    // References
...
static class zNPCProjectileFrozenManager frozenManager; // size: 0x24, address: 0x803C3284
// Range: 0x80176DE8 -> 0x80176E20
void zNPCProjectileFreeze(const struct xMat4x3 & frameMatrix /* r7 */, const struct xVec3 & velocity /* r0 */, enum zNPCProjectileFrozenType type /* r6 */) {
    // References
    // -> static class zNPCProjectileFrozenManager frozenManager;
}

// Range: 0x80176E20 -> 0x80176EF4
// this: r26
...
struct {} @unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozenManager::__vtable; // size: 0x24, address: 0x803BF0DC
// Range: 0x80176FB4 -> 0x80176FEC
// this: r31
...
// total size: 0x24
struct {} zLightweightList<@unnamed@zNPCProjectileFrozen_cpp@::zNPCProjectileFrozen>::__vtable; // size: 0x24, address: 0x803BF0B8
// Range: 0x80177024 -> 0x8017707C
// this: r31
static void zNPCProjectileFrozen::Exit() {}

// Range: 0x8017707C -> 0x80177080
static void zNPCProjectileFrozen::PostRender3d() {}

// Range: 0x80177080 -> 0x80177088
// this: r3
static unsigned char zNPCProjectileFrozen::IsActive() const {}

// Range: 0x80177088 -> 0x8017708C
static void zNPCProjectileFrozen::PostRender2d() {}

// Range: 0x8017708C -> 0x80177180
// this: r31
