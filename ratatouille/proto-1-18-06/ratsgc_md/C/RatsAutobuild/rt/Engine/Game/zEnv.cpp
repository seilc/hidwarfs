/*
    ...
    Language: C++
    Code range: 0x800A3D4C -> 0x800A4184
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800A3D6C -> 0x800A3E9C
void zEnvInit(struct _zEnv * env /* r28 */, struct xEnvAsset * easset /* r27 */) {
    // Local variables
    int mapper_count; // r0
    int i; // r28
...
// Range: 0x800A3E9C -> 0x800A3EE4
void zEnvSetup(struct _zEnv * env /* r31 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x800A3EE4 -> 0x800A3EE8
...
// Range: 0x800A3EE8 -> 0x800A3FAC
void zEnvRender(struct xEnv * env /* r26 */) {
    // Local variables
...
// Range: 0x800A3FAC -> 0x800A3FCC
void zEnvSave(struct _zEnv * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800A3FCC -> 0x800A3FEC
void zEnvLoad(struct _zEnv * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x800A3FEC -> 0x800A4010
void zEnvReset(struct _zEnv * env /* r0 */) {}

struct xEnv * gCurXEnv; // size: 0x4, address: 0x803C0D98
// Range: 0x800A4010 -> 0x800A4138
void zEnvEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, struct xBase * toParamWidget /* r7 */) {
    // References
    // -> struct xEnv * gCurXEnv;
    // -> struct zGlobals globals;
}

// Range: 0x800A4138 -> 0x800A4184
