/*
    ...
    Language: C++
    Code range: 0x800C8550 -> 0x800CDED8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800C8550 -> 0x800C857C
static void bound_update_wrapper(struct xEnt * ent /* r0 */, struct xVec3 * pos /* r0 */) {}

static unsigned char drawLorez; // size: 0x1, address: 0x803C2188
// Range: 0x800C857C -> 0x800C85E8
...
// Range: 0x800C85E8 -> 0x800C8680
static void ScaleHeadAnimMatrices(struct xVec3 * tran /* r29 */) {
    // Local variables
    const int * bones; // r0
    float scale; // f31
    int i; // r0
...
// total size: 0x4
struct /* @class$1380zPlayer_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1381zPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
struct config chronos_effect_config; // size: 0x44, address: 0x8036A868
struct config default_config; // size: 0x44, address: 0x80387AC0
float SECS_PER_VBLANK; // size: 0x4, address: 0x803C2078
// Range: 0x800C8680 -> 0x800C8A60
// this: r30
...
// Range: 0x800C8F58 -> 0x800C9448
// this: r31
void zPlayer::CollideTrigger(struct xScene * sc /* r15 */) {
    // Local variables
    ...
    int triggerTypes; // r23
    unsigned int playerMask; // r22
    int i; // r21
    struct zEntTrigger * trig; // r20
    struct xTriggerAsset * tasset; // r19
...
float sFarWall; // size: 0x4, address: 0x803BEAF4
// total size: 0x30
struct OOBExtent {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x800C958C -> 0x800C95B0
// this: r3
void zPlayer::StoreCheckPoint(const struct zPlayerCheckPoint & theCheckPoint /* r0 */) {}

// total size: 0x118
struct {} zPlayer::__vtable; // size: 0x118, address: 0x802DA218
// Range: 0x800C95D4 -> 0x800C9638
// this: r31
zPlayer::zPlayer() {
    // References
...
// Range: 0x800C96E8 -> 0x800C9738
// this: r6
void zPlayer::GetParameter(const char * name /* r4 */, unsigned char * value /* r31 */, unsigned char default_value /* r0 */) {}

// Range: 0x800C9738 -> 0x800C9780
// this: r6
void zPlayer::GetParameter(const char * name /* r4 */, float * value /* r31 */, float default_value /* f0 */) {}

// Range: 0x800C9780 -> 0x800C97F4
// this: r6
void zPlayer::GetParameterList(const char * name /* r4 */, float * value /* r30 */, int count /* r31 */, const float * default_value /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x800C9DF8 -> 0x800C9E4C
// this: r31
unsigned char zPlayer::IsDead() const {}

// Range: 0x800C9E4C -> 0x800C9E50
void zPlayer::ParseIni() {}

// Range: 0x800C9E50 -> 0x800C9E74
// this: r3
void zPlayer::BeginUpdate(float dt /* f0 */) {}

// Range: 0x800C9E74 -> 0x800C9F28
// this: r31
...
// Range: 0x800C9F28 -> 0x800C9F4C
static unsigned char InheritVelocity(struct xEnt * ent_jumping_off_of /* r0 */) {}
...
// Range: 0x800CA230 -> 0x800CA254
// this: r3
void zPlayer::EndUpdate(float dt /* f0 */) {}

// Range: 0x800CA254 -> 0x800CA2C4
// this: r31
...
// Range: 0x800CA430 -> 0x800CA624
// this: r31
void zPlayer::Update_Prediction(float dt /* f30 */) {
    // Local variables
    struct zEnt * ent; // r0
    struct xVec3 lastDir; // r1+0x14
    float newVel; // f0
    float newAngV; // f29
    float pow; // f31
...
// Range: 0x800CA7CC -> 0x800CA82C
// this: r31
void zPlayer::Update_Fall(float dt /* f31 */) {}

// Range: 0x800CA82C -> 0x800CA878
// this: r31
void zPlayer::Exit() {}

// Range: 0x800CA878 -> 0x800CA8C0
// this: r0
...
static float reactiveAnimSpeed; // size: 0x4, address: 0x803C218C
// Range: 0x800CACF8 -> 0x800CAD3C
// this: r31
void zPlayer::Update_Control() {}

// Range: 0x800CAD3C -> 0x800CAD60
// this: r3
void zPlayer::Update(float dt /* f0 */) {}

// Range: 0x800CAD60 -> 0x800CAF7C
// this: r30
...
// Range: 0x800CB6D0 -> 0x800CB718
// this: r31
void zPlayer::HandleCollision(struct xScene * sc /* r0 */, float dt /* f0 */, float settleRate /* f0 */) {
    // Local variables
    struct xVec3 newPos; // r1+0x8
}

// Range: 0x800CB718 -> 0x800CB920
// this: r31
void zPlayer::Collide(float dt /* f28 */, float settle_rate /* f29 */, float max_settle_amount /* f30 */, float ground_threshold /* f31 */) {
    // Local variables
    unsigned char last_floor_collision; // r30
...
// total size: 0x1
struct /* @class$786zPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$787zPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$788zPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$789zPlayer_cpp */ {
    // Members
...
// Range: 0x800CBDE8 -> 0x800CBE54
// this: r30
unsigned char zPlayer::StayOnGround() {}

// Range: 0x800CBE54 -> 0x800CBE70
// this: r0
float zPlayer::InitialDepenetrationVelocity() {}

// Range: 0x800CBE70 -> 0x800CBF58
// this: r30
...
// Range: 0x800CBF58 -> 0x800CC160
// this: r23
void zPlayer::ComputeDepenetration(const struct xSphere * * spheres /* r24 */, int num_spheres /* r25 */, const struct xVec3 & initial_disp /* r26 */, struct xVec3 & dpos /* r27 */) {
    // Local variables
    int depth; // r29
    struct xVec3 valid_dpen; // r1+0x20
    unsigned int done_env_depen[5]; // r1+0x40
    void * done_obj_depen[5]; // r1+0x2C
    unsigned char tried_depenetrating; // r28
    int i; // r8
    unsigned char already_tried; // r9
    int j; // r0
    struct xVec3 sphere_offset; // r1+0x14
    struct xVec3 new_depen; // r1+0x8
}

// Range: 0x800CC160 -> 0x800CC30C
// this: r27
...
// Range: 0x800CC30C -> 0x800CC350
static void UpdateSWSCollision(struct xSweptSphere & sws /* r0 */, unsigned int whichFlag /* r0 */, unsigned int & collisionFlags /* r0 */, float & last_hit_dist /* r0 */) {}

// Range: 0x800CC350 -> 0x800CC5E0
// this: r25
unsigned char zPlayer::FindShortestCollision(const struct xSphere * * spheres /* r26 */, int num_spheres /* r27 */, const struct xVec3 & initial_disp /* r28 */, const struct xVec3 & dir /* r29 */, float dist /* f30 */, struct SphereCollisionResults & results /* r30 */) {
    // Local variables
    int i; // r31
...
// Range: 0x800CC604 -> 0x800CC718
// this: r30
void zPlayer::SweptSphereCollideCheckFloor(struct SphereCollisionResults & scene_collide /* r31 */) {}

// Range: 0x800CC718 -> 0x800CC890
// this: r29
void zPlayer::SweptSphereCollideComputeResponse(int stuck_collisions /* r26 */, struct SphereCollisionResults * scene_collide /* r31 */, int depth /* r27 */, const struct xVec3 & current_dir /* r7 */, struct xVec3 & remaining_dpos /* r28 */) {
    // Local variables
    struct xVec3 naive_response; // r1+0x14
    int partner_offset; // r29
    struct xVec3 combination; // r1+0x8
}

// Range: 0x800CC890 -> 0x800CC95C
...
// Range: 0x800CCA6C -> 0x800CCCE0
// this: r27
void zPlayer::SweptSphereCollide(const struct xSphere * * spheres /* r28 */, int num_spheres /* r29 */, const struct xVec3 & initial_disp /* r30 */, struct xVec3 & dpos /* r31 */) {
    // Local variables
    struct xVec3 valid_dpos; // r1+0x38
    struct xVec3 full_initial_disp; // r1+0x2C
    struct xVec3 original_desired_dir; // r1+0x20
    float remaining_dist; // f28
    struct xVec3 current_dir; // r1+0x14
    float current_dist; // f27
    struct SphereCollisionResults scene_collide[8]; // r1+0x44
    int stuck_collisions; // r24
    int depth; // r23
    struct xVec3 remaining_dpos; // r1+0x8
}

// Range: 0x800CCCE0 -> 0x800CCD04
// this: r3
...
// Range: 0x800CCD70 -> 0x800CD168
// this: r22
void zPlayer::FindStaticCollisions(const struct xSphere * * spheres /* r23 */, int numSpheres /* r24 */, const struct xVec3 & initialDisplacement /* r25 */, const struct xVec3 & validDepenetration /* r26 */) {
    // Local variables
    int curSphere; // r29
...
// Range: 0x800CD320 -> 0x800CD374
// this: r31
void zPlayer::mblur_setup() {}

// Range: 0x800CD374 -> 0x800CD39C
// this: r0
void zPlayer::mblur_reset() {}

// Range: 0x800CD39C -> 0x800CD3C4
// this: r0
...
// Range: 0x800CD56C -> 0x800CD614
// this: r31
void zPlayer::mblur_set_default_config() {}

// Range: 0x800CD614 -> 0x800CD6A8
// this: r31
...
// Range: 0x800CD6A8 -> 0x800CD6D0
// this: r0
void zPlayer::mblur_set_lifetime(float value /* f0 */, float time /* f0 */) {}

// Range: 0x800CD6D0 -> 0x800CD6F8
// this: r0
void zPlayer::mblur_set_alpha(float value /* f0 */, float time /* f0 */) {}

// Range: 0x800CD6F8 -> 0x800CD71C
// this: r0
void zPlayer::NPCAttackerAddPrvt(class zNPCCommon * addAttacker /* r0 */, int listIdx /* r0 */) {
    // Local variables
    int idx; // r6
}
...
// Range: 0x800CD894 -> 0x800CD8C4
// this: r0
void zPlayer::EnemyKilledComboUpdate(float dt /* f0 */) {}

// Range: 0x800CD8C4 -> 0x800CD938
// this: r0
...
// Range: 0x800CD938 -> 0x800CD98C
// this: r31
void zPlayer::RoundRobinUpdate(float dt /* f0 */) {}

// Range: 0x800CD98C -> 0x800CD9F8
...
// Range: 0x800CDAD8 -> 0x800CDB20
// this: r30
void zPlayer::AddStates(struct xAnimTable * table /* r31 */) {}

// Range: 0x800CDB20 -> 0x800CDD10
// this: r30
