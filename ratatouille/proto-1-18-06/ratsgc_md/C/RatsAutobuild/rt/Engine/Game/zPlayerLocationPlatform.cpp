/*
    ...
    Language: C++
    Code range: 0x801ACF0C -> 0x801AD138
*/
class zPlayerLocationPlatformConnector * head; // size: 0x4, address: 0x803C3A00
// total size: 0x20
struct xLinkAsset {
    // Members
