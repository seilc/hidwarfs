/*
    ...
    Language: C++
    Code range: 0x8013D3E4 -> 0x8013D940
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char sEnabled; // size: 0x1, address: 0x803BEAF8
unsigned char sDebugRender; // size: 0x1, address: 0x803C2EA0
unsigned char sCameraDisable; // size: 0x1, address: 0x803C2EA1
unsigned int sDrawnFrame; // size: 0x4, address: 0x803C2EA4
// total size: 0x1
