/*
    ...
    Language: C++
    Code range: 0x80148BB8 -> 0x80149044
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x803C2F10
// total size: 0x24
struct config {
    // Members
...
int system_id; // size: 0x4, address: 0x803BEBB0
// total size: 0x28
