/*
    ...
    Language: C++
    Code range: 0x801C4EEC -> 0x801C507C
*/
// total size: 0x68
...
// Range: 0x801C4EEC -> 0x801C4EF4
int zNPCSwarmOwl::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {}

signed char zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C3D60
...
class zComponentPool zComponentPool<zCompLogicSwarmOwl, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C3D64
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801C4F8C -> 0x801C4FAC
// this: r0
void zNPCSwarmOwl::Deactivate() {}

// Range: 0x801C4FAC -> 0x801C5020
// this: r30
...
// Range: 0x801C505C -> 0x801C507C
// this: r0
void zNPCSwarmOwl::Render() {}

// total size: 0x3C
struct {} zNPCSwarmOwl::__vtable; // size: 0x3C, address: 0x803C0708
