/*
    ...
    Language: C++
    Code range: 0x8012DE80 -> 0x8012E584
*/
// total size: 0x44
struct config {
    // Members
...
unsigned char need_setup; // size: 0x1, address: 0x803BEA00
// total size: 0x1
class fire_trail {
    // Static members
...
int system_id; // size: 0x4, address: 0x803C2E10
// total size: 0x28
