/*
    ...
    Language: C++
    Code range: 0x80198E5C -> 0x80199B1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gNPCManagerInitialized; // size: 0x1, address: 0x803C3640
class zNPCManager * gNPCManager; // size: 0x4, address: 0x803C3644
// Range: 0x80198E5C -> 0x80198EAC
...
struct zNPCTypesTable {
    ...
    void (* addDebugTweaksFunction)(char *); // offset 0x1C, size 0x4
    void (* createAnimTableFunction)(struct xAnimTable *); // offset 0x20, size 0x4
    void (* combatDamageInitFunction)(); // offset 0x24, size 0x4
    void (* compParametersInitFunction)(); // offset 0x28, size 0x4
    int (* countChildrenInAsset)(struct xDynAsset *, unsigned int, char *); // offset 0x2C, size 0x4
    void (* sceneInitFunction)(); // offset 0x30, size 0x4
    void (* scenePrepareFunction)(); // offset 0x34, size 0x4
    void (* sceneSetupFunction)(); // offset 0x38, size 0x4
    void (* sceneResetFunction)(); // offset 0x3C, size 0x4
    void (* sceneExitFunction)(); // offset 0x40, size 0x4
    unsigned int hashDynAssetTypeName; // offset 0x44, size 0x4
};
// Range: 0x80199138 -> 0x801991A4
// this: r0
...
// Range: 0x801991A4 -> 0x801991A8
void zNPCManager::Shutdown() {}

// Range: 0x801991A8 -> 0x801991FC
void zNPCManager::SceneInit() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x801991FC -> 0x80199280
void zNPCManager::ScenePrepare() {
    // Local variables
    const struct zNPCTypesTable * npcTypesTableEntry; // r31
}

// Range: 0x80199280 -> 0x80199284
void zNPCManager::SceneFinish() {}

// Range: 0x80199284 -> 0x80199330
// this: r26
void zNPCManager::SceneExit() {
    // Local variables
    unsigned int npcType; // r28
    int i; // r27
    const struct zNPCTypesTable * npcTypesTableEntry; // r27
}
...
// Range: 0x801993DC -> 0x801993E0
void zNPCManager::ScenePostInit() {}

// Range: 0x801993E0 -> 0x80199434
...
// total size: 0x4
struct /* @class$786zNPCManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$849zNPCManager_cpp */ {
    // Members
...
union /* @class$617zNPCManager_cpp */ {
...
// Range: 0x801994B0 -> 0x8019952C
// this: r28
int zNPCManager::AllocateNPCs() {
    // Local variables
    int totalNPCCount; // r30
    const struct zNPCTypesTable * npcTypesTableEntry; // r29
    enum eNPCType curNPCType; // r0
}

// Range: 0x8019952C -> 0x80199668
...
void zNPCManager::LoadNPCs() {
    ...
    unsigned int npcType; // r18
    int i; // r22
}

// Range: 0x8019986C -> 0x8019994C
void zNPCManager::LoadNPC(class zNPCBase * npc /* r26 */, enum eNPCType type /* r27 */, const struct xDynAsset * dynAsset /* r28 */, unsigned int dynAssetSize /* r29 */) {
    // Local variables
    struct xEntAsset * entass; // r0
    unsigned int size; // r1+0x8
    struct xModelAssetInfo * modelInfoAssetMINF; // r30
    struct xModelAssetInfo * modelInfoAsset; // r5
    unsigned int aid_minf; // r0
}

// Range: 0x8019994C -> 0x801999E0
// this: r24
void zNPCManager::RegisterNPCs(int * base_idx /* r25 */) {
    // Local variables
    unsigned int npcType; // r28
    int i; // r27
    class zNPCBase * curNPC; // r26
}

// Range: 0x801999E0 -> 0x80199A64
// this: r26
...
// Range: 0x80199A64 -> 0x80199B1C
// this: r24
void zNPCManager::SceneTimestep(struct xScene * xscn /* r25 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1434zNPCManager_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1401zNPCManager_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1402zNPCManager_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1403zNPCManager_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1400zNPCManager_cpp */ {
    // Members
...
class zSpringboard {};
// total size: 0x2
struct /* @class$1405zNPCManager_cpp */ {
    // Members
