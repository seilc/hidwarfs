/*
    ...
    Language: C++
    Code range: 0x801C2928 -> 0x801C35F8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x803C3C80
unsigned int numTextureSystems; // size: 0x4, address: 0x803C3C84
// total size: 0x58
struct config {
    // Members
...
struct config default_config; // size: 0x58, address: 0x803978F0
// total size: 0x8
...
struct TextureSystem textureSystems[8]; // size: 0x40, address: 0x803C3C88
// Range: 0x801C29FC -> 0x801C2A84
