/*
    ...
    Language: C++
    Code range: 0x8014B030 -> 0x8014C014
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float defaultGooTimes[4]; // size: 0x10, address: 0x803C7B58
static float defaultGooWarbc[4]; // size: 0x10, address: 0x803C7B68
// total size: 0x8
struct RwObject {
    // Members
...
struct zFXGooInstance zFXGooInstances[24]; // size: 0xBA0, address: 0x80389678
static struct RwTexture * g_txtr_gooFrozen; // size: 0x4, address: 0x803C2F50
