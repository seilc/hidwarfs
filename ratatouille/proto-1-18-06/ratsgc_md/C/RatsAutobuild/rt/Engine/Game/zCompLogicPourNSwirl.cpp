/*
    ...
    Language: C++
    Code range: 0x801B9DE8 -> 0x801B9F64
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xEnt * small_glass; // size: 0x4, address: 0x803C3B28
// total size: 0x40
struct RwMatrixTag {
    // Members
...
static struct RwMatrixTag small_glass_mat; // size: 0x40, address: 0x803C3B2C
static struct xEnt * large_glass; // size: 0x4, address: 0x803C3B6C
static struct RwMatrixTag large_glass_mat; // size: 0x40, address: 0x803C3B70
static unsigned char init; // size: 0x1, address: 0x803C3BB0
// total size: 0x2
