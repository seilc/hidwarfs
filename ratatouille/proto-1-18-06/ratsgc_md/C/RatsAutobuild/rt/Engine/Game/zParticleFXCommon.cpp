/*
    ...
    Language: C++
    Code range: 0x80129604 -> 0x801298F0
*/
// total size: 0xC
...
static class EnergyPulseSystem energy_pulse_system; // size: 0xC, address: 0x803C2DA0
// total size: 0x1
struct EmitState {};
// total size: 0x4
...
static class RubbleSystem rubble_system; // size: 0xC, address: 0x803C2DAC
// total size: 0x8
struct EmitState : public EmitState {
    // Members
...
static class FlameConeSystem flame_cone_system; // size: 0xC, address: 0x803C2DB8
// total size: 0x30
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x8, size 0xC
...
static class SmokePuffSystem smoke_puff_system; // size: 0xC, address: 0x803C2DC4
// total size: 0xC
class RegisterOnFirstEmitSystem : public zParticleSystemHelper {
    // Members
    unsigned char registered; // offset 0x4, size 0x1
...
static class LavaDripSystem lava_drip_system; // size: 0xC, address: 0x803C2DD0
// total size: 0x40
struct EmitState : public EmitState {
    // Members
...
static class SparkSystem spark_system; // size: 0xC, address: 0x803C2DDC
// total size: 0x4
struct EmitState : public EmitState {
    // Members
    float radius; // offset 0x0, size 0x4
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleUVStaticTile<3, 3, zParticleEmitterConeSurface<zParticleColorWhiteFadeOut<zParticleMoverLinearDecel<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size_uv2, zParticleBase>>>>>>, EnergyPulseSystem>::__vtable; // size: 0xC, address: 0x803BE970
// total size: 0xC
struct {} EnergyPulseSystem::__vtable; // size: 0xC, address: 0x803BE97C
// Range: 0x801296E0 -> 0x80129738
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeSurface<zParticleColorWhiteOpaque<zParticleMoverGravity<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, RubbleSystem>::__vtable; // size: 0xC, address: 0x803BE988
// total size: 0xC
struct {} RubbleSystem::__vtable; // size: 0xC, address: 0x803BE994
// Range: 0x80129738 -> 0x80129790
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, FlameConeSystem>::__vtable; // size: 0xC, address: 0x803BE9A0
// total size: 0xC
struct {} FlameConeSystem::__vtable; // size: 0xC, address: 0x803BE9AC
// Range: 0x80129790 -> 0x801297E8
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SmokePuffSystem>::__vtable; // size: 0xC, address: 0x803BE9B8
// total size: 0xC
struct {} SmokePuffSystem::__vtable; // size: 0xC, address: 0x803BE9C4
// Range: 0x801297E8 -> 0x80129840
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, LavaDripSystem>::__vtable; // size: 0xC, address: 0x803BE9D0
// total size: 0xC
struct {} LavaDripSystem::__vtable; // size: 0xC, address: 0x803BE9DC
// Range: 0x80129840 -> 0x80129898
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverGravity<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SparkSystem>::__vtable; // size: 0xC, address: 0x803BE9E8
// total size: 0xC
struct {} SparkSystem::__vtable; // size: 0xC, address: 0x803BE9F4
// Range: 0x80129898 -> 0x801298F0
// this: r31
