/*
    ...
    Language: C++
    Code range: 0x80145EF8 -> 0x801464A0
*/
static int sAnimCustomCount; // size: 0x4, address: 0x803C2EA8
static int sMaxTempTransCount; // size: 0x4, address: 0x803C2EAC
// total size: 0xC
struct RwV3d {
    // Members
...
static struct zAnimCustomFile * sAnimCustomList; // size: 0x4, address: 0x803C2EB0
static struct zAnimCustomFile * sAnimCustomEndOfList; // size: 0x4, address: 0x803C2EB4
// total size: 0x1C
struct xMemPool {
    // Members
...
static struct xMemPool szAnimCustomTempTranListPool; // size: 0x1C, address: 0x803C2EB8
static struct xAnimTransitionList * * zAnimCustomActiveTempTrans; // size: 0x4, address: 0x803C2ED4
static int sLastIndex; // size: 0x4, address: 0x803C2ED8
static char * sCustomStateName; // size: 0x4, address: 0x803BEB28
enum xSndHandle {
};
// total size: 0x8
...
static struct xAnimState sDummyState; // size: 0x4C, address: 0x803895B8
// total size: 0x2C
...
static struct xAnimTransition sDummyTran; // size: 0x2C, address: 0x803C2EDC
// total size: 0x8
...
static struct xAnimTransitionList sDummyList; // size: 0x8, address: 0x803C2F08
// Range: 0x80145EF8 -> 0x80145F08
static unsigned int TempTransCB(struct xAnimTransition * tran /* r0 */) {}

unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x80145F08 -> 0x80146020
...
// Range: 0x80146050 -> 0x80146084
static void ClearActiveArray() {
    // References
    // -> static int sLastIndex;
}

// Range: 0x80146084 -> 0x801460E8
...
// Range: 0x801460E8 -> 0x80146108
void zAnimCustomReset() {}

// Range: 0x80146108 -> 0x801461A0
