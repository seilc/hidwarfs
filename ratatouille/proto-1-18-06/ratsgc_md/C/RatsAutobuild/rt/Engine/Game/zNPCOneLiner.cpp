/*
    ...
    Language: C++
    Code range: 0x8018C1E8 -> 0x8018C4D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sTimeSinceLastOneLiner; // size: 0x4, address: 0x803C35D0
// total size: 0x10
struct zNPCOneLiner {
    // Members
...
static struct zNPCOneLinerSystem sInternal; // size: 0x204, address: 0x80390508
static struct zNPCOneLinerSystem sExternal; // size: 0x204, address: 0x8039070C
// total size: 0xC
...
static struct zNPCOneLinerExternalSource sExternalSource; // size: 0xC, address: 0x803C35D4
enum iSndGroupHandle {
};
static enum iSndGroupHandle sLastPlayed; // size: 0x4, address: 0x803C35E0
// Range: 0x8018C1E8 -> 0x8018C1F4
