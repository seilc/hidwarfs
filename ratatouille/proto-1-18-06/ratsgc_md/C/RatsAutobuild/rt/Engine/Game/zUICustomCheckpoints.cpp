/*
    ...
    Language: C++
    Code range: 0x80158ABC -> 0x80158E44
*/
static unsigned int sceneCheckPointTotal; // size: 0x4, address: 0x803C3080
static unsigned int sceneCheckPointHit; // size: 0x4, address: 0x803C3084
// Range: 0x80158ABC -> 0x80158AC4
void zUIIncrediblesSetSceneCheckPointHit(unsigned int value /* r0 */) {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80158AC4 -> 0x80158ACC
unsigned int zUIIncrediblesGetSceneCheckPointHit() {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80158ACC -> 0x80158AD4
...
// total size: 0x50
struct {} zUICustomCheckpoints::__vtable; // size: 0x50, address: 0x802DD7E8
// total size: 0x34
struct RwRaster {
    // Members
