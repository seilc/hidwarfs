/*
    ...
    Language: C++
    Code range: 0x801C1E64 -> 0x801C28FC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zNPCGateMgr gNPCGateMgr; // size: 0xC, address: 0x803C3C70
// Range: 0x801C1E64 -> 0x801C1EA8
void zNPCGateMgr::SceneSetup() {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
}

// Range: 0x801C1EA8 -> 0x801C1EC4
// this: r0
void zNPCGateMgr::Assign(class zNPCGate * npcGate /* r0 */) {}

// Range: 0x801C1EC4 -> 0x801C1F18
