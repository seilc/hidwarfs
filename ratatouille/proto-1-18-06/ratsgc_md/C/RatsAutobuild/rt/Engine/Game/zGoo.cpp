/*
    ...
    Language: C++
    Code range: 0x8014C014 -> 0x8014C238
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zGooParams * zgoo_gps; // size: 0x4, address: 0x803C2F58
static int zgoo_ngps; // size: 0x4, address: 0x803C2F5C
static int zgoo_nused; // size: 0x4, address: 0x803C2F60
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x8014C014 -> 0x8014C054
...
// Range: 0x8014C068 -> 0x8014C108
int zGooAdd(struct xEnt * obj /* r0 */, float depth /* f0 */, int freezeGroup /* r4 */) {
    // Local variables
    int i; // r0
    struct zGooParams * gp; // r5
