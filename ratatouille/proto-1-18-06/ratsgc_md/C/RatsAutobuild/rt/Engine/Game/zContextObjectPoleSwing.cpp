/*
    ...
    Language: C++
    Code range: 0x80183134 -> 0x80183458
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x14
struct {} zContextObjectPoleSwing::__vtable; // size: 0x14, address: 0x803BF3F8
// total size: 0x18
