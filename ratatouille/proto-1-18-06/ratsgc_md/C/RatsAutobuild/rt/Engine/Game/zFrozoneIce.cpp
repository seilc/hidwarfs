/*
    ...
    Language: C++
    Code range: 0x8012B790 -> 0x8012DC20
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zFrozoneIceConfig default_config; // size: 0x28, address: 0x803C7588
// total size: 0x4
struct RwRGBA {
    // Members
...
static struct xColor_tag lower_color; // size: 0x4, address: 0x803C75B0
// Range: 0x8012B790 -> 0x8012B794
...
static struct frozone_data * frodata; // size: 0x4, address: 0x803C2DF8
// total size: 0x18
...
static struct frobridge_spike_curve_node spike_appear_curve[4]; // size: 0x60, address: 0x802B0F80
static struct frobridge_spike_curve_node spike_disappear_curve[3]; // size: 0x48, address: 0x802B0FE0
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8012B894 -> 0x8012B908
static void load_assets() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012B908 -> 0x8012B928
...
// Range: 0x8012C9C8 -> 0x8012C9F0
static void im_unlock() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012C9F0 -> 0x8012CA2C
...
// Range: 0x8012D470 -> 0x8012D474
void zFrozoneIceSceneExit() {}

// Range: 0x8012D474 -> 0x8012D614
...
// Range: 0x8012D614 -> 0x8012D658
void zFrozoneIceRender() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012D658 -> 0x8012D6C0
