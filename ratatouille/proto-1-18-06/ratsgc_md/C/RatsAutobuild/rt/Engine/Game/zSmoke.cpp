/*
    ...
    Language: C++
    Code range: 0x800F07B0 -> 0x800F1D10
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float wind_magnitude_time; // size: 0x4, address: 0x803C2790
static float wind_yaw_time; // size: 0x4, address: 0x803C2794
static float wind_pitch_time; // size: 0x4, address: 0x803C2798
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 wind_delta; // size: 0xC, address: 0x803C279C
// total size: 0x8
...
static class xParticleBatchGroup batch_group; // size: 0x8, address: 0x803C27A8
// total size: 0x40
...
// Range: 0x800F0C28 -> 0x800F0D9C
static void update_wind(float dt /* f31 */) {
    // Local variables
    float magnitude; // f27
    float yaw; // f29
    float pitch; // f26
...
// Range: 0x800F0DDC -> 0x800F0DE0
static void debug_init() {}

// Range: 0x800F0DE0 -> 0x800F0DE4
void zSmokeSceneExit() {}

// Range: 0x800F0DE4 -> 0x800F0E18
...
// Range: 0x800F0E18 -> 0x800F12AC
void zSmokeEmitSphere(int system_id /* r29 */, const struct zSmokeSphereVolume & volume /* r0 */, int amount /* r24 */) {
    // Local variables
    float size_min; // f19
...
// Range: 0x800F13A8 -> 0x800F13C8
void zSmokeEmitter::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x800F13C8 -> 0x800F15D8
// this: r31
...
// Range: 0x800F179C -> 0x800F17B4
// this: r0
void zSmokeEmitter::reset() {}

// Range: 0x800F17B4 -> 0x800F1A48
// this: r26
...
// Range: 0x800F1CA0 -> 0x800F1D10
void zSmokeEmitter::cb_dispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */) {
    // Local variables
    class zSmokeEmitter & e; // r4
}
