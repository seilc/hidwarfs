/*
    ...
    Language: C++
    Code range: 0x801B3EB0 -> 0x801B4030
*/
// total size: 0x1
...
static class zICompNPCEntityParams gSpringBoardEntParameters; // size: 0x30, address: 0x803C3A30
signed char zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C3A60
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C3A64
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B3F5C -> 0x801B3F7C
// this: r0
void zNPCSpringBoard::Deactivate() {}

// Range: 0x801B3F7C -> 0x801B3FF0
// this: r30
...
// total size: 0x3C
struct {} zNPCSpringBoard::__vtable; // size: 0x3C, address: 0x803BFEE8
// total size: 0xC
struct RwV3d {
    // Members
