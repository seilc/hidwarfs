/*
    ...
    Language: C++
    Code range: 0x801598B8 -> 0x80159E7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct Scene scenes[200]; // size: 0x2580, address: 0x8038AA60
// total size: 0x14
struct SceneUnlock {
    // Members
...
static struct SceneUnlock scenesUnlock[200]; // size: 0xFA0, address: 0x8038CFE0
static unsigned int sceneCurrent; // size: 0x4, address: 0x803C3088
...
char * allsoaklevels[200]; // size: 0x320, address: 0x8038DF80
// Range: 0x801598B8 -> 0x801598C0
unsigned int zUIIncrediblesGetNumScenes() {
    // References
    // -> int numScenes;
}

// Range: 0x801598C0 -> 0x801598C8
void zUIIncrediblesSetSceneCurrent(unsigned int value /* r0 */) {
    // References
    // -> static unsigned int sceneCurrent;
}

// Range: 0x801598C8 -> 0x801598D0
...
// total size: 0x4
struct /* @class$804zUICustomLevelManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$824zUICustomLevelManager_cpp */ {
    // Members
...
union /* @class$635zUICustomLevelManager_cpp */ {
...
// Range: 0x801599F0 -> 0x80159A24
struct Scene * zUIGetSceneByID(unsigned int sceneID /* r0 */) {
    // Local variables
    unsigned int sceneNumber; // r0
}

// Range: 0x80159A24 -> 0x80159A2C
int zUIIncrediblesGetNumStoryScenes() {
    // References
    // -> int numStoryScenes;
}

// Range: 0x80159A2C -> 0x80159A34
int zUIIncrediblesGetNumArenaScenes() {
    // References
    // -> int numArenaScenes;
}

// Range: 0x80159A34 -> 0x80159A58
struct Scene * zUIIncrediblesGetScene(unsigned int level /* r3 */) {
    // References
    // -> static struct Scene scenes[200];
}

// Range: 0x80159A58 -> 0x80159A6C
struct SceneUnlock * zUIGetSceneUnlock(unsigned int idx /* r0 */) {
    // References
    // -> static struct SceneUnlock scenesUnlock[200];
}

// Range: 0x80159A6C -> 0x80159A9C
struct Scene * zUIIncrediblesFindCurrentScene() {
    // References
    // -> static struct Scene scenes[200];
}

// Range: 0x80159A9C -> 0x80159AB8
unsigned char zUIIncrediblesSceneIsCompleted(unsigned int level /* r0 */) {
    // References
    // -> static struct Scene scenes[200];
}

// Range: 0x80159AB8 -> 0x80159AD4
unsigned char zUIIncrediblesSceneIsUnlocked(unsigned int level /* r0 */) {
    // References
    // -> static struct Scene scenes[200];
}
...
class zUISceneGroups sSceneGroups; // size: 0x54, address: 0x8038E2A0
// total size: 0xC
...
// Range: 0x80159B8C -> 0x80159BA0
// this: r0
struct Group & zUISceneGroups::operator[](unsigned int index /* r0 */) {}

// Range: 0x80159BA0 -> 0x80159BA8
// this: r3
unsigned int zUISceneGroups::NumGroups() {}

// Range: 0x80159BA8 -> 0x80159BD0
unsigned char zUISceneExists(struct _xCounter * mission /* r0 */) {}

// Range: 0x80159BD0 -> 0x80159CBC
...
// Range: 0x80159CF0 -> 0x80159D74
// this: r0
void zUISceneGroups::AddSceneGroup(const char * sceneID /* r0 */) {
    // Local variables
    unsigned int i; // r0
}

// Range: 0x80159D74 -> 0x80159D94
...
static unsigned int cMissionCounterID; // size: 0x4, address: 0x803C309C
static signed char init; // size: 0x1, address: 0x803C30A0
static unsigned int cMissionValidCounterID; // size: 0x4, address: 0x803C30A4
static signed char init; // size: 0x1, address: 0x803C30A8
// Range: 0x80159D94 -> 0x80159E48
