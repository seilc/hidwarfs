/*
    ...
    Language: C++
    Code range: 0x801187B8 -> 0x80118F98
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801187B8 -> 0x801187BC
void zUICustom::Init() {}

// Range: 0x801187BC -> 0x801187C0
void zUICustom::Setup() {}

// Range: 0x801187C0 -> 0x801187C4
void zUICustom::Reset() {}

// Range: 0x801187C4 -> 0x801187C8
void zUICustom::ResetMotion() {}

// Range: 0x801187C8 -> 0x801187D0
unsigned char zUICustom::HandleEvent() {}

// Range: 0x801187D0 -> 0x801187D4
void zUICustom::PreUpdate() {}

// Range: 0x801187D4 -> 0x801187D8
void zUICustom::PostUpdate() {}

// Range: 0x801187D8 -> 0x801187E0
unsigned char zUICustom::PreRender() {}

// Range: 0x801187E0 -> 0x801187E8
unsigned char zUICustom::PreAutoMenu() {}

// Range: 0x801187E8 -> 0x801187EC
void zUICustom::PostRender() {}

// Range: 0x801187EC -> 0x801187F0
void zUICustom::Exit() {}

// Range: 0x801187F0 -> 0x801187F4
void zUICustom::PreInitMotion() {}

// Range: 0x801187F4 -> 0x801187F8
void zUICustom::PostInitMotion() {}

// Range: 0x801187F8 -> 0x801187FC
void zUICustom::PreApplyMotionFrame() {}

// Range: 0x801187FC -> 0x80118800
void zUICustom::PostApplyMotionFrame() {}

// Range: 0x80118800 -> 0x80118820
void * zUICustom::operator new(unsigned long size /* r0 */) {}
...
class zUICustomSoundMode * pUICustomSoundMode; // size: 0x4, address: 0x803C30D0
// total size: 0x34
...
class zUICustomArtworkManager * pUICustomArtworkManager; // size: 0x4, address: 0x803C30E8
...
class zUICustomUpgrade * pUICustomUpgradeManager; // size: 0x4, address: 0x803C30DC
// total size: 0xB0
...
class zUICustom * pUICustomDropJoinSceneManager; // size: 0x4, address: 0x803C2F78
// total size: 0x10
...
class zUICustomCheatsManager * pUICustomCheatsManager; // size: 0x4, address: 0x803C3960
// Range: 0x80118820 -> 0x80118EB8
class zUICustom * zUICustomAllocate(unsigned int hashID /* r0 */, class zUI * ui /* r31 */) {
    // References
...
// Range: 0x80118EB8 -> 0x80118EF0
void zSendUIEvent(const char * widgetName /* r0 */, unsigned int event /* r31 */) {
    // Local variables
    unsigned int id; // r0
    struct xBase * sendTo; // r0
}

// Range: 0x80118EF0 -> 0x80118F44
void zUIAutoScreenManagerFocusOnSelect() {}

// Range: 0x80118F44 -> 0x80118F98
void zUIAutoScreenManagerFocusOffUnselect() {}

// total size: 0x50
struct {} zUICustom::__vtable; // size: 0x50, address: 0x802DC998
