/*
    ...
    Language: C++
    Code range: 0x801C007C -> 0x801C0620
*/
class zButtonMasherMashChecker * * objectArray; // size: 0x4, address: 0x803C3C58
int objectCount; // size: 0x4, address: 0x803C3C5C
// total size: 0x1
...
// total size: 0x14
struct {} zButtonMasherMashChecker::__vtable; // size: 0x14, address: 0x803C0440
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x801C0334 -> 0x801C033C
// this: r3
unsigned char zButtonMasherMashChecker::CycleDone() {}

// Range: 0x801C033C -> 0x801C0610
// this: r31
