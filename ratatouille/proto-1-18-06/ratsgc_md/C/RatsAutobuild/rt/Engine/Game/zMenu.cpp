/*
    ...
    Language: C++
    Code range: 0x800BDF64 -> 0x800BEDE0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float time_elapsed; // size: 0x4, address: 0x803BE184
static float time_last; // size: 0x4, address: 0x803C20C0
static float time_current; // size: 0x4, address: 0x803C20C4
static float sAttractMode_timer; // size: 0x4, address: 0x803C20C8
static float sOneLiner_timer; // size: 0x4, address: 0x803C20CC
enum xSndHandle {
};
static enum xSndHandle frozone_speaks; // size: 0x4, address: 0x803BE188
static int card; // size: 0x4, address: 0x803C20D0
static int sInMenu; // size: 0x4, address: 0x803C20D4
static float ONELINER_WAITTIME; // size: 0x4, address: 0x803BE18C
static float holdTmr; // size: 0x4, address: 0x803BE190
static unsigned char sAllowAttract; // size: 0x1, address: 0x803C20D8
// Range: 0x800BDF64 -> 0x800BDF84
...
// Range: 0x800BDF98 -> 0x800BDFA0
int zMenuRunning() {
    // References
    // -> static int sInMenu;
}

enum eFMVFile attractMovies[5]; // size: 0x14, address: 0x803BE194
// Range: 0x800BDFA0 -> 0x800BDFE4
...
// total size: 0x4
struct /* @class$1224zMenu_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1225zMenu_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x800BE2A4 -> 0x800BEB0C
unsigned int zMenuLoop(int force_draw_black /* r24 */) {
    // Local variables
    int ostrich_delay; // r27
    unsigned int nextSceneID; // r21
    unsigned int attractsPlayed; // r26
    int draw_black; // r25
    int ss; // r0
    const char * fname; // r0
    unsigned int i; // r0
...
// Range: 0x800BECF0 -> 0x800BECFC
unsigned int zMenuGetBadCard() {
    // References
    // -> static int card;
}

// Range: 0x800BECFC -> 0x800BED58
unsigned int zMenuFMVPlay(const char * filename /* r0 */, unsigned int buttons /* r0 */, float time /* f0 */, unsigned int uSubtitlesAID /* r0 */, unsigned char skippable /* r0 */, unsigned char lockController /* r0 */, unsigned char displayDemoBlink /* r0 */) {
    // Local variables
...
// Range: 0x800BED58 -> 0x800BED60
int zMenuIsFirstBoot() {
    // References
    // -> int sFirstBoot;
}

// Range: 0x800BED60 -> 0x800BED68
void zMenuFirstBootSet(int val /* r0 */) {
    // References
    // -> int sFirstBoot;
}

// Range: 0x800BED68 -> 0x800BEDD8
