/*
    ...
    Language: C++
    Code range: 0x801BCD68 -> 0x801BCED4
*/
signed char zComponentPool<zCompLogicContextSensitive, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C3C08
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicContextSensitive, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C3C0C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801BCE00 -> 0x801BCE20
// this: r0
void zNPCContextSensitive::Deactivate() {}

// Range: 0x801BCE20 -> 0x801BCE94
// this: r30
...
// total size: 0x4
struct /* @class$828zNPCContextSensitive_cpp */ {
    // Members
...
union /* @class$848zNPCContextSensitive_cpp */ {
...
// total size: 0xC
struct /* @class$846zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$794zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$795zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$796zNPCContextSensitive_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$797zNPCContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$798zNPCContextSensitive_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$799zNPCContextSensitive_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCContextSensitive::__vtable; // size: 0x3C, address: 0x803C0240
