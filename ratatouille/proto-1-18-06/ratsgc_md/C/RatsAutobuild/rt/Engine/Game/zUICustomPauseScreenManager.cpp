/*
    ...
    Language: C++
    Code range: 0x80159E7C -> 0x8015A13C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static enum enPAUSE_TYPE pauseSysType_cur; // size: 0x4, address: 0x803BEEE0
static enum enPAUSE_TYPE pauseSysType_old; // size: 0x4, address: 0x803BEEE4
// total size: 0x50
struct {} zUICustomPauseScreenManager::__vtable; // size: 0x50, address: 0x802DD888
// total size: 0x8
...
// Range: 0x80159E7C -> 0x80159EB8
// this: r31
zUICustomPauseScreenManager::zUICustomPauseScreenManager(class zUI * ui /* r0 */) {
    // References
...
// total size: 0x4
struct /* @class$786zUICustomPauseScreenManager_cpp */ {
    // Members
...
union /* @class$700zUICustomPauseScreenManager_cpp */ {
...
// total size: 0xC
struct /* @class$877zUICustomPauseScreenManager_cpp */ {
    // Members
...
// Range: 0x80159EBC -> 0x8015A13C
// this: r31
unsigned char zUICustomPauseScreenManager::HandleEvent(struct xBase * from /* r28 */, unsigned int toEvent /* r29 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {
    // Local variables
    unsigned int strHash; // r0
    float toParams[4]; // r1+0x10
    int i; // r30
    int portInitiatedSysMsg; // r29
...
// total size: 0x2
struct /* @class$810zUICustomPauseScreenManager_cpp */ {
    // Members
