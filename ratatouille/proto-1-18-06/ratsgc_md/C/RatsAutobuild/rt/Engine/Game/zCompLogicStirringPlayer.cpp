/*
    ...
    Language: C++
    Code range: 0x801AB8A4 -> 0x801ABED0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xVec3 potPositions[4]; // size: 0x30, address: 0x803BFB80
static unsigned int replyToID; // size: 0x4, address: 0x803C39D0
static unsigned char init; // size: 0x1, address: 0x803C39D4
// total size: 0x4
struct node {
    // Members
...
static struct xResponseCurve potColorCurve; // size: 0x10, address: 0x803C39D8
static struct rgba_node potColors[3]; // size: 0x3C, address: 0x803C9030
static unsigned int boil[4]; // size: 0x10, address: 0x803BFBB0
// total size: 0x2
