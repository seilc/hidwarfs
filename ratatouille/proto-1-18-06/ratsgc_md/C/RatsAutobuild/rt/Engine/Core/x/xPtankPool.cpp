/*
    ...
    Language: C++
    Code range: 0x80058B30 -> 0x800597D8
*/
static int MAX_PTANKS_COLOR_MAT; // size: 0x4, address: 0x803BD868
static int MAX_PTANKS_COLOR_MAT_UV2; // size: 0x4, address: 0x803BD86C
static int MAX_PTANKS_POS_COLOR_SIZE; // size: 0x4, address: 0x803BD870
static int MAX_PTANKS_POS_COLOR_SIZE_UV2; // size: 0x4, address: 0x803BD874
static int MAX_PTANKS_POS_COLOR_SIZE_ROT; // size: 0x4, address: 0x803BD878
static int MAX_PTANKS_POS_COLOR_SIZE_ROT_UV2; // size: 0x4, address: 0x803BD87C
static int MAX_PTANKS; // size: 0x4, address: 0x803C1270
static unsigned char inited; // size: 0x1, address: 0x803C1274
static unsigned int current_sequence_index; // size: 0x4, address: 0x803C1278
// total size: 0x8
struct RwObject {
    // Members
...
static struct group_data groups[6]; // size: 0xA8, address: 0x802CEB70
// Range: 0x80058B30 -> 0x80058C70
static void sort_buckets(struct group_data & group /* r31 */) {
    // Local variables
    struct ptank_context * it; // r3
    struct ptank_context * endp; // r6
    const struct RwTexture * texture; // r7
    struct ptank_context * * bucket; // r4
    struct ptank_context * * end; // r8
    struct ptank_context * front; // r9
}
...
// total size: 0x4
struct /* @class$923xPtankPool_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941xPtankPool_cpp */ {
    // Members
...
// Range: 0x80058D34 -> 0x80058E34
static void init_groups() {
    // Local variables
    int total; // r9
    struct group_data * it; // r7
...
// Range: 0x80059138 -> 0x800591EC
void xPTankPoolSceneEnter() {
    // Local variables
    struct group_data * it; // r30
    struct group_data * end; // r29
...
// Range: 0x800591EC -> 0x8005929C
static int create_ptanks(struct group_data & group /* r27 */, int want /* r4 */) {
    // Local variables
    int old_group_size; // r0
    struct ptank_context * head; // r3
    struct ptank_context * end; // r29
    struct ptank_context * it; // r28
}

// Range: 0x8005929C -> 0x80059310
...
// Range: 0x800594A8 -> 0x80059784
// this: r29
void ptank_pool::grab_block(enum ptank_group_type type /* r0 */) {
    // Local variables
