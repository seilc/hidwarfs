/*
    ...
    Language: C++
    Code range: 0x80043C54 -> 0x800442B8
*/
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x80043C54 -> 0x80043F28
struct xLightKit * xLightKit_Prepare(void * data /* r26 */) {
    // Local variables
...
// Range: 0x80043FC0 -> 0x80044010
void xLightKit_Enable(const struct xModelInstance & model /* r3 */, struct RpWorld * world /* r0 */) {}
...
// Range: 0x80044010 -> 0x80044224
void xLightKit_Enable(struct xLightKit * lkit /* r30 */, struct RpWorld * world /* r28 */, struct xLightKit * lkit_blend /* r31 */, float blendPercentage /* f29 */) {
    // Local variables
    unsigned int i; // r27
...
// Range: 0x80044224 -> 0x8004422C
struct xLightKitBlendInfo * xLightKit_GetCurrent() {
    // References
    // -> struct xLightKitBlendInfo gLastLightKit;
}

// Range: 0x8004422C -> 0x800442B8
