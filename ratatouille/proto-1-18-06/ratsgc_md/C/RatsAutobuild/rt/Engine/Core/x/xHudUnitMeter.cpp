/*
    ...
    Language: C++
    Code range: 0x8003FA38 -> 0x80040170
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float tweak_anim_time_delta; // size: 0x4, address: 0x803BD7D0
// total size: 0x18C
...
// Range: 0x8003FA38 -> 0x8003FA88
void unit_meter_widget::load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */) {}

static unsigned char registered; // size: 0x1, address: 0x803C0F50
static signed char init; // size: 0x1, address: 0x803C0F51
// total size: 0x28
struct {} xhud::unit_meter_widget::__vtable; // size: 0x28, address: 0x803BD7D4
// Range: 0x8003FA88 -> 0x8003FC08
// this: r28
unit_meter_widget::unit_meter_widget(const struct unit_meter_asset & a /* r29 */) {
    // Local variables
    int i; // r31
    int j; // r30
...
// total size: 0x4
struct /* @class$786xHudUnitMeter_cpp */ {
    // Members
...
union /* @class$617xHudUnitMeter_cpp */ {
...
// total size: 0xC
struct /* @class$881xHudUnitMeter_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$858xHudUnitMeter_cpp */ {
    // Members
...
enum /* @enum$859xHudUnitMeter_cpp */ {
    ACT_NONE = 0,
    ACT_SHOW = 1,
    ACT_HIDE = 2,
    MAX_ACT = 3,
...
// Range: 0x8003FC08 -> 0x8003FC28
// this: r0
void unit_meter_widget::destruct() {}

// Range: 0x8003FC28 -> 0x8003FC48
// this: r0
void unit_meter_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x803C0F54
static signed char init; // size: 0x1, address: 0x803C0F58
// Range: 0x8003FC48 -> 0x8003FC88
