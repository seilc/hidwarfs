/*
    ...
    Language: C++
    Code range: 0x8000A340 -> 0x8000B0DC
*/
static unsigned int g_loadlock; // size: 0x4, address: 0x803BD4A0
enum en_FIOERRCODES {
    FIOERR_NONE = 0,
    FIOERR_READFAIL = 1,
    FIOERR_WRITEFAIL = 2,
...
static struct st_FILELOADINFO g_loadinst[8]; // size: 0x340, address: 0x802B9740
static struct tag_xFile g_xfload[8]; // size: 0x8A0, address: 0x802B9A80
// total size: 0x3C
...
static struct st_BINIO_XTRADATA g_xtraload[8]; // size: 0x1E0, address: 0x802BA320
static struct st_BINIO_XTRADATA * g_async_context; // size: 0x4, address: 0x803C0C68
// Range: 0x8000A340 -> 0x8000A548
...
// Range: 0x8000AA3C -> 0x8000AA5C
static enum en_BIO_ASYNC_ERRCODES AsyncReadStatus(struct st_FILELOADINFO * fli /* r0 */) {}

// Range: 0x8000AA5C -> 0x8000AA84
static void Swap2(char * d /* r3 */, int n /* r4 */) {
    // Local variables
    char t; // r4
}

// Range: 0x8000AA84 -> 0x8000AABC
static void Swap4(char * d /* r3 */, int n /* r4 */) {
    // Local variables
    char t; // r4
}

// Range: 0x8000AABC -> 0x8000AB14
static void Swap8(char * d /* r3 */, int n /* r4 */) {
    // Local variables
    char t; // r4
}

// Range: 0x8000AB14 -> 0x8000AC18
static struct tag_xFile * BFD_open(const char * filename /* r26 */, const char * mode /* r27 */, unsigned int lockid /* r31 */, void * xtradata /* r28 */, int fileflags /* r29 */) {
    // Local variables
    struct tag_xFile * bffp; // r31
    unsigned int orc; // r0
...
// Range: 0x8000AF20 -> 0x8000AF24
static void BFD_cb_GCP2_readasync() {}

// Range: 0x8000AF24 -> 0x8000B008
