/*
    ...
    Language: C++
    Code range: 0x8000C934 -> 0x8000E104
*/
// Range: 0x8000C934 -> 0x8000C938
...
// Range: 0x8000C938 -> 0x8000C948
// this: r0
void xCam::start() {}

// Range: 0x8000C948 -> 0x8000C958
// this: r0
void xCam::stop() {}

// Range: 0x8000C958 -> 0x8000C980
void xCam::scene_enter() {}

// Range: 0x8000C980 -> 0x8000C9AC
void xCam::scene_exit() {}

// Range: 0x8000C9AC -> 0x8000CA68
// this: r29
...
// Range: 0x8000CA68 -> 0x8000CAD4
// this: r31
void xCam::refresh_mat() {}

// Range: 0x8000CBD4 -> 0x8000CC0C
// this: r0
void xCam::create() {}
...
// Range: 0x8000CEBC -> 0x8000CF60
// this: r31
void xCamGroup::transition_to(struct xCam & cam /* r8 */, const struct xCamTransitionParams * params /* r0 */, unsigned char force_cut /* r0 */, unsigned char force_restart /* r7 */) {
    // Local variables
    struct xCam * next; // r4
}

// Range: 0x8000CF60 -> 0x8000CF8C
// this: r0
void xCamGroup::add(struct xCam & cam /* r0 */, unsigned char force_cut /* r6 */) {}

// Range: 0x8000CF8C -> 0x8000CFB8
// this: r0
void xCamGroup::remove(struct xCam & cam /* r0 */) {}

// Range: 0x8000CFB8 -> 0x8000CFE8
// this: r0
...
// Range: 0x8000CFE8 -> 0x8000D150
// this: r30
void xCamGroup::set_primary(struct xCam * toCamera /* r31 */, unsigned char force_restart /* r0 */) {
    // Local variables
    float len; // f0
    float len2; // f1
    float len_inv; // f1
...
// Range: 0x8000D150 -> 0x8000D294
// this: r28
struct xCam * xCamGroup::get_blend(class xCamTransition * transition /* r29 */, struct xCam & to /* r30 */) {
    // Local variables
    float blend_time; // f31
    struct xCamBlend * parent; // r31
    struct xCam * pTo; // r3
    struct xCamBlend * blend; // r31
}

// Range: 0x8000D294 -> 0x8000D2AC
void xCamGroup::notify_released(struct xCam & cam /* r0 */) {}

// Range: 0x8000D2AC -> 0x8000D2C4
// this: r0
void xCamGroup::set_child_flags(int add /* r0 */, int remove /* r0 */) {}

// Range: 0x8000D2C4 -> 0x8000D35C
static void do_transient_replacement(struct xCam * & curCam /* r30 */) {
    // Local variables
    struct xCam * next; // r0
}

// Range: 0x8000D35C -> 0x8000D3E0
struct xCamBlend * xCamGroup::create_blend() {}

// total size: 0x20
struct {} xCamBias::__vtable; // size: 0x20, address: 0x803BD508
// total size: 0x8
class xCamBias {
    // Members
public:
...
// Range: 0x8000D458 -> 0x8000D498
// this: r31
void xCamScreen::create(int w /* r4 */, int h /* r0 */) {}

// Range: 0x8000D498 -> 0x8000D4BC
// this: r3
void xCamScreen::destroy() {}

// Range: 0x8000D4BC -> 0x8000D4E8
// this: r3
void xCamScreen::set_scene(struct xScene & scene /* r0 */) {}

// Range: 0x8000D4E8 -> 0x8000D50C
// this: r3
void xCamScreen::prepare_render() {}

// Range: 0x8000D50C -> 0x8000D550
// this: r31
void xCamScreen::begin_render(unsigned char clear /* r4 */) {}

// Range: 0x8000D550 -> 0x8000D574
// this: r3
void xCamScreen::end_render() {}

// Range: 0x8000D574 -> 0x8000D598
// this: r3
void xCamScreen::set_world_matrix(const struct xMat4x3 & mat /* r0 */) {}

// Range: 0x8000D598 -> 0x8000D5C8
// this: r3
void xCamScreen::set_fov(float fov /* f1 */) {}

// Range: 0x8000D5C8 -> 0x8000D638
// this: r3
...
// Range: 0x8000D7A0 -> 0x8000D7E4
// this: r31
void xCamBlend::create() {}

// Range: 0x8000D7E4 -> 0x8000D7E8
void xCamBlend::destroy() {}

static enum xCamCoordType coord_table[3][3]; // size: 0x24, address: 0x803C46F8
static enum xCamOrientType orient_table[2][2]; // size: 0x10, address: 0x803C471C
// Range: 0x8000D7E8 -> 0x8000D984
// this: r31
...
// Range: 0x8000D984 -> 0x8000DA7C
// this: r31
void xCamBlend::stop() {}

// Range: 0x8000DA7C -> 0x8000DAD4
// this: r30
...
// Range: 0x8000DAD4 -> 0x8000DB2C
// this: r30
void xCamBlend::post_update(struct xScene & scene /* r31 */) {}

// Range: 0x8000DB2C -> 0x8000DC4C
// this: r30
...
// Range: 0x8000DC4C -> 0x8000DCC4
// this: r31
struct xCam * xCamBlend::get_next() {}

// Range: 0x8000DCC4 -> 0x8000DD58
// this: r31
...
struct xCamDebug : public xCam {
    // Members
    struct config cfg; // offset 0x130, size 0x70
    struct xVec2 dpad; // offset 0x1A0, size 0x8
    float slow_input; // offset 0x1A8, size 0x4
};
// total size: 0x8
struct xVec2 {
    // Members
...
// total size: 0x40
struct {} xCamBlend::__vtable; // size: 0x40, address: 0x803BD4A8
// total size: 0x0
class zCam2Player {};
// total size: 0x20
struct {} xCamTimeBias::__vtable; // size: 0x20, address: 0x803BD4E8
// total size: 0x40
struct {} xCam::__vtable; // size: 0x40, address: 0x803BD528
