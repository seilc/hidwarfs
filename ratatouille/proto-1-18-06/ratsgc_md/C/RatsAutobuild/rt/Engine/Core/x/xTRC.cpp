/*
    ...
    Language: C++
    Code range: 0x80075C24 -> 0x80076CB0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x803C56E8
static struct _tagTRCPadInfo gTrcPad[4]; // size: 0x40, address: 0x803C15A0
// total size: 0x8
...
static struct _tagTRCDiskInfo gTrcDisk; // size: 0x8, address: 0x803C15E0
static const char * k_CONTROLLER_MISSING_MESSAGE; // size: 0x4, address: 0x803C15E8
static const char * k_CONTROLLER_INVALID_MESSAGE; // size: 0x4, address: 0x803C15EC
enum _tagTRCState {
    TRC_Unknown = 0,
    TRC_PadMissing = 1,
    TRC_PadInserted = 2,
...
// Range: 0x80075C24 -> 0x80075C2C
unsigned char xTRCMemCardCheck() {}

// Range: 0x80075C2C -> 0x80075C78
...
// Range: 0x80075E30 -> 0x80075E44
void xTRCPadSetState(int idx /* r0 */, enum _tagTRCState state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80075E44 -> 0x80075EA4
...
// Range: 0x80075FA4 -> 0x80075FD4
void xTRCPadSetStatePadPort(int port /* r0 */, enum _tagTRCState state /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x80075FD4 -> 0x80076004
void xTRCPadSetPadStatePort(int port /* r0 */, enum _tagTRCPadState state /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x80076004 -> 0x80076068
unsigned char xTRCPadFindFirst(int & idx /* r0 */, enum _tagTRCState state /* r0 */) {
    // Local variables
    int i; // r8
...
// Range: 0x80076068 -> 0x800760CC
unsigned char xTRCPadFindFirstPadState(int & idx /* r0 */, enum _tagTRCPadState state /* r0 */) {
    // Local variables
    int i; // r8
...
// Range: 0x800760CC -> 0x800760EC
unsigned char xTRCPadIsIdx(int idx /* r0 */, enum _tagTRCState state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x800760EC -> 0x80076100
int xTRCPadGetPadPort(int idx /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80076100 -> 0x80076114
enum _tagTRCState xTRCPadGetStateIdx(int idx /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80076114 -> 0x80076154
enum _tagTRCState xTRCPadGetStatePort(int port /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x80076154 -> 0x80076194
enum _tagTRCPadState xTRCPadGetPadStatePort(int port /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x80076194 -> 0x800761A8
enum _tagTRCPadState xTRCPadGetPadStateIdx(int idx /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x800761A8 -> 0x800761F8
...
// Range: 0x800761F8 -> 0x80076260
unsigned char xTRCPadGetPadPort(int & idx /* r0 */, enum _tagTRCState state /* r0 */) {
    // Local variables
    int i; // r7
...
// Range: 0x80076260 -> 0x800762C8
unsigned char xTRCPadPortWasActive(int port /* r30 */) {}

// Range: 0x800762C8 -> 0x800762F8
static unsigned char xTRCIsNextState(int i /* r0 */, unsigned int state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x800762F8 -> 0x80076328
static unsigned char xTRCIsNextPadState(int i /* r0 */, unsigned int state /* r0 */) {
    // References
    // -> static struct _tagTRCPadInfo gTrcPad[4];
}

// Range: 0x80076328 -> 0x800763C8
static unsigned char xTRCBabbleSort(unsigned char (* funcShake)(int, unsigned int) /* r26 */, unsigned int state /* r27 */) {
    // Local variables
...
// Range: 0x800764DC -> 0x800766EC
void xTRCUpdate(int i /* r30 */) {
    // Local variables
    int padPortP1; // r0
    int padPortP2; // r0
    int startidx; // r1+0x8
...
static char composed_message_text[256]; // size: 0x100, address: 0x80337FF0
static const char * message_text; // size: 0x4, address: 0x803C15F0
// Range: 0x80076978 -> 0x8007698C
...
// Range: 0x800769E4 -> 0x80076A04
void xTRCReset() {}

// Range: 0x80076A04 -> 0x80076A50
void xTRCPadSetPressed(int port /* r0 */, int value /* r0 */, unsigned char reverse /* r0 */) {
    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x80076A50 -> 0x80076A7C
...
static class xtextbox tb; // size: 0x74, address: 0x802D3450
static signed char init; // size: 0x1, address: 0x803C15F4
// Range: 0x80076B10 -> 0x80076CB0
