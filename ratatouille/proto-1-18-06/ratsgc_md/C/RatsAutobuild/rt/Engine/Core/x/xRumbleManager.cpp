/*
    ...
    Language: C++
    Code range: 0x8005B2D0 -> 0x8005BC74
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8005B3BC -> 0x8005B400
// this: r31
void effectInternal::EndCameraShake() {}

// Range: 0x8005B400 -> 0x8005B558
// this: r30
...
// Range: 0x8005B558 -> 0x8005B5BC
// this: r0
void padInfo::FindNewExclusive() {
    // Local variables
    unsigned int maxPriority; // r7
    unsigned int i; // r0
...
// total size: 0x4
struct /* @class$786xRumbleManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804xRumbleManager_cpp */ {
    // Members
...
union /* @class$805xRumbleManager_cpp */ {
...
// Range: 0x8005B5F0 -> 0x8005B868
// this: r29
unsigned char Manager::Add(struct _tagxPad * pad /* r27 */, struct emitterBase * pEmitter /* r30 */) {
    // Local variables
    int counter; // r31
    int i; // r28
    struct padInfo * pInfo; // r31
    float timeToLive; // f1
    unsigned char rumbleForever; // r7
    struct effectInternal * currentExclusive; // r0
    const struct emitterBase * pCurrentEmitter; // r3
    unsigned int effectPriority; // r4
    struct effectInternal * freeEffect; // r9
    unsigned int i; // r0
...
// Range: 0x8005B8C8 -> 0x8005BACC
// this: r0
void Manager::Update(struct _tagxPad * pad /* r28 */, const struct xVec3 & playerPos /* r29 */, float timeElapsed /* f0 */, unsigned char bPauseState /* r30 */) {
    // Local variables
    struct padInfo * pInfo; // r31
    unsigned int i; // r0
    float intensity; // f31
...
static signed char init; // size: 0x1, address: 0x803C12D0
static class Manager rumbleManager; // size: 0x510, address: 0x803254A8
// Range: 0x8005BACC -> 0x8005BB10
...
// Range: 0x8005BB10 -> 0x8005BB54
// this: r31
void Manager::Reset() {}

// Range: 0x8005BB54 -> 0x8005BB8C
// this: r31
Manager::Manager() {}

struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80316480
// Range: 0x8005BB8C -> 0x8005BBD8
