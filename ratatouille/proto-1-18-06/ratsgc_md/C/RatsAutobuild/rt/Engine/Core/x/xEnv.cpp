/*
    ...
    Language: C++
    Code range: 0x8002F54C -> 0x8002F75C
*/
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8002F54C -> 0x8002F628
void xEnvLoadJSPList(struct xEnv * env /* r25 */, int dataType /* r26 */) {
    // Local variables
...
// Range: 0x8002F628 -> 0x8002F66C
void xEnvSetup(struct xEnv * env /* r31 */) {
    // References
    // -> struct xEnv * gCurXEnv;
}

// Range: 0x8002F66C -> 0x8002F6AC
void xEnvFree(struct xEnv * env /* r31 */) {}

// Range: 0x8002F6AC -> 0x8002F714
void xEnvRender(struct xEnv * env /* r31 */, unsigned char alpha /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8002F714 -> 0x8002F75C
void xEnvResetJSPVisibilities(struct xEnv * env /* r0 */) {
    // Local variables
    int i; // r7
}
