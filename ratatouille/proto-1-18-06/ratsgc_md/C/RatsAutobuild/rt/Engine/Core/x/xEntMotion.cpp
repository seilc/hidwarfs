/*
    ...
    Language: C++
    Code range: 0x8002C650 -> 0x8002ED9C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$786xEntMotion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804xEntMotion_cpp */ {
    // Members
...
void xEntMotionReset(struct xEntMotion * motion /* r29 */, struct xScene * sc /* r28 */) {
    ...
    float scale; // f2
    float model_scale; // f3
    float asset_scale; // f0
    float drot; // f31
}

// Range: 0x8002CF74 -> 0x8002D03C
void xEntMotionMove(struct xEntMotion * motion /* r31 */, struct xScene * sc /* r0 */, float dt /* f31 */, struct xEntFrame * frame /* r0 */) {}

// Range: 0x8002D03C -> 0x8002D1F4
static void xEntERMove(struct xEntMotion * motion /* r30 */, float dt /* f30 */, struct xEntFrame * frame /* r31 */) {
    // Local variables
    float newt; // f1
    float rem; // f2
    float scale; // f31
...
// Range: 0x8002E190 -> 0x8002E428
static unsigned int xEntScale(struct xEntMotion * motion /* r0 */, float dt /* f0 */, struct xEntFrame * frame /* r30 */) {
    // Local variables
    struct xEntMechData * mech; // r0
    struct xEntMotionMechData * mkasst; // r0
...
// Range: 0x8002EA70 -> 0x8002EBF4
void xEntMechReverse(struct xEntMotion * motion /* r30 */) {
    // Local variables
    struct xEntMechData * mech; // r0
    struct xEntMotionMechData * mkasst; // r0
}

// Range: 0x8002EBF4 -> 0x8002ED9C
