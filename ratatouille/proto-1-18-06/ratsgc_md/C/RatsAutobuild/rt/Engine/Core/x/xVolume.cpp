/*
    ...
    Language: C++
    Code range: 0x80078C30 -> 0x80078CF8
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80078C30 -> 0x80078C88
// this: r30
void xVolume::Init(struct xVolumeAsset * asset /* r31 */) {}

// Range: 0x80078C88 -> 0x80078CAC
// this: r0
void xVolume::Reset() {}

// Range: 0x80078CAC -> 0x80078CCC
// this: r0
void xVolume::Save(struct xSerial * s /* r0 */) {}

// total size: 0x0
struct xSerial {};
// Range: 0x80078CCC -> 0x80078CEC
// this: r0
void xVolume::Load(struct xSerial * s /* r0 */) {}

// Range: 0x80078CEC -> 0x80078CF8
// this: r0
