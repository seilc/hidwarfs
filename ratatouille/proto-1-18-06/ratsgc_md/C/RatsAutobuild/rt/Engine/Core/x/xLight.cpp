/*
    ...
    Language: C++
    Code range: 0x800421F8 -> 0x80043A40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xLight * sLight[128]; // size: 0x200, address: 0x80310448
static int sLightTotal; // size: 0x4, address: 0x803C0F78
static struct xLight sTempLights[16]; // size: 0xD00, address: 0x80310648
static struct xLightAsset sTempLightAssets[16]; // size: 0x4C0, address: 0x80311348
static struct xModelInstance * sTempLightCards[16]; // size: 0x40, address: 0x803C0F7C
// total size: 0xC
struct lightFlash {
    // Members
...
static struct lightFlash sLightFlashes[4]; // size: 0x30, address: 0x803C0FBC
// Range: 0x800421F8 -> 0x8004226C
void xLightResetAll() {
    // Local variables
    int i; // r0
...
// Range: 0x8004226C -> 0x80042294
void xLightSceneInit() {}

// Range: 0x80042294 -> 0x800422B8
void xLightSceneExit() {}

// Range: 0x800422B8 -> 0x800422E0
...
// Range: 0x800422E0 -> 0x80042300
void xLightInit(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x80042300 -> 0x80042430
void xLightInit(struct xBase * b /* r31 */, struct xLightAsset * tasset /* r30 */) {
    // Local variables
    struct xLight * light; // r31
    unsigned int itype; // r4
...
// Range: 0x80042430 -> 0x800425B0
void xLightInitTempLights() {
    // Local variables
    struct RpAtomic * lightCardModel; // r29
    int i; // r28
...
// Range: 0x800425B0 -> 0x800426E8
struct xLight * xLightCreateTempInternal(unsigned char useLightCard /* r29 */) {
    // Local variables
    int i; // r30
...
// Range: 0x800426E8 -> 0x80042730
void xLightDestroyTempInternal(struct xLight * xl /* r31 */) {}

// Range: 0x80042730 -> 0x800427B4
void xLightResolveLinks() {
    // Local variables
    int i; // r28
    struct xLight * xl; // r27
...
// Range: 0x8004281C -> 0x80042868
void xLightDestroy(struct xLight * xl /* r31 */) {}

// Range: 0x80042868 -> 0x80042950
void xLightReset(struct xLight * xl /* r31 */) {}

// Range: 0x80042950 -> 0x80042AE8
void xLightEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */) {
    // Local variables
    struct xLight * xl; // r4
    unsigned char resetEffect; // r5
}
...
static void xLightUpdateLightCard(struct xLight * xl /* r31 */) {
    ...
    struct RpGeometry * geometery; // r5
...
// Range: 0x80043148 -> 0x800431DC
void xLightAddLocalEnv(struct xEnv * env /* r27 */) {
    // Local variables
    int i; // r29
    struct xLight * xlight; // r4
    struct iLight * light; // r28
...
struct xGrid grabbable_grid; // size: 0x38, address: 0x803C1EE8
...
// Range: 0x800431FC -> 0x800433C0
void xLightPrepLocal() {
    // Local variables
    int i; // r29
    struct xLight * xlight; // r23
...
static unsigned char xLightCollisionCallback::operator()(struct xEnt & ent /* r30 */) {
    ...
    int furthestLight; // r7
    int i; // r8
    int freeLight; // r0
}

// Range: 0x80043520 -> 0x8004352C
// this: r0
...
// Range: 0x80043614 -> 0x80043650
void xLightSetEffect(struct xLight * xl /* r31 */, unsigned int effectID /* r4 */) {}

// Range: 0x80043650 -> 0x800436C8
void xLightResetEffect(struct xLight * xl /* r3 */) {}

// Range: 0x800436C8 -> 0x8004378C
void xLightOn(struct xLight * xl /* r31 */, unsigned char on /* r0 */, float transitionTime /* f0 */) {}

// Range: 0x8004378C -> 0x800437C8
void xLightToggle(struct xLight * xl /* r0 */, float transitionTime /* f0 */) {}

// Range: 0x800437C8 -> 0x8004381C
...
// Range: 0x8004381C -> 0x80043898
void xLightSetColor(struct xLight * xl /* r30 */, const struct _xFColor & col /* r31 */, float transitionTime /* f31 */) {}

// Range: 0x800438BC -> 0x800438E0
void xLightGetColor(struct xLight * xl /* r3 */, struct _xFColor & col /* r0 */) {}

// Range: 0x800438E0 -> 0x80043904
void xLightSetPos(struct xLight * xl /* r3 */, const struct xVec3 & pos /* r0 */) {}

// Range: 0x80043904 -> 0x80043928
void xLightSetRadius(struct xLight * xl /* r3 */, float radius /* f0 */) {}

// Range: 0x80043928 -> 0x80043A40
void xLightFlash(const struct xVec3 & pos /* r29 */, const struct _xFColor & color /* r30 */, float radius /* f28 */, float upTime /* f29 */, float maxTime /* f30 */, float downTime /* f31 */) {
    // Local variables
