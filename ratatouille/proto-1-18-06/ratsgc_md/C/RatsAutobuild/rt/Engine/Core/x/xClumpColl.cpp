/*
    ...
    Language: C++
    Code range: 0x80012110 -> 0x80013E58
*/
unsigned char xClumpColl_FilterFlags; // size: 0x1, address: 0x803BD568
unsigned char xClumpColl_FilterFlagsAllMask; // size: 0x1, address: 0x803C0C90
unsigned char xClumpColl_FilterFlagsAllEqual; // size: 0x1, address: 0x803BD569
// Range: 0x80012110 -> 0x80012138
...
// Range: 0x80012338 -> 0x80012C28
struct xClumpCollBSPTree * xClumpColl_ForAllLineLeafNodeIntersections(struct xClumpCollBSPTree * tree /* r25 */, struct RwLine * line /* r0 */, struct xClumpCollV3dGradient * grad /* r26 */, int (* callBack)(struct xClumpCollBSPTriangle *, void *) /* r27 */, void * data /* r28 */) {
    // Local variables
    int nStack; // r30
...
// Range: 0x80012C78 -> 0x80013588
struct xClumpCollBSPTree * xClumpColl_ForAllCapsuleLeafNodeIntersections(struct xClumpCollBSPTree * tree /* r25 */, struct RwLine * line /* r0 */, float radius /* f31 */, struct xClumpCollV3dGradient * grad /* r26 */, int (* callBack)(struct xClumpCollBSPTriangle *, void *) /* r27 */, void * data /* r28 */) {
    // Local variables
    int nStack; // r30
    struct nodeInfo nodeStack[33]; // r1+0x68
    struct nodeInfo node; // r1+0x18
...
// Range: 0x8001394C -> 0x80013A48
static int LeafNodeSpherePolyIntersect(struct xClumpCollBSPTriangle * triangles /* r25 */, void * data /* r0 */) {
    // Local variables
    struct PolyTestParam * isData; // r0
    struct CallBackParam * cbParam; // r30
    struct TestSphere * testSphere; // r29
    struct RwV3d * v0; // r28
    struct RwV3d * v1; // r27
    struct RwV3d * v2; // r26
...
// Range: 0x80013A48 -> 0x80013BCC
static int LeafNodeBoxPolyIntersect(struct xClumpCollBSPTriangle * triangles /* r25 */, void * data /* r4 */) {
    // Local variables
    struct PolyTestParam * isData; // r30
...
// Range: 0x80013BCC -> 0x80013E24
struct xClumpCollBSPTree * xClumpColl_ForAllIntersections(struct xClumpCollBSPTree * tree /* r30 */, struct RpIntersection * intersection /* r31 */, struct RpCollisionTriangle * (* callBack)(struct RpIntersection *, struct RpWorldSector *, struct RpCollisionTriangle *, float, void *) /* r0 */, void * data /* r0 */) {
    // Local variables
