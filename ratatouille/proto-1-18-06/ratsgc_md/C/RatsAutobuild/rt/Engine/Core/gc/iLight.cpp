/*
    ...
    Language: C++
    Code range: 0x8007E780 -> 0x8007EBD0
*/
// Range: 0x8007E780 -> 0x8007E784
void iLightInit() {}

// Range: 0x8007E784 -> 0x8007E788
void iLightDeinit() {}
...
static struct RpTie dummyTie; // size: 0x18, address: 0x803C1680
// total size: 0x8
struct RpTriangle {
    // Members
...
static struct RpWorldSector dummyWorldSector; // size: 0x88, address: 0x8033B598
// total size: 0xC
struct xModelPool {
    // Members
...
// Range: 0x8007EA50 -> 0x8007EAD8
void iLightAddForModel(struct xModelInstance * minst /* r0 */, struct iLight * * lights /* r0 */, int numLights /* r0 */) {
    // Local variables
    struct RpAtomic * atomic; // r8
    int i; // r0
...
// Range: 0x8007EAD8 -> 0x8007EB30
void iLightRemoveFromModel(struct iLight * * lights /* r0 */, int numLights /* r0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x8007EB30 -> 0x8007EB84
void iLightEnv(struct iLight * light /* r0 */, int env /* r0 */) {
    // Local variables
