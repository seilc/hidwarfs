/*
    ...
    Language: C++
    Code range: 0x80038BA0 -> 0x8003A9FC
*/
// total size: 0x8
struct RwObject {
    // Members
...
struct RpAtomic * (* gAtomicRenderCallBack)(struct RpAtomic *); // size: 0x4, address: 0x803C0EC0
// total size: 0x10
struct RwRGBAReal {
    // Members
...
struct RpLight * MainLight; // size: 0x4, address: 0x803C0EC4
// total size: 0x8
struct fxAtomic {
    // Members
...
static unsigned int num_fx_atomics; // size: 0x4, address: 0x803C0EC8
// total size: 0x40
struct RwMatrixTag {
    // Members
...
static struct RwFrame * g_matfx_frame; // size: 0x4, address: 0x803C0ECC
unsigned int xfx_initted; // size: 0x4, address: 0x803C0ED0
// Range: 0x80038BA0 -> 0x80038C24
void xFXInit() {
    // Local variables
...
struct xFXRing ringlist[8]; // size: 0x200, address: 0x80310148
// total size: 0x24
...
// Range: 0x80038C24 -> 0x80038C90
void xFXRingInit() {
    // Local variables
    int i; // r29
    struct xFXRing * ringdata; // r28

    // References
    // -> struct xFXRing ringlist[8];
}

// Range: 0x80038C90 -> 0x80038CD8
...
unsigned int gFXSurfaceFlags; // size: 0x4, address: 0x803C1B60
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80038E58 -> 0x80039078
void xFX_SceneEnter(struct RpWorld * world /* r27 */) {
    // Local variables
    int i; // r30
    int num; // r29
    ...
    struct RwTexture * bump; // r5
    struct xScene * sc; // r7
    struct xEnt * ent; // r8
    struct RpAtomic * (* tmp)(struct RpAtomic *); // r9
...
// Range: 0x80039078 -> 0x8003907C
void xFX_SceneExit() {}

// Range: 0x8003907C -> 0x800390B0
...
static struct RxPipeline * xFXanimUVPipeline; // size: 0x4, address: 0x803C0ED4
float xFXanimUVRotMat0[2]; // size: 0x8, address: 0x803BD6A0
float xFXanimUVRotMat1[2]; // size: 0x8, address: 0x803BD6A8
float xFXanimUVTrans[2]; // size: 0x8, address: 0x803BD6B0
float xFXanimUVScale[2]; // size: 0x8, address: 0x803BD6B8
// Range: 0x800393A8 -> 0x800393C0
void xFXanimUVSetTranslation(const struct xVec3 * trans /* r0 */) {
    // References
    // -> float xFXanimUVTrans[2];
}

// Range: 0x800393C0 -> 0x800393D8
void xFXanimUVSetScale(const struct xVec3 * scale /* r0 */) {
    // References
    // -> float xFXanimUVScale[2];
}

// Range: 0x800393D8 -> 0x80039434
...
float xFXanimUV2PRotMat0[2]; // size: 0x8, address: 0x803BD6C0
float xFXanimUV2PRotMat1[2]; // size: 0x8, address: 0x803BD6C8
float xFXanimUV2PTrans[2]; // size: 0x8, address: 0x803BD6D0
float xFXanimUV2PScale[2]; // size: 0x8, address: 0x803BD6D8
struct RwTexture * xFXanimUV2PTexture; // size: 0x4, address: 0x803C0ED8
// Range: 0x80039434 -> 0x8003944C
void xFXanimUV2PSetTranslation(const struct xVec3 * trans /* r0 */) {
    // References
    // -> float xFXanimUV2PTrans[2];
}

// Range: 0x8003944C -> 0x80039464
void xFXanimUV2PSetScale(const struct xVec3 * scale /* r0 */) {
    // References
    // -> float xFXanimUV2PScale[2];
}

// Range: 0x80039464 -> 0x800394C0
...
// Range: 0x800394C0 -> 0x800394C8
void xFXanimUV2PSetTexture(struct RwTexture * texture /* r0 */) {
    // References
    // -> struct RwTexture * xFXanimUV2PTexture;
}

static struct RwMatrixTag gFXUVs[2]; // size: 0x80, address: 0x80310348
// Range: 0x800394C8 -> 0x80039730
...
class tier_queue_allocator joint_alloc; // size: 0x1C, address: 0x803C0EDC
struct activity_data * activities[32]; // size: 0x80, address: 0x803103C8
int activities_used; // size: 0x4, address: 0x803C0EF8
unsigned char need_sort; // size: 0x1, address: 0x803C0EFC
// total size: 0x48
struct activity_data {
    // Members
...
// Range: 0x8003976C -> 0x8003978C
// this: r0
void xFXRibbon::create() {}

// Range: 0x8003978C -> 0x800397D0
// this: r31
...
static struct curve_node default_curve[2]; // size: 0x18, address: 0x803C4DF4
// Range: 0x800397D0 -> 0x80039844
void xFXRibbon::load_default_config(struct config_type & cfg /* r31 */) {
    // References
    // -> static struct curve_node default_curve[2];
}

// Range: 0x80039844 -> 0x800398B0
// this: r30
...
// Range: 0x800398B0 -> 0x800399B0
// this: r27
void xFXRibbon::insert(const struct xVec3 & loc /* r28 */, const struct xVec3 & norm /* r29 */, float scale /* f30 */, float alpha /* f31 */, int flags /* r30 */) {
    // Local variables
...
// Range: 0x8003A2C0 -> 0x8003A684
// this: r27
void xFXRibbon::render_strip(struct RxObjSpace3DVertex * verts /* r28 */, class iterator & first /* r29 */, unsigned long size /* r30 */) {
    // Local variables
    struct RxObjSpace3DVertex * v; // r31
    class iterator it; // r1+0x28
    class iterator last; // r1+0x20
    struct joint_data & joint; // r26
