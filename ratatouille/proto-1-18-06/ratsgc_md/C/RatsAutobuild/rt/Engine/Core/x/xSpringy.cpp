/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xSpringy.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80152314 -> 0x801523D4
*/
// total size: 0x8
struct substr {
    // Members
...
// total size: 0x1
struct /* @class$713xSpringy_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$714xSpringy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$715xSpringy_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$716xSpringy_cpp */ {
    // Members
