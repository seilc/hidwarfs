/*
    ...
    Language: C++
    Code range: 0x80084298 -> 0x800856DC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int gColorTableInit; // size: 0x4, address: 0x803C1770
static float gColorTable[256]; // size: 0x400, address: 0x8033BD48
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x80084308 -> 0x8008462C
void iParMgrRenderParSys_Sprite(void * data /* r28 */, struct xParGroup * ps /* r27 */) {
    // Local variables
    struct xPar * idx; // r29
...
// Range: 0x8008462C -> 0x800846C8
void iRenderSetCameraViewMatrix(struct xMat4x3 * m /* r3 */) {
    // References
    // -> struct tagiRenderInput gRenderBuffer;
    // -> void * RwEngineInstance;
...
static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x8033C148
static unsigned short i3d[6]; // size: 0xC, address: 0x803BDB80
// Range: 0x800846C8 -> 0x800849B4
...
static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x8033C1D8
static unsigned short i3d[6]; // size: 0xC, address: 0x803BDB8C
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x80085250 -> 0x80085254
void iParMgrRenderParSys_Static() {}

static struct RxObjSpace3DVertex v3d[4]; // size: 0x90, address: 0x8033C268
static unsigned short i3d[6]; // size: 0xC, address: 0x803BDB98
// Range: 0x80085254 -> 0x8008564C
