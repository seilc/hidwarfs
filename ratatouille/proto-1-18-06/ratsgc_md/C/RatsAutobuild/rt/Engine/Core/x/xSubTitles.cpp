/*
    ...
    Language: C++
    Code range: 0x800745D4 -> 0x80074950
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x803C5690
static float subtitleFontWidth; // size: 0x4, address: 0x803BDA90
static float subtitleFontHeight; // size: 0x4, address: 0x803BDA94
static float subtitleSize; // size: 0x4, address: 0x803C1578
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct xSubtitlesAsset * m_pCurrentAsset; // size: 0x4, address: 0x803C157C
static unsigned int m_uLastTimeKey; // size: 0x4, address: 0x803C1580
// Range: 0x800745D4 -> 0x80074640
void xSubTitlesInit() {
    // References
...
// Range: 0x80074698 -> 0x8007469C
void xSubTitlesUnloaded() {}

static unsigned int last_failed_aid; // size: 0x4, address: 0x803C1584
static signed char init; // size: 0x1, address: 0x803C1588
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x8007469C -> 0x80074940
unsigned char xSubTitlesRender(unsigned int aid /* r31 */, float fTime /* f31 */) {
    // Local variables
    unsigned int uSearchIndex; // r6
    char * pszDisplay; // r31
...
// total size: 0x2
struct /* @class$742xSubTitles_cpp */ {
    // Members
...
// Range: 0x80074940 -> 0x80074948
void xSubTitlesSetSize(float size /* f0 */) {
    // References
    // -> static float subtitleSize;
}

// Range: 0x80074948 -> 0x80074950
