/*
    ...
    Language: C++
    Code range: 0x80131460 -> 0x80131728
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80131460 -> 0x801314F0
void xIMLock(struct xIMLockContext & context /* r27 */, enum xIMFormat format /* r28 */, int vertCount /* r29 */) {
    // Local variables
    int pos_qwords; // r31
    int uv_qwords; // r30
    unsigned char * data_buffer; // r4
}
...
static struct rwGameCube2DVertex vx[4]; // size: 0x60, address: 0x80388828
void * RwEngineInstance; // size: 0x4, address: 0x803C4584
// Range: 0x80131654 -> 0x80131728
