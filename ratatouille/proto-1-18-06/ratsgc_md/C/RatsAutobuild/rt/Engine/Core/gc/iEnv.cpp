/*
    ...
    Language: C++
    Code range: 0x8007B4D8 -> 0x8007C560
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sBeginDrawFX; // size: 0x4, address: 0x803C1638
// total size: 0x8
struct RwObject {
    // Members
...
static struct RpWorld * sPipeWorld; // size: 0x4, address: 0x803C163C
// total size: 0x14
...
static struct RwCamera * sPipeCamera; // size: 0x4, address: 0x803C1640
...
static struct RpGameCubeTevOp sTevOpAddLightmap; // size: 0x50, address: 0x802D3910
static struct RpGameCubeTevOp sTevOpModulate; // size: 0x50, address: 0x802D3960
enum RpGXTexGenType {
    rpGX_TG_MTX3x4 = 0,
    rpGX_TG_MTX2x4 = 1,
    rpGX_TG_BUMP0 = 2,
...
static struct RpGameCubeTexGen sTexGenIdentity; // size: 0x18, address: 0x803BDAF0
enum RwPlatformID {
    rwID_PCD3D7 = 1,
    rwID_PCOGL = 2,
    rwID_MAC = 3,
...
static struct RpMTEffect * sEffectLightMap; // size: 0x4, address: 0x803C1644
// total size: 0x10
struct RwSphere {
    // Members
...
// Range: 0x8007B4D8 -> 0x8007B5F8
static struct RpAtomic * SetPipelineCB(struct RpAtomic * atomic /* r31 */) {
    // Local variables
    ...
    int j; // r0
    struct RwTexture * baseTexture; // r27
    struct RwTexture * lightmapTexture; // r26
...
// Range: 0x8007B7CC -> 0x8007B8AC
void iEnvLoadBegin(struct iEnv * env /* r29 */, int dataType /* r0 */, int count /* r30 */) {
    // Local variables
...
// Range: 0x8007B8AC -> 0x8007B988
unsigned char iEnvLoadJSP(struct iEnv * env /* r30 */, unsigned int aid /* r0 */, void * data /* r0 */, int dataType /* r0 */, int index /* r31 */) {
    // Local variables
    struct xJSPHeader * jsp; // r0
}

// Range: 0x8007B988 -> 0x8007BA10
void iEnvJSPVisibilityInc(struct iEnv * env /* r30 */, struct xJSPHeader * jsp /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8007BA10 -> 0x8007BA98
void iEnvJSPVisibilityDec(struct iEnv * env /* r30 */, struct xJSPHeader * jsp /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8007BA98 -> 0x8007BB1C
void iEnvJSPOn(struct iEnv * env /* r30 */, struct xJSPHeader * jsp /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8007BB1C -> 0x8007BBA0
void iEnvJSPOff(struct iEnv * env /* r30 */, struct xJSPHeader * jsp /* r0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x8007BBA0 -> 0x8007BC18
void iBuildJSPBound(const struct xClumpCollBSPTree * colltree /* r0 */, struct xBox & box /* r25 */) {
    // Local variables
    int j; // r27
    int k; // r26
}

// Range: 0x8007BC18 -> 0x8007BC74
...
// Range: 0x8007BC74 -> 0x8007BCE0
void iEnvFree(struct iEnv * env /* r31 */) {}

// Range: 0x8007BCE0 -> 0x8007BCE4
void iEnvDefaultLighting() {}

// Range: 0x8007BCE4 -> 0x8007BCE8
...
static struct iEnv * lastEnv; // size: 0x4, address: 0x803C1648
// Range: 0x8007BCE8 -> 0x8007BCF0
void iEnvSetup(struct iEnv * env /* r0 */) {
    // References
    // -> static struct iEnv * lastEnv;
}

// Range: 0x8007BCF0 -> 0x8007BD50
...
static struct iEnv * sCmpEnv; // size: 0x4, address: 0x803C164C
static int sColorCompare; // size: 0x4, address: 0x803C1650
...
// Range: 0x8007C014 -> 0x8007C218
static void iEnvMatOrderSetup(struct iEnv * env /* r30 */) {
    // Local variables
    int i; // r6
    int currJSPNode; // r0
    int currMatGroup; // r31
    int nodeIndex; // r12
    struct RwLLLink * cur; // r28
    struct RwLLLink * end; // r27
    struct RpClump * clump; // r5
    int i; // r5
