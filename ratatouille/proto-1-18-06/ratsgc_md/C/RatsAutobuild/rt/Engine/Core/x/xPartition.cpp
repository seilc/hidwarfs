/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xPartition.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80055D14 -> 0x80055D18
*/
// Range: 0x80055D14 -> 0x80055D18
...
struct _tagPartLink {
    ...
    struct _tagPartLink * next; // offset 0x4, size 0x4
};
// total size: 0xC
struct _tagPartSpace {
    // Members
    int total; // offset 0x0, size 0x4
    struct _tagPartLink head; // offset 0x4, size 0x8
};
// total size: 0xC
struct RwV3d {
    // Members
...
struct _tagPartition {
    // Members
    struct xVec3 min; // offset 0x0, size 0xC
    struct xVec3 max; // offset 0xC, size 0xC
    struct xVec3 space_dim; // offset 0x18, size 0xC
    int total_x; // offset 0x24, size 0x4
    int total_y; // offset 0x28, size 0x4
    int total_z; // offset 0x2C, size 0x4
    struct _tagPartSpace * space; // offset 0x30, size 0x4
    struct _tagPartSpace global; // offset 0x34, size 0xC
};
// total size: 0x20
struct xLinkAsset {
    // Members
