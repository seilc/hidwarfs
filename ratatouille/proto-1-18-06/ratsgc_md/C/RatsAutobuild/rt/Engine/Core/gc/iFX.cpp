/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\gc\iFX.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8007E454 -> 0x8007E780
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
int _rpDlGeomVtxFmtOffset; // size: 0x4, address: 0x803C44F8
void * RwEngineInstance; // size: 0x4, address: 0x803C4584
int _rpDlWorldVtxFmtOffset; // size: 0x4, address: 0x803C44FC
...
// Range: 0x8007E454 -> 0x8007E6BC
static void * _iGCUVRenderCallback(void * object /* r28 */, struct RxGameCubePipeData * pipeData /* r29 */) {
    // Local variables
    unsigned int numMeshes; // r27
    struct RxGameCubeVertexBuffer * vbHeader; // r27
    struct RxGameCubeDisplayList * dList; // r31
    struct RpMesh * mesh; // r26
    struct RwMatrixTag * ltm; // r26
    void (* matFunc)(struct RwRGBAReal *, struct RwRGBA *, float); // r30
    struct RpAtomic * atomic; // r0
    float tmtx[3][4]; // r1+0x8
...
// Range: 0x8007E6E4 -> 0x8007E780
struct RxPipeline * iFXanimUVCreatePipe() {
    // Local variables
    struct RxPipeline * newPipe; // r31
    struct RxPipeline * lpipe; // r30
    struct RxNodeDefinition * instanceNode; // r30
    struct RxPipelineNode * node; // r0
}
