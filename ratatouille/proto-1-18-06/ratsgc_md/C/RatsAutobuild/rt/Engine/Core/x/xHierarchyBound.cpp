/*
    ...
    Language: C++
    Code range: 0x8003CB08 -> 0x8003CD9C
*/
...
// Range: 0x8003CB08 -> 0x8003CB78
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r29 */, const struct xHierarchyBoundInitData * init /* r0 */, unsigned int extraBounds /* r0 */) {
    // Local variables
...
// Range: 0x8003CB78 -> 0x8003CBC4
int xHierarchyBoundSetup(struct xHierarchyBound * bound /* r29 */, unsigned int nodesNumber /* r30 */) {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x8003CBC4 -> 0x8003CCD4
void xHierarchyBoundInit(struct xHierarchyBound * bound /* r24 */, const struct xHierarchyBoundInitData * init /* r25 */, float masterRadius /* f30 */, float scale /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$787xHierarchyBound_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$805xHierarchyBound_cpp */ {
    // Members
...
union /* @class$806xHierarchyBound_cpp */ {
