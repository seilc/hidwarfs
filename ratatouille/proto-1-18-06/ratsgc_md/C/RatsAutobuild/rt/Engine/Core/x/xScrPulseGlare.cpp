/*
    ...
    Language: C++
    Code range: 0x800F6FF4 -> 0x800F77A0
*/
// total size: 0xC
struct config {
    // Members
...
static struct xPulseGlareMgr glare_mgr; // size: 0x3600, address: 0x8037C208
// Range: 0x800F6FF4 -> 0x800F701C
static void init_pulse(struct xPulse & p /* r0 */) {}

// Range: 0x800F701C -> 0x800F7080
static void xPulseFn(struct xPulse & p /* r31 */) {}

// Range: 0x800F7080 -> 0x800F711C
static void init_pulse_glare(struct xPulseGlare & glare /* r31 */) {}

// Range: 0x800F711C -> 0x800F71F4
...
static struct RxObjSpace3DVertex sStripVert[4]; // size: 0x90, address: 0x8037F808
...
// Range: 0x800F71F4 -> 0x800F761C
static void render_pulse_glare(const struct xMat4x3 & mat /* r29 */, struct xPulseGlare * g /* r31 */) {
    // Local variables
