/*
    ...
    Language: C++
    Code range: 0x801520A8 -> 0x80152300
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class xOneLiner * sDelayedSound; // size: 0x4, address: 0x803C3000
...
// Range: 0x801520A8 -> 0x801520C8
void xOneLiner::SceneInit() {}

// Range: 0x801520C8 -> 0x801520D4
void xOneLiner::SceneReset() {
    // References
    // -> class xOneLiner * sDelayedSound;
}

// Range: 0x801520D4 -> 0x80152120
void xOneLiner::UpdateSounds() {
    // References
    // -> class xOneLiner * sDelayedSound;
}

// Range: 0x80152120 -> 0x80152228
// this: r31
...
// total size: 0x1
struct /* @class$696xOneLiner_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$697xOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$698xOneLiner_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$699xOneLiner_cpp */ {
    // Members
