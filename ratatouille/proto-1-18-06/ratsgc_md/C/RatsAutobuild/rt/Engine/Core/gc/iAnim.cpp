/*
    ...
    Language: C++
    Code range: 0x8008CE70 -> 0x8008D4D0
*/
static unsigned char g_iAnim_workBufferData[16384]; // size: 0x4000, address: 0x80350820
unsigned char * g_iAnim_workBuffer; // size: 0x4, address: 0x803BDC98
// Range: 0x8008CE70 -> 0x8008CE74
void iAnimInit() {}
