/*
    ...
    Language: C++
    Code range: 0x8002FEE8 -> 0x80030180
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sFMVVolumeScale; // size: 0x4, address: 0x803BD678
static void (* sxFMVPauseSoundCB)(unsigned char); // size: 0x4, address: 0x803BD67C
// Range: 0x8002FEE8 -> 0x8002FF2C
...
// Range: 0x8003001C -> 0x80030180
struct RwTexture * xFMVGetTexture(struct MOVIE * pMovie /* r31 */, unsigned short looping /* r26 */, unsigned short freezeframed /* r27 */, unsigned int startframe /* r28 */, unsigned int endframe /* r29 */) {
    // Local variables
    struct RwRaster * pBinkRaster; // r30
    unsigned char * pBits; // r4
    int bFailed; // r0
}
