/*
    ...
    Language: C++
    Code range: 0x8003D73C -> 0x8003EB84
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct /* @class$1182xHud_cpp */ {
    ...
    unsigned char type; // offset 0x0, size 0x1
    unsigned int size; // offset 0x4, size 0x4
} known_types[5]; // size: 0x28, address: 0x803C4E50
...
class block_allocator {
    // Functions
    void create(int block_size, int max_blocks);
...
// Range: 0x8003D73C -> 0x8003D79C
// this: r31
void block_allocator::create(int block_size /* r0 */, int max_blocks /* r0 */) {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x8003D79C -> 0x8003D7B0
// this: r0
...
// Range: 0x8003D7C0 -> 0x8003D80C
// this: r0
void block_allocator::reset() {
    // Local variables
    unsigned char * mem; // r5
    unsigned char * end_mem; // r4
}

class block_allocator motive_allocator; // size: 0x10, address: 0x803C0F10
static unsigned char inited; // size: 0x1, address: 0x803C0F20
// Range: 0x8003D80C -> 0x8003D848
void init() {
    // References
    // -> static unsigned char inited;
}

// Range: 0x8003D848 -> 0x8003D878
void destroy() {}

// Range: 0x8003D878 -> 0x8003D898
void update(float dt /* f0 */) {}

// Range: 0x8003D898 -> 0x8003D8C4
void render() {
    // References
    // -> static unsigned char inited;
}
...
// total size: 0x28
struct {} xhud::widget::__vtable; // size: 0x28, address: 0x803BD718
// total size: 0x8
struct /* @class$858xHud_cpp */ {
    // Members
...
// Range: 0x8003DA34 -> 0x8003DA54
// this: r0
void widget::destruct() {}

// Range: 0x8003DA54 -> 0x8003DA7C
// this: r0
void widget::presetup() {}

// Range: 0x8003DA7C -> 0x8003DB88
// this: r29
...
// Range: 0x8003DB88 -> 0x8003DC48
// this: r0
void widget::dispatcher(unsigned int event /* r0 */) {}

// Range: 0x8003DC48 -> 0x8003DC78
void widget::scene_enter() {
    // References
    // -> class block_allocator motive_allocator;
}

static unsigned int myid; // size: 0x4, address: 0x803C0F24
static signed char init; // size: 0x1, address: 0x803C0F28
// Range: 0x8003DC78 -> 0x8003DCB8
...
// Range: 0x8003E418 -> 0x8003E450
void widget::cb_dispatch(struct xBase * from /* r0 */, struct xBase * to /* r0 */, unsigned int event /* r0 */, const float * argf /* r0 */, struct xBase * argw /* r0 */, unsigned int argwi /* r0 */) {}
...
struct xModelInstance * load_model(unsigned int id /* r30 */) {
    ...
    struct xModelInstance * loaded_model; // r0
}

// Range: 0x8003E510 -> 0x8003E5E4
