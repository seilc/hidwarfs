/*
    ...
    Language: C++
    Code range: 0x800695D8 -> 0x8006A920
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$786xShadowSimple_cpp */ {
    // Members
...
union /* @class$617xShadowSimple_cpp */ {
...
// total size: 0xC
struct /* @class$805xShadowSimple_cpp */ {
    // Members
...
static struct xShadowSimpleQueue sCollQueue[2]; // size: 0x38, address: 0x803C1450
static struct xMat4x3 sCollModelMatrices[2]; // size: 0x80, address: 0x80329120
enum RwShadeMode {
...
static struct RxRenderStateVector xrsv; // size: 0x2C, address: 0x803C1488
// total size: 0x24
...
static struct RxObjSpace3DVertex sShadVert[384]; // size: 0x3600, address: 0x803291A0
static struct RwRaster * sShadRasters[64]; // size: 0x100, address: 0x8032C7A0
static struct RwRaster * sShadRaster; // size: 0x4, address: 0x803C14B4
static unsigned int sShadVertCount; // size: 0x4, address: 0x803C14B8
static struct RwMatrixTag * sModelMat; // size: 0x4, address: 0x803C14BC
// total size: 0x28
...
// Range: 0x800697D0 -> 0x800699A8
static void xShadowSimple_SceneCollide(struct xShadowSimpleCache * cache /* r31 */, const struct xVec3 * pos /* r0 */, float depth /* f0 */) {
    // Local variables
    struct xEnv * env; // r28
...
// Range: 0x80069E38 -> 0x80069F98
void xShadowSimple_CacheInit(struct xShadowSimpleCache * cache /* r29 */, struct xEnt * ent /* r30 */, unsigned char alpha /* r20 */) {
    // Local variables
    int i; // r22
    int n; // r0
    unsigned int j; // r21
...
// Range: 0x8006A230 -> 0x8006A4BC
void xShadowSimple_Add_Expert(struct xShadowSimpleCache * cache /* r29 */, const struct xMat4x3 * mat_owner /* r30 */, unsigned char alpha /* r0 */, float radius /* f29 */, float height /* f30 */, float ecc /* f31 */, unsigned char copyMat /* r31 */) {
    // Local variables
