/*
    ...
    Language: C++
    Code range: 0x8003B408 -> 0x8003C4DC
*/
// total size: 0x38
struct xGrid {
    // Members
...
// Range: 0x8003B408 -> 0x8003B43C
void xGridBoundInit(struct xGridBound * gridb /* r0 */, void * data /* r0 */) {}
...
// Range: 0x8003B43C -> 0x8003B5D4
void xGridInit(struct xGrid * grid /* r29 */, const struct xBox * bounds /* r0 */, unsigned short nx /* r30 */, unsigned short nz /* r0 */, unsigned char ingrid_id /* r0 */) {
    // Local variables
    float gsizex; // f7
    float gsizez; // f3
...
// Range: 0x8003B5D4 -> 0x8003B60C
void xGridKill(struct xGrid * grid /* r31 */) {}

// Range: 0x8003B60C -> 0x8003B6D0
void xGridEmpty(struct xGrid * grid /* r24 */) {
    // Local variables
    struct xGridBound * * head; // r28
...
// Range: 0x8003B6D0 -> 0x8003B74C
int xGridAddToCell(struct xGridBound * * cell /* r30 */, struct xGridBound * gridb /* r31 */) {}

// Range: 0x8003B74C -> 0x8003B788
static int xGridAdd(struct xGrid * grid /* r0 */, struct xGridBound * gridb /* r0 */, int x /* r0 */, int z /* r0 */) {}
...
// Range: 0x8003B788 -> 0x8003BA98
int xGridAdd(struct xGrid * grid /* r30 */, struct xEnt * ent /* r31 */) {
    // Local variables
    struct xBound * bound; // r0
    struct xVec3 * center; // r4
    float maxr; // f0
    struct xSphere * sph; // r3
    int r; // r3
    struct xBBox * bbox; // r4
    float rx; // f13
    float ry; // f31
    float rz; // f11
    float len2; // f1
    int r; // r3
    struct xBBox * bbox; // r3
    float rx; // f2
    float rz; // f3
    int r; // r3
    float cgridx; // f3
...
// Range: 0x8003BA98 -> 0x8003BB18
int xGridRemove(struct xGridBound * gridb /* r0 */) {
    // Local variables
    struct xGridBound * cur; // r6
    struct xGridBound * * prev; // r5
}

// Range: 0x8003BB18 -> 0x8003BC1C
void xGridUpdate(struct xGrid * grid /* r31 */, struct xEnt * ent /* r30 */) {
    // Local variables
    int dx; // r1+0xC
    int dz; // r1+0x8
    struct xGridBound * gridb; // r5
    struct xGridBound * cur; // r6
    struct xGridBound * * prev; // r3
    struct xGridBound * * cell; // r3
}

// Range: 0x8003BC1C -> 0x8003BC98
static struct xGridBound * * xGridGetCell(struct xGrid * grid /* r29 */, const struct xEnt * ent /* r0 */, int & grx /* r30 */, int & grz /* r31 */) {
    // Local variables
    const struct xVec3 * center; // r0
}

// Range: 0x8003BC98 -> 0x8003BDB4
void xGridGetCell(struct xGrid * grid /* r0 */, float posx /* f0 */, float posz /* f0 */, int & grx /* r0 */, int & grz /* r0 */) {
    // Local variables
    float pgridx; // f4
    float pgridz; // f3
}

// Range: 0x8003BDB4 -> 0x8003BE00
...
// Range: 0x8003BE00 -> 0x8003BF58
int xGridEntIsTooBig(struct xGrid * grid /* r0 */, const struct xEnt * ent /* r0 */) {
    // Local variables
...
static int offs[4][3][2]; // size: 0x60, address: 0x802BC440
static int k; // size: 0x4, address: 0x803C0F00
// total size: 0xC
...
// Range: 0x8003BF58 -> 0x8003C1F0
void xGridCheckPosition(struct xGrid * grid /* r27 */, struct xVec3 * pos /* r25 */, struct xQCData * qcd /* r28 */, int (* hitCB)(struct xEnt *, void *) /* r29 */, void * cbdata /* r30 */) {
    // Local variables
