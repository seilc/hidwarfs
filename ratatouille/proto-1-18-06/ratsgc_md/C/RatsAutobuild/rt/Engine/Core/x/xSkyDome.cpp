/*
    ...
    Language: C++
    Code range: 0x8006A9B0 -> 0x8006AD28
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct SkyDomeInfo sSkyList[16]; // size: 0x140, address: 0x8032C8A0
static int sSkyCount; // size: 0x4, address: 0x803C14C0
// Range: 0x8006A9B0 -> 0x8006A9B4
void xSkyDome_EmptyRender() {}

// Range: 0x8006A9B4 -> 0x8006A9C0
void xSkyDome_Setup() {
    // References
    // -> static int sSkyCount;
}

// Range: 0x8006A9C0 -> 0x8006AB54
void xSkyDome_AddEntity(struct xEnt * ent /* r26 */, int sortorder /* r27 */, int lockY /* r28 */, int lockXZ /* r29 */, int ZReadWrite /* r30 */) {
    // Local variables
    unsigned char inList; // r5
    int i; // r0
    int j; // r22
