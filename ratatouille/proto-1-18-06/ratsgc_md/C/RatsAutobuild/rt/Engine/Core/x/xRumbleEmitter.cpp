/*
    ...
    Language: C++
    Code range: 0x8005A9E0 -> 0x8005B1E8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8005A9E0 -> 0x8005AAD0
static void emitter_EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
...
// Range: 0x8005AAD0 -> 0x8005AC0C
// this: r0
float effectAsset::GetIntensity(float currentTime /* f29 */, float totalTime /* f0 */) const {
    // Local variables
...
// Range: 0x8005AC0C -> 0x8005AC50
void effect::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x10
struct {} xRumble::effect::__vtable; // size: 0x10, address: 0x803BD8C4
// Range: 0x8005AC50 -> 0x8005ACBC
// this: r30
...
// Range: 0x8005ACC8 -> 0x8005AD0C
void boxEmitter::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x10
struct {} xRumble::boxEmitter::__vtable; // size: 0x10, address: 0x803BD8A4
// Range: 0x8005AD0C -> 0x8005AD88
// this: r30
...
// total size: 0x4
struct /* @class$786xRumbleEmitter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804xRumbleEmitter_cpp */ {
    // Members
...
union /* @class$805xRumbleEmitter_cpp */ {
...
// Range: 0x8005AEF4 -> 0x8005AF38
void sphericalEmitter::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x14
struct {} xRumble::sphericalEmitter::__vtable; // size: 0x14, address: 0x803BD890
// Range: 0x8005AF38 -> 0x8005AFC0
// this: r30
...
// Range: 0x8005B150 -> 0x8005B178
// this: r0
void sphericalEmitter::UpdatePosition(const struct xVec3 & playerPos /* r0 */) const {}
...
// total size: 0x10
struct {} xRumble::emitterBase::__vtable; // size: 0x10, address: 0x803BD8B4
