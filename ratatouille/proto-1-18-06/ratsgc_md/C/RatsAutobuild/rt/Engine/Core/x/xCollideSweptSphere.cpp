/*
    ...
    Language: C++
    Code range: 0x800FA148 -> 0x800FCFE4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSweptSphereGlobals sSwsGlobal; // size: 0x8, address: 0x803C2830
// Range: 0x800FA148 -> 0x800FA1B0
...
// Range: 0x800FBBDC -> 0x800FBC50
int xSweptSphereToBound(struct xSweptSphere * sws /* r0 */, const struct xBound * bound /* r4 */) {}

static int sSweptSphereEntFound; // size: 0x4, address: 0x803C2838
// total size: 0x20
struct xLinkAsset {
    // Members
...
static const struct xEnt * sSweptSphereMover; // size: 0x4, address: 0x803C283C
static unsigned char sSweptSphereCollType; // size: 0x1, address: 0x803C2840
static int sSweptSpherePenby; // size: 0x4, address: 0x803C2844
static unsigned int sSweptSphereIgnoreMovers; // size: 0x4, address: 0x803C2848
static unsigned char sSweptSphereNPCIgnoreGoo; // size: 0x1, address: 0x803C284C
// Range: 0x800FBC50 -> 0x800FBDD0
