/*
    ...
    Language: C++
    Code range: 0x8003C4DC -> 0x8003CA34
*/
// Range: 0x8003C4DC -> 0x8003C4FC
...
// total size: 0x0
struct xSerial {};
// Range: 0x8003C678 -> 0x8003C698
void xGroupSave(struct xGroup * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8003C698 -> 0x8003C6B8
void xGroupLoad(struct xGroup * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8003C6B8 -> 0x8003C6DC
void xGroupReset(struct xGroup * ent /* r0 */) {}
...
// Range: 0x8003C6DC -> 0x8003C928
void xGroupEventCB(struct xBase * from /* r22 */, struct xBase * to /* r4 */, unsigned int toEvent /* r25 */, const float * toParam /* r26 */, struct xBase * toParamWidget /* r27 */, unsigned int toParamWidgetID /* r28 */) {
    // Local variables
    struct xGroup * g; // r31
    int rand; // r30
...
// Range: 0x8003C928 -> 0x8003C934
unsigned int xGroupGetCount(struct xGroup * g /* r0 */) {}

// Range: 0x8003C934 -> 0x8003C98C
struct xBase * xGroupGetItemPtr(struct xGroup * g /* r30 */, unsigned int index /* r31 */) {}

// Range: 0x8003C98C -> 0x8003C9A0
unsigned int xGroupGetItem(struct xGroup * g /* r0 */, unsigned int index /* r0 */) {}

// Range: 0x8003C9A0 -> 0x8003C9E4
unsigned int xGroupGetAny(struct xGroup * g /* r0 */) {
    // Local variables
    unsigned int id; // r5
}

// Range: 0x8003C9E4 -> 0x8003CA34
