/*
    ...
    Language: C++
    Code range: 0x8005E0FC -> 0x8005FF4C
*/
...
// Range: 0x8005E0FC -> 0x8005E258
void xSceneInit(struct xScene * sc /* r26 */, unsigned short numTrigs /* r27 */, unsigned short numSpecialTrigs /* r28 */, unsigned short numStats /* r29 */, unsigned short numDyns /* r30 */, unsigned short numNpcs /* r31 */) {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x8005E258 -> 0x8005E25C
void xSceneExit() {}

// Range: 0x8005E25C -> 0x8005E260
void xSceneSave() {}

// Range: 0x8005E260 -> 0x8005E264
void xSceneLoad() {}

// Range: 0x8005E264 -> 0x8005E288
void xSceneSetup(struct xScene * sc /* r3 */) {}

// Range: 0x8005E288 -> 0x8005E370
void xSceneAddEnt(struct xScene * sc /* r0 */, struct xEnt * ent /* r0 */) {}

// Range: 0x8005E370 -> 0x8005E3AC
struct xBase * xSceneResolvID(struct xScene * sc /* r0 */, unsigned int id /* r4 */) {}

// Range: 0x8005E3AC -> 0x8005E3FC
char * xSceneID2Name(struct xScene * sc /* r0 */, unsigned int id /* r4 */) {}

// Range: 0x8005E3FC -> 0x8005E470
void xSceneForAllEnts(struct xScene * sc /* r28 */, struct xEnt * (* func)(struct xEnt *, struct xScene *, void *) /* r29 */, void * data /* r30 */) {
    // Local variables
...
// Range: 0x8005E470 -> 0x8005ECD4
void xRayHitsGrid(struct xGrid * grid /* r30 */, struct xScene * sc /* r28 */, struct xRay3 * r /* r31 */, void (* rentcb)(struct xScene *, struct xRay3 *, struct xQCData *, struct xEnt *, void *) /* r27 */, struct xQCData * qcr /* r29 */, void * data /* r26 */) {
    // Local variables
    struct xGridIterator it; // r1+0x38
    float len; // f6
    int sclgx; // r1+0x34
    int sclgz; // r1+0x30
    int eclgx; // r1+0x2C
...
// Range: 0x8005ECD4 -> 0x8005ED70
void xRayHitsEnt(struct xRay3 * r /* r29 */, struct xQCData * qcr /* r5 */, struct xEnt * ent /* r30 */, void * colldata /* r31 */) {
    // Local variables
    struct xCollis * coll; // r0
    struct xCollis c; // r1+0x8
}
...
// Range: 0x8005EE94 -> 0x8005EF78
void xRayHitsEntFlags(struct xRay3 * r /* r29 */, struct xCollis * coll /* r30 */, struct xQCData * qcr /* r6 */, struct xEnt * ent /* r31 */, unsigned char collType /* r0 */) {
    // Local variables
    struct xCollis c; // r1+0x8
}
...
// Range: 0x8005EF78 -> 0x8005F0B8
void xRayHitsSceneFlags(struct xScene * sc /* r26 */, const struct xRay3 * r /* r27 */, struct xCollis * coll /* r28 */, unsigned char collType /* r0 */, unsigned char chk /* r29 */) {
    // Local variables
    struct cbRayHitsEnt cb; // r1+0x8
    struct xBound bound; // r1+0x6C
    struct xCollis tempColl; // r1+0x18
...
// Range: 0x8005F0B8 -> 0x8005F0D8
// this: r0
static cbRayHitsEnt::cbRayHitsEnt(const struct xRay3 & ray /* r0 */, struct xCollis & coll /* r0 */, unsigned char chkby /* r0 */, unsigned char collType /* r0 */) {}
...
// Range: 0x8005F0D8 -> 0x8005F19C
static void ProjectTriangle(struct xVec3 * rkD /* r0 */, struct xVec3 * apkTri /* r0 */, float * rfMin /* r0 */, float * rfMax /* r0 */) {
    // Local variables
    float fDot; // f1
}

// Range: 0x8005F19C -> 0x8005F230
static void ProjectBox(struct xVec3 * rkD /* r0 */, struct xBox * rkBox /* r0 */, float * rfMin /* r0 */, float * rfMax /* r0 */) {
    // Local variables
    float fDdC; // f2
    float fR; // f0
}
...
// Range: 0x8005F230 -> 0x8005F518
static unsigned int Mgc_TriBoxTest(struct xVec3 * apkTri /* r24 */, struct xBox * rkBox /* r25 */) {
    // Local variables
    float fMin0; // r1+0x14
    float fMax0; // r1+0x10
    float fMin1; // r1+0xC
    ...
    unsigned int andflag; // r5
    unsigned int curflag; // r0
    int i; // r0
    int i0; // r27
    int i1; // r26
}

static struct xMat4x3 * sBoxTestMat; // size: 0x4, address: 0x803C12F0
static unsigned char sUseJSP; // size: 0x1, address: 0x803C12F4
static void * sTestOPtr; // size: 0x4, address: 0x803C12F8
static struct xModelInstance * sTestMPtr; // size: 0x4, address: 0x803C12FC
// total size: 0x28
...
// Range: 0x8005F518 -> 0x8005F87C
static struct RpCollisionTriangle * nearestFloorCB(struct RpCollisionTriangle * collTriangle /* r30 */, void * data /* r31 */) {
    // Local variables
    struct xNearFloorPoly * nfpoly; // r0
    float currnear; // f31
    struct xVec3 currpt; // r1+0x20
    int currvert; // r28
    int curredge; // r27
    struct xVec3 xformVert[4]; // r1+0x2C
    struct xVec3 xformNorm; // r1+0x14
...
// Range: 0x8005F87C -> 0x8005F94C
static struct RpCollisionTriangle * boxNearestFloorCB(struct RpIntersection * intersection /* r29 */, struct RpCollisionTriangle * collTriangle /* r30 */, float distance /* f31 */, void * data /* r31 */) {
    // Local variables
    struct xNearFloorPoly * nfpoly; // r31
    struct xVec3 xformVert[3]; // r1+0x8

    // References
    // -> static struct xMat4x3 * sBoxTestMat;
}

static struct xBound sNearestBound; // size: 0x4C, address: 0x803259B8
static unsigned char sNearestChk; // size: 0x1, address: 0x803C1300
static unsigned char sNearestCollType; // size: 0x1, address: 0x803C1301
// total size: 0x18
struct RwLine {
    // Members
...
static struct RpIntersection sSphereIsx; // size: 0x1C, address: 0x803C1304
// Range: 0x8005F94C -> 0x8005F974
static struct RpCollisionTriangle * sectorNearestFloorCB(struct RpIntersection * intersection /* r0 */, struct RpCollisionTriangle * collTriangle /* r5 */, float distance /* f0 */, void * data /* r6 */) {}

// Range: 0x8005F974 -> 0x8005FAB8
static int gridNearestFloorCB(struct xEnt * ent /* r30 */, void * cbdata /* r4 */) {
    // Local variables
    struct xNearFloorPoly * nfpoly; // r31
    struct xCollis tempC; // r1+0x8
...
// Range: 0x8005FAB8 -> 0x8005FD4C
unsigned int xSceneNearestFloorPoly(struct xScene * sc /* r30 */, struct xNearFloorPoly * nfpoly /* r31 */, unsigned char collType /* r26 */, unsigned char chk /* r27 */) {
    // Local variables
