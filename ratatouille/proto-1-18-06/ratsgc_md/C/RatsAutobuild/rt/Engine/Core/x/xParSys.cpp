/*
    ...
    Language: C++
    Code range: 0x800550E8 -> 0x80055B98
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sBlendTable[11]; // size: 0x2C, address: 0x803C5258
...
static enum ptank_render_mode_enum ptank_render_mode; // size: 0x4, address: 0x803BD828
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 par_offset_right; // size: 0xC, address: 0x803C1228
static struct xVec3 par_offset_up; // size: 0xC, address: 0x803C1234
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x8005544C -> 0x8005547C
unsigned char using_ptank_render(const struct xParSysAsset & sys /* r0 */) {
    // References
    // -> static enum ptank_render_mode_enum ptank_render_mode;
}

// Range: 0x8005547C -> 0x800554C4
...
static struct xParSysInfo sParSysInfo[7]; // size: 0x38, address: 0x803BD82C
// Range: 0x800554C4 -> 0x80055538
void xParCmdTexInit(struct xParCmdTex * cmd /* r0 */) {}

// Range: 0x80055538 -> 0x80055558
void xParSysInit(void * b /* r0 */, void * tasset /* r0 */) {}

unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x80055558 -> 0x80055734
void xParSysInit(struct xBase * b /* r30 */, struct xParSysAsset * tasset /* r31 */) {
    // Local variables
    struct xParSys * t; // r0
    unsigned int i; // r27
    unsigned char * cmdPtr; // r26
...
// Range: 0x80055734 -> 0x80055794
void xParSysSetup(struct xParSys * t /* r31 */) {}

// Range: 0x80055794 -> 0x80055828
void xParSysReset(struct xParSys * t /* r31 */) {}

// Range: 0x80055828 -> 0x80055858
struct xBase * xParSysExit(struct xBase * b /* r31 */) {}

// Range: 0x80055858 -> 0x80055898
void xParSysExit(struct xParSys * t /* r31 */) {}

// total size: 0x0
struct xSerial {};
// Range: 0x80055898 -> 0x80055974
void xParSysEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
    struct xParSys * t; // r4
}

// Range: 0x80055974 -> 0x80055A48
void xParSysUpdate(struct xBase * to /* r3 */, float dt /* f31 */) {
    // Local variables
...
// Range: 0x80055A48 -> 0x80055B00
static void xParGroupUpdateR(struct xParSys * s /* r27 */, struct xParGroup * g /* r28 */, float dt /* f31 */) {
    // Local variables
    unsigned int i; // r30
