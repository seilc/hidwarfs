/*
    ...
    Language: C++
    Code range: 0x8007A714 -> 0x8007A94C
*/
// total size: 0x8
struct RwLLLink {
    // Members
...
struct RwLinkList asyncDirtyFrameList; // size: 0x8, address: 0x803C1600
unsigned char asyncThreadDone; // size: 0x1, address: 0x803BDAE8
// total size: 0x2C8
struct OSContext {
    // Members
...
struct OSThread asyncThread; // size: 0x318, address: 0x803380F0
static unsigned char ThreadStack[8192]; // size: 0x2000, address: 0x80338408
// total size: 0xC
struct OSSemaphore {
    // Members
...
// Range: 0x8007A7C4 -> 0x8007A7CC
int iAsyncIsDone() {
    // References
    // -> unsigned char asyncThreadDone;
}

// Range: 0x8007A7CC -> 0x8007A808
...
// Range: 0x8007A808 -> 0x8007A830
void iAsyncBeginUpdate() {}

// Range: 0x8007A830 -> 0x8007A85C
void iAsyncEndUpdate() {}

// Range: 0x8007A85C -> 0x8007A8B0
void iAsyncSuspend() {
    // References
    // -> struct OSThread asyncThread;
    // -> unsigned char asyncThreadDone;
