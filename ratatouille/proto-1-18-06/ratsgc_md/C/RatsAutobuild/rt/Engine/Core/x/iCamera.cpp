/*
    ...
    Language: C++
    Code range: 0x80134D20 -> 0x801359B0
*/
float sCameraNearClip; // size: 0x4, address: 0x803BEA30
float sCameraFarClip; // size: 0x4, address: 0x803BEA34
// total size: 0x8
struct RwObject {
    // Members
...
static struct RwCamera * sMainGameCamera; // size: 0x4, address: 0x803C2E74
void * RwEngineInstance; // size: 0x4, address: 0x803C4584
// Range: 0x80134D20 -> 0x80134D8C
...
// Range: 0x80135068 -> 0x80135070
float iCameraGetAspectRatio() {}

// Range: 0x80135070 -> 0x801350DC
...
// Range: 0x80135870 -> 0x8013587C
static float iCameraFogFarClip() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x8013587C -> 0x801358B0
static void iCameraFogOffWrapper() {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x801358B0 -> 0x80135930
