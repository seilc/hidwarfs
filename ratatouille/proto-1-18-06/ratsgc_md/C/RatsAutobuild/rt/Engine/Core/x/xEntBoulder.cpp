/*
    ...
    Language: C++
    Code range: 0x80028F10 -> 0x8002B6C8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
union /* @class$805xEntBoulder_cpp */ {
...
// total size: 0x4
struct /* @class$786xEntBoulder_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804xEntBoulder_cpp */ {
    // Members
...
static struct xEntCollis sBoulderCollis; // size: 0x5FC, address: 0x802F50B8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80028F10 -> 0x80028FDC
void xEntBoulder_FitToModel(struct xEntBoulder * ent /* r31 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x80028FDC -> 0x800290E8
...
// Range: 0x800290E8 -> 0x80029108
void xEntBoulder_Init(void * ent /* r0 */, void * asset /* r0 */) {}

// Range: 0x80029108 -> 0x80029144
...
// Range: 0x800292E4 -> 0x80029408
void xEntBoulder_ApplyForces(struct zPlayer * player /* r26 */, struct xEntCollis * collis /* r27 */) {
    // Local variables
    int i; // r29
...
// total size: 0x4
struct /* @class$1230xEntBoulder_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1197xEntBoulder_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198xEntBoulder_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1199xEntBoulder_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1196xEntBoulder_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1201xEntBoulder_cpp */ {
    // Members
...
// Range: 0x800294C8 -> 0x8002A244
void xEntBoulder_Update(struct xEntBoulder * ent /* r26 */, struct xScene * sc /* r27 */, float dt /* f30 */) {
    // Local variables
    int i; // r28
    struct xVec3 rotatedLC; // r1+0x9C
    struct xVec3 oldPos; // r1+0x90
    struct xVec3 sweptDisp; // r1+0x84
    unsigned char definitelyBounce; // r30
...
// Range: 0x8002A398 -> 0x8002A3F4
void xEntBoulder_Kill(struct xEntBoulder * ent /* r31 */) {}

// Range: 0x8002A3F4 -> 0x8002A454
void xEntBoulder_Setup(struct xEntBoulder * ent /* r3 */) {}

// Range: 0x8002A454 -> 0x8002A554
...
// Range: 0x8002A554 -> 0x8002A820
void xEntBoulderEventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r7 */) {
    // Local variables
    struct xEntBoulder * s; // r31
    union FloatAndVoid dist; // r1+0x8
    struct zShrapnelAsset * shrap; // r7

    // References
    // -> struct zGlobals globals;
}

// Range: 0x8002A820 -> 0x8002A8A0
static int RecurseLinks(const struct xLinkAsset * link /* r27 */, int count /* r28 */, struct xEntBoulder * * boulList /* r29 */) {
    // Local variables
    int i; // r30
    int numInList; // r1+0x8
    const struct xLinkAsset * currLink; // r3
    struct xBase * mychild; // r0
}

// Range: 0x8002A8A0 -> 0x8002A984
static void RecurseChild(struct xBase * child /* r3 */, struct xEntBoulder * * boulList /* r27 */, int & currBoul /* r28 */) {
    // Local variables
    unsigned int i; // r30
    unsigned int cnt; // r0
    struct xGroup * grp; // r29
    struct xBase * grpitem; // r0
}

// Range: 0x8002A984 -> 0x8002A9A4
void xBoulderGenerator_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x8002AFB0 -> 0x8002B29C
void xBoulderGenerator_EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r29 */, struct xBase * toParamWidget /* r30 */) {
    // Local variables
