/*
    ...
    Language: C++
    Code range: 0x8007A94C -> 0x8007B26C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
void iCSSoundSetup(struct xCutscene * csn /* r29 */) {
    ...
    unsigned int uRegion; // r0
}

// Range: 0x8007AAF8 -> 0x8007AC68
void * iCSSoundGetData(unsigned int assetID /* r29 */, unsigned int * len /* r31 */) {
    // Local variables
    struct xCutscene * csn; // r0
    void * retdata; // r4
...
// Range: 0x8007ACC4 -> 0x8007AD70
unsigned int iCSFileOpen(struct xCutscene * csn /* r30 */) {
    // Local variables
    unsigned int headerskip; // r31
    struct PKRAssetTOCInfo ainfo; // r1+0x8
    const char * filename; // r0
    int uOffsetBytes; // r4
}

unsigned int read_sizzze; // size: 0x4, address: 0x803C1618
// Range: 0x8007AD70 -> 0x8007ADAC
void iCSFileAsyncRead(struct xCutscene * csn /* r3 */, void * dest /* r0 */, unsigned int size /* r0 */) {
    // References
    // -> unsigned int read_sizzze;
}

// Range: 0x8007ADAC -> 0x8007ADDC
void iCSFileAsyncSkip(struct xCutscene * csn /* r3 */, unsigned int size /* r0 */) {}

// Range: 0x8007ADDC -> 0x8007AE10
...
// Range: 0x8007AE10 -> 0x8007B26C
int iCSLoadStep(struct xCutscene * csn /* r30 */) {
    // Local variables
    unsigned int skipAccum; // r31
    unsigned int tmpSize; // r1+0x8
    void * foundModel; // r0
    struct xSndGroup * pLeftGroup; // r0
    enum iSndGroupHandle leftSoundGroup; // r31
    struct xSndGroup * pRightGroup; // r0
    enum iSndGroupHandle rightSoundGroup; // r29
    struct xSndGroup * pLeftGroup; // r0
