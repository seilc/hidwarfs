/*
    ...
    Language: C++
    Code range: 0x8006DC0C -> 0x8006E1C0
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8006DC0C -> 0x8006DC4C
static unsigned char xSoundFXWillSendDone(struct xSoundFX * pSoundFX /* r0 */) {
    // Local variables
    const struct xLinkAsset * idx; // r3
    int i; // r0
}

// Range: 0x8006DC4C -> 0x8006DC6C
void xSoundFXInit(void * t /* r0 */, void * asset /* r0 */) {}

// Range: 0x8006DC6C -> 0x8006DD3C
...
// Range: 0x8006DD3C -> 0x8006DD60
void xSoundFXReset(struct xSoundFX * ent /* r0 */) {}

// Range: 0x8006DD60 -> 0x8006DF5C
void xSoundFXEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r30 */) {
    // Local variables
    struct xSoundFX * t; // r31
    float destVolume; // f2
    float startVolume; // f2
    float destVolume; // f3
}

// Range: 0x8006DF5C -> 0x8006E000
...
// total size: 0x1
struct /* @class$754xSoundFX_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756xSoundFX_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757xSoundFX_cpp */ {
    // Members
