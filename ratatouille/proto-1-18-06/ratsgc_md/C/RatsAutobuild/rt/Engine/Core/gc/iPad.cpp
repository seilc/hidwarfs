/*
    ...
    Language: C++
    Code range: 0x80083994 -> 0x80084298
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float g_rumblingThreshold; // size: 0x4, address: 0x803C1738
// total size: 0xC
struct PADStatus {
    // Members
...
static struct PADStatus sPadData[4]; // size: 0x30, address: 0x803BDB28
static unsigned long sPadMotor[4]; // size: 0x10, address: 0x803C173C
static int sPadCurrLevel[4]; // size: 0x10, address: 0x803C174C
static int sPadDeltaLevel[4]; // size: 0x10, address: 0x803C175C
// Range: 0x80083994 -> 0x800839F0
int iPadInit() {
    // Local variables
    int i; // r0
...
// Range: 0x800839F0 -> 0x80083A5C
struct _tagxPad * iPadEnable(struct _tagxPad * pad /* r31 */, signed short port /* r0 */) {
    // Local variables
    unsigned int new_on; // r1+0x8
}

// Range: 0x80083A5C -> 0x80083AC4
static signed char iPadConvStick(float in /* f1 */) {
    // Local variables
    float fin; // f1
}

// Range: 0x80083AC4 -> 0x80083AC8
void iPadWaitForRevolution() {}

// Range: 0x80083AC8 -> 0x80083AF4
void iPadUpdateDataAll() {
    // References
    // -> static struct PADStatus sPadData[4];
}

static long long held_start[4]; // size: 0x20, address: 0x803BDB58
static unsigned char held_through_reset[4]; // size: 0x4, address: 0x803BDB78
// Range: 0x80083AF4 -> 0x80083BB8
void iPadInHandReset(int port /* r30 */, unsigned int * on /* r0 */) {
    // Local variables
    unsigned char held; // r31
...
// Range: 0x80083BB8 -> 0x80084008
int iPadUpdate(struct _tagxPad * pad /* r29 */, unsigned int * on /* r30 */) {
    // Local variables
    unsigned int read_on; // r31
...
// Range: 0x80084078 -> 0x80084100
void iPadStopRumble() {
    // Local variables
    int j; // r25
    struct _tagxPad * pad; // r3
