/*
    ...
    Language: C++
    Code range: 0x8004F858 -> 0x8004FF24
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8004F95C -> 0x8004F998
void xPadClear() {
    // Local variables
    int i; // r31
}

// Range: 0x8004F998 -> 0x8004F9B8
...
// Range: 0x8004FCB4 -> 0x8004FD04
void xPadUpdateAllPads(float time_passed /* f31 */) {
    // Local variables
    int j; // r31
}

// Range: 0x8004FD04 -> 0x8004FE84
void xPadNormalizeAnalog(struct _tagxPad & pad /* r20 */, int inner_zone /* r21 */, int outer_zone /* r22 */) {
    // Local variables
    const struct _tagPadAnalog * src; // r24
    int i; // r23
}
...
// Range: 0x8004FE84 -> 0x8004FEA4
void xPadKill() {}

// Range: 0x8004FEA4 -> 0x8004FF24
