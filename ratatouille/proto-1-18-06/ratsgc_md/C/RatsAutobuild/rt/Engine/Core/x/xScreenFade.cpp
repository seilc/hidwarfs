/*
    ...
    Language: C++
    Code range: 0x800FD0C4 -> 0x800FD648
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cnt_fadesInProgress; // size: 0x4, address: 0x803C2850
// total size: 0x4
struct RwRGBA {
    // Members
