/*
    ...
    Language: C++
    Code range: 0x80122DCC -> 0x801247EC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char sModelBlurEnabled; // size: 0x1, address: 0x803BE928
// Range: 0x80122DCC -> 0x80122DD0
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x803805C0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
struct activity_data * activity_buffer; // size: 0x4, address: 0x803C2C70
struct activity_data * activities[6]; // size: 0x18, address: 0x803C2C74
int activities_used; // size: 0x4, address: 0x803C2C8C
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
// Range: 0x80123070 -> 0x80123098
void xModelBlur::scene_exit() {
    // References
    // -> static class xFXCameraTexture camtex;
}

// Range: 0x80123098 -> 0x80123120
...
// Range: 0x8012321C -> 0x80123228
// this: r0
void xModelBlur::create() {}

// Range: 0x80123228 -> 0x80123308
// this: r29
...
// Range: 0x80123308 -> 0x80123324
// this: r0
static void interpolator::reset(float value /* f0 */) {}

// Range: 0x80123324 -> 0x80123370
// this: r31
void xModelBlur::deactivate() {}

// Range: 0x80123370 -> 0x801234A0
// this: r30
...
// Range: 0x80123914 -> 0x80123978
// this: r0
static void interpolator::update(float dt /* f0 */) {}

// Range: 0x80123978 -> 0x80123994
...
static unsigned int * FBSaveMem; // size: 0x4, address: 0x803C2C90
static unsigned int * textureMem; // size: 0x4, address: 0x803C2C94
// total size: 0x18
