/*
    ...
    Language: C++
    Code range: 0x800EEF94 -> 0x800F038C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct internal_system systems[128]; // size: 0x2000, address: 0x803763C0
static struct system_bucket buckets[6][128]; // size: 0x3C00, address: 0x803783C0
static struct block_info * head_free_block; // size: 0x4, address: 0x803C2758
static int free_block_count; // size: 0x4, address: 0x803C275C
static unsigned char * block_buffer; // size: 0x4, address: 0x803C2760
static struct block_info block_info_buffer[32]; // size: 0x180, address: 0x8037BFC0
static int systems_size; // size: 0x4, address: 0x803C2764
static int buckets_size[6]; // size: 0x18, address: 0x803C2768
// Range: 0x800EEF98 -> 0x800EEFB4
...
// Range: 0x800EF4C4 -> 0x800EF4C8
static void adjust_batch_size() {}

// Range: 0x800EF4C8 -> 0x800EF4CC
void xParticleBatchSceneExit() {}

// Range: 0x800EF4CC -> 0x800EF550
...
// Range: 0x800EF6C8 -> 0x800EF6CC
static void validate_system() {}

// Range: 0x800EF6CC -> 0x800EF750
