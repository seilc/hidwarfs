/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xCollideFast.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8001B65C -> 0x8001B79C
*/
// total size: 0x10
struct xSphere {
    // Members
...
// Range: 0x8001B73C -> 0x8001B79C
unsigned int xRayHitsBoxFast(const struct xRay3 * r /* r0 */, const struct xBox * b /* r4 */) {
    // Local variables
