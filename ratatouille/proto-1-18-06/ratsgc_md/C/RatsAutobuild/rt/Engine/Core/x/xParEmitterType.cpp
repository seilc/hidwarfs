/*
    ...
    Language: C++
    Code range: 0x80052E28 -> 0x800547C8
*/
// total size: 0x8
struct xBaseAsset {
    // Members
...
// Range: 0x80052F90 -> 0x800530E4
void xParEmitterEmitCircleEdge(struct xPar * p /* r29 */, struct xParEmitterAsset * a /* r30 */) {
    // Local variables
...
// Range: 0x800537E0 -> 0x80053898
void xParEmitterEmitVolume(struct xPar * p /* r29 */, struct xParEmitterAsset * a /* r30 */, class xVolume * vol /* r31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$786xParEmitterType_cpp */ {
    // Members
...
union /* @class$805xParEmitterType_cpp */ {
...
// total size: 0xC
struct /* @class$804xParEmitterType_cpp */ {
    // Members
...
// Range: 0x80053898 -> 0x80053984
void xParEmitterEmitEntity(struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, struct xEnt * ent /* r28 */) {
    // Local variables
...
// Range: 0x80053984 -> 0x80053A04
void xParEmitterEmitOffsetPoint(struct xParEmitter * pe /* r7 */, struct xPar * p /* r30 */, struct xParEmitterAsset * a /* r31 */, struct xEnt * ent /* r0 */) {}

// Range: 0x80053A04 -> 0x80053AE8
...
// Range: 0x80053AE8 -> 0x80053B0C
void xParEmitterEmitOCircleEdge(struct xPar * p /* r0 */, struct xParEmitterAsset * a /* r0 */, float dt /* f0 */) {}

// Range: 0x80053B0C -> 0x80053C2C
...
static struct xMat4x3 buffer_mat; // size: 0x40, address: 0x803C11D0
// Range: 0x80053C90 -> 0x80053D08
struct xMat4x3 * xParEmitterTransformEntBone(struct xVec3 & loc /* r28 */, struct xVec3 & vel /* r29 */, const struct xParEmitterAsset & a /* r30 */, const struct xEnt & ent /* r0 */) {
    // Local variables
