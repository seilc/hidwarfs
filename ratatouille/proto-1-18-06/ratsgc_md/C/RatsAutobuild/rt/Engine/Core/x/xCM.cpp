/*
    ...
    Language: C++
    Code range: 0x80013E88 -> 0x80014E9C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct basic_rect screen_bounds; // size: 0x10, address: 0x803C4798
static const char * KEY; // size: 0x4, address: 0x803BD570
// Range: 0x80013E88 -> 0x80013ED0
static void Decrypt(void * buffer_ /* r3 */, unsigned int size /* r4 */, void * key_ /* r0 */, unsigned int keySize /* r0 */) {
    ...
    unsigned char last; // r9
    unsigned int keyCurrent; // r7
}
...
static float destX; // size: 0x4, address: 0x803C0C98
static float destY; // size: 0x4, address: 0x803C0C9C
static float destWidth; // size: 0x4, address: 0x803BD574
static float destHeight; // size: 0x4, address: 0x803BD578
// Range: 0x80014040 -> 0x8001408C
...
// Range: 0x800141A0 -> 0x80014BCC
static unsigned int xCMrender(float time /* f28 */, struct xCreditsData * data /* r26 */) {
    // Local variables
    struct xCMheader * hdr; // r0
    char * dp; // r30
    struct xCMcredits * cp; // r0
...
float dtscale; // size: 0x4, address: 0x803BD57C
static float credits_time; // size: 0x4, address: 0x803BD580
static struct xCreditsData * credits_data; // size: 0x4, address: 0x803C0CA0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
static unsigned int credits_parentID; // size: 0x4, address: 0x803C0CA4
// Range: 0x80014D78 -> 0x80014DF4
