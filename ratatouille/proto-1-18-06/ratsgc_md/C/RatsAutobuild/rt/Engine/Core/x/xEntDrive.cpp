/*
    ...
    Language: C++
    Code range: 0x8002B82C -> 0x8002C594
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8002B82C -> 0x8002B860
void xEntDriveInit(struct xEntDrive * drv /* r0 */, struct xEnt * driven /* r0 */) {}
...
// Range: 0x8002BC8C -> 0x8002BD40
void xEntDriveDismount(struct xEntDrive * drv /* r31 */, float dmt /* f0 */) {
    // Local variables
...
// Range: 0x8002BD40 -> 0x8002C448
void xEntDriveUpdate(struct xEntDrive * drv /* r30 */, float dt /* f0 */) {
    // Local variables
...
// Range: 0x8002C448 -> 0x8002C4A0
void xEntDriveSimpleInit(struct xEntDriveSimple * drv /* r31 */, struct xMat4x3 * mat /* r0 */) {}

// Range: 0x8002C4A0 -> 0x8002C4F4
void xEntDriveSimpleMount(struct xEntDriveSimple * drv /* r31 */, struct xEnt * driver /* r0 */) {}

// Range: 0x8002C4F4 -> 0x8002C544
void xEntDriveSimpleUpdate(struct xEntDriveSimple * drv /* r31 */) {
    // Local variables
    struct xVec3 newq; // r1+0x8
}

// Range: 0x8002C544 -> 0x8002C594
