/*
    ...
    Language: C++
    Code range: 0x8008AA4C -> 0x8008B870
*/
...
struct RwVideoMode sVideoMode; // size: 0x18, address: 0x803C17F8
// total size: 0x10
...
void (* old_dsc)(unsigned short); // size: 0x4, address: 0x803C1810
// Range: 0x8008AB20 -> 0x8008AB24
void my_dsc() {}

static void * xfb1; // size: 0x4, address: 0x803C1814
static void * xfb2; // size: 0x4, address: 0x803C1818
...
// Range: 0x8008AB24 -> 0x8008AB28
void iExceptionMemCrash() {}

// Range: 0x8008AB28 -> 0x8008ABB4
static void TRCInit() {}

// Range: 0x8008ABB4 -> 0x8008ABE4
void iSystemGetWidthHeight(unsigned int & uWidth /* r0 */, unsigned int & uHeight /* r0 */, unsigned char bPALMode /* r0 */) {}

// Range: 0x8008ABE4 -> 0x8008AC40
void iSystemInit() {}

// Range: 0x8008AC40 -> 0x8008AC7C
void iSystemInitGraphics() {
    // References
    // -> void (* old_dsc)(unsigned short);
}

// Range: 0x8008AC7C -> 0x8008ACD4
void iSystemExit() {}

// Range: 0x8008ACD4 -> 0x8008AD74
static unsigned int RWAttachPlugins() {}

// Range: 0x8008AD74 -> 0x8008ADE4
...
struct RwGameCubeDeviceConfig deviceConfig; // size: 0xC, address: 0x803C181C
enum VITVMode {
...
struct _GXRenderModeObj myGXNtsc480IntDf; // size: 0x3C, address: 0x803BDBC0
struct _GXRenderModeObj myGXPal528IntDf; // size: 0x3C, address: 0x803BDBFC
...
// Range: 0x8008B0AC -> 0x8008B0B0
void null_func() {}

int the_heap; // size: 0x4, address: 0x803C16A8
int the_heap; // size: 0x4, address: 0x803C16A8
// Range: 0x8008B0B0 -> 0x8008B0FC
...
// Range: 0x8008B128 -> 0x8008B154
long iGetMinute() {
    // Local variables
    struct OSCalendarTime td; // r1+0x8
}

// Range: 0x8008B154 -> 0x8008B180
long iGetHour() {
    // Local variables
    struct OSCalendarTime td; // r1+0x8
}

// Range: 0x8008B180 -> 0x8008B1AC
long iGetDay() {
    // Local variables
    struct OSCalendarTime td; // r1+0x8
}

// Range: 0x8008B1AC -> 0x8008B1DC
long iGetMonth() {
    // Local variables
    struct OSCalendarTime td; // r1+0x8
}

char * months[12]; // size: 0x30, address: 0x803BDC38
char * dotw[7]; // size: 0x1C, address: 0x803BDC68
// Range: 0x8008B1DC -> 0x8008B314
...
// Range: 0x8008B314 -> 0x8008B47C
unsigned long iGetCurrFormattedTime(char * p /* r30 */) {
    // Local variables
    struct OSCalendarTime td; // r1+0x8
    char * tp; // r31
    int am; // r29
...
static struct AramAllocNode AramMgr[32]; // size: 0x180, address: 0x80350480
// Range: 0x8008B47C -> 0x8008B594
void * iSystemARAMAlloc(unsigned int numbytes_to_use /* r0 */) {
    // Local variables
    unsigned int uNumBytes; // r0
    unsigned int blockIndex; // r30
    unsigned int segIndex; // r29
    unsigned int pOldEndAddress; // r4

    // References
    // -> static struct AramAllocNode AramMgr[32];
}

// Range: 0x8008B594 -> 0x8008B5DC
void iSystemARAMFree(void * ptr /* r0 */) {
    // Local variables
    unsigned int blockIndex; // r0

    // References
    // -> static struct AramAllocNode AramMgr[32];
}

static unsigned int pARAMBaseAddressBink; // size: 0x4, address: 0x803C1864
static unsigned int ARAMBytesForBink; // size: 0x4, address: 0x803C1868
static unsigned int pARAMBaseAddressFMOD; // size: 0x4, address: 0x803C186C
static unsigned int ARAMBytesForFMOD; // size: 0x4, address: 0x803C1870
// Range: 0x8008B5DC -> 0x8008B67C
...
// Range: 0x8008B67C -> 0x8008B684
unsigned int iSystemARAMBasePtrForFMOD() {
    // References
    // -> static unsigned int pARAMBaseAddressFMOD;
}

// Range: 0x8008B684 -> 0x8008B68C
