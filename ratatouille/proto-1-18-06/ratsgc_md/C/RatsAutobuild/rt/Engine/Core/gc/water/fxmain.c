/*
    ...
    Language: C++
    Code range: 0x801260CC -> 0x80126340
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct FxParam * (* EffectOpenFunctions[1])(); // size: 0x4, address: 0x803BE960
static char * EffectNames[1]; // size: 0x4, address: 0x803C2D18
static struct FxParam * Effects[1]; // size: 0x4, address: 0x803C2D1C
static int EffectIndex; // size: 0x4, address: 0x803C2D20
// total size: 0x0
