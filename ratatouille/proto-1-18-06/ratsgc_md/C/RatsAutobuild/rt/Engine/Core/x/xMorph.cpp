/*
    ...
    Language: C++
    Code range: 0x8004E0BC -> 0x8004E4A4
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x8004E0BC -> 0x8004E2A8
struct xMorphSeqFile * xMorphSeqSetup(void * data /* r3 */, void * (* FindAssetCB)(unsigned int, char *) /* r28 */) {
    // Local variables
    int i; // r26
    int j; // r10
    struct RpAtomic * model; // r7
    struct xMorphTargetFile * mphtgt; // r11
    struct xMorphSeqFile * header; // r31
    struct xMorphFrame * framelist; // r30
    unsigned int * assetlist; // r29
    char * namelist; // r25
    void * assetPtr; // r0
