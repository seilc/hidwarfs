/*
    ...
    Language: C++
    Code range: 0x800723B4 -> 0x80073400
*/
static int g_straninit; // size: 0x4, address: 0x803C14E8
// total size: 0x28
struct PKRAssetType {
    // Members
...
static struct st_STRAN_DATA g_xstdata; // size: 0x2284, address: 0x802D1148
enum en_LAYER_TYPE {
    PKR_LTYPE_ALL = -1,
    PKR_LTYPE_DEFAULT = 0,
    PKR_LTYPE_TEXTURE = 1,
...
static struct PKRReadFuncs * g_pkrf; // size: 0x4, address: 0x803C14EC
static struct PKRAssetType * g_typeHandlers; // size: 0x4, address: 0x803C14F0
static char g_localCode[4]; // size: 0x4, address: 0x803BDA88
enum xRegion {
    eRegionUnknown = -1,
    eRegionUS = 0,
    eRegionBE = 1,
...
static enum xRegion g_localEnum; // size: 0x4, address: 0x803BDA8C
static unsigned int g_localDiscLanguageConfig; // size: 0x4, address: 0x803C14F4
// Range: 0x800723B4 -> 0x800723C4
unsigned char xSTIsLoaded() {
    // References
    // -> static int g_straninit;
}

// Range: 0x800723C4 -> 0x80072410
int xSTStartup(struct PKRAssetType * handlers /* r0 */) {
    // References
    // -> static int g_straninit;
...
// Range: 0x80072450 -> 0x800726B8
int xSTPreLoadScene(unsigned int sid /* r28 */, void * userdata /* r24 */, int flg_hiphop /* r25 */, int fileflags /* r29 */, const char * filename /* r7 */) {
    // Local variables
    int result; // r3
    struct st_STRAN_SCENE * sdata; // r27
    const char * sfile; // r26
    int cltver; // r30
}

// Range: 0x800726B8 -> 0x80072718
...
// Range: 0x800728A8 -> 0x80072978
int xSTSwitchScene(unsigned int sid /* r24 */, void * userdata /* r25 */, int (* progmon)(void *, float) /* r26 */) {
    // Local variables
    struct st_STRAN_SCENE * sdata; // r0
    int rc; // r28
    int i; // r27
...
// Range: 0x80072978 -> 0x800729F4
char * xSTAssetName(unsigned int aid /* r28 */) {
    // Local variables
    const char * aname; // r30
    int scncnt; // r0
    int i; // r29
    struct st_STRAN_SCENE * sdata; // r0
...
// Range: 0x80072A40 -> 0x80072AB0
enum en_pkrfindmyass xSTRandMemToAsset(struct PKRAssetTOCInfo * ainfo /* r28 */, void * addr /* r29 */) {
    // Local variables
    int scncnt; // r0
    int i; // r30
    struct st_STRAN_SCENE * sdata; // r0
...
// Range: 0x80072AB0 -> 0x80072B6C
void * xSTFindAsset(unsigned int aid /* r26 */, unsigned int * size /* r27 */) {
    // Local variables
    void * memloc; // r29
    int scncnt; // r0
    int i; // r28
...
// Range: 0x80072B6C -> 0x80072BDC
int xSTAssetCountByType(unsigned int type /* r28 */) {
    // Local variables
    int sum; // r30
    int cnt; // r0
    struct st_STRAN_SCENE * sdata; // r0
...
// Range: 0x80072DE4 -> 0x80072E08
char * xST_xAssetID_HIPFullPath(unsigned int aid /* r0 */) {}

// Range: 0x80072E08 -> 0x80072E9C
...
// Range: 0x80072E9C -> 0x80072F0C
static int XST_PreLoadScene(struct st_STRAN_SCENE * sdata /* r31 */, const char * sfile /* r0 */, int fileflags /* r5 */) {
    // Local variables
    int cltver; // r1+0x8
...
static char fname[64]; // size: 0x40, address: 0x803C14F8
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
static char fname[64]; // size: 0x40, address: 0x803C1538
// Range: 0x80072FC0 -> 0x800730C4
...
// Range: 0x80073194 -> 0x800731EC
static void XST_unlock(struct st_STRAN_SCENE * sdata /* r0 */) {
    // References
    // -> static struct st_STRAN_DATA g_xstdata;
}

// Range: 0x800731EC -> 0x80073254
...
// Range: 0x80073304 -> 0x80073374
static struct st_STRAN_SCENE * XST_find_bySID(unsigned int sid /* r0 */, int flagHipHop /* r0 */) {
    // Local variables
    struct st_STRAN_SCENE * da_sdata; // r9
    int i; // r10
    struct st_STRAN_SCENE * tmp_sdata; // r11

    // References
    // -> static struct st_STRAN_DATA g_xstdata;
}

// Range: 0x80073374 -> 0x800733C0
