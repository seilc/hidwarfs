/*
    ...
    Language: C++
    Code range: 0x8012B59C -> 0x8012B724
*/
// total size: 0x10
struct _xFColor {
    // Members
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x80380860
// total size: 0x18
struct xBox {
    // Members
...
static struct render_context render_contexts[8]; // size: 0x400, address: 0x803808B0
static int render_contexts_size; // size: 0x4, address: 0x803C2DE8
// total size: 0xC
struct xVec3 {
    // Static members
