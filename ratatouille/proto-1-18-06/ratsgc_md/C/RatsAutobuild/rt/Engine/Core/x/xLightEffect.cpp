/*
    ...
    Language: C++
    Code range: 0x8013BBE0 -> 0x8013C060
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$805xLightEffect_cpp */ {
    // Members
...
class xLightEffectFlicker : private xLightEffectBase {
    ...
    // Members
    struct xLightEffectFlickerAsset * tasset; // offset 0x14, size 0x4
};
// Range: 0x8013BBE0 -> 0x8013BC34
void xLightEffectFlicker::Init(struct xBase & data /* r31 */, struct xDynAsset & asset /* r30 */) {
    // Local variables
    class xLightEffectFlicker * flickerEffect; // r31
}

// Range: 0x8013BC78 -> 0x8013BCC4
void xLightEffectFlicker::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r0 */) {}

// Range: 0x8013BCC4 -> 0x8013BD00
...
class xLightEffectStrobe : private xLightEffectBase {
    ...
    // Members
    struct xLightEffectStrobeAsset * tasset; // offset 0x14, size 0x4
};
// Range: 0x8013BE50 -> 0x8013BEB0
void xLightEffectStrobe::Init(struct xBase & data /* r31 */, struct xDynAsset & asset /* r30 */) {
    // Local variables
    class xLightEffectStrobe * strobeEffect; // r31
}

// Range: 0x8013BEE8 -> 0x8013BF3C
void xLightEffectStrobe::StartEffect(struct xLight & light /* r31 */, unsigned char resetEffect /* r0 */) {}

// Range: 0x8013BF3C -> 0x8013BF78
void xLightEffectStrobe::StopEffect(struct xLight & light /* r4 */, unsigned char resetColor /* r0 */) {}

// Range: 0x8013BF78 -> 0x8013C060
// this: r28
...
// total size: 0x14
struct {} xLightEffectStrobe::__vtable; // size: 0x14, address: 0x803BEA80
// total size: 0x14
struct {} xLightEffectFlicker::__vtable; // size: 0x14, address: 0x803BEA94
// total size: 0x14
struct {} xLightEffectBase::__vtable; // size: 0x14, address: 0x803BEAA8
