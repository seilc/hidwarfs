/*
    ...
    Language: C++
    Code range: 0x800407E0 -> 0x800409B0
*/
enum xJawFlags {
    exJawFlags_None = 0,
    exJawFlags_Remy = 1,
...
class xJawData * xJawData::Find(unsigned int soundID /* r28 */) {
    ...
    unsigned int j; // r0
    void * data; // r0
    unsigned int jawcount; // r4
    struct xJawDataTable * tbl; // r5
    void * rawdata; // r6
}
