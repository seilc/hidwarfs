/*
    ...
    Language: C++
    Code range: 0x8008BA1C -> 0x8008CE70
*/
unsigned char mFirstFrame; // size: 0x1, address: 0x803BDC88
// total size: 0x30
struct OSFontHeader {
    // Members
...
struct OSFontHeader * mFontData; // size: 0x4, address: 0x803C1888
void * mFontDataUnaligned; // size: 0x4, address: 0x803C188C
void * mXFBs[2]; // size: 0x8, address: 0x803C1890
void * mCurrentFrameBuffer; // size: 0x4, address: 0x803C1898
enum VITVMode {
...
struct _GXRenderModeObj * mRenderMode; // size: 0x4, address: 0x803C189C
unsigned char mFontMalloced; // size: 0x1, address: 0x803C18A0
float mRomFontScale; // size: 0x4, address: 0x803BDC8C
static char textureBuffer[288]; // size: 0x120, address: 0x80350600
char * diskNotIdentifiedMessage[21]; // size: 0x54, address: 0x802D3F70
char * diskCoverOpenMessage[21]; // size: 0x54, address: 0x802D3FC4
char * diskNoDiskMessage[21]; // size: 0x54, address: 0x802D4018
char * diskWrongDiskMessage[21]; // size: 0x54, address: 0x802D406C
char * diskRetryMessage[21]; // size: 0x54, address: 0x802D40C0
char * diskFatalMessage[21]; // size: 0x54, address: 0x802D4114
enum xRegion {
    eRegionUnknown = -1,
    eRegionUS = 0,
    eRegionBE = 1,
...
// Range: 0x8008BE30 -> 0x8008BE50
void ROMFont::DestroyDisplay() {}

// Range: 0x8008BE50 -> 0x8008BF74
void ROMFont::InitGX() {
    // Local variables
...
// Range: 0x8008BFC0 -> 0x8008C08C
void ROMFont::RenderBegin() {
    // References
    // -> struct _GXRenderModeObj * mRenderMode;
}

// Range: 0x8008C08C -> 0x8008C0D4
void ROMFont::RenderEnd() {
    // References
    // -> void * mCurrentFrameBuffer;
}

// Range: 0x8008C0D4 -> 0x8008C144
...
int mWasResetButtonPressed; // size: 0x4, address: 0x803C18A4
unsigned char mResetEnabled; // size: 0x1, address: 0x803BDC90
unsigned char mDiscIded; // size: 0x1, address: 0x803C18A8
void (* mSndKill)(); // size: 0x4, address: 0x803C18AC
void (* mMovieKillFunction)(); // size: 0x4, address: 0x803C18B0
// total size: 0x1
class ResetButton {
    // Static members
...
char mMessage[256]; // size: 0x100, address: 0x80350720
void (* mSndSuspend)(); // size: 0x4, address: 0x803C18B4
void (* mSndResume)(); // size: 0x4, address: 0x803C18B8
void (* mAsyncLoadSuspend)(); // size: 0x4, address: 0x803C18BC
void (* mAsyncLoadResume)(); // size: 0x4, address: 0x803C18C0
void (* mPadStopRumbling)(); // size: 0x4, address: 0x803C18C4
void (* mMovieSuspendFunction)(); // size: 0x4, address: 0x803C18C8
void (* mMovieResumeFunction)(); // size: 0x4, address: 0x803C18CC
void (* mMovieResetCallBack)(); // size: 0x4, address: 0x803C18D0
int gWasDiskError; // size: 0x4, address: 0x803C18D4
unsigned char mInCriticalSection; // size: 0x1, address: 0x803C18D8
unsigned char mFModError; // size: 0x1, address: 0x803C18D9
unsigned char mInFModLockingCode; // size: 0x1, address: 0x803C18DA
// total size: 0x2C8
struct OSContext {
    // Members
...
struct OSThread * mMainThread; // size: 0x4, address: 0x803C18DC
long mMainPriority; // size: 0x4, address: 0x803C18E0
struct OSThread * mFModThread; // size: 0x4, address: 0x803C18E4
long mFModPriority; // size: 0x4, address: 0x803C18E8
unsigned char mDiskErrorInHigherPriorityThread; // size: 0x1, address: 0x803C18EC
// total size: 0x1
class iTRCDisk {
    // Static members
...
// Range: 0x8008CBD8 -> 0x8008CD70
unsigned char iTRCDisk::TRCCheck() {
    // Local variables
    int dvdDriveStatus; // r0
