/*
    ...
    Language: C++
    Code range: 0x800830F0 -> 0x80083994
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct RpGeometry * s_geom; // size: 0x4, address: 0x803C1720
static struct RpMorphTarget * s_tgt; // size: 0x4, address: 0x803C1724
static float * s_alloc; // size: 0x4, address: 0x803C1728
static float * s_vTemp; // size: 0x4, address: 0x803C172C
static float * s_nTemp; // size: 0x4, address: 0x803C1730
static int s_numV; // size: 0x4, address: 0x803C1734
// total size: 0x14
...
// Range: 0x800830F0 -> 0x80083698
static void MorphCommon(struct RpAtomic * model /* r29 */, struct RwMatrixTag * mat /* r30 */, signed short * * v_array /* r20 */, signed short * weight /* r0 */, unsigned int normals /* r24 */, float scale /* f31 */, int dorender /* r31 */) {
    // Local variables
    unsigned int i; // r0
    unsigned int a; // r28
    ...
    int wsum; // r27
    struct RwV3d * vold; // r21
    struct RwV3d * nold; // r26
    int lockMode; // r22
    void * temp_scratch; // r25
    struct RpUserDataArray * usr; // r0
    struct DirtyMorph * dm; // r3
...
// Range: 0x80083698 -> 0x80083724
void iMorphOptimize(struct RpAtomic * model /* r0 */, int normals /* r30 */) {
    // Local variables
...
// Range: 0x80083760 -> 0x800837B4
void FastS16unpack(float * dest /* r0 */, signed short * v /* r0 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r0
}

// Range: 0x800837B4 -> 0x80083864
void FastS16weight2(float * dest /* r0 */, signed short * * v_array /* r0 */, signed short * weight /* r0 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r0
    signed short * v0; // r9
    signed short * v1; // r10
...
// Range: 0x80083864 -> 0x80083994
void FastS16weight4(float * dest /* r0 */, signed short * * v_array /* r0 */, signed short * weight /* r0 */, int count /* r0 */, float scale /* f0 */) {
    // Local variables
    int i; // r0
    signed short * v0; // r11
    signed short * v1; // r9
