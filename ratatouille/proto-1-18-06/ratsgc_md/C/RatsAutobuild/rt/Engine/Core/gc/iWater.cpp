/*
    ...
    Language: C++
    Code range: 0x80124890 -> 0x80125B54
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RpLight * iWaterDirectionalLight; // size: 0x4, address: 0x803C2C9C
struct FxParam * iWaterEMBM; // size: 0x4, address: 0x803C2CA0
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct xEnt * waterObjects[8]; // size: 0x20, address: 0x803C2CA4
unsigned int numWaterObjects; // size: 0x4, address: 0x803C2CC4
struct xEnt * water2; // size: 0x4, address: 0x803C2CC8
struct xEnt * water3; // size: 0x4, address: 0x803C2CCC
struct xEnt * water4; // size: 0x4, address: 0x803C2CD0
struct xEnt * water5; // size: 0x4, address: 0x803C2CD4
struct xEnt * water7; // size: 0x4, address: 0x803C2CD8
int water_frame; // size: 0x4, address: 0x803BE930
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
struct xVec3 camscale; // size: 0xC, address: 0x803BE934
static struct RwTexture * saveBump; // size: 0x4, address: 0x803C2CDC
// total size: 0x18
struct bump_layer {
    // Members
    float u; // offset 0x0, size 0x4
...
static struct bump_layer bump_layers[4]; // size: 0x60, address: 0x802B0C28
static struct RwTexture * bumpTex; // size: 0x4, address: 0x803C2CE0
static struct RwRaster * bumpRaster; // size: 0x4, address: 0x803C2CE4
// total size: 0x10
struct RwRGBAReal {
    // Members
...
static struct RwCamera * saveCamera; // size: 0x4, address: 0x803C2CE8
static struct RwCamera * bumpCamera; // size: 0x4, address: 0x803C2CEC
static struct RwCamera * clonedShadowCamera; // size: 0x4, address: 0x803C2CF0
...
static float foo; // size: 0x4, address: 0x803C2CF4
...
// Range: 0x80124D20 -> 0x80124D4C
void iWaterCreateMTEffect() {
    // References
    // -> int gGCwaterDisable;
}

static struct xLightKit * waterLightKit; // size: 0x4, address: 0x803C2CF8
static struct RwRGBAReal waterHackColor; // size: 0x10, address: 0x803C7448
// Range: 0x80124D4C -> 0x80124DE4
...
static struct RpAtomic * (* defaultRenderCB)(struct RpAtomic *); // size: 0x4, address: 0x803C2CFC
// Range: 0x80124DE4 -> 0x80124E0C
...
unsigned int waterTexID; // size: 0x4, address: 0x803BE940
// total size: 0x28
struct PKRAssetType {
    // Members
...
struct RwFrame * FxFrameArray[2]; // size: 0x8, address: 0x803BE958
...
unsigned int enableWater; // size: 0x4, address: 0x803BE944
// Range: 0x80125610 -> 0x80125658
