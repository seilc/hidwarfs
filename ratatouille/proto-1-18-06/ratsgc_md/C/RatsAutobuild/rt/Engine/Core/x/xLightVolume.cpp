/*
    ...
    Language: C++
    Code range: 0x80118678 -> 0x801187B8
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct activity_type * activities; // size: 0x4, address: 0x803C2B08
int activities_used; // size: 0x4, address: 0x803C2B0C
// total size: 0x8
class xLightVolume {
    // Functions
    void create();
...
// Range: 0x801186B8 -> 0x801186BC
void xLightVolume::scene_exit() {}

// Range: 0x801186BC -> 0x801186F4
void xLightVolume::reset_all() {
    // Local variables
    struct activity_type * act; // r4
    struct activity_type * end_act; // r5
...
// Range: 0x801186F4 -> 0x80118700
// this: r0
void xLightVolume::create() {}

// Range: 0x80118700 -> 0x80118740
// this: r0
...
// total size: 0x4
struct /* @class$801xLightVolume_cpp */ {
    // Members
...
// Range: 0x801187B0 -> 0x801187B4
void xLightVolume::render_all() {}

// Range: 0x801187B4 -> 0x801187B8
