/*
    ...
    Language: C++
    Code range: 0x8006AD70 -> 0x8006D864
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct SndMixerFadersEntry g_SndMixerFaders[9]; // size: 0x90, address: 0x802D1068
...
enum xSndEffect m_eCurrentEffect; // size: 0x4, address: 0x803C14C8
// total size: 0x8
...
struct SndListenerSpringTableEntry g_SndListenerSpringTable[3]; // size: 0x18, address: 0x803BD9F0
// Range: 0x8006AD70 -> 0x8006AD74
void xSndMgr_ParseINI() {}
...
static class linear_pool faders; // size: 0xC, address: 0x803C14CC
// Range: 0x8006AD74 -> 0x8006ADA0
...
// Range: 0x8006ADA0 -> 0x8006ADC4
static void reset_faders() {
    // References
    // -> static class linear_pool faders;
}

// Range: 0x8006ADC4 -> 0x8006AED8
...
// total size: 0x1
struct /* @class$719xSndMgr_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$720xSndMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$721xSndMgr_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$722xSndMgr_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1525xSndMgr_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1526xSndMgr_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x8006B83C -> 0x8006B880
void xSndMgr_Stop(struct xSndVoiceInfo * pVoice /* r0 */, unsigned char bFreeRef /* r0 */) {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006B880 -> 0x8006B8F4
void xSndMgr_Pause(struct xSndVoiceInfo * pVoice /* r30 */, unsigned char bPaused /* r31 */) {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006B8F4 -> 0x8006B968
void xSndMgr_CutscenePause(struct xSndVoiceInfo * pVoice /* r30 */, unsigned char bPaused /* r31 */) {}

// Range: 0x8006B968 -> 0x8006BA30
unsigned char xSndMgr_SetInaudible(struct xSndVoiceInfo * pVoice /* r29 */) {
    // Local variables
    struct xSndVoiceInfo * pVoiceStorage; // r0

    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006BB1C -> 0x8006BBC8
...
// Range: 0x8006BCEC -> 0x8006BD24
void xSndMgr_SetInitFlag(unsigned char bIsInit /* r0 */) {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006BD24 -> 0x8006BD90
...
// Range: 0x8006C40C -> 0x8006C424
void xSndMixerSetVolume(enum xSndMixerFaderName eMixerFader /* r0 */, float fVolume /* f0 */) {
    // References
    // -> struct SndMixerFadersEntry g_SndMixerFaders[9];
}

// Range: 0x8006C424 -> 0x8006C43C
float xSndMixerGetVolume(enum xSndMixerFaderName eMixerFader /* r0 */) {
    // References
    // -> struct SndMixerFadersEntry g_SndMixerFaders[9];
}

// Range: 0x8006C43C -> 0x8006C454
void xSndMixerSetDampVolume(enum xSndMixerFaderName eMixerFader /* r0 */, float fVolume /* f0 */) {
    // References
    // -> struct SndMixerFadersEntry g_SndMixerFaders[9];
}

// Range: 0x8006C454 -> 0x8006C480
...
// Range: 0x8006C480 -> 0x8006C54C
float xSndMixerGetOutputVolume(signed short eSoundCategory /* r0 */) {
    // Local variables
    enum xSndMixerFaderName eMixerFader; // r0
    struct SndMixerFadersEntry * CurFader; // r4
    float outputVolume; // f2
    float CurFaderVolume; // f4
...
// Range: 0x8006C880 -> 0x8006CEA4
enum xSndHandle xSndMgrPlay(enum iSndGroupHandle hSoundToPlay /* r25 */, int uFlags /* r18 */, const struct xVec3 * pPos_WS /* r26 */, const struct xVec3 * pVel /* r27 */, struct xEnt * pParentEnt /* r28 */, const float * pfOverrideVolume /* r29 */, const float * pfOverridePitch /* r30 */) {
    // Local variables
    int iFlags; // r23
    struct xSndGroupHeader * pSnd; // r22
    unsigned int uInfoIndex; // r0
    struct xSndGroupInfo * pSndInfo; // r21
    struct iSndFileInfo * ip; // r20
    struct xSndVoiceInfo * vp; // r31
...
// Range: 0x8006D2BC -> 0x8006D358
void xSndMgrFade(enum xSndHandle & hSound /* r31 */, float fadeTime /* f30 */, float destVolume /* f31 */) {
    // Local variables
    struct xSndVoiceInfo * vp; // r0
}

unsigned int gCurrSoundMemoryUsed; // size: 0x4, address: 0x803C14D8
unsigned int gHighwaterSoundMemoryUsed; // size: 0x4, address: 0x803C14DC
// Range: 0x8006D358 -> 0x8006D57C
void xSndMgr_SetPaused(signed short whichCat /* r0 */, unsigned char bPause /* r0 */) {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006D57C -> 0x8006D678
unsigned char xSndMgrIsPaused(signed short eSoundCategory /* r0 */) {
    // References
    // -> struct xSndGlobals gSnd;
}

// Range: 0x8006D678 -> 0x8006D730
int xSndMgrAllocRef(unsigned int uniqueID /* r25 */, int voiceIndex /* r26 */) {
    // Local variables
    int i; // r28
    int refIndex; // r27
...
// Range: 0x8006D730 -> 0x8006D770
void xSndMgrFreeRef(enum xSndHandle & xHandle /* r0 */) {
    // Local variables
    int iVoiceRef; // r0
...
// Range: 0x8006D770 -> 0x8006D808
void xSndMgrUpdateRef(enum xSndHandle & xHandle /* r25 */, int voiceIndex /* r26 */) {
    // Local variables
    int i; // r27
    int iVoiceRef; // r0
