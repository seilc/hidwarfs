/*
    ...
    Language: C++
    Code range: 0x8000F014 -> 0x8000F014
*/
// total size: 0x8
struct /* @class$816xCamFollow_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float dist_min; // offset 0x4, size 0x4
};
// total size: 0x20
struct /* @class$817xCamFollow_cpp */ {
    // Members
...
struct xCamFollow : public xCam {
    // Members
    struct config cfg; // offset 0x130, size 0x94
private:
    const struct xVec3 * target; // offset 0x1C4, size 0x4
    struct xCamCoordCylinder end_coord; // offset 0x1C8, size 0x18
    struct xVec3 face; // offset 0x1E0, size 0xC
    struct xVec3 end_face; // offset 0x1EC, size 0xC
    float vel_dist; // offset 0x1F8, size 0x4
    float vel_height; // offset 0x1FC, size 0x4
    float vel_theta; // offset 0x200, size 0x4
    float vel_face_height; // offset 0x204, size 0x4
    float vel_origin_y; // offset 0x208, size 0x4
    float drift_time; // offset 0x20C, size 0x4
    float vel_stick; // offset 0x210, size 0x4
    struct xVec2 drift_loc; // offset 0x214, size 0x8
    float drift_vel; // offset 0x21C, size 0x4
};
// total size: 0x40
...
// total size: 0x4
struct /* @class$870xCamFollow_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$888xCamFollow_cpp */ {
    // Members
