/*
    ...
    Language: C++
    Code range: 0x800FD648 -> 0x800FF948
*/
// total size: 0x24
struct xRay3 {
    // Members
...
static struct xBoxFace box_faces[6]; // size: 0x480, address: 0x802DC320
static struct xEdge * box_edges[6][6]; // size: 0x90, address: 0x802DC7A0
// total size: 0x18
struct xBox {
    // Members
...
// Range: 0x800FDCD0 -> 0x800FDDA0
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDDA0 -> 0x800FDE48
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDE48 -> 0x800FDECC
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FDECC -> 0x800FDEE8
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FDEE8 -> 0x800FDF90
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDF90 -> 0x800FE014
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE014 -> 0x800FE0DC
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE0DC -> 0x800FE184
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE184 -> 0x800FE208
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE208 -> 0x800FE224
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FE224 -> 0x800FE2CC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE2CC -> 0x800FE350
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE350 -> 0x800FE420
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE420 -> 0x800FE4C8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE4C8 -> 0x800FE54C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE54C -> 0x800FE5F4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE5F4 -> 0x800FE678
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE678 -> 0x800FE720
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE720 -> 0x800FE7C8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE7C8 -> 0x800FE870
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE870 -> 0x800FE8F4
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE8F4 -> 0x800FE99C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE99C -> 0x800FEA44
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEA44 -> 0x800FEA60
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FEA60 -> 0x800FEB08
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEB08 -> 0x800FEB88
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FEB88 -> 0x800FEC50
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEC50 -> 0x800FECF8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FECF8 -> 0x800FED78
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FED78 -> 0x800FEE20
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEE20 -> 0x800FEEA4
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FEEA4 -> 0x800FEF4C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEF4C -> 0x800FEFF4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEFF4 -> 0x800FF09C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FF09C -> 0x800FF120
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FF120 -> 0x800FF1C8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FF1C8 -> 0x800FF270
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}
...
// Range: 0x800FF730 -> 0x800FF7F0
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FF7F0 -> 0x800FF878
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8
