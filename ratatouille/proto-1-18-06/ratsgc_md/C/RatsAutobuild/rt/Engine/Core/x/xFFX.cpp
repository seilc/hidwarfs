/*
    ...
    Language: C++
    Code range: 0x8002FA88 -> 0x8002FEC4
*/
static unsigned int psize; // size: 0x4, address: 0x803C0DA8
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct xFFX * pool; // size: 0x4, address: 0x803C0DAC
static struct xFFX * alist; // size: 0x4, address: 0x803C0DB0
unsigned int gActiveHeap; // size: 0x4, address: 0x803C1074
// Range: 0x8002FA88 -> 0x8002FB14
void xFFXPoolInit(unsigned int num_ffx /* r0 */) {
    // Local variables
    unsigned int i; // r6
...
// Range: 0x8002FB14 -> 0x8002FB34
struct xFFX * xFFXAlloc() {
    // References
    // -> static struct xFFX * alist;
}

// Range: 0x8002FB34 -> 0x8002FB44
void xFFXFree(struct xFFX * f /* r0 */) {
    // References
    // -> static struct xFFX * alist;
}

// Range: 0x8002FB44 -> 0x8002FB70
signed short xFFXAddEffect(struct xEnt * ent /* r0 */, struct xFFX * f /* r0 */) {}

// Range: 0x8002FB70 -> 0x8002FBE0
unsigned int xFFXRemoveEffectByFData(struct xEnt * ent /* r0 */, void * fdata /* r0 */) {
    // Local variables
    struct xFFX * * ffxh; // r31
    struct xFFX * next; // r30
}

// Range: 0x8002FBE0 -> 0x8002FC54
static void xFFXApplyOne(struct xFFX * ffx /* r29 */, struct xEnt * ent /* r30 */, struct xScene * sc /* r31 */, float dt /* f31 */) {}

// Range: 0x8002FC54 -> 0x8002FC8C
void xFFXApply(struct xEnt * ent /* r6 */, struct xScene * sc /* r5 */, float dt /* f0 */) {}
...
// Range: 0x8002FC8C -> 0x8002FD7C
void xFFXShakeUpdateEnt(struct xEnt * ent /* r30 */, float dt /* f0 */, void * fdata /* r31 */) {
    // Local variables
...
static unsigned int shake_psize; // size: 0x4, address: 0x803C0DB4
static struct xFFXShakeState * shake_pool; // size: 0x4, address: 0x803C0DB8
static struct xFFXShakeState * shake_alist; // size: 0x4, address: 0x803C0DBC
// Range: 0x8002FD7C -> 0x8002FE08
void xFFXShakePoolInit(unsigned int num /* r0 */) {
    // Local variables
    unsigned int i; // r6
...
// Range: 0x8002FE08 -> 0x8002FE28
struct xFFXShakeState * xFFXShakeAlloc() {
    // References
    // -> static struct xFFXShakeState * shake_alist;
}

// Range: 0x8002FE28 -> 0x8002FE38
void xFFXShakeFree(struct xFFXShakeState * s /* r0 */) {
    // References
    // -> static struct xFFXShakeState * shake_alist;
}
...
static unsigned int rot_match_psize; // size: 0x4, address: 0x803C0DC0
static struct xFFXRotMatchState * rot_match_pool; // size: 0x4, address: 0x803C0DC4
static struct xFFXRotMatchState * rot_match_alist; // size: 0x4, address: 0x803C0DC8
// Range: 0x8002FE38 -> 0x8002FEC4
void xFFXRotMatchPoolInit(unsigned int num /* r0 */) {
    // Local variables
    unsigned int i; // r6
