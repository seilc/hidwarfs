/*
    ...
    Language: C++
    Code range: 0x8004E4A4 -> 0x8004E8E4
*/
...
// Range: 0x8004E4A4 -> 0x8004E524
void xMovePointInit(struct xMovePoint * m /* r30 */, struct xMovePointAsset * asset /* r31 */) {
    // References
...
// total size: 0x0
struct xSerial {};
// Range: 0x8004E524 -> 0x8004E544
void xMovePointSave(struct xMovePoint * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8004E544 -> 0x8004E564
void xMovePointLoad(struct xMovePoint * ent /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x8004E564 -> 0x8004E5AC
...
// Range: 0x8004E5AC -> 0x8004E648
void xMovePointSetup(struct xMovePoint * m /* r31 */, struct xScene * sc /* r27 */) {
    // Local variables
    unsigned int * id; // r29
...
// Range: 0x8004E648 -> 0x8004E798
void xMovePointSplineSetup(struct xMovePoint * m /* r29 */) {
    // Local variables
    struct xMovePoint * w0; // r31
    struct xMovePoint * w2; // r30
    struct xMovePoint * w3; // r31
    struct xVec3 points[2]; // r1+0x20
    struct xVec3 p1; // r1+0x14
    struct xVec3 p2; // r1+0x8
}

// Range: 0x8004E798 -> 0x8004E7B0
void xMovePointSplineDestroy(struct xMovePoint * m /* r0 */) {}

// Range: 0x8004E7B0 -> 0x8004E8DC
float xMovePointGetNext(const struct xMovePoint * m /* r27 */, const struct xMovePoint * prev /* r28 */, struct xMovePoint * * next /* r29 */, struct xVec3 * hdng /* r30 */) {
    // Local variables
    int rnd; // r7
    unsigned short idx; // r8
    struct xMovePoint * previousOption; // r31
}

// Range: 0x8004E8DC -> 0x8004E8E4
struct xVec3 * xMovePointGetPos(const struct xMovePoint * m /* r3 */) {}
