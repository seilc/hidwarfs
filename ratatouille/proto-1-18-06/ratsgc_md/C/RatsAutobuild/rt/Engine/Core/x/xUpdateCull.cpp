/*
    ...
    Language: C++
    Code range: 0x80076D90 -> 0x80077704
*/
// total size: 0x10
...
// total size: 0x4
struct /* @class$786xUpdateCull_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804xUpdateCull_cpp */ {
    // Members
...
union /* @class$805xUpdateCull_cpp */ {
...
// Range: 0x80076FA4 -> 0x80077448
struct xUpdateCullMgr * xUpdateCull_Init(void * ent /* r18 */, unsigned int entCount /* r17 */, struct xGroup * * group /* r30 */, unsigned int groupCount /* r31 */) {
    // Local variables
    void * tempEnt; // r25
    unsigned int tempCount; // r24
    unsigned int idx; // r0
    unsigned int i; // r19
    unsigned int j; // r20
    unsigned int k; // r6
    ...
    unsigned int entsInGroups; // r26
    unsigned int nonEmptyGroups; // r27
    unsigned int x; // r0
    unsigned char * inGroupArray; // r23
    struct xBase * base; // r0
    unsigned int mgrCount; // r26
    struct xUpdateCullMgr * m; // r22
    unsigned int grpIndex; // r21
    unsigned int mgrIndex; // r20
    unsigned int startIndex; // r19
    struct xBase * base; // r0
    struct xUpdateCullEnt * * prevPtr; // r5
...
// Range: 0x80077658 -> 0x800776AC
void xUpdateCull_SetCB(struct xUpdateCullMgr * m /* r0 */, void * entity /* r0 */, unsigned int (* cb)(void *, void *) /* r0 */, void * cbdata /* r0 */) {
    // Local variables
    unsigned int i; // r10
}

// Range: 0x800776AC -> 0x80077704
