/*
    ...
    Language: C++
    Code range: 0x8000B10C -> 0x8000C2F0
*/
// total size: 0x20
struct xQCData {
    // Members
...
// Range: 0x8000B10C -> 0x8000B1B4
void xBoundUpdate(struct xBound * b /* r31 */) {}

// Range: 0x8000B1B4 -> 0x8000B2BC
void xBoundGetBox(struct xBox & box /* r30 */, const struct xBound & bound /* r31 */) {
    // Local variables
    const struct xSphere & o; // r0
    const struct xCylinder & c; // r0
}
...
// Range: 0x8000B2F0 -> 0x8000B428
void xBoundGetCylinder(struct xCylinder & o /* r29 */, const struct xBound & bound /* r30 */) {
    // Local variables
...
// Range: 0x8000B454 -> 0x8000B54C
void xBoundGetSphere(struct xSphere & o /* r29 */, const struct xBound & bound /* r30 */) {
    // Local variables
    const struct xMat4x3 & mat; // r31
    struct xVec3 v; // r1+0x8
    float r2; // f1
...
// Range: 0x8000B54C -> 0x8000B56C
void xBoundSphereHitsOBB(const struct xSphere * s /* r0 */, const struct xBox * b /* r0 */, const struct xMat4x3 * m /* r0 */, struct xCollis * coll /* r0 */) {}

// Range: 0x8000B56C -> 0x8000B6C8
void xBoundHitsBound(const struct xBound * a /* r29 */, const struct xBound * b /* r30 */, struct xCollis * c /* r31 */) {}

// Range: 0x8000B6C8 -> 0x8000B744
void xBoundHitsModel(const struct xBound * b /* r28 */, const struct xModelInstance * m /* r29 */, struct xCollis * colls /* r30 */, unsigned char ncolls /* r31 */, float sth /* f31 */) {}
...
// Range: 0x8000B744 -> 0x8000BA88
static void xBoundOBBIsectRay(const struct xBox * b /* r28 */, const struct xMat4x3 * m /* r29 */, const struct xRay3 * r /* r30 */, struct xIsect * isect /* r31 */) {
    // Local variables
    struct xRay3 xfr; // r1+0x70
    struct xBox sbox; // r1+0x10
    struct xMat4x3 mnormal; // r1+0x30
    float len2; // f1
    float len_inv; // f4
    float len2; // f1
    float len_inv; // f4
...
// Range: 0x8000BA88 -> 0x8000BB9C
void xRayHitsBound(const struct xRay3 * r /* r3 */, const struct xBound * b /* r7 */, struct xCollis * c /* r31 */) {
    // Local variables
    struct xIsect isect; // r1+0x8
}

// Range: 0x8000BB9C -> 0x8000BC0C
void xSphereHitsBound(const struct xSphere * o /* r0 */, const struct xBound * b /* r4 */, struct xCollis * c /* r6 */) {}

// Range: 0x8000BC0C -> 0x8000BD08
void xVecHitsBound(const struct xVec3 * v /* r3 */, const struct xBound * b /* r30 */, struct xCollis * c /* r31 */) {
    // Local variables
    struct xIsect isect; // r1+0x14
    struct xVec3 lv; // r1+0x8
}

// Range: 0x8000BD08 -> 0x8000BD78
void xBoundDraw(const struct xBound * b /* r3 */) {}

struct xMat4x3 g_I3; // size: 0x40, address: 0x803C1010
// Range: 0x8000BD78 -> 0x8000BE84
unsigned char xBoundHitsBound(const struct xBound & a /* r8 */, const struct xBound & b /* r7 */) {
    // References
    // -> struct xMat4x3 g_I3;
}

// Range: 0x8000BE84 -> 0x8000BEFC
unsigned char xSphereHitsBound(const struct xVec3 & c /* r0 */, float r /* f0 */, const struct xBound & b /* r4 */) {}

// Range: 0x8000BEFC -> 0x8000BF90
unsigned char xOBBHitsBound(const struct xBox & box /* r7 */, const struct xMat4x3 & mat /* r6 */, const struct xBound & b /* r0 */) {
    // References
    // -> struct xMat4x3 g_I3;
}

// Range: 0x8000BF90 -> 0x8000C008
void xBoundGetCenter(const struct xBound * b /* r5 */, struct xVec3 * center /* r4 */) {}

// Range: 0x8000C008 -> 0x8000C2F0
unsigned char xOBBHitsTriangle(const struct xBox & box /* r29 */, const struct xMat4x3 & mat /* r27 */, const struct xVec3 * vertices /* r28 */) {
    // Local variables
    struct xVec3 dist; // r1+0x38
    struct xVec3 center; // r1+0x2C
    struct xVec3 v2MinusV1; // r1+0x20
    struct xVec3 v1MinusV0; // r1+0x14
    struct xVec3 v0MinusV2; // r1+0x8
    struct xVec3 seperationAxes[13]; // r1+0x44
    int i; // r30
    struct xVec3 & s; // r29
    float boxDist; // f31
    float centerDotS; // f0
