/*
    ...
    Language: C++
    Code range: 0x8010A38C -> 0x8010A828
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8010A38C -> 0x8010A3DC
void text_widget::load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x2C
struct {} xhud::text_widget::__vtable; // size: 0x2C, address: 0x803BD058
...
// Range: 0x8010A41C -> 0x8010A43C
// this: r0
void text_widget::destruct() {}

// total size: 0x1
struct /* @class$866xHudText_cpp */ {
    // Members
...
enum /* @enum$871xHudText_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$872xHudText_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$873xHudText_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// Range: 0x8010A60C -> 0x8010A62C
// this: r0
void text_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x803C1408
static signed char init; // size: 0x1, address: 0x803C140C
// Range: 0x8010A62C -> 0x8010A66C
...
// Range: 0x8010A7A0 -> 0x8010A7C8
// this: r3
void text_widget::render() {}

// Range: 0x8010A7C8 -> 0x8010A828
// this: r29
