/*
    ...
    Language: C++
    Code range: 0x800FD2C4 -> 0x800FF5C4
*/
// total size: 0x24
struct xRay3 {
    // Members
...
static struct xBoxFace box_faces[6]; // size: 0x480, address: 0x802DAF00
static struct xEdge * box_edges[6][6]; // size: 0x90, address: 0x802DB380
// total size: 0x18
struct xBox {
    // Members
...
// total size: 0x4
struct /* @class$785xCollideSphereBox_cpp */ {
    // Members
...
union /* @class$805xCollideSphereBox_cpp */ {
...
// Range: 0x800FD2C4 -> 0x800FD708
int xSweptSphereToBox(struct xSweptSphere & sws /* r30 */, const struct xBox & box /* r31 */) {}
...
// Range: 0x800FD708 -> 0x800FD7CC
static int xSweptSphereToBoxInside(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xVec3 box_center; // r1+0x8
    float box_radius; // f1
}

// Range: 0x800FD7CC -> 0x800FD7E8
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FD7E8 -> 0x800FD804
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FD804 -> 0x800FD820
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FD820 -> 0x800FD8C8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FD8C8 -> 0x800FD94C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
    struct xVec3 path_perp; // r1+0x8
...
// Range: 0x800FD94C -> 0x800FDA1C
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDA1C -> 0x800FDAC4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDAC4 -> 0x800FDB48
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FDB48 -> 0x800FDB64
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FDB64 -> 0x800FDC0C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDC0C -> 0x800FDC90
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FDC90 -> 0x800FDD58
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDD58 -> 0x800FDE00
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDE00 -> 0x800FDE84
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FDE84 -> 0x800FDEA0
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FDEA0 -> 0x800FDF48
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FDF48 -> 0x800FDFCC
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FDFCC -> 0x800FE09C
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE09C -> 0x800FE144
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE144 -> 0x800FE1C8
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE1C8 -> 0x800FE270
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE270 -> 0x800FE2F4
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE2F4 -> 0x800FE39C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE39C -> 0x800FE444
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE444 -> 0x800FE4EC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE4EC -> 0x800FE570
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE570 -> 0x800FE618
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE618 -> 0x800FE6C0
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE6C0 -> 0x800FE6DC
static unsigned char check_moving_away(const struct xVec3 & dir /* r0 */) {}

// Range: 0x800FE6DC -> 0x800FE784
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE784 -> 0x800FE804
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE804 -> 0x800FE8CC
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE8CC -> 0x800FE974
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FE974 -> 0x800FE9F4
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FE9F4 -> 0x800FEA9C
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEA9C -> 0x800FEB20
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FEB20 -> 0x800FEBC8
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEBC8 -> 0x800FEC70
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEC70 -> 0x800FED18
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FED18 -> 0x800FED9C
static unsigned char check_against_first_side(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xEdge * edge; // r31
    struct xVec3 to_sphere; // r1+0x14
...
// Range: 0x800FED9C -> 0x800FEE44
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FEE44 -> 0x800FEEEC
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r31 */) {}
...
// Range: 0x800FEEEC -> 0x800FF110
int xSweptSphereToOBB(struct xSweptSphere * sws /* r29 */, const struct xBox * box /* r31 */, const struct xMat4x3 * mat /* r30 */) {
    // Local variables
    struct xVec3 old_start; // r1+0x2C
    struct xVec3 old_end; // r1+0x20
    struct xVec3 old_dir; // r1+0x14
    float old_dist; // f0
    float box_scale; // f0
    float old_radius; // f29
    float old_curdist; // f28
    float initial_scaled_curdist; // f27
    int got_collision; // r31
    struct xVec3 collide_point; // r1+0x8
}
...
// Range: 0x800FF110 -> 0x800FF198
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8

    // References
    // -> static struct xBoxFace box_faces[6];
}

// Range: 0x800FF198 -> 0x800FF220
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8
...
// Range: 0x800FF2A8 -> 0x800FF324
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r31 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8
...
// Range: 0x800FF3AC -> 0x800FF46C
static void fill(struct xBoxFace & face /* r30 */, const struct xBox & box /* r31 */) {}

// Range: 0x800FF46C -> 0x800FF4F4
static int xSweptSphereToBoxFaces(struct xSweptSphere & sphere /* r30 */, const struct xBox & box /* r0 */) {
    // Local variables
    struct xCollideSphereToPolygonResults results; // r1+0x8
