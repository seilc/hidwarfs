/*
    ...
    Language: C++
    Code range: 0x8013499C -> 0x8013562C
*/
float sCameraNearClip; // size: 0x4, address: 0x803BD510
float sCameraFarClip; // size: 0x4, address: 0x803BD514
// total size: 0x8
struct RwObject {
    // Members
...
struct RwCamera * globalCamera; // size: 0x4, address: 0x803C1940
static struct RwCamera * sMainGameCamera; // size: 0x4, address: 0x803C1944
void * RwEngineInstance; // size: 0x4, address: 0x803C3054
// Range: 0x8013499C -> 0x80134A08
...
// Range: 0x80134BC4 -> 0x80134C34
void iCameraBegin(struct RwCamera * cam /* r31 */, int clear /* r0 */) {
    // References
    // -> float sCameraNearClip;
    // -> struct xGlobals * xglobals;
}

// Range: 0x80134C34 -> 0x80134C68
void iCameraEnd(struct RwCamera * cam /* r31 */) {}

// Range: 0x80134C68 -> 0x80134C90
void iCameraShowRaster(struct RwCamera * cam /* r0 */) {}

// Range: 0x80134C90 -> 0x80134CE4
void iCameraUpdatePos(struct RwCamera * cam /* r0 */, struct xMat4x3 * pos /* r30 */) {
    // Local variables
    struct RwFrame * f; // r31
    struct RwMatrixTag * m; // r3
}

// Range: 0x80134CE4 -> 0x80134CEC
float iCameraGetAspectRatio() {}

// Range: 0x80134CEC -> 0x80134D58
...
// Range: 0x801354EC -> 0x801354F8
static float iCameraFogFarClip() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x801354F8 -> 0x8013552C
static void iCameraFogOffWrapper() {
    // References
    // -> void * RwEngineInstance;
}

// Range: 0x8013552C -> 0x801355AC
