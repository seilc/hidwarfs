/*
    ...
    Language: C++
    Code range: 0x800ED304 -> 0x800EE824
*/
// total size: 0xC
struct RwV3d {
    // Members
...
// total size: 0x4
struct /* @class$785xCollideSpherePolygon_cpp */ {
    // Members
...
union /* @class$805xCollideSpherePolygon_cpp */ {
...
// Range: 0x800EE1D8 -> 0x800EE3E0
static unsigned char PolygonTestAH0a(int i /* r25 */, float closest_dist_squ /* f29 */, const struct xEdge * edges /* r26 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r29 */) {
    // Local variables
...
// Range: 0x800EE3E0 -> 0x800EE4FC
static unsigned char PolygonTestAH0b(int i /* r25 */, float closest_dist_squ /* f30 */, const struct xEdge * edges /* r26 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r29 */) {
    // Local variables
...
// Range: 0x800EE4FC -> 0x800EE6C4
static unsigned char PolygonTestAH0c(int i /* r24 */, float closest_dist_squ /* f29 */, const class xPlane & surface /* r25 */, const struct xEdge * edges /* r26 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r29 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x24
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    float above_edge_d0; // f0
...
// Range: 0x800EE6C4 -> 0x800EE824
static unsigned char PolygonTestBH0a(int i /* r24 */, float closest_dist_squ /* f30 */, const class xPlane & surface /* r25 */, const struct xEdge * edges /* r26 */, int num_edges /* r27 */, const struct xSweptSphere & sphere /* r28 */, struct xCollideSphereToPolygonResults & results /* r29 */) {
    // Local variables
    struct xCollideSphereToLineSegmentResults edge_collide; // r1+0x18
    struct xCollideSphereToPointResults vertex_collide; // r1+0x8
    float above_edge_d0; // f0
