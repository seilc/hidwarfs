/*
    ...
    Language: C++
    Code range: 0x801182F4 -> 0x80118434
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct activity_type * activities; // size: 0x4, address: 0x803C15D8
int activities_used; // size: 0x4, address: 0x803C15DC
// total size: 0x8
class xLightVolume {
    // Functions
    void create();
...
// Range: 0x80118334 -> 0x80118338
void xLightVolume::scene_exit() {}

// Range: 0x80118338 -> 0x80118370
...
// Range: 0x80118370 -> 0x8011837C
// this: r0
void xLightVolume::create() {}

// Range: 0x8011837C -> 0x801183BC
// this: r0
...
// Range: 0x8011842C -> 0x80118430
void xLightVolume::render_all() {}

// Range: 0x80118430 -> 0x80118434
