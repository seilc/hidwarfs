/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xModelWarp.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x8012B218 -> 0x8012B3A0
*/
// total size: 0x10
struct _xFColor {
    // Members
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x8037F340
// total size: 0x18
struct xBox {
    // Members
...
static struct render_context render_contexts[8]; // size: 0x400, address: 0x8037F390
static int render_contexts_size; // size: 0x4, address: 0x803C18B8
// total size: 0xC
struct xVec3 {
    // Static members
