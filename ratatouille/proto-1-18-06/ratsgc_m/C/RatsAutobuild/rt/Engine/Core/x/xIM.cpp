/*
    ...
    Language: C++
    Code range: 0x801310DC -> 0x801313A4
*/
// total size: 0xC
struct RwV3d {
    // Members
...
static struct rwGameCube2DVertex vx[4]; // size: 0x60, address: 0x80387308
void * RwEngineInstance; // size: 0x4, address: 0x803C3054
// Range: 0x801312D0 -> 0x801313A4
