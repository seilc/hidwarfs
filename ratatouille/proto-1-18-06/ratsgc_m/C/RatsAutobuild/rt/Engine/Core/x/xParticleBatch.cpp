/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Core\x\xParticleBatch.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x800EEC10 -> 0x800F0008
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct internal_system systems[128]; // size: 0x2000, address: 0x80374EA0
static struct system_bucket buckets[6][128]; // size: 0x3C00, address: 0x80376EA0
static struct block_info * head_free_block; // size: 0x4, address: 0x803C1228
static int free_block_count; // size: 0x4, address: 0x803C122C
static unsigned char * block_buffer; // size: 0x4, address: 0x803C1230
static struct block_info block_info_buffer[32]; // size: 0x180, address: 0x8037AAA0
static int systems_size; // size: 0x4, address: 0x803C1234
static int buckets_size[6]; // size: 0x18, address: 0x803C1238
// Range: 0x800EEC14 -> 0x800EEC30
...
// Range: 0x800EED04 -> 0x800EEDF8
static void add_to_bucket(struct internal_system & isys /* r28 */) {
    // Local variables
    int & bsize; // r30
    struct system_bucket * const begin_bucket; // r29
    struct system_bucket * const end_bucket; // r26
    struct system_bucket key; // r1+0x10
    struct system_bucket * bucket; // r0
...
// Range: 0x800EEE24 -> 0x800EEF04
static void remove_from_bucket(struct internal_system & isys /* r29 */) {
    // Local variables
    int & bsize; // r30
    struct system_bucket * const begin_bucket; // r3
    struct system_bucket * const end_bucket; // r28
    struct system_bucket key; // r1+0xC
    struct system_bucket * bucket; // r3
    struct internal_system * it; // r4
    struct internal_system * * itp; // r5
...
// Range: 0x800EF140 -> 0x800EF144
static void adjust_batch_size() {}

// Range: 0x800EF144 -> 0x800EF148
void xParticleBatchSceneExit() {}

// Range: 0x800EF148 -> 0x800EF1CC
...
// total size: 0x4
struct /* @class$923xParticleBatch_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941xParticleBatch_cpp */ {
    // Members
...
union /* @class$746xParticleBatch_cpp */ {
...
// Range: 0x800EF2E4 -> 0x800EF344
int xParticleBatchAddSystem(const struct xParticleBatchSystem & system /* r3 */) {
    // Local variables
    int system_id; // r31
...
// Range: 0x800EF344 -> 0x800EF348
static void validate_system() {}

// Range: 0x800EF348 -> 0x800EF3CC
void xParticleBatchReplaceSystem(int system_id /* r0 */, const struct xParticleBatchSystem & system /* r30 */) {
    // Local variables
...
// Range: 0x800EF3CC -> 0x800EF51C
float xParticleBatchRequest(int system_id /* r0 */, float amount /* f1 */, int max_blocks /* r0 */) {
    // Local variables
    struct internal_system & s; // r3
    float newBlockUsage; // f5
    float systemFreePercent; // f3
...
// Range: 0x800EF51C -> 0x800EF5C0
int xParticleBatchEmit(int system_id /* r0 */, int amount /* r29 */, unsigned char * * mem /* r30 */) {
    // Local variables
    struct internal_system & isys; // r31
...
class xParticleBatchGroup {
    ...
    int create_system(const struct xParticleBatchSystem & system);

    // Members
    unsigned char * elements; // offset 0x0, size 0x4
    int elements_size; // offset 0x4, size 0x4
};
// Range: 0x800EF68C -> 0x800EF6D4
// this: r31
void xParticleBatchGroup::create() {}

// Range: 0x800EF6D4 -> 0x800EF714
static int compare_group_systems_function(void * e1 /* r0 */, void * e2 /* r0 */) {
    // References
    // -> static struct internal_system systems[128];
}

// Range: 0x800EF714 -> 0x800EF804
static int compare_systems(const struct xParticleBatchSystem & sys1 /* r0 */, const struct xParticleBatchSystem & sys2 /* r0 */) {}

// Range: 0x800EF804 -> 0x800EF8A8
// this: r29
int xParticleBatchGroup::create_system(const struct xParticleBatchSystem & system /* r30 */) {
    // Local variables
    const unsigned char * end_elements; // r31
...
// Range: 0x800EF920 -> 0x800EF958
static int compare_group_systems_functor::operator()(const struct xParticleBatchSystem & system /* r4 */, const unsigned char & system_id /* r0 */) {
    // References
    // -> static struct internal_system systems[128];
}

// Range: 0x800EF958 -> 0x800EF978
// this: r0
