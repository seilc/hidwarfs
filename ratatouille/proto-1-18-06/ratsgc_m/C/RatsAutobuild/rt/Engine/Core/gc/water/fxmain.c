/*
    ...
    Language: C++
    Code range: 0x80125D48 -> 0x80125FBC
*/
// total size: 0x8
struct RwObject {
    // Members
...
static struct FxParam * (* EffectOpenFunctions[1])(); // size: 0x4, address: 0x803BD440
static char * EffectNames[1]; // size: 0x4, address: 0x803C17E8
static struct FxParam * Effects[1]; // size: 0x4, address: 0x803C17EC
static int EffectIndex; // size: 0x4, address: 0x803C17F0
// total size: 0x0
