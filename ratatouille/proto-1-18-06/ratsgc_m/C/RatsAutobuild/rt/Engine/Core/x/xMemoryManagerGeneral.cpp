/*
    ...
    Language: C++
    Code range: 0x8011A13C -> 0x8011AD0C
*/
// total size: 0x10
struct FreeNode {
    // Members
...
// total size: 0x1C
struct {} xMemoryManagerGeneral::__vtable; // size: 0x1C, address: 0x803BD1D8
