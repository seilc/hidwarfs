/*
    ...
    Language: C++
    Code range: 0x800F9DC4 -> 0x800FCC60
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSweptSphereGlobals sSwsGlobal; // size: 0x8, address: 0x803C1300
// Range: 0x800F9DC4 -> 0x800F9E2C
...
// total size: 0xC
struct /* @class$804xCollideSweptSphere_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$785xCollideSweptSphere_cpp */ {
    // Members
...
union /* @class$805xCollideSweptSphere_cpp */ {
...
// Range: 0x800FA334 -> 0x800FA630
int xSweptSphereToEnv(struct xSweptSphere * sws /* r29 */, struct xEnv * env /* r30 */) {
    // Local variables
...
int _rpCollisionGeometryDataOffset; // size: 0x4, address: 0x803C2EB4
// Range: 0x800FA99C -> 0x800FAB14
...
// Range: 0x800FB540 -> 0x800FB6B0
static unsigned char GrossCullTri(struct xSweptSphere * sws /* r0 */, struct xVec3 * v0 /* r0 */, struct xVec3 * v1 /* r0 */, struct xVec3 * v2 /* r0 */) {}

// Range: 0x800FB6B0 -> 0x800FB858
int xSweptSphereToSphere(struct xSweptSphere & sws /* r30 */, const struct xVec3 & center /* r31 */, float radius /* f28 */) {
    // Local variables
...
// Range: 0x800FB858 -> 0x800FB8CC
int xSweptSphereToBound(struct xSweptSphere * sws /* r0 */, const struct xBound * bound /* r4 */) {}

static int sSweptSphereEntFound; // size: 0x4, address: 0x803C1308
// total size: 0x20
struct xLinkAsset {
    // Members
...
static const struct xEnt * sSweptSphereMover; // size: 0x4, address: 0x803C130C
static unsigned char sSweptSphereCollType; // size: 0x1, address: 0x803C1310
static int sSweptSpherePenby; // size: 0x4, address: 0x803C1314
static unsigned int sSweptSphereIgnoreMovers; // size: 0x4, address: 0x803C1318
static unsigned char sSweptSphereNPCIgnoreGoo; // size: 0x1, address: 0x803C131C
// Range: 0x800FB8CC -> 0x800FBA4C
...
// Range: 0x800FBBF4 -> 0x800FBF7C
int xSweptSphereToEnt(struct xSweptSphere * sws /* r29 */, struct xEnt * ent /* r30 */, struct xRay3 * ray /* r27 */) {
    // Local variables
...
// Range: 0x800FBF7C -> 0x800FBFD0
static unsigned char sphereToEntResults(struct xSweptSphere * sws /* r0 */, struct xEnt * ent /* r4 */, unsigned char react /* r0 */) {}

// Range: 0x800FBFD0 -> 0x800FC384
int xNPCSweptSphereToEnt(struct xSweptSphere * sws /* r29 */, struct xEnt * ent /* r30 */, struct xRay3 * ray /* r27 */) {
    // Local variables
    int goo; // r0
    struct xSweptSphere sweptSphere; // r1+0x94
    unsigned int result; // r3
...
// Range: 0x800FC384 -> 0x800FC4E0
int xSweptSphereToScene(struct xSweptSphere * sws /* r28 */, struct xScene * sc /* r29 */, const struct xEnt * mover /* r0 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int envcollfound; // r0
...
// Range: 0x800FC8FC -> 0x800FCA14
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r25 */, struct xEnt * mover /* r26 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int i; // r28
...
// Range: 0x800FCA14 -> 0x800FCB3C
int xSweptSphereToPlayer(struct xSweptSphere * sws /* r24 */, struct xEnt * mover /* r25 */, struct zPlayer * * player /* r26 */, unsigned char collType /* r0 */, int penby /* r0 */) {
    // Local variables
    int i; // r28
    struct xSphere * extra_spheres[10]; // r1+0x8
    int numSpheres; // r0
