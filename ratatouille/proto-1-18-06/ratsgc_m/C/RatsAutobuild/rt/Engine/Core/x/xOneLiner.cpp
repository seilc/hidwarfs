/*
    ...
    Language: C++
    Code range: 0x80151D24 -> 0x80151F7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class xOneLiner * sDelayedSound; // size: 0x4, address: 0x803C1AD0
...
// Range: 0x80151D24 -> 0x80151D44
void xOneLiner::SceneInit() {}

// Range: 0x80151D44 -> 0x80151D50
void xOneLiner::SceneReset() {
    // References
    // -> class xOneLiner * sDelayedSound;
}

// Range: 0x80151D50 -> 0x80151D9C
void xOneLiner::UpdateSounds() {
    // References
    // -> class xOneLiner * sDelayedSound;
}

// Range: 0x80151D9C -> 0x80151EA4
// this: r31
