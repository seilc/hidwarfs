/*
    ...
    Language: C++
    Code range: 0x800FCD40 -> 0x800FD2C4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int cnt_fadesInProgress; // size: 0x4, address: 0x803C1320
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x800FD188 -> 0x800FD1A8
void xScreenFade::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// total size: 0x4
struct /* @class$807xScreenFade_cpp */ {
    // Members
...
union /* @class$826xScreenFade_cpp */ {
...
// total size: 0xC
struct /* @class$825xScreenFade_cpp */ {
    // Members
...
// Range: 0x800FD260 -> 0x800FD2C4
void xScreenFade::cb_dispatch(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int event /* r0 */) {
    // Local variables
    struct xScreenFade & e; // r4
}
