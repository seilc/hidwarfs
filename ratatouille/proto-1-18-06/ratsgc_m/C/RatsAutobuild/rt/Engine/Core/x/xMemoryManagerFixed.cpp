/*
    ...
    Language: C++
    Code range: 0x8011A00C -> 0x8011A134
*/
// total size: 0x4
struct FixedHeader {
    // Members
...
// total size: 0x1C
struct {} xMemoryManagerFixed::__vtable; // size: 0x1C, address: 0x803BD1B8
