/*
    ...
    Language: C++
    Code range: 0x8010428C -> 0x80105D3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char HDR_brightening; // size: 0x1, address: 0x803C13A0
static float overbrighten; // size: 0x4, address: 0x803BCF98
static float overbrighten_decay; // size: 0x4, address: 0x803BCF9C
static int downsamples; // size: 0x4, address: 0x803BCFA0
static unsigned char blur_faster; // size: 0x1, address: 0x803BCFA4
static float colorize_red; // size: 0x4, address: 0x803BCFA8
static float colorize_green; // size: 0x4, address: 0x803BCFAC
static float colorize_blue; // size: 0x4, address: 0x803BCFB0
static float colorize_alpha; // size: 0x4, address: 0x803BCFB4
// Range: 0x8010428C -> 0x80104290
static void add_tweaks() {}

static unsigned char enabled; // size: 0x1, address: 0x803BCFB8
static int background_glow_normal; // size: 0x4, address: 0x803C13A4
static int background_darken_normal; // size: 0x4, address: 0x803C13A8
// total size: 0x18
struct interpolator {
    // Functions
...
static struct interpolator background_glow; // size: 0x18, address: 0x803C13AC
static struct interpolator background_darken; // size: 0x18, address: 0x803C13C4
// total size: 0x10
struct _RwUInt128 {
    // Members
...
// Range: 0x801042E4 -> 0x801042E8
static void add_global_tweaks() {}

// Range: 0x801042E8 -> 0x801042EC
void xFXHighDynamicRangeSceneEnter() {}

// Range: 0x801042EC -> 0x801042F0
void xFXHighDynamicRangeSceneExit() {}

// Range: 0x801042F0 -> 0x8010432C
...
int hdr_dump_efb; // size: 0x4, address: 0x803C13DC
void * texData[8]; // size: 0x20, address: 0x803C13E0
unsigned short sizes[9][2]; // size: 0x24, address: 0x803BCFBC
// Range: 0x80104620 -> 0x801047B0
...
struct _GXRenderModeObj renderObject; // size: 0x3C, address: 0x803C02F8
// total size: 0x4
struct _GXColor {
    // Members
    unsigned char r; // offset 0x0, size 0x1
...
// Range: 0x8010587C -> 0x80105880
void xFXHighDynamicRangeRestoreSettings() {}

// Range: 0x80105880 -> 0x80105998
...
// Range: 0x80105A6C -> 0x80105AFC
// this: r0
static void interpolator::update(float dt /* f0 */) {}

// Range: 0x80105AFC -> 0x80105B04
...
// Range: 0x80105B54 -> 0x80105B58
static void refresh_blur_packets() {}

// Range: 0x80105B58 -> 0x80105B8C
...
// Range: 0x80105B8C -> 0x80105B90
void xFXHighDynamicRangeSetGlowClamp() {}

// Range: 0x80105B90 -> 0x80105B94
void xFXHighDynamicRangeResetGlowClamp() {}

// Range: 0x80105B94 -> 0x80105C20
...
// Range: 0x80105C20 -> 0x80105C98
// this: r3
static void interpolator::go(int value /* r4 */, float time /* f0 */) {}

// Range: 0x80105C98 -> 0x80105D3C
