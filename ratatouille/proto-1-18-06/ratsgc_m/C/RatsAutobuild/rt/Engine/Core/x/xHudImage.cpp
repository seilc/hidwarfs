/*
    ...
    Language: C++
    Code range: 0x8010CF28 -> 0x801101B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8010CF28 -> 0x8010CF78
void image_widget::load(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x28
struct {} xhud::image_widget::__vtable; // size: 0x28, address: 0x803BD100
// total size: 0x2C
...
// Range: 0x8010CFF4 -> 0x8010D030
// this: r0
void image_widget::destruct() {}

// Range: 0x8010D030 -> 0x8010D050
// this: r0
void image_widget::destroy() {}

static unsigned int myid; // size: 0x4, address: 0x803C1470
static signed char init; // size: 0x1, address: 0x803C1474
// Range: 0x8010D050 -> 0x8010D090
...
static float fNearZ; // size: 0x4, address: 0x803C1478
static signed char init; // size: 0x1, address: 0x803C147C
// total size: 0x24
...
class i2dQuadBuffer * gQuadBuffer; // size: 0x4, address: 0x803C18D8
enum LAYER_FLAGS {
    BLEND = 1,
    ADDITIVE = 2,
    SET_DEST_ALPHA = 4,
