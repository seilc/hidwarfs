/*
    ...
    Language: C++
    Code range: 0x800F6C70 -> 0x800F741C
*/
// total size: 0xC
struct config {
    // Members
...
static struct xPulseGlareMgr glare_mgr; // size: 0x3600, address: 0x8037ACE8
// Range: 0x800F6C70 -> 0x800F6C98
static void init_pulse(struct xPulse & p /* r0 */) {}

// Range: 0x800F6C98 -> 0x800F6CFC
static void xPulseFn(struct xPulse & p /* r31 */) {}

// Range: 0x800F6CFC -> 0x800F6D98
static void init_pulse_glare(struct xPulseGlare & glare /* r31 */) {}

// Range: 0x800F6D98 -> 0x800F6E70
...
static struct RxObjSpace3DVertex sStripVert[4]; // size: 0x90, address: 0x8037E2E8
