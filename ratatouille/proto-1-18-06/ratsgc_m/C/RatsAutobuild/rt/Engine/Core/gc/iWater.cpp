/*
    ...
    Language: C++
    Code range: 0x8012450C -> 0x801257D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int gGCwaterDisable; // size: 0x4, address: 0x803C1768
// total size: 0x8
struct RwObject {
    // Members
...
struct RpLight * iWaterDirectionalLight; // size: 0x4, address: 0x803C176C
struct FxParam * iWaterEMBM; // size: 0x4, address: 0x803C1770
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct xEnt * waterObjects[8]; // size: 0x20, address: 0x803C1774
unsigned int numWaterObjects; // size: 0x4, address: 0x803C1794
struct xEnt * water2; // size: 0x4, address: 0x803C1798
struct xEnt * water3; // size: 0x4, address: 0x803C179C
struct xEnt * water4; // size: 0x4, address: 0x803C17A0
struct xEnt * water5; // size: 0x4, address: 0x803C17A4
struct xEnt * water7; // size: 0x4, address: 0x803C17A8
int water_frame; // size: 0x4, address: 0x803BD410
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
struct xVec3 camscale; // size: 0xC, address: 0x803BD414
static struct RwTexture * saveBump; // size: 0x4, address: 0x803C17AC
// total size: 0x18
struct bump_layer {
    // Members
    float u; // offset 0x0, size 0x4
...
static struct bump_layer bump_layers[4]; // size: 0x60, address: 0x802AF808
static struct RwTexture * bumpTex; // size: 0x4, address: 0x803C17B0
static struct RwRaster * bumpRaster; // size: 0x4, address: 0x803C17B4
// total size: 0x10
struct RwRGBAReal {
    // Members
...
static struct RwCamera * saveCamera; // size: 0x4, address: 0x803C17B8
static struct RwCamera * bumpCamera; // size: 0x4, address: 0x803C17BC
static struct RwCamera * clonedShadowCamera; // size: 0x4, address: 0x803C17C0
...
static float foo; // size: 0x4, address: 0x803C17C4
float sTimeElapsed; // size: 0x4, address: 0x803C0674
struct RwCamera * ShadowCamera; // size: 0x4, address: 0x803BFEE8
// total size: 0x4
struct RwRGBA {
    // Members
...
static struct RwTexture * iWaterBumpGen(struct RwTexture * bump /* r30 */, struct RwTexture * src /* r31 */) {
    ...
    const struct bump_layer * bp; // r26
    int i; // r27

    // References
    // -> static struct RwCamera * bumpCamera;
    // -> static float foo;
    // -> static struct bump_layer bump_layers[4];
...
struct RwTexture * iWaterBumpTex; // size: 0x4, address: 0x803C1850
// Range: 0x80124974 -> 0x8012499C
void iWaterBumpGen() {
    // References
...
// Range: 0x8012499C -> 0x801249C8
void iWaterCreateMTEffect() {
    // References
    // -> int gGCwaterDisable;
}

static struct xLightKit * waterLightKit; // size: 0x4, address: 0x803C17C8
static struct RwRGBAReal waterHackColor; // size: 0x10, address: 0x803C5F28
// Range: 0x801249C8 -> 0x80124A60
...
static struct RpAtomic * (* defaultRenderCB)(struct RpAtomic *); // size: 0x4, address: 0x803C17CC
// Range: 0x80124A60 -> 0x80124A88
...
unsigned int waterTexID; // size: 0x4, address: 0x803BD420
// total size: 0x28
struct PKRAssetType {
    // Members
...
float BumpWidth; // size: 0x4, address: 0x803BD42C
float Shininess; // size: 0x4, address: 0x803BD430
float BumpHeight; // size: 0x4, address: 0x803BD428
// total size: 0x0
struct asset_type {};
// total size: 0x0
...
// Range: 0x80124B18 -> 0x80124E08
void iWaterSceneEnter() {
    // Local variables
    struct zScene & scene; // r4
    class zWaterBody * it; // r29
    class zWaterBody * end; // r28
    unsigned int body; // r27
    struct zEntSimpleObj * ent; // r0
    int i; // r27
    struct xEnt * ent; // r28
    struct RwMatrixTag newMat; // r1+0x8
...
struct RwTexture * iWaterEnvTex; // size: 0x4, address: 0x803C1854
// total size: 0x34
struct RwRaster {
    // Members
...
struct FxParam EMBM; // size: 0x14, address: 0x803C17D0
struct RwFrame * FxFrameArray[2]; // size: 0x8, address: 0x803BD438
struct xVec3 g_Y3; // size: 0xC, address: 0x803C3B30
struct xVec3 g_O3; // size: 0xC, address: 0x803C3B18
int EnvMode; // size: 0x4, address: 0x803C17E4
// total size: 0x0
...
unsigned int enableWater; // size: 0x4, address: 0x803BD424
// Range: 0x8012528C -> 0x801252D4
...
// Range: 0x80125584 -> 0x80125684
void iWaterReset() {
    // Local variables
    int i; // r31
    struct zEntSimpleObj * ent; // r27
