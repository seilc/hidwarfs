/*
    ...
    Language: C++
    Code range: 0x80122A48 -> 0x80124468
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char sModelBlurEnabled; // size: 0x1, address: 0x803BD408
// Range: 0x80122A48 -> 0x80122A4C
...
static class xFXCameraTexture camtex; // size: 0x44, address: 0x8037F0A0
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
// total size: 0x4
struct /* @class$785xModelBlur_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$822xModelBlur_cpp */ {
    // Members
...
// Range: 0x80122A4C -> 0x80122C34
static void render_model_now(struct xModelInstance * model /* r30 */) {
    // Local variables
    unsigned char reset; // r31
...
struct activity_data * activity_buffer; // size: 0x4, address: 0x803C1740
struct activity_data * activities[6]; // size: 0x18, address: 0x803C1744
int activities_used; // size: 0x4, address: 0x803C175C
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
struct xColor_tag g_CLEAR; // size: 0x4, address: 0x803C3328
// total size: 0x4
class xModelBlur {
    // Functions
    void create();
...
// Range: 0x80122C34 -> 0x80122CEC
void xModelBlur::scene_enter() {
    // Local variables
    int i; // r7
    struct activity_data * activity; // r8
...
// Range: 0x80122CEC -> 0x80122D14
void xModelBlur::scene_exit() {
    // References
    // -> static class xFXCameraTexture camtex;
}

// Range: 0x80122D14 -> 0x80122D9C
...
// Range: 0x80122E98 -> 0x80122EA4
// this: r0
void xModelBlur::create() {}

// Range: 0x80122EA4 -> 0x80122F84
// this: r29
...
// Range: 0x80122F84 -> 0x80122FA0
// this: r0
static void interpolator::reset(float value /* f0 */) {}

// Range: 0x80122FA0 -> 0x80122FEC
// this: r31
void xModelBlur::deactivate() {}

// Range: 0x80122FEC -> 0x8012311C
// this: r30
...
// Range: 0x8012311C -> 0x80123128
// this: r0
void xModelBlur::set_config(const struct config_data & cfg /* r0 */) {}

// Range: 0x80123128 -> 0x80123178
// this: r0
unsigned char xModelBlur::visible() const {}

// Range: 0x80123178 -> 0x801231A0
// this: r0
void xModelBlur::set_lifetime(float value /* f0 */, float time /* f0 */) {}

// Range: 0x801231A0 -> 0x801231F8
// this: r3
static void interpolator::go(float value /* f1 */, float time /* f0 */) {}

// Range: 0x801231F8 -> 0x80123220
// this: r0
void xModelBlur::set_alpha(float value /* f0 */, float time /* f0 */) {}

// Range: 0x80123220 -> 0x80123590
// this: r31
unsigned char xModelBlur::update(float dt /* f20 */) {
    ...
    float alpha_scale; // f29
    struct card_data * cards; // r27
    int cards_size; // r26
    float path_dist; // f28
    struct path_node & p0; // r25
...
// Range: 0x80123590 -> 0x801235F4
// this: r0
static void interpolator::update(float dt /* f0 */) {}

// Range: 0x801235F4 -> 0x80123610
...
// Range: 0x80123610 -> 0x80123670
void xModelBlur::free_activity(struct activity_data * activity /* r1+0x8 */) {
    // Local variables
    struct activity_data * * tail_activity; // r6
    struct activity_data * temp; // r5
...
static unsigned int * FBSaveMem; // size: 0x4, address: 0x803C1760
static unsigned int * textureMem; // size: 0x4, address: 0x803C1764
// total size: 0x18
...
// Range: 0x80123D30 -> 0x8012443C
// this: r27
void xModelBlur::render_cards(const struct xFRect & src_rect /* r28 */, float xoff0 /* f24 */, float yoff0 /* f25 */, float xoff1 /* f26 */, float yoff1 /* f27 */) {
    // Local variables
    struct RwRaster * draw_raster; // r24
    class xFXFastRaster fr; // r1+0x90
    struct RwCamera * world_cam; // r31
    const struct xMat4x3 & view_mat; // r30
