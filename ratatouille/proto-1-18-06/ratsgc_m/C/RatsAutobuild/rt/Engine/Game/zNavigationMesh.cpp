/*
    ...
    Language: C++
    Code range: 0x80150D70 -> 0x80151080
*/
class zNavigationMesh * activeNavMesh; // size: 0x4, address: 0x803C1AC0
// Range: 0x80150D70 -> 0x80150D90
void zNavigationMesh_Init(void * base /* r0 */, void * asset /* r0 */) {}

// Range: 0x80150D90 -> 0x80150D94
void zNavigationMeshEventCB() {}
...
// total size: 0x4
struct /* @class$804zNavigationMesh_cpp */ {
    // Members
...
union /* @class$635zNavigationMesh_cpp */ {
...
// total size: 0xC
struct /* @class$824zNavigationMesh_cpp */ {
    // Members
...
// Range: 0x80150E4C -> 0x80150E58
void zNavigationMesh::SceneEnd() {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x80150E58 -> 0x80150EAC
class zMeshCircle * zNavigationMesh::FindMeshCircleForEnt(const struct xEnt * ent /* r30 */) {
    // Local variables
...
// Range: 0x80151044 -> 0x8015104C
class zNavigationMesh * zNavigationMesh::GetActiveNavMesh() {
    // References
    // -> class zNavigationMesh * activeNavMesh;
}

// Range: 0x8015104C -> 0x80151080
