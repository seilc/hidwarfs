/*
    ...
    Language: C++
    Code range: 0x801A98F8 -> 0x801AAF04
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float WAITER_BOUND_RADIUS; // size: 0x4, address: 0x803BE580
static float WAITER_BOUND_MIDRADIUS; // size: 0x4, address: 0x803BE584
static float WAITER_BOUND_YSHIFT; // size: 0x4, address: 0x803BE588
static float BIG_EPSILON; // size: 0x4, address: 0x803BE58C
static float WAITER_COLLISION_REFLECTION_HORIZONTAL; // size: 0x4, address: 0x803BE590
static float showScalarVel; // size: 0x4, address: 0x803C2478
static unsigned int WAITER_TORSO; // size: 0x4, address: 0x803BE594
static unsigned int WAITER_HEAD; // size: 0x4, address: 0x803BE598
static unsigned int WAITER_LHAND; // size: 0x4, address: 0x803BE59C
static unsigned int WAITER_RHAND; // size: 0x4, address: 0x803BE5A0
// total size: 0x28
...
class zCompLogicWaiter : public zICompLogic {
    // Functions
    unsigned char SystemEvent(unsigned int to_event, const float * to_param, struct xBase * to_param_widget);
...
// Range: 0x801A98F8 -> 0x801A99E4
// this: r27
unsigned char zCompLogicWaiter::SystemEvent(unsigned int to_event /* r28 */, const float * to_param /* r29 */, struct xBase * to_param_widget /* r30 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$794zCompLogicWaiter_cpp */ {
    // Members
...
union /* @class$813zCompLogicWaiter_cpp */ {
...
// total size: 0xC
struct /* @class$751zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zCompLogicWaiter_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zCompLogicWaiter_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zCompLogicWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zCompLogicWaiter_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zCompLogicWaiter_cpp */ {
    // Members
...
// Range: 0x801AA250 -> 0x801AA398
// this: r30
unsigned char zCompLogicWaiter::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
...
unsigned int zCOLLISION_NPC; // size: 0x4, address: 0x803C7AE8
unsigned int zCOLLISION_NEEDS_DEPEN_OUTER_BOUND; // size: 0x4, address: 0x803C7AEC
unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x803C7AF0
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801AA398 -> 0x801AAB10
// this: r30
void zCompLogicWaiter::SphereCollision(const struct xVec3 * pNewPosition /* r22 */, const struct xVec3 * pVelocity /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
...
// Range: 0x801AAB10 -> 0x801AAC6C
// this: r28
void zCompLogicWaiter::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r29 */, struct xEntFrame * frame /* r30 */) {
    // Local variables
    int i; // r31
    float normDot; // f0
...
// Range: 0x801AAC6C -> 0x801AAD78
// this: r26
void zCompLogicWaiter::DepenetrateCollisionList(struct xVec3 * pPosition /* r27 */) {
    // Local variables
    int i; // r28
...
// total size: 0xC
struct /* @class$812zCompLogicWaiter_cpp */ {
    // Members
