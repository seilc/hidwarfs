/*
    ...
    Language: C++
    Code range: 0x801B3B2C -> 0x801B3CAC
*/
// total size: 0x1
...
static class zICompNPCEntityParams gSpringBoardEntParameters; // size: 0x30, address: 0x803C2500
signed char zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2530
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicSpringBoard, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C2534
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B3BD8 -> 0x801B3BF8
// this: r0
void zNPCSpringBoard::Deactivate() {}

// Range: 0x801B3BF8 -> 0x801B3C6C
// this: r30
...
// total size: 0x4
struct /* @class$828zNPCSpringBoard_cpp */ {
    // Members
...
union /* @class$848zNPCSpringBoard_cpp */ {
...
// total size: 0xC
struct /* @class$846zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$793zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$794zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$795zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$796zNPCSpringBoard_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$797zNPCSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$798zNPCSpringBoard_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$799zNPCSpringBoard_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCSpringBoard::__vtable; // size: 0x3C, address: 0x803BE9C8
// total size: 0xC
struct RwV3d {
    // Members
