/*
    ...
    Language: C++
    Code range: 0x8016DB6C -> 0x8016DC58
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct {} zCamSplineCommonMix::__vtable; // size: 0xC, address: 0x803BDB10
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$787zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$805zCamSplineCommonMix_cpp */ {
    // Members
...
union /* @class$806zCamSplineCommonMix_cpp */ {
...
// total size: 0xC
struct /* @class$728zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$730zCamSplineCommonMix_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$731zCamSplineCommonMix_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$732zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$733zCamSplineCommonMix_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$734zCamSplineCommonMix_cpp */ {
    // Members
