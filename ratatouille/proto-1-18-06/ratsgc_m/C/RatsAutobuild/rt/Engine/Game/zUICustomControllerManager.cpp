/*
    ...
    Language: C++
    Code range: 0x8018A6E0 -> 0x8018AC74
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char mriIsOnTheLeft; // size: 0x1, address: 0x803BDF20
static int secondPlayerPort; // size: 0x4, address: 0x803BDF24
static int totalPlayers; // size: 0x4, address: 0x803BDF28
static int sysMsgType; // size: 0x4, address: 0x803BDF2C
// Range: 0x8018A6E0 -> 0x8018A6E4
static void zSystemEventCB() {}

class zUICustomControllerManager * pUICustomControllerManager; // size: 0x4, address: 0x803C2090
// total size: 0x50
struct {} zUICustomControllerManager::__vtable; // size: 0x50, address: 0x802DF678
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x8018A730 -> 0x8018A73C
// this: r0
void zUICustomControllerManager::Init() {}

// Range: 0x8018A73C -> 0x8018A740
