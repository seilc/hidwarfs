/*
    ...
    Language: C++
    Code range: 0x8017DE78 -> 0x801804F4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct hit_effect_data hit_effects[3][10]; // size: 0x1E0, address: 0x802DECB0
// total size: 0xC
struct curve_node {
    // Members
...
static struct curve_node splash_curve[3]; // size: 0x24, address: 0x803C71E0
enum texture_mode {
    TM_DEFAULT = 0,
    TM_RANDOM = 1,
    TM_CYCLE = 2,
...
static struct config decal_config[1]; // size: 0x28, address: 0x803BDD68
// total size: 0x7C
...
static struct decal_emitter_data decal_emitters[1]; // size: 0x7C, address: 0x802DEE90
...
static class ParticleSystem * par_emitters[3]; // size: 0xC, address: 0x803C1F18
// total size: 0x4
struct node {
    // Members
    float t; // offset 0x0, size 0x4
...
static struct xResponseCurve proj_curve; // size: 0x10, address: 0x803C1F24
// Range: 0x8017E3D8 -> 0x8017E3DC
...
static struct curve_node proj_decal_curve[3]; // size: 0x54, address: 0x802B1BA8
// Range: 0x8017E3DC -> 0x8017E460
...
static signed char init; // size: 0x1, address: 0x803C1F34
static class SparkParticleSystem sparkSystem; // size: 0x88, address: 0x8038ECD8
static signed char init; // size: 0x1, address: 0x803C1F35
// total size: 0x5C
...
static class RockParticleSystem rockSystem; // size: 0x5C, address: 0x8038ED60
static signed char init; // size: 0x1, address: 0x803C1F36
// total size: 0x5C
...
static class BitsParticleSystem bitsSystem; // size: 0x5C, address: 0x8038EDBC
// Range: 0x8017E674 -> 0x8017E74C
...
static struct xFXRibbon slam_drop_ribbon; // size: 0x10, address: 0x803C1F38
// total size: 0x38
...
static struct spiral_config slam_drop_cfg; // size: 0x38, address: 0x803BDD90
// total size: 0xC
struct spiral_data {
    // Members
...
static struct spiral_data slam_drop_data; // size: 0xC, address: 0x803C1F48
// Range: 0x8017ED94 -> 0x8017ED98
void init_slam_drop_ribbon() {}

// Range: 0x8017ED98 -> 0x8017EDC4
...
static struct xFXRibbon slam_land_ribbon[3]; // size: 0x30, address: 0x803C1F54
static struct spiral_config slam_land_cfg[3]; // size: 0xA8, address: 0x802DEF0C
static struct spiral_data slam_land_data[3]; // size: 0x24, address: 0x803C1F84
// Range: 0x8017EDF4 -> 0x8017EE44
...
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x803BDDC8
// total size: 0xC
struct curve_node {
    // Members
    float time; // offset 0x0, size 0x4
...
static struct config_type cfg; // size: 0x20, address: 0x803C1FA8
...
// Range: 0x8017F160 -> 0x8017F164
void PunchEffect::Init() {}

// Range: 0x8017F164 -> 0x8017F1F0
// this: r26
...
// Range: 0x8017F274 -> 0x8017F284
// this: r0
void PunchEffect::Continue() {}

// Range: 0x8017F284 -> 0x8017F290
// this: r0
...
// Range: 0x8017F750 -> 0x8017F754
void PunchEffect::RenderModels() {}

// Range: 0x8017F754 -> 0x8017F7C8
// this: r28
...
struct {} @unnamed@zCombatEffects_cpp@::RockParticleSystem::__vtable; // size: 0x1C, address: 0x803BDDEC
// Range: 0x8017F7C8 -> 0x8017F7D8
static char * RockParticleSystem::tweak_name() {}

// Range: 0x8017F7D8 -> 0x8017F888
// this: r31
...
// Range: 0x8017FB58 -> 0x8017FB5C
static void RockParticleSystem::add_tweaks() {}

// Range: 0x8017FB5C -> 0x8017FDF0
// this: r28
...
// total size: 0x1C
struct {} zCombatEffects::ParticleSystem::__vtable; // size: 0x1C, address: 0x803BDE08
static // total size: 0x1C
struct {} @unnamed@zCombatEffects_cpp@::BitsParticleSystem::__vtable; // size: 0x1C, address: 0x803BDE24
// Range: 0x8017FDF0 -> 0x8017FE00
static char * BitsParticleSystem::tweak_name() {}

// Range: 0x8017FE00 -> 0x8017FEAC
// this: r31
...
// Range: 0x801801A4 -> 0x801801A8
static void BitsParticleSystem::add_tweaks() {}

// Range: 0x801801A8 -> 0x801804F4
// this: r28
...
// total size: 0x1C
struct {} zCombatEffects::SparkParticleSystem::__vtable; // size: 0x1C, address: 0x803BDE40
