/*
    ...
    Language: C++
    Code range: 0x80112848 -> 0x80114C9C
*/
// total size: 0x4
struct RwRGBA {
    // Members
...
struct xColor_tag warnAuraColor; // size: 0x4, address: 0x803BD130
struct xColor_tag warnLightColor; // size: 0x4, address: 0x803BD134
// Range: 0x80112848 -> 0x8011284C
...
static struct flare_element * flares; // size: 0x4, address: 0x803C14B8
static int flares_used; // size: 0x4, address: 0x803C14BC
// total size: 0x4
struct cone_element {
    // Members
    struct zSpotlight * spotlight; // offset 0x0, size 0x4
};
static struct cone_element * cones; // size: 0x4, address: 0x803C14C0
static int cones_used; // size: 0x4, address: 0x803C14C4
static struct RpAtomic * * light_cone_atomics; // size: 0x4, address: 0x803C14C8
static struct RpAtomic * * aura_cone_atomics; // size: 0x4, address: 0x803C14CC
static int light_cone_atomics_size; // size: 0x4, address: 0x803C14D0
static int aura_cone_atomics_size; // size: 0x4, address: 0x803C14D4
// total size: 0x10
struct cone_attrib {
    // Members
...
// total size: 0x4
struct /* @class$911zSpotlight_cpp */ {
    // Members
    struct xColor_tag color; // offset 0x0, size 0x4
};
// total size: 0x4
struct /* @class$912zSpotlight_cpp */ {
    // Members
    struct xColor_tag color; // offset 0x0, size 0x4
};
// total size: 0x14
struct /* @class$913zSpotlight_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$785zSpotlight_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$807zSpotlight_cpp */ {
    // Members
...
// Range: 0x801130F0 -> 0x80113114
void zSpotlight::scene_enter() {}

// Range: 0x80113114 -> 0x80113118
static void debug_init() {}

// Range: 0x80113118 -> 0x80113194
...
void zSpotlight::setup_all() {
    ...
    struct RpAtomic * * lights; // r0
    struct RpAtomic * * auras; // r0
    int lights_size; // r26
    int auras_size; // r25
...
// total size: 0x10
struct {} zSpotlight::light_volume_type::__vtable; // size: 0x10, address: 0x803BD148
// total size: 0x18
...
// Range: 0x80113A94 -> 0x80113A98
static void debug_render() {}

// Range: 0x80113A98 -> 0x80113ABC
void zSpotlight::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x80113ABC -> 0x80113B24
// this: r31
void zSpotlight::load(const struct zSpotlightAsset & a /* r0 */) {}

// Range: 0x80113B24 -> 0x80113B6C
// this: r31
void zSpotlight::setup() {}

// Range: 0x80113B6C -> 0x80113C40
// this: r31
void zSpotlight::reset() {}

struct xGlobals * xglobals; // size: 0x4, address: 0x803BCC40
unsigned int gThisPlayer; // size: 0x4, address: 0x803BF880
// Range: 0x80113C40 -> 0x80113E94
// this: r30
...
// Range: 0x80113E94 -> 0x80113F0C
// this: r31
void zSpotlight::activate() {}

// Range: 0x80113F0C -> 0x80113F60
// this: r31
void zSpotlight::deactivate() {}

// Range: 0x80113F60 -> 0x80114048
// this: r31
void zSpotlight::reload_asset() {}

// Range: 0x80114048 -> 0x801140B4
// this: r31
...
// Range: 0x80114114 -> 0x8011418C
// this: r31
void zSpotlight::load_textures() {}

// Range: 0x8011418C -> 0x801142D8
// this: r31
...
// Range: 0x801142D8 -> 0x801143E8
// this: r30
void zSpotlight::add_flare() {
    // Local variables
    struct flare_element * flare; // r31
    float mag; // f4
    float size0; // f2
    float glow0; // f2
...
// Range: 0x8011447C -> 0x8011477C
// this: r31
void zSpotlight::render_aura() {
    // Local variables
    struct xColor_tag color; // r1+0x1C
    struct xColor_tag warnColor; // r1+0x18
    enum RwBlendFunction old_src_blend; // r1+0x14
    enum RwBlendFunction old_dst_blend; // r1+0x10
...
// Range: 0x8011477C -> 0x801147DC
// this: r3
void zSpotlight::dispatch(unsigned int event /* r0 */) {}

// Range: 0x801147DC -> 0x80114808
void zSpotlight::cb_dispatch(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int event /* r0 */, const float * argf /* r0 */, struct xBase * argw /* r0 */, unsigned int argwi /* r0 */) {}
...
struct tagiRenderArrays gRenderArr; // size: 0x6D80, address: 0x8037F790
// Range: 0x80114808 -> 0x80114B0C
void zSpotlight::render_flares() {
    // Local variables
    struct RxObjSpace3DVertex * vert_buffer; // r31
    struct RxObjSpace3DVertex * vert; // r30
    struct RxObjSpace3DVertex * end_vert; // r29
    struct RwRaster * raster; // r28
    struct flare_element * flare; // r27
    struct flare_element * end_flare; // r26
...
// Range: 0x80114BA8 -> 0x80114BD0
static void flush_textured_strip(struct RxObjSpace3DVertex * verts /* r0 */, int size /* r0 */) {}
...
// total size: 0x10
struct {} xLightVolume::__vtable; // size: 0x10, address: 0x803BD138
// Range: 0x80114C38 -> 0x80114C9C
// this: r31
