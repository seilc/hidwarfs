/*
    ...
    Language: C++
    Code range: 0x80158738 -> 0x80158AC0
*/
static unsigned int sceneCheckPointTotal; // size: 0x4, address: 0x803C1B50
static unsigned int sceneCheckPointHit; // size: 0x4, address: 0x803C1B54
// Range: 0x80158738 -> 0x80158740
void zUIIncrediblesSetSceneCheckPointHit(unsigned int value /* r0 */) {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80158740 -> 0x80158748
unsigned int zUIIncrediblesGetSceneCheckPointHit() {
    // References
    // -> static unsigned int sceneCheckPointHit;
}

// Range: 0x80158748 -> 0x80158750
...
// total size: 0x50
struct {} zUICustomCheckpoints::__vtable; // size: 0x50, address: 0x802DC3C8
// total size: 0x34
struct RwRaster {
    // Members
