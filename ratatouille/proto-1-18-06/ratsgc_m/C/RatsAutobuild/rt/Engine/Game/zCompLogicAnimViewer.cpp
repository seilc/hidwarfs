/*
    ...
    Language: C++
    Code range: 0x801BDBF4 -> 0x801BEF24
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int mNeedTweaks; // size: 0x4, address: 0x803BEDE8
unsigned char mActionPressed; // size: 0x1, address: 0x803C26E8
unsigned char mIsActive; // size: 0x1, address: 0x803C26E9
unsigned int mAutoAction; // size: 0x4, address: 0x803C26EC
static class zCompLogicAnimViewer * viewer; // size: 0x4, address: 0x803C26F0
// total size: 0x20
...
static class AnimFrameStepper sAnimFrameStepper; // size: 0x20, address: 0x803C26F4
static char * stateNames[8]; // size: 0x20, address: 0x803BEDEC
// total size: 0x508
...
// Range: 0x801BDC64 -> 0x801BDCC0
// this: r30
void StateConfig::Init(const char * name /* r31 */) {}

// Range: 0x801BDCC0 -> 0x801BDCC8
// this: r3
int AnimViewerStates::NumStates() const {}

// Range: 0x801BDCC8 -> 0x801BDCDC
// this: r0
...
class AnimViewerStates sAnimViewerStates; // size: 0x508, address: 0x80395C40
// total size: 0xD0
class AnimSequence {
    // Functions
...
// Range: 0x801BE2A8 -> 0x801BE2CC
static int tolower(char c /* r3 */) {}

// Range: 0x801BE2CC -> 0x801BE2D8
...
static class AnimSequence sAnimSequence; // size: 0xD0, address: 0x80396148
float MAX_DISTANCE; // size: 0x4, address: 0x803C7F00
float MIN_DISTANCE; // size: 0x4, address: 0x803C7F04
float START_DISTANCE; // size: 0x4, address: 0x803C7F08
float START_PITCH; // size: 0x4, address: 0x803C7F0C
float SPEED_PITCH; // size: 0x4, address: 0x803C7F10
float SPEED_YAW; // size: 0x4, address: 0x803C7F14
float SPEED_DISTANCE; // size: 0x4, address: 0x803C7F18
// total size: 0x140
...
static class zAnimViewerCamera sAnimViewerCamera; // size: 0x140, address: 0x80396220
// total size: 0x3C
struct {} zCompLogicAnimViewer::__vtable; // size: 0x3C, address: 0x803BEE0C
// total size: 0x18
...
// Range: 0x801BEA34 -> 0x801BEA38
void AnimSequence::Update() {}

// Range: 0x801BEA38 -> 0x801BEA8C
// this: r31
float AnimFrameStepper::Update() {}

// Range: 0x801BEA8C -> 0x801BEABC
// this: r0
void AnimFrameStepper::AdvanceByTime(float dt /* f0 */) {}

// Range: 0x801BEABC -> 0x801BEAF0
// this: r31
struct Step & AnimSequence::NextStep() {}

// Range: 0x801BEAF0 -> 0x801BEB2C
// this: r3
int AnimSequence::NextIndex() {}

// Range: 0x801BEB2C -> 0x801BEB88
// this: r31
void AnimSequence::Advance() {}

// Range: 0x801BEB88 -> 0x801BECF0
// this: r31
...
// total size: 0x40
struct {} zAnimViewerCamera::__vtable; // size: 0x40, address: 0x803BEE48
// Range: 0x801BECF4 -> 0x801BEE50
// this: r31
