/*
    ...
    Language: C++
    Code range: 0x80145B74 -> 0x8014611C
*/
static int sAnimCustomCount; // size: 0x4, address: 0x803C1978
static int sMaxTempTransCount; // size: 0x4, address: 0x803C197C
// total size: 0xC
struct RwV3d {
    // Members
...
static struct zAnimCustomFile * sAnimCustomList; // size: 0x4, address: 0x803C1980
static struct zAnimCustomFile * sAnimCustomEndOfList; // size: 0x4, address: 0x803C1984
// total size: 0x1C
struct xMemPool {
    // Members
...
static struct xMemPool szAnimCustomTempTranListPool; // size: 0x1C, address: 0x803C1988
static struct xAnimTransitionList * * zAnimCustomActiveTempTrans; // size: 0x4, address: 0x803C19A4
static int sLastIndex; // size: 0x4, address: 0x803C19A8
static char * sCustomStateName; // size: 0x4, address: 0x803BD608
enum xSndHandle {
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$785zAnimCustom_cpp */ {
    // Members
...
static struct xAnimState sDummyState; // size: 0x4C, address: 0x80388098
// total size: 0x2C
...
static struct xAnimTransition sDummyTran; // size: 0x2C, address: 0x803C19AC
// total size: 0x8
...
static struct xAnimTransitionList sDummyList; // size: 0x8, address: 0x803C19D8
// Range: 0x80145B74 -> 0x80145B84
static unsigned int TempTransCB(struct xAnimTransition * tran /* r0 */) {}

unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
// Range: 0x80145B84 -> 0x80145C9C
...
// Range: 0x80145CCC -> 0x80145D00
static void ClearActiveArray() {
    // References
    // -> static int sLastIndex;
}

// Range: 0x80145D00 -> 0x80145D64
static void DeleteFromActiveArray(int index /* r0 */) {
    // References
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
    // -> static struct xMemPool szAnimCustomTempTranListPool;
...
// Range: 0x80145D64 -> 0x80145D84
void zAnimCustomReset() {}

// Range: 0x80145D84 -> 0x80145E1C
...
// Range: 0x80146098 -> 0x801460B4
static void AddToActiveArray(struct xAnimTransitionList * l /* r0 */) {
    // References
    // -> static int sLastIndex;
    // -> static struct xAnimTransitionList * * zAnimCustomActiveTempTrans;
}

// Range: 0x801460B4 -> 0x8014611C
