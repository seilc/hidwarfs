/*
    ...
    Language: C++
    Code range: 0x8013BCDC -> 0x8013BCDC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$785zShowerSystem_cpp */ {
    // Members
...
union /* @class$823zShowerSystem_cpp */ {
...
// total size: 0xC
struct /* @class$822zShowerSystem_cpp */ {
    // Members
...
struct ConfigType {
    ...
    const struct xCameraFXShakeParams * cameraShakeParams; // offset 0x4, size 0x4
...
class zShowerSystem : public zLightweightSystemBase {
    // Members
protected:
    const struct ConfigType * config; // offset 0x4, size 0x4
