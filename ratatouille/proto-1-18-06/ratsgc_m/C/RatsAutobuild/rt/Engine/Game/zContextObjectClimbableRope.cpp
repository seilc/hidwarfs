/*
    ...
    Language: C++
    Code range: 0x801885FC -> 0x80189820
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xVec3 GRAB_POINT_UP; // size: 0xC, address: 0x803C7420
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$816zContextObjectClimbableRope_cpp */ {
    // Members
...
union /* @class$835zContextObjectClimbableRope_cpp */ {
...
// total size: 0xC
struct /* @class$834zContextObjectClimbableRope_cpp */ {
    // Members
...
// Range: 0x801890D8 -> 0x801891CC
void zContextObjectClimbableRope::RenderAll() {
    // Local variables
    unsigned int count; // r25
    class zContextObjectClimbableRope * ropeList; // r24
    unsigned char * rendered; // r23
    unsigned int i; // r22
    unsigned int j; // r21
...
// total size: 0x14
struct {} zContextObjectClimbableRope::__vtable; // size: 0x14, address: 0x803BDF08
struct xVec3 m_UnitAxisY; // size: 0xC, address: 0x803C423C
// Range: 0x801891CC -> 0x8018925C
// this: r30
...
// Range: 0x8018925C -> 0x801892A0
void zContextObjectClimbableRope::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}
...
// Range: 0x801893B4 -> 0x801893EC
// this: r3
struct xVec3 & zContextObjectClimbableRope::GetPos() const {}

// Range: 0x801893EC -> 0x80189540
// this: r29
...
// total size: 0x4
struct /* @class$891zContextObjectClimbableRope_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$892zContextObjectClimbableRope_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1206zContextObjectClimbableRope_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1205zContextObjectClimbableRope_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1208zContextObjectClimbableRope_cpp */ {
    // Members
...
struct xColor_tag g_PINK; // size: 0x4, address: 0x803C3334
// Range: 0x80189540 -> 0x80189718
// this: r27
...
// Range: 0x80189718 -> 0x80189788
// this: r31
void zContextObjectClimbableRope::Reset() {}

// Range: 0x80189788 -> 0x801897D4
// this: r29
