/*
    ...
    Language: C++
    Code range: 0x8013D060 -> 0x8013D5BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
float sFarWall; // size: 0x4, address: 0x803BD5D4
unsigned char sEnabled; // size: 0x1, address: 0x803BD5D8
unsigned char sDebugRender; // size: 0x1, address: 0x803C1970
unsigned char sCameraDisable; // size: 0x1, address: 0x803C1971
unsigned int sDrawnFrame; // size: 0x4, address: 0x803C1974
// total size: 0x1
...
// total size: 0x4
struct /* @class$789zPlayerConstrainer_cpp */ {
    // Members
...
union /* @class$654zPlayerConstrainer_cpp */ {
...
// total size: 0xC
struct /* @class$809zPlayerConstrainer_cpp */ {
    // Members
...
// Range: 0x8013D404 -> 0x8013D5BC
unsigned int zPlayerConstrainer::PositionOOB(struct OOBExtent & extent /* r27 */, const struct xMat4x3 & camMat /* r28 */, float fov /* f30 */, const struct xVec3 & position /* r29 */, unsigned int calcFlags /* r30 */) {
    // Local variables
    struct xVec3 to; // r1+0x2C
    unsigned int flags; // r31
    struct xVec3 atNormalizedXZ; // r1+0x20
    float adjustedFarWall; // f31
    float dist2; // f0
    float perpDistance; // f0
    struct xVec3 nLeftPlane; // r1+0x14
    struct xVec3 nRightPlane; // r1+0x8
