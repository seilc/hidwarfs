/*
    ...
    Language: C++
    Code range: 0x8014BEB4 -> 0x8014C1BC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zScreenWarp * sWarpList; // size: 0x4, address: 0x803C1A38
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x8014BF50 -> 0x8014BFAC
void zScreenWarp::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r31 */) {
    // Local variables
...
// Range: 0x8014BFAC -> 0x8014BFE8
// this: r0
void zScreenWarp::Reset() {}

// Range: 0x8014BFE8 -> 0x8014C010
// this: r0
void zScreenWarp::Enable(unsigned char bEnable /* r0 */) {}

// Range: 0x8014C010 -> 0x8014C0A8
// this: r31
...
// total size: 0x4
struct /* @class$805zScreenWarp_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$825zScreenWarp_cpp */ {
    // Members
...
union /* @class$753zScreenWarp_cpp */ {
...
// Range: 0x8014C148 -> 0x8014C1BC
void zScreenWarp::EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
    class zScreenWarp * sw; // r4
}
