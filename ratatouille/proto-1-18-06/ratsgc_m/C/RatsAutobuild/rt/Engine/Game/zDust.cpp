/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zDust.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80111D28 -> 0x8011260C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int texture_rows; // size: 0x4, address: 0x803BD128
static int texture_columns; // size: 0x4, address: 0x803BD12C
// Range: 0x80111D28 -> 0x80111D2C
static void add_tweaks() {}

static int dirt_system_id; // size: 0x4, address: 0x803C1498
static float ring_vel_decay; // size: 0x4, address: 0x803C149C
static struct xVec2 * dirt_uvs; // size: 0x4, address: 0x803C14A0
static unsigned char refreshed_ring_chains; // size: 0x1, address: 0x803C14A4
static float ring_chain_ang[2]; // size: 0x8, address: 0x803C14A8
// Range: 0x80111D2C -> 0x80111E48
...
// Range: 0x80111E48 -> 0x80111F18
static void create_dirt_system() {
    // Local variables
    int uvpairs; // r31
    struct RwTexture * dirt_texture; // r0
...
// Range: 0x80111F18 -> 0x801121B4
static int update_dust_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f28 */) {
    // Local variables
...
// Range: 0x801121B4 -> 0x80112470
static int update_dust_particles_uv2(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f28 */) {
    // Local variables
...
// Range: 0x80112500 -> 0x8011252C
void zDustSceneEnter() {}

// Range: 0x8011252C -> 0x80112550
void zDustReset() {}

// Range: 0x80112550 -> 0x80112570
void zDustUpdate(float dt /* f0 */) {}

// Range: 0x80112570 -> 0x8011257C
void zDustRender() {
    // References
    // -> static unsigned char refreshed_ring_chains;
}

int activities_used; // size: 0x4, address: 0x803C14B0
// total size: 0x18
struct activity_data {
    // Members
...
struct activity_data * activities; // size: 0x4, address: 0x803C14B4
// total size: 0x14
struct config_type {
    // Members
...
// total size: 0x1
struct /* @class$730zDust_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zDust_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zDust_cpp */ {
    // Members
...
// Range: 0x801125E0 -> 0x8011260C
void zDustRingEmitter::update_all(float dt /* f1 */) {
    // References
    // -> static float ring_vel_decay;
}
