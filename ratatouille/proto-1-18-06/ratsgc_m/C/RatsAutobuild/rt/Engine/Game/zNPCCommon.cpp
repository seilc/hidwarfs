/*
    ...
    Language: C++
    Code range: 0x8016E84C -> 0x80173D68
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwTexture * whiteTex; // size: 0x4, address: 0x803C1D30
static float FREEZING_MUL_R; // size: 0x4, address: 0x803BDB70
static float FREEZING_MUL_G; // size: 0x4, address: 0x803BDB74
static float FREEZING_MUL_B; // size: 0x4, address: 0x803BDB78
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$794zNPCCommon_cpp */ {
    // Members
...
static int sNPCHitPoints[3][2]; // size: 0x18, address: 0x803BDB7C
enum ezHitReaction hitReactionTable[3][2][65]; // size: 0x618, address: 0x802DD460
// total size: 0x60
...
class zNPCCommonPlayTaunt : public zBehaviorImplementation {
    // Members
public:
    float playTimer; // offset 0x2C, size 0x4
};
// total size: 0x0
class zNPCCustomAV {};
// total size: 0x58
class zNPCCommonPlayCustomTransient : public zNPCMove {
    // Members
public:
    class zNPCCustomAV * customAV; // offset 0x50, size 0x4
    int exitOntoNavmesh; // offset 0x54, size 0x4
};
// total size: 0x2C
...
class zNPCCommonInterestingIdle : public zNPCMove {
    // Members
protected:
    unsigned char firstUpdate; // offset 0x50, size 0x1
    unsigned char arrivedAtInterestPointer; // offset 0x51, size 0x1
    unsigned int idleAnimID; // offset 0x54, size 0x4
    unsigned int movementAnimID; // offset 0x58, size 0x4
    float timeInIdle; // offset 0x5C, size 0x4
    float timeElapsedInIdle; // offset 0x60, size 0x4
    class zNPCInterestPointer * interestPointer; // offset 0x64, size 0x4
};
// total size: 0x4
struct /* @class$1230zNPCCommon_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1294zNPCCommon_cpp */ {
    // Members
...
static struct zSparkEmitterAsset sNPCCommonDestroyShieldGeneratorSparks; // size: 0x94, address: 0x8038EBA8
// Range: 0x8016EAAC -> 0x8016EAF4
static void bupdate_wrapper(struct xEnt * ent /* r31 */) {}

// Range: 0x8016EAF4 -> 0x8016EB6C
...
// total size: 0x1C8
struct {} zNPC::zNPCCommon::__vtable; // size: 0x1C8, address: 0x802DDC88
// Range: 0x8016EBCC -> 0x8016EC40
// this: r31
...
// total size: 0x74
struct {} zNPC::zNPCBaseIN2::__vtable; // size: 0x74, address: 0x802DDE50
// total size: 0x8
...
// Range: 0x8016EFAC -> 0x8016EFCC
// this: r3
struct xEnt * zNPCCommon::GetAttackingPlayerEnt() {}

// Range: 0x8016EFCC -> 0x8016EFD8
// this: r0
...
// total size: 0xC
struct /* @class$812zNPCCommon_cpp */ {
    // Members
...
void zNPCCommon::CheckForDrivable() {
    ...
    int i; // r28
    struct xEnt * floorEntity; // r27
    struct xCollis * collisionRec; // r26
    enum _xCollsIdx collsIndex; // r0
    struct xEnt * driver; // r26
...
struct zCheats gCheats; // size: 0x2, address: 0x803C0418
// Range: 0x8016F84C -> 0x8016FE68
// this: r31
...
// Range: 0x801700D0 -> 0x80170190
// this: r0
unsigned char zNPCCommon::valid_damage(const struct zCombatDamageInfo & damageInfo /* r0 */) {}

// Range: 0x80170190 -> 0x801702B4
// this: r30
...
struct xSerial {};
// total size: 0x4
struct /* @class$1197zNPCCommon_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zNPCCommon_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1199zNPCCommon_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1196zNPCCommon_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1201zNPCCommon_cpp */ {
    // Members
...
// Range: 0x801702B4 -> 0x801702B8
void zNPCCommon::PlayDamageSound() {}

// Range: 0x801702B8 -> 0x8017034C
// this: r30
...
float zNPCFreezeTimeTable[3][2]; // size: 0x18, address: 0x803C0BF4
// Range: 0x8017093C -> 0x801709E4
// this: r29
void zNPCCommon::SetDefaultLightKit() {
    // Local variables
    const struct zNPCAssetIN2 * npcAsset; // r0
    struct xLightKit * lightKit; // r4
    struct xEnvAsset * easset; // r30

    // References
    // -> struct zGlobals globals;
}

// Range: 0x801709E4 -> 0x80170A10
// this: r0
void zNPCCommon::revive() {}

struct xGrid npcs_grid; // size: 0x38, address: 0x803C0980
// Range: 0x80170A10 -> 0x80170B44
// this: r29
...
// Range: 0x80170CC4 -> 0x80170D3C
// this: r31
void zNPCCommon::deactivate_visible() {}

// Range: 0x80170D3C -> 0x80170D58
// this: r0
void zNPCCommon::imminent_death() {}

// Range: 0x80170D58 -> 0x80170E3C
// this: r31
void zNPCCommon::kill() {}

// Range: 0x80170E3C -> 0x80170E6C
// this: r3
...
float gSceneUpdateTime; // size: 0x4, address: 0x803C0CDC
struct xVec3 g_X3; // size: 0xC, address: 0x803C3B24
// Range: 0x801710FC -> 0x801714D4
// this: r31
...
// Range: 0x801718BC -> 0x8017190C
// this: r31
void zNPCCommon::render_extra() {}

// Range: 0x8017190C -> 0x80171968
// this: r3
void zNPCCommon::post_render_cleanup() {}

// Range: 0x80171968 -> 0x8017196C
void zNPCCommon::debug_render() {}

// Range: 0x8017196C -> 0x80171994
// this: r3
...
class move : public zBehaviorImplementation {
    // Members
protected:
    float turn_speed; // offset 0x2C, size 0x4
    float move_speed; // offset 0x30, size 0x4
    float min_speed; // offset 0x34, size 0x4
    float acceleration; // offset 0x38, size 0x4
    float speed; // offset 0x3C, size 0x4
};
// total size: 0x50
class zNPCMove : public move {
    // Members
    struct xVec3 last_destination; // offset 0x40, size 0xC
    float cos_min_move_angle; // offset 0x4C, size 0x4
};
// total size: 0x28
...
class zNPCCommonMoveToTransient : public zNPCMove {
    // Members
protected:
    int movingState; // offset 0x50, size 0x4
    float closeEnoughToTargetDist; // offset 0x54, size 0x4
};
// Range: 0x80171DEC -> 0x80171E4C
void zNPCCommon::GetPosFromBase(struct xBase * inBase /* r4 */, struct xVec3 * outPos /* r31 */) {}

// Range: 0x80171E4C -> 0x8017212C
// this: r31
...
// Range: 0x80172830 -> 0x801729B8
// this: r31
void zNPCCommon::update_bounds() {}

// Range: 0x801729B8 -> 0x80172A44
// this: r0
struct xVec3 zNPCCommon::get_bone_world_position(int bone /* r0 */) {
    // Local variables
    struct xVec3 position; // r1+0x8
}

// Range: 0x80172A44 -> 0x80172AA0
// this: r0
...
// Range: 0x80172DBC -> 0x80172DC4
unsigned int zNPCCommon::GetNPCIceType() {}

// Range: 0x80172DC4 -> 0x80172DCC
float zNPCCommon::WeaponGetMaxRange() {}

// Range: 0x80172DCC -> 0x80172DD4
unsigned char zNPCCommon::HasRangeWeapon() {}

// Range: 0x80172DD4 -> 0x80172DD8
void init_system() {}

// Range: 0x80172DD8 -> 0x80172E30
// this: r31
...
// Range: 0x80172E30 -> 0x80172F44
// this: r31
unsigned char zNPCCommon::Freeze(float intensity /* f31 */) {
    // Local variables
    class behavior * cur; // r0
}

// Range: 0x80172F44 -> 0x80173048
// this: r30
...
// Range: 0x80173048 -> 0x80173108
// this: r30
void zNPCCommon::PastUpdateDistCleanup() {}

// Range: 0x80173108 -> 0x801731FC
// this: r30
void zNPCCommon::VisibilityCullCleanup() {}

// Range: 0x801731FC -> 0x80173238
// this: r31
void zNPCCommon::SetRandomAnimSpeed(float inMin /* f0 */, float inMax /* f0 */) {
    // Local variables
    float newSpeed; // f0
}

// Range: 0x80173238 -> 0x801732AC
// this: r31
void zNPCCommon::SetRandomAnimTime(float inMin /* f0 */, float inMax /* f0 */) {
    // Local variables
    float newTime; // f1
}

// Range: 0x801732AC -> 0x801732FC
// this: r31
void zNPCCommon::SetRandomAnimSpeedAndTime(float inMin /* f0 */, float inMax /* f0 */) {}

// Range: 0x801732FC -> 0x80173338
// this: r0
void zNPCCommon::SetRandomAnimTime() {}

// Range: 0x80173338 -> 0x801734F8
// this: r31
...
class zBehaviorImplementation : public behavior {
    // Members
protected:
    class zNPCCommon * owner; // offset 0x28, size 0x4
};
// total size: 0x0
...
unsigned int FB_XRES; // size: 0x4, address: 0x803BCC34
unsigned int FB_YRES; // size: 0x4, address: 0x803BCC38
// total size: 0x24
struct xRay3 {
    // Members
    struct xVec3 origin; // offset 0x0, size 0xC
...
// total size: 0x108
struct {} zNPC::npc_nuke::__vtable; // size: 0x108, address: 0x802DDA78
// total size: 0x30
class npc_nuke : public zBehaviorImplementation {
    // Members
public:
    float nukeTimer; // offset 0x2C, size 0x4
};
// total size: 0x108
struct {} zBehaviorImplementation<zNPC::zNPCCommon>::__vtable; // size: 0x108, address: 0x802DDB80
float zNPCThawTimeTable[3][2]; // size: 0x18, address: 0x803C0C0C
// total size: 0x0
