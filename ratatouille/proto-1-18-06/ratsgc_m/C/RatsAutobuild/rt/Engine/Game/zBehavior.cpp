/*
    ...
    Language: C++
    Code range: 0x800F7480 -> 0x800F983C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x800F7480 -> 0x800F7488
unsigned int ErrorCB() {}

// total size: 0x64
struct {} zBehaviorManager::__vtable; // size: 0x64, address: 0x802DAE9C
// total size: 0x14
...
// Range: 0x800F7538 -> 0x800F7580
// this: r31
void zBehaviorManager::createTransientStack(int inMax /* r4 */) {
    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x800F7580 -> 0x800F7660
// this: r23
unsigned char zBehaviorManager::systemEvent(struct xBase * from /* r24 */, struct xBase * to /* r25 */, unsigned int to_event /* r26 */, const float * to_param /* r27 */, struct xBase * to_param_widget /* r28 */, unsigned int to_param_widget_id /* r29 */) {
    // Local variables
...
// total size: 0xC
struct /* @class$1292zBehavior_cpp */ {
    // Members
...
class behavior {
    ...
    void addTest(class behavior * destBehavior, unsigned char (* inTestFunc)(struct xEnt *, class behavior *, class behavior *), float waitTime);
...
// total size: 0x4
struct /* @class$1283zBehavior_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1250zBehavior_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1251zBehavior_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1252zBehavior_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1249zBehavior_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1254zBehavior_cpp */ {
    // Members
...
// Range: 0x800F869C -> 0x800F8704
// this: r31
unsigned char zBehaviorManager::testForCompleteChange() {}

// Range: 0x800F8704 -> 0x800F8784
// this: r0
void zBehaviorManager::preupdate() {
    // Local variables
    class behavior * transient; // r3
    class zNPCCommon * npc; // r0
    class zNPCCommon * npc; // r0
}

// Range: 0x800F8784 -> 0x800F8878
// this: r30
...
// Range: 0x800F8A3C -> 0x800F8A6C
// this: r0
void zBehaviorManager::preRender() {}

// Range: 0x800F8A6C -> 0x800F8A9C
// this: r0
void zBehaviorManager::render() {}

// Range: 0x800F8A9C -> 0x800F8B94
// this: r29
void zBehaviorManager::reset() {
    // Local variables
    unsigned short beforeFlags; // r31
    struct behavior_node * node; // r30
}

// Range: 0x800F8B94 -> 0x800F8BE4
// this: r31
...
// Range: 0x800F8D70 -> 0x800F8E2C
// this: r0
unsigned char behavior::inAnimState(unsigned int stateID /* r0 */, float look_ahead /* f0 */, struct xModelInstance * model /* r5 */) const {
    // Local variables
    struct xAnimState * astate; // r5
}

// Range: 0x800F8E2C -> 0x800F8E7C
// this: r30
unsigned char behavior::isAnimStateStopped(const char * state /* r4 */, struct xModelInstance * model /* r31 */) const {}

// Range: 0x800F8E7C -> 0x800F8F04
// this: r0
...
// Range: 0x800F8F04 -> 0x800F8F2C
// this: r0
float behavior::getAnimDuration() {}

// Range: 0x800F8F2C -> 0x800F8F44
// this: r0
float behavior::getAnimTime() {}

// Range: 0x800F8F44 -> 0x800F8FE8
// this: r0
...
// Range: 0x800F91EC -> 0x800F9278
// this: r29
void behavior::addTest(class behavior * destBehavior /* r30 */, unsigned char (* inTestFunc)(struct xEnt *, class behavior *, class behavior *) /* r31 */, float waitTime /* f31 */) {
    // Local variables
    struct testNode * append_node; // r0
    struct testNode * node; // r4

    // References
    // -> unsigned int gActiveHeap;
}

// Range: 0x800F9278 -> 0x800F92B4
// this: r0
...
// total size: 0x104
struct {} behavior::__vtable; // size: 0x104, address: 0x802DAD98
// Range: 0x800F950C -> 0x800F9528
// this: r0
behavior::behavior() {
    // References
...
// Range: 0x800F9528 -> 0x800F9534
// this: r0
unsigned char behavior::isAttackState() {}

// Range: 0x800F9534 -> 0x800F9624
// this: r30
void zBehaviorManager::PushTransient(class behavior * pushTransient /* r31 */, struct zTransientNodeData * initData /* r28 */) {
    // Local variables
    class behavior * prevBehavior; // r29
    struct zTransientNodeData * contextData; // r28
}

// Range: 0x800F9624 -> 0x800F9728
// this: r29
void zBehaviorManager::PopTransient() {
    // Local variables
    class behavior * poppedTransient; // r31
    struct zTransientNode * tnode; // r3
    class behavior * nextTransient; // r30
}

// Range: 0x800F9728 -> 0x800F983C
// this: r31
