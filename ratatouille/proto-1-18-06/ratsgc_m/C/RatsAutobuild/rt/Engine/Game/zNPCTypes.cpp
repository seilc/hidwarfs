/*
    ...
    Language: C++
    Code range: 0x80175528 -> 0x80175F98
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zNPCTypesTable gNPCTypesTable[17]; // size: 0x4C8, address: 0x802DE540
enum eCompType {
    eCompType_Unknown = -1,
...
static unsigned char gNPCTypesTableInitialized; // size: 0x1, address: 0x803C1D38
// Range: 0x80175528 -> 0x80175534
...
// Range: 0x80175620 -> 0x80175628
unsigned char ValidateNPCAsset() {}

// Range: 0x80175628 -> 0x80175630
unsigned char ValidateNPCAsset() {}

// Range: 0x80175630 -> 0x80175638
unsigned char ValidateNPCAsset() {}

// Range: 0x80175638 -> 0x80175640
unsigned char ValidateNPCAsset() {}

// Range: 0x80175640 -> 0x80175648
unsigned char ValidateNPCAsset() {}

// Range: 0x80175648 -> 0x80175650
unsigned char ValidateNPCAsset() {}

// Range: 0x80175650 -> 0x80175658
unsigned char ValidateNPCAsset() {}

// Range: 0x80175658 -> 0x80175660
unsigned char ValidateNPCAsset() {}

// Range: 0x80175660 -> 0x80175668
unsigned char ValidateNPCAsset() {}

// Range: 0x80175668 -> 0x80175670
unsigned char ValidateNPCAsset() {}

// Range: 0x80175670 -> 0x80175678
unsigned char ValidateNPCAsset() {}

// Range: 0x80175678 -> 0x80175680
unsigned char ValidateNPCAsset() {}

// Range: 0x80175680 -> 0x80175688
unsigned char ValidateNPCAsset() {}

// Range: 0x80175688 -> 0x80175690
unsigned char ValidateNPCAsset() {}

// Range: 0x80175690 -> 0x80175698
unsigned char ValidateNPCAsset() {}

// Range: 0x80175698 -> 0x801756F0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175728 -> 0x80175780
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x801757B8 -> 0x80175810
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175848 -> 0x801758A0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x801758D8 -> 0x80175930
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175968 -> 0x801759C0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x801759F8 -> 0x80175A50
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175A88 -> 0x80175AE0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175B18 -> 0x80175B70
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175BA8 -> 0x80175C00
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175C38 -> 0x80175C90
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175CC8 -> 0x80175D20
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175D58 -> 0x80175DB0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175DE8 -> 0x80175E40
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175E78 -> 0x80175ED0
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}

// Range: 0x80175F08 -> 0x80175F60
class zNPCBase * zNPCTypes_AllocateNPC(int numberOfNPCs /* r3 */) {}
