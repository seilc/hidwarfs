/*
    ...
    Language: C++
    Code range: 0x8019FBA4 -> 0x8019FE78
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char parallel; // size: 0x1, address: 0x803C21B0
// total size: 0x8
struct xBaseAsset {
    // Members
...
static struct PlayerCreationData playerCreationTable[3]; // size: 0x18, address: 0x803BE2B8
static signed char init; // size: 0x1, address: 0x803C21B1
// total size: 0xC
...
static class zMiniGameManager mgr; // size: 0xC, address: 0x803C21B4
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x8019FD4C -> 0x8019FDA4
// this: r31
void zMiniGameManager::Update(float dt /* f31 */) {}

// Range: 0x8019FDA4 -> 0x8019FDEC
// this: r31
void zMiniGameManager::Render() {}

// Range: 0x8019FDEC -> 0x8019FDF0
void zMiniGameManager::PostRender2d() {}

// Range: 0x8019FDF0 -> 0x8019FDF4
void zMiniGameManager::PostRender3d() {}

// Range: 0x8019FDF4 -> 0x8019FE20
void zMiniGameManager::Exit() {
    // References
    // -> struct zGlobals globals;
}

static unsigned int sMiniGameSceneMap[8][4]; // size: 0x80, address: 0x802E03F0
// total size: 0xC
...
// total size: 0x24
struct {} zMiniGameManager::__vtable; // size: 0x24, address: 0x803BE2D0
// total size: 0x4
