/*
    ...
    Language: C++
    Code range: 0x8014BC90 -> 0x8014BEB4
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
static struct zGooParams * zgoo_gps; // size: 0x4, address: 0x803C1A28
static int zgoo_ngps; // size: 0x4, address: 0x803C1A2C
static int zgoo_nused; // size: 0x4, address: 0x803C1A30
unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
// Range: 0x8014BC90 -> 0x8014BCD0
