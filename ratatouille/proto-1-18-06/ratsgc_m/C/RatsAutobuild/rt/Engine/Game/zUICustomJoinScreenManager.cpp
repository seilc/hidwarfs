/*
    ...
    Language: C++
    Code range: 0x8014C89C -> 0x8014CBA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8014C89C -> 0x8014C8A0
static void zSystemEventCB() {}

static unsigned char bJoinDropActionConfirmed; // size: 0x1, address: 0x803C1A4C
// total size: 0x50
struct {} zUICustomJoinScreenManager::__vtable; // size: 0x50, address: 0x802DC088
// total size: 0x14
...
// total size: 0x2
struct /* @class$1108zUICustomJoinScreenManager_cpp */ {
    // Members
...
// Range: 0x8014C8EC -> 0x8014CB28
// this: r31
unsigned char zUICustomJoinScreenManager::HandleEvent(struct xBase * from /* r30 */, unsigned int toEvent /* r0 */) {
    // Local variables
    int port; // r31
