/*
    ...
    Language: C++
    Code range: 0x801A06B0 -> 0x801A3698
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char curveCmds[1][16]; // size: 0x10, address: 0x803BE338
static char actionCmds[3][16]; // size: 0x30, address: 0x803BE348
static char minigameCmds[1][16]; // size: 0x10, address: 0x803BE378
// total size: 0x8
struct /* @class$1029zMiniME_cpp */ {
    // Members
...
struct /* @class$1029zMiniME_cpp */ {
    ...
    char * string; // offset 0x0, size 0x4
    unsigned int value; // offset 0x4, size 0x4
} inputData[9]; // size: 0x48, address: 0x802E0598
// total size: 0x4
struct node {
    // Members
...
// total size: 0x1
struct /* @class$782zMiniME_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$783zMiniME_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$784zMiniME_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$785zMiniME_cpp */ {
    // Members
...
static struct xResponseCurve alphaCurve; // size: 0x10, address: 0x803C2248
// total size: 0x8
struct /* @class$1039zMiniME_cpp */ {
    // Members
...
struct /* @class$1039zMiniME_cpp */ {
    ...
    unsigned int hash; // offset 0x0, size 0x4
    unsigned int event; // offset 0x4, size 0x4
} eventData[1067]; // size: 0x2158, address: 0x802E05E0
// total size: 0x8
struct curve_node {
    // Members
    float t; // offset 0x0, size 0x4
...
static class zMiniME singleMM; // size: 0x41CC, address: 0x8038F6C8
// Range: 0x801A06B0 -> 0x801A06BC
class zMiniME & zMiniME::GetMgr() {
    // References
    // -> static class zMiniME singleMM;
}

// Range: 0x801A06BC -> 0x801A06DC
void zMiniME::Init() {}

// total size: 0x8
struct /* @class$1054zMiniME_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct /* @class$1054zMiniME_cpp */ {
    ...
    float t; // offset 0x0, size 0x4
    float a; // offset 0x4, size 0x4
} alphas[4]; // size: 0x20, address: 0x803C78B8
enum xCamCoordType {
...
// Range: 0x801A06DC -> 0x801A07D4
void zMiniME::SceneEnter(struct zScene * zsc /* r30 */) {
    // Local variables
    class zMiniME & mgr; // r0
    char str[16]; // r1+0xC
    unsigned int size; // r1+0x8
    unsigned int * buf; // r31
...
// Range: 0x801A07D4 -> 0x801A083C
static float get_F32(char * in /* r30 */, char * * out /* r31 */) {
    // Local variables
    float val; // f31
}

// Range: 0x801A083C -> 0x801A0910
static unsigned int get_U32(char * in /* r29 */, char * * out /* r30 */) {
    // Local variables
    unsigned int val; // r31
    char * p; // r4
}

// Range: 0x801A0910 -> 0x801A09A0
static unsigned int get_input(char * in /* r28 */, char * * out /* r4 */) {
    // Local variables
    int i; // r29
...
// Range: 0x801A09A0 -> 0x801A0A2C
static unsigned int get_event(char * in /* r31 */, char * * out /* r4 */) {
    // Local variables
...
// Range: 0x801A0A2C -> 0x801A0ABC
static int get_group_type(char * in /* r31 */, char * * out /* r4 */) {}

unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
void * RwEngineInstance; // size: 0x4, address: 0x803C3054
// Range: 0x801A0ABC -> 0x801A12F4
void zMiniME::ParseMGD(unsigned int * buffer /* r15 */, unsigned int size /* r14 */) {
    // Local variables
    class zMiniME & mgr; // r0
    struct xIniFile * ini; // r20
    unsigned char isCurve; // r15
    unsigned char isMinigame; // r16
    int numCurves; // r17
    int numCurvepoints; // r18
    int numMinigames; // r19
    int numActions; // r21
    struct xIniSection * isec; // r22
    struct xIniSection * end_sec; // r23
    int i; // r24
    unsigned int amt; // r15
    unsigned char groupStart; // r1+0x38
    int groupType; // r1+0x34
    struct zMinigameInput * lastInput; // r19
    char * idxs; // r18
    int * curveIdx; // r0
    int * actionIdx; // r1+0x30
    unsigned char isAction; // r17
    int i; // r16
    char * s; // r1+0xC
    int j; // r0
    int j; // r15
    ...
    char * t; // r0
    float time; // f1
    struct zMinigameEvent * event; // r14
    struct zMinigameInput * input; // r14
    struct zMinigameText * text; // r14
    int j; // r15
    char * s; // r14
    char * s; // r14
    char * q; // r0
    int i; // r14
    class zMinigame * mg; // r15
    unsigned int j; // r16
    struct zMinigameInput * input; // r0
    char flags[32]; // r1+0x10
...
struct _tagxPad mPad[4]; // size: 0x4E0, address: 0x80314F50
// Range: 0x801A136C -> 0x801A1458
// this: r31
void PadHistory::Update() {
    // Local variables
    struct _tagxPad * pad; // r0

    // References
    // -> struct _tagxPad mPad[4];
}

// Range: 0x801A1458 -> 0x801A145C
void PadHistory::Render() {}

unsigned int FB_YRES; // size: 0x4, address: 0x803BCC38
unsigned int FB_XRES; // size: 0x4, address: 0x803BCC34
static float maxRot; // size: 0x4, address: 0x803C2258
static signed char init; // size: 0x1, address: 0x803C225C
float VBLANKS_PER_SEC; // size: 0x4, address: 0x803BCC30
// Range: 0x801A145C -> 0x801A16C0
// this: r31
void PadHistory::DetectStirring(int stick /* r30 */) {
    // Local variables
    float prev_delta[15]; // r1+0x8
    int j; // r0
    float now; // f0
    struct PadValue * val; // r8
    int n; // r3
    int maxInc; // r9
    int inc; // r10
    float inc_dur; // f7
    ...
    float last; // f11
    float delta; // f12
    float smoothed_delta; // f2
    float ang; // f13
    float sum; // f6
    int j; // r0
    float smoothed_freq; // f1
...
// Range: 0x801A16C0 -> 0x801A16E4
// this: r3
unsigned char PadHistory::IsStirring(float & frequency /* r0 */, float & duration /* r0 */) {}

// Range: 0x801A16E4 -> 0x801A1738
// this: r31
...
// Range: 0x801A1738 -> 0x801A17C0
void zMiniME::Update(float dt /* f31 */) {
    // Local variables
    class zMiniME & mgr; // r0
    class zMinigame * mg; // r31
    class zMinigame * mgend; // r30
}

// Range: 0x801A17C0 -> 0x801A183C
void zMiniME::Render() {
    // Local variables
    class zMiniME & mgr; // r0
...
// Range: 0x801A183C -> 0x801A18B0
void zMiniME::StartMinigame(unsigned int replyWidgetID /* r28 */, unsigned int minigameID /* r29 */) {
    // Local variables
    class zMiniME & mgr; // r0
    class zMinigame * mg; // r31
    class zMinigame * mgend; // r30
...
// Range: 0x801A18B0 -> 0x801A18DC
// this: r0
void zMinigame::Start(unsigned int ID /* r0 */) {}

// Range: 0x801A18DC -> 0x801A18F0
// this: r0
void zMinigame::Stop() {}

static float last_hit[10]; // size: 0x28, address: 0x803C2260
// Range: 0x801A18F0 -> 0x801A1E90
// this: r27
void zMinigame::Update(float dt /* f29 */) {
    // Local variables
    struct _tagxPad * pad; // r0
    class zMiniME & mgr; // r0
    float frequency; // r1+0xC
    float duration; // r1+0x8
    unsigned char isStirring; // r0
    union _zMinigameActions * action; // r29
    union _zMinigameActions * end_action; // r28
    float t; // f30
    float delta; // f2
    unsigned int eventMap[10]; // r1+0x10
...
// Range: 0x801A1E90 -> 0x801A2034
static void render_card(struct RwRaster * raster /* r30 */, float x /* f25 */, float y /* f26 */, float w /* f27 */, float h /* f30 */, unsigned char alpha /* r31 */) {
    // Local variables
    float rcz; // f29
    float nsz; // f28
    struct rwGameCube2DVertex vert[4]; // r1+0x8

    // References
    // -> void * RwEngineInstance;
}

// Range: 0x801A2034 -> 0x801A2060
static void set_vert(struct rwGameCube2DVertex & vert /* r0 */, float x /* f0 */, float y /* f0 */, float u /* f0 */, float v /* f0 */, float nsz /* f0 */, unsigned char alpha /* r0 */) {}

// Range: 0x801A2060 -> 0x801A208C
static void render_card_centered(struct RwRaster * raster /* r0 */, float cx /* f1 */, float cy /* f2 */, float dx /* f0 */, float dy /* f0 */, unsigned char alpha /* r0 */) {}

// total size: 0x8
struct /* @class$1707zMiniME_cpp */ {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
struct /* @class$1707zMiniME_cpp */ {
    ...
    unsigned int id; // offset 0x0, size 0x4
    struct RwTexture * texture; // offset 0x4, size 0x4
} textures[5]; // size: 0x28, address: 0x803BE388
// Range: 0x801A208C -> 0x801A231C
// this: r31
void zMinigame::Render() {
    // Local variables
    int i; // r28
    union _zMinigameActions * action; // r28
    union _zMinigameActions * end_action; // r29
    float start; // f3
    float end; // f0
    float pct; // f1
    float x; // f31
...
// Range: 0x801A231C -> 0x801A2368
static void U8_COLOR_CLAMP(unsigned char & destu8 /* r0 */, float srcf32 /* f0 */) {}

// total size: 0x4
struct /* @class$1770zMiniME_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
};
...
struct /* @class$1770zMiniME_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
} sGoodFX[8]; // size: 0x20, address: 0x803C2288
static int sNumGoodFX; // size: 0x4, address: 0x803C22A8
static struct RwTexture * sGoodFXTex; // size: 0x4, address: 0x803C22AC
// Range: 0x801A2368 -> 0x801A23CC
...
static int numDeflectors; // size: 0x4, address: 0x803C22B0
static class zAnalogInputDeflection * deflectors[16]; // size: 0x40, address: 0x803C22B4
static int numDirectors; // size: 0x4, address: 0x803C22F4
static class zAnalogInputDirection * directors[16]; // size: 0x40, address: 0x803C22F8
static int numTwiddlers; // size: 0x4, address: 0x803C2338
static class zAnalogInputTwiddler * twiddlers[16]; // size: 0x40, address: 0x803C233C
static int numPours; // size: 0x4, address: 0x803C237C
static class zCMGPourWidget * pours[16]; // size: 0x40, address: 0x803C2380
// total size: 0x1
class zAnalogInput {};
// Range: 0x801A2558 -> 0x801A2678
void zAnalogInput::Update(float dt /* f31 */) {
    // Local variables
    int i; // r29
    class zAnalogInputDeflection * input; // r3
    int i; // r29
    class zAnalogInputDirection * input; // r3
    int i; // r29
    class zAnalogInputTwiddler * twiddle; // r3
    int i; // r29
    class zCMGPourWidget * pour; // r3
...
// Range: 0x801A26EC -> 0x801A2768
// this: r30
zAnalogInputDeflection::zAnalogInputDeflection(struct zAnalogInputDeflectionAsset * theAsset /* r31 */) {
    // References
    // -> static int numDeflectors;
    // -> static class zAnalogInputDeflection * deflectors[16];
}

// Range: 0x801A2768 -> 0x801A27AC
void zAnalogInputDeflection::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// Range: 0x801A27AC -> 0x801A27D8
void zAnalogInputDeflection::EventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x801A27D8 -> 0x801A286C
// this: r29
void zAnalogInputDeflection::EventCB(unsigned int toEvent /* r0 */) {
    // Local variables
    int i; // r30
}

// Range: 0x801A286C -> 0x801A296C
// this: r31
void zAnalogInputDeflection::Update() {
    // Local variables
    float val; // f4
    float deflection; // f31
    unsigned char centered; // r29
    int i; // r28
...
// Range: 0x801A296C -> 0x801A29E8
// this: r30
zAnalogInputDirection::zAnalogInputDirection(struct zAnalogInputDirectionAsset * theAsset /* r31 */) {
    // References
    // -> static int numDirectors;
    // -> static class zAnalogInputDirection * directors[16];
}

// Range: 0x801A29E8 -> 0x801A2A2C
void zAnalogInputDirection::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// Range: 0x801A2A2C -> 0x801A2A58
void zAnalogInputDirection::EventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x801A2A58 -> 0x801A2AEC
// this: r29
void zAnalogInputDirection::EventCB(unsigned int toEvent /* r0 */) {
    // Local variables
    int i; // r30
}

// Range: 0x801A2AEC -> 0x801A2C1C
// this: r28
void zAnalogInputDirection::Update() {
    // Local variables
    float ang; // f3
    unsigned char centered; // r30
    float direction; // f1
    int i; // r29
    float params[4]; // r1+0x8
...
// Range: 0x801A2C1C -> 0x801A2CEC
// this: r30
zAnalogInputTwiddler::zAnalogInputTwiddler(struct zAnalogInputTwiddlerAsset * theAsset /* r31 */) {
    // References
    // -> static int numTwiddlers;
    // -> static class zAnalogInputTwiddler * twiddlers[16];
}

// Range: 0x801A2CEC -> 0x801A2D30
void zAnalogInputTwiddler::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// Range: 0x801A2D30 -> 0x801A2D5C
void zAnalogInputTwiddler::EventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x801A2D5C -> 0x801A2DE4
// this: r0
void zAnalogInputTwiddler::EventCB(unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {}

// Range: 0x801A2DE4 -> 0x801A2F54
// this: r31
...
// Range: 0x801A2F54 -> 0x801A2FEC
// this: r30
zCMGPourWidget::zCMGPourWidget(struct zCMGPourWidgetAsset * theAsset /* r31 */) {
    // References
    // -> static int numPours;
    // -> static class zCMGPourWidget * pours[16];
}

// Range: 0x801A2FEC -> 0x801A3030
void zCMGPourWidget::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// Range: 0x801A3030 -> 0x801A305C
void zCMGPourWidget::EventCB(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x801A305C -> 0x801A3220
// this: r31
void zCMGPourWidget::EventCB(struct xBase * from /* r0 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */) {
    // Local variables
    float params[4]; // r1+0x18
    float params[4]; // r1+0x8
}

// Range: 0x801A3220 -> 0x801A34C0
// this: r31
void zCMGPourWidget::Update(float dt /* f31 */) {
    // Local variables
...
unsigned int pourBarTexID; // size: 0x4, address: 0x803BE3B0
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
struct xColor_tag g_WHITE; // size: 0x4, address: 0x803C3324
// Range: 0x801A34C0 -> 0x801A363C
// this: r31
