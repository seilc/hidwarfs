/*
    ...
    Language: C++
    Code range: 0x801C8D8C -> 0x801C8E80
*/
// total size: 0x8
struct xBaseAsset {
    // Members
...
class zCompPerceptionParams sNPCGenericDefault; // size: 0x78, address: 0x80396548
class zCompPerceptionParams sNPCInstaKillDefault; // size: 0x78, address: 0x803965C0
const class zCompPerceptionParams * spNPCGenericDefault; // size: 0x4, address: 0x803BF370
// Range: 0x801C8D8C -> 0x801C8DA4
void zCompPerceptionParams::InitializeDefaults() {
    // References
    // -> class zCompPerceptionParams sNPCInstaKillDefault;
}

// Range: 0x801C8DA4 -> 0x801C8E28
// this: r0
zCompPerceptionParams::zCompPerceptionParams() {}

// Range: 0x801C8E28 -> 0x801C8E4C
