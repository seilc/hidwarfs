/*
    ...
    Language: C++
    Code range: 0x8014ACAC -> 0x8014BC90
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float defaultGooTimes[4]; // size: 0x10, address: 0x803C6638
static float defaultGooWarbc[4]; // size: 0x10, address: 0x803C6648
// total size: 0x8
struct RwObject {
    // Members
...
struct zFXGooInstance zFXGooInstances[24]; // size: 0xBA0, address: 0x80388158
static struct RwTexture * g_txtr_gooFrozen; // size: 0x4, address: 0x803C1A20
...
struct _zEnv * gCurEnv; // size: 0x4, address: 0x803C0CC4
// total size: 0xC
struct xModelPool {
    // Members
...
// Range: 0x8014B030 -> 0x8014B068
void zFXGoo_SceneReset() {
    // Local variables
    int i; // r0
    struct zFXGooInstance * goo; // r5

    // References
    // -> struct zFXGooInstance zFXGooInstances[24];
}

// Range: 0x8014B068 -> 0x8014B0E8
...
struct RpAtomic * (* gAtomicRenderCallBack)(struct RpAtomic *); // size: 0x4, address: 0x803BF9A0
// total size: 0xC
struct xVec3 {
    // Static members
...
// Range: 0x8014BA18 -> 0x8014BB00
int zFXGooIs(struct xEnt * obj /* r0 */, float & depth /* r30 */) {
    // Local variables
    int i; // r6
...
// Range: 0x8014BB00 -> 0x8014BB90
void zFXGooEventSetWarb(struct xEnt * ent /* r0 */, const float * warb /* r4 */) {
    // Local variables
    int i; // r7
    struct zFXGooInstance * goo; // r31
...
// Range: 0x8014BB90 -> 0x8014BC10
void zFXGooEventSetFreezeDuration(struct xEnt * ent /* r0 */, float duration /* f0 */) {
    // Local variables
    int i; // r0
...
// Range: 0x8014BC10 -> 0x8014BC90
void zFXGooEventMelt(struct xEnt * ent /* r0 */) {
    // Local variables
    int i; // r0
    struct zFXGooInstance * goo; // r6
    int freezeGroup; // r7
