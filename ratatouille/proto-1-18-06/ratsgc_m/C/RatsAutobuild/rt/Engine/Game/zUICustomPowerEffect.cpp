/*
    ...
    Language: C++
    Code range: 0x80159DB8 -> 0x80159FA0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x50
struct {} zUICustomPowerEffect::__vtable; // size: 0x50, address: 0x802DC4B8
// total size: 0x14
