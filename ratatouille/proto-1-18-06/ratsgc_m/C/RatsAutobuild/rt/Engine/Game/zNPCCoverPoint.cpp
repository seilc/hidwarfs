/*
    ...
    Language: C++
    Code range: 0x801496C0 -> 0x80149BD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801496C0 -> 0x80149914
static void sNPCCoverPointFindNPC(class zNPCCoverPoint * coverPoint /* r27 */, struct xGroup * coverPointGroup /* r28 */, struct xGroup * npcGroup /* r29 */) {
    // Local variables
    int npcIter; // r31
    int cpCheckIter; // r22
    int bestNPC; // r30
...
// total size: 0x4
struct /* @class$804zNPCCoverPoint_cpp */ {
    // Members
...
union /* @class$823zNPCCoverPoint_cpp */ {
...
// total size: 0xC
struct /* @class$822zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1230zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1197zNPCCoverPoint_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zNPCCoverPoint_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1199zNPCCoverPoint_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1196zNPCCoverPoint_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1201zNPCCoverPoint_cpp */ {
    // Members
...
// Range: 0x80149914 -> 0x80149AE0
void zNPCCoverManageRetreatToCover(struct xBase * from /* r25 */, struct xGroup * npcGroup /* r26 */, unsigned int toEvent /* r27 */, const float * toParam /* r28 */, struct xGroup * coverPointGroup /* r29 */, unsigned int toParamWidgetID /* r30 */) {
    // Local variables
    int cpIter; // r31
    class zNPCCoverPoint * coverPoint; // r22
...
// Range: 0x80149AE0 -> 0x80149B90
void zNPCCoverPoint::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */) {
    // Local variables
    class zNPCCoverPoint * newCP; // r0
    struct xMat3x3 eulerMat; // r1+0x10
}

// Range: 0x80149B90 -> 0x80149BB0
// this: r0
unsigned char zNPCCoverPoint::Seize(class zNPCCommon * seizer /* r0 */) {}

// Range: 0x80149BB0 -> 0x80149BD4
// this: r0
