/*
    ...
    Language: C++
    Code range: 0x8018C254 -> 0x8018C698
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char lastSceneWasAlreadyCompleted; // size: 0x1, address: 0x803C20B8
static unsigned char screenEnd; // size: 0x1, address: 0x803BDF90
static unsigned char allowPause; // size: 0x1, address: 0x803C20B9
// Range: 0x8018C254 -> 0x8018C25C
...
// total size: 0x50
struct {} zUICustomMissionCompleteManager::__vtable; // size: 0x50, address: 0x802DF788
// total size: 0x10
...
// total size: 0x2
struct /* @class$1112zUICustomMissionCompleteManager_cpp */ {
    // Members
...
unsigned char gPassAnyActveController; // size: 0x1, address: 0x803C18F2
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$847zUICustomMissionCompleteManager_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$865zUICustomMissionCompleteManager_cpp */ {
    // Members
...
union /* @class$866zUICustomMissionCompleteManager_cpp */ {
...
// Range: 0x8018C508 -> 0x8018C538
static void zSystemMessageCB(unsigned int toEvent /* r0 */) {}

unsigned char gSysMessageManager_active; // size: 0x1, address: 0x803C18F1
// Range: 0x8018C538 -> 0x8018C698
// this: r31
void zUICustomMissionCompleteManager::PreUpdate(float dt /* f0 */) {
    // Local variables
    unsigned int strHash; // r31
    class zUIText * acceptText; // r0
