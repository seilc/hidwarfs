/*
    ...
    Language: C++
    Code range: 0x8014C228 -> 0x8014C838
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char need_setup; // size: 0x1, address: 0x803C1A40
// total size: 0x5C
struct config {
    // Members
...
int system_id; // size: 0x4, address: 0x803BD6F0
// total size: 0x28
...
// total size: 0x4
struct /* @class$923zFXPunchStars_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zFXPunchStars_cpp */ {
    // Members
...
union /* @class$746zFXPunchStars_cpp */ {
