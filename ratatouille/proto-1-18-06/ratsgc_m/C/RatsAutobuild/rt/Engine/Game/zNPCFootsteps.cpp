/*
    ...
    Language: C++
    Code range: 0x8015C7A8 -> 0x8015C97C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct zNPCFootstep * footstepTables[16]; // size: 0x40, address: 0x803C1BC0
// total size: 0x1
class zNPCFootstepsManager {
    // Static members
    static struct zNPCFootstep * footstepTables[16]; // size: 0x40
};
// Range: 0x8015C7A8 -> 0x8015C7D4
