/*
    ...
    Language: C++
    Code range: 0x801A93E8 -> 0x801A95B4
*/
class zUICustomCheatsManager * pUICustomCheatsManager; // size: 0x4, address: 0x803C2430
static unsigned char gCreditCode; // size: 0x1, address: 0x803C2434
static unsigned char gClearUserString; // size: 0x1, address: 0x803C2435
// total size: 0x50
struct {} zUICustomCheatsManager::__vtable; // size: 0x50, address: 0x802E2A10
// total size: 0x8
