/*
    ...
    Language: C++
    Code range: 0x801B9C40 -> 0x801B9DCC
*/
signed char zComponentPool<zCompLogicPourNSwirl, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2688
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicPourNSwirl, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C268C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B9CBC -> 0x801B9CDC
// this: r0
void zNPCPourNSwirl::Deactivate() {}

// Range: 0x801B9CDC -> 0x801B9D8C
// this: r28
...
// total size: 0x3C
struct {} zNPCPourNSwirl::__vtable; // size: 0x3C, address: 0x803BEC80
