/*
    ...
    Language: C++
    Code range: 0x8014FC20 -> 0x8014FEF8
*/
static int decalCount; // size: 0x4, address: 0x803C1A78
static class Decal decals[8]; // size: 0x40, address: 0x803C1A7C
// total size: 0x10
struct xFRect {
    // Members
...
// Range: 0x8014FC20 -> 0x8014FC2C
void zFXScreenDecalSceneEnter() {
    // References
    // -> static int decalCount;
}

// Range: 0x8014FC2C -> 0x8014FC38
void zFXScreenDecalSceneReset() {
    // References
    // -> static int decalCount;
}

// Range: 0x8014FC38 -> 0x8014FCE8
