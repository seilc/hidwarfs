/*
    ...
    Language: C++
    Code range: 0x801B177C -> 0x801B1908
*/
signed char zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C24E0
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicLeftArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C24E4
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B17F8 -> 0x801B1818
// this: r0
void zNPCLeftArm::Deactivate() {}

// Range: 0x801B1818 -> 0x801B18C8
// this: r28
...
// total size: 0x4
struct /* @class$831zNPCLeftArm_cpp */ {
    // Members
...
union /* @class$851zNPCLeftArm_cpp */ {
...
// total size: 0xC
struct /* @class$849zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$760zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$761zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$762zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$763zNPCLeftArm_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$764zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$765zNPCLeftArm_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$766zNPCLeftArm_cpp */ {
    // Members
...
// total size: 0x3C
struct {} zNPCLeftArm::__vtable; // size: 0x3C, address: 0x803BE7C8
