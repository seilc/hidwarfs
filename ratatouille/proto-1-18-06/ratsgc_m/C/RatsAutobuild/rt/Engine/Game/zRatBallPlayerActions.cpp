/*
    ...
    Language: C++
    Code range: 0x801A3FB0 -> 0x801A5DCC
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$804zRatBallPlayerActions_cpp */ {
    // Members
...
union /* @class$823zRatBallPlayerActions_cpp */ {
...
static float min_speed; // size: 0x4, address: 0x803BE3C8
static float norm_speed; // size: 0x4, address: 0x803BE3CC
static float max_speed; // size: 0x4, address: 0x803BE3D0
static unsigned char fastTrack; // size: 0x1, address: 0x803C23C0
// total size: 0x10
struct rest_config {
    // Members
...
// Range: 0x801A4230 -> 0x801A42A8
// this: r31
void zRatBallPlayerDrive::Begin() {}

// Range: 0x801A42A8 -> 0x801A42AC
void zRatBallPlayerDrive::End() {}

// Range: 0x801A42AC -> 0x801A4348
// this: r29
...
struct xColor_tag g_GREEN; // size: 0x4, address: 0x803C3314
float RB_PLSBOUND_RADIUS; // size: 0x4, address: 0x803BE3B8
// total size: 0x40
...
// Range: 0x801A4348 -> 0x801A47F4
// this: r31
void zRatBallPlayerDrive::Physics(float dt /* f29 */) {
    // Local variables
    float x; // r1+0x24
    float z; // r1+0x20
...
// total size: 0x4
struct /* @class$1275zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1197zRatBallPlayerActions_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zRatBallPlayerActions_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1199zRatBallPlayerActions_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1196zRatBallPlayerActions_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1201zRatBallPlayerActions_cpp */ {
    // Members
...
// Range: 0x801A47F4 -> 0x801A493C
// this: r30
unsigned char zRatBallPlayerDrive::operator()(struct xEnt & ent /* r31 */) {
    // Local variables
    struct xCollis * pCollis; // r29
...
static unsigned int zCOLLISION_NEEDS_REFLECTION; // size: 0x4, address: 0x803C7A2C
// total size: 0x38
struct xGrid {
    // Members
...
float RB_boundYShift; // size: 0x4, address: 0x803BE3C0
struct xVec3 g_Y3; // size: 0xC, address: 0x803C3B30
// Range: 0x801A493C -> 0x801A4F74
// this: r24
void zRatBallPlayerDrive::SphereCollision(const struct xVec3 * pNewPosition /* r0 */, const struct xVec3 * pVelocity /* r25 */, unsigned char * pInGroundContact /* r26 */, struct xVec3 * pGroundNormal /* r27 */) {
    // Local variables
    struct xSphere collisionSphere[1]; // r1+0x80
    int i; // r0
    unsigned int numGroundCollisions; // r29
...
// Range: 0x801A4F74 -> 0x801A5104
// this: r25
void zRatBallPlayerDrive::ApplyCollisionRebounds(struct xVec3 * pVelocity /* r26 */) {
    // Local variables
    int i; // r27
    float normDot; // f0
    float normDotUp; // f1
...
// Range: 0x801A5104 -> 0x801A51E8
// this: r26
void zRatBallPlayerDrive::DepenetrateCollisionList(struct xVec3 * pPosition /* r27 */) {
    // Local variables
    int i; // r28
...
// total size: 0xC
struct /* @class$822zRatBallPlayerActions_cpp */ {
    // Members
...
// Range: 0x801A5338 -> 0x801A56D8
static struct RpCollisionTriangle * nearestTrackCB(struct RpCollisionTriangle * collTriangle /* r24 */, void * data /* r31 */) {
    // Local variables
    struct TrackPolyData * tpoly; // r0
    float currnear; // f31
    struct xVec3 currpt; // r1+0x38
    int currvert; // r26
    int curredge; // r25
    struct xVec3 xformVert[4]; // r1+0x44
    struct xVec3 xformNorm; // r1+0x2C
    int i; // r0
    float pdx[3]; // r1+0x20
    float pdz[3]; // r1+0x14
    float numer; // f0
    ...
    float t; // f8
    float testdist2; // f0
    struct xVec3 testpt; // r1+0x8
}

// Range: 0x801A56D8 -> 0x801A56F4
static float det3x3top1(float m21 /* f0 */, float m22 /* f0 */, float m23 /* f0 */, float m31 /* f0 */, float m32 /* f0 */, float m33 /* f0 */) {}

static unsigned int ZPLAYER_IS_TSLIDING; // size: 0x4, address: 0x803C7A50
// total size: 0x10
struct xSphere {
    // Members
    struct xVec3 center; // offset 0x0, size 0xC
...
void zRatBallPlayerDrive::SlideTrackUpdate() {
    ...
    int triIndex; // r31
    int iRaftTrack; // r30
    struct zRaftTrack * curRaftTrack; // r29
    int i; // r28
    struct xEnt * trackEnt; // r27
    struct RpGeometry * geom; // r7
    struct RpTriangle * tri; // r27
    struct RwTexCoords * tex; // r28
    struct RwV3d * vert; // r24
...
// total size: 0x50
struct {} zRatBallPlayerDrive::__vtable; // size: 0x50, address: 0x802E28A8
// total size: 0xC
