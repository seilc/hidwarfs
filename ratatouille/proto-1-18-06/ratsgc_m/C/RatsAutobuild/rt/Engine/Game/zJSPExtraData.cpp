/*
    ...
    Language: C++
    Code range: 0x80126734 -> 0x80126980
*/
// total size: 0x20
struct xLinkAsset {
    // Members
...
struct jspGroupPair sJspGroupPairs[10]; // size: 0xA0, address: 0x8037F1E8
int sNumPairs; // size: 0x4, address: 0x803C1858
// total size: 0x10
...
// Range: 0x801268C0 -> 0x801268CC
void zJSPExtraData::ClearGroupAssociations() {
    // References
    // -> int sNumPairs;
}

// Range: 0x801268CC -> 0x80126900
