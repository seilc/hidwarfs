/*
    ...
    Language: C++
    Code range: 0x80159AF8 -> 0x80159DB8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static enum enPAUSE_TYPE pauseSysType_cur; // size: 0x4, address: 0x803BD9C0
static enum enPAUSE_TYPE pauseSysType_old; // size: 0x4, address: 0x803BD9C4
// total size: 0x50
struct {} zUICustomPauseScreenManager::__vtable; // size: 0x50, address: 0x802DC468
// total size: 0x8
...
// Range: 0x80159B34 -> 0x80159B38
void zUICustomPauseScreenManager::Init() {}

int GCN_DEMO_PARAM; // size: 0x4, address: 0x803C0B54
