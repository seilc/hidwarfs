/*
    ...
    Language: C++
    Code range: 0x800EE880 -> 0x800EEC00
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct RwCamera * cam; // size: 0x4, address: 0x803C1208
// total size: 0x8
struct RwLinkList {
    // Members
...
struct RpLight * light; // size: 0x4, address: 0x803C120C
// total size: 0xA4
struct RwFrame {
    // Members
    struct RwObject object; // offset 0x0, size 0x8
...
struct RwFrame * frame; // size: 0x4, address: 0x803C1210
...
struct RpWorld * world; // size: 0x4, address: 0x803C1214
// total size: 0x4
class Screen {
    // Members
public:
...
class Screen * screen; // size: 0x4, address: 0x803C1218
// Range: 0x800EE880 -> 0x800EE888
...
static float rot; // size: 0x4, address: 0x803C121C
static signed char init; // size: 0x1, address: 0x803C1220
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
unsigned int gFrameCount; // size: 0x4, address: 0x803BF7FC
// total size: 0x4
struct RwRGBA {
    // Members
...
// Range: 0x800EEA28 -> 0x800EEC00
void * RenderThread() {
    // Local variables
    long long lastTime; // r28
...
unsigned int scratch_mem_used; // size: 0x4, address: 0x803BFB6C
