/*
    ...
    Language: C++
    Code range: 0x801ACDB4 -> 0x801AEE10
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int READY_TEX_IDS[3]; // size: 0xC, address: 0x803BE798
// total size: 0x78
struct {} zMiniGameRatOnBall::__vtable; // size: 0x78, address: 0x802E2B10
// total size: 0x1C
...
union /* @class$882zMiniGameRatOnBall_cpp */ {
...
// total size: 0xC
struct /* @class$886zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x801ACE10 -> 0x801ACE84
void zMiniGameRatOnBall::Init(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */) {
    // References
...
void zMiniGameRatOnBall::PlayerCollisions() {
    ...
    int a; // r28
    int b; // r27
    class zMiniGameRatOnBallPlayer * ballA; // r26
    class zMiniGameRatOnBallPlayer * ballB; // r25
    struct xVec3 ballPosA; // r1+0xA4
    struct xVec3 ballPosB; // r1+0x98
    struct xVec3 distVec; // r1+0x8C
    float dist; // f1
    float relativeVelocity; // f0
    struct zRoBPlayerCollision * contact; // r25
    int i; // r26
    ...
    class zMiniGameRatOnBallPlayer * ball2; // r22
    struct xVec3 btravel2; // r1+0x50
    enum iSndGroupHandle soundGroupHandle; // r23
...
// total size: 0xC
struct /* @class$1184zMiniGameRatOnBall_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
struct zParticleGeneratorEarthDust : public zParticleGenerator {
    // Members
protected:
    class zParticleSystemEarthDust * system; // offset 0x20, size 0x4
    struct xEnt * attach_to; // offset 0x24, size 0x4
    float emitted; // offset 0x28, size 0x4
    class zParticleLocator locator; // offset 0x2C, size 0x8
    int batch_id; // offset 0x34, size 0x4
    float shrapEmitted; // offset 0x38, size 0x4
    struct zShrapnelAsset * shrapAsset; // offset 0x3C, size 0x4
    struct xModelInstance * tempModel; // offset 0x40, size 0x4
};
// total size: 0xC40
class zMiniGameRatOnBallPlayer : public zMiniGamePlayer {
    // Members
protected:
    struct xModelInstance * ballModel; // offset 0xB20, size 0x4
public:
    float turbo_emit_remaining; // offset 0xB24, size 0x4
    struct config turbo_config; // offset 0xB28, size 0x58
protected:
    float respawnTimer; // offset 0xB80, size 0x4
    int lifeState; // offset 0xB84, size 0x4
    class zRatOnBallForces forces; // offset 0xB88, size 0x40
    float turboTimer; // offset 0xBC8, size 0x4
    class zMiniGameRatOnBallAI ai; // offset 0xBCC, size 0x18
    int lives; // offset 0xBE4, size 0x4
    class zUIImage * uiImage[9]; // offset 0xBE8, size 0x24
    class zUIImage * uiMarker; // offset 0xC0C, size 0x4
    class zUIImage * uiStagesWon[3]; // offset 0xC10, size 0xC
    class zUIImage * uiWinner; // offset 0xC1C, size 0x4
    int stagesWon; // offset 0xC20, size 0x4
    float markerTimer; // offset 0xC24, size 0x4
    struct zParticleGeneratorEarthDust * deathPGen; // offset 0xC28, size 0x4
    float deathPGenTimer; // offset 0xC2C, size 0x4
    unsigned char deathPGenOn; // offset 0xC30, size 0x1
};
// total size: 0x30
struct xMat3x3 {
    // Members
...
// Range: 0x801AE330 -> 0x801AE368
// this: r31
void zMiniGameRatOnBall::StageStartEnter() {}

// Range: 0x801AE368 -> 0x801AE4A8
// this: r31
...
class zMiniGamePlayer : public zPlayer {
    // Members
protected:
    int activePickupType; // offset 0xB10, size 0x4
    float activePickupTimer; // offset 0xB14, size 0x4
    unsigned char isAI; // offset 0xB18, size 0x1
};
// Range: 0x801AE564 -> 0x801AE600
// this: r29
...
// total size: 0x4
struct /* @class$816zMiniGameRatOnBall_cpp */ {
    // Members
...
// Range: 0x801AEAB0 -> 0x801AEB28
// this: r3
void zMiniGameRatOnBall::StageEndEnter() {}

// Range: 0x801AEB28 -> 0x801AEBCC
// this: r30
