/*
    ...
    Language: C++
    Code range: 0x8015BF5C -> 0x8015C7A0
*/
class zUICustomArtworkManager * pUICustomArtworkManager; // size: 0x4, address: 0x803C1BB8
static unsigned char unlockedBonus[80]; // size: 0x50, address: 0x8038CDD8
// total size: 0x8
struct xIniValue {
    // Members
...
static int translationTable[80]; // size: 0x140, address: 0x802DC828
// Range: 0x8015C6FC -> 0x8015C7A0
