/*
    Compile unit: C:\RatsAutobuild\rt\Engine\Game\zUICustomControlOverlay.cpp
    Producer: MW EABI PPC C-Compiler
    Language: C++
    Code range: 0x80158AC0 -> 0x80159534
*/
// total size: 0x50
struct {} zUICustomControlOverlay::__vtable; // size: 0x50, address: 0x802DC418
// total size: 0x10
class zUICustomControlOverlay : public zUICustom {
    // Functions
    zUICustomControlOverlay(class zUI * ui);
    ...
    // Members
    unsigned int controlCount; // offset 0x8, size 0x4
    unsigned char currPlayer; // offset 0xC, size 0x1
};
// Range: 0x80158AC0 -> 0x80158AFC
// this: r31
zUICustomControlOverlay::zUICustomControlOverlay(class zUI * ui /* r0 */) {
    // References
    // -> struct [anonymous] zUICustomControlOverlay::__vtable;
}
...
// Range: 0x80158AFC -> 0x80158B10
// this: r0
void zUICustomControlOverlay::Init() {}

// Range: 0x80158B10 -> 0x80158E30
// this: r31
void zUICustomControlOverlay::UpdatePlayerText() {
    // Local variables
    class zUIText * text; // r30
}
...
// Range: 0x80158E30 -> 0x80158E50
// this: r0
void zUICustomControlOverlay::PreUpdate() {}
...
// Range: 0x80158E50 -> 0x80158E74
// this: r0
unsigned char zUICustomControlOverlay::PreRender() {}

// total size: 0x18
struct zUICustomControlOverlayLineList {
    // Members
    float x1; // offset 0x0, size 0x4
    float y1; // offset 0x4, size 0x4
    float x2; // offset 0x8, size 0x4
    float y2; // offset 0xC, size 0x4
    float x3; // offset 0x10, size 0x4
    float y3; // offset 0x14, size 0x4
};
// total size: 0xC
struct RwV3d {
    // Members
...
// Range: 0x80158E74 -> 0x801594C0
// this: r27
void zUICustomControlOverlay::RenderLines() {
    // Local variables
    struct rwGameCube2DVertex vertices[88]; // r1+0x268
    unsigned short indices[132]; // r1+0x160
    struct zUICustomControlOverlayLineList lineList[11]; // r1+0x58
    int vertexCount; // r30
    int indexCount; // r29
    float z; // f30
    unsigned int i; // r28
    struct xVec3 p1; // r1+0x4C
    struct xVec3 p2; // r1+0x40
    struct xVec3 dir; // r1+0x34
    float dot; // f0
    int oldCount; // r0
    struct xVec3 p1; // r1+0x28
    struct xVec3 p2; // r1+0x1C
    struct xVec3 dir; // r1+0x10
    float dot; // f0
    int oldCount; // r0
    enum RwShadeMode oldShadeMode; // r1+0xC
    int oldAlphaEnable; // r1+0x8
...
// Range: 0x801594C0 -> 0x80159534
// this: r3
unsigned char zUICustomControlOverlay::HandleEvent(struct xBase * from /* r4 */, unsigned int toEvent /* r5 */, const float * toParam /* r6 */, struct xBase * toParamWidget /* r7 */, unsigned int toParamWidgetID /* r8 */) {
    // References
