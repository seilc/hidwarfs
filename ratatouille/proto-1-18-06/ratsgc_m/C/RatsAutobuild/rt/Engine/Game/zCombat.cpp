/*
    ...
    Language: C++
    Code range: 0x8017C168 -> 0x8017DBA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char hasAddedToCount; // size: 0x1, address: 0x803C1F00
// Range: 0x8017C168 -> 0x8017C194
void zCombatInit() {}
...
// total size: 0x1
struct /* @class$696zCombat_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$697zCombat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$698zCombat_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$699zCombat_cpp */ {
    // Members
...
struct zCombat {
    ...
    void Init(const struct xHierarchyBoundInitData * initHierarchy, float masterRadius, const class zCombatAttack * stateTable, unsigned short stateTableSize, int hitPoints, float scale);
...
// Range: 0x8017C1F0 -> 0x8017C228
// this: r0
int zCombat::Setup(const struct xHierarchyBoundInitData * initHierarchy /* r0 */, unsigned int boundsNumber /* r5 */) {}
...
// Range: 0x8017C228 -> 0x8017C290
// this: r28
void zCombat::Init(const struct xHierarchyBoundInitData * initHierarchy /* r0 */, float masterRadius /* f0 */, const class zCombatAttack * stateTable /* r29 */, unsigned short stateTableSize /* r30 */, int hitPoints /* r31 */, float scale /* f0 */) {}

// Range: 0x8017C290 -> 0x8017C294
void zCombat::PreUpdate() {}

// Range: 0x8017C294 -> 0x8017C2E0
// this: r0
unsigned char zCombat::ShouldRunEffect() {}

// Range: 0x8017C2E0 -> 0x8017C320
// this: r0
...
// total size: 0x4
struct /* @class$1244zCombat_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1245zCombat_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x8017C80C -> 0x8017C878
static void GetBonePos(struct xVec3 & pos /* r29 */, int boneNumber /* r30 */, const struct xMat4x3 * mats /* r31 */) {}

static struct zCombatDamageInfo * damage_info_stack[4]; // size: 0x10, address: 0x803C1F04
static int damage_info_stack_count; // size: 0x4, address: 0x803C1F14
// Range: 0x8017C878 -> 0x8017C8A8
...
// Range: 0x8017C8A8 -> 0x8017C8B8
static void PopDamageInfo() {
    // References
    // -> static int damage_info_stack_count;
}

// Range: 0x8017C8B8 -> 0x8017CAA8
...
// Range: 0x8017CC88 -> 0x8017CCF8
// this: r30
void zCombat::UpdateBounds(struct xEnt * ent /* r4 */) {
    // Local variables
    const struct xVec3 * pos; // r31
    const struct xVec3 * playerCenter; // r5
    struct xVec3 objectDirection; // r1+0x8
...
// Range: 0x8017CCF8 -> 0x8017CF3C
// this: r24
void zCombat::SendObjectHit(struct xEnt * attacker /* r25 */, struct xEnt * target /* r26 */, struct xSurface * surface /* r6 */, enum zHitTarget hitTarget /* r27 */, const struct xVec3 * direction /* r28 */, const struct xVec3 * hit_loc /* r29 */, const struct xVec3 * hit_norm /* r30 */, const struct xVec3 * move_dir /* r0 */, unsigned char hitEffect /* r31 */) {
    // Local variables
    int i; // r0
...
// Range: 0x8017D308 -> 0x8017D488
// this: r26
void zCombat::CheckForCollisionEnv(struct xEnt * attacker /* r27 */, struct xEnv * env /* r28 */, struct xSweptSphere * sphere /* r29 */, const struct xVec3 * hitDirection /* r30 */) {
    // Local variables
    struct xVec3 hdng; // r1+0x10
    unsigned char oldHitEnv; // r31
    struct xSurface * pXSurface; // r31
...
// Range: 0x8017D488 -> 0x8017D664
// this: r27
void zCombat::SweepSphere(struct xEnt * attacker /* r28 */, struct xVec3 * pos1 /* r29 */, struct xVec3 * pos2 /* r31 */, float radius /* f31 */) {
    // Local variables
...
// Range: 0x8017D6F0 -> 0x8017D7D0
// this: r30
void zCombat::StartEffect(struct xEnt * attacker /* r31 */) {
    // Local variables
...
// Range: 0x8017D7D0 -> 0x8017D80C
// this: r3
void zCombat::StopEffect() {}

// Range: 0x8017D80C -> 0x8017D854
// this: r31
void zCombat::RenderEffectModel() {}

// Range: 0x8017D854 -> 0x8017D878
// this: r3
...
static struct xFXRing sBodySlamRing[3]; // size: 0xC0, address: 0x802DEBF0
// Range: 0x8017D878 -> 0x8017D9C8
// this: r30
