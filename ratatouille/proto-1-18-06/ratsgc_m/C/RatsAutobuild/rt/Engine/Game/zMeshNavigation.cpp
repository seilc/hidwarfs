/*
    ...
    Language: C++
    Code range: 0x80137778 -> 0x80138B7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
struct xVec2 g_O2; // size: 0x8, address: 0x803C3AF0
// Range: 0x80137778 -> 0x80137B10
...
void zMeshNavigationCommon::DetermineSteeringDirection(struct xEnt * entity /* r26 */, const class zMeshCircle & entCircle /* r21 */, const struct xVec2 & entDir /* r22 */, class zMeshCircle & threatCircle /* r23 */, struct xVec2 & resultDir /* r24 */, unsigned int & threatClusterSize /* r25 */) {
    // Local variables
    struct xVec3 threatPos; // r1+0x4C
    ...
    struct xVec3 pos1; // r1+0x40
    struct xVec3 pos2; // r1+0x34
    struct xVec3 diff; // r1+0x28
    float noIntersectDist2; // f31
    struct xVec2 normalDir; // r1+0x20
    struct xVec2 entPos2D; // r1+0x18
    class zMeshCircle * curr; // r21
    int weight; // r22
    struct xVec2 currPos2D; // r1+0x10
    struct xVec2 toCurr; // r1+0x8
}
...
// total size: 0x4
struct /* @class$785zMeshNavigation_cpp */ {
    // Members
...
union /* @class$804zMeshNavigation_cpp */ {
...
// total size: 0xC
struct /* @class$803zMeshNavigation_cpp */ {
    // Members
...
// Range: 0x80137EB8 -> 0x80138258
class zMeshCircle * zMeshNavigationCommon::AvoidCircles(struct xEnt * entity /* r28 */, const class zMeshPosition * meshPosition /* r27 */, const class zMeshCircle & my_circle /* r26 */, const struct xVec2 & dir /* r29 */, struct xVec2 & newDir /* r30 */) {
    // Local variables
    struct xVec2 resultDir; // r1+0x84
    struct xVec2 myPos2D; // r1+0x7C
    class zMeshCircle * threatCircle; // r31
    float threatCheckDist; // f29
    struct xVec2 threatPerpVec; // r1+0x74
    struct xVec2 threatParalVec; // r1+0x6C
    class zMeshCircle * nearbyCircles; // r3
    float minDist2; // f28
    class zMeshCircle * currentCircle; // r27
    struct xVec2 targetPos; // r1+0x64
    struct xVec2 toTarget; // r1+0x5C
    float theDot; // f27
    struct xVec2 closestPt; // r1+0x54
    struct xVec2 perpVec; // r1+0x4C
    float checkLength; // f31
    float targetDist; // f1
    struct xVec2 pushVec2D; // r1+0x44
    struct xVec2 pushDir2D; // r1+0x3C
    float length; // f0
    float scale; // f27
    unsigned int threatClusterSize; // r1+0x8
}

// Range: 0x80138258 -> 0x801382C4
...
// total size: 0x4
struct /* @class$1242zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1209zMeshNavigation_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1210zMeshNavigation_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1211zMeshNavigation_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1208zMeshNavigation_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1213zMeshNavigation_cpp */ {
    // Members
