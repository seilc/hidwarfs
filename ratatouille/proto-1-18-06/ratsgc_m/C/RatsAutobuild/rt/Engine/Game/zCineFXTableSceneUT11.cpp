/*
    ...
    Language: C++
    Code range: 0x80181334 -> 0x80181358
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zFrozoneIceRecordEntry record_ut_o[92]; // size: 0x5C0, address: 0x802B1C90
// total size: 0xC
...
static struct cinfx_frobridge_context frotext_ut_o; // size: 0xC, address: 0x803C72C0
// total size: 0x10
struct TypeInfo {
    // Members
    union { // inferred
...
static struct NCINEntry g_cinfx_UT11_manager[2]; // size: 0x128, address: 0x802DF0B8
// total size: 0xC
struct NCINMap {
    // Members
...
static struct NCINMap cutmap[2]; // size: 0x18, address: 0x803BDE80
// Range: 0x80181334 -> 0x80181358
