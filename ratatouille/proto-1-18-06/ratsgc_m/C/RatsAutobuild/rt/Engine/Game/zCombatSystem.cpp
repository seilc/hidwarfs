/*
    ...
    Language: C++
    Code range: 0x80180754 -> 0x80180920
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct xEnt * combatList[96]; // size: 0x180, address: 0x8038EE18
static unsigned int currentCombat; // size: 0x4, address: 0x803C1FC8
// Range: 0x80180754 -> 0x80180774
