/*
    ...
    Language: C++
    Code range: 0x8015B390 -> 0x8015B5C8
*/
// total size: 0x50
struct {} zUICustomStatic::__vtable; // size: 0x50, address: 0x802DC738
enum Stage {
    Stage_Off = 0,
    Stage_FadeIn = 1,
    Stage_On = 2,
...
// Range: 0x8015B3CC -> 0x8015B40C
// this: r31
void zUICustomStatic::Reset() {}

// Range: 0x8015B40C -> 0x8015B4DC
// this: r31
void zUICustomStatic::PreUpdate(float dt /* f0 */) {}

// Range: 0x8015B4DC -> 0x8015B5C8
// this: r30
