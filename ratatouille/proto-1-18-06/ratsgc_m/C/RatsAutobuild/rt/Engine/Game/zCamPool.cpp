/*
    ...
    Language: C++
    Code range: 0x8016CA50 -> 0x8016CBD0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8016CA50 -> 0x8016CA60
// this: r0
zCamPoolBase::zCamPoolBase() {}

// Range: 0x8016CA60 -> 0x8016CAC4
// this: r29
...
// Range: 0x8016CAC4 -> 0x8016CB2C
// this: r30
void zCamPoolBase::AddCamera(struct xCam * newCam /* r31 */) {}

static int depth; // size: 0x4, address: 0x803C1D28
static signed char init; // size: 0x1, address: 0x803C1D2C
// Range: 0x8016CB2C -> 0x8016CBD0
// this: r28
