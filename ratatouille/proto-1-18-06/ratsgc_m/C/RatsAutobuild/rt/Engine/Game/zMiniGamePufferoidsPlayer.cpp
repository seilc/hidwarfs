/*
    ...
    Language: C++
    Code range: 0x801B8A38 -> 0x801B9870
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int SHOT_MODEL_ID; // size: 0x4, address: 0x803C25F0
static unsigned int SHOT_LONG_MODEL_ID; // size: 0x4, address: 0x803C25F4
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$786zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$1088zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1090zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1091zMiniGamePufferoidsPlayer_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1092zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
enum /* @enum$1093zMiniGamePufferoidsPlayer_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1094zMiniGamePufferoidsPlayer_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1095zMiniGamePufferoidsPlayer_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x2
struct /* @class$1085zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
struct xColor_tag g_BLUE; // size: 0x4, address: 0x803C3318
// Range: 0x801B8CE4 -> 0x801B8D8C
// this: r31
...
class zMiniGamePufferoidsPlayer : public zMiniGamePlayer {
    ...
    // Members
protected:
    int state; // offset 0xB20, size 0x4
    struct xMat3x3 restoreMat; // offset 0xB30, size 0x30
    int lives; // offset 0xB60, size 0x4
    int score; // offset 0xB64, size 0x4
    float invincibleTimer; // offset 0xB68, size 0x4
    float fellTimer; // offset 0xB6C, size 0x4
    unsigned char trip; // offset 0xB70, size 0x1
    unsigned char skipRender; // offset 0xB71, size 0x1
    int skipCounter; // offset 0xB74, size 0x4
    class zMiniGamePufferoidsShot * shots; // offset 0xB78, size 0x4
};
// Range: 0x801B8EA0 -> 0x801B8F2C
// this: r29
...
union /* @class$805zMiniGamePufferoidsPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$804zMiniGamePufferoidsPlayer_cpp */ {
    // Members
...
// Range: 0x801B9200 -> 0x801B9240
// this: r0
void zMiniGamePufferoidsPlayer::ApplyPickup(int applyPickup /* r0 */, float activeTime /* f0 */) {}

// Range: 0x801B9240 -> 0x801B92D4
// this: r31
...
// Range: 0x801B9338 -> 0x801B9340
// this: r3
unsigned char zMiniGamePufferoidsShot::IsActive() {}

// Range: 0x801B9340 -> 0x801B95D8
// this: r31
...
// Range: 0x801B95D8 -> 0x801B95F8
// this: r0
void zMiniGamePufferoidsPlayer::EndUpdate(float dt /* f0 */) {}

// Range: 0x801B95F8 -> 0x801B96F4
// this: r29
...
// Range: 0x801B96F4 -> 0x801B9734
// this: r31
void zMiniGamePufferoidsPlayer::SceneSetup() {}

// Range: 0x801B9734 -> 0x801B9774
// this: r31
void zMiniGamePufferoidsPlayer::Reset() {}

// Range: 0x801B9774 -> 0x801B97C4
// this: r29
...
// Range: 0x801B97C4 -> 0x801B9870
void zMiniGamePufferoidsPlayer::AddStates(struct xAnimTable * table /* r31 */) {}

// total size: 0x128
struct {} zMiniGamePufferoidsPlayer::__vtable; // size: 0x128, address: 0x802E3330
