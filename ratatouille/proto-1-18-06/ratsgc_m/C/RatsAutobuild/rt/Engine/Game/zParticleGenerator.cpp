/*
    ...
    Language: C++
    Code range: 0x8011ADE0 -> 0x8011B834
*/
static int max_system_asset_size; // size: 0x4, address: 0x803C16A8
static class zParticleSystem * * systems; // size: 0x4, address: 0x803C16AC
static class zParticleSystem * * system_handler_set[7]; // size: 0x1C, address: 0x803C16B0
static int system_handler_set_size[7]; // size: 0x1C, address: 0x803C16CC
static struct zParticleGenerator * * generators; // size: 0x4, address: 0x803C16E8
static int max_generators; // size: 0x4, address: 0x803C16EC
static int generators_used; // size: 0x4, address: 0x803C16F0
// Range: 0x8011ADE0 -> 0x8011AEE8
...
// Range: 0x8011AEE8 -> 0x8011AEEC
static void sort_handler_sets() {}

// Range: 0x8011AEEC -> 0x8011AF1C
...
// total size: 0x20
struct {} zParticleGenerator::__vtable; // size: 0x20, address: 0x803BD1F8
// total size: 0x34
struct {} zParticleSystem::__vtable; // size: 0x34, address: 0x803BD218
// total size: 0x8
