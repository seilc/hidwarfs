/*
    ...
    Language: C++
    Code range: 0x8018BE64 -> 0x8018C14C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sTimeSinceLastOneLiner; // size: 0x4, address: 0x803C20A0
// total size: 0x10
struct zNPCOneLiner {
    // Members
...
static struct zNPCOneLinerSystem sInternal; // size: 0x204, address: 0x8038EFE8
static struct zNPCOneLinerSystem sExternal; // size: 0x204, address: 0x8038F1EC
// total size: 0xC
...
static struct zNPCOneLinerExternalSource sExternalSource; // size: 0xC, address: 0x803C20A4
enum iSndGroupHandle {
};
static enum iSndGroupHandle sLastPlayed; // size: 0x4, address: 0x803C20B0
// Range: 0x8018BE64 -> 0x8018BE70
...
// Range: 0x8018BE70 -> 0x8018BE98
static void _AddOneLiner(struct zNPCOneLinerSystem * ols /* r0 */, class zNPCCommon * inSource /* r0 */, enum ezNPCOneLinerType inType /* r0 */, int inPriority /* r0 */, enum iSndGroupHandle inSoundGroup /* r0 */) {
    // Local variables
    struct zNPCOneLiner * ol; // r3
}

// Range: 0x8018BE98 -> 0x8018BF3C
...
union /* @class$813zNPCOneLiner_cpp */ {
...
// total size: 0xC
struct /* @class$812zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1230zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1197zNPCOneLiner_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1198zNPCOneLiner_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1199zNPCOneLiner_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1196zNPCOneLiner_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1201zNPCOneLiner_cpp */ {
    // Members
