/*
    ...
    Language: C++
    Code range: 0x8018B2C8 -> 0x8018BCD4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct /* @class$992zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$923zParticleSystemPuffer_cpp */ {
    // Members
...
union /* @class$746zParticleSystemPuffer_cpp */ {
...
// total size: 0xC
struct /* @class$941zParticleSystemPuffer_cpp */ {
    // Members
...
// total size: 0x10
struct /* @class$1062zParticleSystemPuffer_cpp */ {
    // Members
...
// Range: 0x8018B3B0 -> 0x8018B72C
int zParticleSystemPuffer::update_particles(unsigned char * mem /* r22 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f26 */, void * context /* r0 */) {
    // Local variables
...
struct zParticleGeneratorPuffer : public zParticleGenerator {
    ...
    // Members
protected:
    class zParticleSystemPuffer * system; // offset 0x20, size 0x4
    ...
    float timer; // offset 0x38, size 0x4
    float nextTimeEvent; // offset 0x3C, size 0x4
    unsigned char isParticlesOn; // offset 0x40, size 0x1
    struct xVec3 curLoc; // offset 0x44, size 0xC
    float shrapEmitted; // offset 0x50, size 0x4
    struct zShrapnelAsset * shrapAsset; // offset 0x54, size 0x4
    struct xModelInstance * tempModel; // offset 0x58, size 0x4
};
// Range: 0x8018B72C -> 0x8018BA2C
// this: r30
...
// Range: 0x8018BA2C -> 0x8018BB58
// this: r31
void zParticleGeneratorPuffer::create(class zParticleSystemPuffer & system /* r29 */, struct zParticleAsset & asset /* r30 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
    struct RpAtomic * m; // r0
}

// Range: 0x8018BB58 -> 0x8018BBE0
// this: r31
void zParticleGeneratorPuffer::reset() {}

// Range: 0x8018BBE0 -> 0x8018BC34
// this: r31
void zParticleGeneratorPuffer::activate() {}

// Range: 0x8018BC34 -> 0x8018BC78
// this: r31
void zParticleGeneratorPuffer::deactivate() {}

// Range: 0x8018BC78 -> 0x8018BCD4
// this: r31
...
// total size: 0x20
struct {} zParticleGeneratorPuffer::__vtable; // size: 0x20, address: 0x803BDF38
// total size: 0x34
struct {} zParticleSystemPuffer::__vtable; // size: 0x34, address: 0x803BDF58
// total size: 0x8
