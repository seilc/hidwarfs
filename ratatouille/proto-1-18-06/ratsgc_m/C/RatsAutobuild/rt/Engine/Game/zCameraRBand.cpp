/*
    ...
    Language: C++
    Code range: 0x80168258 -> 0x801683F4
*/
// total size: 0x10
...
struct zSlideCam * rbCam; // size: 0x4, address: 0x803C1CB8
unsigned char zRBAND_CAMERA_ACTIVE; // size: 0x1, address: 0x803C1CBC
// total size: 0x10
