/*
    ...
    Language: C++
    Code range: 0x8019F534 -> 0x8019FAE4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zMiniGameBase * currentMiniGame; // size: 0x4, address: 0x803C21A8
// total size: 0x78
struct {} zMiniGameBase::__vtable; // size: 0x78, address: 0x802E0378
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$816zMiniGameBase_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$837zMiniGameBase_cpp */ {
    // Members
...
union /* @class$833zMiniGameBase_cpp */ {
...
// Range: 0x8019F5D0 -> 0x8019F734
// this: r30
void zMiniGameBase::SwitchGameState(enum eMiniGameState newState /* r31 */) {}

// Range: 0x8019F734 -> 0x8019F7E0
// this: r0
void zMiniGameBase::Update(float dt /* f0 */) {}

// total size: 0x78
struct {} zMiniGameType1::__vtable; // size: 0x78, address: 0x802E0300
// total size: 0x30
...
// Range: 0x8019F824 -> 0x8019F898
void zMiniGameType1::Init(struct xBase & data /* r29 */, struct xDynAsset & asset /* r30 */) {
    // References
    // -> struct zGlobals globals;
}
...
// Range: 0x8019F9B8 -> 0x8019F9BC
void zMiniGameType1::Render() {}

// Range: 0x8019F9BC -> 0x8019FA18
float GetAngleDiff(const struct xVec3 * startDir /* r31 */, const struct xVec3 * endDir /* r0 */) {
    // Local variables
