/*
    ...
    Language: C++
    Code range: 0x8013BD04 -> 0x8013CCA8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8013BD04 -> 0x8013BD28
static void CLAMP021(float min /* f0 */, float * test /* r0 */, float max /* f0 */) {}

// total size: 0xC
struct {} zNPCPerceptionTarget::__vtable; // size: 0xC, address: 0x803BD5C4
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$785zNPCPerception_cpp */ {
    // Members
...
union /* @class$804zNPCPerception_cpp */ {
...
// total size: 0xC
struct /* @class$803zNPCPerception_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1230zNPCPerception_cpp */ {
    // Members
...
// Range: 0x8013BD4C -> 0x8013BD68
// this: r0
void zNPCPerceptionTarget::Reset() {}

// Range: 0x8013BD68 -> 0x8013BD74
// this: r0
void zNPCPerceptionTarget::DamagedBy() {}

// Range: 0x8013BD74 -> 0x8013BDB8
// this: r31
zNPCPerceptionTarget::~zNPCPerceptionTarget() {
    // References
    // -> struct [anonymous] zNPCPerceptionTarget::__vtable;
...
// Range: 0x8013BDB8 -> 0x8013BDC0
// this: r0
void zNPCPerceptionTarget::SetEnt(struct xEnt * inEnt /* r0 */) {}

// Range: 0x8013BDC0 -> 0x8013BDC8
// this: r0
float zNPCPerceptionTarget::GetPriority() {}

// Range: 0x8013BDC8 -> 0x8013BDD8
// this: r0
void zNPCPerceptionTarget::AddToPriority(float addPriority /* f0 */, float importance /* f0 */) {}

// Range: 0x8013BDD8 -> 0x8013BE3C
// this: r29
void zNPCPerceptionTarget::CalculateDistance(class zNPCCommon * owner /* r30 */) {
    // Local variables
...
// Range: 0x8013BE3C -> 0x8013BE44
// this: r0
float zNPCPerceptionTarget::GetDistance() {}

// Range: 0x8013BE44 -> 0x8013BEF4
// this: r30
...
// Range: 0x8013C564 -> 0x8013C624
// this: r27
void zNPCPerception::DamagedBy(struct xEnt * damagedByEnt /* r28 */) {
    // Local variables
    int i; // r29
}

int completeUpdateCount; // size: 0x4, address: 0x803C1968
// Range: 0x8013C624 -> 0x8013C630
void zNPCPerception::ResetCompleteUpdateCount() {
    // References
    // -> int completeUpdateCount;
}

// Range: 0x8013C630 -> 0x8013C63C
// this: r0
void zNPCPerception::ForceCompleteUpdate() {}

// Range: 0x8013C63C -> 0x8013C6AC
// this: r0
...
void zNPCPerception::UpdateCompleteDoWork() {
    ...
    int i; // r26
    int a; // r21
    struct xEnt * tempWidgetTarget; // r21
    int a; // r21
    int a; // r21
    int b; // r24
...
// Range: 0x8013CC70 -> 0x8013CCA8
// this: r3
float zNPCPerception::GetPriorityTargetDistance() {}

// total size: 0x4
struct /* @class$1185zNPCPerception_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1186zNPCPerception_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1187zNPCPerception_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1184zNPCPerception_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1189zNPCPerception_cpp */ {
    // Members
