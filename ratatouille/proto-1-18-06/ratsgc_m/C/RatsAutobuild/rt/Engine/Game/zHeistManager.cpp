/*
    ...
    Language: C++
    Code range: 0x8018F000 -> 0x8018F2E0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zHeistManager * heistManager; // size: 0x4, address: 0x803C20D0
...
// Range: 0x8018F034 -> 0x8018F068
void zHeistManager::Exit() {
    // References
    // -> class zHeistManager * heistManager;
}

// Range: 0x8018F068 -> 0x8018F0B4
// this: r31
void zHeistManager::ShutDown() {}

class zHeistManager * heistManager; // size: 0x4, address: 0x803C20D8
enum _tagTransType {
    eTransType_None = 0,
