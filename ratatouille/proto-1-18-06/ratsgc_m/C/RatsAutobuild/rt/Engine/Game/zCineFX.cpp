/*
    ...
    Language: C++
    Code range: 0x80180920 -> 0x80180EE4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct NCINMap * g_cutmap[64]; // size: 0x100, address: 0x802DEFB8
// total size: 0x14
...
static struct NCINBeNosey * g_noz_ncin; // size: 0x4, address: 0x803C1FD0
static signed char init; // size: 0x1, address: 0x803C1FD4
static struct NCINBeNosey nozey_npc_cinematics; // size: 0x14, address: 0x803C1FD8
// Range: 0x80180A4C -> 0x80180A90
void zCineFXStartup() {
    // References
...
// Range: 0x80180AD4 -> 0x80180AD8
void zCineFXShutdown() {}

// Range: 0x80180AD8 -> 0x80180ADC
void zCineFXSceneSetup() {}

// Range: 0x80180ADC -> 0x80180B5C
...
// Range: 0x80180D0C -> 0x80180D20
// this: r0
void NCINBeNosey::Done() {}

// Range: 0x80180D20 -> 0x80180EC0
...
// Range: 0x80180EC0 -> 0x80180EE4
static void AddTables() {}

// total size: 0x10
struct {} XCSNNosey::__vtable; // size: 0x10, address: 0x803BDE60
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x10
struct {} NCINBeNosey::__vtable; // size: 0x10, address: 0x803BDE70
