/*
    ...
    Language: C++
    Code range: 0x801B1A18 -> 0x801B1BA4
*/
signed char zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C24F0
// total size: 0x0
...
class zComponentPool zComponentPool<zCompLogicRightArm, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C24F4
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801B1A94 -> 0x801B1AB4
// this: r0
void zNPCRightArm::Deactivate() {}

// Range: 0x801B1AB4 -> 0x801B1B64
// this: r28
...
// total size: 0x3C
struct {} zNPCRightArm::__vtable; // size: 0x3C, address: 0x803BE808
