/*
    ...
    Language: C++
    Code range: 0x80165728 -> 0x80166D80
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801658EC -> 0x8016590C
// this: r0
struct xVec3 & zTargetBlender::operator const xVec3&() const {}

// Range: 0x8016590C -> 0x80165914
// this: r3
struct xVec3 & zTargetBlender::Result() const {}

// Range: 0x80165914 -> 0x8016592C
void zTargetBlender::blend(float & o /* r0 */, float a /* f0 */, float b /* f0 */, float s /* f0 */) {}

// Range: 0x8016592C -> 0x80165934
// this: r0
float zTargetBlender::BlendTime() {}

static unsigned int input_disabled; // size: 0x4, address: 0x803C1C58
static unsigned char have_default_orientation; // size: 0x1, address: 0x803C1C5C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static struct xVec3 default_orientation; // size: 0xC, address: 0x803BDA38
static struct zCamPlayer * follow_cam; // size: 0x4, address: 0x803C1C60
// total size: 0x18
struct analog_data {
    // Members
...
static struct xCamGroup global_cam; // size: 0xE0, address: 0x8038E730
...
static struct xCamScreen global_screen; // size: 0x8, address: 0x803C1C64
static class zTargetBlender blendedLookat; // size: 0x48, address: 0x8038E810
static class zTargetBlender blendedMidPoint; // size: 0x48, address: 0x8038E858
static class zTargetBlender blendedFloorMount; // size: 0x48, address: 0x8038E8A0
static unsigned char sYTrackingBelowFloorEnabled; // size: 0x1, address: 0x803C1C6C
static unsigned char firstFrame; // size: 0x1, address: 0x803BDA44
static struct xVec3 lastCameraLookAt; // size: 0xC, address: 0x803C1C70
// total size: 0x10
...
// Range: 0x80165A44 -> 0x80165A48
static void init_debug_cam() {}

// Range: 0x80165A80 -> 0x80165AE4
void zCamSceneExit() {
    // References
...
struct xSerial {};
// total size: 0x4
struct /* @class$1229zCam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1230zCam_cpp */ {
    // Members
...
// Range: 0x80165E90 -> 0x80165EB0
static void zCamRestartDefaultCamera() {}

// Range: 0x80165EB0 -> 0x80165EE0
void zCamSceneSetup() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80165EE0 -> 0x80166070
...
static void zCamCollideTriggersCamTarget(struct xScene * sc /* r25 */) {
    ...
    int i; // r29
    struct zEntTrigger * trig; // r28
    struct xTriggerAsset * tasset; // r27
    ...
    int numVolumes; // r0
    int i; // r27
    class xCamTransition * camTransition; // r28
...
// Range: 0x80166AE8 -> 0x80166BB4
void zCamUpdate(float dt /* f31 */) {
    // Local variables
...
// Range: 0x80166BB4 -> 0x80166BBC
static unsigned char update_debug_cam() {}

// Range: 0x80166BBC -> 0x80166BE8
void zCamPrepareRender() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166BE8 -> 0x80166C18
void zCamBeginRender() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166C18 -> 0x80166C44
void zCamEndRender() {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166C44 -> 0x80166C74
void zCamAdd(struct xCam & cam /* r4 */, unsigned char force_cut /* r5 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166C74 -> 0x80166CA4
void zCamRemove(struct xCam & cam /* r4 */, unsigned char force_cut /* r5 */) {
    // References
    // -> struct zGlobals globals;
}

// Range: 0x80166CA4 -> 0x80166CD8
void zCamSetStartOrientation(unsigned int pointer_id /* r0 */) {
    // Local variables
    unsigned int size; // r1+0x8
    void * a; // r0
    const struct pointer_asset & pa; // r0
}

// Range: 0x80166CD8 -> 0x80166D28
