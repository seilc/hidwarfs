/*
    ...
    Language: C++
    Code range: 0x8014755C -> 0x8014863C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801475F8 -> 0x8014761C
// this: r3
void zParticleSystemSnow::scene_enter() {}

// Range: 0x8014761C -> 0x8014763C
// this: r0
...
// total size: 0xC
struct /* @class$992zParticleSystemSnow_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$923zParticleSystemSnow_cpp */ {
    // Members
...
union /* @class$746zParticleSystemSnow_cpp */ {
...
// total size: 0xC
struct /* @class$941zParticleSystemSnow_cpp */ {
    // Members
...
// Range: 0x80147644 -> 0x80147B94
int zParticleSystemSnow::update_particles(unsigned char * mem /* r21 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f20 */, void * context /* r0 */) {
    // Local variables
    ...
    float newDriftForceZ; // f2
    float driftDistanceX; // f3
...
struct zParticleGeneratorSnow : public zParticleGenerator {
    ...
    // Members
protected:
    class zParticleSystemSnow * system; // offset 0x20, size 0x4
    ...
    unsigned char firstEmit; // offset 0x38, size 0x1
    unsigned char killParticles; // offset 0x39, size 0x1
    int numSubBoxes; // offset 0x3C, size 0x4
    float subBoxRowSize; // offset 0x40, size 0x4
    float subBoxColSize; // offset 0x44, size 0x4
    float subBoxHeight; // offset 0x48, size 0x4
    float subBoxRadius; // offset 0x4C, size 0x4
    struct xMat4x3 subBoxRotMat; // offset 0x50, size 0x40
    struct zParticleSnowSubBox * subBoxList; // offset 0x90, size 0x4
};
// Range: 0x80147B94 -> 0x80147CA4
// this: r29
...
void zParticleGeneratorSnow::update(float dt /* f31 */) {
    ...
    int newBoxes; // r1+0xC
    int partAllocate; // r3
    struct particleLocation * locList; // r28
    int emit; // r29
    float minScale; // f30
    float maxScale; // f29
    float maxRotSpeed; // f28
    struct particleLocation * locPtr; // r27
...
// Range: 0x80148128 -> 0x80148430
// this: r28
void zParticleGeneratorSnow::create(class zParticleSystemSnow & system /* r24 */, struct zParticleAsset & asset /* r29 */) {
    // Local variables
...
// total size: 0x20
struct {} zParticleGeneratorSnow::__vtable; // size: 0x20, address: 0x803BD638
// total size: 0x34
struct {} zParticleSystemSnow::__vtable; // size: 0x34, address: 0x803BD658
// total size: 0x8
