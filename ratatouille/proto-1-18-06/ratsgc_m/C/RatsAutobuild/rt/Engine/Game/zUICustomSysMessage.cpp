/*
    ...
    Language: C++
    Code range: 0x8012F290 -> 0x8012FA04
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char gDontAutoMenu; // size: 0x1, address: 0x803C18F0
...
// total size: 0x50
struct {} zUICustomSysMessageManager::__vtable; // size: 0x50, address: 0x802DB7F8
// total size: 0xC
struct ImageState {
    // Members
...
// Range: 0x8012F33C -> 0x8012F480
// this: r31
void zUICustomSysMessageManager::Init() {}

// Range: 0x8012F480 -> 0x8012F4EC
// this: r0
unsigned char zUICustomSysMessageManager::IsSignalAllowed(unsigned int toEvent /* r0 */) {}

// Range: 0x8012F4EC -> 0x8012F50C
// this: r0
void zUICustomSysMessageManager::SetInvisible(class zUI * uiElement /* r0 */) {}
...
// Range: 0x8012F50C -> 0x8012F934
// this: r29
unsigned char zUICustomSysMessageManager::HandleEvent(struct xBase * from /* r30 */, unsigned int toEvent /* r31 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r28 */) {
    // Local variables
    int i; // r0
    class zUIController * c; // r30
    int i; // r0
...
// total size: 0x2
struct /* @class$1112zUICustomSysMessage_cpp */ {
    // Members
...
// Range: 0x8012F934 -> 0x8012F988
// this: r3
void zUICustomSysMessageManager::PreUpdate(float dt /* f0 */) {}

// Range: 0x8012F988 -> 0x8012FA04
// this: r3
