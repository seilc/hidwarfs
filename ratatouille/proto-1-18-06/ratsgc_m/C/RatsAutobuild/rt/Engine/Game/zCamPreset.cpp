/*
    ...
    Language: C++
    Code range: 0x8016CBD0 -> 0x8016D1D0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$909zCamPreset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$929zCamPreset_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$703zCamPreset_cpp */ {
    // Members
    float yaw; // offset 0x0, size 0x4
    float pitch; // offset 0x4, size 0x4
    float roll; // offset 0x8, size 0x4
...
// Range: 0x8016CCB4 -> 0x8016CCD4
void zCamPreset::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x8016CCD4 -> 0x8016CCD8
void zCamPreset::update_all() {}

// Range: 0x8016CCD8 -> 0x8016CD08
void zCamPreset::apply_on_scene_prepare() {
    // Local variables
    struct zCamPreset * preset; // r0
}

// Range: 0x8016CD08 -> 0x8016CD38
...
// Range: 0x8016CD38 -> 0x8016CE50
struct zCamPreset * zCamPreset::find_preset(unsigned char scene_prepare /* r26 */) {
    // Local variables
    struct zCamPreset * best_preset; // r30
    float best_dist2; // f31
    unsigned char best_has_checkpoint; // r29
    struct xVec3 to; // r1+0x14
    struct zScene & s; // r3
    struct zCamPreset * preset; // r28
    struct zCamPreset * const end_preset; // r27
...
// Range: 0x8016D04C -> 0x8016D050
void zCamPreset::apply() {}

// Range: 0x8016D050 -> 0x8016D094
// this: r0
unsigned char zCamPreset::get_relative(struct xVec3 & offset /* r0 */, float & yaw /* r0 */) const {}

// Range: 0x8016D094 -> 0x8016D140
// this: r30
...
// Range: 0x8016D140 -> 0x8016D1A4
// this: r0
void zCamPreset::event_handler(unsigned int event /* r0 */) {}

// Range: 0x8016D1A4 -> 0x8016D1D0
