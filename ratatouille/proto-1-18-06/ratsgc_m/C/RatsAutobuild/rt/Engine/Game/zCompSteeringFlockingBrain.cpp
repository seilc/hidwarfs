/*
    ...
    Language: C++
    Code range: 0x801C0930 -> 0x801C0A30
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x54
struct {} zCompSteeringFlockingBrain::__vtable; // size: 0x54, address: 0x802E36E8
// total size: 0x8
