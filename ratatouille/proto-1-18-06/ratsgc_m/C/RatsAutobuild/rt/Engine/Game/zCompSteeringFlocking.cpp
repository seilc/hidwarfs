/*
    ...
    Language: C++
    Code range: 0x801AC404 -> 0x801ACA68
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gDefaultFlockingParams; // size: 0x8C, address: 0x80395370
// total size: 0x60
struct {} zCompSteeringFlocking::__vtable; // size: 0x60, address: 0x802E2AB0
// total size: 0x3C
...
// Range: 0x801AC478 -> 0x801AC4B0
// this: r31
void zCompSteeringFlocking::AllAttached() {
    // Local variables
    class zNPCBase * parentNPC; // r0
}
...
// Range: 0x801AC4B0 -> 0x801AC4D0
// this: r0
void zCompSteeringFlocking::Detached() {}

// Range: 0x801AC4D0 -> 0x801AC4F0
// this: r0
void zCompSteeringFlocking::Update(struct xScene * xscn /* r0 */, float dt /* f0 */) {}

static class zNPCBase * gNeighbourNPCs; // size: 0x4, address: 0x803C24C8
static int gNumberNeighbourNPCs; // size: 0x4, address: 0x803C24CC
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
void zCompSteeringFlocking::CalculateForce(struct xVec3 & force /* r29 */, class zSteeringBasicDynamics & steeringDynamics /* r30 */, float dt /* f31 */) {
    ...
    struct xVec3 WallAvoidenceForce; // r1+0x68
    struct xVec3 SphereAvoidenceForce; // r1+0x5C
    struct xVec3 SeperationForce; // r1+0x50
    struct xVec3 PlayerAvoidenceForce; // r1+0x44
    struct xVec3 AlignmentForce; // r1+0x38
    struct xVec3 CohesionForce; // r1+0x2C
    struct xVec3 WanderForce; // r1+0x20
    struct xVec3 SeekForce; // r1+0x14
    struct xVec3 FleeForce; // r1+0x8
...
// total size: 0x4
struct /* @class$786zCompSteeringFlocking_cpp */ {
    // Members
...
union /* @class$805zCompSteeringFlocking_cpp */ {
...
// total size: 0xC
struct /* @class$804zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$751zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zCompSteeringFlocking_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zCompSteeringFlocking_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zCompSteeringFlocking_cpp */ {
    // Members
...
// total size: 0xC
struct {} zCompSteeringFlockingParams::__vtable; // size: 0xC, address: 0x803BE788
// total size: 0x1
