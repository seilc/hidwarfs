/*
    ...
    Language: C++
    Code range: 0x80118C1C -> 0x80119AA4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char unlockedMovies[53]; // size: 0x35, address: 0x803C15E0
char sceneBaseName[32]; // size: 0x20, address: 0x803C1618
char sceneBaseDescription[256]; // size: 0x100, address: 0x8037EFA0
static const char * SCENE_STATUS_BONUS; // size: 0x4, address: 0x803C1638
static unsigned char unlockCheatOn; // size: 0x1, address: 0x803C163C
static unsigned char sceneUnlockAll; // size: 0x1, address: 0x803C163D
int numScenes; // size: 0x4, address: 0x803C1B5C
// total size: 0x20
struct xLinkAsset {
    // Members
...
static char buffer[48]; // size: 0x30, address: 0x803C1640
// Range: 0x80118F3C -> 0x80119024
...
unsigned int loadSceneID; // size: 0x4, address: 0x803C1BB0
// Range: 0x80119024 -> 0x80119094
...
// Range: 0x80119094 -> 0x801190E0
static void ParseTagIgnore(struct jot & j /* r31 */) {}

// Range: 0x801190E0 -> 0x8011914C
static void ParseTagSpace(struct jot & j /* r31 */) {}

static struct tag_type newTags[7]; // size: 0x8C, address: 0x802DB5C8
static unsigned int SCENEFLAGS_UNLOCKED; // size: 0x4, address: 0x803C5D08
// total size: 0x14
struct SceneUnlock {
    // Members
    unsigned int sceneID; // offset 0x0, size 0x4
...
// Range: 0x801191F0 -> 0x80119218
unsigned char zUIIncrediblesIsSceneCompleted(int idx /* r0 */) {}

// Range: 0x80119218 -> 0x80119240
unsigned char zUIIncrediblesIsSceneUnlocked(int idx /* r0 */) {}

static unsigned int SCENEFLAGS_COMPLETED; // size: 0x4, address: 0x803C5D0C
static unsigned int SCENEFLAGS_WAS_COMPLETED; // size: 0x4, address: 0x803C5D10
// total size: 0x18
...
int latestScene; // size: 0x4, address: 0x803C1B68
// Range: 0x80119240 -> 0x80119330
...
// Range: 0x801193B4 -> 0x80119404
unsigned char zUIIncrediblesAllGoalsCompleted() {
    // Local variables
    int i; // r31
}

// Range: 0x80119404 -> 0x801194A0
...
// Range: 0x801194F0 -> 0x80119540
unsigned char zUIIncrediblesAllScenesCompleted() {
    // Local variables
    int i; // r31
}

// Range: 0x80119540 -> 0x80119588
unsigned char zUIIncrediblesAllCompleted() {}

enum UnlockFeature {
    Unlock_Scenes = 0,
};
int numStoryScenes; // size: 0x4, address: 0x803C1B60
int numArenaScenes; // size: 0x4, address: 0x803C1B64
char * allsoaklevels[]; // size: 0x0, address: 0x8038CA60
char sceneBaseImage[32]; // size: 0x20, address: 0x803C1B80
// total size: 0x8
struct xIniValue {
    // Members
...
// Range: 0x80119770 -> 0x801197A4
void zUIIncrediblesSceneSetup() {
    // References
    // -> static const char * SCENE_STATUS_BONUS;
}

// Range: 0x801197A4 -> 0x801197C4
unsigned int zUIIncrediblesGetTotalCheckpoints() {}

// Range: 0x801197C4 -> 0x801197E4
...
// Range: 0x801197E4 -> 0x80119808
void zUIIncrediblesWarp(struct _xCounter * counter /* r0 */) {}

// Range: 0x80119808 -> 0x80119878
...
static struct _zPortal portal; // size: 0x14, address: 0x803C1670
// total size: 0x18
...
static struct xPortalAsset portalAsset; // size: 0x18, address: 0x803C1684
unsigned int SCENE_ID_MNU_START; // size: 0x4, address: 0x803C0B50
unsigned char gExitAfterPause; // size: 0x1, address: 0x803C0694
// Range: 0x80119880 -> 0x80119990
...
static enum ePauseType pause_type; // size: 0x4, address: 0x803C169C
// Range: 0x80119A30 -> 0x80119A38
enum ePauseType zUIIncrediblesGetPauseType() {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x80119A38 -> 0x80119A40
void zUIIncrediblesSetPauseType(enum ePauseType type /* r0 */) {
    // References
    // -> static enum ePauseType pause_type;
}

// Range: 0x80119A40 -> 0x80119A44
void zUIIncrediblesLoad() {}

// Range: 0x80119A44 -> 0x80119A78
unsigned int zUIIncrediblesGetGameProgress() {}

// Range: 0x80119A78 -> 0x80119AA4
