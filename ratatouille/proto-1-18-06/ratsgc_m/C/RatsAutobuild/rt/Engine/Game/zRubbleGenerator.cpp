/*
    ...
    Language: C++
    Code range: 0x80126980 -> 0x80128FB0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int numActiveGenerators; // size: 0x4, address: 0x803C1860
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$819zRubbleGenerator_cpp */ {
    // Members
...
union /* @class$838zRubbleGenerator_cpp */ {
...
static int numActiveRubble; // size: 0x4, address: 0x803C1864
// total size: 0xC
...
static struct zFakeRubbleAsset fakeAsset; // size: 0x5C, address: 0x8037F288
// total size: 0x58
struct config {
    // Members
...
static struct config landDustConfig; // size: 0x58, address: 0x8037F2E4
static class zRubble * rubblePool; // size: 0x4, address: 0x803C1868
static unsigned int rubblePoolCount; // size: 0x4, address: 0x803C186C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$996zRubbleGenerator_cpp */ {
    // Members
    float emitRemaining; // offset 0x0, size 0x4
};
// total size: 0x148
struct /* @class$997zRubbleGenerator_cpp */ {
    // Members
...
// Range: 0x80126A30 -> 0x80126F28
// this: r28
unsigned char zRubble::CalculateSimulationParameters(const struct xVec3 * source /* r29 */, const struct xVec3 * target /* r30 */, float launchAngle /* f30 */, float gravity /* f27 */, float rotations /* f28 */, float totalBouncesDistRatio /* f29 */, unsigned char isSpherical /* r31 */) {
    // Local variables
    float simHeight; // f31
    float dx; // f2
    float dz; // f4
    float totalSimDistance; // f0
    float simDistance1; // f29
    float simDistance0; // f25
    float launchAngleRad; // f24
    float sinLaunchAngle; // f0
    float cosLaunchAngle; // f0
    float tanLaunchAngle; // f0
    float launchAngleCheck; // f3
    float initVelocity; // f0
    float hMax; // f1
    float energyLeftForBounces; // f24
    float V0Endy; // f0
    float c; // f2
    float ang; // f24
...
// Range: 0x801273EC -> 0x8012752C
// this: r27
unsigned char zRubble::DestructibleInit(struct xDestructibleAsset * d_asset /* r28 */) {
    // Local variables
    struct xDestructibleAssetState * d_states; // r31
    unsigned char modelAllocFailed; // r30
    unsigned int i; // r29
    struct xDestructibleAssetAttachedAnimList * ds_state_anim_list; // r0
    unsigned int modelID; // r25
    struct RpAtomic * imodel; // r3
    void * tmp_ptr; // r3
}

// Range: 0x8012752C -> 0x80127578
// this: r0
unsigned char zRubble::HitPlayer() {}

// Range: 0x80127578 -> 0x801275AC
// this: r0
...
// Range: 0x801275AC -> 0x801277C4
// this: r31
unsigned char zRubble::Activate(const struct xVec3 & source /* r25 */, const struct xVec3 & target /* r26 */, float launchAngle /* f29 */, float rotations /* f30 */, float totalBouncesDistRatio /* f31 */, const struct ModelData & data /* r27 */, unsigned int modelID /* r28 */, class zRubbleGenerator * par /* r0 */, enum zRubbleLandType landEffect /* r29 */, enum iSndGroupHandle theLandSoundGroup /* r0 */, unsigned char isSpherical /* r30 */) {
    // Local variables
...
// Range: 0x801277C4 -> 0x80127904
// this: r31
void zRubble::HandleGroundHit(float dt /* f29 */, unsigned int hitNum /* r0 */, unsigned char lastHit /* r0 */) {
    // Local variables
...
// Range: 0x80127AB4 -> 0x80127ADC
// this: r0
void zRubble::SetSmashMePlease(unsigned char smashMe /* r0 */) {}

// Range: 0x80127ADC -> 0x80127B30
// this: r31
void zRubble::ReleaseCircle() {}

// Range: 0x80127B30 -> 0x80127F58
// this: r31
...
// Range: 0x80127F58 -> 0x80127FF4
// this: r31
void zRubble::Reset() {}

// Range: 0x80127FF4 -> 0x80128020
...
struct config default_config; // size: 0x58, address: 0x80387368
// Range: 0x80128020 -> 0x801281B8
void zRubbleGeneratorSceneSetup(struct zScene * scene /* r0 */) {
    // Local variables
    unsigned int randomModelID; // r30
...
// Range: 0x801283CC -> 0x8012841C
void zRubbleGenerator::InitDynamic(struct xBase & data /* r0 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {}

// Range: 0x8012841C -> 0x80128640
// this: r29
zRubbleGenerator::zRubbleGenerator(struct zRubbleGeneratorAsset * asset /* r30 */) {
    // Local variables
    unsigned int * modelIDs; // r31
    unsigned int i; // r24
    unsigned int i; // r6
...
// Range: 0x80128900 -> 0x8012895C
// this: r31
void zRubbleGenerator::Spawn() {}

// Range: 0x8012895C -> 0x80128C6C
// this: r26
void zRubbleGenerator::Spawn(const struct zRubbleMarker & from /* r27 */) {
    // Local variables
    unsigned int spawnStatus[32]; // r1+0x10
    unsigned int spawnStatusCount; // r30
    unsigned int i; // r7
    unsigned int modelIndex; // r0
    const struct ModelData & data; // r29
    unsigned int spawnToIndex; // r28
    unsigned int i; // r5
    const struct zRubbleMarker & to; // r28
    int i; // r24
...
// Range: 0x80128CEC -> 0x80128EC0
void zRubbleGenerator::SetupMarkers(unsigned int baseID /* r27 */, struct zRubbleMarker * & marker /* r30 */, unsigned int & count /* r31 */) {
    // Local variables
    struct xBase * b; // r4
    struct xGroup * group; // r28
    unsigned int i; // r27
...
// total size: 0xC
struct /* @class$837zRubbleGenerator_cpp */ {
    // Members
