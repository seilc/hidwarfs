/*
    ...
    Language: C++
    Code range: 0x80177F98 -> 0x8017A720
*/
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig defaultConfig; // size: 0x44, address: 0x8038EC40
int systemID; // size: 0x4, address: 0x803BDC60
// total size: 0x1
...
static struct TrailConfig defaultTConfig; // size: 0x38, address: 0x803C1D90
int systemID; // size: 0x4, address: 0x803BDC64
// total size: 0x1
class zNPCProjectileTGrubTrail {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x801785D0 -> 0x801786C0
...
struct SparkConfig defaultSparkConfig; // size: 0x34, address: 0x803C1DC8
struct SparkConfig burstSparkConfig; // size: 0x34, address: 0x803C1DFC
int systemID; // size: 0x4, address: 0x803BDC68
// total size: 0x1
class zNPCProjectileGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80178C1C -> 0x80178D34
...
struct SparkConfig defaultESparkConfig; // size: 0x34, address: 0x803C1E30
struct SparkConfig burstESparkConfig; // size: 0x34, address: 0x803C1E64
int systemID; // size: 0x4, address: 0x803BDC6C
// total size: 0x1
class zNPCProjectileEGrubSparks {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x80179388 -> 0x80179510
...
static struct ArcConfig defaultArcConfig; // size: 0x1C, address: 0x803C1E98
int systemID; // size: 0x4, address: 0x803BDC70
// total size: 0x1
class zNPCProjectileGrubArc {
    // Static members
    static int systemID; // size: 0x4
};
// Range: 0x8017989C -> 0x80179954
...
static unsigned int HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x803C1EB4
// total size: 0x10
...
static struct GrubHitExplosion * sHitExplosions; // size: 0x4, address: 0x803C1EB8
unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
// Range: 0x80179E6C -> 0x80179EA0
...
static unsigned int BIG_HIT_EXPLOSION_MODEL_ID; // size: 0x4, address: 0x803C1EBC
// total size: 0x80
...
static struct GrubBigHitExplosion * sBigHitExplosions; // size: 0x4, address: 0x803C1EC0
// total size: 0x10
struct _xFColor {
    // Members
...
// Range: 0x8017A620 -> 0x8017A650
void zNPCProjectileGrubFX_SceneSetup() {}

// Range: 0x8017A650 -> 0x8017A660
...
// Range: 0x8017A660 -> 0x8017A684
void zNPCProjectileGrubFX_SceneReset() {}

// Range: 0x8017A684 -> 0x8017A6B8
void zNPCProjectileGrubFX_Update(float dt /* f31 */) {}

// Range: 0x8017A6B8 -> 0x8017A6DC
