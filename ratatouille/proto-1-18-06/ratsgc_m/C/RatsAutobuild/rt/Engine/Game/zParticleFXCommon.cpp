/*
    ...
    Language: C++
    Code range: 0x80129280 -> 0x8012956C
*/
// total size: 0xC
...
static class EnergyPulseSystem energy_pulse_system; // size: 0xC, address: 0x803C1870
// total size: 0x1
struct EmitState {};
// total size: 0x4
...
static class RubbleSystem rubble_system; // size: 0xC, address: 0x803C187C
// total size: 0x8
struct EmitState : public EmitState {
    // Members
...
static class FlameConeSystem flame_cone_system; // size: 0xC, address: 0x803C1888
// total size: 0x30
struct EmitState : public EmitState {
    // Members
    struct xVec3 travel_dir; // offset 0x8, size 0xC
...
static class SmokePuffSystem smoke_puff_system; // size: 0xC, address: 0x803C1894
// total size: 0xC
class RegisterOnFirstEmitSystem : public zParticleSystemHelper {
    // Members
    unsigned char registered; // offset 0x4, size 0x1
...
static class LavaDripSystem lava_drip_system; // size: 0xC, address: 0x803C18A0
// total size: 0x40
struct EmitState : public EmitState {
    // Members
...
static class SparkSystem spark_system; // size: 0xC, address: 0x803C18AC
// total size: 0x4
struct EmitState : public EmitState {
    // Members
    float radius; // offset 0x0, size 0x4
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleUVStaticTile<3, 3, zParticleEmitterConeSurface<zParticleColorWhiteFadeOut<zParticleMoverLinearDecel<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size_uv2, zParticleBase>>>>>>, EnergyPulseSystem>::__vtable; // size: 0xC, address: 0x803BD450
// total size: 0xC
struct {} EnergyPulseSystem::__vtable; // size: 0xC, address: 0x803BD45C
// Range: 0x8012935C -> 0x801293B4
// this: r31
void EnergyPulseSystem::Register() {
    // Local variables
    struct RwTexture * texture; // r8
}
...
// total size: 0x4
struct /* @class$923zParticleFXCommon_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zParticleFXCommon_cpp */ {
    // Members
...
union /* @class$746zParticleFXCommon_cpp */ {
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeSurface<zParticleColorWhiteOpaque<zParticleMoverGravity<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, RubbleSystem>::__vtable; // size: 0xC, address: 0x803BD468
// total size: 0xC
struct {} RubbleSystem::__vtable; // size: 0xC, address: 0x803BD474
// Range: 0x801293B4 -> 0x8012940C
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, FlameConeSystem>::__vtable; // size: 0xC, address: 0x803BD480
// total size: 0xC
struct {} FlameConeSystem::__vtable; // size: 0xC, address: 0x803BD48C
// Range: 0x8012940C -> 0x80129464
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorToBlackFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SmokePuffSystem>::__vtable; // size: 0xC, address: 0x803BD498
// total size: 0xC
struct {} SmokePuffSystem::__vtable; // size: 0xC, address: 0x803BD4A4
// Range: 0x80129464 -> 0x801294BC
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverLinearVel<zParticleRadiusPercent<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, LavaDripSystem>::__vtable; // size: 0xC, address: 0x803BD4B0
// total size: 0xC
struct {} LavaDripSystem::__vtable; // size: 0xC, address: 0x803BD4BC
// Range: 0x801294BC -> 0x80129514
// this: r31
...
// total size: 0xC
struct {} RegisterOnFirstEmitSystem<zParticleEmitterConeVolume<zParticleColorWhiteFadeOut<zParticleMoverGravity<zParticleRadiusConst<zParticlePoolType<ptank_pool__pos_color_size, zParticleBase>>>>>, SparkSystem>::__vtable; // size: 0xC, address: 0x803BD4C8
// total size: 0xC
struct {} SparkSystem::__vtable; // size: 0xC, address: 0x803BD4D4
// Range: 0x80129514 -> 0x8012956C
// this: r31
