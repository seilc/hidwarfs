/*
    ...
    Language: C++
    Code range: 0x801564D0 -> 0x80157EE4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct _xFColor default_color; // size: 0x10, address: 0x803C68E0
static struct _xFColor mid_color; // size: 0x10, address: 0x803C68F0
static struct _xFColor weak_color; // size: 0x10, address: 0x803C6900
static float lifetime; // size: 0x4, address: 0x803BD960
static float life_rand; // size: 0x4, address: 0x803BD964
static float size_min; // size: 0x4, address: 0x803BD968
static float size_rand; // size: 0x4, address: 0x803BD96C
static float velocity; // size: 0x4, address: 0x803BD970
static float velocity_rand; // size: 0x4, address: 0x803BD974
static float glint_length_min; // size: 0x4, address: 0x803C1B28
static float glint_length_rand; // size: 0x4, address: 0x803BD978
static float gravity; // size: 0x4, address: 0x803BD97C
static int fraction; // size: 0x4, address: 0x803BD980
static class zForceFieldEffect FFEList[9]; // size: 0x7E0, address: 0x80388D60
static struct RwRaster * energy_raster; // size: 0x4, address: 0x803C1B2C
static int sparkSystemID; // size: 0x4, address: 0x803BD984
static int glintSystemID; // size: 0x4, address: 0x803BD988
static int electricSystemID; // size: 0x4, address: 0x803BD98C
// total size: 0x1C
struct ArcConfig {
    // Members
...
static struct ArcConfig sNPCProjectileGrubArcShieldBreakConfig; // size: 0x1C, address: 0x803C6910
// Range: 0x801564D0 -> 0x801564F8
static void unit_sphere_size(int & verts_size /* r0 */, int & indices_size /* r0 */, int rows /* r0 */, int cols /* r0 */) {}

// Range: 0x801564F8 -> 0x80156558
...
// Range: 0x80156558 -> 0x8015658C
static void scroll_v(struct xVec2 * ouv /* r3 */, const struct xVec2 * iuv /* r4 */, int size /* r0 */, float uoffset /* f0 */) {
    // Local variables
    struct xVec2 * end_ouv; // r0
}

// Range: 0x8015658C -> 0x80156660
static void unit_sphere_calc_indices(unsigned short * indices /* r3 */, int rows /* r0 */, int cols /* r5 */) {
    // Local variables
    int i; // r7
    int j; // r7
...
// total size: 0x4
struct /* @class$828zForceFieldEffect_cpp */ {
    // Members
    struct xVec3 * verts; // offset 0x0, size 0x4
};
// total size: 0x0
...
void zForceFieldEffect::unit_sphere_calc_vertices(struct xVec3 * verts /* r29 */, int rows /* r30 */, int cols /* r31 */) {
    ...
    struct xVec3 * v; // r27
    struct xVec3 row_dir; // r1+0x1C
    int i; // r26
    struct xVec3 col_dir; // r1+0x10
    int j; // r29
}
...
// Range: 0x80156D74 -> 0x80157134
// this: r31
void zForceFieldEffect::animate_heightmap(float dt /* f30 */) {
    // Local variables
    float d; // f0
    float Anew; // f30
    float Adelta; // r1+0x8
...
union /* @class$776zForceFieldEffect_cpp */ {
...
// total size: 0xC
struct /* @class$848zForceFieldEffect_cpp */ {
    // Members
...
// Range: 0x80157134 -> 0x801571B4
// this: r0
void zForceFieldEffect::copy_buffers(struct xIMLockContext & energy_lock /* r0 */, const struct xVec3 * verts /* r23 */, const struct xColor_tag * colors /* r24 */) {
    // Local variables
    const unsigned short * indices; // r30
    int indices_size; // r29
    struct xVec3 * lock_pos; // r28
    struct xColor_tag * lock_color; // r27
    int i; // r26
    int index; // r25
}

void * RwEngineInstance; // size: 0x4, address: 0x803C3054
// Range: 0x801571B4 -> 0x8015746C
// this: r28
void zForceFieldEffect::shade_sphere(struct xVec3 * verts /* r31 */, struct xColor_tag * colors /* r29 */, const struct _xFColor * shieldColor /* r30 */) {
    ...
    const float * hmap; // r6
    float halfHeight; // f3
    const struct xVec3 * iv; // r7
    struct xVec3 * ov; // r8
    struct xVec3 * endov; // r9
    struct xColor_tag * color; // r10
...
// Range: 0x80157900 -> 0x801579E8
// this: r31
void zForceFieldEffect::Update(float dt /* f31 */) {}

// Range: 0x801579E8 -> 0x80157B90
// this: r31
...
// Range: 0x80157BF8 -> 0x80157BFC
void zForceFieldEffect::RenderBack() {}

static int rows; // size: 0x4, address: 0x803C1B30
static signed char init; // size: 0x1, address: 0x803C1B34
static int cols; // size: 0x4, address: 0x803C1B38
static signed char init; // size: 0x1, address: 0x803C1B3C
enum xIMFormat {
    XIM_TRISTRIP = 4,
    XIM_TRILIST = 3,
};
