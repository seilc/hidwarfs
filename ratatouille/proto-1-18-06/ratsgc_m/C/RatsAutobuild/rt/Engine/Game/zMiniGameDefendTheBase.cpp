/*
    ...
    Language: C++
    Code range: 0x801A5F8C -> 0x801A7160
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zMiniGameDefendTheBaseEnemy sEnemies[50]; // size: 0x15E0, address: 0x80393990
static class zMiniGameDefendTheBaseEnemy * sEnemyPool; // size: 0x4, address: 0x803BE3D8
static unsigned int ENEMY_MODEL_ID; // size: 0x4, address: 0x803C23C8
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x803C23CC
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x803C23D0
static unsigned int WAVE_BOX_ID; // size: 0x4, address: 0x803C23D4
static unsigned int WAVE_DONE_BOX_ID; // size: 0x4, address: 0x803C23D8
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x803C23DC
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x803C23E0
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x803C23E4
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x803C23E8
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x803C23EC
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0xC
struct /* @class$835zMiniGameDefendTheBase_cpp */ {
    // Members
...
union /* @class$836zMiniGameDefendTheBase_cpp */ {
...
class zMiniGameDefendTheBasePlayer : public zMiniGamePlayer {
    // Members
protected:
    class zMiniGameDefendTheBasePlayerShot shots[20]; // offset 0xB20, size 0x780
    int maxBaseHP; // offset 0x12A0, size 0x4
    int currentBaseHP; // offset 0x12A4, size 0x4
    int enemiesKilled; // offset 0x12A8, size 0x4
    int wavesWon; // offset 0x12AC, size 0x4
    float coolDown; // offset 0x12B0, size 0x4
    float coolDownTimer; // offset 0x12B4, size 0x4
};
// total size: 0x4
...
// Range: 0x801A62D8 -> 0x801A6310
// this: r0
float zMiniGameDefendTheBaseEnemy::GetRadius() {}

// Range: 0x801A6310 -> 0x801A635C
// this: r31
...
void Wave::Update(float dt /* f30 */) {
    ...
    class zMiniGameDefendTheBaseEnemy * curr; // r26
    class zMiniGameDefendTheBaseEnemy * prev; // r27
    class zMiniGameDefendTheBaseEnemy * next; // r28
...
// total size: 0x4
struct /* @class$816zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x78
struct {} zMiniGameDefendTheBase::__vtable; // size: 0x78, address: 0x802E28F8
// total size: 0x1
struct /* @class$1087zMiniGameDefendTheBase_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1089zMiniGameDefendTheBase_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1090zMiniGameDefendTheBase_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$1091zMiniGameDefendTheBase_cpp */ {
    // Members
...
enum /* @enum$1092zMiniGameDefendTheBase_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$1093zMiniGameDefendTheBase_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$1094zMiniGameDefendTheBase_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$1096zMiniGameDefendTheBase_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$1084zMiniGameDefendTheBase_cpp */ {
    // Members
...
// Range: 0x801A698C -> 0x801A6AA0
void zMiniGameDefendTheBase::Init(struct xBase & data /* r29 */, struct xDynAsset & asset /* r28 */) {
    // Local variables
    int j; // r28
    int i; // r6
...
// Range: 0x801A6C5C -> 0x801A6C84
// this: r0
void zMiniGameDefendTheBase::EndGame() {}

static char statsBuf[4][128]; // size: 0x200, address: 0x80394F70
static char waveBuf[32]; // size: 0x20, address: 0x803C23F0
// Range: 0x801A6C84 -> 0x801A6F14
// this: r31
void zMiniGameDefendTheBase::Update(float dt /* f31 */) {
    // Local variables
    int prevAlivePlayer; // r25
    int aliveCount; // r26
    int i; // r27
    int j; // r24
...
// Range: 0x801A70C8 -> 0x801A7160
// this: r26
int zMiniGameDefendTheBase::WhichPlayerBase(unsigned int id /* r27 */) {
    // Local variables
    int i; // r29
    unsigned int j; // r28
}
...
// total size: 0x1C
struct {} zMiniGameObject::__vtable; // size: 0x1C, address: 0x803BE3DC
// total size: 0x1C
struct {} zMiniGameDefendTheBaseEnemy::__vtable; // size: 0x1C, address: 0x803BE3F8
