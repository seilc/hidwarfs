/*
    ...
    Language: C++
    Code range: 0x801C1AE0 -> 0x801C2578
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zNPCGateMgr gNPCGateMgr; // size: 0xC, address: 0x803C2740
// Range: 0x801C1AE0 -> 0x801C1B24
void zNPCGateMgr::SceneSetup() {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
}

// Range: 0x801C1B24 -> 0x801C1B40
// this: r0
void zNPCGateMgr::Assign(class zNPCGate * npcGate /* r0 */) {}

// Range: 0x801C1B40 -> 0x801C1B94
...
// Range: 0x801C1C50 -> 0x801C1CA8
void zNPCGate::InitDynamic(struct xBase & data /* r0 */, struct xDynAsset & asset /* r30 */, unsigned long asset_size /* r31 */) {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
}

// Range: 0x801C1CA8 -> 0x801C1D04
// this: r30
zNPCGate::zNPCGate(struct zNPCGateAsset * asset /* r31 */) {}

// Range: 0x801C1D04 -> 0x801C1D30
void zNPCGate::EventHandler(struct xBase * to /* r0 */, unsigned int toEvent /* r0 */) {
    // Local variables
    class zNPCGate * npcGate; // r0
}

// Range: 0x801C1D30 -> 0x801C1D70
// this: r31
void zNPCGate::Setup() {
    // References
    // -> static class zNPCGateMgr gNPCGateMgr;
...
// total size: 0x1
struct /* @class$838zNPCGate_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$839zNPCGate_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$840zNPCGate_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$841zNPCGate_cpp */ {
    // Members
