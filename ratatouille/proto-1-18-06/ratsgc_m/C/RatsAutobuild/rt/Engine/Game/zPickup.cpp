/*
    ...
    Language: C++
    Code range: 0x80114D58 -> 0x801163B0
*/
// total size: 0xC
struct RwV3d {
    // Members
...
static struct xMat3x3 sPickupOrientation; // size: 0x30, address: 0x803BD160
float PICKUP_FADE_DIST_SQR; // size: 0x4, address: 0x803C14D8
float PICKUP_CULL_DIST_SQR; // size: 0x4, address: 0x803C14DC
// total size: 0x8
struct xBaseAsset {
    // Members
...
struct Table * table; // size: 0x4, address: 0x803C14E0
class zPickup * extras; // size: 0x4, address: 0x803C14E4
struct InstanceAsset * extra_assets; // size: 0x4, address: 0x803C14E8
int extras_used; // size: 0x4, address: 0x803C14EC
int extras_max; // size: 0x4, address: 0x803C14F0
struct zSparkEmitterAsset * sparkEmitterAsset; // size: 0x4, address: 0x803C14F4
float lastdt; // size: 0x4, address: 0x803C14F8
struct xFXRibbon ribbon[4]; // size: 0x40, address: 0x803C14FC
float spiralDecay; // size: 0x4, address: 0x803C153C
static struct curve_node ribbon_curve[2]; // size: 0x18, address: 0x803C5BE8
// total size: 0x10
struct glintInfo {
    // Members
...
static struct zSparkEmitterAsset _sparkEmitterAsset; // size: 0x94, address: 0x8037EF08
// total size: 0x20
struct xLinkAsset {
    // Members
...
class zPickup : public xBase {
    ...
    static struct xFXRibbon ribbon[4]; // size: 0x40
...
// Range: 0x80114E00 -> 0x80114E20
void zPickup::ResetAll() {}

// Range: 0x80114E20 -> 0x80114E40
void zPickup::InitDynamic(struct xBase & obj /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
static struct config_type cfg; // size: 0x20, address: 0x803C1540
// Range: 0x80114E40 -> 0x801150EC
// this: r31
unsigned char zPickup::Init(struct InstanceAsset & asset_ /* r0 */) {
    // Local variables
...
// Range: 0x80115184 -> 0x801151C4
void zPickupEventCB(struct xBase * from /* r4 */, struct xBase * to /* r0 */, unsigned int toEvent /* r5 */, const float * toParam /* r7 */, struct xBase * toParamWidget /* r8 */, unsigned int toParamWidgetID /* r9 */) {}

// Range: 0x801151C4 -> 0x80115294
// this: r3
void zPickup::EventCB(struct xBase * to /* r5 */, unsigned int toEvent /* r0 */) {}

static unsigned int SCENEFLAGS_GALLERY; // size: 0x4, address: 0x803C5C14
// Range: 0x80115294 -> 0x8011535C
...
// Range: 0x80115408 -> 0x8011546C
// this: r0
unsigned char zPickup::CanGalleryPickupBeUsed(struct zPlayer * player /* r4 */) const {}

// Range: 0x8011546C -> 0x80115518
// this: r31
void zPickup::BeUsed() {}

// Range: 0x80115518 -> 0x80115594
// this: r31
...
// Range: 0x8011570C -> 0x80115710
void zPickup::UpdateFX() {}

// Range: 0x80115710 -> 0x80115788
...
// total size: 0x4
struct /* @class$1198zPickup_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1199zPickup_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x8011600C -> 0x8011606C
// this: r31
void zPickup::DestroyExtra() {}

// Range: 0x8011606C -> 0x80116100
