/*
    ...
    Language: C++
    Code range: 0x800F5334 -> 0x800F6C0C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int isStartOnKey; // size: 0x4, address: 0x803C12F0
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$823zIncrediSlam_cpp */ {
    // Members
...
union /* @class$846zIncrediSlam_cpp */ {
...
// total size: 0xC
struct /* @class$727zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$728zIncrediSlam_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$730zIncrediSlam_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zIncrediSlam_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zIncrediSlam_cpp */ {
    // Members
...
private:
    ...
    struct xResponseCurve curve; // offset 0x5F28, size 0x10
    struct emit_context ec; // offset 0x5F38, size 0x5C
    enum iSndGroupHandle sound; // offset 0x5F94, size 0x4
    int hitPoints; // offset 0x5F98, size 0x4
    float hitRadius; // offset 0x5F9C, size 0x4
};
// Range: 0x800F5334 -> 0x800F5368
void * zIncrediSlam::operator new(unsigned long size /* r31 */) {
    // Local variables
    class zIncrediSlamMgr * mgr; // r0
}

unsigned int tweakSlamWaveTextureID; // size: 0x4, address: 0x803C12F4
unsigned int tweakSlamParticleTextureID; // size: 0x4, address: 0x803C12F8
// total size: 0x34
struct RwRaster {
    // Members
...
// total size: 0x50
struct /* @class$1257zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x44
struct /* @class$1258zIncrediSlam_cpp */ {
    // Members
...
// Range: 0x800F5600 -> 0x800F56AC
// this: r31
void zIncrediSlam::Update(float dt /* f31 */) {}

// Range: 0x800F56AC -> 0x800F56BC
// this: r0
unsigned char zIncrediSlam::Cull() {}

// Range: 0x800F56BC -> 0x800F56F4
// this: r0
...
static struct curve_node footstep_curve[3]; // size: 0x54, address: 0x802AEE50
// Range: 0x800F56F4 -> 0x800F579C
// this: r31
...
// Range: 0x800F579C -> 0x800F57A0
void zIncrediSlam::AddTweaks() {}
...
// Range: 0x800F58A4 -> 0x800F58A8
void zIncrediSlam::GenerateParticle() {}

// Range: 0x800F58A8 -> 0x800F59E8
// this: r28
...
// total size: 0xC
struct /* @class$1011zIncrediSlam_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
// Range: 0x800F59E8 -> 0x800F5D08
// this: r31
void zIncrediSlam::Start(const struct xMat4x3 & _startMat /* r29 */, float _hitRadius /* f0 */, signed short _hitPoints /* r0 */, struct config * new_cfg /* r0 */, struct xEnt * _owner /* r0 */, unsigned char drawDecal /* r28 */, enum zHitSource _hitSource /* r0 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1246zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1213zIncrediSlam_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1214zIncrediSlam_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1215zIncrediSlam_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1212zIncrediSlam_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1217zIncrediSlam_cpp */ {
    // Members
...
// Range: 0x800F6794 -> 0x800F6798
void zIncrediSlam::BeginRender() {}

// Range: 0x800F6798 -> 0x800F679C
void zIncrediSlam::EndRender() {}

class zIncrediSlamMgr * incrediSlamMgr; // size: 0x4, address: 0x803C12FC
// total size: 0xC
...
// Range: 0x800F67F0 -> 0x800F6808
void zIncrediSlamMgr::Remove() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x800F6808 -> 0x800F6854
...
// Range: 0x800F6854 -> 0x800F6860
// this: r0
void zIncrediSlam::SetInactive() {}

// Range: 0x800F6860 -> 0x800F686C
// this: r0
zIncrediSlamMgr::zIncrediSlamMgr() {}

// Range: 0x800F686C -> 0x800F697C
// this: r31
class zIncrediSlam * zIncrediSlamMgr::GetMem(unsigned long size /* r30 */) {
    // Local variables
    class zIncrediSlam * mem; // r3
    class zIncrediSlam * prev; // r5
    unsigned int i; // r0
    class zIncrediSlam * mem; // r3
...
// Range: 0x800F6A90 -> 0x800F6ABC
void zIncrediSlamMgr::Render() {
    // References
    // -> class zIncrediSlamMgr * incrediSlamMgr;
}

// Range: 0x800F6ABC -> 0x800F6AFC
// this: r0
