/*
    ...
    Language: C++
    Code range: 0x801A7398 -> 0x801A7C00
*/
static unsigned char sConditionMadeChange; // size: 0x1, address: 0x803C2410
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x1
struct /* @class$772zMission_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$773zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$774zMission_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$775zMission_cpp */ {
    // Members
...
// Range: 0x801A73C4 -> 0x801A7434
void zTask::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */) {
    // Local variables
    class zTask * newTask; // r0
}

// Range: 0x801A7434 -> 0x801A7438
void zTask::Reset() {}

// Range: 0x801A7438 -> 0x801A74C0
// this: r29
void zTask::Setup() {
    // Local variables
    int i; // r30
...
// Range: 0x801A74C0 -> 0x801A7514
// this: r0
void zTask::HandleEvent(unsigned int toEvent /* r0 */) {}

// Range: 0x801A7514 -> 0x801A7544
// this: r0
void zTask::Fail() {}

// Range: 0x801A7544 -> 0x801A7594
// this: r31
void zTask::Complete() {}

// Range: 0x801A7594 -> 0x801A75DC
// this: r0
...
// Range: 0x801A75DC -> 0x801A75FC
// this: r0
void zTask::OnChangeInConditions() {}

// Range: 0x801A75FC -> 0x801A7678
// this: r30
...
// Range: 0x801A7738 -> 0x801A77A8
void zMission::Init(struct xBase & data /* r30 */, struct xDynAsset & dynasset /* r31 */) {
    // Local variables
    class zMission * newMission; // r0
}

// Range: 0x801A77A8 -> 0x801A77AC
void zMission::Reset() {}

// Range: 0x801A77AC -> 0x801A784C
// this: r29
void zMission::Setup() {
    // Local variables
    int i; // r30
...
// Range: 0x801A784C -> 0x801A7880
// this: r0
void zMission::Unlock() {}

// Range: 0x801A7880 -> 0x801A78A8
// this: r0
void zMission::Lock() {}

// Range: 0x801A78A8 -> 0x801A78FC
// this: r0
void zMission::HandleEvent(unsigned int toEvent /* r0 */) {}

// Range: 0x801A78FC -> 0x801A7968
// this: r3
void zMission::TestForUnlocking() {
    // Local variables
    int i; // r0
    class zMission * rq; // r5

    // References
    // -> static unsigned char sConditionMadeChange;
}

// Range: 0x801A7968 -> 0x801A79FC
// this: r3
...
// Range: 0x801A79FC -> 0x801A7A30
// this: r31
void zMission::OnChangeInConditions() {}

// Range: 0x801A7A30 -> 0x801A7A60
static struct xBase * _MissionIterator(struct xBase * obj /* r3 */) {
    // Local variables
    class zMission * mission; // r31
}

// Range: 0x801A7A60 -> 0x801A7A90
static struct xBase * _TaskIterator(struct xBase * obj /* r3 */) {
    // Local variables
    class zTask * task; // r31
}

// Range: 0x801A7A90 -> 0x801A7B0C
void zMission::OnChangeInMissionConditions() {
    // References
    // -> static unsigned char sConditionMadeChange;
}

// Range: 0x801A7B0C -> 0x801A7B70
// this: r0
void zMission::Save(struct xSerial * s /* r4 */) {
    // Local variables
    unsigned int output; // r5
}

// Range: 0x801A7B70 -> 0x801A7C00
// this: r31
void zMission::Load(struct xSerial * s /* r4 */) {
    // Local variables
    unsigned int input; // r1+0x8
}
