/*
    ...
    Language: C++
    Code range: 0x8015CC14 -> 0x8015D254
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int instanceCount; // size: 0x4, address: 0x803C1C00
int lastUpgradeValue; // size: 0x4, address: 0x803C1C04
static signed char init; // size: 0x1, address: 0x803C1C08
// total size: 0x8
struct Threshold {
    // Members
...
// total size: 0x4
struct /* @class$786zEconomics_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$806zEconomics_cpp */ {
    // Members
...
static class zEconomics economics; // size: 0xC9C, address: 0x8038CE28
enum xCamCoordType {
...
void zEconomics::ParseINI(struct xIniFile * ini /* r31 */) {
    ...
    int i; // r23
    int level; // r22
    const char * levelName; // r21
    int npc; // r20
    const char * NPCName; // r23
    int i; // r20
}

// Range: 0x8015CF1C -> 0x8015CF4C
// this: r0
...
// Range: 0x8015CF88 -> 0x8015CFC8
// this: r0
int zEconomics::GetUpgradesEarned(int expPoints /* r0 */) {
    // Local variables
    int points; // r7
    int earnedUpgrades; // r8
    int i; // r0
}

// total size: 0x4
struct /* @class$1213zEconomics_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1214zEconomics_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1215zEconomics_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1212zEconomics_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1217zEconomics_cpp */ {
    // Members
...
// Range: 0x8015D004 -> 0x8015D008
void zEconomics::GiveComboPoints() {}

// Range: 0x8015D008 -> 0x8015D118
char * zEconomics::GetLevelName(int level /* r0 */) {
    // Local variables
    const char * name; // r3
}

// Range: 0x8015D118 -> 0x8015D128
char * zEconomics::GetNPCName() {
    // Local variables
    const char * name; // r3
}

// Range: 0x8015D128 -> 0x8015D254
