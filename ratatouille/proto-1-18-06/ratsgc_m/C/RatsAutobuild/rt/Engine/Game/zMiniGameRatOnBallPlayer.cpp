/*
    ...
    Language: C++
    Code range: 0x801AEF2C -> 0x801B0DC4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct compositeEffect rumbleEffects[3]; // size: 0xF0, address: 0x80395400
// total size: 0x40
...
// total size: 0xC
struct /* @class$1101zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$786zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
union /* @class$805zMiniGameRatOnBallPlayer_cpp */ {
...
// total size: 0xC
struct /* @class$804zMiniGameRatOnBallPlayer_cpp */ {
    // Members
...
// Range: 0x801B032C -> 0x801B036C
// this: r31
void zMiniGameRatOnBallPlayer::SceneSetup() {}

// Range: 0x801B036C -> 0x801B03B4
class zUIImage * zMiniGameRatOnBallPlayer::FindUIObject(const char * prefix /* r0 */, const char * desc /* r31 */) {
    // Local variables
    char txt[256]; // r1+0x8
    class zUIImage * img; // r0
}

// Range: 0x801B03B4 -> 0x801B0560
// this: r30
void zMiniGameRatOnBallPlayer::SceneSetupUI(const char * prefix /* r31 */) {}

// Range: 0x801B0560 -> 0x801B05A4
// this: r0
void zMiniGameRatOnBallPlayer::DisplayWinnerIcon(unsigned char visible /* r0 */) {}

// Range: 0x801B05A4 -> 0x801B064C
// this: r30
void zMiniGameRatOnBallPlayer::SceneSetupBall(int idx /* r0 */) {
    // Local variables
    char * ballModelName[4]; // r1+0x8
    unsigned int modelID; // r0
    struct RpAtomic * imodel; // r0
}

// Range: 0x801B064C -> 0x801B06DC
// this: r29
void zMiniGameRatOnBallPlayer::SceneSetupParticles(int idx /* r0 */) {
    // Local variables
...
// Range: 0x801B06DC -> 0x801B0780
// this: r31
void zMiniGameRatOnBallPlayer::Reset() {}

// Range: 0x801B0780 -> 0x801B07A0
// this: r0
void zMiniGameRatOnBallPlayer::Exit() {}

// Range: 0x801B07A0 -> 0x801B08C4
// this: r31
...
// Range: 0x801B08C4 -> 0x801B09FC
// this: r28
void zMiniGameRatOnBallPlayer::ApplyPickup(int applyPickup /* r0 */, float activeTime /* f31 */) {
    // Local variables
    int i; // r29
...
// total size: 0x138
struct {} zMiniGameRatOnBallPlayer::__vtable; // size: 0x138, address: 0x802E2B88
// total size: 0x50
