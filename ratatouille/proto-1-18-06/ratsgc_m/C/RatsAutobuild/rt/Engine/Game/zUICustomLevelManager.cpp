/*
    ...
    Language: C++
    Code range: 0x80159534 -> 0x80159AF8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct Scene scenes[200]; // size: 0x2580, address: 0x80389540
// total size: 0x14
struct SceneUnlock {
    // Members
...
static struct SceneUnlock scenesUnlock[200]; // size: 0xFA0, address: 0x8038BAC0
static unsigned int sceneCurrent; // size: 0x4, address: 0x803C1B58
...
char * allsoaklevels[200]; // size: 0x320, address: 0x8038CA60
// Range: 0x80159534 -> 0x8015953C
unsigned int zUIIncrediblesGetNumScenes() {
    // References
    // -> int numScenes;
}

// Range: 0x8015953C -> 0x80159544
void zUIIncrediblesSetSceneCurrent(unsigned int value /* r0 */) {
    // References
    // -> static unsigned int sceneCurrent;
}

// Range: 0x80159544 -> 0x8015954C
...
class zUISceneGroups sSceneGroups; // size: 0x54, address: 0x8038CD80
// total size: 0xC
...
static unsigned int cMissionCounterID; // size: 0x4, address: 0x803C1B6C
static signed char init; // size: 0x1, address: 0x803C1B70
static unsigned int cMissionValidCounterID; // size: 0x4, address: 0x803C1B74
static signed char init; // size: 0x1, address: 0x803C1B78
// Range: 0x80159A10 -> 0x80159AC4
