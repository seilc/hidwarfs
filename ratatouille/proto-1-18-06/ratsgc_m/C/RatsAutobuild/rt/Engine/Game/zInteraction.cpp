/*
    ...
    Language: C++
    Code range: 0x80107000 -> 0x80109B50
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float sAlphaUpRate; // size: 0x4, address: 0x803BCFE0
static float sAlphaDownRate; // size: 0x4, address: 0x803BCFE4
static float sMaxDrawDist2; // size: 0x4, address: 0x803BCFE8
static float sMinDrawAlpha; // size: 0x4, address: 0x803BCFEC
static float sMaxDrawAlpha; // size: 0x4, address: 0x803BCFF0
static float sLogoAngle; // size: 0x4, address: 0x803C1400
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
static float sLaunchMaxDist2; // size: 0x4, address: 0x803BCFF4
static float sLaunchHalfYawRange; // size: 0x4, address: 0x803BCFF8
static float sLaunchFlipLength; // size: 0x4, address: 0x803BCFFC
static float sLaunchReelInBeginPull; // size: 0x4, address: 0x803BD000
static float sLaunchReelInBeginBounce; // size: 0x4, address: 0x803C1404
// total size: 0x20
struct xLinkAsset {
    // Members
...
// Range: 0x80107000 -> 0x80107020
void zInteraction_SceneInit(struct zScene * zsc /* r0 */) {}

// Range: 0x80107020 -> 0x80107054
...
// total size: 0x14
struct {} zInteraction::__vtable; // size: 0x14, address: 0x803BD040
// total size: 0x14
...
// Range: 0x801072C0 -> 0x801072E4
// this: r0
void zInteraction::Reset() {}

// Range: 0x801072E4 -> 0x80107328
// this: r31
void zInteraction::Stop() {}

// total size: 0x14
struct {} zTriggerInteraction::__vtable; // size: 0x14, address: 0x803BD02C
// total size: 0x50
...
static struct _xFColor LIGHT_OFF_COLOR; // size: 0x10, address: 0x803C59BC
static struct _xFColor LIGHT_ON_COLOR; // size: 0x10, address: 0x803C59CC
// total size: 0x8
struct xBaseAsset {
    // Members
    unsigned int id; // offset 0x0, size 0x4
...
static struct xEntAsset fakeAsset; // size: 0x50, address: 0x8037EE10
// Range: 0x80107618 -> 0x80107714
static void SetupEnt(struct xEnt * ent /* r31 */, struct zSwitchLeverAsset * asset /* r30 */) {
    // References
    // -> static struct xEntAsset fakeAsset;
}

// Range: 0x80107714 -> 0x80107744
...
// Range: 0x80107C28 -> 0x80107C6C
void zSwitchLever::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x14
struct {} zSwitchLever::__vtable; // size: 0x14, address: 0x803BD018
...
// Range: 0x80108614 -> 0x80108650
// this: r31
void zSwitchLever::Render() {}

// Range: 0x80108650 -> 0x80108674
// this: r0
void zSwitchLever::Ready() {}

// Range: 0x80108674 -> 0x801086E4
// this: r30
...
// Range: 0x801087F4 -> 0x80108838
void zLaunch::Init(struct xBase & data /* r3 */, struct xDynAsset & asset /* r31 */) {}

// total size: 0x14
struct {} zLaunch::__vtable; // size: 0x14, address: 0x803BD004
// total size: 0x28
struct PKRAssetType {
    // Members
...
// Range: 0x80108918 -> 0x80108940
// this: r0
void zLaunch::Reset() {}

// Range: 0x80108940 -> 0x80108A08
void zLaunch::StartBlur() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80108A08 -> 0x80108A8C
void zLaunch::StopBlur() {
    // References
    // -> struct xGlobals * xglobals;
}

// Range: 0x80108A8C -> 0x80108C14
// this: r27
...
// Range: 0x80108C14 -> 0x80108C6C
// this: r31
void zLaunch::WindupGrab() {}

// Range: 0x80108C6C -> 0x80109098
// this: r31
...
// Range: 0x801091C0 -> 0x80109248
// this: r31
void zLaunch::EarlyQuit() {}

// Range: 0x80109248 -> 0x80109394
// this: r30
...
// Range: 0x801093C0 -> 0x80109464
// this: r30
void zLaunch::EventCB(unsigned int toEvent /* r31 */) {}

// Range: 0x80109464 -> 0x80109510
