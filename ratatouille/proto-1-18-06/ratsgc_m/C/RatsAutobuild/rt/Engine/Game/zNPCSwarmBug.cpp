/*
    ...
    Language: C++
    Code range: 0x801C46A8 -> 0x801C4838
*/
// total size: 0x68
...
// Range: 0x801C46A8 -> 0x801C46B0
int zNPCSwarmBug::CountChildrenInAsset(const struct xDynAsset * dynAsset /* r3 */) {}

signed char zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2800
...
class zComponentPool zComponentPool<zCompLogicSwarmBug, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C2804
signed char zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2810
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
class zComponentPool zComponentPool<zCompSteeringFlockingBrain, zICompSteering, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C2814
signed char zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2820
...
class zComponentPool zComponentPool<zCompSound, zICompSound, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C2824
// Range: 0x801C46B0 -> 0x801C4748
// this: r31
...
// Range: 0x801C4748 -> 0x801C4768
// this: r0
void zNPCSwarmBug::Deactivate() {}

// Range: 0x801C4768 -> 0x801C47DC
// this: r30
...
// Range: 0x801C4818 -> 0x801C4838
// this: r0
void zNPCSwarmBug::Render() {}

// total size: 0x3C
struct {} zNPCSwarmBug::__vtable; // size: 0x3C, address: 0x803BF1A8
