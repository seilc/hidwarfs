/*
    ...
    Language: C++
    Code range: 0x801C72EC -> 0x801C7A2C
*/
// total size: 0x1
...
static class zCompSteeringGenericParams gDefaultSteeringBasicParams; // size: 0x38, address: 0x803C2870
// total size: 0x18
...
// total size: 0xC
struct /* @class$751zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zCompSteeringGeneric_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zCompSteeringGeneric_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0x64
struct {} zCompSteeringGeneric::__vtable; // size: 0x64, address: 0x802E3A28
// total size: 0x18
...
// Range: 0x801C75AC -> 0x801C76B0
// this: r28
void zCompSteeringGeneric::CalculateAcc(struct xVec3 & acc /* r29 */, class zSteeringGenericDynamics & steeringDynamics /* r30 */, float dt /* f31 */) {
    // Local variables
    float accMag; // r1+0x8
    const class zCompSteeringGenericParams * params; // r0
    struct xVec3 destAcc; // r1+0x18
    float destMag; // f1
    struct xVec3 WanderAcc; // r1+0xC
    float WanderMag; // f2
...
// Range: 0x801C76B0 -> 0x801C76EC
// this: r31
void zCompSteeringGeneric::CalculateVelConstraints(struct xVec3 & dVel /* r4 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x801C76EC -> 0x801C7714
void zCompSteeringGeneric::CalculatePosConstraints(struct xVec3 & dPos /* r3 */) {
    // References
    // -> struct xVec3 m_Null;
}

// Range: 0x801C7714 -> 0x801C773C
void zCompSteeringGeneric::CalculateFacing(struct xVec3 & facing /* r3 */, class zSteeringGenericDynamics & steeringDynamics /* r0 */) {}

// Range: 0x801C773C -> 0x801C7814
...
// Range: 0x801C7900 -> 0x801C7A2C
// this: r28
float zCompSteeringGeneric::GetSeekAcc(struct xVec3 & seekAcc /* r29 */, class zSteeringGenericDynamics & steeringDynamics /* r30 */, float dt /* f30 */) {
    // Local variables
    const class zCompSteeringGenericParams * params; // r0
...
// total size: 0x4
struct /* @class$786zCompSteeringGeneric_cpp */ {
    // Members
...
union /* @class$805zCompSteeringGeneric_cpp */ {
...
// total size: 0xC
struct /* @class$804zCompSteeringGeneric_cpp */ {
    // Members
...
// total size: 0xC
struct {} zCompSteeringGenericParams::__vtable; // size: 0xC, address: 0x803BF288
