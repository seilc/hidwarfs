/*
    ...
    Language: C++
    Code range: 0x80120698 -> 0x80121D1C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80120698 -> 0x80120710
void zUberLaser::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r30 */) {
    // Local variables
...
class zLightweightSystem * zLightweight<z::uber_laser, 5>::GetSystem()::system; // size: 0x4, address: 0x803C1708
signed char zLightweight<z::uber_laser, 5>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C170C
// total size: 0x4
struct RwRGBA {
    // Members
...
// total size: 0x2C
struct /* @class$1081zUberLaser_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$1082zUberLaser_cpp */ {
    // Members
...
struct config default_config; // size: 0x180, address: 0x802DB658
// total size: 0xC
struct xModelPool {
    // Members
...
// total size: 0x4
struct /* @class$889zUberLaser_cpp */ {
    // Members
...
class uber_laser : public zLightweight {
    ...
    uber_laser(struct xEnt * owner, const struct xVec3 & start, const struct xVec3 & end, const struct config * cfg);
    ...
    // Members
    const struct config * cfg; // offset 0xC, size 0x4
...
// total size: 0x24
struct {} zLightweightSystem<z::uber_laser, 5>::__vtable; // size: 0x24, address: 0x803BD3C8
int ring_explosion; // size: 0x4, address: 0x803C1710
enum iSndGroupHandle {
};
enum iSndGroupHandle shoot_charge; // size: 0x4, address: 0x803C1714
enum iSndGroupHandle shoot; // size: 0x4, address: 0x803C1718
enum iSndGroupHandle shoot_end; // size: 0x4, address: 0x803C171C
enum iSndGroupHandle explode; // size: 0x4, address: 0x803C1720
struct RwRaster * beam_raster; // size: 0x4, address: 0x803C1724
// total size: 0x24
...
struct RxObjSpace3DVertex * vert; // size: 0x4, address: 0x803C1728
// total size: 0x18
...
struct tagiRenderInput gRenderBuffer; // size: 0x90, address: 0x80386510
// Range: 0x801207B8 -> 0x80120880
...
// Range: 0x80120880 -> 0x801208E0
// this: r31
void uber_laser::Destroy() {}

// total size: 0x20
struct {} z::uber_laser::__vtable; // size: 0x20, address: 0x803BD388
// Range: 0x801208E0 -> 0x80120A08
// this: r31
uber_laser::uber_laser() {
    // Local variables
    unsigned int ball_model_id; // r0
    unsigned int size; // r1+0x8
    struct RpAtomic * imodel; // r29
    unsigned int beam_model_id; // r0
...
// total size: 0x20
struct {} zLightweight<z::uber_laser, 5>::__vtable; // size: 0x20, address: 0x803BD3A8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
struct xVec3 g_Z3; // size: 0xC, address: 0x803C3B3C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x80120A08 -> 0x80120B58
// this: r27
uber_laser::uber_laser(struct xEnt * owner /* r28 */, const struct xVec3 & start /* r29 */, const struct xVec3 & end /* r30 */, const struct config * cfg /* r31 */) {
    // Local variables
...
static int trail_type; // size: 0x4, address: 0x803C172C
static signed char init; // size: 0x1, address: 0x803C1730
// Range: 0x80120C38 -> 0x80120D04
// this: r29
...
// total size: 0xC
struct /* @class$907zUberLaser_cpp */ {
    // Members
...
class energy_system {
    ...
    // Members
    const struct config * use_config; // offset 0x0, size 0x4
...
struct xMat4x3 g_I3; // size: 0x40, address: 0x803BFAF0
// Range: 0x80121700 -> 0x80121A10
// this: r31
...
static int laser_count; // size: 0x4, address: 0x803C1734
void * RwEngineInstance; // size: 0x4, address: 0x803C3054
// Range: 0x80121A10 -> 0x80121A60
