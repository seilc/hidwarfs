/*
    ...
    Language: C++
    Code range: 0x801366E8 -> 0x80137590
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zPad pads[6]; // size: 0xD8, address: 0x803873C0
static class zPad * debugPad; // size: 0x4, address: 0x803C1958
static class zPad * dualControlPad; // size: 0x4, address: 0x803C195C
// Range: 0x801366E8 -> 0x80136734
...
// Range: 0x801367FC -> 0x80136820
// this: r0
void zPad::Init() {}

// Range: 0x80136820 -> 0x8013687C
...
// Range: 0x80136C24 -> 0x80136CD0
void zPad::RefreshActivePad(int port /* r24 */) {
    // Local variables
    int i; // r25
...
// Range: 0x80136CD0 -> 0x80136D04
// this: r0
void zPad::DisablePad() {}

// Range: 0x80136D04 -> 0x80136D38
// this: r0
void zPad::EnablePad() {}

// Range: 0x80136D38 -> 0x80136E14
...
// Range: 0x80136E14 -> 0x80136E34
// this: r0
unsigned char zPad::Active() {}

// Range: 0x80136E34 -> 0x80136E64
// this: r0
void zPad::DeactivateTRC() {}

// Range: 0x80136E64 -> 0x80136E8C
// this: r0
void zPad::Clear() {
    // References
    // -> struct _tagxPad mPad[4];
...
// Range: 0x80137440 -> 0x80137460
float zPadAnalogControl::GetMag(float x /* f0 */, float y /* f0 */) {}

// Range: 0x80137460 -> 0x801374A4
// this: r31
