/*
    ...
    Language: C++
    Code range: 0x80149BF8 -> 0x8014A5C8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80149D3C -> 0x80149D84
// this: r31
void zVent::refreshMat() {}

// Range: 0x80149D84 -> 0x80149D9C
// this: r0
void zVent::reset() {}
...
// Range: 0x8014A144 -> 0x8014A260
// this: r31
void zVent::changeState(enum eVentState newState /* r0 */) {}

// Range: 0x8014A260 -> 0x8014A280
// this: r0
void zVent::render() {}

// Range: 0x8014A280 -> 0x8014A2A0
void zVent::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x8014A2A0 -> 0x8014A2F8
void zVent::setupAll() {
    // Local variables
...
// Range: 0x8014A3B8 -> 0x8014A420
// this: r31
void zVent::setup() {}

// Range: 0x8014A420 -> 0x8014A4D0
void zVent::cbDispatch(struct xBase * to /* r4 */, unsigned int event /* r0 */) {
    // Local variables
    struct zVent & e; // r4
}
