/*
    ...
    Language: C++
    Code range: 0x801817C8 -> 0x8018264C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct config glint_config; // size: 0x24, address: 0x803C2000
static float * glintEmit[5]; // size: 0x14, address: 0x803C2024
static int contextObjCount[5]; // size: 0x14, address: 0x803C2038
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$786zContextObject_cpp */ {
    // Members
...
union /* @class$805zContextObject_cpp */ {
...
// total size: 0xC
struct /* @class$804zContextObject_cpp */ {
    // Members
...
static struct xEnt * entFXList[16]; // size: 0x40, address: 0x803C204C
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$1226zContextObject_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1225zContextObject_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1228zContextObject_cpp */ {
    // Members
...
// Range: 0x801817C8 -> 0x80181884
unsigned char zContextObject::MoveTowardsMountPoint(struct xEntFrame * frame /* r30 */, const struct xVec3 & mountPoint /* r31 */) {
    // Local variables
    float length2; // f31
    float minDist2; // f0
    struct xVec3 diff; // r1+0x8
    float diffLength2; // f0

    // References
    // -> struct zGlobals globals;
}

// Range: 0x80181884 -> 0x80181934
unsigned char zContextObject::MatchOrientation(struct xEntFrame * frame /* r31 */, float targetAngle /* f1 */, float dt /* f31 */) {
    // Local variables
    float diffAngle; // f1
    float max; // f3
}

// Range: 0x80181934 -> 0x8018199C
unsigned char zContextObject::MatchOrientation(struct xEntFrame * frame /* r30 */, const struct xVec3 & orientation /* r0 */, float dt /* f31 */, unsigned char forward /* r31 */) {
    // Local variables
    float targetAngle; // f1
}

struct config default_config; // size: 0x24, address: 0x803C19E4
unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
// total size: 0x4
struct /* @class$861zContextObject_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$862zContextObject_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// Range: 0x8018199C -> 0x80181B4C
void zContextObjectManager::Setup() {
    // Local variables
    int count; // r29
    class zContextObjectTightrope * list; // r30
    int i; // r27
    int count; // r27
...
// Range: 0x80181BB0 -> 0x80181BD8
void zContextObjectManager::AddEntFX(struct xEnt * ent /* r0 */) {
    // References
    // -> static struct xEnt * entFXList[16];
    // -> static int contextObjCount[5];
}
...
// Range: 0x80181BD8 -> 0x80181C00
// this: r3
void zContextObjectManager::SetTransitionType(enum zContextObjectType type /* r0 */) {}
...
// Range: 0x80181C00 -> 0x80181C64
// this: r30
void zContextObjectManager::Dismount(struct zCommonPlayer * player /* r31 */) {}
...
// Range: 0x80181C64 -> 0x80181CA4
// this: r5
void zContextObjectManager::BeginUpdate(struct zCommonPlayer * player /* r0 */) {}

// Range: 0x80181CA4 -> 0x80181CB8
// this: r0
void zContextObjectManager::MountReset() {}

// Range: 0x80181CB8 -> 0x80181D18
// this: r0
...
// Range: 0x80181D74 -> 0x80181EC0
void zContextObjectManager::EmitSparks(float & emitCount /* r27 */, struct xVec3 & refPos /* r28 */, struct xModelInstance * model /* r29 */, float randR /* f28 */, float dt /* f29 */) {
    // Local variables
    struct RpGeometry * geom; // r31
    struct xVec3 * verts; // r30
    struct xVec3 pos; // r1+0x8
    unsigned int vert; // r0
...
// Range: 0x80181EC0 -> 0x80182214
// this: r28
void zContextObjectManager::UpdateProximityFX(struct zPlayer * player /* r29 */, float dt /* f31 */) {
    // Local variables
    ...
    class zContextObjectPoleSwing * poleSwings; // r22
    int i; // r23
    struct xVec3 polePos; // r1+0xC
    class zCarryableObject * carryableObjs; // r22
    int i; // r23
    int i; // r22
    struct xEnt * ent; // r23
...
// Range: 0x80182214 -> 0x801823DC
// this: r30
void zContextObjectManager::Update(struct zCommonPlayer * player /* r31 */, float dt /* f31 */) {
    // Local variables
    float priority; // r1+0x8
}

// Range: 0x801823DC -> 0x8018243C
// this: r31
unsigned char zContextObjectManager::CheckObjectType(enum zContextObjectType objectType /* r30 */) {}

// Range: 0x8018243C -> 0x801824A8
static void CallUpdate(float dt /* f31 */) {
    // Local variables
    int count; // r30
    class zContextObjectClimbableRope * list; // r29
    int i; // r28
...
// Range: 0x801824A8 -> 0x80182534
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r23 */, union MountData & mountData /* r24 */, float & priority /* r25 */) {
    // Local variables
    class zContextObject * object; // r29
    int count; // r28
    class zContextObjectClimbableRope * list; // r27
    int i; // r26
...
// Range: 0x80182534 -> 0x801825C0
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r23 */, union MountData & mountData /* r24 */, float & priority /* r25 */) {
    // Local variables
    class zContextObject * object; // r29
    int count; // r28
    class zContextObjectPoleSwing * list; // r27
    int i; // r26
...
// Range: 0x801825C0 -> 0x8018264C
static class zContextObject * AttemptMount(struct zCommonPlayer * player /* r23 */, union MountData & mountData /* r24 */, float & priority /* r25 */) {
    // Local variables
    class zContextObject * object; // r29
    int count; // r28
    class zContextObjectTightrope * list; // r27
    int i; // r26
