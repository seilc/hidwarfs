/*
    ...
    Language: C++
    Code range: 0x800F1A9C -> 0x800F5004
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static char ini_filename[11]; // size: 0xB, address: 0x803C5628
static char * texture_key_names[8]; // size: 0x20, address: 0x803BCF10
// total size: 0x34
struct RwRaster {
    // Members
...
static struct RwTexture * cone_texture; // size: 0x4, address: 0x803C1280
// total size: 0x28
...
static struct splash_emitter * splash_emitters; // size: 0x4, address: 0x803C1284
static int splash_emitters_size; // size: 0x4, address: 0x803C1288
// total size: 0x48
...
static struct plume_emitter * plume_emitters; // size: 0x4, address: 0x803C128C
static int plume_emitters_size; // size: 0x4, address: 0x803C1290
// total size: 0x14
...
static struct bubble_emitter * bubble_emitters; // size: 0x4, address: 0x803C1294
static int bubble_emitters_size; // size: 0x4, address: 0x803C1298
// total size: 0x8
struct chain_link {
    // Members
...
static struct chain_emitter * chain_emitters; // size: 0x4, address: 0x803C129C
static int chain_emitters_size; // size: 0x4, address: 0x803C12A0
static int mist_system_id; // size: 0x4, address: 0x803C12A4
static int ring_system_id; // size: 0x4, address: 0x803C12A8
static int streak_system_id; // size: 0x4, address: 0x803C12AC
static int plume_system_id; // size: 0x4, address: 0x803C12B0
static int trail_system_id; // size: 0x4, address: 0x803C12B4
static int drips_system_id; // size: 0x4, address: 0x803C12B8
enum type_enum {
    TYPE_SPLASH = 0,
    TYPE_PLUME = 1,
    TYPE_BUBBLE = 2,
...
static struct splash_planner * planners; // size: 0x4, address: 0x803C12BC
// total size: 0x8
struct type_mapping {
    // Members
...
static struct type_mapping * type_mappings; // size: 0x4, address: 0x803C12C0
static int types_size; // size: 0x4, address: 0x803C12C4
static unsigned int texture_ids[8]; // size: 0x20, address: 0x803C12C8
static int cone_texture_repeats; // size: 0x4, address: 0x803BCF30
// Range: 0x800F1A9C -> 0x800F1D7C
...
// Range: 0x800F4CFC -> 0x800F4D20
void zSplashStartup() {}

// Range: 0x800F4D20 -> 0x800F4E58
...
// Range: 0x800F4E58 -> 0x800F4E5C
static void debug_init() {}

// Range: 0x800F4E5C -> 0x800F4E60
void zSplashSceneExit() {}

// Range: 0x800F4E60 -> 0x800F4EB8
void zSplashUpdate(float dt /* f31 */) {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x800F4EB8 -> 0x800F4EBC
static void debug_update() {}

// Range: 0x800F4EBC -> 0x800F4EE8
void zSplashRender() {
    // References
    // -> static struct splash_emitter * splash_emitters;
}

// Range: 0x800F4EE8 -> 0x800F4F50
