/*
    ...
    Language: C++
    Code range: 0x8013A848 -> 0x8013B7E8
*/
// total size: 0x8
struct xVec2 {
    // Members
...
// total size: 0x4
struct /* @class$825zMeshPosition_cpp */ {
    // Members
...
union /* @class$844zMeshPosition_cpp */ {
...
// total size: 0xC
struct /* @class$843zMeshPosition_cpp */ {
    // Members
...
// Range: 0x8013A848 -> 0x8013A878
// this: r31
zMeshPosition::zMeshPosition() {}

// Range: 0x8013A878 -> 0x8013A890
// this: r0
...
// Range: 0x8013AA10 -> 0x8013ACAC
// this: r27
int zMeshPosition::GetPortal(const class zMeshPosition & destination /* r26 */, struct xVec3 * portal /* r28 */, float radius /* f30 */) const {
    // Local variables
    struct Exit & exit; // r0
...
// Range: 0x8013ACAC -> 0x8013ACF8
void zMeshPosition::GetClosestPosition(const struct xVec3 & pos /* r30 */, class zMeshPosition & result /* r31 */) {}

// Range: 0x8013ACF8 -> 0x8013AF14
// this: r20
void zMeshPosition::GetClosestPosition(class zMeshPosition & result /* r23 */) const {
    // Local variables
    ...
    float Pz; // f28
    int m; // r30
    class xNavigationMeshAssetSubMesh * sub_mesh; // r29
    int i; // r28
    const unsigned char * portal; // r27
    const unsigned char * a; // r26
    const unsigned char * b; // r25
    const unsigned char * end; // r24
...
// Range: 0x8013AF14 -> 0x8013AF70
// this: r31
void zMeshPosition::CorrectHeight() {}

// Range: 0x8013AF70 -> 0x8013AFE4
// this: r30
...
// total size: 0xC
struct /* @class$706zMeshPosition_cpp */ {
    // Members
...
// Range: 0x8013B6A0 -> 0x8013B7E8
// this: r24
unsigned char zMeshPosition::FindNeighborOnPath(const struct xVec3 & startPos /* r25 */, const struct xVec3 & endPos /* r26 */, int subMeshIndex /* r0 */, int triangle /* r27 */, int & neighborTriangle /* r28 */) {
    // Local variables
