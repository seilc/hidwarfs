/*
    ...
    Language: C++
    Code range: 0x801C3528 -> 0x801C3B60
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zCompSteeringFlockingParams gSwarmBugSteeringParams; // size: 0x8C, address: 0x80396428
...
static class zCompSoundParams gSwarmBugSoundParams; // size: 0x1C, address: 0x803C27C0
// total size: 0x8
...
static struct zCompStateMachineTable gSwarmBugStateMachineTable[2]; // size: 0x10, address: 0x803BF0C0
// total size: 0x34
...
// total size: 0x2C
struct {} zSwarmBugWander::__vtable; // size: 0x2C, address: 0x803BF0D0
// total size: 0x14
class zSwarmBugWander : public zCompState {
    // Functions
    zSwarmBugWander();
};
// Range: 0x801C38C0 -> 0x801C3948
// this: r31
