/*
    ...
    Language: C++
    Code range: 0x80130024 -> 0x80130CE4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zSparkEmitterAsset default_spark_asset; // size: 0x94, address: 0x80387270
// Range: 0x80130024 -> 0x8013004C
// this: r0
...
// total size: 0x4
struct /* @class$820zSparkEmitter_cpp */ {
    // Members
...
union /* @class$779zSparkEmitter_cpp */ {
...
// total size: 0xC
struct /* @class$840zSparkEmitter_cpp */ {
    // Members
...
// Range: 0x80130284 -> 0x801302A4
void zSparkEmitter::Load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x801302A4 -> 0x801303A4
// this: r30
void zSparkEmitter::Load(struct zSparkEmitterAsset * asset /* r31 */) {
    // Local variables
    float cpitch; // f0
}

// Range: 0x801303A4 -> 0x80130400
// this: r31
...
// Range: 0x80130494 -> 0x801306E4
// this: r31
void zSparkEmitter::Update(float dt /* f31 */) {
    // Local variables
    unsigned char successfulEmit; // r3
    struct xVec3 cur_pos; // r1+0x14
    struct xVec3 cur_dir; // r1+0x8
...
// Range: 0x801306E4 -> 0x80130AA8
unsigned char zSparkEmitter::EmitSparks(const struct zSparkEmitterAsset & emitData /* r27 */, const struct xVec3 & pos /* r28 */, const struct xVec3 & dir /* r19 */, float dt /* f31 */, int sparkSystemId /* r29 */, int glintSystemId /* r30 */, enum iSndGroupHandle sound /* r31 */) {
    // Local variables
    int num_particles; // r25
    struct xVec3 * locList; // r26
    struct xVec3 * dirList; // r24
    float * lenVelList; // r23
    float cosangle; // f0
...
// Range: 0x80130BD0 -> 0x80130BFC
void zSparkEmitter::Event(struct xBase * from /* r0 */, struct xBase * to /* r4 */, unsigned int toEvent /* r0 */, const float * toParam /* r0 */, struct xBase * toParamWidget /* r0 */, unsigned int toParamWidgetID /* r0 */) {}

// Range: 0x80130BFC -> 0x80130CE4
// this: r30
