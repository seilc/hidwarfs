/*
    ...
    Language: C++
    Code range: 0x80157F98 -> 0x801583F8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned int currentActive; // size: 0x4, address: 0x803C1B40
unsigned int lastCheckpointNumber; // size: 0x4, address: 0x803C1B44
// total size: 0x8
struct substr {
    // Members
...
// total size: 0xC
struct /* @class$769zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$770zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$771zCheckpoint_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$772zCheckpoint_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$773zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$774zCheckpoint_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$775zCheckpoint_cpp */ {
    // Members
...
static struct tweak_callback tweakOnOffCB; // size: 0x28, address: 0x803BD990
static signed char init; // size: 0x1, address: 0x803C1B48
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$804zCheckpoint_cpp */ {
    // Members
...
union /* @class$701zCheckpoint_cpp */ {
...
// total size: 0xC
struct /* @class$824zCheckpoint_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$1129zCheckpoint_cpp */ {
    // Members
...
// Range: 0x80157F98 -> 0x8015808C
void zCheckpoint::SceneInit(struct zScene * scene /* r0 */) {
    // Local variables
    int count; // r28
    class zCheckpoint * checkpointList; // r27
...
// Range: 0x801580F8 -> 0x80158118
void zCheckpoint::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

// Range: 0x80158118 -> 0x801581DC
// this: r30
...
// Range: 0x80158328 -> 0x80158374
void zCheckpoint::EventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
