/*
    ...
    Language: C++
    Code range: 0x8015384C -> 0x80154F3C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x18
struct /* @class$1170zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$727zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$728zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zCam2Player_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$730zCam2Player_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zCam2Player_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zCam2Player_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zCam2Player_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$786zCam2Player_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zCam2Player_cpp */ {
    // Members
...
union /* @class$805zCam2Player_cpp */ {
...
// Range: 0x80153E38 -> 0x80153ED4
// this: r30
void zCam2Player::update_target_info(float dt /* f31 */) {}

// Range: 0x80153ED4 -> 0x80153F68
// this: r30
...
// Range: 0x80153F68 -> 0x80154258
// this: r28
int zCam2Player::yaw_past_limit(float & pastLimit /* r29 */, float guardBandYaw /* f29 */) {
    // Local variables
    ...
    float player0Arc; // f31
    float toPlayer0Yaw; // f0
    float dYawFromPlayer0; // f30
    struct xVec3 player1Pos; // r1+0x14
    struct xVec3 camGoalToPlayer1; // r1+0x8
    float player1Arc; // f27
    float toPlayer1Yaw; // f0
    float dYawFromPlayer1; // f1
    float dYawMax; // f3
    float dAbsYawFromPlayer0; // f4
    float dAbsYawFromPlayer1; // f5
    float adjustedDYawP0; // f0
    float adjustedDYawP1; // f1
    float dYawMostOut; // f1
    float radiusArcOfMostOut; // f4
...
float sNearWall; // size: 0x4, address: 0x803BD5D0
// total size: 0x30
struct OOBExtent {
    // Members
    unsigned int flags; // offset 0x0, size 0x4
...
// Range: 0x801547AC -> 0x801547FC
// this: r31
void zCam2Player::update_precollide() {}

// Range: 0x801547FC -> 0x80154868
// this: r31
void zCam2Player::update_pivot() {}

// Range: 0x80154868 -> 0x801548D4
// this: r31
void zCam2Player::update_compress() {}

// Range: 0x801548D4 -> 0x801548D8
void zCam2Player::update_phi() {}

// Range: 0x801548D8 -> 0x801548DC
void zCam2Player::update_theta() {}

// Range: 0x801548DC -> 0x801548E0
void zCam2Player::update_distance() {}

// Range: 0x801548E0 -> 0x8015499C
// this: r31
void zCam2Player::apply_basis() {}

// Range: 0x8015499C -> 0x801549EC
// this: r31
...
struct config cfg; // size: 0x18, address: 0x803BF750
// Range: 0x801549EC -> 0x80154A8C
// this: r31
...
// Range: 0x80154AD8 -> 0x80154B1C
// this: r31
void zCam2Player::start_position_aim() {}

// Range: 0x80154B1C -> 0x80154B3C
// this: r0
void zCam2Player::stop() {}

// Range: 0x80154B3C -> 0x80154BFC
// this: r31
void zCam2Player::update_camera_goals(float dt /* f31 */) {}

// Range: 0x80154BFC -> 0x80154F38
// this: r30
...
// Range: 0x80154F38 -> 0x80154F3C
void zCam2Player::debug_render() {}

// total size: 0x44
struct {} zCam2Player::__vtable; // size: 0x44, address: 0x802DC298
// total size: 0x0
