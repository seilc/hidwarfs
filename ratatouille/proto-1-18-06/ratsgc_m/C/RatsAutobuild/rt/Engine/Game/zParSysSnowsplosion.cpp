/*
    ...
    Language: C++
    Code range: 0x8014EBEC -> 0x8014F07C
*/
static int systemID; // size: 0x4, address: 0x803BD820
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x4
struct /* @class$785zParSysSnowsplosion_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$803zParSysSnowsplosion_cpp */ {
    // Members
...
union /* @class$804zParSysSnowsplosion_cpp */ {
...
// Range: 0x8014EBEC -> 0x8014ED68
static int ParticleUpdate(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f30 */) {
    // Local variables
