/*
    ...
    Language: C++
    Code range: 0x801BA2D4 -> 0x801BBC58
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class zICompNPCEntityParams gDefaultNPCEntityParams; // size: 0x30, address: 0x803C2698
// total size: 0x60
...
// Range: 0x801BA2D4 -> 0x801BA300
void zICompNPCEntity::BupdateWrapper(struct xEnt * ent /* r3 */) {}

// Range: 0x801BA300 -> 0x801BA34C
...
struct xVec3 m_Ones; // size: 0xC, address: 0x803C4224
// Range: 0x801BA37C -> 0x801BA3D4
...
// total size: 0x4
struct /* @class$786zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zICompNPCEntity_cpp */ {
    // Members
...
union /* @class$805zICompNPCEntity_cpp */ {
...
// Range: 0x801BA6D0 -> 0x801BA734
// this: r31
void zICompNPCEntity::Detached() {}

// Range: 0x801BA734 -> 0x801BA800
// this: r31
...
// Range: 0x801BA800 -> 0x801BA9D4
// this: r31
void zICompNPCEntity::Reset(class zNPCBase * ownerNPC /* r28 */) {
    // Local variables
...
// Range: 0x801BA9D4 -> 0x801BA9D8
void zICompNPCEntity::BeforeAnimMatrices() {}

// Range: 0x801BA9D8 -> 0x801BAD90
// this: r30
...
// Range: 0x801BAF14 -> 0x801BAFA0
// this: r0
struct xVec3 zICompNPCEntity::GetBoneWorldPosition(int bone /* r0 */) {
    // Local variables
    struct xVec3 position; // r1+0x8
}

// Range: 0x801BAFA0 -> 0x801BAFCC
// this: r3
...
// Range: 0x801BB82C -> 0x801BB850
// this: r3
void zICompNPCEntity::ApplyAcc(struct xVec3 & dAcc /* r0 */) {}

// Range: 0x801BB850 -> 0x801BB8FC
// this: r5
...
// Range: 0x801BB9BC -> 0x801BB9E4
// this: r0
void zICompNPCEntity::ApplyPosConstraints(struct xVec3 & dPos /* r0 */) {}

// Range: 0x801BB9E4 -> 0x801BBA0C
// this: r0
unsigned char zICompNPCEntity::TurnToVelocityXZ(float dt /* f0 */, float turnSpringK /* f0 */) {}

// Range: 0x801BBA0C -> 0x801BBB40
// this: r30
...
// total size: 0xC
struct /* @class$751zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zICompNPCEntity_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zICompNPCEntity_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zICompNPCEntity_cpp */ {
    // Members
...
// total size: 0x30
struct {} zICompNPCEntity::__vtable; // size: 0x30, address: 0x803BECF0
enum eCompType {
    eCompType_Unknown = -1,
