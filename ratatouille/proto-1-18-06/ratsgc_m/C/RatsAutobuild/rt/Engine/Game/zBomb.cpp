/*
    ...
    Language: C++
    Code range: 0x80109BDC -> 0x8010A0D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x80109C88 -> 0x80109EC0
void bound_damage(struct xBound & bound /* r22 */, struct xEnt * fromEnt /* r23 */, int player_damage /* r24 */, int obj_damage /* r21 */, int npc_damage /* r20 */, float awayKnockback /* f30 */, float upKnockback /* f31 */, enum zHitSource hitSource /* r25 */, enum zHitTarget hitTarget /* r26 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1274zBomb_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1275zBomb_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
