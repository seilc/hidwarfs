/*
    ...
    Language: C++
    Code range: 0x801679F0 -> 0x801681B0
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801679F0 -> 0x80167A10
void zCameraFly_Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
...
// Range: 0x80167A10 -> 0x80167A70
void zCameraFly_Init(struct zCameraFly * fly /* r30 */, struct CameraFly_asset * asset /* r31 */) {}

// Range: 0x80167A70 -> 0x80167A80
void zCameraFly_Setup(struct zCameraFly * fly /* r0 */) {}

// Range: 0x80167A80 -> 0x80167A84
void zCameraFly_Update() {}

// total size: 0x0
struct xSerial {};
// Range: 0x80167A84 -> 0x80167AA4
void zCameraFly_Save(struct zCameraFly * fly /* r0 */, struct xSerial * s /* r0 */) {}

// Range: 0x80167AA4 -> 0x80167AC4
void zCameraFly_Load(struct zCameraFly * fly /* r0 */, struct xSerial * s /* r0 */) {}
...
class zCamFlyThrough : public xCam {
    ...
    // Members
    struct xCam * mPreviousCam; // offset 0x130, size 0x4
    struct zFlyKey * mKeyFrames; // offset 0x134, size 0x4
    int mNumKeys; // offset 0x138, size 0x4
    float mFlyTime; // offset 0x13C, size 0x4
    float mFlyRate; // offset 0x140, size 0x4
    unsigned char mStopFly; // offset 0x144, size 0x1
    struct zCameraFly * mCamFly; // offset 0x148, size 0x4
};
class zCamFlyThrough sFlyCam; // size: 0x150, address: 0x8038E8F0
float skipTimeFlythrough; // size: 0x4, address: 0x803BDA48
// Range: 0x80167AC4 -> 0x80167B98
...
// Range: 0x80167F14 -> 0x80167F58
// this: r31
void zCamFlyThrough::create() {}

// Range: 0x80167F58 -> 0x80167FDC
// this: r30
...
// Range: 0x80168064 -> 0x80168078
// this: r3
struct xCam * zCamFlyThrough::get_next() {}

// Range: 0x80168078 -> 0x80168098
// this: r0
void zCamFlyThrough::SetFlyData(void * data /* r0 */, unsigned int size /* r0 */, struct zCameraFly * fly /* r0 */, struct xCam * previous /* r0 */) {}
...
// total size: 0x4
struct /* @class$786zCameraFly_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$804zCameraFly_cpp */ {
    // Members
...
// Range: 0x80168140 -> 0x801681B0
void zCameraFlyEventCB(struct xBase * to /* r4 */, unsigned int toEvent /* r0 */) {
    // Local variables
    struct zCameraFly * fly; // r4
}

// total size: 0x40
struct {} zCamFlyThrough::__vtable; // size: 0x40, address: 0x803BDA4C
// total size: 0x0
