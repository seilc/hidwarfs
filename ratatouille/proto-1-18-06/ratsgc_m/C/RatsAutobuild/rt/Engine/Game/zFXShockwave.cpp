/*
    ...
    Language: C++
    Code range: 0x8014D40C -> 0x8014DA40
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$785zFXShockwave_cpp */ {
    // Members
...
// Range: 0x8014D40C -> 0x8014D450
// this: r31
static void zFXShockwave::FreeModel() {}

// Range: 0x8014D450 -> 0x8014D470
// this: r0
static void zFXShockwave::SceneExit() {}

// Range: 0x8014D470 -> 0x8014D4AC
// this: r31
static void zFXShockwave::Reset() {}

// Range: 0x8014D4AC -> 0x8014D560
// this: r29
static void zFXShockwave::Start(class zFXShockwaveConfig * cfg /* r0 */, const struct xVec3 & pos /* r30 */, float instanceScale /* f0 */, unsigned char killProj /* r31 */) {}

class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::system; // size: 0x4, address: 0x803C1A50
signed char zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C1A54
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::system; // size: 0x4, address: 0x803C1A58
signed char zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C1A5C
class zNPCProjectileSystem * zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::system; // size: 0x4, address: 0x803C1A60
signed char zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::_GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C1A64
// Range: 0x8014D560 -> 0x8014D65C
// this: r30
...
// total size: 0x24
struct {} zNPCProjectileSystem<zNPCProjectileMetalSheet, 20>::__vtable; // size: 0x24, address: 0x803BD7FC
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileMetalSheet, 2, 20>::__vtable; // size: 0x38, address: 0x803BD7C4
// total size: 0x14
struct {} zNPCProjectile::__vtable; // size: 0x14, address: 0x803BD7B0
...
class zNPCProjectileSystem : public zLightweightSystemBase {
    // Members
    class zNPCProjectileTrackingGrub projectiles[40]; // offset 0x4, size 0x3A20
    int activeList[40]; // offset 0x3A24, size 0xA0
    int endIndex; // offset 0x3AC4, size 0x4
    int totalCount; // offset 0x3AC8, size 0x4
};
// total size: 0x18
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x24
struct {} zNPCProjectileSystem<zNPCProjectileTrackingGrub, 40>::__vtable; // size: 0x24, address: 0x803BD78C
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileTrackingGrub, 1, 40>::__vtable; // size: 0x38, address: 0x803BD754
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1138zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$750zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$751zFXShockwave_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zFXShockwave_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$753zFXShockwave_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$754zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$755zFXShockwave_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$756zFXShockwave_cpp */ {
    // Members
...
class zNPCProjectileGrub : public zNPCProjectileBase {
    ...
    struct xResponseCurve decalResponseCurve; // offset 0xB4, size 0x10
    enum xSndHandle flyingSound; // offset 0xC4, size 0x4
    struct xShadowSimpleCache simpShadow; // offset 0xC8, size 0xA4
};
// total size: 0x398C
class zNPCProjectileSystem : public zLightweightSystemBase {
    // Members
    class zNPCProjectileGrub projectiles[40]; // offset 0x4, size 0x38E0
    int activeList[40]; // offset 0x38E4, size 0xA0
    int endIndex; // offset 0x3984, size 0x4
    int totalCount; // offset 0x3988, size 0x4
};
// total size: 0x50
...
union /* @class$805zFXShockwave_cpp */ {
...
// total size: 0xC
struct /* @class$804zFXShockwave_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
class zNPCProjectileBase : public zNPCProjectile {};
// total size: 0x24
struct {} zNPCProjectileSystem<zNPCProjectileGrub, 40>::__vtable; // size: 0x24, address: 0x803BD730
// total size: 0x38
struct {} zNPCProjectileBase<zNPCProjectileGrub, 0, 40>::__vtable; // size: 0x38, address: 0x803BD6F8
// Range: 0x8014D65C -> 0x8014D6F8
// this: r0
static void zFXShockwave::Render() {}

static int shockwavesSize; // size: 0x4, address: 0x803C1A68
static class zFXShockwave * shockwaves; // size: 0x4, address: 0x803C1A6C
static class zFXShockwave * freeList; // size: 0x4, address: 0x803C1A70
static class zFXShockwave * usedList; // size: 0x4, address: 0x803C1A74
// Range: 0x8014D6F8 -> 0x8014D708
static void ListPush(class zFXShockwave * & list /* r0 */, class zFXShockwave * element /* r0 */) {}

// Range: 0x8014D708 -> 0x8014D72C
static class zFXShockwave * ListPop(class zFXShockwave * & list /* r0 */) {}

// Range: 0x8014D72C -> 0x8014D764
static class zFXShockwave * ListRemove(class zFXShockwave * & list /* r3 */, class zFXShockwave * element /* r0 */, class zFXShockwave * prev /* r0 */) {}

// Range: 0x8014D764 -> 0x8014D7C4
...
// Range: 0x8014D828 -> 0x8014D860
// this: r31
static zFXShockwave::zFXShockwave() {}

// Range: 0x8014D860 -> 0x8014D8B4
