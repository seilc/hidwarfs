/*
    ...
    Language: C++
    Code range: 0x80148D04 -> 0x80149570
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0xC
struct /* @class$992zParticleSystemRain_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$923zParticleSystemRain_cpp */ {
    // Members
...
union /* @class$746zParticleSystemRain_cpp */ {
...
// total size: 0xC
struct /* @class$941zParticleSystemRain_cpp */ {
    // Members
...
// Range: 0x80148DEC -> 0x801490B8
int zParticleSystemRain::update_particles(unsigned char * mem /* r31 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f24 */, void * context /* r0 */) {
    // Local variables
    ...
    struct particle_instance * p; // r25
    struct particle_instance * end; // r24
    ...
    float dropWidth; // f26
    const struct xMat4x3 & camMat; // r23
...
struct zParticleGeneratorRain : public zParticleGenerator {
    ...
    // Members
protected:
    class zParticleSystemRain * system; // offset 0x20, size 0x4
...
// Range: 0x80149288 -> 0x80149364
// this: r29
void zParticleGeneratorRain::create(class zParticleSystemRain & system /* r30 */, struct zParticleAsset & asset /* r31 */) {
    // Local variables
    struct xParticleBatchSystem batch; // r1+0x8
}

// Range: 0x80149364 -> 0x801493F8
// this: r31
void zParticleGeneratorRain::reset() {}

// Range: 0x801493F8 -> 0x8014944C
// this: r31
void zParticleGeneratorRain::activate() {}

// Range: 0x8014944C -> 0x80149498
// this: r31
void zParticleGeneratorRain::deactivate() {}

// Range: 0x80149498 -> 0x801494E0
// this: r31
void zParticleGeneratorRain::resume() {}

// Range: 0x801494E0 -> 0x80149514
// this: r31
...
// total size: 0x20
struct {} zParticleGeneratorRain::__vtable; // size: 0x20, address: 0x803BD698
// total size: 0x34
struct {} zParticleSystemRain::__vtable; // size: 0x34, address: 0x803BD6B8
// total size: 0x8
