/*
    ...
    Language: C++
    Code range: 0x8011B86C -> 0x8011DE48
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned short popper_weight_sizes[8]; // size: 0x10, address: 0x803C5D30
// total size: 0x8
struct /* @class$1152zParticleLocator_cpp */ {
    // Members
    float ang_delta; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$1153zParticleLocator_cpp */ {
    // Members
    float length; // offset 0x0, size 0x4
    unsigned int cap_weight; // offset 0x4, size 0x4
};
// total size: 0x48
struct /* @class$1154zParticleLocator_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1155zParticleLocator_cpp */ {
    // Members
    struct popper_data * popper; // offset 0x0, size 0x4
};
// total size: 0x18
struct /* @class$1156zParticleLocator_cpp */ {
    // Members
...
// total size: 0x50
struct /* @class$1158zParticleLocator_cpp */ {
    // Members
...
static struct activity_data * activities; // size: 0x4, address: 0x803C16F8
static int activities_used; // size: 0x4, address: 0x803C16FC
static struct popper_data * poppers; // size: 0x4, address: 0x803C1700
// Range: 0x8011B86C -> 0x8011B888
...
// Range: 0x8011BAA8 -> 0x8011BB04
static void update_attach_entity_bone(struct activity_data & activity /* r31 */) {
    // Local variables
    struct xMat4x3 bone_mat; // r1+0x10
}

// Range: 0x8011BB04 -> 0x8011BC10
static unsigned char setup_attach_entity(struct activity_data & activity /* r30 */, const struct zParticleAsset & asset /* r31 */) {
    // Local variables
    struct xEnt * attach_to; // r6
}

// Range: 0x8011BC10 -> 0x8011BC18
static unsigned char setup_attach_entity_tag() {}

// Range: 0x8011BC18 -> 0x8011BC3C
...
static unsigned char setup_volume_model(struct activity_data & activity /* r31 */, const struct zParticleAsset & asset /* r0 */) {
    ...
    int model_index; // r8
    int models_size; // r9
    int total_vertices; // r10
    struct xModelInstance * m; // r11
    int size; // r0
}

// Range: 0x8011CBEC -> 0x8011CBF4
static void edge_emit_model(struct activity_data & activity /* r0 */, unsigned char edge_only /* r0 */) {}

// Range: 0x8011CBF4 -> 0x8011CCE0
...
// total size: 0x4
struct /* @class$785zParticleLocator_cpp */ {
    // Members
...
union /* @class$805zParticleLocator_cpp */ {
...
// total size: 0xC
struct /* @class$804zParticleLocator_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$854zParticleLocator_cpp */ {
    // Members
...
// Range: 0x8011CE2C -> 0x8011CEF4
void zParticleLocator::scene_enter() {
    // Local variables
    unsigned int index; // r0
    struct popper_data * it; // r27
    struct popper_data * end; // r26
...
// Range: 0x8011CF08 -> 0x8011CF14
// this: r0
void zParticleLocator::create() {}

// Range: 0x8011CF14 -> 0x8011CF18
void zParticleLocator::restart() {}

static unsigned char (* const setup_attach_table[3])(struct activity_data &, struct zParticleAsset &); // size: 0xC, address: 0x803C5D74
static unsigned char (* const setup_volume_table[6])(struct activity_data &, struct zParticleAsset &); // size: 0x18, address: 0x803C5D80
// Range: 0x8011CF18 -> 0x8011D000
// this: r29
unsigned char zParticleLocator::activate(const struct zParticleAsset & asset /* r30 */, struct xEnt * attach_to /* r31 */) {
    // References
...
// Range: 0x8011D000 -> 0x8011D06C
// this: r31
void zParticleLocator::deactivate() {}

static void (* const edge_emit_table[6])(struct activity_data &, unsigned char); // size: 0x18, address: 0x803C5D98
// Range: 0x8011D06C -> 0x8011D0A8
// this: r0
...
// Range: 0x8011D0A8 -> 0x8011D0DC
// this: r0
void zParticleLocator::update(float dt /* f0 */) {}

// Range: 0x8011D0DC -> 0x8011D184
// this: r23
void zParticleLocator::make_locations(void * data /* r4 */, int stride /* r24 */, int elements /* r0 */, int loc_offset /* r25 */) {
    // Local variables
    const struct xMat4x3 & amat; // r31
    void (* const get_offset)(struct xVec3 &, struct volume_data &); // r30
    struct volume_data & volume; // r29
    unsigned char * p; // r28
    unsigned char * endp; // r27
    struct xVec3 & loc; // r26
    struct xVec3 offset; // r1+0x8
}

// Range: 0x8011D184 -> 0x8011D190
// this: r0
struct xMat4x3 & zParticleLocator::get_frame() const {}

// Range: 0x8011D190 -> 0x8011D25C
// this: r0
...
// Range: 0x8011D660 -> 0x8011D88C
void SkinXformVertAndNormal(struct xVec3 * vert /* r19 */, struct xVec3 * norm /* r20 */, const struct xVec3 * in_vert /* r1+0x8 */, const struct xVec3 * in_norm /* r1+0xC */, const struct xMat4x3 * mat /* r21 */, const struct xMat4x3 * skinmat /* r22 */, const float * wt /* r23 */, const unsigned int * idx /* r24 */, const unsigned short * vert_index /* r25 */, unsigned int count /* r26 */) {
    // Local variables
    unsigned int catMatFlags[2]; // r1+0x10
    struct xMat4x3 * catmat; // r15
    const struct xMat4x3 * rootmat; // r21
    unsigned short i; // r3
    const struct xVec3 * cur_in_vert; // r31
    const struct xVec3 * cur_in_norm; // r30
    unsigned int cur_idx; // r29
    const float * cur_wt; // r28
    unsigned int i; // r27
    unsigned int midx; // r4
    const struct xMat4x3 * pMatrix; // r0
    const float * fwt; // r16
    unsigned int wtidx; // r17
    unsigned int maxwt; // r18
    struct xVec3 accumV; // r1+0x30
    struct xVec3 v; // r1+0x24
    struct xVec3 v; // r1+0x18
}

// Range: 0x8011D88C -> 0x8011D9DC
...
// Range: 0x8011D9DC -> 0x8011DA98
void random_surface_point(struct xVec3 & loc /* r28 */, struct xVec3 & norm /* r29 */, const struct popper_data & popper /* r30 */) {
    // Local variables
...
// Range: 0x8011DC34 -> 0x8011DC60
int count_faces(struct xModelInstance * model /* r3 */) {
    // Local variables
    int total; // r5
}

// Range: 0x8011DC60 -> 0x8011DD4C
