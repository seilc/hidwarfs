/*
    ...
    Language: C++
    Code range: 0x8012B40C -> 0x8012D89C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zFrozoneIceConfig default_config; // size: 0x28, address: 0x803C6068
// total size: 0x4
struct RwRGBA {
    // Members
...
static struct xColor_tag lower_color; // size: 0x4, address: 0x803C6090
// Range: 0x8012B40C -> 0x8012B410
...
// total size: 0xC
struct /* @class$745zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$746zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$747zFrozoneIce_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$748zFrozoneIce_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$749zFrozoneIce_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$750zFrozoneIce_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$751zFrozoneIce_cpp */ {
    // Members
...
// total size: 0x1C
struct /* @class$1233zFrozoneIce_cpp */ {
    // Members
...
struct frozone_data {
    ...
    struct xResponseCurve spike_curve[2]; // offset 0x3848, size 0x20
    // total size: 0x1C
    struct /* @class$1233zFrozoneIce_cpp */ {
        // Members
        float y0; // offset 0x0, size 0x4
        ...
        float tend; // offset 0x14, size 0x4
        float trestart; // offset 0x18, size 0x4
    } parabola; // offset 0x3868, size 0x1C
    struct RwRaster * spike_raster; // offset 0x3884, size 0x4
    struct RwRaster * spike_raster_cap; // offset 0x3888, size 0x4
    int spawn_system_id; // offset 0x388C, size 0x4
    int decay_system_id; // offset 0x3890, size 0x4
    struct xIMLockContext lock; // offset 0x3894, size 0x18
};
static struct frozone_data * frodata; // size: 0x4, address: 0x803C18C8
// total size: 0x18
...
static struct frobridge_spike_curve_node spike_appear_curve[4]; // size: 0x60, address: 0x802AFB60
static struct frobridge_spike_curve_node spike_disappear_curve[3]; // size: 0x48, address: 0x802AFBC0
// total size: 0x8
struct RwObject {
    // Members
...
// Range: 0x8012B510 -> 0x8012B584
static void load_assets() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012B584 -> 0x8012B5A4
...
// Range: 0x8012B5A4 -> 0x8012B5F0
static void free_spike(struct frobridge_spike * spike /* r0 */) {
    // Local variables
...
// Range: 0x8012B74C -> 0x8012B7D4
static void create_parabola(float & v /* r30 */, float & a /* r31 */, float y0 /* f30 */, float y1 /* f0 */, float t /* f31 */) {}

// Range: 0x8012B7D4 -> 0x8012B7F0
static float evaluate_parabola(float y0 /* f1 */, float v /* f0 */, float a /* f0 */, float t /* f0 */) {}

// Range: 0x8012B7F0 -> 0x8012B88C
...
// Range: 0x8012B9FC -> 0x8012C078
static void emit_spikes(const struct xVec3 & A /* r24 */, const struct xVec3 & B /* r0 */, float dt /* f22 */) {
    // Local variables
    float width; // f15
    float rand_offset_x; // f14
    float ABx; // f16
    float ABy; // f17
    float ABz; // f18
    float ABmag; // f0
    float old_emitted; // f19
    int emit; // r3
    float ABrmag; // f0
    float xdir; // f21
    float ydir; // f31
    ...
    float dy; // r1+0x1B8
    float dz; // r1+0x1B4
    struct frobridge_spike * spike; // r24
...
// Range: 0x8012C130 -> 0x8012C514
static void transform_spikes(struct xVec3 * pos /* r24 */, struct xVec2 * uv /* r25 */, unsigned int * color /* r26 */, const struct frobridge_spike_ref * sspikes /* r27 */, int spikes_size /* r0 */, struct xVec3 * cap_pos /* r28 */) {
    // Local variables
    const struct frobridge_spike_ref * sspike; // r31
    const struct frobridge_spike_ref * const end_sspike; // r30
    const struct frobridge_spike & spike; // r29
    float tx; // f27
    float ty; // f26
    float tz; // f25
    float bscale; // f8
...
// Range: 0x8012C514 -> 0x8012C5D0
static void setup_spike_caps(struct xVec3 * pos /* r0 */, struct xVec2 * uv /* r28 */, unsigned int * color /* r29 */, const struct frobridge_spike_ref * sspikes /* r30 */, int spikes_size /* r31 */, struct xVec3 * cap_pos /* r9 */) {
    // Local variables
...
// Range: 0x8012C644 -> 0x8012C66C
static void im_unlock() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012C66C -> 0x8012C6A8
...
// Range: 0x8012C6A8 -> 0x8012C8FC
static void render_spikes() {
    // Local variables
    int spikes_size; // r30
    struct frobridge_spike * unsorted_spikes; // r29
    struct frobridge_spike_ref * sspikes; // r31
    struct frobridge_spike_ref * sspike; // r5
...
// total size: 0x4
struct /* @class$941zFrozoneIce_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$959zFrozoneIce_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
union /* @class$764zFrozoneIce_cpp */ {
...
// Range: 0x8012C964 -> 0x8012CB74
static int update_decay_particles(unsigned char * mem /* r28 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f28 */) {
    // Local variables
    struct ptank_pool__pos_color_size & pool; // r31
    struct decay_particle * p; // r30
...
// Range: 0x8012D0EC -> 0x8012D0F0
void zFrozoneIceSceneExit() {}

// Range: 0x8012D0F0 -> 0x8012D290
...
// Range: 0x8012D290 -> 0x8012D2D4
void zFrozoneIceRender() {
    // References
    // -> static struct frozone_data * frodata;
}

// Range: 0x8012D2D4 -> 0x8012D33C
...
// Range: 0x8012D470 -> 0x8012D6EC
unsigned char zFrozoneIceEvalRecord(struct xVec3 & v0 /* r31 */, struct xVec3 & v1 /* r24 */, float t0 /* r1+0x8 */, float t1 /* r1+0xC */, const struct zFrozoneIceRecordEntry * record /* r25 */, int record_size /* r26 */) {
    // Local variables
    const struct zFrozoneIceRecordEntry * e0; // r30
    const struct zFrozoneIceRecordEntry * e1; // r29
    const struct zFrozoneIceRecordEntry * end; // r28
    const struct zFrozoneIceRecordEntry * tail; // r27
    const struct zFrozoneIceRecordEntry * e; // r3
    const struct zFrozoneIceRecordEntry * enext; // r0
}

// Range: 0x8012D6EC -> 0x8012D734
...
// total size: 0x54
struct /* @class$1127zFrozoneIce_cpp */ {
    // Members
...
// Range: 0x8012D734 -> 0x8012D798
void cinfx_frobridge_update(struct NCINEntry * fxrec /* r31 */, int killit /* r0 */) {
    // Local variables
    const struct cinfx_frobridge_context & context; // r3
}

// Range: 0x8012D798 -> 0x8012D854
void cinfx_frobridge_animate(struct NCINEntry * fxrec /* r0 */, unsigned int animIndex /* r0 */) {
    // Local variables
    const struct cinfx_frobridge_context & context; // r31
    float t0; // f31
    struct xVec3 foot_loc; // r1+0x14
    struct xVec3 lead_loc; // r1+0x8
...
// Range: 0x8012D854 -> 0x8012D858
void cinfx_frobridge_render() {}

// Range: 0x8012D858 -> 0x8012D85C
void cinfx_frobridge_add_tweaks() {}

// total size: 0x1
struct cb_compare_records {};
// Range: 0x8012D85C -> 0x8012D89C
static int cb_compare_records::operator()(float time /* f0 */, const struct zFrozoneIceRecordEntry & e /* r0 */) {
    // Local variables
    float d; // f1
}
