/*
    ...
    Language: C++
    Code range: 0x8013759C -> 0x8013759C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
class zDirectModeCam : public xCam {
    // Members
    class zPad * pad; // offset 0x130, size 0x4
    struct xVec3 direction; // offset 0x134, size 0xC
    float x; // offset 0x140, size 0x4
    float x_v; // offset 0x144, size 0x4
    float y; // offset 0x148, size 0x4
    float y_v; // offset 0x14C, size 0x4
    struct xVec3 target; // offset 0x150, size 0xC
    float target_v; // offset 0x15C, size 0x4
    struct xVec3 * object_position; // offset 0x160, size 0x4
    float path_v; // offset 0x164, size 0x4
    struct xVec3 lastCameraPosition; // offset 0x168, size 0xC
    class xCamSupportLOSBar losbar; // offset 0x174, size 0x38
    class xCamSupportPath path; // offset 0x1AC, size 0xA8
};
// total size: 0x8
...
// total size: 0x4
struct /* @class$823zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$941zNPCDirectMode_cpp */ {
    // Members
...
union /* @class$858zNPCDirectMode_cpp */ {
...
// total size: 0xC
struct /* @class$727zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$728zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$729zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$730zNPCDirectMode_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$731zNPCDirectMode_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$732zNPCDirectMode_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$733zNPCDirectMode_cpp */ {
    // Members
...
class zDirectMode : public zBehaviorImplementation {
    // Members
    class zDirectModeCam cam; // offset 0x30, size 0x260
    class zPad * pad; // offset 0x290, size 0x4
    struct xVec3 target; // offset 0x294, size 0xC
    float rotation; // offset 0x2A0, size 0x4
    float analog_x; // offset 0x2A4, size 0x4
    float analog_x_v; // offset 0x2A8, size 0x4
    float analog_y; // offset 0x2AC, size 0x4
    float analog_y_v; // offset 0x2B0, size 0x4
    float growEffectTime; // offset 0x2B4, size 0x4
    class invis_walk & controlBehavior; // offset 0x2B8, size 0x4
};
// total size: 0x40
...
// total size: 0x4
struct /* @class$1233zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1200zNPCDirectMode_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1201zNPCDirectMode_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1202zNPCDirectMode_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1199zNPCDirectMode_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1204zNPCDirectMode_cpp */ {
    // Members
