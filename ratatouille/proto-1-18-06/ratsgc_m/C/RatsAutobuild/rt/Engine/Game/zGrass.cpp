/*
    ...
    Language: C++
    Code range: 0x801005CC -> 0x80103058
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x801005CC -> 0x801005D0
static void add_tweaks() {}

class zGrass * grass; // size: 0x4, address: 0x803C1398
// total size: 0x18
struct analog_data {
    // Members
...
// Range: 0x80100714 -> 0x80100748
void zGrass::scene_exit() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100748 -> 0x80100754
void zGrass::setup() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100754 -> 0x8010082C
void zGrass::reset() {
    // Local variables
...
// Range: 0x8010082C -> 0x80100858
void zGrass::update(float dt /* f0 */) {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100858 -> 0x80100864
void zGrass::pre_render() {
    // References
    // -> class zGrass * grass;
}

// Range: 0x80100864 -> 0x801008B8
void zGrass::render() {
    // References
    // -> class zGrass * grass;
}
...
// Range: 0x80100EAC -> 0x80100EBC
void zGrass::reset_cache(struct grass_cache & cache /* r0 */) {}

// Range: 0x80100EBC -> 0x80100F20
// this: r31
void zGrass::reset_view_area() {}

// Range: 0x80100F20 -> 0x80100F34
// this: r0
...
// Range: 0x80101FB8 -> 0x80101FEC
// this: r0
void zGrass::wipe_cell(struct view_cell & vcell /* r0 */) {}

// Range: 0x80101FEC -> 0x801022EC
// this: r15
...
// Range: 0x80102D3C -> 0x80102DB8
// this: r31
void zGrass::create_white_light() {}

// Range: 0x80102DB8 -> 0x80102DE0
// this: r3
void zGrass::destroy_white_light() {}

// Range: 0x80102DE0 -> 0x80102EC0
// this: r26
