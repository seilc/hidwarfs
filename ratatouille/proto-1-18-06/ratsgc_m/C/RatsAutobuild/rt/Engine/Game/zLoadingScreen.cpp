/*
    ...
    Language: C++
    Code range: 0x80122490 -> 0x80122A48
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned char show_stats; // size: 0x1, address: 0x803C1738
// total size: 0x4
class Screen {
    // Members
public:
...
// total size: 0x18
struct {} zLoadingScreen::__vtable; // size: 0x18, address: 0x803BD3F0
