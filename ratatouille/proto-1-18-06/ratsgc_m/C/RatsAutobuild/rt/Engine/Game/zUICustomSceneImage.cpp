/*
    ...
    Language: C++
    Code range: 0x80159FA0 -> 0x8015A154
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x50
struct {} zUICustomSceneImage::__vtable; // size: 0x50, address: 0x802DC508
// total size: 0xC
