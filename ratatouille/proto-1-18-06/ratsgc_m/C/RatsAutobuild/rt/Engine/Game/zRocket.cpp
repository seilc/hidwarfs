/*
    ...
    Language: C++
    Code range: 0x8010C8DC -> 0x8010CEC4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
int system_id; // size: 0x4, address: 0x803BD0F8
static unsigned char need_setup; // size: 0x1, address: 0x803BD0FC
// total size: 0x1
class smoke_trail {
    // Static members
...
// total size: 0x4
struct /* @class$1283zRocket_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1284zRocket_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x1
struct /* @class$768zRocket_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$769zRocket_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$770zRocket_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$771zRocket_cpp */ {
    // Members
