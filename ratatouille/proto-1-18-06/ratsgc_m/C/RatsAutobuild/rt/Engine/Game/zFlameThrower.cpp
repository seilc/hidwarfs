/*
    ...
    Language: C++
    Code range: 0x8010A834 -> 0x8010C118
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8010A834 -> 0x8010A854
void zFlameThrowerWidget::Init(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}

class zLightweightSystem * zLightweight<flamethrower, 10>::GetSystem()::system; // size: 0x4, address: 0x803C1410
signed char zLightweight<flamethrower, 10>::GetSystem()::localstatic4 guard; // size: 0x1, address: 0x803C1414
// total size: 0x30
struct xMat3x3 {
    // Members
...
// total size: 0x24
struct {} zLightweightSystem<flamethrower, 10>::__vtable; // size: 0x24, address: 0x803BD0D0
// Range: 0x8010A934 -> 0x8010AB30
void zFlameThrowerWidget::EventCB(struct xBase * to /* r30 */, unsigned int toEvent /* r0 */, const float * toParam /* r31 */) {
    // Local variables
...
static struct config flamethrower_config; // size: 0x44, address: 0x8037EE60
static float length_modifier; // size: 0x4, address: 0x803BD088
static float radius_modifier; // size: 0x4, address: 0x803BD08C
unsigned char draw_damage; // size: 0x1, address: 0x803C1415
// Range: 0x8010AB30 -> 0x8010ABD0
...
// total size: 0x20
struct {} flamethrower::__vtable; // size: 0x20, address: 0x803BD090
// Range: 0x8010ABD0 -> 0x8010ACE8
// this: r27
flamethrower::flamethrower(const struct xVec3 & position /* r28 */, const struct xVec3 & direction /* r29 */, float length /* f28 */, float burst_time /* f29 */, const struct xColor_tag & color /* r30 */, int damage /* r31 */, float knockback /* f30 */, float damage_radius /* f31 */) {
    // Local variables
    struct collision_particle * end; // r4
    struct collision_particle * p; // r5
...
// total size: 0x20
struct {} zLightweight<flamethrower, 10>::__vtable; // size: 0x20, address: 0x803BD0B0
// Range: 0x8010ACE8 -> 0x8010AD24
// this: r31
...
// total size: 0x4
struct /* @class$923zFlameThrower_cpp */ {
    // Members
...
union /* @class$746zFlameThrower_cpp */ {
...
// Range: 0x8010AEB8 -> 0x8010B040
// this: r25
void flamethrower::collision_emit(const struct xVec3 & position /* r26 */, const struct xVec3 & direction /* r27 */, const struct xVec3 & velocity /* r28 */, float dt /* f30 */) {
    // Local variables
...
struct FlameThrowerCollisionInfo flameThrowerCollisionInfo; // size: 0x14, address: 0x803C1418
struct RwTexture * particleTex; // size: 0x4, address: 0x803C142C
enum FTParType {
    TYPE_A = 0,
    TYPE_B = 1,
};
...
private:
    const struct zFlameThrowerCfg & cfg; // offset 0x14, size 0x4
...
// total size: 0xC
struct /* @class$941zFlameThrower_cpp */ {
    // Members
...
// Range: 0x8010B57C -> 0x8010BD10
// this: r25
void zFlameThrower::UpdateParticles(float dt /* f28 */, struct xVec3 & velocity /* r26 */) {
    // Local variables
    struct xMat4x3 & mat; // r31
    float collide_distance; // f0
    unsigned char isActive; // r30
    int p; // r29
...
class zFlameThrowerMgr * flameThrowerMgr; // size: 0x4, address: 0x803C1430
// total size: 0xC
...
// Range: 0x8010BF78 -> 0x8010BF90
void zFlameThrowerMgr::Remove() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x8010BF90 -> 0x8010BFD0
void zFlameThrowerMgr::Reset() {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x8010BFD0 -> 0x8010BFDC
// this: r0
zFlameThrowerMgr::zFlameThrowerMgr() {}

// Range: 0x8010BFDC -> 0x8010C038
// this: r0
void zFlameThrowerMgr::FreeMem(class zFlameThrower * mem /* r0 */) {}

// Range: 0x8010C038 -> 0x8010C064
void zFlameThrowerMgr::Update(float dt /* f0 */) {
    // References
    // -> class zFlameThrowerMgr * flameThrowerMgr;
}

// Range: 0x8010C064 -> 0x8010C108
// this: r0
...
// Range: 0x8010C108 -> 0x8010C110
// this: r3
unsigned char zFlameThrower::IsShutDown() {}

// Range: 0x8010C110 -> 0x8010C118
// this: r3
