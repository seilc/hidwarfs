/*
    ...
    Language: C++
    Code range: 0x8018C6A0 -> 0x8018D200
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
unsigned char inOverlayScreen; // size: 0x1, address: 0x803C20C0
float inOverlayScreenExitTimer; // size: 0x4, address: 0x803C20C4
static int sysMsgType; // size: 0x4, address: 0x803C20C8
static unsigned char screenAdjusted; // size: 0x1, address: 0x803C20CC
static unsigned char screenIsInSystemMessage; // size: 0x1, address: 0x803C20CD
// Range: 0x8018C6A0 -> 0x8018C6A8
unsigned char zUICustomOptionsScreenIsInSystemMessage() {
    // References
    // -> static unsigned char screenIsInSystemMessage;
}

// Range: 0x8018C6A8 -> 0x8018C6B0
...
// total size: 0x50
struct {} zUICustomOptionsManager::__vtable; // size: 0x50, address: 0x802DF7D8
// total size: 0x8
struct RwObject {
    // Members
...
class zUICustomVolume * pUICustomMusicVolumeManager; // size: 0x4, address: 0x803C1B18
class zUICustomVolume * pUICustomSFXVolumeManager; // size: 0x4, address: 0x803C1B1C
// total size: 0x0
struct xCamGroup {};
// total size: 0x0
struct xCamScreen {};
...
class zUI * pSysMessageManager; // size: 0x4, address: 0x803C18F4
class zUICustom * pSysMessageManager_Custom; // size: 0x4, address: 0x803C18F8
// Range: 0x8018C7AC -> 0x8018D060
// this: r24
