/*
    ...
    Language: C++
    Code range: 0x8015D254 -> 0x8015F8B8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int lastUsedPadMRI; // size: 0x4, address: 0x803BD9C8
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
union /* @class$805zRemyPlayer_cpp */ {
...
// total size: 0x4
struct /* @class$786zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x54
struct /* @class$1359zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$751zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zRemyPlayer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$753zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$754zRemyPlayer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$755zRemyPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$756zRemyPlayer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$757zRemyPlayer_cpp */ {
    // Members
...
static class zCombatAttack remyAttackStates[14]; // size: 0x9D8, address: 0x8038DAC8
static unsigned int NUM_HIT_STARS; // size: 0x4, address: 0x803BD9CC
// total size: 0x5C
struct config {
    // Members
...
static struct config punch_stars_config; // size: 0x5C, address: 0x8038E4A0
static struct config hit_stars_config; // size: 0x5C, address: 0x8038E4FC
// total size: 0x50
struct /* @class$1468zRemyPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x44
struct /* @class$1469zRemyPlayer_cpp */ {
    // Members
...
static struct config uppercut_slam_config; // size: 0xC4, address: 0x8038E558
static struct config finish_slam_config; // size: 0xC4, address: 0x8038E61C
// total size: 0xC
struct curve_node {
    // Members
...
static struct config_type punch_streak_cfg; // size: 0x20, address: 0x803C1C10
static struct curve_node punch_streak_ribbon_curve[3]; // size: 0x24, address: 0x803BD9D0
// total size: 0xC
struct HFXSlamInfo {
    // Members
...
static struct HFXSlamInfo uppercut_slam; // size: 0xC, address: 0x803BD9F4
static struct HFXSlamInfo finish_slam; // size: 0xC, address: 0x803BDA00
// total size: 0x20
struct AttackFX {
    // Members
...
static struct AttackFX AttackFXList[15]; // size: 0x1E0, address: 0x802DC9F0
// total size: 0x14
struct HitFX {
    // Members
    unsigned int anim; // offset 0x0, size 0x4
...
static struct HitFX HitFXList[2]; // size: 0x28, address: 0x803BDA0C
// total size: 0x18
struct analog_data {
    // Members
...
// Range: 0x8015D254 -> 0x8015D4E4
static void RemyMeleeHit(struct xEnt * hitter /* r25 */, const class zCombatAttack * runningAttack /* r0 */, struct xEnt * hittee /* r0 */, const struct xVec3 * hit_loc /* r26 */, const struct xVec3 * hit_norm /* r30 */) {
    // Local variables
    struct zRemyPlayer * player; // r0
    unsigned int anim; // r29
    struct HitFX * hfx; // r28
    struct HitFX * end; // r27
    float time; // f1
...
static struct compositeEffect rumbleEffects[1]; // size: 0x50, address: 0x8038E6E0
// Range: 0x8015D4E4 -> 0x8015D4FC
...
struct zRemyPlayer : public zCommonPlayer {
    ...
    // Members
    int lastSlickness; // offset 0xF60, size 0x4
    float minVelmag; // offset 0xF64, size 0x4
    float surfDamping; // offset 0xF68, size 0x4
    int surfSlickness; // offset 0xF6C, size 0x4
    float surfFriction; // offset 0xF70, size 0x4
    unsigned int surfSticky; // offset 0xF74, size 0x4
private:
    float ShockRadius; // offset 0xF78, size 0x4
    float ShockRadiusOld; // offset 0xF7C, size 0x4
    unsigned int * atomics_order; // offset 0xF80, size 0x4
    unsigned int atomics_count; // offset 0xF84, size 0x4
    struct xVec3 bone_adjust; // offset 0xF88, size 0xC
    struct xVec3 prev_at; // offset 0xF94, size 0xC
    struct xVec3 prev_bi_normal; // offset 0xFA0, size 0xC
    float x_lean; // offset 0xFAC, size 0x4
    float y_lean; // offset 0xFB0, size 0x4
    float last_sign; // offset 0xFB4, size 0x4
    unsigned int modelRender; // offset 0xFB8, size 0x4
    struct xResponseCurve mShockWaveAlphaCurve; // offset 0xFBC, size 0x10
};
// Range: 0x8015D4FC -> 0x8015D548
// this: r31
...
// total size: 0x4
struct /* @class$1185zRemyPlayer_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1186zRemyPlayer_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1187zRemyPlayer_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1184zRemyPlayer_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1189zRemyPlayer_cpp */ {
    // Members
...
// Range: 0x8015D548 -> 0x8015D568
// this: r0
void zRemyPlayer::SetupRumbles() {}

// Range: 0x8015D568 -> 0x8015D5E0
// this: r31
...
// total size: 0x4
struct /* @class$1457zRemyPlayer_cpp */ {
    // Members
...
static struct alpha_curve_node alphaCurve[4]; // size: 0x20, address: 0x803C6BE8
struct config default_config; // size: 0x5C, address: 0x80388CF8
struct config default_config; // size: 0xC4, address: 0x8037AC20
// total size: 0xC
...
struct xColor_tag g_RED; // size: 0x4, address: 0x803C3310
// Range: 0x8015DC88 -> 0x8015DCCC
// this: r31
...
// Range: 0x8015DCCC -> 0x8015DD20
// this: r31
void zRemyPlayer::Reset() {}

// Range: 0x8015DD20 -> 0x8015DDC0
// this: r3
void zRemyPlayer::DefaultBeginUpdate(float dt /* f1 */) {
    // Local variables
    int num_bones; // r8
    struct xModelInstance * m; // r9
    int i; // r0
}

// Range: 0x8015DDC0 -> 0x8015DE30
// this: r31
void zRemyPlayer::DefaultUpdate(float dt /* f31 */) {}

// Range: 0x8015DE30 -> 0x8015DE50
// this: r0
...
// total size: 0xC
struct /* @class$804zRemyPlayer_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
static float time; // size: 0x4, address: 0x803C1C30
static float lastTime; // size: 0x4, address: 0x803C1C34
static struct xFXRibbon * up; // size: 0x4, address: 0x803C1C38
static float distance; // size: 0x4, address: 0x803C1C3C
static struct xVec3 averageWidth; // size: 0xC, address: 0x803C1C40
...
// Range: 0x8015E318 -> 0x8015E694
static void update_and_add_to_punch_streak(struct xFXRibbon * effect /* r25 */, struct xMat4x3 * mat /* r26 */, unsigned int count /* r27 */, struct xEntFrame * frame /* r28 */) {
    // Local variables
    struct xVec3 prevElement; // r1+0xA0
    struct xQuat oldOrient; // r1+0x90
    struct xQuat newOrient; // r1+0x80
    unsigned int i; // r30
    struct xVec3 * cacheElement; // r29
...
// Range: 0x8015EAA0 -> 0x8015EAE4
// this: r31
float zRemyPlayer::InitialDepenetrationVelocity() {}

// Range: 0x8015EAE4 -> 0x8015EB10
// this: r3
...
// Range: 0x8015EB9C -> 0x8015EBA4
int * zRemyPlayer::GetHeadBones() {}

// Range: 0x8015EBA4 -> 0x8015F41C
// this: r31
...
static struct xHierarchyBoundInitData bounds[14]; // size: 0xA8, address: 0x802DCBD0
// Range: 0x8015F774 -> 0x8015F780
struct xHierarchyBoundInitData * zRemyPlayer::GetHierarchyBoundInitData() {
    // References
    // -> static struct xHierarchyBoundInitData bounds[14];
}

// Range: 0x8015F780 -> 0x8015F788
...
// Range: 0x8015F850 -> 0x8015F870
// this: r0
void zRemyPlayer::LoadSetupUpgrades() {}

// total size: 0x50
struct {} zPlayerSpringboard::__vtable; // size: 0x50, address: 0x802DCC78
...
// total size: 0x50
struct {} zPlayerContextAction::__vtable; // size: 0x50, address: 0x802DCCC8
// total size: 0x50
struct {} zCommonPlayerAction::__vtable; // size: 0x50, address: 0x802DCD18
// total size: 0x154
struct {} zRemyPlayer::__vtable; // size: 0x154, address: 0x802DCD68
// total size: 0xC
