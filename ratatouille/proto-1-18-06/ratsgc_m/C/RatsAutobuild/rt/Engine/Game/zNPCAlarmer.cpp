/*
    ...
    Language: C++
    Code range: 0x801A7C00 -> 0x801A8210
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
signed char zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::localstatic4 guard; // size: 0x1, address: 0x803C2418
// total size: 0xC
...
class zComponentPool zComponentPool<zCompLogicAlarmer, zICompLogic, zNPCBase>::GetComponentPool()::_componentPool; // size: 0xC, address: 0x803C241C
// total size: 0xC
class zComponentPool {
    // Members
    int extraComponentMemUsage; // offset 0x0, size 0x4
...
// Range: 0x801A7C7C -> 0x801A7C9C
// this: r0
void zNPCAlarmer::Deactivate() {}

// Range: 0x801A7C9C -> 0x801A7D4C
// this: r28
void zNPCAlarmer::Update(struct xScene * xscn /* r29 */, float dt /* f31 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$829zNPCAlarmer_cpp */ {
    // Members
...
union /* @class$849zNPCAlarmer_cpp */ {
...
// total size: 0xC
struct /* @class$847zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$759zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$760zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$761zNPCAlarmer_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$762zNPCAlarmer_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$763zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$764zNPCAlarmer_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$765zNPCAlarmer_cpp */ {
    // Members
...
// Range: 0x801A812C -> 0x801A8210
// this: r30
void zCompLogicAlarmer::ChangeState(enum eAlarmerStates nextState /* r31 */) {
    // Local variables
    class zICompNPCEntity * compNPCEntity; // r0
}
...
// total size: 0x3C
struct {} zNPCAlarmer::__vtable; // size: 0x3C, address: 0x803BE458
