/*
    ...
    Language: C++
    Code range: 0x8014CBA4 -> 0x8014D3D4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x120
struct {} zNPCMove::__vtable; // size: 0x120, address: 0x802DC0D8
// total size: 0x10
