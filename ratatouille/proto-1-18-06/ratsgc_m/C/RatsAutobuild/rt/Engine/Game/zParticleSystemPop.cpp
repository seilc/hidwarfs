/*
    ...
    Language: C++
    Code range: 0x80151080 -> 0x80151B94
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// total size: 0x4
struct /* @class$923zParticleSystemPop_cpp */ {
    // Members
...
union /* @class$746zParticleSystemPop_cpp */ {
...
// total size: 0xC
struct /* @class$941zParticleSystemPop_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$992zParticleSystemPop_cpp */ {
    // Members
...
static class zParticleLocator * sLocatorPool; // size: 0x4, address: 0x803C1AC8
static int sLocatorsUsed; // size: 0x4, address: 0x803C1ACC
// total size: 0x8
...
// Range: 0x80151198 -> 0x801514C4
int zParticleSystemPop::update_particles(unsigned char * mem /* r22 */, int count /* r0 */, struct ptank_pool & apool /* r5 */, float dt /* f27 */, void * context /* r0 */) {
    // Local variables
...
struct zParticleGeneratorPop : public zParticleGenerator {
    ...
    // Members
protected:
    class zParticleSystemPop * system; // offset 0x20, size 0x4
    struct xEnt * attach_to; // offset 0x24, size 0x4
    float emitted; // offset 0x28, size 0x4
    class zParticleLocator * locators[40]; // offset 0x2C, size 0xA0
    int numLocators; // offset 0xCC, size 0x4
    int batch_id; // offset 0xD0, size 0x4
};
// Range: 0x801514C4 -> 0x80151720
// this: r31
...
// Range: 0x8015182C -> 0x801518B4
// this: r31
void zParticleGeneratorPop::reset() {}

// Range: 0x801518B4 -> 0x801518D0
...
// Range: 0x801518D0 -> 0x80151910
void freeLocator(class zParticleLocator * locator /* r0 */) {
    // Local variables
...
// total size: 0x20
struct {} zParticleGeneratorPop::__vtable; // size: 0x20, address: 0x803BD888
// total size: 0x34
struct {} zParticleSystemPop::__vtable; // size: 0x34, address: 0x803BD8A8
// total size: 0x8
