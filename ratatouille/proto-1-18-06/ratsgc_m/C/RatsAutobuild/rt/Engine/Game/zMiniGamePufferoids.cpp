/*
    ...
    Language: C++
    Code range: 0x801B7814 -> 0x801B88D8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static unsigned int P1_STATS_BOX_ID; // size: 0x4, address: 0x803C25D0
static unsigned int P2_STATS_BOX_ID; // size: 0x4, address: 0x803C25D4
static unsigned int RESULT_IMG_ID; // size: 0x4, address: 0x803C25D8
static unsigned int WIN_TEX_ID; // size: 0x4, address: 0x803C25DC
static unsigned int P1_WIN_TEX_ID; // size: 0x4, address: 0x803C25E0
static unsigned int P2_WIN_TEX_ID; // size: 0x4, address: 0x803C25E4
static unsigned int LOSE_TEX_ID; // size: 0x4, address: 0x803C25E8
static unsigned int PUFF_MODEL_IDS[5]; // size: 0x14, address: 0x803BEC28
// total size: 0x8
struct xVec2 {
    // Members
    float x; // offset 0x0, size 0x4
...
// total size: 0x4
struct /* @class$816zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$905zMiniGamePufferoids_cpp */ {
    // Members
...
union /* @class$901zMiniGamePufferoids_cpp */ {
...
// Range: 0x801B7814 -> 0x801B790C
// this: r27
void zMiniGamePufferoidsPuff::Init(struct PuffInitData * data /* r28 */) {
    // Local variables
...
// Range: 0x801B7D70 -> 0x801B7E6C
// this: r0
void zMiniGamePufferoidsPuff::ProjectileHit(int owner /* r0 */, int value /* r0 */) {}

// Range: 0x801B7E6C -> 0x801B7E78
// this: r0
void zMiniGamePufferoidsPuff::Kill() {}

// total size: 0x78
struct {} zMiniGamePufferoids::__vtable; // size: 0x78, address: 0x802E32B8
// total size: 0x34
...
// total size: 0x1
struct /* @class$844zMiniGamePufferoids_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$846zMiniGamePufferoids_cpp */ {
    // Members
    float width; // offset 0x0, size 0x4
    float height; // offset 0x4, size 0x4
};
// total size: 0x8
struct /* @class$847zMiniGamePufferoids_cpp */ {
    // Members
    float x; // offset 0x0, size 0x4
    float y; // offset 0x4, size 0x4
};
...
// total size: 0x10
struct /* @class$848zMiniGamePufferoids_cpp */ {
    // Members
...
enum /* @enum$849zMiniGamePufferoids_cpp */ {
    XJ_LEFT = 0,
    XJ_CENTER = 1,
    XJ_RIGHT = 2,
};
enum /* @enum$850zMiniGamePufferoids_cpp */ {
    YJ_TOP = 0,
    YJ_CENTER = 1,
    YJ_BOTTOM = 2,
};
enum /* @enum$851zMiniGamePufferoids_cpp */ {
    EX_UP = 0,
    EX_CENTER = 1,
    EX_DOWN = 2,
    MAX_EX = 3,
...
// total size: 0x1C
struct /* @class$853zMiniGamePufferoids_cpp */ {
    // Members
    unsigned int type; // offset 0x0, size 0x4
...
// total size: 0x2
struct /* @class$841zMiniGamePufferoids_cpp */ {
    // Members
...
// Range: 0x801B7EC4 -> 0x801B7F84
void zMiniGamePufferoids::Init(struct xBase & data /* r30 */, struct xDynAsset & asset /* r29 */) {
    // Local variables
    int i; // r6
...
// Range: 0x801B8020 -> 0x801B80BC
// this: r30
void zMiniGamePufferoids::SetupStage(unsigned int id /* r0 */, unsigned char resetPickup /* r31 */) {
    // Local variables
    struct xGroup * pickupSpawnGroup; // r4
}

// Range: 0x801B80BC -> 0x801B824C
// this: r31
...
static char statsBuf[4][128]; // size: 0x200, address: 0x80395960
// Range: 0x801B83E8 -> 0x801B8738
// this: r31
void zMiniGamePufferoids::Update(float dt /* f30 */) {
    // Local variables
    int i; // r25
    int grabbedPickup; // r1+0x8
    class zMiniGamePufferoidsPuff * curr; // r25
    class zMiniGamePufferoidsPuff * prev; // r26
    class zMiniGamePufferoidsPuff * next; // r27
    int num; // r4
    int deadCount; // r25
    int k; // r26
    int j; // r24
