/*
    ...
    Language: C++
    Code range: 0x801A03D4 -> 0x801A06A4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int sFirstPlayerPadPort; // size: 0x4, address: 0x803C2240
// total size: 0xB20
...
// total size: 0x128
struct {} zMiniGamePlayer::__vtable; // size: 0x128, address: 0x802E0470
