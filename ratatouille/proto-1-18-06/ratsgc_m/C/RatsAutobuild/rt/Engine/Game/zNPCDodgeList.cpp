/*
    ...
    Language: C++
    Code range: 0x8014A92C -> 0x8014AC74
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct zNPCDodgeListObject * sNPCDodgeListObjects; // size: 0x4, address: 0x803C1A08
static struct xVec3 * sNPCDodgeListObjectsVelocity; // size: 0x4, address: 0x803C1A0C
static struct xVec3 * sNPCDodgeListObjectsVelocityNormalized; // size: 0x4, address: 0x803C1A10
static struct xVec3 * sNPCDodgeListObjectsLocation; // size: 0x4, address: 0x803C1A14
static float sSinAngle; // size: 0x4, address: 0x803C1A18
static float sCos2Angle; // size: 0x4, address: 0x803C1A1C
unsigned int gActiveHeap; // size: 0x4, address: 0x803BFB54
// Range: 0x8014A9C0 -> 0x8014AA50
