/*
    ...
    Language: C++
    Code range: 0x8015B8D4 -> 0x8015BF5C
*/
unsigned int loadSceneID; // size: 0x4, address: 0x803C1BB0
// total size: 0x50
struct {} zUICustomWireframe::__vtable; // size: 0x50, address: 0x802DC7D8
// total size: 0xC
...
// Range: 0x8015B91C -> 0x8015BB80
// this: r31
void zUICustomWireframe::Init() {
    // Local variables
    char wireframeName[1024]; // r1+0x13C
    char sceneName[5]; // r1+0x8
    char * ID; // r5
    struct PKRAssetTOCInfo info; // r1+0x10
    int found; // r0
    unsigned int size; // r30
    const char * hipFilename; // r0
    unsigned char error; // r29
    struct tag_xFile hipFile; // r1+0x28
    int err; // r0
    float dx; // f31
    float dy; // f30
    unsigned int i; // r29
...
// Range: 0x8015BB80 -> 0x8015BEEC
// this: r29
unsigned char zUICustomWireframe::PreRender() {
    // Local variables
    float scaleX; // f2
    float scaleY; // f0
    struct zWireframeVertex * assetVertices; // r31
...
// Range: 0x8015BEEC -> 0x8015BF58
// this: r0
void zUICustomWireframe::PreUpdate(float dt /* f0 */) {}

// Range: 0x8015BF58 -> 0x8015BF5C
