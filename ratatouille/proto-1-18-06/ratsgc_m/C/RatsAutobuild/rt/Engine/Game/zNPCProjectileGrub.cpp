/*
    ...
    Language: C++
    Code range: 0x801772AC -> 0x80177EB4
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct curve_node decalCurve[5]; // size: 0x8C, address: 0x802B18D8
static unsigned int FLY_SOUND_ID; // size: 0x4, address: 0x803C1D78
static unsigned int LAUNCH_SOUND_ID; // size: 0x4, address: 0x803C1D7C
static unsigned int SPLAT_SOUND_ID; // size: 0x4, address: 0x803C1D80
static unsigned int GRUB_BUG_MODEL_ID; // size: 0x4, address: 0x803C1D84
static unsigned int GRUB_BUG_SURFACE_ID; // size: 0x4, address: 0x803C1D88
// total size: 0x44
struct TrailConfig {
    // Members
...
static struct TrailConfig PuffConfig; // size: 0x44, address: 0x802DEB68
static struct TrailConfig ShortTrailConfig; // size: 0x44, address: 0x802DEBAC
// total size: 0x1C
struct ArcConfig {
    // Members
...
enum iSndGroupHandle launchSoundGroup; // size: 0x4, address: 0x803BDC18
enum iSndGroupHandle flyingSoundGroup; // size: 0x4, address: 0x803BDC1C
enum iSndGroupHandle splatSoundGroup; // size: 0x4, address: 0x803BDC20
// total size: 0x20
struct xLinkAsset {
    // Members
...
// total size: 0x4
struct /* @class$785zNPCProjectileGrub_cpp */ {
    // Members
...
union /* @class$805zNPCProjectileGrub_cpp */ {
...
// total size: 0xC
struct /* @class$804zNPCProjectileGrub_cpp */ {
    // Members
    float t; // offset 0x0, size 0x4
...
struct xSurface * grubScrollingSurf; // size: 0x4, address: 0x803C1D8C
enum zFragType {
    eFragInactive = 0,
    eFragGroup = 1,
    eFragShrapnel = 2,
...
// total size: 0x54
struct /* @class$1143zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$750zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$751zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$752zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x1
struct /* @class$753zNPCProjectileGrub_cpp */ {
    // Members
    unsigned char value_def; // offset 0x0, size 0x1
};
// total size: 0x10
struct /* @class$754zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
...
// total size: 0x8
struct /* @class$755zNPCProjectileGrub_cpp */ {
    // Members
    unsigned int value_def; // offset 0x0, size 0x4
    unsigned int mask; // offset 0x4, size 0x4
};
// total size: 0x10
struct /* @class$756zNPCProjectileGrub_cpp */ {
    // Members
...
// Range: 0x80177980 -> 0x80177C44
// this: r31
void zNPCProjectileGrub::Collide(const struct xVec3 & dpos /* r25 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$1295zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1262zNPCProjectileGrub_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1263zNPCProjectileGrub_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1264zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1261zNPCProjectileGrub_cpp */ {
    // Members
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1266zNPCProjectileGrub_cpp */ {
    // Members
...
// total size: 0x38
struct {} zNPCProjectileGrub::__vtable; // size: 0x38, address: 0x803BDC24
// total size: 0x0
