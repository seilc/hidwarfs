/*
    ...
    Language: C++
    Code range: 0x801313A4 -> 0x80132E7C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x803C1900
// total size: 0x18
...
struct /* @class$1131zParticleCustom_cpp */ {
    ...
    int dust; // offset 0x10, size 0x4
    int fire_smoke; // offset 0x14, size 0x4
} system_id; // size: 0x18, address: 0x803C1908
...
static float dust_vel_decay; // size: 0x4, address: 0x803C1920
// Range: 0x80132440 -> 0x8013246C
