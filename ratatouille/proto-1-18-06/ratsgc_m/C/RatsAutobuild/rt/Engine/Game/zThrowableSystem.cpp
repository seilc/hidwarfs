/*
    ...
    Language: C++
    Code range: 0x801164AC -> 0x80118050
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static float carryDamageMultipliers[3]; // size: 0xC, address: 0x803C5C68
static float carryRadiusMultipliers[3]; // size: 0xC, address: 0x803C5C74
static unsigned int throwEffectFlags[3]; // size: 0xC, address: 0x803C5C80
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$785zThrowableSystem_cpp */ {
    // Members
...
union /* @class$805zThrowableSystem_cpp */ {
...
// total size: 0xC
struct /* @class$804zThrowableSystem_cpp */ {
    // Members
...
static class zFXShockwaveConfig shockwaveConfig; // size: 0x18, address: 0x803C1560
// total size: 0x4
struct xColor_tag {
    // Members
    union { // inferred
...
static struct StaticThrowableProperty staticThrowableProperties[3]; // size: 0x78, address: 0x802DB4A0
// total size: 0xC
...
static struct ThrowableModelMap * throwModelMap; // size: 0x4, address: 0x803C1578
static unsigned int throwModelMapCount; // size: 0x4, address: 0x803C157C
static unsigned int throwModelMapMaxCount; // size: 0x4, address: 0x803C1580
// total size: 0x0
struct zFrag {};
enum zFragType {
    eFragInactive = 0,
...
static struct zThrowableProperty * throwProperties; // size: 0x4, address: 0x803C1584
static unsigned int throwPropertiesCount; // size: 0x4, address: 0x803C1588
static unsigned int throwPropertiesMaxCount; // size: 0x4, address: 0x803C158C
// Range: 0x801164AC -> 0x801164CC
static int UintCompare(unsigned int a /* r0 */, unsigned int b /* r0 */) {}

// Range: 0x801164CC -> 0x80116554
...
static struct RunningThrow * runningThrows; // size: 0x4, address: 0x803C1594
static struct PointTarget * addedTargets; // size: 0x4, address: 0x803C1598
static unsigned int addedTargetsCount; // size: 0x4, address: 0x803C159C
// total size: 0xC
struct RwV3d {
    // Members
    float x; // offset 0x0, size 0x4
...
// Range: 0x801165A0 -> 0x8011691C
static void EmitSparks(const struct xVec3 & start /* r20 */, const struct xVec3 & dir /* r21 */, float distance /* f26 */, float dt /* f27 */) {
    // Local variables
    ...
    int particleCounter; // r25
    struct xVec3 * locPtr; // r24
    struct xVec3 * dirPtr; // r23
    float * lenPtr; // r22
    float ang; // f17
    float uz; // f16
    float r; // f0
...
static struct smoke_config smokeConfig; // size: 0x38, address: 0x803C15A0
struct smoke_config default_config; // size: 0x38, address: 0x803C1438
// Range: 0x8011691C -> 0x80116988
...
// Range: 0x80116CF8 -> 0x801170B8
void zThrowableSystemAddBasicTypes() {
    // Local variables
    int count; // r0
    int i; // r23
    unsigned int size; // r1+0x8
    struct ThrowableTableAsset * table; // r0
    int i; // r25
    struct ThrowableTableAsset * table; // r0
    unsigned int j; // r24
...
// Range: 0x801170B8 -> 0x801171E8
void zThrowableSystemRegister(unsigned int baseModel /* r26 */, unsigned int animCode /* r27 */, float minThrowSpeed /* f0 */, float maxThrowSpeed /* f0 */, float dropSpeed /* f0 */, float maxThrowTime /* f0 */, float rotationRate /* f0 */, unsigned int (* collide)(float &, struct xEnt *, struct xEnt *, struct xVec3 *, struct xVec3 *, float, float, void *) /* r0 */, void * collideData /* r0 */, unsigned int (* destroy)(struct xEnt *, void *, unsigned char) /* r0 */, void * destroyData /* r0 */, struct zShrapnelAsset * shrapnel /* r0 */, const char * splashName /* r10 */, unsigned int flags /* r28 */, const struct xVec3 * preferOffset /* r29 */, const struct xVec3 * preferUp /* r30 */) {
    // Local variables
...
// Range: 0x801171E8 -> 0x80117214
static void InsertModelMap(unsigned int model /* r0 */, unsigned int property /* r0 */, unsigned int animCode /* r0 */) {
    // Local variables
    struct ThrowableModelMap * point; // r6
...
// Range: 0x80117334 -> 0x80117370
unsigned char zThrowableSystemModelAddedBeforeSort(unsigned int model /* r0 */) {
    // Local variables
    unsigned int i; // r0
...
// Range: 0x80117370 -> 0x801176E4
void zThrowableSystemSweptSpherePrepare(int index /* r0 */, struct xSweptSphere & sws /* r29 */, float dt /* f31 */, struct xVec3 & curPos /* r30 */, int npcThrow /* r27 */, int useOldBound /* r28 */) {
    // Local variables
    ...
    const struct xVec3 & position; // r28
...
// total size: 0x4
struct /* @class$1332zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x4
struct /* @class$1185zThrowableSystem_cpp */ {
    // Members
    float u; // offset 0x0, size 0x4
};
// total size: 0x10
struct /* @class$1186zThrowableSystem_cpp */ {
    // Members
    struct xVec3 pos; // offset 0x0, size 0xC
...
// total size: 0x4
struct /* @class$1187zThrowableSystem_cpp */ {
    // Members
...
// total size: 0x8
struct /* @class$1184zThrowableSystem_cpp */ {
    // Members
    float time; // offset 0x0, size 0x4
...
class zNPCBase {};
// total size: 0x2
struct /* @class$1189zThrowableSystem_cpp */ {
    // Members
...
// Range: 0x801176E4 -> 0x80117B90
void zThrowableSystemUpdate(float dt /* f31 */) {
    // Local variables
    struct xSweptSphere sws; // r1+0x44
    unsigned int i; // r26
    struct RunningThrow & thr; // r25
    struct xVec3 currentPosition; // r1+0x38
...
// Range: 0x80117CC0 -> 0x80117EA8
static unsigned int zThrowableSystemGeneralCollideCB(float & blastRadius /* r25 */, struct xEnt * thrown /* r26 */, struct xEnt * hit /* r30 */, const struct xVec3 * pos /* r27 */, const struct xVec3 * velocity /* r7 */, float damageMultiplier /* f0 */, float radiusMultiplier /* f31 */, void * userData /* r31 */, int defaultDamage /* r9 */) {
    // Local variables
    int damage; // r9
    struct ThrowableTableAssetRow * row; // r0
    struct xVec3 knockback; // r1+0x10
    enum zHitTarget hitTarget; // r28
