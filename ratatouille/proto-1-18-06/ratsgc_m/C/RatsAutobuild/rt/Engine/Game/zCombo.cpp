/*
    ...
    Language: C++
    Code range: 0x8012B3A0 -> 0x8012B40C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct widget_chunk * comboHUD; // size: 0x4, address: 0x803C18C0
enum zComboType {
...
static unsigned char sComboIsPaused; // size: 0x1, address: 0x803C18C4
