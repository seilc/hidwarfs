/*
    ...
    Language: C++
    Code range: 0x8018C14C -> 0x8018C24C
*/
// total size: 0x50
struct {} zUICustomConditionallyDisabled::__vtable; // size: 0x50, address: 0x802DF738
// total size: 0x18
