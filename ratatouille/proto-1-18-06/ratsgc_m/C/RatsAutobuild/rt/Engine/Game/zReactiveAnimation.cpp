/*
    ...
    Language: C++
    Code range: 0x80110654 -> 0x80111C34
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static int total_reactives; // size: 0x4, address: 0x803C1480
// total size: 0x8
struct RwObject {
    // Members
...
// total size: 0x4
struct /* @class$786zReactiveAnimation_cpp */ {
    // Members
...
static struct zReactiveGenre * genres; // size: 0x4, address: 0x803C1484
static int genres_size; // size: 0x4, address: 0x803C1488
// total size: 0x20
struct xLinkAsset {
    // Members
...
union /* @class$805zReactiveAnimation_cpp */ {
...
// total size: 0xC
struct /* @class$804zReactiveAnimation_cpp */ {
    // Members
...
static struct zReactiveAnimationData * activities; // size: 0x4, address: 0x803C148C
static int activities_size; // size: 0x4, address: 0x803C1490
static int activities_used; // size: 0x4, address: 0x803C1494
// total size: 0x60
struct property_set {
    // Members
...
static struct property_set fire_props; // size: 0x60, address: 0x8037EEA8
// Range: 0x80110654 -> 0x8011065C
static unsigned int AlwaysConditional() {}

// Range: 0x8011065C -> 0x801107AC
static struct xAnimState * add_anim_state(struct xAnimTable * table /* r29 */, unsigned int id /* r4 */, const char * name /* r30 */, struct xAnimState * transitionTo /* r31 */, unsigned char loop /* r27 */) {
    // Local variables
    void * anim_data; // r0
...
// Range: 0x8011092C -> 0x8011093C
static unsigned char check_flammable(struct zReactiveGenre & genre /* r0 */) {}
...
// Range: 0x8011093C -> 0x80110A38
static void load_genres() {
    // Local variables
    int tables; // r0
    int i; // r30
    unsigned int asset_size; // r1+0xC
    const struct asset_type * asset; // r0
...
static void setup_entities() {
    ...
    struct zReactiveGenre * genre; // r4
...
// Range: 0x80110E0C -> 0x80110EB0
static void set_static_model(struct zEntSimpleObj & ent /* r31 */, struct zReactiveGenre & genre /* r0 */) {
    // Local variables
    struct zSimpleMgr * temp; // r0
    unsigned int visible; // r5
}

// Range: 0x80110EB0 -> 0x80110F5C
static void set_burnt_model(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
...
// Range: 0x80110F5C -> 0x80110F64
static struct zReactiveGenre * get_genre(struct zEntSimpleObj & ent /* r3 */) {}

// Range: 0x80110F64 -> 0x8011100C
static void deactivate_entity(struct zEntSimpleObj & ent /* r29 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
    struct zReactiveAnimationData & react; // r31
    unsigned char burning; // r30
}

// Range: 0x8011100C -> 0x80111124
static unsigned char update_activity(struct zReactiveAnimationData & react /* r30 */, float dt /* f31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r4
    struct zEntSimpleObj & ent; // r31
    struct xModelInstance * model; // r5
    struct xAnimSingle * single; // r3
    struct xAnimState * state; // r6
    float time; // f0
    float duration; // f1
    float time_left; // f2
}

// Range: 0x80111124 -> 0x80111144
...
// Range: 0x80111144 -> 0x80111230
static void play_anim(struct zEntSimpleObj & ent /* r28 */, struct xAnimState * state /* r29 */, float speed /* f31 */, unsigned char force_restart /* r0 */) {
    // Local variables
    struct xModelInstance * model; // r31
    struct xAnimPlay * play; // r3
    struct xAnimSingle * single; // r30
    struct xAnimTransition * tran; // r3
    float params[4]; // r1+0x8
}

// Range: 0x80111230 -> 0x801112B0
...
// Range: 0x801116FC -> 0x80111850
unsigned char zReactiveMoveThrough(struct zEntSimpleObj & ent /* r29 */, float speed /* f31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r31
...
// Range: 0x80111850 -> 0x801118C0
void zReactiveDamage(struct zEntSimpleObj & ent /* r3 */, enum zHitSource hs /* r0 */, float damage /* f1 */) {}

// Range: 0x801118C0 -> 0x80111924
...
// Range: 0x80111924 -> 0x801119F4
unsigned char zReactiveSelectLOD(struct zEntSimpleObj & ent /* r31 */, float dist2 /* f31 */) {
    // Local variables
    struct zReactiveGenre & genre; // r4
    unsigned char was_active; // r6
    unsigned char active; // r0
}

// Range: 0x801119F4 -> 0x80111A68
...
// Range: 0x80111A68 -> 0x80111A94
unsigned char zReactiveNeedExtraModel(struct zEntSimpleObj & ent /* r0 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
}

// Range: 0x80111A94 -> 0x80111AFC
void zReactivePreBucket(struct zEntSimpleObj & ent /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
}

// Range: 0x80111AFC -> 0x80111BAC
void zReactiveAddExtraSimpleMgr(struct zEntSimpleObj & ent /* r31 */, struct zSimpleMgr * smgr /* r30 */) {
    // Local variables
    struct zReactiveGenre & genre; // r0
    struct zSimpleMgr * smgr_static; // r0
    struct zSimpleMgr * smgr_burnt; // r5
