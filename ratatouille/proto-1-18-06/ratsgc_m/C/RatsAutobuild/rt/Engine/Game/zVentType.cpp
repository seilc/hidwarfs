/*
    ...
    Language: C++
    Code range: 0x8014A860 -> 0x8014A92C
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
// Range: 0x8014A90C -> 0x8014A92C
void zVentType::load(struct xBase & data /* r0 */, struct xDynAsset & asset /* r0 */) {}
