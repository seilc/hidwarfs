/*
    ...
    Language: C++
    Code range: 0x8012E264 -> 0x8012F1E8
*/
int streak_system_id; // size: 0x4, address: 0x803BD4E8
int point_system_id; // size: 0x4, address: 0x803BD4EC
unsigned char need_setup; // size: 0x1, address: 0x803C18E8
// total size: 0x3C
class energy_system {
    // Functions
    void setup(const struct config * new_config, unsigned char additive);
...
// total size: 0x2C
struct /* @class$980zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0x14
struct /* @class$981zFXEnergySystem_cpp */ {
    // Members
...
static struct config default_config; // size: 0x74, address: 0x803865E8
// total size: 0x28
...
// Range: 0x8012E270 -> 0x8012E470
// this: r31
void energy_system::setup(const struct config * new_config /* r0 */, unsigned char additive /* r30 */) {
    // Local variables
...
// total size: 0x4
struct /* @class$941zFXEnergySystem_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$959zFXEnergySystem_cpp */ {
    // Members
...
union /* @class$764zFXEnergySystem_cpp */ {
...
int energy_system::point_update(unsigned char * mem /* r27 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f30 */) {
    ...
    const struct config * use_config; // r28
...
int energy_system::streak_update(unsigned char * mem /* r31 */, int count /* r0 */, struct ptank_pool & pool_ /* r5 */, float dt /* f31 */) {
    ...
    const struct config * use_config; // r25
...
// Range: 0x8012F1A8 -> 0x8012F1B4
// this: r0
void energy_system::end() {}

// Range: 0x8012F1B4 -> 0x8012F1E8
// this: r31
