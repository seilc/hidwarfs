/*
    ...
    Language: C++
    Code range: 0x801B4BD4 -> 0x801B55A8
*/
// total size: 0x10
struct basic_rect {
    // Static members
...
static struct st_XORDEREDARRAY g_modlist; // size: 0x10, address: 0x803C2540
static struct st_XORDEREDARRAY g_modlistUpdateSort; // size: 0x10, address: 0x803C2550
static struct st_XORDEREDARRAY g_modlistRenderSort; // size: 0x10, address: 0x803C2560
// total size: 0x1C
struct zModule {
    // Members
...
// total size: 0x4
struct /* @class$785zModuleMgr_cpp */ {
    // Members
...
// total size: 0xC
struct /* @class$826zModuleMgr_cpp */ {
    // Members
...
// Range: 0x801B5358 -> 0x801B548C
void zModule::Mgr_RenderLayer(enum zLayerType endLayer /* r26 */) {
    // Local variables
    int isPaused; // r0
    int isCinematic; // r30
    int num_mod; // r29
