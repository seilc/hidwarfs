/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iNavPnt.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00381480 -> 0x003814A4
*/
// Range: 0x381480 -> 0x3814A4
signed int iNavPointLineOfSightPoint(class xNavPoint * np /* r2 */, class Vector3D * p /* r2 */, signed int physObj /* r2 */) {
    /* anonymous block */ {
        // Range: 0x381480 -> 0x3814A4
    }
}
