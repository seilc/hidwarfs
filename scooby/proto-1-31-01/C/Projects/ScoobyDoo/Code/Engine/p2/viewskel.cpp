/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\viewskel.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
// total size: 0x64
struct /* @anon0 */ {} ViewSkel::__vtable; // size: 0x64, address: 0x4A2600
class _rpAtomic * WorldPickFunc(class _RpIntersection *, class _RpWorldSector *, class _rpAtomic *, float, void *); // size: 0x0, address: 0x201DC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002001A0 -> 0x00200210
*/
// Range: 0x2001A0 -> 0x200210
// this: r29+0x1C
ViewSkel::ViewSkel(signed int width /* r2 */, signed int height /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2001A0 -> 0x200210
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200210 -> 0x00200294
*/
// Range: 0x200210 -> 0x200294
// this: r17
ViewSkel::~ViewSkel() {
    /* anonymous block */ {
        // Range: 0x200210 -> 0x200294
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002002A0 -> 0x002003C8
*/
// Range: 0x2002A0 -> 0x2003C8
// this: r16
signed int ViewSkel::RwInitialize(void * displayID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2002A0 -> 0x2003C8
        char windowText[128]; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002003D0 -> 0x00200428
*/
// Range: 0x2003D0 -> 0x200428
// this: r16
signed int ViewSkel::RwTerminate() {
    /* anonymous block */ {
        // Range: 0x2003D0 -> 0x200428
        class ViewApp * ptr; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200430 -> 0x002004D8
*/
// Range: 0x200430 -> 0x2004D8
// this: r18
signed int ViewSkel::KeyDown(class _RsKeyStatus * ks /* r17 */) {
    /* anonymous block */ {
        // Range: 0x200430 -> 0x2004D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002004E0 -> 0x00200508
*/
// Range: 0x2004E0 -> 0x200508
signed int KeyUp(class _RsKeyStatus * ks /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2004E0 -> 0x200508
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200510 -> 0x0020053C
*/
// Range: 0x200510 -> 0x20053C
signed int PadButtonRight(class _RwV2d * delta /* r2 */) {
    /* anonymous block */ {
        // Range: 0x200510 -> 0x20053C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200540 -> 0x0020056C
*/
// Range: 0x200540 -> 0x20056C
signed int PadButtonLeft(class _RwV2d * delta /* r2 */) {
    /* anonymous block */ {
        // Range: 0x200540 -> 0x20056C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200570 -> 0x0020057C
*/
// Range: 0x200570 -> 0x20057C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200580 -> 0x002005D4
*/
// Range: 0x200580 -> 0x2005D4
signed int PadButtonDown(class _RsPadButtonStatus * pbs /* r2 */) {
    /* anonymous block */ {
        // Range: 0x200580 -> 0x2005D4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002005E0 -> 0x00200630
*/
// Range: 0x2005E0 -> 0x200630
// this: r2
signed int ViewSkel::CameraSize(class _RwRect * rect /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2005E0 -> 0x200630
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00200630 -> 0x00200FFC
*/
// Range: 0x200630 -> 0x200FFC
// this: r18
signed int ViewSkel::MouseMove(class _RsMouseStatus * ms /* r17 */) {
    /* anonymous block */ {
        // Range: 0x200630 -> 0x200FFC
        class _RwV3d offset; // r29+0xB0
        class _RwV3d zoom; // r29+0xA0
        class _RwV2d * offset; // r16
        class _RwMatrix * worldToLocal; // r19
        class _RwMatrix * tmpMatrix; // r16
        class _RwFrame * parent; // r16
        class _RwFrame * cameraFrame; // r16
        class _RwV2d delta; // r29+0x98
        class _RwV3d right; // r29+0x88
        class _RwV3d at; // r29+0x78
        class _RwV3d up; // r29+0x68
        class _RwV3d v; // r29+0x58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201000 -> 0x00201024
*/
// Range: 0x201000 -> 0x201024
// this: r2
signed int ViewSkel::RightButtonUp() {
    /* anonymous block */ {
        // Range: 0x201000 -> 0x201024
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201030 -> 0x00201088
*/
// Range: 0x201030 -> 0x201088
// this: r2
signed int ViewSkel::RightButtonDown(class _RsMouseStatus * ms /* r2 */) {
    /* anonymous block */ {
        // Range: 0x201030 -> 0x201088
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201090 -> 0x002010B4
*/
// Range: 0x201090 -> 0x2010B4
// this: r2
signed int ViewSkel::LeftButtonUp() {
    /* anonymous block */ {
        // Range: 0x201090 -> 0x2010B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002010C0 -> 0x00201300
*/
// Range: 0x2010C0 -> 0x201300
// this: r17
signed int ViewSkel::LeftButtonDown(class _RsMouseStatus * ms /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2010C0 -> 0x201300
        float distance; // r29+0x4C
        class _RpIntersection is; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201300 -> 0x00201388
*/
// Range: 0x201300 -> 0x201388
// this: r18
signed int ViewSkel::FileLoad(char * pathname /* r2 */) {
    /* anonymous block */ {
        // Range: 0x201300 -> 0x201388
        signed int retVal; // r17
        char * psFilename; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201390 -> 0x00201438
*/
// Range: 0x201390 -> 0x201438
// this: r16
signed int ViewSkel::Update(float timeDelta /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x201390 -> 0x201438
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00201440 -> 0x002014FC
*/
// Range: 0x201440 -> 0x2014FC
