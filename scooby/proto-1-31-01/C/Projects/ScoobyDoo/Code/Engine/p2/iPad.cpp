/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iPad.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static __int128 sPadDMA[2][16]; // size: 0x200, address: 0xAAE580
static unsigned char sPadData[2][32]; // size: 0x40, address: 0xAAE780
unsigned int gLastInputTime; // size: 0x4, address: 0x4A4F0C
signed int sNumPads; // size: 0x4, address: 0x4A4F10
unsigned int gSoftReset; // size: 0x4, address: 0x4A4F14
static signed int accTable[15]; // size: 0x3C, address: 0x44FD50
static unsigned short sPadMapping_Debug[16]; // size: 0x20, address: 0x0
static unsigned short sPadMapping_Game[16]; // size: 0x20, address: 0x44FDA0
...
class __xScrFxMgr gScrFx; // size: 0xC, address: 0x4B5368
...
signed int checkRumbleAbility(signed int); // size: 0x0, address: 0x380C50
void p2PadSetVibration(class tagxPad *, unsigned int, unsigned int); // size: 0x0, address: 0x380D70
class tagPadMgrData console; // size: 0x278, address: 0x4DF540
// total size: 0xC
...
class __xScrFxMgr {
    // Members
public:
    unsigned short m_letterbox; // offset 0x0, size 0x2
    unsigned char m_startFadeOut; // offset 0x2, size 0x1
    unsigned char m_doneFadeOut; // offset 0x3, size 0x1
    unsigned char m_startFadeIn; // offset 0x4, size 0x1
    unsigned char m_doneFadeIn; // offset 0x5, size 0x1
    unsigned short m_fadeOutCounter; // offset 0x6, size 0x2
    unsigned short m_fadeInCounter; // offset 0x8, size 0x2
    signed short shake; // offset 0xA, size 0x2
};
// total size: 0x1C
class p2Camera {
    // Members
...
class tagPadMgrData {
    // Members
public:
    unsigned short m_initialized; // offset 0x0, size 0x2
    unsigned short m_numControllers; // offset 0x2, size 0x2
    class tagxPad m_pad[2]; // offset 0x8, size 0x270
};
// total size: 0x34
class _RwRaster {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0037FB60 -> 0x0037FBA4
*/
// Range: 0x37FB60 -> 0x37FBA4
void iPadInitFunc_Game(class tagxPad * p /* r2 */) {
    /* anonymous block */ {
        // Range: 0x37FB60 -> 0x37FBA4
        signed int i; // r6
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0037FBB0 -> 0x00380A14
*/
// Range: 0x37FBB0 -> 0x380A14
signed int iConsoleMgrRead(class tagxPad * pad /* r21 */, signed int numPads /* r20 */, unsigned long theTime /* r29+0xD0 */) {
    /* anonymous block */ {
        // Range: 0x37FBB0 -> 0x380A14
        class _XBUTTON * b; // r6
        class _XBUTTON * b; // r2
        class _tagNativePadData * dp; // r5
        class tagxPad * pp; // r4
        class _tagNativePadData * dp; // r18
        class tagxPad * pp; // r2
        signed int startErrorTime; // r2
        signed int allowMessages; // r29+0xDC
        unsigned int db; // r2
        class xFontBox_t * box; // r19
        class _tagNativePadData * dp; // r18
        class tagxPad * pp; // r2
        signed int last_ry; // r22
        signed int last_rx; // r23
        signed int last_ly; // r30
        signed int last_lx; // r29+0xC0
        signed int controllerCount; // r17
        signed int j; // r3
        signed int i; // r16
        unsigned int buttons_held; // r2
        signed int firstRead; // @ 0x004A4F20
        signed int readIndexMap[2]; // @ 0x0044FD90
        signed int killRumble; // @ 0x004A4F18
        signed char init; // @ 0x004A4F24
        signed char init; // @ 0x004A4F1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380A20 -> 0x00380A28
*/
// Range: 0x380A20 -> 0x380A28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380A30 -> 0x00380C00
*/
// Range: 0x380A30 -> 0x380C00
signed short iConsoleMgrInit(signed int maxControllers /* r2 */, class tagxPad * pad /* r18 */) {
    /* anonymous block */ {
        // Range: 0x380A30 -> 0x380C00
        class tagxPad * p; // r17
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380C00 -> 0x00380C50
*/
// Range: 0x380C00 -> 0x380C50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380C50 -> 0x00380D68
*/
// Range: 0x380C50 -> 0x380D68
signed int checkRumbleAbility(signed int port /* r16 */) {
    /* anonymous block */ {
        // Range: 0x380C50 -> 0x380D68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380D70 -> 0x00380E90
*/
// Range: 0x380D70 -> 0x380E90
void p2PadSetVibration(class tagxPad * pad /* r20 */, unsigned int act0 /* r19 */, unsigned int act1 /* r18 */) {
    /* anonymous block */ {
        // Range: 0x380D70 -> 0x380E90
        signed int slot; // r16
        signed int port; // r2
