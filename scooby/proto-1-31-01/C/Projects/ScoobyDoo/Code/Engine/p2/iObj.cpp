/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float gObjShadowHeight; // size: 0x4, address: 0x4A4F28
signed int gObjHackRenderTranslucent; // size: 0x4, address: 0x4A4F2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00380E90 -> 0x00381430
*/
// Range: 0x380E90 -> 0x381430
void iObjDraw(class _xObj * obj /* r17 */) {
    /* anonymous block */ {
        // Range: 0x380E90 -> 0x381430
        class tagxPhysicsObject * p; // r16
        float * fp; // r2
        float m[16]; // r29+0x60
        class iObjRuntime * r; // r18
        class Vector3D pos; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00381430 -> 0x00381474
*/
// Range: 0x381430 -> 0x381474
void iObjInitialize(class _xObj * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x381430 -> 0x381474
