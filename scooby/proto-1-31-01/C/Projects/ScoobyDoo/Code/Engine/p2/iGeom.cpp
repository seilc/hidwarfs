/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iGeom.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static char dbfont_chars[51]; // size: 0x33, address: 0x0
signed int ignorePass; // size: 0x4, address: 0x0
float pass0ShadowCol; // size: 0x4, address: 0x0
float pass0AlphaCol; // size: 0x4, address: 0x0
float pass1ShadowCol; // size: 0x4, address: 0x0
float pass1AlphaCol; // size: 0x4, address: 0x0
signed int realshadow; // size: 0x4, address: 0x4A4F44
class Vector3D sunlight; // size: 0xC, address: 0x44FE20
static signed int debugAmbient; // size: 0x4, address: 0x0
static class Vector3D debuglight; // size: 0xC, address: 0x0
static class Vector3D debuglightoffset; // size: 0xC, address: 0x0
static class Vector3D debuglightcolor; // size: 0xC, address: 0x0
static signed int shadeGeom; // size: 0x4, address: 0x0
static class Vector3D wlight; // size: 0xC, address: 0x0
static float lightShadeFactor[20]; // size: 0x50, address: 0x0
static class Vector4D light[20]; // size: 0x140, address: 0xAAEA40
static float lightDelta[20]; // size: 0x50, address: 0x0
static class Vector3D lightColor[20]; // size: 0xF0, address: 0x0
static signed int lightCount; // size: 0x4, address: 0x4A4F48
static class Vector3D ambient; // size: 0xC, address: 0x0
unsigned char show_skeleton; // size: 0x1, address: 0x0
unsigned char show_rots; // size: 0x1, address: 0x0
signed int razNormalXform; // size: 0x4, address: 0x0
signed int razNormalize; // size: 0x4, address: 0x0
signed int razNormalHome; // size: 0x4, address: 0x0
unsigned int see_mesh; // size: 0x4, address: 0x0
unsigned int see_face; // size: 0x4, address: 0x0
float zclip; // size: 0x4, address: 0x0
...
class iCamera icamera; // size: 0x8C, address: 0xAFF3D0
...
class iCamera {
    // Members
public:
    signed int roll; // offset 0x0, size 0x4
    class Vector3D look_at; // offset 0x4, size 0xC
    class Vector3D look_from; // offset 0x10, size 0xC
    class Vector3D pos; // offset 0x1C, size 0xC
    class Vector3D view; // offset 0x28, size 0xC
    class Vector3D up; // offset 0x34, size 0xC
    class Vector3D target_pos; // offset 0x40, size 0xC
    float m[16]; // offset 0x4C, size 0x40
};
// total size: 0x5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003865A0 -> 0x003869E8
*/
// Range: 0x3865A0 -> 0x3869E8
void iGeomGetJointWorldPos(class xSkel * skel /* r18 */, signed int jointIndex /* r17 */, class Vector3D * p /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3865A0 -> 0x3869E8
        class tagiJointRuntime * joint; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003869F0 -> 0x003869F8
*/
// Range: 0x3869F0 -> 0x3869F8
void iEffectReflect() {
    /* anonymous block */ {
        // Range: 0x3869F0 -> 0x3869F8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386A00 -> 0x00386A34
*/
// Range: 0x386A00 -> 0x386A34
void iEffectSetFlag(class _iRenderEffects * effects /* r2 */, signed int flag /* r2 */, signed int onoff /* r2 */) {
    /* anonymous block */ {
        // Range: 0x386A00 -> 0x386A34
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386A40 -> 0x00386B14
*/
// Range: 0x386A40 -> 0x386B14
signed int iEffectDone(class _iRenderEffects * effects /* r16 */) {
    /* anonymous block */ {
        // Range: 0x386A40 -> 0x386B14
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386B20 -> 0x00386C10
*/
// Range: 0x386B20 -> 0x386C10
void iEffectFadeStart(class _iRenderEffects * effects /* r18 */, signed int flag /* r17 */, signed int time /* r16 */) {
    /* anonymous block */ {
        // Range: 0x386B20 -> 0x386C10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386C10 -> 0x00386F4C
*/
// Range: 0x386C10 -> 0x386F4C
void iEffectFadeInfo(class _iRenderEffects * fx /* r21 */, signed int r /* r20 */, signed int g /* r19 */, signed int b /* r18 */, signed int mode /* r17 */, signed int idx /* r16 */) {
    /* anonymous block */ {
        // Range: 0x386C10 -> 0x386F4C
        unsigned char * color; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386F50 -> 0x00386FCC
*/
// Range: 0x386F50 -> 0x386FCC
void iGeomInitRenderEffects(class _p2Geom * geom /* r2 */) {
    /* anonymous block */ {
        // Range: 0x386F50 -> 0x386FCC
        class _iRenderEffects * fx; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386FD0 -> 0x00386FD8
*/
// Range: 0x386FD0 -> 0x386FD8
void iMeshDraw() {
    /* anonymous block */ {
        // Range: 0x386FD0 -> 0x386FD8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386FE0 -> 0x00386FE8
*/
// Range: 0x386FE0 -> 0x386FE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00386FF0 -> 0x00386FF8
*/
// Range: 0x386FF0 -> 0x386FF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387000 -> 0x00387008
*/
// Range: 0x387000 -> 0x387008
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387010 -> 0x00387460
*/
// Range: 0x387010 -> 0x387460
void iGeomSetUVUsingMeshPart(unsigned int destModelID /* r17 */, signed int destPartID /* r19 */, unsigned int modelID /* r2 */, signed int partID /* r18 */) {
    /* anonymous block */ {
        // Range: 0x387010 -> 0x387460
        signed int i; // r5
        class tagP2Mesh * dest; // r17
        class tagP2Mesh * source; // r16
        signed int destCount; // r29+0x7C
        signed int sourceCount; // r29+0x78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387460 -> 0x00387854
*/
// Range: 0x387460 -> 0x387854
void iGeomCalcBoundingBox(unsigned int modelID /* r2 */, signed int partID /* r20 */, class Vector3D * a /* r19 */, class Vector3D * b /* r18 */) {
    /* anonymous block */ {
        // Range: 0x387460 -> 0x387854
        signed int partCount; // r29+0xAC
        class tagP2VERTEX * v; // r5
        class tagP2Mesh * mesh; // r17
        signed int j; // r4
        signed int start; // r2
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387860 -> 0x00387B14
*/
// Range: 0x387860 -> 0x387B14
void iGeomSetMeshVisibility(void * data /* r2 */, signed int number /* r20 */, signed int visible /* r19 */) {
    /* anonymous block */ {
        // Range: 0x387860 -> 0x387B14
        signed int i; // r18
        class tagP2Mesh * mesh; // r17
        class _p2Geom * geom; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387B20 -> 0x00387B28
*/
// Range: 0x387B20 -> 0x387B28
void p2GeomDraw() {
    /* anonymous block */ {
        // Range: 0x387B20 -> 0x387B28
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387B30 -> 0x00387F38
*/
// Range: 0x387B30 -> 0x387F38
void p2GeomDrawShadow(class _p2Geom * geom /* r2 */, class _xActor * actor /* r17 */, class _xObj * obj /* r16 */) {
    /* anonymous block */ {
        // Range: 0x387B30 -> 0x387F38
        class tagxPhysicsObject * p; // r16
        class Vector3D a; // r29+0x1E0
        class tagMATRIX sm; // r29+0x160
        class Vector3D gp2; // r29+0x1D0
        class Vector3D gp1; // r29+0x1C0
        class Vector3D gp0; // r29+0x1B0
        float gplane[4]; // r29+0x150
        float alphaCol; // r29+0x1F0
        float shadowcol; // r29+0x1F0
        float objmatrix[16]; // r29+0x110
        float world[16]; // r29+0xD0
        float result[16]; // r29+0x90
        float m[16]; // r29+0x50
        class Vector3D origin; // r29+0x1A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00387F40 -> 0x00387F70
*/
// Range: 0x387F40 -> 0x387F70
void iGeomAssign(class _xActor * actor /* r2 */, class _xModel * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x387F40 -> 0x387F70
        class _p2Geom * geom; // r2
        class iActorRuntime * r; // r6
    }
}
