/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iActor.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static char dbfont_chars[51]; // size: 0x33, address: 0x0
signed int g_textureCount; // size: 0x4, address: 0x0
unsigned short g_tpageInfo[20]; // size: 0x28, address: 0x0
float gActorShadowHeight; // size: 0x4, address: 0x4A4F7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0038DF00 -> 0x0038E078
*/
// Range: 0x38DF00 -> 0x38E078
void iActorDraw(class _xActor * act /* r17 */) {
    /* anonymous block */ {
        // Range: 0x38DF00 -> 0x38E078
        class Vector3D pos; // r29+0x80
        float m[16]; // r29+0x40
        class _p2Geom * geom; // r2
        float * fp; // r2
        class tagxPhysicsObject * p; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0038E080 -> 0x0038E218
*/
// Range: 0x38E080 -> 0x38E218
void iActorGeometryControl(class _xActor * a /* r18 */, signed int partNumber /* r17 */, signed int flag /* r16 */) {
    /* anonymous block */ {
        // Range: 0x38E080 -> 0x38E218
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0038E220 -> 0x0038E338
*/
// Range: 0x38E220 -> 0x38E338
void iActorInitialize(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x38E220 -> 0x38E338
        signed int i; // r3
        class iActorRuntime * r; // r16
