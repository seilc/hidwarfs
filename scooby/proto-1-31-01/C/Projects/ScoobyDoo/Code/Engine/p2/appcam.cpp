/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\appcam.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002020A0 -> 0x002020E4
*/
// Range: 0x2020A0 -> 0x2020E4
// this: r16
AppCamera::AppCamera(signed int width /* r2 */, signed int height /* r2 */, signed int zBuffer /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2020A0 -> 0x2020E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002020F0 -> 0x00202174
*/
// Range: 0x2020F0 -> 0x202174
// this: r17
AppCamera::~AppCamera() {
    /* anonymous block */ {
        // Range: 0x2020F0 -> 0x202174
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202180 -> 0x002021F8
*/
// Range: 0x202180 -> 0x2021F8
// this: r2
void AppCamera::CameraReset(class _RwV3d * origin /* r2 */) {
    /* anonymous block */ {
        // Range: 0x202180 -> 0x2021F8
        class _RwV3d v; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00202200 -> 0x002023D8
*/
// Range: 0x202200 -> 0x2023D8
// this: r16
