/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iModel.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003814B0 -> 0x00381630
*/
// Range: 0x3814B0 -> 0x381630
void iModelAssign(class _xActor * actor /* r17 */, class _xModel * model /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3814B0 -> 0x381630
    }
}
