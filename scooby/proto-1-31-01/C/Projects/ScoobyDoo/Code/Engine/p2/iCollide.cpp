/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iCollide.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int mCollideResult; // size: 0x4, address: 0x4A5068
...
class _RpCollisionTriangle * iSphereCastCallback(class _RpIntersection *, class _RpWorldSector *, class _RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x0
class _RpCollisionTriangle * iRayCastCallback(class _RpIntersection *, class _RpWorldSector *, class _RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x400660
// total size: 0x1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004005B0 -> 0x00400660
*/
// Range: 0x4005B0 -> 0x400660
signed int iRayCastfrompoint(class tagCollideInfo * info /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4005B0 -> 0x400660
        class _RwLine * ray; // r2
        class _RpIntersection intersection; // r29+0x10
        class _RpWorld * World; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00400660 -> 0x00400700
*/
// Range: 0x400660 -> 0x400700
static class _RpCollisionTriangle * iRayCastCallback(class _RpCollisionTriangle * triangle /* r2 */, float distance /* r29 */, void * info_data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x400660 -> 0x400700
        class tagCollideInfo * info; // r2
    }
}
