/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iAnim.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int animID; // size: 0x4, address: 0x4A4F74
unsigned int animFrame; // size: 0x4, address: 0x4A4F78
// total size: 0xC
class Vector3D {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0038DBB0 -> 0x0038DCA4
*/
// Range: 0x38DBB0 -> 0x38DCA4
void iAnimGetFrame(class tagXAnim * anim /* r2 */, signed int joint /* r2 */, signed int frame /* r2 */, class Vector3D * trans /* r2 */, class Vector3D * rot /* r2 */) {
    /* anonymous block */ {
        // Range: 0x38DBB0 -> 0x38DCA4
        class tagiAnimFrame * aj; // r9
        class tagiAnimResource * ar; // r9
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0038DCB0 -> 0x0038DEFC
*/
// Range: 0x38DCB0 -> 0x38DEFC
signed int iAnimSetCharJoints(class tagXAnimControl * act /* r2 */) {
    /* anonymous block */ {
        // Range: 0x38DCB0 -> 0x38DEFC
        signed int frame; // r2
        signed int frame; // r2
        signed int activeJoint; // r7
        signed int i; // r5
        class tagiSkelRuntime * skel; // r3
        class tagiAnimResource * data; // r2
        class _xActor * actor; // r3
    }
}
