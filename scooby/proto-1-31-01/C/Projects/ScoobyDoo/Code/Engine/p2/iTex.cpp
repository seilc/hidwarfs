/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\p2\iTex.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B280 -> 0x0036B404
*/
// Range: 0x36B280 -> 0x36B404
void iTexAssignObj(class _xObj * obj /* r18 */, class _xTex * tex /* r17 */) {
    /* anonymous block */ {
        // Range: 0x36B280 -> 0x36B404
        class _iTexRuntime * tr; // r16
        class iObjRuntime * ob; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B410 -> 0x0036B594
*/
// Range: 0x36B410 -> 0x36B594
void iTexAssign(class _xActor * actor /* r18 */, class _xTex * tex /* r17 */) {
    /* anonymous block */ {
        // Range: 0x36B410 -> 0x36B594
        class _iTexRuntime * tr; // r16
        class iActorRuntime * ar; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B5A0 -> 0x0036B768
*/
// Range: 0x36B5A0 -> 0x36B768
void iTexUnloadAll() {
    /* anonymous block */ {
        // Range: 0x36B5A0 -> 0x36B768
        signed int t; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B770 -> 0x0036B778
*/
// Range: 0x36B770 -> 0x36B778
void iTexLoad() {
    /* anonymous block */ {
        // Range: 0x36B770 -> 0x36B778
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B780 -> 0x0036B980
*/
// Range: 0x36B780 -> 0x36B980
void iTexLevelReset() {
    /* anonymous block */ {
        // Range: 0x36B780 -> 0x36B980
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036B980 -> 0x0036BAD0
*/
// Range: 0x36B980 -> 0x36BAD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036BAD0 -> 0x0036BB34
*/
// Range: 0x36BAD0 -> 0x36BB34
void iTexInit() {
    /* anonymous block */ {
        // Range: 0x36BAD0 -> 0x36BB34
        signed int max; // r2
