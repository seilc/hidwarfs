/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xGameObjMgr.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xGameObjMgr * gGameObjMgr; // size: 0x4, address: 0x4A5070
// total size: 0x28
struct /* @anon0 */ {} xGameObjMgr::__vtable; // size: 0x28, address: 0x4A28A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404390 -> 0x00404484
*/
// Range: 0x404390 -> 0x404484
// this: r17
void xGameObjMgr::gameObjAdd(class xGameObj * obj /* r16 */) {
    /* anonymous block */ {
        // Range: 0x404390 -> 0x404484
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404490 -> 0x004044B4
*/
// Range: 0x404490 -> 0x4044B4
class xGameObj * gameObjCreate(unsigned int type /* r2 */) {
    /* anonymous block */ {
        // Range: 0x404490 -> 0x4044B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004044C0 -> 0x00404514
*/
// Range: 0x4044C0 -> 0x404514
// this: r2
void xGameObjMgr::render() {
    /* anonymous block */ {
        // Range: 0x4044C0 -> 0x404514
        class xGameObj * o; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404520 -> 0x00404574
*/
// Range: 0x404520 -> 0x404574
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404580 -> 0x004045D4
*/
// Range: 0x404580 -> 0x4045D4
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004045E0 -> 0x00404634
*/
// Range: 0x4045E0 -> 0x404634
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404640 -> 0x0040464C
*/
// Range: 0x404640 -> 0x40464C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404650 -> 0x0040467C
*/
// Range: 0x404650 -> 0x40467C
// this: r2
xGameObjMgr::xGameObjMgr() {
    /* anonymous block */ {
        // Range: 0x404650 -> 0x40467C
    }
}
