/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xCond.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00360CD0 -> 0x00361214
*/
// Range: 0x360CD0 -> 0x361214
void xConditionGameEventBase(class xCondition * c /* r19 */, unsigned int eventType /* r18 */, unsigned int eventCmd /* r17 */, unsigned int eventData /* r16 */) {
    /* anonymous block */ {
        // Range: 0x360CD0 -> 0x361214
        class iConditionResource * r; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361220 -> 0x0036174C
*/
// Range: 0x361220 -> 0x36174C
void xConditionGameEvent(class xCondition * c /* r21 */, unsigned int eventWho /* r20 */, unsigned int eventType /* r19 */, unsigned int eventCmd /* r18 */, unsigned int eventData /* r17 */) {
    /* anonymous block */ {
        // Range: 0x361220 -> 0x36174C
        class iConditionResource * r; // r16
        signed int dataMatch; // r2
        signed int cmdMatch; // r23
        signed int typeMatch; // r30
        signed int whoMatch; // r22
        signed int osMatch; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361750 -> 0x003619BC
*/
// Range: 0x361750 -> 0x3619BC
signed int xConditionEvaluate(class xCondition * c /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361750 -> 0x3619BC
        class xCondition * idx; // r16
        signed int isTrue; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003619C0 -> 0x00361A94
*/
// Range: 0x3619C0 -> 0x361A94
void xConditionInitRuntime(class iConditionRuntime * c /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3619C0 -> 0x361A94
    }
}
