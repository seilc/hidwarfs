/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xRoute.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F050 -> 0x0033F17C
*/
// Range: 0x33F050 -> 0x33F17C
void xRouteClearPath(class xRoute * r /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F050 -> 0x33F17C
        class xListItem * i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F180 -> 0x0033F29C
*/
// Range: 0x33F180 -> 0x33F29C
void xRouteOccupyPath(class xRoute * r /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F180 -> 0x33F29C
        class xListItem * i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F2A0 -> 0x0033F498
*/
// Range: 0x33F2A0 -> 0x33F498
void xRouteBuildSearchRoute(class xRoute * r /* r17 */, class xSearchPoint * p /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F2A0 -> 0x33F498
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F4A0 -> 0x0033F54C
*/
// Range: 0x33F4A0 -> 0x33F54C
void xRouteBuildSearchRouteAB(class xRoute * r /* r18 */, class xSearch * s /* r2 */, class Vector3D * a /* r17 */, class Vector3D * b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F4A0 -> 0x33F54C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F550 -> 0x0033F768
*/
// Range: 0x33F550 -> 0x33F768
void xRouteDestroyRoute(class xRoute * r /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F550 -> 0x33F768
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F770 -> 0x0033F958
*/
// Range: 0x33F770 -> 0x33F958
void xRouteDraw(class xRoute * r /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F770 -> 0x33F958
        class xNavPoint * b; // r2
        class xNavPoint * a; // r3
        class Vector3D posb; // r29+0x60
        class Vector3D posa; // r29+0x50
        class xListItem * i; // r17
        float shift; // r20
        class Vector3D lastPoint; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F960 -> 0x0033F9D4
*/
// Range: 0x33F960 -> 0x33F9D4
class xNavPoint * xRouteGetNextNavPoint(class xRoute * r /* r2 */, class xNavPoint * p /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33F960 -> 0x33F9D4
        class xListItem * i; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033F9E0 -> 0x0033FAB4
*/
// Range: 0x33F9E0 -> 0x33FAB4
void xRouteSetState(class xRoute * r /* r17 */, signed int newState /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33F9E0 -> 0x33FAB4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033FAC0 -> 0x0033FAF8
*/
// Range: 0x33FAC0 -> 0x33FAF8
void xRouteInit(class xRoute * r /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33FAC0 -> 0x33FAF8
    }
}
