/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xRouteDB.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xRouteDB g_routeDB; // size: 0x44, address: 0x4B5390
static class xRouteDB * db; // size: 0x4, address: 0x4A3EB8
class xRoute gRouteArray[16]; // size: 0x640, address: 0x4B53E0
...
class xRouteDB {
    // Members
public:
    class xRoute * m_route[16]; // offset 0x0, size 0x40
    class xScene * m_scene; // offset 0x40, size 0x4
};
// total size: 0x18
class _RxHeap {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A5D0 -> 0x0033A830
*/
// Range: 0x33A5D0 -> 0x33A830
void xRouteDBSetRouteUseage(signed int id /* r16 */, signed int useageType /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33A5D0 -> 0x33A830
        class xRoute * r; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033A830 -> 0x0033AA78
*/
// Range: 0x33A830 -> 0x33AA78
signed int xRouteDBRouteStatus(signed int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33A830 -> 0x33AA78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AA80 -> 0x0033AAD0
*/
// Range: 0x33AA80 -> 0x33AAD0
void xRouteDBRouteDraw(signed int routeID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33AA80 -> 0x33AAD0
        class xRoute * r; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AAD0 -> 0x0033AC7C
*/
// Range: 0x33AAD0 -> 0x33AC7C
signed int xRouteDBRouteCreate() {
    /* anonymous block */ {
        // Range: 0x33AAD0 -> 0x33AC7C
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AC80 -> 0x0033AD68
*/
// Range: 0x33AC80 -> 0x33AD68
void xRouteDBRouteDestroy(signed int routeID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33AC80 -> 0x33AD68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033AD70 -> 0x0033B1E8
*/
// Range: 0x33AD70 -> 0x33B1E8
signed int xRouteDBRouteRebuild(class xRoute * r /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33AD70 -> 0x33B1E8
        class xListItem * anchor; // r17
        class xListItem * idx; // r2
        signed int routeID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B1F0 -> 0x0033B4CC
*/
// Range: 0x33B1F0 -> 0x33B4CC
signed int xRouteDBRouteBuild(class Vector3D * pa /* r20 */, class Vector3D * pb /* r19 */, signed int physType /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33B1F0 -> 0x33B4CC
        class xRoute * r; // r17
        signed int routeID; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B4D0 -> 0x0033B950
*/
// Range: 0x33B4D0 -> 0x33B950
signed int xRouteDBRouteToNavigationPoint(signed int objectType /* r19 */, signed int actorID /* r17 */, signed int index /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33B4D0 -> 0x33B950
        class xRoute * r; // r2
        class Vector3D posa; // r29+0x70
        class _xActor * actor; // r17
        signed int routeID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033B950 -> 0x0033BE14
*/
// Range: 0x33B950 -> 0x33BE14
signed int xRouteDBRouteMarkerToMarker(signed int ma /* r17 */, signed int mb /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33B950 -> 0x33BE14
        class xRoute * r; // r2
        class xMarker * marker2; // r17
        class xMarker * marker1; // r4
        signed int routeID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033BE20 -> 0x0033C304
*/
// Range: 0x33BE20 -> 0x33C304
signed int xRouteDBRouteNavToNav(signed int na /* r16 */, signed int nb /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33BE20 -> 0x33C304
        class xRoute * r; // r2
        signed int routeID; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033C310 -> 0x0033C818
*/
// Range: 0x33C310 -> 0x33C818
signed int xRouteDBRouteToMemoryPosition(signed int objectType /* r19 */, signed int actorID /* r17 */, signed int index /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33C310 -> 0x33C818
        class xRoute * r; // r2
        class Vector3D posa; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033C820 -> 0x0033CD7C
*/
// Range: 0x33C820 -> 0x33CD7C
signed int xRouteDBRouteToRTObj(signed int actorType /* r19 */, signed int actorID /* r16 */, signed int objIndex /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33C820 -> 0x33CD7C
        class xRoute * r; // r2
        class Vector3D posa; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033CD80 -> 0x0033D3B4
*/
// Range: 0x33CD80 -> 0x33D3B4
signed int xRouteDBRouteToMarker(signed int objectType /* r20 */, signed int actorID /* r19 */, signed int index /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33CD80 -> 0x33D3B4
        class xRoute * r; // r2
        class Vector3D posa; // r29+0x80
        class xMarker * marker; // r17
        signed int routeID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D3C0 -> 0x0033D790
*/
// Range: 0x33D3C0 -> 0x33D790
signed int xRouteDBRouteToActor(signed int fromObjectType /* r2 */, signed int fromActorID /* r2 */, signed int toObjectType /* r20 */, signed int toActorID /* r19 */) {
    /* anonymous block */ {
        // Range: 0x33D3C0 -> 0x33D790
        class xRoute * r; // r2
        class _xActor * to_actor; // r18
        class _xActor * from_actor; // r17
        signed int routeID; // r16
        class Vector3D posa; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D790 -> 0x0033D89C
*/
// Range: 0x33D790 -> 0x33D89C
signed int xRouteDBRouteToPlayer(signed int objectID /* r18 */, signed int actorID /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33D790 -> 0x33D89C
        signed int routeID; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033D8A0 -> 0x0033DC18
*/
// Range: 0x33D8A0 -> 0x33DC18
void xRouteDBRouteAppend(signed int routeID /* r2 */, signed int routeAppendID /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33D8A0 -> 0x33DC18
        class xRoute * rb; // r17
        class xRoute * ra; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033DC20 -> 0x0033EB18
*/
// Range: 0x33DC20 -> 0x33EB18
void xRouteDBIdle() {
    /* anonymous block */ {
        // Range: 0x33DC20 -> 0x33EB18
        class xSearch * s; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033EB20 -> 0x0033ED7C
*/
// Range: 0x33EB20 -> 0x33ED7C
void xRouteDBSetScene(class xScene * scene /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33EB20 -> 0x33ED7C
        class xRoute * r; // r17
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033ED80 -> 0x0033EFA8
*/
// Range: 0x33ED80 -> 0x33EFA8
class xRoute * xRouteDBGetRoutePtr(signed int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33ED80 -> 0x33EFA8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0033EFB0 -> 0x0033F050
*/
// Range: 0x33EFB0 -> 0x33F050
void xRouteDBInit() {
    /* anonymous block */ {
        // Range: 0x33EFB0 -> 0x33F050
        signed int i; // r16
