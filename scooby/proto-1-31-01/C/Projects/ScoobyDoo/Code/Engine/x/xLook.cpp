/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xLook.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class xLookMgr gLookMgr; // size: 0x128, address: 0xB01420
...
class xLookMgr {
    // Members
public:
    unsigned char m_hasInterest; // offset 0x0, size 0x1
    unsigned char m_lastSlot; // offset 0x1, size 0x1
    unsigned short m_pad; // offset 0x2, size 0x2
    class Vector3D m_lastPoint; // offset 0x4, size 0xC
    class tagxPhysicsObject * m_lookFrom; // offset 0x10, size 0x4
    class Vector3D m_lookFromP; // offset 0x14, size 0xC
    float m_lastLookDelta; // offset 0x20, size 0x4
    float m_lastLookDeltaY; // offset 0x24, size 0x4
    class xLook m_look[16]; // offset 0x28, size 0x100
};
// total size: 0x8
class _RpPolygon {
    // Members
...
class xLook {
    // Members
public:
    unsigned short m_decay; // offset 0x0, size 0x2
    unsigned short m_decayCount; // offset 0x2, size 0x2
    unsigned char m_priority; // offset 0x4, size 0x1
    unsigned char m_flag; // offset 0x5, size 0x1
    unsigned short m_wait; // offset 0x6, size 0x2
    float m_distance; // offset 0x8, size 0x4
    class tagxLookTarget m_t; // offset 0xC, size 0x4
};
// total size: 0x30
...
// total size: 0x4
class tagxLookTarget {
    // Members
public:
    union { // inferred
        class _xActor * m_actor; // offset 0x0, size 0x4
        class _xObj * m_obj; // offset 0x0, size 0x4
        class xMarker * m_marker; // offset 0x0, size 0x4
        class Vector3D * m_vectorp; // offset 0x0, size 0x4
    };
};
// total size: 0xC
class tagxPadAction {
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00396C70 -> 0x00396EDC
*/
// Range: 0x396C70 -> 0x396EDC
void xLookActor(class _xActor * a /* r19 */) {
    /* anonymous block */ {
        // Range: 0x396C70 -> 0x396EDC
        float distance; // r20
        unsigned short duration; // r17
        unsigned char priority; // r16
        class xLook * look; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00396EE0 -> 0x003970BC
*/
// Range: 0x396EE0 -> 0x3970BC
void xLookActorRemove(class _xActor * a /* r17 */) {
    /* anonymous block */ {
        // Range: 0x396EE0 -> 0x3970BC
        class xLook * look; // r16
        signed int i; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003970C0 -> 0x003973D4
*/
// Range: 0x3970C0 -> 0x3973D4
void xLookObj(class _xObj * o /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3970C0 -> 0x3973D4
        float distance; // r20
        unsigned short duration; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003973E0 -> 0x00397508
*/
// Range: 0x3973E0 -> 0x397508
void xLookObjRemove(class _xObj * o /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3973E0 -> 0x397508
        class xLook * look; // r16
        signed int i; // r6
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00397510 -> 0x003979B0
*/
// Range: 0x397510 -> 0x3979B0
class xLook * xLookGetSlot(unsigned char priority /* r19 */, unsigned short duration /* r18 */, float distance /* r20 */, signed int addFlag /* r17 */) {
    /* anonymous block */ {
        // Range: 0x397510 -> 0x3979B0
        unsigned char flag; // r3
        class xLookMgr * mgr; // r7
        unsigned int equalIndex; // r2
        unsigned int lowestIndex; // r6
        unsigned int i; // r5
        class xLook * idx; // r4
        class xLook * look; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003979B0 -> 0x00397B04
*/
// Range: 0x3979B0 -> 0x397B04
void xLookLevelReset() {
    /* anonymous block */ {
        // Range: 0x3979B0 -> 0x397B04
        class xLookMgr * mgr; // r18
        class xLook * look; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00397B10 -> 0x00397F10
*/
// Range: 0x397B10 -> 0x397F10
void xLookDebug() {
    /* anonymous block */ {
        // Range: 0x397B10 -> 0x397F10
        class Vector3D d; // r29+0x170
        float distance; // r29+0x180
        class Vector3D b; // r29+0x160
        class Vector3D a; // r29+0x150
        char name[128]; // r29+0xC0
        char str[128]; // r29+0x40
        signed int hasLookAt; // r2
        class xLook * lookAt; // r2
        float lookAtDistance; // r29+0x180
        signed int good; // r18
        signed int priority; // r2
        class Vector3D p; // r29+0x140
        class xLook * look; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00397F10 -> 0x00397F4C
*/
// Range: 0x397F10 -> 0x397F4C
void xLookInit() {
    /* anonymous block */ {
        // Range: 0x397F10 -> 0x397F4C
    }
