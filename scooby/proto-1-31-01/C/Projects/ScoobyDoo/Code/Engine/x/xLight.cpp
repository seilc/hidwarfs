/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xLight.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0035A120 -> 0x0035A128
*/
// Range: 0x35A120 -> 0x35A128
void xLightIdle() {
    /* anonymous block */ {
        // Range: 0x35A120 -> 0x35A128
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0035A130 -> 0x0035A2A0
*/
// Range: 0x35A130 -> 0x35A2A0
void xLightInitRuntime(class xLight * l /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35A130 -> 0x35A2A0
        class iLightResource * rsrc; // r2
        class _iLightRuntime * r; // r16
    }
}
