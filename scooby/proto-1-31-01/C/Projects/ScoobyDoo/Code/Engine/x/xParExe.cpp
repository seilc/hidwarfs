/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xParExe.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003460A0 -> 0x00346464
*/
// Range: 0x3460A0 -> 0x346464
void ParCmdExec_SpawnVFX(class xParCmd * cmd /* r18 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3460A0 -> 0x346464
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346470 -> 0x00346B8C
*/
// Range: 0x346470 -> 0x346B8C
void ParCmdExec_Emitter(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r20 */) {
    /* anonymous block */ {
        // Range: 0x346470 -> 0x346B8C
        class xPar * tmp; // r19
        float rnd; // r2
        signed int emitCount; // r18
        signed int j; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346B90 -> 0x00346D50
*/
// Range: 0x346B90 -> 0x346D50
void ParCmdExec_KillInvis(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x346B90 -> 0x346D50
        class xPar * p; // r6
        class tagParCmd_KillInvis * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346D50 -> 0x00346F00
*/
// Range: 0x346D50 -> 0x346F00
void ParCmdExec_KillOld(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x346D50 -> 0x346F00
        class xPar * p; // r6
        class tagParCmd_KillOld * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00346F00 -> 0x00347198
*/
// Range: 0x346F00 -> 0x347198
void ParCmdExec_KillSlow(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x346F00 -> 0x347198
        class xPar * p; // r6
        class tagParCmd_KillSlow * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003471A0 -> 0x003475AC
*/
// Range: 0x3471A0 -> 0x3475AC
void ParCmdExec_KillPlane(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3471A0 -> 0x3475AC
        float zow; // r21
        float xow; // r20
        unsigned int zbit; // r2
        unsigned int xbit; // r18
        signed short plane; // r7
        class tagiFloor * f; // r17
        class xPar * p; // r16
        class tagParCmd_KillPlane * d; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003475B0 -> 0x00347898
*/
// Range: 0x3475B0 -> 0x347898
void ParCmdExec_KillBox(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3475B0 -> 0x347898
        class Vector3D * v; // r5
        class xPar * p; // r4
        class tagParCmd_KillBox * d; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003478A0 -> 0x0034800C
*/
// Range: 0x3478A0 -> 0x34800C
void ParCmdExec_Texture(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3478A0 -> 0x34800C
        float col; // r3
        float row; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348010 -> 0x003483C8
*/
// Range: 0x348010 -> 0x3483C8
static void ParCmdExecHelper_TextureBirth(class xParCmd * cmd /* r16 */, class xPar * p /* r17 */) {
    /* anonymous block */ {
        // Range: 0x348010 -> 0x3483C8
        float col; // r3
        float row; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003483D0 -> 0x00348590
*/
// Range: 0x3483D0 -> 0x348590
void ParCmdExec_RotMove(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3483D0 -> 0x348590
        class xPar * p; // r6
        class tagParCmd_RotMove * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348590 -> 0x0034886C
*/
// Range: 0x348590 -> 0x34886C
void ParCmdExec_Accelerate(class xParCmd * cmd /* r18 */, class tagxParSys * ps /* r17 */, unsigned int dt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x348590 -> 0x34886C
        float daz; // r1
        float day; // r3
        float dax; // r2
        class xPar * p; // r3
        class tagParCmd_Accelerate * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348870 -> 0x00348AC4
*/
// Range: 0x348870 -> 0x348AC4
void ParCmdExec_Move(class xParCmd * cmd /* r18 */, class tagxParSys * ps /* r17 */, unsigned int dt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x348870 -> 0x348AC4
        float t; // r2
        class xPar * p; // r4
        class tagParCmd_Move * d; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348AD0 -> 0x00348DE8
*/
// Range: 0x348AD0 -> 0x348DE8
void ParCmdExec_RandomDisplace(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r18 */, unsigned int dt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x348AD0 -> 0x348DE8
        float t; // r29+0x70
        class xPar * p; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00348DF0 -> 0x00349140
*/
// Range: 0x348DF0 -> 0x349140
void ParCmdExec_OrbitPoint(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r18 */, unsigned int dt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x348DF0 -> 0x349140
        float oorSqr; // r2
        float rSqr; // r24
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349140 -> 0x00349504
*/
// Range: 0x349140 -> 0x349504
void ParCmdExec_Turbulence(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r18 */, unsigned int dt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x349140 -> 0x349504
        float zcos; // r21
        float xsin; // r20
        ...
        float t; // r29+0x70
        class xPar * p; // r4
        class tagParCmd_Turbulence * d; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349510 -> 0x003498D4
*/
// Range: 0x349510 -> 0x3498D4
void ParCmdExec_Jet(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r18 */, unsigned int dt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x349510 -> 0x3498D4
        float oorSqr; // r21
        float rSqr; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003498E0 -> 0x00349CA4
*/
// Range: 0x3498E0 -> 0x349CA4
void ParCmdExec_Friction(class xParCmd * cmd /* r18 */, class tagxParSys * ps /* r17 */, unsigned int dt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3498E0 -> 0x349CA4
        float t; // r29+0x60
        class xPar * p; // r3
        class tagParCmd_Friction * d; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00349CB0 -> 0x0034A190
*/
// Range: 0x349CB0 -> 0x34A190
void ParCmdExec_Bounce(class xParCmd * cmd /* r16 */, class tagxParSys * ps /* r17 */) {
    /* anonymous block */ {
        // Range: 0x349CB0 -> 0x34A190
        float zow; // r21
        float xow; // r20
        unsigned int zbit; // r2
        unsigned int xbit; // r19
        signed short plane; // r7
        class tagiFloor * f; // r18
        class xPar * p; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034A190 -> 0x0034A378
*/
// Range: 0x34A190 -> 0x34A378
void ParCmdExec_LimitVelocity(class xParCmd * cmd /* r17 */, class tagxParSys * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x34A190 -> 0x34A378
        float mz; // r3
        float my; // r2
        float mx; // r1
        class xPar * p; // r4
        class tagParCmd_LimitVelocity * d; // r3
    }
}
