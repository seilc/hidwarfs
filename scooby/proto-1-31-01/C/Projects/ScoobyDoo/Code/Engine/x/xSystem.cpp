/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xSystem.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
unsigned int xRnd_seed; // size: 0x4, address: 0x4A3E44
unsigned int gScriptSoftReset; // size: 0x4, address: 0x0
static signed int sFastRandomInit; // size: 0x4, address: 0x4A4CA0
static signed int sFastRandom[64]; // size: 0x100, address: 0x4AD760
static signed int sFastRandomIdx; // size: 0x4, address: 0x4A4CA4
unsigned long gTimerValue; // size: 0x4, address: 0x4A5340
signed int scriptCheckSoftReset(); // size: 0x0, address: 0x32EB20
void scriptReboot(); // size: 0x0, address: 0x32EB30
signed int scriptSwitchToDisk(signed int, signed int); // size: 0x0, address: 0x32EB80
void scriptSceneSwitch(signed int, signed int, signed int, signed int); // size: 0x0, address: 0x32EB90
void scriptControlCamera(signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x32EC00
signed int scriptIsPrivateInterpreter(); // size: 0x0, address: 0x32ED90
void scriptSystemAbort(); // size: 0x0, address: 0x32EC20
signed int scriptPlatform(); // size: 0x0, address: 0x32ECF0
void scriptDebugPrintStringInt(signed int, char *); // size: 0x0, address: 0x32ED00
void scriptDebugPrintString(char *); // size: 0x0, address: 0x32ED30
void scriptDebugPrintInt(signed int); // size: 0x0, address: 0x32ED60
void arraycopy(signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x32EAE0
signed int xFastRandomRange(signed int, signed int); // size: 0x0, address: 0x32E5A0
signed int xTimeGetMSecScript(); // size: 0x0, address: 0x32E900
signed int xFastRandom(signed int); // size: 0x0, address: 0x32E6C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E510 -> 0x0032E59C
*/
// Range: 0x32E510 -> 0x32E59C
signed int xRnd(signed int range /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E510 -> 0x32E59C
        signed int test; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E5A0 -> 0x0032E6B4
*/
// Range: 0x32E5A0 -> 0x32E6B4
signed int xFastRandomRange(signed int min /* r2 */, signed int max /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E5A0 -> 0x32E6B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E6C0 -> 0x0032E7CC
*/
// Range: 0x32E6C0 -> 0x32E7CC
signed int xFastRandom(signed int max /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E6C0 -> 0x32E7CC
        signed int i; // r6
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E7D0 -> 0x0032E868
*/
// Range: 0x32E7D0 -> 0x32E868
signed int xRandomRange(signed int min /* r2 */, signed int max /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E7D0 -> 0x32E868
        signed int num; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E870 -> 0x0032E8FC
*/
// Range: 0x32E870 -> 0x32E8FC
signed int xRandom(signed int max /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32E870 -> 0x32E8FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E900 -> 0x0032E910
*/
// Range: 0x32E900 -> 0x32E910
signed int xTimeGetMSecScript() {
    /* anonymous block */ {
        // Range: 0x32E900 -> 0x32E910
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032E910 -> 0x0032EAD4
*/
// Range: 0x32E910 -> 0x32EAD4
void xSystemInit() {
    /* anonymous block */ {
        // Range: 0x32E910 -> 0x32EAD4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EAE0 -> 0x0032EB1C
*/
// Range: 0x32EAE0 -> 0x32EB1C
void arraycopy(signed int src /* r2 */, signed int srcp /* r2 */, signed int dst /* r2 */, signed int dstp /* r2 */, signed int length /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32EAE0 -> 0x32EB1C
        signed int unitSize; // r9
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EB20 -> 0x0032EB2C
*/
// Range: 0x32EB20 -> 0x32EB2C
signed int scriptCheckSoftReset() {
    /* anonymous block */ {
        // Range: 0x32EB20 -> 0x32EB2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EB30 -> 0x0032EB80
*/
// Range: 0x32EB30 -> 0x32EB80
void scriptReboot() {
    /* anonymous block */ {
        // Range: 0x32EB30 -> 0x32EB80
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EB80 -> 0x0032EB8C
*/
// Range: 0x32EB80 -> 0x32EB8C
signed int scriptSwitchToDisk() {
    /* anonymous block */ {
        // Range: 0x32EB80 -> 0x32EB8C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EB90 -> 0x0032EBF4
*/
// Range: 0x32EB90 -> 0x32EBF4
void scriptSceneSwitch(signed int sceneID /* r8 */, signed int cameraID /* r3 */, signed int markerID /* r2 */, signed int ry /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32EB90 -> 0x32EBF4
        class Vector3D ang; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EC00 -> 0x0032EC20
*/
// Range: 0x32EC00 -> 0x32EC20
void scriptControlCamera(signed int cmd /* r2 */, signed int camera /* r2 */, signed int version /* r2 */, signed int start /* r2 */, signed int end /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32EC00 -> 0x32EC20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032EC20 -> 0x0032ECE4
*/
// Range: 0x32EC20 -> 0x32ECE4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032ECF0 -> 0x0032ECFC
*/
// Range: 0x32ECF0 -> 0x32ECFC
signed int scriptPlatform() {
    /* anonymous block */ {
        // Range: 0x32ECF0 -> 0x32ECFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032ED00 -> 0x0032ED30
*/
// Range: 0x32ED00 -> 0x32ED30
void scriptDebugPrintStringInt(signed int num /* r2 */, char * value /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32ED00 -> 0x32ED30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032ED30 -> 0x0032ED5C
*/
// Range: 0x32ED30 -> 0x32ED5C
void scriptDebugPrintString(char * value /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32ED30 -> 0x32ED5C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032ED60 -> 0x0032ED90
*/
// Range: 0x32ED60 -> 0x32ED90
void scriptDebugPrintInt(signed int value /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32ED60 -> 0x32ED90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032ED90 -> 0x0032ED9C
*/
// Range: 0x32ED90 -> 0x32ED9C
signed int scriptIsPrivateInterpreter() {
    /* anonymous block */ {
        // Range: 0x32ED90 -> 0x32ED9C
    }
}
