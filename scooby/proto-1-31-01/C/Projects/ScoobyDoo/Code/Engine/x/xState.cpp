/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xState.cpp
...
signed int xStateTransitionIsPossible(signed int, signed int, signed int); // size: 0x0, address: 0x3302A0
// total size: 0x20
class _p2Geom {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F390 -> 0x0032F40C
*/
// Range: 0x32F390 -> 0x32F40C
void xCharStateReset(signed int stateMax /* r2 */, class tagxState * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32F390 -> 0x32F40C
        class tagXAnim * anim; // r3
        signed int i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F410 -> 0x0032F70C
*/
// Range: 0x32F410 -> 0x32F70C
void xCharStateInit(signed int stateMax /* r19 */, class tagxState * s /* r18 */) {
    /* anonymous block */ {
        // Range: 0x32F410 -> 0x32F70C
        class tagXAnim * anim; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F710 -> 0x0032F820
*/
// Range: 0x32F710 -> 0x32F820
void xStateDoCallout(class _xActor * actor /* r2 */, class tagxStateThread * thread /* r7 */, signed int callout /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32F710 -> 0x32F820
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F820 -> 0x0032F8C8
*/
// Range: 0x32F820 -> 0x32F8C8
void xStateIdle(class _xActor * actor /* r18 */) {
    /* anonymous block */ {
        // Range: 0x32F820 -> 0x32F8C8
        class tagxStateMgr * sinfo; // r17
        class tagxStateThread * thread; // r2
        signed int t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032F8D0 -> 0x0033029C
*/
// Range: 0x32F8D0 -> 0x33029C
signed int xStateTransition(class _xActor * actor /* r16 */, class tagxPadAction * action /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32F8D0 -> 0x33029C
        char actorString[256]; // r29+0x190
        char actionString[256]; // r29+0x90
        signed int n; // r2
        signed int alreadyActive; // r2
        class tagxStateThread * newThread; // r22
        signed int alreadyActive; // r2
        signed int firstAvail; // r22
        signed int n; // r2
        signed int t2; // r2
        class iActorRuntime * a; // r2
        signed int found; // r23
        class tagxStateMgr * sinfo; // r21
        unsigned int command; // r20
        class tagxStateThread * thread; // r19
        class tagxStateLink * l; // r18
        signed int t; // r17
        signed int i; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003302A0 -> 0x003303D0
*/
// Range: 0x3302A0 -> 0x3303D0
signed int xStateTransitionIsPossible(signed int actorType /* r2 */, signed int actorId /* r2 */, signed int command /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3302A0 -> 0x3303D0
        signed int n; // r4
        class tagxStateMgr * sinfo; // r2
        class tagxStateThread * thread; // r2
        class tagxStateLink * l; // r8
        signed int t; // r7
        signed int i; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003303D0 -> 0x00330450
*/
// Range: 0x3303D0 -> 0x330450
void xStateLevelRestart(class _xActor * actor /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3303D0 -> 0x330450
        class tagxStateThread * thread; // r16
        class tagxStateMgr * sinfo; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00330450 -> 0x0033049C
*/
// Range: 0x330450 -> 0x33049C
void xStateLevelReset(class _xActor * actor /* r2 */) {
    /* anonymous block */ {
        // Range: 0x330450 -> 0x33049C
        class tagxStateThread * thread; // r2
        class tagxStateMgr * sinfo; // r5
        signed int t; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003304A0 -> 0x003305B0
*/
// Range: 0x3304A0 -> 0x3305B0
void xStateInit(class _xActor * actor /* r3 */, class tagxState * states /* r2 */, signed int animationBasedMovement /* r2 */, void (* triggerHandler)(class _xActor *, signed int, class tagXAnim *, class tagXAnimTrigger *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3304A0 -> 0x3305B0
        class tagxStateMgr * sinfo; // r2
        class tagxStateThread * thread; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003305B0 -> 0x003305E4
*/
// Range: 0x3305B0 -> 0x3305E4
