/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xEnvironment.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0039CE70 -> 0x0039CFE4
*/
// Range: 0x39CE70 -> 0x39CFE4
void xEnvDraw(class _tagxEnv * env /* r16 */) {
    /* anonymous block */ {
        // Range: 0x39CE70 -> 0x39CFE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0039CFF0 -> 0x0039D10C
*/
// Range: 0x39CFF0 -> 0x39D10C
signed int xEnvLoad(class _tagxEnv * env /* r17 */, char * filename /* r16 */) {
    /* anonymous block */ {
        // Range: 0x39CFF0 -> 0x39D10C
    }
}
