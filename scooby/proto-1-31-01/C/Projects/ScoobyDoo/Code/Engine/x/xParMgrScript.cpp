/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xParMgrScript.cpp
...
void xScriptParMgrSpawnActorJointRnd(signed int, signed int, signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x3F1370
void xScriptParMgrSpawnActorJoint(signed int, signed int, signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x3F0F80
void xScriptParMgrSpawnActorOffset(signed int, signed int, signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x3F1870
void xScriptParMgrSpawnMarkerOffset(signed int, signed int, signed int, signed int, signed int, signed int, signed int); // size: 0x0, address: 0x3F1D10
void xScriptParMgrSpawnMarker(signed int, signed int, signed int); // size: 0x0, address: 0x3F22C0
// total size: 0x48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F0F80 -> 0x003F1368
*/
// Range: 0x3F0F80 -> 0x3F1368
void xScriptParMgrSpawnActorJoint(signed int vfxType /* r16 */, signed int actorType /* r18 */, signed int actorID /* r17 */, signed int joint /* r22 */, signed int offX /* r21 */, signed int offY /* r20 */, signed int offZ /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3F0F80 -> 0x3F1368
        class tagMATRIX m; // r29+0xA0
        class Vector3D posB; // r29+0xF0
        class Vector3D posA; // r29+0xE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F1370 -> 0x003F186C
*/
// Range: 0x3F1370 -> 0x3F186C
void xScriptParMgrSpawnActorJointRnd(signed int vfxType /* r16 */, signed int actorType /* r19 */, signed int actorID /* r18 */, signed int joint /* r23 */, signed int count /* r22 */, signed int scale /* r21 */, signed int mode /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3F1370 -> 0x3F186C
        class Vector3D posB; // r29+0x110
        class Vector3D posA; // r29+0x100
        class Vector3D pos; // r29+0xF0
        class iActorRuntime * r; // r19
        class _xActor * a; // r18
        class tagMATRIX m; // r29+0xB0
        signed int hscale; // r17
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F1870 -> 0x003F1D10
*/
// Range: 0x3F1870 -> 0x3F1D10
void xScriptParMgrSpawnActorOffset(signed int vfxType /* r16 */, signed int actorType /* r22 */, signed int actorID /* r17 */, signed int offX /* r21 */, signed int offY /* r20 */, signed int offZ /* r19 */, signed int mode /* r18 */) {
    /* anonymous block */ {
        // Range: 0x3F1870 -> 0x3F1D10
        float flr; // r29+0xC0
        class Vector3D posB; // r29+0xB0
        class Vector3D posA; // r29+0xA0
        class iActorRuntime * r; // r17
        class _xActor * a; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F1D10 -> 0x003F22BC
*/
// Range: 0x3F1D10 -> 0x3F22BC
void xScriptParMgrSpawnMarkerOffset(signed int vfxType /* r21 */, signed int markerA /* r20 */, signed int markerB /* r19 */, signed int offX /* r18 */, signed int offY /* r17 */, signed int offZ /* r16 */, signed int mode /* r22 */) {
    /* anonymous block */ {
        // Range: 0x3F1D10 -> 0x3F22BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F22C0 -> 0x003F2710
*/
// Range: 0x3F22C0 -> 0x3F2710
void xScriptParMgrSpawnMarker(signed int vfxType /* r18 */, signed int markerA /* r17 */, signed int markerB /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3F22C0 -> 0x3F2710
        class Vector3D * b; // r2
        class Vector3D * a; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003F2710 -> 0x003F27B4
*/
// Range: 0x3F2710 -> 0x3F27B4
