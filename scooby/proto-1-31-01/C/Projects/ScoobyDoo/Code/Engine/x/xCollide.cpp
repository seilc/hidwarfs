/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xCollide.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404190 -> 0x004041B0
*/
// Range: 0x404190 -> 0x4041B0
signed int xCollideRay(class tagCollideInfo * info /* r2 */) {
    /* anonymous block */ {
        // Range: 0x404190 -> 0x4041B0
    }
}
