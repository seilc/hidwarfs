/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xTrigger.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xTrigger * sPlayerTrigger[16]; // size: 0x40, address: 0x4AC9F0
signed int theGlobalRuleNumber; // size: 0x4, address: 0x4A4C80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C0D0 -> 0x0032C2C4
*/
// Range: 0x32C0D0 -> 0x32C2C4
signed int xTriggerPlayerExistTrigger(class xTrigger * t /* r18 */, signed int * freeSlot /* r17 */) {
    /* anonymous block */ {
        // Range: 0x32C0D0 -> 0x32C2C4
        class xTrigger * val; // r3
        signed int freeidx; // r16
        signed int i; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C2D0 -> 0x0032C30C
*/
// Range: 0x32C2D0 -> 0x32C30C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C310 -> 0x0032C544
*/
// Range: 0x32C310 -> 0x32C544
signed int xTriggerIntersectLine(class xTrigger * t /* r18 */, class xLine2D * line /* r17 */, class _RwV2d * hitVector /* r16 */) {
    /* anonymous block */ {
        // Range: 0x32C310 -> 0x32C544
        signed int intersect; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C550 -> 0x0032C814
*/
// Range: 0x32C550 -> 0x32C814
signed int xTriggerCircleIntersectLine(class xTrigger * trig /* r18 */, class xLine2D * l /* r17 */, class _RwV2d * hitVector /* r16 */) {
    /* anonymous block */ {
        // Range: 0x32C550 -> 0x32C814
        class Vector3D ep; // r29+0x98
        class Vector3D sp; // r29+0x88
        signed int _ein; // r2
        signed int _sin; // r19
        float t2; // r29+0xAC
        float t1; // r29+0xA8
        class _RwV2d center; // r29+0x80
        class _RwV2d ray_dir; // r29+0x78
        class _RwV2d ray; // r29+0x70
        signed int intersect; // r2
        float radius; // r29+0xB0
        class iTriggerResource * r; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C820 -> 0x0032C974
*/
// Range: 0x32C820 -> 0x32C974
signed int xTriggerTriIntersectLine(class xTrigger * t /* r2 */, class xLine2D * l /* r20 */, class _RwV2d * hitVector /* r19 */) {
    /* anonymous block */ {
        // Range: 0x32C820 -> 0x32C974
        class iTriggerResource * r; // r18
        class xLine2D triLine; // r29+0x60
        signed int intersect; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032C980 -> 0x0032CAD4
*/
// Range: 0x32C980 -> 0x32CAD4
signed int xTriggerPolyIntersectLine(class xTrigger * t /* r2 */, class xLine2D * l /* r20 */, class _RwV2d * hitVector /* r19 */) {
    /* anonymous block */ {
        // Range: 0x32C980 -> 0x32CAD4
        class iTriggerResource * r; // r18
        class xLine2D triLine; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032CAE0 -> 0x0032CEDC
*/
// Range: 0x32CAE0 -> 0x32CEDC
signed int xTriggerRectIntersectLine(class xTrigger * t /* r2 */, class xLine2D * l /* r19 */, class _RwV2d * hitVector /* r18 */) {
    /* anonymous block */ {
        // Range: 0x32CAE0 -> 0x32CEDC
        class iTriggerResource * r; // r17
        class xLine2D triLine; // r29+0x70
        signed int intersect; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032CEE0 -> 0x0032D14C
*/
// Range: 0x32CEE0 -> 0x32D14C
signed int xTriggerResourceIntersectPoint(class iTriggerResource * t /* r2 */, class Vector3D * point /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32CEE0 -> 0x32D14C
        class Vector3D tmp; // r29+0x60
        class Vector3D * v; // r16
        signed int intersect; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032D150 -> 0x0032D46C
*/
// Range: 0x32D150 -> 0x32D46C
signed int xTriggerIntersectPoint(class xTrigger * t /* r19 */, class Vector3D * point /* r18 */) {
    /* anonymous block */ {
        // Range: 0x32D150 -> 0x32D46C
        class Vector3D tmp; // r29+0x80
        class Vector3D * v; // r17
        signed int intersect; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032D470 -> 0x0032DD90
*/
// Range: 0x32D470 -> 0x32DD90
void xTriggerHitPlayer(signed int genericTrigIndex /* r16 */, class Vector3D * playerPoint /* r2 */) {
    /* anonymous block */ {
        // Range: 0x32D470 -> 0x32DD90
        unsigned int tflags; // r18
        class xTrigger * t; // r17
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DD90 -> 0x0032DFA4
*/
// Range: 0x32DD90 -> 0x32DFA4
void xTriggerGameEvent(class xTrigger * t /* r21 */, unsigned int eventWho /* r20 */, unsigned int eventType /* r19 */, unsigned int eventCmd /* r18 */, unsigned int eventData /* r17 */) {
    /* anonymous block */ {
        // Range: 0x32DD90 -> 0x32DFA4
        unsigned int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0032DFB0 -> 0x0032E02C
*/
// Range: 0x32DFB0 -> 0x32E02C
void xTriggerEvaluate(class xTrigger * t /* r17 */) {
    /* anonymous block */ {
        // Range: 0x32DFB0 -> 0x32E02C
        unsigned int i; // r16
    }
