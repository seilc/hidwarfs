/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xCart.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class tagxCartControl gCartControl; // size: 0x578, address: 0xAAC620
signed int gCartTime; // size: 0x4, address: 0x4A4E74
signed int xCartDescriptionTable[17][2]; // size: 0x88, address: 0x44F570
static unsigned int interpreterMethodSave; // size: 0x4, address: 0x4A4E78
static unsigned int interpreterMethodRestore; // size: 0x4, address: 0x4A4E7C
static signed int restoreDiskInfo; // size: 0x4, address: 0x4A4E80
static unsigned char * restoreDataBuffer; // size: 0x4, address: 0x4A4E84
class xScene * xScene_current; // size: 0x4, address: 0x4A4E08
float gTimeSec; // size: 0x4, address: 0x4A4C8C
signed int requestCartRestore; // size: 0x4, address: 0x4A4660
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361AA0 -> 0x00361AC0
*/
// Range: 0x361AA0 -> 0x361AC0
void xCartSlotInfo(signed int cart /* r2 */, signed int slot /* r2 */, signed int addr /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361AA0 -> 0x361AC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361AC0 -> 0x00361BD0
*/
// Range: 0x361AC0 -> 0x361BD0
signed int xCartError() {
    /* anonymous block */ {
        // Range: 0x361AC0 -> 0x361BD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361BD0 -> 0x00361C68
*/
// Range: 0x361BD0 -> 0x361C68
signed int xCartFormat() {
    /* anonymous block */ {
        // Range: 0x361BD0 -> 0x361C68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361C70 -> 0x00361C90
*/
// Range: 0x361C70 -> 0x361C90
signed int xCartIsCardPresent() {
    /* anonymous block */ {
        // Range: 0x361C70 -> 0x361C90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361C90 -> 0x00361CB0
*/
// Range: 0x361C90 -> 0x361CB0
signed int xCartGetCardFreeBlocks(signed int slot /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361C90 -> 0x361CB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361CB0 -> 0x00361CD0
*/
// Range: 0x361CB0 -> 0x361CD0
signed int xCartCountValidCardSlots() {
    /* anonymous block */ {
        // Range: 0x361CB0 -> 0x361CD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361CD0 -> 0x00361CF0
*/
// Range: 0x361CD0 -> 0x361CF0
signed int xCartCheckValidSlot(signed int slot /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361CD0 -> 0x361CF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361CF0 -> 0x00361D10
*/
// Range: 0x361CF0 -> 0x361D10
signed int xCartCountValidSlots(signed int cart /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361CF0 -> 0x361D10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361D10 -> 0x00361D74
*/
// Range: 0x361D10 -> 0x361D74
signed int xCartDeleteGame(signed int slot /* r16 */) {
    /* anonymous block */ {
        // Range: 0x361D10 -> 0x361D74
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361D80 -> 0x00361E2C
*/
// Range: 0x361D80 -> 0x361E2C
signed int xCartSaveGameDone() {
    /* anonymous block */ {
        // Range: 0x361D80 -> 0x361E2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00361E30 -> 0x00362110
*/
// Range: 0x361E30 -> 0x362110
signed int xCartSaveGame(signed int slot /* r19 */) {
    /* anonymous block */ {
        // Range: 0x361E30 -> 0x362110
        signed int hour; // r18
        signed int min; // r17
        ...
        char * unknown; // @ 0x004A4E88
        signed char init; // @ 0x004A4E8C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362110 -> 0x00362150
*/
// Range: 0x362110 -> 0x362150
signed int xCartLoadGameDone() {
    /* anonymous block */ {
        // Range: 0x362110 -> 0x362150
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362150 -> 0x003621C0
*/
// Range: 0x362150 -> 0x3621C0
signed int xCartLoadGame(signed int slot /* r16 */) {
    /* anonymous block */ {
        // Range: 0x362150 -> 0x3621C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003621C0 -> 0x0036222C
*/
// Range: 0x3621C0 -> 0x36222C
signed int xCartAccessCardDone() {
    /* anonymous block */ {
        // Range: 0x3621C0 -> 0x36222C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362230 -> 0x003622B8
*/
// Range: 0x362230 -> 0x3622B8
signed int xCartAccessCard(signed int cart /* r16 */) {
    /* anonymous block */ {
        // Range: 0x362230 -> 0x3622B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003622C0 -> 0x00362468
*/
// Range: 0x3622C0 -> 0x362468
void xCartIdle() {
    /* anonymous block */ {
        // Range: 0x3622C0 -> 0x362468
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362470 -> 0x00362810
*/
// Range: 0x362470 -> 0x362810
void xCartRestoreComplete() {
    /* anonymous block */ {
        // Range: 0x362470 -> 0x362810
        unsigned char * buffer; // r2
        unsigned short size; // r29+0x6E
        signed int nextDisk; // r18
        signed int time; // r2
        signed int tmp; // r29+0x68
        signed int dataSize; // r2
        unsigned int cameraId; // r2
        unsigned int sceneId; // r17
        signed int dataUsed; // r2
        unsigned char * dataPointer; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362810 -> 0x00362D0C
*/
// Range: 0x362810 -> 0x362D0C
void xCartSave(signed int write /* r18 */) {
    /* anonymous block */ {
        // Range: 0x362810 -> 0x362D0C
        unsigned int dataSize; // r29+0x68
        unsigned short compressionBufferSize; // r29+0x6E
        unsigned short dataBufferSize; // r29+0x6C
        signed int dataUsed; // r17
        unsigned char * sizePointer; // r16
        unsigned char * dataPointer; // r2
        unsigned char * compressionBuffer; // r16
        unsigned int * javaBuffer; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362D10 -> 0x00362E30
*/
// Range: 0x362D10 -> 0x362E30
void xCartSavePlayer(unsigned char * buffer /* r2 */, signed int size /* r17 */) {
    /* anonymous block */ {
        // Range: 0x362D10 -> 0x362E30
        signed int dataSize; // r29+0x5C
        unsigned int * javaBuffer; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362E30 -> 0x00362E54
*/
// Range: 0x362E30 -> 0x362E54
void xCartBeep() {
    /* anonymous block */ {
        // Range: 0x362E30 -> 0x362E54
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362E60 -> 0x00362EA8
*/
// Range: 0x362E60 -> 0x362EA8
void xCartEnd() {
    /* anonymous block */ {
        // Range: 0x362E60 -> 0x362EA8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362EB0 -> 0x00362F0C
*/
// Range: 0x362EB0 -> 0x362F0C
void xCartBegin() {
    /* anonymous block */ {
        // Range: 0x362EB0 -> 0x362F0C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362F10 -> 0x00362F20
*/
// Range: 0x362F10 -> 0x362F20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00362F20 -> 0x003630E8
*/
// Range: 0x362F20 -> 0x3630E8
signed int xCartInit() {
    /* anonymous block */ {
        // Range: 0x362F20 -> 0x3630E8
    }
}
