/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xActor.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int interpreterMethod; // size: 0x4, address: 0x4A4ED0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369390 -> 0x003693C8
*/
// Range: 0x369390 -> 0x3693C8
void xActorCalloutFlyBack(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369390 -> 0x3693C8
        class tagxPhysicsObject * phys; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003693D0 -> 0x00369408
*/
// Range: 0x3693D0 -> 0x369408
void xActorCalloutFlyFast(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3693D0 -> 0x369408
        class tagxPhysicsObject * phys; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369410 -> 0x00369448
*/
// Range: 0x369410 -> 0x369448
void xActorCalloutFlySlow(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369410 -> 0x369448
        class tagxPhysicsObject * phys; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369450 -> 0x00369458
*/
// Range: 0x369450 -> 0x369458
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369460 -> 0x00369468
*/
// Range: 0x369460 -> 0x369468
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369470 -> 0x00369478
*/
// Range: 0x369470 -> 0x369478
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369480 -> 0x00369488
*/
// Range: 0x369480 -> 0x369488
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369490 -> 0x0036958C
*/
// Range: 0x369490 -> 0x36958C
void xActorCalloutRotateCounterClockwise(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369490 -> 0x36958C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369590 -> 0x00369688
*/
// Range: 0x369590 -> 0x369688
void xActorCalloutRotateClockwise(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369590 -> 0x369688
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369690 -> 0x00369834
*/
// Range: 0x369690 -> 0x369834
void xActorGetMatrix(class _xActor * a /* r17 */, class tagMATRIX * actorMatrix /* r16 */) {
    /* anonymous block */ {
        // Range: 0x369690 -> 0x369834
        class tagxPhysicsObject * p; // r17
        class tagMATRIX ms; // r29+0x190
        class tagMATRIX m1; // r29+0x150
        class tagMATRIX matrix; // r29+0x110
        class tagMATRIX mz; // r29+0xD0
        class tagMATRIX my; // r29+0x90
        class tagMATRIX mx; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369840 -> 0x003698D0
*/
// Range: 0x369840 -> 0x3698D0
void xActorSetOrientation(class _xActor * a /* r2 */, float rx /* r22 */, float ry /* r21 */, float rz /* r20 */) {
    /* anonymous block */ {
        // Range: 0x369840 -> 0x3698D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003698D0 -> 0x00369964
*/
// Range: 0x3698D0 -> 0x369964
void xActorSetLookat(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3698D0 -> 0x369964
        float ry; // r29+0x30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369970 -> 0x00369A10
*/
// Range: 0x369970 -> 0x369A10
void xActorAdjustOrientation(class _xActor * a /* r2 */, float rx /* r29+0x30 */, float ry /* r29+0x30 */, float rz /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x369970 -> 0x369A10
        class iActorRuntime * r; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369A10 -> 0x00369A50
*/
// Range: 0x369A10 -> 0x369A50
void xActorSetPosition(class _xActor * a /* r16 */, float x /* r29+0x20 */, float y /* r29+0x20 */, float z /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x369A10 -> 0x369A50
        class iActorRuntime * r; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369A50 -> 0x00369CE4
*/
// Range: 0x369A50 -> 0x369CE4
signed int xActorActorInFOV(class _xActor * a /* r18 */, class _xActor * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369A50 -> 0x369CE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369CF0 -> 0x00369D10
*/
// Range: 0x369CF0 -> 0x369D10
void xActorDraw(class _xActor * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x369CF0 -> 0x369D10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00369D10 -> 0x0036A1C8
*/
// Range: 0x369D10 -> 0x36A1C8
void xActorIdle(class _xActor * obj /* r17 */) {
    /* anonymous block */ {
        // Range: 0x369D10 -> 0x36A1C8
        class iActorRuntime * aa; // r6
        signed int t; // r3
        class tagXAnimControl * active; // r18
        class tagxPhysicsObject * phys; // r17
        class tagXAnim * anim; // r16
        class Vector3D rot; // r29+0x80
        class Vector3D trans3; // r29+0x70
        class Vector3D trans2; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036A1D0 -> 0x0036A638
*/
// Range: 0x36A1D0 -> 0x36A638
void xActorIdleRoute(class _xActor * actor /* r19 */) {
    /* anonymous block */ {
        // Range: 0x36A1D0 -> 0x36A638
        float mag; // r1
        class _xActor * target_actor; // r18
        class _xObj * target_obj; // r18
        class xNavPoint * nextNav; // r2
        class Vector3D v; // r29+0x70
        class iActorRuntime * a; // r17
        class tagxPhysicsObject * p; // r17
        class xRoute * r; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036A640 -> 0x0036AD00
*/
// Range: 0x36A640 -> 0x36AD00
void xActorIdleAdvanceRoute(class _xActor * actor /* r20 */, class xRoute * r /* r19 */) {
    /* anonymous block */ {
        // Range: 0x36A640 -> 0x36AD00
        signed int id; // r3
        float ang; // r29+0xD0
        class xNavPoint * cnp; // r18
        class tagxPhysicsObject * p; // r17
        class Vector3D * cpos; // r2
        class iActorRuntime * a; // r16
        class Vector3D v; // r29+0xC0
        class Vector3D posb; // r29+0xB0
        class Vector3D posa; // r29+0xA0
        class xNavPoint * np; // r21
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036AD00 -> 0x0036AE14
*/
// Range: 0x36AD00 -> 0x36AE14
signed int xActorConsoleMgr(class _xActor * actor /* r20 */, signed int count /* r19 */, class tagxPadAction * actions /* r18 */, signed int remap /* r2 */) {
    /* anonymous block */ {
        // Range: 0x36AD00 -> 0x36AE14
        signed int validAction; // r17
        class tagXAnimControl * active; // r2
        class tagxPadAction * a; // r2
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036AE20 -> 0x0036AE28
*/
// Range: 0x36AE20 -> 0x36AE28
void xActorDestroy() {
    /* anonymous block */ {
        // Range: 0x36AE20 -> 0x36AE28
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036AE30 -> 0x0036AEB4
*/
// Range: 0x36AE30 -> 0x36AEB4
void xActorInitialize(class _xActor * a /* r16 */) {
    /* anonymous block */ {
        // Range: 0x36AE30 -> 0x36AEB4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0036AEC0 -> 0x0036AECC
*/
// Range: 0x36AEC0 -> 0x36AECC
