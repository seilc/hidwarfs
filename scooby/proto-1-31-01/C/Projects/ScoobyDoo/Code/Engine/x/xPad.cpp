/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xPad.cpp
...
class tagxPlayer g_Players[]; // size: 0x0, address: 0x4B5A20
void iPadInitFunc_Game(class tagxPad *); // size: 0x0, address: 0x37FB60
// total size: 0x48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034C290 -> 0x0034C440
*/
// Range: 0x34C290 -> 0x34C440
signed int xPadButtonPressed(signed int pad /* r17 */, signed int whichXPAD_BUTTON /* r16 */) {
    /* anonymous block */ {
        // Range: 0x34C290 -> 0x34C440
        class _XBUTTON * b; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034C440 -> 0x0034CE8C
*/
// Range: 0x34C440 -> 0x34CE8C
void xConsoleMgrIdle(unsigned long theTime /* r17 */) {
    /* anonymous block */ {
        // Range: 0x34C440 -> 0x34CE8C
        signed int canGoOn; // r17
        class tagxPadAction * ca; // r8
        class tagxPadAction * ta; // r5
        signed int k; // r4
        signed int j; // r3
        class _xActor * a; // r3
        class tagxPlayer * p; // r3
        signed int newCount; // r2
        signed int i; // r16
        signed int actionCount[4]; // @ 0x004499D0
        class tagxPadAction actionQueue[4][33]; // @ 0x004DF7C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034CE90 -> 0x0034CF78
*/
// Range: 0x34CE90 -> 0x34CF78
void (* xPadMgrGetFuncPtrAction(signed int controller /* r16 */))(class tagxPad *, signed int, class tagxPadAction *) {
    /* anonymous block */ {
        // Range: 0x34CE90 -> 0x34CF78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034CF80 -> 0x0034D074
*/
// Range: 0x34CF80 -> 0x34D074
void xPadMgrAssignFuncPtrAction(signed int controller /* r17 */, void (* action)(class tagxPad *, signed int, class tagxPadAction *) /* r16 */) {
    /* anonymous block */ {
        // Range: 0x34CF80 -> 0x34D074
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034D080 -> 0x0034D168
*/
// Range: 0x34D080 -> 0x34D168
signed int (* xPadMgrGetFuncPtrMapper(signed int controller /* r16 */))(class tagxPad *, class tagxPadAction *, signed int) {
    /* anonymous block */ {
        // Range: 0x34D080 -> 0x34D168
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034D170 -> 0x0034D264
*/
// Range: 0x34D170 -> 0x34D264
void xPadMgrAssignFuncPtrMapper(signed int controller /* r17 */, signed int (* mapper)(class tagxPad *, class tagxPadAction *, signed int) /* r16 */) {
    /* anonymous block */ {
        // Range: 0x34D170 -> 0x34D264
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034D270 -> 0x0034DA78
*/
// Range: 0x34D270 -> 0x34DA78
signed short xConsoleMgrInit(signed int maxControllers /* r17 */) {
    /* anonymous block */ {
        // Range: 0x34D270 -> 0x34DA78
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0034DA80 -> 0x0034DAA0
*/
// Range: 0x34DA80 -> 0x34DAA0
