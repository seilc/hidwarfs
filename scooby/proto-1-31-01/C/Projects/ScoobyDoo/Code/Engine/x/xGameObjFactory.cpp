/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xGameObjFactory.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404680 -> 0x00404740
*/
// Range: 0x404680 -> 0x404740
class xGameObj * create() {
    /* anonymous block */ {
        // Range: 0x404680 -> 0x404740
        class xGameObj * go; // r16
    }
}
