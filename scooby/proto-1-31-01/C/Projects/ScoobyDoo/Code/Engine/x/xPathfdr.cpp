/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xPathfdr.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xPathfinder gPathfinder; // size: 0xE4, address: 0x4B5B80
static class xPathfinder * pf; // size: 0x4, address: 0x4A3EBC
class xSearchPoint gSP[4][150]; // size: 0x3840, address: 0x4B5C70
class xNavPoint * startPt; // size: 0x4, address: 0x0
signed int gDebugLOSFast; // size: 0x4, address: 0x0
signed int gDebugLOSCounter; // size: 0x4, address: 0x4A4D04
...
class xPathfinder {
    // Members
public:
    class xSearch m_search[4]; // offset 0x0, size 0xD0
    class xScene * m_scene; // offset 0xD0, size 0x4
    class xList m_open; // offset 0xD4, size 0x8
    class xList m_closed; // offset 0xDC, size 0x8
};
// total size: 0x4
class _RpSector {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00340BE0 -> 0x00341464
*/
// Range: 0x340BE0 -> 0x341464
signed int xPathfinderAStarGenerateSuccessors(class xSearch * s /* r20 */, class xSearchPoint * parent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x340BE0 -> 0x341464
        class xSearchPoint * tmp; // r2
        class xSearchPoint * tmp; // r2
        float f; // r22
        float heuristic; // r21
        float cost; // r20
        unsigned int i; // r18
        class xSearchPoint * sp; // r16
        class xNavPoint * node; // r17
        class xNavLink * link; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341470 -> 0x0034175C
*/
// Range: 0x341470 -> 0x34175C
void xPathfinderSetScene(class xScene * s /* r17 */) {
    /* anonymous block */ {
        // Range: 0x341470 -> 0x34175C
        class xSearchPoint * p; // r6
        unsigned int j; // r3
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341760 -> 0x003418A8
*/
// Range: 0x341760 -> 0x3418A8
class xNavPoint * xPathfinderFindLOSNearestNotInPortal(class Vector3D * p /* r19 */, signed int physObj /* r18 */) {
    /* anonymous block */ {
        // Range: 0x341760 -> 0x3418A8
        float bestDistance; // r21
        class xNavPoint * best; // r17
        float idxDistance; // r20
        class xNavPoint * idx; // r20
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003418B0 -> 0x00341B00
*/
// Range: 0x3418B0 -> 0x341B00
signed int xPathfinderNavPointInPortal(class xNavPoint * nav /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3418B0 -> 0x341B00
        class xEntryPoint * e; // r2
        unsigned int pmask; // r3
        unsigned int maskHi; // r19
        unsigned int maskLo; // r18
        unsigned int mask; // r2
        class Vector3D * ppos; // r17
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341B00 -> 0x00341C18
*/
// Range: 0x341B00 -> 0x341C18
class xNavPoint * xPathfinderFindLOSNearest(class Vector3D * p /* r19 */, signed int physObj /* r18 */) {
    /* anonymous block */ {
        // Range: 0x341B00 -> 0x341C18
        float bestDistance; // r21
        class xNavPoint * best; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341C20 -> 0x00341ED8
*/
// Range: 0x341C20 -> 0x341ED8
signed int xPathfinderLineOfSight(class Vector3D * a /* r18 */, class Vector3D * b /* r17 */, signed int physObjectType /* r20 */) {
    /* anonymous block */ {
        // Range: 0x341C20 -> 0x341ED8
        unsigned int him; // r2
        unsigned int lom; // r16
        unsigned int * maskp; // r19
        unsigned int mask; // r3
        unsigned int lineFloorMaskLo; // r18
        unsigned int lineFloorMaskHi; // r17
        unsigned int lineFloorMask; // r2
        class xLine2D line; // r29+0x70
        class _RwV2d hitVector[2]; // r29+0x60
        unsigned int i; // r16
        class xTrigger * idx; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341EE0 -> 0x00341F30
*/
// Range: 0x341EE0 -> 0x341F30
signed int xPathfinderLineOfSightPhysObj(class tagxPhysicsObject * po /* r2 */, class Vector3D * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x341EE0 -> 0x341F30
        class Vector3D pos; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341F30 -> 0x00341FE0
*/
// Range: 0x341F30 -> 0x341FE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00341FE0 -> 0x00342554
*/
// Range: 0x341FE0 -> 0x342554
void xPathfinderSearchIdle(class xSearch * s /* r18 */) {
    /* anonymous block */ {
        // Range: 0x341FE0 -> 0x342554
        class xListItem * best; // r17
        class xListItem * idx; // r3
        class xSearchPoint * node; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342560 -> 0x00342C44
*/
// Range: 0x342560 -> 0x342C44
void xPathfinderSearchStart(signed char id /* r17 */) {
    /* anonymous block */ {
        // Range: 0x342560 -> 0x342C44
        class xSearchPoint * p; // r17
        class xSearch * s; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342C50 -> 0x00342E64
*/
// Range: 0x342C50 -> 0x342E64
void xPathfinderSearchFree(signed char id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x342C50 -> 0x342E64
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00342E70 -> 0x00343114
*/
// Range: 0x342E70 -> 0x343114
void xPathfinderSearchRestart(signed char id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x342E70 -> 0x343114
        signed int i; // r6
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343120 -> 0x003432DC
*/
// Range: 0x343120 -> 0x3432DC
class xSearch * xPathfinderSearchGetPtr(signed char id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x343120 -> 0x3432DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003432E0 -> 0x00343480
*/
// Range: 0x3432E0 -> 0x343480
signed char xPathfinderSearchNew() {
    /* anonymous block */ {
        // Range: 0x3432E0 -> 0x343480
        signed int i; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00343480 -> 0x00343798
*/
// Range: 0x343480 -> 0x343798
void xPathfinderInit(class xScene * scene /* r2 */) {
    /* anonymous block */ {
        // Range: 0x343480 -> 0x343798
        signed int j; // r3
        signed int i; // r16
