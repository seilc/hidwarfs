/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Engine\x\xActorDB.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class tagxActorDBData gActorDBData; // size: 0x96C, address: 0xAAD650
class tagxActorDBData * gadb; // size: 0x4, address: 0x4A4658
class charstate * sinfo; // size: 0x4, address: 0x4A4EC8
static class charstate charState[40]; // size: 0x3C0, address: 0x44F690
static signed int padActionMethodIndex; // size: 0x4, address: 0x4A4ECC
signed int gLOSOld; // size: 0x4, address: 0x0
...
class charstate {
    // Members
public:
    class tagxState * m_states; // offset 0x0, size 0x4
    signed int m_animationBasedMovement; // offset 0x4, size 0x4
    void (* m_triggerHandler)(class _xActor *, signed int, class tagXAnim *, class tagXAnimTrigger *); // offset 0x8, size 0x4
    signed int m_initialized; // offset 0xC, size 0x4
    void (* m_initFunction)(); // offset 0x10, size 0x4
    void (* m_resetFunction)(); // offset 0x14, size 0x4
};
// total size: 0x14
class tagP2VERTEX {
    // Members
...
class _rxReq {};
// total size: 0x354
class tagxActorDBMemMgr {
    // Members
public:
    class _xActor * usedBy; // offset 0x0, size 0x4
    class _xModel model; // offset 0x4, size 0x8
    class xSkel skeleton; // offset 0xC, size 0x8
    class iActorRuntime actor; // offset 0x14, size 0x134
    class tagxStateMgr state; // offset 0x148, size 0x20C
};
// total size: 0x4698
class XStreamHeader {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003667E0 -> 0x00366B68
*/
// Range: 0x3667E0 -> 0x366B68
void xActorDBSetPositionActor(signed int objectType /* r19 */, signed int actorID /* r18 */, signed int toObjectType /* r17 */, signed int toActorID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3667E0 -> 0x366B68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00366B70 -> 0x00366CD4
*/
// Range: 0x366B70 -> 0x366CD4
void xActorDBSetPositionNavigationPoint(signed int objectType /* r18 */, signed int actorID /* r17 */, signed int navID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x366B70 -> 0x366CD4
        class xNavPoint * nav; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00366CE0 -> 0x00366EA0
*/
// Range: 0x366CE0 -> 0x366EA0
void xActorDBSetPosition(signed int objectType /* r18 */, signed int actorID /* r17 */, class Vector3D * p /* r16 */) {
    /* anonymous block */ {
        // Range: 0x366CE0 -> 0x366EA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00366EA0 -> 0x00366FB4
*/
// Range: 0x366EA0 -> 0x366FB4
class _xActor * xActorDBGetActor(signed int objectType /* r17 */, signed int actorID /* r16 */) {
    /* anonymous block */ {
        // Range: 0x366EA0 -> 0x366FB4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00366FC0 -> 0x00367184
*/
// Range: 0x366FC0 -> 0x367184
signed int xActorDBConsoleAction(signed int objectType /* r18 */, signed int actorID /* r17 */, signed int action /* r16 */) {
    /* anonymous block */ {
        // Range: 0x366FC0 -> 0x367184
        class tagxPadAction a; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367190 -> 0x0036745C
*/
// Range: 0x367190 -> 0x36745C
void xActorDBSetRoute(signed int objectType /* r19 */, signed int actorID /* r18 */, signed int routeID /* r17 */) {
    /* anonymous block */ {
        // Range: 0x367190 -> 0x36745C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367460 -> 0x00367618
*/
// Range: 0x367460 -> 0x367618
void xActorDBIdle() {
    /* anonymous block */ {
        // Range: 0x367460 -> 0x367618
        class xMessage theMessage; // r29+0x40
        class iActorRuntime * r; // r18
        class _xActor * a; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367620 -> 0x00367628
*/
// Range: 0x367620 -> 0x367628
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367630 -> 0x00367638
*/
// Range: 0x367630 -> 0x367638
void xActorDBDebug() {
    /* anonymous block */ {
        // Range: 0x367630 -> 0x367638
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367640 -> 0x003679B4
*/
// Range: 0x367640 -> 0x3679B4
void xActorDBSlide(class _xActor * a /* r16 */) {
    /* anonymous block */ {
        // Range: 0x367640 -> 0x3679B4
        signed int oldApplyVel; // r17
        signed int flip; // r2
        class Vector3D tmp; // r29+0x70
        class Vector3D vhn; // r29+0x60
        class Vector3D d; // r29+0x50
        class tagxPhysicsObject * o; // r17
        class iActorRuntime * r; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003679C0 -> 0x00367C20
*/
// Range: 0x3679C0 -> 0x367C20
void xActorDBPadActionSendRemap(signed int type /* r20 */, signed int id /* r19 */, signed int count /* r18 */, class tagxPadAction * actions /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3679C0 -> 0x367C20
        unsigned int remappedAction; // r29+0x8C
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367C20 -> 0x00367ECC
*/
// Range: 0x367C20 -> 0x367ECC
void xActorDBDestroy(signed int objectType /* r17 */, signed int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x367C20 -> 0x367ECC
        class _xActor * a; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00367ED0 -> 0x00368370
*/
// Range: 0x367ED0 -> 0x368370
void xActorDBSetup(signed int type /* r18 */, signed int id /* r17 */, unsigned int modelType /* r16 */, unsigned int skeletonType /* r23 */, unsigned int textureType /* r30 */) {
    /* anonymous block */ {
        // Range: 0x367ED0 -> 0x368370
        class tagxActorDBMemMgr * mem; // r2
        class xSkel * skeleton; // r22
        class _xModel * model; // r21
        class iActorRuntime * r; // r20
        class _xActor * a; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00368370 -> 0x003686C8
*/
// Range: 0x368370 -> 0x3686C8
signed int xActorDBCreate(signed int type /* r20 */, unsigned int modelType /* r19 */, unsigned int skeletonType /* r18 */, unsigned int textureType /* r17 */) {
    /* anonymous block */ {
        // Range: 0x368370 -> 0x3686C8
        signed int a; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003686D0 -> 0x003687E0
*/
// Range: 0x3686D0 -> 0x3687E0
void xActorDBActiveRemove(class _xActor * a /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3686D0 -> 0x3687E0
        signed int i; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003687E0 -> 0x00368860
*/
// Range: 0x3687E0 -> 0x368860
void xActorDBDraw() {
    /* anonymous block */ {
        // Range: 0x3687E0 -> 0x368860
        class _xActor * a; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00368860 -> 0x0036886C
*/
// Range: 0x368860 -> 0x36886C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00368870 -> 0x00368940
*/
// Range: 0x368870 -> 0x368940
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00368940 -> 0x00368A10
*/
// Range: 0x368940 -> 0x368A10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00368A10 -> 0x00369388
*/
// Range: 0x368A10 -> 0x369388
