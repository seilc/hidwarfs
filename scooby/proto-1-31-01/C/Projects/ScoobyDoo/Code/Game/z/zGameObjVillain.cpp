/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Game\z\zGameObjVillain.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int cur_point; // size: 0x4, address: 0x4A5074
static unsigned char was_active_last_frame; // size: 0x1, address: 0x0
static class _SkinData zSkinData; // size: 0xC, address: 0x0
// total size: 0x20
struct /* @anon0 */ {} zGameObjVillain::__vtable; // size: 0x20, address: 0x4A2970
float g_DEGTORAD; // size: 0x4, address: 0x485A58
class _rpAtomic * zSkinAnimSetupAtomicCallback(class _rpAtomic *, void *); // size: 0x0, address: 0x4059D0
...
class _rpAtomic * hackUpdateSkinAtomic(class _rpAtomic *, void *); // size: 0x0, address: 0x4056C0
...
// total size: 0xF8
class zGameObjVillain : public xGameCharacter {
    // Members
public:
    signed int chris_hack_value; // offset 0xCC, size 0x4
    signed int snack_delay; // offset 0xD0, size 0x4
    signed int m_currentStateTime; // offset 0xD4, size 0x4
    signed int m_currentState; // offset 0xD8, size 0x4
    signed int m_jumping; // offset 0xDC, size 0x4
    signed int m_doublejumping; // offset 0xE0, size 0x4
    float m_gradient; // offset 0xE4, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404E70 -> 0x00404E78
*/
// Range: 0x404E70 -> 0x404E78
void render() {
    /* anonymous block */ {
        // Range: 0x404E70 -> 0x404E78
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00404E80 -> 0x004056BC
*/
// Range: 0x404E80 -> 0x4056BC
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004056C0 -> 0x00405720
*/
// Range: 0x4056C0 -> 0x405720
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00405720 -> 0x00405728
*/
// Range: 0x405720 -> 0x405728
void restart() {
    /* anonymous block */ {
        // Range: 0x405720 -> 0x405728
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00405730 -> 0x00405738
*/
// Range: 0x405730 -> 0x405738
void kill() {
    /* anonymous block */ {
        // Range: 0x405730 -> 0x405738
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00405740 -> 0x004057F0
*/
// Range: 0x405740 -> 0x4057F0
void init() {
    /* anonymous block */ {
        // Range: 0x405740 -> 0x4057F0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004057F0 -> 0x004059C4
*/
// Range: 0x4057F0 -> 0x4059C4
// this: r17
void zGameObjVillain::init(char * filename /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4057F0 -> 0x4059C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004059D0 -> 0x00405A3C
*/
// Range: 0x4059D0 -> 0x405A3C
