/*
    Compile unit: C:\Projects\ScoobyDoo\Code\Game\z\zDemo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static char dbfont_chars[51]; // size: 0x33, address: 0x0
static class zDemo * m_globalDemo; // size: 0x4, address: 0x4A5000
class zCharacter * gVillain; // size: 0x4, address: 0x4A5004
class zCharacter * gPlayer; // size: 0x4, address: 0x4A5008
...
unsigned int anim_ID_snack1; // size: 0x4, address: 0x4A502C
unsigned int anim_ID_grass1; // size: 0x4, address: 0x4A5030
class zCharacter * bad_guy; // size: 0x4, address: 0x4A503C
unsigned int bad_guy_anim_ID; // size: 0x4, address: 0x4A5040
unsigned int bad_guy_idle_ID; // size: 0x4, address: 0x4A5044
// total size: 0x24
struct /* @anon0 */ {} zDemo::__vtable; // size: 0x24, address: 0x4A27F0
...
// total size: 0x24
struct /* @anon1 */ {} xModule::__vtable; // size: 0x24, address: 0x4A2790
...
class xGameObjMgr * gGameObjMgr; // size: 0x4, address: 0x4A5070
// total size: 0xC
...
// total size: 0x34
class xGameObjMgr : public xModule {
    // Members
public:
    class xGameObj * m_list; // offset 0x30, size 0x4
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED750 -> 0x003ED778
*/
// Range: 0x3ED750 -> 0x3ED778
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED780 -> 0x003ED7A4
*/
// Range: 0x3ED780 -> 0x3ED7A4
void PadButtonCross() {
    /* anonymous block */ {
        // Range: 0x3ED780 -> 0x3ED7A4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED7B0 -> 0x003ED894
*/
// Range: 0x3ED7B0 -> 0x3ED894
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED8A0 -> 0x003ED980
*/
// Range: 0x3ED8A0 -> 0x3ED980
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED980 -> 0x003ED9C8
*/
// Range: 0x3ED980 -> 0x3ED9C8
void PadRightStick(float x /* r29+0x20 */, float y /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3ED980 -> 0x3ED9C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003ED9D0 -> 0x003EDA10
*/
// Range: 0x3ED9D0 -> 0x3EDA10
void PadLeftStick(float x /* r29+0x20 */, float y /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3ED9D0 -> 0x3EDA10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDA10 -> 0x003EDA40
*/
// Range: 0x3EDA10 -> 0x3EDA40
// this: r2
zDemo::zDemo() {
    /* anonymous block */ {
        // Range: 0x3EDA10 -> 0x3EDA40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDA40 -> 0x003EDAF8
*/
// Range: 0x3EDA40 -> 0x3EDAF8
// this: r16
void zDemo::render() {
    /* anonymous block */ {
        // Range: 0x3EDA40 -> 0x3EDAF8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDB00 -> 0x003EDD80
*/
// Range: 0x3EDB00 -> 0x3EDD80
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDD80 -> 0x003EDE78
*/
// Range: 0x3EDD80 -> 0x3EDE78
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDE80 -> 0x003EDF8C
*/
// Range: 0x3EDE80 -> 0x3EDF8C
// this: r17
void zDemo::restart() {
    /* anonymous block */ {
        // Range: 0x3EDE80 -> 0x3EDF8C
        class _RwV3d * pos; // r2
        class _RwMatrix * m; // r19
        class _RwFrame * f; // r18
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDF90 -> 0x003EDF98
*/
// Range: 0x3EDF90 -> 0x3EDF98
void kill() {
    /* anonymous block */ {
        // Range: 0x3EDF90 -> 0x3EDF98
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003EDFA0 -> 0x003EE838
*/
// Range: 0x3EDFA0 -> 0x3EE838
// this: r17
void zDemo::init() {
    /* anonymous block */ {
        // Range: 0x3EDFA0 -> 0x3EE838
        signed int i; // r16
        signed int i; // r16
        float grass_pos[123]; // r29+0x80
        class Vector3D bad_pos; // r29+0x270
        signed int healthIndex; // @ 0x004A5034
        signed char init; // @ 0x004A5038
    }
}
