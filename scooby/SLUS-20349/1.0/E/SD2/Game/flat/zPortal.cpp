/*
    Compile unit: E:\SD2\Game\flat\zPortal.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zPortalEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A0360
// total size: 0x7C
class RpWorld {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0360 -> 0x001A03C4
*/
// Range: 0x1A0360 -> 0x1A03C4
signed int zPortalEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0360 -> 0x1A03C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A03D0 -> 0x001A03D8
*/
// Range: 0x1A03D0 -> 0x1A03D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A03E0 -> 0x001A03E8
*/
// Range: 0x1A03E0 -> 0x1A03E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A03F0 -> 0x001A0448
*/
// Range: 0x1A03F0 -> 0x1A0448
