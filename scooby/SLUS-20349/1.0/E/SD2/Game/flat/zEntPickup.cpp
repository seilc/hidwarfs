/*
    Compile unit: E:\SD2\Game\flat\zEntPickup.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float sKeysOffTimer; // size: 0x4, address: 0x35759C
static signed int zHudShowSnackGateInfo; // size: 0x4, address: 0x0
static signed int sKeyCounterEnabledBeforeGive; // size: 0x4, address: 0x358070
static class _tagKeyShake sKeyShake[4]; // size: 0x60, address: 0x2B30F0
static class _xEntFrame gPickupFrame; // size: 0xF0, address: 0x36F0B0
static class _xEntCollis gPickupCollis; // size: 0x4FC, address: 0x36F1A0
static class _zParEmitter * sEmitGlow; // size: 0x4, address: 0x358074
static class _zParEmitter * sEmitMmm; // size: 0x4, address: 0x358078
static class _zParEmitter * sEmitQMark; // size: 0x4, address: 0x35807C
static class _zParEmitter * sEmitBubble; // size: 0x4, address: 0x358080
static class _zParEmitter * sEmitGum; // size: 0x4, address: 0x358084
static class _zParEmitter * sEmitOdour; // size: 0x4, address: 0x358088
static class _zParEmitter * sEmitGrabPowerup; // size: 0x4, address: 0x35808C
static class _zParEmitter * sEmitGrabCrumb; // size: 0x4, address: 0x358090
static class _zParEmitter * sEmitGrabSnackBox; // size: 0x4, address: 0x358094
static class _zParEmitter * sEmitGrabMmm; // size: 0x4, address: 0x358098
static class _zParEmitter * sEmitGrabQMark; // size: 0x4, address: 0x35809C
static class _zParEmitter * sEmitGrabGum; // size: 0x4, address: 0x3580A0
static class _zParEmitter * sEmitGrabBubbles; // size: 0x4, address: 0x3580A4
static class _zParEmitter * sEmitLoveHart; // size: 0x4, address: 0x3580A8
static class _zParEmitter * sEmitAkmalDaisy; // size: 0x4, address: 0x3580AC
static class _zParEmitter * sEmitGrabGhost; // size: 0x4, address: 0x3580B0
static class _zParEmitter * sEmitGrabSDLogo; // size: 0x4, address: 0x3580B4
static class _zParEmitter * sEmitWarpGate; // size: 0x4, address: 0x3580B8
static class _zParEmitter * sEmitMiniVanPuff; // size: 0x4, address: 0x3580BC
static class _zCounter * keyCounter; // size: 0x4, address: 0x3580C0
signed int zHudShowWarpGateInfo; // size: 0x4, address: 0x3575A0
static class zEntPickupWarpPoint zWarpPointTable[27]; // size: 0x144, address: 0x2B3150
class _zParEmitter * sEmitDust; // size: 0x4, address: 0x3581A0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
unsigned char * giAnimScratch; // size: 0x4, address: 0x3574A0
class _xEnt * sDecrementSnackGateEnt; // size: 0x4, address: 0x357F64
signed int zEntPickupEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x191CA0
void zEntPickup_Update(class _zEntPickup *, class _xScene *, float); // size: 0x0, address: 0x190380
// total size: 0x8
...
// total size: 0x18
class _zCounter : public xBase {
    // Members
public:
    class zCounterAsset * asset; // offset 0x10, size 0x4
...
// total size: 0xC
class zEntPickupWarpPoint {
    // Members
public:
    signed int id; // offset 0x0, size 0x4
    unsigned int status; // offset 0x4, size 0x4
    unsigned int sceneID; // offset 0x8, size 0x4
};
// total size: 0xB0
class RwFrame {
    // Members
...
// total size: 0xF8
class _zUI : public _zEnt {
    // Members
public:
    class zUIAsset * sasset; // offset 0xEC, size 0x4
    unsigned int uiFlags; // offset 0xF0, size 0x4
    unsigned int uiButton; // offset 0xF4, size 0x4
};
// total size: 0x10
class xCutsceneData {
    // Members
...
// total size: 0x7C
class zUIAsset : public p2EntAsset {
    // Members
public:
    unsigned int uiFlags; // offset 0x50, size 0x4
    unsigned short dim[2]; // offset 0x54, size 0x4
    unsigned int textureID; // offset 0x58, size 0x4
    float uva[2]; // offset 0x5C, size 0x8
    float uvb[2]; // offset 0x64, size 0x8
    float uvc[2]; // offset 0x6C, size 0x8
    float uvd[2]; // offset 0x74, size 0x8
};
// total size: 0x1C
class RpMaterial {
    // Members
...
// total size: 0xC
class zCounterAsset : public p2BaseAsset {
    // Members
public:
...
class _tagKeyShake {
    // Members
public:
    class _xVec3 orig_pos; // offset 0x0, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018ED10 -> 0x0018ED20
*/
// Range: 0x18ED10 -> 0x18ED20
void zEntPickup_SceneUpdate(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x18ED10 -> 0x18ED20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018ED20 -> 0x0018EE10
*/
// Range: 0x18ED20 -> 0x18EE10
void zEntPickup_ShowKeyCnt(unsigned int collected /* r18 */, unsigned int total /* r17 */) {
    /* anonymous block */ {
        // Range: 0x18ED20 -> 0x18EE10
        signed int i; // r2
        char s[64]; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018EE10 -> 0x0018EE94
*/
// Range: 0x18EE10 -> 0x18EE94
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018EEA0 -> 0x0018EF28
*/
// Range: 0x18EEA0 -> 0x18EF28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018EF30 -> 0x0018F038
*/
// Range: 0x18EF30 -> 0x18F038
void zEntPickup_UnlockSnackGate(class _xEnt * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x18EF30 -> 0x18F038
        class _zParEmitterCustomSettings info; // r29+0x30
        class _zEntPickup * pickup; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F040 -> 0x0018F08C
*/
// Range: 0x18F040 -> 0x18F08C
unsigned int zEntPickup_lastSnackInArea() {
    /* anonymous block */ {
        // Range: 0x18F040 -> 0x18F08C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F090 -> 0x0018F1D4
*/
// Range: 0x18F090 -> 0x18F1D4
void zEntPickup_UpdateFlyToInterface(class _zEntPickup * ent /* r18 */, unsigned int pcount /* r17 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x18F090 -> 0x18F1D4
        float ydist; // r29+0x50
        float xdist; // r20
        class _xVec3 * ent_pos; // r18
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F1E0 -> 0x0018F200
*/
// Range: 0x18F1E0 -> 0x18F200
unsigned int zEntPickup_WarpIsOpen(unsigned int index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18F1E0 -> 0x18F200
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F200 -> 0x0018F224
*/
// Range: 0x18F200 -> 0x18F224
void enableWarpPoint(unsigned int index /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18F200 -> 0x18F224
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F230 -> 0x0018F554
*/
// Range: 0x18F230 -> 0x18F554
void zEntPickup_GiveFX(class _zEntPickup * ent /* r20 */) {
    /* anonymous block */ {
        // Range: 0x18F230 -> 0x18F554
        class _zParEmitterCustomSettings info; // r29+0xD0
        class _zParEmitterCustomSettings info; // r29+0x70
        enum _tagGiveFXType type; // r19
        signed int pickup_idx; // r18
        signed int pickup_type; // r17
        signed int kill_glow; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F560 -> 0x0018F7E0
*/
// Range: 0x18F560 -> 0x18F7E0
void zEntPickup_RenderList(class _zEntPickup * plist /* r18 */, unsigned int pcount /* r17 */) {
    /* anonymous block */ {
        // Range: 0x18F560 -> 0x18F7E0
        float dist2; // r29+0x80
        signed int alpha; // r20
        class RwV3d vec_scale; // r29+0x70
        class RwFrame * frame; // r3
        class RwMatrixTag * imat; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F7E0 -> 0x0018F8C8
*/
// Range: 0x18F7E0 -> 0x18F8C8
static void zEntPickup_PlaySound(class _zEntPickup * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18F7E0 -> 0x18F8C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018F8D0 -> 0x0018FE64
*/
// Range: 0x18F8D0 -> 0x18FE64
static void zEntPickup_UpdateFX(class _zEntPickup * ent /* r20 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x18F8D0 -> 0x18FE64
        class _zParEmitterCustomSettings info; // r29+0xF0
        class _zParEmitterCustomSettings info; // r29+0x90
        unsigned char pupb; // r19
        unsigned char pupg; // r18
        unsigned char pupr; // r17
        signed int powerup; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018FE70 -> 0x00190018
*/
// Range: 0x18FE70 -> 0x190018
void zEntPickup_Drop(class _zEntPickup * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x18FE70 -> 0x190018
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00190020 -> 0x0019007C
*/
// Range: 0x190020 -> 0x19007C
void zEntPickup_MakeDroppable(class _zEntPickup * ent /* r2 */, class _xVec3 * pos /* r2 */, class xBase * parent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x190020 -> 0x19007C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00190080 -> 0x001901EC
*/
// Range: 0x190080 -> 0x1901EC
void zEntPickup_Load(class _zEntPickup * ent /* r16 */, class xSerial * s /* r18 */) {
    /* anonymous block */ {
        // Range: 0x190080 -> 0x1901EC
        signed int is_a_dropper; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001901F0 -> 0x0019022C
*/
// Range: 0x1901F0 -> 0x19022C
void zEntPickup_Save(class _zEntPickup * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1901F0 -> 0x19022C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00190230 -> 0x0019032C
*/
// Range: 0x190230 -> 0x19032C
void zEntPickup_Reset(class _zEntPickup * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x190230 -> 0x19032C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00190330 -> 0x00190378
*/
// Range: 0x190330 -> 0x190378
void zEntPickup_hideSnackGateInfo(class _zEntPickup * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x190330 -> 0x190378
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00190380 -> 0x001916A4
*/
// Range: 0x190380 -> 0x1916A4
void zEntPickup_Update(class _zEntPickup * ent /* r18 */, class _xScene * sc /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x190380 -> 0x1916A4
        float spin_time; // r29+0x290
        float rot_sec; // r3
        class _zParEmitterCustomSettings info; // r29+0x1E0
        float dist; // r29+0x290
        class _xVec3 * facept; // r2
        class _xVec3 * t0; // r19
        class _xQuat * q0; // r16
        float duration; // r29+0x290
        class _zParEmitterCustomSettings info; // r29+0x180
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001916B0 -> 0x0019198C
*/
// Range: 0x1916B0 -> 0x19198C
void zEntPickup_FlyToInterface(class _zEntPickup * ent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1916B0 -> 0x19198C
        float scale; // r4
        class _xVec3 * src; // r2
        float perc; // r29+0x90
        class _xMat4x3 dest; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00191990 -> 0x00191CA0
*/
// Range: 0x191990 -> 0x191CA0
signed int zPickup_Give(class _zEntPickup * ent /* r17 */, class zAssetPickup * p /* r16 */, unsigned short value /* r2 */) {
    /* anonymous block */ {
        // Range: 0x191990 -> 0x191CA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00191DC0 -> 0x00192114
*/
// Range: 0x191DC0 -> 0x192114
void zEntPickup_Setup() {
    /* anonymous block */ {
        // Range: 0x191DC0 -> 0x192114
        class _xVec3 * srcPos; // r5
        class _zEntPickup * p; // r2
        class xBase * base; // r2
        unsigned int j; // r18
        unsigned int i; // r17
        class zScene * zsc; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192120 -> 0x00192154
*/
// Range: 0x192120 -> 0x192154
void zEntPickup_Setup(class _zEntPickup * p /* r2 */) {
    /* anonymous block */ {
        // Range: 0x192120 -> 0x192154
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192160 -> 0x001923EC
*/
// Range: 0x192160 -> 0x1923EC
void zEntPickupInit(class _zEntPickup * ent /* r18 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x192160 -> 0x1923EC
        void * animData; // r17
        class RpAtomic * modelData; // r20
        class zAssetPickup * ptbl; // r16
        unsigned int tmpsize; // r29+0x6C
        unsigned int i; // r5
        class p2EntPickupAsset * pickupAsset; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001923F0 -> 0x001923F8
*/
// Range: 0x1923F0 -> 0x1923F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192400 -> 0x001926AC
*/
// Range: 0x192400 -> 0x1926AC
static void PickupFallPhysics(class _zEntPickup * ent /* r18 */, class _xScene * sc /* r2 */, float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x192400 -> 0x1926AC
    }
}
