/*
    Compile unit: E:\SD2\Game\flat\xFFX.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int psize; // size: 0x4, address: 0x3581CC
static class xFFX * pool; // size: 0x4, address: 0x3581D0
static class xFFX * alist; // size: 0x4, address: 0x3581D4
static unsigned int shake_psize; // size: 0x4, address: 0x3581D8
static class xFFXShakeState * shake_pool; // size: 0x4, address: 0x3581DC
static class xFFXShakeState * shake_alist; // size: 0x4, address: 0x3581E0
static unsigned int rot_match_psize; // size: 0x4, address: 0x3581E4
static class xFFXRotMatchState * rot_match_pool; // size: 0x4, address: 0x3581E8
static class xFFXRotMatchState * rot_match_alist; // size: 0x4, address: 0x3581EC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7860 -> 0x001A7888
*/
// Range: 0x1A7860 -> 0x1A7888
class xFFXRotMatchState * xFFXRotMatchAlloc() {
    /* anonymous block */ {
        // Range: 0x1A7860 -> 0x1A7888
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7890 -> 0x001A793C
*/
// Range: 0x1A7890 -> 0x1A793C
void xFFXRotMatchPoolInit(unsigned int num /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7890 -> 0x1A793C
        unsigned int i; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7940 -> 0x001A7954
*/
// Range: 0x1A7940 -> 0x1A7954
void xFFXShakeFree(class xFFXShakeState * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7940 -> 0x1A7954
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7960 -> 0x001A7988
*/
// Range: 0x1A7960 -> 0x1A7988
class xFFXShakeState * xFFXShakeAlloc() {
    /* anonymous block */ {
        // Range: 0x1A7960 -> 0x1A7988
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7990 -> 0x001A7A3C
*/
// Range: 0x1A7990 -> 0x1A7A3C
void xFFXShakePoolInit(unsigned int num /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7990 -> 0x1A7A3C
        unsigned int i; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7A40 -> 0x001A7BA8
*/
// Range: 0x1A7A40 -> 0x1A7BA8
void xFFXShakeUpdateEnt(class _xEnt * ent /* r17 */, float dt /* r29+0x40 */, void * fdata /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A7A40 -> 0x1A7BA8
        float mag; // r5
        float tnext; // r20
        class xFFXShakeState * ss; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7BB0 -> 0x001A7CAC
*/
// Range: 0x1A7BB0 -> 0x1A7CAC
void xFFXApply(class _xEnt * ent /* r19 */, class _xScene * sc /* r18 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A7BB0 -> 0x1A7CAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7CB0 -> 0x001A7DE0
*/
// Range: 0x1A7CB0 -> 0x1A7DE0
static void xFFXApplyOne(class xFFX * ffx /* r21 */, class _xEnt * ent /* r20 */, class _xScene * sc /* r19 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A7CB0 -> 0x1A7DE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7DE0 -> 0x001A7E44
*/
// Range: 0x1A7DE0 -> 0x1A7E44
signed short xFFXAddEffect(class _xEnt * ent /* r2 */, void (* dof)(class _xEnt *, class _xScene *, float, void *) /* r2 */, void * fd /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7DE0 -> 0x1A7E44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7E50 -> 0x001A7E78
*/
// Range: 0x1A7E50 -> 0x1A7E78
signed short xFFXAddEffect(class _xEnt * ent /* r2 */, class xFFX * f /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7E50 -> 0x1A7E78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7E80 -> 0x001A7E94
*/
// Range: 0x1A7E80 -> 0x1A7E94
void xFFXTurnOff(class xFFX * f /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7E80 -> 0x1A7E94
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7EA0 -> 0x001A7EB0
*/
// Range: 0x1A7EA0 -> 0x1A7EB0
void xFFXTurnOn(class xFFX * f /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7EA0 -> 0x1A7EB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7EB0 -> 0x001A7ED8
*/
// Range: 0x1A7EB0 -> 0x1A7ED8
class xFFX * xFFXAlloc() {
    /* anonymous block */ {
        // Range: 0x1A7EB0 -> 0x1A7ED8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7EE0 -> 0x001A7F70
*/
// Range: 0x1A7EE0 -> 0x1A7F70
void xFFXPoolInit(unsigned int num_ffx /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7EE0 -> 0x1A7F70
        unsigned int i; // r5
    }
