/*
    Compile unit: E:\SD2\Game\flat\xSnd.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F700 -> 0x0019F708
*/
// Range: 0x19F700 -> 0x19F708
void xSndCutsceneMode(void (* callback)(class iSndCutsceneCallbackInfo *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19F700 -> 0x19F708
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F710 -> 0x0019F718
*/
// Range: 0x19F710 -> 0x19F718
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F720 -> 0x0019F7A0
*/
// Range: 0x19F720 -> 0x19F7A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F7A0 -> 0x0019F7E0
*/
// Range: 0x19F7A0 -> 0x19F7E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F7E0 -> 0x0019F7E8
*/
// Range: 0x19F7E0 -> 0x19F7E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F7F0 -> 0x0019F7F8
*/
// Range: 0x19F7F0 -> 0x19F7F8
void xSndPause(unsigned int snd /* r2 */, unsigned int pause /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19F7F0 -> 0x19F7F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F800 -> 0x0019F808
*/
// Range: 0x19F800 -> 0x19F808
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F810 -> 0x0019F818
*/
// Range: 0x19F810 -> 0x19F818
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F820 -> 0x0019F844
*/
// Range: 0x19F820 -> 0x19F844
void xSndSetFrameFar(class _xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19F820 -> 0x19F844
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F850 -> 0x0019F8E8
*/
// Range: 0x19F850 -> 0x19F8E8
void xSndSetFrame(class _xVec3 * right /* r2 */, class _xVec3 * up /* r2 */, class _xVec3 * at /* r2 */, class _xVec3 * pos /* r2 */, float radius /* r29 */) {
    /* anonymous block */ {
        // Range: 0x19F850 -> 0x19F8E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019F8F0 -> 0x0019FA8C
*/
// Range: 0x19F8F0 -> 0x19FA8C
unsigned int xSndPlay3D(unsigned int id /* r20 */, float vol /* r22 */, float pitch /* r21 */, unsigned int priority /* r17 */, unsigned int flags /* r19 */, class _xVec3 * pos /* r18 */, float radius /* r20 */) {
    /* anonymous block */ {
        // Range: 0x19F8F0 -> 0x19FA8C
        class xSndVoiceInfo * vp; // r17
        class iSndFileInfo * ip; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FA90 -> 0x0019FC34
*/
// Range: 0x19FA90 -> 0x19FC34
unsigned int xSndPlay3D(unsigned int id /* r20 */, float vol /* r22 */, float pitch /* r21 */, unsigned int priority /* r17 */, unsigned int flags /* r19 */, class _xEnt * parent /* r18 */, float radius /* r20 */) {
    /* anonymous block */ {
        // Range: 0x19FA90 -> 0x19FC34
        class xSndVoiceInfo * vp; // r17
        class iSndFileInfo * ip; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FC40 -> 0x0019FE28
*/
// Range: 0x19FC40 -> 0x19FE28
unsigned int xSndPlay(unsigned int id /* r20 */, float volL /* r22 */, float volR /* r21 */, float pitch /* r20 */, unsigned int priority /* r17 */, unsigned int flags /* r19 */, unsigned int parentID /* r18 */) {
    /* anonymous block */ {
        // Range: 0x19FC40 -> 0x19FE28
        unsigned int sceneID; // r7
        class xSndVoiceInfo * vp; // r17
        class iSndFileInfo * ip; // r16
        unsigned int voice; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FE30 -> 0x0019FE38
*/
// Range: 0x19FE30 -> 0x19FE38
void xSndExit() {
    /* anonymous block */ {
        // Range: 0x19FE30 -> 0x19FE38
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FE40 -> 0x0019FF20
*/
// Range: 0x19FE40 -> 0x19FF20
void xSndUpdate(float time_elapsed /* r29 */) {
    /* anonymous block */ {
        // Range: 0x19FE40 -> 0x19FF20
        float a; // r3
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FF20 -> 0x0019FF7C
*/
// Range: 0x19FF20 -> 0x19FF7C
void xSndStopAll() {
    /* anonymous block */ {
        // Range: 0x19FF20 -> 0x19FF7C
        unsigned int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019FF80 -> 0x001A0024
*/
// Range: 0x19FF80 -> 0x1A0024
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0030 -> 0x001A0044
*/
// Range: 0x1A0030 -> 0x1A0044
void xSndSetFXVol(float left /* r29 */, float right /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1A0030 -> 0x1A0044
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0050 -> 0x001A0064
*/
// Range: 0x1A0050 -> 0x1A0064
void xSndSetStreamVol(float left /* r29 */, float right /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1A0050 -> 0x1A0064
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0070 -> 0x001A0084
*/
// Range: 0x1A0070 -> 0x1A0084
void xSndSetMasterVol(float left /* r29 */, float right /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1A0070 -> 0x1A0084
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0090 -> 0x001A011C
*/
// Range: 0x1A0090 -> 0x1A011C
void xSndResume() {
    /* anonymous block */ {
        // Range: 0x1A0090 -> 0x1A011C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0120 -> 0x001A0294
*/
// Range: 0x1A0120 -> 0x1A0294
void xSndSuspend() {
    /* anonymous block */ {
        // Range: 0x1A0120 -> 0x1A0294
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A02A0 -> 0x001A0354
*/
// Range: 0x1A02A0 -> 0x1A0354
void xSndInit() {
    /* anonymous block */ {
        // Range: 0x1A02A0 -> 0x1A0354
        class _xVec3 origin; // r29+0x10
        class xSndVoiceInfo * voice; // r4
        unsigned int i; // r3
    }
}
