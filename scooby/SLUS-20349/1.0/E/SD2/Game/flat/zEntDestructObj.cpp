/*
    Compile unit: E:\SD2\Game\flat\zEntDestructObj.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _zParEmitter * sEmitDust; // size: 0x4, address: 0x3581A0
class _zParEmitter * sEmitXplo; // size: 0x4, address: 0x3581A4
class _zParEmitter * sEmitWeb; // size: 0x4, address: 0x3581A8
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zEntDestructObjEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A5750
void zEntDestructObj_Update(class _zEntDestructObj *, class _xScene *, float); // size: 0x0, address: 0x1A5BB0
void zEntDextructObj_Move(class _zEntDestructObj *, class _xScene *, float, class _xEntFrame *); // size: 0x0, address: 0x1A5C60
// total size: 0x34
class RxPipeline {
    // Members
public:
...
// total size: 0x100
class _zEntDestructObj : public _zEnt {
    // Members
public:
    class zEntDestructObjAsset * dasset; // offset 0xEC, size 0x4
    unsigned int state; // offset 0xF0, size 0x4
    unsigned int healthCnt; // offset 0xF4, size 0x4
    float fx_timer; // offset 0xF8, size 0x4
    class _zParEmitter * fx_emitter; // offset 0xFC, size 0x4
};
// total size: 0xB0
...
enum _tagSDRumbleType {
    SDR_Digging = 0,
    SDR_Headbutt = 1,
    SDR_ButtbounceJump = 2,
    SDR_Buttbounce = 3,
    SDR_VillainCollideScare = 4,
    SDR_FleaScratch = 5,
    SDR_ScreechingStop = 6,
    SDR_GotScared = 7,
    SDR_WebDestroyed = 8,
    SDR_XploDestroyedObj = 9,
    SDR_DustDestroyedObj = 10,
    SDR_EventLight = 11,
    SDR_EventMedium = 12,
    SDR_EventHeavy = 13,
    SDR_Test = 14,
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5750 -> 0x001A59C4
*/
// Range: 0x1A5750 -> 0x1A59C4
signed int zEntDestructObjEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A5750 -> 0x1A59C4
        class _zEntDestructObj * s; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A59D0 -> 0x001A5AD0
*/
// Range: 0x1A59D0 -> 0x1A5AD0
void zEntDestructObj_DestroyFX(class _zEntDestructObj * o /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A59D0 -> 0x1A5AD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5AD0 -> 0x001A5AD8
*/
// Range: 0x1A5AD0 -> 0x1A5AD8
unsigned int zEntDestructObj_CheckState(class _zEntDestructObj * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A5AD0 -> 0x1A5AD8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5AE0 -> 0x001A5B1C
*/
// Range: 0x1A5AE0 -> 0x1A5B1C
void zEntDestructObj_Load(class _zEntDestructObj * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A5AE0 -> 0x1A5B1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5B20 -> 0x001A5B5C
*/
// Range: 0x1A5B20 -> 0x1A5B5C
void zEntDestructObj_Save(class _zEntDestructObj * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A5B20 -> 0x1A5B5C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5B60 -> 0x001A5B8C
*/
// Range: 0x1A5B60 -> 0x1A5B8C
unsigned int zEntDestructObj_Headbutt(class _zEntDestructObj * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A5B60 -> 0x1A5B8C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5B90 -> 0x001A5BA8
*/
// Range: 0x1A5B90 -> 0x1A5BA8
unsigned int zEntDestructObj_ButtBounce(class _zEntDestructObj * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A5B90 -> 0x1A5BA8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5BB0 -> 0x001A5C60
*/
// Range: 0x1A5BB0 -> 0x1A5C60
void zEntDestructObj_Update(class _zEntDestructObj * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A5BB0 -> 0x1A5C60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5C60 -> 0x001A5C68
*/
// Range: 0x1A5C60 -> 0x1A5C68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5C70 -> 0x001A5D48
*/
// Range: 0x1A5C70 -> 0x1A5D48
void zEntDestructObj_Init(class _zEntDestructObj * ent /* r16 */, class p2EntAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A5C70 -> 0x1A5D48
        class zEntDestructObjAsset * dasset; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5D50 -> 0x001A5D58
*/
// Range: 0x1A5D50 -> 0x1A5D58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A5D60 -> 0x001A5DA4
*/
// Range: 0x1A5D60 -> 0x1A5DA4
