/*
    Compile unit: E:\SD2\Game\flat\zEntTrigger.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed int zEntTriggerEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x18E860
void zEntTriggerUpdate(class zEntTrigger *, class _xScene *, float); // size: 0x0, address: 0x18E890
// total size: 0x40
class RwMatrixTag {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018E840 -> 0x0018E848
*/
// Range: 0x18E840 -> 0x18E848
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018E850 -> 0x0018E858
*/
// Range: 0x18E850 -> 0x18E858
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018E860 -> 0x0018E890
*/
// Range: 0x18E860 -> 0x18E890
signed int zEntTriggerEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18E860 -> 0x18E890
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018E890 -> 0x0018EBD0
*/
// Range: 0x18E890 -> 0x18EBD0
void zEntTriggerUpdate(class zEntTrigger * trig /* r20 */) {
    /* anonymous block */ {
        // Range: 0x18E890 -> 0x18EBD0
        class _xIsect isect; // r29+0x150
        class _xSphere sphere; // r29+0x140
        class _xIsect isect; // r29+0x110
        class _xCylinder cylinder; // r29+0xF0
        class _xIsect isect; // r29+0xC0
        class _xSphere sphere; // r29+0xB0
        class _xBox box; // r29+0x90
        class _xVec3 * chkPos; // r2
        class _xEnt * chkEnt; // r2
        signed int collide; // r19
        class _xIsect isect; // r29+0x60
        class p2EntTriggerAsset * tasset; // r18
        class p2LinkAsset * link; // r17
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018EBD0 -> 0x0018EC38
*/
// Range: 0x18EBD0 -> 0x18EC38
void zEntTriggerInit(void * ent /* r16 */, void * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18EBD0 -> 0x18EC38
    }
}
