/*
    Compile unit: E:\SD2\Game\flat\zEGenerator.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
void zEGenerator_Render(class zEGenerator *); // size: 0x0, address: 0x1D90B0
signed int zEGeneratorEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1D8A30
void zEGenerator_Update(class zEGenerator *, class _xScene *, float); // size: 0x0, address: 0x1D90C0
// total size: 0x190
class RwCamera {
    // Members
public:
...
// total size: 0x68
class zEGenAsset : public p2EntAsset {
    // Members
public:
    class _xVec3 src_dpos; // offset 0x50, size 0xC
...
public:
    ...
    class _xVec3 * start; // offset 0x10, size 0x4
    class _xVec3 * end; // offset 0x14, size 0x4
    signed int total_points; // offset 0x18, size 0x4
    ...
    unsigned char alpha_pad; // offset 0x2B, size 0x1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D8A30 -> 0x001D8BFC
*/
// Range: 0x1D8A30 -> 0x1D8BFC
signed int zEGeneratorEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D8A30 -> 0x1D8BFC
        class zEGenerator * egen; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D8C00 -> 0x001D8C7C
*/
// Range: 0x1D8C00 -> 0x1D8C7C
void zEGenerator_TurnOff(class zEGenerator * egen /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D8C00 -> 0x1D8C7C
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D8C80 -> 0x001D90A4
*/
// Range: 0x1D8C80 -> 0x1D90A4
void zEGenerator_TurnOn(class zEGenerator * egen /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1D8C80 -> 0x1D90A4
        class _tagLightningAdd add; // r29+0xA0
        signed int i; // r16
        class xBase * b; // r19
        class p2LinkAsset * link; // r18
        signed int i; // r17
        unsigned short imp; // r16
        unsigned short itgt; // r2
        class zEGenAsset * zasset; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D90B0 -> 0x001D90B8
*/
// Range: 0x1D90B0 -> 0x1D90B8
void zEGenerator_Render(class zEGenerator * egen /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D90B0 -> 0x1D90B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D90C0 -> 0x001D91F8
*/
// Range: 0x1D90C0 -> 0x1D91F8
void zEGenerator_Update(class zEGenerator * egen /* r16 */, class _xScene * sc /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D90C0 -> 0x1D91F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D9200 -> 0x001D92D0
*/
// Range: 0x1D9200 -> 0x1D92D0
void zEGenerator_Reset(class zEGenerator * egen /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1D9200 -> 0x1D92D0
        class zEGenAsset * zasset; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D92D0 -> 0x001D92D8
*/
// Range: 0x1D92D0 -> 0x1D92D8
void zEGenerator_Load(class zEGenerator * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D92D0 -> 0x1D92D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D92E0 -> 0x001D92E8
*/
// Range: 0x1D92E0 -> 0x1D92E8
void zEGenerator_Save(class zEGenerator * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D92E0 -> 0x1D92E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D92F0 -> 0x001D93B4
*/
// Range: 0x1D92F0 -> 0x1D93B4
void zEGenerator_Setup(class zEGenerator * egen /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1D92F0 -> 0x1D93B4
        class xBase * b; // r2
        class p2LinkAsset * la; // r19
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D93C0 -> 0x001D94E8
*/
// Range: 0x1D93C0 -> 0x1D94E8
void zEGenerator_Init(class zEGenerator * egen /* r17 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D93C0 -> 0x1D94E8
        unsigned int size; // r29+0x3C
        void * buf; // r2
        class zEGenAsset * zasset; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D94F0 -> 0x001D94F8
*/
// Range: 0x1D94F0 -> 0x1D94F8
void zEGenerator_Init(void * egen /* r2 */, void * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D94F0 -> 0x1D94F8
    }
}
