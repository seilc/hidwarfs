/*
    Compile unit: E:\SD2\Game\flat\zPlatform.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _zParEmitter * sEmitTremble; // size: 0x4, address: 0x3580D0
static class _zParEmitter * sEmitBreakaway; // size: 0x4, address: 0x3580D4
class zGlobals globals; // size: 0x3330, address: 0x362FD0
void xFFXShakeUpdateEnt(class _xEnt *, class _xScene *, float, void *); // size: 0x0, address: 0x1A7A40
class _xVec3 g_O3; // size: 0xC, address: 0x342E28
unsigned int gActiveHeap; // size: 0x4, address: 0x357CAC
void zPlatformTranslate(class _xEnt *, class _xVec3 *); // size: 0x0, address: 0x196620
signed int zPlatformEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1962D0
void zPlatform_Move(class _xEnt *, class _xScene *, float, class _xEntFrame *); // size: 0x0, address: 0x196910
void zPlatform_Update(class _xEnt *, class _xScene *, float); // size: 0x0, address: 0x196920
// total size: 0x10
...
class xFFXShakeState {
    // Members
public:
    class _xVec3 disp; // offset 0x0, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001962D0 -> 0x00196614
*/
// Range: 0x1962D0 -> 0x196614
signed int zPlatformEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1962D0 -> 0x196614
        class _zPlatform * plat; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196620 -> 0x0019665C
*/
// Range: 0x196620 -> 0x19665C
static void zPlatformTranslate(class _xEnt * xent /* r2 */, class _xVec3 * dpos /* r17 */) {
    /* anonymous block */ {
        // Range: 0x196620 -> 0x19665C
        class _zPlatform * plat; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196660 -> 0x00196684
*/
// Range: 0x196660 -> 0x196684
void zPlatform_MakeDiggable(class _zPlatform * plat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x196660 -> 0x196684
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196690 -> 0x00196698
*/
// Range: 0x196690 -> 0x196698
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001966A0 -> 0x00196704
*/
// Range: 0x1966A0 -> 0x196704
void zPlatform_Mount(class _zPlatform * plat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1966A0 -> 0x196704
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196710 -> 0x00196844
*/
// Range: 0x196710 -> 0x196844
static void zPlatform_Tremble(class _zPlatform * plat /* r17 */, float ampl /* r22 */, float freq /* r21 */, float dur /* r20 */) {
    /* anonymous block */ {
        // Range: 0x196710 -> 0x196844
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196850 -> 0x0019690C
*/
// Range: 0x196850 -> 0x19690C
void zPlatform_Shake(class _zPlatform * plat /* r17 */, float ampl /* r21 */, float freq /* r20 */) {
    /* anonymous block */ {
        // Range: 0x196850 -> 0x19690C
        class xFFX * sfkt; // r2
        class xFFXShakeState * ss; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196910 -> 0x00196918
*/
// Range: 0x196910 -> 0x196918
void zPlatform_Move(class _xEnt * entplat /* r2 */, class _xScene * s /* r2 */, float dt /* r29 */, class _xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x196910 -> 0x196918
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196920 -> 0x00197200
*/
// Range: 0x196920 -> 0x197200
void zPlatform_Update(class _xEnt * entplat /* r2 */, class _xScene * sc /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x196920 -> 0x197200
        class _xVec3 * rot; // r8
        class _xVec3 * orot; // r7
        class _xVec3 * pos; // r6
        class _xVec3 * opos; // r5
        signed int moving; // r17
        class _xMovePoint * src; // r17
        class _xVec3 * scale; // r2
        float tangle; // r29+0xC0
        float mangle; // r21
        float dangle; // r20
        float cangle; // r21
        class _xVec3 lpos; // r29+0xB0
        class _xVec3 * scale; // r2
        float dtilt; // r29+0xC0
        float itilt; // r22
        float ctilt; // r21
        class _xEntDrive * drv; // r3
        class _xEnt * p; // r6
        class _xEntDrive * drv; // r4
        class p2EntMotionMechData * mkasst; // r4
        unsigned short state; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197200 -> 0x00197324
*/
// Range: 0x197200 -> 0x197324
void zPlatform_Reset(class _zPlatform * plat /* r16 */, class _xScene * sc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x197200 -> 0x197324
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197330 -> 0x00197338
*/
// Range: 0x197330 -> 0x197338
void zPlatform_Load(class _zPlatform * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x197330 -> 0x197338
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197340 -> 0x00197348
*/
// Range: 0x197340 -> 0x197348
void zPlatform_Save(class _zPlatform * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x197340 -> 0x197348
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197350 -> 0x001973AC
*/
// Range: 0x197350 -> 0x1973AC
void zPlatform_Setup(class _zPlatform * plat /* r17 */, class _xScene * sc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x197350 -> 0x1973AC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001973B0 -> 0x00197590
*/
// Range: 0x1973B0 -> 0x197590
void zPlatform_Init(class _zPlatform * plat /* r18 */, class p2EntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1973B0 -> 0x197590
        class xAnimFile * afile; // r16
        unsigned int size; // r29+0x4C
        void * buf; // r2
        unsigned int size; // r29+0x48
        void * buf; // r2
        class p2EntMotionAsset * emasset; // r17
        class p2PlatformAsset * passet; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00197590 -> 0x00197598
*/
// Range: 0x197590 -> 0x197598
