/*
    Compile unit: E:\SD2\Game\flat\zCutsceneMgr.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class zCutsceneZbufferHack zhacktable[5]; // size: 0x154, address: 0x2B5380
static class zCutsceneBoundHack boundHackTable[12]; // size: 0x60, address: 0x2B54E0
static class zCutSceneNames zCutSceneNamesTable[14]; // size: 0x3F0, address: 0x2B5540
static signed int gCutsceneSkipOK; // size: 0x4, address: 0x35841C
class zGlobals globals; // size: 0x3330, address: 0x362FD0
class RpAtomic * HackBoundCB(class RpAtomic *, void *); // size: 0x0, address: 0x1D7F50
signed int zCutsceneMgrEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1D7BD0
// total size: 0x13C
class zPlayerStatic {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7700 -> 0x001D7724
*/
// Range: 0x1D7700 -> 0x1D7724
unsigned int zCutSceneNamesTable_getStatus(unsigned int number /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D7700 -> 0x1D7724
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7730 -> 0x001D7A6C
*/
// Range: 0x1D7730 -> 0x1D7A6C
void zCutsceneMgrUpdate(class xBase * to /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D7730 -> 0x1D7A6C
        signed int i; // r17
        signed int pauseValue; // r17
        class _zCutsceneMgr * t; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7A70 -> 0x001D7B40
*/
// Range: 0x1D7A70 -> 0x1D7B40
static void zCutsceneMgrUpdateFX(class _zCutsceneMgr * t /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D7A70 -> 0x1D7B40
        class _zParEmitter * e; // r2
        signed int i; // r17
        class xCutscene * csn; // r16
        class zCutsceneMgrAsset * a; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7B40 -> 0x001D7BC8
*/
// Range: 0x1D7B40 -> 0x1D7BC8
void zCutsceneMgrFinishLoad(class xBase * to /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D7B40 -> 0x1D7BC8
        class _zCutsceneMgr * t; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7BD0 -> 0x001D7ED0
*/
// Range: 0x1D7BD0 -> 0x1D7ED0
signed int zCutsceneMgrEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D7BD0 -> 0x1D7ED0
        signed int i; // r17
        unsigned int hackid; // r19
        unsigned int j; // r18
        unsigned int i; // r17
        unsigned int i; // r17
        signed int i; // r17
        class _zCutsceneMgr * t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7ED0 -> 0x001D7F48
*/
// Range: 0x1D7ED0 -> 0x1D7F48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7F50 -> 0x001D7F78
*/
// Range: 0x1D7F50 -> 0x1D7F78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7F80 -> 0x001D7FDC
*/
// Range: 0x1D7F80 -> 0x1D7FDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7FE0 -> 0x001D8064
*/
// Range: 0x1D7FE0 -> 0x1D8064
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D8070 -> 0x001D80D4
*/
// Range: 0x1D8070 -> 0x1D80D4
