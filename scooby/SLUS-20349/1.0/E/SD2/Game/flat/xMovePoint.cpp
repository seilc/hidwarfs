/*
    Compile unit: E:\SD2\Game\flat\xMovePoint.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0450 -> 0x001A0458
*/
// Range: 0x1A0450 -> 0x1A0458
class _xVec3 * xMovePointGetPos(class _xMovePoint * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0450 -> 0x1A0458
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0460 -> 0x001A05E4
*/
// Range: 0x1A0460 -> 0x1A05E4
float xMovePointGetNext(class _xMovePoint * m /* r20 */, class _xMovePoint * prev /* r19 */, class _xMovePoint * * next /* r18 */, class _xVec3 * hdng /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A0460 -> 0x1A05E4
        class _xMovePoint * previousOption; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A05F0 -> 0x001A0608
*/
// Range: 0x1A05F0 -> 0x1A0608
void xMovePointSplineDestroy(class _xMovePoint * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A05F0 -> 0x1A0608
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0610 -> 0x001A07F4
*/
// Range: 0x1A0610 -> 0x1A07F4
void xMovePointSplineSetup(class _xMovePoint * m /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A0610 -> 0x1A07F4
        class _xVec3 p2; // r29+0x50
        class _xVec3 p1; // r29+0x40
        class _xVec3 points[2]; // r29+0x20
        class _xMovePoint * w3; // r2
        class _xMovePoint * w2; // r6
        class _xMovePoint * w0; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0800 -> 0x001A08D0
*/
// Range: 0x1A0800 -> 0x1A08D0
void xMovePointSetup(class _xMovePoint * m /* r20 */, class _xScene * sc /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1A0800 -> 0x1A08D0
        unsigned short idx; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A08D0 -> 0x001A0910
*/
// Range: 0x1A08D0 -> 0x1A0910
void xMovePointReset(class _xMovePoint * m /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A08D0 -> 0x1A0910
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0910 -> 0x001A0918
*/
// Range: 0x1A0910 -> 0x1A0918
void xMovePointLoad(class _xMovePoint * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0910 -> 0x1A0918
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0920 -> 0x001A0928
*/
// Range: 0x1A0920 -> 0x1A0928
void xMovePointSave(class _xMovePoint * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0920 -> 0x1A0928
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0930 -> 0x001A09B4
*/
// Range: 0x1A0930 -> 0x1A09B4
void xMovePointInit(class _xMovePoint * m /* r16 */, class p2MovePointAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A0930 -> 0x1A09B4
    }
}
