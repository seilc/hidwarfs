/*
    Compile unit: E:\SD2\Game\flat\zHologram.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _tagHologram * sHologram[16]; // size: 0x40, address: 0x3B06F0
static class _HoloBurst cHologramColBurst[23]; // size: 0x170, address: 0x354850
...
public:
    ...
    class _xEnt * ent; // offset 0x4, size 0x4
    float src_r; // offset 0x8, size 0x4
    float src_g; // offset 0xC, size 0x4
    float src_b; // offset 0x10, size 0x4
    float time_passed; // offset 0x14, size 0x4
    signed int cur_burst; // offset 0x18, size 0x4
    signed int alpha_max; // offset 0x1C, size 0x4
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A250 -> 0x0024A2C0
*/
// Range: 0x24A250 -> 0x24A2C0
void zHologramUpdate(float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x24A250 -> 0x24A2C0
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A2C0 -> 0x0024A3C0
*/
// Range: 0x24A2C0 -> 0x24A3C0
static void UpdateHologram(class _tagHologram * h /* r2 */, float seconds /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x24A2C0 -> 0x24A3C0
        float bset; // r29+0x10
        float gset; // r29+0x10
        float rset; // r29+0x10
        class _HoloBurst * burst; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A3C0 -> 0x0024A49C
*/
// Range: 0x24A3C0 -> 0x24A49C
void zHologramAdd(class _xEnt * ent /* r18 */) {
    /* anonymous block */ {
        // Range: 0x24A3C0 -> 0x24A49C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A4A0 -> 0x0024A4E4
*/
// Range: 0x24A4A0 -> 0x24A4E4
void zHologramInit() {
    /* anonymous block */ {
        // Range: 0x24A4A0 -> 0x24A4E4
        signed int i; // r4
