/*
    Compile unit: E:\SD2\Game\flat\zScene.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int roomCnt; // size: 0x4, address: 0x357DEC
static signed int bytesNeeded; // size: 0x4, address: 0x357DF0
static signed int availOnDisk; // size: 0x4, address: 0x357DF4
static signed int sMemDepthSceneStart; // size: 0x4, address: 0x3574E0
static class zSceneLevel sLevelTable[13]; // size: 0xD0, address: 0x28FAC0
static class zSceneArea sAreaTable[30]; // size: 0x438, address: 0x28FB90
static class zSceneObjectInstanceDesc sInitTable[34]; // size: 0x330, address: 0x28FFD0
class _tagClimate gClimate; // size: 0x24, address: 0x36A4F0
class _zEnv * gCurEnv; // size: 0x4, address: 0x357DF8
unsigned int gTransitionSceneID; // size: 0x4, address: 0x357DFC
float gSceneUpdateTime; // size: 0x4, address: 0x357E0C
static class IDBasePair * scobj_idbps; // size: 0x4, address: 0x357E18
static signed int scobj_size; // size: 0x4, address: 0x3574EC
static signed int nidbps; // size: 0x4, address: 0x3574F0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zSceneCalcProgress_serialTraverseCB(unsigned int, class xSerial *); // size: 0x0, address: 0x132B70
...
signed int zSceneSetup_serialTraverseCB(unsigned int, class xSerial *); // size: 0x0, address: 0x134760
signed int gOccludeCount; // size: 0x4, address: 0x3581C4
class _xScene * g_xSceneCur; // size: 0x4, address: 0x357D6C
char * zSceneGetName(class xBase *); // size: 0x0, address: 0x1336B0
char * zSceneGetName(unsigned int); // size: 0x0, address: 0x1336F0
class xBase * zSceneFindObject(unsigned int); // size: 0x0, address: 0x1337D0
// total size: 0x1C
class RpMaterial {
    // Members
public:
...
public:
    ...
    class _zParEmitter * rain_emitter; // offset 0x8, size 0x4
    class _zParEmitter * snow_emitter; // offset 0xC, size 0x4
};
// total size: 0x28
...
class _zEnv : public xBase {
    // Members
public:
    class p2EnvAsset * easset; // offset 0x10, size 0x4
};
enum _tagRumbleType {
    eRumble_Off = 0,
...
public:
    ...
    class _xVec3 dir; // offset 0x8, size 0xC
};
// total size: 0x18
...
public:
    ...
    char name; // offset 0x4, size 0x1
    signed int index; // offset 0x8, size 0x4
    unsigned int totalClues; // offset 0xC, size 0x4
};
// total size: 0x8
class _tagEmitRect {
    // Members
...
// total size: 0x40
class p2EnvAsset : public p2BaseAsset {
    // Members
public:
    ...
    float padF1; // offset 0x1C, size 0x4
    float padF2; // offset 0x20, size 0x4
    float padF3; // offset 0x24, size 0x4
...
public:
    char * desc; // offset 0x0, size 0x4
    enum _tagSceneAreas index; // offset 0x4, size 0x4
    unsigned int totalSnacks; // offset 0x8, size 0x4
    unsigned int constTotalSnacks; // offset 0xC, size 0x4
    unsigned int totalMTokens; // offset 0x10, size 0x4
    unsigned int sceneIDs[4]; // offset 0x14, size 0x10
};
// total size: 0x50
class xCutsceneInfo {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132A90 -> 0x00132B38
*/
// Range: 0x132A90 -> 0x132B38
void zSceneStats_Clear() {
    /* anonymous block */ {
        // Range: 0x132A90 -> 0x132B38
        unsigned int i; // r4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132B40 -> 0x00132B4C
*/
// Range: 0x132B40 -> 0x132B4C
void zSceneCardCheckStartup_set(signed int needed /* r2 */, signed int available /* r2 */) {
    /* anonymous block */ {
        // Range: 0x132B40 -> 0x132B4C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132B50 -> 0x00132B64
*/
// Range: 0x132B50 -> 0x132B64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132B70 -> 0x00132BBC
*/
// Range: 0x132B70 -> 0x132BBC
signed int zSceneCalcProgress_serialTraverseCB(unsigned int clientID /* r2 */, class xSerial * xser /* r2 */) {
    /* anonymous block */ {
        // Range: 0x132B70 -> 0x132BBC
        signed int val; // r29+0x1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132BC0 -> 0x00132E40
*/
// Range: 0x132BC0 -> 0x132E40
unsigned int zSceneCalcProgress() {
    /* anonymous block */ {
        // Range: 0x132BC0 -> 0x132E40
        unsigned int totals; // r2
        signed int i; // r5
        signed int i; // r4
        unsigned int killedHolly; // r19
        float mtokPercent; // r23
        unsigned int mtokCnt; // r18
        float snackPercent; // r22
        unsigned int snackCnt; // r17
        float roomPercent; // r21
        unsigned int pupCnt; // r16
        float pupPercent; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132E40 -> 0x00132E74
*/
// Range: 0x132E40 -> 0x132E74
signed int zRayHitsPlayer(class _xRay3 * r /* r2 */) {
    /* anonymous block */ {
        // Range: 0x132E40 -> 0x132E74
        class _xCollis c; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132E80 -> 0x00132F78
*/
// Range: 0x132E80 -> 0x132F78
void zSceneGameStats_Init() {
    /* anonymous block */ {
        // Range: 0x132E80 -> 0x132F78
        signed int i; // r4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132F80 -> 0x00133048
*/
// Range: 0x132F80 -> 0x133048
void zSceneGameStatsTally_clue() {
    /* anonymous block */ {
        // Range: 0x132F80 -> 0x133048
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133050 -> 0x00133074
*/
// Range: 0x133050 -> 0x133074
void zSceneGameStatsTally_death() {
    /* anonymous block */ {
        // Range: 0x133050 -> 0x133074
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133080 -> 0x001330A4
*/
// Range: 0x133080 -> 0x1330A4
void zSceneGameStatsTally_scare() {
    /* anonymous block */ {
        // Range: 0x133080 -> 0x1330A4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001330B0 -> 0x00133140
*/
// Range: 0x1330B0 -> 0x133140
void zSceneGameStatsTally_token() {
    /* anonymous block */ {
        // Range: 0x1330B0 -> 0x133140
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133140 -> 0x001331D0
*/
// Range: 0x133140 -> 0x1331D0
void zSceneGameStatsTally_snack(unsigned int amount /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133140 -> 0x1331D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001331D0 -> 0x00133268
*/
// Range: 0x1331D0 -> 0x133268
unsigned int zSceneGetAreaTokensCollected(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1331D0 -> 0x133268
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133270 -> 0x00133310
*/
// Range: 0x133270 -> 0x133310
unsigned int zSceneGetAreaSnacksCollected(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133270 -> 0x133310
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133310 -> 0x00133374
*/
// Range: 0x133310 -> 0x133374
unsigned int zSceneGetAreaTotalTokens(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133310 -> 0x133374
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133380 -> 0x001333A0
*/
// Range: 0x133380 -> 0x1333A0
unsigned int zSceneGetAreaTotalSnacks(enum _tagSceneAreas scene /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133380 -> 0x1333A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001333A0 -> 0x00133404
*/
// Range: 0x1333A0 -> 0x133404
unsigned int zSceneGetAreaTotalSnacks(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1333A0 -> 0x133404
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133410 -> 0x00133474
*/
// Range: 0x133410 -> 0x133474
unsigned int zSceneGetAreaConstTotalSnacks(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133410 -> 0x133474
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133480 -> 0x0013351C
*/
// Range: 0x133480 -> 0x13351C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133520 -> 0x00133574
*/
// Range: 0x133520 -> 0x133574
unsigned int zSceneGetRoominArea(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133520 -> 0x133574
        unsigned int j; // r2
        unsigned int i; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133580 -> 0x001335D4
*/
// Range: 0x133580 -> 0x1335D4
unsigned int zSceneGetArea(unsigned int sceneID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133580 -> 0x1335D4
        unsigned int j; // r5
        unsigned int i; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001335E0 -> 0x001335E8
*/
// Range: 0x1335E0 -> 0x1335E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001335F0 -> 0x001336AC
*/
// Range: 0x1335F0 -> 0x1336AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001336B0 -> 0x001336E8
*/
// Range: 0x1336B0 -> 0x1336E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001336F0 -> 0x00133748
*/
// Range: 0x1336F0 -> 0x133748
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133750 -> 0x001337CC
*/
// Range: 0x133750 -> 0x1337CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001337D0 -> 0x00133840
*/
// Range: 0x1337D0 -> 0x133840
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133840 -> 0x001338B0
*/
// Range: 0x133840 -> 0x1338B0
static class xBase * zSceneObjHashtableGet(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x133840 -> 0x1338B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001338B0 -> 0x0013391C
*/
// Range: 0x1338B0 -> 0x13391C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00133920 -> 0x00134184
*/
// Range: 0x133920 -> 0x134184
void zSceneRender() {
    /* anonymous block */ {
        // Range: 0x133920 -> 0x134184
        char strn[256]; // r29+0x3A0
        char str[256]; // r29+0x2A0
        signed int available; // r18
        class xFontBox * sTrcFullCardFontBox2; // r17
        class xFontBox * sTrcFullCardFontBox; // r16
        enum eGameMode mode; // r2
        class _xEnt * ent; // r18
        signed int i; // r2
        class zParSys * psys; // r18
        class _xEnt * swap_e; // r5
        signed int index2; // r4
        signed int i; // r17
        class _xVec3 centre; // r29+0x4A8
        class _xEnt * ent; // r19
        unsigned int tide_hash; // r22
        class _xEnt * tide_ent; // r23
        class _xEnt * * entlast; // r21
        class _xEnt * * entptr; // r18
        signed int index; // r3
        unsigned int shadowHackCase; // r30
        class _xVec3 * camera_pos; // r17
        signed int sorted_entities; // r29+0x4B8
        float distance[64]; // r29+0x1A0
        class _xEnt * entities[64]; // r29+0xA0
        class _xScene * sc; // r16
        class zScene * s; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134190 -> 0x001342C4
*/
// Range: 0x134190 -> 0x1342C4
static void zShadowReceivers() {
    /* anonymous block */ {
        // Range: 0x134190 -> 0x1342C4
        class _xScene * sc; // r18
        class _xEnt * ep; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001342D0 -> 0x0013475C
*/
// Range: 0x1342D0 -> 0x13475C
void zSceneUpdate(float elapsedSec /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1342D0 -> 0x13475C
        signed int timer; // r6
        char str[32]; // r29+0xC0
        signed int timer; // r18
        class xBase * * b; // r2
        class zScene * s; // r17
        signed int isPaused; // r16
        signed int i; // r18
        unsigned int sUITimers[10]; // @ 0x0036A520
        unsigned int init; // @ 0x00357E10
        signed char init; // @ 0x00357E14
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134760 -> 0x00134800
*/
// Range: 0x134760 -> 0x134800
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134800 -> 0x00134BC4
*/
// Range: 0x134800 -> 0x134BC4
void zSceneSetup() {
    /* anonymous block */ {
        // Range: 0x134800 -> 0x134BC4
        class iColor_tag clear; // r29+0xAC
        class iColor_tag black; // r29+0xA8
        signed int i; // r17
        unsigned int dontcaresize; // r29+0xA4
        signed int i; // r17
        class zScene * s; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134BD0 -> 0x00134F48
*/
// Range: 0x134BD0 -> 0x134F48
void zSceneReset() {
    /* anonymous block */ {
        // Range: 0x134BD0 -> 0x134F48
        class _tagxCam * cam; // r2
        class _zEnv * env; // r19
        signed int i; // r18
        class zScene * s; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00134F50 -> 0x00135404
*/
// Range: 0x134F50 -> 0x135404
void zSceneLoad(class zScene * ent /* r17 */, class xSerial * s /* r19 */) {
    /* anonymous block */ {
        // Range: 0x134F50 -> 0x135404
        class xBase * b; // r2
        unsigned short i; // r16
        signed int wpset; // r29+0x8C
        signed int i; // r18
        signed int sceneExist; // r29+0x88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135410 -> 0x00135844
*/
// Range: 0x135410 -> 0x135844
void zSceneSave(class zScene * ent /* r16 */, class xSerial * s /* r19 */) {
    /* anonymous block */ {
        // Range: 0x135410 -> 0x135844
        class xBase * b; // r2
        class xSerial xser; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135850 -> 0x0013596C
*/
// Range: 0x135850 -> 0x13596C
void zSceneSwitch(class _zPortal * p /* r2 */) {
    /* anonymous block */ {
        // Range: 0x135850 -> 0x13596C
        class p2MarkerAsset * m; // r2
        unsigned int size; // r29+0x4C
        class _tagxCam * cam; // r2
        unsigned int PlayerMarkerStartCamID; // r18
        unsigned int PlayerMarkerStartID; // r17
        char * id; // r2
        class zPortalAsset * passet; // r8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135970 -> 0x00135B8C
*/
// Range: 0x135970 -> 0x135B8C
void zSceneExit() {
    /* anonymous block */ {
        // Range: 0x135970 -> 0x135B8C
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00135B90 -> 0x001360C0
*/
// Range: 0x135B90 -> 0x1360C0
void zSceneInit(unsigned int theSceneID /* r19 */) {
    /* anonymous block */ {
        // Range: 0x135B90 -> 0x1360C0
        signed int idx; // r16
        class zProjectileTypeAsset * tmp_ptass; // r2
        signed int projectile_count; // r17
        unsigned int base_idx; // r2
        unsigned int typeCount; // r2
        char b[5]; // r29+0x70
        unsigned char rgba_bkgrd[4]; // r29+0x7C
        signed int i; // r3
        class zScene * s; // r16
        float pdone; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001360C0 -> 0x001361C4
*/
// Range: 0x1360C0 -> 0x1361C4
static unsigned int zSceneInitFunc_Dispatcher(class zScene * s /* r19 */, class zSceneObjectInstanceDesc * desc /* r18 */, unsigned int base_idx /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1360C0 -> 0x1361C4
        class p2EntAsset * asset; // r2
        class xBase * b; // r19
        signed int idx; // r18
        class st_ZDISPATCH_DATA * dpat_pool; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001361D0 -> 0x001362D4
*/
// Range: 0x1361D0 -> 0x1362D4
static unsigned int zSceneInitFunc_LobMaster(class zScene * s /* r19 */, class zSceneObjectInstanceDesc * desc /* r18 */, unsigned int base_idx /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1361D0 -> 0x1362D4
        class p2EntAsset * asset; // r2
        class xBase * b; // r19
        signed int idx; // r18
        class st_LOBMASTER_DATA * lm_pool; // r17
        signed int count; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001362E0 -> 0x001363C8
*/
// Range: 0x1362E0 -> 0x1363C8
static unsigned int zSceneInitFunc_Volume(class zScene * s /* r18 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1362E0 -> 0x1363C8
        class xBase * b; // r18
        signed int idx; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001363D0 -> 0x001364A4
*/
// Range: 0x1363D0 -> 0x1364A4
static unsigned int zSceneInitFunc_Gust(class zScene * s /* r18 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1363D0 -> 0x1364A4
        class xBase * b; // r2
        signed int idx; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001364B0 -> 0x00136584
*/
// Range: 0x1364B0 -> 0x136584
static unsigned int zSceneInitFunc_Surface(class zScene * s /* r18 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1364B0 -> 0x136584
        class xBase * b; // r2
        signed int idx; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136590 -> 0x001366A4
*/
// Range: 0x136590 -> 0x1366A4
static unsigned int zSceneInitFunc_Camera(class zScene * s /* r18 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r22 */) {
    /* anonymous block */ {
        // Range: 0x136590 -> 0x1366A4
        class xCamAsset * assetCam; // r18
        class xBase * b; // r2
        signed int idx; // r17
        class _tagxCam * camBlock; // r2
        signed int count; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001366B0 -> 0x001367D4
*/
// Range: 0x1366B0 -> 0x1367D4
static unsigned int zSceneInitFunc_Player(class zScene * s /* r17 */, class zSceneObjectInstanceDesc * desc /* r19 */, unsigned int base_idx /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1366B0 -> 0x1367D4
        class p2EntAsset * asset; // r2
        class xBase * b; // r20
        signed int idx; // r19
        class _zEnt * entBlock; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001367E0 -> 0x001368F4
*/
// Range: 0x1367E0 -> 0x1368F4
static unsigned int zSceneInitFunc_Villain(class zScene * s /* r22 */, class zSceneObjectInstanceDesc * desc /* r16 */, unsigned int base_idx /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1367E0 -> 0x1368F4
        class p2EntAsset * asset; // r2
        class _zEnt * b; // r17
        unsigned int idx; // r16
        class st_zEntVillain * villainBlock; // r2
        signed int count; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136900 -> 0x00136A14
*/
// Range: 0x136900 -> 0x136A14
static unsigned int zSceneInitFunc_MovePoint(class zScene * s /* r19 */, class zSceneObjectInstanceDesc * desc /* r18 */, unsigned int base_idx /* r16 */) {
    /* anonymous block */ {
        // Range: 0x136900 -> 0x136A14
        class p2BaseAsset * basset; // r20
        class xBase * b; // r19
        signed int idx; // r18
        class _zMovePoint * movpBlock; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136A20 -> 0x00136B44
*/
// Range: 0x136A20 -> 0x136B44
static unsigned int zSceneInitFunc_Default(class zScene * s /* r19 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r16 */) {
    /* anonymous block */ {
        // Range: 0x136A20 -> 0x136B44
        void * asset; // r2
        signed int i; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00136B50 -> 0x00136C94
*/
// Range: 0x136B50 -> 0x136C94
static unsigned int zSceneInitFunc_DefaultEnt(class zScene * s /* r18 */, class zSceneObjectInstanceDesc * desc /* r17 */, unsigned int base_idx /* r16 */) {
    /* anonymous block */ {
        ...
        unsigned int assetSize; // r29+0xBC
        signed int count; // r22
