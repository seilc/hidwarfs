/*
    Compile unit: E:\SD2\Game\flat\zPendulum.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
void zPendulumTranslate(class _xEnt *, class _xVec3 *); // size: 0x0, address: 0x1A0D30
signed int zPendulumEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A0BE0
void zPendulum_Move(class _zPendulum *, class _xScene *, float, class _xEntFrame *); // size: 0x0, address: 0x1A0D70
void zPendulum_Update(class _zPendulum *, class _xScene *, float); // size: 0x0, address: 0x1A0D80
// total size: 0xF0
class _xEntFrame {
    // Members
public:
...
// total size: 0x180
class _zPendulum : public _zEnt {
    // Members
public:
    class _xEntMotion motion; // offset 0xF0, size 0x80
    float lt; // offset 0x170, size 0x4
    float q1t; // offset 0x174, size 0x4
    float q3t; // offset 0x178, size 0x4
};
// total size: 0x18
class _xEntShadow {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0BE0 -> 0x001A0D2C
*/
// Range: 0x1A0BE0 -> 0x1A0D2C
signed int zPendulumEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0BE0 -> 0x1A0D2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0D30 -> 0x001A0D6C
*/
// Range: 0x1A0D30 -> 0x1A0D6C
static void zPendulumTranslate(class _xEnt * xent /* r2 */, class _xVec3 * dpos /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A0D30 -> 0x1A0D6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0D70 -> 0x001A0D78
*/
// Range: 0x1A0D70 -> 0x1A0D78
void zPendulum_Move(class _zPendulum * pend /* r2 */, class _xScene * s /* r2 */, float dt /* r29 */, class _xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0D70 -> 0x1A0D78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0D80 -> 0x001A0E30
*/
// Range: 0x1A0D80 -> 0x1A0E30
void zPendulum_Update(class _zPendulum * pend /* r16 */, class _xScene * sc /* r2 */, float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x1A0D80 -> 0x1A0E30
        float t; // r1
        class p2EntMotionPenData * aspen; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0E30 -> 0x001A0F70
*/
// Range: 0x1A0E30 -> 0x1A0F70
void zPendulum_Reset(class _zPendulum * pend /* r16 */, class _xScene * sc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A0E30 -> 0x1A0F70
        class p2EntMotionPenData * aspen; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0F70 -> 0x001A0FAC
*/
// Range: 0x1A0F70 -> 0x1A0FAC
void zPendulum_Setup(class _zPendulum * pend /* r17 */, class _xScene * sc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A0F70 -> 0x1A0FAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0FB0 -> 0x001A0FB8
*/
// Range: 0x1A0FB0 -> 0x1A0FB8
void zPendulum_Load(class _zPendulum * pend /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0FB0 -> 0x1A0FB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0FC0 -> 0x001A0FC8
*/
// Range: 0x1A0FC0 -> 0x1A0FC8
void zPendulum_Save(class _zPendulum * pend /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A0FC0 -> 0x1A0FC8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A0FD0 -> 0x001A106C
*/
// Range: 0x1A0FD0 -> 0x1A106C
void zPendulum_Init(void * pend /* r17 */, void * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A0FD0 -> 0x1A106C
    }
}
