/*
    Compile unit: E:\SD2\Game\flat\zParSys.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class zParSysInfo sParSysInfo[7]; // size: 0x38, address: 0x2B51A0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
unsigned int gActiveHeap; // size: 0x4, address: 0x357CAC
signed int zParSysEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1D2C40
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D28C0 -> 0x001D297C
*/
// Range: 0x1D28C0 -> 0x1D297C
void zParSysRender(class xBase * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D28C0 -> 0x1D297C
        class zParSys * s; // r17
        class _zParGroup * g; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2980 -> 0x001D2AC8
*/
// Range: 0x1D2980 -> 0x1D2AC8
static void zParGroupUpdateR(class zParSys * s /* r20 */, class _zParGroup * g /* r19 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D2980 -> 0x1D2AC8
        void (* func)(class zParCmd *, class xParGroup *, float); // r2
        class zParCmd * cmd; // r18
        signed int i; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2AD0 -> 0x001D2C40
*/
// Range: 0x1D2AD0 -> 0x1D2C40
void zParSysUpdate(class xBase * to /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D2AD0 -> 0x1D2C40
        class _zParGroup * g; // r18
        class zParSys * parent; // r17
        class zParSys * s; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2C40 -> 0x001D2D8C
*/
// Range: 0x1D2C40 -> 0x1D2D8C
signed int zParSysEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D2C40 -> 0x1D2D8C
        class zParSys * t; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2D90 -> 0x001D2DCC
*/
// Range: 0x1D2D90 -> 0x1D2DCC
void zParSysExit(class zParSys * t /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D2D90 -> 0x1D2DCC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2DD0 -> 0x001D2E1C
*/
// Range: 0x1D2DD0 -> 0x1D2E1C
void zParSysSetup(class zParSys * t /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D2DD0 -> 0x1D2E1C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2E20 -> 0x001D30D4
*/
// Range: 0x1D2E20 -> 0x1D30D4
void zParSysInit(class xBase * b /* r20 */, class zParSysAsset * tasset /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1D2E20 -> 0x1D30D4
        signed int i; // r5
        signed int i; // r17
        unsigned char * cmdPtr; // r16
        class zParSys * t; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D30E0 -> 0x001D30E8
*/
// Range: 0x1D30E0 -> 0x1D30E8
void zParSysInit(void * b /* r2 */, void * tasset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D30E0 -> 0x1D30E8
    }
}
