/*
    Compile unit: E:\SD2\Game\flat\xCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _xVec3 sTargetPos; // size: 0xC, address: 0x290508
static class _xVec3 sLastTargetPos; // size: 0xC, address: 0x290518
static class _xVec3 sLastCamPos; // size: 0xC, address: 0x290528
static signed int sOnGround; // size: 0x4, address: 0x357E34
static float sGroundHeight; // size: 0x4, address: 0x357E38
static float sCurXOffset; // size: 0x4, address: 0x357E3C
static float sCurYOffset; // size: 0x4, address: 0x357E40
static signed int sControllerStill; // size: 0x4, address: 0x357E44
float gCameraLastFov; // size: 0x4, address: 0x357E48
static signed int sCamDebugInfoLevel; // size: 0x4, address: 0x0
static unsigned int sCamDebugFixInterp; // size: 0x4, address: 0x357530
class _xVec3 sDummyTargetPos; // size: 0xC, address: 0x290538
class _xMat4x3 sDummyTargetFrame; // size: 0x40, address: 0x36A760
signed int sDXLeft; // size: 0x4, address: 0x357E54
signed int sDXRight; // size: 0x4, address: 0x357E58
signed int sDYUp; // size: 0x4, address: 0x357E5C
signed int sDYDown; // size: 0x4, address: 0x357E60
static float sShoulderTimer; // size: 0x4, address: 0x357E64
class zGlobals globals; // size: 0x3330, address: 0x362FD0
unsigned int gActiveHeap; // size: 0x4, address: 0x357CAC
void xCameraSeeThruCallback(class _xEnt *); // size: 0x0, address: 0x13AF90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138F10 -> 0x00138F18
*/
// Range: 0x138F10 -> 0x138F18
class _xMat4x3 * xCameraGetCurMatrix(class _tagxCamFrame * cam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138F10 -> 0x138F18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138F20 -> 0x00138F28
*/
// Range: 0x138F20 -> 0x138F28
void xCameraTargetOnGround(signed int on_ground /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138F20 -> 0x138F28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138F30 -> 0x0013902C
*/
// Range: 0x138F30 -> 0x13902C
void xCameraPickInitial(class _tagxCamFrame * cam /* r17 */, class _tagxCam * c /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138F30 -> 0x13902C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139030 -> 0x00139178
*/
// Range: 0x139030 -> 0x139178
void xCameraPickInitial(class _tagxCamFrame * cam /* r17 */, unsigned int init_id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x139030 -> 0x139178
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139180 -> 0x00139420
*/
// Range: 0x139180 -> 0x139420
void xCameraNext(class _tagxCamFrame * cam /* r19 */, class _tagxCam * trans_cam /* r18 */) {
    /* anonymous block */ {
        // Range: 0x139180 -> 0x139420
        class _xMat3x3 from_new_src; // r29+0x50
        class _xQuat * dst_rot; // r17
        class _xQuat * src_rot; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139420 -> 0x00139C58
*/
// Range: 0x139420 -> 0x139C58
void xCameraInterpValid(class _tagxCamFrame * cam /* r2 */, enum _tagTransType trans_type /* r2 */, float seconds /* r29+0x100 */) {
    /* anonymous block */ {
        // Range: 0x139420 -> 0x139C58
        class _xQuat dst_fm; // r29+0xC0
        class _xQuat cur_fm; // r29+0xB0
        float t; // r29+0x100
        class _tagxCam * orig; // r18
        class _tagxCam * src; // r17
        class _tagxCam * dest; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139C60 -> 0x00139EE0
*/
// Range: 0x139C60 -> 0x139EE0
class _tagxCam * xCameraSetAsset(class _tagxCamFrame * cam /* r19 */, class xCamAsset * src /* r18 */, signed int idx /* r2 */) {
    /* anonymous block */ {
        // Range: 0x139C60 -> 0x139EE0
        class _tagxCam * dst; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00139EE0 -> 0x0013A0A0
*/
// Range: 0x139EE0 -> 0x13A0A0
class _tagxCam * xCameraInit(class _tagxCamFrame * cam /* r17 */, unsigned int total /* r16 */) {
    /* anonymous block */ {
        // Range: 0x139EE0 -> 0x13A0A0
        signed int i; // r3
        class _tagxCam * array; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A0A0 -> 0x0013A0B0
*/
// Range: 0x13A0A0 -> 0x13A0B0
void xCameraRemoveEnv(class _tagxCamFrame * camera /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A0A0 -> 0x13A0B0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A0B0 -> 0x0013A0C4
*/
// Range: 0x13A0B0 -> 0x13A0C4
void xCameraAssignEnv(class _tagxCamFrame * camera /* r2 */, class _xEnv * env /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A0B0 -> 0x13A0C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A0D0 -> 0x0013A0D8
*/
// Range: 0x13A0D0 -> 0x13A0D8
void xCameraSetTarget(class _tagxCamFrame * cam /* r2 */, class _xMat4x3 * frame_target /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A0D0 -> 0x13A0D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A0E0 -> 0x0013A128
*/
// Range: 0x13A0E0 -> 0x13A128
void xCameraSetTarget(class _tagxCamFrame * cam /* r2 */, class _xVec3 * new_target /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A0E0 -> 0x13A128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A130 -> 0x0013A138
*/
// Range: 0x13A130 -> 0x13A138
void xCameraShowRaster(class _tagxCamFrame * cam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A130 -> 0x13A138
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A140 -> 0x0013A174
*/
// Range: 0x13A140 -> 0x13A174
void xCameraEnd(class _tagxCamFrame * cam /* r16 */, float seconds /* r29+0x20 */, signed int update_scrn_fx /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A140 -> 0x13A174
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A180 -> 0x0013A224
*/
// Range: 0x13A180 -> 0x13A224
void xCameraUpdate(class _tagxCamFrame * cam /* r16 */, float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13A180 -> 0x13A224
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A230 -> 0x0013A538
*/
// Range: 0x13A230 -> 0x13A538
void xCameraRunState(class _tagxCamFrame * cam /* r17 */, float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13A230 -> 0x13A538
        class _tagxCam * c; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A540 -> 0x0013A72C
*/
// Range: 0x13A540 -> 0x13A72C
static void xCameraAdjustTargetPos(class _tagxCamFrame * cam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13A540 -> 0x13A72C
        class _xVec3 cur_pos; // r29+0x10
        class _xVec3 desired_target_pos; // r29
        class _tagxCam * c; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013A730 -> 0x0013AEA8
*/
// Range: 0x13A730 -> 0x13AEA8
class _tagxCam * xCameraShoulderState(class _tagxCamFrame * cam /* r16 */, float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13A730 -> 0x13AEA8
        class _xCollis collis_env; // r29+0x140
        class _xRay3 ray; // r29+0x110
        class _xMat4x3 desired_pos_matrix; // r29+0xD0
        class _xMat4x3 target_pos_matrix; // r29+0x90
        class _tagxCam * c; // r2
        class _xMat4x3 old_matrix; // @ 0x00290550
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013AF90 -> 0x0013AFFC
*/
// Range: 0x13AF90 -> 0x13AFFC
static void xCameraSeeThruCallback(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13AF90 -> 0x13AFFC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B000 -> 0x0013B3EC
*/
// Range: 0x13B000 -> 0x13B3EC
static void ShoulderStateRealign(class _tagxCamFrame * cam /* r18 */, class _tagxCam * c /* r17 */) {
    /* anonymous block */ {
        // Range: 0x13B000 -> 0x13B3EC
        class _xVec3 target_with_y; // r29+0xB0
        float dp2; // r1
        class _xVec3 target_with_y; // r29+0xA0
        class _xVec3 desired_pos; // r29+0x90
        class _xVec3 vec; // r29+0x80
        float dp1; // r20
        float rad_rot; // r29+0xE0
        class _xMat3x3 rot_matrix; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B3F0 -> 0x0013B7F4
*/
// Range: 0x13B3F0 -> 0x13B7F4
static void ShoulderStatePause(class _tagxCamFrame * cam /* r17 */, class _tagxCam * c /* r16 */, float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13B3F0 -> 0x13B7F4
        class _xVec3 desired_pos; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B800 -> 0x0013B864
*/
// Range: 0x13B800 -> 0x13B864
static void ShoulderStateSwitch(class _tagxCamFrame * cam /* r2 */, class _tagxCam * c /* r2 */, signed int new_state /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13B800 -> 0x13B864
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B870 -> 0x0013B8D0
*/
// Range: 0x13B870 -> 0x13B8D0
static signed int ShoulderGetDesiredPos(class _tagxCam * c /* r2 */, class _xVec3 * pos /* r2 */, float x /* r29 */, float z /* r29 */) {
    /* anonymous block */ {
        // Range: 0x13B870 -> 0x13B8D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013B8D0 -> 0x0013BC6C
*/
// Range: 0x13B8D0 -> 0x13BC6C
class _tagxCam * xCameraFollowState(class _tagxCamFrame * cam /* r19 */, float seconds /* r23 */) {
    /* anonymous block */ {
        // Range: 0x13B8D0 -> 0x13BC6C
        class _xVec3 new_pos; // r29+0xF0
        class _xVec3 preline_test_pos; // r29+0xE0
        float cpb; // r4
        float cpa; // r3
        signed int trans; // r3
        class _xVec3 tmp; // r29+0xD0
        class _xMat3x3 mrot; // r29+0x80
        class _xVec3 dirvec; // r29+0xC0
        class _xVec3 to_vec; // r29+0xB0
        class _tagxCam * c; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BC70 -> 0x0013BE10
*/
// Range: 0x13BC70 -> 0x13BE10
static void GetPointOnLine(class _xVec3 * C /* r17 */, unsigned int marker1id /* r2 */, unsigned int marker2id /* r18 */, class _xVec3 * result /* r16 */) {
    /* anonymous block */ {
        // Range: 0x13BC70 -> 0x13BE10
        class _xVec3 normAB; // r29+0x70
        class _xVec3 AB; // r29+0x60
        class p2MarkerAsset * m2; // r19
        class p2MarkerAsset * m1; // r18
        float len; // r29+0x80
        float r; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BE10 -> 0x0013BED4
*/
// Range: 0x13BE10 -> 0x13BED4
void xCameraSetController(class _tagxCamFrame * cam /* r16 */, float x /* r22 */, float y /* r21 */, float seconds /* r20 */) {
    /* anonymous block */ {
        // Range: 0x13BE10 -> 0x13BED4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013BEE0 -> 0x0013C11C
*/
// Range: 0x13BEE0 -> 0x13C11C
void xCameraSetTargetDY(class _tagxCamFrame * cam /* r2 */, float dy /* r29 */, float seconds /* r29 */) {
    /* anonymous block */ {
        // Range: 0x13BEE0 -> 0x13C11C
        class _tagxCam * c; // r3
        float end; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C120 -> 0x0013C35C
*/
// Range: 0x13C120 -> 0x13C35C
void xCameraSetTargetDX(class _tagxCamFrame * cam /* r2 */, float dx /* r29 */, float seconds /* r29 */) {
    /* anonymous block */ {
        // Range: 0x13C120 -> 0x13C35C
        class _tagxCam * c; // r3
        float end; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C360 -> 0x0013C6E8
*/
// Range: 0x13C360 -> 0x13C6E8
class _tagxCam * xCameraFollowWithOffsetState(class _tagxCamFrame * cam /* r20 */, float seconds /* r23 */) {
    /* anonymous block */ {
        // Range: 0x13C360 -> 0x13C6E8
        class _xVec3 preline_test_pos; // r29+0xE0
        float cpb; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C6F0 -> 0x0013C730
*/
// Range: 0x13C6F0 -> 0x13C730
void xCameraBegin(class _tagxCamFrame * cam /* r16 */, signed int clear /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13C6F0 -> 0x13C730
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C730 -> 0x0013C738
*/
// Range: 0x13C730 -> 0x13C738
void xCameraDestroy() {
    /* anonymous block */ {
        // Range: 0x13C730 -> 0x13C738
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C740 -> 0x0013C7B8
*/
// Range: 0x13C740 -> 0x13C7B8
void xCameraCreate(class _tagxCamFrame * cam /* r16 */, unsigned int width /* r2 */, unsigned int height /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13C740 -> 0x13C7B8
        signed int first_time; // @ 0x00357E4C
        signed char init; // @ 0x00357E50
    }
}
