/*
    Compile unit: E:\SD2\Game\flat\zFeet.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int sSurfaceSoundIDStep[23]; // size: 0x5C, address: 0x3ACC80
static class xBase * paremit_sd_pawprint; // size: 0x4, address: 0x358438
static class xBase * paremit_vil_footprint; // size: 0x4, address: 0x35843C
static class RwRaster * sSkidMarkRaster; // size: 0x4, address: 0x358440
static float cPlayerSkidWidth[4]; // size: 0x10, address: 0x351D70
...
unsigned int zFeetStepVillainCB(unsigned int, class xAnimActiveEffect *, class xAnimSingle *, void *); // size: 0x0, address: 0x1DB4F0
unsigned int zFeetStepCB(unsigned int, class xAnimActiveEffect *, class xAnimSingle *, void *); // size: 0x0, address: 0x1DB760
void zFeetDebugCB(); // size: 0x0, address: 0x1DB4E0
...
class _tagFoot {
    // Members
public:
    class tagzFeet * feet; // offset 0x0, size 0x4
    signed int idx; // offset 0x4, size 0x4
};
// total size: 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DAE10 -> 0x001DAE98
*/
// Range: 0x1DAE10 -> 0x1DAE98
void zFeetRenderSkidMark(class _tagFeetSkidMark * m /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1DAE10 -> 0x1DAE98
        signed int i; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DAEA0 -> 0x001DB1EC
*/
// Range: 0x1DAEA0 -> 0x1DB1EC
static void DrawSkidMarkStrip(class _tagFeetSkidMark * m /* r20 */, class _tagSkidEdge * edge_array /* r2 */, unsigned char red /* r19 */, unsigned char green /* r18 */, unsigned char blue /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1DAEA0 -> 0x1DB1EC
        ...
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        unsigned char alphau8; // r2
        float alphaf; // r29+0x60
        class _tagSkidEdge * e; // r16
        unsigned int vert_idx; // r2
        class RxObjSpace3DVertex strip_vert[256]; // @ 0x003ACCE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB1F0 -> 0x001DB258
*/
// Range: 0x1DB1F0 -> 0x1DB258
void zFeetUpdateSkidMark(class _tagFeetSkidMark * m /* r2 */, float seconds /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1DB1F0 -> 0x1DB258
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB260 -> 0x001DB454
*/
// Range: 0x1DB260 -> 0x1DB454
void zFeetAddSkidMark(class _xEnt * ent /* r17 */, class _tagFeetSkidMark * m /* r16 */, float seconds /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x1DB260 -> 0x1DB454
        class _tagSkidEdge * e; // r19
        signed int i; // r18
        class _xVec3 feet_dir; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB460 -> 0x001DB4DC
*/
// Range: 0x1DB460 -> 0x1DB4DC
void zFeetInitSkidMark(class _tagFeetSkidMark * m /* r19 */, signed int total_feet /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1DB460 -> 0x1DB4DC
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB4E0 -> 0x001DB4E8
*/
// Range: 0x1DB4E0 -> 0x1DB4E8
static void zFeetDebugCB() {
    /* anonymous block */ {
        // Range: 0x1DB4E0 -> 0x1DB4E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB4F0 -> 0x001DB760
*/
// Range: 0x1DB4F0 -> 0x1DB760
static unsigned int zFeetStepVillainCB(class xAnimActiveEffect * acteffect /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1DB4F0 -> 0x1DB760
        class _xVec3 angles; // r29+0xC0
        class xBase * b; // r17
        float pitch; // r29+0xCC
        class zSurfaceProps * surface; // r2
        class xSurface * xsurf; // r2
        signed int surface_type; // r16
        class _zParEmitterCustomSettings info; // r29+0x60
        class _xEnt * ent; // r18
        class tagzFeet * feet; // r17
        class _tagFoot * foot; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DB760 -> 0x001DBAAC
*/
// Range: 0x1DB760 -> 0x1DBAAC
static unsigned int zFeetStepCB(class xAnimActiveEffect * acteffect /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1DB760 -> 0x1DBAAC
        class _xVec3 angles; // r29+0x110
        class xBase * b; // r16
        float pitch; // r29+0x11C
        class zSurfaceProps * surface; // r2
        class xSurface * xsurf; // r2
        signed int surface_type; // r18
        signed int collided_with_ground; // r21
        class _xRay3 ray; // r29+0xE0
        class _zParEmitterCustomSettings info; // r29+0x80
        class _xEnt * ent; // r17
        class tagzFeet * feet; // r16
        class _tagFoot * foot; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DBAB0 -> 0x001DCB38
*/
// Range: 0x1DBAB0 -> 0x1DCB38
void zFeetInit(signed int ent_type /* r2 */, class _xEnt * owner /* r2 */, class tagzFeet * feet /* r18 */, signed int feet_subtype /* r2 */, class xAnimTable * table /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1DBAB0 -> 0x1DCB38
        signed int tag_idx[6]; // r29+0xC0
        float step_time[6]; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DCB40 -> 0x001DCB50
*/
// Range: 0x1DCB40 -> 0x1DCB50
void zFeetExit(class xAnimTable * table /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1DCB40 -> 0x1DCB50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001DCB50 -> 0x001DCC30
*/
// Range: 0x1DCB50 -> 0x1DCC30
void zFeetGetIDs() {
    /* anonymous block */ {
        // Range: 0x1DCB50 -> 0x1DCC30
        class RwTexture * tex; // r2
        signed int i; // r16
        char name[128]; // r29+0xB0
        char type_name[128]; // r29+0x30
    }
}
