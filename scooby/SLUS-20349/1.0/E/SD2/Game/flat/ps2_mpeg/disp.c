/*
    Compile unit: E:\SD2\Game\flat\ps2_mpeg\disp.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
signed int isCountVblank; // size: 0x4, address: 0x3585F4
signed int vblankCount; // size: 0x4, address: 0x3585F8
signed int isFrameEnd; // size: 0x4, address: 0x3585FC
signed int oddeven; // size: 0x4, address: 0x358600
signed int handler_error; // size: 0x4, address: 0x358604
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00262E00 -> 0x00262E0C
*/
// Range: 0x262E00 -> 0x262E0C
void endDisplay() {
    /* anonymous block */ {
        // Range: 0x262E00 -> 0x262E0C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00262E10 -> 0x00262E5C
*/
// Range: 0x262E10 -> 0x262E5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00262E60 -> 0x00262E98
*/
// Range: 0x262E60 -> 0x262E98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00262EA0 -> 0x00263058
*/
// Range: 0x262EA0 -> 0x263058
signed int vblankHandler() {
    /* anonymous block */ {
        // Range: 0x262EA0 -> 0x263058
        class VoTag * tag; // r17
        class sceDmaChan * dmaGif_loadimage; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00263060 -> 0x00263370
*/
// Range: 0x263060 -> 0x263370
void setImageTag(unsigned int * tags /* r2 */, void * image /* r21 */, signed int index /* r17 */, signed int image_w /* r30 */, signed int image_h /* r29+0xAC */) {
    /* anonymous block */ {
        // Range: 0x263060 -> 0x263370
        unsigned long * tag; // r2
        unsigned long giftag_eop[2]; // r29+0xD0
        unsigned long giftag[2]; // r29+0xC0
        class sceGifPacket packet; // r29+0xB0
        signed int j; // r17
        signed int i; // r22
        signed int mby; // r16
        signed int mbx; // r23
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00263370 -> 0x002635D8
*/
// Range: 0x263370 -> 0x2635D8
void clearGsMem(signed int r /* r18 */, signed int g /* r17 */, signed int b /* r16 */, signed int disp_width /* r20 */, signed int disp_height /* r21 */) {
    /* anonymous block */ {
        // Range: 0x263370 -> 0x2635D8
        class sceDmaChan * dmaGif; // r22
        __int128 * packetBase; // r19
        class sceGifPacket packet; // r29+0x90
