/*
    Compile unit: E:\SD2\Game\flat\zDispatcher.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int g_zdsp_init; // size: 0x4, address: 0x3581F0
static signed int g_zdsp_dblog_init; // size: 0x4, address: 0x0
static class st_ZDISPATCH_DEPOT g_zdsp_depot; // size: 0x8, address: 0x3575D8
class xSndGlobals gSnd; // size: 0xD30, address: 0x373B80
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int ZDSP_elcb_event(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A8080
unsigned int gActiveHeap; // size: 0x4, address: 0x357CAC
// total size: 0x18
class st_ZDISPATCH_DATA : public xBase {
    // Members
public:
    class p2BaseAsset * rawass; // offset 0x10, size 0x4
...
enum en_DISPATCH_COMMAND {
    ...
    ZDSP_CMD_SNDMOD_GET = 4,
    ZDSP_CMD_SNDMOD_SET = 5,
    ZDSP_CMD_SNDVOL_GET = 6,
    ZDSP_CMD_SNDVOL_SET = 7,
    ZDSP_CMD_SNDVOL_INCR = 8,
    ZDSP_CMD_SNDVOL_DECR = 9,
    ZDSP_CMD_MUSVOL_GET = 10,
    ZDSP_CMD_MUSVOL_SET = 11,
    ZDSP_CMD_MUSVOL_INCR = 12,
    ZDSP_CMD_MUSVOL_DECR = 13,
    ZDSP_CMD_SFXVOL_GET = 14,
    ZDSP_CMD_SFXVOL_SET = 15,
    ZDSP_CMD_SFXVOL_INCR = 16,
    ZDSP_CMD_SFXVOL_DECR = 17,
    ZDSP_CMD_GSTATE_GET = 18,
    ZDSP_CMD_GSTATE_SET = 19,
    ZDSP_CMD_GMODE_GET = 20,
    ZDSP_CMD_GMODE_SET = 21,
    ZDSP_CHECKPNT_SET = 22,
    ZDSP_CMD_NOMORE = 23,
};
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A8080 -> 0x001A883C
*/
// Range: 0x1A8080 -> 0x1A883C
static signed int ZDSP_elcb_event(class xBase * xb /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r17 */, class xBase * toParamWidget /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A8080 -> 0x1A883C
        class iColor_tag clear; // r29+0x3C
        class iColor_tag black; // r29+0x38
        class st_ZDISPATCH_DATA * dspdata; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A8840 -> 0x001A9004
*/
// Range: 0x1A8840 -> 0x1A9004
static signed int ZDSP_doCommand(class st_ZDISPATCH_CONTEXT * cmdCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A8840 -> 0x1A9004
        void * result; // r17
        void * indata; // r16
        enum en_DISPATCH_COMMAND cmd; // r3
        signed int iv; // r2
        signed int warned; // @ 0x003581F4
        signed char init; // @ 0x003581F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9010 -> 0x001A9050
*/
// Range: 0x1A9010 -> 0x1A9050
void ZDSP_injectCmd(class st_ZDISPATCH_DATA * dspdata /* r2 */, enum en_DISPATCH_COMMAND cmd /* r2 */, void * indata /* r2 */, void * inxtra /* r2 */, void * result /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A9010 -> 0x1A9050
        class st_ZDISPATCH_CONTEXT cmdctxt; // r29+0x10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9050 -> 0x001A90C0
*/
// Range: 0x1A9050 -> 0x1A90C0
static void ZDSP_instInit(class st_ZDISPATCH_DATA * dspdata /* r17 */, class p2BaseAsset * bass /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A9050 -> 0x1A90C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A90C0 -> 0x001A90C8
*/
// Range: 0x1A90C0 -> 0x1A90C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A90D0 -> 0x001A90D8
*/
// Range: 0x1A90D0 -> 0x1A90D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A90E0 -> 0x001A90F0
*/
// Range: 0x1A90E0 -> 0x1A90F0
void zDispatcher_InitDep(class st_ZDISPATCH_DATA * dspdata /* r4 */) {
    /* anonymous block */ {
        // Range: 0x1A90E0 -> 0x1A90F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A90F0 -> 0x001A9160
*/
// Range: 0x1A90F0 -> 0x1A9160
void zDispatcher_Init(class st_ZDISPATCH_DATA * dspdata /* r17 */, class p2BaseAsset * bass /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A90F0 -> 0x1A9160
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9160 -> 0x001A9174
*/
// Range: 0x1A9160 -> 0x1A9174
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9180 -> 0x001A9200
*/
// Range: 0x1A9180 -> 0x1A9200
class st_ZDISPATCH_DATA * zDispatcher_memPool(signed int cnt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1A9180 -> 0x1A9200
        class st_ZDISPATCH_DEPOT * depot; // r17
        class st_ZDISPATCH_DATA * pool; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9200 -> 0x001A9234
*/
// Range: 0x1A9200 -> 0x1A9234
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9240 -> 0x001A9274
*/
// Range: 0x1A9240 -> 0x1A9274
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9280 -> 0x001A9288
*/
// Range: 0x1A9280 -> 0x1A9288
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A9290 -> 0x001A9298
*/
// Range: 0x1A9290 -> 0x1A9298
