/*
    Compile unit: E:\SD2\Game\flat\zUI.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int sSortedCount; // size: 0x4, address: 0x358200
class _zUI * sSorted[768]; // size: 0xC00, address: 0x378440
static class RwSky2DVertex Vertex[4]; // size: 0x100, address: 0x379040
static unsigned short Index[6]; // size: 0xC, address: 0x2B3510
static unsigned int cKeyUIid1off; // size: 0x4, address: 0x358204
static unsigned int cKeyUIid2off; // size: 0x4, address: 0x358208
static unsigned int cKeyUIid3off; // size: 0x4, address: 0x35820C
static unsigned int cKeyUIid4off; // size: 0x4, address: 0x358210
static unsigned int cKeyUIid1on; // size: 0x4, address: 0x358214
static unsigned int cKeyUIid2on; // size: 0x4, address: 0x358218
static unsigned int cKeyUIid3on; // size: 0x4, address: 0x35821C
static unsigned int cKeyUIid4on; // size: 0x4, address: 0x358220
static class zSceneLevel sLevelTable2[14]; // size: 0xE0, address: 0x2B3520
static float ushift; // size: 0x4, address: 0x358224
float gFontWiggleTime; // size: 0x4, address: 0x3580EC
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int iRenderQSort_Face(void *, void *); // size: 0x0, address: 0x1ABFC0
class xBase * zUIRenderIteratorInsert(class xBase *, class zScene *, void *); // size: 0x0, address: 0x1AC010
signed int zUIEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1AB140
void zUI_Update(class _zUI *, class _xScene *, float); // size: 0x0, address: 0x1AC040
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AB140 -> 0x001AB474
*/
// Range: 0x1AB140 -> 0x1AB474
signed int zUIEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1AB140 -> 0x1AB474
        char uiName[256]; // r29+0x180
        signed int j; // r18
        signed int i; // r16
        char uiName[256]; // r29+0x80
        signed int j; // r18
        signed int i; // r22
        char level; // r2
        class _zUI * s; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AB480 -> 0x001ABE50
*/
// Range: 0x1AB480 -> 0x1ABE50
void zUI_Render(class _xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1AB480 -> 0x1ABE50
        class _xRect win1; // r29+0x80
        class _xVec3 * pos; // r8
        class _xVec3 relto; // r29+0xC0
        class _xVec3 relfrom; // r29+0xB0
        class _xVec3 to; // r29+0xA0
        class _xVec3 from; // r29+0x90
        float cooz; // r1
        float cz; // r2
        float z; // r29+0xD0
        float pulse_w; // r3
        float wave; // r29+0xD0
        float pulse_h; // r29+0xD0
        float pulse_w; // r2
        float wave; // r1
        float y2; // r31
        float x2; // r30
        ...
        class _zUI * ui; // r2
        unsigned int hack_token2; // @ 0x00358248
        unsigned int hack_token1; // @ 0x00358240
        signed char init; // @ 0x0035824C
        signed char init; // @ 0x00358244
        unsigned int hack_pulse3; // @ 0x00358238
        unsigned int hack_pulse2; // @ 0x00358230
        unsigned int hack_pulse1; // @ 0x00358228
        signed char init; // @ 0x0035823C
        signed char init; // @ 0x00358234
        signed char init; // @ 0x0035822C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001ABE50 -> 0x001ABFB8
*/
// Range: 0x1ABE50 -> 0x1ABFB8
void zUIRenderAll() {
    /* anonymous block */ {
        // Range: 0x1ABE50 -> 0x1ABFB8
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001ABFC0 -> 0x001AC010
*/
// Range: 0x1ABFC0 -> 0x1AC010
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC010 -> 0x001AC040
*/
// Range: 0x1AC010 -> 0x1AC040
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC040 -> 0x001AC24C
*/
// Range: 0x1AC040 -> 0x1AC24C
void zUI_Update(class _zUI * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x1AC040 -> 0x1AC24C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC250 -> 0x001AC468
*/
// Range: 0x1AC250 -> 0x1AC468
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC470 -> 0x001AC4B8
*/
// Range: 0x1AC470 -> 0x1AC4B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC4C0 -> 0x001AC4C8
*/
// Range: 0x1AC4C0 -> 0x1AC4C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC4D0 -> 0x001AC4D8
*/
// Range: 0x1AC4D0 -> 0x1AC4D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC4E0 -> 0x001AC614
*/
// Range: 0x1AC4E0 -> 0x1AC614
void zUI_Init(class _zUI * ent /* r17 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1AC4E0 -> 0x1AC614
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC620 -> 0x001AC628
*/
// Range: 0x1AC620 -> 0x1AC628
