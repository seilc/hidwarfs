/*
    Compile unit: E:\SD2\Game\flat\iCollideFast.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int hitzhit; // size: 0x4, address: 0x35858C
class RpCollisionTriangle * rayHitsEnvFastCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x24C170
class RpCollisionTriangle * rayHitsModelFastCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x24C180
// total size: 0x44
class xAnimFile {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024BB30 -> 0x0024BD88
*/
// Range: 0x24BB30 -> 0x24BD88
unsigned int iRayHitsEnvSpecialFast(class _xRay3 * r /* r2 */, class _xEnv * env /* r17 */) {
    /* anonymous block */ {
        // Range: 0x24BB30 -> 0x24BD88
        class RwV3d temp; // r29+0x50
        float len; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024BD90 -> 0x0024BF80
*/
// Range: 0x24BD90 -> 0x24BF80
unsigned int iRayHitsEnvFast(class _xRay3 * r /* r2 */, class _xEnv * env /* r17 */) {
    /* anonymous block */ {
        // Range: 0x24BD90 -> 0x24BF80
        class RwV3d temp; // r29+0x50
        float len; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024BF80 -> 0x0024C168
*/
// Range: 0x24BF80 -> 0x24C168
unsigned int iRayHitsModelFast(class _xRay3 * r /* r2 */, class xModelInstance * m /* r17 */) {
    /* anonymous block */ {
        // Range: 0x24BF80 -> 0x24C168
        class RwV3d temp; // r29+0x50
        float len; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C170 -> 0x0024C180
*/
// Range: 0x24C170 -> 0x24C180
static class RpCollisionTriangle * rayHitsEnvFastCB() {
    /* anonymous block */ {
        // Range: 0x24C170 -> 0x24C180
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C180 -> 0x0024C190
*/
// Range: 0x24C180 -> 0x24C190
static class RpCollisionTriangle * rayHitsModelFastCB() {
    /* anonymous block */ {
        // Range: 0x24C180 -> 0x24C190
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C190 -> 0x0024C198
*/
// Range: 0x24C190 -> 0x24C198
