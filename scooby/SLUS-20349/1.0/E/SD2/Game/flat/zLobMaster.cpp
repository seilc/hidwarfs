/*
    Compile unit: E:\SD2\Game\flat\zLobMaster.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int g_zlob_init; // size: 0x4, address: 0x358298
static class st_LOBMASTER_DEPOT g_zlob_depot; // size: 0x8, address: 0x3575E8
class st_LOBMASTER_QUEUE g_zlob_queue[5]; // size: 0xDC, address: 0x2B3E80
class _xVec3 g_Y3; // size: 0xC, address: 0x342E38
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int ZLOB_legacy_notify(class zEntProjectile *, enum en_PROJECTILE_EVENT, void *); // size: 0x0, address: 0x1B3890
signed int ZLOB_elcb_event(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1B3B50
...
// total size: 0x80
class zLobMasterAsset : public p2BaseAsset {
    // Members
public:
    signed int lobMasterType; // offset 0x8, size 0x4
    unsigned int projectileTypeID; // offset 0xC, size 0x4
    class _xVec3 pos_launch; // offset 0x10, size 0xC
    class _xVec3 rot_launch; // offset 0x1C, size 0xC
    float spd_launch; // offset 0x28, size 0x4
    float spd_randPct; // offset 0x2C, size 0x4
    class _xVec3 scl_model; // offset 0x30, size 0xC
    signed int flg_enablers; // offset 0x3C, size 0x4
    float tym_maxlife; // offset 0x40, size 0x4
    float dst_maxdist; // offset 0x44, size 0x4
    unsigned int aid_mvptID; // offset 0x48, size 0x4
    signed int cnt_salvo; // offset 0x4C, size 0x4
    signed int cnt_ammo; // offset 0x50, size 0x4
    float fac_arccoeff; // offset 0x54, size 0x4
    signed int ang_debrisCone; // offset 0x58, size 0x4
    signed int numBounce; // offset 0x5C, size 0x4
    signed int typ_powerup; // offset 0x60, size 0x4
    float heavyFactor; // offset 0x64, size 0x4
    class _xVec3 tumbleRotation; // offset 0x68, size 0xC
    float collideDelay; // offset 0x74, size 0x4
    float atRestPeriod; // offset 0x78, size 0x4
    unsigned int mode; // offset 0x7C, size 0x4
};
// total size: 0x8
class _tagxCamPath {
    // Members
...
// total size: 0x90
class st_LOBMASTER_DATA : public xBase {
    // Members
public:
    signed int flg_lmopts; // offset 0x10, size 0x4
    float ang_debrisCone; // offset 0x14, size 0x4
    signed int cnt_ammo; // offset 0x18, size 0x4
    signed int cnt_salvo; // offset 0x1C, size 0x4
    class _zMovePoint * nav_bullbase; // offset 0x20, size 0x4
    class _zMovePoint * nav_nextbull; // offset 0x24, size 0x4
    class _zMovePoint * nav_prevbull; // offset 0x28, size 0x4
    signed int flg_suitcase; // offset 0x2C, size 0x4
    class _xVec3 pos_altLaunch; // offset 0x30, size 0xC
    class _xVec3 dir_altLaunch; // offset 0x3C, size 0xC
    class _xBound bnd_altLaunch; // offset 0x48, size 0x38
    class st_LOBMASTER_CONFIG cfg; // offset 0x80, size 0x10
};
// total size: 0x4
class _iCollis {
    // Members
...
class _zVolume {};
// total size: 0x8
class st_LOBMASTER_DEPOT {
    // Members
public:
    class st_LOBMASTER_DATA * raw_pool; // offset 0x0, size 0x4
...
// total size: 0x10
class st_LOBMASTER_CONFIG {
    // Members
public:
    class zLobMasterAsset * rawass; // offset 0x0, size 0x4
    class _xVec3 dir_launch; // offset 0x4, size 0xC
};
// total size: 0x40
class _xEnv {
    // Members
...
enum en_LOBMASTER_PARAMID {
    ZLOB_PARM_RAWASS = 0,
    ZLOB_PARM_LOBFLAGS = 1,
    ZLOB_PARM_LOBMASTERTYPE = 2,
    ZLOB_PARM_PRJTYPEID = 3,
    ZLOB_PARM_POS_LAUNCH = 4,
    ZLOB_PARM_DIR_LAUNCH = 5,
    ZLOB_PARM_SPD_LAUNCH = 6,
    ZLOB_PARM_SPD_RANDPCT = 7,
    ZLOB_PARM_SCL_MODEL = 8,
    ZLOB_PARM_TYM_MAXLIFE = 9,
    ZLOB_PARM_DST_MAXDIST = 10,
    ZLOB_PARM_DEBRISANGLE = 11,
    ZLOB_PARM_SALVO = 12,
    ZLOB_PARM_AMMO = 13,
    ZLOB_PARM_ARCFACTOR = 14,
    ZLOB_PARM_HEAVYFACTOR = 15,
    ZLOB_PARM_PAYLOAD = 16,
    ZLOB_PARM_MVPTBULL = 17,
    ZLOB_PARM_NUMBOUNCE = 18,
    ZLOB_PARM_TUMBLE = 19,
    ZLOB_PARM_COLLIDEDELAY = 20,
    ZLOB_PARM_RESTPERIOD = 21,
    ZLOB_PARM_NOMORE = 22,
};
// total size: 0x4
...
enum en_LOB_POWERUP_TYPE {
    ZLOB_PUPTYP_NOTHING = 0,
    ZLOB_PUPTYP_DAMAGE = 1,
    ZLOB_PUPTYP_ADDCHANCE = 2,
    ZLOB_PUPTYP_ADDSCARE = 3,
    ZLOB_PUPTYP_ADDGUM = 4,
    ZLOB_PUPTYP_ADDSOAP = 5,
    ZLOB_PUPTYP_ADDSNACK = 6,
    ZLOB_PUPTYP_NOMORE = 7,
};
// total size: 0xC
...
// total size: 0x2C
class st_LOBMASTER_QUEUE {
    // Members
public:
    signed int flg_stat; // offset 0x0, size 0x4
    float tmr_delay; // offset 0x4, size 0x4
    unsigned int aid_lobber; // offset 0x8, size 0x4
    class _xVec3 pos_launch; // offset 0xC, size 0xC
    class _xVec3 dir_launch; // offset 0x18, size 0xC
    signed int cnt_salvo; // offset 0x24, size 0x4
    signed int idx_current; // offset 0x28, size 0x4
};
// total size: 0xC
class RxOutputSpec {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1910 -> 0x001B1A10
*/
// Range: 0x1B1910 -> 0x1B1A10
static signed int LPRJ_debris_prjmove(class zEntProjectile * prj /* r4 */, float dt /* r29+0x20 */, class _xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B1910 -> 0x1B1A10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1A10 -> 0x001B1DF8
*/
// Range: 0x1B1A10 -> 0x1B1DF8
static signed int LPRJ_debris_logix(class zEntProjectile * prj /* r18 */, float dt /* r20 */, class _xEntFrame * frame /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1B1A10 -> 0x1B1DF8
        float elastic; // r21
        class _xVec3 tmp_vec; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1E00 -> 0x001B1E38
*/
// Range: 0x1B1E00 -> 0x1B1E38
static signed int LPRJ_debris_attach(class zEntProjectile * prj /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B1E00 -> 0x1B1E38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1E40 -> 0x001B2584
*/
// Range: 0x1B1E40 -> 0x1B2584
static signed int ZLOB_randpos_fromBound(class _xBound * bnd /* r17 */, signed int flg_ropts /* r21 */, class _xVec3 * pos_launch /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B1E40 -> 0x1B2584
        signed int result; // r18
        float rad; // r20
        float hyt; // r21
        class _xVec3 rot_range; // r29+0xE0
        class _xMat3x3 mat_rot; // r29+0x80
        class _xVec3 dirvec; // r29+0xD0
        class _xVec3 vec_tmp; // r29+0xC0
        class _xVec3 delta; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2590 -> 0x001B25F0
*/
// Range: 0x1B2590 -> 0x1B25F0
static class st_LOBMASTER_DATA * ZLOB_find_lobber(unsigned int aid_lobm /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B2590 -> 0x1B25F0
        signed int i; // r5
        class st_LOBMASTER_DEPOT * depot; // r2
        class st_LOBMASTER_DATA * lob; // r2
        class st_LOBMASTER_DATA * tmp_lob; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B25F0 -> 0x001B267C
*/
// Range: 0x1B25F0 -> 0x1B267C
static void ZLOB_grab_nextBull(class st_LOBMASTER_DATA * lob /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B25F0 -> 0x1B267C
        class _xVec3 hdng; // r29+0x20
        class _zMovePoint * nav_tmp; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2680 -> 0x001B2D58
*/
// Range: 0x1B2680 -> 0x1B2D58
static signed int ZLOB_shoot_debris(class st_LOBMASTER_DATA * lob /* r21 */, signed int nth /* r20 */, signed int total /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1B2680 -> 0x1B2D58
        class _xMat3x3 mat_rot; // r29+0xA0
        class _xVec3 ang; // r29+0x108
        class _xVec3 rot_tumble; // r29+0xF8
        class _xVec3 dir_launch; // r29+0xE8
        class _xVec3 pos_launch; // r29+0xD8
        float spd_launch; // r20
        float spd_base; // [invalid]
        signed int flg_player; // r17
        float ang_cone; // r20
        float fval; // r29+0x120
        class st_ZPRJ_CAT_BOUNCEBALL * bounce; // r18
        unsigned int prjTypeID; // r29+0x118
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B2D60 -> 0x001B30A8
*/
// Range: 0x1B2D60 -> 0x1B30A8
static signed int ZLOB_shoot_arrow(class st_LOBMASTER_DATA * lob /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1B2D60 -> 0x1B30A8
        class _xVec3 pos_tgt; // r29+0x60
        class _xVec3 dir_launch; // r29+0x50
        class _xVec3 pos_launch; // r29+0x40
        float tmp_rand; // r29+0x80
        float spd_randPct; // r29+0x78
        float spd_launch; // r20
        float spd_base; // r29+0x74
        unsigned int prjTypeID; // r29+0x70
        class zEntProjectile * prj; // r16
        signed int result; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B30B0 -> 0x001B3888
*/
// Range: 0x1B30B0 -> 0x1B3888
static signed int ZLOB_shoot_legacy(class st_LOBMASTER_DATA * lob /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1B30B0 -> 0x1B3888
        class _xMat3x3 mat_rot; // r29+0xF0
        class _xVec3 ang; // r29+0x168
        float spd_base; // r20
        class st_CAT_AIMGRAV * grav; // r18
        class ST_CAT_AIMDATA aim; // r29+0xB0
        float fac_arc; // r29+0x188
        class _xVec3 pos_tgt; // r29+0x158
        class _xVec3 dir_launch; // r29+0x148
        class _xVec3 pos_launch; // r29+0x138
        float tmp_rand; // r1
        float spd_randPct; // r29+0x184
        float spd_launch; // r29+0x180
        class _xVec3 rot_tumble; // r29+0x128
        class st_ZPRJ_CAT_BOUNCEBALL * bounce; // r17
        float fval; // r29+0x17C
        unsigned int prjTypeID; // r29+0x178
        class zEntProjectile * prj; // r16
        signed int result; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3890 -> 0x001B3918
*/
// Range: 0x1B3890 -> 0x1B3918
static signed int ZLOB_legacy_notify(class zEntProjectile * prj /* r16 */, enum en_PROJECTILE_EVENT event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B3890 -> 0x1B3918
        float fval; // r29+0x2C
        class st_LOBMASTER_DATA * lob; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3920 -> 0x001B39EC
*/
// Range: 0x1B3920 -> 0x1B39EC
static signed int ZLOB_shoot_one(class st_LOBMASTER_DATA * lob /* r18 */, signed int nth /* r17 */, signed int total /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B3920 -> 0x1B39EC
        enum en_LOB_MASTER_TYPE type; // r29+0x4C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B39F0 -> 0x001B3B44
*/
// Range: 0x1B39F0 -> 0x1B3B44
static signed int ZLOB_doLaunch(class st_LOBMASTER_DATA * lob /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1B39F0 -> 0x1B3B44
        enum en_LOB_MASTER_TYPE type; // r29+0x58
        signed int salvo; // r29+0x54
        signed int cnt; // r17
        signed int rc; // r2
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3B50 -> 0x001B3DC8
*/
// Range: 0x1B3B50 -> 0x1B3DC8
static signed int ZLOB_elcb_event(class xBase * from /* r4 */, class xBase * xb /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B3B50 -> 0x1B3DC8
        signed int do_fromWidge; // r17
        class st_LOBMASTER_DATA * lob; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3DD0 -> 0x001B40CC
*/
// Range: 0x1B3DD0 -> 0x1B40CC
static signed int LCFG_getParam(class st_LOBMASTER_CONFIG * cfg /* r2 */, enum en_LOBMASTER_PARAMID pid /* r2 */, void * vv /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1B3DD0 -> 0x1B40CC
        signed int iv; // r4
        signed int found; // r16
        class zLobMasterAsset * lmass; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B40D0 -> 0x001B41BC
*/
// Range: 0x1B40D0 -> 0x1B41BC
static void ZLOB_HEB_to_DIR(class _xVec3 * dir_result /* r17 */, class _xVec3 * rot_HPB /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B40D0 -> 0x1B41BC
        class _xMat3x3 mat_rot; // r29+0x30
        class _xVec3 vec_aim; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B41C0 -> 0x001B42F0
*/
// Range: 0x1B41C0 -> 0x1B42F0
void zLobMaster_timestep(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1B41C0 -> 0x1B42F0
        signed int i; // r16
        class st_LOBMASTER_DATA * lobber; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B42F0 -> 0x001B43DC
*/
// Range: 0x1B42F0 -> 0x1B43DC
void zLobMaster_InitDep(class st_LOBMASTER_DATA * lob /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B42F0 -> 0x1B43DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B43E0 -> 0x001B44A0
*/
// Range: 0x1B43E0 -> 0x1B44A0
void zLobMaster_Init(class st_LOBMASTER_DATA * lob /* r17 */, class p2BaseAsset * basset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B43E0 -> 0x1B44A0
        class zLobMasterAsset * tmp_rawass; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B44A0 -> 0x001B44B4
*/
// Range: 0x1B44A0 -> 0x1B44B4
class st_LOBMASTER_DATA * zLobMaster_getInst(class st_LOBMASTER_DATA * pool /* r2 */, signed int idx /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1B44A0 -> 0x1B44B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B44C0 -> 0x001B4540
*/
// Range: 0x1B44C0 -> 0x1B4540
class st_LOBMASTER_DATA * zLobMaster_memPool(signed int cnt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1B44C0 -> 0x1B4540
        class st_LOBMASTER_DEPOT * depot; // r17
        class st_LOBMASTER_DATA * pool; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4540 -> 0x001B4574
*/
// Range: 0x1B4540 -> 0x1B4574
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4580 -> 0x001B45D4
*/
// Range: 0x1B4580 -> 0x1B45D4
void zLobMaster_scenePrepare() {
    /* anonymous block */ {
        // Range: 0x1B4580 -> 0x1B45D4
        class st_LOBMASTER_DEPOT * depot; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B45E0 -> 0x001B45E8
*/
// Range: 0x1B45E0 -> 0x1B45E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B45F0 -> 0x001B468C
*/
// Range: 0x1B45F0 -> 0x1B468C
void zLobMaster_Startup() {
    /* anonymous block */ {
        // Range: 0x1B45F0 -> 0x1B468C
        class st_ZPRJ_CATEGORY_PROPS prop_bang; // r29+0x50
        class st_ZPRJ_CATEGORY_PROPS prop_debris; // r29+0x40
        class st_ZPRJ_CATEGORY_FUNCS fmap_debris; // r29+0x10
    }
}
