/*
    Compile unit: E:\SD2\Game\flat\zLightning.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _tagLightning * sLightning[48]; // size: 0xC0, address: 0x3B0730
static unsigned char cSparkColors[24]; // size: 0x18, address: 0x3549E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024ACC0 -> 0x0024ADD8
*/
// Range: 0x24ACC0 -> 0x24ADD8
void zLightningModifyEndpoints(class _tagLightning * l /* r2 */, class _xVec3 * start /* r2 */, class _xVec3 * end /* r2 */) {
    /* anonymous block */ {
        // Range: 0x24ACC0 -> 0x24ADD8
        float scalar; // r4
        float pos; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024ADE0 -> 0x0024ADF4
*/
// Range: 0x24ADE0 -> 0x24ADF4
void zLightningKill(class _tagLightning * l /* r2 */) {
    /* anonymous block */ {
        // Range: 0x24ADE0 -> 0x24ADF4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AE00 -> 0x0024AE94
*/
// Range: 0x24AE00 -> 0x24AE94
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AEA0 -> 0x0024B2E0
*/
// Range: 0x24AEA0 -> 0x24B2E0
static void RenderLightning(class _tagLightning * l /* r17 */) {
    /* anonymous block */ {
        // Range: 0x24AEA0 -> 0x24B2E0
        ...
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        float oldthickness; // r20
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        signed int i; // r4
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        unsigned int verts; // r2
        unsigned char alphau8; // r3
        float alphaf; // r29+0x50
        class RxObjSpace3DVertex sStripVert[128]; // @ 0x003B07F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024B2E0 -> 0x0024B350
*/
// Range: 0x24B2E0 -> 0x24B350
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024B350 -> 0x0024B848
*/
// Range: 0x24B350 -> 0x24B848
static void UpdateLightning(class _tagLightning * l /* r16 */, float seconds /* r23 */) {
    /* anonymous block */ {
        // Range: 0x24B350 -> 0x24B848
        signed int col; // r9
        signed int i; // r3
        ...
        float sc1; // r2
        float sc2; // r21
        class _xVec3 vec; // r29+0x150
        class _xMat3x3 mat3; // r29+0xA0
        signed int i; // r17
        float full; // r20
        class _xVec3 dir_euler; // r29+0x140
        class _xMat3x3 dirmat; // r29+0x70
        class _xVec3 dir; // r29+0x130
        float sc1; // r4
        signed int i; // r17
        float full; // r20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024B850 -> 0x0024BAD4
*/
// Range: 0x24B850 -> 0x24BAD4
class _tagLightning * zLightningAdd(class _tagLightningAdd * add /* r18 */) {
    /* anonymous block */ {
        // Range: 0x24B850 -> 0x24BAD4
        float scalar; // r3
        float pos; // r5
        signed int i; // r6
        float currot; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024BAE0 -> 0x0024BB24
*/
// Range: 0x24BAE0 -> 0x24BB24
void zLightningInit() {
    /* anonymous block */ {
        // Range: 0x24BAE0 -> 0x24BB24
        signed int i; // r4
