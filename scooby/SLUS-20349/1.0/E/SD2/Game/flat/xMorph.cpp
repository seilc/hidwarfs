/*
    Compile unit: E:\SD2\Game\flat\xMorph.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127230 -> 0x00127248
*/
// Range: 0x127230 -> 0x127248
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127250 -> 0x0012743C
*/
// Range: 0x127250 -> 0x12743C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00127440 -> 0x00127668
*/
// Range: 0x127440 -> 0x127668
class xMorphSeqFile * xMorphSeqSetup(void * data /* r2 */, void * (* FindAssetCB)(unsigned int, char *) /* r22 */) {
    /* anonymous block */ {
        ...
        void * assetPtr; // r2
        char * namelist; // r20
        unsigned int * assetlist; // r19
        class xMorphFrame * framelist; // r2
        class xMorphSeqFile * header; // r18
        class xMorphTargetFile * mphtgt; // r8
        class RpAtomic * model; // r4
        signed int j; // r7
        signed int i; // r17
    }
}
