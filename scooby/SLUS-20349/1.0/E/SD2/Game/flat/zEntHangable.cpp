/*
    Compile unit: E:\SD2\Game\flat\zEntHangable.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _zParEmitter * sCandleEmitter; // size: 0x4, address: 0x35817C
static class _zParEmitter * sCandleSmokeEmitter; // size: 0x4, address: 0x358180
static unsigned int sChandelierHash; // size: 0x4, address: 0x358184
static class _zParEmitter * sMountEmitter; // size: 0x4, address: 0x358188
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zEntHangableEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A2A80
void zEntHangable_Update(class _zEntHangable *, class _xScene *, float); // size: 0x0, address: 0x1A2DF0
// total size: 0xE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2050 -> 0x001A21B0
*/
// Range: 0x1A2050 -> 0x1A21B0
void zEntHangable_FollowUpdate(class _zEntHangable * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A2050 -> 0x1A21B0
        class _xVec3 * center; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A21B0 -> 0x001A2338
*/
// Range: 0x1A21B0 -> 0x1A2338
void zEntHangable_SetShaggy(class _zEntHangable * ent /* r2 */, class _zEnt * shaggy /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A21B0 -> 0x1A2338
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2340 -> 0x001A238C
*/
// Range: 0x1A2340 -> 0x1A238C
void zEntHangable_Reset(class _zEntHangable * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A2340 -> 0x1A238C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2390 -> 0x001A2398
*/
// Range: 0x1A2390 -> 0x1A2398
void zEntHangable_Load(class _zEntHangable * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A2390 -> 0x1A2398
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A23A0 -> 0x001A23A8
*/
// Range: 0x1A23A0 -> 0x1A23A8
void zEntHangable_Save(class _zEntHangable * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A23A0 -> 0x1A23A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A23B0 -> 0x001A2A78
*/
// Range: 0x1A23B0 -> 0x1A2A78
void zEntHangable_SetMatrix(class _zEntHangable * ent /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1A23B0 -> 0x1A2A78
        class _xVec3 rot; // r29+0x120
        class _xVec3 * orot; // r19
        class _xVec3 * pos; // r18
        class _xVec3 * opos; // r17
        signed int moving; // r19
        float height; // r2
        class _xMat3x3 spinMat; // r29+0xF0
        class _xMat4x3 tmpMat; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2A80 -> 0x001A2DE4
*/
// Range: 0x1A2A80 -> 0x1A2DE4
signed int zEntHangableEventCB(class xBase * from /* r20 */, class xBase * to /* r2 */, unsigned int toEvent /* r19 */, class xBase * toParamWidget /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1A2A80 -> 0x1A2DE4
        class _zEnt * follow; // r2
        class _zEnt * shagent; // r2
        unsigned int oldvisible; // r17
        class _zEntHangable * ent; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A2DF0 -> 0x001A3198
*/
// Range: 0x1A2DF0 -> 0x1A3198
void zEntHangable_Update(class _zEntHangable * ent /* r18 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1A2DF0 -> 0x1A3198
        class _xVec3 unitHang; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A31A0 -> 0x001A32F4
*/
// Range: 0x1A31A0 -> 0x1A32F4
static void zEntHangable_UpdateFX(class _zEntHangable * ent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1A31A0 -> 0x1A32F4
        class _xVec3 offset; // r29+0x120
        signed int i; // r17
        class _zParEmitter * emitter; // r16
        class _zParEmitterCustomSettings info; // r29+0xC0
        class _xVec3 * local_offset; // r2
        class _xVec3 offset_rlii0006[8]; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3300 -> 0x001A3364
*/
// Range: 0x1A3300 -> 0x1A3364
void zEntHangable_Init(void * ent /* r17 */, void * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A3300 -> 0x1A3364
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3370 -> 0x001A346C
*/
// Range: 0x1A3370 -> 0x1A346C
static void HangableSetup(class _zEntHangable * ent /* r16 */, class p2EntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3370 -> 0x1A346C
        class _xMat3x3 hackMat; // r29+0x20
        class _xVec3 * center; // r2
        class p2EntHangableAsset * hangAsset; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3470 -> 0x001A34C4
*/
// Range: 0x1A3470 -> 0x1A34C4
