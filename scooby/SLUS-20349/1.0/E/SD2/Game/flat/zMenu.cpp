/*
    Compile unit: E:\SD2\Game\flat\zMenu.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int sFirstBoot; // size: 0x4, address: 0x3574D0
static signed int logoTmr; // size: 0x4, address: 0x0
static float time_elapsed; // size: 0x4, address: 0x3574D4
static float time_last; // size: 0x4, address: 0x357DD4
static float time_current; // size: 0x4, address: 0x357DD8
...
static float sAttractMode_timer; // size: 0x4, address: 0x357DDC
static signed int promptSel; // size: 0x4, address: 0x0
static signed int card; // size: 0x4, address: 0x357DE0
static signed int var; // size: 0x4, address: 0x0
static signed int fullCard; // size: 0x4, address: 0x0
static signed int sInMenu; // size: 0x4, address: 0x357DE4
static float holdTmr; // size: 0x4, address: 0x3574D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001320D0 -> 0x001320D8
*/
// Range: 0x1320D0 -> 0x1320D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001320E0 -> 0x00132128
*/
// Range: 0x1320E0 -> 0x132128
void zMenuFMVPlay(char * filename /* r2 */, unsigned int buttons /* r2 */, float time /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x1320E0 -> 0x132128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132130 -> 0x0013213C
*/
// Range: 0x132130 -> 0x13213C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132140 -> 0x001322C8
*/
// Range: 0x132140 -> 0x1322C8
signed int zMenuCardCheckStartup(signed int * bytesNeeded /* r19 */, signed int * availOnDisk /* r18 */) {
    /* anonymous block */ {
        // Range: 0x132140 -> 0x1322C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001322D0 -> 0x00132904
*/
// Range: 0x1322D0 -> 0x132904
unsigned int zMenuLoop() {
    /* anonymous block */ {
        // Range: 0x1322D0 -> 0x132904
        class _xEnt * menu; // r2
        class xBase * title; // r29+0xBC
        signed int ss; // r2
        signed int draw_black; // r21
        signed int ostrich_delay; // r22
        class iColor_tag clear; // r29+0xFC
        class iColor_tag black; // r29+0xF8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132910 -> 0x00132998
*/
// Range: 0x132910 -> 0x132998
void zMenuSetup() {
    /* anonymous block */ {
        // Range: 0x132910 -> 0x132998
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001329A0 -> 0x001329EC
*/
// Range: 0x1329A0 -> 0x1329EC
void zMenuExit() {
    /* anonymous block */ {
        // Range: 0x1329A0 -> 0x1329EC
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001329F0 -> 0x00132A78
*/
// Range: 0x1329F0 -> 0x132A78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132A80 -> 0x00132A88
*/
// Range: 0x132A80 -> 0x132A88
