/*
    Compile unit: E:\SD2\Game\flat\iModel.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int gLastAtomicCount; // size: 0x4, address: 0x357C88
static class RpAtomic * gLastAtomicList[256]; // size: 0x400, address: 0x368EB0
...
class RpHAnimAtomicGlobalVars RpHAnimAtomicGlobals; // size: 0xC, address: 0x2CAA88
class RpAtomic * NextAtomicCallback(class RpAtomic *, void *); // size: 0x0, address: 0x1221A0
class RpAtomic * FindAtomicCallback(class RpAtomic *, void *); // size: 0x0, address: 0x122310
// total size: 0x34
class RxPipeline {
    // Members
public:
...
public:
    ...
    class RpHAnimAnimation * pCurrentAnim; // offset 0x8, size 0x4
    float currentTime; // offset 0xC, size 0x4
    void * pNextFrame; // offset 0x10, size 0x4
    class RpHAnimHierarchy * (* pAnimCallBack)(class RpHAnimHierarchy *, void *); // offset 0x14, size 0x4
    void * pAnimCallBackData; // offset 0x18, size 0x4
    float animCallBackTime; // offset 0x1C, size 0x4
    class RpHAnimHierarchy * (* pAnimLoopCallBack)(class RpHAnimHierarchy *, void *); // offset 0x20, size 0x4
    void * pAnimLoopCallBackData; // offset 0x24, size 0x4
    class RwMatrixTag * pMatrixArray; // offset 0x28, size 0x4
    void * pMatrixArrayUnaligned; // offset 0x2C, size 0x4
    class RpHAnimNodeInfo * pNodeInfo; // offset 0x30, size 0x4
    class RwFrame * parentFrame; // offset 0x34, size 0x4
    signed int maxKeyFrameSize; // offset 0x38, size 0x4
    signed int currentKeyFrameSize; // offset 0x3C, size 0x4
    void (* keyFrameToMatrixCB)(class RwMatrixTag *, void *); // offset 0x40, size 0x4
    void (* keyFrameBlendCB)(void *, void *, void *, float); // offset 0x44, size 0x4
    void (* keyFrameInterpolateCB)(void *, void *, void *, float); // offset 0x48, size 0x4
    void (* keyFrameAddCB)(void *, void *, void *); // offset 0x4C, size 0x4
    class RpHAnimHierarchy * parentHierarchy; // offset 0x50, size 0x4
    signed int offsetInParent; // offset 0x54, size 0x4
    signed int rootParentOffset; // offset 0x58, size 0x4
};
// total size: 0x50
class xCutsceneInfo {
    // Members
...
class RwFreeList {
    // Members
public:
    void * * freeListStack; // offset 0x0, size 0x4
    void * * freeListStackTop; // offset 0x4, size 0x4
    class RwFreeBlock * firstBlock; // offset 0x8, size 0x4
    signed int blockSize; // offset 0xC, size 0x4
    signed int entrySize; // offset 0x10, size 0x4
    signed int alignmentMinusOne; // offset 0x14, size 0x4
    signed int entriesPerBlock; // offset 0x18, size 0x4
    signed int entriesAllocated; // offset 0x1C, size 0x4
    class RwLLLink lFreeList; // offset 0x20, size 0x8
};
// total size: 0x8
class RpPolygon {
    // Members
...
class RwFreeBlock {
    // Members
public:
    class RwFreeBlock * nextBlock; // offset 0x0, size 0x4
};
// total size: 0x14
class RpHAnimAnimation {
    // Members
public:
    class RpHAnimInterpolatorInfo * interpInfo; // offset 0x0, size 0x4
...
// total size: 0xC
class RpHAnimAtomicGlobalVars {
    // Members
public:
    signed int engineOffset; // offset 0x0, size 0x4
    class RwFreeList * HAnimFreeList; // offset 0x4, size 0x4
    class RwFreeList * HAnimAnimationFreeList; // offset 0x8, size 0x4
};
// total size: 0x18
class RwResEntry {
    // Members
...
// total size: 0x28
class RpHAnimInterpolatorInfo {
    // Members
public:
    signed int typeID; // offset 0x0, size 0x4
    signed int keyFrameSize; // offset 0x4, size 0x4
    void (* keyFrameToMatrixCB)(class RwMatrixTag *, void *); // offset 0x8, size 0x4
    void (* keyFrameBlendCB)(void *, void *, void *, float); // offset 0xC, size 0x4
    void (* keyFrameInterpolateCB)(void *, void *, void *, float); // offset 0x10, size 0x4
    void (* keyFrameAddCB)(void *, void *, void *); // offset 0x14, size 0x4
    void (* keyFrameMulRecipCB)(void *, void *); // offset 0x18, size 0x4
    class RpHAnimAnimation * (* keyFrameStreamReadCB)(class RwStream *, class RpHAnimAnimation *); // offset 0x1C, size 0x4
    signed int (* keyFrameStreamWriteCB)(class RpHAnimAnimation *, class RwStream *); // offset 0x20, size 0x4
    signed int (* keyFrameStreamGetSizeCB)(class RpHAnimAnimation *); // offset 0x24, size 0x4
};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121460 -> 0x00121744
*/
// Range: 0x121460 -> 0x121744
void iModelTagEval(class RpAtomic * model /* r2 */, class iModelTag * tag /* r29+0xC0 */, class RwMatrixTag * mat /* r22 */, class _xVec3 * dest /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x121460 -> 0x121744
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121750 -> 0x00121758
*/
// Range: 0x121750 -> 0x121758
unsigned int iModelTagSetup(class iModelTag * tag /* r2 */, class RpAtomic * model /* r2 */, float x /* r29 */, float y /* r29 */, float z /* r29 */) {
    /* anonymous block */ {
        // Range: 0x121750 -> 0x121758
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121760 -> 0x00121774
*/
// Range: 0x121760 -> 0x121774
unsigned int iModelTagIndex(class iModelTag * tag /* r2 */, class RpAtomic * model /* r2 */, signed int v /* r2 */) {
    /* anonymous block */ {
        // Range: 0x121760 -> 0x121774
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121780 -> 0x00121904
*/
// Range: 0x121780 -> 0x121904
static unsigned int iModelTagInternal(class iModelTag * tag /* r17 */, class RpAtomic * model /* r2 */, float x /* r29+0x40 */, float y /* r29+0x40 */, float z /* r29+0x40 */, signed int closeV /* r16 */) {
    /* anonymous block */ {
        // Range: 0x121780 -> 0x121904
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121910 -> 0x00121C88
*/
// Range: 0x121910 -> 0x121C88
unsigned int iModelVertEval(class RpAtomic * model /* r2 */, unsigned int index /* r17 */, unsigned int count /* r29+0xD0 */, class RwMatrixTag * mat /* r22 */, class _xVec3 * vert /* r29+0xC0 */, class _xVec3 * dest /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x121910 -> 0x121C88
        class RpSkin * skin; // r16
        unsigned int numV; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121C90 -> 0x00121C9C
*/
// Range: 0x121C90 -> 0x121C9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121CA0 -> 0x00121D9C
*/
// Range: 0x121CA0 -> 0x121D9C
signed int iModelCull(class RpAtomic * model /* r2 */, class RwMatrixTag * mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x121CA0 -> 0x121D9C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121DA0 -> 0x00121EC4
*/
// Range: 0x121DA0 -> 0x121EC4
void iModelRender(class RpAtomic * model /* r20 */, class RwMatrixTag * mat /* r19 */) {
    /* anonymous block */ {
        // Range: 0x121DA0 -> 0x121EC4
        class RwFrame * frame; // r3
        class RwMatrixTag * pAnimOldMatrix; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00121ED0 -> 0x0012208C
*/
// Range: 0x121ED0 -> 0x12208C
void iModelAnimMatrices(class RpAtomic * model /* r2 */, class _xQuat * quat /* r2 */, class _xVec3 * tran /* r2 */, class RwMatrixTag * mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x121ED0 -> 0x12208C
        class RwMatrixTag * pMatrixArray; // r2
        signed int numFrames; // r13
        signed int i; // r12
        signed int pCurrentFrameFlags; // r11
        class RpHAnimNodeInfo * pCurrentFrame; // r4
        class RwMatrixTag * pMatrixStackTop; // r2
        class RwMatrixTag matrixStack[32]; // r29
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00122090 -> 0x00122100
*/
// Range: 0x122090 -> 0x122100
void iModelQuatToMat(class _xQuat * quat /* r18 */, class _xVec3 * tran /* r17 */, class RwMatrixTag * mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x122090 -> 0x122100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00122100 -> 0x00122144
*/
// Range: 0x122100 -> 0x122144
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001221A0 -> 0x001221CC
*/
// Range: 0x1221A0 -> 0x1221CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001221D0 -> 0x00122240
*/
// Range: 0x1221D0 -> 0x122240
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00122240 -> 0x00122304
*/
// Range: 0x122240 -> 0x122304
class RpAtomic * iModelFileNew(void * buffer /* r2 */, unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x122240 -> 0x122304
        class RwMemory rwmem; // r29+0x38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00122310 -> 0x00122424
*/
// Range: 0x122310 -> 0x122424
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00122430 -> 0x00122438
*/
// Range: 0x122430 -> 0x122438
void iModelInit() {
    /* anonymous block */ {
        // Range: 0x122430 -> 0x122438
    }
