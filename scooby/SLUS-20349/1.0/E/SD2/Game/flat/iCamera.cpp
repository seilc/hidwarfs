/*
    Compile unit: E:\SD2\Game\flat\iCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float sCameraNearClip; // size: 0x4, address: 0x357528
float sCameraFarClip; // size: 0x4, address: 0x35752C
float xCameraLastFov; // size: 0x4, address: 0x0
class RwCamera * globalCamera; // size: 0x4, address: 0x357E30
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001382D0 -> 0x00138838
*/
// Range: 0x1382D0 -> 0x138838
void iCameraUpdateFog(class RwCamera * cam /* r23 */, signed long t /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1382D0 -> 0x138838
        unsigned int bite_me; // r16
        float a; // r29+0xC0
        class iFogParams * fb; // r19
        class iFogParams * fa; // r18
        class iFogParams * fp; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138840 -> 0x00138A94
*/
// Range: 0x138840 -> 0x138A94
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138AA0 -> 0x00138AE8
*/
// Range: 0x138AA0 -> 0x138AE8
void iCameraSetNearFarClip(float near /* r29 */, float far /* r29 */) {
    /* anonymous block */ {
        // Range: 0x138AA0 -> 0x138AE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138AF0 -> 0x00138B00
*/
// Range: 0x138AF0 -> 0x138B00
void iCameraRemoveEnv(class RwCamera * camera /* r2 */, class iEnv * env_geom /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138AF0 -> 0x138B00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138B00 -> 0x00138B3C
*/
// Range: 0x138B00 -> 0x138B3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138BE0 -> 0x00138C30
*/
// Range: 0x138BE0 -> 0x138C30
void iCameraUpdatePos(class RwCamera * cam /* r2 */, class _xMat4x3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138BE0 -> 0x138C30
        class RwMatrixTag * m; // r17
        class RwFrame * f; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138C30 -> 0x00138D34
*/
// Range: 0x138C30 -> 0x138D34
void iCameraFrustumPlanes(class RwCamera * cam /* r2 */, class _xVec4 * frustplane /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138C30 -> 0x138D34
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138D40 -> 0x00138D4C
*/
// Range: 0x138D40 -> 0x138D4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138D50 -> 0x00138D58
*/
// Range: 0x138D50 -> 0x138D58
void iCameraEnd(class RwCamera * cam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x138D50 -> 0x138D58
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138D60 -> 0x00138DC8
*/
// Range: 0x138D60 -> 0x138DC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138DD0 -> 0x00138E5C
*/
// Range: 0x138DD0 -> 0x138E5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00138E60 -> 0x00138F10
*/
// Range: 0x138E60 -> 0x138F10
class RwCamera * iCameraCreate(signed int width /* r18 */, signed int height /* r17 */) {
    /* anonymous block */ {
        // Range: 0x138E60 -> 0x138F10
        class RwCamera * camera; // r16
        class RwV2d vw; // r29+0x48
    }
}
