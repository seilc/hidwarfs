/*
    Compile unit: E:\SD2\Game\flat\xShadow.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float SHADOW_BF_DOT; // size: 0x4, address: 0x3582D0
static float SHADOW_BOTH; // size: 0x4, address: 0x3582D4
static class RxObjSpace3DVertex * Im3DBuffer; // size: 0x4, address: 0x3582D8
static unsigned int Im3DBufferPos; // size: 0x4, address: 0x3582DC
static unsigned int ShadowNumTriangles; // size: 0x4, address: 0x3582E0
float ShadowThreshold; // size: 0x4, address: 0x357600
float ShadowSubdArea; // size: 0x4, address: 0x0
static class RwCamera * ShadowCamera; // size: 0x4, address: 0x3582F0
static class RwRaster * ShadowCameraRaster; // size: 0x4, address: 0x3582F4
static class RwRaster * ShadowRenderRaster; // size: 0x4, address: 0x3582F8
static class RwV2d ShadowPreviewVerts[2]; // size: 0x10, address: 0x0
static signed int ShadowEnabled; // size: 0x4, address: 0x0
static unsigned int ShadowResolutionIndex; // size: 0x4, address: 0x0
unsigned int ShadowBlur; // size: 0x4, address: 0x0
signed int ShadowAA; // size: 0x4, address: 0x0
float ShadowZoneRadius; // size: 0x4, address: 0x357604
float ShadowStrength; // size: 0x4, address: 0x357608
signed int ShadowFade; // size: 0x4, address: 0x3582FC
static unsigned int sShadowFlags; // size: 0x4, address: 0x358300
static class _xSphere sSphere; // size: 0x10, address: 0x3A6C60
float zlim; // size: 0x4, address: 0x0
float zamt; // size: 0x4, address: 0x0
unsigned int tri_no; // size: 0x4, address: 0x358304
signed int watch_tri; // size: 0x4, address: 0x357610
float shit; // size: 0x4, address: 0x357614
class RpCollisionTriangle * ShadowRenderTriangleCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x1C3460
class tagiRenderInput gRenderBuffer; // size: 0x80, address: 0x3A5980
unsigned int ourGlobals[4096]; // size: 0x4000, address: 0x2B5AD0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
void modelRenderCB(void *); // size: 0x0, address: 0x1C4720
// total size: 0x40
class _xEnv {
    // Members
public:
...
public:
    ...
    class _xMat4x3 m_camViewMatrix; // offset 0x20, size 0x40
    class _xVec4 m_camViewR; // offset 0x60, size 0x10
    class _xVec4 m_camViewU; // offset 0x70, size 0x10
};
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C31E0 -> 0x001C345C
*/
// Range: 0x1C31E0 -> 0x1C345C
static signed int ShadowRender(class RwCamera * shadowCamera /* r17 */, class RpWorld * world /* r20 */, class RpIntersection * shadowZone /* r19 */, float shadowFactor /* r21 */, float fadeDist /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C31E0 -> 0x1C345C
        class _xVec3 B; // r29+0x110
        class _xVec3 A; // r29+0x100
        class RwV3d tr; // r29+0xF0
        class RwV3d scl; // r29+0xE0
        float radius; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C3460 -> 0x001C3910
*/
// Range: 0x1C3460 -> 0x1C3910
static class RpCollisionTriangle * ShadowRenderTriangleCB(class RpCollisionTriangle * collTriangle /* r17 */, void * data /* r2 */) {
    /* anonymous block */ {
        ...
        class RwV3d vShad[3]; // r29+0xD0
        class RwV3d vIn[3]; // r29+0xA0
        class _ProjectionParam * param; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C3910 -> 0x001C39F0
*/
// Range: 0x1C3910 -> 0x1C39F0
static class RwCamera * ShadowCameraUpdate(class RwCamera * shadowCamera /* r18 */, void * model /* r17 */, void (* renderCB)(void *) /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1C3910 -> 0x1C39F0
        class RwCamera * camera; // r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C39F0 -> 0x001C3A74
*/
// Range: 0x1C39F0 -> 0x1C3A74
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C3A80 -> 0x001C3AD0
*/
// Range: 0x1C3A80 -> 0x1C3AD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C3AD0 -> 0x001C3CD4
*/
// Range: 0x1C3AD0 -> 0x1C3CD4
void xShadowRender(class _xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1C3AD0 -> 0x1C3CD4
        float radius; // r29+0x4C
        class _xVec3 center; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C3CE0 -> 0x001C44D8
*/
// Range: 0x1C3CE0 -> 0x1C44D8
void xShadowReceiveShadow(class _xEnt * ent /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1C3CE0 -> 0x1C44D8
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        class RwRGBA * _col; // r2
        float len; // r29+0x220
        class RwV3d c; // r29+0x210
        class _xVec3 * v2; // r20
        class _xVec3 * v1; // r19
        class _xVec3 * v0; // r18
        class RwV3d vShad[3]; // r29+0x1C0
        class RwV3d vIn[3]; // r29+0x190
        class RxObjSpace3DVertex * imv; // r17
        unsigned int max_verts; // r4
        class xModelInstance * model; // r3
        unsigned char val; // r16
        float shadowFactor; // r29+0x220
        class RpGeometry * geom; // r29+0xC0
        class RpTriangle * tri; // r22
        class _xVec3 * xvert; // r23
        unsigned int numverts; // r2
        unsigned int i; // r30
        class RwV3d tr; // r29+0x200
        class RwV3d scl; // r29+0x1F0
        float radius; // r23
        class RwMatrixTag invMatrix; // r29+0x150
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C44E0 -> 0x001C45E4
*/
// Range: 0x1C44E0 -> 0x1C45E4
unsigned int xShadowReceiveShadowSetup(class _xEnt * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1C44E0 -> 0x1C45E4
        unsigned int rsf_valid; // r7
        unsigned int sceneID; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C45F0 -> 0x001C471C
*/
// Range: 0x1C45F0 -> 0x1C471C
static unsigned int xShadowEntIsOutsideFrustum(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1C45F0 -> 0x1C471C
        unsigned int test; // r2
        class RwSphere worldsph; // r29+0x40
        class RwCamera * cam; // r17
        class RwMatrixTag * mat; // r16
        class RwV3d * at; // r2
        class RwV3d * up; // r2
        float atomicScale; // r29+0x50
        float zScale2; // r1
        float yScale2; // r2
        float xScale2; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4720 -> 0x001C4728
*/
// Range: 0x1C4720 -> 0x1C4728
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4730 -> 0x001C4C70
*/
// Range: 0x1C4730 -> 0x1C4C70
void xShadowRenderWorld(class _xVec3 * center /* r21 */, float radius /* r25 */) {
    /* anonymous block */ {
        // Range: 0x1C4730 -> 0x1C4C70
        class _xCollis ecrec; // r29+0x290
        class _xVec3 hit; // r29+0x2E0
        signed int i; // r30
        float env_dist; // r20
        float ent_dist; // r29+0x2F0
        unsigned int hit_ent; // r29+0xC0
        unsigned int hit_env; // r17
        float sf[3][2]; // r29+0x270
        class _xCollis crec[3]; // r29+0x1A0
        class _xRay3 R[3]; // r29+0x130
        class _xVec3 * rt; // r16
        class _xVec3 * up; // r22
        class _xVec3 * at; // r23
        class RwMatrixTag * camMatrix; // r2
        class _xSphere zone; // r29+0x120
        class RpIntersection shadowZone; // r29+0x100
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4C70 -> 0x001C4DB8
*/
// Range: 0x1C4C70 -> 0x1C4DB8
void xShadowCameraUpdate(void * model /* r20 */, void (* renderCB)(void *) /* r19 */, class _xVec3 * center /* r18 */, float radius /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C4C70 -> 0x1C4DB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4DC0 -> 0x001C4DE0
*/
// Range: 0x1C4DC0 -> 0x1C4DE0
signed int xShadowCameraCreate() {
    /* anonymous block */ {
        // Range: 0x1C4DC0 -> 0x1C4DE0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4DE0 -> 0x001C4E68
*/
// Range: 0x1C4DE0 -> 0x1C4E68
void xShadowSetLight(class _xVec3 * target_pos /* r16 */, class _xVec3 * in_vec /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1C4DE0 -> 0x1C4E68
        class RwMatrixTag * camMatrix; // r17
        class RwFrame * camFrame; // r16
        class _xMat4x3 matrix; // r29+0x30
        class _xVec3 zvec; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C4E70 -> 0x001C511C
*/
// Range: 0x1C4E70 -> 0x1C511C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5120 -> 0x001C5240
*/
// Range: 0x1C5120 -> 0x1C5240
