/*
    Compile unit: E:\SD2\Game\flat\zCounter.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class xBase * zCounterDebugModeIteratorCB(class xBase *, class zScene *, void *); // size: 0x0, address: 0x0
signed int zCounterEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A1E10
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1E10 -> 0x001A1EDC
*/
// Range: 0x1A1E10 -> 0x1A1EDC
signed int zCounterEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A1E10 -> 0x1A1EDC
        class _zCounter * t; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1EE0 -> 0x001A1F28
*/
// Range: 0x1A1EE0 -> 0x1A1F28
void zCounterLoad(class _zCounter * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A1EE0 -> 0x1A1F28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1F30 -> 0x001A1F78
*/
// Range: 0x1A1F30 -> 0x1A1F78
void zCounterSave(class _zCounter * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A1F30 -> 0x1A1F78
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1F80 -> 0x001A1FD8
*/
// Range: 0x1A1F80 -> 0x1A1FD8
void zCounterReset(class xBase * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A1F80 -> 0x1A1FD8
        class _zCounter * t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1FE0 -> 0x001A204C
*/
// Range: 0x1A1FE0 -> 0x1A204C
void zCounterInit(void * b /* r2 */, void * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A1FE0 -> 0x1A204C
    }
}
