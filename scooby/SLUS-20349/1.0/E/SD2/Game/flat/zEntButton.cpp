/*
    Compile unit: E:\SD2\Game\flat\zEntButton.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zEntButtonEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A38A0
void zEntButton_Move(class _zEntButton *, class _xScene *, float, class _xEntFrame *); // size: 0x0, address: 0x1A3D40
void zEntButton_Update(class _zEntButton *, class _xScene *, float); // size: 0x0, address: 0x1A3B10
// total size: 0x0
class xSerial {};
// total size: 0x10
...
// total size: 0x190
class _zEntButton : public _zEnt {
    // Members
public:
    class zEntButtonAsset * basset; // offset 0xEC, size 0x4
    class _xEntMotion motion; // offset 0xF0, size 0x80
    unsigned int state; // offset 0x170, size 0x4
    float speed; // offset 0x174, size 0x4
    unsigned int oldState; // offset 0x178, size 0x4
    signed int oldMotState; // offset 0x17C, size 0x4
    unsigned int counter; // offset 0x180, size 0x4
};
// total size: 0x8
class RwTexCoords {
    // Members
...
class zEntButtonAsset {
    // Members
public:
    unsigned int actMethod; // offset 0x0, size 0x4
    signed int initButtonState; // offset 0x4, size 0x4
    signed int isReset; // offset 0x8, size 0x4
    signed int isSpringBB; // offset 0xC, size 0x4
    unsigned char buttonFlags; // offset 0x10, size 0x1
};
// total size: 0x18
class RwBBox {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A38A0 -> 0x001A3A8C
*/
// Range: 0x1A38A0 -> 0x1A3A8C
signed int zEntButtonEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A38A0 -> 0x1A3A8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3A90 -> 0x001A3A98
*/
// Range: 0x1A3A90 -> 0x1A3A98
unsigned int zEntButton_CheckState(class _zEntButton * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3A90 -> 0x1A3A98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3AA0 -> 0x001A3ACC
*/
// Range: 0x1A3AA0 -> 0x1A3ACC
unsigned int zEntButton_ButtBounce(class _zEntButton * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3AA0 -> 0x1A3ACC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3AD0 -> 0x001A3AE4
*/
// Range: 0x1A3AD0 -> 0x1A3AE4
unsigned int zEntButton_Stand(class _zEntButton * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3AD0 -> 0x1A3AE4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3AF0 -> 0x001A3B10
*/
// Range: 0x1A3AF0 -> 0x1A3B10
unsigned int zEntButton_Headbutt(class _zEntButton * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3AF0 -> 0x1A3B10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3B10 -> 0x001A3C6C
*/
// Range: 0x1A3B10 -> 0x1A3C6C
void zEntButton_Update(class _zEntButton * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x1A3B10 -> 0x1A3C6C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3C70 -> 0x001A3D10
*/
// Range: 0x1A3C70 -> 0x1A3D10
void zEntButton_Reset(class _zEntButton * ent /* r16 */, class _xScene * sc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1A3C70 -> 0x1A3D10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D10 -> 0x001A3D18
*/
// Range: 0x1A3D10 -> 0x1A3D18
void zEntButton_Load(class _zEntButton * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3D10 -> 0x1A3D18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D20 -> 0x001A3D28
*/
// Range: 0x1A3D20 -> 0x1A3D28
void zEntButton_Save(class _zEntButton * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3D20 -> 0x1A3D28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D30 -> 0x001A3D38
*/
// Range: 0x1A3D30 -> 0x1A3D38
void zEntButton_Setup(class _zEntButton * ent /* r2 */, class _xScene * sc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3D30 -> 0x1A3D38
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D40 -> 0x001A3D48
*/
// Range: 0x1A3D40 -> 0x1A3D48
void zEntButton_Move(class _zEntButton * ent /* r2 */, class _xScene * s /* r2 */, float dt /* r29 */, class _xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A3D40 -> 0x1A3D48
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3D50 -> 0x001A3E40
*/
// Range: 0x1A3D50 -> 0x1A3E40
void zEntButton_Init(class _zEntButton * ent /* r17 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A3D50 -> 0x1A3E40
        class p2EntMotionAsset * emasset; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A3E40 -> 0x001A3E48
*/
// Range: 0x1A3E40 -> 0x1A3E48
