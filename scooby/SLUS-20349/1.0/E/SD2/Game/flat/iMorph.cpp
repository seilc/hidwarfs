/*
    Compile unit: E:\SD2\Game\flat\iMorph.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class RpGeometry * s_geom; // size: 0x4, address: 0x357CF0
static class RpMorphTarget * s_tgt; // size: 0x4, address: 0x357CF4
static float * s_alloc; // size: 0x4, address: 0x357CF8
static float * s_vTemp; // size: 0x4, address: 0x357CFC
static float * s_nTemp; // size: 0x4, address: 0x357D00
static signed int s_numV; // size: 0x4, address: 0x357D04
// total size: 0xC
class RxClusterRef {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001265F0 -> 0x00126730
*/
// Range: 0x1265F0 -> 0x126730
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126730 -> 0x0012682C
*/
// Range: 0x126730 -> 0x12682C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126830 -> 0x0012690C
*/
// Range: 0x126830 -> 0x12690C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126910 -> 0x00126950
*/
// Range: 0x126910 -> 0x126950
void iMorphRender(class RpAtomic * model /* r2 */, class RwMatrixTag * mat /* r2 */, signed short * * v_array /* r2 */, signed short * weight /* r2 */, unsigned int normals /* r2 */, float scale /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x126910 -> 0x126950
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00126950 -> 0x001269DC
*/
// Range: 0x126950 -> 0x1269DC
void iMorphOptimize(class RpAtomic * model /* r2 */, signed int normals /* r17 */) {
    /* anonymous block */ {
        // Range: 0x126950 -> 0x1269DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001269E0 -> 0x00127230
*/
// Range: 0x1269E0 -> 0x127230
static void MorphCommon(class RpAtomic * model /* r29+0x11C */, class RwMatrixTag * mat /* r29+0x110 */, signed short * * v_array /* r29+0x10C */, signed short * weight /* r2 */, unsigned int normals /* r23 */, float scale /* r20 */, signed int dorender /* r29+0x108 */) {
    /* anonymous block */ {
        // Range: 0x1269E0 -> 0x127230
        class DirtyMorph * dm; // r3
        class RpUserDataArray * usr; // r29+0xEC
        signed int lockMode; // r29+0xD0
        class RwV3d * nold; // r29+0xC0
        class RwV3d * vold; // r29+0xB0
        signed int wsum; // r17
