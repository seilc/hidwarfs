/*
    Compile unit: E:\SD2\Game\flat\xEnt.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char * g_xEnt_FMT; // size: 0x4, address: 0x0
static float nsn_angle; // size: 0x4, address: 0x3574B0
static float sEntityTimePassed; // size: 0x4, address: 0x357D10
static class _xBox all_ents_box; // size: 0x18, address: 0x3696E0
static signed int all_ents_box_init; // size: 0x4, address: 0x357D14
static class _xEnt * * dbg_xents; // size: 0x4, address: 0x357D18
static unsigned short dbg_num; // size: 0x2, address: 0x357D1C
static signed short dbg_idx; // size: 0x2, address: 0x3574B4
static signed int dbg_mode; // size: 0x4, address: 0x357D20
static signed int dbg_holding_inc; // size: 0x4, address: 0x357D24
static signed int dbg_holding_dec; // size: 0x4, address: 0x357D28
static float dbg_tmr; // size: 0x4, address: 0x357D2C
static float dbg_ltm; // size: 0x4, address: 0x357D30
static class xModCollRec * mcrecs; // size: 0x4, address: 0x357D34
static signed int num_mcrecs; // size: 0x4, address: 0x357D38
static signed long mctime; // size: 0x4, address: 0x357D40
static class xModCollRec smcrecs[101]; // size: 0xCA0, address: 0x369700
static signed int mcmode; // size: 0x4, address: 0x3574B8
static char scoll_name[6][6]; // size: 0x24, address: 0x28F840
...
signed int CmpModCollLtime(void *, void *); // size: 0x0, address: 0x128AB0
signed int CmpModCollCtime(void *, void *); // size: 0x0, address: 0x128B10
unsigned int gActiveHeap; // size: 0x4, address: 0x357CAC
void xModCollCB(); // size: 0x0, address: 0x1287F0
void xEntDebugCB(); // size: 0x0, address: 0x129B40
float ShadowThreshold; // size: 0x4, address: 0x357600
class _xEnt * xEntCollCheckOneTrigNoDepen(class _xEnt *, class _xScene *, void *); // size: 0x0, address: 0x12ADA0
class _xVec3 g_NY3; // size: 0xC, address: 0x342E58
class _xEnt * xEntCollCheckOneEntNoDepen(class _xEnt *, class _xScene *, void *); // size: 0x0, address: 0x12AE00
class _xVec3 g_O3; // size: 0xC, address: 0x342E28
void xEntUpdateTimer(class _xEnt *); // size: 0x0, address: 0x12D140
void xEntRender(class _xEnt *); // size: 0x0, address: 0x129BE0
void xEntUpdate(class _xEnt *, class _xScene *, float); // size: 0x0, address: 0x12C470
void xEntDefaultTranslate(class _xEnt *, class _xVec3 *); // size: 0x0, address: 0x12C180
void xEntDefaultBoundUpdate(class _xEnt *, class _xVec3 *); // size: 0x0, address: 0x12C260
// total size: 0xE8
...
class xModCollRec {
    // Members
public:
    class _xEnt * owner; // offset 0x0, size 0x4
    unsigned int nusing; // offset 0x4, size 0x4
    signed long ctime; // offset 0x8, size 0x4
    signed long ltime; // offset 0x10, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128790 -> 0x001287E8
*/
// Range: 0x128790 -> 0x1287E8
unsigned int xEntIsVisible(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128790 -> 0x1287E8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001287F0 -> 0x00128AA4
*/
// Range: 0x1287F0 -> 0x128AA4
static void xModCollCB() {
    /* anonymous block */ {
        // Range: 0x1287F0 -> 0x128AA4
        float scale; // r20
        signed int i; // r18
        class xModCollRec * mc; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128AB0 -> 0x00128B10
*/
// Range: 0x128AB0 -> 0x128B10
static signed int CmpModCollLtime(void * a /* r2 */, void * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128AB0 -> 0x128B10
        class xModCollRec * mcb; // r2
        class xModCollRec * mca; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128B10 -> 0x00128B44
*/
// Range: 0x128B10 -> 0x128B44
static signed int CmpModCollCtime(void * a /* r2 */, void * b /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128B10 -> 0x128B44
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128B50 -> 0x00128BEC
*/
// Range: 0x128B50 -> 0x128BEC
void xModCollAddSample(class _xEnt * xent /* r2 */, signed long elapsed /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128B50 -> 0x128BEC
        class xModCollRec * mc; // r2
        class xModCollRec * end; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128BF0 -> 0x00128C9C
*/
// Range: 0x128BF0 -> 0x128C9C
static void xModCollAdd(class _xEnt * xent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x128BF0 -> 0x128C9C
        class xModCollRec * mc; // r2
        class xModCollRec * end; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128CA0 -> 0x00128D54
*/
// Range: 0x128CA0 -> 0x128D54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128D60 -> 0x00128FC0
*/
// Range: 0x128D60 -> 0x128FC0
static void xEntDebugIPad() {
    /* anonymous block */ {
        // Range: 0x128D60 -> 0x128FC0
        float now; // r29+0x10
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00128FC0 -> 0x00129A4C
*/
// Range: 0x128FC0 -> 0x129A4C
static void xEntDebugWrite(class _xEnt * xent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x128FC0 -> 0x129A4C
        class _xVec3 lhdng; // r29+0x130
        signed int i; // r17
        class _xCollis * scoll; // r16
        class _xVec3 ang; // r29+0x120
        class _xMat3x3 mat_norm; // r29+0xE0
        class _xVec3 scale; // r29+0x110
        class _xVec3 * ovel; // r2
        class _xVec3 * vel; // r2
        char str[40]; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129A50 -> 0x00129B40
*/
// Range: 0x129A50 -> 0x129B40
static char * xEntCollTypeStrAll(char * str /* r17 */, unsigned char type /* r2 */) {
    /* anonymous block */ {
        // Range: 0x129A50 -> 0x129B40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129B40 -> 0x00129B98
*/
// Range: 0x129B40 -> 0x129B98
static void xEntDebugCB() {
    /* anonymous block */ {
        // Range: 0x129B40 -> 0x129B98
        class _xEnt * xent; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129BA0 -> 0x00129BAC
*/
// Range: 0x129BA0 -> 0x129BAC
class _xBox * xEntGetAllEntsBox() {
    /* anonymous block */ {
        // Range: 0x129BA0 -> 0x129BAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129BB0 -> 0x00129BB8
*/
// Range: 0x129BB0 -> 0x129BB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129BC0 -> 0x00129BDC
*/
// Range: 0x129BC0 -> 0x129BDC
void xEntSetMaterialMul(class _xEnt * ent /* r2 */, float r /* r29 */, float g /* r29 */, float b /* r29 */) {
    /* anonymous block */ {
        // Range: 0x129BC0 -> 0x129BDC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00129BE0 -> 0x0012A2B0
*/
// Range: 0x129BE0 -> 0x12A2B0
void xEntRender(class _xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x129BE0 -> 0x12A2B0
        float rad; // r29+0x70
        class _xVec3 * campos; // r2
        class _xVec3 * pos; // r2
        signed int reset_material_colors; // r21
        class RwTexture * texptr; // r2
        class RwTexture * texptr; // r2
        unsigned int texid; // r2
        class _zGroup * g; // r2
        class RwTexture * texptr; // r2
        unsigned int texid; // r2
        class _zGroup * g; // r2
        class zSurfaceProps * pp; // r2
        class RxPipeline * oldPipe; // r20
        signed int setPipeline; // r19
        signed int setMaterialTextureRestore; // r18
        signed int we_altered_the_alpha_on_the_material; // r17
        signed int fadeout_type; // @ 0x00357D48
        signed char init; // @ 0x00357D4C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A2B0 -> 0x0012A6F4
*/
// Range: 0x12A2B0 -> 0x12A6F4
void xEntCollideWalls(class _xEnt * p /* r17 */, class _xScene * sc /* r16 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x12A2B0 -> 0x12A6F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A700 -> 0x0012A960
*/
// Range: 0x12A700 -> 0x12A960
void xEntCollideCeiling(class _xEnt * p /* r22 */, class _xScene * sc /* r21 */, float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x12A700 -> 0x12A960
        float ceil_dist; // r1
        class _xEnt * fent; // r2
        class _xCollis * mf; // r19
        class _xCollis * ml; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012A960 -> 0x0012AD9C
*/
// Range: 0x12A960 -> 0x12AD9C
void xEntCollideFloor(class _xEnt * p /* r16 */, class _xScene * sc /* r23 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x12A960 -> 0x12AD9C
        float flr_dist; // r29+0xB0
        class _xEnt * fent; // r2
        class _xCollis * mf; // r20
        signed int stepping; // r30
        class _xCollis * ml; // r19
        unsigned char idx; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012ADA0 -> 0x0012AE00
*/
// Range: 0x12ADA0 -> 0x12AE00
class _xEnt * xEntCollCheckOneTrigNoDepen(class _xEnt * ent /* r2 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12ADA0 -> 0x12AE00
        class _xEnt * p; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012AE00 -> 0x0012B180
*/
// Range: 0x12AE00 -> 0x12B180
class _xEnt * xEntCollCheckOneEntNoDepen(class _xEnt * ent /* r16 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12AE00 -> 0x12B180
        float hsqr; // r29+0x70
        float dz; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B180 -> 0x0012B304
*/
// Range: 0x12B180 -> 0x12B304
void xEntEndCollCheckTrigs(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12B180 -> 0x12B304
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B310 -> 0x0012B37C
*/
// Range: 0x12B310 -> 0x12B37C
void xEntBeginCollCheckTrigs(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12B310 -> 0x12B37C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B380 -> 0x0012B3C8
*/
// Range: 0x12B380 -> 0x12B3C8
void xEntCollCheckNPCs(class _xEnt * p /* r16 */, class _xScene * sc /* r2 */, class _xEnt * (* hitIt)(class _xEnt *, class _xScene *, void *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12B380 -> 0x12B3C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B3D0 -> 0x0012B418
*/
// Range: 0x12B3D0 -> 0x12B418
void xEntCollCheckDyns(class _xEnt * p /* r16 */, class _xScene * sc /* r2 */, class _xEnt * (* hitIt)(class _xEnt *, class _xScene *, void *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12B3D0 -> 0x12B418
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B420 -> 0x0012B468
*/
// Range: 0x12B420 -> 0x12B468
void xEntCollCheckStats(class _xEnt * p /* r16 */, class _xScene * sc /* r2 */, class _xEnt * (* hitIt)(class _xEnt *, class _xScene *, void *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12B420 -> 0x12B468
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B470 -> 0x0012B49C
*/
// Range: 0x12B470 -> 0x12B49C
void xEntEndCollide(class _xEnt * ent /* r2 */, class _xScene * sc /* r2 */, float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x12B470 -> 0x12B49C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B4A0 -> 0x0012B634
*/
// Range: 0x12B4A0 -> 0x12B634
void xEntBeginCollide(class _xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12B4A0 -> 0x12B634
        class _xCollis * coll; // r2
        unsigned char idx; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012B640 -> 0x0012BC48
*/
// Range: 0x12B640 -> 0x12BC48
void xEntCollide(class _xEnt * ent /* r18 */, class _xScene * sc /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12B640 -> 0x12BC48
        class _xRay3 flray; // r29+0x50
        class _xCollis * coll; // r16
        float depen_len; // r2
        float h_dot_n; // r29+0x80
        class _xCollis * coll; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012BC50 -> 0x0012BE60
*/
// Range: 0x12BC50 -> 0x12BE60
void xEntApplyPhysics(class _xEnt * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x12BC50 -> 0x12BE60
        float scale; // r1
        float tdrag; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012BE60 -> 0x0012BEE8
*/
// Range: 0x12BE60 -> 0x12BEE8
void xEntMove(class _xEnt * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x12BE60 -> 0x12BEE8
        class _xEntFrame * dframe; // r2
        class _xVec3 dpos; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012BEF0 -> 0x0012C178
*/
// Range: 0x12BEF0 -> 0x12C178
void xEntMotionToMatrix(class _xEnt * ent /* r17 */, class _xEntFrame * frame /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12BEF0 -> 0x12C178
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C180 -> 0x0012C254
*/
// Range: 0x12C180 -> 0x12C254
void xEntDefaultTranslate(class _xEnt * ent /* r2 */, class _xVec3 * dpos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12C180 -> 0x12C254
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C260 -> 0x0012C2B4
*/
// Range: 0x12C260 -> 0x12C2B4
void xEntDefaultBoundUpdate(class _xEnt * ent /* r2 */, class _xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12C260 -> 0x12C2B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C2C0 -> 0x0012C384
*/
// Range: 0x12C2C0 -> 0x12C384
void xEntEndUpdate(class _xEnt * ent /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12C2C0 -> 0x12C384
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C390 -> 0x0012C46C
*/
// Range: 0x12C390 -> 0x12C46C
void xEntBeginUpdate(class _xEnt * ent /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12C390 -> 0x12C46C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C470 -> 0x0012C6C4
*/
// Range: 0x12C470 -> 0x12C6C4
void xEntUpdate(class _xEnt * ent /* r17 */, class _xScene * sc /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12C470 -> 0x12C6C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C6D0 -> 0x0012C774
*/
// Range: 0x12C6D0 -> 0x12C774
class xModelInstance * xEntLoadModel(class _xEnt * ent /* r18 */, class RpAtomic * imodel /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12C6D0 -> 0x12C774
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012C780 -> 0x0012CB5C
*/
// Range: 0x12C780 -> 0x12CB5C
void xEntReset(class _xEnt * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12C780 -> 0x12CB5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012CB60 -> 0x0012CBC8
*/
// Range: 0x12CB60 -> 0x12CBC8
void xEntLoad(class _xEnt * ent /* r16 */, class xSerial * s /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12CB60 -> 0x12CBC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012CBD0 -> 0x0012CC74
*/
// Range: 0x12CBD0 -> 0x12CC74
void xEntSave(class _xEnt * ent /* r17 */, class xSerial * s /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12CBD0 -> 0x12CC74
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012CC80 -> 0x0012CD54
*/
// Range: 0x12CC80 -> 0x12CD54
void xEntSetup(class _xEnt * ent /* r19 */) {
    /* anonymous block */ {
        // Range: 0x12CC80 -> 0x12CD54
        class _xEnt * dent; // r2
        class p2LinkAsset * la; // r5
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012CD60 -> 0x0012CFAC
*/
// Range: 0x12CD60 -> 0x12CFAC
void xEntInitForType(class _xEnt * ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12CD60 -> 0x12CFAC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012CFB0 -> 0x0012D074
*/
// Range: 0x12CFB0 -> 0x12D074
void xEntInit(class _xEnt * ent /* r17 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12CFB0 -> 0x12D074
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D080 -> 0x0012D0D0
*/
// Range: 0x12D080 -> 0x12D0D0
void xEntSceneExit() {
    /* anonymous block */ {
        // Range: 0x12D080 -> 0x12D0D0
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D0D0 -> 0x0012D128
*/
// Range: 0x12D0D0 -> 0x12D128
void xEntSceneInit() {
    /* anonymous block */ {
        // Range: 0x12D0D0 -> 0x12D128
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D130 -> 0x0012D138
*/
// Range: 0x12D130 -> 0x12D138
void xEntSetTimePassed(float sec /* r29 */) {
    /* anonymous block */ {
        // Range: 0x12D130 -> 0x12D138
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D140 -> 0x0012D14C
*/
// Range: 0x12D140 -> 0x12D14C
static void xEntUpdateTimer(class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12D140 -> 0x12D14C
    }
}
