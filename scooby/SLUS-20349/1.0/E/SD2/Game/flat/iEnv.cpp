/*
    Compile unit: E:\SD2\Game\flat\iEnv.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int sBeginDrawFX; // size: 0x4, address: 0x357E68
static class iEnv * lastEnv; // size: 0x4, address: 0x357E6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C7C0 -> 0x0013C82C
*/
// Range: 0x13C7C0 -> 0x13C82C
void iEnvEndRenderFX(class iEnv * env /* r18 */) {
    /* anonymous block */ {
        // Range: 0x13C7C0 -> 0x13C82C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C830 -> 0x0013C8A4
*/
// Range: 0x13C830 -> 0x13C8A4
void iEnvRenderFX(class iEnv * env /* r16 */) {
    /* anonymous block */ {
        // Range: 0x13C830 -> 0x13C8A4
        signed int varRENDERSTATEALPHAPRIMITIVEBUFFER; // r29+0x2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C8B0 -> 0x0013C924
*/
// Range: 0x13C8B0 -> 0x13C924
signed int iEnvBeginRenderFX(class iEnv * env /* r18 */) {
    /* anonymous block */ {
        // Range: 0x13C8B0 -> 0x13C924
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C930 -> 0x0013C990
*/
// Range: 0x13C930 -> 0x13C990
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C990 -> 0x0013C998
*/
// Range: 0x13C990 -> 0x13C998
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C9A0 -> 0x0013C9A8
*/
// Range: 0x13C9A0 -> 0x13C9A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013C9B0 -> 0x0013CA10
*/
// Range: 0x13C9B0 -> 0x13CA10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013CA10 -> 0x0013CA5C
*/
// Range: 0x13CA10 -> 0x13CA5C
void iEnvLoad(class iEnv * env /* r17 */, void * data /* r2 */, signed int dataType /* r16 */) {
    /* anonymous block */ {
        // Range: 0x13CA10 -> 0x13CA5C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0013CA60 -> 0x0013CACC
*/
// Range: 0x13CA60 -> 0x13CACC
static void iEnvSetBSP(class iEnv * env /* r2 */, signed int envDataType /* r2 */, class RpWorld * bsp /* r2 */) {
    /* anonymous block */ {
        // Range: 0x13CA60 -> 0x13CACC
        class RwSurfaceProperties surf_props; // r29+0x10
    }
}
