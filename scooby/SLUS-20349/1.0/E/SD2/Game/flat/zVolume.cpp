/*
    Compile unit: E:\SD2\Game\flat\zVolume.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _zVolume * vols; // size: 0x4, address: 0x3581BC
static unsigned short nvols; // size: 0x2, address: 0x3581C0
signed int gOccludeCount; // size: 0x4, address: 0x3581C4
class _zVolume * gOccludeList[10]; // size: 0x28, address: 0x3780E0
signed int gOccludeCalcCount; // size: 0x4, address: 0x3581C8
class PreCalcOcclude gOccludeCalc[10]; // size: 0x320, address: 0x378110
signed int occludeAlwaysFalse; // size: 0x4, address: 0x0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zVolumeEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1A67B0
...
class PreCalcOcclude {
    // Members
public:
    class _xVec4 DepthVec; // offset 0x0, size 0x10
    class _xVec4 FrustVec[4]; // offset 0x10, size 0x40
};
// total size: 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A67B0 -> 0x001A68D0
*/
// Range: 0x1A67B0 -> 0x1A68D0
signed int zVolumeEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A67B0 -> 0x1A68D0
        signed int i; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A68D0 -> 0x001A6A30
*/
// Range: 0x1A68D0 -> 0x1A6A30
signed int zVolume_OccludeTest(class RpAtomic * model /* r2 */, class RwMatrixTag * mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A68D0 -> 0x1A6A30
        signed int i; // r5
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A6A30 -> 0x001A700C
*/
// Range: 0x1A6A30 -> 0x1A700C
void zVolume_OccludePrecalc(class _xVec3 * camPos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1A6A30 -> 0x1A700C
        float camdot; // r29+0x160
        float depthdot; // r29+0x160
        class _xVec4 locFrustVec[4]; // r29+0x120
        class PreCalcOcclude * calc; // r17
        float s; // r29+0x160
        float c; // r20
        class zVolumeAsset * a; // r18
        class _xVec3 corner[5]; // r29+0xE0
        signed int j; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7010 -> 0x001A702C
*/
// Range: 0x1A7010 -> 0x1A702C
class _zVolume * zVolumeGetVolume(unsigned short n /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7010 -> 0x1A702C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7030 -> 0x001A703C
*/
// Range: 0x1A7030 -> 0x1A703C
class _xBound * zVolumeGetBound(class _zVolume * vol /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A7030 -> 0x1A703C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A7040 -> 0x001A70A8
*/
// Range: 0x1A7040 -> 0x1A70A8
void zVolumeSetup() {
    /* anonymous block */ {
        // Range: 0x1A7040 -> 0x1A70A8
        unsigned int i; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A70B0 -> 0x001A71C4
*/
// Range: 0x1A70B0 -> 0x1A71C4
void zVolumeInit() {
    /* anonymous block */ {
        // Range: 0x1A70B0 -> 0x1A71C4
        class zVolumeAsset * asset; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A71D0 -> 0x001A71D8
*/
// Range: 0x1A71D0 -> 0x1A71D8
void zVolumeLoad(class _zVolume * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A71D0 -> 0x1A71D8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A71E0 -> 0x001A71E8
*/
// Range: 0x1A71E0 -> 0x1A71E8
void zVolumeSave(class _zVolume * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A71E0 -> 0x1A71E8
    }
}
