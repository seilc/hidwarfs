/*
    Compile unit: E:\SD2\Game\flat\zEntBubble.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class RpAtomic * gBubbleModel; // size: 0x4, address: 0x358100
static class _zParEmitter * sEmitGumWad; // size: 0x4, address: 0x358104
static class _zParEmitter * sEmitSoapFlight; // size: 0x4, address: 0x358108
class zGlobals globals; // size: 0x3330, address: 0x362FD0
class _xMat4x3 g_I3; // size: 0x40, address: 0x342E70
void zEntBubble_Move(class _zEntBubble *, class _xScene *, float, class _xEntFrame *); // size: 0x0, address: 0x19B090
void xEntDefaultBoundUpdate(class _xEnt *, class _xVec3 *); // size: 0x0, address: 0x12C260
void zEntBubble_Update(class _zEntBubble *, class _xScene *, float); // size: 0x0, address: 0x19B0A0
signed int zEntBubbleEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x19AEE0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019AD70 -> 0x0019AEDC
*/
// Range: 0x19AD70 -> 0x19AEDC
static void zEntBubble_FX(class _zEntBubble * ent /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x19AD70 -> 0x19AEDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019AEE0 -> 0x0019AEE8
*/
// Range: 0x19AEE0 -> 0x19AEE8
signed int zEntBubbleEventCB() {
    /* anonymous block */ {
        // Range: 0x19AEE0 -> 0x19AEE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019AEF0 -> 0x0019AFDC
*/
// Range: 0x19AEF0 -> 0x19AFDC
void zEntBubble_Render() {
    /* anonymous block */ {
        // Range: 0x19AEF0 -> 0x19AFDC
        class RwRGBA colsoap; // r29+0x5C
        class zScene * sc; // r17
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019AFE0 -> 0x0019B078
*/
// Range: 0x19AFE0 -> 0x19B078
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B080 -> 0x0019B090
*/
// Range: 0x19B080 -> 0x19B090
void zEntBubble_Pop(class _zEntBubble * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19B080 -> 0x19B090
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B090 -> 0x0019B098
*/
// Range: 0x19B090 -> 0x19B098
void zEntBubble_Move(class _xEntFrame * frame /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19B090 -> 0x19B098
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B0A0 -> 0x0019B770
*/
// Range: 0x19B0A0 -> 0x19B770
void zEntBubble_Update(class _zEntBubble * ent /* r16 */, class _xScene * sc /* r20 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x19B0A0 -> 0x19B770
        enum en_ZVILLAIN_BUBBLE_RESPONSE response; // r2
        class _zEnt * vill; // r19
        class _xCollis * endcoll; // r18
        class _xCollis * coll; // r17
        float lerp; // r4
        class _zParEmitterCustomSettings info; // r29+0x570
        float cpitch; // r29+0x5D0
        float spitch; // r21
        float mag; // r29+0x5D0
        float dz; // r2
        float dy; // r21
        float dx; // r4
        float flyspeed; // r20
        class _xEntCollis coll; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B770 -> 0x0019B968
*/
// Range: 0x19B770 -> 0x19B968
void zEntBubble_Launch(float wait /* r20 */) {
    /* anonymous block */ {
        // Range: 0x19B770 -> 0x19B968
        class _zEntBubble * bub; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B970 -> 0x0019B9C8
*/
// Range: 0x19B970 -> 0x19B9C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019B9D0 -> 0x0019BA58
*/
// Range: 0x19B9D0 -> 0x19BA58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019BA60 -> 0x0019BCD0
*/
// Range: 0x19BA60 -> 0x19BCD0
static class _zEnt * AutoTarget() {
    /* anonymous block */ {
        // Range: 0x19BA60 -> 0x19BCD0
        float spitch; // r29+0x90
        float xzdist; // r22
        float dz; // r2
        float dy; // r21
        float dx; // r3
        class _zEnt * * vill; // r2
        class _zEnt * near; // r17
        float nearDist; // r20
        float pitchSin; // r29+0x8C
        float plusAngle; // r30
        float minusAngle; // r22
        float dirAngle; // r21
        unsigned int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019BCD0 -> 0x0019BEB4
*/
// Range: 0x19BCD0 -> 0x19BEB4
void zEntBubble_SceneInit(class zScene * scene /* r16 */) {
    /* anonymous block */ {
        // Range: 0x19BCD0 -> 0x19BEB4
        class _xEntFrame * frameBlock; // r2
        class _zEntBubble * bubbleBlock; // r2
        unsigned int bufsize; // r29+0x7C
