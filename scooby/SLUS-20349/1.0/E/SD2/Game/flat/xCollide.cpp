/*
    Compile unit: E:\SD2\Game\flat\xCollide.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F3D0 -> 0x0012F540
*/
// Range: 0x12F3D0 -> 0x12F540
unsigned int xSphereHitsOBB(class _xSphere * a /* r19 */, class _xBox * b /* r18 */, class _xMat4x3 * m /* r17 */, class _xCollis * coll /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12F3D0 -> 0x12F540
        class _xMat3x3 mnormal; // r29+0x70
        class _xSphere mxa; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F540 -> 0x0012F6DC
*/
// Range: 0x12F540 -> 0x12F6DC
unsigned int xSphereHitsBox(class _xSphere * a /* r2 */, class _xBox * b /* r2 */, class _xCollis * coll /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12F540 -> 0x12F6DC
        float scale; // r1
        class _xIsect isx; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F6E0 -> 0x0012F8E4
*/
// Range: 0x12F6E0 -> 0x12F8E4
unsigned int xSphereHitsSphere(class _xSphere * a /* r17 */, class _xSphere * b /* r2 */, class _xCollis * coll /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12F6E0 -> 0x12F8E4
        float scale; // r1
        float scale; // r1
        class _xIsect isx; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F8F0 -> 0x0012F8F8
*/
// Range: 0x12F8F0 -> 0x12F8F8
void xCollideInit(class _xScene * sc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12F8F0 -> 0x12F8F8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F900 -> 0x0012FA10
*/
// Range: 0x12F900 -> 0x12FA10
enum _xCollsIdx xCollideGetCollsIdx(class _xVec3 * tohit /* r2 */, class _xMat3x3 * mat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12F900 -> 0x12FA10
        float local_z; // r29
        float local_x; // r2
