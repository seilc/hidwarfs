/*
    Compile unit: E:\SD2\Game\flat\zParCmd.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class zCmdInfo sCmdInfo[29]; // size: 0x15C, address: 0x2B51E0
static class _zVolume * sClipVolume[32]; // size: 0x80, address: 0x3AC5D0
static signed int sClipVolumeTotal; // size: 0x4, address: 0x358408
class zGlobals globals; // size: 0x3330, address: 0x362FD0
class _tagClimate gClimate; // size: 0x24, address: 0x36A4F0
float cosSinPolynomial[]; // size: 0x0, address: 0x28A180
// total size: 0x2C
...
class xParCmdAccelerate : public xParCmdAsset {
    // Members
public:
    class _xVec3 acc; // offset 0x8, size 0xC
};
// total size: 0x10
class RwRGBAReal {
    // Members
...
class xParCmdMoveRandomPar : public xParCmdAsset {
    // Members
public:
    class _xVec3 dim; // offset 0x8, size 0xC
};
// total size: 0x10
...
// total size: 0x10
class xParCmdPlayerCollision : public xParCmdAsset {
    // Members
public:
...
// total size: 0x18
class xParCmdScale3rdPolyReg : public xParCmdAsset {
    // Members
public:
...
class xParCmdOrbitLine : public xParCmdAsset {
    // Members
public:
    class _xVec3 p; // offset 0x8, size 0xC
    class _xVec3 axis; // offset 0x14, size 0xC
...
class xParCmdJet : public xParCmdAsset {
    // Members
public:
    class _xVec3 center; // offset 0x8, size 0xC
    class _xVec3 acc; // offset 0x14, size 0xC
    float gravity; // offset 0x20, size 0x4
    float epsilon; // offset 0x24, size 0x4
...
public:
    unsigned int type; // offset 0x0, size 0x4
    unsigned int size; // offset 0x4, size 0x4
    void (* func)(class zParCmd *, class xParGroup *, float); // offset 0x8, size 0x4
};
// total size: 0x18
class xParCmdAlpha3rdPolyReg : public xParCmdAsset {
    // Members
public:
    float constant; // offset 0x8, size 0x4
    float a; // offset 0xC, size 0x4
...
class xParCmdRotPar : public xParCmdAsset {
    // Members
public:
    class _xVec3 min; // offset 0x8, size 0xC
    class _xVec3 max; // offset 0x14, size 0xC
};
// total size: 0x4
...
class xParCmdApplyCamMat : public xParCmdAsset {
    // Members
public:
    class _xVec3 apply; // offset 0x8, size 0xC
};
// total size: 0x60
class RwTexture {
    // Members
...
// total size: 0xC
class xParCmdApplyWind : public xParCmdAsset {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D30F0 -> 0x001D32C0
*/
// Range: 0x1D30F0 -> 0x1D32C0
void xParCmdCustom_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x1D30F0 -> 0x1D32C0
        float oorSqr; // r3
        float rSqr; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D32C0 -> 0x001D33B8
*/
// Range: 0x1D32C0 -> 0x1D33B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D33C0 -> 0x001D37EC
*/
// Range: 0x1D33C0 -> 0x1D37EC
void xParCmdTexAnim_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x1D33C0 -> 0x1D37EC
        class xParCmdTex * tex; // r17
        class xParCmdTexAnim * cmd; // r3
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D37F0 -> 0x001D37F8
*/
// Range: 0x1D37F0 -> 0x1D37F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3800 -> 0x001D39A4
*/
// Range: 0x1D3800 -> 0x1D39A4
void xParCmdJet_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x1D3800 -> 0x1D39A4
        float oorSqr; // r2
        float rSqr; // r1
        float mdt; // r20
        class xParCmdJet * cmd; // r16
        class xPar * p; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D39B0 -> 0x001D3AF0
*/
// Range: 0x1D39B0 -> 0x1D3AF0
void xParCmdRotateAround_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0xE0 */) {
    /* anonymous block */ {
        // Range: 0x1D39B0 -> 0x1D3AF0
        class _xVec3 out_offset; // r29+0xD0
        class _xVec3 offset; // r29+0xC0
        class _xMat3x3 rotmat; // r29+0x70
        class _xVec3 angles; // r29+0xB0
        float radius; // r22
        class _xMat3x3 lookmat; // r29+0x40
        class _xVec3 at; // r29+0xA0
        float radius_growth; // r21
        float yaw; // r20
        class xParCmdRotateAround * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3AF0 -> 0x001D3C58
*/
// Range: 0x1D3AF0 -> 0x1D3C58
void xParCmdDamagePlayer_Update(class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D3AF0 -> 0x1D3C58
        signed int i; // r4
        class _xCollis collis; // r29+0x40
        signed int i; // r4
        class _xBound * pbound; // r17
        class xPar * p; // r16
        signed int last_idx; // @ 0x0035840C
        signed char init; // @ 0x00358410
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3C60 -> 0x001D3DFC
*/
// Range: 0x1D3C60 -> 0x1D3DFC
void xParCmdAnimalMagentism_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x70 */) {
    /* anonymous block */ {
        // Range: 0x1D3C60 -> 0x1D3DFC
        float dist; // r29+0x70
        class _xVec3 vec; // r29+0x60
        float mul; // r20
        class _xVec3 pos; // r29+0x50
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3E00 -> 0x001D3F60
*/
// Range: 0x1D3E00 -> 0x1D3F60
void xParCmdApplyCamMat_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1D3E00 -> 0x1D3F60
        float mul; // r2
        class _xMat4x3 * mat; // r6
        class xParCmdApplyCamMat * cmd; // r4
        class xPar * p; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3F60 -> 0x001D3FB0
*/
// Range: 0x1D3F60 -> 0x1D3FB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3FB0 -> 0x001D4174
*/
// Range: 0x1D3FB0 -> 0x1D4174
void xParCmdRotPar_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r26 */) {
    /* anonymous block */ {
        // Range: 0x1D3FB0 -> 0x1D4174
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4180 -> 0x001D4230
*/
// Range: 0x1D4180 -> 0x1D4230
void xParCmdApplyWind_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r17 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D4180 -> 0x1D4230
        class _xVec3 wind_vec; // r29+0x40
        class xParCmdApplyWind * cmd; // r16
        class xPar * p; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4230 -> 0x001D4474
*/
// Range: 0x1D4230 -> 0x1D4474
void xParCmdRandomVelocityPar_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r16 */, float dt /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x1D4230 -> 0x1D4474
        unsigned int uvelz; // r2
        unsigned int uvely; // r2
        unsigned int uvelx; // r2
        class _xVec3 * velvec; // r2
        class _xVec3 rot; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4480 -> 0x001D45D8
*/
// Range: 0x1D4480 -> 0x1D45D8
void xParCmdPlayerCollision_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D4480 -> 0x1D45D8
        class _xRay3 ray; // r29+0x40
        float t; // r2
        class xParCmdPlayerCollision * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D45E0 -> 0x001D46E4
*/
// Range: 0x1D45E0 -> 0x1D46E4
void xParCmdAlpha3rdPolyReg_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D45E0 -> 0x1D46E4
        float alpha; // r29+0x30
        float t2; // r4
        float t; // r1
        class xParCmdAlpha3rdPolyReg * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D46F0 -> 0x001D47A8
*/
// Range: 0x1D46F0 -> 0x1D47A8
void xParCmdClipVolumes_Update(class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D46F0 -> 0x1D47A8
        class _xCollis collis; // r29+0x60
        signed int i; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D47B0 -> 0x001D48E0
*/
// Range: 0x1D47B0 -> 0x1D48E0
void xParCmdScale_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D47B0 -> 0x1D48E0
        float t2; // r2
        float t; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D48E0 -> 0x001D4A60
*/
// Range: 0x1D48E0 -> 0x1D4A60
void xParCmdSmokeAlpha_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D48E0 -> 0x1D4A60
        float alpha; // r29+0x30
        float t2; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4A60 -> 0x001D4B18
*/
// Range: 0x1D4A60 -> 0x1D4B18
void xParCmdScale3rdPolyReg_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D4A60 -> 0x1D4B18
        float t2; // r5
        float t; // r29
        class xParCmdScale3rdPolyReg * cmd; // r6
        class xPar * p; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4B20 -> 0x001D4BC8
*/
// Range: 0x1D4B20 -> 0x1D4BC8
void xParCmdMoveRandomPar_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x1D4B20 -> 0x1D4BC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4BD0 -> 0x001D4CCC
*/
// Range: 0x1D4BD0 -> 0x1D4CCC
void xParCmdMoveRandom_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r17 */, float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1D4BD0 -> 0x1D4CCC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4CD0 -> 0x001D4D30
*/
// Range: 0x1D4CD0 -> 0x1D4D30
void xParCmdMove_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1D4CD0 -> 0x1D4D30
        class xParCmdMove * cmd; // r4
        class xPar * p; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4D30 -> 0x001D4D90
*/
// Range: 0x1D4D30 -> 0x1D4D90
void xParCmdAccelerate_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1D4D30 -> 0x1D4D90
        class xParCmdAccelerate * cmd; // r4
        class xPar * p; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4D90 -> 0x001D4EE0
*/
// Range: 0x1D4D90 -> 0x1D4EE0
void xParCmdOrbitLine_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x1D4D90 -> 0x1D4EE0
        float force; // r3
        float rSqr; // r29+0x50
        float mdt; // r20
        class xParCmdOrbitLine * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4EE0 -> 0x001D4FE8
*/
// Range: 0x1D4EE0 -> 0x1D4FE8
void xParCmdOrbitPoint_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x50 */) {
    /* anonymous block */ {
        // Range: 0x1D4EE0 -> 0x1D4FE8
        float force; // r3
        float rSqr; // r29+0x50
        float mdt; // r20
        class xParCmdOrbitPoint * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D4FF0 -> 0x001D50EC
*/
// Range: 0x1D4FF0 -> 0x1D50EC
void xParCmdFollow_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x1D4FF0 -> 0x1D50EC
        float force; // r3
        float lenSqr; // r29+0x40
        float mdt; // r20
        class xParCmdFollow * cmd; // r17
        class xPar * p; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D50F0 -> 0x001D5128
*/
// Range: 0x1D50F0 -> 0x1D5128
void xParCmdAge_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1D50F0 -> 0x1D5128
        float age_rate; // r1
        class xPar * p; // r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5130 -> 0x001D51E8
*/
// Range: 0x1D5130 -> 0x1D51E8
void xParCmdKillSlow_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x1D5130 -> 0x1D51E8
        float speedLimit; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D51F0 -> 0x001D52E0
*/
// Range: 0x1D51F0 -> 0x1D52E0
void xParCmdKillDistance_Update(class zParCmd * c /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D51F0 -> 0x1D52E0
        class _xVec3 * camera_pos; // r5
        class xParCmdKillDistance * cmd; // r6
        class xPar * p; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D52E0 -> 0x001D532C
*/
// Range: 0x1D52E0 -> 0x1D532C
void (* zParCmdGetUpdateFunc(unsigned int parType /* r2 */))(class zParCmd *, class xParGroup *, float) {
    /* anonymous block */ {
        // Range: 0x1D52E0 -> 0x1D532C
        signed int i; // r3
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5330 -> 0x001D537C
*/
// Range: 0x1D5330 -> 0x1D537C
unsigned int zParCmdGetSize(unsigned int parType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D5330 -> 0x1D537C
        signed int i; // r3
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5380 -> 0x001D541C
*/
// Range: 0x1D5380 -> 0x1D541C
void zParCmdFindClipVolumes() {
    /* anonymous block */ {
        // Range: 0x1D5380 -> 0x1D541C
        class _zVolume * vol; // r2
        char findname[64]; // r29+0x30
    }
}
