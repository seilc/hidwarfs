/*
    Compile unit: E:\SD2\Game\flat\xClimate.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _tagClimate * sClimate; // size: 0x4, address: 0x358588
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A4F0 -> 0x0024A518
*/
// Range: 0x24A4F0 -> 0x24A518
void xClimateGetRealWindDir(class _tagClimate * climate /* r2 */, class _xVec3 * vec /* r2 */) {
    /* anonymous block */ {
        // Range: 0x24A4F0 -> 0x24A518
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A520 -> 0x0024A528
*/
// Range: 0x24A520 -> 0x24A528
void xClimateUpdate(class _tagClimate * climate /* r2 */, float seconds /* r29 */) {
    /* anonymous block */ {
        // Range: 0x24A520 -> 0x24A528
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024A530 -> 0x0024AAB0
*/
// Range: 0x24A530 -> 0x24AAB0
static void UpdateRain(class _tagClimate * climate /* r20 */, float seconds /* r23 */) {
    /* anonymous block */ {
        // Range: 0x24A530 -> 0x24AAB0
        float perc; // r2
        signed int i; // r17
        signed int total_snow_flakes; // r16
        signed int i; // r16
        signed int i; // r21
        signed int i; // r21
        signed int i; // r21
        signed int total_rain_drops; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AAB0 -> 0x0024AACC
*/
// Range: 0x24AAB0 -> 0x24AACC
void xClimateSetRain(float stre /* r29 */) {
    /* anonymous block */ {
        // Range: 0x24AAB0 -> 0x24AACC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AAD0 -> 0x0024AAE8
*/
// Range: 0x24AAD0 -> 0x24AAE8
void xClimateSetSnow(float stre /* r29 */) {
    /* anonymous block */ {
        // Range: 0x24AAD0 -> 0x24AAE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AAF0 -> 0x0024AC40
*/
// Range: 0x24AAF0 -> 0x24AC40
void xClimateInitAsset(class _tagClimate * climate /* r18 */, class p2EnvAsset * easset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x24AAF0 -> 0x24AC40
        class _tagWind * w; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024AC40 -> 0x0024ACB4
*/
// Range: 0x24AC40 -> 0x24ACB4
void xClimateInit(class _tagClimate * climate /* r16 */) {
    /* anonymous block */ {
        // Range: 0x24AC40 -> 0x24ACB4
    }
}
