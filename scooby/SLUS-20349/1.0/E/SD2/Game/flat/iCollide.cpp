/*
    Compile unit: E:\SD2\Game\flat\iCollide.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static float cbath; // size: 0x4, address: 0x357D50
static class _xRay3 cbray; // size: 0x24, address: 0x36A3A0
static class _xMat3x3 * cbmat; // size: 0x4, address: 0x357D54
static class RpIntersection cbisx_local; // size: 0x1C, address: 0x36A3D0
static unsigned char cbnumcs; // size: 0x1, address: 0x357D58
static unsigned char cbmaxcs; // size: 0x1, address: 0x357D5C
static unsigned char FLOOR; // size: 0x1, address: 0x357D60
static unsigned char NEXT2; // size: 0x1, address: 0x357D64
static unsigned char OTHER; // size: 0x1, address: 0x357D68
class RpCollisionTriangle * rayHitsModelBackwardCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E2D0
class RpCollisionTriangle * rayHitsModelCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E330
class RpCollisionTriangle * rayHitsEnvBackwardCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E3B0
class RpCollisionTriangle * rayHitsEnvCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E430
class RpCollisionTriangle * sphereHitsModel3CB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E4D0
class RpCollisionTriangle * sphereHitsModelCB(class RpIntersection *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x0
class RpCollisionTriangle * sphereHitsEnv4CB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E4F0
class RpCollisionTriangle * sphereHitsEnv3CB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x12E680
class RpCollisionTriangle * sphereHitsEnvCB(class RpIntersection *, class RpWorldSector *, class RpCollisionTriangle *, float, void *); // size: 0x0, address: 0x0
// total size: 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D150 -> 0x0012D1FC
*/
// Range: 0x12D150 -> 0x12D1FC
void iBoxForModelLocal(class _xBox * o /* r20 */, class xModelInstance * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12D150 -> 0x12D1FC
        unsigned short idx; // r18
        class RpMorphTarget * mtgt; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D200 -> 0x0012D324
*/
// Range: 0x12D200 -> 0x12D324
void iBoxForModel(class _xBox * o /* r21 */, class xModelInstance * m /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12D200 -> 0x12D324
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D330 -> 0x0012D628
*/
// Range: 0x12D330 -> 0x12D628
unsigned int iRayHitsModel(class _xRay3 * r /* r19 */, class xModelInstance * m /* r18 */, class _xCollis * coll /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12D330 -> 0x12D628
        class RwV3d temp; // r29+0x80
        class _xMat4x3 * mat; // r20
        float len; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D630 -> 0x0012D930
*/
// Range: 0x12D630 -> 0x12D930
unsigned int iRayHitsCamEnv(class _xRay3 * r /* r19 */, class _xEnv * env /* r18 */, class _xCollis * coll /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12D630 -> 0x12D930
        class RwV3d temp; // r29+0x70
        float len; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012D930 -> 0x0012DB98
*/
// Range: 0x12D930 -> 0x12DB98
unsigned int iRayHitsEnv(class _xRay3 * r /* r19 */, class _xEnv * env /* r18 */, class _xCollis * coll /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12D930 -> 0x12DB98
        float len; // r1
        class RpIntersection isx; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DBA0 -> 0x0012DEB0
*/
// Range: 0x12DBA0 -> 0x12DEB0
signed int iSphereHitsModel3(class _xSphere * b /* r20 */, class xModelInstance * m /* r19 */, class _xCollis * colls /* r18 */, unsigned char ncolls /* r21 */, float sth /* r21 */) {
    /* anonymous block */ {
        // Range: 0x12DBA0 -> 0x12DEB0
        class _xMat3x3 mnormal; // r29+0xA0
        class _xMat4x3 * mat; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012DEB0 -> 0x0012E0EC
*/
// Range: 0x12DEB0 -> 0x12E0EC
signed int iSphereHitsEnv4(class _xSphere * b /* r19 */, class _xEnv * env /* r18 */, class _xMat3x3 * mat /* r16 */, class _xCollis * colls /* r17 */) {
    /* anonymous block */ {
        // Range: 0x12DEB0 -> 0x12E0EC
        float s; // r2
        signed int numcs; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E0F0 -> 0x0012E2C8
*/
// Range: 0x12E0F0 -> 0x12E2C8
signed int iSphereHitsEnv3(class _xSphere * b /* r4 */, class _xEnv * env /* r18 */, class _xCollis * colls /* r17 */, unsigned char ncolls /* r16 */, float sth /* r20 */) {
    /* anonymous block */ {
        // Range: 0x12E0F0 -> 0x12E2C8
        unsigned char idx; // r3
        class RpIntersection isx; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E2D0 -> 0x0012E328
*/
// Range: 0x12E2D0 -> 0x12E328
static class RpCollisionTriangle * rayHitsModelBackwardCB(class RpCollisionTriangle * tri /* r2 */, float dist /* r29 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12E2D0 -> 0x12E328
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E330 -> 0x0012E3A4
*/
// Range: 0x12E330 -> 0x12E3A4
static class RpCollisionTriangle * rayHitsModelCB(class RpCollisionTriangle * tri /* r2 */, float dist /* r29 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12E330 -> 0x12E3A4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E3B0 -> 0x0012E42C
*/
// Range: 0x12E3B0 -> 0x12E42C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E430 -> 0x0012E4C4
*/
// Range: 0x12E430 -> 0x12E4C4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E4D0 -> 0x0012E4E8
*/
// Range: 0x12E4D0 -> 0x12E4E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E4F0 -> 0x0012E680
*/
// Range: 0x12E4F0 -> 0x12E680
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012E680 -> 0x0012ED58
*/
// Range: 0x12E680 -> 0x12ED58
static class RpCollisionTriangle * sphereHitsEnv3CB(class RpIntersection * isx /* r2 */, class RpWorldSector * sector /* r17 */, class RpCollisionTriangle * tri /* r16 */, float dist /* r29+0x9C */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12E680 -> 0x12ED58
        float scale; // r1
        unsigned char idx; // r2
        class _xVec3 tohit; // r29+0xA0
        float radius; // r20
        class _xCollis * colls; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012ED60 -> 0x0012EF6C
*/
// Range: 0x12ED60 -> 0x12EF6C
static void properSphereIsectTri(class _xVec3 * center /* r21 */, float radius /* r22 */, class _xVec3 * tohit /* r20 */, float * dist_ptr /* r19 */, class RpCollisionTriangle * tri /* r18 */) {
    /* anonymous block */ {
        // Range: 0x12ED60 -> 0x12EF6C
        class _xVec3 vertClosestPoint; // r29+0x90
        unsigned int i; // r16
        float radius2; // r21
        float dist2; // r20
        float dist; // r21
        float dist2plane; // r20
        class _xVec3 projPoint; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012EF70 -> 0x0012F03C
*/
// Range: 0x12EF70 -> 0x12F03C
static void FindNearestPointOnLine(class RwV3d * result /* r2 */, class RwV3d * point /* r2 */, class RwV3d * start /* r2 */, class RwV3d * end /* r2 */) {
    /* anonymous block */ {
        // Range: 0x12EF70 -> 0x12F03C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F040 -> 0x0012F3C0
*/
// Range: 0x12F040 -> 0x12F3C0
static signed int PointWithinTriangle(class RwV3d * pt /* r18 */, class RwV3d * * tri /* r17 */, class RwV3d * normal /* r19 */) {
    /* anonymous block */ {
        // Range: 0x12F040 -> 0x12F3C0
        signed int j; // r2
        signed int i; // r4
        signed int inside; // r16
        float absZ; // r29+0x60
        float absY; // r21
        float absX; // r20
        enum Dimension dimension; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012F3C0 -> 0x0012F3C8
*/
// Range: 0x12F3C0 -> 0x12F3C8
void iCollideInit() {
    /* anonymous block */ {
        // Range: 0x12F3C0 -> 0x12F3C8
    }
