/*
    Compile unit: E:\SD2\Game\flat\zGameExtras.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int sGameExtrasOn; // size: 0x4, address: 0x358670
static signed int sDay; // size: 0x4, address: 0x358674
static signed int sMonth; // size: 0x4, address: 0x358678
static signed int sFireworksOn; // size: 0x4, address: 0x35867C
static signed int sColoredFountain; // size: 0x4, address: 0x358680
static class _zParEmitter * sFireworkTrailEmit; // size: 0x4, address: 0x358684
static class _zParEmitter * sFirework1Emit; // size: 0x4, address: 0x358688
static class _zParEmitter * sFirework2Emit; // size: 0x4, address: 0x35868C
static class _zFog * sFog; // size: 0x4, address: 0x358690
static float sFogIntensity; // size: 0x4, address: 0x358694
static float sFogPrevIntensity; // size: 0x4, address: 0x357BA0
static signed int sThunderOn; // size: 0x4, address: 0x358698
static unsigned int sThunderFar1; // size: 0x4, address: 0x35869C
static unsigned int sThunderFar2; // size: 0x4, address: 0x3586A0
static unsigned int sThunderNear1; // size: 0x4, address: 0x3586A4
static unsigned int sThunderNear2; // size: 0x4, address: 0x3586A8
static unsigned int sThunderNear3; // size: 0x4, address: 0x3586AC
static unsigned int sThunderNear4; // size: 0x4, address: 0x3586B0
static class _tagFirework sFirework[10]; // size: 0x168, address: 0x3B3380
...
public:
    ...
    class _xVec3 vel; // offset 0x8, size 0xC
    class _xVec3 pos; // offset 0x14, size 0xC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027F020 -> 0x0027F054
*/
// Range: 0x27F020 -> 0x27F054
signed int zGameExtraIsAnnaBday() {
    /* anonymous block */ {
        // Range: 0x27F020 -> 0x27F054
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027F060 -> 0x0027F090
*/
// Range: 0x27F060 -> 0x27F090
signed int zGameExtraIsShirazBday() {
    /* anonymous block */ {
        // Range: 0x27F060 -> 0x27F090
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027F090 -> 0x0027F0C4
*/
// Range: 0x27F090 -> 0x27F0C4
signed int zGameExtraIsValentines() {
    /* anonymous block */ {
        // Range: 0x27F090 -> 0x27F0C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027F0D0 -> 0x0027FC30
*/
// Range: 0x27F0D0 -> 0x27FC30
static void UpdateFireworks(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x27F0D0 -> 0x27FC30
        class _zParEmitterCustomSettings xplo_info; // r29+0x170
        class _zParEmitter * femit; // r18
        class _zParEmitterCustomSettings trail_info; // r29+0x110
        signed int i; // r17
        class iFogParams fog; // r29+0xF0
        signed int july_4_rgb; // @ 0x003586BC
        class _xVec3 h002_launch[5]; // @ 0x00341B50
        class _xVec3 h001_launch[5]; // @ 0x00341B10
        signed char init; // @ 0x003586C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027FC30 -> 0x00280250
*/
// Range: 0x27FC30 -> 0x280250
static void UpdateThunder() {
    /* anonymous block */ {
        // Range: 0x27FC30 -> 0x280250
        class iFogParams fog; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00280250 -> 0x00280514
*/
// Range: 0x280250 -> 0x280514
static void UpdateColoredFountain(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x280250 -> 0x280514
        class zParEmitterAsset * a; // r16
        class _zParEmitter * fe; // r2
        float ftimer; // @ 0x003586B4
        signed char init; // @ 0x003586B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00280520 -> 0x002806EC
*/
// Range: 0x280520 -> 0x2806EC
static void Init4thJuly() {
    /* anonymous block */ {
        // Range: 0x280520 -> 0x2806EC
        char emitter_txt[64]; // r29+0x30
        signed int i; // r17
        signed int idx; // r16
        class zParEmitterAsset * a; // r7
        class _zParEmitter * fe; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002806F0 -> 0x00280848
*/
// Range: 0x2806F0 -> 0x280848
static void InitStPatricksDay() {
    /* anonymous block */ {
        // Range: 0x2806F0 -> 0x280848
        char emitter_txt[64]; // r29+0x20
        signed int i; // r16
        class zParEmitterAsset * a; // r7
        class _zParEmitter * fe; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00280850 -> 0x00280868
*/
// Range: 0x280850 -> 0x280868
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00280870 -> 0x002808D0
*/
// Range: 0x280870 -> 0x2808D0
void zGameExtras(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x280870 -> 0x2808D0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002808D0 -> 0x002812A4
*/
// Range: 0x2808D0 -> 0x2812A4
