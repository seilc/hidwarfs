/*
    Compile unit: E:\SD2\Game\flat\xTRC.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class _tagTRCPadInfo gTrcPad[4]; // size: 0x30, address: 0x3B1A10
class _tagTRCDiskInfo gTrcDisk; // size: 0x4, address: 0x3585A4
static class xFontBox * sTrcFontBox; // size: 0x4, address: 0x3585A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0025FE00 -> 0x0025FFDC
*/
// Range: 0x25FE00 -> 0x25FFDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0025FFE0 -> 0x00260040
*/
// Range: 0x25FFE0 -> 0x260040
void xTRCInit() {
    /* anonymous block */ {
        // Range: 0x25FFE0 -> 0x260040
    }
