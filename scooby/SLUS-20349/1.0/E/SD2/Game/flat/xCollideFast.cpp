/*
    Compile unit: E:\SD2\Game\flat\xCollideFast.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C1A0 -> 0x0024C394
*/
// Range: 0x24C1A0 -> 0x24C394
unsigned int xRayHitsSceneFast(class _xRay3 * r /* r17 */, class _xScene * sc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x24C1A0 -> 0x24C394
        class _xEnt * ent; // r20
        class _xEnt * ent; // r18
        class _xEnt * ent; // r19
        class xQCData qcr; // r29+0x60
        unsigned int hit; // r2
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C3A0 -> 0x0024C3A8
*/
// Range: 0x24C3A0 -> 0x24C3A8
unsigned int xRayHitsEnvFast(class _xRay3 * r /* r2 */, class _xEnv * env /* r2 */) {
    /* anonymous block */ {
        // Range: 0x24C3A0 -> 0x24C3A8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C3B0 -> 0x0024C6C0
*/
// Range: 0x24C3B0 -> 0x24C6C0
unsigned int xRayHitsBoundFast(class _xRay3 * r /* r17 */, class _xBound * b /* r16 */) {
    /* anonymous block */ {
        // Range: 0x24C3B0 -> 0x24C6C0
        class _xMat3x3 mn; // r29+0x70
        class _xRay3 lr; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0024C6C0 -> 0x0024C6C8
*/
// Range: 0x24C6C0 -> 0x24C6C8
void xCollideFastInit(class _xScene * sc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x24C6C0 -> 0x24C6C8
    }
}
