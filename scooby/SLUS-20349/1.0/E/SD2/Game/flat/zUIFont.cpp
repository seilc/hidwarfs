/*
    Compile unit: E:\SD2\Game\flat\zUIFont.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
float gFontWiggle; // size: 0x4, address: 0x3580E8
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zUIFontEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1ACA90
void zUIFont_Update(class _zUIFont *, class _xScene *, float); // size: 0x0, address: 0x1ACC00
void zUIFont_Render(class _xEnt *); // size: 0x0, address: 0x1AC630
// total size: 0x6C
class _xScene {
    // Members
public:
...
class zUIFontAsset : public zUIAsset {
    // Members
public:
    unsigned short uiFontFlags; // offset 0x7C, size 0x2
    unsigned char mode; // offset 0x7E, size 0x1
    unsigned char fontID; // offset 0x7F, size 0x1
    unsigned int textAssetID; // offset 0x80, size 0x4
    unsigned char bcolor[4]; // offset 0x84, size 0x4
    unsigned char color[4]; // offset 0x88, size 0x4
    unsigned short inset[4]; // offset 0x8C, size 0x8
    unsigned short space[2]; // offset 0x94, size 0x4
    unsigned short cdim[2]; // offset 0x98, size 0x4
};
// total size: 0x8
class RwTexCoords {
    // Members
...
// total size: 0x100
class _zUIFont : public _zUI {
    // Members
public:
    class zUIFontAsset * fasset; // offset 0xF8, size 0x4
    unsigned short uiFontFlags; // offset 0xFC, size 0x2
    unsigned short uiFontHackFlags; // offset 0xFE, size 0x2
};
// total size: 0x10
class xCutsceneTime {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AC630 -> 0x001ACA84
*/
// Range: 0x1AC630 -> 0x1ACA84
void zUIFont_Render(class _xEnt * e /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1AC630 -> 0x1ACA84
        char processedText[512]; // r29+0x60
        char * text; // r2
        unsigned int jflags; // r2
        class xFontBox * b; // r17
        class iColor_tag c; // r29+0x26C
        class _zUIFont * ent; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001ACA90 -> 0x001ACC00
*/
// Range: 0x1ACA90 -> 0x1ACC00
signed int zUIFontEventCB(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1ACA90 -> 0x1ACC00
        class _zUIFont * s; // r17
        signed int rval; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001ACC00 -> 0x001ACEF4
*/
// Range: 0x1ACC00 -> 0x1ACEF4
void zUIFont_Update(class _zUIFont * ent /* r16 */, class _xScene * sc /* r2 */, float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x1ACC00 -> 0x1ACEF4
        class _zUI * ui; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001ACF00 -> 0x001AD118
*/
// Range: 0x1ACF00 -> 0x1AD118
void zUIFont_PreUpdate(class _zUIFont * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1ACF00 -> 0x1AD118
        class _zUI * ui; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AD120 -> 0x001AD128
*/
// Range: 0x1AD120 -> 0x1AD128
void zUIFont_Load(class _zUIFont * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1AD120 -> 0x1AD128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AD130 -> 0x001AD138
*/
// Range: 0x1AD130 -> 0x1AD138
void zUIFont_Save(class _zUIFont * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1AD130 -> 0x1AD138
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AD140 -> 0x001AD290
*/
// Range: 0x1AD140 -> 0x1AD290
void zUIFont_Init(class _zUIFont * ent /* r17 */, class p2EntAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1AD140 -> 0x1AD290
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AD290 -> 0x001AD298
*/
// Range: 0x1AD290 -> 0x1AD298
