/*
    Compile unit: E:\SD2\Game\flat\zCamera.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zCameraEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x18EC40
// total size: 0x18
class _xEntShadow {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018EC40 -> 0x0018EC98
*/
// Range: 0x18EC40 -> 0x18EC98
signed int zCameraEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18EC40 -> 0x18EC98
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018ECA0 -> 0x0018ECA8
*/
// Range: 0x18ECA0 -> 0x18ECA8
void zCameraLoad(class _tagxCam * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18ECA0 -> 0x18ECA8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018ECB0 -> 0x0018ECB8
*/
// Range: 0x18ECB0 -> 0x18ECB8
void zCameraSave(class _tagxCam * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x18ECB0 -> 0x18ECB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0018ECC0 -> 0x0018ED10
*/
// Range: 0x18ECC0 -> 0x18ED10
void zCameraInit(class xBase * b /* r17 */, class xCamAsset * asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x18ECC0 -> 0x18ED10
    }
}
