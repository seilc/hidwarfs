/*
    Compile unit: E:\SD2\Game\flat\xEntDrive.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00195C50 -> 0x001960C4
*/
// Range: 0x195C50 -> 0x1960C4
void xEntDriveUpdate(class _xEntDrive * drv /* r16 */, float dt /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x195C50 -> 0x1960C4
        class _xVec3 newq; // r29+0x70
        class _xMat3x3 rot; // r29+0x30
        class _xVec3 euler; // r29+0x60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001960D0 -> 0x00196180
*/
// Range: 0x1960D0 -> 0x196180
void xEntDriveDismount(class _xEntDrive * drv /* r2 */, float dmt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x1960D0 -> 0x196180
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00196180 -> 0x001962A0
*/
// Range: 0x196180 -> 0x1962A0
void xEntDriveMount(class _xEntDrive * drv /* r16 */, class _xEnt * driver /* r2 */, float mt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x196180 -> 0x1962A0
        class _xVec3 euler; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001962A0 -> 0x001962CC
*/
// Range: 0x1962A0 -> 0x1962CC
void xEntDriveInit(class _xEntDrive * drv /* r2 */, class _xEnt * driven /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1962A0 -> 0x1962CC
    }
}
