/*
    Compile unit: E:\SD2\Game\flat\zGame.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static unsigned int sPlayerMarkerStartID; // size: 0x4, address: 0x357D70
static unsigned int sPlayerMarkerStartCamID; // size: 0x4, address: 0x357D74
static float sPlayerStartAngle; // size: 0x4, address: 0x357D78
static signed int sPortalling; // size: 0x4, address: 0x357D7C
static float sGameOverTimer; // size: 0x4, address: 0x357D80
float sTimeElapsed; // size: 0x4, address: 0x357D84
static signed long sTimeLast; // size: 0x4, address: 0x357D88
static signed long sTimeCurrent; // size: 0x4, address: 0x357D90
static class RwSky2DVertex Vert[4]; // size: 0x100, address: 0x36A3F0
static unsigned short Idx[6]; // size: 0xC, address: 0x28F868
unsigned int startPressed; // size: 0x4, address: 0x3574BC
static class iColor_tag sFadeColor; // size: 0x4, address: 0x0
class iColor_tag black; // size: 0x4, address: 0x3574C0
class iColor_tag clear; // size: 0x4, address: 0x3574C4
signed long t0; // size: 0x4, address: 0x357D98
signed long t1; // size: 0x4, address: 0x357DA0
float snd_radius; // size: 0x4, address: 0x3574C8
unsigned int gLastVsyncFlip; // size: 0x4, address: 0x357DA8
static class RwCamera * sGameScreenTransCam; // size: 0x4, address: 0x357DC0
static class RpWorld * World; // size: 0x4, address: 0x357DC4
static class RpLight * DirectionalLight; // size: 0x4, address: 0x357DC8
static unsigned int loadMeter; // size: 0x4, address: 0x357DCC
static unsigned int loadCDMeter; // size: 0x4, address: 0x0
static float sCheatTimer; // size: 0x4, address: 0x357DD0
unsigned int sCheatUnlockCredits[14]; // size: 0x38, address: 0x28F980
unsigned int sCheatUnlockAllMovies[14]; // size: 0x38, address: 0x28F9C0
unsigned int sCheatWarpGate[14]; // size: 0x38, address: 0x28FA00
unsigned int sCheatAllPowerups[14]; // size: 0x38, address: 0x28FA40
unsigned int sCheatPressed[14]; // size: 0x38, address: 0x28FA80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130350 -> 0x001305F4
*/
// Range: 0x130350 -> 0x1305F4
static void zGameCheats(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x130350 -> 0x1305F4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130600 -> 0x0013077C
*/
// Range: 0x130600 -> 0x13077C
static signed int TestCheat(unsigned int * cheat_info /* r2 */) {
    /* anonymous block */ {
        // Range: 0x130600 -> 0x13077C
        signed int i; // r3
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130780 -> 0x001308B0
*/
// Range: 0x130780 -> 0x1308B0
void setupPlayer() {
    /* anonymous block */ {
        // Range: 0x130780 -> 0x1308B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001308B0 -> 0x00130944
*/
// Range: 0x1308B0 -> 0x130944
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130950 -> 0x00130D7C
*/
// Range: 0x130950 -> 0x130D7C
void zGameScreenTransition_UIRender(float x1 /* r23 */, float y1 /* r22 */, float x2 /* r21 */, float y2 /* r20 */, signed int tex /* r16 */) {
    /* anonymous block */ {
        // Range: 0x130950 -> 0x130D7C
        float cooz; // r2
        float cz; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130D80 -> 0x001311A8
*/
// Range: 0x130D80 -> 0x1311A8
void zGameScreenTransitionUpdate(float percentComplete /* r20 */, char * msg /* r17 */, unsigned char * rgba /* r16 */) {
    /* anonymous block */ {
        // Range: 0x130D80 -> 0x1311A8
        char str[256]; // r29+0x150
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001311B0 -> 0x001311F4
*/
// Range: 0x1311B0 -> 0x1311F4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131200 -> 0x001312DC
*/
// Range: 0x131200 -> 0x1312DC
void zGameScreenTransitionBegin() {
    /* anonymous block */ {
        // Range: 0x131200 -> 0x1312DC
        class RwBBox box; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001312E0 -> 0x001317C0
*/
// Range: 0x1312E0 -> 0x1317C0
static void zGameUpdateMode() {
    /* anonymous block */ {
        // Range: 0x1312E0 -> 0x1317C0
        signed int qwerty; // r4
        class _tagxCam * cam; // r2
        class _tagxCam * cam; // r17
        class p2MarkerAsset * m; // r2
        unsigned int size; // r29+0x4C
        signed int vbl; // r17
        unsigned int nextSceneID; // r16
        char * id; // r2
        class zPortalAsset * passet; // r9
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001317C0 -> 0x001318A4
*/
// Range: 0x1317C0 -> 0x1318A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001318B0 -> 0x0013191C
*/
// Range: 0x1318B0 -> 0x13191C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131920 -> 0x00131EF8
*/
// Range: 0x131920 -> 0x131EF8
void zGameLoop() {
    /* anonymous block */ {
        // Range: 0x131920 -> 0x131EF8
        unsigned int vcount; // r3
        signed long tprof1; // r2
        signed long tprof0; // r29+0xA8
        signed int ostrich_delay; // r30
        float paccum; // @ 0x00357DAC
        float pcount; // @ 0x00357DB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131F00 -> 0x00131FBC
*/
// Range: 0x131F00 -> 0x131FBC
void zGameSetup() {
    /* anonymous block */ {
        // Range: 0x131F00 -> 0x131FBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00131FC0 -> 0x00132024
*/
// Range: 0x131FC0 -> 0x132024
void zGameExit() {
    /* anonymous block */ {
        // Range: 0x131FC0 -> 0x132024
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00132030 -> 0x001320D0
*/
// Range: 0x132030 -> 0x1320D0
