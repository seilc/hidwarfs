/*
    Compile unit: E:\SD2\Game\flat\zAssetTypes.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class st_PACKER_ASSETTYPE assetTypeHandlers[56]; // size: 0x8C0, address: 0x298D20
static class xAnimTable * (* tableFuncList[22])(); // size: 0x58, address: 0x2995E0
static unsigned int (* effectFuncList[2])(unsigned int, class xAnimActiveEffect *, class xAnimSingle *, void *); // size: 0x8, address: 0x357588
unsigned int gxAnimUseGrowAlloc; // size: 0x4, address: 0x357C50
void * FindAssetCB(unsigned int, char *); // size: 0x0, address: 0x188780
class RwTexture * TexCB(class RwTexture *, void *); // size: 0x0, address: 0x1889F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001881F0 -> 0x001881F8
*/
// Range: 0x1881F0 -> 0x1881F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188200 -> 0x00188208
*/
// Range: 0x188200 -> 0x188208
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188210 -> 0x00188780
*/
// Range: 0x188210 -> 0x188780
static void * ATBL_Read(unsigned int assetid /* r21 */, void * indata /* r2 */, unsigned int * outsize /* r29+0xDC */) {
    /* anonymous block */ {
        // Range: 0x188210 -> 0x188780
        class xAnimEffect * effect; // r2
        class zAssetAnimEffect * zaEffect; // r18
        class xAnimState * state; // r17
        class xAnimFile * foundFile; // r4
        char tmpstr[32]; // r29+0xE0
        class xAnimFile * * fList; // r23
        class zAssetAnimState * zaState; // r2
        class zAssetAnimFile * zaFile; // r2
        void * * zaRaw; // r17
        class zAssetAnimTable * zaTbl; // r16
        unsigned char * zaBytes; // r30
        class xAnimTransition * atran; // r2
        class xAnimState * astate; // r17
        unsigned int tmpsize; // r29+0x10C
        unsigned int debugNum; // r29+0xB0
        unsigned int j; // r3
        unsigned int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188780 -> 0x0018879C
*/
// Range: 0x188780 -> 0x18879C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001887A0 -> 0x0018887C
*/
// Range: 0x1887A0 -> 0x18887C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188880 -> 0x00188888
*/
// Range: 0x188880 -> 0x188888
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188890 -> 0x001888B4
*/
// Range: 0x188890 -> 0x1888B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001888C0 -> 0x001889E4
*/
// Range: 0x1888C0 -> 0x1889E4
static void * RWTX_Read(void * indata /* r2 */, unsigned int insize /* r19 */, unsigned int * outsize /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1888C0 -> 0x1889E4
        class RwTexture * tex; // r29+0x5C
        class RwStream * stream; // r18
        class RwMemory rwmem; // r29+0x50
        class RwTexDictionary * txd; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001889F0 -> 0x00188A08
*/
// Range: 0x1889F0 -> 0x188A08
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188A10 -> 0x00188A20
*/
// Range: 0x188A10 -> 0x188A20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188A20 -> 0x00188B2C
*/
// Range: 0x188A20 -> 0x188B2C
static void * BSP_Read(unsigned int assetid /* r18 */, void * indata /* r2 */, unsigned int insize /* r2 */, unsigned int * outsize /* r17 */) {
    /* anonymous block */ {
        // Range: 0x188A20 -> 0x188B2C
        class RpWorld * bsp; // r16
        class RwChunkHeaderInfo chunkHeaderInfo; // r29+0x50
        class RwMemory rwmem; // r29+0x68
        class RwStream * stream; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188B30 -> 0x00188B50
*/
// Range: 0x188B30 -> 0x188B50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188B50 -> 0x00188B84
*/
// Range: 0x188B50 -> 0x188B84
static void * Model_Read(void * indata /* r2 */, unsigned int insize /* r2 */, unsigned int * outsize /* r16 */) {
    /* anonymous block */ {
        // Range: 0x188B50 -> 0x188B84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188B90 -> 0x00188B98
*/
// Range: 0x188B90 -> 0x188B98
void zAssetShutdown() {
    /* anonymous block */ {
        // Range: 0x188B90 -> 0x188B98
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00188BA0 -> 0x00188BAC
*/
// Range: 0x188BA0 -> 0x188BAC
void zAssetStartup() {
    /* anonymous block */ {
        // Range: 0x188BA0 -> 0x188BAC
    }
