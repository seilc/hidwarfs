/*
    Compile unit: E:\SD2\Game\flat\xScrFx.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _xFadeData mFade; // size: 0x20, address: 0x362B10
static float mLetterboxO; // size: 0x4, address: 0x357C28
static float mLetterboxTO; // size: 0x4, address: 0x357C2C
...
public:
    ...
    signed int fancy; // offset 0x1C, size 0x4
};
// total size: 0x14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00111F10 -> 0x00111F1C
*/
// Range: 0x111F10 -> 0x111F1C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00111F20 -> 0x00111F48
*/
// Range: 0x111F20 -> 0x111F48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00111F50 -> 0x00111F94
*/
// Range: 0x111F50 -> 0x111F94
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00111FA0 -> 0x00112014
*/
// Range: 0x111FA0 -> 0x112014
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00112020 -> 0x001126DC
*/
// Range: 0x112020 -> 0x1126DC
void xScrFxUpdate(class RwCamera * cam /* r16 */, float seconds /* r21 */) {
    /* anonymous block */ {
        // Range: 0x112020 -> 0x1126DC
        class iColor_tag col; // r29+0xEC
        class _xMat4x3 old_head; // r29+0xA0
        class _xMat4x3 old; // r29+0x60
        float sc; // r1
        float sc; // r29+0xF0
        float dog_z; // r22
        float dog_y; // r20
        signed int entering_scene; // r17
        float t; // r29+0xF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001126E0 -> 0x001127A8
*/
// Range: 0x1126E0 -> 0x1127A8
void DrawScreenSizeRectangle() {
    /* anonymous block */ {
        // Range: 0x1126E0 -> 0x1127A8
        class RwVideoMode video_mode; // r29+0x10
        unsigned short indices[4]; // @ 0x00357490
        class RwSky2DVertex v[4]; // @ 0x00362B30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001127B0 -> 0x001127E0
*/
// Range: 0x1127B0 -> 0x1127E0
void xScrFxInit() {
    /* anonymous block */ {
        // Range: 0x1127B0 -> 0x1127E0
    }
