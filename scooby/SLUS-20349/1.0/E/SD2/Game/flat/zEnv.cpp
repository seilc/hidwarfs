/*
    Compile unit: E:\SD2\Game\flat\zEnv.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zEnvEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1926B0
// total size: 0x20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001926B0 -> 0x00192754
*/
// Range: 0x1926B0 -> 0x192754
signed int zEnvEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1926B0 -> 0x192754
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192760 -> 0x00192768
*/
// Range: 0x192760 -> 0x192768
void zEnvLoad(class _zEnv * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x192760 -> 0x192768
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192770 -> 0x00192778
*/
// Range: 0x192770 -> 0x192778
void zEnvSave(class _zEnv * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x192770 -> 0x192778
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192780 -> 0x00192874
*/
// Range: 0x192780 -> 0x192874
void zEnvRender(class _xEnv * env /* r20 */) {
    /* anonymous block */ {
        // Range: 0x192780 -> 0x192874
        class RwTexture * texptr; // r2
        unsigned int texid; // r2
        class _zGroup * g; // r2
        class RpMaterial * mp; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192880 -> 0x001928C0
*/
// Range: 0x192880 -> 0x1928C0
void zEnvStartingCamera(class _zEnv * env /* r2 */) {
    /* anonymous block */ {
        // Range: 0x192880 -> 0x1928C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001928C0 -> 0x001928FC
*/
// Range: 0x1928C0 -> 0x1928FC
void zEnvSetup(class _zEnv * env /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1928C0 -> 0x1928FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192900 -> 0x00192A78
*/
// Range: 0x192900 -> 0x192A78
void zEnvInit(class _zEnv * env /* r17 */, class p2EnvAsset * easset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x192900 -> 0x192A78
        void * buf; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00192A80 -> 0x00192A88
*/
// Range: 0x192A80 -> 0x192A88
void zEnvInit(void * env /* r2 */, void * easset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x192A80 -> 0x192A88
    }
}
