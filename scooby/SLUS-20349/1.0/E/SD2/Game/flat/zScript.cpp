/*
    Compile unit: E:\SD2\Game\flat\zScript.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zScriptEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x27E160
// total size: 0xE8
...
// total size: 0x10
class zScriptAsset : public p2BaseAsset {
    // Members
public:
    float scriptStartTime; // offset 0x8, size 0x4
...
class _zScript : public xBase {
    // Members
public:
    class zScriptAsset * tasset; // offset 0x10, size 0x4
    unsigned char state; // offset 0x14, size 0x1
    unsigned char more; // offset 0x15, size 0x1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027DFA0 -> 0x0027E04C
*/
// Range: 0x27DFA0 -> 0x27E04C
void zScriptUpdate(class xBase * to /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x27DFA0 -> 0x27E04C
        class _zScript * t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027E050 -> 0x0027E160
*/
// Range: 0x27E050 -> 0x27E160
static void zScriptExecuteEvents(class _zScript * t /* r17 */, float start /* r21 */, float end /* r20 */) {
    /* anonymous block */ {
        // Range: 0x27E050 -> 0x27E160
        class xBase * b; // r19
        signed int i; // r16
        class zScriptEventAsset * a; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027E160 -> 0x0027E23C
*/
// Range: 0x27E160 -> 0x27E23C
signed int zScriptEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x27E160 -> 0x27E23C
        class _zScript * t; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027E240 -> 0x0027E248
*/
// Range: 0x27E240 -> 0x27E248
void zScriptLoad(class _zScript * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x27E240 -> 0x27E248
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027E250 -> 0x0027E258
*/
// Range: 0x27E250 -> 0x27E258
void zScriptSave(class _zScript * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x27E250 -> 0x27E258
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0027E260 -> 0x0027E2E8
*/
// Range: 0x27E260 -> 0x27E2E8
void zScriptInit(void * b /* r16 */, void * tasset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x27E260 -> 0x27E2E8
    }
}
