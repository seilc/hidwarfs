/*
    Compile unit: E:\SD2\Game\flat\zParEmitter.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _zParEmitterCustomSettings sSaveEmmiterSettings; // size: 0x54, address: 0x3ACAA0
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int zParEmitterEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x1D74F0
// total size: 0xE8
...
class _xMat2x2 {
    // Members
public:
    class _xVec2 right; // offset 0x0, size 0x8
    class _xVec2 up; // offset 0x8, size 0x8
};
// total size: 0x40
class RpLight {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5A60 -> 0x001D5ACC
*/
// Range: 0x1D5A60 -> 0x1D5ACC
class _zParEmitter * zParEmitterFind(char * asset_name /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D5A60 -> 0x1D5ACC
        unsigned int asset_id; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5AD0 -> 0x001D5B24
*/
// Range: 0x1D5AD0 -> 0x1D5B24
class _zParEmitter * zParEmitterFind(unsigned int asset_id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D5AD0 -> 0x1D5B24
        signed int i; // r2
        class _zParEmitter * pe; // r2
        class zScene * s; // r3
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5B30 -> 0x001D5B80
*/
// Range: 0x1D5B30 -> 0x1D5B80
void zParEmitterUpdate(class xBase * to /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D5B30 -> 0x1D5B80
        class _zParEmitter * pe; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D5B80 -> 0x001D6734
*/
// Range: 0x1D5B80 -> 0x1D6734
class xPar * zParEmitterEmit(class _zParEmitter * pe /* r21 */, float dt /* r28 */) {
    /* anonymous block */ {
        // Range: 0x1D5B80 -> 0x1D6734
        signed int i; // r30
        unsigned int get_rnd_group_idx; // r17
        class _zGroup * g; // r29+0x120
        signed int marker; // r18
        class xBase * emitObj; // r2
        signed int emitAgain; // r29+0x110
        signed int attachGroupTotal; // r29+0x100
        signed int attachGroupIndex; // r2
        class xBase * attachObject; // r2
        signed int sanity; // r2
        unsigned int count; // r29+0xF0
        float size_birth; // r21
        float life; // r20
        class xPar * p; // r17
        class zParSys * ps; // r29+0xE0
        class zParEmitterAsset * a; // r16
        class xPar * last_p; // r29+0xD0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D6740 -> 0x001D6B54
*/
// Range: 0x1D6740 -> 0x1D6B54
class xPar * zParEmitterEmitCustom(class _zParEmitter * p /* r21 */, float dt /* r20 */, class _zParEmitterCustomSettings * info /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1D6740 -> 0x1D6B54
        class xPar * emitted_par; // r16
        class _zParEmitterCustomSettings * s; // r18
        class zParEmitterAsset * pe; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D6B60 -> 0x001D6EE4
*/
// Range: 0x1D6B60 -> 0x1D6EE4
static void zParEmitterEmitSphereEdge(class xPar * p /* r17 */, class zParEmitterAsset * a /* r16 */, float dt /* r29+0xD0 */, signed int subtype /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D6B60 -> 0x1D6EE4
        class _xMat3x3 mat_rot; // r29+0x40
        class _xVec3 offset; // r29+0xB0
        class _xVec3 dirvec; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D6EF0 -> 0x001D7170
*/
// Range: 0x1D6EF0 -> 0x1D7170
static void zParEmitterEmitCircle(class xPar * p /* r20 */, class zParEmitterAsset * a /* r19 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1D6EF0 -> 0x1D7170
        float dt_radius; // r2
        class _xVec2 vec2; // r29+0xB8
        class _xMat2x2 rot_mat; // r29+0x70
        float st; // r29+0xD0
        float ct; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D7170 -> 0x001D73D8
*/
// Range: 0x1D7170 -> 0x1D73D8
static void zParEmitterEmitCircleEdge(class xPar * p /* r17 */, class zParEmitterAsset * a /* r16 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1D7170 -> 0x1D73D8
        float dt_radius; // r2
        class _xVec2 vec2; // r29+0x98
        class _xMat2x2 rot_mat; // r29+0x50
        float st; // r29+0xB0
        float ct; // r20
        float rot_amount; // r20
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D73E0 -> 0x001D74E8
*/
// Range: 0x1D73E0 -> 0x1D74E8
static void zParEmitterAngleVariation(class xPar * p /* r16 */, class zParEmitterAsset * a /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D73E0 -> 0x1D74E8
        float ang[3]; // r29+0x70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D74F0 -> 0x001D75B8
*/
// Range: 0x1D74F0 -> 0x1D75B8
signed int zParEmitterEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D74F0 -> 0x1D75B8
        class _zParEmitterCustomSettings fake_settings; // r29+0x20
        class _zParEmitter * t; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D75C0 -> 0x001D75DC
*/
// Range: 0x1D75C0 -> 0x1D75DC
void zParEmitterSetup(class _zParEmitter * t /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D75C0 -> 0x1D75DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D75E0 -> 0x001D76EC
*/
// Range: 0x1D75E0 -> 0x1D76EC
void zParEmitterInit(class xBase * b /* r17 */, class zParEmitterAsset * tasset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1D75E0 -> 0x1D76EC
        class _xEnt * ent; // r2
        class _zParEmitter * t; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D76F0 -> 0x001D76F8
*/
// Range: 0x1D76F0 -> 0x1D76F8
void zParEmitterInit(void * b /* r2 */, void * tasset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D76F0 -> 0x1D76F8
    }
}
