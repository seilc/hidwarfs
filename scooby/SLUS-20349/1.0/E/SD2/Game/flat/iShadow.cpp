/*
    Compile unit: E:\SD2\Game\flat\iShadow.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class RwRaster * sShadowRaster; // size: 0x4, address: 0x358174
static class RxRenderStateVector rsv; // size: 0x30, address: 0x3748C0
static class _xRay3 sShadowRay; // size: 0x24, address: 0x3748F0
static class RxObjSpace3DVertex sShadowVert[384]; // size: 0x3600, address: 0x374920
static unsigned int sShadowVertCount; // size: 0x4, address: 0x358178
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1660 -> 0x001A176C
*/
// Range: 0x1A1660 -> 0x1A176C
void iShadowRender() {
    /* anonymous block */ {
        // Range: 0x1A1660 -> 0x1A176C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1770 -> 0x001A1910
*/
// Range: 0x1A1770 -> 0x1A1910
void iShadowAdd(class iShadowCache * cache /* r2 */, unsigned char alpha /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1A1770 -> 0x1A1910
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1910 -> 0x001A1D30
*/
// Range: 0x1A1910 -> 0x1A1D30
void iShadowCollide(class iShadowCache * cache /* r17 */, class _xEnt * ent /* r16 */, float radius /* r22 */, float ecc /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1A1910 -> 0x1A1D30
        float centerz; // r6
        float centery; // r3
        ...
        float dydx; // r5
        float mag; // r2
        class _xVec3 tmppos[4]; // r29+0xB0
        class _xCollis crec; // r29+0x60
        float height; // r20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001A1D30 -> 0x001A1E0C
*/
// Range: 0x1A1D30 -> 0x1A1E0C
void iShadowInit() {
    /* anonymous block */ {
        // Range: 0x1A1D30 -> 0x1A1E0C
        unsigned int i; // r5
