/*
    Compile unit: E:\SD2\Game\flat\xScene.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FA10 -> 0x0012FB58
*/
// Range: 0x12FA10 -> 0x12FB58
void xRayHitsCameraScene(class _xScene * sc /* r18 */, class _xRay3 * r /* r17 */, void (* camera_func)(class _xEnt *) /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12FA10 -> 0x12FB58
        class _xEnt * ent; // r19
        class _xEnt * ent; // r20
        unsigned short i; // r19
        class xQCData qcr; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FB60 -> 0x0012FDDC
*/
// Range: 0x12FB60 -> 0x12FDDC
void xRayHitsScene(class _xScene * sc /* r18 */, class _xRay3 * r /* r17 */, class _xCollis * coll /* r16 */) {
    /* anonymous block */ {
        // Range: 0x12FB60 -> 0x12FDDC
        class _xEnt * ent; // r19
        class _xEnt * ent; // r19
        class _xEnt * ent; // r20
        unsigned short i; // r19
        class _xCollis c; // r29+0x70
        class xQCData q; // r29+0xC0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FDE0 -> 0x0012FE78
*/
// Range: 0x12FDE0 -> 0x12FE78
void xSceneForAllNPCs(class _xScene * sc /* r20 */, class _xEnt * (* func)(class _xEnt *, class _xScene *, void *) /* r19 */, void * data /* r18 */) {
    /* anonymous block */ {
        // Range: 0x12FDE0 -> 0x12FE78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FE80 -> 0x0012FF18
*/
// Range: 0x12FE80 -> 0x12FF18
void xSceneForAllDynamics(class _xScene * sc /* r20 */, class _xEnt * (* func)(class _xEnt *, class _xScene *, void *) /* r19 */, void * data /* r18 */) {
    /* anonymous block */ {
        // Range: 0x12FE80 -> 0x12FF18
        unsigned short i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FF20 -> 0x0012FFB8
*/
// Range: 0x12FF20 -> 0x12FFB8
void xSceneForAllStatics(class _xScene * sc /* r20 */, class _xEnt * (* func)(class _xEnt *, class _xScene *, void *) /* r19 */, void * data /* r18 */) {
    /* anonymous block */ {
        // Range: 0x12FF20 -> 0x12FFB8
        unsigned short i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0012FFC0 -> 0x00130058
*/
// Range: 0x12FFC0 -> 0x130058
void xSceneForAllTriggers(class _xScene * sc /* r20 */, class _xEnt * (* func)(class _xEnt *, class _xScene *, void *) /* r19 */, void * data /* r18 */) {
    /* anonymous block */ {
        // Range: 0x12FFC0 -> 0x130058
        unsigned short i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130060 -> 0x00130088
*/
// Range: 0x130060 -> 0x130088
char * xSceneID2Name(class _xScene * sc /* r2 */, unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x130060 -> 0x130088
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130090 -> 0x001300B8
*/
// Range: 0x130090 -> 0x1300B8
class xBase * xSceneResolvID(class _xScene * sc /* r2 */, unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x130090 -> 0x1300B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001300C0 -> 0x00130184
*/
// Range: 0x1300C0 -> 0x130184
void xSceneAddEnt(class _xScene * sc /* r2 */, class _xEnt * ent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1300C0 -> 0x130184
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00130190 -> 0x00130198
*/
// Range: 0x130190 -> 0x130198
void xSceneSetup(class _xScene * sc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x130190 -> 0x130198
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001301A0 -> 0x001301A8
*/
// Range: 0x1301A0 -> 0x1301A8
void xSceneLoad() {
    /* anonymous block */ {
        // Range: 0x1301A0 -> 0x1301A8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001301B0 -> 0x001301B8
*/
// Range: 0x1301B0 -> 0x1301B8
void xSceneSave() {
    /* anonymous block */ {
        // Range: 0x1301B0 -> 0x1301B8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001301C0 -> 0x00130350
*/
// Range: 0x1301C0 -> 0x130350
void xSceneInit(class _xScene * sc /* r16 */, unsigned short num_trigs /* r21 */, unsigned short num_stats /* r20 */, unsigned short num_dyns /* r19 */, unsigned short num_npcs /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1301C0 -> 0x130350
    }
}
