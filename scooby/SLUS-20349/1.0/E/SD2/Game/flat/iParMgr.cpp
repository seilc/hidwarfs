/*
    Compile unit: E:\SD2\Game\flat\iParMgr.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int gColorTableInit; // size: 0x4, address: 0x358294
static float gColorTable[256]; // size: 0x400, address: 0x3A0300
...
class tagiRenderArrays gRenderArr; // size: 0x5280, address: 0x3A0700
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AF280 -> 0x001AF4BC
*/
// Range: 0x1AF280 -> 0x1AF4BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AF4C0 -> 0x001AFD78
*/
// Range: 0x1AF4C0 -> 0x1AFD78
void iParMgrRenderParSys_Ground(void * data /* r2 */, class xParGroup * ps /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1AF4C0 -> 0x1AFD78
        ...
        float angy; // r3
        float angx; // r2
        class _xMat3x3 groundmat; // r29+0x90
        unsigned char a; // r5
        unsigned char b; // r4
        unsigned char g; // r3
        unsigned char r; // r2
        ...
        class RwTexture * texture; // r2
        class xPar * idx; // r16
        unsigned short i3d[6]; // @ 0x002B3E70
        class RxObjSpace3DVertex v3d[4]; // @ 0x003A5B20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AFD80 -> 0x001AFD88
*/
// Range: 0x1AFD80 -> 0x1AFD88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AFD90 -> 0x001AFFDC
*/
// Range: 0x1AFD90 -> 0x1AFFDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AFFE0 -> 0x001B0388
*/
// Range: 0x1AFFE0 -> 0x1B0388
void iParMgrRenderParSys_InvStreak(void * data /* r2 */, class xParGroup * ps /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1AFFE0 -> 0x1B0388
        class RxObjSpace3DVertex * v3d; // r6
        class RwRaster * raster; // r2
        class RwTexture * texture; // r2
        class xPar * idx; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0390 -> 0x001B0738
*/
// Range: 0x1B0390 -> 0x1B0738
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0740 -> 0x001B07B8
*/
// Range: 0x1B0740 -> 0x1B07B8
void iRenderTrianglesImmediate(void * vertices /* r2 */, signed int vertexCount /* r2 */, unsigned short * indices /* r17 */, signed int indexCount /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B0740 -> 0x1B07B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B07C0 -> 0x001B0BB8
*/
// Range: 0x1B07C0 -> 0x1B0BB8
static void iRenderPushFlat(class xPar * p /* r21 */, class xParCmdTex * tex /* r20 */) {
    /* anonymous block */ {
        ...
        class RwRGBA * _col; // r2
        float yaw; // r29+0xE0
        class _xMat3x3 groundmat; // r29+0xB0
        float size; // r20
        unsigned char a; // r17
        unsigned char b; // r22
        unsigned char g; // r23
        ...
        void * vertices; // r2
        unsigned short i3d[6]; // @ 0x002B3E60
        class RxObjSpace3DVertex v3d[4]; // @ 0x003A5A90
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0BC0 -> 0x001B0F54
*/
// Range: 0x1B0BC0 -> 0x1B0F54
void iRenderPushQuadStreak(class xPar * p /* r20 */, class xParCmdTex * tex /* r19 */) {
    /* anonymous block */ {
        // Range: 0x1B0BC0 -> 0x1B0F54
        unsigned short * dst; // r4
        float v2; // r29+0x60
        ...
        unsigned short * indices; // r16
        void * vertices; // r2
        unsigned short i3d[6]; // @ 0x002B3E50
        class RxObjSpace3DVertex v3d[4]; // @ 0x003A5A00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B0F60 -> 0x001B1578
*/
// Range: 0x1B0F60 -> 0x1B1578
void iParMgrRenderParSys_Sprite(void * data /* r2 */, class xParGroup * ps /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B0F60 -> 0x1B1578
        float v2; // r29+0x50
        float v1; // r7
        ...
        class xPar * p; // r2
        class xParCmdTex * tex; // r17
        class RxObjSpace3DVertex * v3d; // r2
        unsigned short * i3d; // r16
        signed int vertexCount; // r7
        signed int indexCount; // r3
        class RwRaster * raster; // r2
        class RwTexture * texture; // r2
        class zParSys * s; // r2
        class xPar * idx; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1580 -> 0x001B1588
*/
// Range: 0x1B1580 -> 0x1B1588
void iParMgrRender() {
    /* anonymous block */ {
        // Range: 0x1B1580 -> 0x1B1588
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B1590 -> 0x001B1598
*/
// Range: 0x1B1590 -> 0x1B1598
void iParMgrUpdate() {
    /* anonymous block */ {
        // Range: 0x1B1590 -> 0x1B1598
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B15A0 -> 0x001B16C8
*/
// Range: 0x1B15A0 -> 0x1B16C8
void iParMgrInit() {
    /* anonymous block */ {
        // Range: 0x1B15A0 -> 0x1B16C8
        signed int i; // r11
