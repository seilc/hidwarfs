/*
    Compile unit: E:\SD2\Game\flat\zMovePoint.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class _zMovePoint * g_mvpt_list; // size: 0x4, address: 0x358148
static signed int g_mvpt_cnt; // size: 0x4, address: 0x35814C
class zGlobals globals; // size: 0x3330, address: 0x362FD0
signed int MVPT_dflt_chklos(void *, class _xVec3 *, class _zMovePoint *); // size: 0x0, address: 0x19CA90
signed int zMovePointEventCB(class xBase *, class xBase *, unsigned int, float *, class xBase *); // size: 0x0, address: 0x19D150
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019CA90 -> 0x0019CBE0
*/
// Range: 0x19CA90 -> 0x19CBE0
static signed int MVPT_dflt_chklos(class _xVec3 * mypos /* r2 */, class _zMovePoint * mvpt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19CA90 -> 0x19CBE0
        class _xCollis colrec; // r29+0x50
        class _xVec3 vec_tgt; // r29+0xA0
        class _xRay3 ray_los; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019CBE0 -> 0x0019D0C8
*/
// Range: 0x19CBE0 -> 0x19D0C8
class _zMovePoint * zMovePointFindNearest(signed int flg_opts /* r2 */, class _xVec3 * yourpos /* r18 */, float okdist /* r24 */, float nohope /* r23 */, void * yourdata /* r29+0x14C */, signed int (* losfunc)(void *, class _xVec3 *, class _zMovePoint *) /* r30 */, signed int * idx_resume /* r29+0x148 */, class _zMovePoint * * prev_best /* r29+0x144 */) {
    /* anonymous block */ {
        // Range: 0x19CBE0 -> 0x19D0C8
        class _xVec3 delta; // r29+0x150
        float ds2_far; // r25
        float ds2_best; // r22
        float ds2_nohope; // r21
        float ds2_ok; // r20
        signed int rc; // r2
        signed int suspend; // r20
        signed int eidx; // r22
        signed int sidx; // r2
        signed int i; // r2
        class _zMovePoint * cur_best; // r19
        class _zMovePoint * da_mvpt; // r29+0xCC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D0D0 -> 0x0019D0F4
*/
// Range: 0x19D0D0 -> 0x19D0F4
class _zMovePoint * zMovePointFindNearest(signed int flg_opts /* r2 */, class _xVec3 * yourpos /* r2 */, void * yourdata /* r2 */, signed int (* losfunc)(void *, class _xVec3 *, class _zMovePoint *) /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D0D0 -> 0x19D0F4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D100 -> 0x0019D118
*/
// Range: 0x19D100 -> 0x19D118
signed int zMovePointIsOn(class _zMovePoint * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D100 -> 0x19D118
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D120 -> 0x0019D128
*/
// Range: 0x19D120 -> 0x19D128
float zMovePointGetDelay(class _zMovePoint * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D120 -> 0x19D128
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D130 -> 0x0019D138
*/
// Range: 0x19D130 -> 0x19D138
class _xVec3 * zMovePointGetPos(class _zMovePoint * m /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D130 -> 0x19D138
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D140 -> 0x0019D148
*/
// Range: 0x19D140 -> 0x19D148
float zMovePointGetNext(class _zMovePoint * current /* r2 */, class _zMovePoint * prev /* r2 */, class _zMovePoint * * next /* r2 */, class _xVec3 * hdng /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D140 -> 0x19D148
        float dist; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D150 -> 0x0019D1B0
*/
// Range: 0x19D150 -> 0x19D1B0
signed int zMovePointEventCB(class xBase * to /* r2 */, unsigned int toEvent /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D150 -> 0x19D1B0
        class _zMovePoint * m; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D1B0 -> 0x0019D1B8
*/
// Range: 0x19D1B0 -> 0x19D1B8
void zMovePointLoad(class _zMovePoint * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D1B0 -> 0x19D1B8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D1C0 -> 0x0019D1C8
*/
// Range: 0x19D1C0 -> 0x19D1C8
void zMovePointSave(class _zMovePoint * ent /* r2 */, class xSerial * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D1C0 -> 0x19D1C8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D1D0 -> 0x0019D218
*/
// Range: 0x19D1D0 -> 0x19D218
class _zMovePoint * zMovePoint_From_xAssetID(unsigned int aid /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D1D0 -> 0x19D218
        signed int i; // r5
        class _zMovePoint * da_mvpt; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D220 -> 0x0019D228
*/
// Range: 0x19D220 -> 0x19D228
void zMovePointSetup(class _zMovePoint * mvpt /* r2 */, class zScene * scn /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D220 -> 0x19D228
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D230 -> 0x0019D250
*/
// Range: 0x19D230 -> 0x19D250
class _zMovePoint * zMovePoint_GetInst(signed int n /* r2 */) {
    /* anonymous block */ {
        // Range: 0x19D230 -> 0x19D250
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D250 -> 0x0019D2B4
*/
// Range: 0x19D250 -> 0x19D2B4
void zMovePointInit(class _zMovePoint * m /* r16 */, class p2MovePointAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x19D250 -> 0x19D2B4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0019D2C0 -> 0x0019D318
*/
// Range: 0x19D2C0 -> 0x19D318
class _zMovePoint * zMovePoint_GetMemPool(signed int cnt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x19D2C0 -> 0x19D318
    }
}
