/*
    Compile unit: E:\SD2\Game\flat\zHud.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static signed int sShakeSnackCounter; // size: 0x4, address: 0x358308
static float widthAspect; // size: 0x4, address: 0x35830C
static float heightAspect; // size: 0x4, address: 0x358310
static signed int sHudGameStatsTimer; // size: 0x4, address: 0x358314
static float tmpRoomTime; // size: 0x4, address: 0x358318
static float sHudStatusAngX; // size: 0x4, address: 0x0
static float sHudStatusAngY; // size: 0x4, address: 0x0
static float sHudStatusAngZ; // size: 0x4, address: 0x0
static float sHudDisplayTimer_plrStatus; // size: 0x4, address: 0x35831C
static float sHudDisplayTimer_snacks; // size: 0x4, address: 0x358320
static float sHudDisplayTimer_gum; // size: 0x4, address: 0x358324
static float sHudDisplayTimer_soap; // size: 0x4, address: 0x358328
static float sHudDisplayTimer_healthBar; // size: 0x4, address: 0x35832C
static unsigned int oldHealthCnt; // size: 0x4, address: 0x358330
static unsigned int oldHealthCnt2; // size: 0x4, address: 0x358334
static unsigned int oldSnackCnt; // size: 0x4, address: 0x0
static signed int oldGumCnt; // size: 0x4, address: 0x358338
static signed int oldGumCnt2; // size: 0x4, address: 0x35833C
static signed int oldSoapCnt; // size: 0x4, address: 0x358340
static signed int oldSoapCnt2; // size: 0x4, address: 0x358344
static float sHudDisplayTimer_allSnacksArea; // size: 0x4, address: 0x357618
static float sHudDisplayTimer_saveDone; // size: 0x4, address: 0x35761C
static class RwSky2DVertex Vert[4]; // size: 0x100, address: 0x3A6C70
static unsigned short Idx[6]; // size: 0xC, address: 0x2B4088
static class zHudModel zHudModelTable[42]; // size: 0x1F8, address: 0x2B40A0
static class zHudItem sHudSnackArray[1]; // size: 0x234, address: 0x3A6D70
static class zHudItem sHudChancesArray[1]; // size: 0x234, address: 0x3A6FB0
static class zHudItem sHudGumArray[5]; // size: 0xB04, address: 0x3A71F0
static class zHudItem sHudSoapArray[6]; // size: 0xD38, address: 0x3A7D00
static class zHudItem sHudSoapboxArray[1]; // size: 0x234, address: 0x3A8A40
static class zHudItem sHudGumpackArray[1]; // size: 0x234, address: 0x3A8C80
static class zHudItem sHudPlayerStatusArray[6]; // size: 0xD38, address: 0x3A8EC0
static class zHudItem sHudHealthbarArray[5]; // size: 0xB04, address: 0x3A9C00
static class zHudItem sHudGameStatsArray[7]; // size: 0xF6C, address: 0x3AA710
static class _zHudElement sHudElements[10]; // size: 0xAF0, address: 0x2B42A0
static class xFontBox * fontBox; // size: 0x4, address: 0x358348
static class iColor_tag clr; // size: 0x4, address: 0x357620
static class iColor_tag clrDropShadow; // size: 0x4, address: 0x357624
static float dynOffset; // size: 0x4, address: 0x35834C
static signed int sStatInit; // size: 0x4, address: 0x358350
...
public:
    ...
    class xAnimTable * atbl; // offset 0x4, size 0x4
    class zHudFrame hframe; // offset 0x8, size 0x40
    enum eHudStatusPos statusPos; // offset 0x48, size 0x4
    enum eHudStatusSize statusSize; // offset 0x4C, size 0x4
    enum eHudStatusAng statusAng; // offset 0x50, size 0x4
    enum eHudStatusColor statusColor; // offset 0x54, size 0x4
    char text[64]; // offset 0x58, size 0x40
    signed int statusFX; // offset 0x98, size 0x4
    float shake; // offset 0x9C, size 0x4
    class zHudStatusPos zHudStatusPosTable[10]; // offset 0xA0, size 0x50
    class zHudStatusAng zHudStatusAngTable[11]; // offset 0xF0, size 0x84
    class zHudStatusSize zHudStatusSizeTable[9]; // offset 0x174, size 0x48
    class zHudStatusColor zHudStatusColorTable[6]; // offset 0x1BC, size 0x78
};
// total size: 0xC
...
enum eHudStatusSize {
    eHudStatusSizeDefault = 0,
    eHudStatusSizeZero = 1,
    eHudStatusSizeSmall = 2,
    eHudStatusSizeBig = 3,
    eHudStatusSizeSquash = 4,
    eHudStatusSizeZeroHoriz = 5,
    eHudStatusSizeZeroVert = 6,
    eHudStatusSizeHyper = 7,
    eHudStatusSizeHyperReverse = 8,
    eHudStatusSizeCount = 9,
};
// total size: 0xC
...
class _zHudElement {
    // Members
public:
    enum eHudElement hudType; // offset 0x0, size 0x4
    void (* hudInit)(); // offset 0x4, size 0x4
    void (* hudSetup)(class _xScene *); // offset 0x8, size 0x4
    void (* hudUpdate)(class _xScene *, float); // offset 0xC, size 0x4
    void (* hudRender)(); // offset 0x10, size 0x4
    unsigned int count; // offset 0x14, size 0x4
    char text[256]; // offset 0x18, size 0x100
};
// total size: 0xC
class RxClusterRef {
    // Members
...
class zHudModel {
    // Members
public:
    enum eHudModel type; // offset 0x0, size 0x4
    char * modelName; // offset 0x4, size 0x4
    unsigned int modelNameID; // offset 0x8, size 0x4
};
// total size: 0x70
class RpAtomic {
    // Members
...
enum eHudStatusColor {
    eHudStatusColorSolid = 0,
    eHudStatusColorTransparent = 1,
    eHudStatusColorLightBlue = 2,
    eHudStatusColorOpaque1 = 3,
    eHudStatusColorOpaque2 = 4,
    eHudStatusColorOpaque3 = 5,
    eHudStatusColorCount = 6,
};
// total size: 0x1C
class RxCluster {
    // Members
...
enum eHudStatusPos {
    eHudStatusPosOnScreen = 0,
    eHudStatusPosOffScreenDefault = 1,
    eHudStatusPosOffScreenAlternate1 = 2,
    eHudStatusPosOffScreenAlternate2 = 3,
    eHudStatusPosNudgeUp = 4,
    eHudStatusPosNudgeDown = 5,
    eHudStatusPosNudgeLeft = 6,
    eHudStatusPosNudgeRight = 7,
    eHudStatusPosMiddleOfScreen = 8,
    eHudStatusPosOnScreenAlt1 = 9,
    eHudStatusPosCount = 10,
};
enum eHudModel {
    eHudModelBubblegumPiece = 0,
    eHudModelBubblegumPack = 1,
    eHudModelBubblegumMachine = 2,
    eHudModelPinkBunnySlippers = 3,
    eHudModelBarSoap = 4,
    eHudModelBoxSoap = 5,
    eHudModelBubblePowerUp = 6,
    eHudModelLampShade = 7,
    eHudModelFlowerPot = 8,
    eHudModelPlungerSuctionCup = 9,
    eHudModelBlackKnightHelmut = 10,
    eHudModelSpring = 11,
    eHudModelDivingHelmut = 12,
    eHudModelSkull = 13,
    eHudModelLightingBolt = 14,
    eHudModelFootballHelmut = 15,
    eHudModelUmbrella_closed = 16,
    eHudModelUmbrella_open = 17,
    eHudModelShovel = 18,
    eHudModelIndividualScoobySnack = 19,
    eHudModelScoobyCollar = 20,
    eHudModelMagnifyingGlass = 21,
    eHudModelHotSauce = 22,
    eHudModelSphere = 23,
    eHudModelHead0 = 24,
    eHudModelHead1 = 25,
    eHudModelHead2 = 26,
    ...
    eHudModelHead4 = 28,
    eHudModelHead5 = 29,
    eHudModelSandwich1 = 30,
    eHudModelSandwich2 = 31,
    eHudModelSandwich3 = 32,
    eHudModelSandwich4 = 33,
    eHudModelSandwich5 = 34,
    eHudModelEnemyIcon = 35,
    eHudModelClue = 36,
    eHudModel_err = 37,
    eHudModelBubblegumPiece2 = 38,
    eHudModelBubblegumPiece3 = 39,
    eHudModelBubblegumPiece4 = 40,
    eHudModelBubblegumPiece5 = 41,
    eHudModelCount = 42,
};
// total size: 0x20
class iModelTag {
...
class xFFX {};
enum eHudInterpType {
    eHudInterpTypeLinear = 0,
    eHudInterpTypeDecel = 1,
    eHudInterpTypeAccel = 2,
    eHudInterpTypeCount = 3,
};
// total size: 0xD0
...
enum eHudStatusAng {
    eHudStatusAngStop = 0,
    eHudStatusAngIdle = 1,
    eHudStatusAngIdleReverse = 2,
    eHudStatusAngSlow = 3,
    eHudStatusAngSlowReverse = 4,
    eHudStatusAngFast = 5,
    eHudStatusAngFastReverse = 6,
    eHudStatusAngHyper = 7,
    eHudStatusAngHyperReverse = 8,
    eHudStatusAngTest1 = 9,
    eHudStatusAngTest2 = 10,
    eHudStatusAngCount = 11,
};
// total size: 0x40
class _xMat4x3 {
    // Members
...
class zHudColor {
    // Members
public:
    float rm; // offset 0x0, size 0x4
    float gm; // offset 0x4, size 0x4
    float bm; // offset 0x8, size 0x4
...
public:
    class _xVec3 pos; // offset 0x0, size 0xC
    class _xVec3 size; // offset 0xC, size 0xC
    class _xVec3 ang; // offset 0x18, size 0xC
    class _xVec3 dang; // offset 0x24, size 0xC
    class zHudColor color; // offset 0x30, size 0x10
};
// total size: 0x10
class _xRect {
    // Members
...
public:
    ...
    float bm; // offset 0x8, size 0x4
    float a; // offset 0xC, size 0x4
    enum eHudInterpType interp; // offset 0x10, size 0x4
};
// total size: 0x50
class _xEntDrive {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C55C0 -> 0x001C59A0
*/
// Range: 0x1C55C0 -> 0x1C59A0
void zHudInterp2d(float dt /* r24 */, float * srcx /* r19 */, float * srcy /* r18 */, float dstx /* r29+0x80 */, float dsty /* r29+0x80 */, float speed /* r23 */, signed int type /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1C55C0 -> 0x1C59A0
        float d2; // r20
        class _xVec2 tNorm; // r29+0x78
        class _xVec2 t; // r29+0x70
        float dy; // r29+0x80
        float dx; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C59A0 -> 0x001C5AE8
*/
// Range: 0x1C59A0 -> 0x1C5AE8
void zHudInterp1d(float dt /* r23 */, float * src /* r16 */, float dst /* r29+0x30 */, float speed /* r22 */, signed int type /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1C59A0 -> 0x1C5AE8
        float diff; // r29+0x30
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5AF0 -> 0x001C5B08
*/
// Range: 0x1C5AF0 -> 0x1C5B08
void zHudHide() {
    /* anonymous block */ {
        // Range: 0x1C5AF0 -> 0x1C5B08
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5B10 -> 0x001C5B30
*/
// Range: 0x1C5B10 -> 0x1C5B30
void zHudShow() {
    /* anonymous block */ {
        // Range: 0x1C5B10 -> 0x1C5B30
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5B30 -> 0x001C5B7C
*/
// Range: 0x1C5B30 -> 0x1C5B7C
unsigned int zHudModelGetID(unsigned int modelEnum /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1C5B30 -> 0x1C5B7C
        signed int i; // r3
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5B80 -> 0x001C5B88
*/
// Range: 0x1C5B80 -> 0x1C5B88
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5B90 -> 0x001C5FCC
*/
// Range: 0x1C5B90 -> 0x1C5FCC
void zHud_UIRender(char * asset /* r2 */, float xPos /* r23 */, float yPos /* r22 */, float w /* r20 */, float h /* r21 */, unsigned char alpha /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1C5B90 -> 0x1C5FCC
        float cooz; // r2
        float cz; // r1
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C5FD0 -> 0x001C6188
*/
// Range: 0x1C5FD0 -> 0x1C6188
void zHud_DrawText(float x /* r25 */, float y /* r24 */, float w /* r23 */, float h /* r22 */, char * s /* r17 */, signed int just /* r16 */, float size /* r29+0x70 */, unsigned char alpha /* r2 */, enum eHudDropShadowMode shadow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1C5FD0 -> 0x1C6188
        float drawSizeY; // r29+0x70
        float drawSizeX; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C6190 -> 0x001C63BC
*/
// Range: 0x1C6190 -> 0x1C63BC
void zHudElementsCB_GameStatsRender() {
    /* anonymous block */ {
        // Range: 0x1C6190 -> 0x1C63BC
        class _xMat4x3 frame; // r29+0x90
        class _xVec3 to; // r29+0xE0
        class _xVec3 from; // r29+0xD0
        class _xRect r; // r29+0x80
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C63C0 -> 0x001C6A5C
*/
// Range: 0x1C63C0 -> 0x1C6A5C
void zHudElementsCB_GameStatsUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C63C0 -> 0x1C6A5C
        float total; // r2
        float collected; // r1
        signed int i; // r16
        class iColor_tag black; // r29+0x6C
        class iColor_tag clear; // r29+0x68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C6A60 -> 0x001C6D70
*/
// Range: 0x1C6A60 -> 0x1C6D70
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C6D70 -> 0x001C70C8
*/
// Range: 0x1C6D70 -> 0x1C70C8
void zHudElementsCB_GameStatsInit() {
    /* anonymous block */ {
        // Range: 0x1C6D70 -> 0x1C70C8
        class xAnimFile * afile; // r18
        unsigned int size; // r29+0x60
        void * buff; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C70D0 -> 0x001C727C
*/
// Range: 0x1C70D0 -> 0x1C727C
void zHudElementsCB_HealthbarRender() {
    /* anonymous block */ {
        // Range: 0x1C70D0 -> 0x1C727C
        class _xMat4x3 frame; // r29+0x80
        class _xVec3 to; // r29+0xD0
        class _xVec3 from; // r29+0xC0
        class _xRect r; // r29+0x70
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C7280 -> 0x001C784C
*/
// Range: 0x1C7280 -> 0x1C784C
void zHudElementsCB_HealthbarUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C7280 -> 0x1C784C
        signed int i; // r16
        signed int i; // r9
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C7850 -> 0x001C79FC
*/
// Range: 0x1C7850 -> 0x1C79FC
void zHudElementsCB_HealthbarSetup() {
    /* anonymous block */ {
        // Range: 0x1C7850 -> 0x1C79FC
        class xAnimSingle * asing; // r2
        class xAnimPlay * aplay; // r3
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C7A00 -> 0x001C7C90
*/
// Range: 0x1C7A00 -> 0x1C7C90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C7C90 -> 0x001C7ED8
*/
// Range: 0x1C7C90 -> 0x1C7ED8
void zHudElementsCB_GumpackRender() {
    /* anonymous block */ {
        // Range: 0x1C7C90 -> 0x1C7ED8
        char str[256]; // r29+0x80
        class RwRGBA colgum; // r29+0x19C
        class _xMat4x3 frame; // r29+0x40
        class _xVec3 to; // r29+0x190
        class _xVec3 from; // r29+0x180
        class _xRect r; // r29+0x30
        class zHudItem * item; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C7EE0 -> 0x001C82AC
*/
// Range: 0x1C7EE0 -> 0x1C82AC
void zHudElementsCB_GumpackUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C7EE0 -> 0x1C82AC
        class zHudItem * item; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C82B0 -> 0x001C8434
*/
// Range: 0x1C82B0 -> 0x1C8434
void zHudElementsCB_GumpackSetup() {
    /* anonymous block */ {
        // Range: 0x1C82B0 -> 0x1C8434
        class xAnimSingle * asing; // r5
        class xAnimPlay * aplay; // r4
        class zHudItem * item; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8440 -> 0x001C85BC
*/
// Range: 0x1C8440 -> 0x1C85BC
void zHudElementsCB_GumpackInit() {
    /* anonymous block */ {
        // Range: 0x1C8440 -> 0x1C85BC
        class xAnimFile * afile; // r17
        unsigned int size; // r29+0x38
        void * buff; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C85C0 -> 0x001C87BC
*/
// Range: 0x1C85C0 -> 0x1C87BC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C87C0 -> 0x001C8B68
*/
// Range: 0x1C87C0 -> 0x1C8B68
void zHudElementsCB_SoapboxUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C87C0 -> 0x1C8B68
        class zHudItem * item; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8B70 -> 0x001C8D0C
*/
// Range: 0x1C8B70 -> 0x1C8D0C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8D10 -> 0x001C8E8C
*/
// Range: 0x1C8D10 -> 0x1C8E8C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8E90 -> 0x001C8E98
*/
// Range: 0x1C8E90 -> 0x1C8E98
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8EA0 -> 0x001C8EA8
*/
// Range: 0x1C8EA0 -> 0x1C8EA8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8EB0 -> 0x001C8EB8
*/
// Range: 0x1C8EB0 -> 0x1C8EB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8EC0 -> 0x001C8EC8
*/
// Range: 0x1C8EC0 -> 0x1C8EC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C8ED0 -> 0x001C91D8
*/
// Range: 0x1C8ED0 -> 0x1C91D8
void zHudElementsCB_SoapRender() {
    /* anonymous block */ {
        // Range: 0x1C8ED0 -> 0x1C91D8
        class RwRGBA colsoap; // r29+0x15C
        class _xMat4x3 frame; // r29+0xE0
        class _xVec3 to; // r29+0x150
        class _xVec3 from; // r29+0x140
        class _xRect r; // r29+0xD0
        signed int i; // r16
        class _xMat4x3 frame; // r29+0x90
        class _xVec3 to; // r29+0x130
        class _xVec3 from; // r29+0x120
        class _xRect r; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C91E0 -> 0x001C97B8
*/
// Range: 0x1C91E0 -> 0x1C97B8
void zHudElementsCB_SoapUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C91E0 -> 0x1C97B8
        signed int i; // r16
        signed int i; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C97C0 -> 0x001C9A60
*/
// Range: 0x1C97C0 -> 0x1C9A60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9A60 -> 0x001C9BD4
*/
// Range: 0x1C9A60 -> 0x1C9BD4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9BE0 -> 0x001C9D9C
*/
// Range: 0x1C9BE0 -> 0x1C9D9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001C9DA0 -> 0x001CA2AC
*/
// Range: 0x1C9DA0 -> 0x1CA2AC
void zHudElementsCB_GumUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1C9DA0 -> 0x1CA2AC
        signed int i; // r16
        signed int i; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA2B0 -> 0x001CA424
*/
// Range: 0x1CA2B0 -> 0x1CA424
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA430 -> 0x001CA834
*/
// Range: 0x1CA430 -> 0x1CA834
void zHudElementsCB_GumInit() {
    /* anonymous block */ {
        // Range: 0x1CA430 -> 0x1CA834
        class xAnimFile * afile; // r17
        unsigned int size; // r29+0x58
        void * buff; // r2
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CA840 -> 0x001CAA1C
*/
// Range: 0x1CA840 -> 0x1CAA1C
void zHudElementsCB_SnacksRender() {
    /* anonymous block */ {
        // Range: 0x1CA840 -> 0x1CAA1C
        class _xMat4x3 frame; // r29+0x140
        class _xVec3 to; // r29+0x190
        class _xVec3 from; // r29+0x180
        class _xRect r; // r29+0x130
        char str[256]; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA20 -> 0x001CAA2C
*/
// Range: 0x1CAA20 -> 0x1CAA2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA30 -> 0x001CAA40
*/
// Range: 0x1CAA30 -> 0x1CAA40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA40 -> 0x001CAA4C
*/
// Range: 0x1CAA40 -> 0x1CAA4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA50 -> 0x001CAA5C
*/
// Range: 0x1CAA50 -> 0x1CAA5C
void zHud_showSnack() {
    /* anonymous block */ {
        // Range: 0x1CAA50 -> 0x1CAA5C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA60 -> 0x001CAA78
*/
// Range: 0x1CAA60 -> 0x1CAA78
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAA80 -> 0x001CAE40
*/
// Range: 0x1CAA80 -> 0x1CAE40
void zHudElementsCB_SnacksUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CAA80 -> 0x1CAE40
        signed int i; // r4
        class zHudItem * item; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAE40 -> 0x001CAF48
*/
// Range: 0x1CAE40 -> 0x1CAF48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CAF50 -> 0x001CB008
*/
// Range: 0x1CAF50 -> 0x1CB008
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB010 -> 0x001CB018
*/
// Range: 0x1CB010 -> 0x1CB018
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB020 -> 0x001CB230
*/
// Range: 0x1CB020 -> 0x1CB230
void zHudElementsCB_ChancesUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CB020 -> 0x1CB230
        class zHudItem * item; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB230 -> 0x001CB2C8
*/
// Range: 0x1CB230 -> 0x1CB2C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB2D0 -> 0x001CB2D8
*/
// Range: 0x1CB2D0 -> 0x1CB2D8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB2E0 -> 0x001CB4FC
*/
// Range: 0x1CB2E0 -> 0x1CB4FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB500 -> 0x001CB510
*/
// Range: 0x1CB500 -> 0x1CB510
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB510 -> 0x001CB968
*/
// Range: 0x1CB510 -> 0x1CB968
void zHudElementsCB_PlayerStatusUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CB510 -> 0x1CB968
        signed int i; // r16
        signed int i; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CB970 -> 0x001CBAF4
*/
// Range: 0x1CB970 -> 0x1CBAF4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CBB00 -> 0x001CC078
*/
// Range: 0x1CBB00 -> 0x1CC078
void zHudElementsCB_PlayerStatusInit() {
    /* anonymous block */ {
        // Range: 0x1CBB00 -> 0x1CC078
        class xAnimFile * afile; // r18
        unsigned int size; // r29+0x64
        void * buff; // r17
        signed int i; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC080 -> 0x001CC0E8
*/
// Range: 0x1CC080 -> 0x1CC0E8
void zHud_Render() {
    /* anonymous block */ {
        // Range: 0x1CC080 -> 0x1CC0E8
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC0F0 -> 0x001CC330
*/
// Range: 0x1CC0F0 -> 0x1CC330
void zHud_Update(class _xScene * sc /* r18 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1CC0F0 -> 0x1CC330
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC330 -> 0x001CC388
*/
// Range: 0x1CC330 -> 0x1CC388
void zHud_Setup(class _xScene * sc /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1CC330 -> 0x1CC388
        signed int i; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC390 -> 0x001CC45C
*/
// Range: 0x1CC390 -> 0x1CC45C
void zHud_Init() {
    /* anonymous block */ {
        // Range: 0x1CC390 -> 0x1CC45C
        signed int i; // r16
