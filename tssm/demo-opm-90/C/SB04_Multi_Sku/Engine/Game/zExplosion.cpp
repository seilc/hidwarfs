/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zExplosion.cpp
...
static char ini_filename[12]; // size: 0xC, address: 0x62DEC8
static char * decal_type_labels[4]; // size: 0x10, address: 0x0
static unsigned int decal_type_ids[4]; // size: 0x10, address: 0x62DEE0
static signed int decal_blend_mode[3]; // size: 0xC, address: 0x62DEF0
static signed int decal_flags[3]; // size: 0xC, address: 0x62DF00
static class curve_node decal_anim_impact[3]; // size: 0x54, address: 0x62DF10
static class curve_node decal_anim_burn[7]; // size: 0xC4, address: 0x62DF70
static class curve_node decal_anim_plasma[3]; // size: 0x54, address: 0x62E040
static class xResponseCurve decal_curve[3]; // size: 0x30, address: 0x7B6820
static class mote * motes; // size: 0x4, address: 0x6383B8
static signed int motes_used; // size: 0x4, address: 0x6383BC
static class streak_particle * streaks; // size: 0x4, address: 0x6383C0
static signed int streaks_used; // size: 0x4, address: 0x6383C4
static class streak_emitter * streak_emitters; // size: 0x4, address: 0x6383C8
static signed int streak_emitters_used; // size: 0x4, address: 0x6383CC
static class streak_group * streak_groups; // size: 0x4, address: 0x6383D0
static signed int streak_groups_used; // size: 0x4, address: 0x6383D4
static class spark_particle * sparks; // size: 0x4, address: 0x6383D8
static signed int sparks_used; // size: 0x4, address: 0x6383DC
static class spark_emitter * spark_emitters; // size: 0x4, address: 0x6383E0
static signed int spark_emitters_used; // size: 0x4, address: 0x6383E4
static class spark_group * spark_groups; // size: 0x4, address: 0x6383E8
static signed int spark_groups_used; // size: 0x4, address: 0x6383EC
static class xVec3 current_cam_at; // size: 0xC, address: 0x0
static float current_cam_depth; // size: 0x4, address: 0x0
static class ini_config * ini_configs; // size: 0x4, address: 0x6383F0
static class runtime_config * runtime_configs; // size: 0x4, address: 0x6383F4
static class material_group * materials; // size: 0x4, address: 0x6383F8
static unsigned int configs_size; // size: 0x4, address: 0x6383FC
static signed int materials_used; // size: 0x4, address: 0x638400
static class presence_node presi[32]; // size: 0x780, address: 0x7B6850
static signed int presi_size; // size: 0x4, address: 0x638404
...
static class default_type_loader default_types[5]; // size: 0x28, address: 0x62E0A0
...
signed int compare_ini_sections(void *, void *); // size: 0x0, address: 0x482730
signed int compare_ini_values(void *, void *); // size: 0x0, address: 0x482720
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DA30 -> 0x0047DD94
*/
// Range: 0x47DA30 -> 0x47DD94
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DDA0 -> 0x0047DF10
*/
// Range: 0x47DDA0 -> 0x47DF10
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047DF10 -> 0x0047E00C
*/
// Range: 0x47DF10 -> 0x47E00C
// this: r17
void trail_emitter::start(signed int type /* r2 */, class xVec3 & loc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47DF10 -> 0x47E00C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E010 -> 0x0047E310
*/
// Range: 0x47E010 -> 0x47E310
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E310 -> 0x0047E354
*/
// Range: 0x47E310 -> 0x47E354
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E360 -> 0x0047E368
*/
// Range: 0x47E360 -> 0x47E368
void render() {
    /* anonymous block */ {
        // Range: 0x47E360 -> 0x47E368
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E370 -> 0x0047E378
*/
// Range: 0x47E370 -> 0x47E378
void pre_render() {
    /* anonymous block */ {
        // Range: 0x47E370 -> 0x47E378
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E380 -> 0x0047E428
*/
// Range: 0x47E380 -> 0x47E428
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E430 -> 0x0047E438
*/
// Range: 0x47E430 -> 0x47E438
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x47E430 -> 0x47E438
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E440 -> 0x0047E574
*/
// Range: 0x47E440 -> 0x47E574
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x47E440 -> 0x47E574
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E580 -> 0x0047E588
*/
// Range: 0x47E580 -> 0x47E588
void startup() {
    /* anonymous block */ {
        // Range: 0x47E580 -> 0x47E588
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E590 -> 0x0047E684
*/
// Range: 0x47E590 -> 0x47E684
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047E690 -> 0x0047EAD8
*/
// Range: 0x47E690 -> 0x47EAD8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047EAE0 -> 0x0047ED50
*/
// Range: 0x47EAE0 -> 0x47ED50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047ED50 -> 0x0047EECC
*/
// Range: 0x47ED50 -> 0x47EECC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047EED0 -> 0x0047F190
*/
// Range: 0x47EED0 -> 0x47F190
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F190 -> 0x0047F30C
*/
// Range: 0x47F190 -> 0x47F30C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F310 -> 0x0047F44C
*/
// Range: 0x47F310 -> 0x47F44C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F450 -> 0x0047F6B0
*/
// Range: 0x47F450 -> 0x47F6B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F6B0 -> 0x0047F8A0
*/
// Range: 0x47F6B0 -> 0x47F8A0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F8A0 -> 0x0047F9A8
*/
// Range: 0x47F8A0 -> 0x47F9A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047F9B0 -> 0x0047FAB8
*/
// Range: 0x47F9B0 -> 0x47FAB8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047FAC0 -> 0x0047FBC0
*/
// Range: 0x47FAC0 -> 0x47FBC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047FBC0 -> 0x0047FF20
*/
// Range: 0x47FBC0 -> 0x47FF20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047FF20 -> 0x00480084
*/
// Range: 0x47FF20 -> 0x480084
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00480090 -> 0x0048016C
*/
// Range: 0x480090 -> 0x48016C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00480170 -> 0x0048037C
*/
// Range: 0x480170 -> 0x48037C
static void load_default_config_fire_trail(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x480170 -> 0x48037C
        class curve_node anim[5]; // @ 0x00605150
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00480380 -> 0x00480584
*/
// Range: 0x480380 -> 0x480584
static void load_default_config_plasma(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x480380 -> 0x480584
        class curve_node anim[4]; // @ 0x006050F0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00480590 -> 0x004807D0
*/
// Range: 0x480590 -> 0x4807D0
static void load_default_config_fire(class ini_config & cfg /* r16 */) {
    /* anonymous block */ {
        // Range: 0x480590 -> 0x4807D0
        class curve_node anim[4]; // @ 0x00605090
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004807D0 -> 0x004825D4
*/
// Range: 0x4807D0 -> 0x4825D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004825E0 -> 0x0048271C
*/
// Range: 0x4825E0 -> 0x48271C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482720 -> 0x0048272C
*/
// Range: 0x482720 -> 0x48272C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482730 -> 0x0048273C
*/
// Range: 0x482730 -> 0x48273C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00482740 -> 0x00483188
*/
// Range: 0x482740 -> 0x483188
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00483190 -> 0x004835AC
*/
// Range: 0x483190 -> 0x4835AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004835B0 -> 0x00483BD4
*/
// Range: 0x4835B0 -> 0x483BD4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00483BE0 -> 0x0048413C
*/
// Range: 0x483BE0 -> 0x48413C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484140 -> 0x004845B4
*/
// Range: 0x484140 -> 0x4845B4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004845C0 -> 0x004849F0
*/
// Range: 0x4845C0 -> 0x4849F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004849F0 -> 0x00484E00
*/
// Range: 0x4849F0 -> 0x484E00
static void launch_line(signed int type /* r20 */, signed int size /* r17 */, class xVec3 & loc0 /* r19 */, class xVec3 & offset /* r18 */, float age_delta /* r25 */) {
    /* anonymous block */ {
        // Range: 0x4849F0 -> 0x484E00
        class runtime_config & cfg; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00484E00 -> 0x0048510C
*/
// Range: 0x484E00 -> 0x48510C
