/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zParticleCustom.cpp
...
static class xParticleBatchGroup particle_batch_group; // size: 0x8, address: 0x638630
...
public:
    ...
    signed int fire_smoke; // offset 0x10, size 0x4
} system_id; // size: 0x14, address: 0x7C5EF0
static float dust_vel_decay; // size: 0x4, address: 0x638638
signed int update_fire_smoke_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4C4530
signed int update_dust_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4C4960
signed int update_pebble_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4C4EF0
signed int update_glint_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4C5340
signed int update_spark_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x4C5830
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C4050 -> 0x004C4078
*/
// Range: 0x4C4050 -> 0x4C4078
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C4080 -> 0x004C42C8
*/
// Range: 0x4C4080 -> 0x4C42C8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C42D0 -> 0x004C4524
*/
// Range: 0x4C42D0 -> 0x4C4524
void zParticleCustomEmitFireSmoke(class xVec3 * loc /* r21 */, class xVec3 * vel /* r20 */, signed int amount /* r19 */, float life_min /* r25 */, float life_range /* r24 */, float size_min /* r23 */, float size_range /* r22 */, float dt /* r29+0xB0 */) {
    /* anonymous block */ {
        // Range: 0x4C42D0 -> 0x4C4524
        float age; // r21
        float dage; // r20
        ...
        signed int have; // r2
        class fire_smoke_particle * p; // r18
        class fire_smoke_particle * endp; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C4530 -> 0x004C4954
*/
// Range: 0x4C4530 -> 0x4C4954
static signed int update_fire_smoke_particles(unsigned char * mem /* r20 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x4C4530 -> 0x4C4954
        ...
        class fire_smoke_particle * p; // r18
        class fire_smoke_particle * end; // r17
        float age1; // r29+0xC0
        float t1; // r21
        float size; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C4960 -> 0x004C4EEC
*/
// Range: 0x4C4960 -> 0x4C4EEC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C4EF0 -> 0x004C5334
*/
// Range: 0x4C4EF0 -> 0x4C5334
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C5340 -> 0x004C5824
*/
// Range: 0x4C5340 -> 0x4C5824
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C5830 -> 0x004C5C18
*/
// Range: 0x4C5830 -> 0x4C5C18
