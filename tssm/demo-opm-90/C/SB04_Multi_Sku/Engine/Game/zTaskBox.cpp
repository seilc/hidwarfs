/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zTaskBox.cpp
...
class talk_callback * tcb; // size: 0x4, address: 0x6383A0
static // total size: 0x4
class /* @class */ {
    // Members
public:
    class ztaskbox * active; // offset 0x0, size 0x4
} shared; // size: 0x4, address: 0x6383A4
// total size: 0x18
struct /* @anon0 */ {} ztaskbox::talk_callback::__vtable; // size: 0x18, address: 0x635FB0
// total size: 0x18
struct /* @anon1 */ {} ztalkbox::callback::__vtable; // size: 0x18, address: 0x0
void cb_dispatch(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x479FE0
// total size: 0x14
class /* @class */ {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00479FE0 -> 0x0047A1B0
*/
// Range: 0x479FE0 -> 0x47A1B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A1B0 -> 0x0047A294
*/
// Range: 0x47A1B0 -> 0x47A294
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A2A0 -> 0x0047A2C0
*/
// Range: 0x47A2A0 -> 0x47A2C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A2C0 -> 0x0047A45C
*/
// Range: 0x47A2C0 -> 0x47A45C
// this: r16
void ztaskbox::set_state(enum state_enum state /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47A2C0 -> 0x47A45C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A460 -> 0x0047A468
*/
// Range: 0x47A460 -> 0x47A468
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A470 -> 0x0047A4B0
*/
// Range: 0x47A470 -> 0x47A4B0
void init() {
    /* anonymous block */ {
        // Range: 0x47A470 -> 0x47A4B0
        signed char @4959; // @ 0x006383A8
        class talk_callback tcb; // @ 0x007B67A0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A4B0 -> 0x0047A53C
*/
// Range: 0x47A4B0 -> 0x47A53C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A540 -> 0x0047A6A8
*/
// Range: 0x47A540 -> 0x47A6A8
// this: r18
void ztaskbox::start_talk(class base * npc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x47A540 -> 0x47A6A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A6B0 -> 0x0047A6C0
*/
// Range: 0x47A6B0 -> 0x47A6C0
// this: r2
void ztaskbox::write(class xSerial & s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47A6B0 -> 0x47A6C0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A6C0 -> 0x0047A700
*/
// Range: 0x47A6C0 -> 0x47A700
// this: r16
void ztaskbox::read(class xSerial & s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47A6C0 -> 0x47A700
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A700 -> 0x0047A7E4
*/
// Range: 0x47A700 -> 0x47A7E4
// this: r17
void ztaskbox::load(class asset_type & a /* r16 */) {
    /* anonymous block */ {
        // Range: 0x47A700 -> 0x47A7E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A7F0 -> 0x0047A83C
*/
// Range: 0x47A7F0 -> 0x47A83C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A840 -> 0x0047A84C
*/
// Range: 0x47A840 -> 0x47A84C
// this: r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0047A850 -> 0x0047A858
*/
// Range: 0x47A850 -> 0x47A858
// this: r2
void talk_callback::on_answer(enum answer_enum answer /* r2 */) {
    /* anonymous block */ {
        // Range: 0x47A850 -> 0x47A858
    }
}
