/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zFire.cpp
...
unsigned char frame_changed; // size: 0x1, address: 0x63840C
class zFlame * flames; // size: 0x4, address: 0x638410
unsigned int flames_size; // size: 0x4, address: 0x638414
unsigned int flames_used; // size: 0x4, address: 0x638418
static class card_info short_card_info; // size: 0x1C, address: 0x62E500
static class card_info tall_card_info; // size: 0x1C, address: 0x62E520
static class RwTexture * face_texture; // size: 0x4, address: 0x63841C
static class RwTexture * floor_texture; // size: 0x4, address: 0x638420
static float anim_frame_time; // size: 0x4, address: 0x638424
static signed int anim_frame; // size: 0x4, address: 0x638428
static class zFlame * im_flames[64]; // size: 0x100, address: 0x7B6FD0
static signed int im_flames_size; // size: 0x4, address: 0x63842C
static signed int last_brightness; // size: 0x4, address: 0x638430
static signed int last_background_glow; // size: 0x4, address: 0x638434
static class zSmokeEmitter * smoke_emitter; // size: 0x4, address: 0x638438
static class RwTexture * wisp_texture; // size: 0x4, address: 0x63843C
static signed int wisp_system_id; // size: 0x4, address: 0x638440
static signed int spawn_explosion_type; // size: 0x4, address: 0x638444
...
signed int update_wisp_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x488470
// total size: 0x8
class flame_distance_pair {
    // Members
public:
    float dist; // offset 0x0, size 0x4
    class zFlame * flame; // offset 0x4, size 0x4
};
// total size: 0x10
class xBase {
    // Members
...
public:
    ...
    class RwTexture * * textures; // offset 0x4, size 0x4
    class cell_data * cells; // offset 0x8, size 0x4
    signed int cells_size; // offset 0xC, size 0x4
    class group_data * groups; // offset 0x10, size 0x4
    ...
    class handle_link head_link; // offset 0x2C, size 0xC
    class handle_link tail_link; // offset 0x38, size 0xC
};
// total size: 0x40
class RpLight {
    // Members
...
// total size: 0x60
class icard_data : public card_data {
    // Members
public:
    class handle h; // offset 0x50, size 0x4
};
// total size: 0x18
...
class group_data {
    // Members
public:
    class icard_data * cards; // offset 0x0, size 0x4
...
// total size: 0x18
class cb_flame_circle_check {
    // Members
public:
    class zFlame * * found; // offset 0x0, size 0x4
...
class cb_sss {
    // Members
public:
    class xSweptSphere & sws; // offset 0x0, size 0x4
    class xRay3 & ray; // offset 0x4, size 0x4
};
...
public:
    ...
    char * format; // offset 0x4, size 0x4
    signed int start_index; // offset 0x8, size 0x4
    signed int rows; // offset 0xC, size 0x4
    signed int cols; // offset 0x10, size 0x4
...
class handle_link {
    // Members
public:
    class handle_link * next; // offset 0x0, size 0x4
    class handle_link * prev; // offset 0x4, size 0x4
    class icard_data * card; // offset 0x8, size 0x4
};
// total size: 0x1C
class RpMorphTarget {
    // Members
...
class zSmokeEmitter : private xBase {
    // Members
public:
    signed int system_id; // offset 0x10, size 0x4
    class asset_type * asset; // offset 0x14, size 0x4
    class xMat4x3 emit_mat; // offset 0x20, size 0x40
    float emitted; // offset 0x60, size 0x4
    signed int flags; // offset 0x64, size 0x4
    class xVec3 vel_dir; // offset 0x68, size 0xC
    signed int max_frame; // offset 0x74, size 0x4
...
class handle {
    // Members
public:
    class handle_link * link; // offset 0x0, size 0x4
};
// total size: 0xA0
class xEntMechData {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485110 -> 0x0048531C
*/
// Range: 0x485110 -> 0x48531C
// this: r16
void zFlame::refresh_nearby() {
    /* anonymous block */ {
        // Range: 0x485110 -> 0x48531C
        class zFlame * found[16]; // r29+0xD0
        signed int found_size; // r2
        class zFlame * * n; // r7
        class zFlame * * endn; // r2
        class flame_distance_pair pairs[16]; // r29+0x50
        class flame_distance_pair * p; // r6
        class zFlame & bro; // r2
        float dx; // r29+0x110
        float dy; // r29+0x110
        float dz; // r29+0x110
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485320 -> 0x00485398
*/
// Range: 0x485320 -> 0x485398
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004853A0 -> 0x00485718
*/
// Range: 0x4853A0 -> 0x485718
// this: r16
void zFlame::emit_smoke(float dheat /* r29+0xA0 */, float dt /* r26 */) {
    /* anonymous block */ {
        // Range: 0x4853A0 -> 0x485718
        float rate; // r2
        signed int emit; // r21
        class xVec3 * buffer; // r20
        class xVec3 * vel; // r22
        float x_min; // r25
        float y_min; // r24
        float z_min; // r23
        float xz_range; // r22
        float y_range; // r29+0xA0
        float vel_min; // r21
        float vel_range; // r20
        signed int i; // r19
        float size_min; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485720 -> 0x00485914
*/
// Range: 0x485720 -> 0x485914
// this: r17
unsigned char zFlame::create(class spawn_data & info /* r16 */) {
    /* anonymous block */ {
        // Range: 0x485720 -> 0x485914
        class xVec3 warp_loc; // r29+0x30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485920 -> 0x00485AC8
*/
// Range: 0x485920 -> 0x485AC8
// this: r16
void zFlame::update_effects(float dt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x485920 -> 0x485AC8
        float end_heat; // r21
        float dh; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485AD0 -> 0x00485C74
*/
// Range: 0x485AD0 -> 0x485C74
// this: r2
void zFlame::update(float dt /* r29 */, float heat_decay /* r29 */) {
    /* anonymous block */ {
        // Range: 0x485AD0 -> 0x485C74
        float add_heat; // r4
        float dh; // r3
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485C80 -> 0x00485EC4
*/
// Range: 0x485C80 -> 0x485EC4
void destroy(class handle h /* r29+0x3C */) {
    /* anonymous block */ {
        // Range: 0x485C80 -> 0x485EC4
        class handle h'100; // r17
        class zFlame & flame; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00485ED0 -> 0x004864E8
*/
// Range: 0x485ED0 -> 0x4864E8
void emit_sphere(class spawn_data & params /* r2 */, class xVec3 & center /* r16 */, float radius /* r21 */) {
    /* anonymous block */ {
        // Range: 0x485ED0 -> 0x4864E8
        class spawn_data d; // r29+0xF0
        float maxr; // r20
        float minr; // r29+0x1C0
        signed int min_fit; // r2
        signed int max_fit; // r2
        signed int fit; // r17
        float r; // r29+0x1C0
        float totalr; // r29+0x1C0
        float start_theta; // r29
        class xVec3 origin; // r29+0x1B0
        signed int max_ring; // r2
        float max_dist; // r29+0x1C0
        float max_dist2; // r28
        float diam; // r27
        signed int ring; // r23
        signed int total; // r30
        signed int amount; // r21
        float theta; // r26
        class xVec3 v; // r29+0x1A0
        class xVec3 endv; // r29+0x190
        class xVec3 dv; // r29+0x180
        signed int i; // r20
        class xVec3 voff; // r29+0x170
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004864F0 -> 0x00486D14
*/
// Range: 0x4864F0 -> 0x486D14
class handle emit(class spawn_data & params /* r19 */, unsigned char * success /* r18 */) {
    /* anonymous block */ {
        // Range: 0x4864F0 -> 0x486D14
        class handle h; // r29+0x26C
        class spawn_data d; // r29+0x210
        float overlap_radius; // r29+0x270
        class zFlame * nearbies[6]; // r29+0x1F0
        signed int nearbies_size; // r2
        class zFlame * * nearby; // r19
        class zFlame * * end_nearby; // r2
        class zFlame * nearby; // r29+0x268
        class xVec3 start; // r29+0x258
        class xVec3 end; // r29+0x248
        class xSweptSphere sws; // r29+0x120
        float overlap_radius; // r29+0x270
        class zFlame * nearbies[6]; // r29+0x100
        signed int nearbies_size; // r2
        class zFlame * * nearby; // r19
        class zFlame * * end_nearby; // r2
        class zFlame * nearby; // r29+0x264
        class zFlame * flame; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00486D20 -> 0x00486F48
*/
// Range: 0x486D20 -> 0x486F48
static unsigned char collide_swept_sphere_statics(class xSweptSphere & sws /* r17 */, unsigned char check_destructibles /* r16 */) {
    /* anonymous block */ {
        // Range: 0x486D20 -> 0x486F48
        class xBound bound; // r29+0x60
        class xRay3 ray; // r29+0x30
        class cb_ss cb; // r29+0xB8
        class cb_sss cb; // r29+0xB0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00486F50 -> 0x0048761C
*/
// Range: 0x486F50 -> 0x48761C
void render() {
    /* anonymous block */ {
        // Range: 0x486F50 -> 0x48761C
        signed int min_alpha; // r16
        class xMat4x3 & cam_mat; // r2
        signed int floor_verts; // r18
        class HIFastIMLockStruct face_lock; // r29+0x80
        class HIFastIMLockStruct floor_lock; // r29+0x60
        class xVec3 * face_pos; // r11
        class xVec3 * floor_pos; // r10
        class xVec2 * face_uv; // r7
        class xVec2 * floor_uv; // r6
        unsigned int * face_color; // r5
        unsigned int * floor_color; // r4
        signed int i; // r9
        float Cx; // r20
        float Cy; // r19
        float Cz; // r18
        ...
        float Uy; // r14
        float Uz; // r13
        float UxCPx; // r29+0xA0
        float UxCPy; // r29+0xA0
        float UxCPz; // r29+0xA0
        float Rx; // r12
        float Ry; // r11
        float Rz; // r10
        float h; // r29+0xA0
        float Escale; // r29+0xA0
        float Vx; // r2
        float Vy; // r4
        float Vz; // r9
        float Vscale; // r29+0xA0
        class zFlame * flame; // r2
        signed int uvindex; // r2
        float u0; // r8
        float v0; // r29+0xA0
        float u1; // r29+0xA0
        float v1; // r29+0xA0
        signed int intensity; // r9
        signed int alpha; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00487620 -> 0x00488224
*/
// Range: 0x487620 -> 0x488224
void pre_render() {
    /* anonymous block */ {
        // Range: 0x487620 -> 0x488224
        signed int rs_flags; // r16
        signed int min_glow; // r29+0x110
        class ptank_pool__color_mat_uv2 face_pool; // r29+0x160
        class ptank_pool__color_mat_uv2 floor_pool; // r29+0x130
        class xMat4x3 & cam_mat; // r2
        float Cx; // r29+0xFC
        float Cy; // r29+0xF8
        float Cz; // r29+0xF4
        class zFlame * flame; // r20
        class zFlame * end_flame; // r2
        float Px; // r31
        float Py; // r30
        float Pz; // r29
        float PCx; // r28
        float PCy; // r27
        float PCz; // r26
        float effect_radius; // r3
        class xVec4 effect_loc; // r29+0x120
        signed int intensity; // r6
        signed int alpha; // r4
        signed int uvindex; // r2
        float u; // r5
        float v; // r29+0x1E0
        ...
        float Uy; // r24
        float Uz; // r23
        float PCxUx; // r29+0x1E0
        float PCxUy; // r29+0x1E0
        float PCxUz; // r29+0x1E0
        float Rx; // r22
        float Ry; // r21
        float Rz; // r20
        float width; // r29+0xF0
        float height; // r29+0x1E0
        float face_width; // r29+0x1E0
        float floor_width; // r29+0x1E0
        float floor_height; // r29+0xEC
        float PCxRx; // r29+0x1E0
        float PCxRy; // r29+0x1E0
        float PCxRz; // r29+0x1E0
        float Vscale; // r29+0x1E0
        float Vx; // r29+0x1E0
        float Vy; // r29+0x1E0
        float Vz; // r29+0x1E0
        float Wx; // r29+0x1E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488230 -> 0x004882C4
*/
// Range: 0x488230 -> 0x4882C4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004882D0 -> 0x004882E8
*/
// Range: 0x4882D0 -> 0x4882E8
void reset() {
    /* anonymous block */ {
        // Range: 0x4882D0 -> 0x4882E8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004882F0 -> 0x00488330
*/
// Range: 0x4882F0 -> 0x488330
void setup() {
    /* anonymous block */ {
        // Range: 0x4882F0 -> 0x488330
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488330 -> 0x0048833C
*/
// Range: 0x488330 -> 0x48833C
void scene_exit() {
    /* anonymous block */ {
        // Range: 0x488330 -> 0x48833C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488340 -> 0x00488468
*/
// Range: 0x488340 -> 0x488468
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x488340 -> 0x488468
        char buffer[128]; // r29+0x50
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488470 -> 0x004888D4
*/
// Range: 0x488470 -> 0x4888D4
static signed int update_wisp_particles(unsigned char * mem /* r19 */, signed int count /* r2 */, class ptank_pool & apool /* r2 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x488470 -> 0x4888D4
        class ptank_pool__pos_color_size_rot & pool; // r18
        class wisp_particle * p; // r17
        class wisp_particle * end; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004888E0 -> 0x00488C18
*/
// Range: 0x4888E0 -> 0x488C18
static void update_flames(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x4888E0 -> 0x488C18
        float heat_decay; // r20
        class zFlame * flame; // r18
        class zFlame * end_flame; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00488C20 -> 0x00488CD0
*/
// Range: 0x488C20 -> 0x488CD0
static void spread_heat(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x488C20 -> 0x488CD0
        float spread_delta; // r29
        class zFlame * flame; // r7
        class zFlame * end_flame; // r2
        float spread; // r1
        class zFlame * * n; // r5
        class zFlame * * endn; // r2
