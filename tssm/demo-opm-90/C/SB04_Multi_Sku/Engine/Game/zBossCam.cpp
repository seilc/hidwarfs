/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zBossCam.cpp
...
// total size: 0x24
struct /* @anon0 */ {} zBossCam_Binary::__vtable; // size: 0x24, address: 0x635F00
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471D70 -> 0x00471F38
*/
// Range: 0x471D70 -> 0x471F38
// this: r18
void zBossCam_Binary::move_to_rest() {
    /* anonymous block */ {
        // Range: 0x471D70 -> 0x471F38
        class xVec3 toTarget; // r29+0x80
        class xVec3 look_loc; // r29+0x70
        class xMat3x3 look_mat; // r29+0x40
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471F40 -> 0x0047291C
*/
// Range: 0x471F40 -> 0x47291C
// this: r20
void zBossCam_Binary::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x471F40 -> 0x47291C
        class xVec3 & A; // r2
        class xVec3 & B; // r19
        class xVec3 & C; // r2
        class xVec3 CA; // r29+0xE8
        float dCA; // r21
        float yaw_end; // r24
        float dyaw1; // r22
        float dyaw2; // r21
        float fov; // r29+0x100
        float max_dyaw; // r29+0x100
        float sstick; // r21
        class analog_data & stick; // r2
        float yaw_diff; // r29+0xFC
        float max_yaw_diff; // r29+0xF8
        float d; // r23
        float h; // r22
        float hf; // r21
        float s; // r29+0x100
        float s; // r29+0x100
        class xVec3 end_loc; // r29+0xD8
        float sloc; // r29+0x100
        class xVec3 heading; // r29+0xC8
        class xQuat end_dir; // r29+0xB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00472920 -> 0x00472928
*/
// Range: 0x472920 -> 0x472928
// this: r2
void zBossCam_Binary::attach(class zPlayer * new_owner /* r2 */) {
    /* anonymous block */ {
        // Range: 0x472920 -> 0x472928
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00472930 -> 0x004729A4
*/
// Range: 0x472930 -> 0x4729A4
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004729B0 -> 0x004729F8
*/
// Range: 0x4729B0 -> 0x4729F8
// this: r16
