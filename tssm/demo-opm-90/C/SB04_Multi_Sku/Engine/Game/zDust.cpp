/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zDust.cpp
...
static class ring_chain_data chain[2]; // size: 0x38, address: 0x62DC90
static signed int texture_rows; // size: 0x4, address: 0x636F78
static signed int texture_columns; // size: 0x4, address: 0x636F7C
static signed int dirt_system_id; // size: 0x4, address: 0x638350
static float ring_vel_decay; // size: 0x4, address: 0x638354
static class xVec2 * dirt_uvs; // size: 0x4, address: 0x638358
static unsigned char refreshed_ring_chains; // size: 0x1, address: 0x63835C
static float ring_chain_ang[2]; // size: 0x8, address: 0x638360
static class xVec2 ring_chain[2][8]; // size: 0x80, address: 0x7ADF40
signed int activities_used; // size: 0x4, address: 0x638368
class activity_data * activities; // size: 0x4, address: 0x63836C
...
signed int update_dust_particles_uv2(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x473730
signed int update_dust_particles(unsigned char *, signed int, class ptank_pool &, float, void *); // size: 0x0, address: 0x473CE0
// total size: 0x0
class xSurface {};
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00472A00 -> 0x00473070
*/
// Range: 0x472A00 -> 0x473070
// this: r29+0x108
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473070 -> 0x004730FC
*/
// Range: 0x473070 -> 0x4730FC
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473100 -> 0x00473244
*/
// Range: 0x473100 -> 0x473244
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473250 -> 0x00473348
*/
// Range: 0x473250 -> 0x473348
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473350 -> 0x00473358
*/
// Range: 0x473350 -> 0x473358
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473360 -> 0x00473368
*/
// Range: 0x473360 -> 0x473368
void zDustRender() {
    /* anonymous block */ {
        // Range: 0x473360 -> 0x473368
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473370 -> 0x00473398
*/
// Range: 0x473370 -> 0x473398
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004733A0 -> 0x00473454
*/
// Range: 0x4733A0 -> 0x473454
void zDustReset() {
    /* anonymous block */ {
        // Range: 0x4733A0 -> 0x473454
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473460 -> 0x00473534
*/
// Range: 0x473460 -> 0x473534
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473540 -> 0x0047372C
*/
// Range: 0x473540 -> 0x47372C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473730 -> 0x00473CDC
*/
// Range: 0x473730 -> 0x473CDC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00473CE0 -> 0x00474234
*/
// Range: 0x473CE0 -> 0x474234
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474240 -> 0x00474308
*/
// Range: 0x474240 -> 0x474308
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00474310 -> 0x004743A0
*/
// Range: 0x474310 -> 0x4743A0
