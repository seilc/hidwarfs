/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zParticleLocator.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static class activity_data * activities; // size: 0x4, address: 0x6384F0
static signed int activities_used; // size: 0x4, address: 0x6384F4
unsigned int gActiveHeap; // size: 0x4, address: 0x638090
void get_offset_model_vert_expand(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49CDB0
void get_offset_model_vert(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49CDC0
void get_offset_line(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D690
void get_offset_capsule(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D3D0
void get_offset_capsule_edge(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D1C0
void get_offset_cylinder(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D070
void get_offset_cylinder_edge(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49CF60
void get_offset_circle(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D830
void get_offset_circle_edge(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D790
void get_offset_sphere(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49DA80
void get_offset_sphere_edge(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49D960
void get_offset_point(class xVec3 &, class volume_data &); // size: 0x0, address: 0x49DC20
void update_attach_entity_bone(class activity_data &, float); // size: 0x0, address: 0x49DDC0
void update_attach_entity(class activity_data &, float); // size: 0x0, address: 0x49DE10
// total size: 0xC
class RwV3d {
    // Members
public:
...
class volume_data {
    // Members
public:
    enum volume_type_enum type; // offset 0x0, size 0x4
    ...
    union { // inferred
        ...
        } line; // offset 0x8, size 0x8
        // total size: 0x48
        class /* @class */ {
            // Members
        public:
            signed int vertices[8]; // offset 0x0, size 0x20
            class xModelInstance * models[8]; // offset 0x20, size 0x20
            signed int models_size; // offset 0x40, size 0x4
            signed int total_vertices; // offset 0x44, size 0x4
        } model_vert; // offset 0x8, size 0x48
        // total size: 0x1
        class /* @class */ {} model_surface; // offset 0x8, size 0x1
    };
};
// total size: 0x2C
class xEntShadow {
...
public:
    ...
    class zParticleAsset * asset; // offset 0x4, size 0x4
    void (* update_attach)(class activity_data &, float); // offset 0x8, size 0x4
    void (* get_offset)(class xVec3 &, class volume_data &); // offset 0xC, size 0x4
    class attach_data attach; // offset 0x10, size 0x50
    class volume_data volume; // offset 0x60, size 0x50
    class xEnt * attach_to; // offset 0xB0, size 0x4
    class xMat4x3 buffer_mat; // offset 0xC0, size 0x40
    class xMat4x3 * attach_mat; // offset 0x100, size 0x4
};
// total size: 0x8
...
enum volume_type_enum {
    VOLUME_POINT = 0,
    VOLUME_SPHERE = 1,
    VOLUME_SPHERE_EDGE = 2,
    VOLUME_CIRCLE = 3,
    VOLUME_CIRCLE_EDGE = 4,
    VOLUME_LINE = 5,
    VOLUME_CAPSULE = 6,
    VOLUME_CAPSULE_EDGE = 7,
    VOLUME_CYLINDER = 8,
    VOLUME_CYLINDER_EDGE = 9,
    VOLUME_MODEL_VERT = 10,
    VOLUME_MODEL_SURFACE = 11,
    MAX_VOLUME = 12,
};
// total size: 0x50
class attach_data {
...
public:
    ...
    public:
        ...
        signed int bone; // offset 0x40, size 0x4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C750 -> 0x0049C840
*/
// Range: 0x49C750 -> 0x49C840
// this: r2
void zParticleLocator::get_center(class xVec3 & center /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49C750 -> 0x49C840
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C840 -> 0x0049C84C
*/
// Range: 0x49C840 -> 0x49C84C
// this: r2
class xMat4x3 & zParticleLocator::get_frame() {
    /* anonymous block */ {
        // Range: 0x49C840 -> 0x49C84C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C850 -> 0x0049C93C
*/
// Range: 0x49C850 -> 0x49C93C
// this: r2
void zParticleLocator::make_locations(void * data /* r2 */, signed int stride /* r22 */, signed int elements /* r2 */, signed int loc_offset /* r21 */) {
    /* anonymous block */ {
        // Range: 0x49C850 -> 0x49C93C
        class xMat4x3 & amat; // r2
        void (* get_offset)(class xVec3 &, class volume_data &); // r2
        class volume_data & volume; // r20
        unsigned char * p; // r19
        unsigned char * endp; // r2
        class xVec3 & loc; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C940 -> 0x0049C96C
*/
// Range: 0x49C940 -> 0x49C96C
// this: r2
void zParticleLocator::update(float dt /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x49C940 -> 0x49C96C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049C970 -> 0x0049CA6C
*/
// Range: 0x49C970 -> 0x49CA6C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CA70 -> 0x0049CC44
*/
// Range: 0x49CA70 -> 0x49CC44
// this: r17
unsigned char zParticleLocator::activate(class zParticleAsset & asset /* r16 */, class xEnt * attach_to /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49CA70 -> 0x49CC44
        unsigned char (* setup_volume_table[5])(class activity_data &, class zParticleAsset &); // @ 0x0062EA70
        unsigned char (* setup_attach_table[3])(class activity_data &, class zParticleAsset &); // @ 0x0062EA60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CC50 -> 0x0049CC58
*/
// Range: 0x49CC50 -> 0x49CC58
void restart() {
    /* anonymous block */ {
        // Range: 0x49CC50 -> 0x49CC58
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CC60 -> 0x0049CC68
*/
// Range: 0x49CC60 -> 0x49CC68
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CC70 -> 0x0049CCB4
*/
// Range: 0x49CC70 -> 0x49CCB4
void scene_enter() {
    /* anonymous block */ {
        // Range: 0x49CC70 -> 0x49CCB4
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CCC0 -> 0x0049CDA4
*/
// Range: 0x49CCC0 -> 0x49CDA4
static unsigned char setup_volume_model(class activity_data & activity /* r2 */, class zParticleAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49CCC0 -> 0x49CDA4
        class xEnt * attach_to; // r2
        class volume_model_data & model; // r2
        signed int model_index; // r10
        signed int models_size; // r9
        signed int total_vertices; // r8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CDB0 -> 0x0049CDB8
*/
// Range: 0x49CDB0 -> 0x49CDB8
static void get_offset_model_vert_expand() {
    /* anonymous block */ {
        // Range: 0x49CDB0 -> 0x49CDB8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CDC0 -> 0x0049CE40
*/
// Range: 0x49CDC0 -> 0x49CE40
static void get_offset_model_vert(class xVec3 & offset /* r16 */, class volume_data & data /* r17 */) {
    /* anonymous block */ {
        // Range: 0x49CDC0 -> 0x49CE40
        signed int vert_index; // r2
        class xModelInstance * * models; // r6
        signed int * vertices; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CE40 -> 0x0049CF5C
*/
// Range: 0x49CE40 -> 0x49CF5C
static unsigned char setup_volume_line(class activity_data & activity /* r2 */, class zParticleAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49CE40 -> 0x49CF5C
        class volume_line_data & line; // r2
        signed int edge_only; // r2
        class volume_data & ovolume; // r2
        float r; // r1
        float d; // r2
        float rr; // r29
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049CF60 -> 0x0049D064
*/
// Range: 0x49CF60 -> 0x49D064
static void get_offset_cylinder_edge(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49CF60 -> 0x49D064
        float ang; // r20
        float d; // r22
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D070 -> 0x0049D1BC
*/
// Range: 0x49D070 -> 0x49D1BC
static void get_offset_cylinder(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D070 -> 0x49D1BC
        float ang; // r21
        float d; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D1C0 -> 0x0049D3C8
*/
// Range: 0x49D1C0 -> 0x49D3C8
static void get_offset_capsule_edge(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D1C0 -> 0x49D3C8
        float ang; // r21
        float uz; // r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D3D0 -> 0x0049D684
*/
// Range: 0x49D3D0 -> 0x49D684
static void get_offset_capsule(class xVec3 & offset /* r18 */, class volume_data & data /* r17 */) {
    /* anonymous block */ {
        // Range: 0x49D3D0 -> 0x49D684
        float ang; // r22
        float uz; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D690 -> 0x0049D70C
*/
// Range: 0x49D690 -> 0x49D70C
static void get_offset_line(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D690 -> 0x49D70C
        float d; // r29+0x30
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D710 -> 0x0049D790
*/
// Range: 0x49D710 -> 0x49D790
static unsigned char setup_volume_circle(class activity_data & activity /* r2 */, class zParticleAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49D710 -> 0x49D790
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D790 -> 0x0049D830
*/
// Range: 0x49D790 -> 0x49D830
static void get_offset_circle_edge(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D790 -> 0x49D830
        float ang; // r20
        float rr; // r29+0x40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D830 -> 0x0049D918
*/
// Range: 0x49D830 -> 0x49D918
static void get_offset_circle(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D830 -> 0x49D918
        float ang; // r20
        float rr; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D920 -> 0x0049D954
*/
// Range: 0x49D920 -> 0x49D954
static unsigned char setup_volume_sphere(class activity_data & activity /* r2 */, class zParticleAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49D920 -> 0x49D954
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049D960 -> 0x0049DA80
*/
// Range: 0x49D960 -> 0x49DA80
static void get_offset_sphere_edge(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49D960 -> 0x49DA80
        float ang; // r20
        float uz; // r23
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DA80 -> 0x0049DC00
*/
// Range: 0x49DA80 -> 0x49DC00
static void get_offset_sphere(class xVec3 & offset /* r17 */, class volume_data & data /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49DA80 -> 0x49DC00
        float ang; // r22
        float uz; // r21
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DC00 -> 0x0049DC14
*/
// Range: 0x49DC00 -> 0x49DC14
static unsigned char setup_volume_point(class activity_data & activity /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49DC00 -> 0x49DC14
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DC20 -> 0x0049DC30
*/
// Range: 0x49DC20 -> 0x49DC30
static void get_offset_point(class xVec3 & offset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x49DC20 -> 0x49DC30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DC30 -> 0x0049DC38
*/
// Range: 0x49DC30 -> 0x49DC38
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DC40 -> 0x0049DDB8
*/
// Range: 0x49DC40 -> 0x49DDB8
static unsigned char setup_attach_entity(class activity_data & activity /* r17 */, class zParticleAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49DC40 -> 0x49DDB8
        class xEnt * attach_to; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DDC0 -> 0x0049DE04
*/
// Range: 0x49DDC0 -> 0x49DE04
static void update_attach_entity_bone(class activity_data & activity /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49DDC0 -> 0x49DE04
        class xMat4x3 bone_mat; // r29+0x20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DE10 -> 0x0049DE28
*/
// Range: 0x49DE10 -> 0x49DE28
static void update_attach_entity(class activity_data & activity /* r4 */) {
    /* anonymous block */ {
        // Range: 0x49DE10 -> 0x49DE28
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0049DE30 -> 0x0049DE9C
*/
// Range: 0x49DE30 -> 0x49DE9C
static unsigned char setup_attach_fixed(class activity_data & activity /* r17 */, class zParticleAsset & asset /* r16 */) {
    /* anonymous block */ {
        // Range: 0x49DE30 -> 0x49DE9C
    }
}
