/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zParticleGenerator.cpp
...
static signed int max_system_asset_size; // size: 0x4, address: 0x638494
static class zParticleSystem * * systems; // size: 0x4, address: 0x638498
static class zParticleSystem * * system_handler_set[7]; // size: 0x1C, address: 0x7B8730
static signed int system_handler_set_size[7]; // size: 0x1C, address: 0x7B8750
static class zParticleGenerator * * generators; // size: 0x4, address: 0x63849C
static signed int max_generators; // size: 0x4, address: 0x6384A0
static signed int generators_used; // size: 0x4, address: 0x6384A4
// total size: 0x14
struct /* @anon0 */ {} zParticleGenerator::__vtable; // size: 0x14, address: 0x0
void event_handler(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x498880
unsigned int gActiveHeap; // size: 0x4, address: 0x638090
signed int compare_generator_systems_function(void *, void *); // size: 0x0, address: 0x499030
// total size: 0x4C
class xAnimState {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498690 -> 0x004987D4
*/
// Range: 0x498690 -> 0x4987D4
void perturb_dir(class xVec3 & dir /* r16 */, float angle /* r29+0x70 */) {
    /* anonymous block */ {
        // Range: 0x498690 -> 0x4987D4
        float rand_scale; // r21
        float ang_min; // r20
        class xVec3 ang; // r29+0x60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004987E0 -> 0x00498874
*/
// Range: 0x4987E0 -> 0x498874
class xEnt * get_attach_entity(class zParticleAsset & asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x4987E0 -> 0x498874
        unsigned int id; // r2
        class xEnt * ent; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498880 -> 0x004988F8
*/
// Range: 0x498880 -> 0x4988F8
void event_handler(class xBase * to /* r2 */, unsigned int event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x498880 -> 0x4988F8
        class zParticleGenerator & gen; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498900 -> 0x00498914
*/
// Range: 0x498900 -> 0x498914
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498920 -> 0x00498930
*/
// Range: 0x498920 -> 0x498930
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498930 -> 0x0049896C
*/
// Range: 0x498930 -> 0x49896C
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498970 -> 0x004989FC
*/
// Range: 0x498970 -> 0x4989FC
// this: r16
void zParticleGenerator::create(class zParticleSystem & system /* r18 */, class zParticleAsset & asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x498970 -> 0x4989FC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498A00 -> 0x00498A64
*/
// Range: 0x498A00 -> 0x498A64
void zParticleRender() {
    /* anonymous block */ {
        // Range: 0x498A00 -> 0x498A64
        class zParticleSystem * * set; // r17
        class zParticleSystem * * end_set; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498A70 -> 0x00498AD4
*/
// Range: 0x498A70 -> 0x498AD4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498AE0 -> 0x00498B50
*/
// Range: 0x498AE0 -> 0x498B50
void zParticleUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x498AE0 -> 0x498B50
        class zParticleSystem * * set; // r17
        class zParticleSystem * * end_set; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498B50 -> 0x00498BB4
*/
// Range: 0x498B50 -> 0x498BB4
void zParticleReset() {
    /* anonymous block */ {
        // Range: 0x498B50 -> 0x498BB4
        class zParticleSystem * * set; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498BC0 -> 0x00498C24
*/
// Range: 0x498BC0 -> 0x498C24
void zParticleSetup() {
    /* anonymous block */ {
        // Range: 0x498BC0 -> 0x498C24
        class zParticleSystem * * set; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498C30 -> 0x00498CE4
*/
// Range: 0x498C30 -> 0x498CE4
void zParticleSceneExit() {
    /* anonymous block */ {
        // Range: 0x498C30 -> 0x498CE4
        class zParticleGenerator * * gen; // r17
        class zParticleGenerator * * end_gen; // r2
        class zParticleSystem * * set; // r17
        class zParticleSystem * * end_set; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498CF0 -> 0x00498DDC
*/
// Range: 0x498CF0 -> 0x498DDC
void zParticleSceneEnter() {
    /* anonymous block */ {
        // Range: 0x498CF0 -> 0x498DDC
        class zParticleSystem * * sys; // r17
        class zParticleSystem * * end_sys; // r2
        signed int size; // r2
        class zParticleSystem * * set; // r17
        class zParticleSystem * * end_set; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498DE0 -> 0x00498F44
*/
// Range: 0x498DE0 -> 0x498F44
static void create_generators() {
    /* anonymous block */ {
        ...
        signed int i; // r18
        unsigned int asset_size; // r29+0x5C
        class zParticleAsset * asset; // r2
        class zParticleGenerator * * gen; // r19
        signed int i; // r18
        class zParticleAsset * asset; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00498F50 -> 0x00499024
*/
// Range: 0x498F50 -> 0x499024
static void sort_generators() {
    /* anonymous block */ {
        // Range: 0x498F50 -> 0x499024
        class zParticleSystem * * sys; // r10
        class zParticleSystem * * end_sys; // r2
        class zParticleGenerator * * first_gen; // r9
        class zParticleGenerator * * last_gen; // r2
        signed int system_type; // r2
        class zParticleGenerator * * found_gen; // r8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499030 -> 0x00499064
*/
// Range: 0x499030 -> 0x499064
static signed int compare_generator_systems_function(void * e1 /* r2 */, void * e2 /* r2 */) {
    /* anonymous block */ {
        // Range: 0x499030 -> 0x499064
        class zParticleGenerator * g1; // r2
        class zParticleGenerator * g2; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00499070 -> 0x00499184
*/
// Range: 0x499070 -> 0x499184
static void create_handler_sets() {
    /* anonymous block */ {
        // Range: 0x499070 -> 0x499184
        signed int total_size; // r12
        signed int handler; // r11
        signed int size; // r10
        class zParticleSystem * * sys; // r9
        class zParticleSystem * * end_sys; // r2
        class zParticleSystem * * set; // r11
        signed int handler; // r10
        class zParticleSystem * * sys; // r9
        class zParticleSystem * * end_sys; // r2
    }
}
