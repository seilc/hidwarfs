/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Game\zWadHud.cpp
...
float thresh; // size: 0x4, address: 0x0
class Combo combos[16]; // size: 0x440, address: 0x685D20
unsigned int comboIndex; // size: 0x4, address: 0x637C88
unsigned int lastComboIndex; // size: 0x4, address: 0x637C8C
float Time[16]; // size: 0x40, address: 0x686160
unsigned int Combo15Count; // size: 0x4, address: 0x637C90
char * includedTextBoxNames[7]; // size: 0x1C, address: 0x600B90
class ztextbox * includedTextBoxes[7]; // size: 0x1C, address: 0x6861A0
// total size: 0x34
struct /* @anon4 */ {} zHud::NitroMeter::__vtable; // size: 0x34, address: 0x635A50
enum eSNDCurrentPlayer gCurrentPlayer; // size: 0x4, address: 0x6379FC
// total size: 0x34
struct /* @anon8 */ {} zHud::ModelAndFontHideOnTextBox::__vtable; // size: 0x34, address: 0x0
// total size: 0x34
struct /* @anon0 */ {} zHud::ModelAndFont::__vtable; // size: 0x34, address: 0x635B40
// total size: 0x24
struct /* @anon5 */ {} zHud::hud_element::__vtable; // size: 0x24, address: 0x0
class zGlobals globals; // size: 0x2410, address: 0x7AB790
// total size: 0x34
struct /* @anon3 */ {} zHud::GoofyGooberMeter::__vtable; // size: 0x34, address: 0x635AC0
// total size: 0x34
struct /* @anon1 */ {} zHud::TreasureChest::__vtable; // size: 0x34, address: 0x635B00
...
void ClearText(class widget &, class motive &); // size: 0x0, address: 0x37B670
...
unsigned char shake_motive_update(class widget &, class motive &, float); // size: 0x0, address: 0x3CF140
void HideAndClearText(class widget &, class motive &); // size: 0x0, address: 0x37B3B0
unsigned char Combo15Effect(class widget &, class motive &, float); // size: 0x0, address: 0x379A80
unsigned char Combo14Effect(class widget &, class motive &, float); // size: 0x0, address: 0x379CD0
unsigned char Combo13Effect(class widget &, class motive &, float); // size: 0x0, address: 0x379D50
unsigned char Combo12Effect(class widget &, class motive &, float); // size: 0x0, address: 0x379F00
unsigned char Combo11Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37A1D0
unsigned char Combo10Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37A460
unsigned char Combo9Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37A5C0
unsigned char Combo8Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37A7D0
unsigned char Combo7Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37AA20
unsigned char Combo6Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37AD10
unsigned char Combo5Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37AF60
unsigned char Combo4Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37B160
unsigned char Combo3Effect(class widget &, class motive &, float); // size: 0x0, address: 0x37B330
// total size: 0x28
struct /* @anon7 */ {} zHud::ManlinessMeter::__vtable; // size: 0x28, address: 0x635B80
// total size: 0x28
struct /* @anon2 */ {} zHud::BarMeter<unsigned int>::__vtable; // size: 0x28, address: 0x635A90
// total size: 0x28
struct /* @anon6 */ {} zHud::KrabbyPattyMeter::__vtable; // size: 0x28, address: 0x635BB0
enum eGameMode gGameMode; // size: 0x4, address: 0x6375B0
class _tagTRCPadInfo gTrcPad[4]; // size: 0x30, address: 0x7AB120
void EventHandlerFunc(class xBase *, class xBase *, unsigned int, float *, class xBase *, unsigned int); // size: 0x0, address: 0x37D7B0
// total size: 0x88
class widget {
    // Members
public:
...
class Combo {
    // Members
public:
    char comboText[64]; // offset 0x0, size 0x40
    unsigned char (* callback)(class widget &, class motive &, float); // offset 0x40, size 0x4
};
// total size: 0x18
...
public:
    ...
    unsigned char last_paused; // offset 0x4, size 0x1
};
// total size: 0x0
