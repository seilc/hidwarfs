/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\x\xFXCameraTexture.cpp
...
static signed long old_skyZbuf_1; // size: 0x4, address: 0x638348
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046EB70 -> 0x0046F0E8
*/
// Range: 0x46EB70 -> 0x46F0E8
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F0F0 -> 0x0046F248
*/
// Range: 0x46F0F0 -> 0x46F248
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F250 -> 0x0046F9B0
*/
// Range: 0x46F250 -> 0x46F9B0
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046F9B0 -> 0x0046FD0C
*/
// Range: 0x46F9B0 -> 0x46FD0C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046FD10 -> 0x0046FFD0
*/
// Range: 0x46FD10 -> 0x46FFD0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046FFD0 -> 0x0046FFEC
*/
// Range: 0x46FFD0 -> 0x46FFEC
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046FFF0 -> 0x0047020C
*/
// Range: 0x46FFF0 -> 0x47020C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470210 -> 0x004702CC
*/
// Range: 0x470210 -> 0x4702CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004702D0 -> 0x00470384
*/
// Range: 0x4702D0 -> 0x470384
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470390 -> 0x00470414
*/
// Range: 0x470390 -> 0x470414
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470420 -> 0x004704C0
*/
// Range: 0x470420 -> 0x4704C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004704C0 -> 0x00470548
*/
// Range: 0x4704C0 -> 0x470548
void set_blend_mode(enum blend_mode mode /* r2 */, float fixed_alpha /* r29 */) {
    /* anonymous block */ {
        // Range: 0x4704C0 -> 0x470548
        signed int func[12]; // @ 0x0062DC60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470550 -> 0x004705B8
*/
// Range: 0x470550 -> 0x4705B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004705C0 -> 0x004705E4
*/
// Range: 0x4705C0 -> 0x4705E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004705F0 -> 0x004705FC
*/
// Range: 0x4705F0 -> 0x4705FC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470600 -> 0x00470658
*/
// Range: 0x470600 -> 0x470658
void texflush() {
    /* anonymous block */ {
        // Range: 0x470600 -> 0x470658
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470660 -> 0x004706CC
*/
// Range: 0x470660 -> 0x4706CC
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004706D0 -> 0x004707F8
*/
// Range: 0x4706D0 -> 0x4707F8
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470800 -> 0x00470984
*/
// Range: 0x470800 -> 0x470984
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470990 -> 0x00470B14
*/
// Range: 0x470990 -> 0x470B14
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470B20 -> 0x00470BB4
*/
// Range: 0x470B20 -> 0x470BB4
// this: r4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470BC0 -> 0x00470CFC
*/
// Range: 0x470BC0 -> 0x470CFC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470D00 -> 0x00470EBC
*/
// Range: 0x470D00 -> 0x470EBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470EC0 -> 0x00470F2C
*/
// Range: 0x470EC0 -> 0x470F2C
void zbuffer_unmap() {
    /* anonymous block */ {
        // Range: 0x470EC0 -> 0x470F2C
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00470F30 -> 0x00471290
*/
// Range: 0x470F30 -> 0x471290
// this: r20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471290 -> 0x00471440
*/
// Range: 0x471290 -> 0x471440
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471440 -> 0x00471500
*/
// Range: 0x471440 -> 0x471500
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471500 -> 0x004715D0
*/
// Range: 0x471500 -> 0x4715D0
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004715D0 -> 0x00471970
*/
// Range: 0x4715D0 -> 0x471970
// this: r19
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471970 -> 0x00471A44
*/
// Range: 0x471970 -> 0x471A44
// this: r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00471A50 -> 0x00471D68
*/
// Range: 0x471A50 -> 0x471D68
// this: r20
