/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\x\xFXHighDynamicRange.cpp
...
static float overbrighten; // size: 0x4, address: 0x636F48
static float overbrighten_decay; // size: 0x4, address: 0x636F4C
static signed int downsamples; // size: 0x4, address: 0x636F50
static unsigned char blur_faster; // size: 0x1, address: 0x636F54
static float colorize_red; // size: 0x4, address: 0x636F58
static float colorize_green; // size: 0x4, address: 0x636F5C
static float colorize_blue; // size: 0x4, address: 0x636F60
static float colorize_alpha; // size: 0x4, address: 0x636F64
static unsigned char enabled; // size: 0x1, address: 0x636F68
static signed int background_glow_normal; // size: 0x4, address: 0x638334
static signed int background_darken_normal; // size: 0x4, address: 0x638338
static class interpolator background_glow; // size: 0x18, address: 0x7ADC20
static class interpolator background_darken; // size: 0x18, address: 0x7ADC40
static signed int saved_alpha_test; // size: 0x4, address: 0x63833C
static __int128 * blur_packet[5]; // size: 0x14, address: 0x0
static class xVec2 diagonal_00_11_offsets[2]; // size: 0x10, address: 0x62DBC0
static class xVec2 diagonal_01_10_offsets[2]; // size: 0x10, address: 0x62DBD0
static class xVec2 square_offsets[4]; // size: 0x20, address: 0x62DBE0
static class downsample_pass_info downsample_passes_fast[5]; // size: 0x28, address: 0x62DC00
static class downsample_pass_info downsample_passes_slow[5]; // size: 0x28, address: 0x62DC30
static class xFXCameraTexture blurbuffer[5]; // size: 0x168, address: 0x7ADC60
static class RwRaster * backbuffer_raster; // size: 0x4, address: 0x0
static class xFXCameraTexture downbuffer[5]; // size: 0x168, address: 0x7ADDD0
static signed int old_alpha_test; // size: 0x4, address: 0x636F6C
static signed int our_alpha_test; // size: 0x4, address: 0x638340
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046D840 -> 0x0046D944
*/
// Range: 0x46D840 -> 0x46D944
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046D950 -> 0x0046D980
*/
// Range: 0x46D950 -> 0x46D980
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046D980 -> 0x0046DA14
*/
// Range: 0x46D980 -> 0x46DA14
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DA20 -> 0x0046DA5C
*/
// Range: 0x46DA20 -> 0x46DA5C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DA60 -> 0x0046DA9C
*/
// Range: 0x46DA60 -> 0x46DA9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DAA0 -> 0x0046DAAC
*/
// Range: 0x46DAA0 -> 0x46DAAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DAB0 -> 0x0046DC54
*/
// Range: 0x46DAB0 -> 0x46DC54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DC60 -> 0x0046DE9C
*/
// Range: 0x46DC60 -> 0x46DE9C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DEA0 -> 0x0046DEC0
*/
// Range: 0x46DEA0 -> 0x46DEC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DEC0 -> 0x0046DF54
*/
// Range: 0x46DEC0 -> 0x46DF54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046DF60 -> 0x0046E70C
*/
// Range: 0x46DF60 -> 0x46E70C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E710 -> 0x0046E87C
*/
// Range: 0x46E710 -> 0x46E87C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E880 -> 0x0046E908
*/
// Range: 0x46E880 -> 0x46E908
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E910 -> 0x0046E918
*/
// Range: 0x46E910 -> 0x46E918
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E920 -> 0x0046E928
*/
// Range: 0x46E920 -> 0x46E928
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0046E930 -> 0x0046EB70
*/
// Range: 0x46E930 -> 0x46EB70
