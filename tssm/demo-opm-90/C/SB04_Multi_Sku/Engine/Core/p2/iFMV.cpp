/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\iFMV.cpp
...
static class xMemoryManagerGeneral binkAllocator; // size: 0x34, address: 0x7C5EB0
static void * iop_addr; // size: 0x4, address: 0x638624
static signed int initReferenceCount; // size: 0x4, address: 0x638628
void BinkFileClose(class BINKIO *); // size: 0x0, address: 0x4C20E0
unsigned int BinkFileIdle(class BINKIO *); // size: 0x0, address: 0x4C2610
void BinkFileSetInfo(class BINKIO *, void *, unsigned int, unsigned int, unsigned int); // size: 0x0, address: 0x4C20F0
unsigned int BinkFileGetBufferSize(class BINKIO *, unsigned int); // size: 0x0, address: 0x4C21D0
unsigned int BinkFileReadFrame(class BINKIO *, unsigned int, signed int, void *, unsigned int); // size: 0x0, address: 0x4C21F0
unsigned int BinkFileReadHeader(class BINKIO *, signed int, void *, unsigned int); // size: 0x0, address: 0x4C2990
void DVDReadCallback(class tag_xFile *); // size: 0x0, address: 0x4C2800
...
signed int (* BinkOpenRAD_IOP(unsigned int))(class BINKSND *, unsigned int, signed int, signed int, unsigned int, class BINK *); // size: 0x0, address: 0x1F3A20
// total size: 0x1C
struct /* @anon1 */ {} xMemoryManagerGeneral::__vtable; // size: 0x1C, address: 0x635E00
// total size: 0x1C
struct /* @anon0 */ {} xMemoryManager::__vtable; // size: 0x1C, address: 0x0
signed int BinkFileOpen(class BINKIO *, char *, unsigned int); // size: 0x0, address: 0x4C1F70
void _MovieFree(void *); // size: 0x0, address: 0x4C3F50
void * _MovieAlloc(unsigned int); // size: 0x0, address: 0x4C3F60
// total size: 0x2C
...
public:
    ...
    signed long long fog_t0; // offset 0x7A8, size 0x8
    signed long long fog_t1; // offset 0x7B0, size 0x8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C1D90 -> 0x004C1F68
*/
// Range: 0x4C1D90 -> 0x4C1F68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C1F70 -> 0x004C20E0
*/
// Range: 0x4C1F70 -> 0x4C20E0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C20E0 -> 0x004C20E8
*/
// Range: 0x4C20E0 -> 0x4C20E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C20F0 -> 0x004C21CC
*/
// Range: 0x4C20F0 -> 0x4C21CC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C21D0 -> 0x004C21E4
*/
// Range: 0x4C21D0 -> 0x4C21E4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C21F0 -> 0x004C2604
*/
// Range: 0x4C21F0 -> 0x4C2604
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C2610 -> 0x004C2680
*/
// Range: 0x4C2610 -> 0x4C2680
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C2680 -> 0x004C27FC
*/
// Range: 0x4C2680 -> 0x4C27FC
static void ReadKickoff(class BINKIO * bio /* r19 */) {
    /* anonymous block */ {
        // Range: 0x4C2680 -> 0x4C27FC
        unsigned int left; // r18
        signed int readOffset; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C2800 -> 0x004C298C
*/
// Range: 0x4C2800 -> 0x4C298C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C2990 -> 0x004C2B4C
*/
// Range: 0x4C2990 -> 0x4C2B4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C2B50 -> 0x004C3658
*/
// Range: 0x4C2B50 -> 0x4C3658
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3660 -> 0x004C37C0
*/
// Range: 0x4C3660 -> 0x4C37C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C37C0 -> 0x004C38B0
*/
// Range: 0x4C37C0 -> 0x4C38B0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C38B0 -> 0x004C3BFC
*/
// Range: 0x4C38B0 -> 0x4C3BFC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3C00 -> 0x004C3E40
*/
// Range: 0x4C3C00 -> 0x4C3E40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3E40 -> 0x004C3F3C
*/
// Range: 0x4C3E40 -> 0x4C3F3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3F40 -> 0x004C3F48
*/
// Range: 0x4C3F40 -> 0x4C3F48
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3F50 -> 0x004C3F60
*/
// Range: 0x4C3F50 -> 0x4C3F60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004C3F60 -> 0x004C3F74
*/
// Range: 0x4C3F60 -> 0x4C3F74
