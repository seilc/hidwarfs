/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\hifastskin\VCL_HIFastSkin_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HIFastSkin_VU1Transforms[2]; // size: 0x8, address: 0x636930
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HIFastSkin_VU1Code; // size: 0x8, address: 0x636938
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D17C0 -> 0x001D17EC
*/
// Range: 0x1D17C0 -> 0x1D17EC
signed int HIFastSkinMatBridgeCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D17C0 -> 0x1D17EC
        signed int oldTSClipperMode; // r2
        signed int retval; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D17F0 -> 0x001D1828
*/
// Range: 0x1D17F0 -> 0x1D1828
static signed int HIFastSkinInstanceCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r16 */, void * * clusterData /* r2 */, unsigned int numClusters /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D17F0 -> 0x1D1828
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1830 -> 0x001D1A80
*/
// Range: 0x1D1830 -> 0x1D1A80
static void HIFastSkinInterleaveNormalReprocessData(class RxPS2AllPipeData * ps2AllPipeData /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D1830 -> 0x1D1A80
        signed int i; // r21
        signed int j; // r5
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D1A80 -> 0x001D2A58
*/
// Range: 0x1D1A80 -> 0x1D2A58
static void FastSkinReprocessData(class RxPS2AllPipeData * ps2AllPipeData /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D1A80 -> 0x1D2A58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D2A60 -> 0x001D3E64
*/
// Range: 0x1D2A60 -> 0x1D3E64
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001D3E70 -> 0x001D3F80
*/
// Range: 0x1D3E70 -> 0x1D3F80
static void HIFastSkinGetBatchData(class BatchData * batch /* r2 */, signed int batchindex /* r2 */, class rwPS2AllResEntryHeader * hdr /* r2 */, class RpMesh * mesh /* r2 */, unsigned char * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1D3E70 -> 0x1D3F80
