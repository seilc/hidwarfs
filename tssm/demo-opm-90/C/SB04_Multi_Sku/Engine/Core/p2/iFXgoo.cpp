/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\iFXgoo.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static float sinRangePoint5[8]; // size: 0x20, address: 0x6059D0
static float xFXWarbleParam[8]; // size: 0x20, address: 0x7C5AC0
static class iFXgooParams gooParams; // size: 0x24, address: 0x6059F0
static unsigned long gs_alpha_2; // size: 0x4, address: 0x636FB8
static class RwTexture * g_txtrGoo; // size: 0x4, address: 0x638608
...
signed long FXgooPRS; // size: 0x4, address: 0x4F4F20
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B7610 -> 0x004B76D0
*/
// Range: 0x4B7610 -> 0x4B76D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B76D0 -> 0x004B78AC
*/
// Range: 0x4B76D0 -> 0x4B78AC
static class RxPipeline * iFXgooCreateMaterialPipe() {
    /* anonymous block */ {
        ...
        class RxPipelineNode * plNode; // r17
        void * VUCodeArray[32]; // @ 0x00605A20
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B78B0 -> 0x004B8278
*/
// Range: 0x4B78B0 -> 0x4B8278
signed int iFXgooBridgeCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r16 */) {
    /* anonymous block */ {
        // Range: 0x4B78B0 -> 0x4B8278
        signed int skyAlphaTex'479; // r2
        __int128 * _rwDMAPktPtr'478; // r3
        unsigned int skyUserSwitch1'477; // r4
        unsigned long tmp; // r8
        unsigned long tmp1; // r2
        __int128 ltmp; // r2
        unsigned long rastex1; // r29+0x68
        unsigned long rastex2; // r29+0x60
        unsigned long tex1_2; // r29+0x58
        class RpMaterial * material; // r17
        class RwRaster * customRaster; // r2
        signed int rc; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B8280 -> 0x004B8288
*/
// Range: 0x4B8280 -> 0x4B8288
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B8290 -> 0x004B82B8
*/
// Range: 0x4B8290 -> 0x4B82B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x004B82C0 -> 0x004B8318
*/
// Range: 0x4B82C0 -> 0x4B8318
