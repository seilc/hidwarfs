/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\iModelBucketPDS.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static class PipeTranslation sPipeTrans[8]; // size: 0xC0, address: 0x5F14C0
static class FastPipeTrans sFastPipeList[2]; // size: 0x10, address: 0x5F1580
// total size: 0x10
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC070 -> 0x001CC2A8
*/
// Range: 0x1CC070 -> 0x1CC2A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC2B0 -> 0x001CC4E0
*/
// Range: 0x1CC2B0 -> 0x1CC4E0
void iModelUseFastPipes(class RpAtomic * dataTemp /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1CC2B0 -> 0x1CC4E0
        signed int i; // r5
        class RpMaterialList * matList; // r20
        signed int i; // r19
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC4E0 -> 0x001CC58C
*/
// Range: 0x1CC4E0 -> 0x1CC58C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC590 -> 0x001CC61C
*/
// Range: 0x1CC590 -> 0x1CC61C
static class RxPipeline * SkinfxMatCB(class RpMaterial * mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CC590 -> 0x1CC61C
        enum RpMatFXMaterialFlags matfxFlags; // r2
        class RxPipeline * pgem; // @ 0x0063722C
        class RxPipeline * pnull; // @ 0x00637230
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC620 -> 0x001CC684
*/
// Range: 0x1CC620 -> 0x1CC684
static class RxPipeline * SkinfxAtmCB(class RpMaterial * mat /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1CC620 -> 0x1CC684
        enum RpMatFXMaterialFlags matfxFlags; // r2
        class RxPipeline * p; // @ 0x00637228
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC690 -> 0x001CC6C8
*/
// Range: 0x1CC690 -> 0x1CC6C8
static class RxPipeline * GenericMatCB() {
    /* anonymous block */ {
        // Range: 0x1CC690 -> 0x1CC6C8
        class RxPipeline * p; // @ 0x00637224
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC6D0 -> 0x001CC708
*/
// Range: 0x1CC6D0 -> 0x1CC708
static class RxPipeline * GenericAtmCB() {
    /* anonymous block */ {
        // Range: 0x1CC6D0 -> 0x1CC708
        class RxPipeline * p; // @ 0x00637220
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC710 -> 0x001CC748
*/
// Range: 0x1CC710 -> 0x1CC748
static class RxPipeline * SkinMatCB() {
    /* anonymous block */ {
        // Range: 0x1CC710 -> 0x1CC748
        class RxPipeline * p; // @ 0x0063721C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001CC750 -> 0x001CC788
*/
// Range: 0x1CC750 -> 0x1CC788
static class RxPipeline * SkinAtmCB() {
    /* anonymous block */ {
        // Range: 0x1CC750 -> 0x1CC788
        class RxPipeline * p; // @ 0x00637218
    }
}
