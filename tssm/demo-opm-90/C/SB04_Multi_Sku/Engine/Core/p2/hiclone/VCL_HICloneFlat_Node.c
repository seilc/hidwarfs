/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\hiclone\VCL_HICloneFlat_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HICloneFlat_VU1Transforms[2]; // size: 0x8, address: 0x636A38
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneFlat_VU1Code; // size: 0x8, address: 0x636A40
