/*
    Compile unit: C:\SB04_Multi_Sku\Engine\Core\p2\hiclone\VCL_HICloneSkin_Node.c
    Producer: MW MIPS C Compiler
    Language: C++
*/
void * rwPDS_VCL_HICloneSkin_VU1Transforms[2]; // size: 0x8, address: 0x636920
class RpPDSSkyVU1CodeTemplate rwPDS_VCL_HICloneSkin_VU1Code; // size: 0x8, address: 0x636928
