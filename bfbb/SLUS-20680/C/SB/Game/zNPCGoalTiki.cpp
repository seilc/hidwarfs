/*
    Compile unit: C:\SB\Game\zNPCGoalTiki.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalTikiDead::__vtable; // size: 0x34, address: 0x50A1C0
// total size: 0x34
struct /* @anon6 */ {} zNPCGoalTikiIdle::__vtable; // size: 0x34, address: 0x50A300
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalCommon::__vtable; // size: 0x34, address: 0x50A340
// total size: 0x2C
struct /* @anon3 */ {} xGoal::__vtable; // size: 0x2C, address: 0x50BE00
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalTikiDying::__vtable; // size: 0x34, address: 0x50A200
// total size: 0x34
struct /* @anon7 */ {} zNPCGoalTikiCount::__vtable; // size: 0x34, address: 0x50A240
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalTikiHide::__vtable; // size: 0x34, address: 0x50A280
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalTikiPatrol::__vtable; // size: 0x34, address: 0x50A2C0
// total size: 0x10
...
class zNPCGoalTikiDead : public zNPCGoalCommon {
    // Members
public:
    float tmr_resurrect; // offset 0x4C, size 0x4
};
// total size: 0x2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA4F0 -> 0x002CA534
*/
// Range: 0x2CA4F0 -> 0x2CA534
// this: r2
signed int zNPCGoalTikiDead::Exit() {
    /* anonymous block */ {
        // Range: 0x2CA4F0 -> 0x2CA534
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA540 -> 0x002CA5AC
*/
// Range: 0x2CA540 -> 0x2CA5AC
// this: r2
signed int zNPCGoalTikiDead::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA540 -> 0x2CA5AC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA5B0 -> 0x002CA5EC
*/
// Range: 0x2CA5B0 -> 0x2CA5EC
// this: r2
signed int zNPCGoalTikiDying::Exit() {
    /* anonymous block */ {
        // Range: 0x2CA5B0 -> 0x2CA5EC
        class zNPCTiki * tiki; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA5F0 -> 0x002CA624
*/
// Range: 0x2CA5F0 -> 0x2CA624
// this: r16
signed int zNPCGoalTikiDying::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA5F0 -> 0x2CA624
        class zNPCTiki * tiki; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA630 -> 0x002CA668
*/
// Range: 0x2CA630 -> 0x2CA668
// this: r16
signed int zNPCGoalTikiCount::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA630 -> 0x2CA668
        class zNPCTiki * tiki; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA670 -> 0x002CA69C
*/
// Range: 0x2CA670 -> 0x2CA69C
// this: r2
signed int zNPCGoalTikiHide::Exit() {
    /* anonymous block */ {
        // Range: 0x2CA670 -> 0x2CA69C
        class zNPCTiki * tiki; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA6A0 -> 0x002CA6C4
*/
// Range: 0x2CA6A0 -> 0x2CA6C4
// this: r2
signed int zNPCGoalTikiHide::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA6A0 -> 0x2CA6C4
        class zNPCTiki * tiki; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA6D0 -> 0x002CA78C
*/
// Range: 0x2CA6D0 -> 0x2CA78C
// this: r17
signed int zNPCGoalTikiPatrol::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA6D0 -> 0x2CA78C
        class zNPCTiki * tiki; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA790 -> 0x002CA804
*/
// Range: 0x2CA790 -> 0x2CA804
// this: r16
signed int zNPCGoalTikiIdle::Enter() {
    /* anonymous block */ {
        // Range: 0x2CA790 -> 0x2CA804
        class zNPCTiki * tiki; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x002CA810 -> 0x002CABB8
*/
// Range: 0x2CA810 -> 0x2CABB8
class xFactoryInst * GOALCreate_Tiki(signed int who /* r16 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CA810 -> 0x2CABB8
        class xGoal * goal; // r2
    }
