/*
    Compile unit: C:\SB\Game\zNPCGoalVillager.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalBoyWeep::__vtable; // size: 0x34, address: 0x50C6C0
...
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalBoySwim::__vtable; // size: 0x34, address: 0x50C700
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalCommon::__vtable; // size: 0x34, address: 0x50A340
// total size: 0x2C
struct /* @anon6 */ {} xGoal::__vtable; // size: 0x2C, address: 0x50BE00
// total size: 0x34
struct /* @anon9 */ {} zNPCGoalBoyFall::__vtable; // size: 0x34, address: 0x50C740
// total size: 0x34
struct /* @anon14 */ {} zNPCGoalBoyRide::__vtable; // size: 0x34, address: 0x50C780
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalBalloon::__vtable; // size: 0x34, address: 0x50C7C0
// total size: 0x34
struct /* @anon11 */ {} zNPCGoalHurt::__vtable; // size: 0x34, address: 0x50C800
// total size: 0x34
struct /* @anon10 */ {} zNPCGoalPushAnim::__vtable; // size: 0x34, address: 0x50A180
// total size: 0x34
struct /* @anon7 */ {} zNPCGoalCheer::__vtable; // size: 0x34, address: 0x50C880
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalLoopAnim::__vtable; // size: 0x34, address: 0x50A140
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalSpeak::__vtable; // size: 0x34, address: 0x50C8C0
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalChatter::__vtable; // size: 0x34, address: 0x50C840
// total size: 0x34
struct /* @anon12 */ {} zNPCGoalTalk::__vtable; // size: 0x34, address: 0x50C900
// total size: 0x34
struct /* @anon13 */ {} zNPCGoalPlayerNear::__vtable; // size: 0x34, address: 0x50C940
// total size: 0x10
class xBase {
    // Members
public:
...
class zNPCGoalPlayerNear : public zNPCGoalCommon {
    // Members
public:
    signed int flg_plyrnear; // offset 0x4C, size 0x4
    class NPCGlyph * talk_glyph; // offset 0x50, size 0x4
    class NPCWidget * talk_font; // offset 0x54, size 0x4
    float tmr_actBored; // offset 0x58, size 0x4
};
// total size: 0x6C
...
class zNPCGoalChatter : public zNPCGoalCommon {
    // Members
public:
    unsigned int sid_played; // offset 0x4C, size 0x4
    unsigned int playThisSound; // offset 0x50, size 0x4
};
// total size: 0x28
class xEntOrbitData {
    // Members
...
public:
    ...
    float tmr_robonear; // offset 0x2C4, size 0x4
...
class zNPCGoalBoyWeep : public zNPCGoalCommon {
    // Members
public:
    float tmr_weep; // offset 0x4C, size 0x4
...
class zNPCGoalBoyFall : public zNPCGoalCommon {
    // Members
public:
    signed int hitGround; // offset 0x4C, size 0x4
};
// total size: 0x6C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326200 -> 0x00326278
*/
// Range: 0x326200 -> 0x326278
// this: r2
signed int zNPCGoalBoyWeep::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326200 -> 0x326278
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326280 -> 0x003263D4
*/
// Range: 0x326280 -> 0x3263D4
// this: r2
signed int zNPCGoalBoyWeep::Process(enum en_trantype * trantype /* r2 */, float dt /* r29+0x10 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326280 -> 0x3263D4
        signed int nextgoal; // r2
        class zNPCBalloonBoy * npc; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003263E0 -> 0x0032645C
*/
// Range: 0x3263E0 -> 0x32645C
// this: r17
signed int zNPCGoalBoyWeep::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3263E0 -> 0x32645C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326460 -> 0x0032651C
*/
// Range: 0x326460 -> 0x32651C
// this: r16
signed int zNPCGoalBoyFall::CollReview() {
    /* anonymous block */ {
        // Range: 0x326460 -> 0x32651C
        signed int diditall; // r2
        class zNPCBalloonBoy * npc; // r4
        class xCollis * floor; // r17
        float gooDepth; // r29+0x3C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326520 -> 0x00326680
*/
// Range: 0x326520 -> 0x326680
// this: r21
signed int zNPCGoalBoyFall::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x326520 -> 0x326680
        signed int nextgoal; // r18
        class zNPCBalloonBoy * npc; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326680 -> 0x00326718
*/
// Range: 0x326680 -> 0x326718
// this: r2
signed int zNPCGoalBoyRide::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326680 -> 0x326718
        class zNPCBalloonBoy * npc; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326720 -> 0x00326810
*/
// Range: 0x326720 -> 0x326810
// this: r19
signed int zNPCGoalBoyRide::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x326720 -> 0x326810
        signed int nextgoal; // r2
        class zNPCBalloonBoy * npc; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326810 -> 0x003268A4
*/
// Range: 0x326810 -> 0x3268A4
// this: r2
signed int zNPCGoalBoyRide::Exit() {
    /* anonymous block */ {
        // Range: 0x326810 -> 0x3268A4
        class zNPCBalloonBoy * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003268B0 -> 0x003268C4
*/
// Range: 0x3268B0 -> 0x3268C4
// this: r2
signed int zNPCGoalBoyRide::Enter(float dt /* r29 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3268B0 -> 0x3268C4
        class zNPCBalloonBoy * npc; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003268D0 -> 0x00326928
*/
// Range: 0x3268D0 -> 0x326928
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326930 -> 0x003269AC
*/
// Range: 0x326930 -> 0x3269AC
// this: r2
signed int zNPCGoalBalloon::Process(enum en_trantype * trantype /* r2 */, float dt /* r29+0x10 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326930 -> 0x3269AC
        signed int nextgoal; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003269B0 -> 0x003269C4
*/
// Range: 0x3269B0 -> 0x3269C4
// this: r2
signed int zNPCGoalBalloon::Exit() {
    /* anonymous block */ {
        // Range: 0x3269B0 -> 0x3269C4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003269D0 -> 0x003269E4
*/
// Range: 0x3269D0 -> 0x3269E4
// this: r2
signed int zNPCGoalBalloon::Enter(float dt /* r29 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3269D0 -> 0x3269E4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003269F0 -> 0x00326A64
*/
// Range: 0x3269F0 -> 0x326A64
// this: r19
signed int zNPCGoalHurt::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3269F0 -> 0x326A64
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326A70 -> 0x00326B00
*/
// Range: 0x326A70 -> 0x326B00
// this: r17
signed int zNPCGoalHurt::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x326A70 -> 0x326B00
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326B00 -> 0x00326CF8
*/
// Range: 0x326B00 -> 0x326CF8
// this: r21
signed int zNPCGoalChatter::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r19 */, class xScene * xscn /* r18 */) {
    /* anonymous block */ {
        // Range: 0x326B00 -> 0x326CF8
        signed int nextgoal; // r17
        class zNPCVillager * npc; // r16
        class xVec3 dir_plyr; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326D00 -> 0x00326DB4
*/
// Range: 0x326D00 -> 0x326DB4
// this: r17
signed int zNPCGoalChatter::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x326D00 -> 0x326DB4
        class zNPCVillager * npc; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326DC0 -> 0x00326F2C
*/
// Range: 0x326DC0 -> 0x326F2C
// this: r20
signed int zNPCGoalCheer::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x326DC0 -> 0x326F2C
        class zNPCVillager * npc; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326F30 -> 0x00326F88
*/
// Range: 0x326F30 -> 0x326F88
// this: r17
signed int zNPCGoalCheer::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x326F30 -> 0x326F88
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326F90 -> 0x00326FC8
*/
// Range: 0x326F90 -> 0x326FC8
signed int NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x326F90 -> 0x326FC8
        signed int handled; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00326FD0 -> 0x00327260
*/
// Range: 0x326FD0 -> 0x327260
// this: r19
signed int zNPCGoalSpeak::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x326FD0 -> 0x327260
        class zNPCVillager * npc; // r16
        class xVec3 dir_plyr; // r29+0x70
        float jawval; // r29+0x80
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327260 -> 0x00327304
*/
// Range: 0x327260 -> 0x327304
// this: r2
signed int zNPCGoalSpeak::Exit() {
    /* anonymous block */ {
        // Range: 0x327260 -> 0x327304
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327310 -> 0x003273E4
*/
// Range: 0x327310 -> 0x3273E4
// this: r18
signed int zNPCGoalSpeak::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x327310 -> 0x3273E4
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003273F0 -> 0x00327448
*/
// Range: 0x3273F0 -> 0x327448
// this: r2
signed int zNPCGoalTalk::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3273F0 -> 0x327448
        signed int handled; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327450 -> 0x003278A4
*/
// Range: 0x327450 -> 0x3278A4
// this: r20
signed int zNPCGoalTalk::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */) {
    /* anonymous block */ {
        // Range: 0x327450 -> 0x3278A4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003278B0 -> 0x00327954
*/
// Range: 0x3278B0 -> 0x327954
// this: r2
signed int zNPCGoalTalk::Exit() {
    /* anonymous block */ {
        // Range: 0x3278B0 -> 0x327954
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327960 -> 0x00327AB8
*/
// Range: 0x327960 -> 0x327AB8
// this: r18
signed int zNPCGoalTalk::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x327960 -> 0x327AB8
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327AC0 -> 0x00327D64
*/
// Range: 0x327AC0 -> 0x327D64
void ChkCheatDogTrix(signed int * nextgoal /* r17 */, enum en_trantype * trantype /* r16 */) {
    /* anonymous block */ {
        // Range: 0x327AC0 -> 0x327D64
        ...
        signed int k; // r5
        signed int k; // r5
        unsigned int hashes_sc[10]; // @ 0x005DE6A0
        unsigned int hashes_pa[3]; // @ 0x005DE6E8
        unsigned int hashes_ss[5]; // @ 0x005DE6D0
        signed char @6164; // @ 0x005100F4
        signed char @6161; // @ 0x005100F0
        signed char @6158; // @ 0x005100EC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327D70 -> 0x00327DB0
*/
// Range: 0x327D70 -> 0x327DB0
// this: r2
signed int zNPCGoalPlayerNear::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x327D70 -> 0x327DB0
        signed int handled; // r2
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00327DB0 -> 0x00328374
*/
// Range: 0x327DB0 -> 0x328374
// this: r21
signed int zNPCGoalPlayerNear::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r22 */) {
    /* anonymous block */ {
        // Range: 0x327DB0 -> 0x328374
        signed int nextgoal; // r29+0xDC
        class zNPCVillager * npc; // r19
        class NPCConfig * cfg; // r18
        class xVec3 dir_plyr; // r29+0xC8
        signed int cheats; // r17
        float rad_taskshow; // r4
        float rad_taskhide; // r3
        float dy; // r29+0xD8
        class xVec3 vex; // r29+0xB8
        class xVec3 vec; // r29+0xA8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328380 -> 0x00328480
*/
// Range: 0x328380 -> 0x328480
// this: r16
signed int zNPCGoalPlayerNear::Resume(float dt /* r20 */, void * updCtxt /* r18 */) {
    /* anonymous block */ {
        // Range: 0x328380 -> 0x328480
        class zNPCVillager * npc; // r17
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00328480 -> 0x003284E0
*/
// Range: 0x328480 -> 0x3284E0
// this: r17
signed int zNPCGoalPlayerNear::Suspend() {
    /* anonymous block */ {
        // Range: 0x328480 -> 0x3284E0
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003284E0 -> 0x003285BC
*/
// Range: 0x3284E0 -> 0x3285BC
// this: r17
signed int zNPCGoalPlayerNear::Exit() {
    /* anonymous block */ {
        // Range: 0x3284E0 -> 0x3285BC
        class zNPCVillager * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003285C0 -> 0x00328794
*/
// Range: 0x3285C0 -> 0x328794
// this: r18
signed int zNPCGoalPlayerNear::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3285C0 -> 0x328794
        class zNPCVillager * npc; // r16
        class xVec3 ang_delta; // r29+0x60
        class xVec3 ang_delta; // r29+0x50
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003287A0 -> 0x00328DD8
*/
// Range: 0x3287A0 -> 0x328DD8
class xFactoryInst * GOALCreate_Villager(signed int who /* r17 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3287A0 -> 0x328DD8
