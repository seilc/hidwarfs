...
// this: r18
void NPARParmFahrwerkz::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B5A90 -> 0x3B5D74
        float fac_rand; // r4
...
// this: r18
void NPARParmDogBreath::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B6600 -> 0x3B66F4
        float fac_rand; // r1
        float samecalc; // r29+0x60
...
// this: r18
void NPARParmTarTarGunk::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B70E0 -> 0x3B73C4
        float fac_rand; // r4
        float samecalc; // r29+0x60
...
// this: r20
void NPARParmVisSplash::ConfigPar(class NPARData * par /* r19 */, enum en_nparmode pmod /* r18 */, class xVec3 * pos /* r17 */, class xVec3 * vel /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3B7B90 -> 0x3B7CAC
        float fac_rand; // r1
        float samecalc; // r29+0x60
...
// this: r18
void NPARParmChuckSplash::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B8470 -> 0x3B868C
        float fac_rand; // r2
        float samecalc; // r29+0x60
...
// this: r18
void NPARParmSleepyZeez::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B9070 -> 0x3B9354
        float fac_rand; // r4
        float samecalc; // r29+0x60
...
// this: r18
void NPARParmGloveDust::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3B9EC0 -> 0x3B9FB4
        float fac_rand; // r1
        float samecalc; // r29+0x60
...
// this: r18
void NPARParmTubeConfetti::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3BA9A0 -> 0x3BAE18
        float fac_rand; // r20
...
// this: r18
void NPARParmOilBub::ConfigPar(class NPARData * par /* r17 */, enum en_nparmode pmod /* r16 */, class xVec3 * pos /* r20 */, class xVec3 * vel /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3BC340 -> 0x3BC470
        float fac_rand; // r1
        float samecalc; // r29+0x60
...
// this: r20
void NPARMgmt::Init(enum en_nparptyp parType /* r19 */, void * * userData /* r18 */, class NPARXtraData * xtraData /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BC470 -> 0x3BC554
