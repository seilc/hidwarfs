/*
    Compile unit: C:\SB\Game\zNPCSpawner.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
char buffer[16]; // size: 0x10, address: 0x0
char buffer[16]; // size: 0x10, address: 0x0
static class SMDepot g_smdepot; // size: 0x10, address: 0x5D4C00
static signed int g_drawSpawnBounds; // size: 0x4, address: 0x51006C
...
class SMDepot {
    // Members
public:
    class st_XORDEREDARRAY spawners; // offset 0x0, size 0x10
};
// total size: 0x68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003165E0 -> 0x00316700
*/
// Range: 0x3165E0 -> 0x316700
// this: r16
void zNPCSpawner::ChildCleanup() {
    /* anonymous block */ {
        // Range: 0x3165E0 -> 0x316700
        signed int i; // r18
        class SMNPCStatus * npc_stat; // r8
        signed int cnt_know; // r7
        signed int cnt_dead; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316700 -> 0x0031680C
*/
// Range: 0x316700 -> 0x31680C
// this: r19
signed int zNPCSpawner::SpawnBeastie(class SMNPCStatus * npcstat /* r18 */, class SMSPStatus * spstat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x316700 -> 0x31680C
        class zNPCCommon * npc; // r17
        class zMovePoint * sp; // r16
        class xVec3 pos_sp; // r29+0x50
        class zMovePoint * nav_dest; // r29+0x5C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316810 -> 0x00316850
*/
// Range: 0x316810 -> 0x316850
// this: r2
class SMNPCStatus * zNPCSpawner::StatForNPC(class zNPCCommon * npc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x316810 -> 0x316850
        class SMNPCStatus * tmp_stat; // r7
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316850 -> 0x00316A34
*/
// Range: 0x316850 -> 0x316A34
signed int IsNearbyMover(class xBound * bnd /* r21 */, signed int usecyl /* r22 */, class xCollis * caller_colrec /* r2 */) {
    /* anonymous block */ {
        // Range: 0x316850 -> 0x316A34
        signed int hitthing; // r20
        class zNPCCommon * npc; // r19
        signed int i; // r18
        class xCollis local_colrec; // r29+0xA0
        class xCollis * colrec; // r17
        class xVec3 delt; // r29+0xF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316A40 -> 0x00316C04
*/
// Range: 0x316A40 -> 0x316C04
// this: r19
signed int zNPCSpawner::IsSPLZClear(class zMovePoint * sp /* r16 */) {
    /* anonymous block */ {
        // Range: 0x316A40 -> 0x316C04
        class xVec3 pos_sp; // r29+0xB0
        signed int rc; // r2
        class xBound bnd; // r29+0x50
        class xVec3 delt; // r29+0xA0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316C10 -> 0x00316DD4
*/
// Range: 0x316C10 -> 0x316DD4
// this: r16
class SMSPStatus * zNPCSpawner::SelectSP(class SMNPCStatus * npcstat /* r2 */) {
    /* anonymous block */ {
        // Range: 0x316C10 -> 0x316DD4
        signed int rc; // r2
        class SMSPStatus * splist[16]; // r29+0x70
        signed int cnt; // r21
        signed int i; // r20
        class SMSPStatus * tmp_stat; // r19
        signed int rc; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316DE0 -> 0x00316E60
*/
// Range: 0x316DE0 -> 0x316E60
// this: r2
unsigned char zNPCSpawner::Receivable(enum en_SM_NOTICES note /* r2 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x316DE0 -> 0x316E60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00316E60 -> 0x00317084
*/
// Range: 0x316E60 -> 0x317084
// this: r16
void zNPCSpawner::Notify(enum en_SM_NOTICES note /* r2 */, void * data /* r17 */) {
    /* anonymous block */ {
        // Range: 0x316E60 -> 0x317084
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317090 -> 0x00317578
*/
// Range: 0x317090 -> 0x317578
// this: r16
void zNPCSpawner::UpdateContinuous() {
    /* anonymous block */ {
        // Range: 0x317090 -> 0x317578
        class SMSPStatus * spstat; // r17
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317580 -> 0x003179A8
*/
// Range: 0x317580 -> 0x3179A8
// this: r19
void zNPCSpawner::UpdateDiscreet() {
    /* anonymous block */ {
        // Range: 0x317580 -> 0x3179A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003179B0 -> 0x00317A74
*/
// Range: 0x3179B0 -> 0x317A74
// this: r16
void zNPCSpawner::Timestep(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3179B0 -> 0x317A74
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317A80 -> 0x00317B44
*/
// Range: 0x317A80 -> 0x317B44
// this: r19
void zNPCSpawner::MapPreferred() {
    /* anonymous block */ {
        // Range: 0x317A80 -> 0x317B44
        signed int i; // r18
        class SMNPCStatus * npc_stat; // r17
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317B50 -> 0x00317C38
*/
// Range: 0x317B50 -> 0x317C38
// this: r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317C40 -> 0x00317CB8
*/
// Range: 0x317C40 -> 0x317CB8
// this: r7
signed int zNPCSpawner::AddSpawnNPC(class zNPCCommon * npc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x317C40 -> 0x317CB8
        signed int ack; // r16
        signed int i; // r6
        class SMNPCStatus * npc_stat; // r4
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317CC0 -> 0x00317D00
*/
// Range: 0x317CC0 -> 0x317D00
// this: r2
signed int zNPCSpawner::AddSpawnPoint(class zMovePoint * sp /* r2 */) {
    /* anonymous block */ {
        // Range: 0x317CC0 -> 0x317D00
        class SMSPStatus * sp_stat; // r7
        signed int ack; // r2
        signed int i; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317D00 -> 0x00317D10
*/
// Range: 0x317D00 -> 0x317D10
// this: r2
void zNPCSpawner::SetWaveMode(enum en_SM_WAVE_MODE mode /* r2 */, float delay /* r29 */, signed int lifemax /* r2 */) {
    /* anonymous block */ {
        // Range: 0x317D00 -> 0x317D10
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317D10 -> 0x00317D68
*/
// Range: 0x317D10 -> 0x317D68
// this: r16
void zNPCSpawner::Subscribe(class zNPCCommon * owner /* r2 */) {
    /* anonymous block */ {
        // Range: 0x317D10 -> 0x317D68
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317D70 -> 0x00317DD0
*/
// Range: 0x317D70 -> 0x317DD0
class zNPCSpawner * zNPCSpawner_GetInstance() {
    /* anonymous block */ {
        // Range: 0x317D70 -> 0x317DD0
        class zNPCSpawner * sm; // r2
        class zNPCSpawner * sm_tmp; // r8
        class SMDepot * depot; // r3
        signed int i; // r7
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317DD0 -> 0x00317E54
*/
// Range: 0x317DD0 -> 0x317E54
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317E60 -> 0x00317ED4
*/
// Range: 0x317E60 -> 0x317ED4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317EE0 -> 0x00317EE8
*/
// Range: 0x317EE0 -> 0x317EE8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00317EF0 -> 0x00317EF8
*/
// Range: 0x317EF0 -> 0x317EF8
