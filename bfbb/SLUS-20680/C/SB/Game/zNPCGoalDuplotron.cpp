/*
    Compile unit: C:\SB\Game\zNPCGoalDuplotron.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalDuploLive::__vtable; // size: 0x34, address: 0x50C2A0
unsigned int g_hash_dupoanim[5]; // size: 0x14, address: 0x5CF440
class zGlobals globals; // size: 0x2050, address: 0x52C8F0
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalDuploDead::__vtable; // size: 0x34, address: 0x50C2E0
// total size: 0x34
...
class zNPCGoalDuploLive : public zNPCGoalCommon {
    // Members
public:
    float tmr_chkPlyrDist; // offset 0x4C, size 0x4
    signed int cnt_destruct; // offset 0x50, size 0x4
    enum en_dupolive livestat; // offset 0x54, size 0x4
};
// total size: 0x0
class xFFX {};
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319800 -> 0x00319968
*/
// Range: 0x319800 -> 0x319968
// this: r2
void zNPCGoalDuploLive::SDS_StartExplode() {
    /* anonymous block */ {
        // Range: 0x319800 -> 0x319968
        class zNPCDuplotron * npc; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319970 -> 0x00319A80
*/
// Range: 0x319970 -> 0x319A80
// this: r17
signed int zNPCGoalDuploLive::SDS_Countdown(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x319970 -> 0x319A80
        class zNPCDuplotron * npc; // r16
        signed int done; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319A80 -> 0x00319BA4
*/
// Range: 0x319A80 -> 0x319BA4
// this: r17
signed int zNPCGoalDuploLive::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x319A80 -> 0x319BA4
        signed int handled; // r16
        class zNPCDuplotron * npc; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319BB0 -> 0x00319E14
*/
// Range: 0x319BB0 -> 0x319E14
// this: r22
signed int zNPCGoalDuploLive::Process(enum en_trantype * trantype /* r21 */, float dt /* r20 */, void * updCtxt /* r20 */, class xScene * xscn /* r19 */) {
    /* anonymous block */ {
        // Range: 0x319BB0 -> 0x319E14
        class zNPCDuplotron * npc; // r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319E20 -> 0x00319E30
*/
// Range: 0x319E20 -> 0x319E30
// this: r2
signed int zNPCGoalDuploLive::Enter(float dt /* r29 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x319E20 -> 0x319E30
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00319E30 -> 0x00319F90
*/
// Range: 0x319E30 -> 0x319F90
class xFactoryInst * GOALCreate_Duplotron(signed int who /* r16 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x319E30 -> 0x319F90
        class xGoal * goal; // r2
    }
