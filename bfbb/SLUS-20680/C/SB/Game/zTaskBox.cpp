...
// total size: 0x18
struct /* @anon1 */ {} ztaskbox::talk_callback::__vtable; // size: 0x18, address: 0x50C3A0
// total size: 0x18
struct /* @anon0 */ {} ztalkbox::callback::__vtable; // size: 0x18, address: 0x0
...
// this: r2
void ztaskbox::set_callback(class callback * cb /* r2 */) {
    /* anonymous block */ {
        // Range: 0x323EC0 -> 0x323EC8
    }
}
...
// this: r18
void ztaskbox::start_talk(class zNPCCommon * npc /* r17 */) {
    /* anonymous block */ {
        // Range: 0x323F70 -> 0x3240EC
