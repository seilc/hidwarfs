...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalPrawnDeath::__vtable; // size: 0x34, address: 0x50D530
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalCommon::__vtable; // size: 0x34, address: 0x50A340
// total size: 0x2C
struct /* @anon6 */ {} xGoal::__vtable; // size: 0x2C, address: 0x50BE00
// total size: 0x34
struct /* @anon12 */ {} zNPCGoalPrawnDamage::__vtable; // size: 0x34, address: 0x50D570
// total size: 0x34
struct /* @anon7 */ {} zNPCGoalPrawnBowl::__vtable; // size: 0x34, address: 0x50D5B0
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalPrawnBeam::__vtable; // size: 0x34, address: 0x50D5F0
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalPrawnIdle::__vtable; // size: 0x34, address: 0x50D630
// total size: 0x34
struct /* @anon14 */ {} zNPCGoalKJDeath::__vtable; // size: 0x34, address: 0x50CD20
// total size: 0x34
struct /* @anon10 */ {} zNPCGoalKJDamage::__vtable; // size: 0x34, address: 0x50CD60
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalKJShockGround::__vtable; // size: 0x34, address: 0x50CDA0
// total size: 0x34
struct /* @anon11 */ {} zNPCGoalKJTaunt::__vtable; // size: 0x34, address: 0x50CDE0
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalKJSpawnKids::__vtable; // size: 0x34, address: 0x50CE20
// total size: 0x34
struct /* @anon13 */ {} zNPCGoalKJBored::__vtable; // size: 0x34, address: 0x50CE60
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalKJIdle::__vtable; // size: 0x34, address: 0x50CEA0
// total size: 0x34
struct /* @anon9 */ {} zNPCGoalHere::__vtable; // size: 0x34, address: 0x50C490
// total size: 0x10
class xBase {
    // Members
public:
