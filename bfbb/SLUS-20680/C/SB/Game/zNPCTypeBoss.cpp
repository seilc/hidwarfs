/*
    Compile unit: C:\SB\Game\zNPCTypeBoss.cpp
...
static signed int g_boss_is_in_the_house; // size: 0x4, address: 0x5100D8
static class zParEmitter * g_pemit_holder; // size: 0x4, address: 0x5100DC
static class xParEmitterCustomSettings g_parf_holder; // size: 0x16C, address: 0x5DE360
// total size: 0xD8
...
// total size: 0x54
struct /* @anon1 */ {} xNPCBasic::__vtable; // size: 0x54, address: 0x50BE30
// total size: 0xD8
struct /* @anon3 */ {} zNPCB_SB2::__vtable; // size: 0xD8, address: 0x50D230
// total size: 0xD8
struct /* @anon2 */ {} zNPCB_SB1::__vtable; // size: 0xD8, address: 0x50D450
// total size: 0xD8
struct /* @anon0 */ {} zNPCBPatrick::__vtable; // size: 0xD8, address: 0x50DE60
// total size: 0xD8
struct /* @anon6 */ {} zNPCBSandy::__vtable; // size: 0xD8, address: 0x50CC40
// total size: 0x8
class RwLLLink {
    // Members
public:
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324D60 -> 0x00324DA4
*/
// Range: 0x324D60 -> 0x324DA4
// this: r2
void zNPCBoss::Setup() {
    /* anonymous block */ {
        // Range: 0x324D60 -> 0x324DA4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324DB0 -> 0x00324E60
*/
// Range: 0x324DB0 -> 0x324E60
class xAnimTable * ZNPC_AnimTable_BossSBobbyArm() {
    /* anonymous block */ {
        // Range: 0x324DB0 -> 0x324E60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324E60 -> 0x00324E84
*/
// Range: 0x324E60 -> 0x324E84
void ZNPC_Destroy_Boss(class xFactoryInst * inst /* r2 */) {
    /* anonymous block */ {
        // Range: 0x324E60 -> 0x324E84
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00324E90 -> 0x003250F0
*/
// Range: 0x324E90 -> 0x3250F0
class xFactoryInst * ZNPC_Create_Boss(signed int who /* r16 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x324E90 -> 0x3250F0
        class zNPCBoss * boss; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003250F0 -> 0x003250F8
*/
// Range: 0x3250F0 -> 0x3250F8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325100 -> 0x0032510C
*/
// Range: 0x325100 -> 0x32510C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325110 -> 0x00325118
*/
// Range: 0x325110 -> 0x325118
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x00325120 -> 0x00325180
*/
// Range: 0x325120 -> 0x325180
