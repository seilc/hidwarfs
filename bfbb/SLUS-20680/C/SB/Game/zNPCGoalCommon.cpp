...
// this: r16
unsigned int zNPCGoalCommon::DoExplicitAnim(unsigned int anid /* r17 */, signed int forceRestart /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CAC10 -> 0x2CAC88
        signed int rc; // r2
    }
...
// this: r16
unsigned int zNPCGoalCommon::DoAutoAnim(enum en_NPC_GOAL_SPOT gspot /* r5 */, signed int forceRestart /* r18 */) {
    /* anonymous block */ {
        // Range: 0x2CAC90 -> 0x2CAD44
...
// this: r17
signed int zNPCGoalCommon::PreCalc(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2CAD50 -> 0x2CAE18
...
// this: r16
signed int zNPCGoalCommon::Resume() {
    /* anonymous block */ {
        // Range: 0x2CAE30 -> 0x2CAF10
        signed int gid; // r2
    }
...
// this: r16
signed int zNPCGoalCommon::Enter() {
    /* anonymous block */ {
        // Range: 0x2CAF10 -> 0x2CAFE8
        signed int gid; // r2
    }
