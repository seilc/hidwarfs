...
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalPrawnDeath::__vtable; // size: 0x34, address: 0x50D530
...
// total size: 0xCC
struct /* @anon2 */ {} zNPCPrawn::__vtable; // size: 0xCC, address: 0x50D670
// total size: 0xCC
struct /* @anon7 */ {} zNPCSubBoss::__vtable; // size: 0xCC, address: 0x50C5F0
// total size: 0xCC
struct /* @anon4 */ {} zNPCCommon::__vtable; // size: 0xCC, address: 0x50A6C0
// total size: 0x54
struct /* @anon6 */ {} xNPCBasic::__vtable; // size: 0x54, address: 0x50BE30
...
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalPrawnDamage::__vtable; // size: 0x34, address: 0x50D570
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalPrawnBowl::__vtable; // size: 0x34, address: 0x50D5B0
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalPrawnBeam::__vtable; // size: 0x34, address: 0x50D5F0
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalPrawnIdle::__vtable; // size: 0x34, address: 0x50D630
// total size: 0xC
class RxOutputSpec {
    // Members
public:
...
public:
    // total size: 0x1
    class /* @class */ {} flag; // offset 0x2B4, size 0x1
...
// this: r2
signed int zNPCGoalPrawnDeath::Process(enum en_trantype * trantype /* r2 */, float dt /* r29 */, void * updCtxt /* r2 */, class xScene * xscn /* r2 */) {
    /* anonymous block */ {
        // Range: 0x35D4F0 -> 0x35D4F8
    }
}
...
// this: r17
signed int zNPCGoalPrawnDeath::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35D510 -> 0x35D564
    }
}
...
// this: r20
signed int zNPCGoalPrawnDamage::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x35D570 -> 0x35D674
...
// this: r2
signed int zNPCGoalPrawnDamage::Exit() {
    /* anonymous block */ {
        // Range: 0x35D680 -> 0x35D744
        class zNPCPrawn & prawn; // r16
    }
...
// this: r17
signed int zNPCGoalPrawnDamage::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35D750 -> 0x35D7B0
    }
}
...
// this: r19
signed int zNPCGoalPrawnBowl::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35D7B0 -> 0x35D89C
...
// this: r2
signed int zNPCGoalPrawnBowl::Exit() {
    /* anonymous block */ {
        // Range: 0x35D8A0 -> 0x35D8D0
    }
}
...
// this: r18
signed int zNPCGoalPrawnBowl::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x35D8D0 -> 0x35D950
        class zNPCPrawn & prawn; // r16
    }
...
// this: r18
enum substate_enum zNPCGoalPrawnBeam::update_sweep() {
    /* anonymous block */ {
        // Range: 0x35D950 -> 0x35DBAC
...
// this: r20
signed int zNPCGoalPrawnBeam::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x35DBB0 -> 0x35DFE0
        class zNPCPrawn & prawn; // r16
    }
...
// this: r2
signed int zNPCGoalPrawnBeam::Exit() {
    /* anonymous block */ {
        // Range: 0x35DFE0 -> 0x35E084
...
// this: r19
signed int zNPCGoalPrawnBeam::Enter(float dt /* r20 */, void * updCtxt /* r18 */) {
    /* anonymous block */ {
        // Range: 0x35E090 -> 0x35E43C
        class zNPCPrawn & prawn; // r17
...
// this: r2
signed int zNPCGoalPrawnIdle::Process(enum en_trantype * trantype /* r2 */, float dt /* r29+0x10 */, void * updCtxt /* r2 */, class xScene * xscn /* r2 */) {
    /* anonymous block */ {
        // Range: 0x35E440 -> 0x35E49C
...
// this: r17
signed int zNPCGoalPrawnIdle::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35E4B0 -> 0x35E51C
...
// this: r16
unsigned char zNPCPrawn::check_player_damage() {
    /* anonymous block */ {
        // Range: 0x35E7E0 -> 0x35E950
...
// this: r18
void zNPCPrawn::set_life(signed int life /* r2 */) {
    /* anonymous block */ {
        // Range: 0x35E950 -> 0x35EB9C
...
// this: r17
static void television::render_background() {
    /* anonymous block */ {
        // Range: 0x35EFC0 -> 0x35F120
...
// this: r16
void zNPCPrawn::set_floor_state(enum floor_state_enum s /* r2 */, unsigned char immediate /* r17 */, unsigned char force /* r2 */) {
    /* anonymous block */ {
        // Range: 0x35F120 -> 0x35F204
...
// this: r19
void zNPCPrawn::get_floor_info(enum floor_state_enum s /* r2 */, class range_type & pattern /* r18 */, float & transition_delay /* r17 */, float & state_delay /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35F210 -> 0x35F474
    }
}
...
// this: r17
void zNPCPrawn::update_beam(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x35F480 -> 0x35F7A0
...
// this: r16
void zNPCPrawn::update_animation() {
    /* anonymous block */ {
        // Range: 0x35F7A0 -> 0x35F870
...
// this: r16
void zNPCPrawn::update_turn(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x35F870 -> 0x35FE78
...
// this: r18
void zNPCPrawn::add_child(class xBase & child /* r17 */, signed int wave /* r16 */) {
    /* anonymous block */ {
        // Range: 0x35FE80 -> 0x360010
        unsigned int i; // r20
...
// this: r20
void zNPCPrawn::DuploNotice(enum en_SM_NOTICES note /* r19 */, void * data /* r18 */) {
    /* anonymous block */ {
        // Range: 0x3602B0 -> 0x360350
        signed int i; // r17
    }
...
// this: r17
void zNPCPrawn::Damage(enum en_NPC_DAMAGE_TYPE damtype /* r16 */) {
    /* anonymous block */ {
        // Range: 0x360350 -> 0x3603C4
        signed int state; // r2
    }
...
// this: r16
signed int zNPCPrawn::SysEvent(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, signed int * handled /* r2 */) {
    /* anonymous block */ {
        // Range: 0x361A10 -> 0x361B28
    }
}
...
// this: r16
void zNPCPrawn::NewTime(class xScene * xscn /* r2 */, float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x361B30 -> 0x361B5C
    }
}
...
// this: r17
void zNPCPrawn::Process(class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x361B60 -> 0x361DE0
        signed int i; // r19
...
// this: r16
void zNPCPrawn::Init(class xEntAsset * asset /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3623A0 -> 0x3626CC
    }
}
...
// this: r17
static void television::destroy() {
    /* anonymous block */ {
        // Range: 0x3626D0 -> 0x362790
...
// this: r2
zNPCPrawn::zNPCPrawn(signed int myType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x362790 -> 0x3627DC
    }
}
...
// this: r2
void aqua_beam::render_ring(class ring_segment & r /* r2 */) {
    /* anonymous block */ {
        // Range: 0x362BC0 -> 0x362D40
...
// this: r17
void aqua_beam::update_rings(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x363140 -> 0x363528
...
// this: r2
unsigned char aqua_beam::hits_sphere(class xSphere & o /* r2 */) {
    /* anonymous block */ {
        // Range: 0x363530 -> 0x363758
