...
// this: r2
void zNPCCommon::AddScripting(class xPsyche * psy /* r21 */, signed int (* eval_script)(class xGoal *, void *, enum en_trantype *, float, void *) /* r20 */, signed int (* eval_playanim)(class xGoal *, void *, enum en_trantype *, float, void *) /* r19 */, signed int (* eval_attack)(class xGoal *, void *, enum en_trantype *, float, void *) /* r18 */, signed int (* eval_move)(class xGoal *, void *, enum en_trantype *, float, void *) /* r17 */, signed int (* eval_follow)(class xGoal *, void *, enum en_trantype *, float, void *) /* r16 */, signed int (* eval_lead)(class xGoal *, void *, enum en_trantype *, float, void *) /* r22 */, signed int (* eval_wait)(class xGoal *, void *, enum en_trantype *, float, void *) /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x2CF970 -> 0x2CFAE8
        class xGoal * goal; // r2
    }
...
// this: r2
void zNPCCommon::LassoNotify(enum en_LASSO_EVENT event /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CFC20 -> 0x2CFCA8
...
// this: r2
class zNPCLassoInfo * zNPCCommon::GimmeLassInfo() {
    /* anonymous block */ {
        // Range: 0x2CFCB0 -> 0x2CFCD0
    }
}
...
// this: r2
void zNPCCommon::LassoSyncAnims(enum en_lassanim lassanim /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CFCD0 -> 0x2CFD5C
...
// this: r2
signed int zNPCCommon::LassoGetAnims(class xModelInstance * modgrab /* r20 */, class xModelInstance * modhold /* r19 */) {
    /* anonymous block */ {
        // Range: 0x2CFD60 -> 0x2CFEF8
...
// this: r2
signed int zNPCCommon::LassoUseGuides(signed int idx_grabmdl /* r2 */, signed int idx_holdmdl /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2CFF00 -> 0x2CFF94
...
// this: r17
signed int zNPCCommon::LassoSetup() {
    /* anonymous block */ {
        // Range: 0x2CFFA0 -> 0x2D0090
        class zNPCLassoInfo * lass; // r16
    }
...
// this: r20
signed int zNPCCommon::SndQueUpdate(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D0090 -> 0x2D0188
...
// this: r2
void zNPCCommon::SndKillSounds(signed int flg_chan /* r2 */, signed int all /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0190 -> 0x2D01F4
...
// this: r2
signed int zNPCCommon::SndChanIsBusy(signed int flg_chan /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0200 -> 0x2D0228
    }
}
...
// this: r2
signed int zNPCCommon::SndIsAnyPlaying() {
    /* anonymous block */ {
        // Range: 0x2D0230 -> 0x2D0284
        signed int yep; // r2
        signed int owner; // r17
...
// this: r21
unsigned int zNPCCommon::SndStart(unsigned int aid_toplay /* r20 */, class NPCSndProp * sprop /* r19 */, float radius /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2D0290 -> 0x2D0590
        float pvary; // r21
...
// this: r19
signed int zNPCCommon::SndPlayRandom(enum en_NPC_SOUND sndtype /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D0590 -> 0x2D0628
...
// this: r18
signed int zNPCCommon::SndPlayFromSFX(class xSFX * sfx /* r17 */, unsigned int * sid_played /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D0630 -> 0x2D06D0
        unsigned int aidToPlay; // r2
...
// this: r18
signed int zNPCCommon::SndPlayFromAFX(class zAnimFxSound * afxsnd /* r17 */, unsigned int * sid_played /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D06D0 -> 0x2D07B4
...
// this: r17
signed int zNPCCommon::SomethingWonderful() {
    /* anonymous block */ {
        // Range: 0x2D07C0 -> 0x2D08B8
...
// this: r2
void zNPCCommon::WonderOfTalking(signed int inprogress /* r2 */, class xBase * owner /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D08C0 -> 0x2D08F0
    }
}
...
// this: r2
class xVec3 * zNPCCommon::MatPosSet(class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0900 -> 0x2D0938
    }
}
...
// this: r2
void zNPCCommon::Vibrate(float ds2_cur /* r29+0x10 */, float ds2_max /* r29+0x10 */) {
    /* anonymous block */ {
        // Range: 0x2D0A80 -> 0x2D0B54
        float rat; // r1
    }
...
// this: r2
float zNPCCommon::AnimTimeCurrent() {
    /* anonymous block */ {
        // Range: 0x2D0C40 -> 0x2D0C54
    }
}
...
// this: r2
float zNPCCommon::AnimTimeRemain(class xAnimState * ast /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0C60 -> 0x2D0CC8
    }
}
...
// this: r2
float zNPCCommon::AnimDuration(class xAnimState * ast /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0CD0 -> 0x2D0D40
    }
}
...
// this: r2
unsigned int zNPCCommon::AnimCurStateID() {
    /* anonymous block */ {
        // Range: 0x2D0D40 -> 0x2D0DA0
    }
}
...
// this: r2
class xAnimState * zNPCCommon::AnimCurState() {
    /* anonymous block */ {
        // Range: 0x2D0DA0 -> 0x2D0DE8
    }
}
...
// this: r2
class xAnimSingle * zNPCCommon::AnimCurSingle() {
    /* anonymous block */ {
        // Range: 0x2D0DF0 -> 0x2D0E38
    }
}
...
// this: r2
class xAnimState * zNPCCommon::AnimFindState(unsigned int animID /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0E40 -> 0x2D0E50
    }
}
...
// this: r16
void zNPCCommon::AnimSetState(unsigned int animID /* r2 */, float time /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D0E50 -> 0x2D0EA4
...
// this: r8
signed int zNPCCommon::AnimStart(unsigned int animID /* r2 */, signed int forceRestart /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0EB0 -> 0x2D0FB8
...
// this: r2
void zNPCCommon::ModelScaleSet(float x /* r29 */, float y /* r29 */, float z /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D0FC0 -> 0x2D0FF0
...
// this: r2
class xModelInstance * zNPCCommon::ModelAtomicFind(signed int index /* r2 */, signed int idx_prev /* r2 */, class xModelInstance * mdl_prev /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D0FF0 -> 0x2D1040
...
// this: r2
class xModelInstance * zNPCCommon::ModelAtomicShow(signed int index /* r2 */, class xModelInstance * mdl /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D1040 -> 0x2D10A4
        class xModelInstance * minst; // r2
    }
...
// this: r2
class xModelInstance * zNPCCommon::ModelAtomicHide(signed int index /* r2 */, class xModelInstance * mdl /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D10B0 -> 0x2D1104
        class xModelInstance * minst; // r2
    }
...
// this: r21
signed int zNPCCommon::HaveLOSToPos(class xVec3 * pos /* r20 */, float dist /* r20 */, class xScene * xscn /* r19 */, class xBase * tgt /* r18 */, class xCollis * colCallers /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D1110 -> 0x2D1354
...
// this: r16
signed int zNPCCommon::MvptCycle() {
    /* anonymous block */ {
        // Range: 0x2D1360 -> 0x2D14F8
...
// this: r16
void zNPCCommon::MvptReset(class zMovePoint * nav_goto /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D1500 -> 0x2D156C
    }
}
...
// this: r2
class zMovePoint * zNPCCommon::FirstAssigned() {
    /* anonymous block */ {
        // Range: 0x2D1570 -> 0x2D15A0
...
// this: r19
void zNPCCommon::GetParm(enum en_npcparm pid /* r18 */, void * val /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2D17F0 -> 0x2D19CC
        char * * names; // r16
...
// this: r2
void zNPCCommon::GetParm(enum en_npcparm pid /* r2 */, class zMovePoint * * val /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D19D0 -> 0x2D19E0
    }
}
...
// this: r2
signed int zNPCCommon::IsAttackFrame(float tym_anim /* r29 */, signed int series /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D2050 -> 0x2D2178
        signed int result; // r2
...
// this: r2
signed int zNPCCommon::GetVertPos(enum en_mdlvert vid /* r2 */, class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D2180 -> 0x2D21DC
        class NPCConfig * cfg; // r6
    }
...
// this: r16
float zNPCCommon::TurnToFace(float dt /* r29+0x30 */, class xVec3 * dir_want /* r2 */, float useTurnRate /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x2D2F20 -> 0x2D3074
...
// this: r2
float zNPCCommon::ThrottleApply(float dt /* r29+0x40 */, class xVec3 * dir /* r2 */, signed int force3D /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D3080 -> 0x2D31F4
    }
}
...
// this: r2
float zNPCCommon::ThrottleAccel(float dt /* r29 */, signed int speedup /* r2 */, float pct_max /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D3200 -> 0x2D3288
...
// this: r2
float zNPCCommon::ThrottleAdjust(float dt /* r29 */, float spd_want /* r29 */, float accel /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D3290 -> 0x2D3398
...
// this: r17
void zNPCCommon::ConvertHitEvent(class xBase * from /* r16 */, float * toParam /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D3460 -> 0x2D36A0
...
// this: r21
signed int zNPCCommon::SysEvent(class xBase * from /* r20 */, class xBase * to /* r19 */, unsigned int toEvent /* r18 */, float * toParam /* r17 */, class xBase * toParamWidget /* r16 */, signed int * handled /* r22 */) {
    /* anonymous block */ {
        // Range: 0x2D36A0 -> 0x2D4290
...
// this: r17
void zNPCCommon::NewTime(class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2D4290 -> 0x2D4318
    }
}
...
// this: r2
float zNPCCommon::BoundAsRadius(signed int useCfg /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D4320 -> 0x2D43F8
        float rad; // r29+0x10
...
// this: r16
void zNPCCommon::BUpdate(class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D4400 -> 0x2D46A8
...
// this: r2
void zNPCCommon::Process(class xScene * xscn /* r2 */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2D46B0 -> 0x2D4704
    }
}
...
// this: r16
void zNPCCommon::Move(class xScene * xscn /* r2 */, float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x2D4710 -> 0x2D47D0
...
// this: r18
signed int zNPCCommon::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2D47D0 -> 0x2D4ABC
...
// this: r19
signed int zNPCCommon::Respawn(class xVec3 * pos /* r18 */, class zMovePoint * mvptFirst /* r17 */, class zMovePoint * mvptSpawnRef /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2D4AC0 -> 0x2D4BDC
...
// this: r20
void zNPCCommon::Damage(enum en_NPC_DAMAGE_TYPE damtype /* r19 */, class xBase * who /* r18 */, class xVec3 * vec_hit /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2D4BE0 -> 0x2D4F08
...
// this: r16
void zNPCCommon::Init(class xEntAsset * entass /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2D5A40 -> 0x2D5BD8
