...
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalKJDeath::__vtable; // size: 0x34, address: 0x50CD20
...
// total size: 0xCC
struct /* @anon0 */ {} zNPCKingJelly::__vtable; // size: 0xCC, address: 0x50CEE0
// total size: 0xCC
struct /* @anon4 */ {} zNPCSubBoss::__vtable; // size: 0xCC, address: 0x50C5F0
// total size: 0xCC
struct /* @anon1 */ {} zNPCCommon::__vtable; // size: 0xCC, address: 0x50A6C0
// total size: 0x54
struct /* @anon7 */ {} xNPCBasic::__vtable; // size: 0x54, address: 0x50BE30
...
// total size: 0x34
struct /* @anon9 */ {} zNPCGoalKJDamage::__vtable; // size: 0x34, address: 0x50CD60
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalKJShockGround::__vtable; // size: 0x34, address: 0x50CDA0
// total size: 0x34
struct /* @anon10 */ {} zNPCGoalKJTaunt::__vtable; // size: 0x34, address: 0x50CDE0
// total size: 0x34
struct /* @anon6 */ {} zNPCGoalKJSpawnKids::__vtable; // size: 0x34, address: 0x50CE20
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalKJBored::__vtable; // size: 0x34, address: 0x50CE60
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalKJIdle::__vtable; // size: 0x34, address: 0x50CEA0
// total size: 0xC
class xVec3 {
    // Members
public:
...
// this: r2
signed int zNPCGoalKJDeath::Process(enum en_trantype * trantype /* r2 */, float dt /* r29 */, void * updCtxt /* r2 */, class xScene * xscn /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33C4B0 -> 0x33C4B8
    }
}
...
// this: r18
signed int zNPCGoalKJDeath::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33C4D0 -> 0x33C570
...
// this: r20
signed int zNPCGoalKJDamage::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33C570 -> 0x33C64C
        class zNPCKingJelly & kj; // r16
...
// this: r2
signed int zNPCGoalKJDamage::Exit() {
    /* anonymous block */ {
        // Range: 0x33C650 -> 0x33C6AC
...
// this: r20
signed int zNPCGoalKJDamage::Enter(float dt /* r20 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x33C6B0 -> 0x33C94C
...
// this: r16
enum shockstate_enum zNPCGoalKJShockGround::update_cool_down(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x33C950 -> 0x33CB74
        class zNPCKingJelly & kj; // r18
        class xAnimState * anim; // r2
...
// this: r19
enum shockstate_enum zNPCGoalKJShockGround::update_warm_up(float dt /* r21 */) {
    /* anonymous block */ {
        // Range: 0x33CB80 -> 0x33CE64
        class zNPCKingJelly & kj; // r16
...
// this: r20
signed int zNPCGoalKJShockGround::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33CE70 -> 0x33D0D0
        class zNPCKingJelly & kj; // r16
    }
...
// this: r2
signed int zNPCGoalKJShockGround::Exit() {
    /* anonymous block */ {
        // Range: 0x33D0D0 -> 0x33D168
        class zNPCKingJelly & kj; // r16
    }
...
// this: r20
signed int zNPCGoalKJShockGround::Enter(float dt /* r20 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x33D170 -> 0x33D314
        class zNPCKingJelly & kj; // r18
    }
...
// this: r19
signed int zNPCGoalKJTaunt::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x33D320 -> 0x33D3E4
...
// this: r20
signed int zNPCGoalKJTaunt::Enter(float dt /* r20 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x33D400 -> 0x33D694
        class zNPCKingJelly & kj; // r18
    }
...
// this: r20
signed int zNPCGoalKJSpawnKids::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r23 */) {
    /* anonymous block */ {
        // Range: 0x33D6A0 -> 0x33DAA0
...
// this: r2
signed int zNPCGoalKJSpawnKids::Exit() {
    /* anonymous block */ {
        // Range: 0x33DAA0 -> 0x33DAF8
...
// this: r2
signed int zNPCGoalKJSpawnKids::Enter(float dt /* r29 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x33DB00 -> 0x33DB60
...
// this: r20
signed int zNPCGoalKJBored::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33DB60 -> 0x33DC64
        class zNPCKingJelly & kj; // r16
        class xAnimState * anim; // r2
...
// this: r20
signed int zNPCGoalKJBored::Enter(float dt /* r20 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x33DC80 -> 0x33DF14
        class zNPCKingJelly & kj; // r18
    }
...
// this: r2
void zNPCGoalKJIdle::move(float dt /* r29+0x170 */) {
    /* anonymous block */ {
        // Range: 0x33DF20 -> 0x33E590
        class zNPCKingJelly & kj; // r5
...
// this: r20
signed int zNPCGoalKJIdle::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x33E590 -> 0x33E83C
        class zNPCKingJelly & kj; // r16
        class xAnimState * anim; // r2
...
// this: r2
signed int zNPCGoalKJIdle::Exit() {
    /* anonymous block */ {
        // Range: 0x33E840 -> 0x33E8A0
        class zNPCKingJelly & kj; // r17
    }
...
// this: r19
signed int zNPCGoalKJIdle::Enter(float dt /* r20 */, void * updCtxt /* r18 */) {
    /* anonymous block */ {
        // Range: 0x33E8A0 -> 0x33EA68
        class zNPCKingJelly & kj; // r16
    }
...
// this: r2
void zNPCKingJelly::update_blink(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x33EA70 -> 0x33EC00
        float max_delay; // r2
        float ii; // r4
...
// this: r2
void zNPCKingJelly::update_charge(float frac /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x33EC00 -> 0x33F5C4
...
// this: r2
void zNPCKingJelly::update_spawn_particles(float dt /* r29+0x40 */) {
    /* anonymous block */ {
        // Range: 0x33FC80 -> 0x33FDF4
        float & amount; // r5
        float accel; // r4
...
// this: r16
void zNPCKingJelly::update_rings(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x340150 -> 0x340304
...
// this: r22
void zNPCKingJelly::refresh_tentacle_points(signed int which /* r2 */) {
    /* anonymous block */ {
        // Range: 0x340310 -> 0x34048C
        signed int j; // r21
        signed int j; // r12
...
// this: r16
void zNPCKingJelly::update_tentacle_lightning(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x340790 -> 0x340A28
        signed int i; // r20
...
// this: r2
unsigned char zNPCKingJelly::apply_ambient_damage() {
    /* anonymous block */ {
        // Range: 0x341150 -> 0x3413D4
...
// this: r2
unsigned char zNPCKingJelly::apply_wave_damage() {
    /* anonymous block */ {
        // Range: 0x3413E0 -> 0x341674
...
// this: r22
unsigned char zNPCKingJelly::apply_tentacle_damage() {
    /* anonymous block */ {
        // Range: 0x341680 -> 0x341B00
...
// this: r21
void zNPCKingJelly::spawn_children(signed int wave /* r2 */, signed int count /* r20 */) {
    /* anonymous block */ {
        // Range: 0x342090 -> 0x342374
...
// this: r18
void zNPCKingJelly::add_child(class xBase & child /* r17 */, signed int wave /* r16 */) {
    /* anonymous block */ {
        // Range: 0x342380 -> 0x3424A8
        unsigned int i; // r20
...
// this: r17
void zNPCKingJelly::set_life(signed int life /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3424B0 -> 0x3425F8
...
// this: r17
void zNPCKingJelly::Damage(enum en_NPC_DAMAGE_TYPE damtype /* r16 */) {
    /* anonymous block */ {
        // Range: 0x342730 -> 0x34282C
        signed int state; // r2
    }
...
// this: r2
signed int zNPCKingJelly::SysEvent(class xBase * from /* r2 */, class xBase * to /* r2 */, unsigned int toEvent /* r2 */, float * toParam /* r2 */, class xBase * toParamWidget /* r2 */, signed int * handled /* r2 */) {
    /* anonymous block */ {
        // Range: 0x348660 -> 0x3486E4
    }
}
...
// this: r2
void zNPCKingJelly::BUpdate(class xVec3 * pos /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3486F0 -> 0x348770
...
// this: r22
void zNPCKingJelly::Process(class xScene * xscn /* r21 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x348770 -> 0x348B44
        class xEnt * tub; // r2
        class xVec3 & vel; // r2
...
// this: r16
void zNPCKingJelly::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x349120 -> 0x34916C
    }
}
...
// this: r22
zNPCKingJelly::zNPCKingJelly(signed int myType /* r2 */) {
    /* anonymous block */ {
        // Range: 0x349170 -> 0x3492B0
    }
}
