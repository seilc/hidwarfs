...
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalBossPatFudge::__vtable; // size: 0x34, address: 0x50DBE0
...
// total size: 0x34
struct /* @anon10 */ {} zNPCGoalBossPatSpin::__vtable; // size: 0x34, address: 0x50DC20
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalBossPatSpawn::__vtable; // size: 0x34, address: 0x50DC60
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalBossPatFreeze::__vtable; // size: 0x34, address: 0x50DCA0
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalBossPatSmack::__vtable; // size: 0x34, address: 0x50DCE0
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalBossPatRun::__vtable; // size: 0x34, address: 0x50DD20
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalBossPatSpit::__vtable; // size: 0x34, address: 0x50DD60
// total size: 0x34
struct /* @anon9 */ {} zNPCGoalBossPatHit::__vtable; // size: 0x34, address: 0x50DDA0
// total size: 0x34
struct /* @anon6 */ {} zNPCGoalBossPatTaunt::__vtable; // size: 0x34, address: 0x50DDE0
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalBossPatIdle::__vtable; // size: 0x34, address: 0x50DE20
// total size: 0xD8
struct /* @anon7 */ {} zNPCBPatrick::__vtable; // size: 0xD8, address: 0x50DE60
// total size: 0x40
class RwMatrixTag {
    // Members
public:
...
// this: r17
signed int zNPCGoalBossPatFudge::Process(enum en_trantype * trantype /* r29+0xBC */, float dt /* r20 */, void * updCtxt /* r29+0xB8 */, class xScene * xscn /* r29+0xB4 */) {
    /* anonymous block */ {
        // Range: 0x36E640 -> 0x36F208
...
// this: r17
signed int zNPCGoalBossPatFudge::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x36F210 -> 0x36F288
...
// this: r2
signed int zNPCGoalBossPatSpin::Exit() {
    /* anonymous block */ {
        // Range: 0x36F290 -> 0x36F2C0
        class zNPCBPatrick * pat; // r2
    }
...
// this: r17
signed int zNPCGoalBossPatSpin::Process(enum en_trantype * trantype /* r29+0xCC */, float dt /* r24 */, void * updCtxt /* r29+0xC8 */, class xScene * xscn /* r29+0xC4 */) {
    /* anonymous block */ {
        // Range: 0x36F2C0 -> 0x3706DC
        class zNPCBPatrick * pat; // r16
...
// this: r20
signed int zNPCGoalBossPatSpin::Enter(float dt /* r22 */, void * updCtxt /* r19 */) {
    /* anonymous block */ {
        // Range: 0x3706E0 -> 0x370B58
...
// this: r21
signed int zNPCGoalBossPatSpawn::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r19 */, class xScene * xscn /* r18 */) {
    /* anonymous block */ {
        // Range: 0x370B60 -> 0x370D40
        signed int i; // r4
...
// this: r17
signed int zNPCGoalBossPatSpawn::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x370D40 -> 0x370DA4
        class zNPCBPatrick * pat; // r2
    }
...
// this: r20
signed int zNPCGoalBossPatFreeze::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r21 */) {
    /* anonymous block */ {
        // Range: 0x370DB0 -> 0x37108C
        class zNPCBPatrick * pat; // r17
...
// this: r17
signed int zNPCGoalBossPatFreeze::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x371090 -> 0x37115C
        class zNPCBPatrick * pat; // r18
    }
...
// this: r21
signed int zNPCGoalBossPatSmack::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r22 */, class xScene * xscn /* r23 */) {
    /* anonymous block */ {
        // Range: 0x371320 -> 0x371844
        signed int i; // r19
        class zNPCBPatrick * pat; // r18
...
// this: r17
signed int zNPCGoalBossPatSmack::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x371850 -> 0x3718BC
        class zNPCBPatrick * pat; // r2
    }
...
// this: r16
signed int zNPCGoalBossPatRun::Exit() {
    /* anonymous block */ {
        // Range: 0x3718C0 -> 0x3718F0
    }
}
...
// this: r19
signed int zNPCGoalBossPatRun::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3718F0 -> 0x371968
    }
}
...
// this: r18
signed int zNPCGoalBossPatRun::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x371970 -> 0x371A24
        class zNPCBPatrick * pat; // r16
    }
...
// this: r21
signed int zNPCGoalBossPatSpit::Process(enum en_trantype * trantype /* r20 */, float dt /* r20 */, void * updCtxt /* r19 */, class xScene * xscn /* r18 */) {
    /* anonymous block */ {
        // Range: 0x371A30 -> 0x3720B4
        class zNPCBPatrick * pat; // r17
        float leadTime; // r21
...
// this: r17
signed int zNPCGoalBossPatSpit::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3720C0 -> 0x372134
        class zNPCBPatrick * pat; // r2
    }
...
// this: r2
signed int zNPCGoalBossPatHit::Exit() {
    /* anonymous block */ {
        // Range: 0x372140 -> 0x3721C0
    }
}
...
// this: r19
signed int zNPCGoalBossPatHit::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3721C0 -> 0x372260
        class zNPCBPatrick * pat; // r2
    }
...
// this: r18
signed int zNPCGoalBossPatHit::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x372260 -> 0x372424
        class zNPCBPatrick * pat; // r16
    }
...
// this: r19
signed int zNPCGoalBossPatTaunt::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x372430 -> 0x3724D0
        class zNPCBPatrick * pat; // r2
    }
...
// this: r18
signed int zNPCGoalBossPatTaunt::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3724D0 -> 0x372724
        class zNPCBPatrick * pat; // r16
    }
...
// this: r19
signed int zNPCGoalBossPatIdle::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x372730 -> 0x3727D0
        class zNPCBPatrick * pat; // r2
    }
...
// this: r17
signed int zNPCGoalBossPatIdle::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3727D0 -> 0x37283C
        class zNPCBPatrick * pat; // r2
    }
...
// this: r17
void zNPCBPatrick::bossPatBoxUpdate(class bossPatBox * bx /* r16 */, float dt /* r29+0x30 */) {
    /* anonymous block */ {
        // Range: 0x3734A0 -> 0x3737B0
    }
}
...
// this: r2
void zNPCBPatrick::ParabolaHitsConveyors(class xParabola * path /* r2 */, class xCollis * colls /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3737B0 -> 0x3739F8
        signed int i; // r13
        signed int j; // r12
...
// this: r16
void zNPCBPatrick::gotoRound(signed int num /* r2 */) {
    /* anonymous block */ {
        // Range: 0x373C30 -> 0x373DF0
    }
}
...
// this: r2
unsigned int zNPCBPatrick::canSpawnChucks() {
    /* anonymous block */ {
        // Range: 0x373DF0 -> 0x373E30
...
// this: r2
void zNPCBPatrick::playSplat(class xVec3 * pos /* r16 */) {
    /* anonymous block */ {
        // Range: 0x373E30 -> 0x3740C8
        float picker; // r2
    }
...
// this: r17
signed int zNPCBPatrick::nextGoal() {
    /* anonymous block */ {
        // Range: 0x3740D0 -> 0x3742F4
        signed int nextgoal; // r16
    }
...
// this: r22
void zNPCBPatrick::NewTime(class xScene * xscn /* r21 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x374300 -> 0x374430
        signed int i; // r20
    }
...
// this: r16
void zNPCBPatrick::Damage(enum en_NPC_DAMAGE_TYPE dmg_type /* r2 */, class xVec3 * vec_hit /* r2 */) {
    /* anonymous block */ {
        // Range: 0x374EA0 -> 0x3750D8
...
// this: r2
void zNPCBPatrick::DuploNotice(enum en_SM_NOTICES note /* r2 */, void * data /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3750E0 -> 0x375120
...
// this: r16
void zNPCBPatrick::Process(class xScene * xscn /* r29+0xEC */, float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x375120 -> 0x376E60
        signed int i; // r5
        signed int j; // r21
...
// this: r21
void zNPCBPatrick::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x377C40 -> 0x377E8C
        signed int i; // r20
        class xEnt * ent; // r19
