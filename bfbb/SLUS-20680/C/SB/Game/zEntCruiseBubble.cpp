...
// total size: 0x1C
struct /* @anon0 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_camera_restore::__vtable; // size: 0x1C, address: 0x508E60
// total size: 0x1C
struct /* @anon5 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_type::__vtable; // size: 0x1C, address: 0x0
// total size: 0x1C
struct /* @anon6 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_camera_survey::__vtable; // size: 0x1C, address: 0x508E80
// total size: 0x1C
struct /* @anon1 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_camera_attach::__vtable; // size: 0x1C, address: 0x508EA0
// total size: 0x1C
struct /* @anon9 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_camera_seize::__vtable; // size: 0x1C, address: 0x508EC0
// total size: 0x1C
struct /* @anon10 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_camera_aim::__vtable; // size: 0x1C, address: 0x508EE0
// total size: 0x1C
struct /* @anon3 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_missle_explode::__vtable; // size: 0x1C, address: 0x508F00
// total size: 0x1C
struct /* @anon7 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_missle_fly::__vtable; // size: 0x1C, address: 0x508F20
// total size: 0x1C
struct /* @anon2 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_missle_appear::__vtable; // size: 0x1C, address: 0x508F40
// total size: 0x1C
struct /* @anon4 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_player_wait::__vtable; // size: 0x1C, address: 0x508F60
// total size: 0x1C
struct /* @anon8 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_player_fire::__vtable; // size: 0x1C, address: 0x508F80
// total size: 0x1C
struct /* @anon11 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_player_aim::__vtable; // size: 0x1C, address: 0x508FA0
// total size: 0x1C
struct /* @anon12 */ {} cruise_bubble::@unnamed@zEntCruiseBubble_cpp@::state_player_halt::__vtable; // size: 0x1C, address: 0x508FC0
...
// this: r2
static void state_camera_restore::start() {
    /* anonymous block */ {
        // Range: 0x2A7A80 -> 0x2A7BDC
...
// this: r2
static enum state_enum state_camera_restore::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2A7C50 -> 0x2A7C7C
    }
}
...
// this: r16
static void state_camera_survey::start() {
    /* anonymous block */ {
        // Range: 0x2A7C80 -> 0x2A7F0C
    }
}
...
// this: r2
static void state_camera_survey::eval_missle_path(float dist /* r29 */, class xVec3 & loc /* r2 */, float & roll /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2A7FE0 -> 0x2A81B0
        signed int i; // r3
...
// this: r16
static enum state_enum state_camera_survey::update(float dt /* r29+0x90 */) {
    /* anonymous block */ {
        // Range: 0x2A8340 -> 0x2A856C
    }
}
...
// this: r17
static enum state_enum state_camera_attach::update() {
    /* anonymous block */ {
        // Range: 0x2A8660 -> 0x2A8720
    }
}
...
// this: r16
static void state_camera_seize::start() {
    /* anonymous block */ {
        // Range: 0x2A8960 -> 0x2A89E0
    }
}
...
// this: r16
static enum state_enum state_camera_seize::update(float dt /* r29+0x110 */) {
    /* anonymous block */ {
        // Range: 0x2A8A30 -> 0x2A8ECC
        float time_frac; // r2
        float s; // r20
...
// this: r18
static void state_camera_aim::start() {
    /* anonymous block */ {
        // Range: 0x2A8ED0 -> 0x2A90F8
...
// this: r17
static enum state_enum state_camera_aim::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2A9130 -> 0x2A97C4
...
// this: r2
static void state_missle_explode::start() {
    /* anonymous block */ {
        // Range: 0x2A9880 -> 0x2A9C30
        float min_dist; // r21
    }
...
// this: r2
static enum state_enum state_missle_explode::update(float dt /* r29+0x80 */) {
    /* anonymous block */ {
        // Range: 0x2AA4A0 -> 0x2AA5A4
    }
}
...
// this: r17
static void state_missle_fly::start() {
    /* anonymous block */ {
        // Range: 0x2AA5B0 -> 0x2AA878
    }
}
...
// this: r16
static enum state_enum state_missle_fly::update(float dt /* r25 */) {
    /* anonymous block */ {
        // Range: 0x2AAA20 -> 0x2AB418
...
// this: r4
static unsigned char state_missle_fly::hit_test(class xVec3 & hit_loc /* r20 */, class xVec3 & hit_norm /* r19 */, class xVec3 & hit_depen /* r18 */, class xEnt * & hit_ent /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2AB610 -> 0x2AB8C4
        class xScene & s; // r16
        class xVec3 & loc; // r21
...
// this: r2
static void state_player_fire::start() {
    /* anonymous block */ {
        // Range: 0x2ABC60 -> 0x2ABE84
    }
}
...
// this: r2
static enum state_enum state_player_fire::update(float dt /* r29 */) {
    /* anonymous block */ {
        // Range: 0x2ABEB0 -> 0x2ABF38
...
// this: r16
static void state_player_aim::start() {
    /* anonymous block */ {
        // Range: 0x2ABF40 -> 0x2AC000
...
// this: r16
static enum state_enum state_player_aim::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2AC020 -> 0x2AC2FC
    }
}
...
// this: r2
static void state_player_halt::start() {
    /* anonymous block */ {
        // Range: 0x2AC300 -> 0x2AC30C
    }
}
...
// this: r2
static enum state_enum state_player_halt::update(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x2AC330 -> 0x2AC448
