/*
    Compile unit: C:\SB\Game\zNPCGoalAmbient.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalJellyBirth::__vtable; // size: 0x34, address: 0x50E330
class xVec3 g_NY3; // size: 0xC, address: 0x4F8DC0
class zGlobals globals; // size: 0x2050, address: 0x52C8F0
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalCommon::__vtable; // size: 0x34, address: 0x50A340
// total size: 0x2C
struct /* @anon3 */ {} xGoal::__vtable; // size: 0x2C, address: 0x50BE00
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalJellyAttack::__vtable; // size: 0x34, address: 0x50E370
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalPushAnim::__vtable; // size: 0x34, address: 0x50A180
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalJellyBumped::__vtable; // size: 0x34, address: 0x50E3B0
// total size: 0x70
class RpAtomic {
    // Members
public:
...
class zNPCGoalJellyBumped : public zNPCGoalPushAnim {
    // Members
public:
    class xVec3 pos_bumper; // offset 0x54, size 0xC
    class xVec3 pos_bumpin; // offset 0x60, size 0xC
    class xVec3 pos_grindin; // offset 0x6C, size 0xC
    unsigned int streakID; // offset 0x78, size 0x4
};
// total size: 0x14
class xGridBound {
    // Members
...
public:
    ...
    class zLightning * zap_lytnin[3]; // offset 0x58, size 0xC
};
// total size: 0xC
class xListItem {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BDE00 -> 0x003BDE2C
*/
// Range: 0x3BDE00 -> 0x3BDE2C
// this: r2
void zNPCGoalJellyBirth::BirthInfoSet(class xVec3 * pos_birth /* r2 */, float tym_fall /* r29 */) {
    /* anonymous block */ {
        // Range: 0x3BDE00 -> 0x3BDE2C
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BDE30 -> 0x003BE024
*/
// Range: 0x3BDE30 -> 0x3BE024
// this: r20
signed int zNPCGoalJellyBirth::Process(enum en_trantype * trantyp /* r19 */, float dt /* r20 */, void * ctxt /* r18 */, class xScene * xscn /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BDE30 -> 0x3BE024
        signed int nextgoal; // r2
        class zNPCJelly * npc; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE030 -> 0x003BE0E8
*/
// Range: 0x3BE030 -> 0x3BE0E8
// this: r18
signed int zNPCGoalJellyBirth::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BE030 -> 0x3BE0E8
        class zNPCJelly * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE0F0 -> 0x003BE6C4
*/
// Range: 0x3BE0F0 -> 0x3BE6C4
// this: r16
void zNPCGoalJellyAttack::ZapperUpdate() {
    /* anonymous block */ {
        ...
        float tym_ancur; // r20
        class xVec3 pos_bone; // r29+0x140
        signed int i; // r21
        signed int idx_tgtBone; // r2
        class xVec3 pos_tgt; // r29+0x130
        class xVec3 pos_plyr; // r29+0x120
        signed int i; // r21
        class xVec3 pos_tgt; // r29+0x110
        class xVec3 wt_tgt; // @ 0x00507428
        float tym_attackOn[2]; // @ 0x00507438
        signed int idx_fromBone; // @ 0x0050F164
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE6D0 -> 0x003BE86C
*/
// Range: 0x3BE6D0 -> 0x3BE86C
// this: r18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE870 -> 0x003BE8DC
*/
// Range: 0x3BE870 -> 0x3BE8DC
// this: r19
signed int zNPCGoalJellyAttack::Process(enum en_trantype * trantype /* r18 */, float dt /* r20 */, void * updCtxt /* r17 */, class xScene * xscn /* r16 */) {
    /* anonymous block */ {
        // Range: 0x3BE870 -> 0x3BE8DC
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE8E0 -> 0x003BE974
*/
// Range: 0x3BE8E0 -> 0x3BE974
// this: r19
signed int zNPCGoalJellyAttack::Exit(float dt /* r20 */, void * updCtxt /* r18 */) {
    /* anonymous block */ {
        // Range: 0x3BE8E0 -> 0x3BE974
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BE980 -> 0x003BE9F8
*/
// Range: 0x3BE980 -> 0x3BE9F8
// this: r18
signed int zNPCGoalJellyAttack::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BE980 -> 0x3BE9F8
        class zNPCJelly * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BEA00 -> 0x003BEC48
*/
// Range: 0x3BEA00 -> 0x3BEC48
// this: r2
float zNPCGoalJellyBumped::CalcEndPoint(class xVec3 * pos_end /* r18 */, class xVec3 * dir_aim /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BEA00 -> 0x3BEC48
        float dst_toEndPnt; // r29+0x110
        class zNPCJelly * npc; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BEC50 -> 0x003BEDC0
*/
// Range: 0x3BEC50 -> 0x3BEDC0
// this: r2
void zNPCGoalJellyBumped::ExtractAimDir(class xVec3 * dir_aim /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3BEC50 -> 0x3BEDC0
        class zNPCJelly * npc; // r6
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BEDC0 -> 0x003BF138
*/
// Range: 0x3BEDC0 -> 0x3BF138
// this: r20
signed int zNPCGoalJellyBumped::Process(enum en_trantype * trantype /* r19 */, float dt /* r20 */, void * updCtxt /* r18 */, class xScene * xscn /* r22 */) {
    /* anonymous block */ {
        // Range: 0x3BEDC0 -> 0x3BF138
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BF140 -> 0x003BF1C4
*/
// Range: 0x3BF140 -> 0x3BF1C4
// this: r18
signed int zNPCGoalJellyBumped::Exit(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BF140 -> 0x3BF1C4
        class zNPCJelly * npc; // r16
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BF1D0 -> 0x003BF2CC
*/
// Range: 0x3BF1D0 -> 0x3BF2CC
// this: r18
signed int zNPCGoalJellyBumped::Enter(float dt /* r20 */, void * updCtxt /* r17 */) {
    /* anonymous block */ {
        // Range: 0x3BF1D0 -> 0x3BF2CC
        class zNPCJelly * npc; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x003BF2D0 -> 0x003BF4C8
*/
// Range: 0x3BF2D0 -> 0x3BF4C8
class xFactoryInst * GOALCreate_Ambient(signed int who /* r16 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x3BF2D0 -> 0x3BF4C8
        class xGoal * goal; // r2
    }
