/*
    Compile unit: C:\SB\Game\zNPCTypeVillager.cpp
...
// total size: 0xD0
struct /* @anon10 */ {} zNPCBubbleBuddy::__vtable; // size: 0xD0, address: 0x50B760
...
class NPCSndTrax g_sndTrax_VillagerElder[]; // size: 0x0, address: 0x5CF9C8
class NPCSndTrax g_sndTrax_VillagerFemale[]; // size: 0x0, address: 0x5CF9B8
class NPCSndTrax g_sndTrax_VillagerMale[]; // size: 0x0, address: 0x5CF9A8
class NPCSndTrax g_sndTrax_Squidward[]; // size: 0x0, address: 0x4DFEC0
...
// total size: 0x10
struct /* @anon1 */ {} HiThere::__vtable; // size: 0x10, address: 0x50B900
// total size: 0x10
struct /* @anon9 */ {} ztaskbox::callback::__vtable; // size: 0x10, address: 0x50B910
// total size: 0xD0
struct /* @anon5 */ {} zNPCVillager::__vtable; // size: 0xD0, address: 0x50BD30
// total size: 0xCC
struct /* @anon6 */ {} zNPCCommon::__vtable; // size: 0xCC, address: 0x50A6C0
// total size: 0x54
struct /* @anon8 */ {} xNPCBasic::__vtable; // size: 0x54, address: 0x50BE30
// total size: 0xD0
struct /* @anon4 */ {} zNPCNewsFishTV::__vtable; // size: 0xD0, address: 0x50B830
// total size: 0xD0
struct /* @anon7 */ {} zNPCNewsFish::__vtable; // size: 0xD0, address: 0x50BAC0
// total size: 0xD0
struct /* @anon2 */ {} zNPCMerManChair::__vtable; // size: 0xD0, address: 0x50BB90
// total size: 0xD0
struct /* @anon3 */ {} zNPCSandyBikini::__vtable; // size: 0xD0, address: 0x50B9F0
// total size: 0xD0
struct /* @anon11 */ {} zNPCBalloonBoy::__vtable; // size: 0xD0, address: 0x50B920
// total size: 0xD0
struct /* @anon0 */ {} zNPCFish::__vtable; // size: 0xD0, address: 0x50BC60
// total size: 0x40
class RwMatrixTag {
    // Members
public:
...
void zNPCBubbleBuddy::RenderExtra() {
    /* anonymous block */ {
        // Range: 0x2EB2D0 -> 0x2EB358
        enum RwCullMode old_cull_mode; // r29+0x2C
    }
}
...
// this: r16
void zNPCBubbleBuddy::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EB480 -> 0x2EB530
    }
}
...
// this: r2
void zNPCBalloonBoy::PlatAnimSet(enum en_BBOY_PLATANIM platanim /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EB540 -> 0x2EB5A4
        float fvals[4]; // r29+0x10
    }
}
...
// this: r2
signed int zNPCBalloonBoy::ParseSysEvent(class NPCSysEvent * sed /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EB5B0 -> 0x2EB72C
...
// this: r18
signed int zNPCBalloonBoy::FolkHandleMail(class NPCMsg * mail /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2EB730 -> 0x2EB810
...
// this: r2
unsigned int zNPCBalloonBoy::AnimPick(signed int gid /* r2 */, enum en_NPC_GOAL_SPOT gspot /* r2 */, class xGoal * rawgoal /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EB810 -> 0x2EB968
        signed int idx; // r16
...
void zNPCBalloonBoy::PlatShadRend() {
    /* anonymous block */ {
        // Range: 0x2EB970 -> 0x2EBC18
        float ds2_cam; // r20
        signed int fillit; // r16
        signed int needit; // r4
        class xMat4x3 mat_fake; // r29+0x40
        signed int takeThePain; // @ 0x0050FF80
    }
}
...
// this: r16
void zNPCBalloonBoy::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EBD30 -> 0x2EBDCC
    }
}
...
// this: r18
void zNPCSandyBikini::VFXLeakyFaucet(float dt /* r23 */) {
    /* anonymous block */ {
        // Range: 0x2EBDD0 -> 0x2EC0B4
        float rat_tym; // r22
        ...
        float dist; // r24
        class xVec3 vec_boneOffset; // @ 0x004FEF58
    }
}
...
// this: r17
void zNPCSandyBikini::Process(class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2EC0C0 -> 0x2EC12C
    }
}
...
// this: r22
signed int zNPCNewsFish::say(enum say_enum * s /* r21 */, unsigned int size /* r2 */, signed int flags /* r23 */, signed int max_say /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EC1E0 -> 0x2EC430
...
// this: r18
unsigned char zNPCNewsFish::say(enum say_enum s /* r2 */, signed int flags /* r17 */) {
    /* anonymous block */ {
        // Range: 0x2EC430 -> 0x2EC568
        unsigned int id; // r16
    }
...
// this: r2
void zNPCNewsFish::TalkOnScreen(signed int talkOnScreen /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EC780 -> 0x2EC7B0
    }
}
...
// this: r18
void zNPCNewsFish::SpeakStart(unsigned int sndid /* r17 */, unsigned int sndhandle /* r16 */) {
    /* anonymous block */ {
        // Range: 0x2EC820 -> 0x2EC910
    }
}
...
// this: r16
void zNPCNewsFish::Process(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2ECA10 -> 0x2ECD5C
...
// this: r16
void zNPCNewsFish::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2ECD80 -> 0x2ECE5C
        signed int i; // r19
    }
...
// this: r16
void zNPCMerManChair::Process(float dt /* r29+0x20 */) {
    /* anonymous block */ {
        // Range: 0x2ECE60 -> 0x2ECED0
...
// this: r18
unsigned int zNPCMerManChair::AnimPick(signed int gid /* r2 */, enum en_NPC_GOAL_SPOT gspot /* r2 */, class xGoal * rawgoal /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2ECED0 -> 0x2ED0A4
        signed int idx; // r17
        unsigned int da_anim; // r16
        signed int superfolk; // r3
        unsigned int which; // r3
        signed int choices[4]; // @ 0x004DF670
    }
}
...
// this: r16
void zNPCMerManChair::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2ED280 -> 0x2ED2D4
    }
}
...
// this: r19
signed int zNPCFish::FolkHandleMail(class NPCMsg * msg /* r18 */) {
    /* anonymous block */ {
        // Range: 0x2ED4D0 -> 0x2ED670
...
// this: r17
void zNPCFish::Process(class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2ED670 -> 0x2ED770
    }
}
...
// this: r2
unsigned int zNPCFish::AnimPick(signed int gid /* r2 */, enum en_NPC_GOAL_SPOT gspot /* r2 */, class xGoal * rawgoal /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2ED770 -> 0x2ED8D0
        signed int idx; // r16
        unsigned int da_anim; // r2
...
// this: r16
void zNPCFish::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EDDA0 -> 0x2EDE2C
    }
}
...
// this: r2
signed int zNPCVillager::PlayerIsStaring() {
    /* anonymous block */ {
        // Range: 0x2EDFD0 -> 0x2EE120
        class xVec3 vec; // r29+0x10
        float dy; // r29+0x1C
    }
}
...
// this: r2
void zNPCVillager::SpeakStart(unsigned int sndid /* r17 */, signed int anim /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EE180 -> 0x2EE214
...
// this: r2
signed int zNPCVillager::FolkHandleMail(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EE290 -> 0x2EE390
        signed int handled; // r17
    }
...
// this: r19
signed int zNPCVillager::NPCMessage(class NPCMsg * mail /* r18 */) {
    /* anonymous block */ {
        // Range: 0x2EE390 -> 0x2EE474
...
// this: r17
unsigned int zNPCVillager::AnimPick(signed int gid /* r2 */, enum en_NPC_GOAL_SPOT gspot /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EE480 -> 0x2EE848
        signed int idx; // r2
        unsigned int da_anim; // r16
        signed int superfolk; // r2
        signed int superfolk; // r4
        signed int choices[4]; // r29+0x40
        signed int superfolk; // r4
        signed int choices[4]; // r29+0x30
        signed int superfolk; // r2
        unsigned int which; // r3
        signed int choices[4]; // @ 0x004DF640
        signed int choices[4]; // @ 0x004DF610
    }
}
...
// this: r17
void zNPCVillager::Process(class xScene * xscn /* r16 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x2EEB90 -> 0x2EEBF0
    }
}
...
// this: r16
void zNPCVillager::Init(class xEntAsset * asset /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2EEDF0 -> 0x2EEE20
    }
}
...
// this: r2
unsigned char zNPCVillager::PhysicsFlags() {
    /* anonymous block */ {
        // Range: 0x2EEE20 -> 0x2EEE68
        signed int flags; // r4
    }
...
// this: r2
unsigned char zNPCVillager::ColPenFlags() {
    /* anonymous block */ {
        // Range: 0x2EEE70 -> 0x2EEED8
        signed int flags; // r5
    }
...
// this: r2
unsigned char zNPCVillager::ColChkFlags() {
    /* anonymous block */ {
        // Range: 0x2EEEE0 -> 0x2EEF48
        signed int flags; // r5
    }
