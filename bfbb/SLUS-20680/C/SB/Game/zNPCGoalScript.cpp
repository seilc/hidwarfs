/*
    Compile unit: C:\SB\Game\zNPCGoalScript.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
// total size: 0x34
struct /* @anon3 */ {} zNPCGoalScript::__vtable; // size: 0x34, address: 0x50C0A0
// total size: 0x34
struct /* @anon2 */ {} zNPCGoalScriptWait::__vtable; // size: 0x34, address: 0x50C0E0
// total size: 0x34
struct /* @anon1 */ {} zNPCGoalCommon::__vtable; // size: 0x34, address: 0x50A340
// total size: 0x2C
struct /* @anon6 */ {} xGoal::__vtable; // size: 0x2C, address: 0x50BE00
// total size: 0x34
struct /* @anon8 */ {} zNPCGoalScriptLead::__vtable; // size: 0x34, address: 0x50C120
// total size: 0x34
struct /* @anon5 */ {} zNPCGoalScriptFollow::__vtable; // size: 0x34, address: 0x50C160
// total size: 0x34
struct /* @anon7 */ {} zNPCGoalScriptTalk::__vtable; // size: 0x34, address: 0x50C1A0
// total size: 0x34
struct /* @anon4 */ {} zNPCGoalScriptMove::__vtable; // size: 0x34, address: 0x50C1E0
// total size: 0x34
struct /* @anon0 */ {} zNPCGoalScriptAttack::__vtable; // size: 0x34, address: 0x50C220
// total size: 0x34
struct /* @anon9 */ {} zNPCGoalScriptAnim::__vtable; // size: 0x34, address: 0x50C260
// total size: 0x0
...
class zNPCGoalScript : public zNPCGoalCommon {
    // Members
public:
    signed int flg_script; // offset 0x4C, size 0x4
};
// total size: 0x18
class RwBBox {
    // Members
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0030FDC0 -> 0x0030FE4C
*/
// Range: 0x30FDC0 -> 0x30FE4C
// this: r2
signed int zNPCGoalScript::NPCMessage(class NPCMsg * mail /* r2 */) {
    /* anonymous block */ {
        // Range: 0x30FDC0 -> 0x30FE4C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0030FE50 -> 0x0030FE58
*/
// Range: 0x30FE50 -> 0x30FE58
signed int SysEvent() {
    /* anonymous block */ {
        // Range: 0x30FE50 -> 0x30FE58
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0030FE60 -> 0x0030FE68
*/
// Range: 0x30FE60 -> 0x30FE68
signed int Exit() {
    /* anonymous block */ {
        // Range: 0x30FE60 -> 0x30FE68
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0030FE70 -> 0x0030FECC
*/
// Range: 0x30FE70 -> 0x30FECC
// this: r17
signed int zNPCGoalScript::Enter(float dt /* r20 */, void * updCtxt /* r16 */) {
    /* anonymous block */ {
        // Range: 0x30FE70 -> 0x30FECC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0030FED0 -> 0x00310330
*/
// Range: 0x30FED0 -> 0x310330
class xFactoryInst * GOALCreate_Script(signed int who /* r16 */, class RyzMemGrow * grow /* r2 */) {
    /* anonymous block */ {
        // Range: 0x30FED0 -> 0x310330
        class xGoal * goal; // r2
    }
