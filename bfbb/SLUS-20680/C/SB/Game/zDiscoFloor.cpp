...
// this: r2
void z_disco_floor::set_state_delay(float s /* r29 */) {
    /* anonymous block */ {
        // Range: 0x337D40 -> 0x337D48
    }
}
...
// this: r2
void z_disco_floor::set_transition_delay(float s /* r29 */) {
    /* anonymous block */ {
        // Range: 0x337D50 -> 0x337D58
    }
}
...
// this: r17
void z_disco_floor::set_state_range(signed int min /* r19 */, signed int max /* r18 */, unsigned char immediate /* r16 */) {
    /* anonymous block */ {
        // Range: 0x337D60 -> 0x337E54
...
// this: r16
void z_disco_floor::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x3380F0 -> 0x338378
    }
}
...
// this: r2
static void clone_pipe_data::insert_atomic(class xModelInstance * model /* r2 */) {
    /* anonymous block */ {
        // Range: 0x339CC0 -> 0x339E28
