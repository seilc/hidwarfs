/*
    Compile unit: C:\SB\Game\zTalkBox.cpp
...
static class shared_type shared; // size: 0x869C, address: 0x5D5920
unsigned int zero; // size: 0x4, address: 0x510098
unsigned int zero; // size: 0x4, address: 0x0
static class tag_type new_tags[9]; // size: 0xB4, address: 0x4E0460
static unsigned int new_tags_size; // size: 0x4, address: 0x50F094
...
// total size: 0x14
struct /* @anon2 */ {} @unnamed@zTalkBox_cpp@::stop_state_type::__vtable; // size: 0x14, address: 0x50C320
// total size: 0x14
struct /* @anon3 */ {} @unnamed@zTalkBox_cpp@::state_type::__vtable; // size: 0x14, address: 0x0
// total size: 0x14
struct /* @anon4 */ {} @unnamed@zTalkBox_cpp@::wait_state_type::__vtable; // size: 0x14, address: 0x50C340
// total size: 0x14
struct /* @anon1 */ {} @unnamed@zTalkBox_cpp@::next_state_type::__vtable; // size: 0x14, address: 0x50C360
// total size: 0x14
struct /* @anon0 */ {} @unnamed@zTalkBox_cpp@::start_state_type::__vtable; // size: 0x14, address: 0x50C380
...
public:
    ...
    signed int page_end_jot; // offset 0x8524, size 0x4
    class wait_context wait; // offset 0x8528, size 0x10
    class wait_context auto_wait; // offset 0x8538, size 0x10
    unsigned int wait_event_mask; // offset 0x8548, size 0x4
    float prompt_delay; // offset 0x854C, size 0x4
    float quit_delay; // offset 0x8550, size 0x4
    unsigned char prompt_ready; // offset 0x8554, size 0x1
    unsigned char quit_ready; // offset 0x8555, size 0x1
    unsigned char stream_locked[2]; // offset 0x8556, size 0x2
    signed int next_stream; // offset 0x8558, size 0x4
    class sound_queue sounds; // offset 0x855C, size 0x1C
...
void update_all(class xScene & s /* r21 */, float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x31D860 -> 0x31DC08
        enum state_enum newtype; // r16
        enum trigger_pads_enum tp; // r4
    }
}
...
void init() {
    /* anonymous block */ {
        // Range: 0x31DCB0 -> 0x31DE30
        class stop_state_type stop_state; // @ 0x005100C0
        signed char @6594; // @ 0x005100B8
        class wait_state_type wait_state; // @ 0x005DE050
        signed char @6591; // @ 0x005100B4
        class next_state_type next_state; // @ 0x005DE040
        signed char @6588; // @ 0x005100B0
        class start_state_type start_state; // @ 0x005100A8
        signed char @6585; // @ 0x005100A0
    }
}
...
// this: r19
void ztalkbox::MasterTellSlaves(signed int isBeginning /* r18 */) {
    /* anonymous block */ {
        // Range: 0x31DF50 -> 0x31E010
        signed int i; // r17
...
// this: r18
void ztalkbox::start_talk(unsigned int text_id /* r2 */, class callback * cb /* r17 */, class zNPCCommon * npc /* r16 */) {
    /* anonymous block */ {
        // Range: 0x31E0D0 -> 0x31E148
...
// this: r18
void ztalkbox::start_talk(char * s /* r17 */, class callback * cb /* r16 */, class zNPCCommon * npc /* r2 */) {
    /* anonymous block */ {
        // Range: 0x31E150 -> 0x31E654
...
// this: r16
void ztalkbox::set_text(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x31E660 -> 0x31E6B8
        class xTextAsset * ta; // r2
    }
...
// this: r17
void ztalkbox::set_text(char * s /* r2 */) {
    /* anonymous block */ {
        // Range: 0x31E6C0 -> 0x31E88C
        class ztextbox & d; // r16
    }
...
static unsigned char read_bool(class substr & s /* r18 */, unsigned char def /* r2 */) {
    /* anonymous block */ {
        ...
        unsigned int i; // r17
        unsigned int i; // r17
        class substr positive[6]; // @ 0x00500950
        class substr negative[6]; // @ 0x00500980
    }
}
...
// this: r16
static enum state_enum wait_state_type::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x321FA0 -> 0x322388
    }
}
