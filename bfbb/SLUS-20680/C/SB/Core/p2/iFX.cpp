/*
    Compile unit: C:\SB\Core\p2\iFX.cpp
...
unsigned long gs_alpha_2; // size: 0x4, address: 0x50E7F0
signed int RpAtomicPS2AllObjectSetupCallBack(class RxPS2AllPipeData *, class RwMatrixTag * *); // size: 0x0, address: 0x237FC8
signed int iFXanimUVBridgeCallBack(class RxPS2AllPipeData *); // size: 0x0, address: 0x1AA6A0
...
signed long FXanimUVPRS; // size: 0x4, address: 0x3D7300
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AA3F0 -> 0x001AA4B8
*/
// Range: 0x1AA3F0 -> 0x1AA4B8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AA4C0 -> 0x001AA6A0
*/
// Range: 0x1AA4C0 -> 0x1AA6A0
static class RxPipeline * iFXanimUVCreateMaterialPipe() {
    /* anonymous block */ {
        // Range: 0x1AA4C0 -> 0x1AA6A0
        class RxPipeline * newPipe; // r2
        ...
        class RxPipelineNode * plNode; // r17
        void * VUCodeArray[32]; // @ 0x00416D60
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001AA6A0 -> 0x001AAF34
*/
// Range: 0x1AA6A0 -> 0x1AAF34
static signed int iFXanimUVBridgeCallBack(class RxPS2AllPipeData * ps2AllPipeData /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1AA6A0 -> 0x1AAF34
        unsigned int numInitialQW; // r17
        unsigned int numUserInitialQW; // r2
        unsigned int numExtraQW; // r3
        unsigned int prim; // r3
        unsigned int primSwitch; // r2
        unsigned int fogSwitch; // r12
        class RwRaster * customRaster; // r17
        unsigned long tmp; // r3
        unsigned long tmp1; // r11
        __int128 ltmp; // r12
        ...
        __int128 ltmp; // r3
        __int128 ___ltmp; // r2
        __int128 * _rwDMA_local_rwDMAPktPtr; // r10
        __int128 ___ltmp; // r2
        __int128 ___ltmp; // r2
        __int128 ___ltmp; // r2
        __int128 ___ltmp; // r2
