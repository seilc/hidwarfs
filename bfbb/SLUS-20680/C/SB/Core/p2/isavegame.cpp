/*
    Compile unit: C:\SB\Core\p2\isavegame.cpp
    Producer: MW MIPS C Compiler
    Language: C++
*/
static char * g_scoobydoo_icon_list; // size: 0x4, address: 0x50F83C
signed int gIconSize; // size: 0x4, address: 0x50F840
static char * g_scoobydoo_icon_copy; // size: 0x4, address: 0x50F844
static char * g_scoobydoo_icon_delete; // size: 0x4, address: 0x50F848
static signed int g_isginit; // size: 0x4, address: 0x50F84C
static class st_ISG_MEMCARD_DATA g_mcdata_MAIN; // size: 0x100, address: 0x538E00
static class st_ISGSESSION g_isgdata_MAIN; // size: 0x9C, address: 0x538F00
static class st_ISG_MEMCARD_DATA g_mcdata_MONITOR; // size: 0x100, address: 0x538FC0
static class st_ISGSESSION g_isgdata_MONITOR; // size: 0x9C, address: 0x5390C0
static char * g_isg_scemodule[3]; // size: 0xC, address: 0x416E50
static char * g_strz_egotrip[8]; // size: 0x20, address: 0x416E60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3230 -> 0x001B329C
*/
// Range: 0x1B3230 -> 0x1B329C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B32A0 -> 0x001B33B0
*/
// Range: 0x1B32A0 -> 0x1B33B0
unsigned char iSGCheckForGameFiles(signed int mcPort /* r16 */) {
    /* anonymous block */ {
        // Range: 0x1B32A0 -> 0x1B33B0
        char fileNames[3][25]; // r29+0x40
        char * gameDir; // r2
        signed int resultCode; // r29+0x8C
        signed int i; // r18
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B33B0 -> 0x001B34D0
*/
// Range: 0x1B33B0 -> 0x1B34D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B34D0 -> 0x001B34DC
*/
// Range: 0x1B34D0 -> 0x1B34DC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B34E0 -> 0x001B34E8
*/
// Range: 0x1B34E0 -> 0x1B34E8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B34F0 -> 0x001B3538
*/
// Range: 0x1B34F0 -> 0x1B3538
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3540 -> 0x001B3A58
*/
// Range: 0x1B3540 -> 0x1B3A58
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3A60 -> 0x001B3BEC
*/
// Range: 0x1B3A60 -> 0x1B3BEC
enum en_ISGMCA_STATUS iSG_mcasync_chkop(class st_ISG_MEMCARD_DATA * mcdata /* r20 */, signed int block /* r19 */, signed int * sync_resval /* r18 */) {
    /* anonymous block */ {
        ...
        signed int rc; // r2
        signed int ret; // r29+0x6C
        signed int mcf; // r29+0x68
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3BF0 -> 0x001B3C60
*/
// Range: 0x1B3BF0 -> 0x1B3C60
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3C60 -> 0x001B3CC8
*/
// Range: 0x1B3C60 -> 0x1B3CC8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3CD0 -> 0x001B3D40
*/
// Range: 0x1B3CD0 -> 0x1B3D40
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3D40 -> 0x001B3DC0
*/
// Range: 0x1B3D40 -> 0x1B3DC0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3DC0 -> 0x001B3E84
*/
// Range: 0x1B3DC0 -> 0x1B3E84
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3E90 -> 0x001B3F80
*/
// Range: 0x1B3E90 -> 0x1B3F80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B3F80 -> 0x001B4194
*/
// Range: 0x1B3F80 -> 0x1B4194
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B41A0 -> 0x001B4338
*/
// Range: 0x1B41A0 -> 0x1B4338
signed int iSG_isSpaceForFile(class st_ISG_MEMCARD_DATA * mcdata /* r22 */, signed int mcidx /* r21 */, signed int fsize /* r20 */, char * dpath /* r2 */, char * fname /* r23 */, signed int * bytesNeeded /* r19 */, signed int * availOnDisk /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1B41A0 -> 0x1B4338
        signed int rc; // r2
        signed int fc_need; // r17
        signed int fEc_need; // r30
        signed int xtra_fent; // r2
        signed int estclust; // r17
        signed int totclust; // r2
        signed int reset_mcpath; // r16
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4340 -> 0x001B43F0
*/
// Range: 0x1B4340 -> 0x1B43F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B43F0 -> 0x001B4498
*/
// Range: 0x1B43F0 -> 0x1B4498
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B44A0 -> 0x001B4560
*/
// Range: 0x1B44A0 -> 0x1B4560
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4560 -> 0x001B4614
*/
// Range: 0x1B4560 -> 0x1B4614
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4620 -> 0x001B46C0
*/
// Range: 0x1B4620 -> 0x1B46C0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B46C0 -> 0x001B486C
*/
// Range: 0x1B46C0 -> 0x1B486C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4870 -> 0x001B4A3C
*/
// Range: 0x1B4870 -> 0x1B4A3C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4A40 -> 0x001B4C18
*/
// Range: 0x1B4A40 -> 0x1B4C18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4C20 -> 0x001B4D7C
*/
// Range: 0x1B4C20 -> 0x1B4D7C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4D80 -> 0x001B4E28
*/
// Range: 0x1B4D80 -> 0x1B4E28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4E30 -> 0x001B4EB0
*/
// Range: 0x1B4E30 -> 0x1B4EB0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4EB0 -> 0x001B4EBC
*/
// Range: 0x1B4EB0 -> 0x1B4EBC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4EC0 -> 0x001B4F80
*/
// Range: 0x1B4EC0 -> 0x1B4F80
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4F80 -> 0x001B4F88
*/
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B4F90 -> 0x001B51D4
*/
// Range: 0x1B4F90 -> 0x1B51D4
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B51E0 -> 0x001B5388
*/
// Range: 0x1B51E0 -> 0x1B5388
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5390 -> 0x001B5660
*/
// Range: 0x1B5390 -> 0x1B5660
signed int iSGReadLeader(class st_ISGSESSION * isgdata /* r22 */, char * fname /* r23 */, char * databuf /* r21 */, signed int numbytes /* r20 */, signed int async /* r30 */) {
    /* anonymous block */ {
        // Range: 0x1B5390 -> 0x1B5660
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5660 -> 0x001B56F0
*/
// Range: 0x1B5660 -> 0x1B56F0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B56F0 -> 0x001B5A18
*/
// Range: 0x1B56F0 -> 0x1B5A18
signed int iSGSaveFile(class st_ISGSESSION * isgdata /* r22 */, char * fname /* r21 */, char * data /* r20 */, signed int n /* r19 */, signed int async /* r30 */) {
    /* anonymous block */ {
        // Range: 0x1B56F0 -> 0x1B5A18
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5A20 -> 0x001B5D40
*/
// Range: 0x1B5A20 -> 0x1B5D40
signed int iSGSetupGameDir(class st_ISGSESSION * isgdata /* r16 */, char * dname /* r2 */, signed int force_iconfix /* r20 */) {
    /* anonymous block */ {
        // Range: 0x1B5A20 -> 0x1B5D40
        signed int result; // r19
        signed int rc; // r2
        class st_ISG_MEMCARD_DATA * mcdata; // r18
        signed int dir_isnew; // r17
        char * strptr; // r2
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5D40 -> 0x001B5E2C
*/
// Range: 0x1B5D40 -> 0x1B5E2C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5E30 -> 0x001B5F90
*/
// Range: 0x1B5E30 -> 0x1B5F90
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5F90 -> 0x001B5FAC
*/
// Range: 0x1B5F90 -> 0x1B5FAC
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B5FB0 -> 0x001B6000
*/
// Range: 0x1B5FB0 -> 0x1B6000
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6000 -> 0x001B6198
*/
// Range: 0x1B6000 -> 0x1B6198
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B61A0 -> 0x001B61A8
*/
// Range: 0x1B61A0 -> 0x1B61A8
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B61B0 -> 0x001B62AC
*/
// Range: 0x1B61B0 -> 0x1B62AC
signed int iSGTgtHaveRoom(class st_ISGSESSION * isgdata /* r22 */, signed int tidx /* r21 */, signed int fsize /* r20 */, char * dpath /* r19 */, char * fname /* r18 */, signed int * bytesNeeded /* r17 */, signed int * availOnDisk /* r23 */) {
    /* anonymous block */ {
        // Range: 0x1B61B0 -> 0x1B62AC
        signed int result; // r2
        signed int i; // r16
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B62B0 -> 0x001B6320
*/
// Range: 0x1B62B0 -> 0x1B6320
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6320 -> 0x001B6454
*/
// Range: 0x1B6320 -> 0x1B6454
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6460 -> 0x001B6578
*/
// Range: 0x1B6460 -> 0x1B6578
signed int iSGTgtFormat(class st_ISGSESSION * isgdata /* r16 */, signed int tgtidx /* r19 */, signed int async /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1B6460 -> 0x1B6578
        signed int result; // r18
        signed int rc; // r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6580 -> 0x001B65D0
*/
// Range: 0x1B6580 -> 0x1B65D0
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B65D0 -> 0x001B6670
*/
// Range: 0x1B65D0 -> 0x1B6670
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6670 -> 0x001B667C
*/
// Range: 0x1B6670 -> 0x1B667C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6680 -> 0x001B6770
*/
// Range: 0x1B6680 -> 0x1B6770
class st_ISGSESSION * iSGSessionBegin(void * cltdata /* r19 */, void (* chgfunc)(void *, enum en_CHGCODE) /* r18 */, signed int monitor /* r17 */) {
    /* anonymous block */ {
        // Range: 0x1B6680 -> 0x1B6770
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6770 -> 0x001B6964
*/
// Range: 0x1B6770 -> 0x1B6964
char * iSGMakeName(enum en_NAMEGEN_TYPE type /* r2 */, char * base /* r2 */, signed int idx /* r2 */) {
    /* anonymous block */ {
        ...
        char * fmt_sd; // r2
        char * fmt_sbd; // r10
        signed int rotate; // @ 0x0050F850
        char rotatebuf[8][32]; // @ 0x00539160
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6970 -> 0x001B6984
*/
// Range: 0x1B6970 -> 0x1B6984
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001B6990 -> 0x001B69C0
*/
// Range: 0x1B6990 -> 0x1B69C0
