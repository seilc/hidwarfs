/*
    Compile unit: C:\SB\Core\x\xMorph.cpp
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2400 -> 0x001F2414
*/
// Range: 0x1F2400 -> 0x1F2414
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2420 -> 0x001F261C
*/
// Range: 0x1F2420 -> 0x1F261C
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x001F2620 -> 0x001F2870
*/
// Range: 0x1F2620 -> 0x1F2870
class xMorphSeqFile * xMorphSeqSetup(void * data /* r2 */, void * (* FindAssetCB)(unsigned int, char *) /* r22 */) {
    /* anonymous block */ {
        // Range: 0x1F2620 -> 0x1F2870
        signed int i; // r21
        signed int j; // r5
        class xMorphTargetFile * mphtgt; // r4
        class xMorphSeqFile * header; // r18
        class xMorphFrame * framelist; // r17
        unsigned int * assetlist; // r16
        char * namelist; // r20
        void * assetPtr; // r2
