...
// this: r2
signed int xGoal::Process(enum en_trantype * trantype /* r5 */, float dt /* r29+0x10 */, void * ctxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F1CD0 -> 0x2F1D08
    }
}
...
// this: r2
signed int xGoal::EvalRules(enum en_trantype * trantype /* r5 */, float dt /* r29+0x10 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F1D10 -> 0x2F1D48
    }
}
...
// this: r2
signed int xGoal::PreCalc(float dt /* r29+0x10 */, void * updCtxt /* r2 */) {
    /* anonymous block */ {
        // Range: 0x2F1D50 -> 0x2F1D84
    }
}
