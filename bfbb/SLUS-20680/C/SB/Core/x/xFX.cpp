...
// this: r2
signed int xFXRibbon::render_compare(class xFXRibbon & c /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E5080 -> 0x1E5120
    }
}
...
// this: r18
void xFXRibbon::render_strip(class RxObjSpace3DVertex * verts /* r17 */, class iterator first /* r29+0xA0 */, unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E5120 -> 0x1E5578
...
// this: r2
void xFXRibbon::eval_joint(class joint_data & joint /* r2 */, class iColor_tag & color /* r2 */, float & width /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E5580 -> 0x1E5A34
        float frac; // r4
...
// this: r16
void xFXRibbon::set_texture(char * name /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E6050 -> 0x1E60C8
    }
}
...
// this: r16
void xFXRibbon::set_texture(unsigned int id /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E60D0 -> 0x1E6138
    }
}
...
// this: r20
void xFXRibbon::update(float dt /* r29+0xC0 */) {
    /* anonymous block */ {
        // Range: 0x1E62D0 -> 0x1E66F4
    }
}
...
// this: r20
void xFXRibbon::insert(class xVec3 & loc /* r19 */, float orient /* r22 */, float scale /* r21 */, float alpha /* r20 */, unsigned int flags /* r18 */) {
    /* anonymous block */ {
        // Range: 0x1E6850 -> 0x1E6B88
    }
}
...
// this: r20
void xFXRibbon::insert(class xVec3 & loc /* r19 */, class xVec3 & norm /* r18 */, float scale /* r21 */, float alpha /* r20 */, unsigned int flags /* r21 */) {
    /* anonymous block */ {
        // Range: 0x1E6B90 -> 0x1E6ED0
    }
}
...
// this: r2
void xFXRibbon::set_curve(class curve_node * curve /* r2 */, unsigned int size /* r2 */) {
    /* anonymous block */ {
        // Range: 0x1E6ED0 -> 0x1E6EDC
    }
}
