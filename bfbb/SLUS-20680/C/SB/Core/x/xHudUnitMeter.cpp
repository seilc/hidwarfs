/*
    Compile unit: C:\SB\Core\x\xHudUnitMeter.cpp
...
char buffer[16]; // size: 0x10, address: 0x0
static float tweak_anim_time_delta; // size: 0x4, address: 0x50EF30
// total size: 0x28
struct /* @anon2 */ {} xhud::unit_meter_widget::__vtable; // size: 0x28, address: 0x508E30
// total size: 0x28
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A660 -> 0x0029A858
*/
// Range: 0x29A660 -> 0x29A858
// this: r21
void unit_meter_widget::render() {
    /* anonymous block */ {
        // Range: 0x29A660 -> 0x29A858
        class render_context unitrc; // r29+0xA0
        signed int units; // r20
        signed int i; // r19
        signed int which; // r5
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029A860 -> 0x0029AA34
*/
// Range: 0x29A860 -> 0x29AA34
// this: r20
void unit_meter_widget::update(float dt /* r20 */) {
    /* anonymous block */ {
        // Range: 0x29A860 -> 0x29AA34
        signed int units; // r19
        signed int i; // r18
        signed int which; // r5
        class xModelInstance * m; // r17
        float duration; // r29+0x70
        float time; // r29+0x70
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AA40 -> 0x0029AA48
*/
// Range: 0x29AA40 -> 0x29AA48
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AA50 -> 0x0029AABC
*/
// Range: 0x29AA50 -> 0x29AABC
// this: r17
unsigned char unit_meter_widget::is(unsigned int id /* r16 */) {
    /* anonymous block */ {
        // Range: 0x29AA50 -> 0x29AABC
        unsigned int myid; // @ 0x0050FDEC
        signed char @3861; // @ 0x0050FDF0
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AAC0 -> 0x0029AAF8
*/
// Range: 0x29AAC0 -> 0x29AAF8
unsigned int type() {
    /* anonymous block */ {
        // Range: 0x29AAC0 -> 0x29AAF8
    }
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AB00 -> 0x0029AB08
*/
// Range: 0x29AB00 -> 0x29AB08
// this: r2
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AB10 -> 0x0029ABF8
*/
// Range: 0x29AB10 -> 0x29ABF8
// this: r21
unit_meter_widget::unit_meter_widget(class unit_meter_asset & a /* r16 */) {
    /* anonymous block */ {
        // Range: 0x29AB10 -> 0x29ABF8
        signed int i; // r20
        signed int j; // r19
        unsigned char registered; // @ 0x0050FDE8
    }
}
...
/*
    ...
    Producer: MW MIPS C Compiler
    Language: C++
    Code range: 0x0029AC00 -> 0x0029AC4C
*/
// Range: 0x29AC00 -> 0x29AC4C
